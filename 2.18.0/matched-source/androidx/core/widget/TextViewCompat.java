...
public final class TextViewCompat {
    ...
    public static class OooO {
        ...
        @DoNotInline
        public static PrecomputedText.Params OooO0O0(TextView textView) {
    ...
    public static class OooOO0 implements ActionMode.Callback {
        ...
        public final ActionMode.Callback f8035OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final TextView f8036OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public Class<?> f8037OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public Method f8038OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public boolean f8039OooO0o = false;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public boolean f8040OooO0o0;

        public OooOO0(ActionMode.Callback callback, TextView textView) {
            this.f8035OooO00o = callback;
            this.f8036OooO0O0 = textView;
        }

        @Override // android.view.ActionMode.Callback
        public final boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            return this.f8035OooO00o.onActionItemClicked(actionMode, menuItem);
        }

        @Override // android.view.ActionMode.Callback
        public final boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            return this.f8035OooO00o.onCreateActionMode(actionMode, menu);
        }

        @Override // android.view.ActionMode.Callback
        public final void onDestroyActionMode(ActionMode actionMode) {
            this.f8035OooO00o.onDestroyActionMode(actionMode);
        }
        ...
        public final boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
            boolean z;
            String str;
            Context context = this.f8036OooO0O0.getContext();
            PackageManager packageManager = context.getPackageManager();
            if (!this.f8039OooO0o) {
                this.f8039OooO0o = true;
                try {
                    Class<?> cls = Class.forName("com.android.internal.view.menu.MenuBuilder");
                    this.f8037OooO0OO = cls;
                    this.f8038OooO0Oo = cls.getDeclaredMethod("removeItemAt", Integer.TYPE);
                    this.f8040OooO0o0 = true;
                } catch (ClassNotFoundException | NoSuchMethodException unused) {
                    this.f8037OooO0OO = null;
                    this.f8038OooO0Oo = null;
                    this.f8040OooO0o0 = false;
                }
            }
            try {
                Method declaredMethod = (this.f8040OooO0o0 && this.f8037OooO0OO.isInstance(menu)) ? this.f8038OooO0Oo : menu.getClass().getDeclaredMethod("removeItemAt", Integer.TYPE);
                ...
                for (int i = 0; i < arrayList.size(); i++) {
                    ...
                    TextView textView = this.f8036OooO0O0;
            ...
            return this.f8035OooO00o.onPrepareActionMode(actionMode, menu);
        }
    }

    @NonNull
    public static o000O0Oo.OooO0O0.OooO00o OooO00o(@NonNull TextView textView) {
        int iOooO00o;
        int iOooO0Oo;
        TextDirectionHeuristic textDirectionHeuristic;
        int i = Build.VERSION.SDK_INT;
        if (i >= 28) {
            return new o000O0Oo.OooO0O0.OooO00o(OooO.OooO0O0(textView));
        }
        ...
        if (i >= 23) {
            iOooO00o = OooO0OO.OooO00o(textView);
            iOooO0Oo = OooO0OO.OooO0Oo(textView);
        }
        if (textView.getTransformationMethod() instanceof PasswordTransformationMethod) {
            ...
            byte directionality = Character.getDirectionality(OooO.OooO00o(OooO0o.OooO00o(OooO0O0.OooO0Oo(textView)))[0].codePointAt(0));
            textDirectionHeuristic = (directionality == 1 || directionality == 2) ? TextDirectionHeuristics.RTL : TextDirectionHeuristics.LTR;
        }
        return new o000O0Oo.OooO0O0.OooO00o(textPaint, textDirectionHeuristic, iOooO00o, iOooO0Oo);
    }

    public static void OooO0O0(@NonNull TextView textView, @IntRange(from = ULong.MIN_VALUE) @Px int i) {
        o000OO0O.OooOOO0.OooO0O0(i);
    ...
    public static void OooO0o(@NonNull TextView textView, @StyleRes int i) {
        if (Build.VERSION.SDK_INT >= 23) {
    ...
    public static void OooO0o0(@NonNull TextView textView, @NonNull o000O0Oo.OooO0O0 oooO0O0) {
        if (Build.VERSION.SDK_INT >= 29) {
            Objects.requireNonNull(oooO0O0);
            textView.setText((CharSequence) null);
            return;
        }
        o000O0Oo.OooO0O0.OooO00o OooO00o2 = OooO00o(textView);
        Objects.requireNonNull(oooO0O0);
    ...
    @Nullable
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public static ActionMode.Callback OooO0oO(@Nullable ActionMode.Callback callback) {
        return (!(callback instanceof OooOO0) || Build.VERSION.SDK_INT < 26) ? callback : ((OooOO0) callback).f8035OooO00o;
    }

    @Nullable
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public static ActionMode.Callback OooO0oo(@NonNull TextView textView, @Nullable ActionMode.Callback callback) {
        int i = Build.VERSION.SDK_INT;
