...
public final class OooO00o extends Lambda implements Function3<RoomUserInfoModel, Integer, RoomMemberManagerTag, Unit> {
    ...
    public final /* synthetic */ o000OO00 f11669Oooo;

    /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
    public final /* synthetic */ RoomInfoMemberListFragment f11670OoooO00;
    ...
    public OooO00o(o000OO00 o000oo01, RoomInfoMemberListFragment roomInfoMemberListFragment) {
        super(3);
        this.f11669Oooo = o000oo01;
        this.f11670OoooO00 = roomInfoMemberListFragment;
    }
    ...
    public final Unit invoke(RoomUserInfoModel roomUserInfoModel, Integer num, RoomMemberManagerTag roomMemberManagerTag) {
        ...
        if (i == 1) {
            ...
            this.f11669Oooo.notifyItemChanged(iIntValue);
            this.f11670OoooO00.getBinding().f51088OooO0OO.smoothScrollToPosition(iIntValue);
        } else if (i == 2) {
            this.f11670OoooO00.delMember(model);
        } else if (i == 3) {
            this.f11670OoooO00.setToManger(model);
        } else if (i == 4) {
            this.f11670OoooO00.setToMember(model);
        } else if (i == 5) {
            EditText view = this.f11670OoooO00.getBinding().f51087OooO0O0.f50575OooO0OO;
            ...
            FragmentActivity activity = this.f11670OoooO00.getActivity();
            if (activity != null) {
                UserInfoActivity.f23471o0OOO0o.OooO0OO(activity, String.valueOf(model.getUserId()), false, true, false, false);
            }
        }
