...
public class RoomChatType {
    public static final int TYPE_ANIM_EMOJI_DICE = 9;
    public static final int TYPE_ANIM_EMOJI_JSB = 10;
    public static final int TYPE_APPLY_MIC_SWITCH = 32;
    public static final int TYPE_EVENT = 26;
    public static final int TYPE_FOLLOW_ROOM_TIP = 27;
    public static final int TYPE_GIF = 16;
    public static final int TYPE_GIFT = 1;
    public static final int TYPE_HATS = 5;
    public static final int TYPE_InRoom_BeConvened = 35;
    public static final int TYPE_LUCKY_NUMBER = 4;
    public static final int TYPE_LUCKY_NUMBER_SET_NOTIFICATION = 34;
    public static final int TYPE_LUCKY_NUMBER_SET_RESULT = 33;
    public static final int TYPE_MAGIC_VOICE = 15;
    public static final int TYPE_MEMBER_INTIMACY_TIP = 28;
    public static final int TYPE_MEMBER_INVITE_TASK = 29;
    public static final int TYPE_MEMBER_SHARE_TASK = 30;
    public static final int TYPE_MEMBER_UP_LEVEL = 31;
    ...
    public static final int TYPE_TYPE_VIP_TIP = 2;
    public static final int TYPE_UNKNOWN = -1;
    public static final int TYPE_VOTE_GAME = 21;
    public static final int TYPE_WELCOME_JOIN_ROOM = 25;
