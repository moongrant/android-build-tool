...
@Metadata(bv = {}, d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\b\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0007\u0018\u00002\u00020\u0001:\u0001\u001eB\u0019\u0012\u0006\u0010\u0018\u001a\u00020\u0017\u0012\b\u0010\u001a\u001a\u0004\u0018\u00010\u0019¢\u0006\u0004\b\u001b\u0010\u001cB\u0011\b\u0016\u0012\u0006\u0010\u0018\u001a\u00020\u0017¢\u0006\u0004\b\u001b\u0010\u001dR\u0017\u0010\u0007\u001a\u00020\u00028\u0006¢\u0006\f\n\u0004\b\u0003\u0010\u0004\u001a\u0004\b\u0005\u0010\u0006R*\u0010\u0010\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\b8\u0006@FX\u0086\u000e¢\u0006\u0012\n\u0004\b\n\u0010\u000b\u001a\u0004\b\f\u0010\r\"\u0004\b\u000e\u0010\u000fR\u001b\u0010\u0016\u001a\u00020\u00118BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u0012\u0010\u0013\u001a\u0004\b\u0014\u0010\u0015¨\u0006\u001f"}, d2 = {"Lcom/app/base/view/SonicView;", "Landroid/view/View;", "Landroid/view/animation/AccelerateInterpolator;", "OoooOOO", "Landroid/view/animation/AccelerateInterpolator;", "getInterpolator", "()Landroid/view/animation/AccelerateInterpolator;", "interpolator", "Lcom/app/base/view/SonicView$SonicType;", AppMeasurementSdk.ConditionalUserProperty.VALUE, "OoooOOo", "Lcom/app/base/view/SonicView$SonicType;", "getSonicType", "()Lcom/app/base/view/SonicView$SonicType;", "setSonicType", "(Lcom/app/base/view/SonicView$SonicType;)V", "sonicType", "Landroid/animation/ValueAnimator;", "OoooOo0", "Lkotlin/Lazy;", "getDefaultAnimator", "()Landroid/animation/ValueAnimator;", "defaultAnimator", "Landroid/content/Context;", d.R, "Landroid/util/AttributeSet;", "attributeSet", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "(Landroid/content/Context;)V", "SonicType", "app_YallaRelease"}, k = 1, mv = {1, 7, 1})
public final class SonicView extends View {

    /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
    @NotNull
    public final Paint f12115Oooo;

    /* JADX INFO: renamed from: OoooO, reason: collision with root package name */
    public float f12116OoooO;

    /* JADX INFO: renamed from: OoooO0, reason: collision with root package name */
    public float f12117OoooO0;

    /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
    public int f12118OoooO00;

    /* JADX INFO: renamed from: OoooO0O, reason: collision with root package name */
    public final float f12119OoooO0O;

    /* JADX INFO: renamed from: OoooOO0, reason: collision with root package name */
    public float f12120OoooOO0;
    ...
    public boolean f12124OoooOoO;

    /* JADX INFO: renamed from: o000oOoO, reason: collision with root package name */
    public final Animation f12125o000oOoO;
    ...
    public static final class OooO0OO extends Lambda implements Function0<ValueAnimator> {
        ...
        public final ValueAnimator invoke() {
            ...
            valueAnimator.setFloatValues(ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, sonicView.f12119OoooO0O);
            valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: o00OooOo.o0OOO0
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    ...
                    this$0.f12117OoooO0 = ((Float) animatedValue).floatValue();
    ...
    public SonicView(@NotNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.f12115Oooo = paint;
        this.f12118OoooO00 = o000O0O0.OooO00o(R.color.color_white);
        this.f12119OoooO0O = 100.0f;
        this.f12116OoooO = OooOo00.OooO00o(24.8f);
        this.f12120OoooOO0 = Float.MIN_VALUE;
        this.f12125o000oOoO = AnimationUtils.loadAnimation(context, R.anim.room_mic_view);
    ...
    public final void OooO00o() {
        ...
        if (i != 1) {
            ...
            } else if (this.f12125o000oOoO.hasStarted() || !this.f12125o000oOoO.hasEnded()) {
                clearAnimation();
            }
    ...
    public final void OooO0OO() {
        ...
        if (i == 1) {
            ...
            if (!this.f12125o000oOoO.hasStarted() || this.f12125o000oOoO.hasEnded()) {
                startAnimation(this.f12125o000oOoO);
            }
        }
    }
    ...
    public final void onDraw(@Nullable Canvas canvas) {
        ...
        this.f12115Oooo.setColor(this.f12118OoooO00);
        if (canvas != null) {
            canvas.drawCircle(getWidth() / 2.0f, getHeight() / 2.0f, this.f12116OoooO + OooOo00.OooO00o(1), this.f12115Oooo);
        }
        float width = ((getWidth() / 2.0f) - this.f12116OoooO) / 2.0f;
        this.f12120OoooOO0 = width;
        float width2 = (getWidth() / 2.0f) + (width * 3);
        float f = this.f12117OoooO0 / this.f12119OoooO0O;
        float f2 = this.f12116OoooO;
        float fOooO00o = Oooo000.OooO00o.OooO00o(width2, f2, f, f2);
        float f3 = 1;
        float width3 = f3 - ((fOooO00o - f2) / ((getWidth() / 2.0f) - this.f12116OoooO));
        for (int i = 0; i < 4; i++) {
            this.f12115Oooo.setColor(OooO0O0(this.f12118OoooO00, width3));
            if ((fOooO00o <= ((float) getWidth()) / 2.0f && this.f12116OoooO <= fOooO00o) && canvas != null) {
                canvas.drawCircle(getWidth() / 2.0f, getHeight() / 2.0f, fOooO00o, this.f12115Oooo);
            }
            fOooO00o -= this.f12120OoooOO0;
            width3 = f3 - ((fOooO00o - this.f12116OoooO) / ((getWidth() / 2.0f) - this.f12116OoooO));
            this.f12115Oooo.setColor(OooO0O0(this.f12118OoooO00, width3));
        }
    }
    ...
    public final void setSonicType(@NotNull SonicType value) {
        ...
        if (i == 1) {
            ...
            this.f12118OoooO00 = o000O0O0.OooO00o(R.color.color_FF006E);
            setBackgroundResource(0);
        }
