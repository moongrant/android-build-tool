...
public final class ModelManager {
        ...
        public static final class Companion {
            ...
            private final void deleteOldFiles(String useCase, int versionId) {
                ...
                while (i < length) {
                    ...
                    if (StringsKt__StringsJVMKt.startsWith$default(name, useCase, false, 2, null) && !StringsKt__StringsJVMKt.startsWith$default(name, str, false, 2, null)) {
                        file.delete();
                    }
                }
            }
            ...
            public static final void m153execute$lambda1(List slaves, File file) {
                ...
                if (modelBuild != null) {
                    ...
                    while (it.hasNext()) {
                        ...
                        sb.append('_');
                        TaskHandler.INSTANCE.download(taskHandler.getRuleUri(), OooO0o.OooO0OO.OooO0O0(sb, taskHandler.getVersionId(), "_rule"), new FileDownloadTask.Callback() { // from class: com.facebook.appevents.ml.OooO0o
                            @Override // com.facebook.appevents.internal.FileDownloadTask.Callback
                            public final void onComplete(File file2) {
                                ModelManager.TaskHandler.Companion.m154execute$lambda1$lambda0(taskHandler, modelBuild, file2);
                            }
                        });
                    }
                }
            ...
            public static final void m154execute$lambda1$lambda0(TaskHandler slave, Model model, File file) {
            ...
            public final void execute(@NotNull TaskHandler master, @NotNull List<TaskHandler> slaves) {
                ...
                download(master.getAssetUri(), master.getUseCase() + '_' + master.getVersionId(), new OooO(slaves, 0));
            }
        }
    ...
    public static final void enable() {
        ...
        try {
            ...
            Utility.runOnNonUiThread(new Runnable() { // from class: com.facebook.appevents.ml.OooO0OO
                @Override // java.lang.Runnable
                public final void run() {
                    ModelManager.m150enable$lambda0();
                }
            });
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, ModelManager.class);
    ...
    public static final void m150enable$lambda0() {
            ...
            for (Map.Entry<String, TaskHandler> entry : taskHandlers.entrySet()) {
                ...
                if (Intrinsics.areEqual(key, Task.MTML_APP_EVENT_PREDICTION.toUseCase())) {
                    ...
                    if (FeatureManager.isEnabled(FeatureManager.Feature.SuggestedEvents) && isLocaleEnglish()) {
                        arrayList.add(value.setOnPostExecute(new Runnable() { // from class: com.facebook.appevents.ml.OooO00o
                            @Override // java.lang.Runnable
                            public final void run() {
                                ModelManager.m151enableMTML$lambda1();
                            }
                        }));
                    }
                    assetUri = assetUri2;
                ...
                if (Intrinsics.areEqual(key, Task.MTML_INTEGRITY_DETECT.toUseCase())) {
                    ...
                    if (FeatureManager.isEnabled(FeatureManager.Feature.IntelligentIntegrity)) {
                        arrayList.add(value.setOnPostExecute(new Runnable() { // from class: com.facebook.appevents.ml.OooO0O0
                            @Override // java.lang.Runnable
                            public final void run() {
                                ModelManager.m152enableMTML$lambda2();
                            }
                        }));
                    }
                }
    ...
    public static final void m151enableMTML$lambda1() {
        if (CrashShieldHandler.isObjectCrashing(ModelManager.class)) {
            return;
        }
        try {
    ...
    public static final void m152enableMTML$lambda2() {
        if (CrashShieldHandler.isObjectCrashing(ModelManager.class)) {
            return;
        }
        try {
    ...
    private final boolean isLocaleEnglish() {
        ...
        try {
            ...
            if (resourceLocale != null) {
                ...
                if (!StringsKt.OooO0OO(language, "en")) {
                    return false;
                }
            }
            return true;
