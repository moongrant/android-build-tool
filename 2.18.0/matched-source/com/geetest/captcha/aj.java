    ...
    public static final class b {
        ...
        public static final class a implements Runnable {
            ...
            public final void run() {
                b.this.b.evaluateJavascript(OooO00o.OooO00o(new StringBuilder("javascript:jsBridge.callback('postNativeMessage', '"), this.b, "')"), new ValueCallback<String>() { // from class: com.geetest.captcha.aj.b.a.1
        ...
        public final void gt4Notify(@Nullable String response) throws JSONException {
            ag agVar = ag.a;
            ag.b("JSInterface.gt4Notify: " + response + ", main: " + Intrinsics.areEqual(Looper.getMainLooper(), Looper.myLooper()));
