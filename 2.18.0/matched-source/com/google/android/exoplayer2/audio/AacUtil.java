...
public final class AacUtil {
    ...
    public static final int[] f13484OooO00o = {96000, 88200, 64000, 48000, 44100, LogType.UNEXP_KNOWN_REASON, 24000, 22050, 16000, 12000, 11025, 8000, 7350};

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final int[] f13485OooO0O0 = {0, 1, 2, 3, 4, 5, 6, 8, -1, -1, -1, 7, 8, -1, 8, -1};
    ...
    public static final class OooO00o {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final int f13486OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final int f13487OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final String f13488OooO0OO;

        public OooO00o(int i, int i2, String str) {
            this.f13486OooO00o = i;
            this.f13487OooO0O0 = i2;
            this.f13488OooO0OO = str;
        }
    }
    ...
    public static int OooO0O0(o000 o000Var) {
        ...
        return f13484OooO00o[iOooO0oO];
    }

    public static OooO00o OooO0OO(o000 o000Var, boolean z) throws ParserException {
    ...
    public static OooO00o OooO0Oo(byte[] bArr) throws ParserException {
        return OooO0OO(new o000(bArr, bArr.length), false);
    }
}
