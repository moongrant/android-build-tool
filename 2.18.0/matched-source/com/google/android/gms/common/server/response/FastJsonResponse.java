...
public abstract class FastJsonResponse {
    ...
    public static final void OooOO0O(StringBuilder sb, Field field, Object obj) {
        ...
        if (i == 11) {
            Class<? extends FastJsonResponse> cls = field.f15722OoooOOO;
    ...
    public final Object OooO00o(@NonNull Field field) {
        String str = field.f15721OoooOO0;
        if (field.f15722OoooOOO == null) {
            return getValueObject(str);
        }
        Preconditions.checkState(getValueObject(str) == null, "Concrete field shouldn't be value object: %s", field.f15721OoooOO0);
        try {
    ...
    public final boolean OooO0O0(@NonNull Field field) {
        if (field.f15720OoooO0O != 11) {
            return isPrimitiveFieldSet(field.f15721OoooOO0);
        }
        if (field.f15717OoooO) {
    ...
    public String toString() {
        ...
        for (String str : fieldMappings.keySet()) {
            ...
            if (OooO0O0(field)) {
                ...
                p710oo000o.Oooo0.OooO00o(sb, "\"", str, "\":");
                if (objOooO00o != null) {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        public final int f15716Oooo;

        /* JADX INFO: renamed from: OoooO, reason: collision with root package name */
        @SafeParcelable.Field(getter = "isTypeOutArray", id = 5)
        public final boolean f15717OoooO;

        /* JADX INFO: renamed from: OoooO0, reason: collision with root package name */
        @SafeParcelable.Field(getter = "isTypeInArray", id = 3)
        public final boolean f15718OoooO0;

        /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
        @SafeParcelable.Field(getter = "getTypeIn", id = 2)
        public final int f15719OoooO00;

        /* JADX INFO: renamed from: OoooO0O, reason: collision with root package name */
        @SafeParcelable.Field(getter = "getTypeOut", id = 4)
        public final int f15720OoooO0O;

        /* JADX INFO: renamed from: OoooOO0, reason: collision with root package name */
        @NonNull
        @SafeParcelable.Field(getter = "getOutputFieldName", id = 6)
        public final String f15721OoooOO0;

        /* JADX INFO: renamed from: OoooOOO, reason: collision with root package name */
        @Nullable
        public final Class<? extends FastJsonResponse> f15722OoooOOO;

        /* JADX INFO: renamed from: OoooOOo, reason: collision with root package name */
        @Nullable
        @SafeParcelable.Field(getter = "getConcreteTypeName", id = 8)
        public final String f15723OoooOOo;

        /* JADX INFO: renamed from: OoooOo0, reason: collision with root package name */
        public zan f15724OoooOo0;

        /* JADX INFO: renamed from: OoooOoO, reason: collision with root package name */
        @Nullable
        @SafeParcelable.Field(getter = "getWrappedConverter", id = 9, type = "com.google.android.gms.common.server.converter.ConverterWrapper")
        public FieldConverter<I, O> f15725OoooOoO;

        /* JADX INFO: renamed from: o000oOoO, reason: collision with root package name */
        @SafeParcelable.Field(getter = "getSafeParcelableFieldId", id = 7)
        public final int f15726o000oOoO;
        ...
        public Field(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) int i2, @SafeParcelable.Param(id = 3) boolean z, @SafeParcelable.Param(id = 4) int i3, @SafeParcelable.Param(id = 5) boolean z2, @SafeParcelable.Param(id = 6) String str, @SafeParcelable.Param(id = 7) int i4, @Nullable @SafeParcelable.Param(id = 8) String str2, @Nullable @SafeParcelable.Param(id = 9) zaa zaaVar) {
            this.f15716Oooo = i;
            this.f15719OoooO00 = i2;
            this.f15718OoooO0 = z;
            this.f15720OoooO0O = i3;
            this.f15717OoooO = z2;
            this.f15721OoooOO0 = str;
            this.f15726o000oOoO = i4;
            if (str2 == null) {
                this.f15722OoooOOO = null;
                this.f15723OoooOOo = null;
            } else {
                this.f15722OoooOOO = SafeParcelResponse.class;
                this.f15723OoooOOo = str2;
            }
            if (zaaVar == null) {
                this.f15725OoooOoO = null;
            } else {
                this.f15725OoooOoO = (FieldConverter<I, O>) zaaVar.zab();
            }
        }
        ...
        public int getSafeParcelableFieldId() {
            return this.f15726o000oOoO;
        }

        @NonNull
        public final String toString() {
            Objects.ToStringHelper toStringHelperAdd = Objects.toStringHelper(this).add("versionCode", Integer.valueOf(this.f15716Oooo)).add("typeIn", Integer.valueOf(this.f15719OoooO00)).add("typeInArray", Boolean.valueOf(this.f15718OoooO0)).add("typeOut", Integer.valueOf(this.f15720OoooO0O)).add("typeOutArray", Boolean.valueOf(this.f15717OoooO)).add("outputFieldName", this.f15721OoooOO0).add("safeParcelFieldId", Integer.valueOf(this.f15726o000oOoO));
            String str = this.f15723OoooOOo;
            if (str == null) {
                str = null;
            }
            Objects.ToStringHelper toStringHelperAdd2 = toStringHelperAdd.add("concreteTypeName", str);
            Class<? extends FastJsonResponse> cls = this.f15722OoooOOO;
            if (cls != null) {
                toStringHelperAdd2.add("concreteType.class", cls.getCanonicalName());
            }
            FieldConverter<I, O> fieldConverter = this.f15725OoooOoO;
        ...
        public final void writeToParcel(@NonNull Parcel parcel, int i) {
            ...
            SafeParcelWriter.writeInt(parcel, 1, this.f15716Oooo);
            SafeParcelWriter.writeInt(parcel, 2, this.f15719OoooO00);
            SafeParcelWriter.writeBoolean(parcel, 3, this.f15718OoooO0);
            SafeParcelWriter.writeInt(parcel, 4, this.f15720OoooO0O);
            SafeParcelWriter.writeBoolean(parcel, 5, this.f15717OoooO);
            SafeParcelWriter.writeString(parcel, 6, this.f15721OoooOO0, false);
        ...
        public final Field<I, O> zab() {
            int i = this.f15716Oooo;
            int i2 = this.f15719OoooO00;
            boolean z = this.f15718OoooO0;
            int i3 = this.f15720OoooO0O;
            boolean z2 = this.f15717OoooO;
            String str = this.f15721OoooOO0;
            int i4 = this.f15726o000oOoO;
            String str2 = this.f15723OoooOOo;
            FieldConverter<I, O> fieldConverter = this.f15725OoooOoO;
        ...
        public final FastJsonResponse zad() throws IllegalAccessException, InstantiationException {
            Preconditions.checkNotNull(this.f15722OoooOOO);
            Class<? extends FastJsonResponse> cls = this.f15722OoooOOO;
            if (cls != SafeParcelResponse.class) {
                return cls.newInstance();
            }
            Preconditions.checkNotNull(this.f15723OoooOOo);
            Preconditions.checkNotNull(this.f15724OoooOo0, "The field mapping dictionary must be set if the concrete type is a SafeParcelResponse object.");
            return new SafeParcelResponse(this.f15724OoooOo0, this.f15723OoooOOo);
        }

        @NonNull
        public final O zae(@Nullable I i) {
            Preconditions.checkNotNull(this.f15725OoooOoO);
            return (O) Preconditions.checkNotNull(this.f15725OoooOoO.zac(i));
        }

        @NonNull
        public final I zaf(@NonNull O o2) {
            Preconditions.checkNotNull(this.f15725OoooOoO);
            return this.f15725OoooOoO.zad(o2);
        }

        @NonNull
        public final Map<String, Field<?, ?>> zah() {
            Preconditions.checkNotNull(this.f15723OoooOOo);
            Preconditions.checkNotNull(this.f15724OoooOo0);
            return (Map) Preconditions.checkNotNull(this.f15724OoooOo0.zab(this.f15723OoooOOo));
        }

        public final void zai(zan zanVar) {
            this.f15724OoooOo0 = zanVar;
        }

        public final boolean zaj() {
            return this.f15725OoooOoO != null;
        }
        ...
        public Field(int i, boolean z, int i2, boolean z2, @NonNull String str, int i3, @Nullable Class<? extends FastJsonResponse> cls, @Nullable FieldConverter<I, O> fieldConverter) {
            this.f15716Oooo = 1;
            this.f15719OoooO00 = i;
            this.f15718OoooO0 = z;
            this.f15720OoooO0O = i2;
            this.f15717OoooO = z2;
            this.f15721OoooOO0 = str;
            this.f15726o000oOoO = i3;
            this.f15722OoooOOO = cls;
            if (cls == null) {
                this.f15723OoooOOo = null;
            } else {
                this.f15723OoooOOo = cls.getCanonicalName();
            }
            this.f15725OoooOoO = fieldConverter;
        }
    }
}
