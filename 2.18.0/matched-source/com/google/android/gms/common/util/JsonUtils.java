...
public final class JsonUtils {
    ...
    public static final Pattern f15798OooO00o = Pattern.compile("\\\\.");

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final Pattern f15799OooO0O0 = Pattern.compile("[\\\\\"/\b\f\n\r\t]");
    ...
    public static String escapeString(@Nullable String str) {
        ...
        Matcher matcher = f15799OooO0O0.matcher(str);
    ...
    public static String unescapeString(@NonNull String str) {
        ...
        Pattern pattern = OooO00o.f37224OooO00o;
        StringBuffer stringBuffer = null;
        if (!TextUtils.isEmpty(str)) {
            Matcher matcher = OooO00o.f37224OooO00o.matcher(str);
            int iEnd = 0;
        ...
        Matcher matcher2 = f15798OooO00o.matcher(str);
        while (matcher2.find()) {
            if (stringBuffer == null) {
                stringBuffer = new StringBuffer();
            }
