...
import p287o0O0O0oO.o0O0O00;
import p303o0O0o00.o000OOo0;
import p352o0OOOOo.OooOOO;
import p383o0OOoOOO.o00O;
import p383o0OOoOOO.o00O0OOO;
import p383o0OOoOOO.o00OO;
import p383o0OOoOOO.o0O0ooO;
import p385o0OOoOo0.o0OoOo0;
...
public class FirebaseMessagingService extends EnhancedIntentService {
    ...
    private void passMessageIntentToSdk(Intent intent) {
        ...
        if (ACTION_DIRECT_BOOT_REMOTE_INTENT.equals(intent.getAction())) {
            ...
            try {
                ...
                Context context = oooOOOOooO0OO2.f38283OooO00o;
        ...
        if (z) {
            ...
            OooOO0 oooOO1 = FirebaseMessaging.f19191OooOOOO;
            if (oooOO1 == null) {
                    ...
                    if (obj instanceof Integer) {
                        ...
                        if (TextUtils.isEmpty(string)) {
                            try {
                                ...
                                Object obj2 = com.google.firebase.installations.OooO00o.f19139OooOOO0;
                                Preconditions.checkArgument(true, "Null is not a valid value of FirebaseApp.");
                                string = (String) Tasks.await(((com.google.firebase.installations.OooO00o) oooOOOOooO0OO3.OooO0O0(p379o0OOoO00.OooOOO.class)).getId());
                        ...
                        String packageName = oooOOOOooO0OO4.f38283OooO00o.getPackageName();
                        ...
                        if (extras.containsKey("google.c.sender.id")) {
                            try {
                                ...
                                str6 = oooOOOOooO0OO.f38285OooO0OO.f38307OooO0o0;
                                if (str6 != null) {
                                    try {
                                        ...
                                        oooOOOOooO0OO.OooO00o();
                                        str7 = oooOOOOooO0OO.f38285OooO0OO.f38303OooO0O0;
                        ...
                        ((o0O0O00) oooOO1.OooO00o("FCM_CLIENT_EVENT_LOGGING", new o0O0O0Oo.OooO0O0("proto"), o000OOo0.f36092Oooo)).OooO00o(new o0O0O0Oo.OooO00o(new o0OoOo0(new MessagingClientEvent(j2, str, str9, messageType2, sDKPlatform, packageName, str3, i, str2, event, str4, str5)), Priority.DEFAULT), OooOOOO.f12712OoooO00);
                    }
                    ((o0O0O00) oooOO1.OooO00o("FCM_CLIENT_EVENT_LOGGING", new o0O0O0Oo.OooO0O0("proto"), o000OOo0.f36092Oooo)).OooO00o(new o0O0O0Oo.OooO00o(new o0OoOo0(new MessagingClientEvent(j2, str, str9, messageType2, sDKPlatform, packageName, str3, i, str2, event, str4, str5)), Priority.DEFAULT), OooOOOO.f12712OoooO00);
                ...
                if (TextUtils.isEmpty(string)) {
                    ...
                    Object obj3 = com.google.firebase.installations.OooO00o.f19139OooOOO0;
                    Preconditions.checkArgument(true, "Null is not a valid value of FirebaseApp.");
                    string = (String) Tasks.await(((com.google.firebase.installations.OooO00o) oooOOOOooO0OO5.OooO0O0(p379o0OOoO00.OooOOO.class)).getId());
                }
                String str10 = string;
                OooOOO oooOOOOooO0OO6 = OooOOO.OooO0OO();
                oooOOOOooO0OO6.OooO00o();
                String packageName2 = oooOOOOooO0OO6.f38283OooO00o.getPackageName();
    ...
    public Intent getStartCommandIntent(Intent intent) {
        return (Intent) o00OO.OooO00o().f38792OooO0Oo.poll();
    }
