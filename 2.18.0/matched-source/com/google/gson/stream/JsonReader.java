...
public class JsonReader implements Closeable {
    ...
    static {
        o00OOOO0.INSTANCE = new o00OOOO0() { // from class: com.google.gson.stream.JsonReader.1
            @Override // p389o0OOoo0o.o00OOOO0
            public void promoteNameToValue(JsonReader jsonReader) throws IOException {
                if (jsonReader instanceof OooO0O0) {
                    OooO0O0 oooO0O0 = (OooO0O0) jsonReader;
                    Objects.requireNonNull(oooO0O0);
                    oooO0O0.OooO00o(JsonToken.NAME);
                    Map.Entry entry = (Map.Entry) ((Iterator) oooO0O0.OooO0O0()).next();
                    oooO0O0.OooO0o(entry.getValue());
                    oooO0O0.OooO0o(new oOO00O((String) entry.getKey()));
                    return;
                }
                ...
                if (iDoPeek == 12) {
                    ...
                    StringBuilder sbOooO0O0 = OooO00o.OooO0O0("Expected a name but was ");
                    sbOooO0O0.append(jsonReader.peek());
                    sbOooO0O0.append(jsonReader.locationString());
    ...
    private String getPath(boolean z) {
        StringBuilder sbOooO0O0 = OooO0OO.OooO0O0(Typography.dollar);
        int i = 0;
        while (true) {
        ...
        while (true) {
            if (i == i2) {
                ...
                if (!fillBuffer(1)) {
                    ...
                    StringBuilder sbOooO0O0 = OooO00o.OooO0O0("End of input");
                    sbOooO0O0.append(locationString());
            ...
            while (i5 < i6) {
                ...
                if (c3 < '0' || c3 > '9') {
                    if (c3 >= 'a' && c3 <= 'f') {
                        ...
                        if (c3 < 'A' || c3 > 'F') {
                            StringBuilder sbOooO0O0 = OooO00o.OooO0O0("\\u");
                            sbOooO0O0.append(new String(this.buffer, this.pos, 4));
    ...
    private IOException syntaxError(String str) throws IOException {
        ...
        sbOooO0O0.append(locationString());
        throw new MalformedJsonException(sbOooO0O0.toString());
    }
    ...
    public void beginArray() throws IOException {
        ...
        if (iDoPeek == 3) {
            ...
            StringBuilder sbOooO0O0 = OooO00o.OooO0O0("Expected BEGIN_ARRAY but was ");
            sbOooO0O0.append(peek());
            sbOooO0O0.append(locationString());
            throw new IllegalStateException(sbOooO0O0.toString());
        }
    }
    ...
    public void beginObject() throws IOException {
        ...
        if (iDoPeek == 1) {
            ...
            StringBuilder sbOooO0O0 = OooO00o.OooO0O0("Expected BEGIN_OBJECT but was ");
            sbOooO0O0.append(peek());
            sbOooO0O0.append(locationString());
            throw new IllegalStateException(sbOooO0O0.toString());
        }
    ...
    public void endArray() throws IOException {
        ...
        if (iDoPeek != 4) {
            StringBuilder sbOooO0O0 = OooO00o.OooO0O0("Expected END_ARRAY but was ");
            sbOooO0O0.append(peek());
            sbOooO0O0.append(locationString());
            throw new IllegalStateException(sbOooO0O0.toString());
        }
    ...
    public void endObject() throws IOException {
        ...
        if (iDoPeek != 2) {
            StringBuilder sbOooO0O0 = OooO00o.OooO0O0("Expected END_OBJECT but was ");
            sbOooO0O0.append(peek());
            sbOooO0O0.append(locationString());
            throw new IllegalStateException(sbOooO0O0.toString());
        }
    ...
    public String locationString() {
        StringBuilder sbOooO0OO = o000O0Oo.OooO0OO(" at line ", this.lineNumber + 1, " column ", (this.pos - this.lineStart) + 1, " path ");
        sbOooO0OO.append(getPath());
    ...
    public boolean nextBoolean() throws IOException {
        ...
        if (iDoPeek != 6) {
            StringBuilder sbOooO0O0 = OooO00o.OooO0O0("Expected a boolean but was ");
            sbOooO0O0.append(peek());
            sbOooO0O0.append(locationString());
            throw new IllegalStateException(sbOooO0O0.toString());
        }
    ...
    public double nextDouble() throws IOException {
        ...
        if (iDoPeek == 16) {
            ...
            StringBuilder sbOooO0O0 = OooO00o.OooO0O0("Expected a double but was ");
            sbOooO0O0.append(peek());
            sbOooO0O0.append(locationString());
            throw new IllegalStateException(sbOooO0O0.toString());
        }
    ...
    public int nextInt() throws IOException {
        ...
        if (iDoPeek == 15) {
            ...
            int i = (int) j;
            if (j != i) {
                StringBuilder sbOooO0O0 = OooO00o.OooO0O0("Expected an int but was ");
                sbOooO0O0.append(this.peekedLong);
                sbOooO0O0.append(locationString());
                throw new NumberFormatException(sbOooO0O0.toString());
            }
            this.peeked = 0;
        ...
        if (iDoPeek == 16) {
            ...
            if (iDoPeek != 8 && iDoPeek != 9 && iDoPeek != 10) {
                StringBuilder sbOooO0O1 = OooO00o.OooO0O0("Expected an int but was ");
                sbOooO0O1.append(peek());
                sbOooO0O1.append(locationString());
        ...
        int i5 = (int) d;
        if (i5 != d) {
            StringBuilder sbOooO0O2 = OooO00o.OooO0O0("Expected an int but was ");
            sbOooO0O2.append(this.peekedString);
            sbOooO0O2.append(locationString());
            throw new NumberFormatException(sbOooO0O2.toString());
        }
        this.peekedString = null;
        this.peeked = 0;
    ...
    public long nextLong() throws IOException {
        ...
        if (iDoPeek == 16) {
            ...
            if (iDoPeek != 8 && iDoPeek != 9 && iDoPeek != 10) {
                StringBuilder sbOooO0O0 = OooO00o.OooO0O0("Expected a long but was ");
                sbOooO0O0.append(peek());
                sbOooO0O0.append(locationString());
                throw new IllegalStateException(sbOooO0O0.toString());
            }
        ...
        long j2 = (long) d;
        if (j2 != d) {
            StringBuilder sbOooO0O1 = OooO00o.OooO0O0("Expected a long but was ");
            sbOooO0O1.append(this.peekedString);
            sbOooO0O1.append(locationString());
    ...
    public void nextNull() throws IOException {
        ...
        if (iDoPeek != 7) {
            StringBuilder sbOooO0O0 = OooO00o.OooO0O0("Expected null but was ");
            sbOooO0O0.append(peek());
            sbOooO0O0.append(locationString());
            throw new IllegalStateException(sbOooO0O0.toString());
        }
    ...
    public String nextString() throws IOException {
        ...
        if (iDoPeek == 10) {
            ...
            if (iDoPeek != 16) {
                StringBuilder sbOooO0O0 = OooO00o.OooO0O0("Expected a string but was ");
                sbOooO0O0.append(peek());
                sbOooO0O0.append(locationString());
                throw new IllegalStateException(sbOooO0O0.toString());
            }
