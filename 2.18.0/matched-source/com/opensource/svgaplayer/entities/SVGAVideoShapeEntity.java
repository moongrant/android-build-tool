...
public final class SVGAVideoShapeEntity {
    ...
    @NotNull
    public Type f19457OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @Nullable
    public Map<String, ? extends Object> f19458OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @Nullable
    public OooO00o f19459OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @Nullable
    public Matrix f19460OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @Nullable
    public Path f19461OooO0o0;

    public static final class OooO00o {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public int f19462OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public int f19463OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public float f19464OooO0OO;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f19466OooO0o;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        @NotNull
        public String f19465OooO0Oo = "butt";

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        @NotNull
        public String f19467OooO0o0 = "miter";

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        @NotNull
        public float[] f19468OooO0oO = new float[0];
    }
    ...
    public SVGAVideoShapeEntity(@NotNull JSONObject jSONObject) throws JSONException {
        ...
        if (jSONObjectOptJSONObject2 != null) {
            ...
            if (jSONArrayOptJSONArray != null && jSONArrayOptJSONArray.length() == 4) {
                ...
                oooO00o.f19462OooO00o = Color.argb((int) (dOptDouble * d), (int) (jSONArrayOptJSONArray.optDouble(0) * d), (int) (jSONArrayOptJSONArray.optDouble(1) * d), (int) (d * jSONArrayOptJSONArray.optDouble(2)));
            }
            ...
            if (jSONArrayOptJSONArray2 != null && jSONArrayOptJSONArray2.length() == 4) {
                ...
                oooO00o.f19463OooO0O0 = Color.argb((int) (dOptDouble2 * d2), (int) (jSONArrayOptJSONArray2.optDouble(0) * d2), (int) (jSONArrayOptJSONArray2.optDouble(1) * d2), (int) (jSONArrayOptJSONArray2.optDouble(2) * d2));
            }
            oooO00o.f19464OooO0OO = (float) jSONObjectOptJSONObject2.optDouble("strokeWidth", 0.0d);
            ...
            oooO00o.f19465OooO0Oo = strOptString2;
            ...
            oooO00o.f19467OooO0o0 = strOptString3;
            oooO00o.f19466OooO0o = jSONObjectOptJSONObject2.optInt("miterLimit", 0);
            JSONArray jSONArrayOptJSONArray3 = jSONObjectOptJSONObject2.optJSONArray("lineDash");
            if (jSONArrayOptJSONArray3 != null) {
                oooO00o.f19468OooO0oO = new float[jSONArrayOptJSONArray3.length()];
                int length = jSONArrayOptJSONArray3.length();
                for (int i = 0; i < length; i++) {
                    oooO00o.f19468OooO0oO[i] = (float) jSONArrayOptJSONArray3.optDouble(i, 0.0d);
                }
            }
            this.f19459OooO0OO = oooO00o;
        }
    ...
    public SVGAVideoShapeEntity(@NotNull ShapeEntity shapeEntity) {
        ...
        if (shapeStyle != null) {
            ...
            if (rGBAColor != null) {
                ...
                oooO00o.f19462OooO00o = Color.argb(i2, iFloatValue, iFloatValue2, (int) ((f14 != null ? f14.floatValue() : ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE) * f11));
            }
            ...
            if (rGBAColor2 != null) {
                ...
                oooO00o.f19463OooO0O0 = Color.argb(i3, iFloatValue3, iFloatValue4, (int) ((f19 != null ? f19.floatValue() : ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE) * f16));
            }
            Float f20 = shapeStyle.strokeWidth;
            oooO00o.f19464OooO0OO = f20 != null ? f20.floatValue() : ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
            ShapeEntity.ShapeStyle.LineCap lineCap = shapeStyle.lineCap;
            if (lineCap != null) {
                int i4 = o0O0o.$EnumSwitchMapping$1[lineCap.ordinal()];
                if (i4 == 1) {
                    oooO00o.f19465OooO0Oo = "butt";
                } else if (i4 == 2) {
                    oooO00o.f19465OooO0Oo = "round";
                } else if (i4 == 3) {
                    oooO00o.f19465OooO0Oo = "square";
                }
            }
            ...
            if (lineJoin != null) {
                ...
                if (i5 == 1) {
                    oooO00o.f19467OooO0o0 = "bevel";
                } else if (i5 == 2) {
                    oooO00o.f19467OooO0o0 = "miter";
                } else if (i5 == 3) {
                    oooO00o.f19467OooO0o0 = "round";
                }
            }
            Float f21 = shapeStyle.miterLimit;
            oooO00o.f19466OooO0o = (int) (f21 != null ? f21.floatValue() : ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE);
            oooO00o.f19468OooO0oO = new float[3];
            Float f22 = shapeStyle.lineDashI;
            if (f22 != null) {
                oooO00o.f19468OooO0oO[0] = f22.floatValue();
            }
            Float f23 = shapeStyle.lineDashII;
            if (f23 != null) {
                oooO00o.f19468OooO0oO[1] = f23.floatValue();
            }
            Float f24 = shapeStyle.lineDashIII;
            if (f24 != null) {
                oooO00o.f19468OooO0oO[2] = f24.floatValue();
            }
            this.f19459OooO0OO = oooO00o;
        }
