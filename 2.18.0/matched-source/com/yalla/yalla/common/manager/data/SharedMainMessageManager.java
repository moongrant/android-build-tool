...
public final class SharedMainMessageManager extends o00OO.OooO00o {
    ...
    static {
        p500o0o00Oo0.OooOOO.f41235OooO00o.OooOooO().observeForever(new Observer() { // from class: com.yalla.yalla.common.manager.data.o0Oo0oo
    ...
    public final LiveData<Integer> getNewFansNum() {
        if (newFansNum == null) {
            newFansNum = FlowLiveDataConversions.asLiveData$default(FlowKt.debounce(p493o0o00O00.OooO0OO.OooO00o().Oooo00O().OooO0o0(((Number) kotlin.reflect.jvm.internal.impl.types.OooO00o.OooO00o(p500o0o00Oo0.OooOOO.f41235OooO00o)).longValue()), 300L), ViewModelKt.getViewModelScope(this).getCoroutineContext(), 0L, 2, (Object) null);
        }
        return newFansNum;
    }
    ...
    public final LiveData<Integer> getNewVisitorNum() {
        if (newVisitorNum == null) {
            newVisitorNum = FlowLiveDataConversions.asLiveData$default(FlowKt.debounce(p493o0o00O00.OooO0OO.OooO00o().Oooo00O().OooO(((Number) kotlin.reflect.jvm.internal.impl.types.OooO00o.OooO00o(p500o0o00Oo0.OooOOO.f41235OooO00o)).longValue()), 300L), ViewModelKt.getViewModelScope(this).getCoroutineContext(), 0L, 2, (Object) null);
        }
    ...
    public final MediatorLiveData<Boolean> getStoreDot() {
        if (storeDot == null) {
            MediatorLiveData<Boolean> mediatorLiveData = new MediatorLiveData<>();
            mediatorLiveData.addSource(uniqueMessageDot, o000OO00.f32481OooO0OO);
            mediatorLiveData.addSource(userVehicleMessageDot, Oooo000.f20645OooO0O0);
    ...
    public final MediatorLiveData<Boolean> getUserDot() {
        if (userDot == null) {
            ...
            mediatorLiveData.addSource(haveAchievementRewardTask, o0OoOo0.f20659OooO0O0);
            ...
            mediatorLiveData.addSource(premiumMomentEditRedDot, Oooo0.f20642OooO0O0);
            ...
            mediatorLiveData.addSource(vipRedDot_ExclusiveBubble, o00O0O.f20649OooO0O0);
