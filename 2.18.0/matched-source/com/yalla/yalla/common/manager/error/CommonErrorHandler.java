...
public final class CommonErrorHandler {
    ...
    private final void sendThemeFailedNotFriend() {
        ...
        if ((contextOooO0O0 instanceof FragmentActivity ? (FragmentActivity) contextOooO0O0 : null) != null) {
            Context contextOooO0O1 = com.yalla.support.common.util.OooO0O0.f20522OooO00o.OooO0O0();
    ...
    private final synchronized void showAccountBanedDialog(String message, final boolean needToMainPage) {
        ...
        final Activity activityOooO0O0 = com.yalla.support.common.util.OooO0O0.f20522OooO00o.OooO0O0();
        if (activityOooO0O0 != null) {
            ...
            r7 r7VarInflate = r7.inflate(LayoutInflater.from(oo0ooo0.f34221OooO00o), oo0ooo0.f34223OooO0OO, false);
            Intrinsics.checkNotNullExpressionValue(r7VarInflate, "inflate(LayoutInflater.f…ontext), rootView, false)");
            oo0ooo0.OooOooO(o000O0O0.OooO0OO(R.string.common_dialog_suspension_blocked_title));
            LinearLayout linearLayout = r7VarInflate.f50452OooO00o;
            ...
            try {
                ...
                String reason = null;
                r7VarInflate.f50454OooO0OO.setText(String.valueOf((apiError1005 == null || (data3 = apiError1005.getData()) == null) ? null : Long.valueOf(data3.getPrettyId())));
                r7VarInflate.f50455OooO0Oo.setText(o000O0O0.OooO0OO(R.string.common_dialog_suspension_blocked_content));
                TextView textView = r7VarInflate.f50458OooO0oO;
                ...
                textView.setText(oo00oVar.OooO0OO(jOooO0oO, "dd/MM/yyyy HH:mm:ss"));
                TextView textView2 = r7VarInflate.f50457OooO0o0;
                ...
                r7VarInflate.f50456OooO0o.setText(spannableString);
                r7VarInflate.f50456OooO0o.setOnClickListener(new View.OnClickListener() { // from class: com.yalla.yalla.common.manager.error.OooO0O0
                ...
                r7VarInflate.f50453OooO0O0.setOnClickListener(new View.OnClickListener() { // from class: com.yalla.yalla.common.manager.error.OooO00o
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
    ...
    public static final void m285showAccountBanedDialog$lambda6$lambda5$lambda3(boolean z, Activity activity, oo0oOO0 this_apply, ApiError1005 apiError1005, View view) {
        ...
        if (fragmentActivity != null) {
            ...
            new oOo0oooO(fragmentActivity, prettyId, userId).OooOO0();
        }
    }
    ...
    private final void showCreateRoomDialog() {
        ...
        if (fragmentActivity != null) {
            ...
            oo0ooo0.OooOo0o(new Function0<Unit>() { // from class: com.yalla.yalla.common.manager.error.CommonErrorHandler$showCreateRoomDialog$1$1$1
                ...
                /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    CreateRoomActivity.f22793o00O0O.OooO00o(fragmentActivity);
                }
            });
            oo0oOO0.OooOoo0(oo0ooo0, false, 1, null);
            oo0ooo0.OooOOO0();
        ...
        if (fragmentActivity != null) {
            ...
            oo0ooo0.OooOo0o(new Function0<Unit>() { // from class: com.yalla.yalla.common.manager.error.CommonErrorHandler$showCrystalNotEnoughDialog$1$1$1
                ...
                public final void invoke2() {
                    ...
                    TaskActivity.f22080o00ooo.OooO00o(fragmentActivity);
                }
            });
            ...
            Lazy lazy = LazyKt.lazy(o000O.f42997Oooo);
            ((List) lazy.getValue()).add(listener);
            oo0ooo0.OooOO0O(new p524o0o0O0o.o000O0O0(lazy));
            oo0ooo0.OooOOO0();
        }
    }
    ...
    private final void showLoginOtherDeviceDialog(String message) {
        ...
        if (outDialogShowing || (activityOooO0O0 = com.yalla.support.common.util.OooO0O0.f20522OooO00o.OooO0O0()) == null || !(activityOooO0O0 instanceof FragmentActivity)) {
            return;
        }
        boolean z = true;
        outDialogShowing = true;
