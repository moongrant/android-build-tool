...
public final class ShareLogViewModel extends o00OO.OooO00o {
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public int f21355Oooo;

        /* JADX INFO: renamed from: OoooO0, reason: collision with root package name */
        public final /* synthetic */ ShareLogType f21356OoooO0;

        /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
        public final /* synthetic */ String f21357OoooO00;
        ...
        public OooO0O0(String str, ShareLogType shareLogType, Continuation<? super OooO0O0> continuation) {
            super(2, continuation);
            this.f21357OoooO00 = str;
            this.f21356OoooO0 = shareLogType;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0O0(this.f21357OoooO00, this.f21356OoooO0, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            String str = this.f21357OoooO00;
            ShareLogType shareLogType = this.f21356OoooO0;
            this.f21355Oooo = 1;
            o000000 o000000Var = o000000.f40925OooO00o;
            String url = o000000.f40927OooO0OO;
            Intrinsics.checkNotNullParameter(url, "url");
            o00O000 o00o001 = new o00O000(url, 1);
            o00o001.OooO0O0("eventId", str);
            o00o001.OooO0O0("shareType", OooO.OooO0oo(Boxing.boxInt(shareLogType.getValue()), ""));
            o00o001.OooO0O0("shareDevice", Boxing.boxInt(2));
            obj = o0000O0.OooO0OO(new ShareLogRepository$shareEventLog$$inlined$call$1(o00o001, null), this);
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
        public int f21359Oooo;

        /* JADX INFO: renamed from: OoooO0, reason: collision with root package name */
        public final /* synthetic */ ShareLogType f21360OoooO0;

        /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
        public final /* synthetic */ String f21361OoooO00;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(String str, ShareLogType shareLogType, Continuation<? super OooO0OO> continuation) {
            super(2, continuation);
            this.f21361OoooO00 = str;
            this.f21360OoooO0 = shareLogType;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0OO(this.f21361OoooO00, this.f21360OoooO0, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f21359Oooo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                String str = this.f21361OoooO00;
                ShareLogType shareLogType = this.f21360OoooO0;
                this.f21359Oooo = 1;
                o000000 o000000Var = o000000.f40925OooO00o;
                String url = o000000.f40926OooO0O0;
                Intrinsics.checkNotNullParameter(url, "url");
                o00O000 o00o001 = new o00O000(url, 0);
                o00o001.OooO0O0("barid", str);
                o00o001.OooO0O0("type", OooO.OooO0oo(Boxing.boxInt(shareLogType.getValue()), ""));
                obj = o0000O0.OooO0OO(new ShareLogRepository$shareRoomLog$$inlined$call$1(o00o001, null), this);
                if (obj == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
