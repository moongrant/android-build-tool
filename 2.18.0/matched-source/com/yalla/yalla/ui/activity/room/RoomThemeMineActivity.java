...
public final class RoomThemeMineActivity extends BaseActivityK {
    ...
    @NotNull
    public static final OooO00o f23012Ooooooo = new OooO00o();

    /* JADX INFO: renamed from: OooooO0, reason: collision with root package name */
    @NotNull
    public final o00O000o f23013OooooO0 = new o00O000o(Reflection.getOrCreateKotlinClass(ue.class), this, null);

    /* JADX INFO: renamed from: OooooOO, reason: collision with root package name */
    @Nullable
    public ThemeType f23014OooooOO;

    /* JADX INFO: renamed from: OooooOo, reason: collision with root package name */
    @Nullable
    public Fragment f23015OooooOo;

    /* JADX INFO: renamed from: Oooooo, reason: collision with root package name */
    @Nullable
    public RoomThemeCustomizeFragment f23016Oooooo;

    /* JADX INFO: renamed from: Oooooo0, reason: collision with root package name */
    @Nullable
    public RoomThemeMineFragment f23017Oooooo0;

    /* JADX INFO: renamed from: OoooooO, reason: collision with root package name */
    @Nullable
    public ThemeType f23018OoooooO;
    ...
    public final void OooOoo(ThemeType themeType) {
        if (this.f23014OooooOO == themeType) {
            return;
        }
        int i = OooO0O0.$EnumSwitchMapping$0[themeType.ordinal()];
        int i2 = R.drawable.shape_whit_radius25_right;
        if (i == 1) {
            OooOooO().f50751OooO0Oo.setBackgroundResource(0);
            OooOooO().f50751OooO0Oo.setTextColor(o000O0O0.OooO00o(R.color.white));
            OooOooO().f50752OooO0o0.setTextColor(o000O0O0.OooO00o(R.color.color_00d8c9));
            TextView textView = OooOooO().f50752OooO0o0;
            if (!oo000o.OooO0o0()) {
        ...
        OooOooO().f50752OooO0o0.setBackgroundResource(0);
        OooOooO().f50752OooO0o0.setTextColor(o000O0O0.OooO00o(R.color.white));
        OooOooO().f50751OooO0Oo.setTextColor(o000O0O0.OooO00o(R.color.color_00d8c9));
        TextView textView2 = OooOooO().f50751OooO0Oo;
        if (oo000o.OooO0o0()) {
            i2 = R.drawable.shape_whit_radius25_left;
        }
    ...
    public final ue OooOooO() {
        return (ue) this.f23013OooooO0.getValue();
    }
    ...
    public final void OooOooo(ThemeType themeType) {
        ...
        Fragment fragment = this.f23015OooooOo;
        if (fragment != null) {
            o0000Ooo.OooO0O0(oooO00o, fragment);
        }
        int i = OooO0O0.$EnumSwitchMapping$0[themeType.ordinal()];
        if (i == 1) {
            RoomThemeMineFragment roomThemeMineFragment = this.f23017Oooooo0;
            if (roomThemeMineFragment == null) {
                this.f23017Oooooo0 = new RoomThemeMineFragment();
                int id = OooOooO().f50749OooO0O0.getId();
                RoomThemeMineFragment roomThemeMineFragment2 = this.f23017Oooooo0;
            ...
            this.f23015OooooOo = this.f23017Oooooo0;
        } else {
            if (i != 2) {
                throw new NoWhenBranchMatchedException();
            }
            RoomThemeCustomizeFragment roomThemeCustomizeFragment = this.f23016Oooooo;
            if (roomThemeCustomizeFragment == null) {
                this.f23016Oooooo = new RoomThemeCustomizeFragment();
                int id2 = OooOooO().f50749OooO0O0.getId();
                RoomThemeCustomizeFragment roomThemeCustomizeFragment2 = this.f23016Oooooo;
            ...
            this.f23015OooooOo = this.f23016Oooooo;
        }
        this.f23014OooooOO = themeType;
        oooO00o.OooO0oO();
    }
    ...
    public void onClickNotDouble(@NotNull View view) {
        ...
        if (Intrinsics.areEqual(view, OooOooO().f50752OooO0o0)) {
            ThemeType themeType = ThemeType.Mine;
            OooOoo(themeType);
            OooOooo(themeType);
        } else if (Intrinsics.areEqual(view, OooOooO().f50751OooO0Oo)) {
            ThemeType themeType2 = ThemeType.Customize;
            OooOoo(themeType2);
            OooOooo(themeType2);
        } else if (Intrinsics.areEqual(view, OooOooO().f50750OooO0OO)) {
            o0O00000.OooO0OO("Me_store_CreateTheme");
            o000O.OooO00o(oO0000O.f47725OooO00o, null);
        }
    }
    ...
    public final void onCreate(@Nullable Bundle bundle) {
        ...
        setContentView(OooOooO().f50748OooO00o);
        OooOooO().f50752OooO0o0.setOnClickListener(this);
        OooOooO().f50751OooO0Oo.setOnClickListener(this);
        OooOooO().f50750OooO0OO.setOnClickListener(this);
