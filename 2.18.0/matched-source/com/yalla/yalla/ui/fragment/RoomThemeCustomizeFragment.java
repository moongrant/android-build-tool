...
import p600o0oo00O.oO0000O;
import p618o0oo0Ooo.oO0O000o;
import p651o0ooOOoo.cg;

/* JADX INFO: loaded from: classes3.dex */
@StabilityInferred(parameters = 0)
@Metadata(bv = {}, d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0007\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007¢\u0006\u0004\b\u0016\u0010\u0017J\b\u0010\u0004\u001a\u00020\u0003H\u0002J\b\u0010\u0005\u001a\u00020\u0003H\u0002J\u001a\u0010\n\u001a\u00020\u00022\u0006\u0010\u0007\u001a\u00020\u00062\b\u0010\t\u001a\u0004\u0018\u00010\bH\u0016J\b\u0010\u000b\u001a\u00020\u0003H\u0014R\u001b\u0010\u0011\u001a\u00020\f8BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\r\u0010\u000e\u001a\u0004\b\u000f\u0010\u0010R\u0016\u0010\u0015\u001a\u0004\u0018\u00010\u00128BX\u0082\u0004¢\u0006\u0006\u001a\u0004\b\u0013\u0010\u0014¨\u0006\u0018"}, d2 = {"Lcom/yalla/yalla/ui/fragment/RoomThemeCustomizeFragment;", "Lo0o00o00/OooO;", "Lo0ooOOoo/cg;", "", "initView", "loadData", "Landroid/view/LayoutInflater;", "inflater", "Landroid/view/ViewGroup;", "container", "getViewBinding", "onLazyInit", "Lcom/yalla/yalla/ui/vm/store/ThemeStoreVM;", "storeVm$delegate", "Lkotlin/Lazy;", "getStoreVm", "()Lcom/yalla/yalla/ui/vm/store/ThemeStoreVM;", "storeVm", "Lcom/yalla/yalla/ui/activity/room/RoomThemeMineActivity;", "getActivity", "()Lcom/yalla/yalla/ui/activity/room/RoomThemeMineActivity;", "activity", "<init>", "()V", "app_YallaRelease"}, k = 1, mv = {1, 7, 1})
public final class RoomThemeCustomizeFragment extends p505o0o00o00.OooO<cg> {
    public static final int $stable = 8;

    @Nullable
    private p189o00o00o0.OooO0OO<CustomizeThemeModel> mAdapter;
    ...
    public static final class OooO extends Lambda implements Function1<String, Unit> {
        ...
        public final Unit invoke(String str) {
            ...
            if ((activity != null ? activity.f23018OoooooO : null) == RoomThemeMineActivity.ThemeType.Customize) {
    ...
    public static final class OooO00o extends p189o00o00o0.OooO0OO<CustomizeThemeModel> {
        ...
        public final void convert(com.chad.library.adapter.base.OooO00o oooO00o, Object obj) {
            ...
            oooO00o2.f48447OooO0OO = CloudImageUtilKt.imgSize(customizeThemeModel.getPic(), com.yalla.support.common.util.OooOo00.OooO00o(165), com.yalla.support.common.util.OooOo00.OooO00o(260));
            oooO00o2.f48445OooO00o = 0;
            oooO00o2.f48472OooOoo0 = 2;
            oooO00o2.f48462OooOOoo = 3;
            oooO00o2.f48459OooOOOo = R.drawable.icon_room_theme_placeholder;
            oooO00o2.OooO0oO(8);
            oooO00o2.OooO0o((ImageView) oooO0o.OooO0Oo(R.id.ivTheme));
            if (customizeThemeModel.getIsFrozen()) {
                strOooO0OO = p255o00ooO0O.o000O0O0.OooO0OO(R.string.room_theme_customize_frozen_unfreeze);
            } else {
                strOooO0OO = customizeThemeModel.getIsExpired() ? p255o00ooO0O.o000O0O0.OooO0OO(R.string.room_theme_customize_purchase_again) : p255o00ooO0O.o000O0O0.OooO0OO(R.string.room_theme_customize_renewals);
            }
            ...
            if (customizeThemeModel.getIsExpired()) {
                ...
                oooO0o.OooOO0(R.id.tvRemain, com.yalla.support.common.util.OooOo.OooO00o(p255o00ooO0O.o000O0O0.OooO0OO(R.string.room_theme_customize_invalid_days), String.valueOf(customizeThemeModel.getInvalidDay())));
            } else {
                if (customizeThemeModel.getCurrState() == 0) {
                    oooO0o.OooO0oO(R.id.tvRenewals, false);
                    oooO0o.OooOO0(R.id.tvRemain, p255o00ooO0O.o000O0O0.OooO0OO(R.string.room_theme_customize_under_review));
                } else {
                    oooO0o.OooO0oO(R.id.tvRenewals, true);
                    String strOooO0OO2 = p255o00ooO0O.o000O0O0.OooO0OO(R.string.days_remained);
                ...
                if (customizeThemeModel.getIsSelected() && (activity = RoomThemeCustomizeFragment.this.getActivity()) != null) {
                    activity.f23018OoooooO = RoomThemeMineActivity.ThemeType.Customize;
                }
            }
    ...
    public static final class OooO0O0 extends p656o0ooo.o00Oo0 {
        public OooO0O0() {
        }
    ...
    public static final class OooO0OO extends Lambda implements Function0<Unit> {
        ...
        public final /* synthetic */ oo0oOO0 f24216Oooo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(oo0oOO0 oo0ooo0) {
            super(0);
            this.f24216Oooo = oo0ooo0;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            PremiumActivity.f23379o0Oo0oo.OooO00o(this.f24216Oooo.f34221OooO00o, PremiumLevel.Premium1);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0o extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
        public final /* synthetic */ oo0oOO0 f24217Oooo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(oo0oOO0 oo0ooo0) {
            super(0);
            this.f24217Oooo = oo0ooo0;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            VipActivity.OooO0O0 oooO0O0 = VipActivity.f23589OoooOoo;
            VipActivity.f23589OoooOoo.OooO00o(this.f24217Oooo.f34221OooO00o, VipLevel.Vip0);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0O extends Lambda implements Function0<Unit> {
        ...
        public final /* synthetic */ CustomizeThemeModel f24220OoooO00;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0O(CustomizeThemeModel customizeThemeModel) {
            super(0);
            this.f24220OoooO00 = customizeThemeModel;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            LiveData<ApiResult<RenewCustomizeTheme>> liveDataRenewCustomTheme = RoomThemeCustomizeFragment.this.getStoreVm().renewCustomTheme(this.f24220OoooO00.getId(), this.f24220OoooO00.getThemeType());
    ...
    public static final class OooOOO extends Lambda implements Function1<ApiError, Unit> {
        ...
        public final Unit invoke(ApiError apiError) {
            ApiError it = apiError;
            Intrinsics.checkNotNullParameter(it, "it");
            p189o00o00o0.OooO0OO oooO0OO = RoomThemeCustomizeFragment.this.mAdapter;
            if (oooO0OO != null) {
                oooO0OO.loadError();
            }
            return Unit.INSTANCE;
    ...
    public static final class OooOOO0 extends Lambda implements Function1<List<CustomizeThemeModel>, Unit> {
        ...
        public final Unit invoke(List<CustomizeThemeModel> list) {
            ...
            p189o00o00o0.OooO0OO oooO0OO2 = RoomThemeCustomizeFragment.this.mAdapter;
            if (oooO0OO2 != null) {
    ...
    public RoomThemeCustomizeFragment() {
        ...
        this.storeVm = androidx.fragment.app.o0000OO0.OooO0O0(this, Reflection.getOrCreateKotlinClass(ThemeStoreVM.class), new Function0<ViewModelStore>() { // from class: com.yalla.yalla.ui.fragment.RoomThemeCustomizeFragment$special$$inlined$viewModels$default$3
            {
                super(0);
            }
            ...
            /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
            public final /* synthetic */ Function0 f24227Oooo = null;
            ...
            public final CreationExtras invoke() {
                ...
                Function0 function1 = this.f24227Oooo;
    ...
    private final void initView() {
        LiveEventBus.get("ROOM_THEME_UPDATE").observe(this, new oO0000o0(this, 3));
        OooO00o oooO00o = new OooO00o(getContext());
        this.mAdapter = oooO00o;
        oooO00o.setLoadErrorClickListener(new OooO0O0());
        p189o00o00o0.OooO0OO<CustomizeThemeModel> oooO0OO = this.mAdapter;
        if (oooO0OO != null) {
            oooO0OO.setOnItemChildClickListener(new BaseQuickAdapter.OooOOO0() { // from class: o0oOoOoO.c3
                ...
                public final void OooO0oo(BaseQuickAdapter baseQuickAdapter, View view, int i) {
                    RoomThemeCustomizeFragment.m396initView$lambda3(this.f46861Oooo, baseQuickAdapter, view, i);
                }
            });
        }
        p189o00o00o0.OooO0OO<CustomizeThemeModel> oooO0OO2 = this.mAdapter;
        if (oooO0OO2 != null) {
            oooO0OO2.setEmptyImageRes(R.drawable.ic_empty_message_system);
        }
        p189o00o00o0.OooO0OO<CustomizeThemeModel> oooO0OO3 = this.mAdapter;
        if (oooO0OO3 != null) {
            oooO0OO3.setEmptyText(R.string.room_theme_customize_no_data);
        }
        getBinding().f49132OooO0O0.setLayoutManager(new GridLayoutManager(getContext(), 2));
        getBinding().f49132OooO0O0.setAdapter(this.mAdapter);
    }
    ...
    public static final void m396initView$lambda3(RoomThemeCustomizeFragment this$0, BaseQuickAdapter baseQuickAdapter, View view, int i) {
        ...
        boolean z = true;
        if (customizeThemeModel.getIsFrozen()) {
            Context context = this$0.getBinding().f49132OooO0O0.getContext();
            Intrinsics.checkNotNullExpressionValue(context, "binding.rvThemeLayout.context");
            oo0oOO0 oo0ooo0 = new oo0oOO0(context);
            oo0ooo0.OooOo0O(p255o00ooO0O.o000O0O0.OooO0OO(R.string.room_theme_customize_new_unfrozen_content));
            oo0ooo0.OooOooo();
            oo0ooo0.OooOooO(p255o00ooO0O.o000O0O0.OooO0OO(R.string.title_RoomMember_Tips));
            oo0ooo0.OooOoOO(true);
            oo0ooo0.OooOOo0(p255o00ooO0O.o000O0O0.OooO0OO(R.string.Get_Yalla_Premium));
            oo0ooo0.OooOoO0(p255o00ooO0O.o000O0O0.OooO0OO(R.string.Get_Vip));
            TextButtonStyle buttonStyle = TextButtonStyle.OutLined;
            Intrinsics.checkNotNullParameter(buttonStyle, "buttonStyle");
            TextView textView = oo0ooo0.OooOOO().f34420OooO0Oo;
            Intrinsics.checkNotNullExpressionValue(textView, "dialogBinding.tvConfirm");
            oo0ooo0.OooOOOO(textView, buttonStyle);
            Intrinsics.checkNotNullParameter(buttonStyle, "buttonStyle");
            TextView textView2 = oo0ooo0.OooOOO().f34421OooO0o;
        ...
        if (customizeThemeModel.getCurrState() == 0) {
            String strOooO0OO = p255o00ooO0O.o000O0O0.OooO0OO(R.string.room_theme_customize_toast_under_review);
        ...
        if (view.getId() == R.id.tvRenewals) {
            if (customizeThemeModel.getIsExpired()) {
                o000O.OooO00o(oO0000O.f47725OooO00o, o000O00O.OooO0OO.OooO0O0(TuplesKt.to("preThemeThemeId", Long.valueOf(customizeThemeModel.getId())), TuplesKt.to("preThemePicUrl", customizeThemeModel.getPic()), TuplesKt.to("preThemeThemeType", Integer.valueOf(customizeThemeModel.getThemeType()))));
                return;
            }
            o0O00000.OooO0OO("Me_store_CreateTheme_renew");
            Context context2 = this$0.getBinding().f49132OooO0O0.getContext();
            Intrinsics.checkNotNullExpressionValue(context2, "binding.rvThemeLayout.context");
            oo0oOO0 oo0ooo1 = new oo0oOO0(context2);
            oo0ooo1.OooOo0O(com.yalla.support.common.util.OooOo.OooO00o(p255o00ooO0O.o000O0O0.OooO0OO(R.string.room_theme_customize_new_renewals_content), String.valueOf(customizeThemeModel.getRenewPrice()), RoomThemeCustomizeVM.INSTANCE.OooO00o(customizeThemeModel.getThemeType())));
            oo0ooo1.OooOoOO(true);
            oo0ooo1.OooOOo0(p255o00ooO0O.o000O0O0.OooO0OO(R.string.room_dialog_theme_customize_renewals));
