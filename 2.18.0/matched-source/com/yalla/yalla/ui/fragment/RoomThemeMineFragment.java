...
public final class RoomThemeMineFragment extends p505o0o00o00.OooO<dg> {
    ...
    public static final class OooO00o extends p189o00o00o0.OooO0OO<ThemeModel> {
        ...
        public final void convert(com.chad.library.adapter.base.OooO00o oooO00o, Object obj) {
            ...
            activity.f23018OoooooO = RoomThemeMineActivity.ThemeType.Mine;
        }
    }
    ...
    public static final class OooO0OO extends Lambda implements Function1<MyThemeListModel, Unit> {
        ...
        public final Unit invoke(MyThemeListModel myThemeListModel) {
            ...
            p189o00o00o0.OooO0OO oooO0OO2 = RoomThemeMineFragment.this.mAdapter;
            if (oooO0OO2 != null) {
                RoomThemeMineFragment roomThemeMineFragment = RoomThemeMineFragment.this;
    ...
    public static final class OooO0o extends Lambda implements Function1<ApiError, Unit> {
        ...
        public final Unit invoke(ApiError apiError) {
            ...
            p189o00o00o0.OooO0OO oooO0OO = RoomThemeMineFragment.this.mAdapter;
            if (oooO0OO != null) {
                oooO0OO.loadError();
            }
            return Unit.INSTANCE;
    ...
    public RoomThemeMineFragment() {
        ...
        this.storeVm = androidx.fragment.app.o0000OO0.OooO0O0(this, Reflection.getOrCreateKotlinClass(ThemeStoreVM.class), new Function0<ViewModelStore>() { // from class: com.yalla.yalla.ui.fragment.RoomThemeMineFragment$special$$inlined$viewModels$default$3
            {
                super(0);
            }
            ...
            public final /* synthetic */ Function0 f24238Oooo = null;
            ...
            public final CreationExtras invoke() {
                ...
                Function0 function1 = this.f24238Oooo;
    ...
    private final void initView() {
        LiveEventBus.get("ROOM_THEME_UPDATE").observe(this, new oO00o00O(this, 7));
        ...
        getBinding().f49212OooO0O0.setLayoutManager(new GridLayoutManager(getContext(), 2));
        getBinding().f49212OooO0O0.setAdapter(this.mAdapter);
    }
    ...
    public final void loadData() {
        Integer value = o00OO0O0.f43338OooooOo.OooO00o().f43346OooO0o0.getValue();
        if (value == null) {
            return;
        }
