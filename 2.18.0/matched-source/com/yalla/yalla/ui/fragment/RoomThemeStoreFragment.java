...
public final class RoomThemeStoreFragment extends p505o0o00o00.OooO<eg> {
    ...
    @Nullable
    private p189o00o00o0.OooO0OO<ThemeModel> mAdapter;
    ...
    @Nullable
    private b1 themePreviewDialog;
    private boolean themePreviewDialogIsShowing;
    private int themeTypeId;

    public static final class OooO extends p656o0ooo.o00Oo0 {
        public OooO() {
        }
    ...
    public static final class OooO0O0 extends Lambda implements Function1<List<ThemeModel>, Unit> {
        ...
        public final Unit invoke(List<ThemeModel> list) {
            ...
            p189o00o00o0.OooO0OO oooO0OO = RoomThemeStoreFragment.this.mAdapter;
            if (oooO0OO != null) {
                oooO0OO.setNewData(list2);
            }
            p189o00o00o0.OooO0OO oooO0OO2 = RoomThemeStoreFragment.this.mAdapter;
            if (oooO0OO2 != null) {
    ...
    public static final class OooO0o extends p189o00o00o0.OooO0OO<ThemeModel> {
        ...
        public final void convert(com.chad.library.adapter.base.OooO00o oooO00o, Object obj) {
            String str;
            p189o00o00o0.OooO0o oooO0o = (p189o00o00o0.OooO0o) oooO00o;
            ...
            LinearLayout linearLayout = themeLayout.f25235Oooo.f50657OooOO0;
            ...
            TextView textView = themeLayout.f25235Oooo.f50665OooOOo0;
            ...
            if (item.getIsHave() != 1) {
                if (item.getThemeTagType() != 1 && item.getThemeTagType() != 3) {
                    LinearLayout linearLayout2 = themeLayout.f25235Oooo.f50657OooOO0;
                ...
                if (item.getTimeLong() < 0) {
                    if (item.getPrice() > item.getPromotionPrice()) {
                        TextView textView2 = themeLayout.f25235Oooo.f50665OooOOo0;
                        Intrinsics.checkNotNullExpressionValue(textView2, "binding.tvThemePrice");
                        com.yalla.support.common.util.o00O0O.OooO(textView2);
                        themeLayout.f25235Oooo.f50665OooOOo0.setText(String.valueOf(item.getPrice()));
                        themeLayout.f25235Oooo.f50665OooOOo0.getPaint().setFlags(17);
                    }
                    themeLayout.f25235Oooo.f50662OooOOOO.setText(String.valueOf(item.getPromotionPrice()));
                } else if (item.getPromotionPrice() <= 0) {
                    ImageView imageView = themeLayout.f25235Oooo.f50652OooO0Oo;
                    Intrinsics.checkNotNullExpressionValue(imageView, "binding.ivCoin");
                    com.yalla.support.common.util.o00O0O.OooO00o(imageView);
                    themeLayout.f25235Oooo.f50662OooOOOO.setText(com.yalla.support.common.util.OooOOO.OooO0OO(R.string.Free) + '/' + item.getTimeLong() + ' ' + com.yalla.support.common.util.OooOOO.OooO0OO(DateNumeralUtils.OooO00o(item.getTimeLong(), DateNumeralUtils.DateType.d)));
                } else {
                    ImageView imageView2 = themeLayout.f25235Oooo.f50652OooO0Oo;
                    ...
                    if (item.getPrice() > item.getPromotionPrice()) {
                        TextView textView3 = themeLayout.f25235Oooo.f50665OooOOo0;
                        Intrinsics.checkNotNullExpressionValue(textView3, "binding.tvThemePrice");
                        com.yalla.support.common.util.o00O0O.OooO(textView3);
                        themeLayout.f25235Oooo.f50665OooOOo0.setText(String.valueOf(item.getPrice()));
                        themeLayout.f25235Oooo.f50665OooOOo0.getPaint().setFlags(16);
                    }
                    themeLayout.f25235Oooo.f50662OooOOOO.setText(str);
                }
            }
            themeLayout.f25235Oooo.f50656OooO0oo.setOnClickListener(new p504o0o00o0.o000(o000o0oo2, 2));
        }
    }
    ...
    public static final class OooOO0 extends Lambda implements Function0<Unit> {
        ...
        public final /* synthetic */ ThemeModel f24246Oooo;

        /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
        public final /* synthetic */ oo0oOO0 f24247OoooO00;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0(ThemeModel themeModel, oo0oOO0 oo0ooo0) {
            super(0);
            this.f24246Oooo = themeModel;
            this.f24247OoooO00 = oo0ooo0;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            p608o0oo0O.OooOo.OooO0OO("102015", MapsKt.mapOf(new Pair("shopid", Long.valueOf(this.f24246Oooo.getShopId()))));
            WebPageInfo webPageInfo = new WebPageInfo(WebFrom.Unknow);
            webPageInfo.OooO0Oo(this.f24246Oooo.getH5Url());
            WebActivity.f22127ooOO.OooO00o(this.f24247OoooO00.f34221OooO00o, webPageInfo);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0O extends Lambda implements Function0<Unit> {
        ...
        public final /* synthetic */ oo0oOO0 f24249OoooO0;

        /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
        public final /* synthetic */ ThemeModel f24250OoooO00;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0O(ThemeModel themeModel, oo0oOO0 oo0ooo0) {
            super(0);
            this.f24250OoooO00 = themeModel;
            this.f24249OoooO0 = oo0ooo0;
        }
        ...
        public final Unit invoke() {
            ...
            LiveData<ApiResult<ThemeBoughtModel>> liveDataGoBuyTheme = RoomThemeStoreFragment.this.getStoreVm().goBuyTheme(this.f24250OoooO00.getShopId());
            RoomThemeStoreFragment roomThemeStoreFragment = RoomThemeStoreFragment.this;
            liveDataGoBuyTheme.observe(roomThemeStoreFragment, new o0o0000.OooOo(new o000OO0O(roomThemeStoreFragment, this.f24249OoooO0), null, new o000O0O0(RoomThemeStoreFragment.this), false, 10));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOOO extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
        public final /* synthetic */ ThemeModel f24251Oooo;

        /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
        public final /* synthetic */ oo0oOO0 f24252OoooO00;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO(ThemeModel themeModel, oo0oOO0 oo0ooo0) {
            super(0);
            this.f24251Oooo = themeModel;
            this.f24252OoooO00 = oo0ooo0;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            p608o0oo0O.OooOo.OooO0OO("102015", MapsKt.mapOf(new Pair("shopid", Long.valueOf(this.f24251Oooo.getShopId()))));
            WebPageInfo webPageInfo = new WebPageInfo(WebFrom.Unknow);
            webPageInfo.OooO0Oo(this.f24251Oooo.getH5Url());
            WebActivity.f22127ooOO.OooO00o(this.f24252OoooO00.f34221OooO00o, webPageInfo);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOOO0 extends Lambda implements Function0<Unit> {
        ...
        public final Unit invoke() {
            ...
            Context context = RoomThemeStoreFragment.this.getBinding().f49338OooO0O0.getContext();
    ...
    public static final class OooOOOO extends Lambda implements Function1<Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
        public final /* synthetic */ ThemeModel f24255OoooO00;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOOO(ThemeModel themeModel) {
            super(1);
            this.f24255OoooO00 = themeModel;
        }
        ...
        public final Unit invoke(Integer num) {
            ...
            ThemeModel themeModel = this.f24255OoooO00;
    ...
    public RoomThemeStoreFragment() {
        ...
        this.storeVm = androidx.fragment.app.o0000OO0.OooO0O0(this, Reflection.getOrCreateKotlinClass(ThemeStoreVM.class), new Function0<ViewModelStore>() { // from class: com.yalla.yalla.ui.fragment.RoomThemeStoreFragment$special$$inlined$viewModels$default$3
            {
                super(0);
            }
            ...
            /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
            public final /* synthetic */ Function0 f24263Oooo = null;
            ...
            public final CreationExtras invoke() {
                ...
                Function0 function1 = this.f24263Oooo;
        ...
        this.isHasRoom = p500o0o00Oo0.OooOOO.f41270Oooo0OO.getValue() != null;
    }

    private final String getActivePurchaseContent(ThemeModel model) {
        String strOooO00o;
        if (model.getTimeLong() < 0) {
            return com.yalla.support.common.util.OooOo.OooO00o(p169o00Ooo0.oo000o.OooO0O0() == 7 ? com.yalla.support.common.util.OooOo.OooO00o(com.yalla.support.common.util.OooOo.OooO00o(p255o00ooO0O.o000O0O0.OooO0OO(R.string.Confirm_to_pay_XXX_golds_to_buy_XXX_for_activity_permanently), model.getName()), String.valueOf(model.getPromotionPrice())) : com.yalla.support.common.util.OooOo.OooO00o(com.yalla.support.common.util.OooOo.OooO00o(p255o00ooO0O.o000O0O0.OooO0OO(R.string.Confirm_to_pay_XXX_golds_to_buy_XXX_for_activity_permanently), String.valueOf(model.getPromotionPrice())), model.getName()), model.getThemeTag());
        }
        if (model.getPromotionPrice() <= 0) {
            strOooO00o = (p169o00Ooo0.oo000o.OooO0O0() == 7 || p169o00Ooo0.oo000o.OooO0O0() == 2 || p169o00Ooo0.oo000o.OooO0O0() == 8) ? com.yalla.support.common.util.OooOo.OooO00o(com.yalla.support.common.util.OooOo.OooO00o(p255o00ooO0O.o000O0O0.OooO0OO(R.string.Confirm_to_claim_XXX__for_activity_XXX_days), String.valueOf(model.getTimeLong())), model.getName()) : com.yalla.support.common.util.OooOo.OooO00o(com.yalla.support.common.util.OooOo.OooO00o(p255o00ooO0O.o000O0O0.OooO0OO(R.string.Confirm_to_claim_XXX__for_activity_XXX_days), model.getName()), String.valueOf(model.getTimeLong()));
        } else if (p169o00Ooo0.oo000o.OooO0O0() == 7) {
            strOooO00o = com.yalla.support.common.util.OooOo.OooO00o(com.yalla.support.common.util.OooOo.OooO00o(com.yalla.support.common.util.OooOo.OooO00o(p255o00ooO0O.o000O0O0.OooO0OO(R.string.Confirm_to_pay_XXX_golds_to_buy_XXX_for_activity_XXX_days), String.valueOf(model.getTimeLong())), model.getName()), String.valueOf(model.getPromotionPrice()));
        } else {
            strOooO00o = p169o00Ooo0.oo000o.OooO0O0() == 8 ? com.yalla.support.common.util.OooOo.OooO00o(com.yalla.support.common.util.OooOo.OooO00o(com.yalla.support.common.util.OooOo.OooO00o(p255o00ooO0O.o000O0O0.OooO0OO(R.string.Confirm_to_pay_XXX_golds_to_buy_XXX_for_activity_XXX_days), String.valueOf(model.getPromotionPrice())), String.valueOf(model.getTimeLong())), model.getName()) : com.yalla.support.common.util.OooOo.OooO00o(com.yalla.support.common.util.OooOo.OooO00o(com.yalla.support.common.util.OooOo.OooO00o(p255o00ooO0O.o000O0O0.OooO0OO(R.string.Confirm_to_pay_XXX_golds_to_buy_XXX_for_activity_XXX_days), String.valueOf(model.getPromotionPrice())), model.getName()), String.valueOf(model.getTimeLong()));
        }
    ...
    private final String getSimplePurchaseContent(ThemeModel model) {
        if (model.getTimeLong() < 0) {
            return com.yalla.support.common.util.OooOo.OooO00o(com.yalla.support.common.util.OooOo.OooO00o(p255o00ooO0O.o000O0O0.OooO0OO(R.string.Confirm_to_pay_XXX_golds_to_buy_XXX_permanently), String.valueOf(model.getPromotionPrice())), model.getName());
        }
        return model.getPromotionPrice() <= 0 ? com.yalla.support.common.util.OooOo.OooO00o(com.yalla.support.common.util.OooOo.OooO00o(p255o00ooO0O.o000O0O0.OooO0OO(R.string.Confirm_to_claim_XXX_for_XXX_days), model.getName()), String.valueOf(model.getTimeLong())) : com.yalla.support.common.util.OooOo.OooO00o(com.yalla.support.common.util.OooOo.OooO00o(com.yalla.support.common.util.OooOo.OooO00o(p255o00ooO0O.o000O0O0.OooO0OO(R.string.Confirm_to_pay_XXX_golds_to_buy_XXX_for_XXX_days), String.valueOf(model.getPromotionPrice())), model.getName()), String.valueOf(model.getTimeLong()));
    }
    ...
    public final void initData() {
        ...
        p189o00o00o0.OooO0OO<ThemeModel> oooO0OO = this.mAdapter;
        if (oooO0OO != null) {
            oooO0OO.loadError();
        }
    }
    ...
    private final void initView() {
        OooO0o oooO0o = new OooO0o(getBinding().f49338OooO0O0.getContext());
        ...
        p189o00o00o0.OooO0OO<ThemeModel> oooO0OO2 = this.mAdapter;
        if (oooO0OO2 != null) {
            oooO0OO2.setLoadErrorClickListener(new OooO());
        }
        getBinding().f49338OooO0O0.setLayoutManager(new GridLayoutManager(getBinding().f49338OooO0O0.getContext(), 2));
        getBinding().f49338OooO0O0.setAdapter(this.mAdapter);
    }
    ...
    private final void showBuyConfirmDialog(String content, ThemeModel item) {
        ...
        String strOooO0OO = p255o00ooO0O.o000O0O0.OooO0OO(R.string.OK);
        if (item.getThemeTagType() == 2 && (!StringsKt.isBlank(item.getH5Url()))) {
            strOooO0OO = p255o00ooO0O.o000O0O0.OooO0OO(R.string.Purchase);
            oo0ooo0.OooOoO0(p255o00ooO0O.o000O0O0.OooO0OO(R.string.Obtain));
    ...
    public final void showPurchase(ThemeModel item) {
        if (item.getIsHave() == 1) {
            ToastUtil.f12582OooO00o.OooO0O0(p255o00ooO0O.o000O0O0.OooO0OO(R.string.room_theme_bought));
            return;
        }
        ...
        if (themeTagType == 1) {
            ...
            Intrinsics.checkNotNullExpressionValue(fragmentActivityRequireActivity, "requireActivity()");
            oo0oOO0 oo0ooo0 = new oo0oOO0(fragmentActivityRequireActivity);
            oo0ooo0.OooOo0O(com.yalla.support.common.util.OooOo.OooO00o(p255o00ooO0O.o000O0O0.OooO0OO(R.string.open_vip_alert), item.getThemeTag()));
            oo0oOO0.OooOoo0(oo0ooo0, false, 1, null);
        ...
        oo0ooo1.OooOo0O(com.yalla.support.common.util.OooOo.OooO00o(p255o00ooO0O.o000O0O0.OooO0OO(R.string.join_activity), item.getThemeTag()));
        if (!StringsKt.isBlank(item.getH5Url())) {
            oo0ooo1.OooOOo0(p255o00ooO0O.o000O0O0.OooO0OO(R.string.Obtain));
    ...
    public final void showThemeBigImageDialog(int position, List<ThemeModel> themeModel) {
        ...
        FragmentActivity fragmentActivityRequireActivity = requireActivity();
        Intrinsics.checkNotNullExpressionValue(fragmentActivityRequireActivity, "requireActivity()");
        b1 b1Var = new b1(fragmentActivityRequireActivity, new OooOo(), new Oooo000());
        b1Var.OooO00o(new Oooo0());
        this.themePreviewDialog = b1Var;
        Intrinsics.checkNotNullParameter(themeModel, "themeModel");
        b1Var.f45930OoooOoo = position;
        p189o00o00o0.OooO0OO<ThemeModel> oooO0OO = b1Var.f45929OoooOoO;
        if (oooO0OO == null) {
            Intrinsics.throwUninitializedPropertyAccessException("adapter");
            oooO0OO = null;
        }
        oooO0OO.setNewData(themeModel);
        b1Var.f45928OoooOo0.f50052OooO0Oo.scrollToPosition(position);
        b1Var.OooOO0O();
        b1 b1Var2 = this.themePreviewDialog;
        if (b1Var2 != null) {
            b1Var2.OooOO0();
        }
