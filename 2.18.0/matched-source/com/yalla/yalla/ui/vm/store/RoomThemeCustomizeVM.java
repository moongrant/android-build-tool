...
public final class RoomThemeCustomizeVM extends OooO00o {
    ...
    @NotNull
    private final o0O00O currentThemeType = o0OOO00.OooO0Oo(-1);

    /* JADX INFO: renamed from: customImagePath$delegate, reason: from kotlin metadata */
    @NotNull
    private final o0O00O customImagePath = o0OOO00.OooO0Oo(null);

    /* JADX INFO: renamed from: dayChooseList$delegate, reason: from kotlin metadata */
    @NotNull
    private final o0O00O dayChooseList = o0OOO00.OooO0Oo(null);

    /* JADX INFO: renamed from: coin$delegate, reason: from kotlin metadata */
    @NotNull
    private final o0O00O coin = o0OOO00.OooO0Oo(AppEventsConstants.EVENT_PARAM_VALUE_NO);
    private long reNewThemeId = -1;

    /* JADX INFO: renamed from: contentState$delegate, reason: from kotlin metadata */
    @NotNull
    private final o0O00O contentState = o0OOO00.OooO0Oo(ContentState.Loading);
    ...
    public static final class OooO extends SuspendLambda implements Function2<LiveDataScope<CloudFileInfo>, Continuation<? super Unit>, Object> {
        ...
        public int f26151Oooo;

        /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
        public /* synthetic */ Object f26153OoooO00;

        /* JADX INFO: renamed from: OoooO0O, reason: collision with root package name */
        public final /* synthetic */ File f26154OoooO0O;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(File file, Continuation<? super OooO> continuation) {
            super(2, continuation);
            this.f26154OoooO0O = file;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO oooO = RoomThemeCustomizeVM.this.new OooO(this.f26154OoooO0O, continuation);
            oooO.f26153OoooO00 = obj;
            return oooO;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f26151Oooo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f26153OoooO00;
            ...
            File file = this.f26154OoooO0O;
            this.f26153OoooO00 = liveDataScope;
            this.f26151Oooo = 1;
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f26155Oooo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                o00O000o o00o000o2 = o00O000o.f42656OooO00o;
                this.f26155Oooo = 1;
                obj = o00o000o2.OooO0o0(this);
                if (obj == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<LiveDataScope<ApiResult<RenewCustomizeTheme>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
        public int f26157Oooo;

        /* JADX INFO: renamed from: OoooO, reason: collision with root package name */
        public final /* synthetic */ RoomThemeCustomizeVM f26158OoooO;

        /* JADX INFO: renamed from: OoooO0, reason: collision with root package name */
        public final /* synthetic */ String f26159OoooO0;

        /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
        public /* synthetic */ Object f26160OoooO00;

        /* JADX INFO: renamed from: OoooO0O, reason: collision with root package name */
        public final /* synthetic */ int f26161OoooO0O;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(String str, int i, RoomThemeCustomizeVM roomThemeCustomizeVM, Continuation<? super OooO0OO> continuation) {
            super(2, continuation);
            this.f26159OoooO0 = str;
            this.f26161OoooO0O = i;
            this.f26158OoooO = roomThemeCustomizeVM;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0OO oooO0OO = new OooO0OO(this.f26159OoooO0, this.f26161OoooO0O, this.f26158OoooO, continuation);
            oooO0OO.f26160OoooO00 = obj;
            return oooO0OO;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            LiveDataScope liveDataScope;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f26157Oooo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f26160OoooO00;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            liveDataScope = (LiveDataScope) this.f26160OoooO00;
            o00O000o o00o000o2 = o00O000o.f42656OooO00o;
            String str = this.f26159OoooO0;
            int i2 = this.f26161OoooO0O;
            this.f26160OoooO00 = liveDataScope;
            this.f26157Oooo = 1;
            obj = o00o000o2.OooOO0o(str, i2, this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f26158OoooO.getShowLoadingDialog().setValue(Boxing.boxBoolean(false));
            this.f26160OoooO00 = null;
            this.f26157Oooo = 2;
    ...
    public static final class OooO0o extends SuspendLambda implements Function2<LiveDataScope<ApiResult<RenewCustomizeTheme>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
        public int f26162Oooo;

        /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
        public /* synthetic */ Object f26164OoooO00;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            LiveDataScope liveDataScope;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f26162Oooo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f26164OoooO00;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            this.f26164OoooO00 = liveDataScope;
            this.f26162Oooo = 1;
            obj = o00o000o2.OooOOO0(reNewThemeId, currentThemeType, 1, this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            RoomThemeCustomizeVM.this.getShowLoadingDialog().setValue(Boxing.boxBoolean(false));
            this.f26164OoooO00 = null;
            this.f26162Oooo = 2;
            if (liveDataScope.emit((ApiResult) obj, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
