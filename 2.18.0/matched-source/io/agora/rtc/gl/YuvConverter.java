        ...
        if (!this.released) {
            ...
            if (i3 >= i) {
                ...
                if (byteBuffer.capacity() >= i3 * i10) {
                    ...
                    int i11 = i3 / 4;
                    this.textureFrameBuffer.setSize(i11, i10);
                    ...
                    GLES20.glUniform4f(this.coeffsLoc, 0.299f, 0.587f, 0.114f, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE);
                    ...
                    GLES20.glDrawArrays(5, 0, 4);
                    int iGPUFBOReadFrame = -1;
                    if (GPUFBOValid()) {
                        if (this.nativeHanlder == 0) {
                            this.nativeHanlder = GPUFBOInit(i11, i10);
                        }
                        iGPUFBOReadFrame = GPUFBOReadFrame(this.nativeHanlder, byteBuffer.array(), i11, i10);
                    }
                    if (iGPUFBOReadFrame != 0) {
                        i6 = 0;
                        i5 = 36160;
                        GLES20.glReadPixels(0, 0, i11, i10, 6408, 5121, byteBuffer);
                    } else {
                        i5 = 36160;
                        i6 = 0;
                    }
                    ...
                    GLES20.glBindTexture(type.getGlTarget(), i6);
                    return;
                }
