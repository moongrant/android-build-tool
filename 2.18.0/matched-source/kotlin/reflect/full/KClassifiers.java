...
public final class KClassifiers {
    ...
    public static final KType createType(@NotNull KClassifier kClassifier, @NotNull List<KTypeProjection> arguments, boolean z, @NotNull List<? extends Annotation> annotations) {
        ...
        StringBuilder sbOooO0O0 = OooO00o.OooO0O0("Class declares ");
        sbOooO0O0.append(parameters.size());
        sbOooO0O0.append(" type parameters, but ");
        sbOooO0O0.append(arguments.size());
        sbOooO0O0.append(" were provided.");
