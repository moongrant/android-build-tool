...
public final class KClassImpl<T> extends KDeclarationContainerImpl implements KClass<T>, KClassifierImpl, KTypeParameterOwnerImpl {
        ...
        public Data() {
            ...
            this.supertypes = ReflectProperties.lazySoft(new Function0<List<? extends KTypeImpl>>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$supertypes$2
                ...
                public final List<? extends KTypeImpl> invoke() {
                    ClassKind kind;
                    Collection<KotlinType> collectionMo1791getSupertypes = this.this$0.getDescriptor().getTypeConstructor().mo1791getSupertypes();
                    Intrinsics.checkNotNullExpressionValue(collectionMo1791getSupertypes, "descriptor.typeConstructor.supertypes");
                    ArrayList arrayList = new ArrayList(collectionMo1791getSupertypes.size());
                    final KClassImpl<T>.Data data = this.this$0;
                    final KClassImpl<T> kClassImpl = kClassImpl;
                    for (final KotlinType kotlinType : collectionMo1791getSupertypes) {
                        ...
                        arrayList.add(new KTypeImpl(kotlinType, new Function0<Type>() { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$supertypes$2$1$1
                            ...
                            public final Type invoke() {
                                ...
                                if (!(classifierDescriptorMo1790getDeclarationDescriptor instanceof ClassDescriptor)) {
                                    throw new KotlinReflectionInternalError("Supertype not a class: " + classifierDescriptorMo1790getDeclarationDescriptor);
                                }
                                Class<?> javaClass = UtilKt.toJavaClass((ClassDescriptor) classifierDescriptorMo1790getDeclarationDescriptor);
                                if (javaClass == null) {
                                    StringBuilder sbOooO0O0 = OooO00o.OooO0O0("Unsupported superclass of ");
                                    sbOooO0O0.append(data);
                                    sbOooO0O0.append(": ");
                                    sbOooO0O0.append(classifierDescriptorMo1790getDeclarationDescriptor);
                                ...
                                StringBuilder sbOooO0O1 = OooO00o.OooO0O0("No superclass of ");
                                sbOooO0O1.append(data);
                                sbOooO0O1.append(" in Java reflection for ");
                                sbOooO0O1.append(classifierDescriptorMo1790getDeclarationDescriptor);
                    ...
                    if (!KotlinBuiltIns.isSpecialClassWithNoSupertypes(this.this$0.getDescriptor())) {
                        ...
                        do {
                            ...
                            kind = DescriptorUtils.getClassDescriptorForType(((KTypeImpl) it.next()).getType()).getKind();
            ...
            this.allNonStaticMembers = ReflectProperties.lazySoft(new Function0<List<? extends KCallableImpl<?>>>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$allNonStaticMembers$2
                ...
                public final List<? extends KCallableImpl<?>> invoke() {
                    return kotlin.collections.CollectionsKt.plus((Collection) this.this$0.getDeclaredNonStaticMembers(), (Iterable) this.this$0.getInheritedNonStaticMembers());
                }
            });
            this.allStaticMembers = ReflectProperties.lazySoft(new Function0<List<? extends KCallableImpl<?>>>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$allStaticMembers$2
                ...
                @Override // kotlin.jvm.functions.Function0
                public final List<? extends KCallableImpl<?>> invoke() {
                    return kotlin.collections.CollectionsKt.plus(this.this$0.getDeclaredStaticMembers(), (Iterable) this.this$0.getInheritedStaticMembers());
                }
            });
            this.declaredMembers = ReflectProperties.lazySoft(new Function0<List<? extends KCallableImpl<?>>>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$declaredMembers$2
                ...
                @Override // kotlin.jvm.functions.Function0
                public final List<? extends KCallableImpl<?>> invoke() {
                    return kotlin.collections.CollectionsKt.plus((Collection) this.this$0.getDeclaredNonStaticMembers(), (Iterable) this.this$0.getDeclaredStaticMembers());
                }
            });
    ...
    public final Void reportUnresolvedClass() throws InvocationTargetException {
        ...
        switch (kind == null ? -1 : WhenMappings.$EnumSwitchMapping$0[kind.ordinal()]) {
            case -1:
            case 6:
                StringBuilder sbOooO0O0 = OooO00o.OooO0O0("Unresolved class: ");
            ...
            case 2:
            case 3:
                StringBuilder sbOooO0O1 = OooO00o.OooO0O0("Packages and file facades are not yet supported in Kotlin reflection. Meanwhile please use Java reflection to inspect this class: ");
                sbOooO0O1.append(getJClass());
                throw new UnsupportedOperationException(sbOooO0O1.toString());
            case 4:
                StringBuilder sbOooO0O2 = OooO00o.OooO0O0("This class is an internal synthetic class generated by the Kotlin compiler, such as an anonymous class for a lambda, a SAM wrapper, a callable reference, etc. It's not a Kotlin class or interface, so the reflection library has no idea what declarations it has. Please use Java reflection to inspect this class: ");
                sbOooO0O2.append(getJClass());
                throw new UnsupportedOperationException(sbOooO0O2.toString());
            case 5:
                StringBuilder sbOooO0O3 = OooO00o.OooO0O0("Unknown class: ");
                sbOooO0O3.append(getJClass());
                sbOooO0O3.append(" (kind = ");
                sbOooO0O3.append(kind);
                sbOooO0O3.append(')');
                throw new KotlinReflectionInternalError(sbOooO0O3.toString());
        }
    }
    ...
    public String toString() {
        ...
        sbOooO0O0.append(str + StringsKt__StringsJVMKt.replace$default(strAsString, '.', Typography.dollar, false, 4, (Object) null));
