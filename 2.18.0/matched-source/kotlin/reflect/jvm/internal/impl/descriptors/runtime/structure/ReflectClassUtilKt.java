...
public final class ReflectClassUtilKt {
    ...
    public static final ClassId getClassId(@NotNull Class<?> cls) {
        ...
        if (cls.isPrimitive()) {
            throw new IllegalArgumentException(OooOOO.OooO00o("Can't compute ClassId for primitive type: ", cls));
        }
        if (cls.isArray()) {
            throw new IllegalArgumentException(OooOOO.OooO00o("Can't compute ClassId for array type: ", cls));
        }
    ...
    public static final String getDesc(@NotNull Class<?> cls) {
        ...
        if (!cls.isPrimitive()) {
            ...
            StringBuilder sbOooO0O0 = OooO0OO.OooO0O0('L');
            String name2 = cls.getName();
            Intrinsics.checkNotNullExpressionValue(name2, "name");
            sbOooO0O0.append(StringsKt__StringsJVMKt.replace$default(name2, '.', '/', false, 4, (Object) null));
            sbOooO0O0.append(';');
        ...
        throw new IllegalArgumentException(OooOOO.OooO00o("Unsupported primitive type: ", cls));
    }
