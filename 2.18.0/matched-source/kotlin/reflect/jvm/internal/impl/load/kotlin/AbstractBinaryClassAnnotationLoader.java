...
public abstract class AbstractBinaryClassAnnotationLoader<A, S extends AnnotationsContainer<? extends A>> implements AnnotationLoader<A> {
    ...
    private final int computeJvmParameterIndexShift(ProtoContainer protoContainer, MessageLite messageLite) {
        if (messageLite instanceof ProtoBuf.Function) {
            ...
            if (!(messageLite instanceof ProtoBuf.Constructor)) {
                StringBuilder sbOooO0O0 = OooO00o.OooO0O0("Unsupported message: ");
                sbOooO0O0.append(messageLite.getClass());
    ...
    private final List<A> loadPropertyAnnotations(ProtoContainer protoContainer, ProtoBuf.Property property, PropertyRelatedElement propertyRelatedElement) {
        ...
        return StringsKt.OooO0OO(propertySignature$default2.getSignature(), "$delegate") != (propertyRelatedElement == PropertyRelatedElement.DELEGATE_FIELD) ? CollectionsKt.emptyList() : findClassAndLoadMemberAnnotations(protoContainer, propertySignature$default2, true, true, Boolean.valueOf(zBooleanValue), zIsMovedFromInterfaceCompanion);
    }
    ...
    public final KotlinJvmBinaryClass getSpecialCaseContainerClass(@NotNull ProtoContainer container, boolean z, boolean z2, @Nullable Boolean bool, boolean z3) {
        ...
        if (z) {
            ...
            if (container instanceof ProtoContainer.Class) {
                ...
                if (r5.getKind() == ProtoBuf.Class.Kind.INTERFACE) {
                    ...
                    ClassId classIdCreateNestedClassId = r5.getClassId().createNestedClassId(Name.identifier("DefaultImpls"));
        ...
        if (z2 && (container instanceof ProtoContainer.Class)) {
            ...
            if (r6.getKind() == ProtoBuf.Class.Kind.COMPANION_OBJECT && (outerClass = r6.getOuterClass()) != null && (outerClass.getKind() == ProtoBuf.Class.Kind.CLASS || outerClass.getKind() == ProtoBuf.Class.Kind.ENUM_CLASS || (z3 && (outerClass.getKind() == ProtoBuf.Class.Kind.INTERFACE || outerClass.getKind() == ProtoBuf.Class.Kind.ANNOTATION_CLASS)))) {
    ...
    public List<A> loadClassAnnotations(@NotNull ProtoContainer.Class container) {
        ...
        StringBuilder sbOooO0O0 = OooO00o.OooO0O0("Class for loading annotations is not found: ");
        sbOooO0O0.append(container.debugFqName());
