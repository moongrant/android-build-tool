...
public class TypeSubstitutor {
    ...
    private static void assertRecursionDepth(int i, TypeProjection typeProjection, TypeSubstitution typeSubstitution) {
        ...
        StringBuilder sbOooO0O0 = OooO00o.OooO00o.OooO0O0("Recursion too deep. Most likely infinite loop while substituting ");
        sbOooO0O0.append(safeToString(typeProjection));
        sbOooO0O0.append("; substitution: ");
        sbOooO0O0.append(safeToString(typeSubstitution));
    ...
    private TypeProjection substituteCompoundType(TypeProjection typeProjection, int i) throws SubstitutionException {
        ...
        if (type.getConstructor().mo1790getDeclarationDescriptor() instanceof TypeParameterDescriptor) {
            return typeProjection;
        }
    ...
    private TypeProjection unsafeSubstitute(@NotNull TypeProjection typeProjection, @Nullable TypeParameterDescriptor typeParameterDescriptor, int i) throws SubstitutionException {
        ...
        if (!DynamicTypesKt.isDynamic(type) && !(type.unwrap() instanceof RawType)) {
            TypeProjection typeProjectionMo1799get = this.substitution.mo1799get(type);
            TypeProjection typeProjectionProjectedTypeForConflictedTypeWithUnsafeVariance = typeProjectionMo1799get != null ? projectedTypeForConflictedTypeWithUnsafeVariance(type, typeProjectionMo1799get, typeParameterDescriptor, typeProjection) : null;
            Variance projectionKind = typeProjection.getProjectionKind();
