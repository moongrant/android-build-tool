...
public final class CoroutineScheduler implements Executor, Closeable {
    ...
    public CoroutineScheduler(int i, int i2, long j, @NotNull String str) {
        ...
        if (!(i >= 1)) {
            throw new IllegalArgumentException(OooO00o.OooO00o("Core pool size ", i, " should be at least 1").toString());
        }
        if (!(i2 >= i)) {
            throw new IllegalArgumentException(o00O00OO.OooO00o("Max pool size ", i2, " should be greater than or equals to core pool size ", i).toString());
        }
        if (!(i2 <= 2097150)) {
            throw new IllegalArgumentException(OooO00o.OooO00o("Max pool size ", i2, " should not exceed maximal supported number of threads 2097150").toString());
        }
        if (!(j > 0)) {
    ...
    public final void dispatch(@NotNull Runnable block, @NotNull TaskContext taskContext, boolean tailDispatch) {
        ...
        if (taskSubmitToLocalQueue != null && !addToGlobalQueue(taskSubmitToLocalQueue)) {
            throw new RejectedExecutionException(OooO00o.OooO00o.OooO00o(new StringBuilder(), this.schedulerName, " was terminated"));
        }
