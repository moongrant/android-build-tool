        ...
        public void writeInternal(ByteBuffer byteBuffer) throws IOException {
            ...
            do {
                ...
                if (sSLEngineResultWrap.getStatus() != SSLEngineResult.Status.OK) {
                    StringBuilder sbOooO0O0 = OooO00o.OooO00o.OooO0O0("Unexpected engine result ");
                    sbOooO0O0.append(sSLEngineResultWrap.getStatus());
                    throw new SSLException(sbOooO0O0.toString());
                }
                if (this.target.position() != sSLEngineResultWrap.bytesProduced()) {
                    StringBuilder sbOooO0O1 = OooO00o.OooO00o.OooO0O0("Engine bytesProduced ");
                    sbOooO0O1.append(sSLEngineResultWrap.bytesProduced());
                    sbOooO0O1.append(" does not match bytes written ");
                    sbOooO0O1.append(this.target.position());
                    throw new SSLException(sbOooO0O1.toString());
                }
            ...
            while (this.fromEngine.remaining() <= 0) {
                ...
                if (i3 == 1) {
                    ...
                    if (i3 != 2) {
                        ...
                        StringBuilder sbOooO0O0 = OooO00o.OooO00o.OooO0O0("Unexpected engine result ");
                        sbOooO0O0.append(sSLEngineResultUnwrap.getStatus());
                        throw new SSLException(sbOooO0O0.toString());
                    }
