...
final class SSLUtils {
    ...
    public static String[] decodeProtocols(byte[] bArr) {
        ...
        while (i2 < bArr.length) {
            ...
            if (b < 0 || b > bArr.length - i2) {
                StringBuilder sbOooO0OO = o000O0Oo.OooO0OO("Protocol has invalid length (", b, " at position ", i2, "): ");
                sbOooO0OO.append(bArr.length < 50 ? Arrays.toString(bArr) : OooO0OO.OooO0O0(new StringBuilder(), bArr.length, " byte array"));
    ...
    public static byte[] encodeProtocols(String[] strArr) {
        ...
        for (int i2 = 0; i2 < strArr.length; i2++) {
            if (strArr[i2] == null) {
                throw new IllegalArgumentException(OooO0O0.OooO00o.OooO00o("protocol[", i2, "] is null"));
            }
