...
public final class oO0O000o extends oO0O00O<Boolean> {
    ...
    public static final String f30062OooO = o0OoOo0.OooO0o0("BatteryChrgTracker");

    public oO0O000o(@NonNull Context context, @NonNull OooO00o oooO00o) {
        super(context, oooO00o);
    }

    @Override // p113o000oooo.oO0O00o0
    public final Object OooO00o() {
        int intExtra;
        Intent intentRegisterReceiver = this.f30068OooO0O0.registerReceiver(null, new IntentFilter("android.intent.action.BATTERY_CHANGED"));
        boolean z = false;
        if (intentRegisterReceiver == null) {
            o0OoOo0.OooO0OO().OooO0O0(f30062OooO, "getInitialState - null intent received", new Throwable[0]);
            return null;
        }
    ...
    public final void OooO0oO(@NonNull Intent intent) {
        ...
        byte b = 0;
        o0OoOo0.OooO0OO().OooO00o(f30062OooO, String.format("Received %s", action), new Throwable[0]);
