...
import p124o00O0o0.OooOO0;
import p124o00O0o0.OooOOO;
import p124o00O0o0.OooOOO0;
import p124o00O0o0.OooOo00;
import p124o00O0o0.Oooo000;
import p124o00O0o0.o00O0O;
import p124o00O0o0.o00Oo0;
import p126o00O0o0O.o0000;
import p126o00O0o0O.o00000;
import p126o00O0o0O.o00000O0;
import p126o00O0o0O.o00000OO;
import p126o00O0o0O.o0000Ooo;
import p126o00O0o0O.o000OOo;
...
public final class o000000O {
    ...
    public static final JsonReader.OooO00o f31091OooO00o = JsonReader.OooO00o.OooO00o("ty", "d");
    ...
    public static o000OOo OooO00o(JsonReader jsonReader, OooOO0O oooOO0O) throws IOException {
        ...
        while (true) {
            ...
            int iOooo0 = jsonReader.Oooo0(f31091OooO00o);
            if (iOooo0 == 0) {
        ...
        switch (strOooOoOO) {
            case "el":
                JsonReader.OooO00o oooO00o = o000OOo.f31135OooO00o;
                ...
                while (jsonReader.OooOOO()) {
                    int iOooo1 = jsonReader.Oooo0(o000OOo.f31135OooO00o);
                    if (iOooo1 == 0) {
                ...
                break;
            case "fl":
                JsonReader.OooO00o oooO00o2 = o000O.f31119OooO00o;
                int iOooOo0O2 = 1;
                OooOOO oooOOO = null;
                ...
                while (jsonReader.OooOOO()) {
                    int iOooo2 = jsonReader.Oooo0(o000O.f31119OooO00o);
                    if (iOooo2 == 0) {
                ...
                if (oooOOO == null) {
                    oooOOO = new OooOOO(Collections.singletonList(new p132o00O0oo0.o000OOo(100)));
                }
                ...
                break;
            case "gf":
                JsonReader.OooO00o oooO00o3 = o0000oo.f31117OooO00o;
                ...
                while (jsonReader.OooOOO()) {
                    switch (jsonReader.Oooo0(o0000oo.f31117OooO00o)) {
                        case 0:
                        ...
                        case 1:
                            ...
                            int iOooOo0O3 = -1;
                            while (jsonReader.OooOOO()) {
                                int iOooo3 = jsonReader.Oooo0(o0000oo.f31118OooO0O0);
                                if (iOooo3 == 0) {
                ...
                o0o0o00 = new p126o00O0o0O.o000000O(strOooOoOO4, gradientType, fillType, oooOOO0, oooOOOOooO0Oo == null ? new OooOOO(Collections.singletonList(new p132o00O0oo0.o000OOo(100))) : oooOOOOooO0Oo, oooOo00OooO0o1, oooOo00OooO0o2, zOooOOo5);
                break;
            case "gr":
                JsonReader.OooO00o oooO00o4 = o000OO00.f31133OooO00o;
                ArrayList arrayList = new ArrayList();
                String strOooOoOO5 = null;
                while (jsonReader.OooOOO()) {
                    int iOooo4 = jsonReader.Oooo0(o000OO00.f31133OooO00o);
                    if (iOooo4 == 0) {
            ...
            case "gs":
                ...
                while (jsonReader.OooOOO()) {
                    switch (jsonReader.Oooo0(o0000O0.f31109OooO00o)) {
                        case 0:
                        ...
                        case 1:
                            ...
                            int iOooOo0O4 = -1;
                            while (jsonReader.OooOOO()) {
                                int iOooo5 = jsonReader.Oooo0(o0000O0.f31110OooO0O0);
                                if (iOooo5 == 0) {
                        ...
                        case 11:
                            ...
                            while (jsonReader.OooOOO()) {
                                jsonReader.OooO0O0();
                                p124o00O0o0.OooOO0O oooOO0OOooO0OO2 = null;
                                String strOooOoOO7 = null;
                                while (jsonReader.OooOOO()) {
                                    int iOooo6 = jsonReader.Oooo0(o0000O0.f31111OooO0OO);
                                    if (iOooo6 == 0) {
                                ...
                                if (strOooOoOO7.equals("o")) {
                                    ...
                                    oooOO0O.f10068OooOOO = true;
                                    arrayList2.add(oooOO0OOooO0OO2);
                                }
                            }
                            jsonReader.OooO0Oo();
                            if (arrayList2.size() == 1) {
                                arrayList2.add((p124o00O0o0.OooOO0O) arrayList2.get(0));
                            }
                            break;
                        default:
                            jsonReader.Oooo0OO();
                ...
                o0o0o00 = new OooO00o(strOooOoOO6, gradientType2, oooOOO1, oooOOOOooO0Oo2 == null ? new OooOOO(Collections.singletonList(new p132o00O0oo0.o000OOo(100))) : oooOOOOooO0Oo2, oooOo00OooO0o3, oooOo00OooO0o4, oooOO0OOooO0OO, lineCapType, lineJoinType, fOooOOoo, arrayList2, oooOO0O2, zOooOOo6);
                break;
            case "mm":
                JsonReader.OooO00o oooO00o6 = o000O0o.f31130OooO00o;
                MergePaths.MergePathsMode mergePathsMode = null;
                String strOooOoOO8 = null;
                while (jsonReader.OooOOO()) {
                    int iOooo7 = jsonReader.Oooo0(o000O0o.f31130OooO00o);
                    if (iOooo7 == 0) {
                ...
                break;
            case "rc":
                JsonReader.OooO00o oooO00o7 = o000O0.f31120OooO00o;
                String strOooOoOO9 = null;
                o00Oo0<PointF, PointF> o00oo0OooO0O1 = null;
                OooOo00 oooOo00OooO0o5 = null;
                p124o00O0o0.OooOO0O oooOO0OOooO0OO3 = null;
                boolean zOooOOo7 = false;
                while (jsonReader.OooOOO()) {
                    int iOooo8 = jsonReader.Oooo0(o000O0.f31120OooO00o);
                    if (iOooo8 == 0) {
                ...
                break;
            case "rp":
                JsonReader.OooO00o oooO00o8 = o000O0Oo.f31129OooO00o;
                String strOooOoOO10 = null;
                p124o00O0o0.OooOO0O oooOO0OOooO0OO4 = null;
                p124o00O0o0.OooOO0O oooOO0OOooO0OO5 = null;
                o00O0O o00o0oOooO00o = null;
                boolean zOooOOo8 = false;
                while (jsonReader.OooOOO()) {
                    int iOooo9 = jsonReader.Oooo0(o000O0Oo.f31129OooO00o);
                    if (iOooo9 == 0) {
                ...
                break;
            case "sh":
                JsonReader.OooO00o oooO00o9 = o000OOo0.f31136OooO00o;
                Oooo000 oooo000 = null;
                int iOooOo0O6 = 0;
                String strOooOoOO11 = null;
                boolean zOooOOo9 = false;
                while (jsonReader.OooOOO()) {
                    int iOooo10 = jsonReader.Oooo0(o000OOo0.f31136OooO00o);
                    if (iOooo10 == 0) {
                        strOooOoOO11 = jsonReader.OooOoOO();
                    } else if (iOooo10 == 1) {
                        iOooOo0O6 = jsonReader.OooOo0O();
                    } else if (iOooo10 == 2) {
                        oooo000 = new Oooo000(o0000OO0.OooO00o(jsonReader, oooOO0O, o000O0Oo.OooO0OO(), o000O0O0.f31127OooO00o, false));
                    } else if (iOooo10 != 3) {
                        jsonReader.Oooo0o();
                    } else {
                ...
                break;
            case "sr":
                JsonReader.OooO00o oooO00o10 = o000O00O.f31126OooO00o;
                String strOooOoOO12 = null;
                PolystarShape.Type typeOooO00o = null;
                p124o00O0o0.OooOO0O oooOO0OOooO0OO6 = null;
                o00Oo0<PointF, PointF> o00oo0OooO0O2 = null;
                p124o00O0o0.OooOO0O oooOO0OOooO0OO7 = null;
                p124o00O0o0.OooOO0O oooOO0OOooO0OO8 = null;
                p124o00O0o0.OooOO0O oooOO0OOooO0OO9 = null;
                p124o00O0o0.OooOO0O oooOO0OOooO0OO10 = null;
                p124o00O0o0.OooOO0O oooOO0OOooO0OO11 = null;
                boolean zOooOOo10 = false;
                while (jsonReader.OooOOO()) {
                    switch (jsonReader.Oooo0(o000O00O.f31126OooO00o)) {
                        case 0:
                ...
                break;
            case "st":
                JsonReader.OooO00o oooO00o11 = o00.f31081OooO00o;
                ArrayList arrayList3 = new ArrayList();
                OooOOO oooOOOOooO0Oo3 = null;
                p124o00O0o0.OooOO0O oooOO0O3 = null;
                OooOO0 oooOO0OooO0O1 = null;
                p124o00O0o0.OooOO0O oooOO0OOooO0OO12 = null;
                ...
                while (jsonReader.OooOOO()) {
                    switch (jsonReader.Oooo0(o00.f31081OooO00o)) {
                        case 0:
                        ...
                        case 8:
                            ...
                            while (jsonReader.OooOOO()) {
                                jsonReader.OooO0O0();
                                p124o00O0o0.OooOO0O oooOO0OOooO0OO13 = null;
                                String strOooOoOO14 = null;
                                while (jsonReader.OooOOO()) {
                                    int iOooo11 = jsonReader.Oooo0(o00.f31082OooO0O0);
                                    if (iOooo11 == 0) {
                            ...
                            if (arrayList3.size() == 1) {
                                arrayList3.add((p124o00O0o0.OooOO0O) arrayList3.get(0));
                            }
                            break;
                        default:
                            jsonReader.Oooo0o();
                ...
                o0o0o00 = new ShapeStroke(strOooOoOO13, oooOO0O3, arrayList3, oooOO0OooO0O1, oooOOOOooO0Oo3 == null ? new OooOOO(Collections.singletonList(new p132o00O0oo0.o000OOo(100))) : oooOOOOooO0Oo3, oooOO0OOooO0OO12, lineCapType2, lineJoinType2, fOooOOoo2, zOooOOo11);
                break;
            case "tm":
                JsonReader.OooO00o oooO00o12 = o00O0000.f31138OooO00o;
                String strOooOoOO15 = null;
                ShapeTrimPath.Type type2 = null;
                p124o00O0o0.OooOO0O oooOO0OOooO0OO14 = null;
                p124o00O0o0.OooOO0O oooOO0OOooO0OO15 = null;
                p124o00O0o0.OooOO0O oooOO0OOooO0OO16 = null;
                boolean zOooOOo12 = false;
                while (jsonReader.OooOOO()) {
                    int iOooo12 = jsonReader.Oooo0(o00O0000.f31138OooO00o);
                    if (iOooo12 == 0) {
