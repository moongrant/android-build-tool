...
import p226o00oOOo.o00O0OO;
import p226o00oOOo.o00OO000;
import p226o00oOOo.oo0o0O0;

/* JADX INFO: loaded from: classes.dex */
public final class o000O000 {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public static final JsonReader.OooO00o f31122OooO00o = JsonReader.OooO00o.OooO00o("w", "h", "ip", "op", "fr", ak.aE, "layers", "assets", "fonts", "chars", "markers");

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static JsonReader.OooO00o f31123OooO0O0 = JsonReader.OooO00o.OooO00o("id", "layers", "w", "h", ak.ax, ak.aG);

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final JsonReader.OooO00o f31124OooO0OO = JsonReader.OooO00o.OooO00o("list");

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public static final JsonReader.OooO00o f31125OooO0Oo = JsonReader.OooO00o.OooO00o("cm", "tm", "dr");
    ...
    public static OooOO0O OooO00o(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.OooOOO()) {
            float f5 = fOooOOoo;
            switch (jsonReader.Oooo0(f31122OooO00o)) {
                case 0:
                ...
                case 6:
                    ...
                    while (jsonReader.OooOOO()) {
                        ...
                        if (layerOooO00o.f10161OooO0o0 == Layer.LayerType.IMAGE) {
                            i4++;
                        }
                        arrayList.add(layerOooO00o);
                        o00Ooo<Layer> o00ooo5 = o00ooo4;
                        o00ooo5.OooOO0o(layerOooO00o.f10159OooO0Oo, layerOooO00o);
                        if (i4 > 4) {
                ...
                case 7:
                    ...
                    while (jsonReader.OooOOO()) {
                        ...
                        while (jsonReader.OooOOO()) {
                            o0ooooo2 = o0ooooo2;
                            int iOooo0 = jsonReader.Oooo0(f31123OooO0O0);
                            if (iOooo0 != 0) {
                                i = iOooOo0O;
                                if (iOooo0 == 1) {
                                    jsonReader.OooO00o();
                                    while (jsonReader.OooOOO()) {
                                        ...
                                        o00ooo6.OooOO0o(layerOooO00o2.f10159OooO0Oo, layerOooO00o2);
                ...
                case 8:
                    ...
                    jsonReader.OooO0O0();
                    while (jsonReader.OooOOO()) {
                        if (jsonReader.Oooo0(f31124OooO0OO) != 0) {
                            jsonReader.Oooo0OO();
                            jsonReader.Oooo0o();
                        } else {
                            jsonReader.OooO00o();
                            while (jsonReader.OooOOO()) {
                                JsonReader.OooO00o oooO00o = o0000.f31087OooO00o;
                                jsonReader.OooO0O0();
                                String strOooOoOO3 = null;
                                String strOooOoOO4 = null;
                                String strOooOoOO5 = null;
                                while (jsonReader.OooOOO()) {
                                    int iOooo1 = jsonReader.Oooo0(o0000.f31087OooO00o);
                                    if (iOooo1 != 0) {
                ...
                case 9:
                    ...
                    jsonReader.OooO00o();
                    while (jsonReader.OooOOO()) {
                        JsonReader.OooO00o oooO00o2 = o0000Ooo.f31115OooO00o;
                        ...
                        char cCharAt = 0;
                        while (jsonReader.OooOOO()) {
                            int iOooo2 = jsonReader.Oooo0(o0000Ooo.f31115OooO00o);
                            if (iOooo2 == 0) {
                                ...
                                jsonReader.OooO0O0();
                                while (jsonReader.OooOOO()) {
                                    if (jsonReader.Oooo0(o0000Ooo.f31116OooO0O0) != 0) {
                                        jsonReader.Oooo0OO();
                                        jsonReader.Oooo0o();
                                    } else {
                                        jsonReader.OooO00o();
                ...
                case 10:
                    ...
                    while (jsonReader.OooOOO()) {
                        ...
                        while (jsonReader.OooOOO()) {
                            int iOooo3 = jsonReader.Oooo0(f31125OooO0Oo);
                            if (iOooo3 != 0) {
                                f4 = fOooOOoo3;
                                if (iOooo3 == 1) {
        ...
        float f7 = fOooO0OO;
        oooOO0O.f10065OooOO0 = new Rect(0, 0, (int) (iOooOo0O2 * f7), (int) (iOooOo0O * f7));
        oooOO0O.f10066OooOO0O = fOooOOoo2;
        oooOO0O.f10067OooOO0o = fOooOOoo3;
        oooOO0O.f10069OooOOO0 = fOooOOoo;
        oooOO0O.f10056OooO = arrayList;
        oooOO0O.f10064OooO0oo = o00ooo3;
        oooOO0O.f10059OooO0OO = map;
        oooOO0O.f10060OooO0Oo = map2;
        oooOO0O.f10063OooO0oO = o0ooooo2;
        oooOO0O.f10062OooO0o0 = map3;
        oooOO0O.f10061OooO0o = arrayList2;
        return oooOO0O;
    }
}
