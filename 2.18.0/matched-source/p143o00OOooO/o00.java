...
public final /* synthetic */ class o00 implements Observer {
    ...
    public final /* synthetic */ int f31929OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final /* synthetic */ Object f31930OooO0O0;

    public /* synthetic */ o00(Object obj, int i) {
        this.f31929OooO00o = i;
        this.f31930OooO0O0 = obj;
    }
    ...
    public final void onChanged(Object obj) {
        switch (this.f31929OooO00o) {
            case 0:
                StoreCoinFragment this$0 = (StoreCoinFragment) this.f31930OooO0O0;
                ...
                break;
            case 1:
                o000O000 this$1 = (o000O000) this.f31930OooO0O0;
                GiftView giftView = (GiftView) obj;
                Intrinsics.checkNotNullParameter(this$1, "this$0");
                this$1.OooOoO(giftView, giftView.getF20965OoooOO0());
                break;
            case 2:
                SmsCodeActivity this$2 = (SmsCodeActivity) this.f31930OooO0O0;
                ...
                break;
            case 3:
                UserPostListActivity this$3 = (UserPostListActivity) this.f31930OooO0O0;
                Long it = (Long) obj;
                ...
                break;
            case 4:
                RoomSettingActivity this$4 = (RoomSettingActivity) this.f31930OooO0O0;
                ...
                for (RoomItemInfoModel roomItemInfoModel : this$4.f22990OooooOO) {
                ...
                break;
            case 5:
                a this$5 = (a) this.f31930OooO0O0;
                MusicState.LoopMode loopMode = (MusicState.LoopMode) obj;
                Intrinsics.checkNotNullParameter(this$5, "this$0");
                int i = loopMode == null ? -1 : a.OooO00o.$EnumSwitchMapping$1[loopMode.ordinal()];
                if (i == 1) {
                    this$5.f45896OoooOOO.f51073OooO0oO.setImageResource(R.drawable.ic_music_dialog_loop_all);
                    break;
                } else if (i == 2) {
                    this$5.f45896OoooOOO.f51073OooO0oO.setImageResource(R.drawable.ic_dialog_muisc_loop_single);
                    break;
                }
                break;
            case 6:
                EventMineFragment.m322onLazyInit$lambda0((EventMineFragment) this.f31930OooO0O0, (String) obj);
                break;
            default:
                MainRoomFragment.m445checkSignIn$lambda17((MainRoomFragment) this.f31930OooO0O0, (Response) obj);
                break;
        }
    }
}
