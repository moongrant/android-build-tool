...
public final /* synthetic */ class o0000OO0 implements Observer {
    ...
    public final /* synthetic */ int f31953OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final /* synthetic */ Object f31954OooO0O0;

    public /* synthetic */ o0000OO0(Object obj, int i) {
        this.f31953OooO00o = i;
        this.f31954OooO0O0 = obj;
    }

    @Override // androidx.lifecycle.Observer
    public final void onChanged(Object obj) {
        boolean z = true;
        switch (this.f31953OooO00o) {
            case 0:
                MomentListFeaturedFragment.m36initObserver$lambda2((MomentListFeaturedFragment) this.f31954OooO0O0, (MomentDetailModel) obj);
                break;
            case 1:
                final MixedRoomActivity mixedRoomActivity = (MixedRoomActivity) this.f31954OooO0O0;
                int i = MixedRoomActivity.f11779o0000O00;
                Objects.requireNonNull(mixedRoomActivity);
                n.OooO00o(false, true, new Function1() { // from class: o00OoOO.o00O0O
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj2) {
                        mixedRoomActivity.f11797o00000oO = (l) obj2;
                        return null;
                    }
                });
                break;
            case 2:
                RoomBlackListUnJoinAndUnFollowDialog this$0 = (RoomBlackListUnJoinAndUnFollowDialog) this.f31954OooO0O0;
                ...
                break;
            case 3:
                TopicSearchActivity this$1 = (TopicSearchActivity) this.f31954OooO0O0;
                ...
                if (!this$1.f22677Oooooo) {
                    if (response.getIsSuccess()) {
                        ...
                        if (this$1.OooOooo().f50297OooO00o.getParent() != null) {
                ...
                break;
            case 4:
                RoomSettingActivity this$2 = (RoomSettingActivity) this.f31954OooO0O0;
                RoomSettingActivity.OooO00o oooO00o2 = RoomSettingActivity.f22988oo000o;
                Intrinsics.checkNotNullParameter(this$2, "this$0");
                this$2.OooOooo();
                break;
            case 5:
                UserInfoEditActivity this$3 = (UserInfoEditActivity) this.f31954OooO0O0;
