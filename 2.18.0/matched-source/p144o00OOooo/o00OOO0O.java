...
public final /* synthetic */ class o00OOO0O implements Observer {
    ...
    public final void onChanged(Object obj) {
        switch (this.f32043OooO00o) {
            case 0:
                RoomInfoProfileFragment.m77initDataObserver$lambda5((RoomInfoProfileFragment) this.f32044OooO0O0, (Boolean) obj);
                break;
            case 1:
                o00OO this$0 = (o00OO) this.f32044OooO0O0;
                Intrinsics.checkNotNullParameter(this$0, "this$0");
                this$0.OooO00o(0);
                break;
            case 2:
                MutableLiveData mutableLiveData = (MutableLiveData) this.f32044OooO0O0;
                ...
                break;
            case 3:
                MomentSendActivity this$1 = (MomentSendActivity) this.f32044OooO0O0;
                ...
                break;
            case 4:
                TopicDetailActivity this$2 = (TopicDetailActivity) this.f32044OooO0O0;
                Long l = (Long) obj;
                TopicDetailActivity.OooO00o oooO00o2 = TopicDetailActivity.f22586o00Oo0;
                Intrinsics.checkNotNullParameter(this$2, "this$0");
                TopicInfoModel topicInfoModel = this$2.f22588OooooOO;
                ...
                break;
            case 5:
                PremiumActivity this$3 = (PremiumActivity) this.f32044OooO0O0;
                Pair<Boolean, Integer> it = (Pair) obj;
                PremiumActivity.OooO00o oooO00o3 = PremiumActivity.f23379o0Oo0oo;
                Intrinsics.checkNotNullParameter(this$3, "this$0");
                this$3.f23388o00Oo0 = PremiumLevel.INSTANCE.OooO00o(it.getSecond());
                UserPremiumView userPremiumView = this$3.Oooo00o().f51051OooO0o0;
                Intrinsics.checkNotNullExpressionValue(it, "it");
                userPremiumView.setPremium(it);
                break;
            default:
                TopicPostPopularFragment.m410initObserve$lambda0((TopicPostPopularFragment) this.f32044OooO0O0, (MomentDetailModel) obj);
                break;
        }
    }
}
