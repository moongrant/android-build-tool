...
public final /* synthetic */ class o0000oo implements Function0 {
    ...
    public final /* synthetic */ int f32442Oooo;

    /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
    public final /* synthetic */ BaseFragmentActivity f32443OoooO00;

    public /* synthetic */ o0000oo(BaseFragmentActivity baseFragmentActivity, int i) {
        this.f32442Oooo = i;
        this.f32443OoooO00 = baseFragmentActivity;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Object invoke() {
        switch (this.f32442Oooo) {
            case 0:
                MixedRoomActivity mixedRoomActivity = (MixedRoomActivity) this.f32443OoooO00;
                int i = MixedRoomActivity.f11779o0000O00;
                mixedRoomActivity.OooOoo();
                break;
            default:
                SearchMusicActivity searchMusicActivity = (SearchMusicActivity) this.f32443OoooO00;
