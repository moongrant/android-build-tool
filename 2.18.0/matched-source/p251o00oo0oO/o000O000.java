...
public class o000O000<T extends o000O000<T>> {
    ...
    @NotNull
    public final Context f34221OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public final o000Oo0 f34222OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @NotNull
    public final LinearLayout f34223OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public boolean f34224OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @Nullable
    public Function0<? extends Object> f34225OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @Nullable
    public Function0<? extends Object> f34226OooO0o0;
    ...
    public o000O000(Context context) {
        ...
        this.f34221OooO00o = context;
        int i = 0;
        o000Oo0 o000oo1 = new o000Oo0(0, this, context);
        this.f34222OooO0O0 = o000oo1;
        this.f34224OooO0Oo = true;
        ...
        this.f34223OooO0OO = linearLayout;
        ...
        o000oo1.setOnShowListener(new DialogInterface.OnShowListener() { // from class: o00oo0oO.o0000OO0
            ...
            public final void onShow(DialogInterface dialogInterface) {
                o000O000 this$0 = this.f34219OooO00o;
        ...
        o000oo1.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: o00oo0oO.o000OO
            ...
            public final void onDismiss(DialogInterface dialogInterface) {
                o000O000 this$0 = this.f34232Oooo;
                Intrinsics.checkNotNullParameter(this$0, "this$0");
                this$0.OooO0o();
                Function0<? extends Object> function0 = this$0.f34226OooO0o0;
                if (function0 != null) {
                    function0.invoke();
                }
            }
        ...
        o000oo1.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: o00oo0oO.o0000O0O
            ...
            public final void onCancel(DialogInterface dialogInterface) {
                o000O000 this$0 = this.f34218Oooo;
                Intrinsics.checkNotNullParameter(this$0, "this$0");
                Objects.requireNonNull(this$0);
                Function0<? extends Object> function0 = this$0.f34225OooO0o;
                if (function0 != null) {
                    function0.invoke();
                }
            }
    ...
    public final o000O000 OooO() {
        this.f34223OooO0OO.setGravity(81);
    ...
    public final void OooO0OO() {
        this.f34222OooO0O0.cancel();
    }

    public final void OooO0Oo() {
        this.f34222OooO0O0.dismiss();
    }
    ...
    public final Window OooO0o0() {
        return this.f34222OooO0O0.getWindow();
    }

    @NotNull
    public final T OooO0oO(boolean z) {
        this.f34224OooO0Oo = z;
        this.f34222OooO0O0.setCancelable(z);
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of com.code.android.easydialog.EasyDialog");
        return this;
    }
    ...
    public final T OooO0oo(@NotNull View view) {
        ...
        this.f34223OooO0OO.removeAllViews();
        this.f34223OooO0OO.addView(view);
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of com.code.android.easydialog.EasyDialog");
        return this;
    }
    ...
    public void OooOOO0() {
        Context context = this.f34221OooO00o;
        if ((context instanceof Activity) && (((Activity) context).isDestroyed() || ((Activity) this.f34221OooO00o).isFinishing())) {
            return;
        }
        try {
            this.f34222OooO0O0.show();
