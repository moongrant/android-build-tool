...
public final class o00Oo0 {
    ...
    public static void OooO00o(o00000O o00000o, ErrorCorrectionLevel errorCorrectionLevel, o000oOoO o000oooo2, int i, o0OoOo0 o0oooo1) throws WriterException {
        ...
        int i7;
        boolean z;
        for (byte[] bArr : o0oooo1.f39039OooO00o) {
            Arrays.fill(bArr, (byte) -1);
        }
        int length = f39035OooO00o[0].length;
        OooO0Oo(0, 0, o0oooo1);
        OooO0Oo(o0oooo1.f39040OooO0O0 - length, 0, o0oooo1);
        OooO0Oo(0, o0oooo1.f39040OooO0O0 - length, o0oooo1);
        OooO0OO(0, 7, o0oooo1);
        OooO0OO(o0oooo1.f39040OooO0O0 - 8, 7, o0oooo1);
        OooO0OO(0, o0oooo1.f39040OooO0O0 - 8, o0oooo1);
        OooO0o0(7, 0, o0oooo1);
        OooO0o0((o0oooo1.f39041OooO0OO - 7) - 1, 0, o0oooo1);
        OooO0o0(7, o0oooo1.f39041OooO0OO - 7, o0oooo1);
        if (o0oooo1.OooO00o(8, o0oooo1.f39041OooO0OO - 8) == 0) {
            throw new WriterException();
        }
        o0oooo1.OooO0O0(8, o0oooo1.f39041OooO0OO - 8, 1);
        int i8 = o000oooo2.f39024OooO00o;
        int i9 = 5;
        if (i8 >= 2) {
            int[] iArr = f39037OooO0OO[i8 - 1];
        ...
        int i18 = 8;
        while (i18 < o0oooo1.f39040OooO0O0 - 8) {
            int i19 = i18 + 1;
            int i20 = i19 % 2;
        ...
        if (o00000o2.f38937OoooO00 != o00000o3.f38937OoooO00) {
            throw new IllegalArgumentException("Sizes don't match");
        }
        int i21 = 0;
        while (true) {
            int[] iArr3 = o00000o2.f38936Oooo;
            if (i21 >= iArr3.length) {
                break;
            }
            iArr3[i21] = iArr3[i21] ^ o00000o3.f38936Oooo[i21];
            i21++;
        }
        if (o00000o2.f38937OoooO00 != 15) {
            throw new WriterException("should not happen but we got: " + o00000o2.f38937OoooO00);
        }
        int i22 = 0;
        while (true) {
            int i23 = o00000o2.f38937OoooO00;
            if (i22 >= i23) {
                break;
            }
            boolean zOooO0oO2 = o00000o2.OooO0oO((i23 - 1) - i22);
            int[] iArr4 = f39038OooO0Oo[i22];
            o0oooo1.OooO0OO(iArr4[0], iArr4[1], zOooO0oO2);
            if (i22 < 8) {
                o0oooo1.OooO0OO((o0oooo1.f39040OooO0O0 - i22) - 1, 8, zOooO0oO2);
            } else {
                o0oooo1.OooO0OO(8, (i22 - 8) + (o0oooo1.f39041OooO0OO - 7), zOooO0oO2);
            }
            i22++;
        }
        int i24 = o000oooo2.f39024OooO00o;
        if (i24 >= 7) {
            o00000O o00000o4 = new o00000O();
            o00000o4.OooO0o0(i24, 6);
            o00000o4.OooO0o0(OooO0O0(o000oooo2.f39024OooO00o, 7973), 12);
            if (o00000o4.f38937OoooO00 != 18) {
                throw new WriterException("should not happen but we got: " + o00000o4.f38937OoooO00);
            }
            int i25 = 17;
            for (int i26 = 0; i26 < 6; i26++) {
                for (int i27 = 0; i27 < 3; i27++) {
                    ...
                    i25--;
                    o0oooo1.OooO0OO(i26, (o0oooo1.f39041OooO0OO - 11) + i27, zOooO0oO3);
                    o0oooo1.OooO0OO((o0oooo1.f39041OooO0OO - 11) + i27, i26, zOooO0oO3);
                }
            }
        }
        int i28 = o0oooo1.f39040OooO0O0 - 1;
        int i29 = o0oooo1.f39041OooO0OO - 1;
        int i30 = 0;
        int i31 = -1;
        while (i28 > 0) {
            if (i28 == 6) {
            ...
            while (i29 >= 0 && i29 < o0oooo1.f39041OooO0OO) {
                for (int i32 = 0; i32 < 2; i32++) {
                    int i33 = i28 - i32;
                    if (OooO0oO(o0oooo1.OooO00o(i33, i29))) {
                        if (i30 < o00000o.f38937OoooO00) {
        ...
        throw new WriterException("Not all bits consumed: " + i30 + '/' + o00000o.f38937OoooO00);
    }
