...
import p428o0OoO0OO.o0Oo0oo;
import p550o0oO0O00.o000O00O;

/* JADX INFO: loaded from: classes2.dex */
public final class OooO0o implements OooO0OO {

    /* JADX INFO: renamed from: OoooO, reason: collision with root package name */
    public final float[] f39835OoooO;

    /* JADX INFO: renamed from: OoooO0, reason: collision with root package name */
    public FloatBuffer f39836OoooO0;

    /* JADX INFO: renamed from: OoooOO0, reason: collision with root package name */
    public int f39839OoooOO0;

    /* JADX INFO: renamed from: OoooOOO, reason: collision with root package name */
    public int f39840OoooOOO;

    /* JADX INFO: renamed from: OoooOOo, reason: collision with root package name */
    public int f39841OoooOOo;

    /* JADX INFO: renamed from: OoooOo0, reason: collision with root package name */
    public int f39842OoooOo0;

    /* JADX INFO: renamed from: OoooOoO, reason: collision with root package name */
    public int f39843OoooOoO;

    /* JADX INFO: renamed from: Ooooo0o, reason: collision with root package name */
    public SurfaceTexture f39846Ooooo0o;

    /* JADX INFO: renamed from: OooooO0, reason: collision with root package name */
    public OooO0OO.OooO00o f39847OooooO0;

    /* JADX INFO: renamed from: OooooOo, reason: collision with root package name */
    @NotNull
    public final o0Oo0oo f39849OooooOo;

    /* JADX INFO: renamed from: o000oOoO, reason: collision with root package name */
    public int f39850o000oOoO;

    /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
    public final int f39834Oooo = 20;

    /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
    public float[] f39837OoooO00 = {-1.0f, -1.0f, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, 0.5f, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, 1.0f, -1.0f, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, 1.0f, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, -1.0f, 1.0f, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, 0.5f, 1.0f, 1.0f, 1.0f, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, 1.0f, 1.0f};

    /* JADX INFO: renamed from: OoooO0O, reason: collision with root package name */
    public final float[] f39838OoooO0O = new float[16];

    /* JADX INFO: renamed from: OoooOoo, reason: collision with root package name */
    public final AtomicBoolean f39844OoooOoo = new AtomicBoolean(false);

    /* JADX INFO: renamed from: Ooooo00, reason: collision with root package name */
    public final AtomicBoolean f39845Ooooo00 = new AtomicBoolean(false);

    /* JADX INFO: renamed from: OooooOO, reason: collision with root package name */
    public ScaleType f39848OooooOO = ScaleType.ScaleAspectFill;

    public OooO0o(@NotNull o0Oo0oo o0oo0oo2) {
        this.f39849OooooOo = o0oo0oo2;
        float[] fArr = new float[16];
        this.f39835OoooO = fArr;
        FloatBuffer floatBufferAsFloatBuffer = ByteBuffer.allocateDirect(this.f39837OoooO00.length * 4).order(ByteOrder.nativeOrder()).asFloatBuffer();
        Intrinsics.checkExpressionValueIsNotNull(floatBufferAsFloatBuffer, "ByteBuffer.allocateDirec…eOrder()).asFloatBuffer()");
        this.f39836OoooO0 = floatBufferAsFloatBuffer;
        floatBufferAsFloatBuffer.put(this.f39837OoooO00).position(0);
        Matrix.setIdentityM(fArr, 0);
    }

    @Override // p425o0OoO0.OooO0OO
    public final void OooO00o() {
        this.f39844OoooOoo.compareAndSet(false, true);
        Log.i("VideoRender", "onFirstFrame:    canDraw = " + this.f39844OoooOoo.get());
        this.f39849OooooOo.requestRender();
    }

    @Override // p425o0OoO0.OooO0OO
    public final void OooO0O0() {
        this.f39844OoooOoo.compareAndSet(true, false);
        Log.i("VideoRender", "onCompletion:   canDraw = " + this.f39844OoooOoo.get());
        this.f39849OooooOo.requestRender();
    }

    @Override // p425o0OoO0.OooO0OO
    public final void OooO0OO(@NotNull OooO0OO.OooO00o oooO00o) {
        this.f39847OooooO0 = oooO00o;
    }
    ...
    public final void OooO0Oo(float f, float f2, float f3, float f4) {
        ...
        ScaleType scaleType = this.f39848OooooOO;
        float f9 = f / f2;
        float f10 = f3 / f4;
        ...
        switch (o000O00O.OooO00o.f44615OooO00o[scaleType.ordinal()]) {
            case 1:
                if (f9 > f10) {
        ...
        this.f39837OoooO00 = fArrOooO0O0;
    ...
    public final void onDrawFrame(@NotNull GL10 gl10) {
        if (this.f39845Ooooo00.compareAndSet(true, false)) {
            try {
                SurfaceTexture surfaceTexture = this.f39846Ooooo0o;
            ...
            SurfaceTexture surfaceTexture2 = this.f39846Ooooo0o;
            if (surfaceTexture2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("surfaceTexture");
            }
            surfaceTexture2.getTransformMatrix(this.f39835OoooO);
        }
        ...
        if (!this.f39844OoooOoo.get()) {
            GLES20.glFinish();
            return;
        }
        GLES20.glEnable(3042);
        GLES20.glBlendFunc(NativeConstants.TLS1_1_VERSION, NativeConstants.TLS1_2_VERSION);
        GLES20.glUseProgram(this.f39839OoooOO0);
        OooO0o0("glUseProgram");
        GLES20.glActiveTexture(33984);
        GLES20.glBindTexture(36197, this.f39850o000oOoO);
        this.f39836OoooO0.position(0);
        GLES20.glVertexAttribPointer(this.f39842OoooOo0, 3, 5126, false, this.f39834Oooo, (Buffer) this.f39836OoooO0);
        OooO0o0("glVertexAttribPointer maPosition");
        GLES20.glEnableVertexAttribArray(this.f39842OoooOo0);
        OooO0o0("glEnableVertexAttribArray aPositionHandle");
        this.f39836OoooO0.position(3);
        GLES20.glVertexAttribPointer(this.f39843OoooOoO, 3, 5126, false, this.f39834Oooo, (Buffer) this.f39836OoooO0);
        OooO0o0("glVertexAttribPointer aTextureHandle");
        GLES20.glEnableVertexAttribArray(this.f39843OoooOoO);
        OooO0o0("glEnableVertexAttribArray aTextureHandle");
        Matrix.setIdentityM(this.f39838OoooO0O, 0);
        GLES20.glUniformMatrix4fv(this.f39840OoooOOO, 1, false, this.f39838OoooO0O, 0);
        GLES20.glUniformMatrix4fv(this.f39841OoooOOo, 1, false, this.f39835OoooO, 0);
    ...
    public final void onFrameAvailable(@NotNull SurfaceTexture surfaceTexture) {
        this.f39845Ooooo00.compareAndSet(false, true);
        this.f39849OooooOo.requestRender();
    }
    ...
    public final void onSurfaceCreated(@NotNull GL10 gl10, @NotNull EGLConfig eGLConfig) {
        ...
        String vertexSource = o000O0O0.OooO0OO("vertex.sh", this.f39849OooooOo.getView().getResources());
        String fragmentSource = o000O0O0.OooO0OO("frag.sh", this.f39849OooooOo.getView().getResources());
        ...
        this.f39839OoooOO0 = iGlCreateProgram;
        if (iGlCreateProgram == 0) {
            return;
        }
        this.f39842OoooOo0 = GLES20.glGetAttribLocation(iGlCreateProgram, "aPosition");
        OooO0o0("glGetAttribLocation aPosition");
        if (this.f39842OoooOo0 == -1) {
            throw new RuntimeException("Could not get attrib location for aPosition");
        }
        this.f39843OoooOoO = GLES20.glGetAttribLocation(this.f39839OoooOO0, "aTextureCoord");
        OooO0o0("glGetAttribLocation aTextureCoord");
        if (this.f39843OoooOoO == -1) {
            throw new RuntimeException("Could not get attrib location for aTextureCoord");
        }
        this.f39840OoooOOO = GLES20.glGetUniformLocation(this.f39839OoooOO0, "uMVPMatrix");
        OooO0o0("glGetUniformLocation uMVPMatrix");
        if (this.f39840OoooOOO == -1) {
            throw new RuntimeException("Could not get attrib location for uMVPMatrix");
        }
        this.f39841OoooOOo = GLES20.glGetUniformLocation(this.f39839OoooOO0, "uSTMatrix");
        OooO0o0("glGetUniformLocation uSTMatrix");
        if (this.f39841OoooOOo == -1) {
            throw new RuntimeException("Could not get attrib location for uSTMatrix");
        }
        int[] iArr2 = new int[1];
        GLES20.glGenTextures(1, iArr2, 0);
        int i = iArr2[0];
        this.f39850o000oOoO = i;
        GLES20.glBindTexture(36197, i);
        OooO0o0("glBindTexture textureID");
        GLES20.glTexParameterf(36197, 10241, 9728);
        GLES20.glTexParameterf(36197, 10240, 9729);
        SurfaceTexture surfaceTexture = new SurfaceTexture(this.f39850o000oOoO);
        this.f39846Ooooo0o = surfaceTexture;
        surfaceTexture.setDefaultBufferSize(this.f39849OooooOo.getMeasuredWidth(), this.f39849OooooOo.getMeasuredHeight());
        SurfaceTexture surfaceTexture2 = this.f39846Ooooo0o;
        if (surfaceTexture2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("surfaceTexture");
        }
        surfaceTexture2.setOnFrameAvailableListener(this);
        SurfaceTexture surfaceTexture3 = this.f39846Ooooo0o;
        if (surfaceTexture3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("surfaceTexture");
        }
        Surface surface = new Surface(surfaceTexture3);
        OooO0OO.OooO00o oooO00o = this.f39847OooooO0;
        if (oooO00o != null) {
            oooO00o.OooO00o(surface);
        }
        this.f39845Ooooo00.compareAndSet(true, false);
    }

    @Override // p425o0OoO0.OooO0OO
    public final void setScaleType(@NotNull ScaleType scaleType) {
        this.f39848OooooOO = scaleType;
    }
}
