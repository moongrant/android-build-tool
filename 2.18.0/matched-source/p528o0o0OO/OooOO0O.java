...
public final class OooOO0O extends OooOo {
    ...
    public final void OooO0Oo(@NotNull MessageIM.Message msg, boolean z) throws InvalidProtocolBufferException {
        ...
        if ((value == null || fromId != value.longValue()) && !OooO0OO.OooO00o(msg.getMid())) {
            if (!(p493o0o00O00.OooO0OO.OooO00o().OooOOo().OooO0oo(((Number) OooO00o.OooO00o(oooOOO)).longValue(), msg.getMid()) != null) || z) {
                ...
                if (head == 1504) {
                    ...
                    oooOo00.OooO0oO(oooOo00.OooO0o(true, mid));
                    if (!OooO0OO() || (userInfoOooO00o = o00Oo0.OooO00o(msg.getFromId())) == null) {
                        return;
                    }
                    String strOooO0O0 = o00Ooo.f42780OooO00o.OooO0O0(msg.getFromId(), userInfoOooO00o.getUserName());
                    Intent intent = new Intent(App.f11473OoooO00, (Class<?>) PrivateChatActivity.class);
                    intent.putExtra(o00OOOO0.OooO00o.f31699OooO00o, msg.getFromId());
                ...
                if (head == 2103) {
                    ...
                    msg.getBody().OooO();
                    OooOo00 oooOo01 = OooOo00.f42259OooO00o;
                    ...
                    oooOo01.OooO0oO(oooOo01.OooOo0o(fromId2, content, mid2, msg.getTime(), true, from2.getWarn() == 1));
                    if (!OooO0OO() || (userInfoOooO00o2 = o00Oo0.OooO00o(msg.getFromId())) == null) {
                        return;
                    }
                    String strOooO0O1 = o00Ooo.f42780OooO00o.OooO0O0(msg.getFromId(), userInfoOooO00o2.getUserName());
                    Intent intent2 = new Intent(App.f11473OoooO00, (Class<?>) PrivateChatActivity.class);
                    intent2.putExtra(o00OOOO0.OooO00o.f31699OooO00o, msg.getFromId());
                    OooOO0 oooOO2 = OooOO0.f40366OooO00o;
                ...
                if (head == 2105) {
                    ...
                    OooOo00 oooOo02 = OooOo00.f42259OooO00o;
                    ...
                    ChatMessage chatMessageOooOO0O = OooOo00.OooOO0O(fromId3, giftId, number, giftURL, mid3, msg.getTime(), true, false, false, 384);
                    oooOo02.OooO0oO(chatMessageOooOO0O);
                    if (!OooO0OO() || (userInfoOooO00o3 = o00Oo0.OooO00o(msg.getFromId())) == null) {
                        return;
                    }
                    String strOooO0O2 = o00Ooo.f42780OooO00o.OooO0O0(msg.getFromId(), userInfoOooO00o3.getUserName());
                    Intent intent3 = new Intent(App.f11473OoooO00, (Class<?>) PrivateChatActivity.class);
                    intent3.putExtra(o00OOOO0.OooO00o.f31699OooO00o, msg.getFromId());
                    GiftPropModel giftPropModelOooO0O0 = oo0O.OooO0OO.f53343OooO00o.OooO0O0(from3.getGiftId());
                ...
                if (head == 2109) {
                    ...
                    OooOo00 oooOo03 = OooOo00.f42259OooO00o;
                    ...
                    oooOo03.OooO0oO(oooOo03.OooOoO0(fromId4, "", duration, url, mid4, msg.getTime(), true));
                    if (!OooO0OO() || (userInfoOooO00o4 = o00Oo0.OooO00o(msg.getFromId())) == null) {
                        return;
                    }
                    String strOooO0O3 = o00Ooo.f42780OooO00o.OooO0O0(msg.getFromId(), userInfoOooO00o4.getUserName());
                    Intent intent4 = new Intent(App.f11473OoooO00, (Class<?>) PrivateChatActivity.class);
                    intent4.putExtra(o00OOOO0.OooO00o.f31699OooO00o, msg.getFromId());
                ...
                if (head == 2115) {
                    ...
                    OooOo00 oooOo04 = OooOo00.f42259OooO00o;
                    ...
                    ChatMessage chatMessage = oooOo04.OooO0oo(fromId5, type, number2, mid5, msg.getTime(), true);
                    Intrinsics.checkNotNullParameter(chatMessage, "chatMessage");
                    p493o0o00O00.OooO0OO.OooO00o().OooOOo().OooOO0(chatMessage);
                    oooOo04.OooO0oO(chatMessage);
                    if (!OooO0OO() || (userInfoOooO00o5 = o00Oo0.OooO00o(msg.getFromId())) == null) {
                        return;
                    }
                    String strOooO0O4 = o00Ooo.f42780OooO00o.OooO0O0(msg.getFromId(), userInfoOooO00o5.getUserName());
                    Intent intent5 = new Intent(App.f11473OoooO00, (Class<?>) PrivateChatActivity.class);
                    intent5.putExtra(o00OOOO0.OooO00o.f31699OooO00o, msg.getFromId());
                ...
                if (head == 2124) {
                    ...
                    OooOo00 oooOo05 = OooOo00.f42259OooO00o;
                    ...
                    oooOo05.OooO0oO(oooOo05.OooOo0(fromId6, userId, prettyID, nickName, photo, msg2, mid6, msg.getTime(), true));
                    if (OooO0OO() && (userInfoOooO00o6 = o00Oo0.OooO00o(msg.getFromId())) != null) {
                        String strOooO0O5 = o00Ooo.f42780OooO00o.OooO0O0(msg.getFromId(), userInfoOooO00o6.getUserName());
                        Intent intent6 = new Intent(App.f11473OoooO00, (Class<?>) PrivateChatActivity.class);
                        intent6.putExtra(o00OOOO0.OooO00o.f31699OooO00o, msg.getFromId());
                ...
                if (head == 2140) {
                    ...
                    if (giftsList != null) {
                        ...
                        for (MessageIM.GiftIdUrl giftIdUrl : giftsList) {
                            OooOo00 oooOo06 = OooOo00.f42259OooO00o;
                            ...
                            ChatMessage chatMessageOooOO0O2 = OooOo00.OooOO0O(fromId7, iOooO0o0, 1, giftUrl, mid7, msg.getTime(), true, false, false, 384);
                            oooOo06.OooO0oO(chatMessageOooOO0O2);
                            if (OooO0OO() && (userInfoOooO00o7 = o00Oo0.OooO00o(msg.getFromId())) != null) {
                                String strOooO0O6 = o00Ooo.f42780OooO00o.OooO0O0(msg.getFromId(), userInfoOooO00o7.getUserName());
                                Intent intent7 = new Intent(App.f11473OoooO00, (Class<?>) PrivateChatActivity.class);
                                intent7.putExtra(o00OOOO0.OooO00o.f31699OooO00o, msg.getFromId());
                                GiftPropModel giftPropModelOooO0O1 = oo0O.OooO0OO.f53343OooO00o.OooO0O0(oOO00O.OooO0o0(Long.valueOf(giftIdUrl.getGiftId())));
                ...
                switch (head) {
                    case 2119:
                        ...
                        if (from8 != null) {
                            ...
                            OooOo00 oooOo07 = OooOo00.f42259OooO00o;
                            ...
                            oooOo07.OooO0oO(oooOo07.OooO(fromId8, gifid, gifurl, mid8, msg.getTime(), true));
                            if (OooO0OO() && (userInfoOooO00o8 = o00Oo0.OooO00o(msg.getFromId())) != null) {
                                String strOooO0O7 = o00Ooo.f42780OooO00o.OooO0O0(msg.getFromId(), userInfoOooO00o8.getUserName());
                                Intent intent8 = new Intent(App.f11473OoooO00, (Class<?>) PrivateChatActivity.class);
                                intent8.putExtra(o00OOOO0.OooO00o.f31699OooO00o, msg.getFromId());
                    ...
                    case 2120:
                        ...
                        if (from9 != null) {
                            ...
                            OooOo00 oooOo08 = OooOo00.f42259OooO00o;
                            ...
                            oooOo08.OooO0oO(oooOo08.OooOOo0(fromId9, i64RoomId, i64RoomIdx, name, image, roomIp, msg3, mid9, msg.getTime(), true));
                            if (OooO0OO() && (userInfoOooO00o9 = o00Oo0.OooO00o(msg.getFromId())) != null) {
                                String strOooO0O8 = o00Ooo.f42780OooO00o.OooO0O0(msg.getFromId(), userInfoOooO00o9.getUserName());
                                Intent intent9 = new Intent(App.f11473OoooO00, (Class<?>) PrivateChatActivity.class);
                                intent9.putExtra(o00OOOO0.OooO00o.f31699OooO00o, msg.getFromId());
                    ...
                    case 2121:
                        ...
                        if (from10 != null) {
                            ...
                            OooOo00 oooOo09 = OooOo00.f42259OooO00o;
                            ...
                            oooOo09.OooO0oO(oooOo09.OooOOOO(fromId10, momentId, image2, text, type2, msg4, mid10, msg.getTime(), true));
                            if (OooO0OO() && (userInfoOooO00o10 = o00Oo0.OooO00o(msg.getFromId())) != null) {
                                String strOooO0O9 = o00Ooo.f42780OooO00o.OooO0O0(msg.getFromId(), userInfoOooO00o10.getUserName());
                                Intent intent10 = new Intent(App.f11473OoooO00, (Class<?>) PrivateChatActivity.class);
                                intent10.putExtra(o00OOOO0.OooO00o.f31699OooO00o, msg.getFromId());
                    ...
                    case 2122:
                        ...
                        if (from11 != null) {
                            ...
                            OooOo00 oooOo010 = OooOo00.f42259OooO00o;
                            ...
                            oooOo010.OooO0oO(oooOo010.OooOOoo(fromId11, circleId, image3, name2, userCount, momentCount, msg5, mid11, msg.getTime(), true));
                            if (OooO0OO() && (userInfoOooO00o11 = o00Oo0.OooO00o(msg.getFromId())) != null) {
                                String strOooO0O10 = o00Ooo.f42780OooO00o.OooO0O0(msg.getFromId(), userInfoOooO00o11.getUserName());
                                Intent intent11 = new Intent(App.f11473OoooO00, (Class<?>) PrivateChatActivity.class);
                                intent11.putExtra(o00OOOO0.OooO00o.f31699OooO00o, msg.getFromId());
                    ...
                    default:
                        switch (head) {
                            case 2127:
                                ...
                                OooOo00 oooOo011 = OooOo00.f42259OooO00o;
                                ...
                                oooOo011.OooO0oO(oooOo011.OooOO0o(fromId12, image4, txt1, txt2, url2, msg6, mid12, msg.getTime(), true));
                                if (OooO0OO() && (userInfoOooO00o12 = o00Oo0.OooO00o(msg.getFromId())) != null) {
                                    String strOooO0O11 = o00Ooo.f42780OooO00o.OooO0O0(msg.getFromId(), userInfoOooO00o12.getUserName());
                                    Intent intent12 = new Intent(App.f11473OoooO00, (Class<?>) PrivateChatActivity.class);
                                    intent12.putExtra(o00OOOO0.OooO00o.f31699OooO00o, msg.getFromId());
                            ...
                            case 2128:
                                ...
                                if (from13 != null) {
                                    ...
                                    OooOo00 oooOo012 = OooOo00.f42259OooO00o;
                                    ...
                                    ChatMessage chatMessageOooO0O0 = oooOo012.OooO0O0(mid13, fromId13, time, true);
                                    ...
                                    oooOo012.OooO0oO(chatMessageOooO0O0);
                                    if (!OooO0OO() || (userInfoOooO00o13 = o00Oo0.OooO00o(msg.getFromId())) == null) {
                                        oooOO0O = this;
                                    } else {
                                        String strOooO0O12 = o00Ooo.f42780OooO00o.OooO0O0(msg.getFromId(), userInfoOooO00o13.getUserName());
                                        Intent intent13 = new Intent(App.f11473OoooO00, (Class<?>) PrivateChatActivity.class);
                                        intent13.putExtra(o00OOOO0.OooO00o.f31699OooO00o, msg.getFromId());
                                        oooOO0O = this;
                            ...
                            case 2129:
                                ...
                                if (from14 != null) {
                                    ...
                                    OooOo00 oooOo013 = OooOo00.f42259OooO00o;
                                    ...
                                    oooOo013.OooO0oO(oooOo013.OooOOO(fromId14, eventId, eventName, pic, keyWord, startTime, endTime, roomId, roomName, roomIp2, mid14, msg.getTime(), true));
                                    if (OooO0OO() && (userInfoOooO00o14 = o00Oo0.OooO00o(msg.getFromId())) != null) {
                                        String strOooO0O13 = o00Ooo.f42780OooO00o.OooO0O0(msg.getFromId(), userInfoOooO00o14.getUserName());
                                        Intent intent14 = new Intent(App.f11473OoooO00, (Class<?>) PrivateChatActivity.class);
                                        intent14.putExtra(o00OOOO0.OooO00o.f31699OooO00o, msg.getFromId());
                            ...
                            default:
                                ...
                                OooOo00 oooOo014 = OooOo00.f42259OooO00o;
                                ...
                                ChatMessage chatMessageOooO0O1 = oooOo014.OooO0O0(mid15, fromId15, time2, true);
                                chatMessageOooO0O1.setContentType(100);
                                chatMessageOooO0O1.setUnknownMessage(messageContent);
                                p493o0o00O00.OooO0OO.OooO00o().OooOOo().OooOO0(chatMessageOooO0O1);
                                oooOo014.OooO0oO(chatMessageOooO0O1);
                                if (!OooO0OO() || (userInfoOooO00o15 = o00Oo0.OooO00o(msg.getFromId())) == null) {
                                    return;
                                }
                                String strOooO0O14 = o00Ooo.f42780OooO00o.OooO0O0(msg.getFromId(), userInfoOooO00o15.getUserName());
                                Intent intent15 = new Intent(App.f11473OoooO00, (Class<?>) PrivateChatActivity.class);
                                intent15.putExtra(o00OOOO0.OooO00o.f31699OooO00o, msg.getFromId());
    ...
    public final void OooO0o0(MessageIM.Message message, String str) {
        ...
        OooOo00.f42259OooO00o.OooO0oO(OooOo00.f42259OooO00o.OooOo0o(message.getFromId(), str, (60 & 4) != 0 ? "" : o0OoOo0.f43152OooO00o.OooO00o(Long.valueOf(message.getFromId())), (60 & 8) != 0 ? 0L : message.getTime() + 1, (60 & 16) != 0 ? false : true, false));
        if (!OooO0OO() || (userInfoOooO00o = o00Oo0.OooO00o(message.getFromId())) == null) {
            return;
        }
        String strOooO0O0 = o00Ooo.f42780OooO00o.OooO0O0(message.getFromId(), userInfoOooO00o.getUserName());
        Intent intent = new Intent(App.f11473OoooO00, (Class<?>) PrivateChatActivity.class);
        intent.putExtra(o00OOOO0.OooO00o.f31699OooO00o, message.getFromId());
        OooOO0 oooOO1 = OooOO0.f40366OooO00o;
