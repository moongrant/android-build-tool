...
public final class d8 implements o00O0O {
    ...
    @NonNull
    public final Switch f49151OooO;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    @NonNull
    public final ConstraintLayout f49152OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NonNull
    public final AppCompatEditText f49153OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @NonNull
    public final AppCompatImageView f49154OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NonNull
    public final AppCompatTextView f49155OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @NonNull
    public final ConstraintLayout f49156OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @NonNull
    public final ImageView f49157OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    @NonNull
    public final SetLuckyNumberLayout f49158OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    @NonNull
    public final AppCompatTextView f49159OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    @NonNull
    public final AppCompatTextView f49160OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    @NonNull
    public final Switch f49161OooOO0O;

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    @NonNull
    public final AppCompatTextView f49162OooOO0o;

    public d8(@NonNull ConstraintLayout constraintLayout, @NonNull AppCompatEditText appCompatEditText, @NonNull AppCompatImageView appCompatImageView, @NonNull AppCompatTextView appCompatTextView, @NonNull ImageView imageView, @NonNull ConstraintLayout constraintLayout2, @NonNull SetLuckyNumberLayout setLuckyNumberLayout, @NonNull AppCompatTextView appCompatTextView2, @NonNull Switch r9, @NonNull AppCompatTextView appCompatTextView3, @NonNull Switch r11, @NonNull AppCompatTextView appCompatTextView4) {
        this.f49152OooO00o = constraintLayout;
        this.f49153OooO0O0 = appCompatEditText;
        this.f49154OooO0OO = appCompatImageView;
        this.f49155OooO0Oo = appCompatTextView;
        this.f49157OooO0o0 = imageView;
        this.f49156OooO0o = constraintLayout2;
        this.f49158OooO0oO = setLuckyNumberLayout;
        this.f49159OooO0oo = appCompatTextView2;
        this.f49151OooO = r9;
        this.f49160OooOO0 = appCompatTextView3;
        this.f49161OooOO0O = r11;
        this.f49162OooOO0o = appCompatTextView4;
    }
                                        ...
                                        if (r11 != null) {
                                            ...
                                            if (appCompatTextView4 != null) {
                                                ...
                                                if (((AppCompatTextView) o00Oo0.OooO00o(viewInflate, R.id.title)) != null) {
                                                    return new d8(constraintLayout, appCompatEditText, appCompatImageView, appCompatTextView, imageView, constraintLayout, setLuckyNumberLayout, appCompatTextView2, r9, appCompatTextView3, r11, appCompatTextView4);
                                                }
                                            }
                                        }
                                    }
