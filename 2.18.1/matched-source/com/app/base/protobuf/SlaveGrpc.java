...
public final class SlaveGrpc {
    ...
    public static final class SlaveBlockingStub extends o000O00O<SlaveBlockingStub> {
        public MessageIM.BanStatusOut banStatus(MessageIM.BanStatusIn banStatusIn) {
            return (MessageIM.BanStatusOut) o000O0.OooO0OO(getChannel(), SlaveGrpc.getBanStatusMethod(), getCallOptions(), banStatusIn);
        }

        public MessageEmpty.Empty confirm(MessageIM.ConfirmRequest confirmRequest) {
            return (MessageEmpty.Empty) o000O0.OooO0OO(getChannel(), SlaveGrpc.getConfirmMethod(), getCallOptions(), confirmRequest);
        }

        public MessageIM.FriendAddReply friendAdd(MessageIM.FriendAddRequest friendAddRequest) {
            return (MessageIM.FriendAddReply) o000O0.OooO0OO(getChannel(), SlaveGrpc.getFriendAddMethod(), getCallOptions(), friendAddRequest);
        }

        public MessageEmpty.Empty friendApply(MessageIM.FriendApplyRequest friendApplyRequest) {
            return (MessageEmpty.Empty) o000O0.OooO0OO(getChannel(), SlaveGrpc.getFriendApplyMethod(), getCallOptions(), friendApplyRequest);
        }

        public MessageEmpty.Empty friendBlock(MessageIM.FriendBlockRequest friendBlockRequest) {
            return (MessageEmpty.Empty) o000O0.OooO0OO(getChannel(), SlaveGrpc.getFriendBlockMethod(), getCallOptions(), friendBlockRequest);
        }

        public MessageIM.FriendCheckReply friendCheck(MessageIM.FriendCheckRequest friendCheckRequest) {
            return (MessageIM.FriendCheckReply) o000O0.OooO0OO(getChannel(), SlaveGrpc.getFriendCheckMethod(), getCallOptions(), friendCheckRequest);
        }

        public MessageEmpty.Empty friendDelete(MessageIM.FriendDeleteRequest friendDeleteRequest) {
            return (MessageEmpty.Empty) o000O0.OooO0OO(getChannel(), SlaveGrpc.getFriendDeleteMethod(), getCallOptions(), friendDeleteRequest);
        }

        public MessageEmpty.Empty friendUnblock(MessageIM.FriendUnblockRequest friendUnblockRequest) {
            return (MessageEmpty.Empty) o000O0.OooO0OO(getChannel(), SlaveGrpc.getFriendUnblockMethod(), getCallOptions(), friendUnblockRequest);
        }

        public MessageEmpty.Empty gifEmoticon(MessageIM.GifEmoticonIn gifEmoticonIn) {
            return (MessageEmpty.Empty) o000O0.OooO0OO(getChannel(), SlaveGrpc.getGifEmoticonMethod(), getCallOptions(), gifEmoticonIn);
        }
        ...
        public Iterator<MessageIM.NotifyReply> notify(MessageIM.NotifyRequest notifyRequest) {
            ...
            Logger logger = o000O0.f48863OooO00o;
            o000O0.OooO0OO oooO0OO = new o000O0.OooO0OO();
            OooO0o oooO0oOooO00o = channel.OooO00o(notifyMethod, callOptions.OooO00o(oooO0OO));
            o000O0.OooO00o oooO00o = new o000O0.OooO00o(oooO0oOooO00o, oooO0OO);
            o000O0.OooO00o(oooO0oOooO00o);
            return oooO00o;
        }

        public MessageIM.ReceiveReply receive(MessageIM.ReceiveRequest receiveRequest) {
            return (MessageIM.ReceiveReply) o000O0.OooO0OO(getChannel(), SlaveGrpc.getReceiveMethod(), getCallOptions(), receiveRequest);
        }

        public MessageIM.SayReply say(MessageIM.SayRequest sayRequest) {
            return (MessageIM.SayReply) o000O0.OooO0OO(getChannel(), SlaveGrpc.getSayMethod(), getCallOptions(), sayRequest);
        }

        public MessageIM.SendEmoticonReply sendEmoticon(MessageIM.SendEmoticonRequest sendEmoticonRequest) {
            return (MessageIM.SendEmoticonReply) o000O0.OooO0OO(getChannel(), SlaveGrpc.getSendEmoticonMethod(), getCallOptions(), sendEmoticonRequest);
        }

        public MessageIM.SendGiftReply sendGift(MessageIM.SendGiftRequest sendGiftRequest) {
            return (MessageIM.SendGiftReply) o000O0.OooO0OO(getChannel(), SlaveGrpc.getSendGiftMethod(), getCallOptions(), sendGiftRequest);
        }

        public MessageIM.SendVoiceReply sendVoice(MessageIM.SendVoiceRequest sendVoiceRequest) {
            return (MessageIM.SendVoiceReply) o000O0.OooO0OO(getChannel(), SlaveGrpc.getSendVoiceMethod(), getCallOptions(), sendVoiceRequest);
        }

        public MessageEmpty.Empty shareRoom(MessageIM.ShareRoomIn shareRoomIn) {
            return (MessageEmpty.Empty) o000O0.OooO0OO(getChannel(), SlaveGrpc.getShareRoomMethod(), getCallOptions(), shareRoomIn);
        }

        public MessageIM.UserInfoReply userInfo(MessageIM.UserInfoRequest userInfoRequest) {
            return (MessageIM.UserInfoReply) o000O0.OooO0OO(getChannel(), SlaveGrpc.getUserInfoMethod(), getCallOptions(), userInfoRequest);
        }
    ...
    public static final class SlaveFutureStub extends o000O00O<SlaveFutureStub> {
        public com.google.common.util.concurrent.OooO0OO<MessageIM.BanStatusOut> banStatus(MessageIM.BanStatusIn banStatusIn) {
            return o000O0.OooO0o0(getChannel().OooO00o(SlaveGrpc.getBanStatusMethod(), getCallOptions()));
        }

        public com.google.common.util.concurrent.OooO0OO<MessageEmpty.Empty> confirm(MessageIM.ConfirmRequest confirmRequest) {
            return o000O0.OooO0o0(getChannel().OooO00o(SlaveGrpc.getConfirmMethod(), getCallOptions()));
        }
        ...
        public com.google.common.util.concurrent.OooO0OO<MessageIM.FriendAddReply> friendAdd(MessageIM.FriendAddRequest friendAddRequest) {
            return o000O0.OooO0o0(getChannel().OooO00o(SlaveGrpc.getFriendAddMethod(), getCallOptions()));
        }
        ...
        public com.google.common.util.concurrent.OooO0OO<MessageEmpty.Empty> friendApply(MessageIM.FriendApplyRequest friendApplyRequest) {
            return o000O0.OooO0o0(getChannel().OooO00o(SlaveGrpc.getFriendApplyMethod(), getCallOptions()));
        }
        ...
        public com.google.common.util.concurrent.OooO0OO<MessageEmpty.Empty> friendBlock(MessageIM.FriendBlockRequest friendBlockRequest) {
            return o000O0.OooO0o0(getChannel().OooO00o(SlaveGrpc.getFriendBlockMethod(), getCallOptions()));
        }
        ...
        public com.google.common.util.concurrent.OooO0OO<MessageIM.FriendCheckReply> friendCheck(MessageIM.FriendCheckRequest friendCheckRequest) {
            return o000O0.OooO0o0(getChannel().OooO00o(SlaveGrpc.getFriendCheckMethod(), getCallOptions()));
        }
        ...
        public com.google.common.util.concurrent.OooO0OO<MessageEmpty.Empty> friendDelete(MessageIM.FriendDeleteRequest friendDeleteRequest) {
            return o000O0.OooO0o0(getChannel().OooO00o(SlaveGrpc.getFriendDeleteMethod(), getCallOptions()));
        }
        ...
        public com.google.common.util.concurrent.OooO0OO<MessageIM.SendEmoticonReply> sendEmoticon(MessageIM.SendEmoticonRequest sendEmoticonRequest) {
            return o000O0.OooO0o0(getChannel().OooO00o(SlaveGrpc.getSendEmoticonMethod(), getCallOptions()));
        }
        ...
        public com.google.common.util.concurrent.OooO0OO<MessageIM.SendGiftReply> sendGift(MessageIM.SendGiftRequest sendGiftRequest) {
            return o000O0.OooO0o0(getChannel().OooO00o(SlaveGrpc.getSendGiftMethod(), getCallOptions()));
        }
        ...
        public com.google.common.util.concurrent.OooO0OO<MessageIM.SendVoiceReply> sendVoice(MessageIM.SendVoiceRequest sendVoiceRequest) {
            return o000O0.OooO0o0(getChannel().OooO00o(SlaveGrpc.getSendVoiceMethod(), getCallOptions()));
        }

        public com.google.common.util.concurrent.OooO0OO<MessageEmpty.Empty> shareRoom(MessageIM.ShareRoomIn shareRoomIn) {
            return o000O0.OooO0o0(getChannel().OooO00o(SlaveGrpc.getShareRoomMethod(), getCallOptions()));
        }
        ...
        public com.google.common.util.concurrent.OooO0OO<MessageIM.UserInfoReply> userInfo(MessageIM.UserInfoRequest userInfoRequest) {
            return o000O0.OooO0o0(getChannel().OooO00o(SlaveGrpc.getUserInfoMethod(), getCallOptions()));
        }
    ...
    public static abstract class SlaveImplBase {
        public void banStatus(MessageIM.BanStatusIn banStatusIn, o000O0O0<MessageIM.BanStatusOut> o000o0o1) {
            o000OO0O.OooO00o(SlaveGrpc.getBanStatusMethod(), o000o0o1);
        }
        ...
        public final o0OoOo0 bindService() {
            ...
            oooO0O0.OooO00o(notifyMethod, new o000OO0O.OooO00o());
            ...
            oooO0O0.OooO00o(receiveMethod, new o000OO0O.OooO00o());
            ...
            oooO0O0.OooO00o(sendGiftMethod, new o000OO0O.OooO00o());
            ...
            oooO0O0.OooO00o(sendVoiceMethod, new o000OO0O.OooO00o());
            ...
            oooO0O0.OooO00o(gifEmoticonMethod, new o000OO0O.OooO00o());
            ...
            oooO0O0.OooO00o(friendAddMethod, new o000OO0O.OooO00o());
            ...
            oooO0O0.OooO00o(friendDeleteMethod, new o000OO0O.OooO00o());
            ...
            oooO0O0.OooO00o(friendApplyMethod, new o000OO0O.OooO00o());
            ...
            oooO0O0.OooO00o(userInfoMethod, new o000OO0O.OooO00o());
            ...
            oooO0O0.OooO00o(friendCheckMethod, new o000OO0O.OooO00o());
            ...
            oooO0O0.OooO00o(friendBlockMethod, new o000OO0O.OooO00o());
            ...
            oooO0O0.OooO00o(friendUnblockMethod, new o000OO0O.OooO00o());
            ...
            oooO0O0.OooO00o(sendEmoticonMethod, new o000OO0O.OooO00o());
            ...
            oooO0O0.OooO00o(banStatusMethod, new o000OO0O.OooO00o());
            ...
            oooO0O0.OooO00o(shareRoomMethod, new o000OO0O.OooO00o());
            return oooO0O0.OooO0O0();
        }

        public void confirm(MessageIM.ConfirmRequest confirmRequest, o000O0O0<MessageEmpty.Empty> o000o0o1) {
            o000OO0O.OooO00o(SlaveGrpc.getConfirmMethod(), o000o0o1);
        }

        public void friendAdd(MessageIM.FriendAddRequest friendAddRequest, o000O0O0<MessageIM.FriendAddReply> o000o0o1) {
            o000OO0O.OooO00o(SlaveGrpc.getFriendAddMethod(), o000o0o1);
        }

        public void friendApply(MessageIM.FriendApplyRequest friendApplyRequest, o000O0O0<MessageEmpty.Empty> o000o0o1) {
            o000OO0O.OooO00o(SlaveGrpc.getFriendApplyMethod(), o000o0o1);
        }

        public void friendBlock(MessageIM.FriendBlockRequest friendBlockRequest, o000O0O0<MessageEmpty.Empty> o000o0o1) {
            o000OO0O.OooO00o(SlaveGrpc.getFriendBlockMethod(), o000o0o1);
        }

        public void friendCheck(MessageIM.FriendCheckRequest friendCheckRequest, o000O0O0<MessageIM.FriendCheckReply> o000o0o1) {
            o000OO0O.OooO00o(SlaveGrpc.getFriendCheckMethod(), o000o0o1);
        }

        public void friendDelete(MessageIM.FriendDeleteRequest friendDeleteRequest, o000O0O0<MessageEmpty.Empty> o000o0o1) {
            o000OO0O.OooO00o(SlaveGrpc.getFriendDeleteMethod(), o000o0o1);
        }

        public void friendUnblock(MessageIM.FriendUnblockRequest friendUnblockRequest, o000O0O0<MessageEmpty.Empty> o000o0o1) {
            o000OO0O.OooO00o(SlaveGrpc.getFriendUnblockMethod(), o000o0o1);
        }

        public void gifEmoticon(MessageIM.GifEmoticonIn gifEmoticonIn, o000O0O0<MessageEmpty.Empty> o000o0o1) {
            o000OO0O.OooO00o(SlaveGrpc.getGifEmoticonMethod(), o000o0o1);
        }

        public void notify(MessageIM.NotifyRequest notifyRequest, o000O0O0<MessageIM.NotifyReply> o000o0o1) {
            o000OO0O.OooO00o(SlaveGrpc.getNotifyMethod(), o000o0o1);
        }

        public void receive(MessageIM.ReceiveRequest receiveRequest, o000O0O0<MessageIM.ReceiveReply> o000o0o1) {
            o000OO0O.OooO00o(SlaveGrpc.getReceiveMethod(), o000o0o1);
        }

        public void say(MessageIM.SayRequest sayRequest, o000O0O0<MessageIM.SayReply> o000o0o1) {
            o000OO0O.OooO00o(SlaveGrpc.getSayMethod(), o000o0o1);
        }

        public void sendEmoticon(MessageIM.SendEmoticonRequest sendEmoticonRequest, o000O0O0<MessageIM.SendEmoticonReply> o000o0o1) {
            o000OO0O.OooO00o(SlaveGrpc.getSendEmoticonMethod(), o000o0o1);
        }

        public void sendGift(MessageIM.SendGiftRequest sendGiftRequest, o000O0O0<MessageIM.SendGiftReply> o000o0o1) {
            o000OO0O.OooO00o(SlaveGrpc.getSendGiftMethod(), o000o0o1);
        }

        public void sendVoice(MessageIM.SendVoiceRequest sendVoiceRequest, o000O0O0<MessageIM.SendVoiceReply> o000o0o1) {
            o000OO0O.OooO00o(SlaveGrpc.getSendVoiceMethod(), o000o0o1);
        }

        public void shareRoom(MessageIM.ShareRoomIn shareRoomIn, o000O0O0<MessageEmpty.Empty> o000o0o1) {
            o000OO0O.OooO00o(SlaveGrpc.getShareRoomMethod(), o000o0o1);
        }

        public void userInfo(MessageIM.UserInfoRequest userInfoRequest, o000O0O0<MessageIM.UserInfoReply> o000o0o1) {
            o000OO0O.OooO00o(SlaveGrpc.getUserInfoMethod(), o000o0o1);
        }
    }

    public static final class SlaveStub extends o000O00O<SlaveStub> {
        public void banStatus(MessageIM.BanStatusIn banStatusIn, o000O0O0<MessageIM.BanStatusOut> o000o0o1) {
            o000O0.OooO0O0(getChannel().OooO00o(SlaveGrpc.getBanStatusMethod(), getCallOptions()), o000o0o1);
        }

        public void confirm(MessageIM.ConfirmRequest confirmRequest, o000O0O0<MessageEmpty.Empty> o000o0o1) {
            o000O0.OooO0O0(getChannel().OooO00o(SlaveGrpc.getConfirmMethod(), getCallOptions()), o000o0o1);
        }

        public void friendAdd(MessageIM.FriendAddRequest friendAddRequest, o000O0O0<MessageIM.FriendAddReply> o000o0o1) {
            o000O0.OooO0O0(getChannel().OooO00o(SlaveGrpc.getFriendAddMethod(), getCallOptions()), o000o0o1);
        }

        public void friendApply(MessageIM.FriendApplyRequest friendApplyRequest, o000O0O0<MessageEmpty.Empty> o000o0o1) {
            o000O0.OooO0O0(getChannel().OooO00o(SlaveGrpc.getFriendApplyMethod(), getCallOptions()), o000o0o1);
        }

        public void friendBlock(MessageIM.FriendBlockRequest friendBlockRequest, o000O0O0<MessageEmpty.Empty> o000o0o1) {
            o000O0.OooO0O0(getChannel().OooO00o(SlaveGrpc.getFriendBlockMethod(), getCallOptions()), o000o0o1);
        }

        public void friendCheck(MessageIM.FriendCheckRequest friendCheckRequest, o000O0O0<MessageIM.FriendCheckReply> o000o0o1) {
            o000O0.OooO0O0(getChannel().OooO00o(SlaveGrpc.getFriendCheckMethod(), getCallOptions()), o000o0o1);
        }

        public void friendDelete(MessageIM.FriendDeleteRequest friendDeleteRequest, o000O0O0<MessageEmpty.Empty> o000o0o1) {
            o000O0.OooO0O0(getChannel().OooO00o(SlaveGrpc.getFriendDeleteMethod(), getCallOptions()), o000o0o1);
        }

        public void friendUnblock(MessageIM.FriendUnblockRequest friendUnblockRequest, o000O0O0<MessageEmpty.Empty> o000o0o1) {
            o000O0.OooO0O0(getChannel().OooO00o(SlaveGrpc.getFriendUnblockMethod(), getCallOptions()), o000o0o1);
        }

        public void gifEmoticon(MessageIM.GifEmoticonIn gifEmoticonIn, o000O0O0<MessageEmpty.Empty> o000o0o1) {
            o000O0.OooO0O0(getChannel().OooO00o(SlaveGrpc.getGifEmoticonMethod(), getCallOptions()), o000o0o1);
        }

        public void notify(MessageIM.NotifyRequest notifyRequest, o000O0O0<MessageIM.NotifyReply> o000o0o1) {
            o000O0.OooO0O0(getChannel().OooO00o(SlaveGrpc.getNotifyMethod(), getCallOptions()), o000o0o1);
        }

        public void receive(MessageIM.ReceiveRequest receiveRequest, o000O0O0<MessageIM.ReceiveReply> o000o0o1) {
            o000O0.OooO0O0(getChannel().OooO00o(SlaveGrpc.getReceiveMethod(), getCallOptions()), o000o0o1);
        }

        public void say(MessageIM.SayRequest sayRequest, o000O0O0<MessageIM.SayReply> o000o0o1) {
            o000O0.OooO0O0(getChannel().OooO00o(SlaveGrpc.getSayMethod(), getCallOptions()), o000o0o1);
        }

        public void sendEmoticon(MessageIM.SendEmoticonRequest sendEmoticonRequest, o000O0O0<MessageIM.SendEmoticonReply> o000o0o1) {
            o000O0.OooO0O0(getChannel().OooO00o(SlaveGrpc.getSendEmoticonMethod(), getCallOptions()), o000o0o1);
        }

        public void sendGift(MessageIM.SendGiftRequest sendGiftRequest, o000O0O0<MessageIM.SendGiftReply> o000o0o1) {
            o000O0.OooO0O0(getChannel().OooO00o(SlaveGrpc.getSendGiftMethod(), getCallOptions()), o000o0o1);
        }

        public void sendVoice(MessageIM.SendVoiceRequest sendVoiceRequest, o000O0O0<MessageIM.SendVoiceReply> o000o0o1) {
            o000O0.OooO0O0(getChannel().OooO00o(SlaveGrpc.getSendVoiceMethod(), getCallOptions()), o000o0o1);
        }

        public void shareRoom(MessageIM.ShareRoomIn shareRoomIn, o000O0O0<MessageEmpty.Empty> o000o0o1) {
            o000O0.OooO0O0(getChannel().OooO00o(SlaveGrpc.getShareRoomMethod(), getCallOptions()), o000o0o1);
        }

        public void userInfo(MessageIM.UserInfoRequest userInfoRequest, o000O0O0<MessageIM.UserInfoReply> o000o0o1) {
            o000O0.OooO0O0(getChannel().OooO00o(SlaveGrpc.getUserInfoMethod(), getCallOptions()), o000o0o1);
        }
        ...
        if (methodDescriptorOooO00o == null) {
            synchronized (SlaveGrpc.class) {
                ...
                if (methodDescriptorOooO00o == null) {
                    ...
                    oooO00oOooO0O0.f26352OooO0Oo = MethodDescriptor.OooO00o(SERVICE_NAME, "BanStatus");
                    ...
                    oooO00oOooO0O0.f26350OooO0O0 = new o0ooO0Oo.o000OO0O.OooO00o(MessageIM.BanStatusOut.getDefaultInstance());
        ...
        if (methodDescriptorOooO00o == null) {
            synchronized (SlaveGrpc.class) {
                ...
                if (methodDescriptorOooO00o == null) {
                    MethodDescriptor.OooO00o oooO00oOooO0O0 = MethodDescriptor.OooO0O0();
                    oooO00oOooO0O0.f26351OooO0OO = MethodDescriptor.MethodType.UNARY;
                    oooO00oOooO0O0.f26352OooO0Oo = MethodDescriptor.OooO00o(SERVICE_NAME, "Confirm");
                    oooO00oOooO0O0.f26353OooO0o0 = true;
                    MessageIM.ConfirmRequest defaultInstance = MessageIM.ConfirmRequest.getDefaultInstance();
                    int i = p637o0ooO0Oo.o000OO0O.f48860OooO00o;
                    oooO00oOooO0O0.f26349OooO00o = new o0ooO0Oo.o000OO0O.OooO00o(defaultInstance);
                    oooO00oOooO0O0.f26350OooO0O0 = new o0ooO0Oo.o000OO0O.OooO00o(MessageEmpty.Empty.getDefaultInstance());
                    methodDescriptorOooO00o = oooO00oOooO0O0.OooO00o();
        ...
        if (methodDescriptorOooO00o == null) {
            synchronized (SlaveGrpc.class) {
                ...
                if (methodDescriptorOooO00o == null) {
                    MethodDescriptor.OooO00o oooO00oOooO0O0 = MethodDescriptor.OooO0O0();
                    oooO00oOooO0O0.f26351OooO0OO = MethodDescriptor.MethodType.UNARY;
                    oooO00oOooO0O0.f26352OooO0Oo = MethodDescriptor.OooO00o(SERVICE_NAME, "FriendAdd");
                    oooO00oOooO0O0.f26353OooO0o0 = true;
                    MessageIM.FriendAddRequest defaultInstance = MessageIM.FriendAddRequest.getDefaultInstance();
                    int i = p637o0ooO0Oo.o000OO0O.f48860OooO00o;
                    oooO00oOooO0O0.f26349OooO00o = new o0ooO0Oo.o000OO0O.OooO00o(defaultInstance);
                    oooO00oOooO0O0.f26350OooO0O0 = new o0ooO0Oo.o000OO0O.OooO00o(MessageIM.FriendAddReply.getDefaultInstance());
                    methodDescriptorOooO00o = oooO00oOooO0O0.OooO00o();
        ...
        if (methodDescriptorOooO00o == null) {
            synchronized (SlaveGrpc.class) {
                ...
                if (methodDescriptorOooO00o == null) {
                    MethodDescriptor.OooO00o oooO00oOooO0O0 = MethodDescriptor.OooO0O0();
                    oooO00oOooO0O0.f26351OooO0OO = MethodDescriptor.MethodType.UNARY;
                    oooO00oOooO0O0.f26352OooO0Oo = MethodDescriptor.OooO00o(SERVICE_NAME, "FriendApply");
                    oooO00oOooO0O0.f26353OooO0o0 = true;
        ...
        if (methodDescriptorOooO00o == null) {
            synchronized (SlaveGrpc.class) {
                ...
                if (methodDescriptorOooO00o == null) {
                    MethodDescriptor.OooO00o oooO00oOooO0O0 = MethodDescriptor.OooO0O0();
                    oooO00oOooO0O0.f26351OooO0OO = MethodDescriptor.MethodType.UNARY;
                    oooO00oOooO0O0.f26352OooO0Oo = MethodDescriptor.OooO00o(SERVICE_NAME, "FriendBlock");
                    oooO00oOooO0O0.f26353OooO0o0 = true;
        ...
        if (methodDescriptorOooO00o == null) {
            synchronized (SlaveGrpc.class) {
                ...
                if (methodDescriptorOooO00o == null) {
                    MethodDescriptor.OooO00o oooO00oOooO0O0 = MethodDescriptor.OooO0O0();
                    oooO00oOooO0O0.f26351OooO0OO = MethodDescriptor.MethodType.UNARY;
                    oooO00oOooO0O0.f26352OooO0Oo = MethodDescriptor.OooO00o(SERVICE_NAME, "FriendCheck");
                    oooO00oOooO0O0.f26353OooO0o0 = true;
                    MessageIM.FriendCheckRequest defaultInstance = MessageIM.FriendCheckRequest.getDefaultInstance();
                    int i = p637o0ooO0Oo.o000OO0O.f48860OooO00o;
                    oooO00oOooO0O0.f26349OooO00o = new o0ooO0Oo.o000OO0O.OooO00o(defaultInstance);
                    oooO00oOooO0O0.f26350OooO0O0 = new o0ooO0Oo.o000OO0O.OooO00o(MessageIM.FriendCheckReply.getDefaultInstance());
                    methodDescriptorOooO00o = oooO00oOooO0O0.OooO00o();
        ...
        if (methodDescriptorOooO00o == null) {
            synchronized (SlaveGrpc.class) {
                ...
                if (methodDescriptorOooO00o == null) {
                    MethodDescriptor.OooO00o oooO00oOooO0O0 = MethodDescriptor.OooO0O0();
                    oooO00oOooO0O0.f26351OooO0OO = MethodDescriptor.MethodType.UNARY;
                    oooO00oOooO0O0.f26352OooO0Oo = MethodDescriptor.OooO00o(SERVICE_NAME, "FriendDelete");
                    oooO00oOooO0O0.f26353OooO0o0 = true;
        ...
        if (methodDescriptorOooO00o == null) {
            synchronized (SlaveGrpc.class) {
                ...
                if (methodDescriptorOooO00o == null) {
                    MethodDescriptor.OooO00o oooO00oOooO0O0 = MethodDescriptor.OooO0O0();
                    oooO00oOooO0O0.f26351OooO0OO = MethodDescriptor.MethodType.UNARY;
                    oooO00oOooO0O0.f26352OooO0Oo = MethodDescriptor.OooO00o(SERVICE_NAME, "FriendUnblock");
                    oooO00oOooO0O0.f26353OooO0o0 = true;
        ...
        if (methodDescriptorOooO00o == null) {
            synchronized (SlaveGrpc.class) {
                ...
                if (methodDescriptorOooO00o == null) {
                    MethodDescriptor.OooO00o oooO00oOooO0O0 = MethodDescriptor.OooO0O0();
                    oooO00oOooO0O0.f26351OooO0OO = MethodDescriptor.MethodType.UNARY;
                    oooO00oOooO0O0.f26352OooO0Oo = MethodDescriptor.OooO00o(SERVICE_NAME, "GifEmoticon");
                    oooO00oOooO0O0.f26353OooO0o0 = true;
    ...
    public static MethodDescriptor<MessageIM.NotifyRequest, MessageIM.NotifyReply> getNotifyMethod() {
        ...
        if (methodDescriptorOooO00o == null) {
            synchronized (SlaveGrpc.class) {
                ...
                if (methodDescriptorOooO00o == null) {
                    MethodDescriptor.OooO00o oooO00oOooO0O0 = MethodDescriptor.OooO0O0();
                    oooO00oOooO0O0.f26351OooO0OO = MethodDescriptor.MethodType.SERVER_STREAMING;
                    oooO00oOooO0O0.f26352OooO0Oo = MethodDescriptor.OooO00o(SERVICE_NAME, "Notify");
                    oooO00oOooO0O0.f26353OooO0o0 = true;
                    MessageIM.NotifyRequest defaultInstance = MessageIM.NotifyRequest.getDefaultInstance();
                    int i = p637o0ooO0Oo.o000OO0O.f48860OooO00o;
                    oooO00oOooO0O0.f26349OooO00o = new o0ooO0Oo.o000OO0O.OooO00o(defaultInstance);
                    oooO00oOooO0O0.f26350OooO0O0 = new o0ooO0Oo.o000OO0O.OooO00o(MessageIM.NotifyReply.getDefaultInstance());
                    methodDescriptorOooO00o = oooO00oOooO0O0.OooO00o();
        ...
        if (methodDescriptorOooO00o == null) {
            synchronized (SlaveGrpc.class) {
                ...
                if (methodDescriptorOooO00o == null) {
                    MethodDescriptor.OooO00o oooO00oOooO0O0 = MethodDescriptor.OooO0O0();
                    oooO00oOooO0O0.f26351OooO0OO = MethodDescriptor.MethodType.UNARY;
                    oooO00oOooO0O0.f26352OooO0Oo = MethodDescriptor.OooO00o(SERVICE_NAME, "Receive");
                    oooO00oOooO0O0.f26353OooO0o0 = true;
                    MessageIM.ReceiveRequest defaultInstance = MessageIM.ReceiveRequest.getDefaultInstance();
                    int i = p637o0ooO0Oo.o000OO0O.f48860OooO00o;
                    oooO00oOooO0O0.f26349OooO00o = new o0ooO0Oo.o000OO0O.OooO00o(defaultInstance);
                    oooO00oOooO0O0.f26350OooO0O0 = new o0ooO0Oo.o000OO0O.OooO00o(MessageIM.ReceiveReply.getDefaultInstance());
                    methodDescriptorOooO00o = oooO00oOooO0O0.OooO00o();
        ...
        if (methodDescriptorOooO00o == null) {
            synchronized (SlaveGrpc.class) {
                ...
                if (methodDescriptorOooO00o == null) {
                    MethodDescriptor.OooO00o oooO00oOooO0O0 = MethodDescriptor.OooO0O0();
                    oooO00oOooO0O0.f26351OooO0OO = MethodDescriptor.MethodType.UNARY;
                    oooO00oOooO0O0.f26352OooO0Oo = MethodDescriptor.OooO00o(SERVICE_NAME, "Say");
                    oooO00oOooO0O0.f26353OooO0o0 = true;
                    MessageIM.SayRequest defaultInstance = MessageIM.SayRequest.getDefaultInstance();
                    int i = p637o0ooO0Oo.o000OO0O.f48860OooO00o;
                    oooO00oOooO0O0.f26349OooO00o = new o0ooO0Oo.o000OO0O.OooO00o(defaultInstance);
                    oooO00oOooO0O0.f26350OooO0O0 = new o0ooO0Oo.o000OO0O.OooO00o(MessageIM.SayReply.getDefaultInstance());
                    methodDescriptorOooO00o = oooO00oOooO0O0.OooO00o();
        ...
        if (methodDescriptorOooO00o == null) {
            synchronized (SlaveGrpc.class) {
                ...
                if (methodDescriptorOooO00o == null) {
                    MethodDescriptor.OooO00o oooO00oOooO0O0 = MethodDescriptor.OooO0O0();
                    oooO00oOooO0O0.f26351OooO0OO = MethodDescriptor.MethodType.UNARY;
                    oooO00oOooO0O0.f26352OooO0Oo = MethodDescriptor.OooO00o(SERVICE_NAME, "SendEmoticon");
                    oooO00oOooO0O0.f26353OooO0o0 = true;
                    MessageIM.SendEmoticonRequest defaultInstance = MessageIM.SendEmoticonRequest.getDefaultInstance();
                    int i = p637o0ooO0Oo.o000OO0O.f48860OooO00o;
                    oooO00oOooO0O0.f26349OooO00o = new o0ooO0Oo.o000OO0O.OooO00o(defaultInstance);
                    oooO00oOooO0O0.f26350OooO0O0 = new o0ooO0Oo.o000OO0O.OooO00o(MessageIM.SendEmoticonReply.getDefaultInstance());
                    methodDescriptorOooO00o = oooO00oOooO0O0.OooO00o();
        ...
        if (methodDescriptorOooO00o == null) {
            synchronized (SlaveGrpc.class) {
                ...
                if (methodDescriptorOooO00o == null) {
                    MethodDescriptor.OooO00o oooO00oOooO0O0 = MethodDescriptor.OooO0O0();
                    oooO00oOooO0O0.f26351OooO0OO = MethodDescriptor.MethodType.UNARY;
                    oooO00oOooO0O0.f26352OooO0Oo = MethodDescriptor.OooO00o(SERVICE_NAME, "SendGift");
                    oooO00oOooO0O0.f26353OooO0o0 = true;
                    MessageIM.SendGiftRequest defaultInstance = MessageIM.SendGiftRequest.getDefaultInstance();
                    int i = p637o0ooO0Oo.o000OO0O.f48860OooO00o;
                    oooO00oOooO0O0.f26349OooO00o = new o0ooO0Oo.o000OO0O.OooO00o(defaultInstance);
                    oooO00oOooO0O0.f26350OooO0O0 = new o0ooO0Oo.o000OO0O.OooO00o(MessageIM.SendGiftReply.getDefaultInstance());
                    methodDescriptorOooO00o = oooO00oOooO0O0.OooO00o();
        ...
        if (methodDescriptorOooO00o == null) {
            synchronized (SlaveGrpc.class) {
                ...
                if (methodDescriptorOooO00o == null) {
                    MethodDescriptor.OooO00o oooO00oOooO0O0 = MethodDescriptor.OooO0O0();
                    oooO00oOooO0O0.f26351OooO0OO = MethodDescriptor.MethodType.UNARY;
                    oooO00oOooO0O0.f26352OooO0Oo = MethodDescriptor.OooO00o(SERVICE_NAME, "SendVoice");
                    oooO00oOooO0O0.f26353OooO0o0 = true;
                    MessageIM.SendVoiceRequest defaultInstance = MessageIM.SendVoiceRequest.getDefaultInstance();
                    int i = p637o0ooO0Oo.o000OO0O.f48860OooO00o;
                    oooO00oOooO0O0.f26349OooO00o = new o0ooO0Oo.o000OO0O.OooO00o(defaultInstance);
                    oooO00oOooO0O0.f26350OooO0O0 = new o0ooO0Oo.o000OO0O.OooO00o(MessageIM.SendVoiceReply.getDefaultInstance());
                    methodDescriptorOooO00o = oooO00oOooO0O0.OooO00o();
        ...
        if (methodDescriptorOooO00o == null) {
            synchronized (SlaveGrpc.class) {
                ...
                if (methodDescriptorOooO00o == null) {
                    MethodDescriptor.OooO00o oooO00oOooO0O0 = MethodDescriptor.OooO0O0();
                    oooO00oOooO0O0.f26351OooO0OO = MethodDescriptor.MethodType.UNARY;
                    oooO00oOooO0O0.f26352OooO0Oo = MethodDescriptor.OooO00o(SERVICE_NAME, "ShareRoom");
                    oooO00oOooO0O0.f26353OooO0o0 = true;
        ...
        if (methodDescriptorOooO00o == null) {
            synchronized (SlaveGrpc.class) {
                ...
                if (methodDescriptorOooO00o == null) {
                    MethodDescriptor.OooO00o oooO00oOooO0O0 = MethodDescriptor.OooO0O0();
                    oooO00oOooO0O0.f26351OooO0OO = MethodDescriptor.MethodType.UNARY;
                    oooO00oOooO0O0.f26352OooO0Oo = MethodDescriptor.OooO00o(SERVICE_NAME, "UserInfo");
                    oooO00oOooO0O0.f26353OooO0o0 = true;
                    MessageIM.UserInfoRequest defaultInstance = MessageIM.UserInfoRequest.getDefaultInstance();
                    int i = p637o0ooO0Oo.o000OO0O.f48860OooO00o;
                    oooO00oOooO0O0.f26349OooO00o = new o0ooO0Oo.o000OO0O.OooO00o(defaultInstance);
                    oooO00oOooO0O0.f26350OooO0O0 = new o0ooO0Oo.o000OO0O.OooO00o(MessageIM.UserInfoReply.getDefaultInstance());
                    methodDescriptorOooO00o = oooO00oOooO0O0.OooO00o();
    ...
    public static final class MethodHandlers<Req, Resp> {
        ...
        public void invoke(Req req, o000O0O0<Resp> o000o0o1) {
            switch (this.methodId) {
                case 0:
                    this.serviceImpl.notify((MessageIM.NotifyRequest) req, o000o0o1);
                    return;
                case 1:
                    this.serviceImpl.receive((MessageIM.ReceiveRequest) req, o000o0o1);
                    return;
                case 2:
                    this.serviceImpl.confirm((MessageIM.ConfirmRequest) req, o000o0o1);
                    return;
                case 3:
                    this.serviceImpl.say((MessageIM.SayRequest) req, o000o0o1);
                    return;
                case 4:
                    this.serviceImpl.sendGift((MessageIM.SendGiftRequest) req, o000o0o1);
                    return;
                case 5:
                    this.serviceImpl.sendVoice((MessageIM.SendVoiceRequest) req, o000o0o1);
                    return;
                case 6:
                    this.serviceImpl.gifEmoticon((MessageIM.GifEmoticonIn) req, o000o0o1);
                    return;
                case 7:
                    this.serviceImpl.friendAdd((MessageIM.FriendAddRequest) req, o000o0o1);
                    return;
                case 8:
                    this.serviceImpl.friendDelete((MessageIM.FriendDeleteRequest) req, o000o0o1);
                    return;
                case 9:
                    this.serviceImpl.friendApply((MessageIM.FriendApplyRequest) req, o000o0o1);
                    return;
                case 10:
                    this.serviceImpl.userInfo((MessageIM.UserInfoRequest) req, o000o0o1);
                    return;
                case 11:
                    this.serviceImpl.friendCheck((MessageIM.FriendCheckRequest) req, o000o0o1);
                    return;
                case 12:
                    this.serviceImpl.friendBlock((MessageIM.FriendBlockRequest) req, o000o0o1);
                    return;
                case 13:
                    this.serviceImpl.friendUnblock((MessageIM.FriendUnblockRequest) req, o000o0o1);
                    return;
                case 14:
                    this.serviceImpl.sendEmoticon((MessageIM.SendEmoticonRequest) req, o000o0o1);
                    return;
                case 15:
                    this.serviceImpl.banStatus((MessageIM.BanStatusIn) req, o000o0o1);
                    return;
                case 16:
                    this.serviceImpl.shareRoom((MessageIM.ShareRoomIn) req, o000o0o1);
                    return;
                default:
