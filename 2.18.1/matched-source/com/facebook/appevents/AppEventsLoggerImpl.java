...
public final class AppEventsLoggerImpl {
    ...
    public static final class Companion {
        ...
        public static final void m117initializeLib$lambda4(Context context, AppEventsLoggerImpl logger) {
        ...
        public final void initializeTimersIfNeeded() {
            synchronized (AppEventsLoggerImpl.access$getStaticLock$cp()) {
                ...
                OooOOO oooOOO = new Runnable() { // from class: com.facebook.appevents.OooOOO
                    @Override // java.lang.Runnable
                    public final void run() {
                        AppEventsLoggerImpl.Companion.m118initializeTimersIfNeeded$lambda6();
                    }
                };
                ...
                scheduledThreadPoolExecutorAccess$getBackgroundExecutor$cp.scheduleAtFixedRate(oooOOO, 0L, 86400L, TimeUnit.SECONDS);
            }
        }

        /* JADX INFO: Access modifiers changed from: private */
        /* JADX INFO: renamed from: initializeTimersIfNeeded$lambda-6, reason: not valid java name */
        public static final void m118initializeTimersIfNeeded$lambda6() {
        ...
        public final void augmentWebView(@NotNull WebView webView, @Nullable Context context) {
            ...
            Object[] array = StringsKt__StringsKt.split$default(RELEASE, new String[]{"."}, false, 0, 6, (Object) null).toArray(new String[0]);
        ...
        public final void initializeLib(@NotNull Context context, @Nullable String applicationId) {
            ...
            if (FacebookSdk.getAutoLogAppEventsEnabled()) {
                ...
                scheduledThreadPoolExecutorAccess$getBackgroundExecutor$cp.execute(new OooOOO0(context, appEventsLoggerImpl, 0));
            }
        }
    ...
    public final void logSdkEvent(@NotNull String eventName, @Nullable Double valueToSum, @Nullable Bundle parameters) {
        ...
        try {
            ...
            if (!StringsKt.OooOoOO(eventName, ACCOUNT_KIT_EVENT_NAME_PREFIX)) {
