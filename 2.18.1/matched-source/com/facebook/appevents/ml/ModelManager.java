        ...
        public static final class Companion {
            ...
            private final void deleteOldFiles(String useCase, int versionId) {
                ...
                while (i < length) {
                    ...
                    if (StringsKt.OooOoOO(name, useCase) && !StringsKt.OooOoOO(name, str)) {
                        file.delete();
                    }
                }
            }
            ...
            public static final void m153execute$lambda1(List slaves, File file) {
                ...
                if (modelBuild != null) {
                    ...
                    while (it.hasNext()) {
                        ...
                        sb.append('_');
                        TaskHandler.INSTANCE.download(taskHandler.getRuleUri(), o0ooOOo.OooO00o(sb, taskHandler.getVersionId(), "_rule"), new FileDownloadTask.Callback() { // from class: com.facebook.appevents.ml.OooO0o
    ...
    private final boolean isLocaleEnglish() {
        ...
        try {
            ...
            if (resourceLocale != null) {
                ...
                if (!StringsKt__StringsKt.contains$default(language, "en", false, 2, (Object) null)) {
                    return false;
                }
            }
            return true;
