...
public final class ServerProtocol {
    ...
    public static final String getDialogAuthority() {
        ...
        return OooO00o.OooO0OO.OooO00o(new Object[]{FacebookSdk.getFacebookDomain()}, 1, DIALOG_AUTHORITY_FORMAT, "java.lang.String.format(format, *args)");
    }
    ...
    public static final String getFacebookGraphUrlBase() {
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
        FacebookSdk facebookSdk = FacebookSdk.INSTANCE;
        return OooO00o.OooO0OO.OooO00o(new Object[]{FacebookSdk.getFacebookDomain()}, 1, GRAPH_URL_FORMAT, "java.lang.String.format(format, *args)");
    }
    ...
    public static final String getGraphUrlBase() {
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
        FacebookSdk facebookSdk = FacebookSdk.INSTANCE;
        return OooO00o.OooO0OO.OooO00o(new Object[]{FacebookSdk.getGraphDomain()}, 1, GRAPH_URL_FORMAT, "java.lang.String.format(format, *args)");
    }
    ...
    public static final String getGraphUrlBaseForSubdomain(@NotNull String subdomain) {
        ...
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
        return OooO00o.OooO0OO.OooO00o(new Object[]{subdomain}, 1, GRAPH_URL_FORMAT, "java.lang.String.format(format, *args)");
    }
    ...
    public static final String getGraphVideoUrlBase() {
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
        FacebookSdk facebookSdk = FacebookSdk.INSTANCE;
        return OooO00o.OooO0OO.OooO00o(new Object[]{FacebookSdk.getGraphDomain()}, 1, GRAPH_VIDEO_URL_FORMAT, "java.lang.String.format(format, *args)");
    }
    ...
    public static final String getInstagramDialogAuthority() {
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
        FacebookSdk facebookSdk = FacebookSdk.INSTANCE;
        return OooO00o.OooO0OO.OooO00o(new Object[]{FacebookSdk.getInstagramDomain()}, 1, DIALOG_AUTHORITY_FORMAT, "java.lang.String.format(format, *args)");
    }
