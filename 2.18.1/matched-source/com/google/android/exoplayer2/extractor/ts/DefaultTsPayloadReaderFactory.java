...
public final class DefaultTsPayloadReaderFactory implements TsPayloadReader.OooO0OO {
    ...
    public final int f14038OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final List<Format> f14039OooO0O0;
    ...
    public DefaultTsPayloadReaderFactory() {
        ...
        this.f14038OooO00o = 0;
        this.f14039OooO0O0 = immutableList;
    }
    ...
    public final TsPayloadReader OooO00o(int i, TsPayloadReader.OooO0O0 oooO0O0) {
        ...
        if (i == 3 || i == 4) {
            return new o00O0O(new o000oOoO(oooO0O0.f14289OooO00o));
        }
        if (i == 21) {
        ...
        if (i == 89) {
            return new o00O0O(new OooOO0O(oooO0O0.f14290OooO0O0));
        }
        if (i != 138) {
            if (i == 172) {
                return new o00O0O(new OooO0o(oooO0O0.f14289OooO00o));
            }
            if (i == 257) {
                    ...
                    if (i != 135) {
                        switch (i) {
                            case 15:
                                ...
                                return new o00O0O(new OooO(false, oooO0O0.f14289OooO00o));
                            case 16:
                            ...
                            case 17:
                                ...
                                return new o00O0O(new Oooo0(oooO0O0.f14289OooO00o));
                            default:
                                return null;
                        }
                    }
            ...
            return new o00O0O(new OooO0O0(oooO0O0.f14289OooO00o));
        }
        return new o00O0O(new OooOO0(oooO0O0.f14289OooO00o));
    }
    ...
    public final List<Format> OooO0O0(TsPayloadReader.OooO0O0 oooO0O0) {
        ...
        o000 o000Var = new o000(oooO0O0.f14291OooO0OO);
        ArrayList arrayList = this.f14039OooO0O0;
        while (o000Var.f36663OooO0OO - o000Var.f36662OooO0O0 > 0) {
            ...
            if (iOooOOo0 == 134) {
                ...
                int iOooOOo2 = o000Var.OooOOo0() & 31;
                for (int i2 = 0; i2 < iOooOOo2; i2++) {
                    String strOooOOO = o000Var.OooOOO(3);
                    ...
                    byte bOooOOo0 = (byte) o000Var.OooOOo0();
                    o000Var.OooOoo0(1);
                    ...
                    oooO0O1.f13156OooO0OO = strOooOOO;
                    oooO0O1.f13180OooOoo = i;
                    oooO0O1.f13166OooOOO0 = listSingletonList;
                    arrayList.add(new Format(oooO0O1));
                }
            }
            o000Var.OooOoOO(iOooOOo1);
            arrayList = arrayList;
        }
        return arrayList;
    }
