...
public final class zzbk extends zzaw {
    public zzbk() {
        this.f15899OooO00o.add(zzbl.ASSIGN);
        this.f15899OooO00o.add(zzbl.CONST);
        this.f15899OooO00o.add(zzbl.CREATE_ARRAY);
        this.f15899OooO00o.add(zzbl.CREATE_OBJECT);
        this.f15899OooO00o.add(zzbl.EXPRESSION_LIST);
        this.f15899OooO00o.add(zzbl.GET);
        this.f15899OooO00o.add(zzbl.GET_INDEX);
        this.f15899OooO00o.add(zzbl.GET_PROPERTY);
        this.f15899OooO00o.add(zzbl.NULL);
        this.f15899OooO00o.add(zzbl.SET_PROPERTY);
        this.f15899OooO00o.add(zzbl.TYPEOF);
        this.f15899OooO00o.add(zzbl.UNDEFINED);
        this.f15899OooO00o.add(zzbl.VAR);
    }
    ...
    public final zzap zza(String str, zzg zzgVar, List list) {
        ...
        int i = 0;
        if (iOrdinal == 3) {
            zzap zzapVarZzb = zzgVar.zzb((zzap) o000000O.OooO00o(zzbl.ASSIGN, 2, list, 0));
        ...
        if (iOrdinal == 33) {
            zzap zzapVarZzb5 = zzgVar.zzb((zzap) o000000O.OooO00o(zzbl.GET, 1, list, 0));
        ...
        if (iOrdinal == 58) {
            zzap zzapVarZzb6 = zzgVar.zzb((zzap) o000000O.OooO00o(zzbl.SET_PROPERTY, 3, list, 0));
        ...
        if (iOrdinal == 35 || iOrdinal == 36) {
            zzap zzapVarZzb12 = zzgVar.zzb((zzap) o000000O.OooO00o(zzbl.GET_PROPERTY, 2, list, 0));
        ...
        switch (iOrdinal) {
            case 62:
                zzap zzapVarZzb14 = zzgVar.zzb((zzap) o000000O.OooO00o(zzbl.TYPEOF, 1, list, 0));
