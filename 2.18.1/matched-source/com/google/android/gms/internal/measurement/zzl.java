...
public final class zzl extends zzam {
    ...
    public final zzab f15985Oooo0oO;

    public zzl(zzab zzabVar) {
        this.f15985Oooo0oO = zzabVar;
    }
    ...
    public final zzap zzbN(String str, zzg zzgVar, List list) {
        ...
        if (b == 0) {
            ...
            return new zzat(this.f15985Oooo0oO.zzb().zzd());
        }
        if (b == 1) {
            zzh.zzh("getParamValue", 1, list);
            return zzi.zzb(this.f15985Oooo0oO.zzb().zzc(zzgVar.zzb((zzap) list.get(0)).zzi()));
        }
        if (b == 2) {
            zzh.zzh("getParams", 0, list);
            Map mapZze = this.f15985Oooo0oO.zzb().zze();
        ...
        if (b == 3) {
            ...
            return new zzah(Double.valueOf(this.f15985Oooo0oO.zzb().zza()));
        }
        if (b != 4) {
            if (b != 5) {
            ...
            this.f15985Oooo0oO.zzb().zzg(strZzi, zzh.zzf(zzapVarZzb));
            return zzapVarZzb;
        }
        ...
        this.f15985Oooo0oO.zzb().zzf(zzapVarZzb2.zzi());
