...
import o0OO0OoO.o00OO000;
import o0OO0OoO.o0O;
import o0OO0OoO.o0O0o0;
...
public final class zzkz implements o000O0O0 {

    /* JADX INFO: renamed from: Oooo000, reason: collision with root package name */
    public static volatile zzkz f16282Oooo000;

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    public zzju f16283OooO;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final zzfp f16284OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final zzeu f16285OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public OooOO0O f16286OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public o0OO00O f16287OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public OooO0OO f16288OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public zzkl f16289OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final zzlb f16290OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public o00OO000 f16291OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public final zzko f16292OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public zzfg f16293OooOO0O;

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    public final zzfy f16294OooOO0o;

    /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
    public boolean f16295OooOOO;

    /* JADX INFO: renamed from: OooOOOO, reason: collision with root package name */
    @VisibleForTesting
    public long f16297OooOOOO;

    /* JADX INFO: renamed from: OooOOOo, reason: collision with root package name */
    public ArrayList f16298OooOOOo;

    /* JADX INFO: renamed from: OooOOo, reason: collision with root package name */
    public int f16299OooOOo;

    /* JADX INFO: renamed from: OooOOo0, reason: collision with root package name */
    public int f16300OooOOo0;

    /* JADX INFO: renamed from: OooOOoo, reason: collision with root package name */
    public boolean f16301OooOOoo;

    /* JADX INFO: renamed from: OooOo, reason: collision with root package name */
    public ArrayList f16302OooOo;

    /* JADX INFO: renamed from: OooOo0, reason: collision with root package name */
    public boolean f16303OooOo0;

    /* JADX INFO: renamed from: OooOo00, reason: collision with root package name */
    public boolean f16304OooOo00;

    /* JADX INFO: renamed from: OooOo0O, reason: collision with root package name */
    public FileLock f16305OooOo0O;

    /* JADX INFO: renamed from: OooOo0o, reason: collision with root package name */
    public FileChannel f16306OooOo0o;

    /* JADX INFO: renamed from: OooOoO, reason: collision with root package name */
    public long f16307OooOoO;

    /* JADX INFO: renamed from: OooOoO0, reason: collision with root package name */
    public ArrayList f16308OooOoO0;

    /* JADX INFO: renamed from: OooOoOO, reason: collision with root package name */
    public final HashMap f16309OooOoOO;

    /* JADX INFO: renamed from: OooOoo, reason: collision with root package name */
    public zzik f16310OooOoo;

    /* JADX INFO: renamed from: OooOoo0, reason: collision with root package name */
    public final HashMap f16311OooOoo0;

    /* JADX INFO: renamed from: OooOooO, reason: collision with root package name */
    public String f16312OooOooO;

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    public boolean f16296OooOOO0 = false;

    /* JADX INFO: renamed from: OooOooo, reason: collision with root package name */
    public final o0O f16313OooOooo = new o0O(this);

    public zzkz(zzla zzlaVar) {
        Preconditions.checkNotNull(zzlaVar);
        this.f16294OooOO0o = zzfy.zzp(zzlaVar.f16314OooO00o, null, null);
        this.f16307OooOoO = -1L;
        this.f16292OooOO0 = new zzko(this);
        zzlb zzlbVar = new zzlb(this);
        zzlbVar.zzX();
        this.f16290OooO0oO = zzlbVar;
        zzeu zzeuVar = new zzeu(this);
        zzeuVar.zzX();
        this.f16285OooO0O0 = zzeuVar;
        zzfp zzfpVar = new zzfp(this);
        zzfpVar.zzX();
        this.f16284OooO00o = zzfpVar;
        this.f16309OooOoOO = new HashMap();
        this.f16311OooOoo0 = new HashMap();
        zzaz().zzp(new o0O0o000(this, zzlaVar));
    }
    ...
    public static final oo0OOoo OooOooO(oo0OOoo oo0oooo) {
        if (oo0oooo == null) {
            throw new IllegalStateException("Upload Component not created");
        }
        if (oo0oooo.f37899OooO0OO) {
            return oo0oooo;
        }
        throw new IllegalStateException("Component not initialized: ".concat(String.valueOf(oo0oooo.getClass())));
    }

    public static zzkz zzt(Context context) {
        Preconditions.checkNotNull(context);
        Preconditions.checkNotNull(context.getApplicationContext());
        if (f16282Oooo000 == null) {
            synchronized (zzkz.class) {
                if (f16282Oooo000 == null) {
                    f16282Oooo000 = new zzkz((zzla) Preconditions.checkNotNull(new zzla(context)));
                }
            }
        }
        return f16282Oooo000;
    }
    ...
    public final void OooO(zzq zzqVar) {
        ...
        if (OooOoo(zzqVar)) {
            OooOO0O oooOO0O = this.f16286OooO0OO;
            OooOooO(oooOO0O);
            o000O o000oOooOo00 = oooOO0O.OooOo00(zzqVar.zza);
            if (o000oOooOo00 != null && TextUtils.isEmpty(o000oOooOo00.OoooO00()) && !TextUtils.isEmpty(zzqVar.zzb)) {
                o000oOooOo00.OooO(0L);
                OooOO0O oooOO0O2 = this.f16286OooO0OO;
                OooOooO(oooOO0O2);
                oooOO0O2.OooO0o0(o000oOooOo00);
                zzfp zzfpVar = this.f16284OooO00o;
                OooOooO(zzfpVar);
                String str11 = zzqVar.zza;
                zzfpVar.zzg();
                zzfpVar.f16176OooO0oo.remove(str11);
            }
            if (!zzqVar.zzh) {
                OooOooo(zzqVar);
                return;
            ...
            zzaq zzaqVarZzg = this.f16294OooOO0o.zzg();
            zzaqVarZzg.zzg();
            zzaqVarZzg.f16086OooO0o = null;
            zzaqVarZzg.f16088OooO0oO = 0L;
            int i = zzqVar.zzn;
            if (i != 0 && i != 1) {
                zzay().zzk().zzc("Incorrect app type, assuming installed app. appId, appType", zzeo.OooO0o0(zzqVar.zza), Integer.valueOf(i));
                i = 0;
            }
            OooOO0O oooOO0O3 = this.f16286OooO0OO;
            OooOooO(oooOO0O3);
            oooOO0O3.zzw();
            try {
                OooOO0O oooOO0O4 = this.f16286OooO0OO;
                OooOooO(oooOO0O4);
                oo0ooO oo0oooOooOoO0 = oooOO0O4.OooOoO0(zzqVar.zza, "_npa");
                if (oo0oooOooOoO0 != null && !DebugKt.DEBUG_PROPERTY_VALUE_AUTO.equals(oo0oooOooOoO0.f37907OooO0O0)) {
                    str = "_sysu";
                    ...
                    if (oo0oooOooOoO0 == null || !oo0oooOooOoO0.f37910OooO0o0.equals(zzlcVar.zzd)) {
                        OooOOOO(zzlcVar, zzqVar);
                    }
                } else {
                    str = "_sysu";
                    if (oo0oooOooOoO0 != null) {
                        OooOO0O(new zzlc("_npa", jCurrentTimeMillis, null, DebugKt.DEBUG_PROPERTY_VALUE_AUTO), zzqVar);
                    }
                }
                OooOO0O oooOO0O5 = this.f16286OooO0OO;
                OooOooO(oooOO0O5);
                o000O o000oOooOo01 = oooOO0O5.OooOo00((String) Preconditions.checkNotNull(zzqVar.zza));
                if (o000oOooOo01 == null || !zzv().Oooo000(zzqVar.zzb, o000oOooOo01.OoooO00(), zzqVar.zzq, o000oOooOo01.Oooo0O0())) {
                    str2 = "_sys";
                    str3 = "_pfo";
                } else {
                    zzay().zzk().zzb("New GMP App Id passed in. Removing cached database data. appId", zzeo.OooO0o0(o000oOooOo01.Oooo0o0()));
                    OooOO0O oooOO0O6 = this.f16286OooO0OO;
                    OooOooO(oooOO0O6);
                    String strOooo0o0 = o000oOooOo01.Oooo0o0();
                    oooOO0O6.OooO00o();
                    oooOO0O6.zzg();
                    ...
                    try {
                        ...
                        try {
                            ...
                            o000o = null;
                            try {
                                if (oooOO0O6.f37615OooO00o.zzf().zzs(null, zzeb.zzaB)) {
                                    iDelete += sQLiteDatabaseOooOOo.delete("default_event_params", "app_id=?", strArr);
                                }
                                if (iDelete > 0) {
                                    oooOO0O6.f37615OooO00o.zzay().zzj().zzc("Deleted application data. app, records", strOooo0o0, Integer.valueOf(iDelete));
                                }
                            } catch (SQLiteException e) {
                                e = e;
                                oooOO0O6.f37615OooO00o.zzay().zzd().zzc("Error deleting application data. appId, error", zzeo.OooO0o0(strOooo0o0), e);
                            }
                            ...
                            oooOO0O6.f37615OooO00o.zzay().zzd().zzc("Error deleting application data. appId, error", zzeo.OooO0o0(strOooo0o0), e);
                            o000oOooOo01 = o000o;
                            if (o000oOooOo01 != null) {
                                if (o000oOooOo01.OooOoOO() != -2147483648L) {
                                    z3 = false;
                                } else {
                                    z3 = false;
                                }
                                strOooo0oo = o000oOooOo01.Oooo0oo();
                                if (o000oOooOo01.OooOoOO() == -2147483648L) {
                                    z4 = false;
                                } else {
                                    z4 = false;
                            ...
                            OooOooo(zzqVar);
                            if (i == 0) {
                                OooOO0O oooOO0O7 = this.f16286OooO0OO;
                                OooOooO(oooOO0O7);
                                oooOOOOOooOo = oooOO0O7.OooOo(zzqVar.zza, "_f");
                                z = false;
                            } else {
                                OooOO0O oooOO0O8 = this.f16286OooO0OO;
                                OooOooO(oooOO0O8);
                            ...
                            if (oooOOOOOooOo == null) {
                                ...
                                if (z) {
                                    ...
                                    zzaz().zzg();
                                    zzfgVar = (zzfg) Preconditions.checkNotNull(this.f16293OooOO0O);
                                    str4 = zzqVar.zza;
                                    if (str4 != null) {
                                        zzfgVar.f16169OooO00o.zzay().zzm().zza("Install Referrer Reporter was called with invalid app package name");
                                        zzaz().zzg();
                                        OooO0O0();
                                        bundle2 = new Bundle();
                                        ...
                                        OooOO0O oooOO0O9 = this.f16286OooO0OO;
                                        OooOooO(oooOO0O9);
                                        Preconditions.checkNotEmpty(str8);
                                        oooOO0O9.zzg();
                                        oooOO0O9.OooO00o();
                                        jOooOOOo = oooOO0O9.OooOOOo(str8);
                                        if (this.f16294OooOO0o.zzau().getPackageManager() == null) {
                                            zzay().zzd().zzb("PackageManager is null, first open report might be inaccurate. appId", zzeo.OooO0o0(str8));
                                            str5 = str5;
                                        } else {
                                            try {
                                                packageInfo = Wrappers.packageManager(this.f16294OooOO0o.zzau()).getPackageInfo(str8, 0);
                                            ...
                                            try {
                                                applicationInfo2 = Wrappers.packageManager(this.f16294OooOO0o.zzau()).getApplicationInfo(str8, 0);
                                        ...
                                        str8 = (String) Preconditions.checkNotNull(zzqVar.zza);
                                        OooOO0O oooOO0O10 = this.f16286OooO0OO;
                                        OooOooO(oooOO0O10);
                                        Preconditions.checkNotEmpty(str8);
                                        oooOO0O10.zzg();
                                        oooOO0O10.OooO00o();
                            ...
                            OooOO0O oooOO0O11 = this.f16286OooO0OO;
                            OooOooO(oooOO0O11);
                            oooOO0O11.OooO0Oo();
                            OooOO0O oooOO0O12 = this.f16286OooO0OO;
                            OooOooO(oooOO0O12);
                            oooOO0O12.OooOooo();
                        }
                ...
                if (o000oOooOo01 != null) {
                    if (o000oOooOo01.OooOoOO() != -2147483648L || o000oOooOo01.OooOoOO() == zzqVar.zzj) {
                        z3 = false;
                    } else {
                        z3 = true;
                    }
                    strOooo0oo = o000oOooOo01.Oooo0oo();
                    if (o000oOooOo01.OooOoOO() == -2147483648L || strOooo0oo == null || strOooo0oo.equals(zzqVar.zzc)) {
                        z4 = false;
                    } else {
                        z4 = true;
                    }
                ...
                OooOooo(zzqVar);
                if (i == 0) {
                    OooOO0O oooOO0O13 = this.f16286OooO0OO;
                    OooOooO(oooOO0O13);
                    oooOOOOOooOo = oooOO0O13.OooOo(zzqVar.zza, "_f");
                    z = false;
                } else {
                    OooOO0O oooOO0O14 = this.f16286OooO0OO;
                    OooOooO(oooOO0O14);
                    ...
                    if (z) {
                        ...
                        if (str4 != null || str4.isEmpty()) {
                            ...
                            if (zzfgVar.OooO00o()) {
                                ...
                                PackageManager packageManager = zzfgVar.f16169OooO00o.zzau().getPackageManager();
                                if (packageManager == null) {
                                    zzfgVar.f16169OooO00o.zzay().zzm().zza("Failed to obtain Package Manager to verify binding conditions for Install Referrer");
                                } else {
                                    List<ResolveInfo> listQueryIntentServices = packageManager.queryIntentServices(intent, 0);
                                    if (listQueryIntentServices == null || listQueryIntentServices.isEmpty()) {
                                        zzfgVar.f16169OooO00o.zzay().zzi().zza("Play Service for fetching Install Referrer is unavailable on device");
                                    } else {
                                        ...
                                        if (serviceInfo != null) {
                                            ...
                                            if (serviceInfo.name != null && "com.android.vending".equals(str12) && zzfgVar.OooO00o()) {
                                                try {
                                                    zzfgVar.f16169OooO00o.zzay().zzj().zzb("Install Referrer Service is", true != ConnectionTracker.getInstance().bindService(zzfgVar.f16169OooO00o.zzau(), new Intent(intent), zzffVar, 1) ? "not available" : "available");
                                                } catch (RuntimeException e6) {
                                                    zzfgVar.f16169OooO00o.zzay().zzd().zzb("Exception occurred while binding to Install Referrer Service", e6.getMessage());
                                                }
                                            } else {
                                                zzfgVar.f16169OooO00o.zzay().zzk().zza("Play Store version 8.3.73 or higher required for Install Referrer");
                                            }
                                        }
                                    }
                                }
                            } else {
                                zzfgVar.f16169OooO00o.zzay().zzi().zza("Install Referrer Reporter is not available");
                            }
                        }
                        zzaz().zzg();
                        OooO0O0();
                        ...
                        str8 = (String) Preconditions.checkNotNull(zzqVar.zza);
                        OooOO0O oooOO0O15 = this.f16286OooO0OO;
                        OooOooO(oooOO0O15);
                        Preconditions.checkNotEmpty(str8);
                        oooOO0O15.zzg();
                        oooOO0O15.OooO00o();
                ...
                OooOO0O oooOO0O16 = this.f16286OooO0OO;
                OooOooO(oooOO0O16);
                oooOO0O16.OooO0Oo();
                OooOO0O oooOO0O17 = this.f16286OooO0OO;
                OooOooO(oooOO0O17);
                oooOO0O17.OooOooo();
            } catch (Throwable th) {
                OooOO0O oooOO0O18 = this.f16286OooO0OO;
                OooOooO(oooOO0O18);
                oooOO0O18.OooOooo();
                throw th;
            }
    ...
    public final void OooO00o() {
        ...
        zzaz().zzg();
        OooO0O0();
        if (this.f16295OooOOO) {
            return;
        }
        this.f16295OooOOO = true;
        zzaz().zzg();
        FileLock fileLock = this.f16305OooOo0O;
        int i2 = 0;
        if (fileLock == null || !fileLock.isValid()) {
            this.f16286OooO0OO.f37615OooO00o.zzf();
            try {
                FileChannel channel = new RandomAccessFile(new File(this.f16294OooOO0o.zzau().getFilesDir(), "google_app_measurement.db"), "rw").getChannel();
                this.f16306OooOo0o = channel;
                FileLock fileLockTryLock = channel.tryLock();
                this.f16305OooOo0O = fileLockTryLock;
                if (fileLockTryLock == null) {
                    zzay().zzd().zza("Storage concurrent data access panic");
                    z = false;
                    if (z) {
                        fileChannel = this.f16306OooOo0o;
                        zzaz().zzg();
                        ...
                        zzef zzefVarZzh = this.f16294OooOO0o.zzh();
                        zzefVarZzh.zza();
                        i = zzefVarZzh.f16112OooO0o0;
                        zzaz().zzg();
                        if (i2 > i) {
                        ...
                        if (i2 < i) {
                            fileChannel2 = this.f16306OooOo0o;
                            zzaz().zzg();
        ...
        if (z) {
            ...
            zzef zzefVarZzh2 = this.f16294OooOO0o.zzh();
            zzefVarZzh2.zza();
            i = zzefVarZzh2.f16112OooO0o0;
            zzaz().zzg();
            if (i2 > i) {
                zzay().zzd().zzc("Panic: can't downgrade version. Previous, current version", Integer.valueOf(i2), Integer.valueOf(i));
                return;
    ...
    public final void OooO0OO(String str, zzgb zzgbVar) {
        ...
        if (zzg().zzs(str, zzeb.zzam)) {
            ...
            zzfpVar.zzg();
            zzfpVar.OooO0o0(str);
            Set set = (Set) zzfpVar.f16174OooO0o0.getOrDefault(str, null);
            if (set != null) {
                zzgbVar.zzi(set);
            }
        }
        if (zzg().zzs(str, zzeb.zzao)) {
            zzfp zzfpVar2 = this.f16284OooO00o;
            OooOooO(zzfpVar2);
            zzfpVar2.zzg();
            zzfpVar2.OooO0o0(str);
            if (zzfpVar2.f16174OooO0o0.getOrDefault(str, null) != 0 && (((Set) zzfpVar2.f16174OooO0o0.getOrDefault(str, null)).contains("device_model") || ((Set) zzfpVar2.f16174OooO0o0.getOrDefault(str, null)).contains(DeviceRequestsHelper.DEVICE_INFO_PARAM))) {
                zzgbVar.zzp();
            }
            zzfp zzfpVar3 = this.f16284OooO00o;
            OooOooO(zzfpVar3);
            zzfpVar3.zzg();
            zzfpVar3.OooO0o0(str);
            if (zzfpVar3.f16174OooO0o0.getOrDefault(str, null) != 0 && (((Set) zzfpVar3.f16174OooO0o0.getOrDefault(str, null)).contains("os_version") || ((Set) zzfpVar3.f16174OooO0o0.getOrDefault(str, null)).contains(DeviceRequestsHelper.DEVICE_INFO_PARAM))) {
        ...
        if (zzg().zzs(str, zzeb.zzap)) {
            zzfp zzfpVar4 = this.f16284OooO00o;
            OooOooO(zzfpVar4);
            zzfpVar4.zzg();
            zzfpVar4.OooO0o0(str);
            if ((zzfpVar4.f16174OooO0o0.getOrDefault(str, null) != 0 && ((Set) zzfpVar4.f16174OooO0o0.getOrDefault(str, null)).contains(AccessToken.USER_ID_KEY)) && (iOooOOO0 = zzlb.OooOOO0(zzgbVar, ao.d)) != -1) {
                zzgbVar.zzB(iOooOOO0);
            }
        }
        if (zzg().zzs(str, zzeb.zzaq)) {
            zzfp zzfpVar5 = this.f16284OooO00o;
            OooOooO(zzfpVar5);
            zzfpVar5.zzg();
            zzfpVar5.OooO0o0(str);
            if (zzfpVar5.f16174OooO0o0.getOrDefault(str, null) != 0 && ((Set) zzfpVar5.f16174OooO0o0.getOrDefault(str, null)).contains("google_signals")) {
                zzgbVar.zzq();
            }
        }
        if (zzg().zzs(str, zzeb.zzat)) {
            zzfp zzfpVar6 = this.f16284OooO00o;
            OooOooO(zzfpVar6);
            zzfpVar6.zzg();
            zzfpVar6.OooO0o0(str);
            if (zzfpVar6.f16174OooO0o0.getOrDefault(str, null) != 0 && ((Set) zzfpVar6.f16174OooO0o0.getOrDefault(str, null)).contains("app_instance_id")) {
                zzgbVar.zzn();
                if (zzg().zzs(str, zzeb.zzau)) {
                    o0OO000o o0oo000o = (o0OO000o) this.f16311OooOoo0.get(str);
                    if (o0oo000o == null) {
                        o0oo000o = new o0OO000o(this);
                        this.f16311OooOoo0.put(str, o0oo000o);
                    } else if (zzg().zzi(str, zzeb.zzR) + o0oo000o.f37819OooO0O0 < zzav().elapsedRealtime()) {
                        o0oo000o = new o0OO000o(this);
                        this.f16311OooOoo0.put(str, o0oo000o);
                    }
                    zzgbVar.zzR(o0oo000o.f37818OooO00o);
                }
            }
        }
        if (zzg().zzs(str, zzeb.zzav)) {
            zzfp zzfpVar7 = this.f16284OooO00o;
            OooOooO(zzfpVar7);
            zzfpVar7.zzg();
            zzfpVar7.OooO0o0(str);
            if (zzfpVar7.f16174OooO0o0.getOrDefault(str, null) != 0 && ((Set) zzfpVar7.f16174OooO0o0.getOrDefault(str, null)).contains("enhanced_user_id")) {
                zzgbVar.zzy();
            }
        }
    }
    ...
    @WorkerThread
    public final void OooO0Oo(o000O o000o) {
        Oooo0 oooo0;
        Oooo0 oooo1;
        zzaz().zzg();
        if (TextUtils.isEmpty(o000o.OoooO00()) && TextUtils.isEmpty(o000o.Oooo0O0())) {
            OooO0oo((String) Preconditions.checkNotNull(o000o.Oooo0o0()), IZegoLiveEventCallback.StreamEvent.RetryPlaySuccess, null, null, null);
            return;
        }
        zzko zzkoVar = this.f16292OooOO0;
        Uri.Builder builder = new Uri.Builder();
        String strOoooO00 = o000o.OoooO00();
        if (TextUtils.isEmpty(strOoooO00)) {
            strOoooO00 = o000o.Oooo0O0();
        }
        Oooo0 oooo2 = null;
        ...
        zzow.zzc();
        if (!zzkoVar.f37615OooO00o.zzf().zzs(o000o.Oooo0o0(), zzeb.zzak)) {
            builder.appendQueryParameter("app_instance_id", o000o.Oooo0o());
        }
        String string = builder.build().toString();
        try {
            String str = (String) Preconditions.checkNotNull(o000o.Oooo0o0());
            ...
            OooOooO(zzfpVar2);
            zzfpVar2.zzg();
            String str2 = (String) zzfpVar2.f16181OooOOO0.getOrDefault(str, null);
            if (zzfeVarOooO == null) {
                oooo0 = oooo2;
            } else {
                ...
                if (zzg().zzs(null, zzeb.zzaw)) {
                    ...
                    OooOooO(zzfpVar3);
                    zzfpVar3.zzg();
                    String str3 = (String) zzfpVar3.f16180OooOOO.getOrDefault(str, null);
            ...
            this.f16301OooOOoo = true;
            zzeu zzeuVar = this.f16285OooO0O0;
            OooOooO(zzeuVar);
            o0O0o0 o0o0o0 = new o0O0o0(this);
            zzeuVar.zzg();
            zzeuVar.OooO00o();
            Preconditions.checkNotNull(url);
            Preconditions.checkNotNull(o0o0o0);
            zzeuVar.f37615OooO00o.zzaz().zzo(new o0OOO0o(zzeuVar, str, url, null, oooo0, o0o0o0));
        } catch (MalformedURLException unused) {
            zzay().zzd().zzc("Failed to parse config URL. Not fetching. appId", zzeo.OooO0o0(o000o.Oooo0o0()), string);
        }
    }
    ...
    public final void OooO0o(zzaw zzawVar, String str) {
        OooOO0O oooOO0O = this.f16286OooO0OO;
        OooOooO(oooOO0O);
        o000O o000oOooOo00 = oooOO0O.OooOo00(str);
        if (o000oOooOo00 == null || TextUtils.isEmpty(o000oOooOo00.Oooo0oo())) {
            zzay().zzc().zzb("No app data available; dropping event", str);
            return;
        }
        Boolean boolOooOo0O = OooOo0O(o000oOooOo00);
        if (boolOooOo0O == null) {
        ...
        String strOoooO00 = o000oOooOo00.OoooO00();
        String strOooo0oo = o000oOooOo00.Oooo0oo();
        long jOooOoOO = o000oOooOo00.OooOoOO();
        String strOooo0oO = o000oOooOo00.Oooo0oO();
        long jOooo000 = o000oOooOo00.Oooo000();
        long jOooOoo = o000oOooOo00.OooOoo();
        boolean zOooOoO = o000oOooOo00.OooOoO();
        String strOooo = o000oOooOo00.Oooo();
        o000oOooOo00.OooOOo();
        boolean zOooOoO0 = o000oOooOo00.OooOoO0();
        String strOooo0O0 = o000oOooOo00.Oooo0O0();
        o000oOooOo00.f37572OooO00o.zzaz().zzg();
        OooO0oO(zzawVar, new zzq(str, strOoooO00, strOooo0oo, jOooOoOO, strOooo0oO, jOooo000, jOooOoo, null, zOooOoO, false, strOooo, 0L, 0, zOooOoO0, false, strOooo0O0, o000oOooOo00.f37587OooOOo, o000oOooOo00.OooOooO(), o000oOooOo00.OooO00o(), Oooo000(str).zzh(), "", null));
    }
    ...
    public final void OooO0o0(zzaw zzawVar, zzq zzqVar) {
        ...
        zzaz().zzg();
        zzlh.zzK((this.f16310OooOoo == null || (str = this.f16312OooOooO) == null || !str.equals(str2)) ? null : this.f16310OooOoo, zzepVarZzb.zzd, false);
        zzaw zzawVarZza = zzepVarZzb.zza();
        OooOooO(this.f16290OooO0oO);
        if (zzlb.OooO0OO(zzawVarZza, zzqVar)) {
            ...
            try {
                ...
                oooOO0O2.OooO00o();
                if (j < 0) {
                    oooOO0O2.f37615OooO00o.zzay().zzk().zzc("Invalid time querying timed out conditional properties", zzeo.OooO0o0(str2), Long.valueOf(j));
                ...
                for (zzac zzacVar : listOooOoo0) {
                    if (zzacVar != null) {
                        zzay().zzj().zzd("User property timed out", zzacVar.zza, this.f16294OooOO0o.zzj().OooO0o(zzacVar.zzc.zzb), zzacVar.zzc.zza());
                ...
                oooOO0O4.OooO00o();
                if (j < 0) {
                    oooOO0O4.f37615OooO00o.zzay().zzk().zzc("Invalid time querying expired conditional properties", zzeo.OooO0o0(str2), Long.valueOf(j));
                ...
                for (zzac zzacVar2 : listOooOoo1) {
                    if (zzacVar2 != null) {
                        zzay().zzj().zzd("User property expired", zzacVar2.zza, this.f16294OooOO0o.zzj().OooO0o(zzacVar2.zzc.zzb), zzacVar2.zzc.zza());
                        OooOO0O oooOO0O5 = this.f16286OooO0OO;
                        OooOooO(oooOO0O5);
                ...
                oooOO0O7.OooO00o();
                if (j < 0) {
                    oooOO0O7.f37615OooO00o.zzay().zzk().zzd("Invalid time querying triggered conditional properties", zzeo.OooO0o0(str2), oooOO0O7.f37615OooO00o.zzj().OooO0Oo(str3), Long.valueOf(j));
                ...
                for (zzac zzacVar3 : listOooOoo2) {
                    if (zzacVar3 != null) {
                        ...
                        oo0ooO oo0ooo = new oo0ooO((String) Preconditions.checkNotNull(zzacVar3.zza), zzacVar3.zzb, zzlcVar.zzb, j, Preconditions.checkNotNull(zzlcVar.zza()));
                        OooOO0O oooOO0O8 = this.f16286OooO0OO;
                        OooOooO(oooOO0O8);
                        if (oooOO0O8.OooOO0(oo0ooo)) {
                            zzay().zzj().zzd("User property triggered", zzacVar3.zza, this.f16294OooOO0o.zzj().OooO0o(oo0ooo.f37908OooO0OO), oo0ooo.f37910OooO0o0);
                        } else {
                            zzay().zzd().zzd("Too many active user properties, ignoring", zzeo.OooO0o0(zzacVar3.zza), this.f16294OooOO0o.zzj().OooO0o(oo0ooo.f37908OooO0OO), oo0ooo.f37910OooO0o0);
                        }
                        zzaw zzawVar5 = zzacVar3.zzi;
                        if (zzawVar5 != null) {
                            arrayList2.add(zzawVar5);
                        }
                        zzacVar3.zzc = new zzlc(oo0ooo);
                        zzacVar3.zze = true;
                        OooOO0O oooOO0O9 = this.f16286OooO0OO;
                        OooOooO(oooOO0O9);
    ...
    public final void OooO0oo(String str, int i, Throwable th, byte[] bArr, Map map) {
        ...
        try {
            OooOO0O oooOO0O3 = this.f16286OooO0OO;
            OooOooO(oooOO0O3);
            o000O o000oOooOo00 = oooOO0O3.OooOo00(str);
            if (i == 200 || i == 204) {
                if (th == null) {
                    z = true;
                } else {
            ...
            if (o000oOooOo00 == null) {
                    ...
                    if (i == 404 || i == 304) {
                        ...
                        if (zzfpVar.OooO(str) == null) {
                            ...
                            if (!zzfpVar2.OooOOOo(str, null, null, null)) {
                                oooOO0O = this.f16286OooO0OO;
                            }
                        }
                        o000oOooOo00.OooO(zzav().currentTimeMillis());
                        OooOO0O oooOO0O4 = this.f16286OooO0OO;
                        OooOooO(oooOO0O4);
                        oooOO0O4.OooO0o0(o000oOooOo00);
                        if (i == 404) {
                ...
                o000oOooOo00.OooOO0o(zzav().currentTimeMillis());
                OooOO0O oooOO0O6 = this.f16286OooO0OO;
                OooOooO(oooOO0O6);
                oooOO0O6.OooO0o0(o000oOooOo00);
                zzay().zzj().zzc("Fetching config failed. code, error", Integer.valueOf(i), th);
                zzfp zzfpVar4 = this.f16284OooO00o;
                OooOooO(zzfpVar4);
                zzfpVar4.zzg();
                zzfpVar4.f16181OooOOO0.put(str, null);
                this.f16283OooO.zzd.zzb(zzav().currentTimeMillis());
                if (i == 503 || i == 429) {
                    this.f16283OooO.zzb.zzb(zzav().currentTimeMillis());
                }
                OooOoO0();
            }
            OooOO0O oooOO0O7 = this.f16286OooO0OO;
        ...
        if (OooOoo(zzqVar)) {
            ...
            try {
                ...
                if (zzacVarOooOo0 != null) {
                    zzay().zzc().zzc("Removing conditional user property", zzacVar.zza, this.f16294OooOO0o.zzj().OooO0o(zzacVar.zzc.zzb));
                    OooOO0O oooOO0O3 = this.f16286OooO0OO;
                    OooOooO(oooOO0O3);
                    ...
                    zzay().zzk().zzc("Conditional user property doesn't exist", zzeo.OooO0o0(zzacVar.zza), this.f16294OooOO0o.zzj().OooO0o(zzacVar.zzc.zzb));
                }
                OooOO0O oooOO0O5 = this.f16286OooO0OO;
                OooOooO(oooOO0O5);
                oooOO0O5.OooO0Oo();
    ...
    public final void OooOO0O(zzlc zzlcVar, zzq zzqVar) {
        ...
        if (OooOoo(zzqVar)) {
            ...
            zzay().zzc().zzb("Removing user property", this.f16294OooOO0o.zzj().OooO0o(zzlcVar.zzb));
            OooOO0O oooOO0O = this.f16286OooO0OO;
            OooOooO(oooOO0O);
            oooOO0O.zzw();
            try {
                ...
                OooOooO(oooOO0O4);
                oooOO0O4.OooO0Oo();
                zzay().zzc().zzb("User property removed", this.f16294OooOO0o.zzj().OooO0o(zzlcVar.zzb));
            } finally {
                OooOO0O oooOO0O5 = this.f16286OooO0OO;
                OooOooO(oooOO0O5);
                oooOO0O5.OooOooo();
    ...
    public final void OooOO0o(zzq zzqVar) {
        if (this.f16302OooOo != null) {
            ArrayList arrayList = new ArrayList();
            this.f16308OooOoO0 = arrayList;
            arrayList.addAll(this.f16302OooOo);
        }
        OooOO0O oooOO0O = this.f16286OooO0OO;
        OooOooO(oooOO0O);
        ...
        try {
            ...
            if (iDelete > 0) {
                oooOO0O.f37615OooO00o.zzay().zzj().zzc("Reset analytics data. app, records", str, Integer.valueOf(iDelete));
            }
        } catch (SQLiteException e) {
            oooOO0O.f37615OooO00o.zzay().zzd().zzc("Error resetting analytics data. appId, error", zzeo.OooO0o0(str), e);
        }
        if (zzqVar.zzh) {
            OooO(zzqVar);
        }
    ...
    public final void OooOOO(String str, zzai zzaiVar) {
        zzaz().zzg();
        OooO0O0();
        this.f16309OooOoOO.put(str, zzaiVar);
        OooOO0O oooOO0O = this.f16286OooO0OO;
        OooOooO(oooOO0O);
        ...
        try {
            if (oooOO0O.OooOOo().insertWithOnConflict("consent_settings", null, contentValues, 5) == -1) {
                oooOO0O.f37615OooO00o.zzay().zzd().zzb("Failed to insert/update consent setting (got -1). appId", zzeo.OooO0o0(str));
            }
        } catch (SQLiteException e) {
            oooOO0O.f37615OooO00o.zzay().zzd().zzc("Error storing consent setting. appId, error", zzeo.OooO0o0(str), e);
        }
    }
        ...
        if (OooOoo(zzqVar)) {
            ...
            try {
                ...
                if (zzacVarOooOo0 != null && !zzacVarOooOo0.zzb.equals(zzacVar2.zzb)) {
                    zzay().zzk().zzd("Updating a conditional user property with different origin. name, origin, origin (from DB)", this.f16294OooOO0o.zzj().OooO0o(zzacVar2.zzc.zzb), zzacVar2.zzb, zzacVarOooOo0.zzb);
                }
                ...
                if (zzacVar2.zze) {
                    ...
                    oo0ooO oo0ooo = new oo0ooO((String) Preconditions.checkNotNull(zzacVar2.zza), zzacVar2.zzb, zzlcVar3.zzb, zzlcVar3.zzc, Preconditions.checkNotNull(zzlcVar3.zza()));
                    OooOO0O oooOO0O3 = this.f16286OooO0OO;
                    OooOooO(oooOO0O3);
                    if (oooOO0O3.OooOO0(oo0ooo)) {
                        zzay().zzc().zzd("User property updated immediately", zzacVar2.zza, this.f16294OooOO0o.zzj().OooO0o(oo0ooo.f37908OooO0OO), oo0ooo.f37910OooO0o0);
                    } else {
                        zzay().zzd().zzd("(2)Too many active user properties, ignoring", zzeo.OooO0o0(zzacVar2.zza), this.f16294OooOO0o.zzj().OooO0o(oo0ooo.f37908OooO0OO), oo0ooo.f37910OooO0o0);
                    }
                ...
                if (oooOO0O4.OooO(zzacVar2)) {
                    zzay().zzc().zzd("Conditional property added", zzacVar2.zza, this.f16294OooOO0o.zzj().OooO0o(zzacVar2.zzc.zzb), zzacVar2.zzc.zza());
                } else {
                    zzay().zzd().zzd("Too many conditional properties, ignoring", zzeo.OooO0o0(zzacVar2.zza), this.f16294OooOO0o.zzj().OooO0o(zzacVar2.zzc.zzb), zzacVar2.zzc.zza());
                }
                OooOO0O oooOO0O5 = this.f16286OooO0OO;
                OooOooO(oooOO0O5);
                oooOO0O5.OooO0Oo();
    ...
    public final void OooOOOO(zzlc zzlcVar, zzq zzqVar) {
        ...
        if (OooOoo(zzqVar)) {
            ...
            if (iOooo != 0) {
                ...
                zzv().OooOOO(this.f16313OooOooo, zzqVar.zza, iOooo, "_ev", strZzD, str2 != null ? str2.length() : 0);
                return;
            }
            ...
            if (iOooo0o != 0) {
                ...
                zzv().OooOOO(this.f16313OooOooo, zzqVar.zza, iOooo0o, "_ev", strZzD2, (objZza == null || !((objZza instanceof String) || (objZza instanceof CharSequence))) ? 0 : objZza.toString().length());
                return;
            }
            ...
            if ("_sid".equals(zzlcVar.zzb)) {
                ...
                OooOO0O oooOO0O = this.f16286OooO0OO;
                OooOooO(oooOO0O);
                oo0ooO oo0oooOooOoO0 = oooOO0O.OooOoO0(str5, "_sno");
                if (oo0oooOooOoO0 != null) {
                    Object obj = oo0oooOooOoO0.f37910OooO0o0;
                    if (obj instanceof Long) {
                        jLongValue = ((Long) obj).longValue();
                    } else {
                        if (oo0oooOooOoO0 != null) {
                            zzay().zzk().zzb("Retrieved last session number from database does not contain a valid (long) value", oo0oooOooOoO0.f37910OooO0o0);
                        }
                        OooOO0O oooOO0O2 = this.f16286OooO0OO;
                        OooOooO(oooOO0O2);
                        oooOOOOOooOo = oooOO0O2.OooOo(str5, "_s");
                        if (oooOOOOOooOo != null) {
                            jLongValue = oooOOOOOooOo.f37506OooO0OO;
            ...
            oo0ooO oo0ooo = new oo0ooO((String) Preconditions.checkNotNull(zzqVar.zza), (String) Preconditions.checkNotNull(zzlcVar.zzf), zzlcVar.zzb, zzlcVar.zzc, objOooO0o);
            zzay().zzj().zzc("Setting user property", this.f16294OooOO0o.zzj().OooO0o(oo0ooo.f37908OooO0OO), objOooO0o);
            OooOO0O oooOO0O4 = this.f16286OooO0OO;
            OooOooO(oooOO0O4);
            oooOO0O4.zzw();
            try {
                if (ao.d.equals(oo0ooo.f37908OooO0OO)) {
                    OooOO0O oooOO0O5 = this.f16286OooO0OO;
                    OooOooO(oooOO0O5);
                    oo0ooO oo0oooOooOoO1 = oooOO0O5.OooOoO0(zzqVar.zza, ao.d);
                    if (oo0oooOooOoO1 != null && !oo0ooo.f37910OooO0o0.equals(oo0oooOooOoO1.f37910OooO0o0)) {
                        OooOO0O oooOO0O6 = this.f16286OooO0OO;
                        OooOooO(oooOO0O6);
                ...
                OooOO0O oooOO0O7 = this.f16286OooO0OO;
                OooOooO(oooOO0O7);
                boolean zOooOO0 = oooOO0O7.OooOO0(oo0ooo);
                OooOO0O oooOO0O8 = this.f16286OooO0OO;
                OooOooO(oooOO0O8);
                oooOO0O8.OooO0Oo();
                if (!zOooOO0) {
                    zzay().zzd().zzc("Too many unique user properties are set. Ignoring user property", this.f16294OooOO0o.zzj().OooO0o(oo0ooo.f37908OooO0OO), oo0ooo.f37910OooO0o0);
                    zzv().OooOOO(this.f16313OooOooo, zzqVar.zza, 9, null, null, 0);
                }
            } finally {
                OooOO0O oooOO0O9 = this.f16286OooO0OO;
                OooOooO(oooOO0O9);
            ...
            if (boolOooOO0o == null) {
                ...
                if (this.f16302OooOo != null) {
                    ...
                    if (zzeuVar.zza()) {
                        ...
                        long jZza = this.f16283OooO.zzc.zza();
                        if (jZza != 0) {
                        ...
                        if (TextUtils.isEmpty(strZzr)) {
                            try {
                                ...
                                try {
                                    ...
                                    try {
                                        if (cursorRawQuery.moveToFirst()) {
                                            ...
                                            oooOO0O3.f37615OooO00o.zzay().zzj().zza("No expired configs for apps with pending events");
                                            cursorRawQuery.close();
                                            string = null;
                                        }
                                    } catch (SQLiteException e) {
                                        e = e;
                                        oooOO0O3.f37615OooO00o.zzay().zzd().zzb("Error selecting expired configs", e);
                                        ...
                                        if (!TextUtils.isEmpty(string)) {
                                            OooOO0O oooOO0O4 = this.f16286OooO0OO;
                                            OooOooO(oooOO0O4);
                                            o000oOooOo00 = oooOO0O4.OooOo00(string);
                                            if (o000oOooOo00 != null) {
                                                OooO0Oo(o000oOooOo00);
                                            }
                                        }
                                        this.f16303OooOo0 = false;
                                        OooOo0o();
                                ...
                                if (!TextUtils.isEmpty(string)) {
                                    OooOO0O oooOO0O5 = this.f16286OooO0OO;
                                    OooOooO(oooOO0O5);
                                    o000oOooOo00 = oooOO0O5.OooOo00(string);
                                    if (o000oOooOo00 != null) {
                                        OooO0Oo(o000oOooOo00);
                                    }
                                }
                                ...
                                try {
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            e = e3;
                                            oooOO0O6.f37615OooO00o.zzay().zzd().zzb("Error querying raw events", e);
                                            if (cursorRawQuery2 != null) {
                                            }
                                            this.f16307OooOoO = j3;
                                                ...
                                                if (cursorQuery.moveToFirst()) {
                                                    ...
                                                    while (true) {
                                                        ...
                                                        try {
                                                            ...
                                                            zzlb zzlbVar = oooOO0O.f37794OooO0O0.f16290OooO0oO;
                                                            OooOooO(zzlbVar);
                                                            try {
                                                                ...
                                                                while (true) {
                                                                    try {
                                                                        try {
                                                                            ...
                                                                            e = e4;
                                                                            try {
                                                                                zzlbVar.f37615OooO00o.zzay().zzd().zzb("Failed to ungzip content", e);
                                                                                throw e;
                                                                            } catch (IOException e5) {
                                                                                e = e5;
                                                                                oooOO0O.f37615OooO00o.zzay().zzd().zzc("Failed to unzip queued bundle. appId", zzeo.OooO0o0(strZzr), e);
                                                                                ...
                                                                                if (!listEmptyList.isEmpty()) {
                                                                                    ...
                                                                                    while (i < size) {
                                                                                        ...
                                                                                        if (zzg().zzs(strZzr, zzeb.zzT)) {
                                                                                            ...
                                                                                            zzlb zzlbVar2 = this.f16290OooO0oO;
                                                                                            OooOooO(zzlbVar2);
                                                                                    ...
                                                                                    if (Log.isLoggable(zzay().zzq(), 2)) {
                                                                                        zzlb zzlbVar3 = this.f16290OooO0oO;
                                                                                        OooOooO(zzlbVar3);
                                                                                    ...
                                                                                    zzkoVar = this.f16292OooOO0;
                                                                                    zzow.zzc();
                                                                                    if (zzkoVar.f37615OooO00o.zzf().zzs(strZzr, zzeb.zzan)) {
                                                                                        zzfp zzfpVar = zzkoVar.f37794OooO0O0.f16284OooO00o;
                                                                                        OooOooO(zzfpVar);
                                                                                    ...
                                                                                    try {
                                                                                        ...
                                                                                        if (this.f16302OooOo != null) {
                                                                                            ...
                                                                                            this.f16302OooOo = new ArrayList(arrayList);
                                                                                        }
                                                                                        this.f16283OooO.zzd.zzb(j5);
                                                                                        ...
                                                                                        this.f16304OooOo00 = true;
                                                                                        zzeu zzeuVar2 = this.f16285OooO0O0;
                                                                                        OooOooO(zzeuVar2);
                                                                                        o0O0o00O o0o0o00o = new o0O0o00O(this, strZzr);
                                                                                        zzeuVar2.zzg();
                                                                                        zzeuVar2.OooO00o();
                                                                                        Preconditions.checkNotNull(url);
                                                                                        Preconditions.checkNotNull(bArrZzbv2);
                                                                                        Preconditions.checkNotNull(o0o0o00o);
                                                                                        zzeuVar2.f37615OooO00o.zzaz().zzo(new o0OOO0o(zzeuVar2, strZzr, url, bArrZzbv2, null, o0o0o00o));
                                                                                    } catch (MalformedURLException unused) {
                                                                        ...
                                                                        e = e6;
                                                                        oooOO0O.f37615OooO00o.zzay().zzd().zzc("Error querying bundles. appId", zzeo.OooO0o0(strZzr), e);
                                                                ...
                                                                try {
                                                                    ...
                                                                    oooOO0O.f37615OooO00o.zzay().zzd().zzc("Failed to merge queued bundle. appId", zzeo.OooO0o0(strZzr), e7);
                                                                }
                                            ...
                                            if (!listEmptyList.isEmpty()) {
                                                ...
                                                while (i < size) {
                                                    ...
                                                    if (zzg().zzs(strZzr, zzeb.zzT)) {
                                                        ...
                                                        zzlb zzlbVar4 = this.f16290OooO0oO;
                                                        OooOooO(zzlbVar4);
                                                ...
                                                long j7 = j;
                                                if (Log.isLoggable(zzay().zzq(), 2)) {
                                                    zzlb zzlbVar5 = this.f16290OooO0oO;
                                                    OooOooO(zzlbVar5);
                                                ...
                                                zzow.zzc();
                                                if (zzkoVar.f37615OooO00o.zzf().zzs(strZzr, zzeb.zzan)) {
                                                    zzfp zzfpVar2 = zzkoVar.f37794OooO0O0.f16284OooO00o;
                                                    OooOooO(zzfpVar2);
                                                ...
                                                this.f16304OooOo00 = true;
                                                zzeu zzeuVar3 = this.f16285OooO0O0;
                                                OooOooO(zzeuVar3);
                                                o0O0o00O o0o0o00o2 = new o0O0o00O(this, strZzr);
                                                zzeuVar3.zzg();
                                                zzeuVar3.OooO00o();
                                                Preconditions.checkNotNull(url2);
                                                Preconditions.checkNotNull(bArrZzbv4);
                                                Preconditions.checkNotNull(o0o0o00o2);
                                                zzeuVar3.f37615OooO00o.zzaz().zzo(new o0OOO0o(zzeuVar3, strZzr, url2, bArrZzbv4, null, o0o0o00o2));
                                            }
                                            this.f16303OooOo0 = false;
                                            OooOo0o();
                                        }
                                ...
                                try {
                                    ...
                                    if (cursorQuery.moveToFirst()) {
                                        ...
                                        while (true) {
                                            ...
                                            zzlb zzlbVar6 = oooOO0O.f37794OooO0O0.f16290OooO0oO;
                                            OooOooO(zzlbVar6);
                                ...
                                if (!listEmptyList.isEmpty()) {
                                    ...
                                    while (i < size) {
                                        ...
                                        if (zzg().zzs(strZzr, zzeb.zzT)) {
                                            ...
                                            zzlb zzlbVar7 = this.f16290OooO0oO;
                                            OooOooO(zzlbVar7);
                                    ...
                                    long j9 = j;
                                    if (Log.isLoggable(zzay().zzq(), 2)) {
                                        zzlb zzlbVar8 = this.f16290OooO0oO;
                                        OooOooO(zzlbVar8);
                                    ...
                                    zzow.zzc();
                                    if (zzkoVar.f37615OooO00o.zzf().zzs(strZzr, zzeb.zzan)) {
                                        zzfp zzfpVar3 = zzkoVar.f37794OooO0O0.f16284OooO00o;
                                        OooOooO(zzfpVar3);
                                    ...
                                    this.f16304OooOo00 = true;
                                    zzeu zzeuVar4 = this.f16285OooO0O0;
                                    OooOooO(zzeuVar4);
                                    o0O0o00O o0o0o00o3 = new o0O0o00O(this, strZzr);
                                    zzeuVar4.zzg();
                                    zzeuVar4.OooO00o();
                                    Preconditions.checkNotNull(url3);
                                    Preconditions.checkNotNull(bArrZzbv6);
                                    Preconditions.checkNotNull(o0o0o00o3);
                                    zzeuVar4.f37615OooO00o.zzaz().zzo(new o0OOO0o(zzeuVar4, strZzr, url3, bArrZzbv6, null, o0o0o00o3));
                                }
                            } catch (Throwable th6) {
                                th = th6;
    ...
    public final long OooOOo() {
        long jCurrentTimeMillis = zzav().currentTimeMillis();
        zzju zzjuVar = this.f16283OooO;
        zzjuVar.OooO00o();
        zzjuVar.zzg();
        long jZza = zzjuVar.zze.zza();
        if (jZza == 0) {
            jZza = ((long) zzjuVar.f37615OooO00o.zzv().OooO().nextInt(86400000)) + 1;
    ...
    public final void OooOOo0(zzaw zzawVar, zzq zzqVar) {
        ...
        if (zzlb.OooO0OO(zzawVar, zzqVar)) {
            ...
            if (zzfpVar.OooOOO(str5, zzawVar.zza)) {
                zzay().zzk().zzc("Dropping blocked event. appId", zzeo.OooO0o0(str5), this.f16294OooOO0o.zzj().OooO0Oo(zzawVar.zza));
                zzfp zzfpVar2 = this.f16284OooO00o;
                OooOooO(zzfpVar2);
                if (!zzfpVar2.OooOO0o(str5)) {
                    ...
                    if (!zzfpVar3.OooOOOO(str5)) {
                        ...
                        zzv().OooOOO(this.f16313OooOooo, str5, 11, "_ev", zzawVar.zza, 0);
                        return;
                    }
                }
                OooOO0O oooOO0O7 = this.f16286OooO0OO;
                OooOooO(oooOO0O7);
                o000O o000oOooOo01 = oooOO0O7.OooOo00(str5);
                if (o000oOooOo01 != null) {
                    long jAbs = Math.abs(zzav().currentTimeMillis() - Math.max(o000oOooOo01.OooOooo(), o000oOooOo01.OooOoo0()));
                    zzg();
                    if (jAbs > ((Long) zzeb.zzy.zza(null)).longValue()) {
                        zzay().zzc().zza("Fetching config for blocked app");
                        OooO0Oo(o000oOooOo01);
                        return;
                    }
                    return;
                }
            ...
            zzaw zzawVarZza = zzepVarZzb.zza();
            if (Log.isLoggable(zzay().zzq(), 2)) {
                zzay().zzj().zzb("Logging event", this.f16294OooOO0o.zzj().OooO0OO(zzawVarZza));
            }
            OooOO0O oooOO0O8 = this.f16286OooO0OO;
            OooOooO(oooOO0O8);
            oooOO0O8.zzw();
            try {
                ...
                if ("_iap".equals(zzawVarZza.zza)) {
                    ...
                    if (!TextUtils.isEmpty(strOoooO0O)) {
                        ...
                        if (upperCase.matches("[A-Z]{3}")) {
                            ...
                            OooOO0O oooOO0O11 = this.f16286OooO0OO;
                            OooOooO(oooOO0O11);
                            oo0oooOooOoO0 = oooOO0O11.OooOoO0(str5, strConcat);
                            if (oo0oooOooOoO0 != null) {
                                obj = oo0oooOooOoO0.f37910OooO0o0;
                                if (obj instanceof Long) {
                                    str4 = "metadata_fingerprint";
                                    str = str6;
                                    oo0ooo = new oo0ooO(str5, zzawVarZza.zzc, strConcat, zzav().currentTimeMillis(), Long.valueOf(((Long) obj).longValue() + jLongValue));
                                } else {
                                    str2 = str6;
                                    oooOO0O = this.f16286OooO0OO;
                                    OooOooO(oooOO0O);
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            try {
                                                ...
                                                e = e;
                                                oooOO0O.f37615OooO00o.zzay().zzd().zzc("Error pruning currencies. appId", zzeo.OooO0o0(str5), e);
                                            }
                                        } catch (SQLiteException e2) {
                                            e = e2;
                                            oooOO0O.f37615OooO00o.zzay().zzd().zzc("Error pruning currencies. appId", zzeo.OooO0o0(str5), e);
                                            str = str3;
                                            oo0ooo = new oo0ooO(str5, zzawVarZza.zzc, strConcat, zzav().currentTimeMillis(), Long.valueOf(jLongValue));
                                            oooOO0O2 = this.f16286OooO0OO;
                                            OooOooO(oooOO0O2);
                                            if (!oooOO0O2.OooOO0(oo0ooo)) {
                                                zzay().zzd().zzd("Too many unique user properties are set. Ignoring user property. appId", zzeo.OooO0o0(str5), this.f16294OooOO0o.zzj().OooO0o(oo0ooo.f37908OooO0OO), oo0ooo.f37910OooO0o0);
                                                zzv().OooOOO(this.f16313OooOooo, str5, 9, null, null, 0);
                                            }
                                            ...
                                            if (zzauVar == null) {
                                                ...
                                                it = zzauVar.f16095Oooo0o.keySet().iterator();
                                                length = 0;
                                                while (it.hasNext()) {
                                            ...
                                            long j3 = zzakVarOooOo0o.f16080OooO0O0;
                                            zzg();
                                            jIntValue = j3 - ((long) ((Integer) zzeb.zzj.zza(null)).intValue());
                                            if (jIntValue > 0) {
                                                if (jIntValue % 1000 == 1) {
                                                    zzay().zzd().zzc("Data loss. Too many events logged. appId, count", zzeo.OooO0o0(str5), Long.valueOf(zzakVarOooOo0o.f16080OooO0O0));
                                                }
                                                OooOO0O oooOO0O13 = this.f16286OooO0OO;
                                                OooOooO(oooOO0O13);
                                                oooOO0O13.OooO0Oo();
                                            ...
                                            if (zOooOoo) {
                                                long j4 = zzakVarOooOo0o.f16079OooO00o;
                                                zzg();
                                                jIntValue2 = j4 - ((long) ((Integer) zzeb.zzl.zza(null)).intValue());
                                                if (jIntValue2 > 0) {
                                                    if (jIntValue2 % 1000 == 1) {
                                                        zzay().zzd().zzc("Data loss. Too many public events logged. appId, count", zzeo.OooO0o0(str5), Long.valueOf(zzakVarOooOo0o.f16079OooO00o));
                                                    }
                                                    zzv().OooOOO(this.f16313OooOooo, str5, 16, "_ev", zzawVarZza.zza, 0);
                                                    OooOO0O oooOO0O15 = this.f16286OooO0OO;
                                                    OooOooO(oooOO0O15);
                                                    oooOO0O15.OooO0Oo();
                                                    OooOO0O oooOO0O16 = this.f16286OooO0OO;
                                            ...
                                            if (zEquals) {
                                                jMax = zzakVarOooOo0o.f16082OooO0Oo - ((long) Math.max(0, Math.min(1000000, zzg().zze(zzqVar.zza, zzeb.zzk))));
                                                if (jMax > 0) {
                                                    if (jMax == 1) {
                                                        zzay().zzd().zzc("Too many error events logged. appId, count", zzeo.OooO0o0(str5), Long.valueOf(zzakVarOooOo0o.f16082OooO0Oo));
                                                    }
                                                    OooOO0O oooOO0O17 = this.f16286OooO0OO;
                                                    OooOooO(oooOO0O17);
                                                    oooOO0O17.OooO0Oo();
                                            ...
                                            if ("_s".equals(zzawVarZza.zza)) {
                                                OooOO0O oooOO0O19 = this.f16286OooO0OO;
                                                OooOooO(oooOO0O19);
                                                oo0oooOooOoO1 = oooOO0O19.OooOoO0(zzqVar.zza, "_sno");
                                                if (oo0oooOooOoO1 != null) {
                                                    zzv().OooOOOO(bundleZzc, "_sno", oo0oooOooOoO1.f37910OooO0o0);
                                                }
                                            }
                                            oooOO0O3 = this.f16286OooO0OO;
                                            OooOooO(oooOO0O3);
                                            Preconditions.checkNotEmpty(str5);
                                            oooOO0O3.zzg();
                                            oooOO0O3.OooO00o();
                                            try {
                                                try {
                                                    try {
                                                        try {
                                                            jDelete = oooOO0O3.OooOOo().delete("raw_events", "rowid in (select rowid from raw_events where app_id=? order by rowid desc limit -1 offset ?)", new String[]{str5, String.valueOf(Math.max(0, Math.min(1000000, oooOO0O3.f37615OooO00o.zzf().zze(str5, zzeb.zzo))))});
                                                            while (true) {
                                                                if (it2.hasNext()) {
                                                                    zzfp zzfpVar4 = this.f16284OooO00o;
                                                                    OooOooO(zzfpVar4);
                                                                    zOooOOO0 = zzfpVar4.OooOOO0(zzarVar.f16089OooO00o, zzarVar.f16090OooO0O0);
                                                                    OooOO0O oooOO0O20 = this.f16286OooO0OO;
                                                                    OooOooO(oooOO0O20);
                                                                    zzak zzakVarOooOo0O = oooOO0O20.OooOo0O(OooOOo(), zzarVar.f16089OooO00o, false, false);
                                                                    if (zOooOOO0) {
                                                                    }
                                                                    i2 = 0;
                                                                    break;
                                                            ...
                                                            e = e3;
                                                            oooOO0O3.f37615OooO00o.zzay().zzd().zzc("Error deleting over the limit events. appId", zzeo.OooO0o0(str5), e);
                                                            jDelete = 0;
                                                        }
                                                        oooOO0O4.OooOOo().insertWithOnConflict("raw_events_metadata", null, contentValues, 4);
                                                        oooOO0O5 = this.f16286OooO0OO;
                                                        OooOooO(oooOO0O5);
                                                        it2 = zzarVar.f16093OooO0o.f16095Oooo0o.keySet().iterator();
                                                        oooOO0O5.zzg();
                                                        oooOO0O5.OooO00o();
                                                        Preconditions.checkNotNull(zzarVar);
                                                        Preconditions.checkNotEmpty(zzarVar.f16089OooO00o);
                                                        zzlb zzlbVar = oooOO0O5.f37794OooO0O0.f16290OooO0oO;
                                                        OooOooO(zzlbVar);
                                                        byte[] bArrZzbv = zzlbVar.OooOOo(zzarVar).zzbv();
                                                        contentValues = new ContentValues();
                                                        contentValues.put("app_id", zzarVar.f16089OooO00o);
                                                        contentValues.put("name", zzarVar.f16090OooO0O0);
                                                        contentValues.put("timestamp", Long.valueOf(zzarVar.f16092OooO0Oo));
                                                        ...
                                                        try {
                                                            if (oooOO0O5.OooOOo().insert("raw_events", null, contentValues) == -1) {
                                                                oooOO0O5.f37615OooO00o.zzay().zzd().zzb("Failed to insert raw event (got -1). appId", zzeo.OooO0o0(zzarVar.f16089OooO00o));
                                                            } else {
                                                                this.f16297OooOOOO = 0L;
                                                            }
                                                        } catch (SQLiteException e4) {
                                                            oooOO0O5.f37615OooO00o.zzay().zzd().zzc("Error storing raw event. appId", zzeo.OooO0o0(zzarVar.f16089OooO00o), e4);
                                                        }
                                                        OooOO0O oooOO0O21 = this.f16286OooO0OO;
                                                        OooOooO(oooOO0O21);
                                                        oooOO0O21.OooO0Oo();
                                                        OooOO0O oooOO0O22 = this.f16286OooO0OO;
                                                        OooOooO(oooOO0O22);
                                                        oooOO0O22.OooOooo();
                                                        OooOoO0();
                                                        zzay().zzj().zzb("Background event processing time, ms", Long.valueOf(((System.nanoTime() - jNanoTime) + 500000) / 1000000));
                                                    } catch (SQLiteException e5) {
                                                        oooOO0O4.f37615OooO00o.zzay().zzd().zzc("Error storing raw event metadata. appId", zzeo.OooO0o0(zzgcVar.zzx()), e5);
                                                        throw e5;
                                                    }
                                                } catch (SQLiteException e6) {
                                                    e = e6;
                                                }
                                                oooOO0O4 = this.f16286OooO0OO;
                                                OooOooO(oooOO0O4);
                                                ...
                                                zzlb zzlbVar2 = oooOO0O4.f37794OooO0O0.f16290OooO0oO;
                                                OooOooO(zzlbVar2);
                                            ...
                                            zzarVar = new zzar(this.f16294OooOO0o, zzawVarZza.zzc, str5, zzawVarZza.zza, zzawVarZza.zzd, bundleZzc);
                                            OooOO0O oooOO0O23 = this.f16286OooO0OO;
                                            OooOooO(oooOO0O23);
                                            oooOOOOOooOo = oooOO0O23.OooOo(str5, zzarVar.f16090OooO0O0);
                                            if (oooOOOOOooOo == null) {
                                                oooOO0O6 = this.f16286OooO0OO;
                                                OooOooO(oooOO0O6);
                                                if (oooOO0O6.OooOOo0(str5) < zzg().OooO0O0(str5)) {
                                                }
                                                oooOOOOOooO0OO = new OooOOOO(str5, zzarVar.f16090OooO0O0, 0L, 0L, 0L, zzarVar.f16092OooO0Oo, 0L, null, null, null, null);
                                            } else {
                                                zzarVar = zzarVar.OooO00o(this.f16294OooOO0o, oooOOOOOooOo.f37508OooO0o);
                                                oooOOOOOooO0OO = oooOOOOOooOo.OooO0OO(zzarVar.f16092OooO0Oo);
                                            }
                                            OooOO0O oooOO0O24 = this.f16286OooO0OO;
                                            OooOooO(oooOO0O24);
                                            ...
                                            Preconditions.checkNotNull(zzqVar);
                                            Preconditions.checkNotEmpty(zzarVar.f16089OooO00o);
                                            Preconditions.checkArgument(zzarVar.f16089OooO00o.equals(zzqVar.zza));
                                            zzgbVarZzt = zzgc.zzt();
                                            zzgbVarZzt.zzad(1);
                                            ...
                                            zzlb zzlbVar3 = this.f16290OooO0oO;
                                            OooOooO(zzlbVar3);
                                            mapZzc = zzeb.zzc(zzlbVar3.f37794OooO0O0.f16294OooOO0o.zzau());
                                            if (mapZzc != null) {
                                                arrayList = null;
                                            } else {
                                                arrayList = null;
                                            ...
                                            if (zzaiVarZzc.zzi(zzahVar)) {
                                                pairOooO0Oo = this.f16283OooO.OooO0Oo(zzqVar.zza, zzaiVarZzc);
                                            ...
                                            this.f16294OooOO0o.zzg().OooO0OO();
                                            zzgbVarZzt.zzN(Build.MODEL);
                                            this.f16294OooOO0o.zzg().OooO0OO();
                                            zzgbVarZzt.zzY(Build.VERSION.RELEASE);
                                            zzgbVarZzt.zzaj((int) this.f16294OooOO0o.zzg().zzb());
                                            zzgbVarZzt.zzan(this.f16294OooOO0o.zzg().zzc());
                                            if (this.f16294OooOO0o.zzJ()) {
                                                zzgbVarZzt.zzap();
                                                if (!TextUtils.isEmpty(null)) {
                                                    zzgbVarZzt.zzO(null);
                                                }
                                            }
                                            OooOO0O oooOO0O25 = this.f16286OooO0OO;
                                            OooOooO(oooOO0O25);
                                            o000oOooOo00 = oooOO0O25.OooOo00(zzqVar.zza);
                                            if (o000oOooOo00 == null) {
                                                o000oOooOo00 = new o000O(this.f16294OooOO0o, zzqVar.zza);
                                                o000oOooOo00.OooO0o0(Oooo00O(zzaiVarZzc));
                                                o000oOooOo00.OooOOO0(zzqVar.zzk);
                                                o000oOooOo00.OooOOO(zzqVar.zzb);
                                                if (zzaiVarZzc.zzi(zzahVar)) {
                                                    o000oOooOo00.OooOo0O(this.f16283OooO.OooO0o0(zzqVar.zza, zzqVar.zzo));
                                                }
                                                o000oOooOo00.OooOOoo(0L);
                                                o000oOooOo00.OooOo00(0L);
                                                o000oOooOo00.OooOOo0(0L);
                                                o000oOooOo00.OooO0oO(zzqVar.zzc);
                                                o000oOooOo00.OooO0oo(zzqVar.zzj);
                                                o000oOooOo00.OooO0o(zzqVar.zzd);
                                                o000oOooOo00.OooOOOO(zzqVar.zze);
                                                o000oOooOo00.OooOO0(zzqVar.zzf);
                                                o000oOooOo00.OooOo0(zzqVar.zzh);
                                                o000oOooOo00.OooOO0O(zzqVar.zzs);
                                                OooOO0O oooOO0O26 = this.f16286OooO0OO;
                                                OooOooO(oooOO0O26);
                                                oooOO0O26.OooO0o0(o000oOooOo00);
                                            }
                                            if (zzaiVarZzc.zzi(zzah.ANALYTICS_STORAGE)) {
                                                zzgbVarZzt.zzE((String) Preconditions.checkNotNull(o000oOooOo00.Oooo0o()));
                                            }
                                            if (!TextUtils.isEmpty(o000oOooOo00.Oooo())) {
                                                zzgbVarZzt.zzT((String) Preconditions.checkNotNull(o000oOooOo00.Oooo()));
                                            }
                                            OooOO0O oooOO0O27 = this.f16286OooO0OO;
                                            OooOooO(oooOO0O27);
                                            listOooOoo = oooOO0O27.OooOoo(zzqVar.zza);
                                            for (i = 0; i < listOooOoo.size(); i++) {
                                                zzgk zzgkVarZzd = zzgl.zzd();
                                                zzgkVarZzd.zzf(((oo0ooO) listOooOoo.get(i)).f37908OooO0OO);
                                                zzgkVarZzd.zzg(((oo0ooO) listOooOoo.get(i)).f37909OooO0Oo);
                                                zzlb zzlbVar4 = this.f16290OooO0oO;
                                                OooOooO(zzlbVar4);
                                                zzlbVar4.OooOoO(zzgkVarZzd, ((oo0ooO) listOooOoo.get(i)).f37910OooO0o0);
                    ...
                    if (z) {
                        ...
                        zzay().zzk().zzc("Data lost. Currency value is too big. appId", zzeo.OooO0o0(str5), Double.valueOf(dDoubleValue));
                        OooOO0O oooOO0O28 = this.f16286OooO0OO;
                        OooOooO(oooOO0O28);
                        oooOO0O28.OooO0Oo();
                        OooOO0O oooOO0O110 = this.f16286OooO0OO;
                        OooOooO(oooOO0O110);
                        oooOO0O110.OooOooo();
                        return;
                    }
                    ...
                    if (!TextUtils.isEmpty(strOoooO0O)) {
                        ...
                        if (upperCase.matches("[A-Z]{3}")) {
                            strConcat = "_ltv_".concat(upperCase);
                            OooOO0O oooOO0O111 = this.f16286OooO0OO;
                            OooOooO(oooOO0O111);
                            oo0oooOooOoO0 = oooOO0O111.OooOoO0(str5, strConcat);
                            if (oo0oooOooOoO0 != null) {
                                obj = oo0oooOooOoO0.f37910OooO0o0;
                                if (obj instanceof Long) {
                                    str2 = str6;
                ...
                if (jIntValue > 0) {
                    ...
                    OooOO0O oooOO0O113 = this.f16286OooO0OO;
                    OooOooO(oooOO0O113);
                    oooOO0O113.OooO0Oo();
                    OooOO0O oooOO0O114 = this.f16286OooO0OO;
                    OooOooO(oooOO0O114);
                    oooOO0O114.OooOooo();
                    return;
                }
                if (zOooOoo) {
                    long j6 = zzakVarOooOo0o.f16079OooO00o;
                    zzg();
                    ...
                    if (jIntValue2 > 0) {
                        ...
                        zzv().OooOOO(this.f16313OooOooo, str5, 16, "_ev", zzawVarZza.zza, 0);
                        OooOO0O oooOO0O115 = this.f16286OooO0OO;
                        OooOooO(oooOO0O115);
                        oooOO0O115.OooO0Oo();
                        OooOO0O oooOO0O116 = this.f16286OooO0OO;
                        OooOooO(oooOO0O116);
                        oooOO0O116.OooOooo();
                        return;
                    }
                ...
                if (zEquals) {
                    ...
                    if (jMax > 0) {
                        ...
                        OooOO0O oooOO0O117 = this.f16286OooO0OO;
                        OooOooO(oooOO0O117);
                        oooOO0O117.OooO0Oo();
                        OooOO0O oooOO0O118 = this.f16286OooO0OO;
                        OooOooO(oooOO0O118);
                        oooOO0O118.OooOooo();
                        return;
                    }
                ...
                if ("_s".equals(zzawVarZza.zza)) {
                    OooOO0O oooOO0O119 = this.f16286OooO0OO;
                    OooOooO(oooOO0O119);
                    oo0oooOooOoO1 = oooOO0O119.OooOoO0(zzqVar.zza, "_sno");
                    if (oo0oooOooOoO1 != null && (oo0oooOooOoO1.f37910OooO0o0 instanceof Long)) {
                        zzv().OooOOOO(bundleZzc, "_sno", oo0oooOooOoO1.f37910OooO0o0);
                    }
                }
                oooOO0O3 = this.f16286OooO0OO;
                ...
                zzarVar = new zzar(this.f16294OooOO0o, zzawVarZza.zzc, str5, zzawVarZza.zza, zzawVarZza.zzd, bundleZzc);
                OooOO0O oooOO0O29 = this.f16286OooO0OO;
                OooOooO(oooOO0O29);
                oooOOOOOooOo = oooOO0O29.OooOo(str5, zzarVar.f16090OooO0O0);
                if (oooOOOOOooOo == null) {
                    oooOO0O6 = this.f16286OooO0OO;
                    OooOooO(oooOO0O6);
                    if (oooOO0O6.OooOOo0(str5) < zzg().OooO0O0(str5) && zOooOoo) {
                        zzay().zzd().zzd("Too many event names used, ignoring event. appId, name, supported count", zzeo.OooO0o0(str5), this.f16294OooOO0o.zzj().OooO0Oo(zzarVar.f16090OooO0O0), Integer.valueOf(zzg().OooO0O0(str5)));
                        zzv().OooOOO(this.f16313OooOooo, str5, 8, null, null, 0);
                        OooOO0O oooOO0O30 = this.f16286OooO0OO;
                        OooOooO(oooOO0O30);
                        oooOO0O30.OooOooo();
                        return;
                    }
                ...
                OooOO0O oooOO0O210 = this.f16286OooO0OO;
                OooOooO(oooOO0O210);
                ...
                zzlb zzlbVar5 = this.f16290OooO0oO;
                OooOooO(zzlbVar5);
                mapZzc = zzeb.zzc(zzlbVar5.f37794OooO0O0.f16294OooOO0o.zzau());
                            ...
                            try {
                                ...
                                if (i3 != 0) {
                                    ...
                                    if (arrayList.size() >= iIntValue) {
                                        zzlbVar5.f37615OooO00o.zzay().zzk().zzb("Too many experiment IDs. Number of IDs", Integer.valueOf(arrayList.size()));
                                        break;
                                    }
                                    continue;
                                } else {
                                ...
                                zzlbVar5.f37615OooO00o.zzay().zzk().zzb("Experiment ID NumberFormatException", e9);
                            }
                        }
                    }
                ...
                OooOO0O oooOO0O211 = this.f16286OooO0OO;
                OooOooO(oooOO0O211);
                o000oOooOo00 = oooOO0O211.OooOo00(zzqVar.zza);
                if (o000oOooOo00 == null) {
                    o000oOooOo00 = new o000O(this.f16294OooOO0o, zzqVar.zza);
                    o000oOooOo00.OooO0o0(Oooo00O(zzaiVarZzc));
                    o000oOooOo00.OooOOO0(zzqVar.zzk);
                    ...
                    o000oOooOo00.OooOo0(zzqVar.zzh);
                    o000oOooOo00.OooOO0O(zzqVar.zzs);
                    OooOO0O oooOO0O212 = this.f16286OooO0OO;
                    OooOooO(oooOO0O212);
                    oooOO0O212.OooO0o0(o000oOooOo00);
                }
                if (zzaiVarZzc.zzi(zzah.ANALYTICS_STORAGE) && !TextUtils.isEmpty(o000oOooOo00.Oooo0o())) {
                    zzgbVarZzt.zzE((String) Preconditions.checkNotNull(o000oOooOo00.Oooo0o()));
                }
                if (!TextUtils.isEmpty(o000oOooOo00.Oooo())) {
                    zzgbVarZzt.zzT((String) Preconditions.checkNotNull(o000oOooOo00.Oooo()));
                }
                OooOO0O oooOO0O213 = this.f16286OooO0OO;
                OooOooO(oooOO0O213);
                listOooOoo = oooOO0O213.OooOoo(zzqVar.zza);
                while (i < listOooOoo.size()) {
                    zzgk zzgkVarZzd2 = zzgl.zzd();
                    zzgkVarZzd2.zzf(((oo0ooO) listOooOoo.get(i)).f37908OooO0OO);
                    zzgkVarZzd2.zzg(((oo0ooO) listOooOoo.get(i)).f37909OooO0Oo);
                    zzlb zzlbVar6 = this.f16290OooO0oO;
                    OooOooO(zzlbVar6);
                    zzlbVar6.OooOoO(zzgkVarZzd2, ((oo0ooO) listOooOoo.get(i)).f37910OooO0o0);
                ...
                zzlb zzlbVar7 = oooOO0O4.f37794OooO0O0.f16290OooO0oO;
                OooOooO(zzlbVar7);
                ...
                while (true) {
                    if (it2.hasNext()) {
                        zzfp zzfpVar5 = this.f16284OooO00o;
                        OooOooO(zzfpVar5);
                        zOooOOO0 = zzfpVar5.OooOOO0(zzarVar.f16089OooO00o, zzarVar.f16090OooO0O0);
                        OooOO0O oooOO0O214 = this.f16286OooO0OO;
                        OooOooO(oooOO0O214);
                        zzak zzakVarOooOo0O2 = oooOO0O214.OooOo0O(OooOOo(), zzarVar.f16089OooO00o, false, false);
                        if (zOooOOO0 || zzakVarOooOo0O2.f16083OooO0o0 >= zzg().zze(zzarVar.f16089OooO00o, zzeb.zzn)) {
                            i2 = 0;
                            break;
                        }
                ...
                Preconditions.checkNotNull(zzarVar);
                Preconditions.checkNotEmpty(zzarVar.f16089OooO00o);
                zzlb zzlbVar8 = oooOO0O5.f37794OooO0O0.f16290OooO0oO;
                OooOooO(zzlbVar8);
                ...
                OooOO0O oooOO0O215 = this.f16286OooO0OO;
                OooOooO(oooOO0O215);
                oooOO0O215.OooO0Oo();
                OooOO0O oooOO0O216 = this.f16286OooO0OO;
                OooOooO(oooOO0O216);
                oooOO0O216.OooOooo();
                OooOoO0();
                zzay().zzj().zzb("Background event processing time, ms", Long.valueOf(((System.nanoTime() - jNanoTime) + 500000) / 1000000));
            } catch (Throwable th) {
                OooOO0O oooOO0O31 = this.f16286OooO0OO;
                OooOooO(oooOO0O31);
                oooOO0O31.OooOooo();
                throw th;
            }
    ...
    public final void OooOo(zzgb zzgbVar, long j, boolean z) {
        ...
        OooOO0O oooOO0O = this.f16286OooO0OO;
        OooOooO(oooOO0O);
        oo0ooO oo0oooOooOoO0 = oooOO0O.OooOoO0(zzgbVar.zzap(), str);
        if (oo0oooOooOoO0 == null || oo0oooOooOoO0.f37910OooO0o0 == null) {
            oo0ooo = new oo0ooO(zzgbVar.zzap(), DebugKt.DEBUG_PROPERTY_VALUE_AUTO, str, zzav().currentTimeMillis(), Long.valueOf(j));
        } else {
            oo0ooo = new oo0ooO(zzgbVar.zzap(), DebugKt.DEBUG_PROPERTY_VALUE_AUTO, str, zzav().currentTimeMillis(), Long.valueOf(((Long) oo0oooOooOoO0.f37910OooO0o0).longValue() + j));
        }
        zzgk zzgkVarZzd = zzgl.zzd();
        zzgkVarZzd.zzf(str);
        zzgkVarZzd.zzg(zzav().currentTimeMillis());
        zzgkVarZzd.zze(((Long) oo0ooo.f37910OooO0o0).longValue());
        ...
        if (j > 0) {
            OooOO0O oooOO0O2 = this.f16286OooO0OO;
            OooOooO(oooOO0O2);
            oooOO0O2.OooOO0(oo0ooo);
            zzay().zzj().zzc("Updated engagement user property. scope, value", true != z ? "lifetime" : "session-scoped", oo0ooo.f37910OooO0o0);
        }
    }
    ...
    public final zzq OooOo0(String str) {
        ...
        String strOooo0O0 = o000oOooOo00.Oooo0O0();
        o000oOooOo00.f37572OooO00o.zzaz().zzg();
        return new zzq(str, strOoooO00, strOooo0oo, jOooOoOO, strOooo0oO, jOooo000, jOooOoo, null, zOooOoO, false, strOooo, 0L, 0, zOooOoO0, false, strOooo0O0, o000oOooOo00.f37587OooOOo, o000oOooOo00.OooOooO(), o000oOooOo00.OooO00o(), Oooo000(str).zzh(), "", null);
    }

    @WorkerThread
    public final Boolean OooOo0O(o000O o000o) {
        try {
            if (o000o.OooOoOO() != -2147483648L) {
                if (o000o.OooOoOO() == Wrappers.packageManager(this.f16294OooOO0o.zzau()).getPackageInfo(o000o.Oooo0o0(), 0).versionCode) {
                    return Boolean.TRUE;
                }
            } else {
                String str = Wrappers.packageManager(this.f16294OooOO0o.zzau()).getPackageInfo(o000o.Oooo0o0(), 0).versionName;
                String strOooo0oo = o000o.Oooo0oo();
    ...
    public final void OooOo0o() {
        zzaz().zzg();
        if (this.f16301OooOOoo || this.f16304OooOo00 || this.f16303OooOo0) {
            zzay().zzj().zzd("Not stopping services. fetch, network, upload", Boolean.valueOf(this.f16301OooOOoo), Boolean.valueOf(this.f16304OooOo00), Boolean.valueOf(this.f16303OooOo0));
            return;
        }
        zzay().zzj().zza("Stopping uploading service(s)");
        ArrayList arrayList = this.f16298OooOOOo;
        if (arrayList == null) {
            return;
        }
        Iterator it = arrayList.iterator();
        ...
        ((List) Preconditions.checkNotNull(this.f16298OooOOOo)).clear();
    }
    ...
    public final boolean OooOoO(long j) {
        ...
        oooOO0O.zzw();
        try {
            o0OO000 o0oo001 = new o0OO000(this);
            OooOO0O oooOO0O2 = this.f16286OooO0OO;
            OooOooO(oooOO0O2);
            oooOO0O2.OooOO0O(j, this.f16307OooOoO, o0oo001);
            ArrayList arrayList2 = o0oo001.f37815OooO0OO;
            if (arrayList2 != null && !arrayList2.isEmpty()) {
                zzgb zzgbVar4 = (zzgb) o0oo001.f37813OooO00o.zzby();
                zzgbVar4.zzr();
                int i11 = 0;
                int i12 = 0;
                int i13 = 0;
                ...
                while (true) {
                    ...
                    str = str3;
                    String str5 = str4;
                    if (i12 >= o0oo001.f37815OooO0OO.size()) {
                        break;
                    }
                    zzfr zzfrVar7 = (zzfr) ((zzfs) o0oo001.f37815OooO0OO.get(i12)).zzby();
                    zzfp zzfpVar = this.f16284OooO00o;
                    OooOooO(zzfpVar);
                    int i16 = i13;
                    if (zzfpVar.OooOOO(o0oo001.f37813OooO00o.zzx(), zzfrVar7.zzo())) {
                        zzay().zzk().zzc("Dropping blocked raw event. appId", zzeo.OooO0o0(o0oo001.f37813OooO00o.zzx()), this.f16294OooOO0o.zzj().OooO0Oo(zzfrVar7.zzo()));
                        zzfp zzfpVar2 = this.f16284OooO00o;
                        OooOooO(zzfpVar2);
                        if (!zzfpVar2.OooOO0o(o0oo001.f37813OooO00o.zzx())) {
                            zzfp zzfpVar3 = this.f16284OooO00o;
                            OooOooO(zzfpVar3);
                            if (!zzfpVar3.OooOOOO(o0oo001.f37813OooO00o.zzx()) && !"_err".equals(zzfrVar7.zzo())) {
                                zzv().OooOOO(this.f16313OooOooo, o0oo001.f37813OooO00o.zzx(), 11, "_ev", zzfrVar7.zzo(), 0);
                            }
                        }
                        i6 = i12;
                        i11 = i;
                        ...
                        zzfp zzfpVar4 = this.f16284OooO00o;
                        OooOooO(zzfpVar4);
                        boolean zOooOOO0 = zzfpVar4.OooOOO0(o0oo001.f37813OooO00o.zzx(), zzfrVar7.zzo());
                        if (zOooOOO0) {
                            zzfrVar = zzfrVar5;
                            i2 = i14;
                        } else {
                            ...
                            i6 = i19;
                            o0oo001.f37815OooO0OO.set(i6, (zzfs) zzfrVar7.zzaE());
                            i13 = i16 + 1;
                        ...
                        i3 = i15;
                        if (!z && zOooOOO0) {
                            zzay().zzj().zzb("Marking event as conversion", this.f16294OooOO0o.zzj().OooO0Oo(zzfrVar7.zzo()));
                            com.google.android.gms.internal.measurement.zzfv zzfvVarZze = com.google.android.gms.internal.measurement.zzfw.zze();
                            zzfvVarZze.zzj("_c");
                            zzfvVarZze.zzi(1L);
                        ...
                        if (!z2) {
                            zzay().zzj().zzb("Marking event as real-time", this.f16294OooOO0o.zzj().OooO0Oo(zzfrVar7.zzo()));
                            com.google.android.gms.internal.measurement.zzfv zzfvVarZze2 = com.google.android.gms.internal.measurement.zzfw.zze();
                            zzfvVarZze2.zzj("_r");
                            zzfvVarZze2.zzi(1L);
                        ...
                        OooOO0O oooOO0O3 = this.f16286OooO0OO;
                        OooOooO(oooOO0O3);
                        if (oooOO0O3.OooOo0O(OooOOo(), o0oo001.f37813OooO00o.zzx(), false, true).f16083OooO0o0 > zzg().zze(o0oo001.f37813OooO00o.zzx(), zzeb.zzn)) {
                            OooOo00(zzfrVar7, "_r");
                        } else {
                            i = 1;
                        }
                        if (zzlh.OooOoo(zzfrVar7.zzo()) && zOooOOO0) {
                            OooOO0O oooOO0O4 = this.f16286OooO0OO;
                            OooOooO(oooOO0O4);
                            if (oooOO0O4.OooOo0O(OooOOo(), o0oo001.f37813OooO00o.zzx(), true, false).f16081OooO0OO > zzg().zze(o0oo001.f37813OooO00o.zzx(), zzeb.zzm)) {
                                zzay().zzk().zzb("Too many conversions. Not logging as conversion. appId", zzeo.OooO0o0(o0oo001.f37813OooO00o.zzx()));
                                ...
                                if (z3) {
                                    if (zzfvVar3 != null) {
                                        ...
                                        if (zzfvVar3 != null) {
                                            ...
                                            zzay().zzd().zzb("Did not find conversion parameter. appId", zzeo.OooO0o0(o0oo001.f37813OooO00o.zzx()));
                                        }
                                    }
                ...
                if (zzlb.OooOOO0(zzgbVar5, "_sid") >= 0) {
                    ...
                    if (iOooOOO0 >= 0) {
                        ...
                        zzay().zzd().zzb("Session engagement user property is in the bundle without session ID. appId", zzeo.OooO0o0(o0oo001.f37813OooO00o.zzx()));
                    }
                }
                zzlb zzlbVar = this.f16290OooO0oO;
                OooOooO(zzlbVar);
                zzlbVar.f37615OooO00o.zzay().zzj().zza("Checking account type status for ad personalization signals");
                zzfp zzfpVar5 = zzlbVar.f37794OooO0O0.f16284OooO00o;
                OooOooO(zzfpVar5);
                if (zzfpVar5.OooOO0O(zzgbVar5.zzap())) {
                    OooOO0O oooOO0O6 = zzlbVar.f37794OooO0O0.f16286OooO0OO;
                    OooOooO(oooOO0O6);
                    o000O o000oOooOo00 = oooOO0O6.OooOo00(zzgbVar5.zzap());
                    if (o000oOooOo00 != null && o000oOooOo00.OooOoO0() && zzlbVar.f37615OooO00o.zzg().OooO0o()) {
                        zzlbVar.f37615OooO00o.zzay().zzc().zza("Turning off ad personalization due to account type");
                        zzgk zzgkVarZzd = zzgl.zzd();
                        zzgkVarZzd.zzf(str);
                        zzgkVarZzd.zzg(zzlbVar.f37615OooO00o.zzg().OooO0o0());
                        zzgkVarZzd.zze(1L);
                        zzgl zzglVar = (zzgl) zzgkVarZzd.zzaE();
                        int i25 = 0;
                        while (true) {
                ...
                zzgbVar5.zzz();
                zzgbVar5.zzo();
                OooO0OO oooO0OO = this.f16288OooO0o;
                OooOooO(oooO0OO);
                ...
                if (zzg().zzw(o0oo001.f37813OooO00o.zzx())) {
                    ...
                    while (i27 < zzgbVar5.zza()) {
                        ...
                        if (zzfrVar10.zzo().equals("_ep")) {
                            ...
                            if (oooOOOOOooOo == null) {
                                OooOO0O oooOO0O7 = this.f16286OooO0OO;
                                OooOooO(oooOO0O7);
                                oooOOOOOooOo = oooOO0O7.OooOo(o0oo001.f37813OooO00o.zzx(), (String) Preconditions.checkNotNull(str6));
                                if (oooOOOOOooOo != null) {
                                    map2.put(str6, oooOOOOOooOo);
                                }
                            }
                            if (oooOOOOOooOo != null && oooOOOOOooOo.f37503OooO == null) {
                                Long l = oooOOOOOooOo.f37512OooOO0;
                                if (l != null && l.longValue() > 1) {
                                    OooOooO(this.f16290OooO0oO);
                                    zzlb.OooOooo(zzfrVar10, "_sr", oooOOOOOooOo.f37512OooOO0);
                                }
                                Boolean bool = oooOOOOOooOo.f37513OooOO0O;
                            ...
                            zzfp zzfpVar6 = this.f16284OooO00o;
                            OooOooO(zzfpVar6);
                            String strZzx = o0oo001.f37813OooO00o.zzx();
                            ...
                            if (TextUtils.isEmpty(strZza)) {
                                ...
                                try {
                                    ...
                                    zzfpVar6.f37615OooO00o.zzay().zzk().zzc("Unable to parse timezone offset. appId", zzeo.OooO0o0(strZzx), e);
                                    j2 = 0;
                                }
                            }
                            ...
                            if (!TextUtils.isEmpty("_dbg")) {
                                ...
                                while (true) {
                                    ...
                                    zzfp zzfpVar7 = this.f16284OooO00o;
                                    OooOooO(zzfpVar7);
                                    iOooO0oo = zzfpVar7.OooO0oo(o0oo001.f37813OooO00o.zzx(), zzfrVar10.zzo());
                                    break;
                                }
                            }
                            zzfp zzfpVar8 = this.f16284OooO00o;
                            OooOooO(zzfpVar8);
                            iOooO0oo = zzfpVar8.OooO0oo(o0oo001.f37813OooO00o.zzx(), zzfrVar10.zzo());
                            break;
                            if (iOooO0oo <= 0) {
                                ...
                                if (oooOOOOOooO00o == null) {
                                    OooOO0O oooOO0O8 = this.f16286OooO0OO;
                                    OooOooO(oooOO0O8);
                                    oooOOOOOooO00o = oooOO0O8.OooOo(o0oo001.f37813OooO00o.zzx(), zzfrVar10.zzo());
                                    if (oooOOOOOooO00o == null) {
                                        zzay().zzk().zzc("Event being bundled has no eventAggregate. appId, eventName", o0oo001.f37813OooO00o.zzx(), zzfrVar10.zzo());
                                        oooOOOOOooO00o = new OooOOOO(o0oo001.f37813OooO00o.zzx(), zzfrVar10.zzo(), 1L, 1L, 1L, zzfrVar10.zzc(), 0L, null, null, null, null);
                                    }
                                }
                                OooOooO(this.f16290OooO0oO);
                                ...
                                if (iOooO0oo == 1) {
                                    arrayList3.add((zzfs) zzfrVar10.zzaE());
                                    if (boolValueOf.booleanValue() && (oooOOOOOooO00o.f37503OooO != null || oooOOOOOooO00o.f37512OooOO0 != null || oooOOOOOooO00o.f37513OooOO0O != null)) {
                                    ...
                                    if (secureRandomOooO.nextInt(iOooO0oo) == 0) {
                                        ...
                                        Long l4 = oooOOOOOooO00o.f37511OooO0oo;
                ...
                o0OO000 o0oo002 = o0oo000;
                String strZzx2 = o0oo002.f37813OooO00o.zzx();
                OooOO0O oooOO0O10 = this.f16286OooO0OO;
                OooOooO(oooOO0O10);
                o000O o000oOooOo01 = oooOO0O10.OooOo00(strZzx2);
                if (o000oOooOo01 == null) {
                    zzay().zzd().zzb("Bundling raw events w/o app info. appId", zzeo.OooO0o0(o0oo002.f37813OooO00o.zzx()));
                } else if (zzgbVar.zza() > 0) {
                    long jOooo00O = o000oOooOo01.Oooo00O();
                    if (jOooo00O != 0) {
                        zzgbVar.zzab(jOooo00O);
                    } else {
                        zzgbVar.zzv();
                    }
                    long jOooo0 = o000oOooOo01.Oooo0();
                    if (jOooo0 != 0) {
                        jOooo00O = jOooo0;
                    }
                    if (jOooo00O != 0) {
                    ...
                    o000oOooOo01.OooO0O0();
                    zzgbVar.zzI((int) o000oOooOo01.Oooo00o());
                    o000oOooOo01.OooOo00(zzgbVar.zzd());
                    o000oOooOo01.OooOOo0(zzgbVar.zzc());
                    String strOooo0OO = o000oOooOo01.Oooo0OO();
                    if (strOooo0OO != null) {
                    ...
                    OooOO0O oooOO0O11 = this.f16286OooO0OO;
                    OooOooO(oooOO0O11);
                    oooOO0O11.OooO0o0(o000oOooOo01);
                }
                if (zzgbVar.zza() > 0) {
                    this.f16294OooOO0o.zzaw();
                    zzfp zzfpVar9 = this.f16284OooO00o;
                    OooOooO(zzfpVar9);
                    zzfe zzfeVarOooO = zzfpVar9.OooO(o0oo002.f37813OooO00o.zzx());
                    if (zzfeVarOooO != null && zzfeVarOooO.zzs()) {
                        zzgbVar.zzK(zzfeVarOooO.zzc());
                    } else if (o0oo002.f37813OooO00o.zzF().isEmpty()) {
                        zzgbVar.zzK(-1L);
                    } else {
                        zzay().zzk().zzb("Did not find measurement config or missing version info. appId", zzeo.OooO0o0(o0oo002.f37813OooO00o.zzx()));
                    }
                    OooOO0O oooOO0O12 = this.f16286OooO0OO;
                    OooOooO(oooOO0O12);
                    ...
                    oooOO0O12.zzz();
                    long jCurrentTimeMillis = oooOO0O12.f37615OooO00o.zzav().currentTimeMillis();
                    long jZzk = zzgcVar.zzk();
                    oooOO0O12.f37615OooO00o.zzf();
                    if (jZzk >= jCurrentTimeMillis - zzag.zzA()) {
                        long jZzk2 = zzgcVar.zzk();
                        oooOO0O12.f37615OooO00o.zzf();
                        if (jZzk2 > zzag.zzA() + jCurrentTimeMillis) {
                            oooOO0O12.f37615OooO00o.zzay().zzk().zzd("Storing bundle outside of the max uploading time span. appId, now, timestamp", zzeo.OooO0o0(zzgcVar.zzx()), Long.valueOf(jCurrentTimeMillis), Long.valueOf(zzgcVar.zzk()));
                        }
                    } else {
                        oooOO0O12.f37615OooO00o.zzay().zzk().zzd("Storing bundle outside of the max uploading time span. appId, now, timestamp", zzeo.OooO0o0(zzgcVar.zzx()), Long.valueOf(jCurrentTimeMillis), Long.valueOf(zzgcVar.zzk()));
                    }
                    ...
                    try {
                        zzlb zzlbVar2 = oooOO0O12.f37794OooO0O0.f16290OooO0oO;
                        OooOooO(zzlbVar2);
                        byte[] bArrOooOooO = zzlbVar2.OooOooO(bArrZzbv);
                        oooOO0O12.f37615OooO00o.zzay().zzj().zzb("Saving bundle, size", Integer.valueOf(bArrOooOooO.length));
                        ContentValues contentValues = new ContentValues();
                        ...
                        try {
                            if (oooOO0O12.OooOOo().insert("queue", null, contentValues) == -1) {
                                oooOO0O12.f37615OooO00o.zzay().zzd().zzb("Failed to insert bundle (got -1). appId", zzeo.OooO0o0(zzgcVar.zzx()));
                            }
                        } catch (SQLiteException e2) {
                            oooOO0O12.f37615OooO00o.zzay().zzd().zzc("Error storing bundle. appId", zzeo.OooO0o0(zzgcVar.zzx()), e2);
                        }
                    } catch (IOException e3) {
                        oooOO0O12.f37615OooO00o.zzay().zzd().zzc("Data loss. Failed to serialize bundle. appId", zzeo.OooO0o0(zzgcVar.zzx()), e3);
                    }
                }
                OooOO0O oooOO0O13 = this.f16286OooO0OO;
                OooOooO(oooOO0O13);
                ArrayList arrayList4 = o0oo002.f37814OooO0O0;
                ...
                if (iDelete != arrayList4.size()) {
                    oooOO0O13.f37615OooO00o.zzay().zzd().zzc("Deleted fewer rows from raw events table than expected", Integer.valueOf(iDelete), Integer.valueOf(arrayList4.size()));
                }
                OooOO0O oooOO0O14 = this.f16286OooO0OO;
                OooOooO(oooOO0O14);
                try {
                    ...
                    oooOO0O14.f37615OooO00o.zzay().zzd().zzc("Failed to remove unused event metadata. appId", zzeo.OooO0o0(strZzx2), e4);
                }
                OooOO0O oooOO0O15 = this.f16286OooO0OO;
                OooOooO(oooOO0O15);
                oooOO0O15.OooO0Oo();
    ...
    public final void OooOoO0() {
        ...
        zzaz().zzg();
        OooO0O0();
        if (this.f16297OooOOOO > 0) {
            long jAbs = 3600000 - Math.abs(zzav().elapsedRealtime() - this.f16297OooOOOO);
            if (jAbs > 0) {
                zzay().zzj().zzb("Upload has been suspended. Will update scheduling later in approximately ms", Long.valueOf(jAbs));
                zzm().OooO00o();
                zzkl zzklVar = this.f16289OooO0o0;
                OooOooO(zzklVar);
                zzklVar.zza();
                return;
            }
        ...
        if (!this.f16294OooOO0o.OooO0O0() || !OooOoOO()) {
            zzay().zzj().zza("Nothing to upload or uploading impossible");
            zzm().OooO00o();
            zzkl zzklVar2 = this.f16289OooO0o0;
            OooOooO(zzklVar2);
            zzklVar2.zza();
            return;
        }
        ...
        long jZza2 = this.f16283OooO.zzc.zza();
        long jZza3 = this.f16283OooO.zzd.zza();
        OooOO0O oooOO0O3 = this.f16286OooO0OO;
        OooOooO(oooOO0O3);
        ...
        if (jMax5 != 0) {
            ...
            zzkzVar = this;
            zzlb zzlbVar2 = zzkzVar.f16290OooO0oO;
            OooOooO(zzlbVar2);
            ...
            if (jMax2 != 0) {
                ...
                zzm().OooO00o();
                zzkl zzklVar3 = zzkzVar.f16289OooO0o0;
                OooOooO(zzklVar3);
                zzklVar3.zza();
                return;
            }
            ...
            if (zzeuVar.zza()) {
                ...
                o0oo00oZzm = zzm();
                o0oo00oZzm.f37820OooO00o.OooO0O0();
                o0oo00oZzm.f37820OooO00o.zzaz().zzg();
                if (!o0oo00oZzm.f37821OooO0O0) {
                    o0oo00oZzm.f37820OooO00o.zzau().registerReceiver(o0oo00oZzm, new IntentFilter("android.net.conn.CONNECTIVITY_CHANGE"));
                    o0oo00oZzm.f37822OooO0OO = o0oo00oZzm.f37820OooO00o.zzl().zza();
                    o0oo00oZzm.f37820OooO00o.zzay().zzj().zzb("Registering connectivity change receiver. Network connected", Boolean.valueOf(o0oo00oZzm.f37822OooO0OO));
                    o0oo00oZzm.f37821OooO0O0 = true;
                }
                zzkl zzklVar4 = zzkzVar.f16289OooO0o0;
                OooOooO(zzklVar4);
                zzklVar4.zza();
                return;
            }
            jZza = zzkzVar.f16283OooO.zzb.zza();
            zzg();
            jMax3 = Math.max(0L, ((Long) zzeb.zzq.zza(null)).longValue());
            zzlbVar = zzkzVar.f16290OooO0oO;
            OooOooO(zzlbVar);
            ...
            if (jCurrentTimeMillis <= 0) {
                ...
                zzkzVar.f16283OooO.zzc.zzb(zzav().currentTimeMillis());
            }
            zzay().zzj().zzb("Upload scheduled in approximately ms", Long.valueOf(jCurrentTimeMillis));
            zzkl zzklVar5 = zzkzVar.f16289OooO0o0;
            OooOooO(zzklVar5);
        ...
        if (jMax2 != 0) {
            zzay().zzj().zza("Next upload time is 0");
            zzm().OooO00o();
            zzkl zzklVar6 = zzkzVar.f16289OooO0o0;
            OooOooO(zzklVar6);
            zzklVar6.zza();
            return;
        }
        ...
        if (zzeuVar.zza()) {
            ...
            zzkl zzklVar7 = zzkzVar.f16289OooO0o0;
            OooOooO(zzklVar7);
            zzklVar7.zza();
            return;
        }
        ...
        zzay().zzj().zzb("Upload scheduled in approximately ms", Long.valueOf(jCurrentTimeMillis));
        zzkl zzklVar8 = zzkzVar.f16289OooO0o0;
        OooOooO(zzklVar8);
    ...
    @WorkerThread
    public final o000O OooOooo(zzq zzqVar) {
        zzaz().zzg();
        OooO0O0();
        Preconditions.checkNotNull(zzqVar);
        Preconditions.checkNotEmpty(zzqVar.zza);
        ...
        if (zzg().zzs(zzqVar.zza, zzeb.zzat) && !zzqVar.zzw.isEmpty()) {
            this.f16311OooOoo0.put(zzqVar.zza, new o0OO000o(this, zzqVar.zzw, null));
        }
        OooOO0O oooOO0O = this.f16286OooO0OO;
        OooOooO(oooOO0O);
        o000O o000oOooOo00 = oooOO0O.OooOo00(zzqVar.zza);
        ...
        String strOooO0o0 = zzaiVarZzc.zzi(zzahVar) ? this.f16283OooO.OooO0o0(zzqVar.zza, zzqVar.zzo) : "";
        if (o000oOooOo00 == null) {
            o000oOooOo00 = new o000O(this.f16294OooOO0o, zzqVar.zza);
            if (zzaiVarZzc.zzi(zzah.ANALYTICS_STORAGE)) {
                o000oOooOo00.OooO0o0(Oooo00O(zzaiVarZzc));
            ...
            if (zzaiVarZzc.zzi(zzahVar)) {
                o000oOooOo00.OooOo0O(strOooO0o0);
            }
        } else if (zzaiVarZzc.zzi(zzahVar) && strOooO0o0 != null) {
            o000oOooOo00.f37572OooO00o.zzaz().zzg();
            if (!strOooO0o0.equals(o000oOooOo00.f37577OooO0o0)) {
                o000oOooOo00.OooOo0O(strOooO0o0);
                if (zzqVar.zzo && !"00000000-0000-0000-0000-000000000000".equals(this.f16283OooO.OooO0Oo(zzqVar.zza, zzaiVarZzc).first)) {
                    o000oOooOo00.OooO0o0(Oooo00O(zzaiVarZzc));
                    OooOO0O oooOO0O2 = this.f16286OooO0OO;
                    OooOooO(oooOO0O2);
                    if (oooOO0O2.OooOoO0(zzqVar.zza, ao.d) != null) {
                        ...
                        if (oooOO0O3.OooOoO0(zzqVar.zza, "_lair") == null) {
                            oo0ooO oo0ooo = new oo0ooO(zzqVar.zza, DebugKt.DEBUG_PROPERTY_VALUE_AUTO, "_lair", zzav().currentTimeMillis(), 1L);
                            OooOO0O oooOO0O4 = this.f16286OooO0OO;
                            OooOooO(oooOO0O4);
                            oooOO0O4.OooOO0(oo0ooo);
                        }
                    }
                }
            } else if (TextUtils.isEmpty(o000oOooOo00.Oooo0o())) {
                o000oOooOo00.OooO0o0(Oooo00O(zzaiVarZzc));
            }
        } else if (TextUtils.isEmpty(o000oOooOo00.Oooo0o()) && zzaiVarZzc.zzi(zzah.ANALYTICS_STORAGE)) {
            o000oOooOo00.OooO0o0(Oooo00O(zzaiVarZzc));
        }
        o000oOooOo00.OooOOO(zzqVar.zzb);
        o000oOooOo00.OooO0OO(zzqVar.zzq);
        if (!TextUtils.isEmpty(zzqVar.zzk)) {
            o000oOooOo00.OooOOO0(zzqVar.zzk);
        }
        long j = zzqVar.zze;
        if (j != 0) {
            o000oOooOo00.OooOOOO(j);
        }
        if (!TextUtils.isEmpty(zzqVar.zzc)) {
            o000oOooOo00.OooO0oO(zzqVar.zzc);
        }
        ...
        if (str != null) {
            o000oOooOo00.OooO0o(str);
        }
        o000oOooOo00.OooOO0(zzqVar.zzf);
        o000oOooOo00.OooOo0(zzqVar.zzh);
        if (!TextUtils.isEmpty(zzqVar.zzg)) {
            o000oOooOo00.OooOOOo(zzqVar.zzg);
        }
        o000oOooOo00.OooO0Oo(zzqVar.zzo);
        Boolean bool = zzqVar.zzr;
        o000oOooOo00.f37572OooO00o.zzaz().zzg();
        o000oOooOo00.f37598OooOoo |= !zzg.zza(o000oOooOo00.f37587OooOOo, bool);
        o000oOooOo00.f37587OooOOo = bool;
        o000oOooOo00.OooOO0O(zzqVar.zzs);
        zzoz.zzc();
        if (zzg().zzs(null, zzeb.zzar)) {
            o000oOooOo00.OooOo(zzqVar.zzx);
        }
        zzns.zzc();
        if (zzg().zzs(null, zzeb.zzaj)) {
            o000oOooOo00.OooOo0o(zzqVar.zzt);
        } else {
            zzns.zzc();
            if (zzg().zzs(null, zzeb.zzai)) {
                o000oOooOo00.OooOo0o(null);
            }
        }
        o000oOooOo00.f37572OooO00o.zzaz().zzg();
        if (o000oOooOo00.f37598OooOoo) {
            OooOO0O oooOO0O5 = this.f16286OooO0OO;
            OooOooO(oooOO0O5);
            oooOO0O5.OooO0o0(o000oOooOo00);
        }
    ...
    public final zzai Oooo000(String str) {
        ...
        zzaz().zzg();
        OooO0O0();
        zzai zzaiVar2 = (zzai) this.f16309OooOoOO.get(str);
        if (zzaiVar2 != null) {
            return zzaiVar2;
        }
        OooOO0O oooOO0O = this.f16286OooO0OO;
        ...
        try {
            try {
                ...
                oooOO0O.f37615OooO00o.zzay().zzd().zzc("Database error", "select consent_state from consent_settings where app_id=? limit 1;", e);
                throw e;
            }
        } catch (Throwable th) {
            if (cursorRawQuery != null) {
    ...
    public final void zzR(String str, zzik zzikVar) {
        zzaz().zzg();
        String str2 = this.f16312OooOooO;
        if (str2 == null || str2.equals(str) || zzikVar != null) {
            this.f16312OooOooO = str;
            this.f16310OooOoo = zzikVar;
        }
    }

    @Override // o0OO0OoO.o000O0O0
    public final Context zzau() {
        return this.f16294OooOO0o.zzau();
    }

    @Override // o0OO0OoO.o000O0O0
    public final Clock zzav() {
        return ((zzfy) Preconditions.checkNotNull(this.f16294OooOO0o)).zzav();
    }
    ...
    public final zzeo zzay() {
        return ((zzfy) Preconditions.checkNotNull(this.f16294OooOO0o)).zzay();
    }

    @Override // o0OO0OoO.o000O0O0
    public final zzfv zzaz() {
        return ((zzfy) Preconditions.checkNotNull(this.f16294OooOO0o)).zzaz();
    }
    ...
    public final zzag zzg() {
        return ((zzfy) Preconditions.checkNotNull(this.f16294OooOO0o)).zzf();
    }
    ...
    public final o0OO00O zzm() {
        o0OO00O o0oo00o2 = this.f16287OooO0Oo;
        if (o0oo00o2 != null) {
            return o0oo00o2;
        }
    ...
    public final o00OO000 zzr() {
        o00OO000 o00oo001 = this.f16291OooO0oo;
        OooOooO(o00oo001);
        return o00oo001;
    }

    public final zzju zzs() {
        return this.f16283OooO;
    }
    ...
    public final zzlh zzv() {
        return ((zzfy) Preconditions.checkNotNull(this.f16294OooOO0o)).zzv();
    }
}
