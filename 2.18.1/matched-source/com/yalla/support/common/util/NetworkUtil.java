...
public final class NetworkUtil {
    ...
    @NotNull
    public static final NetworkUtil f20498OooO00o = new NetworkUtil();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public static final Lazy f20499OooO0O0 = LazyKt.lazy(new Function0<NetworkReceiver>() { // from class: com.yalla.support.common.util.NetworkUtil$netReceiver$2
    ...
    @NotNull
    public static final MutableLiveData<NetStatus> f20500OooO0OO = new NetworkUtil$netStatusLiveData$1();

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public static final Lazy f20501OooO0Oo = LazyKt.lazy(new Function0<NetworkUtil$netCallback$2.AnonymousClass1>() { // from class: com.yalla.support.common.util.NetworkUtil$netCallback$2
        /* JADX WARN: Can't rename method to resolve collision */
        ...
        public final AnonymousClass1 invoke() {
            return new ConnectivityManager.NetworkCallback() { // from class: com.yalla.support.common.util.NetworkUtil$netCallback$2.1
                ...
                public void onAvailable(@NotNull Network network) {
                    ...
                    NetworkUtil.f20500OooO0OO.postValue(new NetworkUtil.NetStatus(true, networkUtil.OooO0OO()));
                }
                ...
                public void onLost(@NotNull Network network) {
                    ...
                    Objects.requireNonNull(NetworkUtil.f20498OooO00o);
                    NetworkUtil.f20500OooO0OO.postValue(new NetworkUtil.NetStatus(false, null, 2, 0 == true ? 1 : 0));
                }
            };
        }
    });
    ...
    public final NetworkType OooO0OO() {
        ...
        switch (activeNetworkInfo.getSubtype()) {
            ...
            default:
                ...
                return (StringsKt.OooO(subtypeName, "TD-SCDMA") || StringsKt.OooO(subtypeName, "WCDMA") || StringsKt.OooO(subtypeName, "CDMA2000")) ? NetworkType.NETWORK_3G : NetworkType.NETWORK_UNKNOWN;
            case 20:
    ...
    public final void OooO0o0() {
        ...
        if (connectivityManagerOooO00o != null) {
            connectivityManagerOooO00o.registerNetworkCallback(networkRequestBuild, (ConnectivityManager.NetworkCallback) f20501OooO0Oo.getValue());
        }
    }
}
