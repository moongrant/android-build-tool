...
import p544o0o0OoOO.e6;
import p544o0o0OoOO.f6;
import p544o0o0OoOO.g6;
import p544o0o0OoOO.h6;
import p544o0o0OoOO.i6;
import p544o0o0OoOO.j6;
import p616o0oo0Ooo.oO0O00;
import p618o0oo0o0.o0O0O00;
import p621o0oo0o0o.o00O0;
import p649o0ooOOoo.a7;
...
public final class RoomSettingActivity extends BaseActivityK {
    ...
    @NotNull
    public static final OooO00o f22969o00Ooo = new OooO00o();

    /* JADX INFO: renamed from: Ooooo0o, reason: collision with root package name */
    @Nullable
    public RoomConfiguration f22972Ooooo0o;

    /* JADX INFO: renamed from: OooooO0, reason: collision with root package name */
    @Nullable
    public SelectModel f22973OooooO0;

    /* JADX INFO: renamed from: OooooOO, reason: collision with root package name */
    @Nullable
    public MemberFeeModel f22974OooooOO;

    /* JADX INFO: renamed from: OooooOo, reason: collision with root package name */
    @Nullable
    public o000O f22975OooooOo;

    /* JADX INFO: renamed from: Oooooo0, reason: collision with root package name */
    public int f22977Oooooo0;

    /* JADX INFO: renamed from: o00O0O, reason: collision with root package name */
    public boolean f22980o00O0O;

    /* JADX INFO: renamed from: o00Oo0, reason: collision with root package name */
    public boolean f22981o00Oo0;

    /* JADX INFO: renamed from: o0OoOo0, reason: collision with root package name */
    public RoomInfoEditVM f22982o0OoOo0;

    /* JADX INFO: renamed from: OoooOoo, reason: collision with root package name */
    @NotNull
    public final o00O000o f22970OoooOoo = new o00O000o(Reflection.getOrCreateKotlinClass(a7.class), this, null);

    /* JADX INFO: renamed from: Ooooo00, reason: collision with root package name */
    @NotNull
    public List<RoomItemInfoModel> f22971Ooooo00 = new ArrayList();

    /* JADX INFO: renamed from: Oooooo, reason: collision with root package name */
    @NotNull
    public final MutableLiveData<ProfileLimitModel> f22976Oooooo = new MutableLiveData<>();

    /* JADX INFO: renamed from: OoooooO, reason: collision with root package name */
    @NotNull
    public final MutableLiveData<ProfileLimitModel> f22978OoooooO = new MutableLiveData<>();

    /* JADX INFO: renamed from: Ooooooo, reason: collision with root package name */
    @NotNull
    public final MutableLiveData<ProfileLimitModel> f22979Ooooooo = new MutableLiveData<>();

    /* JADX INFO: renamed from: ooOO, reason: collision with root package name */
    @NotNull
    public final Lazy f22983ooOO = LazyKt.lazy(new OooO0o());
    ...
    public static final class OooO extends Lambda implements Function2<RoomItemInfoModel, Integer, Unit> {
        ...
        public final Unit invoke(RoomItemInfoModel roomItemInfoModel, Integer num) {
            ...
            OooO00o oooO00o = RoomSettingActivity.f22969o00Ooo;
    ...
    public static final class OooO00o {
        ...
        public final void OooO00o(@Nullable Activity activity, @Nullable String str) {
            ...
            o00OO0O0.OooO0OO(null, o0ooOOo.f32244OooOoo, "/Webservers/Bar/RoomInfo", mapOooO0O0, oooOOO);
        }
    }

    @SuppressLint({"UseSwitchCompatOrMaterialCode"})
    public static final class OooO0O0 extends p188o00o00o0.OooO0OO<RoomItemInfoModel> {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        @Nullable
        public Function2<? super RoomItemInfoModel, ? super Integer, Unit> f22985OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        @NotNull
        public final Drawable f22986OooO0O0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(@NotNull Context context) {
            super(context, R.layout.item_room_info_detail);
            Intrinsics.checkNotNullParameter(context, "context");
            this.f22986OooO0O0 = o000O0O0.OooO0O0(R.drawable.common_warning_tip);
        }
        ...
        public final void convert(com.chad.library.adapter.base.OooO00o oooO00o, Object obj) {
            ...
            r7.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: o0o0OoOO.d6
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    Function2<? super RoomItemInfoModel, ? super Integer, Unit> function2;
                    RoomSettingActivity.OooO0O0 this$0 = this.f44223OooO00o;
                    RoomItemInfoModel model2 = model;
                    OooO0o helper2 = helper;
                    Intrinsics.checkNotNullParameter(this$0, "this$0");
                    Intrinsics.checkNotNullParameter(model2, "$model");
                    Intrinsics.checkNotNullParameter(helper2, "$helper");
                    if (compoundButton.isPressed() && (function2 = this$0.f22985OooO00o) != null) {
            ...
            if (!TextUtils.isEmpty(model.getHeadUrl())) {
                ...
                oooO00o2.f48429OooO0OO = model.getHeadUrl();
                oooO00o2.f48427OooO00o = 0;
                oooO00o2.f48441OooOOOo = R.drawable.icon_head_default;
                oooO00o2.f48431OooO0o = R.drawable.icon_head_default;
            ...
            if (profileLimitModel != null) {
                oo0o0O0.OooO0oO(tvTitle, this.f22986OooO0O0);
    ...
    public static final class OooOO0 extends Lambda implements Function3<o0O00OO<Boolean>, oOO00O, Integer, Unit> {

        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ ArrayList<SelectDialogModel<String>> f22988Oooo0o;

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ RoomSettingActivity f22989Oooo0oO;

        /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
        public final /* synthetic */ int f22990Oooo0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0(ArrayList<SelectDialogModel<String>> arrayList, RoomSettingActivity roomSettingActivity, int i) {
            super(3);
            this.f22988Oooo0o = arrayList;
            this.f22989Oooo0oO = roomSettingActivity;
            this.f22990Oooo0oo = i;
        }
        ...
        public final Unit invoke(o0O00OO<Boolean> o0o00oo2, oOO00O ooo00o, Integer num) {
            ...
            if ((i & 91) == 18 && ooo00o2.OooOo0()) {
                ...
                o0oO0O0o.OooO0O0(it, null, this.f22988Oooo0o, null, false, new OooOOOO(this.f22989Oooo0oO, this.f22990Oooo0oo), null, null, 0L, null, null, null, ooo00o2, (i & 14) | 512, 0, 4058);
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0O extends Lambda implements Function0<Unit> {
        ...
        public final Unit invoke() {
            RoomSettingActivity.this.f22980o00O0O = false;
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOOO0 extends Lambda implements Function1<Boolean, Unit> {
        ...
        public final Unit invoke(Boolean bool) {
            if (bool.booleanValue()) {
                RoomSettingActivity roomSettingActivity = RoomSettingActivity.this;
                Oooo0.f33130OooO00o.OooO0O0(roomSettingActivity, 1.0f, 1.0f, false, false, new OooOo00(roomSettingActivity));
                RoomSettingActivity.this.f22980o00O0O = false;
            } else {
                RoomSettingActivity.this.f22980o00O0O = false;
            }
    ...
    public final OooO0O0 OooOoo() {
        return (OooO0O0) this.f22983ooOO.getValue();
    }

    public final a7 OooOooO() {
        return (a7) this.f22970OoooOoo.getValue();
    }
    ...
    public final void OooOooo() {
        ...
        Integer value = oooO00o.OooO00o().f43338OooOo0o.getValue();
        CategoryModel value2 = oooO00o.OooO00o().f43334OooOo.getValue();
        Boolean value3 = oooO00o.OooO00o().f43348Oooo000.getValue();
        if (value3 == null) {
            value3 = Boolean.FALSE;
        }
        boolean zBooleanValue = value3.booleanValue();
        if (this.f22972Ooooo0o == null) {
            return;
        }
        this.f22971Ooooo00.clear();
        ?? r4 = this.f22971Ooooo00;
        int i = 1;
        ...
        RoomConfiguration roomConfiguration = this.f22972Ooooo0o;
        roomItemInfoModel.setHeadUrl(roomConfiguration != null ? roomConfiguration.getBarimage() : null);
        roomItemInfoModel.setProfileLimitModel(this.f22976Oooooo.getValue());
        r4.add(roomItemInfoModel);
        ?? r5 = this.f22971Ooooo00;
        ...
        RoomConfiguration roomConfiguration4 = this.f22972Ooooo0o;
        roomItemInfoModel3.setContent(roomConfiguration4 != null ? roomConfiguration4.getNotice() : null);
        roomItemInfoModel3.setProfileLimitModel(this.f22979Ooooooo.getValue());
        r6.add(roomItemInfoModel3);
        ?? r7 = this.f22971Ooooo00;
        ...
        if (o000O00O.OooO().f32427Oooo != null && o000O00O.OooO().f32427Oooo.isGuestlive()) {
            roomItemInfoModel8.setContent(o000O0O0.OooO0OO(R.string.everyone));
        }
        r8.add(roomItemInfoModel8);
        ?? r9 = this.f22971Ooooo00;
        ...
        roomItemInfoModel9.setTurnOnSwitch(oooO00o.OooO00o().f43349Oooo00O.getValue());
        r9.add(roomItemInfoModel9);
        ?? r10 = this.f22971Ooooo00;
        ...
        roomItemInfoModel11.setTurnOnSwitch(oooO00o.OooO00o().f43352Oooo0OO.getValue());
        roomItemInfoModel11.setShowRedPoint(true);
        p497o0o00Oo.OooOOO0 oooOOO0 = p497o0o00Oo.OooOOO0.f41180OooO00o;
        if (p497o0o00Oo.OooOOO0.OooO0o0().OooOO0O()) {
            roomItemInfoModel11.setShowRedPoint(false);
        }
        r11.add(roomItemInfoModel11);
        this.f22971Ooooo00.add(new RoomItemInfoModel(o000O0O0.OooO0OO(R.string.room_info_ban), true, RoomItemInfoModelTag.ForbiddenList));
        this.f22971Ooooo00.add(new RoomItemInfoModel(o000O0O0.OooO0OO(R.string.room_setting_kick_record), true, RoomItemInfoModelTag.KickRecord));
        ?? r0 = this.f22971Ooooo00;
        ...
        OooOoo().f22985OooO00o = new OooO();
        OooOoo().setOnItemClickListener(new o0o0Oo(this, i));
        OooOoo().setNewData(this.f22971Ooooo00);
    }
    ...
    public final void Oooo000(RoomItemInfoModel roomItemInfoModel, int i) {
        ...
        switch (tag == null ? -1 : OooO0OO.$EnumSwitchMapping$0[tag.ordinal()]) {
            case 1:
                ProfileLimitModel value = this.f22976Oooooo.getValue();
                if (value == null) {
                    Oooo00o();
                } else {
                    ...
                    if (value.getExpireTime() > 0 && (System.currentTimeMillis() / ((long) 1000)) - value.getExpireTime() <= 0) {
                        strOooO00o = com.yalla.support.common.util.OooOo.OooO00o(com.yalla.support.common.util.OooOo.OooO00o(o000O0O0.OooO0OO(R.string.RoomInfoEdit_ChangeLimit_HintContent_Header_Time), String.valueOf(value.getBlockReason())), o00O0.f48624OooO00o.OooO0Oo(value.getExpireTime(), System.currentTimeMillis()));
                        z = true;
                    }
                    ...
                    if (z) {
                        ...
                        oo0ooo0.OooOo0o(new f6(this));
                    }
                    oo0ooo0.OooOOO0();
                }
                break;
            case 2:
                ProfileLimitModel value2 = this.f22978OoooooO.getValue();
                if (value2 == null) {
                    RoomReNameActivity.OooOoO(this, this.f22972Ooooo0o);
                } else {
                    ...
                    if (value2.getExpireTime() > 0 && (System.currentTimeMillis() / ((long) 1000)) - value2.getExpireTime() <= 0) {
                        strOooO00o2 = com.yalla.support.common.util.OooOo.OooO00o(com.yalla.support.common.util.OooOo.OooO00o(o000O0O0.OooO0OO(R.string.RoomInfoEdit_ChangeLimit_HintContent_Name_Time), String.valueOf(value2.getBlockReason())), o00O0.f48624OooO00o.OooO0Oo(value2.getExpireTime(), System.currentTimeMillis()));
                        z = true;
                    }
                    ...
                    if (!z) {
                        ...
                        oo0ooo1.OooOo0o(new g6(this));
                    }
                    oo0ooo1.OooOOO0();
                }
                break;
            case 3:
                p159o00OoOO.o00O000o.OooO00o(this, this.f22979Ooooooo.getValue(), new h6(this));
                break;
            case 4:
                RoomConfiguration roomConfiguration = this.f22972Ooooo0o;
            ...
            case 5:
                ...
                if (roomConfiguration2 == null || roomConfiguration2.getBarlevel() >= 4) {
                    ...
                    if (roomConfiguration2 == null || !roomConfiguration2.isGuestlive()) {
                        ...
                        SelectModel selectModel3 = this.f22973OooooO0;
                        ...
                        SelectModel selectModel4 = this.f22973OooooO0;
                        ...
                        SelectModel selectModel5 = this.f22973OooooO0;
            ...
            case 6:
                ...
                break;
            case 7:
                if (this.f22974OooooOO == null) {
                    String strOooO0OO2 = o000O0O0.OooO0OO(R.string.title_RoomEdit_memberDesc);
                    Integer value5 = o00OO00O.f43313OooooOo.OooO00o().f43338OooOo0o.getValue();
                    Intrinsics.checkNotNull(value5);
                    this.f22974OooooOO = new MemberFeeModel(strOooO0OO2, value5.intValue(), 0, 500);
                }
                MemberFeeModel memberFeeModel = this.f22974OooooOO;
                if (memberFeeModel != null) {
                    ...
                    j6 onConfirmClick = new j6(this);
                    Intrinsics.checkNotNullParameter(this, "activity");
                    Intrinsics.checkNotNullParameter(infoTop, "infoTop");
                    Intrinsics.checkNotNullParameter(onConfirmClick, "onConfirmClick");
                    showDialog((String) null, o00O0000.OooO0O0(2059378828, true, new p139o00OOOo0.oo0o0Oo(infoTop, onConfirmClick, fee, min, max)));
                }
                break;
            case 8:
                o0O00000.OooO0OO("InRoom_setting_bonus");
                SharedUrlManager.INSTANCE.getRoomBonusUrl().observe(this, new o0000O0O(this, i2));
                break;
            case 9:
            ...
            case 10:
                o00O.OooO0o oooO0o = o00O.OooO0o.f43216OooO00o;
                p606o0oo0O.OooOo.OooO0OO("102232", MapsKt.mapOf(new Pair("type", Integer.valueOf(!oooO0o.OooO0OO() ? 1 : 0))));
                ...
                if (p159o00OoOO.o00O000.f32468OooO00o != null) {
                    ...
                    builderNewBuilder.setUserId(p498o0o00Oo0.OooOOO.f41216OooO00o.OooOo().getValue().longValue());
                    builderNewBuilder.setOp(z2 ? 1L : 2L);
                    p159o00OoOO.o00O000.f32468OooO00o.OooO0oO(1001108, builderNewBuilder.build().toByteArray());
                }
                break;
            case 11:
                if (!this.f22981o00Oo0) {
                    this.f22981o00Oo0 = true;
                    Boolean value6 = o00OO00O.f43313OooooOo.OooO00o().f43348Oooo000.getValue();
            ...
            case 12:
                ...
                break;
            case 13:
                Boolean value7 = o00OO00O.f43313OooooOo.OooO00o().f43349Oooo00O.getValue();
                p159o00OoOO.o00O000 o00o000OooO3 = p159o00OoOO.o00O000.OooO();
                ...
                if (p159o00OoOO.o00O000.f32468OooO00o != null) {
                    ...
                    if (p498o0o00Oo0.OooOOO.f41251Oooo0OO.getValue() != null) {
                        ...
                        builderNewBuilder2.setRoomId(com.yalla.support.common.util.OooO.OooO0o(p498o0o00Oo0.OooOOO.f41251Oooo0OO.getValue().barid));
                        builderNewBuilder2.setAllowMicStatus(iOooO0O0);
                        p159o00OoOO.o00O000.f32468OooO00o.OooO0oO(1000002, builderNewBuilder2.build().toByteArray());
                    }
                }
                break;
            case 14:
                Boolean value8 = o00OO00O.f43313OooooOo.OooO00o().f43352Oooo0OO.getValue();
                ...
                if (!(barid == null || StringsKt.isBlank(barid))) {
                    ...
                    o0ooOOo o0ooooo2 = o0ooOOo.f32218OooO00o;
                    o00OO0O0.OooO0Oo(null, o0ooOOo.f32244OooOoo, "/Webservers/Bar/SetEventManage", mapOooO0O0, i6Var);
                    break;
                }
                break;
        }
    ...
    public final void Oooo00O(int i) {
        List<SelectItemModel> list;
        if (this.f22973OooooO0 == null) {
            return;
        }
        ArrayList arrayList = new ArrayList();
        SelectModel selectModel = this.f22973OooooO0;
    ...
    public final void Oooo00o() {
        if (this.f22980o00O0O) {
            return;
        }
        this.f22980o00O0O = true;
        o0O0O00.OooO0OO(this, p618o0oo0o0.oo0o0Oo.f48607OooO0O0, new OooOO0O(), new OooOOO0());
    }
    ...
    public final void onCreate(@Nullable Bundle bundle) {
        ...
        setContentView(OooOooO().f48902OooO00o);
        this.f22982o0OoOo0 = (RoomInfoEditVM) new ViewModelProvider(this).get(RoomInfoEditVM.class);
        if (getIntent() == null || o000O00O.OooO().f32430Oooo0oo == null) {
            finish();
        } else {
            ...
            this.f22972Ooooo0o = (RoomConfiguration) serializableExtra;
        }
        ...
        if (headerLayout2 != null) {
            headerLayout2.OooOoO0(new e6(this));
        }
        OooOo0O(0);
        OooOooO().f48903OooO0O0.setLayoutManager(new FixLinearLayoutManager(this));
        OooOooO().f48903OooO0O0.setAdapter(OooOoo());
        if (o000O00O.OooO().f32430Oooo0oo != null) {
            this.f22977Oooooo0 = o000O00O.OooO().f32430Oooo0oo.getRoom().getMictype();
        }
        OooOooo();
        o00OO00O.OooO00o oooO00o = o00OO00O.f43313OooooOo;
        int i = 2;
        oooO00o.OooO00o().f43338OooOo0o.observe(this, new o0000(this, i));
        int i2 = 4;
        oooO00o.OooO00o().f43334OooOo.observe(this, new o0000OO0(this, i2));
        LiveEventBus.get("FORBID_GUESTS_ENTER_ROOM", Boolean.TYPE).observe(this, new o000O0o(this, i));
        MutableLiveData<Boolean> mutableLiveData = oooO00o.OooO00o().f43348Oooo000;
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type androidx.fragment.app.FragmentActivity");
        mutableLiveData.observe(this, new p142o00OOooO.o000Oo0(this, 7));
        oooO00o.OooO00o().f43349Oooo00O.observe(this, new o000O000(this, i2));
        LiveEventBus.get("RoomHeaderUrl").observe(this, new p501o0o00o.o0ooOOo(this, i));
        int i3 = 3;
        LiveEventBus.get("RoomName").observe(this, new p142o00OOooO.o000O(this, i3));
        LiveEventBus.get("ALLOW_ROOM_MANAGER_OPEN_APPLY_MIC").observe(this, new o000OO0O(this, i3));
        LiveEventBus.get("RoomAnnouncement").observe(this, new p142o00OOooO.o000O0O0(this, i2));
        this.f22976Oooooo.observe(this, new o00(this, i2));
        this.f22978OoooooO.observe(this, new o0000Ooo(this, i3));
        this.f22979Ooooooo.observe(this, new o000(this, i3));
        this.f22976Oooooo.setValue(null);
        this.f22978OoooooO.setValue(null);
        this.f22979Ooooooo.setValue(null);
        RoomConfiguration roomConfiguration = this.f22972Ooooo0o;
        ...
        for (ProfileLimitModel profileLimitModel : profileLimit) {
            ...
            if (operationType == 1) {
                this.f22976Oooooo.setValue(profileLimitModel);
            } else if (operationType == 2) {
                this.f22978OoooooO.setValue(profileLimitModel);
            } else if (operationType == 3) {
                this.f22979Ooooooo.setValue(profileLimitModel);
            }
        }
    }
    ...
    public final void onDestroy() {
        ...
        if (o00O.OooO0o.f43216OooO00o.OooO0O0()) {
            p497o0o00Oo.OooOOO0 oooOOO0 = p497o0o00Oo.OooOOO0.f41180OooO00o;
            p497o0o00Oo.OooOOO0.OooO0o0().OooOo();
            o00O.OooO0o.f43231OooOOo0.setValue(Boolean.FALSE);
        }
        p497o0o00Oo.OooOOO0 oooOOO1 = p497o0o00Oo.OooOOO0.f41180OooO00o;
        if (p497o0o00Oo.OooOOO0.OooO0o0().OooOO0O()) {
            return;
        }
        p497o0o00Oo.OooOOO0.OooO0o0().OooOOO();
        o00O o00o2 = o00O.f43140OooO00o;
        o00O.f43192o000oOoO.setValue(Boolean.FALSE);
        o00OO00O.f43313OooooOo.OooO00o().f43329OooOOOO.postValue(1);
    }
    ...
    public final void onEventMainThread(@Nullable p140o00OOOoO.OooO0OO<?> oooO0OO) {
        ...
        if (numValueOf != null && numValueOf.intValue() == 33) {
            ...
            this.f22972Ooooo0o = (RoomConfiguration) t;
            o00OO00O.f43313OooooOo.OooO00o().f43326OooOO0o.setValue(this.f22972Ooooo0o);
            OooOooo();
            return;
        }
        if (numValueOf != null && numValueOf.intValue() == 177) {
            ...
            this.f22977Oooooo0 = ((Integer) t2).intValue();
            OooOooo();
        ...
        if (numValueOf != null && numValueOf.intValue() == 57) {
            ...
            o00O.OooO0O0.f43205OooO0OO.setValue(0);
            OooOoo().notifyDataSetChanged();
        }
    }
}
