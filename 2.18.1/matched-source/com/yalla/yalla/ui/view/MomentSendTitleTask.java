...
import p601o0oo00Oo.o0OO000;
import p601o0oo00Oo.o0OO000o;
import p621o0oo0o0o.o00O0;
import p649o0ooOOoo.zd;
...
public final class MomentSendTitleTask extends ConstraintLayout {
    ...
    @NotNull
    public final zd f24988Oooo0o;

    /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
    @Nullable
    public MomentSendModel f24989Oooo0oO;
    ...
    public static final class OooO0O0 extends o00Oo0 {
        ...
        public final void OooO00o(@NotNull View view) {
            ...
            if (Intrinsics.areEqual(view, MomentSendTitleTask.this.f24988Oooo0o.f51083OooO)) {
                MomentSendTitleTask.OooO0O0(MomentSendTitleTask.this);
                return;
            }
            if (Intrinsics.areEqual(view, MomentSendTitleTask.this.f24988Oooo0o.f51085OooO0O0)) {
    ...
    public static final void OooO0O0(MomentSendTitleTask momentSendTitleTask) {
        MomentSendModel momentSendModel = momentSendTitleTask.f24989Oooo0oO;
    ...
    public final void OooO0OO() {
        this.f24988Oooo0o.f51083OooO.setClickable(true);
        ImageView imageView = this.f24988Oooo0o.f51087OooO0Oo;
        Intrinsics.checkNotNullExpressionValue(imageView, "binding.ivPower");
        o00O0O.OooO00o(imageView);
        MomentSendModel momentSendModel = this.f24989Oooo0oO;
        ...
        if (i == 1) {
            ImageView imageView2 = this.f24988Oooo0o.f51085OooO0O0;
            Intrinsics.checkNotNullExpressionValue(imageView2, "binding.ivDel");
            o00O0O.OooO00o(imageView2);
            ImageView imageView3 = this.f24988Oooo0o.f51087OooO0Oo;
            Intrinsics.checkNotNullExpressionValue(imageView3, "binding.ivPower");
            o00O0O.OooO(imageView3);
            this.f24988Oooo0o.f51091OooO0oo.setText(o00O0.f48624OooO00o.OooO0Oo(System.currentTimeMillis(), System.currentTimeMillis()) + " • ");
            TextView textView = this.f24988Oooo0o.f51083OooO;
            Intrinsics.checkNotNullExpressionValue(textView, "binding.tvTry");
            o00O0O.OooO00o(textView);
            this.f24988Oooo0o.f51083OooO.setClickable(false);
            return;
        }
        if (i == 2) {
            ImageView imageView4 = this.f24988Oooo0o.f51085OooO0O0;
            Intrinsics.checkNotNullExpressionValue(imageView4, "binding.ivDel");
            o00O0O.OooO00o(imageView4);
            this.f24988Oooo0o.f51091OooO0oo.setText(R.string.Posting);
            TextView textView2 = this.f24988Oooo0o.f51083OooO;
        ...
        if (i == 3) {
            ImageView imageView5 = this.f24988Oooo0o.f51085OooO0O0;
            Intrinsics.checkNotNullExpressionValue(imageView5, "binding.ivDel");
            o00O0O.OooO(imageView5);
            this.f24988Oooo0o.f51091OooO0oo.setText(R.string.You_are_posting_too_much);
            TextView textView3 = this.f24988Oooo0o.f51083OooO;
            Intrinsics.checkNotNullExpressionValue(textView3, "binding.tvTry");
            o00O0O.OooO(textView3);
            return;
        }
        if (i == 4) {
            ImageView imageView6 = this.f24988Oooo0o.f51085OooO0O0;
            Intrinsics.checkNotNullExpressionValue(imageView6, "binding.ivDel");
            o00O0O.OooO(imageView6);
            this.f24988Oooo0o.f51091OooO0oo.setText(R.string.Network_connection_lost);
            TextView textView4 = this.f24988Oooo0o.f51083OooO;
        ...
        ImageView imageView7 = this.f24988Oooo0o.f51085OooO0O0;
        Intrinsics.checkNotNullExpressionValue(imageView7, "binding.ivDel");
        o00O0O.OooO(imageView7);
        this.f24988Oooo0o.f51091OooO0oo.setText(R.string.Network_connection_lost);
        TextView textView5 = this.f24988Oooo0o.f51083OooO;
    ...
    public MomentSendTitleTask(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        zd zdVarInflate = zd.inflate(LayoutInflater.from(context), this, true);
        Intrinsics.checkNotNullExpressionValue(zdVarInflate, "inflate(LayoutInflater.from(context), this, true)");
        this.f24988Oooo0o = zdVarInflate;
        OooO0O0 oooO0O0 = new OooO0O0();
        ConstraintLayout constraintLayout = zdVarInflate.f51088OooO0o;
        Intrinsics.checkNotNullExpressionValue(constraintLayout, "binding.layoutRoot");
        o00O0O.OooO(constraintLayout);
        zdVarInflate.f51083OooO.setOnClickListener(oooO0O0);
        zdVarInflate.f51085OooO0O0.setOnClickListener(oooO0O0);
    }
}
