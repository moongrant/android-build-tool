...
import p520o0o0O0O0.o00;
import p520o0o0O0O0.o0000;
import p520o0o0O0O0.o00000O;
...
public final class ShareToFriendVM extends o00OO.OooO00o {
    ...
    public static final class OooO00o extends Lambda implements Function0<o00O00o0<Integer, FriendInfo>> {
        ...
        public static final OooO00o f25675Oooo0o = new OooO00o();
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<LiveDataScope<ApiResult<RoomThemeGiveInfo>>, Continuation<? super Unit>, Object> {
        ...
        public final /* synthetic */ long f25676Oooo;

        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public int f25677Oooo0o;

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public /* synthetic */ Object f25678Oooo0oO;

        /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
        public final /* synthetic */ long f25679Oooo0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(long j, long j2, Continuation<? super OooO0O0> continuation) {
            super(2, continuation);
            this.f25679Oooo0oo = j;
            this.f25676Oooo = j2;
        }
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0O0 oooO0O0 = new OooO0O0(this.f25679Oooo0oo, this.f25676Oooo, continuation);
            oooO0O0.f25678Oooo0oO = obj;
            return oooO0O0;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f25677Oooo0o;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f25678Oooo0oO;
            ...
            ResultKt.throwOnFailure(obj);
            liveDataScope = (LiveDataScope) this.f25678Oooo0oO;
            o00 o00Var = o00.f42307OooO00o;
            long j = this.f25679Oooo0oo;
            long j2 = this.f25676Oooo;
            this.f25678Oooo0oO = liveDataScope;
            this.f25677Oooo0o = 1;
            obj = o00Var.OooO00o(j, j2, this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f25678Oooo0oO = null;
            this.f25677Oooo0o = 2;
    ...
    public static final class OooO0OO extends Lambda implements Function0<o00O00o0<Integer, FriendInfo>> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ String f25680Oooo0o;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(String str) {
            super(0);
            this.f25680Oooo0o = str;
        }

        @Override // kotlin.jvm.functions.Function0
        public final o00O00o0<Integer, FriendInfo> invoke() {
            String searchText = this.f25680Oooo0o;
    ...
    public static final class OooO0o extends Lambda implements Function0<o00O00o0<Integer, FriendInfo>> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public static final OooO0o f25681Oooo0o = new OooO0o();
    ...
    public ShareToFriendVM() {
        ...
        OooO0o pagingSourceFactory = OooO0o.f25681Oooo0o;
        ...
        OooO00o pagingSourceFactory2 = OooO00o.f25675Oooo0o;
    ...
    public final LiveData<Boolean> sendEventRoomMsg(@NotNull List<Long> targetIds, long eventId, @NotNull String eventName, @NotNull String eventImgUrl, int eventTagId, long eventStartTime, long eventEndTime, long roomId, @NotNull String roomName, @NotNull String roomIp) {
        ...
        while (it.hasNext()) {
            ...
            msg = oooOOO.OooOOO(jLongValue, eventId, eventName, eventImgUrl, eventTagId, eventStartTime, eventEndTime, roomId, roomName, roomIp, "", 0L, false);
            oooOOO.OooO0oO(msg);
        ...
        BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, Dispatchers.getIO(), null, new o00000O(msg, mutableLiveData, targetIds, midList, null), 2, null);
    ...
    public final LiveData<Boolean> shareActivity(@NotNull List<Long> targetIds, @NotNull String activityImage, @NotNull String activityText1, @NotNull String activityText2, @NotNull String activityUrl, @NotNull String message, int activity) {
        ...
        while (it.hasNext()) {
            ...
            p520o0o0O0O0.OooOOO oooOOO = p520o0o0O0O0.OooOOO.f42227OooO00o;
            ArrayList arrayList2 = arrayList;
            ChatMessage chatMessageOooOO0o = p520o0o0O0O0.OooOOO.f42227OooO00o.OooOO0o(jLongValue, activityImage, activityText1, activityText2, activityUrl, (448 & 32) != 0 ? "" : message, (448 & 64) != 0 ? "" : null, 0L, false);
            ...
            if (message.length() > 0) {
                ChatMessage chatMessageOooOo0o = p520o0o0O0O0.OooOOO.f42227OooO00o.OooOo0o(jLongValue, message, (60 & 4) != 0 ? "" : null, (60 & 8) != 0 ? 0L : 0L, (60 & 16) != 0 ? false : false, false);
                oooOOO.OooO0oO(chatMessageOooOo0o);
        ...
        Intrinsics.checkNotNullParameter(msg, "msg");
        MutableLiveData mutableLiveData = new MutableLiveData();
        BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, Dispatchers.getIO(), null, new o00000O0(msg, mutableLiveData, targetIds, midList, null), 2, null);
        return mutableLiveData;
    }
    ...
    public final LiveData<Boolean> shareMoment(@NotNull List<Long> targetIds, long momentId, @NotNull String momentImage, @NotNull String momentText, int momentType, @NotNull String message) {
        ...
        while (it.hasNext()) {
            long jLongValue = ((Number) it.next()).longValue();
            p520o0o0O0O0.OooOOO oooOOO = p520o0o0O0O0.OooOOO.f42227OooO00o;
            ChatMessage chatMessageOooOOOO = p520o0o0O0O0.OooOOO.f42227OooO00o.OooOOOO(jLongValue, momentId, momentImage, momentText, momentType, (448 & 32) != 0 ? "" : message, (448 & 64) != 0 ? "" : null, 0L, false);
            oooOOO.OooO0oO(chatMessageOooOOOO);
            if (message.length() > 0) {
                ChatMessage chatMessageOooOo0o = p520o0o0O0O0.OooOOO.f42227OooO00o.OooOo0o(jLongValue, message, (60 & 4) != 0 ? "" : null, (60 & 8) != 0 ? 0L : 0L, (60 & 16) != 0 ? false : false, false);
                oooOOO.OooO0oO(chatMessageOooOo0o);
    ...
    public final LiveData<Boolean> shareRoom(@NotNull List<Long> targetIds, long roomId, long roomIdx, @NotNull String roomName, @NotNull String roomHeader, @NotNull String message) {
        ...
        while (it.hasNext()) {
            ...
            p520o0o0O0O0.OooOOO oooOOO = p520o0o0O0O0.OooOOO.f42227OooO00o;
            ArrayList arrayList2 = arrayList;
            ChatMessage chatMessageOooOOo0 = p520o0o0O0O0.OooOOO.f42227OooO00o.OooOOo0(jLongValue, roomId, roomIdx, roomName, roomHeader, (928 & 32) != 0 ? "" : null, (928 & 64) != 0 ? "" : message, (928 & 128) != 0 ? "" : null, 0L, false);
    ...
    public final LiveData<Boolean> shareTopic(@NotNull List<Long> targetIds, long topicId, @NotNull String topicImage, @NotNull String topicName, int topicUserCount, int topicMomentCount, @NotNull String message) {
        ...
        while (it.hasNext()) {
            ...
            p520o0o0O0O0.OooOOO oooOOO = p520o0o0O0O0.OooOOO.f42227OooO00o;
            ArrayList arrayList2 = arrayList;
            ChatMessage chatMessageOooOOoo = p520o0o0O0O0.OooOOO.f42227OooO00o.OooOOoo(jLongValue, topicId, topicImage, topicName, topicUserCount, topicMomentCount, (896 & 64) != 0 ? "" : message, (896 & 128) != 0 ? "" : null, 0L, false);
            oooOOO.OooO0oO(chatMessageOooOOoo);
            if (message.length() > 0) {
                ChatMessage chatMessageOooOo0o = p520o0o0O0O0.OooOOO.f42227OooO00o.OooOo0o(jLongValue, message, (60 & 4) != 0 ? "" : null, (60 & 8) != 0 ? 0L : 0L, (60 & 16) != 0 ? false : false, false);
                oooOOO.OooO0oO(chatMessageOooOo0o);
    ...
    public final LiveData<Boolean> shareUser(@NotNull List<Long> targetIds, long userId, long userIdx, @NotNull String userName, @NotNull String userHead, @NotNull String message) {
        ...
        while (it.hasNext()) {
            ...
            p520o0o0O0O0.OooOOO oooOOO = p520o0o0O0O0.OooOOO.f42227OooO00o;
            ArrayList arrayList2 = arrayList;
            ChatMessage chatMessageOooOo0 = p520o0o0O0O0.OooOOO.f42227OooO00o.OooOo0(jLongValue, userId, userIdx, userName, userHead, (448 & 32) != 0 ? "" : message, (448 & 64) != 0 ? "" : null, 0L, false);
            oooOOO.OooO0oO(chatMessageOooOo0);
            if (message.length() > 0) {
                ChatMessage chatMessageOooOo0o = p520o0o0O0O0.OooOOO.f42227OooO00o.OooOo0o(jLongValue, message, (60 & 4) != 0 ? "" : null, (60 & 8) != 0 ? 0L : 0L, (60 & 16) != 0 ? false : false, false);
                oooOOO.OooO0oO(chatMessageOooOo0o);
