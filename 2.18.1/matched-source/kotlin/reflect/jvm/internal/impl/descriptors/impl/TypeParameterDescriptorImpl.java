...
public class TypeParameterDescriptorImpl extends AbstractTypeParameterDescriptor {
    ...
    private void checkInitialized() {
        ...
        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("Type parameter descriptor is not initialized: ");
        sbOooO0o0.append(nameForAssertions());
        throw new IllegalStateException(sbOooO0o0.toString());
    }

    private void checkUninitialized() {
        if (this.initialized) {
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("Type parameter descriptor is already initialized: ");
            sbOooO0o0.append(nameForAssertions());
            throw new IllegalStateException(sbOooO0o0.toString());
        }
    }
    ...
    public void mo1793reportSupertypeLoopError(@NotNull KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(27);
        }
