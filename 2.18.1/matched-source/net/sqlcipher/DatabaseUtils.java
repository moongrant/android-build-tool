...
public class DatabaseUtils {
    ...
    public static class InsertHelper {
        ...
        private SQLiteStatement getStatement(boolean z) throws SQLException {
            ...
            if (this.mReplaceStatement == null) {
                ...
                StringBuilder sbOooO0o0 = OooO00o.OooO0o0("INSERT OR REPLACE");
                sbOooO0o0.append(this.mInsertSQL.substring(6));
                this.mReplaceStatement = this.mDb.compileStatement(sbOooO0o0.toString());
            }
        ...
        public int getColumnIndex(String str) {
            ...
            throw new IllegalArgumentException(OooO0OO.OooO00o("column '", str, "' is invalid"));
        }
    ...
    public static String concatenateWhere(String str, String str2) {
        ...
        return TextUtils.isEmpty(str2) ? str : oo000o.OooO00o("(", str, ") AND (", str2, ")");
    }
    ...
    public static void dumpCurrentRow(Cursor cursor, PrintStream printStream) {
        ...
        sbOooO0o0.append(cursor.getPosition());
        sbOooO0o0.append(" {");
        ...
        for (int i = 0; i < length; i++) {
            ...
            sbOooO0o1.append(columnNames[i]);
            sbOooO0o1.append('=');
            sbOooO0o1.append(string);
            printStream.println(sbOooO0o1.toString());
        }
        printStream.println("}");
    }
