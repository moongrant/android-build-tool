...
public final class o0ooOOo {
    ...
    public static /* synthetic */ class OooO00o {
        ...
        public static final /* synthetic */ int[] f30171OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public static final /* synthetic */ int[] f30172OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public static final /* synthetic */ int[] f30173OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final /* synthetic */ int[] f30174OooO0Oo;
        ...
        static {
            ...
            try {
                f30174OooO0Oo[OutOfQuotaPolicy.DROP_WORK_REQUEST.ordinal()] = 2;
            ...
            try {
                f30173OooO0OO[NetworkType.CONNECTED.ordinal()] = 2;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f30173OooO0OO[NetworkType.UNMETERED.ordinal()] = 3;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f30173OooO0OO[NetworkType.NOT_ROAMING.ordinal()] = 4;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f30173OooO0OO[NetworkType.METERED.ordinal()] = 5;
            ...
            try {
                f30172OooO0O0[BackoffPolicy.LINEAR.ordinal()] = 2;
            ...
            try {
                f30171OooO00o[WorkInfo$State.RUNNING.ordinal()] = 2;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f30171OooO00o[WorkInfo$State.SUCCEEDED.ordinal()] = 3;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f30171OooO00o[WorkInfo$State.FAILED.ordinal()] = 4;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f30171OooO00o[WorkInfo$State.BLOCKED.ordinal()] = 5;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f30171OooO00o[WorkInfo$State.CANCELLED.ordinal()] = 6;
            ...
            try {
                ...
                try {
                    for (int i = objectInputStream.readInt(); i > 0; i--) {
                        oooOOO0.f29804OooO00o.add(new o000oo.OooOOO0.OooO00o(Uri.parse(objectInputStream.readUTF()), objectInputStream.readBoolean()));
                    }
                    try {
    ...
    public static int OooO0o(WorkInfo$State workInfo$State) {
        switch (OooO00o.f30171OooO00o[workInfo$State.ordinal()]) {
            case 1:
                return 0;
            case 2:
                return 1;
