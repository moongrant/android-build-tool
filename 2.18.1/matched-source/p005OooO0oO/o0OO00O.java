...
public final class o0OO00O extends OooO00o {
    ...
    public final boolean getNetworkStatus(@NotNull String data) {
        ...
        if (activeNetworkInfo == null) {
            ...
            switch (activeNetworkInfo.getSubtype()) {
                ...
                default:
                    ...
                    if (!StringsKt.OooO(subtypeName, "TD-SCDMA") && !StringsKt.OooO(subtypeName, "WCDMA")) {
                        StringsKt.OooO(subtypeName, "CDMA2000");
                    }
                    break;
            }
            netUtil$NetworkType = NetUtil$NetworkType.NETWORK_NO;
        ...
        o00o00o2.OooO0o0(AnalyticsEvents.PARAMETER_SHARE_DIALOG_CONTENT_STATUS, numValueOf == null ? o00O00.f38884OooO00o : new oOO00O(numValueOf));
        Integer numValueOf2 = Integer.valueOf(netUtil$NetworkType.getValue());
        o00o00o2.OooO0o0("accessTechnology", numValueOf2 == null ? o00O00.f38884OooO00o : new oOO00O(numValueOf2));
