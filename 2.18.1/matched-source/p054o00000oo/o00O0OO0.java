...
public final class o00O0OO0 implements InputConnection {
    ...
    @NotNull
    public final o00O00O f27187OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final boolean f27188OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public int f27189OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public oo0oOO0 f27190OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public boolean f27191OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public int f27192OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    @NotNull
    public final List<o000O> f27193OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public boolean f27194OooO0oo;

    public o00O0OO0(@NotNull oo0oOO0 initState, @NotNull o00O00O eventCallback, boolean z) {
        Intrinsics.checkNotNullParameter(initState, "initState");
        Intrinsics.checkNotNullParameter(eventCallback, "eventCallback");
        this.f27187OooO00o = eventCallback;
        this.f27188OooO0O0 = z;
        this.f27190OooO0Oo = initState;
        this.f27193OooO0oO = new ArrayList();
        this.f27194OooO0oo = true;
    }
    ...
    public final boolean OooO0O0() {
        int i = this.f27189OooO0OO - 1;
        this.f27189OooO0OO = i;
        if (i == 0 && (!this.f27193OooO0oO.isEmpty())) {
            this.f27187OooO00o.OooO0OO(CollectionsKt.toMutableList((Collection) this.f27193OooO0oO));
            this.f27193OooO0oO.clear();
        }
        return this.f27189OooO0OO > 0;
    }
    ...
    public final void closeConnection() {
        this.f27193OooO0oO.clear();
        this.f27189OooO0OO = 0;
        this.f27194OooO0oo = false;
    }
    ...
    public final int getCursorCapsMode(int i) {
        oo0oOO0 oo0ooo0 = this.f27190OooO0Oo;
        return TextUtils.getCapsMode(oo0ooo0.f27236OooO00o.f26756Oooo0o, o0OO00O.OooO0oO(oo0ooo0.f27237OooO0O0), i);
    }
    ...
    public final ExtractedText getExtractedText(@Nullable ExtractedTextRequest extractedTextRequest, int i) {
        ...
        this.f27191OooO0o = z;
        if (z) {
            this.f27192OooO0o0 = extractedTextRequest != null ? extractedTextRequest.token : 0;
        }
        return o00O00o0.OooO00o(this.f27190OooO0Oo);
    }
    ...
    public final CharSequence getSelectedText(int i) {
        if (o0OO00O.OooO0OO(this.f27190OooO0Oo.f27237OooO0O0)) {
            return null;
        }
        return o00O.OooO00o(this.f27190OooO0Oo).f26756Oooo0o;
    }

    @Override // android.view.inputmethod.InputConnection
    @NotNull
    public final CharSequence getTextAfterCursor(int i, int i2) {
        return o00O.OooO0O0(this.f27190OooO0Oo, i).f26756Oooo0o;
    }

    @Override // android.view.inputmethod.InputConnection
    @NotNull
    public final CharSequence getTextBeforeCursor(int i, int i2) {
        return o00O.OooO0OO(this.f27190OooO0Oo, i).f26756Oooo0o;
    }
    ...
    public final boolean performContextMenuAction(int i) {
        ...
        if (z) {
            ...
            switch (i) {
                case R.id.selectAll:
                    OooO00o(new o00O0OOO(0, this.f27190OooO0Oo.f27236OooO00o.f26756Oooo0o.length()));
                    break;
                case R.id.cut:
                    OooO0OO(277);
                    break;
    ...
    public final boolean sendKeyEvent(@NotNull KeyEvent event) {
        ...
        this.f27187OooO00o.OooO00o(event);
        return true;
    }
