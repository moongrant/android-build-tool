...
public final class OooOO0O {
    public static boolean OooO00o(@Nullable OooO00o[] oooO00oArr, @Nullable OooO00o[] oooO00oArr2) {
        ...
        for (int i = 0; i < oooO00oArr.length; i++) {
            if (oooO00oArr[i].f28168OooO00o != oooO00oArr2[i].f28168OooO00o || oooO00oArr[i].f28169OooO0O0.length != oooO00oArr2[i].f28169OooO0O0.length) {
                return false;
            }
        }
        return true;
    ...
    */
    ...
    public static Path OooO0Oo(String str) {
        ...
        try {
            ...
            throw new RuntimeException(OooOo00.OooO0Oo("Error in parsing ", str), e);
        }
    }
    ...
    public static class OooO00o {
        ...
        public char f28168OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public float[] f28169OooO0O0;

        public OooO00o(char c, float[] fArr) {
            this.f28168OooO00o = c;
            this.f28169OooO0O0 = fArr;
        }
        ...
        public static void OooO0O0(OooO00o[] oooO00oArr, Path path) {
            ...
            while (i3 < oooO00oArr.length) {
                char c4 = oooO00oArr[i3].f28168OooO00o;
                float[] fArr3 = oooO00oArr[i3].f28169OooO0O0;
                float f19 = fArr2[c2];
                float f20 = fArr2[1];
                float f21 = fArr2[2];
                float f22 = fArr2[3];
                ...
                fArr2[5] = f26;
                i3 = i49 + 1;
                c3 = oooO00oArr[i49].f28168OooO00o;
                c = 'm';
                c2 = 0;
            }
        }
        ...
        public OooO00o(OooO00o oooO00o) {
            this.f28168OooO00o = oooO00o.f28168OooO00o;
            float[] fArr = oooO00o.f28169OooO0O0;
            this.f28169OooO0O0 = OooOO0O.OooO0O0(fArr, fArr.length);
        }
    }
}
