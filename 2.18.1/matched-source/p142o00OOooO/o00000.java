...
public final /* synthetic */ class o00000 implements Observer {
    ...
    public final /* synthetic */ int f31914OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final /* synthetic */ Object f31915OooO0O0;

    public /* synthetic */ o00000(Object obj, int i) {
        this.f31914OooO00o = i;
        this.f31915OooO0O0 = obj;
    }
    ...
    public final void onChanged(Object obj) {
        ...
        Object obj2 = null;
        e7 e7Var = null;
        switch (this.f31914OooO00o) {
            case 0:
                MainMomentFollowingFragment.m19initObserver$lambda3((MainMomentFollowingFragment) this.f31915OooO0O0, (MomentDetailModel) obj);
                break;
            case 1:
                WebActivity this$0 = (WebActivity) this.f31915OooO0O0;
                WebActivity.OooO00o oooO00o = WebActivity.f22108OoooooO;
                Intrinsics.checkNotNullParameter(this$0, "this$0");
                if (this$0.f22109OoooOo0) {
                    e7 e7Var2 = this$0.f22115OooooOO;
                    if (e7Var2 == null) {
                ...
                break;
            case 2:
                PostDetailActivity this$1 = (PostDetailActivity) this.f31915OooO0O0;
                ...
                if (momentDetailModel2 != null) {
                    ...
                    if (type == MomentType.Poll.getValue()) {
                        if (momentDetailModel2.getId() == momentDetailModel.getId()) {
                            ...
                            this$1.f22420Ooooo0o = momentDetailModel;
                            this$1.OooOooO().f50589OooOOOO.OooOOo0(this$1.f22420Ooooo0o, 0);
                        }
                        break;
                        ...
                        o00O00.OooOO0O("POST_DETAIL_POLL_DATA_REFRESH PostDetailActivity result = " + momentDetailModel);
                        MomentDetailModel momentDetailModel3 = this$1.f22420Ooooo0o;
                        if (momentDetailModel3 != null) {
                            momentDetailModel3.setForward(momentDetailModel);
                        }
                        if (this$1.f22420Ooooo0o != null) {
                            this$1.OooOooO().f50589OooOOOO.OooOOo0(this$1.f22420Ooooo0o, 0);
                        }
                        break;
                    }
                ...
                break;
            case 3:
                MixedRoomActivity activity = (MixedRoomActivity) this.f31915OooO0O0;
                Intrinsics.checkNotNullParameter(activity, "$activity");
                new b(activity).OooOO0();
                break;
            case 4:
                MainMomentsTopicRecommendFragment.m360initObserver$lambda1((MainMomentsTopicRecommendFragment) this.f31915OooO0O0, (TopicFollowChange) obj);
                break;
            default:
                EventSquareViewModel squareVM = (EventSquareViewModel) this.f31915OooO0O0;
                Long l = (Long) obj;
                Intrinsics.checkNotNullParameter(squareVM, "$squareVM");
                o000O0<EventModel> squareEventPager = squareVM.getSquareEventPager();
                for (Object obj3 : squareEventPager.f48682OooO0Oo) {
                    if (l != null && ((EventModel) obj3).getId() == l.longValue()) {
                        obj2 = obj3;
                        eventModel = (EventModel) obj2;
                        r11 = squareEventPager.f48682OooO0Oo;
                        if (eventModel == null) {
