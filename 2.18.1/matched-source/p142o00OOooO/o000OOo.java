...
public final /* synthetic */ class o000OOo implements Observer {
    ...
    public final /* synthetic */ int f31954OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final /* synthetic */ Object f31955OooO0O0;

    public /* synthetic */ o000OOo(Object obj, int i) {
        this.f31954OooO00o = i;
        this.f31955OooO0O0 = obj;
    }
    ...
    public final void onChanged(Object obj) {
        boolean z = true;
        switch (this.f31954OooO00o) {
            case 0:
                MainMomentFollowingFragment.m23initObserver$lambda9((MainMomentFollowingFragment) this.f31955OooO0O0, (MomentDetailModel) obj);
                break;
            case 1:
                LoginActivity this$0 = (LoginActivity) this.f31955OooO0O0;
                ...
                break;
            case 2:
                FriendRequestMessageActivity this$1 = (FriendRequestMessageActivity) this.f31955OooO0O0;
                ...
                break;
            case 3:
                PostDetailActivity this$2 = (PostDetailActivity) this.f31955OooO0O0;
                ...
                if (momentDetailModel != null && momentDetailModel.getUserId() == Long.parseLong(result.getUserId())) {
                    ...
                    this$2.OooOooO().f50589OooOOOO.OooOOO();
                    break;
                }
                break;
            case 4:
                oOO0O00O this$3 = (oOO0O00O) this.f31955OooO0O0;
                ...
                if (!z) {
                    ...
                    this$3.OooOO0O().f49193OooO0Oo.loadUrl(o00000OO.OooO0OO(o00000OO.OooO00o(it2), null));
                }
                break;
            case 5:
                ((UserInfoLeftFragment) this.f31955OooO0O0).lambda$loadVehicleList$1((ApiResult) obj);
                break;
            default:
                RoomEventInfoViewModel roomInfoVM = (RoomEventInfoViewModel) this.f31955OooO0O0;
                ...
                Iterator it3 = eventInfoPager.f48682OooO0Oo.iterator();
                int i = 0;
                while (true) {
                    if (!it3.hasNext()) {
                        i = -1;
                ...
                if (i >= 0) {
                    EventModel eventModel = (EventModel) eventInfoPager.f48682OooO0Oo.get(i);
                    ...
                    eventInfoPager.f48682OooO0Oo.set(i, (T) eventModel.clone());
