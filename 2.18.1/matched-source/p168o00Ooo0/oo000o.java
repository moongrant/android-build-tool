...
public final class oo000o {
    public static String OooO00o() {
        switch (OooOOO.f41216OooO00o.OooOOO().getValue().intValue()) {
            case 0:
                return "en";
            case 1:
                return "ar";
    ...
    public static String OooO0Oo() {
        ...
        String strOooO00o = p617o0oo0o.oo000o.OooO00o();
        String[] stringArray = App.f11458Oooo0oO.getResources().getStringArray(R.array.region_id_list);
        ...
        String[] stringArray2 = App.f11458Oooo0oO.getResources().getStringArray(R.array.id_countries_areaCode_region);
