...
public final class o000OO {
    ...
    public static final ArrayList<OooO00o> f36730OooO00o = new ArrayList<>();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final Pattern f36731OooO0O0 = Pattern.compile("^mp4a\\.([a-zA-Z0-9]{2})(?:\\.([0-9]{1,2}))?$");
    ...
    public static final class OooO0O0 {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final int f36732OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final int f36733OooO0O0;

        public OooO0O0(int i, int i2) {
            this.f36732OooO00o = i;
            this.f36733OooO0O0 = i2;
        }
    }
    ...
    public static boolean OooO00o(@Nullable String str, @Nullable String str2) {
        ...
        switch (str) {
            ...
            case "audio/mp4a-latm":
                return (str2 == null || (oooO0O0OooO0Oo = OooO0Oo(str2)) == null || (iOooO00o = AacUtil.OooO00o(oooO0O0OooO0Oo.f36733OooO0O0)) == 0 || iOooO00o == 16) ? false : true;
            default:
                return false;
        }
    }
    ...
    public static int OooO0O0(String str, @Nullable String str2) {
        ...
        switch (str) {
            ...
            case "audio/mp4a-latm":
                ...
                return AacUtil.OooO00o(oooO0O0OooO0Oo.f36733OooO0O0);
            case "audio/ac3":
                return 5;
            case "audio/ac4":
                return 17;
    ...
    public static OooO0O0 OooO0Oo(String str) {
        Matcher matcher = f36731OooO0O0.matcher(str);
        if (!matcher.matches()) {
            return null;
        }
    ...
    public static int OooO0o(@Nullable String str) {
        ...
        int size = f36730OooO00o.size();
        for (int i = 0; i < size; i++) {
            Objects.requireNonNull(f36730OooO00o.get(i));
            if (str.equals(null)) {
                return 0;
            }
        }
