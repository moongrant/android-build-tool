...
public abstract class o0OO00O {
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            Activity activityOooO0O0 = o00O000.OooO0O0();
            if (activityOooO0O0 != null) {
                CreateRoomActivity.f22774Ooooooo.OooO00o(activityOooO0O0);
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final /* synthetic */ String f40976Oooo0o;

        public static final class OooO00o extends Lambda implements Function1<Boolean, Unit> {

            /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
            public final /* synthetic */ String f40977Oooo0o;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public OooO00o(String str) {
                super(1);
                this.f40977Oooo0o = str;
            }

            @Override // kotlin.jvm.functions.Function1
            public final Unit invoke(Boolean bool) {
                if (bool.booleanValue()) {
                    String str = this.f40977Oooo0o;
                    if (!(str == null || StringsKt.isBlank(str))) {
                        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), Dispatchers.getIO(), null, new o0O0O00(this.f40977Oooo0o, null), 2, null);
                    }
                }
                return Unit.INSTANCE;
            }
        ...
        public OooO0OO(String str, Continuation<? super OooO0OO> continuation) {
            super(2, continuation);
            this.f40976Oooo0o = str;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0OO(this.f40976Oooo0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            Activity activityOooO0O0 = o00O000.OooO0O0();
            if (activityOooO0O0 != null) {
                o0O0O00.OooO0OO(activityOooO0O0, oo0o0Oo.f48608OooO0OO, null, new OooO00o(this.f40976Oooo0o));
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            Activity activityOooO0O0 = o00O000.OooO0O0();
            if (activityOooO0O0 != null) {
                RoomThemeStoreActivity.f23000OooooO0.OooO00o(activityOooO0O0, false);
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0O extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ String f40978Oooo0o;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0O(String str, Continuation<? super OooOO0O> continuation) {
            super(2, continuation);
            this.f40978Oooo0o = str;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOO0O(this.f40978Oooo0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            Activity activityOooO0O0 = o00O000.OooO0O0();
            if (activityOooO0O0 != null) {
                UserInfoActivity.OooO00o.OooO0Oo(UserInfoActivity.f23452o0ooOO0, activityOooO0O0, this.f40978Oooo0o, false, 12);
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOOO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ String f40979Oooo0o;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO(String str, Continuation<? super OooOOO> continuation) {
            super(2, continuation);
            this.f40979Oooo0o = str;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOOO(this.f40979Oooo0o, continuation);
        }
    ...
    public static final class OooOOOO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ String f40980Oooo0o;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOOO(String str, Continuation<? super OooOOOO> continuation) {
            super(2, continuation);
            this.f40980Oooo0o = str;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOOOO(this.f40980Oooo0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            IntrinsicsKt.getCOROUTINE_SUSPENDED();
            ResultKt.throwOnFailure(obj);
            ToastUtil.f12567OooO00o.OooO0O0(this.f40980Oooo0o);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOo extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ String f40981Oooo0o;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOo(String str, Continuation<? super OooOo> continuation) {
            super(2, continuation);
            this.f40981Oooo0o = str;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOo(this.f40981Oooo0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (context != null) {
                String packageName = this.f40981Oooo0o;
                Intrinsics.checkNotNullParameter(context, "context");
                Intrinsics.checkNotNullParameter(packageName, "packageName");
                if (p516o0o0O000.Oooo000.OooO00o(context, "com.android.vending")) {
                    try {
                        ...
                        e.printStackTrace();
                        p516o0o0O000.Oooo000.OooO0OO(context, packageName);
                    }
                } else {
                    p516o0o0O000.Oooo000.OooO0OO(context, packageName);
                }
    ...
    public static final class OooOo00 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            Activity activityOooO0O0 = o00O000.OooO0O0();
            if (activityOooO0O0 != null) {
                TaskActivity.f22061o00Oo0.OooO00o(activityOooO0O0);
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class Oooo0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ int f40982Oooo0o;
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new Oooo0(this.f40982Oooo0o, continuation);
        }
    ...
    public static final class Oooo000 extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public static final Oooo000 f40983Oooo0o = new Oooo000();
        ...
        public final Unit invoke() {
            ...
            if (fragmentActivity != null) {
                ...
                o00000 action = new o00000(fragmentActivity);
    ...
    public static final class o000oOoO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ int f40984Oooo0o;
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new o000oOoO(this.f40984Oooo0o, continuation);
        }
    ...
    public static final class o00O0O extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ String f40985Oooo0o;

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ FragmentActivity f40986Oooo0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public o00O0O(String str, FragmentActivity fragmentActivity, Continuation<? super o00O0O> continuation) {
            super(2, continuation);
            this.f40985Oooo0o = str;
            this.f40986Oooo0oO = fragmentActivity;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new o00O0O(this.f40985Oooo0o, this.f40986Oooo0oO, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            IntrinsicsKt.getCOROUTINE_SUSPENDED();
            ResultKt.throwOnFailure(obj);
            if (!o00O0.OooO0o0(this.f40985Oooo0o)) {
                SharedUrlManager.INSTANCE.getYallachatTreeUrl().observe(this.f40986Oooo0oO, new Observer() { // from class: o0o000oo.o00000O0
                    @Override // androidx.lifecycle.Observer
                    public final void onChanged(Object obj2) {
                        String it = (String) obj2;
                        o0000O0.OooO00o oooO00o = o0000O0.f48629OooO0O0;
            ...
            String str = this.f40985Oooo0o;
            if (str != null) {
                o0000O0.f48629OooO0O0.OooO0O0(str);
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class o0OoOo0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ MomentDetailModel f40987Oooo0o;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public o0OoOo0(MomentDetailModel momentDetailModel, Continuation<? super o0OoOo0> continuation) {
            super(2, continuation);
            this.f40987Oooo0o = momentDetailModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new o0OoOo0(this.f40987Oooo0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            Activity activityOooO0O0 = o00O000.OooO0O0();
            if (activityOooO0O0 != null) {
                MomentDetailModel momentDetailModel = this.f40987Oooo0o;
                PostDetailActivity.OooO00o oooO00o = PostDetailActivity.f22417o0O0O00;
                PostDetailActivity.f22417o0O0O00.OooO00o(activityOooO0O0, momentDetailModel, (256 & 4) != 0 ? false : false, (256 & 8) != 0 ? 1 : -1, (256 & 16) != 0 ? null : null, (256 & 32) != 0 ? false : false, (256 & 64) != 0 ? null : MomentAdapterTag.Web, (256 & 128) != 0 ? false : true, (256 & 256) != 0 ? "" : null);
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public final void coinNotEnoughQuick() {
        p606o0oo0O.OooOo.OooO0OO("202005", MapsKt.mapOf(new Pair("source", 4)));
        p189o00o00oO.oo0o0Oo.OooO0O0(CommonError.Coin_NotEnough_QuickRecharge, null, 2, null, CommonErrorHandler.INSTANCE);
    }
            ...
            switch (str.hashCode()) {
                case -1850780999:
                    if (str.equals("phoneBrand")) {
                        ...
                        jSInfoModel.setPhoneBrand(o0Oo0oo.OooO0O0());
                    }
                    break;
                case -1840709029:
                    if (str.equals("phoneModel")) {
                        o0Oo0oo o0oo0oo3 = o0Oo0oo.f40947OooO00o;
                        jSInfoModel.setPhoneModel(o0Oo0oo.OooO0OO());
                    }
                    break;
                case -1811743075:
                    if (str.equals("networkOperatorName")) {
                        jSInfoModel.setNetworkOperatorName(NetworkUtil.f20498OooO00o.OooO0Oo());
                    }
                    break;
                case -1540282147:
                ...
                case -934795532:
                    if (str.equals("region")) {
                        Integer value2 = p498o0o00Oo0.OooOOO.f41216OooO00o.OooOOO().getValue();
                ...
                case -925319370:
                    if (str.equals("roomID")) {
                        Long value3 = o00OO00O.f43313OooooOo.OooO00o().f43319OooO0Oo.getValue();
                        if (value3 != null) {
                ...
                case -836030906:
                    if (str.equals("userId")) {
                        Long value4 = p498o0o00Oo0.OooOOO.f41216OooO00o.OooOo().getValue();
                        if (value4 != null) {
                ...
                case -662089212:
                    if (str.equals("appVersionCode")) {
                        ...
                        jSInfoModel.setAppVersionCode(o0OOO0o.OooO00o());
                    }
                    break;
                case -661774686:
                    if (str.equals("appVersionName")) {
                        o0OOO0o o0ooo0o3 = o0OOO0o.f40936OooO00o;
                        jSInfoModel.setAppVersionName(o0OOO0o.OooO0O0());
                    }
                    break;
                case -147154190:
                    if (str.equals("userIdx")) {
                        String value5 = p498o0o00Oo0.OooOOO.f41216OooO00o.OooOoO0().getValue();
                        if (value5 != null) {
                ...
                case 3735305:
                    if (str.equals("zeus")) {
                        jSInfoModel.setZeus(p485o0o000Oo.o000oOoO.f40895OooO00o.OooO00o("").OooO00o());
                    }
                    break;
                case 110541305:
                    if (str.equals(FirebaseMessagingService.EXTRA_TOKEN)) {
                        String value6 = p498o0o00Oo0.OooOOO.f41216OooO00o.OooOo0().getValue();
                        if (value6 != null) {
                ...
                case 321545849:
                    if (str.equals("userLevel")) {
                        Integer value7 = p498o0o00Oo0.OooOOO.f41216OooO00o.OooOO0().getValue();
                        if (value7 == null) {
                            iIntValue = 0;
                        } else {
                ...
                case 329221358:
                    if (str.equals("userToken")) {
                        String value8 = p498o0o00Oo0.OooOOO.f41216OooO00o.OooOo00().getValue();
                        if (value8 != null) {
                ...
                case 1471573351:
                    if (str.equals("vipLevel")) {
                        Pair<Boolean, Integer> value9 = p498o0o00Oo0.OooOOO.f41216OooO00o.OooOOO0().getValue();
                        jSInfoModel.setVipLevel(value9 != null ? value9.getSecond().intValue() : 0);
                    }
                    break;
                case 1842452087:
                    if (str.equals("netType")) {
                        jSInfoModel.setNetType(NetworkUtil.f20498OooO00o.OooO0OO().toString());
                    }
                    break;
                case 2098881846:
                    if (str.equals("systemVersionCode")) {
                        o0Oo0oo o0oo0oo4 = o0Oo0oo.f40947OooO00o;
                        jSInfoModel.setSystemVersionCode(String.valueOf(((Number) o0Oo0oo.f40948OooO0O0.getValue()).intValue()));
                    }
                    break;
                case 2099196372:
                    if (str.equals("systemVersionName")) {
                        o0Oo0oo o0oo0oo5 = o0Oo0oo.f40947OooO00o;
                        jSInfoModel.setSystemVersionName(o0Oo0oo.OooO0Oo());
                    }
                    break;
            }
        }
        return p516o0o0O000.o0Oo0oo.OooO0O0(jSInfoModel);
    }
    ...
    public final void toAssociationYallaChat() {
        Oooo000 action = Oooo000.f40983Oooo0o;
    ...
    public final void updateCoin(long j) {
        p498o0o00Oo0.OooOOO.f41216OooO00o.OooO0OO().postValue(Long.valueOf(j));
    }

    @JavascriptInterface
    public void updateCrystal(int i) {
        p498o0o00Oo0.OooOOO.f41216OooO00o.OooO0o().postValue(Long.valueOf(i));
    }
    ...
    public final void buriedPointEvent(@Nullable String str, @Nullable Map<String, String> map) {
        if (str != null) {
            p606o0oo0O.OooOo.OooO0OO(str, map);
        }
    }
    ...
    public final void roomPage(@Nullable String str, int i) {
        ...
        o00000OO.f32213OooO0oO.OooO0OO(str, new o000OOo(numValueOf));
    }
}
