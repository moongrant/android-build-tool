...
public final /* synthetic */ class o000Oo0 implements View.OnClickListener {
    ...
    public final /* synthetic */ int f41602Oooo0o;

    /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
    public final /* synthetic */ Object f41603Oooo0oO;

    public /* synthetic */ o000Oo0(Object obj, int i) {
        this.f41602Oooo0o = i;
        this.f41603Oooo0oO = obj;
    }

    @Override // android.view.View.OnClickListener
    public final void onClick(View view) {
        switch (this.f41602Oooo0o) {
            case 0:
                RoomBlackListUnJoinAndUnFollowDialog this$0 = (RoomBlackListUnJoinAndUnFollowDialog) this.f41603Oooo0oO;
                Intrinsics.checkNotNullParameter(this$0, "this$0");
                Long value = o00OO00O.f43313OooooOo.OooO00o().f43319OooO0Oo.getValue();
                if (value != null) {
                    this$0.OooOO0o().unFollowRoom(String.valueOf(value.longValue())).observe(this$0.f20878OoooO, new o000(this$0, 2));
                }
                Objects.requireNonNull(this$0);
                break;
            default:
                MainRoomPopularTopView this$1 = (MainRoomPopularTopView) this.f41603Oooo0oO;
