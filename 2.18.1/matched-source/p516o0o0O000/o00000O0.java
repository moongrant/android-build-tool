...
import p506o0o00oO0.o0;
import p506o0o00oO0.o00O;
import p506o0o00oO0.o00OO;
import p506o0o00oO0.o00OO000;
import p506o0o00oO0.o00OO00O;
import p506o0o00oO0.o00OO0O0;
import p506o0o00oO0.o00OO0OO;
import p506o0o00oO0.o00OOO0O;
import p506o0o00oO0.o00OOOOo;
import p506o0o00oO0.o00Oo00;
import p506o0o00oO0.o0O000;
import p506o0o00oO0.o0O0000O;
import p506o0o00oO0.o0O000O;
import p506o0o00oO0.o0o0Oo;
import p506o0o00oO0.o0oOOo;
import p506o0o00oO0.oo0O;
...
public final class o00000O0 {
    ...
    @Nullable
    public ShareModel f42066OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @Nullable
    public o00O f42067OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @Nullable
    public o0oOOo f42068OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @Nullable
    public o0O0000O f42069OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @Nullable
    public o00Oo00 f42070OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @Nullable
    public o00OO f42071OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    @Nullable
    public oo0O f42072OooO0oO;
    ...
    public o00000O0(@NotNull FragmentActivity activity, @NotNull ShareType shareType) {
        ...
        this.f42067OooO0O0 = new o00O(activity);
        this.f42068OooO0OO = new o0oOOo(activity);
        this.f42069OooO0Oo = new o0O0000O(activity);
        this.f42071OooO0o0 = new o00OO(activity);
        this.f42070OooO0o = new o00Oo00(activity);
        this.f42072OooO0oO = new oo0O(activity);
    }
    ...
    public final void OooO00o(@Nullable ShareChannel shareChannel) {
        ...
        if (shareChannel != null) {
            ...
            switch (OooO00o.$EnumSwitchMapping$0[shareChannel.ordinal()]) {
                case 1:
                    oo0O oo0o = this.f42072OooO0oO;
                    if (oo0o != null && (shareModel = this.f42066OooO00o) != null) {
                        o00OO0OO onLogin = new o00OO0OO(shareModel, oo0o);
                    ...
                    break;
                case 2:
                    o00Oo00 o00oo00 = this.f42070OooO0o;
                    if (o00oo00 != null && (shareModel2 = this.f42066OooO00o) != null) {
                        o00OOOOo onLogin2 = new o00OOOOo(shareModel2, o00oo00);
                    ...
                    break;
                case 3:
                    o00O o00o2 = this.f42067OooO0O0;
                    if (o00o2 != null && (shareModel3 = this.f42066OooO00o) != null) {
                        int i = o00O.OooO00o.$EnumSwitchMapping$0[shareModel3.getType().ordinal()];
                        if (i == 1) {
                        ...
                        o00OO000 o00oo001 = new o00OO000(o00o2, shareModel3, str4);
                        if (!(string == null || StringsKt.isBlank(string))) {
                            ...
                            if (ShareDialog.INSTANCE.canShow(ShareLinkContent.class)) {
                                FragmentActivity fragmentActivity = o00o2.f41623OooO00o;
                                if (fragmentActivity instanceof BaseAppCompatActivity) {
                                    ((BaseAppCompatActivity) fragmentActivity).f21687Oooo0oO = new o00OO00O(o00o2);
                                }
                                o00o2.f41626OooO0Oo.registerCallback(o00o2.f41625OooO0OO, new o00OO0O0());
                                o00o2.f41626OooO0Oo.show(shareLinkContentBuild);
                                o00oo001.invoke();
                            }
                            break;
                        }
                    ...
                    break;
                case 4:
                    o0oOOo o0oooo2 = this.f42068OooO0OO;
                    if (o0oooo2 != null && (shareModel4 = this.f42066OooO00o) != null) {
                        int i2 = o0oOOo.OooO00o.$EnumSwitchMapping$0[shareModel4.getType().ordinal()];
                        if (i2 == 1) {
                        ...
                        final o0 o0Var = new o0(o0oooo2, str2, str3, shareModel4, str);
                        if (!(str5 == null || str5.length() == 0)) {
                            OooO0o oooO0o = OooO0o.f41155OooO00o;
                            o000000O o000000oOooO0OO = o0O000Oo.OooO0OO(OooO0o.f41158OooO0Oo);
                            o000000oOooO0OO.f33055OooO0Oo = new o00O0O() { // from class: o0o00oO0.oo00oO
                            ...
                            o000000oOooO0OO.OooO0O0(CloudImageUtilKt.imgFormat(str5));
                        } else {
                            o0Var.invoke("");
                        }
                        break;
                    ...
                    break;
                case 5:
                    o00OO o00oo2 = this.f42071OooO0o0;
                    if (o00oo2 != null && (shareModel5 = this.f42066OooO00o) != null) {
                        FragmentActivity fragmentActivity2 = o00oo2.f41627OooO00o;
                        try {
                        ...
                        if (!z) {
                            ToastUtil.f12567OooO00o.OooO0O0(OooOo.OooO00o(o000O0O0.OooO0OO(R.string.Please_install_XXX), o000O0O0.OooO0OO(R.string.single_third_instagram)));
                        }
                        if (z) {
                            int i3 = o00OO.OooO0O0.$EnumSwitchMapping$0[shareModel5.getType().ordinal()];
                            if (i3 == 1) {
                            ...
                            o00OOO0O o00ooo0o2 = new o00OOO0O(o00oo2, shareModel5, roomid3);
                            if (strOooO00o == null || strOooO00o.length() == 0) {
                                if (imageUrl2 == null || imageUrl2.length() == 0) {
                                }
                            }
                            o00oo2.OooO00o().f41634OoooOOO = strOooO00o;
                            o00oo2.OooO00o().f41637o000oOoO = imageUrl2;
                            o00oo2.OooO00o().f41635OoooOOo = type;
                            o00oo2.OooO00o().f41636OoooOo0 = new o0o0Oo(o00oo2, o00ooo0o2);
                            o00oo2.OooO00o().OooOO0();
                            break;
                        }
                    }
                    break;
                case 6:
                    o0O0000O o0o0000o2 = this.f42069OooO0Oo;
                    if (o0o0000o2 != null && (shareModel6 = this.f42066OooO00o) != null) {
                        int i4 = o0O0000O.OooO00o.$EnumSwitchMapping$0[shareModel6.getType().ordinal()];
                        if (i4 == 1) {
                        ...
                        o0O000 o0o001 = new o0O000(o0o0000o2, shareModel6, title3);
                        ...
                        try {
                            FragmentActivity fragmentActivity3 = o0o0000o2.f41661OooO00o;
                            if (fragmentActivity3 instanceof BaseAppCompatActivity) {
                                ((BaseAppCompatActivity) fragmentActivity3).f21687Oooo0oO = new o0O000O(o0o0000o2);
                            }
                            Intent intent2 = new Intent();
                            intent2.setAction("android.intent.action.SEND");
                            intent2.setPackage(o0o0000o2.f41664OooO0Oo);
                            intent2.putExtra("android.intent.extra.TEXT", title2 + ' ' + strOooO00o2 + ' ' + string3);
                            intent2.setType("text/plain");
                            intent2.addFlags(1);
                            o0o0000o2.f41661OooO00o.startActivityForResult(intent2, o0o0000o2.f41663OooO0OO);
                            o0o001.invoke();
                        } catch (Exception e2) {
                            e2.printStackTrace();
                            ToastUtil.f12567OooO00o.OooO0O0(OooOo.OooO00o(o000O0O0.OooO0OO(R.string.Please_install_XXX), o000O0O0.OooO0OO(R.string.single_third_whatsApp)));
                            return;
                        }
                        break;
                    }
