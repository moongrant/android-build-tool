...
public final class oO000O0O implements oO00000 {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    @Nullable
    public oO00000o f43455OooO00o;
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final /* synthetic */ MemberBadgeInfo f43456Oooo0o;

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ RoomJoinMemberModel f43457Oooo0oO;
        ...
        public OooO00o(MemberBadgeInfo memberBadgeInfo, RoomJoinMemberModel roomJoinMemberModel, Continuation<? super OooO00o> continuation) {
            super(2, continuation);
            this.f43456Oooo0o = memberBadgeInfo;
            this.f43457Oooo0oO = roomJoinMemberModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO00o(this.f43456Oooo0o, this.f43457Oooo0oO, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            o00O o00o2 = o00O.f43140OooO00o;
            o00o2.OooOOOo(this.f43456Oooo0o.getBadgeUrl());
            o00O.f43152OooOOO0.setValue(Boolean.valueOf(this.f43456Oooo0o.getBadgeState()));
            o00o2.OooOo00(this.f43456Oooo0o.getBadgeLevelUrl());
            o00o2.OooOOoo(this.f43456Oooo0o.getMemberLevel());
            o00o2.OooOo0O(this.f43457Oooo0oO.getRoomMemberCount());
            boolean z = false;
            o00O.f43168OooOooO.setValue(Boxing.boxBoolean(false));
            if (!this.f43456Oooo0o.getBadgeState()) {
                if (this.f43456Oooo0o.getMemberLevel() >= 15) {
                    str = "svga/anim_member_high_frozen.svga";
                } else {
                    int memberLevel = this.f43456Oooo0o.getMemberLevel();
            ...
            RoomUserInfoModel roomUserInfoModelOooOO0 = o00o2.OooOO0(this.f43457Oooo0oO.getUserid());
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final /* synthetic */ long f43458Oooo;

        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ int f43459Oooo0o;

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ int f43460Oooo0oO;

        /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
        public final /* synthetic */ long f43461Oooo0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(int i, int i2, long j, long j2, Continuation<? super OooO0O0> continuation) {
            super(2, continuation);
            this.f43459Oooo0o = i;
            this.f43460Oooo0oO = i2;
            this.f43461Oooo0oo = j;
            this.f43458Oooo = j2;
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0O0(this.f43459Oooo0o, this.f43460Oooo0oO, this.f43461Oooo0oo, this.f43458Oooo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            o00O o00o2 = o00O.f43140OooO00o;
            o00O.f43173Oooo00O.setValue(Integer.valueOf(this.f43459Oooo0o));
            o00O.f43172Oooo000.setValue(Integer.valueOf(this.f43460Oooo0oO));
            o00o2.OooOo0(this.f43461Oooo0oo);
            o00O.f43171Oooo0 = this.f43458Oooo;
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
        public final /* synthetic */ String f43462Oooo;

        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ long f43463Oooo0o;

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ int f43464Oooo0oO;

        /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
        public final /* synthetic */ String f43465Oooo0oo;

        /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
        public final /* synthetic */ boolean f43466OoooO00;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(long j, int i, String str, String str2, boolean z, Continuation<? super OooO0OO> continuation) {
            super(2, continuation);
            this.f43463Oooo0o = j;
            this.f43464Oooo0oO = i;
            this.f43465Oooo0oo = str;
            this.f43462Oooo = str2;
            this.f43466OoooO00 = z;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0OO(this.f43463Oooo0o, this.f43464Oooo0oO, this.f43465Oooo0oo, this.f43462Oooo, this.f43466OoooO00, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            IntrinsicsKt.getCOROUTINE_SUSPENDED();
            ResultKt.throwOnFailure(obj);
            long j = this.f43463Oooo0o;
            Long value = p498o0o00Oo0.OooOOO.f41216OooO00o.OooOo().getValue();
            if (value != null && j == value.longValue()) {
                o00O o00o2 = o00O.f43140OooO00o;
                o00o2.OooOOoo(this.f43464Oooo0oO);
                String badgeUrl = this.f43465Oooo0oo;
                Intrinsics.checkNotNullExpressionValue(badgeUrl, "badgeUrl");
                o00o2.OooOOOo(badgeUrl);
                String badgeLevelUrl = this.f43462Oooo;
                Intrinsics.checkNotNullExpressionValue(badgeLevelUrl, "badgeLevelUrl");
                o00o2.OooOo00(badgeLevelUrl);
                o00o2.OooOOo(this.f43466OoooO00);
                int i = this.f43464Oooo0oO;
                if (i >= 15) {
            ...
            RoomUserInfoModel roomUserInfoModelOooOO0 = o00O.f43140OooO00o.OooOO0(this.f43463Oooo0o);
            if (roomUserInfoModelOooOO0 != null) {
    ...
    public static final class OooO0o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ int f43467Oooo0o;
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0o(this.f43467Oooo0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            IntrinsicsKt.getCOROUTINE_SUSPENDED();
            ResultKt.throwOnFailure(obj);
            o00O.f43140OooO00o.OooOo0O(this.f43467Oooo0o);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ RoomJoinMemberModel f43468Oooo0o;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0(RoomJoinMemberModel roomJoinMemberModel, Continuation<? super OooOO0> continuation) {
            super(2, continuation);
            this.f43468Oooo0o = roomJoinMemberModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOO0(this.f43468Oooo0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            o00O o00o2 = o00O.f43140OooO00o;
            o00o2.OooOo0O(this.f43468Oooo0o.getRoomMemberCount());
            RoomUserInfoModel roomUserInfoModelOooOO0 = o00o2.OooOO0(this.f43468Oooo0o.getUserid());
            if (roomUserInfoModelOooOO0 != null) {
                roomUserInfoModelOooOO0.setRoomMemberType(3);
            }
            return Unit.INSTANCE;
    ...
    public static final class OooOO0O extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ RoomJoinMemberModel f43469Oooo0o;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0O(RoomJoinMemberModel roomJoinMemberModel, Continuation<? super OooOO0O> continuation) {
            super(2, continuation);
            this.f43469Oooo0o = roomJoinMemberModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOO0O(this.f43469Oooo0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            o00O o00o2 = o00O.f43140OooO00o;
            o00o2.OooOo0O(this.f43469Oooo0o.getRoomMemberCount());
            RoomUserInfoModel roomUserInfoModelOooOO0 = o00o2.OooOO0(this.f43469Oooo0o.getUserid());
            if (roomUserInfoModelOooOO0 != null) {
                RoomJoinMemberModel roomJoinMemberModel = this.f43469Oooo0o;
                roomUserInfoModelOooOO0.setRoomMemberType(3);
    ...
    public static final class OooOOO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ RoomAdminDemotionModel f43470Oooo0o;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO(RoomAdminDemotionModel roomAdminDemotionModel, Continuation<? super OooOOO> continuation) {
            super(2, continuation);
            this.f43470Oooo0o = roomAdminDemotionModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOOO(this.f43470Oooo0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            IntrinsicsKt.getCOROUTINE_SUSPENDED();
            ResultKt.throwOnFailure(obj);
            RoomUserInfoModel roomUserInfoModelOooOO0 = o00O.f43140OooO00o.OooOO0(this.f43470Oooo0o.getUserid());
            if (roomUserInfoModelOooOO0 != null) {
                roomUserInfoModelOooOO0.setRoomMemberType(3);
            }
            return Unit.INSTANCE;
    ...
    public static final class OooOOO0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ RoomAdminUpgradeModel f43471Oooo0o;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO0(RoomAdminUpgradeModel roomAdminUpgradeModel, Continuation<? super OooOOO0> continuation) {
            super(2, continuation);
            this.f43471Oooo0o = roomAdminUpgradeModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOOO0(this.f43471Oooo0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            IntrinsicsKt.getCOROUTINE_SUSPENDED();
            ResultKt.throwOnFailure(obj);
            RoomUserInfoModel roomUserInfoModelOooOO0 = o00O.f43140OooO00o.OooOO0(this.f43471Oooo0o.userid);
            if (roomUserInfoModelOooOO0 != null) {
    ...
    public static final class OooOOOO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ JSONObject f43472Oooo0o;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOOO(JSONObject jSONObject, Continuation<? super OooOOOO> continuation) {
            super(2, continuation);
            this.f43472Oooo0o = jSONObject;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOOOO(this.f43472Oooo0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            IntrinsicsKt.getCOROUTINE_SUSPENDED();
            ResultKt.throwOnFailure(obj);
            o00O.f43140OooO00o.OooOo0O(this.f43472Oooo0o.getInt("roomMemberCount"));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOo extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
        public final /* synthetic */ boolean f43473Oooo;

        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ int f43474Oooo0o;

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ String f43475Oooo0oO;

        /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
        public final /* synthetic */ String f43476Oooo0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOo(int i, String str, String str2, boolean z, Continuation<? super OooOo> continuation) {
            super(2, continuation);
            this.f43474Oooo0o = i;
            this.f43475Oooo0oO = str;
            this.f43476Oooo0oo = str2;
            this.f43473Oooo = z;
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOo(this.f43474Oooo0o, this.f43475Oooo0oO, this.f43476Oooo0oo, this.f43473Oooo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            o00O o00o2 = o00O.f43140OooO00o;
            o00o2.OooOOoo(this.f43474Oooo0o);
            String badgeLevelUrl = this.f43475Oooo0oO;
            Intrinsics.checkNotNullExpressionValue(badgeLevelUrl, "badgeLevelUrl");
            o00o2.OooOo00(badgeLevelUrl);
            String badgeUrl = this.f43476Oooo0oo;
            Intrinsics.checkNotNullExpressionValue(badgeUrl, "badgeUrl");
            o00o2.OooOOOo(badgeUrl);
            o00o2.OooOOo(this.f43473Oooo);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOo00 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ RemoveMemberModel f43477Oooo0o;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOo00(RemoveMemberModel removeMemberModel, Continuation<? super OooOo00> continuation) {
            super(2, continuation);
            this.f43477Oooo0o = removeMemberModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOo00(this.f43477Oooo0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            o00O o00o2 = o00O.f43140OooO00o;
            RoomUserInfoModel roomUserInfoModelOooOO0 = o00o2.OooOO0(this.f43477Oooo0o.getUserid());
            if (roomUserInfoModelOooOO0 != null) {
                roomUserInfoModelOooOO0.setRoomMemberType(0);
            }
            RoomUserInfoModel roomUserInfoModelOooOO1 = o00o2.OooOO0(this.f43477Oooo0o.getUserid());
        ...
        switch (i) {
            case 10021:
                if (bArr != null) {
                    ...
                    if (roomJoinMemberModel != null) {
                        ...
                        p498o0o00Oo0.OooOOO.f41216OooO00o.OooO0OO().postValue(Long.valueOf(roomJoinMemberModel.getLeftcoin()));
                        LiveEventBus.get("ROOM_JOIN_MEMBER").post(Long.valueOf(roomJoinMemberModel.getUserid()));
                        o00OO00O.f43313OooooOo.OooO00o().f43368Ooooo0o.postValue(new Pair<>(Long.valueOf(roomJoinMemberModel.getUserid()), 3));
                        break;
                    }
                }
                break;
            ...
            case 100222:
                if (bArr != null && (removeMemberModel = (RemoveMemberModel) o0Oo0oo.OooO0OO(new String(bArr, charset), RemoveMemberModel.class)) != null) {
                    ...
                    if ((value != null && userid == value.longValue()) || i == 100221) {
                        ...
                        num = 0;
                        oooO00o.OooO00o().f43329OooOOOO.postValue(null);
                        if (i == 10022) {
                            oooO00o.OooO00o().f43327OooOOO.postValue(Boolean.valueOf(!(removeMemberModel.getFollowType() == 1)));
                            o0O00000.OooO0OO("InRoom_roomProfile_unjoin_success");
                        } else {
                            oooO00o.OooO00o().f43327OooOOO.postValue(Boolean.TRUE);
                        }
                    } else {
                        if (i == 10022) {
                            ...
                            o00O o00o2 = o00O.f43140OooO00o;
                            o00O.f43181OoooO.postValue(Long.valueOf(removeMemberModel.getUserid()));
                    ...
                    o00OO00O.f43313OooooOo.OooO00o().f43368Ooooo0o.postValue(new Pair<>(Long.valueOf(removeMemberModel.getUserid()), num));
            ...
            case 100232:
                ...
                if (i == 10023) {
                    ...
                    o00O00.OooO0OO(oO00000.OooO00o.OooO00o(this), "被提升者弹被提升提示并修改自己的身份信息");
                    ...
                    o00OO00O.f43313OooooOo.OooO00o().f43329OooOOOO.postValue(2);
                }
                ...
                o00OO00O.f43313OooooOo.OooO00o().f43368Ooooo0o.postValue(new Pair<>(Long.valueOf(roomAdminUpgradeModel.userid), 2));
            ...
            case 100242:
                if (i == 100241) {
                    ...
                    Long value3 = p498o0o00Oo0.OooOOO.f41216OooO00o.OooOo().getValue();
                    if (value3 != null) {
                ...
                if (i == 10024) {
                    ...
                    if (!(strOooO0OO5 == null || StringsKt.isBlank(strOooO0OO5))) {
                        ...
                        if (Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                            ...
                            o00O000.f34348OooO0OO.post(o0o0oooOooO0O4);
                        }
                    }
                } else if (i == 100241) {
                    ...
                    if (!(strOooO0OO6 == null || StringsKt.isBlank(strOooO0OO6))) {
                        ...
                        if (Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                            ...
                            o00O000.f34348OooO0OO.post(o0o0oooOooO0O5);
                        }
                    }
                    o00OO00O.f43313OooooOo.OooO00o().f43329OooOOOO.postValue(3);
                }
                ...
                o00OO00O.f43313OooooOo.OooO00o().f43368Ooooo0o.postValue(new Pair<>(Long.valueOf(roomAdminDemotionModel.getUserid()), 3));
            ...
            case 10042:
                if (bArr != null) {
                    String strOooO00o3 = oO00000.OooO00o.OooO00o(this);
                    ...
                    oO00000o oo00000o = this.f43455OooO00o;
                    if (oo00000o != null) {
                        ...
                        oo00000o.OooO0O0(jLongValue, value4, value5);
                    ...
                    if (roomJoinMemberModel2 != null) {
                        if (roomJoinMemberModel2.getDues() > 0) {
                            p498o0o00Oo0.OooOOO.f41216OooO00o.OooO0OO().postValue(Long.valueOf(roomJoinMemberModel2.getLeftcoin()));
                        }
                        ...
                        oooO00o2.OooO00o().f43329OooOOOO.postValue(3);
                        oooO00o2.OooO00o().f43327OooOOO.postValue(bool);
                        ...
                        if (!z) {
                            ...
                            if (Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                                ...
                                o00O000.f34348OooO0OO.post(o0o0oooOooO0O6);
                            }
                        }
                        o00O o00o3 = o00O.f43140OooO00o;
                        o00o3.OooOoO(false);
                        p498o0o00Oo0.OooOOO oooOOO3 = p498o0o00Oo0.OooOOO.f41216OooO00o;
                        RoomUserInfoModel roomUserInfoModelOooOO0 = o00o3.OooOO0(((Number) kotlin.reflect.jvm.internal.impl.types.OooO00o.OooO00o(oooOOO3)).longValue());
                        if (roomUserInfoModelOooOO0 != null) {
                            roomUserInfoModelOooOO0.setRoomMemberType(3);
                        }
            ...
            case 100212:
                if (bArr != null) {
                    String strOooO00o4 = oO00000.OooO00o.OooO00o(this);
                    ...
                    if (roomJoinMemberModel3 != null) {
                        oO00000o oo00000o2 = this.f43455OooO00o;
                        if (oo00000o2 != null) {
                            oo00000o2.OooO0O0(roomJoinMemberModel3.getUserid(), roomJoinMemberModel3.getHeadphoto(), roomJoinMemberModel3.getNickname());
                        ...
                        o00OO00O.f43313OooooOo.OooO00o().f43368Ooooo0o.postValue(new Pair<>(Long.valueOf(roomJoinMemberModel3.getUserid()), 3));
                        break;
                    }
                }
                break;
            case 1000402:
                if (bArr != null) {
                    String strOooO00o5 = oO00000.OooO00o.OooO00o(this);
                ...
                if (o00OO00O.f43313OooooOo.OooO00o().OooOOo0()) {
                    ...
                    if (!(strOooO0OO8 == null || StringsKt.isBlank(strOooO0OO8))) {
                        ...
                        if (Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                            ...
                            o00O000.f34348OooO0OO.post(o0o0oooOooO0O7);
                        }
                    }
                    o00O o00o4 = o00O.f43140OooO00o;
                    o00O.f43173Oooo00O.setValue(Integer.valueOf(o00o4.OooO0o() - 1));
                    if (o00o4.OooO0o() > 0) {
                        o00o4.OooOo0(o00O.f43171Oooo0);
                        o00o4.OooOoOO();
                    }
                } else if (this.f43455OooO00o != null) {
            ...
            case 1000901:
                if (bArr != null) {
                    String strOooO00o6 = oO00000.OooO00o.OooO00o(this);
                    ...
                    Long value7 = p498o0o00Oo0.OooOOO.f41216OooO00o.OooOo().getValue();
                    ...
                    if (iOptInt >= 5 && this.f43455OooO00o != null) {
            ...
            case 1000902:
                if (bArr != null) {
                    ...
                    if (this.f43455OooO00o != null) {
                        ...
                        ArrayList<ChatModel> arrayList = o000O00O.OooO().f32436OoooOOO;
                            ...
                            while (true) {
                                if ((arrayList.size() - i2) - 1 < 0 || arrayList.get((arrayList.size() - i2) - 1).type != 30) {
                                    if (i2 != iMin) {
                                        ...
                                        p606o0oo0O.OooOo.OooO0O0("402003");
            ...
            case 1000903:
                if (bArr != null) {
                    String strOooO00o7 = oO00000.OooO00o.OooO00o(this);
                    ...
                    if (jSONObject4.has("badgeState")) {
                        ...
                        if (zOooO00o) {
                            p606o0oo0O.OooOo.OooO0O0("402001");
                        } else {
                            p606o0oo0O.OooOo.OooO0O0("402002");
                        }
                        if (this.f43455OooO00o != null) {
            ...
            case 1000904:
                if (bArr != null) {
                    String strOooO00o8 = oO00000.OooO00o.OooO00o(this);
            ...
            case 1000905:
                if (bArr != null) {
                    String strOooO00o9 = oO00000.OooO00o.OooO00o(this);
