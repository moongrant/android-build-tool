...
import p649o0ooOOoo.yb;

/* JADX INFO: loaded from: classes3.dex */
@StabilityInferred(parameters = 0)
public final class e1 extends o00000O {

    /* JADX INFO: renamed from: OoooO, reason: collision with root package name */
    @NotNull
    public final Function0<Unit> f45947OoooO;

    /* JADX INFO: renamed from: OoooOO0, reason: collision with root package name */
    @NotNull
    public final Function0<Unit> f45948OoooOO0;

    /* JADX INFO: renamed from: OoooOOO, reason: collision with root package name */
    @NotNull
    public final List<OooO0O0> f45949OoooOOO;

    /* JADX INFO: renamed from: o000oOoO, reason: collision with root package name */
    @NotNull
    public final yb f45950o000oOoO;
    ...
    public static final class OooO00o implements OooO0OO {
        ...
        public final void onStateChanged(@NotNull PlayState state) {
            ...
            if (state == PlayState.Playing) {
                VideoView videoView = e1.this.f45950o000oOoO.f51020OooOO0O;
    ...
    public e1(@NotNull Context context, @NotNull Function0<Unit> onReceiveRequest, @NotNull Function0<Unit> onWatchRequest) {
        super(context, 0);
        ...
        this.f45947OoooO = onReceiveRequest;
        this.f45948OoooOO0 = onWatchRequest;
        yb ybVarInflate = yb.inflate(LayoutInflater.from(context), this.f41545Oooo0oo, true);
        Intrinsics.checkNotNullExpressionValue(ybVarInflate, "inflate(LayoutInflater.f…xt), getRootView(), true)");
        this.f45950o000oOoO = ybVarInflate;
        this.f45949OoooOOO = new ArrayList();
        ConstraintLayout constraintLayout = ybVarInflate.f51011OooO00o;
        Intrinsics.checkNotNullExpressionValue(constraintLayout, "binding.root");
        OooO0oO(constraintLayout);
        ybVarInflate.f51015OooO0o.setOnClickListener(this);
        ybVarInflate.f51012OooO0O0.setOnClickListener(this);
        ybVarInflate.f51019OooOO0.setOnClickListener(this);
        OooO0o(false);
    }

    public static void OooOO0O(e1 e1Var, boolean z, boolean z2, boolean z3, boolean z4, int i) {
        if ((i & 1) != 0) {
            z = false;
        }
        if ((i & 2) != 0) {
        ...
        TextView textView = e1Var.f45950o000oOoO.f51019OooOO0;
    ...
    public static void OooOO0o(e1 e1Var, boolean z, boolean z2, boolean z3, int i) {
        if ((i & 1) != 0) {
            z = false;
        }
        if ((i & 2) != 0) {
    ...
    public final void OooO0Oo() {
        for (OooO0O0 oooO0O0 : this.f45949OoooOOO) {
            oooO0O0.OooO0o0();
            oooO0O0.OooO0O0();
        }
    }
    ...
    public final void OooO0o0(@NotNull View view) {
        ...
        Intrinsics.checkNotNullParameter(view, "view");
        if (Intrinsics.areEqual(view, this.f45950o000oOoO.f51012OooO0O0)) {
            this.f45947OoooO.invoke();
            return;
        }
        if (Intrinsics.areEqual(view, this.f45950o000oOoO.f51010OooO)) {
            this.f45948OoooOO0.invoke();
        } else if (!Intrinsics.areEqual(view, this.f45950o000oOoO.f51019OooOO0)) {
            OooO0O0();
        } else {
            RoomThemeMineActivity.OooO00o oooO00o = RoomThemeMineActivity.f22993Oooooo0;
            RoomThemeMineActivity.f22993Oooooo0.OooO00o(this.f41543Oooo0o, RoomThemeMineActivity.ThemeType.Mine);
        }
    }
    ...
    public final void OooOOO0(boolean z, int i, @NotNull String themeBackgroundUrl, @NotNull String videoUrl) {
        ...
        if (!StringsKt.isBlank(themeBackgroundUrl)) {
            ...
            oooO00o.f48429OooO0OO = CloudImageUtilKt.imgSize(themeBackgroundUrl, OooOo00.OooO00o(165), OooOo00.OooO00o(260));
            oooO00o.f48427OooO00o = 0;
            oooO00o.f48441OooOOOo = R.drawable.icon_room_theme_placeholder_big;
            oooO00o.OooO0oO(6);
            oooO00o.OooO0o(this.f45950o000oOoO.f51017OooO0oO);
            ImageView imageView = this.f45950o000oOoO.f51017OooO0oO;
            Intrinsics.checkNotNullExpressionValue(imageView, "binding.ivTheme");
            oOO00O.OooO(imageView);
        } else {
            ImageView imageView2 = this.f45950o000oOoO.f51017OooO0oO;
        ...
        if (!StringsKt.isBlank(videoUrl)) {
            ...
            this.f45949OoooOOO.add(oooO0O0);
            VideoView videoView = this.f45950o000oOoO.f51020OooOO0O;
            Intrinsics.checkNotNullExpressionValue(videoView, "binding.videoView");
            oooO0O0.OooO0Oo(videoView);
            SharedThemeVideoManager.INSTANCE.loadVideo(videoUrl).observe(this.f41544Oooo0oO, new Observer() { // from class: o0oOoOOo.d1
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    e1 this$0 = this.f45943OooO00o;
            ...
            this.f45950o000oOoO.f51020OooOO0O.setStateChangedListener(new OooO00o());
        } else {
            VideoView videoView2 = this.f45950o000oOoO.f51020OooOO0O;
        ...
        if (i == ChatMessage.GiveRoomThemeInfo.ThemeState.ThemeHasReceived.getValue()) {
            ...
            this.f45950o000oOoO.f51010OooO.setText(o000O0O0.OooO0OO(R.string.message_theme_has_received));
            ...
            if (i == ChatMessage.GiveRoomThemeInfo.ThemeState.ThemeHasExpired.getValue() || i == ChatMessage.GiveRoomThemeInfo.ThemeState.ThemeHasReturn.getValue()) {
                ...
                this.f45950o000oOoO.f51010OooO.setText(o000O0O0.OooO0OO(R.string.message_theme_has_invalid));
