...
public final class d5 extends o0000O {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    @NotNull
    public static final d5 f47212OooO00o = new d5();

    public static final class OooO extends Lambda implements Function2<oOO00O, Integer, Unit> {

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ o00O0O00 f47214Oooo0oO;

        /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
        public final /* synthetic */ int f47215Oooo0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(o00O0O00 o00o0o01, int i) {
            super(2);
            this.f47214Oooo0oO = o00o0o01;
            this.f47215Oooo0oo = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(oOO00O ooo00o, Integer num) {
            num.intValue();
            d5.this.OooO00o(this.f47214Oooo0oO, ooo00o, this.f47215Oooo0oo | 1);
    ...
    public static final class OooO00o extends Lambda implements Function1<Boolean, Unit> {
        ...
        public final /* synthetic */ EventSettingViewModel f47216Oooo0o;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(EventSettingViewModel eventSettingViewModel) {
            super(1);
            this.f47216Oooo0o = eventSettingViewModel;
        }
        ...
        public final Unit invoke(Boolean bool) {
            ...
            this.f47216Oooo0o.setEventSettingState();
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0O0 extends Lambda implements Function2<oOO00O, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ int f47218Oooo0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(int i) {
            super(2);
            this.f47218Oooo0oO = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(oOO00O ooo00o, Integer num) {
            num.intValue();
            d5.this.OooO0o0(ooo00o, this.f47218Oooo0oO | 1);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0OO extends Lambda implements Function2<o00OOOO0, Lifecycle.State, Unit> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ EventSettingViewModel f47219Oooo0o;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(EventSettingViewModel eventSettingViewModel) {
            super(2);
            this.f47219Oooo0o = eventSettingViewModel;
        }
        ...
        public final Unit invoke(o00OOOO0 o00oooo1, Lifecycle.State state) {
            ...
            if (it == Lifecycle.State.RESUMED) {
                o0O00OO<Boolean> hasPermissions = this.f47219Oooo0o.getHasPermissions();
                o00O000 o00o001 = o00O000.f34346OooO00o;
                hasPermissions.setValue(Boolean.valueOf(o0O0O00.OooO0O0(o00O000.OooO00o(), oo0o0Oo.f48608OooO0OO)));
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0o extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ Context f47220Oooo0o;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(Context context) {
            super(0);
            this.f47220Oooo0o = context;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            Context context = this.f47220Oooo0o;
    ...
    public static final class OooOO0 extends Lambda implements Function2<oOO00O, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ int f47222Oooo0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0(int i) {
            super(2);
            this.f47222Oooo0oO = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(oOO00O ooo00o, Integer num) {
            num.intValue();
            d5.this.OooO0o(ooo00o, this.f47222Oooo0oO | 1);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0O extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ Context f47223Oooo0o;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0O(Context context) {
            super(0);
            this.f47223Oooo0o = context;
        }
        ...
        public final Unit invoke() {
            try {
                ...
                intent.setData(Uri.fromParts("package", this.f47223Oooo0o.getPackageName(), null));
                this.f47223Oooo0o.startActivity(intent);
            } catch (Exception e) {
                e.printStackTrace();
            }
            return Unit.INSTANCE;
    ...
    public static final class OooOOO0 extends Lambda implements Function2<oOO00O, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ int f47225Oooo0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO0(int i) {
            super(2);
            this.f47225Oooo0oO = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(oOO00O ooo00o, Integer num) {
            num.intValue();
            d5.this.OooO0o(ooo00o, this.f47225Oooo0oO | 1);
            return Unit.INSTANCE;
        }
    }
    ...
    public final void OooO00o(@NotNull o00O0O00 o00o0o01, @Nullable oOO00O ooo00o, int i) {
        ...
        if ((i & 1) == 0 && composer.OooOo0()) {
            ...
            p048OoooooO.o00OOOO0 o00oooo0OooO0O0 = BackgroundKt.OooO0O0(OoooooO.o00OOOO0.OooO00o.f4198Oooo0o, u.OooO0O0(composer).OooOo00(), o000O0Oo.f32099OooO00o);
    ...
    public final void OooO0o(oOO00O ooo00o, int i) {
        ...
        if ((i & 1) == 0 && composer.OooOo0()) {
            ...
            if (!((EventSettingViewModel) viewModel).getHasPermissions().getValue().booleanValue()) {
                ...
                p048OoooooO.o00OOOO0 o00oooo0OooO = PaddingKt.OooO(BackgroundKt.OooO0O0(o00oooo0OooO0o, j, o000O0Oo.f32099OooO00o), ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, 10, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, 13);
                ...
                Objects.requireNonNull(o000000.OooO00o.f26575OooO0Oo);
                Function0<o000000.OooO00o> function0 = o000000.OooO00o.C0279OooO00o.f26577OooO0O0;
                Function3<o0OO00o0<o000000.OooO00o>, oOO00O, Integer, Unit> function3OooO0O0 = o00Oo0.OooO0O0(o00oooo0OooO);
                if (!(composer.OooOo0o() instanceof p100o000oOoO.o00O000)) {
                    o00O00O.OooO00o();
                    throw null;
                }
                ...
                oO00000o.OooO0O0(composer, layoutDirection, o000000.OooO00o.C0279OooO00o.f26580OooO0o);
                ((o00) function3OooO0O0).invoke(Oooo000.OooO0o.OooO00o(composer, o00ooooo2, o000000.OooO00o.C0279OooO00o.f26582OooO0oO, composer, "composer", composer), composer, 0);
                o000O0O0.OooO0OO(OooOOO.OooO00o(composer, 2058660585, -1163856341, R.string.event_setting_enable_desc, composer), null, u.OooO0O0(composer).OooO(), o0000O0O.o00Oo0.OooO0OO(12), null, null, null, 0L, null, null, 0L, 0, false, 0, null, null, composer, 3072, 0, 65522);
                o0O0OOO0.OooO00o(SizeKt.OooO0oO(oooO00o, 14), composer, 6);
                o000O0O0.OooO0OO(o00000.OooO0OO.OooO00o(R.string.event_setting_enable, composer), o000O0o.OooO0O0(PaddingKt.OooO0oO(BackgroundKt.OooO0O0(PaddingKt.OooO0oO(SizeKt.OooO0o(oooO00o), 46, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, 2), o0000O0.f41710OooOo0, o00O0O.f3431OooO00o), ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, 12, 1), false, false, null, new OooOO0O(context), 253), j, o0000O0O.o00Oo0.OooO0OO(15), null, null, null, 0L, null, new o0000O0.OooO0o(3), 0L, 0, false, 0, null, null, composer, 3456, 0, 65008);
                o0O0OOO0.OooO00o(SizeKt.OooO0oO(oooO00o, 19), composer, 6);
    ...
    public final void OooO0o0(oOO00O ooo00o, int i) {
        ...
        if ((i & 1) == 0 && composer.OooOo0()) {
            ...
            o0000O0 o0000o1 = o0000O0.f41691OooO00o;
            float f = 14;
            p048OoooooO.o00OOOO0 o00oooo0OooO0oo = PaddingKt.OooO0oo(BackgroundKt.OooO0O0(o00oooo0OooO0o, o0000O0.f41693OooO0OO, o000O0Oo.f32099OooO00o), f, 12, f, 18);
            composer.OooO0o0(-483455358);
            p028Oooo0o0.o00O000 o00o001 = p028Oooo0o0.o00O000.f2029OooO00o;
            o000000 o000000VarOooO00o = oo00o.OooO00o(p028Oooo0o0.o00O000.f2032OooO0Oo, o00OO0O0.OooO00o.f4182OooOOO, composer);
            composer.OooO0o0(-1323940314);
            ...
            p048OoooooO.o00OOOO0 o00oooo0OooO0O0 = o000O00O.OooO0O0(composer, 2058660585, -1163856341, oooO00o);
            ...
            o000O0O0.OooO0OO(OooOOO.OooO00o(composer, 2058660585, -678309503, R.string.event_setting_auto_add_title, composer), null, u.OooO0O0(composer).OooO0o(), o0000O0O.o00Oo0.OooO0OO(15), null, null, null, 0L, null, null, 0L, 0, false, 0, null, null, composer, 3072, 0, 65522);
            ...
            composer.Oooo0o0();
            composer.Oooo0o0();
            o000O0O0.OooO0OO(o00000.OooO0OO.OooO00o(R.string.event_auto_add_calendar, composer), null, u.OooO0O0(composer).OooO(), o0000O0O.o00Oo0.OooO0OO(12), null, null, null, 0L, null, null, 0L, 0, false, 0, null, null, composer, 3072, 0, 65522);
