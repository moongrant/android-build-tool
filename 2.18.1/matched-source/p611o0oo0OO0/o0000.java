...
public final class o0000 {
    ...
    @NotNull
    public static final o0000 f48362OooO00o = new o0000();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public static final AtomicBoolean f48363OooO0O0 = new AtomicBoolean(false);
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final /* synthetic */ String f48364Oooo;

        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public int f48365Oooo0o;

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ String f48366Oooo0oO;

        /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
        public final /* synthetic */ String f48367Oooo0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(String str, String str2, String str3, Continuation<? super OooO00o> continuation) {
            super(2, continuation);
            this.f48366Oooo0oO = str;
            this.f48367Oooo0oo = str2;
            this.f48364Oooo = str3;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO00o(this.f48366Oooo0oO, this.f48367Oooo0oo, this.f48364Oooo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f48365Oooo0o;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                BuriedPoint buriedPoint = BuriedPoint.Factory.INSTANCE.create(this.f48366Oooo0oO, this.f48367Oooo0oo, this.f48364Oooo);
                Intrinsics.checkNotNullParameter(buriedPoint, "buriedPoint");
                buriedPoint.setEventTime(System.currentTimeMillis());
                p491o0o00O00.OooO0OO.OooO00o().OooOo0o().OooO0O0(buriedPoint);
                o0000 o0000Var = o0000.f48362OooO00o;
                this.f48365Oooo0o = 1;
                if (p491o0o00O00.OooO0OO.OooO00o().OooOo0o().OooO00o() < 50 || (objOooO0O0 = o0000Var.OooO0O0(this)) != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final class OooO0O0 extends ContinuationImpl {
        ...
        /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
        public int f48368Oooo;

        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public Pair f48369Oooo0o;

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public /* synthetic */ Object f48370Oooo0oO;
        ...
        @Nullable
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f48370Oooo0oO = obj;
            this.f48368Oooo |= Integer.MIN_VALUE;
            o0000 o0000Var = o0000.this;
            o0000 o0000Var2 = o0000.f48362OooO00o;
    ...
    public static final class OooO0OO extends ContinuationImpl {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public /* synthetic */ Object f48372Oooo0o;

        /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
        public int f48374Oooo0oo;
        ...
        @Nullable
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f48372Oooo0o = obj;
            this.f48374Oooo0oo |= Integer.MIN_VALUE;
            o0000 o0000Var = o0000.this;
            o0000 o0000Var2 = o0000.f48362OooO00o;
    ...
    public final Object OooO0O0(Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof OooO0O0) {
            ...
            int i = oooO0O0.f48368Oooo;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO0O0.f48368Oooo = i - Integer.MIN_VALUE;
            } else {
        ...
        Object obj = oooO0O0.f48370Oooo0oO;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = oooO0O0.f48368Oooo;
        if (i2 == 0) {
            ResultKt.throwOnFailure(obj);
            if (f48363OooO0O0.get()) {
                return Unit.INSTANCE;
            }
            List<BuriedPoint> listOooO0Oo = p491o0o00O00.OooO0OO.OooO00o().OooOo0o().OooO0Oo();
            ...
            if (((Number) pair.getFirst()).intValue() != -1) {
                ...
                oooO0O0.f48369Oooo0o = pair;
                oooO0O0.f48368Oooo = 1;
        ...
        pair2 = oooO0O0.f48369Oooo0o;
        ResultKt.throwOnFailure(obj);
        if (((Boolean) obj).booleanValue()) {
            p491o0o00O00.OooO0OO.OooO00o().OooOo0o().OooO0OO(((Number) pair2.getFirst()).intValue());
        }
        return Unit.INSTANCE;
    }
    ...
    public final Object OooO0OO(String str, Continuation<? super Boolean> continuation) {
        ...
        if (continuation instanceof OooO0OO) {
            ...
            int i = oooO0OO.f48374Oooo0oo;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO0OO.f48374Oooo0oo = i - Integer.MIN_VALUE;
            } else {
