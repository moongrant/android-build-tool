...
public final class x9 implements o00O0O {

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    @NonNull
    public final LinearLayout f50923OooO;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    @NonNull
    public final LinearLayout f50924OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NonNull
    public final NetImageView f50925OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @NonNull
    public final TextView f50926OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NonNull
    public final TextView f50927OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @NonNull
    public final TextView f50928OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @NonNull
    public final TextView f50929OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    @NonNull
    public final NetImageView f50930OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    @NonNull
    public final ConstraintLayout f50931OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    @NonNull
    public final TextView f50932OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    @NonNull
    public final TextView f50933OooOO0O;

    public x9(@NonNull LinearLayout linearLayout, @NonNull NetImageView netImageView, @NonNull TextView textView, @NonNull TextView textView2, @NonNull TextView textView3, @NonNull TextView textView4, @NonNull NetImageView netImageView2, @NonNull ConstraintLayout constraintLayout, @NonNull LinearLayout linearLayout2, @NonNull TextView textView5, @NonNull TextView textView6) {
        this.f50924OooO00o = linearLayout;
        this.f50925OooO0O0 = netImageView;
        this.f50926OooO0OO = textView;
        this.f50927OooO0Oo = textView2;
        this.f50929OooO0o0 = textView3;
        this.f50928OooO0o = textView4;
        this.f50930OooO0oO = netImageView2;
        this.f50931OooO0oo = constraintLayout;
        this.f50923OooO = linearLayout2;
        this.f50932OooOO0 = textView5;
        this.f50933OooOO0O = textView6;
    }
                                ...
                                if (constraintLayout != null) {
                                    ...
                                    if (linearLayout != null) {
                                        ...
                                        if (textView5 != null) {
                                            ...
                                            if (textView6 != null) {
                                                return new x9((LinearLayout) viewInflate, netImageView, textView, textView2, textView3, textView4, netImageView2, constraintLayout, linearLayout, textView5, textView6);
                                            }
                                        }
                                    }
                                }
