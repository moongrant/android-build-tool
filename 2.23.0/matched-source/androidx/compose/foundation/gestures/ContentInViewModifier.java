...
public final class ContentInViewModifier implements BringIntoViewResponder, OnRemeasuredModifier, OnPlacedModifier {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public static final class C00401 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
            ...
            public C00401(ContentInViewModifier contentInViewModifier, Job job, Continuation<? super C00401> continuation) {
            ...
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                C00401 c00401 = new C00401(this.this$0, this.$animationJob, continuation);
                c00401.L$0 = obj;
                return c00401;
            }
            ...
            public final Object invoke(@NotNull ScrollScope scrollScope, @Nullable Continuation<? super Unit> continuation) {
                return ((C00401) create(scrollScope, continuation)).invokeSuspend(Unit.INSTANCE);
            }
                    ...
                    Function0<Unit> function0 = new Function0<Unit>() { // from class: androidx.compose.foundation.gestures.ContentInViewModifier.launchAnimation.1.1.2
                        ...
                        public final void invoke2() {
                            ...
                            while (true) {
                                ...
                                if (!(rectInvoke == null ? true : ContentInViewModifier.m259isMaxVisibleO0kMr_c$default(contentInViewModifier3, rectInvoke, 0L, 1, null))) {
                                    break;
                                } else {
                                    ((Request) bringIntoViewRequestPriorityQueue.requests.removeAt(bringIntoViewRequestPriorityQueue.requests.getSize() - 1)).getContinuation().resumeWith(Result.m4213constructorimpl(Unit.INSTANCE));
                                }
                            }
                            if (contentInViewModifier2.trackingFocusedChild) {
                                Rect focusedChildBounds = contentInViewModifier2.getFocusedChildBounds();
                                if (focusedChildBounds != null && ContentInViewModifier.m259isMaxVisibleO0kMr_c$default(contentInViewModifier2, focusedChildBounds, 0L, 1, null)) {
            ...
            try {
                try {
                    if (i == 0) {
                        ...
                        C00401 c00401 = new C00401(ContentInViewModifier.this, job, null);
                        this.label = 1;
                        if (OooO0o.OooO0o0(scrollableState, null, c00401, this, 1, null) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    } else {
                        if (i != 1) {
    ...
    public ContentInViewModifier(@NotNull CoroutineScope scope, @NotNull Orientation orientation, @NotNull ScrollableState scrollState, boolean z) {
        ...
        this.viewportSize = IntSize.INSTANCE.m3930getZeroYbymL2g();
    ...
    public final float calculateScrollDelta() {
        if (IntSize.m3923equalsimpl0(this.viewportSize, IntSize.INSTANCE.m3930getZeroYbymL2g())) {
            return 0.0f;
        }
        ...
        long jM3935toSizeozmzZPI = IntSizeKt.m3935toSizeozmzZPI(this.viewportSize);
        int i = WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()];
        if (i == 1) {
            return relocationDistance(rectFindBringIntoViewRequest.getTop(), rectFindBringIntoViewRequest.getBottom(), Size.m1502getHeightimpl(jM3935toSizeozmzZPI));
        }
        if (i == 2) {
            return relocationDistance(rectFindBringIntoViewRequest.getLeft(), rectFindBringIntoViewRequest.getRight(), Size.m1505getWidthimpl(jM3935toSizeozmzZPI));
        }
        throw new NoWhenBranchMatchedException();
    }

    /* JADX INFO: renamed from: compareTo-TemP2vQ, reason: not valid java name */
    private final int m255compareToTemP2vQ(long j, long j2) {
        int i = WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()];
        if (i == 1) {
            return Intrinsics.compare(IntSize.m3924getHeightimpl(j), IntSize.m3924getHeightimpl(j2));
        }
        if (i == 2) {
            return Intrinsics.compare(IntSize.m3925getWidthimpl(j), IntSize.m3925getWidthimpl(j2));
        }
        throw new NoWhenBranchMatchedException();
    }

    /* JADX INFO: renamed from: compareTo-iLBOSCw, reason: not valid java name */
    private final int m256compareToiLBOSCw(long j, long j2) {
        int i = WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()];
        if (i == 1) {
            return Float.compare(Size.m1502getHeightimpl(j), Size.m1502getHeightimpl(j2));
        }
        if (i == 2) {
            return Float.compare(Size.m1505getWidthimpl(j), Size.m1505getWidthimpl(j2));
        }
        throw new NoWhenBranchMatchedException();
    }

    /* JADX INFO: renamed from: computeDestination-O0kMr_c, reason: not valid java name */
    private final Rect m257computeDestinationO0kMr_c(Rect childBounds, long containerSize) {
        return childBounds.m1473translatek4lQ0M(Offset.m1445unaryMinusF1C5BW0(m260relocationOffsetBMxPBkI(childBounds, containerSize)));
    }
    ...
    private final Rect findBringIntoViewRequest() {
        ...
        if (size > 0) {
            ...
            do {
                ...
                if (rectInvoke != null) {
                    if (m256compareToiLBOSCw(rectInvoke.m1469getSizeNHjbRc(), IntSizeKt.m3935toSizeozmzZPI(this.viewportSize)) > 0) {
                        return rect;
                    }
                    rect = rectInvoke;
                }
    ...
    private final boolean m258isMaxVisibleO0kMr_c(Rect rect, long j) {
        return Offset.m1433equalsimpl0(m260relocationOffsetBMxPBkI(rect, j), Offset.INSTANCE.m1452getZeroF1C5BW0());
    }

    /* JADX INFO: renamed from: isMaxVisible-O0kMr_c$default, reason: not valid java name */
    public static /* synthetic */ boolean m259isMaxVisibleO0kMr_c$default(ContentInViewModifier contentInViewModifier, Rect rect, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = contentInViewModifier.viewportSize;
        }
        return contentInViewModifier.m258isMaxVisibleO0kMr_c(rect, j);
    }
    ...
    private final long m260relocationOffsetBMxPBkI(Rect childBounds, long containerSize) {
        long jM3935toSizeozmzZPI = IntSizeKt.m3935toSizeozmzZPI(containerSize);
        int i = WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()];
        if (i == 1) {
            return OffsetKt.Offset(0.0f, relocationDistance(childBounds.getTop(), childBounds.getBottom(), Size.m1502getHeightimpl(jM3935toSizeozmzZPI)));
        }
        if (i == 2) {
            return OffsetKt.Offset(relocationDistance(childBounds.getLeft(), childBounds.getRight(), Size.m1505getWidthimpl(jM3935toSizeozmzZPI)), 0.0f);
        }
        throw new NoWhenBranchMatchedException();
    }
    ...
    public Object bringChildIntoView(@NotNull Function0<Rect> function0, @NotNull Continuation<? super Unit> continuation) throws Throwable {
        ...
        boolean z = false;
        if (rectInvoke != null && !m259isMaxVisibleO0kMr_c$default(this, rectInvoke, 0L, 1, null)) {
            z = true;
        }
        if (!z) {
            return Unit.INSTANCE;
    ...
    public Rect calculateRectForParent(@NotNull Rect localRect) {
        ...
        if (!IntSize.m3923equalsimpl0(this.viewportSize, IntSize.INSTANCE.m3930getZeroYbymL2g())) {
            return m257computeDestinationO0kMr_c(localRect, this.viewportSize);
        }
    ...
    public void mo261onRemeasuredozmzZPI(long size) {
        Rect focusedChildBounds;
        long j = this.viewportSize;
        this.viewportSize = size;
        if (m255compareToTemP2vQ(size, j) < 0 && (focusedChildBounds = getFocusedChildBounds()) != null) {
            Rect rect = this.focusedChildBoundsFromPreviousRemeasure;
            if (rect == null) {
                rect = focusedChildBounds;
            }
            if (!this.isAnimationRunning && !this.trackingFocusedChild && m258isMaxVisibleO0kMr_c(rect, j) && !m258isMaxVisibleO0kMr_c(focusedChildBounds, size)) {
