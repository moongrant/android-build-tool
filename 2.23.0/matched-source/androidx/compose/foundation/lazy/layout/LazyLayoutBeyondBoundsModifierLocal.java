...
public final class LazyLayoutBeyondBoundsModifierLocal implements ModifierLocalProvider<BeyondBoundsLayout>, BeyondBoundsLayout {
    ...
    private final LazyLayoutBeyondBoundsInfo.Interval m624addNextIntervalFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval currentInterval, int direction) {
        int start = currentInterval.getStart();
        int end = currentInterval.getEnd();
        if (m626isForward4vf7U8o(direction)) {
            end++;
        } else {
            start--;
        }
    ...
    public final boolean m625hasMoreContentFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval interval, int i) {
        if (m627isOppositeToOrientation4vf7U8o(i)) {
            return false;
        }
        if (m626isForward4vf7U8o(i)) {
    ...
    private final boolean m626isForward4vf7U8o(int i) {
        BeyondBoundsLayout.LayoutDirection.Companion companion = BeyondBoundsLayout.LayoutDirection.INSTANCE;
        if (BeyondBoundsLayout.LayoutDirection.m2774equalsimpl0(i, companion.m2780getBeforehoxUOeE())) {
            return false;
        }
        if (!BeyondBoundsLayout.LayoutDirection.m2774equalsimpl0(i, companion.m2779getAfterhoxUOeE())) {
            if (BeyondBoundsLayout.LayoutDirection.m2774equalsimpl0(i, companion.m2778getAbovehoxUOeE())) {
                return this.reverseLayout;
            }
            if (BeyondBoundsLayout.LayoutDirection.m2774equalsimpl0(i, companion.m2781getBelowhoxUOeE())) {
                if (this.reverseLayout) {
                    return false;
                }
            } else if (BeyondBoundsLayout.LayoutDirection.m2774equalsimpl0(i, companion.m2782getLefthoxUOeE())) {
                ...
                if (!BeyondBoundsLayout.LayoutDirection.m2774equalsimpl0(i, companion.m2783getRighthoxUOeE())) {
    ...
    private final boolean m627isOppositeToOrientation4vf7U8o(int i) {
        BeyondBoundsLayout.LayoutDirection.Companion companion = BeyondBoundsLayout.LayoutDirection.INSTANCE;
        if (!(BeyondBoundsLayout.LayoutDirection.m2774equalsimpl0(i, companion.m2778getAbovehoxUOeE()) ? true : BeyondBoundsLayout.LayoutDirection.m2774equalsimpl0(i, companion.m2781getBelowhoxUOeE()))) {
            if (!(BeyondBoundsLayout.LayoutDirection.m2774equalsimpl0(i, companion.m2782getLefthoxUOeE()) ? true : BeyondBoundsLayout.LayoutDirection.m2774equalsimpl0(i, companion.m2783getRighthoxUOeE()))) {
                if (!(BeyondBoundsLayout.LayoutDirection.m2774equalsimpl0(i, companion.m2780getBeforehoxUOeE()) ? true : BeyondBoundsLayout.LayoutDirection.m2774equalsimpl0(i, companion.m2779getAfterhoxUOeE()))) {
                    LazyLayoutBeyondBoundsModifierLocalKt.unsupportedDirection();
                    throw new KotlinNothingValueException();
                }
    ...
    public <T> T mo628layouto7g1Pn8(final int direction, @NotNull Function1<? super BeyondBoundsLayout.BeyondBoundsScope, ? extends T> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        if (this.state.getItemCount() <= 0 || !this.state.getHasVisibleItems()) {
            return block.invoke(emptyBeyondBoundsScope);
        }
        int lastPlacedIndex = m626isForward4vf7U8o(direction) ? this.state.getLastPlacedIndex() : this.state.getFirstPlacedIndex();
        final Ref.ObjectRef objectRef = new Ref.ObjectRef();
        objectRef.element = (T) this.beyondBoundsInfo.addInterval(lastPlacedIndex, lastPlacedIndex);
        T tInvoke = null;
        while (tInvoke == null && m625hasMoreContentFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, direction)) {
            T t = (T) m624addNextIntervalFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, direction);
