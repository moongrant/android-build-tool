...
public final class HandlePositionProvider implements PopupPositionProvider {
    ...
    public long mo868calculatePositionllwVHH4(@NotNull IntRect anchorBounds, long windowSize, @NotNull LayoutDirection layoutDirection, long popupContentSize) {
        ...
        if (i == 1) {
            int iM3883getXimpl = IntOffset.m3883getXimpl(this.offset) + anchorBounds.getLeft();
            return OooO0o.OooO00o(this.offset, anchorBounds.getTop(), iM3883getXimpl);
        }
        if (i == 2) {
            int iM3883getXimpl2 = (IntOffset.m3883getXimpl(this.offset) + anchorBounds.getLeft()) - IntSize.m3925getWidthimpl(popupContentSize);
            return OooO0o.OooO00o(this.offset, anchorBounds.getTop(), iM3883getXimpl2);
        }
        if (i != 3) {
            throw new NoWhenBranchMatchedException();
        }
        int iM3883getXimpl3 = (IntOffset.m3883getXimpl(this.offset) + anchorBounds.getLeft()) - (IntSize.m3925getWidthimpl(popupContentSize) / 2);
        return OooO0o.OooO00o(this.offset, anchorBounds.getTop(), iM3883getXimpl3);
    }
