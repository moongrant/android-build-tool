...
public final class SelectionManagerKt {
    ...
    public static final long m919calculateSelectionMagnifierCenterAndroidO0kMr_c(@NotNull SelectionManager manager, long j) {
    ...
    private static final long calculateSelectionMagnifierCenterAndroid_O0kMr_c$getMagnifierCenter(SelectionManager selectionManager, long j, Selection.AnchorInfo anchorInfo, boolean z) {
        ...
        Offset offsetM908getCurrentDragPosition_m7T9E = selectionManager.m908getCurrentDragPosition_m7T9E();
        Intrinsics.checkNotNull(offsetM908getCurrentDragPosition_m7T9E);
        float fM1436getXimpl = Offset.m1436getXimpl(layoutCoordinates.mo2802localPositionOfR5De75A(containerLayoutCoordinates, offsetM908getCurrentDragPosition_m7T9E.getPackedValue()));
        long jMo870getRangeOfLineContainingjx7JFs = anchorSelectable$foundation_release.mo870getRangeOfLineContainingjx7JFs(offset);
        Rect boundingBox = anchorSelectable$foundation_release.getBoundingBox(TextRange.m3308getMinimpl(jMo870getRangeOfLineContainingjx7JFs));
        Rect boundingBox2 = anchorSelectable$foundation_release.getBoundingBox(RangesKt.coerceAtLeast(TextRange.m3307getMaximpl(jMo870getRangeOfLineContainingjx7JFs) - 1, TextRange.m3308getMinimpl(jMo870getRangeOfLineContainingjx7JFs)));
        float fCoerceIn = RangesKt.coerceIn(fM1436getXimpl, Math.min(boundingBox.getLeft(), boundingBox2.getLeft()), Math.max(boundingBox.getRight(), boundingBox2.getRight()));
        return Math.abs(fM1436getXimpl - fCoerceIn) > ((float) (IntSize.m3925getWidthimpl(j) / 2)) ? Offset.INSTANCE.m1451getUnspecifiedF1C5BW0() : containerLayoutCoordinates.mo2802localPositionOfR5De75A(layoutCoordinates, OffsetKt.Offset(fCoerceIn, Offset.m1437getYimpl(anchorSelectable$foundation_release.getBoundingBox(offset).m1466getCenterF1C5BW0())));
    }

    /* JADX INFO: renamed from: containsInclusive-Uv8p0NA, reason: not valid java name */
    public static final boolean m920containsInclusiveUv8p0NA(@NotNull Rect containsInclusive, long j) {
    ...
    public static final Rect visibleBounds(@NotNull LayoutCoordinates layoutCoordinates) {
        ...
        return RectKt.m1474Rect0a9Yr6o(layoutCoordinates.mo2806windowToLocalMKHz9U(rectBoundsInWindow.m1471getTopLeftF1C5BW0()), layoutCoordinates.mo2806windowToLocalMKHz9U(rectBoundsInWindow.m1465getBottomRightF1C5BW0()));
    }
}
