...
public final class LayoutNode implements ComposeNodeLifecycleCallback, Remeasurement, OwnerScope, LayoutInfo, ComposeUiNode, InteroperableComposeUiNode, Owner.OnLayoutCompletedListener {
    ...
    private static final NoIntrinsicsMeasurePolicy ErrorMeasurePolicy = new NoIntrinsicsMeasurePolicy() { // from class: androidx.compose.ui.node.LayoutNode$Companion$ErrorMeasurePolicy$1
        ...
        public /* bridge */ /* synthetic */ MeasureResult mo3measure3p2s80s(MeasureScope measureScope, List list, long j) {
            return (MeasureResult) m2924measure3p2s80s(measureScope, (List<? extends Measurable>) list, j);
        }

        @NotNull
        /* JADX INFO: renamed from: measure-3p2s80s, reason: not valid java name */
        public Void m2924measure3p2s80s(@NotNull MeasureScope measure, @NotNull List<? extends Measurable> measurables, long j) {
    ...
    private static final ViewConfiguration DummyViewConfiguration = new ViewConfiguration() { // from class: androidx.compose.ui.node.LayoutNode$Companion$DummyViewConfiguration$1
        ...
        public long mo2923getMinimumTouchTargetSizeMYxV2XQ() {
            return DpSize.INSTANCE.m3873getZeroMYxV2XQ();
        }
    ...
    @NotNull
    private static final Comparator<LayoutNode> ZComparator = new OooO0o();
    ...
    public static abstract class NoIntrinsicsMeasurePolicy implements MeasurePolicy {
        ...
        public /* bridge */ /* synthetic */ int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m2925maxIntrinsicHeight(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m2926maxIntrinsicWidth(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m2927minIntrinsicHeight(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m2928minIntrinsicWidth(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        @NotNull
        /* JADX INFO: renamed from: maxIntrinsicHeight, reason: collision with other method in class */
        public Void m2925maxIntrinsicHeight(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull List<? extends IntrinsicMeasurable> measurables, int i) {
        ...
        public Void m2926maxIntrinsicWidth(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull List<? extends IntrinsicMeasurable> measurables, int i) {
            Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
            Intrinsics.checkNotNullParameter(measurables, "measurables");
            throw new IllegalStateException(this.error.toString());
        }
        ...
        public Void m2927minIntrinsicHeight(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull List<? extends IntrinsicMeasurable> measurables, int i) {
            Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
            Intrinsics.checkNotNullParameter(measurables, "measurables");
            throw new IllegalStateException(this.error.toString());
        }
        ...
        public Void m2928minIntrinsicWidth(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull List<? extends IntrinsicMeasurable> measurables, int i) {
            Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
            Intrinsics.checkNotNullParameter(measurables, "measurables");
            throw new IllegalStateException(this.error.toString());
        }
    ...
    public static /* synthetic */ void m2915hitTestM_7yMNQ$ui_release$default(LayoutNode layoutNode, long j, HitTestResult hitTestResult, boolean z, boolean z2, int i, Object obj) {
        if ((i & 4) != 0) {
            z = false;
        }
        boolean z3 = z;
        ...
        layoutNode.m2919hitTestM_7yMNQ$ui_release(j, hitTestResult, z3, z2);
    }

    private final void invalidateFocusOnAttach() {
        if (this.nodes.has$ui_release(NodeKind.m2994constructorimpl(LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) | NodeKind.m2994constructorimpl(2048) | NodeKind.m2994constructorimpl(4096))) {
            for (Modifier.Node head = this.nodes.getHead(); head != null; head = head.getChild()) {
                if (((NodeKind.m2994constructorimpl(LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) & head.getKindSet()) != 0) | ((NodeKind.m2994constructorimpl(2048) & head.getKindSet()) != 0) | ((NodeKind.m2994constructorimpl(4096) & head.getKindSet()) != 0)) {
    ...
    private final void invalidateFocusOnDetach() {
        ...
        if ((nodeChain.getAggregateChildKindSet() & iM2994constructorimpl) != 0) {
            for (Modifier.Node tail = nodeChain.getTail(); tail != null; tail = tail.getParent()) {
                if ((tail.getKindSet() & iM2994constructorimpl) != 0) {
    ...
    public static /* synthetic */ boolean m2917lookaheadRemeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i, Object obj) {
        if ((i & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m2936getLastLookaheadConstraintsDWUhwKw();
        }
        return layoutNode.m2921lookaheadRemeasure_Sx5XlM$ui_release(constraints);
    }
    ...
    public static /* synthetic */ boolean m2918remeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i, Object obj) {
        if ((i & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m2935getLastConstraintsDWUhwKw();
        }
        return layoutNode.m2922remeasure_Sx5XlM$ui_release(constraints);
    }
    ...
    private final boolean shouldInvalidateParentLayer() {
        if (this.nodes.m2957hasH91voCI$ui_release(NodeKind.m2994constructorimpl(4)) && !this.nodes.m2957hasH91voCI$ui_release(NodeKind.m2994constructorimpl(2))) {
            return true;
        }
        for (Modifier.Node head = this.nodes.getHead(); head != null; head = head.getChild()) {
            if (((NodeKind.m2994constructorimpl(2) & head.getKindSet()) != 0) && DelegatableNodeKt.m2893requireCoordinator64DMado(head, NodeKind.m2994constructorimpl(2)).getLayer() != null) {
                return false;
            }
            if ((NodeKind.m2994constructorimpl(4) & head.getKindSet()) != 0) {
                return true;
            }
        }
        return true;
    ...
    public final void attach$ui_release(@NotNull Owner owner) {
        ...
        if (this.nodes.m2957hasH91voCI$ui_release(NodeKind.m2994constructorimpl(8))) {
    ...
    public final void dispatchOnPositionedCallbacks$ui_release() {
        ...
        L3c:
            ...
            int r6 = androidx.compose.ui.node.NodeKind.m2994constructorimpl(r1)
            androidx.compose.ui.node.NodeCoordinator r6 = androidx.compose.ui.node.DelegatableNodeKt.m2893requireCoordinator64DMado(r4, r6)
    ...
    public void forceRemeasure() {
        ...
        Constraints constraintsM2935getLastConstraintsDWUhwKw = this.layoutDelegate.m2935getLastConstraintsDWUhwKw();
        if (constraintsM2935getLastConstraintsDWUhwKw != null) {
            Owner owner = this.owner;
            if (owner != null) {
                owner.mo3049measureAndLayout0kLqBqw(this, constraintsM2935getLastConstraintsDWUhwKw.getValue());
                return;
            }
            return;
        }
    ...
    public final SemanticsConfiguration getCollapsedSemantics$ui_release() {
        if (!this.nodes.m2957hasH91voCI$ui_release(NodeKind.m2994constructorimpl(8)) || this._collapsedSemantics != null) {
        ...
        LayoutNodeKt.requireOwner(this).getSnapshotObserver().observeSemanticsReads$ui_release(this, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNode$collapsedSemantics$1
            ...
            public final void invoke2() {
                /*
                    ...
                    r1 = 8
                    int r1 = androidx.compose.ui.node.NodeKind.m2994constructorimpl(r1)
    ...
    public final boolean getHasFixedInnerContentConstraints$ui_release() {
        long jM2978getLastMeasurementConstraintsmsEJaDk$ui_release = getInnerCoordinator$ui_release().m2978getLastMeasurementConstraintsmsEJaDk$ui_release();
        return Constraints.m3731getHasFixedWidthimpl(jM2978getLastMeasurementConstraintsmsEJaDk$ui_release) && Constraints.m3730getHasFixedHeightimpl(jM2978getLastMeasurementConstraintsmsEJaDk$ui_release);
    }
    ...
    public final void m2919hitTestM_7yMNQ$ui_release(long pointerPosition, @NotNull HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        Intrinsics.checkNotNullParameter(hitTestResult, "hitTestResult");
        getOuterCoordinator$ui_release().m2981hitTestYqVAtuI(NodeCoordinator.INSTANCE.getPointerInputSource(), getOuterCoordinator$ui_release().m2977fromParentPositionMKHz9U(pointerPosition), hitTestResult, isTouchEvent, isInLayer);
    }

    /* JADX INFO: renamed from: hitTestSemantics-M_7yMNQ$ui_release, reason: not valid java name */
    public final void m2920hitTestSemanticsM_7yMNQ$ui_release(long pointerPosition, @NotNull HitTestResult hitSemanticsEntities, boolean isTouchEvent, boolean isInLayer) {
        Intrinsics.checkNotNullParameter(hitSemanticsEntities, "hitSemanticsEntities");
        getOuterCoordinator$ui_release().m2981hitTestYqVAtuI(NodeCoordinator.INSTANCE.getSemanticsSource(), getOuterCoordinator$ui_release().m2977fromParentPositionMKHz9U(pointerPosition), hitSemanticsEntities, true, isInLayer);
    }
    ...
    public final void invalidateSubtree(boolean r11) {
        ...
        Lb:
            ...
            r2 = 2
            int r3 = androidx.compose.ui.node.NodeKind.m2994constructorimpl(r2)
        ...
        L32:
            ...
            int r7 = androidx.compose.ui.node.NodeKind.m2994constructorimpl(r2)
            androidx.compose.ui.node.NodeCoordinator r4 = androidx.compose.ui.node.DelegatableNodeKt.m2893requireCoordinator64DMado(r4, r7)
    ...
    public final boolean m2921lookaheadRemeasure_Sx5XlM$ui_release(@Nullable Constraints constraints) {
        if (constraints == null || this.lookaheadRoot == null) {
            return false;
        }
        LayoutNodeLayoutDelegate.LookaheadPassDelegate lookaheadPassDelegate$ui_release = getLookaheadPassDelegate$ui_release();
        Intrinsics.checkNotNull(lookaheadPassDelegate$ui_release);
        return lookaheadPassDelegate$ui_release.m2939remeasureBRTryo0(constraints.getValue());
    }
    ...
    public void onLayoutComplete() {
        /*
            ...
            int r1 = androidx.compose.ui.node.NodeKind.m2994constructorimpl(r1)
            boolean r2 = androidx.compose.ui.node.NodeKindKt.m3003getIncludeSelfInTraversalH91voCI(r1)
    ...
    public final boolean m2922remeasure_Sx5XlM$ui_release(@Nullable Constraints constraints) {
        if (constraints == null) {
            return false;
        }
        if (this.intrinsicsUsageByParent == UsageByParent.NotUsed) {
        ...
        return getMeasurePassDelegate$ui_release().m2942remeasureBRTryo0(constraints.getValue());
    }
    ...
    public void setModifier(@NotNull Modifier value) {
        ...
        this.layoutDelegate.updateParentData();
        if (this.nodes.m2957hasH91voCI$ui_release(NodeKind.m2994constructorimpl(ConstantsKt.MINIMUM_BLOCK_SIZE)) && this.lookaheadRoot == null) {
            setLookaheadRoot(this);
        }
    }
