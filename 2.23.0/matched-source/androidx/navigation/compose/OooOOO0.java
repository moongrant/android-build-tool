...
public final class OooOOO0 extends Lambda implements Function1<DisposableEffectScope, DisposableEffectResult> {
    ...
    public final /* synthetic */ OooOo00 f7028OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ NavBackStackEntry f7029OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooOOO0(OooOo00 oooOo00, NavBackStackEntry navBackStackEntry) {
        super(1);
        this.f7028OooO0Oo = oooOo00;
        this.f7029OooO0o0 = navBackStackEntry;
    }

    @Override // kotlin.jvm.functions.Function1
    public final DisposableEffectResult invoke(DisposableEffectScope disposableEffectScope) {
        return new OooOO0O(this.f7028OooO0Oo, this.f7029OooO0o0);
    }
}
