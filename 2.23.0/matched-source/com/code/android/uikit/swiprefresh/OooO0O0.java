...
public final class OooO0O0 {
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final /* synthetic */ float f10179OooO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f10180OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ RefreshState f10181OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f10182OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ LazyListState f10183OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ long f10184OooO0oo;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public final /* synthetic */ long f10185OooOO0;

        /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
        public final /* synthetic */ Function0<Unit> f10186OooOO0O;

        /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f10187OooOO0o;
        ...
        public static final class C0178OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {

            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public int f10188OooO0Oo;

            public C0178OooO00o(Continuation<? super C0178OooO00o> continuation) {
            ...
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                return new C0178OooO00o(continuation);
            }

            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
                return new C0178OooO00o(continuation).invokeSuspend(Unit.INSTANCE);
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                int i = this.f10188OooO0Oo;
                if (i == 0) {
                    ResultKt.throwOnFailure(obj);
                    this.f10188OooO0Oo = 1;
        ...
        public /* synthetic */ class C0179OooO0O0 {
        ...
        public OooO00o(RefreshState refreshState, LazyListState lazyListState, long j, float f, long j2, Function0<Unit> function0, MutableState<Boolean> mutableState, Continuation<? super OooO00o> continuation) {
            super(2, continuation);
            this.f10181OooO0o = refreshState;
            this.f10183OooO0oO = lazyListState;
            this.f10184OooO0oo = j;
            this.f10179OooO = f;
            this.f10185OooOO0 = j2;
            this.f10186OooOO0O = function0;
            this.f10187OooOO0o = mutableState;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO00o oooO00o = new OooO00o(this.f10181OooO0o, this.f10183OooO0oO, this.f10184OooO0oo, this.f10179OooO, this.f10185OooOO0, this.f10186OooOO0O, this.f10187OooOO0o, continuation);
            oooO00o.f10182OooO0o0 = obj;
            return oooO00o;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            long j = this.f10184OooO0oo;
            LazyListState lazyListState = this.f10183OooO0oO;
            RefreshState refreshState = this.f10181OooO0o;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                CoroutineScope scope2 = (CoroutineScope) this.f10182OooO0o0;
                int i2 = C0179OooO0O0.$EnumSwitchMapping$0[refreshState.OooO0OO().ordinal()];
                MutableState<Boolean> mutableState = this.f10187OooOO0o;
                if (i2 == 1) {
                    ...
                    if (lazyListState != null) {
                        ...
                        BuildersKt__Builders_commonKt.launch$default(scope2, null, null, new p153o00OoO0.OooO0o(lazyListState, null), 3, null);
                    }
                    this.f10182OooO0o0 = scope2;
                    ...
                    if (lazyListState != null) {
                        ...
                        BuildersKt__Builders_commonKt.launch$default(scope, null, null, new OooO(lazyListState, null), 3, null);
                    }
                    refreshState.OooO0o0(RefreshState.State.Null);
                } else if (i2 == 3) {
                    CoroutineDispatcher io2 = Dispatchers.getIO();
                    C0178OooO00o c0178OooO00o = new C0178OooO00o(null);
                    this.f10180OooO0Oo = 2;
                    if (BuildersKt.withContext(io2, c0178OooO00o, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    this.f10180OooO0Oo = 3;
                    if (refreshState.OooO00o(0.0f, j, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    refreshState.OooO0o0(RefreshState.State.Null);
                    ...
                    this.f10180OooO0Oo = 4;
                    if (refreshState.OooO00o(this.f10179OooO, this.f10185OooOO0, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    this.f10186OooOO0O.invoke();
                }
            } else if (i != 1) {
                if (i == 2) {
                    ResultKt.throwOnFailure(obj);
                ...
                CoroutineScope coroutineScope = (CoroutineScope) this.f10182OooO0o0;
                ResultKt.throwOnFailure(obj);
    ...
    public static final class C0180OooO0O0 extends Lambda implements Function2<Composer, Integer, Unit> {

        /* JADX INFO: renamed from: OooO, reason: collision with root package name */
        public final /* synthetic */ boolean f10189OooO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ RefreshState f10190OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ Function0<Unit> f10191OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ float f10192OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ Modifier f10193OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ LazyListState f10194OooO0oo;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public final /* synthetic */ boolean f10195OooOO0;

        /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
        public final /* synthetic */ float f10196OooOO0O;

        /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
        public final /* synthetic */ long f10197OooOO0o;

        /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
        public final /* synthetic */ Function6<BoxScope, RefreshState.State, Dp, Function2<? super Composer, ? super Integer, Unit>, Composer, Integer, Unit> f10198OooOOO;

        /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
        public final /* synthetic */ long f10199OooOOO0;

        /* JADX INFO: renamed from: OooOOOO, reason: collision with root package name */
        public final /* synthetic */ Function2<Composer, Integer, Unit> f10200OooOOOO;

        /* JADX INFO: renamed from: OooOOOo, reason: collision with root package name */
        public final /* synthetic */ int f10201OooOOOo;

        /* JADX INFO: renamed from: OooOOo, reason: collision with root package name */
        public final /* synthetic */ int f10202OooOOo;

        /* JADX INFO: renamed from: OooOOo0, reason: collision with root package name */
        public final /* synthetic */ int f10203OooOOo0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C0180OooO0O0(RefreshState refreshState, float f, Function0<Unit> function0, Modifier modifier, LazyListState lazyListState, boolean z, boolean z2, float f2, long j, long j2, Function6<? super BoxScope, ? super RefreshState.State, ? super Dp, ? super Function2<? super Composer, ? super Integer, Unit>, ? super Composer, ? super Integer, Unit> function6, Function2<? super Composer, ? super Integer, Unit> function2, int i, int i2, int i3) {
            super(2);
            this.f10190OooO0Oo = refreshState;
            this.f10192OooO0o0 = f;
            this.f10191OooO0o = function0;
            this.f10193OooO0oO = modifier;
            this.f10194OooO0oo = lazyListState;
            this.f10189OooO = z;
            this.f10195OooOO0 = z2;
            this.f10196OooOO0O = f2;
            this.f10197OooOO0o = j;
            this.f10199OooOOO0 = j2;
            this.f10198OooOOO = function6;
            this.f10200OooOOOO = function2;
            this.f10201OooOOOo = i;
            this.f10203OooOOo0 = i2;
            this.f10202OooOOo = i3;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            OooO0O0.OooO00o(this.f10190OooO0Oo, this.f10192OooO0o0, this.f10191OooO0o, this.f10193OooO0oO, this.f10194OooO0oo, this.f10189OooO, this.f10195OooOO0, this.f10196OooOO0O, this.f10197OooOO0o, this.f10199OooOOO0, this.f10198OooOOO, this.f10200OooOOOO, composer, RecomposeScopeImplKt.updateChangedFlags(this.f10201OooOOOo | 1), RecomposeScopeImplKt.updateChangedFlags(this.f10203OooOOo0), this.f10202OooOOo);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0OO extends Lambda implements Function6<BoxScope, RefreshState.State, Dp, Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ RefreshState f10204OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f10205OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ Function5<BoxScope, RefreshState.State, Dp, Composer, Integer, Unit> f10206OooO0o0;
        ...
        public OooO0OO(RefreshState refreshState, Function5<? super BoxScope, ? super RefreshState.State, ? super Dp, ? super Composer, ? super Integer, Unit> function5, int i) {
            super(6);
            this.f10204OooO0Oo = refreshState;
            this.f10206OooO0o0 = function5;
            this.f10205OooO0o = i;
        }
        ...
        public final Unit invoke(BoxScope boxScope, RefreshState.State state, Dp dp, Function2<? super Composer, ? super Integer, ? extends Unit> function2, Composer composer, Integer num) {
            ...
            if ((46801 & i) == 9360 && composer2.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(1221294851, i, -1, "com.code.android.uikit.swiprefresh.EasyRefresh.<anonymous> (EasySwipeRefresh.kt:56)");
                }
                Modifier.Companion companion = Modifier.INSTANCE;
                Modifier modifierM437offsetVpY3zN4$default = OffsetKt.m437offsetVpY3zN4$default(companion, 0.0f, fM3779unboximpl, 1, null);
                ...
                androidx.compose.material.OooO0O0.OooO00o((i >> 9) & 14, _content, composer2);
                if (this.f10204OooO0Oo.OooO0OO() != RefreshState.State.Null) {
                    Modifier modifierFillMaxWidth$default = SizeKt.fillMaxWidth$default(ClipKt.clipToBounds(SizeKt.m509height3ABfNKs(companion, fM3779unboximpl)), 0.0f, 1, null);
                    Alignment bottomCenter = companion2.getBottomCenter();
                    Function5<BoxScope, RefreshState.State, Dp, Composer, Integer, Unit> function5 = this.f10206OooO0o0;
                    composer2.startReplaceableGroup(733328855);
                    ...
                    function5.invoke(boxScopeInstance, _state, Dp.m3763boximpl(fM3779unboximpl), composer2, Integer.valueOf((i & 896) | (i & 112) | 6 | ((this.f10205OooO0o << 9) & 7168)));
    ...
    public static final class OooO0o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO, reason: collision with root package name */
        public final /* synthetic */ boolean f10207OooO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ RefreshState f10208OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ Function0<Unit> f10209OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ float f10210OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ Modifier f10211OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ LazyListState f10212OooO0oo;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public final /* synthetic */ boolean f10213OooOO0;

        /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
        public final /* synthetic */ float f10214OooOO0O;

        /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
        public final /* synthetic */ long f10215OooOO0o;

        /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
        public final /* synthetic */ Function5<BoxScope, RefreshState.State, Dp, Composer, Integer, Unit> f10216OooOOO;

        /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
        public final /* synthetic */ long f10217OooOOO0;

        /* JADX INFO: renamed from: OooOOOO, reason: collision with root package name */
        public final /* synthetic */ Function2<Composer, Integer, Unit> f10218OooOOOO;

        /* JADX INFO: renamed from: OooOOOo, reason: collision with root package name */
        public final /* synthetic */ int f10219OooOOOo;

        /* JADX INFO: renamed from: OooOOo, reason: collision with root package name */
        public final /* synthetic */ int f10220OooOOo;

        /* JADX INFO: renamed from: OooOOo0, reason: collision with root package name */
        public final /* synthetic */ int f10221OooOOo0;
        ...
        public OooO0o(RefreshState refreshState, float f, Function0<Unit> function0, Modifier modifier, LazyListState lazyListState, boolean z, boolean z2, float f2, long j, long j2, Function5<? super BoxScope, ? super RefreshState.State, ? super Dp, ? super Composer, ? super Integer, Unit> function5, Function2<? super Composer, ? super Integer, Unit> function2, int i, int i2, int i3) {
            super(2);
            this.f10208OooO0Oo = refreshState;
            this.f10210OooO0o0 = f;
            this.f10209OooO0o = function0;
            this.f10211OooO0oO = modifier;
            this.f10212OooO0oo = lazyListState;
            this.f10207OooO = z;
            this.f10213OooOO0 = z2;
            this.f10214OooOO0O = f2;
            this.f10215OooOO0o = j;
            this.f10217OooOOO0 = j2;
            this.f10216OooOOO = function5;
            this.f10218OooOOOO = function2;
            this.f10219OooOOOo = i;
            this.f10221OooOOo0 = i2;
            this.f10220OooOOo = i3;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            OooO0O0.OooO0O0(this.f10208OooO0Oo, this.f10210OooO0o0, this.f10209OooO0o, this.f10211OooO0oO, this.f10212OooO0oo, this.f10207OooO, this.f10213OooOO0, this.f10214OooOO0O, this.f10215OooOO0o, this.f10217OooOOO0, this.f10216OooOOO, this.f10218OooOOOO, composer, RecomposeScopeImplKt.updateChangedFlags(this.f10219OooOOOo | 1), RecomposeScopeImplKt.updateChangedFlags(this.f10221OooOOo0), this.f10220OooOOo);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final void OooO00o(@NotNull RefreshState refreshState, float f, @NotNull Function0<Unit> onRefresh, @Nullable Modifier modifier, @Nullable LazyListState lazyListState, boolean z, boolean z2, float f2, long j, long j2, @NotNull Function6<? super BoxScope, ? super RefreshState.State, ? super Dp, ? super Function2<? super Composer, ? super Integer, Unit>, ? super Composer, ? super Integer, Unit> refreshIndicator, @NotNull Function2<? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, int i, int i2, int i3) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1177741051, i, i2, "com.code.android.uikit.swiprefresh.BasicRefresh (EasySwipeRefresh.kt:90)");
        }
        float fMo324toPx0680j_4 = ((Density) composerStartRestartGroup.consume(CompositionLocalsKt.getLocalDensity())).mo324toPx0680j_4(f);
        ...
        oooO0OO2.f10226OooO0oo = fMo324toPx0680j_4;
        composerStartRestartGroup.startReplaceableGroup(-492369756);
        ...
        EffectsKt.LaunchedEffect(refreshState.OooO0OO(), new OooO00o(refreshState, lazyListState2, j4, fMo324toPx0680j_4, j3, onRefresh, mutableState, null), composerStartRestartGroup, 64);
        ...
        float fM3765constructorimpl = !z3 ? Dp.m3765constructorimpl(0) : ((Density) composerStartRestartGroup.consume(CompositionLocalsKt.getLocalDensity())).mo320toDpu2uoSUM(refreshState.OooO0O0());
        composerStartRestartGroup.endReplaceableGroup();
        refreshIndicator.invoke(boxScopeInstance, refreshState.OooO0OO(), Dp.m3763boximpl(fM3765constructorimpl), content, composerStartRestartGroup, Integer.valueOf(((i2 << 6) & 7168) | 6 | ((i2 << 12) & 57344)));
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new C0180OooO0O0(refreshState, f, onRefresh, modifier3, lazyListState2, z3, z4, f4, j3, j4, refreshIndicator, content, i, i2, i3));
    }
    ...
    public static final void OooO0O0(@NotNull RefreshState refreshState, float f, @NotNull Function0<Unit> onRefresh, @Nullable Modifier modifier, @Nullable LazyListState lazyListState, boolean z, boolean z2, float f2, long j, long j2, @NotNull Function5<? super BoxScope, ? super RefreshState.State, ? super Dp, ? super Composer, ? super Integer, Unit> refreshIndicator, @NotNull Function2<? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, int i, int i2, int i3) {
        ...
        long j4 = (i3 & ConstantsKt.MINIMUM_BLOCK_SIZE) != 0 ? 300L : j2;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-388061258, i, i2, "com.code.android.uikit.swiprefresh.EasyRefresh (EasySwipeRefresh.kt:32)");
        }
