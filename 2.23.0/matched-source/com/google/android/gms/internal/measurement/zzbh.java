...
public final class zzbh extends zzaw {
    public zzbh() {
        this.f15666OooO00o.add(zzbl.FOR_IN);
        this.f15666OooO00o.add(zzbl.FOR_IN_CONST);
        this.f15666OooO00o.add(zzbl.FOR_IN_LET);
        this.f15666OooO00o.add(zzbl.FOR_LET);
        this.f15666OooO00o.add(zzbl.FOR_OF);
        this.f15666OooO00o.add(zzbl.FOR_OF_CONST);
        this.f15666OooO00o.add(zzbl.FOR_OF_LET);
        this.f15666OooO00o.add(zzbl.WHILE);
    }
