...
public class AppMeasurementSdk {
    ...
    public final zzef f15869OooO00o;
    ...
    public void beginAdUnitExposure(@NonNull @Size(min = 1) String str) {
        this.f15869OooO00o.zzv(str);
    }

    @KeepForSdk
    public void clearConditionalUserProperty(@NonNull @Size(max = 24, min = 1) String str, @Nullable String str2, @Nullable Bundle bundle) {
        this.f15869OooO00o.zzw(str, str2, bundle);
    }

    @KeepForSdk
    public void endAdUnitExposure(@NonNull @Size(min = 1) String str) {
        this.f15869OooO00o.zzx(str);
    }

    @KeepForSdk
    public long generateEventId() {
        return this.f15869OooO00o.zzb();
    }

    @Nullable
    @KeepForSdk
    public String getAppIdOrigin() {
        return this.f15869OooO00o.zzk();
    }

    @Nullable
    @KeepForSdk
    public String getAppInstanceId() {
        return this.f15869OooO00o.zzm();
    }
    ...
    public List<Bundle> getConditionalUserProperties(@Nullable String str, @Nullable @Size(max = 23, min = 1) String str2) {
        return this.f15869OooO00o.zzq(str, str2);
    }

    @Nullable
    @KeepForSdk
    public String getCurrentScreenClass() {
        return this.f15869OooO00o.zzn();
    }

    @Nullable
    @KeepForSdk
    public String getCurrentScreenName() {
        return this.f15869OooO00o.zzo();
    }

    @Nullable
    @KeepForSdk
    public String getGmpAppId() {
        return this.f15869OooO00o.zzp();
    }

    @KeepForSdk
    @WorkerThread
    public int getMaxUserProperties(@NonNull @Size(min = 1) String str) {
        return this.f15869OooO00o.zza(str);
    }
    ...
    public void setEventInterceptor(@NonNull EventInterceptor eventInterceptor) {
        this.f15869OooO00o.zzK(eventInterceptor);
    }

    @KeepForSdk
    public void setMeasurementEnabled(@Nullable Boolean bool) {
        this.f15869OooO00o.zzL(bool);
    }

    @KeepForSdk
    public void setUserProperty(@NonNull String str, @NonNull String str2, @NonNull Object obj) {
        this.f15869OooO00o.zzO(str, str2, obj, true);
    }

    @ShowFirstParty
    @KeepForSdk
    public void unregisterOnMeasurementEventListener(@NonNull OnEventListener onEventListener) {
        this.f15869OooO00o.zzP(onEventListener);
    }

    public final void zza(boolean z) {
        this.f15869OooO00o.zzI(z);
    }

    @KeepForSdk
    public void setMeasurementEnabled(boolean z) {
        this.f15869OooO00o.zzL(Boolean.valueOf(z));
    }
