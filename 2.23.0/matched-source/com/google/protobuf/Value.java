...
public final class Value extends GeneratedMessageV3 implements ValueOrBuilder {
    ...
    public int hashCode() {
        ...
        switch (this.kindCase_) {
            case 1:
                iOooO00o = o000000O.OooO00o(iHashCode, 37, 1, 53);
                nullValueValue = getNullValueValue();
                break;
            case 2:
                iOooO00o = o000000O.OooO00o(iHashCode, 37, 2, 53);
                nullValueValue = Internal.hashLong(Double.doubleToLongBits(getNumberValue()));
                break;
            case 3:
                iOooO00o = o000000O.OooO00o(iHashCode, 37, 3, 53);
                nullValueValue = getStringValue().hashCode();
                break;
            case 4:
                iOooO00o = o000000O.OooO00o(iHashCode, 37, 4, 53);
                nullValueValue = Internal.hashBoolean(getBoolValue());
                break;
            case 5:
                iOooO00o = o000000O.OooO00o(iHashCode, 37, 5, 53);
                nullValueValue = getStructValue().hashCode();
                break;
            case 6:
                iOooO00o = o000000O.OooO00o(iHashCode, 37, 6, 53);
