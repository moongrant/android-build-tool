...
public final class EventDetailViewModel extends EventViewModel {
    ...
    @NotNull
    private final p143o00Oo000.OooO0O0<UserInfoModel> getSubsPage;
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public ApiResult f24080OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public int f24082OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ MutableSharedFlow<ApiResult<String>> f24083OooO0oO;
        ...
        public OooO00o(MutableSharedFlow<ApiResult<String>> mutableSharedFlow, Continuation<? super OooO00o> continuation) {
            ...
            this.f24083OooO0oO = mutableSharedFlow;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return EventDetailViewModel.this.new OooO00o(this.f24083OooO0oO, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f24082OooO0o0;
            EventDetailViewModel eventDetailViewModel = EventDetailViewModel.this;
            if (i != 0) {
                if (i == 1) {
                    ResultKt.throwOnFailure(obj);
                } else if (i == 2) {
                    apiResult = this.f24080OooO0Oo;
                    ResultKt.throwOnFailure(obj);
                    this.f24080OooO0Oo = null;
                    this.f24082OooO0o0 = 3;
                    if (this.f24083OooO0oO.emit(apiResult, this) == coroutine_suspended) {
            ...
            this.f24082OooO0o0 = 1;
            String strOooO0O0 = o000OOo0.OooO0O0("/Webservers/Event/Delete");
            o0O0ooO o0o0oooOooO00o = o00oOoo.OooO00o(strOooO0O0, "url", strOooO0O0, 1);
            o0o0oooOooO00o.OooO0O0(Boxing.boxLong(id), "eventId");
            obj = OooOOO.OooO0Oo(new EventRepo$delete$$inlined$call$1(o0o0oooOooO00o, null), this);
            ...
            if (apiResult.isSuccess()) {
                ...
                this.f24080OooO0Oo = apiResult;
                this.f24082OooO0o0 = 2;
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f24084OooO0Oo;
            EventDetailViewModel eventDetailViewModel = EventDetailViewModel.this;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                long id = eventDetailViewModel.get_eventModel().getId();
                this.f24084OooO0Oo = 1;
                String strOooO0O0 = o000OOo0.OooO0O0("/Webservers/Event/GetInfo");
                o0O0ooO o0o0oooOooO00o = o00oOoo.OooO00o(strOooO0O0, "url", strOooO0O0, 0);
                o0o0oooOooO00o.OooO0O0(Boxing.boxLong(id), "eventid");
                obj = OooOOO.OooO0Oo(new EventRepo$detail$$inlined$call$1(o0o0oooOooO00o, null), this);
                if (obj == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<Integer, Continuation<? super OooO<UserInfoModel>>, Object> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f24086OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ int f24088OooO0o0;
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            ...
            oooO0OO.f24088OooO0o0 = ((Number) obj).intValue();
            return oooO0OO;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Integer num, Continuation<? super OooO<UserInfoModel>> continuation) {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f24086OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                int i2 = this.f24088OooO0o0;
                long id = EventDetailViewModel.this.getEventModel().getId();
                this.f24086OooO0Oo = 1;
                String strOooO0O0 = o000OOo0.OooO0O0("Webservers/Event/GetSubPage");
                o0O0ooO o0o0oooOooO00o = o00oOoo.OooO00o(strOooO0O0, "url", strOooO0O0, 0);
                o0o0oooOooO00o.OooO0O0(Boxing.boxLong(id), "eventid");
                o0o0oooOooO00o.OooO0O0(Boxing.boxInt(i2), "pageIndex");
                obj = OooOOO.OooO0Oo(new EventRepo$getSubPage$$inlined$call$1(o0o0oooOooO00o, null), this);
                if (obj == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
    ...
    public EventDetailViewModel(@NotNull EventModel _eventModel) {
        ...
        getDetail();
        this.getSubsPage = new p143o00Oo000.OooO0O0<>(ViewModelKt.getViewModelScope(this), new OooO0OO(null));
    }
    ...
    public final void updateRoomEventState() {
        ...
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), Dispatchers.getIO(), null, new oOO0O00O(mid, null), 2, null);
    }
    ...
    @NotNull
    public final p143o00Oo000.OooO0O0<UserInfoModel> getGetSubsPage() {
