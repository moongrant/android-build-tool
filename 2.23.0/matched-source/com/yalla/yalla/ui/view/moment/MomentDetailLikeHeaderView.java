...
public final class MomentDetailLikeHeaderView extends ConstraintLayout {
    ...
    @NotNull
    public final w2 f31121OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public int f31122OooO0o;
    ...
    public final void setCount(long count) {
        this.f31121OooO0Oo.f59123OooO0O0.setText(o0000O.OooO00o(o000O0.OooO0O0(oO00OOo0.XXX_likes, this), OooOOOO.OooO0o(count, false)));
    }

    public final void setData(int selectType) {
        this.f31122OooO0o = selectType;
        w2 w2Var = this.f31121OooO0Oo;
        TextView textView = w2Var.f59125OooO0Oo;
        int i = oO00O0o.color_333333_65;
        textView.setTextColor(o0000.OooO00o(i));
        int i2 = oOo00OO0.bg_tr00_r360;
        w2Var.f59125OooO0Oo.setBackgroundResource(i2);
        int iOooO00o = o0000.OooO00o(i);
        TextView textView2 = w2Var.f59124OooO0OO;
        textView2.setTextColor(iOooO00o);
        textView2.setBackgroundResource(i2);
        int i3 = this.f31122OooO0o;
        if (i3 == -1) {
            LinearLayoutCompat linearLayoutCompat = w2Var.f59126OooO0o0;
            Intrinsics.checkNotNullExpressionValue(linearLayoutCompat, "binding.switchLayout");
            o000OO00.OooO0O0(linearLayoutCompat);
        } else {
            if (i3 == 0) {
                LinearLayoutCompat linearLayoutCompat2 = w2Var.f59126OooO0o0;
                Intrinsics.checkNotNullExpressionValue(linearLayoutCompat2, "binding.switchLayout");
                o000OO00.OooOOOO(linearLayoutCompat2);
                w2Var.f59124OooO0OO.setTextColor(o0000.OooO00o(oO00O0o.color_333333));
                w2Var.f59124OooO0OO.setBackgroundResource(oOo00OO0.bg_ffffffff_r360);
                return;
            }
            if (i3 != 1) {
                return;
            }
            LinearLayoutCompat linearLayoutCompat3 = w2Var.f59126OooO0o0;
            Intrinsics.checkNotNullExpressionValue(linearLayoutCompat3, "binding.switchLayout");
            o000OO00.OooOOOO(linearLayoutCompat3);
            w2Var.f59125OooO0Oo.setTextColor(o0000.OooO00o(oO00O0o.color_333333));
            w2Var.f59125OooO0Oo.setBackgroundResource(oOo00OO0.bg_ffffffff_r360);
        }
    }
    ...
    public MomentDetailLikeHeaderView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        w2 w2VarInflate = w2.inflate(LayoutInflater.from(context), this, true);
        Intrinsics.checkNotNullExpressionValue(w2VarInflate, "inflate(LayoutInflater.from(context), this, true)");
        this.f31121OooO0Oo = w2VarInflate;
        LinearLayoutCompat linearLayoutCompat = w2VarInflate.f59126OooO0o0;
        Intrinsics.checkNotNullExpressionValue(linearLayoutCompat, "binding.switchLayout");
        o000OO00.OooO0O0(linearLayoutCompat);
        setCount(0L);
        this.f31122OooO0o = -1;
