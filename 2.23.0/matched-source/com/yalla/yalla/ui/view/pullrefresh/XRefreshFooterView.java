...
@Metadata(d1 = {"\u0000<\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0015\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0007\u0018\u00002\u00020\u00012\u00020\u0002B'\b\u0007\u0012\u0006\u0010\u0012\u001a\u00020\u0011\u0012\n\b\u0002\u0010\u0014\u001a\u0004\u0018\u00010\u0013\u0012\b\b\u0002\u0010\u0015\u001a\u00020\u0003¢\u0006\u0004\b\u0016\u0010\u0017J\u000e\u0010\u0006\u001a\u00020\u00052\u0006\u0010\u0004\u001a\u00020\u0003J\u000e\u0010\b\u001a\u00020\u00052\u0006\u0010\u0007\u001a\u00020\u0003J\u000e\u0010\t\u001a\u00020\u00052\u0006\u0010\u0007\u001a\u00020\u0003J\b\u0010\u000b\u001a\u00020\nH\u0016J\b\u0010\r\u001a\u00020\fH\u0016J\u0014\u0010\u0010\u001a\u00020\u00052\n\u0010\u000f\u001a\u00020\u000e\"\u00020\u0003H\u0016¨\u0006\u0018"}, d2 = {"Lcom/yalla/yalla/ui/view/pullrefresh/XRefreshFooterView;", "Landroid/widget/FrameLayout;", "Lo0OO0o/OooO0o;", "", "noMoreText", "", "setNoMoreText", "color", "setNoMoreTextColor", "setFooterDrawBackground", "Landroid/view/View;", "getView", "Lo0OO0oO0/OooO0O0;", "getSpinnerStyle", "", "colors", "setPrimaryColors", "Landroid/content/Context;", "context", "Landroid/util/AttributeSet;", "attrs", "defStyleAttr", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "Common_YallaRelease"}, k = 1, mv = {1, 8, 0})
public final class XRefreshFooterView extends FrameLayout implements OooO0o {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public TextView f31253OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public boolean f31254OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public int f31255OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public SVGAView f31256OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public com.yalla.yalla.util.Function.OooO00o f31257OooO0oo;
    ...
    public final void OooO00o(@NotNull OooOO0O kernel, int i, int i2) {
        ...
        if (this.f31255OooO0o0 != 0) {
            ((SmartRefreshLayout.OooOOO) kernel).OooO0OO(this, o0000.OooO00o(oO00O0o.colorPrimary));
        }
    }
    ...
    public final void OooO0OO(@NotNull OooOOO0 refreshLayout, @NotNull RefreshState oldState, @NotNull RefreshState newState) {
        ...
        if (i == 1) {
            SVGAView sVGAView = this.f31256OooO0oO;
            if (sVGAView == null) {
                Intrinsics.throwUninitializedPropertyAccessException("svgaFooter");
                sVGAView = null;
            }
            o000OO00.OooOOO0(sVGAView, true ^ this.f31254OooO0o);
            TextView textView = this.f31253OooO0Oo;
            if (textView == null) {
                Intrinsics.throwUninitializedPropertyAccessException("tvFooter");
                textView = null;
            }
            o000OO00.OooOOO0(textView, this.f31254OooO0o);
            SVGAView sVGAView2 = this.f31256OooO0oO;
            if (sVGAView2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("svgaFooter");
                sVGAView2 = null;
            }
            sVGAView2.OooO0Oo();
            com.yalla.yalla.util.Function.OooO00o oooO00o2 = this.f31257OooO0oo;
            if (oooO00o2 == null) {
        ...
        SVGAView sVGAView3 = this.f31256OooO0oO;
        if (sVGAView3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("svgaFooter");
            sVGAView3 = null;
        }
        o000OO00.OooOOO0(sVGAView3, !this.f31254OooO0o);
        TextView textView2 = this.f31253OooO0Oo;
        if (textView2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("tvFooter");
            textView2 = null;
        }
        o000OO00.OooOOO0(textView2, this.f31254OooO0o);
        SVGAView sVGAView4 = this.f31256OooO0oO;
        if (sVGAView4 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("svgaFooter");
            sVGAView4 = null;
        }
        sVGAView4.OooO0oO(false);
        com.yalla.yalla.util.Function.OooO00o oooO00o3 = this.f31257OooO0oo;
        if (oooO00o3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("loadingAnim");
        } else {
            oooO00o = oooO00o3;
    ...
    public XRefreshFooterView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        View.inflate(getContext(), oO00OO0O.layout_load_more_footer, this);
        View viewFindViewById = findViewById(oO00O0oO.tv_refresh_footer);
        Intrinsics.checkNotNullExpressionValue(viewFindViewById, "findViewById(R.id.tv_refresh_footer)");
        this.f31253OooO0Oo = (TextView) viewFindViewById;
        View viewFindViewById2 = findViewById(oO00O0oO.svga_refersh_footer);
        ...
        this.f31256OooO0oO = sVGAView2;
        TextView textView = null;
        if (sVGAView2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("svgaFooter");
            sVGAView2 = null;
        }
        o000OO00.OooOOO0(sVGAView2, true);
        SVGAView sVGAView3 = this.f31256OooO0oO;
        if (sVGAView3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("svgaFooter");
            sVGAView = null;
