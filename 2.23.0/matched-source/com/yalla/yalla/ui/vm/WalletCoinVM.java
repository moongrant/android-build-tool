...
public final class WalletCoinVM extends o0O0O00 {
    ...
    @NotNull
    private final o00OOO0 payLogUpload = new o00OOO0();
    ...
    public static final class OooO extends SuspendLambda implements Function2<LiveDataScope<ApiResult<RechargeMenuModel>>, Continuation<? super Unit>, Object> {
        ...
        public int f31521OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ String f31522OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f31523OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(String str, Continuation<? super OooO> continuation) {
            super(2, continuation);
            this.f31522OooO0o = str;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO oooO = new OooO(this.f31522OooO0o, continuation);
            oooO.f31523OooO0o0 = obj;
            return oooO;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f31521OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                liveDataScope = (LiveDataScope) this.f31523OooO0o0;
                if (oO000O0.f56533OooO00o.OooO0OO()) {
                    WalletRepo walletRepo = WalletRepo.f24837OooO00o;
                    this.f31523OooO0o0 = liveDataScope;
                    this.f31521OooO0Oo = 1;
                    walletRepo.getClass();
                    ...
                    this.f31523OooO0o0 = null;
                    this.f31521OooO0Oo = 3;
                    ...
                    this.f31523OooO0o0 = liveDataScope;
                    this.f31521OooO0Oo = 2;
                    obj = walletRepo2.OooOOO0(this.f31522OooO0o, this);
                    if (obj == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    apiResult = (ApiResult) obj;
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<LiveDataScope<ApiResult<RechargeMenuConfirmOrderResultModel>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31524OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ PayOrder f31525OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f31526OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(PayOrder payOrder, Continuation<? super OooO00o> continuation) {
            super(2, continuation);
            this.f31525OooO0o = payOrder;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO00o oooO00o = new OooO00o(this.f31525OooO0o, continuation);
            oooO00o.f31526OooO0o0 = obj;
            return oooO00o;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            LiveDataScope liveDataScope;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31524OooO0Oo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f31526OooO0o0;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            liveDataScope = (LiveDataScope) this.f31526OooO0o0;
            WalletRepo walletRepo = WalletRepo.f24837OooO00o;
            this.f31526OooO0o0 = liveDataScope;
            this.f31524OooO0Oo = 1;
            obj = walletRepo.OooO00o(this.f31525OooO0o, this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f31526OooO0o0 = null;
            this.f31524OooO0Oo = 2;
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<LiveDataScope<ApiResult<RechargeMenuCreateOrderResultModel>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31527OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ RechargeMenuCreateOrderModel f31528OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f31529OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(RechargeMenuCreateOrderModel rechargeMenuCreateOrderModel, Continuation<? super OooO0O0> continuation) {
            super(2, continuation);
            this.f31528OooO0o = rechargeMenuCreateOrderModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0O0 oooO0O0 = new OooO0O0(this.f31528OooO0o, continuation);
            oooO0O0.f31529OooO0o0 = obj;
            return oooO0O0;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ApiResult apiResult;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            switch (this.f31527OooO0Oo) {
                case 0:
                    ResultKt.throwOnFailure(obj);
                    liveDataScope = (LiveDataScope) this.f31529OooO0o0;
                    RechargeMenuCreateOrderModel rechargeMenuCreateOrderModel = this.f31528OooO0o;
                    int type = rechargeMenuCreateOrderModel.getType();
                    if (type == PaySupportChannels.pay_type_googlePay.getNum()) {
                        WalletRepo walletRepo = WalletRepo.f24837OooO00o;
                        this.f31529OooO0o0 = liveDataScope;
                        this.f31527OooO0Oo = 1;
                        obj = walletRepo.OooO0oo(rechargeMenuCreateOrderModel, this);
                        if (obj == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        apiResult = (ApiResult) obj;
                        this.f31529OooO0o0 = null;
                        this.f31527OooO0Oo = 6;
                        if (liveDataScope.emit(apiResult, this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        return Unit.INSTANCE;
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<LiveDataScope<ApiResult<VipCreateOrderResultModel>>, Continuation<? super Unit>, Object> {
        ...
        public final /* synthetic */ int f31530OooO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31531OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ boolean f31532OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f31533OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ String f31534OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ double f31535OooO0oo;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public final /* synthetic */ String f31536OooOO0;

        /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
        public final /* synthetic */ String f31537OooOO0O;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(boolean z, String str, double d, int i, String str2, String str3, Continuation<? super OooO0OO> continuation) {
            super(2, continuation);
            this.f31532OooO0o = z;
            this.f31534OooO0oO = str;
            this.f31535OooO0oo = d;
            this.f31530OooO = i;
            this.f31536OooOO0 = str2;
            this.f31537OooOO0O = str3;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0OO oooO0OO = new OooO0OO(this.f31532OooO0o, this.f31534OooO0oO, this.f31535OooO0oo, this.f31530OooO, this.f31536OooOO0, this.f31537OooOO0O, continuation);
            oooO0OO.f31533OooO0o0 = obj;
            return oooO0OO;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            LiveDataScope liveDataScope;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31531OooO0Oo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f31533OooO0o0;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            ResultKt.throwOnFailure(obj);
            liveDataScope = (LiveDataScope) this.f31533OooO0o0;
            int i2 = !this.f31532OooO0o ? 1 : 0;
            WalletRepo walletRepo = WalletRepo.f24837OooO00o;
            String str = this.f31534OooO0oO;
            double d = this.f31535OooO0oo;
            int i3 = this.f31530OooO;
            String str2 = this.f31536OooOO0;
            String str3 = this.f31537OooOO0O;
            this.f31533OooO0o0 = liveDataScope;
            this.f31531OooO0Oo = 1;
            obj = walletRepo.OooO0oO(i2, str, d, i3, str2, str3, this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f31533OooO0o0 = null;
            this.f31531OooO0Oo = 2;
            if (liveDataScope.emit(obj, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
    ...
    public static final class OooO0o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31538OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ String f31539OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(String str, Continuation<? super OooO0o> continuation) {
            super(2, continuation);
            this.f31539OooO0o0 = str;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0o(this.f31539OooO0o0, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31538OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                WalletRepo walletRepo = WalletRepo.f24837OooO00o;
                this.f31538OooO0Oo = 1;
                walletRepo.getClass();
                if (WalletRepo.OooOO0o(this.f31539OooO0o0) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
    ...
    public static final class OooOO0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31540OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ WalletCoinVM f31541OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ PayOrder f31542OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0(PayOrder payOrder, WalletCoinVM walletCoinVM, Continuation<? super OooOO0> continuation) {
            super(2, continuation);
            this.f31542OooO0o0 = payOrder;
            this.f31541OooO0o = walletCoinVM;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOO0(this.f31542OooO0o0, this.f31541OooO0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31540OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                WalletRepo walletRepo = WalletRepo.f24837OooO00o;
                PayOrder payOrder = this.f31542OooO0o0;
                String orderId = payOrder.getOrderId();
                String sku = payOrder.getSku();
                String payTypeName = this.f31541OooO0o.getPayTypeName(payOrder.getType());
                this.f31540OooO0Oo = 1;
    ...
    public static final class OooOO0O extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31543OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ WalletCoinVM f31544OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ PayOrder f31545OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0O(PayOrder payOrder, WalletCoinVM walletCoinVM, Continuation<? super OooOO0O> continuation) {
            super(2, continuation);
            this.f31545OooO0o0 = payOrder;
            this.f31544OooO0o = walletCoinVM;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOO0O(this.f31545OooO0o0, this.f31544OooO0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31543OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                WalletRepo walletRepo = WalletRepo.f24837OooO00o;
                PayOrder payOrder = this.f31545OooO0o0;
                String orderId = payOrder.getOrderId();
                String sku = payOrder.getSku();
                String payTypeName = this.f31544OooO0o.getPayTypeName(payOrder.getType());
                int errorCode = payOrder.getErrorCode();
                this.f31543OooO0Oo = 1;
    ...
    public static final class OooOOO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31546OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ WalletCoinVM f31547OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ PayOrder f31548OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO(PayOrder payOrder, WalletCoinVM walletCoinVM, Continuation<? super OooOOO> continuation) {
            super(2, continuation);
            this.f31548OooO0o0 = payOrder;
            this.f31547OooO0o = walletCoinVM;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOOO(this.f31548OooO0o0, this.f31547OooO0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31546OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                WalletRepo walletRepo = WalletRepo.f24837OooO00o;
                PayOrder payOrder = this.f31548OooO0o0;
                String orderId = payOrder.getOrderId();
                String sku = payOrder.getSku();
                String payTypeName = this.f31547OooO0o.getPayTypeName(payOrder.getType());
                this.f31546OooO0Oo = 1;
    ...
    public static final class OooOOO0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ String f31550OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ Double f31551OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ List<RechargeMenuType> f31552OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO0(Double d, String str, List<RechargeMenuType> list, Continuation<? super OooOOO0> continuation) {
            super(2, continuation);
            this.f31551OooO0o0 = d;
            this.f31550OooO0o = str;
            this.f31552OooO0oO = list;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return WalletCoinVM.this.new OooOOO0(this.f31551OooO0o0, this.f31550OooO0o, this.f31552OooO0oO, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            o00OOO0 o00ooo1 = WalletCoinVM.this.payLogUpload;
            o00ooo1.getClass();
            String str = "";
            Double d = this.f31551OooO0o0;
            String str2 = null;
            if (d != null) {
            ...
            String str3 = this.f31550OooO0o;
            List<RechargeMenuType> list = this.f31552OooO0oO;
            if (str3 != null) {
                if (string != null) {
                    try {
                        ...
                        lazy = o00ooo1.f45909OooO00o;
                        if (!z2) {
                            ((AppEventsLogger) lazy.getValue()).logPurchase(BigDecimal.valueOf(p590o0oo0.OooOOOO.OooOO0(string)), Currency.getInstance("USD"));
                        } else if (list != null) {
            ...
            if (str3 != null) {
                if (str2 != null) {
                    try {
                        ...
                        if (!z) {
                            p592o0oo00O.OooOOO0.OooO0O0("GooglePlayPay amount =" + str2 + "===" + p590o0oo0.OooOOOO.OooOO0(str2) + "===" + str3);
                            HashMap map = new HashMap();
                            map.put(AFInAppEventParameterName.REVENUE, Double.valueOf(p590o0oo0.OooOOOO.OooOO0(str2)));
                            ...
                            o00O0O0O.OooO00o(AFInAppEventType.PURCHASE, map);
                        } else if (list != null) {
                            for (RechargeMenuType rechargeMenuType2 : list) {
                                if (str3 == rechargeMenuType2.getSku()) {
                                    ...
                                    o00O0O0O.OooO00o(AFInAppEventType.PURCHASE, map2);
                                }
                            }
                        }
                    } catch (Exception e2) {
                    ...
                    map3.put(AFInAppEventParameterName.REVENUE, Double.valueOf(p590o0oo0.OooOOOO.OooOO0(str2)));
                    ...
                    o00O0O0O.OooO00o(AFInAppEventType.PURCHASE, map3);
                } else if (list != null) {
                    while (r15.hasNext()) {
                        if (str3 == rechargeMenuType2.getSku()) {
                            ...
                            o00O0O0O.OooO00o(AFInAppEventType.PURCHASE, map4);
                        }
                    }
                }
            }
    ...
    public static final class OooOOOO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31553OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ MutableLiveData<Boolean> f31554OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ PayOrder f31555OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOOO(PayOrder payOrder, MutableLiveData<Boolean> mutableLiveData, Continuation<? super OooOOOO> continuation) {
            super(2, continuation);
            this.f31555OooO0o0 = payOrder;
            this.f31554OooO0o = mutableLiveData;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOOOO(this.f31555OooO0o0, this.f31554OooO0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31553OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                PayOrder payOrder = this.f31555OooO0o0;
                if (payOrder.getType() == PaySupportChannels.pay_type_googlePay.getNum() || payOrder.getType() == PaySupportChannels.pay_type_huaWeiPay.getNum()) {
                    WalletRepo walletRepo = WalletRepo.f24837OooO00o;
                    this.f31553OooO0Oo = 1;
                    walletRepo.getClass();
                    o000OOo.OooO00o().OooOoO0().OooO00o(payOrder);
            ...
            this.f31554OooO0o.postValue(Boxing.boxBoolean(true));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOo extends SuspendLambda implements Function2<LiveDataScope<ApiResult<List<GoldModel>>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ String f31557OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f31558OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ String f31559OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOo(String str, String str2, Continuation<? super OooOo> continuation) {
            super(2, continuation);
            this.f31557OooO0o = str;
            this.f31559OooO0oO = str2;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooOo oooOo = new OooOo(this.f31557OooO0o, this.f31559OooO0oO, continuation);
            oooOo.f31558OooO0o0 = obj;
            return oooOo;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            String url = o000OOo0.OooO0o0(4, "/Webservers/Recharge/TransactionDetails");
            Intrinsics.checkNotNullParameter(url, "url");
            o0O0ooO o0o0ooo = new o0O0ooO(url, 0);
            o0o0ooo.OooO0O0(this.f31557OooO0o, "pageindex");
            o0o0ooo.OooO0O0(this.f31559OooO0oO, "type");
            obj = com.code.android.util.OooOOO.OooO0Oo(new WalletRepo$userBill$$inlined$call$1(o0o0ooo, null), this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
    ...
    public static final class OooOo00 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31560OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ PayOrder f31561OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOo00(PayOrder payOrder, Continuation<? super OooOo00> continuation) {
            super(2, continuation);
            this.f31561OooO0o0 = payOrder;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOo00(this.f31561OooO0o0, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31560OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                PayOrder payOrder = this.f31561OooO0o0;
                if (payOrder.getType() == PaySupportChannels.pay_type_googlePay.getNum() || payOrder.getType() == PaySupportChannels.pay_type_huaWeiPay.getNum()) {
                    WalletRepo walletRepo = WalletRepo.f24837OooO00o;
                    this.f31560OooO0Oo = 1;
                    walletRepo.getClass();
    ...
    private final CountryModel getUserCountry() {
        ...
        return com.yalla.yalla.app.golbalData.OooO00o.OooO00o(String.valueOf(o000000O.OooO0OO().getValue()));
    }
