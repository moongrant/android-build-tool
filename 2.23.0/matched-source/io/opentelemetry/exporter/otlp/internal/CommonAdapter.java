...
public final class CommonAdapter {
    ...
    public static final WeakConcurrentMap.WithInlinedExpunction f33118OooO00o = new WeakConcurrentMap.WithInlinedExpunction();

    /* JADX INFO: renamed from: io.opentelemetry.exporter.otlp.internal.CommonAdapter$1, reason: invalid class name */
    public static /* synthetic */ class AnonymousClass1 {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public static final /* synthetic */ int[] f33119OooO00o;
        ...
        static {
            ...
            try {
                f33119OooO00o[AttributeType.BOOLEAN.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f33119OooO00o[AttributeType.LONG.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f33119OooO00o[AttributeType.DOUBLE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f33119OooO00o[AttributeType.BOOLEAN_ARRAY.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f33119OooO00o[AttributeType.LONG_ARRAY.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f33119OooO00o[AttributeType.DOUBLE_ARRAY.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f33119OooO00o[AttributeType.STRING_ARRAY.ordinal()] = 8;
    ...
    public static KeyValue OooO00o(AttributeKey<?> attributeKey, Object obj) {
        switch (AnonymousClass1.f33119OooO00o[attributeKey.getType().ordinal()]) {
            case 1:
    ...
    public static InstrumentationLibrary OooO0O0(InstrumentationLibraryInfo instrumentationLibraryInfo) {
        WeakConcurrentMap.WithInlinedExpunction withInlinedExpunction = f33118OooO00o;
