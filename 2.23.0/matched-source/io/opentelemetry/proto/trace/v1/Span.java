...
public final class Span extends GeneratedMessageLite<Span, Builder> implements SpanOrBuilder {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        public static final /* synthetic */ int[] f33180OooO00o;
        ...
        static {
            ...
            try {
                f33180OooO00o[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f33180OooO00o[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f33180OooO00o[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f33180OooO00o[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f33180OooO00o[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f33180OooO00o[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Span, Builder> implements SpanOrBuilder {
        ...
        public final void OooO0oo(SpanKind spanKind) {
            copyOnWrite();
        ...
        public final void OooOOO(ByteString byteString) {
            copyOnWrite();
            ((Span) this.instance).setTraceId(byteString);
        }

        public final void OooOOO0(Status status) {
            copyOnWrite();
    ...
    public static final class Event extends GeneratedMessageLite<Event, Builder> implements EventOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            int i = 0;
            switch (AnonymousClass1.f33180OooO00o[methodToInvoke.ordinal()]) {
                case 1:
                    return new Event();
                case 2:
