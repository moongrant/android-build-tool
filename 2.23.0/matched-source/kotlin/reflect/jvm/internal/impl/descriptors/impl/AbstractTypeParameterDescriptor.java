...
public abstract class AbstractTypeParameterDescriptor extends DeclarationDescriptorNonRootImpl implements TypeParameterDescriptor {
    ...
    public class TypeParameterTypeConstructor extends AbstractTypeConstructor {
        ...
        public void reportSupertypeLoopError(@NotNull KotlinType kotlinType) {
            ...
            this.this$0.mo5505reportSupertypeLoopError(kotlinType);
        }
    ...
    public List<KotlinType> getUpperBounds() {
        List<KotlinType> listMo5503getSupertypes = ((TypeParameterTypeConstructor) getTypeConstructor()).mo5503getSupertypes();
        if (listMo5503getSupertypes == null) {
            $$$reportNull$$$0(8);
        }
        return listMo5503getSupertypes;
    }
    ...
    public abstract void mo5505reportSupertypeLoopError(@NotNull KotlinType kotlinType);
