...
public final class OooOo00 extends OooOO0O {
    ...
    @NotNull
    public final String f47568OooO00o = "MomentMsgProcessor";
    ...
    public static final class OooO00o {
        ...
        public static MomentMessage OooO00o(int i, String mid, long j, String messageContent, int i2) {
            ...
            if (l == null) {
                ...
                Intrinsics.checkNotNullExpressionValue(l, "Account.userId.value ?: 0L");
    ...
    public final void OooO0O0(@NotNull MessageIM.Message message, boolean z) {
        ...
        String str = this.f47568OooO00o;
        p592o0oo00O.OooOOO0.OooO00o(102, str, "\n动态消息\nMomentMsgProcessor parseMessage message = " + message, null);
        long fromId = message.getFromId();
        o000000O o000000o2 = o000000O.f46674OooO00o;
        Long l = (Long) o000000O.OooOOo0().getValue();
        if ((l != null && fromId == l.longValue()) || com.code.android.util.OooOo00.OooO00o(message.getMid())) {
            return;
        }
        String mid = message.getMid();
        Intrinsics.checkNotNullExpressionValue(mid, "message.mid");
        Intrinsics.checkNotNullParameter(mid, "mid");
        if (com.code.android.util.OooOo00.OooO0O0(o000OOo.OooO00o().OooOo0o().OooO0oO(mid))) {
            return;
        }
        if (o000000O.OooOOo0().getValue() == 0) {
            return;
        }
        int head = message.getHead();
        if (head == 1000) {
            p592o0oo00O.OooOOO0.OooO0OO(str, "\n朋友圈评论点赞通知 \nsaveMessage1000 message " + message);
            try {
                ...
                if (com.code.android.util.OooOo00.OooO00o(from)) {
                    return;
                }
                ...
                p592o0oo00O.OooOOO0.OooO0O0("MomentMessageRepo saveMessage msg:" + momentMessageOooO00o + ZegoConstants.ZegoVideoDataAuxPublishingStream);
                o000OOo.OooO00o().OooOo0o().OooOOO(momentMessageOooO00o);
                return;
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        if (head == 1001) {
            ...
            try {
                ...
                if (com.code.android.util.OooOo00.OooO00o(from2)) {
                    return;
                }
                ...
                p592o0oo00O.OooOOO0.OooO0O0("MomentMessageRepo saveMessage msg:" + momentMessageOooO00o2 + ZegoConstants.ZegoVideoDataAuxPublishingStream);
                o000OOo.OooO00o().OooOo0o().OooOOO(momentMessageOooO00o2);
                return;
            } catch (Exception e2) {
                e2.printStackTrace();
                return;
        ...
        if (head == 1501) {
            ...
            try {
                ...
                if (com.code.android.util.OooOo00.OooO00o(from3)) {
                    return;
                }
                ...
                p592o0oo00O.OooOOO0.OooO0oo(str, "\n动态被删除 \nsaveMessage1501 \nmessage : " + message + " \nmessageData : " + oO00Oo0.OooO00o(from3) + "\ndb : " + momentMessageOooO00o3);
                ...
                o000OOo.OooO00o().OooOo0o().OooOOO(momentMessageOooO00o3);
                return;
            } catch (Exception e3) {
                e3.printStackTrace();
                return;
        ...
        if (head == 1503) {
            ...
            try {
                ...
                if (com.code.android.util.OooOo00.OooO00o(from4)) {
                    return;
                }
        ...
        if (head == 2117) {
            ...
            try {
                ...
                if (com.code.android.util.OooOo00.OooO00o(from5)) {
                    return;
                }
                ...
                Intrinsics.checkNotNullExpressionValue(commentImg3, "messageData.commentImg");
                momentFeatured.setMomentImageUrl(commentImg3);
                momentMessageOooO00o5.setMomentFeatured(momentFeatured);
                p592o0oo00O.OooOOO0.OooO0O0("MomentMessageRepo saveMessage msg:" + momentMessageOooO00o5 + ZegoConstants.ZegoVideoDataAuxPublishingStream);
                o000OOo.OooO00o().OooOo0o().OooOOO(momentMessageOooO00o5);
                return;
            } catch (Exception e5) {
                e5.printStackTrace();
                return;
        ...
        switch (head) {
            case 1003:
                ...
                try {
                    Message.MessageDyToppedAndRemove messageDyToppedAndRemove = (Message.MessageDyToppedAndRemove) Message.MessageDyToppedAndRemove.f33617OooOO0O.parseFrom(message.getBody());
                    if (!com.code.android.util.OooOo00.OooO00o(messageDyToppedAndRemove)) {
                        ...
                        momentTopicTop.setUserId(messageDyToppedAndRemove.f33623OooO0oo);
                        String strOooO0OO = messageDyToppedAndRemove.OooO0OO();
                        Intrinsics.checkNotNullExpressionValue(strOooO0OO, "messageData.hostImg");
                        momentTopicTop.setUserHeadUrl(strOooO0OO);
                        String strOooO0O0 = messageDyToppedAndRemove.OooO0O0();
                        Intrinsics.checkNotNullExpressionValue(strOooO0O0, "messageData.dyImg");
                        momentTopicTop.setMomentImageUrl(strOooO0O0);
                        momentTopicTop.setTopicId(messageDyToppedAndRemove.f33619OooO0Oo);
                        String circleName = messageDyToppedAndRemove.getCircleName();
                        Intrinsics.checkNotNullExpressionValue(circleName, "messageData.circleName");
                        momentTopicTop.setTopicName(circleName);
                        momentMessageOooO00o6.setMomentTopicTop(momentTopicTop);
                        p592o0oo00O.OooOOO0.OooO0O0("MomentMessageRepo saveMessage msg:" + momentMessageOooO00o6 + ZegoConstants.ZegoVideoDataAuxPublishingStream);
                        o000OOo.OooO00o().OooOo0o().OooOOO(momentMessageOooO00o6);
                    }
                } catch (Exception e6) {
                    e6.printStackTrace();
                    return;
            ...
            case 1004:
                ...
                try {
                    Message.MessageDyToppedAndRemove messageDyToppedAndRemove2 = (Message.MessageDyToppedAndRemove) Message.MessageDyToppedAndRemove.f33617OooOO0O.parseFrom(message.getBody());
                    if (!com.code.android.util.OooOo00.OooO00o(messageDyToppedAndRemove2)) {
                        ...
                        momentTopicTopRevoke.setUserId(messageDyToppedAndRemove2.f33623OooO0oo);
                        String strOooO0OO2 = messageDyToppedAndRemove2.OooO0OO();
                        Intrinsics.checkNotNullExpressionValue(strOooO0OO2, "messageData.hostImg");
                        momentTopicTopRevoke.setUserHeadUrl(strOooO0OO2);
                        String strOooO0O1 = messageDyToppedAndRemove2.OooO0O0();
                        Intrinsics.checkNotNullExpressionValue(strOooO0O1, "messageData.dyImg");
                        momentTopicTopRevoke.setMomentImageUrl(strOooO0O1);
                        momentTopicTopRevoke.setTopicId(messageDyToppedAndRemove2.f33619OooO0Oo);
                        String circleName2 = messageDyToppedAndRemove2.getCircleName();
                        Intrinsics.checkNotNullExpressionValue(circleName2, "messageData.circleName");
                        momentTopicTopRevoke.setTopicName(circleName2);
                        momentMessageOooO00o7.setMomentTopicTopRevoke(momentTopicTopRevoke);
                        p592o0oo00O.OooOOO0.OooO0oo(str, "\n圈子内置顶取消通知 \nsaveMessage1004 \nmessage : " + message + " \nmessageData : " + oO00Oo0.OooO00o(messageDyToppedAndRemove2) + "\ndb : " + momentMessageOooO00o7);
                        ...
                        p592o0oo00O.OooOOO0.OooO0O0(sb3.toString());
                        o000OOo.OooO00o().OooOo0o().OooOOO(momentMessageOooO00o7);
                    }
                } catch (Exception e7) {
                    e7.printStackTrace();
                    return;
            ...
            case 1005:
                ...
                try {
                    Message.MessageDyToppedAndRemove messageDyToppedAndRemove3 = (Message.MessageDyToppedAndRemove) Message.MessageDyToppedAndRemove.f33617OooOO0O.parseFrom(message.getBody());
                    if (!com.code.android.util.OooOo00.OooO00o(messageDyToppedAndRemove3)) {
                        ...
                        momentTopicRemoveOwner.setUserId(messageDyToppedAndRemove3.f33623OooO0oo);
                        String strOooO0OO3 = messageDyToppedAndRemove3.OooO0OO();
                        Intrinsics.checkNotNullExpressionValue(strOooO0OO3, "messageData.hostImg");
                        momentTopicRemoveOwner.setUserHeadUrl(strOooO0OO3);
                        String strOooO0O2 = messageDyToppedAndRemove3.OooO0O0();
                        Intrinsics.checkNotNullExpressionValue(strOooO0O2, "messageData.dyImg");
                        momentTopicRemoveOwner.setMomentImageUrl(strOooO0O2);
                        momentTopicRemoveOwner.setMomentId(messageDyToppedAndRemove3.f33619OooO0Oo);
                        String circleName3 = messageDyToppedAndRemove3.getCircleName();
                        Intrinsics.checkNotNullExpressionValue(circleName3, "messageData.circleName");
                        momentTopicRemoveOwner.setTopicName(circleName3);
                        momentMessageOooO00o8.setMomentTopicRemoveOwner(momentTopicRemoveOwner);
                        p592o0oo00O.OooOOO0.OooO0oo(str, "\n圈子内移除通知-圈主移出 \nsaveMessage1005 \nmessage : " + message + " \nmessageData : " + oO00Oo0.OooO00o(messageDyToppedAndRemove3) + "\ndb : " + momentMessageOooO00o8);
                        ...
                        p592o0oo00O.OooOOO0.OooO0O0(sb4.toString());
                        o000OOo.OooO00o().OooOo0o().OooOOO(momentMessageOooO00o8);
                    }
                } catch (Exception e8) {
                    e8.printStackTrace();
                    return;
            ...
            case 1006:
                ...
                try {
                    Message.MessageDyToppedAndRemove messageDyToppedAndRemove4 = (Message.MessageDyToppedAndRemove) Message.MessageDyToppedAndRemove.f33617OooOO0O.parseFrom(message.getBody());
                    if (!com.code.android.util.OooOo00.OooO00o(messageDyToppedAndRemove4)) {
                        String mid10 = message.getMid();
                        Intrinsics.checkNotNullExpressionValue(mid10, "message.mid");
                        ...
                        momentTopicRemoveAdmin.setUserId(messageDyToppedAndRemove4.f33623OooO0oo);
                        String strOooO0OO4 = messageDyToppedAndRemove4.OooO0OO();
                        Intrinsics.checkNotNullExpressionValue(strOooO0OO4, "messageData.hostImg");
                        momentTopicRemoveAdmin.setUserHeadUrl(strOooO0OO4);
                        String strOooO0O3 = messageDyToppedAndRemove4.OooO0O0();
                        Intrinsics.checkNotNullExpressionValue(strOooO0O3, "messageData.dyImg");
                        momentTopicRemoveAdmin.setMomentImageUrl(strOooO0O3);
                        momentTopicRemoveAdmin.setMomentId(messageDyToppedAndRemove4.f33619OooO0Oo);
                        String circleName4 = messageDyToppedAndRemove4.getCircleName();
                        Intrinsics.checkNotNullExpressionValue(circleName4, "messageData.circleName");
                        momentTopicRemoveAdmin.setTopicName(circleName4);
                        momentMessageOooO00o9.setMomentTopicRemoveAdmin(momentTopicRemoveAdmin);
                        p592o0oo00O.OooOOO0.OooO0oo(str, "\n圈子内移除通知-管理员移出 \nsaveMessage1006 \nmessage : " + message + " \nmessageData : " + oO00Oo0.OooO00o(messageDyToppedAndRemove4) + "\ndb : " + momentMessageOooO00o9);
                        ...
                        p592o0oo00O.OooOOO0.OooO0O0(sb5.toString());
                        o000OOo.OooO00o().OooOo0o().OooOOO(momentMessageOooO00o9);
                    }
                } catch (Exception e9) {
                    e9.printStackTrace();
                    return;
    ...
    public final void OooO0OO(MessageIM.Message message) throws InvalidProtocolBufferException {
        ...
        if (com.code.android.util.OooOo00.OooO00o(messageData)) {
        }
        MomentMessageCommentModel momentMessageCommentModel = (MomentMessageCommentModel) oOo00OO0.OooO00o(messageData.getContent(), MomentMessageCommentModel.class);
        p592o0oo00O.OooOOO0.OooO0oo(this.f47568OooO00o, "\n朋友圈操作消息 \nsaveMessage2114 \nmessage : " + message + " \nmomentMessageCommentModel : " + momentMessageCommentModel);
                        ...
                        if (lValueOf.longValue() > 0) {
                            ...
                            try {
                                if (!com.code.android.util.OooOo00.OooO00o(messageData)) {
                                    ...
                                    p592o0oo00O.OooOOO0.OooO00o(104, "MomentMsgProcessor - 2114", "\n朋友圈操作消息 - 动态评论/动态回复 被@ - 撤回 \nsaveMessage2114MomentCommentAtRevoke db = " + momentMessageOooO00o, null);
                                    j.OooO00o(momentMessageOooO00o);
                                }
                            } catch (Exception e) {
                                e.printStackTrace();
                                return;
            ...
            case -3:
                ...
                try {
                    if (!com.code.android.util.OooOo00.OooO00o(messageData)) {
                        ...
                        j.OooO00o(momentMessageOooO00o2);
                    }
                } catch (Exception e2) {
                    e2.printStackTrace();
                    return;
            ...
            case -2:
                ...
                try {
                    if (!com.code.android.util.OooOo00.OooO00o(messageData)) {
                        ...
                        j.OooO00o(momentMessageOooO00o3);
                    }
                } catch (Exception e3) {
                    e3.printStackTrace();
                    return;
            ...
            case -1:
                ...
                try {
                    if (!com.code.android.util.OooOo00.OooO00o(messageData)) {
                        ...
                        j.OooO00o(momentMessageOooO00o4);
                    }
                } catch (Exception e4) {
                    e4.printStackTrace();
                    return;
            ...
            case 3:
                ...
                try {
                    if (!com.code.android.util.OooOo00.OooO00o(messageData)) {
                        ...
                        p592o0oo00O.OooOOO0.OooO0O0("MomentMessageRepo saveMessage msg:" + momentMessageOooO00o7 + ZegoConstants.ZegoVideoDataAuxPublishingStream);
                        o000OOo.OooO00o().OooOo0o().OooOOO(momentMessageOooO00o7);
                    }
                } catch (Exception e7) {
                    e7.printStackTrace();
            ...
            case 4:
                        ...
                        if (lValueOf2.longValue() > 0) {
                            ...
                            try {
                                if (!com.code.android.util.OooOo00.OooO00o(messageData)) {
                                    ...
                                    p592o0oo00O.OooOOO0.OooO0O0("MomentMessageRepo saveMessage msg:" + momentMessageOooO00o8 + ZegoConstants.ZegoVideoDataAuxPublishingStream);
                                    o000OOo.OooO00o().OooOo0o().OooOOO(momentMessageOooO00o8);
                                }
                            } catch (Exception e8) {
                                e8.printStackTrace();
                ...
                try {
                    if (!com.code.android.util.OooOo00.OooO00o(messageData)) {
                        ...
                        p592o0oo00O.OooOOO0.OooO0O0("MomentMessageRepo saveMessage msg:" + momentMessageOooO00o9 + ZegoConstants.ZegoVideoDataAuxPublishingStream);
                        o000OOo.OooO00o().OooOo0o().OooOOO(momentMessageOooO00o9);
                    }
                } catch (Exception e9) {
                    e9.printStackTrace();
    ...
    public final void OooO0Oo(MessageIM.Message message) {
        ...
        try {
            ...
            p592o0oo00O.OooOOO0.OooO0oo(str, "\n动态的评论/回复打赏 \nsaveMessage2125 \nmessage : " + message + " \nmessageData : " + oO00Oo0.OooO00o(from) + "\ndb : " + momentMessageOooO00o);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
