...
public final class OooOOOO implements o00Oo0 {
    ...
    public final o00OO f446OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final CaptureResult f447OooO0O0;

    public OooOOOO(@NonNull o00OO o00oo2, @NonNull CaptureResult captureResult) {
        this.f446OooO00o = o00oo2;
        this.f447OooO0O0 = captureResult;
    }

    @NonNull
    public final CameraCaptureMetaData$AfMode OooO() {
        Integer num = (Integer) this.f447OooO0O0.get(CaptureResult.CONTROL_AF_MODE);
        if (num == null) {
    ...
    public final void OooO00o(@NonNull ExifData.OooO0O0 oooO0O0) {
        ...
        CaptureResult captureResult = this.f447OooO0O0;
    ...
    public final o00OO OooO0O0() {
        return this.f446OooO00o;
    }

    @Override // androidx.camera.core.impl.o00Oo0
    public final long OooO0OO() {
        Long l = (Long) this.f447OooO0O0.get(CaptureResult.SENSOR_TIMESTAMP);
        if (l == null) {
            return -1L;
        }
        return l.longValue();
    ...
    public final CameraCaptureMetaData$FlashState OooO0Oo() {
        Integer num = (Integer) this.f447OooO0O0.get(CaptureResult.FLASH_STATE);
        if (num == null) {
    ...
    public final CameraCaptureMetaData$AfState OooO0o() {
        Integer num = (Integer) this.f447OooO0O0.get(CaptureResult.CONTROL_AF_STATE);
        if (num == null) {
    ...
    public final CaptureResult OooO0o0() {
        return this.f447OooO0O0;
    }

    @Override // androidx.camera.core.impl.o00Oo0
    @NonNull
    public final CameraCaptureMetaData$AwbState OooO0oO() {
        Integer num = (Integer) this.f447OooO0O0.get(CaptureResult.CONTROL_AWB_STATE);
        if (num == null) {
    ...
    public final CameraCaptureMetaData$AeState OooO0oo() {
        Integer num = (Integer) this.f447OooO0O0.get(CaptureResult.CONTROL_AE_STATE);
        if (num == null) {
