...
public final class o00O {
    ...
    @NonNull
    public final o0O0O00 f607OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NonNull
    public final MutableLiveData<CameraState> f608OooO0O0;

    public static /* synthetic */ class OooO00o {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public static final /* synthetic */ int[] f609OooO00o;
        ...
        static {
            ...
            try {
                f609OooO00o[CameraInternal.State.OPENING.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f609OooO00o[CameraInternal.State.OPEN.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f609OooO00o[CameraInternal.State.CONFIGURED.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f609OooO00o[CameraInternal.State.CLOSING.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f609OooO00o[CameraInternal.State.RELEASING.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f609OooO00o[CameraInternal.State.CLOSED.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f609OooO00o[CameraInternal.State.RELEASED.ordinal()] = 8;
    ...
    public final void OooO00o(@NonNull CameraInternal.State state, @Nullable OooO0OO oooO0OO) {
        boolean z;
        OooO0O0 oooO0O0;
        switch (OooO00o.f609OooO00o[state.ordinal()]) {
            case 1:
                o0O0O00 o0o0o00 = this.f607OooO00o;
                synchronized (o0o0o00.f3757OooO0O0) {
                    Iterator it = o0o0o00.f3761OooO0o0.entrySet().iterator();
                    while (true) {
                        if (!it.hasNext()) {
                            z = false;
                        } else if (((o0O0O00.OooO00o) ((Map.Entry) it.next()).getValue()).f3762OooO00o == CameraInternal.State.CLOSING) {
                            z = true;
                        }
                    }
                }
        ...
        if (Objects.equals(this.f608OooO0O0.getValue(), oooO0O0)) {
            return;
        }
        o00O0O0.OooO00o("CameraStateMachine", "Publishing new public camera state " + oooO0O0);
        this.f608OooO0O0.postValue(oooO0O0);
    }
}
