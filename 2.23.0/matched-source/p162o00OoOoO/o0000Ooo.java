...
public final class o0000Ooo extends o0ooOOo<MutableStateFlow<Boolean>> {
        ...
        if (i != 1) {
            if (i == 2) {
                ...
                if (i == 4) {
                    ...
                    if (!Intrinsics.areEqual(strNextString, "1") && !StringsKt.OooOO0o(strNextString, ServerProtocol.DIALOG_RETURN_SCOPES_TRUE)) {
                    }
                }
