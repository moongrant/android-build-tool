...
public final class o000oOoO extends Lambda implements Function1<CameraState, Unit> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ Context f46485OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o000oOoO(Context context) {
        super(1);
        this.f46485OooO0Oo = context;
    }
    ...
    public final Unit invoke(CameraState cameraState) {
        ...
        if (OooO00o2 != null) {
            ...
            Context context = this.f46485OooO0Oo;
            switch (iOooO0O0) {
                case 1:
