...
public final class o0O0OO0 extends k {

    /* JADX INFO: renamed from: OooOOo0, reason: collision with root package name */
    public final /* synthetic */ SmsCodeActivity f47315OooOOo0;
    ...
    public o0O0OO0(SmsCodeActivity smsCodeActivity, boolean z) {
        super(smsCodeActivity, z);
        this.f47315OooOOo0 = smsCodeActivity;
    }
    ...
    public final void OooO0Oo(@NotNull OtherLoginType loginType) {
        ...
        SmsCodeActivity smsCodeActivity = this.f47315OooOOo0;
        if (i == 1) {
        ...
        if (i == 2) {
            int i3 = SmsCodeActivity.f25298Oooo0;
            ...
            int i5 = SmsCodeActivity.f25298Oooo0;
