...
public final class oO0000Oo extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MomentGiftsVM f53819OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public oO0000Oo(MomentGiftsVM momentGiftsVM) {
        super(0);
        this.f53819OooO0Oo = momentGiftsVM;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        MomentGiftsVM momentGiftsVM = this.f53819OooO0Oo;
