...
public final class MediaControllerCompat {
    ...
    public final MediaControllerImplApi21 f2094OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @SuppressLint({"BanConcurrentHashMap"})
    public final ConcurrentHashMap<OooO00o, Boolean> f2095OooO0O0 = new ConcurrentHashMap<>();

    @RequiresApi(21)
    public static class MediaControllerImplApi21 {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final MediaController f2096OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final Object f2097OooO0O0 = new Object();

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        @GuardedBy("mLock")
        public final ArrayList f2098OooO0OO = new ArrayList();

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final HashMap<OooO00o, OooO00o> f2099OooO0Oo = new HashMap<>();

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final MediaSessionCompat.Token f2100OooO0o0;

        public static class ExtraBinderRequestResultReceiver extends ResultReceiver {

            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final WeakReference<MediaControllerImplApi21> f2101OooO0Oo;

            public ExtraBinderRequestResultReceiver(MediaControllerImplApi21 mediaControllerImplApi21) {
                super(null);
                this.f2101OooO0Oo = new WeakReference<>(mediaControllerImplApi21);
            }

            @Override // android.os.ResultReceiver
            public final void onReceiveResult(int i, Bundle bundle) {
                MediaControllerImplApi21 mediaControllerImplApi21 = this.f2101OooO0Oo.get();
                if (mediaControllerImplApi21 == null || bundle == null) {
                    return;
                }
                synchronized (mediaControllerImplApi21.f2097OooO0O0) {
                    mediaControllerImplApi21.f2100OooO0o0.OooO0O0(android.support.v4.media.session.OooO0O0.OooO00o.OooOOoo(Oooo0.OooO00o(bundle, "android.support.v4.media.session.EXTRA_BINDER")));
                    mediaControllerImplApi21.f2100OooO0o0.OooO0OO(OooOOOO.OooO00o(bundle));
        ...
        public MediaControllerImplApi21(Context context, MediaSessionCompat.Token token) {
            this.f2100OooO0o0 = token;
            MediaController mediaController = new MediaController(context, (MediaSession.Token) token.f2114OooO0o0);
            this.f2096OooO00o = mediaController;
        ...
        public final void OooO00o() {
            MediaSessionCompat.Token token = this.f2100OooO0o0;
            if (token.OooO00o() == null) {
                return;
            }
            ArrayList<OooO00o> arrayList = this.f2098OooO0OO;
            for (OooO00o oooO00o : arrayList) {
                OooO00o oooO00o2 = new OooO00o(oooO00o);
                this.f2099OooO0Oo.put(oooO00o, oooO00o2);
                oooO00o.f2104OooO0OO = oooO00o2;
                try {
    ...
    public static abstract class OooO00o implements IBinder.DeathRecipient {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final C0008OooO00o f2102OooO00o = new C0008OooO00o(this);

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public OooO0O0 f2103OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public MediaControllerImplApi21.OooO00o f2104OooO0OO;
        ...
        public static class C0008OooO00o extends MediaController.Callback {
            ...
            /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
            public final WeakReference<OooO00o> f2105OooO00o;

            public C0008OooO00o(OooO00o oooO00o) {
                this.f2105OooO00o = new WeakReference<>(oooO00o);
            }

            @Override // android.media.session.MediaController.Callback
            public final void onAudioInfoChanged(MediaController.PlaybackInfo playbackInfo) {
                OooO00o oooO00o = this.f2105OooO00o.get();
                if (oooO00o != null) {
            ...
            public final void onPlaybackStateChanged(PlaybackState playbackState) {
                OooO00o oooO00o = this.f2105OooO00o.get();
                if (oooO00o == null || oooO00o.f2104OooO0OO != null) {
                    return;
                }
        ...
        public class OooO0O0 extends Handler {
            ...
            /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
            public boolean f2106OooO00o;

            public OooO0O0(Looper looper) {
                super(looper);
                this.f2106OooO00o = false;
            }

            @Override // android.os.Handler
            public final void handleMessage(Message message) {
                if (this.f2106OooO00o) {
                    int i = message.what;
        ...
        public static class OooO0OO extends android.support.v4.media.session.OooO00o.AbstractBinderC0009OooO00o {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final WeakReference<OooO00o> f2108OooO0Oo;

            public OooO0OO(OooO00o oooO00o) {
                this.f2108OooO0Oo = new WeakReference<>(oooO00o);
            }
        }
        ...
        public final void OooOOO(Handler handler) {
            if (handler != null) {
                ...
                this.f2103OooO0O0 = oooO0O0;
                oooO0O0.f2106OooO00o = true;
            } else {
                OooO0O0 oooO0O1 = this.f2103OooO0O0;
                if (oooO0O1 != null) {
                    oooO0O1.f2106OooO00o = false;
                    oooO0O1.removeCallbacksAndMessages(null);
                    this.f2103OooO0O0 = null;
                }
            }
        }

        public final void OooOOO0(int i, Object obj, Bundle bundle) {
            OooO0O0 oooO0O0 = this.f2103OooO0O0;
            if (oooO0O0 != null) {
    ...
    public MediaControllerCompat(Context context, @NonNull MediaSessionCompat.Token token) {
        ...
        this.f2094OooO00o = new MediaControllerImplApi21(context, token);
    }
}
