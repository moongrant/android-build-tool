...
public final class FocusOwnerImpl implements FocusOwner {
    ...
    private final Modifier.Node lastLocalKeyInputNode(DelegatableNode delegatableNode) {
        int iM3004constructorimpl = NodeKind.m3004constructorimpl(LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) | NodeKind.m3004constructorimpl(8192);
        if (!delegatableNode.getNode().getIsAttached()) {
            throw new IllegalStateException("visitLocalDescendants called on an unattached node".toString());
        }
        Modifier.Node node = delegatableNode.getNode();
        Modifier.Node node2 = null;
        if ((node.getAggregateChildKindSet() & iM3004constructorimpl) != 0) {
            for (Modifier.Node child = node.getChild(); child != null; child = child.getChild()) {
                if ((child.getKindSet() & iM3004constructorimpl) != 0) {
                    if ((NodeKind.m3004constructorimpl(LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) & child.getKindSet()) != 0) {
                        return node2;
                    }
                    node2 = child;
                }
    ...
    private final /* synthetic */ <T extends DelegatableNode> void m1387traverseAncestorsYYKmho(DelegatableNode delegatableNode, int i, Function1<? super T, Unit> function1, Function1<? super T, Unit> function2) {
        int size;
        NodeChain nodes;
        if (!delegatableNode.getNode().getIsAttached()) {
        ...
        while (layoutNodeRequireLayoutNode != null) {
            if ((OooO00o.OooO00o(layoutNodeRequireLayoutNode) & i) != 0) {
                while (parent != null) {
    ...
    private final boolean m1388wrapAroundFocus3ESFkO8(int focusDirection) {
        if (this.rootFocusNode.getFocusState().getHasFocus() && !this.rootFocusNode.getFocusState().isFocused()) {
            FocusDirection.Companion companion = FocusDirection.INSTANCE;
            if (FocusDirection.m1366equalsimpl0(focusDirection, companion.m1379getNextdhqQ8s()) ? true : FocusDirection.m1366equalsimpl0(focusDirection, companion.m1381getPreviousdhqQ8s())) {
                clearFocus(false);
                if (this.rootFocusNode.getFocusState().isFocused()) {
                    return mo1384moveFocus3ESFkO8(focusDirection);
                }
                return false;
            }
        }
    ...
    public boolean mo1385dispatchInterceptedSoftKeyboardEventZmokQxo(@org.jetbrains.annotations.NotNull android.view.KeyEvent r15) {
        /*
            Method dump skipped, instruction units count: 614
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.focus.FocusOwnerImpl.mo1385dispatchInterceptedSoftKeyboardEventZmokQxo(android.view.KeyEvent):boolean");
    }
    ...
    public boolean mo1386dispatchKeyEventZmokQxo(@org.jetbrains.annotations.NotNull android.view.KeyEvent r15) {
        /*
            Method dump skipped, instruction units count: 639
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.focus.FocusOwnerImpl.mo1386dispatchKeyEventZmokQxo(android.view.KeyEvent):boolean");
    }
    ...
    public boolean mo1384moveFocus3ESFkO8(final int focusDirection) {
        final FocusTargetNode focusTargetNodeFindActiveFocusNode = FocusTraversalKt.findActiveFocusNode(this.rootFocusNode);
        if (focusTargetNodeFindActiveFocusNode == null) {
            return false;
        }
        FocusRequester focusRequesterM1399customFocusSearchOMvw8 = FocusTraversalKt.m1399customFocusSearchOMvw8(focusTargetNodeFindActiveFocusNode, focusDirection, getLayoutDirection());
        FocusRequester.Companion companion = FocusRequester.INSTANCE;
        if (focusRequesterM1399customFocusSearchOMvw8 != companion.getDefault()) {
            return focusRequesterM1399customFocusSearchOMvw8 != companion.getCancel() && focusRequesterM1399customFocusSearchOMvw8.focus$ui_release();
        }
        final Ref.BooleanRef booleanRef = new Ref.BooleanRef();
        boolean zM1400focusSearchsMXa3k8 = FocusTraversalKt.m1400focusSearchsMXa3k8(this.rootFocusNode, focusDirection, getLayoutDirection(), new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusOwnerImpl$moveFocus$foundNextItem$1
            ...
            public final Boolean invoke(@NotNull FocusTargetNode destination) {
                ...
                int i2 = WhenMappings.$EnumSwitchMapping$0[FocusTransactionsKt.m1398performCustomRequestFocusMxy_nc0(destination, focusDirection).ordinal()];
                if (i2 != 1) {
                    if (i2 == 2 || i2 == 3) {
        ...
        return zM1400focusSearchsMXa3k8 || m1388wrapAroundFocus3ESFkO8(focusDirection);
    }
    ...
    public void clearFocus(boolean force, boolean refreshFocusEvents) {
        ...
        if (!force) {
            int i = WhenMappings.$EnumSwitchMapping$0[FocusTransactionsKt.m1395performCustomClearFocusMxy_nc0(this.rootFocusNode, FocusDirection.INSTANCE.m1376getExitdhqQ8s()).ordinal()];
            if (i == 1 || i == 2 || i == 3) {
                return;
            }
        }
