...
public final class TextInputServiceAndroid implements PlatformTextInputService {
    ...
    public TextInputServiceAndroid(@NotNull View view, @NotNull InputMethodManager inputMethodManager, @Nullable PlatformTextInput platformTextInput, @NotNull Executor inputCommandProcessorExecutor) {
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid$onImeActionPerformed$1
            ...
            public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                m3538invokeKlQnJC8(imeAction.getValue());
                return Unit.INSTANCE;
            }

            /* JADX INFO: renamed from: invoke-KlQnJC8, reason: not valid java name */
            public final void m3538invokeKlQnJC8(int i) {
            }
        };
        this.state = new TextFieldValue("", TextRange.INSTANCE.m3325getZerod9O1mEE(), (TextRange) null, 4, (DefaultConstructorMarker) null);
    ...
    public final InputConnection createInputConnection(@NotNull EditorInfo outAttrs) {
        ...
        RecordingInputConnection recordingInputConnection = new RecordingInputConnection(this.state, new InputEventCallback2() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid.createInputConnection.1
            ...
            public void mo3491onImeActionKlQnJC8(int imeAction) {
                TextInputServiceAndroid.this.onImeActionPerformed.invoke(ImeAction.m3462boximpl(imeAction));
            }
    ...
    public void stopInput() {
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid.stopInput.2
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                m3539invokeKlQnJC8(imeAction.getValue());
                return Unit.INSTANCE;
            }

            /* JADX INFO: renamed from: invoke-KlQnJC8, reason: not valid java name */
            public final void m3539invokeKlQnJC8(int i) {
            }
        };
    ...
    public void updateState(@Nullable TextFieldValue oldValue, @NotNull TextFieldValue newValue) {
        ...
        boolean z = true;
        boolean z2 = (TextRange.m3313equalsimpl0(this.state.getSelection(), newValue.getSelection()) && Intrinsics.areEqual(this.state.getComposition(), newValue.getComposition())) ? false : true;
        this.state = newValue;
        ...
        if (Intrinsics.areEqual(oldValue, newValue)) {
            if (z2) {
                ...
                int iM3318getMinimpl = TextRange.m3318getMinimpl(newValue.getSelection());
                int iM3317getMaximpl = TextRange.m3317getMaximpl(newValue.getSelection());
                TextRange textRangeM3536getCompositionMzsxiRA = this.state.getComposition();
                int iM3318getMinimpl2 = textRangeM3536getCompositionMzsxiRA != null ? TextRange.m3318getMinimpl(textRangeM3536getCompositionMzsxiRA.getPackedValue()) : -1;
                TextRange textRangeM3536getCompositionMzsxiRA2 = this.state.getComposition();
                inputMethodManager.updateSelection(iM3318getMinimpl, iM3317getMaximpl, iM3318getMinimpl2, textRangeM3536getCompositionMzsxiRA2 != null ? TextRange.m3317getMaximpl(textRangeM3536getCompositionMzsxiRA2.getPackedValue()) : -1);
                return;
            }
            return;
        }
        if (oldValue == null || (Intrinsics.areEqual(oldValue.getText(), newValue.getText()) && (!TextRange.m3313equalsimpl0(oldValue.getSelection(), newValue.getSelection()) || Intrinsics.areEqual(oldValue.getComposition(), newValue.getComposition())))) {
            z = false;
        }
        if (z) {
            restartInputImmediately();
