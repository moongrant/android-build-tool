...
public final class OooOOO extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ OooOo00.OooO00o f10131OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ NavBackStackEntry f10132OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooOOO(OooOo00.OooO00o oooO00o, NavBackStackEntry navBackStackEntry) {
        super(2);
        this.f10131OooO0Oo = oooO00o;
        this.f10132OooO0o0 = navBackStackEntry;
    }
    ...
    public final Unit invoke(Composer composer, Integer num) {
        ...
        if ((iIntValue & 11) == 2 && composer2.getSkipping()) {
            ...
            this.f10131OooO0Oo.f10144OooOOO.invoke(this.f10132OooO0o0, composer2, 8);
            if (ComposerKt.isTraceInProgress()) {
