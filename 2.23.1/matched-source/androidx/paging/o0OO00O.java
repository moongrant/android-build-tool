...
public final class o0OO00O extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f10465OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ o0Oo0oo<Object> f10466OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ Oooo000<Object> f10467OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final /* synthetic */ o0OOO0o<Object> f10468OooO0oO;
    ...
    public o0OO00O(Oooo000<Object> oooo000, o0Oo0oo<Object> o0oo0oo2, o0OOO0o<Object> o0ooo0o2, Continuation<? super o0OO00O> continuation) {
        ...
        this.f10467OooO0o0 = oooo000;
        this.f10466OooO0o = o0oo0oo2;
        this.f10468OooO0oO = o0ooo0o2;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o0OO00O(this.f10467OooO0o0, this.f10466OooO0o, this.f10468OooO0oO, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i10 = this.f10465OooO0Oo;
        if (i10 == 0) {
            ResultKt.throwOnFailure(obj);
            Oooo000<Object> oooo000 = this.f10467OooO0o0;
            if (oooo000 instanceof Oooo000.OooO0O0) {
                Oooo000.OooO0O0 oooO0O1 = (Oooo000.OooO0O0) oooo000;
                if (oooO0O1.f10297OooO00o == LoadType.REFRESH) {
                    o0Oo0oo<Object> o0oo0oo5 = this.f10466OooO0o;
                    List<o000000O<T>> list2 = oooO0O1.f10298OooO0O0;
                    int i11 = oooO0O1.f10299OooO0OO;
                    int i12 = oooO0O1.f10300OooO0Oo;
                    OooOOO oooOOO4 = oooO0O1.f10302OooO0o0;
                    OooOOO oooOOO5 = oooO0O1.f10301OooO0o;
                    o0000 o0000Var3 = this.f10468OooO0oO.f10473OooO0OO;
                    this.f10465OooO0Oo = 1;
                    ...
                    o0oo0oo2 = this.f10466OooO0o;
                    listListOf = CollectionsKt.listOf(new o000000O(0, ((Oooo000.OooO0o) this.f10467OooO0o0).f10305OooO00o));
                    Oooo000.OooO0o oooO0o = (Oooo000.OooO0o) this.f10467OooO0o0;
                    oooOOO = oooO0o.f10306OooO0O0;
                    z = oooOOO == null || oooO0o.f10307OooO0OO != null;
                    oooOOO2 = oooO0o.f10307OooO0OO;
                    o0000Var = this.f10468OooO0oO.f10473OooO0OO;
                    this.f10465OooO0Oo = 2;
                    if (o0Oo0oo.OooO00o(o0oo0oo2, listListOf, 0, 0, z, oooOOO, oooOOO2, o0000Var, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (this.f10466OooO0o.OooO0OO()) {
                        this.f10465OooO0Oo = 3;
                        if (YieldKt.yield(this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    }
                    o0Oo0oo<Object> o0oo0oo6 = this.f10466OooO0o;
                    o0ooooo = o0oo0oo6.f10481OooO0o0;
                    pageEvent = this.f10467OooO0o0;
                    callback = o0oo0oo6.f10485OooOO0O;
                    o0ooooo.getClass();
                    Intrinsics.checkNotNullParameter(pageEvent, "pageEvent");
                    Intrinsics.checkNotNullParameter(callback, "callback");
                    if (pageEvent instanceof Oooo000.OooO0O0) {
                        oooO0O0 = (Oooo000.OooO0O0) pageEvent;
                        it2 = oooO0O0.f10298OooO0O0.iterator();
                        size4 = 0;
                        while (it2.hasNext()) {
                            size4 += ((o000000O) it2.next()).f10389OooO0O0.size();
                        }
                        size5 = o0ooooo.getSize();
                        i9 = o0ooOOo.OooO00o.$EnumSwitchMapping$0[oooO0O0.f10297OooO00o.ordinal()];
                        if (i9 == 1) {
                            throw new IllegalStateException("Paging received a refresh event in the middle of an actively loading generation\nof PagingData. If you see this exception, it is most likely a bug in the library.\nPlease file a bug so we can fix it at:\nhttps://issuetracker.google.com/issues/new?component=413106");
                        }
                        list = o0ooooo.f10514OooO00o;
                        collection2 = oooO0O0.f10298OooO0O0;
                        if (i9 == 2) {
                            int iMin2 = Math.min(o0ooooo.f10516OooO0OO, size4);
                            int i13 = o0ooooo.f10516OooO0OO - iMin2;
                            int i14 = size4 - iMin2;
                            list.addAll(0, collection2);
                            o0ooooo.f10515OooO0O0 += size4;
                            o0ooooo.f10516OooO0OO = oooO0O0.f10299OooO0OO;
                            callback.f10489OooO00o.f10476OooO00o.OooO0OO(i13, iMin2);
                            callback.OooO00o(0, i14);
                            size6 = (o0ooooo.getSize() - size5) - i14;
                            if (size6 > 0) {
                                callback.OooO00o(0, size6);
                            } else if (size6 < 0) {
                                callback.f10489OooO00o.f10476OooO00o.OooO0O0(0, -size6);
                            }
                        } else if (i9 == 3) {
                            int iMin3 = Math.min(o0ooooo.f10517OooO0Oo, size4);
                            int i15 = o0ooooo.f10516OooO0OO + o0ooooo.f10515OooO0O0;
                            int i16 = size4 - iMin3;
                            list.addAll(list.size(), collection2);
                            o0ooooo.f10515OooO0O0 += size4;
                            o0ooooo.f10517OooO0Oo = oooO0O0.f10300OooO0Oo;
                            callback.f10489OooO00o.f10476OooO00o.OooO0OO(i15, iMin3);
                            callback.OooO00o(i15 + iMin3, i16);
                            size7 = (o0ooooo.getSize() - size5) - i16;
                            if (size7 > 0) {
                                callback.OooO00o(o0ooooo.getSize() - size7, size7);
                            } else if (size7 < 0) {
                                callback.f10489OooO00o.f10476OooO00o.OooO0O0(o0ooooo.getSize(), -size7);
                            }
                        }
                        OooOOO sourceLoadStates = oooO0O0.f10302OooO0o0;
                        OooOOO oooOOO6 = oooO0O0.f10301OooO0o;
                        callback.getClass();
                        Intrinsics.checkNotNullParameter(sourceLoadStates, "source");
                        o0Oo0oo<T> o0oo0oo7 = callback.f10489OooO00o;
                        o0oo0oo7.getClass();
                        Intrinsics.checkNotNullParameter(sourceLoadStates, "source");
                        OooOo00 oooOo00 = o0oo0oo7.f10480OooO0o;
                        oooOo00.getClass();
                        ...
                        loadType = oooO00o.f10292OooO00o;
                        loadType2 = LoadType.PREPEND;
                        i = oooO00o.f10294OooO0OO;
                        i2 = oooO00o.f10293OooO0O0;
                        i3 = oooO00o.f10295OooO0Oo;
                        if (loadType == loadType2) {
                            int i17 = o0ooooo.f10516OooO0OO;
                            o0ooooo.f10515OooO0O0 -= o0ooooo.OooO0o(new IntRange(i2, i));
                            o0ooooo.f10516OooO0OO = i3;
                            size3 = o0ooooo.getSize() - size;
                            if (size3 > 0) {
                                callback.OooO00o(0, size3);
                            } else if (size3 < 0) {
                                callback.f10489OooO00o.f10476OooO00o.OooO0O0(0, -size3);
                            }
                            iMax = Math.max(0, i17 + size3);
                            i6 = i3 - iMax;
                            if (i6 > 0) {
                                callback.f10489OooO00o.f10476OooO00o.OooO0OO(iMax, i6);
                            }
                            callback.OooO0O0(loadType2);
                        } else {
                            i4 = o0ooooo.f10517OooO0Oo;
                            o0ooooo.f10515OooO0O0 -= o0ooooo.OooO0o(new IntRange(i2, i));
                            o0ooooo.f10517OooO0Oo = i3;
                            size2 = o0ooooo.getSize() - size;
                            if (size2 > 0) {
                                callback.OooO00o(size, size2);
                            } else if (size2 < 0) {
                                callback.f10489OooO00o.f10476OooO00o.OooO0O0(size + size2, -size2);
                            }
                            if (size2 < 0) {
                            ...
                            i5 = i3 - (i4 - iMin);
                            if (i5 > 0) {
                                callback.f10489OooO00o.f10476OooO00o.OooO0OO(o0ooooo.getSize() - i3, i5);
                            }
                        ...
                        OooOOO sourceLoadStates2 = oooO0OO.f10303OooO00o;
                        OooOOO oooOOO7 = oooO0OO.f10304OooO0O0;
                        callback.getClass();
                        Intrinsics.checkNotNullParameter(sourceLoadStates2, "source");
                        o0Oo0oo<T> o0oo0oo8 = callback.f10489OooO00o;
                        o0oo0oo8.getClass();
                        Intrinsics.checkNotNullParameter(sourceLoadStates2, "source");
                        OooOo00 oooOo01 = o0oo0oo8.f10480OooO0o;
                        oooOo01.getClass();
                    ...
                    if (this.f10467OooO0o0 instanceof Oooo000.OooO00o) {
                        this.f10466OooO0o.f10475OooO = false;
                    }
                    if (this.f10467OooO0o0 instanceof Oooo000.OooO0O0) {
                        value = this.f10466OooO0o.f10480OooO0o.f10279OooO0OO.getValue();
                        if (value != null) {
                            oooOOO3 = value.f35618OooO0Oo;
                        } else {
                            oooOOO3 = null;
                        }
                        if (oooOOO3 == null) {
                        ...
                        boolean z5 = oooOOO3.f10266OooO0O0.f10268OooO00o;
                        boolean z6 = oooOOO3.f10267OooO0OO.f10268OooO00o;
                        Oooo000.OooO0O0 oooO0O2 = (Oooo000.OooO0O0) this.f10467OooO0o0;
                        LoadType loadType3 = oooO0O2.f10297OooO00o;
                        if (loadType3 == LoadType.PREPEND) {
                        }
                        collection = oooO0O2.f10298OooO0O0;
                        if (!(collection instanceof Collection)) {
                            ...
                            while (true) {
                                ...
                                if (!((o000000O) it.next()).f10389OooO0O0.isEmpty()) {
                                    z3 = false;
                                    break;
                                }
                            }
                        ...
                        if (!z2) {
                            this.f10466OooO0o.f10475OooO = false;
                        } else if (this.f10466OooO0o.f10475OooO) {
                            if (z3) {
                                z4 = true;
                            } else {
                                i7 = this.f10466OooO0o.f10484OooOO0;
                                o0oo0oo4 = this.f10466OooO0o;
                                if (i7 >= o0oo0oo4.f10481OooO0o0.f10516OooO0OO) {
                                    i8 = o0oo0oo4.f10484OooOO0;
                                    o0ooooo2 = this.f10466OooO0o.f10481OooO0o0;
                                    if (i8 > o0ooooo2.f10516OooO0OO + o0ooooo2.f10515OooO0O0) {
                                        z4 = true;
                                    } else {
                                        z4 = false;
                                    }
                            ...
                            if (z4) {
                                o0oo0oo3 = this.f10466OooO0o;
                                o0000Var2 = o0oo0oo3.f10478OooO0OO;
                                if (o0000Var2 != null) {
                                    o0000Var2.OooO00o(o0oo0oo3.f10481OooO0o0.OooO0o0(o0oo0oo3.f10484OooOO0));
                                }
                            } else {
                                this.f10466OooO0o.f10475OooO = false;
                            }
                ...
                o0oo0oo2 = this.f10466OooO0o;
                listListOf = CollectionsKt.listOf(new o000000O(0, ((Oooo000.OooO0o) this.f10467OooO0o0).f10305OooO00o));
                Oooo000.OooO0o oooO0o2 = (Oooo000.OooO0o) this.f10467OooO0o0;
                oooOOO = oooO0o2.f10306OooO0O0;
                if (oooOOO == null) {
                }
                oooOOO2 = oooO0o2.f10307OooO0OO;
                o0000Var = this.f10468OooO0oO.f10473OooO0OO;
                this.f10465OooO0Oo = 2;
                if (o0Oo0oo.OooO00o(o0oo0oo2, listListOf, 0, 0, z, oooOOO, oooOOO2, o0000Var, this) == coroutine_suspended) {
                    return coroutine_suspended;
                ...
                o0Oo0oo<Object> o0oo0oo9 = this.f10466OooO0o;
                o0ooooo = o0oo0oo9.f10481OooO0o0;
                pageEvent = this.f10467OooO0o0;
                callback = o0oo0oo9.f10485OooOO0O;
                o0ooooo.getClass();
                Intrinsics.checkNotNullParameter(pageEvent, "pageEvent");
                Intrinsics.checkNotNullParameter(callback, "callback");
                if (pageEvent instanceof Oooo000.OooO0O0) {
                    ...
                    collection2 = oooO0O0.f10298OooO0O0;
                    if (i9 == 2) {
                        int iMin4 = Math.min(o0ooooo.f10516OooO0OO, size4);
                        int i18 = o0ooooo.f10516OooO0OO - iMin4;
                        int i19 = size4 - iMin4;
                        list.addAll(0, collection2);
                        o0ooooo.f10515OooO0O0 += size4;
                        o0ooooo.f10516OooO0OO = oooO0O0.f10299OooO0OO;
                        callback.f10489OooO00o.f10476OooO00o.OooO0OO(i18, iMin4);
                        ...
                        int iMin5 = Math.min(o0ooooo.f10517OooO0Oo, size4);
                        int i110 = o0ooooo.f10516OooO0OO + o0ooooo.f10515OooO0O0;
                        int i111 = size4 - iMin5;
                        list.addAll(list.size(), collection2);
                        o0ooooo.f10515OooO0O0 += size4;
                        o0ooooo.f10517OooO0Oo = oooO0O0.f10300OooO0Oo;
                        callback.f10489OooO00o.f10476OooO00o.OooO0OO(i110, iMin5);
                    ...
                    OooOOO sourceLoadStates3 = oooO0O0.f10302OooO0o0;
                    OooOOO oooOOO8 = oooO0O0.f10301OooO0o;
                    callback.getClass();
                    Intrinsics.checkNotNullParameter(sourceLoadStates3, "source");
                    o0Oo0oo<T> o0oo0oo10 = callback.f10489OooO00o;
                    o0oo0oo10.getClass();
                    Intrinsics.checkNotNullParameter(sourceLoadStates3, "source");
                    OooOo00 oooOo02 = o0oo0oo10.f10480OooO0o;
                    oooOo02.getClass();
                    ...
                    size = o0ooooo.getSize();
                    loadType = oooO00o2.f10292OooO00o;
                    loadType2 = LoadType.PREPEND;
                    i = oooO00o2.f10294OooO0OO;
                    i2 = oooO00o2.f10293OooO0O0;
                    i3 = oooO00o2.f10295OooO0Oo;
                    if (loadType == loadType2) {
                        int i112 = o0ooooo.f10516OooO0OO;
                        o0ooooo.f10515OooO0O0 -= o0ooooo.OooO0o(new IntRange(i2, i));
                        o0ooooo.f10516OooO0OO = i3;
                        size3 = o0ooooo.getSize() - size;
                        if (size3 > 0) {
                    ...
                    OooOOO sourceLoadStates4 = oooO0OO2.f10303OooO00o;
                    OooOOO oooOOO9 = oooO0OO2.f10304OooO0O0;
                    callback.getClass();
                    Intrinsics.checkNotNullParameter(sourceLoadStates4, "source");
                    o0Oo0oo<T> o0oo0oo11 = callback.f10489OooO00o;
                    o0oo0oo11.getClass();
                    Intrinsics.checkNotNullParameter(sourceLoadStates4, "source");
                    OooOo00 oooOo03 = o0oo0oo11.f10480OooO0o;
                    oooOo03.getClass();
                ...
                if (this.f10467OooO0o0 instanceof Oooo000.OooO0O0) {
                    ...
                    boolean z7 = oooOOO3.f10266OooO0O0.f10268OooO00o;
                    boolean z8 = oooOOO3.f10267OooO0OO.f10268OooO00o;
                    Oooo000.OooO0O0 oooO0O3 = (Oooo000.OooO0O0) this.f10467OooO0o0;
                    LoadType loadType4 = oooO0O3.f10297OooO00o;
                    if (loadType4 == LoadType.PREPEND) {
                    }
                    collection = oooO0O3.f10298OooO0O0;
                    if (!(collection instanceof Collection)) {
                        it = collection.iterator();
                        while (true) {
                            if (!it.hasNext()) {
            ...
            ResultKt.throwOnFailure(obj);
            o0Oo0oo<Object> o0oo0oo12 = this.f10466OooO0o;
            o0ooooo = o0oo0oo12.f10481OooO0o0;
            pageEvent = this.f10467OooO0o0;
            callback = o0oo0oo12.f10485OooOO0O;
            o0ooooo.getClass();
            Intrinsics.checkNotNullParameter(pageEvent, "pageEvent");
            Intrinsics.checkNotNullParameter(callback, "callback");
            if (pageEvent instanceof Oooo000.OooO0O0) {
                ...
                collection2 = oooO0O0.f10298OooO0O0;
                if (i9 == 2) {
                    int iMin6 = Math.min(o0ooooo.f10516OooO0OO, size4);
                    int i113 = o0ooooo.f10516OooO0OO - iMin6;
                    int i114 = size4 - iMin6;
                    list.addAll(0, collection2);
                    o0ooooo.f10515OooO0O0 += size4;
                    o0ooooo.f10516OooO0OO = oooO0O0.f10299OooO0OO;
                    callback.f10489OooO00o.f10476OooO00o.OooO0OO(i113, iMin6);
                    ...
                    int iMin7 = Math.min(o0ooooo.f10517OooO0Oo, size4);
                    int i115 = o0ooooo.f10516OooO0OO + o0ooooo.f10515OooO0O0;
                    int i116 = size4 - iMin7;
                    list.addAll(list.size(), collection2);
                    o0ooooo.f10515OooO0O0 += size4;
                    o0ooooo.f10517OooO0Oo = oooO0O0.f10300OooO0Oo;
                    callback.f10489OooO00o.f10476OooO00o.OooO0OO(i115, iMin7);
                ...
                OooOOO sourceLoadStates5 = oooO0O0.f10302OooO0o0;
                OooOOO oooOOO10 = oooO0O0.f10301OooO0o;
                callback.getClass();
                Intrinsics.checkNotNullParameter(sourceLoadStates5, "source");
                o0Oo0oo<T> o0oo0oo13 = callback.f10489OooO00o;
                o0oo0oo13.getClass();
                Intrinsics.checkNotNullParameter(sourceLoadStates5, "source");
                OooOo00 oooOo04 = o0oo0oo13.f10480OooO0o;
                oooOo04.getClass();
                ...
                size = o0ooooo.getSize();
                loadType = oooO00o3.f10292OooO00o;
                loadType2 = LoadType.PREPEND;
                i = oooO00o3.f10294OooO0OO;
                i2 = oooO00o3.f10293OooO0O0;
                i3 = oooO00o3.f10295OooO0Oo;
                if (loadType == loadType2) {
                    int i117 = o0ooooo.f10516OooO0OO;
                    o0ooooo.f10515OooO0O0 -= o0ooooo.OooO0o(new IntRange(i2, i));
                    o0ooooo.f10516OooO0OO = i3;
                    size3 = o0ooooo.getSize() - size;
                    if (size3 > 0) {
                ...
                OooOOO sourceLoadStates6 = oooO0OO3.f10303OooO00o;
                OooOOO oooOOO11 = oooO0OO3.f10304OooO0O0;
                callback.getClass();
                Intrinsics.checkNotNullParameter(sourceLoadStates6, "source");
                o0Oo0oo<T> o0oo0oo14 = callback.f10489OooO00o;
                o0oo0oo14.getClass();
                Intrinsics.checkNotNullParameter(sourceLoadStates6, "source");
                OooOo00 oooOo05 = o0oo0oo14.f10480OooO0o;
                oooOo05.getClass();
            ...
            if (this.f10467OooO0o0 instanceof Oooo000.OooO0O0) {
                ...
                boolean z9 = oooOOO3.f10266OooO0O0.f10268OooO00o;
                boolean z10 = oooOOO3.f10267OooO0OO.f10268OooO00o;
                Oooo000.OooO0O0 oooO0O4 = (Oooo000.OooO0O0) this.f10467OooO0o0;
                LoadType loadType5 = oooO0O4.f10297OooO00o;
                z2 = (loadType5 == LoadType.PREPEND || !z9) && !(loadType5 == LoadType.APPEND && z10);
                collection = oooO0O4.f10298OooO0O0;
                ...
                if (!z2) {
                    this.f10466OooO0o.f10475OooO = false;
                } else if (this.f10466OooO0o.f10475OooO || z3) {
                    if (z3) {
                        i7 = this.f10466OooO0o.f10484OooOO0;
                        o0oo0oo4 = this.f10466OooO0o;
                        if (i7 >= o0oo0oo4.f10481OooO0o0.f10516OooO0OO) {
        ...
        Oooo000<Object> oooo001 = this.f10467OooO0o0;
        if ((oooo001 instanceof Oooo000.OooO0O0) || (oooo001 instanceof Oooo000.OooO00o) || (oooo001 instanceof Oooo000.OooO0o)) {
            Iterator<Function0<Unit>> it3 = this.f10466OooO0o.f10482OooO0oO.iterator();
            while (it3.hasNext()) {
                it3.next().invoke();
            }
        }
