...
public class ChangeTransform extends Transition {
    ...
    public static final String[] f11223OooOooo = {"android:changeTransform:matrix", "android:changeTransform:transforms", "android:changeTransform:parentMatrix"};

    /* JADX INFO: renamed from: Oooo000, reason: collision with root package name */
    public static final OooO00o f11224Oooo000 = new OooO00o();

    /* JADX INFO: renamed from: Oooo00O, reason: collision with root package name */
    public static final OooO0O0 f11225Oooo00O = new OooO0O0();

    /* JADX INFO: renamed from: Oooo00o, reason: collision with root package name */
    public static final boolean f11226Oooo00o = true;

    /* JADX INFO: renamed from: OooOoo, reason: collision with root package name */
    public final boolean f11227OooOoo;

    /* JADX INFO: renamed from: OooOoo0, reason: collision with root package name */
    public final boolean f11228OooOoo0;

    /* JADX INFO: renamed from: OooOooO, reason: collision with root package name */
    public final Matrix f11229OooOooO;

    public static class OooO {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final float f11230OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final float f11231OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final float f11232OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final float f11233OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final float f11234OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final float f11235OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final float f11236OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final float f11237OooO0oo;

        public OooO(View view) {
            this.f11230OooO00o = view.getTranslationX();
            this.f11231OooO0O0 = view.getTranslationY();
            WeakHashMap<View, o000OOo0> weakHashMap = ViewCompat.f5344OooO00o;
            this.f11232OooO0OO = ViewCompat.OooOOO.OooOO0o(view);
            this.f11233OooO0Oo = view.getScaleX();
            this.f11235OooO0o0 = view.getScaleY();
            this.f11234OooO0o = view.getRotationX();
            this.f11236OooO0oO = view.getRotationY();
            this.f11237OooO0oo = view.getRotation();
        }
    ...
    public class OooO00o extends Property<OooO0o, float[]> {
        ...
        public final void set(OooO0o oooO0o, float[] fArr) {
            ...
            float[] fArr2 = fArr;
            oooO0o2.getClass();
            System.arraycopy(fArr2, 0, oooO0o2.f11242OooO0OO, 0, fArr2.length);
            oooO0o2.OooO00o();
        }
    }
    ...
    public class OooO0O0 extends Property<OooO0o, PointF> {
        ...
        public final void set(OooO0o oooO0o, PointF pointF) {
            ...
            oooO0o2.getClass();
            oooO0o2.f11243OooO0Oo = pointF2.x;
            oooO0o2.f11244OooO0o0 = pointF2.y;
            oooO0o2.OooO00o();
        }
    }
    ...
    public static class OooO0OO extends OooOO0O {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final View f11238OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final oOO00O.OooO f11239OooO0o0;

        public OooO0OO(View view, oOO00O.OooO oooO) {
            this.f11238OooO0Oo = view;
            this.f11239OooO0o0 = oooO;
        }

        @Override // androidx.transition.OooOO0O, androidx.transition.Transition.OooO0o
        public final void OooO00o() {
            this.f11239OooO0o0.setVisibility(4);
        }

        @Override // androidx.transition.OooOO0O, androidx.transition.Transition.OooO0o
        public final void OooO0OO() {
            this.f11239OooO0o0.setVisibility(0);
        }
        ...
        public final void OooO0o0(@NonNull Transition transition) {
            ...
            View view = this.f11238OooO0Oo;
            if (i == 28) {
                if (!oOO00O.OooOO0O.f60096OooOO0) {
                    try {
                        if (!oOO00O.OooOO0O.f60092OooO0o) {
                            try {
                                oOO00O.OooOO0O.f60093OooO0o0 = Class.forName("android.view.GhostView");
                            } catch (ClassNotFoundException e) {
                                Log.i("GhostViewApi21", "Failed to retrieve GhostView class", e);
                            }
                            oOO00O.OooOO0O.f60092OooO0o = true;
                        }
                        Method declaredMethod = oOO00O.OooOO0O.f60093OooO0o0.getDeclaredMethod("removeGhost", View.class);
                        oOO00O.OooOO0O.f60091OooO = declaredMethod;
                        declaredMethod.setAccessible(true);
                    } catch (NoSuchMethodException e2) {
                        Log.i("GhostViewApi21", "Failed to retrieve removeGhost method", e2);
                    }
                    oOO00O.OooOO0O.f60096OooOO0 = true;
                }
                Method method = oOO00O.OooOO0O.f60091OooO;
                if (method != null) {
                    try {
                ...
                int i2 = oOO00O.OooOOO0.f60098OooOO0;
                oOO00O.OooOOO0 oooOOO0 = (oOO00O.OooOOO0) view.getTag(OooOo.ghost_view);
                if (oooOOO0 != null) {
                    int i3 = oooOOO0.f60103OooO0oO - 1;
                    oooOOO0.f60103OooO0oO = i3;
                    if (i3 <= 0) {
    ...
    public static class OooO0o {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final Matrix f11240OooO00o = new Matrix();

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final View f11241OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final float[] f11242OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public float f11243OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public float f11244OooO0o0;

        public OooO0o(View view, float[] fArr) {
            this.f11241OooO0O0 = view;
            float[] fArr2 = (float[]) fArr.clone();
            this.f11242OooO0OO = fArr2;
            this.f11243OooO0Oo = fArr2[2];
            this.f11244OooO0o0 = fArr2[5];
            OooO00o();
        }

        public final void OooO00o() {
            float f = this.f11243OooO0Oo;
            float[] fArr = this.f11242OooO0OO;
            fArr[2] = f;
            fArr[5] = this.f11244OooO0o0;
            Matrix matrix = this.f11240OooO00o;
            matrix.setValues(fArr);
            o0OO00O.f60126OooO00o.OooO0Oo(this.f11241OooO0O0, matrix);
        }
    }

    public ChangeTransform() {
        this.f11228OooOoo0 = true;
        this.f11227OooOoo = true;
        this.f11229OooOooO = new Matrix();
    }
    ...
    public final void OooO(@NonNull o00oO0o o00oo0o2) {
        ...
        View view = o00oo0o2.f60123OooO0O0;
    ...
    */
    public final Animator OooOOO0(@NonNull ViewGroup viewGroup, @Nullable o00oO0o o00oo0o2, @Nullable o00oO0o o00oo0o3) {
        ...
        HashMap map = o00oo0o2.f60122OooO00o;
        if (!map.containsKey("android:changeTransform:parent")) {
            return null;
        }
        HashMap map2 = o00oo0o3.f60122OooO00o;
        ...
        if (matrix6 == null) {
            matrix6 = oOO00O.OooOo00.f60107OooO00o;
        }
        if (matrix7 == null) {
            matrix7 = oOO00O.OooOo00.f60107OooO00o;
        }
        ...
        if (matrix6.equals(matrix8)) {
            ...
            view = view6;
            Animator animatorOfPropertyValuesHolder = ObjectAnimator.ofPropertyValuesHolder(oooO0o, PropertyValuesHolder.ofObject(f11224Oooo000, new oOO00O.OooO0OO(new float[9]), fArr, fArr2), PropertyValuesHolder.ofObject(f11225Oooo00O, (TypeConverter) null, this.f11327OooOo.OooO00o(fArr[2], fArr[5], fArr2[2], fArr2[5])));
            obj = "android:changeTransform:parentMatrix";
            r13 = 1;
        ...
        boolean z5 = f11226Oooo00o;
        View view7 = o00oo0o2.f60123OooO0O0;
        if (z && animator != null && this.f11228OooOoo0) {
            Matrix matrix9 = new Matrix((Matrix) map2.get(obj));
            o0OO00O.f60126OooO00o.OooO0o(viewGroup, matrix9);
            if (Build.VERSION.SDK_INT == 28) {
                if (oOO00O.OooOO0O.f60095OooO0oo) {
                    c2 = 2;
                    c3 = 0;
                } else {
                    try {
                        if (!oOO00O.OooOO0O.f60092OooO0o) {
                            ...
                            oOO00O.OooOO0O.f60092OooO0o = r13;
                        }
                        Class<?> cls = oOO00O.OooOO0O.f60093OooO0o0;
                        ...
                        try {
                            ...
                            try {
                                ...
                                oOO00O.OooOO0O.f60094OooO0oO = declaredMethod;
                    ...
                    oOO00O.OooOO0O.f60095OooO0oo = r13;
                }
                Method method = oOO00O.OooOO0O.f60094OooO0oO;
                if (method != null) {
                    try {
                        try {
                ...
                View view8 = view;
                int i5 = 0;
                int i6 = oOO00O.OooOOO0.f60098OooOO0;
                if (!(view8.getParent() instanceof ViewGroup)) {
                    throw new IllegalArgumentException("Ghosted views must be parented by a ViewGroup");
                }
                int i7 = oOO00O.OooOO0.f60088OooO0o;
                ...
                if (oooOOO0 == null || (oooOO1 = (oOO00O.OooOO0) oooOOO0.getParent()) == oooOO2) {
                    ...
                    i = oooOOO0.f60103OooO0oO;
                    oooOO1.removeView(oooOOO0);
                    oooOOO0 = null;
                }
                if (oooOOO0 == null) {
                    oooOOO0 = new oOO00O.OooOOO0(view8);
                    oooOOO0.f60104OooO0oo = matrix9;
                    if (oooOO2 == null) {
                        oooOO2 = new oOO00O.OooOO0(viewGroup);
                    } else {
                        if (!oooOO2.f60090OooO0o0) {
                            throw new IllegalStateException("This GhostViewHolder is detached!");
                        }
                        ViewGroup viewGroup3 = oooOO2.f60089OooO0Oo;
                    ...
                    oOO00O.OooOO0.OooO00o(oooOOO0.f60101OooO0o, arrayList2);
                    ArrayList arrayList3 = new ArrayList();
                    int childCount = oooOO2.getChildCount() - r13;
                    int i8 = 0;
                    while (i8 <= childCount) {
                        int i9 = (i8 + childCount) / 2;
                        oOO00O.OooOO0.OooO00o(((oOO00O.OooOOO0) oooOO2.getChildAt(i9)).f60101OooO0o, arrayList3);
                                                        ...
                                                        if (o0Oo0oo.f60131OooO0OO) {
                                                            ...
                                                            try {
                                                                ...
                                                                try {
                                                                    ...
                                                                    o0Oo0oo.f60130OooO0O0 = declaredMethod2;
                                                            ...
                                                            z3 = true;
                                                            o0Oo0oo.f60131OooO0OO = z3;
                                                        }
                                                        Method method2 = o0Oo0oo.f60130OooO0O0;
                                                        if (method2 != null) {
                                                            c = 2;
                                                            try {
            ...
            if (oooO != null) {
                ...
                while (true) {
                    Transition transition2 = transition.f11319OooOO0o;
                    if (transition2 == null) {
                        break;
                    }
                ...
                if (z2) {
                    if (view7 != view11) {
                        o0OO00O.OooO0O0(view7, 0.0f);
                    }
                    o0OO00O.OooO0O0(view11, 1.0f);
                }
            }
        } else {
            animator2 = animator;
    ...
    public final String[] OooOOo() {
        return f11223OooOooo;
    }

    public final void Oooo0o0(o00oO0o o00oo0o2) {
        View view = o00oo0o2.f60123OooO0O0;
        ...
        if (this.f11227OooOoo) {
            ...
            o0OO00O.f60126OooO00o.OooO0o0(viewGroup, matrix2);
    ...
    public ChangeTransform(@NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        this.f11227OooOoo = true;
        this.f11229OooOooO = new Matrix();
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, o0OoOo0.f60138OooO0o0);
        XmlPullParser xmlPullParser = (XmlPullParser) attributeSet;
        this.f11228OooOoo0 = oo000o.OooO00o(typedArrayObtainStyledAttributes, xmlPullParser, "reparentWithOverlay", 1, true);
        this.f11227OooOoo = oo000o.OooO00o(typedArrayObtainStyledAttributes, xmlPullParser, "reparent", 0, true);
