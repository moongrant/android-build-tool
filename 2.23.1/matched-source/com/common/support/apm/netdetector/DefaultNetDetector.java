...
public final class DefaultNetDetector extends BaseNetDetector {
    ...
    @NotNull
    private final o0oo0000 okHttpClient;

    @NotNull
    private final DefaultNetDetectApi reportApi;

    public DefaultNetDetector(@NotNull o0oo0000 okHttpClient) {
    ...
    public void report() {
        ...
        ooo0Oo0 ooo0oo0CreateNetDetectRequest = this.reportApi.createNetDetectRequest(Sailfish.appId, Sailfish.appNameSpace, Sailfish.uniqueId, strOooO0oo);
        ...
        final BaseServerResponse<NetDetectResponse> baseServerResponse = (BaseServerResponse) BaseMonitorReportApi.syncForMetric$default(defaultNetDetectApi, ooo0oo0CreateNetDetectRequest, respType, null, 4, null);
