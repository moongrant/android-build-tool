...
public final class RoomGiftVideoPlayManager {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i != 0) {
                ...
                if (videoModel2.isDownloadUrl()) {
                    File file2 = o0oOo0O0.f47829OooO00o;
                    File file3 = new File(o0oOo0O0.OooO0OO(), fileNameByUrl);
                    if (file3.exists()) {
    ...
    public static final class C08741 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
    ...
    public final Object realPlay(File file, VideoModel videoModel, Continuation<? super Unit> continuation) {
        ...
        if (i2 == 0) {
            ...
            if (i3 == 1 || i3 == 2) {
                ...
                c08741.L$0 = this;
                c08741.L$1 = videoModel;
                c08741.label = 1;
                if (yyEvaVideoView.play(file, videoModel, c08741) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                ...
                if (svgaView2 != null) {
                    ...
                    c08741.L$1 = videoModel;
                    c08741.label = 2;
                    objPlay = svgaView2.play(file, videoModel, c08741);
            ...
            videoModel = (VideoModel) c08741.L$1;
            roomGiftVideoPlayManager = (RoomGiftVideoPlayManager) c08741.L$0;
            ResultKt.throwOnFailure(objPlay);
            RoomGiftVideoPlayDownloadManager.INSTANCE.log("play YYEva end url: " + videoModel.getUrl());
        } else {
            if (i2 != 2) {
            ...
            videoModel2 = (VideoModel) c08741.L$1;
            roomGiftVideoPlayManager2 = (RoomGiftVideoPlayManager) c08741.L$0;
            ResultKt.throwOnFailure(objPlay);
    ...
    public final void addItem(@NotNull VideoModel model) {
        ...
        File fileOooO0OO = o0oOo0O0.OooO0OO();
