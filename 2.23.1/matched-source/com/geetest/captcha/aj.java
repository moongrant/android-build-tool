    ...
    public static final class b {
        ...
        public static final class a implements Runnable {
            ...
            public final void run() {
                b.this.b.evaluateJavascript(o0oOO.OooO00o(new StringBuilder("javascript:jsBridge.callback('postNativeMessage', '"), this.b, "')"), new ValueCallback<String>() { // from class: com.geetest.captcha.aj.b.a.1
        ...
        public final void gt4Notify(@Nullable String response) throws JSONException {
            ag agVar = ag.a;
            StringBuilder sbOooO0O0 = o0OoOo0.OooO0O0("JSInterface.gt4Notify: ", response, ", main: ");
            sbOooO0O0.append(Intrinsics.areEqual(Looper.getMainLooper(), Looper.myLooper()));
            ag.b(sbOooO0O0.toString());
