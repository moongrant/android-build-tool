...
public final class Field extends GeneratedMessageV3 implements FieldOrBuilder {
    ...
    public int hashCode() {
        ...
        int iHashBoolean = Internal.hashBoolean(getPacked()) + ((((getOneofIndex() + ((((getTypeUrl().hashCode() + ((((getName().hashCode() + ((((getNumber() + o00OOO.OooO00o.OooO00o(o00OOO.OooO00o.OooO00o((((getDescriptor().hashCode() + 779) * 37) + 1) * 53, this.kind_, 37, 2, 53), this.cardinality_, 37, 3, 53)) * 37) + 4) * 53)) * 37) + 6) * 53)) * 37) + 7) * 53)) * 37) + 8) * 53);
