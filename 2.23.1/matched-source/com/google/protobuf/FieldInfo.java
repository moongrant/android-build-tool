...
final class FieldInfo implements Comparable<FieldInfo> {
    ...
    private static void checkFieldNumber(int i) {
        if (i <= 0) {
            throw new IllegalArgumentException(android.support.v4.media.OooO00o.OooO00o("fieldNumber must be positive: ", i));
        }
    }
    ...
    public static FieldInfo forProto2OptionalField(java.lang.reflect.Field field, int i, FieldType fieldType, java.lang.reflect.Field field2, int i2, boolean z, Internal.EnumVerifier enumVerifier) {
        ...
        throw new IllegalArgumentException(android.support.v4.media.OooO00o.OooO00o("presenceMask must have exactly one bit set: ", i2));
    }
