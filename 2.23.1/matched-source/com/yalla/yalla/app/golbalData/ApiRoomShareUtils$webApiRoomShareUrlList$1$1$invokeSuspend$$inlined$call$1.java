...
import p382o0OOoOo.o00Ooo;
import p382o0OOoOo.o00oO0o;
import p382o0OOoOo.o0ooOOo;
import p385o0OOoo0.OooOo;
import p385o0OOoo0.OooOo00;
import p385o0OOoo0.Oooo000;
...
public final class ApiRoomShareUtils$webApiRoomShareUrlList$1$1$invokeSuspend$$inlined$call$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<Object>>, Object> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public int f22253OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ o0ooOOo f22254OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ApiRoomShareUtils$webApiRoomShareUrlList$1$1$invokeSuspend$$inlined$call$1(o0ooOOo o0ooooo, Continuation continuation) {
        super(2, continuation);
        this.f22254OooO0o0 = o0ooooo;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new ApiRoomShareUtils$webApiRoomShareUrlList$1$1$invokeSuspend$$inlined$call$1(this.f22254OooO0o0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ApiResult<Object>> continuation) {
        return ((ApiRoomShareUtils$webApiRoomShareUrlList$1$1$invokeSuspend$$inlined$call$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f22253OooO0Oo;
        Object obj2 = null;
        try {
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                o0ooOOo o0ooooo = this.f22254OooO0o0;
            ...
            o00Ooo o00ooo2 = o00Ooo.f43254OooO00o;
            Type type = new TypeToken<ApiResult<Object>>() { // from class: com.yalla.yalla.app.golbalData.ApiRoomShareUtils$webApiRoomShareUrlList$1$1$invokeSuspend$$inlined$call$1.1
            }.getType();
            o00ooo2.getClass();
            String strOooO00o = o00Ooo.OooO00o((oO0000o0) obj);
            Intrinsics.checkNotNull(type);
            ApiResult apiResult = (ApiResult) OooO.OooO0OO(strOooO00o, type);
            if (apiResult == null) {
                ...
                Function2<? super String, ? super Throwable, Unit> function2 = com.code.android.json.OooO00o.f13217OooO00o;
                Type type2 = new TypeToken<Object>() { // from class: com.yalla.yalla.app.golbalData.ApiRoomShareUtils$webApiRoomShareUrlList$1$1$invokeSuspend$$inlined$call$1.2
                }.getType();
                Intrinsics.checkNotNullExpressionValue(type2, "getType(...)");
                Object objOooO0Oo = com.code.android.json.OooO00o.OooO0Oo(strOooO00o, type2);
                if (objOooO0Oo instanceof Object) {
                    obj2 = objOooO0Oo;
                }
            ...
            OooOOOO.OooO0o0("WebAPIException", e3.getMessage(), e3);
