...
public final class SharedMainMessageManager extends p396o0Oo0.OooOO0 {
    ...
    public static final class OooO extends Lambda implements Function1<Boolean, Unit> {
        ...
        public static final OooO f22326OooO0Oo = new OooO();
    ...
    public static final class OooO00o extends Lambda implements Function1<Boolean, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO00o f22327OooO0Oo = new OooO00o();
    ...
    public static final class OooO0O0 extends Lambda implements Function1<Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO0O0 f22328OooO0Oo = new OooO0O0();
    ...
    public static final class OooO0OO extends Lambda implements Function1<Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO0OO f22329OooO0Oo = new OooO0OO();
    ...
    public static final class OooO0o extends Lambda implements Function1<Boolean, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO0o f22330OooO0Oo = new OooO0o();
    ...
    public static final class OooOO0 extends Lambda implements Function1<Boolean, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooOO0 f22331OooO0Oo = new OooOO0();
    ...
    public static final class OooOO0O extends Lambda implements Function1<Boolean, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooOO0O f22332OooO0Oo = new OooOO0O();
    ...
    public static final class OooOOO extends Lambda implements Function1<Boolean, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooOOO f22333OooO0Oo = new OooOOO();
    ...
    public static final class OooOOO0 implements Observer, FunctionAdapter {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function1 f22334OooO0Oo;

        public OooOOO0(Function1 function) {
            Intrinsics.checkNotNullParameter(function, "function");
            this.f22334OooO0Oo = function;
        }
        ...
        public final boolean equals(@Nullable Object obj) {
            ...
            return Intrinsics.areEqual(this.f22334OooO0Oo, ((FunctionAdapter) obj).getFunctionDelegate());
        }

        @Override // kotlin.jvm.internal.FunctionAdapter
        @NotNull
        public final Function<?> getFunctionDelegate() {
            return this.f22334OooO0Oo;
        }

        public final int hashCode() {
            return this.f22334OooO0Oo.hashCode();
        }

        @Override // androidx.lifecycle.Observer
        public final /* synthetic */ void onChanged(Object obj) {
            this.f22334OooO0Oo.invoke(obj);
        }
    }
    ...
    public static final class OooOOOO extends Lambda implements Function1<Boolean, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooOOOO f22335OooO0Oo = new OooOOOO();
    ...
    public static final class OooOo extends Lambda implements Function1<Boolean, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooOo f22336OooO0Oo = new OooOo();
    ...
    public static final class OooOo00 extends Lambda implements Function1<Boolean, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooOo00 f22337OooO0Oo = new OooOo00();
    ...
    public static final class Oooo0 extends Lambda implements Function1<Boolean, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final Oooo0 f22338OooO0Oo = new Oooo0();
    ...
    public static final class Oooo000 extends Lambda implements Function1<Boolean, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final Oooo000 f22339OooO0Oo = new Oooo000();
    ...
    public static final class o000oOoO extends Lambda implements Function1<Boolean, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final o000oOoO f22340OooO0Oo = new o000oOoO();
    ...
    public static final class o00O0O extends Lambda implements Function1<Boolean, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final o00O0O f22341OooO0Oo = new o00O0O();
    ...
    public static final class o00Oo0 extends Lambda implements Function1<Boolean, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final o00Oo0 f22342OooO0Oo = new o00Oo0();
    ...
    public static final class o0OoOo0 extends Lambda implements Function1<Boolean, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final o0OoOo0 f22343OooO0Oo = new o0OoOo0();
    ...
    static {
        ...
        oo0oO0.OooOo0O().observeForever(new OooOOO0(OooO00o.f22327OooO0Oo));
    ...
    public final MediatorLiveData<Boolean> getDrawUserDot() {
        if (drawUserDot == null) {
            ...
            Intrinsics.checkNotNull(newFansNum2);
            mediatorLiveData.addSource(newFansNum2, new OooOOO0(OooO0O0.f22328OooO0Oo));
            LiveData newVisitorNum2 = sharedMainMessageManager.getNewVisitorNum();
            Intrinsics.checkNotNull(newVisitorNum2);
            mediatorLiveData.addSource(newVisitorNum2, new OooOOO0(OooO0OO.f22329OooO0Oo));
    ...
    public final MediatorLiveData<Boolean> getDrawerTaskDot() {
        if (drawerTaskDot == null) {
            MediatorLiveData<Boolean> mediatorLiveData = new MediatorLiveData<>();
            mediatorLiveData.addSource(isSignIn, new OooOOO0(OooO0o.f22330OooO0Oo));
            mediatorLiveData.addSource(haveRewardTask, new OooOOO0(OooO.f22326OooO0Oo));
            mediatorLiveData.addSource(haveAchievementRewardTask, new OooOOO0(OooOO0.f22331OooO0Oo));
    ...
    public final LiveData<Integer> getNewFansNum() {
        if (newFansNum == null) {
            o0O o0oOooo000 = p410o0Oo0Oo0.o00O0O.OooO00o().Oooo000();
            oo0oO0 oo0oo0 = oo0oO0.f47967OooO00o;
    ...
    public final MediatorLiveData<Boolean> getPremiumDot() {
        if (premiumDot == null) {
            MediatorLiveData<Boolean> mediatorLiveData = new MediatorLiveData<>();
            mediatorLiveData.addSource(premiumMomentEditRedDot, new OooOOO0(OooOO0O.f22332OooO0Oo));
    ...
    public final MediatorLiveData<Boolean> getStoreDot() {
        if (storeDot == null) {
            MediatorLiveData<Boolean> mediatorLiveData = new MediatorLiveData<>();
            mediatorLiveData.addSource(uniqueMessageDot, new OooOOO0(OooOOO.f22333OooO0Oo));
            mediatorLiveData.addSource(userVehicleMessageDot, new OooOOO0(OooOOOO.f22335OooO0Oo));
            mediatorLiveData.addSource(storeBubbleDot, new OooOOO0(OooOo00.f22337OooO0Oo));
    ...
    public final MediatorLiveData<Boolean> getUserDot() {
        if (userDot == null) {
            MediatorLiveData<Boolean> mediatorLiveData = new MediatorLiveData<>();
            mediatorLiveData.addSource(isSignIn, new OooOOO0(OooOo.f22336OooO0Oo));
            mediatorLiveData.addSource(haveRewardTask, new OooOOO0(Oooo000.f22339OooO0Oo));
            mediatorLiveData.addSource(haveAchievementRewardTask, new OooOOO0(Oooo0.f22338OooO0Oo));
            mediatorLiveData.addSource(uniqueMessageDot, new OooOOO0(o000oOoO.f22340OooO0Oo));
            mediatorLiveData.addSource(userVehicleMessageDot, new OooOOO0(o0OoOo0.f22343OooO0Oo));
            mediatorLiveData.addSource(storeBubbleDot, new OooOOO0(o00O0O.f22341OooO0Oo));
            mediatorLiveData.addSource(premiumMomentEditRedDot, new OooOOO0(o00Oo0.f22342OooO0Oo));
