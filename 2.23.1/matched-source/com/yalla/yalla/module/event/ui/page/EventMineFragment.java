...
@Metadata(d1 = {"\u0000<\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010!\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0007\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007¢\u0006\u0004\b\u0016\u0010\u0017J\u001a\u0010\u0007\u001a\u00020\u00022\u0006\u0010\u0004\u001a\u00020\u00032\b\u0010\u0006\u001a\u0004\u0018\u00010\u0005H\u0016J\b\u0010\t\u001a\u00020\bH\u0014R\u001b\u0010\u000f\u001a\u00020\n8BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u000b\u0010\f\u001a\u0004\b\r\u0010\u000eR\u001a\u0010\u0012\u001a\b\u0012\u0004\u0012\u00020\u00110\u00108\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0012\u0010\u0013R\u001a\u0010\u0015\u001a\b\u0012\u0004\u0012\u00020\u00140\u00108\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0015\u0010\u0013¨\u0006\u0018"}, d2 = {"Lcom/yalla/yalla/module/event/ui/page/EventMineFragment;", "Lo0o0OO0/o00OO0O0;", "Lo0Oo0OOO/o0O0O0Oo;", "Landroid/view/LayoutInflater;", "inflater", "Landroid/view/ViewGroup;", "container", "getViewBinding", "", "onLazyInit", "Lcom/yalla/yalla/module/event/vm/EventDisplayViewModel;", "displayVM$delegate", "Lkotlin/Lazy;", "getDisplayVM", "()Lcom/yalla/yalla/module/event/vm/EventDisplayViewModel;", "displayVM", "", "", "titles", "Ljava/util/List;", "Lcom/yalla/yalla/module/event/ui/page/EventDisplayChildFragment;", "fragments", "<init>", "()V", "Event_YallaRelease"}, k = 1, mv = {1, 9, 0})
@SourceDebugExtension({"SMAP\nEventMineFragment.kt\nKotlin\n*S Kotlin\n*F\n+ 1 EventMineFragment.kt\ncom/yalla/yalla/module/event/ui/page/EventMineFragment\n+ 2 FragmentViewModelLazy.kt\nandroidx/fragment/app/FragmentViewModelLazyKt\n*L\n1#1,68:1\n172#2,9:69\n*S KotlinDebug\n*F\n+ 1 EventMineFragment.kt\ncom/yalla/yalla/module/event/ui/page/EventMineFragment\n*L\n22#1:69,9\n*E\n"})
public final class EventMineFragment extends o00OO0O0<o0O0O0Oo> {
    ...
    private final Lazy displayVM = o000Oo0.OooO0O0(this, Reflection.getOrCreateKotlinClass(EventDisplayViewModel.class), new Function0<ViewModelStore>() { // from class: com.yalla.yalla.module.event.ui.page.EventMineFragment$special$$inlined$activityViewModels$default$1
        ...
        public final /* synthetic */ Function0 f23198OooO0Oo = null;
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f23198OooO0Oo;
    ...
    @NotNull
    private final List<String> titles = CollectionsKt.mutableListOf(o0000.OooO0OO(o000OOo.event_mine_subscribe), o0000.OooO0OO(o000OOo.event_mine_creator));

    public static final class OooO00o extends Lambda implements Function1<View, Unit> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO00o f23196OooO0Oo = new OooO00o();
    ...
    public static final void onLazyInit$lambda$0(EventMineFragment this$0, Object obj) {
        ...
        h0.OooO0OO("101003", obj instanceof Map ? (Map) obj : null);
        this$0.getDisplayVM().setEventPageState(EventPage.MineCreator);
        RtlViewPager rtlViewPager = this$0.getBinding().f44477OooO0OO;
    ...
    public void onLazyInit() {
        super.onLazyInit();
        ImageView ivSetting = getBinding().f44476OooO0O0;
        Intrinsics.checkNotNullExpressionValue(ivSetting, "ivSetting");
        o000O.OooO0oo(ivSetting, OooO00o.f23196OooO0Oo);
        Context context = getBinding().f44477OooO0OO.getContext();
        Intrinsics.checkNotNullExpressionValue(context, "getContext(...)");
        Intrinsics.checkNotNullParameter(context, "context");
        a.OooO00o oooO00o = new a.OooO00o(context);
        oooO00o.OooO0O0(this.titles);
        oooO00o.f56182OooO0o0 = o0000.OooO00o(o0ooOOo.color_333333);
        oooO00o.f56184OooO0oo = o0000.OooO00o(o0ooOOo.color_999999);
        float f = 8;
        oooO00o.f56197OooOo0O = o0000O0.OooO00o(f);
        oooO00o.f56180OooO0Oo = 15.0f;
        oooO00o.f56179OooO0OO = 15.0f;
        oooO00o.f56195OooOo0 = o0000O0.OooO00o(f);
        oooO00o.f56184OooO0oo = o0000.OooO00o(o0ooOOo.color_alpha_38_A3);
        RtlViewPager vpEvent = getBinding().f44477OooO0OO;
        Intrinsics.checkNotNullExpressionValue(vpEvent, "vpEvent");
        oooO00o.OooO0Oo(vpEvent);
        oooO00o.f56176OooO = o0000O0.OooO00o(2);
        oooO00o.f56185OooOO0 = o0000.OooO00o(o0ooOOo.color_00d8c9);
        oooO00o.f56186OooOO0O = o0000O0.OooO00o(12);
        oooO00o.f56187OooOO0o = o0000O0.OooO00o(3);
        int i = 0;
        oooO00o.f56177OooO00o.setAdjustMode(false);
        YlTableLayout ylEvent = getBinding().f44478OooO0Oo;
        Intrinsics.checkNotNullExpressionValue(ylEvent, "ylEvent");
        oooO00o.OooO00o(ylEvent);
        getBinding().f44477OooO0OO.setOffscreenPageLimit(this.fragments.size());
        RtlViewPager rtlViewPager = getBinding().f44477OooO0OO;
        FragmentManager childFragmentManager = getChildFragmentManager();
        Intrinsics.checkNotNullExpressionValue(childFragmentManager, "getChildFragmentManager(...)");
        rtlViewPager.setAdapter(new o0oO0O0o(childFragmentManager, this.fragments));
        RtlViewPager rtlViewPager2 = getBinding().f44477OooO0OO;
        ...
        LiveEventBus.get("EVENT_CREATE_SUCCESS").observe(this, new Observer() { // from class: o0OoOoo.o00O00OO
            ...
            public final void onChanged(Object obj) {
                EventMineFragment.onLazyInit$lambda$0(this.f47406OooO0Oo, obj);
            }
        });
    }
