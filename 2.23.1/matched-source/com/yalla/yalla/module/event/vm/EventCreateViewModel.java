...
public final class EventCreateViewModel extends OooOO0 {
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<o00OO00O<ApiResult<Long>>, Continuation<? super Unit>, Object> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public String f23614OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public long f23615OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public long f23616OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public int f23617OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public /* synthetic */ Object f23618OooO0oo;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public final /* synthetic */ String f23619OooOO0;

        /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
        public final /* synthetic */ String f23620OooOO0O;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(String str, String str2, Continuation<? super OooO00o> continuation) {
            super(2, continuation);
            this.f23619OooOO0 = str;
            this.f23620OooOO0O = str2;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO00o oooO00o = EventCreateViewModel.this.new OooO00o(this.f23619OooOO0, this.f23620OooOO0O, continuation);
            oooO00o.f23618OooO0oo = obj;
            return oooO00o;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(o00OO00O<ApiResult<Long>> o00oo00o, Continuation<? super Unit> continuation) {
            return ((OooO00o) create(o00oo00o, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i2 = this.f23617OooO0oO;
            EventCreateViewModel eventCreateViewModel = EventCreateViewModel.this;
            if (i2 != 0) {
                if (i2 == 1) {
                    o00oo00o = (o00OO00O) this.f23618OooO0oo;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i2 != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                    }
                    j2 = this.f23615OooO0o;
                    j = this.f23616OooO0o0;
                    str = this.f23614OooO0Oo;
                    o00oo00o2 = (o00OO00O) this.f23618OooO0oo;
                    ResultKt.throwOnFailure(obj);
                }
            ...
            if (eventCreateViewModel.getHeadPath().length() > 0) {
                if (eventCreateViewModel.getHeadUrl().length() == 0) {
                    ...
                    this.f23618OooO0oo = o00oo00o;
                    this.f23617OooO0oO = 1;
            ...
            while (i >= 0) {
                i--;
                describe = StringsKt__StringsJVMKt.replace$default(describe, "\n\n", "\n", false, 4, (Object) null);
            }
            ...
            this.f23618OooO0oo = o00oo00o2;
            this.f23614OooO0Oo = describe;
            this.f23616OooO0o0 = timeInMillis;
            this.f23615OooO0o = timeInMillis2;
            this.f23617OooO0oO = 2;
            String strOooO0O0 = oo000o.OooO0O0("/Webservers/Event/Create");
            o0ooOOo o0oooooOooO00o = com.common.support.apm.netdetector.OooO00o.OooO00o(strOooO0O0, "url", strOooO0O0, 1);
            o0oooooOooO00o.OooO0O0(this.f23619OooOO0, "createToken");
            o0oooooOooO00o.OooO0O0(this.f23620OooOO0O, "RoomId");
            o0oooooOooO00o.OooO0O0(name, "EventName");
            o0oooooOooO00o.OooO0O0(Boxing.boxInt(id), "KeyWord");
            o0oooooOooO00o.OooO0O0(tagName, "KeyWordText");
            o0oooooOooO00o.OooO0O0(headUrl, "Pic");
            o0oooooOooO00o.OooO0O0(Boxing.boxLong(timeInMillis), "StartTime");
            o0oooooOooO00o.OooO0O0(Boxing.boxLong(timeInMillis2), "EndTime");
            o0oooooOooO00o.OooO0O0(describe, "EventDesc");
            objOooO0Oo = OooOOO.OooO0Oo(new EventRepo$create$$inlined$call$1(o0oooooOooO00o, null), this);
            ...
            if (oooO0o != null) {
                if (oooO0o.OooO00o().length() > 0) {
                    eventCreateViewModel.setHeadUrl(oooO0o.OooO00o());
                }
            }
            o00oo00o2 = o00oo00o;
            long j4 = 1000;
            ...
            this.f23615OooO0o = timeInMillis2;
            this.f23617OooO0oO = 2;
            String strOooO0O1 = oo000o.OooO0O0("/Webservers/Event/Create");
            o0ooOOo o0oooooOooO00o2 = com.common.support.apm.netdetector.OooO00o.OooO00o(strOooO0O1, "url", strOooO0O1, 1);
            o0oooooOooO00o2.OooO0O0(this.f23619OooOO0, "createToken");
            o0oooooOooO00o2.OooO0O0(this.f23620OooOO0O, "RoomId");
            o0oooooOooO00o2.OooO0O0(name2, "EventName");
            o0oooooOooO00o2.OooO0O0(Boxing.boxInt(id), "KeyWord");
            o0oooooOooO00o2.OooO0O0(tagName, "KeyWordText");
            o0oooooOooO00o2.OooO0O0(headUrl2, "Pic");
            o0oooooOooO00o2.OooO0O0(Boxing.boxLong(timeInMillis), "StartTime");
            o0oooooOooO00o2.OooO0O0(Boxing.boxLong(timeInMillis2), "EndTime");
            o0oooooOooO00o2.OooO0O0(describe, "EventDesc");
            objOooO0Oo = OooOOO.OooO0Oo(new EventRepo$create$$inlined$call$1(o0oooooOooO00o2, null), this);
            if (objOooO0Oo == coroutine_suspended) {
                return coroutine_suspended;
            }
            str = describe;
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public Object f23621OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public int f23623OooO0o0;
        ...
        public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ ApiResult<List<EventTagModel>> f23624OooO0Oo;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public final /* synthetic */ EventCreateViewModel f23625OooO0o0;
            ...
            public OooO00o(ApiResult<List<EventTagModel>> apiResult, EventCreateViewModel eventCreateViewModel, Continuation<? super OooO00o> continuation) {
                super(2, continuation);
                this.f23624OooO0Oo = apiResult;
                this.f23625OooO0o0 = eventCreateViewModel;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                return new OooO00o(this.f23624OooO0Oo, this.f23625OooO0o0, continuation);
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                ResultKt.throwOnFailure(obj);
                ApiResult<List<EventTagModel>> apiResult = this.f23624OooO0Oo;
                if (apiResult.isSuccess() && (data = apiResult.getData()) != null) {
                    EventCreateViewModel eventCreateViewModel = this.f23625OooO0o0;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            eventCreateViewModel.getShowLoadingDialog().setValue(Boxing.boxBoolean(true));
            this.f23623OooO0o0 = 1;
            String strOooO0O0 = oo000o.OooO0O0("/Webservers/Event/GetTagList");
            obj = OooOOO.OooO0Oo(new EventRepo$getTagList$$inlined$call$1(com.common.support.apm.netdetector.OooO00o.OooO00o(strOooO0O0, "url", strOooO0O0, 0), null), this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            MainCoroutineDispatcher main = Dispatchers.getMain();
            OooO00o oooO00o = new OooO00o((ApiResult) obj, eventCreateViewModel, null);
            this.f23621OooO0Oo = obj;
            this.f23623OooO0o0 = 2;
    ...
    @NotNull
    public final o00OO00O<ApiResult<Long>> create(@NotNull String createToken, @NotNull String roomId) {
        Intrinsics.checkNotNullParameter(createToken, "createToken");
        Intrinsics.checkNotNullParameter(roomId, "roomId");
        return oo0oOO0.OooO00o(this, new OooO00o(createToken, roomId, null));
    }
    ...
    public final void m4201getTagList() {
