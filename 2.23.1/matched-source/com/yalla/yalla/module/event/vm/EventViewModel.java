...
public class EventViewModel extends OooOO0 {
    ...
    @NotNull
    private final String today = o0000.OooO0OO(o000OOo.Room_Event_Today);

    @NotNull
    private final String weekly = o0000.OooO0OO(o000OOo.Room_Event_This_Week);

    @NotNull
    private final String nextWeekly = o0000.OooO0OO(o000OOo.Room_Event_Next_Week);
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public int f23652OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ MutableSharedFlow<ApiResult<EventCreateStateModel>> f23653OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ long f23654OooO0o0;
        ...
        public OooO00o(long j, MutableSharedFlow<ApiResult<EventCreateStateModel>> mutableSharedFlow, Continuation<? super OooO00o> continuation) {
            ...
            this.f23654OooO0o0 = j;
            this.f23653OooO0o = mutableSharedFlow;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO00o(this.f23654OooO0o0, this.f23653OooO0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            o0oooooOooO00o.OooO0O0(Boxing.boxLong(this.f23654OooO0o0), ContributionFragment.ARG_1);
            obj = OooOOO.OooO0Oo(new EventRepo$getCreateEventState$$inlined$call$1(o0oooooOooO00o, null), this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f23652OooO0Oo = 2;
            if (this.f23653OooO0o.emit((ApiResult) obj, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
        }
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f23655OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                EventRepo eventRepo = EventRepo.f22467OooO00o;
                this.f23655OooO0Oo = 1;
    ...
    public static final class OooO0OO extends Lambda implements Function1<Boolean, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO0OO f23657OooO0Oo = new OooO0OO();
    ...
    public static final class OooO0o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f23658OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ EventModel f23659OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ EventViewModel f23660OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ Function1<Boolean, Unit> f23661OooO0oO;
        ...
        public static final class OooO00o extends SuspendLambda implements Function2<ApiResult<EventSubscribeModel>, Continuation<? super Unit>, Object> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ EventViewModel f23662OooO0Oo;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public OooO00o(EventViewModel eventViewModel, Continuation<? super OooO00o> continuation) {
                super(2, continuation);
                this.f23662OooO0Oo = eventViewModel;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                return new OooO00o(this.f23662OooO0Oo, continuation);
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                ResultKt.throwOnFailure(obj);
                this.f23662OooO0Oo.getShowLoadingDialog().setValue(Boxing.boxBoolean(false));
                return Unit.INSTANCE;
            }
        }
        ...
        public static final class OooO0O0 extends SuspendLambda implements Function2<EventSubscribeModel, Continuation<? super Unit>, Object> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public int f23663OooO0Oo;

            /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
            public final /* synthetic */ EventModel f23664OooO0o;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public /* synthetic */ Object f23665OooO0o0;

            /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
            public final /* synthetic */ EventViewModel f23666OooO0oO;

            /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
            public final /* synthetic */ Function1<Boolean, Unit> f23667OooO0oo;

            public static final class OooO00o extends Lambda implements Function1<Boolean, Unit> {

                /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
                public final /* synthetic */ EventViewModel f23668OooO0Oo;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public OooO00o(EventViewModel eventViewModel) {
                    super(1);
                    this.f23668OooO0Oo = eventViewModel;
                }

                @Override // kotlin.jvm.functions.Function1
                public final Unit invoke(Boolean bool) {
                    if (bool.booleanValue()) {
                        this.f23668OooO0Oo.getShowAddToCalendarDialog().setValue(Boolean.TRUE);
                    }
                    return Unit.INSTANCE;
                }
            }
            ...
            public static final class C0302OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
                public final /* synthetic */ EventModel f23669OooO0Oo;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C0302OooO0O0(EventModel eventModel, Continuation<? super C0302OooO0O0> continuation) {
                    super(2, continuation);
                    this.f23669OooO0Oo = eventModel;
                }

                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                @NotNull
                public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                    return new C0302OooO0O0(this.f23669OooO0Oo, continuation);
                }
                ...
                public final Object invokeSuspend(@NotNull Object obj) {
                    ...
                    String title = this.f23669OooO0Oo.getEventName();
            ...
            public OooO0O0(EventModel eventModel, EventViewModel eventViewModel, Continuation continuation, Function1 function1) {
                super(2, continuation);
                this.f23664OooO0o = eventModel;
                this.f23666OooO0oO = eventViewModel;
                this.f23667OooO0oo = function1;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                OooO0O0 oooO0O0 = new OooO0O0(this.f23664OooO0o, this.f23666OooO0oO, continuation, this.f23667OooO0oo);
                oooO0O0.f23665OooO0o0 = obj;
                return oooO0O0;
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                int i = this.f23663OooO0Oo;
                EventModel eventModel = this.f23664OooO0o;
                if (i == 0) {
                    ResultKt.throwOnFailure(obj);
                    eventSubscribeModel = (EventSubscribeModel) this.f23665OooO0o0;
                    boolean hasSubscribe = eventModel.getHasSubscribe();
                    EventViewModel eventViewModel = this.f23666OooO0oO;
                    if (hasSubscribe) {
                        eventViewModel.getShowAddToCalendarDialog().setValue(Boxing.boxBoolean(false));
                        if (com.yalla.yalla.util.permission.OooO00o.OooO00o(o000O00O.OooO00o(), PermissionGroupReveal.f32342OooO0O0)) {
                            CoroutineDispatcher io2 = Dispatchers.getIO();
                            C0302OooO0O0 c0302OooO0O0 = new C0302OooO0O0(eventModel, null);
                            this.f23665OooO0o0 = eventSubscribeModel;
                            this.f23663OooO0Oo = 1;
                        ...
                        if (activityOooO0O0 != null) {
                            com.yalla.yalla.util.permission.OooO00o.OooO0OO(activityOooO0O0, PermissionGroupReveal.f32342OooO0O0, null, new OooO00o(eventViewModel));
                        }
                    }
                    ...
                    this.f23667OooO0oo.invoke(Boxing.boxBoolean(!eventModel.getHasSubscribe()));
                    return Unit.INSTANCE;
                }
                if (i != 1) {
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                }
                eventSubscribeModel2 = (EventSubscribeModel) this.f23665OooO0o0;
                ResultKt.throwOnFailure(obj);
                eventSubscribeModel = eventSubscribeModel2;
                LiveEventBus.get("EVENT_UPDATE_SUBSCRIBE_NUMBER").post(new SubscribeNotifyModel(eventModel.getId(), !eventModel.getHasSubscribe(), eventSubscribeModel != null ? eventSubscribeModel.getSubCount() : 0));
                this.f23667OooO0oo.invoke(Boxing.boxBoolean(!eventModel.getHasSubscribe()));
        ...
        public OooO0o(EventModel eventModel, EventViewModel eventViewModel, Continuation continuation, Function1 function1) {
            super(2, continuation);
            this.f23660OooO0o0 = eventViewModel;
            this.f23659OooO0o = eventModel;
            this.f23661OooO0oO = function1;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0o(this.f23659OooO0o, this.f23660OooO0o0, continuation, this.f23661OooO0oO);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f23658OooO0Oo;
            EventModel eventModel = this.f23659OooO0o;
            EventViewModel eventViewModel = this.f23660OooO0o0;
            if (i != 0) {
                if (i == 1) {
                    ResultKt.throwOnFailure(obj);
                } else {
            ...
            OooO0O0 oooO0O0 = new OooO0O0(eventModel, eventViewModel, null, this.f23661OooO0oO);
            this.f23658OooO0Oo = 2;
            if (o00Oo0.OooO0OO(apiResult, false, oooO00o, null, oooO0O0, this, 5) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
        }
    ...
    public static /* synthetic */ void subscribeEvent$default(EventViewModel eventViewModel, EventModel eventModel, Function1 function1, int i, Object obj) {
        ...
        if ((i & 2) != 0) {
            function1 = OooO0OO.f23657OooO0Oo;
        }
