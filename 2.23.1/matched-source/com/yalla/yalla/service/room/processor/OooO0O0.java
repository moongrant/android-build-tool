...
public final class OooO0O0 implements com.yalla.yalla.service.room.processor.OooO00o {
    ...
    @NotNull
    public static final OooO0O0 f24630OooO00o = new OooO0O0();
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public int f24631OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ ChatModel f24632OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(ChatModel chatModel, Continuation<? super OooO00o> continuation) {
            super(2, continuation);
            this.f24632OooO0o0 = chatModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO00o(this.f24632OooO0o0, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f24631OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                this.f24631OooO0Oo = 1;
            ...
            MixedRoomDataSource.OooO0o0().OooO00o(this.f24632OooO0o0);
    ...
    public final void OooO0O0(@NotNull InOutRoomModel inOutRoomModel) {
        ...
        p597o0oo00O.OooOOOO.OooO0OO(com.yalla.yalla.service.room.processor.OooO00o.C0318OooO00o.OooO00o(this), " OtherUserLoginRoom = " + inOutRoomModel);
    ...
    public final void OooO0Oo(@NotNull SkillCardModel model) {
        ...
        if (Intrinsics.areEqual(value, oo0oO0.OooOOo0().getValue())) {
            ...
            chatModel.setMessage(o0000.OooO0OO(o000OOo.send_you) + ZegoConstants.ZegoVideoDataAuxPublishingStream + o0000.OooO0OO(o000OOo.Hats));
            MixedRoomDataSource.OooO0o0().OooO00o(chatModel);
        }
    }
    ...
    public final void OooO0o(int i, @Nullable Object obj) {
        ...
        if (i != 1001201 || (roomContributionUpModel = (RoomContributionUpModel) p187o00o00o0.OooO.OooO0O0(RoomContributionUpModel.class, new String((byte[]) obj, Charsets.UTF_8))) == null || (changeUsers = roomContributionUpModel.getChangeUsers()) == null) {
            return;
        }
    ...
    public final void OooO0o0(@NotNull Room.MagicVoiceOut model) {
        ...
        if (l != null && userId == l.longValue()) {
            ...
            String strOooO00o = oO000O0O.OooO00o(model.getCardid());
            int cardid2 = model.getCardid();
            Intrinsics.checkNotNull(strOooO00o);
            chatModel.setMagicVoiceInfo(new ChatModel.MagicVoiceInfo(cardid2, strOooO00o));
            ...
            chatModel.setMessage(o0000.OooO0OO(o000OOo.message_room_send_voice_changer));
            MixedRoomDataSource.OooO0o0().OooO00o(chatModel);
        }
    }
}
