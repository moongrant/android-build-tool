...
public final class OooOo00 extends Lambda implements Function1<Object, Unit> {
    ...
    public final /* synthetic */ SmsCodeActivity f24769OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ String f24770OooO0o0;
    ...
    public OooOo00(SmsCodeActivity smsCodeActivity, String str) {
        super(1);
        this.f24769OooO0Oo = smsCodeActivity;
        this.f24770OooO0o0 = str;
    }

    @Override // kotlin.jvm.functions.Function1
    public final Unit invoke(Object obj) {
        SmsCodeActivity activity = this.f24769OooO0Oo;
        ClientCodeType clientCodeType = activity.f24850OooOo0O;
        int i = clientCodeType == null ? -1 : OooO00o.$EnumSwitchMapping$0[clientCodeType.ordinal()];
        String str = this.f24770OooO0o0;
        switch (i) {
            case 1:
                int i2 = PasswordActivity.f24771OooOoOO;
                PasswordActivity.OooO00o.OooO00o(activity, activity.f24847OooOo, null, str, activity.f24850OooOo0O);
                break;
            case 2:
            case 3:
            ...
            case 4:
                ...
                break;
            case 5:
                int i4 = PasswordActivity.f24771OooOoOO;
                PasswordActivity.OooO00o.OooO00o(activity, activity.f24847OooOo, null, str, activity.f24850OooOo0O);
                break;
            case 6:
                int i5 = PhoneNumberActivity.f24809OooOoO;
                PhoneNumberActivity.OooO00o.OooO00o(activity, activity.f24847OooOo, ClientCodeType.Change);
                break;
            case 7:
            ...
            case 8:
                ...
                int i6 = DeleteAccountSubmitActivity.f24727OooOo0;
                ...
                break;
            case 9:
                String strOooO0OO = o0000.OooO0OO(o000OOo.account_login_protection_turn_on_success);
