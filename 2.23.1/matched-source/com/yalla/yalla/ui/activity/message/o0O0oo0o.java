...
public final class o0O0oo0o extends Lambda implements Function1<YallaTeamMessage, Unit> {
    ...
    public final Unit invoke(YallaTeamMessage yallaTeamMessage) {
        ...
        if (it.getType() == 5 && p425o0OoO0OO.oOO00O.OooO0o(it.getBuriedPointMessageId()) && p425o0OoO0OO.oOO00O.OooO0o(it.getBuriedPointSource())) {
            h0.OooO0OO("104041", MapsKt.mapOf(TuplesKt.to("messageid", it.getBuriedPointMessageId()), TuplesKt.to("source", it.getBuriedPointSource())));
        }
        int i3 = YallaTeamMessageActivity.f25320OooOoo0;
        YallaTeamMessageActivity context = this.f25512OooO0Oo;
        context.getClass();
        if (it.getMessageType() != 2) {
            int jumpType = it.getJumpType();
            int i4 = MainActivity.f24941OooOoo;
            switch (jumpType) {
                case 1:
                    ...
                    break;
                case 2:
                    p585o0oOoo00.o00000OO.f56628OooOOO0.observe(context, new YallaTeamMessageActivity.OooO00o(new o0O0o000(it, context)));
                    break;
                case 3:
                    p585o0oOoo00.o00000OO.f56626OooOO0o.observe(context, new YallaTeamMessageActivity.OooO00o(new o0O0o00O(it, context)));
                    break;
                case 4:
                ...
                default:
                    switch (jumpType) {
                        case 103:
                            oOO0OO.OooO00o(null, null, Long.valueOf(com.code.android.util.o0OoOo0.OooO(0L, it.getJumpId())), 3);
                            break;
                        case 104:
                            ...
                            int i5 = MomentDetailActivity.f25610Oooo0;
                        ...
                        case 106:
                            ...
                            break;
                        case 107:
                            oOO0OO.OooO00o(Integer.valueOf(com.code.android.util.o000000.OooO0o0(it.getJumpId())), GiftPropTypeUser.Backpack, null, 4);
                            break;
                        case 108:
                            RedemptionCodeScreen.navigate$default(RedemptionCodeScreen.INSTANCE, null, 1, null);
                            break;
                        default:
                            com.code.android.util.o000O00.OooO00o(p565o0oOo000.o000OOo.Yalla_Update_Latest_Version);
                            break;
                    }
                    break;
            }
            ...
            p532o0o0OOOO.o0O0o000.OooO0o0(YallaTeamImageMessageScreen.INSTANCE, bundleOooO00o, false, null, 12);
        }
