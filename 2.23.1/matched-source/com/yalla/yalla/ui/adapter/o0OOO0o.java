...
public final class o0OOO0o {
    ...
    @NotNull
    public final AppCompatActivity f27201OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public final Lazy f27202OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public MomentMessage f27203OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @Nullable
    public BaseMomentDetailVM f27204OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @Nullable
    public YallaChatVM f27205OooO0o0;

    public static final class OooO00o extends Lambda implements Function0<o0ooOOo> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ PagingViewHolder f27206OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(PagingViewHolder pagingViewHolder) {
            super(0);
            this.f27206OooO0Oo = pagingViewHolder;
        }

        @Override // kotlin.jvm.functions.Function0
        public final o0ooOOo invoke() {
            return new o0ooOOo(this.f27206OooO0Oo);
        }
    }
    ...
    public static final class OooO0O0 extends oo0OOoo {
        ...
        public static final class OooO00o extends Lambda implements Function1<List<MomentCommentDetailModel>, Unit> {
            ...
            public final Unit invoke(List<MomentCommentDetailModel> list) {
                ...
                if (list2 != null && list2.size() > 0) {
                    this.f27208OooO0Oo.element = list2.get(0);
                }
        ...
        public static final class C0329OooO0O0 extends Lambda implements Function1<ApiResult<List<MomentCommentDetailModel>>, Unit> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ Ref.ObjectRef<MomentCommentDetailModel> f27209OooO0Oo;

            /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
            public final /* synthetic */ MomentDetailModel f27210OooO0o;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public final /* synthetic */ o0OOO0o f27211OooO0o0;

            /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
            public final /* synthetic */ MomentCommentDetailModel f27212OooO0oO;

            /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
            public final /* synthetic */ MomentReplyModel f27213OooO0oo;
            ...
            public C0329OooO0O0(Ref.ObjectRef<MomentCommentDetailModel> objectRef, o0OOO0o o0ooo0o2, MomentDetailModel momentDetailModel, MomentCommentDetailModel momentCommentDetailModel, MomentReplyModel momentReplyModel) {
                super(1);
                this.f27209OooO0Oo = objectRef;
                this.f27211OooO0o0 = o0ooo0o2;
                this.f27210OooO0o = momentDetailModel;
                this.f27212OooO0oO = momentCommentDetailModel;
                this.f27213OooO0oo = momentReplyModel;
            }
            ...
            public final Unit invoke(ApiResult<List<MomentCommentDetailModel>> apiResult) {
                ...
                Ref.ObjectRef<MomentCommentDetailModel> objectRef = this.f27209OooO0Oo;
                String userid = objectRef.element.getUserid();
                boolean z = userid == null || userid.length() == 0;
                o0OOO0o o0ooo0o2 = this.f27211OooO0o0;
                if (z) {
                    int i = MomentDetailActivity.f25610Oooo0;
                    MomentDetailActivity.OooO00o.OooO00o(o0ooo0o2.f27201OooO00o, this.f27210OooO0o, (PSKKeyManager.MAX_KEY_LENGTH_BYTES & 4) != 0 ? false : false, (PSKKeyManager.MAX_KEY_LENGTH_BYTES & 8) != 0 ? 1 : -1, (PSKKeyManager.MAX_KEY_LENGTH_BYTES & 16) != 0 ? null : this.f27212OooO0oO, (PSKKeyManager.MAX_KEY_LENGTH_BYTES & 32) != 0 ? false : false, (PSKKeyManager.MAX_KEY_LENGTH_BYTES & 64) != 0 ? null : MomentAdapterTag.MomentMessageList, (PSKKeyManager.MAX_KEY_LENGTH_BYTES & 128) != 0 ? false : false, (PSKKeyManager.MAX_KEY_LENGTH_BYTES & PSKKeyManager.MAX_KEY_LENGTH_BYTES) != 0 ? "" : null);
                } else {
                    int i2 = MomentReplyActivity.f25702OooOoO;
                    MomentReplyActivity.OooO00o.OooO00o(o0ooo0o2.f27201OooO00o, false, this.f27210OooO0o, objectRef.element, this.f27213OooO0oo);
                }
                return Unit.INSTANCE;
            }
        }
        ...
        public static final class OooO0OO extends Lambda implements Function1<TopicGroupInfoModel, Unit> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ MomentMessage.TopicGroupCreateSuccessNotice f27214OooO0Oo;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public OooO0OO(MomentMessage.TopicGroupCreateSuccessNotice topicGroupCreateSuccessNotice) {
                super(1);
                this.f27214OooO0Oo = topicGroupCreateSuccessNotice;
            }
            ...
            public final Unit invoke(TopicGroupInfoModel topicGroupInfoModel) {
                ...
                if (topicGroupInfoModel2 != null) {
                    if (topicGroupInfoModel2.getIsDisbanded() || topicGroupInfoModel2.getCircleUserIsCancel()) {
                        String strOooO0OO = com.code.android.util.o0000.OooO0OO(p565o0oOo000.o000OOo.topic_group_join_dissolved);
                        ...
                        MomentMessage.TopicGroupCreateSuccessNotice topicGroupCreateSuccessNotice = this.f27214OooO0Oo;
                        ...
                        o0O0o000.OooO0o0(TopicGroupJoinScreen.INSTANCE, p063o0000oO.o000oOoO.OooO0O0(TuplesKt.to("DATA", topicGroupInfoModel2)), false, null, 12);
                    }
                }
                return Unit.INSTANCE;
            }
        ...
        public final void OooO00o(@NotNull View v) {
            ...
            int id = v.getId();
            int i = p565o0oOo000.o0Oo0oo.ivHead;
            MomentMessage momentMessage = null;
            o0OOO0o o0ooo0o2 = o0OOO0o.this;
            if (id == i) {
                MomentMessage momentMessage2 = o0ooo0o2.f27203OooO0OO;
                ...
                if (type == 19) {
                    UserInfoActivity.OooO00o oooO00o3 = UserInfoActivity.f26776Oooo0o;
                ...
                switch (type) {
                    case 1:
                        UserInfoActivity.OooO00o oooO00o4 = UserInfoActivity.f26776Oooo0o;
                        ...
                        break;
                    case 2:
                        UserInfoActivity.OooO00o oooO00o5 = UserInfoActivity.f26776Oooo0o;
                        ...
                        break;
                    case 3:
                        UserInfoActivity.OooO00o oooO00o6 = UserInfoActivity.f26776Oooo0o;
                        ...
                        break;
                    case 4:
                        UserInfoActivity.OooO00o oooO00o7 = UserInfoActivity.f26776Oooo0o;
                        ...
                        break;
                    case 5:
                        UserInfoActivity.OooO00o oooO00o8 = UserInfoActivity.f26776Oooo0o;
                        ...
                        break;
                    case 6:
                        UserInfoActivity.OooO00o oooO00o9 = UserInfoActivity.f26776Oooo0o;
                        ...
                        break;
                    case 7:
                        UserInfoActivity.OooO00o oooO00o10 = UserInfoActivity.f26776Oooo0o;
                        ...
                        break;
                    case 8:
                        UserInfoActivity.OooO00o oooO00o11 = UserInfoActivity.f26776Oooo0o;
                        ...
                        break;
                    case 9:
                        UserInfoActivity.OooO00o oooO00o12 = UserInfoActivity.f26776Oooo0o;
                    ...
                    default:
                        switch (type) {
                            case 12:
                                UserInfoActivity.OooO00o oooO00o13 = UserInfoActivity.f26776Oooo0o;
                                ...
                                break;
                            case 13:
                                UserInfoActivity.OooO00o oooO00o14 = UserInfoActivity.f26776Oooo0o;
                                ...
                                break;
                            case 14:
                                UserInfoActivity.OooO00o oooO00o15 = UserInfoActivity.f26776Oooo0o;
            ...
            if (!(((((((id == p565o0oOo000.o0Oo0oo.layout || id == p565o0oOo000.o0Oo0oo.layoutContent) != false || id == p565o0oOo000.o0Oo0oo.tvName) != false || id == p565o0oOo000.o0Oo0oo.ivLike) != false || id == p565o0oOo000.o0Oo0oo.ivReward) != false || id == p565o0oOo000.o0Oo0oo.tvContent) != false || id == p565o0oOo000.o0Oo0oo.tvTime) == true || id == p565o0oOo000.o0Oo0oo.ivImage)) {
                if (id == p565o0oOo000.o0Oo0oo.tvReply) {
                    h0.OooO0O0("103022");
                    ...
                    o0O0OO0.OooO0OO(553, momentMessage);
                    return;
                }
                return;
            }
            ...
            if (type2 != -12) {
                switch (type2) {
                    ...
                    case 14:
                        ...
                        break;
                    case 15:
                        com.code.android.util.o000O00.OooO00o(p565o0oOo000.o000OOo.moment_delete_by_user);
                        break;
                    case 16:
                    ...
                    case 17:
                        ...
                        if (commentReportFeedback != null) {
                            AppCompatActivity appCompatActivity2 = o0ooo0o2.f27201OooO00o;
                            ...
                            BaseMomentDetailVM baseMomentDetailVM = o0ooo0o2.f27204OooO0Oo;
                            if (baseMomentDetailVM != null && (commentInfo = baseMomentDetailVM.getCommentInfo(com.code.android.util.o0OoOo0.OooOO0(commentReportFeedback.getCommentId()))) != null) {
                                commentInfo.observe(appCompatActivity2, new p386o0OOoo0O.o0OoOo0(new o0Oo0oo(oo0o0oo), null, new o0OO00O(o0ooo0o2), false, 10));
                            }
                        }
                        break;
                    case 18:
        ...
        public final void OooO0O0(Long l, Long l2, MomentCommentDetailModel momentCommentDetailModel) {
            ...
            if (l != null) {
                ...
                liveDataCommentParentCommentInfo.observe(o0ooo0o2.f27201OooO00o, new p386o0OOoo0O.o0OoOo0(new OooO00o(objectRef), null, new C0329OooO0O0(objectRef, o0ooo0o2, momentDetailModel, momentCommentDetailModel, momentReplyModel), false, 10));
            }
        }
        ...
        public final void OooO0Oo(Long l) {
            if (l != null) {
                ...
                TopicDetailActivity.OooO00o.OooO00o(o0OOO0o.this.f27201OooO00o, topicInfoModel);
            }
        }
        ...
        public final void OooO0o0(MomentMessage.TopicGroupCreateSuccessNotice topicGroupCreateSuccessNotice) {
            ...
            if (topicGroupCreateSuccessNotice == null || (yallaChatVM = (o0ooo0o2 = o0OOO0o.this).f27205OooO0o0) == null || (groupInfo = yallaChatVM.getGroupInfo(com.code.android.util.o0OoOo0.OooOO0(topicGroupCreateSuccessNotice.getCircleId()))) == null) {
                return;
            }
            groupInfo.observe(o0ooo0o2.f27201OooO00o, new p386o0OOoo0O.o0OoOo0(new OooO0OO(topicGroupCreateSuccessNotice), null, null, false, 14));
        }
    }
    ...
    public o0OOO0o(@NotNull AppCompatActivity activity, @NotNull PagingViewHolder viewHolder) {
        ...
        this.f27201OooO00o = activity;
        this.f27202OooO0O0 = LazyKt.lazy(new OooO00o(viewHolder));
        OooO0O0 oooO0O0 = new OooO0O0();
        OooO00o().f27220OooO00o.setOnClickListener(oooO0O0);
        OooO00o().f27221OooO0O0.setOnClickListener(oooO0O0);
        OooO00o().f27222OooO0OO.setOnClickListener(oooO0O0);
        OooO00o().f27223OooO0Oo.setOnClickListener(oooO0O0);
        OooO00o().f27225OooO0o0.setOnClickListener(oooO0O0);
        OooO00o().f27224OooO0o.setOnClickListener(oooO0O0);
        OooO00o().f27226OooO0oO.setOnClickListener(oooO0O0);
        OooO00o().f27227OooO0oo.setOnClickListener(oooO0O0);
        OooO00o().f27219OooO.setOnClickListener(oooO0O0);
        OooO00o().f27228OooOO0.setOnClickListener(oooO0O0);
        OooO00o().f27229OooOO0O.setOnClickListener(oooO0O0);
        OooO00o().f27230OooOO0o.setOnClickListener(oooO0O0);
    }

    public final void OooO() {
        MomentMessage momentMessage = this.f27203OooO0OO;
        ...
        if (momentTopicRemoveAdmin != null) {
            AppCompatActivity appCompatActivity = this.f27201OooO00o;
            o0OOo0Oo.Oooo000.OooO00o oooO00o = new o0OOo0Oo.Oooo000.OooO00o(appCompatActivity);
            oooO00o.OooO00o(o0O0O0Oo.OooO0OO());
            oooO00o.f43127OooO0OO = momentTopicRemoveAdmin.getUserHeadUrl();
            oooO00o.f43125OooO00o = 0;
            oooO00o.OooO0Oo(OooO00o().f27221OooO0O0);
            OooO00o().f27222OooO0OO.setText(com.code.android.util.o0000.OooO0OO(p565o0oOo000.o000OOo.MessageFragment_moment_postRemoved));
            OooO00o().f27224OooO0o.setText(com.code.android.util.o0000O.OooO00o(com.code.android.util.o0000.OooO0OO(p565o0oOo000.o000OOo.moment_message_removed_from_xxx_topic_admin), momentTopicRemoveAdmin.getTopicName()));
            OooO00o().f27224OooO0o.setVisibility(0);
            TextView textView = OooO00o().f27226OooO0oO;
            MomentMessage momentMessage3 = this.f27203OooO0OO;
            if (momentMessage3 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("data");
            } else {
                momentMessage2 = momentMessage3;
            }
            textView.setText(p606o0oo0O0.OooOOOO.OooO0Oo(momentMessage2.getTime(), System.currentTimeMillis()));
            OooO00o().f27227OooO0oo.setVisibility(8);
            OooO00o().f27219OooO.setVisibility(4);
            if (TextUtils.isEmpty(momentTopicRemoveAdmin.getMomentImageUrl())) {
                return;
            }
            OooO00o().f27219OooO.setVisibility(0);
            o0OOo0Oo.Oooo000.OooO00o oooO00o2 = new o0OOo0Oo.Oooo000.OooO00o(appCompatActivity);
            oooO00o2.OooO00o(o0O0O0Oo.OooO0Oo());
            oooO00o2.OooO0o0(6);
            oooO00o2.f43127OooO0OO = p405o0Oo0OO.OooO0OO.OooO00o(momentTopicRemoveAdmin.getMomentImageUrl());
            oooO00o2.f43125OooO00o = 0;
            oooO00o2.OooO0Oo(OooO00o().f27219OooO);
        }
    }

    public final o0ooOOo OooO00o() {
        return (o0ooOOo) this.f27202OooO0O0.getValue();
    }
    ...
    public final void OooO0O0() {
        ...
        if (circleReportFeedback != null) {
            OooO00o().f27221OooO0O0.setImageResource(p565o0oOo000.o0OOO0o.icon_moment_featurd_head);
            OooO00o().f27222OooO0OO.setText(!TextUtils.isEmpty(com.code.android.util.o0OoOo0.OooOOO(circleReportFeedback.getCircleTitle(), "")) ? com.code.android.util.o0OoOo0.OooOOO(circleReportFeedback.getCircleTitle(), "") : com.code.android.util.o0000.OooO0OO(p565o0oOo000.o000OOo.Thanks_for_your_report));
            OooO00o().f27224OooO0o.setText(com.code.android.util.o0OoOo0.OooOOO(circleReportFeedback.getCircleContent(), ""));
            OooO00o().f27224OooO0o.setVisibility(0);
            TextView textView = OooO00o().f27226OooO0oO;
            MomentMessage momentMessage3 = this.f27203OooO0OO;
            if (momentMessage3 == null) {
            ...
            o0OOo0Oo.Oooo000.OooO00o oooO00o = new o0OOo0Oo.Oooo000.OooO00o(this.f27201OooO00o);
            oooO00o.OooO00o(o0O0O0Oo.OooO0Oo());
            oooO00o.OooO0o0(6);
            oooO00o.f43127OooO0OO = strOooO0oo;
            oooO00o.f43125OooO00o = 0;
            oooO00o.OooO0Oo(OooO00o().f27219OooO);
        }
    }
    ...
    public final void OooO0OO() {
        ...
        if (commentFeatured != null) {
            OooO00o().f27221OooO0O0.setImageResource(p565o0oOo000.o0OOO0o.ic_moment_message_featured_add);
            OooO00o().f27222OooO0OO.setText(com.code.android.util.o0000.OooO0OO(p565o0oOo000.o000OOo.Moment_Message_comment_featured));
            OooO00o().f27224OooO0o.setText("");
            ...
            if (momentSendContentModel != null) {
                p600o0oo00Oo.o0000oo.OooO0OO(appCompatActivity, momentSendContentModel, OooO00o().f27224OooO0o, null);
                OooO00o().f27224OooO0o.getEditableText().insert(0, Html.fromHtml("<font color='#999999'> " + com.code.android.util.o0000.OooO0OO(p565o0oOo000.o000OOo.MessageFragment_moment_comment_postFeatured_itemInfo) + "</font> "));
            }
            OooO00o().f27224OooO0o.setVisibility(0);
            TextView textView = OooO00o().f27226OooO0oO;
            MomentMessage momentMessage3 = this.f27203OooO0OO;
            ...
            oooO00o.OooO00o(o0O0O0Oo.OooO0Oo());
            oooO00o.OooO0o0(6);
            oooO00o.f43127OooO0OO = strOooO0O0;
            oooO00o.f43125OooO00o = 0;
            oooO00o.OooO0Oo(OooO00o().f27219OooO);
        }
    }
    ...
    public final void OooO0Oo() {
        ...
        if (commentReportFeedback != null) {
            OooO00o().f27221OooO0O0.setImageResource(p565o0oOo000.o0OOO0o.icon_moment_featurd_head);
            OooO00o().f27222OooO0OO.setText(!TextUtils.isEmpty(com.code.android.util.o0OoOo0.OooOOO(commentReportFeedback.getTitle(), "")) ? com.code.android.util.o0OoOo0.OooOOO(commentReportFeedback.getTitle(), "") : com.code.android.util.o0000.OooO0OO(p565o0oOo000.o000OOo.Thanks_for_your_report));
            OooO00o().f27224OooO0o.setText(commentReportFeedback.getContent());
            OooO00o().f27224OooO0o.setVisibility(0);
            TextView textView = OooO00o().f27226OooO0oO;
            MomentMessage momentMessage3 = this.f27203OooO0OO;
            if (momentMessage3 == null) {
    ...
    public final void OooO0o() {
        ...
        if (momentSystemRemove != null) {
            OooO00o().f27221OooO0O0.setImageResource(p565o0oOo000.o0OOO0o.ic_moment_message_delete);
            OooO00o().f27222OooO0OO.setText(com.code.android.util.o0000.OooO0OO(p565o0oOo000.o000OOo.Post_Deleted));
            String strOooO00o = oO00O0o0.OooO00o(momentSystemRemove.getDeleteType());
            MomentMessage momentMessage3 = this.f27203OooO0OO;
            if (momentMessage3 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("data");
            } else {
            ...
            String strOooO0Oo = p606o0oo0O0.OooOOOO.OooO0Oo(momentMessage2.getTime(), System.currentTimeMillis());
            OooO00o().f27224OooO0o.setText(com.code.android.util.o0000O.OooO00o(com.code.android.util.o0000O.OooO00o(com.code.android.util.o0000.OooO0OO(p565o0oOo000.o000OOo.We_deleted_your_post_posted_XXX_for_XXX), strOooO0Oo), strOooO00o));
            OooO00o().f27224OooO0o.setVisibility(0);
            OooO00o().f27226OooO0oO.setText(strOooO0Oo);
            OooO00o().f27227OooO0oo.setVisibility(8);
            OooO00o().f27219OooO.setVisibility(4);
    ...
    public final void OooO0o0() {
        ...
        if (momentReportFeedback != null) {
            OooO00o().f27221OooO0O0.setImageResource(p565o0oOo000.o0OOO0o.icon_moment_featurd_head);
            OooO00o().f27222OooO0OO.setText(!TextUtils.isEmpty(com.code.android.util.o0OoOo0.OooOOO(momentReportFeedback.getMomentTitle(), "")) ? com.code.android.util.o0OoOo0.OooOOO(momentReportFeedback.getMomentTitle(), "") : com.code.android.util.o0000.OooO0OO(p565o0oOo000.o000OOo.Thanks_for_your_report));
            OooO00o().f27224OooO0o.setText(momentReportFeedback.getMomentContent());
            OooO00o().f27224OooO0o.setVisibility(0);
            TextView textView = OooO00o().f27226OooO0oO;
            MomentMessage momentMessage3 = this.f27203OooO0OO;
            if (momentMessage3 == null) {
    ...
    public final void OooO0oO() {
        ...
        if (topicGroupCreateSuccessNotice != null) {
            ...
            o0OOo0Oo.Oooo000.OooO00o oooO00o = new o0OOo0Oo.Oooo000.OooO00o(appCompatActivity);
            oooO00o.OooO00o(o0O0O0Oo.OooO0OO());
            oooO00o.f43127OooO0OO = com.code.android.util.o0OoOo0.OooOOO(topicGroupCreateSuccessNotice.getHeadUrl(), "");
            oooO00o.f43125OooO00o = 0;
            oooO00o.OooO0Oo(OooO00o().f27221OooO0O0);
            OooO00o().f27222OooO0OO.setText(com.code.android.util.o0OoOo0.OooOOO(topicGroupCreateSuccessNotice.getNickName(), ""));
            OooO00o().f27224OooO0o.setText(com.code.android.util.o0000O.OooO00o(com.code.android.util.o0000.OooO0OO(p565o0oOo000.o000OOo.topic_group_create_success_notify_xxx), com.code.android.util.o0OoOo0.OooOOO(topicGroupCreateSuccessNotice.getCircleName(), "")));
            OooO00o().f27224OooO0o.setVisibility(0);
            TextView textView = OooO00o().f27226OooO0oO;
            MomentMessage momentMessage3 = this.f27203OooO0OO;
            if (momentMessage3 == null) {
            ...
            oooO00o2.OooO00o(o0O0O0Oo.OooO0Oo());
            oooO00o2.OooO0o0(6);
            oooO00o2.f43127OooO0OO = p405o0Oo0OO.OooO0OO.OooO00o(topicGroupCreateSuccessNotice.getCircleHead());
            oooO00o2.f43125OooO00o = 0;
            oooO00o2.OooO0Oo(OooO00o().f27219OooO);
        }
    }
    ...
    public final void OooO0oo() {
        ...
        if (topicGroupCreateSuccessNotice != null) {
            ...
            oooO00o.OooO0Oo(OooO00o().f27221OooO0O0);
            OooO00o().f27222OooO0OO.setText(com.code.android.util.o0OoOo0.OooOOO(topicGroupCreateSuccessNotice.getNickName(), ""));
            OooO00o().f27224OooO0o.setText(com.code.android.util.o0000O.OooO00o(com.code.android.util.o0000.OooO0OO(p565o0oOo000.o000OOo.topic_group_join_success_notify_xxx), com.code.android.util.o0OoOo0.OooOOO(topicGroupCreateSuccessNotice.getCircleName(), "")));
            OooO00o().f27224OooO0o.setVisibility(0);
            TextView textView = OooO00o().f27226OooO0oO;
            MomentMessage momentMessage3 = this.f27203OooO0OO;
            if (momentMessage3 == null) {
    ...
    public final void OooOO0() {
        ...
        if (momentTopicRemoveOwner != null) {
            ...
            o0OOo0Oo.Oooo000.OooO00o oooO00o = new o0OOo0Oo.Oooo000.OooO00o(appCompatActivity);
            oooO00o.OooO00o(o0O0O0Oo.OooO0OO());
            oooO00o.f43127OooO0OO = momentTopicRemoveOwner.getUserHeadUrl();
            oooO00o.f43125OooO00o = 0;
            oooO00o.OooO0Oo(OooO00o().f27221OooO0O0);
            OooO00o().f27222OooO0OO.setText(com.code.android.util.o0000.OooO0OO(p565o0oOo000.o000OOo.MessageFragment_moment_postRemoved));
            OooO00o().f27224OooO0o.setText(com.code.android.util.o0000O.OooO00o(com.code.android.util.o0000.OooO0OO(p565o0oOo000.o000OOo.MessageFragment_moment_postRemoved_itemInfo), momentTopicRemoveOwner.getTopicName()));
            OooO00o().f27224OooO0o.setVisibility(0);
            TextView textView = OooO00o().f27226OooO0oO;
            MomentMessage momentMessage3 = this.f27203OooO0OO;
            if (momentMessage3 == null) {
            ...
            oooO00o2.OooO00o(o0O0O0Oo.OooO0Oo());
            oooO00o2.OooO0o0(6);
            oooO00o2.f43127OooO0OO = p405o0Oo0OO.OooO0OO.OooO00o(momentTopicRemoveOwner.getMomentImageUrl());
            oooO00o2.f43125OooO00o = 0;
            oooO00o2.OooO0Oo(OooO00o().f27219OooO);
        }
    }
    ...
    public final void OooOO0O() {
        ...
        if (momentTopicTop != null) {
            OooO00o().f27221OooO0O0.setImageResource(p565o0oOo000.o0OOO0o.ic_moment_message_pinned);
            OooO00o().f27222OooO0OO.setText(com.code.android.util.o0000.OooO0OO(p565o0oOo000.o000OOo.MessageFragment_moment_postPinned));
            OooO00o().f27224OooO0o.setText(com.code.android.util.o0000O.OooO00o(com.code.android.util.o0000.OooO0OO(p565o0oOo000.o000OOo.MessageFragment_moment_postPinned_itemInfo), momentTopicTop.getTopicName()));
            OooO00o().f27224OooO0o.setVisibility(0);
            TextView textView = OooO00o().f27226OooO0oO;
            MomentMessage momentMessage3 = this.f27203OooO0OO;
            if (momentMessage3 == null) {
            ...
            oooO00o.OooO00o(o0O0O0Oo.OooO0Oo());
            oooO00o.OooO0o0(6);
            oooO00o.f43127OooO0OO = p405o0Oo0OO.OooO0OO.OooO00o(momentTopicTop.getMomentImageUrl());
            oooO00o.f43125OooO00o = 0;
            oooO00o.OooO0Oo(OooO00o().f27219OooO);
        }
    }
    ...
    public final void OooOO0o() {
        ...
        if (replyReward != null) {
            ...
            o0OOo0Oo.Oooo000.OooO00o oooO00o = new o0OOo0Oo.Oooo000.OooO00o(appCompatActivity);
            oooO00o.OooO00o(o0O0O0Oo.OooO0OO());
            oooO00o.f43127OooO0OO = replyReward.getUserHeadUrl();
            oooO00o.f43125OooO00o = 0;
            oooO00o.OooO0Oo(OooO00o().f27221OooO0O0);
            OooO00o().f27222OooO0OO.setText(p414o0Oo0o0O.o000O00.OooO0O0(replyReward.getUserId(), replyReward.getUserNickName()));
            TextView textView = OooO00o().f27226OooO0oO;
            MomentMessage momentMessage2 = this.f27203OooO0OO;
            if (momentMessage2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("data");
                momentMessage2 = null;
            }
            ...
            if (com.code.android.util.OooOo00.OooO0O0(replyReward.getMomentImageUrl())) {
                ...
                oooO00o2.OooO00o(o0O0O0Oo.OooO0Oo());
                oooO00o2.OooO0o0(6);
                oooO00o2.f43127OooO0OO = replyReward.getMomentImageUrl();
                oooO00o2.f43125OooO00o = 0;
                oooO00o2.OooO0Oo(OooO00o().f27219OooO);
                OooO00o().f27219OooO.setVisibility(0);
            } else {
            ...
            OooO00o().f27225OooO0o0.setVisibility(0);
            OooO00o().f27225OooO0o0.setImageResource(p565o0oOo000.o0OOO0o.ic_moment_comment_reward_color);
            OooO00o().f27230OooOO0o.setVisibility(0);
            ...
            p600o0oo00Oo.o0000oo.OooO0OO(appCompatActivity, momentSendContentModel, OooO00o().f27230OooOO0o, null);
            OooO00o().f27230OooOO0o.getEditableText().insert(0, Html.fromHtml("<font color='#999999'> " + com.code.android.util.o0000.OooO0OO(p565o0oOo000.o000OOo.moment_message_reward_comments_title) + "</font> "));
        }
    }
}
