...
public final class PacketHistoryFragment extends o00OO0O0<f0> {
    ...
    private final void initView() {
        ...
        RtlViewPager rtlViewPager = getBinding().f43827OooO0Oo;
        FragmentManager childFragmentManager = getChildFragmentManager();
        Intrinsics.checkNotNullExpressionValue(childFragmentManager, "getChildFragmentManager(...)");
        rtlViewPager.setAdapter(new o0oO0O0o(childFragmentManager, listMutableListOf));
        getBinding().f43827OooO0Oo.OooO0O0(new OooO0O0());
        getBinding().f43825OooO0O0.setOnClickListener(this);
        getBinding().f43826OooO0OO.setOnClickListener(this);
        switchTitle(0);
    }
    ...
    public final void switchTitle(int position) {
        if (position == 0) {
            getBinding().f43825OooO0O0.setSelected(true);
            getBinding().f43825OooO0O0.setTextColor(com.code.android.util.o0000.OooO00o(p565o0oOo000.o0ooOOo.color_333333));
            TextView tvReceived = getBinding().f43825OooO0O0;
            ...
            getBinding().f43826OooO0OO.setSelected(false);
            getBinding().f43826OooO0OO.setTextColor(com.code.android.util.o0000.OooO00o(p565o0oOo000.o0ooOOo.white));
            TextView tvSend = getBinding().f43826OooO0OO;
            Intrinsics.checkNotNullExpressionValue(tvSend, "tvSend");
            com.code.android.util.o000O.OooOOO(com.code.android.util.o0000O0.OooO00o(30), tvSend);
        } else {
            getBinding().f43825OooO0O0.setSelected(false);
            getBinding().f43825OooO0O0.setTextColor(com.code.android.util.o0000.OooO00o(p565o0oOo000.o0ooOOo.white));
            TextView tvReceived2 = getBinding().f43825OooO0O0;
            ...
            getBinding().f43826OooO0OO.setSelected(true);
            getBinding().f43826OooO0OO.setTextColor(com.code.android.util.o0000.OooO00o(p565o0oOo000.o0ooOOo.color_333333));
            TextView tvSend2 = getBinding().f43826OooO0OO;
        ...
        getBinding().f43827OooO0Oo.OooOo(position, true);
    }
    ...
    public void onNoDoubleClick(@NotNull View view) {
        ...
        if (Intrinsics.areEqual(view, getBinding().f43825OooO0O0)) {
            switchTitle(0);
        } else if (Intrinsics.areEqual(view, getBinding().f43826OooO0OO)) {
            switchTitle(1);
        }
    }
