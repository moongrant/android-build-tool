...
import p529o0o0OO0o.o0000O0O;
import p565o0oOo000.o000OOo;
import p579o0oOoOo.o0o0000;
import p582o0oOoOoo.y;
...
public final class MessageListFragment extends o00OO0O0<oO0O00oO> {
    ...
    public static final class OooOO0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public static final class OooO00o extends SuspendLambda implements Function2<o0OOO0o<ConversationWithUser>, Continuation<? super Unit>, Object> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public int f28037OooO0Oo;

            /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
            public final /* synthetic */ MessageListFragment f28038OooO0o;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public /* synthetic */ Object f28039OooO0o0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public OooO00o(MessageListFragment messageListFragment, Continuation<? super OooO00o> continuation) {
                super(2, continuation);
                this.f28038OooO0o = messageListFragment;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                OooO00o oooO00o = new OooO00o(this.f28038OooO0o, continuation);
                oooO00o.f28039OooO0o0 = obj;
                return oooO00o;
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                int i = this.f28037OooO0Oo;
                if (i == 0) {
                    ResultKt.throwOnFailure(obj);
                    o0OOO0o o0ooo0o2 = (o0OOO0o) this.f28039OooO0o0;
                    com.yalla.yalla.ui.adapter.OooO0OO oooO0OO = this.f28038OooO0o.adapterMessageChat;
                    if (oooO0OO == null) {
                        Intrinsics.throwUninitializedPropertyAccessException("adapterMessageChat");
                        oooO0OO = null;
                    }
                    this.f28037OooO0Oo = 1;
    ...
    public static final class OooOO0O extends Lambda implements Function3<n0<ConversationWithUser>, View, Integer, Unit> {
        public OooOO0O() {
            super(3);
        }

        @Override // kotlin.jvm.functions.Function3
        public final Unit invoke(n0<ConversationWithUser> n0Var, View view, Integer num) {
            n0<ConversationWithUser> adapter = n0Var;
    ...
    public static final class OooOOO extends Lambda implements Function2<Integer, o00O0O, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ Conversation f28042OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO(Conversation conversation) {
            super(2);
            this.f28042OooO0o0 = conversation;
        }
        ...
        public final Unit invoke(Integer num, o00O0O o00o0o2) {
            ...
            MessageListFragment messageListFragment = MessageListFragment.this;
            Conversation conversation = this.f28042OooO0o0;
            if (iIntValue == 0) {
                messageListFragment.getVm().getClass();
                o0o0000.OooO0OO(conversation);
            } else if (conversation.getTargetId() > 0) {
                h0.OooO0O0("104021");
                Context contextRequireContext = messageListFragment.requireContext();
                Intrinsics.checkNotNullExpressionValue(contextRequireContext, "requireContext(...)");
                o000O o000o = new o000O(contextRequireContext);
                o000o.OooOOoo(o000OOo.delete_item);
                o000o.OooOo(true);
    ...
    public static final class OooOOO0 extends Lambda implements Function3<n0<ConversationWithUser>, View, Integer, Boolean> {
        public OooOOO0() {
            super(3);
        }

        @Override // kotlin.jvm.functions.Function3
        public final Boolean invoke(n0<ConversationWithUser> n0Var, View view, Integer num) {
            n0<ConversationWithUser> adapter = n0Var;
            int iIntValue = num.intValue();
            Intrinsics.checkNotNullParameter(adapter, "adapter");
            Intrinsics.checkNotNullParameter(view, "<anonymous parameter 1>");
    ...
    public MessageListFragment() {
        ...
        this.vm = o000Oo0.OooO0O0(this, Reflection.getOrCreateKotlinClass(o0o0000.class), new Function0<ViewModelStore>() { // from class: com.yalla.yalla.ui.fragment.message.MessageListFragment$special$$inlined$viewModels$default$3
            {
                super(0);
            }
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ Function0 f28047OooO0Oo = null;
            ...
            public final CreationExtras invoke() {
                ...
                Function0 function0 = this.f28047OooO0Oo;
    ...
    public final o0o0000 getVm() {
        return (o0o0000) this.vm.getValue();
    }
    ...
    private final void initObserver() {
        ...
        if (unreadSystemMessageCount != null) {
            unreadSystemMessageCount.observe(getViewLifecycleOwner(), new y(this, 1));
        }
    ...
    private final void initView() {
        getBinding().f44877OooO0oo.f20862OooOooO = false;
        ...
        oooo001.f13187OooO0o = new o0OO00O(this, 3);
        ...
        oooO0OO3.f57585OooOO0O = listener;
    ...
    public final void showDialog(Conversation model) {
        ...
        strArr[0] = model.getTopTime() > 0 ? o0000.OooO0OO(o000OOo.message_list_Unpin) : o0000.OooO0OO(o000OOo.message_list_Pin);
        strArr[1] = o0000.OooO0OO(o000OOo.delete_item);
    ...
    public final void showMessageLoadingTab(StatusEnum$ChatServerStatus status) {
        ...
        if (status == StatusEnum$ChatServerStatus.CONNECTING) {
            ...
            getBinding().f44876OooO0oO.setText(getResources().getString(o000OOo.title_connecting));
        ...
        if (status == StatusEnum$ChatServerStatus.UNCONN) {
            ...
            getBinding().f44876OooO0oO.setText(getResources().getString(o000OOo.title_unconnected));
            return;
        }
    ...
    private final void toSystemConversationPage(SystemConversationModel model) {
        ...
        if (context != null) {
            ...
            if (i == 1) {
                int i2 = SystemMessageActivity.f25310OooOo0o;
    ...
    public void onResume() {
        ...
        if (o0O00OO.OooO00o.f41001OooO00o > 0) {
            o0O00OO.OooO00o.f41001OooO00o = 0;
        }
    }
    ...
    @NotNull
    public oO0O00oO getViewBinding(@NotNull LayoutInflater inflater, @Nullable ViewGroup container) {
        Intrinsics.checkNotNullParameter(inflater, "inflater");
        oO0O00oO oo0o00ooInflate = oO0O00oO.inflate(getLayoutInflater());
        Intrinsics.checkNotNullExpressionValue(oo0o00ooInflate, "inflate(...)");
        return oo0o00ooInflate;
    }
}
