...
public final class o0OOO0o extends Lambda implements Function1<ThemeBoughtModel, Unit> {
    ...
    public final /* synthetic */ RoomThemeStoreFragment f28612OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0OOO0o(RoomThemeStoreFragment roomThemeStoreFragment) {
        super(1);
        this.f28612OooO0Oo = roomThemeStoreFragment;
    }

    @Override // kotlin.jvm.functions.Function1
    public final Unit invoke(ThemeBoughtModel themeBoughtModel) {
        ThemeBoughtModel themeBoughtModel2 = themeBoughtModel;
        RoomThemeStoreFragment roomThemeStoreFragment = this.f28612OooO0Oo;
        roomThemeStoreFragment.initData();
        String strOooO0OO = o0000.OooO0OO(o000OOo.Purchase_successful);
        ...
        oo0oO0.OooO0O0().postValue(themeBoughtModel2 != null ? Long.valueOf(themeBoughtModel2.getBalance()) : null);
