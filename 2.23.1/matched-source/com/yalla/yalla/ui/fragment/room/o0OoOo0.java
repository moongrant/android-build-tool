...
public final class o0OoOo0 extends Lambda implements Function1<String, Unit> {
    ...
    public final /* synthetic */ RoomThemeMineFragment f28614OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0OoOo0(RoomThemeMineFragment roomThemeMineFragment) {
        super(1);
        this.f28614OooO0Oo = roomThemeMineFragment;
    }

    @Override // kotlin.jvm.functions.Function1
    public final Unit invoke(String str) {
        RoomThemeMineFragment roomThemeMineFragment = this.f28614OooO0Oo;
        RoomThemeMineActivity activity = roomThemeMineFragment.getActivity();
        if ((activity != null ? activity.f26222OooOo : null) == RoomThemeMineActivity.ThemeType.Mine) {
