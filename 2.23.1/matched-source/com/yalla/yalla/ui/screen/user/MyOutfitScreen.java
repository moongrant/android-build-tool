...
public final class MyOutfitScreen extends o0O00OOO {
    ...
    public static final class OooO00o extends Lambda implements Function3<RowScope, Composer, Integer, Unit> {
        ...
        public final /* synthetic */ o000000 f29415OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ FragmentActivity f29416OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(o000000 o000000Var, FragmentActivity fragmentActivity) {
            super(3);
            this.f29415OooO0Oo = o000000Var;
            this.f29416OooO0o0 = fragmentActivity;
        }
        ...
        public final Unit invoke(RowScope rowScope, Composer composer, Integer num) {
            ...
            if ((iIntValue & 81) == 16 && composer2.getSkipping()) {
                ...
                ImageKt.Image(PainterResources_androidKt.painterResource(oo0o0Oo.ic_title_store, composer2, 0), (String) null, o0O0O00.OooO0O0(SizeKt.m525size3ABfNKs(PaddingKt.m482paddingqDBjuR0$default(Modifier.INSTANCE, 0.0f, 0.0f, Dp.m3775constructorimpl(8), 0.0f, 11, null), Dp.m3775constructorimpl(24)), false, false, 0L, false, null, null, null, new OooOo00(this.f29415OooO0Oo, this.f29416OooO0o0), 255), (Alignment) null, (ContentScale) null, 0.0f, (ColorFilter) null, composer2, 56, 120);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public static final class OooO0O0 extends Lambda implements Function1<Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO0O0 f29417OooO0Oo = new OooO0O0();
        ...
        public final Unit invoke(Integer num) {
            h0.OooO0OO("105115", MapsKt.mapOf(TuplesKt.to("source", Integer.valueOf(num.intValue() + 1))));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0OO extends Lambda implements Function4<p230o00oOo0o.o0O0O00, Integer, Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ RoomThemePageType f29418OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(RoomThemePageType roomThemePageType) {
            super(4);
            this.f29418OooO0Oo = roomThemePageType;
        }
        ...
        public final Unit invoke(p230o00oOo0o.o0O0O00 o0o0o00, Integer num, Composer composer, Integer num2) {
            ...
            if ((iIntValue2 & 721) == 144 && composer2.getSkipping()) {
                ...
                if (iIntValue == 0) {
                    ...
                    b1.OooO00o(0, composer2, 6);
                    composer2.endReplaceableGroup();
                } else if (iIntValue == 1) {
                    composer2.startReplaceableGroup(878268112);
                    b1.OooO00o(1, composer2, 6);
                    composer2.endReplaceableGroup();
                } else if (iIntValue == 2) {
                    ...
                    RoomThemeScreen.INSTANCE.MainContent(this.f29418OooO0Oo, composer2, 48, 0);
                    composer2.endReplaceableGroup();
                } else if (iIntValue != 4) {
    ...
    public static final class OooO0o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ int f29420OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ ColumnScope f29421OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(ColumnScope columnScope, int i) {
            super(2);
            this.f29421OooO0o0 = columnScope;
            this.f29420OooO0o = i;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f29420OooO0o | 1);
            MyOutfitScreen.this.Content(this.f29421OooO0o0, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public void Content(@NotNull ColumnScope columnScope, @Nullable Composer composer, int i) {
        ...
        if ((i & 1) == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            List listListOf = CollectionsKt.listOf((Object[]) new String[]{o0000.OooO0OO(o000OOo.Entrance_Effects), o0000.OooO0OO(o000OOo.Profile_Card_Skins), o0000.OooO0OO(o000OOo.Chat_Boxes), o0000.OooO0OO(o000OOo.Room_Themes), o0000.OooO0OO(o000OOo.vehicle_store_enter)});
            ...
            o0O0oo0o.OooO00o(StringResources_androidKt.stringResource(o000OOo.My_Items, composerStartRestartGroup, 0), 0.0f, 0L, null, null, null, null, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -275512482, true, new OooO00o(o000000VarOooO00o, (FragmentActivity) objConsume)), null, composerStartRestartGroup, 12582912, 382);
            o00O0000.OooO00o(listListOf, o000000VarOooO00o, null, 0L, 0L, 0L, false, OooO0O0.f29417OooO0Oo, composerStartRestartGroup, 12582912, 124);
    ...
    public final void navigate(int pageNumber, @NotNull RoomThemePageType themePageType, boolean isFromStore) {
        ...
        if (o0O0o000.OooO00o(myOutfitScreen)) {
            o0O0o000.OooO0O0(myOutfitScreen);
        } else {
            o0O0o000.OooO0o0(myOutfitScreen, bundleOooO0O0, false, null, 12);
        }
    }
}
