...
public final class NumberView extends AppCompatImageView {
    ...
    public final void OooO0OO() {
        int i;
        int i2 = this.f29970OooO0Oo;
        if (i2 < 0) {
            setVisibility(8);
            invalidate();
            return;
        }
        int i3 = NumberSize.f29968OooO00o;
        NumberSize.Size size = this.size;
        switch (size == null ? -1 : NumberSize.OooO00o.$EnumSwitchMapping$0[size.ordinal()]) {
            case 1:
                i = o0O0oo0o.f46387OooO0o0[i2];
                break;
            case 2:
                i = o0O0oo0o.f46386OooO0o[i2];
                break;
            case 3:
                i = o0O0oo0o.f46388OooO0oO[i2];
                break;
            case 4:
                i = o0O0oo0o.f46389OooO0oo[i2];
                break;
            case 5:
                i = o0O0oo0o.f46381OooO[i2];
                break;
            case 6:
                i = o0O0oo0o.f46385OooO0Oo[i2];
                break;
            default:
                i = o0O0oo0o.f46386OooO0o[i2];
                break;
    ...
    public NumberView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, o000000O.NumberView);
        int integer = typedArrayObtainStyledAttributes.getInteger(o000000O.NumberView_numItemSize, 2);
        int i2 = NumberSize.f29968OooO00o;
        this.size = NumberSize.OooO00o(Integer.valueOf(integer));
        this.f29970OooO0Oo = typedArrayObtainStyledAttributes.getInteger(o000000O.NumberView_numItemData, 0);
