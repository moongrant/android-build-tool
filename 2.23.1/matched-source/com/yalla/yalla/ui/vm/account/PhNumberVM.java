...
public final class PhNumberVM extends OooOO0 {
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<LiveDataScope<ApiResult<Boolean>>, Continuation<? super Unit>, Object> {
        ...
        public int f31151OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f31153OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ String f31154OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ String f31155OooO0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(String str, String str2, Continuation<? super OooO0O0> continuation) {
            super(2, continuation);
            this.f31154OooO0oO = str;
            this.f31155OooO0oo = str2;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0O0 oooO0O0 = PhNumberVM.this.new OooO0O0(this.f31154OooO0oO, this.f31155OooO0oo, continuation);
            oooO0O0.f31153OooO0o0 = obj;
            return oooO0O0;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f31151OooO0Oo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f31153OooO0o0;
            ...
            String str = this.f31154OooO0oO;
            String str2 = this.f31155OooO0oo;
            String isoCode = phNumberVM.getPhoneAreaCodeInfo().getIsoCode();
            this.f31153OooO0o0 = liveDataScope;
            this.f31151OooO0Oo = 1;
            obj = o00o2.OooO00o(str, str2, isoCode, source, this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f31153OooO0o0 = null;
            this.f31151OooO0Oo = 2;
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<LiveDataScope<ApiResult<CountryItemList>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31156OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f31157OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f31158OooO0o0;
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0OO oooO0OO = new OooO0OO(this.f31157OooO0o, continuation);
            oooO0OO.f31158OooO0o0 = obj;
            return oooO0OO;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            LiveDataScope liveDataScope;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31156OooO0Oo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f31158OooO0o0;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            ResultKt.throwOnFailure(obj);
            liveDataScope = (LiveDataScope) this.f31158OooO0o0;
            this.f31158OooO0o0 = liveDataScope;
            this.f31156OooO0Oo = 1;
            String str = o000oOoO.f43425o0000oo;
            o0ooOOo o0oooooOooO00o = com.common.support.apm.netdetector.OooO00o.OooO00o(str, "url", str, 0);
            o0oooooOooO00o.OooO0O0(Boxing.boxInt(this.f31157OooO0o), "source");
            obj = OooOOO.OooO0Oo(new LoginRepo$getCountry$$inlined$call$1(o0oooooOooO00o, null), this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f31158OooO0o0 = null;
            this.f31156OooO0Oo = 2;
            if (liveDataScope.emit((ApiResult) obj, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
    ...
    public PhNumberVM() {
        CountryItemData countryItemDataOooO0O0 = oO000Oo.OooO0O0(new oO000Oo());
        countryItemDataOooO0O0.setIcon(OooO0o.OooO00o(String.valueOf(countryItemDataOooO0O0.getId())));
    ...
    public final void initPhoneAreaCodeInfo(@Nullable ClientCodeType type) {
        ...
        CountryItemData countryItemDataOooO00o = new oO000Oo().OooO00o(iOooO0OO, type == ClientCodeType.Register || type == ClientCodeType.BingingPhone);
        countryItemDataOooO00o.setIcon(OooO0o.OooO00o(String.valueOf(countryItemDataOooO00o.getId())));
    ...
    public final void savePhoneInfo(@NotNull String phone, @NotNull String countryCode, @Nullable ClientCodeType type) {
        ...
        oO000O0 oo000o0OooO00o2 = o00Oo0.OooO00o();
