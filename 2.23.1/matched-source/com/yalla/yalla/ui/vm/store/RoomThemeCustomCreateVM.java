...
public final class RoomThemeCustomCreateVM extends OooOO0 {
    ...
    public static final class OooO extends SuspendLambda implements Function2<LiveDataScope<p182o00o000O.OooO0o>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ File f32077OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(File file, Continuation<? super OooO> continuation) {
            super(2, continuation);
            this.f32077OooO0oO = file;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO oooO = RoomThemeCustomCreateVM.this.new OooO(this.f32077OooO0oO, continuation);
            oooO.f32076OooO0o0 = obj;
            return oooO;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            obj = CloudFileRepo.OooO0o0(cloudFileRepo, cloudFileType, this.f32077OooO0oO, this);
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f32078OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                o00OOOOo o00ooooo2 = o00OOOOo.f46210OooO00o;
                this.f32078OooO0Oo = 1;
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<LiveDataScope<ApiResult<RenewCustomizeTheme>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f32080OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ String f32081OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f32082OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f32083OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ RoomThemeCustomCreateVM f32084OooO0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(String str, int i, RoomThemeCustomCreateVM roomThemeCustomCreateVM, Continuation<? super OooO0OO> continuation) {
            super(2, continuation);
            this.f32081OooO0o = str;
            this.f32083OooO0oO = i;
            this.f32084OooO0oo = roomThemeCustomCreateVM;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0OO oooO0OO = new OooO0OO(this.f32081OooO0o, this.f32083OooO0oO, this.f32084OooO0oo, continuation);
            oooO0OO.f32082OooO0o0 = obj;
            return oooO0OO;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            LiveDataScope liveDataScope;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f32080OooO0Oo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f32082OooO0o0;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            liveDataScope = (LiveDataScope) this.f32082OooO0o0;
            o00OOOOo o00ooooo2 = o00OOOOo.f46210OooO00o;
            this.f32082OooO0o0 = liveDataScope;
            this.f32080OooO0Oo = 1;
            obj = o00ooooo2.OooOO0(this.f32081OooO0o, this.f32083OooO0oO, this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f32084OooO0oo.getShowLoadingDialog().setValue(Boxing.boxBoolean(false));
            this.f32082OooO0o0 = null;
            this.f32080OooO0Oo = 2;
    ...
    public static final class OooO0o extends SuspendLambda implements Function2<LiveDataScope<ApiResult<RenewCustomizeTheme>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f32087OooO0o0;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f32087OooO0o0;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            ResultKt.throwOnFailure(obj);
            liveDataScope = (LiveDataScope) this.f32087OooO0o0;
            OooOOOO.OooO0OO(o0000oo.OooO00o(RoomThemeCustomCreateVM.INSTANCE), "reNewThemeId: " + roomThemeCustomCreateVM.getReNewThemeId() + "  currentThemeType:" + roomThemeCustomCreateVM.getCurrentThemeType());
            o00OOOOo o00ooooo2 = o00OOOOo.f46210OooO00o;
            ...
            this.f32087OooO0o0 = liveDataScope;
            this.f32085OooO0Oo = 1;
            obj = o00ooooo2.OooOO0O(reNewThemeId, currentThemeType, 1, this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            roomThemeCustomCreateVM.getShowLoadingDialog().setValue(Boxing.boxBoolean(false));
            this.f32087OooO0o0 = null;
