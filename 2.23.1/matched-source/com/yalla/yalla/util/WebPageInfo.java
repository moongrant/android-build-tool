...
public final class WebPageInfo implements Serializable {
    ...
    @NotNull
    public static final WebPageInfo f32285OooOOo = new WebPageInfo(WebFrom.Unknow);

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    public boolean f32286OooO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public final WebFrom f32287OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public boolean f32288OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @NotNull
    public String f32289OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    @NotNull
    public String f32290OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public boolean f32291OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    @NotNull
    public final LinkedHashMap f32292OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    @NotNull
    public ShareType f32293OooOO0O;

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    @NotNull
    public String f32294OooOO0o;

    /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
    public boolean f32295OooOOO;

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    @NotNull
    public String f32296OooOOO0;

    /* JADX INFO: renamed from: OooOOOO, reason: collision with root package name */
    public long f32297OooOOOO;

    /* JADX INFO: renamed from: OooOOOo, reason: collision with root package name */
    @Nullable
    public Dp f32298OooOOOo;

    /* JADX INFO: renamed from: OooOOo0, reason: collision with root package name */
    @Nullable
    public Long f32299OooOOo0;
    ...
    public WebPageInfo(@NotNull WebFrom from) {
        ...
        this.f32287OooO0Oo = from;
        this.f32289OooO0o0 = "";
        this.f32290OooO0oO = "";
        this.f32291OooO0oo = true;
        this.f32292OooOO0 = new LinkedHashMap();
        this.f32293OooOO0O = ShareType.NoShare;
        this.f32294OooOO0o = "";
        this.f32296OooOOO0 = "";
        this.f32297OooOOOO = o0O0o.f48093OooO0O0;
    }
    ...
    public final void OooO00o(@NotNull String key, @NotNull String value) {
        ...
        this.f32292OooOO0.put(key, value);
    }

    /* JADX WARN: Multi-variable type inference failed */
    @NotNull
    public final String OooO0O0(boolean z) {
        StringBuffer stringBuffer = new StringBuffer(this.f32289OooO0o0);
        ...
        if (Intrinsics.areEqual(oo0oO0.OooOo0O().getValue(), Boolean.TRUE)) {
            ...
            int i = OooO00o.$EnumSwitchMapping$0[this.f32287OooO0Oo.ordinal()];
            stringBuffer.append("&token=" + ((i == 1 || i == 2 || i == 3 || i == 4 || i == 5) ? (String) ((MutableLiveData) oo0oO0.f47993OooOoo.getValue()).getValue() : (String) oo0oO0.OooOOOO().getValue()));
        }
        LinkedHashMap linkedHashMap = this.f32292OooOO0;
    ...
    public final void OooO0OO(@NotNull ShareType type, @NotNull String imgUrl, @NotNull String content) {
        ...
        this.f32293OooOO0O = type;
        this.f32294OooOO0o = imgUrl;
        this.f32296OooOOO0 = content;
    }

    @NotNull
    public final void OooO0Oo(@NotNull String title) {
        Intrinsics.checkNotNullParameter(title, "title");
        this.f32290OooO0oO = title;
    }

    @NotNull
    public final void OooO0o0(@NotNull String url) {
        Intrinsics.checkNotNullParameter(url, "url");
        this.f32289OooO0o0 = url;
    }

    @NotNull
    public final String toString() {
        String str = this.f32289OooO0o0;
        boolean z = this.f32288OooO0o;
        String str2 = this.f32290OooO0oO;
        boolean z2 = this.f32291OooO0oo;
        boolean z3 = this.f32286OooO;
        LinkedHashMap linkedHashMap = this.f32292OooOO0;
        ShareType shareType = this.f32293OooOO0O;
        String str3 = this.f32294OooOO0o;
        String str4 = this.f32296OooOOO0;
        boolean z4 = this.f32295OooOOO;
        String strM1689toStringimpl = Color.m1689toStringimpl(this.f32297OooOOOO);
        Dp dp = this.f32298OooOOOo;
        Long l = this.f32299OooOOo0;
        StringBuilder sb = new StringBuilder("WebPageInfo(from=");
        sb.append(this.f32287OooO0Oo);
        sb.append(", url='");
        sb.append(str);
