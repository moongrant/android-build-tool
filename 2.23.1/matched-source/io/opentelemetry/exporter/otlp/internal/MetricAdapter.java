...
public final class MetricAdapter {
    ...
    @NotNull
    public static final MetricAdapter f32587OooO00o = new MetricAdapter();
    ...
    public static ArrayList OooO(@NotNull Collection points) {
        ...
        while (it.hasNext()) {
            ...
            longPointData.OooO00o().OooO0o(new o0000oo(builderNewBuilder));
            List<Exemplar> listOooO0o0 = longPointData.OooO0o0();
            Intrinsics.checkNotNullExpressionValue(listOooO0o0, "longPoint.exemplars");
            Iterator<T> it2 = listOooO0o0.iterator();
            if (it2.hasNext()) {
                Exemplar exemplar = (Exemplar) it2.next();
                f32587OooO00o.getClass();
                OooO0oo(exemplar);
                throw null;
            }
    ...
    public static ArrayList OooO0oO(@NotNull Collection points) {
        ...
        while (it.hasNext()) {
            ...
            doublePointData.OooO00o().OooO0o(new oO00o000(builderNewBuilder, 3));
            List<Exemplar> listOooO0o0 = doublePointData.OooO0o0();
            Intrinsics.checkNotNullExpressionValue(listOooO0o0, "doublePoint.exemplars");
            Iterator<T> it2 = listOooO0o0.iterator();
            if (it2.hasNext()) {
                Exemplar exemplar = (Exemplar) it2.next();
                f32587OooO00o.getClass();
        ...
        while (it.hasNext()) {
            ...
            if (!metricData2.OooOOO()) {
                ...
                switch (metricDataTypeOooOO0o == null ? -1 : WhenMappings.$EnumSwitchMapping$0[metricDataTypeOooOO0o.ordinal()]) {
                    case 1:
                        LongSumData longSumData = metricData2.OooOO0o() == MetricDataType.LONG_SUM ? (LongSumData) metricData2.OooO0oO() : MetricData.f32756OooO0Oo;
                        ...
                        break;
                    case 2:
                        DoubleSumData doubleSumData = metricData2.OooOO0o() == MetricDataType.DOUBLE_SUM ? (DoubleSumData) metricData2.OooO0oO() : MetricData.f32755OooO0OO;
                        ...
                        break;
                    case 3:
                        DoubleSummaryData doubleSummaryData = metricData2.OooOO0o() == MetricDataType.SUMMARY ? (DoubleSummaryData) metricData2.OooO0oO() : MetricData.f32758OooO0o0;
                        ...
                        for (DoubleSummaryPointData doubleSummaryPointData : points) {
                            ...
                            doubleSummaryPointData.OooO00o().OooO0o(new o0O000o0(builderNewBuilder5));
                        ...
                        break;
                    case 4:
                        LongGaugeData longGaugeData = metricData2.OooOO0o() == MetricDataType.LONG_GAUGE ? (LongGaugeData) metricData2.OooO0oO() : MetricData.f32754OooO0O0;
                        ...
                        break;
                    case 5:
                        DoubleGaugeData doubleGaugeData = metricData2.OooOO0o() == MetricDataType.DOUBLE_GAUGE ? (DoubleGaugeData) metricData2.OooO0oO() : MetricData.f32753OooO00o;
                        ...
                        break;
                    case 6:
                        DoubleHistogramData doubleHistogramData = metricData2.OooOO0o() == MetricDataType.HISTOGRAM ? (DoubleHistogramData) metricData2.OooO0oO() : MetricData.f32757OooO0o;
                        ...
                        for (DoubleHistogramPointData doubleHistogramPointData : points2) {
                            ...
                            doubleHistogramPointData.OooO00o().OooO0o(new o0000O00(builderNewBuilder10, 3));
                            List<Exemplar> listOooO0o0 = doubleHistogramPointData.OooO0o0();
                            Intrinsics.checkNotNullExpressionValue(listOooO0o0, "doubleHistogramPoint.exemplars");
                            Iterator<T> it2 = listOooO0o0.iterator();
                            if (it2.hasNext()) {
                                Exemplar exemplar = (Exemplar) it2.next();
                                f32587OooO00o.getClass();
