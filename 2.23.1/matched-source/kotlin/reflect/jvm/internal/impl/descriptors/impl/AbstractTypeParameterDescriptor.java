...
public abstract class AbstractTypeParameterDescriptor extends DeclarationDescriptorNonRootImpl implements TypeParameterDescriptor {
    ...
    public class TypeParameterTypeConstructor extends AbstractTypeConstructor {
        ...
        public void reportSupertypeLoopError(@NotNull KotlinType kotlinType) {
            ...
            this.this$0.mo5495reportSupertypeLoopError(kotlinType);
        }
    ...
    public List<KotlinType> getUpperBounds() {
        List<KotlinType> listMo5493getSupertypes = ((TypeParameterTypeConstructor) getTypeConstructor()).mo5493getSupertypes();
        if (listMo5493getSupertypes == null) {
            $$$reportNull$$$0(8);
        }
        return listMo5493getSupertypes;
    }
    ...
    public abstract void mo5495reportSupertypeLoopError(@NotNull KotlinType kotlinType);
