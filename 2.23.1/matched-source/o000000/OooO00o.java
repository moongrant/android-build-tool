...
public final class OooO00o {
    ...
    public static /* synthetic */ class C0387OooO00o {
        ...
        public static final /* synthetic */ int[] f33223OooO00o;
        ...
        static {
            ...
            try {
                f33223OooO00o[ConstraintAttribute.AttributeType.FLOAT_TYPE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f33223OooO00o[ConstraintAttribute.AttributeType.COLOR_DRAWABLE_TYPE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f33223OooO00o[ConstraintAttribute.AttributeType.COLOR_TYPE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f33223OooO00o[ConstraintAttribute.AttributeType.STRING_TYPE.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f33223OooO00o[ConstraintAttribute.AttributeType.BOOLEAN_TYPE.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f33223OooO00o[ConstraintAttribute.AttributeType.DIMENSION_TYPE.ordinal()] = 7;
    ...
    public static void OooO0O0(ConstraintAttribute constraintAttribute, View view, float[] fArr) {
        ...
        String str = "set" + constraintAttribute.f4915OooO0O0;
        try {
            boolean z = true;
            switch (C0387OooO00o.f33223OooO00o[constraintAttribute.f4916OooO0OO.ordinal()]) {
                case 1:
                ...
                case 4:
                    ...
                    return;
                case 5:
                    throw new RuntimeException("unable to interpolate strings " + constraintAttribute.f4915OooO0O0);
                case 6:
