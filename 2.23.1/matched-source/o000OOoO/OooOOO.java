...
public final class OooOOO implements o0OoOo0 {
    ...
    @Nullable
    public o0O00 f34682OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public static final int[] f34680OooO0o0 = {5, 4, 12, 8, 3, 10, 9, 11, 6, 2, 0, 1, 7, 16, 15, 14};

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public static final OooO00o f34679OooO0o = new OooO00o(new o000O00O.o00000O0());

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public static final OooO00o f34681OooO0oO = new OooO00o(new OooOOO0());

    public static final class OooO00o {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final InterfaceC0403OooO00o f34683OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final AtomicBoolean f34684OooO0O0 = new AtomicBoolean(false);

        /* JADX INFO: renamed from: o000OOoO.OooOOO$OooO00o$OooO00o, reason: collision with other inner class name */
        public interface InterfaceC0403OooO00o {
            @Nullable
        ...
        public OooO00o(InterfaceC0403OooO00o interfaceC0403OooO00o) {
            this.f34683OooO00o = interfaceC0403OooO00o;
        }

        @Nullable
        public final Extractor OooO00o(Object... objArr) {
            Constructor<? extends Extractor> constructorOooO00o;
            synchronized (this.f34684OooO0O0) {
                try {
                    if (!this.f34684OooO0O0.get()) {
                        try {
                            constructorOooO00o = this.f34683OooO00o.OooO00o();
                        } catch (ClassNotFoundException unused) {
                            this.f34684OooO0O0.set(true);
    ...
    public final void OooO0O0(int i, ArrayList arrayList) {
        switch (i) {
            ...
            case 3:
                ...
                break;
            case 4:
                Extractor extractorOooO00o = f34679OooO0o.OooO00o(0);
            ...
            case 10:
                ...
                break;
            case 11:
                if (this.f34682OooO0Oo == null) {
                    ImmutableList.OooO0O0 oooO0O0 = ImmutableList.f18686OooO0o0;
                    this.f34682OooO0Oo = o0O00.f19065OooO0oo;
                }
                arrayList.add(new TsExtractor(new o000O00O(0L), new DefaultTsPayloadReaderFactory(this.f34682OooO0Oo)));
                break;
            case 12:
            ...
            case 14:
                ...
                break;
            case 15:
                Extractor extractorOooO00o2 = f34681OooO0oO.OooO00o(new Object[0]);
