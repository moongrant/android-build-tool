...
public final class o000OO00 {
    ...
    @Nullable
    public static HashMap<String, String> f34964OooO;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    @UnstableApi
    public static final int f34965OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @UnstableApi
    public static final String f34966OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @UnstableApi
    public static final String f34967OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @UnstableApi
    public static final String f34968OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @UnstableApi
    public static final byte[] f34969OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @UnstableApi
    public static final String f34970OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public static final Pattern f34971OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public static final Pattern f34972OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public static final String[] f34973OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public static final String[] f34974OooOO0O;

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    public static final int[] f34975OooOO0o;

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    public static final int[] f34976OooOOO0;
    ...
    @UnstableApi
    public static int OooO0Oo(o00000O0 o00000o1, long j) {
        int i = o00000o1.f34931OooO00o - 1;
        int i2 = 0;
        while (i2 <= i) {
            int i3 = (i2 + i) >>> 1;
            if (o00000o1.OooO0O0(i3) < j) {
                i2 = i3 + 1;
            } else {
                i = i3 - 1;
            }
        ...
        int i4 = i + 1;
        if (i4 < o00000o1.f34931OooO00o && o00000o1.OooO0O0(i4) == j) {
            return i4;
        }
        if (i == -1) {
            return 0;
    ...
    public static int OooOO0O(int i, byte[] bArr, int i2, int i3) {
        while (i < i2) {
            i3 = f34975OooOO0o[((i3 >>> 24) ^ (bArr[i] & 255)) & 255] ^ (i3 << 8);
            i++;
        }
        return i3;
    }
    ...
    @UnstableApi
    public static Handler OooOOO0(@Nullable oo0o0Oo oo0o0oo) {
        Looper looperMyLooper = Looper.myLooper();
        if (looperMyLooper == null) {
            looperMyLooper = Looper.getMainLooper();
        }
        return new Handler(looperMyLooper, oo0o0oo);
    }

    @UnstableApi
    public static String OooOOOO(byte[] bArr) {
        return new String(bArr, OooOO0.f18597OooO0OO);
    }
    ...
    @UnstableApi
    public static Drawable OooOOo0(Context context, Resources resources, @DrawableRes int i) {
        return f34965OooO00o >= 21 ? OooO00o.OooO00o(context, resources, i) : resources.getDrawable(i);
    }
    ...
    @UnstableApi
    public static long OooOo00(long j, float f) {
    ...
    public static String[] OooOoO() {
        ...
        for (int i2 = 0; i2 < strArrSplit.length; i2++) {
            strArrSplit[i2] = Oooo0o0(strArrSplit[i2]);
        }
        return strArrSplit;
    }

    @UnstableApi
    public static String OooOoO0(StringBuilder sb, Formatter formatter, long j) {
    ...
    public static byte[] OooOoo(String str) {
        return str.getBytes(OooOO0.f18597OooO0OO);
    }
    ...
    public static boolean OooOooo(@Nullable Player player) {
        ...
        if (iOooo0o != 1 || !player.OooOOo0(2)) {
            if (iOooo0o == 4 && player.OooOOo0(4)) {
                player.OooO0oo();
            } else {
                z = false;
            }
    ...
    public static int Oooo000(Uri uri, @Nullable String str) {
        int i;
        boolean z;
        char c;
        if (str != null) {
                ...
                if (4 == scheme.length()) {
                    ...
                    while (true) {
                        if (i2 >= 4) {
                            ...
                            char cCharAt = "rtsp".charAt(i2);
                            char cCharAt2 = scheme.charAt(i2);
        ...
        if (iLastIndexOf >= 0) {
            String strOooO00o = OooO0OO.OooO00o(lastPathSegment.substring(iLastIndexOf + 1));
            strOooO00o.getClass();
            switch (strOooO00o.hashCode()) {
                case 104579:
                    if (strOooO00o.equals("ism")) {
                    }
                    break;
                case 108321:
                    if (strOooO00o.equals("mpd")) {
                    }
                    break;
                case 3242057:
                    if (strOooO00o.equals("isml")) {
                    }
                    break;
                case 3299913:
                    if (strOooO00o.equals("m3u8")) {
                    }
                    break;
            }
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: p080o000OoO.o000OO00.Oooo000(android.net.Uri, java.lang.String):int");
        }

        @UnstableApi
        public static boolean Oooo00O(o0000OO0 o0000oo1, o0000OO0 o0000oo2, @Nullable Inflater inflater) {
            int i = o0000oo1.f34951OooO0OO - o0000oo1.f34950OooO0O0;
            if (i <= 0) {
                return false;
            }
            if (o0000oo2.f34949OooO00o.length < i) {
                o0000oo2.OooO00o(i * 2);
            }
            if (inflater == null) {
                inflater = new Inflater();
            }
            byte[] bArr = o0000oo1.f34949OooO00o;
            int i2 = o0000oo1.f34950OooO0O0;
            inflater.setInput(bArr, i2, o0000oo1.f34951OooO0OO - i2);
            int iInflate = 0;
            while (true) {
                try {
                    ...
                    if (inflater.finished()) {
                        o0000oo2.Oooo000(iInflate);
                        inflater.reset();
                        return true;
                    }
                    if (!inflater.needsDictionary() && !inflater.needsInput()) {
                        byte[] bArr3 = o0000oo2.f34949OooO00o;
                        if (iInflate == bArr3.length) {
                            o0000oo2.OooO00o(bArr3.length * 2);
                        }
                    }
                    inflater.reset();
                    return false;
        ...
        public static Object[] Oooo0o(int i, Object[] objArr) {
            o00O0O.OooO00o(i <= objArr.length);
        ...
        public static String Oooo0o0(String str) {
            ...
            int i = 0;
            String str2 = strOooO00o.split("-", 2)[0];
            if (f34964OooO == null) {
                String[] iSOLanguages = Locale.getISOLanguages();
                int length = iSOLanguages.length;
                String[] strArr = f34973OooOO0;
            ...
            String str4 = f34964OooO.get(str2);
            if (str4 != null) {
                StringBuilder sbOooO00o = o0o0Oo.OooO00o(str4);
                sbOooO00o.append(strOooO00o.substring(str2.length()));
            ...
            while (true) {
                String[] strArr2 = f34974OooOO0O;
                if (i >= strArr2.length) {
                    return strOooO00o;
                }
                if (strOooO00o.startsWith(strArr2[i])) {
                    return strArr2[i + 1] + strOooO00o.substring(strArr2[i].length());
                }
                i += 2;
            }
        }
        ...
        @UnstableApi
        public static long Oooo0oo(int i, long j) {
            return (j * AnimationKt.MillisToNanos) / ((long) i);
        }

        @UnstableApi
        public static boolean OoooO(android.database.sqlite.SQLiteDatabase sQLiteDatabase, String str) {
            return DatabaseUtils.queryNumEntries(sQLiteDatabase, "sqlite_master", "tbl_name = ?", new String[]{str}) > 0;
        }

        @EnsuresNonNullIf(expression = {"#1"}, result = false)
        public static boolean OoooO0(@Nullable Player player) {
            return player == null || !player.OooOoOO() || player.Oooo0o() == 1 || player.Oooo0o() == 4;
        }

        @UnstableApi
        public static void OoooO00(long[] jArr, long j) {
            int i = 0;
        ...
        @UnstableApi
        public static long o000oOoO(long j) {
            return (j == -9223372036854775807L || j == Long.MIN_VALUE) ? j : j / 1000;
        }
    }
