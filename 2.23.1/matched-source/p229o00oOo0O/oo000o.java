...
public final class oo000o extends Painter implements RememberObserver {
    ...
    @NotNull
    public final Drawable f39741OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @NotNull
    public final Lazy f39742OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @NotNull
    public final MutableState f39743OooO0o0;
    ...
    public oo000o(@NotNull Drawable drawable) {
        ...
        this.f39741OooO0Oo = drawable;
        this.f39743OooO0o0 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(0, null, 2, null);
        this.f39742OooO0o = LazyKt.lazy(new OooO0O0());
        drawable.setBounds(0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight());
    }

    @Override // androidx.compose.ui.graphics.painter.Painter
    public final boolean applyAlpha(float f) {
        this.f39741OooO0Oo.setAlpha(RangesKt.coerceIn(MathKt.roundToInt(f * 255), 0, 255));
        return true;
    }

    @Override // androidx.compose.ui.graphics.painter.Painter
    public final boolean applyColorFilter(@Nullable ColorFilter colorFilter) {
        this.f39741OooO0Oo.setColorFilter(colorFilter == null ? null : AndroidColorFilter_androidKt.asAndroidColorFilter(colorFilter));
        return true;
    }
    ...
    public final boolean applyLayoutDirection(@NotNull LayoutDirection layoutDirection) {
        ...
        return this.f39741OooO0Oo.setLayoutDirection(i2);
    }

    @Override // androidx.compose.ui.graphics.painter.Painter
    /* JADX INFO: renamed from: getIntrinsicSize-NH-jbRc */
    public final long mo2211getIntrinsicSizeNHjbRc() {
        Drawable drawable = this.f39741OooO0Oo;
    ...
    public final void onDraw(@NotNull DrawScope drawScope) {
        ...
        ((Number) this.f39743OooO0o0.getValue()).intValue();
    ...
    public final void onRemembered() {
        Drawable.Callback callback = (Drawable.Callback) this.f39742OooO0o.getValue();
        Drawable drawable = this.f39741OooO0Oo;
