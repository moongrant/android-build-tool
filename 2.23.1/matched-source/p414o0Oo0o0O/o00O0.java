...
public final class o00O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f46069OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ MutableLiveData<Boolean> f46070OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ ChatMessage f46071OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final /* synthetic */ List<Long> f46072OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final /* synthetic */ List<Pair<String, String>> f46073OooO0oo;
    ...
    public o00O0(ChatMessage chatMessage, MutableLiveData<Boolean> mutableLiveData, List<Long> list, List<Pair<String, String>> list2, Continuation<? super o00O0> continuation) {
        ...
        this.f46071OooO0o0 = chatMessage;
        this.f46070OooO0o = mutableLiveData;
        this.f46072OooO0oO = list;
        this.f46073OooO0oo = list2;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o00O0(this.f46071OooO0o0, this.f46070OooO0o, this.f46072OooO0oO, this.f46073OooO0oo, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f46069OooO0Oo;
        MutableLiveData<Boolean> mutableLiveData = this.f46070OooO0o;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ChatMessage chatMessage = this.f46071OooO0o0;
        ...
        Iterator<T> it2 = this.f46073OooO0oo.iterator();
        while (it2.hasNext()) {
            Pair pair = (Pair) it2.next();
            o00O0000.OooOO0((String) pair.getFirst(), zIsSuccess);
            o00O0000.OooOO0((String) pair.getSecond(), zIsSuccess);
        }
        if (!zIsSuccess) {
