...
public final /* synthetic */ class o000O0 implements Observer {
    ...
    public final /* synthetic */ int f47285OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ Object f47286OooO0o0;

    public /* synthetic */ o000O0(Object obj, int i) {
        this.f47285OooO0Oo = i;
        this.f47286OooO0o0 = obj;
    }

    @Override // androidx.lifecycle.Observer
    public final void onChanged(Object obj) {
        int i = this.f47285OooO0Oo;
        Object obj2 = this.f47286OooO0o0;
        switch (i) {
            case 0:
                ...
                if (bool.booleanValue()) {
                    o000O.OooOOOO(this$0.f23100OooO0o0);
                } else {
                    o000O.OooO0O0(this$0.f23100OooO0o0);
                }
                boolean zBooleanValue = bool.booleanValue();
                int i2 = o0Oo0oo.cv;
                MixedRoomActivity mixedRoomActivity = this$0.f23095OooO00o;
                View viewFindViewById = mixedRoomActivity.findViewById(i2);
                final LinearLayout linearLayout = (LinearLayout) mixedRoomActivity.findViewById(o0Oo0oo.v_room_content);
                ...
                if (i3 != i4) {
                    ...
                    valueAnimatorOfInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: o0OoOo0o.o000O
                        ...
                        public final void onAnimationUpdate(ValueAnimator it) {
                            ...
                            com.code.android.util.o000O.OooOO0o(linearLayout2, iIntValue);
            ...
            case 1:
                ...
                int i5 = MainSearchActivity.f24961OooOoO;
                Intrinsics.checkNotNullParameter(this$1, "this$0");
                Function1<? super String, Unit> function1 = this$1.f24968OooOoO0;
                if (function1 != null) {
            ...
            case 2:
                ...
                break;
            default:
                RoomThemeCustomCreateVM roomThemeCustomCreateVM = (RoomThemeCustomCreateVM) obj2;
                if (obj != null) {
