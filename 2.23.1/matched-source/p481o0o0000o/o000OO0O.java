...
public final class o000OO0O extends o000O00 {
    ...
    public static void OooO0Oo(String str) {
        ...
        if (o000O00.OooO00o() || (activityOooO0O0 instanceof FriendRequestMessageActivity) || App.f22237OooO0o0) {
            return;
        }
        oOO0.OooO0O0("Yalla_Notice_YallaTeam", o0000.OooO0OO(o000OOo.Notice_Title_yalla_team), str, str, new Intent(o000O00O.OooO00o(), (Class<?>) YallaTeamMessageActivity.class));
    }

    /* JADX WARN: Multi-variable type inference failed */
    public final void OooO0OO(@NotNull MessageIM.Message msg, boolean z) {
        Intrinsics.checkNotNullParameter(msg, "msg");
        OooOOOO.OooO0OO("YallaTeamMsgProcessor", " parseMessage = " + msg);
        if (msg.getHead() == 2102) {
            ...
            OooOOOO.OooO0OO("YallaTeamMsgProcessor", " type = " + yallaTeamMessageModel.getType() + " message = " + OooO.OooO00o(yallaTeamMessageModel.getData()));
            ...
            if (type == 43) {
                ...
                Integer num2 = (Integer) oo0oO0.OooOOO0().getValue();
                if (num2 != null && area2 == num2.intValue()) {
                    ...
                    o00O0O.OooO00o().Oooo0O0().OooO0oO(message2);
                    OooO0Oo(o0000.OooO0OO(o000OOo.yalla_team_feedback_replied));
                    return;
                }
                return;
            }
            if (type != 70) {
                ...
                o00O0O.OooO00o().Oooo0O0().OooO0oO(message3);
                OooO0Oo(o0000.OooO0OO(o000OOo.yalla_team_satisfaction_survey_title));
                return;
            }
            int area3 = from.getArea();
            oo0oO0 oo0oo2 = oo0oO0.f47967OooO00o;
            Integer num3 = (Integer) oo0oO0.OooOOO0().getValue();
            if (num3 != null && area3 == num3.intValue()) {
                ...
                o00O0O.OooO00o().Oooo0O0().OooO0oO(message4);
