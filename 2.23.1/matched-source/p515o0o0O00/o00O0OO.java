...
public final class o00O0OO {
    ...
    public static final class OooO00o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ MomentBannerModel f51302OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f51303OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(MomentBannerModel momentBannerModel, int i) {
            super(2);
            this.f51302OooO0Oo = momentBannerModel;
            this.f51303OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f51303OooO0o0 | 1);
            o00O0OO.OooO00o(this.f51302OooO0Oo, composer, iUpdateChangedFlags);
    ...
    public static final class OooO0O0 extends Lambda implements Function3<Integer, Composer, Integer, Unit> {
        ...
        public final /* synthetic */ Context f51305OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ List<MomentBannerModel.MomentBannerItem> f51306OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ BaseMomentDetailVM f51307OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ LifecycleOwner f51308OooO0oo;
        ...
        public OooO0O0(int i, List list, Context context, BaseMomentDetailVM baseMomentDetailVM, LifecycleOwner lifecycleOwner) {
            ...
            this.f51306OooO0o0 = list;
            this.f51305OooO0o = context;
            this.f51307OooO0oO = baseMomentDetailVM;
            this.f51308OooO0oo = lifecycleOwner;
        }
        ...
        public final Unit invoke(Integer num, Composer composer, Integer num2) {
            ...
            if ((iIntValue2 & 91) == 18 && composer2.getSkipping()) {
                ...
                int iOooO0OO = o00000.OooO0OO(iIntValue - LockFreeTaskQueueCore.MAX_CAPACITY_MASK, this.f51304OooO0Oo);
                ImageKt.Image(o0000O0O.OooO0OO(this.f51306OooO0o0.get(iOooO0OO).getImageUrl(), o00O0OOO.f51314OooO0Oo, composer2, 48, 0), (String) null, o0O0O00.OooO0O0(o000.OooO00o(9, SizeKt.fillMaxSize$default(Modifier.INSTANCE, 0.0f, 1, null)), false, false, 0L, false, null, null, null, new o00O(this.f51306OooO0o0, iOooO0OO, this.f51305OooO0o, this.f51307OooO0oO, this.f51308OooO0oo), 253), (Alignment) null, ContentScale.INSTANCE.getCrop(), 0.0f, (ColorFilter) null, composer2, 24624, 104);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public static final class OooO0OO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MomentBannerModel f51309OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f51310OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(MomentBannerModel momentBannerModel, int i) {
            super(2);
            this.f51309OooO0Oo = momentBannerModel;
            this.f51310OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f51310OooO0o0 | 1);
            o00O0OO.OooO00o(this.f51309OooO0Oo, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MomentBannerModel f51311OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f51312OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(MomentBannerModel momentBannerModel, int i) {
            super(2);
            this.f51311OooO0Oo = momentBannerModel;
            this.f51312OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f51312OooO0o0 | 1);
            o00O0OO.OooO00o(this.f51311OooO0Oo, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
