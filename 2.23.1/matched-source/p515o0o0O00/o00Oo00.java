...
public final class o00Oo00 {
    ...
    public static final class OooO00o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ String f51368OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f51369OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f51370OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(String str, int i, int i2) {
            super(2);
            this.f51368OooO0Oo = str;
            this.f51370OooO0o0 = i;
            this.f51369OooO0o = i2;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f51370OooO0o0 | 1);
            o00Oo00.OooO00o(this.f51368OooO0Oo, composer, iUpdateChangedFlags, this.f51369OooO0o);
    ...
    public static final class OooO0O0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ LoadMoreState f51371OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f51372OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ String f51373OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f51374OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(LoadMoreState loadMoreState, String str, int i, int i2) {
            super(2);
            this.f51371OooO0Oo = loadMoreState;
            this.f51373OooO0o0 = str;
            this.f51372OooO0o = i;
            this.f51374OooO0oO = i2;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f51372OooO0o | 1);
            o00Oo00.OooO0O0(this.f51371OooO0Oo, this.f51373OooO0o0, composer, iUpdateChangedFlags, this.f51374OooO0oO);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0OO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ int f51375OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(int i) {
            super(2);
            this.f51375OooO0Oo = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            o00Oo00.OooO0OO(composer, RecomposeScopeImplKt.updateChangedFlags(this.f51375OooO0Oo | 1));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final void OooO00o(String str, Composer composer, int i, int i2) {
        ...
        if ((i3 & 11) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            if ((i & 1) != 0 && !composerStartRestartGroup.getDefaultsInvalid()) {
                ...
                strStringResource = StringResources_androidKt.stringResource(o000OOo.No_more_data, composerStartRestartGroup, 0);
                i3 &= -15;
            }
            ...
            Modifier modifierOooO00o = kotlin.reflect.jvm.internal.impl.builtins.OooO00o.OooO00o(50, SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), composerStartRestartGroup, 733328855);
            ...
            composer2 = composerStartRestartGroup;
            TextKt.m1261Text4IGK_g(str2, boxScopeInstance.align(companion, companion2.getCenter()), o0000oo.OooO0OO(composerStartRestartGroup).f38622OooOO0O, sp, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, (i5 & 14) | 3072, 0, 131056);
    ...
    public static final void OooO0O0(@NotNull LoadMoreState state, @Nullable String str, @Nullable Composer composer, int i, int i2) {
        ...
        if ((i3 & 91) == 18 && composerStartRestartGroup.getSkipping()) {
            ...
            if ((i & 1) != 0 && !composerStartRestartGroup.getDefaultsInvalid()) {
                ...
                str = StringResources_androidKt.stringResource(o000OOo.event_not_more, composerStartRestartGroup, 0);
                i3 &= -113;
            }
            composerStartRestartGroup.endDefaults();
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void OooO0OO(Composer composer, int i) {
        ...
        if (i == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            Modifier.Companion companion = Modifier.INSTANCE;
            Modifier modifierOooO00o = kotlin.reflect.jvm.internal.impl.builtins.OooO00o.OooO00o(60, SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), composerStartRestartGroup, 733328855);
            Alignment.Companion companion2 = Alignment.INSTANCE;
            MeasurePolicy measurePolicyOooO00o = Oooo000.OooO00o(companion2, false, composerStartRestartGroup, 0, -1323940314);
            int currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
            CompositionLocalMap currentCompositionLocalMap = composerStartRestartGroup.getCurrentCompositionLocalMap();
            ...
            OooOO0.OooO00o(0, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composerStartRestartGroup)), composerStartRestartGroup, 2058660585);
            o0OO0o00.OooO00o(BoxScopeInstance.INSTANCE.align(SizeKt.m527sizeVpY3zN4(companion, Dp.m3775constructorimpl(75), Dp.m3775constructorimpl(45)), companion2.getCenter()), composerStartRestartGroup, 0);
            composerStartRestartGroup.endReplaceableGroup();
