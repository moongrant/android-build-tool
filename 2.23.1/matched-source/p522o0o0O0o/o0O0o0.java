...
public final class o0O0o0 {
    ...
    @NotNull
    public static final o0O0o0 f52969OooO00o = new o0O0o0();

    public static final class OooO00o extends Lambda implements Function1<SoundRippleAnimationType, Unit> {

        /* JADX INFO: renamed from: OooO, reason: collision with root package name */
        public final /* synthetic */ MutableState<Float> f52970OooO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ CoroutineScope f52971OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ MutableState<SoundRippleAnimationType> f52972OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MutableState<Job> f52973OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ Animatable<Float, AnimationVector1D> f52974OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ MutableState<Color> f52975OooO0oo;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public final /* synthetic */ List<Float> f52976OooOO0;

        /* JADX INFO: renamed from: o0o0O0o.o0O0o0$OooO00o$OooO00o, reason: collision with other inner class name */
        public /* synthetic */ class C0481OooO00o {
        ...
        public OooO00o(CoroutineScope coroutineScope, MutableState<Job> mutableState, MutableState<SoundRippleAnimationType> mutableState2, Animatable<Float, AnimationVector1D> animatable, MutableState<Color> mutableState3, MutableState<Float> mutableState4, List<Float> list) {
            super(1);
            this.f52971OooO0Oo = coroutineScope;
            this.f52973OooO0o0 = mutableState;
            this.f52972OooO0o = mutableState2;
            this.f52974OooO0oO = animatable;
            this.f52975OooO0oo = mutableState3;
            this.f52970OooO = mutableState4;
            this.f52976OooOO0 = list;
        }
        ...
        public final Unit invoke(SoundRippleAnimationType soundRippleAnimationType) {
            ...
            MutableState<Job> mutableState = this.f52973OooO0o0;
            if (mutableState.getValue() == null) {
                this.f52972OooO0o.setValue(type);
                int i = C0481OooO00o.$EnumSwitchMapping$0[type.ordinal()];
                MutableState<Color> mutableState2 = this.f52975OooO0oo;
                Animatable<Float, AnimationVector1D> animatable = this.f52974OooO0oO;
                if (i == 1) {
                    jobLaunch$default = BuildersKt__Builders_commonKt.launch$default(this.f52971OooO0Oo, null, null, new oo0OOoo(animatable, mutableState2, mutableState, null), 3, null);
                } else if (i == 2) {
                    jobLaunch$default = BuildersKt__Builders_commonKt.launch$default(this.f52971OooO0Oo, null, null, new o0O0o000(animatable, mutableState2, mutableState, null), 3, null);
                } else {
                    if (i != 3) {
                        throw new NoWhenBranchMatchedException();
                    }
                    jobLaunch$default = BuildersKt__Builders_commonKt.launch$default(this.f52971OooO0Oo, null, null, new o0O0o00O(this.f52970OooO, this.f52976OooOO0, mutableState, null), 3, null);
                }
    ...
    public static final class OooO0O0 extends Lambda implements Function1<DrawScope, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Animatable<Float, AnimationVector1D> f52977OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MutableState<Color> f52978OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(Animatable<Float, AnimationVector1D> animatable, MutableState<Color> mutableState) {
            super(1);
            this.f52977OooO0Oo = animatable;
            this.f52978OooO0o0 = mutableState;
        }
        ...
        public final Unit invoke(DrawScope drawScope) {
            ...
            Animatable<Float, AnimationVector1D> animatable = this.f52977OooO0Oo;
            if (animatable.getValue().floatValue() > 0.0f) {
                ...
                for (int i = 0; i < 4; i++) {
                    ...
                    if (fM1516getWidthimpl2 <= f4 && f4 <= fM1516getWidthimpl) {
                        androidx.compose.ui.graphics.drawscope.OooO0O0.OooOo(Canvas, Color.m1680copywmQWz5c$default(this.f52978OooO0o0.getValue().m1691unboximpl(), RangesKt.coerceIn(f5, 0.0f, 1.0f), 0.0f, 0.0f, 0.0f, 14, null), f4, 0L, 0.0f, null, null, 0, 124, null);
                    }
                }
            }
            return Unit.INSTANCE;
    ...
    public static final class OooO0OO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ Function1<Function1<? super SoundRippleAnimationType, Unit>, Unit> f52980OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ Modifier f52981OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f52982OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ int f52983OooO0oo;
        ...
        public OooO0OO(Modifier modifier, Function1<? super Function1<? super SoundRippleAnimationType, Unit>, Unit> function1, int i, int i2) {
            super(2);
            this.f52981OooO0o0 = modifier;
            this.f52980OooO0o = function1;
            this.f52982OooO0oO = i;
            this.f52983OooO0oo = i2;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            o0O0o0.this.OooO00o(this.f52981OooO0o0, this.f52980OooO0o, composer, RecomposeScopeImplKt.updateChangedFlags(this.f52982OooO0oO | 1), this.f52983OooO0oo);
            return Unit.INSTANCE;
        }
    }
    ...
    public final void OooO00o(@Nullable Modifier modifier, @NotNull Function1<? super Function1<? super SoundRippleAnimationType, Unit>, Unit> animationLauncher, @Nullable Composer composer, int i, int i2) {
        ...
        if ((i3 & 91) == 18 && composerStartRestartGroup.getSkipping()) {
            ...
            if (objRememberedValue2 == companion.getEmpty()) {
                objRememberedValue2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Color.m1671boximpl(o0O0o.f48093OooO0O0), null, 2, null);
