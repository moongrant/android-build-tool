...
public final class c implements MeasurePolicy {
    ...
    public final /* synthetic */ q f57619OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final /* synthetic */ i f57620OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final /* synthetic */ int f57621OooO0OO = 257;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ MutableState<Boolean> f57622OooO0Oo;

    public static final class OooO00o extends Lambda implements Function1<Placeable.PlacementScope, Unit> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ q f57623OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ List<Measurable> f57624OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public OooO00o(q qVar, List<? extends Measurable> list) {
            super(1);
            this.f57623OooO0Oo = qVar;
            this.f57624OooO0o0 = list;
        }
        ...
        public final Unit invoke(Placeable.PlacementScope placementScope) {
            ...
            q qVar = this.f57623OooO0Oo;
            qVar.getClass();
            Intrinsics.checkNotNullParameter(layout, "<this>");
            List<Measurable> measurables = this.f57624OooO0o0;
            Intrinsics.checkNotNullParameter(measurables, "measurables");
            LinkedHashMap linkedHashMap = qVar.f57674OooO0Oo;
            boolean zIsEmpty = linkedHashMap.isEmpty();
            OooO0o oooO0o = qVar.f57671OooO00o;
            if (zIsEmpty) {
                for (ConstraintWidget constraintWidget3 : oooO0o.f60308o0OOO0o) {
                    Object obj2 = constraintWidget3.f4403Ooooooo;
                    if (obj2 instanceof Measurable) {
                        OooO0O0 oooO0O2 = constraintWidget3.f4353OooOO0O;
                        ConstraintWidget constraintWidget4 = oooO0O2.f42264OooO00o;
                        if (constraintWidget4 != null) {
                            oooO0O2.f42265OooO0O0 = constraintWidget4.OooOo0o();
                            oooO0O2.f42266OooO0OO = constraintWidget4.OooOo();
                            oooO0O2.f42267OooO0Oo = constraintWidget4.OooOo0o() + constraintWidget4.f4392OoooOo0;
                            oooO0O2.f42269OooO0o0 = constraintWidget4.OooOo() + constraintWidget4.f4393OoooOoO;
                            oooO0O2.OooO0OO(constraintWidget4.f4353OooOO0O);
                        }
            ...
            if (size >= 0) {
                ...
                while (true) {
                    ...
                    if (oooO0O3 != null) {
                        boolean z = Float.isNaN(oooO0O3.f42271OooO0oo) && Float.isNaN(oooO0O3.f42263OooO) && Float.isNaN(oooO0O3.f42272OooOO0) && Float.isNaN(oooO0O3.f42273OooOO0O) && Float.isNaN(oooO0O3.f42274OooOO0o) && Float.isNaN(oooO0O3.f42276OooOOO0) && Float.isNaN(oooO0O3.f42275OooOOO) && Float.isNaN(oooO0O3.f42277OooOOOO) && Float.isNaN(oooO0O3.f42278OooOOOo);
                        LinkedHashMap linkedHashMap2 = qVar.f57672OooO0O0;
                        if (z) {
                            OooO0O0 oooO0O4 = (OooO0O0) linkedHashMap.get(measurable2);
                            Intrinsics.checkNotNull(oooO0O4);
                            int i4 = oooO0O4.f42265OooO0O0;
                            OooO0O0 oooO0O5 = (OooO0O0) linkedHashMap.get(measurable2);
                            Intrinsics.checkNotNull(oooO0O5);
                            int i5 = oooO0O5.f42266OooO0OO;
                ...
                if (LayoutInfoFlags.BOUNDS == null) {
                    ...
                    sbOooO00o.append(" } }");
                    for (ConstraintWidget constraintWidget5 : oooO0o.f60308o0OOO0o) {
                        obj = constraintWidget5.f4403Ooooooo;
                        if (!(obj instanceof Measurable)) {
                            oooO0O0 = null;
                            if (constraintWidget5.f4354OooOO0o == null) {
                                ...
                                constraintWidget5.f4354OooOO0o = string;
                            }
                            oooO0O1 = (OooO0O0) linkedHashMap.get(obj);
                            if (oooO0O1 != null && (constraintWidget2 = oooO0O1.f42264OooO00o) != null) {
                                oooO0O0 = constraintWidget2.f4353OooOO0O;
                            }
                            if (oooO0O0 == null) {
                                sbOooO00o.append(ZegoConstants.ZegoVideoDataAuxPublishingStream + ((Object) constraintWidget5.f4354OooOO0o) + ": {");
                                sbOooO00o.append(" interpolated : ");
                                sbOooO00o.append("{\n");
                                OooO0O0.OooO0O0(sbOooO00o, ViewHierarchyConstants.DIMENSION_LEFT_KEY, oooO0O0.f42265OooO0O0);
                                OooO0O0.OooO0O0(sbOooO00o, ViewHierarchyConstants.DIMENSION_TOP_KEY, oooO0O0.f42266OooO0OO);
                                OooO0O0.OooO0O0(sbOooO00o, "right", oooO0O0.f42267OooO0Oo);
                                OooO0O0.OooO0O0(sbOooO00o, "bottom", oooO0O0.f42269OooO0o0);
                                OooO0O0.OooO00o(sbOooO00o, "pivotX", oooO0O0.f42268OooO0o);
                                OooO0O0.OooO00o(sbOooO00o, "pivotY", oooO0O0.f42270OooO0oO);
                                OooO0O0.OooO00o(sbOooO00o, "rotationX", oooO0O0.f42271OooO0oo);
                                OooO0O0.OooO00o(sbOooO00o, "rotationY", oooO0O0.f42263OooO);
                                OooO0O0.OooO00o(sbOooO00o, "rotationZ", oooO0O0.f42272OooOO0);
                                OooO0O0.OooO00o(sbOooO00o, "translationX", oooO0O0.f42273OooOO0O);
                                OooO0O0.OooO00o(sbOooO00o, "translationY", oooO0O0.f42274OooOO0o);
                                OooO0O0.OooO00o(sbOooO00o, "translationZ", oooO0O0.f42276OooOOO0);
                                OooO0O0.OooO00o(sbOooO00o, "scaleX", oooO0O0.f42275OooOOO);
                                OooO0O0.OooO00o(sbOooO00o, "scaleY", oooO0O0.f42277OooOOOO);
                                OooO0O0.OooO00o(sbOooO00o, "alpha", oooO0O0.f42278OooOOOo);
                                OooO0O0.OooO0O0(sbOooO00o, ViewHierarchyConstants.DIMENSION_VISIBILITY_KEY, oooO0O0.f42279OooOOo);
                                OooO0O0.OooO00o(sbOooO00o, "interpolatedPos", oooO0O0.f42280OooOOo0);
                                constraintWidget = oooO0O0.f42264OooO00o;
                                if (constraintWidget != null) {
                                    for (ConstraintAnchor.Type type : ConstraintAnchor.Type.values()) {
                                        constraintAnchorOooOOO = constraintWidget.OooOOO(type);
                                        if (constraintAnchorOooOOO == null && constraintAnchorOooOOO.f4338OooO0o != null) {
                                            sbOooO00o.append("Anchor");
                                            sbOooO00o.append(type.name());
                                            sbOooO00o.append(": ['");
                                            String str = constraintAnchorOooOOO.f4338OooO0o.f4337OooO0Oo.f4354OooOO0o;
                                            if (str == null) {
                                                str = "#PARENT";
                                            }
                                            sbOooO00o.append(str);
                                            sbOooO00o.append("', '");
                                            sbOooO00o.append(constraintAnchorOooOOO.f4338OooO0o.f4339OooO0o0.name());
                                            sbOooO00o.append("', '");
                                            sbOooO00o.append(constraintAnchorOooOOO.f4340OooO0oO);
                                            sbOooO00o.append("'],\n");
                                        }
                                    }
                                }
                                ...
                                if (map.size() != 0) {
                                    ...
                                    for (String str2 : map.keySet()) {
                                        ...
                                        sbOooO00o.append(": ");
                                        switch (oooO0OO.f42784OooO0O0) {
                                            case 900:
                                                sbOooO00o.append(oooO0OO.f42785OooO0OO);
                                                sbOooO00o.append(",\n");
                                                break;
                                            case VideoCapture.VideoCaptureEvent.kCameraErrorRuntimeUnknown /* 901 */:
                                            case 905:
                                                sbOooO00o.append(oooO0OO.f42786OooO0Oo);
                                                sbOooO00o.append(",\n");
                                                break;
                                            case 902:
                                                sbOooO00o.append("'");
                                                sbOooO00o.append(OooO0OO.OooO00o(oooO0OO.f42785OooO0OO));
                                                sbOooO00o.append("',\n");
                                                break;
                                            case 903:
                                                sbOooO00o.append("'");
                                                sbOooO00o.append(oooO0OO.f42788OooO0o0);
                                                sbOooO00o.append("',\n");
                                                break;
                                            case 904:
                                                sbOooO00o.append("'");
                                                sbOooO00o.append(oooO0OO.f42787OooO0o);
                                                sbOooO00o.append("',\n");
                                                break;
                                        }
                                    }
    ...
    public c(q qVar, i iVar, MutableState mutableState) {
        this.f57619OooO00o = qVar;
        this.f57620OooO0O0 = iVar;
        this.f57622OooO0Oo = mutableState;
    }
    ...
    public final MeasureResult mo3measure3p2s80s(@NotNull MeasureScope measureScope, @NotNull List<? extends Measurable> measurables, long j) {
        ...
        q qVar = this.f57619OooO00o;
        qVar.getClass();
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        i constraintSet = this.f57620OooO0O0;
        Intrinsics.checkNotNullParameter(constraintSet, "constraintSet");
        Intrinsics.checkNotNullParameter(measurables, "measurables");
        Intrinsics.checkNotNullParameter(measureScope, "measureScope");
        Intrinsics.checkNotNullParameter(measureScope, "<set-?>");
        qVar.f57676OooO0o0 = measureScope;
        Intrinsics.checkNotNullParameter(measureScope, "<set-?>");
        qVar.f57675OooO0o = measureScope;
        s sVarOooO0OO = qVar.OooO0OO();
        if (Constraints.m3741getHasFixedWidthimpl(j)) {
            int iM3743getMaxWidthimpl = Constraints.m3743getMaxWidthimpl(j);
            dimension = new Dimension(Dimension.f4278OooO0oO);
            dimension.f4287OooO0o0 = null;
            dimension.f4285OooO0Oo = iM3743getMaxWidthimpl;
        } else {
            dimension = new Dimension(Dimension.f4279OooO0oo);
            int iM3745getMinWidthimpl = Constraints.m3745getMinWidthimpl(j);
            if (iM3745getMinWidthimpl >= 0) {
                dimension.f4282OooO00o = iM3745getMinWidthimpl;
            }
        }
        sVarOooO0OO.f4332OooO0Oo.f4322Oooo00o = dimension;
        s sVarOooO0OO2 = qVar.OooO0OO();
        if (Constraints.m3740getHasFixedHeightimpl(j)) {
            int iM3742getMaxHeightimpl = Constraints.m3742getMaxHeightimpl(j);
            dimension2 = new Dimension(Dimension.f4278OooO0oO);
            dimension2.f4287OooO0o0 = null;
            dimension2.f4285OooO0Oo = iM3742getMaxHeightimpl;
        } else {
            dimension2 = new Dimension(Dimension.f4279OooO0oo);
            int iM3744getMinHeightimpl = Constraints.m3744getMinHeightimpl(j);
            if (iM3744getMinHeightimpl >= 0) {
                dimension2.f4282OooO00o = iM3744getMinHeightimpl;
            }
        }
        sVarOooO0OO2.f4332OooO0Oo.f4319Oooo0 = dimension2;
        qVar.OooO0OO().f57683OooO0oO = j;
        s sVarOooO0OO3 = qVar.OooO0OO();
        sVarOooO0OO3.getClass();
        Intrinsics.checkNotNullParameter(layoutDirection, "<set-?>");
        sVarOooO0OO3.f57684OooO0oo = layoutDirection;
        LinkedHashMap linkedHashMap = qVar.f57672OooO0O0;
        linkedHashMap.clear();
        qVar.f57673OooO0OO.clear();
        qVar.f57674OooO0Oo.clear();
        boolean zOooO0O0 = constraintSet.OooO0O0(measurables);
        OooO0o oooO0o = qVar.f57671OooO00o;
        if (zOooO0O0) {
            s sVarOooO0OO4 = qVar.OooO0OO();
            HashMap<Object, o0OO00O.OooO00o> mReferences = sVarOooO0OO4.f4329OooO00o;
            ...
            mReferences.clear();
            Intrinsics.checkNotNullExpressionValue(mReferences, "mReferences");
            mReferences.put(State.f4328OooO0o0, sVarOooO0OO4.f4332OooO0Oo);
            sVarOooO0OO4.f57681OooO.clear();
            sVarOooO0OO4.f57685OooOO0 = true;
            sVarOooO0OO4.f4330OooO0O0.clear();
            sVarOooO0OO4.f4331OooO0OO.clear();
            constraintSet.OooO00o(qVar.OooO0OO(), measurables);
            e.OooO00o(qVar.OooO0OO(), measurables);
            s sVarOooO0OO5 = qVar.OooO0OO();
            sVarOooO0OO5.getClass();
            oooO0o.f60308o0OOO0o.clear();
            androidx.constraintlayout.core.state.OooO00o oooO00o = sVarOooO0OO5.f4332OooO0Oo;
            oooO00o.f4322Oooo00o.OooO0O0(oooO0o, 0);
            oooO00o.f4319Oooo0.OooO0O0(oooO0o, 1);
            HashMap<Object, androidx.constraintlayout.core.state.OooO0O0> map = sVarOooO0OO5.f4330OooO0O0;
            Iterator<Object> it2 = map.keySet().iterator();
            while (it2.hasNext()) {
                map.get(it2.next()).getClass();
            }
            HashMap<Object, o0OO00O.OooO00o> map2 = sVarOooO0OO5.f4329OooO00o;
            ...
            while (it4.hasNext()) {
                ...
                if (oooO00o3 != oooO00o) {
                    ...
                    constraintWidgetOooO00o2.f4405o00O0O = oooO00o3.getKey().toString();
                    constraintWidgetOooO00o2.f4391OoooOOo = null;
                    oooO00o3.OooO0Oo();
            ...
            for (Object obj : map2.keySet()) {
                ...
                if (constraintWidgetOooO00o3 != null && obj != null) {
                    constraintWidgetOooO00o3.f4354OooOO0o = obj.toString();
                }
            }
        } else {
            e.OooO00o(qVar.OooO0OO(), measurables);
        ...
        oooO0o.f4492o00000Oo = this.f57621OooO0OO;
        androidx.constraintlayout.core.OooO0OO.f4242OooOOOo = oooO0o.OooooOO(ConstantsKt.MINIMUM_BLOCK_SIZE);
        oooO0o.Ooooo0o(oooO0o.f4492o00000Oo, 0, 0, 0, 0, 0, 0);
        for (ConstraintWidget constraintWidget : oooO0o.f60308o0OOO0o) {
            Object obj2 = constraintWidget.f4403Ooooooo;
            if (obj2 instanceof Measurable) {
        ...
        this.f57622OooO0Oo.getValue();
        return MeasureScope.CC.OooOOo0(measureScope, IntSize.m3935getWidthimpl(jIntSize), IntSize.m3934getHeightimpl(jIntSize), null, new OooO00o(qVar, measurables), 4, null);
    }
