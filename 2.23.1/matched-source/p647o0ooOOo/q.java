...
@PublishedApi
public class q implements o0O0O00.OooO0O0.InterfaceC0443OooO0O0 {

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    @NotNull
    public final int[] f57670OooO;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    @NotNull
    public final OooO0o f57671OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public final LinkedHashMap f57672OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @NotNull
    public final LinkedHashMap f57673OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public final LinkedHashMap f57674OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public MeasureScope f57675OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public Density f57676OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    @NotNull
    public final Lazy f57677OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    @NotNull
    public final int[] f57678OooO0oo;
    ...
    public static final class OooO0O0 extends Lambda implements Function0<s> {
        public OooO0O0() {
            super(0);
        }
        ...
        public final s invoke() {
            Density density = q.this.f57676OooO0o0;
            if (density != null) {
                return new s(density);
            }
    ...
    public q() {
        ...
        oooO0o.f4501o0O0O00 = this;
        oooO0o.f4502o0OO00O.f41088OooO0o = this;
        Unit unit = Unit.INSTANCE;
        this.f57671OooO00o = oooO0o;
        this.f57672OooO0O0 = new LinkedHashMap();
        this.f57673OooO0OO = new LinkedHashMap();
        this.f57674OooO0Oo = new LinkedHashMap();
        this.f57677OooO0oO = LazyKt.lazy(LazyThreadSafetyMode.NONE, (Function0) new OooO0O0());
        this.f57678OooO0oo = new int[2];
        this.f57670OooO = new int[2];
        new ArrayList();
    }
    ...
    public final void OooO0O0(@NotNull ConstraintWidget constraintWidget, @NotNull o0O0O00.OooO0O0.OooO00o measure) {
        ...
        if (obj2 instanceof Measurable) {
            LinkedHashMap linkedHashMap = this.f57673OooO0OO;
            Integer[] numArr = (Integer[]) linkedHashMap.get(obj2);
            ConstraintWidget.DimensionBehaviour dimensionBehaviour = measure.f41096OooO00o;
            Intrinsics.checkNotNullExpressionValue(dimensionBehaviour, "measure.horizontalBehavior");
            boolean z6 = 1;
            z6 = 1;
            OooO0Oo(dimensionBehaviour, measure.f41098OooO0OO, constraintWidget.f4364OooOo00, measure.f41104OooOO0, ((numArr != null && (num2 = numArr[1]) != null) ? num2.intValue() : 0) == constraintWidget.OooOOOo(), constraintWidget.Oooo000(), Constraints.m3743getMaxWidthimpl(OooO0OO().f57683OooO0oO), this.f57678OooO0oo);
            ConstraintWidget.DimensionBehaviour dimensionBehaviour2 = measure.f41097OooO0O0;
            Intrinsics.checkNotNullExpressionValue(dimensionBehaviour2, "measure.verticalBehavior");
            OooO0Oo(dimensionBehaviour2, measure.f41099OooO0Oo, constraintWidget.f4363OooOo0, measure.f41104OooOO0, ((numArr != null && (num = numArr[0]) != null) ? num.intValue() : 0) == constraintWidget.OooOo0O(), constraintWidget.Oooo00O(), Constraints.m3742getMaxHeightimpl(OooO0OO().f57683OooO0oO), this.f57670OooO);
            int[] iArr = this.f57678OooO0oo;
            int i2 = iArr[0];
            int i3 = iArr[1];
            int[] iArr2 = this.f57670OooO;
            long jConstraints = ConstraintsKt.Constraints(i2, i3, iArr2[0], iArr2[1]);
            int i4 = measure.f41104OooOO0;
            LinkedHashMap linkedHashMap2 = this.f57672OooO0O0;
            if (i4 == 1 || i4 == 2) {
                ...
                numValueOf = Integer.valueOf(constraintWidget.f4366OooOo0o);
                ...
                numValueOf2 = Integer.valueOf(constraintWidget.f4362OooOo);
                ...
                numValueOf3 = Integer.valueOf(constraintWidget.f4367OooOoO);
                ...
                numValueOf4 = Integer.valueOf(constraintWidget.f4369OooOoOO);
                ...
                ConstraintWidget.DimensionBehaviour dimensionBehaviour3 = measure.f41096OooO00o;
                ConstraintWidget.DimensionBehaviour dimensionBehaviour4 = ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT;
                if (dimensionBehaviour3 != dimensionBehaviour4 || constraintWidget.f4364OooOo00 != 0 || measure.f41097OooO0O0 != dimensionBehaviour4 || constraintWidget.f4363OooOo0 != 0) {
                    measurable = (Measurable) obj2;
                    placeableMo2804measureBRTryo0 = measurable.mo2804measureBRTryo0(jConstraints);
                    linkedHashMap2.put(obj2, placeableMo2804measureBRTryo0);
                    constraintWidget.f4350OooO0oO = false;
            ...
            measure.f41101OooO0o0 = numValueOf9 == null ? constraintWidget.OooOo0O() : numValueOf9.intValue();
            Integer numValueOf10 = placeable == null ? null : Integer.valueOf(placeable.getHeight());
            measure.f41100OooO0o = numValueOf10 == null ? constraintWidget.OooOOOo() : numValueOf10.intValue();
            if (placeable != null) {
                s sVarOooO0OO = OooO0OO();
                sVarOooO0OO.getClass();
                Intrinsics.checkNotNullParameter(constraintWidget, "constraintWidget");
                boolean z7 = sVarOooO0OO.f57685OooOO0;
                LinkedHashSet linkedHashSet = sVarOooO0OO.f57686OooOO0O;
                if (z7) {
                    linkedHashSet.clear();
                    Iterator it = sVarOooO0OO.f57681OooO.iterator();
                    while (it.hasNext()) {
                        o0OO00O.OooO00o oooO00o = sVarOooO0OO.f4329OooO00o.get(it.next());
                    ...
                    sVarOooO0OO.f57685OooOO0 = false;
                }
            ...
            measure.f41103OooO0oo = i != Integer.MIN_VALUE;
            measure.f41102OooO0oO = i;
            ...
            numArr3[c] = Integer.valueOf(measure.f41101OooO0o0);
            numArr3[1] = Integer.valueOf(measure.f41100OooO0o);
            numArr3[2] = Integer.valueOf(measure.f41102OooO0oO);
            if (measure.f41101OooO0o0 == measure.f41098OooO0OO && measure.f41100OooO0o == measure.f41099OooO0Oo) {
                z6 = c;
            }
            measure.f41095OooO = z6;
        }
    }

    @NotNull
    public final s OooO0OO() {
        return (s) this.f57677OooO0oO.getValue();
    }
}
