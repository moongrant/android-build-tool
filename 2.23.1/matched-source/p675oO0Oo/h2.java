...
public final class h2 {
    ...
    @NotNull
    public static final h2 f59176OooO00o = new h2();

    public static final class OooO extends Lambda implements Function0<Unit> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO f59177OooO0Oo = new OooO();
    ...
    public static final class OooO00o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ float f59179OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ BoxScope f59180OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f59181OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(BoxScope boxScope, float f, int i) {
            super(2);
            this.f59180OooO0o0 = boxScope;
            this.f59179OooO0o = f;
            this.f59181OooO0oO = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f59181OooO0oO | 1);
            BoxScope boxScope = this.f59180OooO0o0;
            float f = this.f59179OooO0o;
            h2.this.OooO00o(boxScope, f, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0O0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ RedemptionCodeVm f59183OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ BoxScope f59184OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ float f59185OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ int f59186OooO0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(BoxScope boxScope, RedemptionCodeVm redemptionCodeVm, float f, int i) {
            super(2);
            this.f59184OooO0o0 = boxScope;
            this.f59183OooO0o = redemptionCodeVm;
            this.f59185OooO0oO = f;
            this.f59186OooO0oo = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            h2.this.OooO0O0(this.f59184OooO0o0, this.f59183OooO0o, this.f59185OooO0oO, composer, RecomposeScopeImplKt.updateChangedFlags(this.f59186OooO0oo | 1));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0OO extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ RedemptionCodeVm f59187OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(RedemptionCodeVm redemptionCodeVm) {
            super(0);
            this.f59187OooO0Oo = redemptionCodeVm;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            RedemptionCodeVm redemptionCodeVm = this.f59187OooO0Oo;
    ...
    public static final class OooO0o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ RedemptionCodeVm f59189OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ BoxScope f59190OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f59191OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(BoxScope boxScope, RedemptionCodeVm redemptionCodeVm, int i) {
            super(2);
            this.f59190OooO0o0 = boxScope;
            this.f59189OooO0o = redemptionCodeVm;
            this.f59191OooO0oO = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f59191OooO0oO | 1);
            BoxScope boxScope = this.f59190OooO0o0;
            RedemptionCodeVm redemptionCodeVm = this.f59189OooO0o;
            h2.this.OooO0OO(boxScope, redemptionCodeVm, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0 extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ RedemptionCodeVm f59192OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0(RedemptionCodeVm redemptionCodeVm) {
            super(0);
            this.f59192OooO0Oo = redemptionCodeVm;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            RedemptionCodeVm redemptionCodeVm = this.f59192OooO0Oo;
            redemptionCodeVm.getRedemptionCodeDialogShow().setValue(Boolean.FALSE);
            Function0<Unit> redemptionCodeDialogDismissListener = redemptionCodeVm.getRedemptionCodeDialogDismissListener();
            if (redemptionCodeDialogDismissListener != null) {
                redemptionCodeDialogDismissListener.invoke();
    ...
    public static final class OooOO0O extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ RedemptionCodeVm f59193OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ Ref.FloatRef f59194OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ Ref.FloatRef f59195OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0O(RedemptionCodeVm redemptionCodeVm, Ref.FloatRef floatRef, Ref.FloatRef floatRef2) {
            super(2);
            this.f59193OooO0Oo = redemptionCodeVm;
            this.f59195OooO0o0 = floatRef;
            this.f59194OooO0o = floatRef2;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            ...
            if ((iIntValue & 11) == 2 && composer2.getSkipping()) {
                ...
                h2.OooO0oo(h2.f59176OooO00o, this.f59193OooO0Oo, this.f59195OooO0o0.element, this.f59194OooO0o.element, composer2, 3080);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public static final class OooOOO extends Lambda implements Function1<LazyGridScope, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ int f59196OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ List<RedemptionCodeAwards> f59197OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f59198OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO(List list, int i, int i2) {
            super(1);
            this.f59196OooO0Oo = i;
            this.f59198OooO0o0 = i2;
            this.f59197OooO0o = list;
        }
        ...
        public final Unit invoke(LazyGridScope lazyGridScope) {
            ...
            LazyGridScope.CC.OooO0O0(LazyVerticalGrid, this.f59196OooO0Oo, null, null, null, ComposableLambdaKt.composableLambdaInstance(148830938, true, new j2(this.f59198OooO0o0, this.f59197OooO0o)), 14, null);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOOO0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f59200OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ boolean f59201OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f59202OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO0(boolean z, int i, int i2) {
            super(2);
            this.f59201OooO0o0 = z;
            this.f59200OooO0o = i;
            this.f59202OooO0oO = i2;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f59200OooO0o | 1);
            h2.this.OooO0Oo(this.f59201OooO0o0, composer, iUpdateChangedFlags, this.f59202OooO0oO);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOOOO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ RedemptionCodeVm f59204OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ BoxScope f59205OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f59206OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOOO(BoxScope boxScope, RedemptionCodeVm redemptionCodeVm, int i) {
            super(2);
            this.f59205OooO0o0 = boxScope;
            this.f59204OooO0o = redemptionCodeVm;
            this.f59206OooO0oO = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f59206OooO0oO | 1);
            BoxScope boxScope = this.f59205OooO0o0;
            RedemptionCodeVm redemptionCodeVm = this.f59204OooO0o;
            h2.this.OooO0o0(boxScope, redemptionCodeVm, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOo extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f59208OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ RedemptionCodeAwards f59209OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOo(RedemptionCodeAwards redemptionCodeAwards, int i) {
            super(2);
            this.f59209OooO0o0 = redemptionCodeAwards;
            this.f59208OooO0o = i;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f59208OooO0o | 1);
            h2.this.OooO0o(this.f59209OooO0o0, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOo00 extends Lambda implements Function1<coil.request.OooO00o.C0189OooO00o, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooOo00 f59210OooO0Oo = new OooOo00();
        ...
        public final Unit invoke(coil.request.OooO00o.C0189OooO00o c0189OooO00o) {
            ...
            o0000O0O.OooO0o0(it, o0OOO0o.icon_picture_default);
            it.OooO0O0();
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class Oooo0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f59212OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ RedemptionCodeAwards f59213OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public Oooo0(RedemptionCodeAwards redemptionCodeAwards, int i) {
            super(2);
            this.f59213OooO0o0 = redemptionCodeAwards;
            this.f59212OooO0o = i;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f59212OooO0o | 1);
            h2.this.OooO0oO(this.f59213OooO0o0, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class Oooo000 extends Lambda implements Function1<coil.request.OooO00o.C0189OooO00o, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final Oooo000 f59214OooO0Oo = new Oooo000();
    ...
    public static final void OooO0oo(h2 h2Var, RedemptionCodeVm redemptionCodeVm, float f, float f2, Composer composer, int i) {
        h2Var.getClass();
        ...
        h2 h2Var2 = f59176OooO00o;
        h2Var2.OooO00o(boxScopeInstance, f, composerStartRestartGroup, (i & 112) | 390);
        h2Var2.OooO0O0(boxScopeInstance, redemptionCodeVm, f2, composerStartRestartGroup, (i & 896) | 3142);
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new i2(h2Var, redemptionCodeVm, f, f2, i));
    }
    ...
    public final void OooO00o(BoxScope boxScope, float f, Composer composer, int i) {
        ...
        if ((i2 & 91) == 18 && composerStartRestartGroup.getSkipping()) {
            ...
            if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
                int i3 = oo0o0Oo.ic_redemption_code_reward_dialog_bg_x;
            ...
            float f2 = 24;
            BoxKt.Box(o00oOoo.OooO00o(SizeKt.m511height3ABfNKs(SizeKt.fillMaxWidth$default(ClipKt.clip(PaddingKt.m482paddingqDBjuR0$default(companion, 0.0f, Dp.m3775constructorimpl(42), 0.0f, 0.0f, 13, null), RoundedCornerShapeKt.m729RoundedCornerShape0680j_4(Dp.m3775constructorimpl(f2))), 0.0f, 1, null), f), (Drawable) objRememberedValue, composerStartRestartGroup, 64), composerStartRestartGroup, 0);
            String strStringResource = StringResources_androidKt.stringResource(o000OOo.Congrats_You_got, composerStartRestartGroup, 0);
            long sp = TextUnitKt.getSp(20);
            FontWeight bold = FontWeight.INSTANCE.getBold();
            int i4 = o0O0o.f48305o00OOooO;
            long j = o0O0o.f48278o00O0oOO;
    ...
    public final void OooO0O0(BoxScope boxScope, RedemptionCodeVm redemptionCodeVm, float f, Composer composer, int i) {
        ...
        Modifier modifierM171backgroundbw27NRU$default = BackgroundKt.m171backgroundbw27NRU$default(modifierM511height3ABfNKs, o0O0o.f48093OooO0O0, null, 2, null);
        ...
        androidx.compose.animation.OooOO0.OooO00o(0, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composerStartRestartGroup)), composerStartRestartGroup, 2058660585);
        BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
        h2 h2Var = f59176OooO00o;
        h2Var.OooO0o0(boxScopeInstance, redemptionCodeVm, composerStartRestartGroup, 454);
        h2Var.OooO0OO(boxScopeInstance, redemptionCodeVm, composerStartRestartGroup, 454);
        composerStartRestartGroup.endReplaceableGroup();
    ...
    public final void OooO0OO(BoxScope boxScope, RedemptionCodeVm redemptionCodeVm, Composer composer, int i) {
        ...
        Modifier.Companion companion = Modifier.INSTANCE;
        Alignment.Companion companion2 = Alignment.INSTANCE;
        Modifier modifierOooO00o = kotlin.reflect.jvm.internal.impl.builtins.OooO00o.OooO00o(76, SizeKt.fillMaxWidth$default(boxScope.align(companion, companion2.getBottomCenter()), 0.0f, 1, null), composerStartRestartGroup, 733328855);
        ...
        androidx.compose.animation.OooOO0.OooO00o(0, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composerStartRestartGroup)), composerStartRestartGroup, 2058660585);
        BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
        ImageKt.Image(PainterResources_androidKt.painterResource(oo0o0Oo.ic_redemption_code_reward_dialog_btn_bg, composerStartRestartGroup, 0), "", SizeKt.fillMaxSize$default(companion, 0.0f, 1, null), (Alignment) null, (ContentScale) null, 0.0f, (ColorFilter) null, composerStartRestartGroup, 440, 120);
        ...
        ImageKt.Image(PainterResources_androidKt.painterResource(oo0o0Oo.ic_redemption_code_reward_dialog_btn, composerStartRestartGroup, 0), "", SizeKt.fillMaxSize$default(companion, 0.0f, 1, null), (Alignment) null, (ContentScale) null, 0.0f, (ColorFilter) null, composerStartRestartGroup, 440, 120);
        String strStringResource = StringResources_androidKt.stringResource(o000OOo.OK, composerStartRestartGroup, 0);
        long sp = TextUnitKt.getSp(16);
        int i2 = o0O0o.f48305o00OOooO;
        TextKt.m1261Text4IGK_g(strStringResource, (Modifier) null, o0O0o.f48093OooO0O0, sp, (FontStyle) null, FontWeight.INSTANCE.getNormal(), (FontFamily) null, 0L, (TextDecoration) null, TextAlign.m3674boximpl(TextAlign.INSTANCE.m3681getCentere0LSkKk()), 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composerStartRestartGroup, 199680, 0, 130514);
    ...
    public final void OooO0Oo(boolean z, @Nullable Composer composer, int i, int i2) {
        ...
        if ((i3 & 11) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            o0000O0.OooO00o(redemptionCodeVm.getRedemptionCodeDialogShow(), z3, false, OooO.f59177OooO0Oo, new OooOO0(redemptionCodeVm), 0, 0, 0.0f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, 769967820, true, new OooOO0O(redemptionCodeVm, floatRef2, floatRef)), composerStartRestartGroup, ((i3 << 3) & 112) | 100666368, 228);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            z2 = z3;
    ...
    public final void OooO0o(@NotNull RedemptionCodeAwards it, @Nullable Composer composer, int i) {
        ...
        Modifier.Companion companion = Modifier.INSTANCE;
        Modifier modifierOooO0O0 = com.app.base.protobuf.OooO0O0.OooO0O0(8, BackgroundKt.m171backgroundbw27NRU$default(SizeKt.m511height3ABfNKs(SizeKt.m530width3ABfNKs(companion, Dp.m3775constructorimpl(136)), Dp.m3775constructorimpl(Constants.ERR_ALREADY_IN_RECORDING)), o0O0o.f48093OooO0O0, null, 2, null), 0.0f, 2, null, composerStartRestartGroup, -483455358);
        ...
        Modifier modifierOooO00o = kotlin.reflect.jvm.internal.impl.builtins.OooO00o.OooO00o(Constants.ERR_ENCRYPTED_STREAM_NOT_ALLOWED_PUBLISHED, SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), composerStartRestartGroup, 733328855);
        ...
        androidx.compose.animation.OooOO0.OooO00o(0, function3ModifierMaterializerOf2, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composerStartRestartGroup)), composerStartRestartGroup, 2058660585);
        BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
        ImageKt.Image(PainterResources_androidKt.painterResource(oo0o0Oo.ic_redemption_code_reward_dialog_item_bg_2, composerStartRestartGroup, 0), "", SizeKt.fillMaxSize$default(companion, 0.0f, 1, null), (Alignment) null, (ContentScale) null, 0.0f, (ColorFilter) null, composerStartRestartGroup, 440, 120);
        Modifier modifierOooO00o2 = kotlin.reflect.jvm.internal.impl.builtins.OooO00o.OooO00o(103, SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), composerStartRestartGroup, 733328855);
        ...
        if (it.getRewardType() == RedemptionCodeType.RewardType.INSTANCE.getCoin()) {
            ...
            painterOooO0OO = PainterResources_androidKt.painterResource(oo0o0Oo.ic_redemption_code_reward_coin, composerStartRestartGroup, 0);
            composerStartRestartGroup.endReplaceableGroup();
        } else {
            composerStartRestartGroup.startReplaceableGroup(-1526661956);
            painterOooO0OO = o0000O0O.OooO0OO(it.getRewardImage(), OooOo00.f59210OooO0Oo, composerStartRestartGroup, 48, 0);
            composerStartRestartGroup.endReplaceableGroup();
        }
        ...
        if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
            ...
            if (unit == unit2.getCount()) {
                objRememberedValue = o0000O.OooO00o(o0000.OooO0OO(o000OOo.Exchange_Records_X_xxx), String.valueOf(it.getRewardCount()));
            } else if (unit == unit2.getDays()) {
                objRememberedValue = o0000O.OooO00o(o0000.OooO0OO(o000OOo.Exchange_Records_X_xxx_Days), String.valueOf(it.getRewardCount()));
            } else {
                objRememberedValue = unit == unit2.getCoin() ? o0000O.OooO00o(o0000.OooO0OO(o000OOo.Exchange_Records_X_xxx), String.valueOf(it.getRewardCount())) : o0000O.OooO00o(o0000.OooO0OO(o000OOo.Exchange_Records_X_xxx), String.valueOf(it.getRewardCount()));
            }
            composerStartRestartGroup.updateRememberedValue(objRememberedValue);
        }
        composerStartRestartGroup.endReplaceableGroup();
        long sp = TextUnitKt.getSp(12);
        long j = o0O0o.f48277o00O0oO;
        ...
        composerStartRestartGroup.endReplaceableGroup();
        float f = 5;
        TextKt.m1261Text4IGK_g(it.getRewardName(), SizeKt.m511height3ABfNKs(SizeKt.fillMaxWidth$default(PaddingKt.m482paddingqDBjuR0$default(companion, Dp.m3775constructorimpl(f), 0.0f, Dp.m3775constructorimpl(f), 0.0f, 10, null), 0.0f, 1, null), Dp.m3775constructorimpl(25)), o0000oo.OooO0OO(composerStartRestartGroup).f38612OooO, TextUnitKt.getSp(10), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, TextAlign.m3674boximpl(companion4.m3681getCentere0LSkKk()), 0L, 0, false, 2, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composerStartRestartGroup, 3120, 3072, 122352);
        if (androidx.compose.material.OooO0o.OooO00o(composerStartRestartGroup)) {
            ComposerKt.traceEventEnd();
        }
        ScopeUpdateScope scopeUpdateScopeEndRestartGroup = composerStartRestartGroup.endRestartGroup();
    ...
    public final void OooO0oO(@NotNull RedemptionCodeAwards it, @Nullable Composer composer, int i) {
        ...
        Modifier.Companion companion = Modifier.INSTANCE;
        Modifier modifierOooO0O0 = com.app.base.protobuf.OooO0O0.OooO0O0(2, BackgroundKt.m171backgroundbw27NRU$default(SizeKt.m511height3ABfNKs(SizeKt.m530width3ABfNKs(companion, Dp.m3775constructorimpl(90)), Dp.m3775constructorimpl(132)), o0O0o.f48093OooO0O0, null, 2, null), 0.0f, 2, null, composerStartRestartGroup, -483455358);
        Arrangement arrangement = Arrangement.INSTANCE;
        Arrangement.Vertical top = arrangement.getTop();
        Alignment.Companion companion2 = Alignment.INSTANCE;
        MeasurePolicy measurePolicyOooO00o = androidx.compose.material.OooO00o.OooO00o(companion2, top, composerStartRestartGroup, 0, -1323940314);
        ...
        androidx.compose.animation.OooOO0.OooO00o(0, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composerStartRestartGroup)), composerStartRestartGroup, 2058660585);
        ColumnScopeInstance columnScopeInstance = ColumnScopeInstance.INSTANCE;
        Modifier modifierOooO00o = kotlin.reflect.jvm.internal.impl.builtins.OooO00o.OooO00o(98, SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), composerStartRestartGroup, 733328855);
        MeasurePolicy measurePolicyOooO00o2 = androidx.compose.animation.Oooo000.OooO00o(companion2, false, composerStartRestartGroup, 0, -1323940314);
        int currentCompositeKeyHash2 = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
        CompositionLocalMap currentCompositionLocalMap2 = composerStartRestartGroup.getCurrentCompositionLocalMap();
        Function0<ComposeUiNode> constructor2 = companion3.getConstructor();
        ...
        BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
        ImageKt.Image(PainterResources_androidKt.painterResource(oo0o0Oo.ic_redemption_code_reward_dialog_item_bg_2, composerStartRestartGroup, 0), "", SizeKt.fillMaxSize$default(companion, 0.0f, 1, null), (Alignment) null, (ContentScale) null, 0.0f, (ColorFilter) null, composerStartRestartGroup, 440, 120);
        Modifier modifierOooO00o2 = kotlin.reflect.jvm.internal.impl.builtins.OooO00o.OooO00o(78, SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), composerStartRestartGroup, 733328855);
        MeasurePolicy measurePolicyOooO00o3 = androidx.compose.animation.Oooo000.OooO00o(companion2, false, composerStartRestartGroup, 0, -1323940314);
        int currentCompositeKeyHash3 = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
        CompositionLocalMap currentCompositionLocalMap3 = composerStartRestartGroup.getCurrentCompositionLocalMap();
        Function0<ComposeUiNode> constructor3 = companion3.getConstructor();
        ...
        if (it.getRewardType() == RedemptionCodeType.RewardType.INSTANCE.getCoin()) {
            ...
            painterOooO0OO = o0000O0O.OooO0OO(it.getRewardImage(), Oooo000.f59214OooO0Oo, composerStartRestartGroup, 48, 0);
            composerStartRestartGroup.endReplaceableGroup();
        }
        float f = 62;
        ...
        composerStartRestartGroup.endReplaceableGroup();
        float f2 = 4;
        TextKt.m1261Text4IGK_g(it.getRewardName(), SizeKt.m511height3ABfNKs(SizeKt.fillMaxWidth$default(PaddingKt.m482paddingqDBjuR0$default(companion, Dp.m3775constructorimpl(f2), 0.0f, Dp.m3775constructorimpl(f2), 0.0f, 10, null), 0.0f, 1, null), Dp.m3775constructorimpl(34)), o0000oo.OooO0OO(composerStartRestartGroup).f38612OooO, TextUnitKt.getSp(10), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, TextAlign.m3674boximpl(companion4.m3681getCentere0LSkKk()), 0L, 0, false, 2, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composerStartRestartGroup, 3120, 3072, 122352);
        if (androidx.compose.material.OooO0o.OooO00o(composerStartRestartGroup)) {
            ComposerKt.traceEventEnd();
        }
        ScopeUpdateScope scopeUpdateScopeEndRestartGroup = composerStartRestartGroup.endRestartGroup();
