...
public final class TextFieldSelectionManagerKt {
    ...
    public static final long m954calculateSelectionMagnifierCenterAndroidO0kMr_c(@NotNull TextFieldSelectionManager manager, long j) {
        int iM3320getStartimpl;
        ...
        if (i == 1 || i == 2) {
            iM3320getStartimpl = TextRange.m3320getStartimpl(manager.getValue$foundation_release().getSelection());
        } else {
            if (i != 3) {
                throw new NoWhenBranchMatchedException();
            }
            iM3320getStartimpl = TextRange.m3315getEndimpl(manager.getValue$foundation_release().getSelection());
        }
        int iOriginalToTransformed = manager.getOffsetMapping().originalToTransformed(iM3320getStartimpl);
        ...
        long jM1477getCenterF1C5BW0 = value.getBoundingBox(iCoerceIn).m1477getCenterF1C5BW0();
        ...
        Offset offsetM951getCurrentDragPosition_m7T9E = manager.m951getCurrentDragPosition_m7T9E();
        if (offsetM951getCurrentDragPosition_m7T9E == null) {
            return Offset.INSTANCE.m1462getUnspecifiedF1C5BW0();
        }
        float fM1447getXimpl = Offset.m1447getXimpl(innerTextFieldCoordinates.mo2812localPositionOfR5De75A(layoutCoordinates, offsetM951getCurrentDragPosition_m7T9E.getPackedValue()));
        ...
        boolean z = TextRange.m3320getStartimpl(manager.getValue$foundation_release().getSelection()) > TextRange.m3315getEndimpl(manager.getValue$foundation_release().getSelection());
        ...
        float fCoerceIn = RangesKt.coerceIn(fM1447getXimpl, Math.min(horizontalPosition, horizontalPosition2), Math.max(horizontalPosition, horizontalPosition2));
        return Math.abs(fM1447getXimpl - fCoerceIn) > ((float) (IntSize.m3935getWidthimpl(j) / 2)) ? Offset.INSTANCE.m1462getUnspecifiedF1C5BW0() : layoutCoordinates.mo2812localPositionOfR5De75A(innerTextFieldCoordinates, OffsetKt.Offset(fCoerceIn, Offset.m1448getYimpl(jM1477getCenterF1C5BW0)));
    }
    ...
    public static final boolean isSelectionHandleInVisibleBound(@NotNull TextFieldSelectionManager textFieldSelectionManager, boolean z) {
        ...
        return SelectionManagerKt.m934containsInclusiveUv8p0NA(rectVisibleBounds, textFieldSelectionManager.m953getHandlePositiontuRUvjQ$foundation_release(z));
    }
}
