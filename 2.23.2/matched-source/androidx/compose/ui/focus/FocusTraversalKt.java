...
public final class FocusTraversalKt {
    ...
    public static final FocusRequester m1399customFocusSearchOMvw8(@NotNull FocusTargetNode customFocusSearch, int i, @NotNull LayoutDirection layoutDirection) {
        FocusRequester end;
        ...
        if (FocusDirection.m1366equalsimpl0(i, companion.m1383getUpdhqQ8s())) {
        ...
        if (FocusDirection.m1366equalsimpl0(i, companion.m1378getLeftdhqQ8s())) {
            ...
            if (!FocusDirection.m1366equalsimpl0(i, companion.m1382getRightdhqQ8s())) {
                if (FocusDirection.m1366equalsimpl0(i, companion.m1375getEnterdhqQ8s())) {
                    return focusPropertiesFetchFocusProperties$ui_release.getEnter().invoke(FocusDirection.m1363boximpl(i));
                }
                if (FocusDirection.m1366equalsimpl0(i, companion.m1376getExitdhqQ8s())) {
                    return focusPropertiesFetchFocusProperties$ui_release.getExit().invoke(FocusDirection.m1363boximpl(i));
                }
    ...
    public static final boolean m1400focusSearchsMXa3k8(@NotNull FocusTargetNode focusSearch, int i, @NotNull LayoutDirection layoutDirection, @NotNull Function1<? super FocusTargetNode, Boolean> onFound) {
        int iM1382getRightdhqQ8s;
        Boolean boolM1412twoDimensionalFocusSearchOMvw8;
        Intrinsics.checkNotNullParameter(focusSearch, "$this$focusSearch");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Intrinsics.checkNotNullParameter(onFound, "onFound");
        FocusDirection.Companion companion = FocusDirection.INSTANCE;
        if (FocusDirection.m1366equalsimpl0(i, companion.m1379getNextdhqQ8s()) ? true : FocusDirection.m1366equalsimpl0(i, companion.m1381getPreviousdhqQ8s())) {
            return OneDimensionalFocusSearchKt.m1403oneDimensionalFocusSearchOMvw8(focusSearch, i, onFound);
        }
        if (FocusDirection.m1366equalsimpl0(i, companion.m1378getLeftdhqQ8s()) ? true : FocusDirection.m1366equalsimpl0(i, companion.m1382getRightdhqQ8s()) ? true : FocusDirection.m1366equalsimpl0(i, companion.m1383getUpdhqQ8s()) ? true : FocusDirection.m1366equalsimpl0(i, companion.m1374getDowndhqQ8s())) {
            Boolean boolM1412twoDimensionalFocusSearchOMvw9 = TwoDimensionalFocusSearchKt.m1412twoDimensionalFocusSearchOMvw8(focusSearch, i, onFound);
            if (boolM1412twoDimensionalFocusSearchOMvw9 != null) {
                return boolM1412twoDimensionalFocusSearchOMvw9.booleanValue();
            }
        } else if (FocusDirection.m1366equalsimpl0(i, companion.m1375getEnterdhqQ8s())) {
            int i2 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i2 == 1) {
                iM1382getRightdhqQ8s = companion.m1382getRightdhqQ8s();
            } else {
                if (i2 != 2) {
                    throw new NoWhenBranchMatchedException();
                }
                iM1382getRightdhqQ8s = companion.m1378getLeftdhqQ8s();
            }
            FocusTargetNode focusTargetNodeFindActiveFocusNode = findActiveFocusNode(focusSearch);
            if (focusTargetNodeFindActiveFocusNode != null && (boolM1412twoDimensionalFocusSearchOMvw8 = TwoDimensionalFocusSearchKt.m1412twoDimensionalFocusSearchOMvw8(focusTargetNodeFindActiveFocusNode, iM1382getRightdhqQ8s, onFound)) != null) {
                return boolM1412twoDimensionalFocusSearchOMvw8.booleanValue();
            }
        } else {
            if (!FocusDirection.m1366equalsimpl0(i, companion.m1376getExitdhqQ8s())) {
                throw new IllegalStateException(("Focus search invoked with invalid FocusDirection " + ((Object) FocusDirection.m1368toStringimpl(i))).toString());
            }
