...
public final class LayoutNodeLayoutDelegate {
    ...
    public final class LookaheadPassDelegate extends Placeable implements Measurable, AlignmentLinesOwner {
        ...
        private long lastPosition = IntOffset.INSTANCE.m3903getZeronOccac();
            ...
            if (size > 0) {
                ...
                do {
                    ...
                    if (layoutNode2.getLookaheadMeasurePending$ui_release() && layoutNode2.getMeasuredByParentInLookahead$ui_release() == LayoutNode.UsageByParent.InMeasureBlock) {
                        ...
                        if (lookaheadPassDelegate.m2949remeasureBRTryo0(lookaheadConstraints.getValue())) {
        ...
        public Placeable mo2804measureBRTryo0(long constraints) {
            ...
            m2949remeasureBRTryo0(constraints);
            return this;
        }
        ...
        public void mo2805placeAtf8xVGno(final long position, float zIndex, @Nullable Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            LayoutNodeLayoutDelegate.this.layoutState = LayoutNode.LayoutState.LookaheadLayingOut;
            this.placedOnce = true;
            if (!IntOffset.m3892equalsimpl0(position, this.lastPosition)) {
            ...
            if (LayoutNodeLayoutDelegate.this.getLookaheadLayoutPending() || !getIsPlaced()) {
                ...
                OwnerSnapshotObserver.observeLayoutModifierSnapshotReads$ui_release$default(snapshotObserver, layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$placeAt$1
                    ...
                    public final void invoke2() {
                        ...
                        Intrinsics.checkNotNull(lookaheadDelegate);
                        Placeable.PlacementScope.m2848place70tqf50$default(companion, lookaheadDelegate, j, 0.0f, 2, null);
                    }
                }, 2, null);
            } else {
        ...
        public final boolean m2949remeasureBRTryo0(long constraints) {
            LayoutNode parent$ui_release = LayoutNodeLayoutDelegate.this.layoutNode.getParent$ui_release();
            ...
            if (!LayoutNodeLayoutDelegate.this.layoutNode.getLookaheadMeasurePending$ui_release()) {
                ...
                if (constraints2 == null ? false : Constraints.m3736equalsimpl0(constraints2.getValue(), constraints)) {
            ...
            this.lookaheadConstraints = Constraints.m3731boximpl(constraints);
            ...
            LayoutNodeLayoutDelegate.this.m2943performLookaheadMeasureBRTryo0(constraints);
            m2846setMeasuredSizeozmzZPI(IntSizeKt.IntSize(lookaheadDelegate.getWidth(), lookaheadDelegate.getHeight()));
            return (IntSize.m3935getWidthimpl(jIntSize) == lookaheadDelegate.getWidth() && IntSize.m3934getHeightimpl(jIntSize) == lookaheadDelegate.getHeight()) ? false : true;
        }
        ...
        public final void replace() {
            try {
                ...
                mo2805placeAtf8xVGno(this.lastPosition, 0.0f, null);
    ...
    public final class MeasurePassDelegate extends Placeable implements Measurable, AlignmentLinesOwner {
        ...
        private final void onBeforeLayoutChildren() {
            ...
            if (size > 0) {
                ...
                do {
                    LayoutNode layoutNode2 = content[i];
                    if (layoutNode2.getMeasurePending$ui_release() && layoutNode2.getMeasuredByParent$ui_release() == LayoutNode.UsageByParent.InMeasureBlock && LayoutNode.m2928remeasure_Sx5XlM$ui_release$default(layoutNode2, null, 1, null)) {
        ...
        private final void m2950placeOuterCoordinatorf8xVGno(final long position, final float zIndex, final Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            ...
            if (LayoutNodeLayoutDelegate.this.getLayoutPending() || !getIsPlaced()) {
                ...
                snapshotObserver.observeLayoutModifierSnapshotReads$ui_release(layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$MeasurePassDelegate$placeOuterCoordinator$1
                    ...
                    public final void invoke2() {
                        ...
                        float f = zIndex;
                        if (function1 == null) {
                            companion.m2852place70tqf50(layoutNodeLayoutDelegate2.getOuterCoordinator(), j, f);
                        } else {
                            companion.m2857placeWithLayeraW9wM(layoutNodeLayoutDelegate2.getOuterCoordinator(), j, f, function1);
                        }
                    }
                });
            } else {
                LayoutNodeLayoutDelegate.this.getOuterCoordinator().m2994placeSelfApparentToRealOffsetf8xVGno(position, zIndex, layerBlock);
                onNodePlaced$ui_release();
            }
            LayoutNodeLayoutDelegate.this.layoutState = LayoutNode.LayoutState.Idle;
        }
        ...
        public final Constraints m2951getLastConstraintsDWUhwKw() {
            if (this.measuredOnce) {
                return Constraints.m3731boximpl(getMeasurementConstraints());
            }
            return null;
        }
        ...
        public Placeable mo2804measureBRTryo0(long constraints) {
            ...
            if (layoutNodeLayoutDelegate.isOutMostLookaheadRoot(layoutNodeLayoutDelegate.layoutNode)) {
                ...
                lookaheadPassDelegate.mo2804measureBRTryo0(constraints);
            }
            trackMeasurementByParent(LayoutNodeLayoutDelegate.this.layoutNode);
            m2952remeasureBRTryo0(constraints);
            return this;
        }
        ...
        public final void measureBasedOnLookahead() {
            ...
            if (lookaheadPassDelegate.getMeasuredByParent() == LayoutNode.UsageByParent.InMeasureBlock && parent$ui_release.getLayoutState$ui_release() == LayoutNode.LayoutState.Measuring) {
                ...
                Intrinsics.checkNotNull(lookaheadConstraints);
                mo2804measureBRTryo0(lookaheadConstraints.getValue());
                ...
                mo2804measureBRTryo0(lookaheadConstraints2.getValue());
            }
        }
        ...
        public void mo2805placeAtf8xVGno(long position, float zIndex, @Nullable Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            ...
            if (layoutNodeLayoutDelegate.isOutMostLookaheadRoot(layoutNodeLayoutDelegate.layoutNode)) {
                ...
                Placeable.PlacementScope.place$default(companion, lookaheadPassDelegate, IntOffset.m3893getXimpl(position), IntOffset.m3894getYimpl(position), 0.0f, 4, null);
            }
            m2950placeOuterCoordinatorf8xVGno(position, zIndex, layerBlock);
        }
        ...
        public final void placeBasedOnLookahead() {
            ...
            mo2805placeAtf8xVGno(lookaheadPassDelegate.getLastPosition(), lookaheadPassDelegate.getLastZIndex(), lookaheadPassDelegate.getLastLayerBlock$ui_release());
        }

        /* JADX INFO: renamed from: remeasure-BRTryo0, reason: not valid java name */
        public final boolean m2952remeasureBRTryo0(long constraints) {
            Owner ownerRequireOwner = LayoutNodeKt.requireOwner(LayoutNodeLayoutDelegate.this.layoutNode);
            LayoutNode parent$ui_release = LayoutNodeLayoutDelegate.this.layoutNode.getParent$ui_release();
            boolean z = true;
            LayoutNodeLayoutDelegate.this.layoutNode.setCanMultiMeasure$ui_release(LayoutNodeLayoutDelegate.this.layoutNode.getCanMultiMeasure() || (parent$ui_release != null && parent$ui_release.getCanMultiMeasure()));
            if (!LayoutNodeLayoutDelegate.this.layoutNode.getMeasurePending$ui_release() && Constraints.m3736equalsimpl0(getMeasurementConstraints(), constraints)) {
            ...
            this.measuredOnce = true;
            long jMo2811getSizeYbymL2g = LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo2811getSizeYbymL2g();
            m2847setMeasurementConstraintsBRTryo0(constraints);
            LayoutNodeLayoutDelegate.this.m2944performMeasureBRTryo0(constraints);
            if (IntSize.m3933equalsimpl0(LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo2811getSizeYbymL2g(), jMo2811getSizeYbymL2g) && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth() == getWidth() && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight() == getHeight()) {
                z = false;
            }
            m2846setMeasuredSizeozmzZPI(IntSizeKt.IntSize(LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth(), LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight()));
            return z;
        }
        ...
        public final void replace() {
            try {
                ...
                m2950placeOuterCoordinatorf8xVGno(this.lastPosition, this.lastZIndex, this.lastLayerBlock);
                this.relayoutWithoutParentInProgress = false;
            } catch (Throwable th) {
                this.relayoutWithoutParentInProgress = false;
                throw th;
    ...
    public final void m2943performLookaheadMeasureBRTryo0(final long constraints) {
        ...
        OwnerSnapshotObserver.observeMeasureSnapshotReads$ui_release$default(LayoutNodeKt.requireOwner(this.layoutNode).getSnapshotObserver(), this.layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performLookaheadMeasure$1
            ...
            public final void invoke2() {
                ...
                Intrinsics.checkNotNull(lookaheadDelegate);
                lookaheadDelegate.mo2804measureBRTryo0(constraints);
            }
        }, 2, null);
    ...
    public final void m2944performMeasureBRTryo0(final long constraints) {
        ...
        LayoutNodeKt.requireOwner(this.layoutNode).getSnapshotObserver().observeMeasureSnapshotReads$ui_release(this.layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performMeasure$2
            ...
            /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2() {
                this.this$0.getOuterCoordinator().mo2804measureBRTryo0(constraints);
            }
        });
    ...
    @Nullable
    /* JADX INFO: renamed from: getLastConstraints-DWUhwKw, reason: not valid java name */
    public final Constraints m2945getLastConstraintsDWUhwKw() {
        return this.measurePassDelegate.m2951getLastConstraintsDWUhwKw();
    }

    @Nullable
    /* JADX INFO: renamed from: getLastLookaheadConstraints-DWUhwKw, reason: not valid java name */
    public final Constraints m2946getLastLookaheadConstraintsDWUhwKw() {
