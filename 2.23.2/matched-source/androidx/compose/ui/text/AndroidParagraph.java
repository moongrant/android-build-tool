...
public final class AndroidParagraph implements Paragraph {
    ...
    public final void m3181fillBoundingBoxes8ffj60Q(long range, @NotNull float[] array, int arrayStart) {
        Intrinsics.checkNotNullParameter(array, "array");
        this.layout.fillBoundingBoxes(TextRange.m3318getMinimpl(range), TextRange.m3317getMaximpl(range), array, arrayStart);
    }
    ...
    public Rect getCursorRect(int offset) {
        ...
        StringBuilder sbOooO0O0 = o0000O0.OooO0O0("offset(", offset, ") is out of bounds (0,");
        sbOooO0O0.append(this.charSequence.length());
    ...
    public int mo3183getOffsetForPositionk4lQ0M(long position) {
        return this.layout.getOffsetForHorizontal(this.layout.getLineForVertical((int) Offset.m1448getYimpl(position)), Offset.m1447getXimpl(position));
    }
    ...
    public float getWidth() {
        return Constraints.m3743getMaxWidthimpl(this.constraints);
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* JADX INFO: renamed from: getWordBoundary--jx7JFs, reason: not valid java name */
    public long mo3184getWordBoundaryjx7JFs(int offset) {
    ...
    public void mo3185paintLG529CI(@NotNull Canvas canvas, long color, @Nullable Shadow shadow, @Nullable TextDecoration textDecoration, @Nullable DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        int iM3552getBlendMode0nO6VwU = getTextPaint$ui_text_release().m3552getBlendMode0nO6VwU();
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m3555setColor8_81llA(color);
        ...
        textPaint$ui_text_release.m3553setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m3553setBlendModes9anfk8(iM3552getBlendMode0nO6VwU);
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* JADX INFO: renamed from: paint-RPmYEkk, reason: not valid java name */
    public void mo3186paintRPmYEkk(@NotNull Canvas canvas, long color, @Nullable Shadow shadow, @Nullable TextDecoration textDecoration) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m3555setColor8_81llA(color);
        textPaint$ui_text_release.setShadow(shadow);
    ...
    public void mo3187painthn5TExg(@NotNull Canvas canvas, @NotNull Brush brush, float alpha, @Nullable Shadow shadow, @Nullable TextDecoration textDecoration, @Nullable DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(brush, "brush");
        int iM3552getBlendMode0nO6VwU = getTextPaint$ui_text_release().m3552getBlendMode0nO6VwU();
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m3554setBrush12SF9DM(brush, SizeKt.Size(getWidth(), getHeight()), alpha);
        textPaint$ui_text_release.setShadow(shadow);
        textPaint$ui_text_release.setTextDecoration(textDecoration);
        textPaint$ui_text_release.setDrawStyle(drawStyle);
        textPaint$ui_text_release.m3553setBlendModes9anfk8(blendMode);
    ...
    private AndroidParagraph(AndroidParagraphIntrinsics paragraphIntrinsics, int i, boolean z, long j) {
        ...
        this.ellipsis = z;
        this.constraints = j;
        if ((Constraints.m3744getMinHeightimpl(j) == 0 && Constraints.m3745getMinWidthimpl(j) == 0) != true) {
        ...
        if ((i >= 1) != false) {
            ...
            int iM3193toLayoutAlignAMY3VfE = AndroidParagraph_androidKt.m3193toLayoutAlignAMY3VfE(style.m3349getTextAlignbuA522U());
            TextAlign textAlignM3349getTextAlignbuA522U = style.m3349getTextAlignbuA522U();
            boolean zM3677equalsimpl0 = textAlignM3349getTextAlignbuA522U == null ? false : TextAlign.m3677equalsimpl0(textAlignM3349getTextAlignbuA522U.getValue(), TextAlign.INSTANCE.m3683getJustifye0LSkKk());
            int iM3195toLayoutHyphenationFrequency0_XeFpE = AndroidParagraph_androidKt.m3195toLayoutHyphenationFrequency0_XeFpE(style.getParagraphStyle().getHyphens());
            LineBreak lineBreakM3347getLineBreakLgCVezo = style.m3347getLineBreakLgCVezo();
            int iM3194toLayoutBreakStrategyu6PBz3U = AndroidParagraph_androidKt.m3194toLayoutBreakStrategyu6PBz3U(lineBreakM3347getLineBreakLgCVezo != null ? LineBreak.Strategy.m3618boximpl(LineBreak.m3609getStrategyfcGXIks(lineBreakM3347getLineBreakLgCVezo.getMask())) : null);
            LineBreak lineBreakM3347getLineBreakLgCVezo2 = style.m3347getLineBreakLgCVezo();
            int iM3196toLayoutLineBreakStyle4a2g8L8 = AndroidParagraph_androidKt.m3196toLayoutLineBreakStyle4a2g8L8(lineBreakM3347getLineBreakLgCVezo2 != null ? LineBreak.Strictness.m3628boximpl(LineBreak.m3610getStrictnessusljTpc(lineBreakM3347getLineBreakLgCVezo2.getMask())) : null);
            LineBreak lineBreakM3347getLineBreakLgCVezo3 = style.m3347getLineBreakLgCVezo();
            int iM3197toLayoutLineBreakWordStylegvcdTPQ = AndroidParagraph_androidKt.m3197toLayoutLineBreakWordStylegvcdTPQ(lineBreakM3347getLineBreakLgCVezo3 != null ? LineBreak.WordBreak.m3639boximpl(LineBreak.m3611getWordBreakjp8hJ3c(lineBreakM3347getLineBreakLgCVezo3.getMask())) : null);
            TextUtils.TruncateAt truncateAt = z ? TextUtils.TruncateAt.END : null;
            TextLayout textLayoutConstructTextLayout = constructTextLayout(iM3193toLayoutAlignAMY3VfE, zM3677equalsimpl0 ? 1 : 0, truncateAt, i, iM3195toLayoutHyphenationFrequency0_XeFpE, iM3194toLayoutBreakStrategyu6PBz3U, iM3196toLayoutLineBreakStyle4a2g8L8, iM3197toLayoutLineBreakWordStylegvcdTPQ);
            if (z && textLayoutConstructTextLayout.getHeight() > Constraints.m3742getMaxHeightimpl(j) && i > 1) {
                int iNumberOfLinesThatFitMaxHeight = AndroidParagraph_androidKt.numberOfLinesThatFitMaxHeight(textLayoutConstructTextLayout, Constraints.m3742getMaxHeightimpl(j));
                if (iNumberOfLinesThatFitMaxHeight >= 0 && iNumberOfLinesThatFitMaxHeight != i) {
                    textLayoutConstructTextLayout = constructTextLayout(iM3193toLayoutAlignAMY3VfE, zM3677equalsimpl0 ? 1 : 0, truncateAt, RangesKt.coerceAtLeast(iNumberOfLinesThatFitMaxHeight, 1), iM3195toLayoutHyphenationFrequency0_XeFpE, iM3194toLayoutBreakStrategyu6PBz3U, iM3196toLayoutLineBreakStyle4a2g8L8, iM3197toLayoutLineBreakWordStylegvcdTPQ);
                }
                this.layout = textLayoutConstructTextLayout;
            } else {
                this.layout = textLayoutConstructTextLayout;
            }
            getTextPaint$ui_text_release().m3554setBrush12SF9DM(style.getBrush(), SizeKt.Size(getWidth(), getHeight()), style.getAlpha());
            for (ShaderBrushSpan shaderBrushSpan : getShaderBrushSpans(this.layout)) {
                shaderBrushSpan.m3573setSizeuvyYCjk(SizeKt.Size(getWidth(), getHeight()));
            }
