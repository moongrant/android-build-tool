...
public final class TextInformationFrame extends Id3Frame {
    ...
    public final ImmutableList<String> f8484OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @Nullable
    public final String f8485OooO0o0;
    ...
    public TextInformationFrame(String str, @Nullable String str2, o0O00 o0o01) {
        super(str);
        o00Oo0.OooO00o(!o0o01.isEmpty());
        this.f8485OooO0o0 = str2;
        ImmutableList<String> immutableListOooOO0O = ImmutableList.OooOO0O(o0o01);
        this.f8484OooO0o = immutableListOooOO0O;
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        return o00.OooO00o(this.f8473OooO0Oo, textInformationFrame.f8473OooO0Oo) && o00.OooO00o(this.f8485OooO0o0, textInformationFrame.f8485OooO0o0) && this.f8484OooO0o.equals(textInformationFrame.f8484OooO0o);
    }

    public final int hashCode() {
        int iOooO00o = OooO0O0.OooO00o(this.f8473OooO0Oo, 527, 31);
        String str = this.f8485OooO0o0;
        return this.f8484OooO0o.hashCode() + ((iOooO00o + (str != null ? str.hashCode() : 0)) * 31);
    }
    ...
    public final void o0ooOoO(MediaMetadata.OooO00o oooO00o) {
        ...
        ImmutableList<String> immutableList = this.f8484OooO0o;
        try {
            switch (b) {
                case 0:
                case 10:
                ...
                case 6:
                case 20:
                    String[] strArrOoooO0O = o00.OoooO0O(immutableList.get(0));
    ...
    public final String toString() {
        return this.f8473OooO0Oo + ": description=" + this.f8485OooO0o0 + ": values=" + this.f8484OooO0o;
    }

    @Override // android.os.Parcelable
    public final void writeToParcel(Parcel parcel, int i) {
        parcel.writeString(this.f8473OooO0Oo);
        parcel.writeString(this.f8485OooO0o0);
        parcel.writeStringArray((String[]) this.f8484OooO0o.toArray(new String[0]));
    }
}
