...
public final class OooOO0 {
    ...
    public static final class OooO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ List<NavBackStackEntry> f10104OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f10105OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ Collection<NavBackStackEntry> f10106OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(List<NavBackStackEntry> list, Collection<NavBackStackEntry> collection, int i) {
            super(2);
            this.f10104OooO0Oo = list;
            this.f10106OooO0o0 = collection;
            this.f10105OooO0o = i;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f10105OooO0o | 1);
            OooOO0.OooO0O0(this.f10104OooO0Oo, this.f10106OooO0o0, composer, iUpdateChangedFlags);
    ...
    public static final class OooO00o extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ OooOo00 f10107OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ NavBackStackEntry f10108OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(OooOo00 oooOo00, NavBackStackEntry navBackStackEntry) {
            super(0);
            this.f10107OooO0Oo = oooOo00;
            this.f10108OooO0o0 = navBackStackEntry;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            this.f10107OooO0Oo.OooO0O0().OooO0Oo(this.f10108OooO0o0, false);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0O0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ NavBackStackEntry f10109OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ OooOo00 f10110OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ SaveableStateHolder f10111OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ OooOo00.OooO00o f10112OooO0oO;
        ...
        public OooO0O0(NavBackStackEntry navBackStackEntry, SaveableStateHolder saveableStateHolder, OooOo00 oooOo00, OooOo00.OooO00o oooO00o) {
            super(2);
            this.f10109OooO0Oo = navBackStackEntry;
            this.f10111OooO0o0 = saveableStateHolder;
            this.f10110OooO0o = oooOo00;
            this.f10112OooO0oO = oooO00o;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            ...
            if ((iIntValue & 11) == 2 && composer2.getSkipping()) {
                ...
                OooOo00 oooOo00 = this.f10110OooO0o;
                NavBackStackEntry navBackStackEntry = this.f10109OooO0Oo;
                EffectsKt.DisposableEffect(navBackStackEntry, new OooOOO0(oooOo00, navBackStackEntry), composer2, 8);
                OooOo.OooO00o(navBackStackEntry, this.f10111OooO0o0, ComposableLambdaKt.composableLambda(composer2, -497631156, true, new OooOOO(this.f10112OooO0oO, navBackStackEntry)), composer2, 456);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public static final class OooO0OO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ OooOo00 f10113OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f10114OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(OooOo00 oooOo00, int i) {
            super(2);
            this.f10113OooO0Oo = oooOo00;
            this.f10114OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f10114OooO0o0 | 1);
            OooOO0.OooO00o(this.f10113OooO0Oo, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0o extends Lambda implements Function1<DisposableEffectScope, DisposableEffectResult> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ NavBackStackEntry f10115OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ List<NavBackStackEntry> f10116OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ boolean f10117OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(NavBackStackEntry navBackStackEntry, List list, boolean z) {
            super(1);
            this.f10115OooO0Oo = navBackStackEntry;
            this.f10117OooO0o0 = z;
            this.f10116OooO0o = list;
        }

        @Override // kotlin.jvm.functions.Function1
        public final DisposableEffectResult invoke(DisposableEffectScope disposableEffectScope) {
            final List<NavBackStackEntry> list = this.f10116OooO0o;
            final boolean z = this.f10117OooO0o0;
            final NavBackStackEntry navBackStackEntry = this.f10115OooO0Oo;
    ...
    public static final void OooO00o(@NotNull OooOo00 oooOo00, @Nullable Composer composer, int i) {
        ...
        if ((((i & 14) == 0 ? (composerStartRestartGroup.changed(oooOo00) ? 4 : 2) | i : i) & 11) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            State stateCollectAsState = SnapshotStateKt.collectAsState(oooOo00.OooO0O0().f35768OooO0o0, null, composerStartRestartGroup, 8, 1);
            ...
            for (NavBackStackEntry navBackStackEntry : snapshotStateList) {
                ...
                AndroidDialog_androidKt.Dialog(new OooO00o(oooOo00, navBackStackEntry), oooO00o.f10134OooOOO0, ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1129586364, true, new OooO0O0(navBackStackEntry, saveableStateHolderRememberSaveableStateHolder, oooOo00, oooO00o)), composerStartRestartGroup, 384, 0);
            }
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
