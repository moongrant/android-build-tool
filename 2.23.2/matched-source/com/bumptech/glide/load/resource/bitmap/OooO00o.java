...
public final class OooO00o {
    ...
    public static final o0OO00O<Boolean> f13082OooO;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public static final o0OO00O<DecodeFormat> f13083OooO0o = o0OO00O.OooO00o(DecodeFormat.DEFAULT, "com.bumptech.glide.load.resource.bitmap.Downsampler.DecodeFormat");

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public static final o0OO00O<PreferredColorSpace> f13084OooO0oO = new o0OO00O<>("com.bumptech.glide.load.resource.bitmap.Downsampler.PreferredColorSpace", null, o0OO00O.f37828OooO0o0);

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public static final o0OO00O<Boolean> f13085OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public static final Set<String> f13086OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public static final C0192OooO00o f13087OooOO0O;

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    public static final Set<ImageHeaderParser.ImageType> f13088OooOO0o;

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    public static final ArrayDeque f13089OooOOO0;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final OooOO0 f13090OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final DisplayMetrics f13091OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final OooO0o f13092OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final List<ImageHeaderParser> f13093OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final o000000 f13094OooO0o0 = o000000.OooO00o();
    ...
    static {
        DownsampleStrategy.OooO oooO = DownsampleStrategy.f13075OooO00o;
        Boolean bool = Boolean.FALSE;
        f13085OooO0oo = o0OO00O.OooO00o(bool, "com.bumptech.glide.load.resource.bitmap.Downsampler.FixBitmapSize");
        f13082OooO = o0OO00O.OooO00o(bool, "com.bumptech.glide.load.resource.bitmap.Downsampler.AllowHardwareDecode");
        f13086OooOO0 = Collections.unmodifiableSet(new HashSet(Arrays.asList("image/vnd.wap.wbmp", "image/x-ico")));
        f13087OooOO0O = new C0192OooO00o();
        f13088OooOO0o = Collections.unmodifiableSet(EnumSet.of(ImageHeaderParser.ImageType.JPEG, ImageHeaderParser.ImageType.PNG_A, ImageHeaderParser.ImageType.PNG));
        char[] cArr = o00OO0O0.f38351OooO00o;
        f13089OooOOO0 = new ArrayDeque(0);
    }

    public OooO00o(ArrayList arrayList, DisplayMetrics displayMetrics, OooOO0 oooOO1, OooO0o oooO0o) {
        this.f13093OooO0Oo = arrayList;
        o00OO00O.OooO0O0(displayMetrics);
        this.f13091OooO0O0 = displayMetrics;
        o00OO00O.OooO0O0(oooOO1);
        this.f13090OooO00o = oooOO1;
        o00OO00O.OooO0O0(oooO0o);
        this.f13092OooO0OO = oooO0o;
    }
    ...
    */
    ...
    public static void OooO0o(BitmapFactory.Options options) {
        OooO0oO(options);
        ArrayDeque arrayDeque = f13089OooOOO0;
    ...
    public final o00Ooo OooO00o(com.bumptech.glide.load.resource.bitmap.OooO0O0 oooO0O0, int i, int i2, oo0o0Oo oo0o0oo, OooO0O0 oooO0O1) throws IOException {
        BitmapFactory.Options options;
        BitmapFactory.Options options2;
        byte[] bArr = (byte[]) this.f13092OooO0OO.OooO0OO(65536, byte[].class);
        ...
        DecodeFormat decodeFormat = (DecodeFormat) oo0o0oo.OooO0OO(f13083OooO0o);
        PreferredColorSpace preferredColorSpace = (PreferredColorSpace) oo0o0oo.OooO0OO(f13084OooO0oO);
        DownsampleStrategy downsampleStrategy = (DownsampleStrategy) oo0o0oo.OooO0OO(DownsampleStrategy.f13079OooO0o);
        boolean zBooleanValue = ((Boolean) oo0o0oo.OooO0OO(f13085OooO0oo)).booleanValue();
        o0OO00O<Boolean> o0oo00o2 = f13082OooO;
        try {
            return o00Ooo.OooO0O0(OooO0O0(oooO0O0, options2, downsampleStrategy, decodeFormat, preferredColorSpace, oo0o0oo.OooO0OO(o0oo00o2) != null && ((Boolean) oo0o0oo.OooO0OO(o0oo00o2)).booleanValue(), i, i2, zBooleanValue, oooO0O1), this.f13090OooO00o);
        } finally {
            OooO0o(options2);
            this.f13092OooO0OO.put(bArr);
        }
    }
    ...
    public final Bitmap OooO0O0(com.bumptech.glide.load.resource.bitmap.OooO0O0 oooO0O0, BitmapFactory.Options options, DownsampleStrategy downsampleStrategy, DecodeFormat decodeFormat, PreferredColorSpace preferredColorSpace, boolean z, int i, int i2, boolean z2, OooO0O0 oooO0O1) throws IOException {
        ...
        int i19;
        int i20 = i;
        int i21 = o00O0OOO.f38347OooO0O0;
        long jElapsedRealtimeNanos = SystemClock.elapsedRealtimeNanos();
        options.inJustDecodeBounds = true;
        OooOO0 oooOO2 = this.f13090OooO00o;
        ...
        if (i22 <= 0 || i23 <= 0) {
            ...
            if (fOooO0O0 <= 0.0f) {
                ...
                sb.append(", source: [");
                OooOOO0.OooO00o(sb, i22, "x", i23, "], target: [");
                sb.append(i20);
                sb.append("x");
                sb.append(i4);
                sb.append("]");
            ...
            if (i29 <= 23) {
                i15 = i20;
                if (f13086OooOO0.contains(options.outMimeType)) {
                    iMax = 1;
                }
                ...
                if (Log.isLoggable(str2, 2)) {
                    ...
                    OooOOO0.OooO00o(sbOooO00o, i24, ", target: [", i8, str3);
                    OooOOO0.OooO00o(sbOooO00o, i7, "], power of two scaled: [", iFloor, str3);
            ...
            if (Log.isLoggable(str2, 2)) {
                ...
                OooOOO0.OooO00o(sbOooO00o2, i24, ", target: [", i8, str3);
                OooOOO0.OooO00o(sbOooO00o2, i7, "], power of two scaled: [", iFloor, str3);
        ...
        boolean zOooO0OO = this.f13094OooO0o0.OooO0OO(i8, i7, z10, z9);
        if (zOooO0OO) {
        ...
        if (!zOooO0OO) {
            ...
            if (i5 >= 0 || i6 < 0 || !z2) {
                ...
                if (Log.isLoggable(str2, 2)) {
                    ...
                    OooOOO0.OooO00o(sbOooO00o3, i5, str3, i6, "], sampleSize: ");
            ...
            if (Log.isLoggable(str2, 2)) {
                Log.v(str2, "Decoded " + OooO0Oo(OooO0OO2) + " from [" + i5 + str3 + i6 + "] " + str6 + " with inBitmap " + OooO0Oo(options.inBitmap) + " for [" + i + str3 + i2 + "], sample size: " + options.inSampleSize + str4 + options.inDensity + str5 + options.inTargetDensity + ", thread: " + Thread.currentThread().getName() + ", duration: " + o00O0OOO.OooO00o(jElapsedRealtimeNanos));
            }
            if (OooO0OO2 != 0) {
                OooO0OO2.setDensity(this.f13091OooO0O0.densityDpi);
                switch (iOooO0OO) {
                    case 2:
                    case 3:
                    case 4:
                ...
                if (z5) {
                    ...
                    o0000.OooO00o(OooO0OO2, bitmapOooO0o0, matrix);
                    r7 = bitmapOooO0o0;
                } else {
                    r7 = OooO0OO2;
                }
        ...
        if (i5 >= 0) {
            ...
            if (Log.isLoggable(str2, 2)) {
                ...
                OooOOO0.OooO00o(sbOooO00o4, i5, str3, i6, "], sampleSize: ");
            ...
            if (Log.isLoggable(str2, 2)) {
                ...
                OooOOO0.OooO00o(sbOooO00o5, i5, str3, i6, "], sampleSize: ");
        ...
        if (OooO0OO2 != 0) {
            ...
            if (z5) {
                ...
                o0000.OooO00o(OooO0OO2, bitmapOooO0o1, matrix);
                r7 = bitmapOooO0o1;
            }
            if (!OooO0OO2.equals(r7)) {
                r12.OooO0Oo(OooO0OO2);
