...
public final class ModelManager {
    ...
    public static final class TaskHandler {
        ...
        public static final class Companion {
            ...
            public static final void m4100execute$lambda1(List slaves, File file) {
                ...
                if (modelBuild != null) {
                    ...
                    while (it.hasNext()) {
                        ...
                        sb.append('_');
                        TaskHandler.INSTANCE.download(taskHandler.getRuleUri(), OooOO0.OooO00o(sb, taskHandler.getVersionId(), "_rule"), new FileDownloadTask.Callback() { // from class: com.facebook.appevents.ml.OooO0o
                            @Override // com.facebook.appevents.internal.FileDownloadTask.Callback
                            public final void onComplete(File file2) {
                                ModelManager.TaskHandler.Companion.m4101execute$lambda1$lambda0(taskHandler, modelBuild, file2);
                            }
                        });
                    }
                }
            ...
            public static final void m4101execute$lambda1$lambda0(TaskHandler slave, Model model, File file) {
            ...
            public final void execute(@NotNull TaskHandler master, @NotNull List<TaskHandler> slaves) {
                ...
                download(master.getAssetUri(), master.getUseCase() + '_' + master.getVersionId(), new o0000Ooo(slaves, 2));
            }
        }
    ...
    public static final void enable() {
        ...
        try {
            Utility.runOnNonUiThread(new OooO00o());
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, ModelManager.class);
        }
    }
    ...
    public static final void m4097enable$lambda0() {
            ...
            for (Map.Entry<String, TaskHandler> entry : taskHandlers.entrySet()) {
                ...
                if (Intrinsics.areEqual(key, Task.MTML_APP_EVENT_PREDICTION.toUseCase())) {
                    ...
                    if (FeatureManager.isEnabled(FeatureManager.Feature.SuggestedEvents) && isLocaleEnglish()) {
                        arrayList.add(value.setOnPostExecute(new OooO0O0()));
                    }
                    assetUri = assetUri2;
                    iMax = iMax2;
                }
                if (Intrinsics.areEqual(key, Task.MTML_INTEGRITY_DETECT.toUseCase())) {
                    ...
                    if (FeatureManager.isEnabled(FeatureManager.Feature.IntelligentIntegrity)) {
                        arrayList.add(value.setOnPostExecute(new OooO0OO()));
                    }
                }
            }
    ...
    public static final void m4098enableMTML$lambda1() {
        if (CrashShieldHandler.isObjectCrashing(ModelManager.class)) {
            return;
        }
        try {
    ...
    public static final void m4099enableMTML$lambda2() {
        if (CrashShieldHandler.isObjectCrashing(ModelManager.class)) {
            return;
        }
        try {
