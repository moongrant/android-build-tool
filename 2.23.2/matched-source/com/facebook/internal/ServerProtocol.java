...
public final class ServerProtocol {
    ...
    public static final String getDialogAuthority() {
        ...
        return OooO0O0.OooO0O0.OooO00o(new Object[]{FacebookSdk.getFacebookDomain()}, 1, DIALOG_AUTHORITY_FORMAT, "java.lang.String.format(format, *args)");
    }
    ...
    public static final String getFacebookGraphUrlBase() {
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
        return OooO0O0.OooO0O0.OooO00o(new Object[]{FacebookSdk.getFacebookDomain()}, 1, GRAPH_URL_FORMAT, "java.lang.String.format(format, *args)");
    }
    ...
    public static final String getGraphUrlBase() {
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
        return OooO0O0.OooO0O0.OooO00o(new Object[]{FacebookSdk.getGraphDomain()}, 1, GRAPH_URL_FORMAT, "java.lang.String.format(format, *args)");
    }
    ...
    public static final String getGraphUrlBaseForSubdomain(@NotNull String subdomain) {
        ...
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
        return OooO0O0.OooO0O0.OooO00o(new Object[]{subdomain}, 1, GRAPH_URL_FORMAT, "java.lang.String.format(format, *args)");
    }
    ...
    public static final String getGraphVideoUrlBase() {
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
        return OooO0O0.OooO0O0.OooO00o(new Object[]{FacebookSdk.getGraphDomain()}, 1, GRAPH_VIDEO_URL_FORMAT, "java.lang.String.format(format, *args)");
    }
    ...
    public static final String getInstagramDialogAuthority() {
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
        return OooO0O0.OooO0O0.OooO00o(new Object[]{FacebookSdk.getInstagramDomain()}, 1, DIALOG_AUTHORITY_FORMAT, "java.lang.String.format(format, *args)");
    }
    ...
    public static final Bundle getQueryParamsForPlatformActivityIntentWebFallback(@NotNull String callId, int version, @Nullable Bundle methodArgs) {
        ...
        try {
            ...
            Logger.INSTANCE.log(LoggingBehavior.DEVELOPER_ERRORS, 6, TAG, Intrinsics.stringPlus("Error creating Url -- ", e));
            return null;
        } catch (JSONException e2) {
            Logger.INSTANCE.log(LoggingBehavior.DEVELOPER_ERRORS, 6, TAG, Intrinsics.stringPlus("Error creating Url -- ", e2));
            return null;
        }
    }
}
