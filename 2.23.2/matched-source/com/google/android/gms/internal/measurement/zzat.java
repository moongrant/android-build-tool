...
public final class zzat implements Iterable, zzap {
    ...
    public final String f15189OooO0Oo;

    public zzat(String str) {
        if (str == null) {
            throw new IllegalArgumentException("StringValue cannot be null.");
        }
        this.f15189OooO0Oo = str;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof zzat) {
            return this.f15189OooO0Oo.equals(((zzat) obj).f15189OooO0Oo);
        }
        return false;
    }

    public final int hashCode() {
        return this.f15189OooO0Oo.hashCode();
    }
    ...
    public final String toString() {
        return p028Oooo0oO.o0oOO.OooO0O0(new StringBuilder("\""), this.f15189OooO0Oo, "\"");
    }
    ...
    public final zzap zzbU(String str, zzg zzgVar, List list) {
        ...
        String str3 = str2;
        String str4 = this.f15189OooO0Oo;
        switch (b) {
            case 0:
                zzh.zzj(str3, 1, list);
            ...
            case 6:
                ...
                if (iIndexOf >= 0) {
                    ...
                    zzatVar = new zzat(p031OoooO0.o0OoOo0.OooO0O0(str4.substring(0, iIndexOf), zzapVarZza.zzi(), str4.substring(str5.length() + iIndexOf)));
                    return zzatVar;
                }
                return this;
            case 7:
    ...
    public final zzap zzd() {
        return new zzat(this.f15189OooO0Oo);
    }

    @Override // com.google.android.gms.internal.measurement.zzap
    public final Boolean zzg() {
        return Boolean.valueOf(!this.f15189OooO0Oo.isEmpty());
    }

    @Override // com.google.android.gms.internal.measurement.zzap
    public final Double zzh() {
        String str = this.f15189OooO0Oo;
        if (str.isEmpty()) {
