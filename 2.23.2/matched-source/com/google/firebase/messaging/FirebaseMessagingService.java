...
public class FirebaseMessagingService extends EnhancedIntentService {
    ...
    private void dispatchMessage(Intent intent) {
        ...
        if (o0Oo0oo.OooO0o(extras)) {
            o0Oo0oo o0oo0oo2 = new o0Oo0oo(extras);
            ...
            try {
                if (new OooOO0O(this, o0oo0oo2, executorServiceNewSingleThreadExecutor).OooO00o()) {
                    executorServiceNewSingleThreadExecutor.shutdown();
                    return;
                } else {
                    executorServiceNewSingleThreadExecutor.shutdown();
                    if (o0ooOOo.OooO0O0(intent)) {
                        o0ooOOo.OooO00o(intent.getExtras(), "_nf");
                    }
                }
            } catch (Throwable th) {
                executorServiceNewSingleThreadExecutor.shutdown();
    ...
    private void passMessageIntentToSdk(Intent intent) {
        ...
        boolean z;
        long j;
        p626o0ooO.o0OOO0o o0ooo0oOooO0OO;
        p626o0ooO.oo0o0Oo oo0o0oo;
        String str;
        String str2;
        String[] strArrSplit;
        String str3;
        ...
        if (o0ooOOo.OooO0O0(intent)) {
            o0ooOOo.OooO00o(intent.getExtras(), "_nr");
        }
        if ("com.google.firebase.messaging.RECEIVE_DIRECT_BOOT".equals(intent.getAction())) {
            z = false;
        } else {
            try {
                p626o0ooO.o0OOO0o.OooO0OO();
                p626o0ooO.o0OOO0o o0ooo0oOooO0OO2 = p626o0ooO.o0OOO0o.OooO0OO();
                o0ooo0oOooO0OO2.OooO00o();
                Context context = o0ooo0oOooO0OO2.f57662OooO00o;
        ...
        if (z) {
            ...
            o0OoO00O o0ooo00o2 = FirebaseMessaging.f19757OooOOO;
            if (o0ooo00o2 == null) {
                ...
                if (TextUtils.isEmpty(string)) {
                    try {
                        p626o0ooO.o0OOO0o o0ooo0oOooO0OO3 = p626o0ooO.o0OOO0o.OooO0OO();
                        Object obj2 = com.google.firebase.installations.OooO00o.f19706OooOOO0;
                        Preconditions.checkArgument(true, "Null is not a valid value of FirebaseApp.");
                        string = (String) Tasks.await(((com.google.firebase.installations.OooO00o) o0ooo0oOooO0OO3.OooO0O0(p302o0O0o0OO.o0000O0O.class)).getId());
                    } catch (InterruptedException | ExecutionException e) {
                        throw new RuntimeException(e);
                    }
                }
                String str4 = string;
                p626o0ooO.o0OOO0o o0ooo0oOooO0OO4 = p626o0ooO.o0OOO0o.OooO0OO();
                o0ooo0oOooO0OO4.OooO00o();
                String packageName = o0ooo0oOooO0OO4.f57662OooO00o.getPackageName();
                MessagingClientEvent.SDKPlatform sDKPlatform = MessagingClientEvent.SDKPlatform.ANDROID;
                MessagingClientEvent.MessageType messageType = o0Oo0oo.OooO0o(extras) ? MessagingClientEvent.MessageType.DISPLAY_NOTIFICATION : MessagingClientEvent.MessageType.DATA_MESSAGE;
                ...
                if (extras.containsKey("google.c.sender.id")) {
                    try {
                        ...
                        o0ooo0oOooO0OO = p626o0ooO.o0OOO0o.OooO0OO();
                        o0ooo0oOooO0OO.OooO00o();
                        oo0o0oo = o0ooo0oOooO0OO.f57664OooO0OO;
                        str = oo0o0oo.f57679OooO0o0;
                        if (str != null) {
                            try {
                ...
                try {
                    o0ooo00o2.OooO00o("FCM_CLIENT_EVENT_LOGGING", new o0OoOoOo("proto"), new p102o000oo0.o00Ooo()).OooO00o(new o0O000O(new o000O0(new MessagingClientEvent(j > 0 ? j : 0L, str5, str4, messageType, sDKPlatform, packageName, str7, i, str6, event, str8, str9)), Priority.DEFAULT), new com.facebook.OooOO0O());
    ...
    public Intent getStartCommandIntent(Intent intent) {
        return (Intent) o00000O.OooO00o().f19834OooO0Oo.poll();
    }
