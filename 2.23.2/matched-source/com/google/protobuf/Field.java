...
public final class Field extends GeneratedMessageV3 implements FieldOrBuilder {
    ...
    public int hashCode() {
        ...
        int iHashBoolean = Internal.hashBoolean(getPacked()) + ((((getOneofIndex() + ((((getTypeUrl().hashCode() + ((((getName().hashCode() + ((((getNumber() + androidx.compose.ui.graphics.colorspace.OooO00o.OooO00o(androidx.compose.ui.graphics.colorspace.OooO00o.OooO00o((((getDescriptor().hashCode() + 779) * 37) + 1) * 53, this.kind_, 37, 2, 53), this.cardinality_, 37, 3, 53)) * 37) + 4) * 53)) * 37) + 6) * 53)) * 37) + 7) * 53)) * 37) + 8) * 53);
        if (getOptionsCount() > 0) {
            iHashBoolean = getOptionsList().hashCode() + o00Ooo.OooO00o(iHashBoolean, 37, 9, 53);
        }
        int iHashCode = getUnknownFields().hashCode() + ((getDefaultValue().hashCode() + ((((getJsonName().hashCode() + o00Ooo.OooO00o(iHashBoolean, 37, 10, 53)) * 37) + 11) * 53)) * 29);
