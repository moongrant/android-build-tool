...
public final /* synthetic */ class o00000O implements Observer {
    ...
    public final /* synthetic */ int f23038OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ KeyEvent.Callback f23039OooO0o0;

    public /* synthetic */ o00000O(KeyEvent.Callback callback, int i) {
        this.f23038OooO0Oo = i;
        this.f23039OooO0o0 = callback;
    }

    @Override // androidx.lifecycle.Observer
    public final void onChanged(Object obj) {
        RoomRunWayModel roomRunWayModel;
        int i = this.f23038OooO0Oo;
        TopicInfoModel topicInfoModel = null;
        boolean z = true;
        KeyEvent.Callback callback = this.f23039OooO0o0;
        switch (i) {
            case 0:
            ...
            default:
                ...
                int i4 = BaseWebView2.f30861OooOO0;
                Intrinsics.checkNotNullParameter(this$1, "this$0");
                if (str2 != null && str2.length() != 0) {
                    z = false;
                }
                if (!z) {
                    oOO00O0.OooO0O0(this$1, str2);
                } else {
