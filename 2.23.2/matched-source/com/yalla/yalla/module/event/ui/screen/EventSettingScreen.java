...
public final class EventSettingScreen extends o000O0 {
    ...
    public static final class OooO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ int f23396OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(int i) {
            super(2);
            this.f23396OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f23396OooO0o0 | 1);
    ...
    public static final class OooO00o extends Lambda implements Function1<Boolean, Unit> {
        ...
        public final /* synthetic */ EventSettingViewModel f23397OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(EventSettingViewModel eventSettingViewModel) {
            super(1);
            this.f23397OooO0Oo = eventSettingViewModel;
        }

        @Override // kotlin.jvm.functions.Function1
        public final Unit invoke(Boolean bool) {
            o0oo0000.OooO00o.OooO0OO("101083", MapsKt.mapOf(new Pair("type", Integer.valueOf(bool.booleanValue() ? 1 : 2))));
            this.f23397OooO0Oo.setEventSettingState();
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0O0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f23399OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(int i) {
            super(2);
            this.f23399OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f23399OooO0o0 | 1);
    ...
    public static final class OooO0OO extends Lambda implements Function1<Lifecycle.Event, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ EventSettingViewModel f23400OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(EventSettingViewModel eventSettingViewModel) {
            super(1);
            this.f23400OooO0Oo = eventSettingViewModel;
        }
        ...
        public final Unit invoke(Lifecycle.Event event) {
            ...
            if (it == Lifecycle.Event.ON_START) {
                this.f23400OooO0Oo.getHasPermissions().setValue(Boolean.valueOf(com.yalla.yalla.util.permission.OooO00o.OooO00o(o000O00O.OooO00o(), PermissionGroupReveal.f32339OooO0o)));
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ int f23402OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ ColumnScope f23403OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(ColumnScope columnScope, int i) {
            super(2);
            this.f23403OooO0o0 = columnScope;
            this.f23402OooO0o = i;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f23402OooO0o | 1);
            EventSettingScreen.this.Content(this.f23403OooO0o0, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0 extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Context f23404OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0(Context context) {
            super(0);
            this.f23404OooO0Oo = context;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            Context context = this.f23404OooO0Oo;
            try {
    ...
    public static final class OooOO0O extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f23406OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0O(int i) {
            super(2);
            this.f23406OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f23406OooO0o0 | 1);
            EventSettingScreen.this.EnableCalendarPermissions(composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public final void EnableCalendarPermissions(Composer composer, int i) {
        ...
        if ((i & 1) == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            if (((EventSettingViewModel) viewModel).getHasPermissions().getValue().booleanValue()) {
                ...
                androidx.compose.animation.OooOO0.OooO00o(0, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composerStartRestartGroup)), composerStartRestartGroup, 2058660585);
                ColumnScopeInstance columnScopeInstance = ColumnScopeInstance.INSTANCE;
                TextKt.m1261Text4IGK_g(StringResources_androidKt.stringResource(p562o0oOo000.o000000.event_setting_enable_desc, composerStartRestartGroup, 0), (Modifier) null, o0000oo.OooO0OO(composerStartRestartGroup).f38627OooOO0o, TextUnitKt.getSp(12), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composerStartRestartGroup, 3072, 0, 131058);
                composer2 = composerStartRestartGroup;
                androidx.compose.ui.semantics.OooO0O0.OooO0O0(14, companion, composer2, 6);
                TextKt.m1261Text4IGK_g(StringResources_androidKt.stringResource(p562o0oOo000.o000000.event_setting_enable, composer2, 0), com.code.android.util.o0O0O00.OooO0O0(PaddingKt.m480paddingVpY3zN4$default(BackgroundKt.m170backgroundbw27NRU(PaddingKt.m480paddingVpY3zN4$default(SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), Dp.m3775constructorimpl(46), 0.0f, 2, null), o0000oo.OooO0OO(composer2).f38617OooO00o, RoundedCornerShapeKt.getCircleShape()), 0.0f, Dp.m3775constructorimpl(12), 1, null), false, false, 0L, false, null, null, null, new OooOO0(context), 253), o0OOo000.f48135OooO0O0, TextUnitKt.getSp(15), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, TextAlign.m3674boximpl(TextAlign.INSTANCE.m3681getCentere0LSkKk()), 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 3072, 0, 130544);
    ...
    public void Content(@NotNull ColumnScope columnScope, @Nullable Composer composer, int i) {
        ...
        if ((i2 & 81) == 16 && composerStartRestartGroup.getSkipping()) {
            ...
            o0O0oo0o.OooO00o(StringResources_androidKt.stringResource(p562o0oOo000.o000000.event_setting, composerStartRestartGroup, 0), 0.0f, 0L, null, null, null, null, null, null, composerStartRestartGroup, 0, 510);
            int i3 = (i2 >> 3) & 14;
            composer2 = composerStartRestartGroup;
