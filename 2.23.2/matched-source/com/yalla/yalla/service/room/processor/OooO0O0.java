...
public final class OooO0O0 implements com.yalla.yalla.service.room.processor.OooO00o {
    ...
    @NotNull
    public static final OooO0O0 f24622OooO00o = new OooO0O0();
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public int f24623OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ ChatModel f24624OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(ChatModel chatModel, Continuation<? super OooO00o> continuation) {
            super(2, continuation);
            this.f24624OooO0o0 = chatModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO00o(this.f24624OooO0o0, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f24623OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                this.f24623OooO0Oo = 1;
            ...
            MixedRoomDataSource.OooO0o0().OooO00o(this.f24624OooO0o0);
    ...
    public final void OooO0O0(@NotNull InOutRoomModel inOutRoomModel) {
        ...
        o0000O00.OooO0OO(com.yalla.yalla.service.room.processor.OooO00o.C0318OooO00o.OooO00o(this), " OtherUserLoginRoom = " + inOutRoomModel);
    ...
    public final void OooO0Oo(@NotNull SkillCardModel model) {
        ...
        if (Intrinsics.areEqual(value, o0O00oO0.OooOOo0().getValue())) {
            ...
            chatModel.setMessage(o0000.OooO0OO(o000000.send_you) + ZegoConstants.ZegoVideoDataAuxPublishingStream + o0000.OooO0OO(o000000.Hats));
            MixedRoomDataSource.OooO0o0().OooO00o(chatModel);
        }
    }
    ...
    public final void OooO0o0(@NotNull Room.MagicVoiceOut model) {
        ...
        if (l != null && userId == l.longValue()) {
            ...
            String strOooO00o = oOO000o.OooO00o(model.getCardid());
            ...
            chatModel.setMessage(o0000.OooO0OO(o000000.message_room_send_voice_changer));
            MixedRoomDataSource.OooO0o0().OooO00o(chatModel);
        }
    }
}
