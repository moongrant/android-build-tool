...
public final class OooO0o implements OooO00o {
    ...
    public static void OooO0OO(Room.BackPackGiftReply backPackGiftReply) {
        ...
        if (code == 0) {
            ...
            oo0o0Oo.OooO0o((int) backPackGiftReply.getGiftId(), backPackGiftReply.getRemainingNum(), backPackGiftReply.getMinExpirationTime());
            return;
        }
        boolean z = true;
        if (code != 1 && code != 4153) {
        ...
        if (z) {
            ...
            oo0o0Oo.OooO0o((int) backPackGiftReply.getGiftId(), backPackGiftReply.getRemainingNum(), backPackGiftReply.getMinExpirationTime());
            o000O00.OooO0O0(o0000.OooO0OO(backPackGiftReply.getRemainingNum() > 0 ? o000000.Some_gifts_have_expired : o000000.The_gift_has_expired));
        } else if (code == 4154) {
    ...
    public static void OooO0Oo(RoomGiftModel roomGiftModel, int i, int i2) {
        ...
        o0000O00.OooO0O0("parseGiftMessage type: " + roomGiftModel.getType() + ", model = " + p187o00o00o0.OooO.OooO00o(roomGiftModel));
        ...
        if (Intrinsics.areEqual(value, o0O00oO0.OooOOo0().getValue())) {
            o0oo0000.OooO00o.OooO0OO("202004", p190o00o0O.OooOO0.OooO00o(new Pair("Giftid", Integer.valueOf(roomGiftModel.getGiftid()))));
        }
        if (i == GiftPropTypePay.Coin.getValue()) {
            long morajuid = roomGiftModel.getMorajuid();
            Long l = (Long) o0O00oO0.OooOOo0().getValue();
            if (l != null && morajuid == l.longValue()) {
                MixedRoomDataSource.OooO0o0().f23003OooOOo0 = roomGiftModel;
                return;
        ...
        o0000O00.OooO0O0("NormalGiftRunWay, messageType:" + i2 + "  isAddGiftRunway:" + roomGiftModel.isAddGiftRunway() + "  " + p187o00o00o0.OooO.OooO00o(roomGiftModel));
    ...
    public static void OooO0o(RoomGiftModel roomGiftModel, int i) {
        ...
        if (roomGiftModel.getNewTo() != null) {
            ...
            T value3 = o0O00oO0.OooOOo0().getValue();
    ...
    public final void OooO0o0(int i, @Nullable Object obj) {
        ...
        try {
            switch (i) {
                case 10009:
                    o0000O00.OooO0O0("RoomGiftMsgProcessor parseMessage type = " + i + ", 接收到送金币礼物");
                    RoomGiftModel roomGiftModel = (RoomGiftModel) oOOO00.OooO00o(str, RoomGiftModel.class);
                    if (roomGiftModel != null) {
                        OooO0Oo(roomGiftModel, GiftPropTypePay.Coin.getValue(), i);
                    }
                    break;
                case 10048:
                    o0000O00.OooO0O0("RoomGiftMsgProcessor parseMessage type = " + i + ", 接收到送房间所有人金币礼物");
                    GiftRoomAllResultModel giftRoomAllResultModel = (GiftRoomAllResultModel) oOOO00.OooO00o(str, GiftRoomAllResultModel.class);
                    if (giftRoomAllResultModel != null) {
                        OooO0O0(giftRoomAllResultModel, GiftPropTypePay.Coin.getValue(), true);
                    }
                    break;
                case 10056:
                    RoomGiftModel roomGiftModel2 = (RoomGiftModel) oOOO00.OooO00o(str, RoomGiftModel.class);
                    if (roomGiftModel2 != null) {
                        OooO0Oo(roomGiftModel2, GiftPropTypePay.Crystal.getValue(), i);
                    }
                    break;
                case 10057:
                    o0000O00.OooO0O0("RoomGiftMsgProcessor parseMessage type = " + i + ", 接收到送房间所有人水晶礼物");
                    GiftRoomAllResultModel giftRoomAllResultModel2 = (GiftRoomAllResultModel) oOOO00.OooO00o(str, GiftRoomAllResultModel.class);
                    if (giftRoomAllResultModel2 != null) {
                        OooO0O0(giftRoomAllResultModel2, GiftPropTypePay.Crystal.getValue(), true);
                    }
                    break;
                case 1000100:
                    o0000O00.OooO0O0("RoomGiftMsgProcessor parseMessage type = " + i + ", 一键送麦上礼物");
                    GiftRoomAllResultModel giftRoomAllResultModel3 = (GiftRoomAllResultModel) oOOO00.OooO00o(str, GiftRoomAllResultModel.class);
                    ...
                    break;
                case 1000600:
                    o0000O00.OooO0O0("RoomGiftMsgProcessor parseMessage type = " + i + ", 活动特效");
                    RoomActivityEffectAnimModel roomActivityEffectAnimModel = (RoomActivityEffectAnimModel) oOOO00.OooO00o(str, RoomActivityEffectAnimModel.class);
                    if (roomActivityEffectAnimModel != null) {
                        MixedRoomDataSource.OooO0o0().OooOOOO(1000600, roomActivityEffectAnimModel);
                    }
                    break;
                case 1001001:
                    RoomGiftModel roomGiftModel3 = (RoomGiftModel) oOOO00.OooO00o(str, RoomGiftModel.class);
