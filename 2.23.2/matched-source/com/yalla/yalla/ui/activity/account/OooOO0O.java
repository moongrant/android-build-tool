...
public final class OooOO0O extends p {

    /* JADX INFO: renamed from: OooOOo0, reason: collision with root package name */
    public final /* synthetic */ PhoneNumberActivity f24759OooOOo0;
    ...
    public static final class OooO0O0 extends Lambda implements Function1<Boolean, Unit> {
        ...
        public final /* synthetic */ PhoneNumberActivity f24760OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(PhoneNumberActivity phoneNumberActivity) {
            super(1);
            this.f24760OooO0Oo = phoneNumberActivity;
        }
        ...
        public final Unit invoke(Boolean bool) {
            ...
            PhoneNumberActivity fragmentActivity = this.f24760OooO0Oo;
            if (zBooleanValue) {
                ...
                fragmentActivity.OooOoO0().OooO00o();
            }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooOO0O(PhoneNumberActivity phoneNumberActivity, boolean z) {
        super(phoneNumberActivity, z);
        this.f24759OooOOo0 = phoneNumberActivity;
    }
    ...
    public final void OooO0Oo(@NotNull OtherLoginType loginType) {
        ...
        PhoneNumberActivity phoneNumberActivity = this.f24759OooOOo0;
        if (i == 1) {
            AppConfigRepo.f24292OooO00o.getClass();
            AppConfigRepo.f24293OooO0O0.observe(phoneNumberActivity, new PhoneNumberActivity.OooO0o(new OooO0O0(phoneNumberActivity)));
            return;
        }
        if (i == 2) {
            int i2 = PhoneNumberActivity.f24807OooOoO;
            ...
            int i4 = PhoneNumberActivity.f24807OooOoO;
