...
public final /* synthetic */ class o0O0O00 implements Observer {
    ...
    public final /* synthetic */ int f25497OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ BaseFragmentActivity f25498OooO0o0;

    public /* synthetic */ o0O0O00(BaseFragmentActivity baseFragmentActivity, int i) {
        this.f25497OooO0Oo = i;
        this.f25498OooO0o0 = baseFragmentActivity;
    }

    @Override // androidx.lifecycle.Observer
    public final void onChanged(Object obj) {
        int i = this.f25497OooO0Oo;
        BaseFragmentActivity baseFragmentActivity = this.f25498OooO0o0;
        switch (i) {
            case 0:
                ...
                if (bool.booleanValue() && !WealthLevel.Companion.isUnlocked$default(WealthLevel.INSTANCE, null, 1, null)) {
                    p423o0OoO0OO.oo0o0Oo.OooO00o(this$0, new m5(new o000O0(this$0)));
                    break;
                }
                break;
            default:
