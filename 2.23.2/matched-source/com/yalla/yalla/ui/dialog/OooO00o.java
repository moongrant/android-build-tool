...
public final class OooO00o extends o0000oo<RoomGameBoxDialog.GameType> {

    /* JADX INFO: renamed from: OooOoo0, reason: collision with root package name */
    public final /* synthetic */ RoomGameBoxDialog f27385OooOoo0;
    ...
    public OooO00o(RoomGameBoxDialog roomGameBoxDialog, MixedRoomActivity mixedRoomActivity, int i) {
        ...
        this.f27385OooOoo0 = roomGameBoxDialog;
    }
    ...
    public final void OooO0oO(BaseViewHolder baseViewHolder, Object obj) {
        ...
        int i2 = o0OO00O.ivGameDetail;
        View view = viewHolder.getView(i2);
        Intrinsics.checkNotNullExpressionValue(view, "getView(...)");
        o000O.OooOOOO(view);
        int i3 = o0OO00O.vMoraPoint;
        viewHolder.setGone(i3, false);
        int i4 = o0OO00O.tvLuckyNumberSettings;
        viewHolder.setGone(i4, false);
        int i5 = o0OO00O.tvLuckyNumberCost;
        viewHolder.setGone(i5, false);
        int i6 = o0OO00O.ivLimit;
        ...
        switch (C0330OooO00o.$EnumSwitchMapping$0[gameType.ordinal()]) {
            case 1:
                ...
                ((ImageView) viewHolder.getView(i2)).setImageResource(o0Oo0oo.ic_room_game_box_mora);
                viewHolder.setText(o0OO00O.tvGameDescribe, o0000.OooO0OO(o000000.mora));
                break;
            case 2:
                ((ImageView) viewHolder.getView(i2)).setImageResource(o0Oo0oo.ic_room_game_box_lucky_golds);
                viewHolder.setGone(i6, true);
                ((ImageView) viewHolder.getView(i6)).setImageResource(o0Oo0oo.ic_gift_tag_vip);
                viewHolder.setText(o0OO00O.tvGameDescribe, o0000.OooO0OO(o000000.Lucky_Bag));
                break;
            case 3:
                ((ImageView) viewHolder.getView(i2)).setImageResource(o0Oo0oo.ic_room_game_box_turntable);
                viewHolder.setText(o0OO00O.tvGameDescribe, o0000.OooO0OO(o000000.room_game_box_lucky_wheel));
                break;
            case 4:
                ((ImageView) viewHolder.getView(i2)).setImageResource(o0Oo0oo.ic_room_game_box_vote);
                viewHolder.setText(o0OO00O.tvGameDescribe, o0000.OooO0OO(o000000.room_vote_game_page_title));
                break;
            case 5:
                ImageView imageView = (ImageView) viewHolder.getView(i2);
                RoomGameBoxDialog roomGameBoxDialog = this.f27385OooOoo0;
                int i7 = roomGameBoxDialog.f27461OooOO0O;
                if (i7 == 1) {
                    i = o0Oo0oo.ic_room_game_box_lucky_number_9;
                } else if (i7 != 2) {
                    i = i7 != 3 ? o0Oo0oo.ic_room_game_box_lucky_number_9 : o0Oo0oo.ic_room_game_box_lucky_number_999;
                } else {
                    i = o0Oo0oo.ic_room_game_box_lucky_number_99;
                }
                imageView.setImageResource(i);
                viewHolder.setGone(i5, roomGameBoxDialog.f27460OooOO0);
                TextView textView = (TextView) viewHolder.getView(i5);
                Intrinsics.checkNotNull(textView);
                int i8 = roomGameBoxDialog.f27462OooOO0o;
                textView.setVisibility(0);
                MixedRoomActivity mixedRoomActivity = roomGameBoxDialog.f27458OooO0oO;
                if (i8 == 0) {
                    textView.setText(mixedRoomActivity.getString(o000000.Free_lucky_number));
                    int i9 = o0OOO0o.color_CCCCCC;
                    ...
                    int i10 = o0OOO0o.color_ffe024;
                    Object obj3 = ContextCompat.f5281OooO00o;
                    textView.setTextColor(ContextCompat.OooO0o.OooO00o(mixedRoomActivity, i10));
                    Drawable drawableOooO0O0 = ContextCompat.OooO0OO.OooO0O0(mixedRoomActivity, o0Oo0oo.coin_little);
                ...
                int i11 = o0OO00O.tvGameDescribe;
                ...
                viewHolder.setText(i11, o0000.OooO0OO(o000000.Lucky_Number_GameName));
                ...
                if (value != null && value.intValue() == 1) {
                    boolean z = roomGameBoxDialog.f27460OooOO0;
                    ...
                    boolean z2 = roomGameBoxDialog.f27464OooOOO0;
                    Intrinsics.checkNotNull(textView3);
                    if (z2) {
                        o000O.OooOOOO(textView3);
                    } else {
                ...
                break;
            case 6:
                ((ImageView) viewHolder.getView(i2)).setImageResource(o0Oo0oo.ic_room_game_box_camel);
                viewHolder.setText(o0OO00O.tvGameDescribe, o0000.OooO0OO(o000000.Camel_racing));
                break;
        }
    }
}
