...
import p405o0Oo0OOO.q;
import p442o0OoOo0O.o000OO;
import p448o0OoOoo.o00oOoo;
...
public final class RoomGameBoxDialog extends o0000OO0<RoomGameBoxDialog> {
    ...
    @NotNull
    public final Lazy f27457OooO;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    @NotNull
    public final MixedRoomActivity f27458OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    @Nullable
    public final o000OO f27459OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public boolean f27460OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public int f27461OooOO0O;

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    public int f27462OooOO0o;

    /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
    @NotNull
    public final List<GameType> f27463OooOOO;

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    public boolean f27464OooOOO0;

    /* JADX INFO: renamed from: OooOOOO, reason: collision with root package name */
    public long f27465OooOOOO;
    ...
    public static final class OooO0O0 extends Lambda implements Function0<com.yalla.yalla.ui.dialog.OooO00o> {
        ...
        public final com.yalla.yalla.ui.dialog.OooO00o invoke() {
            ...
            return new com.yalla.yalla.ui.dialog.OooO00o(roomGameBoxDialog, roomGameBoxDialog.f27458OooO0oO, oo0o0Oo.room_item_game_box_dialog);
        }
    }
    ...
    public static final class OooO0OO implements Observer, FunctionAdapter {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function1 f27467OooO0Oo;

        public OooO0OO(Function1 function) {
            Intrinsics.checkNotNullParameter(function, "function");
            this.f27467OooO0Oo = function;
        }
        ...
        public final boolean equals(@Nullable Object obj) {
            ...
            return Intrinsics.areEqual(this.f27467OooO0Oo, ((FunctionAdapter) obj).getFunctionDelegate());
        }

        @Override // kotlin.jvm.internal.FunctionAdapter
        @NotNull
        public final Function<?> getFunctionDelegate() {
            return this.f27467OooO0Oo;
        }

        public final int hashCode() {
            return this.f27467OooO0Oo.hashCode();
        }

        @Override // androidx.lifecycle.Observer
        public final /* synthetic */ void onChanged(Object obj) {
            this.f27467OooO0Oo.invoke(obj);
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public RoomGameBoxDialog(@NotNull MixedRoomActivity mActivity, @Nullable o000OO o000oo2) {
        Integer value;
        super(mActivity);
        Intrinsics.checkNotNullParameter(mActivity, "mActivity");
        this.f27458OooO0oO = mActivity;
        this.f27459OooO0oo = o000oo2;
        int i = 1;
        q qVarInflate = q.inflate(LayoutInflater.from(mActivity), this.f38489OooO0OO, true);
        Intrinsics.checkNotNullExpressionValue(qVarInflate, "inflate(...)");
        Lazy lazy = LazyKt.lazy(new OooO0O0());
        this.f27457OooO = lazy;
        this.f27461OooOO0O = 1;
        ...
        if (Intrinsics.areEqual(oooO00o.OooO00o().f24555OooOo0.getValue(), Boolean.FALSE)) {
            listMutableListOf.remove(gameType);
        }
        Integer num = (Integer) ((MutableLiveData) oooO00o.OooO00o().f24567Oooo0.getValue()).getValue();
        if (num == null || num.intValue() != 1 || (value = oooO00o.OooO00o().f24546OooOO0o.getValue()) == null || value.intValue() != 1) {
            listMutableListOf.remove(gameType2);
        }
        if (!oooO00o.OooO00o().OooOOO() && !oooO00o.OooO00o().OooOO0o()) {
            listMutableListOf.remove(gameType3);
        }
        if (!Intrinsics.areEqual(oooO00o.OooO00o().f24579OoooO00.getValue(), Boolean.TRUE)) {
            listMutableListOf.remove(gameType4);
        }
        this.f27463OooOOO = listMutableListOf;
        OooO0oo();
        int i2 = o000000O.anim_bottom_top_bottom;
        ...
        qVarInflate.f45398OooO0O0.addItemDecoration(new o0OOO0o(o0000O0.OooO00o(3)));
        FixGridLayoutManager fixGridLayoutManager = new FixGridLayoutManager(this.f38487OooO00o, listMutableListOf.size() < 4 ? listMutableListOf.size() : 4);
        FixedRecyclerView fixedRecyclerView = qVarInflate.f45398OooO0O0;
        fixedRecyclerView.setLayoutManager(fixGridLayoutManager);
        fixedRecyclerView.setAdapter((o0000oo) lazy.getValue());
        ((o0000oo) lazy.getValue()).f13176OooO0o = new o0O00O0o(this);
        oooO00o.OooO00o().f24555OooOo0.observe(mActivity, new OooO0OO(new com.yalla.yalla.ui.dialog.OooO0OO(this)));
        ((MutableLiveData) oooO00o.OooO00o().f24567Oooo0.getValue()).observe(mActivity, new OooO0OO(new OooO0o(this)));
        ...
        oooO00o.OooO00o().f24579OoooO00.observe(mActivity, new OooO0OO(new OooOOO(this)));
    ...
    public final void OooOOO0(boolean z, GameType gameType) {
        List<GameType> list = this.f27463OooOOO;
        if (z) {
        ...
        ((o0000oo) this.f27457OooO.getValue()).OooOoO0(list);
    }
}
