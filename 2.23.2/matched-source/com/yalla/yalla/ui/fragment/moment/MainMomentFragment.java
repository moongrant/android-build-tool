...
import p405o0Oo0OOO.o0O;
import p423o0OoO0OO.o00;
import p423o0OoO0OO.o0O0ooO;
import p471o0OoooO0.o0O000O;
...
public final class MainMomentFragment extends o000O<o0O> {
    ...
    public static final class OooO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ MomentListFeaturedFragment f28088OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MainMomentFollowingFragment f28089OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ MainMomentTopicFragment f28090OooO0oO;
        ...
        public OooO(MainMomentFollowingFragment mainMomentFollowingFragment, MomentListFeaturedFragment momentListFeaturedFragment, MainMomentTopicFragment mainMomentTopicFragment) {
            super(2);
            this.f28089OooO0o0 = mainMomentFollowingFragment;
            this.f28088OooO0o = momentListFeaturedFragment;
            this.f28090OooO0oO = mainMomentTopicFragment;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            ...
            if ((iIntValue & 11) == 2 && composer2.getSkipping()) {
                ...
                mainMomentFragment.TabItem(rowScopeInstance, StringResources_androidKt.stringResource(p562o0oOo000.o000000.moments_following, composer2, 0), mainMomentFragment.getCurrentSelectTab() == 0, new o0OoOo0(mainMomentFragment, this.f28089OooO0o0), composer2, 32774, 0);
                mainMomentFragment.TabItem(rowScopeInstance, StringResources_androidKt.stringResource(p562o0oOo000.o000000.Featured, composer2, 0), mainMomentFragment.getCurrentSelectTab() == 1, new o00O0O(mainMomentFragment, this.f28088OooO0o), composer2, 32774, 0);
                mainMomentFragment.TabItem(rowScopeInstance, StringResources_androidKt.stringResource(p562o0oOo000.o000000.Topics, composer2, 0), mainMomentFragment.getCurrentSelectTab() == 2, new o00Oo0(mainMomentFragment, this.f28090OooO0oO), composer2, 32774, 0);
    ...
    public static final class OooO00o extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function0<Unit> f28091OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(Function0<Unit> function0) {
            super(0);
            this.f28091OooO0Oo = function0;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            this.f28091OooO0Oo.invoke();
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0O0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ int f28092OooO;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ String f28094OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ RowScope f28095OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ boolean f28096OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ Function0<Unit> f28097OooO0oo;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public final /* synthetic */ int f28098OooOO0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(RowScope rowScope, String str, boolean z, Function0<Unit> function0, int i, int i2) {
            super(2);
            this.f28095OooO0o0 = rowScope;
            this.f28094OooO0o = str;
            this.f28096OooO0oO = z;
            this.f28097OooO0oo = function0;
            this.f28092OooO = i;
            this.f28098OooOO0 = i2;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            MainMomentFragment.this.TabItem(this.f28095OooO0o0, this.f28094OooO0o, this.f28096OooO0oO, this.f28097OooO0oo, composer, RecomposeScopeImplKt.updateChangedFlags(this.f28092OooO | 1), this.f28098OooOO0);
            return Unit.INSTANCE;
        }
    }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            ...
            if ((iIntValue & 11) == 2 && composer2.getSkipping()) {
                ...
                if (activity != null && !activity.isFinishing() && !activity.isDestroyed()) {
                    ...
                    androidx.compose.animation.OooOO0.OooO00o(0, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer2)), composer2, 2058660585);
                    o0O0o000.f52369OooO00o.OooO00o(PaddingKt.m482paddingqDBjuR0$default(BoxScopeInstance.INSTANCE.align(companion, companion2.getBottomEnd()), 0.0f, 0.0f, Dp.m3775constructorimpl(6), Dp.m3775constructorimpl(38), 3, null), new o000oOoO(activity), composer2, 384, 0);
    ...
    public static final class OooOO0O extends Lambda implements Function1<View, Unit> {
        ...
        public final Unit invoke(View view) {
            ...
            o0oo0000.OooO00o.OooO0O0("103021");
    ...
    public static final class OooOOO implements Observer, FunctionAdapter {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function1 f28102OooO0Oo;

        public OooOOO(Function1 function) {
            Intrinsics.checkNotNullParameter(function, "function");
            this.f28102OooO0Oo = function;
        }
        ...
        public final boolean equals(@Nullable Object obj) {
            ...
            return Intrinsics.areEqual(this.f28102OooO0Oo, ((FunctionAdapter) obj).getFunctionDelegate());
        }

        @Override // kotlin.jvm.internal.FunctionAdapter
        @NotNull
        public final Function<?> getFunctionDelegate() {
            return this.f28102OooO0Oo;
        }

        public final int hashCode() {
            return this.f28102OooO0Oo.hashCode();
        }

        @Override // androidx.lifecycle.Observer
        public final /* synthetic */ void onChanged(Object obj) {
            this.f28102OooO0Oo.invoke(obj);
        }
    }
    ...
    public static final class OooOOO0 extends Lambda implements Function1<Integer, Unit> {
        ...
        public final Unit invoke(Integer num) {
            int i;
            Integer num2 = num;
            LinearLayout linearLayout = MainMomentFragment.this.getBinding().f44386OooO0Oo;
            z0 z0Var = z0.f57313OooO00o;
            Intrinsics.checkNotNull(num2);
            int iIntValue = num2.intValue();
            MutableLiveData<Integer> mutableLiveData = p429o0OoOO.OooOo00.f46776OooO00o;
            int i2 = z0.OooO0O0.$EnumSwitchMapping$0[p429o0OoOO.OooOo00.OooO00o(Integer.valueOf(iIntValue)).ordinal()];
            if (i2 == 1) {
                i = p562o0oOo000.o0O0O00.ic_moment_top_notice_bg;
            } else if (i2 == 2) {
                i = p562o0oOo000.o0O0O00.ic_moment_top_notice_bg_seven_ramdan;
            } else {
                if (i2 != 3) {
                    throw new NoWhenBranchMatchedException();
                }
                i = p562o0oOo000.o0O0O00.ic_moment_top_notice_bg_seven_year;
            }
    ...
    public static final class OooOOOO extends Lambda implements Function1<ApiResult<Object>, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooOOOO f28104OooO0Oo = new OooOOOO();
    ...
    public MainMomentFragment() {
        ...
        this.vm = androidx.fragment.app.o000Oo0.OooO0O0(this, Reflection.getOrCreateKotlinClass(BaseMomentDetailVM.class), new Function0<ViewModelStore>() { // from class: com.yalla.yalla.ui.fragment.moment.MainMomentFragment$special$$inlined$viewModels$default$3
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ Function0 f28108OooO0Oo = null;
            ...
            public final CreationExtras invoke() {
                ...
                Function0 function0 = this.f28108OooO0Oo;
    ...
    public final void changeCreateImageButtonState() {
        ...
        if (!Intrinsics.areEqual(value, bool) && getBinding().f44387OooO0o.getCurrentItem() == 2) {
            if (this.topicState == null && Intrinsics.areEqual(o0O00oO0.OooOo0O().getValue(), bool)) {
    ...
    private final void checkTopicState(final boolean isClick) {
        ...
        getVm().checkTopicState().observe(getViewLifecycleOwner(), new Observer() { // from class: o0o0OOO.o000O0O0
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                MainMomentFragment.checkTopicState$lambda$2(this.f53350OooO0Oo, isClick, (Response) obj);
            }
        });
    }
    ...
    public static final void checkTopicState$lambda$2(MainMomentFragment this$0, boolean z, Response response) {
        ...
        if (topicCreateCheckModel != null) {
            ...
            if (z && (context = this$0.getContext()) != null) {
                ...
                if (i == 1) {
                    int i2 = TopicCreateCheckActivity.f25844OooOo0;
                ...
                if (i == 2) {
                    int i3 = TopicReviewActivity.f25945OooOo00;
                    Intrinsics.checkNotNull(context);
                ...
                String strOooO0OO = com.code.android.util.o0000.OooO0OO(p562o0oOo000.o000000.topic_exist);
    ...
    private final void initObserver() {
        ...
        int i = 1;
        unreadMomentsMessageCount.observe(getViewLifecycleOwner(), new o0O000O(i, this));
        int i2 = 2;
        LiveEventBus.get("MESSAGE_TOPIC_STATE_CHANGE").observe(this, new o0OoOoOo(i2, this));
        LiveEventBus.get("TOPIC_CREATE_CHECK").observe(this, new o00(this, i2));
        LiveEventBus.get("TOPIC_CREATE_CHECK_CLICK", Boolean.TYPE).observe(this, new o0O0ooO(this, i));
        LiveEventBus.get("OPEN_MAIN_ACTIVITY_PAGE", Integer.TYPE).observeSticky(this, new Observer() { // from class: o0o0OOO.o000O
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                MainMomentFragment.initObserver$lambda$11(this.f53345OooO0Oo, (Integer) obj);
            }
        });
    }
    ...
    public static final void initObserver$lambda$11(MainMomentFragment this$0, Integer num) {
        ...
        if (iIntValue == MainPage.MomentFollowingPage.getValue()) {
            this$0.getBinding().f44387OooO0o.setCurrentItem(0);
        } else if (iIntValue == MainPage.MomentFeaturedPage.getValue()) {
            this$0.getBinding().f44387OooO0o.setCurrentItem(1);
        } else if (iIntValue == MainPage.MomentTopicsPage.getValue()) {
            this$0.getBinding().f44387OooO0o.setCurrentItem(2);
        }
        this$0.setCurrentSelectTab(this$0.getBinding().f44387OooO0o.getCurrentItem());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void initObserver$lambda$7(MainMomentFragment this$0, Integer num) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        TextView textView = this$0.getBinding().f44388OooO0o0;
        String strOooO0OO = com.code.android.util.o0000.OooO0OO(p562o0oOo000.o000000.moment_notice_XXX);
        boolean z = true;
        ...
        LinearLayout llMainMomentNotice = this$0.getBinding().f44386OooO0Oo;
        Intrinsics.checkNotNullExpressionValue(llMainMomentNotice, "llMainMomentNotice");
        if (num != null && num.intValue() == 0) {
            z = false;
        }
        com.code.android.util.o000O.OooOOO0(llMainMomentNotice, z);
    }
    ...
    private final void initView() {
        ...
        ComposeView composeMomentCreate = getBinding().f44384OooO0O0;
        ...
        ComposeView composeView = getBinding().f44385OooO0OO;
        ...
        getBinding().f44387OooO0o.setAdapter(new oO0o0000(childFragmentManager, listMutableListOf));
        getBinding().f44387OooO0o.setOffscreenPageLimit(listMutableListOf.size() - 1);
        getBinding().f44387OooO0o.OooO0O0(new OooOO0());
        LinearLayout llMainMomentNotice = getBinding().f44386OooO0Oo;
        Intrinsics.checkNotNullExpressionValue(llMainMomentNotice, "llMainMomentNotice");
        com.code.android.util.o000O.OooO(llMainMomentNotice, new OooOO0O());
        p477o0o00.OooO0o oooO0oOooO00o = o0O0oo0o.OooO00o();
        oooO0oOooO00o.getClass();
        o0O00oO0 o0o00oo1 = o0O00oO0.f47936OooO00o;
        if (oooO0oOooO00o.OooO0O0("FIRST_FEATURED_MOMENT_FOR_NEW_USER".concat(String.valueOf(o0O00oO0.OooOOo0().getValue())), true)) {
            getBinding().f44387OooO0o.setCurrentItem(1);
            p477o0o00.OooO0o oooO0oOooO00o2 = o0O0oo0o.OooO00o();
            oooO0oOooO00o2.getClass();
            oooO0oOooO00o2.OooO0o("FIRST_FEATURED_MOMENT_FOR_NEW_USER".concat(String.valueOf(o0O00oO0.OooOOo0().getValue())), false);
            return;
        }
        p477o0o00.OooO0o oooO0oOooO00o3 = o0O0oo0o.OooO00o();
        oooO0oOooO00o3.getClass();
        if (oooO0oOooO00o3.OooO0O0("FIRST_RECOMMEND_TOPIC".concat(String.valueOf(o0O00oO0.OooOOo0().getValue())), true)) {
            getBinding().f44387OooO0o.setCurrentItem(2);
        } else {
            int lastLeaveMomentPage = getVm().getLastLeaveMomentPage();
            if (lastLeaveMomentPage == 0) {
                getBinding().f44387OooO0o.setCurrentItem(0);
        ...
        setCurrentSelectTab(getBinding().f44387OooO0o.getCurrentItem());
    }
    ...
    private final void uploadMomentStatisticalTime() {
        ...
        getVm().momentsDurationAdd(sharedPreferences != null ? sharedPreferences.getLong("MOMENT_STATISTICAL_TIME", 0L) : 0L).observe(getViewLifecycleOwner(), new OooOOO(OooOOOO.f28104OooO0Oo));
    }
    ...
    public void onViewCreated(@NotNull View view, @Nullable Bundle savedInstanceState) {
        ...
        MutableLiveData<Integer> mutableLiveData = p429o0OoOO.OooOo00.f46776OooO00o;
        p429o0OoOO.OooOo00.f46776OooO00o.observe(getViewLifecycleOwner(), new OooOOO(new OooOOO0()));
    }
