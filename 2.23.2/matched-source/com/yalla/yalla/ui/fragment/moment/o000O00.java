...
public final class o000O00 extends Lambda implements Function3<LazyItemScope, Composer, Integer, Unit> {
    ...
    public final /* synthetic */ MomentFeaturedVM f28323OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ MutableState<Dp> f28324OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o000O00(MomentFeaturedVM momentFeaturedVM, MutableState<Dp> mutableState) {
        super(3);
        this.f28323OooO0Oo = momentFeaturedVM;
        this.f28324OooO0o0 = mutableState;
    }
    ...
    public final Unit invoke(LazyItemScope lazyItemScope, Composer composer, Integer num) {
        ...
        if ((iIntValue & 81) == 16 && composer2.getSkipping()) {
            ...
            MomentBannerModel value = this.f28323OooO0Oo.getBannerModel().getValue();
            if (value != null && (bannerList = value.getBannerList()) != null) {
                z = bannerList.isEmpty();
            }
            MutableState<Dp> mutableState = this.f28324OooO0o0;
            oOO00O.OooO00o(com.code.android.util.o0000.OooO0OO(p562o0oOo000.o000000.moments_none), p562o0oOo000.o0Oo0oo.ic_empty_fans, 0.0f, null, null, false, SizeKt.m511height3ABfNKs(Modifier.INSTANCE, z ? mutableState.getValue().m3789unboximpl() : Dp.m3775constructorimpl(mutableState.getValue().m3789unboximpl() - Dp.m3775constructorimpl(68))), null, null, composer2, 196608, FacebookRequestErrorClassification.EC_APP_NOT_INSTALLED);
            if (ComposerKt.isTraceInProgress()) {
