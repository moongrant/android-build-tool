...
public final class LanguageView extends TextView {
    ...
    public final void setLanguage(int region) {
        int i;
        this.f29935OooO0Oo = region;
        if (!this.translation) {
            switch (region) {
                case 0:
                    i = o000000.single_language_English;
                    break;
                case 1:
                    i = o000000.single_language_Arabic;
                    break;
                case 2:
                    i = o000000.single_language_Turkish;
                    break;
                case 3:
                    i = o000000.single_language_Indonesia;
                    break;
                case 4:
                    i = o000000.single_language_Japanese;
                    break;
                case 5:
                    i = o000000.single_language_Portugal;
                    break;
                case 6:
                    i = o000000.single_language_Espana;
                    break;
                case 7:
                    i = o000000.single_language_Hindi;
                    break;
                case 8:
                    i = o000000.single_language_Urdu;
                    break;
                default:
                    i = -1;
                    break;
    ...
    public final void setTranslation(boolean z) {
        if (this.translation != z) {
            this.translation = z;
            setLanguage(this.f29935OooO0Oo);
        }
    }
