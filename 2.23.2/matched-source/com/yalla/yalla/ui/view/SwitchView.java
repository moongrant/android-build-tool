...
public final class SwitchView extends ConstraintLayout {
    ...
    public static final /* synthetic */ int f30187OooOo0 = 0;
    ...
    @NotNull
    public List<String> f30191OooO0o0;
    ...
    public float f30199OooOOOO;

    /* JADX INFO: renamed from: OooOOOo, reason: collision with root package name */
    public float f30200OooOOOo;

    /* JADX INFO: renamed from: OooOOo, reason: collision with root package name */
    public float f30201OooOOo;

    /* JADX INFO: renamed from: OooOOo0, reason: collision with root package name */
    public float f30202OooOOo0;

    /* JADX INFO: renamed from: OooOOoo, reason: collision with root package name */
    public float f30203OooOOoo;

    /* JADX INFO: renamed from: OooOo00, reason: collision with root package name */
    public float f30204OooOo00;

    @StabilityInferred(parameters = 0)
    public static final class OooO00o {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final int f30205OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        @NotNull
        public final ImageView f30206OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        @NotNull
        public final TextView f30207OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public boolean f30208OooO0Oo;
        ...
        public OooO00o(int i, @NotNull ConstraintLayout layout, @NotNull ImageView image, @NotNull TextView content) {
            ...
            this.f30205OooO00o = i;
            this.f30206OooO0O0 = image;
            this.f30207OooO0OO = content;
            this.f30208OooO0Oo = false;
        }
    }
    ...
    public static final class OooO0O0 extends Lambda implements Function0<OooO0o> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Context f30209OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ SwitchView f30210OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(Context context, SwitchView switchView) {
            super(0);
            this.f30209OooO0Oo = context;
            this.f30210OooO0o0 = switchView;
        }

        @Override // kotlin.jvm.functions.Function0
        public final OooO0o invoke() {
            return new OooO0o(this.f30209OooO0Oo, this.f30210OooO0o0, oo0o0Oo.switch_view_item);
        }
    }
    ...
    public static void OooO0Oo(SwitchView switchView, ArrayList titles) {
        ...
        switchView.f30191OooO0o0 = titles;
        switchView.getAdapter().OooOoO0(titles);
        switchView.f30189OooO0Oo.f43978OooO0OO.post(new OooOo00(switchView, 0, 1));
    }
    ...
    public SwitchView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        j1 j1VarInflate = j1.inflate(LayoutInflater.from(context), this, true);
        Intrinsics.checkNotNullExpressionValue(j1VarInflate, "inflate(...)");
        this.f30189OooO0Oo = j1VarInflate;
        new ArrayList();
        this.resIdBg = o0Oo0oo.bg_tr00_r360;
        this.resIdBgSelect = o0Oo0oo.bg_green_r360;
        this.textColor = o0OOO0o.color_333333_65;
        this.textColorSelect = o0OOO0o.color_333333;
        this.itemTextHeight = 24;
        this.adapter = LazyKt.lazy(new OooO0O0(context, this));
        j1VarInflate.f43978OooO0OO.setLayoutManager(new FixLinearLayoutManager(context, 0));
        j1VarInflate.f43978OooO0OO.setAdapter(getAdapter());
        getAdapter().f13176OooO0o = new o000(this);
        this.f30199OooOOOO = -1.0f;
        this.f30200OooOOOo = -1.0f;
        this.f30202OooOOo0 = -1.0f;
        this.f30201OooOOo = -1.0f;
        this.f30203OooOOoo = -1.0f;
        this.f30204OooOo00 = -1.0f;
    }
}
