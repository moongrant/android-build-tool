...
@Metadata(d1 = {"\u0000B\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u000b\b\u0007\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u001c\u0010\u001dJ\u0012\u0010\u0005\u001a\u00020\u00042\n\b\u0002\u0010\u0003\u001a\u0004\u0018\u00010\u0002J\"\u0010\f\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u000b0\n0\t2\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\b\u001a\u00020\u0006J\"\u0010\r\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\b\u001a\u00020\u00062\n\b\u0002\u0010\u0003\u001a\u0004\u0018\u00010\u0002J\u000e\u0010\u0010\u001a\u00020\u00042\u0006\u0010\u000f\u001a\u00020\u000eJ\u001c\u0010\u0014\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00130\n0\t2\b\b\u0002\u0010\u0012\u001a\u00020\u0011R$\u0010\u0016\u001a\u00020\u000e2\u0006\u0010\u0015\u001a\u00020\u000e8\u0006@BX\u0086\u000e¢\u0006\f\n\u0004\b\u0016\u0010\u0017\u001a\u0004\b\u0018\u0010\u0019R\u0018\u0010\u001a\u001a\u0004\u0018\u00010\u00028\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u001a\u0010\u001b¨\u0006\u001e"}, d2 = {"Lcom/yalla/yalla/ui/vm/account/PhNumberVM;", "Lo0Oo0/OooOO0;", "Lcom/yalla/yalla/data/constant/ClientCodeType;", "type", "", "initPhoneAreaCodeInfo", "", "phone", RemoteConfigConstants$RequestFieldKey.COUNTRY_CODE, "Landroidx/lifecycle/LiveData;", "Lcom/yalla/yalla/model/http/ApiResult;", "", "checkPhoneRegister", "savePhoneInfo", "Lcom/yalla/yalla/model/user/CountryItemData;", "data", "saveCountryData", "", "source", "Lcom/yalla/yalla/model/user/CountryItemList;", "getCountry", "<set-?>", "phoneAreaCodeInfo", "Lcom/yalla/yalla/model/user/CountryItemData;", "getPhoneAreaCodeInfo", "()Lcom/yalla/yalla/model/user/CountryItemData;", "currentType", "Lcom/yalla/yalla/data/constant/ClientCodeType;", "<init>", "()V", "Common_YallaRelease"}, k = 1, mv = {1, 9, 0})
public final class PhNumberVM extends OooOO0 {
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<LiveDataScope<ApiResult<Boolean>>, Continuation<? super Unit>, Object> {
        ...
        public int f31145OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f31147OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ String f31148OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ String f31149OooO0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(String str, String str2, Continuation<? super OooO0O0> continuation) {
            super(2, continuation);
            this.f31148OooO0oO = str;
            this.f31149OooO0oo = str2;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0O0 oooO0O0 = PhNumberVM.this.new OooO0O0(this.f31148OooO0oO, this.f31149OooO0oo, continuation);
            oooO0O0.f31147OooO0o0 = obj;
            return oooO0O0;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f31145OooO0Oo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f31147OooO0o0;
            ...
            String str = this.f31148OooO0oO;
            String str2 = this.f31149OooO0oo;
            String isoCode = phNumberVM.getPhoneAreaCodeInfo().getIsoCode();
            this.f31147OooO0o0 = liveDataScope;
            this.f31145OooO0Oo = 1;
            obj = o00o0oo2.OooO00o(str, str2, isoCode, source, this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f31147OooO0o0 = null;
            this.f31145OooO0Oo = 2;
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<LiveDataScope<ApiResult<CountryItemList>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31150OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f31151OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f31152OooO0o0;
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0OO oooO0OO = new OooO0OO(this.f31151OooO0o, continuation);
            oooO0OO.f31152OooO0o0 = obj;
            return oooO0OO;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            LiveDataScope liveDataScope;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31150OooO0Oo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f31152OooO0o0;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            ResultKt.throwOnFailure(obj);
            liveDataScope = (LiveDataScope) this.f31152OooO0o0;
            this.f31152OooO0o0 = liveDataScope;
            this.f31150OooO0Oo = 1;
            String str = Oooo0.f43425o0000oo;
            o0ooOOo o0oooooOooO00o = oo000o.OooO00o(str, "url", str, 0);
            o0oooooOooO00o.OooO0O0(Boxing.boxInt(this.f31151OooO0o), "source");
            obj = OooOOO.OooO0Oo(new LoginRepo$getCountry$$inlined$call$1(o0oooooOooO00o, null), this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f31152OooO0o0 = null;
            this.f31150OooO0Oo = 2;
            if (liveDataScope.emit((ApiResult) obj, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
    ...
    public PhNumberVM() {
        CountryItemData countryItemDataOooO0O0 = oOO0O0O0.OooO0O0(new oOO0O0O0());
        countryItemDataOooO0O0.setIcon(OooOo00.OooO00o(String.valueOf(countryItemDataOooO0O0.getId())));
    ...
    public final void initPhoneAreaCodeInfo(@Nullable ClientCodeType type) {
        ...
        if (i == 1 || i == 2) {
            ...
            iOooO0OO = o00Ooo.OooO00o().OooO0OO("loginCountryId", 0);
        }
        CountryItemData countryItemDataOooO00o = new oOO0O0O0().OooO00o(iOooO0OO, type == ClientCodeType.Register || type == ClientCodeType.BingingPhone);
        countryItemDataOooO00o.setIcon(OooOo00.OooO00o(String.valueOf(countryItemDataOooO00o.getId())));
    ...
    public final void savePhoneInfo(@NotNull String phone, @NotNull String countryCode, @Nullable ClientCodeType type) {
        ...
        if (type == ClientCodeType.Register) {
            o00Ooo.OooO00o().OooO0oO(this.phoneAreaCodeInfo.getId(), "signCountryId");
            oO000O0 oo000o0OooO00o = o00Ooo.OooO00o();
            oo000o0OooO00o.getClass();
            Intrinsics.checkNotNullParameter(value, "value");
            oo000o0OooO00o.OooO("signInNumber", value);
            return;
        }
        o00Ooo.OooO00o().OooO0oO(this.phoneAreaCodeInfo.getId(), "loginCountryId");
        oO000O0 oo000o0OooO00o2 = o00Ooo.OooO00o();
        oo000o0OooO00o2.getClass();
        Intrinsics.checkNotNullParameter(value, "value");
        oo000o0OooO00o2.OooO("loginPhoneNumber", value);
    }
}
