...
public final class MainRoomVM extends p394o0Oo0.OooOO0 {
    ...
    @NotNull
    private MutableState<Boolean> dialogShowBindYallaChatTips;

    @NotNull
    private MutableState<Boolean> dialogShowCheckInTask;

    @NotNull
    private MutableState<Boolean> dialogShowOfficialAction;

    @NotNull
    private MutableState<Boolean> dialogShowUserReturn;

    @NotNull
    private MutableState<Boolean> dialogShowWelcome;
    ...
    public static final class OooO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                ...
                o00O o00o2 = o00O.f46051OooO00o;
                this.f31232OooO0Oo = 1;
                o00o2.getClass();
            ...
            if (checkSignInModel != null && checkSignInModel.getState() == 0) {
                ...
                if (!mainRoomVM.getDialogShowWelcome().getValue().booleanValue() && !mainRoomVM.getDialogShowUserReturn().getValue().booleanValue() && !mainRoomVM.getDialogShowOfficialAction().getValue().booleanValue()) {
                    Intrinsics.checkNotNull(str);
                    mainRoomVM.dialogCheckInTaskForToDay = str;
                    mainRoomVM.getDialogShowCheckInTask().setValue(Boxing.boxBoolean(true));
                }
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31234OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ MainRoomVM f31235OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ Function1<Boolean, Unit> f31236OooO0o0;
        ...
        public OooO00o(Function1<? super Boolean, Unit> function1, MainRoomVM mainRoomVM, Continuation<? super OooO00o> continuation) {
            super(2, continuation);
            this.f31236OooO0o0 = function1;
            this.f31235OooO0o = mainRoomVM;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO00o(this.f31236OooO0o0, this.f31235OooO0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31234OooO0Oo;
            MainRoomVM mainRoomVM = this.f31235OooO0o;
            Function1<Boolean, Unit> function1 = this.f31236OooO0o0;
            if (i != 0) {
                if (i == 1) {
                    ResultKt.throwOnFailure(obj);
                } else {
                ...
                if (apiResult.isSuccess() && (officialActionModel2 = (OfficialActionModel) apiResult.getData()) != null) {
                    ...
                    if (officialActionModel2.getDefaultIsShowDialog()) {
                        ...
                        mainRoomVM.getDialogShowOfficialAction().setValue(Boxing.boxBoolean(true));
                        if (function1 != null) {
            ...
            if (apiResult2.isSuccess() && (officialActionModel = (OfficialActionModel) apiResult2.getData()) != null) {
                ...
                if (officialActionModel.getDefaultIsShowDialog()) {
                    ...
                    mainRoomVM.getDialogShowUserReturn().setValue(Boxing.boxBoolean(true));
                    if (function1 != null) {
                        function1.invoke(Boxing.boxBoolean(true));
                    }
                    return Unit.INSTANCE;
            ...
            o00O o00o3 = o00O.f46051OooO00o;
            this.f31234OooO0Oo = 2;
            o00o3.getClass();
    ...
    public static final class OooO0OO extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MainDialogManager$Link f31239OooO0o0;
        ...
        public OooO0OO(MainDialogManager$Link mainDialogManager$Link) {
            super(0);
            this.f31239OooO0o0 = mainDialogManager$Link;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            MainRoomVM mainRoomVM = MainRoomVM.this;
            MainDialogManager$Link mainDialogManager$Link = this.f31239OooO0o0;
    ...
    public static final class OooO0o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ Ref.BooleanRef f31241OooO0o;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ Function0<Unit> f31243OooO0oO;

        @DebugMetadata(c = "com.yalla.yalla.ui.vm.main.MainRoomVM$loadBindMoreAccount$1$1", f = "MainRoomVM.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
        public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {

            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ Ref.BooleanRef f31244OooO0Oo;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public final /* synthetic */ Function0<Unit> f31245OooO0o0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public OooO00o(Ref.BooleanRef booleanRef, Function0<Unit> function0, Continuation<? super OooO00o> continuation) {
                super(2, continuation);
                this.f31244OooO0Oo = booleanRef;
                this.f31245OooO0o0 = function0;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                return new OooO00o(this.f31244OooO0Oo, this.f31245OooO0o0, continuation);
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                ResultKt.throwOnFailure(obj);
                if (this.f31244OooO0Oo.element && (function0 = this.f31245OooO0o0) != null) {
                    function0.invoke();
                }
                return Unit.INSTANCE;
            }
        ...
        public OooO0o(Ref.BooleanRef booleanRef, Function0<Unit> function0, Continuation<? super OooO0o> continuation) {
            super(2, continuation);
            this.f31241OooO0o = booleanRef;
            this.f31243OooO0oO = function0;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return MainRoomVM.this.new OooO0o(this.f31241OooO0o, this.f31243OooO0oO, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            Ref.BooleanRef booleanRef = this.f31241OooO0o;
            MainRoomVM mainRoomVM = MainRoomVM.this;
            if (i != 0) {
                if (i == 1) {
                    ResultKt.throwOnFailure(obj);
            ...
            oooO00o = new OooO00o(booleanRef, this.f31243OooO0oO, null);
            ...
            if (apiResult.isSuccess() && apiResult.getData() != null) {
                ...
                if (bindMoreAccountModel != null && bindMoreAccountModel.getIsShowDialog()) {
                    ...
                    oo00oooOooOO0o.OooO0oO(iOooO0o0, "bindMoreAccountMaxCount" + o0O00oO0.OooOOo0().getValue());
                    int iOooOO0o = o00Ooo.OooOO0o().OooOO0o();
                    int iOooOO0O = o00Ooo.OooOO0o().OooOO0O();
                    boolean z = o0O00oO0.f47939OooO0Oo;
                    ...
                    if (o00Ooo.OooOO0o().OooOO0o() > o00Ooo.OooOO0o().OooOO0O() && !o0O00oO0.f47939OooO0Oo) {
    ...
    public static final class OooOO0 extends SuspendLambda implements Function2<o00OO0O0<ApiResult<List<SignTaskModel>>>, Continuation<? super Unit>, Object> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31246OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f31247OooO0o0;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                o00OO0O0 o00oo0o2 = (o00OO0O0) this.f31247OooO0o0;
                SignTaskRepository signTaskRepository = SignTaskRepository.f22667OooO00o;
                this.f31247OooO0o0 = o00oo0o2;
                ...
                o00oo0o1 = (o00OO0O0) this.f31247OooO0o0;
                ResultKt.throwOnFailure(obj);
            }
            ApiResult apiResult = (ApiResult) obj;
            w0.OooO00o(false, apiResult);
    ...
    public final void checkState() {
        ...
        if (!Intrinsics.areEqual(str, o00Ooo.OooOO0o().OooOOO0())) {
            loadSignIn();
        } else {
            loadTaskListData();
    ...
    public final void loadAction(Function1<? super Boolean, Unit> listener) {
        String str = this.dateFormat.format(new Date());
        o0O00oO0 o0o00oo1 = o0O00oO0.f47936OooO00o;
        if (!Intrinsics.areEqual(o0O00oO0.OooOo0O().getValue(), Boolean.TRUE) || Intrinsics.areEqual(this.dialogOfficialActionShowForToDay, str)) {
            return;
        }
        Intrinsics.checkNotNull(str);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final o00OO0O0<ApiResult<List<SignTaskModel>>> loadTaskListData() {
        return p424o0OoO0Oo.o00O.OooO00o(this, new OooOO0(null));
    }
    ...
    @NotNull
    public final MutableState<Boolean> getDialogShowBindYallaChatTips() {
        return this.dialogShowBindYallaChatTips;
    }

    @NotNull
    public final MutableState<Boolean> getDialogShowCheckInTask() {
        return this.dialogShowCheckInTask;
    }

    @NotNull
    public final MutableState<Boolean> getDialogShowOfficialAction() {
        return this.dialogShowOfficialAction;
    }

    @NotNull
    public final MutableState<Boolean> getDialogShowUserReturn() {
        return this.dialogShowUserReturn;
    }

    @NotNull
    public final MutableState<Boolean> getDialogShowWelcome() {
        return this.dialogShowWelcome;
    }
    ...
    public final void loadAll(@NotNull MainDialogManager$Link link, boolean reGet) {
        ...
        if (isLoginState()) {
            o0000O0.OooO00o(Boolean.valueOf(reGet), new OooO0O0());
            MainDialogManager$Link mainDialogManager$Link = this.lastLink;
            OooO0OO listener = new OooO0OO(link);
    ...
    public final void setDialogShowBindYallaChatTips(@NotNull MutableState<Boolean> mutableState) {
        Intrinsics.checkNotNullParameter(mutableState, "<set-?>");
        this.dialogShowBindYallaChatTips = mutableState;
    }

    public final void setDialogShowCheckInTask(@NotNull MutableState<Boolean> mutableState) {
        Intrinsics.checkNotNullParameter(mutableState, "<set-?>");
        this.dialogShowCheckInTask = mutableState;
    }

    public final void setDialogShowOfficialAction(@NotNull MutableState<Boolean> mutableState) {
        Intrinsics.checkNotNullParameter(mutableState, "<set-?>");
        this.dialogShowOfficialAction = mutableState;
    }

    public final void setDialogShowUserReturn(@NotNull MutableState<Boolean> mutableState) {
        Intrinsics.checkNotNullParameter(mutableState, "<set-?>");
        this.dialogShowUserReturn = mutableState;
    }

    public final void setDialogShowWelcome(@NotNull MutableState<Boolean> mutableState) {
        Intrinsics.checkNotNullParameter(mutableState, "<set-?>");
        this.dialogShowWelcome = mutableState;
    }
