...
public class ZegoLiveRoomEngine implements ZegoRoomManagerCallback, ZegoRoomManagerLiveStatusCallback, IZegoAudioRecordCallback2, IZegoMixStreamExCallback, IZegoAVEngineCallback, IZegoAudioPlayerCallback {
    ...
    private float mDamping = DEFAULT_DAMPING;
    private int mRtcDryLevel = 0;
    private int mRtcWetLevel = 0;
    private float mDryWetRatio = 1.0f;
    private float mRoomSize = 0.0f;
    private float mReverberance = 0.0f;
    ...
    private boolean addMixStreamTarget(String str) {
        ...
        ZLog.d(TAG, OooO00o.OooO00o("addMixStreamTarget mixStreamEx result: ", iMixStreamEx), new Object[0]);
    ...
    private void callOnAudioMixingStateChanged(final int i, final int i2) {
        ZLog.d(TAG, OooO0O0.OooO0O0("callOnAudioMixingStateChanged state: ", i, ", errorCode: ", i2), new Object[0]);
        if (this.mEngineEventHandler == null) {
            return;
        }
    ...
    private void callOnFirstLocalAudioFrame() {
        ...
        ZLog.d(TAG, OooO00o.OooO00o("callOnFirstLocalAudioFrame elapsed: ", loginElapsed), new Object[0]);
        IZegoLiveRoomEngineEventHandler iZegoLiveRoomEngineEventHandler = this.mEngineEventHandler;
        if (iZegoLiveRoomEngineEventHandler == null) {
            return;
        }
    ...
    private void callOnFirstRemoteAudioDecoded(int i) {
        int loginElapsed = getLoginElapsed();
        ZLog.d(TAG, OooO0O0.OooO0O0("callOnFirstRemoteAudioDecoded uid: ", i, ", elapsed: ", loginElapsed), new Object[0]);
        IZegoLiveRoomEngineEventHandler iZegoLiveRoomEngineEventHandler = this.mEngineEventHandler;
        if (iZegoLiveRoomEngineEventHandler == null) {
            return;
        }
    ...
    private void callOnFirstRemoteAudioFrame(int i) {
        int loginElapsed = getLoginElapsed();
        ZLog.d(TAG, OooO0O0.OooO0O0("callOnFirstRemoteAudioFrame uid: ", i, ", elapsed: ", loginElapsed), new Object[0]);
        IZegoLiveRoomEngineEventHandler iZegoLiveRoomEngineEventHandler = this.mEngineEventHandler;
        if (iZegoLiveRoomEngineEventHandler == null) {
            return;
        }
    ...
    private void callOnWarning(final int i) {
        ZLog.d(TAG, OooO00o.OooO00o("callOnWarning warningCode: ", i), new Object[0]);
        if (this.mEngineEventHandler == null) {
            return;
        }
    ...
    public static int setLogFile(String str) {
        ZLog.i(TAG, o00O00OO.OooO00o("setLogFile filePath: ", str), new Object[0]);
        ZegoLiveRoomEngine zegoLiveRoomEngine = sInstance;
        if (zegoLiveRoomEngine == null) {
            sFilePath = str;
            return 0;
    ...
    public static int setLogFileSize(int i) {
        String str = TAG;
        ZLog.i(str, OooO00o.OooO00o("setLogFileSize fileSizeInKBytes: ", i), new Object[0]);
        ZegoLiveRoomEngine zegoLiveRoomEngine = sInstance;
        if (zegoLiveRoomEngine != null) {
    ...
    public static int setLogFilter(int i) {
        ZLog.i(TAG, OooO00o.OooO00o("setLogFilter filter: ", i), new Object[0]);
        ZegoLiveRoomEngine zegoLiveRoomEngine = sInstance;
        if (zegoLiveRoomEngine == null) {
            sLogFilter = i;
            return 0;
    ...
    private void setReverbParam() {
        ...
        zegoAudioReverbParam.damping = DEFAULT_DAMPING;
    ...
    private void setRtcDryLevel(int i) {
        ...
        if (i > 10) {
            ...
            i2 = MIN_RTC_DRY_WET_LEVEL;
            if (i < MIN_RTC_DRY_WET_LEVEL) {
                i = i2;
            }
        }
        this.mRtcDryLevel = i;
    ...
    private void setupLiveRoom(final Context context, long j, byte[] bArr, boolean z) {
        ...
        if (sDKContext < 0) {
            callOnError(3);
            ZLog.d(TAG, OooO00o.OooO00o("setSDKContext errorCode: ", sDKContext), new Object[0]);
            return;
        }
        ...
        if (this.mLiveRoom.initSDK(j, bArr, new IZegoInitSDKCompletionCallback() { // from class: com.zego.wrapper.ZegoLiveRoomEngine.4
            ...
            public void onInitSDK(int i) {
                if (i == 0) {
                    ZLog.d(ZegoLiveRoomEngine.TAG, OooO00o.OooO00o("onInitSDK errorCode: ", i), new Object[0]);
                } else {
                    ZLog.e(ZegoLiveRoomEngine.TAG, OooO00o.OooO00o("onInitSDK errorCode: ", i), new Object[0]);
                }
            }
        })) {
    ...
    public void updateAudioMixingStateWithReason(int i, int i2) {
        String str = TAG;
        StringBuilder sb = new StringBuilder("updateAudioMixingStateWithReason mAudioMixingState: ");
        OooOOO0.OooO00o(sb, this.mAudioMixingState, ", audioMixingEvent: ", i, ", errorCode: ");
        sb.append(i2);
        ...
        switch (i3) {
            case 710:
                if (i == 1 || i == 2) {
                    ...
                    ZLog.w(str, "updateAudioMixingStateWithReason status error!! mAudioMixingState = " + this.mAudioMixingState + " audioMixingEvent = " + i, new Object[0]);
                }
                break;
            case 711:
                if (i == 1) {
        ...
        ZLog.d(str, OooO0O0.OooO0O0("updateAudioMixingStateWithReason update audioMixingState: ", i3, ", audioMixingEvent: ", i), new Object[0]);
        if (i == 2) {
    ...
    public int addVideoWatermark(ZegoImage zegoImage) {
        ...
        String strConcat = ZEGO_WATERMARK_FILE_PREFIX.concat(str);
        int i = zegoImage.x;
        int i2 = zegoImage.y;
        Rect rect = new Rect(i, i2, zegoImage.width + i, zegoImage.height + i2);
        ZegoLiveRoom.setWaterMarkImagePath(strConcat);
    ...
    public int adjustAudioMixingVolume(int i) {
        ZLog.i(TAG, OooO00o.OooO00o("adjustAudioMixingVolume volume: ", i), new Object[0]);
    ...
    public int adjustPlaybackSignalVolume(int i) {
        ZLog.i(TAG, OooO00o.OooO00o("adjustPlaybackSignalVolume volume: ", i), new Object[0]);
    ...
    public int adjustRecordingSignalVolume(int i) {
        ZLog.i(TAG, OooO00o.OooO00o("adjustRecordingSignalVolume volume: ", i), new Object[0]);
    ...
    public int enableAudioVolumeIndication(int i) {
        ZLog.i(TAG, OooO00o.OooO00o("enableAudioVolumeIndication interval: ", i), new Object[0]);
    ...
    public void onPlayEffect(int i, int i2) {
        ZLog.d(TAG, OooO0O0.OooO0O0("onPlayEffect soundID: ", i, ", error: ", i2), new Object[0]);
        if (i2 != 0) {
            callOnWarning(701);
        }
    }
    ...
    public void onPlayEnd(int i) {
        ZLog.d(TAG, OooO00o.OooO00o("onPlayEnd soundID: ", i), new Object[0]);
        IZegoLiveRoomEngineEventHandler iZegoLiveRoomEngineEventHandler = this.mEngineEventHandler;
        if (iZegoLiveRoomEngineEventHandler == null) {
            return;
        }
    ...
    public void onPreloadComplete(int i) {
        ZLog.d(TAG, OooO00o.OooO00o("onPreloadComplete soundID: ", i), new Object[0]);
    }

    @Override // com.zego.wrapper.empty.audioplayer.IZegoAudioPlayerCallback
    public void onPreloadEffect(int i, int i2) {
        ZLog.d(TAG, OooO0O0.OooO0O0("onPreloadEffect soundID: ", i, ", error: ", i2), new Object[0]);
        if (i2 != 0) {
            callOnWarning(701);
        }
    }
    ...
    public int removePublishStreamUrl(String str, boolean z) {
        ZLog.i(TAG, o00O00OO.OooO00o("removePublishStreamUrl url: ", str), new Object[0]);
    ...
    public void resetReverbParam() {
        ZegoAudioReverbParam zegoAudioReverbParam = new ZegoAudioReverbParam();
        zegoAudioReverbParam.roomSize = 0.0f;
        zegoAudioReverbParam.reverberance = 0.0f;
        zegoAudioReverbParam.damping = 0.0f;
        zegoAudioReverbParam.dryWetRatio = 0.0f;
    }
    ...
    public int setAudioMixingPosition(int i) {
        ZLog.i(TAG, OooO00o.OooO00o("setAudioMixingPosition pos: ", i), new Object[0]);
    ...
    public int setChannelProfile(int i) {
        ZLog.i(TAG, OooO00o.OooO00o("setChannelProfile channelProfile: ", i), new Object[0]);
    ...
    public int setClientRole(int i) {
        ZLog.i(TAG, OooO00o.OooO00o("setClientRole role: ", i), new Object[0]);
    ...
    public int setInEarMonitoringVolume(int i) {
        ZLog.i(TAG, OooO00o.OooO00o("setInEarMonitoringVolume volume: ", i), new Object[0]);
    ...
    public int setLocalRenderMode(int i) {
        ZLog.i(TAG, OooO00o.OooO00o("setLocalRenderMode mode: ", i), new Object[0]);
    ...
    public int setLocalVideoMirrorMode(int i) {
        ZLog.i(TAG, OooO00o.OooO00o("setLocalVideoMirrorMode mode: ", i), new Object[0]);
    ...
    /* JADX WARN: Code duplicated, block: B:4:0x0021 A[PHI: r0
      0x0021: PHI (r0v4 double) = (r0v2 double), (r0v3 double) binds: [B:3:0x001f, B:6:0x0027] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public int setLocalVoiceReverb(int i, int i2) {
        ZLog.i(TAG, OooO0O0.OooO0O0("setLocalVoiceReverb reverbKey: ", i, ", value: ", i2), new Object[0]);
    ...
    public int setParameters(String str) {
        ZLog.i(TAG, o00O00OO.OooO00o("setParameters parameters: ", str), new Object[0]);
        setCurrentApiName("setParameters");
        try {
            JSONObject jSONObject = new JSONObject(str);
            if (jSONObject.length() == 1) {
                String next = jSONObject.keys().next();
                if (((next.hashCode() == -332484574 && next.equals(LOCAL_VIEW_MIRROR_SETTING)) ? (byte) 0 : (byte) -1) == 0 && localViewMirror(jSONObject.getString(LOCAL_VIEW_MIRROR_SETTING))) {
                    callOnApiCallExecuted(0);
                    return 0;
                }
            }
    ...
    public int setRemoteRenderMode(int i, int i2) {
        ZLog.i(TAG, OooO00o.OooO00o("setRemoteRenderMode mode: ", i2), new Object[0]);
    ...
    public int setVideoCamera(int i) {
        ZLog.i(TAG, OooO00o.OooO00o("setVideoCamera cameraDevice: ", i), new Object[0]);
        ...
        if (this.mMediaPlayer == null) {
            ...
            this.mMediaPlayer.setEventWithIndexCallback(new ZegoMediaPlayerCallbackAdapter() { // from class: com.zego.wrapper.ZegoLiveRoomEngine.6
                ...
                public void onPlayError(int i3, int i4) {
                    int i5;
                    ZLog.d(ZegoLiveRoomEngine.TAG, OooO00o.OooO00o("onPlayError code:", i3), new Object[0]);
                    if (i3 == -6) {
                        return;
                    }
                    if (ZegoLiveRoomEngine.this.isAudioMixingReplace) {
                    ...
                    if (i3 == -5) {
                        ...
                        i5 = -1;
                        if (i3 != -1) {
                            ZLog.w(ZegoLiveRoomEngine.TAG, OooO00o.OooO00o("onPlayError unknown errorCode: ", i3), new Object[0]);
                        } else {
                            i5 = 1001;
                        }
                    } else {
