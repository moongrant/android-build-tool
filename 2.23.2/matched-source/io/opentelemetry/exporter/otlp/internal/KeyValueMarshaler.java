...
final class KeyValueMarshaler extends MarshalerWithSize {
    ...
    class AnonymousClass1 implements BiConsumer<AttributeKey<?>, Object> {
        ...
        public final void accept(AttributeKey<?> attributeKey, Object obj) {
            ...
            if (attributeKey2.getKey().isEmpty()) {
                bytes = MarshalerUtil.f32588OooO00o;
                ...
                byte[] bytes3 = internalAttributeKeyImpl.f32508OooO0Oo;
                if (bytes3 == null) {
                    bytes3 = internalAttributeKeyImpl.f32506OooO0O0.getBytes(StandardCharsets.UTF_8);
                    internalAttributeKeyImpl.f32508OooO0Oo = bytes3;
                }
                bytes = bytes3;
            } else {
            ...
            int i = 0;
            switch (AnonymousClass2.f32587OooO00o[attributeKey2.getType().ordinal()]) {
                case 1:
                    String str = (String) obj;
                    if (str != null) {
                        byte[] bArr = MarshalerUtil.f32588OooO00o;
                        if (str.isEmpty()) {
                            bytes2 = MarshalerUtil.f32588OooO00o;
                        } else {
    ...
    public static /* synthetic */ class AnonymousClass2 {
        ...
        public static final /* synthetic */ int[] f32587OooO00o;
        ...
        static {
            ...
            try {
                f32587OooO00o[AttributeType.LONG.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f32587OooO00o[AttributeType.BOOLEAN.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f32587OooO00o[AttributeType.DOUBLE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f32587OooO00o[AttributeType.STRING_ARRAY.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f32587OooO00o[AttributeType.LONG_ARRAY.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f32587OooO00o[AttributeType.BOOLEAN_ARRAY.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f32587OooO00o[AttributeType.DOUBLE_ARRAY.ordinal()] = 8;
    ...
    public static class AnyDoubleFieldMarshaler extends MarshalerWithSize {
        ...
        public AnyDoubleFieldMarshaler() {
            int i = ((AutoValue_ProtoFieldInfo) AnyValue.f32618OooO0Oo).f32582OooO0OO;
            int i2 = CodedOutputStream.f32584OooO00o;
            super(i + 8);
        }
    }
    ...
    public static class ArrayAnyValueMarshaler extends MarshalerWithSize {
        ...
        public ArrayAnyValueMarshaler(Marshaler marshaler) {
            ProtoFieldInfo protoFieldInfo = AnyValue.f32619OooO0o0;
            byte[] bArr = MarshalerUtil.f32588OooO00o;
            int i = ((AutoValue_ProtoFieldInfo) protoFieldInfo).f32582OooO0OO;
            int i2 = ((MarshalerWithSize) marshaler).f32589OooO00o;
    ...
    public static class ArrayValueMarshaler extends MarshalerWithSize {
        ...
        public ArrayValueMarshaler(Marshaler[] marshalerArr) {
            ProtoFieldInfo protoFieldInfo = ArrayValue.f32620OooO00o;
            byte[] bArr = MarshalerUtil.f32588OooO00o;
            int i = ((AutoValue_ProtoFieldInfo) protoFieldInfo).f32582OooO0OO;
            int iOooO00o = 0;
    ...
    public static class BoolAnyValueMarshaler extends MarshalerWithSize {
        ...
        public BoolAnyValueMarshaler() {
            int i = ((AutoValue_ProtoFieldInfo) AnyValue.f32616OooO0O0).f32582OooO0OO;
            int i2 = CodedOutputStream.f32584OooO00o;
            super(i + 1);
        }
    }
    ...
    public static class Int64AnyValueMarshaler extends MarshalerWithSize {
        ...
        public Int64AnyValueMarshaler(long j) {
            int i;
            int i2;
            int i3 = ((AutoValue_ProtoFieldInfo) AnyValue.f32617OooO0OO).f32582OooO0OO;
            if (((-128) & j) == 0) {
                i2 = 1;
            } else if (j < 0) {
                i2 = 10;
    ...
    public static class StringAnyValueMarshaler extends MarshalerWithSize {
        ...
        public StringAnyValueMarshaler(byte[] bArr) {
            int i = ((AutoValue_ProtoFieldInfo) AnyValue.f32615OooO00o).f32582OooO0OO;
    ...
    public KeyValueMarshaler(byte[] bArr, Marshaler marshaler) {
        int iOooO00o;
        ProtoFieldInfo protoFieldInfo = KeyValue.f32621OooO00o;
        byte[] bArr2 = MarshalerUtil.f32588OooO00o;
        if (bArr.length == 0) {
            iOooO00o = 0;
        } else {
            int i = ((AutoValue_ProtoFieldInfo) protoFieldInfo).f32582OooO0OO;
        ...
        int i2 = ((AutoValue_ProtoFieldInfo) KeyValue.f32622OooO0O0).f32582OooO0OO;
        int i3 = ((MarshalerWithSize) marshaler).f32589OooO00o;
