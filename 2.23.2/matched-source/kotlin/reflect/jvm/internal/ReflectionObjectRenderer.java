...
public final class ReflectionObjectRenderer {
    ...
    public final String renderFunction(@NotNull FunctionDescriptor descriptor) {
        ...
        CollectionsKt.OooOO0O(valueParameters, sb, ", ", "(", ")", new Function1<ValueParameterDescriptor, CharSequence>() { // from class: kotlin.reflect.jvm.internal.ReflectionObjectRenderer$renderFunction$1$1
    ...
    public final String renderLambda(@NotNull FunctionDescriptor invoke) {
        ...
        CollectionsKt.OooOO0O(valueParameters, sb, ", ", "(", ")", new Function1<ValueParameterDescriptor, CharSequence>() { // from class: kotlin.reflect.jvm.internal.ReflectionObjectRenderer$renderLambda$1$1
            @Override // kotlin.jvm.functions.Function1
            @NotNull
            public final CharSequence invoke(ValueParameterDescriptor valueParameterDescriptor) {
                ReflectionObjectRenderer reflectionObjectRenderer2 = ReflectionObjectRenderer.INSTANCE;
