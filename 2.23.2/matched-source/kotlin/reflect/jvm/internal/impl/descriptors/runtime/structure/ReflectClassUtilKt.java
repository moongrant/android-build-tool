...
public final class ReflectClassUtilKt {
    ...
    static {
        ...
        ArrayList arrayList3 = new ArrayList(CollectionsKt.OooO0oo(listListOf2));
    ...
    public static final ClassId getClassId(@NotNull Class<?> cls) {
        ...
        if (cls.isPrimitive()) {
            throw new IllegalArgumentException(OooO00o.OooO00o("Can't compute ClassId for primitive type: ", cls));
        }
        if (cls.isArray()) {
            throw new IllegalArgumentException(OooO00o.OooO00o("Can't compute ClassId for array type: ", cls));
        }
    ...
    public static final String getDesc(@NotNull Class<?> cls) {
        ...
        throw new IllegalArgumentException(OooO00o.OooO00o("Unsupported primitive type: ", cls));
    }
