...
public final class oo00o implements o0000O {
    ...
    public final boolean f893OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final String f894OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final int f895OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final HashMap f896OooO0Oo = new HashMap();
    ...
    public final boolean OooO00o(int i) {
        if (this.f893OooO00o) {
            return CamcorderProfile.hasProfile(this.f895OooO0OO, i);
        }
        return false;
    }
    ...
    public final EncoderProfilesProxy OooO0O0(int i) {
        ...
        int i6 = this.f895OooO0OO;
        if (!CamcorderProfile.hasProfile(i6, i)) {
            return null;
        }
        HashMap map = this.f896OooO0Oo;
        ...
        if (i7 < 31) {
            ...
            EncoderProfiles encoderProfilesOooO00o = OooO00o.OooO00o(this.f894OooO0O0, i);
