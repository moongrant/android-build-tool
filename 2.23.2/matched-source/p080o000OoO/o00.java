...
public final class o00 {
    ...
    @Nullable
    public static HashMap<String, String> f34909OooO;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    @UnstableApi
    public static final int f34910OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @UnstableApi
    public static final String f34911OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @UnstableApi
    public static final String f34912OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @UnstableApi
    public static final String f34913OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @UnstableApi
    public static final byte[] f34914OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @UnstableApi
    public static final String f34915OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public static final Pattern f34916OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public static final Pattern f34917OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public static final String[] f34918OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public static final String[] f34919OooOO0O;

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    public static final int[] f34920OooOO0o;

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    public static final int[] f34921OooOOO0;
    ...
    @UnstableApi
    public static int OooO0Oo(o00000O o00000o, long j) {
        int i = o00000o.f34930OooO00o - 1;
        int i2 = 0;
        while (i2 <= i) {
            int i3 = (i2 + i) >>> 1;
            if (o00000o.OooO0O0(i3) < j) {
                i2 = i3 + 1;
            } else {
                i = i3 - 1;
            }
        ...
        int i4 = i + 1;
        if (i4 < o00000o.f34930OooO00o && o00000o.OooO0O0(i4) == j) {
            return i4;
        }
        if (i == -1) {
            return 0;
    ...
    public static int OooOO0O(int i, byte[] bArr, int i2, int i3) {
        while (i < i2) {
            i3 = f34920OooOO0o[((i3 >>> 24) ^ (bArr[i] & 255)) & 255] ^ (i3 << 8);
            i++;
        }
        return i3;
    }
    ...
    @UnstableApi
    public static Handler OooOOO0(@Nullable o000OOo o000ooo2) {
        Looper looperMyLooper = Looper.myLooper();
        if (looperMyLooper == null) {
            looperMyLooper = Looper.getMainLooper();
        }
        return new Handler(looperMyLooper, o000ooo2);
    }

    @UnstableApi
    public static String OooOOOO(byte[] bArr) {
        return new String(bArr, OooOO0.f18592OooO0OO);
    }
    ...
    public static Drawable OooOOo0(Context context, Resources resources, @DrawableRes int i) {
        return f34910OooO00o >= 21 ? OooO00o.OooO00o(context, resources, i) : resources.getDrawable(i);
    }
    ...
    public static byte[] OooOoo(String str) {
        return str.getBytes(OooOO0.f18592OooO0OO);
    }
    ...
    public static int Oooo000(Uri uri, @Nullable String str) {
        ...
        if (iLastIndexOf >= 0) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: p080o000OoO.o00.Oooo000(android.net.Uri, java.lang.String):int");
        }

        @UnstableApi
        public static boolean Oooo00O(o000O000 o000o001, o000O000 o000o002, @Nullable Inflater inflater) {
            int i = o000o001.f34964OooO0OO - o000o001.f34963OooO0O0;
            if (i <= 0) {
                return false;
            }
            if (o000o002.f34962OooO00o.length < i) {
                o000o002.OooO00o(i * 2);
            }
            if (inflater == null) {
            ...
            inflater.setInput(bArr, i2, o000o001.f34964OooO0OO - i2);
            int iInflate = 0;
            while (true) {
                try {
                    ...
                    if (inflater.finished()) {
                        o000o002.Oooo000(iInflate);
                        inflater.reset();
                        return true;
                    }
                    if (!inflater.needsDictionary() && !inflater.needsInput()) {
                        byte[] bArr3 = o000o002.f34962OooO00o;
                        if (iInflate == bArr3.length) {
                            o000o002.OooO00o(bArr3.length * 2);
                        }
                    }
                    inflater.reset();
                    return false;
        ...
        public static Object[] Oooo0o(int i, Object[] objArr) {
            o00Oo0.OooO00o(i <= objArr.length);
        ...
        public static String Oooo0o0(String str) {
            ...
            String str4 = f34909OooO.get(str2);
            if (str4 != null) {
