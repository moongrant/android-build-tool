...
public final class o00O00OO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f46076OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ MutableLiveData<Boolean> f46077OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ ChatMessage f46078OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final /* synthetic */ List<Long> f46079OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final /* synthetic */ List<Pair<String, String>> f46080OooO0oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00O00OO(ChatMessage chatMessage, MutableLiveData<Boolean> mutableLiveData, List<Long> list, List<Pair<String, String>> list2, Continuation<? super o00O00OO> continuation) {
        super(2, continuation);
        this.f46078OooO0o0 = chatMessage;
        this.f46077OooO0o = mutableLiveData;
        this.f46079OooO0oO = list;
        this.f46080OooO0oo = list2;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o00O00OO(this.f46078OooO0o0, this.f46077OooO0o, this.f46079OooO0oO, this.f46080OooO0oo, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f46076OooO0Oo;
        MutableLiveData<Boolean> mutableLiveData = this.f46077OooO0o;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ChatMessage chatMessage = this.f46078OooO0o0;
            ...
            this.f46076OooO0Oo = 1;
            MessageIM.ShareActivity2127.Builder builderNewBuilder = MessageIM.ShareActivity2127.newBuilder();
            builderNewBuilder.setImage(activityImage);
            builderNewBuilder.setTxt1(activityText1);
            builderNewBuilder.setTxt2(activityText2);
            builderNewBuilder.setUrl(activityUrl);
            builderNewBuilder.setMsg(message);
            builderNewBuilder.setActivity(activity);
            Iterator<T> it = this.f46079OooO0oO.iterator();
            while (it.hasNext()) {
                builderNewBuilder.addTargets(((Number) it.next()).longValue());
            }
            o0OoO00O o0ooo00o2 = OooOO0.f48392OooO00o;
            String str = Oooo0.f43351OooOo;
        ...
        Iterator<T> it2 = this.f46080OooO0oo.iterator();
        while (it2.hasNext()) {
