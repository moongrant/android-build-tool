...
public class oO00Oo00 {
    ...
    public static final oO00Oo00 f46472OooO0O0 = new oO00Oo00();

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final String[] f46473OooO0OO = {"standard", "accelerate", "decelerate", "linear"};

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public String f46474OooO00o = "identity";

    public static class OooO00o extends oO00Oo00 {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final double f46475OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final double f46476OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final double f46477OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final double f46478OooO0oO;

        public OooO00o(String str) {
            this.f46474OooO00o = str;
            int iIndexOf = str.indexOf(40);
            int iIndexOf2 = str.indexOf(44, iIndexOf);
            this.f46475OooO0Oo = Double.parseDouble(str.substring(iIndexOf + 1, iIndexOf2).trim());
            int i = iIndexOf2 + 1;
            int iIndexOf3 = str.indexOf(44, i);
            this.f46477OooO0o0 = Double.parseDouble(str.substring(i, iIndexOf3).trim());
            int i2 = iIndexOf3 + 1;
            int iIndexOf4 = str.indexOf(44, i2);
            this.f46476OooO0o = Double.parseDouble(str.substring(i2, iIndexOf4).trim());
            int i3 = iIndexOf4 + 1;
            this.f46478OooO0oO = Double.parseDouble(str.substring(i3, str.indexOf(41, i3)).trim());
        }
        ...
        public final double OooO0Oo(double d) {
            ...
            double d4 = d2 * d3 * d;
            double d5 = d3 * d * d;
            return (this.f46476OooO0o * d5) + (this.f46475OooO0Oo * d4) + (d * d * d);
        }
        ...
        public final double OooO0o0(double d) {
            ...
            double d4 = d2 * d3 * d;
            double d5 = d3 * d * d;
            return (this.f46478OooO0oO * d5) + (this.f46477OooO0o0 * d4) + (d * d * d);
        }
    }
    ...
    public static oO00Oo00 OooO0OO(String str) {
        ...
        switch (str) {
            ...
            default:
                System.err.println("transitionEasing syntax error syntax:transitionEasing=\"cubic(1.0,0.5,0.0,0.6)\" or " + Arrays.toString(f46473OooO0OO));
                return f46472OooO0O0;
        }
    }
