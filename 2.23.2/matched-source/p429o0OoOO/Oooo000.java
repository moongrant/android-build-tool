...
public final class Oooo000 {
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public static final class C0452OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {

            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ RechargeMenuConfirmOrderResultModel f46788OooO0Oo;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C0452OooO00o(RechargeMenuConfirmOrderResultModel rechargeMenuConfirmOrderResultModel, Continuation<? super C0452OooO00o> continuation) {
            ...
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                return new C0452OooO00o(this.f46788OooO0Oo, continuation);
            }

            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
                return ((C0452OooO00o) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                if (balance != null) {
                    ...
                    o0O00oO0.OooO0O0().postValue(Boxing.boxLong(jLongValue));
                }
                LiveEventBus.get("FixRechargeOrder_Success").post(Boxing.boxBoolean(true));
                o0000O00.OooO0O0("Google补单 App确认 成功 data:" + oOOOOo0O.OooO00o(rechargeMenuConfirmOrderResultModel));
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            switch (i) {
                case 0:
                    ...
                    o0000O00.OooO0o("Google补单 App确认 结果 result:" + oOOOOo0O.OooO00o(apiResult));
                    if (apiResult.isSuccess()) {
                        ...
                        if (rechargeMenuConfirmOrderResultModel != null) {
                            ...
                            if (l != null && userId == l.longValue()) {
                                ...
                                c0452OooO00o = new C0452OooO00o(rechargeMenuConfirmOrderResultModel, null);
                                this.f46785OooO0Oo = 2;
                                if (BuildersKt.withContext(main, c0452OooO00o, this) == coroutine_suspended) {
                                    return coroutine_suspended;
                                }
                            }
                        }
                        ...
                        o0000O00.OooO("Google补单 App确认 失败 result:" + apiResult);
                ...
                case 1:
                    ...
                    if (apiResult.isSuccess()) {
                        ...
                        code = apiResult.getCode();
                        if (code != 2000) {
                            WalletRepo walletRepo6 = WalletRepo.f24376OooO00o;
                            orderId = payOrder.getOrderId();
                            this.f46785OooO0Oo = 4;
                            ...
                            WalletRepo walletRepo7 = WalletRepo.f24376OooO00o;
                            orderId = payOrder.getOrderId();
                            this.f46785OooO0Oo = 4;
                ...
                case 2:
                    ResultKt.throwOnFailure(obj);
                    WalletRepo walletRepo8 = WalletRepo.f24376OooO00o;
                    orderId2 = payOrder.getOrderId();
                    this.f46785OooO0Oo = 3;
    ...
    public static final void OooO00o(Oooo000 oooo000) {
        ...
        o0000O00.OooO0O0("Google补单 SDK消费 payOrder:" + payOrder);
    ...
    public final void OooO0O0(PayOrder payOrder) {
        o0000O00.OooO0O0("Google补单 App确认 model:" + payOrder);
