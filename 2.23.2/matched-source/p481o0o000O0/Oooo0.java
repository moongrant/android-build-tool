...
public final class Oooo0 extends OooOo {
    ...
    public static SystemMessage OooO0OO(long j, String str, String str2) {
        ...
        if (j <= 0) {
            synchronized (o0O0o00O.f55755OooO00o) {
                jCurrentTimeMillis = System.currentTimeMillis() + o0ooOOo.OooO00o().f57307OooO00o;
            }
    ...
    public static String OooO0o(String str, long j, SystemMessageModel systemMessageModel) {
        o0000O00.OooO0OO("saveEventMsg", " saveEventMsg = " + systemMessageModel);
        ...
        if (data != null) {
            ...
            switch (systemMessageModel.getType()) {
                case 72:
                    ...
                    strOooO0OO = o0000.OooO0OO(o000000.Event_Message_Title_start);
                    break;
                case 73:
                ...
                case 74:
                    ...
                    strOooO0OO = o0000.OooO0OO(o000000.Event_Message_Title_cancel);
                    break;
                case 75:
                    systemMessageOooO0OO.setType(31);
                    strOooO0OO = o0000.OooO0OO(o000000.Event_Message_Title_passed);
                    break;
                case 76:
                    systemMessageOooO0OO.setType(32);
                    strOooO0OO = o0000.OooO0OO(o000000.Event_Message_Title_recommend);
                    break;
                case 77:
                    systemMessageOooO0OO.setType(29);
                    strOooO0OO = o0000.OooO0OO(o000000.Event_Message_Title_deleted);
                    break;
            }
            o00O0.OooO00o(systemMessageOooO0OO);
        }
        return strOooO0OO;
    }
    ...
    public static void OooO0oO(String str, String str2, String str3, String str4) {
        if (OooOo00.OooO0O0(str3)) {
            g0.OooO0O0(str, str2, str3, str4, new Intent(App.f22232OooO0o, (Class<?>) SystemMessageActivity.class));
        }
    }

    public final boolean OooO0Oo() {
        return ((OooO0O0.OooO0O0() instanceof SystemMessageActivity) || OooOo.OooO00o()) ? false : true;
    }
    ...
    public final void OooO0o0(@NotNull MessageIM.Message msg, boolean z) {
        ...
        o0000O00.OooO0OO("SystemMsgProcessor", " parseMessage = " + msg);
        if (msg.getFromId() == OooO0O0() || OooOo00.OooO00o(msg.getMid())) {
            return;
        }
        if (OooOo00.OooO0O0(o00Oo0.OooO00o().Oooo00O().OooO0o(msg.getMid(), Long.valueOf(OooO0O0())))) {
            return;
        }
        int head = msg.getHead();
        if (head == 1002) {
            o0000O00.OooO0OO("SystemMsgProcessor", " saveJoinTopicMessage = " + msg);
            ...
            o00Oo0.OooO00o().Oooo00O().OooO0O0(systemMessageOooO0OO);
            p545o0oO0O00.OooOo00.OooO0O0(40, null);
            if (OooO0Oo()) {
                OooO0oO("Yalla_Notice_Monemt", o0000.OooO0OO(o000000.Notice_Title_moment), systemMessageOooO0OO.getMessage(), o0000.OooO0OO(o000000.notify_new_message));
                return;
            }
            return;
        }
        if (head == 1051) {
            o0000O00.OooO0OO("SystemMsgProcessor", " saveVipMessage = " + msg);
            ...
            o00Oo0.OooO00o().Oooo00O().OooO0O0(systemMessageOooO0OO2);
            p545o0oO0O00.OooOo00.OooO0O0(40, null);
            if (OooO0Oo()) {
                int i2 = o000000.notify_new_message;
        ...
        if (head == 1500) {
            o0000O00.OooO0OO("SystemMsgProcessor", " saveTopicStateMessage = " + msg);
            ...
            o00Oo0.OooO00o().Oooo00O().OooO0O0(systemMessageOooO0OO3);
            p545o0oO0O00.OooOo00.OooO0O0(40, null);
            if (OooO0Oo()) {
                int i3 = o000000.notify_new_message;
        ...
        if (head != 2102) {
            ...
            o0000O00.OooO0OO("SystemMsgProcessor", " saveMoraMessage = " + msg);
            ...
            o00Oo0.OooO00o().Oooo00O().OooO0O0(systemMessageOooO0OO4);
            p545o0oO0O00.OooOo00.OooO0O0(40, null);
            o0O0oo0o.OooO00o().OooO0Oo(1L, OooO0O0() + "MORA_RED_POINT");
            LiveEventBus.get("MORA_RED_POINT").post(msg);
            return;
        }
        o0000O00.OooO0OO("SystemMsgProcessor", " parseBroadcastMessage = " + msg);
        ...
        if (type5 == 10) {
            ...
            long jOooO0O0 = Oooo000.OooO0O0(mid5, "getMid(...)", msg, systemMessageModel);
            o0000O00.OooO0OO("SystemMsgProcessor", " saveUserUpgradeMsg = " + systemMessageModel);
            ...
            SystemMessage systemMessageOooO0OO5 = OooO0OO(jOooO0O0, mid5, systemMessageModel.getMessage());
            systemMessageOooO0OO5.setUserUpgradeInfo(userUpgradeInfo);
            systemMessageOooO0OO5.setType(5);
            o00O0.OooO00o(systemMessageOooO0OO5);
            strOooO0OO = o0000.OooO0OO(o000000.str_notice_personer_promotion);
        } else if (type5 == 11) {
            str = "Yalla_Notice_Syatem";
            String mid6 = msg.getMid();
            long jOooO0O1 = Oooo000.OooO0O0(mid6, "getMid(...)", msg, systemMessageModel);
            o0000O00.OooO0OO("SystemMsgProcessor", " saveRoomUpgradeMsg = " + systemMessageModel);
            ...
            SystemMessage systemMessageOooO0OO6 = OooO0OO(jOooO0O1, mid6, systemMessageModel.getMessage());
            systemMessageOooO0OO6.setRoomUpgradeInfo(roomUpgradeInfo);
            systemMessageOooO0OO6.setType(6);
            o00O0.OooO00o(systemMessageOooO0OO6);
            strOooO0OO = o0000.OooO0OO(o000000.str_notice_room_promotion);
        } else if (type5 == 21) {
            str = "Yalla_Notice_Syatem";
            String mid7 = msg.getMid();
            long jOooO0O2 = Oooo000.OooO0O0(mid7, "getMid(...)", msg, systemMessageModel);
            o0000O00.OooO0OO("SystemMsgProcessor", " saveRoomWagesMsg = " + systemMessageModel);
            ...
            SystemMessage systemMessageOooO0OO7 = OooO0OO(jOooO0O2, mid7, systemMessageModel.getMessage());
            systemMessageOooO0OO7.setRoomWageInfo(roomWageInfo);
            systemMessageOooO0OO7.setType(7);
            o00O0.OooO00o(systemMessageOooO0OO7);
            strOooO0OO = o0000.OooO0OO(o000000.str_notice_salary);
        } else if (type5 == 22) {
            str = "Yalla_Notice_Syatem";
            String mid8 = msg.getMid();
            long jOooO0O3 = Oooo000.OooO0O0(mid8, "getMid(...)", msg, systemMessageModel);
            o0000O00.OooO0OO("SystemMsgProcessor", " saveLuckyRefundMsg = " + systemMessageModel);
            SystemMessage systemMessageOooO0OO8 = OooO0OO(jOooO0O3, mid8, systemMessageModel.getMessage());
            systemMessageOooO0OO8.setType(8);
            o00O0.OooO00o(systemMessageOooO0OO8);
            strOooO0OO = o0000.OooO0OO(o000000.str_notice_red_packet);
        } else if (type5 == 24) {
            str = "Yalla_Notice_Syatem";
            String mid9 = msg.getMid();
            long jOooO0O4 = Oooo000.OooO0O0(mid9, "getMid(...)", msg, systemMessageModel);
            o0000O00.OooO0OO("SystemMsgProcessor", " saveGiftLuckyRefundMsg = " + systemMessageModel);
            SystemMessage systemMessageOooO0OO9 = OooO0OO(jOooO0O4, mid9, systemMessageModel.getMessage());
            systemMessageOooO0OO9.setType(9);
            o00O0.OooO00o(systemMessageOooO0OO9);
            strOooO0OO = o0000.OooO0OO(o000000.str_notice_red_packet);
        } else if (type5 == 42) {
            str = "Yalla_Notice_Syatem";
            String mid10 = msg.getMid();
            long jOooO0O5 = Oooo000.OooO0O0(mid10, "getMid(...)", msg, systemMessageModel);
            o0000O00.OooO0OO("SystemMsgProcessor", " saveAppWakeupMsg = " + systemMessageModel);
            SystemMessage systemMessageOooO0OO10 = OooO0OO(jOooO0O5, mid10, systemMessageModel.getMessage());
            systemMessageOooO0OO10.setType(18);
            o00Oo0.OooO00o().Oooo00O().OooO0O0(systemMessageOooO0OO10);
            ...
            if (type5 != 60) {
                ...
                if (type5 == 65) {
                    ...
                    o0000O00.OooO0OO("saveKaVipMsg", " saveKaVipMsg = " + systemMessageModel);
                    if (systemMessageModel.getData() != null) {
                        ...
                        o00O0.OooO00o(systemMessageOooO0OO11);
                    }
                    ...
                    if (numValueOf != null && numValueOf.intValue() == 1) {
                        strOooO00o2 = o0000.OooO0OO(o000000.message_ka_vip_expire);
                    } else if (numValueOf != null && numValueOf.intValue() == 2) {
                        strOooO00o2 = o0000.OooO0OO(o000000.message_ka_vip_will_upgrade);
                    } else if (numValueOf != null && numValueOf.intValue() == 3) {
                        String strOooO0OO5 = o0000.OooO0OO(o000000.message_ka_vip_obtain);
                    ...
                    if (type5 != 66) {
                        ...
                        switch (type5) {
                            case 30:
                                ...
                                long jOooO0O6 = Oooo000.OooO0O0(mid12, "getMid(...)", msg, systemMessageModel);
                                o0000O00.OooO0OO("SystemMsgProcessor", " saveVipWillExpireMsg = " + systemMessageModel);
                                SystemMessage systemMessageOooO0OO12 = OooO0OO(jOooO0O6, mid12, systemMessageModel.getMessage());
                                systemMessageOooO0OO12.setType(10);
                                o00O0.OooO00o(systemMessageOooO0OO12);
                                strOooO0OO = o0000.OooO0OO(o000000.str_notice_vip_timeout);
                                break;
                            case 31:
                                String mid13 = msg.getMid();
                                long jOooO0O7 = Oooo000.OooO0O0(mid13, "getMid(...)", msg, systemMessageModel);
                                o0000O00.OooO0OO("SystemMsgProcessor", " saveVipHasExpireMsg = " + systemMessageModel);
                                ...
                                SystemMessage systemMessageOooO0OO13 = OooO0OO(jOooO0O7, mid13, systemMessageModel.getMessage());
                                systemMessageOooO0OO13.setAristocracyInfo(aristocracyExpiredInfo);
                                systemMessageOooO0OO13.setType(11);
                                o00O0.OooO00o(systemMessageOooO0OO13);
                                strOooO0OO = o0000.OooO0OO(o000000.Confirmation);
                                break;
                            case 32:
                                String mid14 = msg.getMid();
                                long jOooO0O8 = Oooo000.OooO0O0(mid14, "getMid(...)", msg, systemMessageModel);
                                o0000O00.OooO0OO("SystemMsgProcessor", " saveUniqueIdHasExpiredMsg = " + systemMessageModel);
                                ...
                                SystemMessage systemMessageOooO0OO14 = OooO0OO(jOooO0O8, mid14, systemMessageModel.getMessage());
                                systemMessageOooO0OO14.setUniqueIdDueRemindInfo(uniqueIdDueRemindInfo);
                                systemMessageOooO0OO14.setType(12);
                                o00O0.OooO00o(systemMessageOooO0OO14);
                                strOooO0OO = o0000.OooO0OO(o000000.Confirmation);
                                break;
                            case 33:
                                String mid15 = msg.getMid();
                                long jOooO0O9 = Oooo000.OooO0O0(mid15, "getMid(...)", msg, systemMessageModel);
                                o0000O00.OooO0OO("SystemMsgProcessor", " saveTopCardBidRefundMsg = " + systemMessageModel);
                                SystemMessage systemMessageOooO0OO15 = OooO0OO(jOooO0O9, mid15, systemMessageModel.getMessage());
                                systemMessageOooO0OO15.setType(13);
                                o00O0.OooO00o(systemMessageOooO0OO15);
                                strOooO0OO = o0000.OooO0OO(o000000.system_message_top_card_refund);
                                break;
                            case 34:
                                String mid16 = msg.getMid();
                                long jOooO0O10 = Oooo000.OooO0O0(mid16, "getMid(...)", msg, systemMessageModel);
                                o0000O00.OooO0OO("SystemMsgProcessor", " saveTopCardBidSuccessMsg = " + systemMessageModel);
                                SystemMessage systemMessageOooO0OO16 = OooO0OO(jOooO0O10, mid16, systemMessageModel.getMessage());
                                systemMessageOooO0OO16.setType(14);
                                o00O0.OooO00o(systemMessageOooO0OO16);
                                strOooO0OO = o0000.OooO0OO(o000000.system_message_top_card_bid);
                                break;
                            case 35:
                                String mid17 = msg.getMid();
                                long jOooO0O11 = Oooo000.OooO0O0(mid17, "getMid(...)", msg, systemMessageModel);
                                o0000O00.OooO0OO("SystemMsgProcessor", " saveVipCoinRebateMsg = " + systemMessageModel);
                                ...
                                SystemMessage systemMessageOooO0OO17 = OooO0OO(jOooO0O11, mid17, systemMessageModel.getMessage());
                                systemMessageOooO0OO17.setConsumerRebateInfo(consumerRebateInfo);
                                systemMessageOooO0OO17.setType(15);
                                o00O0.OooO00o(systemMessageOooO0OO17);
                                strOooO0OO = o0000.OooO0OO(o000000.Rebate_on_Gift_Sending);
                                break;
                            case 36:
                                String mid18 = msg.getMid();
                                long jOooO0O12 = Oooo000.OooO0O0(mid18, "getMid(...)", msg, systemMessageModel);
                                o0000O00.OooO0OO("SystemMsgProcessor", " saveHeaderFrameUnlockMsg = " + systemMessageModel);
                                ...
                                SystemMessage systemMessageOooO0OO18 = OooO0OO(jOooO0O12, mid18, systemMessageModel.getMessage());
                                systemMessageOooO0OO18.setUnlockAvatarFrameInfo(unlockAvatarFrameInfo);
                                systemMessageOooO0OO18.setType(16);
                                o00O0.OooO00o(systemMessageOooO0OO18);
                                strOooO0OO = o0000.OooO0OO(o000000.message_unlocked_a_profile_frame);
                                break;
                            case 37:
                                String mid19 = msg.getMid();
                                long jOooO0O13 = Oooo000.OooO0O0(mid19, "getMid(...)", msg, systemMessageModel);
                                o0000O00.OooO0OO("SystemMsgProcessor", " saveSubscribePremiumRewardMsg = " + systemMessageModel);
                                ...
                                SystemMessage systemMessageOooO0OO19 = OooO0OO(jOooO0O13, mid19, systemMessageModel.getMessage());
                                systemMessageOooO0OO19.setSubscribeRewardInfo(subscribeRewardInfo);
                                systemMessageOooO0OO19.setType(17);
                                o00O0.OooO00o(systemMessageOooO0OO19);
                                strOooO0OO = o0000.OooO0OO(o000000.premium_reward);
                                break;
                            default:
                                switch (type5) {
                                    case 50:
                                        String mid20 = msg.getMid();
                                        long jOooO0O14 = Oooo000.OooO0O0(mid20, "getMid(...)", msg, systemMessageModel);
                                        o0000O00.OooO0OO("SystemMsgProcessor", " saveMedalNoticeMsg = " + systemMessageModel);
                                        ...
                                        SystemMessage systemMessageOooO0OO20 = OooO0OO(jOooO0O14, mid20, systemMessageModel.getMessage());
                                        systemMessageOooO0OO20.setMedalNoticeInfo(medalNoticeInfo);
                                        systemMessageOooO0OO20.setType(19);
                                        o00O0.OooO00o(systemMessageOooO0OO20);
                                        strOooO0OO = o0000.OooO0OO(o000000.system_title_newbadge);
                                        break;
                                    case 51:
                                        String mid21 = msg.getMid();
                                        long jOooO0O15 = Oooo000.OooO0O0(mid21, "getMid(...)", msg, systemMessageModel);
                                        o0000O00.OooO0OO("SystemMsgProcessor", " saveHonorMedalNoticeMsg = " + systemMessageModel);
                                        ...
                                        SystemMessage systemMessageOooO0OO21 = OooO0OO(jOooO0O15, mid21, systemMessageModel.getMessage());
                                        systemMessageOooO0OO21.setMedalNoticeInfo(medalNoticeInfo2);
                                        systemMessageOooO0OO21.setType(20);
                                        o00O0.OooO00o(systemMessageOooO0OO21);
                                        strOooO0OO = o0000.OooO0OO(o000000.system_title_newbadge);
                                        break;
                                    case 52:
                                        ...
                                        o0000O00.OooO0OO("SystemMsgProcessor", " savaCustomThemeMsg = " + systemMessageModel);
                                        SystemMessageData data21 = systemMessageModel.getData();
                                        if (data21 == null) {
                                            strOooO0OO = o0000.OooO0OO(o000000.message_custom_theme_failed_title);
                                        } else {
                                            ...
                                            if (iOooO0o2 == 1) {
                                                ...
                                                o00O0.OooO00o(systemMessageOooO0OO22);
                                                strOooO0OO = o0000.OooO0OO(o000000.message_custom_theme_successful_title);
                                            } else if (iOooO0o2 == 2) {
                                                ...
                                                o00O0.OooO00o(systemMessageOooO0OO23);
                                                strOooO0OO = o0000.OooO0OO(o000000.message_custom_theme_failed_title);
                                            } else if (iOooO0o2 == 4) {
                                                ...
                                                o00O0.OooO00o(systemMessageOooO0OO24);
                                                strOooO0OO = o0000.OooO0OO(o000000.message_custom_theme_delete_title);
                                            } else {
                                                strOooO0OO = o0000.OooO0OO(o000000.message_custom_theme_failed_title);
                                            }
                                        }
                                    ...
                                    default:
                                        switch (type5) {
                                            ...
                                            case 78:
                                                ...
                                                long jOooO0O16 = Oooo000.OooO0O0(mid29, "getMid(...)", msg, systemMessageModel);
                                                o0000O00.OooO0OO("saveFirstDepositReward", "saveFirstDepositReward = " + systemMessageModel);
                                                int i4 = o000000.system_mssage_title_first_recharge_rewards;
                                                strOooO0OO2 = o0000.OooO0OO(i4);
                                                SystemMessageData data22 = systemMessageModel.getData();
                                                if (data22 != null) {
                                                    SystemMessage systemMessageOooO0OO25 = OooO0OO(jOooO0O16, mid29, systemMessageModel.getMessage());
                                                    if (data22.getMessageType() == 0) {
                                                        systemMessageOooO0OO25.setType(33);
                                                        strOooO0OO3 = o0000.OooO0OO(i4);
                                                    } else {
                                                        systemMessageOooO0OO25.setType(35);
                                                        strOooO0OO3 = o0000.OooO0OO(o000000.system_mssage_title_first_month_recharge_rewards);
                                                    }
                                                    ...
                                                    o00Oo0.OooO00o().Oooo00O().OooO0O0(systemMessageOooO0OO25);
                                                }
                                                break;
                                            default:
                                                switch (type5) {
                                                    case 80:
                                                        ...
                                                        long jOooO0O17 = Oooo000.OooO0O0(mid30, "getMid(...)", msg, systemMessageModel);
                                                        o0000O00.OooO0OO("saveRechargeReward", "saveRechargeReward = " + systemMessageModel);
                                                        SystemMessage systemMessageOooO0OO26 = OooO0OO(jOooO0O17, mid30, systemMessageModel.getMessage());
                                                        systemMessageOooO0OO26.setType(34);
                                                        o00O0.OooO00o(systemMessageOooO0OO26);
                                                        strOooO0OO = o0000.OooO0OO(o000000.Recharge_Successful);
                                                        break;
                                                    case 81:
                                                        String mid31 = msg.getMid();
                                                        long jOooO0O18 = Oooo000.OooO0O0(mid31, "getMid(...)", msg, systemMessageModel);
                                                        o0000O00.OooO0OO("saveRoomMemberBadgeFrozenMessage", "model = " + systemMessageModel);
                                                        SystemMessage systemMessageOooO0OO27 = OooO0OO(jOooO0O18, mid31, systemMessageModel.getMessage());
                                                        ...
                                                        if (data23 != null) {
                                                            ...
                                                            o00Oo0.OooO00o().Oooo00O().OooO0O0(systemMessageOooO0OO27);
                                                        }
                                                        strOooO0OO = o0000.OooO0OO(o000000.member_badge_frozen_tip_title);
                                                        break;
                                                    case 82:
                                                        String mid32 = msg.getMid();
                                                        long jOooO0O19 = Oooo000.OooO0O0(mid32, "getMid(...)", msg, systemMessageModel);
                                                        o0000O00.OooO0OO("saveRoomMemberBadgeFrozenMessage", "model = " + systemMessageModel);
                                                        SystemMessage systemMessageOooO0OO28 = OooO0OO(jOooO0O19, mid32, systemMessageModel.getMessage());
                                                        ...
                                                        if (data24 != null) {
                                                            ...
                                                            o00Oo0.OooO00o().Oooo00O().OooO0O0(systemMessageOooO0OO28);
                                                        }
                                                        strOooO0OO = o0000.OooO0OO(o000000.member_badge_reward_title);
                                                        break;
                                                    case 83:
                                                        String mid33 = msg.getMid();
                                                        long jOooO0O20 = Oooo000.OooO0O0(mid33, "getMid(...)", msg, systemMessageModel);
                                                        o0000O00.OooO0OO("saveGiftBackpackExpiredMessage", "model = " + systemMessageModel);
                                                        SystemMessage systemMessageOooO0OO29 = OooO0OO(jOooO0O20, mid33, systemMessageModel.getMessage());
                                                        ...
                                                        if (data25 != null) {
                                                            ...
                                                            o00Oo0.OooO00o().Oooo00O().OooO0O0(systemMessageOooO0OO29);
                                                        }
                                                        strOooO0OO = o0000.OooO0OO(o000000.backpack_expired_system_title);
                                                        break;
                                                    case 84:
                                                        String mid34 = msg.getMid();
                                                        long jOooO0O21 = Oooo000.OooO0O0(mid34, "getMid(...)", msg, systemMessageModel);
                                                        o0000O00.OooO0OO("saveGiftBlindTaskRewardMessage", "model = " + systemMessageModel);
                                                        SystemMessage systemMessageOooO0OO30 = OooO0OO(jOooO0O21, mid34, systemMessageModel.getMessage());
                                                                ...
                                                                if (awardtype == null || awardtype.intValue() != headdressCard) {
                                                                    ...
                                                                    if (awardtype == null || awardtype.intValue() != backpackGift) {
                                                                        ...
                                                                        if (awardtype != null && awardtype.intValue() == headPortraitBox) {
                                                                            strOooO0OO4 = o0000.OooO0OO(o000000.Got_a_Profile_Frame);
                                                                        } else if (o00O00OO.OooO0o(strOooO00o2)) {
                                                                            o00O0.OooO00o(systemMessageOooO0OO30);
                                                                        }
                                                                    } else {
                                                                        o00Ooo.OooOO0O().OooOOOo(GiftPropTypeUser.Backpack.getValue(), true);
                                                                        MutableLiveData<Map<Integer, GiftPropModel>> mutableLiveData = oo0o0Oo.f43573OooO00o;
                                                                        OooOOO.OooO0OO(CoroutineScopeKt.MainScope(), new o000OOo(0L, null));
                                                                        strOooO0OO4 = o0000.OooO0OO(o000000.Got_a_Gift);
                                                                    }
                                                                } else {
                                                                    strOooO0OO4 = o0000.OooO0OO(o000000.Got_a_Hat);
                                                                }
                                                            } else {
                                                                strOooO0OO4 = o0000.OooO0OO(o000000.Got_a_Chat_Box);
                                                            }
                                                            strOooO00o2 = strOooO0OO4;
                                                            if (o00O00OO.OooO0o(strOooO00o2)) {
                                                                o00O0.OooO00o(systemMessageOooO0OO30);
                                                            }
                                                        }
                                                        break;
                                                    case 85:
                                                        ...
                                                        long jOooO0O22 = Oooo000.OooO0O0(mid35, "getMid(...)", msg, systemMessageModel);
                                                        o0000O00.OooO0OO("saveGiftBlindRankingRewardMessage", "model = " + systemMessageModel);
                                                        SystemMessage systemMessageOooO0OO31 = OooO0OO(jOooO0O22, mid35, systemMessageModel.getMessage());
                                                        ...
                                                        if (data27 != null) {
                                                            ...
                                                            if (toptype == null || toptype.intValue() != giftRankingSend) {
                                                                ...
                                                                if (toptype == null || toptype.intValue() != giftRankingReception) {
                                                                    ...
                                                                    if (o00O00OO.OooO0o(strOooO00o2)) {
                                                                        o00O0.OooO00o(systemMessageOooO0OO31);
                                                                    }
                                                                } else {
                                                                    strOooO00o = o0000O.OooO00o(o0000.OooO0OO(o000000.Received_Ranking_XXX_Rewards), String.valueOf(giftBlindRankingReward.getToprank()));
                                                                }
                                                            } else {
                                                                strOooO00o = o0000O.OooO00o(o0000.OooO0OO(o000000.Sent_Ranking_XXX_Rewards), String.valueOf(giftBlindRankingReward.getToprank()));
                                                            }
                                                            strOooO00o2 = strOooO00o;
                                                            if (data27.getAwardtype() == SystemMessage.AwardType.INSTANCE.getBackpackGift()) {
                                                                o00Ooo.OooOO0O().OooOOOo(GiftPropTypeUser.Backpack.getValue(), true);
                                                                MutableLiveData<Map<Integer, GiftPropModel>> mutableLiveData3 = oo0o0Oo.f43573OooO00o;
                                                                OooOOO.OooO0OO(CoroutineScopeKt.MainScope(), new o000OOo(0L, null));
                                                            }
                                                            if (o00O00OO.OooO0o(strOooO00o2)) {
                                                                o00O0.OooO00o(systemMessageOooO0OO31);
                                                    ...
                                                    case 86:
                                                        ...
                                                        long jOooO0O23 = Oooo000.OooO0O0(mid36, "getMid(...)", msg, systemMessageModel);
                                                        o0000O00.OooO0OO("saveVip6DistributeSupremeGiftsMessage", "model = " + systemMessageModel);
                                                        SystemMessage systemMessageOooO0OO32 = OooO0OO(jOooO0O23, mid36, systemMessageModel.getMessage());
                                                        ...
                                                        if (data28 != null) {
                                                            ...
                                                            strOooO00o2 = o0000.OooO0OO(o000000.vip6_message_notify_title);
                                                            o00Ooo.OooOO0O().OooOOOo(GiftPropTypeUser.Backpack.getValue(), true);
                                                            MutableLiveData<Map<Integer, GiftPropModel>> mutableLiveData4 = oo0o0Oo.f43573OooO00o;
                                                            OooOOO.OooO0OO(CoroutineScopeKt.MainScope(), new o000OOo(0L, null));
                                                            o00Oo0.OooO00o().Oooo00O().OooO0O0(systemMessageOooO0OO32);
                                                        }
                                                        break;
                                                    case 87:
                                                        ...
                                                        o0000O00.OooO0OO("giftBackpackUpdateMessage", "model = " + systemMessageModel);
                                                        if (systemMessageModel.getData() != null) {
                                                            o00Ooo.OooOO0O().OooOOOo(GiftPropTypeUser.Backpack.getValue(), true);
                                                            MutableLiveData<Map<Integer, GiftPropModel>> mutableLiveData5 = oo0o0Oo.f43573OooO00o;
                                                            OooOOO.OooO0OO(CoroutineScopeKt.MainScope(), new o000OOo(0L, null));
                                                        }
                                                        break;
                                                    case 88:
                                                        String mid37 = msg.getMid();
                                                        long jOooO0O24 = Oooo000.OooO0O0(mid37, "getMid(...)", msg, systemMessageModel);
                                                        o0000O00.OooO0OO("SystemMsgProcessor", " saveWealthLevelUpMsg = " + systemMessageModel);
                                                        ...
                                                        SystemMessage systemMessageOooO0OO33 = OooO0OO(jOooO0O24, mid37, systemMessageModel.getMessage());
                                                        systemMessageOooO0OO33.setWealthLevelUpInfo(wealthLevelUpInfo);
                                                        systemMessageOooO0OO33.setType(88);
                                                        o00O0.OooO00o(systemMessageOooO0OO33);
                                                        strOooO0OO = o0000.OooO0OO(o000000.message_wealth_notify_title);
                                                        break;
                                                }
                                                break;
                                        }
                        ...
                        if (OooO0Oo()) {
                            int i5 = o000000.notify_new_message;
                    ...
                    o0000O00.OooO0OO("saveGiveThemeMsg", " saveGiveThemeMsg = " + systemMessageModel);
                    ...
                    if (data32 != null) {
                        ...
                        o00O0.OooO00o(systemMessageOooO0OO34);
                    }
                    strOooO0OO = o0000.OooO0OO(o000000.message_give_theme_reimburse_title);
                }
                strOooO0OO2 = strOooO00o2;
                if (OooO0Oo()) {
                    int i6 = o000000.notify_new_message;
            ...
            o0000O00.OooO0OO("SystemMsgProcessor", " saveTreasureBoxWinMsg = " + systemMessageModel);
            ...
            if (data33 != null) {
                ...
                o00O0.OooO00o(systemMessageOooO0OO35);
            }
            strOooO0OO = o0000.OooO0OO(o000000.system_message_treasure_win);
        }
        strOooO0OO2 = strOooO0OO;
        if (OooO0Oo()) {
            int i7 = o000000.notify_new_message;
