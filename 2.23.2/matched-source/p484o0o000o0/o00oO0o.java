...
public final class o00oO0o {
    ...
    public static final class OooO00o extends Lambda implements Function0<Unit> {
        ...
        public static final OooO00o f48659OooO0Oo = new OooO00o();
    ...
    public static final class OooO0O0 extends Lambda implements Function0<Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO0O0 f48660OooO0Oo = new OooO0O0();
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ int f48661OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ Object f48662OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f48663OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(int i, int i2, Object obj, Continuation<? super OooO0OO> continuation) {
            super(2, continuation);
            this.f48661OooO0Oo = i;
            this.f48663OooO0o0 = i2;
            this.f48662OooO0o = obj;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0OO(this.f48661OooO0Oo, this.f48663OooO0o0, this.f48662OooO0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            o00oO0o.OooO00o(this.f48661OooO0Oo, this.f48663OooO0o0, this.f48662OooO0o);
            return Unit.INSTANCE;
        }
    }
    ...
    public static void OooO00o(int i, int i2, Object obj) {
        ...
        o0000O00.OooO0OO("RoomErrorHandler", sbOooO00o.toString());
        if (i != 0) {
            try {
                if (i == 1) {
                    ...
                    String strOooO0OO = o0000.OooO0OO(o000000.Unknown_Failure);
                ...
                if (i == 1037) {
                    String strOooO0OO2 = o0000.OooO0OO(o000000.You_are_unable_to_ban_kick_out_Duke);
                ...
                if (i == 1038) {
                    String strOooO0OO3 = o0000.OooO0OO(o000000.You_are_unable_to_ban_kick_out_Emperor);
                ...
                if (i == 5000) {
                    String strOooO0OO4 = o0000.OooO0OO(o000000.face_has_expired);
                ...
                if (i == 5001) {
                    String strOooO0OO5 = o0000.OooO0OO(o000000.face_has_sold_out);
                ...
                switch (i) {
                    case 1001:
                        Lazy lazy2 = OooOO0.f48912OooO00o;
                        ...
                        OooOO0.OooO00o(customLogModel2);
                        OooO0Oo(o0000.OooO0OO(o000000.microom_code_1001));
                        break;
                    case 1035:
                        ...
                        break;
                    case 1040:
                        String strOooO0OO6 = o0000.OooO0OO(o000000.Sorry_the_number_of_members_in_this_room_has_reached_the_maximum_please_contact_the_owner);
                    ...
                    case 1055:
                        ...
                        break;
                    case 1058:
                        String strOooO0OO7 = o0000.OooO0OO(o000000.error_friend_add_unacceptable_word);
                        if (!(strOooO0OO7 == null || StringsKt.isBlank(strOooO0OO7))) {
                            ...
                            if (!Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                                o000O00O.f13422OooO0O0.post(runnable7);
                            } else {
                                runnable7.run();
                            }
                        }
                    ...
                    case 1070:
                        try {
                            ...
                            if (from != null) {
                                ...
                                OooO0Oo(o0000O.OooO00o(o0000.OooO0OO(o000000.room_voice_card_protected), String.valueOf(protectedTimeLeft / 60), String.valueOf(protectedTimeLeft % 60)));
                            }
                        } catch (InvalidProtocolBufferException e) {
                            o0000O00.OooO0O0("RoomErrorCode.Voice_Card_Protection_Cover " + e.getMessage());
                            return;
                        }
                        break;
                    case ZegoConstants.StreamUpdateType.Deleted /* 2002 */:
                        ...
                        break;
                    case 4000:
                        String strOooO0OO8 = o0000.OooO0OO(o000000.room_vote_game_exist);
                        if (!(strOooO0OO8 == null || StringsKt.isBlank(strOooO0OO8))) {
                            ...
                            if (!Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                                o000O00O.f13422OooO0O0.post(runnable8);
                            } else {
                                runnable8.run();
                            }
                        }
                    ...
                    case 4155:
                        ...
                        o000O00.OooO0O0(o0000.OooO0OO(o000000.gift_sold_out));
                        break;
                    case 6000:
                        Context context = o000O00O.f13421OooO00o;
                        Activity activityOooO0O0 = com.code.android.util.OooO0O0.OooO0O0();
                        ...
                        if (fragmentActivity != null) {
                            p423o0OoO0OO.oo0o0Oo.OooO00o(fragmentActivity, new m5(o00Oo0.f48657OooO0Oo));
                        }
                        break;
                    case 10041:
                        OooO0Oo(o0000.OooO0OO(o000000.microom_code_1005));
                        break;
                    case 10070:
                        Boolean value = oooO00o.OooO00o().f24559OooOoO.getValue();
                        if (value == null) {
                            value = Boolean.FALSE;
                        }
                        oooO00o.OooO00o().f24559OooOoO.postValue(Boolean.valueOf(value.booleanValue()));
                    ...
                    default:
                        switch (i) {
                            case 1003:
                                OooO0Oo(o0000.OooO0OO(o000000.microom_code_1003));
                                break;
                            case 1004:
                            ...
                            case 1006:
                                ...
                                break;
                            case 1007:
                                OooO0Oo(o0000.OooO0OO(o000000.microom_code_1007));
                                break;
                            case 1008:
                                if (!oooO00o.OooO00o().OooOOO()) {
                                    o000O00.OooO0O0(o0000.OooO0OO(o000000.microom_code_1008_));
                                } else {
                                    o000O00.OooO0O0(o0000.OooO0OO(o000000.microom_code_1008));
                                }
                                break;
                            case 1009:
                                OooO0Oo(o0000.OooO0OO(o000000.microom_code_1009));
                                break;
                            case 1010:
                                OooO0Oo(o0000.OooO0OO(o000000.microom_code_1010));
                                break;
                            case 1011:
                                o0Oo0oo.OooO0OO(1011, 2);
                                break;
                            case 1012:
                                o0o001.OooO0OO(new o0O0o(o0O0o.Coin_NotEnough, ""));
                                break;
                            case 1013:
                                OooO0Oo(o0000.OooO0OO(o000000.microom_code_1013));
                                break;
                            case 1014:
                            ...
                            case 1015:
                                ...
                                break;
                            case 1016:
                                OooO0Oo(o0000.OooO0OO(o000000.microom_code_1016));
                                break;
                            case 1017:
                                OooO0Oo(o0000.OooO0OO(o000000.microom_code_1017));
                                break;
                            case 1018:
                                OooO0Oo(o0000.OooO0OO(o000000.microom_code_1018));
                                break;
                            case 1019:
                                OooO0Oo(o0000.OooO0OO(o000000.microom_code_1019));
                                break;
                            case Constants.WARN_ADM_PLAYOUT_ABNORMAL_FREQUENCY /* 1020 */:
                                OooO0Oo(o0000.OooO0OO(o000000.microom_code_1020));
                                break;
                            case Constants.WARN_ADM_RECORD_ABNORMAL_FREQUENCY /* 1021 */:
                                OooO0Oo(o0000.OooO0OO(o000000.microom_code_1021));
                                break;
                            case 1022:
                                OooO0Oo(o0000.OooO0OO(o000000.microom_code_1022));
                                break;
                            default:
                                switch (i) {
                                    case LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY /* 1024 */:
                                        ...
                                        if (!Intrinsics.areEqual(com.yalla.yalla.service.room.OooO00o.OooO0OO(), com.yalla.yalla.service.room.OooO0OO.OooO0o.f24593OooO00o)) {
                                            ...
                                            com.yalla.yalla.service.room.OooO00o.f24515OooO0o.f48650OooO0O0.setValue(Boolean.TRUE);
                                        }
                                        break;
                                    case 1025:
                                        p483o0o000Oo.o000000 o000000Var = com.yalla.yalla.service.room.OooO00o.f24516OooO0o0;
                                        o000000Var.f48465OooO0oO.setValue(Integer.valueOf(((Number) o000000Var.f48465OooO0oO.getValue()).intValue() + 1));
                                        ArrayList arrayList2 = com.yalla.yalla.service.room.OooO00o.f24511OooO00o;
                                        com.yalla.yalla.service.room.OooO00o.OooO0oO(com.yalla.yalla.service.room.OooO0OO.AbstractC0317OooO0OO.OooO00o.f24591OooO00o);
                                        break;
                                    case 1026:
                                        o0Oo0oo.OooO0OO(1026, 2);
                                        p479o0o0000o.o0000O error = new p479o0o0000o.o0000O();
                                    ...
                                    default:
                                        switch (i) {
                                            case 1028:
                                                break;
                                            case 1029:
                                                String strOooO0OO9 = o0000.OooO0OO(o000000.mic_using);
                                                if (!(strOooO0OO9 == null || StringsKt.isBlank(strOooO0OO9))) {
                                                    ...
                                                    if (!Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                                                        o000O00O.f13422OooO0O0.post(runnable9);
                                                    } else {
                                                        runnable9.run();
                                                    }
                                                }
                                                break;
                                            case 1030:
                                                String strOooO0OO10 = o0000.OooO0OO(o000000.tip_locked);
                                                if (!(strOooO0OO10 == null || StringsKt.isBlank(strOooO0OO10))) {
                                                    ...
                                                    if (!Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                                                        o000O00O.f13422OooO0O0.post(runnable10);
                                                    } else {
                                                        runnable10.run();
                                                    }
                                                }
                                            ...
                                            case Constants.WARN_ADM_RECORD_AUDIO_LOWLEVEL /* 1031 */:
                                                String strOooO0OO11 = o0000.OooO0OO(o000000.mic_locked_by_ower);
                                                if (!(strOooO0OO11 == null || StringsKt.isBlank(strOooO0OO11))) {
                                                    ...
                                                    if (!Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                                                        o000O00O.f13422OooO0O0.post(runnable11);
                                                    } else {
                                                        runnable11.run();
                                                    }
                                                }
                                            ...
                                            case Constants.WARN_ADM_PLAYOUT_AUDIO_LOWLEVEL /* 1032 */:
                                                o0o001.OooO0OO(new o0O0o(o0O0o.Coin_Frozen, ""));
                                                break;
                                            case 1033:
                                                o0o001.OooO0OO(new o0O0o(o0O0o.Coin_NotEnough, ""));
                                                break;
                                            default:
                                                switch (i) {
                                                    case 1046:
                                                        ...
                                                        break;
                                                    case 1047:
                                                        OooO0Oo(o0000.OooO0OO(o000000.room_mora_code_10047));
                                                        break;
                                                    case 1048:
                                                        try {
                                                            Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type kotlin.ByteArray");
                                                            ...
                                                            OooO0Oo(o0000.OooO0OO(o000000.room_mora_code_10048));
                                                        } catch (InvalidProtocolBufferException e2) {
                                                            o0000O00.OooO0Oo("RoomErrorCode.ROOM_MORA_GAME_FAIL_1048" + e2.getMessage());
                                                            return;
                                                        }
                                                        break;
                                                    case 1049:
                                                        ...
                                                        switch (i) {
                                                            case BannerConfig.LOOP_TIME /* 3000 */:
                                                                ...
                                                                if (activityOooO0O1 != null) {
                                                                    ...
                                                                    o000o.OooOo00(o0000.OooO0OO(o000000.feature_not_available));
                                                                    o000o.OooOo(true);
                                                                    o000o.OooOOOo(o0000.OooO0OO(o000000.Update_Now));
                                                                    o000o.OooOo0(o00O0O.f48656OooO0Oo);
                                                                    o000o.OooOO0o();
                                                                }
                                                                break;
                                                            ...
                                                            case ZegoConstants.RoomError.DatiRepeatError /* 3003 */:
                                                                ...
                                                                if (str != null && (roomError3003 = (RoomError3003) OooO.OooO0O0(RoomError3003.class, str)) != null) {
                                                                    ...
                                                                    if (!(msg == null || StringsKt.isBlank(msg))) {
                                                                        ...
                                                                        if (!Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                                                                            o000O00O.f13422OooO0O0.post(runnable12);
                                                                        } else {
                                                                            runnable12.run();
                                                                        }
                                                                    }
                                                            ...
                                                            default:
                                                                switch (i) {
                                                                    case 4251:
                                                                        o000O00.OooO00o(o000000.apply_mic_is_turned_off);
                                                                        break;
                                                                    case 4252:
                                                                        ...
                                                                        if (activityOooO0O2 != null) {
                                                                            ...
                                                                            o000o2.OooOo00(o0000.OooO0OO(o000000.apply_mic_outof_max));
                                                                            o000o2.OooOo0(o00Ooo.f48658OooO0Oo);
                                                                            o000o2.OooOO0o();
                                                                        }
                                                                        break;
                                                                    case 4253:
                                                                        ...
                                                                        if (activityOooO0O3 != null) {
                                                                            ...
                                                                            o000o3.OooOo00(o0000.OooO0OO(o000000.no_mic_return_apply_list));
                                                                            o000o3.OooOo0(oo000o.f48664OooO0Oo);
                                                                            o000o3.OooOO0o();
                                                                        }
                                                                        break;
                                                                    default:
                                                                        ...
                                                                        Lazy lazy3 = OooOO0.f48912OooO00o;
                                                                        OooOO0.OooO0OO(RoomEventType.Room_Socket_UnknowErrcode);
                                                                        break;
                                                                }
                                                                break;
                                                        }
    ...
    public static void OooO0O0() {
        boolean z;
        ArrayList<ProfileLimitModel> profileLimit = MixedRoomDataSource.OooO0o0().f22991OooO0o.getProfileLimit();
        if (profileLimit != null) {
            for (ProfileLimitModel profileLimitModel : profileLimit) {
                if (profileLimitModel.getOperationType() == 3) {
                    String strOooO00o = o0000O.OooO00o(o0000.OooO0OO(o000000.RoomInfoEdit_ChangeLimit_HintContent_Sign), String.valueOf(profileLimitModel.getBlockReason()));
                    if (profileLimitModel.getExpireTime() <= 0 || (System.currentTimeMillis() / ((long) 1000)) - profileLimitModel.getExpireTime() > 0) {
                        z = false;
                    } else {
                        strOooO00o = o0000O.OooO00o(o0000O.OooO00o(o0000.OooO0OO(o000000.RoomInfoEdit_ChangeLimit_HintContent_Sign_Time), String.valueOf(profileLimitModel.getBlockReason())), o0O0O0o0.OooO0Oo(profileLimitModel.getExpireTime(), System.currentTimeMillis()));
                        z = true;
                    }
                    Context context = o000O00O.f13421OooO00o;
                    Activity activityOooO0O0 = com.code.android.util.OooO0O0.OooO0O0();
                    if (activityOooO0O0 != null) {
                        ...
                        if (z) {
                            o000o.OooOo0(OooO00o.f48659OooO0Oo);
                        } else {
                            o000o.OooOo(true);
                            o000o.OooOOOo(o0000.OooO0OO(o000000.CONTINUE_));
                            o000o.OooOo0(OooO0O0.f48660OooO0Oo);
                        }
                        o000o.OooOO0o();
                        return;
                    }
