...
public final class o0OoO00O extends OooOO0O {

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final HorizontalScrollView f49915OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @NotNull
    public final ArrayList f49916OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public boolean f49917OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @Nullable
    public RoomBroadcastView f49918OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @NotNull
    public final Lazy f49919OooO0o0;

    public static final class OooO00o extends Lambda implements Function0<o0OoOoOo> {
        public OooO00o() {
            super(0);
        }
        ...
        public final o0OoOoOo invoke() {
            ...
            o0O00 o0o01 = new o0O00(o0OoO00O.this);
            TranslateAnimation translateAnimation = o0oooooo.f49921OooO00o;
            if (translateAnimation == null) {
                if (translateAnimation == null) {
                    TranslateAnimation translateAnimation2 = new TranslateAnimation(2, 1.0f, 1, -1.0f, 2, 0.0f, 2, 0.0f);
                    o0oooooo.f49921OooO00o = translateAnimation2;
                    Intrinsics.checkNotNull(translateAnimation2);
                    translateAnimation2.setInterpolator(new LinearInterpolator());
                    TranslateAnimation translateAnimation3 = o0oooooo.f49921OooO00o;
                    Intrinsics.checkNotNull(translateAnimation3);
                    translateAnimation3.setDuration(8000L);
                }
                o0oooooo.f49921OooO00o = o0oooooo.f49921OooO00o;
            }
            TranslateAnimation translateAnimation4 = o0oooooo.f49922OooO0O0;
            if (translateAnimation4 == null) {
                if (translateAnimation4 == null) {
                    TranslateAnimation translateAnimation5 = new TranslateAnimation(1, -1.0f, 2, 1.0f, 2, 0.0f, 2, 0.0f);
                    o0oooooo.f49922OooO0O0 = translateAnimation5;
                    Intrinsics.checkNotNull(translateAnimation5);
                    translateAnimation5.setInterpolator(new LinearInterpolator());
                    TranslateAnimation translateAnimation6 = o0oooooo.f49922OooO0O0;
                    Intrinsics.checkNotNull(translateAnimation6);
                    translateAnimation6.setDuration(8000L);
                }
                o0oooooo.f49922OooO0O0 = o0oooooo.f49922OooO0O0;
            }
            TranslateAnimation translateAnimation7 = o0oooooo.f49921OooO00o;
            Intrinsics.checkNotNull(translateAnimation7);
            translateAnimation7.setAnimationListener(o0o01);
            TranslateAnimation translateAnimation8 = o0oooooo.f49922OooO0O0;
            Intrinsics.checkNotNull(translateAnimation8);
            translateAnimation8.setAnimationListener(o0o01);
            return o0oooooo;
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0OoO00O(@NotNull MixedRoomActivity roomActivity) {
        super(roomActivity);
        Intrinsics.checkNotNullParameter(roomActivity, "roomActivity");
        HorizontalScrollView horizontalScrollView = (HorizontalScrollView) roomActivity.findViewById(o0OO00O.roomBroadcastScroll);
        this.f49915OooO0O0 = horizontalScrollView;
        this.f49916OooO0OO = new ArrayList();
        this.f49919OooO0o0 = LazyKt.lazy(new OooO00o());
        horizontalScrollView.setOnTouchListener(new o0O000Oo());
    }

    public static final void OooO0OO(o0OoO00O o0ooo00o2) {
        HorizontalScrollView horizontalScrollView = o0ooo00o2.f49915OooO0O0;
        if (horizontalScrollView != null) {
            horizontalScrollView.removeAllViews();
            horizontalScrollView.setVisibility(8);
        }
        o0ooo00o2.f49917OooO0Oo = false;
        ArrayList<RoomBroadcastModel> arrayList = o0ooo00o2.f49916OooO0OO;
        if (arrayList.size() > 0) {
            ArrayList arrayList2 = new ArrayList();
            ArrayList arrayList3 = new ArrayList();
            MixedRoomDataSource.OooO0o0().getClass();
            if (com.yalla.yalla.service.room.OooO00o.f24516OooO0o0.OooO0o0() != 0) {
    ...
    public final void OooO0Oo(RoomBroadcastModel roomBroadcastModel) {
        ...
        ArrayList arrayList = this.f49916OooO0OO;
        if (roominfo != null) {
    ...
    public final void OooO0o() {
        ...
        if (roomBroadcastModel != null) {
            boolean z2 = true;
            this.f49917OooO0Oo = true;
            HorizontalScrollView horizontalScrollView = this.f49915OooO0O0;
            horizontalScrollView.setVisibility(0);
            arrayList.remove(roomBroadcastModel);
            if (this.f49918OooO0o == null) {
                RoomBroadcastView roomBroadcastView = new RoomBroadcastView(this.f49626OooO00o);
                this.f49918OooO0o = roomBroadcastView;
                Intrinsics.checkNotNull(roomBroadcastView);
                roomBroadcastView.setRoomBroadcastNewAnimation((o0OoOoOo) this.f49919OooO0o0.getValue());
            }
            RoomBroadcastView roomBroadcastView2 = this.f49918OooO0o;
            Intrinsics.checkNotNull(roomBroadcastView2);
            roomBroadcastView2.f30746OooO0o0 = roomBroadcastModel;
            o0000O00.OooO0O0("RoomBroadcastView\ndata.type = " + Integer.valueOf(roomBroadcastModel.getType()) + "\ndata = " + OooO.OooO00o(roomBroadcastModel));
            u0 u0Var = roomBroadcastView2.f30744OooO0Oo;
            RoomBroadcastViewVip6 layoutVip6 = u0Var.f45572OooO0OO;
            Intrinsics.checkNotNullExpressionValue(layoutVip6, "layoutVip6");
            o000O.OooO0O0(layoutVip6);
            RoomBroadcastViewAll layoutAll = u0Var.f45571OooO0O0;
            ...
            if (roomBroadcastModel.getType() != 19) {
                ...
                Boolean boolValueOf = Boolean.valueOf(o000000O.OooO0O0(roomBroadcastModel));
                Boolean boolValueOf2 = Boolean.valueOf(roomBroadcastModel.getShoweffectflag() == 1);
                Boolean boolValueOf3 = Boolean.valueOf(o000000O.OooO0OO(roomBroadcastModel));
                o0000O00.OooO0O0("RoomBroadcastView Vip6 \nisFromUserVip6 = " + z3 + "\nisGiftEffectFlag = " + boolValueOf2 + "\nisGiftTotalType = " + boolValueOf + "\nisGiftTotal1799 = " + boolValueOf3);
                if (z3) {
                ...
                if (z) {
                    RoomBroadcastViewVip6 layoutVip7 = u0Var.f45572OooO0OO;
                ...
                LinearLayout linearLayout = u0Var.f45570OooO00o;
                if (type == 21 || type == 22) {
            ...
            if (z2) {
                horizontalScrollView.removeAllViews();
                RoomBroadcastView roomBroadcastView3 = this.f49918OooO0o;
                Intrinsics.checkNotNull(roomBroadcastView3);
                horizontalScrollView.addView(roomBroadcastView3.getRootView());
                RoomBroadcastView roomBroadcastView4 = this.f49918OooO0o;
                Intrinsics.checkNotNull(roomBroadcastView4);
                o0O000o0 onFailureCallBack = new o0O000o0(this);
                u0 u0Var2 = roomBroadcastView4.f30744OooO0Oo;
                ...
                try {
                    ...
                    int measuredWidth = u0Var2.f45570OooO00o.getMeasuredWidth();
                    o0OoOoOo o0oooooo = roomBroadcastView4.f30747OooO0oO;
                    if (o0oooooo == null) {
                        unit = null;
                    } else {
                        TranslateAnimation translateAnimation = OooOo00.OooO0o0() ? o0oooooo.f49922OooO0O0 : o0oooooo.f49921OooO00o;
                        if (translateAnimation != null) {
                            Resources system = Resources.getSystem();
                            Intrinsics.checkExpressionValueIsNotNull(system, "Resources.getSystem()");
                            int i = (int) ((measuredWidth / system.getDisplayMetrics().density) + 0.5f);
                            int i2 = roomBroadcastView4.f30745OooO0o;
                            translateAnimation.setDuration(i2 + ((i * i2) / 360));
                            u0Var2.f45570OooO00o.startAnimation(translateAnimation);
                            unit = Unit.INSTANCE;
                        } else {
                            unit = null;
                        }
                ...
                if (thM4218exceptionOrNullimpl != null) {
                    o0000O00.OooO0O0("startInAnimation  onFailure    " + thM4218exceptionOrNullimpl);
    ...
    public final void OooO0o0(@NotNull RoomBroadcastModel data) {
        ...
        o0000O00.OooO0O0("收到广播 data.getType = " + data.getType() + ", broadcast = " + OooO.OooO00o(data));
        if (data.getType() != 11) {
            OooO0Oo(data);
        ...
        if (Intrinsics.areEqual(OooOo00.OooO0O0(), data.getLang())) {
            OooO0Oo(data);
            OooO0o();
        } else if (Intrinsics.areEqual(data.getLang(), "id") && OooOo00.OooO0OO() == 3) {
            OooO0Oo(data);
            OooO0o();
        }
    }
