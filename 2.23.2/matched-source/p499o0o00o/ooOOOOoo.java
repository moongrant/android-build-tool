...
public final class ooOOOOoo {
    ...
    @NotNull
    public static final ooOOOOoo f50100OooO00o = new ooOOOOoo();

    public static final class OooO extends Lambda implements Function2<Composer, Integer, Unit> {

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f50102OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(int i) {
            super(2);
            this.f50102OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f50102OooO0o0 | 1);
    ...
    public static final class OooO00o extends Lambda implements Function1<DisposableEffectScope, DisposableEffectResult> {
        ...
        public final /* synthetic */ MutableState<BaseWebView> f50103OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MutableState<String> f50104OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(MutableState<BaseWebView> mutableState, MutableState<String> mutableState2) {
            super(1);
            this.f50103OooO0Oo = mutableState;
            this.f50104OooO0o0 = mutableState2;
        }
        ...
        public final DisposableEffectResult invoke(DisposableEffectScope disposableEffectScope) {
            ...
            return new oO000OOo(this.f50103OooO0Oo, this.f50104OooO0o0);
        }
    }
    ...
    public static final class OooO0O0 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO0O0 f50105OooO0Oo = new OooO0O0();
    ...
    public static final class OooO0OO extends Lambda implements Function3<AnimatedVisibilityScope, Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f50106OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ MixedRoomActivity f50107OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MutableState<BaseWebView> f50108OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ MutableState<String> f50109OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f50110OooO0oo;
        ...
        public OooO0OO(MutableState<Boolean> mutableState, MutableState<BaseWebView> mutableState2, MixedRoomActivity mixedRoomActivity, MutableState<String> mutableState3, MutableState<Boolean> mutableState4) {
            super(3);
            this.f50106OooO0Oo = mutableState;
            this.f50108OooO0o0 = mutableState2;
            this.f50107OooO0o = mixedRoomActivity;
            this.f50109OooO0oO = mutableState3;
            this.f50110OooO0oo = mutableState4;
        }
        ...
        public final Unit invoke(AnimatedVisibilityScope animatedVisibilityScope, Composer composer, Integer num) {
            ...
            int i = OooO00o.$EnumSwitchMapping$0[((TurntableGameState) SnapshotStateKt.collectAsState(com.yalla.yalla.service.room.OooO00o.f24520OooOO0O.f48511OooO0O0, null, composer2, 8, 1).getValue()).ordinal()];
            if (i != 1) {
                if (i == 2) {
                    composer2.startReplaceableGroup(-1101860771);
                    strStringResource = StringResources_androidKt.stringResource(o000000.Waiting, composer2, 0);
                    ...
                    strStringResource2 = StringResources_androidKt.stringResource(o000000.Playing, composer2, 0);
                    composer2.endReplaceableGroup();
                ...
                oooooooo.OooO0O0(str2, str3, this.f50106OooO0Oo, this.f50108OooO0o0, this.f50107OooO0o, this.f50109OooO0oO, this.f50110OooO0oo, composer2, 14388608);
                if (ComposerKt.isTraceInProgress()) {
            ...
            strStringResource = StringResources_androidKt.stringResource(o000000.room_game_box_lucky_wheel, composer2, 0);
            composer2.endReplaceableGroup();
            strStringResource2 = strStringResource;
            str = "svga/room_turntable_wait.svga";
            str2 = str;
            ooOOOOoo oooooooo2 = ooOOOOoo.f50100OooO00o;
            if (strStringResource2 == null) {
                str3 = "";
            } else {
                str3 = strStringResource2;
            }
            oooooooo2.OooO0O0(str2, str3, this.f50106OooO0Oo, this.f50108OooO0o0, this.f50107OooO0o, this.f50109OooO0oO, this.f50110OooO0oo, composer2, 14388608);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            return Unit.INSTANCE;
    ...
    public static final class OooO0o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f50112OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(int i) {
            super(2);
            this.f50112OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f50112OooO0o0 | 1);
            ooOOOOoo.this.OooO00o(composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ MixedRoomActivity f50113OooO;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ String f50115OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ String f50116OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f50117OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ MutableState<BaseWebView> f50118OooO0oo;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public final /* synthetic */ MutableState<String> f50119OooOO0;

        /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f50120OooOO0O;

        /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
        public final /* synthetic */ int f50121OooOO0o;
        ...
        public OooOO0(String str, String str2, MutableState<Boolean> mutableState, MutableState<BaseWebView> mutableState2, MixedRoomActivity mixedRoomActivity, MutableState<String> mutableState3, MutableState<Boolean> mutableState4, int i) {
            super(2);
            this.f50116OooO0o0 = str;
            this.f50115OooO0o = str2;
            this.f50117OooO0oO = mutableState;
            this.f50118OooO0oo = mutableState2;
            this.f50113OooO = mixedRoomActivity;
            this.f50119OooOO0 = mutableState3;
            this.f50120OooOO0O = mutableState4;
            this.f50121OooOO0o = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            ooOOOOoo.this.OooO0O0(this.f50116OooO0o0, this.f50115OooO0o, this.f50117OooO0oO, this.f50118OooO0oo, this.f50113OooO, this.f50119OooOO0, this.f50120OooOO0O, composer, RecomposeScopeImplKt.updateChangedFlags(this.f50121OooOO0o | 1));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0O extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f50122OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ MixedRoomActivity f50123OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MutableState<BaseWebView> f50124OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ MutableState<String> f50125OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f50126OooO0oo;
        ...
        public OooOO0O(MutableState<Boolean> mutableState, MutableState<BaseWebView> mutableState2, MixedRoomActivity mixedRoomActivity, MutableState<String> mutableState3, MutableState<Boolean> mutableState4) {
            super(0);
            this.f50122OooO0Oo = mutableState;
            this.f50124OooO0o0 = mutableState2;
            this.f50123OooO0o = mixedRoomActivity;
            this.f50125OooO0oO = mutableState3;
            this.f50126OooO0oo = mutableState4;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            oO0OOo0o onLogin = new oO0OOo0o(this.f50122OooO0Oo, this.f50124OooO0o0, this.f50123OooO0o, this.f50125OooO0oO, this.f50126OooO0oo);
    ...
    public static final class OooOOO implements BaseWebView.OooO0OO {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f50127OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f50128OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final /* synthetic */ MutableState<BaseWebView> f50129OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MutableState<String> f50130OooO0Oo;
        ...
        public OooOOO(MutableState<Boolean> mutableState, MutableState<Boolean> mutableState2, MutableState<BaseWebView> mutableState3, MutableState<String> mutableState4) {
            this.f50127OooO00o = mutableState;
            this.f50128OooO0O0 = mutableState2;
            this.f50129OooO0OO = mutableState3;
            this.f50130OooO0Oo = mutableState4;
        }
        ...
        public final void OooO0O0(boolean z) {
            o0000O00.OooO0OO("createAndShowGame", "success = " + z);
            Boolean bool = Boolean.FALSE;
            MutableState<Boolean> mutableState = this.f50127OooO00o;
            mutableState.setValue(bool);
            Boolean bool2 = Boolean.TRUE;
            this.f50128OooO0O0.setValue(bool2);
            if (z) {
                ...
                if (o0000oo1.f48511OooO0O0.getValue() != TurntableGameState.Close) {
                    o0000oo1.f48513OooO0Oo.setValue(bool2);
                    o0000oo1.f48512OooO0OO.setValue(bool2);
                    return;
                }
                return;
            }
            this.f50130OooO0Oo.setValue("");
            mutableState.setValue(bool);
            BaseWebView value = this.f50129OooO0OO.getValue();
            if (value != null) {
                o000O.OooO0O0(value);
            }
            com.yalla.yalla.service.room.OooO00o.f24520OooOO0O.f48510OooO00o.setValue(bool);
        }
    }
    ...
    public static final class OooOOO0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO, reason: collision with root package name */
        public final /* synthetic */ MixedRoomActivity f50131OooO;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ String f50133OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ String f50134OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f50135OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ MutableState<BaseWebView> f50136OooO0oo;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public final /* synthetic */ MutableState<String> f50137OooOO0;

        /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f50138OooOO0O;

        /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
        public final /* synthetic */ int f50139OooOO0o;
        ...
        public OooOOO0(String str, String str2, MutableState<Boolean> mutableState, MutableState<BaseWebView> mutableState2, MixedRoomActivity mixedRoomActivity, MutableState<String> mutableState3, MutableState<Boolean> mutableState4, int i) {
            super(2);
            this.f50134OooO0o0 = str;
            this.f50133OooO0o = str2;
            this.f50135OooO0oO = mutableState;
            this.f50136OooO0oo = mutableState2;
            this.f50131OooO = mixedRoomActivity;
            this.f50137OooOO0 = mutableState3;
            this.f50138OooOO0O = mutableState4;
            this.f50139OooOO0o = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            ooOOOOoo.this.OooO0O0(this.f50134OooO0o0, this.f50133OooO0o, this.f50135OooO0oO, this.f50136OooO0oo, this.f50131OooO, this.f50137OooOO0, this.f50138OooOO0O, composer, RecomposeScopeImplKt.updateChangedFlags(this.f50139OooOO0o | 1));
            return Unit.INSTANCE;
        }
    }

    public static final class OooOOOO extends oO0o0000 {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final /* synthetic */ MixedRoomActivity f50140OooO00o;
        ...
        public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                o0000OO0 o0000oo1 = com.yalla.yalla.service.room.OooO00o.f24520OooOO0O;
                MutableStateFlow<Boolean> mutableStateFlow = o0000oo1.f48513OooO0Oo;
                Boolean bool = Boolean.FALSE;
                mutableStateFlow.setValue(bool);
                o0000oo1.f48512OooO0OO.setValue(bool);
                return Unit.INSTANCE;
            }
        }

        public OooOOOO(MixedRoomActivity mixedRoomActivity) {
            this.f50140OooO00o = mixedRoomActivity;
        }
        ...
        @JavascriptInterface
        public void zoomOut() {
            BuildersKt__Builders_commonKt.launch$default(LifecycleOwnerKt.getLifecycleScope(this.f50140OooO00o), null, null, new OooO00o(null), 3, null);
        }
    }
    ...
    public static final class OooOo implements Observer, FunctionAdapter {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function1 f50141OooO0Oo;

        public OooOo(OooOo00 function) {
            Intrinsics.checkNotNullParameter(function, "function");
            this.f50141OooO0Oo = function;
        }
        ...
        public final boolean equals(@Nullable Object obj) {
            ...
            return Intrinsics.areEqual(this.f50141OooO0Oo, ((FunctionAdapter) obj).getFunctionDelegate());
        }

        @Override // kotlin.jvm.internal.FunctionAdapter
        @NotNull
        public final Function<?> getFunctionDelegate() {
            return this.f50141OooO0Oo;
        }

        public final int hashCode() {
            return this.f50141OooO0Oo.hashCode();
        }

        @Override // androidx.lifecycle.Observer
        public final /* synthetic */ void onChanged(Object obj) {
            this.f50141OooO0Oo.invoke(obj);
        }
    }
    ...
    public static final class OooOo00 extends Lambda implements Function1<String, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MutableState<String> f50142OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ MutableState<BaseWebView> f50143OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f50144OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f50145OooO0oO;
        ...
        public OooOo00(MutableState<String> mutableState, MutableState<Boolean> mutableState2, MutableState<BaseWebView> mutableState3, MutableState<Boolean> mutableState4) {
            super(1);
            this.f50142OooO0Oo = mutableState;
            this.f50144OooO0o0 = mutableState2;
            this.f50143OooO0o = mutableState3;
            this.f50145OooO0oO = mutableState4;
        }

        @Override // kotlin.jvm.functions.Function1
        public final Unit invoke(String str) {
            String str2 = str;
            MutableState<String> mutableState = this.f50142OooO0Oo;
            boolean zAreEqual = Intrinsics.areEqual(mutableState.getValue(), str2);
            MutableState<Boolean> mutableState2 = this.f50145OooO0oO;
            MutableState<Boolean> mutableState3 = this.f50144OooO0o0;
            if (zAreEqual) {
                ...
                String strOooO0O0 = c1.OooO0O0(c1.OooO0OO(c1.OooO00o(str2), null), ContributionFragment.ARG_1, String.valueOf(com.yalla.yalla.service.room.OooO0O0.f24533OoooOOO.OooO00o().f24539OooO0Oo.getValue()));
                o0000O00.OooO0OO("SharedUrlManager", "url = " + strOooO0O0);
                BaseWebView value = this.f50143OooO0o.getValue();
                if (value != null) {
    ...
    public final void OooO00o(@Nullable Composer composer, int i) {
        ...
        if ((i2 & 11) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            if (objRememberedValue3 == companion.getEmpty()) {
                objRememberedValue3 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(mixedRoomActivity.findViewById(o0OO00O.v_room_root), null, 2, null);
            ...
            o00O0000.OooO00o(observable, new Observer() { // from class: o0o00o.oO0o0o
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object it) {
                    ...
                    ooOOOOoo oooooooo = ooOOOOoo.f50100OooO00o;
                    o0000OO0 o0000oo1 = OooO00o.f24520OooOO0O;
                    if (o0000oo1.f48511OooO0O0.getValue() == TurntableGameState.Close) {
                        o0000oo1.f48511OooO0O0.setValue(TurntableGameState.Setting);
                    }
                    oooooooo.OooO0OO(showProgress, webView, activity, currentUrl, loadFinish);
                }
            }, composerStartRestartGroup, 72);
            o0000OO0 o0000oo1 = com.yalla.yalla.service.room.OooO00o.f24520OooOO0O;
            Object value = SnapshotStateKt.collectAsState(o0000oo1.f48511OooO0O0, null, composerStartRestartGroup, 8, 1).getValue();
            TurntableGameState turntableGameState = TurntableGameState.Close;
            MutableStateFlow<Boolean> mutableStateFlow = o0000oo1.f48512OooO0OO;
            if (value == turntableGameState) {
                ...
                if ((baseWebView3 != null ? baseWebView3.getParent() : null) != null && o000O.OooO0o0(baseWebView3)) {
                    o0000oo1.f48513OooO0Oo.setValue(Boolean.TRUE);
                }
                mutableStateFlow.setValue(bool);
                ...
                if ((baseWebView4 != null ? baseWebView4.getParent() : null) != null && o000O.OooO0o0(baseWebView4)) {
                    ...
                    LifecycleOwnerKt.getLifecycleScope(mixedRoomActivity).launchWhenCreated(new oO000Oo0(mutableState2, null));
                }
                ...
                o00O0000.OooO00o(observable2, new Observer() { // from class: o0o00o.oO0OoOO0
                    @Override // androidx.lifecycle.Observer
                    public final void onChanged(Object obj) {
                        ...
                        Intrinsics.checkNotNullParameter(currentUrl, "$currentUrl");
                        Intrinsics.checkNotNullParameter(loadFinish, "$loadFinish");
                        if (OooO00o.f24520OooOO0O.f48513OooO0Oo.getValue().booleanValue()) {
                            o0O00oO0 o0o00oo1 = o0O00oO0.f47936OooO00o;
                            if (Intrinsics.areEqual(o0O00oO0.OooOo0O().getValue(), Boolean.TRUE)) {
                                ooOOOOoo.f50100OooO00o.OooO0OO(showProgress, webView, activity, currentUrl, loadFinish);
                            }
                        }
                    }
                }, composerStartRestartGroup, 72);
                ...
                o00O0000.OooO00o(observable3, new Observer() { // from class: o0o00o.oO0Oo0oo
                    @Override // androidx.lifecycle.Observer
                    public final void onChanged(Object obj) {
                        MutableState<Boolean> showProgress = mutableState5;
                        MutableState<BaseWebView> webView = mutableState3;
                        ...
                        Intrinsics.checkNotNullParameter(currentUrl, "$currentUrl");
                        Intrinsics.checkNotNullParameter(loadFinish, "$loadFinish");
                        if (OooO00o.f24520OooOO0O.f48511OooO0O0.getValue() != TurntableGameState.Close) {
                            ooOOOOoo.f50100OooO00o.OooO0OO(showProgress, webView, activity, currentUrl, loadFinish);
                            return;
                        }
                        String strOooO0OO = o0000.OooO0OO(o000000.lucky_wheel_ended);
            ...
            o00O0000.OooO00o(observable4, new Observer() { // from class: o0o00o.oO0OoOO0
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    MutableState<Boolean> showProgress = mutableState5;
                    MutableState<BaseWebView> webView = mutableState3;
            ...
            o00O0000.OooO00o(observable5, new Observer() { // from class: o0o00o.oO0Oo0oo
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    MutableState<Boolean> showProgress = mutableState5;
                    MutableState<BaseWebView> webView = mutableState3;
    ...
    public final void OooO0O0(@Nullable String str, @NotNull String text, @NotNull MutableState<Boolean> showProgress, @NotNull MutableState<BaseWebView> webView, @NotNull MixedRoomActivity activity, @NotNull MutableState<String> currentUrl, @NotNull MutableState<Boolean> loadFinish, @Nullable Composer composer, int i) {
        ...
        o00OO00O.OooO00o(str, true, 0, null, null, boxScopeInstance.align(SizeKt.m525size3ABfNKs(companion, Dp.m3775constructorimpl(40)), companion2.getCenter()), composerStartRestartGroup, 48, 28);
        ...
        TextKt.m1261Text4IGK_g(text, PaddingKt.m482paddingqDBjuR0$default(companion, 0.0f, Dp.m3775constructorimpl(4), 0.0f, 0.0f, 13, null), o0OOo000.f48147OooOOOO, TextUnitKt.getSp(10), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, TextAlign.m3674boximpl(TextAlign.INSTANCE.m3681getCentere0LSkKk()), 0L, 0, false, 2, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composerStartRestartGroup, ((i >> 3) & 14) | 3120, 3072, 122352);
    ...
    public final synchronized void OooO0OO(MutableState<Boolean> mutableState, MutableState<BaseWebView> mutableState2, MixedRoomActivity mixedRoomActivity, MutableState<String> mutableState3, MutableState<Boolean> mutableState4) {
        ...
        if (Intrinsics.areEqual(value, bool)) {
            ...
            o00000OO.f56666OooO0oo.observe(mixedRoomActivity, new OooOo(new OooOo00(mutableState3, mutableState4, mutableState2, mutableState)));
        }
    }
}
