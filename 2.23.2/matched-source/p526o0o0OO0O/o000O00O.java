...
public final class o000O00O {
    ...
    @NotNull
    public final FragmentActivity f53306OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public final ShareLogViewModel f53307OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @NotNull
    public final String f53308OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public final String f53309OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final int f53310OooO0o0;
    ...
    public static final class OooO0O0 extends Lambda implements Function1<String, Unit> {
        ...
        public final /* synthetic */ String f53312OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ String f53313OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ ShareContentModel f53314OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ String f53315OooO0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(String str, String str2, ShareContentModel shareContentModel, String str3) {
            super(1);
            this.f53313OooO0o0 = str;
            this.f53312OooO0o = str2;
            this.f53314OooO0oO = shareContentModel;
            this.f53315OooO0oo = str3;
        }
        ...
        public final Unit invoke(String str) {
            ...
            ShareContentModel shareContentModel = this.f53314OooO0oO;
            String str3 = this.f53315OooO0oo;
            o000O00O o000o00o2 = o000O00O.this;
            o000O0 o000o0 = new o000O0(o000o00o2, shareContentModel, str3);
            o000o00o2.getClass();
            String str4 = this.f53313OooO0o0;
            boolean z5 = str4 == null || str4.length() == 0;
            String str5 = this.f53312OooO0o;
            if (z5) {
                if (imagePath == null || imagePath.length() == 0) {
                    if (!(str5 == null || str5.length() == 0)) {
                        fragmentActivity = o000o00o2.f53306OooO00o;
                        if (fragmentActivity instanceof BaseAppCompatActivity) {
                            ((BaseAppCompatActivity) fragmentActivity).f24677OooO0o0 = new o000O0Oo(o000o00o2);
                        }
                        ...
                        while (true) {
                            ...
                            str2 = o000o00o2.f53308OooO0OO;
                            if (StringsKt__StringsJVMKt.startsWith$default(packageName, str2, false, 2, null)) {
                        ...
                        if (intent == null) {
                            ...
                            String str6 = String.format(o000o00o2.f53309OooO0Oo, Arrays.copyOf(new Object[]{OooO.OooO0oO(str4), OooO.OooO0oO(str5)}, 2));
                        ...
                        fragmentActivity.startActivityForResult(intent, o000o00o2.f53310OooO0o0);
                        o000o0.invoke();
                    }
                } else {
                    fragmentActivity = o000o00o2.f53306OooO00o;
                    ...
                    if (intent == null) {
                        ...
                        String str7 = String.format(o000o00o2.f53309OooO0Oo, Arrays.copyOf(new Object[]{OooO.OooO0oO(str4), OooO.OooO0oO(str5)}, 2));
                ...
                if (intent == null) {
                    ...
                    String str8 = String.format(o000o00o2.f53309OooO0Oo, Arrays.copyOf(new Object[]{OooO.OooO0oO(str4), OooO.OooO0oO(str5)}, 2));
    ...
    public o000O00O(@NotNull FragmentActivity activity) {
        Intrinsics.checkNotNullParameter(activity, "activity");
        this.f53306OooO00o = activity;
        this.f53307OooO0O0 = (ShareLogViewModel) new ViewModelProvider(activity).get(ShareLogViewModel.class);
        this.f53308OooO0OO = "com.twitter.android";
        this.f53309OooO0Oo = "https://twitter.com/intent/tweet?text=%s&url=%s";
        this.f53310OooO0o0 = 1702;
        if (activity == null) {
        ...
        String strOooO0o0 = oo000oo0OooO0o.OooO0o0(String.valueOf(-59014420), o0000.OooO0OO(o000000.single_twitter_key));
        oO000Oo0 oo000oo0OooO0o2 = o00Ooo.OooO0o();
        oo000oo0OooO0o2.getClass();
        com.twitter.sdk.android.core.o00Ooo o00ooo2 = new com.twitter.sdk.android.core.o00Ooo(applicationContext, oooO0OO, new TwitterAuthConfig(strOooO0o0, oo000oo0OooO0o2.OooO0o0(String.valueOf(-1228471549), o0000.OooO0OO(o000000.single_twitter_secret))), Boolean.valueOf(!oo0o0Oo.OooO0o0()));
    ...
    public final void OooO00o(@Nullable ShareContentModel shareContentModel) {
        ...
        if (i == 1) {
            ...
            strOooO0O0 = o0OoOo0.OooO0O0(url2, "?RoomId=", web3 != null ? web3.getIdx() : null);
            ...
            if (i != 3) {
                if (i != 4) {
                    ...
                    String strOooO0OO = o0000.OooO0OO(o000000.event_share_twitter);
                    ...
                    strOooO0O0 = event2 != null ? event2.getEventShareUrl() : null;
                ...
                oo000o oo000oVar = new oo000o(o0O0o00O.f47847OooO0Oo);
                Intrinsics.checkNotNullExpressionValue(oo000oVar, "download(...)");
                oo000oVar.f43611OooO0Oo = new o0000O00() { // from class: o0o0OO0O.o000O00
            ...
            strOooO0O0 = web7 != null ? web7.getUrl() : null;
        ...
        oo000o oo000oVar2 = new oo000o(o0O0o00O.f47847OooO0Oo);
        Intrinsics.checkNotNullExpressionValue(oo000oVar2, "download(...)");
        oo000oVar2.f43611OooO0Oo = new o0000O00() { // from class: o0o0OO0O.o000O00
            @Override // p675oOooo0o.o0000O00
            public final void result(boolean z2, Object obj) {
                String str4 = (String) obj;
                Function1 function1 = oooO0O0;
