...
public final class z0 {
    ...
    @NotNull
    public static final z0 f57313OooO00o = new z0();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public static final ArrayList f57314OooO0O0 = new ArrayList();

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @NotNull
    public static final String f57315OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public static final String f57316OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @NotNull
    public static final String f57317OooO0o0;

    public static final class OooO00o extends Lambda implements Function1<Integer, Unit> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO00o f57318OooO0Oo = new OooO00o();
    ...
    public static final class OooO0OO implements Observer, FunctionAdapter {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function1 f57319OooO0Oo;

        public OooO0OO(OooO00o function) {
            Intrinsics.checkNotNullParameter(function, "function");
            this.f57319OooO0Oo = function;
        }
        ...
        public final boolean equals(@Nullable Object obj) {
            ...
            return Intrinsics.areEqual(this.f57319OooO0Oo, ((FunctionAdapter) obj).getFunctionDelegate());
        }

        @Override // kotlin.jvm.internal.FunctionAdapter
        @NotNull
        public final Function<?> getFunctionDelegate() {
            return this.f57319OooO0Oo;
        }

        public final int hashCode() {
            return this.f57319OooO0Oo.hashCode();
        }

        @Override // androidx.lifecycle.Observer
        public final /* synthetic */ void onChanged(Object obj) {
            this.f57319OooO0Oo.invoke(obj);
        }
    }

    static {
        OooOo00.f46776OooO00o.observeForever(new OooO0OO(OooO00o.f57318OooO0Oo));
        f57315OooO0OO = "com.yalla.yalla.ui.activity.main.StartActivity";
        f57316OooO0Oo = OooOOOO.OooO00o(o000O00O.OooO00o().getPackageName(), ".YallaRamdan");
        f57317OooO0o0 = OooOOOO.OooO00o(o000O00O.OooO00o().getPackageName(), ".YallaAnniversary");
    }
    ...
    public static int OooO0O0(int i) {
        ...
        if (i2 == 1) {
            return o0Oo0oo.ic_moment_comment_praise_color;
        }
        if (i2 == 2) {
            return o0Oo0oo.ic_moment_comment_praise_color_ramdan;
        }
        if (i2 == 3) {
            return o0Oo0oo.ic_moment_comment_praise_color_seven_year;
        }
    ...
    public static int OooO0OO(int i) {
        ...
        int i2 = OooO0O0.$EnumSwitchMapping$0[OooOo00.OooO00o(Integer.valueOf(i)).ordinal()];
        if (i2 == 1) {
            return o0O0O00.ic_main_header_bg_bottom;
        }
        if (i2 == 2) {
            return o0O0O00.ic_main_header_bg_bottom_ramadan;
        }
        if (i2 == 3) {
            return o0O0O00.ic_main_header_bg_bottom_seven_year;
        }
        throw new NoWhenBranchMatchedException();
    }
    ...
    public static int OooO0Oo(int i) {
        ...
        int i2 = OooO0O0.$EnumSwitchMapping$0[OooOo00.OooO00o(Integer.valueOf(i)).ordinal()];
        if (i2 == 1) {
            return o0O0O00.ic_moment_post_create;
        }
        if (i2 == 2) {
            return o0O0O00.ic_moment_post_create_ramdan;
        }
        if (i2 == 3) {
            return o0O0O00.ic_moment_post_create_seven_year;
        }
        throw new NoWhenBranchMatchedException();
    }
    ...
    public static int OooO0o0(@Nullable Composer composer) {
        ...
        if (i2 == 1) {
            i = o0O0O00.ic_has_praise;
        } else if (i2 == 2) {
            i = o0O0O00.ic_has_praise_ramdan;
        } else {
            if (i2 != 3) {
                throw new NoWhenBranchMatchedException();
            }
            i = o0O0O00.ic_has_praise_seven_year;
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final void OooO00o(int i, int i2, @Nullable Composer composer, @Nullable Modifier modifier) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new a1(this, modifier, i, i2));
    }
}
