...
import p624o0oo0oO.o000O0;
import p624o0oo0oO.o000O00O;
import p626o0oo0oOo.oO0O00O;
...
public abstract class OooO extends OooO0o {
    ...
    @Nullable
    public BaseReq f18OoooO;

    /* JADX INFO: renamed from: OoooO0, reason: collision with root package name */
    @Nullable
    public Dialog f19OoooO0;

    /* JADX INFO: renamed from: OoooO0O, reason: collision with root package name */
    public FragmentActivity f20OoooO0O;

    /* JADX INFO: renamed from: OoooOO0, reason: collision with root package name */
    public p003OooO0Oo.OooOo00 f21OoooOO0;
                ...
                public final void run() {
                    ...
                    switch (i) {
                        case 0:
                            OooO this$0 = (OooO) oooO;
                            Intrinsics.checkNotNullParameter(this$0, "this$0");
                            if (!this$0.isAdded() || (dialog = this$0.f19OoooO0) == null) {
                                return;
                            }
                            dialog.dismiss();
                            return;
    ...
    public final p003OooO0Oo.OooOo00 OooO0o() {
        p003OooO0Oo.OooOo00 oooOo00 = this.f21OoooOO0;
        if (oooOo00 != null) {
            return oooOo00;
        }
    ...
    public final FragmentActivity OooO0o0() {
        FragmentActivity fragmentActivity = this.f20OoooO0O;
    ...
    public final void onCreate(@Nullable Bundle bundle) {
        ...
        this.f20OoooO0O = fragmentActivityRequireActivity;
        Intent intent = OooO0o0().getIntent();
        this.f18OoooO = intent == null ? null : (BaseReq) intent.getParcelableExtra("yalla_buddle_extra_data");
        p003OooO0Oo.OooOo00 oooOo00OooO0OO = OooO0OO();
        Intrinsics.checkNotNullParameter(oooOo00OooO0OO, "<set-?>");
        this.f21OoooOO0 = oooOo00OooO0OO;
        BaseReq baseReq = this.f18OoooO;
        if (baseReq == null) {
            baseReq = null;
        } else {
            ...
            Dialog dialog = new Dialog(context, o000O0.BaseCore_MD_Light);
            dialog.setContentView(o000O00O.base_core_layout_loading);
            dialog.setCanceledOnTouchOutside(false);
            dialog.setCancelable(z);
            dialog.setOnCancelListener(new oO0O00O(oooO0OO));
            dialog.show();
            this.f19OoooO0 = dialog;
