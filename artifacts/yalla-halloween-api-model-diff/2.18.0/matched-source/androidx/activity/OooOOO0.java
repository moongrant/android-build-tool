...
public class OooOOO0 extends Dialog implements LifecycleOwner, OooOOOO {
    ...
    @Nullable
    public LifecycleRegistry f4345Oooo;

    /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
    @NotNull
    public final OnBackPressedDispatcher f4346OoooO00;
    ...
    public OooOOO0(@NotNull Context context, @StyleRes int i) {
        ...
        final int i2 = 0;
        this.f4346OoooO00 = new OnBackPressedDispatcher(new Runnable() { // from class: androidx.activity.OooOO0O
                ...
                switch (i2) {
                    ...
                    default:
                        ...
                        synchronized (o00000o1) {
                            o00000o1.f29151OooO0o = false;
                            o00000O0.OooO0O0 oooO0O0 = o00000o1.f29154OooO0oo;
                            synchronized (oooO0O0) {
                                Arrays.fill(oooO0O0.f29162OooO0O0, false);
                                oooO0O0.f29164OooO0Oo = true;
                                break;
                            }
                        }
                        return;
    ...
    public final LifecycleRegistry OooO0o0() {
        LifecycleRegistry lifecycleRegistry = this.f4345Oooo;
        if (lifecycleRegistry != null) {
            return lifecycleRegistry;
        }
        LifecycleRegistry lifecycleRegistry2 = new LifecycleRegistry(this);
        this.f4345Oooo = lifecycleRegistry2;
    ...
    public final OnBackPressedDispatcher getOnBackPressedDispatcher() {
        return this.f4346OoooO00;
    }

    @Override // android.app.Dialog
    @CallSuper
    public final void onBackPressed() {
        this.f4346OoooO00.OooO0O0();
    }
