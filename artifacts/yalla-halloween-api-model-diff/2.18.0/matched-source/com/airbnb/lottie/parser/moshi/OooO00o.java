...
public final class OooO00o extends JsonReader {
    ...
    public static final ByteString f10273OoooOoo;

    /* JADX INFO: renamed from: Ooooo00, reason: collision with root package name */
    public static final ByteString f10274Ooooo00;

    /* JADX INFO: renamed from: Ooooo0o, reason: collision with root package name */
    public static final ByteString f10275Ooooo0o;

    /* JADX INFO: renamed from: OooooO0, reason: collision with root package name */
    public static final ByteString f10276OooooO0;

    /* JADX INFO: renamed from: OoooOO0, reason: collision with root package name */
    public final o0oOOo f10277OoooOO0;

    /* JADX INFO: renamed from: OoooOOO, reason: collision with root package name */
    public int f10278OoooOOO = 0;

    /* JADX INFO: renamed from: OoooOOo, reason: collision with root package name */
    public long f10279OoooOOo;

    /* JADX INFO: renamed from: OoooOo0, reason: collision with root package name */
    public int f10280OoooOo0;

    /* JADX INFO: renamed from: OoooOoO, reason: collision with root package name */
    @Nullable
    public String f10281OoooOoO;

    /* JADX INFO: renamed from: o000oOoO, reason: collision with root package name */
    public final o0oOO f10282o000oOoO;

    static {
        ByteString.OooO00o oooO00o = ByteString.f53062OoooO;
        f10273OoooOoo = oooO00o.OooO0OO("'\\");
        f10274Ooooo00 = oooO00o.OooO0OO("\"\\");
        f10275Ooooo0o = oooO00o.OooO0OO("{}[]:, \n\t\r\f/\\;#=");
        f10276OooooO0 = oooO00o.OooO0OO("\n\r");
        oooO00o.OooO0OO("*/");
    }

    public OooO00o(o0oOOo o0oooo2) {
        this.f10277OoooOO0 = o0oooo2;
        this.f10282o000oOoO = ((o0O00OO) o0oooo2).f52081Oooo;
        Oooo00o(6);
    }

    @Override // com.airbnb.lottie.parser.moshi.JsonReader
    public final void OooO00o() throws IOException {
        int iOoooOO0 = this.f10278OoooOOO;
        if (iOoooOO0 == 0) {
            iOoooOO0 = OoooOO0();
        }
        if (iOoooOO0 == 3) {
            Oooo00o(1);
            this.f10270OoooO0O[this.f10267Oooo - 1] = 0;
            this.f10278OoooOOO = 0;
        } else {
    ...
    public final void OooO0Oo() throws IOException {
        ...
        int i = this.f10267Oooo - 1;
        this.f10267Oooo = i;
        int[] iArr = this.f10270OoooO0O;
        int i2 = i - 1;
        iArr[i2] = iArr[i2] + 1;
        this.f10278OoooOOO = 0;
    }
    ...
    public final boolean OooOOo() throws IOException {
        ...
        if (iOoooOO0 == 6) {
            this.f10278OoooOOO = 0;
            int[] iArr2 = this.f10270OoooO0O;
            int i2 = this.f10267Oooo - 1;
            iArr2[i2] = iArr2[i2] + 1;
            return false;
        }
    ...
    public final double OooOOoo() throws IOException {
        ...
        if (iOoooOO0 == 16) {
            ...
            int i = this.f10267Oooo - 1;
            iArr[i] = iArr[i] + 1;
            return this.f10279OoooOOo;
        }
        if (iOoooOO0 == 17) {
            this.f10281OoooOoO = this.f10282o000oOoO.OooOOO0(this.f10280OoooOo0);
        } else if (iOoooOO0 == 9) {
            this.f10281OoooOoO = OoooOo0(f10274Ooooo00);
        } else if (iOoooOO0 == 8) {
            this.f10281OoooOoO = OoooOo0(f10273OoooOoo);
        } else if (iOoooOO0 == 10) {
            this.f10281OoooOoO = OoooOoO();
        } else if (iOoooOO0 != 11) {
        ...
        this.f10278OoooOOO = 11;
        try {
            double d = Double.parseDouble(this.f10281OoooOoO);
            if (Double.isNaN(d) || Double.isInfinite(d)) {
                throw new o000("JSON forbids NaN and infinities: " + d + " at path " + OooO0oo());
            }
            this.f10281OoooOoO = null;
            this.f10278OoooOOO = 0;
            int[] iArr2 = this.f10270OoooO0O;
            int i2 = this.f10267Oooo - 1;
            iArr2[i2] = iArr2[i2] + 1;
            ...
            sbOooO0O1.append(this.f10281OoooOoO);
    ...
    public final int OooOo0O() throws IOException {
        ...
        if (iOoooOO0 == 16) {
            ...
            sbOooO0O0.append(this.f10279OoooOOo);
            sbOooO0O0.append(" at path ");
            sbOooO0O0.append(OooO0oo());
            throw new o0000OO0(sbOooO0O0.toString());
        }
        if (iOoooOO0 == 17) {
            ...
            String strOoooOo0 = iOoooOO0 == 9 ? OoooOo0(f10274Ooooo00) : OoooOo0(f10273OoooOoo);
            this.f10281OoooOoO = strOoooOo0;
            try {
                int i3 = Integer.parseInt(strOoooOo0);
                this.f10278OoooOOO = 0;
                int[] iArr2 = this.f10270OoooO0O;
                int i4 = this.f10267Oooo - 1;
                iArr2[i4] = iArr2[i4] + 1;
                return i3;
            } catch (NumberFormatException unused) {
            }
        ...
        try {
            ...
            if (i5 != d) {
                ...
                sbOooO0O2.append(this.f10281OoooOoO);
            ...
            this.f10281OoooOoO = null;
            this.f10278OoooOOO = 0;
            int[] iArr3 = this.f10270OoooO0O;
            int i6 = this.f10267Oooo - 1;
            iArr3[i6] = iArr3[i6] + 1;
            return i5;
        } catch (NumberFormatException unused2) {
            StringBuilder sbOooO0O3 = OooO00o.OooO00o.OooO0O0("Expected an int but was ");
            sbOooO0O3.append(this.f10281OoooOoO);
    ...
    public final String OooOoO() throws IOException {
        ...
        if (iOoooOO0 == 14) {
            ...
            strOoooOo0 = OoooOo0(f10274Ooooo00);
        } else if (iOoooOO0 == 12) {
            strOoooOo0 = OoooOo0(f10273OoooOoo);
        } else {
            if (iOoooOO0 != 15) {
            ...
            strOoooOo0 = this.f10281OoooOoO;
        }
        this.f10278OoooOOO = 0;
        this.f10268OoooO0[this.f10267Oooo - 1] = strOoooOo0;
        return strOoooOo0;
    }
    ...
    public final String OooOoOO() throws IOException {
        ...
        if (iOoooOO0 == 10) {
            ...
            strOooOOO0 = Long.toString(this.f10279OoooOOo);
        } else {
            if (iOoooOO0 != 17) {
            ...
            strOooOOO0 = this.f10282o000oOoO.OooOOO0(this.f10280OoooOo0);
        }
        this.f10278OoooOOO = 0;
        int[] iArr = this.f10270OoooO0O;
        int i = this.f10267Oooo - 1;
    ...
    public final int Oooo0(JsonReader.OooO00o oooO00o) throws IOException {
        ...
        if (iOoooOO0 == 15) {
            return o000oOoO(this.f10281OoooOoO, oooO00o);
        }
        int iO00000OO = this.f10277OoooOO0.o00000OO(oooO00o.f10272OooO0O0);
        if (iO00000OO != -1) {
            this.f10278OoooOOO = 0;
            this.f10268OoooO0[this.f10267Oooo - 1] = oooO00o.f10271OooO00o[iO00000OO];
            return iO00000OO;
        }
        String str = this.f10268OoooO0[this.f10267Oooo - 1];
        String strOooOoO = OooOoO();
        int iO000oOoO = o000oOoO(strOooOoO, oooO00o);
        if (iO000oOoO == -1) {
            this.f10278OoooOOO = 15;
            this.f10281OoooOoO = strOooOoO;
            this.f10268OoooO0[this.f10267Oooo - 1] = str;
        }
        return iO000oOoO;
    }
    ...
    public final void Oooo0OO() throws IOException {
        ...
        if (iOoooOO0 == 14) {
            ...
            OooooOO(f10274Ooooo00);
        } else if (iOoooOO0 == 12) {
            OooooOO(f10273OoooOoo);
        } else if (iOoooOO0 != 15) {
            StringBuilder sbOooO0O0 = OooO00o.OooO00o.OooO0O0("Expected a name but was ");
            sbOooO0O0.append(OooOoo());
            sbOooO0O0.append(" at path ");
        ...
        this.f10278OoooOOO = 0;
        this.f10268OoooO0[this.f10267Oooo - 1] = "null";
    }
    ...
    public final void Oooo0o() throws IOException {
        ...
        do {
            ...
            if (iOoooOO0 == 3) {
                ...
                if (iOoooOO0 == 1) {
                    ...
                    this.f10282o000oOoO.skip(this.f10280OoooOo0);
                } else if (iOoooOO0 == 18) {
        ...
        int[] iArr = this.f10270OoooO0O;
        int i2 = this.f10267Oooo;
        int i3 = i2 - 1;
        iArr[i3] = iArr[i3] + 1;
        this.f10268OoooO0[i2 - 1] = "null";
    }
    ...
    public final int OoooOO0() throws IOException {
        ...
        byte bOooOOoo2;
        int i5;
        int[] iArr = this.f10269OoooO00;
        int i6 = this.f10267Oooo;
        int i7 = iArr[i6 - 1];
        if (i7 == 1) {
            iArr[i6 - 1] = 2;
        } else if (i7 == 2) {
            int iOoooOOo = OoooOOo(true);
            this.f10282o000oOoO.readByte();
            if (iOoooOOo != 44) {
                if (iOoooOOo == 59) {
                    OoooO0O();
                    throw null;
        ...
        if (iOoooOOo5 != 44 && iOoooOOo5 != 59) {
            if (iOoooOOo5 == 91) {
                this.f10282o000oOoO.readByte();
                this.f10278OoooOOO = 3;
                return 3;
            }
            if (iOoooOOo5 != 93) {
                if (iOoooOOo5 == 123) {
                    this.f10282o000oOoO.readByte();
                    this.f10278OoooOOO = 1;
                    return 1;
                }
                byte bOooOOoo3 = this.f10282o000oOoO.OooOOoo(0L);
                if (bOooOOoo3 == 116 || bOooOOoo3 == 84) {
                    ...
                    if (bOooOOoo3 != 102 && bOooOOoo3 != 70) {
                        ...
                        while (true) {
                            i3 = i2 + 1;
                            if (this.f10277OoooOO0.request(i3)) {
                                bOooOOoo2 = this.f10282o000oOoO.OooOOoo(i2);
                                if (bOooOOoo2 != 43) {
                                    ...
                                    if (OoooOOO(this.f10282o000oOoO.OooOOoo(0L))) {
                                        OoooO0O();
                                        throw null;
                                    }
                            ...
                            if (c != 2) {
                                if (c != c2 || c == 4 || c == 7) {
                                    this.f10280OoooOo0 = i2;
                                    i4 = 17;
                                    this.f10278OoooOOO = 17;
                                } else {
                                    i4 = 0;
                                }
                                ...
                                this.f10279OoooOOo = j;
                                this.f10282o000oOoO.skip(i2);
                                i4 = 16;
                                this.f10278OoooOOO = 16;
                            }
                            if (i4 != 0) {
                                return i4;
                            }
                ...
                while (true) {
                    if (i8 >= length) {
                        if (!this.f10277OoooOO0.request(length + 1) || !OoooOOO(this.f10282o000oOoO.OooOOoo(length))) {
                            this.f10282o000oOoO.skip(length);
                            this.f10278OoooOOO = i;
                            break;
                        }
                    } else {
                        int i9 = i8 + 1;
                        if (this.f10277OoooOO0.request(i9) && ((bOooOOoo = this.f10282o000oOoO.OooOOoo(i8)) == str.charAt(i8) || bOooOOoo == str2.charAt(i8))) {
                            i8 = i9;
                        }
                    }
                    i = 0;
    ...
    public final int OoooOOo(boolean z) throws IOException {
        ...
        while (true) {
            int i2 = i + 1;
            if (!this.f10277OoooOO0.request(i2)) {
                if (z) {
                    throw new EOFException("End of input");
                }
                return -1;
            }
            byte bOooOOoo = this.f10282o000oOoO.OooOOoo(i);
            if (bOooOOoo != 10 && bOooOOoo != 32 && bOooOOoo != 13 && bOooOOoo != 9) {
                this.f10282o000oOoO.skip(i2 - 1);
                if (bOooOOoo == 47) {
                    if (!this.f10277OoooOO0.request(2L)) {
                        return bOooOOoo;
                    }
                    OoooO0O();
                    throw null;
    ...
    public final String OoooOo0(ByteString byteString) throws IOException {
        ...
        while (true) {
            long jOooo0oO = this.f10277OoooOO0.Oooo0oO(byteString);
            if (jOooo0oO == -1) {
                OoooO0("Unterminated string");
                throw null;
            }
            if (this.f10282o000oOoO.OooOOoo(jOooo0oO) != 92) {
                if (sb == null) {
                    String strOooOOO0 = this.f10282o000oOoO.OooOOO0(jOooo0oO);
                    this.f10282o000oOoO.readByte();
                    return strOooOOO0;
                }
                sb.append(this.f10282o000oOoO.OooOOO0(jOooo0oO));
                this.f10282o000oOoO.readByte();
                return sb.toString();
            }
            if (sb == null) {
    ...
    public final String OoooOoO() throws IOException {
        long jOooo0oO = this.f10277OoooOO0.Oooo0oO(f10275Ooooo0o);
        return jOooo0oO != -1 ? this.f10282o000oOoO.OooOOO0(jOooo0oO) : this.f10282o000oOoO.Oooo0o();
    }

    public final char Ooooo0o() throws IOException {
        int i;
        int i2;
        if (!this.f10277OoooOO0.request(1L)) {
            OoooO0("Unterminated escape sequence");
            throw null;
        }
        byte b = this.f10282o000oOoO.readByte();
        ...
        if (!this.f10277OoooOO0.request(4L)) {
        ...
        for (int i3 = 0; i3 < 4; i3++) {
            byte bOooOOoo = this.f10282o000oOoO.OooOOoo(i3);
            char c2 = (char) (c << 4);
            if (bOooOOoo < 48 || bOooOOoo > 57) {
                if (bOooOOoo >= 97 && bOooOOoo <= 102) {
                    ...
                    if (bOooOOoo < 65 || bOooOOoo > 70) {
                        ...
                        sbOooO0O2.append(this.f10282o000oOoO.OooOOO0(4L));
    ...
    public final void OooooOO(ByteString byteString) throws IOException {
        while (true) {
            ...
            if (this.f10282o000oOoO.OooOOoo(jOooo0oO) != 92) {
                this.f10282o000oOoO.skip(jOooo0oO + 1);
                return;
            } else {
                this.f10282o000oOoO.skip(jOooo0oO + 1);
                Ooooo0o();
    ...
    public final void OoooooO() throws IOException {
        long jOooo0oO = this.f10277OoooOO0.Oooo0oO(f10275Ooooo0o);
        o0oOO o0ooo2 = this.f10282o000oOoO;
        if (jOooo0oO == -1) {
            jOooo0oO = o0ooo2.f52117OoooO00;
        }
    ...
    public final void close() throws IOException {
        this.f10278OoooOOO = 0;
        this.f10269OoooO00[0] = 8;
        this.f10267Oooo = 1;
        this.f10282o000oOoO.OooO0Oo();
        this.f10277OoooOO0.close();
    }

    public final int o000oOoO(String str, JsonReader.OooO00o oooO00o) {
        int length = oooO00o.f10271OooO00o.length;
        for (int i = 0; i < length; i++) {
            if (str.equals(oooO00o.f10271OooO00o[i])) {
                this.f10278OoooOOO = 0;
                this.f10268OoooO0[this.f10267Oooo - 1] = str;
                return i;
            }
    ...
    public final String toString() {
        ...
        sbOooO0O0.append(this.f10277OoooOO0);
        sbOooO0O0.append(")");
