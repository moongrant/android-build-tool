...
public final class RoomInfoProfileFragment extends o00OOO0.OooO00o {
    ...
    @Nullable
    private o0O00O<Boolean> centerTextDialog;
    ...
    @NotNull
    private final Lazy liveRoomVM = o0000OO0.OooO0O0(this, Reflection.getOrCreateKotlinClass(LiveRoomVM.class), new Function0<ViewModelStore>() { // from class: com.app.base.fragment.room.RoomInfoProfileFragment$special$$inlined$activityViewModels$default$1
        {
            super(0);
        }
        ...
        public final /* synthetic */ Function0 f11699Oooo = null;
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f11699Oooo;
    ...
    @NotNull
    private final Lazy loadingVM = o0000OO0.OooO0O0(this, Reflection.getOrCreateKotlinClass(oO000OOo.class), new Function0<ViewModelStore>() { // from class: com.app.base.fragment.room.RoomInfoProfileFragment$special$$inlined$activityViewModels$default$4
        {
            super(0);
        }
        ...
        /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
        public final /* synthetic */ Function0 f11703Oooo = null;
        ...
        public final CreationExtras invoke() {
            CreationExtras creationExtras;
            Function0 function0 = this.f11703Oooo;
            if (function0 != null && (creationExtras = (CreationExtras) function0.invoke()) != null) {
                return creationExtras;
            }
            CreationExtras defaultViewModelCreationExtras = this.requireActivity().getDefaultViewModelCreationExtras();
    ...
    public static final class OooO0O0 extends Lambda implements Function1<View, Unit> {
        ...
        public final Unit invoke(View view) {
            ...
            Boolean value = o00OO0O0.f43338OooooOo.OooO00o().f43352OooOOO.getValue();
            Boolean bool = Boolean.TRUE;
            if (Intrinsics.areEqual(value, bool)) {
                o00OO000 o00oo001 = o00OO000.f43171OooO00o;
                o00OO000.f43197OooOoo.setValue(bool);
            } else {
    ...
    public static final class OooO0o extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
        public final /* synthetic */ String f11696Oooo;

        /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
        public final /* synthetic */ RoomInfoProfileFragment f11697OoooO00;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(String str, RoomInfoProfileFragment roomInfoProfileFragment) {
            super(0);
            this.f11696Oooo = str;
            this.f11697OoooO00 = roomInfoProfileFragment;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            String str = this.f11696Oooo;
            int iHashCode = str.hashCode();
            if (iHashCode != -1298587734) {
                if (iHashCode != -841454749) {
                    if (iHashCode == 613961165 && str.equals("unJoin&unFollow")) {
                        p160o00OoOO.o00O000.OooO().OooOoo0(String.valueOf(p500o0o00Oo0.OooOOO.f41235OooO00o.OooOo().getValue()), "1");
                        RoomConfiguration roomConfiguration = this.f11697OoooO00.mRoomConfiguration;
                        Intrinsics.checkNotNull(roomConfiguration);
                        roomConfiguration.setIsfollow(0);
                    }
                } else if (str.equals("unJoin")) {
                    p160o00OoOO.o00O000.OooO().OooOoo0(String.valueOf(p500o0o00Oo0.OooOOO.f41235OooO00o.OooOo().getValue()), AppEventsConstants.EVENT_PARAM_VALUE_NO);
                    RoomConfiguration roomConfiguration2 = this.f11697OoooO00.mRoomConfiguration;
    ...
    private final void changeDialogState() {
        o0O00O<Boolean> o0o00o2;
        int i = this.userIdentityInfo;
        if (i != 0) {
            if (i != 3 || (o0o00o2 = this.centerTextDialog) == null || o0o00o2 == null) {
                return;
            }
            o0o00o2.setValue(Boolean.FALSE);
            return;
        }
        m1 m1Var = this.triangleDialog;
        if (m1Var != null) {
            m1Var.dismiss();
        }
        o0O00O<Boolean> o0o00o3 = this.centerTextDialog;
        if (o0o00o3 == null) {
            return;
        }
        o0o00o3.setValue(Boolean.FALSE);
    }
    ...
    private final List<ReportFromData> getLash50RoomChatList() {
        ...
        Object objClone = (mixedRoomActivity == null || (arrayList = mixedRoomActivity.f11813o0ooOO0.f31608OoooO00) == null) ? null : arrayList.clone();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final oO000OOo getLoadingVM() {
        return (oO000OOo) this.loadingVM.getValue();
    }

    @SuppressLint({"SetTextI18n"})
    private final void initDataObserver(final o00OO0O0 liveDataSource) {
        int i = 0;
        liveDataSource.f43352OooOOO.observe(getViewLifecycleOwner(), new o00OOO0O(this, i));
        liveDataSource.f43341OooO00o.observe(getViewLifecycleOwner(), new o00OOO0(this, i));
        liveDataSource.f43342OooO0O0.observe(getViewLifecycleOwner(), new o00OOOO0(this, i));
        liveDataSource.f43354OooOOOO.observe(getViewLifecycleOwner(), new Observer() { // from class: o00OOooo.o00Oo00
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                RoomInfoProfileFragment.m80initDataObserver$lambda8(this.f32049OooO00o, liveDataSource, (Integer) obj);
            }
        });
        liveDataSource.f43362OooOo0O.observe(getViewLifecycleOwner(), new o00O0O(this, 1));
        liveDataSource.f43363OooOo0o.observe(getViewLifecycleOwner(), new o0o0Oo(this, i));
        liveDataSource.f43359OooOo.observe(getViewLifecycleOwner(), new o00OOOOo(this, i));
    }
    ...
    public static final void m80initDataObserver$lambda8(RoomInfoProfileFragment this$0, o00OO0O0 liveDataSource, Integer userIdentity) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        ...
        if (imageView != null) {
            imageView.setVisibility(o00OO0O0.f43338OooooOo.OooO00o().OooOOo0() ? 0 : 8);
        }
    ...
    private final void initView(View view) {
        ...
        int i = 0;
        xRefreshLayout.f19564o00o0O = false;
    ...
    public final void setCenterTextDialog(String type) {
        ...
        o000oOoO o000oooo2 = o000oOoO.f31826OooO00o;
        FragmentActivity activity = getActivity();
    ...
    private final void showLevelDialog() {
        ...
        if (o0000Ooo.OooO00o(getActivity())) {
            ...
            new oO000o00(fragmentActivityRequireActivity, id, name).show();
        }
    }

    private final void showRoomInfo() {
        o00OO0O0.OooO00o oooO00o = o00OO0O0.f43338OooooOo;
        this.mRoomConfiguration = oooO00o.OooO00o().f43351OooOO0o.getValue();
        RoomLoginInformation value = oooO00o.OooO00o().f43349OooOO0.getValue();
        ...
        if (textView4 != null) {
            textView4.setText(String.valueOf(o00OO000.f43171OooO00o.OooO0oo()));
        }
    ...
    private final void unJoinRoom() {
        FragmentActivity fragmentActivityRequireActivity = requireActivity();
        Intrinsics.checkNotNullExpressionValue(fragmentActivityRequireActivity, "requireActivity()");
        m1 m1Var = new m1(fragmentActivityRequireActivity);
        this.triangleDialog = m1Var;
        m1Var.show();
        m1 m1Var2 = this.triangleDialog;
        if (m1Var2 != null) {
            OooO onClickListener = new OooO();
            Intrinsics.checkNotNullParameter(onClickListener, "onClickListener");
            m1Var2.f46015OoooOO0 = onClickListener;
        }
    }
        ...
        switch (id) {
            case R.id.ivFollow /* 2131297654 */:
                if (this.userIdentityInfo != 1) {
                    if (!Intrinsics.areEqual(o00OO0O0.f43338OooooOo.OooO00o().f43352OooOOO.getValue(), Boolean.TRUE)) {
            ...
            case R.id.layout_room_info_pop_warning_iv /* 2131298178 */:
                ...
                o000O.OooO00o(t5.f47585OooO00o, t5.OooO0o(1, com.yalla.support.common.util.OooO.OooO0o(barid), (52 & 4) != 0 ? null : lash50RoomChatList, (52 & 8) != 0 ? null : null, (52 & 16) != 0 ? null : null, (52 & 32) != 0 ? null : null));
                break;
        }
    }
    ...
    @Override // o00OOO0.OooO00o, p141o00OOOoO.OooO0o
    public void onEventMainThread(@Nullable p141o00OOOoO.OooO0OO<?> msg) {
        super.onEventMainThread(msg);
        if (msg != null && msg.f31906OooO00o == 57) {
            o000O00O.OooO().f32453OoooO0O.setWage(0);
