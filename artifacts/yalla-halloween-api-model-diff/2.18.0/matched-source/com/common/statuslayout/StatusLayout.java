...
import p267o00ooo0O.o00O;

/* JADX INFO: loaded from: classes.dex */
@Metadata(bv = {}, d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\b\n\u0002\u0010\t\n\u0002\b\u0011\n\u0002\u0010\u000b\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0005\b\u0016\u0018\u00002\u00020\u0001:\u0001-B'\b\u0007\u0012\u0006\u0010&\u001a\u00020%\u0012\n\b\u0002\u0010(\u001a\u0004\u0018\u00010'\u0012\b\b\u0002\u0010*\u001a\u00020)¢\u0006\u0004\b+\u0010,J\n\u0010\u0003\u001a\u0004\u0018\u00010\u0002H\u0014J\n\u0010\u0004\u001a\u0004\u0018\u00010\u0002H\u0014J\n\u0010\u0005\u001a\u0004\u0018\u00010\u0002H\u0014R\u001e\u0010\n\u001a\u0004\u0018\u00010\u00028B@\u0002X\u0082\u000e¢\u0006\f\n\u0004\b\u0006\u0010\u0007\u001a\u0004\b\b\u0010\tR(\u0010\u0014\u001a\u00020\u000b8\u0006@\u0006X\u0087\u000e¢\u0006\u0018\n\u0004\b\f\u0010\r\u0012\u0004\b\u0012\u0010\u0013\u001a\u0004\b\u000e\u0010\u000f\"\u0004\b\u0010\u0010\u0011R\"\u0010\u0018\u001a\u00020\u000b8\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\u0015\u0010\r\u001a\u0004\b\u0016\u0010\u000f\"\u0004\b\u0017\u0010\u0011R\"\u0010\u001c\u001a\u00020\u000b8\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\u0019\u0010\r\u001a\u0004\b\u001a\u0010\u000f\"\u0004\b\u001b\u0010\u0011R\"\u0010$\u001a\u00020\u001d8\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\u001e\u0010\u001f\u001a\u0004\b \u0010!\"\u0004\b\"\u0010#¨\u0006."}, d2 = {"Lcom/common/statuslayout/StatusLayout;", "Landroid/widget/FrameLayout;", "Landroid/view/View;", "getLoadingView", "getEmptyView", "getErrorView", "OoooO0", "Landroid/view/View;", "getContentView", "()Landroid/view/View;", "contentView", "", "OoooO0O", "J", "getDuration", "()J", "setDuration", "(J)V", "getDuration$annotations", "()V", "duration", "OoooO", "getAnimShowDuration", "setAnimShowDuration", "animShowDuration", "OoooOO0", "getAnimHideDuration", "setAnimHideDuration", "animHideDuration", "", "o000oOoO", "Z", "getEnableStateChangeAnim", "()Z", "setEnableStateChangeAnim", "(Z)V", "enableStateChangeAnim", "Landroid/content/Context;", d.R, "Landroid/util/AttributeSet;", "attrs", "", "defStyleAttr", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "State", "StatusLayout_release"}, k = 1, mv = {1, 4, 0})
public class StatusLayout extends FrameLayout {

    /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
    public List<Function2<State, View, Unit>> f12657Oooo;
    ...
    public static final class OooO00o extends AnimatorListenerAdapter {
        ...
        /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
        public final /* synthetic */ View f12665OoooO00;

        public OooO00o(View view) {
            this.f12665OoooO00 = view;
        }

        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        public final void onAnimationEnd(@Nullable Animator animator) {
            View view = this.f12665OoooO00;
    ...
    public static final class OooO0O0 extends AnimatorListenerAdapter {
        ...
        /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
        public final /* synthetic */ View f12666Oooo;

        public OooO0O0(View view) {
            this.f12666Oooo = view;
        }

        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        public final void onAnimationStart(@Nullable Animator animator) {
            this.f12666Oooo.setVisibility(0);
        }
    }
    ...
    public final void OooO(State state) {
        ...
        if (i == 1) {
            ...
            if (loadingView != null) {
                ...
                OooO0oO(loadingView);
                Iterator it = this.f12657Oooo.iterator();
                while (it.hasNext()) {
            ...
            if (emptyView != null) {
                ...
                OooO0oO(emptyView);
                Iterator it2 = this.f12657Oooo.iterator();
                while (it2.hasNext()) {
            ...
            if (errorView != null) {
                ...
                OooO0oO(errorView);
                Iterator it3 = this.f12657Oooo.iterator();
                while (it3.hasNext()) {
            ...
            OooO0oO(contentView);
            Iterator it4 = this.f12657Oooo.iterator();
            while (it4.hasNext()) {
                ((Function2) it4.next()).invoke(State.Content, contentView);
            }
        }
        this.f12660OoooO00 = state;
    }

    public final void OooO0O0(State state) {
        View contentView;
        State state2 = this.f12660OoooO00;
        if (state2 == state) {
            return;
        }
    ...
    public StatusLayout(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.f12657Oooo = new ArrayList();
        this.f12660OoooO00 = State.Content;
        this.duration = 300L;
