...
public final class CustomTabMainActivity extends Activity {
    ...
    private final void sendResult(int resultCode, Intent resultIntent) {
        ...
        if (broadcastReceiver != null) {
            p083o000OoOo.OooOo00.OooO00o(this).OooO0Oo(broadcastReceiver);
        }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (!zOpenCustomTab) {
            ...
            p083o000OoOo.OooOo00.OooO00o(this).OooO0O0(broadcastReceiver, new IntentFilter(str));
        }
    }
    ...
    public void onNewIntent(@NotNull Intent intent) {
        ...
        if (Intrinsics.areEqual(REFRESH_ACTION, intent.getAction())) {
            p083o000OoOo.OooOo00.OooO00o(this).OooO0OO(new Intent(CustomTabActivity.DESTROY_ACTION));
            sendResult(-1, intent);
