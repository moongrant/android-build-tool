...
public final class InstrumentData {
    ...
    @Metadata(d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\u0003\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\bÆ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u001c\u0010\u0003\u001a\u00020\u00042\b\u0010\u0005\u001a\u0004\u0018\u00010\u00062\b\u0010\u0007\u001a\u0004\u0018\u00010\u0006H\u0007J\u001a\u0010\u0003\u001a\u00020\u00042\b\u0010\b\u001a\u0004\u0018\u00010\t2\u0006\u0010\n\u001a\u00020\u000bH\u0007J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\f\u001a\u00020\rH\u0007J\u0010\u0010\u000e\u001a\u00020\u00042\u0006\u0010\u000f\u001a\u00020\u0010H\u0007¨\u0006\u0011"}, d2 = {"Lcom/facebook/internal/instrument/InstrumentData$Builder;", "", "()V", "build", "Lcom/facebook/internal/instrument/InstrumentData;", "anrCause", "", "st", "e", "", ak.aH, "Lcom/facebook/internal/instrument/InstrumentData$Type;", "features", "Lorg/json/JSONArray;", "load", ShareInternalUtility.STAGING_PARAM, "Ljava/io/File;", "facebook-core_release"}, k = 1, mv = {1, 5, 1}, xi = 48)
    ...
    public static final class Companion {
        ...
        public final Type getType(String filename) {
            if (StringsKt__StringsJVMKt.startsWith$default(filename, InstrumentUtility.CRASH_REPORT_PREFIX, false, 2, null)) {
                return Type.CrashReport;
            }
            if (StringsKt__StringsJVMKt.startsWith$default(filename, InstrumentUtility.CRASH_SHIELD_PREFIX, false, 2, null)) {
                return Type.CrashShield;
            }
            if (StringsKt__StringsJVMKt.startsWith$default(filename, InstrumentUtility.THREAD_CHECK_PREFIX, false, 2, null)) {
                return Type.ThreadCheck;
            }
            if (StringsKt__StringsJVMKt.startsWith$default(filename, InstrumentUtility.ANALYSIS_REPORT_PREFIX, false, 2, null)) {
                return Type.Analysis;
            }
            return StringsKt__StringsJVMKt.startsWith$default(filename, InstrumentUtility.ANR_REPORT_PREFIX, false, 2, null) ? Type.AnrReport : Type.Unknown;
        }
    }
