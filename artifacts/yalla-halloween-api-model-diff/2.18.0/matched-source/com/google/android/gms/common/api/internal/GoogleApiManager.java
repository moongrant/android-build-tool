...
import p332o0O0oooO.o0O0000O;
import p332o0O0oooO.o0O0o000;
import p332o0O0oooO.o0O0oo00;
import p332o0O0oooO.o0oOo0O0;
...
public class GoogleApiManager implements Handler.Callback {
    ...
    @Nullable
    @GuardedBy("lock")
    public static GoogleApiManager f15249Oooooo0;

    /* JADX INFO: renamed from: OoooO, reason: collision with root package name */
    public final Context f15251OoooO;

    /* JADX INFO: renamed from: OoooO0, reason: collision with root package name */
    @Nullable
    public TelemetryData f15252OoooO0;

    /* JADX INFO: renamed from: OoooO0O, reason: collision with root package name */
    @Nullable
    public TelemetryLoggingClient f15254OoooO0O;

    /* JADX INFO: renamed from: OoooOO0, reason: collision with root package name */
    public final GoogleApiAvailability f15255OoooOO0;

    /* JADX INFO: renamed from: Ooooo0o, reason: collision with root package name */
    @NotOnlyInitialized
    public final zaq f15262Ooooo0o;

    /* JADX INFO: renamed from: OooooO0, reason: collision with root package name */
    public volatile boolean f15263OooooO0;

    /* JADX INFO: renamed from: o000oOoO, reason: collision with root package name */
    public final com.google.android.gms.common.internal.zal f15264o000oOoO;

    @NonNull
    public static final Status zaa = new Status(4, "Sign-out occurred while this API call was in progress.");

    /* JADX INFO: renamed from: OooooOO, reason: collision with root package name */
    public static final Status f15247OooooOO = new Status(4, "The user must be signed in to make this API call.");

    /* JADX INFO: renamed from: OooooOo, reason: collision with root package name */
    public static final Object f15248OooooOo = new Object();

    /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
    public long f15250Oooo = 10000;

    /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
    public boolean f15253OoooO00 = false;

    /* JADX INFO: renamed from: OoooOOO, reason: collision with root package name */
    public final AtomicInteger f15256OoooOOO = new AtomicInteger(1);

    /* JADX INFO: renamed from: OoooOOo, reason: collision with root package name */
    public final AtomicInteger f15257OoooOOo = new AtomicInteger(0);

    /* JADX INFO: renamed from: OoooOo0, reason: collision with root package name */
    public final Map<ApiKey<?>, zabq<?>> f15258OoooOo0 = new ConcurrentHashMap(5, 0.75f, 1);

    /* JADX INFO: renamed from: OoooOoO, reason: collision with root package name */
    @Nullable
    @GuardedBy("lock")
    public zaae f15259OoooOoO = null;

    /* JADX INFO: renamed from: OoooOoo, reason: collision with root package name */
    @GuardedBy("lock")
    public final Set<ApiKey<?>> f15260OoooOoo = new o0OoOo0(0);

    /* JADX INFO: renamed from: Ooooo00, reason: collision with root package name */
    public final Set<ApiKey<?>> f15261Ooooo00 = new o0OoOo0(0);

    @KeepForSdk
    public GoogleApiManager(Context context, Looper looper, GoogleApiAvailability googleApiAvailability) {
        this.f15263OooooO0 = true;
        this.f15251OoooO = context;
        zaq zaqVar = new zaq(looper, this);
        this.f15262Ooooo0o = zaqVar;
        this.f15255OoooOO0 = googleApiAvailability;
        this.f15264o000oOoO = new com.google.android.gms.common.internal.zal(googleApiAvailability);
        if (DeviceProperties.isAuto(context)) {
            this.f15263OooooO0 = false;
        }
    ...
    public static void reportSignOut() {
        synchronized (f15248OooooOo) {
            GoogleApiManager googleApiManager = f15249Oooooo0;
            if (googleApiManager != null) {
                googleApiManager.f15257OoooOOo.incrementAndGet();
                zaq zaqVar = googleApiManager.f15262Ooooo0o;
    ...
    public static GoogleApiManager zal() {
        ...
        synchronized (f15248OooooOo) {
            Preconditions.checkNotNull(f15249Oooooo0, "Must guarantee manager is non-null before using getInstance");
            googleApiManager = f15249Oooooo0;
        }
    ...
    public static GoogleApiManager zam(@NonNull Context context) {
        GoogleApiManager googleApiManager;
        synchronized (f15248OooooOo) {
            if (f15249Oooooo0 == null) {
                f15249Oooooo0 = new GoogleApiManager(context.getApplicationContext(), GmsClientSupervisor.getOrStartHandlerThread().getLooper(), GoogleApiAvailability.getInstance());
            }
            googleApiManager = f15249Oooooo0;
        }
        return googleApiManager;
    ...
    public final boolean OooO00o() {
        ...
        int iZaa = this.f15264o000oOoO.zaa(this.f15251OoooO, 203400000);
        return iZaa == -1 || iZaa == 0;
    }

    public final boolean OooO0O0(ConnectionResult connectionResult, int i) {
        return this.f15255OoooOO0.zah(this.f15251OoooO, connectionResult, i);
    }
    ...
    public final zabq<?> OooO0Oo(GoogleApi<?> googleApi) {
        ...
        zabq<?> zabqVar = this.f15258OoooOo0.get(apiKey);
        if (zabqVar == null) {
            zabqVar = new zabq<>(this, googleApi);
            this.f15258OoooOo0.put((ApiKey<?>) apiKey, zabqVar);
        }
        if (zabqVar.zaz()) {
            this.f15261Ooooo00.add((ApiKey<?>) apiKey);
        }
        zabqVar.zao();
        return zabqVar;
    }
        ...
        if (i != 0) {
            ...
            if (OooO00o()) {
                ...
                if (config == null) {
                    ...
                    o0ooo0o1 = new o0oOo0O0(this, i, apiKey, jCurrentTimeMillis, jElapsedRealtime);
                    ...
                    zabq zabqVar = (zabq) this.f15258OoooOo0.get(apiKey);
                    if (zabqVar == null) {
                        ...
                        if (!baseGmsClient.hasConnectionInfo() || baseGmsClient.isConnecting()) {
                            ...
                            ConnectionTelemetryConfiguration connectionTelemetryConfigurationOooO00o = o0oOo0O0.OooO00o(zabqVar, baseGmsClient, i);
                            if (connectionTelemetryConfigurationOooO00o != null) {
                                zabqVar.f15411OooOO0o++;
            ...
            if (o0ooo0o1 != null) {
                ...
                final zaq zaqVar = this.f15262Ooooo0o;
    ...
    public final void OooO0o0() {
        TelemetryData telemetryData = this.f15252OoooO0;
        if (telemetryData != null) {
            if (telemetryData.zaa() > 0 || OooO00o()) {
                if (this.f15254OoooO0O == null) {
                    this.f15254OoooO0O = TelemetryLogging.getClient(this.f15251OoooO);
                }
                this.f15254OoooO0O.log(telemetryData);
            }
            this.f15252OoooO0 = null;
        }
    }
    ...
    /* JADX WARN: Type inference failed for: r2v25, types: [java.util.ArrayList, java.util.List<o0O0oooO.o0O0o000>] */
    /* JADX WARN: Type inference failed for: r2v28, types: [java.util.ArrayList, java.util.List<o0O0oooO.o0O0o000>] */
    ...
    public final boolean handleMessage(@NonNull Message message) {
        ...
        switch (i) {
            case 1:
                this.f15250Oooo = true == ((Boolean) message.obj).booleanValue() ? 10000L : 300000L;
                this.f15262Ooooo0o.removeMessages(12);
                for (ApiKey apiKey : this.f15258OoooOo0.keySet()) {
                    zaq zaqVar = this.f15262Ooooo0o;
                    zaqVar.sendMessageDelayed(zaqVar.obtainMessage(12, apiKey), this.f15250Oooo);
                }
                return true;
            case 2:
                zal zalVar = (zal) message.obj;
                for (ApiKey<?> apiKey2 : zalVar.zab()) {
                    zabq zabqVar2 = (zabq) this.f15258OoooOo0.get(apiKey2);
                    if (zabqVar2 == null) {
                        zalVar.zac(apiKey2, new ConnectionResult(13), null);
                        return true;
                    }
                    if (zabqVar2.f15402OooO0O0.isConnected()) {
                ...
                return true;
            case 3:
                for (zabq zabqVar3 : this.f15258OoooOo0.values()) {
                    zabqVar3.zan();
                    zabqVar3.zao();
                }
                return true;
            ...
            case 13:
                ...
                zabq<?> zabqVarOooO0Oo = (zabq) this.f15258OoooOo0.get(zachVar.zac.getApiKey());
                if (zabqVarOooO0Oo == null) {
                    zabqVarOooO0Oo = OooO0Oo(zachVar.zac);
                }
                if (!zabqVarOooO0Oo.zaz() || this.f15257OoooOOo.get() == zachVar.zab) {
            ...
            case 5:
                ...
                for (zabq zabqVar4 : this.f15258OoooOo0.values()) {
                    if (zabqVar4.zab() == i2) {
                        zabqVar = zabqVar4;
                        if (zabqVar != null) {
                            ...
                            String errorString = this.f15255OoooOO0.getErrorString(connectionResult.getErrorCode());
                            ...
                            zabqVar.OooO0OO(OooO0OO(zabqVar.f15403OooO0OO, connectionResult));
                        }
                        return true;
                    }
                }
                if (zabqVar != null) {
                    ...
                    String errorString2 = this.f15255OoooOO0.getErrorString(connectionResult.getErrorCode());
                ...
                return true;
            case 6:
                if (this.f15251OoooO.getApplicationContext() instanceof Application) {
                    BackgroundDetector.initialize((Application) this.f15251OoooO.getApplicationContext());
                    BackgroundDetector.getInstance().addListener(new OooO0OO(this));
                    if (!BackgroundDetector.getInstance().readCurrentStateIfPossible(true)) {
                        this.f15250Oooo = 300000L;
                    }
                }
                return true;
            case 7:
                ...
                return true;
            case 9:
                if (this.f15258OoooOo0.containsKey(message.obj)) {
                    ((zabq) this.f15258OoooOo0.get(message.obj)).zau();
                }
                return true;
            case 10:
                ?? r10 = this.f15261Ooooo00;
                Objects.requireNonNull(r10);
                o0OoOo0.OooO00o oooO00o = new o0OoOo0.OooO00o();
                while (oooO00o.hasNext()) {
                    zabq zabqVar5 = (zabq) this.f15258OoooOo0.remove((ApiKey) oooO00o.next());
                    if (zabqVar5 != null) {
                        zabqVar5.zav();
                    }
                }
                this.f15261Ooooo00.clear();
                return true;
            case 11:
                if (this.f15258OoooOo0.containsKey(message.obj)) {
                    ((zabq) this.f15258OoooOo0.get(message.obj)).zaw();
                }
                return true;
            case 12:
                if (this.f15258OoooOo0.containsKey(message.obj)) {
                    ((zabq) this.f15258OoooOo0.get(message.obj)).zaA();
                }
                return true;
            case 14:
                o0O0000O o0o0000o2 = (o0O0000O) message.obj;
                ApiKey<?> apiKey3 = o0o0000o2.f37097OooO00o;
                if (this.f15258OoooOo0.containsKey(apiKey3)) {
                    o0o0000o2.f37098OooO0O0.setResult(Boolean.valueOf(((zabq) this.f15258OoooOo0.get(apiKey3)).OooOOO0(false)));
                } else {
                    o0o0000o2.f37098OooO0O0.setResult(Boolean.FALSE);
                }
                return true;
            case 15:
                o0O0o000 o0o0o000 = (o0O0o000) message.obj;
                if (this.f15258OoooOo0.containsKey(o0o0o000.f37129OooO00o)) {
                    zabq zabqVar6 = (zabq) this.f15258OoooOo0.get(o0o0o000.f37129OooO00o);
                    if (zabqVar6.f15409OooOO0.contains(o0o0o000) && !zabqVar6.f15400OooO) {
                        if (zabqVar6.f15402OooO0O0.isConnected()) {
                            zabqVar6.OooO0o0();
                        } else {
                            zabqVar6.zao();
                        }
                ...
                return true;
            case 16:
                o0O0o000 o0o0o001 = (o0O0o000) message.obj;
                if (this.f15258OoooOo0.containsKey(o0o0o001.f37129OooO00o)) {
                    zabq<?> zabqVar7 = (zabq) this.f15258OoooOo0.get(o0o0o001.f37129OooO00o);
                    if (zabqVar7.f15409OooOO0.remove(o0o0o001)) {
                        zabqVar7.f15412OooOOO0.f15262Ooooo0o.removeMessages(15, o0o0o001);
                        zabqVar7.f15412OooOOO0.f15262Ooooo0o.removeMessages(16, o0o0o001);
                        Feature feature = o0o0o001.f37130OooO0O0;
                        ArrayList arrayList = new ArrayList(zabqVar7.f15401OooO00o.size());
                        for (zai zaiVar : zabqVar7.f15401OooO00o) {
                        ...
                        for (int i3 = 0; i3 < size; i3++) {
                            ...
                            zabqVar7.f15401OooO00o.remove(zaiVar2);
            ...
            case 17:
                ...
                return true;
            case 18:
                o0O0oo00 o0o0oo00 = (o0O0oo00) message.obj;
                if (o0o0oo00.f37135OooO0OO == 0) {
                    TelemetryData telemetryData = new TelemetryData(o0o0oo00.f37134OooO0O0, Arrays.asList(o0o0oo00.f37133OooO00o));
                    if (this.f15254OoooO0O == null) {
                        this.f15254OoooO0O = TelemetryLogging.getClient(this.f15251OoooO);
                    }
                    this.f15254OoooO0O.log(telemetryData);
                } else {
                    TelemetryData telemetryData2 = this.f15252OoooO0;
                    if (telemetryData2 != null) {
                        List<MethodInvocation> listZab = telemetryData2.zab();
                        if (telemetryData2.zaa() != o0o0oo00.f37134OooO0O0 || (listZab != null && listZab.size() >= o0o0oo00.f37136OooO0Oo)) {
                            this.f15262Ooooo0o.removeMessages(17);
                            OooO0o0();
                        } else {
                            this.f15252OoooO0.zac(o0o0oo00.f37133OooO00o);
                        }
                    }
                    if (this.f15252OoooO0 == null) {
                        ArrayList arrayList2 = new ArrayList();
                        arrayList2.add(o0o0oo00.f37133OooO00o);
                        this.f15252OoooO0 = new TelemetryData(o0o0oo00.f37134OooO0O0, arrayList2);
                        zaq zaqVar2 = this.f15262Ooooo0o;
                        zaqVar2.sendMessageDelayed(zaqVar2.obtainMessage(17), o0o0oo00.f37135OooO0OO);
                    }
                }
                return true;
            case 19:
                this.f15253OoooO00 = false;
                return true;
            default:
                o0O0O00.OooO00o(31, "Unknown message id: ", i, "GoogleApiManager");
                return false;
        }
    }
    ...
    public final void zaC(@NonNull zaae zaaeVar) {
        synchronized (f15248OooooOo) {
            if (this.f15259OoooOoO != zaaeVar) {
                this.f15259OoooOoO = zaaeVar;
                this.f15260OoooOoo.clear();
            }
            this.f15260OoooOoo.addAll(zaaeVar.f15331OoooOO0);
        }
    }

    public final int zaa() {
        return this.f15256OoooOOO.getAndIncrement();
    }
    ...
    public final Task<Boolean> zap(@NonNull GoogleApi<?> googleApi) {
        o0O0000O o0o0000o2 = new o0O0000O(googleApi.getApiKey());
        zaq zaqVar = this.f15262Ooooo0o;
        zaqVar.sendMessage(zaqVar.obtainMessage(14, o0o0000o2));
        return o0o0000o2.f37098OooO0O0.getTask();
    }
    ...
    public final <O extends Api.ApiOptions> Task<Void> zaq(@NonNull GoogleApi<O> googleApi, @NonNull RegisterListenerMethod<Api.AnyClient, ?> registerListenerMethod, @NonNull UnregisterListenerMethod<Api.AnyClient, ?> unregisterListenerMethod, @NonNull Runnable runnable) {
        ...
        zaq zaqVar = this.f15262Ooooo0o;
        zaqVar.sendMessage(zaqVar.obtainMessage(8, new zach(zafVar, this.f15257OoooOOo.get(), googleApi)));
    ...
    public final <O extends Api.ApiOptions> Task<Boolean> zar(@NonNull GoogleApi<O> googleApi, @NonNull ListenerHolder.ListenerKey listenerKey, int i) {
        ...
        zaq zaqVar = this.f15262Ooooo0o;
        zaqVar.sendMessage(zaqVar.obtainMessage(13, new zach(zahVar, this.f15257OoooOOo.get(), googleApi)));
        return taskCompletionSource.getTask();
    }
    ...
    public final <O extends Api.ApiOptions> void zaw(@NonNull GoogleApi<O> googleApi, int i, @NonNull BaseImplementation.ApiMethodImpl<? extends Result, Api.AnyClient> apiMethodImpl) {
        ...
        zaq zaqVar = this.f15262Ooooo0o;
        zaqVar.sendMessage(zaqVar.obtainMessage(4, new zach(zaeVar, this.f15257OoooOOo.get(), googleApi)));
    }
    ...
    public final <O extends Api.ApiOptions, ResultT> void zax(@NonNull GoogleApi<O> googleApi, int i, @NonNull TaskApiCall<Api.AnyClient, ResultT> taskApiCall, @NonNull TaskCompletionSource<ResultT> taskCompletionSource, @NonNull StatusExceptionMapper statusExceptionMapper) {
        ...
        zaq zaqVar = this.f15262Ooooo0o;
        zaqVar.sendMessage(zaqVar.obtainMessage(4, new zach(zagVar, this.f15257OoooOOo.get(), googleApi)));
    }
