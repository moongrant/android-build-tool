...
public final class zac {
    ...
    @GuardedBy("sCache")
    public static final o00oO0o<String, String> f15648OooO00o = new o00oO0o<>();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @Nullable
    @GuardedBy("sCache")
    public static Locale f15649OooO0O0;
    ...
    public static String OooO0O0(Context context, String str) {
        o00oO0o<String, String> o00oo0o2 = f15648OooO00o;
        synchronized (o00oo0o2) {
            Configuration configuration = context.getResources().getConfiguration();
            Locale locale = (Build.VERSION.SDK_INT >= 24 ? new OooOOO0(new OooOo00(o000O00O.OooO.OooO00o(configuration))) : OooOOO0.OooO00o(configuration.locale)).f28114OooO00o.get();
            if (!locale.equals(f15649OooO0O0)) {
                o00oo0o2.clear();
                f15649OooO0O0 = locale;
            }
