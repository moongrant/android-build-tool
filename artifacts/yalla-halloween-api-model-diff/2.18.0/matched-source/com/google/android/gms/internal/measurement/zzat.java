...
import p335o0OO00o.OooOO0O;
import p335o0OO00o.OooOOO0;

/* JADX INFO: loaded from: classes2.dex */
public final class zzat implements Iterable, zzap {

    /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
    public final String f15916Oooo;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof zzat) {
            return this.f15916Oooo.equals(((zzat) obj).f15916Oooo);
        }
        return false;
    }

    public final int hashCode() {
        return this.f15916Oooo.hashCode();
    }
    ...
    public final String toString() {
        return OooO0OO.OooO00o("\"", this.f15916Oooo, "\"");
    }
    ...
    public final zzap zzbN(String str, zzg zzgVar, List list) {
        ...
        if (!"charAt".equals(str) && !"concat".equals(str) && !"hasOwnProperty".equals(str) && !"indexOf".equals(str) && !"lastIndexOf".equals(str) && !"match".equals(str) && !"replace".equals(str) && !"search".equals(str) && !"slice".equals(str) && !"split".equals(str) && !"substring".equals(str) && !"toLowerCase".equals(str) && !"toLocaleLowerCase".equals(str) && !"toString".equals(str) && !"toUpperCase".equals(str)) {
            ...
            switch (b) {
                ...
                case 1:
                    zzatVar2 = this;
                    if (!list.isEmpty()) {
                        sb = new StringBuilder(zzatVar2.f15916Oooo);
                ...
                case 3:
                    ...
                    zzatVar = new zzah(Double.valueOf(this.f15916Oooo.indexOf(list.size() > 0 ? zzgVar.zzb((zzap) list.get(0)).zzi() : "undefined", (int) zzh.zza(list.size() >= 2 ? zzgVar.zzb((zzap) list.get(1)).zzh().doubleValue() : 0.0d))));
                    return zzatVar;
                case 4:
                    zzh.zzj("lastIndexOf", 2, list);
                    String str12 = this.f15916Oooo;
                ...
                case 7:
                    ...
                    Matcher matcher2 = Pattern.compile(list.isEmpty() ? "undefined" : zzgVar.zzb((zzap) list.get(0)).zzi()).matcher(this.f15916Oooo);
                    return matcher2.find() ? new zzah(Double.valueOf(matcher2.start())) : new zzah(Double.valueOf(-1.0d));
                case 8:
                    zzh.zzj("slice", 2, list);
                    str8 = this.f15916Oooo;
                    if (list.isEmpty()) {
                        dDoubleValue2 = 0.0d;
                    } else {
                ...
                case 11:
                    zzh.zzh(str2, 0, list);
                    return new zzat(this.f15916Oooo.toUpperCase());
                case 12:
                    zzh.zzh("toLocaleLowerCase", 0, list);
                    return new zzat(this.f15916Oooo.toLowerCase());
                case 13:
                    zzh.zzh("toLowerCase", 0, list);
                    return new zzat(this.f15916Oooo.toLowerCase(Locale.ENGLISH));
                case 14:
                    zzatVar2 = this;
                ...
                case 15:
                    ...
                    return new zzat(this.f15916Oooo.toUpperCase(Locale.ENGLISH));
                case 16:
                    zzh.zzh("toUpperCase", 0, list);
                    return new zzat(this.f15916Oooo.trim());
                default:
        ...
        switch (b) {
            ...
            case 7:
                zzh.zzj("search", 1, list);
                Matcher matcher4 = Pattern.compile(list.isEmpty() ? "undefined" : zzgVar.zzb((zzap) list.get(0)).zzi()).matcher(this.f15916Oooo);
                if (matcher4.find()) {
                }
            case 8:
                zzh.zzj("slice", 2, list);
    ...
    public final zzap zzd() {
        return new zzat(this.f15916Oooo);
    }

    @Override // com.google.android.gms.internal.measurement.zzap
    public final Boolean zzg() {
        return Boolean.valueOf(!this.f15916Oooo.isEmpty());
    }

    @Override // com.google.android.gms.internal.measurement.zzap
    public final Double zzh() {
        if (this.f15916Oooo.isEmpty()) {
            return Double.valueOf(0.0d);
        }
        try {
            return Double.valueOf(this.f15916Oooo);
