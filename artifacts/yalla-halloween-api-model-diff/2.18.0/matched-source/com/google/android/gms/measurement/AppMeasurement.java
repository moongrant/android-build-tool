...
public class AppMeasurement {
    ...
    public static volatile AppMeasurement f16085OooO0O0;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final OooO0OO f16086OooO00o;
    ...
    public AppMeasurement(zzfy zzfyVar) {
        this.f16086OooO00o = new OooO00o(zzfyVar);
    }
        ...
        if (f16085OooO0O0 == null) {
            synchronized (AppMeasurement.class) {
                if (f16085OooO0O0 == null) {
                    ...
                    if (zzieVar != null) {
                        f16085OooO0O0 = new AppMeasurement(zzieVar);
                    } else {
                        f16085OooO0O0 = new AppMeasurement(zzfy.zzp(context, new zzcl(0L, 0L, true, null, null, null, null, null), null));
                    }
                }
            }
        }
        return f16085OooO0O0;
    }

    @Keep
    public void beginAdUnitExposure(@NonNull @Size(min = 1) String str) {
        this.f16086OooO00o.zzp(str);
    }
    ...
    public void clearConditionalUserProperty(@NonNull @Size(max = 24, min = 1) String str, @NonNull String str2, @NonNull Bundle bundle) {
        this.f16086OooO00o.zzq(str, str2, bundle);
    }

    @Keep
    public void endAdUnitExposure(@NonNull @Size(min = 1) String str) {
        this.f16086OooO00o.zzr(str);
    }

    @Keep
    public long generateEventId() {
        return this.f16086OooO00o.zzb();
    }

    @NonNull
    @Keep
    public String getAppInstanceId() {
        return this.f16086OooO00o.zzh();
    }

    @NonNull
    @KeepForSdk
    public Boolean getBoolean() {
        return this.f16086OooO00o.OooO00o();
    }
    ...
    public List<ConditionalUserProperty> getConditionalUserProperties(@NonNull String str, @NonNull @Size(max = 23, min = 1) String str2) {
        List listZzm = this.f16086OooO00o.zzm(str, str2);
    ...
    public String getCurrentScreenClass() {
        return this.f16086OooO00o.zzi();
    }

    @NonNull
    @Keep
    public String getCurrentScreenName() {
        return this.f16086OooO00o.zzj();
    }

    @NonNull
    @KeepForSdk
    public Double getDouble() {
        return this.f16086OooO00o.OooO0O0();
    }
    ...
    public Integer getInteger() {
        return this.f16086OooO00o.OooO0OO();
    }
    ...
    public int getMaxUserProperties(@NonNull @Size(min = 1) String str) {
        return this.f16086OooO00o.zza(str);
    }
    ...
    public Map<String, Object> getUserProperties(@NonNull String str, @NonNull @Size(max = 24, min = 1) String str2, boolean z) {
        return this.f16086OooO00o.zzo(str, str2, z);
    }

    @ShowFirstParty
    @Keep
    public void logEventInternal(@NonNull String str, @NonNull String str2, @NonNull Bundle bundle) {
        this.f16086OooO00o.zzs(str, str2, bundle);
    }

    @ShowFirstParty
    @KeepForSdk
    public void logEventInternalNoInterceptor(@NonNull String str, @NonNull String str2, @NonNull Bundle bundle, long j) {
        this.f16086OooO00o.zzt(str, str2, bundle, j);
    }

    @ShowFirstParty
    @KeepForSdk
    public void registerOnMeasurementEventListener(@NonNull OnEventListener onEventListener) {
        this.f16086OooO00o.zzu(onEventListener);
    }
    ...
    public void setConditionalUserProperty(@NonNull ConditionalUserProperty conditionalUserProperty) {
        ...
        OooO0OO oooO0OO = this.f16086OooO00o;
    ...
    public Map<String, Object> getUserProperties(boolean z) {
        return this.f16086OooO00o.OooO0o(z);
    }
