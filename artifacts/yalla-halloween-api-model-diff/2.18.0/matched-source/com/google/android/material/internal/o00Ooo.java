...
public final class o00Ooo {
    ...
    public class OooO00o implements Runnable {
        ...
        public final /* synthetic */ View f17377Oooo;

        public OooO00o(View view) {
            this.f17377Oooo = view;
        }

        @Override // java.lang.Runnable
        public final void run() {
            ((InputMethodManager) this.f17377Oooo.getContext().getSystemService("input_method")).showSoftInput(this.f17377Oooo, 1);
        }
    }
    ...
    public class OooO0O0 implements o000O0O0.oo000o {
        ...
        /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
        public final /* synthetic */ OooO0OO f17378Oooo;

        /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
        public final /* synthetic */ OooO0o f17379OoooO00;

        public OooO0O0(OooO0OO oooO0OO, OooO0o oooO0o) {
            this.f17378Oooo = oooO0OO;
            this.f17379OoooO00 = oooO0o;
        }

        @Override // o000O0O0.oo000o
        public final WindowInsetsCompat OooO00o(View view, WindowInsetsCompat windowInsetsCompat) {
            return this.f17378Oooo.OooO00o(view, windowInsetsCompat, new OooO0o(this.f17379OoooO00));
        }
    }
    ...
    public static class OooO0o {
        ...
        public int f17380OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public int f17381OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public int f17382OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f17383OooO0Oo;

        public OooO0o(int i, int i2, int i3, int i4) {
            this.f17380OooO00o = i;
            this.f17381OooO0O0 = i2;
            this.f17382OooO0OO = i3;
            this.f17383OooO0Oo = i4;
        }

        public final void OooO00o(View view) {
            int i = this.f17380OooO00o;
            int i2 = this.f17381OooO0O0;
            int i3 = this.f17382OooO0OO;
            int i4 = this.f17383OooO0Oo;
            WeakHashMap<View, o00000O> weakHashMap = ViewCompat.f7885OooO00o;
            ViewCompat.OooO.OooOO0O(view, i, i2, i3, i4);
        }

        public OooO0o(@NonNull OooO0o oooO0o) {
            this.f17380OooO00o = oooO0o.f17380OooO00o;
            this.f17381OooO0O0 = oooO0o.f17381OooO0O0;
            this.f17382OooO0OO = oooO0o.f17382OooO0OO;
            this.f17383OooO0Oo = oooO0o.f17383OooO0Oo;
        }
    }
}
