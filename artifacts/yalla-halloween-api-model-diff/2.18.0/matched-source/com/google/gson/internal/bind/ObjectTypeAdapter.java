...
public final class ObjectTypeAdapter extends o00O0<Object> {
    ...
    public static /* synthetic */ class OooO00o {
        ...
        public static final /* synthetic */ int[] f19265OooO00o;
        ...
        static {
            ...
            try {
                f19265OooO00o[JsonToken.BEGIN_OBJECT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f19265OooO00o[JsonToken.STRING.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f19265OooO00o[JsonToken.NUMBER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f19265OooO00o[JsonToken.BOOLEAN.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f19265OooO00o[JsonToken.NULL.ordinal()] = 6;
    ...
    public Object read(JsonReader jsonReader) throws IOException {
        switch (OooO00o.f19265OooO00o[jsonReader.peek().ordinal()]) {
            case 1:
