...
public class l1111l111111Il {
    ...
    public static class C0162l1111l111111Il {
        public final X509Certificate[][] l1111l111111Il;
        private byte[] l111l11111lIl;

        public C0162l1111l111111Il() {
        }

        public C0162l1111l111111Il(X509Certificate[][] x509CertificateArr, byte[] bArr) {
    ...
    public static C0162l1111l111111Il l1111l111111Il(RandomAccessFile randomAccessFile, l1111l111111Il l1111l111111il) throws IOException, CertificateException {
        ...
        return new C0162l1111l111111Il((X509Certificate[][]) arrayList.toArray(new X509Certificate[arrayList.size()][]), bArrCopyOfRange);
    }
    ...
    public static l1111l111111Il l1111l111111Il(RandomAccessFile randomAccessFile) throws IOException {
        ...
        if (jL1111l111111Il > jLongValue) {
            throw new IOException("ZIP Central Directory offset out of range: " + jL1111l111111Il + ". ZIP End of Central Directory offset: " + jLongValue);
        }
        ...
        if (jL1111l111111Il < 32) {
            throw new IOException("APK too small for APK Signing Block. ZIP Central Directory offset: " + jL1111l111111Il);
        }
    ...
    private static void l1111l111111Il(ByteBuffer byteBuffer) throws IOException {
    ...
    private static X509Certificate[] l1111l111111Il(ByteBuffer byteBuffer, Map<Integer, byte[]> map, CertificateFactory certificateFactory) throws InvalidKeySpecException, NoSuchAlgorithmException, SignatureException, IOException, InvalidKeyException, InvalidAlgorithmParameterException {
        String str;
        String str2;
        int i;
        ByteBuffer byteBufferL1111l111111Il = l111l11111lIl.l1111l111111Il(byteBuffer);
