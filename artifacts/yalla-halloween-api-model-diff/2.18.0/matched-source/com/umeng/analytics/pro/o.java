...
public class o {
    ...
    private static final String f20266o = "dstk_last_time";
    ...
    public static class a {
        ...
        /* JADX INFO: renamed from: o, reason: collision with root package name */
        public static final int f20267o = 4356;
    ...
    private void o() {
        try {
            ...
            this.j = 0;
            this.k = System.currentTimeMillis();
            PreferenceWrapper.getDefault(a).edit().putLong(f20266o, System.currentTimeMillis()).putInt(p, 0).commit();
        } catch (Throwable unused) {
        }
    }
