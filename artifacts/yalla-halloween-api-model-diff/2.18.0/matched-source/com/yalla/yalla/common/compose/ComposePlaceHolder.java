...
public final class ComposePlaceHolder {
    ...
    @NotNull
    public static final ComposePlaceHolder f20590OooO00o = new ComposePlaceHolder();
    ...
    public static final class OooO0O0 extends Lambda implements Function2<oOO00O, Integer, Unit> {
        ...
        public final /* synthetic */ PlaceholderType f20592OoooO0;

        /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
        public final /* synthetic */ coil.request.OooO00o.C0072OooO00o f20593OoooO00;

        /* JADX INFO: renamed from: OoooO0O, reason: collision with root package name */
        public final /* synthetic */ int f20594OoooO0O;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(coil.request.OooO00o.C0072OooO00o c0072OooO00o, PlaceholderType placeholderType, int i) {
            super(2);
            this.f20593OoooO00 = c0072OooO00o;
            this.f20592OoooO0 = placeholderType;
            this.f20594OoooO0O = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(oOO00O ooo00o, Integer num) {
            num.intValue();
            ComposePlaceHolder.this.OooO00o(this.f20593OoooO00, this.f20592OoooO0, ooo00o, this.f20594OoooO0O | 1);
