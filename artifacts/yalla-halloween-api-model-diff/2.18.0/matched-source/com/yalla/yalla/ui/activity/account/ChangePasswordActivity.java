...
import p536o0o0OOo0.o00OO;
import p536o0o0OOo0.oo0O;
import p651o0ooOOoo.w6;
...
public final class ChangePasswordActivity extends BaseActivityK {
    ...
    public boolean f21743OooooO0;

    /* JADX INFO: renamed from: OooooOO, reason: collision with root package name */
    public boolean f21744OooooOO;

    /* JADX INFO: renamed from: OooooOo, reason: collision with root package name */
    @NotNull
    public final o00O000o f21745OooooOo = new o00O000o(Reflection.getOrCreateKotlinClass(w6.class), this, null);

    /* JADX INFO: renamed from: Oooooo0, reason: collision with root package name */
    @NotNull
    public final ViewModelLazy f21746Oooooo0 = new ViewModelLazy(Reflection.getOrCreateKotlinClass(AccountVM.class), new Function0<ViewModelStore>() { // from class: com.yalla.yalla.ui.activity.account.ChangePasswordActivity$special$$inlined$viewModels$default$2
        {
            super(0);
        }
        ...
        public final /* synthetic */ Function0 f21751Oooo = null;
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f21751Oooo;
    ...
    public static final class OooO00o extends Lambda implements Function1<LoginInformation2, Unit> {
        ...
        public final Unit invoke(LoginInformation2 loginInformation2) {
            ...
            if (loginInformation3 != null) {
                ...
                ToastUtil.f12582OooO00o.OooO0O0(o000O0O0.OooO0OO(R.string.Successfully));
    ...
    public static final void OooOoo(ChangePasswordActivity changePasswordActivity) {
        String string = changePasswordActivity.OooOooO().f50853OooO0o0.getText().toString();
        ...
        String string3 = changePasswordActivity.OooOooO().f50852OooO0o.getText().toString();
        ...
        if (!(string2.length() == 0)) {
            if (!(string4.length() == 0)) {
                changePasswordActivity.OooOooO().f50849OooO0O0.setEnabled(true);
                changePasswordActivity.OooOooO().f50849OooO0O0.setClickable(true);
                return;
            }
        }
        changePasswordActivity.OooOooO().f50849OooO0O0.setEnabled(false);
        changePasswordActivity.OooOooO().f50849OooO0O0.setClickable(false);
    }

    public final w6 OooOooO() {
        return (w6) this.f21745OooooOo.getValue();
    }
    ...
    public void onClick(@NotNull View v) {
        ...
        switch (v.getId()) {
            case R.id.btn_submit /* 2131296559 */:
                String string5 = OooOooO().f50852OooO0o.getText().toString();
                ...
                while (i3 <= length2) {
                    ...
                    if (z4) {
                        if (!z5) {
                            ...
                            string2 = OooOooO().f50853OooO0o0.getText().toString();
                            ...
                            while (i <= length) {
                                ...
                                if (z) {
                                    if (!z2) {
                                        ...
                                        if (OooOooO().f50853OooO0o0.getText().toString().length() != string3.length()) {
                                            string4 = getString(R.string.invalid_password);
                                            toastUtil3 = ToastUtil.f12583OooO0O0;
                                            ...
                                            toastUtil2 = ToastUtil.f12583OooO0O0;
                                            ...
                                            ((AccountVM) this.f21746Oooooo0.getValue()).userPasswordEdit(string, string3).observe(this, new OooOo(new OooO00o(), null, new OooO0O0(), false, 10));
                                            break;
                                        } else {
            ...
            case R.id.iv_see_new /* 2131297978 */:
                boolean z6 = !this.f21744OooooOO;
                this.f21744OooooOO = z6;
                if (z6) {
                    OooOooO().f50853OooO0o0.setInputType(144);
                    OooOooO().f50850OooO0OO.setImageResource(R.drawable.eye1);
                } else {
                    OooOooO().f50853OooO0o0.setInputType(Constants.ERR_WATERMARK_READ);
                    OooOooO().f50850OooO0OO.setImageResource(R.drawable.eye2);
                }
                OooOooO().f50853OooO0o0.setTypeface(Typeface.DEFAULT);
                o0000.OooOO0(OooOooO().f50853OooO0o0);
                break;
            case R.id.iv_see_old /* 2131297979 */:
                boolean z7 = !this.f21743OooooO0;
                this.f21743OooooO0 = z7;
                if (z7) {
                    OooOooO().f50852OooO0o.setInputType(144);
                    OooOooO().f50851OooO0Oo.setImageResource(R.drawable.eye1);
                } else {
                    OooOooO().f50852OooO0o.setInputType(Constants.ERR_WATERMARK_READ);
                    OooOooO().f50851OooO0Oo.setImageResource(R.drawable.eye2);
                }
                OooOooO().f50852OooO0o.setTypeface(Typeface.DEFAULT);
                o0000.OooOO0(OooOooO().f50852OooO0o);
                break;
        }
    }
    ...
    public final void onCreate(@Nullable Bundle bundle) {
        ...
        setContentView(OooOooO().f50848OooO00o);
        HeaderLayout headerLayout = this.f11480OoooOOO;
        if (headerLayout != null) {
            headerLayout.setTitle(R.string.change_password);
        }
        OooOo0O(1);
        OooOooO().f50849OooO0O0.setOnClickListener(this);
        OooOooO().f50851OooO0Oo.setOnClickListener(this);
        OooOooO().f50850OooO0OO.setOnClickListener(this);
        OooOooO().f50853OooO0o0.addTextChangedListener(new oo0O(this));
        OooOooO().f50852OooO0o.addTextChangedListener(new o00OO(this));
        OooOooO().f50852OooO0o.setTypeface(Typeface.DEFAULT);
        OooOooO().f50853OooO0o0.setTypeface(Typeface.DEFAULT);
    }
}
