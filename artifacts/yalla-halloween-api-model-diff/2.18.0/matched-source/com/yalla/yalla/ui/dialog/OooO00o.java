...
public final class OooO00o extends p189o00o00o0.OooO0OO<RoomGameBoxDialog.GameType> {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final /* synthetic */ RoomGameBoxDialog f23760OooO00o;
    ...
    public OooO00o(RoomGameBoxDialog roomGameBoxDialog, MixedRoomActivity mixedRoomActivity) {
        ...
        this.f23760OooO00o = roomGameBoxDialog;
    }
    ...
    public final void convert(com.chad.library.adapter.base.OooO00o oooO00o, Object obj) {
        ...
        switch (C0259OooO00o.$EnumSwitchMapping$0[gameType.ordinal()]) {
            case 1:
                ...
                sb.append(OooOOO.f41235OooO00o.OooOo().getValue());
            ...
            case 5:
                ...
                int i = this.f23760OooO00o.f23768OooOO0O;
                ...
                oooO0o.OooO0oO(R.id.tvLuckyNumberCost, this.f23760OooO00o.f23767OooOO0);
                TextView tvCenterLuckyNumber = (TextView) oooO0o.OooO0Oo(R.id.tvLuckyNumberCost);
                RoomGameBoxDialog roomGameBoxDialog = this.f23760OooO00o;
                Intrinsics.checkNotNullExpressionValue(tvCenterLuckyNumber, "tvCenterLuckyNumber");
                int i3 = this.f23760OooO00o.f23769OooOO0o;
                Objects.requireNonNull(roomGameBoxDialog);
                tvCenterLuckyNumber.setVisibility(0);
                if (i3 == 0) {
                    tvCenterLuckyNumber.setText(roomGameBoxDialog.f23765OooO0oO.getString(R.string.Free_lucky_number));
                    tvCenterLuckyNumber.setTextColor(o000O000.OooO00o.OooO0O0(roomGameBoxDialog.f23765OooO0oO, R.color.color_CCCCCC));
                    tvCenterLuckyNumber.setCompoundDrawables(null, null, null, null);
                } else if (i3 == 2 || i3 == 5) {
                    tvCenterLuckyNumber.setText(String.valueOf(i3));
                    tvCenterLuckyNumber.setTextColor(o000O000.OooO00o.OooO0O0(roomGameBoxDialog.f23765OooO0oO, R.color.color_ffe024));
                    Drawable drawableOooO0O0 = o000O000.OooO00o.OooO0OO.OooO0O0(roomGameBoxDialog.f23765OooO0oO, R.drawable.coin_little);
                ...
                if (value != null && value.intValue() == 1) {
                    ...
                    boolean z2 = roomGameBoxDialog2.f23771OooOOO0;
                    Intrinsics.checkNotNullExpressionValue(it, "it");
                    if (z2) {
                        oOO00O.OooO(it);
                    } else {
