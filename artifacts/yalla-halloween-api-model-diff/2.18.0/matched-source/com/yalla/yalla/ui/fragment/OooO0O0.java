...
import p589o0oOoo0O.o0OOO0OO;
import p589o0oOoo0O.o0OOo000;

/* JADX INFO: loaded from: classes3.dex */
public final class OooO0O0 extends Lambda implements Function2<oOO00O, Integer, Unit> {

    /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
    public final /* synthetic */ EventDisplayChildFragment f24075Oooo;
    ...
    public OooO0O0(EventDisplayChildFragment eventDisplayChildFragment) {
        super(2);
        this.f24075Oooo = eventDisplayChildFragment;
    }
    ...
    public final Unit invoke(oOO00O ooo00o, Integer num) {
        ...
        if ((num.intValue() & 11) == 2 && ooo00o2.OooOo0()) {
            ...
            EventPage eventPage = this.f24075Oooo.eventPage;
            if (eventPage == null) {
            ...
            if (i == 1) {
                ...
                o0OOo000.OooO00o(this.f24075Oooo.getEventVM(), ooo00o2, 0);
                ooo00o2.Oooo0o0();
            } else if (i != 2) {
                ...
                o0OOO0OO.OooO00o(this.f24075Oooo.getEventVM(), ooo00o2, 0);
                ooo00o2.Oooo0o0();
            }
        }
