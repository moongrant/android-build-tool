...
public final class PacketHistoryFragment extends p505o0o00o00.OooO<zf> {
    ...
    private final void initView() {
        ...
        RtlViewPager rtlViewPager = getBinding().f51120OooO0Oo;
        FragmentManager childFragmentManager = getChildFragmentManager();
        Intrinsics.checkNotNullExpressionValue(childFragmentManager, "childFragmentManager");
        rtlViewPager.setAdapter(new p464o0Ooo0o.o0000O00(childFragmentManager, listMutableListOf));
        getBinding().f51120OooO0Oo.OooO0O0(new OooO0O0());
        getBinding().f51118OooO0O0.setOnClickListener(this);
        getBinding().f51119OooO0OO.setOnClickListener(this);
        switchTitle(0);
    }
    ...
    public final void switchTitle(int position) {
        if (position == 0) {
            getBinding().f51118OooO0O0.setSelected(true);
            getBinding().f51118OooO0O0.setTextColor(p255o00ooO0O.o000O0O0.OooO00o(R.color.color_333333));
            TextView textView = getBinding().f51118OooO0O0;
            ...
            getBinding().f51119OooO0OO.setSelected(false);
            getBinding().f51119OooO0OO.setTextColor(p255o00ooO0O.o000O0O0.OooO00o(R.color.white));
            TextView textView2 = getBinding().f51119OooO0OO;
            ...
            getBinding().f51118OooO0O0.setSelected(false);
            getBinding().f51118OooO0O0.setTextColor(p255o00ooO0O.o000O0O0.OooO00o(R.color.white));
            TextView textView3 = getBinding().f51118OooO0O0;
            ...
            getBinding().f51119OooO0OO.setSelected(true);
            getBinding().f51119OooO0OO.setTextColor(p255o00ooO0O.o000O0O0.OooO00o(R.color.color_333333));
            TextView textView4 = getBinding().f51119OooO0OO;
        ...
        getBinding().f51120OooO0Oo.OooOoO(position, true);
    }
    ...
    public void onNoDoubleClick(@NotNull View view) {
        ...
        if (Intrinsics.areEqual(view, getBinding().f51118OooO0O0)) {
            switchTitle(0);
        } else if (Intrinsics.areEqual(view, getBinding().f51119OooO0OO)) {
            switchTitle(1);
        }
    }
