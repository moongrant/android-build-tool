            ...
            try {
                this.mBTHeadsetListener = new BluetoothProfile.ServiceListener() { // from class: io.agora.rtc.internal.AudioRoutingController.3
                    ...
                    public void onServiceConnected(int i, BluetoothProfile bluetoothProfile) {
                        Logging.i(AudioRoutingController.TAG, o000000.OooO0O0("onServiceConnected ", i, " =? headset(", 1, ")"));
                        if (i != 1) {
                            if (i == 2) {
                    ...
                    public void onServiceDisconnected(int i) {
                        Logging.i(AudioRoutingController.TAG, o000000.OooO0O0("onServiceDisconnected ", i, " =? headset(", 1, ")"));
                        if (i != 1) {
                            if (i == 2) {
