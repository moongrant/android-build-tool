...
public final class TypeReference implements KType {
    ...
    private final String asString(boolean convertPrimitiveToWrapper) {
        ...
        String strOooO00o = OooO0OO.OooO00o(name, getArguments().isEmpty() ? "" : CollectionsKt___CollectionsKt.joinToString$default(getArguments(), ", ", "<", ">", 0, null, new Function1<KTypeProjection, CharSequence>() { // from class: kotlin.jvm.internal.TypeReference$asString$args$1
            {
                super(1);
            }
        ...
        if (Intrinsics.areEqual(strAsString, strOooO00o)) {
            return strOooO00o;
        }
        if (Intrinsics.areEqual(strAsString, strOooO00o + '?')) {
            return strOooO00o + '!';
        }
        return '(' + strOooO00o + ".." + strAsString + ')';
    }
    ...
    public String toString() {
        return OooO00o.OooO00o(new StringBuilder(), asString(false), Reflection.REFLECTION_NOT_AVAILABLE);
    }
    ...
    public final String asString(KTypeProjection kTypeProjection) {
        ...
        if (i == 2) {
            return OooOo00.OooO00o("in ", strValueOf);
        }
        if (i == 3) {
            return OooOo00.OooO00o("out ", strValueOf);
        }
