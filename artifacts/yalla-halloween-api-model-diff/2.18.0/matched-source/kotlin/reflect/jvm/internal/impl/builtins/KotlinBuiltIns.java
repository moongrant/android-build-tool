...
public abstract class KotlinBuiltIns {
    ...
    public KotlinBuiltIns(@NotNull StorageManager storageManager) {
        ...
        this.builtInClassesByName = storageManager.createMemoizedFunction(new Function1<Name, ClassDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.3
            ...
            public ClassDescriptor invoke(Name name) {
                ClassifierDescriptor classifierDescriptorMo1792getContributedClassifier = KotlinBuiltIns.this.getBuiltInsPackageScope().mo1792getContributedClassifier(name, NoLookupLocation.FROM_BUILTINS);
                if (classifierDescriptorMo1792getContributedClassifier == null) {
                    StringBuilder sbOooO0O0 = OooO00o.OooO00o.OooO0O0("Built-in class ");
                    sbOooO0O0.append(StandardNames.BUILT_INS_PACKAGE_FQ_NAME.child(name));
                    sbOooO0O0.append(" is not found");
                ...
                throw new AssertionError("Must be a class descriptor " + name + ", but was " + classifierDescriptorMo1792getContributedClassifier);
            }
        });
    }
    ...
    private static KotlinType getElementTypeForUnsignedArray(@NotNull KotlinType kotlinType, @NotNull ModuleDescriptor moduleDescriptor) {
        ...
        if (!unsignedTypes.isShortNameOfUnsignedArray(classifierDescriptorMo1790getDeclarationDescriptor.getName()) || (classId = DescriptorUtilsKt.getClassId(classifierDescriptorMo1790getDeclarationDescriptor)) == null || (unsignedClassIdByArrayClassId = unsignedTypes.getUnsignedClassIdByArrayClassId(classId)) == null || (classDescriptorFindClassAcrossModuleDependencies = FindClassInModuleKt.findClassAcrossModuleDependencies(moduleDescriptor, unsignedClassIdByArrayClassId)) == null) {
            return null;
        }
    ...
    public static PrimitiveType getPrimitiveArrayElementType(@NotNull KotlinType kotlinType) {
        ...
        return getPrimitiveArrayType(classifierDescriptorMo1790getDeclarationDescriptor);
    }
    ...
    public static boolean isDefaultBound(@NotNull KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(ZegoConstants.RoomError.SessionError);
        }
    ...
    public static boolean isDeprecated(@NotNull DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(Constants.ERR_ALREADY_IN_RECORDING);
        }
    ...
    public static boolean isKClass(@NotNull ClassDescriptor classDescriptor) {
        if (classDescriptor == null) {
            $$$reportNull$$$0(Constants.ERR_MODULE_NOT_FOUND);
        }
    ...
    public static boolean isPrimitiveArray(@NotNull KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo1790getDeclarationDescriptor = kotlinType.getConstructor().mo1790getDeclarationDescriptor();
        return (classifierDescriptorMo1790getDeclarationDescriptor == null || getPrimitiveArrayType(classifierDescriptorMo1790getDeclarationDescriptor) == null) ? false : true;
    }
    ...
    public static boolean isPrimitiveTypeOrNullablePrimitiveType(@NotNull KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo1790getDeclarationDescriptor = kotlinType.getConstructor().mo1790getDeclarationDescriptor();
        return (classifierDescriptorMo1790getDeclarationDescriptor instanceof ClassDescriptor) && isPrimitiveClass((ClassDescriptor) classifierDescriptorMo1790getDeclarationDescriptor);
    }
    ...
    public static boolean isTypeConstructorForGivenClass(@NotNull TypeConstructor typeConstructor, @NotNull FqNameUnsafe fqNameUnsafe) {
        ...
        return (classifierDescriptorMo1790getDeclarationDescriptor instanceof ClassDescriptor) && classFqNameEquals(classifierDescriptorMo1790getDeclarationDescriptor, fqNameUnsafe);
    }
    ...
    public void setBuiltInsModule(@NotNull final ModuleDescriptorImpl moduleDescriptorImpl) {
        ...
        this.storageManager.compute(new Function0<Void>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.4
            ...
            public Void invoke() {
                ...
                StringBuilder sbOooO0O0 = OooO00o.OooO00o.OooO0O0("Built-ins module is already set: ");
                sbOooO0O0.append(KotlinBuiltIns.this.builtInsModule);
                sbOooO0O0.append(" (attempting to reset to ");
                sbOooO0O0.append(moduleDescriptorImpl);
                sbOooO0O0.append(")");
                throw new AssertionError(sbOooO0O0.toString());
            }
        });
