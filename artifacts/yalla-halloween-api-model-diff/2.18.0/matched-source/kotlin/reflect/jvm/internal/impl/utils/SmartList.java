...
public class SmartList<E> extends AbstractList<E> implements RandomAccess {
    ...
    public class SingletonIterator extends SingletonIteratorBase<E> {
        ...
        public void checkCoModification() {
            ...
            StringBuilder sbOooO0O0 = OooO00o.OooO0O0("ModCount: ");
            sbOooO0O0.append(((AbstractList) SmartList.this).modCount);
            sbOooO0O0.append("; expected: ");
            sbOooO0O0.append(this.myInitialModCount);
            throw new ConcurrentModificationException(sbOooO0O0.toString());
        }
    ...
    public boolean add(E e) {
        ...
        if (i == 0) {
            ...
            if (i >= length) {
                int iOooO00o = kotlin.reflect.jvm.internal.impl.builtins.OooO00o.OooO00o(length, 3, 2, 1);
                int i2 = i + 1;
                if (iOooO00o < i2) {
                    iOooO00o = i2;
                }
