...
final /* synthetic */ class FlowKt__MigrationKt {
    ...
    public static final class C06191<T> extends SuspendLambda implements Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        public final /* synthetic */ long $timeMillis;
        public int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C06191(long j, Continuation<? super C06191> continuation) {
            super(2, continuation);
            this.$timeMillis = j;
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C06191(this.$timeMillis, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        @Nullable
        public final Object invoke(@NotNull FlowCollector<? super T> flowCollector, @Nullable Continuation<? super Unit> continuation) {
            return ((C06191) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Flow<T> delayFlow(@NotNull Flow<? extends T> flow, long j) {
        return FlowKt.onStart(flow, new C06191(j, null));
    }
    ...
    public static final <T> Flow<T> onErrorReturn(@NotNull Flow<? extends T> flow, T t, @NotNull Function1<? super Throwable, Boolean> function1) {
        return FlowKt.m2040catch(flow, new AnonymousClass2(function1, t, null));
    }
