...
public class OpenSSLSignature extends SignatureSpi {
    ...
    public static abstract class RSAPSSPadding extends OpenSSLSignature {
        ...
        public final void engineSetParameter(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidAlgorithmParameterException {
            ...
            if (jcaDigestAlgorithmStandardName == null) {
                StringBuilder sbOooO0O0 = OooO00o.OooO00o.OooO0O0("Unsupported content digest algorithm: ");
                sbOooO0O0.append(pSSParameterSpec.getDigestAlgorithm());
                throw new InvalidAlgorithmParameterException(sbOooO0O0.toString());
            }
            ...
            if (!EvpMdRef.MGF1_ALGORITHM_NAME.equalsIgnoreCase(mGFAlgorithm) && !EvpMdRef.MGF1_OID.equals(mGFAlgorithm)) {
                throw new InvalidAlgorithmParameterException(oo000o.OooO00o("Unsupported MGF algorithm: ", mGFAlgorithm, ". Only ", EvpMdRef.MGF1_ALGORITHM_NAME, " supported"));
            }
            ...
            if (jcaDigestAlgorithmStandardName2 == null) {
                StringBuilder sbOooO0O1 = OooO00o.OooO00o.OooO0O0("Unsupported MGF1 digest algorithm: ");
                sbOooO0O1.append(mGF1ParameterSpec.getDigestAlgorithm());
                throw new InvalidAlgorithmParameterException(sbOooO0O1.toString());
            }
            try {
                ...
                if (saltLength < 0) {
                    throw new InvalidAlgorithmParameterException(android.support.v4.media.OooO00o.OooO00o("Salt length must be non-negative: ", saltLength));
                }
                int trailerField = pSSParameterSpec.getTrailerField();
                if (trailerField != 1) {
                    throw new InvalidAlgorithmParameterException(o000000.OooO0O0("Unsupported trailer field: ", trailerField, ". Only ", 1, " supported"));
                }
                ...
                throw new ProviderException(OooOo00.OooO00o("Failed to obtain EVP_MD for ", jcaDigestAlgorithmStandardName2), e);
            }
        }
    }
    ...
    private void checkEngineType(OpenSSLKey openSSLKey) throws InvalidKeyException {
        ...
        if (i == 1) {
            ...
            StringBuilder sbOooO0O0 = OooO00o.OooO00o.OooO0O0("Signature initialized as ");
            sbOooO0O0.append(this.engineType);
            sbOooO0O0.append(" (not RSA)");
            throw new InvalidKeyException(sbOooO0O0.toString());
        }
        if (i != 2) {
            StringBuilder sbOooO0O1 = OooO00o.OooO00o.OooO0O0("Key must be of type ");
            sbOooO0O1.append(this.engineType);
            throw new InvalidKeyException(sbOooO0O1.toString());
        }
        if (iEVP_PKEY_type == 408) {
            return;
        }
        StringBuilder sbOooO0O2 = OooO00o.OooO00o.OooO0O0("Signature initialized as ");
        sbOooO0O2.append(this.engineType);
        sbOooO0O2.append(" (not EC)");
        throw new InvalidKeyException(sbOooO0O2.toString());
    }
