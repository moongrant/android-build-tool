...
public class o000000O {
    ...
    public static o000000O f27579OooO0O0 = new o000000O();

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static String[] f27580OooO0OO = {"standard", "accelerate", "decelerate", "linear"};

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public String f27581OooO00o = "identity";

    public static class OooO00o extends o000000O {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public double f27582OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public double f27583OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public double f27584OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public double f27585OooO0oO;

        public OooO00o(String str) {
            this.f27581OooO00o = str;
            int iIndexOf = str.indexOf(40);
            int iIndexOf2 = str.indexOf(44, iIndexOf);
            this.f27582OooO0Oo = Double.parseDouble(str.substring(iIndexOf + 1, iIndexOf2).trim());
            int i = iIndexOf2 + 1;
            int iIndexOf3 = str.indexOf(44, i);
            this.f27584OooO0o0 = Double.parseDouble(str.substring(i, iIndexOf3).trim());
            int i2 = iIndexOf3 + 1;
            int iIndexOf4 = str.indexOf(44, i2);
            this.f27583OooO0o = Double.parseDouble(str.substring(i2, iIndexOf4).trim());
            int i3 = iIndexOf4 + 1;
            this.f27585OooO0oO = Double.parseDouble(str.substring(i3, str.indexOf(41, i3)).trim());
        }
        ...
        public final double OooO0Oo(double d) {
            ...
            double d4 = d2 * d3 * d;
            double d5 = d3 * d * d;
            return (this.f27583OooO0o * d5) + (this.f27582OooO0Oo * d4) + (d * d * d);
        }
        ...
        public final double OooO0o0(double d) {
            ...
            double d4 = d2 * d3 * d;
            double d5 = d3 * d * d;
            return (this.f27585OooO0oO * d5) + (this.f27584OooO0o0 * d4) + (d * d * d);
        }
    }
    ...
    public static o000000O OooO0OO(String str) {
        ...
        switch (str) {
            ...
            default:
                ...
                sbOooO0O0.append(Arrays.toString(f27580OooO0OO));
                printStream.println(sbOooO0O0.toString());
                return f27579OooO0O0;
        }
    }
