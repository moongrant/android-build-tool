...
import p124o00O0o0.o000oOoO;
import p124o00O0o0.o00O0O;
import p124o00O0o0.o0OoOo0;
import p126o00O0o0O.o000OOo;
import p126o00O0o0O.oo0o0Oo;
...
public final class o000 {
    ...
    public static final JsonReader.OooO00o f31083OooO00o = JsonReader.OooO00o.OooO00o("nm", "ind", "refId", "ty", "parent", "sw", "sh", "sc", "ks", "tt", "masksProperties", "shapes", ak.aH, "ef", "sr", "st", "w", "h", "ip", "op", "tm", "cl", "hd");

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final JsonReader.OooO00o f31084OooO0O0 = JsonReader.OooO00o.OooO00o("d", ak.av);

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final JsonReader.OooO00o f31085OooO0OO = JsonReader.OooO00o.OooO00o("ty", "nm");

    public static /* synthetic */ class OooO00o {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public static final /* synthetic */ int[] f31086OooO00o;
        ...
        static {
            ...
            try {
                f31086OooO00o[Layer.MatteType.LUMA_INVERTED.ordinal()] = 2;
    ...
    public static Layer OooO00o(JsonReader jsonReader, OooOO0O oooOO0O) throws IOException {
        ...
        while (jsonReader.OooOOO()) {
            boolean z2 = true;
            switch (jsonReader.Oooo0(f31083OooO00o)) {
                case 0:
                    str = strOooOoOO;
                ...
                case 10:
                    ...
                    str = strOooOoOO;
                    oooOO0O.f10070OooOOOO += arrayList.size();
                    jsonReader.OooO0Oo();
                    continue;
                    strOooOoOO = str;
                    z = false;
                ...
                case 12:
                    jsonReader.OooO0O0();
                    while (jsonReader.OooOOO()) {
                        int iOooo0 = jsonReader.Oooo0(f31084OooO0O0);
                        if (iOooo0 == 0) {
                            o000oooo2 = new o000oOoO(oo0o0Oo.OooO00o(jsonReader, oooOO0O, o00000.f31088OooO00o));
                        } else if (iOooo0 != 1) {
                            jsonReader.Oooo0OO();
                            jsonReader.Oooo0o();
                        } else {
                            ...
                            if (jsonReader.OooOOO()) {
                                JsonReader.OooO00o oooO00o = o0Oo0oo.f31144OooO00o;
                                jsonReader.OooO0O0();
                                o0OoOo0 o0oooo2 = null;
                                while (jsonReader.OooOOO()) {
                                    if (jsonReader.Oooo0(o0Oo0oo.f31144OooO00o) != 0) {
                                        jsonReader.Oooo0OO();
                                        jsonReader.Oooo0o();
                                    } else {
                                        jsonReader.OooO0O0();
                                        ...
                                        while (jsonReader.OooOOO()) {
                                            int iOooo1 = jsonReader.Oooo0(o0Oo0oo.f31145OooO0O0);
                                            if (iOooo1 == 0) {
                ...
                case 13:
                    ...
                    while (jsonReader.OooOOO()) {
                        jsonReader.OooO0O0();
                        while (jsonReader.OooOOO()) {
                            int iOooo2 = jsonReader.Oooo0(f31085OooO0OO);
                            if (iOooo2 == 0) {
                                int iOooOo0O3 = jsonReader.OooOo0O();
                                if (iOooOo0O3 == 29) {
                                    JsonReader.OooO00o oooO00o2 = o0O0O00.f31139OooO00o;
                                    oo0o0oo = null;
                                    while (jsonReader.OooOOO()) {
                                        if (jsonReader.Oooo0(o0O0O00.f31139OooO00o) != 0) {
                                            jsonReader.Oooo0OO();
                                            jsonReader.Oooo0o();
                                        } else {
                                            jsonReader.OooO00o();
                                            while (jsonReader.OooOOO()) {
                                                ...
                                                while (true) {
                                                    ...
                                                    while (true) {
                                                        if (jsonReader.OooOOO()) {
                                                            int iOooo3 = jsonReader.Oooo0(o0O0O00.f31140OooO0O0);
                                                            if (iOooo3 != 0) {
                                                                if (iOooo3 != z2) {
                                                                    jsonReader.Oooo0OO();
                                                                    jsonReader.Oooo0o();
                                    ...
                                    while (jsonReader.OooOOO()) {
                                        if (jsonReader.Oooo0(o00000O.f31092OooO0o) != 0) {
                                            jsonReader.Oooo0OO();
                                            jsonReader.Oooo0o();
                                        } else {
                                            jsonReader.OooO00o();
                                            while (jsonReader.OooOOO()) {
                                                ...
                                                String strOooOoOO5 = "";
                                                while (jsonReader.OooOOO()) {
                                                    int iOooo4 = jsonReader.Oooo0(o00000O.f31093OooO0oO);
                                                    if (iOooo4 == 0) {
                                                        ...
                                                        if (b3 == 0) {
                                                            o00000o.f31097OooO0Oo = oo0o0Oo.OooO0OO(jsonReader, oooOO0O, true);
                                                        } else if (b3 == z2) {
                                                            o00000o.f31095OooO0O0 = oo0o0Oo.OooO0OO(jsonReader, oooOO0O, false);
                                                        } else if (b3 == 2) {
                                                            o00000o.f31096OooO0OO = oo0o0Oo.OooO0OO(jsonReader, oooOO0O, false);
                                                        } else if (b3 == 3) {
                                                            o00000o.f31094OooO00o = oo0o0Oo.OooO0O0(jsonReader, oooOO0O);
                                                        } else if (b3 != 4) {
                                                            jsonReader.Oooo0o();
                                                        } else {
                                                            o00000o.f31098OooO0o0 = oo0o0Oo.OooO0OO(jsonReader, oooOO0O, true);
                                                        }
                                                    }
                                                    z2 = true;
                                                }
                                    ...
                                    OooOO0 oooOO1 = o00000o.f31094OooO00o;
                                    o00000o1 = (oooOO1 == null || (oooOO0O2 = o00000o.f31095OooO0O0) == null || (oooOO0O3 = o00000o.f31096OooO0OO) == null || (oooOO0O4 = o00000o.f31097OooO0Oo) == null || (oooOO0O5 = o00000o.f31098OooO0o0) == null) ? null : new o00000O0(oooOO1, oooOO0O2, oooOO0O3, oooOO0O4, oooOO0O5);
                                }
                            } else if (iOooo2 != z2) {
                                jsonReader.Oooo0OO();
                                jsonReader.Oooo0o();
        ...
        if (fOooOOoo > ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE) {
            arrayList4.add(new p132o00O0oo0.o000OOo(oooOO0O, fValueOf2, fValueOf2, (Interpolator) null, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, Float.valueOf(fOooOOoo)));
        }
        if (fOooOOoo4 <= ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE) {
            fOooOOoo4 = oooOO0O.f10067OooOO0o;
        }
        arrayList4.add(new p132o00O0oo0.o000OOo(oooOO0O, fValueOf, fValueOf, (Interpolator) null, fOooOOoo, Float.valueOf(fOooOOoo4)));
        arrayList4.add(new p132o00O0oo0.o000OOo(oooOO0O, fValueOf2, fValueOf2, (Interpolator) null, fOooOOoo4, Float.valueOf(Float.MAX_VALUE)));
