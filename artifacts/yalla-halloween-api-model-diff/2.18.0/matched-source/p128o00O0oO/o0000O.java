...
public final class o0000O {
    ...
    public static o0ooOOo<WeakReference<Interpolator>> f31106OooO0O0;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public static final LinearInterpolator f31105OooO00o = new LinearInterpolator();

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static JsonReader.OooO00o f31107OooO0OO = JsonReader.OooO00o.OooO00o(ak.aH, ak.aB, "e", "o", ak.aC, "h", "to", "ti");

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public static JsonReader.OooO00o f31108OooO0Oo = JsonReader.OooO00o.OooO00o("x", "y");
    ...
    public static Interpolator OooO00o(PointF pointF, PointF pointF2) {
        ...
        float f2 = pointF.y;
        float f3 = pointF2.x;
        ThreadLocal<PathMeasure> threadLocal = o000O0Oo.f31159OooO00o;
        ...
        synchronized (o0000O.class) {
            if (f31106OooO0O0 == null) {
                f31106OooO0O0 = new o0ooOOo<>();
            }
            weakReferenceOooO0oO = f31106OooO0O0.OooO0oO(i, null);
        }
        ...
        if (weakReferenceOooO0oO == null || interpolator == null) {
            ...
            try {
                ...
                synchronized (o0000O.class) {
                    f31106OooO0O0.OooOO0O(i, weakReference);
                }
    ...
    public static <T> o000OOo<T> OooO0O0(JsonReader jsonReader, OooOO0O oooOO0O, float f, o0O0ooO<T> o0o0ooo, boolean z, boolean z2) throws IOException {
        ...
        if (!z || !z2) {
            ...
            while (jsonReader.OooOOO()) {
                switch (jsonReader.Oooo0(f31107OooO0OO)) {
                    case 0:
            ...
            jsonReader.OooO0o();
            if (z3) {
                interpolatorOooO00o = f31105OooO00o;
                t = tOooO00o;
            } else {
                interpolatorOooO00o = (pointFOooO0O3 == null || pointFOooO0O0 == null) ? f31105OooO00o : OooO00o(pointFOooO0O3, pointFOooO0O0);
                t = tOooO00o2;
            }
            o000OOo<T> o000ooo3 = new o000OOo<>(oooOO0O, tOooO00o, t, interpolatorOooO00o, fOooOOoo, (Float) null);
            o000ooo3.f31187OooOOOO = pointFOooO0O1;
            o000ooo3.f31188OooOOOo = pointFOooO0O2;
            return o000ooo3;
        }
        jsonReader.OooO0O0();
        PointF pointF4 = null;
            ...
            switch (jsonReader.Oooo0(f31107OooO0OO)) {
                ...
                case 3:
                    ...
                    if (jsonReader.OooOoo() == JsonReader.Token.BEGIN_OBJECT) {
                        ...
                        while (jsonReader.OooOOO()) {
                            int iOooo0 = jsonReader.Oooo0(f31108OooO0Oo);
                            if (iOooo0 == 0) {
                ...
                case 4:
                    if (jsonReader.OooOoo() == JsonReader.Token.BEGIN_OBJECT) {
                        ...
                        while (jsonReader.OooOOO()) {
                            ...
                            int iOooo1 = jsonReader.Oooo0(f31108OooO0Oo);
                            if (iOooo1 != 0) {
        ...
        jsonReader.OooO0o();
        if (z4) {
            interpolatorOooO00o2 = f31105OooO00o;
            tOooO00o4 = tOooO00o3;
        } else {
            if (pointFOooO0O5 == null || pointFOooO0O6 == null) {
                ...
                o000ooo2.f31187OooOOOO = pointF14;
                o000ooo2.f31188OooOOOo = pointF13;
                return o000ooo2;
            }
