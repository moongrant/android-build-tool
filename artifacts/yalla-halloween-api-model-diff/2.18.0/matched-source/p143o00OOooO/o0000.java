...
public final /* synthetic */ class o0000 implements Observer {
    ...
    public final /* synthetic */ int f31933OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final /* synthetic */ Object f31934OooO0O0;

    public /* synthetic */ o0000(Object obj, int i) {
        this.f31933OooO00o = i;
        this.f31934OooO0O0 = obj;
    }

    @Override // androidx.lifecycle.Observer
    public final void onChanged(Object obj) {
        boolean z = true;
        switch (this.f31933OooO00o) {
            case 0:
                MainMomentFragment.m32initObserver$lambda8((MainMomentFragment) this.f31934OooO0O0, (Integer) obj);
                break;
            case 1:
                LoginActivity context = (LoginActivity) this.f31934OooO0O0;
                ...
                break;
            case 2:
                PrivateChatActivity this$0 = (PrivateChatActivity) this.f31934OooO0O0;
                ...
                break;
            case 3:
                UserInfoActivity this$1 = (UserInfoActivity) this.f31934OooO0O0;
                ...
                break;
            case 4:
                oOO this$2 = (oOO) this.f31934OooO0O0;
                Intrinsics.checkNotNullParameter(this$2, "this$0");
                if (Intrinsics.areEqual(obj, (Object) 0)) {
                    AppCompatTextView appCompatTextView = this$2.OooOO0O().f49335OooOOOO;
                    Intrinsics.checkNotNullExpressionValue(appCompatTextView, "binding.selected");
                    oo0o0O0.OooO0oo(appCompatTextView, this$2.f46067OoooOOo);
                } else {
                    AppCompatTextView appCompatTextView2 = this$2.OooOO0O().f49335OooOOOO;
                    Intrinsics.checkNotNullExpressionValue(appCompatTextView2, "binding.selected");
                    oo0o0O0.OooO0oo(appCompatTextView2, this$2.f46066OoooOOO);
                }
                break;
            default:
                RoomThemeCustomizeVM roomThemeCustomizeVM = (RoomThemeCustomizeVM) this.f31934OooO0O0;
                if (obj != null) {
