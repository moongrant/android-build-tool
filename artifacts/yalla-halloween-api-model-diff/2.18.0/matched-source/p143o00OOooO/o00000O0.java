...
public final /* synthetic */ class o00000O0 implements Observer {
    ...
    public final void onChanged(Object obj) {
        switch (this.f31943OooO00o) {
            case 0:
                MainMomentFollowingFragment.m15initObserver$lambda13((MainMomentFollowingFragment) this.f31944OooO0O0, (Long) obj);
                break;
            case 1:
                TopicInfoActivity this$0 = (TopicInfoActivity) this.f31944OooO0O0;
                ...
                break;
            case 2:
                Function1 tmp0 = (Function1) this.f31944OooO0O0;
                Intrinsics.checkNotNullParameter(tmp0, "$tmp0");
                tmp0.invoke(obj);
                break;
            case 3:
                UserInfoActivity this$1 = (UserInfoActivity) this.f31944OooO0O0;
                ...
                break;
            default:
                EventRoomPreviewPageViewModel previewPageVM = (EventRoomPreviewPageViewModel) this.f31944OooO0O0;
                ...
                o000O0Oo<EventModel> eventRoomPreviewPager = previewPageVM.getEventRoomPreviewPager();
                Iterator it3 = eventRoomPreviewPager.f48702OooO0Oo.iterator();
                int i = 0;
                while (true) {
                    if (!it3.hasNext()) {
                        i = -1;
                ...
                if (i >= 0) {
                    EventModel eventModel = (EventModel) eventRoomPreviewPager.f48702OooO0Oo.get(i);
                    ...
                    eventRoomPreviewPager.f48702OooO0Oo.set(i, (T) eventModel.clone());
                    previewPageVM.updateTimeDivision(eventRoomPreviewPager.f48702OooO0Oo);
