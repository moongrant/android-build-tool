...
public final /* synthetic */ class oo0oOO0 implements Observer {
    ...
    public final /* synthetic */ int f32064OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final /* synthetic */ Object f32065OooO0O0;

    public /* synthetic */ oo0oOO0(Object obj, int i) {
        this.f32064OooO00o = i;
        this.f32065OooO0O0 = obj;
    }
    ...
    public final void onChanged(Object obj) {
        int i = 0;
        boolean z = true;
        switch (this.f32064OooO00o) {
            case 0:
                RoomInfoMomentFragment.m68initObserver$lambda4((RoomInfoMomentFragment) this.f32065OooO0O0, (MomentDetailModel) obj);
                break;
            case 1:
                oO0O00o0 oo0o00o0 = (oO0O00o0) this.f32065OooO0O0;
                int i2 = oO0O00o0.f32922OooooOO;
            ...
            case 3:
                ...
                if (response.getIsSuccess()) {
                    ...
                    if (i != 0) {
                        ((o0oOo0O0) this$0.f21969Ooooooo.getValue()).OooO0OO();
                    }
                }
                break;
            case 4:
                Function1 tmp0 = (Function1) this.f32065OooO0O0;
                Intrinsics.checkNotNullParameter(tmp0, "$tmp0");
                tmp0.invoke((Boolean) obj);
                break;
            case 5:
                FollowerActivity followerActivity = (FollowerActivity) this.f32065OooO0O0;
                Long l = (Long) obj;
                while (true) {
                    if (i < followerActivity.f23340OooooOo.getData().size()) {
                        if (l.longValue() != followerActivity.f23340OooooOo.getData().get(i).getUserId()) {
                            i++;
                        }
                    } else {
                        i = -1;
                ...
                if (i > 0 && i < followerActivity.f23340OooooOo.getData().size()) {
                    followerActivity.f23340OooooOo.remove(i);
                    break;
                }
                break;
            case 6:
                RoomGameBoxDialog this$1 = (RoomGameBoxDialog) this.f32065OooO0O0;
                Intrinsics.checkNotNullParameter(this$1, "this$0");
                this$1.OooOOOO(true, RoomGameBoxDialog.GameType.GameMora);
                break;
            case 7:
                MainMomentsTopicAddMoreFragment.m344initObserver$lambda1((MainMomentsTopicAddMoreFragment) this.f32065OooO0O0, (TopicFollowChange) obj);
                break;
            case 8:
                TopicPostLatestFragment.m402initObserve$lambda1((TopicPostLatestFragment) this.f32065OooO0O0, (Long) obj);
                break;
            default:
                MainRoomMineJoinedFragment.m473onLazyInit$lambda0((MainRoomMineJoinedFragment) this.f32065OooO0O0, (Boolean) obj);
                break;
        }
    }
}
