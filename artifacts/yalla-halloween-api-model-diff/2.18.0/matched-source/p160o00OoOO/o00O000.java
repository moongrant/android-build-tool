...
public final class o00O000 {
    ...
    public static o00 f32490OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static o00O000 f32491OooO0O0;

    public static o00O000 OooO() {
        if (f32491OooO0O0 == null) {
            f32491OooO0O0 = new o00O000();
        }
        return f32491OooO0O0;
    }

    /* JADX WARN: Multi-variable type inference failed */
    public final void OooO00o(boolean z, boolean z2) {
        if (f32490OooO00o != null) {
            ...
            builderNewBuilder.setInviter(((RoomUserInfoModel) o00OO000.OooO0o.f43248OooO0Oo.getValue()).getUserId());
            builderNewBuilder.setYesOrNo(z ? 1 : 2);
            builderNewBuilder.setFromApplyMicList(z2);
            f32490OooO00o.OooO0oO(1001105, builderNewBuilder.build().toByteArray());
    ...
    public final void OooO0O0(boolean z) {
        if (f32490OooO00o != null) {
            ...
            builderNewBuilder.setRoomId(o00OO0O0.f43338OooooOo.OooO00o().f43344OooO0Oo.getValue().longValue());
            builderNewBuilder.setUserId(OooOOO.f41235OooO00o.OooOo().getValue().longValue());
            builderNewBuilder.setOp(z ? 1 : 2);
            f32490OooO00o.OooO0oO(1001100, builderNewBuilder.build().toByteArray());
        }
    }
    ...
    public final void OooO0OO(String str) {
        if (f32490OooO00o != null) {
            ...
            f32490OooO00o.OooO0oO(10059, builderNewBuilder.build().toByteArray());
        }
    }
    ...
    public final void OooO0Oo(int i) {
        if (f32490OooO00o != null) {
            ...
            f32490OooO00o.OooO0oO(10058, builderNewBuilder.build().toByteArray());
        }
    }

    public final void OooO0o(long j) {
        o00 o00Var = f32490OooO00o;
        if (o00Var != null) {
    ...
    public final void OooO0o0(int i, int i2, long j, boolean z) {
        if (f32490OooO00o != null) {
            ...
            f32490OooO00o.OooO0oO(10071, builderNewBuilder.build().toByteArray());
        }
    }
    ...
    public final void OooO0oO(int i) {
        if (f32490OooO00o != null) {
            ...
            f32490OooO00o.OooO0oO(10070, builderNewBuilder.build().toByteArray());
        }
    }

    public final void OooO0oo(long j) {
        if (f32490OooO00o == null || j <= 0) {
            return;
        }
        Room.UserInfoRequest.Builder builderNewBuilder = Room.UserInfoRequest.newBuilder();
        builderNewBuilder.setUserid(j);
        f32490OooO00o.OooO0oO(10060, builderNewBuilder.build().toByteArray());
    }
    ...
    public final void OooOO0(int i, int i2) {
        if (f32490OooO00o != null) {
            ...
            f32490OooO00o.OooO0oO(10078, builderNewBuilder.build().toByteArray());
        }
    }
    ...
    public final void OooOOO(String str, String str2, String str3) {
        String strOooO00o = OooO00o.OooO00o(o00oOoo.OooO00o("{\"userid\":", str, ",\"barid\":", str2, ",\"invitefalg\":"), str3, "}");
        o00 o00Var = f32490OooO00o;
        if (o00Var != null) {
    ...
    public final void OooOOO0(long j, boolean z) {
        if (f32490OooO00o != null) {
            ...
            f32490OooO00o.OooO0oO(1001103, builderNewBuilder.build().toByteArray());
        }
    }
    ...
    public final void OooOOOo() {
        if (f32490OooO00o != null) {
            ...
            builderNewBuilder.setRoomId(o00OO0O0.f43338OooooOo.OooO00o().f43344OooO0Oo.getValue().longValue());
            builderNewBuilder.setUserId(OooOOO.f41235OooO00o.OooOo().getValue().longValue());
            f32490OooO00o.OooO0oO(1001109, builderNewBuilder.build().toByteArray());
        }
    }
    ...
    public final void OooOOo0(Long l, boolean z) {
        if (f32490OooO00o != null) {
            ...
            f32490OooO00o.OooO0oO(10065, builderNewBuilder.build().toByteArray());
        }
    }

    public final void OooOOoo(Integer num) {
        if (f32490OooO00o != null) {
            f32490OooO00o.OooO0o(10031, "{\"order\":" + num + "}");
        }
    }
    ...
    public final void OooOo(Long[] lArr, int i) {
        ...
        if (f32490OooO00o != null) {
            ...
            f32490OooO00o.OooO0o(10049, o0Oo0oo.OooO0Oo(skillCardSendModel));
        }
    }
    ...
    public final void OooOo0O(Room.BlindBoxGiftRequest.Builder builder) {
        if (f32490OooO00o != null) {
            ...
            f32490OooO00o.OooO0oO(1001000, builder.build().toByteArray());
        }
    }
    ...
    public final void OooOoO(int i) {
        if (f32490OooO00o != null) {
            ...
            f32490OooO00o.OooO0oO(10074, builderNewBuilder.build().toByteArray());
        }
    }

    public final void OooOoO0(String str, p151o00Oo0Oo.OooOo oooOo, RoomMessageReplyInfo roomMessageReplyInfo) {
        if (f32490OooO00o != null) {
            HashMap map = new HashMap();
            ArrayList arrayList = new ArrayList();
            if (oooOo != null) {
                int i = oooOo.f32194OoooO0;
                if (i == 40) {
                    StringBuilder sbOooO0O0 = OooO00o.OooO0O0("@");
                    sbOooO0O0.append(oooOo.f32192Oooo);
                    map.put("atHead", sbOooO0O0.toString());
                    map.put("type", Integer.valueOf(oooOo.f32194OoooO0));
                } else if (i == 39) {
                    StringBuilder sbOooO0O1 = OooO00o.OooO0O0("@");
                    sbOooO0O1.append(oooOo.f32192Oooo);
                    map.put("atHead", sbOooO0O1.toString());
                    map.put("type", Integer.valueOf(oooOo.f32194OoooO0));
                } else {
                    AtUserInfoModel atUserInfoModel = new AtUserInfoModel();
                    atUserInfoModel.setUserid(oooOo.f32195OoooO00);
                    atUserInfoModel.setUsername(oooOo.f32192Oooo);
            ...
            f32490OooO00o.OooO0o(10003, o0Oo0oo.OooO0Oo(map));
        }
    }
    ...
    public final void OooOoOO(boolean z) {
        if (f32490OooO00o != null) {
            ...
            f32490OooO00o.OooO0oO(1001106, builderNewBuilder.build().toByteArray());
        }
    }

    public final void OooOoo(Integer num) {
        if (f32490OooO00o != null) {
            f32490OooO00o.OooO0o(10032, "{\"order\":" + num + "}");
        }
    }
