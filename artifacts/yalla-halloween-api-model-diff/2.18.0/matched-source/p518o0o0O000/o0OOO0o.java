...
public final class o0OOO0o {
    ...
    @NotNull
    public static final o0OOO0o f42139OooO00o = null;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public static final Lazy f42140OooO0O0 = LazyKt.lazy(OooOO0.f42141Oooo);
    ...
    public static final class OooO00o extends o00O0<Boolean> {
        ...
        public Boolean read(@Nullable JsonReader jsonReader) throws IOException {
            ...
            if (i == 1) {
                ...
                if (i == 4) {
                    String strNextString = jsonReader.nextString();
                    return Boolean.valueOf(Intrinsics.areEqual(strNextString, "1") || StringsKt__StringsJVMKt.equals(strNextString, ServerProtocol.DIALOG_RETURN_SCOPES_TRUE, true));
                }
    ...
    public static final class OooOO0 extends Lambda implements Function0<o000OOo0> {
        ...
        public static final OooOO0 f42141Oooo = new OooOO0();
    ...
    public static final o000OOo0 OooO00o() {
        Object value = f42140OooO0O0.getValue();
