...
public final /* synthetic */ class o0O00OOO implements Observer {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final /* synthetic */ int f43052OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final /* synthetic */ Object f43053OooO0O0;

    public /* synthetic */ o0O00OOO(Object obj, int i) {
        this.f43052OooO00o = i;
        this.f43053OooO0O0 = obj;
    }

    @Override // androidx.lifecycle.Observer
    public final void onChanged(Object obj) {
        switch (this.f43052OooO00o) {
            case 0:
                o0O000 this$0 = (o0O000) this.f43053OooO0O0;
                ...
                break;
            case 1:
                AccountActivity this$1 = (AccountActivity) this.f43053OooO0O0;
                Boolean it = (Boolean) obj;
                int i = AccountActivity.f21714OooooOo;
                Intrinsics.checkNotNullParameter(this$1, "this$0");
                Intrinsics.checkNotNullExpressionValue(it, "it");
                if (!it.booleanValue()) {
                    LinearLayout linearLayout = this$1.OooOoo().f49358OooO0Oo;
                    Intrinsics.checkNotNullExpressionValue(linearLayout, "binding.llUnprotected");
                    oOO00O.OooO(linearLayout);
                } else {
                    LinearLayout linearLayout2 = this$1.OooOoo().f49358OooO0Oo;
                    Intrinsics.checkNotNullExpressionValue(linearLayout2, "binding.llUnprotected");
                    oOO00O.OooO00o(linearLayout2);
                }
                break;
            case 2:
                MainSearchActivity this$2 = (MainSearchActivity) this.f43053OooO0O0;
                String str = (String) obj;
                MainSearchActivity.OooO00o oooO00o = MainSearchActivity.f21986Ooooooo;
                Intrinsics.checkNotNullParameter(this$2, "this$0");
                if (!Intrinsics.areEqual(str, StringsKt.trim((CharSequence) this$2.OooOoo().f49671OooO0O0.getText().toString()).toString())) {
                    this$2.OooOoo().f49671OooO0O0.setText(str);
                    this$2.OooOoo().f49671OooO0O0.setSelection(str.length());
                }
                break;
            case 3:
                TopicDetailActivity this$3 = (TopicDetailActivity) this.f43053OooO0O0;
                ...
                if (type == 0) {
                    LinearLayoutCompat linearLayoutCompat = this$3.OooOooo().f51017OooO0o0.f49777OooO0Oo;
                    Intrinsics.checkNotNullExpressionValue(linearLayoutCompat, "binding.head.layoutFans");
                    oOO00O.OooO00o(linearLayoutCompat);
                } else if (type == 1) {
                    LinearLayoutCompat linearLayoutCompat2 = this$3.OooOooo().f51017OooO0o0.f49777OooO0Oo;
                    Intrinsics.checkNotNullExpressionValue(linearLayoutCompat2, "binding.head.layoutFans");
                    oOO00O.OooO(linearLayoutCompat2);
                    this$3.OooOooo().f51017OooO0o0.f49773OooO.setText(o000O0O0.OooO0OO(R.string.topic_group_create));
                } else if (type == 2 && !topicGroupInfoModel.getIsDisbanded()) {
                    LinearLayoutCompat linearLayoutCompat3 = this$3.OooOooo().f51017OooO0o0.f49777OooO0Oo;
                    Intrinsics.checkNotNullExpressionValue(linearLayoutCompat3, "binding.head.layoutFans");
                    oOO00O.OooO(linearLayoutCompat3);
                    this$3.OooOooo().f51017OooO0o0.f49773OooO.setText(o000O0O0.OooO0OO(R.string.topic_group_join));
                }
                break;
            case 4:
                oO0O00O this$4 = (oO0O00O) this.f43053OooO0O0;
                ...
                break;
            case 5:
                FollowingActivity followingActivity = (FollowingActivity) this.f43053OooO0O0;
                Long l = (Long) obj;
                int i2 = 0;
                while (true) {
                    if (i2 < followingActivity.f23350Oooooo0.getData().size()) {
                        if (l.longValue() != followingActivity.f23350Oooooo0.getData().get(i2).getUserId()) {
                            i2++;
                        }
                    } else {
                        i2 = -1;
                ...
                if (i2 > 0 && i2 < followingActivity.f23350Oooooo0.getData().size()) {
                    followingActivity.f23350Oooooo0.remove(i2);
                    break;
                }
                break;
            default:
                TopicPostLatestFragment.m405initObserve$lambda5((TopicPostLatestFragment) this.f43053OooO0O0, (Long) obj);
                break;
        }
    }
}
