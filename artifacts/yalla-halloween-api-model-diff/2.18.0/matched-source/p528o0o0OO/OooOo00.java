    ...
    public final void OooO0O0(@NotNull MessageIM.Message msg, boolean z) {
        ...
        switch (msg.getHead()) {
            case 2111:
                ...
                if (!(OooO0OO.OooO00o().OooOo0().OooO0oO(((Number) OooO00o.OooO00o(OooOOO.f41235OooO00o)).longValue(), mid) != null)) {
            ...
            case 2112:
                ...
                if (!(from.getResult() == 1)) {
                    OooO0OO.OooO00o().OooOo00().OooOOO(((Number) OooO00o.OooO00o(OooOOO.f41235OooO00o)).longValue(), from.getFromId());
                } else {
                    ...
                    o00Ooo.f42780OooO00o.OooO0o(friend);
                    BuildersKt__Builders_commonKt.async$default(GlobalScope.INSTANCE, null, null, new OooOOO(from, null), 3, null).start();
                }
                break;
            case 2113:
                OooO0OO.OooO00o().OooOo00().OooOOO(((Number) OooO00o.OooO00o(OooOOO.f41235OooO00o)).longValue(), MessageIM.Message2113.parseFrom(msg.getBody()).getFromId());
                break;
        }
    }
}
