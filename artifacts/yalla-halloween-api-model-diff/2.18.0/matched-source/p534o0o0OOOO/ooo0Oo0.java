...
public final class ooo0Oo0 {
    ...
    @NotNull
    public static final ooo0Oo0 f43446OooO00o = new ooo0Oo0();

    public static final class OooO extends Lambda implements Function0<Unit> {

        /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
        public static final OooO f43447Oooo = new OooO();
    ...
    public static final class OooO00o extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
        public static final OooO00o f43448Oooo = new OooO00o();
    ...
    public static final class OooO0O0 extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
        public static final OooO0O0 f43449Oooo = new OooO0O0();
    ...
    public static final class OooO0OO extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
        public static final OooO0OO f43450Oooo = new OooO0OO();
    ...
    public static final class OooO0o extends Lambda implements Function1<DialogInterface, Unit> {
        ...
        /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
        public static final OooO0o f43451Oooo = new OooO0o();
    ...
    public static final class OooOO0 extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
        public static final OooOO0 f43452Oooo = new OooOO0();
    ...
    public static final class OooOO0O extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
        public static final OooOO0O f43453Oooo = new OooOO0O();
    ...
    public static final class OooOOO extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
        public static final OooOOO f43454Oooo = new OooOOO();
        ...
        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            Object objOooO0O0 = com.yalla.support.common.util.OooO0O0.f20522OooO00o.OooO0O0();
            if (objOooO0O0 == null && (objOooO0O0 = o0000O.f2671OooO00o) == null) {
                Intrinsics.throwUninitializedPropertyAccessException(d.R);
                objOooO0O0 = null;
            }
            Intrinsics.checkNotNull(objOooO0O0, "null cannot be cast to non-null type android.app.Activity");
            RoomReAnnouncementActivity.OooOoO((Activity) objOooO0O0, o000O00O.OooO().f32453OoooO0O);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOOO0 extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
        public static final OooOOO0 f43455Oooo = new OooOOO0();
    ...
    public static final class OooOOOO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
        public final /* synthetic */ int f43456Oooo;

        /* JADX INFO: renamed from: OoooO0, reason: collision with root package name */
        public final /* synthetic */ Object f43457OoooO0;

        /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
        public final /* synthetic */ int f43458OoooO00;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOOO(int i, int i2, Object obj, Continuation<? super OooOOOO> continuation) {
            super(2, continuation);
            this.f43456Oooo = i;
            this.f43458OoooO00 = i2;
            this.f43457OoooO0 = obj;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOOOO(this.f43456Oooo, this.f43458OoooO00, this.f43457OoooO0, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ooo0Oo0.f43446OooO00o.OooO00o(this.f43456Oooo, this.f43458OoooO00, this.f43457OoooO0);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOo00 extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
        public static final OooOo00 f43459Oooo = new OooOo00();
    ...
    public static final void OooO0OO(int i, int i2, @Nullable Object obj) {
        StringBuilder sbOooO0OO = o000O0Oo.OooO0OO("code = ", i, ", commendCode = ", i2, ", data = ");
        sbOooO0OO.append(obj);
        o00O00.OooO0OO("RoomErrorHandler", sbOooO0OO.toString());
        if (Intrinsics.areEqual(Looper.getMainLooper(), Looper.myLooper())) {
            f43446OooO00o.OooO00o(i, i2, obj);
        } else {
            ...
            try {
                if (i == 1) {
                    ...
                    if (Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                        ...
                        o00O000.f34370OooO0OO.post(runnable);
                        return;
                    }
                }
                if (i == 1037) {
                    ...
                    if (Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                        ...
                        o00O000.f34370OooO0OO.post(runnable2);
                        return;
                    }
                }
                if (i == 1038) {
                    ...
                    if (Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                        ...
                        o00O000.f34370OooO0OO.post(runnable3);
                        return;
                    }
                }
                if (i == 5000) {
                    ...
                    if (!(strOooO0OO4 == null || StringsKt.isBlank(strOooO0OO4))) {
                        ...
                        if (Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                            ...
                            o00O000.f34370OooO0OO.post(runnable4);
                        }
                    }
                ...
                if (i == 5001) {
                    ...
                    if (!(strOooO0OO5 == null || StringsKt.isBlank(strOooO0OO5))) {
                        ...
                        if (Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                            ...
                            o00O000.f34370OooO0OO.post(runnable5);
                        }
                    }
                    LiveEventBus.get("CHAT_FACE_HAS_SOLD_OUT").post("");
                    return;
                ...
                switch (i) {
                    case 1001:
                        ...
                        break;
                    case 1024:
                        if (o00OO0O0.f43338OooooOo.OooO00o().f43350OooOO0O.getValue() == RoomLoginState.Succes) {
                            o00OO000 o00oo001 = o00OO000.f43171OooO00o;
                            o00OO000.f43207Oooo0OO.setValue(Boolean.TRUE);
                        }
                        break;
                    case 1026:
                        RoomStateManager.INSTANCE.disconnectRoom();
                        p530o0o0OO0O.o000O0O0 error = new p530o0o0OO0O.o000O0O0(618);
                    ...
                    case 1040:
                        ...
                        if (!(strOooO0OO6 == null || StringsKt.isBlank(strOooO0OO6))) {
                            ...
                            if (!Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                                ...
                                o00O000.f34370OooO0OO.post(runnable6);
                            } else {
                                runnable6.run();
                            }
                        }
                    ...
                    case 1051:
                        ...
                        if (str2 != null && (roomError1051 = (RoomError1051) o0Oo0oo.OooO0OO(str2, RoomError1051.class)) != null) {
                            ...
                            if (activityOooO0O0 != null) {
                                ...
                                roomBlackListUnJoinAndUnFollowDialog.OooO00o(OooO0o.f43451Oooo);
                    ...
                    case 1055:
                        ...
                        if (activityOooO0O1 != null) {
                            ...
                            oo0ooo0.OooOO0O(OooO.f43447Oooo);
                            oo0ooo0.OooOOO0();
                        }
                        break;
                    case 1058:
                        ...
                        if (!(strOooO0OO7 == null || StringsKt.isBlank(strOooO0OO7))) {
                            ...
                            if (!Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                                ...
                                o00O000.f34370OooO0OO.post(runnable7);
                            } else {
                                runnable7.run();
                            }
                        }
                    ...
                    case 1070:
                        try {
                            ...
                            if (from != null) {
                                ...
                                f43446OooO00o.OooO0Oo(OooOo.OooO00o(o000O0O0.OooO0OO(R.string.room_voice_card_protected), String.valueOf(protectedTimeLeft / 60), String.valueOf(protectedTimeLeft % 60)));
                            }
                    ...
                    case ZegoConstants.StreamUpdateType.Deleted /* 2002 */:
                        o00O000 o00o0010 = o00O000.f34368OooO00o;
                        ...
                        if (activityOooO0O2 != null) {
                            ...
                            oo0ooo1.OooOO0O(OooOO0.f43452Oooo);
                            oo0ooo1.OooOOO0();
                        }
                        break;
                    case 4000:
                        ...
                        if (!(strOooO0OO8 == null || StringsKt.isBlank(strOooO0OO8))) {
                            ...
                            if (!Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                                o00O000 o00o0011 = o00O000.f34368OooO00o;
                                o00O000.f34370OooO0OO.post(runnable8);
                            } else {
                                runnable8.run();
                            }
                        }
                    ...
                    case 10070:
                        ...
                        Boolean value = oooO00o.OooO00o().f43373Oooo000.getValue();
                        if (value == null) {
                            value = Boolean.FALSE;
                        }
                        oooO00o.OooO00o().f43373Oooo000.postValue(Boolean.valueOf(value.booleanValue()));
                    ...
                    default:
                        switch (i) {
                            ...
                            case 1005:
                                ...
                                break;
                            case 1006:
                                o00OO0O0.f43338OooooOo.OooO00o().f43350OooOO0O.postValue(RoomLoginState.NumberLimit);
                                break;
                            case 1007:
                            ...
                            case 1011:
                                ...
                                oo0ooo2.OooOo0o(OooO0OO.f43450Oooo);
                                oo0ooo2.OooOOO0();
                                break;
                            case 1012:
                            ...
                            default:
                                switch (i) {
                                    ...
                                    case 1029:
                                        ...
                                        ToastUtil toastUtil9 = ToastUtil.f12583OooO0O0;
                                        if (!(strOooO0OO9 == null || StringsKt.isBlank(strOooO0OO9))) {
                                            ...
                                            if (!Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                                                o00O000 o00o0012 = o00O000.f34368OooO00o;
                                                o00O000.f34370OooO0OO.post(runnable9);
                                            } else {
                                                runnable9.run();
                                            }
                                        }
                                    ...
                                    case 1030:
                                        ...
                                        ToastUtil toastUtil10 = ToastUtil.f12583OooO0O0;
                                        if (!(strOooO0OO10 == null || StringsKt.isBlank(strOooO0OO10))) {
                                            ...
                                            if (!Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                                                o00O000 o00o0013 = o00O000.f34368OooO00o;
                                                o00O000.f34370OooO0OO.post(runnable10);
                                            } else {
                                                runnable10.run();
                                            }
                                        }
                                    ...
                                    case Constants.WARN_ADM_RECORD_AUDIO_LOWLEVEL /* 1031 */:
                                        ...
                                        ToastUtil toastUtil11 = ToastUtil.f12583OooO0O0;
                                        if (!(strOooO0OO11 == null || StringsKt.isBlank(strOooO0OO11))) {
                                            ...
                                            if (!Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                                                o00O000 o00o0014 = o00O000.f34368OooO00o;
                                                o00O000.f34370OooO0OO.post(runnable11);
                                            } else {
                                                runnable11.run();
                                            }
                                        }
                                    ...
                                    default:
                                        switch (i) {
                                            case 1044:
                                                ...
                                                break;
                                            case 1045:
                                                Integer value2 = o00OO0O0.f43338OooooOo.OooO00o().f43379Oooo0o0.getValue();
                                                if (value2 == null) {
                                                    value2 = 0;
                                                }
                                            ...
                                            default:
                                                switch (i) {
                                                    case BannerConfig.LOOP_TIME /* 3000 */:
                                                        o00O000 o00o0015 = o00O000.f34368OooO00o;
                                                        ...
                                                        if (activityOooO0O3 != null) {
                                                            ...
                                                            oo0ooo3.OooOo0o(OooOO0O.f43453Oooo);
                                                            oo0ooo3.OooOOO0();
                                                        }
                                                        break;
                                                    case ZegoConstants.RoomError.DatiCommitError /* 3001 */:
                                                        ...
                                                        if (str3 != null && (roomError3000 = (RoomError3000) o0Oo0oo.OooO0OO(str3, RoomError3000.class)) != null) {
                                                            f43446OooO00o.OooO0Oo(roomError3000.getMsg());
                                                            break;
                                                        }
                                                        break;
                                                    ...
                                                    case ZegoConstants.RoomError.DatiRepeatError /* 3003 */:
                                                        ...
                                                        if (str4 != null && (roomError3003 = (RoomError3003) o0Oo0oo.OooO0OO(str4, RoomError3003.class)) != null) {
                                                            ...
                                                            ToastUtil toastUtil12 = ToastUtil.f12583OooO0O0;
                                                            if (!(msg == null || StringsKt.isBlank(msg))) {
                                                                ...
                                                                if (!Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                                                                    o00O000 o00o0016 = o00O000.f34368OooO00o;
                                                                    o00O000.f34370OooO0OO.post(runnable12);
                                                                } else {
                                                                    runnable12.run();
                                                                }
                                                            }
                                                    ...
                                                    default:
                                                        switch (i) {
                                                            case 4251:
                                                                ...
                                                                break;
                                                            case 4252:
                                                                o00O000 o00o0017 = o00O000.f34368OooO00o;
                                                                ...
                                                                if (activityOooO0O4 != null) {
                                                                    ...
                                                                    oo0ooo4.OooOo0o(OooO00o.f43448Oooo);
                                                                    oo0ooo4.OooOOO0();
                                                                }
                                                                break;
                                                            case 4253:
                                                                o00O000 o00o0018 = o00O000.f34368OooO00o;
                                                                ...
                                                                if (activityOooO0O5 != null) {
                                                                    ...
                                                                    oo0ooo5.OooOo0o(OooO0O0.f43449Oooo);
                                                                    oo0ooo5.OooOOO0();
                                                                }
                                                                break;
                                                            default:
    ...
    public final void OooO0O0() {
        ArrayList<ProfileLimitModel> profileLimit = o000O00O.OooO().f32453OoooO0O.getProfileLimit();
            ...
            for (ProfileLimitModel profileLimitModel : profileLimit) {
                if (profileLimitModel.getOperationType() == 3) {
                    ...
                    if (profileLimitModel.getExpireTime() > 0 && (System.currentTimeMillis() / ((long) 1000)) - profileLimitModel.getExpireTime() <= 0) {
                        strOooO00o = OooOo.OooO00o(OooOo.OooO00o(o000O0O0.OooO0OO(R.string.RoomInfoEdit_ChangeLimit_HintContent_Sign_Time), String.valueOf(profileLimitModel.getBlockReason())), oo00o.f48643OooO00o.OooO0Oo(profileLimitModel.getExpireTime(), System.currentTimeMillis()));
                        z = true;
                    }
                    Context contextOooO0O0 = com.yalla.support.common.util.OooO0O0.f20522OooO00o.OooO0O0();
    ...
    public final void OooO0o0(String str) {
        ...
        if (activity != null) {
            oo0oOO0 oo0ooo0 = new oo0oOO0(activity);
            oo0ooo0.OooOo0O(str);
            oo0ooo0.OooOO0O(OooOo00.f43459Oooo);
            oo0ooo0.OooOOO0();
            Intrinsics.checkNotNullParameter(activity, "activity");
            Object systemService = activity.getSystemService("input_method");
            Objects.requireNonNull(systemService, "null cannot be cast to non-null type android.view.inputmethod.InputMethodManager");
