...
public final class f0 extends Lambda implements Function3<o0000O0O<ChatMessage>, View, Integer, Unit> {

    /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
    public final /* synthetic */ PrivateChatActivity f43800Oooo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f0(PrivateChatActivity privateChatActivity) {
        super(3);
        this.f43800Oooo = privateChatActivity;
    }
    ...
    public final Unit invoke(o0000O0O<ChatMessage> o0000o0o2, View view, Integer num) {
        ...
        PrivateChatActivity privateChatActivity = this.f43800Oooo;
        PrivateChatActivity.OooO00o oooO00o = PrivateChatActivity.f22185o0ooOOo;
        privateChatActivity.Oooo000();
        o00O0000 o00o0001 = this.f43800Oooo.f22193OoooooO;
        if (o00o0001 != null) {
        ...
        if (id == R.id.svga_message_status) {
            oo0oOO0 oo0ooo0OooOoOO = PrivateChatActivity.OooOoOO(this.f43800Oooo);
            String string = this.f43800Oooo.getString(R.string.resend);
            Intrinsics.checkNotNullExpressionValue(string, "getString(R.string.resend)");
            oo0ooo0OooOoOO.OooOo0O(string);
            PrivateChatActivity.OooOoOO(this.f43800Oooo).OooOo0o(new e0(this.f43800Oooo, data));
            PrivateChatActivity.OooOoOO(this.f43800Oooo).OooOOO0();
        } else if (id == R.id.niv_chat_message_header) {
            UserInfoActivity.f23471o0OOO0o.OooO0O0(this.f43800Oooo, data.getIsAcceptMsg() ? String.valueOf(this.f43800Oooo.Oooo0O0().getTargetId()) : OooO00o.OooO0O0(OooOOO.f41235OooO00o), true, new o00O00OO() { // from class: o0o0OOoo.d0
            ...
            if (data.getShareMomentInfo() != null) {
                PrivateChatActivity privateChatActivity2 = this.f43800Oooo;
                ...
                ((MomentVM) privateChatActivity2.f22205ooOO.getValue()).momentDetail("" + momentId, 0).observe(privateChatActivity2, new o0o0000.OooOo(new p(privateChatActivity2, mid), null, null, false));
            }
            ...
            if (data.getShareTopicInfo() != null) {
                ...
                TopicDetailActivity.f22586o00Oo0.OooO00o(this.f43800Oooo, topicInfoModel);
            }
            ...
            if (data.getShareUserInfo() != null) {
                ...
                PrivateChatActivity privateChatActivity3 = this.f43800Oooo;
            ...
            if (data.getShareActivityInfo() != null) {
                ...
                WebActivity.f22127ooOO.OooO00o(this.f43800Oooo, webPageInfo);
            }
        } else if (id == R.id.clRoomTheme) {
            PrivateChatActivity privateChatActivity4 = this.f43800Oooo;
            if (!privateChatActivity4.f22197o00Ooo) {
                privateChatActivity4.f22197o00Ooo = true;
