...
import p594o0oOooo.a;
import p608o0oo0O.OooOo;

/* JADX INFO: loaded from: classes2.dex */
public final class j2 extends Lambda implements Function1<YallaTeamMessage, Unit> {

    /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
    public final /* synthetic */ YallaTeamMessageActivity f43820Oooo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public j2(YallaTeamMessageActivity yallaTeamMessageActivity) {
        super(1);
        this.f43820Oooo = yallaTeamMessageActivity;
    }
    ...
    public final Unit invoke(YallaTeamMessage yallaTeamMessage) {
        ...
        final YallaTeamMessageActivity context = this.f43820Oooo;
        ...
        if (it.getMessageType() == 2) {
            ...
            o000O.OooO00o(a.f47433OooO00o, bundleOooO00o);
        } else {
            int i = 0;
            if (it.getJumpType() == 1 && OooO.OooO0o0(it.getJumpId()) == 101) {
                int i2 = PurchaseSkillCardActivity.f23230o0OoOo0;
                ...
                SharedUrlManager.INSTANCE.getPrettyRoomIdUrl().observe(context, new b2(it, context, i));
            } else if (it.getJumpType() == 3) {
                SharedUrlManager.INSTANCE.getPrettyUserIdUrl().observe(context, new Observer() { // from class: o0o0OOoo.c2
                    @Override // androidx.lifecycle.Observer
                    public final void onChanged(Object obj) {
                        YallaTeamMessage message = it;
                        YallaTeamMessageActivity context2 = context;
                        String url = (String) obj;
                        YallaTeamMessageActivity.OooO00o oooO00o2 = YallaTeamMessageActivity.f22270ooOO;
                ...
                PostDetailActivity.f22436o000000O.OooO00o(context, momentDetailModel, (256 & 4) != 0 ? false : false, (256 & 8) != 0 ? 1 : 0, (256 & 16) != 0 ? null : null, (256 & 32) != 0 ? false : false, (256 & 64) != 0 ? null : null, (256 & 128) != 0 ? false : false, (256 & 256) != 0 ? "" : null);
