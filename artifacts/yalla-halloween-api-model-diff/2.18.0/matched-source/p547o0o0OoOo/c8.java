...
public final class c8 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f44373Oooo;

    /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
    public final /* synthetic */ d8<Object> f44374OoooO00;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public c8(d8<Object> d8Var, Continuation<? super c8> continuation) {
        super(2, continuation);
        this.f44374OoooO00 = d8Var;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new c8(this.f44374OoooO00, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f44373Oooo;
        if (i != 0 && i != 1) {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        ResultKt.throwOnFailure(obj);
        while (!this.f44374OoooO00.OooO0OO().isEmpty()) {
            d8<Object> d8Var = this.f44374OoooO00;
            int i2 = 0;
            Object objRemove = d8Var.OooO0OO().remove(0);
            this.f44373Oooo = 1;
            oO00O0oO oo00o0oo = (oO00O0oO) d8Var;
            RoomUserInfoModel roomUserInfoModel = (RoomUserInfoModel) objRemove;
            if (o0000Ooo.OooO00o(oo00o0oo.f44874OooO0Oo)) {
                if (roomUserInfoModel.getIsUnLoginUser()) {
                    oo00o0oo.f44877OooO0oO.setText(o000O0O0.OooO0OO(R.string.tourists_enter_room_tip));
                    oo00o0oo.f44885OooOOOo.setVisibility(8);
                } else {
                    oo00o0oo.f44877OooO0oO.setText(o00Ooo.f42780OooO00o.OooO0O0(roomUserInfoModel.getUserId(), roomUserInfoModel.getUserName()));
                    oo00o0oo.f44885OooOOOo.setVisibility(0);
                }
                oo00o0oo.f44877OooO0oO.requestLayout();
                oo00o0oo.f44876OooO0o0.OooO0Oo(roomUserInfoModel.isPremium(), roomUserInfoModel.getPremiumLevel());
                UserVipView userVipView = oo00o0oo.f44875OooO0o;
                ...
                oo00o0oo.f44878OooO0oo.setUserPrettyId(roomUserInfoModel.getIdLevel());
                oo00o0oo.f44882OooOOO.OooO00o(roomUserInfoModel.getRankWeek(), roomUserInfoModel.getRankDay());
                oo00o0oo.f44873OooO.OooO0O0(roomUserInfoModel.getMedal(), oo00o0oo.f44874OooO0Oo);
                if (!(roomUserInfoModel.getShowPremiumFirst() && roomUserInfoModel.isPremium()) && roomUserInfoModel.getVipState() == vipState2.getValue() && roomUserInfoModel.getShowVIP()) {
                    UserVipView userKaVipView = oo00o0oo.f44875OooO0o;
                    Intrinsics.checkNotNullExpressionValue(userKaVipView, "userKaVipView");
                    oOO00O.OooO00o(userKaVipView);
                    int i3 = oO00O0oO.OooO00o.$EnumSwitchMapping$0[VipLevel.INSTANCE.OooO0O0(roomUserInfoModel.getVipLevel()).ordinal()];
                    if (i3 == 1) {
                    ...
                    UserPremiumView userVipView2 = oo00o0oo.f44876OooO0o0;
                ...
                if (roomUserInfoModel.getBadgeState()) {
                    RoomMemberBadgeView roomMemberBadgeView = oo00o0oo.f44884OooOOOO;
                    Intrinsics.checkNotNullExpressionValue(roomMemberBadgeView, "roomMemberBadgeView");
                    oOO00O.OooO(roomMemberBadgeView);
                    RoomMemberBadgeView roomMemberBadgeView2 = oo00o0oo.f44884OooOOOO;
                    ...
                    int i4 = RoomMemberBadgeView.f25126OoooO0;
                    roomMemberBadgeView2.OooO00o(numBoxInt, badgeUrl, isTopRank, 11.0f);
                } else {
                    RoomMemberBadgeView roomMemberBadgeView3 = oo00o0oo.f44884OooOOOO;
                ...
                if (i2 != 0) {
                    oo00o0oo.f44880OooOO0O.setBackgroundResource(i2);
                }
                if (!o000O00O.OooO().f32467OoooooO) {
                    oo00o0oo.f44883OooOOO0.setLayoutTransition(new LayoutTransition());
                    o000O00O.OooO().f32467OoooooO = true;
                }
                oo00o0oo.f44881OooOO0o.setOnClickListener(new oO00OO0O(roomUserInfoModel));
                if (TextUtils.isEmpty(roomUserInfoModel.getVehicleSVGAUrl()) || !StringsKt__StringsJVMKt.endsWith$default(o00O0.OooO0o(roomUserInfoModel.getVehicleSVGAUrl()), ".svga", false, 2, null)) {
                    objOooO0o0 = oo00o0oo.OooO0o0(roomUserInfoModel.isPremium(), roomUserInfoModel.getPremiumLevel(), this);
                    if (objOooO0o0 != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                        objOooO0o0 = Unit.INSTANCE;
                    }
                } else {
                    objOooO0o0 = oo00o0oo.OooO0o(roomUserInfoModel.getVehicleSVGAUrl(), this);
                    if (objOooO0o0 != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                        objOooO0o0 = Unit.INSTANCE;
                    }
                }
        ...
        this.f44374OoooO00.f44375OooO0O0 = null;
