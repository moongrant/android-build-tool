...
public final class o00oOoo extends o0000O0O<SystemMessage> {
    ...
    @NotNull
    public final FragmentActivity f45109OooOOo0;

    public static final class OooO00o extends Oooo000.OooO<SystemMessage> {
    ...
    public final void OooO0o(o000OO holder, SystemMessage systemMessage) {
        ...
        switch (item.getType()) {
            case 1:
                ...
                textView2.setText(OooOo.OooO00o(o000O0O0.OooO0OO(R.string.system_message_subscribe_vip_title), oooO00o.OooO0O0(vipInfo2 != null ? vipInfo2.getVipLevel() : PremiumLevel.Premium1.getValue())));
            ...
            case 5:
                ...
                if (upCoin > 0 && upCrystal > 0) {
                    strOooO00o = OooOo.OooO00o(OooOo.OooO00o(OooOo.OooO00o(o000O0O0.OooO0OO(R.string.system_message_user_level_upgrade_coin_crystal), String.valueOf(upCoin)), String.valueOf(upCrystal)), String.valueOf(numValueOf3));
                } else if (upCoin > 0) {
                    strOooO00o = OooOo.OooO00o(OooOo.OooO00o(o000O0O0.OooO0OO(R.string.system_message_user_level_upgrade_coin), String.valueOf(upCoin)), String.valueOf(numValueOf3));
                } else if (upCrystal > 0) {
                    strOooO00o = OooOo.OooO00o(OooOo.OooO00o(o000O0O0.OooO0OO(R.string.system_message_user_level_upgrade_cryctal), String.valueOf(upCrystal)), String.valueOf(numValueOf3));
                }
            ...
            case 6:
                ...
                textView3.setText(OooOo.OooO00o(strOooO0OO2, strArr));
                break;
            case 7:
                ...
                textView3.setText(OooOo.OooO00o(strOooO0OO3, strArr2));
                oOO00O.OooO(textView4);
                break;
            case 8:
            ...
            case 11:
                ...
                textView3.setText(item.getMessage());
                UserPremiumView.OooO00o oooO00o2 = UserPremiumView.f21071OoooO;
            ...
            case 12:
                ...
                textView3.setText(OooOo.OooO00o(strOooO0OO4, strArr3));
                oOO00O.OooO(textView4);
                break;
            case 13:
                netImageView.setImageResource(R.drawable.icon_system_message_notice);
            ...
            case 15:
                ...
                textView3.setText(OooOo.OooO00o(strOooO0OO5, strArr4));
                oOO00O.OooO(textView4);
                break;
            case 16:
                netImageView.setImageResource(R.drawable.icon_system_message_notice);
                ...
                FragmentActivity fragmentActivity = this.f45109OooOOo0;
            ...
            case 17:
                ...
                textView3.setText(OooOo.OooO00o(strOooO0OO6, strArr5));
                oOO00O.OooO(textView4);
                break;
            case 19:
                ...
                if (medalLevel > 0 && medalId > 0) {
                    sVGAView.f21029OooooOo = R.drawable.icon_badge_no_pic;
                    ...
                    sVGAView.OooO0oo(string2, this.f45109OooOOo0);
                    sVGAView.OooO();
                    oOO00O.OooO(sVGAView);
                }
                oOO00O.OooO(textView4);
            ...
            case 20:
                ...
                if (medalLevel > 0 && medalId2 > 0) {
                    sVGAView.f21029OooooOo = R.drawable.icon_honor_badge_nopic;
                    ...
                    sVGAView.OooO0oo(string3, this.f45109OooOOo0);
                    sVGAView.OooO();
            ...
            case 21:
                ...
                if (treasureBox != null && (imageurl = treasureBox.getImageurl()) != null) {
                    oOO00O.OooO(sVGAView);
                    sVGAView.OooO0oo(imageurl, this.f45109OooOOo0);
                    sVGAView.OooO();
                }
            ...
            case 23:
                ...
                if (numValueOf4 != null && numValueOf4.intValue() == 1) {
                    textView3.setText(OooOo.OooO00o(strOooO0OO7, o000O0O0.OooO0OO(R.string.message_custom_theme_failed_content1)));
                } else if (numValueOf4 != null && numValueOf4.intValue() == 2) {
                    textView3.setText(OooOo.OooO00o(strOooO0OO7, o000O0O0.OooO0OO(R.string.message_custom_theme_failed_content2)));
                } else if (numValueOf4 != null && numValueOf4.intValue() == 3) {
                    textView3.setText(OooOo.OooO00o(strOooO0OO7, o000O0O0.OooO0OO(R.string.message_custom_theme_failed_content3)));
                } else if (numValueOf4 != null && numValueOf4.intValue() == 4) {
                    textView3.setText(OooOo.OooO00o(strOooO0OO7, o000O0O0.OooO0OO(R.string.message_custom_theme_failed_content4)));
                } else if (numValueOf4 != null && numValueOf4.intValue() == 5) {
                    textView3.setText(OooOo.OooO00o(strOooO0OO7, o000O0O0.OooO0OO(R.string.message_custom_theme_failed_content5)));
                } else if (numValueOf4 != null && numValueOf4.intValue() == 6) {
                    textView3.setText(OooOo.OooO00o(strOooO0OO7, o000O0O0.OooO0OO(R.string.message_custom_theme_failed_content6)));
                } else if (numValueOf4 != null && numValueOf4.intValue() == 7) {
                    textView3.setText(OooOo.OooO00o(strOooO0OO7, o000O0O0.OooO0OO(R.string.message_custom_theme_failed_content7)));
                } else if (numValueOf4 != null && numValueOf4.intValue() == 9) {
                    textView3.setText(OooOo.OooO00o(strOooO0OO7, o000O0O0.OooO0OO(R.string.message_custom_theme_failed_content8)));
                }
                break;
            case 24:
                netImageView.setImageResource(R.drawable.icon_system_message_notice);
            ...
            case 25:
                ...
                if (numValueOf5 != null && numValueOf5.intValue() == 1) {
                    ...
                    textView3.setText(OooOo.OooO00o(o000O0O0.OooO0OO(R.string.message_ka_vip_expire_content), strValueOf2));
                } else if (numValueOf5 != null && numValueOf5.intValue() == 2) {
                    textView2.setText(o000O0O0.OooO0OO(R.string.message_ka_vip_will_upgrade));
                    textView3.setText(OooOo.OooO00o(o000O0O0.OooO0OO(R.string.message_ka_vip_will_upgrade_content), strValueOf2));
                } else if (numValueOf5 != null && numValueOf5.intValue() == 3) {
                    textView2.setText(OooOo.OooO00o(o000O0O0.OooO0OO(R.string.message_ka_vip_obtain), strValueOf2));
                    textView3.setText(OooOo.OooO00o(o000O0O0.OooO0OO(R.string.message_ka_vip_obtain_content), strValueOf2));
                }
                oOO00O.OooO(textView4);
                break;
            case 26:
                ...
                Friend friendOooO0Oo = p493o0o00O00.OooO0OO.OooO00o().OooOo00().OooO0Oo(((Number) kotlin.reflect.jvm.internal.impl.types.OooO00o.OooO00o(OooOOO.f41235OooO00o)).longValue(), userId);
                UserInfo userInfoOooO00o = o00Oo0.OooO00o(userId);
                ...
                textView3.setText(OooOo.OooO00o(strOooO0OO8, strArr6));
                break;
            case 27:
                netImageView.setImageResource(R.drawable.icon_system_message_notice);
                ...
                textView3.setText(OooOo.OooO00o(strOooO0OO9, strArr7));
                oOO00O.OooO(textView4);
                break;
            case 28:
                netImageView.setImageResource(R.drawable.icon_system_message_notice);
                ...
                textView3.setText(OooOo.OooO00o(strOooO0OO10, strArr8));
                oOO00O.OooO(textView4);
                break;
            case 29:
                netImageView.setImageResource(R.drawable.icon_system_message_notice);
                ...
                textView3.setText(OooOo.OooO00o(strOooO0OO11, strArr9));
                break;
            case 30:
                netImageView.setImageResource(R.drawable.icon_system_message_notice);
                ...
                textView3.setText(OooOo.OooO00o(strOooO0OO12, strArr10));
                break;
            case 31:
                netImageView.setImageResource(R.drawable.icon_system_message_notice);
                ...
                textView3.setText(OooOo.OooO00o(strOooO0OO13, strArr11));
                oOO00O.OooO(textView4);
                break;
            case 32:
                netImageView.setImageResource(R.drawable.icon_system_message_notice);
                ...
                textView3.setText(OooOo.OooO00o(strOooO0OO14, strArr12));
                break;
            case 33:
                netImageView.setImageResource(R.drawable.icon_system_message_salary);
            ...
            case 34:
                ...
                textView3.setText(OooOo.OooO00o(o000O0O0.OooO0OO(R.string.xxx_golds_recharge_successful), item.getMessage()));
                break;
            case 35:
                netImageView.setImageResource(R.drawable.icon_system_message_salary);
                ...
                strArr13[0] = str;
                textView3.setText(OooOo.OooO00o(strOooO0OO15, strArr13));
                break;
            case 36:
                netImageView.setImageResource(R.drawable.icon_system_message_notice);
                ...
                strArr14[0] = str;
                textView3.setText(OooOo.OooO00o(strOooO0OO16, strArr14));
                oOO00O.OooO(textView4);
                break;
            case 37:
                netImageView.setImageResource(R.drawable.icon_system_message_notice);
                ...
                if (memberBadgeTopRankReward != null && (shopUrl = memberBadgeTopRankReward.getShopUrl()) != null) {
                    oO0O000o.OooO00o oooO00o3 = new oO0O000o.OooO00o(netImageView2.getContext());
                    oooO00o3.f48447OooO0OO = CloudImageUtilKt.imgSize$default(shopUrl, o000OO00.OooO00o(106), false, 2, null);
