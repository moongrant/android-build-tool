...
public final class ooOOO0Oo extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ RefreshState f46751Oooo;

    /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
    public final /* synthetic */ o0O00O<Boolean> f46752OoooO00;
    ...
    public ooOOO0Oo(RefreshState refreshState, o0O00O<Boolean> o0o00o2, Continuation<? super ooOOO0Oo> continuation) {
        super(2, continuation);
        this.f46751Oooo = refreshState;
        this.f46752OoooO00 = o0o00o2;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new ooOOO0Oo(this.f46751Oooo, this.f46752OoooO00, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (OooO00o.$EnumSwitchMapping$0[this.f46751Oooo.OooO0OO().ordinal()] == 1) {
            this.f46752OoooO00.setValue(Boxing.boxBoolean(true));
        } else {
            this.f46752OoooO00.setValue(Boxing.boxBoolean(false));
        }
