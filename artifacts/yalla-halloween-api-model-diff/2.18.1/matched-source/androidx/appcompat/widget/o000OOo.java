...
public final class o000OOo {
    ...
    public static o000OOo f5393OooO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public static final PorterDuff.Mode f5394OooO0oo = PorterDuff.Mode.SRC_IN;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public static final OooO0OO f5395OooOO0 = new OooO0OO();

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public WeakHashMap<Context, p021OooOooo.o0ooOOo<ColorStateList>> f5396OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public p021OooOooo.o00oO0o<String, OooO> f5397OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public p021OooOooo.o0ooOOo<String> f5398OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final WeakHashMap<Context, p021OooOooo.o00Ooo<WeakReference<Drawable.ConstantState>>> f5399OooO0Oo = new WeakHashMap<>(0);

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public boolean f5400OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public TypedValue f5401OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public OooOO0 f5402OooO0oO;
    ...
    public static class OooO0O0 implements OooO {
        ...
        public final Drawable OooO00o(@NonNull Context context, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) {
            try {
                return p103o000oo00.OooOOO0.OooO00o(context, context.getResources(), xmlPullParser, attributeSet, theme);
            } catch (Exception e) {
    ...
    public static class OooOO0O implements OooO {
        ...
        public final Drawable OooO00o(@NonNull Context context, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) {
            try {
                return p103o000oo00.OooOo.OooO00o(context.getResources(), xmlPullParser, attributeSet, theme);
            } catch (Exception e) {
    ...
    public final synchronized ColorStateList OooO(@NonNull Context context, @DrawableRes int i) {
        ...
        WeakHashMap<Context, p021OooOooo.o0ooOOo<ColorStateList>> weakHashMap = this.f5396OooO00o;
        ...
        if (colorStateListOooO0oO == null) {
            OooOO0 oooOO1 = this.f5402OooO0oO;
            if (oooOO1 != null) {
                colorStateListOooO0Oo = ((androidx.appcompat.widget.OooOO0O.OooO00o) oooOO1).OooO0Oo(context, i);
            }
            if (colorStateListOooO0Oo != null) {
                if (this.f5396OooO00o == null) {
                    this.f5396OooO00o = new WeakHashMap<>();
                }
                p021OooOooo.o0ooOOo<ColorStateList> o0ooooo3 = this.f5396OooO00o.get(context);
                if (o0ooooo3 == null) {
                    o0ooooo3 = new p021OooOooo.o0ooOOo<>();
                    this.f5396OooO00o.put(context, o0ooooo3);
                }
    ...
    public final void OooO00o(@NonNull String str, @NonNull OooO oooO) {
        if (this.f5397OooO0O0 == null) {
            this.f5397OooO0O0 = new p021OooOooo.o00oO0o<>();
        }
        this.f5397OooO0O0.put(str, oooO);
    }
    ...
    public final synchronized boolean OooO0O0(@NonNull Context context, long j, @NonNull Drawable drawable) {
        ...
        p021OooOooo.o00Ooo<WeakReference<Drawable.ConstantState>> o00ooo2 = this.f5399OooO0Oo.get(context);
        if (o00ooo2 == null) {
            o00ooo2 = new p021OooOooo.o00Ooo<>();
            this.f5399OooO0Oo.put(context, o00ooo2);
        }
    ...
    public final Drawable OooO0OO(@NonNull Context context, @DrawableRes int i) {
        if (this.f5401OooO0o0 == null) {
            this.f5401OooO0o0 = new TypedValue();
        }
        TypedValue typedValue = this.f5401OooO0o0;
    ...
    */
    public final synchronized Drawable OooO0oO(@NonNull Context context, @DrawableRes int i, boolean z) {
        ...
        if (!this.f5400OooO0o) {
            boolean z2 = true;
            this.f5400OooO0o = true;
            Drawable drawableOooO0o = OooO0o(context, p014OooOo0o.OooOOO.abc_vector_test);
            if (drawableOooO0o != null) {
                if (!(drawableOooO0o instanceof p103o000oo00.OooOo) && !"android.graphics.drawable.VectorDrawable".equals(drawableOooO0o.getClass().getName())) {
                    z2 = false;
                }
            }
            this.f5400OooO0o = false;
    ...
    public final Drawable OooOO0O(@NonNull Context context, @DrawableRes int i) {
        int next;
        p021OooOooo.o00oO0o<String, OooO> o00oo0o2 = this.f5397OooO0O0;
        if (o00oo0o2 == null || o00oo0o2.isEmpty()) {
            return null;
        }
        p021OooOooo.o0ooOOo<String> o0ooooo2 = this.f5398OooO0OO;
        if (o0ooooo2 != null) {
            String strOooO0oO = o0ooooo2.OooO0oO(i, null);
            if ("appcompat_skip_skip".equals(strOooO0oO) || (strOooO0oO != null && this.f5397OooO0O0.getOrDefault(strOooO0oO, null) == null)) {
                return null;
            }
        } else {
            this.f5398OooO0OO = new p021OooOooo.o0ooOOo<>();
        }
        if (this.f5401OooO0o0 == null) {
            this.f5401OooO0o0 = new TypedValue();
        }
        ...
        if (charSequence != null && charSequence.toString().endsWith(".xml")) {
            try {
                ...
                this.f5398OooO0OO.OooO0OO(i, name);
                OooO orDefault = this.f5397OooO0O0.getOrDefault(name, null);
                if (orDefault != null) {
        ...
        if (drawableOooO0o0 == null) {
            this.f5398OooO0OO.OooO0OO(i, "appcompat_skip_skip");
        }
        return drawableOooO0o0;
    }
    ...
    public final Drawable OooOO0o(@NonNull Context context, @DrawableRes int i, boolean z, @NonNull Drawable drawable) {
        ...
        if (colorStateListOooO != null) {
            ...
            if (this.f5402OooO0oO != null && i == OooOo00.OooO.abc_switch_thumb_material) {
        ...
        if (oooOO1 != null) {
            ...
            if (i == OooOo00.OooO.abc_seekbar_track_material) {
                ...
                PorterDuff.Mode mode2 = androidx.appcompat.widget.OooOO0O.f5086OooO0O0;
                ...
                PorterDuff.Mode mode3 = androidx.appcompat.widget.OooOO0O.f5086OooO0O0;
    ...
    public final boolean OooOOO0(@NonNull Context context, @DrawableRes int i, @NonNull Drawable drawable) {
        ...
        if (oooOO1 != null) {
            androidx.appcompat.widget.OooOO0O.OooO00o oooO00o = (androidx.appcompat.widget.OooOO0O.OooO00o) oooOO1;
            PorterDuff.Mode mode = androidx.appcompat.widget.OooOO0O.f5086OooO0O0;
            boolean zOooO00o = oooO00o.OooO00o(oooO00o.f5089OooO00o, i);
            int i3 = R.attr.colorBackground;
            if (zOooO00o) {
                i3 = OooOo00.OooO00o.colorControlNormal;
            } else if (oooO00o.OooO00o(oooO00o.f5091OooO0OO, i)) {
                i3 = OooOo00.OooO00o.colorControlActivated;
            } else if (oooO00o.OooO00o(oooO00o.f5092OooO0Oo, i)) {
                mode = PorterDuff.Mode.MULTIPLY;
            } else {
            ...
            z = true;
            if (z) {
                int[] iArr2 = o0ooOOo.f5478OooO00o;
                drawableMutate = drawable.mutate();
                drawableMutate.setColorFilter(androidx.appcompat.widget.OooOO0O.OooO0OO(o00000OO.OooO0OO(context, i2), mode));
                if (iRound != -1) {
                    drawableMutate.setAlpha(iRound);
