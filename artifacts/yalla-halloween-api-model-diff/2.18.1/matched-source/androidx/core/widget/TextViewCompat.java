...
public final class TextViewCompat {
    ...
    public static class OooOO0 implements ActionMode.Callback {
        ...
        public final ActionMode.Callback f8020OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final TextView f8021OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public Class<?> f8022OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public Method f8023OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public boolean f8024OooO0o = false;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public boolean f8025OooO0o0;

        public OooOO0(ActionMode.Callback callback, TextView textView) {
            this.f8020OooO00o = callback;
            this.f8021OooO0O0 = textView;
        }

        @Override // android.view.ActionMode.Callback
        public final boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            return this.f8020OooO00o.onActionItemClicked(actionMode, menuItem);
        }

        @Override // android.view.ActionMode.Callback
        public final boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            return this.f8020OooO00o.onCreateActionMode(actionMode, menu);
        }

        @Override // android.view.ActionMode.Callback
        public final void onDestroyActionMode(ActionMode actionMode) {
            this.f8020OooO00o.onDestroyActionMode(actionMode);
        }
        ...
        public final boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
            boolean z;
            String str;
            Context context = this.f8021OooO0O0.getContext();
            PackageManager packageManager = context.getPackageManager();
            if (!this.f8024OooO0o) {
                this.f8024OooO0o = true;
                try {
                    Class<?> cls = Class.forName("com.android.internal.view.menu.MenuBuilder");
                    this.f8022OooO0OO = cls;
                    this.f8023OooO0Oo = cls.getDeclaredMethod("removeItemAt", Integer.TYPE);
                    this.f8025OooO0o0 = true;
                } catch (ClassNotFoundException | NoSuchMethodException unused) {
                    this.f8022OooO0OO = null;
                    this.f8023OooO0Oo = null;
                    this.f8025OooO0o0 = false;
                }
            }
            try {
                Method declaredMethod = (this.f8025OooO0o0 && this.f8022OooO0OO.isInstance(menu)) ? this.f8023OooO0Oo : menu.getClass().getDeclaredMethod("removeItemAt", Integer.TYPE);
                ...
                for (int i = 0; i < arrayList.size(); i++) {
                    ...
                    TextView textView = this.f8021OooO0O0;
            ...
            return this.f8020OooO00o.onPrepareActionMode(actionMode, menu);
        }
    }
    ...
    public static ActionMode.Callback OooO0oO(@Nullable ActionMode.Callback callback) {
        return (!(callback instanceof OooOO0) || Build.VERSION.SDK_INT < 26) ? callback : ((OooOO0) callback).f8020OooO00o;
    }
