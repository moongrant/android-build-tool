...
public class EmojiCompatInitializer implements o00oO0o<Boolean> {
    ...
    public static class OooO0O0 implements EmojiCompat.OooOO0O {
        ...
        public final Context f8101OooO00o;

        public OooO0O0(Context context) {
            this.f8101OooO00o = context.getApplicationContext();
        }
                ...
                public final void run() {
                    switch (i) {
                        case 0:
                            ...
                            try {
                                OooOOO oooOOOOooO00o = OooO0OO.OooO00o(oooO0O0.f8101OooO00o);
                                if (oooOOOOooO00o == null) {
                                    throw new RuntimeException("EmojiCompat font provider not available on this device.");
                                }
                                OooOOO.OooO0O0 oooO0O1 = (OooOOO.OooO0O0) oooOOOOooO00o.f8093OooO00o;
                                synchronized (oooO0O1.f8129OooO0Oo) {
                                    oooO0O1.f8130OooO0o = threadPoolExecutor;
                                    break;
                                }
                                oooOOOOooO00o.f8093OooO00o.OooO00o(new OooOO0(oooOOO1, threadPoolExecutor));
                                return;
                            } catch (Throwable th) {
                                oooOOO1.OooO00o(th);
                        ...
                        default:
                            ((androidx.room.OooO0O0) this).f9287Oooo0o.OooO00o();
                            return;
                    }
                }
            });
    ...
    public final void OooO00o(@NonNull Context context) {
        ...
        if (EmojiCompat.f8080OooOO0 == null) {
            synchronized (EmojiCompat.f8079OooO) {
                if (EmojiCompat.f8080OooOO0 == null) {
                    EmojiCompat.f8080OooOO0 = new EmojiCompat(oooO00o);
                }
            }
        }
        oo000o oo000oVarOooO0OO = oo000o.OooO0OO(context);
        Objects.requireNonNull(oo000oVarOooO0OO);
        synchronized (oo000o.f29297OooO0o0) {
            objOooO0O0 = oo000oVarOooO0OO.f29298OooO00o.get(ProcessLifecycleInitializer.class);
            if (objOooO0O0 == null) {
