...
public class ChangeTransform extends Transition {
    ...
    public static final String[] f9470o00Oo0 = {"android:changeTransform:matrix", "android:changeTransform:transforms", "android:changeTransform:parentMatrix"};

    /* JADX INFO: renamed from: o00Ooo, reason: collision with root package name */
    public static final Property<OooO0o, float[]> f9471o00Ooo = new OooO00o();

    /* JADX INFO: renamed from: o00o0O, reason: collision with root package name */
    public static final Property<OooO0o, PointF> f9472o00o0O = new OooO0O0(PointF.class);

    /* JADX INFO: renamed from: o00ooo, reason: collision with root package name */
    public static final boolean f9473o00ooo = true;

    /* JADX INFO: renamed from: o00O0O, reason: collision with root package name */
    public Matrix f9474o00O0O;

    /* JADX INFO: renamed from: o0OoOo0, reason: collision with root package name */
    public boolean f9475o0OoOo0;

    /* JADX INFO: renamed from: ooOO, reason: collision with root package name */
    public boolean f9476ooOO;

    public static class OooO {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final float f9477OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final float f9478OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final float f9479OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final float f9480OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final float f9481OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final float f9482OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final float f9483OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final float f9484OooO0oo;

        public OooO(View view) {
            this.f9477OooO00o = view.getTranslationX();
            this.f9478OooO0O0 = view.getTranslationY();
            WeakHashMap<View, o00000O> weakHashMap = ViewCompat.f7870OooO00o;
            this.f9479OooO0OO = ViewCompat.OooOOO.OooOO0o(view);
            this.f9480OooO0Oo = view.getScaleX();
            this.f9482OooO0o0 = view.getScaleY();
            this.f9481OooO0o = view.getRotationX();
            this.f9483OooO0oO = view.getRotationY();
            this.f9484OooO0oo = view.getRotation();
        }

        public final void OooO00o(View view) {
            ChangeTransform.Oooo0o(view, this.f9477OooO00o, this.f9478OooO0O0, this.f9479OooO0OO, this.f9480OooO0Oo, this.f9482OooO0o0, this.f9481OooO0o, this.f9483OooO0oO, this.f9484OooO0oo);
        }
    ...
    public class OooO00o extends Property<OooO0o, float[]> {
        ...
        public final void set(OooO0o oooO0o, float[] fArr) {
            ...
            float[] fArr2 = fArr;
            System.arraycopy(fArr2, 0, oooO0o2.f9489OooO0OO, 0, fArr2.length);
            oooO0o2.OooO00o();
        }
    }
    ...
    public class OooO0O0 extends Property<OooO0o, PointF> {
        ...
        public final void set(OooO0o oooO0o, PointF pointF) {
            ...
            oooO0o2.f9490OooO0Oo = pointF2.x;
            oooO0o2.f9491OooO0o0 = pointF2.y;
            oooO0o2.OooO00o();
        }
    }
    ...
    public static class OooO0OO extends androidx.transition.OooO {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public View f9485Oooo0o;

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public oO000O0 f9486Oooo0oO;

        public OooO0OO(View view, oO000O0 oo000o0) {
            this.f9485Oooo0o = view;
            this.f9486Oooo0oO = oo000o0;
        }

        @Override // androidx.transition.OooO, androidx.transition.Transition.OooO0o
        public final void OooO00o() {
            this.f9486Oooo0oO.setVisibility(4);
        }
        ...
        public final void OooO0Oo(@NonNull Transition transition) {
            ...
            View view = this.f9485Oooo0o;
            if (Build.VERSION.SDK_INT == 28) {
                if (!oO0Ooooo.f29767OoooO0O) {
                    try {
                        oO0Ooooo.OooO0O0();
                        Method declaredMethod = oO0Ooooo.f29763Oooo0oO.getDeclaredMethod("removeGhost", View.class);
                        oO0Ooooo.f29765OoooO0 = declaredMethod;
                        declaredMethod.setAccessible(true);
                    } catch (NoSuchMethodException e) {
                        Log.i("GhostViewApi21", "Failed to retrieve removeGhost method", e);
                    }
                    oO0Ooooo.f29767OoooO0O = true;
                }
                Method method = oO0Ooooo.f29765OoooO0;
                if (method != null) {
                    try {
                ...
                int i = oO0o0o.f29769OoooO0O;
                oO0o0o oo0o0o = (oO0o0o) view.getTag(oO000OOo.ghost_view);
                if (oo0o0o != null) {
                    int i2 = oo0o0o.f29770Oooo - 1;
                    oo0o0o.f29770Oooo = i2;
                    if (i2 <= 0) {
                        ((oO000O0O) oo0o0o.getParent()).removeView(oo0o0o);
                    }
                }
            }
            this.f9485Oooo0o.setTag(oO000OOo.transition_transform, null);
            this.f9485Oooo0o.setTag(oO000OOo.parent_matrix, null);
        }

        @Override // androidx.transition.OooO, androidx.transition.Transition.OooO0o
        public final void OooO0o0() {
            this.f9486Oooo0oO.setVisibility(0);
        }
    }
    ...
    public static class OooO0o {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final Matrix f9487OooO00o = new Matrix();

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final View f9488OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final float[] f9489OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public float f9490OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public float f9491OooO0o0;

        public OooO0o(View view, float[] fArr) {
            this.f9488OooO0O0 = view;
            float[] fArr2 = (float[]) fArr.clone();
            this.f9489OooO0OO = fArr2;
            this.f9490OooO0Oo = fArr2[2];
            this.f9491OooO0o0 = fArr2[5];
            OooO00o();
        }

        public final void OooO00o() {
            float[] fArr = this.f9489OooO0OO;
            fArr[2] = this.f9490OooO0Oo;
            fArr[5] = this.f9491OooO0o0;
            this.f9487OooO00o.setValues(fArr);
            oO00OO0O.f29748OooO00o.OooO0o0(this.f9488OooO0O0, this.f9487OooO00o);
        }
    }

    public ChangeTransform() {
        this.f9475o0OoOo0 = true;
        this.f9476ooOO = true;
        this.f9474o00O0O = new Matrix();
    }
    ...
    public final void OooOO0(@NonNull oO00O0o oo00o0o) {
        ...
        ((ViewGroup) oo00o0o.f29743OooO0O0.getParent()).startViewTransition(oo00o0o.f29743OooO0O0);
    }
    ...
    */
    public final Animator OooOOO(@NonNull ViewGroup viewGroup, @Nullable oO00O0o oo00o0o, @Nullable oO00O0o oo00o0o2) {
        ...
        char c2;
        boolean z3;
        if (oo00o0o == null || oo00o0o2 == null || !oo00o0o.f29742OooO00o.containsKey("android:changeTransform:parent") || !oo00o0o2.f29742OooO00o.containsKey("android:changeTransform:parent")) {
            return null;
        }
        ViewGroup viewGroup2 = (ViewGroup) oo00o0o.f29742OooO00o.get("android:changeTransform:parent");
        ViewGroup viewGroup3 = (ViewGroup) oo00o0o2.f29742OooO00o.get("android:changeTransform:parent");
        if (!this.f9476ooOO) {
            z = false;
        ...
        Matrix matrix = (Matrix) oo00o0o.f29742OooO00o.get("android:changeTransform:intermediateMatrix");
        if (matrix != null) {
            oo00o0o.f29742OooO00o.put("android:changeTransform:matrix", matrix);
        }
        Matrix matrix2 = (Matrix) oo00o0o.f29742OooO00o.get("android:changeTransform:intermediateParentMatrix");
        if (matrix2 != null) {
            oo00o0o.f29742OooO00o.put("android:changeTransform:parentMatrix", matrix2);
        }
        if (z) {
            Matrix matrix3 = (Matrix) oo00o0o2.f29742OooO00o.get("android:changeTransform:parentMatrix");
            oo00o0o2.f29743OooO0O0.setTag(oO000OOo.parent_matrix, matrix3);
            Matrix matrix4 = this.f9474o00O0O;
            matrix4.reset();
            matrix3.invert(matrix4);
            Matrix matrix5 = (Matrix) oo00o0o.f29742OooO00o.get("android:changeTransform:matrix");
            if (matrix5 == null) {
                matrix5 = new Matrix();
                oo00o0o.f29742OooO00o.put("android:changeTransform:matrix", matrix5);
            }
            matrix5.postConcat((Matrix) oo00o0o.f29742OooO00o.get("android:changeTransform:parentMatrix"));
            matrix5.postConcat(matrix4);
        }
        Matrix matrix6 = (Matrix) oo00o0o.f29742OooO00o.get("android:changeTransform:matrix");
        Matrix matrix7 = (Matrix) oo00o0o2.f29742OooO00o.get("android:changeTransform:matrix");
        if (matrix6 == null) {
            matrix6 = oO0Oo0oo.f29760OooO00o;
        }
        if (matrix7 == null) {
            matrix7 = oO0Oo0oo.f29760OooO00o;
        }
        ...
        if (matrix6.equals(matrix8)) {
            ...
            OooO oooO = (OooO) oo00o0o2.f29742OooO00o.get("android:changeTransform:transforms");
            ...
            Animator animatorOfPropertyValuesHolder = ObjectAnimator.ofPropertyValuesHolder(oooO0o, PropertyValuesHolder.ofObject(f9471o00Ooo, new oO0000o0(new float[9]), fArr, fArr2), PropertyValuesHolder.ofObject(f9472o00o0O, (TypeConverter) null, this.f9577Oooooo0.OooO00o(fArr[2], fArr[5], fArr2[2], fArr2[5])));
            c = 2;
            obj = "android:changeTransform:parentMatrix";
        ...
        if (z && animator != null && this.f9475o0OoOo0) {
            View view2 = oo00o0o2.f29743OooO0O0;
            Matrix matrix9 = new Matrix((Matrix) oo00o0o2.f29742OooO00o.get(obj));
            oO00OO0O.OooO0o(viewGroup, matrix9);
            if (Build.VERSION.SDK_INT == 28) {
                if (oO0Ooooo.f29766OoooO00) {
                    c2 = 1;
                } else {
                    try {
                        oO0Ooooo.OooO0O0();
                        Class<?> cls = oO0Ooooo.f29763Oooo0oO;
                        Class<?>[] clsArr = new Class[3];
                        clsArr[0] = View.class;
                        clsArr[1] = ViewGroup.class;
                        clsArr[c] = Matrix.class;
                        Method declaredMethod = cls.getDeclaredMethod("addGhost", clsArr);
                        oO0Ooooo.f29762Oooo = declaredMethod;
                        declaredMethod.setAccessible(true);
                    } catch (NoSuchMethodException e) {
                        Log.i("GhostViewApi21", "Failed to retrieve addGhost method", e);
                    }
                    c2 = 1;
                    oO0Ooooo.f29766OoooO00 = true;
                }
                Method method = oO0Ooooo.f29762Oooo;
                if (method != null) {
                    try {
                ...
                int i3 = oO0o0o.f29769OoooO0O;
                if (!(view2.getParent() instanceof ViewGroup)) {
                    throw new IllegalArgumentException("Ghosted views must be parented by a ViewGroup");
                }
                int i4 = oO000O0O.f29727Oooo0oo;
                ...
                if (oo0o0o3 == null || (oo000o0o = (oO000O0O) oo0o0o3.getParent()) == oo000o0o2) {
                    ...
                    i = oo0o0o3.f29770Oooo;
                    oo000o0o.removeView(oo0o0o3);
                    oo0o0o = null;
                }
                if (oo0o0o == null) {
                    oO0o0o oo0o0o4 = new oO0o0o(view2);
                    oo0o0o4.f29775OoooO00 = matrix9;
                    if (oo000o0o2 == null) {
                        oo000o0o2 = new oO000O0O(viewGroup);
                    } else {
                        if (!oo000o0o2.f29729Oooo0oO) {
                            throw new IllegalStateException("This GhostViewHolder is detached!");
                        }
                        oo000o0o2.f29728Oooo0o.getOverlay().remove(oo000o0o2);
                        oo000o0o2.f29728Oooo0o.getOverlay().add(oo000o0o2);
                    }
                    oO0o0o.OooO0O0(viewGroup, oo000o0o2);
                    oO0o0o.OooO0O0(viewGroup, oo0o0o4);
                    ArrayList arrayList2 = new ArrayList();
                    oO000O0O.OooO00o(oo0o0o4.f29773Oooo0oo, arrayList2);
                    ArrayList arrayList3 = new ArrayList();
                    int childCount = oo000o0o2.getChildCount() - 1;
                    int i5 = 0;
                    while (i5 <= childCount) {
                        int i6 = (i5 + childCount) / 2;
                        oO000O0O.OooO00o(((oO0o0o) oo000o0o2.getChildAt(i6)).f29773Oooo0oo, arrayList3);
                    ...
                    oo0o0o4.f29770Oooo = i;
                    oo0o0o2 = oo0o0o4;
                } else {
                    oo0o0o.f29775OoooO00 = matrix9;
                    oo0o0o2 = oo0o0o;
                }
                oo0o0o2.f29770Oooo++;
                oo0ooooo = oo0o0o2;
            ...
            if (oo0ooooo != null) {
                oo0ooooo.OooO00o((ViewGroup) oo00o0o.f29742OooO00o.get("android:changeTransform:parent"), oo00o0o.f29743OooO0O0);
                Transition transition = this;
                while (true) {
                    TransitionSet transitionSet = transition.f9566OoooOO0;
                ...
                if (f9473o00ooo) {
                    View view5 = oo00o0o.f29743OooO0O0;
                    if (view5 != oo00o0o2.f29743OooO0O0) {
            ...
            viewGroup2.endViewTransition(oo00o0o.f29743OooO0O0);
        }
        return animator;
    }
    ...
    public final void Oooo0o0(oO00O0o oo00o0o) {
        ...
        oo00o0o.f29742OooO00o.put("android:changeTransform:parent", view.getParent());
        oo00o0o.f29742OooO00o.put("android:changeTransform:transforms", new OooO(view));
        Matrix matrix = view.getMatrix();
        oo00o0o.f29742OooO00o.put("android:changeTransform:matrix", (matrix == null || matrix.isIdentity()) ? null : new Matrix(matrix));
        if (this.f9476ooOO) {
            ...
            oo00o0o.f29742OooO00o.put("android:changeTransform:parentMatrix", matrix2);
            oo00o0o.f29742OooO00o.put("android:changeTransform:intermediateMatrix", view.getTag(oO000OOo.transition_transform));
            oo00o0o.f29742OooO00o.put("android:changeTransform:intermediateParentMatrix", view.getTag(oO000OOo.parent_matrix));
        }
    }
    ...
    public ChangeTransform(@NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        this.f9476ooOO = true;
        this.f9474o00O0O = new Matrix();
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, oO000Oo.f29736OooO0o0);
        XmlPullParser xmlPullParser = (XmlPullParser) attributeSet;
        this.f9475o0OoOo0 = o00oO0o.OooO00o(typedArrayObtainStyledAttributes, xmlPullParser, "reparentWithOverlay", 1, true);
        this.f9476ooOO = o00oO0o.OooO00o(typedArrayObtainStyledAttributes, xmlPullParser, "reparent", 0, true);
