...
public final class AccessToken implements Parcelable {
    ...
    public int hashCode() {
        int iHashCode = (this.dataAccessExpirationTime.hashCode() + o0O0O00.OooO00o(this.userId, o0O0O00.OooO00o(this.applicationId, (this.lastRefresh.hashCode() + ((this.source.hashCode() + o0O0O00.OooO00o(this.token, (this.expiredPermissions.hashCode() + ((this.declinedPermissions.hashCode() + ((this.permissions.hashCode() + ((this.expires.hashCode() + 527) * 31)) * 31)) * 31)) * 31, 31)) * 31)) * 31, 31), 31)) * 31;
        String str = this.graphDomain;
    ...
    public String toString() {
        StringBuilder sbOooO00o = p708oo000o.Oooo0.OooO00o("{AccessToken", " token:");
