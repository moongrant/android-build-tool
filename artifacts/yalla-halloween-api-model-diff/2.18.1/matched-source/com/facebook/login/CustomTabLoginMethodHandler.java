...
public final class CustomTabLoginMethodHandler extends WebLoginMethodHandler {
    ...
    private final void onCustomTabComplete(String url, LoginClient.Request request) {
        ...
        if (url != null) {
            int i2 = 0;
            if (StringsKt.OooOoOO(url, Validate.CUSTOM_TAB_REDIRECT_URI_PREFIX) || StringsKt.OooOoOO(url, super.getValidRedirectURI())) {
                ...
                if (Utility.isNullOrEmpty(string) && Utility.isNullOrEmpty(string2) && i == -1) {
                    if (urlQueryString.containsKey("access_token")) {
                        ...
                        FacebookSdk.getExecutor().execute(new OooO00o(this, request, urlQueryString, i2));
                        return;
                    }
                }
    ...
    public static final void m217onCustomTabComplete$lambda0(CustomTabLoginMethodHandler this$0, LoginClient.Request request, Bundle values) {
