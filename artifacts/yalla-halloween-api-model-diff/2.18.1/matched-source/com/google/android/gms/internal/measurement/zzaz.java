...
public final class zzaz extends zzaw {
    public zzaz() {
        this.f15899OooO00o.add(zzbl.APPLY);
        this.f15899OooO00o.add(zzbl.BLOCK);
        this.f15899OooO00o.add(zzbl.BREAK);
        this.f15899OooO00o.add(zzbl.CASE);
        this.f15899OooO00o.add(zzbl.DEFAULT);
        this.f15899OooO00o.add(zzbl.CONTINUE);
        this.f15899OooO00o.add(zzbl.DEFINE_FUNCTION);
        this.f15899OooO00o.add(zzbl.FN);
        this.f15899OooO00o.add(zzbl.IF);
        this.f15899OooO00o.add(zzbl.QUOTE);
        this.f15899OooO00o.add(zzbl.RETURN);
        this.f15899OooO00o.add(zzbl.SWITCH);
        this.f15899OooO00o.add(zzbl.TERNARY);
    }
    ...
    */
    public final zzap zza(String str, zzg zzgVar, List list) {
        ...
        if (iOrdinal == 2) {
            zzap zzapVarZzb2 = zzgVar.zzb((zzap) o000000O.OooO00o(zzbl.APPLY, 3, list, 0));
        ...
        if (iOrdinal == 57) {
            return list.isEmpty() ? zzap.zzj : new zzag("return", zzgVar.zzb((zzap) o000000O.OooO00o(zzbl.RETURN, 1, list, 0)));
        }
        if (iOrdinal != 19) {
            if (iOrdinal == 20) {
            ...
            if (iOrdinal == 60) {
                zzap zzapVarZzb7 = zzgVar.zzb((zzap) o000000O.OooO00o(zzbl.SWITCH, 3, list, 0));
            ...
            if (iOrdinal == 61) {
                return zzgVar.zzb((zzap) o000000O.OooO00o(zzbl.TERNARY, 3, list, 0)).zzg().booleanValue() ? zzgVar.zzb((zzap) list.get(1)) : zzgVar.zzb((zzap) list.get(2));
            }
            switch (iOrdinal) {
                case 11:
