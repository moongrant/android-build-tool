...
final class l111l11111lIl {
    ...
    private static long l1111l111111Il(ByteBuffer byteBuffer, long j) throws IOException {
        ...
        throw new IOException("ZIP Central Directory offset out of range: " + jL1111l111111Il + ". ZIP End of Central Directory offset: " + j);
    }
    ...
    public static ByteBuffer l1111l111111Il(ByteBuffer byteBuffer) throws IOException {
    ...
    public static ByteBuffer l1111l111111Il(ByteBuffer byteBuffer, int i) throws IOException {
        ...
        while (byteBufferL1111l111111Il.hasRemaining()) {
            ...
            if (i3 > byteBufferL1111l111111Il.remaining()) {
                throw new IOException("APK Signing Block entry #" + i2 + " size out of range: " + i3 + ", available: " + byteBufferL1111l111111Il.remaining());
            }
                ...
                if (i != 1057) {
                    if (i != 1059) {
                        if (i != 1061) {
                            switch (i) {
                                case 257:
                                    return Pair.create("SHA256withRSA/PSS", new PSSParameterSpec(EvpMdRef.SHA256.JCA_NAME, EvpMdRef.MGF1_ALGORITHM_NAME, MGF1ParameterSpec.SHA256, 32, 1));
                                case 258:
                                    return Pair.create("SHA512withRSA/PSS", new PSSParameterSpec(EvpMdRef.SHA512.JCA_NAME, EvpMdRef.MGF1_ALGORITHM_NAME, MGF1ParameterSpec.SHA512, 64, 1));
                                case 259:
                                    break;
                                case 260:
    ...
    public static byte[] l111l11111lIl(ByteBuffer byteBuffer) throws IOException {
        int i = byteBuffer.getInt();
        if (i < 0) {
