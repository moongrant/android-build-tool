...
public class o {
    ...
    private static final String f20246o = "dstk_last_time";
    ...
    public static class a {
        ...
        /* JADX INFO: renamed from: o, reason: collision with root package name */
        public static final int f20247o = 4356;
    ...
    private void f(JSONObject jSONObject) {
        ...
        try {
            if (!jSONObject.getJSONObject("header").has(com.umeng.analytics.pro.d.aB)) {
                ...
                if (jSONObject.has("analytics") && (jSONObjectOptJSONObject = jSONObject.optJSONObject("analytics")) != null && jSONObjectOptJSONObject.length() > 0 && jSONObjectOptJSONObject.has(com.umeng.analytics.pro.d.n)) {
                    i.a(a).a(true, false);
                }
                i.a(a).b();
                return;
    ...
    private JSONObject l() {
        ...
        try {
            ...
            if (verticalType == 1) {
                ...
                jSONObject.put("sdk_version", "9.4.2+000");
            }
            ...
            if (sharedPreferences != null) {
                ...
                if (!TextUtils.isEmpty(string)) {
                    ...
                    if (TextUtils.isEmpty(strImprintProperty)) {
                        jSONObject.put(com.umeng.analytics.pro.d.l, sharedPreferences.getString("vers_pre_version", AppEventsConstants.EVENT_PARAM_VALUE_NO));
                        jSONObject.put(com.umeng.analytics.pro.d.m, sharedPreferences.getString("vers_date", str3));
                    }
        ...
        try {
            ...
            if (TextUtils.isEmpty(strImprintProperty)) {
                ...
                if (TextUtils.isEmpty(string)) {
                    ...
                    strImprintProperty = AppEventsConstants.EVENT_PARAM_VALUE_NO;
                } else {
    ...
    private void o() {
        try {
            ...
            this.j = 0;
            this.k = System.currentTimeMillis();
            PreferenceWrapper.getDefault(a).edit().putLong(f20246o, System.currentTimeMillis()).putInt(p, 0).commit();
        } catch (Throwable unused) {
        }
    }
        ...
        try {
            ...
            if (jSONObject.has("header") && jSONObject.has("header") && (jSONObject2 = jSONObject.getJSONObject("header")) != null && jSONObject2.length() > 0) {
                ...
                if (jSONObject2.has(str2)) {
                    jSONObject3.put(ServerProtocol.FALLBACK_DIALOG_PARAM_VERSION, jSONObject2.getInt(str2));
                }
    ...
    private boolean c(boolean z2) {
        ...
        if (zShouldSendMessage) {
            ...
            if (UMConfigure.isDebugLog()) {
                StringBuilder sbOooO0o0 = OooO00o.OooO00o.OooO0o0("数据发送策略 : ");
                sbOooO0o0.append(reportStrategyC.getClass().getSimpleName());
                MLog.d(sbOooO0o0.toString());
            }
        }
