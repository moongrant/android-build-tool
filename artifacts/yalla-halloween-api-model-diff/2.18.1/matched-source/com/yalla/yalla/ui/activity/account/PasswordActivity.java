...
import p534o0o0OOo0.o0O0o0;
import p534o0o0OOo0.o0O0o000;
import p534o0o0OOo0.o0O0o00O;
import p617o0oo0o.Oooo000;
import p649o0ooOOoo.l6;
...
public final class PasswordActivity extends BaseActivityK {
    ...
    @NotNull
    public static final OooO00o f21781OoooooO = new OooO00o();

    /* JADX INFO: renamed from: OoooOoo, reason: collision with root package name */
    @NotNull
    public final o00O000o f21782OoooOoo = new o00O000o(Reflection.getOrCreateKotlinClass(l6.class), this, null);

    /* JADX INFO: renamed from: Ooooo00, reason: collision with root package name */
    @NotNull
    public final ViewModelLazy f21783Ooooo00 = new ViewModelLazy(Reflection.getOrCreateKotlinClass(PasswordVM.class), new Function0<ViewModelStore>() { // from class: com.yalla.yalla.ui.activity.account.PasswordActivity$special$$inlined$viewModels$default$2
        {
            super(0);
        }
        ...
        public final /* synthetic */ Function0 f21798Oooo0o = null;
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f21798Oooo0o;
    ...
    @NotNull
    public String f21784Ooooo0o = "";

    /* JADX INFO: renamed from: OooooO0, reason: collision with root package name */
    @NotNull
    public String f21785OooooO0 = "";

    /* JADX INFO: renamed from: OooooOO, reason: collision with root package name */
    @NotNull
    public String f21786OooooOO = "";

    /* JADX INFO: renamed from: OooooOo, reason: collision with root package name */
    public boolean f21787OooooOo;

    /* JADX INFO: renamed from: Oooooo, reason: collision with root package name */
    public boolean f21788Oooooo;

    /* JADX INFO: renamed from: Oooooo0, reason: collision with root package name */
    @Nullable
    public ClientCodeType f21789Oooooo0;
    ...
    public static final class OooO extends Lambda implements Function1<ApiResult<LoginListModel>, Unit> {
        ...
        public final Unit invoke(ApiResult<LoginListModel> apiResult) {
            ...
            PasswordActivity.this.f21788Oooooo = false;
    ...
    public static final class OooO0OO extends Lambda implements Function1<LoginListModel, Unit> {
        ...
        public final Unit invoke(LoginListModel loginListModel) {
            ...
            if (PasswordActivity.this.f21789Oooooo0 == ClientCodeType.Retrieve) {
    ...
    public static final class OooO0o extends Lambda implements Function1<ApiError, Unit> {
        ...
        public final /* synthetic */ String f21793Oooo0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(String str) {
            super(1);
            this.f21793Oooo0oO = str;
        }
        ...
        public final Unit invoke(ApiError apiError) {
            ...
            if (PasswordActivity.this.f21789Oooooo0 == ClientCodeType.Login) {
                o0O00000.OooO0OO("Log_password_error");
            }
            if (error.getCode() == 1069) {
                Pair<String, String> pairOooO00o = Oooo000.OooO00o(this.f21793Oooo0oO, PasswordActivity.this);
    ...
    public static final void OooOoo(PasswordActivity passwordActivity) {
        ...
        EditText view = passwordActivity.OooOooO().f49908OooO0OO;
        Intrinsics.checkNotNullExpressionValue(view, "binding.etPassword");
        Intrinsics.checkNotNullParameter(view, "view");
        Context context = view.getContext();
        Intrinsics.checkNotNullExpressionValue(context, "view.context");
        p470o0Oooo0.o00O000.OooO00o(context).hideSoftInputFromWindow(view.getWindowToken(), 0, new KeyBoardUtil$hideKeyboard$1(o000O0Oo.OooO00o(view, "view.context"), new Handler()));
    ...
    public final void OooOOoo() {
        MobclickAgent.onPageEnd(PasswordActivity.class.getName() + "-Type" + this.f21789Oooooo0);
    }
    ...
    public final void OooOo00() {
        MobclickAgent.onPageStart(PasswordActivity.class.getName() + "-Type" + this.f21789Oooooo0);
    }

    public final l6 OooOooO() {
        return (l6) this.f21782OoooOoo.getValue();
    }

    /* JADX WARN: Multi-variable type inference failed */
    public final PasswordVM OooOooo() {
        return (PasswordVM) this.f21783Ooooo00.getValue();
    }

    public final void Oooo000(String str, String str2) {
        if (this.f21788Oooooo) {
            return;
        }
        this.f21788Oooooo = true;
    ...
    public void onClick(@NotNull View view) {
        ...
        if (view.getId() == R.id.iv_see) {
            boolean z = !this.f21787OooooOo;
            this.f21787OooooOo = z;
            if (z) {
                OooOooO().f49908OooO0OO.setTransformationMethod(HideReturnsTransformationMethod.getInstance());
                OooOooO().f49911OooO0o0.setImageResource(R.drawable.eye1);
            } else {
                OooOooO().f49908OooO0OO.setTransformationMethod(PasswordTransformationMethod.getInstance());
                OooOooO().f49911OooO0o0.setImageResource(R.drawable.eye2);
            }
            OooOooO().f49908OooO0OO.setTypeface(Typeface.MONOSPACE);
            o0000.OooOO0(OooOooO().f49908OooO0OO);
        }
    }
    ...
    public final void onCreate(@Nullable Bundle bundle) {
        ...
        setContentView(OooOooO().f49906OooO00o);
        ...
        this.f21789Oooooo0 = (ClientCodeType) serializableExtra;
        String stringExtra = getIntent().getStringExtra("PHONE_NUMBER");
        if (stringExtra == null) {
            stringExtra = "";
        }
        this.f21784Ooooo0o = stringExtra;
        String stringExtra2 = getIntent().getStringExtra("COUNTRY_AREA_CODE");
        if (stringExtra2 == null) {
            stringExtra2 = "";
        }
        this.f21785OooooO0 = stringExtra2;
        String stringExtra3 = getIntent().getStringExtra("SMS_CODE");
        this.f21786OooooOO = stringExtra3 != null ? stringExtra3 : "";
        if (this.f21789Oooooo0 == ClientCodeType.Register) {
            o00oO0o o00oo0o2 = o00000OO.f32207OooO00o;
            new ApiEvent().OooO00o(60);
        }
        OooOo0O(1);
        OooOooO().f49909OooO0Oo.setOnClickListener(new o000O000(this, 1));
        OooOooO().f49910OooO0o.setColor(o000O0O0.OooO00o(R.color.color_FFB7B7B7));
        OooOooO().f49910OooO0o.OooO00o();
        ClientCodeType clientCodeType = this.f21789Oooooo0;
        ...
        if (i == 1) {
            ...
            OooOooO().f49905OooO.setText(R.string.Create_password);
        } else if (i == 2) {
            ...
            OooOoO0(str);
            OooOooO().f49905OooO.setText(R.string.Create_new_password);
        } else if (i == 3) {
            ...
            OooOooO().f49912OooO0oO.setVisibility(0);
            OooOooO().f49912OooO0oO.setEnabled(true);
            OooOooO().f49905OooO.setText(R.string.Registered_Phone_Number);
            OooOooO().f49913OooO0oo.setVisibility(0);
            String string = this.f21784Ooooo0o;
            if (com.yalla.support.common.util.OooO0OO.OooO0O0(this.f21785OooooO0) && StringsKt.OooOoOO(this.f21784Ooooo0o, this.f21785OooooO0)) {
                StringBuilder sb = new StringBuilder();
                sb.append(this.f21785OooooO0);
                sb.append(' ');
                String strSubstring = this.f21784Ooooo0o.substring(this.f21785OooooO0.length());
                Intrinsics.checkNotNullExpressionValue(strSubstring, "this as java.lang.String).substring(startIndex)");
                sb.append(strSubstring);
                string = sb.toString();
            }
            OooOooO().f49913OooO0oo.setText('+' + string);
        }
        OooOooO().f49912OooO0oO.setOnClickListener(new o0O0o00O(this));
        OooOooO().f49911OooO0o0.setOnClickListener(this);
        OooOooO().f49907OooO0O0.setOnClickListener(new o0O0o0(this));
        EditText editText = OooOooO().f49908OooO0OO;
        Intrinsics.checkNotNullExpressionValue(editText, "binding.etPassword");
        editText.addTextChangedListener(new o0O0o000(this));
        EditText view = OooOooO().f49908OooO0OO;
        Intrinsics.checkNotNullExpressionValue(view, "binding.etPassword");
        Intrinsics.checkNotNullParameter(view, "view");
        Context context = view.getContext();
        Intrinsics.checkNotNullExpressionValue(context, "view.context");
