...
import p544o0o0OoOO.l6;
import p544o0o0OoOO.m6;
import p544o0o0OoOO.n6;
import p649o0ooOOoo.te;
...
public final class RoomThemeStoreActivity extends BaseActivityK {
    ...
    @NotNull
    public static final OooO00o f23000OooooO0 = new OooO00o();

    /* JADX INFO: renamed from: OoooOoo, reason: collision with root package name */
    @NotNull
    public final o00O000o f23001OoooOoo = new o00O000o(Reflection.getOrCreateKotlinClass(te.class), this, null);

    /* JADX INFO: renamed from: Ooooo00, reason: collision with root package name */
    @NotNull
    public final ViewModelLazy f23002Ooooo00 = new ViewModelLazy(Reflection.getOrCreateKotlinClass(ThemeStoreVM.class), new Function0<ViewModelStore>() { // from class: com.yalla.yalla.ui.activity.room.RoomThemeStoreActivity$special$$inlined$viewModels$default$2
        {
            super(0);
        }
        ...
        public final /* synthetic */ Function0 f23014Oooo0o = null;
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f23014Oooo0o;
    ...
    public final boolean f23003Ooooo0o;
    ...
    public static final class OooO0O0 extends Lambda implements Function1<List<ThemeListModel>, Unit> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ List<String> f23004Oooo0o;

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ RoomThemeStoreActivity f23005Oooo0oO;

        /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
        public final /* synthetic */ List<Fragment> f23006Oooo0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(List<String> list, RoomThemeStoreActivity roomThemeStoreActivity, List<Fragment> list2) {
            super(1);
            this.f23004Oooo0o = list;
            this.f23005Oooo0oO = roomThemeStoreActivity;
            this.f23006Oooo0oo = list2;
        }
        ...
        public final Unit invoke(List<ThemeListModel> list) {
            ...
            if (list2 != null) {
                List<String> list3 = this.f23004Oooo0o;
                List<Fragment> list4 = this.f23006Oooo0oo;
            ...
            if (this.f23004Oooo0o.size() != 0) {
                RoomThemeStoreActivity roomThemeStoreActivity = this.f23005Oooo0oO;
                OooO00o oooO00o = RoomThemeStoreActivity.f23000OooooO0;
                YlTableLayout ylTableLayout = roomThemeStoreActivity.OooOoo().f50661OooO0o0;
    ...
    public static final class OooO0OO extends Lambda implements Function1<ApiError, Unit> {
        ...
        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ List<Fragment> f23008Oooo0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(List<Fragment> list) {
            super(1);
            this.f23008Oooo0oO = list;
        }
        ...
        public final Unit invoke(ApiError apiError) {
            ...
            List<Fragment> list = this.f23008Oooo0oO;
    ...
    public static final class OooO0o extends Lambda implements Function1<ApiResult<List<ThemeListModel>>, Unit> {
        ...
        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ List<String> f23010Oooo0oO;

        /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
        public final /* synthetic */ List<Fragment> f23011Oooo0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(List<String> list, List<Fragment> list2) {
            super(1);
            this.f23010Oooo0oO = list;
            this.f23011Oooo0oo = list2;
        }
        ...
        public final Unit invoke(ApiResult<List<ThemeListModel>> apiResult) {
            ...
            RoomThemeStoreActivity roomThemeStoreActivity = RoomThemeStoreActivity.this;
            OooO00o oooO00o = RoomThemeStoreActivity.f23000OooooO0;
            Context context = roomThemeStoreActivity.OooOoo().f50660OooO0Oo.getContext();
            ...
            oooO00o2.OooO0O0(this.f23010Oooo0oO);
            ...
            oooO00o2.f32978OooO0O0.setRightPadding(com.yalla.support.common.util.OooOo00.OooO00o(f));
            oooO00o2.f32983OooO0oO = o000O0O0.OooO00o(R.color.color_alpha_38_A3);
            ViewPager2 viewPager2 = RoomThemeStoreActivity.this.OooOoo().f50660OooO0Oo;
            ...
            oooO00o2.f32985OooOO0 = com.yalla.support.common.util.OooOo00.OooO00o(f);
            oooO00o2.f32986OooOO0O = com.yalla.support.common.util.OooOo00.OooO00o(3);
            oooO00o2.f32978OooO0O0.setAdjustMode(false);
            YlTableLayout ylTableLayout = RoomThemeStoreActivity.this.OooOoo().f50661OooO0o0;
            Intrinsics.checkNotNullExpressionValue(ylTableLayout, "binding.ylThemeTable");
            oooO00o2.OooO00o(ylTableLayout);
            RoomThemeStoreActivity.this.OooOoo().f50660OooO0Oo.setOffscreenPageLimit(this.f23011Oooo0oo.size());
            RoomThemeStoreActivity.this.OooOoo().f50660OooO0Oo.setAdapter(new OooOo(RoomThemeStoreActivity.this, this.f23011Oooo0oo));
    ...
    public RoomThemeStoreActivity() {
        ...
        this.f23003Ooooo0o = p498o0o00Oo0.OooOOO.f41251Oooo0OO.getValue() != null;
    }

    public final te OooOoo() {
        return (te) this.f23001OoooOoo.getValue();
    }
    ...
    public final void OooOooO() {
        ...
        ((ThemeStoreVM) this.f23002Ooooo00.getValue()).getThemeStyleListData().observe(this, new o0o0000.OooOo(new OooO0O0(arrayList, this, arrayList2), new OooO0OO(arrayList2), new OooO0o(arrayList, arrayList2), false, 8));
    }

    @Override // com.app.base.base.activity.BaseFragmentActivity, com.yalla.yalla.ui.activity.BaseAppCompatActivity, androidx.fragment.app.FragmentActivity, androidx.activity.ComponentActivity, androidx.core.app.ComponentActivity, android.app.Activity
    public final void onCreate(@Nullable Bundle bundle) {
        super.onCreate(bundle);
        setContentView(OooOoo().f50657OooO00o);
        ...
        if (this.f23003Ooooo0o) {
            HeaderLayout headerLayout3 = this.f11463OoooO;
            if (headerLayout3 != null) {
                headerLayout3.OooOoo0(R.string.Mine, new l6());
            }
        } else {
            ConstraintLayout constraintLayout = OooOoo().f50659OooO0OO.f50977OooO0O0;
            Intrinsics.checkNotNullExpressionValue(constraintLayout, "binding.themeHeadLayout.clThemeHead");
            oOO00O.OooO(constraintLayout);
            OooOoo().f50659OooO0OO.f50978OooO0OO.setOnClickListener(new m6(this));
        }
        if (getIntent().getBooleanExtra("IS_SHOW_RECHARGE", false)) {
            ConstraintLayout constraintLayout2 = OooOoo().f50658OooO0O0.f50893OooO0O0;
            ...
            OooOoo().f50658OooO0O0.f50894OooO0OO.setText(o0O0O00.OooO0Oo(String.valueOf(p498o0o00Oo0.OooOOO.f41216OooO00o.OooO0OO().getValue())));
            OooOoo().f50658OooO0O0.f50895OooO0Oo.setOnClickListener(new n6(this));
        }
        OooOooO();
        LiveEventBus.get("ROOM_THEME_REQUEST_FAILED").observe(this, new o0000O(this, 5));
    }
}
