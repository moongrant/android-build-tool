...
import p563o0oOo0.o000;
import p563o0oOo0.o0000OO0;
import p563o0oOo0.o000O000;
import p563o0oOo0.o000O0o;
...
public final class PrivateChatAdapter extends o0000O0O<ChatMessage> {
    ...
    @NotNull
    public String f23637OooOOo;

    /* JADX INFO: renamed from: OooOOo0, reason: collision with root package name */
    @NotNull
    public final FragmentActivity f23638OooOOo0;

    /* JADX INFO: renamed from: OooOOoo, reason: collision with root package name */
    @Nullable
    public UserInfo f23639OooOOoo;

    /* JADX INFO: renamed from: OooOo, reason: collision with root package name */
    @NotNull
    public final int[] f23640OooOo;

    /* JADX INFO: renamed from: OooOo0, reason: collision with root package name */
    @Nullable
    public Function2<? super ChatMessage, ? super Integer, Unit> f23641OooOo0;

    /* JADX INFO: renamed from: OooOo00, reason: collision with root package name */
    @Nullable
    public OooOo f23642OooOo00;

    /* JADX INFO: renamed from: OooOo0O, reason: collision with root package name */
    @Nullable
    public Function1<? super ChatMessage, Unit> f23643OooOo0O;

    /* JADX INFO: renamed from: OooOo0o, reason: collision with root package name */
    @Nullable
    public ChatMessage f23644OooOo0o;

    /* JADX INFO: renamed from: OooOoO, reason: collision with root package name */
    @NotNull
    public final int[] f23645OooOoO;

    /* JADX INFO: renamed from: OooOoO0, reason: collision with root package name */
    @NotNull
    public final int[] f23646OooOoO0;

    /* JADX INFO: renamed from: OooOoOO, reason: collision with root package name */
    @Nullable
    public Function0<Unit> f23647OooOoOO;

    public static final class OooO extends OooOOO0 {

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ ChatMessage f23649Oooo0oO;

        /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
        public final /* synthetic */ o000OO f23650Oooo0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(ChatMessage chatMessage, o000OO o000oo2) {
            super(0L, 1, null);
            this.f23649Oooo0oO = chatMessage;
            this.f23650Oooo0oo = o000oo2;
        }

        @Override // com.yalla.support.common.util.OooOOO0
        public final void onNoDoubleClick(@NotNull View view) {
            Intrinsics.checkNotNullParameter(view, "view");
            Function2<? super ChatMessage, ? super Integer, Unit> function2 = PrivateChatAdapter.this.f23641OooOo0;
            if (function2 != null) {
                function2.invoke(this.f23649Oooo0oO, Integer.valueOf(this.f23650Oooo0oo.getLayoutPosition()));
            }
        }
    }

    public static final class OooO00o extends androidx.recyclerview.widget.OooOo.OooO<ChatMessage> {
    ...
    public static final class OooO0OO implements OooOo00.OooO0O0 {
        ...
        public final void onComplete(@NotNull OooOo videoItem) {
            ...
            PrivateChatAdapter.this.f23642OooOo00 = videoItem;
        }
    ...
    public static final class OooO0o extends ClickableSpan {
        ...
        public final void onClick(@NotNull View widget) {
            ...
            UserInfo userInfo = PrivateChatAdapter.this.f23639OooOOoo;
            if (userInfo != null) {
                o000O.OooO00o(u5.f47570OooO00o, u5.OooO0o(2, userInfo.getUserId(), (52 & 4) != 0 ? null : null, (52 & 8) != 0 ? null : null, (52 & 16) != 0 ? null : null, (52 & 32) != 0 ? null : null));
            }
        }
    ...
    public PrivateChatAdapter(@NotNull FragmentActivity context) {
        ...
        this.f23638OooOOo0 = context;
        this.f23637OooOOo = "";
        this.f23640OooOo = new int[]{R.drawable.ic_gift_num0, R.drawable.ic_gift_num1, R.drawable.ic_gift_num2, R.drawable.ic_gift_num3, R.drawable.ic_gift_num4, R.drawable.ic_gift_num5, R.drawable.ic_gift_num6, R.drawable.ic_gift_num7, R.drawable.ic_gift_num8, R.drawable.ic_gift_num9};
        this.f23646OooOoO0 = new int[]{R.drawable.icon_anim_dice_1, R.drawable.icon_anim_dice_2, R.drawable.icon_anim_dice_3, R.drawable.icon_anim_dice_4, R.drawable.icon_anim_dice_5, R.drawable.icon_anim_dice_6};
        this.f23645OooOoO = new int[]{R.drawable.icon_anim_jsb_s, R.drawable.icon_anim_jsb_j, R.drawable.icon_anim_jsb_b};
    ...
    public final void OooO(o000OO o000oo2, ChatMessage chatMessage) {
        ...
        GiftPropModel giftPropModelOooO0O0 = oo0O.OooO0OO.f53327OooO00o.OooO0O0(giftInfo.getGiftId());
        ...
        oO0O00.OooO00o oooO00o = new oO0O00.OooO00o(o000oo2.itemView.getContext());
        ...
        if (giftNumber == 0) {
            ...
            imageView.setImageResource(this.f23640OooOo[giftNumber]);
        }
        ...
        if (giftNumber2 == 0 && giftNumber == 0) {
            ...
            imageView2.setImageResource(this.f23640OooOo[giftNumber2]);
        }
        ((ImageView) o000oo2.OooO00o(R.id.iv_chat_gift_one)).setImageResource(this.f23640OooOo[giftInfo.getGiftNumber() % 10]);
    }
    ...
    public final void OooO0o(o000OO holder, ChatMessage chatMessage) {
        ...
        if (itemViewType != viewType.getValue()) {
            ...
            if (item.getIsAcceptMsg()) {
                UserInfo userInfo = this.f23639OooOOoo;
                value = userInfo != null ? userInfo.getUserHeader() : null;
            } else {
                value = OooOOO.f41216OooO00o.OooO0oo().getValue();
            }
            oooO00o.f48429OooO0OO = CloudImageUtilKt.imgSize(CloudImageUtilKt.imgFormat(value), com.yalla.support.common.util.OooOo00.OooO00o(50), true);
            oooO00o.f48427OooO00o = 0;
            oooO00o.f48443OooOOo0 = com.yalla.support.common.util.OooOOO.OooO0O0(R.drawable.icon_head_default);
        ...
        if (itemViewType2 == ViewType.SendEmotion.getValue() || itemViewType2 == ViewType.ReceiveEmotion.getValue()) {
            ...
            if (numValueOf != null && numValueOf.intValue() == 0) {
                ...
                if (i != 0) {
                    if (emoticonValue <= 0 || emoticonValue > this.f23646OooOoO0.length) {
                        return;
                    }
                    lottieAnimationView.clearAnimation();
                    lottieAnimationView.setImageResource(this.f23646OooOoO0[emoticonValue - 1]);
                    return;
                }
            ...
            if (numValueOf != null && numValueOf.intValue() == 1) {
                ...
                if (i != 0) {
                    if (emoticonValue2 <= 0 || emoticonValue2 > this.f23645OooOoO.length) {
                        return;
                    }
                    lottieAnimationView.clearAnimation();
                    lottieAnimationView.setImageResource(this.f23645OooOoO[emoticonValue2 - 1]);
                    return;
                }
                ...
                lottieAnimationView.setRepeatCount(4);
                lottieAnimationView.f9955OoooO.f9986Oooo0oo.removeAllListeners();
        ...
        if (itemViewType2 == ViewType.SendShareRoom.getValue()) {
            ...
            oO0O00.OooO00o oooO00o2 = new oO0O00.OooO00o(holder.itemView.getContext());
            oooO00o2.OooO00o(o00OOO.OooO00o.OooO0oO());
            oooO00o2.OooO0oO(6);
            ChatMessage.ShareRoomInfo shareRoomInfo = item.getShareRoomInfo();
            oooO00o2.f48429OooO0OO = CloudImageUtilKt.imgSize(CloudImageUtilKt.imgFormat(shareRoomInfo != null ? shareRoomInfo.getRoomHeader() : null), com.yalla.support.common.util.OooOo00.OooO00o(60), true);
        ...
        if (itemViewType2 == ViewType.ReceiveShareRoom.getValue()) {
            ...
            oO0O00.OooO00o oooO00o3 = new oO0O00.OooO00o(holder.itemView.getContext());
            oooO00o3.OooO00o(o00OOO.OooO00o.OooO0oO());
            oooO00o3.OooO0oO(6);
            ChatMessage.ShareRoomInfo shareRoomInfo4 = item.getShareRoomInfo();
            oooO00o3.f48429OooO0OO = CloudImageUtilKt.imgSize(CloudImageUtilKt.imgFormat(shareRoomInfo4 != null ? shareRoomInfo4.getRoomHeader() : null), com.yalla.support.common.util.OooOo00.OooO00o(60), true);
        ...
        if (itemViewType2 == ViewType.SendShareMoment.getValue()) {
            ...
            oO0O00.OooO00o oooO00o4 = new oO0O00.OooO00o(holder.itemView.getContext());
            ...
            oooO00o4.f48429OooO0OO = CloudImageUtilKt.imgFormat(shareMomentInfo != null ? shareMomentInfo.getMomentImage() : null);
            ...
            if (momentText3 == null || StringsKt.isBlank(momentText3)) {
                ...
                o0o0Oo.OooO0O0(holder.itemView.getContext(), new MomentSendContentModel(str), textView4, null);
            }
        ...
        if (itemViewType2 == ViewType.ReceiveShareMoment.getValue()) {
            ...
            oO0O00.OooO00o oooO00o5 = new oO0O00.OooO00o(holder.itemView.getContext());
            ...
            oooO00o5.f48429OooO0OO = CloudImageUtilKt.imgFormat(shareMomentInfo5 != null ? shareMomentInfo5.getMomentImage() : null);
            ...
            if (momentText4 == null || StringsKt.isBlank(momentText4)) {
                ...
                o0o0Oo.OooO0O0(holder.itemView.getContext(), new MomentSendContentModel(str), textView5, null);
            }
        ...
        if (itemViewType2 == ViewType.SendShareTopic.getValue()) {
            ...
            oO0O00.OooO00o oooO00o6 = new oO0O00.OooO00o(holder.itemView.getContext());
            ...
            oooO00o6.f48429OooO0OO = CloudImageUtilKt.imgFormat(shareTopicInfo != null ? shareTopicInfo.getTopicImage() : null);
        ...
        if (itemViewType2 == ViewType.ReceiveShareTopic.getValue()) {
            ...
            oO0O00.OooO00o oooO00o7 = new oO0O00.OooO00o(holder.itemView.getContext());
            ...
            oooO00o7.f48429OooO0OO = CloudImageUtilKt.imgFormat(shareTopicInfo5 != null ? shareTopicInfo5.getTopicImage() : null);
        ...
        if (itemViewType2 == ViewType.SendShareUser.getValue()) {
            ...
            oO0O00.OooO00o oooO00o8 = new oO0O00.OooO00o(holder.itemView.getContext());
            oooO00o8.OooO00o(o00OOO.OooO00o.OooO0o0());
            ChatMessage.ShareUserInfo shareUserInfo = item.getShareUserInfo();
            oooO00o8.f48429OooO0OO = CloudImageUtilKt.imgSize(CloudImageUtilKt.imgFormat(shareUserInfo != null ? shareUserInfo.getUserHead() : null), com.yalla.support.common.util.OooOo00.OooO00o(60), true);
        ...
        if (itemViewType2 == ViewType.ReceiveShareUser.getValue()) {
            ...
            oO0O00.OooO00o oooO00o9 = new oO0O00.OooO00o(holder.itemView.getContext());
            oooO00o9.OooO00o(o00OOO.OooO00o.OooO0o0());
            ChatMessage.ShareUserInfo shareUserInfo4 = item.getShareUserInfo();
            oooO00o9.f48429OooO0OO = CloudImageUtilKt.imgSize(CloudImageUtilKt.imgFormat(shareUserInfo4 != null ? shareUserInfo4.getUserHead() : null), com.yalla.support.common.util.OooOo00.OooO00o(60), true);
    ...
    public final void OooO0oo(o000OO o000oo2, ChatMessage chatMessage) {
        ...
        oooO00o.f48429OooO0OO = CloudImageUtilKt.imgFormat(gifUrl);
        oooO00o.f48427OooO00o = 0;
    ...
    public final void OooOO0(o000OO o000oo2, ChatMessage chatMessage) {
        ...
        if (numValueOf != null && numValueOf.intValue() == value) {
            ...
            strArr2[0] = o00o1.OooO0OO(giveRoomThemeInfo3 != null ? giveRoomThemeInfo3.getThemeExpireTime() : 0L, "dd/MM/yyyy");
    ...
    public final void OooOO0O(o000OO o000oo2, ChatMessage chatMessage) {
        ...
        if (sendState == StatusEnum$MsgSendStatus.ING.OooO00o()) {
            ...
            sVGAView.setVideoItem(this.f23642OooOo00);
            sVGAView.OooO0OO();
    ...
    public final void OooOO0o(o000OO o000oo2, ChatMessage chatMessage) {
        ...
        oO0O00.OooO00o oooO00o = new oO0O00.OooO00o(o000oo2.itemView.getContext());
        oooO00o.f48441OooOOOo = R.drawable.message_ic_chat_share_post_default;
        ChatMessage.ShareActivityInfo shareActivityInfo = chatMessage.getShareActivityInfo();
        oooO00o.f48429OooO0OO = CloudImageUtilKt.imgFormat(shareActivityInfo != null ? shareActivityInfo.getActivityImage() : null);
        oooO00o.f48427OooO00o = 0;
    ...
    public final void OooOOO(o000OO o000oo2, ChatMessage chatMessage) {
        ...
        if ((!StringsKt.isBlank(this.f23637OooOOo) && !Intrinsics.areEqual(this.f23637OooOOo, chatMessage.getMid())) || !chatMessage.getIsWarn()) {
        ...
        this.f23637OooOOo = chatMessage.getMid();
        ...
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(p016OooOoO0.OooOo00.OooO0Oo(strOooO0OO, strOooO0OO2));
        int iIndexOf$default = StringsKt__StringsKt.indexOf$default((CharSequence) p016OooOoO0.OooOo00.OooO0Oo(strOooO0OO, strOooO0OO2), strOooO0OO2, 0, false, 6, (Object) null);
    ...
    public final void OooOOO0(o000OO o000oo2, ChatMessage chatMessage) {
        ...
        oooO00o.f48429OooO0OO = CloudImageUtilKt.imgFormat(shareEventRoomInfo2 != null ? shareEventRoomInfo2.getEventImageUrl() : null);
        oooO00o.f48427OooO00o = 0;
        oooO00o.OooO0oo(6, 6, 0, 0);
        oooO00o.f48441OooOOOo = R.drawable.icon_picture_default;
        ...
        o000oo2.OooO0o0(R.id.tvEventTime, o00o1.OooO0oO(shareEventRoomInfo3 != null ? shareEventRoomInfo3.getEventStartTime() : 0L));
        ...
        textView.setText(o00o1.OooO0oO(shareEventRoomInfo9.getEventStartTime()));
    ...
    public final void OooOOOO(o000OO o000oo2, ChatMessage chatMessage) {
        ...
        ChatMessage chatMessage2 = this.f23644OooOo0o;
        ...
        if (chatMessage2 == null) {
            ...
            if (Intrinsics.areEqual(chatMessage2 != null ? chatMessage2.getMid() : null, chatMessage.getMid())) {
                ChatMessage chatMessage3 = this.f23644OooOo0o;
                if (((chatMessage3 == null || (voiceInfo2 = chatMessage3.getVoiceInfo()) == null) ? null : voiceInfo2.getPlayState()) != ChatMessage.VoiceInfo.PlayState.Stop) {
                    sVGAView.OooOO0(false);
                    ChatMessage chatMessage4 = this.f23644OooOo0o;
                    ...
                    if (playState == ChatMessage.VoiceInfo.PlayState.Download) {
                        sVGAView.OooO0oo("svga/anim_voice_loading.svga", this.f23638OooOOo0);
                        o00O00.OooO0O0("playingVoice mid = " + chatMessage.getMid() + "   loading");
                    } else {
                        sVGAView.OooO0oo("svga/anim_voice_play.svga", this.f23638OooOOo0);
    ...
    public final void OooOOOo() {
        ChatMessage chatMessage = this.f23644OooOo0o;
