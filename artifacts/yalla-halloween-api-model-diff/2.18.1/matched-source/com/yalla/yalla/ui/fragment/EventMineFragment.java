...
import p649o0ooOOoo.o8;

/* JADX INFO: loaded from: classes3.dex */
@StabilityInferred(parameters = 0)
@Metadata(bv = {}, d1 = {"\u0000<\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010!\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0007\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007¢\u0006\u0004\b\u0016\u0010\u0017J\u001a\u0010\u0007\u001a\u00020\u00022\u0006\u0010\u0004\u001a\u00020\u00032\b\u0010\u0006\u001a\u0004\u0018\u00010\u0005H\u0016J\b\u0010\t\u001a\u00020\bH\u0014R\u001b\u0010\u000f\u001a\u00020\n8BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u000b\u0010\f\u001a\u0004\b\r\u0010\u000eR\u001a\u0010\u0012\u001a\b\u0012\u0004\u0012\u00020\u00110\u00108\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0012\u0010\u0013R\u001a\u0010\u0015\u001a\b\u0012\u0004\u0012\u00020\u00140\u00108\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0015\u0010\u0013¨\u0006\u0018"}, d2 = {"Lcom/yalla/yalla/ui/fragment/EventMineFragment;", "Lo0o00o00/OooO;", "Lo0ooOOoo/o8;", "Landroid/view/LayoutInflater;", "inflater", "Landroid/view/ViewGroup;", "container", "getViewBinding", "", "onLazyInit", "Lcom/yalla/yalla/ui/vm/event/EventDisplayViewModel;", "displayVM$delegate", "Lkotlin/Lazy;", "getDisplayVM", "()Lcom/yalla/yalla/ui/vm/event/EventDisplayViewModel;", "displayVM", "", "", "titles", "Ljava/util/List;", "Lcom/yalla/yalla/ui/fragment/EventDisplayChildFragment;", "fragments", "<init>", "()V", "app_YallaRelease"}, k = 1, mv = {1, 7, 1})
public final class EventMineFragment extends p503o0o00o00.OooO<o8> {
    ...
    @NotNull
    private final Lazy displayVM = androidx.fragment.app.o0000O.OooO0O0(this, Reflection.getOrCreateKotlinClass(EventDisplayViewModel.class), new Function0<ViewModelStore>() { // from class: com.yalla.yalla.ui.fragment.EventMineFragment$special$$inlined$activityViewModels$default$1
        {
            super(0);
        }
        ...
        public final /* synthetic */ Function0 f23833Oooo0o = null;
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f23833Oooo0o;
    ...
    @NotNull
    private final List<String> titles = CollectionsKt.mutableListOf(p254o00ooO0O.o000O0O0.OooO0OO(R.string.event_mine_subscribe), p254o00ooO0O.o000O0O0.OooO0OO(R.string.event_mine_creator));

    public static final class OooO00o extends Lambda implements Function1<View, Unit> {

        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public static final OooO00o f23831Oooo0o = new OooO00o();
    ...
    public static final void m322onLazyInit$lambda0(EventMineFragment this$0, String str) {
        ...
        p611o0oo0OO0.o0000.f48362OooO00o.OooO00o("101003", p606o0oo0O.OooOo.OooO00o(), str);
        this$0.getDisplayVM().setEventPageState(EventPage.MineCreator);
        RtlViewPager rtlViewPager = this$0.getBinding().f50150OooO0OO;
    ...
    public void onLazyInit() {
        super.onLazyInit();
        ImageView imageView = getBinding().f50149OooO0O0;
        Intrinsics.checkNotNullExpressionValue(imageView, "binding.ivSetting");
        com.yalla.support.common.util.o00O0O.OooO0Oo(imageView, OooO00o.f23831Oooo0o);
        Context context = getBinding().f50150OooO0OO.getContext();
        ...
        float f = 8;
        oooO00o.f32995OooOo0 = com.yalla.support.common.util.OooOo00.OooO00o(f);
        oooO00o.f32982OooO0o0 = 15.0f;
        oooO00o.f32980OooO0Oo = 15.0f;
        oooO00o.f32996OooOo00 = com.yalla.support.common.util.OooOo00.OooO00o(f);
        oooO00o.f32983OooO0oO = p254o00ooO0O.o000O0O0.OooO00o(R.color.color_alpha_38_A3);
        RtlViewPager rtlViewPager = getBinding().f50150OooO0OO;
        Intrinsics.checkNotNullExpressionValue(rtlViewPager, "binding.vpEvent");
        oooO00o.OooO0OO(rtlViewPager);
        oooO00o.f32984OooO0oo = com.yalla.support.common.util.OooOo00.OooO00o(2);
        oooO00o.f32976OooO = p254o00ooO0O.o000O0O0.OooO00o(R.color.color_00d8c9);
        oooO00o.f32985OooOO0 = com.yalla.support.common.util.OooOo00.OooO00o(12);
        oooO00o.f32986OooOO0O = com.yalla.support.common.util.OooOo00.OooO00o(3);
        int i = 0;
        oooO00o.f32978OooO0O0.setAdjustMode(false);
        YlTableLayout ylTableLayout = getBinding().f50151OooO0Oo;
        Intrinsics.checkNotNullExpressionValue(ylTableLayout, "binding.ylEvent");
        oooO00o.OooO00o(ylTableLayout);
        getBinding().f50150OooO0OO.setOffscreenPageLimit(this.fragments.size());
        RtlViewPager rtlViewPager2 = getBinding().f50150OooO0OO;
        FragmentManager childFragmentManager = getChildFragmentManager();
        Intrinsics.checkNotNullExpressionValue(childFragmentManager, "childFragmentManager");
        rtlViewPager2.setAdapter(new p462o0Ooo0o.o0000O00(childFragmentManager, this.fragments));
        RtlViewPager rtlViewPager3 = getBinding().f50150OooO0OO;
    ...
    @NotNull
    public o8 getViewBinding(@NotNull LayoutInflater inflater, @Nullable ViewGroup container) {
        Intrinsics.checkNotNullParameter(inflater, "inflater");
        o8 o8VarInflate = o8.inflate(inflater, container, false);
        Intrinsics.checkNotNullExpressionValue(o8VarInflate, "inflate(inflater, container, false)");
        return o8VarInflate;
    }
}
