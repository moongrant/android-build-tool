...
public final class PostDetailCommentFragment extends p503o0o00o00.OooO<rd> {
    ...
    @Nullable
    private o00oOoo mPostDetailCommentSendUtils;
    ...
    @NotNull
    private final o0O0ooO mMapListSendPostCommentModel = new o0O0ooO();
    ...
    public static final class OooO extends Lambda implements Function2<Integer, MoreModel, Object> {
        ...
        public final /* synthetic */ PostCommentDetailModel f24086Oooo0o;

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ FragmentActivity f24087Oooo0oO;

        /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
        public final /* synthetic */ PostDetailCommentFragment f24088Oooo0oo;
        ...
        public OooO(PostCommentDetailModel postCommentDetailModel, FragmentActivity fragmentActivity, PostDetailCommentFragment postDetailCommentFragment) {
            super(2);
            this.f24086Oooo0o = postCommentDetailModel;
            this.f24087Oooo0oO = fragmentActivity;
            this.f24088Oooo0oo = postDetailCommentFragment;
        }
        ...
        public final Object invoke(Integer num, MoreModel moreModel) {
            ...
            PostCommentDetailModel postCommentDetailModel = this.f24086Oooo0o;
            FragmentActivity activity = this.f24087Oooo0oO;
            PostDetailCommentFragment postDetailCommentFragment = this.f24088Oooo0oo;
            ...
            if (i != 1) {
                ...
                o0o0Oo.OooO0O0(activity, postCommentDetailModel.getContent(), textView, new o00O000o(postDetailCommentFragment));
    ...
    public static final class OooO0OO extends o00OO0O0.OooO0O0 {
        ...
        public final /* synthetic */ String f24091OooO0O0;

        public OooO0OO(String str) {
            this.f24091OooO0O0 = str;
        }
        ...
        public final void onFinish(@NotNull String response) {
            ...
            PostDetailCommentFragment.this.getBinding().f50451OooO0Oo.OooO0Oo();
    ...
    public static final class OooOO0 extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public static final OooOO0 f24093Oooo0o = new OooOO0();
    ...
    public static final class OooOO0O extends Lambda implements Function1<List<PostCommentDetailModel>, Unit> {
        ...
        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ boolean f24095Oooo0oO;

        /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
        public final /* synthetic */ boolean f24096Oooo0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0O(boolean z, boolean z2) {
            super(1);
            this.f24095Oooo0oO = z;
            this.f24096Oooo0oo = z2;
        }
        ...
        public final Unit invoke(List<PostCommentDetailModel> list) {
            ...
            int i = 1;
            if (list2 != null) {
                boolean z = this.f24095Oooo0oO;
                PostDetailCommentFragment postDetailCommentFragment = PostDetailCommentFragment.this;
                boolean z2 = this.f24096Oooo0oo;
                if (z) {
                    ...
                    postDetailCommentFragment.getBinding().f50449OooO0O0.postDelayed(new o0oo0000(postDetailCommentFragment, i), 300L);
                    if (z2) {
                        postDetailCommentFragment.getBinding().f50449OooO0O0.scrollToPosition(0);
                    }
                } else {
    ...
    public static final class OooOOO extends Lambda implements Function1<ApiResult<List<PostCommentDetailModel>>, Unit> {
        ...
        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ boolean f24098Oooo0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO(boolean z) {
            super(1);
            this.f24098Oooo0oO = z;
        }
        ...
        public final Unit invoke(ApiResult<List<PostCommentDetailModel>> apiResult) {
            ...
            PostDetailCommentFragment.this.mIsRefresh = this.f24098Oooo0oO;
            ...
            PostDetailCommentFragment.this.getBinding().f50450OooO0OO.Oooo00o(PostDetailCommentFragment.this.mIsRefresh, PostDetailCommentFragment.this.mIsSuccess, PostDetailCommentFragment.this.mIsNoMoreData);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOOO0 extends Lambda implements Function1<ApiError, Unit> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public static final OooOOO0 f24099Oooo0o = new OooOOO0();
    ...
    public static final class OooOOOO {
        ...
        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final /* synthetic */ EditTextSpan f24101OooO0O0;

        public OooOOOO(EditTextSpan editTextSpan) {
            this.f24101OooO0O0 = editTextSpan;
        }
        ...
        public final void OooO00o(@NotNull PostCommentDetailModel data) {
            ...
            PostDetailCommentFragment.this.getBinding().f50449OooO0O0.smoothScrollToPosition(PostDetailCommentFragment.this.getBaseAdapter().getHeaderLayoutCount() + 0);
            if (PostDetailCommentFragment.this.getBaseAdapter().getData().isEmpty()) {
                PostDetailCommentFragment.this.getEmptyView().OooO0O0(EmptyView.State.DataNull);
                PostDetailCommentFragment.this.getBaseAdapter().hindEmptyView(true);
            }
            ...
            this.f24101OooO0O0.setText("");
            this.f24101OooO0O0.OooO0O0();
            this.f24101OooO0O0.setHint(com.yalla.support.common.util.OooOOO.OooO0OO(R.string.Write_a_comment));
            PostDetailCommentFragment.this.showHotOrNewHeaderView();
        }
        ...
        public final void OooO0O0(@NotNull PostCommentDetailModel data, int i) {
            ...
            PostDetailCommentFragment.this.getBinding().f50449OooO0O0.smoothScrollToPosition(PostDetailCommentFragment.this.getBaseAdapter().getHeaderLayoutCount() + i);
            if (PostDetailCommentFragment.this.getBaseAdapter().getData().isEmpty()) {
                PostDetailCommentFragment.this.getEmptyView().OooO0O0(EmptyView.State.DataNull);
                PostDetailCommentFragment.this.getBaseAdapter().hindEmptyView(true);
            }
    ...
    public static final class OooOo extends Lambda implements Function1<ApiError, Unit> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ PostCommentDetailModel f24102Oooo0o;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOo(PostCommentDetailModel postCommentDetailModel) {
            super(1);
            this.f24102Oooo0o = postCommentDetailModel;
        }
        ...
        public final Unit invoke(ApiError apiError) {
            ApiError it = apiError;
            Intrinsics.checkNotNullParameter(it, "it");
            this.f24102Oooo0o.setSendProp(false);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOo00 extends Lambda implements Function1<RewardCommentResultModel, Unit> {
        ...
        public final /* synthetic */ TextView f24103Oooo;

        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ SVGAView f24104Oooo0o;

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ PostDetailCommentFragment f24105Oooo0oO;

        /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
        public final /* synthetic */ PostCommentDetailModel f24106Oooo0oo;
        ...
        public OooOo00(SVGAView sVGAView, PostDetailCommentFragment postDetailCommentFragment, PostCommentDetailModel postCommentDetailModel, TextView textView) {
            super(1);
            this.f24104Oooo0o = sVGAView;
            this.f24105Oooo0oO = postDetailCommentFragment;
            this.f24106Oooo0oo = postCommentDetailModel;
            this.f24103Oooo = textView;
        }
        ...
        public final Unit invoke(RewardCommentResultModel rewardCommentResultModel) {
            ...
            this.f24104Oooo0o.OooO0oo("svga/anim_moment_reward.svga", this.f24105Oooo0oO.getViewLifecycleOwner());
            this.f24104Oooo0o.OooO();
            this.f24106Oooo0oo.setSendProp(true);
            this.f24106Oooo0oo.setPropNum(rewardCommentResultModel2 != null ? rewardCommentResultModel2.getTotalPropNum() : 0L);
            p498o0o00Oo0.OooOOO.f41216OooO00o.OooO0OO().setValue(Long.valueOf(rewardCommentResultModel2 != null ? rewardCommentResultModel2.getCoinBalance() : 0L));
            this.f24103Oooo.setText(p168o00Ooo0.o0O0O00.OooO0oO(this.f24106Oooo0oo.getPropNum(), false));
            this.f24103Oooo.setTextColor(p254o00ooO0O.o000O0O0.OooO00o(this.f24106Oooo0oo.isSendProp() ? R.color.color_FFA16C : R.color.color_666666));
            oo00oO.OooO00o.OooO0OO oooO0OO = oo00oO.OooO00o.f53312OooO0OO;
            FragmentActivity fragmentActivityRequireActivity = this.f24105Oooo0oO.requireActivity();
            Intrinsics.checkNotNullExpressionValue(fragmentActivityRequireActivity, "requireActivity()");
            oooO0OO.OooO00o(fragmentActivityRequireActivity, this.f24103Oooo);
            return Unit.INSTANCE;
        }
    }

    public static final class Oooo0 extends o00OO0O0.OooO0O0 {

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final /* synthetic */ MomentSendCommentModel f24108OooO0O0;

        public static final class OooO00o implements o00oOoo.OooO00o {

            /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
            public final /* synthetic */ PostDetailCommentFragment f24109OooO00o;

            public OooO00o(PostDetailCommentFragment postDetailCommentFragment) {
                this.f24109OooO00o = postDetailCommentFragment;
            }

            @Override // o0o0Oo0O.o00oOoo.OooO00o
            public final void OooO00o(@NotNull PostCommentDetailModel data, int i) {
                Intrinsics.checkNotNullParameter(data, "data");
                o00O00.OooO0Oo("回复 替换评论 \n position = " + i + "\n data = " + data);
                this.f24109OooO00o.getBaseAdapter().setData(i, data);
                LiveEventBus.get("POST_DETAIL_APP_BAR_LAYOUT_SET_EXPANDED").post(Boolean.FALSE);
                this.f24109OooO00o.getBinding().f50449OooO0O0.smoothScrollToPosition(this.f24109OooO00o.getBaseAdapter().getHeaderLayoutCount() + i);
            }
            ...
            public final void OooO0O0(@NotNull PostCommentDetailModel data, int i) {
                ...
                this.f24109OooO00o.getBaseAdapter().remove(i);
                LiveEventBus.get("POST_DETAIL_APP_BAR_LAYOUT_SET_EXPANDED").post(Boolean.FALSE);
                this.f24109OooO00o.getBinding().f50449OooO0O0.smoothScrollToPosition(this.f24109OooO00o.getBaseAdapter().getHeaderLayoutCount() + i);
                this.f24109OooO00o.showHotOrNewHeaderView();
            }
        }

        public static final class OooO0O0 extends p388o0OOooO.o00000O0<AbsJavaBeanApiList<PostDetailCommentResultModel>> {
        }

        public Oooo0(MomentSendCommentModel momentSendCommentModel) {
            this.f24108OooO0O0 = momentSendCommentModel;
        }
        ...
        public final void onError(@NotNull String code2, @NotNull String message) {
            ...
            o00oOoo o00oooo2 = PostDetailCommentFragment.this.mPostDetailCommentSendUtils;
            Intrinsics.checkNotNull(o00oooo2);
            List<T> data = PostDetailCommentFragment.this.getBaseAdapter().getData();
            MomentSendCommentModel momentSendCommentModel = this.f24108OooO0O0;
            ...
            o0O0ooO o0o0ooo = PostDetailCommentFragment.this.mMapListSendPostCommentModel;
            MomentSendCommentModel momentSendCommentModel2 = this.f24108OooO0O0;
            ...
            o0o0ooo.OooO00o(momentSendCommentModel3);
        ...
        public final void onFinish(@NotNull String response) {
            ...
            PostDetailCommentFragment.this.mMapListSendPostCommentModel.OooO0o0(this.f24108OooO0O0);
            o00O00.OooO0O0("toApiSendData onFinish\n response = " + response + "\n result = " + absJavaBeanApiList + "\n mMapListSendPostCommentModel = " + PostDetailCommentFragment.this.mMapListSendPostCommentModel + "\n sendPostCommentModel = " + this.f24108OooO0O0);
            if (TextUtils.isEmpty(this.f24108OooO0O0.getCid()) && absJavaBeanApiList != null && absJavaBeanApiList.getData() != 0) {
                MomentSendCommentModel momentSendCommentModel = this.f24108OooO0O0;
                StringBuilder sb = new StringBuilder();
                ...
                if (data3 != 0 && momentSendCommentModel2 != null && TextUtils.isEmpty(momentSendCommentModel2.getParentUserId())) {
                    ...
                    if (data != null) {
                        ...
                        LiveEventBus.get("POST_DETAIL_APP_BAR_LAYOUT_SET_EXPANDED").post(Boolean.FALSE);
                        postDetailCommentFragment.getBinding().f50449OooO0O0.smoothScrollToPosition(postDetailCommentFragment.getBaseAdapter().getHeaderLayoutCount() + i);
                    }
                }
            }
            PostDetailCommentFragment.this.clearSendEdit();
    ...
    public static final class Oooo000 extends Lambda implements Function1<ApiResult<RewardCommentResultModel>, Unit> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public static final Oooo000 f24110Oooo0o = new Oooo000();
    ...
    public PostDetailCommentFragment() {
        ...
        this.vm = androidx.fragment.app.o0000O.OooO0O0(this, Reflection.getOrCreateKotlinClass(MomentVM.class), new Function0<ViewModelStore>() { // from class: com.yalla.yalla.ui.fragment.PostDetailCommentFragment$special$$inlined$viewModels$default$3
            {
                super(0);
            }
            ...
            /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
            public final /* synthetic */ Function0 f24114Oooo0o = null;
            ...
            public final CreationExtras invoke() {
                ...
                Function0 function1 = this.f24114Oooo0o;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final p188o00o00o0.OooO0OO<PostCommentDetailModel> getBaseAdapter() {
    ...
    private final MomentSendContentModel getSendPostModelContent() {
        ...
        String strOooO00o = o0o0Oo.OooO00o(getActivity(), editTextSpan);
        ...
        ArrayList<? extends p150o00Oo0Oo.OooOo> arrayListOooO0OO = editTextSpan.getSpanManager().OooO0OO("@");
    ...
    private final void init() {
        ...
        getBinding().f50449OooO0O0.setLayoutManager(new FixLinearLayoutManager(getContext()));
        getBinding().f50449OooO0O0.setAdapter(getBaseAdapter());
        getBaseAdapter().setEmptyView(getEmptyView());
        getBinding().f50450OooO0OO.f19541o00O0O = false;
        getBinding().f50450OooO0OO.OooOoOO(true);
        getBinding().f50450OooO0OO.Oooo0(new t0(this, 2));
        ...
        if (postDetailCommentHeaderView2 != null) {
            postDetailCommentHeaderView2.setListener(new p070o0000ooO.o00Ooo(this));
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: init$lambda-2, reason: not valid java name */
    public static final void m387init$lambda2(PostDetailCommentFragment this$0, oO000Oo it) {
    ...
    private final void initObserver() {
        ...
        LiveEventBus.get("POST_COMMENT_LIST_REFRESH_FOR_REPLY_DEL").observe(this, new p142o00OOooO.o000OO0O(this, i));
    }
    ...
    public final void loadData(boolean isRefresh, boolean isMoveToListTop) {
        ...
        if (momentDetailModel != null) {
            ...
            if (isRefresh) {
                this.pageIndex = 1;
                this.dateSort = 0L;
                getBinding().f50451OooO0Oo.OooO0oo();
            }
            getVm().momentCommentList(id, this.mSortType, this.dateSort, this.pageIndex).observe(getViewLifecycleOwner(), new o0o0000.OooOo(new OooOO0O(isRefresh, isMoveToListTop), OooOOO0.f24099Oooo0o, new OooOOO(isRefresh), false));
        }
    }
    ...
    private final void recoverSendEdit() {
        ...
        if (momentSendCommentModel != null) {
            ...
            if (TextUtils.isEmpty(momentSendCommentModel.getCid())) {
                ...
                String strOooO0O0 = o00o0o2.OooO0O0(j, parentUserName != null ? parentUserName : "");
            ...
            o00OO.OooO00o(this.mEditContentInput, momentSendCommentModel.getContent(), getActivity());
    ...
    public final void reportComment(String cid) {
        if (cid != null) {
            ...
            MomentDetailModel momentDetailModel = this.mPostDetailModel;
            p584o0oOoo.o000O.OooO00o(u5Var, u5.OooO0o(5, jOooO0oO, (52 & 4) != 0 ? null : null, (52 & 8) != 0 ? null : Long.valueOf(momentDetailModel != null ? momentDetailModel.getId() : 0L), (52 & 16) != 0 ? null : null, (52 & 32) != 0 ? null : null));
        }
    }
    ...
    public final void sendReward(PostCommentDetailModel item, SVGAView rewardSvga, TextView tvRewardCount) {
        ...
        vm.commentSendProp(str, userid).observe(getViewLifecycleOwner(), new o0o0000.OooOo(new OooOo00(rewardSvga, this, item, tvRewardCount), new OooOo(item), Oooo000.f24110Oooo0o, false));
    }
    ...
    public final void smoothScrollToPositionCommentMessageIndex() {
        ...
        getBinding().f50449OooO0O0.smoothScrollToPosition(getBaseAdapter().getHeaderLayoutCount() + this.commentMessageForPostListIndex);
        getBinding().f50449OooO0O0.postDelayed(new com.facebook.appevents.codeless.OooO0O0(this, 2), this.delayMillsCommentMessageChangeColor);
    }
    ...
    private final void smoothScrollToPositionSendCommentIndex() {
        ...
        if ((postCommentDetailModel != null ? postCommentDetailModel.getId() : 0L) > 0) {
            ...
            if (TextUtils.isEmpty(this.commentId)) {
                getBinding().f50449OooO0O0.smoothScrollToPosition(getBaseAdapter().getHeaderLayoutCount() + 0);
                return;
            }
            ...
            this.commentId = "";
            getBinding().f50449OooO0O0.smoothScrollToPosition(getBaseAdapter().getHeaderLayoutCount() + i);
        }
    }
    ...
    public final void commentReplaceCid() {
        ...
        this.isCommentReplacePost = true;
        o0O0ooO o0o0ooo = this.mMapListSendPostCommentModel;
        o0o0ooo.OooO0Oo();
        o0o0ooo.OooO0Oo();
        int size = o0o0ooo.f32166OooO0O0.size();
        do {
            size--;
            if (size < 0) {
                ...
                o0o0ooo.OooO0Oo();
                momentSendCommentModel = (MomentSendCommentModel) o0o0ooo.f32166OooO0O0.get(size);
            }
    ...
    public final void itemViewOnLongClick(@Nullable PostCommentDetailModel postCommentDetailModel) {
        ...
        if (activity != null) {
            ...
            o00o1.OooOO0(OooOO0.f24093Oooo0o);
            o00o1.OooOOO0();
        }
    }
    ...
    public final void sendComment() {
        ...
        if (editTextSpan != null) {
            ...
            if (p168o00Ooo0.o0OoOo0.OooO0o0(editTextSpan) > 500) {
                ...
                p254o00ooO0O.o0O0ooO o0o0oooOooO0O1 = p074o000O0oo.OooOOO.OooO0O0(toastUtil2, strOooO00o, "runnable");
                if (Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                    o0o0oooOooO0O1.run();
                    return;
                } else {
            ...
            if (p168o00Ooo0.o0OoOo0.OooO0Oo(editTextSpan) > 50) {
                ...
                p254o00ooO0O.o0O0ooO o0o0oooOooO0O2 = p074o000O0oo.OooOOO.OooO0O0(toastUtil3, strOooO0OO2, "runnable");
                if (Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                    o0o0oooOooO0O2.run();
                    return;
                } else {
            ...
            if (this.mPostDetailCommentSendUtils == null) {
                this.mPostDetailCommentSendUtils = new o00oOoo();
            }
            if (this.mPostDetailCommentSendUtils != null) {
                List<PostCommentDetailModel> data = getBaseAdapter().getData();
                MomentSendCommentModel momentSendCommentModel3 = this.mSendPostCommentModel;
    ...
    public final void toApiSendData(@Nullable MomentSendCommentModel sendPostCommentModel, boolean isReplyComment) {
        ...
        if (isReplyComment) {
            if (String.valueOf(momentDetailModel.getUserId()).length() > 0) {
                ...
                BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), null, null, new p498o0o00Oo0.oo0o0O0(actionType, actionInfo, sessionId, null), 3, null);
            }
        } else {
            if (String.valueOf(momentDetailModel.getUserId()).length() > 0) {
                ...
                BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), null, null, new p498o0o00Oo0.oo0o0O0(actionType2, actionInfo2, sessionId2, null), 3, null);
            }
        }
        p153o00Oo0oO.o00oO0o o00oo0o2 = p153o00Oo0oO.o00000OO.f32207OooO00o;
        p153o00Oo0oO.o00000OO.f32213OooO0oO.OooO0O0(sendPostCommentModel, new Oooo0(sendPostCommentModel));
    }

    public final void toReplyComment(@NotNull PostCommentDetailModel postCommentDetailModel) {
        Intrinsics.checkNotNullParameter(postCommentDetailModel, "postCommentDetailModel");
        getBinding().f50449OooO0O0.postDelayed(new com.facebook.appevents.codeless.OooO0OO(this, postCommentDetailModel, 1), 200L);
    }

    @Override // p503o0o00o00.OooO
    @NotNull
    public rd getViewBinding(@NotNull LayoutInflater inflater, @Nullable ViewGroup container) {
        Intrinsics.checkNotNullParameter(inflater, "inflater");
        rd rdVarInflate = rd.inflate(inflater, container, false);
        Intrinsics.checkNotNullExpressionValue(rdVarInflate, "inflate(inflater, container, false)");
        return rdVarInflate;
    }
}
