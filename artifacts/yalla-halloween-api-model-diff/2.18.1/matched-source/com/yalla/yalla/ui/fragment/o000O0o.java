...
public final class o000O0o extends Lambda implements Function1<ApiResult<String>, Unit> {
    ...
    public final /* synthetic */ RoomThemeMineFragment f24506Oooo0o;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o000O0o(RoomThemeMineFragment roomThemeMineFragment) {
        super(1);
        this.f24506Oooo0o = roomThemeMineFragment;
    }
    ...
    public final Unit invoke(ApiResult<String> apiResult) {
        ...
        RoomThemeMineActivity activity = this.f24506Oooo0o.getActivity();
        if (activity != null) {
            activity.OooOoO();
        }
