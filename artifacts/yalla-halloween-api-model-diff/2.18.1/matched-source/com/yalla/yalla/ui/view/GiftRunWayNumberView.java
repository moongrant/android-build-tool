...
public final class GiftRunWayNumberView extends LinearLayout {
    ...
    public final void setNumber(@Nullable String string) {
        ...
        while (i < length) {
            if (i == 0) {
                imageView = this.f24813Oooo0o.f50827OooO0O0;
            } else if (i != 1) {
                imageView = i != 2 ? null : this.f24813Oooo0o.f50829OooO0Oo;
            } else {
                imageView = this.f24813Oooo0o.f50828OooO0OO;
            }
            if (imageView != null) {
    ...
    public GiftRunWayNumberView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        vi viVarInflate = vi.inflate(LayoutInflater.from(context), this, true);
        Intrinsics.checkNotNullExpressionValue(viVarInflate, "inflate(LayoutInflater.from(context), this, true)");
        this.f24813Oooo0o = viVarInflate;
    }
}
