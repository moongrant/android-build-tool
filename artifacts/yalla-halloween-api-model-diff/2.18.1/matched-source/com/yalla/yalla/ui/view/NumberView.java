...
public final class NumberView extends AppCompatImageView {
    ...
    public final void OooO0OO() {
        ...
        if (i3 == 1) {
            i = NumberSize.f25022OooO0O0[i2];
        } else if (i3 == 2) {
            i = NumberSize.f25023OooO0OO[i2];
        } else if (i3 == 3) {
            i = NumberSize.f25024OooO0Oo[i2];
        } else if (i3 != 4) {
            i = i3 != 5 ? NumberSize.f25023OooO0OO[i2] : NumberSize.f25025OooO0o[i2];
        } else {
            i = NumberSize.f25026OooO0o0[i2];
        }
        setDataRes(i);
    }
    ...
    public NumberView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, o0O0OO0.NumberView);
        this.size = NumberSize.f25021OooO00o.OooO00o(Integer.valueOf(typedArrayObtainStyledAttributes.getInteger(1, 2)));
        this.f25027Oooo = typedArrayObtainStyledAttributes.getInteger(0, 0);
