...
public final class AccountProtectionVM extends o00OO.OooO00o {
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f25261Oooo0o;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                o000 o000Var = o000.f42171OooO00o;
                this.f25261Oooo0o = 1;
                if (o000Var.OooO00o(this) == coroutine_suspended) {
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<LiveDataScope<ApiResult<List<TrustedDevice>>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public int f25262Oooo0o;

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public /* synthetic */ Object f25263Oooo0oO;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f25262Oooo0o;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f25263Oooo0oO;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            ResultKt.throwOnFailure(obj);
            liveDataScope = (LiveDataScope) this.f25263Oooo0oO;
            this.f25263Oooo0oO = liveDataScope;
            this.f25262Oooo0o = 1;
            p480o0o000.OooO0OO oooO0OO = p480o0o000.OooO0OO.f40754OooO00o;
            String str = p480o0o000.OooO0OO.f40757OooO0Oo;
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<LiveDataScope<ApiResult<String>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public int f25264Oooo0o;

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public /* synthetic */ Object f25265Oooo0oO;

        /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
        public final /* synthetic */ int f25266Oooo0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(int i, Continuation<? super OooO0OO> continuation) {
            super(2, continuation);
            this.f25266Oooo0oo = i;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0OO oooO0OO = new OooO0OO(this.f25266Oooo0oo, continuation);
            oooO0OO.f25265Oooo0oO = obj;
            return oooO0OO;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            LiveDataScope liveDataScope;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f25264Oooo0o;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f25265Oooo0oO;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            ResultKt.throwOnFailure(obj);
            liveDataScope = (LiveDataScope) this.f25265Oooo0oO;
            int i2 = this.f25266Oooo0oo;
            this.f25265Oooo0oO = liveDataScope;
            this.f25264Oooo0o = 1;
            p480o0o000.OooO0OO oooO0OO = p480o0o000.OooO0OO.f40754OooO00o;
            String str = p480o0o000.OooO0OO.f40759OooO0o0;
            o00O000o o00o000oOooO0O0 = com.app.base.app.appConfig.apiDataModela.OooO00o.OooO0O0(str, "url", str, 1);
            o00o000oOooO0O0.OooO0O0("isOpenProtected", Boxing.boxInt(i2));
            obj = o0000O0.OooO0OO(new AccountRepo$switchUserDevice$$inlined$call$1(o00o000oOooO0O0, null), this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f25265Oooo0oO = null;
            this.f25264Oooo0o = 2;
            if (liveDataScope.emit(obj, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
