...
public final class TypeReference implements KType {
    ...
    public String toString() {
        return OooO.OooO00o(new StringBuilder(), asString(false), Reflection.REFLECTION_NOT_AVAILABLE);
    }
    ...
    public final String asString(KTypeProjection kTypeProjection) {
        ...
        if (i == 2) {
            return OooOo00.OooO0Oo("in ", strValueOf);
        }
        if (i == 3) {
            return OooOo00.OooO0Oo("out ", strValueOf);
        }
