...
public abstract class AbstractTypeParameterDescriptor extends DeclarationDescriptorNonRootImpl implements TypeParameterDescriptor {
    ...
    public class TypeParameterTypeConstructor extends AbstractTypeConstructor {
        ...
        public void reportSupertypeLoopError(@NotNull KotlinType kotlinType) {
            ...
            this.this$0.mo1793reportSupertypeLoopError(kotlinType);
        }
            ...
            public SimpleType invoke() {
                return KotlinTypeFactory.simpleTypeWithNonTrivialMemberScope(TypeAttributes.Companion.getEmpty(), AbstractTypeParameterDescriptor.this.getTypeConstructor(), Collections.emptyList(), false, new LazyScopeAdapter(new Function0<MemberScope>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeParameterDescriptor.2.1
                    ...
                    public MemberScope invoke() {
                        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("Scope for type parameter ");
                        sbOooO0o0.append(name.asString());
                        return TypeIntersectionScope.create(sbOooO0o0.toString(), AbstractTypeParameterDescriptor.this.getUpperBounds());
                    }
                }));
            }
        });
    ...
    public List<KotlinType> getUpperBounds() {
        List<KotlinType> listMo1791getSupertypes = ((TypeParameterTypeConstructor) getTypeConstructor()).mo1791getSupertypes();
        if (listMo1791getSupertypes == null) {
            $$$reportNull$$$0(8);
        }
        return listMo1791getSupertypes;
    }
    ...
    public abstract void mo1793reportSupertypeLoopError(@NotNull KotlinType kotlinType);
