...
public class LockBasedStorageManager implements StorageManager {
    ...
    public <K, V> RecursionDetectedResult<V> recursionDetectedDefault(@NotNull String str, K k) {
        ...
        StringBuilder sbOooO00o = Oooo0.OooO00o("Recursion detected ", str);
        if (k == null) {
            str2 = "";
        } else {
            str2 = "on input: " + k;
        ...
        sbOooO00o.append(" under ");
        sbOooO00o.append(this);
        throw ((AssertionError) sanitizeStackTrace(new AssertionError(sbOooO00o.toString())));
    }
    ...
    public String toString() {
        ...
        sb.append(" (");
        return OooO.OooO00o(sb, this.debugText, ")");
    }
