...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m2040catch(@NotNull Flow<? extends T> flow, @NotNull Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt__ErrorsKt.m2047catch(flow, function3);
    }
    ...
    public static final <T> Flow<T> m2041debounceHG0u8IE(@NotNull Flow<? extends T> flow, long j) {
        return FlowKt__DelayKt.m2043debounceHG0u8IE(flow, j);
    }
    ...
    public static final <T> Flow<T> m2042sampleHG0u8IE(@NotNull Flow<? extends T> flow, long j) {
        return FlowKt__DelayKt.m2044sampleHG0u8IE(flow, j);
    }
