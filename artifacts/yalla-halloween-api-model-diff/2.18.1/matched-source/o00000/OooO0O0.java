...
import p220o00oO0o.o0OOO0o;
import p220o00oO0o.o0ooOOo;
import p263o00ooo.o000O0;
import p263o00ooo.o000OO0O;
import p708oo000o.OooOOO0;
import p708oo000o.OooOOOO;
import p708oo000o.o00Oo0;
import p708oo000o.o0OO00O;
...
public final class OooO0O0 {
    ...
    public static final o000OO0O OooO00o(@DrawableRes int i, @Nullable oOO00O ooo00o) {
        ...
        if (charSequence != null && StringsKt__StringsKt.endsWith$default(charSequence, ".xml", false, 2, (Object) null)) {
            ...
            OooO00o oooO00o = (OooO00o) ooo00o.OooOO0o(o0O0O00.f6592OooO0OO);
            OooO00o.OooO0O0 key = new OooO00o.OooO0O0(theme2, i);
            Objects.requireNonNull(oooO00o);
            String str = "key";
            Intrinsics.checkNotNullParameter(key, "key");
            WeakReference<OooO00o.C0278OooO00o> weakReference = oooO00o.f26570OooO00o.get(key);
            ...
            if (imageVectorEntry == null) {
                ...
                TypedArray typedArray = o0ooooo2.OooO0o0(res, theme2, attrs, o0OOO0o.f33676OooO00o);
                String str2 = "typedArray";
                Intrinsics.checkNotNullParameter(typedArray, "typedArray");
                Intrinsics.checkNotNullParameter("autoMirrored", "attrName");
                boolean zOooO00o = o00oO0o.OooO00o(typedArray, o0ooooo2.f33680OooO00o, "autoMirrored", 5, false);
                ...
                if (typedArray.hasValue(1)) {
                    ...
                    if (typedValue2.type == 2) {
                        ...
                        jOooO0O0 = o00000O0.f32062OooO;
                    } else {
                        Intrinsics.checkNotNullParameter(typedArray, "typedArray");
                        Intrinsics.checkNotNullParameter("tint", "attrName");
                        ColorStateList colorStateListOooO0OO = o00oO0o.OooO0OO(typedArray, o0ooooo2.f33680OooO00o, theme2);
                        o0ooooo2.OooO0o(typedArray.getChangingConfigurations());
                ...
                while (true) {
                    ...
                    if (parser.getEventType() == 1 || (parser.getDepth() < 1 && parser.getEventType() == i7)) {
                        String str3 = str;
                        builder.OooO0Oo();
                        while (builder.f53104OooO.size() > 1) {
                            builder.OooO0OO();
                        }
                        OooOOO0 oooOOO0 = new OooOOO0(builder.f53105OooO00o, builder.f53106OooO0O0, builder.f53107OooO0OO, builder.f53108OooO0Oo, builder.f53110OooO0o0, builder.OooO0O0(builder.f53113OooOO0), builder.f53109OooO0o, builder.f53111OooO0oO, builder.f53112OooO0oo);
                        builder.f53114OooOO0O = true;
                        imageVectorEntry = new OooO00o.C0278OooO00o(oooOOO0, o0ooooo2.f33681OooO0O0);
                        Intrinsics.checkNotNullParameter(key, str3);
                        Intrinsics.checkNotNullParameter(imageVectorEntry, "imageVectorEntry");
                        oooO00o.f26570OooO00o.put(key, new WeakReference<>(imageVectorEntry));
                    } else {
                        Intrinsics.checkNotNullParameter(o0ooooo2, "<this>");
                        Intrinsics.checkNotNullParameter(res, "res");
                        Intrinsics.checkNotNullParameter(attrs, "attrs");
                        Intrinsics.checkNotNullParameter(builder, "builder");
                        int eventType = o0ooooo2.f33680OooO00o.getEventType();
                        String str4 = str;
                        XmlResourceParser xmlResourceParser = parser;
                        if (eventType == 2) {
                            String name = o0ooooo2.f33680OooO00o.getName();
                            if (name != null) {
                                ...
                                if (iHashCode != -1649314686) {
                                    ...
                                    if (iHashCode != 3433509) {
                                        if (iHashCode == 98629247 && name.equals("group")) {
                                            ...
                                            Intrinsics.checkNotNullParameter(attrs, "attrs");
                                            Intrinsics.checkNotNullParameter(builder, "builder");
                                            TypedArray typedArrayOooO0o0 = o0ooooo2.OooO0o0(res, theme3, attrs, o0OOO0o.f33677OooO0O0);
                                            ...
                                            builder.OooO00o(str5, fOooO0O2, f3, f4, fOooO0O3, fOooO0O4, fOooO0O5, fOooO0O6, o00Oo0.f53217OooO00o);
                                        }
                                        ...
                                        Intrinsics.checkNotNullParameter(attrs, "attrs");
                                        Intrinsics.checkNotNullParameter(builder, "builder");
                                        TypedArray typedArrayOooO0o1 = o0ooooo2.OooO0o0(res, theme3, attrs, o0OOO0o.f33678OooO0OO);
                                        if (!o00oO0o.OooO(o0ooooo2.f33680OooO00o, "pathData")) {
                                        ...
                                        if (iOooO0OO3 != 0) {
                                            ...
                                            o0Oo0oo o0oo0ooOooO00o = p220o00oO0o.o0Oo0oo.OooO00o(o000ooooOooO00o);
                                            o0Oo0oo o0oo0ooOooO00o2 = p220o00oO0o.o0Oo0oo.OooO00o(o000ooooOooO00o2);
                                            if (iOooO0OO2 == 0) {
                                                i6 = 0;
                                            } else {
                                                i6 = 1;
                                            ...
                                            builder.OooO0Oo();
                                            ArrayList<OooOOO0.OooO00o.C0436OooO00o> arrayList = builder.f53104OooO;
                                            arrayList.get(arrayList.size() - 1).f53124OooOO0.add(new o0OO00O(name2, pathData, i6, o0oo0ooOooO00o, fOooO0O7, o0oo0ooOooO00o2, fOooO0O9, fOooO0O10, i4, i5, fOooO0O8, fOooO0O13, fOooO0O11, fOooO0O12, null));
                                        }
                                        i4 = 0;
                                        iOooO0OO = o0ooooo2.OooO0OO(typedArrayOooO0o1, "strokeLineJoin", 9, -1);
                                        if (iOooO0OO != 0) {
                                        ...
                                        iOooO0OO2 = o0ooooo2.OooO0OO(typedArrayOooO0o1, "fillType", 13, 0);
                                        typedArrayOooO0o1.recycle();
                                        o0Oo0oo o0oo0ooOooO00o3 = p220o00oO0o.o0Oo0oo.OooO00o(o000ooooOooO00o);
                                        o0Oo0oo o0oo0ooOooO00o4 = p220o00oO0o.o0Oo0oo.OooO00o(o000ooooOooO00o3);
                                        if (iOooO0OO2 == 0) {
                                            i6 = 0;
                                        } else {
                                            i6 = 1;
                                        ...
                                        Intrinsics.checkNotNullParameter(name2, "name");
                                        builder.OooO0Oo();
                                        ArrayList<OooOOO0.OooO00o.C0436OooO00o> arrayList2 = builder.f53104OooO;
                                        arrayList2.get(arrayList2.size() - 1).f53124OooOO0.add(new o0OO00O(name2, pathData, i6, o0oo0ooOooO00o3, fOooO0O7, o0oo0ooOooO00o4, fOooO0O15, fOooO0O16, i4, i5, fOooO0O14, fOooO0O19, fOooO0O17, fOooO0O18, null));
                                    }
                                } else {
                                    theme = theme2;
                                    str2 = str2;
                                    ...
                                    if (name.equals("clip-path")) {
                                        ...
                                        Intrinsics.checkNotNullParameter(builder, "builder");
                                        theme2 = theme;
                                        TypedArray typedArrayOooO0o2 = o0ooooo2.OooO0o0(res, theme2, attrs, o0OOO0o.f33679OooO0Oo);
                            ...
                            i9 = i3;
                        } else if (eventType == i7 && Intrinsics.areEqual("group", o0ooooo2.f33680OooO00o.getName())) {
                            int i10 = i9 + 1;
            ...
            OooOOO0 image = imageVectorEntry.f26571OooO00o;
            ooo00o.Oooo0o0();
            Intrinsics.checkNotNullParameter(image, "image");
            ooo00o.OooO0o0(1413834416);
            float f5 = image.f53097OooO0O0;
            float f6 = image.f53098OooO0OO;
            float f7 = image.f53099OooO0Oo;
            float f8 = image.f53101OooO0o0;
            String str7 = image.f53096OooO00o;
            long j2 = image.f53102OooO0oO;
            int i12 = image.f53103OooO0oo;
            boolean z = image.f53095OooO;
            o000OOo0 content = o00O0000.OooO00o(ooo00o, 1873274766, new p708oo000o.o0Oo0oo(image));
            ...
            Object o00oo0o2 = new p145o00Oo0.o00oO0o(i12);
            ...
            if (zOooo0oo || objOooO0o2 == oOO00O.OooO00o.f29689OooO0O0) {
                o00000O0.OooO00o oooO00o5 = o00000O0.f32063OooO0O0;
                Object o00000o = o00000O0.OooO0Oo(j2, o00000O0.f32062OooO) ? null : new o00000O(Build.VERSION.SDK_INT >= 29 ? p145o00Oo0.o0ooOOo.f32150OooO00o.OooO00o(j2, i12) : new PorterDuffColorFilter(o00000OO.OooO0oO(j2), p145o00Oo0.OooOOO0.OooO0O0(i12)));
            ...
            if (objOooO0o3 == oOO00O.OooO00o.f29689OooO0O0) {
                objOooO0o3 = new p708oo000o.o00oO0o();
                ooo00o.Oooo00o(objOooO0o3);
            }
            ooo00o.Oooo0o0();
            p708oo000o.o00oO0o o00oo0o3 = (p708oo000o.o00oO0o) objOooO0o3;
            o00oo0o3.f53219OoooO0.setValue(new OooOo00(OooOo.OooO00o(fOoooOoo, fOoooOoo2)));
            o00oo0o3.f53220OoooO0O.setValue(Boolean.valueOf(z));
            o00oo0o3.f53218OoooO.f53198OooO0o.setValue(o00000o2);
            ...
            if (zOooo0oo2 || objOooO0o4 == obj) {
                Intrinsics.checkNotNullExpressionValue(res, "res");
                try {
                    Intrinsics.checkNotNullParameter(o0000oo.OooO00o.f32079OooO00o, "<this>");
                    Intrinsics.checkNotNullParameter(res, "res");
                    ...
                    objOooO0o4 = new p145o00Oo0.OooOo00(bitmap);
