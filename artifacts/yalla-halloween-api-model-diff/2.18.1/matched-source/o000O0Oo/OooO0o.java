...
public final class OooO0o {
    ...
    public static final C0297OooO0o f28154OooO00o = new C0297OooO0o(null, false);

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final C0297OooO0o f28155OooO0O0 = new C0297OooO0o(null, true);

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final C0297OooO0o f28156OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public static final C0297OooO0o f28157OooO0Oo;

    public static class OooO00o implements OooO0O0 {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public static final OooO00o f28158OooO00o = new OooO00o();
        ...
        public final int OooO00o(CharSequence charSequence, int i) {
            ...
            for (int i4 = 0; i4 < i2 && i3 == 2; i4++) {
                ...
                C0297OooO0o c0297OooO0o = OooO0o.f28154OooO00o;
                if (directionality == 0) {
                    i3 = 1;
    ...
    public static abstract class OooO0OO implements o000O0Oo.OooO0OO {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final OooO0O0 f28159OooO00o;

        public OooO0OO(OooO0O0 oooO0O0) {
            this.f28159OooO00o = oooO0O0;
        }
        ...
        public final boolean OooO0O0(CharSequence charSequence, int i) {
            ...
            OooO0O0 oooO0O0 = this.f28159OooO00o;
            if (oooO0O0 == null) {
                return OooO00o();
            }
    ...
    public static class C0297OooO0o extends OooO0OO {
        ...
        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final boolean f28160OooO0O0;

        public C0297OooO0o(OooO0O0 oooO0O0, boolean z) {
            super(oooO0O0);
            this.f28160OooO0O0 = z;
        }

        @Override // o000O0Oo.OooO0o.OooO0OO
        public final boolean OooO00o() {
            return this.f28160OooO0O0;
        }
    }

    static {
        OooO00o oooO00o = OooO00o.f28158OooO00o;
        f28156OooO0OO = new C0297OooO0o(oooO00o, false);
        f28157OooO0Oo = new C0297OooO0o(oooO00o, true);
    }
}
