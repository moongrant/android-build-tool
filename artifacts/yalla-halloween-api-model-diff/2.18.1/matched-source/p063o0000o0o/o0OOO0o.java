...
public final class o0OOO0o {
    ...
    public static /* synthetic */ class OooO00o {
        ...
        public static final /* synthetic */ int[] f27906OooO00o;
        ...
        static {
            ...
            try {
                f27906OooO00o[ConstraintAttribute.AttributeType.FLOAT_TYPE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f27906OooO00o[ConstraintAttribute.AttributeType.COLOR_DRAWABLE_TYPE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f27906OooO00o[ConstraintAttribute.AttributeType.COLOR_TYPE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f27906OooO00o[ConstraintAttribute.AttributeType.STRING_TYPE.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f27906OooO00o[ConstraintAttribute.AttributeType.BOOLEAN_TYPE.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f27906OooO00o[ConstraintAttribute.AttributeType.DIMENSION_TYPE.ordinal()] = 7;
    ...
    public static void OooO0O0(ConstraintAttribute constraintAttribute, View view, float[] fArr) {
        ...
        sbOooO0o0.append(constraintAttribute.f7481OooO0O0);
        String string = sbOooO0o0.toString();
        try {
            boolean z = true;
            switch (OooO00o.f27906OooO00o[constraintAttribute.f7482OooO0OO.ordinal()]) {
                case 1:
                ...
                case 4:
                    ...
                    return;
                case 5:
                    throw new RuntimeException("unable to interpolate strings " + constraintAttribute.f7481OooO0O0);
                case 6:
            ...
            StringBuilder sbOooO0OO = OooO0o.OooO0OO("cannot access method ", string, " on View \"");
            sbOooO0OO.append(OooO.OooO0Oo(view));
            sbOooO0OO.append("\"");
            Log.e("CustomSupport", sbOooO0OO.toString());
            e.printStackTrace();
        } catch (NoSuchMethodException e2) {
            StringBuilder sbOooO0OO2 = OooO0o.OooO0OO("no method ", string, " on View \"");
            sbOooO0OO2.append(OooO.OooO0Oo(view));
            sbOooO0OO2.append("\"");
            Log.e("CustomSupport", sbOooO0OO2.toString());
            e2.printStackTrace();
