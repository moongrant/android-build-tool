...
import p538o0o0Oo0.o0O0OO0;
import p558o0oOOoo.o00OO;
import p579o0oOoOOo.ooOOO0Oo;
import p617o0oo0o.o00O00;
import p617o0oo0o.o00O00O;
...
public final /* synthetic */ class o0OOO0o implements Observer {
    ...
    public final /* synthetic */ int f31974OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final /* synthetic */ Object f31975OooO0O0;

    public /* synthetic */ o0OOO0o(Object obj, int i) {
        this.f31974OooO00o = i;
        this.f31975OooO0O0 = obj;
    }
    ...
    public final void onChanged(Object obj) {
        ...
        List<T> list;
        switch (this.f31974OooO00o) {
            case 0:
                MainMomentFollowingFragment.m11initObserver$lambda1((MainMomentFollowingFragment) this.f31975OooO0O0, (MomentDetailModel) obj);
                break;
            case 1:
                boolean z = true;
                RoomInfoProfileFragment this$0 = (RoomInfoProfileFragment) this.f31975OooO0O0;
                Intrinsics.checkNotNullParameter(this$0, "this$0");
                this$0.getLoadingVM().f48285OooO00o.f45559OooO00o.setValue(Boolean.FALSE);
            ...
            case 2:
                boolean z2 = true;
                DeleteAccountCheckActivity activity = (DeleteAccountCheckActivity) this.f31975OooO0O0;
                ...
                break;
            case 3:
                TaskActivity this$1 = (TaskActivity) this.f31975OooO0O0;
                ApiResult apiResult = (ApiResult) obj;
                Intrinsics.checkNotNullParameter(this$1, "this$0");
                if (apiResult.isSuccess()) {
                    TaskActivity.OooO00o oooO00o2 = TaskActivity.f22061o00Oo0;
                    this$1.OooOooO().f49075OooO0Oo.postDelayed(new OooOO0(this$1, 1), 1000L);
                } else {
                    ((o0000O) this$1.f22073o0OoOo0.getValue()).dismiss();
                ...
                break;
            case 4:
                PostDetailActivity this$2 = (PostDetailActivity) this.f31975OooO0O0;
                ...
                break;
            case 5:
                TopicDetailActivity this$3 = (TopicDetailActivity) this.f31975OooO0O0;
                Response response2 = (Response) obj;
                TopicDetailActivity.OooO00o oooO00o4 = TopicDetailActivity.f22567o0OoOo0;
                ...
                if (!response2.getIsSuccess()) {
                    ...
                    if (code2 != null && code2.intValue() == 4006) {
                        HeaderLayout headerLayout = this$3.f11463OoooO;
                        if (headerLayout != null) {
                            headerLayout.OooOoOO(0, o0O0OO0.f44012Oooo0o);
                        }
                        CoordinatorLayout coordinatorLayout = this$3.OooOooo().f51077OooO0OO;
                        Intrinsics.checkNotNullExpressionValue(coordinatorLayout, "binding.clTopics");
                        oOO00O.OooO00o(coordinatorLayout);
                        ImageView imageView = this$3.OooOooo().f51079OooO0o;
                        Intrinsics.checkNotNullExpressionValue(imageView, "binding.ivCreate");
                        oOO00O.OooO00o(imageView);
                        LinearLayout linearLayout = this$3.OooOooo().f51078OooO0Oo.f50992OooO00o;
                ...
                break;
            case 6:
                ExploreTagRoomListActivity this$4 = (ExploreTagRoomListActivity) this.f31975OooO0O0;
                ExploreTagRoomListActivity.OooO00o oooO00o5 = ExploreTagRoomListActivity.f22818Ooooooo;
                ...
                this$4.f22820Ooooo00.clear();
                this$4.f22821Ooooo0o.clear();
                this$4.f22822OooooO0.clear();
                if (listAsMutableList.size() > 0) {
                    int size = listAsMutableList.size();
                    i = 0;
                    int i3 = 0;
                    while (i3 < size) {
                        int i4 = this$4.f22824OooooOo;
                        ...
                        List<String> list2 = this$4.f22821Ooooo0o;
                        if (oo000o.OooO0o0()) {
                            sbOooO00o = new StringBuilder();
                            sbOooO00o.append(((CategoryModel) listAsMutableList.get(i3)).labelname);
                            sbOooO00o.append('#');
                        } else {
                            sbOooO00o = o00O0O0O.OooO00o('#');
                            sbOooO00o.append(((CategoryModel) listAsMutableList.get(i3)).labelname);
                        }
                        list2.add(sbOooO00o.toString());
                        try {
                            Result.Companion companion = Result.INSTANCE;
                            List<Fragment> list3 = this$4.f22822OooooO0;
                    ...
                    ConstraintLayout constraintLayout = this$4.OooOoo().f49444OooO0Oo;
                    Intrinsics.checkNotNullExpressionValue(constraintLayout, "binding.topLayout");
                    o00O0O.OooO(constraintLayout);
                    this$4.f22820Ooooo00.addAll(listAsMutableList);
                } else {
                    ConstraintLayout constraintLayout2 = this$4.OooOoo().f49444OooO0Oo;
                    Intrinsics.checkNotNullExpressionValue(constraintLayout2, "binding.topLayout");
                    o00O0O.OooO00o(constraintLayout2);
                    i = 0;
                }
                Context context = this$4.OooOoo().f49446OooO0o0.getContext();
                ...
                oooO00o6.OooO0O0(this$4.f22821Ooooo0o);
                oooO00o6.f32981OooO0o = o000O0O0.OooO00o(R.color.color_333333);
                oooO00o6.f32983OooO0oO = o000O0O0.OooO00o(R.color.color_999999);
                float f = 8;
                oooO00o6.f32995OooOo0 = OooOo00.OooO00o(f);
                oooO00o6.f32982OooO0o0 = 15.0f;
                oooO00o6.f32980OooO0Oo = 15.0f;
                oooO00o6.f32996OooOo00 = OooOo00.OooO00o(f);
                oooO00o6.f32983OooO0oO = o000O0O0.OooO00o(R.color.color_alpha_38_A3);
                ViewPager2 viewPager2 = this$4.OooOoo().f49446OooO0o0;
                Intrinsics.checkNotNullExpressionValue(viewPager2, "binding.vpMoreRoom");
                oooO00o6.OooO0Oo(viewPager2);
                oooO00o6.f32984OooO0oo = OooOo00.OooO00o(2);
                oooO00o6.f32976OooO = o000O0O0.OooO00o(R.color.color_00d8c9);
                oooO00o6.f32985OooOO0 = OooOo00.OooO00o(11);
                oooO00o6.f32986OooOO0O = OooOo00.OooO00o(3);
                oooO00o6.f32978OooO0O0.setAdjustMode(false);
                YlTableLayout ylTableLayout = this$4.OooOoo().f49445OooO0o;
                Intrinsics.checkNotNullExpressionValue(ylTableLayout, "binding.ylMoreRoom");
                oooO00o6.OooO00o(ylTableLayout);
                this$4.OooOoo().f49446OooO0o0.setOffscreenPageLimit(this$4.f22822OooooO0.size());
                this$4.OooOoo().f49446OooO0o0.setAdapter(this$4.f22826Oooooo0);
                this$4.OooOoo().f49446OooO0o0.setCurrentItem(i);
                break;
            case 7:
                o00OO.f44710OooO00o.OooO0O0(true, (MixedRoomActivity) this.f31975OooO0O0);
                break;
            case 8:
                SupportTopActivity this$5 = (SupportTopActivity) this.f31975OooO0O0;
                Response response3 = (Response) obj;
                SupportTopActivity.OooO00o oooO00o7 = SupportTopActivity.f23411OooooO0;
                ...
                if (response3.getIsSuccess() && response3.getData() != null) {
                    ...
                    if (supportInfo2 != null && (data = supportInfo2.getData()) != null) {
                        this$5.OooOoo().f50331OooO0Oo.setText("" + updateAt + " (GMT+2)");
                        OooO0OO<SupportInfo.UserData> oooO0OO = this$5.f23414Ooooo0o;
                        if (oooO0OO == null) {
                            Intrinsics.throwUninitializedPropertyAccessException("adapter");
                            oooO0OO = null;
                        }
                        oooO0OO.setNewData(data);
                        OooO0OO<SupportInfo.UserData> oooO0OO2 = this$5.f23414Ooooo0o;
                        if (oooO0OO2 == null) {
                            Intrinsics.throwUninitializedPropertyAccessException("adapter");
                            oooO0OO2 = null;
                        }
                        oooO0OO2.setLoadComplete();
                        this$5.OooOoo().f50329OooO0O0.Oooo0o0(true, true, true);
                        break;
                    }
                }
                break;
            case 9:
                ooOOO0Oo this$6 = (ooOOO0Oo) this.f31975OooO0O0;
                ...
                if (response4.getIsSuccess() && response4.getData() != null) {
                    ...
                    if (((List) data3).size() > 0) {
                        OooO0OO<TaskModel> oooO0OO3 = this$6.f46214Ooooo00;
                        if (oooO0OO3 == null) {
                            Intrinsics.throwUninitializedPropertyAccessException("adapter");
                            oooO0OO3 = null;
                        }
                        ...
                        o00O00O.f48556OooO00o = sparseArray;
                        ...
                        for (TaskModel taskModel : data5) {
                            if (taskModel.getState() < 2 || taskModel.isOneTime() != 1) {
                                SparseArray<TaskModel> sparseArray2 = o00O00O.f48556OooO00o;
                        ...
                        o00O00O.f48557OooO0O0 = arrayList;
                        SparseArray<TaskModel> sparseArray3 = o00O00O.f48556OooO00o;
                        if (sparseArray3 == null) {
                            Intrinsics.throwUninitializedPropertyAccessException("taskInfoSparseArray");
                            sparseArray3 = null;
                        }
                        arrayList.add(sparseArray3.get(37));
                        ArrayList<TaskModel> arrayList2 = o00O00O.f48557OooO0O0;
                        if (arrayList2 == null) {
                            Intrinsics.throwUninitializedPropertyAccessException("taskInfo");
                            arrayList2 = null;
                        }
                        SparseArray<TaskModel> sparseArray4 = o00O00O.f48556OooO00o;
                        if (sparseArray4 == null) {
                            Intrinsics.throwUninitializedPropertyAccessException("taskInfoSparseArray");
                            sparseArray4 = null;
                        }
                        arrayList2.add(sparseArray4.get(2));
                        ArrayList<TaskModel> arrayList3 = o00O00O.f48557OooO0O0;
                        if (arrayList3 == null) {
                            Intrinsics.throwUninitializedPropertyAccessException("taskInfo");
                            arrayList3 = null;
                        }
                        SparseArray<TaskModel> sparseArray5 = o00O00O.f48556OooO00o;
                        if (sparseArray5 == null) {
                            Intrinsics.throwUninitializedPropertyAccessException("taskInfoSparseArray");
                            sparseArray5 = null;
                        }
                        arrayList3.add(sparseArray5.get(12));
                        ArrayList<TaskModel> arrayList4 = o00O00O.f48557OooO0O0;
                        if (arrayList4 == null) {
                            Intrinsics.throwUninitializedPropertyAccessException("taskInfo");
                            arrayList4 = null;
                        }
                        SparseArray<TaskModel> sparseArray6 = o00O00O.f48556OooO00o;
                        if (sparseArray6 == null) {
                            Intrinsics.throwUninitializedPropertyAccessException("taskInfoSparseArray");
                            sparseArray6 = null;
                        }
                        arrayList4.add(sparseArray6.get(21));
                        ArrayList<TaskModel> arrayList5 = o00O00O.f48557OooO0O0;
                        if (arrayList5 == null) {
                            Intrinsics.throwUninitializedPropertyAccessException("taskInfo");
                            arrayList5 = null;
                        }
                        SparseArray<TaskModel> sparseArray7 = o00O00O.f48556OooO00o;
                        if (sparseArray7 == null) {
                            Intrinsics.throwUninitializedPropertyAccessException("taskInfoSparseArray");
                            sparseArray7 = null;
                        }
                        arrayList5.add(sparseArray7.get(26));
                        ArrayList<TaskModel> arrayList6 = o00O00O.f48557OooO0O0;
                        if (arrayList6 == null) {
                            Intrinsics.throwUninitializedPropertyAccessException("taskInfo");
                            arrayList6 = null;
                        }
                        SparseArray<TaskModel> sparseArray8 = o00O00O.f48556OooO00o;
                        if (sparseArray8 == null) {
                            Intrinsics.throwUninitializedPropertyAccessException("taskInfoSparseArray");
                            sparseArray8 = null;
                        }
                        arrayList6.add(sparseArray8.get(35));
                        ArrayList<TaskModel> arrayList7 = o00O00O.f48557OooO0O0;
                        if (arrayList7 == null) {
                            Intrinsics.throwUninitializedPropertyAccessException("taskInfo");
                            arrayList7 = null;
                        }
                        CollectionsKt.removeAll((List) arrayList7, (Function1) o00O00.f48548Oooo0o);
                        ArrayList<TaskModel> arrayList8 = o00O00O.f48557OooO0O0;
                        if (arrayList8 == null) {
                            Intrinsics.throwUninitializedPropertyAccessException("taskInfo");
                            arrayList8 = null;
                        }
                        oooO0OO3.setNewData(arrayList8);
                        OooO0OO<TaskModel> oooO0OO4 = this$6.f46214Ooooo00;
                        if (oooO0OO4 == null) {
                            Intrinsics.throwUninitializedPropertyAccessException("adapter");
                            oooO0OO4 = null;
                        }
                ...
                break;
            case 10:
                TreasureBoxDialog this$7 = (TreasureBoxDialog) this.f31975OooO0O0;
                Intrinsics.checkNotNullParameter(this$7, "this$0");
                this$7.OooOO0o();
                break;
            case 11:
                TopicPostPopularFragment.m417initObserve$lambda9((TopicPostPopularFragment) this.f31975OooO0O0, (Long) obj);
                break;
            default:
                Object obj2 = null;
                EventMineViewModel mineVM = (EventMineViewModel) this.f31975OooO0O0;
                Long l = (Long) obj;
                ...
                for (Object obj3 : mineEventPager.f48682OooO0Oo) {
                    if (l != null && ((EventModel) obj3).getId() == l.longValue()) {
                        ...
                        list = mineEventPager.f48682OooO0Oo;
                        if (eventModel == null) {
