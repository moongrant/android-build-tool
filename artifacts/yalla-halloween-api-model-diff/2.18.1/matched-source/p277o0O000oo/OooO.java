...
public final class OooO {
    ...
    @NotNull
    public static final OooO f35092OooO00o = new OooO();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @Nullable
    public static OooO0OO f35093OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @Nullable
    public static OooO0O0 f35094OooO0OO;
    ...
    public static final class OooO0O0 extends MutableLiveData<OooO0o> {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        @NotNull
        public WeakReference<Context> f35095OooO00o;

        public OooO0O0(@NotNull Context context) {
            Intrinsics.checkNotNullParameter(context, "context");
            this.f35095OooO00o = new WeakReference<>(null);
            this.f35095OooO00o = new WeakReference<>(context.getApplicationContext());
        }
        ...
        public final void observe(@NotNull LifecycleOwner owner, @NotNull Observer<? super OooO0o> observer) {
            ...
            if (!hasObservers() && (context = this.f35095OooO00o.get()) != null && (oooO0OO = OooO.f35093OooO0O0) != null) {
        ...
        public final void removeObserver(@NotNull Observer<? super OooO0o> observer) {
            ...
            try {
                connectivityManager.unregisterNetworkCallback((ConnectivityManager.NetworkCallback) oooO0OO.f35098OooO0O0.getValue());
    ...
    public static final void OooO00o(boolean z) {
        ...
        OooO oooO = f35092OooO00o;
        OooO0O0 oooO0O0 = f35094OooO0OO;
        if (oooO0O0 == null || (context = oooO0O0.f35095OooO00o.get()) == null) {
            return;
        }
        if (!z) {
    ...
    public final NetworkType OooO0Oo(int i, String str) {
        switch (i) {
            ...
            case 19:
            default:
                return (StringsKt.OooO(str, "TD-SCDMA") || StringsKt.OooO(str, "WCDMA") || StringsKt.OooO(str, "CDMA2000")) ? NetworkType.NETWORK_3G : NetworkType.NETWORK_UNKNOWN;
            case 20:
