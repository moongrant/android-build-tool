...
public final class o00O00OO {
    ...
    public static final Pattern f36632OooO00o = Pattern.compile("^(\\S+)\\s+-->\\s+(\\S+)(.*)?$");

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final Pattern f36633OooO0O0 = Pattern.compile("(\\S+?):(\\S+)");

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final Map<String, Integer> f36634OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public static final Map<String, Integer> f36635OooO0Oo;

    public static class OooO00o {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final OooO0O0 f36636OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final int f36637OooO0O0;

        public OooO00o(OooO0O0 oooO0O0, int i) {
            this.f36636OooO00o = oooO0O0;
            this.f36637OooO0O0 = i;
        }
    }
    ...
    public static final class OooO0O0 {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final String f36638OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final int f36639OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final String f36640OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final Set<String> f36641OooO0Oo;

        public OooO0O0(String str, int i, String str2, Set<String> set) {
            this.f36639OooO0O0 = i;
            this.f36638OooO00o = str;
            this.f36640OooO0OO = str2;
            this.f36641OooO0Oo = set;
        }
    }
    ...
    public static final class OooO0OO implements Comparable<OooO0OO> {
        ...
        public final int f36642Oooo0o;

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final WebvttCssStyle f36643Oooo0oO;

        public OooO0OO(int i, WebvttCssStyle webvttCssStyle) {
            this.f36642Oooo0o = i;
            this.f36643Oooo0oO = webvttCssStyle;
        }

        @Override // java.lang.Comparable
        public final int compareTo(OooO0OO oooO0OO) {
            return Integer.compare(this.f36642Oooo0o, oooO0OO.f36642Oooo0o);
        }
    }
    ...
    public static final class OooO0o {
        ...
        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public CharSequence f36647OooO0OO;

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public long f36645OooO00o = 0;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public long f36646OooO0O0 = 0;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f36648OooO0Oo = 2;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public float f36650OooO0o0 = -3.4028235E38f;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f36649OooO0o = 1;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public int f36651OooO0oO = 0;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public float f36652OooO0oo = -3.4028235E38f;

        /* JADX INFO: renamed from: OooO, reason: collision with root package name */
        public int f36644OooO = Integer.MIN_VALUE;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public float f36653OooOO0 = 1.0f;

        /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
        public int f36654OooOO0O = Integer.MIN_VALUE;
        ...
        public final Cue.OooO00o OooO00o() {
            ...
            float f = this.f36652OooO0oo;
            float f2 = -3.4028235E38f;
            if (f == -3.4028235E38f) {
                int i = this.f36648OooO0Oo;
                if (i != 4) {
                    f = i != 5 ? 0.5f : 1.0f;
                } else {
            ...
            int i2 = this.f36644OooO;
            if (i2 == Integer.MIN_VALUE) {
                int i3 = this.f36648OooO0Oo;
                if (i3 == 1) {
                    i2 = 0;
                } else if (i3 == 3) {
                    i2 = 2;
            ...
            if (i4 == 1) {
                ...
                o00O00O.OooO0OO.OooO0O0(34, "Unknown textAlignment: ", i4, "WebvttCueParser");
                alignment = null;
            } else {
                alignment = Layout.Alignment.ALIGN_OPPOSITE;
            }
            oooO00o.f14636OooO0OO = alignment;
            float f3 = this.f36650OooO0o0;
            int i5 = this.f36649OooO0o;
            ...
            oooO00o.f14637OooO0Oo = f2;
            oooO00o.f14639OooO0o0 = i5;
            oooO00o.f14638OooO0o = this.f36651OooO0oO;
            oooO00o.f14640OooO0oO = f;
            oooO00o.f14641OooO0oo = i2;
            float f4 = this.f36653OooOO0;
            if (i2 == 0) {
                f = 1.0f - f;
            } else if (i2 == 1) {
            ...
            oooO00o.f14643OooOO0O = Math.min(f4, f);
            oooO00o.f14647OooOOOO = this.f36654OooOO0O;
            CharSequence charSequence = this.f36647OooO0OO;
            if (charSequence != null) {
                oooO00o.f14634OooO00o = charSequence;
            }
            return oooO00o;
        }
    }
    ...
    static {
        ...
        f36634OooO0OO = Collections.unmodifiableMap(map);
        ...
        f36635OooO0Oo = Collections.unmodifiableMap(map2);
    }
    ...
    public static void OooO00o(@Nullable String str, OooO0O0 oooO0O0, List<OooO00o> list, SpannableStringBuilder spannableStringBuilder, List<WebvttCssStyle> list2) {
        byte b;
        int i = oooO0O0.f36639OooO0O0;
        int length = spannableStringBuilder.length();
        String str2 = oooO0O0.f36638OooO00o;
        ...
        switch (b) {
            ...
            case 1:
                ...
                break;
            case 2:
                for (String str3 : oooO0O0.f36641OooO0Oo) {
                    Map<String, Integer> map = f36634OooO0OO;
                    if (map.containsKey(str3)) {
                        spannableStringBuilder.setSpan(new ForegroundColorSpan(map.get(str3).intValue()), i, length, 33);
                    } else {
                        Map<String, Integer> map2 = f36635OooO0Oo;
            ...
            case 7:
                ...
                Collections.sort(arrayList, new Comparator() { // from class: o0O0oOOO.oOO00O
                    @Override // java.util.Comparator
                    public final int compare(Object obj, Object obj2) {
                        return Integer.compare(((o00O00OO.OooO00o) obj).f36636OooO00o.f36639OooO0O0, ((o00O00OO.OooO00o) obj2).f36636OooO00o.f36639OooO0O0);
                    }
                });
                int i2 = oooO0O0.f36639OooO0O0;
                int length2 = 0;
                for (int i3 = 0; i3 < arrayList.size(); i3++) {
                    if ("rt".equals(((OooO00o) arrayList.get(i3)).f36636OooO00o.f36638OooO00o)) {
                        OooO00o oooO00o = (OooO00o) arrayList.get(i3);
                        OooO0OO(list2, str, oooO00o.f36636OooO00o);
                        int i4 = oooO00o.f36636OooO00o.f36639OooO0O0 - length2;
                        int i5 = oooO00o.f36637OooO0O0 - length2;
        ...
        while (true) {
            ...
            WebvttCssStyle webvttCssStyle = ((OooO0OO) arrayList2.get(i6)).f36643Oooo0oO;
            if (webvttCssStyle != null) {
                if (webvttCssStyle.OooO00o() != -1) {
                    o00000O.OooO00o(spannableStringBuilder, new StyleSpan(webvttCssStyle.OooO00o()), i, length);
                }
                if (webvttCssStyle.f14688OooOO0 == 1) {
                    spannableStringBuilder.setSpan(new StrikethroughSpan(), i, length, 33);
                }
                if (webvttCssStyle.f14689OooOO0O == 1) {
                    spannableStringBuilder.setSpan(new UnderlineSpan(), i, length, 33);
                }
                if (webvttCssStyle.f14686OooO0oO) {
                    if (!webvttCssStyle.f14686OooO0oO) {
                        throw new IllegalStateException("Font color not defined");
                    }
                    o00000O.OooO00o(spannableStringBuilder, new ForegroundColorSpan(webvttCssStyle.f14684OooO0o), i, length);
                }
                if (webvttCssStyle.f14679OooO) {
                    if (!webvttCssStyle.f14679OooO) {
                        throw new IllegalStateException("Background color not defined.");
                    }
                    o00000O.OooO00o(spannableStringBuilder, new BackgroundColorSpan(webvttCssStyle.f14687OooO0oo), i, length);
                }
                if (webvttCssStyle.f14685OooO0o0 != null) {
                    o00000O.OooO00o(spannableStringBuilder, new TypefaceSpan(webvttCssStyle.f14685OooO0o0), i, length);
                }
                int i7 = webvttCssStyle.f14691OooOOO;
                if (i7 == 1) {
                    o00000O.OooO00o(spannableStringBuilder, new AbsoluteSizeSpan((int) ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, true), i, length);
                } else if (i7 == 2 || i7 == 3) {
                    o00000O.OooO00o(spannableStringBuilder, new RelativeSizeSpan(ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE), i, length);
                }
                if (webvttCssStyle.f14694OooOOOo) {
    ...
    public static List<OooO0OO> OooO0O0(List<WebvttCssStyle> list, @Nullable String str, OooO0O0 oooO0O0) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            String str2 = oooO0O0.f36638OooO00o;
            Set<String> set = oooO0O0.f36641OooO0Oo;
            String str3 = oooO0O0.f36640OooO0OO;
            if (webvttCssStyle.f14680OooO00o.isEmpty() && webvttCssStyle.f14681OooO0O0.isEmpty() && webvttCssStyle.f14682OooO0OO.isEmpty() && webvttCssStyle.f14683OooO0Oo.isEmpty()) {
                zIsEmpty = TextUtils.isEmpty(str2);
            } else {
                int iOooO0O0 = WebvttCssStyle.OooO0O0(WebvttCssStyle.OooO0O0(WebvttCssStyle.OooO0O0(0, webvttCssStyle.f14680OooO00o, str, 1073741824), webvttCssStyle.f14681OooO0O0, str2, 2), webvttCssStyle.f14683OooO0Oo, str3, 4);
                if (iOooO0O0 == -1 || !set.containsAll(webvttCssStyle.f14682OooO0OO)) {
                    r4 = 0;
                } else {
                    size = iOooO0O0 + (webvttCssStyle.f14682OooO0OO.size() * 4);
                }
            }
            if (r4 > 0) {
                r4 = size;
    ...
    public static int OooO0OO(List<WebvttCssStyle> list, @Nullable String str, OooO0O0 oooO0O0) {
        ...
        while (true) {
            ...
            int i2 = ((OooO0OO) arrayList.get(i)).f36643Oooo0oO.f14693OooOOOO;
            if (i2 != -1) {
                return i2;
            }
            i++;
    ...
    @Nullable
    public static o00O00O OooO0Oo(@Nullable String str, Matcher matcher, o000 o000Var, List<WebvttCssStyle> list) {
        OooO0o oooO0o = new OooO0o();
        try {
            String strGroup = matcher.group(1);
            Objects.requireNonNull(strGroup);
            oooO0o.f36645OooO00o = oo00o.OooO0O0(strGroup);
            String strGroup2 = matcher.group(2);
            Objects.requireNonNull(strGroup2);
            oooO0o.f36646OooO0O0 = oo00o.OooO0O0(strGroup2);
            ...
            while (!TextUtils.isEmpty(strOooO0o0)) {
                ...
                strOooO0o0 = o000Var.OooO0o0();
            }
            oooO0o.f36647OooO0OO = OooO0o(str, sb.toString(), list);
            return new o00O00O(oooO0o.OooO00o().OooO00o(), oooO0o.f36645OooO00o, oooO0o.f36646OooO0O0);
            ...
            if (cCharAt == '&') {
                ...
                if (length < str2.length()) {
                    ...
                    if (!strSubstring2.trim().isEmpty()) {
                        ...
                        p318o0O0oOo.o00000O0.OooO00o(!strTrim2.isEmpty());
                        ...
                        if (z) {
                            if (z2) {
                                while (!arrayDeque.isEmpty()) {
                                    ...
                                    if (oooO0O0.f36638OooO00o.equals(str3)) {
                                    }
                                }
                            } else if (!z3) {
                                int length2 = spannableStringBuilder.length();
                                String strTrim3 = strSubstring2.trim();
                                p318o0O0oOo.o00000O0.OooO00o(!strTrim3.isEmpty());
    ...
    public static void OooO0o0(String str, OooO0o oooO0o) {
        Matcher matcher = f36633OooO0O0.matcher(str);
        while (matcher.find()) {
            int i = 1;
            String strGroup = matcher.group(1);
            Objects.requireNonNull(strGroup);
            ...
            try {
                if ("line".equals(strGroup)) {
                    ...
                    oooO0o.f36648OooO0Oo = i;
                } else if ("position".equals(strGroup)) {
                    OooO0oo(strGroup2, oooO0o);
                } else if ("size".equals(strGroup)) {
                    oooO0o.f36653OooOO0 = oo00o.OooO00o(strGroup2);
    ...
    public static void OooO0oO(String str, OooO0o oooO0o) {
        ...
        if (iIndexOf != -1) {
            ...
            oooO0o.f36651OooO0oO = i;
            str = str.substring(0, iIndexOf);
        }
        if (str.endsWith("%")) {
            oooO0o.f36650OooO0o0 = oo00o.OooO00o(str);
            oooO0o.f36649OooO0o = 0;
        } else {
            oooO0o.f36650OooO0o0 = Integer.parseInt(str);
            oooO0o.f36649OooO0o = 1;
        }
    }
    ...
    public static void OooO0oo(String str, OooO0o oooO0o) {
        ...
        oooO0o.f36652OooO0oo = oo00o.OooO00o(str);
    }
}
