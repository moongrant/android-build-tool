...
public final class o000OOo0 {
    ...
    public static final String[] f36739OooO;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public static final int f36740OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final String f36741OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final String f36742OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public static final String f36743OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public static final byte[] f36744OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public static final String f36745OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    @Nullable
    public static HashMap<String, String> f36746OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public static final String[] f36747OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public static final int[] f36748OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public static final int[] f36749OooOO0O;
    ...
    public static int OooO0OO(o0000O0 o0000o1, long j) {
        int i = o0000o1.f36693OooO00o - 1;
        int i2 = 0;
        while (i2 <= i) {
            int i3 = (i2 + i) >>> 1;
            if (o0000o1.OooO0O0(i3) < j) {
                i2 = i3 + 1;
            } else {
                i = i3 - 1;
            }
        ...
        int i4 = i + 1;
        if (i4 < o0000o1.f36693OooO00o && o0000o1.OooO0O0(i4) == j) {
            return i4;
        }
        if (i == -1) {
            return 0;
    ...
    public static String OooOO0o(byte[] bArr) {
        return new String(bArr, OooO0o.f38232OooO0OO);
    }
    ...
    public static String OooOOO0(byte[] bArr, int i, int i2) {
        return new String(bArr, i, i2, OooO0o.f38232OooO0OO);
    }
    ...
    public static Point OooOOOO(Context context) {
        ...
        if (i <= 29 && defaultDisplay.getDisplayId() == 0 && OooOoOO(context)) {
            if ("Sony".equals(f36742OooO0OO) && f36743OooO0Oo.startsWith("BRAVIA") && context.getPackageManager().hasSystemFeature("com.sony.dtv.hardware.panel.qfhd")) {
    ...
    public static String OooOo(Context context) {
        ...
        return o00O0O.OooO0O0(sb, str2, ") ", "ExoPlayerLib/2.12.1");
    }
    ...
    public static String OooOo0o(String str) {
        try {
            ...
            o0000oo.OooO0O0("Util", str.length() != 0 ? "Failed to read system property ".concat(str) : new String("Failed to read system property "), e);
            return null;
        }
    }
    ...
    public static byte[] OooOoO0(String str) {
        return str.getBytes(OooO0o.f38232OooO0OO);
    }
    ...
    public static String OooOoo0(String str) {
        ...
        if (f36746OooO0oO == null) {
            String[] iSOLanguages = Locale.getISOLanguages();
            HashMap<String, String> map = new HashMap<>(iSOLanguages.length + f36747OooO0oo.length);
        ...
        String str4 = f36746OooO0oO.get(str2);
        if (str4 != null) {
    ...
    public static ComponentName Oooo00O(Context context, Intent intent) {
        return f36740OooO00o >= 26 ? context.startForegroundService(intent) : context.startService(intent);
    }
