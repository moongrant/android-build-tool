...
import p393o0OOooo0.o0ooOOo;
import p393o0OOooo0.oo000o;
...
public final class o0O00000 implements o0 {
    ...
    public static Context f38915OooO00o;
    ...
    public static void OooO0OO(String str) {
        if (f38915OooO00o == null) {
            return;
        }
        o00O00.OooO0O0("UmengEvent.onEvent(" + str + ")");
        MobclickAgent.onEvent(f38915OooO00o, str);
    }
    ...
    public static void OooO0o(String str, Map map, int i) {
        ...
        MobclickAgent.onEventValue(f38915OooO00o, str, map, i);
    }
    ...
    public o00000OO OooO00o(String str, BarcodeFormat barcodeFormat, Map map) {
        ...
        Collection<o0Oo0oo> collectionSingletonList = Collections.singletonList(o0Oo0oo.f38928OooO0o0);
        int i9 = 0;
        while (true) {
            byte[] bArr = o0ooooo2.f38937OooO00o;
            i = 32;
            int i10 = 4;
            int i11 = 2;
            i2 = 1;
            ...
            if (i6 > 0) {
                ...
                for (o0Oo0oo o0oo0oo3 : collectionSingletonList) {
                    char c = (char) (o0ooooo2.f38937OooO00o[i9] & UByte.MAX_VALUE);
                    boolean z2 = o0ooOOo.f38935OooO0Oo[o0oo0oo3.f38929OooO00o][c] > 0;
                    int i13 = 0;
                    o0Oo0oo o0oo0ooOooO0O1 = null;
                    while (i13 <= i10) {
                        int i14 = o0ooOOo.f38935OooO0Oo[i13][c];
                        if (i14 > 0) {
                            if (o0oo0ooOooO0O1 == null) {
                                o0oo0ooOooO0O1 = o0oo0oo3.OooO0O0(i9);
                            }
                            if (!z2 || i13 == o0oo0oo3.f38929OooO00o || i13 == i11) {
                                linkedList2.add(o0oo0ooOooO0O1.OooO0Oo(i13, i14));
                            }
                            if (!z2 && o0ooOOo.f38936OooO0o0[o0oo0oo3.f38929OooO00o][i13] >= 0) {
                    ...
                    if (o0oo0oo3.f38931OooO0OO > 0 || o0ooOOo.f38935OooO0Oo[o0oo0oo3.f38929OooO00o][c] == 0) {
        ...
        byte[] bArr2 = o0ooooo2.f38937OooO00o;
        Objects.requireNonNull(o0oo0oo4);
        LinkedList linkedList3 = new LinkedList();
        for (o0OO00O o0oo00o2 = o0oo0oo4.OooO0O0(bArr2.length).f38930OooO0O0; o0oo00o2 != null; o0oo00o2 = o0oo00o2.f38925OooO00o) {
        ...
        int i15 = o00000o.f38917Oooo0oO;
        int iOooO00o = com.app.base.protobuf.OooO00o.OooO00o(i7, i15, 100, 11);
        ...
        if (i8 != 0) {
            ...
            i3 = oo000o.f38938OooO00o[iAbs];
            int i17 = i4 - (i4 % i3);
            o00000oOooO0OO = oo000o.OooO0OO(o00000o, i3);
            int i18 = o00000oOooO0OO.f38917Oooo0oO;
            if (iOooO00o + i18 > i17) {
            ...
            while (true) {
                ...
                if (i16 <= i21) {
                    if (o00000oOooO0OO2 == null || i3 != oo000o.f38938OooO00o[i20]) {
                        int i22 = oo000o.f38938OooO00o[i20];
                        i3 = i22;
                        o00000oOooO0OO2 = oo000o.OooO0OO(o00000o, i22);
                    }
                    int i23 = i21 - (i21 % i3);
                    if ((!z3 || o00000oOooO0OO2.f38917Oooo0oO <= (i3 << 6)) && o00000oOooO0OO2.f38917Oooo0oO + iOooO00o <= i23) {
        ...
        int i24 = o00000oOooO0OO.f38917Oooo0oO / i3;
        ...
        int i51 = o00000oo2.f38919Oooo0o;
        int i52 = o00000oo2.f38920Oooo0oO;
