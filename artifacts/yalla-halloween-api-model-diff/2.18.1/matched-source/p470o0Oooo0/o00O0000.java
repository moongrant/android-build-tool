...
public final class o00O0000 {
    ...
    @Nullable
    public Function3<? super Boolean, ? super Integer, ? super View, Unit> f40622OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @Nullable
    public Function2<? super Boolean, ? super Integer, Unit> f40623OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @NotNull
    public final o00 f40624OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public int f40625OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public View f40626OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public boolean f40627OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    @NotNull
    public final o0O0o00O f40628OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    @NotNull
    public final EditText f40629OooO0oo;
    ...
    public static final class OooO00o extends Lambda implements Function1<Integer, Unit> {
        ...
        public final Unit invoke(Integer num) {
            o00O0000.this.f40628OooO0oO.OooO00o(num.intValue());
    ...
    public static final class OooO0O0 extends Lambda implements Function2<Boolean, Integer, Unit> {
        ...
        public final Unit invoke(Boolean bool, Integer num) {
            ...
            if (zBooleanValue) {
                o00O0000.this.f40628OooO0oO.OooO00o(iIntValue);
                o00O0000 o00o0001 = o00O0000.this;
                if (o00o0001.f40625OooO0Oo == 0 && (function2 = o00o0001.f40623OooO0O0) != null) {
                    function2.invoke(Boolean.TRUE, Integer.valueOf(iIntValue));
                }
                Function3<? super Boolean, ? super Integer, ? super View, Unit> function3 = o00O0000.this.f40622OooO00o;
                if (function3 != null) {
                    function3.invoke(Boolean.TRUE, Integer.valueOf(iIntValue), o00O0000.this.f40626OooO0o);
                }
                o00O0000.this.f40625OooO0Oo = 1;
            } else {
                o00O0000 o00o0002 = o00O0000.this;
                if (o00o0002.f40627OooO0o0) {
    ...
    public static final class OooO0OO implements View.OnClickListener {
        ...
        public final void onClick(View it) {
            o00O0000 o00o0001 = o00O0000.this;
            o00o0001.f40626OooO0o = it;
            int i = o00o0001.f40625OooO0Oo;
            if (i == 0) {
            ...
            if (i == 1) {
                o00o0001.f40627OooO0o0 = true;
                EditText editText = o00o0001.f40629OooO0oo;
            ...
            o00o0001.f40627OooO0o0 = false;
            EditText view = o00o0001.f40629OooO0oo;
    ...
    public o00O0000(@NotNull o0O0o00O panelView, @NotNull EditText editText) {
        Activity activity;
        Intrinsics.checkNotNullParameter(panelView, "panelView");
        Intrinsics.checkNotNullParameter(editText, "editText");
        this.f40628OooO0oO = panelView;
        this.f40629OooO0oo = editText;
        ...
        this.f40624OooO0OO = o00Var;
        o00Var.f40617OooO0Oo = new OooO00o();
        o00Var.f40619OooO0o0 = new OooO0O0();
    }

    public static final void OooO00o(o00O0000 o00o0001, int i) {
        Function2<? super Boolean, ? super Integer, Unit> function2;
        o00o0001.f40627OooO0o0 = false;
        if (o00o0001.f40625OooO0Oo != 1 && (function2 = o00o0001.f40623OooO0O0) != null) {
            function2.invoke(Boolean.TRUE, Integer.valueOf(i));
        }
        o00o0001.f40628OooO0oO.OooO0O0(i);
        o00o0001.f40625OooO0Oo = 2;
        Function3<? super Boolean, ? super Integer, ? super View, Unit> function3 = o00o0001.f40622OooO00o;
        if (function3 != null) {
            function3.invoke(Boolean.FALSE, Integer.valueOf(i), o00o0001.f40626OooO0o);
        }
    }
    ...
    public final void OooO0OO() {
        if (this.f40625OooO0Oo != 2) {
            EditText editText = this.f40629OooO0oo;
            o00O0O.OooO00o(editText, ViewHierarchyConstants.VIEW_KEY, "view.context").hideSoftInputFromWindow(editText.getWindowToken(), 0, new KeyBoardUtil$hideKeyboard$1(o000O0Oo.OooO00o(editText, "view.context"), new Handler()));
            return;
        }
        this.f40628OooO0oO.OooO0OO();
        this.f40625OooO0Oo = 0;
        Function2<? super Boolean, ? super Integer, Unit> function2 = this.f40623OooO0O0;
        if (function2 != null) {
            Boolean bool = Boolean.FALSE;
            Context context = this.f40629OooO0oo.getContext();
