...
public final /* synthetic */ class o000OO implements Observer {
    ...
    public final /* synthetic */ int f41470OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final /* synthetic */ Object f41471OooO0O0;

    public /* synthetic */ o000OO(Object obj, int i) {
        this.f41470OooO00o = i;
        this.f41471OooO0O0 = obj;
    }
    ...
    public final void onChanged(Object obj) {
        ...
        switch (this.f41470OooO00o) {
            case 0:
                o000 this$0 = (o000) this.f41471OooO0O0;
                Intrinsics.checkNotNullParameter(this$0, "this$0");
                this$0.OooOoo();
                break;
            case 1:
                SmsCodeActivity context = (SmsCodeActivity) this.f41471OooO0O0;
                ...
                break;
            case 2:
                ShareToFriendsActivity this$1 = (ShareToFriendsActivity) this.f41471OooO0O0;
                ...
                break;
            case 3:
                PurchaseLockRoomActivity this$2 = (PurchaseLockRoomActivity) this.f41471OooO0O0;
                PurchaseLockRoomActivity.OooO00o oooO00o2 = PurchaseLockRoomActivity.f22505OooooOO;
                Intrinsics.checkNotNullParameter(this$2, "this$0");
                this$2.OooOooO().f50603OooO0o.setText(o0O0O00.OooO0OO((Long) obj));
                break;
            case 4:
                UserPostListActivity this$3 = (UserPostListActivity) this.f41471OooO0O0;
                Long l = (Long) obj;
                ...
                break;
            case 5:
                VehicleMineActivity this$4 = (VehicleMineActivity) this.f41471OooO0O0;
                ...
                if (response.getIsSuccess() && (list = (List) response.getData()) != null) {
                    for (ShopVehicleListModel shopVehicleListModel : list) {
                        if (shopVehicleListModel.getIsSelected()) {
                            this$4.f23253OooooO0 = shopVehicleListModel.getShopId();
                        }
                    }
                    OooO0OO<ShopVehicleListModel> oooO0OO2 = this$4.f23252Ooooo0o;
                    if (oooO0OO2 == null) {
                ...
                OooO0OO<ShopVehicleListModel> oooO0OO3 = this$4.f23252Ooooo0o;
                if (oooO0OO3 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("mAdapter");
                } else {
                    oooO0OO = oooO0OO3;
                ...
                this$4.OooOoo().f50907OooO0OO.Oooo0o0(true, response.getIsSuccess(), response.getNoMoreData());
                this$4.OooOoO();
                break;
            case 6:
                MainRoomFragment.m450initObserver$lambda3((MainRoomFragment) this.f41471OooO0O0, obj);
                break;
            default:
                MomentEditVM.m494getEditHistory$lambda2$lambda1((MomentEditVM) this.f41471OooO0O0, (ApiResult) obj);
                break;
        }
    }
}
