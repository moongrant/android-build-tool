...
public final class o0OO extends Lambda implements Function1<ApiError, Unit> {
    ...
    public final /* synthetic */ o00000O0 f44026Oooo0o;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0OO(o00000O0 o00000o1) {
        super(1);
        this.f44026Oooo0o = o00000o1;
    }
    ...
    public final Unit invoke(ApiError apiError) {
        ...
        o00000O0 o00000o1 = this.f44026Oooo0o;
        Objects.requireNonNull(o00000o1);
        Intrinsics.checkNotNullParameter(errorText, "errorText");
        o00000o1.f31749OooO0O0.setValue(errorText);
        o00000o1.f31750OooO0OO.setValue(Boolean.TRUE);
        o00000o1.f31748OooO00o.setValue(Boolean.FALSE);
        o00000o1.f31751OooO0Oo.setValue("");
