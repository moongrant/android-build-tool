...
public final class o0000O {
    ...
    public static final class OooO0O0 extends Lambda implements Function1<OooO0OO.OooO00o, Boolean> {
        ...
        public final /* synthetic */ Function1<o0OO00O, Boolean> f53451Oooo;

        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ o0OO00O f53452Oooo0o;

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ o0OO00O f53453Oooo0oO;

        /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
        public final /* synthetic */ int f53454Oooo0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public OooO0O0(o0OO00O o0oo00o2, o0OO00O o0oo00o3, int i, Function1<? super o0OO00O, Boolean> function1) {
            super(1);
            this.f53452Oooo0o = o0oo00o2;
            this.f53453Oooo0oO = o0oo00o3;
            this.f53454Oooo0oo = i;
            this.f53451Oooo = function1;
        }
        ...
        public final Boolean invoke(OooO0OO.OooO00o oooO00o) {
            ...
            Boolean boolValueOf = Boolean.valueOf(o0000O.OooO0oO(this.f53452Oooo0o, this.f53453Oooo0oO, this.f53454Oooo0oo, this.f53451Oooo));
    ...
    public static final boolean OooO00o(OooOO0O oooOO0O, OooOO0O oooOO0O2, OooOO0O oooOO0O3, int i) {
        ...
        if (!OooO0O0(oooOO0O3, i, oooOO0O) && OooO0O0(oooOO0O2, i, oooOO0O)) {
            if (!(i == 3)) {
                if (!(i == 4)) {
                    if (!(i == 5)) {
                        ...
                        if (oooOO0O.f30407OooO0Oo <= oooOO0O3.f30405OooO0O0) {
                            z = true;
                        } else {
                            z = false;
                        }
                    } else if (oooOO0O.f30405OooO0O0 >= oooOO0O3.f30407OooO0Oo) {
                        z = true;
                    } else {
                        z = false;
                    }
                } else if (oooOO0O.f30406OooO0OO <= oooOO0O3.f30404OooO00o) {
                    z = true;
                } else {
                    z = false;
                }
            } else if (oooOO0O.f30404OooO00o >= oooOO0O3.f30406OooO0OO) {
                z = true;
            } else {
                z = false;
            }
            ...
            if (i == 3) {
                f3 = oooOO0O.f30404OooO00o;
                f4 = oooOO0O2.f30406OooO0OO;
            } else {
                if (i == 4) {
                    f = oooOO0O2.f30404OooO00o;
                    f2 = oooOO0O.f30406OooO0OO;
                } else {
                    if (i == 5) {
                        f3 = oooOO0O.f30405OooO0O0;
                        f4 = oooOO0O2.f30407OooO0Oo;
                    } else {
                        if (!(i == 6)) {
                            throw new IllegalStateException("This function should only be used for 2-D focus search".toString());
                        }
                        f = oooOO0O2.f30405OooO0O0;
                        f2 = oooOO0O.f30407OooO0Oo;
                    }
                }
                f5 = f - f2;
                ...
                if (z2) {
                    f8 = oooOO0O.f30404OooO00o;
                    f9 = oooOO0O3.f30404OooO00o;
                } else {
                    if (i == 4) {
                        z3 = true;
                    } else {
                    ...
                    if (z3) {
                        f6 = oooOO0O3.f30406OooO0OO;
                        f7 = oooOO0O.f30406OooO0OO;
                    } else {
                        if (i == 5) {
                            z4 = true;
                        } else {
                        ...
                        if (z4) {
                            f8 = oooOO0O.f30405OooO0O0;
                            f9 = oooOO0O3.f30405OooO0O0;
                        } else {
                            if (i == 6) {
                                z5 = true;
                            } else {
                            ...
                            f6 = oooOO0O3.f30407OooO0Oo;
                            f7 = oooOO0O.f30407OooO0Oo;
                        }
                    }
                    f10 = f6 - f7;
    ...
    public static final boolean OooO0O0(OooOO0O oooOO0O, int i, OooOO0O oooOO0O2) {
        if (!((i == 3) || i == 4)) {
            ...
            if (oooOO0O.f30406OooO0OO > oooOO0O2.f30404OooO00o && oooOO0O.f30404OooO00o < oooOO0O2.f30406OooO0OO) {
                return true;
            }
        } else if (oooOO0O.f30407OooO0Oo > oooOO0O2.f30405OooO0O0 && oooOO0O.f30405OooO0O0 < oooOO0O2.f30407OooO0Oo) {
            return true;
        }
        return false;
    }
    ...
    public static final o0OO00O OooO0OO(o000OOo<o0OO00O> o000ooo2, OooOO0O oooOO0O, int i) {
        ...
        if (i == 3) {
            oooOO0OOooO0OO = oooOO0O.OooO0OO((oooOO0O.f30406OooO0OO - oooOO0O.f30404OooO00o) + 1, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE);
        } else {
            if (i == 4) {
                oooOO0OOooO0OO = oooOO0O.OooO0OO(-((oooOO0O.f30406OooO0OO - oooOO0O.f30404OooO00o) + 1), ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE);
            } else {
                if (i == 5) {
                    oooOO0OOooO0OO = oooOO0O.OooO0OO(ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, (oooOO0O.f30407OooO0Oo - oooOO0O.f30405OooO0O0) + 1);
                } else {
                    if (!(i == 6)) {
                        throw new IllegalStateException("This function should only be used for 2-D focus search".toString());
                    }
    ...
    public static final long OooO0o(int i, OooOO0O oooOO0O, OooOO0O oooOO0O2) {
        ...
        if ((i == 3) || i == 4) {
            float f7 = oooOO0O.f30405OooO0O0;
            f3 = 2;
            f4 = ((oooOO0O.f30407OooO0Oo - f7) / f3) + f7;
            f5 = oooOO0O2.f30405OooO0O0;
            f6 = oooOO0O2.f30407OooO0Oo;
        } else {
            if (!(i == 5)) {
                z = i == 6;
            }
            ...
            float f8 = oooOO0O.f30404OooO00o;
            f3 = 2;
            f4 = ((oooOO0O.f30406OooO0OO - f8) / f3) + f8;
            f5 = oooOO0O2.f30404OooO00o;
            f6 = oooOO0O2.f30406OooO0OO;
        }
    ...
    public static final boolean OooO0o0(OooOO0O oooOO0O, int i, OooOO0O oooOO0O2) {
        if (i == 3) {
            float f = oooOO0O2.f30406OooO0OO;
            float f2 = oooOO0O.f30406OooO0OO;
            if ((f <= f2 && oooOO0O2.f30404OooO00o < f2) || oooOO0O2.f30404OooO00o <= oooOO0O.f30404OooO00o) {
                return false;
            }
        } else {
            if (i == 4) {
                float f3 = oooOO0O2.f30404OooO00o;
                float f4 = oooOO0O.f30404OooO00o;
                if ((f3 >= f4 && oooOO0O2.f30406OooO0OO > f4) || oooOO0O2.f30406OooO0OO >= oooOO0O.f30406OooO0OO) {
                    return false;
                }
            } else {
                if (i == 5) {
                    float f5 = oooOO0O2.f30407OooO0Oo;
                    float f6 = oooOO0O.f30407OooO0Oo;
                    if ((f5 <= f6 && oooOO0O2.f30405OooO0O0 < f6) || oooOO0O2.f30405OooO0O0 <= oooOO0O.f30405OooO0O0) {
                        return false;
                    }
                } else {
                    if (!(i == 6)) {
                    ...
                    float f7 = oooOO0O2.f30405OooO0O0;
                    float f8 = oooOO0O.f30405OooO0O0;
                    if ((f7 >= f8 && oooOO0O2.f30407OooO0Oo > f8) || oooOO0O2.f30407OooO0Oo >= oooOO0O.f30407OooO0Oo) {
                        return false;
                    }
                }
            }
    ...
    public static final boolean OooO0oO(o0OO00O o0oo00o2, o0OO00O o0oo00o3, int i, Function1<? super o0OO00O, Boolean> function1) {
        ...
        o000OOo o000ooo2 = new o000OOo(new o0OO00O[o0oo00o2.f53477Oooo0oo.f3664Oooo0oo]);
        o000ooo2.OooO0OO(o000ooo2.f3664Oooo0oo, o0oo00o2.f53477Oooo0oo);
        while (o000ooo2.OooOO0() && (o0oo00oOooO0OO = OooO0OO(o000ooo2, o0000O0O.OooO0Oo(o0oo00o3), i)) != null) {
            if (!o0oo00oOooO0OO.f53475Oooo.OooO0Oo()) {
    ...
    public static final boolean OooO0oo(@NotNull o0OO00O twoDimensionalFocusSearch, int i, @NotNull Function1<? super o0OO00O, Boolean> onFound) {
        ...
        FocusStateImpl focusStateImpl = twoDimensionalFocusSearch.f53475Oooo;
        int[] iArr = OooO00o.$EnumSwitchMapping$0;
        boolean z = true;
        switch (iArr[focusStateImpl.ordinal()]) {
            case 1:
            case 2:
                o0OO00O o0oo00o2 = twoDimensionalFocusSearch.f53480OoooO00;
                if (o0oo00o2 == null) {
                    throw new IllegalStateException("ActiveParent must have a focusedChild".toString());
                }
                switch (iArr[o0oo00o2.f53475Oooo.ordinal()]) {
                    case 1:
                    case 2:
                        if (OooO0oo(o0oo00o2, i, onFound)) {
                            return true;
                        }
                        FocusStateImpl focusStateImpl2 = o0oo00o2.f53475Oooo;
            ...
            case 4:
                ...
                if (o000oooOooO00o.f3664Oooo0oo <= 1) {
                    o0OO00O o0oo00o3 = o000oooOooO00o.OooO() ? null : o000oooOooO00o.f3662Oooo0o[0];
                    if (o0oo00o3 != null) {
                ...
                if ((i == 4) || i == 6) {
                    ...
                    float f = oooOO0OOooO0Oo.f30404OooO00o;
                    float f2 = oooOO0OOooO0Oo.f30405OooO0O0;
                    ...
                    float f3 = oooOO0OOooO0Oo2.f30406OooO0OO;
                    float f4 = oooOO0OOooO0Oo2.f30407OooO0Oo;
