...
public final class o0OOO0o implements o0ooOOo {
    ...
    @NotNull
    public final o0OO00O f53491OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public final o00OOOO0 f53492OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public LayoutDirection f53493OooO0OO;
    ...
    public static final class OooO0O0 extends Lambda implements Function1<o0OO00O, Boolean> {
        ...
        public final /* synthetic */ o0OO00O f53494Oooo0o;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(o0OO00O o0oo00o2) {
            super(1);
            this.f53494Oooo0o = o0oo00o2;
        }
        ...
        public final Boolean invoke(o0OO00O o0oo00o2) {
            ...
            if (Intrinsics.areEqual(destination, this.f53494Oooo0o)) {
                return Boolean.FALSE;
            }
            if (destination.f53476Oooo0oO == null) {
    ...
    public o0OOO0o() {
        ...
        this.f53491OooO00o = focusModifier;
        this.f53492OooO0O0 = oo0o0Oo.OooO00o(o00OOOO0.OooO00o.f4198Oooo0o, focusModifier);
    }

    /* JADX WARN: Code duplicated, block: B:152:0x01b8  */
    /* JADX WARN: Code duplicated, block: B:172:0x01f2  */
    @Override // p710ooOO.o0ooOOo
    public final boolean OooO00o(int i) {
        o0000Ooo o0000ooo;
        boolean zBooleanValue;
        boolean zOooO00o;
        o0OO00O customFocusSearch = o0000O0O.OooO0O0(this.f53491OooO00o);
        if (customFocusSearch == null) {
            return false;
        }
        LayoutDirection layoutDirection = this.f53493OooO0OO;
        ...
        int i2 = 3;
        if (i == 1) {
            o0000ooo = customFocusSearch.f53483OoooOOO.f53441OooO0O0;
        } else {
            if (i == 2) {
                o0000ooo = customFocusSearch.f53483OoooOOO.f53442OooO0OO;
            } else {
                if (i == 5) {
                    o0000ooo = customFocusSearch.f53483OoooOOO.f53443OooO0Oo;
                } else {
                    if (i == 6) {
                        o0000ooo = customFocusSearch.f53483OoooOOO.f53445OooO0o0;
                    } else {
                        if (i == 3) {
                            int i3 = o000000O.$EnumSwitchMapping$0[layoutDirection.ordinal()];
                            if (i3 == 1) {
                                o0000ooo = customFocusSearch.f53483OoooOOO.f53447OooO0oo;
                            } else {
                                if (i3 != 2) {
                                    throw new NoWhenBranchMatchedException();
                                }
                                o0000ooo = customFocusSearch.f53483OoooOOO.f53439OooO;
                            }
                            o0000Ooo.OooO00o oooO00o = o0000Ooo.f53457OooO0O0;
                            if (Intrinsics.areEqual(o0000ooo, o0000Ooo.f53458OooO0OO)) {
                                o0000ooo = null;
                            }
                            if (o0000ooo == null) {
                                o0000ooo = customFocusSearch.f53483OoooOOO.f53444OooO0o;
                            }
                        } else {
                            if (i == 4) {
                                ...
                                o0000Ooo.OooO00o oooO00o2 = o0000Ooo.f53457OooO0O0;
                                if (Intrinsics.areEqual(o0000ooo, o0000Ooo.f53458OooO0OO)) {
                                    o0000ooo = null;
                                }
                                if (o0000ooo == null) {
                                    o0000ooo = customFocusSearch.f53483OoooOOO.f53446OooO0oO;
                                }
                            } else {
                                if (i == 7) {
                                    o0000Ooo.OooO00o oooO00o3 = o0000Ooo.f53457OooO0O0;
                                    o0000ooo = o0000Ooo.f53458OooO0OO;
                                } else {
                                    if (!(i == 8)) {
                                        throw new IllegalStateException("invalid FocusDirection".toString());
                                    }
                                    o0000Ooo.OooO00o oooO00o4 = o0000Ooo.f53457OooO0O0;
                                    o0000ooo = o0000Ooo.f53458OooO0OO;
                                }
                            }
                        }
        ...
        o0000Ooo.OooO00o oooO00o5 = o0000Ooo.f53457OooO0O0;
        if (!Intrinsics.areEqual(o0000ooo, o0000Ooo.f53458OooO0OO)) {
            o0000ooo.OooO00o();
            return true;
        }
        o0OO00O oneDimensionalFocusSearch = this.f53491OooO00o;
        LayoutDirection layoutDirection2 = this.f53493OooO0OO;
        ...
        if (!zBooleanValue) {
            if (!this.f53491OooO00o.f53475Oooo.OooO00o() || this.f53491OooO00o.f53475Oooo.OooO0O0()) {
                zOooO00o = false;
            } else {
                if ((i == 1) || i == 2) {
                    OooO0O0(false);
                    if (this.f53491OooO00o.f53475Oooo.OooO0O0()) {
                        zOooO00o = OooO00o(i);
                    } else {
                        zOooO00o = false;
                    }
