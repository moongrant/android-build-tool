...
public final class o0000Ooo {
    ...
    public static o0000Ooo f3249OooO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public static final PorterDuff.Mode f3250OooO0oo = PorterDuff.Mode.SRC_IN;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public static final OooO0OO f3251OooOO0 = new OooO0OO();

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public WeakHashMap<Context, p188o00o0O.Oooo0<ColorStateList>> f3252OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public p188o00o0O.Oooo000<String, OooO> f3253OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public p188o00o0O.Oooo0<String> f3254OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final WeakHashMap<Context, p188o00o0O.OooOo00<WeakReference<Drawable.ConstantState>>> f3255OooO0Oo = new WeakHashMap<>(0);

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public boolean f3256OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public TypedValue f3257OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public OooOO0 f3258OooO0oO;
    ...
    public static class OooO0O0 implements OooO {
        ...
        public final Drawable OooO00o(@NonNull Context context, @NonNull XmlResourceParser xmlResourceParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) {
            try {
                ...
                p079o000Oo0o.o000OOo0 o000ooo1 = new p079o000Oo0o.o000OOo0(context);
                o000ooo1.inflate(resources, xmlResourceParser, attributeSet, theme);
                return o000ooo1;
            } catch (Exception e) {
    ...
    public static class OooO0OO extends p188o00o0O.OooOo<Integer, PorterDuffColorFilter> {
        public OooO0OO() {
            super(6);
        }
    }
    ...
    public static class OooOO0O implements OooO {
        ...
        public final Drawable OooO00o(@NonNull Context context, @NonNull XmlResourceParser xmlResourceParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) {
            try {
                ...
                o00o001.inflate(resources, xmlResourceParser, attributeSet, theme);
                return o00o001;
            } catch (Exception e) {
    ...
    public final synchronized ColorStateList OooO(@DrawableRes int i, @NonNull Context context) {
        ...
        p188o00o0O.Oooo0<ColorStateList> oooo0;
        try {
            WeakHashMap<Context, p188o00o0O.Oooo0<ColorStateList>> weakHashMap = this.f3252OooO00o;
            ColorStateList colorStateListOooO0Oo = null;
            colorStateList = (weakHashMap == null || (oooo0 = weakHashMap.get(context)) == null) ? null : (ColorStateList) oooo0.OooO0o(i, null);
            if (colorStateList == null) {
                OooOO0 oooOO1 = this.f3258OooO0oO;
                if (oooOO1 != null) {
                    colorStateListOooO0Oo = ((OooOOO0.OooO00o) oooOO1).OooO0Oo(i, context);
                }
                if (colorStateListOooO0Oo != null) {
                    if (this.f3252OooO00o == null) {
                        this.f3252OooO00o = new WeakHashMap<>();
                    }
                    p188o00o0O.Oooo0<ColorStateList> oooo1 = this.f3252OooO00o.get(context);
                    if (oooo1 == null) {
                        oooo1 = new p188o00o0O.Oooo0<>();
                        this.f3252OooO00o.put(context, oooo1);
                    }
                    oooo1.OooO0O0(i, colorStateListOooO0Oo);
                }
    ...
    public final void OooO00o(@NonNull String str, @NonNull OooO oooO) {
        if (this.f3253OooO0O0 == null) {
            this.f3253OooO0O0 = new p188o00o0O.Oooo000<>();
        }
        this.f3253OooO0O0.put(str, oooO);
    }

    public final synchronized void OooO0O0(@NonNull Context context, long j, @NonNull Drawable drawable) {
        Drawable.ConstantState constantState = drawable.getConstantState();
        if (constantState != null) {
            p188o00o0O.OooOo00<WeakReference<Drawable.ConstantState>> oooOo00 = this.f3255OooO0Oo.get(context);
            if (oooOo00 == null) {
                oooOo00 = new p188o00o0O.OooOo00<>();
                this.f3255OooO0Oo.put(context, oooOo00);
            }
            oooOo00.OooO(j, new WeakReference<>(constantState));
        }
    }
    ...
    public final Drawable OooO0OO(@DrawableRes int i, @NonNull Context context) {
        ...
        if (this.f3257OooO0o0 == null) {
            this.f3257OooO0o0 = new TypedValue();
        }
        TypedValue typedValue = this.f3257OooO0o0;
    ...
    public final synchronized Drawable OooO0o0(@NonNull Context context, long j) {
        ...
        WeakReference weakReference = (WeakReference) oooOo00.OooO0oO(j, null);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:15:0x002a, code lost:
        ...
        if (((r0 instanceof p079o000Oo0o.o00O000) || "android.graphics.drawable.VectorDrawable".equals(r0.getClass().getName())) != false) goto L16;
     */
    ...
    */
    public final synchronized Drawable OooO0oO(@NonNull Context context, @DrawableRes int i, boolean z) {
        ...
        try {
            ...
            if (oooo000 == null || oooo000.isEmpty()) {
                ...
                p188o00o0O.Oooo0<String> oooo0 = this.f3254OooO0OO;
                if (oooo0 != null) {
                    String str = (String) oooo0.OooO0o(i, null);
                    if ("appcompat_skip_skip".equals(str) || (str != null && this.f3253OooO0O0.getOrDefault(str, null) == null)) {
                        drawableOooO0O0 = null;
                    }
                } else {
                    this.f3254OooO0OO = new p188o00o0O.Oooo0<>();
                }
                if (this.f3257OooO0o0 == null) {
                    this.f3257OooO0o0 = new TypedValue();
                }
                ...
                if (drawableOooO0O0 == null) {
                    ...
                    if (charSequence != null && charSequence.toString().endsWith(".xml")) {
                        try {
                            ...
                            this.f3254OooO0OO.OooO0O0(i, name);
                            OooO orDefault = this.f3253OooO0O0.getOrDefault(name, null);
                            if (orDefault != null) {
                    ...
                    if (drawableOooO0O0 == null) {
                        this.f3254OooO0OO.OooO0O0(i, "appcompat_skip_skip");
                    }
                }
            }
            if (drawableOooO0O0 == null) {
            ...
            if (drawableOooO0O0 != null) {
                ...
                if (colorStateListOooO != null) {
                    ...
                    if (this.f3258OooO0oO != null && i == p012OooOo0O.OooOo.abc_switch_thumb_material) {
                ...
                } else if (this.f3258OooO0oO != null) {
                    if (i == p012OooOo0O.OooOo.abc_seekbar_track_material) {
                        ...
                        PorterDuff.Mode mode2 = OooOOO0.f2981OooO0O0;
                        ...
                        if (i == p012OooOo0O.OooOo.abc_ratingbar_material || i == p012OooOo0O.OooOo.abc_ratingbar_indicator_material || i == p012OooOo0O.OooOo.abc_ratingbar_small_material) {
                            ...
                            PorterDuff.Mode mode3 = OooOOO0.f2981OooO0O0;
    ...
    public final boolean OooOOO0(@NonNull Context context, @DrawableRes int i, @NonNull Drawable drawable) {
        ...
        PorterDuff.Mode mode2 = OooOOO0.f2981OooO0O0;
        if (OooOOO0.OooO00o.OooO00o(i, oooO00o.f2984OooO00o)) {
            i4 = p012OooOo0O.OooOOO0.colorControlNormal;
        } else if (OooOOO0.OooO00o.OooO00o(i, oooO00o.f2986OooO0OO)) {
            i4 = p012OooOo0O.OooOOO0.colorControlActivated;
        } else {
            if (!OooOOO0.OooO00o.OooO00o(i, oooO00o.f2987OooO0Oo)) {
        ...
        iRound = -1;
        if (z) {
            int[] iArr2 = o000000.f3194OooO00o;
            drawableMutate = drawable.mutate();
            drawableMutate.setColorFilter(OooOOO0.OooO0OO(o0000O.OooO0OO(i3, context), mode));
            if (iRound != -1) {
                drawableMutate.setAlpha(iRound);
