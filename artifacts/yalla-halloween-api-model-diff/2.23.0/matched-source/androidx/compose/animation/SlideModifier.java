...
final class SlideModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public MeasureResult mo27measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j) {
        ...
        return MeasureScope.CC.OooOOo0(measure, placeableMo2794measureBRTryo0.getWidth(), placeableMo2794measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SlideModifier$measure$1
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.m2841placeWithLayeraW9wM$default(layout, placeableMo2794measureBRTryo0, lazyAnimation.animate(transitionSpec, new Function1<EnterExitState, IntOffset>() { // from class: androidx.compose.animation.SlideModifier$measure$1$slideOffset$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                    ...
                    public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                        return IntOffset.m3874boximpl(m67invokeBjo55l4(enterExitState));
                    }
    ...
    public final long m66targetValueByStateoFUgxo0(@NotNull EnterExitState targetState, long fullSize) {
        ...
        long jM3893getZeronOccac = (value == null || (slideOffset2 = value.getSlideOffset()) == null) ? IntOffset.INSTANCE.m3893getZeronOccac() : slideOffset2.invoke(IntSize.m3917boximpl(fullSize)).getPackedValue();
        Slide value2 = this.slideOut.getValue();
        long jM3893getZeronOccac2 = (value2 == null || (slideOffset = value2.getSlideOffset()) == null) ? IntOffset.INSTANCE.m3893getZeronOccac() : slideOffset.invoke(IntSize.m3917boximpl(fullSize)).getPackedValue();
