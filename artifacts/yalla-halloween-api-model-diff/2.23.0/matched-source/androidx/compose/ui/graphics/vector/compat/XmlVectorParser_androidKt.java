...
public final class XmlVectorParser_androidKt {
    ...
    public static final ImageVector.Builder createVectorImageBuilder(@NotNull AndroidVectorParser androidVectorParser, @NotNull Resources res, @Nullable Resources.Theme theme, @NotNull AttributeSet attrs) throws XmlPullParserException {
        ...
        if (typedArrayObtainAttributes.hasValue(androidVectorResources.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            jM1706getUnspecified0d7_KjU = (typedValue.type == 2 || (namedColorStateList = androidVectorParser.getNamedColorStateList(typedArrayObtainAttributes, theme, "tint", androidVectorResources.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) == null) ? Color.INSTANCE.m1706getUnspecified0d7_KjU() : ColorKt.Color(namedColorStateList.getDefaultColor());
        } else {
            jM1706getUnspecified0d7_KjU = Color.INSTANCE.m1706getUnspecified0d7_KjU();
        }
        long j = jM1706getUnspecified0d7_KjU;
        ...
        if (i == -1) {
            iM1618getSrcIn0nO6VwU = BlendMode.INSTANCE.m1618getSrcIn0nO6VwU();
        } else if (i == 3) {
            iM1618getSrcIn0nO6VwU = BlendMode.INSTANCE.m1620getSrcOver0nO6VwU();
        } else if (i == 5) {
            iM1618getSrcIn0nO6VwU = BlendMode.INSTANCE.m1618getSrcIn0nO6VwU();
        } else if (i != 9) {
            switch (i) {
                case 14:
                    iM1618getSrcIn0nO6VwU = BlendMode.INSTANCE.m1609getModulate0nO6VwU();
                    break;
                case 15:
                    iM1618getSrcIn0nO6VwU = BlendMode.INSTANCE.m1614getScreen0nO6VwU();
                    break;
                case 16:
                    iM1618getSrcIn0nO6VwU = BlendMode.INSTANCE.m1612getPlus0nO6VwU();
                    break;
                default:
                    iM1618getSrcIn0nO6VwU = BlendMode.INSTANCE.m1618getSrcIn0nO6VwU();
                    break;
            ...
            iM1618getSrcIn0nO6VwU = BlendMode.INSTANCE.m1617getSrcAtop0nO6VwU();
        }
        int i2 = iM1618getSrcIn0nO6VwU;
        float fM3765constructorimpl = Dp.m3765constructorimpl(dimension / res.getDisplayMetrics().density);
        float fM3765constructorimpl2 = Dp.m3765constructorimpl(dimension2 / res.getDisplayMetrics().density);
        typedArrayObtainAttributes.recycle();
        return new ImageVector.Builder(null, fM3765constructorimpl, fM3765constructorimpl2, namedFloat, namedFloat2, j, i2, namedBoolean, 1, null);
    }

    /* JADX INFO: renamed from: getStrokeLineCap-CSYIeUk, reason: not valid java name */
    private static final int m2234getStrokeLineCapCSYIeUk(int i, int i2) {
        if (i == 0) {
            return StrokeCap.INSTANCE.m1995getButtKaPHkGw();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeCap.INSTANCE.m1997getSquareKaPHkGw();
        }
    ...
    public static /* synthetic */ int m2235getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.INSTANCE.m1995getButtKaPHkGw();
        }
        return m2234getStrokeLineCapCSYIeUk(i, i2);
    }

    /* JADX INFO: renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m2236getStrokeLineJoinkLtJ_vA(int i, int i2) {
        if (i == 0) {
            return StrokeJoin.INSTANCE.m2006getMiterLxFBmk8();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeJoin.INSTANCE.m2005getBevelLxFBmk8();
        }
        return StrokeJoin.INSTANCE.m2007getRoundLxFBmk8();
    }

    /* JADX INFO: renamed from: getStrokeLineJoin-kLtJ_vA$default, reason: not valid java name */
    public static /* synthetic */ int m2237getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.INSTANCE.m2006getMiterLxFBmk8();
        }
        return m2236getStrokeLineJoinkLtJ_vA(i, i2);
    }
    ...
    private static final Brush obtainBrushFromComplexColor(o0OoOo0 o0oooo0) {
        Shader shader = o0oooo0.f34254OooO00o;
        boolean z = true;
        if (!(shader != null) && o0oooo0.f34256OooO0OO == 0) {
            z = false;
        }
        if (z) {
            return shader != null ? BrushKt.ShaderBrush(shader) : new SolidColor(ColorKt.Color(o0oooo0.f34256OooO0OO), null);
        }
        return null;
    }
    ...
    public static final void parsePath(@NotNull AndroidVectorParser androidVectorParser, @NotNull Resources res, @Nullable Resources.Theme theme, @NotNull AttributeSet attrs, @NotNull ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int iM2234getStrokeLineCapCSYIeUk = m2234getStrokeLineCapCSYIeUk(androidVectorParser.getNamedInt(typedArrayObtainAttributes, "strokeLineCap", androidVectorResources.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.INSTANCE.m1995getButtKaPHkGw());
        int iM2236getStrokeLineJoinkLtJ_vA = m2236getStrokeLineJoinkLtJ_vA(androidVectorParser.getNamedInt(typedArrayObtainAttributes, "strokeLineJoin", androidVectorResources.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.INSTANCE.m2005getBevelLxFBmk8());
        ...
        builder.m2214addPathoIyEayM(listAddPathNodes, namedInt == 0 ? companion.m1926getNonZeroRgk1Os() : companion.m1925getEvenOddRgk1Os(), str, brushObtainBrushFromComplexColor, namedFloat, brushObtainBrushFromComplexColor2, namedFloat3, namedFloat4, iM2234getStrokeLineCapCSYIeUk, iM2236getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
    }
