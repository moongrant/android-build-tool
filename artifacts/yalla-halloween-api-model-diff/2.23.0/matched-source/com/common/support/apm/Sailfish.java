...
public final class Sailfish implements Logger {
    ...
    private static o00OOOO0 okHttpClient;
    ...
    public static final class C08661 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public static final class C01851 extends SuspendLambda implements Function2<Boolean, Continuation<? super Unit>, Object> {
            int label;

            public C01851(Continuation<? super C01851> continuation) {
                super(2, continuation);
            }
            ...
            public final Object invoke(boolean z, @Nullable Continuation<? super Unit> continuation) {
                return ((C01851) create(Boolean.valueOf(z), continuation)).invokeSuspend(Unit.INSTANCE);
            }
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C08661(continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (FlowKt.collectLatest(mutableSharedFlow, c01851, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
    ...
    static {
        ...
        sb.append(StringsKt.OooOoO(string, "-", ""));
    ...
    public final synchronized void init(@NotNull Context context, @NotNull String appId2, @NotNull String appKey2, @NotNull String appSecret2, @NotNull String appChannel2, @NotNull SailfishConfiguration config2, @NotNull String deviceId2, @NotNull String uniqueId2, @NotNull String appNameSpace2, boolean sdkLoggable2) {
        ...
        synchronized (this) {
            ...
            o00OOOO0.OooO00o oooO00oCreateOkHttpClientBuilder = httpClient.createOkHttpClientBuilder((String[]) array, new OtlpHeaderInterceptor());
            oooO00oCreateOkHttpClientBuilder.getClass();
            okHttpClient = new o00OOOO0(oooO00oCreateOkHttpClientBuilder);
            MonitorManager monitorManager = MonitorManager.INSTANCE;
            o00OOOO0 o00oooo1 = okHttpClient;
            if (o00oooo1 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("okHttpClient");
                o00oooo1 = null;
            }
            monitorManager.init$sailfish_release(o00oooo1);
            ConfigurationManager configurationManager = ConfigurationManager.INSTANCE;
            o00OOOO0 o00oooo2 = okHttpClient;
            if (o00oooo2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("okHttpClient");
                o00oooo2 = null;
            }
            configurationManager.init(appContext, o00oooo2);
            o00OOOO0 o00oooo3 = okHttpClient;
            if (o00oooo3 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("okHttpClient");
                o00oooo3 = null;
            }
            new NetDetectorManager(o00oooo3).startDetect();
            UploadService uploadService = UploadService.INSTANCE;
            o00OOOO0 o00oooo4 = okHttpClient;
            if (o00oooo4 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("okHttpClient");
                o00oooo4 = null;
            }
            uploadService.init(o00oooo4, domainConfig.getDefaultDomains().get(0), appId2, appNameSpace);
            ...
            configurationManager.addOnConfigChangeListener(new Function0<Unit>() { // from class: com.common.support.apm.Sailfish.init.1
                ...
                public final void invoke2() {
                    o00OOOO0 o00oooo5 = Sailfish.okHttpClient;
                    if (o00oooo5 == null) {
                        Intrinsics.throwUninitializedPropertyAccessException("okHttpClient");
                        o00oooo5 = null;
                    }
                    ...
                    HostSwitchInterceptorKt.updateHosts(o00oooo5, (String[]) Arrays.copyOf(strArr, strArr.length));
                }
            });
            isInitialized = true;
            BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new AnonymousClass2(null), 3, null);
            MonitorManager.writeMonitorLogForInit$sailfish_release$default(monitorManager, new StatusMetricModel(1, 0), System.currentTimeMillis() - jCurrentTimeMillis, 0, 4, null);
        }
    }
    ...
    public final boolean isNetAvailable$sailfish_release() {
        ...
        Boolean boolValueOf = context == null ? null : Boolean.valueOf(NetUtilKt.isNetAvailable(context));
        if (boolValueOf == null) {
            return false;
        }
    ...
    public final MeterBuilder meterBuilder(@NotNull String name) {
        ...
        MeterBuilder meterBuilderOooO0O0 = YallaOtlpSdk.INSTANCE.getMeterProvider().OooO0O0(name);
        Intrinsics.checkNotNullExpressionValue(meterBuilderOooO0O0, "YallaOtlpSdk.getMeterProvider().meterBuilder(name)");
        return meterBuilderOooO0O0;
    }
    ...
    public final MeterBuilder meterBuilderOrNull(@NotNull String name) {
        ...
        if (yallaOtlpSdk.isInited()) {
            return yallaOtlpSdk.getMeterProvider().OooO0O0(name);
        }
        return null;
    }
    ...
    public final NetService netDiagService(@NotNull Context context) {
        ...
        return new NetSpeedServiceImpl(context, o00oooo1, DomainConfig.INSTANCE.getDefaultDomains().get(0));
    }
    ...
    public final void setUniqueId(@NotNull String uniqueId2) {
        ...
        uniqueId = uniqueId2;
        BuildersKt__Builders_commonKt.launch$default(sailfishScope, null, null, new C08661(null), 3, null);
    }
