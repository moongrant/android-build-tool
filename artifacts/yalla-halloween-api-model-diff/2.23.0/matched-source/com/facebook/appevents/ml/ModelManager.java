...
public final class ModelManager {
        ...
        public static final class Companion {
            ...
            private final void deleteOldFiles(String useCase, int versionId) {
                ...
                while (i < length) {
                    ...
                    if (StringsKt.Oooo00o(name, useCase) && !StringsKt.Oooo00o(name, str)) {
                        file.delete();
                    }
                }
            }
            ...
            public static final void m4098execute$lambda1(List slaves, File file) {
                ...
                if (modelBuild != null) {
                    ...
                    while (it.hasNext()) {
                        ...
                        sb.append('_');
                        TaskHandler.INSTANCE.download(taskHandler.getRuleUri(), OooOO0.OooO0O0(sb, taskHandler.getVersionId(), "_rule"), new FileDownloadTask.Callback() { // from class: com.facebook.appevents.ml.OooO
                            @Override // com.facebook.appevents.internal.FileDownloadTask.Callback
                            public final void onComplete(File file2) {
                                ModelManager.TaskHandler.Companion.m4099execute$lambda1$lambda0(taskHandler, modelBuild, file2);
                            }
                        });
                    }
                }
            ...
            public static final void m4099execute$lambda1$lambda0(TaskHandler slave, Model model, File file) {
            ...
            public final void execute(@NotNull TaskHandler master, @NotNull final List<TaskHandler> slaves) {
                ...
                download(master.getAssetUri(), master.getUseCase() + '_' + master.getVersionId(), new FileDownloadTask.Callback() { // from class: com.facebook.appevents.ml.OooO0o
                    @Override // com.facebook.appevents.internal.FileDownloadTask.Callback
                    public final void onComplete(File file) {
                        ModelManager.TaskHandler.Companion.m4098execute$lambda1(slaves, file);
                    }
                });
            }
        }
    ...
    public static final void m4095enable$lambda0() {
    ...
    public static final void m4096enableMTML$lambda1() {
        if (CrashShieldHandler.isObjectCrashing(ModelManager.class)) {
            return;
        }
        try {
    ...
    public static final void m4097enableMTML$lambda2() {
        if (CrashShieldHandler.isObjectCrashing(ModelManager.class)) {
            return;
        }
        try {
    ...
    private final boolean isLocaleEnglish() {
        ...
        try {
            ...
            if (resourceLocale != null) {
                ...
                if (!StringsKt.OooO0o(language, "en")) {
                    return false;
                }
            }
            return true;
