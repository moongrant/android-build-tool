...
public abstract class NativeAppLoginMethodHandler extends LoginMethodHandler {
    ...
    private final void processSuccessResponse(final LoginClient.Request request, final Bundle extras) {
        if (extras.containsKey("code")) {
            ...
            if (!Utility.isNullOrEmpty(extras.getString("code"))) {
                final int i = 1;
                FacebookSdk.getExecutor().execute(new Runnable() { // from class: o000O0O0.o00O0O
                    ...
                    public final void run() {
                        ...
                        switch (i2) {
                            case 0:
                                o00Ooo this$0 = (o00Ooo) obj3;
                                SupportSQLiteQuery query = (SupportSQLiteQuery) obj2;
                                oo000o queryInterceptorProgram = (oo000o) obj;
                                ...
                                throw null;
                            default:
                                NativeAppLoginMethodHandler.m4178processSuccessResponse$lambda0((NativeAppLoginMethodHandler) obj3, (LoginClient.Request) obj2, (Bundle) obj);
                                return;
                        }
                    }
                });
    ...
    public static final void m4178processSuccessResponse$lambda0(NativeAppLoginMethodHandler this$0, LoginClient.Request request, Bundle extras) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
