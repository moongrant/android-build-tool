...
public final class zzat implements Iterable, zzap {
    ...
    public final String f15665OooO0Oo;

    public zzat(String str) {
        if (str == null) {
            throw new IllegalArgumentException("StringValue cannot be null.");
        }
        this.f15665OooO0Oo = str;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof zzat) {
            return this.f15665OooO0Oo.equals(((zzat) obj).f15665OooO0Oo);
        }
        return false;
    }

    public final int hashCode() {
        return this.f15665OooO0Oo.hashCode();
    }
    ...
    public final String toString() {
        return p028Oooo0oO.o0O00o0.OooO0O0(new StringBuilder("\""), this.f15665OooO0Oo, "\"");
    }
    ...
    public final zzap zzbU(String str, zzg zzgVar, List list) {
        ...
        String str3 = str2;
        String str4 = this.f15665OooO0Oo;
        switch (b) {
            case 0:
                zzh.zzj(str3, 1, list);
    ...
    public final zzap zzd() {
        return new zzat(this.f15665OooO0Oo);
    }

    @Override // com.google.android.gms.internal.measurement.zzap
    public final Boolean zzg() {
        return Boolean.valueOf(!this.f15665OooO0Oo.isEmpty());
    }

    @Override // com.google.android.gms.internal.measurement.zzap
    public final Double zzh() {
        String str = this.f15665OooO0Oo;
        if (str.isEmpty()) {
