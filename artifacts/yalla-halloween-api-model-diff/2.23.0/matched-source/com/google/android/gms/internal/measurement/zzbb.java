...
public final class zzbb {
    public static zzae OooO00o(zzae zzaeVar, zzg zzgVar, zzao zzaoVar, Boolean bool, Boolean bool2) {
        zzae zzaeVar2 = new zzae();
        Iterator itZzk = zzaeVar.zzk();
        while (itZzk.hasNext()) {
            int iIntValue = ((Integer) itZzk.next()).intValue();
            if (zzaeVar.zzs(iIntValue)) {
                zzap zzapVarZza = zzaoVar.zza(zzgVar, Arrays.asList(zzaeVar.zze(iIntValue), new zzah(Double.valueOf(iIntValue)), zzaeVar));
    ...
    public static zzap OooO0O0(zzae zzaeVar, zzg zzgVar, List list, boolean z) {
        zzap zzapVarZza;
    ...
    public static zzap zza(String str, zzae zzaeVar, zzg zzgVar, List list) {
        ...
        switch (b) {
            ...
            case 1:
                ...
                return OooO00o(zzaeVar, zzgVar, (zzao) zzapVarZzb2, Boolean.FALSE, Boolean.TRUE).zzc() != zzaeVar.zzc() ? zzap.zzl : zzap.zzk;
            case 2:
                ...
                zzae zzaeVarOooO00o = OooO00o(zzaeVar, zzgVar, (zzao) zzapVarZzb3, null, Boolean.TRUE);
                zzae zzaeVar4 = new zzae();
                Iterator itZzk2 = zzaeVarOooO00o.zzk();
            ...
            case 3:
                ...
                OooO00o(zzaeVar, zzgVar, (zzao) zzapVarZzb4, null, null);
                return zzap.zzf;
            case 4:
            ...
            case 7:
                ...
                if (zzapVarZzb9 instanceof zzao) {
                    return zzaeVar.zzc() == 0 ? new zzae() : OooO00o(zzaeVar, zzgVar, (zzao) zzapVarZzb9, null, null);
                }
                throw new IllegalArgumentException("Callback should be a method");
            case 8:
                zzh.zzh("pop", 0, list);
            ...
            case 10:
                return OooO0O0(zzaeVar, zzgVar, list, true);
            case 11:
                return OooO0O0(zzaeVar, zzgVar, list, false);
            case 12:
            ...
            case 16:
                ...
                if (zzaeVar.zzc() >= 2) {
                    ...
                    Collections.sort(listZzm, new OooOO0O(zzaiVar, zzgVar));
                    zzaeVar.zzn();
