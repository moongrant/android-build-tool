...
import p312o0O0oOOO.o00O;
import p312o0O0oOOO.oo0oOO0;

/* JADX INFO: loaded from: classes3.dex */
public final class TraceMetric extends GeneratedMessageLite<TraceMetric, OooO0O0> implements o00O {
    ...
    public static /* synthetic */ class OooO00o {
        ...
        public static final /* synthetic */ int[] f20497OooO00o;
        ...
        static {
            ...
            try {
                f20497OooO00o[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f20497OooO00o[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f20497OooO00o[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f20497OooO00o[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f20497OooO00o[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f20497OooO00o[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
        }
    }

    public static final class OooO0O0 extends GeneratedMessageLite.Builder<TraceMetric, OooO0O0> implements o00O {
        public OooO0O0() {
    ...
    public static final class OooO0OO {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public static final MapEntryLite<String, Long> f20498OooO00o = MapEntryLite.newDefaultInstance(WireFormat.FieldType.STRING, "", WireFormat.FieldType.INT64, 0L);
    }

    public static final class OooO0o {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public static final MapEntryLite<String, String> f20499OooO00o;

        static {
            WireFormat.FieldType fieldType = WireFormat.FieldType.STRING;
            f20499OooO00o = MapEntryLite.newDefaultInstance(fieldType, "", fieldType, "");
        }
    }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (OooO00o.f20497OooO00o[methodToInvoke.ordinal()]) {
            case 1:
                return new TraceMetric();
            case 2:
                return new OooO0O0();
            case 3:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0001\b\u0000\u0001\u0001\t\b\u0002\u0002\u0000\u0001ဈ\u0000\u0002ဇ\u0001\u0004ဂ\u0002\u0005ဂ\u0003\u00062\u0007\u001b\b2\t\u001b", new Object[]{"bitField0_", "name_", "isAuto_", "clientStartTimeUs_", "durationUs_", "counters_", OooO0OO.f20498OooO00o, "subtraces_", TraceMetric.class, "customAttributes_", OooO0o.f20499OooO00o, "perfSessions_", PerfSession.class});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
    ...
    public oo0oOO0 getPerfSessionsOrBuilder(int i) {
        return this.perfSessions_.get(i);
    }

    public List<? extends oo0oOO0> getPerfSessionsOrBuilderList() {
        return this.perfSessions_;
    }
    ...
    public o00O getSubtracesOrBuilder(int i) {
        return this.subtraces_.get(i);
    }

    public List<? extends o00O> getSubtracesOrBuilderList() {
        return this.subtraces_;
    }
