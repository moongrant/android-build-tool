    ...
    public static final class DescriptorPool {
        ...
        public void addPackage(String str, FileDescriptor fileDescriptor) throws DescriptorValidationException {
            ...
            if (genericDescriptorPut != null) {
                ...
                StringBuilder sbOooO00o = o0OoOo0.OooO00o("\"", strSubstring, "\" is already defined (as something other than a package) in file \"");
                sbOooO00o.append(genericDescriptorPut.getFile().getName());
                sbOooO00o.append("\".");
                throw new DescriptorValidationException(fileDescriptor, sbOooO00o.toString(), (AnonymousClass1) null);
            }
        }
        ...
        public void addSymbol(GenericDescriptor genericDescriptor) throws DescriptorValidationException {
            ...
            if (genericDescriptorPut != null) {
                ...
                if (genericDescriptor.getFile() != genericDescriptorPut.getFile()) {
                    StringBuilder sbOooO00o = o0OoOo0.OooO00o("\"", fullName, "\" is already defined in file \"");
                    sbOooO00o.append(genericDescriptorPut.getFile().getName());
                    sbOooO00o.append("\".");
                    throw new DescriptorValidationException(genericDescriptor, sbOooO00o.toString(), anonymousClass1);
                }
