...
public final class Field extends GeneratedMessageV3 implements FieldOrBuilder {
    ...
    public int hashCode() {
        ...
        int iHashBoolean = Internal.hashBoolean(getPacked()) + ((((getOneofIndex() + ((((getTypeUrl().hashCode() + ((((getName().hashCode() + ((((getNumber() + o000000.OooO00o(o000000.OooO00o((((getDescriptor().hashCode() + 779) * 37) + 1) * 53, this.kind_, 37, 2, 53), this.cardinality_, 37, 3, 53)) * 37) + 4) * 53)) * 37) + 6) * 53)) * 37) + 7) * 53)) * 37) + 8) * 53);
        if (getOptionsCount() > 0) {
            iHashBoolean = getOptionsList().hashCode() + o000000O.OooO00o(iHashBoolean, 37, 9, 53);
        }
        int iHashCode = getUnknownFields().hashCode() + ((getDefaultValue().hashCode() + ((((getJsonName().hashCode() + o000000O.OooO00o(iHashBoolean, 37, 10, 53)) * 37) + 11) * 53)) * 29);
