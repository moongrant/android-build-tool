...
final class MessageSchema<T> implements Schema<T> {
    ...
    private static void checkMutable(Object obj) {
        if (!isMutable(obj)) {
            throw new IllegalArgumentException(Oooo000.OooO00o("Mutating immutable message: ", obj));
        }
    }
    ...
    private static java.lang.reflect.Field reflectField(Class<?> cls, String str) {
        try {
            ...
            StringBuilder sbOooO00o = o0OoOo0.OooO00o("Field ", str, " for ");
            sbOooO00o.append(cls.getName());
            sbOooO00o.append(" not found. Known fields are ");
            sbOooO00o.append(Arrays.toString(declaredFields));
