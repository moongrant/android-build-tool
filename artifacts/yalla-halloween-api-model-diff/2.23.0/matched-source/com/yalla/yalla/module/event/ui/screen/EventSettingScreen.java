...
public final class EventSettingScreen extends o00O00O {
    ...
    public static final class OooO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ int f23858OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(int i) {
            super(2);
            this.f23858OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f23858OooO0o0 | 1);
    ...
    public static final class OooO00o extends Lambda implements Function1<Boolean, Unit> {
        ...
        public final /* synthetic */ EventSettingViewModel f23859OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(EventSettingViewModel eventSettingViewModel) {
            super(1);
            this.f23859OooO0Oo = eventSettingViewModel;
        }

        @Override // kotlin.jvm.functions.Function1
        public final Unit invoke(Boolean bool) {
            o0OO000.OooO0O0("101083", MapsKt.mapOf(new Pair("type", Integer.valueOf(bool.booleanValue() ? 1 : 2))));
            this.f23859OooO0Oo.setEventSettingState();
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0O0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f23861OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(int i) {
            super(2);
            this.f23861OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f23861OooO0o0 | 1);
    ...
    public static final class OooO0OO extends Lambda implements Function1<Lifecycle.Event, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ EventSettingViewModel f23862OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(EventSettingViewModel eventSettingViewModel) {
            super(1);
            this.f23862OooO0Oo = eventSettingViewModel;
        }
        ...
        public final Unit invoke(Lifecycle.Event event) {
            ...
            if (it == Lifecycle.Event.ON_START) {
                this.f23862OooO0Oo.getHasPermissions().setValue(Boolean.valueOf(com.yalla.yalla.util.permission.OooO00o.OooO00o(o000O0.OooO00o(), PermissionGroupReveal.f32883OooO0o)));
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ int f23864OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ ColumnScope f23865OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(ColumnScope columnScope, int i) {
            super(2);
            this.f23865OooO0o0 = columnScope;
            this.f23864OooO0o = i;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f23864OooO0o | 1);
            EventSettingScreen.this.Content(this.f23865OooO0o0, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0 extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Context f23866OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0(Context context) {
            super(0);
            this.f23866OooO0Oo = context;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            Context context = this.f23866OooO0Oo;
            try {
    ...
    public static final class OooOO0O extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f23868OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0O(int i) {
            super(2);
            this.f23868OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f23868OooO0o0 | 1);
            EventSettingScreen.this.EnableCalendarPermissions(composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public final void AllowAutoAddEventToCalendar(Composer composer, int i) {
        ...
        if ((i & 1) == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            float f = 14;
            Modifier modifierM479paddingqDBjuR0 = PaddingKt.m479paddingqDBjuR0(SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), Dp.m3765constructorimpl(f), Dp.m3765constructorimpl(12), Dp.m3765constructorimpl(f), Dp.m3765constructorimpl(18));
            ...
            TextKt.m1251Text4IGK_g(StringResources_androidKt.stringResource(oO00OOo0.event_setting_auto_add_title, composerStartRestartGroup, 0), (Modifier) null, p147o00Oo0Oo.o000OOo.OooO0OO(composerStartRestartGroup).f37701OooO, TextUnitKt.getSp(15), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composerStartRestartGroup, 3072, 0, 131058);
            ...
            composer2 = composerStartRestartGroup;
            TextKt.m1251Text4IGK_g(StringResources_androidKt.stringResource(oO00OOo0.event_auto_add_calendar, composerStartRestartGroup, 0), (Modifier) null, p147o00Oo0Oo.o000OOo.OooO0OO(composerStartRestartGroup).f37712OooOO0o, TextUnitKt.getSp(12), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 3072, 0, 131058);
    ...
    public final void EnableCalendarPermissions(Composer composer, int i) {
        ...
        if ((i & 1) == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            if (((EventSettingViewModel) viewModel).getHasPermissions().getValue().booleanValue()) {
                ...
                Modifier.Companion companion = Modifier.INSTANCE;
                Modifier modifierM480paddingqDBjuR0$default = PaddingKt.m480paddingqDBjuR0$default(SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), 0.0f, Dp.m3765constructorimpl(10), 0.0f, 0.0f, 13, null);
                ...
                androidx.compose.animation.OooOO0.OooO00o(0, function3ModifierMaterializerOf, SkippableUpdater.m1300boximpl(SkippableUpdater.m1301constructorimpl(composerStartRestartGroup)), composerStartRestartGroup, 2058660585);
                ColumnScopeInstance columnScopeInstance = ColumnScopeInstance.INSTANCE;
                TextKt.m1251Text4IGK_g(StringResources_androidKt.stringResource(oO00OOo0.event_setting_enable_desc, composerStartRestartGroup, 0), (Modifier) null, p147o00Oo0Oo.o000OOo.OooO0OO(composerStartRestartGroup).f37712OooOO0o, TextUnitKt.getSp(12), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composerStartRestartGroup, 3072, 0, 131058);
                composer2 = composerStartRestartGroup;
                p150o00Oo0oO.o00000O.OooO00o(14, companion, composer2, 6);
                TextKt.m1251Text4IGK_g(StringResources_androidKt.stringResource(oO00OOo0.event_setting_enable, composer2, 0), com.code.android.util.o0O0O00.OooO0O0(PaddingKt.m478paddingVpY3zN4$default(BackgroundKt.m168backgroundbw27NRU(PaddingKt.m478paddingVpY3zN4$default(SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), Dp.m3765constructorimpl(46), 0.0f, 2, null), p147o00Oo0Oo.o000OOo.OooO0OO(composer2).f37702OooO00o, RoundedCornerShapeKt.getCircleShape()), 0.0f, Dp.m3765constructorimpl(12), 1, null), false, false, 0L, false, null, null, null, new OooOO0(context), 253), o0oO0O0o.f46946OooO0O0, TextUnitKt.getSp(15), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, TextAlign.m3664boximpl(TextAlign.INSTANCE.m3671getCentere0LSkKk()), 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 3072, 0, 130544);
                SpacerKt.Spacer(SizeKt.m509height3ABfNKs(companion, Dp.m3765constructorimpl(19)), composer2, 6);
    ...
    public void Content(@NotNull ColumnScope columnScope, @Nullable Composer composer, int i) {
        ...
        if ((i2 & 81) == 16 && composerStartRestartGroup.getSkipping()) {
            ...
            t1.OooO00o(StringResources_androidKt.stringResource(oO00OOo0.event_setting, composerStartRestartGroup, 0), 0.0f, 0L, null, null, null, null, null, null, composerStartRestartGroup, 0, 510);
            int i3 = (i2 >> 3) & 14;
            composer2 = composerStartRestartGroup;
