...
public final class o0OOO0o {
    ...
    @NotNull
    public final AppCompatActivity f27656OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public final Lazy f27657OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public MomentMessage f27658OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @Nullable
    public BaseMomentDetailVM f27659OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @Nullable
    public YallaChatVM f27660OooO0o0;

    public static final class OooO00o extends Lambda implements Function0<o0ooOOo> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ PagingViewHolder f27661OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(PagingViewHolder pagingViewHolder) {
            super(0);
            this.f27661OooO0Oo = pagingViewHolder;
        }

        @Override // kotlin.jvm.functions.Function0
        public final o0ooOOo invoke() {
            return new o0ooOOo(this.f27661OooO0Oo);
        }
    }
    ...
    public static final class OooO0O0 extends p466o0Oooo0o.oo00o {
        ...
        public static final class OooO00o extends Lambda implements Function1<List<MomentCommentDetailModel>, Unit> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ Ref.ObjectRef<MomentCommentDetailModel> f27663OooO0Oo;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public OooO00o(Ref.ObjectRef<MomentCommentDetailModel> objectRef) {
                super(1);
                this.f27663OooO0Oo = objectRef;
            }
            ...
            public final Unit invoke(List<MomentCommentDetailModel> list) {
                ...
                if (list2 != null && list2.size() > 0) {
                    this.f27663OooO0Oo.element = list2.get(0);
                }
        ...
        public static final class C0330OooO0O0 extends Lambda implements Function1<ApiResult<List<MomentCommentDetailModel>>, Unit> {

            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ Ref.ObjectRef<MomentCommentDetailModel> f27664OooO0Oo;

            /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
            public final /* synthetic */ MomentDetailModel f27665OooO0o;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public final /* synthetic */ o0OOO0o f27666OooO0o0;

            /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
            public final /* synthetic */ MomentCommentDetailModel f27667OooO0oO;

            /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
            public final /* synthetic */ MomentReplyModel f27668OooO0oo;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C0330OooO0O0(Ref.ObjectRef<MomentCommentDetailModel> objectRef, o0OOO0o o0ooo0o2, MomentDetailModel momentDetailModel, MomentCommentDetailModel momentCommentDetailModel, MomentReplyModel momentReplyModel) {
                super(1);
                this.f27664OooO0Oo = objectRef;
                this.f27666OooO0o0 = o0ooo0o2;
                this.f27665OooO0o = momentDetailModel;
                this.f27667OooO0oO = momentCommentDetailModel;
                this.f27668OooO0oo = momentReplyModel;
            }
            ...
            public final Unit invoke(ApiResult<List<MomentCommentDetailModel>> apiResult) {
                ...
                Ref.ObjectRef<MomentCommentDetailModel> objectRef = this.f27664OooO0Oo;
                String userid = objectRef.element.getUserid();
                boolean z = userid == null || userid.length() == 0;
                o0OOO0o o0ooo0o2 = this.f27666OooO0o0;
                if (z) {
                    int i = MomentDetailActivity.f26057Oooo0;
                    MomentDetailActivity.OooO00o.OooO00o(o0ooo0o2.f27656OooO00o, this.f27665OooO0o, (PSKKeyManager.MAX_KEY_LENGTH_BYTES & 4) != 0 ? false : false, (PSKKeyManager.MAX_KEY_LENGTH_BYTES & 8) != 0 ? 1 : -1, (PSKKeyManager.MAX_KEY_LENGTH_BYTES & 16) != 0 ? null : this.f27667OooO0oO, (PSKKeyManager.MAX_KEY_LENGTH_BYTES & 32) != 0 ? false : false, (PSKKeyManager.MAX_KEY_LENGTH_BYTES & 64) != 0 ? null : MomentAdapterTag.MomentMessageList, (PSKKeyManager.MAX_KEY_LENGTH_BYTES & 128) != 0 ? false : false, (PSKKeyManager.MAX_KEY_LENGTH_BYTES & PSKKeyManager.MAX_KEY_LENGTH_BYTES) != 0 ? "" : null);
                } else {
                    int i2 = MomentReplyActivity.f26149OooOoO;
                    MomentReplyActivity.OooO00o.OooO00o(o0ooo0o2.f27656OooO00o, false, this.f27665OooO0o, objectRef.element, this.f27668OooO0oo);
                }
                return Unit.INSTANCE;
            }
        }
        ...
        public static final class OooO0OO extends Lambda implements Function1<TopicGroupInfoModel, Unit> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ MomentMessage.TopicGroupCreateSuccessNotice f27669OooO0Oo;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public OooO0OO(MomentMessage.TopicGroupCreateSuccessNotice topicGroupCreateSuccessNotice) {
                super(1);
                this.f27669OooO0Oo = topicGroupCreateSuccessNotice;
            }
            ...
            public final Unit invoke(TopicGroupInfoModel topicGroupInfoModel) {
                ...
                if (topicGroupInfoModel2 != null) {
                    if (topicGroupInfoModel2.getIsDisbanded() || topicGroupInfoModel2.getCircleUserIsCancel()) {
                        String strOooO0OO = com.code.android.util.o0000.OooO0OO(oO00OOo0.topic_group_join_dissolved);
                        ...
                        MomentMessage.TopicGroupCreateSuccessNotice topicGroupCreateSuccessNotice = this.f27669OooO0Oo;
                        ...
                        oo0oOO0.OooO0o0(TopicGroupJoinScreen.INSTANCE, p063o0000oO.o00Ooo.OooO0O0(TuplesKt.to("DATA", topicGroupInfoModel2)), false, null, 12);
                    }
                }
                return Unit.INSTANCE;
            }
        ...
        public final void OooO00o(@NotNull View v) {
            ...
            if (id == i) {
                MomentMessage momentMessage2 = o0ooo0o2.f27658OooO0OO;
                ...
                if (type == 19) {
                    UserInfoActivity.OooO00o oooO00o3 = UserInfoActivity.f27240Oooo0o;
                ...
                switch (type) {
                    case 1:
                        UserInfoActivity.OooO00o oooO00o4 = UserInfoActivity.f27240Oooo0o;
                        ...
                        break;
                    case 2:
                        UserInfoActivity.OooO00o oooO00o5 = UserInfoActivity.f27240Oooo0o;
                        ...
                        break;
                    case 3:
                        UserInfoActivity.OooO00o oooO00o6 = UserInfoActivity.f27240Oooo0o;
                        ...
                        break;
                    case 4:
                        UserInfoActivity.OooO00o oooO00o7 = UserInfoActivity.f27240Oooo0o;
                        ...
                        break;
                    case 5:
                        UserInfoActivity.OooO00o oooO00o8 = UserInfoActivity.f27240Oooo0o;
                        ...
                        break;
                    case 6:
                        UserInfoActivity.OooO00o oooO00o9 = UserInfoActivity.f27240Oooo0o;
                        ...
                        break;
                    case 7:
                        UserInfoActivity.OooO00o oooO00o10 = UserInfoActivity.f27240Oooo0o;
                        ...
                        break;
                    case 8:
                        UserInfoActivity.OooO00o oooO00o11 = UserInfoActivity.f27240Oooo0o;
                        ...
                        break;
                    case 9:
                        UserInfoActivity.OooO00o oooO00o12 = UserInfoActivity.f27240Oooo0o;
                    ...
                    default:
                        switch (type) {
                            case 12:
                                UserInfoActivity.OooO00o oooO00o13 = UserInfoActivity.f27240Oooo0o;
                                ...
                                break;
                            case 13:
                                UserInfoActivity.OooO00o oooO00o14 = UserInfoActivity.f27240Oooo0o;
                                ...
                                break;
                            case 14:
                                UserInfoActivity.OooO00o oooO00o15 = UserInfoActivity.f27240Oooo0o;
            ...
            if (!(((((((id == oO00O0oO.layout || id == oO00O0oO.layoutContent) != false || id == oO00O0oO.tvName) != false || id == oO00O0oO.ivLike) != false || id == oO00O0oO.ivReward) != false || id == oO00O0oO.tvContent) != false || id == oO00O0oO.tvTime) == true || id == oO00O0oO.ivImage)) {
                if (id == oO00O0oO.tvReply) {
                    o0OO000.OooO00o("103022");
                    ...
                    com.squareup.okhttp.OooOo.OooO0OO(553, momentMessage);
                    return;
                }
                return;
            }
            ...
            if (type2 != -12) {
                switch (type2) {
                    ...
                    case 14:
                        ...
                        break;
                    case 15:
                        com.code.android.util.o000O00O.OooO00o(oO00OOo0.moment_delete_by_user);
                        break;
                    case 16:
                    ...
                    case 17:
                        ...
                        if (commentReportFeedback != null) {
                            AppCompatActivity appCompatActivity2 = o0ooo0o2.f27656OooO00o;
                            ...
                            BaseMomentDetailVM baseMomentDetailVM = o0ooo0o2.f27659OooO0Oo;
                            if (baseMomentDetailVM != null && (commentInfo = baseMomentDetailVM.getCommentInfo(com.code.android.util.o0OoOo0.OooOO0(commentReportFeedback.getCommentId()))) != null) {
                                commentInfo.observe(appCompatActivity2, new p377o0OOoOo.o0000OO0(new o0Oo0oo(oo0o0oo), null, new o0OO00O(o0ooo0o2), false, 10));
                            }
                        }
                        break;
                    case 18:
            ...
            com.squareup.okhttp.OooOo.OooO0OO(553, null);
        }
        ...
        public final void OooO0O0(Long l, Long l2, MomentCommentDetailModel momentCommentDetailModel) {
            ...
            if (l != null) {
                ...
                liveDataCommentParentCommentInfo.observe(o0ooo0o2.f27656OooO00o, new p377o0OOoOo.o0000OO0(new OooO00o(objectRef), null, new C0330OooO0O0(objectRef, o0ooo0o2, momentDetailModel, momentCommentDetailModel, momentReplyModel), false, 10));
            }
        }
        ...
        public final void OooO0Oo(Long l) {
            if (l != null) {
                ...
                TopicDetailActivity.OooO00o.OooO00o(o0OOO0o.this.f27656OooO00o, topicInfoModel);
            }
        }
        ...
        public final void OooO0o0(MomentMessage.TopicGroupCreateSuccessNotice topicGroupCreateSuccessNotice) {
            ...
            if (topicGroupCreateSuccessNotice == null || (yallaChatVM = (o0ooo0o2 = o0OOO0o.this).f27660OooO0o0) == null || (groupInfo = yallaChatVM.getGroupInfo(com.code.android.util.o0OoOo0.OooOO0(topicGroupCreateSuccessNotice.getCircleId()))) == null) {
                return;
            }
            groupInfo.observe(o0ooo0o2.f27656OooO00o, new p377o0OOoOo.o0000OO0(new OooO0OO(topicGroupCreateSuccessNotice), null, null, false, 14));
        }
    }
    ...
    public o0OOO0o(@NotNull AppCompatActivity activity, @NotNull PagingViewHolder viewHolder) {
        ...
        this.f27656OooO00o = activity;
        this.f27657OooO0O0 = LazyKt.lazy(new OooO00o(viewHolder));
        OooO0O0 oooO0O0 = new OooO0O0();
        OooO00o().f27675OooO00o.setOnClickListener(oooO0O0);
        OooO00o().f27676OooO0O0.setOnClickListener(oooO0O0);
        OooO00o().f27677OooO0OO.setOnClickListener(oooO0O0);
        OooO00o().f27678OooO0Oo.setOnClickListener(oooO0O0);
        OooO00o().f27680OooO0o0.setOnClickListener(oooO0O0);
        OooO00o().f27679OooO0o.setOnClickListener(oooO0O0);
        OooO00o().f27681OooO0oO.setOnClickListener(oooO0O0);
        OooO00o().f27682OooO0oo.setOnClickListener(oooO0O0);
        OooO00o().f27674OooO.setOnClickListener(oooO0O0);
        OooO00o().f27683OooOO0.setOnClickListener(oooO0O0);
        OooO00o().f27684OooOO0O.setOnClickListener(oooO0O0);
        OooO00o().f27685OooOO0o.setOnClickListener(oooO0O0);
    }

    public final void OooO() {
        MomentMessage momentMessage = this.f27658OooO0OO;
        ...
        if (momentTopicRemoveAdmin != null) {
            AppCompatActivity appCompatActivity = this.f27656OooO00o;
            o0OOo0O.OooOO0.OooO00o oooO00o = new o0OOo0O.OooOO0.OooO00o(appCompatActivity);
            oooO00o.OooO00o(p543o0oO0O00.OooO.OooO0OO());
            oooO00o.f43911OooO0OO = momentTopicRemoveAdmin.getUserHeadUrl();
            oooO00o.f43909OooO00o = 0;
            oooO00o.OooO0Oo(OooO00o().f27676OooO0O0);
            OooO00o().f27677OooO0OO.setText(com.code.android.util.o0000.OooO0OO(oO00OOo0.MessageFragment_moment_postRemoved));
            OooO00o().f27679OooO0o.setText(com.code.android.util.o0000O.OooO00o(com.code.android.util.o0000.OooO0OO(oO00OOo0.moment_message_removed_from_xxx_topic_admin), momentTopicRemoveAdmin.getTopicName()));
            OooO00o().f27679OooO0o.setVisibility(0);
            TextView textView = OooO00o().f27681OooO0oO;
            MomentMessage momentMessage3 = this.f27658OooO0OO;
            if (momentMessage3 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("data");
            } else {
                momentMessage2 = momentMessage3;
            }
            textView.setText(p601o0oo0O0.o0000oo.OooO0Oo(momentMessage2.getTime(), System.currentTimeMillis()));
            OooO00o().f27682OooO0oo.setVisibility(8);
            OooO00o().f27674OooO.setVisibility(4);
            if (TextUtils.isEmpty(momentTopicRemoveAdmin.getMomentImageUrl())) {
                return;
            }
            OooO00o().f27674OooO.setVisibility(0);
            o0OOo0O.OooOO0.OooO00o oooO00o2 = new o0OOo0O.OooOO0.OooO00o(appCompatActivity);
            oooO00o2.OooO00o(p543o0oO0O00.OooO.OooO0Oo());
            oooO00o2.OooO0o0(6);
            oooO00o2.f43911OooO0OO = p396o0Oo0O.OooOOO.OooO00o(momentTopicRemoveAdmin.getMomentImageUrl());
            oooO00o2.f43909OooO00o = 0;
            oooO00o2.OooO0Oo(OooO00o().f27674OooO);
        }
    }

    public final o0ooOOo OooO00o() {
        return (o0ooOOo) this.f27657OooO0O0.getValue();
    }
    ...
    public final void OooO0O0() {
        ...
        if (circleReportFeedback != null) {
            OooO00o().f27676OooO0O0.setImageResource(oOo00OO0.icon_moment_featurd_head);
            OooO00o().f27677OooO0OO.setText(!TextUtils.isEmpty(com.code.android.util.o0OoOo0.OooOOO(circleReportFeedback.getCircleTitle(), "")) ? com.code.android.util.o0OoOo0.OooOOO(circleReportFeedback.getCircleTitle(), "") : com.code.android.util.o0000.OooO0OO(oO00OOo0.Thanks_for_your_report));
            OooO00o().f27679OooO0o.setText(com.code.android.util.o0OoOo0.OooOOO(circleReportFeedback.getCircleContent(), ""));
            OooO00o().f27679OooO0o.setVisibility(0);
            TextView textView = OooO00o().f27681OooO0oO;
            MomentMessage momentMessage3 = this.f27658OooO0OO;
            if (momentMessage3 == null) {
            ...
            String strOooO0oo = p139o00OOooO.OooO0o.OooO0oo(iOooO00o, iOooO00o, strOooOOO);
            o0OOo0O.OooOO0.OooO00o oooO00o = new o0OOo0O.OooOO0.OooO00o(this.f27656OooO00o);
            oooO00o.OooO00o(p543o0oO0O00.OooO.OooO0Oo());
            oooO00o.OooO0o0(6);
            oooO00o.f43911OooO0OO = strOooO0oo;
            oooO00o.f43909OooO00o = 0;
            oooO00o.OooO0Oo(OooO00o().f27674OooO);
        }
    }
    ...
    public final void OooO0OO() {
        ...
        if (commentFeatured != null) {
            OooO00o().f27676OooO0O0.setImageResource(oOo00OO0.ic_moment_message_featured_add);
            OooO00o().f27677OooO0OO.setText(com.code.android.util.o0000.OooO0OO(oO00OOo0.Moment_Message_comment_featured));
            OooO00o().f27679OooO0o.setText("");
            ...
            if (momentSendContentModel != null) {
                p595o0oo00Oo.o0000Ooo.OooO0OO(appCompatActivity, momentSendContentModel, OooO00o().f27679OooO0o, null);
                OooO00o().f27679OooO0o.getEditableText().insert(0, Html.fromHtml("<font color='#999999'> " + com.code.android.util.o0000.OooO0OO(oO00OOo0.MessageFragment_moment_comment_postFeatured_itemInfo) + "</font> "));
            }
            OooO00o().f27679OooO0o.setVisibility(0);
            TextView textView = OooO00o().f27681OooO0oO;
            MomentMessage momentMessage3 = this.f27658OooO0OO;
            ...
            OooO00o().f27674OooO.setVisibility(0);
            String strOooO0O0 = p139o00OOooO.OooO0o.OooO0O0(com.code.android.util.o0000O0.OooO00o(120), commentFeatured.getMomentImageUrl());
            o0OOo0O.OooOO0.OooO00o oooO00o = new o0OOo0O.OooOO0.OooO00o(appCompatActivity);
            oooO00o.OooO00o(p543o0oO0O00.OooO.OooO0Oo());
            oooO00o.OooO0o0(6);
            oooO00o.f43911OooO0OO = strOooO0O0;
            oooO00o.f43909OooO00o = 0;
            oooO00o.OooO0Oo(OooO00o().f27674OooO);
        }
    }
    ...
    public final void OooO0Oo() {
        ...
        if (commentReportFeedback != null) {
            OooO00o().f27676OooO0O0.setImageResource(oOo00OO0.icon_moment_featurd_head);
            OooO00o().f27677OooO0OO.setText(!TextUtils.isEmpty(com.code.android.util.o0OoOo0.OooOOO(commentReportFeedback.getTitle(), "")) ? com.code.android.util.o0OoOo0.OooOOO(commentReportFeedback.getTitle(), "") : com.code.android.util.o0000.OooO0OO(oO00OOo0.Thanks_for_your_report));
            OooO00o().f27679OooO0o.setText(commentReportFeedback.getContent());
            OooO00o().f27679OooO0o.setVisibility(0);
            TextView textView = OooO00o().f27681OooO0oO;
            MomentMessage momentMessage3 = this.f27658OooO0OO;
            if (momentMessage3 == null) {
            ...
            OooO00o().f27674OooO.setVisibility(0);
            String strOooO0O0 = p139o00OOooO.OooO0o.OooO0O0(com.code.android.util.o0000O0.OooO00o(120), commentReportFeedback.getMomentImageUrl());
            o0OOo0O.OooOO0.OooO00o oooO00o = new o0OOo0O.OooOO0.OooO00o(this.f27656OooO00o);
            oooO00o.OooO00o(p543o0oO0O00.OooO.OooO0Oo());
            oooO00o.OooO0o0(6);
            oooO00o.f43911OooO0OO = strOooO0O0;
    ...
    public final void OooO0o() {
        ...
        if (momentSystemRemove != null) {
            OooO00o().f27676OooO0O0.setImageResource(oOo00OO0.ic_moment_message_delete);
            OooO00o().f27677OooO0OO.setText(com.code.android.util.o0000.OooO0OO(oO00OOo0.Post_Deleted));
            String strOooO00o = ooOOOOoo.OooO00o(momentSystemRemove.getDeleteType());
            MomentMessage momentMessage3 = this.f27658OooO0OO;
            if (momentMessage3 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("data");
            } else {
            ...
            String strOooO0Oo = p601o0oo0O0.o0000oo.OooO0Oo(momentMessage2.getTime(), System.currentTimeMillis());
            OooO00o().f27679OooO0o.setText(com.code.android.util.o0000O.OooO00o(com.code.android.util.o0000O.OooO00o(com.code.android.util.o0000.OooO0OO(oO00OOo0.We_deleted_your_post_posted_XXX_for_XXX), strOooO0Oo), strOooO00o));
            OooO00o().f27679OooO0o.setVisibility(0);
            OooO00o().f27681OooO0oO.setText(strOooO0Oo);
            OooO00o().f27682OooO0oo.setVisibility(8);
            OooO00o().f27674OooO.setVisibility(4);
            ...
            OooO00o().f27674OooO.setVisibility(0);
            String strOooO0O0 = p139o00OOooO.OooO0o.OooO0O0(com.code.android.util.o0000O0.OooO00o(120), momentSystemRemove.getMomentImageUrl());
            o0OOo0O.OooOO0.OooO00o oooO00o = new o0OOo0O.OooOO0.OooO00o(this.f27656OooO00o);
            oooO00o.OooO00o(p543o0oO0O00.OooO.OooO0Oo());
            oooO00o.OooO0o0(6);
            oooO00o.f43911OooO0OO = strOooO0O0;
    ...
    public final void OooO0o0() {
        ...
        if (momentReportFeedback != null) {
            OooO00o().f27676OooO0O0.setImageResource(oOo00OO0.icon_moment_featurd_head);
            OooO00o().f27677OooO0OO.setText(!TextUtils.isEmpty(com.code.android.util.o0OoOo0.OooOOO(momentReportFeedback.getMomentTitle(), "")) ? com.code.android.util.o0OoOo0.OooOOO(momentReportFeedback.getMomentTitle(), "") : com.code.android.util.o0000.OooO0OO(oO00OOo0.Thanks_for_your_report));
            OooO00o().f27679OooO0o.setText(momentReportFeedback.getMomentContent());
            OooO00o().f27679OooO0o.setVisibility(0);
            TextView textView = OooO00o().f27681OooO0oO;
            MomentMessage momentMessage3 = this.f27658OooO0OO;
            if (momentMessage3 == null) {
            ...
            OooO00o().f27674OooO.setVisibility(0);
            String strOooO0O0 = p139o00OOooO.OooO0o.OooO0O0(com.code.android.util.o0000O0.OooO00o(120), momentReportFeedback.getMomentImageUrl());
            o0OOo0O.OooOO0.OooO00o oooO00o = new o0OOo0O.OooOO0.OooO00o(this.f27656OooO00o);
            oooO00o.OooO00o(p543o0oO0O00.OooO.OooO0Oo());
            oooO00o.OooO0o0(6);
            oooO00o.f43911OooO0OO = strOooO0O0;
    ...
    public final void OooO0oO() {
        ...
        if (topicGroupCreateSuccessNotice != null) {
            ...
            o0OOo0O.OooOO0.OooO00o oooO00o = new o0OOo0O.OooOO0.OooO00o(appCompatActivity);
            oooO00o.OooO00o(p543o0oO0O00.OooO.OooO0OO());
            oooO00o.f43911OooO0OO = com.code.android.util.o0OoOo0.OooOOO(topicGroupCreateSuccessNotice.getHeadUrl(), "");
            oooO00o.f43909OooO00o = 0;
            oooO00o.OooO0Oo(OooO00o().f27676OooO0O0);
            OooO00o().f27677OooO0OO.setText(com.code.android.util.o0OoOo0.OooOOO(topicGroupCreateSuccessNotice.getNickName(), ""));
            OooO00o().f27679OooO0o.setText(com.code.android.util.o0000O.OooO00o(com.code.android.util.o0000.OooO0OO(oO00OOo0.topic_group_create_success_notify_xxx), com.code.android.util.o0OoOo0.OooOOO(topicGroupCreateSuccessNotice.getCircleName(), "")));
            OooO00o().f27679OooO0o.setVisibility(0);
            TextView textView = OooO00o().f27681OooO0oO;
            MomentMessage momentMessage3 = this.f27658OooO0OO;
            if (momentMessage3 == null) {
            ...
            oooO00o2.OooO00o(p543o0oO0O00.OooO.OooO0Oo());
            oooO00o2.OooO0o0(6);
            oooO00o2.f43911OooO0OO = p396o0Oo0O.OooOOO.OooO00o(topicGroupCreateSuccessNotice.getCircleHead());
            oooO00o2.f43909OooO00o = 0;
            oooO00o2.OooO0Oo(OooO00o().f27674OooO);
        }
    }
    ...
    public final void OooO0oo() {
        ...
        if (topicGroupCreateSuccessNotice != null) {
            ...
            oooO00o.OooO0Oo(OooO00o().f27676OooO0O0);
            OooO00o().f27677OooO0OO.setText(com.code.android.util.o0OoOo0.OooOOO(topicGroupCreateSuccessNotice.getNickName(), ""));
            OooO00o().f27679OooO0o.setText(com.code.android.util.o0000O.OooO00o(com.code.android.util.o0000.OooO0OO(oO00OOo0.topic_group_join_success_notify_xxx), com.code.android.util.o0OoOo0.OooOOO(topicGroupCreateSuccessNotice.getCircleName(), "")));
            OooO00o().f27679OooO0o.setVisibility(0);
            TextView textView = OooO00o().f27681OooO0oO;
            MomentMessage momentMessage3 = this.f27658OooO0OO;
            if (momentMessage3 == null) {
    ...
    public final void OooOO0() {
        ...
        if (momentTopicRemoveOwner != null) {
            ...
            o0OOo0O.OooOO0.OooO00o oooO00o = new o0OOo0O.OooOO0.OooO00o(appCompatActivity);
            oooO00o.OooO00o(p543o0oO0O00.OooO.OooO0OO());
            oooO00o.f43911OooO0OO = momentTopicRemoveOwner.getUserHeadUrl();
            oooO00o.f43909OooO00o = 0;
            oooO00o.OooO0Oo(OooO00o().f27676OooO0O0);
            OooO00o().f27677OooO0OO.setText(com.code.android.util.o0000.OooO0OO(oO00OOo0.MessageFragment_moment_postRemoved));
            OooO00o().f27679OooO0o.setText(com.code.android.util.o0000O.OooO00o(com.code.android.util.o0000.OooO0OO(oO00OOo0.MessageFragment_moment_postRemoved_itemInfo), momentTopicRemoveOwner.getTopicName()));
            OooO00o().f27679OooO0o.setVisibility(0);
            TextView textView = OooO00o().f27681OooO0oO;
            MomentMessage momentMessage3 = this.f27658OooO0OO;
            if (momentMessage3 == null) {
            ...
            oooO00o2.OooO00o(p543o0oO0O00.OooO.OooO0Oo());
            oooO00o2.OooO0o0(6);
            oooO00o2.f43911OooO0OO = p396o0Oo0O.OooOOO.OooO00o(momentTopicRemoveOwner.getMomentImageUrl());
            oooO00o2.f43909OooO00o = 0;
            oooO00o2.OooO0Oo(OooO00o().f27674OooO);
        }
    }
    ...
    public final void OooOO0O() {
        ...
        if (momentTopicTop != null) {
            OooO00o().f27676OooO0O0.setImageResource(oOo00OO0.ic_moment_message_pinned);
            OooO00o().f27677OooO0OO.setText(com.code.android.util.o0000.OooO0OO(oO00OOo0.MessageFragment_moment_postPinned));
            OooO00o().f27679OooO0o.setText(com.code.android.util.o0000O.OooO00o(com.code.android.util.o0000.OooO0OO(oO00OOo0.MessageFragment_moment_postPinned_itemInfo), momentTopicTop.getTopicName()));
            OooO00o().f27679OooO0o.setVisibility(0);
            TextView textView = OooO00o().f27681OooO0oO;
            MomentMessage momentMessage3 = this.f27658OooO0OO;
            if (momentMessage3 == null) {
            ...
            oooO00o.OooO00o(p543o0oO0O00.OooO.OooO0Oo());
            oooO00o.OooO0o0(6);
            oooO00o.f43911OooO0OO = p396o0Oo0O.OooOOO.OooO00o(momentTopicTop.getMomentImageUrl());
            oooO00o.f43909OooO00o = 0;
            oooO00o.OooO0Oo(OooO00o().f27674OooO);
        }
    }
    ...
    public final void OooOO0o() {
        ...
        if (replyReward != null) {
            ...
            o0OOo0O.OooOO0.OooO00o oooO00o = new o0OOo0O.OooOO0.OooO00o(appCompatActivity);
            oooO00o.OooO00o(p543o0oO0O00.OooO.OooO0OO());
            oooO00o.f43911OooO0OO = replyReward.getUserHeadUrl();
            oooO00o.f43909OooO00o = 0;
            oooO00o.OooO0Oo(OooO00o().f27676OooO0O0);
            OooO00o().f27677OooO0OO.setText(oOO0O0O.OooO0O0(replyReward.getUserId(), replyReward.getUserNickName()));
            TextView textView = OooO00o().f27681OooO0oO;
            MomentMessage momentMessage2 = this.f27658OooO0OO;
            if (momentMessage2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("data");
                momentMessage2 = null;
            }
            ...
            if (com.code.android.util.OooOo00.OooO0O0(replyReward.getMomentImageUrl())) {
                ...
                oooO00o2.OooO00o(p543o0oO0O00.OooO.OooO0Oo());
                oooO00o2.OooO0o0(6);
                oooO00o2.f43911OooO0OO = replyReward.getMomentImageUrl();
                oooO00o2.f43909OooO00o = 0;
                oooO00o2.OooO0Oo(OooO00o().f27674OooO);
                OooO00o().f27674OooO.setVisibility(0);
            } else {
            ...
            OooO00o().f27680OooO0o0.setVisibility(0);
            OooO00o().f27680OooO0o0.setImageResource(oOo00OO0.ic_moment_comment_reward_color);
            OooO00o().f27685OooOO0o.setVisibility(0);
            ...
            p595o0oo00Oo.o0000Ooo.OooO0OO(appCompatActivity, momentSendContentModel, OooO00o().f27685OooOO0o, null);
            OooO00o().f27685OooOO0o.getEditableText().insert(0, Html.fromHtml("<font color='#999999'> " + com.code.android.util.o0000.OooO0OO(oO00OOo0.moment_message_reward_comments_title) + "</font> "));
        }
    }
}
