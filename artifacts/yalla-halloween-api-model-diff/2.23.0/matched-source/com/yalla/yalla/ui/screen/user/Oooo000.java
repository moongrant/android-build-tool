...
public final class Oooo000 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ CustomizeThemeModel f29999OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ RoomThemeVM f30000OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public Oooo000(CustomizeThemeModel customizeThemeModel, RoomThemeVM roomThemeVM) {
        super(0);
        this.f29999OooO0Oo = customizeThemeModel;
        this.f30000OooO0o0 = roomThemeVM;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        RoomThemeCustomScreen.INSTANCE.onRenewals(this.f29999OooO0Oo, this.f30000OooO0o0);
