...
public final class LanguageView extends TextView {
    ...
    public final void setLanguage(int region) {
        int i;
        this.f30480OooO0Oo = region;
        if (!this.translation) {
            switch (region) {
                case 0:
                    i = oO00OOo0.single_language_English;
                    break;
                case 1:
                    i = oO00OOo0.single_language_Arabic;
                    break;
                case 2:
                    i = oO00OOo0.single_language_Turkish;
                    break;
                case 3:
                    i = oO00OOo0.single_language_Indonesia;
                    break;
                case 4:
                    i = oO00OOo0.single_language_Japanese;
                    break;
                case 5:
                    i = oO00OOo0.single_language_Portugal;
                    break;
                case 6:
                    i = oO00OOo0.single_language_Espana;
                    break;
                case 7:
                    i = oO00OOo0.single_language_Hindi;
                    break;
                case 8:
                    i = oO00OOo0.single_language_Urdu;
                    break;
                default:
                    i = -1;
                    break;
    ...
    public final void setTranslation(boolean z) {
        if (this.translation != z) {
            this.translation = z;
            setLanguage(this.f30480OooO0Oo);
        }
    }
