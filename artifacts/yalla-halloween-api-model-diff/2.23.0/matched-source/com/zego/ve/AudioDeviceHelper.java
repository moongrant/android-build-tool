...
public class AudioDeviceHelper {
    ...
    public static int getCurrentRoute(Context context, int i, boolean z) {
        ...
        StringBuilder sbOooO00o = o0OoOo0.OooO00o("current route:", string, " select route type:");
        sbOooO00o.append(RoutType2String(i2));
        Log.i(DeviceRequestsHelper.DEVICE_INFO_DEVICE, sbOooO00o.toString());
        return i2;
    }
