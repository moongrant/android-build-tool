...
public final class TypeReference implements KType {
    ...
    private final String asString(boolean convertPrimitiveToWrapper) {
        ...
        String strOooO00o = o0OoOo0.OooO00o(name, getArguments().isEmpty() ? "" : CollectionsKt___CollectionsKt.joinToString$default(getArguments(), ", ", "<", ">", 0, null, new Function1<KTypeProjection, CharSequence>() { // from class: kotlin.jvm.internal.TypeReference$asString$args$1
            {
                super(1);
            }
    ...
    public String toString() {
        return o0O00o0.OooO0O0(new StringBuilder(), asString(false), " (Kotlin reflection is not available)");
    }
