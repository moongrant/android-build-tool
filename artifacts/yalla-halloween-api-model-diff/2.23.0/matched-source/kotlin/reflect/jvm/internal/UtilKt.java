    ...
    */
    private static final Object arrayToRuntimeValue(ArrayValue arrayValue, ClassLoader classLoader) {
        ...
        switch (primitiveArrayElementType == null ? -1 : WhenMappings.$EnumSwitchMapping$0[primitiveArrayElementType.ordinal()]) {
            case -1:
                ...
                ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor = type2.getConstructor().mo5502getDeclarationDescriptor();
    ...
    private static final Object toRuntimeValue(ConstantValue<?> constantValue, ClassLoader classLoader) {
        ...
        if (constantValue instanceof EnumValue) {
            ...
            ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor = ((KClassValue.Value.LocalClass) value2).getType().getConstructor().mo5502getDeclarationDescriptor();
            ClassDescriptor classDescriptor = classifierDescriptorMo5502getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo5502getDeclarationDescriptor : null;
            if (classDescriptor != null) {
    ...
    private static final Class<?> loadClass(ClassLoader classLoader, String str, String str2, int i) {
        if (Intrinsics.areEqual(str, Constants.SDK_LANGUAGE)) {
