...
public abstract class KotlinBuiltIns {
    ...
    public KotlinBuiltIns(@NotNull StorageManager storageManager) {
        ...
        this.builtInClassesByName = storageManager.createMemoizedFunction(new Function1<Name, ClassDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.3
            ...
            public ClassDescriptor invoke(Name name) {
                ClassifierDescriptor classifierDescriptorMo5504getContributedClassifier = KotlinBuiltIns.this.getBuiltInsPackageScope().mo5504getContributedClassifier(name, NoLookupLocation.FROM_BUILTINS);
                ...
                throw new AssertionError("Must be a class descriptor " + name + ", but was " + classifierDescriptorMo5504getContributedClassifier);
            }
        });
    }
    ...
    public static PrimitiveType getPrimitiveArrayElementType(@NotNull KotlinType kotlinType) {
        ...
        return getPrimitiveArrayType(classifierDescriptorMo5502getDeclarationDescriptor);
    }
    ...
    public static boolean isPrimitiveArray(@NotNull KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor = kotlinType.getConstructor().mo5502getDeclarationDescriptor();
        return (classifierDescriptorMo5502getDeclarationDescriptor == null || getPrimitiveArrayType(classifierDescriptorMo5502getDeclarationDescriptor) == null) ? false : true;
    }
    ...
    public static boolean isPrimitiveTypeOrNullablePrimitiveType(@NotNull KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor = kotlinType.getConstructor().mo5502getDeclarationDescriptor();
        return (classifierDescriptorMo5502getDeclarationDescriptor instanceof ClassDescriptor) && isPrimitiveClass((ClassDescriptor) classifierDescriptorMo5502getDeclarationDescriptor);
    }
    ...
    public static boolean isTypeConstructorForGivenClass(@NotNull TypeConstructor typeConstructor, @NotNull FqNameUnsafe fqNameUnsafe) {
        ...
        return (classifierDescriptorMo5502getDeclarationDescriptor instanceof ClassDescriptor) && classFqNameEquals(classifierDescriptorMo5502getDeclarationDescriptor, fqNameUnsafe);
    }
