...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
    ...
    private final List<String> renderAndSortAnnotationArguments(AnnotationDescriptor annotationDescriptor) {
        ClassConstructorDescriptor classConstructorDescriptorMo5496getUnsubstitutedPrimaryConstructor;
        ...
        if (annotationClass != null && (classConstructorDescriptorMo5496getUnsubstitutedPrimaryConstructor = annotationClass.mo5496getUnsubstitutedPrimaryConstructor()) != null && (valueParameters = classConstructorDescriptorMo5496getUnsubstitutedPrimaryConstructor.getValueParameters()) != null) {
    ...
    public final void renderClass(ClassDescriptor classDescriptor, StringBuilder sb) throws IOException {
        ...
        if (!classDescriptor.getKind().isSingleton() && getClassWithPrimaryConstructor() && (classConstructorDescriptorMo5496getUnsubstitutedPrimaryConstructor = classDescriptor.mo5496getUnsubstitutedPrimaryConstructor()) != null) {
            sb.append(ZegoConstants.ZegoVideoDataAuxPublishingStream);
            renderAnnotations$default(this, sb, classConstructorDescriptorMo5496getUnsubstitutedPrimaryConstructor, null, 2, null);
            DescriptorVisibility visibility2 = classConstructorDescriptorMo5496getUnsubstitutedPrimaryConstructor.getVisibility();
            Intrinsics.checkNotNullExpressionValue(visibility2, "primaryConstructor.visibility");
            renderVisibility(visibility2, sb);
            sb.append(renderKeyword("constructor"));
            List<ValueParameterDescriptor> valueParameters = classConstructorDescriptorMo5496getUnsubstitutedPrimaryConstructor.getValueParameters();
            Intrinsics.checkNotNullExpressionValue(valueParameters, "primaryConstructor.valueParameters");
            renderValueParameters(valueParameters, classConstructorDescriptorMo5496getUnsubstitutedPrimaryConstructor.hasSynthesizedParameterNames(), sb);
        }
    ...
    public final void renderConstructor(ConstructorDescriptor constructorDescriptor, StringBuilder sb) throws IOException {
        ...
        if (getRenderConstructorDelegation() && !constructorDescriptor.isPrimary() && (containingDeclaration instanceof ClassDescriptor) && (classConstructorDescriptorMo5496getUnsubstitutedPrimaryConstructor = ((ClassDescriptor) containingDeclaration).mo5496getUnsubstitutedPrimaryConstructor()) != null) {
            List<ValueParameterDescriptor> valueParameters2 = classConstructorDescriptorMo5496getUnsubstitutedPrimaryConstructor.getValueParameters();
    ...
    private final String renderError(String str) {
        ...
        if (i == 2) {
            return o000oOoO.OooO00o("<font color=red><b>", str, "</b></font>");
        }
        throw new NoWhenBranchMatchedException();
    }
    ...
    private final void renderInitializer(VariableDescriptor variableDescriptor, StringBuilder sb) {
        ConstantValue<?> constantValueMo5498getCompileTimeInitializer;
        if (!getIncludePropertyConstant() || (constantValueMo5498getCompileTimeInitializer = variableDescriptor.mo5498getCompileTimeInitializer()) == null) {
            return;
        }
        sb.append(" = ");
        sb.append(escape(renderConstant(constantValueMo5498getCompileTimeInitializer)));
    }
    ...
    private final String renderKeyword(String str) {
        ...
        if (i == 2) {
            return getBoldOnlyForNamesInHtml() ? str : o000oOoO.OooO00o("<b>", str, "</b>");
        }
        throw new NoWhenBranchMatchedException();
    }
    ...
    private final void renderSuperTypes(ClassDescriptor classDescriptor, StringBuilder sb) throws IOException {
        ...
        Collection<KotlinType> collectionMo5503getSupertypes = classDescriptor.getTypeConstructor().mo5503getSupertypes();
        Intrinsics.checkNotNullExpressionValue(collectionMo5503getSupertypes, "klass.typeConstructor.supertypes");
        if (collectionMo5503getSupertypes.isEmpty()) {
            return;
        }
        if (collectionMo5503getSupertypes.size() == 1 && KotlinBuiltIns.isAnyOrNullableAny(collectionMo5503getSupertypes.iterator().next())) {
            return;
        }
        renderSpaceIfNeeded(sb);
        sb.append(": ");
        CollectionsKt___CollectionsKt.joinTo(collectionMo5503getSupertypes, sb, (124 & 2) != 0 ? ", " : ", ", (124 & 4) != 0 ? "" : null, (124 & 8) == 0 ? null : "", (124 & 16) != 0 ? -1 : 0, (124 & 32) != 0 ? "..." : null, (124 & 64) != 0 ? null : new Function1<KotlinType, CharSequence>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl.renderSuperTypes.1
            {
                super(1);
            }
    ...
    public String renderAnnotation(@NotNull AnnotationDescriptor annotation, @Nullable AnnotationUseSiteTarget annotationUseSiteTarget) throws IOException {
        ...
        if (getVerbose() && (KotlinTypeKt.isError(type) || (type.getConstructor().mo5502getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor))) {
    ...
    public String renderFlexibleType(@NotNull String lowerRendered, @NotNull String upperRendered, @NotNull KotlinBuiltIns builtIns) {
        ...
        if (RenderingUtilsKt.typeStringsDifferOnlyInNullability(lowerRendered, upperRendered)) {
            if (StringsKt.Oooo00o(upperRendered, "(")) {
                return o000oOoO.OooO00o("(", lowerRendered, ")!");
            }
        ...
        StringBuilder sbOooO00o = o00OO.OooO00o(strSubstringBefore$default2);
        sbOooO00o.append(escape("Array<"));
        String string = sbOooO00o.toString();
        StringBuilder sbOooO00o2 = o00OO.OooO00o(strSubstringBefore$default2);
        sbOooO00o2.append(escape("Array<out "));
        String string2 = sbOooO00o2.toString();
        StringBuilder sbOooO00o3 = o00OO.OooO00o(strSubstringBefore$default2);
    ...
    public String renderMessage(@NotNull String message) {
        ...
        if (i == 2) {
            return o000oOoO.OooO00o("<i>", message, "</i>");
        }
        throw new NoWhenBranchMatchedException();
    }
    ...
    public String renderName(@NotNull Name name, boolean z) {
        ...
        return (getBoldOnlyForNamesInHtml() && getTextFormat() == RenderingFormat.HTML && z) ? o000oOoO.OooO00o("<b>", strEscape, "</b>") : strEscape;
    }
    ...
    public String renderTypeConstructor(@NotNull TypeConstructor typeConstructor) {
        ...
        if (classifierDescriptorMo5502getDeclarationDescriptor instanceof TypeParameterDescriptor ? true : classifierDescriptorMo5502getDeclarationDescriptor instanceof ClassDescriptor ? true : classifierDescriptorMo5502getDeclarationDescriptor instanceof TypeAliasDescriptor) {
            return renderClassifierName(classifierDescriptorMo5502getDeclarationDescriptor);
        }
        if (classifierDescriptorMo5502getDeclarationDescriptor == null) {
        ...
        throw new IllegalStateException(("Unexpected classifier: " + classifierDescriptorMo5502getDeclarationDescriptor.getClass()).toString());
    }
