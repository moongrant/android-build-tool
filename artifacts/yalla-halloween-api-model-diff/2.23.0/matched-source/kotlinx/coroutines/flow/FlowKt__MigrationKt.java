...
final /* synthetic */ class FlowKt__MigrationKt {
    ...
    public static final class C10531<T> extends SuspendLambda implements Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        final /* synthetic */ long $timeMillis;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C10531(long j, Continuation<? super C10531> continuation) {
            super(2, continuation);
            this.$timeMillis = j;
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C10531(this.$timeMillis, continuation);
        }
    ...
    public static final <T> Flow<T> delayFlow(@NotNull Flow<? extends T> flow, long j) {
        return FlowKt.onStart(flow, new C10531(j, null));
    }
    ...
    public static final <T> Flow<T> onErrorReturn(@NotNull Flow<? extends T> flow, T t, @NotNull Function1<? super Throwable, Boolean> function1) {
        return FlowKt.m5754catch(flow, new AnonymousClass2(function1, t, null));
    }
