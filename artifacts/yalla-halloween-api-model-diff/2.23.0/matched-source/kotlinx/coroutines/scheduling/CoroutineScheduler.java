...
public final class CoroutineScheduler implements Executor, Closeable {
    ...
    public CoroutineScheduler(int i, int i2, long j, @NotNull String str) {
        ...
        if (!(i2 >= i)) {
            throw new IllegalArgumentException(OooOO0.OooO00o("Max pool size ", i2, " should be greater than or equals to core pool size ", i).toString());
        }
        if (!(i2 <= 2097150)) {
    ...
    public final void dispatch(@NotNull Runnable block, @NotNull TaskContext taskContext, boolean tailDispatch) {
        ...
        if (taskSubmitToLocalQueue != null && !addToGlobalQueue(taskSubmitToLocalQueue)) {
            throw new RejectedExecutionException(o0O00o0.OooO0O0(new StringBuilder(), this.schedulerName, " was terminated"));
        }
    ...
    public String toString() {
        ...
        sb4.append(", max = ");
        OooOOO0.OooO00o(sb4, this.maxPoolSize, "}, Worker States {CPU = ", i, ", blocking = ");
        OooOOO0.OooO00o(sb4, i2, ", parked = ", i3, ", dormant = ");
        OooOOO0.OooO00o(sb4, i4, ", terminated = ", i5, "}, running workers queues = ");
