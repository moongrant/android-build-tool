    ...
    public static String[] decodeProtocols(byte[] bArr) {
        ...
        while (i2 < bArr.length) {
            ...
            if (b < 0 || b > bArr.length - i2) {
                ...
                sbOooO00o.append(bArr.length < 50 ? Arrays.toString(bArr) : p022Oooo00O.OooOO0.OooO0O0(new StringBuilder(), bArr.length, " byte array"));
    ...
    public static byte[] encodeProtocols(String[] strArr) {
        ...
        for (int i2 = 0; i2 < strArr.length; i2++) {
            ...
            if (length == 0 || length > 255) {
                throw new IllegalArgumentException(p022Oooo00O.OooOO0.OooO00o("protocol[", i2, "] has invalid length: ", length));
            }
            i += length + 1;
        }
