...
public final class oo00o implements o0000O {
    ...
    public final boolean f898OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final String f899OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final int f900OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final HashMap f901OooO0Oo = new HashMap();
    ...
    public final boolean OooO00o(int i) {
        if (this.f898OooO00o) {
            return CamcorderProfile.hasProfile(this.f900OooO0OO, i);
        }
        return false;
    }
    ...
    public final EncoderProfilesProxy OooO0O0(int i) {
        ...
        int i6 = this.f900OooO0OO;
        if (!CamcorderProfile.hasProfile(i6, i)) {
            return null;
        }
        HashMap map = this.f901OooO0Oo;
        ...
        if (i7 < 31) {
            ...
            EncoderProfiles encoderProfilesOooO00o = OooO00o.OooO00o(this.f899OooO0O0, i);
            if (encoderProfilesOooO00o != null) {
                if (p024Oooo0O0.o0000O.OooO00o(o000O.class) != null) {
