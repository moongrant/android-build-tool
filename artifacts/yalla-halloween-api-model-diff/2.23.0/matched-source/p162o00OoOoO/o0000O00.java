...
public final class o0000O00 extends o0ooOOo<MutableStateFlow<Double>> {
    ...
    @NotNull
    public MutableStateFlow<Double> read(@Nullable JsonReader jsonReader) throws IOException {
        ...
        return StateFlowKt.MutableStateFlow(Double.valueOf(dNextDouble));
    }

    @Override // com.google.gson.o0ooOOo
    public void write(@Nullable JsonWriter jsonWriter, @Nullable MutableStateFlow<Double> mutableStateFlow) throws IOException {
        if (jsonWriter != null) {
            jsonWriter.value(mutableStateFlow != null ? mutableStateFlow.getValue().doubleValue() : 0.0d);
        }
    }
}
