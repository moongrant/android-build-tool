...
public final class oO00O0o0 {
    ...
    @NotNull
    public static final oO00O0o0 f53838OooO00o = new oO00O0o0();

    public static final class OooO extends Lambda implements Function2<Composer, Integer, Unit> {

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f53840OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(int i) {
            super(2);
            this.f53840OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f53840OooO0o0 | 1);
            oO00O0o0.this.OooO00o(composer, iUpdateChangedFlags);
    ...
    public static final class OooO00o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f53842OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(int i) {
            super(2);
            this.f53842OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f53842OooO0o0 | 1);
            oO00O0o0.this.OooO00o(composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0O0 extends Lambda implements Function2<Integer, MoreModel, Unit> {
        ...
        public final /* synthetic */ MomentReplyVM f53843OooO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ FragmentActivity f53844OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f53845OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MomentCommentDetailModel f53846OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ MomentCommentsVM f53847OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ LifecycleOwner f53848OooO0oo;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public final /* synthetic */ CoroutineScope f53849OooOO0;
        ...
        public OooO0O0(FragmentActivity fragmentActivity, MomentCommentDetailModel momentCommentDetailModel, MomentVideoVM momentVideoVM, MomentCommentsVM momentCommentsVM, LifecycleOwner lifecycleOwner, MomentReplyVM momentReplyVM, CoroutineScope coroutineScope) {
            super(2);
            this.f53844OooO0Oo = fragmentActivity;
            this.f53846OooO0o0 = momentCommentDetailModel;
            this.f53845OooO0o = momentVideoVM;
            this.f53847OooO0oO = momentCommentsVM;
            this.f53848OooO0oo = lifecycleOwner;
            this.f53843OooO = momentReplyVM;
            this.f53849OooOO0 = coroutineScope;
        }
        ...
        public final Unit invoke(Integer num, MoreModel moreModel) {
            ...
            if (moreModel2 != null) {
                ...
                MomentCommentDetailModel momentCommentDetailModel2 = this.f53846OooO0o0;
                if (i != 1) {
                    MomentVideoVM momentVideoVM = this.f53845OooO0o;
                    MomentCommentsVM momentCommentsVM = this.f53847OooO0oO;
                    MomentReplyVM momentReplyVM = this.f53843OooO;
                    if (i == 2) {
                        ...
                        o0000Ooo.OooO00o(momentVideoVM.deleteCommentOrReply(o0OoOo0.OooOOO0("", currentMomentDetail2 != null ? Long.valueOf(currentMomentDetail2.getId()) : null), o0OoOo0.OooOOO0("", Long.valueOf(momentCommentDetailModel2.getId()))), this.f53848OooO0oo, new oOo00OO0(momentVideoVM, momentCommentsVM, momentCommentDetailModel2, momentReplyVM));
                    } else if (i == 4) {
                        MomentDetailModel currentMomentDetail3 = momentVideoVM.getCurrentMomentDetail();
                        momentVideoVM.reportCommentOrReply(o0OoOo0.OooOO0(currentMomentDetail3 != null ? Long.valueOf(currentMomentDetail3.getId()) : null), momentCommentDetailModel2.getId());
                    } else if (i == 5) {
                        oO00OO0O onLogin = new oO00OO0O(momentVideoVM, momentCommentDetailModel2, this.f53849OooOO0);
                    ...
                    FragmentActivity fragmentActivity = this.f53844OooO0Oo;
                    TextView textView = new TextView(fragmentActivity);
                    p595o0oo00Oo.o0000Ooo.OooO0OO(fragmentActivity, momentCommentDetailModel2.getContent(), textView, new o0OOO0o());
                    o000O0o.OooO0o0(textView, fragmentActivity, o0000.OooO0OO(oO00OOo0.Copied));
                }
            }
            return null;
        }
    ...
    public static final class OooO0OO extends Lambda implements Function0<Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f53850OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ o00O0O f53851OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(MomentVideoVM momentVideoVM, o00O0O o00o0o2) {
            super(0);
            this.f53850OooO0Oo = momentVideoVM;
            this.f53851OooO0o0 = o00o0o2;
        }

        @Override // kotlin.jvm.functions.Function0
        @Nullable
        public final Object invoke() {
            this.f53850OooO0Oo.setShowDialogCommentMore(null);
            return this.f53851OooO0o0;
        }
    }
    ...
    public static final class OooO0o extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f53852OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(MomentVideoVM momentVideoVM) {
            super(0);
            this.f53852OooO0Oo = momentVideoVM;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            this.f53852OooO0Oo.setShowDialogCommentMore(null);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f53854OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0(int i) {
            super(2);
            this.f53854OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f53854OooO0o0 | 1);
            oO00O0o0.this.OooO0O0(composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0O extends Lambda implements Function2<Integer, MoreModel, Unit> {
        ...
        /* JADX INFO: renamed from: OooO, reason: collision with root package name */
        public final /* synthetic */ MomentCommentsVM f53855OooO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ FragmentActivity f53856OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f53857OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MomentReplyModel f53858OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ LifecycleOwner f53859OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ MomentReplyVM f53860OooO0oo;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public final /* synthetic */ CoroutineScope f53861OooOO0;
        ...
        public OooOO0O(FragmentActivity fragmentActivity, MomentReplyModel momentReplyModel, MomentVideoVM momentVideoVM, LifecycleOwner lifecycleOwner, MomentReplyVM momentReplyVM, MomentCommentsVM momentCommentsVM, CoroutineScope coroutineScope) {
            super(2);
            this.f53856OooO0Oo = fragmentActivity;
            this.f53858OooO0o0 = momentReplyModel;
            this.f53857OooO0o = momentVideoVM;
            this.f53859OooO0oO = lifecycleOwner;
            this.f53860OooO0oo = momentReplyVM;
            this.f53855OooO = momentCommentsVM;
            this.f53861OooOO0 = coroutineScope;
        }
        ...
        public final Unit invoke(Integer num, MoreModel moreModel) {
            ...
            if (moreModel2 != null) {
                int i = OooO00o.$EnumSwitchMapping$0[moreModel2.getTag().ordinal()];
                MomentReplyModel momentReplyModel = this.f53858OooO0o0;
                if (i != 1) {
                    MomentVideoVM momentVideoVM = this.f53857OooO0o;
                    if (i == 2) {
                        MomentDetailModel currentMomentDetail = momentVideoVM.getCurrentMomentDetail();
                        o0000Ooo.OooO00o(momentVideoVM.deleteCommentOrReply(o0OoOo0.OooOOO0("", currentMomentDetail != null ? Long.valueOf(currentMomentDetail.getId()) : null), o0OoOo0.OooOOO0("", Long.valueOf(momentReplyModel.getId()))), this.f53859OooO0oO, new oO00OOOo(this.f53860OooO0oo, momentReplyModel, this.f53855OooO, momentVideoVM));
                    } else if (i == 3) {
                        MomentDetailModel currentMomentDetail2 = momentVideoVM.getCurrentMomentDetail();
                        ...
                        MomentDetailModel currentMomentDetail3 = momentVideoVM.getCurrentMomentDetail();
                        momentVideoVM.reportCommentOrReply(o0OoOo0.OooOO0(currentMomentDetail3 != null ? Long.valueOf(currentMomentDetail3.getId()) : null), momentReplyModel.getId());
                    } else if (i == 5) {
                        oO00Oo00 onLogin = new oO00Oo00(momentVideoVM, momentReplyModel, this.f53861OooOO0);
                        Intrinsics.checkNotNullParameter(onLogin, "onLogin");
                        o000000O o000000o2 = o000000O.f46674OooO00o;
                        if (Intrinsics.areEqual(o000000O.OooOo0O().getValue(), Boolean.TRUE)) {
                            onLogin.invoke();
                    ...
                    FragmentActivity fragmentActivity = this.f53856OooO0Oo;
                    TextView textView = new TextView(fragmentActivity);
                    p595o0oo00Oo.o0000Ooo.OooO0OO(fragmentActivity, momentReplyModel.getContent(), textView, new o00OOO00());
                    o000O0o.OooO0o0(textView, fragmentActivity, o0000.OooO0OO(oO00OOo0.Copied));
                }
            }
            return null;
    ...
    public static final class OooOOO extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f53862OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO(MomentVideoVM momentVideoVM) {
            super(0);
            this.f53862OooO0Oo = momentVideoVM;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            this.f53862OooO0Oo.setShowDialogReplySonMore(null);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOOO0 extends Lambda implements Function0<Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f53863OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ o00O0O f53864OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO0(MomentVideoVM momentVideoVM, o00O0O o00o0o2) {
            super(0);
            this.f53863OooO0Oo = momentVideoVM;
            this.f53864OooO0o0 = o00o0o2;
        }

        @Override // kotlin.jvm.functions.Function0
        @Nullable
        public final Object invoke() {
            this.f53863OooO0Oo.setShowDialogReplySonMore(null);
    ...
    public static final class OooOOOO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f53866OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOOO(int i) {
            super(2);
            this.f53866OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f53866OooO0o0 | 1);
            oO00O0o0.this.OooO0O0(composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
        ...
        if ((i & 1) == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            if (showDialogCommentMore != null) {
                ...
                if (fragmentActivity != null) {
                    o00O0O o00o0o2 = new o00O0O(fragmentActivity, null);
                    o00o0o2.OooOOO(list);
                    o00o0o2.OooOOo0(new OooO0O0(fragmentActivity, showDialogCommentMore, momentVideoVM, momentCommentsVM, lifecycleOwner, momentReplyVM, coroutineScope));
                    o00o0o2.OooO(new OooO0OO(momentVideoVM, o00o0o2));
                    oo0o0Oo.OooO0O0(o00o0o2, new OooO0o(momentVideoVM));
                    o00o0o2.OooOO0o();
                }
            }
            if (ComposerKt.isTraceInProgress()) {
        ...
        if ((i & 1) == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            if (showDialogReplySonMore != null) {
                ...
                if (fragmentActivity != null) {
                    o00O0O o00o0o2 = new o00O0O(fragmentActivity, null);
                    o00o0o2.OooOOO(list);
                    o00o0o2.OooOOo0(new OooOO0O(fragmentActivity, showDialogReplySonMore, momentVideoVM, lifecycleOwner, momentReplyVM, momentCommentsVM, coroutineScope));
                    o00o0o2.OooO(new OooOOO0(momentVideoVM, o00o0o2));
                    oo0o0Oo.OooO0O0(o00o0o2, new OooOOO(momentVideoVM));
                    o00o0o2.OooOO0o();
                }
            }
            if (ComposerKt.isTraceInProgress()) {
