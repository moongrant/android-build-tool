...
public final class r extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ String f56790OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ Map<String, Object> f56791OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ String f56792OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public r(String str, String str2, Map<String, ? extends Object> map, Continuation<? super r> continuation) {
        super(2, continuation);
        this.f56790OooO0Oo = str;
        this.f56792OooO0o0 = str2;
        this.f56791OooO0o = map;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new r(this.f56790OooO0Oo, this.f56792OooO0o0, this.f56791OooO0o, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        BuriedPoint buriedPointCreate = BuriedPoint.Factory.INSTANCE.create(this.f56790OooO0Oo, this.f56792OooO0o0, this.f56791OooO0o);
        ...
        trackModel.addExtInfo("event", OooOO0.OooO00o(buriedPointCreate));
