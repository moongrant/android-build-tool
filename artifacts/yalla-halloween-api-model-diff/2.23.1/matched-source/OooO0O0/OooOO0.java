...
import com.google.firebase.messaging.o000O0o;
    ...
    public final void run() {
        ...
        switch (i) {
            case 0:
                ...
                break;
            case 1:
                o000O0o.OooO00o oooO00o2 = (o000O0o.OooO00o) obj;
                Log.w("FirebaseMessaging", "Service took too long to process intent: " + oooO00o2.f19893OooO00o.getAction() + " Releasing WakeLock.");
                oooO00o2.f19894OooO0O0.trySetResult(null);
                break;
            default:
                EditText view = ((PasswordSettingDialog) obj).f27417OooOOo0;
