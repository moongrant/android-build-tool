...
public final class o0000Ooo {
    ...
    public static o0000Ooo f3250OooO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public static final PorterDuff.Mode f3251OooO0oo = PorterDuff.Mode.SRC_IN;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public static final OooO0OO f3252OooOO0 = new OooO0OO();

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public WeakHashMap<Context, p190o00o0O.Oooo000<ColorStateList>> f3253OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public p190o00o0O.OooOo<String, OooO> f3254OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public p190o00o0O.Oooo000<String> f3255OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final WeakHashMap<Context, p190o00o0O.OooOOOO<WeakReference<Drawable.ConstantState>>> f3256OooO0Oo = new WeakHashMap<>(0);

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public boolean f3257OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public TypedValue f3258OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public OooOO0 f3259OooO0oO;
    ...
    public final synchronized ColorStateList OooO(@DrawableRes int i, @NonNull Context context) {
        ...
        try {
            WeakHashMap<Context, p190o00o0O.Oooo000<ColorStateList>> weakHashMap = this.f3253OooO00o;
            ...
            if (colorStateList == null) {
                OooOO0 oooOO1 = this.f3259OooO0oO;
                if (oooOO1 != null) {
                    colorStateListOooO0Oo = ((OooOOO0.OooO00o) oooOO1).OooO0Oo(i, context);
                }
                if (colorStateListOooO0Oo != null) {
                    if (this.f3253OooO00o == null) {
                        this.f3253OooO00o = new WeakHashMap<>();
                    }
                    p190o00o0O.Oooo000<ColorStateList> oooo001 = this.f3253OooO00o.get(context);
                    if (oooo001 == null) {
                        oooo001 = new p190o00o0O.Oooo000<>();
                        this.f3253OooO00o.put(context, oooo001);
                    }
    ...
    public final void OooO00o(@NonNull String str, @NonNull OooO oooO) {
        if (this.f3254OooO0O0 == null) {
            this.f3254OooO0O0 = new p190o00o0O.OooOo<>();
        }
        this.f3254OooO0O0.put(str, oooO);
    }

    public final synchronized void OooO0O0(@NonNull Context context, long j, @NonNull Drawable drawable) {
        Drawable.ConstantState constantState = drawable.getConstantState();
        if (constantState != null) {
            p190o00o0O.OooOOOO<WeakReference<Drawable.ConstantState>> oooOOOO = this.f3256OooO0Oo.get(context);
            if (oooOOOO == null) {
                oooOOOO = new p190o00o0O.OooOOOO<>();
                this.f3256OooO0Oo.put(context, oooOOOO);
            }
    ...
    public final Drawable OooO0OO(@DrawableRes int i, @NonNull Context context) {
        ...
        if (this.f3258OooO0o0 == null) {
            this.f3258OooO0o0 = new TypedValue();
        }
        TypedValue typedValue = this.f3258OooO0o0;
    ...
    */
    public final synchronized Drawable OooO0oO(@NonNull Context context, @DrawableRes int i, boolean z) {
        ...
        try {
            ...
            p190o00o0O.OooOo<String, OooO> oooOo = this.f3254OooO0O0;
            ...
            if (oooOo == null || oooOo.isEmpty()) {
                ...
                p190o00o0O.Oooo000<String> oooo000 = this.f3255OooO0OO;
                if (oooo000 != null) {
                    String str = (String) oooo000.OooO0o(i, null);
                    if ("appcompat_skip_skip".equals(str) || (str != null && this.f3254OooO0O0.getOrDefault(str, null) == null)) {
                        drawableOooO0O0 = null;
                    }
                } else {
                    this.f3255OooO0OO = new p190o00o0O.Oooo000<>();
                }
                if (this.f3258OooO0o0 == null) {
                    this.f3258OooO0o0 = new TypedValue();
                }
                ...
                if (drawableOooO0O0 == null) {
                    ...
                    if (charSequence != null && charSequence.toString().endsWith(".xml")) {
                        try {
                            ...
                            this.f3255OooO0OO.OooO0O0(i, name);
                            OooO orDefault = this.f3254OooO0O0.getOrDefault(name, null);
                            if (orDefault != null) {
                    ...
                    if (drawableOooO0O0 == null) {
                        this.f3255OooO0OO.OooO0O0(i, "appcompat_skip_skip");
                    }
                }
            }
            if (drawableOooO0O0 == null) {
            ...
            if (drawableOooO0O0 != null) {
                ...
                if (colorStateListOooO != null) {
                    ...
                    if (this.f3259OooO0oO != null && i == p012OooOo0O.OooOo.abc_switch_thumb_material) {
                ...
                } else if (this.f3259OooO0oO != null) {
                    if (i == p012OooOo0O.OooOo.abc_seekbar_track_material) {
                        ...
                        PorterDuff.Mode mode2 = OooOOO0.f2982OooO0O0;
                        ...
                        if (i == p012OooOo0O.OooOo.abc_ratingbar_material || i == p012OooOo0O.OooOo.abc_ratingbar_indicator_material || i == p012OooOo0O.OooOo.abc_ratingbar_small_material) {
                            ...
                            PorterDuff.Mode mode3 = OooOOO0.f2982OooO0O0;
    ...
    public final boolean OooOOO0(@NonNull Context context, @DrawableRes int i, @NonNull Drawable drawable) {
        ...
        PorterDuff.Mode mode2 = OooOOO0.f2982OooO0O0;
        if (OooOOO0.OooO00o.OooO00o(i, oooO00o.f2985OooO00o)) {
            i4 = p012OooOo0O.OooOOO0.colorControlNormal;
        } else if (OooOOO0.OooO00o.OooO00o(i, oooO00o.f2987OooO0OO)) {
            i4 = p012OooOo0O.OooOOO0.colorControlActivated;
        } else {
            if (!OooOOO0.OooO00o.OooO00o(i, oooO00o.f2988OooO0Oo)) {
