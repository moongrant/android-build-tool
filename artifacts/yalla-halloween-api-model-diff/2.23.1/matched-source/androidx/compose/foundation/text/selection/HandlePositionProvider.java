...
public final class HandlePositionProvider implements PopupPositionProvider {
    ...
    public long mo882calculatePositionllwVHH4(@NotNull IntRect anchorBounds, long windowSize, @NotNull LayoutDirection layoutDirection, long popupContentSize) {
        ...
        if (i == 1) {
            int iM3893getXimpl = IntOffset.m3893getXimpl(this.offset) + anchorBounds.getLeft();
            return OooO0o.OooO00o(this.offset, anchorBounds.getTop(), iM3893getXimpl);
        }
        if (i == 2) {
            int iM3893getXimpl2 = (IntOffset.m3893getXimpl(this.offset) + anchorBounds.getLeft()) - IntSize.m3935getWidthimpl(popupContentSize);
            return OooO0o.OooO00o(this.offset, anchorBounds.getTop(), iM3893getXimpl2);
        }
        if (i != 3) {
            throw new NoWhenBranchMatchedException();
        }
        int iM3893getXimpl3 = (IntOffset.m3893getXimpl(this.offset) + anchorBounds.getLeft()) - (IntSize.m3935getWidthimpl(popupContentSize) / 2);
        return OooO0o.OooO00o(this.offset, anchorBounds.getTop(), iM3893getXimpl3);
    }
