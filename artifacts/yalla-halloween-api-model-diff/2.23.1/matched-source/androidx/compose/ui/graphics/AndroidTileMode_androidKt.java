...
public final class AndroidTileMode_androidKt {
    ...
    public static final boolean m1593isSupported0vamqd0(int i) {
        return Build.VERSION.SDK_INT >= 31 || !TileMode.m2021equalsimpl0(i, TileMode.INSTANCE.m2026getDecal3opZhB0());
    }

    @NotNull
    /* JADX INFO: renamed from: toAndroidTileMode-0vamqd0, reason: not valid java name */
    public static final Shader.TileMode m1594toAndroidTileMode0vamqd0(int i) {
        TileMode.Companion companion = TileMode.INSTANCE;
        if (TileMode.m2021equalsimpl0(i, companion.m2025getClamp3opZhB0())) {
            return Shader.TileMode.CLAMP;
        }
        if (TileMode.m2021equalsimpl0(i, companion.m2028getRepeated3opZhB0())) {
            return Shader.TileMode.REPEAT;
        }
        if (TileMode.m2021equalsimpl0(i, companion.m2027getMirror3opZhB0())) {
            return Shader.TileMode.MIRROR;
        }
        if (TileMode.m2021equalsimpl0(i, companion.m2026getDecal3opZhB0())) {
    ...
    public static final int toComposeTileMode(@NotNull Shader.TileMode tileMode) {
        ...
        if (i == 1) {
            return TileMode.INSTANCE.m2025getClamp3opZhB0();
        }
        if (i == 2) {
            return TileMode.INSTANCE.m2027getMirror3opZhB0();
        }
        if (i != 3) {
            return (Build.VERSION.SDK_INT < 31 || tileMode != Shader.TileMode.DECAL) ? TileMode.INSTANCE.m2025getClamp3opZhB0() : TileModeVerificationHelper.INSTANCE.m2029getComposeTileModeDecal3opZhB0();
        }
        return TileMode.INSTANCE.m2028getRepeated3opZhB0();
    }
}
