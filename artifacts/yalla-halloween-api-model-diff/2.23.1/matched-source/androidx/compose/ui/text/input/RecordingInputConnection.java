...
public final class RecordingInputConnection implements InputConnection {
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m3318getMinimpl(this.mTextFieldValue.getSelection()), reqModes);
    }
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m3314getCollapsedimpl(this.mTextFieldValue.getSelection())) {
            return null;
        }
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        if (editorAction != 0) {
            switch (editorAction) {
                case 2:
                    iM3477getDefaulteUduSuo = ImeAction.INSTANCE.m3479getGoeUduSuo();
                    break;
                case 3:
                    iM3477getDefaulteUduSuo = ImeAction.INSTANCE.m3483getSearcheUduSuo();
                    break;
                case 4:
                    iM3477getDefaulteUduSuo = ImeAction.INSTANCE.m3484getSendeUduSuo();
                    break;
                case 5:
                    iM3477getDefaulteUduSuo = ImeAction.INSTANCE.m3480getNexteUduSuo();
                    break;
                case 6:
                    iM3477getDefaulteUduSuo = ImeAction.INSTANCE.m3478getDoneeUduSuo();
                    break;
                case 7:
                    iM3477getDefaulteUduSuo = ImeAction.INSTANCE.m3482getPreviouseUduSuo();
                    break;
                default:
        ...
        this.eventCallback.mo3491onImeActionKlQnJC8(iM3477getDefaulteUduSuo);
        return true;
    }
    ...
    public final void updateInputState(@NotNull TextFieldValue state, @NotNull InputMethodManager inputMethodManager) {
        ...
        if (this.isActive) {
            ...
            int iM3318getMinimpl = composition != null ? TextRange.m3318getMinimpl(composition.getPackedValue()) : -1;
            TextRange composition2 = state.getComposition();
            inputMethodManager.updateSelection(TextRange.m3318getMinimpl(state.getSelection()), TextRange.m3317getMaximpl(state.getSelection()), iM3318getMinimpl, composition2 != null ? TextRange.m3317getMaximpl(composition2.getPackedValue()) : -1);
        }
    }
}
