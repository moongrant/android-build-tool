...
final class GsonFactory implements AwsJsonFactory {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        public static final /* synthetic */ int[] f12701OooO00o;
        ...
        static {
            ...
            try {
                f12701OooO00o[JsonToken.END_ARRAY.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f12701OooO00o[JsonToken.BEGIN_OBJECT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f12701OooO00o[JsonToken.END_OBJECT.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f12701OooO00o[JsonToken.NAME.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f12701OooO00o[JsonToken.BOOLEAN.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f12701OooO00o[JsonToken.NUMBER.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f12701OooO00o[JsonToken.NULL.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f12701OooO00o[JsonToken.STRING.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f12701OooO00o[JsonToken.END_DOCUMENT.ordinal()] = 10;
    ...
    public static final class GsonReader implements AwsJsonReader {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final JsonReader f12702OooO00o;

        public GsonReader(Reader reader) {
            this.f12702OooO00o = new JsonReader(reader);
        }

        @Override // com.amazonaws.util.json.AwsJsonReader
        public final void OooO00o() throws IOException {
            this.f12702OooO00o.beginObject();
        }

        @Override // com.amazonaws.util.json.AwsJsonReader
        public final void OooO0O0() throws IOException {
            this.f12702OooO00o.endObject();
        }

        @Override // com.amazonaws.util.json.AwsJsonReader
        public final void OooO0OO() throws IOException {
            this.f12702OooO00o.skipValue();
        }

        @Override // com.amazonaws.util.json.AwsJsonReader
        public final boolean OooO0Oo() throws IOException {
            JsonToken jsonTokenPeek = this.f12702OooO00o.peek();
        ...
        public final String OooO0o() throws IOException {
            JsonReader jsonReader = this.f12702OooO00o;
            ...
            if (JsonToken.BOOLEAN.equals(jsonTokenPeek)) {
                return jsonReader.nextBoolean() ? ServerProtocol.DIALOG_RETURN_SCOPES_TRUE : "false";
            }
        ...
        public final String OooO0o0() throws IOException {
            return this.f12702OooO00o.nextName();
        }
        ...
        public final AwsJsonToken OooO0oO() throws IOException {
            ...
            try {
                ...
                if (jsonTokenPeek != null) {
                    switch (AnonymousClass1.f12701OooO00o[jsonTokenPeek.ordinal()]) {
                        case 1:
        ...
        public final void close() throws IOException {
            this.f12702OooO00o.close();
        }

        @Override // com.amazonaws.util.json.AwsJsonReader
        public final boolean hasNext() throws IOException {
            return this.f12702OooO00o.hasNext();
        }
    }
