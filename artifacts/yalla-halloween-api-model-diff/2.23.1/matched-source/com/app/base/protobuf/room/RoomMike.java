...
public final class RoomMike {
    ...
    public static final class MicApplyListInOutNotify extends GeneratedMessageV3 implements MicApplyListInOutNotifyOrBuilder {
        ...
        public int hashCode() {
            ...
            if (hasUser()) {
                iHashLong = getUser().hashCode() + o00Ooo.OooO00o(iHashLong, 37, 2, 53);
            }
            int iHashCode = this.unknownFields.hashCode() + ((getInOrOut() + o00Ooo.OooO00o(iHashLong, 37, 3, 53)) * 29);
            this.memoizedHashCode = iHashCode;
            return iHashCode;
        }
    ...
    public static final class MicApplyListReply extends GeneratedMessageV3 implements MicApplyListReplyOrBuilder {
        ...
        public int hashCode() {
            ...
            if (getUsersCount() > 0) {
                code = getUsersList().hashCode() + o00Ooo.OooO00o(code, 37, 2, 53);
            }
            int iHashCode = this.unknownFields.hashCode() + ((Internal.hashBoolean(getListEmpty()) + o00Ooo.OooO00o(code, 37, 3, 53)) * 29);
            this.memoizedHashCode = iHashCode;
            return iHashCode;
        }
    ...
    public static final class MicApplyReply extends GeneratedMessageV3 implements MicApplyReplyOrBuilder {
        ...
        public int hashCode() {
            ...
            int iHashCode = this.unknownFields.hashCode() + ((Internal.hashLong(getUserId()) + ((((Internal.hashLong(getRoomId()) + ((((getOp() + ((((Internal.hashBoolean(getApplyListEmpty()) + o00Ooo.OooO00o(code, 37, 3, 53)) * 37) + 4) * 53)) * 37) + 5) * 53)) * 37) + 6) * 53)) * 29);
            this.memoizedHashCode = iHashCode;
            return iHashCode;
        }
    ...
    public static final class MicApplySwitchOpenReply extends GeneratedMessageV3 implements MicApplySwitchOpenReplyOrBuilder {
        ...
        public int hashCode() {
            ...
            if (hasWho()) {
                status = getWho().hashCode() + o00Ooo.OooO00o(status, 37, 4, 53);
            }
    ...
    public static final class MicInviteFromApplyReply extends GeneratedMessageV3 implements MicInviteFromApplyReplyOrBuilder {
        ...
        public int hashCode() {
            ...
            if (hasInviter()) {
                targetRole = getInviter().hashCode() + o00Ooo.OooO00o(targetRole, 37, 4, 53);
            }
            int iHashCode = this.unknownFields.hashCode() + ((Internal.hashBoolean(getFromApplyMicList()) + o00Ooo.OooO00o(targetRole, 37, 5, 53)) * 29);
            this.memoizedHashCode = iHashCode;
            return iHashCode;
        }
