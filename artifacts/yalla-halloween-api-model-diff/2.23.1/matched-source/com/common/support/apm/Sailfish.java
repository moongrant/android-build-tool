...
public final class Sailfish implements Logger {
    ...
    private static o0oo0000 okHttpClient;
    ...
    public static final class C08461 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public C08461(Continuation<? super C08461> continuation) {
            super(2, continuation);
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C08461(continuation);
        }
    ...
    public final synchronized void init(@NotNull Context context, @NotNull String appId2, @NotNull String appKey2, @NotNull String appSecret2, @NotNull String appChannel2, @NotNull SailfishConfiguration config2, @NotNull String deviceId2, @NotNull String uniqueId2, @NotNull String appNameSpace2, boolean sdkLoggable2) {
        ...
        synchronized (this) {
            ...
            o0oo0000.OooO00o oooO00oCreateOkHttpClientBuilder = httpClient.createOkHttpClientBuilder((String[]) array, new OtlpHeaderInterceptor());
            oooO00oCreateOkHttpClientBuilder.getClass();
            okHttpClient = new o0oo0000(oooO00oCreateOkHttpClientBuilder);
            MonitorManager monitorManager = MonitorManager.INSTANCE;
            o0oo0000 o0oo0000Var = okHttpClient;
            if (o0oo0000Var == null) {
                Intrinsics.throwUninitializedPropertyAccessException("okHttpClient");
                o0oo0000Var = null;
            }
            monitorManager.init$sailfish_release(o0oo0000Var);
            ConfigurationManager configurationManager = ConfigurationManager.INSTANCE;
            o0oo0000 o0oo0000Var2 = okHttpClient;
            if (o0oo0000Var2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("okHttpClient");
                o0oo0000Var2 = null;
            }
            configurationManager.init(appContext, o0oo0000Var2);
            o0oo0000 o0oo0000Var3 = okHttpClient;
            if (o0oo0000Var3 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("okHttpClient");
                o0oo0000Var3 = null;
            }
            new NetDetectorManager(o0oo0000Var3).startDetect();
            UploadService uploadService = UploadService.INSTANCE;
            o0oo0000 o0oo0000Var4 = okHttpClient;
            if (o0oo0000Var4 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("okHttpClient");
                o0oo0000Var4 = null;
            }
            uploadService.init(o0oo0000Var4, domainConfig.getDefaultDomains().get(0), appId2, appNameSpace);
            ...
            configurationManager.addOnConfigChangeListener(new Function0<Unit>() { // from class: com.common.support.apm.Sailfish.init.1
                ...
                public final void invoke2() {
                    o0oo0000 o0oo0000Var5 = Sailfish.okHttpClient;
                    if (o0oo0000Var5 == null) {
                        Intrinsics.throwUninitializedPropertyAccessException("okHttpClient");
                        o0oo0000Var5 = null;
                    }
                    ...
                    HostSwitchInterceptorKt.updateHosts(o0oo0000Var5, (String[]) Arrays.copyOf(strArr, strArr.length));
                }
            });
            isInitialized = true;
    ...
    public final NetService netDiagService(@NotNull Context context) {
        ...
        return new NetSpeedServiceImpl(context, o0oo0000Var, DomainConfig.INSTANCE.getDefaultDomains().get(0));
    }
    ...
    public final void setUniqueId(@NotNull String uniqueId2) {
        ...
        uniqueId = uniqueId2;
        BuildersKt__Builders_commonKt.launch$default(sailfishScope, null, null, new C08461(null), 3, null);
    }
