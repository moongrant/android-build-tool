...
public final class AppEventsLoggerImpl {
    ...
    public static final class Companion {
        ...
        public static final void m4064initializeLib$lambda4(Context context, AppEventsLoggerImpl logger) {
        ...
        public final void initializeTimersIfNeeded() {
            synchronized (AppEventsLoggerImpl.access$getStaticLock$cp()) {
                ...
                scheduledThreadPoolExecutorAccess$getBackgroundExecutor$cp.scheduleAtFixedRate(oooOO1, 0L, 86400L, TimeUnit.SECONDS);
            }
        }

        /* JADX INFO: Access modifiers changed from: private */
        /* JADX INFO: renamed from: initializeTimersIfNeeded$lambda-6, reason: not valid java name */
        public static final void m4065initializeTimersIfNeeded$lambda6() {
        ...
        public final void initializeLib(@NotNull final Context context, @Nullable String applicationId) {
            ...
            if (FacebookSdk.getAutoLogAppEventsEnabled()) {
                ...
                scheduledThreadPoolExecutorAccess$getBackgroundExecutor$cp.execute(new Runnable() { // from class: com.facebook.appevents.OooOO0O
                    @Override // java.lang.Runnable
                    public final void run() {
                        AppEventsLoggerImpl.Companion.m4064initializeLib$lambda4(context, appEventsLoggerImpl);
                    }
                });
            }
        }
    ...
    public final void logSdkEvent(@NotNull String eventName, @Nullable Double valueToSum, @Nullable Bundle parameters) {
        ...
        try {
            ...
            if (!StringsKt.Oooo00o(eventName, ACCOUNT_KIT_EVENT_NAME_PREFIX)) {
