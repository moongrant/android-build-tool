...
public final class FacebookWebFallbackDialog extends WebDialog {
    ...
    public static final void m4125cancel$lambda0(FacebookWebFallbackDialog this$0) {
    ...
    public void cancel() {
        ...
        if (!getIsPageFinished() || getIsListenerCalled() || webView == null || !webView.isShown()) {
            ...
            new Handler(Looper.getMainLooper()).postDelayed(new androidx.fragment.app.o000oOoO(this, 1), 1500L);
        }
    }
