...
public final class zac {
    ...
    @GuardedBy("sCache")
    public static final OooOo<String, String> f14654OooO00o = new OooOo<>();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @Nullable
    @GuardedBy("sCache")
    public static Locale f14655OooO0O0;
    ...
    public static String OooO0O0(Context context, String str) {
        OooOo<String, String> oooOo = f14654OooO00o;
        synchronized (oooOo) {
            Locale localeOooO0OO = o00O0O.OooO00o(context.getResources().getConfiguration()).OooO0OO(0);
            if (!localeOooO0OO.equals(f14655OooO0O0)) {
                oooOo.clear();
                f14655OooO0O0 = localeOooO0OO;
            }
