...
public final class zzbi extends zzaw {
    public zzbi() {
        this.f15197OooO00o.add(zzbl.ADD);
        this.f15197OooO00o.add(zzbl.DIVIDE);
        this.f15197OooO00o.add(zzbl.MODULUS);
        this.f15197OooO00o.add(zzbl.MULTIPLY);
        this.f15197OooO00o.add(zzbl.NEGATE);
        this.f15197OooO00o.add(zzbl.POST_DECREMENT);
        this.f15197OooO00o.add(zzbl.POST_INCREMENT);
        this.f15197OooO00o.add(zzbl.PRE_DECREMENT);
        this.f15197OooO00o.add(zzbl.PRE_INCREMENT);
        this.f15197OooO00o.add(zzbl.SUBTRACT);
    }
