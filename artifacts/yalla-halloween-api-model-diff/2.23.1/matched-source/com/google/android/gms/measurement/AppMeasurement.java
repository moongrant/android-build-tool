...
import p271o00ooooO.oO0OOo0o;
import p271o00ooooO.ooOOOOoo;
...
public class AppMeasurement {
    ...
    public static volatile AppMeasurement f15395OooO0O0;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final oO000Oo0 f15396OooO00o;
    ...
    public AppMeasurement(zzgd zzgdVar) {
        this.f15396OooO00o = new ooOOOOoo(zzgdVar);
    }
        ...
        if (f15395OooO0O0 == null) {
            synchronized (AppMeasurement.class) {
                if (f15395OooO0O0 == null) {
                    ...
                    if (zzilVar != null) {
                        f15395OooO0O0 = new AppMeasurement(zzilVar);
                    } else {
                        f15395OooO0O0 = new AppMeasurement(zzgd.zzp(context, new zzcl(0L, 0L, true, null, null, null, null, null), null));
                    }
                }
            }
        }
        return f15395OooO0O0;
    }

    @Keep
    public void beginAdUnitExposure(@NonNull @Size(min = 1) String str) {
        this.f15396OooO00o.zzp(str);
    }
    ...
    public void clearConditionalUserProperty(@NonNull @Size(max = 24, min = 1) String str, @NonNull String str2, @NonNull Bundle bundle) {
        this.f15396OooO00o.zzq(str, str2, bundle);
    }

    @Keep
    public void endAdUnitExposure(@NonNull @Size(min = 1) String str) {
        this.f15396OooO00o.zzr(str);
    }

    @Keep
    public long generateEventId() {
        return this.f15396OooO00o.zzb();
    }

    @NonNull
    @Keep
    public String getAppInstanceId() {
        return this.f15396OooO00o.zzh();
    }

    @NonNull
    @KeepForSdk
    public Boolean getBoolean() {
        return this.f15396OooO00o.OooO00o();
    }
    ...
    public List<ConditionalUserProperty> getConditionalUserProperties(@NonNull String str, @NonNull @Size(max = 23, min = 1) String str2) {
        List listZzm = this.f15396OooO00o.zzm(str, str2);
    ...
    public String getCurrentScreenClass() {
        return this.f15396OooO00o.zzi();
    }

    @NonNull
    @Keep
    public String getCurrentScreenName() {
        return this.f15396OooO00o.zzj();
    }

    @NonNull
    @KeepForSdk
    public Double getDouble() {
        return this.f15396OooO00o.OooO0O0();
    }

    @NonNull
    @Keep
    public String getGmpAppId() {
        return this.f15396OooO00o.zzk();
    }

    @NonNull
    @KeepForSdk
    public Integer getInteger() {
        return this.f15396OooO00o.OooO0OO();
    }
    ...
    public int getMaxUserProperties(@NonNull @Size(min = 1) String str) {
        return this.f15396OooO00o.zza(str);
    }
    ...
    public Map<String, Object> getUserProperties(@NonNull String str, @NonNull @Size(max = 24, min = 1) String str2, boolean z) {
        return this.f15396OooO00o.zzo(str, str2, z);
    }

    @ShowFirstParty
    @Keep
    public void logEventInternal(@NonNull String str, @NonNull String str2, @NonNull Bundle bundle) {
        this.f15396OooO00o.zzs(str, str2, bundle);
    }

    @ShowFirstParty
    @KeepForSdk
    public void logEventInternalNoInterceptor(@NonNull String str, @NonNull String str2, @NonNull Bundle bundle, long j) {
        this.f15396OooO00o.zzt(str, str2, bundle, j);
    }

    @ShowFirstParty
    @KeepForSdk
    public void registerOnMeasurementEventListener(@NonNull OnEventListener onEventListener) {
        this.f15396OooO00o.zzu(onEventListener);
    }
    ...
    public Map<String, Object> getUserProperties(boolean z) {
        return this.f15396OooO00o.OooO0o(z);
    }
}
