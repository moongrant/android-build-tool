...
import p272o00ooooo.oOo00ooO;

/* JADX INFO: loaded from: classes3.dex */
public final class zzek extends oOo00ooO {

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    public List f15435OooO;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public String f15436OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public String f15437OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public String f15438OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public int f15439OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public long f15440OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final long f15441OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public String f15442OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public int f15443OooOO0O;

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    public String f15444OooOO0o;

    /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
    public String f15445OooOOO;

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    public String f15446OooOOO0;

    /* JADX INFO: renamed from: OooOOOO, reason: collision with root package name */
    public long f15447OooOOOO;

    /* JADX INFO: renamed from: OooOOOo, reason: collision with root package name */
    public String f15448OooOOOo;

    public zzek(zzgd zzgdVar, long j) {
        super(zzgdVar);
        this.f15447OooOOOO = 0L;
        this.f15448OooOOOo = null;
        this.f15441OooO0oo = j;
    }
    ...
    @Override // p272o00ooooo.oOo00ooO
    ...
    public final void OooO00o() {
        ...
        String[] stringArray;
        Iterator it;
        zzgd zzgdVar = this.f40527OooO00o;
        ...
        this.f15436OooO0OO = packageName;
        this.f15438OooO0o = installerPackageName;
        this.f15437OooO0Oo = str3;
        this.f15439OooO0o0 = i;
        this.f15440OooO0oO = 0L;
        ...
        zzgdVar.zzay();
        if (z) {
            this.f15446OooOOO0 = zzgdVar.zzw();
        }
        try {
            ...
            if (!TextUtils.isEmpty(strZzc)) {
                ...
                this.f15446OooOOO0 = zzfv.zzb("admob_app_id", resources, strZzz);
            }
            if (iZza == 0) {
                zzgdVar.zzaA().zzj().zzc("App measurement enabled for app package, google app id", this.f15436OooO0OO, TextUtils.isEmpty(this.f15444OooOO0o) ? this.f15446OooOOO0 : this.f15444OooOO0o);
            }
        ...
        zzgd zzgdVar2 = zzagVarZzf.f40527OooO00o;
        if (bundleOooO0O0 != null) {
            ...
            if (packageManager != null) {
                this.f15443OooOO0O = InstantApps.isInstantApp(zzgdVar.zzaw()) ? 1 : 0;
            } else {
                this.f15443OooOO0O = 0;
            }
        }
        o0000OO0.OooO0O0(zzgdVar2, "Failed to load metadata: Metadata bundle is null");
        numValueOf = null;
        if (numValueOf != null) {
            stringArray = zzgdVar2.zzaw().getResources().getStringArray(numValueOf.intValue());
            if (stringArray == null) {
    ...
    public final void OooO0OO() {
        ...
        this.f15445OooOOO = str;
        this.f15447OooOOOO = zzgdVar.zzax().currentTimeMillis();
    }

    @WorkerThread
    public final String zzl() {
        zza();
        Preconditions.checkNotNull(this.f15436OooO0OO);
        return this.f15436OooO0OO;
    }
    ...
    public final String zzm() {
        zzg();
        zza();
        Preconditions.checkNotNull(this.f15444OooOO0o);
        return this.f15444OooOO0o;
    }
}
