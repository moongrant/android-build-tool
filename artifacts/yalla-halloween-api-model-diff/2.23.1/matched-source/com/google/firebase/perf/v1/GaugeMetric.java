...
import p677oo0oOOo.OooO;
import p677oo0oOOo.OooO0o;
...
public final class GaugeMetric extends GeneratedMessageLite<GaugeMetric, OooO0O0> implements MessageLiteOrBuilder {
    ...
    public static /* synthetic */ class OooO00o {
        ...
        public static final /* synthetic */ int[] f20018OooO00o;
        ...
        static {
            ...
            try {
                f20018OooO00o[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f20018OooO00o[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f20018OooO00o[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f20018OooO00o[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f20018OooO00o[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f20018OooO00o[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (OooO00o.f20018OooO00o[methodToInvoke.ordinal()]) {
            case 1:
    ...
    public OooO0o getAndroidMemoryReadingsOrBuilder(int i) {
        return this.androidMemoryReadings_.get(i);
    }

    public List<? extends OooO0o> getAndroidMemoryReadingsOrBuilderList() {
        return this.androidMemoryReadings_;
    }
    ...
    public OooO getCpuMetricReadingsOrBuilder(int i) {
        return this.cpuMetricReadings_.get(i);
    }

    public List<? extends OooO> getCpuMetricReadingsOrBuilderList() {
        return this.cpuMetricReadings_;
    }
