...
public class l1111l111111Il {
    ...
    public static class C0264l1111l111111Il {
        public final X509Certificate[][] l1111l111111Il;
        private byte[] l111l11111lIl;

        public C0264l1111l111111Il() {
        }

        public C0264l1111l111111Il(X509Certificate[][] x509CertificateArr, byte[] bArr) {
    ...
    public static C0264l1111l111111Il l1111l111111Il(RandomAccessFile randomAccessFile, l1111l111111Il l1111l111111il) throws IOException, CertificateException {
        ...
        return new C0264l1111l111111Il((X509Certificate[][]) arrayList.toArray(new X509Certificate[arrayList.size()][]), bArrCopyOfRange);
    }
