...
public final class SVGAVideoShapeEntity {
    ...
    @NotNull
    public Type f20807OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @Nullable
    public HashMap f20808OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @Nullable
    public OooO00o f20809OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @Nullable
    public Matrix f20810OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @Nullable
    public Path f20811OooO0o0;

    public static final class OooO00o {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public int f20812OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public int f20813OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public float f20814OooO0OO;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f20816OooO0o;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        @NotNull
        public String f20815OooO0Oo = "butt";

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        @NotNull
        public String f20817OooO0o0 = "miter";

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        @NotNull
        public float[] f20818OooO0oO = new float[0];
    }
        ...
        if (jSONObjectOptJSONObject2 != null) {
            ...
            if (jSONArrayOptJSONArray != null) {
                ...
                if (jSONArrayOptJSONArray.length() == 4) {
                    ...
                    oooO00o.f20812OooO00o = Color.argb((int) (jSONArrayOptJSONArray.optDouble(3) * ((double) (jSONArrayOptJSONArray.optDouble(3) <= 1.0d ? 255.0f : 1.0f))), (int) (jSONArrayOptJSONArray.optDouble(0) * dOooO0O0), (int) (jSONArrayOptJSONArray.optDouble(1) * dOooO0O0), (int) (dOooO0O0 * jSONArrayOptJSONArray.optDouble(2)));
                }
            }
            ...
            if (jSONArrayOptJSONArray2 != null) {
                ...
                if (jSONArrayOptJSONArray2.length() == 4) {
                    ...
                    oooO00o.f20813OooO0O0 = Color.argb((int) (jSONArrayOptJSONArray2.optDouble(3) * ((double) (jSONArrayOptJSONArray2.optDouble(3) <= 1.0d ? 255.0f : 1.0f))), (int) (jSONArrayOptJSONArray2.optDouble(0) * dOooO0O1), (int) (jSONArrayOptJSONArray2.optDouble(1) * dOooO0O1), (int) (dOooO0O1 * jSONArrayOptJSONArray2.optDouble(2)));
                }
            }
            oooO00o.f20814OooO0OO = (float) jSONObjectOptJSONObject2.optDouble("strokeWidth", 0.0d);
            ...
            oooO00o.f20815OooO0Oo = strOptString2;
            ...
            oooO00o.f20817OooO0o0 = strOptString3;
            oooO00o.f20816OooO0o = jSONObjectOptJSONObject2.optInt("miterLimit", 0);
            ...
            if (jSONArrayOptJSONArray3 != null) {
                ...
                oooO00o.f20818OooO0oO = fArr;
                int length = jSONArrayOptJSONArray3.length();
                for (int i = 0; i < length; i++) {
                    oooO00o.f20818OooO0oO[i] = (float) jSONArrayOptJSONArray3.optDouble(i, 0.0d);
                }
            }
            this.f20809OooO0OO = oooO00o;
        }
    ...
    public SVGAVideoShapeEntity(@NotNull ShapeEntity obj) {
        ...
        if (shapeStyle != null) {
            ...
            if (fill != null) {
                ...
                Float f15 = fill.b;
                oooO00o.f20812OooO00o = Color.argb(iFloatValue, iFloatValue2, iFloatValue3, (int) ((f15 != null ? f15.floatValue() : 0.0f) * fOooO00o));
            }
            ...
            if (stroke != null) {
                ...
                Float f21 = stroke.b;
                oooO00o.f20813OooO0O0 = Color.argb(iFloatValue4, iFloatValue5, iFloatValue6, (int) ((f21 != null ? f21.floatValue() : 0.0f) * fOooO00o2));
            }
            ...
            oooO00o.f20814OooO0OO = fFloatValue7;
            ...
            if (lineJoin != null) {
                ...
                if (i3 == 1) {
                    ...
                    oooO00o.f20817OooO0o0 = "bevel";
                } else if (i3 == 2) {
                    Intrinsics.checkNotNullParameter("miter", "<set-?>");
                    oooO00o.f20817OooO0o0 = "miter";
                } else if (i3 == 3) {
                    Intrinsics.checkNotNullParameter("round", "<set-?>");
                    oooO00o.f20817OooO0o0 = "round";
                }
            }
            Float f23 = shapeStyle.miterLimit;
            oooO00o.f20816OooO0o = (int) (f23 != null ? f23.floatValue() : 0.0f);
