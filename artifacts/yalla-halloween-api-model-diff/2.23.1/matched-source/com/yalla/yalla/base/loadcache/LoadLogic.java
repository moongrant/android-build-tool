...
public abstract class LoadLogic<K, T> {
    ...
    public final Object OooO0O0(String str, @NotNull LoadLevel loadLevel, @NotNull Continuation continuation) {
        ...
        if (continuation instanceof OooO00o) {
            ...
            int i = oooO00o.f22302OooO;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO00o.f22302OooO = i - Integer.MIN_VALUE;
            } else {
        ...
        Object objOooO0OO = oooO00o.f22306OooO0oO;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (oooO00o.f22302OooO) {
            case 0:
                ResultKt.throwOnFailure(objOooO0OO);
                oooO00o.f22303OooO0Oo = this;
                oooO00o.f22305OooO0o0 = str;
                oooO00o.f22304OooO0o = loadLevel;
                oooO00o.f22302OooO = 1;
                ...
                if (loadLevel.getLevel() > 1) {
                    oooO00o.f22303OooO0Oo = loadLogic;
                    oooO00o.f22305OooO0o0 = obj;
                    oooO00o.f22304OooO0o = loadLevel;
                    oooO00o.f22302OooO = 2;
                    ...
                    if (objOooO0OO != null) {
                        obj3 = obj;
                        oooO00o.f22303OooO0Oo = objOooO0OO;
                        oooO00o.f22305OooO0o0 = null;
                        oooO00o.f22304OooO0o = null;
                        oooO00o.f22302OooO = 3;
                    ...
                    if (loadLevel.getLevel() > 2) {
                        oooO00o.f22303OooO0Oo = loadLogic;
                        oooO00o.f22305OooO0o0 = obj3;
                        oooO00o.f22304OooO0o = null;
                        oooO00o.f22302OooO = 4;
                        ...
                        if (objOooO0OO != null) {
                            oooO00o.f22303OooO0Oo = loadLogic;
                            oooO00o.f22305OooO0o0 = obj5;
                            oooO00o.f22304OooO0o = objOooO0OO;
                            oooO00o.f22302OooO = 5;
                            if (loadLogic.OooO0o(obj5, objOooO0OO) == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            obj6 = objOooO0OO;
                            obj7 = obj5;
                            oooO00o.f22303OooO0Oo = obj6;
                            oooO00o.f22305OooO0o0 = null;
                            oooO00o.f22304OooO0o = null;
                            oooO00o.f22302OooO = 6;
                ...
                return null;
            case 1:
                loadLevel = (LoadLevel) oooO00o.f22304OooO0o;
                Object obj9 = oooO00o.f22305OooO0o0;
                loadLogic = (LoadLogic) oooO00o.f22303OooO0Oo;
                ResultKt.throwOnFailure(objOooO0OO);
                obj = obj9;
                if (objOooO0OO != null) {
                    obj = str;
                ...
                return null;
            case 2:
                loadLevel2 = (LoadLevel) oooO00o.f22304OooO0o;
                Object obj11 = oooO00o.f22305OooO0o0;
                loadLogic = (LoadLogic) oooO00o.f22303OooO0Oo;
                ResultKt.throwOnFailure(objOooO0OO);
                obj2 = obj11;
                if (objOooO0OO != null) {
                ...
                return null;
            case 3:
                Object obj13 = oooO00o.f22303OooO0Oo;
                ResultKt.throwOnFailure(objOooO0OO);
                return obj13;
            case 4:
                Object obj14 = oooO00o.f22305OooO0o0;
                LoadLogic<K, T> loadLogic2 = (LoadLogic) oooO00o.f22303OooO0Oo;
                ResultKt.throwOnFailure(objOooO0OO);
                ...
                return null;
            case 5:
                obj6 = oooO00o.f22304OooO0o;
                Object obj15 = oooO00o.f22305OooO0o0;
                loadLogic = (LoadLogic) oooO00o.f22303OooO0Oo;
                ResultKt.throwOnFailure(objOooO0OO);
                obj7 = obj15;
                oooO00o.f22303OooO0Oo = obj6;
                ...
                return obj6;
            case 6:
                Object obj16 = oooO00o.f22303OooO0Oo;
                ResultKt.throwOnFailure(objOooO0OO);
                return obj16;
            default:
