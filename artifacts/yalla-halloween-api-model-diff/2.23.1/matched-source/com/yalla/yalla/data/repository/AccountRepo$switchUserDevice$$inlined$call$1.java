...
public final class AccountRepo$switchUserDevice$$inlined$call$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<String>>, Object> {
    ...
    public int f22442OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ o0ooOOo f22443OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AccountRepo$switchUserDevice$$inlined$call$1(o0ooOOo o0ooooo, Continuation continuation) {
        super(2, continuation);
        this.f22443OooO0o0 = o0ooooo;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new AccountRepo$switchUserDevice$$inlined$call$1(this.f22443OooO0o0, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f22442OooO0Oo;
        Object obj2 = null;
        try {
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                o0ooOOo o0ooooo = this.f22443OooO0o0;
            ...
            Type type = new TypeToken<ApiResult<String>>() { // from class: com.yalla.yalla.data.repository.AccountRepo$switchUserDevice$$inlined$call$1.1
            }.getType();
            o00ooo2.getClass();
            ...
            if (apiResult == null) {
                ...
                Type type2 = new TypeToken<String>() { // from class: com.yalla.yalla.data.repository.AccountRepo$switchUserDevice$$inlined$call$1.2
                }.getType();
            ...
            String strOooO0oo2 = OooO00o.OooO00o().OooO0oo(o00O0OO0.OooO0Oo("WebAPIException", "canceled ", e2, 3, "canceled", null, 4, null));
