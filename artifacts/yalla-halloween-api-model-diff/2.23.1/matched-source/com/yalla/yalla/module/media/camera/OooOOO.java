...
public final class OooOOO {
    ...
    public static final class OooO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final /* synthetic */ CameraViewModel f23825OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(CameraViewModel cameraViewModel, Continuation<? super OooO> continuation) {
            super(2, continuation);
            this.f23825OooO0Oo = cameraViewModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO(this.f23825OooO0Oo, continuation);
        }
    ...
    public static final class OooO00o extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ boolean f23826OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ Function0<Unit> f23827OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(boolean z, Function0<Unit> function0) {
            super(0);
            this.f23826OooO0Oo = z;
            this.f23827OooO0o0 = function0;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            if (this.f23826OooO0Oo) {
                this.f23827OooO0o0.invoke();
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0O0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ BoxScope f23828OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ Function0<Unit> f23829OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ boolean f23830OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f23831OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ int f23832OooO0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(BoxScope boxScope, boolean z, Function0<Unit> function0, int i, int i2) {
            super(2);
            this.f23828OooO0Oo = boxScope;
            this.f23830OooO0o0 = z;
            this.f23829OooO0o = function0;
            this.f23831OooO0oO = i;
            this.f23832OooO0oo = i2;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            OooOOO.OooO00o(this.f23828OooO0Oo, this.f23830OooO0o0, this.f23829OooO0o, composer, RecomposeScopeImplKt.updateChangedFlags(this.f23831OooO0oO | 1), this.f23832OooO0oo);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0OO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Modifier f23833OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f23834OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(Modifier modifier, int i) {
            super(2);
            this.f23833OooO0Oo = modifier;
            this.f23834OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f23834OooO0o0 | 1);
            OooOOO.OooO0O0(this.f23833OooO0Oo, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0o extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ CameraViewModel f23835OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(CameraViewModel cameraViewModel) {
            super(0);
            this.f23835OooO0Oo = cameraViewModel;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            h0.OooO0O0("106077");
            CameraViewModel cameraViewModel = this.f23835OooO0Oo;
            Intrinsics.checkNotNullParameter(cameraViewModel, "cameraViewModel");
            int iOooO0o0 = cameraViewModel.OooO0o0();
            MutableState mutableState = cameraViewModel.f23787OooOo0;
            if (iOooO0o0 == 1) {
            ...
            try {
                o0oOOo o0oooo = o0oOOo.f47875OooO0O0;
                int iOooO0o1 = cameraViewModel.OooO0o0();
                o0oooo.getClass();
                Intrinsics.checkNotNullParameter("flashMode", "key");
                SharedPreferences.Editor editorPutInt = o0oooo.f47876OooO00o.edit().putInt("flashMode", iOooO0o1);
    ...
    public static final class OooOO0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f23837OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0(CameraViewModel cameraViewModel, int i) {
            super(2);
            this.f23836OooO0Oo = cameraViewModel;
            this.f23837OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f23837OooO0o0 | 1);
            OooOOO.OooO0OO(this.f23836OooO0Oo, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0O extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ CoroutineScope f23838OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ Context f23839OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ CameraViewModel f23840OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ MutableState<PreviewView> f23841OooO0oO;
        ...
        public OooOO0O(CoroutineScope coroutineScope, CameraViewModel cameraViewModel, Context context, MutableState<PreviewView> mutableState) {
            super(0);
            this.f23838OooO0Oo = coroutineScope;
            this.f23840OooO0o0 = cameraViewModel;
            this.f23839OooO0o = context;
            this.f23841OooO0oO = mutableState;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            BuildersKt__Builders_commonKt.launch$default(this.f23838OooO0Oo, null, null, new com.yalla.yalla.module.media.camera.OooOOOO(this.f23840OooO0o0, this.f23839OooO0o, this.f23841OooO0oO, null), 3, null);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class C0304OooOOO extends Lambda implements Function1<DrawScope, Unit> {
        ...
        public final /* synthetic */ MutableFloatState f23842OooO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ float f23843OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ float f23844OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ boolean f23845OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ float f23846OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ MutableState<Dp> f23847OooO0oo;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public final /* synthetic */ MutableFloatState f23848OooOO0;
        ...
        public C0304OooOOO(float f, boolean z, float f2, float f3, MutableState<Dp> mutableState, MutableFloatState mutableFloatState, MutableFloatState mutableFloatState2) {
            super(1);
            this.f23843OooO0Oo = f;
            this.f23845OooO0o0 = z;
            this.f23844OooO0o = f2;
            this.f23846OooO0oO = f3;
            this.f23847OooO0oo = mutableState;
            this.f23842OooO = mutableFloatState;
            this.f23848OooOO0 = mutableFloatState2;
        }
        ...
        public final Unit invoke(DrawScope drawScope) {
            ...
            float fMo326toPx0680j_4 = Canvas.mo326toPx0680j_4(this.f23847OooO0oo.getValue().m3789unboximpl());
            float f = 2;
            ...
            float f2 = this.f23843OooO0Oo * 360;
            if (!this.f23845OooO0o0) {
            ...
            MutableFloatState mutableFloatState = this.f23842OooO;
            float floatValue = mutableFloatState.getFloatValue();
            MutableFloatState mutableFloatState2 = this.f23848OooOO0;
            float floatValue2 = (mutableFloatState2.getFloatValue() * f) - mutableFloatState.getFloatValue();
            float f5 = this.f23844OooO0o;
    ...
    public static final class OooOOO0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ CameraViewModel f23849OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f23850OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MutableState<PreviewView> f23851OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO0(CameraViewModel cameraViewModel, MutableState<PreviewView> mutableState, int i) {
            super(2);
            this.f23849OooO0Oo = cameraViewModel;
            this.f23851OooO0o0 = mutableState;
            this.f23850OooO0o = i;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f23850OooO0o | 1);
            OooOOO.OooO0Oo(this.f23849OooO0Oo, this.f23851OooO0o0, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOOOO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ float f23852OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ Modifier f23853OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ boolean f23854OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f23855OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOOO(float f, boolean z, Modifier modifier, int i) {
            super(2);
            this.f23852OooO0Oo = f;
            this.f23854OooO0o0 = z;
            this.f23853OooO0o = modifier;
            this.f23855OooO0oO = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f23855OooO0oO | 1);
            boolean z = this.f23854OooO0o0;
            Modifier modifier = this.f23853OooO0o;
            OooOOO.OooO0o0(this.f23852OooO0Oo, z, modifier, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOo extends Lambda implements Function1<Long, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function1<Long, Unit> f23856OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public OooOo(Function1<? super Long, Unit> function1) {
            super(1);
            this.f23856OooO0Oo = function1;
        }

        @Override // kotlin.jvm.functions.Function1
        public final Unit invoke(Long l) {
            long jLongValue = l.longValue();
            Function1<Long, Unit> function1 = this.f23856OooO0Oo;
            if (function1 != null) {
    ...
    public static final class OooOo00 extends Lambda implements Function1<Long, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function1<Long, Unit> f23857OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public OooOo00(Function1<? super Long, Unit> function1) {
            super(1);
            this.f23857OooO0Oo = function1;
        }

        @Override // kotlin.jvm.functions.Function1
        public final Unit invoke(Long l) {
            long jLongValue = l.longValue();
            Function1<Long, Unit> function1 = this.f23857OooO0Oo;
            if (function1 != null) {
                function1.invoke(Long.valueOf(jLongValue));
            }
            return Unit.INSTANCE;
    ...
    public static final class Oooo0 extends Lambda implements Function1<Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final Oooo0 f23858OooO0Oo = new Oooo0();
    ...
    public static final class Oooo000 extends Lambda implements Function1<Long, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function1<Boolean, Unit> f23859OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public Oooo000(Function1<? super Boolean, Unit> function1) {
            super(1);
            this.f23859OooO0Oo = function1;
        }

        @Override // kotlin.jvm.functions.Function1
        public final Unit invoke(Long l) {
            l.longValue();
            p365o0OOo00O.OooO0o oooO0o = o0O00O0o.f47809OooO00o;
            o0O00O0o.OooO0O0();
            Function1<Boolean, Unit> function1 = this.f23859OooO0Oo;
            if (function1 != null) {
    ...
    public static final class o000oOoO extends Lambda implements Function1<Long, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MutableState<SelectMusicModel> f23860OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f23861OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public o000oOoO(MutableState<SelectMusicModel> mutableState, MutableState<Boolean> mutableState2) {
            super(1);
            this.f23860OooO0Oo = mutableState;
            this.f23861OooO0o0 = mutableState2;
        }
        ...
        public final Unit invoke(Long l) {
            ...
            long jLongValue = l.longValue();
            MutableState<SelectMusicModel> mutableState = this.f23860OooO0Oo;
            if (mutableState.getValue() != null && (value = mutableState.getValue()) != null) {
                value.setStartPosition(jLongValue);
            }
            this.f23861OooO0o0.setValue(Boolean.FALSE);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class o00O0O extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f23862OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ Function1<Boolean, Unit> f23863OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public o00O0O(MutableState<Boolean> mutableState, Function1<? super Boolean, Unit> function1) {
            super(0);
            this.f23862OooO0Oo = mutableState;
            this.f23863OooO0o0 = function1;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            Boolean bool = Boolean.TRUE;
            this.f23862OooO0Oo.setValue(bool);
            Function1<Boolean, Unit> function1 = this.f23863OooO0o0;
            if (function1 != null) {
    ...
    public static final class o00Oo0 extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function0<Unit> f23864OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public o00Oo0(Function0<Unit> function0) {
            super(0);
            this.f23864OooO0Oo = function0;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            this.f23864OooO0Oo.invoke();
            h0.OooO0O0("106092");
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class o00Ooo extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO, reason: collision with root package name */
        public final /* synthetic */ Function1<SelectMusicModel, Unit> f23865OooO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ BoxScope f23866OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ boolean f23867OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MutableState<SelectMusicModel> f23868OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ long f23869OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ Function0<Unit> f23870OooO0oo;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f23871OooOO0;

        /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
        public final /* synthetic */ MutableState<Function0<Unit>> f23872OooOO0O;

        /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
        public final /* synthetic */ Function1<Long, Unit> f23873OooOO0o;

        /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
        public final /* synthetic */ int f23874OooOOO;

        /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
        public final /* synthetic */ Function1<Boolean, Unit> f23875OooOOO0;

        /* JADX INFO: renamed from: OooOOOO, reason: collision with root package name */
        public final /* synthetic */ int f23876OooOOOO;
        ...
        public o00Ooo(BoxScope boxScope, MutableState<SelectMusicModel> mutableState, boolean z, long j, Function0<Unit> function0, Function1<? super SelectMusicModel, Unit> function1, MutableState<Boolean> mutableState2, MutableState<Function0<Unit>> mutableState3, Function1<? super Long, Unit> function2, Function1<? super Boolean, Unit> function3, int i, int i2) {
            super(2);
            this.f23866OooO0Oo = boxScope;
            this.f23868OooO0o0 = mutableState;
            this.f23867OooO0o = z;
            this.f23869OooO0oO = j;
            this.f23870OooO0oo = function0;
            this.f23865OooO = function1;
            this.f23871OooOO0 = mutableState2;
            this.f23872OooOO0O = mutableState3;
            this.f23873OooOO0o = function2;
            this.f23875OooOOO0 = function3;
            this.f23874OooOOO = i;
            this.f23876OooOOOO = i2;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            OooOOO.OooO0o(this.f23866OooO0Oo, this.f23868OooO0o0, this.f23867OooO0o, this.f23869OooO0oO, this.f23870OooO0oo, this.f23865OooO, this.f23871OooOO0, this.f23872OooOO0O, this.f23873OooOO0o, this.f23875OooOOO0, composer, RecomposeScopeImplKt.updateChangedFlags(this.f23874OooOOO | 1), this.f23876OooOOOO);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class o00oO0o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f23877OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ CameraViewModel f23878OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public o00oO0o(CameraViewModel cameraViewModel, Continuation<? super o00oO0o> continuation) {
            super(2, continuation);
            this.f23878OooO0o0 = cameraViewModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new o00oO0o(this.f23878OooO0o0, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f23877OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                this.f23877OooO0Oo = 1;
            ...
            this.f23878OooO0o0.f23786OooOo.setValue(Boolean.FALSE);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class o0OO00O extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ int f23879OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ Function0<Unit> f23880OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ CameraViewModel f23881OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public o0OO00O(int i, CameraViewModel cameraViewModel, Function0<Unit> function0, Continuation<? super o0OO00O> continuation) {
            super(2, continuation);
            this.f23879OooO0Oo = i;
            this.f23881OooO0o0 = cameraViewModel;
            this.f23880OooO0o = function0;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new o0OO00O(this.f23879OooO0Oo, this.f23881OooO0o0, this.f23880OooO0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            IntrinsicsKt.getCOROUTINE_SUSPENDED();
            ResultKt.throwOnFailure(obj);
            if (this.f23879OooO0Oo >= this.f23881OooO0o0.OooO0oo().f23794OooO00o) {
                this.f23880OooO0o.invoke();
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class o0OOO0o extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ CameraViewModel f23882OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public o0OOO0o(CameraViewModel cameraViewModel) {
            super(0);
            this.f23882OooO0Oo = cameraViewModel;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            this.f23882OooO0Oo.f23786OooOo.setValue(Boolean.FALSE);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class o0Oo0oo extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ BoxScope f23883OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f23884OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ CameraViewModel f23885OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public o0Oo0oo(BoxScope boxScope, CameraViewModel cameraViewModel, int i) {
            super(2);
            this.f23883OooO0Oo = boxScope;
            this.f23885OooO0o0 = cameraViewModel;
            this.f23884OooO0o = i;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f23884OooO0o | 1);
            OooOOO.OooO0oO(this.f23883OooO0Oo, this.f23885OooO0o0, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class o0OoOo0 extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function1<SelectMusicModel, Unit> f23886OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MutableState<SelectMusicModel> f23887OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public o0OoOo0(Function1<? super SelectMusicModel, Unit> function1, MutableState<SelectMusicModel> mutableState) {
            super(0);
            this.f23886OooO0Oo = function1;
            this.f23887OooO0o0 = mutableState;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            MutableState<SelectMusicModel> mutableState = this.f23887OooO0o0;
            this.f23886OooO0Oo.invoke(mutableState.getValue());
    ...
    public static final class o0ooOOo extends Lambda implements Function1<DrawScope, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Drawable f23888OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public o0ooOOo(Drawable drawable) {
            super(1);
            this.f23888OooO0Oo = drawable;
        }
        ...
        public final Unit invoke(DrawScope drawScope) {
            ...
            Drawable drawable = this.f23888OooO0Oo;
    ...
    public static final class oo000o extends Lambda implements Function1<DisposableEffectScope, DisposableEffectResult> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ CameraViewModel f23889OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public oo000o(CameraViewModel cameraViewModel) {
            super(1);
            this.f23889OooO0Oo = cameraViewModel;
        }
        ...
        public final DisposableEffectResult invoke(DisposableEffectScope disposableEffectScope) {
            ...
            o0oOOo.f47875OooO0O0.OooO0O0("pauseRecordingVideo", false);
            return new a0(this.f23889OooO0Oo);
        }
    }
    ...
    public static final class oo0o0Oo extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ CameraViewModel f23890OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f23891OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ Function0<Unit> f23892OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public oo0o0Oo(CameraViewModel cameraViewModel, Function0<Unit> function0, int i) {
            super(2);
            this.f23890OooO0Oo = cameraViewModel;
            this.f23892OooO0o0 = function0;
            this.f23891OooO0o = i;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f23891OooO0o | 1);
            OooOOO.OooO0oo(this.f23890OooO0Oo, this.f23892OooO0o0, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final void OooO00o(@NotNull BoxScope boxScope, boolean z, @NotNull Function0<Unit> onClick, @Nullable Composer composer, int i, int i2) {
        ...
        if (i5 == 0) {
            ...
            if ((i3 & 731) == 146 || !composerStartRestartGroup.getSkipping()) {
                ...
                float f2 = 10;
                Modifier modifierM171backgroundbw27NRU$default = BackgroundKt.m171backgroundbw27NRU$default(o000.OooO00o(f2, AlphaKt.alpha(modifierM532widthInVpY3zN4$default, f)), Color.m1680copywmQWz5c$default(ColorKt.Color(0), 0.3f, 0.0f, 0.0f, 0.0f, 14, null), null, 2, null);
                ...
                MeasurePolicy measurePolicyOooO00o = androidx.compose.material.OooO0OO.OooO00o(Arrangement.INSTANCE, centerVertically, composerStartRestartGroup, 48, -1323940314);
        ...
        if ((i3 & 731) == 146) {
            ...
            float f3 = 10;
            Modifier modifierM171backgroundbw27NRU$default2 = BackgroundKt.m171backgroundbw27NRU$default(o000.OooO00o(f3, AlphaKt.alpha(modifierM532widthInVpY3zN4$default2, f)), Color.m1680copywmQWz5c$default(ColorKt.Color(0), 0.3f, 0.0f, 0.0f, 0.0f, 14, null), null, 2, null);
            zOooO00o = androidx.compose.foundation.gestures.OooO0OO.OooO00o(z3, composerStartRestartGroup, 511388516) | composerStartRestartGroup.changed(onClick);
            objRememberedValue = composerStartRestartGroup.rememberedValue();
            if (zOooO00o) {
                objRememberedValue = new OooO00o(z3, onClick);
            ...
            composerStartRestartGroup.startReplaceableGroup(693286680);
            MeasurePolicy measurePolicyOooO00o2 = androidx.compose.material.OooO0OO.OooO00o(Arrangement.INSTANCE, centerVertically2, composerStartRestartGroup, 48, -1323940314);
            currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
            ...
            z4 = z3;
            TextKt.m1261Text4IGK_g(StringResources_androidKt.stringResource(o0O0oo0o.Add_Sound, composerStartRestartGroup, 0), PaddingKt.m482paddingqDBjuR0$default(companion4, Dp.m3775constructorimpl(f3), 0.0f, 0.0f, 0.0f, 14, null), Color.INSTANCE.m1718getWhite0d7_KjU(), TextUnitKt.getSp(14), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, TextOverflow.INSTANCE.m3729getEllipsisgIe3tQ8(), false, 1, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composerStartRestartGroup, 3504, 3120, 120816);
            if (androidx.compose.material.OooO0o.OooO00o(composerStartRestartGroup)) {
                ComposerKt.traceEventEnd();
            }
        } else {
            ...
            float f4 = 10;
            Modifier modifierM171backgroundbw27NRU$default3 = BackgroundKt.m171backgroundbw27NRU$default(o000.OooO00o(f4, AlphaKt.alpha(modifierM532widthInVpY3zN4$default3, f)), Color.m1680copywmQWz5c$default(ColorKt.Color(0), 0.3f, 0.0f, 0.0f, 0.0f, 14, null), null, 2, null);
            zOooO00o = androidx.compose.foundation.gestures.OooO0OO.OooO00o(z3, composerStartRestartGroup, 511388516) | composerStartRestartGroup.changed(onClick);
            objRememberedValue = composerStartRestartGroup.rememberedValue();
            if (zOooO00o) {
                objRememberedValue = new OooO00o(z3, onClick);
            ...
            composerStartRestartGroup.startReplaceableGroup(693286680);
            MeasurePolicy measurePolicyOooO00o3 = androidx.compose.material.OooO0OO.OooO00o(Arrangement.INSTANCE, centerVertically3, composerStartRestartGroup, 48, -1323940314);
            currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
            ...
            z4 = z3;
            TextKt.m1261Text4IGK_g(StringResources_androidKt.stringResource(o0O0oo0o.Add_Sound, composerStartRestartGroup, 0), PaddingKt.m482paddingqDBjuR0$default(companion7, Dp.m3775constructorimpl(f4), 0.0f, 0.0f, 0.0f, 14, null), Color.INSTANCE.m1718getWhite0d7_KjU(), TextUnitKt.getSp(14), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, TextOverflow.INSTANCE.m3729getEllipsisgIe3tQ8(), false, 1, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composerStartRestartGroup, 3504, 3120, 120816);
            if (androidx.compose.material.OooO0o.OooO00o(composerStartRestartGroup)) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final void OooO0OO(@NotNull CameraViewModel cameraViewModel, @Nullable Composer composer, int i) {
        ...
        int iOooO0o0 = cameraViewModel.OooO0o0();
        if (iOooO0o0 != 1) {
            i2 = iOooO0o0 != 2 ? o0oO0O0o.ic_camera_flash_mode_auto : o0oO0O0o.ic_camera_flash_mode_off;
        } else {
            i2 = o0oO0O0o.ic_camera_flash_mode_on;
        }
    ...
    public static final void OooO0o(@NotNull BoxScope boxScope, @NotNull MutableState<SelectMusicModel> selectMusicModel, boolean z, long j, @NotNull Function0<Unit> deleteMusic, @NotNull Function1<? super SelectMusicModel, Unit> direct2AddMusic, @Nullable MutableState<Boolean> mutableState, @Nullable MutableState<Function0<Unit>> mutableState2, @Nullable Function1<? super Long, Unit> function1, @Nullable Function1<? super Boolean, Unit> function2, @Nullable Composer composer, int i, int i2) {
        ...
        if ((i2 & 16) == 0) {
            ...
            if (i5 != 0) {
                ...
                if (i7 != 0) {
                    ...
                    if ((i3 & 1533916891) == 306783378 || !composerStartRestartGroup.getSkipping()) {
                        ...
                        if (mutableState3 != null && mutableState4 != null) {
                            ...
                            Oooo0 oooo0 = Oooo0.f23858OooO0Oo;
                            ...
                            composerStartRestartGroup.endReplaceableGroup();
                            mutableState4.setValue(o0000oo.OooO00o(mutableState3, str2, durationMs, j, function9, function10, function11, oooo0, (Function1) objRememberedValue7, composerStartRestartGroup, ((i3 >> 18) & 14) | 100663296 | (i3 & 7168)));
                        }
                        composerStartRestartGroup.endReplaceableGroup();
                        companion = Modifier.INSTANCE;
                        Alignment.Companion companion2 = Alignment.INSTANCE;
                        f = 10;
                        Modifier modifierOooO00o = o000.OooO00o(f, androidx.compose.foundation.layout.SizeKt.m511height3ABfNKs(PaddingKt.m482paddingqDBjuR0$default(boxScope.align(companion, companion2.getTopCenter()), 0.0f, Dp.m3775constructorimpl(6), 0.0f, 0.0f, 13, null), Dp.m3775constructorimpl(35)));
                        if (z) {
                            f2 = 1.0f;
                        } else {
                            f2 = 0.5f;
                        ...
                        composerStartRestartGroup.endReplaceableGroup();
                        oo0o0O0.OooO00o(str, jM1718getWhite0d7_KjU, sp, o0O0O00.OooO0O0(modifierM532widthInVpY3zN4$default, z, false, 0L, false, null, null, null, (Function0) objRememberedValue, 252), false, composerStartRestartGroup, 432, 16);
                        if (mutableState5 != null) {
                            composerStartRestartGroup.startReplaceableGroup(-194151136);
                            Painter painterPainterResource = PainterResources_androidKt.painterResource(o0oO0O0o.ic_camera_music_clip, composerStartRestartGroup, 0);
                            composerStartRestartGroup.startReplaceableGroup(511388516);
                        ...
                        Painter painterPainterResource2 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_remove_selected_music, composer2, 0);
                ...
                if ((i3 & 1533916891) == 306783378) {
                    ...
                    if (mutableState3 != null) {
                        ...
                        Oooo0 oooo1 = Oooo0.f23858OooO0Oo;
                        composerStartRestartGroup.startReplaceableGroup(511388516);
                        zChanged7 = composerStartRestartGroup.changed(selectMusicModel) | composerStartRestartGroup.changed(mutableState3);
                        objRememberedValue7 = composerStartRestartGroup.rememberedValue();
                        if (zChanged7) {
                        ...
                        composerStartRestartGroup.endReplaceableGroup();
                        mutableState4.setValue(o0000oo.OooO00o(mutableState3, str2, durationMs, j, function13, function14, function15, oooo1, (Function1) objRememberedValue7, composerStartRestartGroup, ((i3 >> 18) & 14) | 100663296 | (i3 & 7168)));
                    }
                    composerStartRestartGroup.endReplaceableGroup();
                    companion = Modifier.INSTANCE;
                    Alignment.Companion companion4 = Alignment.INSTANCE;
                    f = 10;
                    Modifier modifierOooO00o2 = o000.OooO00o(f, androidx.compose.foundation.layout.SizeKt.m511height3ABfNKs(PaddingKt.m482paddingqDBjuR0$default(boxScope.align(companion, companion4.getTopCenter()), 0.0f, Dp.m3775constructorimpl(6), 0.0f, 0.0f, 13, null), Dp.m3775constructorimpl(35)));
                    if (z) {
                        f2 = 1.0f;
                    } else {
                        f2 = 0.5f;
                    ...
                    MeasurePolicy measurePolicyOooO00o3 = androidx.compose.material.OooO0OO.OooO00o(arrangement2, centerVertically3, composerStartRestartGroup, 48, -1323940314);
                    currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
                    CompositionLocalMap currentCompositionLocalMap3 = composerStartRestartGroup.getCurrentCompositionLocalMap();
                    mutableState5 = mutableState3;
                    ...
                    composerM1320constructorimpl = Updater.m1320constructorimpl(composerStartRestartGroup);
                    function2OooO00o = androidx.compose.animation.OooO.OooO00o(companion5, composerM1320constructorimpl, measurePolicyOooO00o3, composerM1320constructorimpl, currentCompositionLocalMap3);
                    if (composerM1320constructorimpl.getInserting()) {
                        androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
                    } else {
                        androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
                    ...
                    composerStartRestartGroup.startReplaceableGroup(693286680);
                    MeasurePolicy measurePolicyOooO00o4 = androidx.compose.material.OooO0OO.OooO00o(arrangement2, centerVertically4, composerStartRestartGroup, 48, -1323940314);
                    currentCompositeKeyHash2 = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
                    ...
                    composerM1320constructorimpl2 = Updater.m1320constructorimpl(composerStartRestartGroup);
                    function2OooO00o2 = androidx.compose.animation.OooO.OooO00o(companion5, composerM1320constructorimpl2, measurePolicyOooO00o4, composerM1320constructorimpl2, currentCompositionLocalMap4);
                    ...
                    composerStartRestartGroup.endReplaceableGroup();
                    oo0o0O0.OooO00o(str, jM1718getWhite0d7_KjU2, sp2, o0O0O00.OooO0O0(modifierM532widthInVpY3zN4$default2, z, false, 0L, false, null, null, null, (Function0) objRememberedValue, 252), false, composerStartRestartGroup, 432, 16);
                    if (mutableState5 != null) {
                        composerStartRestartGroup.startReplaceableGroup(-194151136);
                        Painter painterPainterResource3 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_camera_music_clip, composerStartRestartGroup, 0);
                        composerStartRestartGroup.startReplaceableGroup(511388516);
                        zChanged3 = composerStartRestartGroup.changed(mutableState5) | composerStartRestartGroup.changed(function5);
                        objRememberedValue3 = composerStartRestartGroup.rememberedValue();
                        if (zChanged3) {
                    ...
                    o00O00OO.OooO0O0(composer2);
                    Painter painterPainterResource4 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_remove_selected_music, composer2, 0);
                    ...
                    if (mutableState3 != null) {
                        ...
                        Oooo0 oooo2 = Oooo0.f23858OooO0Oo;
                        composerStartRestartGroup.startReplaceableGroup(511388516);
                        zChanged7 = composerStartRestartGroup.changed(selectMusicModel) | composerStartRestartGroup.changed(mutableState3);
                        objRememberedValue7 = composerStartRestartGroup.rememberedValue();
                        if (zChanged7) {
                        ...
                        composerStartRestartGroup.endReplaceableGroup();
                        mutableState4.setValue(o0000oo.OooO00o(mutableState3, str2, durationMs, j, function17, function18, function19, oooo2, (Function1) objRememberedValue7, composerStartRestartGroup, ((i3 >> 18) & 14) | 100663296 | (i3 & 7168)));
                    }
                    composerStartRestartGroup.endReplaceableGroup();
                    companion = Modifier.INSTANCE;
                    Alignment.Companion companion6 = Alignment.INSTANCE;
                    f = 10;
                    Modifier modifierOooO00o3 = o000.OooO00o(f, androidx.compose.foundation.layout.SizeKt.m511height3ABfNKs(PaddingKt.m482paddingqDBjuR0$default(boxScope.align(companion, companion6.getTopCenter()), 0.0f, Dp.m3775constructorimpl(6), 0.0f, 0.0f, 13, null), Dp.m3775constructorimpl(35)));
                    if (z) {
                        f2 = 1.0f;
                    } else {
                        f2 = 0.5f;
                    ...
                    MeasurePolicy measurePolicyOooO00o5 = androidx.compose.material.OooO0OO.OooO00o(arrangement3, centerVertically5, composerStartRestartGroup, 48, -1323940314);
                    currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
                    ...
                    composerM1320constructorimpl = Updater.m1320constructorimpl(composerStartRestartGroup);
                    function2OooO00o = androidx.compose.animation.OooO.OooO00o(companion7, composerM1320constructorimpl, measurePolicyOooO00o5, composerM1320constructorimpl, currentCompositionLocalMap5);
                    if (composerM1320constructorimpl.getInserting()) {
                        androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
                    } else {
                        androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
                    ...
                    composerStartRestartGroup.startReplaceableGroup(693286680);
                    MeasurePolicy measurePolicyOooO00o6 = androidx.compose.material.OooO0OO.OooO00o(arrangement3, centerVertically6, composerStartRestartGroup, 48, -1323940314);
                    currentCompositeKeyHash2 = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
                    ...
                    composerM1320constructorimpl2 = Updater.m1320constructorimpl(composerStartRestartGroup);
                    function2OooO00o2 = androidx.compose.animation.OooO.OooO00o(companion7, composerM1320constructorimpl2, measurePolicyOooO00o6, composerM1320constructorimpl2, currentCompositionLocalMap6);
                    if (composerM1320constructorimpl2.getInserting()) {
                        androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
                    } else {
                        androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
                    ...
                    composerStartRestartGroup.endReplaceableGroup();
                    oo0o0O0.OooO00o(str, jM1718getWhite0d7_KjU3, sp3, o0O0O00.OooO0O0(modifierM532widthInVpY3zN4$default3, z, false, 0L, false, null, null, null, (Function0) objRememberedValue, 252), false, composerStartRestartGroup, 432, 16);
                    if (mutableState5 != null) {
                        composerStartRestartGroup.startReplaceableGroup(-194151136);
                        Painter painterPainterResource5 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_camera_music_clip, composerStartRestartGroup, 0);
                        composerStartRestartGroup.startReplaceableGroup(511388516);
                        zChanged3 = composerStartRestartGroup.changed(mutableState5) | composerStartRestartGroup.changed(function5);
                        objRememberedValue3 = composerStartRestartGroup.rememberedValue();
                        if (zChanged3) {
                    ...
                    o00O00OO.OooO0O0(composer2);
                    Painter painterPainterResource6 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_remove_selected_music, composer2, 0);
            ...
            if (i7 != 0) {
                ...
                if ((i3 & 1533916891) == 306783378) {
                    ...
                    if (mutableState3 != null) {
                        ...
                        Oooo0 oooo3 = Oooo0.f23858OooO0Oo;
                        composerStartRestartGroup.startReplaceableGroup(511388516);
                        zChanged7 = composerStartRestartGroup.changed(selectMusicModel) | composerStartRestartGroup.changed(mutableState3);
                        objRememberedValue7 = composerStartRestartGroup.rememberedValue();
                        if (zChanged7) {
                        ...
                        composerStartRestartGroup.endReplaceableGroup();
                        mutableState4.setValue(o0000oo.OooO00o(mutableState3, str2, durationMs, j, function111, function112, function113, oooo3, (Function1) objRememberedValue7, composerStartRestartGroup, ((i3 >> 18) & 14) | 100663296 | (i3 & 7168)));
                    }
                    composerStartRestartGroup.endReplaceableGroup();
                    companion = Modifier.INSTANCE;
                    Alignment.Companion companion8 = Alignment.INSTANCE;
                    f = 10;
                    Modifier modifierOooO00o4 = o000.OooO00o(f, androidx.compose.foundation.layout.SizeKt.m511height3ABfNKs(PaddingKt.m482paddingqDBjuR0$default(boxScope.align(companion, companion8.getTopCenter()), 0.0f, Dp.m3775constructorimpl(6), 0.0f, 0.0f, 13, null), Dp.m3775constructorimpl(35)));
                    if (z) {
                        f2 = 1.0f;
                    } else {
                        f2 = 0.5f;
                    ...
                    MeasurePolicy measurePolicyOooO00o7 = androidx.compose.material.OooO0OO.OooO00o(arrangement4, centerVertically7, composerStartRestartGroup, 48, -1323940314);
                    currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
                    ...
                    composerM1320constructorimpl = Updater.m1320constructorimpl(composerStartRestartGroup);
                    function2OooO00o = androidx.compose.animation.OooO.OooO00o(companion9, composerM1320constructorimpl, measurePolicyOooO00o7, composerM1320constructorimpl, currentCompositionLocalMap7);
                    if (composerM1320constructorimpl.getInserting()) {
                        androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
                    } else {
                        androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
                    ...
                    composerStartRestartGroup.startReplaceableGroup(693286680);
                    MeasurePolicy measurePolicyOooO00o8 = androidx.compose.material.OooO0OO.OooO00o(arrangement4, centerVertically8, composerStartRestartGroup, 48, -1323940314);
                    currentCompositeKeyHash2 = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
                    ...
                    composerM1320constructorimpl2 = Updater.m1320constructorimpl(composerStartRestartGroup);
                    function2OooO00o2 = androidx.compose.animation.OooO.OooO00o(companion9, composerM1320constructorimpl2, measurePolicyOooO00o8, composerM1320constructorimpl2, currentCompositionLocalMap8);
                    if (composerM1320constructorimpl2.getInserting()) {
                        androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
                    } else {
                        androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
                    ...
                    composerStartRestartGroup.endReplaceableGroup();
                    oo0o0O0.OooO00o(str, jM1718getWhite0d7_KjU4, sp4, o0O0O00.OooO0O0(modifierM532widthInVpY3zN4$default4, z, false, 0L, false, null, null, null, (Function0) objRememberedValue, 252), false, composerStartRestartGroup, 432, 16);
                    if (mutableState5 != null) {
                        composerStartRestartGroup.startReplaceableGroup(-194151136);
                        Painter painterPainterResource7 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_camera_music_clip, composerStartRestartGroup, 0);
                        composerStartRestartGroup.startReplaceableGroup(511388516);
                        zChanged3 = composerStartRestartGroup.changed(mutableState5) | composerStartRestartGroup.changed(function5);
                        objRememberedValue3 = composerStartRestartGroup.rememberedValue();
                        if (zChanged3) {
                    ...
                    o00O00OO.OooO0O0(composer2);
                    Painter painterPainterResource8 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_remove_selected_music, composer2, 0);
                    ...
                    if (mutableState3 != null) {
                        ...
                        Oooo0 oooo4 = Oooo0.f23858OooO0Oo;
                        composerStartRestartGroup.startReplaceableGroup(511388516);
                        zChanged7 = composerStartRestartGroup.changed(selectMusicModel) | composerStartRestartGroup.changed(mutableState3);
                        objRememberedValue7 = composerStartRestartGroup.rememberedValue();
                        if (zChanged7) {
                        ...
                        composerStartRestartGroup.endReplaceableGroup();
                        mutableState4.setValue(o0000oo.OooO00o(mutableState3, str2, durationMs, j, function115, function116, function117, oooo4, (Function1) objRememberedValue7, composerStartRestartGroup, ((i3 >> 18) & 14) | 100663296 | (i3 & 7168)));
                    }
                    composerStartRestartGroup.endReplaceableGroup();
                    companion = Modifier.INSTANCE;
                    Alignment.Companion companion10 = Alignment.INSTANCE;
                    f = 10;
                    Modifier modifierOooO00o5 = o000.OooO00o(f, androidx.compose.foundation.layout.SizeKt.m511height3ABfNKs(PaddingKt.m482paddingqDBjuR0$default(boxScope.align(companion, companion10.getTopCenter()), 0.0f, Dp.m3775constructorimpl(6), 0.0f, 0.0f, 13, null), Dp.m3775constructorimpl(35)));
                    if (z) {
                        f2 = 1.0f;
                    } else {
                        f2 = 0.5f;
                    ...
                    MeasurePolicy measurePolicyOooO00o9 = androidx.compose.material.OooO0OO.OooO00o(arrangement5, centerVertically9, composerStartRestartGroup, 48, -1323940314);
                    currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
                    ...
                    composerM1320constructorimpl = Updater.m1320constructorimpl(composerStartRestartGroup);
                    function2OooO00o = androidx.compose.animation.OooO.OooO00o(companion11, composerM1320constructorimpl, measurePolicyOooO00o9, composerM1320constructorimpl, currentCompositionLocalMap9);
                    if (composerM1320constructorimpl.getInserting()) {
                        androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
                    } else {
                        androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
                    ...
                    composerStartRestartGroup.startReplaceableGroup(693286680);
                    MeasurePolicy measurePolicyOooO00o10 = androidx.compose.material.OooO0OO.OooO00o(arrangement5, centerVertically10, composerStartRestartGroup, 48, -1323940314);
                    currentCompositeKeyHash2 = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
                    ...
                    composerM1320constructorimpl2 = Updater.m1320constructorimpl(composerStartRestartGroup);
                    function2OooO00o2 = androidx.compose.animation.OooO.OooO00o(companion11, composerM1320constructorimpl2, measurePolicyOooO00o10, composerM1320constructorimpl2, currentCompositionLocalMap10);
                    if (composerM1320constructorimpl2.getInserting()) {
                        androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
                    } else {
                        androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
                    ...
                    composerStartRestartGroup.endReplaceableGroup();
                    oo0o0O0.OooO00o(str, jM1718getWhite0d7_KjU5, sp5, o0O0O00.OooO0O0(modifierM532widthInVpY3zN4$default5, z, false, 0L, false, null, null, null, (Function0) objRememberedValue, 252), false, composerStartRestartGroup, 432, 16);
                    if (mutableState5 != null) {
                        composerStartRestartGroup.startReplaceableGroup(-194151136);
                        Painter painterPainterResource9 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_camera_music_clip, composerStartRestartGroup, 0);
                        composerStartRestartGroup.startReplaceableGroup(511388516);
                        zChanged3 = composerStartRestartGroup.changed(mutableState5) | composerStartRestartGroup.changed(function5);
                        objRememberedValue3 = composerStartRestartGroup.rememberedValue();
                        if (zChanged3) {
                    ...
                    o00O00OO.OooO0O0(composer2);
                    Painter painterPainterResource10 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_remove_selected_music, composer2, 0);
            ...
            if ((i3 & 1533916891) == 306783378) {
                ...
                if (mutableState3 != null) {
                    ...
                    Oooo0 oooo5 = Oooo0.f23858OooO0Oo;
                    composerStartRestartGroup.startReplaceableGroup(511388516);
                    zChanged7 = composerStartRestartGroup.changed(selectMusicModel) | composerStartRestartGroup.changed(mutableState3);
                    objRememberedValue7 = composerStartRestartGroup.rememberedValue();
                    if (zChanged7) {
                    ...
                    composerStartRestartGroup.endReplaceableGroup();
                    mutableState4.setValue(o0000oo.OooO00o(mutableState3, str2, durationMs, j, function119, function1110, function1111, oooo5, (Function1) objRememberedValue7, composerStartRestartGroup, ((i3 >> 18) & 14) | 100663296 | (i3 & 7168)));
                }
                composerStartRestartGroup.endReplaceableGroup();
                companion = Modifier.INSTANCE;
                Alignment.Companion companion12 = Alignment.INSTANCE;
                f = 10;
                Modifier modifierOooO00o6 = o000.OooO00o(f, androidx.compose.foundation.layout.SizeKt.m511height3ABfNKs(PaddingKt.m482paddingqDBjuR0$default(boxScope.align(companion, companion12.getTopCenter()), 0.0f, Dp.m3775constructorimpl(6), 0.0f, 0.0f, 13, null), Dp.m3775constructorimpl(35)));
                if (z) {
                    f2 = 1.0f;
                } else {
                    f2 = 0.5f;
                ...
                MeasurePolicy measurePolicyOooO00o11 = androidx.compose.material.OooO0OO.OooO00o(arrangement6, centerVertically11, composerStartRestartGroup, 48, -1323940314);
                currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
                ...
                composerM1320constructorimpl = Updater.m1320constructorimpl(composerStartRestartGroup);
                function2OooO00o = androidx.compose.animation.OooO.OooO00o(companion13, composerM1320constructorimpl, measurePolicyOooO00o11, composerM1320constructorimpl, currentCompositionLocalMap11);
                if (composerM1320constructorimpl.getInserting()) {
                    androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
                } else {
                    androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
                ...
                composerStartRestartGroup.startReplaceableGroup(693286680);
                MeasurePolicy measurePolicyOooO00o12 = androidx.compose.material.OooO0OO.OooO00o(arrangement6, centerVertically12, composerStartRestartGroup, 48, -1323940314);
                currentCompositeKeyHash2 = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
                ...
                composerM1320constructorimpl2 = Updater.m1320constructorimpl(composerStartRestartGroup);
                function2OooO00o2 = androidx.compose.animation.OooO.OooO00o(companion13, composerM1320constructorimpl2, measurePolicyOooO00o12, composerM1320constructorimpl2, currentCompositionLocalMap12);
                if (composerM1320constructorimpl2.getInserting()) {
                    androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
                } else {
                    androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
                ...
                composerStartRestartGroup.endReplaceableGroup();
                oo0o0O0.OooO00o(str, jM1718getWhite0d7_KjU6, sp6, o0O0O00.OooO0O0(modifierM532widthInVpY3zN4$default6, z, false, 0L, false, null, null, null, (Function0) objRememberedValue, 252), false, composerStartRestartGroup, 432, 16);
                if (mutableState5 != null) {
                    composerStartRestartGroup.startReplaceableGroup(-194151136);
                    Painter painterPainterResource11 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_camera_music_clip, composerStartRestartGroup, 0);
                    composerStartRestartGroup.startReplaceableGroup(511388516);
                    zChanged3 = composerStartRestartGroup.changed(mutableState5) | composerStartRestartGroup.changed(function5);
                    objRememberedValue3 = composerStartRestartGroup.rememberedValue();
                    if (zChanged3) {
                ...
                o00O00OO.OooO0O0(composer2);
                Painter painterPainterResource12 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_remove_selected_music, composer2, 0);
                ...
                if (mutableState3 != null) {
                    ...
                    Oooo0 oooo6 = Oooo0.f23858OooO0Oo;
                    composerStartRestartGroup.startReplaceableGroup(511388516);
                    zChanged7 = composerStartRestartGroup.changed(selectMusicModel) | composerStartRestartGroup.changed(mutableState3);
                    objRememberedValue7 = composerStartRestartGroup.rememberedValue();
                    if (zChanged7) {
                    ...
                    composerStartRestartGroup.endReplaceableGroup();
                    mutableState4.setValue(o0000oo.OooO00o(mutableState3, str2, durationMs, j, function1113, function1114, function1115, oooo6, (Function1) objRememberedValue7, composerStartRestartGroup, ((i3 >> 18) & 14) | 100663296 | (i3 & 7168)));
                }
                composerStartRestartGroup.endReplaceableGroup();
                companion = Modifier.INSTANCE;
                Alignment.Companion companion14 = Alignment.INSTANCE;
                f = 10;
                Modifier modifierOooO00o7 = o000.OooO00o(f, androidx.compose.foundation.layout.SizeKt.m511height3ABfNKs(PaddingKt.m482paddingqDBjuR0$default(boxScope.align(companion, companion14.getTopCenter()), 0.0f, Dp.m3775constructorimpl(6), 0.0f, 0.0f, 13, null), Dp.m3775constructorimpl(35)));
                if (z) {
                    f2 = 1.0f;
                } else {
                    f2 = 0.5f;
                ...
                MeasurePolicy measurePolicyOooO00o13 = androidx.compose.material.OooO0OO.OooO00o(arrangement7, centerVertically13, composerStartRestartGroup, 48, -1323940314);
                currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
                ...
                composerM1320constructorimpl = Updater.m1320constructorimpl(composerStartRestartGroup);
                function2OooO00o = androidx.compose.animation.OooO.OooO00o(companion15, composerM1320constructorimpl, measurePolicyOooO00o13, composerM1320constructorimpl, currentCompositionLocalMap13);
                if (composerM1320constructorimpl.getInserting()) {
                    androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
                } else {
                    androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
                ...
                composerStartRestartGroup.startReplaceableGroup(693286680);
                MeasurePolicy measurePolicyOooO00o14 = androidx.compose.material.OooO0OO.OooO00o(arrangement7, centerVertically14, composerStartRestartGroup, 48, -1323940314);
                currentCompositeKeyHash2 = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
                ...
                composerM1320constructorimpl2 = Updater.m1320constructorimpl(composerStartRestartGroup);
                function2OooO00o2 = androidx.compose.animation.OooO.OooO00o(companion15, composerM1320constructorimpl2, measurePolicyOooO00o14, composerM1320constructorimpl2, currentCompositionLocalMap14);
                if (composerM1320constructorimpl2.getInserting()) {
                    androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
                } else {
                    androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
                ...
                composerStartRestartGroup.endReplaceableGroup();
                oo0o0O0.OooO00o(str, jM1718getWhite0d7_KjU7, sp7, o0O0O00.OooO0O0(modifierM532widthInVpY3zN4$default7, z, false, 0L, false, null, null, null, (Function0) objRememberedValue, 252), false, composerStartRestartGroup, 432, 16);
                if (mutableState5 != null) {
                    composerStartRestartGroup.startReplaceableGroup(-194151136);
                    Painter painterPainterResource13 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_camera_music_clip, composerStartRestartGroup, 0);
                    composerStartRestartGroup.startReplaceableGroup(511388516);
                    zChanged3 = composerStartRestartGroup.changed(mutableState5) | composerStartRestartGroup.changed(function5);
                    objRememberedValue3 = composerStartRestartGroup.rememberedValue();
                    if (zChanged3) {
                ...
                o00O00OO.OooO0O0(composer2);
                Painter painterPainterResource14 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_remove_selected_music, composer2, 0);
        ...
        if (i5 != 0) {
            ...
            if (i7 != 0) {
                ...
                if ((i3 & 1533916891) == 306783378) {
                    ...
                    if (mutableState3 != null) {
                        ...
                        Oooo0 oooo7 = Oooo0.f23858OooO0Oo;
                        composerStartRestartGroup.startReplaceableGroup(511388516);
                        zChanged7 = composerStartRestartGroup.changed(selectMusicModel) | composerStartRestartGroup.changed(mutableState3);
                        objRememberedValue7 = composerStartRestartGroup.rememberedValue();
                        if (zChanged7) {
                        ...
                        composerStartRestartGroup.endReplaceableGroup();
                        mutableState4.setValue(o0000oo.OooO00o(mutableState3, str2, durationMs, j, function1117, function1118, function1119, oooo7, (Function1) objRememberedValue7, composerStartRestartGroup, ((i3 >> 18) & 14) | 100663296 | (i3 & 7168)));
                    }
                    composerStartRestartGroup.endReplaceableGroup();
                    companion = Modifier.INSTANCE;
                    Alignment.Companion companion16 = Alignment.INSTANCE;
                    f = 10;
                    Modifier modifierOooO00o8 = o000.OooO00o(f, androidx.compose.foundation.layout.SizeKt.m511height3ABfNKs(PaddingKt.m482paddingqDBjuR0$default(boxScope.align(companion, companion16.getTopCenter()), 0.0f, Dp.m3775constructorimpl(6), 0.0f, 0.0f, 13, null), Dp.m3775constructorimpl(35)));
                    if (z) {
                        f2 = 1.0f;
                    } else {
                        f2 = 0.5f;
                    ...
                    MeasurePolicy measurePolicyOooO00o15 = androidx.compose.material.OooO0OO.OooO00o(arrangement8, centerVertically15, composerStartRestartGroup, 48, -1323940314);
                    currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
                    ...
                    composerM1320constructorimpl = Updater.m1320constructorimpl(composerStartRestartGroup);
                    function2OooO00o = androidx.compose.animation.OooO.OooO00o(companion17, composerM1320constructorimpl, measurePolicyOooO00o15, composerM1320constructorimpl, currentCompositionLocalMap15);
                    if (composerM1320constructorimpl.getInserting()) {
                        androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
                    } else {
                        androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
                    ...
                    composerStartRestartGroup.startReplaceableGroup(693286680);
                    MeasurePolicy measurePolicyOooO00o16 = androidx.compose.material.OooO0OO.OooO00o(arrangement8, centerVertically16, composerStartRestartGroup, 48, -1323940314);
                    currentCompositeKeyHash2 = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
                    ...
                    composerM1320constructorimpl2 = Updater.m1320constructorimpl(composerStartRestartGroup);
                    function2OooO00o2 = androidx.compose.animation.OooO.OooO00o(companion17, composerM1320constructorimpl2, measurePolicyOooO00o16, composerM1320constructorimpl2, currentCompositionLocalMap16);
                    if (composerM1320constructorimpl2.getInserting()) {
                        androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
                    } else {
                        androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
                    ...
                    composerStartRestartGroup.endReplaceableGroup();
                    oo0o0O0.OooO00o(str, jM1718getWhite0d7_KjU8, sp8, o0O0O00.OooO0O0(modifierM532widthInVpY3zN4$default8, z, false, 0L, false, null, null, null, (Function0) objRememberedValue, 252), false, composerStartRestartGroup, 432, 16);
                    if (mutableState5 != null) {
                        composerStartRestartGroup.startReplaceableGroup(-194151136);
                        Painter painterPainterResource15 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_camera_music_clip, composerStartRestartGroup, 0);
                        composerStartRestartGroup.startReplaceableGroup(511388516);
                        zChanged3 = composerStartRestartGroup.changed(mutableState5) | composerStartRestartGroup.changed(function5);
                        objRememberedValue3 = composerStartRestartGroup.rememberedValue();
                        if (zChanged3) {
                    ...
                    o00O00OO.OooO0O0(composer2);
                    Painter painterPainterResource16 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_remove_selected_music, composer2, 0);
                    ...
                    if (mutableState3 != null) {
                        ...
                        Oooo0 oooo8 = Oooo0.f23858OooO0Oo;
                        composerStartRestartGroup.startReplaceableGroup(511388516);
                        zChanged7 = composerStartRestartGroup.changed(selectMusicModel) | composerStartRestartGroup.changed(mutableState3);
                        objRememberedValue7 = composerStartRestartGroup.rememberedValue();
                        if (zChanged7) {
                        ...
                        composerStartRestartGroup.endReplaceableGroup();
                        mutableState4.setValue(o0000oo.OooO00o(mutableState3, str2, durationMs, j, function11111, function11112, function11113, oooo8, (Function1) objRememberedValue7, composerStartRestartGroup, ((i3 >> 18) & 14) | 100663296 | (i3 & 7168)));
                    }
                    composerStartRestartGroup.endReplaceableGroup();
                    companion = Modifier.INSTANCE;
                    Alignment.Companion companion18 = Alignment.INSTANCE;
                    f = 10;
                    Modifier modifierOooO00o9 = o000.OooO00o(f, androidx.compose.foundation.layout.SizeKt.m511height3ABfNKs(PaddingKt.m482paddingqDBjuR0$default(boxScope.align(companion, companion18.getTopCenter()), 0.0f, Dp.m3775constructorimpl(6), 0.0f, 0.0f, 13, null), Dp.m3775constructorimpl(35)));
                    if (z) {
                        f2 = 1.0f;
                    } else {
                        f2 = 0.5f;
                    ...
                    MeasurePolicy measurePolicyOooO00o17 = androidx.compose.material.OooO0OO.OooO00o(arrangement9, centerVertically17, composerStartRestartGroup, 48, -1323940314);
                    currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
                    ...
                    composerM1320constructorimpl = Updater.m1320constructorimpl(composerStartRestartGroup);
                    function2OooO00o = androidx.compose.animation.OooO.OooO00o(companion19, composerM1320constructorimpl, measurePolicyOooO00o17, composerM1320constructorimpl, currentCompositionLocalMap17);
                    if (composerM1320constructorimpl.getInserting()) {
                        androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
                    } else {
                        androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
                    ...
                    composerStartRestartGroup.startReplaceableGroup(693286680);
                    MeasurePolicy measurePolicyOooO00o18 = androidx.compose.material.OooO0OO.OooO00o(arrangement9, centerVertically18, composerStartRestartGroup, 48, -1323940314);
                    currentCompositeKeyHash2 = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
                    ...
                    composerM1320constructorimpl2 = Updater.m1320constructorimpl(composerStartRestartGroup);
                    function2OooO00o2 = androidx.compose.animation.OooO.OooO00o(companion19, composerM1320constructorimpl2, measurePolicyOooO00o18, composerM1320constructorimpl2, currentCompositionLocalMap18);
                    if (composerM1320constructorimpl2.getInserting()) {
                        androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
                    } else {
                        androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
                    ...
                    composerStartRestartGroup.endReplaceableGroup();
                    oo0o0O0.OooO00o(str, jM1718getWhite0d7_KjU9, sp9, o0O0O00.OooO0O0(modifierM532widthInVpY3zN4$default9, z, false, 0L, false, null, null, null, (Function0) objRememberedValue, 252), false, composerStartRestartGroup, 432, 16);
                    if (mutableState5 != null) {
                        composerStartRestartGroup.startReplaceableGroup(-194151136);
                        Painter painterPainterResource17 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_camera_music_clip, composerStartRestartGroup, 0);
                        composerStartRestartGroup.startReplaceableGroup(511388516);
                        zChanged3 = composerStartRestartGroup.changed(mutableState5) | composerStartRestartGroup.changed(function5);
                        objRememberedValue3 = composerStartRestartGroup.rememberedValue();
                        if (zChanged3) {
                    ...
                    o00O00OO.OooO0O0(composer2);
                    Painter painterPainterResource18 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_remove_selected_music, composer2, 0);
            ...
            if ((i3 & 1533916891) == 306783378) {
                ...
                if (mutableState3 != null) {
                    ...
                    Oooo0 oooo9 = Oooo0.f23858OooO0Oo;
                    composerStartRestartGroup.startReplaceableGroup(511388516);
                    zChanged7 = composerStartRestartGroup.changed(selectMusicModel) | composerStartRestartGroup.changed(mutableState3);
                    objRememberedValue7 = composerStartRestartGroup.rememberedValue();
                    if (zChanged7) {
                    ...
                    composerStartRestartGroup.endReplaceableGroup();
                    mutableState4.setValue(o0000oo.OooO00o(mutableState3, str2, durationMs, j, function11115, function11116, function11117, oooo9, (Function1) objRememberedValue7, composerStartRestartGroup, ((i3 >> 18) & 14) | 100663296 | (i3 & 7168)));
                }
                composerStartRestartGroup.endReplaceableGroup();
                companion = Modifier.INSTANCE;
                Alignment.Companion companion110 = Alignment.INSTANCE;
                f = 10;
                Modifier modifierOooO00o10 = o000.OooO00o(f, androidx.compose.foundation.layout.SizeKt.m511height3ABfNKs(PaddingKt.m482paddingqDBjuR0$default(boxScope.align(companion, companion110.getTopCenter()), 0.0f, Dp.m3775constructorimpl(6), 0.0f, 0.0f, 13, null), Dp.m3775constructorimpl(35)));
                if (z) {
                    f2 = 1.0f;
                } else {
                    f2 = 0.5f;
                ...
                MeasurePolicy measurePolicyOooO00o19 = androidx.compose.material.OooO0OO.OooO00o(arrangement10, centerVertically19, composerStartRestartGroup, 48, -1323940314);
                currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
                ...
                composerM1320constructorimpl = Updater.m1320constructorimpl(composerStartRestartGroup);
                function2OooO00o = androidx.compose.animation.OooO.OooO00o(companion111, composerM1320constructorimpl, measurePolicyOooO00o19, composerM1320constructorimpl, currentCompositionLocalMap19);
                if (composerM1320constructorimpl.getInserting()) {
                    androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
                } else {
                    androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
                ...
                composerStartRestartGroup.startReplaceableGroup(693286680);
                MeasurePolicy measurePolicyOooO00o110 = androidx.compose.material.OooO0OO.OooO00o(arrangement10, centerVertically110, composerStartRestartGroup, 48, -1323940314);
                currentCompositeKeyHash2 = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
                ...
                composerM1320constructorimpl2 = Updater.m1320constructorimpl(composerStartRestartGroup);
                function2OooO00o2 = androidx.compose.animation.OooO.OooO00o(companion111, composerM1320constructorimpl2, measurePolicyOooO00o110, composerM1320constructorimpl2, currentCompositionLocalMap110);
                if (composerM1320constructorimpl2.getInserting()) {
                    androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
                } else {
                    androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
                ...
                composerStartRestartGroup.endReplaceableGroup();
                oo0o0O0.OooO00o(str, jM1718getWhite0d7_KjU10, sp10, o0O0O00.OooO0O0(modifierM532widthInVpY3zN4$default10, z, false, 0L, false, null, null, null, (Function0) objRememberedValue, 252), false, composerStartRestartGroup, 432, 16);
                if (mutableState5 != null) {
                    composerStartRestartGroup.startReplaceableGroup(-194151136);
                    Painter painterPainterResource19 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_camera_music_clip, composerStartRestartGroup, 0);
                    composerStartRestartGroup.startReplaceableGroup(511388516);
                    zChanged3 = composerStartRestartGroup.changed(mutableState5) | composerStartRestartGroup.changed(function5);
                    objRememberedValue3 = composerStartRestartGroup.rememberedValue();
                    if (zChanged3) {
                ...
                o00O00OO.OooO0O0(composer2);
                Painter painterPainterResource110 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_remove_selected_music, composer2, 0);
                ...
                if (mutableState3 != null) {
                    ...
                    Oooo0 oooo10 = Oooo0.f23858OooO0Oo;
                    composerStartRestartGroup.startReplaceableGroup(511388516);
                    zChanged7 = composerStartRestartGroup.changed(selectMusicModel) | composerStartRestartGroup.changed(mutableState3);
                    objRememberedValue7 = composerStartRestartGroup.rememberedValue();
                    if (zChanged7) {
                    ...
                    composerStartRestartGroup.endReplaceableGroup();
                    mutableState4.setValue(o0000oo.OooO00o(mutableState3, str2, durationMs, j, function11119, function111110, function111111, oooo10, (Function1) objRememberedValue7, composerStartRestartGroup, ((i3 >> 18) & 14) | 100663296 | (i3 & 7168)));
                }
                composerStartRestartGroup.endReplaceableGroup();
                companion = Modifier.INSTANCE;
                Alignment.Companion companion112 = Alignment.INSTANCE;
                f = 10;
                Modifier modifierOooO00o11 = o000.OooO00o(f, androidx.compose.foundation.layout.SizeKt.m511height3ABfNKs(PaddingKt.m482paddingqDBjuR0$default(boxScope.align(companion, companion112.getTopCenter()), 0.0f, Dp.m3775constructorimpl(6), 0.0f, 0.0f, 13, null), Dp.m3775constructorimpl(35)));
                if (z) {
                    f2 = 1.0f;
                } else {
                    f2 = 0.5f;
                ...
                MeasurePolicy measurePolicyOooO00o111 = androidx.compose.material.OooO0OO.OooO00o(arrangement11, centerVertically111, composerStartRestartGroup, 48, -1323940314);
                currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
                ...
                composerM1320constructorimpl = Updater.m1320constructorimpl(composerStartRestartGroup);
                function2OooO00o = androidx.compose.animation.OooO.OooO00o(companion113, composerM1320constructorimpl, measurePolicyOooO00o111, composerM1320constructorimpl, currentCompositionLocalMap111);
                if (composerM1320constructorimpl.getInserting()) {
                    androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
                } else {
                    androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
                ...
                composerStartRestartGroup.startReplaceableGroup(693286680);
                MeasurePolicy measurePolicyOooO00o112 = androidx.compose.material.OooO0OO.OooO00o(arrangement11, centerVertically112, composerStartRestartGroup, 48, -1323940314);
                currentCompositeKeyHash2 = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
                ...
                composerM1320constructorimpl2 = Updater.m1320constructorimpl(composerStartRestartGroup);
                function2OooO00o2 = androidx.compose.animation.OooO.OooO00o(companion113, composerM1320constructorimpl2, measurePolicyOooO00o112, composerM1320constructorimpl2, currentCompositionLocalMap112);
                if (composerM1320constructorimpl2.getInserting()) {
                    androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
                } else {
                    androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
                ...
                composerStartRestartGroup.endReplaceableGroup();
                oo0o0O0.OooO00o(str, jM1718getWhite0d7_KjU11, sp11, o0O0O00.OooO0O0(modifierM532widthInVpY3zN4$default11, z, false, 0L, false, null, null, null, (Function0) objRememberedValue, 252), false, composerStartRestartGroup, 432, 16);
                if (mutableState5 != null) {
                    composerStartRestartGroup.startReplaceableGroup(-194151136);
                    Painter painterPainterResource111 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_camera_music_clip, composerStartRestartGroup, 0);
                    composerStartRestartGroup.startReplaceableGroup(511388516);
                    zChanged3 = composerStartRestartGroup.changed(mutableState5) | composerStartRestartGroup.changed(function5);
                    objRememberedValue3 = composerStartRestartGroup.rememberedValue();
                    if (zChanged3) {
                ...
                o00O00OO.OooO0O0(composer2);
                Painter painterPainterResource112 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_remove_selected_music, composer2, 0);
        ...
        if (i7 != 0) {
            ...
            if ((i3 & 1533916891) == 306783378) {
                ...
                if (mutableState3 != null) {
                    ...
                    Oooo0 oooo11 = Oooo0.f23858OooO0Oo;
                    composerStartRestartGroup.startReplaceableGroup(511388516);
                    zChanged7 = composerStartRestartGroup.changed(selectMusicModel) | composerStartRestartGroup.changed(mutableState3);
                    objRememberedValue7 = composerStartRestartGroup.rememberedValue();
                    if (zChanged7) {
                    ...
                    composerStartRestartGroup.endReplaceableGroup();
                    mutableState4.setValue(o0000oo.OooO00o(mutableState3, str2, durationMs, j, function111113, function111114, function111115, oooo11, (Function1) objRememberedValue7, composerStartRestartGroup, ((i3 >> 18) & 14) | 100663296 | (i3 & 7168)));
                }
                composerStartRestartGroup.endReplaceableGroup();
                companion = Modifier.INSTANCE;
                Alignment.Companion companion114 = Alignment.INSTANCE;
                f = 10;
                Modifier modifierOooO00o12 = o000.OooO00o(f, androidx.compose.foundation.layout.SizeKt.m511height3ABfNKs(PaddingKt.m482paddingqDBjuR0$default(boxScope.align(companion, companion114.getTopCenter()), 0.0f, Dp.m3775constructorimpl(6), 0.0f, 0.0f, 13, null), Dp.m3775constructorimpl(35)));
                if (z) {
                    f2 = 1.0f;
                } else {
                    f2 = 0.5f;
                ...
                MeasurePolicy measurePolicyOooO00o113 = androidx.compose.material.OooO0OO.OooO00o(arrangement12, centerVertically113, composerStartRestartGroup, 48, -1323940314);
                currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
                ...
                composerM1320constructorimpl = Updater.m1320constructorimpl(composerStartRestartGroup);
                function2OooO00o = androidx.compose.animation.OooO.OooO00o(companion115, composerM1320constructorimpl, measurePolicyOooO00o113, composerM1320constructorimpl, currentCompositionLocalMap113);
                if (composerM1320constructorimpl.getInserting()) {
                    androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
                } else {
                    androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
                ...
                composerStartRestartGroup.startReplaceableGroup(693286680);
                MeasurePolicy measurePolicyOooO00o114 = androidx.compose.material.OooO0OO.OooO00o(arrangement12, centerVertically114, composerStartRestartGroup, 48, -1323940314);
                currentCompositeKeyHash2 = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
                ...
                composerM1320constructorimpl2 = Updater.m1320constructorimpl(composerStartRestartGroup);
                function2OooO00o2 = androidx.compose.animation.OooO.OooO00o(companion115, composerM1320constructorimpl2, measurePolicyOooO00o114, composerM1320constructorimpl2, currentCompositionLocalMap114);
                if (composerM1320constructorimpl2.getInserting()) {
                    androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
                } else {
                    androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
                ...
                composerStartRestartGroup.endReplaceableGroup();
                oo0o0O0.OooO00o(str, jM1718getWhite0d7_KjU12, sp12, o0O0O00.OooO0O0(modifierM532widthInVpY3zN4$default12, z, false, 0L, false, null, null, null, (Function0) objRememberedValue, 252), false, composerStartRestartGroup, 432, 16);
                if (mutableState5 != null) {
                    composerStartRestartGroup.startReplaceableGroup(-194151136);
                    Painter painterPainterResource113 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_camera_music_clip, composerStartRestartGroup, 0);
                    composerStartRestartGroup.startReplaceableGroup(511388516);
                    zChanged3 = composerStartRestartGroup.changed(mutableState5) | composerStartRestartGroup.changed(function5);
                    objRememberedValue3 = composerStartRestartGroup.rememberedValue();
                    if (zChanged3) {
                ...
                o00O00OO.OooO0O0(composer2);
                Painter painterPainterResource114 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_remove_selected_music, composer2, 0);
                ...
                if (mutableState3 != null) {
                    ...
                    Oooo0 oooo12 = Oooo0.f23858OooO0Oo;
                    composerStartRestartGroup.startReplaceableGroup(511388516);
                    zChanged7 = composerStartRestartGroup.changed(selectMusicModel) | composerStartRestartGroup.changed(mutableState3);
                    objRememberedValue7 = composerStartRestartGroup.rememberedValue();
                    if (zChanged7) {
                    ...
                    composerStartRestartGroup.endReplaceableGroup();
                    mutableState4.setValue(o0000oo.OooO00o(mutableState3, str2, durationMs, j, function111117, function111118, function111119, oooo12, (Function1) objRememberedValue7, composerStartRestartGroup, ((i3 >> 18) & 14) | 100663296 | (i3 & 7168)));
                }
                composerStartRestartGroup.endReplaceableGroup();
                companion = Modifier.INSTANCE;
                Alignment.Companion companion116 = Alignment.INSTANCE;
                f = 10;
                Modifier modifierOooO00o13 = o000.OooO00o(f, androidx.compose.foundation.layout.SizeKt.m511height3ABfNKs(PaddingKt.m482paddingqDBjuR0$default(boxScope.align(companion, companion116.getTopCenter()), 0.0f, Dp.m3775constructorimpl(6), 0.0f, 0.0f, 13, null), Dp.m3775constructorimpl(35)));
                if (z) {
                    f2 = 1.0f;
                } else {
                    f2 = 0.5f;
                ...
                MeasurePolicy measurePolicyOooO00o115 = androidx.compose.material.OooO0OO.OooO00o(arrangement13, centerVertically115, composerStartRestartGroup, 48, -1323940314);
                currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
                ...
                composerM1320constructorimpl = Updater.m1320constructorimpl(composerStartRestartGroup);
                function2OooO00o = androidx.compose.animation.OooO.OooO00o(companion117, composerM1320constructorimpl, measurePolicyOooO00o115, composerM1320constructorimpl, currentCompositionLocalMap115);
                if (composerM1320constructorimpl.getInserting()) {
                    androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
                } else {
                    androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
                ...
                composerStartRestartGroup.startReplaceableGroup(693286680);
                MeasurePolicy measurePolicyOooO00o116 = androidx.compose.material.OooO0OO.OooO00o(arrangement13, centerVertically116, composerStartRestartGroup, 48, -1323940314);
                currentCompositeKeyHash2 = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
                ...
                composerM1320constructorimpl2 = Updater.m1320constructorimpl(composerStartRestartGroup);
                function2OooO00o2 = androidx.compose.animation.OooO.OooO00o(companion117, composerM1320constructorimpl2, measurePolicyOooO00o116, composerM1320constructorimpl2, currentCompositionLocalMap116);
                if (composerM1320constructorimpl2.getInserting()) {
                    androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
                } else {
                    androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
                ...
                composerStartRestartGroup.endReplaceableGroup();
                oo0o0O0.OooO00o(str, jM1718getWhite0d7_KjU13, sp13, o0O0O00.OooO0O0(modifierM532widthInVpY3zN4$default13, z, false, 0L, false, null, null, null, (Function0) objRememberedValue, 252), false, composerStartRestartGroup, 432, 16);
                if (mutableState5 != null) {
                    composerStartRestartGroup.startReplaceableGroup(-194151136);
                    Painter painterPainterResource115 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_camera_music_clip, composerStartRestartGroup, 0);
                    composerStartRestartGroup.startReplaceableGroup(511388516);
                    zChanged3 = composerStartRestartGroup.changed(mutableState5) | composerStartRestartGroup.changed(function5);
                    objRememberedValue3 = composerStartRestartGroup.rememberedValue();
                    if (zChanged3) {
                ...
                o00O00OO.OooO0O0(composer2);
                Painter painterPainterResource116 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_remove_selected_music, composer2, 0);
        ...
        if ((i3 & 1533916891) == 306783378) {
            ...
            if (mutableState3 != null) {
                ...
                Oooo0 oooo13 = Oooo0.f23858OooO0Oo;
                composerStartRestartGroup.startReplaceableGroup(511388516);
                zChanged7 = composerStartRestartGroup.changed(selectMusicModel) | composerStartRestartGroup.changed(mutableState3);
                objRememberedValue7 = composerStartRestartGroup.rememberedValue();
                if (zChanged7) {
                ...
                composerStartRestartGroup.endReplaceableGroup();
                mutableState4.setValue(o0000oo.OooO00o(mutableState3, str2, durationMs, j, function1111111, function1111112, function1111113, oooo13, (Function1) objRememberedValue7, composerStartRestartGroup, ((i3 >> 18) & 14) | 100663296 | (i3 & 7168)));
            }
            composerStartRestartGroup.endReplaceableGroup();
            companion = Modifier.INSTANCE;
            Alignment.Companion companion118 = Alignment.INSTANCE;
            f = 10;
            Modifier modifierOooO00o14 = o000.OooO00o(f, androidx.compose.foundation.layout.SizeKt.m511height3ABfNKs(PaddingKt.m482paddingqDBjuR0$default(boxScope.align(companion, companion118.getTopCenter()), 0.0f, Dp.m3775constructorimpl(6), 0.0f, 0.0f, 13, null), Dp.m3775constructorimpl(35)));
            if (z) {
                f2 = 1.0f;
            } else {
                f2 = 0.5f;
            ...
            MeasurePolicy measurePolicyOooO00o117 = androidx.compose.material.OooO0OO.OooO00o(arrangement14, centerVertically117, composerStartRestartGroup, 48, -1323940314);
            currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
            ...
            composerM1320constructorimpl = Updater.m1320constructorimpl(composerStartRestartGroup);
            function2OooO00o = androidx.compose.animation.OooO.OooO00o(companion119, composerM1320constructorimpl, measurePolicyOooO00o117, composerM1320constructorimpl, currentCompositionLocalMap117);
            if (composerM1320constructorimpl.getInserting()) {
                androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
            } else {
                androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
            ...
            composerStartRestartGroup.startReplaceableGroup(693286680);
            MeasurePolicy measurePolicyOooO00o118 = androidx.compose.material.OooO0OO.OooO00o(arrangement14, centerVertically118, composerStartRestartGroup, 48, -1323940314);
            currentCompositeKeyHash2 = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
            ...
            composerM1320constructorimpl2 = Updater.m1320constructorimpl(composerStartRestartGroup);
            function2OooO00o2 = androidx.compose.animation.OooO.OooO00o(companion119, composerM1320constructorimpl2, measurePolicyOooO00o118, composerM1320constructorimpl2, currentCompositionLocalMap118);
            if (composerM1320constructorimpl2.getInserting()) {
                androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
            } else {
                androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
            ...
            composerStartRestartGroup.endReplaceableGroup();
            oo0o0O0.OooO00o(str, jM1718getWhite0d7_KjU14, sp14, o0O0O00.OooO0O0(modifierM532widthInVpY3zN4$default14, z, false, 0L, false, null, null, null, (Function0) objRememberedValue, 252), false, composerStartRestartGroup, 432, 16);
            if (mutableState5 != null) {
                composerStartRestartGroup.startReplaceableGroup(-194151136);
                Painter painterPainterResource117 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_camera_music_clip, composerStartRestartGroup, 0);
                composerStartRestartGroup.startReplaceableGroup(511388516);
                zChanged3 = composerStartRestartGroup.changed(mutableState5) | composerStartRestartGroup.changed(function5);
                objRememberedValue3 = composerStartRestartGroup.rememberedValue();
                if (zChanged3) {
            ...
            o00O00OO.OooO0O0(composer2);
            Painter painterPainterResource118 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_remove_selected_music, composer2, 0);
            ...
            if (mutableState3 != null) {
                ...
                Oooo0 oooo14 = Oooo0.f23858OooO0Oo;
                composerStartRestartGroup.startReplaceableGroup(511388516);
                zChanged7 = composerStartRestartGroup.changed(selectMusicModel) | composerStartRestartGroup.changed(mutableState3);
                objRememberedValue7 = composerStartRestartGroup.rememberedValue();
                if (zChanged7) {
                ...
                composerStartRestartGroup.endReplaceableGroup();
                mutableState4.setValue(o0000oo.OooO00o(mutableState3, str2, durationMs, j, function1111115, function1111116, function1111117, oooo14, (Function1) objRememberedValue7, composerStartRestartGroup, ((i3 >> 18) & 14) | 100663296 | (i3 & 7168)));
            }
            composerStartRestartGroup.endReplaceableGroup();
            companion = Modifier.INSTANCE;
            Alignment.Companion companion1110 = Alignment.INSTANCE;
            f = 10;
            Modifier modifierOooO00o15 = o000.OooO00o(f, androidx.compose.foundation.layout.SizeKt.m511height3ABfNKs(PaddingKt.m482paddingqDBjuR0$default(boxScope.align(companion, companion1110.getTopCenter()), 0.0f, Dp.m3775constructorimpl(6), 0.0f, 0.0f, 13, null), Dp.m3775constructorimpl(35)));
            if (z) {
                f2 = 1.0f;
            } else {
                f2 = 0.5f;
            ...
            MeasurePolicy measurePolicyOooO00o119 = androidx.compose.material.OooO0OO.OooO00o(arrangement15, centerVertically119, composerStartRestartGroup, 48, -1323940314);
            currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
            ...
            composerM1320constructorimpl = Updater.m1320constructorimpl(composerStartRestartGroup);
            function2OooO00o = androidx.compose.animation.OooO.OooO00o(companion1111, composerM1320constructorimpl, measurePolicyOooO00o119, composerM1320constructorimpl, currentCompositionLocalMap119);
            if (composerM1320constructorimpl.getInserting()) {
                androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
            } else {
                androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
            ...
            composerStartRestartGroup.startReplaceableGroup(693286680);
            MeasurePolicy measurePolicyOooO00o1110 = androidx.compose.material.OooO0OO.OooO00o(arrangement15, centerVertically1110, composerStartRestartGroup, 48, -1323940314);
            currentCompositeKeyHash2 = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
            ...
            composerM1320constructorimpl2 = Updater.m1320constructorimpl(composerStartRestartGroup);
            function2OooO00o2 = androidx.compose.animation.OooO.OooO00o(companion1111, composerM1320constructorimpl2, measurePolicyOooO00o1110, composerM1320constructorimpl2, currentCompositionLocalMap1110);
            if (composerM1320constructorimpl2.getInserting()) {
                androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
            } else {
                androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
            ...
            composerStartRestartGroup.endReplaceableGroup();
            oo0o0O0.OooO00o(str, jM1718getWhite0d7_KjU15, sp15, o0O0O00.OooO0O0(modifierM532widthInVpY3zN4$default15, z, false, 0L, false, null, null, null, (Function0) objRememberedValue, 252), false, composerStartRestartGroup, 432, 16);
            if (mutableState5 != null) {
                composerStartRestartGroup.startReplaceableGroup(-194151136);
                Painter painterPainterResource119 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_camera_music_clip, composerStartRestartGroup, 0);
                composerStartRestartGroup.startReplaceableGroup(511388516);
                zChanged3 = composerStartRestartGroup.changed(mutableState5) | composerStartRestartGroup.changed(function5);
                objRememberedValue3 = composerStartRestartGroup.rememberedValue();
                if (zChanged3) {
            ...
            o00O00OO.OooO0O0(composer2);
            Painter painterPainterResource1110 = PainterResources_androidKt.painterResource(o0oO0O0o.ic_remove_selected_music, composer2, 0);
    ...
    public static final void OooO0oO(@NotNull BoxScope boxScope, @NotNull CameraViewModel viewModel, @Nullable Composer composer, int i) {
        ...
        if (viewModel.OooO() || viewModel.OooO0oo().f23800OooO0oO.getValue() != CameraViewModel.VideoRecordState.Pause || !((Boolean) viewModel.f23786OooOo.getValue()).booleanValue() || viewModel.OooO0oo().f23795OooO0O0) {
            composer2 = composerStartRestartGroup;
        } else {
            ...
            if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
                int i2 = o0oO0O0o.ic_camera_pause_recording_warn;
            ...
            composer2 = composerStartRestartGroup;
            TextKt.m1261Text4IGK_g(StringResources_androidKt.stringResource(o0O0oo0o.tap_to_continue_recording, composerStartRestartGroup, 0), PaddingKt.m480paddingVpY3zN4$default(PaddingKt.m482paddingqDBjuR0$default(boxScopeInstance.align(companion, companion2.getBottomCenter()), 0.0f, Dp.m3775constructorimpl(15), 0.0f, Dp.m3775constructorimpl(14), 5, null), Dp.m3775constructorimpl(27), 0.0f, 2, null), p193o00o0O0O.o0000oo.OooO0OO(composerStartRestartGroup).f38612OooO, TextUnitKt.getSp(12), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 3072, 0, 131056);
            o00O00OO.OooO0O0(composer2);
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
