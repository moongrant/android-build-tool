...
public final class CloudFileRepo$loadToken$$inlined$call$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Response<UploadTokenModel>>, Object> {
    ...
    public int f24320OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ CloudFileType f24321OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ oO0oO000 f24322OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final /* synthetic */ Long f24323OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final /* synthetic */ Boolean f24324OooO0oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CloudFileRepo$loadToken$$inlined$call$1(oO0oO000 oo0oo000, Continuation continuation, CloudFileType cloudFileType, Long l, Boolean bool) {
        super(2, continuation);
        this.f24322OooO0o0 = oo0oo000;
        this.f24321OooO0o = cloudFileType;
        this.f24323OooO0oO = l;
        this.f24324OooO0oo = bool;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new CloudFileRepo$loadToken$$inlined$call$1(this.f24322OooO0o0, continuation, this.f24321OooO0o, this.f24323OooO0oO, this.f24324OooO0oo);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
        ...
        int i = this.f24320OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            final oO0oO000 oo0oo000 = this.f24322OooO0o0;
            this.f24320OooO0Oo = 1;
            ...
            OooO0OO.OooO0O0 callback = new OooO0OO.OooO0O0() { // from class: com.yalla.yalla.repository.CloudFileRepo$loadToken$$inlined$call$1.1
                ...
                public final void OooO0O0(@Nullable String str2, @Nullable String str3) {
                    ...
                    cancellableContinuationImpl.resumeWith(o0000O0O.OooO00o(oo0oo000, str2, str3));
                }

                @Override // com.yalla.yalla.http.iteratehttp.OooO0OO.OooO0O0, com.yalla.yalla.http.iteratehttp.OooO0OO.OooO00o
                public final void OooO0o0(@Nullable String str2) {
                    boolean z = str2 == null || StringsKt.isBlank(str2);
                    oO0oO000 oo0oo001 = oo0oo000;
                    CancellableContinuation cancellableContinuation = cancellableContinuationImpl;
                    if (z) {
                        Result.Companion companion = Result.INSTANCE;
                        o00OOOOo.OooO0O0(oo0oo001, "-1", "", cancellableContinuation);
                    } else {
                        ...
                        o0000O0.OooO0O0(oo0oo001, (Response) o000O00.OooO00o(type, str2, type), cancellableContinuation);
                    }
                }
            };
            CloudFileType type = this.f24321OooO0o;
            ...
            Long l = this.f24323OooO0oO;
            if (l != null) {
                linkedHashMapOooO00o.put("sourceId", String.valueOf(l.longValue()));
            }
            switch (oOo00o00.$EnumSwitchMapping$0[type.ordinal()]) {
                case 1:
                    list = o000oOoO.f43359OooOoo;
                ...
                case 15:
                case 16:
                    list = o000oOoO.f43408o0000O0O;
                    oO listener = new oO(linkedHashMapOooO00o);
                    Intrinsics.checkNotNullParameter(listener, "listener");
                    if (Intrinsics.areEqual(this.f24324OooO0oo, Boolean.TRUE)) {
                        listener.invoke();
                    }
