    ...
    public final void OooO0O0(int i, @Nullable Object obj) {
        ...
        switch (i) {
            case 1000800:
                ...
                if (from != null) {
                    p597o0oo00O.OooOOOO.OooO0OO("RoomEventMsgProcessor", "what = " + i + "  data = " + from);
                    BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), null, null, new o0OoOo0(from, null), 3, null);
                }
                break;
            case 1000801:
                Room.EventInfoNotify from2 = Room.EventInfoNotify.parseFrom((byte[]) obj);
                if (from2 != null) {
                    p597o0oo00O.OooOOOO.OooO0OO("RoomEventMsgProcessor", "what = " + i + "  data = " + from2);
                    long id = from2.getId();
                    ...
                    if (!(o00o0oo0OooOo0o.OooO0O0(3, ((Number) com.yalla.yalla.common.manager.OooO00o.OooO00o()).longValue(), String.valueOf(id2)) != null)) {
                        ...
                        if (fState == companion.getNotStarted()) {
                            LinkedHashSet<Long> linkedHashSet = o0O0O00.f56646OooO00o;
                            ...
                            LinkedHashSet<Long> linkedHashSet2 = o0O0O00.f56647OooO0O0;
