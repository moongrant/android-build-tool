...
import p435o0OoOOO0.o0000O00;
import p474o0OoooOO.oo0oO0;
import p492o0o00O0O.o000O0O0;
import p492o0o00O0O.o000OOo0;
import p515o0o0O00.o0oOOo;
import p519o0o0O0O.o0O00o0;
...
public final class OooO0OO {
    ...
    @NotNull
    public static final MutableState<Float> f24986OooO00o = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Float.valueOf(0.0f), null, 2, null);
    ...
    public static final class OooO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            OooO0OO.OooO0O0(composer, RecomposeScopeImplKt.updateChangedFlags(this.f24987OooO0Oo | 1));
    ...
    public static final class OooO00o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ int f24988OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(int i) {
            super(2);
            this.f24988OooO0Oo = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            OooO0OO.OooO00o(composer, RecomposeScopeImplKt.updateChangedFlags(this.f24988OooO0Oo | 1));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0O0 extends Lambda implements Function1<LayoutCoordinates, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ float f24989OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(float f) {
            super(1);
            this.f24989OooO0Oo = f;
        }
        ...
        public final Unit invoke(LayoutCoordinates layoutCoordinates) {
            ...
            OooO0OO.f24986OooO00o.setValue(Float.valueOf(IntSize.m3934getHeightimpl(it.mo2811getSizeYbymL2g()) - this.f24989OooO0Oo));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class C0321OooO0OO extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ AppCompatActivity f24990OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C0321OooO0OO(AppCompatActivity appCompatActivity) {
            super(0);
            this.f24990OooO0Oo = appCompatActivity;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            if (!oo0o0Oo.OooO0o0()) {
                int i = p422o0OoO0.OooO0OO.f46611OooO00o;
                AppCompatActivity context = this.f24990OooO0Oo;
    ...
    public static final class OooO0o extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO0o f24991OooO0Oo = new OooO0o();
        ...
        public final Unit invoke() {
            h0.OooO0O0("101047");
            com.yalla.yalla.ui.activity.main.OooO0o onLogin = com.yalla.yalla.ui.activity.main.OooO0o.f24993OooO0Oo;
    ...
    public static final class OooOO0 implements Observer, FunctionAdapter {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function1 f24992OooO0Oo;

        public OooOO0(o000O0O0 function) {
            Intrinsics.checkNotNullParameter(function, "function");
            this.f24992OooO0Oo = function;
        }
        ...
        public final boolean equals(@Nullable Object obj) {
            ...
            return Intrinsics.areEqual(this.f24992OooO0Oo, ((FunctionAdapter) obj).getFunctionDelegate());
        }

        @Override // kotlin.jvm.internal.FunctionAdapter
        @NotNull
        public final Function<?> getFunctionDelegate() {
            return this.f24992OooO0Oo;
        }

        public final int hashCode() {
            return this.f24992OooO0Oo.hashCode();
        }

        @Override // androidx.lifecycle.Observer
        public final /* synthetic */ void onChanged(Object obj) {
            this.f24992OooO0Oo.invoke(obj);
        }
    }
    ...
    public static final void OooO00o(@Nullable Composer composer, int i) {
        ...
        if (i == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            float fM3775constructorimpl = Dp.m3775constructorimpl(((Density) composerStartRestartGroup.consume(CompositionLocalsKt.getLocalDensity())).mo322toDpu2uoSUM(f24986OooO00o.getValue().floatValue()) + Dp.m3775constructorimpl(48));
            ...
            AppUIThemeConfig appUIThemeConfigOooO00o = p431o0OoOO.OooOo00.OooO00o((Integer) LiveDataAdapterKt.observeAsState(mutableLiveData, composerStartRestartGroup, 8).getValue());
            ...
            int i5 = iArr[p431o0OoOO.OooOo00.OooO00o((Integer) LiveDataAdapterKt.observeAsState(mutableLiveData, composerStartRestartGroup, 8).getValue()).ordinal()];
            if (i5 == 1) {
                i2 = p565o0oOo000.oo0o0Oo.ic_main_header_bg_top;
            } else if (i5 == 2) {
                i2 = p565o0oOo000.oo0o0Oo.ic_main_header_bg_top_ramadan;
            } else {
                if (i5 != 3) {
                    throw new NoWhenBranchMatchedException();
                }
                i2 = p565o0oOo000.oo0o0Oo.ic_main_header_bg_top_seven_year;
            }
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            ...
            int i6 = iArr[p431o0OoOO.OooOo00.OooO00o((Integer) LiveDataAdapterKt.observeAsState(mutableLiveData, composerStartRestartGroup, i3).getValue()).ordinal()];
            if (i6 == 1) {
                numValueOf = null;
            } else if (i6 == 2) {
                numValueOf = Integer.valueOf(p565o0oOo000.oo0o0Oo.ic_main_header_bg_top_content_ramadan);
            } else {
                if (i6 != 3) {
                    throw new NoWhenBranchMatchedException();
                }
                numValueOf = Integer.valueOf(p565o0oOo000.oo0o0Oo.ic_main_header_bg_top_content_seven_year);
            }
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
    ...
    public static final void OooO0O0(Composer composer, int i) {
        ...
        if (i == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
            oo0oO0 oo0oo0 = oo0oO0.f47967OooO00o;
            ImageKt.Image(o0000O0O.OooO0O0((String) LiveDataAdapterKt.observeAsState(oo0oO0.OooO(), composerStartRestartGroup, 8).getValue(), null, composerStartRestartGroup, 0, 1), (String) null, o0O0O00.OooO0O0(boxScopeInstance.align(ClipKt.clip(SizeKt.m525size3ABfNKs(companion, Dp.m3775constructorimpl(f2)), RoundedCornerShapeKt.getCircleShape()), companion2.getCenter()), false, false, 0L, false, null, null, new C0321OooO0OO(appCompatActivity), OooO0o.f24991OooO0Oo, 189), (Alignment) null, ContentScale.INSTANCE.getCrop(), 0.0f, (ColorFilter) null, composerStartRestartGroup, 24624, 104);
            ...
            o0oOOo o0oooo = o0oOOo.f51633OooO00o;
    ...
    public static final void OooO0OO(o00000OO o00000oo2, Composer composer, int i) {
        ...
        o0000O00.OooO00o(boxScopeInstance, o00000oo2 != null ? o00000oo2.f46859OooO0o : null, composerStartRestartGroup, 70);
        o0O00o0.OooO00o(boxScopeInstance, composerStartRestartGroup, 6);
        composerStartRestartGroup.endReplaceableGroup();
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new o000OOo0(o00000oo2, i));
    }
}
