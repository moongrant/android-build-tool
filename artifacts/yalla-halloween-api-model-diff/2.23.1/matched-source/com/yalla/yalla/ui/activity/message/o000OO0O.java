...
public final class o000OO0O extends Lambda implements Function1<Pair<? extends Integer, ? extends ChatMessage>, Unit> {
    ...
    public final /* synthetic */ PrivateChatActivity f25370OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o000OO0O(PrivateChatActivity privateChatActivity) {
        super(1);
        this.f25370OooO0Oo = privateChatActivity;
    }
    ...
    public final Unit invoke(Pair<? extends Integer, ? extends ChatMessage> pair) {
        ...
        PrivateChatActivity privateChatActivity = this.f25370OooO0Oo;
        privateChatActivity.f25251OooOoOO = false;
        if (pair2 != null && (s5Var = privateChatActivity.f25249OooOoO) != null) {
            Intrinsics.checkNotNull(s5Var);
            if (s5Var.OooO0OO() && pair2.getSecond().getGiveRoomThemeInfo() != null) {
                ...
                s5Var2.OooOO0o(giveRoomThemeInfo.getThemeBgImgUrl(), iIntValue, giveRoomThemeInfo.getThemeVideoUrl(), isAcceptMsg);
            }
        }
