...
public final class OooO00o extends Lambda implements Function3<RoomUserInfoModel, Integer, RoomMemberManagerTag, Unit> {
    ...
    public final /* synthetic */ o000O000 f28434OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ RoomInfoMemberListFragment f28435OooO0o0;
    ...
    public OooO00o(o000O000 o000o001, RoomInfoMemberListFragment roomInfoMemberListFragment) {
        super(3);
        this.f28434OooO0Oo = o000o001;
        this.f28435OooO0o0 = roomInfoMemberListFragment;
    }
    ...
    public final Unit invoke(RoomUserInfoModel roomUserInfoModel, Integer num, RoomMemberManagerTag roomMemberManagerTag) {
        ...
        RoomInfoMemberListFragment roomInfoMemberListFragment = this.f28435OooO0o0;
        if (i == 1) {
            model.isSetting().setValue(Boolean.valueOf(!model.isSetting().getValue().booleanValue()));
            this.f28434OooO0Oo.notifyItemChanged(iIntValue);
            roomInfoMemberListFragment.getBinding().f44383OooO0OO.smoothScrollToPosition(iIntValue);
        } else if (i == 2) {
            ...
            EditText view = roomInfoMemberListFragment.getBinding().f44382OooO0O0.f44542OooO0OO;
