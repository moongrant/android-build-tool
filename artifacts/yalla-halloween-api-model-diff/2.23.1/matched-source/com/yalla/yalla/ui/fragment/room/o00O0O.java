...
public final class o00O0O extends Lambda implements Function1<ApiResult<String>, Unit> {
    ...
    public final /* synthetic */ RoomThemeMineFragment f28605OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00O0O(RoomThemeMineFragment roomThemeMineFragment) {
        super(1);
        this.f28605OooO0Oo = roomThemeMineFragment;
    }
    ...
    public final Unit invoke(ApiResult<String> apiResult) {
        ...
        RoomThemeMineActivity activity = this.f28605OooO0Oo.getActivity();
        if (activity != null) {
            activity.OooOo0();
        }
