...
public final class o00Oo0 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ RoomThemeMineFragment f28606OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ ThemeModel f28607OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00Oo0(RoomThemeMineFragment roomThemeMineFragment, ThemeModel themeModel) {
        super(0);
        this.f28606OooO0Oo = roomThemeMineFragment;
        this.f28607OooO0o0 = themeModel;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        RoomThemeMineFragment roomThemeMineFragment = this.f28606OooO0Oo;
        long j = roomThemeMineFragment.currentThemeId;
        ThemeModel themeModel = this.f28607OooO0o0;
        if (j != themeModel.getShopId()) {
            ...
            roomThemeMineFragment.getStoreVm().setRoomTheme(themeModel.getShopId(), com.code.android.util.o0OoOo0.OooO(0L, str)).observe(roomThemeMineFragment, new p386o0OOoo0O.o0OoOo0(new o0OoOo0(roomThemeMineFragment), null, new o00O0O(roomThemeMineFragment), false, 10));
        }
