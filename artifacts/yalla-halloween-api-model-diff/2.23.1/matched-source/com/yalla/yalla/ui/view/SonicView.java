...
public final class SonicView extends View {
    ...
    public float f30142OooO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public final Paint f30143OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public float f30144OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public int f30145OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final float f30146OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final float f30147OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public final Animation f30148OooOO0;
    ...
    public static final class OooO0OO extends Lambda implements Function0<ValueAnimator> {
        ...
        public final ValueAnimator invoke() {
            ...
            valueAnimator.setFloatValues(0.0f, sonicView.f30146OooO0oO);
            valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: o0o0Ooo0.oOo000Oo
                ...
                public final void onAnimationUpdate(ValueAnimator it) {
                    ...
                    this$0.f30144OooO0o = ((Float) animatedValue).floatValue();
    ...
    public SonicView(@NotNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.f30143OooO0Oo = paint;
        int i = o0ooOOo.color_white;
        this.f30145OooO0o0 = o0000.OooO00o(i);
        this.f30146OooO0oO = 100.0f;
        this.f30147OooO0oo = o0000O0.OooO00o((float) 24.8d);
        this.f30142OooO = Float.MIN_VALUE;
        this.f30148OooOO0 = AnimationUtils.loadAnimation(context, o00Ooo.room_mic_view);
    ...
    public final void onDraw(@NotNull Canvas canvas) {
        ...
        super.onDraw(canvas);
        if (this.f30151OooOOO) {
            canvas.drawColor(0);
            return;
        }
        canvas.setDrawFilter(new PaintFlagsDrawFilter(0, 3));
        Paint paint = this.f30143OooO0Oo;
        paint.setColor(this.f30145OooO0o0);
        float width = getWidth() / 2.0f;
        float height = getHeight() / 2.0f;
        float f = 1;
        float fOooO00o = o0000O0.OooO00o(f);
        float f2 = this.f30147OooO0oo;
        canvas.drawCircle(width, height, fOooO00o + f2, paint);
        float width2 = ((getWidth() / 2.0f) - f2) / 2.0f;
        this.f30142OooO = width2;
        float fOooO00o2 = OooOo.OooO0o.OooO00o((getWidth() / 2.0f) + (width2 * 3), f2, this.f30144OooO0o / this.f30146OooO0oO, f2);
        float width3 = f - ((fOooO00o2 - f2) / ((getWidth() / 2.0f) - f2));
        for (int i = 0; i < 4; i++) {
            float f3 = 255;
            paint.setColor((Math.min(255, Math.max(0, (int) (width3 * f3))) << 24) + (this.f30145OooO0o0 & 16777215));
            if (fOooO00o2 <= ((float) getWidth()) / 2.0f && f2 <= fOooO00o2) {
                canvas.drawCircle(getWidth() / 2.0f, getHeight() / 2.0f, fOooO00o2, paint);
            }
            fOooO00o2 -= this.f30142OooO;
            width3 = f - ((fOooO00o2 - f2) / ((getWidth() / 2.0f) - f2));
            paint.setColor((Math.min(255, Math.max(0, (int) (f3 * width3))) << 24) + (this.f30145OooO0o0 & 16777215));
        }
    }
    ...
    public final void setSonicType(@NotNull SonicType value) {
        ...
        if (i2 == 1) {
            this.f30145OooO0o0 = o0000.OooO00o(o0ooOOo.color_white);
            setBackgroundResource(0);
        } else if (i2 == 2) {
            this.f30145OooO0o0 = o0000.OooO00o(o0ooOOo.color_white);
            setBackground(o0000.OooO0O0(o0OOO0o.room_mic_view));
        } else if (i2 == 3) {
            this.f30145OooO0o0 = o0000.OooO00o(o0ooOOo.color_FF006E);
            setBackgroundResource(0);
        }
