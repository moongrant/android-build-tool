...
public final class MomentDetailLikeHeaderView extends ConstraintLayout {
    ...
    @NotNull
    public final o0OOooO0 f30586OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public int f30587OooO0o;
    ...
    public final void setCount(long count) {
        this.f30586OooO0Oo.f44650OooO0O0.setText(o0000O.OooO00o(o00O0OO.OooO0O0(o000OOo.XXX_likes, this), OooOo00.OooO0o(count, false)));
    }

    public final void setData(int selectType) {
        this.f30587OooO0o = selectType;
        o0OOooO0 o0ooooo0 = this.f30586OooO0Oo;
        TextView textView = o0ooooo0.f44652OooO0Oo;
        int i = o0ooOOo.color_333333_65;
        textView.setTextColor(o0000.OooO00o(i));
        int i2 = o0OOO0o.bg_tr00_r360;
        o0ooooo0.f44652OooO0Oo.setBackgroundResource(i2);
        int iOooO00o = o0000.OooO00o(i);
        TextView textView2 = o0ooooo0.f44651OooO0OO;
        textView2.setTextColor(iOooO00o);
        textView2.setBackgroundResource(i2);
        int i3 = this.f30587OooO0o;
        if (i3 == -1) {
            LinearLayoutCompat switchLayout = o0ooooo0.f44653OooO0o0;
            Intrinsics.checkNotNullExpressionValue(switchLayout, "switchLayout");
            o000O.OooO0O0(switchLayout);
        } else {
            if (i3 == 0) {
                LinearLayoutCompat switchLayout2 = o0ooooo0.f44653OooO0o0;
                Intrinsics.checkNotNullExpressionValue(switchLayout2, "switchLayout");
                o000O.OooOOOO(switchLayout2);
                o0ooooo0.f44651OooO0OO.setTextColor(o0000.OooO00o(o0ooOOo.color_333333));
                o0ooooo0.f44651OooO0OO.setBackgroundResource(o0OOO0o.bg_ffffffff_r360);
                return;
            }
            if (i3 != 1) {
                return;
            }
            LinearLayoutCompat switchLayout3 = o0ooooo0.f44653OooO0o0;
            Intrinsics.checkNotNullExpressionValue(switchLayout3, "switchLayout");
            o000O.OooOOOO(switchLayout3);
            o0ooooo0.f44652OooO0Oo.setTextColor(o0000.OooO00o(o0ooOOo.color_333333));
            o0ooooo0.f44652OooO0Oo.setBackgroundResource(o0OOO0o.bg_ffffffff_r360);
        }
    }
    ...
    public MomentDetailLikeHeaderView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.f30586OooO0Oo = o0ooooo0Inflate;
        LinearLayoutCompat switchLayout = o0ooooo0Inflate.f44653OooO0o0;
        Intrinsics.checkNotNullExpressionValue(switchLayout, "switchLayout");
        o000O.OooO0O0(switchLayout);
        setCount(0L);
        this.f30587OooO0o = -1;
