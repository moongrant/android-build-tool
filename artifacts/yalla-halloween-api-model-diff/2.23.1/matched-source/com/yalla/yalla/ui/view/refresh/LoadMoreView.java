...
public final class LoadMoreView extends FrameLayout implements OooO0o {
    ...
    @NotNull
    public final TextView f30731OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final ImageView f30732OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public boolean f30733OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    @NotNull
    public final o00 f30734OooO0oO;
    ...
    public final void OooO00o(@NotNull OooOOO0 refreshLayout, @NotNull RefreshState oldState, @NotNull RefreshState newState) {
        ...
        o00 o00Var = this.f30734OooO0oO;
        ImageView imageView = null;
        ImageView imageView2 = this.f30732OooO0o;
        TextView textView = this.f30731OooO0Oo;
        if (i != 1) {
            if (i != 2) {
                return;
            }
            o00Var.f38643OooO0o = o00Var.f38642OooO0Oo;
            if (this.f30733OooO0o0) {
                if (imageView2 == null) {
    ...
    public final void setNoMoreText(@NotNull String noMoreText) {
        ...
        this.f30731OooO0Oo.setText(noMoreText);
    }
    ...
    public LoadMoreView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        View.inflate(context, o0OO00O.view_load_more, this);
        View viewFindViewById = findViewById(o0Oo0oo.tvLoadMore);
        Intrinsics.checkNotNullExpressionValue(viewFindViewById, "findViewById(...)");
        TextView textView = (TextView) viewFindViewById;
        this.f30731OooO0Oo = textView;
        textView.setVisibility(8);
        View viewFindViewById2 = findViewById(o0Oo0oo.ivLoadMore);
        Intrinsics.checkNotNullExpressionValue(viewFindViewById2, "findViewById(...)");
        ImageView imageView2 = (ImageView) viewFindViewById2;
        this.f30732OooO0o = imageView2;
        if (imageView2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("ivLoadMore");
            imageView = null;
        } else {
        ...
        this.f30734OooO0oO = new o00(imageView2, oo000o.anim_loading_horse_green, 100L);
    }
}
