...
public final class ShareLogViewModel extends OooOO0 {
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public int f30970OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ ShareLogType f30971OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ String f30972OooO0o0;
        ...
        public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ ApiResult<String> f30973OooO0Oo;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public OooO00o(ApiResult<String> apiResult, Continuation<? super OooO00o> continuation) {
                super(2, continuation);
                this.f30973OooO0Oo = apiResult;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                return new OooO00o(this.f30973OooO0Oo, continuation);
            }
        ...
        public OooO0O0(String str, ShareLogType shareLogType, Continuation<? super OooO0O0> continuation) {
            super(2, continuation);
            this.f30972OooO0o0 = str;
            this.f30971OooO0o = shareLogType;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0O0(this.f30972OooO0o0, this.f30971OooO0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            o0oooooOooO00o.OooO0O0(this.f30972OooO0o0, "eventId");
            o0oooooOooO00o.OooO0O0(o0OoOo0.OooOO0o(Boxing.boxInt(this.f30971OooO0o.getValue()), ""), "shareType");
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f30974OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ ShareLogType f30975OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ String f30976OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(String str, ShareLogType shareLogType, Continuation<? super OooO0OO> continuation) {
            super(2, continuation);
            this.f30976OooO0o0 = str;
            this.f30975OooO0o = shareLogType;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0OO(this.f30976OooO0o0, this.f30975OooO0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f30974OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                this.f30974OooO0Oo = 1;
                ...
                o0oooooOooO00o.OooO0O0(this.f30976OooO0o0, "barid");
                o0oooooOooO00o.OooO0O0(o0OoOo0.OooOO0o(Boxing.boxInt(this.f30975OooO0o.getValue()), ""), "type");
