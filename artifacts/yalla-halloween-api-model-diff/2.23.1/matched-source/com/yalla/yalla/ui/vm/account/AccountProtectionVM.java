...
import p585o0oOoo00.o000OOo;

/* JADX INFO: loaded from: classes4.dex */
@StabilityInferred(parameters = 0)
@Metadata(d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010!\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0007\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\r\u0010\u000eJ\u0006\u0010\u0003\u001a\u00020\u0002J\u0018\u0010\b\u001a\u0014\u0012\u0010\u0012\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00070\u00060\u00050\u0004J\u001a\u0010\f\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u000b0\u00050\u00042\u0006\u0010\n\u001a\u00020\t¨\u0006\u000f"}, d2 = {"Lcom/yalla/yalla/ui/vm/account/AccountProtectionVM;", "Lo0Oo0/OooOO0;", "", "syncAccountProtection", "Landroidx/lifecycle/LiveData;", "Lcom/yalla/yalla/model/http/ApiResult;", "", "Lcom/yalla/yalla/model/TrustedDevice;", "getTrustDeviceList", "", "isOpenProtected", "", "switchUserDevice", "<init>", "()V", "Common_YallaRelease"}, k = 1, mv = {1, 9, 0})
public final class AccountProtectionVM extends OooOO0 {
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<LiveDataScope<ApiResult<List<TrustedDevice>>>, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f31026OooO0Oo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f31027OooO0o0;
            ...
            this.f31027OooO0o0 = liveDataScope;
            this.f31026OooO0Oo = 1;
            accountRepo.getClass();
            String str = OooOOO0.f43293OooO0o0;
            obj = OooOOO.OooO0Oo(new AccountRepo$getTrustDeviceList$$inlined$call$1(com.common.support.apm.netdetector.OooO00o.OooO00o(str, "url", str, 0), null), this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f31027OooO0o0 = null;
            this.f31026OooO0Oo = 2;
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<LiveDataScope<ApiResult<String>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31028OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f31029OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f31030OooO0o0;
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0O0 oooO0O0 = new OooO0O0(this.f31029OooO0o, continuation);
            oooO0O0.f31030OooO0o0 = obj;
            return oooO0O0;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            LiveDataScope liveDataScope;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31028OooO0Oo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f31030OooO0o0;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            liveDataScope = (LiveDataScope) this.f31030OooO0o0;
            AccountRepo accountRepo = AccountRepo.f22392OooO00o;
            this.f31030OooO0o0 = liveDataScope;
            this.f31028OooO0Oo = 1;
            accountRepo.getClass();
            String str = OooOOO0.f43292OooO0o;
            o0ooOOo o0oooooOooO00o = com.common.support.apm.netdetector.OooO00o.OooO00o(str, "url", str, 1);
            o0oooooOooO00o.OooO0O0(Boxing.boxInt(this.f31029OooO0o), "isOpenProtected");
            obj = OooOOO.OooO0Oo(new AccountRepo$switchUserDevice$$inlined$call$1(o0oooooOooO00o, null), this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f31030OooO0o0 = null;
            this.f31028OooO0Oo = 2;
            if (liveDataScope.emit(obj, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
    ...
    public final void syncAccountProtection() {
        MutableLiveData<Boolean> mutableLiveData = o000000.f56591OooO00o;
        CoroutineScope coroutineScope = ViewModelKt.getViewModelScope(this);
        Intrinsics.checkNotNullParameter(coroutineScope, "coroutineScope");
        oo0oOO0.OooO0O0(coroutineScope, new o000OOo(null));
    }
}
