...
public final class RoomThemeVM extends OooOO0 {
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<Integer, Continuation<? super o000Oo0<CustomizeThemeModel>>, Object> {
        ...
        public /* synthetic */ int f32164OooO0o0;
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            ...
            oooO00o.f32164OooO0o0 = ((Number) obj).intValue();
            return oooO00o;
        }
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<Integer, Continuation<? super o000Oo0<ThemeModel>>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f32165OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ int f32167OooO0o0;
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            ...
            oooO0O0.f32167OooO0o0 = ((Number) obj).intValue();
            return oooO0O0;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f32165OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                int i2 = this.f32167OooO0o0;
                Integer value = com.yalla.yalla.service.room.OooO0O0.f24541OoooOOO.OooO00o().f24549OooO0o0.getValue();
                if (value == null) {
                    return new o000Oo0(new ArrayList());
                }
                ...
                o00OOOOo o00ooooo2 = o00OOOOo.f46210OooO00o;
                this.f32165OooO0Oo = 1;
                obj = o00ooooo2.OooO0o(iIntValue, 2, this);
                if (obj == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<LiveDataScope<ApiResult<RenewCustomizeTheme>>, Continuation<? super Unit>, Object> {
        ...
        public final /* synthetic */ long f32169OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f32170OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f32171OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(long j, int i, Continuation<? super OooO0OO> continuation) {
            super(2, continuation);
            this.f32169OooO0o = j;
            this.f32171OooO0oO = i;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0OO oooO0OO = new OooO0OO(this.f32169OooO0o, this.f32171OooO0oO, continuation);
            oooO0OO.f32170OooO0o0 = obj;
            return oooO0OO;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f32168OooO0Oo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f32170OooO0o0;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            liveDataScope = (LiveDataScope) this.f32170OooO0o0;
            o00OOOOo o00ooooo2 = o00OOOOo.f46210OooO00o;
            long j = this.f32169OooO0o;
            int i2 = this.f32171OooO0oO;
            this.f32170OooO0o0 = liveDataScope;
            this.f32168OooO0Oo = 1;
            obj = o00ooooo2.OooOO0O(j, i2, 0, this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f32170OooO0o0 = null;
            this.f32168OooO0Oo = 2;
    ...
    public static final class OooO0o extends SuspendLambda implements Function2<o00OO00O<ApiResult<String>>, Continuation<? super Unit>, Object> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f32172OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ long f32173OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f32174OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ RoomThemeVM f32175OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ boolean f32176OooO0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(long j, RoomThemeVM roomThemeVM, boolean z, Continuation<? super OooO0o> continuation) {
            super(2, continuation);
            this.f32173OooO0o = j;
            this.f32175OooO0oO = roomThemeVM;
            this.f32176OooO0oo = z;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0o oooO0o = new OooO0o(this.f32173OooO0o, this.f32175OooO0oO, this.f32176OooO0oo, continuation);
            oooO0o.f32174OooO0o0 = obj;
            return oooO0o;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(o00OO00O<ApiResult<String>> o00oo00o, Continuation<? super Unit> continuation) {
            return ((OooO0o) create(o00oo00o, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            o00OO00O o00oo00o;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f32172OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                o00OO00O o00oo00o2 = (o00OO00O) this.f32174OooO0o0;
                ...
                o00OOOOo o00ooooo2 = o00OOOOo.f46210OooO00o;
                long j = this.f32173OooO0o;
                this.f32174OooO0o0 = o00oo00o2;
                this.f32172OooO0Oo = 1;
                Object objOooOO0o = o00ooooo2.OooOO0o(j, jOooO, this);
                ...
                o00oo00o = (o00OO00O) this.f32174OooO0o0;
                ResultKt.throwOnFailure(obj);
            }
            ApiResult apiResult = (ApiResult) obj;
            if (apiResult.isSuccess()) {
                RoomThemeVM roomThemeVM = this.f32175OooO0oO;
                MutableState<Long> currentThemeShopId = roomThemeVM.getCurrentThemeShopId();
                long j2 = this.f32173OooO0o;
                currentThemeShopId.setValue(Boxing.boxLong(j2));
                Iterator<T> it = roomThemeVM.getMineRoomTheme().f38492OooO0Oo.iterator();
                while (true) {
                    if (!it.hasNext()) {
                        break;
                    }
                ...
                for (CustomizeThemeModel customizeThemeModel : roomThemeVM.getCustomizeRoomTheme().f38492OooO0Oo) {
                ...
                String strOooO0OO = o0000.OooO0OO(o000OOo.item_in_use_now);
    ...
    public RoomThemeVM() {
        ...
        this.pageList = CollectionsKt.listOf((Object[]) new String[]{o0000.OooO0OO(o000OOo.Mine), o0000.OooO0OO(o000OOo.room_theme_customize)});
    ...
    public final List<ThemeModel> addDefaultTheme(List<ThemeModel> list) {
        if (list != null) {
            ...
            ThemeModel defaultDrawable = new ThemeModel().setDefaultDrawable(true, o0000.OooO0OO(o000OOo.Yalla_1));
            if (!z) {
    ...
    @NotNull
    public final o00OO00O<ApiResult<String>> setRoomTheme(long id, boolean isRefresh) {
        return oo0oOO0.OooO00o(this, new OooO0o(id, this, isRefresh, null));
    }
