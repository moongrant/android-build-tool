...
public final class OooO0O0 extends Lambda implements Function2<Bitmap, EvaSrc.FitType, Unit> {
    ...
    public final /* synthetic */ EvaSrc f32429OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ com.yy.yyeva.mix.OooO00o f32430OooO0o0;
    ...
    public OooO0O0(EvaSrc evaSrc, com.yy.yyeva.mix.OooO00o oooO00o) {
        super(2);
        this.f32429OooO0Oo = evaSrc;
        this.f32430OooO0o0 = oooO00o;
    }
    ...
    public final Unit invoke(Bitmap bitmap, EvaSrc.FitType fitType) {
        ...
        EvaSrc evaSrc = this.f32429OooO0Oo;
        if (bitmap2 == null) {
            String msg = "fetch image " + this.f32429OooO0Oo.f32409OooO00o + " bitmap return null";
        ...
        evaSrc.f32416OooO0oo = bitmapCopy;
        int i = fitType2 == null ? -1 : OooO00o.$EnumSwitchMapping$0[fitType2.ordinal()];
        if (i == -1) {
            str = this.f32429OooO0Oo.f32415OooO0oO;
        } else if (i != 1) {
        ...
        int i2 = this.f32430OooO0o0.f32421OooO00o.f57042OooO0O0;
        EvaSrc evaSrc2 = this.f32429OooO0Oo;
        evaJniUtil.setSrcBitmap(i2, evaSrc2.f32409OooO00o, evaSrc2.f32416OooO0oo, str);
        StringBuilder sb = new StringBuilder("fetch image ");
        sb.append(this.f32429OooO0Oo.f32409OooO00o);
        sb.append(" finish bitmap is ");
        Bitmap bitmap3 = this.f32429OooO0Oo.f32416OooO0oo;
        sb.append(bitmap3 != null ? Integer.valueOf(bitmap3.hashCode()) : null);
        String msg2 = sb.toString();
        Intrinsics.checkNotNullParameter("EvaAnimPlayer.MixAnimPlugin", ViewHierarchyConstants.TAG_KEY);
        Intrinsics.checkNotNullParameter(msg2, "msg");
        Bitmap bitmap4 = this.f32429OooO0Oo.f32416OooO0oo;
        if (bitmap4 != null) {
            bitmap4.recycle();
        }
        com.yy.yyeva.mix.OooO00o oooO00o = this.f32430OooO0o0;
        synchronized (oooO00o.f32425OooO0o) {
            oooO00o.f32424OooO0Oo++;
            oooO00o.f32425OooO0o.notifyAll();
        }
