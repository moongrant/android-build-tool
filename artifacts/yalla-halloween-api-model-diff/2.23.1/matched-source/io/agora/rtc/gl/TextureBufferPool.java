...
public class TextureBufferPool {
    ...
    public VideoFrame.TextureBuffer doTextureCopy(int i, VideoFrame.TextureBuffer.Type type, int i2, int i3, Matrix matrix, final Runnable runnable) {
        ...
        GLES20.glFlush();
        ATrace.endSection();
        TextureBufferImpl textureBufferImpl = new TextureBufferImpl(this.eglContext, i2, i3, VideoFrame.TextureBuffer.Type.RGB, textureInfoAcquireTextureFramebuffer.textureId, matrix, this.handler, this.yuvConverter, new Runnable() { // from class: io.agora.rtc.gl.TextureBufferPool.4
