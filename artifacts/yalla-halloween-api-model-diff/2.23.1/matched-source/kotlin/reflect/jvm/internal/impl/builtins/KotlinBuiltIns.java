...
public abstract class KotlinBuiltIns {
    ...
    public KotlinBuiltIns(@NotNull StorageManager storageManager) {
        ...
        this.builtInClassesByName = storageManager.createMemoizedFunction(new Function1<Name, ClassDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.3
            ...
            public ClassDescriptor invoke(Name name) {
                ClassifierDescriptor classifierDescriptorMo5494getContributedClassifier = KotlinBuiltIns.this.getBuiltInsPackageScope().mo5494getContributedClassifier(name, NoLookupLocation.FROM_BUILTINS);
                ...
                throw new AssertionError("Must be a class descriptor " + name + ", but was " + classifierDescriptorMo5494getContributedClassifier);
            }
        });
    }
    ...
    private static KotlinType getElementTypeForUnsignedArray(@NotNull KotlinType kotlinType, @NotNull ModuleDescriptor moduleDescriptor) {
        ...
        if (!unsignedTypes.isShortNameOfUnsignedArray(classifierDescriptorMo5492getDeclarationDescriptor.getName()) || (classId = DescriptorUtilsKt.getClassId(classifierDescriptorMo5492getDeclarationDescriptor)) == null || (unsignedClassIdByArrayClassId = unsignedTypes.getUnsignedClassIdByArrayClassId(classId)) == null || (classDescriptorFindClassAcrossModuleDependencies = FindClassInModuleKt.findClassAcrossModuleDependencies(moduleDescriptor, unsignedClassIdByArrayClassId)) == null) {
            return null;
        }
    ...
    public static PrimitiveType getPrimitiveArrayElementType(@NotNull KotlinType kotlinType) {
        ...
        return getPrimitiveArrayType(classifierDescriptorMo5492getDeclarationDescriptor);
    }
    ...
    public static boolean isPrimitiveArray(@NotNull KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo5492getDeclarationDescriptor = kotlinType.getConstructor().mo5492getDeclarationDescriptor();
        return (classifierDescriptorMo5492getDeclarationDescriptor == null || getPrimitiveArrayType(classifierDescriptorMo5492getDeclarationDescriptor) == null) ? false : true;
    }
    ...
    public static boolean isPrimitiveTypeOrNullablePrimitiveType(@NotNull KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo5492getDeclarationDescriptor = kotlinType.getConstructor().mo5492getDeclarationDescriptor();
        return (classifierDescriptorMo5492getDeclarationDescriptor instanceof ClassDescriptor) && isPrimitiveClass((ClassDescriptor) classifierDescriptorMo5492getDeclarationDescriptor);
    }
    ...
    public static boolean isTypeConstructorForGivenClass(@NotNull TypeConstructor typeConstructor, @NotNull FqNameUnsafe fqNameUnsafe) {
        ...
        return (classifierDescriptorMo5492getDeclarationDescriptor instanceof ClassDescriptor) && classFqNameEquals(classifierDescriptorMo5492getDeclarationDescriptor, fqNameUnsafe);
    }
