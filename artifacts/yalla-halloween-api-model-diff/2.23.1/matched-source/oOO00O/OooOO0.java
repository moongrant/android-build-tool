...
public final class OooOO0 extends FrameLayout {
    ...
    public static final /* synthetic */ int f60088OooO0o = 0;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NonNull
    public final ViewGroup f60089OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public boolean f60090OooO0o0;

    public OooOO0(ViewGroup viewGroup) {
        super(viewGroup.getContext());
        setClipChildren(false);
        this.f60089OooO0Oo = viewGroup;
        viewGroup.setTag(OooOo.ghost_view_holder, this);
        viewGroup.getOverlay().add(this);
        this.f60090OooO0o0 = true;
    }
    ...
    public final void onViewRemoved(View view) {
        ...
        if ((getChildCount() == 1 && getChildAt(0) == view) || getChildCount() == 0) {
            ...
            ViewGroup viewGroup = this.f60089OooO0Oo;
            viewGroup.setTag(i, null);
            viewGroup.getOverlay().remove(this);
            this.f60090OooO0o0 = false;
        }
    }
}
