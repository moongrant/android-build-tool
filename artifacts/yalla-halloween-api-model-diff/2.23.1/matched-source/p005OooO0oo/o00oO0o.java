...
public final class o00oO0o extends Oooo000 {
    ...
    public final boolean getCarrier(@NotNull String data) {
        ...
        if (systemService instanceof TelephonyManager) {
            ...
            if (completion != null) {
                ...
                oooOo00.f20134OooO0Oo.add(o00o0o2);
    ...
    public final boolean getNetworkStatus(@NotNull String data) {
        ...
        o00o0o2.OooO0OO(AnalyticsEvents.PARAMETER_SHARE_DIALOG_CONTENT_STATUS, numValueOf == null ? o0OoOo0.f20247OooO0Oo : new o00Ooo(numValueOf));
        Integer numValueOf2 = Integer.valueOf(netUtil$NetworkType.getValue());
        o00o0o2.OooO0OO("accessTechnology", numValueOf2 == null ? o0OoOo0.f20247OooO0Oo : new o00Ooo(numValueOf2));
