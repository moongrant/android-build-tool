...
@UnstableApi
public final class o0000OO0 extends o0Oo0oo {

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    public final XmlPullParserFactory f35303OooOOO0;

    /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
    public static final Pattern f35294OooOOO = Pattern.compile("^([0-9][0-9]+):([0-9][0-9]):([0-9][0-9])(?:(\\.[0-9]+)|:([0-9][0-9])(?:\\.([0-9]+))?)?$");

    /* JADX INFO: renamed from: OooOOOO, reason: collision with root package name */
    public static final Pattern f35295OooOOOO = Pattern.compile("^([0-9]+(?:\\.[0-9]+)?)(h|m|s|ms|f|t)$");

    /* JADX INFO: renamed from: OooOOOo, reason: collision with root package name */
    public static final Pattern f35296OooOOOo = Pattern.compile("^(([0-9]*.)?[0-9]+)(px|em|%)$");

    /* JADX INFO: renamed from: OooOOo0, reason: collision with root package name */
    public static final Pattern f35298OooOOo0 = Pattern.compile("^([-+]?\\d+\\.?\\d*?)%$");

    /* JADX INFO: renamed from: OooOOo, reason: collision with root package name */
    public static final Pattern f35297OooOOo = Pattern.compile("^(\\d+\\.?\\d*?)% (\\d+\\.?\\d*?)%$");

    /* JADX INFO: renamed from: OooOOoo, reason: collision with root package name */
    public static final Pattern f35299OooOOoo = Pattern.compile("^(\\d+\\.?\\d*?)px (\\d+\\.?\\d*?)px$");

    /* JADX INFO: renamed from: OooOo00, reason: collision with root package name */
    public static final Pattern f35301OooOo00 = Pattern.compile("^(\\d+) (\\d+)$");

    /* JADX INFO: renamed from: OooOo0, reason: collision with root package name */
    public static final OooO0O0 f35300OooOo0 = new OooO0O0(1, 30.0f, 1);

    /* JADX INFO: renamed from: OooOo0O, reason: collision with root package name */
    public static final OooO00o f35302OooOo0O = new OooO00o(15);

    public static final class OooO00o {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final int f35304OooO00o;

        public OooO00o(int i) {
            this.f35304OooO00o = i;
        }
    }
    ...
    public static final class OooO0O0 {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final float f35305OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final int f35306OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final int f35307OooO0OO;

        public OooO0O0(int i, float f, int i2) {
            this.f35305OooO00o = f;
            this.f35306OooO0O0 = i;
            this.f35307OooO0OO = i2;
        }
    }
    ...
    public static final class OooO0OO {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final int f35308OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final int f35309OooO0O0;

        public OooO0OO(int i, int i2) {
            this.f35308OooO00o = i;
            this.f35309OooO0O0 = i2;
        }
    }
    ...
    public o0000OO0() {
        try {
            ...
            this.f35303OooOOO0 = xmlPullParserFactoryNewInstance;
    ...
    public static OooO00o OooOO0O(XmlPullParser xmlPullParser, OooO00o oooO00o) throws SubtitleDecoderException {
        ...
        Matcher matcher = f35301OooOo00.matcher(attributeValue);
        if (!matcher.matches()) {
    ...
    public static void OooOO0o(String str, TtmlStyle ttmlStyle) throws SubtitleDecoderException {
        ...
        switch (strGroup) {
            case "%":
                ttmlStyle.f8841OooOO0 = 3;
                break;
            case "em":
                ttmlStyle.f8841OooOO0 = 2;
                break;
            case "px":
                ttmlStyle.f8841OooOO0 = 1;
                break;
            default:
        ...
        strGroup2.getClass();
        ttmlStyle.f8842OooOO0O = Float.parseFloat(strGroup2);
    }
    ...
    public static void OooOOO(XmlPullParser xmlPullParser, HashMap map, OooO00o oooO00o, @Nullable OooO0OO oooO0OO, HashMap map2, HashMap map3) throws XmlPullParserException, IOException {
        ...
        do {
            xmlPullParser.next();
            if (o000OOo0.OooO0OO(xmlPullParser, AnalyticsEvents.PARAMETER_LIKE_VIEW_STYLE)) {
                String strOooO00o7 = o000OOo0.OooO00o(xmlPullParser, AnalyticsEvents.PARAMETER_LIKE_VIEW_STYLE);
                ...
                String str2 = ttmlStyleOooOOOo.f8843OooOO0o;
                if (str2 != null) {
                    map.put(str2, ttmlStyleOooOOOo);
                }
            } else if (o000OOo0.OooO0OO(xmlPullParser, "region")) {
                String strOooO00o8 = o000OOo0.OooO00o(xmlPullParser, "id");
                if (strOooO00o8 != null) {
                    String strOooO00o9 = o000OOo0.OooO00o(xmlPullParser, AppMeasurementSdk.ConditionalUserProperty.ORIGIN);
                    if (strOooO00o9 != null) {
                        Pattern pattern = f35297OooOOo;
                        Matcher matcher3 = pattern.matcher(strOooO00o9);
                        Pattern pattern2 = f35299OooOOoo;
                        ...
                        if (matcher3.matches()) {
                            try {
                                ...
                                strOooO00o2 = o000OOo0.OooO00o(xmlPullParser, "extent");
                                if (strOooO00o2 != null) {
                                    ...
                                    if (matcher.matches()) {
                                        ...
                                        try {
                                            ...
                                            f3 = i4 / oooO0OO.f35308OooO00o;
                                            f4 = i5 / oooO0OO.f35309OooO0O0;
                                        } catch (NumberFormatException unused2) {
                                            Log.OooO0o("TtmlDecoder", "Ignoring region with malformed extent: ".concat(strOooO00o9));
                                            o000o001 = null;
                                        }
                                    }
                                    strOooO00o3 = o000OOo0.OooO00o(xmlPullParser, "displayAlign");
                                    if (strOooO00o3 != null) {
                                    ...
                                    float f6 = 1.0f / oooO00o.f35304OooO00o;
                                    strOooO00o4 = o000OOo0.OooO00o(xmlPullParser, "writingMode");
                                    if (strOooO00o4 != null) {
                                    ...
                                    o000o001 = new o000O000(strOooO00o8, f, f5, 0, i, f3, f4, 1, f6, i2);
                                } else {
                            ...
                            try {
                                ...
                                float f7 = i6 / oooO0OO.f35308OooO00o;
                                float f8 = i7 / oooO0OO.f35309OooO0O0;
                                f = f7;
                                f2 = f8;
                                strOooO00o2 = o000OOo0.OooO00o(xmlPullParser, "extent");
                                if (strOooO00o2 != null) {
                                    ...
                                    if (matcher.matches()) {
                                        ...
                                        f3 = i8 / oooO0OO.f35308OooO00o;
                                        f4 = i9 / oooO0OO.f35309OooO0O0;
                                    }
                                    strOooO00o3 = o000OOo0.OooO00o(xmlPullParser, "displayAlign");
                                    if (strOooO00o3 != null) {
                                        strOooO00o6 = com.google.common.base.OooO0OO.OooO00o(strOooO00o3);
                                    ...
                                    float f9 = 1.0f / oooO00o.f35304OooO00o;
                                    strOooO00o4 = o000OOo0.OooO00o(xmlPullParser, "writingMode");
                                    if (strOooO00o4 != null) {
                                        strOooO00o5 = com.google.common.base.OooO0OO.OooO00o(strOooO00o4);
                                        strOooO00o5.getClass();
                                        ...
                                        */
                                        throw new UnsupportedOperationException("Method not decompiled: p097o000o0oO.o0000OO0.OooOOO(org.xmlpull.v1.XmlPullParser, java.util.HashMap, o000o0oO.o0000OO0$OooO00o, o000o0oO.o0000OO0$OooO0OO, java.util.HashMap, java.util.HashMap):void");
                                    }
                                    ...
                                    public static OooO0O0 OooOOO0(XmlPullParser xmlPullParser) throws SubtitleDecoderException {
                                        ...
                                        OooO0O0 oooO0O0 = f35300OooOo0;
                                        int i3 = oooO0O0.f35306OooO0O0;
                                        String attributeValue3 = xmlPullParser.getAttributeValue("http://www.w3.org/ns/ttml#parameter", "subFrameRate");
                                        if (attributeValue3 != null) {
                                            i3 = Integer.parseInt(attributeValue3);
                                        }
                                        String attributeValue4 = xmlPullParser.getAttributeValue("http://www.w3.org/ns/ttml#parameter", "tickRate");
                                        return new OooO0O0(i3, i * f, attributeValue4 != null ? Integer.parseInt(attributeValue4) : oooO0O0.f35307OooO0OO);
                                    }

                                    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
                                    /* JADX WARN: Code duplicated, block: B:31:0x007d  */
                                    /* JADX WARN: Code duplicated, block: B:80:0x0115  */
                                    public static o000 OooOOOO(XmlPullParser xmlPullParser, @Nullable o000 o000Var, HashMap map, OooO0O0 oooO0O0) throws SubtitleDecoderException {
                                        long j;
                                        long j2;
                                        byte b;
                                        String[] strArrSplit;
                                        ...
                                        } else if (o000Var != null) {
                                            long j4 = o000Var.f35287OooO0o0;
                                            if (j4 != j) {
                                                j2 = j4;
                                            } else {
                                                j2 = jOooOOo1;
                                        ...
                                        return new o000(xmlPullParser.getName(), null, jOooOOo0, j2, ttmlStyleOooOOOo, strArr, str, strSubstring, o000Var);
                                    }
                                        ...
                                        for (int i = 0; i < attributeCount; i++) {
                                            ...
                                            switch (attributeName) {
                                                case "fontStyle":
                                                    ...
                                                    ttmlStyle.f8832OooO = "italic".equalsIgnoreCase(attributeValue) ? 1 : 0;
                                                    break;
                                                case "fontFamily":
                                                    ttmlStyle = OooO0oo(ttmlStyle);
                                                    ttmlStyle.f8833OooO00o = attributeValue;
                                                    break;
                                                case "textAlign":
                                                    ttmlStyle = OooO0oo(ttmlStyle);
                                                    ttmlStyle.f8846OooOOOO = OooOO0(attributeValue);
                                                    break;
                                                case "textDecoration":
                                                    ...
                                                    switch (strOooO00o) {
                                                        case "nounderline":
                                                            ttmlStyle = OooO0oo(ttmlStyle);
                                                            ttmlStyle.f8839OooO0oO = 0;
                                                            break;
                                                        case "underline":
                                                            ttmlStyle = OooO0oo(ttmlStyle);
                                                            ttmlStyle.f8839OooO0oO = 1;
                                                            break;
                                                        case "nolinethrough":
                                                            ttmlStyle = OooO0oo(ttmlStyle);
                                                            ttmlStyle.f8837OooO0o = 0;
                                                            break;
                                                        case "linethrough":
                                                            ttmlStyle = OooO0oo(ttmlStyle);
                                                            ttmlStyle.f8837OooO0o = 1;
                                                            break;
                                                    }
                                                    break;
                                                case "fontWeight":
                                                    ttmlStyle = OooO0oo(ttmlStyle);
                                                    ttmlStyle.f8840OooO0oo = "bold".equalsIgnoreCase(attributeValue) ? 1 : 0;
                                                    break;
                                                case "id":
                                                    if (!AnalyticsEvents.PARAMETER_LIKE_VIEW_STYLE.equals(xmlPullParser.getName())) {
                                                        ...
                                                        ttmlStyle = OooO0oo(ttmlStyle);
                                                        ttmlStyle.f8843OooOO0o = attributeValue;
                                                        break;
                                                    }
                                                    break;
                                                case "ruby":
                                                    ...
                                                    switch (strOooO00o2) {
                                                        ...
                                                        case "base":
                                                            ttmlStyle = OooO0oo(ttmlStyle);
                                                            ttmlStyle.f8845OooOOO0 = 2;
                                                            break;
                                                        case "container":
                                                            ttmlStyle = OooO0oo(ttmlStyle);
                                                            ttmlStyle.f8845OooOOO0 = 1;
                                                            break;
                                                        case "delimiter":
                                                            ttmlStyle = OooO0oo(ttmlStyle);
                                                            ttmlStyle.f8845OooOOO0 = 4;
                                                            break;
                                                        case "textContainer":
                                                        case "text":
                                                            ttmlStyle = OooO0oo(ttmlStyle);
                                                            ttmlStyle.f8845OooOOO0 = 3;
                                                            break;
                                                    }
                                                    break;
                                                case "color":
                                                    ttmlStyle = OooO0oo(ttmlStyle);
                                                    try {
                                                        ttmlStyle.f8834OooO0O0 = p080o000OoO.o0Oo0oo.OooO00o(attributeValue, false);
                                                        ttmlStyle.f8835OooO0OO = true;
                                                        break;
                                                    } catch (IllegalArgumentException unused) {
                                                        o0OoOo0.OooO00o("Failed parsing color value: ", attributeValue, "TtmlDecoder");
                                                        break;
                                                    }
                                                    break;
                                                case "shear":
                                                    ttmlStyle = OooO0oo(ttmlStyle);
                                                    Matcher matcher = f35298OooOOo0.matcher(attributeValue);
                                                    if (matcher.matches()) {
                                                        try {
                                                            String strGroup = matcher.group(1);
                                                            strGroup.getClass();
                                                        ...
                                                        ttmlStyle.f8850OooOOoo = fMin;
                                                        break;
                                                    } else {
                                                        o0OoOo0.OooO00o("Invalid value for shear: ", attributeValue, "TtmlDecoder");
                                                    }
                                                    fMin = Float.MAX_VALUE;
                                                    ttmlStyle.f8850OooOOoo = fMin;
                                                    break;
                                                case "textCombine":
                                                    ...
                                                    if (!strOooO00o3.equals("all")) {
                                                        if (strOooO00o3.equals("none")) {
                                                            ttmlStyle = OooO0oo(ttmlStyle);
                                                            ttmlStyle.f8849OooOOo0 = 0;
                                                        }
                                                        break;
                                                    } else {
                                                        ttmlStyle = OooO0oo(ttmlStyle);
                                                        ttmlStyle.f8849OooOOo0 = 1;
                                                        break;
                                                    }
                                                    break;
                                                case "fontSize":
                                                    try {
                                                        ...
                                                        o0OoOo0.OooO00o("Failed parsing fontSize value: ", attributeValue, "TtmlDecoder");
                                                        break;
                                                    }
                                                    break;
                                                case "textEmphasis":
                                                    ttmlStyle = OooO0oo(ttmlStyle);
                                                    Pattern pattern = TextEmphasis.f8824OooO0Oo;
                                                    if (attributeValue == null) {
                                                        textEmphasis = null;
                                                    } else {
                                                        ...
                                                        if (strOooO00o4.isEmpty()) {
                                                            ...
                                                            ImmutableSet immutableSetOooOO0o = ImmutableSet.OooOO0o(TextUtils.split(strOooO00o4, TextEmphasis.f8824OooO0Oo));
                                                            String str = (String) o00O0O0O.OooO0Oo("outside", new o0oO0O0o(o0O0O0Oo.OooO0Oo(TextEmphasis.f8828OooO0oo, immutableSetOooOO0o)));
                                                            ...
                                                            o0O0oo0o o0o0oo0oOooO0Oo = o0O0O0Oo.OooO0Oo(TextEmphasis.f8826OooO0o0, immutableSetOooOO0o);
                                                            if (o0o0oo0oOooO0Oo.isEmpty()) {
                                                                o0O0oo0o o0o0oo0oOooO0Oo2 = o0O0O0Oo.OooO0Oo(TextEmphasis.f8827OooO0oO, immutableSetOooOO0o);
                                                                o0O0oo0o o0o0oo0oOooO0Oo3 = o0O0O0Oo.OooO0Oo(TextEmphasis.f8825OooO0o, immutableSetOooOO0o);
                                                    ...
                                                    ttmlStyle.f8848OooOOo = textEmphasis;
                                                    break;
                                                case "rubyPosition":
                                                    ...
                                                    if (!strOooO00o5.equals("before")) {
                                                        if (strOooO00o5.equals("after")) {
                                                            ttmlStyle = OooO0oo(ttmlStyle);
                                                            ttmlStyle.f8844OooOOO = 2;
                                                        }
                                                        break;
                                                    } else {
                                                        ttmlStyle = OooO0oo(ttmlStyle);
                                                        ttmlStyle.f8844OooOOO = 1;
                                                        break;
                                                    }
                                                    break;
                                                case "backgroundColor":
                                                    ttmlStyle = OooO0oo(ttmlStyle);
                                                    try {
                                                        ttmlStyle.f8836OooO0Oo = p080o000OoO.o0Oo0oo.OooO00o(attributeValue, false);
                                                        ttmlStyle.f8838OooO0o0 = true;
                                                        break;
                                                    } catch (IllegalArgumentException unused3) {
                                                        o0OoOo0.OooO00o("Failed parsing background value: ", attributeValue, "TtmlDecoder");
                                                        break;
                                                    }
                                                    break;
                                                case "multiRowAlign":
                                                    ttmlStyle = OooO0oo(ttmlStyle);
                                                    ttmlStyle.f8847OooOOOo = OooOO0(attributeValue);
                                                    break;
                                            }
                                        }
                                        return ttmlStyle;
                                    ...
                                    public static OooO0OO OooOOo(XmlPullParser xmlPullParser) {
                                        String strOooO00o = o000OOo0.OooO00o(xmlPullParser, "extent");
                                        if (strOooO00o == null) {
                                            return null;
                                        }
                                        Matcher matcher = f35299OooOOoo.matcher(strOooO00o);
                                        if (!matcher.matches()) {
                                    ...
                                    public static long OooOOo0(String str, OooO0O0 oooO0O0) throws SubtitleDecoderException {
                                        double d;
                                        double d2;
                                        Matcher matcher = f35294OooOOO.matcher(str);
                                        if (matcher.matches()) {
                                            String strGroup = matcher.group(1);
                                            strGroup.getClass();
                                            ...
                                            double d7 = d6 + (strGroup5 != null ? Long.parseLong(strGroup5) / oooO0O0.f35305OooO00o : 0.0d);
                                            String strGroup6 = matcher.group(6);
                                            return (long) ((d7 + (strGroup6 != null ? (Long.parseLong(strGroup6) / ((double) oooO0O0.f35306OooO0O0)) / ((double) oooO0O0.f35305OooO00o) : 0.0d)) * 1000000.0d);
                                        }
                                        Matcher matcher2 = f35295OooOOOO.matcher(str);
                                        if (!matcher2.matches()) {
                                    ...
                                    public final o0OO00O OooO0oO(byte[] bArr, int i, boolean z) throws SubtitleDecoderException {
                                        ...
                                        OooO0O0 oooO0O0;
                                        try {
                                            XmlPullParser xmlPullParserNewPullParser = this.f35303OooOOO0.newPullParser();
                                            HashMap map = new HashMap();
                                            HashMap map2 = new HashMap();
                                            HashMap map3 = new HashMap();
                                            map2.put("", new o000O000("", -3.4028235E38f, -3.4028235E38f, Integer.MIN_VALUE, Integer.MIN_VALUE, -3.4028235E38f, -3.4028235E38f, Integer.MIN_VALUE, -3.4028235E38f, Integer.MIN_VALUE));
                                            OooO0OO oooO0OOOooOOo = null;
                                            xmlPullParserNewPullParser.setInput(new ByteArrayInputStream(bArr, 0, i), null);
                                            ArrayDeque arrayDeque = new ArrayDeque();
                                            OooO0O0 oooO0O0OooOOO0 = f35300OooOo0;
                                            OooO00o oooO00o2 = f35302OooOo0O;
                                            int i2 = 0;
                                            o000Oo0 o000oo1 = null;
                                            OooO00o oooO00oOooOO0O = oooO00o2;
                                            for (int eventType = xmlPullParserNewPullParser.getEventType(); eventType != 1; eventType = xmlPullParserNewPullParser.getEventType()) {
                                                o000 o000Var = (o000) arrayDeque.peek();
                                                if (i2 == 0) {
                                                    ...
                                                    if (eventType == 2) {
                                                        ...
                                                        if (!OooO(name)) {
                                                            ...
                                                            oooO0O0 = oooO0O1;
                                                            try {
                                                                o000 o000VarOooOOOO = OooOOOO(xmlPullParserNewPullParser, o000Var, map2, oooO0O0);
                                                                arrayDeque.push(o000VarOooOOOO);
                                                                if (o000Var != null) {
                                                                    if (o000Var.f35293OooOOO0 == null) {
                                                                        o000Var.f35293OooOOO0 = new ArrayList();
                                                                    }
                                                                    o000Var.f35293OooOOO0.add(o000VarOooOOOO);
                                                                }
                                                        ...
                                                        o000Var.getClass();
                                                        o000 o000VarOooO00o = o000.OooO00o(xmlPullParserNewPullParser.getText());
                                                        if (o000Var.f35293OooOOO0 == null) {
                                                            o000Var.f35293OooOOO0 = new ArrayList();
                                                        }
                                                        o000Var.f35293OooOOO0.add(o000VarOooO00o);
                                                    } else if (eventType == 3) {
                                                        if (xmlPullParserNewPullParser.getName().equals("tt")) {
                                                            o000 o000Var2 = (o000) arrayDeque.peek();
                                                            o000Var2.getClass();
                                                            o000oo1 = new o000Oo0(o000Var2, map, map2, map3);
                                                        }
                                                        arrayDeque.pop();
                                                    }
                                                } else if (eventType == 2) {
