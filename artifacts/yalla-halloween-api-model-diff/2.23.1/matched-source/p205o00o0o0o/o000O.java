...
public final class o000O extends o0000OO0<o000O> {
    ...
    @Nullable
    public Function0<? extends Object> f39357OooO;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public boolean f39358OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final boolean f39359OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    @Nullable
    public Function0<? extends Object> f39360OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    @NotNull
    public final o000O0 f39361OooOO0O;
    ...
    public static final class OooO extends Lambda implements Function0<ViewGroup> {
        ...
        public final ViewGroup invoke() {
            return o000O.this.f38484OooO0OO;
        }
    }
    ...
    public static final class OooO00o extends Lambda implements Function1<View, Unit> {
        ...
        public final Unit invoke(View view) {
            ...
            Function0<? extends Object> function0 = o000o.f39357OooO;
            if (function0 != null) {
                function0.invoke();
            }
            if (o000o.f39358OooO0oO) {
                o000o.OooO0OO();
            }
    ...
    public static final class OooO0O0 extends Lambda implements Function1<View, Unit> {
        ...
        public final Unit invoke(View view) {
            ...
            Intrinsics.checkNotNullParameter(it, "it");
            o000O o000o = o000O.this;
            Function0<? extends Object> function0 = o000o.f39360OooOO0;
            if (function0 != null) {
                function0.invoke();
            }
            if (o000o.f39359OooO0oo) {
                o000o.OooO0OO();
            }
            return Unit.INSTANCE;
        }
    ...
    public static final class OooO0OO extends Lambda implements Function1<View, Unit> {
        ...
        public final Unit invoke(View view) {
            View it = view;
            Intrinsics.checkNotNullParameter(it, "it");
            o000O.this.f38483OooO0O0.cancel();
            return Unit.INSTANCE;
        }
    }
    ...
    public o000O(@NotNull Context context) {
        ...
        this.f39358OooO0oO = true;
        this.f39359OooO0oo = true;
        this.f39361OooOO0O = new o000O0(Reflection.getOrCreateKotlinClass(o0O00000.class), context, new OooO());
        OooOO0O(WindowAnim.ScaleWithAlpha);
        FrameLayout frameLayout = OooOOO0().f39383OooO00o;
    ...
    public final o0O00000 OooOOO0() {
        return (o0O00000) this.f39361OooOO0O.getValue();
    }

    @NotNull
    public final void OooOOOO(int i) {
        OooOOO0().f39386OooO0Oo.setText(i);
        TextView tvConfirm = OooOOO0().f39386OooO0Oo;
        Intrinsics.checkNotNullExpressionValue(tvConfirm, "tvConfirm");
    ...
    public final void OooOOOo(@NotNull String string) {
        ...
        OooOOO0().f39386OooO0Oo.setText(string);
        TextView tvConfirm = OooOOO0().f39386OooO0Oo;
        Intrinsics.checkNotNullExpressionValue(tvConfirm, "tvConfirm");
        com.code.android.util.o000O.OooOOOO(tvConfirm);
    }
    ...
    public final void OooOOo(@NotNull View customizeView) {
        ...
        OooOOO0().f39384OooO0O0.removeAllViews();
        OooOOO0().f39384OooO0O0.addView(customizeView);
        FrameLayout flCustom = OooOOO0().f39384OooO0O0;
        Intrinsics.checkNotNullExpressionValue(flCustom, "flCustom");
    ...
    public final void OooOo0o(@NotNull String string) {
        Intrinsics.checkNotNullParameter(string, "string");
        OooOOO0().f39387OooO0o.setText(string);
        TextView tvRefuse = OooOOO0().f39387OooO0o;
        Intrinsics.checkNotNullExpressionValue(tvRefuse, "tvRefuse");
        com.code.android.util.o000O.OooOOOO(tvRefuse);
    }
    ...
    public final void OooOoOO() {
        ...
        Space vCloseHolder = OooOOO0().f39390OooO0oo;
