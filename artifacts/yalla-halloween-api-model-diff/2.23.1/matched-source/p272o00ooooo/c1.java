...
public final class c1 {
    ...
    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ oO000o00 f40471OooO0Oo;

    public /* synthetic */ c1(oO000o00 oo000o00) {
        this.f40471OooO0Oo = oo000o00;
    }
    ...
    public final zzft OooO00o(zzft zzftVar, String str) throws Throwable {
        ...
        oO000o00 oo000o00 = this.f40471OooO0Oo;
        oo000o00.f40509OooO0O0.zzu();
        Long l = (Long) zzlj.OooO0o0(zzftVar, "_eid");
        if (l != null) {
            boolean zEquals = strZzh.equals("_ep");
            zzgd zzgdVar = oo000o00.f40527OooO00o;
            zzlh zzlhVar = oo000o00.f40509OooO0O0;
            if (zEquals) {
                ...
                if (this.f40468OooO00o == null || this.f40469OooO0O0 == null || l.longValue() != this.f40469OooO0O0.longValue()) {
                    oOo00OO0 ooo00oo0Zzh = zzlhVar.zzh();
                    ooo00oo0Zzh.zzg();
                    zzgd zzgdVar2 = ooo00oo0Zzh.f40527OooO00o;
                    ooo00oo0Zzh.OooO00o();
                    try {
                        try {
                            cursorRawQuery = ooo00oo0Zzh.OooOOo().rawQuery("select main_event, children_to_process from main_event_params where app_id=? and event_id=?", new String[]{str, l.toString()});
                            try {
                ...
                if (j <= 0) {
                    oOo00OO0 ooo00oo0Zzh2 = zzlhVar.zzh();
                    ooo00oo0Zzh2.zzg();
                    zzgd zzgdVar3 = ooo00oo0Zzh2.f40527OooO00o;
                    zzgdVar3.zzaA().zzj().zzb("Clearing complex main event info. appId", str);
                    try {
                        ooo00oo0Zzh2.OooOOo().execSQL("delete from main_event_params where app_id=?", new String[]{str});
