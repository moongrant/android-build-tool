...
public final class o000oOoO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f48648OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ JSONObject f48649OooO0o0;
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ RoomTheme f48650OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(RoomTheme roomTheme, Continuation<? super OooO00o> continuation) {
            super(2, continuation);
            this.f48650OooO0Oo = roomTheme;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO00o(this.f48650OooO0Oo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            o00O0O.OooO00o().OooOooO().OooO00o(this.f48650OooO0Oo);
            return Unit.INSTANCE;
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o000oOoO(JSONObject jSONObject, Continuation<? super o000oOoO> continuation) {
        super(2, continuation);
        this.f48649OooO0o0 = jSONObject;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o000oOoO(this.f48649OooO0o0, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws JSONException {
        ...
        int i = this.f48648OooO0Oo;
        OooO0O0.OooO00o oooO00o = OooO0O0.f24541OoooOOO;
        JSONObject jSONObject = this.f48649OooO0o0;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            if (jSONObject.has("dues")) {
                oooO00o.OooO00o().f24560OooOOo0.setValue(Boxing.boxInt(jSONObject.getInt("dues")));
            }
            if (jSONObject.has("sumamount")) {
                com.yalla.yalla.service.room.OooO00o.f24518OooO.f48411OooO00o.setValue(Long.valueOf(jSONObject.getLong("sumamount")));
            }
            if (jSONObject.has("background")) {
                String string = jSONObject.getString("background");
                oooO00o.OooO00o().f24556OooOOO0.setValue(string);
                RoomTheme roomTheme = new RoomTheme();
                roomTheme.roomId = com.yalla.yalla.service.room.OooO00o.f24524OooO0o0.OooO0o0();
                roomTheme.roomTheme = string;
                OooO00o oooO00o2 = new OooO00o(roomTheme, null);
                this.f48648OooO0Oo = 1;
        ...
        if (jSONObject.has("backgroundvideo")) {
            oooO00o.OooO00o().f24555OooOOO.setValue(jSONObject.getString("backgroundvideo"));
        }
        if (jSONObject.has("image")) {
            oooO00o.OooO00o().f24544OooO00o.setValue(jSONObject.getString("image"));
        }
        return Unit.INSTANCE;
    }
}
