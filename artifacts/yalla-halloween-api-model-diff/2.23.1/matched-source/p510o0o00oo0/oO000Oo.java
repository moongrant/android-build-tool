...
public final class oO000Oo extends Lambda implements Function2<Integer, oO0O000<MenuDialogTag>, Unit> {
    ...
    public oO000Oo(ChatModel chatModel) {
        super(2);
    ...
    public final Unit invoke(Integer num, oO0O000<MenuDialogTag> oo0o000) {
        ...
        int i = OooO00o.$EnumSwitchMapping$0[item.f59676OooO0Oo.ordinal()];
        ChatModel chatModel = this.f50712OooO0Oo;
        if (i == 1) {
            EventModel eventModel = chatModel.getEventModel();
            o000OO0O.OooO0O0(eventModel != null ? eventModel.getId() : 0L);
            ...
            o0O0o000.OooO0o0(reportScreen, ReportScreen.bundleOf(6, eventModel3 != null ? eventModel3.getId() : 0L, (244 & 4) != 0 ? null : null, (244 & 8) != 0 ? null : null, (244 & 16) != 0 ? null : null, (244 & 32) != 0 ? null : null, (244 & 64) != 0 ? null : null, (244 & 128) != 0 ? null : null), false, null, 12);
        }
        return null;
    }
}
