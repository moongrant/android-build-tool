...
public final class o0O0000O {
    ...
    @NotNull
    public final FragmentActivity f54871OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public final ShareLogViewModel f54872OooO0O0;

    public static final class OooO00o extends Lambda implements Function0<Unit> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ ShareContentModel f54873OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ o0O0000O f54874OooO0o0;

        /* JADX INFO: renamed from: o0o0OoO0.o0O0000O$OooO00o$OooO00o, reason: collision with other inner class name */
        public /* synthetic */ class C0487OooO00o {
        ...
        public OooO00o(ShareContentModel shareContentModel, o0O0000O o0o0000o2) {
            super(0);
            this.f54873OooO0Oo = shareContentModel;
            this.f54874OooO0o0 = o0o0000o2;
        }
        ...
        public final Unit invoke() {
            String string;
            String strValueOf;
            ShareContentModel shareContentModel = this.f54873OooO0Oo;
            int i = C0487OooO00o.$EnumSwitchMapping$0[shareContentModel.getType().ordinal()];
            o0O0000O o0o0000o2 = this.f54874OooO0o0;
            if (i != 1) {
                if (i == 2) {
                    ...
                    if (web != null) {
                        ...
                        if (!(id == null || id.length() == 0)) {
                            ...
                            FragmentActivity context = o0o0000o2.f54871OooO00o;
                    ...
                    if (event != null) {
                        ...
                        MomentSendActivity.OooO00o.OooO0O0(o0o0000o2.f54871OooO00o, momentSendShareModel2);
                    }
                }
                strValueOf = null;
            } else {
                ...
                if (room != null) {
                    ...
                    if (!(roomid == null || roomid.length() == 0)) {
                        ...
                        int i4 = MomentSendActivity.f25728Oooo0OO;
                        FragmentActivity context2 = o0o0000o2.f54871OooO00o;
            ...
            if (!(strValueOf == null || strValueOf.length() == 0)) {
                o0o0000o2.f54872OooO0O0.shareLog(shareContentModel.getType(), String.valueOf(strValueOf), ShareLogType.Moments);
            }
    ...
    public o0O0000O(@NotNull FragmentActivity activity) {
        ...
        this.f54871OooO00o = activity;
        this.f54872OooO0O0 = (ShareLogViewModel) new ViewModelProvider(activity).get(ShareLogViewModel.class);
    }
