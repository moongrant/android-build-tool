...
public final class o0O00o0 {
    ...
    @NotNull
    public final FragmentActivity f54896OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public final ShareLogViewModel f54897OooO0O0;

    public static final class OooO00o extends Lambda implements Function0<Unit> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ ShareContentModel f54898OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ o0O00o0 f54899OooO0o0;

        /* JADX INFO: renamed from: o0o0OoO0.o0O00o0$OooO00o$OooO00o, reason: collision with other inner class name */
        public /* synthetic */ class C0489OooO00o {
        ...
        public OooO00o(ShareContentModel shareContentModel, o0O00o0 o0o00o1) {
            super(0);
            this.f54898OooO0Oo = shareContentModel;
            this.f54899OooO0o0 = o0o00o1;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            ShareContentModel shareContentModel = this.f54898OooO0Oo;
            int i = C0489OooO00o.$EnumSwitchMapping$0[shareContentModel.getType().ordinal()];
            boolean z = true;
            o0O00o0 o0o00o1 = this.f54899OooO0o0;
            String string = null;
            if (i == 1) {
                ...
                ShareToFriendsActivity.OooO00o.OooO00o(o0o00o1.f54896OooO00o, shareToFriendModel);
            } else if (i == 2) {
                ...
                if (web != null) {
                    ...
                    ShareToFriendsActivity.OooO00o.OooO00o(o0o00o1.f54896OooO00o, shareToFriendModel2);
                }
            } else if (i != 3) {
                ...
                if (event != null) {
                    ...
                    int i4 = ShareToFriendsActivity.f25276Oooo00o;
                    ShareToFriendsActivity.OooO00o.OooO00o(o0o00o1.f54896OooO00o, shareToFriendModel3);
                }
            }
            ...
            if (!z) {
                o0o00o1.f54897OooO0O0.shareLog(shareContentModel.getType(), String.valueOf(string), ShareLogType.Friend);
            }
            return Unit.INSTANCE;
        }
    }

    public o0O00o0(@NotNull FragmentActivity activity) {
        Intrinsics.checkNotNullParameter(activity, "activity");
        this.f54896OooO00o = activity;
        this.f54897OooO0O0 = (ShareLogViewModel) new ViewModelProvider(activity).get(ShareLogViewModel.class);
    }
