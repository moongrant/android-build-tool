...
public final class o0OoO00O {
    ...
    @NotNull
    public final FragmentActivity f54902OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public final ShareLogViewModel f54903OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final int f54904OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public final String f54905OooO0Oo;
    ...
    public static final class OooO0O0 extends Lambda implements Function0<Unit> {
        ...
        public final /* synthetic */ String f54907OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ ShareContentModel f54908OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(ShareContentModel shareContentModel, String str) {
            super(0);
            this.f54908OooO0o0 = shareContentModel;
            this.f54907OooO0o = str;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            o0OoO00O.this.f54903OooO0O0.shareLog(this.f54908OooO0o0.getType(), String.valueOf(this.f54907OooO0o), ShareLogType.WhatsApp);
            return Unit.INSTANCE;
        }
    }

    public o0OoO00O(@NotNull FragmentActivity activity) {
        Intrinsics.checkNotNullParameter(activity, "activity");
        this.f54902OooO00o = activity;
        this.f54903OooO0O0 = (ShareLogViewModel) new ViewModelProvider(activity).get(ShareLogViewModel.class);
        this.f54904OooO0OO = 1704;
        this.f54905OooO0Oo = "com.whatsapp";
    }

    /* JADX WARN: Code duplicated, block: B:94:0x0172 A[Catch: Exception -> 0x01ba, TryCatch #0 {Exception -> 0x01ba, blocks: (B:92:0x016e, B:94:0x0172, B:95:0x017c), top: B:106:0x016e }] */
    public final void OooO00o(@Nullable ShareContentModel shareContentModel) {
        ...
        try {
            if (i == 1) {
                ...
                if (i != 3) {
                    if (i != 4) {
                        ...
                        strOooO00o = o0000.OooO0OO(o000OOo.event_share_twitter);
                    ...
                    fragmentActivity = this.f54902OooO00o;
                    ...
                    if (fragmentActivity instanceof BaseAppCompatActivity) {
                        ((BaseAppCompatActivity) fragmentActivity).f24685OooO0o0 = new o0O00O0o(this);
                    }
                    Intent intent = new Intent();
                    intent.setAction("android.intent.action.SEND");
                    intent.setPackage(this.f54905OooO0Oo);
                    ...
                    intent.addFlags(1);
                    fragmentActivity.startActivityForResult(intent, this.f54904OooO0OO);
                    oooO0O0.invoke();
                    return;
                }
            ...
            intent2.setPackage(this.f54905OooO0Oo);
            ...
            intent2.addFlags(1);
            fragmentActivity.startActivityForResult(intent2, this.f54904OooO0OO);
            oooO0O0.invoke();
            return;
        } catch (Exception e) {
            e.printStackTrace();
            String strOooO00o3 = o0000O.OooO00o(o0000.OooO0OO(o000OOo.Please_install_XXX), o0000.OooO0OO(o000OOo.single_third_whatsApp));
            if (StringsKt.isBlank(strOooO00o3)) {
                return;
            }
            o000Oo0 o000oo0OooO00o = OooOo00.OooO00o(strOooO00o3, "runnable");
        ...
        OooOOOO.OooO0O0(sbOooO00o2.toString());
    }
}
