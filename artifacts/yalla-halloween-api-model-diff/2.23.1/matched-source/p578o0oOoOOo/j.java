...
public final class j extends SuspendLambda implements Function2<LiveDataScope<ApiResult<List<EventModel>>>, Continuation<? super Unit>, Object> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public int f56412OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public /* synthetic */ Object f56413OooO0o0;
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f56412OooO0Oo;
        if (i != 0) {
            if (i == 1) {
                liveDataScope = (LiveDataScope) this.f56413OooO0o0;
        ...
        ResultKt.throwOnFailure(obj);
        liveDataScope = (LiveDataScope) this.f56413OooO0o0;
        this.f56413OooO0o0 = liveDataScope;
        this.f56412OooO0Oo = 1;
        String strOooO0O0 = oo000o.OooO0O0("/Webservers/Event/GetTop5");
        obj = OooOOO.OooO0Oo(new ExploreRepository$loadEvents$$inlined$call$1(OooO00o.OooO00o(strOooO0O0, "url", strOooO0O0, 0), null), this);
        if (obj == coroutine_suspended) {
            return coroutine_suspended;
        }
        this.f56413OooO0o0 = null;
        this.f56412OooO0Oo = 2;
