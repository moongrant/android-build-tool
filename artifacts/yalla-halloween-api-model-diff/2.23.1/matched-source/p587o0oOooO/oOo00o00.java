...
public final class oOo00o00 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f56850OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ MomentSendModel f56851OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ oO0Oo0o0 f56852OooO0o0;
    ...
    public oOo00o00(oO0Oo0o0 oo0oo0o0, MomentSendModel momentSendModel, Continuation<? super oOo00o00> continuation) {
        super(2, continuation);
        this.f56852OooO0o0 = oo0oo0o0;
        this.f56851OooO0o = momentSendModel;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new oOo00o00(this.f56852OooO0o0, this.f56851OooO0o, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
        ...
        int i3 = this.f56850OooO0Oo;
        MomentSendModel momentSendModel = this.f56851OooO0o;
        oO0Oo0o0 oo0oo0o0 = this.f56852OooO0o0;
        if (i3 != 0) {
            if (i3 == 1) {
                ...
                if (i3 == 2) {
                    ...
                    if (i == 3) {
                        this.f56850OooO0Oo = 3;
                        obj = oO0Oo0o0.OooO00o(oo0oo0o0, momentSendModel, this);
            ...
            if (i2 != 1 || i2 == 2) {
                oo0oo0o0.f56749OooO00o.OooOo0();
                LiveEventBus.get("MOMENT_EDIT_SEND_SUCCESS").post(Boxing.boxLong(momentSendModel.getPostId()));
            }
            return Unit.INSTANCE;
        }
        ResultKt.throwOnFailure(obj);
        this.f56850OooO0Oo = 1;
        obj = oO0Oo0o0.OooO0OO(oo0oo0o0, momentSendModel, this);
        if (obj == coroutine_suspended) {
            return coroutine_suspended;
        }
        ...
        if (i4 == 1 || i4 == 4) {
            this.f56850OooO0Oo = 2;
            obj = oO0Oo0o0.OooO0O0(oo0oo0o0, momentSendModel2, this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            editState = ((MomentSendModel) obj).getEditState();
