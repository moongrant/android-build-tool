...
public final class o0oOo0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ RefreshState f58118OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ MutableState<Boolean> f58119OooO0o0;
    ...
    public o0oOo0O0(RefreshState refreshState, MutableState<Boolean> mutableState, Continuation<? super o0oOo0O0> continuation) {
        super(2, continuation);
        this.f58118OooO0Oo = refreshState;
        this.f58119OooO0o0 = mutableState;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o0oOo0O0(this.f58118OooO0Oo, this.f58119OooO0o0, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = OooO00o.$EnumSwitchMapping$0[this.f58118OooO0Oo.OooO0OO().ordinal()];
        MutableState<Boolean> mutableState = this.f58119OooO0o0;
        if (i == 1) {
