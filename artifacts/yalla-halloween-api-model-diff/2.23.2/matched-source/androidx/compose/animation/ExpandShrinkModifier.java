...
final class ExpandShrinkModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public MeasureResult mo27measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j) {
        ...
        long packedValue = this.sizeAnimation.animate(this.sizeTransitionSpec, new Function1<EnterExitState, IntSize>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$currentSize$1
            ...
            public /* bridge */ /* synthetic */ IntSize invoke(EnterExitState enterExitState) {
                return IntSize.m3927boximpl(m50invokeYEO4UFw(enterExitState));
            }
        ...
        final long packedValue2 = this.offsetAnimation.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<IntOffset>>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$offsetDelta$1
            ...
            public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                return IntOffset.m3884boximpl(m51invokeBjo55l4(enterExitState));
            }
        ...
        final long jMo1337alignKFBX0sM = alignment != null ? alignment.mo1337alignKFBX0sM(jIntSize, packedValue, LayoutDirection.Ltr) : IntOffset.INSTANCE.m3903getZeronOccac();
        return MeasureScope.CC.OooOOo0(measure, IntSize.m3935getWidthimpl(packedValue), IntSize.m3934getHeightimpl(packedValue), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.place$default(layout, placeableMo2804measureBRTryo0, IntOffset.m3893getXimpl(packedValue2) + IntOffset.m3893getXimpl(jMo1337alignKFBX0sM), IntOffset.m3894getYimpl(packedValue2) + IntOffset.m3894getYimpl(jMo1337alignKFBX0sM), 0.0f, 4, null);
            }
        }, 4, null);
    }
    ...
    public final long m48sizeByStateUzc_VyU(@NotNull EnterExitState targetState, long fullSize) {
        ...
        long packedValue = value != null ? value.getSize().invoke(IntSize.m3927boximpl(fullSize)).getPackedValue() : fullSize;
        ChangeSize value2 = this.shrink.getValue();
        long packedValue2 = value2 != null ? value2.getSize().invoke(IntSize.m3927boximpl(fullSize)).getPackedValue() : fullSize;
    ...
    public final long m49targetOffsetByStateoFUgxo0(@NotNull EnterExitState targetState, long fullSize) {
        ...
        long packedValue = value.getSize().invoke(IntSize.m3927boximpl(fullSize)).getPackedValue();
        Alignment value2 = this.alignment.getValue();
        Intrinsics.checkNotNull(value2);
        Alignment alignment = value2;
        LayoutDirection layoutDirection = LayoutDirection.Ltr;
        long jMo1337alignKFBX0sM = alignment.mo1337alignKFBX0sM(fullSize, packedValue, layoutDirection);
        Alignment alignment2 = this.currentAlignment;
        Intrinsics.checkNotNull(alignment2);
        long jMo1337alignKFBX0sM2 = alignment2.mo1337alignKFBX0sM(fullSize, packedValue, layoutDirection);
        return IntOffsetKt.IntOffset(IntOffset.m3893getXimpl(jMo1337alignKFBX0sM) - IntOffset.m3893getXimpl(jMo1337alignKFBX0sM2), IntOffset.m3894getYimpl(jMo1337alignKFBX0sM) - IntOffset.m3894getYimpl(jMo1337alignKFBX0sM2));
    }
}
