...
final class MarqueeModifierNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, FocusEventModifierNode {
    ...
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public static final class C00392 extends SuspendLambda implements Function2<Float, Continuation<? super Unit>, Object> {
            ...
            public C00392(MarqueeModifierNode marqueeModifierNode, Continuation<? super C00392> continuation) {
                super(2, continuation);
            ...
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                C00392 c00392 = new C00392(this.this$0, continuation);
                c00392.L$0 = obj;
                return c00392;
            }
            ...
            public final Object invoke(@Nullable Float f, @Nullable Continuation<? super Unit> continuation) {
                return ((C00392) create(f, continuation)).invokeSuspend(Unit.INSTANCE);
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
                AnimationSpec animationSpecM178createMarqueeAnimationSpecZ4HSEVQ;
                Float f;
                ...
                try {
                    if (i != 0) {
                        if (i == 1) {
                            ...
                            f = (Float) this.L$0;
                            ResultKt.throwOnFailure(obj);
                            animationSpecM178createMarqueeAnimationSpecZ4HSEVQ = animationSpec;
                        } else if (i == 2) {
                            ResultKt.throwOnFailure(obj);
                    ...
                    animationSpecM178createMarqueeAnimationSpecZ4HSEVQ = BasicMarqueeKt.m178createMarqueeAnimationSpecZ4HSEVQ(this.this$0.iterations, f2.floatValue(), this.this$0.initialDelayMillis, this.this$0.delayMillis, this.this$0.velocity, DelegatableNodeKt.requireDensity(this.this$0));
                    Animatable animatable2 = this.this$0.offset;
                    Float fBoxFloat2 = Boxing.boxFloat(0.0f);
                    this.L$0 = f2;
                    this.L$1 = animationSpecM178createMarqueeAnimationSpecZ4HSEVQ;
                    this.label = 1;
                    ...
                    this.L$1 = null;
                    this.label = 2;
                    if (Animatable.animateTo$default(animatable3, f, animationSpecM178createMarqueeAnimationSpecZ4HSEVQ, null, null, this, 12, null) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    animatable = this.this$0.offset;
                    fBoxFloat = Boxing.boxFloat(0.0f);
            ...
            if (i == 0) {
                ...
                Flow flowSnapshotFlow = SnapshotStateKt.snapshotFlow(new Function0<Float>() { // from class: androidx.compose.foundation.MarqueeModifierNode.runAnimation.2.1
                    ...
                    public final Float invoke() {
                        ...
                        if (!MarqueeAnimationMode.m237equalsimpl0(marqueeModifierNode.m249getAnimationModeZbEOnfQ(), MarqueeAnimationMode.INSTANCE.m244getWhileFocusedZbEOnfQ()) || marqueeModifierNode.getHasFocus()) {
                            return Float.valueOf(marqueeModifierNode.getContentWidth() + marqueeModifierNode.getSpacingPx());
                        }
                        return null;
                    }
                });
                C00392 c00392 = new C00392(MarqueeModifierNode.this, null);
                this.label = 1;
                if (FlowKt.collectLatest(flowSnapshotFlow, c00392, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
    ...
    public void draw(@NotNull ContentDrawScope contentDrawScope) {
        ...
        float fM1513getHeightimpl = Size.m1513getHeightimpl(contentDrawScope.mo2118getSizeNHjbRc());
        ...
        drawContext.getTransform().mo2127clipRectN_I0leg(fFloatValue, 0.0f, containerWidth, fM1513getHeightimpl, iM1670getIntersectrtfAjoo);
        if (z) {
    ...
    public final int m249getAnimationModeZbEOnfQ() {
    ...
    public MeasureResult mo250measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j) {
        ...
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        final Placeable placeableMo2804measureBRTryo0 = measurable.mo2804measureBRTryo0(Constraints.m3734copyZbe2FdA$default(j, 0, Integer.MAX_VALUE, 0, 0, 13, null));
        setContainerWidth(ConstraintsKt.m3757constrainWidthK40F9xA(j, placeableMo2804measureBRTryo0.getWidth()));
        setContentWidth(placeableMo2804measureBRTryo0.getWidth());
        return MeasureScope.CC.OooOOo0(measure, getContainerWidth(), placeableMo2804measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.MarqueeModifierNode$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.placeWithLayer$default(layout, placeableMo2804measureBRTryo0, MathKt.roundToInt((-((Number) this.offset.getValue()).floatValue()) * this.getDirection()), 0, 0.0f, null, 12, null);
            }
        }, 4, null);
    }
    ...
    public final void m251setAnimationMode97h66l8(int i) {
        this.animationMode.setValue(MarqueeAnimationMode.m234boximpl(i));
    }
    ...
    public final void m252updatelWfNwf4(int iterations, int animationMode, int delayMillis, int initialDelayMillis, @NotNull MarqueeSpacing spacing, float velocity) {
        Intrinsics.checkNotNullParameter(spacing, "spacing");
        setSpacing(spacing);
        m251setAnimationMode97h66l8(animationMode);
        if (this.iterations == iterations && this.delayMillis == delayMillis && this.initialDelayMillis == initialDelayMillis && Dp.m3780equalsimpl0(this.velocity, velocity)) {
            return;
        }
    ...
    private MarqueeModifierNode(int i, int i2, int i3, int i4, final MarqueeSpacing spacing, float f) {
        ...
        this.animationMode = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(MarqueeAnimationMode.m234boximpl(i2), null, 2, null);
