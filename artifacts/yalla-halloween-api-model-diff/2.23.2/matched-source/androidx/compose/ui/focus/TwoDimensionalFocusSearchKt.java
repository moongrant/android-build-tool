...
public final class TwoDimensionalFocusSearchKt {
    ...
    private static final boolean m1406beamBeatsI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        ...
        if (beamBeats_I7lrPNg$isInDirectionOfSearch(rect3, i, rect)) {
            ...
            if (!FocusDirection.m1366equalsimpl0(i, companion.m1378getLeftdhqQ8s()) && !FocusDirection.m1366equalsimpl0(i, companion.m1382getRightdhqQ8s()) && beamBeats_I7lrPNg$majorAxisDistance$6(rect2, i, rect) >= beamBeats_I7lrPNg$majorAxisDistanceToFarEdge(rect3, i, rect)) {
                return false;
            }
        }
        return true;
    ...
    private static final boolean beamBeats_I7lrPNg$inSourceBeam(Rect rect, int i, Rect rect2) {
        FocusDirection.Companion companion = FocusDirection.INSTANCE;
        if (!(FocusDirection.m1366equalsimpl0(i, companion.m1378getLeftdhqQ8s()) ? true : FocusDirection.m1366equalsimpl0(i, companion.m1382getRightdhqQ8s()))) {
            if (!(FocusDirection.m1366equalsimpl0(i, companion.m1383getUpdhqQ8s()) ? true : FocusDirection.m1366equalsimpl0(i, companion.m1374getDowndhqQ8s()))) {
    ...
    private static final boolean beamBeats_I7lrPNg$isInDirectionOfSearch(Rect rect, int i, Rect rect2) {
        FocusDirection.Companion companion = FocusDirection.INSTANCE;
        if (FocusDirection.m1366equalsimpl0(i, companion.m1378getLeftdhqQ8s())) {
            if (rect2.getLeft() >= rect.getRight()) {
                return true;
            }
        } else if (FocusDirection.m1366equalsimpl0(i, companion.m1382getRightdhqQ8s())) {
            if (rect2.getRight() <= rect.getLeft()) {
                return true;
            }
        } else if (FocusDirection.m1366equalsimpl0(i, companion.m1383getUpdhqQ8s())) {
            if (rect2.getTop() >= rect.getBottom()) {
                return true;
            }
        } else {
            if (!FocusDirection.m1366equalsimpl0(i, companion.m1374getDowndhqQ8s())) {
                throw new IllegalStateException(InvalidFocusDirection.toString());
            }
    ...
    private static final float beamBeats_I7lrPNg$majorAxisDistance$6(Rect rect, int i, Rect rect2) {
        ...
        FocusDirection.Companion companion = FocusDirection.INSTANCE;
        if (!FocusDirection.m1366equalsimpl0(i, companion.m1378getLeftdhqQ8s())) {
            if (FocusDirection.m1366equalsimpl0(i, companion.m1382getRightdhqQ8s())) {
                top = rect.getLeft();
    ...
    private static final FocusTargetNode m1407findBestCandidate4WY_MpI(MutableVector<FocusTargetNode> mutableVector, Rect rect, int i) {
        Rect rectTranslate;
        FocusDirection.Companion companion = FocusDirection.INSTANCE;
        if (FocusDirection.m1366equalsimpl0(i, companion.m1378getLeftdhqQ8s())) {
        ...
        if (size > 0) {
            ...
            do {
                ...
                if (FocusTraversalKt.isEligibleForFocusSearch(focusTargetNode2)) {
                    ...
                    if (m1410isBetterCandidateI7lrPNg(rectFocusRect, rectTranslate, rect, i)) {
    ...
    public static final boolean m1408findChildCorrespondingToFocusEnterOMvw8(@NotNull FocusTargetNode findChildCorrespondingToFocusEnter, int i, @NotNull Function1<? super FocusTargetNode, Boolean> onFound) {
        ...
        FocusDirection.Companion companion = FocusDirection.INSTANCE;
        if (FocusDirection.m1366equalsimpl0(i, companion.m1375getEnterdhqQ8s())) {
            i = companion.m1382getRightdhqQ8s();
        }
        if (FocusDirection.m1366equalsimpl0(i, companion.m1382getRightdhqQ8s()) ? true : FocusDirection.m1366equalsimpl0(i, companion.m1374getDowndhqQ8s())) {
            rectBottomRight = topLeft(FocusTraversalKt.focusRect(findChildCorrespondingToFocusEnter));
        } else {
            if (!(FocusDirection.m1366equalsimpl0(i, companion.m1378getLeftdhqQ8s()) ? true : FocusDirection.m1366equalsimpl0(i, companion.m1383getUpdhqQ8s()))) {
                throw new IllegalStateException(InvalidFocusDirection.toString());
            }
            rectBottomRight = bottomRight(FocusTraversalKt.focusRect(findChildCorrespondingToFocusEnter));
        }
        FocusTargetNode focusTargetNodeM1407findBestCandidate4WY_MpI = m1407findBestCandidate4WY_MpI(mutableVector, rectBottomRight, i);
        if (focusTargetNodeM1407findBestCandidate4WY_MpI != null) {
            return onFound.invoke(focusTargetNodeM1407findBestCandidate4WY_MpI).booleanValue();
        }
        return false;
    }

    /* JADX INFO: renamed from: generateAndSearchChildren-4C6V_qg, reason: not valid java name */
    private static final boolean m1409generateAndSearchChildren4C6V_qg(final FocusTargetNode focusTargetNode, final FocusTargetNode focusTargetNode2, final int i, final Function1<? super FocusTargetNode, Boolean> function1) {
        if (m1411searchChildren4C6V_qg(focusTargetNode, focusTargetNode2, i, function1)) {
            return true;
        }
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m1362searchBeyondBoundsOMvw8(focusTargetNode, i, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.TwoDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(@NotNull BeyondBoundsLayout.BeyondBoundsScope searchBeyondBounds) {
                ...
                Boolean boolValueOf = Boolean.valueOf(TwoDimensionalFocusSearchKt.m1411searchChildren4C6V_qg(focusTargetNode, focusTargetNode2, i, function1));
    ...
    private static final boolean m1410isBetterCandidateI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        if (isBetterCandidate_I7lrPNg$isCandidate(rect, i, rect3)) {
            return !isBetterCandidate_I7lrPNg$isCandidate(rect2, i, rect3) || m1406beamBeatsI7lrPNg(rect3, rect, rect2, i) || (!m1406beamBeatsI7lrPNg(rect3, rect2, rect, i) && isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect) < isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect2));
        }
        return false;
    }
    ...
    public static final boolean m1411searchChildren4C6V_qg(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        FocusTargetNode focusTargetNodeM1407findBestCandidate4WY_MpI;
        MutableVector mutableVector = new MutableVector(new FocusTargetNode[16], 0);
        int iM3004constructorimpl = NodeKind.m3004constructorimpl(LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY);
        ...
        while (mutableVector.isNotEmpty() && (focusTargetNodeM1407findBestCandidate4WY_MpI = m1407findBestCandidate4WY_MpI(mutableVector, FocusTraversalKt.focusRect(focusTargetNode2), i)) != null) {
            if (focusTargetNodeM1407findBestCandidate4WY_MpI.fetchFocusProperties$ui_release().getCanFocus()) {
                return function1.invoke(focusTargetNodeM1407findBestCandidate4WY_MpI).booleanValue();
            }
            if (m1409generateAndSearchChildren4C6V_qg(focusTargetNodeM1407findBestCandidate4WY_MpI, focusTargetNode2, i, function1)) {
                return true;
            }
            mutableVector.remove(focusTargetNodeM1407findBestCandidate4WY_MpI);
        }
        return false;
    }
    ...
    public static final Boolean m1412twoDimensionalFocusSearchOMvw8(@NotNull FocusTargetNode twoDimensionalFocusSearch, int i, @NotNull Function1<? super FocusTargetNode, Boolean> onFound) {
        ...
        if (i2 != 1) {
            if (i2 == 2 || i2 == 3) {
                return Boolean.valueOf(m1408findChildCorrespondingToFocusEnterOMvw8(twoDimensionalFocusSearch, i, onFound));
            }
            if (i2 == 4) {
        ...
        if (i3 == 1) {
            Boolean boolM1412twoDimensionalFocusSearchOMvw8 = m1412twoDimensionalFocusSearchOMvw8(activeChild, i, onFound);
            return !Intrinsics.areEqual(boolM1412twoDimensionalFocusSearchOMvw8, Boolean.FALSE) ? boolM1412twoDimensionalFocusSearchOMvw8 : Boolean.valueOf(m1409generateAndSearchChildren4C6V_qg(twoDimensionalFocusSearch, activeNode(activeChild), i, onFound));
        }
        if (i3 == 2 || i3 == 3) {
            return Boolean.valueOf(m1409generateAndSearchChildren4C6V_qg(twoDimensionalFocusSearch, activeChild, i, onFound));
        }
        if (i3 != 4) {
            throw new NoWhenBranchMatchedException();
        }
