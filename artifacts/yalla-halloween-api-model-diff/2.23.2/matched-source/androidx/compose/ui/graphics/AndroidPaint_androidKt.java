...
public final class AndroidPaint_androidKt {
    ...
    public static final int getNativeFilterQuality(@NotNull android.graphics.Paint paint) {
        Intrinsics.checkNotNullParameter(paint, "<this>");
        return !paint.isFilterBitmap() ? FilterQuality.INSTANCE.m1778getNonefv9h1I() : FilterQuality.INSTANCE.m1776getLowfv9h1I();
    }
    ...
    public static final int getNativeStrokeCap(@NotNull android.graphics.Paint paint) {
        ...
        if (i != 2) {
            return i != 3 ? StrokeCap.INSTANCE.m2005getButtKaPHkGw() : StrokeCap.INSTANCE.m2007getSquareKaPHkGw();
        }
    ...
    public static final int getNativeStrokeJoin(@NotNull android.graphics.Paint paint) {
        ...
        if (i != 2) {
            return i != 3 ? StrokeJoin.INSTANCE.m2016getMiterLxFBmk8() : StrokeJoin.INSTANCE.m2017getRoundLxFBmk8();
        }
        return StrokeJoin.INSTANCE.m2015getBevelLxFBmk8();
    }
    ...
    public static final int getNativeStyle(@NotNull android.graphics.Paint paint) {
        ...
        return (style == null ? -1 : WhenMappings.$EnumSwitchMapping$0[style.ordinal()]) == 1 ? PaintingStyle.INSTANCE.m1923getStrokeTiuSbCo() : PaintingStyle.INSTANCE.m1922getFillTiuSbCo();
    }
    ...
    public static final void m1573setNativeBlendModeGB0RdKg(@NotNull android.graphics.Paint setNativeBlendMode, int i) {
        Intrinsics.checkNotNullParameter(setNativeBlendMode, "$this$setNativeBlendMode");
        if (Build.VERSION.SDK_INT >= 29) {
            WrapperVerificationHelperMethods.INSTANCE.m2055setBlendModeGB0RdKg(setNativeBlendMode, i);
        } else {
            setNativeBlendMode.setXfermode(new PorterDuffXfermode(AndroidBlendMode_androidKt.m1540toPorterDuffModes9anfk8(i)));
        }
    }

    /* JADX INFO: renamed from: setNativeColor-4WTKRHQ, reason: not valid java name */
    public static final void m1574setNativeColor4WTKRHQ(@NotNull android.graphics.Paint setNativeColor, long j) {
        Intrinsics.checkNotNullParameter(setNativeColor, "$this$setNativeColor");
        setNativeColor.setColor(ColorKt.m1735toArgb8_81llA(j));
    }
    ...
    public static final void m1575setNativeFilterQuality50PEsBU(@NotNull android.graphics.Paint setNativeFilterQuality, int i) {
        Intrinsics.checkNotNullParameter(setNativeFilterQuality, "$this$setNativeFilterQuality");
        setNativeFilterQuality.setFilterBitmap(!FilterQuality.m1771equalsimpl0(i, FilterQuality.INSTANCE.m1778getNonefv9h1I()));
    }
    ...
    public static final void m1576setNativeStrokeCapCSYIeUk(@NotNull android.graphics.Paint setNativeStrokeCap, int i) {
        android.graphics.Paint.Cap cap;
        Intrinsics.checkNotNullParameter(setNativeStrokeCap, "$this$setNativeStrokeCap");
        StrokeCap.Companion companion = StrokeCap.INSTANCE;
        if (StrokeCap.m2001equalsimpl0(i, companion.m2007getSquareKaPHkGw())) {
            cap = android.graphics.Paint.Cap.SQUARE;
        } else if (StrokeCap.m2001equalsimpl0(i, companion.m2006getRoundKaPHkGw())) {
            cap = android.graphics.Paint.Cap.ROUND;
        } else {
            cap = StrokeCap.m2001equalsimpl0(i, companion.m2005getButtKaPHkGw()) ? android.graphics.Paint.Cap.BUTT : android.graphics.Paint.Cap.BUTT;
        }
        setNativeStrokeCap.setStrokeCap(cap);
    }

    /* JADX INFO: renamed from: setNativeStrokeJoin-kLtJ_vA, reason: not valid java name */
    public static final void m1577setNativeStrokeJoinkLtJ_vA(@NotNull android.graphics.Paint setNativeStrokeJoin, int i) {
        ...
        } else if (StrokeJoin.m2011equalsimpl0(i, companion.m2015getBevelLxFBmk8())) {
            join = android.graphics.Paint.Join.BEVEL;
        } else {
            join = StrokeJoin.m2011equalsimpl0(i, companion.m2017getRoundLxFBmk8()) ? android.graphics.Paint.Join.ROUND : android.graphics.Paint.Join.MITER;
        }
    ...
    public static final void m1578setNativeStyle5YerkU(@NotNull android.graphics.Paint setNativeStyle, int i) {
        Intrinsics.checkNotNullParameter(setNativeStyle, "$this$setNativeStyle");
        setNativeStyle.setStyle(PaintingStyle.m1918equalsimpl0(i, PaintingStyle.INSTANCE.m1923getStrokeTiuSbCo()) ? android.graphics.Paint.Style.STROKE : android.graphics.Paint.Style.FILL);
    }
}
