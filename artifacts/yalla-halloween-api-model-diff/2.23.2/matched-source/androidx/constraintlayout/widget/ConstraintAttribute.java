...
public final class ConstraintAttribute {
    ...
    public final boolean f4911OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final String f4912OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final AttributeType f4913OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public int f4914OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public String f4915OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public float f4916OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public boolean f4917OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public int f4918OooO0oo;
    ...
    public static /* synthetic */ class OooO00o {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public static final /* synthetic */ int[] f4919OooO00o;
        ...
        static {
            ...
            try {
                f4919OooO00o[AttributeType.BOOLEAN_TYPE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f4919OooO00o[AttributeType.STRING_TYPE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f4919OooO00o[AttributeType.COLOR_TYPE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f4919OooO00o[AttributeType.COLOR_DRAWABLE_TYPE.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f4919OooO00o[AttributeType.INT_TYPE.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f4919OooO00o[AttributeType.FLOAT_TYPE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f4919OooO00o[AttributeType.DIMENSION_TYPE.ordinal()] = 8;
    ...
    public ConstraintAttribute(String str, AttributeType attributeType, Object obj, boolean z) {
        this.f4911OooO00o = false;
        this.f4912OooO0O0 = str;
        this.f4913OooO0OO = attributeType;
        this.f4911OooO00o = z;
        OooO0o(obj);
    }
    ...
    public static void OooO0o0(View view, HashMap<String, ConstraintAttribute> map) {
        ...
        for (String str : map.keySet()) {
            ...
            String strOooO00o = !constraintAttribute.f4911OooO00o ? o00O00OO.OooO00o("set", str) : str;
            try {
                switch (OooO00o.f4919OooO00o[constraintAttribute.f4913OooO0OO.ordinal()]) {
                    case 1:
    ...
    public final float OooO00o() {
        switch (OooO00o.f4919OooO00o[this.f4913OooO0OO.ordinal()]) {
            case 2:
                return this.f4917OooO0oO ? 1.0f : 0.0f;
            case 3:
            ...
            case 6:
                return this.f4914OooO0Oo;
            case 7:
                return this.f4916OooO0o0;
            case 8:
                return this.f4916OooO0o0;
            default:
                return Float.NaN;
    ...
    public final void OooO0O0(float[] fArr) {
        switch (OooO00o.f4919OooO00o[this.f4913OooO0OO.ordinal()]) {
            case 2:
                fArr[0] = this.f4917OooO0oO ? 1.0f : 0.0f;
                return;
            case 3:
                throw new RuntimeException("Color does not have a single color to interpolate");
            case 4:
            case 5:
                int i = this.f4918OooO0oo;
                int i2 = (i >> 24) & 255;
                ...
                return;
            case 6:
                fArr[0] = this.f4914OooO0Oo;
                return;
            case 7:
                fArr[0] = this.f4916OooO0o0;
                return;
            case 8:
                fArr[0] = this.f4916OooO0o0;
                return;
    ...
    public final int OooO0OO() {
        int i = OooO00o.f4919OooO00o[this.f4913OooO0OO.ordinal()];
        return (i == 4 || i == 5) ? 4 : 1;
    }
    ...
    public final void OooO0o(Object obj) {
        switch (OooO00o.f4919OooO00o[this.f4913OooO0OO.ordinal()]) {
            case 1:
            case 6:
                this.f4914OooO0Oo = ((Integer) obj).intValue();
                break;
            case 2:
                this.f4917OooO0oO = ((Boolean) obj).booleanValue();
                break;
            case 3:
                this.f4915OooO0o = (String) obj;
                break;
            case 4:
            case 5:
                this.f4918OooO0oo = ((Integer) obj).intValue();
                break;
            case 7:
                this.f4916OooO0o0 = ((Float) obj).floatValue();
                break;
            case 8:
                this.f4916OooO0o0 = ((Float) obj).floatValue();
                break;
    ...
    public ConstraintAttribute(ConstraintAttribute constraintAttribute, Object obj) {
        this.f4911OooO00o = false;
        this.f4912OooO0O0 = constraintAttribute.f4912OooO0O0;
        this.f4913OooO0OO = constraintAttribute.f4913OooO0OO;
        OooO0o(obj);
    }
}
