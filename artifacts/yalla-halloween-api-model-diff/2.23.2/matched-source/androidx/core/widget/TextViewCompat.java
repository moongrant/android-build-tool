...
public final class TextViewCompat {
    ...
    public static class OooOO0 implements ActionMode.Callback {
        ...
        public final ActionMode.Callback f5538OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final TextView f5539OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public Class<?> f5540OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public Method f5541OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public boolean f5542OooO0o = false;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public boolean f5543OooO0o0;

        public OooOO0(ActionMode.Callback callback, TextView textView) {
            this.f5538OooO00o = callback;
            this.f5539OooO0O0 = textView;
        }

        @Override // android.view.ActionMode.Callback
        public final boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            return this.f5538OooO00o.onActionItemClicked(actionMode, menuItem);
        }

        @Override // android.view.ActionMode.Callback
        public final boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            return this.f5538OooO00o.onCreateActionMode(actionMode, menu);
        }

        @Override // android.view.ActionMode.Callback
        public final void onDestroyActionMode(ActionMode actionMode) {
            this.f5538OooO00o.onDestroyActionMode(actionMode);
        }
        ...
        public final boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
            boolean z;
            String str;
            TextView textView = this.f5539OooO0O0;
            Context context = textView.getContext();
            PackageManager packageManager = context.getPackageManager();
            if (!this.f5542OooO0o) {
                this.f5542OooO0o = true;
                try {
                    Class<?> cls = Class.forName("com.android.internal.view.menu.MenuBuilder");
                    this.f5540OooO0OO = cls;
                    this.f5541OooO0Oo = cls.getDeclaredMethod("removeItemAt", Integer.TYPE);
                    this.f5543OooO0o0 = true;
                } catch (ClassNotFoundException | NoSuchMethodException unused) {
                    this.f5540OooO0OO = null;
                    this.f5541OooO0Oo = null;
                    this.f5543OooO0o0 = false;
                }
            }
            try {
                Method declaredMethod = (this.f5543OooO0o0 && this.f5540OooO0OO.isInstance(menu)) ? this.f5541OooO0Oo : menu.getClass().getDeclaredMethod("removeItemAt", Integer.TYPE);
            ...
            return this.f5538OooO00o.onPrepareActionMode(actionMode, menu);
        }
    }
    ...
    public static ActionMode.Callback OooO0o0(@Nullable ActionMode.Callback callback) {
        return (!(callback instanceof OooOO0) || Build.VERSION.SDK_INT < 26) ? callback : ((OooOO0) callback).f5538OooO00o;
    }
}
