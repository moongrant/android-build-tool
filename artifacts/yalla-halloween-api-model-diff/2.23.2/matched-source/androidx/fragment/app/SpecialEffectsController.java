...
public abstract class SpecialEffectsController {
    ...
    @NotNull
    public final ViewGroup f5946OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public final ArrayList f5947OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @NotNull
    public final ArrayList f5948OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public boolean f5949OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public boolean f5950OooO0o0;

    public static final class OooO00o extends Operation {

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        @NotNull
        public final o0000 f5951OooO0oo;
        ...
        public OooO00o(@NotNull Operation.State finalState, @NotNull Operation.LifecycleImpact lifecycleImpact, @NotNull o0000 fragmentStateManager, @NotNull p063o0000oO.o0OoOo0 cancellationSignal) {
            ...
            Fragment fragment = fragmentStateManager.f5966OooO0OO;
            Intrinsics.checkNotNullExpressionValue(fragment, "fragmentStateManager.fragment");
            super(finalState, lifecycleImpact, fragment, cancellationSignal);
            this.f5951OooO0oo = fragmentStateManager;
        }

        @Override // androidx.fragment.app.SpecialEffectsController.Operation
        public final void OooO0O0() {
            super.OooO0O0();
            this.f5951OooO0oo.OooOO0O();
        }

        @Override // androidx.fragment.app.SpecialEffectsController.Operation
        public final void OooO0Oo() {
            Operation.LifecycleImpact lifecycleImpact = this.f5953OooO0O0;
            Operation.LifecycleImpact lifecycleImpact2 = Operation.LifecycleImpact.ADDING;
            o0000 o0000Var = this.f5951OooO0oo;
            ...
            View viewRequireView2 = this.f5954OooO0OO.requireView();
    ...
    public static class Operation {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        @NotNull
        public State f5952OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        @NotNull
        public LifecycleImpact f5953OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        @NotNull
        public final Fragment f5954OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        @NotNull
        public final ArrayList f5955OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public boolean f5956OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        @NotNull
        public final LinkedHashSet f5957OooO0o0;
        ...
        public Operation(@NotNull State finalState, @NotNull LifecycleImpact lifecycleImpact, @NotNull Fragment fragment, @NotNull p063o0000oO.o0OoOo0 cancellationSignal) {
            ...
            Intrinsics.checkNotNullParameter(cancellationSignal, "cancellationSignal");
            this.f5952OooO00o = finalState;
            this.f5953OooO0O0 = lifecycleImpact;
            this.f5954OooO0OO = fragment;
            this.f5955OooO0Oo = new ArrayList();
            this.f5957OooO0o0 = new LinkedHashSet();
        ...
        public final void OooO00o() {
            ...
            this.f5956OooO0o = true;
            LinkedHashSet linkedHashSet = this.f5957OooO0o0;
        ...
        public void OooO0O0() {
            ...
            Iterator it = this.f5955OooO0Oo.iterator();
            while (it.hasNext()) {
        ...
        public final void OooO0OO(@NotNull State finalState, @NotNull LifecycleImpact lifecycleImpact) {
            ...
            Fragment fragment = this.f5954OooO0OO;
            if (i == 1) {
                if (this.f5952OooO00o == State.REMOVED) {
                    if (FragmentManager.Oooo0O0(2)) {
                        Log.v("FragmentManager", "SpecialEffectsController: For fragment " + fragment + " mFinalState = REMOVED -> VISIBLE. mLifecycleImpact = " + this.f5953OooO0O0 + " to ADDING.");
                    }
                    this.f5952OooO00o = State.VISIBLE;
                    this.f5953OooO0O0 = LifecycleImpact.ADDING;
                    return;
                }
                return;
            }
            if (i == 2) {
                if (FragmentManager.Oooo0O0(2)) {
                    Log.v("FragmentManager", "SpecialEffectsController: For fragment " + fragment + " mFinalState = " + this.f5952OooO00o + " -> REMOVED. mLifecycleImpact  = " + this.f5953OooO0O0 + " to REMOVING.");
                }
                this.f5952OooO00o = State.REMOVED;
                this.f5953OooO0O0 = LifecycleImpact.REMOVING;
                return;
            }
            if (i == 3 && this.f5952OooO00o != State.REMOVED) {
                if (FragmentManager.Oooo0O0(2)) {
                    Log.v("FragmentManager", "SpecialEffectsController: For fragment " + fragment + " mFinalState = " + this.f5952OooO00o + " -> " + finalState + '.');
                }
                this.f5952OooO00o = finalState;
            }
        }
        ...
        public final String toString() {
            ...
            sbOooO0O0.append(this.f5952OooO00o);
            sbOooO0O0.append(" lifecycleImpact = ");
            sbOooO0O0.append(this.f5953OooO0O0);
            sbOooO0O0.append(" fragment = ");
            sbOooO0O0.append(this.f5954OooO0OO);
            sbOooO0O0.append('}');
    ...
    public SpecialEffectsController(@NotNull ViewGroup container) {
        ...
        this.f5946OooO00o = container;
        this.f5947OooO0O0 = new ArrayList();
        this.f5948OooO0OO = new ArrayList();
    }
    ...
    public final void OooO() {
        ...
        synchronized (this.f5947OooO0O0) {
            OooOO0o();
            Iterator it = this.f5947OooO0O0.iterator();
            while (it.hasNext()) {
                ((Operation) it.next()).OooO0Oo();
            }
            for (Operation operation : CollectionsKt.toMutableList((Collection) this.f5948OooO0OO)) {
                if (FragmentManager.Oooo0O0(2)) {
                    Log.v("FragmentManager", "SpecialEffectsController: " + (zOooO0O0 ? "" : "Container " + this.f5946OooO00o + " is not attached to window. ") + "Cancelling running operation " + operation);
                }
                operation.OooO00o();
            }
            for (Operation operation2 : CollectionsKt.toMutableList((Collection) this.f5947OooO0O0)) {
                if (FragmentManager.Oooo0O0(2)) {
                    Log.v("FragmentManager", "SpecialEffectsController: " + (zOooO0O0 ? "" : "Container " + this.f5946OooO00o + " is not attached to window. ") + "Cancelling pending operation " + operation2);
                }
                operation2.OooO00o();
            }
    ...
    public final void OooO00o(Operation.State state, Operation.LifecycleImpact lifecycleImpact, o0000 o0000Var) {
        synchronized (this.f5947OooO0O0) {
            ...
            oooO00o.f5955OooO0Oo.add(listener);
            Runnable listener2 = new Runnable() { // from class: androidx.fragment.app.o000O0
                @Override // java.lang.Runnable
                public final void run() {
                    SpecialEffectsController this$0 = this.f6025OooO0Oo;
                    Intrinsics.checkNotNullParameter(this$0, "this$0");
                    SpecialEffectsController.OooO00o operation = oooO00o;
                    Intrinsics.checkNotNullParameter(operation, "$operation");
                    this$0.f5947OooO0O0.remove(operation);
                    this$0.f5948OooO0OO.remove(operation);
                }
            };
            Intrinsics.checkNotNullParameter(listener2, "listener");
            oooO00o.f5955OooO0Oo.add(listener2);
            Unit unit = Unit.INSTANCE;
        }
    }
    ...
    public final void OooO0O0(@NotNull Operation.State finalState, @NotNull o0000 fragmentStateManager) {
        ...
        Intrinsics.checkNotNullParameter(fragmentStateManager, "fragmentStateManager");
        if (FragmentManager.Oooo0O0(2)) {
            Log.v("FragmentManager", "SpecialEffectsController: Enqueuing add operation for fragment " + fragmentStateManager.f5966OooO0OO);
        }
    ...
    public final void OooO0OO(@NotNull o0000 fragmentStateManager) {
        Intrinsics.checkNotNullParameter(fragmentStateManager, "fragmentStateManager");
        if (FragmentManager.Oooo0O0(2)) {
            Log.v("FragmentManager", "SpecialEffectsController: Enqueuing hide operation for fragment " + fragmentStateManager.f5966OooO0OO);
        }
    ...
    public final void OooO0Oo(@NotNull o0000 fragmentStateManager) {
        Intrinsics.checkNotNullParameter(fragmentStateManager, "fragmentStateManager");
        if (FragmentManager.Oooo0O0(2)) {
            Log.v("FragmentManager", "SpecialEffectsController: Enqueuing remove operation for fragment " + fragmentStateManager.f5966OooO0OO);
        }
    ...
    public final void OooO0o0(@NotNull o0000 fragmentStateManager) {
        Intrinsics.checkNotNullParameter(fragmentStateManager, "fragmentStateManager");
        if (FragmentManager.Oooo0O0(2)) {
            Log.v("FragmentManager", "SpecialEffectsController: Enqueuing show operation for fragment " + fragmentStateManager.f5966OooO0OO);
        }
        OooO00o(Operation.State.VISIBLE, Operation.LifecycleImpact.NONE, fragmentStateManager);
    }

    public final void OooO0oO() {
        if (this.f5950OooO0o0) {
            return;
        }
        ViewGroup viewGroup = this.f5946OooO00o;
        WeakHashMap<View, o000OOo0> weakHashMap = ViewCompat.f5341OooO00o;
        if (!ViewCompat.OooOO0O.OooO0O0(viewGroup)) {
            OooO();
            this.f5949OooO0Oo = false;
            return;
        }
        synchronized (this.f5947OooO0O0) {
            if (!this.f5947OooO0O0.isEmpty()) {
                List<Operation> mutableList = CollectionsKt.toMutableList((Collection) this.f5948OooO0OO);
                this.f5948OooO0OO.clear();
                for (Operation operation : mutableList) {
                    if (FragmentManager.Oooo0O0(2)) {
                        Log.v("FragmentManager", "SpecialEffectsController: Cancelling operation " + operation);
                    }
                    operation.OooO00o();
                    if (!operation.f5958OooO0oO) {
                        this.f5948OooO0OO.add(operation);
                    }
                }
                OooOO0o();
                List<Operation> mutableList2 = CollectionsKt.toMutableList((Collection) this.f5947OooO0O0);
                this.f5947OooO0O0.clear();
                this.f5948OooO0OO.addAll(mutableList2);
                if (FragmentManager.Oooo0O0(2)) {
                ...
                OooO0o(mutableList2, this.f5949OooO0Oo);
                this.f5949OooO0Oo = false;
                if (FragmentManager.Oooo0O0(2)) {
    ...
    public final Operation OooO0oo(Fragment fragment) {
        ...
        while (it.hasNext()) {
            ...
            if (Intrinsics.areEqual(operation.f5954OooO0OO, fragment) && !operation.f5956OooO0o) {
    ...
    public final void OooOO0O() {
        ...
        synchronized (this.f5947OooO0O0) {
            OooOO0o();
            ArrayList arrayList = this.f5947OooO0O0;
            ...
            do {
                ...
                state = operation.f5952OooO00o;
                state2 = Operation.State.VISIBLE;
            } while (!(state == state2 && stateOooO00o != state2));
            Operation operation2 = (Operation) objPrevious;
            Fragment fragment = operation2 != null ? operation2.f5954OooO0OO : null;
            this.f5950OooO0o0 = fragment != null ? fragment.isPostponed() : false;
            Unit unit = Unit.INSTANCE;
        }
    }

    public final void OooOO0o() {
        for (Operation operation : this.f5947OooO0O0) {
            if (operation.f5953OooO0O0 == Operation.LifecycleImpact.ADDING) {
                View viewRequireView = operation.f5954OooO0OO.requireView();
                Intrinsics.checkNotNullExpressionValue(viewRequireView, "fragment.requireView()");
                Operation.State.Companion companion = Operation.State.INSTANCE;
