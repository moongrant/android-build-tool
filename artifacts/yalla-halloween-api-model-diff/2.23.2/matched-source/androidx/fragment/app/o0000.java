...
public final class o0000 {
    ...
    public final oo0o0Oo f5964OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final o0000O00 f5965OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @NonNull
    public final Fragment f5966OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public boolean f5967OooO0Oo = false;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public int f5968OooO0o0 = -1;

    public class OooO00o implements View.OnAttachStateChangeListener {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ View f5969OooO0Oo;

        public OooO00o(View view) {
            this.f5969OooO0Oo = view;
        }

        @Override // android.view.View.OnAttachStateChangeListener
        public final void onViewAttachedToWindow(View view) {
            View view2 = this.f5969OooO0Oo;
    ...
    public static /* synthetic */ class OooO0O0 {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public static final /* synthetic */ int[] f5970OooO00o;
        ...
        static {
            ...
            try {
                f5970OooO00o[Lifecycle.State.STARTED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f5970OooO00o[Lifecycle.State.CREATED.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f5970OooO00o[Lifecycle.State.INITIALIZED.ordinal()] = 4;
    ...
    public o0000(@NonNull oo0o0Oo oo0o0oo, @NonNull o0000O00 o0000o00, @NonNull Fragment fragment) {
        this.f5964OooO00o = oo0o0oo;
        this.f5965OooO0O0 = o0000o00;
        this.f5966OooO0OO = fragment;
    }

    public final void OooO() {
        boolean zOooo0O0 = FragmentManager.Oooo0O0(3);
        Fragment fragment = this.f5966OooO0OO;
        if (zOooo0O0) {
            Log.d("FragmentManager", "movefrom ATTACHED: " + fragment);
        }
        fragment.performDetach();
        boolean z = false;
        this.f5964OooO00o.OooO0o0(fragment, false);
        fragment.mState = -1;
        fragment.mHost = null;
        ...
        if (!z) {
            o00000O o00000o = this.f5965OooO0O0.f5993OooO0Oo;
            if (o00000o.f5975OooO00o.containsKey(fragment.mWho) && o00000o.f5978OooO0Oo) {
                z2 = o00000o.f5980OooO0o0;
            }
            if (!z2) {
                return;
            }
    ...
    public final void OooO00o() {
        ...
        this.f5964OooO00o.OooO00o(fragment, bundle2, false);
    }
    ...
    public final void OooO0O0() {
        ...
        if (expectedParentFragment != null && !expectedParentFragment.equals(parentFragment)) {
            ...
            if (OooO00o2.f6071OooO00o.contains(FragmentStrictMode.Flag.DETECT_WRONG_NESTED_HIERARCHY) && FragmentStrictMode.OooO0o0(OooO00o2, fragment.getClass(), WrongNestedHierarchyViolation.class)) {
                FragmentStrictMode.OooO0O0(OooO00o2, wrongNestedHierarchyViolation);
            }
        }
        o0000O00 o0000o00 = this.f5965OooO0O0;
        o0000o00.getClass();
    ...
    public final void OooO0OO() {
        ...
        o0000O00 o0000o00 = this.f5965OooO0O0;
        if (fragment2 != null) {
            o0000 o0000Var2 = o0000o00.f5991OooO0O0.get(fragment2.mWho);
            if (o0000Var2 == null) {
            ...
            if (str != null && (o0000Var = o0000o00.f5991OooO0O0.get(str)) == null) {
                StringBuilder sb = new StringBuilder("Fragment ");
                sb.append(fragment);
                sb.append(" declared target fragment ");
                throw new IllegalStateException(o0oOO.OooO0O0(sb, fragment.mTargetWho, " that does not belong to this FragmentManager!"));
            }
        }
        if (o0000Var != null) {
            o0000Var.OooOO0O();
        ...
        fragment.mHost = fragmentManager.f5836OooOo0;
        fragment.mParentFragment = fragmentManager.f5839OooOo0o;
        oo0o0Oo oo0o0oo = this.f5964OooO00o;
    ...
    public final int OooO0Oo() {
        ...
        int iMin = this.f5968OooO0o0;
        int i = OooO0O0.f5970OooO00o[fragment.mMaxState.ordinal()];
        if (i != 1) {
            if (i == 2) {
        ...
        if (fragment.mFromLayout) {
            if (fragment.mInLayout) {
                iMin = Math.max(this.f5968OooO0o0, 2);
                View view = fragment.mView;
                if (view != null && view.getParent() == null) {
                    iMin = Math.min(iMin, 2);
                }
            } else {
                iMin = this.f5968OooO0o0 < 4 ? Math.min(iMin, fragment.mState) : Math.min(iMin, 1);
            }
        }
        if (!fragment.mAdded) {
            iMin = Math.min(iMin, 1);
        ...
        if (viewGroup != null) {
            ...
            SpecialEffectsController.Operation.LifecycleImpact lifecycleImpact2 = operationOooO0oo != null ? operationOooO0oo.f5953OooO0O0 : null;
            Iterator it = specialEffectsControllerOooOO0.f5948OooO0OO.iterator();
            do {
                if (!it.hasNext()) {
                    next = null;
                    break;
            ...
            } while (!(Intrinsics.areEqual(operation.f5954OooO0OO, fragment) && !operation.f5956OooO0o));
            SpecialEffectsController.Operation operation2 = (SpecialEffectsController.Operation) next;
            lifecycleImpact = operation2 != null ? operation2.f5953OooO0O0 : null;
    ...
    public final void OooO0o() {
        ...
        if (viewGroup != null) {
            ...
            if (i != 0) {
                if (i == -1) {
                    throw new IllegalArgumentException(androidx.compose.animation.o00O0O.OooO0O0("Cannot create fragment ", fragment, " for a container view with no id"));
                }
                container = (ViewGroup) fragment.mFragmentManager.f5838OooOo0O.OooO0O0(i);
                if (container == null) {
                    ...
                    FragmentStrictMode.OooO00o OooO00o2 = FragmentStrictMode.OooO00o(fragment);
                    if (OooO00o2.f6071OooO00o.contains(FragmentStrictMode.Flag.DETECT_WRONG_FRAGMENT_CONTAINER) && FragmentStrictMode.OooO0o0(OooO00o2, fragment.getClass(), WrongFragmentContainerViolation.class)) {
        ...
        if (fragment.mView != null) {
            ...
            this.f5964OooO00o.OooOOO0(fragment, fragment.mView, bundle2, false);
    ...
    public final void OooO0oO() {
        ...
        if (z2) {
            ...
            if ((o00000o.f5975OooO00o.containsKey(fragment.mWho) && o00000o.f5978OooO0Oo) ? o00000o.f5980OooO0o0 : true) {
                z = true;
            } else {
                z = false;
            }
        ...
        if ((z2 && !fragment.mBeingSaved) || zIsChangingConfigurations) {
            o0000o00.f5993OooO0Oo.OooO0OO(fragment);
        }
        fragment.performDestroy();
        this.f5964OooO00o.OooO0Oo(fragment, false);
    ...
    public final void OooO0oo() {
        ...
        this.f5964OooO00o.OooOOO(fragment, false);
                ...
                if (iOooO0Oo == i) {
                    ...
                    if (fragment.mHiddenChanged) {
                        ...
                        if (fragmentManager != null && fragment.mAdded && FragmentManager.Oooo0OO(fragment)) {
                            fragmentManager.f5846OooOooo = true;
                        }
                    ...
                    switch (i - 1) {
                        ...
                        case 0:
                            if (fragment.mBeingSaved) {
                                if (o0000o00.f5992OooO0OO.get(fragment.mWho) == null) {
    ...
    public final void OooOO0o(@NonNull ClassLoader classLoader) {
        ...
        if (fragmentState != null) {
            fragment.mTargetWho = fragmentState.f5888OooOOOO;
            fragment.mTargetRequestCode = fragmentState.f5889OooOOOo;
            Boolean bool = fragment.mSavedUserVisibleHint;
            if (bool != null) {
                fragment.mUserVisibleHint = bool.booleanValue();
                fragment.mSavedUserVisibleHint = null;
            } else {
                fragment.mUserVisibleHint = fragmentState.f5890OooOOo0;
            }
        }
    ...
    public final Bundle OooOOO() {
        ...
        if (fragment.mState > -1) {
            ...
            this.f5964OooO00o.OooOO0(fragment, bundle3, false);
    ...
    public final void OooOOO0() {
        ...
        this.f5964OooO00o.OooO(fragment, false);
        this.f5965OooO0O0.OooO(null, fragment.mWho);
    ...
    public final void OooOOOO() {
        ...
        fragment.mViewLifecycleOwner.f6032OooO.OooO0OO(bundle);
        if (bundle.isEmpty()) {
            return;
        }
    ...
    public o0000(@NonNull oo0o0Oo oo0o0oo, @NonNull o0000O00 o0000o00, @NonNull ClassLoader classLoader, @NonNull o0OOO0o o0ooo0o2, @NonNull Bundle bundle) {
        ...
        Fragment fragmentInstantiate = Fragment.instantiate(FragmentManager.this.f5836OooOo0.f6054OooO0o0, fragmentState.f5878OooO0Oo, null);
        fragmentInstantiate.mWho = fragmentState.f5880OooO0o0;
        fragmentInstantiate.mFromLayout = fragmentState.f5879OooO0o;
        fragmentInstantiate.mRestored = true;
        fragmentInstantiate.mFragmentId = fragmentState.f5881OooO0oO;
        fragmentInstantiate.mContainerId = fragmentState.f5882OooO0oo;
        fragmentInstantiate.mTag = fragmentState.f5877OooO;
        fragmentInstantiate.mRetainInstance = fragmentState.f5883OooOO0;
        fragmentInstantiate.mRemoving = fragmentState.f5884OooOO0O;
        fragmentInstantiate.mDetached = fragmentState.f5885OooOO0o;
        fragmentInstantiate.mHidden = fragmentState.f5887OooOOO0;
        fragmentInstantiate.mMaxState = Lifecycle.State.values()[fragmentState.f5886OooOOO];
        fragmentInstantiate.mTargetWho = fragmentState.f5888OooOOOO;
        fragmentInstantiate.mTargetRequestCode = fragmentState.f5889OooOOOo;
        fragmentInstantiate.mUserVisibleHint = fragmentState.f5890OooOOo0;
        this.f5966OooO0OO = fragmentInstantiate;
