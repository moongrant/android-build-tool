...
public final class MediaCodecUtil {
    ...
    public static final Pattern f7732OooO00o = Pattern.compile("^\\D?(\\d+)$");

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @GuardedBy("MediaCodecUtil.class")
    public static final HashMap<OooO00o, List<androidx.media3.exoplayer.mediacodec.OooO0o>> f7733OooO0O0 = new HashMap<>();

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static int f7734OooO0OO = -1;
    ...
    public static final class OooO00o {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final String f7735OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final boolean f7736OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final boolean f7737OooO0OO;

        public OooO00o(String str, boolean z, boolean z2) {
            this.f7735OooO00o = str;
            this.f7736OooO0O0 = z;
            this.f7737OooO0OO = z2;
        }
        ...
        public final boolean equals(@Nullable Object obj) {
            ...
            return TextUtils.equals(this.f7735OooO00o, oooO00o.f7735OooO00o) && this.f7736OooO0O0 == oooO00o.f7736OooO0O0 && this.f7737OooO0OO == oooO00o.f7737OooO0OO;
        }

        public final int hashCode() {
            return ((androidx.compose.animation.OooO0O0.OooO00o(this.f7735OooO00o, 31, 31) + (this.f7736OooO0O0 ? 1231 : 1237)) * 31) + (this.f7737OooO0OO ? 1231 : 1237);
        }
    }
    ...
    public static final class OooO0o implements OooO0O0 {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final int f7738OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        @Nullable
        public MediaCodecInfo[] f7739OooO0O0;

        public OooO0o(boolean z, boolean z2) {
            this.f7738OooO00o = (z || z2) ? 1 : 0;
        }

        @Override // androidx.media3.exoplayer.mediacodec.MediaCodecUtil.OooO0O0
        public final MediaCodecInfo OooO00o(int i) {
            if (this.f7739OooO0O0 == null) {
                this.f7739OooO0O0 = new MediaCodecList(this.f7738OooO00o).getCodecInfos();
            }
            return this.f7739OooO0O0[i];
        }
        ...
        public final int OooO0Oo() {
            ...
            return this.f7739OooO0O0.length;
        }
    ...
    public static int OooO() throws DecoderQueryException {
        ...
        if (f7734OooO0OO == -1) {
            ...
            if (oooO0o != null) {
                ...
                iMax = Math.max(iMax2, o00.f34910OooO00o >= 21 ? 345600 : 172800);
            }
            f7734OooO0OO = iMax;
        }
        return f7734OooO0OO;
    ...
    public static void OooO00o(String str, ArrayList arrayList) {
        if ("audio/raw".equals(str)) {
            if (o00.f34910OooO00o < 26 && o00.f34911OooO0O0.equals("R9") && arrayList.size() == 1 && ((androidx.media3.exoplayer.mediacodec.OooO0o) arrayList.get(0)).f7754OooO00o.equals("OMX.MTK.AUDIO.DECODER.RAW")) {
        ...
        if (i < 21 && arrayList.size() > 1) {
            String str2 = ((androidx.media3.exoplayer.mediacodec.OooO0o) arrayList.get(0)).f7754OooO00o;
            if ("OMX.SEC.mp3.dec".equals(str2) || "OMX.SEC.MP3.Decoder".equals(str2) || "OMX.brcm.audio.mp3.decoder".equals(str2)) {
                Collections.sort(arrayList, new o0OoOo0(new o00000()));
            }
        }
        if (i >= 32 || arrayList.size() <= 1 || !"OMX.qti.audio.decoder.flac".equals(((androidx.media3.exoplayer.mediacodec.OooO0o) arrayList.get(0)).f7754OooO00o)) {
            return;
        }
    ...
    public static String OooO0O0(androidx.media3.common.OooOO0 oooOO1) {
        ...
        if ("audio/eac3-joc".equals(oooOO1.f6412OooOOOO)) {
            return "audio/eac3";
        }
        if (!"video/dolby-vision".equals(oooOO1.f6412OooOOOO) || (pairOooO0Oo = OooO0Oo(oooOO1)) == null) {
            return null;
        }
    ...
    public static Pair<Integer, Integer> OooO0Oo(androidx.media3.common.OooOO0 oooOO1) {
        ...
        Integer numValueOf2;
        Integer numValueOf3;
        String str = oooOO1.f6409OooOO0o;
        if (str == null) {
            return null;
        }
        ...
        if (zEquals) {
            if (strArrSplit.length < 3) {
                o000Oo0.o0OoOo0.OooO0O0("Ignoring malformed Dolby Vision codec string: ", str2, "MediaCodecUtil");
            } else {
                Matcher matcher = f7732OooO00o.matcher(strArrSplit[1]);
                if (matcher.matches()) {
                    ...
                    if (numValueOf2 == null) {
                        o000Oo0.o0OoOo0.OooO0O0("Unknown Dolby Vision profile string: ", strGroup, "MediaCodecUtil");
                    } else {
                        ...
                        o000Oo0.o0OoOo0.OooO0O0("Unknown Dolby Vision level string: ", str3, "MediaCodecUtil");
                    }
                } else {
                    o000Oo0.o0OoOo0.OooO0O0("Ignoring malformed Dolby Vision codec string: ", str2, "MediaCodecUtil");
                }
        ...
        switch (str4) {
            case "av01":
                if (strArrSplit.length < 4) {
                    o000Oo0.o0OoOo0.OooO0O0("Ignoring malformed AV1 codec string: ", str2, "MediaCodecUtil");
                } else {
                    try {
                        ...
                        if (i16 != 0) {
                            Oooo000.OooO00o("Unknown AV1 profile: ", i16, "MediaCodecUtil");
                        } else if (i18 == 8 || i18 == 10) {
                            if (i18 == 8) {
                                i = 1;
                            } else {
                                androidx.media3.common.OooO0o oooO0o = oooOO1.f6424OooOoOO;
                                i = (oooO0o == null || !(oooO0o.f6365OooO0oO != null || (i2 = oooO0o.f6363OooO0o) == 7 || i2 == 6)) ? 2 : 4096;
                            }
                            switch (i17) {
                                case 0:
                                    i3 = -1;
                            ...
                            Oooo000.OooO00o("Unknown AV1 level: ", i17, "MediaCodecUtil");
                        } else {
                            Oooo000.OooO00o("Unknown AV1 bit depth: ", i18, "MediaCodecUtil");
                        }
            ...
            case "avc2":
                if (strArrSplit.length < 2) {
                    o000Oo0.o0OoOo0.OooO0O0("Ignoring malformed AVC codec string: ", str2, "MediaCodecUtil");
                } else {
                    try {
                        ...
                        if (i7 == -1) {
                            Oooo000.OooO00o("Unknown AVC profile: ", i5, "MediaCodecUtil");
                        } else {
                            switch (i6) {
                                case 10:
                                    i14 = 1;
                            ...
                            Oooo000.OooO00o("Unknown AVC level: ", i6, "MediaCodecUtil");
                        }
            ...
            case "hvc1":
                if (strArrSplit.length < 4) {
                    o000Oo0.o0OoOo0.OooO0O0("Ignoring malformed HEVC codec string: ", str2, "MediaCodecUtil");
                } else {
                    Matcher matcher2 = f7732OooO00o.matcher(strArrSplit[1]);
                    if (matcher2.matches()) {
                        ...
                        if ("1".equals(strGroup2)) {
                            ...
                            i9 = (oooO0o2 == null || oooO0o2.f6363OooO0o != 6) ? 2 : 4096;
                        } else {
                            o000Oo0.o0OoOo0.OooO0O0("Unknown HEVC profile string: ", strGroup2, "MediaCodecUtil");
                        }
                        ...
                        o000Oo0.o0OoOo0.OooO0O0("Unknown HEVC level string: ", str5, "MediaCodecUtil");
                    } else {
                        o000Oo0.o0OoOo0.OooO0O0("Ignoring malformed HEVC codec string: ", str2, "MediaCodecUtil");
                    }
                }
            ...
            case "mp4a":
                if (strArrSplit.length != 3) {
                    o000Oo0.o0OoOo0.OooO0O0("Ignoring malformed MP4A codec string: ", str2, "MediaCodecUtil");
                } else {
                    try {
                        if ("audio/mp4a-latm".equals(o0000oo.OooO0Oo(Integer.parseInt(strArrSplit[1], 16)))) {
            ...
            case "vp09":
                if (strArrSplit.length < 3) {
                    o000Oo0.o0OoOo0.OooO0O0("Ignoring malformed VP9 codec string: ", str2, "MediaCodecUtil");
                } else {
                    try {
                        ...
                        if (i12 == -1) {
                            Oooo000.OooO00o("Unknown VP9 profile: ", i21, "MediaCodecUtil");
                        } else {
                            if (i22 == 10) {
                                i14 = 1;
                            } else if (i22 == 11) {
                                ...
                                Oooo000.OooO00o("Unknown VP9 level: ", i22, "MediaCodecUtil");
                            } else {
                                i14 = 256;
                            }
                            i13 = -1;
    ...
    public static ArrayList<androidx.media3.exoplayer.mediacodec.OooO0o> OooO0o(OooO00o oooO00o, OooO0O0 oooO0O0) throws DecoderQueryException {
        ...
        try {
            ...
            String str3 = oooO00o2.f7735OooO00o;
                ...
                if (!(i3 >= 29 && mediaCodecInfoOooO00o.isAlias())) {
                    ...
                    if (OooO0oO(mediaCodecInfoOooO00o, name, zOooO0o0, str3) && (strOooO0OO = OooO0OO(mediaCodecInfoOooO00o, name, str3)) != null) {
                        try {
                            ...
                            boolean z3 = oooO00o2.f7737OooO0OO;
                            if ((z3 || !zOooO0OO) && (!z3 || zOooO0O0)) {
                                ...
                                boolean z4 = oooO00o2.f7736OooO0O0;
                                if ((z4 || !zOooO0OO2) && (!z4 || zOooO0O1)) {
                                    ...
                                    if (!(zOooO0o0 && z4 == zOooO0O1) && (zOooO0o0 || z4)) {
                                        ...
                                        try {
                                            ...
                                            e = e2;
                                            str2 = name;
                                            if (o00.f34910OooO00o <= 23 || arrayList.isEmpty()) {
                                                Log.OooO0OO("MediaCodecUtil", "Failed to query codec " + str2 + " (" + str + ")");
                                                throw e;
                                            }
    ...
    public static synchronized List<androidx.media3.exoplayer.mediacodec.OooO0o> OooO0o0(String str, boolean z, boolean z2) throws DecoderQueryException {
        ...
        HashMap<OooO00o, List<androidx.media3.exoplayer.mediacodec.OooO0o>> map = f7733OooO0O0;
        ...
        if (z && arrayListOooO0o.isEmpty() && 21 <= i && i <= 23) {
            ...
            if (!arrayListOooO0o.isEmpty()) {
                Log.OooO0o("MediaCodecUtil", "MediaCodecList API didn't list secure decoder for: " + str + ". Assuming: " + arrayListOooO0o.get(0).f7754OooO00o);
            }
        }
    ...
    public static boolean OooO0oO(MediaCodecInfo mediaCodecInfo, String str, boolean z, String str2) {
        ...
        if (i < 18 && "OMX.MTK.AUDIO.DECODER.AAC".equals(str)) {
            ...
            if ("a70".equals(str3) || ("Xiaomi".equals(o00.f34912OooO0OO) && str3.startsWith("HM"))) {
                return false;
            }
        }
        if (i == 16 && "OMX.qcom.audio.decoder.mp3".equals(str)) {
            String str4 = o00.f34911OooO0O0;
            if ("dlxu".equals(str4) || "protou".equals(str4) || "ville".equals(str4) || "villeplus".equals(str4) || "villec2".equals(str4) || str4.startsWith("gee") || "C6602".equals(str4) || "C6603".equals(str4) || "C6606".equals(str4) || "C6616".equals(str4) || "L36h".equals(str4) || "SO-02E".equals(str4)) {
                return false;
            }
        }
        if (i == 16 && "OMX.qcom.audio.decoder.aac".equals(str)) {
            String str5 = o00.f34911OooO0O0;
            if ("C1504".equals(str5) || "C1505".equals(str5) || "C1604".equals(str5) || "C1605".equals(str5)) {
                return false;
            }
        }
        if (i < 24 && (("OMX.SEC.aac.dec".equals(str) || "OMX.Exynos.AAC.Decoder".equals(str)) && "samsung".equals(o00.f34912OooO0OO))) {
            String str6 = o00.f34911OooO0O0;
            if (str6.startsWith("zeroflte") || str6.startsWith("zerolte") || str6.startsWith("zenlte") || "SC-05G".equals(str6) || "marinelteatt".equals(str6) || "404SC".equals(str6) || "SC-04G".equals(str6) || "SCV31".equals(str6)) {
                return false;
            }
        }
        if (i <= 19 && "OMX.SEC.vp8.dec".equals(str) && "samsung".equals(o00.f34912OooO0OO)) {
            String str7 = o00.f34911OooO0O0;
            if (str7.startsWith("d2") || str7.startsWith("serrano") || str7.startsWith("jflte") || str7.startsWith("santos") || str7.startsWith("t0")) {
                return false;
            }
        }
        if (i <= 19 && o00.f34911OooO0O0.startsWith("jflte") && "OMX.qcom.video.decoder.vp8".equals(str)) {
            return false;
        }
