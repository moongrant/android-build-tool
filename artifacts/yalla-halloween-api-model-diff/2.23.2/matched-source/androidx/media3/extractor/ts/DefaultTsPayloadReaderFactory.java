...
public final class DefaultTsPayloadReaderFactory implements TsPayloadReader.OooO0OO {
    ...
    public final int f8875OooO00o = 0;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final List<androidx.media3.common.OooOO0> f8876OooO0O0;
    ...
    public DefaultTsPayloadReaderFactory(ImmutableList immutableList) {
        this.f8876OooO0O0 = immutableList;
    }
    ...
    public final TsPayloadReader OooO00o(int i, TsPayloadReader.OooO0O0 oooO0O0) {
        if (i != 2) {
            String str = oooO0O0.f9123OooO00o;
            if (i == 3 || i == 4) {
            ...
            if (i == 89) {
                return new o00O0O(new OooOO0O(oooO0O0.f9124OooO0O0));
            }
            if (i != 138) {
                if (i == 172) {
    ...
    public final List<androidx.media3.common.OooOO0> OooO0O0(TsPayloadReader.OooO0O0 oooO0O0) {
        ...
        List<androidx.media3.common.OooOO0> list = this.f8876OooO0O0;
        if (zOooO0OO) {
            return list;
        }
        o000O000 o000o001 = new o000O000(oooO0O0.f9125OooO0OO);
        while (o000o001.f34964OooO0OO - o000o001.f34963OooO0O0 > 0) {
            ...
            if (iOooOo0O == 134) {
                ...
                int iOooOo0O3 = o000o001.OooOo0O() & 31;
                for (int i2 = 0; i2 < iOooOo0O3; i2++) {
                    String strOooOOoo = o000o001.OooOOoo(3);
                    ...
                    oooO00o.f6438OooO0OO = strOooOOoo;
                    oooO00o.f6462OooOoo = i;
                    oooO00o.f6448OooOOO0 = listSingletonList;
                    arrayList.add(new androidx.media3.common.OooOO0(oooO00o));
                }
                list = arrayList;
            }
            o000o001.Oooo00O(iOooOo0O2);
        }
        return list;
    }

    public final boolean OooO0OO(int i) {
        return (i & this.f8875OooO00o) != 0;
    }
}
