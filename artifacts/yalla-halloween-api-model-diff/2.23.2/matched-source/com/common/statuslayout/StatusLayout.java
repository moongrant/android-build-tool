...
public class StatusLayout extends FrameLayout {
    ...
    public static final class OooO00o extends AnimatorListenerAdapter {
        ...
        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ View f13578OooO0o0;

        public OooO00o(View view) {
            this.f13578OooO0o0 = view;
        }

        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        public final void onAnimationEnd(@Nullable Animator animator) {
            View contentView = StatusLayout.this.getContentView();
            View view = this.f13578OooO0o0;
    ...
    public static final class OooO0O0 extends AnimatorListenerAdapter {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ View f13579OooO0Oo;

        public OooO0O0(View view) {
            this.f13579OooO0Oo = view;
        }

        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        public final void onAnimationStart(@Nullable Animator animator) {
            this.f13579OooO0Oo.setVisibility(0);
        }
    }
    ...
    public final void OooO(State state) {
        View contentView;
        if (this.f13573OooO0o0 == state) {
            return;
        }
        int i = OooO0o.$EnumSwitchMapping$1[state.ordinal()];
        ArrayList arrayList = this.f13571OooO0Oo;
        if (i == 1) {
        ...
        this.f13573OooO0o0 = state;
    }

    public final void OooO0O0(State state) {
        View contentView;
        State state2 = this.f13573OooO0o0;
        if (state2 == state) {
            return;
        }
    ...
    public StatusLayout(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.f13571OooO0Oo = new ArrayList();
        this.f13573OooO0o0 = State.Content;
        this.duration = 300L;
