...
public final class ExoPlayerImpl extends OooO00o {
    ...
    public static final class C08701 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public C08701(Continuation<? super C08701> continuation) {
            super(2, continuation);
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return ExoPlayerImpl.this.new C08701(continuation);
        }
        ...
        @Nullable
        public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C08701) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public static final class C08711 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        int label;

        public C08711(Continuation<? super C08711> continuation) {
            super(2, continuation);
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return ExoPlayerImpl.this.new C08711(continuation);
        }
    ...
    public static final class C08721 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public C08721(int i, Continuation<? super C08721> continuation) {
            super(2, continuation);
            this.$volume = i;
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return ExoPlayerImpl.this.new C08721(this.$volume, continuation);
        }
    ...
    public static final class C08731 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C08731(Surface surface, Continuation<? super C08731> continuation) {
            super(2, continuation);
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return ExoPlayerImpl.this.new C08731(this.$surface, continuation);
        }
    ...
    public static final class C08741 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C08741(float f, Continuation<? super C08741> continuation) {
            super(2, continuation);
            this.$volume = f;
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return ExoPlayerImpl.this.new C08741(this.$volume, continuation);
        }
    ...
    public ExoPlayerImpl(@NotNull Context context) {
        ...
        this.exoPlayerListener = new Player.OooO0OO() { // from class: com.common.support.roomgiftplayer.player.ExoPlayerImpl$exoPlayerListener$1
            ...
            public void onRenderedFirstFrame() {
                OooO0OO.InterfaceC0448OooO0OO firstFrameListener = this.this$0.getFirstFrameListener();
            ...
            public void onVideoSizeChanged(@NotNull o00Ooo videoSize) {
                ...
                this.this$0.currVideoWidth = videoSize.f6869OooO0Oo;
                this.this$0.currVideoHeight = videoSize.f6871OooO0o0;
            }
    ...
    @Override // o0OOO0OO.OooO0OO
    public void release() {
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), null, null, new C08701(null), 3, null);
    }

    @Override // o0OOO0OO.OooO0OO
    public void reset() {
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), null, null, new C08711(null), 3, null);
    }

    public final void setAudioStreamType(int usage, boolean handleAudioFocus) {
        OooO oooO = (OooO) this.exoPlayer;
        oooO.o00000();
        androidx.media3.common.OooO00o oooO00o = oooO.f7169OoooOOo;
        Intrinsics.checkNotNullExpressionValue(oooO00o, "getAudioAttributes(...)");
        final androidx.media3.common.OooO00o oooO00o2 = new androidx.media3.common.OooO00o(oooO00o.f6349OooO0Oo, oooO00o.f6351OooO0o0, usage, oooO00o.f6352OooO0oO, 0);
        Intrinsics.checkNotNullExpressionValue(oooO00o2, "build(...)");
        OooO oooO2 = (OooO) this.exoPlayer;
        oooO2.o00000();
        if (oooO2.f7175OooooO0) {
            return;
        }
        boolean zOooO00o = o00.OooO00o(oooO2.f7169OoooOOo, oooO00o2);
        int i = 1;
        o00000O0<Player.OooO0OO> o00000o1 = oooO2.f7132OooOO0o;
        if (!zOooO00o) {
            oooO2.f7169OoooOOo = oooO00o2;
            oooO2.o00oO0O(1, 3, oooO00o2);
            final int i2 = 0;
            o00000o1.OooO0OO(20, new o00000O0.OooO00o() { // from class: o000O00O.o000OOo
        ...
        AudioFocusManager audioFocusManager = oooO2.f7147OooOoOO;
        audioFocusManager.OooO0OO(oooO00o3);
        oooO2.f7129OooO0oo.OooO0o(oooO00o2);
    ...
    public void setDataSource(@NotNull String dataPath) {
        ...
        oooO0O0.f6520OooO0O0 = dataPath == null ? null : Uri.parse(dataPath);
    ...
    public final void setDeviceVolume(int volume) {
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), null, null, new C08721(volume, null), 3, null);
    }
    ...
    public void setSurface(@NotNull Surface surface) {
        ...
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), null, null, new C08731(surface, null), 3, null);
    }

    public final void setVolume(float volume) {
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), null, null, new C08741(volume, null), 3, null);
    }
