...
public final class AccessToken implements Parcelable {
    ...
    public static final class Companion {
        ...
        public final AccessToken createFromBundle(List<String> requestedPermissions, Bundle bundle, AccessTokenSource source, Date expirationBase, String applicationId) {
            ...
            return new AccessToken(string2, applicationId, string, requestedPermissions, null, null, source, bundleLongAsDate, new Date(), Utility.getBundleLongAsDate(bundle, AccessToken.DATA_ACCESS_EXPIRATION_TIME, new Date(0L)), null, LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY, null);
        }

        @NotNull
        public final AccessToken createExpired$facebook_core_release(@NotNull AccessToken current) {
            Intrinsics.checkNotNullParameter(current, "current");
            return new AccessToken(current.getToken(), current.getApplicationId(), current.getUserId(), current.getPermissions(), current.getDeclinedPermissions(), current.getExpiredPermissions(), current.getSource(), new Date(), new Date(), current.getDataAccessExpirationTime(), null, LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY, null);
        }
    ...
    public AccessToken(@NotNull String str, @NotNull String str2, @NotNull String str3, @Nullable Collection<String> collection, @Nullable Collection<String> collection2, @Nullable Collection<String> collection3, @Nullable AccessTokenSource accessTokenSource, @Nullable Date date, @Nullable Date date2, @Nullable Date date3) {
        this(str, str2, str3, collection, collection2, collection3, accessTokenSource, date, date2, date3, null, LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY, null);
        com.common.support.apm.netdetector.OooO00o.OooO00o(str, "accessToken", str2, "applicationId", str3, "userId");
    }
    ...
    public int hashCode() {
        int iHashCode = (this.dataAccessExpirationTime.hashCode() + androidx.compose.animation.OooO0O0.OooO00o(this.userId, androidx.compose.animation.OooO0O0.OooO00o(this.applicationId, (this.lastRefresh.hashCode() + ((this.source.hashCode() + androidx.compose.animation.OooO0O0.OooO00o(this.token, (this.expiredPermissions.hashCode() + ((this.declinedPermissions.hashCode() + ((this.permissions.hashCode() + ((this.expires.hashCode() + 527) * 31)) * 31)) * 31)) * 31, 31)) * 31)) * 31, 31), 31)) * 31;
        String str = this.graphDomain;
    ...
    public String toString() {
        StringBuilder sbOooO00o = o0o0Oo.OooO00o("{AccessToken token:");
        sbOooO00o.append(tokenToString());
        appendPermissions(sbOooO00o);
        sbOooO00o.append("}");
    ...
    public /* synthetic */ AccessToken(String str, String str2, String str3, Collection collection, Collection collection2, Collection collection3, AccessTokenSource accessTokenSource, Date date, Date date2, Date date3, String str4, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, str2, str3, collection, collection2, collection3, accessTokenSource, date, date2, date3, (i & LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) != 0 ? DEFAULT_GRAPH_DOMAIN : str4);
    }
