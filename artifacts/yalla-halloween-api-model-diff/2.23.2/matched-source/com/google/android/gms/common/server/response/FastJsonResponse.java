...
public abstract class FastJsonResponse {
    ...
    public static final void OooOO0O(StringBuilder sb, Field field, Object obj) {
        ...
        if (i == 11) {
            Class<? extends FastJsonResponse> cls = field.f14722OooOO0O;
    ...
    public final boolean OooO0O0(@NonNull Field field) {
        if (field.f14719OooO0oO != 11) {
            return isPrimitiveFieldSet(field.f14715OooO);
        }
        if (field.f14720OooO0oo) {
    ...
    public final <I, O> void OooOO0(Field<I, O> field, @Nullable I i) {
        ...
        switch (i2) {
            ...
            case 3:
            default:
                throw new IllegalStateException(android.support.v4.media.session.OooO0OO.OooO00o(44, "Unsupported type for conversion: ", i2));
            case 4:
                if (oZae != null) {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        public final String f14715OooO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        @SafeParcelable.VersionField(getter = "getVersionCode", id = 1)
        public final int f14716OooO0Oo;
        ...
        public final int f14718OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        @SafeParcelable.Field(getter = "getTypeOut", id = 4)
        public final int f14719OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        @SafeParcelable.Field(getter = "isTypeOutArray", id = 5)
        public final boolean f14720OooO0oo;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        @SafeParcelable.Field(getter = "getSafeParcelableFieldId", id = 7)
        public final int f14721OooOO0;

        /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
        @Nullable
        public final Class<? extends FastJsonResponse> f14722OooOO0O;

        /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
        @Nullable
        @SafeParcelable.Field(getter = "getConcreteTypeName", id = 8)
        public final String f14723OooOO0o;

        /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
        @Nullable
        @SafeParcelable.Field(getter = "getWrappedConverter", id = 9, type = "com.google.android.gms.common.server.converter.ConverterWrapper")
        public final FieldConverter<I, O> f14724OooOOO;

        /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
        public zan f14725OooOOO0;
        ...
        public Field(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) int i2, @SafeParcelable.Param(id = 3) boolean z, @SafeParcelable.Param(id = 4) int i3, @SafeParcelable.Param(id = 5) boolean z2, @SafeParcelable.Param(id = 6) String str, @SafeParcelable.Param(id = 7) int i4, @Nullable @SafeParcelable.Param(id = 8) String str2, @Nullable @SafeParcelable.Param(id = 9) zaa zaaVar) {
            this.f14716OooO0Oo = i;
            this.f14718OooO0o0 = i2;
            this.f14717OooO0o = z;
            this.f14719OooO0oO = i3;
            this.f14720OooO0oo = z2;
            this.f14715OooO = str;
            this.f14721OooOO0 = i4;
            if (str2 == null) {
                this.f14722OooOO0O = null;
                this.f14723OooOO0o = null;
            } else {
                this.f14722OooOO0O = SafeParcelResponse.class;
                this.f14723OooOO0o = str2;
            }
            if (zaaVar == null) {
                this.f14724OooOOO = null;
            } else {
                this.f14724OooOOO = (FieldConverter<I, O>) zaaVar.zab();
            }
        }
        ...
        public int getSafeParcelableFieldId() {
            return this.f14721OooOO0;
        }

        @NonNull
        public final String toString() {
            Objects.ToStringHelper toStringHelperAdd = Objects.toStringHelper(this).add("versionCode", Integer.valueOf(this.f14716OooO0Oo)).add("typeIn", Integer.valueOf(this.f14718OooO0o0)).add("typeInArray", Boolean.valueOf(this.f14717OooO0o)).add("typeOut", Integer.valueOf(this.f14719OooO0oO)).add("typeOutArray", Boolean.valueOf(this.f14720OooO0oo)).add("outputFieldName", this.f14715OooO).add("safeParcelFieldId", Integer.valueOf(this.f14721OooOO0));
            String str = this.f14723OooOO0o;
            if (str == null) {
                str = null;
            }
            Objects.ToStringHelper toStringHelperAdd2 = toStringHelperAdd.add("concreteTypeName", str);
            Class<? extends FastJsonResponse> cls = this.f14722OooOO0O;
            if (cls != null) {
                toStringHelperAdd2.add("concreteType.class", cls.getCanonicalName());
            }
            FieldConverter<I, O> fieldConverter = this.f14724OooOOO;
        ...
        public final void writeToParcel(@NonNull Parcel parcel, int i) {
            ...
            SafeParcelWriter.writeInt(parcel, 1, this.f14716OooO0Oo);
            SafeParcelWriter.writeInt(parcel, 2, this.f14718OooO0o0);
            SafeParcelWriter.writeBoolean(parcel, 3, this.f14717OooO0o);
            SafeParcelWriter.writeInt(parcel, 4, this.f14719OooO0oO);
            SafeParcelWriter.writeBoolean(parcel, 5, this.f14720OooO0oo);
            SafeParcelWriter.writeString(parcel, 6, this.f14715OooO, false);
        ...
        public final Field<I, O> zab() {
            int i = this.f14716OooO0Oo;
            int i2 = this.f14718OooO0o0;
            boolean z = this.f14717OooO0o;
            int i3 = this.f14719OooO0oO;
            boolean z2 = this.f14720OooO0oo;
            String str = this.f14715OooO;
            int i4 = this.f14721OooOO0;
            String str2 = this.f14723OooOO0o;
            FieldConverter<I, O> fieldConverter = this.f14724OooOOO;
        ...
        public final FastJsonResponse zad() throws IllegalAccessException, InstantiationException {
            ...
            Preconditions.checkNotNull(this.f14725OooOOO0, "The field mapping dictionary must be set if the concrete type is a SafeParcelResponse object.");
            return new SafeParcelResponse(this.f14725OooOOO0, str);
        }
        ...
        public final Map<String, Field<?, ?>> zah() {
            String str = this.f14723OooOO0o;
            Preconditions.checkNotNull(str);
            Preconditions.checkNotNull(this.f14725OooOOO0);
            return (Map) Preconditions.checkNotNull(this.f14725OooOOO0.zab(str));
        }

        public final void zai(zan zanVar) {
            this.f14725OooOOO0 = zanVar;
        }

        public final boolean zaj() {
            return this.f14724OooOOO != null;
        }
        ...
        public Field(int i, boolean z, int i2, boolean z2, @NonNull String str, int i3, @Nullable Class<? extends FastJsonResponse> cls, @Nullable FieldConverter<I, O> fieldConverter) {
            this.f14716OooO0Oo = 1;
            this.f14718OooO0o0 = i;
            this.f14717OooO0o = z;
            this.f14719OooO0oO = i2;
            this.f14720OooO0oo = z2;
            this.f14715OooO = str;
            this.f14721OooOO0 = i3;
            this.f14722OooOO0O = cls;
            if (cls == null) {
                this.f14723OooOO0o = null;
            } else {
                this.f14723OooOO0o = cls.getCanonicalName();
            }
            this.f14724OooOOO = fieldConverter;
        }
    }
}
