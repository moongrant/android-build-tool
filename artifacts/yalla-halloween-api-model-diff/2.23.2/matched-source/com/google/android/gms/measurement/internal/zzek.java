...
public final class zzek extends oOo00o0o {

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    public List f15428OooO;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public String f15429OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public String f15430OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public String f15431OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public int f15432OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public long f15433OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final long f15434OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public String f15435OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public int f15436OooOO0O;

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    public String f15437OooOO0o;

    /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
    public String f15438OooOOO;

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    public String f15439OooOOO0;

    /* JADX INFO: renamed from: OooOOOO, reason: collision with root package name */
    public long f15440OooOOOO;

    /* JADX INFO: renamed from: OooOOOo, reason: collision with root package name */
    public String f15441OooOOOo;

    public zzek(zzgd zzgdVar, long j) {
        super(zzgdVar);
        this.f15440OooOOOO = 0L;
        this.f15441OooOOOo = null;
        this.f15434OooO0oo = j;
    }
    ...
    public final void OooO00o() {
        ...
        this.f15429OooO0OO = packageName;
        this.f15431OooO0o = installerPackageName;
        this.f15430OooO0Oo = str3;
        this.f15432OooO0o0 = i;
        this.f15433OooO0oO = 0L;
        ...
        zzgdVar.zzay();
        if (z) {
            this.f15439OooOOO0 = zzgdVar.zzw();
        }
        try {
            ...
            if (!TextUtils.isEmpty(strZzc)) {
                ...
                this.f15439OooOOO0 = zzfv.zzb("admob_app_id", resources, strZzz);
            }
            if (iZza == 0) {
                zzgdVar.zzaA().zzj().zzc("App measurement enabled for app package, google app id", this.f15429OooO0OO, TextUtils.isEmpty(this.f15437OooOO0o) ? this.f15439OooOOO0 : this.f15437OooOO0o);
            }
        ...
        zzgd zzgdVar2 = zzagVarZzf.f40788OooO00o;
        if (bundleOooO0O0 != null) {
            ...
            if (packageManager != null) {
                this.f15436OooOO0O = InstantApps.isInstantApp(zzgdVar.zzaw()) ? 1 : 0;
            } else {
                this.f15436OooOO0O = 0;
            }
        }
        o00O00.OooO00o(zzgdVar2, "Failed to load metadata: Metadata bundle is null");
        numValueOf = null;
        if (numValueOf != null) {
            stringArray = zzgdVar2.zzaw().getResources().getStringArray(numValueOf.intValue());
            if (stringArray == null) {
    ...
    public final void OooO0OO() {
        ...
        this.f15438OooOOO = str;
        this.f15440OooOOOO = zzgdVar.zzax().currentTimeMillis();
    }

    @WorkerThread
    public final String zzl() {
        zza();
        Preconditions.checkNotNull(this.f15429OooO0OO);
        return this.f15429OooO0OO;
    }
    ...
    public final String zzm() {
        zzg();
        zza();
        Preconditions.checkNotNull(this.f15437OooOO0o);
        return this.f15437OooOO0o;
    }
}
