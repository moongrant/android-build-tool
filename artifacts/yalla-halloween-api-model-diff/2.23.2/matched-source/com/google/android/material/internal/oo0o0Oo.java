...
public final class oo0o0Oo {
    ...
    public class OooO00o implements o000000O {
        ...
        public final /* synthetic */ OooO0O0 f16861OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ OooO0OO f16862OooO0o0;

        public OooO00o(OooO0O0 oooO0O0, OooO0OO oooO0OO) {
            this.f16861OooO0Oo = oooO0O0;
            this.f16862OooO0o0 = oooO0OO;
        }

        @Override // androidx.core.view.o000000O
        public final WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
            return this.f16861OooO0Oo.OooO00o(view, windowInsetsCompat, new OooO0OO(this.f16862OooO0o0));
        }
    }
    ...
    public static void OooO0o0(@NonNull View view, boolean z) {
        ...
        if (z && (o0VarOooO0oo = ViewCompat.OooO0oo(view)) != null) {
            o0VarOooO0oo.f5420OooO00o.OooO00o(8);
            return;
        }
    ...
    public static class OooO0OO {
        ...
        public int f16863OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public int f16864OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public int f16865OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f16866OooO0Oo;

        public OooO0OO(int i, int i2, int i3, int i4) {
            this.f16863OooO00o = i;
            this.f16864OooO0O0 = i2;
            this.f16865OooO0OO = i3;
            this.f16866OooO0Oo = i4;
        }

        public OooO0OO(@NonNull OooO0OO oooO0OO) {
            this.f16863OooO00o = oooO0OO.f16863OooO00o;
            this.f16864OooO0O0 = oooO0OO.f16864OooO0O0;
            this.f16865OooO0OO = oooO0OO.f16865OooO0OO;
            this.f16866OooO0Oo = oooO0OO.f16866OooO0Oo;
        }
    }
}
