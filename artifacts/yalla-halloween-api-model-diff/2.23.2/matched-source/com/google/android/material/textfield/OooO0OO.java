...
public final /* synthetic */ class OooO0OO implements View.OnClickListener {
    ...
    public final /* synthetic */ int f17481OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ Object f17482OooO0o0;

    public /* synthetic */ OooO0OO(Object obj, int i) {
        this.f17481OooO0Oo = i;
        this.f17482OooO0o0 = obj;
    }

    @Override // android.view.View.OnClickListener
    public final void onClick(View view) {
        int i = this.f17481OooO0Oo;
        Object obj = this.f17482OooO0o0;
        switch (i) {
            case 0:
                OooOO0O oooOO0O = (OooOO0O) obj;
                EditText editText = oooOO0O.f17485OooO;
                if (editText != null) {
            ...
            case 1:
                ...
                break;
            default:
                o000OO0O this$1 = (o000OO0O) obj;
                Intrinsics.checkNotNullParameter(this$1, "this$0");
                if (StringsKt.trim((CharSequence) this$1.f58516OooOO0o.f44679OooO0OO.getText().toString()).toString().length() >= 10) {
                    BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), Dispatchers.getIO(), null, new o000O0(this$1, null), 2, null);
                    break;
                }
                break;
        }
