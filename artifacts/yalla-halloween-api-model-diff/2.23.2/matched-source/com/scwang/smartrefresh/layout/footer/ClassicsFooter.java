...
public class ClassicsFooter extends InternalClassics<ClassicsFooter> implements OooO0o {
    ...
    public final String f20945OooOo;

    /* JADX INFO: renamed from: OooOo0, reason: collision with root package name */
    public final String f20946OooOo0;

    /* JADX INFO: renamed from: OooOo00, reason: collision with root package name */
    public final String f20947OooOo00;

    /* JADX INFO: renamed from: OooOo0O, reason: collision with root package name */
    public final String f20948OooOo0O;

    /* JADX INFO: renamed from: OooOo0o, reason: collision with root package name */
    public final String f20949OooOo0o;

    /* JADX INFO: renamed from: OooOoO, reason: collision with root package name */
    public final String f20950OooOoO;

    /* JADX INFO: renamed from: OooOoO0, reason: collision with root package name */
    public final String f20951OooOoO0;

    /* JADX INFO: renamed from: OooOoOO, reason: collision with root package name */
    public boolean f20952OooOoOO;

    public static /* synthetic */ class OooO00o {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public static final /* synthetic */ int[] f20953OooO00o;
        ...
        static {
            ...
            try {
                f20953OooO00o[RefreshState.PullUpToLoad.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f20953OooO00o[RefreshState.Loading.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f20953OooO00o[RefreshState.LoadReleased.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f20953OooO00o[RefreshState.ReleaseToLoad.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f20953OooO00o[RefreshState.Refreshing.ordinal()] = 6;
    ...
    public final void OooO00o(@NonNull OooOOO0 oooOOO0, @NonNull RefreshState refreshState, @NonNull RefreshState refreshState2) {
        ...
        if (this.f20952OooOoOO) {
            return;
        }
        switch (OooO00o.f20953OooO00o[refreshState2.ordinal()]) {
            case 1:
            ...
            case 4:
                ...
                this.f21012OooO0oO.setText(this.f20948OooOo0O);
                return;
            case 5:
                this.f21012OooO0oO.setText(this.f20946OooOo0);
                imageView.animate().rotation(0.0f);
                return;
            case 6:
                this.f21012OooO0oO.setText(this.f20949OooOo0o);
                imageView.setVisibility(8);
                return;
            default:
                return;
        }
        this.f21012OooO0oO.setText(this.f20947OooOo00);
    ...
    public final boolean OooO0O0(boolean z) {
        if (this.f20952OooOoOO == z) {
            return true;
        }
        this.f20952OooOoOO = z;
        ImageView imageView = this.f21013OooO0oo;
        if (z) {
            this.f21012OooO0oO.setText(this.f20950OooOoO);
            imageView.setVisibility(8);
            return true;
        }
        this.f21012OooO0oO.setText(this.f20947OooOo00);
    ...
    public final int OooO0OO(@NonNull SmartRefreshLayout smartRefreshLayout, boolean z) {
        ...
        this.f21012OooO0oO.setText(z ? this.f20945OooOo : this.f20951OooOoO0);
    ...
    public void setPrimaryColors(@ColorInt int... iArr) {
        if (this.f21010OooO0o0 == OooO0O0.f42506OooO0o0) {
    ...
    public ClassicsFooter(Context context, AttributeSet attributeSet) {
        ...
        this.f21020OooOOOo = typedArrayObtainStyledAttributes.getInt(o0OO0o.OooO0o.ClassicsFooter_srlFinishDuration, this.f21020OooOOOo);
        this.f21010OooO0o0 = OooO0O0.f42508OooO0oo[typedArrayObtainStyledAttributes.getInt(o0OO0o.OooO0o.ClassicsFooter_srlClassicsSpinnerStyle, this.f21010OooO0o0.f42509OooO00o)];
        ...
        if (typedArrayObtainStyledAttributes.hasValue(i9)) {
            this.f20947OooOo00 = typedArrayObtainStyledAttributes.getString(i9);
        } else {
            this.f20947OooOo00 = context.getString(OooO0OO.srl_footer_pulling);
        }
        int i10 = o0OO0o.OooO0o.ClassicsFooter_srlTextRelease;
        if (typedArrayObtainStyledAttributes.hasValue(i10)) {
            this.f20946OooOo0 = typedArrayObtainStyledAttributes.getString(i10);
        } else {
            this.f20946OooOo0 = context.getString(OooO0OO.srl_footer_release);
        }
        int i11 = o0OO0o.OooO0o.ClassicsFooter_srlTextLoading;
        if (typedArrayObtainStyledAttributes.hasValue(i11)) {
            this.f20948OooOo0O = typedArrayObtainStyledAttributes.getString(i11);
        } else {
            this.f20948OooOo0O = context.getString(OooO0OO.srl_footer_loading);
        }
        int i12 = o0OO0o.OooO0o.ClassicsFooter_srlTextRefreshing;
        if (typedArrayObtainStyledAttributes.hasValue(i12)) {
            this.f20949OooOo0o = typedArrayObtainStyledAttributes.getString(i12);
        } else {
            this.f20949OooOo0o = context.getString(OooO0OO.srl_footer_refreshing);
        }
        int i13 = o0OO0o.OooO0o.ClassicsFooter_srlTextFinish;
        if (typedArrayObtainStyledAttributes.hasValue(i13)) {
            this.f20945OooOo = typedArrayObtainStyledAttributes.getString(i13);
        } else {
            this.f20945OooOo = context.getString(OooO0OO.srl_footer_finish);
        }
        int i14 = o0OO0o.OooO0o.ClassicsFooter_srlTextFailed;
        if (typedArrayObtainStyledAttributes.hasValue(i14)) {
            this.f20951OooOoO0 = typedArrayObtainStyledAttributes.getString(i14);
        } else {
            this.f20951OooOoO0 = context.getString(OooO0OO.srl_footer_failed);
        }
        int i15 = o0OO0o.OooO0o.ClassicsFooter_srlTextNothing;
        if (typedArrayObtainStyledAttributes.hasValue(i15)) {
            this.f20950OooOoO = typedArrayObtainStyledAttributes.getString(i15);
        } else {
            this.f20950OooOoO = context.getString(OooO0OO.srl_footer_nothing);
        }
        typedArrayObtainStyledAttributes.recycle();
        imageView2.animate().setInterpolator(null);
        this.f21012OooO0oO.setText(isInEditMode() ? this.f20948OooOo0O : this.f20947OooOo00);
        if (isInEditMode()) {
            imageView.setVisibility(8);
        } else {
