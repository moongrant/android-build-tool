...
public enum PremiumLevel {
    ...
    public final String premiumName() {
        ...
        if (i == 2) {
            return o0000.OooO0OO(o000000.Patrician);
        }
        if (i == 3) {
            return o0000.OooO0OO(o000000.Knight);
        }
        if (i == 4) {
            return o0000.OooO0OO(o000000.Baron);
        }
        if (i != 5) {
            return i != 6 ? "" : o0000.OooO0OO(o000000.Marquis);
        }
        return o0000.OooO0OO(o000000.Count);
    }
}
