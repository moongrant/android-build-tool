...
public final class OooOO0 implements com.yalla.yalla.service.room.processor.OooO00o {
    ...
    public static final class OooO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final /* synthetic */ int f24625OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(int i, Continuation<? super OooO> continuation) {
            super(2, continuation);
            this.f24625OooO0Oo = i;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO(this.f24625OooO0Oo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            com.yalla.yalla.service.room.OooO00o.f24524OooOOOO.OooO0o(this.f24625OooO0Oo);
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MemberBadgeInfo f24626OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ RoomJoinMemberModel f24627OooO0o0;
        ...
        public OooO00o(MemberBadgeInfo memberBadgeInfo, RoomJoinMemberModel roomJoinMemberModel, Continuation<? super OooO00o> continuation) {
            super(2, continuation);
            this.f24626OooO0Oo = memberBadgeInfo;
            this.f24627OooO0o0 = roomJoinMemberModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO00o(this.f24626OooO0Oo, this.f24627OooO0o0, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            MemberBadgeInfo memberBadgeInfo = this.f24626OooO0Oo;
            String badgeUrl = memberBadgeInfo.getBadgeUrl();
            o0000ooo.getClass();
            Intrinsics.checkNotNullParameter(badgeUrl, "<set-?>");
            o0000ooo.f48521OooO0OO.setValue(badgeUrl);
            o0000ooo.f48524OooO0o0.setValue(Boolean.valueOf(memberBadgeInfo.getBadgeState()));
            String badgeLevelUrl = memberBadgeInfo.getBadgeLevelUrl();
            Intrinsics.checkNotNullParameter(badgeLevelUrl, "<set-?>");
            o0000ooo.f48522OooO0Oo.setValue(badgeLevelUrl);
            o0000ooo.f48520OooO0O0.setValue(Integer.valueOf(memberBadgeInfo.getMemberLevel()));
            RoomJoinMemberModel roomJoinMemberModel = this.f24627OooO0o0;
            o0000ooo.OooO0o(roomJoinMemberModel.getRoomMemberCount());
            boolean z = false;
            o0000ooo.f48544OooOoOO.setValue(Boxing.boxBoolean(false));
            if (!memberBadgeInfo.getBadgeState()) {
                ...
                o0000ooo.f48525OooO0oO.setValue(str);
            }
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            o0000Ooo o0000ooo = com.yalla.yalla.service.room.OooO00o.f24524OooOOOO;
            Integer numValueOf = Integer.valueOf(((Number) o0000ooo.f48532OooOOOO.getValue()).intValue() - 1);
            MutableState mutableState = o0000ooo.f48532OooOOOO;
            mutableState.setValue(numValueOf);
            if (((Number) mutableState.getValue()).intValue() > 0) {
                o0000ooo.f48533OooOOOo.setValue(Long.valueOf(o0000ooo.f48535OooOOo0));
                Job job = o0000ooo.f48534OooOOo;
                if (job != null) {
                    Job.DefaultImpls.cancel$default(job, (CancellationException) null, 1, (Object) null);
                }
                o0000ooo.f48534OooOOo = null;
                o0000ooo.f48534OooOOo = com.code.android.util.OooOOO.OooO0O0(GlobalScope.INSTANCE, new o0000(o0000ooo, null));
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ int f24628OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ long f24629OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f24630OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ long f24631OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(int i, int i2, long j, long j2, Continuation<? super OooO0OO> continuation) {
            super(2, continuation);
            this.f24628OooO0Oo = i;
            this.f24630OooO0o0 = i2;
            this.f24629OooO0o = j;
            this.f24631OooO0oO = j2;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0OO(this.f24628OooO0Oo, this.f24630OooO0o0, this.f24629OooO0o, this.f24631OooO0oO, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            o0000Ooo o0000ooo = com.yalla.yalla.service.room.OooO00o.f24524OooOOOO;
            o0000ooo.f48532OooOOOO.setValue(Integer.valueOf(this.f24628OooO0Oo));
            o0000ooo.f48530OooOOO.setValue(Integer.valueOf(this.f24630OooO0o0));
            o0000ooo.f48533OooOOOo.setValue(Long.valueOf(this.f24629OooO0o));
            o0000ooo.f48535OooOOo0 = this.f24631OooO0oO;
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ long f24632OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ String f24633OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f24634OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ String f24635OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ boolean f24636OooO0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(long j, int i, String str, String str2, boolean z, Continuation<? super OooO0o> continuation) {
            super(2, continuation);
            this.f24632OooO0Oo = j;
            this.f24634OooO0o0 = i;
            this.f24633OooO0o = str;
            this.f24635OooO0oO = str2;
            this.f24636OooO0oo = z;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0o(this.f24632OooO0Oo, this.f24634OooO0o0, this.f24633OooO0o, this.f24635OooO0oO, this.f24636OooO0oo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            long j = this.f24632OooO0Oo;
            if (l != null && j == l.longValue()) {
                o0000Ooo o0000ooo = com.yalla.yalla.service.room.OooO00o.f24524OooOOOO;
                MutableState mutableState = o0000ooo.f48520OooO0O0;
                int i = this.f24634OooO0o0;
                mutableState.setValue(Integer.valueOf(i));
                String badgeUrl = this.f24633OooO0o;
                Intrinsics.checkNotNullExpressionValue(badgeUrl, "$badgeUrl");
                Intrinsics.checkNotNullParameter(badgeUrl, "<set-?>");
                o0000ooo.f48521OooO0OO.setValue(badgeUrl);
                String badgeLevelUrl = this.f24635OooO0oO;
                Intrinsics.checkNotNullExpressionValue(badgeLevelUrl, "$badgeLevelUrl");
                Intrinsics.checkNotNullParameter(badgeLevelUrl, "<set-?>");
                o0000ooo.f48522OooO0Oo.setValue(badgeLevelUrl);
                o0000ooo.f48523OooO0o.setValue(Boolean.valueOf(this.f24636OooO0oo));
                if (i >= 15) {
    ...
    public static final class C0319OooOO0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            IntrinsicsKt.getCOROUTINE_SUSPENDED();
            ResultKt.throwOnFailure(obj);
            com.yalla.yalla.service.room.OooO00o.f24524OooOOOO.f48519OooO00o.setValue(Boxing.boxBoolean(true));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0O extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ RoomJoinMemberModel f24637OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0O(RoomJoinMemberModel roomJoinMemberModel, Continuation<? super OooOO0O> continuation) {
            super(2, continuation);
            this.f24637OooO0Oo = roomJoinMemberModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOO0O(this.f24637OooO0Oo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            o0000Ooo o0000ooo = com.yalla.yalla.service.room.OooO00o.f24524OooOOOO;
            RoomJoinMemberModel roomJoinMemberModel = this.f24637OooO0Oo;
            o0000ooo.OooO0o(roomJoinMemberModel.getRoomMemberCount());
            ArrayList arrayList = com.yalla.yalla.service.room.OooO00o.f24511OooO00o;
            RoomUserInfoModel roomUserInfoModelOooO0o0 = com.yalla.yalla.service.room.OooO00o.OooO0o0(Boxing.boxLong(roomJoinMemberModel.getUserid()));
            MutableStateFlow<Integer> roomMemberType = roomUserInfoModelOooO0o0 != null ? roomUserInfoModelOooO0o0.getRoomMemberType() : null;
    ...
    public static final class OooOOO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ RoomAdminUpgradeModel f24638OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO(RoomAdminUpgradeModel roomAdminUpgradeModel, Continuation<? super OooOOO> continuation) {
            super(2, continuation);
            this.f24638OooO0Oo = roomAdminUpgradeModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOOO(this.f24638OooO0Oo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            ArrayList arrayList = com.yalla.yalla.service.room.OooO00o.f24511OooO00o;
            RoomUserInfoModel roomUserInfoModelOooO0o0 = com.yalla.yalla.service.room.OooO00o.OooO0o0(Boxing.boxLong(this.f24638OooO0Oo.userid));
            MutableStateFlow<Integer> roomMemberType = roomUserInfoModelOooO0o0 != null ? roomUserInfoModelOooO0o0.getRoomMemberType() : null;
            if (roomMemberType != null) {
    ...
    public static final class OooOOO0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ RoomJoinMemberModel f24639OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO0(RoomJoinMemberModel roomJoinMemberModel, Continuation<? super OooOOO0> continuation) {
            super(2, continuation);
            this.f24639OooO0Oo = roomJoinMemberModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOOO0(this.f24639OooO0Oo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            o0000Ooo o0000ooo = com.yalla.yalla.service.room.OooO00o.f24524OooOOOO;
            RoomJoinMemberModel roomJoinMemberModel = this.f24639OooO0Oo;
            o0000ooo.OooO0o(roomJoinMemberModel.getRoomMemberCount());
            ArrayList arrayList = com.yalla.yalla.service.room.OooO00o.f24511OooO00o;
            RoomUserInfoModel roomUserInfoModelOooO0o0 = com.yalla.yalla.service.room.OooO00o.OooO0o0(Boxing.boxLong(roomJoinMemberModel.getUserid()));
    ...
    public static final class OooOOOO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ RoomAdminDemotionModel f24640OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOOO(RoomAdminDemotionModel roomAdminDemotionModel, Continuation<? super OooOOOO> continuation) {
            super(2, continuation);
            this.f24640OooO0Oo = roomAdminDemotionModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOOOO(this.f24640OooO0Oo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            ArrayList arrayList = com.yalla.yalla.service.room.OooO00o.f24511OooO00o;
            RoomUserInfoModel roomUserInfoModelOooO0o0 = com.yalla.yalla.service.room.OooO00o.OooO0o0(Boxing.boxLong(this.f24640OooO0Oo.getUserid()));
            MutableStateFlow<Integer> roomMemberType = roomUserInfoModelOooO0o0 != null ? roomUserInfoModelOooO0o0.getRoomMemberType() : null;
            if (roomMemberType != null) {
                roomMemberType.setValue(Boxing.boxInt(3));
            }
    ...
    public static final class OooOo extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ RemoveMemberModel f24641OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOo(RemoveMemberModel removeMemberModel, Continuation<? super OooOo> continuation) {
            super(2, continuation);
            this.f24641OooO0Oo = removeMemberModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOo(this.f24641OooO0Oo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            ArrayList arrayList = com.yalla.yalla.service.room.OooO00o.f24511OooO00o;
            RemoveMemberModel removeMemberModel = this.f24641OooO0Oo;
    ...
    public static final class OooOo00 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ JSONObject f24642OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOo00(JSONObject jSONObject, Continuation<? super OooOo00> continuation) {
            super(2, continuation);
            this.f24642OooO0Oo = jSONObject;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOo00(this.f24642OooO0Oo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            IntrinsicsKt.getCOROUTINE_SUSPENDED();
            ResultKt.throwOnFailure(obj);
            com.yalla.yalla.service.room.OooO00o.f24524OooOOOO.OooO0o(this.f24642OooO0Oo.getInt("roomMemberCount"));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class Oooo000 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ int f24643OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ String f24644OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ String f24645OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ boolean f24646OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public Oooo000(int i, String str, String str2, boolean z, Continuation<? super Oooo000> continuation) {
            super(2, continuation);
            this.f24643OooO0Oo = i;
            this.f24645OooO0o0 = str;
            this.f24644OooO0o = str2;
            this.f24646OooO0oO = z;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new Oooo000(this.f24643OooO0Oo, this.f24645OooO0o0, this.f24644OooO0o, this.f24646OooO0oO, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            o0000Ooo o0000ooo = com.yalla.yalla.service.room.OooO00o.f24524OooOOOO;
            o0000ooo.f48520OooO0O0.setValue(Integer.valueOf(this.f24643OooO0Oo));
            String badgeLevelUrl = this.f24645OooO0o0;
            Intrinsics.checkNotNullExpressionValue(badgeLevelUrl, "$badgeLevelUrl");
            Intrinsics.checkNotNullParameter(badgeLevelUrl, "<set-?>");
            o0000ooo.f48522OooO0Oo.setValue(badgeLevelUrl);
            String badgeUrl = this.f24644OooO0o;
            Intrinsics.checkNotNullExpressionValue(badgeUrl, "$badgeUrl");
            Intrinsics.checkNotNullParameter(badgeUrl, "<set-?>");
            o0000ooo.f48521OooO0OO.setValue(badgeUrl);
            o0000ooo.f48523OooO0o.setValue(Boolean.valueOf(this.f24646OooO0oO));
            return Unit.INSTANCE;
        }
    }
    ...
    public final void OooO0O0(int i, @Nullable Object obj) {
        ...
        o0000O00.OooO0OO(strOooO00o, "type = " + i + "  data = " + new String(bArr, charset));
        com.yalla.yalla.service.room.OooO0O0.OooO00o oooO00o = com.yalla.yalla.service.room.OooO0O0.f24533OoooOOO;
        switch (i) {
            case 10021:
                o0000O00.OooO0OO(com.yalla.yalla.service.room.processor.OooO00o.C0318OooO00o.OooO00o(this), "type = " + i + "  data = " + new String(bArr, charset));
                ...
                if (roomJoinMemberModel != null) {
                    ...
                    o0O00oO0 o0o00oo1 = o0O00oO0.f47936OooO00o;
                    o0O00oO0.OooO0O0().postValue(Long.valueOf(roomJoinMemberModel.getLeftcoin()));
                    LiveEventBus.get("ROOM_JOIN_MEMBER").post(Long.valueOf(roomJoinMemberModel.getUserid()));
                    oooO00o.OooO00o().f24577OoooO.postValue(new Pair<>(Long.valueOf(roomJoinMemberModel.getUserid()), 3));
                    break;
                }
                break;
            case 10022:
            ...
            case 100222:
                ...
                if (removeMemberModel != null) {
                    ...
                    if ((l != null && userid == l.longValue()) || i == 100221) {
                        String strOooO0OO = com.code.android.util.o0000.OooO0OO(o000000.member_getOut);
                        ...
                        oooO00o.OooO00o().f24546OooOO0o.postValue(0);
                        if (i == 10022) {
                            oooO00o.OooO00o().f24545OooOO0O.postValue(Boolean.valueOf(!(removeMemberModel.getFollowType() == 1)));
                        } else {
                            oooO00o.OooO00o().f24545OooOO0O.postValue(Boolean.TRUE);
                        }
                    } else if (i == 10022) {
                        String strOooO0OO2 = com.code.android.util.o0000.OooO0OO(o000000.Removed_successfully);
                        ...
                        com.yalla.yalla.service.room.OooO00o.f24524OooOOOO.f48545OooOoo.postValue(Long.valueOf(removeMemberModel.getUserid()));
                    ...
                    oooO00o.OooO00o().f24577OoooO.postValue(new Pair<>(Long.valueOf(removeMemberModel.getUserid()), 0));
            ...
            case 100232:
                ...
                if (i == 10023) {
                    String strOooO0OO3 = com.code.android.util.o0000.OooO0OO(o000000.Set_admin_successfully);
                    ...
                    o0000O00.OooO0OO(com.yalla.yalla.service.room.processor.OooO00o.C0318OooO00o.OooO00o(this), "被提升者弹被提升提示并修改自己的身份信息");
                    String strOooO0OO4 = com.code.android.util.o0000.OooO0OO(o000000.improves_admin);
                    ...
                    oooO00o.OooO00o().f24546OooOO0o.postValue(2);
                }
                ...
                chatModel.setType(3);
                chatModel.setMessage(o0000O.OooO00o(com.code.android.util.o0000.OooO0OO(o000000.welcome_xxx_to_become_admin), userName));
                MixedRoomDataSource.OooO0o0().OooO00o(chatModel);
                MixedRoomDataSource.OooO0o0().OooO0OO(roomAdminUpgradeModel);
                oooO00o.OooO00o().f24577OoooO.postValue(new Pair<>(Long.valueOf(roomAdminUpgradeModel.userid), 2));
            ...
            case 100242:
                ...
                if (i == 10024) {
                    String strOooO0OO5 = com.code.android.util.o0000.OooO0OO(o000000.Removed_admin_successfully);
                    ...
                    String strOooO0OO6 = com.code.android.util.o0000.OooO0OO(o000000.demotiion_Management);
                    ...
                    oooO00o.OooO00o().f24546OooOO0o.postValue(3);
                }
                ...
                oooO00o.OooO00o().f24577OoooO.postValue(new Pair<>(Long.valueOf(roomAdminDemotionModel.getUserid()), 3));
            ...
            case 10042:
                ...
                if (roomJoinMemberModel2 != null) {
                    if (roomJoinMemberModel2.getDues() > 0) {
                        o0O00oO0.OooO0O0().postValue(Long.valueOf(roomJoinMemberModel2.getLeftcoin()));
                    }
                    ...
                    oooO00o.OooO00o().f24546OooOO0o.postValue(3);
                    oooO00o.OooO00o().f24545OooOO0O.postValue(bool);
                    String strOooO0OO7 = com.code.android.util.o0000.OooO0OO(o000000.title_Room_beMember);
                    if (!(strOooO0OO7 == null || StringsKt.isBlank(strOooO0OO7))) {
                        ...
                        if (Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                            ...
                            o000O00O.f13422OooO0O0.post(o000oo0OooO00o7);
                        }
                    }
            ...
            case 100212:
                ...
                if (roomJoinMemberModel3 != null) {
                    ...
                    oooO00o.OooO00o().f24577OoooO.postValue(new Pair<>(Long.valueOf(roomJoinMemberModel3.getUserid()), 3));
                    break;
                }
                break;
            case 1000402:
            ...
            case 1000900:
                if (!oooO00o.OooO00o().OooOOO()) {
                    ...
                    String strOooO0OO8 = com.code.android.util.o0000.OooO0OO(o000000.member_task_invite_success);
                    if (!(strOooO0OO8 == null || StringsKt.isBlank(strOooO0OO8))) {
                        ...
                        if (Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                            ...
                            o000O00O.f13422OooO0O0.post(o000oo0OooO00o8);
                        }
                    }
            ...
            case 1000902:
                ...
                ArrayList<ChatModel> arrayList2 = MixedRoomDataSource.OooO0o0().f22996OooOO0O;
                ...
                o0oo0000.OooO00o.OooO0O0("402003");
            ...
            case 1000903:
                ...
                if (jSONObject4.has("badgeState")) {
                    boolean zOooO00o = com.code.android.util.o000000.OooO00o(Integer.valueOf(jSONObject4.optInt("badgeState")));
                    if (zOooO00o) {
                        o0oo0000.OooO00o.OooO0O0("402001");
                    } else {
                        o0oo0000.OooO00o.OooO0O0("402002");
                    }
            ...
            case 1000904:
                ...
                if (jOptLong3 > 0) {
                    ...
                    o0000ooo.f48534OooOOo = actorCoroutine;
                    o0000ooo.f48534OooOOo = com.code.android.util.OooOOO.OooO0O0(GlobalScope.INSTANCE, new o0000(o0000ooo, actorCoroutine));
                }
                break;
            case 1000905:
                o0000O00.OooO0OO(com.yalla.yalla.service.room.processor.OooO00o.C0318OooO00o.OooO00o(this), "type = " + i + "  data = " + new String(bArr, charset));
