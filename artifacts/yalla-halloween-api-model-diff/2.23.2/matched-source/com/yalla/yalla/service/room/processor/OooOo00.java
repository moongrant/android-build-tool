    ...
    public final void OooO0O0(int i, @Nullable Object obj) {
        ...
        switch (i) {
            case 1000200:
                ...
                if (from != null) {
                    o0000O00.OooO0OO(OooO00o.C0318OooO00o.OooO00o(this), "type = " + i + "  data = " + from);
                    ...
                    if (value != null && value.longValue() == roomId) {
                        ...
                        oooO00o.OooO00o().f24576Oooo0oo.postValue(treasureBoxProgressModel);
                    }
                }
                break;
            case 1000201:
                ...
                if (box != null) {
                    o0000O00.OooO0OO(OooO00o.C0318OooO00o.OooO00o(this), "type = " + i + "  data = " + box);
