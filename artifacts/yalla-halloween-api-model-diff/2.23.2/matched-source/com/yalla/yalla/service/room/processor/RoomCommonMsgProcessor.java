...
public final class RoomCommonMsgProcessor implements com.yalla.yalla.service.room.processor.OooO00o {
    ...
    @NotNull
    public static final RoomCommonMsgProcessor f24666OooO00o = new RoomCommonMsgProcessor();
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                ...
                if (com.yalla.yalla.service.room.OooO0O0.f24533OoooOOO.OooO00o().OooOOO()) {
                    ...
                    this.f24667OooO0Oo = 1;
                    String str = p382o0OOoo.OooOOO.f43281OooO0oO;
            ...
            ResultKt.throwOnFailure(obj);
            com.yalla.yalla.service.room.OooO00o.f24518OooO0oo.f48486OooO0O0.postValue((GetConveneMemberStateModel) ((ApiResult) obj).getData());
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            com.yalla.yalla.service.room.OooO00o.OooO0oO(com.yalla.yalla.service.room.OooO0OO.OooO0o.f24593OooO00o);
            com.yalla.yalla.service.room.OooO00o.f24516OooO0o0.f48465OooO0oO.setValue(-1);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MemberBadgeInfo f24668OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(MemberBadgeInfo memberBadgeInfo, Continuation<? super OooO0O0> continuation) {
            super(2, continuation);
            this.f24668OooO0Oo = memberBadgeInfo;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0O0(this.f24668OooO0Oo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            MemberBadgeInfo memberBadgeInfo = this.f24668OooO0Oo;
            ...
            o0000ooo.f48523OooO0o.setValue(Boolean.valueOf(memberBadgeInfo.getIsTopRank()));
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ RoomLoginInformation f24669OooO0Oo;
        ...
        public OooO0OO(RoomLoginInformation roomLoginInformation, Continuation<? super OooO0OO> continuation) {
            super(2, continuation);
            this.f24669OooO0Oo = roomLoginInformation;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0OO(this.f24669OooO0Oo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            IntrinsicsKt.getCOROUTINE_SUSPENDED();
            ResultKt.throwOnFailure(obj);
            o000000O o000000o2 = com.yalla.yalla.service.room.OooO00o.f24530OooOo00;
            if (((Boolean) o000000o2.f48478OooO00o.getValue()).booleanValue()) {
                o000000o2.f48478OooO00o.setValue(Boolean.FALSE);
                RoomLoginInformation loginInformation = this.f24669OooO0Oo;
                Intrinsics.checkNotNullParameter(loginInformation, "loginInformation");
                if (loginInformation.code == 0) {
                    ChatModel chatModel = new ChatModel();
                    chatModel.setType(3);
                    chatModel.setMessage(o0000.OooO0OO(o000000.welcome_top));
    ...
    public static final class OooO0o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            IntrinsicsKt.getCOROUTINE_SUSPENDED();
            ResultKt.throwOnFailure(obj);
            if (com.yalla.yalla.service.room.OooO0O0.f24533OoooOOO.OooO00o().OooOO0O()) {
                com.yalla.yalla.service.room.OooO00o.f24524OooOOOO.f48519OooO00o.setValue(Boxing.boxBoolean(true));
            } else {
                com.yalla.yalla.service.room.OooO00o.f24524OooOOOO.f48544OooOoOO.setValue(Boxing.boxBoolean(true));
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Room.SumAmountOut f24671OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0(Room.SumAmountOut sumAmountOut, Continuation<? super OooOO0> continuation) {
            super(2, continuation);
            this.f24671OooO0Oo = sumAmountOut;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOO0(this.f24671OooO0Oo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            IntrinsicsKt.getCOROUTINE_SUSPENDED();
            ResultKt.throwOnFailure(obj);
            o0OO00O o0oo00o2 = com.yalla.yalla.service.room.OooO00o.f24510OooO;
            Room.SumAmountOut sumAmountOut = this.f24671OooO0Oo;
            o0oo00o2.f48637OooO00o.setValue(Long.valueOf(sumAmountOut.getAmount()));
            com.yalla.yalla.service.room.OooO0O0.f24533OoooOOO.OooO00o().f24549OooOOOO.postValue(Boxing.boxLong(sumAmountOut.getAmount()));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0O extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ JSONObject f24672OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ long f24673OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ RoomUserInfoModel f24674OooO0o0;
        ...
        public OooOO0O(JSONObject jSONObject, RoomUserInfoModel roomUserInfoModel, long j, Continuation<? super OooOO0O> continuation) {
            super(2, continuation);
            this.f24672OooO0Oo = jSONObject;
            this.f24674OooO0o0 = roomUserInfoModel;
            this.f24673OooO0o = j;
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOO0O(this.f24672OooO0Oo, this.f24674OooO0o0, this.f24673OooO0o, continuation);
        }
        ...
        @Nullable
        public final Object invokeSuspend(@NotNull Object obj) {
            JSONObject jSONObject = this.f24672OooO0Oo;
            IntrinsicsKt.getCOROUTINE_SUSPENDED();
            ResultKt.throwOnFailure(obj);
            try {
                boolean zHas = jSONObject.has("isVIP");
                RoomUserInfoModel roomUserInfoModel = this.f24674OooO0o0;
                if (zHas) {
                    roomUserInfoModel.isPremium().setValue(Boxing.boxBoolean(com.code.android.util.o000000.OooO00o(Boxing.boxInt(jSONObject.getInt("isVIP")))));
                ...
                if (jSONObject.has("showKAVIP")) {
                    roomUserInfoModel.getShowVIP().setValue(Boxing.boxBoolean(com.code.android.util.o000000.OooO00o(Boxing.boxInt(jSONObject.getInt("showKAVIP")))));
                }
                if (jSONObject.has("showPremiumFirst")) {
                    roomUserInfoModel.getShowPremiumFirst().setValue(Boxing.boxBoolean(com.code.android.util.o000000.OooO00o(Boxing.boxInt(jSONObject.getInt("showPremiumFirst")))));
                }
                ...
                if (jSONObject.has("priority")) {
                    ...
                    SnapshotStateList<Long> snapshotStateList = com.yalla.yalla.service.room.OooO00o.f24519OooOO0.f48495OooO0OO;
                ...
                long j = this.f24673OooO0o;
                if (zHas2) {
                    boolean z2 = jSONObject.getBoolean("wealthShow");
                    o0O00oO0 o0o00oo1 = o0O00oO0.f47936OooO00o;
                    Long l = (Long) o0O00oO0.OooOOo0().getValue();
                    if (l != null && j == l.longValue()) {
                        MutableLiveData mutableLiveDataOooOo = o0O00oO0.OooOo();
                        if (!z2) {
                            z = false;
                        }
                ...
                if (l2 != null && j == l2.longValue()) {
                    if (jSONObject.has("wealthShow")) {
                        o0O00oO0.OooOo().postValue(Boxing.boxBoolean(jSONObject.getBoolean("wealthShow")));
                    }
                    if (jSONObject.has("wealthLevel")) {
                        o0O00oO0.OooO0oO().postValue(Boxing.boxInt(jSONObject.getInt("wealthLevel")));
                    }
                    if (jSONObject.has("wealthValue")) {
                        ((MutableLiveData) o0O00oO0.f47975Oooo0oO.getValue()).postValue(Boxing.boxLong(jSONObject.getLong("wealthValue")));
                    }
                    if (jSONObject.has("wealthBadgeUrl")) {
                        o0O00oO0.OooO0o().postValue(jSONObject.getString("wealthBadgeUrl"));
                    }
                }
            } catch (Exception e) {
                if (!oo0o0Oo.OooO0o0()) {
    ...
    public static void OooO0O0(byte[] bArr) {
        ...
        o0000O00.OooO0O0("parseBroadcastMessage->".concat(str));
        AbsJavaBeanApi absJavaBeanApi = (AbsJavaBeanApi) oOOO00.OooO0O0(str, new TypeToken<AbsJavaBeanApi<RoomBroadcastModel>>() { // from class: com.yalla.yalla.service.room.processor.RoomCommonMsgProcessor$parseBroadcastMessage$1
        }.getType());
        if (absJavaBeanApi == null || (roomLoginInformation = MixedRoomDataSource.OooO0o0().f22992OooO0o0) == null) {
            return;
        }
        ...
        if (model != 0) {
            ...
            o0O00oO0 o0o00oo1 = o0O00oO0.f47936OooO00o;
            if (Intrinsics.areEqual(lValueOf, o0O00oO0.OooOOo0().getValue()) && ((RoomBroadcastModel) absJavaBeanApi.data).getBalance() > 0) {
                MixedRoomDataSource.OooO0o0().f22994OooO0oo.postValue(Integer.valueOf(((RoomBroadcastModel) absJavaBeanApi.data).getBalance()));
            }
    ...
    public static void OooO0o(int i, byte[] bArr) throws InvalidProtocolBufferException {
        ...
        if (from != null) {
            o0000O00.OooO0OO(com.yalla.yalla.service.room.processor.OooO00o.C0318OooO00o.OooO00o(f24666OooO00o), "parseSearchUserMessage what = " + i + "  data = " + from);
    ...
    public static void OooO0o0(int i, byte[] bArr) throws InvalidProtocolBufferException {
        ...
        if (from != null) {
            o0000O00.OooO0OO(com.yalla.yalla.service.room.processor.OooO00o.C0318OooO00o.OooO00o(f24666OooO00o), "parseRoomContributionMessage what = " + i + "  data = " + from);
    ...
    public final void OooO0OO(@NotNull RoomLoginInformation loginInfo) {
        ...
        if (o00Ooo.OooO0Oo().OooO0O0("IsNewUserFirstEnterRoom", false)) {
            o00Ooo.OooO0Oo().OooO0o("IsNewUserFirstEnterRoom", false);
            o0oo0000.OooO00o.OooO0O0("101062");
        }
        MixedRoomDataSource mixedRoomDataSourceOooO0o0 = MixedRoomDataSource.OooO0o0();
        mixedRoomDataSourceOooO0o0.getClass();
        o0000O00.OooO0OO("setRoomLoginInformation", loginInfo.toString());
        mixedRoomDataSourceOooO0o0.f22992OooO0o0 = loginInfo;
        ...
        oooO0O0OooO00o.f24548OooOOO0.postValue(room.getBackground());
        oooO0O0OooO00o.f24547OooOOO.postValue(room.getBackgroundvideo());
        oooO0O0OooO00o.f24546OooOO0o.postValue(Integer.valueOf(loginInfo.getPosition()));
        oooO0O0OooO00o.f24552OooOOo0.postValue(Integer.valueOf(loginInfo.getRoom().getDues()));
        oooO0O0OooO00o.f24541OooO0o0.postValue(Integer.valueOf(loginInfo.getRoom().getRegion()));
        oooO0O0OooO00o.OooO0o().postValue(Integer.valueOf(loginInfo.getRoom().getLucknumcost()));
        oooO0O0OooO00o.OooO().postValue(Boolean.valueOf(loginInfo.getRoom().getLuckNumAdmin()));
        ...
        ((MutableLiveData) oooO0O0OooO00o.f24567Oooo0.getValue()).postValue(Integer.valueOf(loginInfo.getRoom().getLucknumset()));
        p483o0o000Oo.o000000 o000000Var = com.yalla.yalla.service.room.OooO00o.f24516OooO0o0;
        o000000Var.f48463OooO0o.setValue(room.getNotice());
        oooO0O0OooO00o.f24540OooO0o.postValue(Integer.valueOf(room.getLevel()));
        o0O00oO0 o0o00oo1 = o0O00oO0.f47936OooO00o;
        if (!((Boolean) o0O00oO0.OooOo0O().getValue()).booleanValue()) {
            oO0OOo0o oo0ooo0oOooO0o0 = o00Ooo.OooO0o0();
            oo0ooo0oOooO0o0.getClass();
            if (oo0ooo0oOooO0o0.OooO0O0("touristLoginRoom" + o0O00oO0.OooOOo0().getValue(), false)) {
                Job job = oooO0O0OooO00o.f24574Oooo0o0;
                if (job != null) {
                    Job.DefaultImpls.cancel$default(job, (CancellationException) null, 1, (Object) null);
                }
                oooO0O0OooO00o.f24574Oooo0o0 = BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, null, null, new p482o0o000OO.OooOOOO(oooO0O0OooO00o, null), 3, null);
            }
        }
        oO000o00 oo000o00OooO0oo = o00Ooo.OooO0oo();
        int autoGrabBonus = loginInfo.getAutoGrabBonus();
        oo000o00OooO0oo.getClass();
        oo000o00OooO0oo.OooO0oO(autoGrabBonus, "autoShowLuckyPacketDialog" + o0O00oO0.OooOOo0().getValue());
        RoomTheme roomTheme = new RoomTheme();
        roomTheme.roomId = room.getId();
        roomTheme.roomTheme = room.getBackground();
        o00Oo0.OooO00o().OooOooO().OooO00o(roomTheme);
        ...
        o000O000 o000o001 = new o000O000(App.f22232OooO0o);
        ...
        List<String> list = Oooo0.f43359OooOoo;
        com.yalla.yalla.http.iteratehttp.OooO0OO.OooO0O0(null, list, Oooo0.f43438o0OO00O, linkedHashMapOooO00o, o000o001);
        Long lValueOf = Long.valueOf(o000000Var.OooO0o0());
        o00oO0o o00oo0o2 = p384o0OOoo0O.o0OO00O.f43462OooO00o;
        o000O0o o000o0o2 = new o000O0o();
        LinkedHashMap linkedHashMapOooO00o2 = p426o0OoO0o0.OooOOOO.OooO00o();
        linkedHashMapOooO00o2.put("barid", String.valueOf(lValueOf));
        com.yalla.yalla.http.iteratehttp.OooO0OO.OooO0O0(null, list, Oooo0.f43445oo000o, linkedHashMapOooO00o2, o000o0o2);
        if (((Boolean) o0O00oO0.OooOo0O().getValue()).booleanValue()) {
            mixedRoomDataSourceOooO0o0.OooOOO();
        }
        p391o0OOooo0.oo0o0Oo.OooO0Oo(false);
        if (!mixedRoomDataSourceOooO0o0.f22999OooOOO0) {
        ...
        mixedRoomDataSourceOooO0o0.f22999OooOOO0 = true;
        ...
        if (((Boolean) com.yalla.yalla.service.room.OooO00o.f24524OooOOOO.f48543OooOoO0.getValue()).booleanValue()) {
    ...
    public final void OooO0Oo(int i, @Nullable Object obj) {
        ...
        try {
            if (i == 10019) {
                ...
                BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), null, null, new p485o0o000oO.o000O000(new JSONObject(new String((byte[]) obj, Charsets.UTF_8)), null), 3, null);
            } else if (i == 10053) {
                OooO0o0(i, (byte[]) obj);
            } else if (i == 100702) {
            ...
            if (!oo0o0Oo.OooO0o0()) {
                ...
                o0000O00.OooO0o0("RoomCommonMsgProcessor", "Exception", e);
            }
            e.printStackTrace();
        }
    }
    ...
    public final void OooO0oO(@NotNull String data) {
        ...
        o0000O00.OooO0OO(com.yalla.yalla.service.room.processor.OooO00o.C0318OooO00o.OooO00o(this), "parseUserInfoChangedMessage data = ".concat(data));
