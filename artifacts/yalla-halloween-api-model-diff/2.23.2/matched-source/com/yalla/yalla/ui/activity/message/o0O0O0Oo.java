...
public final class o0O0O0Oo extends Lambda implements Function1<YallaTeamMessage, Unit> {
    ...
    public final /* synthetic */ YallaTeamMessageActivity f25500OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0O0O0Oo(YallaTeamMessageActivity yallaTeamMessageActivity) {
        super(1);
        this.f25500OooO0Oo = yallaTeamMessageActivity;
    }

    /* JADX WARN: Code duplicated, block: B:85:0x028e  */
    ...
    public final Unit invoke(YallaTeamMessage yallaTeamMessage) {
        ...
        if (it.getType() == 5 && p423o0OoO0OO.o00O00OO.OooO0o(it.getBuriedPointMessageId()) && p423o0OoO0OO.o00O00OO.OooO0o(it.getBuriedPointSource())) {
            o0oo0000.OooO00o.OooO0OO("104041", MapsKt.mapOf(TuplesKt.to("messageid", it.getBuriedPointMessageId()), TuplesKt.to("source", it.getBuriedPointSource())));
        }
        int i3 = YallaTeamMessageActivity.f25319OooOoo0;
        YallaTeamMessageActivity context = this.f25500OooO0Oo;
        context.getClass();
        p569o0oOo0o0.o0ooOOo o0ooooo = null;
        if (it.getMessageType() != 2) {
            int jumpType = it.getJumpType();
            int i4 = MainActivity.f24940OooOoo;
            switch (jumpType) {
                case 1:
                    ...
                    break;
                case 2:
                    p583o0oOoo00.o00000OO.f56671OooOOO0.observe(context, new YallaTeamMessageActivity.OooO00o(new o0O0o00O(it, context)));
                    break;
                case 3:
                    p583o0oOoo00.o00000OO.f56669OooOO0o.observe(context, new YallaTeamMessageActivity.OooO00o(new o0O0o0(it, context)));
                    break;
                case 4:
                ...
                default:
                    switch (jumpType) {
                        case 103:
                            n0.OooO00o(null, null, Long.valueOf(com.code.android.util.o0OoOo0.OooO(0L, it.getJumpId())), 3);
                            break;
                        case 104:
                            ...
                            int i5 = MomentDetailActivity.f25608Oooo0;
                        ...
                        case 106:
                            ...
                            break;
                        case 107:
                            n0.OooO00o(Integer.valueOf(com.code.android.util.o000000.OooO0o0(it.getJumpId())), GiftPropTypeUser.Backpack, null, 4);
                            break;
                        case 108:
                            RedemptionCodeScreen.navigate$default(RedemptionCodeScreen.INSTANCE, null, 1, null);
                            break;
                        case 109:
                            p569o0oOo0o0.o0ooOOo o0ooooo2 = p569o0oOo0o0.o00000OO.f56398OooO00o;
                            if (o0ooooo2 != null) {
                                o0ooooo = o0ooooo2;
                            } else {
                            ...
                            break;
                        default:
                            com.code.android.util.o000O00.OooO00o(p562o0oOo000.o000000.Yalla_Update_Latest_Version);
                            break;
                    }
                    break;
            }
            ...
            p532o0o0OOo0.o00O00.OooO0o0(YallaTeamImageMessageScreen.INSTANCE, bundleOooO00o, false, null, 12);
        }
