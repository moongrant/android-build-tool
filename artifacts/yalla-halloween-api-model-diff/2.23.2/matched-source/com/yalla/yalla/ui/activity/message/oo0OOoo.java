...
public final class oo0OOoo extends Lambda implements Function2<Integer, MoreModel, Unit> {
    ...
    public final /* synthetic */ View f25547OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ YallaTeamMessageActivity f25548OooO0o0;
    ...
    public oo0OOoo(View view, YallaTeamMessageActivity yallaTeamMessageActivity) {
        super(2);
        this.f25547OooO0Oo = view;
        this.f25548OooO0o0 = yallaTeamMessageActivity;
    }
    ...
    public final Unit invoke(Integer num, MoreModel moreModel) {
        ...
        if (OooO00o.$EnumSwitchMapping$0[moreModel2.getTag().ordinal()] == 1) {
            View view = this.f25547OooO0Oo;
            Intrinsics.checkNotNull(view, "null cannot be cast to non-null type android.widget.TextView");
            String string = ((TextView) view).getText().toString();
            YallaTeamMessageActivity yallaTeamMessageActivity = this.f25548OooO0o0;
            yallaTeamMessageActivity.getClass();
            String string2 = yallaTeamMessageActivity.getString(p562o0oOo000.o000000.Copied);
            Intrinsics.checkNotNullExpressionValue(string2, "getString(...)");
            p423o0OoO0OO.o00O00OO.OooO00o(yallaTeamMessageActivity, string, string2);
        }
