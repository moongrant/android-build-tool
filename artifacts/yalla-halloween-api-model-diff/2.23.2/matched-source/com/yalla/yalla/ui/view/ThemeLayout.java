...
public final class ThemeLayout extends FrameLayout {
    ...
    public static final /* synthetic */ int f30213OooO0o0 = 0;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public final O0O0 f30214OooO0Oo;
    ...
    public static final class OooO00o extends OooOO0O {
        ...
        public final void OooO0O0(int i, boolean z) {
            if (z) {
                ThemeLayout.this.f30214OooO0Oo.f43694OooOo00.setAlpha(1.0f);
            }
        }
    }
    ...
    public ThemeLayout(@NotNull Context context) {
        ...
        O0O0 o0o0Inflate = O0O0.inflate(LayoutInflater.from(getContext()), this, true);
        Intrinsics.checkNotNullExpressionValue(o0o0Inflate, "inflate(...)");
        this.f30214OooO0Oo = o0o0Inflate;
    }
    ...
    public static void OooO0OO(ThemeLayout themeLayout, ThemeModel item, boolean z, oo000o oo000oVar, o00oO0o o00oo0o2, int i) {
        ...
        ImageView imageView = o0o0.f43680OooO0o;
        TextView textView = o0o0.f43693OooOOoo;
        if (isRoomTeamAward) {
            Intrinsics.checkNotNullExpressionValue(textView, "tvThemeType");
            oOOO000o.OooO00o(textView, o0000.OooO00o(o0OOO0o.color_FFEE63), o0000.OooO00o(o0OOO0o.color_FFA907));
            imageView.setImageResource(o0O0O00.ic_room_member_host);
            textView.setText(o0000.OooO0OO(o000000.room_theme_mine_member_group_reward));
            textView.setSelected(true);
        } else if (item.getIsBoxAward()) {
            Intrinsics.checkNotNullExpressionValue(textView, "tvThemeType");
            oOOO000o.OooO00o(textView, o0000.OooO00o(o0OOO0o.color_FFEF9D), o0000.OooO00o(o0OOO0o.color_FFCC50));
            imageView.setImageResource(o0Oo0oo.room_ic_theme_box_award);
            textView.setText(o0000.OooO0OO(o000000.room_theme_mine_chest_reward));
            ...
            if (i3 == 2) {
                oOOO000o.OooO00o(textView, o0000.OooO00o(o0OOO0o.color_FBE7D7), o0000.OooO00o(o0OOO0o.color_C89272));
            } else if (i3 == 3) {
                oOOO000o.OooO00o(textView, o0000.OooO00o(o0OOO0o.color_E4FEF9), o0000.OooO00o(o0OOO0o.color_B9FDBB));
            } else if (i3 == 4) {
                oOOO000o.OooO00o(textView, o0000.OooO00o(o0OOO0o.color_DCF5FE), o0000.OooO00o(o0OOO0o.color_91D7FB));
            } else if (i3 == 5) {
                oOOO000o.OooO00o(textView, o0000.OooO00o(o0OOO0o.color_F9DBE9), o0000.OooO00o(o0OOO0o.color_F090B6));
            } else if (i3 == 6) {
                oOOO000o.OooO00o(textView, o0000.OooO00o(o0OOO0o.color_FAE3FD), o0000.OooO00o(o0OOO0o.color_F099F9));
            }
        ...
        TextView tvActivityTheme = o0o0.f43686OooOO0o;
        Intrinsics.checkNotNullExpressionValue(tvActivityTheme, "tvActivityTheme");
        oOOO000o.OooO00o(tvActivityTheme, o0000.OooO00o(o0OOO0o.color_FCF), o0000.OooO00o(o0OOO0o.color_D7A5F6), o0000.OooO00o(o0OOO0o.color_B8F));
        Intrinsics.checkNotNullExpressionValue(tvActivityTheme, "tvActivityTheme");
        ...
        if (themeTagType == 0) {
            ...
            strOooO0OO = o0000.OooO0OO(z4 ? o000000.Purchased : o000000.Purchase);
        } else if (themeTagType == 1) {
            Intrinsics.checkNotNullExpressionValue(tvActivityTheme, "tvActivityTheme");
            o000O.OooO0O0(tvActivityTheme);
            strOooO0OO = o0000.OooO0OO(z4 ? o000000.Obtained : o000000.Obtain);
        ...
        TextView tvRemainNum2 = o0o0.f43687OooOOO;
        LinearLayout llBottomPurchase = o0o0.f43675OooO;
        ImageView ivZoomTheme = o0o0.f43682OooO0oO;
        if (!z3) {
            ...
            if (StringsKt.isBlank(item.getVideoPath())) {
                ...
                ivZoomTheme.setImageResource(o0Oo0oo.room_ic_theme_scale_video);
            }
            ...
            tvRemainNum2.setText(o0000O.OooO00o(o0000.OooO0OO(o000000.days_remained), String.valueOf(item.getDayNum())));
            return;
        }
        Intrinsics.checkNotNullExpressionValue(ivZoomTheme, "ivZoomTheme");
        o000O.OooOOOO(ivZoomTheme);
        ivZoomTheme.setImageResource(StringsKt.isBlank(item.getVideoPath()) ^ true ? o0Oo0oo.room_ic_theme_scale_video : o0Oo0oo.room_ic_theme_scale);
        boolean isCanGive = item.getIsCanGive();
        FrameLayout flSendGift = o0o0.f43678OooO0OO;
        if (isCanGive) {
            Intrinsics.checkNotNullExpressionValue(flSendGift, "flSendGift");
            o000O.OooOOOO(flSendGift);
            flSendGift.setOnClickListener(new View.OnClickListener() { // from class: o0oOooOO.g2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    int i4 = ThemeLayout.f30213OooO0o0;
        ...
        Drawable drawableOooO0O0 = ((z2 && z4) || !z2 || z4) ? o0000.OooO0O0(o0Oo0oo.room_shape_theme_can_not_purchase) : o0000.OooO0O0(o0Oo0oo.room_shape_theme_purchase);
        TextView textView2 = o0o0.f43691OooOOo;
        textView2.setBackground(drawableOooO0O0);
        int iOooO00o = ((z2 && z4) || !z2 || z4) ? o0000.OooO00o(o0OOO0o.color_321) : o0000.OooO00o(o0OOO0o.color_630);
        ...
        textView2.setOnClickListener(new View.OnClickListener() { // from class: o0oOooOO.h2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                int i4 = ThemeLayout.f30213OooO0o0;
    ...
    public final void OooO00o(@NotNull ThemeModel item) {
        Intrinsics.checkNotNullParameter(item, "item");
        O0O0 o0o0 = this.f30214OooO0Oo;
        o0o0.f43690OooOOOo.setText(item.getName());
        if (item.getIsHave() == 1 || item.getLimitNum() <= 0) {
            TextView tvLimitTime = o0o0.f43688OooOOO0;
            Intrinsics.checkNotNullExpressionValue(tvLimitTime, "tvLimitTime");
            o000O.OooO0O0(tvLimitTime);
        } else {
            TextView tvLimitTime2 = o0o0.f43688OooOOO0;
            Intrinsics.checkNotNullExpressionValue(tvLimitTime2, "tvLimitTime");
            o000O.OooOOOO(tvLimitTime2);
            o0o0.f43688OooOOO0.setText(o0000O.OooO00o(o0000.OooO0OO(o000000.days_special), String.valueOf(item.getLimitNum())));
        }
    }
    ...
    public final void OooO0O0(@NotNull ThemeModel item, @Nullable Function0<Unit> function0) {
        ...
        if (defaultDrawable) {
            ...
            oooO00o.f43130OooO0oO = o0Oo0oo.icon_room_bg;
            oooO00o.f43124OooO00o = 1;
            oooO00o.f43138OooOOOo = o0Oo0oo.icon_room_theme_placeholder_big;
            oooO00o.OooO0o0(8);
            oooO00o.OooO0Oo(o0o0.f43681OooO0o0);
        } else {
            try {
                o0o0.f43694OooOo00.setAlpha(0.4f);
                Oooo000.OooO00o oooO00o2 = new Oooo000.OooO00o(getContext());
                oooO00o2.f43126OooO0OO = p184o00o00O0.OooO0OO.OooO0oo(o0000O0.OooO00o(165), o0000O0.OooO00o(269), item.getPic());
                oooO00o2.f43124OooO00o = 0;
                oooO00o2.f43138OooOOOo = o0Oo0oo.icon_room_theme_placeholder_big;
                oooO00o2.OooO0o0(8);
                oooO00o2.f43133OooOO0O = new OooO00o();
                oooO00o2.OooO0Oo(o0o0.f43681OooO0o0);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
        o0o0.f43681OooO0o0.setOnClickListener(new f1(function0, 1));
    }

    public final void setSelectTheme(boolean isSelected) {
        O0O0 o0o0 = this.f30214OooO0Oo;
        if (isSelected) {
            FrameLayout flSelectedThemeBg = o0o0.f43677OooO0O0;
            Intrinsics.checkNotNullExpressionValue(flSelectedThemeBg, "flSelectedThemeBg");
            o000O.OooOOOO(flSelectedThemeBg);
        } else {
            FrameLayout flSelectedThemeBg2 = o0o0.f43677OooO0O0;
