...
public final class RefreshView extends FrameLayout implements OooO {
    ...
    @Nullable
    public final o00 f30732OooO0Oo;
    ...
    public final void OooO00o(@NotNull OooOOO0 refreshLayout, @NotNull RefreshState oldState, @NotNull RefreshState newState) {
        ...
        o00 o00Var = this.f30732OooO0Oo;
        if (i == 1) {
            if (o00Var != null) {
                o00Var.f38647OooO0o = o00Var.f38646OooO0Oo;
            }
        } else {
            if (i != 2 || o00Var == null || o00Var.f38647OooO0o == 0) {
                return;
            }
    ...
    public RefreshView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        View.inflate(context, oo0o0Oo.view_refresh, this);
        ImageView imageView = (ImageView) findViewById(o0OO00O.ivRefresh);
        Intrinsics.checkNotNull(imageView);
        this.f30732OooO0Oo = new o00(imageView, o00oO0o.anim_loading_horse_green, 1000L);
    }
}
