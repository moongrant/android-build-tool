...
public final class AccountProtectionVM extends OooOO0 {
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<LiveDataScope<ApiResult<List<TrustedDevice>>>, Continuation<? super Unit>, Object> {
        ...
        public /* synthetic */ Object f31021OooO0o0;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f31021OooO0o0;
            ...
            this.f31021OooO0o0 = liveDataScope;
            this.f31020OooO0Oo = 1;
            accountRepo.getClass();
            String str = OooOOO0.f43293OooO0o0;
            obj = OooOOO.OooO0Oo(new AccountRepo$getTrustDeviceList$$inlined$call$1(oo000o.OooO00o(str, "url", str, 0), null), this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f31021OooO0o0 = null;
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<LiveDataScope<ApiResult<String>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31022OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f31023OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f31024OooO0o0;
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0O0 oooO0O0 = new OooO0O0(this.f31023OooO0o, continuation);
            oooO0O0.f31024OooO0o0 = obj;
            return oooO0O0;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            LiveDataScope liveDataScope;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31022OooO0Oo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f31024OooO0o0;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
