...
public class LoginVM extends OooOO0 {
    ...
    public static final class OooO extends ContinuationImpl {
        ...
        public /* synthetic */ Object f31102OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f31103OooO0o;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f31102OooO0Oo = obj;
            this.f31103OooO0o |= Integer.MIN_VALUE;
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<LiveDataScope<ApiResult<LoginModel>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public ApiResult f31105OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public /* synthetic */ Object f31106OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public int f31107OooO0o0;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f31107OooO0o0;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f31106OooO0o;
                    ResultKt.throwOnFailure(obj);
                } else if (i == 2) {
                    apiResult2 = this.f31105OooO0Oo;
                    liveDataScope2 = (LiveDataScope) this.f31106OooO0o;
                    ResultKt.throwOnFailure(obj);
                    apiResult = apiResult2;
                    liveDataScope = liveDataScope2;
                    this.f31106OooO0o = null;
                    this.f31105OooO0Oo = null;
                    this.f31107OooO0o0 = 3;
            ...
            ResultKt.throwOnFailure(obj);
            LiveDataScope liveDataScope3 = (LiveDataScope) this.f31106OooO0o;
            AccountRepo accountRepo = AccountRepo.f22385OooO00o;
            this.f31106OooO0o = liveDataScope3;
            this.f31107OooO0o0 = 1;
            ...
            if (apiResult.isSuccess()) {
                ...
                this.f31106OooO0o = liveDataScope;
                this.f31105OooO0Oo = apiResult;
                this.f31107OooO0o0 = 2;
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ LoginToken f31110OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ boolean f31111OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ MyUserInfoModel f31112OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ OpenAuthManager.AuthType f31113OooO0oo;
        ...
        public OooO0OO(boolean z, MyUserInfoModel myUserInfoModel, LoginToken loginToken, OpenAuthManager.AuthType authType, Continuation continuation) {
            super(2, continuation);
            this.f31111OooO0o0 = z;
            this.f31110OooO0o = loginToken;
            this.f31112OooO0oO = myUserInfoModel;
            this.f31113OooO0oo = authType;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return LoginVM.this.new OooO0OO(this.f31111OooO0o0, this.f31112OooO0oO, this.f31110OooO0o, this.f31113OooO0oo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) throws JSONException {
            ...
            LoginVM loginVM = LoginVM.this;
            boolean z = this.f31111OooO0o0;
            LoginToken loginToken = this.f31110OooO0o;
            MyUserInfoModel myUserInfoModel = this.f31112OooO0oO;
            loginVM.saveAccountData(z, loginToken, myUserInfoModel);
            loginVM.saveDataToSp(z, myUserInfoModel);
            loginVM.insertWelcomeMessage(z);
            loginVM.logSuccessEvent(z, this.f31113OooO0oo);
            o0o0000.OooO00o.OooO00o();
            o0O00oO0.OooOo0O().setValue(Boxing.boxBoolean(true));
            LiveEventBus.get("LOGIN_RESULT").post(Boxing.boxBoolean(true));
            loginVM.changeLanguageAndRoom(!Intrinsics.areEqual(num, o0O00oO0.OooOOO0().getValue()));
            oOO0000.OooO0O0(true);
    ...
    public static final class OooO0o extends SuspendLambda implements Function2<LiveDataScope<ApiResult<LoginListModel>>, Continuation<? super Unit>, Object> {
        ...
        public final /* synthetic */ String f31114OooO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public ApiResult f31115OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public /* synthetic */ Object f31116OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public int f31117OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ OpenAuthManager.AuthType f31118OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ String f31119OooO0oo;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public final /* synthetic */ LoginVM f31120OooOO0;
        ...
        public OooO0o(OpenAuthManager.AuthType authType, String str, String str2, LoginVM loginVM, Continuation<? super OooO0o> continuation) {
            super(2, continuation);
            this.f31118OooO0oO = authType;
            this.f31119OooO0oo = str;
            this.f31114OooO = str2;
            this.f31120OooOO0 = loginVM;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0o oooO0o = new OooO0o(this.f31118OooO0oO, this.f31119OooO0oo, this.f31114OooO, this.f31120OooOO0, continuation);
            oooO0o.f31116OooO0o = obj;
            return oooO0o;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            LiveDataScope liveDataScope3;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            switch (this.f31117OooO0o0) {
                case 0:
                    ResultKt.throwOnFailure(obj);
                    liveDataScope = (LiveDataScope) this.f31116OooO0o;
                    int i = OooO00o.$EnumSwitchMapping$0[this.f31118OooO0oO.ordinal()];
                    o00O0OO o00o0oo2 = o00O0OO.f46099OooO00o;
                    String str = this.f31114OooO;
                    String str2 = this.f31119OooO0oo;
                    if (i == 1) {
                        Intrinsics.checkNotNull(str);
                        this.f31116OooO0o = liveDataScope;
                        this.f31117OooO0o0 = 1;
                        obj = o00o0oo2.OooO0oO(str2, str, this);
                        ...
                        if (apiResult2.isSuccess()) {
                            ...
                            if (!z) {
                                ...
                                if (token != null) {
                                    ...
                                    authType = this.f31118OooO0oO;
                                    this.f31116OooO0o = liveDataScope2;
                                    this.f31115OooO0Oo = apiResult2;
                                    this.f31117OooO0o0 = 6;
                        ...
                        this.f31116OooO0o = null;
                        this.f31115OooO0Oo = null;
                        this.f31117OooO0o0 = 7;
                    ...
                    if (i == 2) {
                        this.f31116OooO0o = liveDataScope;
                        this.f31117OooO0o0 = 2;
                        obj = o00o0oo2.OooO0OO(str2, this);
                        if (obj == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        apiResult = (ApiResult) obj;
                    ...
                    if (i == 4) {
                        this.f31116OooO0o = liveDataScope;
                        this.f31117OooO0o0 = 4;
                        obj = this.f31120OooOO0.yallaChatLoginCovert(str2, this);
                        if (obj == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        apiResult = (ApiResult) obj;
                    ...
                    this.f31116OooO0o = liveDataScope;
                    this.f31117OooO0o0 = 5;
                    obj = o00o0oo2.OooO0Oo(str2, strValueOf, this);
                    if (obj == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    apiResult = (ApiResult) obj;
                ...
                case 5:
                    ...
                    return Unit.INSTANCE;
                case 6:
                    apiResult2 = this.f31115OooO0Oo;
                    liveDataScope3 = (LiveDataScope) this.f31116OooO0o;
                    ResultKt.throwOnFailure(obj);
                    liveDataScope2 = liveDataScope3;
                    this.f31116OooO0o = null;
                    this.f31115OooO0Oo = null;
    ...
    public final void changeLanguageAndRoom(boolean regionChange) {
        ...
        if (regionChange) {
            ...
            if (o0Oo0oo.OooO0oO() == RoomState.InRoom) {
                String strOooO0OO = o0000.OooO0OO(o000000.reenter_room);
    ...
    public final void insertWelcomeMessage(boolean isFirst) {
        if (isFirst) {
            ...
            message.setMid(o0O0o00O.f55755OooO00o.OooO00o(null));
            message.setType(6);
    ...
    public final void logSuccessEvent(boolean isFirst, OpenAuthManager.AuthType type) {
        ...
        if (i2 == 2) {
            o0oo0000.OooO00o.OooO0O0("201034");
        } else if (i2 == 3) {
            o0oo0000.OooO00o.OooO0O0("201036");
        } else {
            if (i2 != 5) {
                return;
            }
            o0oo0000.OooO00o.OooO0O0("201038");
        }
    }
    ...
    public final void saveAccountData(boolean isFirst, LoginToken token, MyUserInfoModel userInfoModel) {
        o0O00oO0 o0o00oo1 = o0O00oO0.f47936OooO00o;
        o0O00oO0.OooOoo0(false, userInfoModel);
        o0O00oO0.OooOoOO(token.getToken(), token.getTokenActivity(), token.getTokenChat(), token.getTokenRoom());
        o0O00oO0.f47939OooO0Oo = isFirst;
    }
    ...
    public final void saveDataToSp(boolean isFirst, MyUserInfoModel userInfoModel) {
        if (isFirst) {
            ...
            oo0ooo0oOooO0o0.OooO0o("room" + o0O00oO0.OooOOo0().getValue(), true);
            oO0OOo0o oo0ooo0oOooO0o1 = o00Ooo.OooO0o0();
            oo0ooo0oOooO0o1.getClass();
            oo0ooo0oOooO0o1.OooO0o("roomChat" + o0O00oO0.OooOOo0().getValue(), true);
            oO0OOo0o oo0ooo0oOooO0o2 = o00Ooo.OooO0o0();
            oo0ooo0oOooO0o2.getClass();
            oo0ooo0oOooO0o2.OooO0o("roomGift" + o0O00oO0.OooOOo0().getValue(), true);
            oO0OOo0o oo0ooo0oOooO0o3 = o00Ooo.OooO0o0();
            oo0ooo0oOooO0o3.getClass();
            oo0ooo0oOooO0o3.OooO0o("roomHook" + o0O00oO0.OooOOo0().getValue(), true);
            o00Ooo.OooO0o0().OooOOO(true);
            o0O00oO0 o0o00oo1 = o0O00oO0.f47936OooO00o;
            ((MutableLiveData) o0O00oO0.f47938OooO0OO.getValue()).postValue(Boolean.TRUE);
            oO0OOo0o oo0ooo0oOooO0o4 = o00Ooo.OooO0o0();
            oo0ooo0oOooO0o4.getClass();
            oo0ooo0oOooO0o4.OooO0o("messageDot" + o0O00oO0.OooOOo0().getValue(), true);
            oO0OOo0o oo0ooo0oOooO0o5 = o00Ooo.OooO0o0();
            oo0ooo0oOooO0o5.getClass();
            o0000O0O.OooO0O0("language", o0O00oO0.OooOOo0().getValue(), oo0ooo0oOooO0o5, true);
        ...
        o00Ooo.OooOO0O().OooOOOo(GiftPropTypeUser.Backpack.getValue(), false);
        o00Ooo.OooOO0O().OooOOO0(VipLevel.Vip6.level());
        oO0OOo0o oo0ooo0oOooO0o6 = o00Ooo.OooO0o0();
        oo0ooo0oOooO0o6.getClass();
        oo0ooo0oOooO0o6.OooO0o("giftBackpackFirstReminderTips" + o0O00oO0.OooOOo0().getValue(), true);
        oO0OOo0o oo0ooo0oOooO0o7 = o00Ooo.OooO0o0();
        oo0ooo0oOooO0o7.getClass();
        oo0ooo0oOooO0o7.OooO0o("isConveneMembersRead" + o0O00oO0.OooOOo0().getValue(), false);
        o00Ooo.OooO0o0().OooOOOo();
        oO0OOo0o oo0ooo0oOooO0o8 = o00Ooo.OooO0o0();
        oo0ooo0oOooO0o8.getClass();
        oo0ooo0oOooO0o8.OooO0o("showRoomApplyMicSettingDot" + o0O00oO0.OooOOo0().getValue(), false);
        o00Ooo.OooO0o0().OooOOo0();
        oO0OOo0o oo0ooo0oOooO0o9 = o00Ooo.OooO0o0();
        oo0ooo0oOooO0o9.getClass();
        oo0ooo0oOooO0o9.OooO0o("roomSettingActionRecord" + o0O00oO0.OooOOo0().getValue(), false);
        o00Ooo.OooO0o0().OooOOO0();
    }
    ...
    public final Object yallaChatLoginCovert(String str, Continuation<? super ApiResult<LoginListModel>> continuation) {
        ...
        if (continuation instanceof OooO) {
            ...
            int i = oooO.f31103OooO0o;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO.f31103OooO0o = i - Integer.MIN_VALUE;
            } else {
        ...
        Object objOooO = oooO.f31102OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = oooO.f31103OooO0o;
        if (i2 == 0) {
            ResultKt.throwOnFailure(objOooO);
            o00O0OO o00o0oo2 = o00O0OO.f46099OooO00o;
            oooO.f31103OooO0o = 1;
            objOooO = o00o0oo2.OooO(str, oooO);
    ...
    public final LiveData<ApiResult<LoginModel>> activeAccount() {
        return com.code.android.util.o00oO0o.OooO00o(new OooO0O0(null));
    }
    ...
    public final LiveData<ApiResult<LoginListModel>> thirdLogin(@NotNull String accessToken, @NotNull OpenAuthManager.AuthType type, @Nullable String twitterSecretOrInsUserId) {
        ...
        return com.code.android.util.o00oO0o.OooO00o(new OooO0o(type, accessToken, twitterSecretOrInsUserId, this, null));
    }
}
