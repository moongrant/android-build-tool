...
import p412o0Oo0o0O.o00O00o0;
import p412o0Oo0o0O.o00O0O0;
import p412o0Oo0o0O.o00O0O00;
import p412o0Oo0o0O.o00OOO00;
...
public final class ShareToFriendVM extends OooOO0 {
    ...
    public static final class OooO00o extends Lambda implements Function0<o0O0O00<Integer, FriendInfo>> {
        ...
        public static final OooO00o f31467OooO0Oo = new OooO00o();
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<LiveDataScope<ApiResult<RoomThemeGiveInfo>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31468OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ long f31469OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f31470OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ long f31471OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(long j, long j2, Continuation<? super OooO0O0> continuation) {
            super(2, continuation);
            this.f31469OooO0o = j;
            this.f31471OooO0oO = j2;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0O0 oooO0O0 = new OooO0O0(this.f31469OooO0o, this.f31471OooO0oO, continuation);
            oooO0O0.f31470OooO0o0 = obj;
            return oooO0O0;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f31468OooO0Oo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f31470OooO0o0;
            ...
            ResultKt.throwOnFailure(obj);
            liveDataScope = (LiveDataScope) this.f31470OooO0o0;
            o00OOO00 o00ooo00 = o00OOO00.f46203OooO00o;
            long j = this.f31469OooO0o;
            long j2 = this.f31471OooO0oO;
            this.f31470OooO0o0 = liveDataScope;
            this.f31468OooO0Oo = 1;
            obj = o00ooo00.OooO00o(j, j2, this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f31470OooO0o0 = null;
            this.f31468OooO0Oo = 2;
    ...
    public static final class OooO0OO extends Lambda implements Function0<o0O0O00<Integer, FriendInfo>> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ String f31472OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(String str) {
            super(0);
            this.f31472OooO0Oo = str;
        }

        @Override // kotlin.jvm.functions.Function0
        public final o0O0O00<Integer, FriendInfo> invoke() {
            String searchText = this.f31472OooO0Oo;
    ...
    public static final class OooO0o extends Lambda implements Function0<o0O0O00<Integer, FriendInfo>> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO0o f31473OooO0Oo = new OooO0o();
    ...
    public ShareToFriendVM() {
        ...
        OooO0o pagingSourceFactory = OooO0o.f31473OooO0Oo;
        ...
        OooO00o pagingSourceFactory2 = OooO00o.f31467OooO0Oo;
    ...
    public final LiveData<Boolean> sendEventRoomMsg(@NotNull List<Long> targetIds, long eventId, @NotNull String eventName, @NotNull String eventImgUrl, int eventTagId, long eventStartTime, long eventEndTime, long roomId, @NotNull String roomName, @NotNull String roomIp) {
        ...
        while (it.hasNext()) {
            ...
            msg = o000OO.OooOOO(((Number) it.next()).longValue(), eventId, eventName, eventImgUrl, eventTagId, eventStartTime, eventEndTime, roomId, roomName, roomIp, "", 0L, false);
            o000OO.OooO0oO(msg);
        ...
        BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, Dispatchers.getIO(), null, new o00O00o0(msg, mutableLiveData, targetIds, midList, null), 2, null);
    ...
    public final LiveData<Boolean> shareActivity(@NotNull List<Long> targetIds, @NotNull String activityImage, @NotNull String activityText1, @NotNull String activityText2, @NotNull String activityUrl, @NotNull String message, int activity) {
        ...
        while (it.hasNext()) {
            ...
            ArrayList arrayList2 = arrayList;
            ChatMessage chatMessageOooOO0o = o000OO.OooOO0o(jLongValue, activityImage, activityText1, activityText2, activityUrl, (416 & 32) != 0 ? "" : message, (416 & 64) != 0 ? "" : null, 0L, false);
            ...
            if (message.length() > 0) {
                ChatMessage chatMessageOooOo = o000OO.OooOo(jLongValue, message, null, 0L, false, 60);
        ...
        Intrinsics.checkNotNullParameter(msg, "msg");
        MutableLiveData mutableLiveData = new MutableLiveData();
        BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, Dispatchers.getIO(), null, new o00O00OO(msg, mutableLiveData, targetIds, midList, null), 2, null);
        return mutableLiveData;
    }
    ...
    public final LiveData<Boolean> shareMoment(@NotNull List<Long> targetIds, long momentId, @NotNull String momentImage, @NotNull String momentText, int momentType, @NotNull String message) {
        ...
        while (it.hasNext()) {
            long jLongValue = ((Number) it.next()).longValue();
            ChatMessage chatMessageOooOOOO = o000OO.OooOOOO(jLongValue, momentId, momentImage, momentText, momentType, (416 & 32) != 0 ? "" : message, (416 & 64) != 0 ? "" : null, 0L, false);
            o000OO.OooO0oO(chatMessageOooOOOO);
            if (message.length() > 0) {
                ChatMessage chatMessageOooOo = o000OO.OooOo(jLongValue, message, null, 0L, false, 60);
                o000OO.OooO0oO(chatMessageOooOo);
        ...
        Intrinsics.checkNotNullParameter(msg, "msg");
        MutableLiveData mutableLiveData = new MutableLiveData();
        BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, Dispatchers.getIO(), null, new oo00o(msg, mutableLiveData, targetIds, midList, null), 2, null);
        return mutableLiveData;
    }
    ...
    public final LiveData<Boolean> shareRoom(@NotNull List<Long> targetIds, long roomId, long roomIdx, @NotNull String roomName, @NotNull String roomHeader, @NotNull String message) {
        ...
        while (it.hasNext()) {
            long jLongValue = ((Number) it.next()).longValue();
            ArrayList arrayList2 = arrayList;
            ChatMessage chatMessageOooOOo0 = o000OO.OooOOo0(jLongValue, roomId, roomIdx, roomName, roomHeader, (864 & 32) != 0 ? "" : null, (864 & 64) != 0 ? "" : message, (864 & 128) != 0 ? "" : null, 0L, false);
    ...
    public final LiveData<Boolean> shareTopic(@NotNull List<Long> targetIds, long topicId, @NotNull String topicImage, @NotNull String topicName, int topicUserCount, int topicMomentCount, @NotNull String message) {
        ...
        while (it.hasNext()) {
            long jLongValue = ((Number) it.next()).longValue();
            ArrayList arrayList2 = arrayList;
            ChatMessage chatMessageOooOOoo = o000OO.OooOOoo(jLongValue, topicImage, topicName, topicUserCount, (832 & 64) != 0 ? "" : message, false, topicMomentCount, (832 & 128) != 0 ? "" : null, topicId, 0L);
            o000OO.OooO0oO(chatMessageOooOOoo);
            if (message.length() > 0) {
                ChatMessage chatMessageOooOo = o000OO.OooOo(jLongValue, message, null, 0L, false, 60);
                o000OO.OooO0oO(chatMessageOooOo);
    ...
    public final LiveData<Boolean> shareUser(@NotNull List<Long> targetIds, long userId, long userIdx, @NotNull String userName, @NotNull String userHead, @NotNull String message) {
        ...
        while (it.hasNext()) {
            long jLongValue = ((Number) it.next()).longValue();
            ArrayList arrayList2 = arrayList;
            ChatMessage chatMessageOooOo0 = o000OO.OooOo0(jLongValue, userId, userIdx, userName, userHead, (416 & 32) != 0 ? "" : message, (416 & 64) != 0 ? "" : null, 0L, false);
            o000OO.OooO0oO(chatMessageOooOo0);
            if (message.length() > 0) {
                ChatMessage chatMessageOooOo = o000OO.OooOo(jLongValue, message, null, 0L, false, 60);
                o000OO.OooO0oO(chatMessageOooOo);
