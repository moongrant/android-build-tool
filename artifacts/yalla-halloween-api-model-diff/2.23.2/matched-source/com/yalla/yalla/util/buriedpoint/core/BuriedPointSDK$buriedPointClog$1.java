...
public final class BuriedPointSDK$buriedPointClog$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f32297OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ String f32298OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ String f32299OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final /* synthetic */ Map<String, Object> f32300OooO0oO;
    ...
    public BuriedPointSDK$buriedPointClog$1(String str, String str2, Map<String, ? extends Object> map, Continuation<? super BuriedPointSDK$buriedPointClog$1> continuation) {
        ...
        this.f32299OooO0o0 = str;
        this.f32298OooO0o = str2;
        this.f32300OooO0oO = map;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new BuriedPointSDK$buriedPointClog$1(this.f32299OooO0o0, this.f32298OooO0o, this.f32300OooO0oO, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f32297OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            BuriedPoint.Factory factory = BuriedPoint.Factory.INSTANCE;
            String str = this.f32299OooO0o0;
            BuriedPoint buriedPointCreate = factory.create(str, this.f32298OooO0o, this.f32300OooO0oO);
            ...
            o0000O00.OooO0OO("BuriedPointSDK", "eventId is " + str + ", json is :" + strOooO0oo);
            Intrinsics.checkNotNullParameter("/Webservers/events/point", "<this>");
            String url = oo000o.OooO0o0(7, "/Webservers/events/point");
            Intrinsics.checkNotNullParameter(url, "url");
            o0ooOOo o0ooooo = new o0ooOOo(url, 1);
            o0ooooo.OooO0O0("1", "type");
            o0ooooo.OooO0O0(str, "event_id");
            String strOooO0oo2 = OooO00o.OooO00o().OooO0oo(CollectionsKt.listOf(buriedPointCreate));
            o0ooooo.OooO0O0(strOooO0oo2 != null ? strOooO0oo2 : "", "content");
            BuriedPointSDK$buriedPointClog$1$invokeSuspend$$inlined$call$1 buriedPointSDK$buriedPointClog$1$invokeSuspend$$inlined$call$1 = new BuriedPointSDK$buriedPointClog$1$invokeSuspend$$inlined$call$1(o0ooooo, null);
            this.f32297OooO0Oo = 1;
