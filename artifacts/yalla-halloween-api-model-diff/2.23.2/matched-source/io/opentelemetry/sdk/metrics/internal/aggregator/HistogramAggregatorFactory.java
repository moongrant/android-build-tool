...
public final class HistogramAggregatorFactory implements AggregatorFactory {
    ...
    @NotNull
    public final double[] f32813OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public final AggregationTemporality f32814OooO0O0;
    ...
    public HistogramAggregatorFactory(@NotNull AggregationTemporality temporality, @NotNull List boundaries) {
        ...
        this.f32813OooO00o = dArrCopyOf;
        this.f32814OooO0O0 = temporality;
        for (double d : dArrCopyOf) {
            if (!(true ^ Double.isNaN(d))) {
                throw new IllegalArgumentException("invalid bucket boundary: NaN".toString());
            }
        }
        int length = this.f32813OooO00o.length;
        for (int i = 1; i < length; i++) {
            double[] dArr = this.f32813OooO00o;
            int i2 = i - 1;
            if (!(dArr[i2] < dArr[i])) {
                throw new IllegalArgumentException(("invalid bucket boundary: " + this.f32813OooO00o[i2] + " >= " + this.f32813OooO00o[i]).toString());
            }
        }
        double[] dArr2 = this.f32813OooO00o;
        if (!(dArr2.length == 0)) {
    ...
    public final <T> Aggregator<T> OooO00o(@NotNull Resource resource, @NotNull InstrumentationLibraryInfo instrumentationLibraryInfo, @NotNull InstrumentDescriptor instrumentDescriptor, @NotNull MetricDescriptor metricDescriptor) {
        ...
        boolean z = this.f32814OooO0O0 == AggregationTemporality.CUMULATIVE;
        ...
        if (i == 1 || i == 2) {
            return new DoubleHistogramAggregator(resource, instrumentationLibraryInfo, metricDescriptor, this.f32813OooO00o, z);
        }
