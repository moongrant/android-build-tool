    ...
    public static abstract class RSAPSSPadding extends OpenSSLSignature {
        ...
        public final void engineSetParameter(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidAlgorithmParameterException {
            ...
            if (!"MGF1".equalsIgnoreCase(mGFAlgorithm) && !"1.2.840.113549.1.1.8".equals(mGFAlgorithm)) {
                throw new InvalidAlgorithmParameterException(p004OooO0oO.o000oOoO.OooO0O0("Unsupported MGF algorithm: ", mGFAlgorithm, ". Only MGF1 supported"));
            }
            ...
            try {
                ...
                if (trailerField != 1) {
                    throw new InvalidAlgorithmParameterException(OooO0OO.OooO00o.OooO00o("Unsupported trailer field: ", trailerField, ". Only 1 supported"));
                }
