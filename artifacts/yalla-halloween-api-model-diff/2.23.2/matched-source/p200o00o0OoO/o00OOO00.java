...
public final class o00OOO00 implements OooO0OO.OooO0O0 {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final /* synthetic */ SVGAView f39293OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final /* synthetic */ Function1<o00Ooo, Unit> f39294OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final /* synthetic */ Function0<Unit> f39295OooO0OO;
    ...
    public o00OOO00(SVGAView sVGAView, Function1<? super o00Ooo, Unit> function1, Function0<Unit> function0) {
        this.f39293OooO00o = sVGAView;
        this.f39294OooO0O0 = function1;
        this.f39295OooO0OO = function0;
    }

    @Override // com.opensource.svgaplayer.OooO0OO.OooO0O0
    public final void OooO00o(@NotNull o00Ooo videoItem) {
        Intrinsics.checkNotNullParameter(videoItem, "videoItem");
        SVGAView sVGAView = this.f39293OooO00o;
        sVGAView.f13221OooOOoo = true;
        Function1<o00Ooo, Unit> function1 = this.f39294OooO0O0;
        if (function1 != null) {
        ...
        if (i != 2) {
            ...
            if (!sVGAView.f13225OooOo0O) {
                sVGAView.setVideoItem(videoItem);
            }
            sVGAView.OooO0oO(sVGAView.f13225OooOo0O);
            sVGAView.OooO();
            return;
        }
        sVGAView.setVideoItem(videoItem);
    ...
    public final void onError() {
        Function0<Unit> function0 = this.f39295OooO0OO;
        if (function0 != null) {
            function0.invoke();
        }
    }
