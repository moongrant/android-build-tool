...
public final class o000OO extends oO0O00o0 {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    @NotNull
    public static final o000OO f46006OooO00o = new o000OO();
    ...
    public static final class OooO00o extends ContinuationImpl {
        ...
        public String f46007OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f46009OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public int f46010OooO0oO;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f46009OooO0o0 = obj;
            this.f46010OooO0oO |= Integer.MIN_VALUE;
            return o000OO.this.OooO0Oo(0L, null, this);
        }
    }
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ ApiResult<RoomThemeAccept> f46011OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ String f46012OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(ApiResult<RoomThemeAccept> apiResult, String str, Continuation<? super OooO0O0> continuation) {
            super(2, continuation);
            this.f46011OooO0Oo = apiResult;
            this.f46012OooO0o0 = str;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0O0(this.f46011OooO0Oo, this.f46012OooO0o0, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ApiResult<RoomThemeAccept> apiResult = this.f46011OooO0Oo;
            int code = apiResult.getError().getCode();
            boolean z = true;
            if (code == 1062) {
                String strOooO0OO = o0000.OooO0OO(o000000.message_accept_failed_not_friend);
                ...
                String str = this.f46012OooO0o0;
                switch (code) {
                    case 2050:
                        String strOooO0OO2 = o0000.OooO0OO(o000000.message_room_theme_you_has_it);
                        ...
                        break;
                    case 2051:
                        o00Oo0.OooO00o().OooOOo0().OooOO0(ChatMessage.GiveRoomThemeInfo.ThemeState.ThemeHasReceived.getValue(), str);
                        break;
                    case 2052:
                        String strOooO0OO3 = o0000.OooO0OO(o000000.message_theme_has_invalid);
                        ...
                        o00Oo0.OooO00o().OooOOo0().OooOO0(ChatMessage.GiveRoomThemeInfo.ThemeState.ThemeHasExpired.getValue(), str);
                        break;
                    default:
    ...
    public static final class OooO0OO extends ContinuationImpl {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public String f46013OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public /* synthetic */ Object f46014OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public int f46015OooO0o0;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public int f46017OooO0oo;
        ...
        @Nullable
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f46014OooO0o = obj;
            this.f46017OooO0oo |= Integer.MIN_VALUE;
            return o000OO.this.OooO0o0(0L, null, 0, this);
        }
    }
    ...
    public static Unit OooO00o() {
        o00Oo0.OooO00o().OooOOo().OooO0OO(OooO0OO());
        o00Oo0.OooO00o().OooOOo0().OooO(OooO0OO());
        return Unit.INSTANCE;
    }
    ...
    public static ChatMessage OooO0o(@NotNull String mid, boolean z) {
        Intrinsics.checkNotNullParameter(mid, "mid");
        o00Oo0.OooO00o().OooOOo0().OooOO0(ChatMessage.GiveRoomThemeInfo.ThemeState.ThemeHasReceived.getValue(), mid);
        ChatMessage chatMessageOooO0O0 = OooO0O0(0L, 0L, "", z);
        p407o0Oo0Oo.Oooo000 oooo000OooOOo0 = o00Oo0.OooO00o().OooOOo0();
        o0O00oO0 o0o00oo1 = o0O00oO0.f47936OooO00o;
        ...
        if (chatMessageOooO0o != null) {
            ...
            if (userInfoOooO0Oo != null) {
                String strOooO0O0 = o000O000.OooO0O0(chatMessageOooO0o.getTargetId(), userInfoOooO0Oo.getUserName());
                chatMessageOooO0O0.setMessage(z ? o0000O.OooO00o(o0000.OooO0OO(o000000.message_give_theme_successful), strOooO0O0) : o0000O.OooO00o(o0000.OooO0OO(o000000.message_get_theme_successful), strOooO0O0));
    ...
    public static void OooO0oO(@NotNull ChatMessage chatMessage) {
        ...
        Long lOooO0O0 = o00Oo0.OooO00o().OooOOo().OooO0O0(chatMessage.getUid(), chatMessage.getTargetId());
        ...
        Integer numOooOOOO = o00Oo0.OooO00o().OooOOo().OooOOOO(conversation.getUid(), conversation.getTargetId());
        ...
        o00Oo0.OooO00o().OooOOo().OooOO0o(conversation);
    }
    ...
    public final Object OooO0Oo(long j, @NotNull String str, @NotNull Continuation<? super ApiResult<RoomThemeAccept>> continuation) {
        ...
        if (continuation instanceof OooO00o) {
            ...
            int i = oooO00o.f46010OooO0oO;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO00o.f46010OooO0oO = i - Integer.MIN_VALUE;
            } else {
        ...
        Object roomThemeAccept = oooO00o.f46009OooO0o0;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = oooO00o.f46010OooO0oO;
        try {
            if (i2 == 0) {
                ResultKt.throwOnFailure(roomThemeAccept);
                MainApiService mainApiServiceOooO00o = OooOOO.OooO00o();
                oooO00o.f46007OooO0Oo = str2;
                oooO00o.f46010OooO0oO = 1;
            ...
            o00Oo0.OooO00o().OooOOo0().OooOO0(roomThemeAccept2.getStatus(), str2);
    ...
    public final Object OooO0o0(long j, @NotNull String str, int i, @NotNull Continuation<? super ApiResult<RoomThemeGiveState>> continuation) {
        ...
        if (continuation instanceof OooO0OO) {
            ...
            int i3 = oooO0OO.f46017OooO0oo;
            if ((i3 & Integer.MIN_VALUE) != 0) {
                oooO0OO.f46017OooO0oo = i3 - Integer.MIN_VALUE;
            } else {
        ...
        Object roomThemeGivenInfo = oooO0OO.f46014OooO0o;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i4 = oooO0OO.f46017OooO0oo;
        try {
            if (i4 == 0) {
                ResultKt.throwOnFailure(roomThemeGivenInfo);
                MainApiService mainApiServiceOooO00o = OooOOO.OooO00o();
                oooO0OO.f46013OooO0Oo = str;
                oooO0OO.f46015OooO0o0 = i;
                oooO0OO.f46017OooO0oo = 1;
                ...
                i2 = oooO0OO.f46015OooO0o0;
                str2 = oooO0OO.f46013OooO0Oo;
                ResultKt.throwOnFailure(roomThemeGivenInfo);
            }
            ...
            o00Oo0.OooO00o().OooOOo0().OooOO0(roomThemeGiveState.getStatus(), str2);
            return roomThemeGivenInfo;
        } catch (IOException e) {
            String strOooO0oo = com.code.android.json.OooO00o.OooO00o().OooO0oo(o00oO0o.OooO00o("WebAPIException", "time out ", e, 1, "time out", null, 4, null));
            Object objOooO0OO = com.code.android.json.OooO00o.OooO0OO(ApiResult.class, strOooO0oo != null ? strOooO0oo : "");
