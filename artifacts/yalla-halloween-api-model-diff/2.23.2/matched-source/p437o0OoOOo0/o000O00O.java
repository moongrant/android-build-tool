...
public class o000O00O {
    ...
    public static final class OooO00o implements OooOOOO {
        ...
        public final void onBillingSetupFinished(@NotNull OooOo00 billingResult) {
            Intrinsics.checkNotNullParameter(billingResult, "billingResult");
            o000O00O.this.f47089OooO0OO = billingResult.f12746OooO00o == 0;
        }
    }
    ...
    public static final class OooOO0 implements com.android.billingclient.api.OooO0OO {
        ...
        public final void OooO00o(@NotNull OooOo00 billingResult) {
            ...
            oooO00oOooO0O0.f12748OooO00o = 0;
            ...
            public final void onSkuDetailsResponse(@NotNull OooOo00 billingResult, @Nullable List<SkuDetails> list) {
                ...
                if (list != null) {
                    for (SkuDetails skuDetails : list) {
                        String strOptString = skuDetails.f12774OooO0O0.optString("productId");
    ...
    public o000O00O(@NotNull Activity activity, long j) {
        ...
        if (p429o0OoOO.o00Ooo.OooO0O0(activity)) {
    ...
    public final Object OooO00o(@NotNull String str, @NotNull RechargeMenuToPayModel rechargeMenuToPayModel, @Nullable GooglePaySubscriptionModel googlePaySubscriptionModel, @NotNull Continuation<? super o00O0000<RechargeMenuPayBuyResultModel>> continuation) throws Throwable {
        ...
        if (rechargeMenuToPayModel.getSkuDetails() == null) {
            o00O0000 o00o0001 = new o00O0000(null, null);
            o00o0001.f47169OooO0O0 = new o000OOo0(-113, o0000.OooO0OO(o000000.Pay_Params_Is_Null));
            return o00o0001;
        }
        ...
        oooO00o.f12701OooO00o = Base64ExtensionsKt.base64EncodeToString(AESKt.aesEncrypt$default(content, oOO0Oo00.OooO00o(), oO0oO000.f57154OooO00o, (String) null, 4, (Object) null));
        oooO00o.f12702OooO0O0 = str2;
        SkuDetails skuDetails = rechargeMenuToPayModel2.getSkuDetails();
        Intrinsics.checkNotNull(skuDetails);
        ArrayList arrayList = new ArrayList();
        arrayList.add(skuDetails);
        oooO00o.f12704OooO0Oo = arrayList;
        Intrinsics.checkNotNullExpressionValue(oooO00o, "setSkuDetails(...)");
        o0000O00.OooO0O0("GooglePay 购买订阅 V4 \nsubscription:" + googlePaySubscriptionModel2 + "\norderId:" + str2 + " \nskuDetail:" + rechargeMenuToPayModel2.getSkuDetails());
        if (googlePaySubscriptionModel2 != null && (!StringsKt.isBlank(googlePaySubscriptionModel2.f22938OooO00o)) && (!StringsKt.isBlank(googlePaySubscriptionModel2.f22939OooO0O0))) {
            String str4 = googlePaySubscriptionModel2.f22939OooO0O0;
            int i4 = GooglePaySubscriptionModel.OooO00o.$EnumSwitchMapping$0[googlePaySubscriptionModel2.f22940OooO0OO.ordinal()];
            if (i4 != 1) {
                i = i4 != 2 ? 1 : 4;
            } else {
                i = 2;
            ...
            oooO0OO.f12710OooO00o = str4;
            oooO0OO.f12711OooO0O0 = i;
            BillingFlowParams.OooO0OO.OooO00o oooO00o2 = new BillingFlowParams.OooO0OO.OooO00o();
            oooO00o2.f12712OooO00o = oooO0OO.f12710OooO00o;
            oooO00o2.f12714OooO0OO = oooO0OO.f12711OooO0O0;
            oooO00o.f12705OooO0o0 = oooO00o2;
        }
        if (o000o00o2.f47090OooO0Oo.OooO0o0(o000o00o2.f47087OooO00o, oooO00o.OooO00o()).f12746OooO00o != 0) {
    ...
    public final Object OooO0O0(@NotNull ContinuationImpl continuationImpl) throws Throwable {
        ...
        if (p429o0OoOO.o00Ooo.OooO0O0(this.f47087OooO00o)) {
            ...
            Result.Companion companion2 = Result.INSTANCE;
            cancellableContinuationImpl.resumeWith(Result.m4215constructorimpl(new o00O0000(Boxing.boxBoolean(false), new o000OOo0(-101, o0000.OooO0OO(o000000.Pay_SDK_Does_Not_Exist)))));
        }
    ...
    public final Object OooO0OO(@NotNull PayOrder payOrder, @NotNull Continuation<? super Boolean> continuation) throws Throwable {
        ...
        if (Intrinsics.areEqual(((o00O0000) objOooO0O0).f47168OooO00o, Boxing.boxBoolean(true))) {
            if (payOrder.getIsSubscription()) {
                ...
                oooO0O0.f12718OooO00o = purchaseToken;
                ...
                oooOo.f12745OooO00o = purchaseToken2;
    ...
    public final Object OooO0Oo(@NotNull List<String> list, boolean z, @NotNull Continuation<? super o00O0000<List<o000OO00>>> continuation) throws Throwable {
        ...
        oooO00o.f12856OooO0O0 = new ArrayList(list);
        oooO00o.f12855OooO00o = z ? "subs" : "inapp";
    ...
    public final Object OooO0o0(boolean z, @NotNull Continuation<? super List<PayOrder>> continuation) throws Throwable {
        ...
        if (i2 != 0) {
            ...
            for (Purchase purchase : ((o00Oo0) objOooO0O0).f12841OooO0O0) {
                OooO00o2 = purchase.OooO00o();
                if (OooO00o2 != null) {
                    str = OooO00o2.f12716OooO00o;
                } else {
                    str = null;
                }
                OooO00o3 = purchase.OooO00o();
                if (OooO00o3 != null) {
                    str2 = OooO00o3.f12717OooO0O0;
                } else {
                    str2 = null;
                }
                o0000O00.OooO0O0("GooglePay 补单V4 有丢单记录 accountId:" + str + " \torderId:" + str2);
                if (str == null) {
