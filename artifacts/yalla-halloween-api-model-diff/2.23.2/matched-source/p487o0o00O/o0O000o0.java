...
public final class o0O000o0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ WebActivity f48846OooO0Oo;
    ...
    public o0O000o0(WebActivity webActivity, Continuation<? super o0O000o0> continuation) {
        super(2, continuation);
        this.f48846OooO0Oo = webActivity;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o0O000o0(this.f48846OooO0Oo, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        WebActivity webActivity = this.f48846OooO0Oo;
        ...
        webVMOooOoO0.setToolbarTitle(webPageInfo.f32284OooO0oO);
        ...
        webVMOooOoO1.setBackIconIsClose(webPageInfo3.f32280OooO);
        ...
        webVMOooOoO2.setShowMenuShare(webPageInfo4.f32287OooOO0O != WebPageInfo.ShareType.NoShare);
        ...
        webVMOooOoO3.setShowMenuOpenInBrowser(webPageInfo5.f32289OooOOO);
        WebPageInfo webPageInfo6 = webActivity.f25137OooOo0O;
        if (webPageInfo6 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("webPageInfo");
            webPageInfo6 = null;
        }
        int i2 = OooO00o.$EnumSwitchMapping$0[webPageInfo6.f32281OooO0Oo.ordinal()];
        if (i2 == 1) {
            ...
            webVMOooOoO4.setShowToolbar(!webPageInfo7.f32282OooO0o);
            webActivity.OooOoO0().setStatusBarBlackIcon(false);
            WebVM webVMOooOoO5 = webActivity.OooOoO0();
            WebPageInfo webPageInfo8 = webActivity.f25137OooOo0O;
            if (webPageInfo8 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("webPageInfo");
                webPageInfo8 = null;
            }
            webVMOooOoO5.setShowMenuRefresh(!webPageInfo8.f32282OooO0o);
            webActivity.OooOoO0().setShowCloseAdIcon(false);
            ...
            webVMOooOoO6.setToolbarGreenStyle(!webPageInfo2.f32282OooO0o);
        }
