...
public final class oOo00OO0 {
    ...
    @NotNull
    public static final oOo00OO0 f53200OooO00o = new oOo00OO0();

    public static final class OooO00o extends Lambda implements Function1<SoundRippleAnimationType, Unit> {

        /* JADX INFO: renamed from: OooO, reason: collision with root package name */
        public final /* synthetic */ MutableState<Float> f53201OooO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ CoroutineScope f53202OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ MutableState<SoundRippleAnimationType> f53203OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MutableState<Job> f53204OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ Animatable<Float, AnimationVector1D> f53205OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ MutableState<Color> f53206OooO0oo;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public final /* synthetic */ List<Float> f53207OooOO0;

        /* JADX INFO: renamed from: o0o0O0oo.oOo00OO0$OooO00o$OooO00o, reason: collision with other inner class name */
        public /* synthetic */ class C0476OooO00o {
        ...
        public OooO00o(CoroutineScope coroutineScope, MutableState<Job> mutableState, MutableState<SoundRippleAnimationType> mutableState2, Animatable<Float, AnimationVector1D> animatable, MutableState<Color> mutableState3, MutableState<Float> mutableState4, List<Float> list) {
            super(1);
            this.f53202OooO0Oo = coroutineScope;
            this.f53204OooO0o0 = mutableState;
            this.f53203OooO0o = mutableState2;
            this.f53205OooO0oO = animatable;
            this.f53206OooO0oo = mutableState3;
            this.f53201OooO = mutableState4;
            this.f53207OooOO0 = list;
        }
        ...
        public final Unit invoke(SoundRippleAnimationType soundRippleAnimationType) {
            ...
            MutableState<Job> mutableState = this.f53204OooO0o0;
            if (mutableState.getValue() == null) {
                this.f53203OooO0o.setValue(type);
                int i = C0476OooO00o.$EnumSwitchMapping$0[type.ordinal()];
                MutableState<Color> mutableState2 = this.f53206OooO0oo;
                Animatable<Float, AnimationVector1D> animatable = this.f53205OooO0oO;
                if (i == 1) {
                    jobLaunch$default = BuildersKt__Builders_commonKt.launch$default(this.f53202OooO0Oo, null, null, new oO0O0OoO(animatable, mutableState2, mutableState, null), 3, null);
                } else if (i == 2) {
                    jobLaunch$default = BuildersKt__Builders_commonKt.launch$default(this.f53202OooO0Oo, null, null, new oO00O0o0(animatable, mutableState2, mutableState, null), 3, null);
                } else {
                    if (i != 3) {
                        throw new NoWhenBranchMatchedException();
                    }
                    jobLaunch$default = BuildersKt__Builders_commonKt.launch$default(this.f53202OooO0Oo, null, null, new oO00O0o(this.f53201OooO, this.f53207OooOO0, mutableState, null), 3, null);
                }
    ...
    public static final class OooO0O0 extends Lambda implements Function1<DrawScope, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Animatable<Float, AnimationVector1D> f53208OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MutableState<Color> f53209OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(Animatable<Float, AnimationVector1D> animatable, MutableState<Color> mutableState) {
            super(1);
            this.f53208OooO0Oo = animatable;
            this.f53209OooO0o0 = mutableState;
        }
        ...
        public final Unit invoke(DrawScope drawScope) {
            ...
            Animatable<Float, AnimationVector1D> animatable = this.f53208OooO0Oo;
            if (animatable.getValue().floatValue() > 0.0f) {
                float f = 2;
                float fM1516getWidthimpl = Size.m1516getWidthimpl(Canvas.mo2118getSizeNHjbRc()) / f;
                float fM1516getWidthimpl2 = (Size.m1516getWidthimpl(Canvas.mo2118getSizeNHjbRc()) * 0.7f) / 2.0f;
                float f2 = fM1516getWidthimpl - fM1516getWidthimpl2;
                float f3 = f2 / f;
                float fFloatValue = (animatable.getValue().floatValue() * 5.0f * f3) + fM1516getWidthimpl2;
                for (int i = 0; i < 4; i++) {
                    float f4 = fFloatValue - (i * f3);
                    float f5 = 1 - ((f4 - fM1516getWidthimpl2) / f2);
                    if (fM1516getWidthimpl2 <= f4 && f4 <= fM1516getWidthimpl) {
                        androidx.compose.ui.graphics.drawscope.OooO0O0.OooOo(Canvas, Color.m1680copywmQWz5c$default(this.f53209OooO0o0.getValue().m1691unboximpl(), RangesKt.coerceIn(f5, 0.0f, 1.0f), 0.0f, 0.0f, 0.0f, 14, null), f4, 0L, 0.0f, null, null, 0, 124, null);
                    }
                }
            }
            return Unit.INSTANCE;
    ...
    public static final class OooO0OO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ Function1<Function1<? super SoundRippleAnimationType, Unit>, Unit> f53211OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ Modifier f53212OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f53213OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ int f53214OooO0oo;
        ...
        public OooO0OO(Modifier modifier, Function1<? super Function1<? super SoundRippleAnimationType, Unit>, Unit> function1, int i, int i2) {
            super(2);
            this.f53212OooO0o0 = modifier;
            this.f53211OooO0o = function1;
            this.f53213OooO0oO = i;
            this.f53214OooO0oo = i2;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            oOo00OO0.this.OooO00o(this.f53212OooO0o0, this.f53211OooO0o, composer, RecomposeScopeImplKt.updateChangedFlags(this.f53213OooO0oO | 1), this.f53214OooO0oo);
            return Unit.INSTANCE;
        }
    }
    ...
    public final void OooO00o(@Nullable Modifier modifier, @NotNull Function1<? super Function1<? super SoundRippleAnimationType, Unit>, Unit> animationLauncher, @Nullable Composer composer, int i, int i2) {
        ...
        if ((i3 & 91) == 18 && composerStartRestartGroup.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-83607944, i3, -1, "com.yalla.yalla.ui.composable.room.SoundRippleComp.SoundRipple (SoundRippleComp.kt:39)");
            }
            ...
            if (objRememberedValue2 == companion.getEmpty()) {
                objRememberedValue2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Color.m1671boximpl(o0OOo000.f48135OooO0O0), null, 2, null);
            ...
            MeasurePolicy measurePolicyOooO00o = Oooo000.OooO00o(Alignment.INSTANCE, r15, composerStartRestartGroup, r15, -1323940314);
            ...
            OooOO0.OooO00o(r15, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composerStartRestartGroup)), composerStartRestartGroup, 2058660585);
