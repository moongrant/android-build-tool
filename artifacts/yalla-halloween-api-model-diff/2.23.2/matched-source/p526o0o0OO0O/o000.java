...
public final class o000 {
    ...
    @NotNull
    public final FragmentActivity f53265OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public final ShareLogViewModel f53266OooO0O0;

    public static final class OooO00o extends Lambda implements Function0<Unit> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ ShareContentModel f53267OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ o000 f53268OooO0o0;

        /* JADX INFO: renamed from: o0o0OO0O.o000$OooO00o$OooO00o, reason: collision with other inner class name */
        ...
        public OooO00o(ShareContentModel shareContentModel, o000 o000Var) {
            super(0);
            this.f53267OooO0Oo = shareContentModel;
            this.f53268OooO0o0 = o000Var;
        }
        ...
        public final Unit invoke() {
            String string;
            String strValueOf;
            ShareContentModel shareContentModel = this.f53267OooO0Oo;
            int i = C0477OooO00o.$EnumSwitchMapping$0[shareContentModel.getType().ordinal()];
            o000 o000Var = this.f53268OooO0o0;
            if (i != 1) {
                if (i == 2) {
                    ...
                    if (web != null) {
                        ...
                        if (!(id == null || id.length() == 0)) {
                            ...
                            FragmentActivity context = o000Var.f53265OooO00o;
                    ...
                    if (event != null) {
                        ...
                        MomentSendActivity.OooO00o.OooO0O0(o000Var.f53265OooO00o, momentSendShareModel2);
                    }
                }
                strValueOf = null;
            } else {
                ...
                if (room != null) {
                    ...
                    if (!(roomid == null || roomid.length() == 0)) {
                        ...
                        FragmentActivity context2 = o000Var.f53265OooO00o;
            ...
            if (!(strValueOf == null || strValueOf.length() == 0)) {
                o000Var.f53266OooO0O0.shareLog(shareContentModel.getType(), String.valueOf(strValueOf), ShareLogType.Moments);
            }
    ...
    public o000(@NotNull FragmentActivity activity) {
        ...
        this.f53265OooO00o = activity;
        this.f53266OooO0O0 = (ShareLogViewModel) new ViewModelProvider(activity).get(ShareLogViewModel.class);
    }
