...
public final class OooOOO0 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ OooO f37Oooo0o;

    /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
    public final /* synthetic */ Action f38Oooo0oO;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooOOO0(OooO oooO, Action action) {
        super(0);
        this.f37Oooo0o = oooO;
        this.f38Oooo0oO = action;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        this.f37Oooo0o.OooO0OO(this.f38Oooo0oO.getCompletion().getFunctionID(), null);
