...
public final class o00Oo0 {
    ...
    public static o00Oo0 f4556OooO0Oo;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public long f4557OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public long f4558OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public int f4559OooO0OO;
    ...
    public final void OooO00o(long j, double d, double d2) {
        ...
        if (dSin3 >= 1.0d) {
            this.f4559OooO0OO = 1;
            this.f4557OooO00o = -1L;
            this.f4558OooO0O0 = -1L;
        } else {
            if (dSin3 <= -1.0d) {
                this.f4559OooO0OO = 0;
                this.f4557OooO00o = -1L;
            ...
            this.f4557OooO00o = Math.round((dSin2 + dAcos) * 8.64E7d) + 946728000000L;
            long jRound = Math.round((dSin2 - dAcos) * 8.64E7d) + 946728000000L;
            this.f4558OooO0O0 = jRound;
            if (jRound >= j || this.f4557OooO00o <= j) {
                this.f4559OooO0OO = 1;
            } else {
                this.f4559OooO0OO = 0;
            }
