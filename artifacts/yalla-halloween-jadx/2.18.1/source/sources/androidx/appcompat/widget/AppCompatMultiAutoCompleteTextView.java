...
public class AppCompatMultiAutoCompleteTextView extends MultiAutoCompleteTextView implements androidx.core.widget.OooOo {

    /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
    public static final int[] f4944Oooo = {R.attr.popupBackground};

    /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
    public final OooO0o f4945Oooo0o;

    /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
    public final o00O0O f4946Oooo0oO;

    /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
    @NonNull
    public final OooOOO0 f4947Oooo0oo;
    ...
    public final void drawableStateChanged() {
        ...
        OooO0o oooO0o = this.f4945Oooo0o;
        if (oooO0o != null) {
            oooO0o.OooO00o();
        }
        o00O0O o00o0o2 = this.f4946Oooo0oO;
        if (o00o0o2 != null) {
            o00o0o2.OooO0O0();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f4946Oooo0oO.OooO0o0();
    }

    @Nullable
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f4946Oooo0oO.OooO0o();
    }
    ...
    public final InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        ...
        return this.f4947Oooo0oo.OooO0OO(inputConnectionOnCreateInputConnection, editorInfo);
    }
    ...
    public void setEmojiCompatEnabled(boolean z) {
        this.f4947Oooo0oo.OooO0Oo(z);
    }

    @Override // android.widget.TextView
    public void setKeyListener(@Nullable KeyListener keyListener) {
        super.setKeyListener(this.f4947Oooo0oo.OooO00o(keyListener));
    }
    ...
    public void setSupportCompoundDrawablesTintList(@Nullable ColorStateList colorStateList) {
        this.f4946Oooo0oO.OooOOO(colorStateList);
        this.f4946Oooo0oO.OooO0O0();
    }

    @Override // androidx.core.widget.OooOo
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public void setSupportCompoundDrawablesTintMode(@Nullable PorterDuff.Mode mode) {
        this.f4946Oooo0oO.OooOOOO(mode);
        this.f4946Oooo0oO.OooO0O0();
    }
    ...
    public AppCompatMultiAutoCompleteTextView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        o0000O0 o0000o0OooOOo = o0000O0.OooOOo(getContext(), attributeSet, f4944Oooo, i);
