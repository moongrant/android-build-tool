...
public class AppCompatRadioButton extends RadioButton implements androidx.core.widget.OooOo {

    /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
    public OooOOO f4948Oooo;

    /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
    public final OooOO0 f4949Oooo0o;

    /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
    public final OooO0o f4950Oooo0oO;

    /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
    public final o00O0O f4951Oooo0oo;
    ...
    private OooOOO getEmojiTextViewHelper() {
        if (this.f4948Oooo == null) {
            this.f4948Oooo = new OooOOO(this);
        }
        return this.f4948Oooo;
    }

    @Override // android.widget.CompoundButton, android.widget.TextView, android.view.View
    public final void drawableStateChanged() {
        super.drawableStateChanged();
        OooO0o oooO0o = this.f4950Oooo0oO;
        if (oooO0o != null) {
            oooO0o.OooO00o();
        }
        o00O0O o00o0o2 = this.f4951Oooo0oo;
        if (o00o0o2 != null) {
            o00o0o2.OooO0O0();
        }
    }
    ...
    public int getCompoundPaddingLeft() {
        ...
        OooOO0 oooOO1 = this.f4949Oooo0o;
        if (oooOO1 != null) {
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f4951Oooo0oo.OooO0o0();
    }

    @Nullable
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f4951Oooo0oo.OooO0o();
    }
    ...
    public void setSupportCompoundDrawablesTintList(@Nullable ColorStateList colorStateList) {
        this.f4951Oooo0oo.OooOOO(colorStateList);
        this.f4951Oooo0oo.OooO0O0();
    }

    @Override // androidx.core.widget.OooOo
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public void setSupportCompoundDrawablesTintMode(@Nullable PorterDuff.Mode mode) {
        this.f4951Oooo0oo.OooOOOO(mode);
        this.f4951Oooo0oo.OooO0O0();
    }

    public AppCompatRadioButton(Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, OooOo00.OooO00o.radioButtonStyle);
    }
