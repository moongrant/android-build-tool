...
public final class o0ooOOo {
    ...
    public static final int[] f5478OooO00o = {R.attr.state_checked};

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final int[] f5479OooO0O0 = new int[0];

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final Rect f5480OooO0OO = new Rect();

    @RequiresApi(18)
    public static class OooO00o {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public static final boolean f5481OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public static final Method f5482OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public static final Field f5483OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final Field f5484OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public static final Field f5485OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public static final Field f5486OooO0o0;
    ...
    public static void OooO0O0(Drawable drawable) {
        ...
        if (state == null || state.length == 0) {
            drawable.setState(f5478OooO00o);
        } else {
            drawable.setState(f5479OooO0O0);
        }
    ...
    public static Rect OooO0OO(@NonNull Drawable drawable) {
        ...
        boolean z = OooO00o.f5481OooO00o;
        if (i < 29 && OooO00o.f5481OooO00o) {
            try {
                Object objInvoke = OooO00o.f5482OooO0O0.invoke(drawableOooO0Oo, new Object[0]);
                if (objInvoke != null) {
                    return new Rect(OooO00o.f5483OooO0OO.getInt(objInvoke), OooO00o.f5484OooO0Oo.getInt(objInvoke), OooO00o.f5486OooO0o0.getInt(objInvoke), OooO00o.f5485OooO0o.getInt(objInvoke));
                }
