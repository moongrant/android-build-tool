...
public final class FlowExtKt {
    ...
    public static final class AnonymousClass1<T> extends SuspendLambda implements Function2<ProducerScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        public static final class C00541 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public C00541(Flow<? extends T> flow, ProducerScope<? super T> producerScope, Continuation<? super C00541> continuation) {
            ...
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                return new C00541(this.$this_flowWithLifecycle, this.$$this$callbackFlow, continuation);
            }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                ...
                C00541 c00541 = new C00541(this.$this_flowWithLifecycle, producerScope2, null);
                this.L$0 = producerScope2;
                this.label = 1;
                if (RepeatOnLifecycleKt.repeatOnLifecycle(lifecycle, state, c00541, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
