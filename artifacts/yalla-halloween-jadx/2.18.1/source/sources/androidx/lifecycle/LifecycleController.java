...
public final class LifecycleController {
    ...
    public LifecycleController(@NotNull Lifecycle lifecycle, @NotNull Lifecycle.State minState, @NotNull DispatchQueue dispatchQueue, @NotNull final Job parentJob) {
        ...
        LifecycleEventObserver lifecycleEventObserver = new LifecycleEventObserver() { // from class: androidx.lifecycle.OooOO0
            @Override // androidx.lifecycle.LifecycleEventObserver
            public final void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
                LifecycleController.m7observer$lambda0(this.f8546Oooo0o, parentJob, lifecycleOwner, event);
            }
        };
    ...
    /* JADX INFO: renamed from: observer$lambda-0, reason: not valid java name */
    public static final void m7observer$lambda0(LifecycleController this$0, Job parentJob, LifecycleOwner source, Lifecycle.Event event) {
