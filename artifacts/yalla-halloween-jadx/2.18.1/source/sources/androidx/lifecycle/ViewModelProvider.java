    ...
    public static class NewInstanceFactory implements Factory {
        ...
        public <T extends ViewModel> T create(@NotNull Class<T> modelClass) {
            ...
            try {
                ...
                throw new RuntimeException(OooOOO.OooO00o("Cannot create an instance of ", modelClass), e);
            } catch (InstantiationException e2) {
                throw new RuntimeException(OooOOO.OooO00o("Cannot create an instance of ", modelClass), e2);
            }
        }
        ...
        private final <T extends ViewModel> T create(Class<T> modelClass, Application app) {
            if (AndroidViewModel.class.isAssignableFrom(modelClass)) {
                try {
                    ...
                    throw new RuntimeException(OooOOO.OooO00o("Cannot create an instance of ", modelClass), e3);
                } catch (InvocationTargetException e4) {
                    throw new RuntimeException(OooOOO.OooO00o("Cannot create an instance of ", modelClass), e4);
                }
            }
            return (T) super.create(modelClass);
        }
