...
final class FakeDrag {
    ...
    public boolean beginFakeDrag() {
        ...
        addFakeMotionEvent(this.mFakeDragBeginTime, 0, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE);
        return true;
    }
    ...
    public boolean fakeDragBy(float f) {
        ...
        int i = z ? iRound : 0;
        int i2 = z ? 0 : iRound;
        float f3 = z ? this.mRequestedDragDistance : ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
        float f4 = z ? ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE : this.mRequestedDragDistance;
