...
final class ScrollEventAdapter extends RecyclerView.o00O0O {
    ...
    public static final class ScrollEventValues {
        ...
        public void reset() {
            this.mPosition = -1;
            this.mOffset = ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
            this.mOffsetPx = 0;
        }
    }
    ...
    private void updateScrollEventValues() {
        ...
        if (i >= 0) {
            scrollEventValues.mOffset = height == 0 ? ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE : i / height;
        } else {
    ...
    public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int i) {
        ...
        if (isInAnyDraggingState() && i == 0) {
            ...
            if (this.mScrollHappened) {
                ...
                if (i4 != -1) {
                    dispatchScrolled(i4, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, 0);
                }
            }
            if (z) {
                dispatchStateChanged(0);
