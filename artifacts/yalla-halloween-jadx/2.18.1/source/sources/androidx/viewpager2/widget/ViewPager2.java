...
public final class ViewPager2 extends ViewGroup {
    ...
    private o000OOo mPagerSnapHelper;
    ...
    public abstract class AccessibilityProvider {
        ...
        public void onLmInitializeAccessibilityNodeInfo(@NonNull o0000OO0 o0000oo1) {
        }
    ...
    public class BasicAccessibilityProvider extends AccessibilityProvider {
        ...
        public void onLmInitializeAccessibilityNodeInfo(@NonNull o0000OO0 o0000oo1) {
            ...
            o0000oo1.OooOoO0(o0000OO0.OooO00o.f28203OooOO0O);
            o0000oo1.OooOoO0(o0000OO0.OooO00o.f28202OooOO0);
            o0000oo1.OoooOoO(false);
        }
    ...
    public class LinearLayoutManagerImpl extends LinearLayoutManager {
        ...
        public void onInitializeAccessibilityNodeInfo(@NonNull RecyclerView.o00Ooo o00ooo2, @NonNull RecyclerView.o0OOO0o o0ooo0o2, @NonNull o0000OO0 o0000oo1) {
            super.onInitializeAccessibilityNodeInfo(o00ooo2, o0ooo0o2, o0000oo1);
            ViewPager2.this.mAccessibilityProvider.onLmInitializeAccessibilityNodeInfo(o0000oo1);
        }
    ...
    public class PageAwareAccessibilityProvider extends AccessibilityProvider {
        private final o000Oo0 mActionPageBackward;
        private final o000Oo0 mActionPageForward;
        private RecyclerView.OooOOO mAdapterDataObserver;

        public PageAwareAccessibilityProvider() {
            super();
            this.mActionPageForward = new o000Oo0() { // from class: androidx.viewpager2.widget.ViewPager2.PageAwareAccessibilityProvider.1
                @Override // p072o000O0o0.o000Oo0
                public boolean perform(@NonNull View view, @Nullable o000Oo0.OooO00o oooO00o) {
                    PageAwareAccessibilityProvider.this.setCurrentItemFromAccessibilityCommand(((ViewPager2) view).getCurrentItem() + 1);
                    return true;
                }
            };
            this.mActionPageBackward = new o000Oo0() { // from class: androidx.viewpager2.widget.ViewPager2.PageAwareAccessibilityProvider.2
                @Override // p072o000O0o0.o000Oo0
                public boolean perform(@NonNull View view, @Nullable o000Oo0.OooO00o oooO00o) {
                    PageAwareAccessibilityProvider.this.setCurrentItemFromAccessibilityCommand(((ViewPager2) view).getCurrentItem() - 1);
                    return true;
        ...
        private void addCollectionInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            if (ViewPager2.this.getAdapter() != null) {
                ...
                accessibilityNodeInfo.setCollectionInfo((AccessibilityNodeInfo.CollectionInfo) o0000OO0.OooO0O0.OooO00o(itemCount, itemCount2, false, 0).f28216OooO00o);
            }
            itemCount = 0;
            itemCount2 = 0;
            accessibilityNodeInfo.setCollectionInfo((AccessibilityNodeInfo.CollectionInfo) o0000OO0.OooO0O0.OooO00o(itemCount, itemCount2, false, 0).f28216OooO00o);
        ...
        public void updatePageAccessibilityActions() {
            ...
            ViewCompat.OooOOoo(viewPager2);
            int i = R.id.accessibilityActionPageRight;
            ViewCompat.OooOo00(R.id.accessibilityActionPageRight, viewPager2);
            ViewCompat.OooOOO(viewPager2, 0);
            ViewCompat.OooOo00(R.id.accessibilityActionPageUp, viewPager2);
            ViewCompat.OooOOO(viewPager2, 0);
            ViewCompat.OooOo00(R.id.accessibilityActionPageDown, viewPager2);
            ViewCompat.OooOOO(viewPager2, 0);
            ...
            if (ViewPager2.this.getOrientation() != 0) {
                if (ViewPager2.this.mCurrentItem < itemCount - 1) {
                    ViewCompat.OooOo0(viewPager2, new o0000OO0.OooO00o(R.id.accessibilityActionPageDown, (CharSequence) null), this.mActionPageForward);
                }
                if (ViewPager2.this.mCurrentItem > 0) {
                    ViewCompat.OooOo0(viewPager2, new o0000OO0.OooO00o(R.id.accessibilityActionPageUp, (CharSequence) null), this.mActionPageBackward);
                    return;
                }
                return;
            }
            ...
            if (ViewPager2.this.mCurrentItem < itemCount - 1) {
                ViewCompat.OooOo0(viewPager2, new o0000OO0.OooO00o(i2, (CharSequence) null), this.mActionPageForward);
            }
            if (ViewPager2.this.mCurrentItem > 0) {
                ViewCompat.OooOo0(viewPager2, new o0000OO0.OooO00o(i, (CharSequence) null), this.mActionPageBackward);
            }
        }
    }
    ...
    public class PagerSnapHelperImpl extends o000OOo {
        public PagerSnapHelperImpl() {
        }

        @Override // androidx.recyclerview.widget.o000OOo, androidx.recyclerview.widget.o00000O0
        @Nullable
    ...
    public void updateCurrentItem() {
        o000OOo o000ooo2 = this.mPagerSnapHelper;
        if (o000ooo2 == null) {
            throw new IllegalStateException("Design assumption violated.");
        }
        View viewFindSnapView = o000ooo2.findSnapView(this.mLayoutManager);
        if (viewFindSnapView == null) {
            return;
        }
