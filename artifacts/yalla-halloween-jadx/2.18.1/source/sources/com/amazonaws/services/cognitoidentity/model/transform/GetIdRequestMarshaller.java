...
public class GetIdRequestMarshaller {
    /* JADX WARN: Type inference failed for: r6v5, types: [java.util.HashMap, java.util.Map<java.lang.String, java.lang.String>] */
    public final Request<GetIdRequest> OooO00o(GetIdRequest getIdRequest) {
        DefaultRequest defaultRequest = new DefaultRequest(getIdRequest, "AmazonCognitoIdentity");
        defaultRequest.OooO00o("X-Amz-Target", "AWSCognitoIdentityService.GetId");
        ...
        try {
            ...
            if (str != null) {
                awsJsonWriterOooO0O0.OooO0Oo("AccountId");
                awsJsonWriterOooO0O0.OooO0OO(str);
            }
            String str2 = getIdRequest.f10587OoooO00;
            if (str2 != null) {
                awsJsonWriterOooO0O0.OooO0Oo("IdentityPoolId");
