...
public class GetOpenIdTokenRequestMarshaller {
    ...
    public final Request<GetOpenIdTokenRequest> OooO00o(GetOpenIdTokenRequest getOpenIdTokenRequest) {
        DefaultRequest defaultRequest = new DefaultRequest(getOpenIdTokenRequest, "AmazonCognitoIdentity");
        defaultRequest.OooO00o("X-Amz-Target", "AWSCognitoIdentityService.GetOpenIdToken");
