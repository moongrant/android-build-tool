...
public class GenerateDataKeyRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public Map<String, String> f10607Oooo = new HashMap();

    /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
    public List<String> f10608OoooO00 = new ArrayList();
    ...
    public final boolean equals(Object obj) {
        ...
        Map<String, String> map = generateDataKeyRequest.f10607Oooo;
        boolean z = map == null;
        Map<String, String> map2 = this.f10607Oooo;
        if (z ^ (map2 == null)) {
            return false;
        }
        ...
        List<String> list = generateDataKeyRequest.f10608OoooO00;
        boolean z2 = list == null;
        List<String> list2 = this.f10608OoooO00;
        if (z2 ^ (list2 == null)) {
            return false;
        }
