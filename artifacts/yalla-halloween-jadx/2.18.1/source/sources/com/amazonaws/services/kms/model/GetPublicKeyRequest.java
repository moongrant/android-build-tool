...
public class GetPublicKeyRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public List<String> f10611Oooo = new ArrayList();
    ...
    public final boolean equals(Object obj) {
        ...
        List<String> list = ((GetPublicKeyRequest) obj).f10611Oooo;
        boolean z = list == null;
        List<String> list2 = this.f10611Oooo;
        if (z ^ (list2 == null)) {
            return false;
        }
