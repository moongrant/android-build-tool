...
public final class ApiTagUtils$init$1$invokeSuspend$$inlined$call$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<List<? extends CategoryModel>>>, Object> {
    ...
    public ApiTagUtils$init$1$invokeSuspend$$inlined$call$1(o00O000o o00o000o2, Continuation continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new ApiTagUtils$init$1$invokeSuspend$$inlined$call$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super ApiResult<List<? extends CategoryModel>>> continuation) {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        try {
            ...
            Type type = new o00000O0<ApiResult<List<? extends CategoryModel>>>() { // from class: com.app.base.app.appConfig.apiDataModela.ApiTagUtils$init$1$invokeSuspend$$inlined$call$1.1
            }.getType();
