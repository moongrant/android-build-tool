...
public final class MomentListFeaturedFragment extends p503o0o00o00.OooO<b9> {
    ...
    public static final class OooO extends Lambda implements Function1<ApiResult<MomentBannerModel>, Unit> {
        ...
        public final Unit invoke(ApiResult<MomentBannerModel> apiResult) {
            ...
            if (it.getData() == null) {
                AppBarLayout appBarLayout = MomentListFeaturedFragment.this.getBinding().f49008OooO0Oo;
                ...
                if (bannerList == null || bannerList.isEmpty()) {
                    AppBarLayout appBarLayout2 = MomentListFeaturedFragment.this.getBinding().f49008OooO0Oo;
                    Intrinsics.checkNotNullExpressionValue(appBarLayout2, "binding.layoutBanner");
                    oOO00O.OooO00o(appBarLayout2);
                } else {
                    AppBarLayout appBarLayout3 = MomentListFeaturedFragment.this.getBinding().f49008OooO0Oo;
    ...
    public static final class OooO00o extends Lambda implements Function1<MomentDetailModel, Unit> {
        ...
        public final Unit invoke(MomentDetailModel momentDetailModel) {
            ...
            if (momentDetailModel2 != null && (it1 = MomentListFeaturedFragment.this.getContext()) != null) {
                ...
                PostDetailActivity.f22417o0O0O00.OooO00o(it1, momentDetailModel2, (256 & 4) != 0 ? false : false, (256 & 8) != 0 ? 1 : -1, (256 & 16) != 0 ? null : null, (256 & 32) != 0 ? false : false, (256 & 64) != 0 ? null : MomentAdapterTag.MomentBanner, (256 & 128) != 0 ? false : false, (256 & 256) != 0 ? "" : null);
            }
            return Unit.INSTANCE;
        }
    }
        ...
        public final Unit invoke(MomentBannerModel momentBannerModel) {
            ...
            if (momentBannerModel2 != null) {
                ...
                if (momentListFeaturedFragment.bannerAdapter == null) {
                    ...
                    Banner banner = momentListFeaturedFragment.getBinding().f49006OooO0O0;
                    o00000 o00000Var = momentListFeaturedFragment.bannerAdapter;
                    Intrinsics.checkNotNull(o00000Var);
                    banner.setAdapter(o00000Var);
                    momentListFeaturedFragment.getBinding().f49006OooO0O0.addBannerLifecycleObserver(momentListFeaturedFragment.getViewLifecycleOwner());
                    momentListFeaturedFragment.getBinding().f49006OooO0O0.isAutoLoop(true);
                    momentListFeaturedFragment.getBinding().f49006OooO0O0.setDelayTime(momentBannerModel2.delayTime());
                    momentListFeaturedFragment.getBinding().f49006OooO0O0.setIntercept(false);
                    ...
                    momentListFeaturedFragment.getBinding().f49006OooO0O0.setIndicator(new CircleIndicator(momentListFeaturedFragment.getContext()));
                    momentListFeaturedFragment.getBinding().f49006OooO0O0.start();
                } else {
    ...
    public static final class OooOO0 extends Lambda implements Function1<List<MomentDetailModel>, Unit> {
        ...
        public final /* synthetic */ boolean f11594Oooo0o;

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ MomentListFeaturedFragment f11595Oooo0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0(boolean z, MomentListFeaturedFragment momentListFeaturedFragment) {
            super(1);
            this.f11594Oooo0o = z;
            this.f11595Oooo0oO = momentListFeaturedFragment;
        }
        ...
        public final Unit invoke(List<MomentDetailModel> list) {
            ...
            if (this.f11594Oooo0o) {
                if (this.f11595Oooo0oO.lastPageIndex == 1) {
                    o00000OO o00000oo4 = this.f11595Oooo0oO.mAdapter;
                    if (o00000oo4 == null) {
                        Intrinsics.throwUninitializedPropertyAccessException("mAdapter");
                        o00000oo4 = null;
                    }
                    o00000oo4.setNewData(list2);
                    PostGifPlayControl postGifPlayControl2 = this.f11595Oooo0oO.mPostGifPlayControl;
                    ...
                    o00000OO o00000oo5 = this.f11595Oooo0oO.mAdapter;
                    if (o00000oo5 == null) {
                        Intrinsics.throwUninitializedPropertyAccessException("mAdapter");
                    } else {
                        o00000oo3 = o00000oo5;
                ...
                this.f11595Oooo0oO.getBinding().f49010OooO0o0.scrollToPosition(0);
            } else if (list2 != null) {
                o00000OO o00000oo6 = this.f11595Oooo0oO.mAdapter;
                if (o00000oo6 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("mAdapter");
                } else {
                    o00000oo2 = o00000oo6;
    ...
    public static final class OooOO0O extends Lambda implements Function1<ApiResult<List<MomentDetailModel>>, Unit> {
        ...
        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ boolean f11597Oooo0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0O(boolean z) {
            super(1);
            this.f11597Oooo0oO = z;
        }
        ...
        public final Unit invoke(ApiResult<List<MomentDetailModel>> apiResult) {
            ...
            MomentListFeaturedFragment.this.getBinding().f49009OooO0o.Oooo0OO(this.f11597Oooo0oO, it.isSuccess());
            o00000OO o00000oo2 = MomentListFeaturedFragment.this.mAdapter;
            o00000OO o00000oo3 = null;
            if (o00000oo2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("mAdapter");
            ...
            Boolean boolValueOf = Boolean.valueOf(this.f11597Oooo0oO);
    ...
    public static final class OooOOO0 extends Lambda implements Function1<MomentDetailModel, Unit> {
        ...
        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ long f11599Oooo0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO0(long j) {
            super(1);
            this.f11599Oooo0oO = j;
        }
    ...
    public MomentListFeaturedFragment() {
        ...
        this.vm = o0000O.OooO0O0(this, Reflection.getOrCreateKotlinClass(MomentVM.class), new Function0<ViewModelStore>() { // from class: com.app.base.fragment.MomentListFeaturedFragment$special$$inlined$viewModels$default$3
            {
                super(0);
            }
            ...
            /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
            public final /* synthetic */ Function0 f11603Oooo0o = null;
            ...
            public final CreationExtras invoke() {
                ...
                Function0 function1 = this.f11603Oooo0o;
    ...
    private final void initObserver() {
        ...
        LiveEventBus.get("POST_DETAIL_POLL_DATA_REFRESH", MomentDetailModel.class).observe(this, new o0000OO0(this, i));
        Class cls = Long.TYPE;
                ...
                if (adData != null) {
                    this$0.getVm().adAddBlockIns(adData.getAdId()).observe(this$0.getViewLifecycleOwner(), new Observer() { // from class: o00OOooO.o000O00
                        ...
                        public final void onChanged(Object obj) {
                            MomentListFeaturedFragment.m39initObserver$lambda6$lambda5$lambda4(this.f31941OooO00o, position, (ApiResult) obj);
                        }
                    });
                }
            }
    ...
    private final void initView() {
        getBinding().f49009OooO0o.setOnRefreshListener(new o000O0(this));
        ...
        o00000oo2.f44994OooO0o = EnterRoomParentPage.Moments_Feature_SharedRoom;
        ...
        o00000oo5.setOnLoadMoreListener(new o000O00O(this), getBinding().f49010OooO0o0);
        ...
        getBinding().f49010OooO0o0.setLayoutManager(new FixLinearLayoutManager(getContext()));
        FixedRecyclerView fixedRecyclerView = getBinding().f49010OooO0o0;
        ...
        this.mPostGifPlayControl = new PostGifPlayControl(this, getBinding().f49010OooO0o0);
        p617o0oo0o.o00000OO o00000oo9 = p617o0oo0o.o00000OO.f48476OooO00o;
        FixedRecyclerView fixedRecyclerView2 = getBinding().f49010OooO0o0;
        Intrinsics.checkNotNullExpressionValue(fixedRecyclerView2, "binding.recyclerView");
        p617o0oo0o.o00000OO.OooO00o(fixedRecyclerView2);
    }
    ...
    public final void onBannerClick(int position) {
        ...
        if (jumpType == 0) {
            if (data.getUrl().length() > 0) {
                ...
                if (context2 != null) {
                    WebActivity.f22108OoooooO.OooO00o(context2, webPageInfo);
                    return;
                }
                return;
            }
        ...
        if (jumpType == 2) {
            ...
            TopicDetailActivity.f22567o0OoOo0.OooO00o(context, topicInfoModel);
        }
    }
    ...
    public final void scrollToTop() {
        getBinding().f49010OooO0o0.scrollToPosition(0);
        ...
        postGifPlayControl.OooO0O0();
        getBinding().f49009OooO0o.OooO();
        getBinding().f49009OooO0o.Oooo00o();
    }

    @Override // p503o0o00o00.OooO
    @NotNull
    public b9 getViewBinding(@NotNull LayoutInflater inflater, @Nullable ViewGroup container) {
        Intrinsics.checkNotNullParameter(inflater, "inflater");
        b9 b9VarInflate = b9.inflate(inflater);
        Intrinsics.checkNotNullExpressionValue(b9VarInflate, "inflate(inflater)");
        CollapsingToolbarLayout unconsumeWindowInset = b9VarInflate.f49007OooO0OO;
