...
public final /* data */ class RoomPKResultModel {
    ...
    public int hashCode() {
        int iOooO00o = (o0O0O00.OooO00o(this.pk_end, this.gift_picurl.hashCode() * 31, 31) + this.pk_time_duration) * 31;
        long j = this.room_a_barid;
        int iOooO00o2 = o0O0O00.OooO00o(this.room_a_picurl, o0O0O00.OooO00o(this.room_a_name, (((((iOooO00o + ((int) (j ^ (j >>> 32)))) * 31) + this.room_a_giftamount) * 31) + this.room_a_giftnumber) * 31, 31), 31);
        long j2 = this.room_b_barid;
        return this.room_b_picurl.hashCode() + o0O0O00.OooO00o(this.room_b_name, (((((iOooO00o2 + ((int) (j2 ^ (j2 >>> 32)))) * 31) + this.room_b_giftamount) * 31) + this.room_b_giftnumber) * 31, 31);
    }

    @NotNull
    public String toString() {
        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("RoomPKResultModel(gift_picurl=");
        sbOooO0o0.append(this.gift_picurl);
        sbOooO0o0.append(", pk_end=");
        sbOooO0o0.append(this.pk_end);
        sbOooO0o0.append(", pk_time_duration=");
        sbOooO0o0.append(this.pk_time_duration);
        sbOooO0o0.append(", room_a_barid=");
        sbOooO0o0.append(this.room_a_barid);
        sbOooO0o0.append(", room_a_giftamount=");
        sbOooO0o0.append(this.room_a_giftamount);
        sbOooO0o0.append(", room_a_giftnumber=");
        sbOooO0o0.append(this.room_a_giftnumber);
        sbOooO0o0.append(", room_a_name=");
        sbOooO0o0.append(this.room_a_name);
        sbOooO0o0.append(", room_a_picurl=");
        sbOooO0o0.append(this.room_a_picurl);
        sbOooO0o0.append(", room_b_barid=");
        sbOooO0o0.append(this.room_b_barid);
        sbOooO0o0.append(", room_b_giftamount=");
        sbOooO0o0.append(this.room_b_giftamount);
        sbOooO0o0.append(", room_b_giftnumber=");
        sbOooO0o0.append(this.room_b_giftnumber);
        sbOooO0o0.append(", room_b_name=");
        sbOooO0o0.append(this.room_b_name);
        sbOooO0o0.append(", room_b_picurl=");
        return o00oO0o.OooO0O0(sbOooO0o0, this.room_b_picurl, ')');
    }
    ...
    public /* synthetic */ RoomPKResultModel(String str, String str2, int i, long j, int i2, int i3, String str3, String str4, long j2, int i4, int i5, String str5, String str6, int i6, DefaultConstructorMarker defaultConstructorMarker) {
        this((i6 & 1) != 0 ? "" : str, (i6 & 2) != 0 ? "" : str2, (i6 & 4) != 0 ? 0 : i, (i6 & 8) != 0 ? 0L : j, (i6 & 16) != 0 ? 0 : i2, (i6 & 32) != 0 ? 0 : i3, (i6 & 64) != 0 ? "" : str3, (i6 & 128) != 0 ? "" : str4, (i6 & 256) == 0 ? j2 : 0L, (i6 & 512) != 0 ? 0 : i4, (i6 & 1024) == 0 ? i5 : 0, (i6 & RecyclerView.oo0o0Oo.FLAG_MOVED) != 0 ? "" : str5, (i6 & 4096) == 0 ? str6 : "");
    }
}
