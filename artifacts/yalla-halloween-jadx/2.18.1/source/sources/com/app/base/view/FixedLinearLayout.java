...
public class FixedLinearLayout extends LinearLayout {
    ...
    public GestureDetector f11980Oooo0o;
    ...
    public class OooO00o implements GestureDetector.OnGestureListener {
        ...
        public final boolean onScroll(MotionEvent motionEvent, MotionEvent motionEvent2, float f, float f2) {
            if (Math.abs(motionEvent2.getRawX() - motionEvent.getRawX()) > Math.abs(motionEvent2.getRawY() - motionEvent.getRawY())) {
                FixedLinearLayout.this.getParent().requestDisallowInterceptTouchEvent(false);
            } else {
                FixedLinearLayout.this.getParent().requestDisallowInterceptTouchEvent(true);
            }
            return false;
    ...
    public final void OooO00o() {
        this.f11980Oooo0o = new GestureDetector(getContext(), new OooO00o());
    }

    @Override // android.view.ViewGroup, android.view.View
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        this.f11980Oooo0o.onTouchEvent(motionEvent);
