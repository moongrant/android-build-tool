...
public abstract class AppBarStateChangeListener implements AppBarLayout.OooO0O0 {
    ...
    public State f12229OooO00o = State.IDLE;
    ...
    public final void OooO00o(AppBarLayout appBarLayout, int i) {
        if (i == 0) {
            State state = this.f12229OooO00o;
            State state2 = State.EXPANDED;
            if (state != state2) {
                OooO0O0(appBarLayout, state, state2);
            }
            this.f12229OooO00o = state2;
            return;
        }
        if (Math.abs(i) >= appBarLayout.getTotalScrollRange()) {
            State state3 = this.f12229OooO00o;
            State state4 = State.COLLAPSED;
            if (state3 != state4) {
                OooO0O0(appBarLayout, state3, state4);
            }
            this.f12229OooO00o = state4;
            return;
        }
        State state5 = this.f12229OooO00o;
        State state6 = State.IDLE;
        if (state5 != state6) {
            OooO0O0(appBarLayout, state5, state6);
        }
        this.f12229OooO00o = state6;
    }
