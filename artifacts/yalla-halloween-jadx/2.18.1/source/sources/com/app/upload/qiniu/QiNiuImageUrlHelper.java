...
public class QiNiuImageUrlHelper {
    ...
    public static String getBlurUrl(String str, int i, int i2) {
        ...
        return isGifUrl(str) ? stringMerge(url, imageMogr2_blur, o00O00OO.OooO00o(slash, i, "x", i2), format_jpg) : stringMerge(url, imageMogr2_blur, o00O00OO.OooO00o(slash, i, "x", i2));
    }
    ...
    private static String getThumbnail(double d) {
        ...
        return stringMerge(imageMogr2_thumbnail, String.valueOf(d), ak.ax);
    }
    ...
    public static String getWatermarkUrl(String str, String str2, String str3, int i, int i2, int i3) {
        ...
        if (TextUtils.isEmpty(str2)) {
            ...
            StringBuilder sbOooO0o0 = OooO00o.OooO00o.OooO0o0("?watermark/2/text/");
            sbOooO0o0.append(UrlSafeBase64.encodeToString(str2));
            string = sbOooO0o0.toString();
        }
        if (TextUtils.isEmpty(string) || TextUtils.isEmpty(str3)) {
            string2 = null;
        } else {
            StringBuilder sbOooO0o1 = OooO00o.OooO00o.OooO0o0(watermark_fill);
            sbOooO0o1.append(UrlSafeBase64.encodeToString(str3));
            string2 = sbOooO0o1.toString();
        }
        String strOooO00o2 = (TextUtils.isEmpty(string) || i <= 0) ? null : OooO00o.OooO00o(watermark_fontsize, i);
        String strOooO00o3 = (TextUtils.isEmpty(string) || i2 <= 0) ? null : OooO00o.OooO00o(watermark_dx, i2);
        if (!TextUtils.isEmpty(string) && i3 > 0) {
            strOooO00o = OooO00o.OooO00o(watermark_dy, i3);
        }
        return stringMerge(url, string, string2, strOooO00o2, strOooO00o3, strOooO00o);
    }
