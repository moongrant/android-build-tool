...
public final class OooO00o {
    ...
    public static final o000000O<Boolean> f12512OooO;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public static final o000000O<DecodeFormat> f12513OooO0o = o000000O.OooO00o("com.bumptech.glide.load.resource.bitmap.Downsampler.DecodeFormat", DecodeFormat.DEFAULT);

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public static final o000000O<PreferredColorSpace> f12514OooO0oO = o000000O.OooO00o("com.bumptech.glide.load.resource.bitmap.Downsampler.PreferredColorSpace", PreferredColorSpace.SRGB);

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public static final o000000O<Boolean> f12515OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public static final Set<String> f12516OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public static final C0080OooO00o f12517OooOO0O;

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    public static final Set<ImageHeaderParser.ImageType> f12518OooOO0o;

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    public static final Queue<BitmapFactory.Options> f12519OooOOO0;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final o0oOOo f12520OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final DisplayMetrics f12521OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final o0O00o0 f12522OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final List<ImageHeaderParser> f12523OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final oO0o0000 f12524OooO0o0 = oO0o0000.OooO00o();
    ...
    static {
        o000000O<DownsampleStrategy> o000000o2 = DownsampleStrategy.f12509OooO0o;
        Boolean bool = Boolean.FALSE;
        f12515OooO0oo = o000000O.OooO00o("com.bumptech.glide.load.resource.bitmap.Downsampler.FixBitmapSize", bool);
        f12512OooO = o000000O.OooO00o("com.bumptech.glide.load.resource.bitmap.Downsampler.AllowHardwareDecode", bool);
        f12516OooOO0 = Collections.unmodifiableSet(new HashSet(Arrays.asList("image/vnd.wap.wbmp", "image/x-ico")));
        f12517OooOO0O = new C0080OooO00o();
        f12518OooOO0o = Collections.unmodifiableSet(EnumSet.of(ImageHeaderParser.ImageType.JPEG, ImageHeaderParser.ImageType.PNG_A, ImageHeaderParser.ImageType.PNG));
        char[] cArr = o000O000.f34177OooO00o;
        f12519OooOOO0 = new ArrayDeque(0);
    }

    public OooO00o(List<ImageHeaderParser> list, DisplayMetrics displayMetrics, o0oOOo o0oooo2, o0O00o0 o0o00o1) {
        this.f12523OooO0Oo = list;
        Objects.requireNonNull(displayMetrics, "Argument must not be null");
        this.f12521OooO0O0 = displayMetrics;
        Objects.requireNonNull(o0oooo2, "Argument must not be null");
        this.f12520OooO00o = o0oooo2;
        Objects.requireNonNull(o0o00o1, "Argument must not be null");
        this.f12522OooO0OO = o0o00o1;
    }
    ...
    */
    ...
    public static IOException OooO0oo(IllegalArgumentException illegalArgumentException, int i, int i2, String str, BitmapFactory.Options options) {
        StringBuilder sbOooO0O0 = o000O0Oo.OooO0O0("Exception decoding bitmap, outWidth: ", i, ", outHeight: ", i2, ", outMimeType: ");
        sbOooO0O0.append(str);
        sbOooO0O0.append(", inBitmap: ");
        sbOooO0O0.append(OooO0Oo(options.inBitmap));
        return new IOException(sbOooO0O0.toString(), illegalArgumentException);
    }
    ...
    public final o00OOOO0<Bitmap> OooO00o(com.bumptech.glide.load.resource.bitmap.OooO0O0 oooO0O0, int i, int i2, o00000 o00000Var, OooO0O0 oooO0O1) throws IOException {
        ?? r14;
        BitmapFactory.Options options;
        BitmapFactory.Options options2;
        byte[] bArr = (byte[]) this.f12522OooO0OO.OooO0oO(65536, byte[].class);
        ...
        DecodeFormat decodeFormat = (DecodeFormat) o00000Var.OooO0OO(f12513OooO0o);
        PreferredColorSpace preferredColorSpace = (PreferredColorSpace) o00000Var.OooO0OO(f12514OooO0oO);
        DownsampleStrategy downsampleStrategy = (DownsampleStrategy) o00000Var.OooO0OO(DownsampleStrategy.f12509OooO0o);
        boolean zBooleanValue = ((Boolean) o00000Var.OooO0OO(f12515OooO0oo)).booleanValue();
        o000000O<Boolean> o000000o2 = f12512OooO;
        try {
            oO0O0O0o oo0o0o0oOooO0O0 = oO0O0O0o.OooO0O0(OooO0O0(oooO0O0, options2, downsampleStrategy, decodeFormat, preferredColorSpace, o00000Var.OooO0OO(o000000o2) != null && ((Boolean) o00000Var.OooO0OO(o000000o2)).booleanValue(), i, i2, zBooleanValue, oooO0O1), this.f12520OooO00o);
            OooO(options2);
            synchronized (r14) {
                r14.offer(options2);
            }
            return oo0o0o0oOooO0O0;
        } finally {
            OooO(options2);
            ?? r2 = f12519OooOOO0;
            synchronized (r2) {
                r2.offer(options2);
                this.f12522OooO0OO.OooO0o(bArr);
            }
        }
    }
    ...
    public final Bitmap OooO0O0(com.bumptech.glide.load.resource.bitmap.OooO0O0 oooO0O0, BitmapFactory.Options options, DownsampleStrategy downsampleStrategy, DecodeFormat decodeFormat, PreferredColorSpace preferredColorSpace, boolean z, int i, int i2, boolean z2, OooO0O0 oooO0O1) throws IOException {
        ...
        boolean z3;
        int i11;
        int i12 = o0000O0O.f34164OooO0O0;
        long jElapsedRealtimeNanos = SystemClock.elapsedRealtimeNanos();
        int[] iArrOooO0o = OooO0o(oooO0O0, options, oooO0O1, this.f12520OooO00o);
        ...
        boolean zOooO0Oo = oOO000.OooO0Oo(iOooO00o);
        ...
        o0oOOo o0oooo2 = this.f12520OooO00o;
        ...
        if (i13 <= 0 || i14 <= 0) {
            ...
            if (i21 <= 23) {
                str3 = "x";
                if (f12516OooOO0.contains(options.outMimeType)) {
                    iMax = 1;
                }
                ...
                if (Log.isLoggable(str8, 2)) {
                    ...
                    i13 = i13;
                    str7 = str3;
                    StringBuilder sbOooO0O0 = o000O0Oo.OooO0O0("Calculate scaling, source: [", i13, str7, i14, "], degreesToRotate: ");
                    sbOooO0O0.append(i16);
                    sbOooO0O0.append(", target: [");
                    sbOooO0O0.append(i4);
                    sbOooO0O0.append(str7);
                    sbOooO0O0.append(i5);
                    sbOooO0O0.append("], power of two scaled: [");
                    sbOooO0O0.append(iFloor);
                    sbOooO0O0.append(str7);
                    sbOooO0O0.append(iRound2);
                    sbOooO0O0.append("], exact scale factor: ");
                    sbOooO0O0.append(fOooO0O0);
                    sbOooO0O0.append(", power of 2 sample size: ");
                    sbOooO0O0.append(iMax);
                    sbOooO0O0.append(", adjusted scale factor: ");
                    sbOooO0O0.append(dOooO0O0);
                    str5 = ", target density: ";
                    sbOooO0O0.append(str5);
                    sbOooO0O0.append(options.inTargetDensity);
                    str6 = ", density: ";
                    sbOooO0O0.append(str6);
                    sbOooO0O0.append(options.inDensity);
                    Log.v(str8, sbOooO0O0.toString());
                } else {
                    str6 = str6;
                    str5 = str5;
                    i14 = i14;
            ...
            if (Log.isLoggable(str8, 2)) {
                ...
                i13 = i13;
                str7 = str3;
                StringBuilder sbOooO0O1 = o000O0Oo.OooO0O0("Calculate scaling, source: [", i13, str7, i14, "], degreesToRotate: ");
                sbOooO0O1.append(i16);
                sbOooO0O1.append(", target: [");
                sbOooO0O1.append(i4);
                sbOooO0O1.append(str7);
                sbOooO0O1.append(i5);
                sbOooO0O1.append("], power of two scaled: [");
                sbOooO0O1.append(iFloor);
                sbOooO0O1.append(str7);
                sbOooO0O1.append(iRound2);
                sbOooO0O1.append("], exact scale factor: ");
                sbOooO0O1.append(fOooO0O0);
                sbOooO0O1.append(", power of 2 sample size: ");
                sbOooO0O1.append(iMax);
                sbOooO0O1.append(", adjusted scale factor: ");
                sbOooO0O1.append(dOooO0O0);
                str5 = ", target density: ";
                sbOooO0O1.append(str5);
                sbOooO0O1.append(options.inTargetDensity);
                str6 = ", density: ";
                sbOooO0O1.append(str6);
                sbOooO0O1.append(options.inDensity);
                Log.v(str8, sbOooO0O1.toString());
            } else {
                str6 = str6;
                str5 = str5;
                i14 = i14;
        ...
        boolean z5 = z4;
        String str11 = str5;
        if (this.f12524OooO0o0.OooO0OO(i25, i24, options, z5, zOooO0Oo)) {
            str2 = str7;
        } else {
            str2 = str7;
        ...
        if (i13 < 0 || i14 < 0 || !z2) {
            ...
            if (Log.isLoggable(str9, 2)) {
                StringBuilder sbOooO0O2 = o000O0Oo.OooO0O0("Calculated target [", iRound, str2, iRound3, "] for source [");
                sbOooO0O2.append(i13);
                sbOooO0O2.append(str2);
                sbOooO0O2.append(i14);
                sbOooO0O2.append("], sampleSize: ");
                sbOooO0O2.append(i28);
                sbOooO0O2.append(", targetDensity: ");
                sbOooO0O2.append(options.inTargetDensity);
                sbOooO0O2.append(str6);
                sbOooO0O2.append(options.inDensity);
                sbOooO0O2.append(", density multiplier: ");
                sbOooO0O2.append(f8);
                Log.v(str9, sbOooO0O2.toString());
            }
            i6 = iRound3;
        } else {
            i6 = i24;
        ...
        if (iRound > 0 && i6 > 0) {
            o0oOOo o0oooo3 = this.f12520OooO00o;
            if (i27 >= 26) {
        ...
        Bitmap bitmapOooO0OO = OooO0OO(oooO0O0, options, oooO0O1, this.f12520OooO00o);
        oooO0O1.OooO00o(this.f12520OooO00o, bitmapOooO0OO);
        if (Log.isLoggable(str9, 2)) {
            ...
            o00O0.OooO0OO(sbOooO0o0, "] ", str10, " with inBitmap ");
            sbOooO0o0.append(OooO0Oo(options.inBitmap));
        ...
        bitmapOooO0OO.setDensity(this.f12521OooO0O0.densityDpi);
        o0oOOo o0oooo4 = this.f12520OooO00o;
        if (oOO000.OooO0Oo(iOooO00o)) {
            ...
            Bitmap bitmapOooO0OO2 = o0oooo4.OooO0OO(Math.round(rectF.width()), Math.round(rectF.height()), oOO000.OooO0OO(bitmapOooO0OO));
            matrix.postTranslate(-rectF.left, -rectF.top);
            bitmapOooO0OO2.setHasAlpha(bitmapOooO0OO.hasAlpha());
            oOO000.OooO00o(bitmapOooO0OO, bitmapOooO0OO2, matrix);
        ...
        this.f12520OooO00o.OooO0O0(bitmapOooO0OO);
        return bitmap;
    }
}
