...
public final class AuthenticationToken implements Parcelable {
    ...
    public AuthenticationToken(@NotNull String token, @NotNull String expectedNonce) {
        ...
        Validate.notEmpty(token, FirebaseMessagingService.EXTRA_TOKEN);
    ...
    public int hashCode() {
        return this.signature.hashCode() + ((this.claims.hashCode() + ((this.header.hashCode() + o0O0O00.OooO00o(this.expectedNonce, o0O0O00.OooO00o(this.token, 527, 31), 31)) * 31)) * 31);
    }
    ...
    public AuthenticationToken(@NotNull Parcel parcel) {
        ...
        Validate validate = Validate.INSTANCE;
        this.token = Validate.notNullOrEmpty(string, FirebaseMessagingService.EXTRA_TOKEN);
