...
public final class FacebookContentProvider extends ContentProvider {
    ...
    public static final class Companion {
        ...
        public final String getAttachmentUrl(@Nullable String applicationId, @NotNull UUID callId, @Nullable String attachmentName) {
            ...
            return OooO00o.OooO0OO.OooO00o(new Object[]{FacebookContentProvider.ATTACHMENT_URL_BASE, applicationId, callId.toString(), attachmentName}, 4, "%s%s/%s/%s", "java.lang.String.format(format, *args)");
        }
    }
    ...
    private final Pair<UUID, String> parseCallIdAndAttachmentName(Uri uri) {
        try {
            ...
            Object[] array = StringsKt__StringsKt.split$default(strSubstring, new String[]{"/"}, false, 0, 6, (Object) null).toArray(new String[0]);
            if (array == null) {
    ...
    public ParcelFileDescriptor openFile(@NotNull Uri uri, @NotNull String mode) throws FileNotFoundException {
        ...
        try {
            ...
            if (fileOpenAttachment != null) {
                return ParcelFileDescriptor.open(fileOpenAttachment, SQLiteDatabase.CREATE_IF_NECESSARY);
            }
            throw new FileNotFoundException();
