...
public class FacebookException extends RuntimeException {
    ...
    public static final void m91_init_$lambda0(String str, boolean z) {
        if (z) {
            try {
    ...
    public FacebookException(@Nullable String str) {
        ...
        if (str != null) {
            ...
            FeatureManager.checkFeature(FeatureManager.Feature.ErrorReport, new OooOO0(str, 0));
        }
    }
    ...
    public FacebookException(@Nullable String str, @NotNull Object... args) {
        ...
        if (str == null) {
            ...
            strOooO00o = OooO00o.OooO0OO.OooO00o(objArrCopyOf, objArrCopyOf.length, str, "java.lang.String.format(this, *args)");
        }
        this(strOooO00o);
    }
