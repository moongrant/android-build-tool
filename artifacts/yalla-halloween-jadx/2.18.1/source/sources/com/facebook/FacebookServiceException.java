...
public final class FacebookServiceException extends FacebookException {
    ...
    public String toString() {
        StringBuilder sbOooO00o = p708oo000o.Oooo0.OooO00o("{FacebookServiceException: ", "httpResponseCode: ");
        sbOooO00o.append(this.requestError.getRequestStatusCode());
        sbOooO00o.append(", facebookErrorCode: ");
        sbOooO00o.append(this.requestError.getErrorCode());
        sbOooO00o.append(", facebookErrorType: ");
        sbOooO00o.append(this.requestError.getErrorType());
        sbOooO00o.append(", message: ");
        sbOooO00o.append(this.requestError.getErrorMessage());
        sbOooO00o.append("}");
