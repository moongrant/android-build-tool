...
public final class ProgressOutputStream extends FilterOutputStream implements RequestOutputStream {
        ...
        if (this.batchProgress > this.lastReportedProgress) {
            for (GraphRequestBatch.Callback callback : this.requests.getCallbacks()) {
                if (callback instanceof GraphRequestBatch.OnProgressCallback) {
                    ...
                    if ((callbackHandler == null ? null : Boolean.valueOf(callbackHandler.post(new o00Ooo(callback, this, 0)))) == null) {
    ...
    public static final void m105reportBatchProgress$lambda0(GraphRequestBatch.Callback callback, ProgressOutputStream this$0) {
