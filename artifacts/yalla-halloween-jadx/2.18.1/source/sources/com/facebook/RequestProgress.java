...
public final class RequestProgress {
    ...
    public static final void m106reportProgress$lambda0(GraphRequest.Callback callback, long j, long j2) {
        ...
        if (this.progress > this.lastReportedProgress) {
            ...
            if ((handler == null ? null : Boolean.valueOf(handler.post(new Runnable() { // from class: com.facebook.oo000o
                ...
                public final void run() {
                    RequestProgress.m106reportProgress$lambda0(callback, j2, j);
                }
            }))) == null) {
