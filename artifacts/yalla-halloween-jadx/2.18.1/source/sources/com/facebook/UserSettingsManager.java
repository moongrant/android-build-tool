...
public final class UserSettingsManager {
    ...
    public static final class UserSetting {
        ...
        public final boolean m108getValue() {
    ...
    public static final boolean getAdvertiserIDCollectionEnabled() {
        ...
        try {
            ...
            return advertiserIDCollectionEnabled.m108getValue();
        } catch (Throwable th) {
    ...
    public static final boolean getAutoInitEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return autoInitEnabled.m108getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    public static final boolean getAutoLogAppEventsEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return autoLogAppEventsEnabled.m108getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    public static final boolean getCodelessSetupEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return codelessSetupEnabled.m108getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    public static final boolean getMonitorEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return monitorEnabled.m108getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
                ...
                if (isFetchingCodelessStatus.compareAndSet(false, true)) {
                    ...
                    FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.o00oO0o
                        ...
                        public final void run() {
                            UserSettingsManager.m107initializeCodelessSetupEnabledAsync$lambda0(jCurrentTimeMillis);
                        }
                    });
                }
            }
    ...
    public static final void m107initializeCodelessSetupEnabledAsync$lambda0(long j) {
        if (CrashShieldHandler.isObjectCrashing(UserSettingsManager.class)) {
            return;
        }
        try {
            if (advertiserIDCollectionEnabled.m108getValue()) {
        ...
        try {
            if (isInitialized.get()) {
                ...
                if (FacebookSdk.isInitialized()) {
                    Context applicationContext = FacebookSdk.getApplicationContext();
                    int i3 = 0;
                    int i4 = ((autoInitEnabled.m108getValue() ? 1 : 0) << 0) | 0 | ((autoLogAppEventsEnabled.m108getValue() ? 1 : 0) << 1) | ((advertiserIDCollectionEnabled.m108getValue() ? 1 : 0) << 2) | ((monitorEnabled.m108getValue() ? 1 : 0) << 3);
