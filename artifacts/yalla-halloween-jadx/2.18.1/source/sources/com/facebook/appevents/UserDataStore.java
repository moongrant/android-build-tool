...
public final class UserDataStore {
    ...
    public static final void clear() {
        ...
        try {
            InternalAppEventsLogger.INSTANCE.getAnalyticsExecutor().execute(new Runnable() { // from class: com.facebook.appevents.o00O0O
                @Override // java.lang.Runnable
                public final void run() {
                    UserDataStore.m125clear$lambda2();
                }
            });
        } catch (Throwable th) {
    ...
    public static final void m125clear$lambda2() {
        if (CrashShieldHandler.isObjectCrashing(UserDataStore.class)) {
            return;
        }
        try {
    ...
    public static final void setUserDataAndHash(@Nullable final Bundle ud) {
        ...
        try {
            InternalAppEventsLogger.INSTANCE.getAnalyticsExecutor().execute(new Runnable() { // from class: com.facebook.appevents.o0OoOo0
                @Override // java.lang.Runnable
                public final void run() {
                    UserDataStore.m126setUserDataAndHash$lambda1(ud);
                }
            });
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserDataStore.class);
    ...
    public static final void m126setUserDataAndHash$lambda1(Bundle bundle) {
        if (CrashShieldHandler.isObjectCrashing(UserDataStore.class)) {
            return;
        }
        try {
    ...
    private final void writeDataIntoCache(String key, String value) {
        ...
        try {
            FacebookSdk facebookSdk = FacebookSdk.INSTANCE;
            FacebookSdk.getExecutor().execute(new o000oOoO(key, value, 0));
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
        }
    }
    ...
    public static final void m127writeDataIntoCache$lambda0(String key, String value) {
        if (CrashShieldHandler.isObjectCrashing(UserDataStore.class)) {
            return;
        }
        try {
