...
public final class CodelessMatcher {
    ...
    public static final class ViewMatcher implements ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, Runnable {
        ...
        private final void attachListener(MatchedView matchedView, View rootView, EventBinding mapping) {
            ...
            try {
                ...
                if (viewFindRCTRootView != null && viewHierarchy.isRCTButton(view, viewFindRCTRootView)) {
                    attachRCTListener(matchedView, rootView, mapping);
                    return;
                }
                String name = view.getClass().getName();
                Intrinsics.checkNotNullExpressionValue(name, "view.javaClass.name");
                if (StringsKt.OooOoOO(name, "com.facebook.react")) {
                    return;
                }
    ...
    private final void startTracking() {
        ...
        try {
            if (Thread.currentThread() == Looper.getMainLooper().getThread()) {
                ...
                this.uiThreadHandler.post(new OooO0O0(this, 0));
            }
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
        }
    ...
    public static final void m136startTracking$lambda1(CodelessMatcher this$0) {
        if (CrashShieldHandler.isObjectCrashing(CodelessMatcher.class)) {
            return;
        }
        try {
