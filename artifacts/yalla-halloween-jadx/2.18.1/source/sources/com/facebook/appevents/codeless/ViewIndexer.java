...
public final class ViewIndexer {
    ...
    public static final class Companion {
        ...
        public static final void m139buildAppIndexingRequest$lambda0(GraphResponse it) {
        ...
        public final GraphRequest buildAppIndexingRequest(@Nullable String appIndex, @Nullable AccessToken accessToken, @Nullable String appId, @NotNull String requestType) {
            ...
            graphRequestNewPostRequest.setCallback(new GraphRequest.Callback() { // from class: com.facebook.appevents.codeless.OooO0o
                @Override // com.facebook.GraphRequest.Callback
                public final void onCompleted(GraphResponse graphResponse) {
                    ViewIndexer.Companion.m139buildAppIndexingRequest$lambda0(graphResponse);
                }
            });
    ...
    public static final void m137schedule$lambda0(ViewIndexer this$0, TimerTask indexingTask) {
        if (CrashShieldHandler.isObjectCrashing(ViewIndexer.class)) {
            return;
        }
        try {
    ...
    private final void sendToServer(String tree) {
        ...
        try {
            ...
            FacebookSdk.getExecutor().execute(new o00O0O(tree, this, 2));
        } catch (Throwable th) {
    ...
    public static final void m138sendToServer$lambda1(String tree, ViewIndexer this$0) {
        if (CrashShieldHandler.isObjectCrashing(ViewIndexer.class)) {
            return;
        }
        try {
    ...
    public final void schedule() {
        ...
        try {
            ...
            try {
                FacebookSdk facebookSdk = FacebookSdk.INSTANCE;
                FacebookSdk.getExecutor().execute(new OooO0OO(this, timerTask, 0));
