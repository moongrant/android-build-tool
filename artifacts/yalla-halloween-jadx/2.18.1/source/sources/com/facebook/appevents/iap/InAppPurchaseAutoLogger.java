...
@Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\bÇ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\b\u0010\u0005\u001a\u00020\u0006H\u0002J\u0010\u0010\u0007\u001a\u00020\u00062\u0006\u0010\b\u001a\u00020\tH\u0007R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\n"}, d2 = {"Lcom/facebook/appevents/iap/InAppPurchaseAutoLogger;", "", "()V", "BILLING_CLIENT_PURCHASE_NAME", "", "logPurchase", "", "startIapLogging", d.R, "Landroid/content/Context;", "facebook-core_release"}, k = 1, mv = {1, 5, 1}, xi = 48)
...
public final class InAppPurchaseAutoLogger {
    ...
    public static final void startIapLogging(@NotNull Context context) {
        ...
        try {
            ...
            if (InAppPurchaseLoggerManager.eligibleQueryPurchaseHistory()) {
                orCreateInstance.queryPurchaseHistory(BillingClient.SkuType.INAPP, new Runnable() { // from class: o0O00Oo.OooO
                    @Override // java.lang.Runnable
                    public final void run() {
                        InAppPurchaseAutoLogger.m142startIapLogging$lambda0();
                    }
                });
            } else {
                orCreateInstance.queryPurchase(BillingClient.SkuType.INAPP, new Runnable() { // from class: o0O00Oo.OooOO0
                    @Override // java.lang.Runnable
                    public final void run() {
                        InAppPurchaseAutoLogger.m143startIapLogging$lambda1();
                    }
                });
            }
        } catch (Throwable th) {
    ...
    public static final void m142startIapLogging$lambda0() {
        if (CrashShieldHandler.isObjectCrashing(InAppPurchaseAutoLogger.class)) {
            return;
        }
        try {
    ...
    public static final void m143startIapLogging$lambda1() {
        if (CrashShieldHandler.isObjectCrashing(InAppPurchaseAutoLogger.class)) {
            return;
        }
        try {
