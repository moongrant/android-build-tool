...
public final class ActivityLifecycleTracker {
    ...
    public static final void onActivityCreated(@Nullable Activity activity) {
        singleThreadExecutor.execute(new Runnable() { // from class: com.facebook.appevents.internal.OooO
            @Override // java.lang.Runnable
            public final void run() {
                ActivityLifecycleTracker.m145onActivityCreated$lambda1();
            }
        });
    }
    ...
    public static final void m145onActivityCreated$lambda1() {
    ...
    public final void onActivityPaused(Activity activity) {
        ...
        singleThreadExecutor.execute(new Runnable() { // from class: com.facebook.appevents.internal.OooO0O0
            @Override // java.lang.Runnable
            public final void run() {
                ActivityLifecycleTracker.m146onActivityPaused$lambda6(jCurrentTimeMillis, activityName);
            }
        });
    }
    ...
    public static final void m146onActivityPaused$lambda6(final long j, final String activityName) {
        ...
        if (foregroundActivityCount.get() <= 0) {
            Runnable runnable = new Runnable() { // from class: com.facebook.appevents.internal.OooO0OO
                @Override // java.lang.Runnable
                public final void run() {
                    ActivityLifecycleTracker.m147onActivityPaused$lambda6$lambda4(j, activityName);
                }
            };
            synchronized (currentFutureLock) {
    ...
    public static final void m147onActivityPaused$lambda6$lambda4(long j, String activityName) {
        Intrinsics.checkNotNullParameter(activityName, "$activityName");
        if (currentSession == null) {
            currentSession = new SessionInfo(Long.valueOf(j), null, null, 4, null);
        }
    ...
    public static final void onActivityResumed(@NotNull Activity activity) {
        ...
        singleThreadExecutor.execute(new Runnable() { // from class: com.facebook.appevents.internal.OooO0o
            @Override // java.lang.Runnable
            public final void run() {
                ActivityLifecycleTracker.m148onActivityResumed$lambda2(jCurrentTimeMillis, activityName, applicationContext);
            }
        });
    }
    ...
    public static final void m148onActivityResumed$lambda2(long j, String activityName, Context appContext) {
        SessionInfo sessionInfo;
        Intrinsics.checkNotNullParameter(activityName, "$activityName");
        SessionInfo sessionInfo2 = currentSession;
    ...
    public static final void startTracking(@NotNull Application application, @Nullable String appId2) {
        ...
        if (tracking.compareAndSet(false, true)) {
            ...
            FeatureManager.checkFeature(FeatureManager.Feature.CodelessEvents, OooO00o.f12747OooO0Oo);
            appId = appId2;
    ...
    public static final void m149startTracking$lambda0(boolean z) {
        if (z) {
            CodelessManager codelessManager = CodelessManager.INSTANCE;
