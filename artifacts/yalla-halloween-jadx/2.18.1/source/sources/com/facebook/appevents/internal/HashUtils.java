                        ...
                        if (Intrinsics.areEqual(method.getName(), "onChecksumsReady") && objects.length == 1 && (objects[0] instanceof List)) {
                            for (Object obj2 : (List) objects[0]) {
                                if (obj2 != null) {
                                    ...
                                    if (method2.invoke(obj2, new Object[0]) == null && Intrinsics.areEqual(method3.invoke(obj2, new Object[0]), obj)) {
