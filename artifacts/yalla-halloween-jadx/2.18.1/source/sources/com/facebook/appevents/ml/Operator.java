...
public final class Operator {
            ...
            if (shape2 > 0) {
                ...
                while (true) {
                    ...
                    if (length2 >= 0) {
                        ...
                        while (true) {
                            int i7 = i6 + 1;
                            float[] data2 = tensors[i6].getData();
                            int shape3 = tensors[i6].getShape(1);
                            System.arraycopy(data2, i3 * shape3, data, i5, shape3);
                            i5 += shape3;
                            if (i7 > length2) {
                                break;
                            }
                                ...
                                while (true) {
                                    ...
                                    if (poolSize > 0) {
                                        ...
                                        while (true) {
                                            int i13 = i12 + 1;
                                            i = shape2;
                                            data2[i10] = Math.max(data2[i10], data[(i12 * shape3) + i11]);
                                            if (i13 >= poolSize) {
                                                break;
                                            }
                                            i12 = i13;
    ...
    public static final void relu(@NotNull MTensor x) {
        ...
        try {
            ...
            while (true) {
                int i2 = i + 1;
                if (data[i] < ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE) {
                    data[i] = 0.0f;
                }
                if (i2 > length) {
                    return;
