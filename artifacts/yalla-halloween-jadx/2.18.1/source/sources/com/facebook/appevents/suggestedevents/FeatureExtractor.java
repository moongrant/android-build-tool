...
public final class FeatureExtractor {
    ...
    public static final void initialize(@Nullable File file) {
        ...
        try {
            try {
                ...
                languageInfo = MapsKt.mapOf(TuplesKt.to(ViewHierarchyConstants.ENGLISH, "1"), TuplesKt.to(ViewHierarchyConstants.GERMAN, FeedbackType.Suggestions), TuplesKt.to(ViewHierarchyConstants.SPANISH, FeedbackType.Recharge), TuplesKt.to(ViewHierarchyConstants.JAPANESE, "4"));
                eventInfo = MapsKt.mapOf(TuplesKt.to(ViewHierarchyConstants.VIEW_CONTENT, AppEventsConstants.EVENT_PARAM_VALUE_NO), TuplesKt.to(ViewHierarchyConstants.SEARCH, "1"), TuplesKt.to(ViewHierarchyConstants.ADD_TO_CART, FeedbackType.Suggestions), TuplesKt.to(ViewHierarchyConstants.ADD_TO_WISHLIST, FeedbackType.Recharge), TuplesKt.to(ViewHierarchyConstants.INITIATE_CHECKOUT, "4"), TuplesKt.to(ViewHierarchyConstants.ADD_PAYMENT_INFO, FeedbackType.Others), TuplesKt.to(ViewHierarchyConstants.PURCHASE, "6"), TuplesKt.to(ViewHierarchyConstants.LEAD, "7"), TuplesKt.to(ViewHierarchyConstants.COMPLETE_REGISTRATION, "8"));
                textTypeInfo = MapsKt.mapOf(TuplesKt.to(ViewHierarchyConstants.BUTTON_TEXT, "1"), TuplesKt.to(ViewHierarchyConstants.PAGE_TITLE, FeedbackType.Suggestions), TuplesKt.to(ViewHierarchyConstants.RESOLVED_DOCUMENT_LINK, FeedbackType.Recharge), TuplesKt.to(ViewHierarchyConstants.BUTTON_ID, "4"));
                initialized = true;
            } catch (Throwable th) {
                CrashShieldHandler.handleThrowable(th, FeatureExtractor.class);
            }
        ...
        try {
            ...
            while (i < length) {
                ...
                while (i2 < length2) {
                    ...
                    i2++;
                    if (StringsKt__StringsKt.contains$default(str2, str, false, 2, (Object) null)) {
                        return true;
                    }
                }
            }
    ...
    private final float[] nonparseFeatures(JSONObject node, JSONArray siblings, String screenName, String formFieldsJSON, String appName) {
        ...
        try {
            ...
            fArr[3] = length > 1 ? length - 1.0f : ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
            try {
                int length2 = siblings.length();
                if (length2 > 0) {
                    while (true) {
                        int i3 = i + 1;
                        JSONObject jSONObject = siblings.getJSONObject(i);
            ...
            fArr[15] = regexMatched(ViewHierarchyConstants.ENGLISH, ViewHierarchyConstants.COMPLETE_REGISTRATION, ViewHierarchyConstants.BUTTON_TEXT, string2) ? 1.0f : ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
            fArr[16] = regexMatched(ViewHierarchyConstants.ENGLISH, ViewHierarchyConstants.COMPLETE_REGISTRATION, ViewHierarchyConstants.PAGE_TITLE, str) ? 1.0f : ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
            fArr[17] = regexMatched(ViewHierarchyConstants.ENGLISH, ViewHierarchyConstants.COMPLETE_REGISTRATION, ViewHierarchyConstants.BUTTON_ID, string) ? 1.0f : ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
            fArr[18] = StringsKt__StringsKt.contains$default(formFieldsJSON, REGEX_CR_PASSWORD_FIELD, false, 2, (Object) null) ? 1.0f : ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
            fArr[19] = regexMatched(REGEX_CR_HAS_CONFIRM_PASSWORD_FIELD, formFieldsJSON) ? 1.0f : ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
            fArr[20] = regexMatched(REGEX_CR_HAS_LOG_IN_KEYWORDS, formFieldsJSON) ? 1.0f : ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
            fArr[21] = regexMatched(REGEX_CR_HAS_SIGN_ON_KEYWORDS, formFieldsJSON) ? 1.0f : ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
            fArr[22] = regexMatched(ViewHierarchyConstants.ENGLISH, ViewHierarchyConstants.PURCHASE, ViewHierarchyConstants.BUTTON_TEXT, string2) ? 1.0f : ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
            fArr[24] = regexMatched(ViewHierarchyConstants.ENGLISH, ViewHierarchyConstants.PURCHASE, ViewHierarchyConstants.PAGE_TITLE, str) ? 1.0f : ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
            fArr[25] = regexMatched(REGEX_ADD_TO_CART_BUTTON_TEXT, string2) ? 1.0f : ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
            fArr[27] = regexMatched(REGEX_ADD_TO_CART_PAGE_TITLE, str) ? 1.0f : ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
            fArr[28] = regexMatched(ViewHierarchyConstants.ENGLISH, ViewHierarchyConstants.LEAD, ViewHierarchyConstants.BUTTON_TEXT, string2) ? 1.0f : ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
            fArr[29] = regexMatched(ViewHierarchyConstants.ENGLISH, ViewHierarchyConstants.LEAD, ViewHierarchyConstants.PAGE_TITLE, str) ? 1.0f : ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
            return fArr;
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
            return null;
    ...
    private final float[] parseFeatures(JSONObject node) {
        ...
        try {
            ...
            if (StringsKt__StringsKt.contains$default(lowerCase3, "checkbox", false, 2, (Object) null)) {
                fArr[8] = fArr[8] + 1.0f;
            }
            if (matchIndicators(new String[]{"complete", "confirm", "done", "submit"}, new String[]{lowerCase})) {
                fArr[10] = fArr[10] + 1.0f;
            }
            if (StringsKt__StringsKt.contains$default(lowerCase3, "radio", false, 2, (Object) null) && StringsKt__StringsKt.contains$default(lowerCase3, "button", false, 2, (Object) null)) {
    ...
    private final void updateHintAndTextRecursively(JSONObject view, StringBuilder textSB, StringBuilder hintSB) {
        ...
        try {
            String strOptString = view.optString(ViewHierarchyConstants.TEXT_KEY, "");
            ...
            if (lowerCase.length() > 0) {
                ...
                textSB.append(ZegoConstants.ZegoVideoDataAuxPublishingStream);
            }
            ...
            if (z) {
                ...
                hintSB.append(ZegoConstants.ZegoVideoDataAuxPublishingStream);
            }
            JSONArray jSONArrayOptJSONArray = view.optJSONArray(ViewHierarchyConstants.CHILDREN_VIEW_KEY);
