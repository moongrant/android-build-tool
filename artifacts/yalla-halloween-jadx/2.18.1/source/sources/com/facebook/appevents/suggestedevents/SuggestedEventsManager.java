...
public final class SuggestedEventsManager {
    ...
    public static final synchronized void enable() {
        ...
        try {
            ...
            FacebookSdk.getExecutor().execute(new Runnable() { // from class: o0oO0Ooo.oO0OO00o
                @Override // java.lang.Runnable
                public final void run() {
                    SuggestedEventsManager.m157enable$lambda0();
                }
            });
        } catch (Throwable th) {
    ...
    public static final void m157enable$lambda0() {
        if (CrashShieldHandler.isObjectCrashing(SuggestedEventsManager.class)) {
            return;
        }
        try {
