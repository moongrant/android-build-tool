...
public final class ViewOnClickListener implements View.OnClickListener {
    ...
    public static final class Companion {
        ...
        public final boolean queryHistoryAndProcess(String pathID, final String buttonText) {
            ...
            Utility.runOnNonUiThread(new Runnable() { // from class: o000o00o.o00000OO

                /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
                public final /* synthetic */ int f29151Oooo0o = 1;

                @Override // java.lang.Runnable
                public final void run() {
                    switch (this.f29151Oooo0o) {
                        case 0:
                            RoomDatabase.OooO0o oooO0o = ((OooO0O0) buttonText).f9287Oooo0o;
                            Collections.emptyList();
                            oooO0o.OooO00o();
                            break;
                        default:
                            ViewOnClickListener.Companion.m160queryHistoryAndProcess$lambda0(strQueryEvent, (String) buttonText);
                            break;
                    }
                }
            });
        ...
        public static final void m160queryHistoryAndProcess$lambda0(String queriedEvent, String buttonText) {
    ...
    private ViewOnClickListener(View view, View view2, String str) {
        ...
        this.activityName = StringsKt.OooOo00(lowerCase, "activity", "");
    }
    ...
    private final void predictAndProcess(final String pathID, final String buttonText, final JSONObject viewData) {
        ...
        try {
            Utility utility = Utility.INSTANCE;
            Utility.runOnNonUiThread(new Runnable() { // from class: o0oO0Ooo.oOo000Oo
                @Override // java.lang.Runnable
                public final void run() {
                    ViewOnClickListener.m159predictAndProcess$lambda0(viewData, buttonText, this, pathID);
                }
            });
        } catch (Throwable th) {
    ...
    public static final void m159predictAndProcess$lambda0(JSONObject viewData, String buttonText, ViewOnClickListener this$0, String pathID) {
        if (CrashShieldHandler.isObjectCrashing(ViewOnClickListener.class)) {
            return;
        }
        try {
