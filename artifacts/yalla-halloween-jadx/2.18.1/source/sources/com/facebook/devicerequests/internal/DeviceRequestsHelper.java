...
public final class DeviceRequestsHelper {
    ...
    public static final Bitmap generateQRCode(@Nullable String url) {
        ...
        try {
            o00000OO o00000ooOooO00o = new o0oOOo().OooO00o(url, BarcodeFormat.QR_CODE, enumMap);
            int i = o00000ooOooO00o.f38920Oooo0oO;
            int i2 = o00000ooOooO00o.f38919Oooo0o;
            ...
            if (i > 0) {
                ...
                while (true) {
                    ...
                    if (i2 > 0) {
                        ...
                        while (true) {
                            int i7 = i6 + 1;
                            iArr[i5 + i6] = o00000ooOooO00o.OooO0OO(i6, i3) ? -16777216 : -1;
                            if (i7 >= i2) {
                                break;
                            }
                            i6 = i7;
