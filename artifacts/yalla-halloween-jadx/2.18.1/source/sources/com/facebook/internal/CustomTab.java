...
public class CustomTab {
    ...
    public final boolean openCustomTab(@NotNull Activity activity, @Nullable String packageName) {
        ...
        p019OooOoo0.oo000o preparedSessionOnce = CustomTabPrefetchHelper.INSTANCE.getPreparedSessionOnce();
        Intent intent = new Intent("android.intent.action.VIEW");
        if (preparedSessionOnce != null) {
            intent.setPackage(preparedSessionOnce.f379OooO0OO.getPackageName());
        }
        Bundle bundle = new Bundle();
        o0OO00O.OooO0O0(bundle, "android.support.customtabs.extra.SESSION", preparedSessionOnce == null ? null : preparedSessionOnce.f378OooO0O0.asBinder());
        ...
        try {
            ...
            o000O000.OooO00o.C0293OooO00o.OooO0O0(activity, intent, null);
            return true;
