...
public final class ImageDownloader {
    ...
    private final void issueResponse(RequestKey key, final Exception error, final Bitmap bitmap, final boolean isCachedRedirect) {
        ...
        handler2.post(new Runnable() { // from class: com.facebook.internal.OooOo
            ...
            public final void run() {
                ImageDownloader.m188issueResponse$lambda4(request, error, isCachedRedirect, bitmap, callback);
            }
        });
    }
    ...
    public static final void m188issueResponse$lambda4(ImageRequest request, Exception exc, boolean z, Bitmap bitmap, ImageRequest.Callback callback) {
        Intrinsics.checkNotNullParameter(request, "$request");
