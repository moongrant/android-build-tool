...
public final class ImageResponseCache {
    ...
    private final boolean isCDNURL(Uri uri) {
        ...
        return Intrinsics.areEqual(host, "fbcdn.net") || StringsKt__StringsJVMKt.endsWith$default(host, ".fbcdn.net", false, 2, null) || (StringsKt.OooOoOO(host, "fbcdn") && StringsKt__StringsJVMKt.endsWith$default(host, ".akamaihd.net", false, 2, null));
    }
