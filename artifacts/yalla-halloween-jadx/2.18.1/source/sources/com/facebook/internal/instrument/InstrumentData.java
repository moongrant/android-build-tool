...
public final class InstrumentData {
    ...
    public static final class Companion {
        ...
        public final Type getType(String filename) {
            if (StringsKt.OooOoOO(filename, InstrumentUtility.CRASH_REPORT_PREFIX)) {
                return Type.CrashReport;
            }
            if (StringsKt.OooOoOO(filename, InstrumentUtility.CRASH_SHIELD_PREFIX)) {
                return Type.CrashShield;
            }
            if (StringsKt.OooOoOO(filename, InstrumentUtility.THREAD_CHECK_PREFIX)) {
                return Type.ThreadCheck;
            }
            if (StringsKt.OooOoOO(filename, InstrumentUtility.ANALYSIS_REPORT_PREFIX)) {
                return Type.Analysis;
            }
            return StringsKt.OooOoOO(filename, InstrumentUtility.ANR_REPORT_PREFIX) ? Type.AnrReport : Type.Unknown;
        }
    }
