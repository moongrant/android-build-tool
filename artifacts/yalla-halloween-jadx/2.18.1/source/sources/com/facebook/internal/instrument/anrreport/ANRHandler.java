...
public final class ANRHandler {
    ...
    public static final void sendANRReports() {
        ...
        try {
            ...
            final List listSortedWith = CollectionsKt.sortedWith(arrayList2, new Comparator() { // from class: o0O00Ooo.OooOo
                @Override // java.util.Comparator
                public final int compare(Object obj2, Object obj3) {
                    return ANRHandler.m209sendANRReports$lambda2((InstrumentData) obj2, (InstrumentData) obj3);
                }
            });
            ...
            InstrumentUtility.sendReports("anr_reports", jSONArray, new GraphRequest.Callback() { // from class: o0O00Ooo.OooOo00
                @Override // com.facebook.GraphRequest.Callback
                public final void onCompleted(GraphResponse graphResponse) {
                    ANRHandler.m210sendANRReports$lambda5(listSortedWith, graphResponse);
                }
            });
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, ANRHandler.class);
    ...
    public static final int m209sendANRReports$lambda2(InstrumentData instrumentData, InstrumentData o2) {
        if (CrashShieldHandler.isObjectCrashing(ANRHandler.class)) {
            return 0;
        }
        try {
    ...
    public static final void m210sendANRReports$lambda5(List validReports, GraphResponse response) {
        if (CrashShieldHandler.isObjectCrashing(ANRHandler.class)) {
            return;
        }
        try {
