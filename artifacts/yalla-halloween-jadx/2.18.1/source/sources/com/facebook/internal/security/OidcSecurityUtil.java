...
public final class OidcSecurityUtil {
    ...
    public static final PublicKey getPublicKeyFromString(@NotNull String key) {
        ...
        byte[] bArrDecode = Base64.decode(StringsKt.OooOo00(StringsKt.OooOo00(StringsKt.OooOo00(key, "\n", ""), "-----BEGIN PUBLIC KEY-----", ""), "-----END PUBLIC KEY-----", ""), 0);
    ...
    public static final String getRawKeyFromEndPoint(@NotNull final String kid) {
        ...
        FacebookSdk.getExecutor().execute(new Runnable() { // from class: o0O00o0o.OooOOO0
            @Override // java.lang.Runnable
            public final void run() throws IOException {
                OidcSecurityUtil.m216getRawKeyFromEndPoint$lambda1(url, objectRef, kid, reentrantLock, conditionNewCondition);
            }
        });
        reentrantLock.lock();
        try {
    ...
    public static final void m216getRawKeyFromEndPoint$lambda1(URL openIdKeyUrl, Ref.ObjectRef result, String kid, ReentrantLock lock, Condition condition) throws IOException {
