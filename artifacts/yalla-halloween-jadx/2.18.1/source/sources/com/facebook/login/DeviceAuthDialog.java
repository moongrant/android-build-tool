...
public class DeviceAuthDialog extends androidx.fragment.app.OooOo00 {
    ...
    public static final void m218_get_pollRequest_$lambda5(DeviceAuthDialog this$0, GraphResponse response) {
    ...
    private final GraphRequest getPollRequest() {
        ...
        return GraphRequest.INSTANCE.newPostRequestWithBundle(null, DEVICE_LOGIN_STATUS_ENDPOINT, bundle, new GraphRequest.Callback() { // from class: com.facebook.login.OooO
            ...
            public final void onCompleted(GraphResponse graphResponse) {
                DeviceAuthDialog.m218_get_pollRequest_$lambda5(this.f12852OooO00o, graphResponse);
            }
        });
    }
    ...
    public static final void m219initializeContentView$lambda2(DeviceAuthDialog this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.onCancel();
    }
    ...
    private final void onSuccess(final String accessToken, long expiresIn, Long dataAccessExpirationTime) {
        ...
        FacebookSdk facebookSdk = FacebookSdk.INSTANCE;
        GraphRequest graphRequestNewGraphPathRequest = GraphRequest.INSTANCE.newGraphPathRequest(new AccessToken(accessToken, FacebookSdk.getApplicationId(), AppEventsConstants.EVENT_PARAM_VALUE_NO, null, null, null, null, date, null, date2, null, 1024, null), "me", new GraphRequest.Callback() { // from class: com.facebook.login.OooOO0
            @Override // com.facebook.GraphRequest.Callback
            public final void onCompleted(GraphResponse graphResponse) {
                DeviceAuthDialog.m220onSuccess$lambda10(this.f12865OooO00o, accessToken, date, date2, graphResponse);
            }
        });
    ...
    public static final void m220onSuccess$lambda10(DeviceAuthDialog this$0, String accessToken, Date date, Date date2, GraphResponse response) {
    ...
    private final void presentConfirmation(final String userId, final PermissionsLists permissions, final String accessToken, String name, final Date expirationTime, final Date dataAccessExpirationTime) {
        ...
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
        String strOooO00o = OooO00o.OooO0OO.OooO00o(new Object[]{name}, 1, string2, "java.lang.String.format(format, *args)");
        ...
        builder.setMessage(string).setCancelable(true).setNegativeButton(strOooO00o, new DialogInterface.OnClickListener() { // from class: com.facebook.login.OooO0OO
            ...
            public final void onClick(DialogInterface dialogInterface, int i) {
                DeviceAuthDialog.m221presentConfirmation$lambda6(this.f12859Oooo0o, userId, permissions, accessToken, expirationTime, dataAccessExpirationTime, dialogInterface, i);
            }
        }).setPositiveButton(string3, new DialogInterface.OnClickListener() { // from class: com.facebook.login.OooO0O0
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                DeviceAuthDialog.m222presentConfirmation$lambda8(this.f12857Oooo0o, dialogInterface, i);
            }
        });
        builder.create().show();
    }
    ...
    public static final void m221presentConfirmation$lambda6(DeviceAuthDialog this$0, String userId, PermissionsLists permissions, String accessToken, Date date, Date date2, DialogInterface dialogInterface, int i) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public static final void m222presentConfirmation$lambda8(DeviceAuthDialog this$0, DialogInterface dialogInterface, int i) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    private final void schedulePoll() {
        ...
        if (lValueOf != null) {
            this.scheduledPoll = DeviceAuthMethodHandler.INSTANCE.getBackgroundExecutor().schedule(new OooOO0.OooO(this, 1), lValueOf.longValue(), TimeUnit.SECONDS);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: schedulePoll$lambda-3, reason: not valid java name */
    public static final void m223schedulePoll$lambda3(DeviceAuthDialog this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.poll();
    }
    ...
    public static final void m224startLogin$lambda1(DeviceAuthDialog this$0, GraphResponse response) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(response, "response");
        ...
        try {
            ...
            requestState.setInterval(graphObject.getLong(ak.aT));
    ...
    public View initializeContentView(boolean isSmartLogin) {
        ...
        ((Button) viewFindViewById3).setOnClickListener(new o00OO0O.OooO0o(this, 2));
    ...
    public void startLogin(@NotNull LoginClient.Request request) {
        ...
        GraphRequest.INSTANCE.newPostRequestWithBundle(null, DEVICE_LOGIN_ENDPOINT, bundle, new GraphRequest.Callback() { // from class: com.facebook.login.OooO0o
            @Override // com.facebook.GraphRequest.Callback
            public final void onCompleted(GraphResponse graphResponse) {
                DeviceAuthDialog.m224startLogin$lambda1(this.f12864OooO00o, graphResponse);
            }
        }).executeAsync();
    }
}
