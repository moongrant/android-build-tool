...
public final class GetTokenLoginMethodHandler extends LoginMethodHandler {
    ...
    public static final void m225tryAuthorize$lambda1(GetTokenLoginMethodHandler this$0, LoginClient.Request request, Bundle bundle) {
    ...
    public int tryAuthorize(@NotNull LoginClient.Request request) {
        ...
        getLoginClient().notifyBackgroundProcessingStart();
        OooOO0O oooOO0O = new OooOO0O(this, request);
        GetTokenClient getTokenClient2 = this.getTokenClient;
        if (getTokenClient2 == null) {
            return 1;
        }
        getTokenClient2.setCompletedListener(oooOO0O);
        return 1;
    }
