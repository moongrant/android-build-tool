...
public class VideoDecoderOutputBuffer extends o000OOo {
    ...
    public int height;
    public int mode;
    private final o000OOo.OooO00o<VideoDecoderOutputBuffer> owner;
    ...
    public VideoDecoderOutputBuffer(o000OOo.OooO00o<VideoDecoderOutputBuffer> oooO00o) {
        this.owner = oooO00o;
    }
    ...
    public void init(long j, int i, @Nullable ByteBuffer byteBuffer) {
        ...
        addFlag(SQLiteDatabase.CREATE_IF_NECESSARY);
