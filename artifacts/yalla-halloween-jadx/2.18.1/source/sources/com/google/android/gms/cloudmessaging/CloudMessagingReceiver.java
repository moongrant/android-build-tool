...
public abstract class CloudMessagingReceiver extends BroadcastReceiver {
    ...
    public final ExecutorService f15072OooO00o;
    ...
    public CloudMessagingReceiver() {
        ...
        this.f15072OooO00o = Executors.unconfigurableExecutorService(threadPoolExecutor);
    }
    ...
    public final void onReceive(@NonNull final Context context, @NonNull final Intent intent) {
        ...
        this.f15072OooO00o.execute(new Runnable() { // from class: com.google.android.gms.cloudmessaging.zze
