...
public final class DataBufferObserverSet implements DataBufferObserver, DataBufferObserver.Observable {
    ...
    public HashSet<DataBufferObserver> f15457OooO00o = new HashSet<>();

    @Override // com.google.android.gms.common.data.DataBufferObserver.Observable
    public void addObserver(@NonNull DataBufferObserver dataBufferObserver) {
        this.f15457OooO00o.add(dataBufferObserver);
    }
    ...
    public boolean hasObservers() {
        return !this.f15457OooO00o.isEmpty();
    }

    @Override // com.google.android.gms.common.data.DataBufferObserver
    public void onDataChanged() {
        Iterator<DataBufferObserver> it = this.f15457OooO00o.iterator();
        while (it.hasNext()) {
    ...
    public void removeObserver(@NonNull DataBufferObserver dataBufferObserver) {
        this.f15457OooO00o.remove(dataBufferObserver);
    }
}
