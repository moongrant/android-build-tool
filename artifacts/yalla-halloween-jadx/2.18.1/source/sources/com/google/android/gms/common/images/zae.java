...
public final class zae extends zag {
    ...
    public final WeakReference<ImageView> f15508OooO0OO;

    public zae(ImageView imageView, int i) {
        super(Uri.EMPTY, i);
        Asserts.checkNotNull(imageView);
        this.f15508OooO0OO = new WeakReference<>(imageView);
    }

    @Override // com.google.android.gms.common.images.zag
    public final void OooO00o(@Nullable Drawable drawable, boolean z, boolean z2, boolean z3) {
        ImageView imageView = this.f15508OooO0OO.get();
        if (imageView != null) {
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        ImageView imageView = this.f15508OooO0OO.get();
        ImageView imageView2 = ((zae) obj).f15508OooO0OO.get();
