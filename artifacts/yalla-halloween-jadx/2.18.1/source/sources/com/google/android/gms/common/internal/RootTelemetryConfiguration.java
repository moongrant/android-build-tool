...
public class RootTelemetryConfiguration extends AbstractSafeParcelable {
    ...
    public final int f15615Oooo;

    /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
    @SafeParcelable.Field(getter = "getVersion", id = 1)
    public final int f15616Oooo0o;

    /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
    @SafeParcelable.Field(getter = "getMethodInvocationTelemetryEnabled", id = 2)
    public final boolean f15617Oooo0oO;

    /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
    @SafeParcelable.Field(getter = "getMethodTimingTelemetryEnabled", id = 3)
    public final boolean f15618Oooo0oo;

    /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
    @SafeParcelable.Field(getter = "getMaxMethodInvocationsInBatch", id = 5)
    public final int f15619OoooO00;
    ...
    public RootTelemetryConfiguration(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) boolean z, @SafeParcelable.Param(id = 3) boolean z2, @SafeParcelable.Param(id = 4) int i2, @SafeParcelable.Param(id = 5) int i3) {
        this.f15616Oooo0o = i;
        this.f15617Oooo0oO = z;
        this.f15618Oooo0oo = z2;
        this.f15615Oooo = i2;
        this.f15619OoooO00 = i3;
    }

    @KeepForSdk
    public int getBatchPeriodMillis() {
        return this.f15615Oooo;
    }

    @KeepForSdk
    public int getMaxMethodInvocationsInBatch() {
        return this.f15619OoooO00;
    }

    @KeepForSdk
    public boolean getMethodInvocationTelemetryEnabled() {
        return this.f15617Oooo0oO;
    }

    @KeepForSdk
    public boolean getMethodTimingTelemetryEnabled() {
        return this.f15618Oooo0oo;
    }

    @KeepForSdk
    public int getVersion() {
        return this.f15616Oooo0o;
    }
