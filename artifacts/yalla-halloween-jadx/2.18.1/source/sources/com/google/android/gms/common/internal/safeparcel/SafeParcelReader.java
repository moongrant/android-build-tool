...
public class SafeParcelReader {
    ...
    public static void OooO00o(Parcel parcel, int i, int i2) {
        ...
        throw new ParseException(OooO.OooO00o(o000O0Oo.OooO0O0("Expected size ", i2, " got ", i, " (0x"), Integer.toHexString(i), ")"), parcel);
    }

    public static void OooO0O0(Parcel parcel, int i, int i2) {
        int size = readSize(parcel, i);
        if (size == i2) {
            return;
        }
        throw new ParseException(OooO.OooO00o(o000O0Oo.OooO0O0("Expected size ", i2, " got ", size, " (0x"), Integer.toHexString(size), ")"), parcel);
    }
    ...
    public static void ensureAtEnd(@NonNull Parcel parcel, int i) {
        if (parcel.dataPosition() != i) {
            throw new ParseException(OooO00o.OooO00o("Overread allowed size end=", i), parcel);
        }
    }
    ...
    public static int readSize(@NonNull Parcel parcel, int i) {
        return (i & bl.a) != -65536 ? (char) (i >> 16) : parcel.readInt();
    }
    ...
    public static int validateObjectHeader(@NonNull Parcel parcel) {
        ...
        if (i < iDataPosition || i > parcel.dataSize()) {
            throw new ParseException(o00O00OO.OooO00o("Size read is invalid start=", iDataPosition, " end=", i), parcel);
        }
        return i;
    }
}
