...
public final class zao extends GoogleApi<TelemetryLoggingOptions> implements TelemetryLoggingClient {
    ...
    public static final Api.AbstractClientBuilder<zap, TelemetryLoggingOptions> f15627OooOO0O;

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    public static final Api<TelemetryLoggingOptions> f15628OooOO0o;
    public static final /* synthetic */ int zab = 0;

    static {
        Api.ClientKey clientKey = new Api.ClientKey();
        OooOO0 oooOO1 = new OooOO0();
        f15627OooOO0O = oooOO1;
        f15628OooOO0o = new Api<>("ClientTelemetry.API", oooOO1, clientKey);
    }

    public zao(Context context, TelemetryLoggingOptions telemetryLoggingOptions) {
        super(context, f15628OooOO0o, telemetryLoggingOptions, GoogleApi.Settings.DEFAULT_SETTINGS);
    }
