...
public final class CollectionUtils {
    public static Map OooO00o(int i) {
        return i <= 256 ? new Oooo0(i) : new HashMap(i, 1.0f);
    }

    public static Set OooO0O0(int i, boolean z) {
        return i <= (true != z ? 256 : 128) ? new o0OoOo0(i) : new HashSet(i, true != z ? 1.0f : 0.75f);
    }
    ...
    public static <K, V> Map<K, V> mapOfKeyValueArrays(@NonNull K[] kArr, @NonNull V[] vArr) {
        ...
        if (length != length2) {
            throw new IllegalArgumentException(o00O00OO.OooO00o("Key and values array lengths not equal: ", length, " != ", length2));
        }
        if (length == 0) {
    ...
    public static <T> Set<T> mutableSetOfWithSize(int i) {
        return i == 0 ? new o0OoOo0(0) : OooO0O0(i, true);
    }
