...
public final class zzel extends zzke implements zzlm {
    ...
    static {
        ...
        zza = zzelVar;
        zzke.OooO0oO(zzel.class, zzelVar);
    }

    public static /* synthetic */ void OooOO0o(zzel zzelVar, String str) {
        zzelVar.zze |= 8;
        zzelVar.zzi = str;
    }
    ...
    public final Object OooOO0(int i) {
        ...
        if (i2 == 2) {
            return new o0O0OOO0(zza, "\u0001\u0004\u0000\u0001\u0001\u0004\u0004\u0000\u0000\u0000\u0001ဉ\u0000\u0002ဉ\u0001\u0003ဇ\u0002\u0004ဈ\u0003", new Object[]{"zze", "zzf", "zzg", "zzh", "zzi"});
        }
        if (i2 == 3) {
            return new zzel();
        }
