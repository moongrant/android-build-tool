...
public final class zzkp {
    ...
    static {
        ...
        zzc = zzkpVar3;
        zzkp zzkpVar4 = new zzkp("FLOAT", 3, Float.TYPE, Float.class, Float.valueOf(ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE));
        zzd = zzkpVar4;
    ...
    public zzkp(String str, int i, Class cls, Class cls2, Object obj) {
        super(str, i);
        this.zzl = cls;
        this.zzm = cls2;
        this.zzn = obj;
