...
public class CircularRevealLinearLayout extends LinearLayout implements OooO0O0 {
    ...
    @NonNull
    public final CircularRevealHelper f16856Oooo0o;
    ...
    public final void OooO00o() {
        Objects.requireNonNull(this.f16856Oooo0o);
    }
    ...
    public final void draw(@NonNull Canvas canvas) {
        CircularRevealHelper circularRevealHelper = this.f16856Oooo0o;
    ...
    public Drawable getCircularRevealOverlayDrawable() {
        return this.f16856Oooo0o.f16855OooO0o0;
    }

    @Override // com.google.android.material.circularreveal.OooO0O0
    public int getCircularRevealScrimColor() {
        return this.f16856Oooo0o.OooO0O0();
    }

    @Override // com.google.android.material.circularreveal.OooO0O0
    @Nullable
    public OooO0O0.OooO0o getRevealInfo() {
        return this.f16856Oooo0o.OooO0Oo();
    }
    ...
    public void setCircularRevealOverlayDrawable(@Nullable Drawable drawable) {
        this.f16856Oooo0o.OooO0o(drawable);
    }

    @Override // com.google.android.material.circularreveal.OooO0O0
    public void setCircularRevealScrimColor(@ColorInt int i) {
        this.f16856Oooo0o.OooO0oO(i);
    }

    @Override // com.google.android.material.circularreveal.OooO0O0
    public void setRevealInfo(@Nullable OooO0O0.OooO0o oooO0o) {
        this.f16856Oooo0o.OooO0oo(oooO0o);
    }

    public CircularRevealLinearLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.f16856Oooo0o = new CircularRevealHelper(this);
    }
}
