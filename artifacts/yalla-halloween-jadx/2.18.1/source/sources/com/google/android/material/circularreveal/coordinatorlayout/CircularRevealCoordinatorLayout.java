...
public class CircularRevealCoordinatorLayout extends CoordinatorLayout implements OooO0O0 {
    ...
    @NonNull
    public final CircularRevealHelper f16866o0OoOo0;
    ...
    public final void OooO00o() {
        Objects.requireNonNull(this.f16866o0OoOo0);
    }
    ...
    public final void draw(Canvas canvas) {
        CircularRevealHelper circularRevealHelper = this.f16866o0OoOo0;
    ...
    public Drawable getCircularRevealOverlayDrawable() {
        return this.f16866o0OoOo0.f16855OooO0o0;
    }

    @Override // com.google.android.material.circularreveal.OooO0O0
    public int getCircularRevealScrimColor() {
        return this.f16866o0OoOo0.OooO0O0();
    }

    @Override // com.google.android.material.circularreveal.OooO0O0
    @Nullable
    public OooO0O0.OooO0o getRevealInfo() {
        return this.f16866o0OoOo0.OooO0Oo();
    }
    ...
    public void setCircularRevealOverlayDrawable(@Nullable Drawable drawable) {
        this.f16866o0OoOo0.OooO0o(drawable);
    }

    @Override // com.google.android.material.circularreveal.OooO0O0
    public void setCircularRevealScrimColor(@ColorInt int i) {
        this.f16866o0OoOo0.OooO0oO(i);
    }

    @Override // com.google.android.material.circularreveal.OooO0O0
    public void setRevealInfo(@Nullable OooO0O0.OooO0o oooO0o) {
        this.f16866o0OoOo0.OooO0oo(oooO0o);
    }

    public CircularRevealCoordinatorLayout(@NonNull Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.f16866o0OoOo0 = new CircularRevealHelper(this);
    }
}
