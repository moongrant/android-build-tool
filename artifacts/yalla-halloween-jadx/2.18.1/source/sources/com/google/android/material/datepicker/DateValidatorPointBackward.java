...
public class DateValidatorPointBackward implements CalendarConstraints.DateValidator {
    ...
    public final long f16883Oooo0o;
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof DateValidatorPointBackward) && this.f16883Oooo0o == ((DateValidatorPointBackward) obj).f16883Oooo0o;
    }

    public final int hashCode() {
        return Arrays.hashCode(new Object[]{Long.valueOf(this.f16883Oooo0o)});
    }

    @Override // com.google.android.material.datepicker.CalendarConstraints.DateValidator
    public final boolean oo000o(long j) {
        return j <= this.f16883Oooo0o;
    }

    @Override // android.os.Parcelable
    public final void writeToParcel(@NonNull Parcel parcel, int i) {
        parcel.writeLong(this.f16883Oooo0o);
    }
}
