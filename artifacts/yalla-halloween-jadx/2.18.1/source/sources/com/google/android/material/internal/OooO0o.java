...
public final class OooO0o {
    ...
    public static final ThreadLocal<Matrix> f17278OooO00o = new ThreadLocal<>();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final ThreadLocal<RectF> f17279OooO0O0 = new ThreadLocal<>();
    ...
    public static void OooO0OO(@NonNull ViewGroup viewGroup, @NonNull View view, @NonNull Rect rect) {
        ThreadLocal<Matrix> threadLocal = f17278OooO00o;
        ...
        ThreadLocal<RectF> threadLocal2 = f17279OooO0O0;
