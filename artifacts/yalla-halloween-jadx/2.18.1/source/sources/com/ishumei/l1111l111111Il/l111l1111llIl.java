...
public class l111l1111llIl implements l1111l111111Il.InterfaceC0160l1111l111111Il, l1111l111111Il.l111l11111lIl {
    ...
    public static class l1111l111111Il {
        ...
        public com.ishumei.l111l1111l1Il.l111l11111I1l.l1111l111111Il<?> l111l11111I1l;
        ...
        private InterfaceC0160l1111l111111Il l11l1111lIIl;
        ...
        public interface InterfaceC0160l1111l111111Il {
            String l111l11111Il();
        }
        ...
        public l1111l111111Il(InterfaceC0160l1111l111111Il interfaceC0160l1111l111111Il, l111l11111lIl l111l11111lil, boolean z, int i, com.ishumei.l111l1111l1Il.l111l11111I1l.l1111l111111Il<?> l1111l111111il, String str) {
            this.l111l1111lI1l = null;
            this.l111l1111lIl = null;
            this.l11l1111lIIl = interfaceC0160l1111l111111Il;
    ...
    public static String l1111l111111Il(String str, String str2, boolean z) {
        ...
        return OooO.OooO00o(new StringBuilder(z ? "https://" : "http://"), str.equals(str2) ? "fp-it.fengkongcloud.com" : str, str2);
    }

    private static void l111l11111lIl(JSONObject jSONObject) {
        int iOptInt = jSONObject.optInt(ak.aF, -1);
        int iOptInt2 = jSONObject.optInt(ak.aH, -1);
    ...
    public final boolean l1111l111111Il(JSONObject jSONObject) {
        ...
        try {
            ...
            int iOptInt = jSONObject2.optInt(ak.aF, -1);
            int iOptInt2 = jSONObject2.optInt(ak.aH, -1);
            if (iOptInt >= 0 && iOptInt2 >= 0) {
                com.ishumei.l111l11111lIl.l111l11111lIl.l1111l111111Il.l1111l111111Il().l1111l111111Il(iOptInt2, iOptInt);
            }
    ...
    @Override // com.ishumei.l1111l111111Il.l111l1111llIl.l1111l111111Il.InterfaceC0160l1111l111111Il
