...
public final class Headers {
    ...
    public static final class Builder {
        ...
        private void checkNameAndValue(String str, String str2) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (cCharAt <= ' ' || cCharAt >= 127) {
                    throw new IllegalArgumentException(o00OOO00.OooOO0("Unexpected char %#04x at %d in header name: %s", Integer.valueOf(cCharAt), Integer.valueOf(i), str));
                }
            }
            if (str2 == null) {
                throw new NullPointerException(OooO0OO.OooO00o("value for name ", str, " == null"));
            }
            int length2 = str2.length();
            for (int i2 = 0; i2 < length2; i2++) {
                char cCharAt2 = str2.charAt(i2);
                if ((cCharAt2 <= 31 && cCharAt2 != '\t') || cCharAt2 >= 127) {
                    throw new IllegalArgumentException(o00OOO00.OooOO0("Unexpected char %#04x at %d in %s value: %s", Integer.valueOf(cCharAt2), Integer.valueOf(i2), str, str2));
                }
            }
        }
        ...
        public Builder add(String str) {
            ...
            throw new IllegalArgumentException(OooOo00.OooO0Oo("Unexpected header: ", str));
        }
