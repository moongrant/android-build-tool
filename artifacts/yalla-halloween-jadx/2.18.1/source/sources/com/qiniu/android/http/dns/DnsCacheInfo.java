...
public class DnsCacheInfo implements Serializable {
    ...
    public byte[] toJsonData() {
        ...
        try {
            jSONObject.putOpt("localIp", this.currentTime);
            ...
            if (list != null) {
                for (IDnsNetworkAddress iDnsNetworkAddress : list) {
                    if (iDnsNetworkAddress instanceof DnsNetworkAddress) {
                        try {
                            jSONObject2.put(str, ((DnsNetworkAddress) iDnsNetworkAddress).toJson());
    ...
    public String toString() {
        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("{\"currentTime\":\"");
        sbOooO0o0.append(this.currentTime);
        sbOooO0o0.append("\", \"localIp\":\"");
        return OooO.OooO00o(sbOooO0o0, this.localIp, "\"}");
    }
