...
public class RequestTransaction {
    ...
    public void completeParts(boolean z, String str, String str2, List<Map<String, Object>> list, final RequestCompleteHandler requestCompleteHandler) {
        ...
        String str5 = "/buckets/" + this.token.bucket;
        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("/objects/");
        sbOooO0o0.append(resumeV2EncodeKey(this.key));
        String strOooO00o = OooO0OO.OooO00o(str5, sbOooO0o0.toString(), OooOo00.OooO0Oo("/uploads/", str2));
        ...
        this.regionRequest.post(strOooO00o, z, new JSONObject(map2).toString().getBytes(), map, new RequestShouldRetryHandler() { // from class: com.qiniu.android.http.request.RequestTransaction.15
    ...
    public void initPart(boolean z, final RequestCompleteHandler requestCompleteHandler) {
        ...
        map.put("Content-Type", "application/octet-stream");
        map.put("User-Agent", this.userAgent);
        String str3 = "/buckets/" + this.token.bucket;
        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("/objects/");
        sbOooO0o0.append(resumeV2EncodeKey(this.key));
        this.regionRequest.post(OooO0OO.OooO00o(str3, sbOooO0o0.toString(), "/uploads"), z, null, map, new RequestShouldRetryHandler() { // from class: com.qiniu.android.http.request.RequestTransaction.11
            @Override // com.qiniu.android.http.request.handler.RequestShouldRetryHandler
            public boolean shouldRetry(ResponseInfo responseInfo, JSONObject jSONObject) {
                return !responseInfo.isOK();
            }
    ...
    public void makeBlock(long j, long j2, byte[] bArr, boolean z, RequestProgressHandler requestProgressHandler, final RequestCompleteHandler requestCompleteHandler) {
        ...
        sbOooO0o0.append(Crc32.bytes(bArr));
        final String string = sbOooO0o0.toString();
    ...
    public void makeFile(long j, String str, String[] strArr, boolean z, final RequestCompleteHandler requestCompleteHandler) {
        ...
        map.put("Content-Type", "application/octet-stream");
        map.put("User-Agent", this.userAgent);
        String strOooO0Oo = "/mkfile/" + j + String.format("/mimeType/%s", UrlSafeBase64.encodeToString(this.uploadOption.mimeType));
        String str4 = this.key;
        if (str4 != null) {
            strOooO0Oo = OooOo00.OooO0Oo(strOooO0Oo, String.format("/key/%s", UrlSafeBase64.encodeToString(str4)));
        }
        ...
        if (map2 != null) {
            for (String str5 : map2.keySet()) {
                ...
                if (str6 != null) {
                    StringBuilder sbOooO0OO = OooO0o.OooO0OO("/", str5, "/");
                    sbOooO0OO.append(UrlSafeBase64.encodeToString(str6));
                    strOooO0Oo = OooOo00.OooO0Oo(strOooO0Oo, sbOooO0OO.toString());
                }
            }
        }
        ...
        if (map3 != null) {
            for (String str7 : map3.keySet()) {
                ...
                if (str8 != null) {
                    StringBuilder sbOooO0OO2 = OooO0o.OooO0OO("/", str7, "/");
                    sbOooO0OO2.append(UrlSafeBase64.encodeToString(str8));
                    strOooO0Oo = OooOo00.OooO0Oo(strOooO0Oo, sbOooO0OO2.toString());
                }
            }
        }
        this.regionRequest.post(OooOo00.OooO0Oo(strOooO0Oo, String.format("/fname/%s", UrlSafeBase64.encodeToString(str))), z, StringUtils.join(strArr, ",").getBytes(), map, new RequestShouldRetryHandler() { // from class: com.qiniu.android.http.request.RequestTransaction.9
            @Override // com.qiniu.android.http.request.handler.RequestShouldRetryHandler
            public boolean shouldRetry(ResponseInfo responseInfo, JSONObject jSONObject) {
                return !responseInfo.isOK();
            }
    ...
    public void uploadFormData(byte[] bArr, String str, boolean z, RequestProgressHandler requestProgressHandler, final RequestCompleteHandler requestCompleteHandler) {
        this.requestInfo.requestType = UploadRequestInfo.RequestTypeForm;
        HashMap map = new HashMap();
        Map<String, String> map2 = this.uploadOption.params;
        if (map2 != null) {
            map.putAll(map2);
        ...
        map.put(FirebaseMessagingService.EXTRA_TOKEN, str3);
    ...
    public void uploadPart(boolean z, String str, int i, byte[] bArr, RequestProgressHandler requestProgressHandler, final RequestCompleteHandler requestCompleteHandler) {
        ...
        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("/buckets/");
        sbOooO0o0.append(this.token.bucket);
        String string = sbOooO0o0.toString();
        StringBuilder sbOooO0o1 = OooO00o.OooO0o0("/objects/");
        sbOooO0o1.append(resumeV2EncodeKey(this.key));
        this.regionRequest.put(string + sbOooO0o1.toString() + OooOo00.OooO0Oo("/uploads/", str) + android.support.v4.media.OooO00o.OooO00o("/", i), z, bArr, map, new RequestShouldRetryHandler() { // from class: com.qiniu.android.http.request.RequestTransaction.13
            @Override // com.qiniu.android.http.request.handler.RequestShouldRetryHandler
            public boolean shouldRetry(ResponseInfo responseInfo, JSONObject jSONObject) {
                String string2;
                if (jSONObject == null) {
                ...
                String string3 = null;
                try {
                    string2 = jSONObject.getString("etag");
                    try {
                        string3 = jSONObject.getString(GooglePaySignOrMd5.md5);
                    } catch (JSONException unused) {
                    }
                } catch (JSONException unused2) {
                    string2 = null;
                }
                return !responseInfo.isOK() || string2 == null || string3 == null;
            }
