...
public class UploadDomainRegion implements IUploadRegion {
    ...
    private void freezeServerIfNeed(ResponseInfo responseInfo, IUploadServer iUploadServer) {
        ...
        if (!responseInfo.canConnectToHost() || responseInfo.isHostUnavailable()) {
            this.hasFreezeHost = true;
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("partial freeze server host:");
            sbOooO0o0.append(StringUtils.toNonnullString(iUploadServer.getHost()));
            sbOooO0o0.append(" ip:");
            sbOooO0o0.append(StringUtils.toNonnullString(iUploadServer.getIp()));
        ...
        if (responseInfo.isHostUnavailable()) {
            this.hasFreezeHost = true;
            StringBuilder sbOooO0o1 = OooO00o.OooO0o0("global freeze server host:");
            sbOooO0o1.append(StringUtils.toNonnullString(iUploadServer.getHost()));
            sbOooO0o1.append(" ip:");
            sbOooO0o1.append(StringUtils.toNonnullString(iUploadServer.getIp()));
    ...
    public void setupRegionData(ZoneInfo zoneInfo) {
        ...
        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("region :");
        sbOooO0o0.append(StringUtils.toNonnullString(arrayList));
        LogUtil.i(sbOooO0o0.toString());
