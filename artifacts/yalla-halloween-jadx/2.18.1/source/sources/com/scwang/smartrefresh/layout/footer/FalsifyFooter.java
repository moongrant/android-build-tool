...
public class FalsifyFooter extends InternalAbstract implements oO000OOo {

    /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
    public oO000Oo0 f19612Oooo;
    ...
    public final void OooO00o(@NonNull oO000Oo oo000oo, int i, int i2) {
        oO000Oo0 oo000oo0 = this.f19612Oooo;
        if (oo000oo0 != null) {
            ((SmartRefreshLayout.OooOo00) oo000oo0).OooO0Oo(RefreshState.None);
            ((SmartRefreshLayout.OooOo00) this.f19612Oooo).OooO0Oo(RefreshState.LoadFinish);
        }
    }

    @Override // com.scwang.smartrefresh.layout.internal.InternalAbstract, p407o0Oo0OOo.oO0OOo0o
    public final void OooO0o(@NonNull oO000Oo0 oo000oo0, int i, int i2) {
        this.f19612Oooo = oo000oo0;
        SmartRefreshLayout.this.f19555o0ooOoO = false;
    }
