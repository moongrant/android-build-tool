...
public class TwitterAuthConfig implements Parcelable {
    ...
    public final String f19938Oooo0o;

    /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
    public final String f19939Oooo0oO;
    ...
    public TwitterAuthConfig(String str, String str2) {
        ...
        this.f19938Oooo0o = str.trim();
        this.f19939Oooo0oO = str2.trim();
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        parcel.writeString(this.f19938Oooo0o);
        parcel.writeString(this.f19939Oooo0oO);
    }

    public TwitterAuthConfig(Parcel parcel) {
        this.f19938Oooo0o = parcel.readString();
        this.f19939Oooo0oO = parcel.readString();
    }
}
