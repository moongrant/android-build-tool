...
public class CompactTweetView extends BaseTweetView {
    ...
    public final void OooO0o() {
        super.OooO0o();
        setPadding(0, getResources().getDimensionPixelSize(o000OO00.tw__compact_tweet_container_padding_top), 0, 0);
        int dimensionPixelSize = getResources().getDimensionPixelSize(o000OO00.tw__media_view_radius);
        this.f20110OoooOOO.OooO0oo(dimensionPixelSize, dimensionPixelSize, dimensionPixelSize, dimensionPixelSize);
    }

    @Override // com.twitter.sdk.android.tweetui.OooO00o
    public int getLayout() {
        return o00O0000.tw__tweet_compact;
    }
