...
public class c {
    ...
    private static byte[] a(byte[] bArr) {
        ...
        bArr2[0] = (byte) ((length >> 0) & KotlinVersion.MAX_COMPONENT_VALUE);
        bArr2[1] = (byte) ((length >> 8) & KotlinVersion.MAX_COMPONENT_VALUE);
        bArr2[2] = (byte) ((length >> 16) & KotlinVersion.MAX_COMPONENT_VALUE);
        bArr2[3] = (byte) ((length >> 24) & KotlinVersion.MAX_COMPONENT_VALUE);
        for (int i = 4; i < 16; i++) {
            bArr2[i] = 0;
        }
