...
public class d {
    ...
    public static final String f20243o = "id";
    ...
    public static final String[] aH = {as, at, "_$!du", "_$!c", Y, "_$!sp", "event_name", FirebaseMessagingService.EXTRA_TOKEN, "time", "ip", "country", "region", "city", "browser", ak.x, ak.F, "device_version", ak.ai, "screen_width", "screen_height", "referrer", "referrer_domain", "initial_referrer", "initial_referrer_domain", "initial_view_time", "search_engine", "keyword", "ali_lib", "utm_source", "utm_medium", "utm_term", "utm_content", "utm_campaign", "date", TopDataVM.TYPE_HOUR, "minute", "app_version", "sp"};
}
