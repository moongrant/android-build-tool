...
public class Envelope {
    ...
    private byte[] genGuid(byte[] bArr, int i) {
        ...
        byte[] bArr3 = {(byte) (i & KotlinVersion.MAX_COMPONENT_VALUE), (byte) ((i >> 8) & KotlinVersion.MAX_COMPONENT_VALUE), (byte) ((i >> 16) & KotlinVersion.MAX_COMPONENT_VALUE), (byte) (i >>> 24)};
    ...
    public void export(Context context) {
        ...
        String strImprintProperty = UMEnvelopeBuild.imprintProperty(context, ak.g, null);
        ...
        try {
            ...
            if (strImprintProperty != null) {
                jSONObject.put(ak.g, strImprintProperty);
            }
        ...
        try {
            ...
            if (strImprintProperty != null) {
                jSONObject2.put(ak.g, HelperUtils.getUmengMD5(strImprintProperty));
            }
