...
public final class FixRechargeOrderManager {
    ...
    public static final class C04601 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C04601(this.$model, this.this$0, continuation);
        }
                ...
                case 0:
                    ...
                    if (apiResult.isSuccess()) {
                        ...
                        if (rechargeMenuConfirmOrderResultModel != null) {
                            ...
                            value = OooOOO.f41216OooO00o.OooOo().getValue();
    ...
    public static final class C04611 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C04611(PayOrder payOrder, FixRechargeOrderManager fixRechargeOrderManager, Continuation<? super C04611> continuation) {
            super(2, continuation);
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C04611(this.$payOrder, this.this$0, continuation);
        }
    ...
    public final void confirmRechargeOrder(PayOrder model) {
        ...
        BuildersKt__Builders_commonKt.launch$default(LifecycleOwnerKt.getLifecycleScope(this.activity), Dispatchers.getIO(), null, new C04601(model, this, null), 2, null);
    }
    ...
    private final void toConsumeOrder(PayOrder payOrder) {
        ...
        if (StringsKt.isBlank(payOrder.getPurchaseToken())) {
            BuildersKt__Builders_commonKt.launch$default(LifecycleOwnerKt.getLifecycleScope(this.activity), Dispatchers.getIO(), null, new C04611(payOrder, this, null), 2, null);
        } else {
