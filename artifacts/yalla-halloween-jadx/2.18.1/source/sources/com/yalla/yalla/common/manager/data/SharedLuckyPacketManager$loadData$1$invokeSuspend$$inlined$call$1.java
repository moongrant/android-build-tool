...
public final class SharedLuckyPacketManager$loadData$1$invokeSuspend$$inlined$call$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<List<? extends GiftPropModel>>>, Object> {
    public int label;
    public final /* synthetic */ o00O000o this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SharedLuckyPacketManager$loadData$1$invokeSuspend$$inlined$call$1(o00O000o o00o000o2, Continuation continuation) {
        super(2, continuation);
        this.this$0 = o00o000o2;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new SharedLuckyPacketManager$loadData$1$invokeSuspend$$inlined$call$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super ApiResult<List<? extends GiftPropModel>>> continuation) {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        try {
            if (i == 0) {
                ...
                o00O000o o00o000o2 = this.this$0;
                ...
                p481o0o0000o.OooOo00 oooOo = (i2 == 0 || i2 != 1) ? new p481o0o0000o.OooOo(url, paramsWrapper) : new p481o0o0000o.Oooo000(url, paramsWrapper);
                this.label = 1;
            ...
            Type type = new o00000O0<ApiResult<List<? extends GiftPropModel>>>() { // from class: com.yalla.yalla.common.manager.data.SharedLuckyPacketManager$loadData$1$invokeSuspend$$inlined$call$1.1
            }.getType();
            ...
            return com.android.billingclient.api.o0Oo0oo.OooO0OO(o0oooClone.OooooO0(charset), type);
        } catch (IOException e) {
