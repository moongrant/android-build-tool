...
public final class ExploreRepository$loadEvents$$inlined$call$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<List<EventModel>>>, Object> {
    ...
    public final /* synthetic */ o00O000o f20719Oooo0oO;

    public static final class OooO00o extends o00000O0<ApiResult<List<EventModel>>> {
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ExploreRepository$loadEvents$$inlined$call$1(o00O000o o00o000o2, Continuation continuation) {
        super(2, continuation);
        this.f20719Oooo0oO = o00o000o2;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new ExploreRepository$loadEvents$$inlined$call$1(this.f20719Oooo0oO, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        try {
            if (i == 0) {
                ...
                o00O000o o00o000o2 = this.f20719Oooo0oO;
