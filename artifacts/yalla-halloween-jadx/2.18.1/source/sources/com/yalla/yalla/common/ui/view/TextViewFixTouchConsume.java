...
public final class TextViewFixTouchConsume extends FixTextView {
    ...
    public final void setTextViewHTML(@Nullable String html) {
        ...
        Intrinsics.checkNotNullExpressionValue(spannedFromHtml, "fromHtml(html)");
