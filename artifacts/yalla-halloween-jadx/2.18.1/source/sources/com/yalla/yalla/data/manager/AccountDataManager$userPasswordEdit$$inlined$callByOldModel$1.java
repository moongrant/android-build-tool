...
public final class AccountDataManager$userPasswordEdit$$inlined$callByOldModel$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<LoginInformation2>>, Object> {

    /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
    public int f21397Oooo0o;

    /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
    public final /* synthetic */ o00O000o f21398Oooo0oO;

    public static final class OooO00o extends o00000O0<LoginInformation2> {
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AccountDataManager$userPasswordEdit$$inlined$callByOldModel$1(o00O000o o00o000o2, Continuation continuation) {
        super(2, continuation);
        this.f21398Oooo0oO = o00o000o2;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new AccountDataManager$userPasswordEdit$$inlined$callByOldModel$1(this.f21398Oooo0oO, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ApiResult<LoginInformation2>> continuation) {
        return ((AccountDataManager$userPasswordEdit$$inlined$callByOldModel$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f21397Oooo0o;
        Object obj2 = null;
        String str = "";
        try {
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                o00O000o o00o000o2 = this.f21398Oooo0oO;
            ...
            LoginInformation2 loginInformation2 = (LoginInformation2) obj2;
            ...
            apiResult.setData(loginInformation2);
            return apiResult;
        } catch (IOException e) {
