...
public final class AccountRepo$postAddTrustDevice$$inlined$call$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<Object>>, Object> {
    ...
    public int f21461Oooo0o;

    /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
    public final /* synthetic */ o00O000o f21462Oooo0oO;

    public static final class OooO00o extends o00000O0<ApiResult<Object>> {
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AccountRepo$postAddTrustDevice$$inlined$call$1(o00O000o o00o000o2, Continuation continuation) {
        super(2, continuation);
        this.f21462Oooo0oO = o00o000o2;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new AccountRepo$postAddTrustDevice$$inlined$call$1(this.f21462Oooo0oO, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f21461Oooo0o;
        String str = "";
        try {
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                o00O000o o00o000o2 = this.f21462Oooo0oO;
