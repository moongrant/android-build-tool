...
public class CommentMessageModel extends AbsJavaBean {
    ...
    public MomentSendContentModel getMsgObj() {
        ...
        try {
            MomentSendContentModel momentSendContentModel2 = (MomentSendContentModel) o0Oo0oo.OooO0OO(this.msg, new o00000O0<MomentSendContentModel>() { // from class: com.yalla.yalla.model.CommentMessageModel.1
            }.getType());
