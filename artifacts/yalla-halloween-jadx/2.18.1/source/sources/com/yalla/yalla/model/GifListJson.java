...
public final /* data */ class GifListJson {
    ...
    public int hashCode() {
        ...
        int iOooO00o = o0O0O00.OooO00o(this.folderIcon, o0O0O00.OooO00o(this.folderName, (((((((((((i2 + r2) * 31) + ((int) (j ^ (j >>> 32)))) * 31) + this.dayNum) * 31) + this.payType) * 31) + this.price) * 31) + this.promotionPrice) * 31, 31), 31);
    ...
    public String toString() {
        StringBuilder sbOooO0o0 = OooO00o.OooO00o.OooO0o0("GifListJson(catalogId=");
        sbOooO0o0.append(this.catalogId);
        sbOooO0o0.append(", buyType=");
        sbOooO0o0.append(this.buyType);
        sbOooO0o0.append(", isCanUse=");
        sbOooO0o0.append(this.isCanUse);
        sbOooO0o0.append(", isNew=");
        sbOooO0o0.append(this.isNew);
        ...
        sbOooO0o0.append(", folderName=");
        sbOooO0o0.append(this.folderName);
        sbOooO0o0.append(", folderIcon=");
        sbOooO0o0.append(this.folderIcon);
        sbOooO0o0.append(", themeConfig=");
        sbOooO0o0.append(this.themeConfig);
        sbOooO0o0.append(", item=");
        return o000O0Oo.OooO00o(sbOooO0o0, this.item, ')');
    }
    ...
    public /* synthetic */ GifListJson(int i, int i2, boolean z, boolean z2, long j, int i3, int i4, int i5, int i6, String str, String str2, ThemeConfig themeConfig, List list, int i7, DefaultConstructorMarker defaultConstructorMarker) {
        this(i, i2, z, z2, j, i3, i4, i5, i6, str, str2, (i7 & RecyclerView.oo0o0Oo.FLAG_MOVED) != 0 ? null : themeConfig, list);
    }
}
