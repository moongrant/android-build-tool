...
@Metadata(d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010!\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\t\n\u0002\b\r\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0003\b\u0007\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u0006\u0010 \u001a\u00020!J\u0018\u0010\"\u001a\u00020\u00002\u0006\u0010\f\u001a\u00020\r2\b\u0010\u0012\u001a\u0004\u0018\u00010\u0003J\u0006\u0010#\u001a\u00020\u0003R \u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00070\u0006X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\b\u0010\t\"\u0004\b\n\u0010\u000bR\u001a\u0010\f\u001a\u00020\rX\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u000e\u0010\u000f\"\u0004\b\u0010\u0010\u0011R\u001c\u0010\u0012\u001a\u0004\u0018\u00010\u0003X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0013\u0010\u0014\"\u0004\b\u0015\u0010\u0004R&\u0010\u0017\u001a\u00020\u00032\u0006\u0010\u0016\u001a\u00020\u00038F@FX\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0018\u0010\u0014\"\u0004\b\u0019\u0010\u0004R*\u0010\u001a\u001a\b\u0012\u0004\u0012\u00020\u001b0\u00068\u0006@\u0006X\u0087\u000e¢\u0006\u0014\n\u0000\u0012\u0004\b\u001c\u0010\u001d\u001a\u0004\b\u001e\u0010\t\"\u0004\b\u001f\u0010\u000b¨\u0006$"}, d2 = {"Lcom/yalla/yalla/model/MomentSendContentModel;", "Ljava/io/Serializable;", "contentStr", "", "(Ljava/lang/String;)V", "at", "", "Lcom/yalla/yalla/model/MomentSendContentAtModel;", "getAt", "()Ljava/util/List;", "setAt", "(Ljava/util/List;)V", "circleId", "", "getCircleId", "()J", "setCircleId", "(J)V", "circleName", "getCircleName", "()Ljava/lang/String;", "setCircleName", AppMeasurementSdk.ConditionalUserProperty.VALUE, "content", "getContent", "setContent", "topic", "Lcom/yalla/yalla/model/MomentSendContentTopicModel;", "getTopic$annotations", "()V", "getTopic", "setTopic", "hasCircle", "", "setCircle", "toJSONString", "app_YallaRelease"}, k = 1, mv = {1, 7, 1}, xi = 48)
public final class MomentSendContentModel implements Serializable {
    ...
    public final String getContent() {
        String strReplace = this.content;
        if (strReplace != null && strReplace.contains("\u3000")) {
            strReplace = strReplace.replace("\u3000", ZegoConstants.ZegoVideoDataAuxPublishingStream);
        }
        Intrinsics.checkNotNullExpressionValue(strReplace, "replaceErr1(field)");
        return strReplace;
    }
    ...
    public final boolean hasCircle() {
        return this.circleId > 0 && o00O0.OooO0o0(this.circleName);
    }
    ...
    public final void setContent(@NotNull String value) {
        ...
        if (string != null && string.contains("\u3000")) {
            string = string.replace("\u3000", ZegoConstants.ZegoVideoDataAuxPublishingStream);
        }
        Intrinsics.checkNotNullExpressionValue(string, "replaceErr1(builder.toString())");
        this.content = string;
    }
