...
public final /* data */ class RoomMemberTaskInfoModel {
    ...
    public RoomMemberTaskInfoModel(long j, long j2, int i, @NotNull String str, int i2, int i3, @NotNull String str2, @NotNull String str3, int i4) {
        com.facebook.OooO00o.OooO0O0(str, "taskDesc", str2, "taskName", str3, "taskPic");
        this.completedVal = j;
        this.currVal = j2;
        this.state = i;
        this.taskDesc = str;
    ...
    public int hashCode() {
        ...
        return o0O0O00.OooO00o(this.taskPic, o0O0O00.OooO00o(this.taskName, (((o0O0O00.OooO00o(this.taskDesc, ((((((int) (j ^ (j >>> 32))) * 31) + ((int) (j2 ^ (j2 >>> 32)))) * 31) + this.state) * 31, 31) + this.unitRewardVal) * 31) + this.taskId) * 31, 31), 31) + this.taskType;
    }
    ...
    public String toString() {
        StringBuilder sbOooO0o0 = OooO00o.OooO00o.OooO0o0("RoomMemberTaskInfoModel(completedVal=");
        sbOooO0o0.append(this.completedVal);
        sbOooO0o0.append(", currVal=");
        sbOooO0o0.append(this.currVal);
        sbOooO0o0.append(", state=");
        sbOooO0o0.append(this.state);
        sbOooO0o0.append(", taskDesc=");
        sbOooO0o0.append(this.taskDesc);
        sbOooO0o0.append(", unitRewardVal=");
        sbOooO0o0.append(this.unitRewardVal);
        sbOooO0o0.append(", taskId=");
        sbOooO0o0.append(this.taskId);
        sbOooO0o0.append(", taskName=");
        sbOooO0o0.append(this.taskName);
        sbOooO0o0.append(", taskPic=");
        sbOooO0o0.append(this.taskPic);
        sbOooO0o0.append(", taskType=");
        return o0O0ooO.OooO00o(sbOooO0o0, this.taskType, ')');
    }
    ...
    public /* synthetic */ RoomMemberTaskInfoModel(long j, long j2, int i, String str, int i2, int i3, String str2, String str3, int i4, int i5, DefaultConstructorMarker defaultConstructorMarker) {
        this((i5 & 1) != 0 ? 0L : j, (i5 & 2) == 0 ? j2 : 0L, (i5 & 4) != 0 ? 0 : i, (i5 & 8) != 0 ? "" : str, (i5 & 16) != 0 ? 0 : i2, (i5 & 32) != 0 ? 0 : i3, (i5 & 64) != 0 ? "" : str2, (i5 & 128) == 0 ? str3 : "", (i5 & 256) == 0 ? i4 : 0);
    }
}
