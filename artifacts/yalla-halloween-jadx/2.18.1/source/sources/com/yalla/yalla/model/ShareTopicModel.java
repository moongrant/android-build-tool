...
public final /* data */ class ShareTopicModel {
    ...
    public int hashCode() {
        ...
        return this.msg.hashCode() + ((((o0O0O00.OooO00o(this.name, o0O0O00.OooO00o(this.image, (iHashCode + ((int) (j ^ (j >>> 32)))) * 31, 31), 31) + this.userCount) * 31) + this.momentCount) * 31);
    }

    @NotNull
    public String toString() {
        StringBuilder sbOooO0o0 = OooO00o.OooO00o.OooO0o0("ShareTopicModel(targets=");
        sbOooO0o0.append(this.targets);
        sbOooO0o0.append(", circleId=");
        sbOooO0o0.append(this.circleId);
        sbOooO0o0.append(", image=");
        sbOooO0o0.append(this.image);
        sbOooO0o0.append(", name=");
        sbOooO0o0.append(this.name);
        sbOooO0o0.append(", userCount=");
        sbOooO0o0.append(this.userCount);
        sbOooO0o0.append(", momentCount=");
        sbOooO0o0.append(this.momentCount);
        sbOooO0o0.append(", msg=");
        return o00oO0o.OooO0O0(sbOooO0o0, this.msg, ')');
    }
}
