...
public final /* data */ class ShareUserModel {
    ...
    public int hashCode() {
        ...
        long j2 = this.idx;
        return this.msg.hashCode() + o0O0O00.OooO00o(this.name, o0O0O00.OooO00o(this.head, (i + ((int) (j2 ^ (j2 >>> 32)))) * 31, 31), 31);
    }

    @NotNull
    public String toString() {
        StringBuilder sbOooO0o0 = OooO00o.OooO00o.OooO0o0("ShareUserModel(targets=");
        sbOooO0o0.append(this.targets);
        sbOooO0o0.append(", id=");
        sbOooO0o0.append(this.id);
        sbOooO0o0.append(", idx=");
        sbOooO0o0.append(this.idx);
        sbOooO0o0.append(", head=");
        sbOooO0o0.append(this.head);
