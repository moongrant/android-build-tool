...
public final /* data */ class StoreRoomChatBubbleModel {
    ...
    public int hashCode() {
        int iOooO00o = o0O0O00.OooO00o(this.bubbleColour, o0O0O00.OooO00o(this.backgroundUrl, this.attachedPicUrl.hashCode() * 31, 31), 31);
        boolean z = this.canBuy;
        ?? r1 = z;
        if (z) {
            r1 = 1;
        }
        int iOooO00o2 = o0O0O00.OooO00o(this.h5Url, (((((((((((iOooO00o + r1) * 31) + this.canBuyUserType) * 31) + this.dayNum) * 31) + this.exclusiveLv) * 31) + this.flagType) * 31) + this.frozenDay) * 31, 31);
        boolean z2 = this.isHave;
        ?? r2 = z2;
        if (z2) {
            r2 = 1;
        }
        int iOooO00o3 = o0O0O00.OooO00o(this.replyColour, (((o0O0O00.OooO00o(this.picUrl, (((((((iOooO00o2 + r2) * 31) + this.limitNum) * 31) + this.obtainType) * 31) + this.obtainLevel) * 31, 31) + this.price) * 31) + this.promotionPrice) * 31, 31);
        boolean z3 = this.selected;
        return this.bubbleText.hashCode() + o0O0O00.OooO00o(this.waresName, (((((iOooO00o3 + (z3 ? 1 : z3)) * 31) + this.shopId) * 31) + this.timeLong) * 31, 31);
    }
    ...
    public String toString() {
        StringBuilder sbOooO0o0 = OooO00o.OooO00o.OooO0o0("StoreRoomChatBubbleModel(attachedPicUrl=");
        sbOooO0o0.append(this.attachedPicUrl);
        sbOooO0o0.append(", backgroundUrl=");
        sbOooO0o0.append(this.backgroundUrl);
        sbOooO0o0.append(", bubbleColour=");
        sbOooO0o0.append(this.bubbleColour);
        sbOooO0o0.append(", canBuy=");
        sbOooO0o0.append(this.canBuy);
        sbOooO0o0.append(", canBuyUserType=");
        sbOooO0o0.append(this.canBuyUserType);
        sbOooO0o0.append(", dayNum=");
        sbOooO0o0.append(this.dayNum);
        sbOooO0o0.append(", exclusiveLv=");
        sbOooO0o0.append(this.exclusiveLv);
        sbOooO0o0.append(", flagType=");
        sbOooO0o0.append(this.flagType);
        sbOooO0o0.append(", frozenDay=");
        sbOooO0o0.append(this.frozenDay);
        sbOooO0o0.append(", h5Url=");
        sbOooO0o0.append(this.h5Url);
        sbOooO0o0.append(", isHave=");
        sbOooO0o0.append(this.isHave);
        sbOooO0o0.append(", limitNum=");
        sbOooO0o0.append(this.limitNum);
        sbOooO0o0.append(", obtainType=");
        sbOooO0o0.append(this.obtainType);
        sbOooO0o0.append(", obtainLevel=");
        sbOooO0o0.append(this.obtainLevel);
        sbOooO0o0.append(", picUrl=");
        sbOooO0o0.append(this.picUrl);
        sbOooO0o0.append(", price=");
        sbOooO0o0.append(this.price);
        sbOooO0o0.append(", promotionPrice=");
        sbOooO0o0.append(this.promotionPrice);
        sbOooO0o0.append(", replyColour=");
        sbOooO0o0.append(this.replyColour);
        sbOooO0o0.append(", selected=");
        sbOooO0o0.append(this.selected);
        sbOooO0o0.append(", shopId=");
        sbOooO0o0.append(this.shopId);
        sbOooO0o0.append(", timeLong=");
        sbOooO0o0.append(this.timeLong);
        sbOooO0o0.append(", waresName=");
        sbOooO0o0.append(this.waresName);
        sbOooO0o0.append(", bubbleText=");
        return o00oO0o.OooO0O0(sbOooO0o0, this.bubbleText, ')');
    }
    ...
    public /* synthetic */ StoreRoomChatBubbleModel(String str, String str2, String str3, boolean z, int i, int i2, int i3, int i4, int i5, String str4, boolean z2, int i6, int i7, int i8, String str5, int i9, int i10, String str6, boolean z3, int i11, int i12, String str7, String str8, int i13, DefaultConstructorMarker defaultConstructorMarker) {
        this((i13 & 1) != 0 ? "" : str, (i13 & 2) != 0 ? "" : str2, (i13 & 4) != 0 ? "" : str3, (i13 & 8) != 0 ? false : z, (i13 & 16) != 0 ? 0 : i, (i13 & 32) != 0 ? 0 : i2, (i13 & 64) != 0 ? 0 : i3, (i13 & 128) != 0 ? 0 : i4, (i13 & 256) != 0 ? 0 : i5, (i13 & 512) != 0 ? "" : str4, (i13 & 1024) != 0 ? false : z2, (i13 & RecyclerView.oo0o0Oo.FLAG_MOVED) != 0 ? 0 : i6, (i13 & 4096) != 0 ? 0 : i7, (i13 & 8192) != 0 ? 0 : i8, (i13 & 16384) != 0 ? "" : str5, (i13 & ShareRequest.THUMB_DATA_SIZE_LIMIT) != 0 ? 0 : i9, (i13 & 65536) != 0 ? 0 : i10, (i13 & 131072) != 0 ? "" : str6, (i13 & 262144) != 0 ? false : z3, (i13 & 524288) != 0 ? 0 : i11, (i13 & 1048576) != 0 ? 0 : i12, (i13 & 2097152) != 0 ? "" : str7, (i13 & 4194304) != 0 ? "" : str8);
    }
}
