...
public final /* data */ class TaskModel {
    ...
    public TaskModel(int i, int i2, int i3, @NotNull String getcrystal, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11) {
    ...
    @NotNull
    public final TaskModel copy(int takeId, int icon, int name, @NotNull String getcrystal, int state, int typeName, int num, int maxNum, int rewardCoin, int rewardType, int isOneTime, int rewardMultiple) {
        Intrinsics.checkNotNullParameter(getcrystal, "getcrystal");
        return new TaskModel(takeId, icon, name, getcrystal, state, typeName, num, maxNum, rewardCoin, rewardType, isOneTime, rewardMultiple);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return this.takeId == taskModel.takeId && this.icon == taskModel.icon && this.name == taskModel.name && Intrinsics.areEqual(this.getcrystal, taskModel.getcrystal) && this.state == taskModel.state && this.typeName == taskModel.typeName && this.num == taskModel.num && this.maxNum == taskModel.maxNum && this.rewardCoin == taskModel.rewardCoin && this.rewardType == taskModel.rewardType && this.isOneTime == taskModel.isOneTime && this.rewardMultiple == taskModel.rewardMultiple;
    }
    ...
    public int hashCode() {
        return ((((((((((((((o0O0O00.OooO00o(this.getcrystal, ((((this.takeId * 31) + this.icon) * 31) + this.name) * 31, 31) + this.state) * 31) + this.typeName) * 31) + this.num) * 31) + this.maxNum) * 31) + this.rewardCoin) * 31) + this.rewardType) * 31) + this.isOneTime) * 31) + this.rewardMultiple;
    }
    ...
    public String toString() {
        StringBuilder sbOooO0o0 = OooO00o.OooO00o.OooO0o0("TaskModel(takeId=");
        ...
        sbOooO0o0.append(", getcrystal=");
        sbOooO0o0.append(this.getcrystal);
        sbOooO0o0.append(", state=");
        sbOooO0o0.append(this.state);
        sbOooO0o0.append(", typeName=");
        sbOooO0o0.append(this.typeName);
        ...
        sbOooO0o0.append(this.isOneTime);
        sbOooO0o0.append(", rewardMultiple=");
        return o0O0ooO.OooO00o(sbOooO0o0, this.rewardMultiple, ')');
    }

    public /* synthetic */ TaskModel(int i, int i2, int i3, String str, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, DefaultConstructorMarker defaultConstructorMarker) {
        this((i12 & 1) != 0 ? 0 : i, (i12 & 2) != 0 ? 0 : i2, (i12 & 4) != 0 ? 0 : i3, (i12 & 8) != 0 ? "" : str, (i12 & 16) != 0 ? 0 : i4, (i12 & 32) != 0 ? 0 : i5, (i12 & 64) != 0 ? -1 : i6, (i12 & 128) != 0 ? 0 : i7, (i12 & 256) != 0 ? 0 : i8, (i12 & 512) != 0 ? 0 : i9, (i12 & 1024) != 0 ? 0 : i10, (i12 & RecyclerView.oo0o0Oo.FLAG_MOVED) == 0 ? i11 : 0);
    }
}
