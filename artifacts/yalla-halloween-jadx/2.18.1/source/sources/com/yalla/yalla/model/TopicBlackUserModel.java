...
public final /* data */ class TopicBlackUserModel {
    ...
    public TopicBlackUserModel(int i, int i2, @NotNull String str, @NotNull String str2, long j, int i3, long j2, int i4, int i5, long j3, int i6, @NotNull String str3) {
        com.facebook.OooO00o.OooO0O0(str, "imageurl", str2, "nickName", str3, "exnickName");
        this.createTime = i;
        this.id = i2;
        this.imageurl = str;
        this.nickName = str2;
    ...
    public int hashCode() {
        int iOooO00o = o0O0O00.OooO00o(this.nickName, o0O0O00.OooO00o(this.imageurl, ((this.createTime * 31) + this.id) * 31, 31), 31);
    ...
    public String toString() {
        StringBuilder sbOooO0o0 = OooO00o.OooO00o.OooO0o0("TopicBlackUserModel(createTime=");
        ...
        sbOooO0o0.append(", exUserid=");
        sbOooO0o0.append(this.exUserid);
        sbOooO0o0.append(", exRole=");
        sbOooO0o0.append(this.exRole);
        sbOooO0o0.append(", exnickName=");
        return o00oO0o.OooO0O0(sbOooO0o0, this.exnickName, ')');
    }
    ...
    public /* synthetic */ TopicBlackUserModel(int i, int i2, String str, String str2, long j, int i3, long j2, int i4, int i5, long j3, int i6, String str3, int i7, DefaultConstructorMarker defaultConstructorMarker) {
        this((i7 & 1) != 0 ? 0 : i, (i7 & 2) != 0 ? 0 : i2, (i7 & 4) != 0 ? "" : str, (i7 & 8) != 0 ? "" : str2, (i7 & 16) != 0 ? 0L : j, (i7 & 32) != 0 ? 0 : i3, (i7 & 64) != 0 ? 0L : j2, (i7 & 128) != 0 ? 0 : i4, (i7 & 256) != 0 ? 0 : i5, (i7 & 512) == 0 ? j3 : 0L, (i7 & 1024) != 0 ? 0 : i6, (i7 & RecyclerView.oo0o0Oo.FLAG_MOVED) == 0 ? str3 : "");
    }
}
