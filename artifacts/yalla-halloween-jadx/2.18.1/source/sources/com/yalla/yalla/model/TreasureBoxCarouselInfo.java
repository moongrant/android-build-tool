...
public final /* data */ class TreasureBoxCarouselInfo {
    ...
    public TreasureBoxCarouselInfo(@NotNull String str, @NotNull String str2, @NotNull String str3, int i) {
        com.facebook.OooO00o.OooO0O0(str, "broadcast", str2, "headUrl", str3, "nickName");
        this.broadcast = str;
        this.headUrl = str2;
        this.nickName = str3;
        this.userId = i;
    ...
    public int hashCode() {
        return o0O0O00.OooO00o(this.nickName, o0O0O00.OooO00o(this.headUrl, this.broadcast.hashCode() * 31, 31), 31) + this.userId;
    }

    @NotNull
    public String toString() {
        StringBuilder sbOooO0o0 = OooO00o.OooO00o.OooO0o0("TreasureBoxCarouselInfo(broadcast=");
        sbOooO0o0.append(this.broadcast);
        ...
        return o0O0ooO.OooO00o(sbOooO0o0, this.userId, ')');
    }
