...
import p538o0o0Oo0.o0OO00OO;
import p538o0o0Oo0.oo0oO0;
import p538o0o0Oo0.oo0ooO;
import p649o0ooOOoo.bd;
...
public final class TopicEditRuleActivity extends BaseActivityK {
    ...
    public static final /* synthetic */ int f22610OooooOO = 0;

    /* JADX INFO: renamed from: Ooooo0o, reason: collision with root package name */
    public long f22613Ooooo0o;

    /* JADX INFO: renamed from: OoooOoo, reason: collision with root package name */
    @NotNull
    public final o00O000o f22611OoooOoo = new o00O000o(Reflection.getOrCreateKotlinClass(bd.class), this, null);

    /* JADX INFO: renamed from: Ooooo00, reason: collision with root package name */
    @NotNull
    public String f22612Ooooo00 = "";

    /* JADX INFO: renamed from: OooooO0, reason: collision with root package name */
    @NotNull
    public final ViewModelLazy f22614OooooO0 = new ViewModelLazy(Reflection.getOrCreateKotlinClass(TopicEditVM.class), new Function0<ViewModelStore>() { // from class: com.yalla.yalla.ui.activity.moment.TopicEditRuleActivity$special$$inlined$viewModels$default$2
        {
            super(0);
        }
        ...
        public final /* synthetic */ Function0 f22617Oooo0o = null;
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f22617Oooo0o;
    ...
    public final bd OooOoo() {
        return (bd) this.f22611OoooOoo.getValue();
    }
    ...
    public final void onCreate(@Nullable Bundle bundle) {
        ...
        setContentView(OooOoo().f49028OooO00o);
        this.f22613Ooooo0o = getIntent().getLongExtra("edit_topic_id", 0L);
        String stringExtra = getIntent().getStringExtra("rule");
        if (stringExtra == null) {
            stringExtra = "";
        }
        this.f22612Ooooo00 = stringExtra;
        ...
        EditText editText = OooOoo().f49029OooO0O0;
        Intrinsics.checkNotNullExpressionValue(editText, "binding.etRule");
        editText.addTextChangedListener(new oo0oO0(this));
        OooOoo().f49029OooO0O0.setText(this.f22612Ooooo00);
        OooOoo().f49029OooO0O0.setSelection(this.f22612Ooooo00.length());
        OooOoo().f49030OooO0OO.setOnClickListener(this);
        final int i = 1;
        OooOoo().f49029OooO0O0.post(new Runnable() { // from class: o0oOOO0o.o0oOo0O0
            ...
            public final void run() {
                ...
                switch (i) {
                    ...
                    default:
                        ...
                        EditText view2 = this$0.OooOoo().f49029OooO0O0;
        ...
        new o00(this).f40619OooO0o0 = new o0OO00OO(this);
    }
    ...
    public final void onPause() {
        super.onPause();
        EditText view = OooOoo().f49029OooO0O0;
