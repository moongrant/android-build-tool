...
public final class CountryTagActivity$initData$1$invokeSuspend$$inlined$call$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<List<? extends CountryModel>>>, Object> {
    ...
    public int f22772Oooo0o;

    /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
    public final /* synthetic */ o00O000o f22773Oooo0oO;

    public static final class OooO00o extends o00000O0<ApiResult<List<? extends CountryModel>>> {
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CountryTagActivity$initData$1$invokeSuspend$$inlined$call$1(o00O000o o00o000o2, Continuation continuation) {
        super(2, continuation);
        this.f22773Oooo0oO = o00o000o2;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new CountryTagActivity$initData$1$invokeSuspend$$inlined$call$1(this.f22773Oooo0oO, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f22772Oooo0o;
        String str = "";
        try {
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                o00O000o o00o000o2 = this.f22773Oooo0oO;
                ...
                p481o0o0000o.OooOo00 oooOo = (i2 == 0 || i2 != 1) ? new p481o0o0000o.OooOo(url, paramsWrapper) : new Oooo000(url, paramsWrapper);
                this.f22772Oooo0o = 1;
