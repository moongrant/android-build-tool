...
import p579o0oOoOOo.i;
import p649o0ooOOoo.ab;

/* JADX INFO: loaded from: classes3.dex */
@StabilityInferred(parameters = 0)
@Metadata(bv = {}, d1 = {"\u0000D\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0007\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\u0012\u0006\u0010\u000f\u001a\u00020\u000e¢\u0006\u0004\b\u001c\u0010\u001dJ\b\u0010\u0004\u001a\u00020\u0003H\u0002J\u0012\u0010\u0007\u001a\u00020\u00032\b\b\u0002\u0010\u0006\u001a\u00020\u0005H\u0002J\u001a\u0010\f\u001a\u00020\u00022\u0006\u0010\t\u001a\u00020\b2\b\u0010\u000b\u001a\u0004\u0018\u00010\nH\u0016J\b\u0010\r\u001a\u00020\u0003H\u0014R\u0014\u0010\u000f\u001a\u00020\u000e8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u000f\u0010\u0010R\u001b\u0010\u0016\u001a\u00020\u00118BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u0012\u0010\u0013\u001a\u0004\b\u0014\u0010\u0015R\u001c\u0010\u0019\u001a\b\u0012\u0004\u0012\u00020\u00180\u00178\u0002@\u0002X\u0082.¢\u0006\u0006\n\u0004\b\u0019\u0010\u001aR\u0016\u0010\u001b\u001a\u00020\u000e8\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u001b\u0010\u0010¨\u0006\u001e"}, d2 = {"Lcom/yalla/yalla/ui/fragment/ExploreTagRoomListFragment;", "Lo0o00o00/OooO;", "Lo0ooOOoo/ab;", "", "initView", "", "isRefresh", "loadCountryData", "Landroid/view/LayoutInflater;", "inflater", "Landroid/view/ViewGroup;", "container", "getViewBinding", "onLazyInit", "", "labelId", "I", "Lcom/yalla/yalla/ui/vm/main/MoreRoomVM;", "vm$delegate", "Lkotlin/Lazy;", "getVm", "()Lcom/yalla/yalla/ui/vm/main/MoreRoomVM;", "vm", "Lcom/app/base/adapter/room/RoomBaseAdapter;", "Lcom/app/base/model/RoomIndexModel;", "roomCountryAdapter", "Lcom/app/base/adapter/room/RoomBaseAdapter;", "pageIndex", "<init>", "(I)V", "app_YallaRelease"}, k = 1, mv = {1, 7, 1})
public final class ExploreTagRoomListFragment extends p503o0o00o00.OooO<ab> {
    ...
    public static final class OooO00o extends p654o0ooo.o00Oo0 {
        ...
        public final void OooO00o(@NotNull View view) {
            ...
            RoomBaseAdapter roomBaseAdapter = ExploreTagRoomListFragment.this.roomCountryAdapter;
    ...
    public static final class OooO0OO extends Lambda implements Function1<List<RoomIndexModel>, Unit> {
        ...
        public final /* synthetic */ boolean f23856Oooo0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(boolean z) {
            super(1);
            this.f23856Oooo0oO = z;
        }

        @Override // kotlin.jvm.functions.Function1
        public final Unit invoke(List<RoomIndexModel> list) {
            List<RoomIndexModel> list2 = list;
            ExploreTagRoomListFragment.this.pageIndex++;
            if (list2 != null) {
                boolean z = this.f23856Oooo0oO;
            ...
            RoomBaseAdapter roomBaseAdapter4 = ExploreTagRoomListFragment.this.roomCountryAdapter;
            if (roomBaseAdapter4 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("roomCountryAdapter");
                roomBaseAdapter4 = null;
            }
            roomBaseAdapter4.setLoadComplete(Boolean.valueOf(this.f23856Oooo0oO), Boolean.TRUE, list2 != null ? Boolean.valueOf(list2.isEmpty()) : null);
            ExploreTagRoomListFragment.this.getBinding().f48933OooO0OO.Oooo0OO(this.f23856Oooo0oO, true);
    ...
    public static final class OooO0o extends Lambda implements Function1<ApiError, Unit> {
        ...
        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ boolean f23858Oooo0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(boolean z) {
            super(1);
            this.f23858Oooo0oO = z;
        }
        ...
        public final Unit invoke(ApiError apiError) {
            ...
            ExploreTagRoomListFragment.this.getBinding().f48933OooO0OO.Oooo0OO(this.f23858Oooo0oO, false);
            return Unit.INSTANCE;
        }
    }
    ...
    public ExploreTagRoomListFragment(int i) {
        this.labelId = i;
        final Function0<Fragment> function0 = new Function0<Fragment>() { // from class: com.yalla.yalla.ui.fragment.ExploreTagRoomListFragment$special$$inlined$viewModels$default$1
            {
                super(0);
            }
        ...
        this.vm = androidx.fragment.app.o0000O.OooO0O0(this, Reflection.getOrCreateKotlinClass(MoreRoomVM.class), new Function0<ViewModelStore>() { // from class: com.yalla.yalla.ui.fragment.ExploreTagRoomListFragment$special$$inlined$viewModels$default$3
            {
                super(0);
            }
            ...
            public final /* synthetic */ Function0 f23862Oooo0o = null;
            ...
            public final CreationExtras invoke() {
                ...
                Function0 function1 = this.f23862Oooo0o;
    ...
    private final void initView() {
        getBinding().f48933OooO0OO.setOnRefreshListener(new o00O000o(this));
        getBinding().f48933OooO0OO.OooOoOO(false);
        ...
        roomBaseAdapter7.setLoadErrorClickListener(new OooO00o());
        RoomBaseAdapter<RoomIndexModel> roomBaseAdapter8 = this.roomCountryAdapter;
        if (roomBaseAdapter8 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("roomCountryAdapter");
            roomBaseAdapter8 = null;
        }
        roomBaseAdapter8.setOnLoadMoreListener(new i(this), getBinding().f48932OooO0O0);
        RoomBaseAdapter<RoomIndexModel> roomBaseAdapter9 = this.roomCountryAdapter;
        if (roomBaseAdapter9 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("roomCountryAdapter");
            roomBaseAdapter9 = null;
        }
        roomBaseAdapter9.setOnItemChildClickListener(p351o0OOOOo.OooOo.f38279OooO0o0);
        RoomBaseAdapter<RoomIndexModel> roomBaseAdapter10 = this.roomCountryAdapter;
        if (roomBaseAdapter10 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("roomCountryAdapter");
            roomBaseAdapter10 = null;
        }
        roomBaseAdapter10.setLoadErrorClickListener(new OooO0O0());
        getBinding().f48932OooO0O0.setLayoutManager(new FixLinearLayoutManager(getContext()));
        RecyclerView recyclerView = getBinding().f48932OooO0O0;
    ...
    public static final void m326initView$lambda0(ExploreTagRoomListFragment this$0) {
    ...
    public static final void m327initView$lambda1(ExploreTagRoomListFragment this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public static final void m328initView$lambda2(BaseQuickAdapter baseQuickAdapter, View view, int i) {
    ...
    public final void loadCountryData(boolean isRefresh) {
        ...
        getVm().getRoomListByTag(this.pageIndex, this.labelId).observe(this, new o0o0000.OooOo(new OooO0OO(isRefresh), new OooO0o(isRefresh), null, false, 12));
    }
    ...
    @NotNull
    public ab getViewBinding(@NotNull LayoutInflater inflater, @Nullable ViewGroup container) {
        Intrinsics.checkNotNullParameter(inflater, "inflater");
        ab abVarInflate = ab.inflate(getLayoutInflater(), container, false);
        Intrinsics.checkNotNullExpressionValue(abVarInflate, "inflate(layoutInflater, container, false)");
        return abVarInflate;
    }
}
