...
public final class MainExploreFragment extends MainRoomBaseFragment<z8> {
    ...
    public static final class OooO0OO extends p188o00o00o0.OooO0OO<RoomIndexModel> {
        ...
        public final void convert(com.chad.library.adapter.base.OooO00o oooO00o, Object obj) {
            ...
            p188o00o00o0.OooO0OO oooO0OO = MainExploreFragment.this.mAdapter;
            ...
            oooO00o2.f48448OooOo0O = true;
            oooO00o2.f48429OooO0OO = item.barimage;
    ...
    public static final class OooO0o extends p187o00o00o.o00Oo0 {

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final /* synthetic */ p187o00o00o.o00O0O f23904OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ p187o00o00o.o00O0O f23905OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ p187o00o00o.o00O0O f23906OooO0o0;

        public OooO0o(p187o00o00o.o00O0O o00o0o2, p187o00o00o.o00O0O o00o0o3, p187o00o00o.o00O0O o00o0o4, Context context) {
            this.f23904OooO0OO = o00o0o2;
            this.f23905OooO0Oo = o00o0o3;
            this.f23906OooO0o0 = o00o0o4;
        }

        @Override // p187o00o00o.o00Oo0
        @Nullable
        public final p187o00o00o.o00O0O OooO0Oo(int i) {
            p188o00o00o0.OooO0OO oooO0OO = MainExploreFragment.this.mAdapter;
            ...
            if (iIntValue == 0) {
                return this.f23904OooO0OO;
            }
            if (iIntValue == 1) {
                return this.f23905OooO0Oo;
            }
            if (iIntValue != 2) {
                return null;
            }
            return this.f23906OooO0o0;
        }
    }
    ...
    public static final class OooOO0O extends Lambda implements Function1<List<EventModel>, Unit> {
        ...
        public final Unit invoke(List<EventModel> list) {
            ...
            if (result != null) {
                ...
                oOO00O.OooO(roomExploreEventsManager.f11393OooO0OO);
                oOO00O.OooO(roomExploreEventsManager.f11394OooO0Oo);
                roomExploreEventsManager.f11395OooO0o0.clear();
                roomExploreEventsManager.f11395OooO0o0.addAll(result);
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public final void enterRoom(RoomIndexModel item, int index) {
        o0o00Ooo.o0000Ooo.OooO00o oooO00oOooO0O0 = p500o0o00Ooo.o0000Ooo.f41382OooO00o.OooO0O0(((z8) getBinding()).f51061OooO0Oo);
        ...
        if (i == 0) {
            ...
            int i4 = oooO00oOooO0O0.f41386OooO0O0;
        ...
        if (str.length() > 0) {
            ...
            BuildersKt__Builders_commonKt.launch$default(LifecycleOwnerKt.getLifecycleScope(this), null, null, new o00O0O0O(arrayList, arrayList2, roomId, sourcePage, null), 3, null);
        }
        ...
        roomModel.setId(p168o00Ooo0.o0O0O00.OooOOO0(item.barid));
    ...
    private final void initObserver() {
        ((MutableLiveData) getMViewModel().f25466OooO0O0.getValue()).observe(this, new o00O0O0(this, 4));
        ((MutableLiveData) getMViewModel().f25467OooO0OO.getValue()).observe(this, new oO000(this, 2));
        ((MutableLiveData) getMViewModel().f25468OooO0Oo.getValue()).observe(this, new o0O00o0(this, 5));
        getMViewModel().OooO0OO().observe(this, new oO00o000(this, 6));
    }
    ...
    public static final void m336initObserver$lambda6(MainExploreFragment this$0, Pair pair) {
        p188o00o00o0.OooO0OO<RoomIndexModel> oooO0OO;
        byte b;
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        ...
        if (commonParseMultiListModel == null || com.yalla.support.common.util.OooO0OO.OooO00o(commonParseMultiListModel.data)) {
            ((z8) this$0.getBinding()).f51063OooO0o0.Oooo0o0(zBooleanValue, true, true);
            p188o00o00o0.OooO0OO<RoomIndexModel> oooO0OO2 = this$0.mAdapter;
            if (oooO0OO2 != null) {
        ...
        if (zBooleanValue) {
            ...
            roomExploreHotHeadView.f11437o00o0O = this$0.hotTop3List;
            int iOooO0oo = p206o00o0o0o.o000OO0O.OooO0oo();
            int iOooO00o = (iOooO0oo - p418o0Oo0oo.oo000o.OooO00o(roomExploreHotHeadView.f11715OoooO0O, 42.0d)) / 3;
            LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) roomExploreHotHeadView.f11419OoooOOO.getLayoutParams();
            layoutParams.width = (iOooO0oo - p418o0Oo0oo.oo000o.OooO00o(roomExploreHotHeadView.f11715OoooO0O, 37.0d)) - iOooO00o;
            layoutParams.height = (iOooO0oo - p418o0Oo0oo.oo000o.OooO00o(roomExploreHotHeadView.f11715OoooO0O, 37.0d)) - iOooO00o;
            roomExploreHotHeadView.f11419OoooOOO.setLayoutParams(layoutParams);
            if (roomExploreHotHeadView.f11437o00o0O.size() > 0) {
                roomExploreHotHeadView.f11433o000oOoO.setVisibility(0);
                ((SVGAView) roomExploreHotHeadView.OooO0O0(R.id.lav_hot_room_live1)).OooO0oo("svga/anim_room_live.svga", (LifecycleOwner) roomExploreHotHeadView.f11711Oooo0oo);
                ((SVGAView) roomExploreHotHeadView.OooO0O0(R.id.lav_hot_room_live1)).OooO();
                if (roomExploreHotHeadView.f11437o00o0O.size() == 1) {
                    roomExploreHotHeadView.f11419OoooOOO.setVisibility(0);
                    roomExploreHotHeadView.f11420OoooOOo.setVisibility(8);
                    roomExploreHotHeadView.f11421OoooOo0.setVisibility(8);
                } else if (roomExploreHotHeadView.f11437o00o0O.size() == 2) {
                    ((SVGAView) roomExploreHotHeadView.OooO0O0(R.id.lav_hot_room_live2)).OooO0oo("svga/anim_room_live.svga", (LifecycleOwner) roomExploreHotHeadView.f11711Oooo0oo);
                    ((SVGAView) roomExploreHotHeadView.OooO0O0(R.id.lav_hot_room_live2)).OooO();
                    roomExploreHotHeadView.f11419OoooOOO.setVisibility(0);
                    roomExploreHotHeadView.f11420OoooOOo.setVisibility(0);
                    roomExploreHotHeadView.f11421OoooOo0.setVisibility(8);
                } else if (roomExploreHotHeadView.f11437o00o0O.size() >= 3) {
                    ((SVGAView) roomExploreHotHeadView.OooO0O0(R.id.lav_hot_room_live2)).OooO0oo("svga/anim_room_live.svga", (LifecycleOwner) roomExploreHotHeadView.f11711Oooo0oo);
                    ((SVGAView) roomExploreHotHeadView.OooO0O0(R.id.lav_hot_room_live3)).OooO0oo("svga/anim_room_live.svga", (LifecycleOwner) roomExploreHotHeadView.f11711Oooo0oo);
                    ((SVGAView) roomExploreHotHeadView.OooO0O0(R.id.lav_hot_room_live2)).OooO();
                    ((SVGAView) roomExploreHotHeadView.OooO0O0(R.id.lav_hot_room_live3)).OooO();
                    roomExploreHotHeadView.f11419OoooOOO.setVisibility(0);
                    roomExploreHotHeadView.f11420OoooOOo.setVisibility(0);
                    roomExploreHotHeadView.f11421OoooOo0.setVisibility(0);
                }
                for (int i2 = 0; i2 < roomExploreHotHeadView.f11437o00o0O.size(); i2++) {
                    roomExploreHotHeadView.f11440ooOO.get(i2).setText(roomExploreHotHeadView.f11437o00o0O.get(i2).onlinenum);
                    roomExploreHotHeadView.f11435o00Oo0.get(i2).setVisibility(0);
                    LottieAnimationView lottieAnimationView = roomExploreHotHeadView.f11435o00Oo0.get(i2);
                    lottieAnimationView.OooO0Oo();
                    String str = roomExploreHotHeadView.f11437o00o0O.get(i2).bartype;
                    ...
                    roomExploreHotHeadView.f11434o00O0O.get(i2).setText(roomExploreHotHeadView.f11437o00o0O.get(i2).barname);
                    oO0O00.OooO00o oooO00o = new oO0O00.OooO00o(roomExploreHotHeadView.f11715OoooO0O);
                    oooO00o.OooO00o(o00OOO.OooO00o.OooO0oO());
                    oooO00o.f48429OooO0OO = roomExploreHotHeadView.f11437o00o0O.get(i2).barimage;
                    oooO00o.f48427OooO00o = 0;
                    oooO00o.OooO0oO(12);
                    oooO00o.f48448OooOo0O = true;
                    oooO00o.OooO0o(roomExploreHotHeadView.f11436o00Ooo.get(i2));
                }
            } else {
                roomExploreHotHeadView.f11433o000oOoO.setVisibility(8);
            }
        } else {
        ...
        p188o00o00o0.OooO0OO<RoomIndexModel> oooO0OO3 = this$0.mAdapter;
        if (oooO0OO3 != null) {
        ...
        mViewModel.f25469OooO0o = i3;
        ((z8) this$0.getBinding()).f51063OooO0o0.Oooo0o0(zBooleanValue, true, z);
        p188o00o00o0.OooO0OO<RoomIndexModel> oooO0OO4 = this$0.mAdapter;
        if (oooO0OO4 != null) {
    ...
    public static final void m338initObserver$lambda9(MainExploreFragment this$0, Pair pair) {
        ...
        StateLayout stateLayout = ((z8) this$0.getBinding()).f51062OooO0o;
        Intrinsics.checkNotNullExpressionValue(stateLayout, "binding.stateLayout");
        oOO00O.OooO00o(stateLayout);
        if (zBooleanValue || bool == null) {
            return;
        }
        ((z8) this$0.getBinding()).f51063OooO0o0.Oooo0O0(bool.booleanValue());
        this$0.showOrInitErrorView();
    }

    /* JADX WARN: Multi-variable type inference failed */
    private final void initView() {
        ((z8) getBinding()).f51059OooO0O0.setText(p254o00ooO0O.o000O0O0.OooO0OO(R.string.room_nav_explore));
        ImageView imageView = ((z8) getBinding()).f51060OooO0OO;
        Intrinsics.checkNotNullExpressionValue(imageView, "binding.ivSearchRoom");
        oOO00O.OooO0oO(imageView, new OooO00o());
        XRefreshLayout xRefreshLayout = ((z8) getBinding()).f51063OooO0o0;
        xRefreshLayout.setOnRefreshListener(new o00O00(this, 3));
        xRefreshLayout.f19555o0ooOoO = true;
        xRefreshLayout.f19537o000OOo = true;
        xRefreshLayout.f19500o000000 = true;
        xRefreshLayout.f19551o0Oo0oo = false;
        RoomExploreHeadView mRoomExploreHeadView = getMRoomExploreHeadView();
        mRoomExploreHeadView.f11708Oooo = null;
        mRoomExploreHeadView.f11714OoooO00 = -1;
        mRoomExploreHeadView.OooO(mRoomExploreHeadView.f11412Ooooo0o, false, 6);
        mRoomExploreHeadView.OooOO0(mRoomExploreHeadView.f11413OooooO0, false);
        ...
        roomExploreHotHeadView.f11438o00ooo = new OooO0O0();
        ...
        ((z8) getBinding()).f51063OooO0o0.f12224o000OO0O = new oO0O000(this, 2);
        ((z8) getBinding()).f51061OooO0Oo.setLayoutManager(new GridLayoutManager(getContext(), 3, 1, false));
        ((z8) getBinding()).f51061OooO0Oo.setHasFixedSize(true);
        p187o00o00o.o00Ooo o00ooo2 = new p187o00o00o.o00Ooo(true, 0, 15.0f);
        p187o00o00o.o00Ooo o00ooo3 = new p187o00o00o.o00Ooo(true, 0, 8.0f);
        p187o00o00o.o00Ooo o00ooo4 = new p187o00o00o.o00Ooo(false, -10066330, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE);
        p187o00o00o.o00O0O o00o0o2 = new p187o00o00o.o00O0O(o00ooo2, o00ooo3, o00ooo4, o00ooo4);
        p187o00o00o.o00O0O o00o0o3 = new p187o00o00o.o00O0O(new p187o00o00o.o00Ooo(true, 0, 8.0f), new p187o00o00o.o00Ooo(true, 0, 8.0f), new p187o00o00o.o00Ooo(true, 0, 8.0f), new p187o00o00o.o00Ooo(false, -10066330, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE));
        p187o00o00o.o00Ooo o00ooo5 = new p187o00o00o.o00Ooo(true, 0, 15.0f);
        p187o00o00o.o00Ooo o00ooo6 = new p187o00o00o.o00Ooo(true, 0, 8.0f);
        p187o00o00o.o00Ooo o00ooo7 = new p187o00o00o.o00Ooo(false, -10066330, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE);
        ((z8) getBinding()).f51061OooO0Oo.addItemDecoration(new OooO0o(o00o0o2, o00o0o3, new p187o00o00o.o00O0O(o00ooo7, o00ooo6, o00ooo5, o00ooo7), getContext()));
        p188o00o00o0.OooO0OO<RoomIndexModel> oooO0OO2 = this.mAdapter;
        if (oooO0OO2 != null) {
            oooO0OO2.setHeaderView(getMRoomExploreHeadView().f11713OoooO0, 1);
        }
        p188o00o00o0.OooO0OO<RoomIndexModel> oooO0OO3 = this.mAdapter;
        if (oooO0OO3 != null) {
            RoomExploreHotHeadView roomExploreHotHeadView2 = this.mHotHeadView;
            Intrinsics.checkNotNull(roomExploreHotHeadView2);
            oooO0OO3.setHeaderView(roomExploreHotHeadView2.f11713OoooO0, 2);
        }
        ((z8) getBinding()).f51061OooO0Oo.setAdapter(this.mAdapter);
        p617o0oo0o.o00000OO o00000oo2 = p617o0oo0o.o00000OO.f48476OooO00o;
        RecyclerView recyclerView = ((z8) getBinding()).f51061OooO0Oo;
        Intrinsics.checkNotNullExpressionValue(recyclerView, "binding.recyclerView");
        p617o0oo0o.o00000OO.OooO00o(recyclerView);
        p188o00o00o0.OooO0OO<RoomIndexModel> oooO0OO4 = this.mAdapter;
        if (oooO0OO4 != null) {
    ...
    private final void refreshLoad() {
        ...
        p254o00ooO0O.o0000O0O.OooO00o(new ooOOOOoo(null)).observe(getViewLifecycleOwner(), new o0o0000.OooOo(new OooOO0O(), null, null, false, 14));
    ...
    private final void showOrInitErrorView() {
        ...
        statusView2.setLayoutParams(new ViewGroup.LayoutParams(-1, ((z8) getBinding()).f51063OooO0o0.getMeasuredHeight()));
        ...
        statusView3.setOnErrorClickListener(new p564o0oOo00.o000O00(this, 1));
        p188o00o00o0.OooO0OO<RoomIndexModel> oooO0OO = this.mAdapter;
        if (oooO0OO != null) {
    ...
    public static final void m341showOrInitErrorView$lambda11(MainExploreFragment this$0, View view) {
        ...
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        p188o00o00o0.OooO0OO<RoomIndexModel> oooO0OO = this$0.mAdapter;
        ...
        oOO00O.OooO00o(statusView);
        ((z8) this$0.getBinding()).f51063OooO0o0.Oooo00o();
    }
    ...
    public void onLazyInit() {
        ...
        initObserver();
        refreshLoad();
        ((z8) getBinding()).f51062OooO0o.OooOO0O(true);
    }
    ...
    public void onPause() {
        ...
        p606o0oo0O.OooOo.OooO0OO("401001", MapsKt.mapOf(new Pair("staytime", getTimeLengthStr())));
    }
    ...
    public void scrollToTop() {
        super.scrollToTop();
        ((z8) getBinding()).f51061OooO0Oo.scrollToPosition(0);
        if (((z8) getBinding()).f51063OooO0o0.getState() == RefreshState.None) {
            ((z8) getBinding()).f51063OooO0o0.OooO();
            ((z8) getBinding()).f51063OooO0o0.OooO0oo();
        }
    }
    ...
    public final void uploadApiStatistical() {
        ...
        try {
            ...
            ArrayList arrayList = new ArrayList();
            ArrayList arrayList2 = new ArrayList();
            if (oooO00oOooO0O0.f41385OooO00o == 0) {
                for (RoomIndexModel roomIndexModel : this.hotTop3List) {
                    arrayList.add(roomIndexModel.barid);
                    arrayList2.add(roomIndexModel.sessionId);
                }
                if (oooO00oOooO0O0.f41386OooO0O0 > 0 && (!this.hotDataList.isEmpty())) {
                    int i = oooO00oOooO0O0.f41386OooO0O0 - 1;
                ...
                int i3 = oooO00oOooO0O0.f41386OooO0O0 - 1;
                for (int i4 = oooO00oOooO0O0.f41385OooO00o - 1; i4 < i3; i4++) {
            ...
            if (!arrayList.isEmpty()) {
                ...
                BuildersKt__Builders_commonKt.launch$default(LifecycleOwnerKt.getLifecycleScope(this), null, null, new oo0oOO0(arrayList, arrayList2, expoSource, null), 3, null);
            }
    ...
    @NotNull
    public z8 getViewBinding(@NotNull LayoutInflater inflater, @Nullable ViewGroup container) {
        Intrinsics.checkNotNullParameter(inflater, "inflater");
        z8 z8VarInflate = z8.inflate(inflater, container, false);
        Intrinsics.checkNotNullExpressionValue(z8VarInflate, "inflate(inflater, container, false)");
        return z8VarInflate;
    }
}
