...
public final class TopicPostPopularFragment extends p503o0o00o00.OooO<h9> {
    ...
    @NotNull
    private final Lazy vm = androidx.fragment.app.o0000O.OooO0O0(this, Reflection.getOrCreateKotlinClass(TopicDetailVM.class), new Function0<ViewModelStore>() { // from class: com.yalla.yalla.ui.fragment.TopicPostPopularFragment$special$$inlined$activityViewModels$default$1
        {
            super(0);
        }
    ...
    }, new Function0<CreationExtras>() { // from class: com.yalla.yalla.ui.fragment.TopicPostPopularFragment$special$$inlined$activityViewModels$default$2

        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ Function0 f24289Oooo0o = null;
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f24289Oooo0o;
    ...
    }, new Function0<ViewModelProvider.Factory>() { // from class: com.yalla.yalla.ui.fragment.TopicPostPopularFragment$special$$inlined$activityViewModels$default$3
        {
            super(0);
        }
    ...
    public static final class OooO00o extends Lambda implements Function0<p563o0oOo0.o00000OO> {
        ...
        public final p563o0oOo0.o00000OO invoke() {
            FragmentActivity fragmentActivityRequireActivity = TopicPostPopularFragment.this.requireActivity();
            Intrinsics.checkNotNullExpressionValue(fragmentActivityRequireActivity, "requireActivity()");
            return new p563o0oOo0.o00000OO(fragmentActivityRequireActivity, MomentAdapterTag.TopicDetailFragmentPopular);
        }
    }
    ...
    public static final class OooO0O0 extends p654o0ooo.o00Oo0 {
        ...
        public final void OooO00o(@NotNull View view) {
            ...
            TopicPostPopularFragment.this.getAdapter().setFirstLoading(true);
            TopicPostPopularFragment.this.loadTopicPost(true);
        }
    }
    ...
    public static final class OooO0OO extends Lambda implements Function1<ApiResult<List<MomentDetailModel>>, Unit> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ boolean f24284Oooo0o;

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ TopicPostPopularFragment f24285Oooo0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(boolean z, TopicPostPopularFragment topicPostPopularFragment) {
            super(1);
            this.f24284Oooo0o = z;
            this.f24285Oooo0oO = topicPostPopularFragment;
        }
        ...
        public final Unit invoke(ApiResult<List<MomentDetailModel>> apiResult) {
            ...
            if (it.isSuccess()) {
                if (this.f24284Oooo0o) {
                    this.f24285Oooo0oO.getAdapter().setNewData(it.getData());
                    List<MomentDetailModel> data = this.f24285Oooo0oO.getAdapter().getData();
                    Intrinsics.checkNotNullExpressionValue(data, "adapter.data");
                    if (!data.isEmpty()) {
                        this.f24285Oooo0oO.getBinding().f49530OooO0O0.scrollToPosition(0);
                    }
                } else {
                    List<MomentDetailModel> data2 = it.getData();
                    if (data2 != null) {
                        this.f24285Oooo0oO.getAdapter().addData((Collection) data2);
                    }
                }
                TopicPostPopularFragment topicPostPopularFragment = this.f24285Oooo0oO;
                Long dateSort = it.getPage().getDateSort();
                topicPostPopularFragment.dateSort = dateSort != null ? dateSort.longValue() : 0L;
                this.f24285Oooo0oO.pageIndex = it.getPage().getPageIndex() + 1;
            }
            this.f24285Oooo0oO.getBinding().f49531OooO0OO.Oooo0OO(this.f24284Oooo0o, it.isSuccess());
            p563o0oOo0.o00000OO adapter = this.f24285Oooo0oO.getAdapter();
            Boolean boolValueOf = Boolean.valueOf(this.f24284Oooo0o);
    ...
    public static final class OooO0o extends Lambda implements Function1<MomentDetailModel, Unit> {
        ...
        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ long f24287Oooo0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(long j) {
            super(1);
            this.f24287Oooo0oO = j;
        }
        ...
        public final Unit invoke(MomentDetailModel momentDetailModel) {
            ...
            if (momentDetailModel2 != null) {
                List<MomentDetailModel> data = TopicPostPopularFragment.this.getAdapter().getData();
                Intrinsics.checkNotNullExpressionValue(data, "adapter.data");
                long j = this.f24287Oooo0oO;
                ...
                if (i != -1 && TopicPostPopularFragment.this.getAdapter().getData().size() > i) {
                    if (momentDetailModel2.getPower() == MomentTypePower.Self.getValue()) {
                        TopicPostPopularFragment.this.getAdapter().remove(i);
                        TopicPostPopularFragment.this.getAdapter().notifyItemRemoved(TopicPostPopularFragment.this.getAdapter().getHeaderLayoutCount() + i);
                    } else {
                        TopicPostPopularFragment.this.getAdapter().setData(i, momentDetailModel2);
                    }
                }
            }
            return Unit.INSTANCE;
    ...
    private final void initObserve() {
        LiveEventBus.get("POST_DETAIL_DATA_REFRESH", MomentDetailModel.class).observe(this, new o00OOO0O(this, 6));
        Class cls = Long.TYPE;
        int i = 5;
        LiveEventBus.get("EVENT_DELETED", cls).observe(this, new o00OOO0(this, i));
        getVm().getTopicOwnerId().observe(this, new o00OOOO0(this, 9));
        getVm().getTopicManagerIds().observe(this, new o00O00O(this, 4));
        getVm().getTopDyId().observe(this, new p142o00OOooO.o00O0O(this, 8));
        getVm().getTopDyIdRefresh().observe(this, new o0o0Oo(this, i));
        getVm().getDeletePostId().observe(this, new o00OOOOo(this, i));
        LiveEventBus.get("MOMENT_EDIT_SEND_SUCCESS", cls).observe(this, new p142o00OOooO.o0OOO0o(this, 11));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: initObserve$lambda-0, reason: not valid java name */
    public static final void m410initObserve$lambda0(TopicPostPopularFragment this$0, MomentDetailModel momentDetailModel) {
    ...
    public static final void m411initObserve$lambda1(TopicPostPopularFragment this$0, Long l) {
    ...
    public static final void m412initObserve$lambda2(TopicPostPopularFragment this$0, Long l) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public static final void m413initObserve$lambda3(TopicPostPopularFragment this$0, ArrayList it) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        p563o0oOo0.o00000OO adapter = this$0.getAdapter();
    ...
    public static final void m414initObserve$lambda5(TopicPostPopularFragment this$0, Long l) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        if (l != null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: initObserve$lambda-6, reason: not valid java name */
    public static final void m415initObserve$lambda6(TopicPostPopularFragment this$0, Long it) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        p563o0oOo0.o00000OO adapter = this$0.getAdapter();
        Intrinsics.checkNotNullExpressionValue(it, "it");
        adapter.f44995OooO0o0 = it.longValue();
        this$0.loadTopicPost(true);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: initObserve$lambda-8, reason: not valid java name */
    public static final void m416initObserve$lambda8(TopicPostPopularFragment this$0, Long l) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: initObserve$lambda-9, reason: not valid java name */
    public static final void m417initObserve$lambda9(TopicPostPopularFragment this$0, Long it) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    private final void initView() {
        ...
        getBinding().f49531OooO0OO.setOnRefreshListener(new p142o00OOooO.OooOo00(this, 4));
        ...
        getAdapter().setOnLoadMoreListener(new p466o0OooO0.o00000(this), getBinding().f49530OooO0O0);
    ...
    public static final void m418initView$lambda10(TopicPostPopularFragment this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public static final void m419initView$lambda12(TopicPostPopularFragment this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public final void loadTopicPost(boolean isRefresh) {
        ...
        getVm().topicMomentListHot(this.topicId, this.dateSort, this.pageIndex).observe(getViewLifecycleOwner(), new o0o0000.OooOo(null, null, new OooO0OO(isRefresh, this), false, 11));
    }

    private final void squareSingle4Edited(long postId) {
        MomentVM.momentDetail$default(getVm(), String.valueOf(postId), 0, 2, null).observe(this, new o0o0000.OooOo(new OooO0o(postId), null, null, false, 14));
    }
