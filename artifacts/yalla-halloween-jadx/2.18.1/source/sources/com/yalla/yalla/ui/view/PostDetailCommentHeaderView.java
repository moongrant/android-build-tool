...
public final class PostDetailCommentHeaderView extends LinearLayout implements o00Oo00.OooO00o {
    ...
    @Nullable
    public o00Oo0 f25058OoooO0;

    /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
    @Nullable
    public o00Oo00.OooO0OO<Integer> f25059OoooO00;
    ...
    public static final class OooO00o extends o00Oo0 {
        ...
        public final void OooO00o(@NotNull View view) {
            ...
            PostDetailCommentHeaderView.this.onClickNotDouble(view);
        }
    }

    @JvmOverloads
    public PostDetailCommentHeaderView(@Nullable Context context) {
        this(context, null, 0, 6, null);
    }

    @JvmOverloads
    public PostDetailCommentHeaderView(@Nullable Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, 0, 4, null);
    }

    public /* synthetic */ PostDetailCommentHeaderView(Context context, AttributeSet attributeSet, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public o00Oo0 getNoDoubleClickListener() {
        if (this.f25058OoooO0 == null) {
            this.f25058OoooO0 = new OooO00o();
        }
        o00Oo0 o00oo1 = this.f25058OoooO0;
    ...
    public final void onClickNotDouble(@NotNull View view) {
        ...
        if (id == R.id.image || id == R.id.name) {
            int i = this.f25054Oooo == 0 ? 1 : 0;
            this.f25054Oooo = i;
            OooO00o(i);
            o00Oo00.OooO0OO<Integer> oooO0OO = this.f25059OoooO00;
            if (oooO0OO != null) {
                oooO0OO.OooO00o(Integer.valueOf(this.f25054Oooo));
            }
        }
    }

    public final void setListener(@Nullable o00Oo00.OooO0OO<Integer> listener) {
        this.f25059OoooO00 = listener;
    }
    ...
    public final void setNoDoubleClickListener(@Nullable o00Oo0 mNoDoubleClickListener) {
        this.f25058OoooO0 = mNoDoubleClickListener;
    }

    @JvmOverloads
    public PostDetailCommentHeaderView(@Nullable Context context, @Nullable AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        View.inflate(getContext(), R.layout.item_post_detail_comment_header, this);
