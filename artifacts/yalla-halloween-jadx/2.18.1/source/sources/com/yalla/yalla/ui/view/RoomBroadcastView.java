...
import p601o0oo00Oo.o0OOooO0;
import p649o0ooOOoo.pg;

/* JADX INFO: loaded from: classes3.dex */
@StabilityInferred(parameters = 0)
@Metadata(bv = {}, d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0004\b\u0007\u0018\u00002\u00020\u0001B'\b\u0007\u0012\u0006\u0010\u0007\u001a\u00020\u0006\u0012\n\b\u0002\u0010\t\u001a\u0004\u0018\u00010\b\u0012\b\b\u0002\u0010\u000b\u001a\u00020\n¢\u0006\u0004\b\f\u0010\rJ\u0010\u0010\u0005\u001a\u00020\u00042\b\u0010\u0003\u001a\u0004\u0018\u00010\u0002¨\u0006\u000e"}, d2 = {"Lcom/yalla/yalla/ui/view/RoomBroadcastView;", "Landroidx/constraintlayout/widget/ConstraintLayout;", "Lo0oOOoOO/oO0OOo0o;", "mRoomBroadcastNewAnimation", "", "setRoomBroadcastNewAnimation", "Landroid/content/Context;", d.R, "Landroid/util/AttributeSet;", "attrs", "", "defStyle", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "app_YallaRelease"}, k = 1, mv = {1, 7, 1})
public final class RoomBroadcastView extends ConstraintLayout {

    /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
    public static final /* synthetic */ int f25101OoooO00 = 0;

    /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
    @Nullable
    public oO0OOo0o f25102Oooo;

    /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
    @NotNull
    public final pg f25103Oooo0o;

    /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
    @Nullable
    public RoomBroadcastModel f25104Oooo0oO;

    /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
    public final int f25105Oooo0oo;
    ...
    public static final class OooO00o extends Lambda implements Function0<Unit> {
        ...
        public final Unit invoke() {
            ...
            int i = RoomBroadcastView.f25101OoooO00;
            Objects.requireNonNull(roomBroadcastView);
            o00O00.OooO0O0("toClick data = " + roomBroadcastView.f25104Oooo0oO);
            RoomBroadcastModel roomBroadcastModel = roomBroadcastView.f25104Oooo0oO;
            if (roomBroadcastModel != null) {
                ...
                switch (roomBroadcastModel.getType()) {
                    ...
                    case 21:
                    case 22:
                        o00O00.OooO0O0("showGiftRoomSelectPop \ndata = " + roomBroadcastModel + "\nloginInformation = " + o000O00O.OooO().f32430Oooo0oo + "\nroomConfiguration = " + o000O00O.OooO().f32427Oooo);
    ...
    public final void clearAnimation() {
        this.f25103Oooo0o.f50326OooO00o.clearAnimation();
    }

    public final void setRoomBroadcastNewAnimation(@Nullable oO0OOo0o mRoomBroadcastNewAnimation) {
        this.f25102Oooo = mRoomBroadcastNewAnimation;
    }
    ...
    public RoomBroadcastView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        pg pgVarInflate = pg.inflate(LayoutInflater.from(context), this, true);
        Intrinsics.checkNotNullExpressionValue(pgVarInflate, "inflate(LayoutInflater.from(context), this, true)");
        this.f25103Oooo0o = pgVarInflate;
        this.f25105Oooo0oo = 5000;
        pgVarInflate.f50327OooO0O0.setGoListener(new OooO00o());
    }
}
