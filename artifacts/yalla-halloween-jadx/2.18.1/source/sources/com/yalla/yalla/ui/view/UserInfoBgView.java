...
public final class UserInfoBgView extends AppCompatImageView {
    ...
    private final void setKaVipBackgroundResource(int kaVipLevel) {
        if (kaVipLevel == VipLevel.Vip1.getValue()) {
            setBackgroundResource(R.drawable.room_user_info_dialog_identity_ka_vip_1);
            return;
        }
        if (kaVipLevel == VipLevel.Vip2.getValue()) {
            setBackgroundResource(R.drawable.room_user_info_dialog_identity_ka_vip_2);
            return;
        }
        if (kaVipLevel == VipLevel.Vip3.getValue()) {
            setBackgroundResource(R.drawable.room_user_info_dialog_identity_ka_vip_3);
            return;
        }
        if (kaVipLevel == VipLevel.Vip4.getValue()) {
            setBackgroundResource(R.drawable.room_user_info_dialog_identity_ka_vip_4);
        } else if (kaVipLevel == VipLevel.Vip5.getValue()) {
            setBackgroundResource(R.drawable.room_user_info_dialog_identity_ka_vip_5);
        } else {
            setVisibility(8);
        }
    }
    ...
    private final void setVipBackgroundResource(int vipLevel) {
        if (vipLevel == PremiumLevel.Premium3.getValue()) {
            setBackgroundResource(R.drawable.room_user_info_dialog_identity_aristocrat_3);
            return;
        }
        if (vipLevel == PremiumLevel.Premium4.getValue()) {
            setBackgroundResource(R.drawable.room_user_info_dialog_identity_aristocrat_4);
        } else if (vipLevel == PremiumLevel.Premium5.getValue()) {
            setBackgroundResource(R.drawable.room_user_info_dialog_identity_aristocrat_5);
        } else {
            setVisibility(8);
        }
    }
