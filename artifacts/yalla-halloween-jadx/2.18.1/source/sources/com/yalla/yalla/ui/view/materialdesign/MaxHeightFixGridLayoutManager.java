...
public final class MaxHeightFixGridLayoutManager extends FixGridLayoutManager {
    ...
    public int f25236OoooOO0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MaxHeightFixGridLayoutManager(@NotNull Context context) {
        super(context, 3);
        Intrinsics.checkNotNullParameter(context, "context");
        this.f25236OoooOO0 = OooOo00.OooO00o(316);
    }
    ...
    public final void setMeasuredDimension(@Nullable Rect rect, int i, int i2) {
        super.setMeasuredDimension(rect, i, View.MeasureSpec.makeMeasureSpec(this.f25236OoooOO0, Integer.MIN_VALUE));
    }
