...
@Metadata(bv = {}, d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0004\u001a\b\u0012\u0004\u0012\u00028\u00000\u0002\"\u0006\b\u0000\u0010\u0000\u0018\u0001*\u00020\u0001H\u008a@¨\u0006\u0003"}, d2 = {"T", "Lkotlinx/coroutines/CoroutineScope;", "Lcom/yalla/yalla/common/model/ApiResult;", "com/yalla/yalla/api/call/NewApiClient$CommonRequest$callByOldModel$2", "<anonymous>"}, k = 3, mv = {1, 7, 1})
...
public final class MainRoomExploreViewModel$loadCountryHotSort$1$invokeSuspend$$inlined$callByOldModel$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<CountryTagModel>>, Object> {

    /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
    public int f25481Oooo0o;

    /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
    public final /* synthetic */ o00O000o f25482Oooo0oO;

    public static final class OooO00o extends o00000O0<CountryTagModel> {
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MainRoomExploreViewModel$loadCountryHotSort$1$invokeSuspend$$inlined$callByOldModel$1(o00O000o o00o000o2, Continuation continuation) {
        super(2, continuation);
        this.f25482Oooo0oO = o00o000o2;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new MainRoomExploreViewModel$loadCountryHotSort$1$invokeSuspend$$inlined$callByOldModel$1(this.f25482Oooo0oO, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ApiResult<CountryTagModel>> continuation) {
        return ((MainRoomExploreViewModel$loadCountryHotSort$1$invokeSuspend$$inlined$callByOldModel$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f25481Oooo0o;
        Object obj2 = null;
        String str = "";
        try {
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                o00O000o o00o000o2 = this.f25482Oooo0oO;
            ...
            CountryTagModel countryTagModel = (CountryTagModel) obj2;
            ...
            apiResult.setData(countryTagModel);
            return apiResult;
        } catch (IOException e) {
