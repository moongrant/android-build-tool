...
@Metadata(bv = {}, d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\b\u0007\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u000e\u0010\u000fJ \u0010\u0007\u001a\u000e\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\u00030\u0005*\u00020\u00022\u0006\u0010\u0004\u001a\u00020\u0003H\u0002R\u0016\u0010\u0004\u001a\u00020\u00038\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0004\u0010\bR\u001d\u0010\n\u001a\b\u0012\u0004\u0012\u00020\u00020\t8\u0006¢\u0006\f\n\u0004\b\n\u0010\u000b\u001a\u0004\b\f\u0010\r¨\u0006\u0010"}, d2 = {"Lcom/yalla/yalla/ui/vm/room/RoomEventHistoryViewModel;", "Lo00OO/OooO00o;", "Lcom/yalla/yalla/model/EventModel;", "", "lastNodeTime", "Lkotlin/Pair;", "", "filterMarkTimeNode", "Ljava/lang/String;", "Lo0ooO00/o000O0;", "eventHistoryPager", "Lo0ooO00/o000O0;", "getEventHistoryPager", "()Lo0ooO00/o000O0;", "<init>", "()V", "app_YallaRelease"}, k = 1, mv = {1, 7, 1})
public final class RoomEventHistoryViewModel extends o00OO.OooO00o {
    ...
    @NotNull
    private final o000O0<EventModel> eventHistoryPager = new o000O0<>(ViewModelKt.getViewModelScope(this), new OooO00o(null));
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<Integer, Continuation<? super o000OO0O<EventModel>>, Object> {
        ...
        public int f26095Oooo0o;

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public /* synthetic */ int f26096Oooo0oO;
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            ...
            oooO00o.f26096Oooo0oO = ((Number) obj).intValue();
            return oooO00o;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f26095Oooo0o;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                int i2 = this.f26096Oooo0oO;
                if (i2 == 1) {
                    RoomEventHistoryViewModel.this.lastNodeTime = "";
                }
                o000O o000o = o000O.f42441OooO00o;
                long id = o000O00O.OooO().f32429Oooo0oO.getId();
                this.f26095Oooo0o = 1;
                obj = o000o.OooO00o(id, i2, this);
    ...
    public final Pair<Boolean, String> filterMarkTimeNode(EventModel eventModel, String str) {
        String strOooO0OO = o00O0.f48624OooO00o.OooO0OO(eventModel.getEventStartTime(), "dd/MM yyyy");
    ...
    @NotNull
    public final o000O0<EventModel> getEventHistoryPager() {
