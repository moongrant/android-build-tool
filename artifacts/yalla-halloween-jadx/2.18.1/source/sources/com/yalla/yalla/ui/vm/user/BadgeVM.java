...
@Metadata(bv = {}, d1 = {"\u0000@\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010!\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u000b\b\u0007\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0006\u001a\u00020\u0005¢\u0006\u0004\b!\u0010\"J\b\u0010\u0003\u001a\u00020\u0002H\u0002J\u0006\u0010\u0004\u001a\u00020\u0002R\u0014\u0010\u0006\u001a\u00020\u00058\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0006\u0010\u0007R#\u0010\u000b\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\n0\t0\b8\u0006¢\u0006\f\n\u0004\b\u000b\u0010\f\u001a\u0004\b\r\u0010\u000eR%\u0010\u0010\u001a\u0010\u0012\f\u0012\n\u0012\u0004\u0012\u00020\u000f\u0018\u00010\t0\b8\u0006¢\u0006\f\n\u0004\b\u0010\u0010\f\u001a\u0004\b\u0011\u0010\u000eR%\u0010\u0012\u001a\u0010\u0012\f\u0012\n\u0012\u0004\u0012\u00020\u000f\u0018\u00010\t0\b8\u0006¢\u0006\f\n\u0004\b\u0012\u0010\f\u001a\u0004\b\u0013\u0010\u000eR\u0017\u0010\u0015\u001a\u00020\u00148\u0006¢\u0006\f\n\u0004\b\u0015\u0010\u0016\u001a\u0004\b\u0015\u0010\u0017R%\u0010\u001a\u001a\u0010\u0012\f\u0012\n \u0019*\u0004\u0018\u00010\u00180\u00180\b8\u0006¢\u0006\f\n\u0004\b\u001a\u0010\f\u001a\u0004\b\u001b\u0010\u000eR%\u0010\u001c\u001a\u0010\u0012\f\u0012\n \u0019*\u0004\u0018\u00010\u00180\u00180\b8\u0006¢\u0006\f\n\u0004\b\u001c\u0010\f\u001a\u0004\b\u001d\u0010\u000eR\u0017\u0010\u001e\u001a\u00020\u00058\u0006¢\u0006\f\n\u0004\b\u001e\u0010\u0007\u001a\u0004\b\u001f\u0010 ¨\u0006#"}, d2 = {"Lcom/yalla/yalla/ui/vm/user/BadgeVM;", "Lo00OO/OooO00o;", "", "requestBadgeBannerRankTop", "requestBadgeInfo", "", "userId", "J", "Landroidx/lifecycle/MutableLiveData;", "", "Lcom/yalla/yalla/model/BadgeBannerModel;", "medalBannerRank", "Landroidx/lifecycle/MutableLiveData;", "getMedalBannerRank", "()Landroidx/lifecycle/MutableLiveData;", "Lcom/yalla/yalla/model/BadgeDataModel;", "achievementList", "getAchievementList", "honorList", "getHonorList", "", "isFromMe", "Z", "()Z", "", "kotlin.jvm.PlatformType", "currentStar", "getCurrentStar", "currentRank", "getCurrentRank", "currentId", "getCurrentId", "()J", "<init>", "(J)V", "app_YallaRelease"}, k = 1, mv = {1, 7, 1})
public final class BadgeVM extends o00OO.OooO00o {
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f26188Oooo0o;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                OooOOO0 oooOOO0 = OooOOO0.f42243OooO00o;
                this.f26188Oooo0o = 1;
                obj = oooOOO0.OooO00o(this);
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f26190Oooo0o;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                OooOOO0 oooOOO0 = OooOOO0.f42243OooO00o;
                long j = BadgeVM.this.userId;
                this.f26190Oooo0o = 1;
                obj = oooOOO0.OooO0O0(j, this);
                if (obj == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
            ...
            if (apiResult.isSuccess()) {
                ...
                MutableLiveData<Boolean> mutableLiveDataOooOO0o = OooOOO.f41216OooO00o.OooOO0o();
                BadgeModel badgeModel5 = (BadgeModel) apiResult.getData();
                mutableLiveDataOooOO0o.postValue(badgeModel5 != null ? badgeModel5.getOpenDiamondMedal() : null);
            }
            return Unit.INSTANCE;
        }
    }
