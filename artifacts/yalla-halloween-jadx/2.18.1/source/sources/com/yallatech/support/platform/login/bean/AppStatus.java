...
public final /* data */ class AppStatus {
    ...
    public int hashCode() {
        return o0O0O00.OooO00o(this.appIcon, o0O0O00.OooO00o(this.appName, this.status * 31, 31), 31) + this.shareStatus;
    }

    @NotNull
    public String toString() {
        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("AppStatus(status=");
        sbOooO0o0.append(this.status);
        sbOooO0o0.append(", appName=");
        sbOooO0o0.append(this.appName);
        sbOooO0o0.append(", appIcon=");
        sbOooO0o0.append(this.appIcon);
        sbOooO0o0.append(", shareStatus=");
        return o0O0ooO.OooO00o(sbOooO0o0, this.shareStatus, ')');
    }
