...
public class Banner<T, BA extends BannerAdapter> extends FrameLayout implements BannerLifecycleObserver {
    ...
    private void initTypedArray(@NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        this.mDelayTime = typedArrayObtainStyledAttributes.getInt(R.styleable.Banner_delay_time, BannerConfig.LOOP_TIME);
        this.mIsAutoLoop = typedArrayObtainStyledAttributes.getBoolean(R.styleable.Banner_is_auto_loop, true);
        this.mIsInfiniteLoop = typedArrayObtainStyledAttributes.getBoolean(R.styleable.Banner_is_infinite_loop, true);
        this.normalWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.Banner_indicator_normal_width, BannerConfig.INDICATOR_NORMAL_WIDTH);
        this.selectedWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.Banner_indicator_selected_width, BannerConfig.INDICATOR_SELECTED_WIDTH);
        this.normalColor = typedArrayObtainStyledAttributes.getColor(R.styleable.Banner_indicator_normal_color, BannerConfig.INDICATOR_NORMAL_COLOR);
        this.selectedColor = typedArrayObtainStyledAttributes.getColor(R.styleable.Banner_indicator_selected_color, BannerConfig.INDICATOR_SELECTED_COLOR);
        this.indicatorGravity = typedArrayObtainStyledAttributes.getInt(R.styleable.Banner_indicator_gravity, 1);
        this.indicatorSpace = typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.Banner_indicator_space, 0);
        this.indicatorMargin = typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.Banner_indicator_margin, 0);
        this.indicatorMarginLeft = typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.Banner_indicator_marginLeft, 0);
        this.indicatorMarginTop = typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.Banner_indicator_marginTop, 0);
        this.indicatorMarginRight = typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.Banner_indicator_marginRight, 0);
        this.indicatorMarginBottom = typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.Banner_indicator_marginBottom, 0);
        this.indicatorHeight = typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.Banner_indicator_height, BannerConfig.INDICATOR_HEIGHT);
        this.indicatorRadius = typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.Banner_indicator_radius, BannerConfig.INDICATOR_RADIUS);
    ...
    public Banner addItemDecoration(@NonNull RecyclerView.OooOo oooOo) {
        getViewPager2().addItemDecoration(oooOo);
        return this;
    }
    ...
    public void destroy() {
        Banner<T, BA>.BannerOnPageChangeCallback bannerOnPageChangeCallback;
        ViewPager2 viewPager2 = this.mViewPager2;
        if (viewPager2 != null && (bannerOnPageChangeCallback = this.mPageChangeCallback) != null) {
    ...
    public void dispatchDraw(Canvas canvas) {
        if (this.mBannerRadius > ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE) {
            Path path = new Path();
    ...
    public Banner setIndicatorNormalColorRes(@ColorRes int i) {
        setIndicatorNormalColor(OooO00o.OooO0O0(getContext(), i));
        return this;
    }
    ...
    public Banner setIndicatorSelectedColorRes(@ColorRes int i) {
        setIndicatorSelectedColor(OooO00o.OooO0O0(getContext(), i));
        return this;
    }
    ...
    public Banner addItemDecoration(@NonNull RecyclerView.OooOo oooOo, int i) {
        getViewPager2().addItemDecoration(oooOo, i);
        return this;
    }
    ...
    public Banner setIndicator(@NonNull Indicator indicator, boolean z) {
        removeIndicator();
    ...
    public Banner(@NonNull Context context, @NonNull AttributeSet attributeSet, int i) {
        ...
        this.mBannerRadius = ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
        this.isIntercept = true;
        this.mAdapterDataObserver = new RecyclerView.OooOOO() { // from class: com.youth.banner.Banner.1
