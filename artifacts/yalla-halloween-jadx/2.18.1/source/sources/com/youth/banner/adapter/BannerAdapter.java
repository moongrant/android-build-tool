...
public abstract class BannerAdapter<T, VH extends RecyclerView.oo0o0Oo> extends RecyclerView.Adapter<VH> implements IViewHolder<T, VH> {
    ...
    public final void onBindViewHolder(@NonNull VH vh, int i) {
        ...
        if (this.mOnBannerListener != null) {
            vh.itemView.setOnClickListener(new View.OnClickListener() { // from class: o0ooO000.Oooo000
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f48698Oooo0o.lambda$onBindViewHolder$0(realPosition, view);
                }
            });
        }
    }
