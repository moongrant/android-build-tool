...
public class AudioEventMonitor extends BroadcastReceiver {
    ...
    public boolean _speaker_phone_on = true;
    ...
    public class AudioRoutChange extends AudioDeviceCallback implements AudioRouting.OnRoutingChangedListener {
        ...
        public void onAudioDevicesAdded(AudioDeviceInfo[] audioDeviceInfoArr) {
            ...
            try {
                ...
                StringBuilder sbOooO0o0 = OooO00o.OooO0o0("onAudioDevicesAdded ");
                sbOooO0o0.append(e.toString());
                Log.w("device", sbOooO0o0.toString());
            }
        }
        ...
        public void onAudioDevicesRemoved(AudioDeviceInfo[] audioDeviceInfoArr) {
            try {
                ...
                StringBuilder sbOooO0o0 = OooO00o.OooO0o0("onAudioDevicesRemoved ");
                sbOooO0o0.append(e.toString());
                Log.w("device", sbOooO0o0.toString());
            }
        }
    ...
    private void InitAudioFocusChangeListener() {
        ...
        try {
            ...
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("trace request audio focus failed, ");
            sbOooO0o0.append(th.getMessage());
            Log.e("device", sbOooO0o0.toString());
    ...
    public int SetBluetoothScoOn(boolean z) {
        ...
        try {
            ...
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("setBluetoothScoOn failed, ");
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        StringBuilder sbOooO00o = Oooo0.OooO00o("action: ", action);
        if (extras == null || extras.size() <= 0) {
            string = "";
        } else {
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0(", ");
            sbOooO0o0.append(extras.toString());
            string = sbOooO0o0.toString();
        }
        sbOooO00o.append(string);
        Log.i("device", "onReceive " + sbOooO00o.toString());
