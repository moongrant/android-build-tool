...
public class VCam implements Handler.Callback {
    ...
    public float mExposureCompensation = ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
    public float mFocusPointX = ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
    public float mFocusPointY = ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
    public float mExposurePointX = ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
    public float mExposurePointY = ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
            ...
            try {
                ...
                CameraAvailabilityCallback cameraAvailabilityCallback = new CameraAvailabilityCallback(this.mThis, new CameraAvailabilityCallback.Listener() { // from class: com.zego.ve.VCam.1
                    ...
                    public void onCameraAvailable(long j, String str) {
                        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("trace interruption this: ");
                        sbOooO0o0.append(VCam.this);
                        sbOooO0o0.append(", cameraId: ");
                        sbOooO0o0.append(str);
                        sbOooO0o0.append(" available, mUseCameraId: ");
                        sbOooO0o0.append(VCam.this.mUseCameraId);
                        Log.i(VCam.TAG, sbOooO0o0.toString());
                    ...
                    public void onCameraUnavailable(long j, String str) {
                        ...
                        sbOooO0o0.append(", cameraId: ");
                        sbOooO0o0.append(str);
                        sbOooO0o0.append(" unavailable, mUseCameraId: ");
                        sbOooO0o0.append(VCam.this.mUseCameraId);
                        Log.i(VCam.TAG, sbOooO0o0.toString());
    ...
    public int createCam(int i, int i2, boolean z) {
        ...
        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("vcap -- board: ");
        sbOooO0o0.append(Build.BOARD);
        ...
        sbOooO0o0.append(" sdk: ");
        sbOooO0o0.append(Build.VERSION.SDK_INT);
        sbOooO0o0.append(" cameraid:");
        sbOooO0o0.append(i);
        android.util.Log.i(TAG, sbOooO0o0.toString());
        if (this.mCam != null) {
            return 0;
        }
        ...
        try {
            ...
            StringBuilder sbOooO0o1 = OooO00o.OooO0o0("trace interruption open ");
            sbOooO0o1.append(GetCameraString(i));
            sbOooO0o1.append(" failed, ");
            sbOooO0o1.append(e);
        ...
        if (this.mCam == null) {
            ...
            try {
                ...
                StringBuilder sbOooO0o2 = OooO00o.OooO0o0("trace interruption open ");
                sbOooO0o2.append(GetCameraString(this.mBackCameraId));
                sbOooO0o2.append(" failed, ");
                sbOooO0o2.append(e2);
                Log.e(TAG, sbOooO0o2.toString());
                this.mCam = null;
            }
            if (this.mCam == null) {
                android.util.Log.e(TAG, "vcap: no camera found");
        ...
        if (supportedVideoSizes != null) {
            ...
            for (Camera.Size size : supportedVideoSizes) {
                StringBuilder sbOooO0o3 = OooO00o.OooO0o0("vcap: support size -- ");
                sbOooO0o3.append(size.width);
                sbOooO0o3.append("x");
                sbOooO0o3.append(size.height);
                android.util.Log.i(TAG, sbOooO0o3.toString());
                int i8 = size.width;
                int i9 = size.height;
                if (i8 * i9 > i5 * i6 && (i8 * 3 == i9 * 4 || i8 * 9 == i9 * 16)) {
                    i6 = i9;
                    i5 = i8;
                }
            }
                    ...
                    if (i11 % 16 == 0 && (!z3 || preferredPreviewSizeForVideo.height * i10 == preferredPreviewSizeForVideo.width * i11)) {
                        ...
                        if (i10 < i12 || i11 < (i7 = this.mHeight)) {
                            if (i10 < i12) {
                                ...
                                if (i11 >= i13 && (i3 < i12 || i4 < i13)) {
                                    if ((i3 < i12 && i4 < i13) || ((i4 >= i13 && i10 > i3) || i10 * i11 > i3 * i4)) {
                                        i4 = i11;
                                        i3 = i10;
                                    }
                                }
                            } else if (i3 < i12 || i4 < this.mHeight) {
                                if ((i3 < i12 && i4 < this.mHeight) || ((i3 >= i12 && i11 > i4) || i10 * i11 > i3 * i4)) {
                                    i4 = i11;
                                    i3 = i10;
                                }
                            }
                        } else if (i3 < i12 || i4 < i7 || i10 * i11 < i3 * i4) {
                            i4 = i11;
                            i3 = i10;
                        }
                    }
        ...
        if (i3 * i4 != 0) {
            ...
            this.mParams.setPreviewSize(i5, i6);
            this.mWidth = i5;
            this.mHeight = i6;
        } else {
        ...
        StringBuilder sbOooO0o4 = OooO00o.OooO0o0("vcap: preview size -- perferred:");
        sbOooO0o4.append(preferredPreviewSizeForVideo == null ? 0 : preferredPreviewSizeForVideo.width);
        sbOooO0o4.append("x");
        sbOooO0o4.append(preferredPreviewSizeForVideo == null ? 0 : preferredPreviewSizeForVideo.height);
        sbOooO0o4.append(", candidate:");
        sbOooO0o4.append(i3);
        sbOooO0o4.append("x");
        sbOooO0o4.append(i4);
        sbOooO0o4.append(", preview:");
        sbOooO0o4.append(this.mWidth);
        sbOooO0o4.append("x");
        sbOooO0o4.append(this.mHeight);
        android.util.Log.i(TAG, sbOooO0o4.toString());
        if (this.mFPSMode != 0) {
        ...
        try {
            ...
            StringBuilder sbOooO0o5 = OooO00o.OooO0o0("vcap: set camera parameters error with exception width:");
            sbOooO0o5.append(this.mParams.getPreviewSize().width);
            sbOooO0o5.append(" height:");
            sbOooO0o5.append(this.mParams.getPreviewSize().height);
            sbOooO0o5.append(".");
            android.util.Log.e(TAG, sbOooO0o5.toString());
            e3.printStackTrace();
            this.mCam.release();
            this.mCam = null;
            if (this.mNeedHack) {
    ...
    public int doSetExposureCompensation(float f, Camera.Parameters parameters) {
        int minExposureCompensation = (int) ((f < ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE ? parameters.getMinExposureCompensation() * (-1) : parameters.getMaxExposureCompensation()) * f);
        try {
    ...
    public int doSetExposurePoint(float f, float f2, Camera.Parameters parameters) {
        ...
        arrayList.add(new Camera.Area(rectCalculateArea, 800));
        try {
    ...
    /* JADX WARN: Code duplicated, block: B:21:0x002a  */
    ...
    public void setZoomFactor(float f) {
        if (this.mCam != null && this.mParams.isZoomSupported()) {
            ...
            int i2 = 0;
            if (i != 100) {
                for (int i3 = 1; i3 < zoomRatios.size(); i3++) {
    ...
    public int startCam(boolean z) {
        ...
        if (this.mSceneMode != 0 && (supportedSceneModes = this.mParams.getSupportedSceneModes()) != null) {
            ...
            try {
                ...
                Log.i(TAG, "vcap: set scene mode " + str);
                str2 = str;
                z2 = true;
            } catch (Exception e) {
            ...
            if (!z2 && supportedSceneModes.contains(str2)) {
                try {
                    this.mParams.setSceneMode(str2);
                    Log.i(TAG, "vcap: set scene mode " + str2);
                } catch (Exception e2) {
                    Log.e(TAG, "vcap: set scene mode failed");
                    e2.printStackTrace();
                }
    ...
    public int updateRate(int i, Camera.Parameters parameters) {
        ...
        if (supportedPreviewFpsRange != null) {
            ...
            if (this.mLowLightBoost) {
                ...
                for (int[] iArr : supportedPreviewFpsRange) {
                    if (iArr[1] >= i4) {
                        if (i2 < i4 || iArr[1] < i2 || (iArr[1] == i2 && iArr[0] < i3)) {
                            i3 = iArr[0];
                            i2 = iArr[1];
                        }
                    } else if (iArr[1] > i2 || (iArr[1] == i2 && iArr[0] < i3)) {
                        i3 = iArr[0];
                        i2 = iArr[1];
                    }
                }
                ...
                for (int[] iArr2 : supportedPreviewFpsRange) {
                    if (iArr2[1] >= i4) {
                        if (i2 < i4 || iArr2[1] < i2 || (iArr2[1] == i2 && iArr2[0] > i3)) {
                            i3 = iArr2[0];
                            i2 = iArr2[1];
                        }
                    } else if (iArr2[1] > i2 || (iArr2[1] == i2 && iArr2[0] > i3)) {
                        i3 = iArr2[0];
                        i2 = iArr2[1];
                    }
                }
        ...
        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("real fps:| ");
        sbOooO0o0.append(iArr3[0]);
        sbOooO0o0.append("|");
        sbOooO0o0.append(iArr3[1]);
        sbOooO0o0.append("|");
        Log.i(TAG, sbOooO0o0.toString());
        return 0;
    }
}
