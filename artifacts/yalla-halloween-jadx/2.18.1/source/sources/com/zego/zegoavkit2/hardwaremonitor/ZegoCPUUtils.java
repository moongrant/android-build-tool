...
public class ZegoCPUUtils {
    ...
    private float appCpuUseTimeLast = ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
    private float appCpuUsage = ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
    private long sysCpuTotalTimeLast = 0;
    private long sysCpuIdelTimeLast = 0;
    private float sysCpuUsage = ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
