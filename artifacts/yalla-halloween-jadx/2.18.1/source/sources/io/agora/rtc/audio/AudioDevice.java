...
class AudioDevice {
    ...
    private boolean EnableBuiltInAEC(boolean z) {
        ...
        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("AcousticEchoCanceler.getEnabled: ");
        sbOooO0o0.append(this.aec.getEnabled());
        Logging.e("AudioDevice Java", sbOooO0o0.toString());
        return true;
    }
    ...
    private int InitPlayback(int i, int i2, int i3, int i4) {
        ...
        StringBuilder sbOooO0O0 = o000O0Oo.OooO0O0("Java minimum playback buffer size is ", minBufferSize, ", profiledMiniOutBufferSize is ", i5, " stream type ");
        sbOooO0O0.append(this._streamType);
        Logging.d("AudioDevice Java", sbOooO0O0.toString());
        int i6 = minBufferSize < i5 ? i5 : minBufferSize;
        this._bufferedPlaySamples = 0;
        this._currentTotalPostion = 0L;
        StringBuilder sbOooO00o = o00000O0.OooO00o("Java playback buffer size is ", i6, ", duration is ");
        sbOooO00o.append((i6 * 1000) / ((i * i2) * 2));
        sbOooO00o.append(" ms");
        ...
        try {
            ...
            if (acousticEchoCancelerCreate == null) {
                ...
                if (descriptor == null) {
                    ...
                    StringBuilder sbOooO0o0 = OooO00o.OooO0o0("AcousticEchoCanceler name: ");
                    sbOooO0o0.append(descriptor.name);
                    sbOooO0o0.append(", implementor: ");
                    sbOooO0o0.append(descriptor.implementor);
                    sbOooO0o0.append(", uuid: ");
                    sbOooO0o0.append(descriptor.uuid);
                    Logging.d("AudioDevice Java", sbOooO0o0.toString());
                }
    ...
    private int PlayNoBlockAudio(int i) {
        ...
        if (i2 < 23) {
            Logging.e("AudioDevice Java", "Play failed,  SDK_INT " + i2);
            return -2;
        }
        this._playLock.lock();
        try {
            try {
                ...
                while (this._isPlaying) {
                    int iWrite = this._audioTrack.write(this._tempBufPlay, i4, i3, 1);
                    if (iWrite < 0) {
                        if (this._playbackRestartCount <= 20) {
                            Logging.e("AudioDevice Java", "Error writing AudioTrack! Restart AudioTrack " + i4);
                            this._playbackRestartCount = this._playbackRestartCount + 1;
                            this._audioTrack.stop();
                            this._audioTrack.release();
                            this._audioTrack = null;
                ...
                int i5 = i4 >> 1;
                this._bufferedPlaySamples += i5;
                this.playWriten += i4;
                this._currentTotalPostion += (long) (i5 / this._playChannel);
                if (Build.VERSION.SDK_INT >= 24) {
                    long jNanoTime = (System.nanoTime() / 1000) / 1000;
                    this.current_time_ms = jNanoTime;
                    if (jNanoTime - this.previous_time_ms >= 50) {
                ...
                long[] jArr = this._audioStatistic;
                long j2 = this._currentTotalPostion * 1000;
                int i6 = this._playbackSampleRate;
                jArr[0] = j2 / ((long) i6);
                jArr[1] = (((long) playbackHeadPosition) * 1000) / ((long) i6);
                jArr[2] = (System.nanoTime() / 1000) / 1000;
                boolean z = this._isRecording;
                return this._bufferedPlaySamples * this._playChannel;
            } finally {
        ...
        try {
            try {
                ...
                if (this._audioRecord == null) {
                    ...
                    int i4 = this._audioRecord.read(this._tempBufRec, 0, i);
                    ...
                    if (i4 >= 0) {
                        this._recPosition += (long) ((i4 / this._recordChannel) / 2);
                    }
                    long[] jArr = this._audioStatistic;
                    ...
                    if (this._recordRestartCount % 10 == 0) {
                        Logging.e("AudioDevice Java", "Error reading AudioRecord! AudioRecord.read returns " + i4);
                    }
                    int i5 = this._recordRestartCount;
                    if (i5 <= 100) {
                        this._recordRestartCount = i5 + 1;
                    ...
                    Logging.e("AudioDevice Java", "Failed to restart AudioRecord,  readBytes : " + i4);
                    this._recordRestartCount = 0;
                    i2 = -20;
                }
                return i2;
    ...
    private int SetPlayoutVolume(int i) {
        ...
        if (i < 255) {
            streamMaxVolume = (i * streamMaxVolume) / KotlinVersion.MAX_COMPONENT_VALUE;
        }
    ...
    private int StopPlayback() {
        ...
        try {
            try {
                try {
                    this._audioTrack.setVolume(ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE);
