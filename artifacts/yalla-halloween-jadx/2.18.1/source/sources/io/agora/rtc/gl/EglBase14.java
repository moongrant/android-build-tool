...
public class EglBase14 extends EglBase {
    ...
    private static EGLContext createEglContext(Context context, EGLDisplay eGLDisplay, EGLConfig eGLConfig) {
        ...
        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("Failed to create EGL context: 0x");
        sbOooO0o0.append(Integer.toHexString(EGL14.eglGetError()));
    ...
    private void createSurfaceInternal(Object obj) {
        ...
        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("Failed to create window surface: 0x");
        sbOooO0o0.append(Integer.toHexString(EGL14.eglGetError()));
        throw new RuntimeException(sbOooO0o0.toString());
    }
    ...
    private static EGLConfig getEglConfig(EGLDisplay eGLDisplay, int[] iArr) {
        ...
        if (!EGL14.eglChooseConfig(eGLDisplay, iArr, 0, eGLConfigArr, 0, 1, iArr2, 0)) {
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("eglChooseConfig failed: 0x");
            sbOooO0o0.append(Integer.toHexString(EGL14.eglGetError()));
            throw new RuntimeException(sbOooO0o0.toString());
        }
        if (iArr2[0] <= 0) {
    ...
    private static EGLDisplay getEglDisplay() {
        ...
        if (eGLDisplayEglGetDisplay == EGL14.EGL_NO_DISPLAY) {
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("Unable to get EGL14 display: 0x");
            sbOooO0o0.append(Integer.toHexString(EGL14.eglGetError()));
            throw new RuntimeException(sbOooO0o0.toString());
        }
        int[] iArr = new int[2];
        ...
        StringBuilder sbOooO0o1 = OooO00o.OooO0o0("Unable to initialize EGL14: 0x");
        sbOooO0o1.append(Integer.toHexString(EGL14.eglGetError()));
        throw new RuntimeException(sbOooO0o1.toString());
    }

    public static boolean isEGL14Supported() {
        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("SDK version: ");
        int i = CURRENT_SDK_VERSION;
        sbOooO0o0.append(i);
        sbOooO0o0.append(". isEGL14Supported: ");
        sbOooO0o0.append(i >= 18);
    ...
    public void createPbufferSurface(int i, int i2) {
        ...
        StringBuilder sbOooO0O0 = o000O0Oo.OooO0O0("Failed to create pixel buffer surface with size ", i, "x", i2, ": 0x");
        sbOooO0O0.append(Integer.toHexString(EGL14.eglGetError()));
        throw new RuntimeException(sbOooO0O0.toString());
    }
