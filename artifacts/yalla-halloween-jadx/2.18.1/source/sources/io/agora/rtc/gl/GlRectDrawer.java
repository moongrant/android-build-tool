...
public class GlRectDrawer implements RendererCommon.GlDrawer {
    ...
    private static final FloatBuffer FULL_RECTANGLE_TEX_BUF = GlUtil.createFloatBuffer(new float[]{ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, 1.0f, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, 1.0f, 1.0f, 1.0f});
    ...
    private FloatBuffer mTexCoordinate = GlUtil.createFloatBuffer(new float[]{ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, 1.0f, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, 1.0f, 1.0f, 1.0f});
    ...
    private float[] ComputeVertexAttribArray(int i, int i2, int i3, int i4) {
        ...
        if (f2 / f3 >= f) {
            ...
            float f5 = 1.0f - f4;
            return new float[]{f4, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, f5, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, f4, 1.0f, f5, 1.0f};
        }
        float f6 = ((f3 - (f2 / f)) / 2.0f) / f3;
        float f7 = 1.0f - f6;
        return new float[]{ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, f6, 1.0f, f6, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, f7, 1.0f, f7};
    }
        ...
        if (this.shaders.containsKey(str)) {
            ...
            if (YUV_FRAGMENT_SHADER_STRING.equals(str)) {
                ...
                if (!OES_FRAGMENT_SHADER_STRING.equals(str)) {
                    throw new IllegalStateException(OooOo00.OooO0Oo("Unknown fragment shader: ", str));
                }
    ...
    public void drawRgb(int i, float[] fArr, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
        ...
        prepareShader(RGB_FRAGMENT_SHADER_STRING, fArr, floatBufferCreateFloatBuffer, this.mPosCoordinate);
        GLES20.glActiveTexture(33984);
        GLES20.glBindTexture(3553, i);
        drawRectangle(i4, i5, i6, i7);
        GLES20.glBindTexture(3553, 0);
