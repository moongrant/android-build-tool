...
public class SurfaceTextureHelper {
    ...
    public static SurfaceTextureHelper create(final String str, final EglBase.Context context, final int i) {
        ...
        StringBuilder sbOooO0OO = OooO0o.OooO0OO("create thread: ", str, " id: ");
        sbOooO0OO.append(handlerThread.getThreadId());
        Logging.d(TAG, sbOooO0OO.toString());
    ...
    private SurfaceTextureHelper(final String str, EglBase.Context context, Handler handler, int i) {
        ...
        this.setListenerRunnable = new Runnable() { // from class: io.agora.rtc.gl.SurfaceTextureHelper.2
            @Override // java.lang.Runnable
            public void run() {
                StringBuilder sbOooO0o0 = OooO00o.OooO0o0("Setting listener to ");
                sbOooO0o0.append(SurfaceTextureHelper.this.pendingListener);
                Logging.i(SurfaceTextureHelper.TAG, sbOooO0o0.toString());
