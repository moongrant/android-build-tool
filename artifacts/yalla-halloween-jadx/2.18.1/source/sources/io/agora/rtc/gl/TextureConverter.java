...
public class TextureConverter {
    ...
    public static final float[] rectCoords = {-1.0f, 1.0f, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, 1.0f, 1.0f, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, -1.0f, -1.0f, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, 1.0f, -1.0f, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE};
    public static final float[] textureCoords = {ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, 1.0f, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE, 1.0f, 1.0f, 1.0f};
    ...
    private void checkFramebufferStatus() {
        ...
        if (iGlCheckFramebufferStatus != 36053) {
            ...
            StringBuilder sbOooO00o = Oooo0.OooO00o(str, " : 0x");
            sbOooO00o.append(Integer.toHexString(iGlCheckFramebufferStatus));
