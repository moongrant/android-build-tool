...
public class GLTextureView extends TextureView implements TextureView.SurfaceTextureListener, View.OnLayoutChangeListener {
    ...
    public static class GLThread extends Thread {
                    ...
                    try {
                        synchronized (GLTextureView.sGLThreadManager) {
                            while (true) {
                                ...
                                boolean z11 = this.mRequestPaused;
                                if (z10 != z11) {
                                    this.mPaused = z11;
                                ...
                                if (z11 && this.mHaveEglSurface) {
                                    stopEglSurfaceLocked();
                                }
                                if (z11 && this.mHaveEglContext) {
                                    GLTextureView gLTextureView = this.mGLSurfaceViewWeakRef.get();
                                ...
                                if (z11 && GLTextureView.sGLThreadManager.shouldTerminateEGLWhenPausing()) {
        ...
        public void run() {
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("GLThread ");
