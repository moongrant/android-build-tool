...
public abstract class VideoCapture {
    ...
    public static final int MAX_BUFFER_CNT = 8;
    ...
    public void onTextureBufferAvailable(VideoFrame.TextureBuffer textureBuffer, int i, long j) {
        ...
        if (textureBuffer == null) {
            ...
            if (i2 % 50 == 1) {
                String str = TAG;
                StringBuilder sbOooO0o0 = OooO00o.OooO0o0("Dropped texture buffer count: ");
                sbOooO0o0.append(this.mDroppedTextureBufferCount);
                Logging.w(str, sbOooO0o0.toString());
            }
