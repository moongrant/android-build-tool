...
public class VideoCaptureCamera2 extends VideoCapture implements SurfaceTextureHelper.OnTextureFrameAvailableListener {
    ...
    public VideoCaptureCamera2(Context context, int i, int i2, EglBase.Context context2, long j) {
        ...
        this.mCaptureCallback = new CameraCaptureSession.CaptureCallback() { // from class: io.agora.rtc.video.VideoCaptureCamera2.2
            ...
            private void notifyCameraFocusAreaChanged(Rect rect, Rect rect2) {
                ...
                StringBuilder sbOooO0o0 = OooO00o.OooO0o0("face bound = ");
                sbOooO0o0.append(rect2.toString());
                Logging.d(VideoCaptureCamera2.TAG, sbOooO0o0.toString());
                ...
                StringBuilder sbOooO0o1 = OooO00o.OooO0o0("preview size width = ");
                sbOooO0o1.append(VideoCaptureCamera2.this.mCaptureWidth);
                sbOooO0o1.append(" height = ");
                sbOooO0o1.append(VideoCaptureCamera2.this.mCaptureHeight);
                Logging.d(VideoCaptureCamera2.TAG, sbOooO0o1.toString());
    ...
    public static int createCapabilities(int i, Context context) {
        ...
        String strOooO00o = OooO0O0.OooO00o.OooO00o("\"id\":", i, ",");
        ...
        for (int i3 = 0; i3 < arrayList.size(); i3++) {
            ...
            if (width >= 240 && height >= 240 && (width >= 320 || height >= 320)) {
                String strOooO00o3 = Oooo0.OooO00o("{\"w\":", width, ",\"h\":", height, "}");
                strOooO00o2 = !strOooO00o2.isEmpty() ? OooO0OO.OooO00o(strOooO00o2, ",", strOooO00o3) : strOooO00o3;
            }
        }
        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("");
        sbOooO0o0.append(VideoCapture.translateToEngineFormat(35));
        String string = sbOooO0o0.toString();
        StringBuilder sbOooO00o = o00oOoo.OooO00o("{", strOooO00o, "\"resolution\":", "[", strOooO00o2);
        OooO0O0.OooO00o(sbOooO00o, "],", "\"format\":", "[", string);
        OooO0O0.OooO00o(sbOooO00o, "],", "\"fps\":", "[", strValueOf);
        sbOooO00o.append("]}");
        VideoCapture.cacheCapability(i, context, sbOooO00o.toString(), getCaptureName());
        return 0;
    }
    ...
    public int doStartCapture() {
        ...
        try {
                ...
                if (this.mPQFirst < 1) {
                    ...
                    for (Range range : rangeArr) {
                        if (((Integer) range.getLower()).intValue() >= Math.max(this.mCaptureFps, 15)) {
                            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("set fps :");
                            sbOooO0o0.append(range.toString());
                            sbOooO0o0.append(" to camera2::fps first, request:");
                            sbOooO0o0.append(this.mCaptureFps);
                    ...
                    for (Range range2 : rangeArr) {
                        if (((Integer) range2.getUpper()).intValue() >= this.mCaptureFps) {
                            StringBuilder sbOooO0o1 = OooO00o.OooO0o0("set fps :");
                            sbOooO0o1.append(range2.toString());
                            sbOooO0o1.append(" to camera2::PQ first, request:");
                            sbOooO0o1.append(this.mCaptureFps);
            ...
            int i = this.mCaptureOutputDataType;
            if (i == 1 || i == 2) {
                StringBuilder sbOooO0o2 = OooO00o.OooO0o0("Camera2Tex-");
                sbOooO0o2.append(this.mId);
                SurfaceTextureHelper surfaceTextureHelperCreate = SurfaceTextureHelper.create(sbOooO0o2.toString(), this.mShareContext, 8);
    ...
    public static String getName(int i, Context context) {
        ...
        StringBuilder sbOooO00o = o00000O0.OooO00o("camera2 ", i, ", facing ");
    ...
    public void startNormalPreview() {
        ...
        try {
            ...
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("setRepeatingRequest failed, error message : ");
    ...
    public int allocate() {
        synchronized (this.mCameraStateLock) {
            ...
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("allocate() face detection: ");
            sbOooO0o0.append(this.mFaceDetectMode);
            sbOooO0o0.append(com.zego.zegoavkit2.ZegoConstants.ZegoVideoDataAuxPublishingStream);
            sbOooO0o0.append(iIntValue);
            sbOooO0o0.append(com.zego.zegoavkit2.ZegoConstants.ZegoVideoDataAuxPublishingStream);
            sbOooO0o0.append(this.mFaceDetectSupported);
            Logging.i(TAG, sbOooO0o0.toString());
    ...
    public float getMaxZoom() {
        if (this.mMaxZoom <= ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE) {
            CameraCharacteristics cameraCharacteristics = getCameraCharacteristics(this.mContext, this.mId);
            if (cameraCharacteristics == null) {
                Logging.w(TAG, "warning cameraCharacteristics is null");
    ...
    public boolean isExposureSupported() {
        ...
        if (iArr != null) {
            for (int i = 0; i < iArr.length; i++) {
                StringBuilder sbOooO0o0 = OooO00o.OooO0o0("isExposureSupported AE mode = ");
                sbOooO0o0.append(iArr[i]);
    ...
    public int setExposure(float f, float f2, boolean z) {
        ...
        if (f < ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE || f > ZOOM_UNSUPPORTED_DEFAULT_VALUE || f2 < ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE || f2 > ZOOM_UNSUPPORTED_DEFAULT_VALUE) {
        ...
        StringBuilder sbOooO0O0 = o000O0Oo.OooO0O0("crop width = ", iWidth, " crop height = ", iHeight, " capture width = ");
        sbOooO0O0.append(this.mCaptureWidth);
        sbOooO0O0.append(" capture height = ");
        sbOooO0O0.append(this.mCaptureHeight);
        Logging.d(TAG, sbOooO0O0.toString());
    ...
    public int setZoom(float f) {
        ...
        if (Math.abs(this.mMaxZoom - ZOOM_UNSUPPORTED_DEFAULT_VALUE) < 0.001f) {
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("Camera ");
            sbOooO0o0.append(this.mId);
            sbOooO0o0.append(" does not support camera zoom");
            Logging.w(TAG, sbOooO0o0.toString());
            return -1;
        }
        this.mCurZoomRatio = f;
        if (!(f >= ZOOM_UNSUPPORTED_DEFAULT_VALUE && f <= this.mMaxZoom && f != this.mLastZoomRatio)) {
            return -2;
        }
