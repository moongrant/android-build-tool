    ...
    public static final class Companion {
        ...
        public final void checkBoundsIndexes$kotlin_stdlib(int startIndex, int endIndex, int size) {
            if (startIndex < 0 || endIndex > size) {
                StringBuilder sbOooO0O0 = o000O0Oo.OooO0O0("startIndex: ", startIndex, ", endIndex: ", endIndex, ", size: ");
                sbOooO0O0.append(size);
                throw new IndexOutOfBoundsException(sbOooO0O0.toString());
            }
            if (startIndex > endIndex) {
                throw new IllegalArgumentException(o00O00OO.OooO00o("startIndex: ", startIndex, " > endIndex: ", endIndex));
            }
        }

        public final void checkElementIndex$kotlin_stdlib(int index, int size) {
            if (index < 0 || index >= size) {
                throw new IndexOutOfBoundsException(o00O00OO.OooO00o("index: ", index, ", size: ", size));
            }
        }
        ...
        public final void checkRangeIndexes$kotlin_stdlib(int fromIndex, int toIndex, int size) {
            if (fromIndex < 0 || toIndex > size) {
                StringBuilder sbOooO0O0 = o000O0Oo.OooO0O0("fromIndex: ", fromIndex, ", toIndex: ", toIndex, ", size: ");
                sbOooO0O0.append(size);
                throw new IndexOutOfBoundsException(sbOooO0O0.toString());
            }
            if (fromIndex > toIndex) {
                throw new IllegalArgumentException(o00O00OO.OooO00o("fromIndex: ", fromIndex, " > toIndex: ", toIndex));
            }
        }
