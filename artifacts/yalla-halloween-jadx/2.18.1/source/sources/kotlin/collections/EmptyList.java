...
public final class EmptyList implements List, Serializable, RandomAccess, KMappedMarker {
    ...
    public List subList(int fromIndex, int toIndex) {
        ...
        throw new IndexOutOfBoundsException(o00O00OO.OooO00o("fromIndex: ", fromIndex, ", toIndex: ", toIndex));
    }
    ...
    public Void get(int index) {
        throw new IndexOutOfBoundsException(OooOOO0.OooO00o("Empty list doesn't contain element at index ", index, '.'));
    }
