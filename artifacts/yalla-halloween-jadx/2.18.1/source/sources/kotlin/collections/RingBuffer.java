...
final class RingBuffer<T> extends AbstractList<T> implements RandomAccess {
    ...
    public RingBuffer(@NotNull Object[] buffer, int i) {
        ...
        this.buffer = buffer;
        if (!(i >= 0)) {
            throw new IllegalArgumentException(android.support.v4.media.OooO00o.OooO00o("ring buffer filled size should not be negative but it is ", i).toString());
        }
        if (i <= buffer.length) {
            this.capacity = buffer.length;
            this.size = i;
        } else {
            StringBuilder sbOooO00o = o00000O0.OooO00o("ring buffer filled size: ", i, " cannot be larger than the buffer size: ");
            sbOooO00o.append(buffer.length);
    ...
    public final void removeFirst(int n) {
        if (!(n >= 0)) {
            throw new IllegalArgumentException(android.support.v4.media.OooO00o.OooO00o("n shouldn't be negative but it is ", n).toString());
        }
        if (!(n <= size())) {
            StringBuilder sbOooO00o = o00000O0.OooO00o("n shouldn't be greater than the buffer size: n = ", n, ", size = ");
