...
public class Intrinsics {
    ...
    public static void checkExpressionValueIsNotNull(Object obj, String str) {
        if (obj == null) {
            throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException(OooOo00.OooO0Oo(str, " must not be null"))));
        }
    }
    ...
    public static void checkHasClass(String str) throws ClassNotFoundException {
        ...
        try {
            ...
            throw ((ClassNotFoundException) sanitizeStackTrace(new ClassNotFoundException(OooO0OO.OooO00o("Class ", strReplace, " is not found. Please update the Kotlin runtime to the latest version"), e)));
        }
    }
    ...
    public static void checkNotNullExpressionValue(Object obj, String str) {
        if (obj == null) {
            throw ((NullPointerException) sanitizeStackTrace(new NullPointerException(OooOo00.OooO0Oo(str, " must not be null"))));
        }
    }
