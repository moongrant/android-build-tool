...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1740fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m1716getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM674constructorimpl = ((int) ULong.m674constructorimpl(j ^ ULong.m674constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM674constructorimpl2 = (iM674constructorimpl + ((int) ULong.m674constructorimpl(j2 ^ ULong.m674constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + iM674constructorimpl2;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m719toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) ULong.m719toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
