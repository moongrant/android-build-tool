            ...
            public final Caller<? extends Member> invoke() {
                ...
                if (constructor instanceof Constructor) {
                    ...
                    if (!(constructor instanceof Method)) {
                        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("Could not compute caller for function: ");
                        sbOooO0o0.append(this.this$0.getDescriptor());
                        sbOooO0o0.append(" (member = ");
                        sbOooO0o0.append(constructor);
                        sbOooO0o0.append(')');
                        throw new KotlinReflectionInternalError(sbOooO0o0.toString());
                    }
                    Method method = (Method) constructor;
                    if (Modifier.isStatic(method.getModifiers())) {
                        callerCreateJvmStaticInObjectCaller = this.this$0.getDescriptor().getAnnotations().mo1784findAnnotation(UtilKt.getJVM_STATIC()) != null ? this.this$0.createJvmStaticInObjectCaller(method) : this.this$0.createStaticMethodCaller(method);
                    } else {
        ...
        this.defaultCaller = ReflectProperties.lazy(new Function0<Caller<? extends Member>>() { // from class: kotlin.reflect.jvm.internal.KFunctionImpl$defaultCaller$2
            ...
            public final Caller<? extends Member> invoke() {
                ...
                if (jvmFunctionSignatureMapSignature instanceof JvmFunctionSignature.KotlinFunction) {
                    ...
                    Member memberMo1777getMember = this.this$0.getCaller().mo1777getMember();
                    Intrinsics.checkNotNull(memberMo1777getMember);
                    genericDeclarationFindDefaultConstructor = container.findDefaultMethod(methodName, methodDesc, !Modifier.isStatic(memberMo1777getMember.getModifiers()));
                ...
                } else if (this.this$0.getDescriptor().getAnnotations().mo1784findAnnotation(UtilKt.getJVM_STATIC()) != null) {
                ...
                if (callerCreateStaticMethodCaller != null) {
                    return InlineClassAwareCallerKt.createInlineClassAwareCallerIfNeeded(callerCreateStaticMethodCaller, this.this$0.getDescriptor(), true);
                }
                return null;
            }
        });
