        ...
        if (jvmPropertySignatureMapPropertySignature instanceof JvmPropertySignature.KotlinProperty) {
            ...
            if (methodFindMethodBySignature != null) {
                ...
                if (inlineClass == null || (unboxMethod = InlineClassAwareCallerKt.getUnboxMethod(inlineClass, accessor.getProperty().getDescriptor())) == null) {
                    StringBuilder sbOooO0o0 = OooO00o.OooO0o0("Underlying property of inline class ");
                    sbOooO0o0.append(accessor.getProperty());
                    sbOooO0o0.append(" should have a field");
                ...
                if (javaField == null) {
                    StringBuilder sbOooO0o1 = OooO00o.OooO0o0("No accessors or field is found for property ");
                    sbOooO0o1.append(accessor.getProperty());
            ...
            if (!(jvmPropertySignatureMapPropertySignature instanceof JvmPropertySignature.JavaMethodProperty)) {
                ...
                if (z) {
                    ...
                    if (setterSignature == null) {
                        StringBuilder sbOooO0o2 = OooO00o.OooO0o0("No setter found for property ");
                        sbOooO0o2.append(accessor.getProperty());
                        throw new KotlinReflectionInternalError(sbOooO0o2.toString());
                    }
                }
                ...
                StringBuilder sbOooO0o3 = OooO00o.OooO0o0("No accessor found for property ");
                sbOooO0o3.append(accessor.getProperty());
            ...
            if (z) {
                ...
                if (setterMethod == null) {
                    StringBuilder sbOooO0o4 = OooO00o.OooO0o0("No source found for setter of Java method property: ");
                    sbOooO0o4.append(javaMethodProperty.getGetterMethod());
                    throw new KotlinReflectionInternalError(sbOooO0o4.toString());
                }
            }
