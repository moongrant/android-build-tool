...
public final class UtilKt {
    ...
    */
    private static final Object arrayToRuntimeValue(ArrayValue arrayValue, ClassLoader classLoader) {
        ...
        switch (primitiveArrayElementType == null ? -1 : WhenMappings.$EnumSwitchMapping$0[primitiveArrayElementType.ordinal()]) {
            case -1:
                ...
                ClassifierDescriptor classifierDescriptorMo1790getDeclarationDescriptor = type2.getConstructor().mo1790getDeclarationDescriptor();
    ...
    private static final Object toRuntimeValue(ConstantValue<?> constantValue, ClassLoader classLoader) {
        ...
        ClassifierDescriptor classifierDescriptorMo1790getDeclarationDescriptor = ((KClassValue.Value.LocalClass) value2).getType().getConstructor().mo1790getDeclarationDescriptor();
        ClassDescriptor classDescriptor = classifierDescriptorMo1790getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo1790getDeclarationDescriptor : null;
        if (classDescriptor != null) {
