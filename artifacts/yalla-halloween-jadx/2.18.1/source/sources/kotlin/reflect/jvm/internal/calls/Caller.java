...
public interface Caller<M extends Member> {
    ...
    public static final class DefaultImpls {
        public static <M extends Member> void checkArguments(@NotNull Caller<? extends M> caller, @NotNull Object[] args) {
            ...
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("Callable expects ");
            sbOooO0o0.append(CallerKt.getArity(caller));
            sbOooO0o0.append(" arguments, but ");
            throw new IllegalArgumentException(o0ooOOo.OooO00o(sbOooO0o0, args.length, " were provided."));
        }
    }
