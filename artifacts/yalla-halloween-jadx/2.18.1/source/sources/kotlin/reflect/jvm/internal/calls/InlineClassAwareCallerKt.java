...
public final class InlineClassAwareCallerKt {
    ...
    public static final Class<?> toInlineClass(@NotNull KotlinType kotlinType) {
        ...
        Class<?> inlineClass = toInlineClass(kotlinType.getConstructor().mo1790getDeclarationDescriptor());
        if (inlineClass == null) {
            return null;
        }
    ...
    public static final Class<?> toInlineClass(@Nullable DeclarationDescriptor declarationDescriptor) {
        ...
        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("Class object for the class ");
        sbOooO0o0.append(classDescriptor.getName());
        sbOooO0o0.append(" cannot be found (classId=");
        sbOooO0o0.append(DescriptorUtilsKt.getClassId((ClassifierDescriptor) declarationDescriptor));
        sbOooO0o0.append(')');
