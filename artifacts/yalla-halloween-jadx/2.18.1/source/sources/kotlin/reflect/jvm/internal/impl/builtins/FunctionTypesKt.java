...
public final class FunctionTypesKt {
    public static final int contextFunctionTypeParamsCount(@NotNull KotlinType kotlinType) {
        ...
        AnnotationDescriptor annotationDescriptorMo1784findAnnotation = kotlinType.getAnnotations().mo1784findAnnotation(StandardNames.FqNames.contextFunctionTypeParams);
        if (annotationDescriptorMo1784findAnnotation == null) {
            return 0;
        }
        ConstantValue constantValue = (ConstantValue) MapsKt.getValue(annotationDescriptorMo1784findAnnotation.getAllValueArguments(), StandardNames.CONTEXT_FUNCTION_TYPE_PARAMETER_COUNT_NAME);
    ...
    public static final Name extractParameterNameFromFunctionTypeArgument(@NotNull KotlinType kotlinType) {
        String value;
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        AnnotationDescriptor annotationDescriptorMo1784findAnnotation = kotlinType.getAnnotations().mo1784findAnnotation(StandardNames.FqNames.parameterName);
        if (annotationDescriptorMo1784findAnnotation == null) {
            return null;
        }
    ...
    public static final boolean isBuiltinFunctionalType(@NotNull KotlinType kotlinType) {
        ...
        return classifierDescriptorMo1790getDeclarationDescriptor != null && isBuiltinFunctionalClassDescriptor(classifierDescriptorMo1790getDeclarationDescriptor);
    }

    public static final boolean isFunctionType(@NotNull KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor classifierDescriptorMo1790getDeclarationDescriptor = kotlinType.getConstructor().mo1790getDeclarationDescriptor();
        return (classifierDescriptorMo1790getDeclarationDescriptor != null ? getFunctionalClassKind(classifierDescriptorMo1790getDeclarationDescriptor) : null) == FunctionClassKind.Function;
    }

    public static final boolean isSuspendFunctionType(@NotNull KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor classifierDescriptorMo1790getDeclarationDescriptor = kotlinType.getConstructor().mo1790getDeclarationDescriptor();
        return (classifierDescriptorMo1790getDeclarationDescriptor != null ? getFunctionalClassKind(classifierDescriptorMo1790getDeclarationDescriptor) : null) == FunctionClassKind.SuspendFunction;
    }

    private static final boolean isTypeAnnotatedWithExtensionFunctionType(KotlinType kotlinType) {
        return kotlinType.getAnnotations().mo1784findAnnotation(StandardNames.FqNames.extensionFunctionType) != null;
    }
