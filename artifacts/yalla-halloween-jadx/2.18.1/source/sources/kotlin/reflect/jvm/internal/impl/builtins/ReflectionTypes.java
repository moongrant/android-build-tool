...
public final class ReflectionTypes {
    ...
    public final ClassDescriptor find(String str, int i) {
        ...
        ClassifierDescriptor classifierDescriptorMo1792getContributedClassifier = getKotlinReflectScope().mo1792getContributedClassifier(nameIdentifier, NoLookupLocation.FROM_REFLECTION);
