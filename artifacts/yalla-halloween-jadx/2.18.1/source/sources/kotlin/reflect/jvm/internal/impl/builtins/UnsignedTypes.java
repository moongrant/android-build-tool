...
public final class UnsignedTypes {
    ...
    public static final boolean isUnsignedType(@NotNull KotlinType type) {
        ClassifierDescriptor classifierDescriptorMo1790getDeclarationDescriptor;
        Intrinsics.checkNotNullParameter(type, "type");
        if (TypeUtils.noExpectedType(type) || (classifierDescriptorMo1790getDeclarationDescriptor = type.getConstructor().mo1790getDeclarationDescriptor()) == null) {
            return false;
        }
        return INSTANCE.isUnsignedClass(classifierDescriptorMo1790getDeclarationDescriptor);
    }
