...
public final class JavaToKotlinClassMap {
    ...
    public static final class PlatformMutabilityMapping {
        ...
        public String toString() {
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("PlatformMutabilityMapping(javaClass=");
            sbOooO0o0.append(this.javaClass);
            sbOooO0o0.append(", kotlinReadOnly=");
            sbOooO0o0.append(this.kotlinReadOnly);
            sbOooO0o0.append(", kotlinMutable=");
            sbOooO0o0.append(this.kotlinMutable);
            sbOooO0o0.append(')');
    ...
    static {
        ...
        for (ClassId classId18 : CompanionObjectMapping.INSTANCE.allClassesWithIntrinsicCompanions()) {
            ...
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("kotlin.jvm.internal.");
            sbOooO0o0.append(classId18.getShortClassName().asString());
            sbOooO0o0.append("CompanionObject");
            ClassId classId19 = ClassId.topLevel(new FqName(sbOooO0o0.toString()));
        ...
        for (int i = 0; i < 23; i++) {
            ...
            ClassId classId20 = ClassId.topLevel(new FqName(android.support.v4.media.OooO00o.OooO00o("kotlin.jvm.functions.Function", i)));
        ...
        for (int i2 = 0; i2 < 22; i2++) {
            ...
            INSTANCE.addKotlinToJava(new FqName(android.support.v4.media.OooO00o.OooO00o(functionClassKind5.getPackageFqName().toString() + '.' + functionClassKind5.getClassNamePrefix(), i2)), K_FUNCTION_CLASS_ID);
        }
    ...
    private final boolean isKotlinFunctionWithBigArity(FqNameUnsafe fqNameUnsafe, String str) {
        ...
        return (strSubstringAfter.length() > 0) && !StringsKt__StringsKt.startsWith$default((CharSequence) strSubstringAfter, '0', false, 2, (Object) null) && (intOrNull = StringsKt.toIntOrNull(strSubstringAfter)) != null && intOrNull.intValue() >= 23;
    }
