...
public abstract class AbstractTypeAliasDescriptor extends DeclarationDescriptorNonRootImpl implements TypeAliasDescriptor {
    ...
    public AbstractTypeAliasDescriptor(@NotNull DeclarationDescriptor containingDeclaration, @NotNull Annotations annotations, @NotNull Name name, @NotNull SourceElement sourceElement, @NotNull DescriptorVisibility visibilityImpl) {
        ...
        this.typeConstructor = new TypeConstructor() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor$typeConstructor$1
            ...
            public KotlinBuiltIns getBuiltIns() {
                return DescriptorUtilsKt.getBuiltIns(mo1790getDeclarationDescriptor());
            }
            ...
            public Collection<KotlinType> mo1791getSupertypes() {
                Collection<KotlinType> collectionMo1791getSupertypes = mo1790getDeclarationDescriptor().getUnderlyingType().getConstructor().mo1791getSupertypes();
                Intrinsics.checkNotNullExpressionValue(collectionMo1791getSupertypes, "declarationDescriptor.un…pe.constructor.supertypes");
            ...
            public String toString() {
                StringBuilder sbOooO0o0 = OooO00o.OooO0o0("[typealias ");
                sbOooO0o0.append(mo1790getDeclarationDescriptor().getName().asString());
                sbOooO0o0.append(']');
            ...
            public TypeAliasDescriptor mo1790getDeclarationDescriptor() {
                return this.this$0;
            }
        };
    }
        ...
        return TypeUtils.contains(getUnderlyingType(), new Function1<UnwrappedType, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor.isInner.1
            ...
            public final Boolean invoke(UnwrappedType type) {
                ...
                if (!KotlinTypeKt.isError(type)) {
                    ...
                    z = (classifierDescriptorMo1790getDeclarationDescriptor instanceof TypeParameterDescriptor) && !Intrinsics.areEqual(((TypeParameterDescriptor) classifierDescriptorMo1790getDeclarationDescriptor).getContainingDeclaration(), abstractTypeAliasDescriptor);
                }
    ...
    public String toString() {
        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("typealias ");
        sbOooO0o0.append(getName().asString());
        return sbOooO0o0.toString();
    }
