    ...
    public static final class Companion {
        ...
        public final TypeAliasConstructorDescriptor createIfAvailable(@NotNull StorageManager storageManager, @NotNull TypeAliasDescriptor typeAliasDescriptor, @NotNull ClassConstructorDescriptor constructor) {
            ...
            if (classDescriptor != null) {
                ...
                EmptyList = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(contextReceiverParameters, 10));
                Iterator it = contextReceiverParameters.iterator();
                while (it.hasNext()) {
                    EmptyList.add(DescriptorFactory.createContextReceiverParameterForClass(classDescriptor, typeSubstitutorForUnderlyingClass.safeSubstitute(((ReceiverParameterDescriptor) it.next()).getType(), Variance.INVARIANT), Annotations.Companion.getEMPTY()));
                }
            } else {
