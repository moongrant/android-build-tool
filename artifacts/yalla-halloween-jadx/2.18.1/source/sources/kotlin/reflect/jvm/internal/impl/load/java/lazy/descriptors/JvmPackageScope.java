...
public final class JvmPackageScope implements MemberScope {
    ...
    public ClassifierDescriptor mo1792getContributedClassifier(@NotNull Name name, @NotNull LookupLocation location) {
        ...
        ClassDescriptor classDescriptorMo1792getContributedClassifier = this.javaScope.mo1792getContributedClassifier(name, location);
        if (classDescriptorMo1792getContributedClassifier != null) {
            return classDescriptorMo1792getContributedClassifier;
        }
    ...
    public String toString() {
        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("scope for ");
        sbOooO0o0.append(this.packageFragment);
