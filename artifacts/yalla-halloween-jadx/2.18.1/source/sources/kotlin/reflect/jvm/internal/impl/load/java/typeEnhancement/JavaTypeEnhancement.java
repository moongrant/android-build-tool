...
public final class JavaTypeEnhancement {
    ...
    private final SimpleResult enhanceInflexible(SimpleType simpleType, Function1<? super Integer, JavaTypeQualifiers> function1, int i, TypeComponentPosition typeComponentPosition, boolean z, boolean z2) {
        ...
        ClassifierDescriptor classifierDescriptorMo1790getDeclarationDescriptor = simpleType.getConstructor().mo1790getDeclarationDescriptor();
        ...
        ClassifierDescriptor classifierDescriptorEnhanceMutability = TypeEnhancementKt.enhanceMutability(classifierDescriptorMo1790getDeclarationDescriptor, javaTypeQualifiersInvoke, typeComponentPosition);
        ...
        ArrayList arrayList = new ArrayList(Math.min(CollectionsKt__IterablesKt.collectionSizeOrDefault(arguments, 10), CollectionsKt__IterablesKt.collectionSizeOrDefault(parameters, 10)));
        while (it.hasNext() && it2.hasNext()) {
            ...
            if (z5) {
                ...
                if (!typeProjection.isStarProjection()) {
                    ...
                    result = new Result(KotlinTypeFactory.flexibleType(FlexibleTypesKt.lowerIfFlexible(unwrappedTypeUnwrap).makeNullableAsSpecified((boolean) r6), FlexibleTypesKt.upperIfFlexible(unwrappedTypeUnwrap).makeNullableAsSpecified(true)), 1);
                } else {
                    result = new Result(null, 1);
                }
            } else {
                z4 = z5;
                result = new Result(kotlinType, r6);
            }
        ...
        EnhancedTypeAnnotations enhancedTypeAnnotations2 = TypeEnhancementKt.ENHANCED_NULLABILITY_ANNOTATIONS;
