...
class BoundedByteString extends LiteralByteString {
    ...
    public BoundedByteString(byte[] bArr, int i, int i2) {
        super(bArr);
        if (i < 0) {
            throw new IllegalArgumentException(Oooo0.OooO00o(29, "Offset too small: ", i));
        }
        if (i2 < 0) {
            throw new IllegalArgumentException(Oooo0.OooO00o(29, "Length too small: ", i));
        }
    ...
    public byte byteAt(int i) {
        if (i < 0) {
            throw new ArrayIndexOutOfBoundsException(Oooo0.OooO00o(28, "Index too small: ", i));
        }
        if (i < size()) {
