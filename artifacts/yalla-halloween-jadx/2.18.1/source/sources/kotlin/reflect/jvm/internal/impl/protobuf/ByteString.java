...
public abstract class ByteString implements Iterable<Byte> {
    ...
    public void copyTo(byte[] bArr, int i, int i2, int i3) {
        if (i < 0) {
            throw new IndexOutOfBoundsException(Oooo0.OooO00o(30, "Source offset < 0: ", i));
        }
        if (i2 < 0) {
            throw new IndexOutOfBoundsException(Oooo0.OooO00o(30, "Target offset < 0: ", i2));
        }
        if (i3 < 0) {
            throw new IndexOutOfBoundsException(Oooo0.OooO00o(23, "Length < 0: ", i3));
        }
        int i4 = i + i3;
        if (i4 > size()) {
            throw new IndexOutOfBoundsException(Oooo0.OooO00o(34, "Source end offset < 0: ", i4));
        }
        int i5 = i2 + i3;
        if (i5 > bArr.length) {
            throw new IndexOutOfBoundsException(Oooo0.OooO00o(34, "Target end offset < 0: ", i5));
        }
        if (i3 > 0) {
    ...
    public void writeTo(OutputStream outputStream, int i, int i2) throws IOException {
        ...
        if (i2 < 0) {
            throw new IndexOutOfBoundsException(Oooo0.OooO00o(23, "Length < 0: ", i2));
        }
        int i3 = i + i2;
        if (i3 > size()) {
            throw new IndexOutOfBoundsException(Oooo0.OooO00o(39, "Source end offset exceeded: ", i3));
        }
        if (i2 > 0) {
