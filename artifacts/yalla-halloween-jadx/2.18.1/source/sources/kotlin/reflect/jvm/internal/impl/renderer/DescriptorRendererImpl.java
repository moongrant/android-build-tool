...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
    ...
    /* JADX WARN: Code duplicated, block: B:11:0x0048 A[RETURN, SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:8:0x002b  */
    /* JADX WARN: Instruction removed from duplicated block: B:8:0x002b, please report this as an issue */
    private final boolean differsOnlyInNullability(String str, String str2) {
        if (!Intrinsics.areEqual(str, StringsKt.OooOo00(str2, "?", ""))) {
    ...
    private final List<String> renderAndSortAnnotationArguments(AnnotationDescriptor annotationDescriptor) {
        ClassConstructorDescriptor classConstructorDescriptorMo1783getUnsubstitutedPrimaryConstructor;
        ...
        if (annotationClass != null && (classConstructorDescriptorMo1783getUnsubstitutedPrimaryConstructor = annotationClass.mo1783getUnsubstitutedPrimaryConstructor()) != null && (valueParameters = classConstructorDescriptorMo1783getUnsubstitutedPrimaryConstructor.getValueParameters()) != null) {
        ...
        ArrayList arrayList4 = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(setEntrySet, 10));
    ...
    public final void renderClass(ClassDescriptor classDescriptor, StringBuilder sb) throws IOException {
        ...
        if (!getStartFromName()) {
            ...
            renderModifier(sb, getModifiers().contains(DescriptorRendererModifier.INNER) && classDescriptor.isInner(), ak.au);
        ...
        if (!classDescriptor.getKind().isSingleton() && getClassWithPrimaryConstructor() && (classConstructorDescriptorMo1783getUnsubstitutedPrimaryConstructor = classDescriptor.mo1783getUnsubstitutedPrimaryConstructor()) != null) {
            sb.append(ZegoConstants.ZegoVideoDataAuxPublishingStream);
            renderAnnotations$default(this, sb, classConstructorDescriptorMo1783getUnsubstitutedPrimaryConstructor, null, 2, null);
            DescriptorVisibility visibility2 = classConstructorDescriptorMo1783getUnsubstitutedPrimaryConstructor.getVisibility();
            ...
            renderValueParameters(valueParameters, classConstructorDescriptorMo1783getUnsubstitutedPrimaryConstructor.hasSynthesizedParameterNames(), sb);
        }
    ...
    public final String renderConstant(ConstantValue<?> constantValue) {
        ...
        return OooOo00.OooO0Oo(strAsString, "::class");
    }
    ...
    public final void renderConstructor(ConstructorDescriptor constructorDescriptor, StringBuilder sb) throws IOException {
        ...
        if (getRenderConstructorDelegation() && !constructorDescriptor.isPrimary() && (containingDeclaration instanceof ClassDescriptor) && (classConstructorDescriptorMo1783getUnsubstitutedPrimaryConstructor = ((ClassDescriptor) containingDeclaration).mo1783getUnsubstitutedPrimaryConstructor()) != null) {
            List<ValueParameterDescriptor> valueParameters2 = classConstructorDescriptorMo1783getUnsubstitutedPrimaryConstructor.getValueParameters();
    ...
    private final String renderError(String str) {
        ...
        if (i == 2) {
            return OooO0OO.OooO00o("<font color=red><b>", str, "</b></font>");
        }
        throw new NoWhenBranchMatchedException();
    }
    ...
    private final void renderInitializer(VariableDescriptor variableDescriptor, StringBuilder sb) {
        ConstantValue<?> constantValueMo1785getCompileTimeInitializer;
        if (!getIncludePropertyConstant() || (constantValueMo1785getCompileTimeInitializer = variableDescriptor.mo1785getCompileTimeInitializer()) == null) {
            return;
        }
        sb.append(" = ");
        sb.append(escape(renderConstant(constantValueMo1785getCompileTimeInitializer)));
    }
    ...
    private final String renderKeyword(String str) {
        ...
        if (i == 2) {
            return getBoldOnlyForNamesInHtml() ? str : OooO0OO.OooO00o("<b>", str, "</b>");
        }
        throw new NoWhenBranchMatchedException();
    }
    ...
    private final void renderSuperTypes(ClassDescriptor classDescriptor, StringBuilder sb) throws IOException {
        ...
        Intrinsics.checkNotNullExpressionValue(collectionMo1791getSupertypes, "klass.typeConstructor.supertypes");
        if (collectionMo1791getSupertypes.isEmpty()) {
            return;
        }
        if (collectionMo1791getSupertypes.size() == 1 && KotlinBuiltIns.isAnyOrNullableAny(collectionMo1791getSupertypes.iterator().next())) {
            return;
        }
        renderSpaceIfNeeded(sb);
        sb.append(": ");
        CollectionsKt___CollectionsKt.joinTo(collectionMo1791getSupertypes, sb, (124 & 2) != 0 ? ", " : ", ", (124 & 4) != 0 ? "" : null, (124 & 8) == 0 ? null : "", (124 & 16) != 0 ? -1 : 0, (124 & 32) != 0 ? "..." : null, (124 & 64) != 0 ? null : new Function1<KotlinType, CharSequence>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl.renderSuperTypes.1
            {
                super(1);
            }
    ...
    public final void renderValueParameter(ValueParameterDescriptor valueParameterDescriptor, boolean z, StringBuilder sb, boolean z2) {
        ...
        if (z4) {
            ...
            sbOooO0o0.append(defaultParameterValueRenderer.invoke(valueParameterDescriptor));
    ...
    private final String replacePrefixes(String str, String str2, String str3, String str4, String str5) {
        if (!StringsKt.OooOoOO(str, str2) || !StringsKt.OooOoOO(str3, str4)) {
            return null;
        }
        ...
        String strOooO0Oo = OooOo00.OooO0Oo(str5, strSubstring);
    ...
    public String renderAnnotation(@NotNull AnnotationDescriptor annotation, @Nullable AnnotationUseSiteTarget annotationUseSiteTarget) throws IOException {
        ...
        if (getVerbose() && (KotlinTypeKt.isError(type) || (type.getConstructor().mo1790getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor))) {
    ...
    public String renderFlexibleType(@NotNull String lowerRendered, @NotNull String upperRendered, @NotNull KotlinBuiltIns builtIns) {
        ...
        if (differsOnlyInNullability(lowerRendered, upperRendered)) {
            if (!StringsKt.OooOoOO(upperRendered, "(")) {
        ...
        String strReplacePrefixes = replacePrefixes(lowerRendered, OooOo00.OooO0Oo(strSubstringBefore$default, "Mutable"), upperRendered, strSubstringBefore$default, strSubstringBefore$default + "(Mutable)");
        if (strReplacePrefixes != null) {
            return strReplacePrefixes;
        }
        String strReplacePrefixes2 = replacePrefixes(lowerRendered, OooOo00.OooO0Oo(strSubstringBefore$default, "MutableMap.MutableEntry"), upperRendered, OooOo00.OooO0Oo(strSubstringBefore$default, "Map.Entry"), OooOo00.OooO0Oo(strSubstringBefore$default, "(Mutable)Map.(Mutable)Entry"));
        ...
        StringBuilder sbOooO0o0 = OooO00o.OooO0o0(strSubstringBefore$default2);
        sbOooO0o0.append(escape("Array<"));
        String string = sbOooO0o0.toString();
        StringBuilder sbOooO0o1 = OooO00o.OooO0o0(strSubstringBefore$default2);
        sbOooO0o1.append(escape("Array<out "));
        String string2 = sbOooO0o1.toString();
        StringBuilder sbOooO0o2 = OooO00o.OooO0o0(strSubstringBefore$default2);
        sbOooO0o2.append(escape("Array<(out) "));
        String strReplacePrefixes3 = replacePrefixes(lowerRendered, string, upperRendered, string2, sbOooO0o2.toString());
    ...
    public String renderMessage(@NotNull String message) {
        ...
        if (i == 2) {
            return OooO0OO.OooO00o("<i>", message, "</i>");
        }
        throw new NoWhenBranchMatchedException();
    }
    ...
    public String renderName(@NotNull Name name, boolean z) {
        ...
        return (getBoldOnlyForNamesInHtml() && getTextFormat() == RenderingFormat.HTML && z) ? OooO0OO.OooO00o("<b>", strEscape, "</b>") : strEscape;
    }
    ...
    public String renderTypeConstructor(@NotNull TypeConstructor typeConstructor) {
        ...
        if (classifierDescriptorMo1790getDeclarationDescriptor instanceof TypeParameterDescriptor ? true : classifierDescriptorMo1790getDeclarationDescriptor instanceof ClassDescriptor ? true : classifierDescriptorMo1790getDeclarationDescriptor instanceof TypeAliasDescriptor) {
            return renderClassifierName(classifierDescriptorMo1790getDeclarationDescriptor);
        }
        ...
        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("Unexpected classifier: ");
        sbOooO0o0.append(classifierDescriptorMo1790getDeclarationDescriptor.getClass());
