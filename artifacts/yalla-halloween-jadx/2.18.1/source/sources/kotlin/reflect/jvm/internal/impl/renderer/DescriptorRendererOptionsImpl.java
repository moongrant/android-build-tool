        ...
        for (Field field : declaredFields) {
            if ((field.getModifiers() & 8) == 0) {
                ...
                if (observableProperty != null) {
                    ...
                    sbOooO0o0.append(name3);
                    field.set(descriptorRendererOptionsImpl, descriptorRendererOptionsImpl.property(observableProperty.getValue(this, new PropertyReference1Impl(orCreateKotlinClass, name2, sbOooO0o0.toString()))));
                }
            }
        }
