...
public final class DescriptorUtilsKt {
    ...
    public static final ClassDescriptor getAnnotationClass(@NotNull AnnotationDescriptor annotationDescriptor) {
        ...
        ClassifierDescriptor classifierDescriptorMo1790getDeclarationDescriptor = annotationDescriptor.getType().getConstructor().mo1790getDeclarationDescriptor();
    ...
    public static final ClassDescriptor getSuperClassNotAny(@NotNull ClassDescriptor classDescriptor) {
        ...
        for (KotlinType kotlinType : classDescriptor.getDefaultType().getConstructor().mo1791getSupertypes()) {
            if (!KotlinBuiltIns.isAnyOrNullableAny(kotlinType)) {
                ...
                if (DescriptorUtils.isClassOrEnumClass(classifierDescriptorMo1790getDeclarationDescriptor)) {
    ...
    public static final ClassDescriptor resolveTopLevelClass(@NotNull ModuleDescriptor moduleDescriptor, @NotNull FqName topLevelClassFqName, @NotNull LookupLocation location) {
        ...
        ClassifierDescriptor classifierDescriptorMo1792getContributedClassifier = memberScope.mo1792getContributedClassifier(nameShortName, location);
