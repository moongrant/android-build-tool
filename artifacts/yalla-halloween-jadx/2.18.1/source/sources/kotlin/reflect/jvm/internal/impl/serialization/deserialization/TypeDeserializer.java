...
public final class TypeDeserializer {
    ...
    private final SimpleType transformRuntimeFunctionTypeToSuspendFunction(KotlinType kotlinType) {
        ...
        FqName fqNameSafe = classifierDescriptorMo1790getDeclarationDescriptor != null ? DescriptorUtilsKt.getFqNameSafe(classifierDescriptorMo1790getDeclarationDescriptor) : null;
    ...
    public final SimpleType simpleType(@NotNull final ProtoBuf.Type proto, boolean z) {
        ...
        boolean z2 = true;
        if (ErrorUtils.isError(typeConstructor.mo1790getDeclarationDescriptor())) {
        ...
        if (z && (classifierDescriptorMo1790getDeclarationDescriptor instanceof TypeAliasDescriptor)) {
            KotlinTypeFactory kotlinTypeFactory = KotlinTypeFactory.INSTANCE;
            SimpleType simpleTypeComputeExpandedType = KotlinTypeFactory.computeExpandedType((TypeAliasDescriptor) classifierDescriptorMo1790getDeclarationDescriptor, list);
    ...
    public String toString() {
        ...
        if (this.parent == null) {
            ...
            StringBuilder sbOooO0o0 = OooO00o.OooO00o.OooO0o0(". Child of ");
            sbOooO0o0.append(this.parent.debugName);
