...
public abstract class AbstractClassTypeConstructor extends AbstractTypeConstructor {
    ...
    public KotlinType defaultSupertypeIfEmpty() {
        if (KotlinBuiltIns.isSpecialClassWithNoSupertypes(mo1790getDeclarationDescriptor())) {
            return null;
        }
    ...
    public Collection<KotlinType> getAdditionalNeighboursInSupertypeGraph(boolean z) {
        DeclarationDescriptor containingDeclaration = mo1790getDeclarationDescriptor().getContainingDeclaration();
        ...
        ClassDescriptor classDescriptorMo1782getCompanionObjectDescriptor = classDescriptor.mo1782getCompanionObjectDescriptor();
        if (z && classDescriptorMo1782getCompanionObjectDescriptor != null) {
            smartList.add(classDescriptorMo1782getCompanionObjectDescriptor.getDefaultType());
        }
        return smartList;
    }
    ...
    public KotlinBuiltIns getBuiltIns() {
        KotlinBuiltIns builtIns = DescriptorUtilsKt.getBuiltIns(mo1790getDeclarationDescriptor());
        if (builtIns == null) {
            $$$reportNull$$$0(1);
        }
        return builtIns;
    ...
    public abstract ClassDescriptor mo1790getDeclarationDescriptor();
    ...
    public boolean isSameClassifier(@NotNull ClassifierDescriptor classifierDescriptor) {
        ...
        return (classifierDescriptor instanceof ClassDescriptor) && areFqNamesEqual(mo1790getDeclarationDescriptor(), classifierDescriptor);
    }
}
