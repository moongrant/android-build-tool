...
public final class FlexibleTypeImpl extends FlexibleType implements CustomTypeParameter {
    ...
    public boolean isTypeParameter() {
        return (getLowerBound().getConstructor().mo1790getDeclarationDescriptor() instanceof TypeParameterDescriptor) && Intrinsics.areEqual(getLowerBound().getConstructor(), getUpperBound().getConstructor());
    }
    ...
    public String render(@NotNull DescriptorRenderer renderer, @NotNull DescriptorRendererOptions options) {
        ...
        sbOooO00o.append(renderer.renderType(getLowerBound()));
        sbOooO00o.append("..");
        sbOooO00o.append(renderer.renderType(getUpperBound()));
        sbOooO00o.append(')');
    ...
    public String toString() {
        StringBuilder sbOooO00o = o00O0O0O.OooO00o('(');
        sbOooO00o.append(getLowerBound());
        sbOooO00o.append("..");
        sbOooO00o.append(getUpperBound());
        sbOooO00o.append(')');
        return sbOooO00o.toString();
    }
