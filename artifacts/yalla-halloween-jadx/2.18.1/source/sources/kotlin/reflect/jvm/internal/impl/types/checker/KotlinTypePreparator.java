    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> collectionMo1791getSupertypes = capturedTypeConstructorImpl.mo1791getSupertypes();
        ...
        if (constructor instanceof IntegerValueTypeConstructor) {
            Collection<KotlinType> collectionMo1791getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo1791getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(collectionMo1791getSupertypes2, 10));
            Iterator<T> it2 = collectionMo1791getSupertypes2.iterator();
            while (it2.hasNext()) {
        ...
        Collection<KotlinType> collectionMo1791getSupertypes3 = intersectionTypeConstructor.mo1791getSupertypes();
        ArrayList arrayList3 = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(collectionMo1791getSupertypes3, 10));
        Iterator<T> it3 = collectionMo1791getSupertypes3.iterator();
        while (it3.hasNext()) {
