...
public class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    public static final class C05421<R> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
        ...
        public C05421(Sequence<? extends T> sequence, Function2<? super Integer, ? super T, ? extends C> function2, Function1<? super C, ? extends Iterator<? extends R>> function1, Continuation<? super C05421> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C05421 c05421 = new C05421(this.$source, this.$transform, this.$iterator, continuation);
            c05421.L$0 = obj;
            return c05421;
        }
        ...
        public final Object invoke(@NotNull SequenceScope<? super R> sequenceScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C05421) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final class C05461<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C05461(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> function0, Continuation<? super C05461> continuation) {
            super(2, continuation);
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C05461 c05461 = new C05461(this.$this_ifEmpty, this.$defaultValue, continuation);
            c05461.L$0 = obj;
            return c05461;
        }
        ...
        public final Object invoke(@NotNull SequenceScope<? super T> sequenceScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C05461) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final class C05471<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C05471(Sequence<? extends T> sequence, Random random, Continuation<? super C05471> continuation) {
            super(2, continuation);
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C05471 c05471 = new C05471(this.$this_shuffled, this.$random, continuation);
            c05471.L$0 = obj;
            return c05471;
        }
        ...
        @Nullable
        public final Object invoke(@NotNull SequenceScope<? super T> sequenceScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C05471) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T, C, R> Sequence<R> flatMapIndexed(@NotNull Sequence<? extends T> source, @NotNull Function2<? super Integer, ? super T, ? extends C> transform, @NotNull Function1<? super C, ? extends Iterator<? extends R>> iterator) {
        ...
        Intrinsics.checkNotNullParameter(iterator, "iterator");
        return SequencesKt__SequenceBuilderKt.sequence(new C05421(source, transform, iterator, null));
    }
    ...
    public static final <T> Sequence<T> ifEmpty(@NotNull Sequence<? extends T> sequence, @NotNull Function0<? extends Sequence<? extends T>> defaultValue) {
        ...
        return SequencesKt__SequenceBuilderKt.sequence(new C05461(sequence, defaultValue, null));
    }
    ...
    public static final <T> Sequence<T> shuffled(@NotNull Sequence<? extends T> sequence, @NotNull Random random) {
        ...
        return SequencesKt__SequenceBuilderKt.sequence(new C05471(sequence, random, null));
    }
