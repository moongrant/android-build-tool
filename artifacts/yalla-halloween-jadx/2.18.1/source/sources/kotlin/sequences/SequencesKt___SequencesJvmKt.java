...
class SequencesKt___SequencesJvmKt extends SequencesKt__SequencesKt {
    ...
    public static final /* synthetic */ Double m1802max(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt___SequencesKt.m1810maxOrNull((Sequence<Double>) sequence);
    }
    ...
    public static final /* synthetic */ <T, R extends Comparable<? super R>> T maxBy(Sequence<? extends T> sequence, Function1<? super T, ? extends R> function1) {
        Iterator itOooO00o = OooO00o.OooO00o(sequence, "<this>", function1, "selector");
    ...
    public static final /* synthetic */ Double m1804min(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt___SequencesKt.m1818minOrNull((Sequence<Double>) sequence);
    }
    ...
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* JADX INFO: renamed from: max, reason: collision with other method in class */
    public static final /* synthetic */ Float m1803max(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt___SequencesKt.m1811maxOrNull((Sequence<Float>) sequence);
    }
    ...
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* JADX INFO: renamed from: min, reason: collision with other method in class */
    public static final /* synthetic */ Float m1805min(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt___SequencesKt.m1819minOrNull((Sequence<Float>) sequence);
    }
