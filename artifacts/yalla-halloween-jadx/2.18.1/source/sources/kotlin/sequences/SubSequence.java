...
public final class SubSequence<T> implements Sequence<T>, DropTakeSequence<T> {
    ...
    public SubSequence(@NotNull Sequence<? extends T> sequence, int i, int i2) {
        ...
        this.endIndex = i2;
        if (!(i >= 0)) {
            throw new IllegalArgumentException(android.support.v4.media.OooO00o.OooO00o("startIndex should be non-negative, but is ", i).toString());
        }
        if (!(i2 >= 0)) {
            throw new IllegalArgumentException(android.support.v4.media.OooO00o.OooO00o("endIndex should be non-negative, but is ", i2).toString());
        }
        if (!(i2 >= i)) {
            throw new IllegalArgumentException(o00O00OO.OooO00o("endIndex should be not less than startIndex, but was ", i2, " < ", i).toString());
        }
    }
