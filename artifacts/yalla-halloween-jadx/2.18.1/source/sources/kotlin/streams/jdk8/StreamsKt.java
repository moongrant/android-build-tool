...
public final class StreamsKt {
    ...
    public static final <T> Stream<T> asStream(@NotNull final Sequence<? extends T> sequence) {
        ...
        Stream<T> stream = StreamSupport.stream(new Supplier() { // from class: o0ooOO0O.oO00OOOo
            @Override // java.util.function.Supplier
            public final Object get() {
                return StreamsKt.m1822asStream$lambda4(sequence);
            }
        }, 16, false);
    ...
    public static final Spliterator m1822asStream$lambda4(Sequence this_asStream) {
