...
public class CharsKt__CharKt extends CharsKt__CharJVMKt {
    ...
    public static final char digitToChar(int i) {
        ...
        throw new IllegalArgumentException(OooO0O0.OooO00o.OooO00o("Int ", i, " is not a decimal digit"));
    }
    ...
    public static final char digitToChar(int i, int i2) {
        if (!new IntRange(2, 36).contains(i2)) {
            throw new IllegalArgumentException(OooO0O0.OooO00o.OooO00o("Invalid radix: ", i2, ". Valid radix values are in range 2..36"));
        }
        if (i < 0 || i >= i2) {
            throw new IllegalArgumentException(o00O00OO.OooO00o("Digit ", i, " does not represent a valid digit in radix ", i2));
        }
