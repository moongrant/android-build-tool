...
public final class Regex implements Serializable {
    ...
    public static final class C05691 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super String>, Continuation<? super Unit>, Object> {
        ...
        public C05691(CharSequence charSequence, int i, Continuation<? super C05691> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C05691 c05691 = Regex.this.new C05691(this.$input, this.$limit, continuation);
            c05691.L$0 = obj;
            return c05691;
        }
        ...
        public final Object invoke(@NotNull SequenceScope<? super String> sequenceScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C05691) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i2 == 0) {
                ...
                if (this.$limit != 1 && matcher.find()) {
                    ...
                    i = 0;
                    string = c05691.$input.subSequence(iEnd, matcher.start()).toString();
                    c05691.L$0 = sequenceScope;
                    c05691.L$1 = matcher;
                    c05691.I$0 = i;
                    c05691.label = 2;
                    if (sequenceScope.yield(string, c05691) == coroutine_suspended) {
                    ...
                    CharSequence charSequence = c05691.$input;
                    string2 = charSequence.subSequence(iEnd, charSequence.length()).toString();
                    c05691.L$0 = null;
                    c05691.L$1 = null;
                    c05691.label = 3;
                    if (sequenceScope.yield(string2, c05691) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                ...
                if (i2 != 1) {
                    if (i2 == 2) {
                        ...
                        iEnd = matcher.end();
                        i++;
                        if (i != c05691.$limit - 1 || !matcher.find()) {
                            CharSequence charSequence2 = c05691.$input;
                        ...
                        CharSequence charSequence3 = c05691.$input;
    ...
    public final Sequence<MatchResult> findAll(@NotNull final CharSequence input, final int startIndex) {
        ...
        StringBuilder sbOooO00o = o00000O0.OooO00o("Start index out of bounds: ", startIndex, ", input length: ");
    ...
    public final Sequence<String> splitToSequence(@NotNull CharSequence input, int limit) {
        Intrinsics.checkNotNullParameter(input, "input");
        StringsKt__StringsKt.requireNonNegativeLimit(limit);
        return SequencesKt.sequence(new C05691(input, limit, null));
    }
