...
public class StringsKt__StringsJVMKt extends StringsKt__StringNumberConversionsKt {
    ...
    private static final String format(String str, Object... args) {
        ...
        return OooO0OO.OooO00o(args, args.length, str, "format(this, *args)");
    }
    ...
    public static String repeat(@NotNull CharSequence charSequence, int i) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        if (!(i >= 0)) {
            throw new IllegalArgumentException(OooOOO0.OooO00o("Count 'n' must be non-negative, but was ", i, '.').toString());
        }
        if (i == 0) {
            return "";
        }
        ...
        IntIterator intIteratorOooO00o = kotlin.collections.OooO00o.OooO00o(1, i);
    ...
    public static final String replace(@NotNull String str, @NotNull String str2, @NotNull String str3, boolean z) {
        com.facebook.OooO00o.OooO0O0(str, "<this>", str2, "oldValue", str3, "newValue");
        int i = 0;
    ...
    private static final String format(StringCompanionObject stringCompanionObject, String format, Object... args) {
        ...
        Intrinsics.checkNotNullParameter(format, "format");
        Intrinsics.checkNotNullParameter(args, "args");
        return OooO0OO.OooO00o(args, args.length, format, "format(format, *args)");
    }
