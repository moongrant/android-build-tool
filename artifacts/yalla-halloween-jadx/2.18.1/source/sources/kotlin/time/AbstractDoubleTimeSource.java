...
public abstract class AbstractDoubleTimeSource implements TimeSource {
    ...
    public static final class DoubleTimeMark implements TimeMark {
        ...
        public long mo1835elapsedNowUwyO8pc() {
            return Duration.m1878minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }
        ...
        public TimeMark mo1836minusLRDsOJo(long j) {
            return TimeMark.DefaultImpls.m1978minusLRDsOJo(this, j);
        }

        @Override // kotlin.time.TimeMark
        @NotNull
        /* JADX INFO: renamed from: plus-LRDsOJo, reason: not valid java name */
        public TimeMark mo1837plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1879plusLRDsOJo(this.offset, duration), null);
        }
    }
    ...
    public TimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m1945getZEROUwyO8pc(), null);
    }
