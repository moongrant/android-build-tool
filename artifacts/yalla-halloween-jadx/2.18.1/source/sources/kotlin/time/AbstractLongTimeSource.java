...
public abstract class AbstractLongTimeSource implements TimeSource {
    ...
    public static final class LongTimeMark implements TimeMark {
        ...
        public TimeMark mo1837plusLRDsOJo(long duration) {
            return new LongTimeMark(this.startedAt, this.timeSource, Duration.m1879plusLRDsOJo(this.offset, duration), null);
        }
    }
    ...
    public TimeMark markNow() {
        return new LongTimeMark(read(), this, Duration.INSTANCE.m1945getZEROUwyO8pc(), null);
    }
