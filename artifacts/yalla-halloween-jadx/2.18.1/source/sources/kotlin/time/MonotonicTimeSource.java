...
public final class MonotonicTimeSource implements TimeSource {
    ...
    public final long m1973adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1982constructorimpl(LongSaturatedMathKt.m1971saturatingAddpTJri5U(timeMark, duration));
    }

    /* JADX INFO: renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m1974elapsedFrom6eNON_k(long timeMark) {
        return LongSaturatedMathKt.saturatingDiff(read(), timeMark);
    }

    @Override // kotlin.time.TimeSource
    public /* bridge */ /* synthetic */ TimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m1981boximpl(m1975markNowz9LOYto());
    }

    /* JADX INFO: renamed from: markNow-z9LOYto, reason: not valid java name */
    public long m1975markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1982constructorimpl(read());
    }
