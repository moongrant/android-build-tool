...
public final class CompletionStateKt {
    ...
    public static final <T> Object recoverResult(@Nullable Object obj, @NotNull Continuation<? super T> continuation) {
        if (obj instanceof CompletedExceptionally) {
            ...
            return Result.m502constructorimpl(ResultKt.createFailure(((CompletedExceptionally) obj).cause));
        }
    ...
    public static final <T> Object toState(@NotNull Object obj, @Nullable Function1<? super Throwable, Unit> function1) {
        ...
        return new CompletedExceptionally(thM505exceptionOrNullimpl, false, 2, null);
    }
    ...
    public static final <T> Object toState(@NotNull Object obj, @NotNull CancellableContinuation<?> cancellableContinuation) {
        Throwable thM505exceptionOrNullimpl = Result.m505exceptionOrNullimpl(obj);
        return thM505exceptionOrNullimpl == null ? obj : new CompletedExceptionally(thM505exceptionOrNullimpl, false, 2, null);
    }
}
