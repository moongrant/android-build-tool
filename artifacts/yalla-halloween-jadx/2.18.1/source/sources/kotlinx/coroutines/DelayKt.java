...
public final class DelayKt {
    ...
    public static final Object delay(long j, @NotNull Continuation<? super Unit> continuation) {
        ...
        cancellableContinuationImpl.initCancellability();
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl.get$context()).mo2063scheduleResumeAfterDelay(j, cancellableContinuationImpl);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m2001delayVtjQ1oo(long j, @NotNull Continuation<? super Unit> continuation) {
        Object objDelay = delay(m2002toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2002toDelayMillisLRDsOJo(long j) {
        if (Duration.m1842compareToLRDsOJo(j, Duration.INSTANCE.m1945getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1861getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
