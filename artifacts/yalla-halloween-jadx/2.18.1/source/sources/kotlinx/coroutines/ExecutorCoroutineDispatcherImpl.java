...
public final class ExecutorCoroutineDispatcherImpl extends ExecutorCoroutineDispatcher implements Delay {
    ...
    public void mo2062dispatch(@NotNull CoroutineContext context, @NotNull Runnable block) {
        ...
        try {
            ...
            Dispatchers.getIO().mo2062dispatch(context, block);
        }
    }
    ...
    public void mo2063scheduleResumeAfterDelay(long timeMillis, @NotNull CancellableContinuation<? super Unit> continuation) {
        Executor executor = getExecutor();
        ScheduledExecutorService scheduledExecutorService = executor instanceof ScheduledExecutorService ? (ScheduledExecutorService) executor : null;
        ...
        if (scheduledFutureScheduleBlock != null) {
            ...
            DefaultExecutor.INSTANCE.mo2063scheduleResumeAfterDelay(timeMillis, continuation);
        }
    }
