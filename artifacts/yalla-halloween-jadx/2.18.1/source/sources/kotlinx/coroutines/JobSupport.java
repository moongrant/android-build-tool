...
public class JobSupport implements Job, ChildJob, ParentJob, SelectClause0 {
    ...
    public static final class Finishing implements Incomplete {
        ...
        public final void addExceptionLocked(@NotNull Throwable exception) {
            ...
            if (!(obj instanceof Throwable)) {
                if (!(obj instanceof ArrayList)) {
                    throw new IllegalStateException(com.facebook.OooO00o.OooO00o("State is ", obj));
                }
        ...
        public String toString() {
            StringBuilder sbOooO0o0 = OooO00o.OooO00o.OooO0o0("Finishing[cancelling=");
            sbOooO0o0.append(isCancelling());
            sbOooO0o0.append(", completing=");
            sbOooO0o0.append(isCompleting());
            sbOooO0o0.append(", rootCause=");
            sbOooO0o0.append(getRootCause());
            sbOooO0o0.append(", exceptions=");
            sbOooO0o0.append(get_exceptionsHolder());
            sbOooO0o0.append(", list=");
            sbOooO0o0.append(getList());
            sbOooO0o0.append(']');
        ...
        while (true) {
            ...
            if (!incomplete.getIsActive()) {
                ...
                if (objTryMakeCompleting == JobSupportKt.COMPLETING_ALREADY) {
                    throw new IllegalStateException(com.facebook.OooO00o.OooO00o("Cannot happen in ", state$kotlinx_coroutines_core));
                }
    ...
    private final int startInternal(Object state) {
        ...
        if (state instanceof Empty) {
            ...
            } while (atomicReferenceFieldUpdater.get(this) == state);
            if (!z) {
                return -1;
            }
            onStart();
        ...
        } while (atomicReferenceFieldUpdater2.get(this) == state);
        if (!z) {
            return -1;
        }
        onStart();
    ...
    private final boolean tryFinalizeSimpleState(Incomplete state, Object update) throws Throwable {
        ...
        while (true) {
            if (atomicReferenceFieldUpdater.compareAndSet(this, state, objBoxIncomplete)) {
                z = true;
                break;
            }
    ...
    public CancellationException getChildJobCancellationCause() {
        ...
        if (state$kotlinx_coroutines_core instanceof Finishing) {
            ...
            if (state$kotlinx_coroutines_core instanceof Incomplete) {
                throw new IllegalStateException(com.facebook.OooO00o.OooO00o("Cannot be cancelling child in this state: ", state$kotlinx_coroutines_core));
            }
            rootCause = null;
        }
        ...
        StringBuilder sbOooO0o0 = OooO00o.OooO00o.OooO0o0("Parent job is ");
        sbOooO0o0.append(stateString(state$kotlinx_coroutines_core));
        return new JobCancellationException(sbOooO0o0.toString(), rootCause, this);
    }
    ...
    public final String toDebugString() {
        ...
        sb.append('{');
        return o00oO0o.OooO0O0(sb, stateString(getState$kotlinx_coroutines_core()), '}');
    }
        ...
        while (true) {
            ...
            if (state$kotlinx_coroutines_core instanceof Empty) {
                ...
                if (empty.getIsActive()) {
                    AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = _state$FU;
                    while (true) {
                        if (atomicReferenceFieldUpdater.compareAndSet(this, state$kotlinx_coroutines_core, jobNodeMakeNode)) {
                            z = true;
                            break;
                        }
