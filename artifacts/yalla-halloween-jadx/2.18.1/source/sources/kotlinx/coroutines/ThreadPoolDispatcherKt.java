...
public final class ThreadPoolDispatcherKt {
    ...
    public static final ExecutorCoroutineDispatcher newFixedThreadPoolContext(final int i, @NotNull final String str) {
        if (!(i >= 1)) {
            throw new IllegalArgumentException(OooO0O0.OooO00o.OooO00o("Expected at least one thread, but ", i, " specified").toString());
        }
        ...
        return ExecutorsKt.from((ExecutorService) Executors.newScheduledThreadPool(i, new ThreadFactory() { // from class: kotlinx.coroutines.OooO00o
            ...
            public final Thread newThread(Runnable runnable) {
                return ThreadPoolDispatcherKt.m2009newFixedThreadPoolContext$lambda1(i, str, atomicInteger, runnable);
            }
        }));
    }
    ...
    public static final Thread m2009newFixedThreadPoolContext$lambda1(int i, String str, AtomicInteger atomicInteger, Runnable runnable) {
        if (i != 1) {
