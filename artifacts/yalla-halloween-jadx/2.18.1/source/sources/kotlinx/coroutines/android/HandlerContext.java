...
public final class HandlerContext extends HandlerDispatcher {
    ...
    public static final void m2012invokeOnTimeout$lambda3(HandlerContext handlerContext, Runnable runnable) {
        ...
        if (this.handler.postDelayed(block, RangesKt.coerceAtMost(timeMillis, DurationKt.MAX_MILLIS))) {
            return new DisposableHandle() { // from class: kotlinx.coroutines.android.OooO00o
                ...
                public final void dispose() {
                    HandlerContext.m2012invokeOnTimeout$lambda3(this.f26414Oooo0o, block);
                }
            };
        }
        cancelOnRejection(context, block);
    ...
    public void mo2063scheduleResumeAfterDelay(long timeMillis, @NotNull final CancellableContinuation<? super Unit> continuation) {
    ...
    public String toString() {
        ...
        return this.invokeImmediately ? OooOo00.OooO0Oo(string, ".immediate") : string;
    }
