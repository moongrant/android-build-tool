...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM502constructorimpl = Result.m502constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), objArr2 == true ? 1 : 0, 2, objArr == true ? 1 : 0));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM502constructorimpl = Result.m502constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m508isFailureimpl(objM502constructorimpl) ? null : objM502constructorimpl);
    }
    ...
    public static final Object awaitFrame(@NotNull Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo2062dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1
    ...
    public static final void postFrameCallback(Choreographer choreographer2, final CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() { // from class: kotlinx.coroutines.android.OooO0O0
            ...
            public final void doFrame(long j) {
                HandlerDispatcherKt.m2013postFrameCallback$lambda6(cancellableContinuation, j);
            }
        });
    }
    ...
    public static final void m2013postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
