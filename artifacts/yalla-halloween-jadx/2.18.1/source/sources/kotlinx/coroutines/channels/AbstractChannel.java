...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
            ...
            while (true) {
                ...
                if (objPollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause != null) {
                        ...
                        orCreateCancellableContinuation.resumeWith(Result.m502constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                        break;
                    }
                    Result.Companion companion2 = Result.INSTANCE;
                    orCreateCancellableContinuation.resumeWith(Result.m502constructorimpl(Boxing.boxBoolean(false)));
                    break;
                }
    ...
    public static class ReceiveElement<E> extends Receive<E> {
        ...
        public void resumeReceiveClosed(@NotNull Closed<?> closed) {
            if (this.receiveMode != 1) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m502constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
            } else {
                CancellableContinuation<Object> cancellableContinuation2 = this.cont;
                ChannelResult channelResultM2022boximpl = ChannelResult.m2022boximpl(ChannelResult.INSTANCE.m2035closedJP2dKIU(closed.closeCause));
                Result.Companion companion2 = Result.INSTANCE;
                cancellableContinuation2.resumeWith(Result.m502constructorimpl(channelResultM2022boximpl));
            }
        }

        @Nullable
        public final Object resumeValue(E value) {
            return this.receiveMode == 1 ? ChannelResult.m2022boximpl(ChannelResult.INSTANCE.m2037successJP2dKIU(value)) : value;
        }

        @Override // kotlinx.coroutines.internal.LockFreeLinkedListNode
        @NotNull
        public String toString() {
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("ReceiveElement@");
            sbOooO0o0.append(DebugStringsKt.getHexAddress(this));
            sbOooO0o0.append("[receiveMode=");
            return o0O0ooO.OooO00o(sbOooO0o0, this.receiveMode, ']');
        }
    ...
    public static class ReceiveHasNext<E> extends Receive<E> {
        ...
        @NotNull
        public String toString() {
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("ReceiveHasNext@");
            sbOooO0o0.append(DebugStringsKt.getHexAddress(this));
    ...
    public static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        public void completeResumeReceive(E value) throws Throwable {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m2022boximpl(ChannelResult.INSTANCE.m2037successJP2dKIU(value)) : value, this.select.getCompletion(), resumeOnCancellationFun(value));
        }
        ...
        public void resumeReceiveClosed(@NotNull Closed<?> closed) throws Throwable {
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m2022boximpl(ChannelResult.INSTANCE.m2035closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                }
            }
        }
        ...
        @NotNull
        public String toString() {
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("ReceiveSelect@");
            sbOooO0o0.append(DebugStringsKt.getHexAddress(this));
            sbOooO0o0.append('[');
    ...
    public final class RemoveReceiveOnCancel extends BeforeResumeCancelHandler {
        ...
        @NotNull
        public String toString() {
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("RemoveReceiveOnCancel[");
            sbOooO0o0.append(this.receive);
            sbOooO0o0.append(']');
            return sbOooO0o0.toString();
        }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) throws Throwable {
        ...
        if (!z) {
            if (i != 1) {
                ...
                UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m2022boximpl(z ? companion.m2035closedJP2dKIU(((Closed) obj).closeCause) : companion.m2037successJP2dKIU(obj)), selectInstance.getCompletion());
                return;
            }
        }
        if (i == 0) {
        ...
        if (i == 1 && selectInstance.trySelect()) {
            UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m2022boximpl(ChannelResult.INSTANCE.m2035closedJP2dKIU(((Closed) obj).closeCause)), selectInstance.getCompletion());
        }
    }
    ...
    public void onCancelIdempotent(boolean wasClosed) {
        ...
        Object objM2053constructorimpl$default = InlineList.m2053constructorimpl$default(null, 1, null);
        while (true) {
            LockFreeLinkedListNode prevNode = closedForSend.getPrevNode();
            if (prevNode instanceof LockFreeLinkedListHead) {
                mo2014onCancelIdempotentListww6eGU(objM2053constructorimpl$default, closedForSend);
                return;
            } else if (prevNode.mo2061remove()) {
                objM2053constructorimpl$default = InlineList.m2058plusFjFbRPM(objM2053constructorimpl$default, (Send) prevNode);
            } else {
                prevNode.helpRemove();
            }
        }
    ...
    public void mo2014onCancelIdempotentListww6eGU(@NotNull Object list, @NotNull Closed<?> closed) {
        if (list == null) {
            return;
        }
    ...
    public final Object mo2015receiveCatchingJP2dKIU(@NotNull Continuation<? super ChannelResult<? extends E>> continuation) {
        ...
        if (continuation instanceof AbstractChannel$receiveCatching$1) {
            ...
            if ((i & Integer.MIN_VALUE) != 0) {
                abstractChannel$receiveCatching$1.label = i - Integer.MIN_VALUE;
            } else {
        ...
        if (i2 == 0) {
            ...
            Object objPollInternal = pollInternal();
            if (objPollInternal != AbstractChannelKt.POLL_FAILED) {
                return objPollInternal instanceof Closed ? ChannelResult.INSTANCE.m2035closedJP2dKIU(((Closed) objPollInternal).closeCause) : ChannelResult.INSTANCE.m2037successJP2dKIU(objPollInternal);
            }
    ...
    public final Object mo2016tryReceivePtdJZtk() {
        Object objPollInternal = pollInternal();
        if (objPollInternal == AbstractChannelKt.POLL_FAILED) {
            return ChannelResult.INSTANCE.m2036failurePtdJZtk();
        }
        return objPollInternal instanceof Closed ? ChannelResult.INSTANCE.m2035closedJP2dKIU(((Closed) objPollInternal).closeCause) : ChannelResult.INSTANCE.m2037successJP2dKIU(objPollInternal);
    }
