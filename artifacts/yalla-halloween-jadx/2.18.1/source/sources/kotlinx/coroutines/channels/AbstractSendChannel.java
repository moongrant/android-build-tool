...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    public static final class SendBuffered<E> extends Send {
        ...
        public String toString() {
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("SendBuffered@");
            sbOooO0o0.append(DebugStringsKt.getHexAddress(this));
            sbOooO0o0.append('(');
            return o0.OooO00o(sbOooO0o0, this.element, ')');
        }
    ...
    public static final class SendSelect<E, R> extends Send implements DisposableHandle {
        ...
        @NotNull
        public String toString() {
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("SendSelect@");
            sbOooO0o0.append(DebugStringsKt.getHexAddress(this));
            sbOooO0o0.append('(');
            sbOooO0o0.append(getElement());
            sbOooO0o0.append(")[");
    ...
    private final String getQueueDebugStateString() {
        ...
        StringBuilder sbOooO00o = Oooo0.OooO00o(string, ",queueSize=");
        sbOooO00o.append(countQueueSize());
    ...
    private final void helpClose(Closed<?> closed) {
        ...
        while (true) {
            ...
            if (receive == null) {
                break;
            } else if (receive.mo2061remove()) {
                objM2053constructorimpl$default = InlineList.m2058plusFjFbRPM(objM2053constructorimpl$default, receive);
            } else {
                receive.helpRemove();
            }
        }
        if (objM2053constructorimpl$default != null) {
            if (objM2053constructorimpl$default instanceof ArrayList) {
                ArrayList arrayList = (ArrayList) objM2053constructorimpl$default;
                for (int size = arrayList.size() - 1; -1 < size; size--) {
                    ((Receive) arrayList.get(size)).resumeReceiveClosed(closed);
                }
            } else {
                ((Receive) objM2053constructorimpl$default).resumeReceiveClosed(closed);
            }
        }
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 == null || (undeliveredElementExceptionCallUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) == null) {
            ...
            continuation.resumeWith(Result.m502constructorimpl(ResultKt.createFailure(sendException)));
        } else {
            ...
            continuation.resumeWith(Result.m502constructorimpl(ResultKt.createFailure(undeliveredElementExceptionCallUndeliveredElementCatchingException$default)));
        }
    }
            ...
            if (objOfferSelectInternal != AbstractChannelKt.OFFER_FAILED && objOfferSelectInternal != AtomicKt.RETRY_ATOMIC) {
                if (objOfferSelectInternal == AbstractChannelKt.OFFER_SUCCESS) {
                    ...
                    if (!(objOfferSelectInternal instanceof Closed)) {
                        throw new IllegalStateException(com.facebook.OooO00o.OooO00o("offerSelectInternal returned ", objOfferSelectInternal));
                    }
    ...
    public final Object sendSuspend(E e, Continuation<? super Unit> continuation) {
        ...
        while (true) {
            if (isFullImpl()) {
                ...
                if (objEnqueueSend != AbstractChannelKt.ENQUEUE_FAILED && !(objEnqueueSend instanceof Receive)) {
                    throw new IllegalStateException(com.facebook.OooO00o.OooO00o("enqueueSend returned ", objEnqueueSend));
                }
                objOfferInternal = offerInternal(e);
                if (objOfferInternal == AbstractChannelKt.OFFER_SUCCESS) {
                    Result.Companion companion = Result.INSTANCE;
                    orCreateCancellableContinuation.resumeWith(Result.m502constructorimpl(Unit.INSTANCE));
                    break;
                }
                if (objOfferInternal != AbstractChannelKt.OFFER_FAILED) {
                    if (objOfferInternal instanceof Closed) {
                        throw new IllegalStateException(com.facebook.OooO00o.OooO00o("offerInternal returned ", objOfferInternal));
                    }
    ...
    public final Object mo2017trySendJP2dKIU(E element) {
        Object objOfferInternal = offerInternal(element);
        if (objOfferInternal == AbstractChannelKt.OFFER_SUCCESS) {
            return ChannelResult.INSTANCE.m2037successJP2dKIU(Unit.INSTANCE);
        }
        if (objOfferInternal == AbstractChannelKt.OFFER_FAILED) {
            Closed<?> closedForSend = getClosedForSend();
            return closedForSend == null ? ChannelResult.INSTANCE.m2036failurePtdJZtk() : ChannelResult.INSTANCE.m2035closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        }
        if (objOfferInternal instanceof Closed) {
            return ChannelResult.INSTANCE.m2035closedJP2dKIU(helpCloseAndGetSendException((Closed) objOfferInternal));
        }
        throw new IllegalStateException(com.facebook.OooO00o.OooO00o("trySend returned ", objOfferInternal));
    }
