...
public final class ArrayBroadcastChannel<E> extends AbstractSendChannel<E> implements BroadcastChannel<E> {
    ...
    public ArrayBroadcastChannel(int i) {
        ...
        this.capacity = i;
        if (!(i >= 1)) {
            throw new IllegalArgumentException(OooO00o.OooO00o("ArrayBroadcastChannel capacity must be at least 1, but ", i, " was specified").toString());
        }
    ...
    public String getBufferDebugString() {
        ...
        sbOooO0o0.append(this.buffer.length);
        sbOooO0o0.append(",size=");
        return o0O0ooO.OooO00o(sbOooO0o0, get_size(), ')');
    }
