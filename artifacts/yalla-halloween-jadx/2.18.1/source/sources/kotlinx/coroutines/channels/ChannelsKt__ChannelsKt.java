...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            return ChannelResult.m2022boximpl(Result.m509isSuccessimpl(objM502constructorimpl) ? ChannelResult.INSTANCE.m2037successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m2035closedJP2dKIU(Result.m505exceptionOrNullimpl(objM502constructorimpl)));
        }
    }
    ...
    public static final <E> void sendBlocking(@NotNull SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m2032isSuccessimpl(sendChannel.mo2017trySendJP2dKIU(e))) {
            return;
        }
    ...
    public static final <E> Object trySendBlocking(@NotNull SendChannel<? super E> sendChannel, E e) {
        Object objMo2017trySendJP2dKIU = sendChannel.mo2017trySendJP2dKIU(e);
        if (objMo2017trySendJP2dKIU instanceof ChannelResult.Failed) {
