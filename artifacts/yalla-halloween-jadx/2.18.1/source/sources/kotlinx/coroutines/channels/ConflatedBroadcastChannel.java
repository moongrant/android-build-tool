...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    public final void closeSubscriber(Subscriber<E> subscriber) {
        ...
        do {
            ...
            if (!(obj instanceof State)) {
                throw new IllegalStateException(OooO00o.OooO00o("Invalid state ", obj));
            }
    ...
    private final Closed offerInternal(E element) {
        ...
        do {
            try {
                ...
                State state = new State(element, ((State) obj).subscribers);
                AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = _state$FU;
                while (true) {
    ...
    private final Subscriber<E>[] removeSubscriber(Subscriber<E>[] list, Subscriber<E> subscriber) {
        ...
        ArraysKt.OooO0o0(list, subscriberArr, 0, 0, iIndexOf, 6);
        ArraysKt.OooO0o0(list, subscriberArr, iIndexOf, iIndexOf + 1, 0, 8);
        return subscriberArr;
    }
    ...
    public boolean cancel(@Nullable Throwable cause) {
        ...
        do {
            ...
            Closed closed = cause == null ? CLOSED : new Closed(cause);
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = _state$FU;
            while (true) {
    ...
    public Object mo2017trySendJP2dKIU(E element) {
        Closed closedOfferInternal = offerInternal(element);
        return closedOfferInternal != null ? ChannelResult.INSTANCE.m2035closedJP2dKIU(closedOfferInternal.getSendException()) : ChannelResult.INSTANCE.m2037successJP2dKIU(Unit.INSTANCE);
    }
