...
public interface ReceiveChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(@NotNull ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo2016tryReceivePtdJZtk = receiveChannel.mo2016tryReceivePtdJZtk();
            if (ChannelResult.m2032isSuccessimpl(objMo2016tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2028getOrThrowimpl(objMo2016tryReceivePtdJZtk);
            }
            Throwable thM2026exceptionOrNullimpl = ChannelResult.m2026exceptionOrNullimpl(objMo2016tryReceivePtdJZtk);
            if (thM2026exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM2026exceptionOrNullimpl);
        }
        ...
        public static <E> Object receiveOrNull(@NotNull ReceiveChannel<? extends E> receiveChannel, @NotNull Continuation<? super E> continuation) {
            ...
            if (i2 == 0) {
                ...
                objMo2015receiveCatchingJP2dKIU = receiveChannel.mo2015receiveCatchingJP2dKIU(anonymousClass1);
            ...
            return ChannelResult.m2027getOrNullimpl(objMo2015receiveCatchingJP2dKIU);
        }
    ...
    Object mo2015receiveCatchingJP2dKIU(@NotNull Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo2016tryReceivePtdJZtk();
}
