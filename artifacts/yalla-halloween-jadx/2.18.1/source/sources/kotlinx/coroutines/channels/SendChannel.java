...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(@NotNull SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2032isSuccessimpl(objMo2017trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2026exceptionOrNullimpl = ChannelResult.m2026exceptionOrNullimpl(objMo2017trySendJP2dKIU);
    ...
    Object mo2017trySendJP2dKIU(E element);
}
