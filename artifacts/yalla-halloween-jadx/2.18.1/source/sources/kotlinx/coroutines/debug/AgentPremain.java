...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM502constructorimpl = Result.m502constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM502constructorimpl = Result.m502constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m508isFailureimpl(objM502constructorimpl) ? null : objM502constructorimpl);
    ...
    private final void installSignalHandler() {
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: o0ooOO0o.oO00OOo0
            });
    ...
    private static final void m2039installSignalHandler$lambda1(Signal signal) {
