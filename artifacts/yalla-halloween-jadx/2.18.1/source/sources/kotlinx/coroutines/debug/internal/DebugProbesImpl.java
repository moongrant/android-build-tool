...
public final class DebugProbesImpl {
    ...
    private final void build(Job job, Map<Job, DebugCoroutineInfoImpl> map, StringBuilder sb, String str) {
        ...
        if (debugCoroutineInfoImpl != null) {
            ...
            OooO0O0.OooO00o(sbOooO0o0, getDebugString(job), ", continuation is ", str2, " at line ");
            sbOooO0o0.append(stackTraceElement);
            sbOooO0o0.append('\n');
            sb.append(sbOooO0o0.toString());
            str = str + '\t';
        } else if (!(job instanceof ScopeCoroutine)) {
            StringBuilder sbOooO0o1 = OooO00o.OooO0o0(str);
            sbOooO0o1.append(getDebugString(job));
            sbOooO0o1.append('\n');
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> coroutineTrace) {
        ...
        try {
            ...
            objM502constructorimpl = Result.m502constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
        ...
        StackTraceElement[] stackTraceElementArr = (StackTraceElement[]) objM502constructorimpl;
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        try {
            ...
            objM502constructorimpl = Result.m502constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(objNewInstance, 1));
            if (Result.m508isFailureimpl(objM502constructorimpl)) {
                objM502constructorimpl = null;
            }
            return (Function1) objM502constructorimpl;
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM502constructorimpl = Result.m502constructorimpl(ResultKt.createFailure(th));
        }
    ...
    private final boolean isInternalMethod(StackTraceElement stackTraceElement) {
        return StringsKt.OooOoOO(stackTraceElement.getClassName(), "kotlinx.coroutines");
    }
    ...
    public final Object[] dumpCoroutinesInfoAsJsonAndReferences() {
        ...
        for (DebugCoroutineInfo debugCoroutineInfo : listDumpCoroutinesInfo) {
            ...
            StringBuilder sbOooO0OO = OooO0o.OooO0OO("\n                {\n                    \"name\": ", stringWithQuotes, ",\n                    \"id\": ");
            CoroutineId coroutineId = (CoroutineId) context.get(CoroutineId.INSTANCE);
            if (coroutineId != null) {
                lValueOf = Long.valueOf(coroutineId.getId());
            }
            sbOooO0OO.append(lValueOf);
            sbOooO0OO.append(",\n                    \"dispatcher\": ");
            sbOooO0OO.append(stringWithQuotes2);
            sbOooO0OO.append(",\n                    \"sequenceNumber\": ");
            sbOooO0OO.append(debugCoroutineInfo.getSequenceNumber());
            sbOooO0OO.append(",\n                    \"state\": \"");
            sbOooO0OO.append(debugCoroutineInfo.getState());
            sbOooO0OO.append("\"\n                } \n                ");
            arrayList3.add(StringsKt.trimIndent(sbOooO0OO.toString()));
        ...
        return new Object[]{o00oO0o.OooO0O0(o00O0O0O.OooO00o('['), CollectionsKt___CollectionsKt.joinToString$default(arrayList3, null, null, null, 0, null, null, 63, null), ']'), array, array2, array3};
    }
    ...
    public final String enhanceStackTraceWithThreadDumpAsJson(@NotNull DebugCoroutineInfo info) {
        ...
        for (StackTraceElement stackTraceElement : listEnhanceStackTraceWithThreadDump) {
            ...
            sbOooO0o0.append(stackTraceElement.getClassName());
            sbOooO0o0.append("\",\n                    \"methodName\": \"");
            sbOooO0o0.append(stackTraceElement.getMethodName());
            sbOooO0o0.append("\",\n                    \"fileName\": ");
            String fileName = stackTraceElement.getFileName();
            sbOooO0o0.append(fileName != null ? toStringWithQuotes(fileName) : null);
            sbOooO0o0.append(",\n                    \"lineNumber\": ");
            sbOooO0o0.append(stackTraceElement.getLineNumber());
            sbOooO0o0.append("\n                }\n                ");
            arrayList.add(StringsKt.trimIndent(sbOooO0o0.toString()));
        }
        return o00oO0o.OooO0O0(o00O0O0O.OooO00o('['), CollectionsKt___CollectionsKt.joinToString$default(arrayList, null, null, null, 0, null, null, 63, null), ']');
    }
