...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final class C06153 extends SuspendLambda implements Function2<ProducerScope<? super Unit>, Continuation<? super Unit>, Object> {
        ...
        public C06153(long j, long j2, Continuation<? super C06153> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C06153 c06153 = new C06153(this.$initialDelayMillis, this.$delayMillis, continuation);
            c06153.L$0 = obj;
            return c06153;
        }
        ...
        public final Object invoke(@NotNull ProducerScope<? super Unit> producerScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C06153) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final java.lang.Object invokeSuspend(@org.jetbrains.annotations.NotNull java.lang.Object r8) {
            ...
            L51:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__DelayKt.C06153.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
    ...
    public static final class C06162<T> extends SuspendLambda implements Function3<CoroutineScope, FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        ...
        public C06162(long j, Flow<? extends T> flow, Continuation<? super C06162> continuation) {
        ...
        public final Object invoke(@NotNull CoroutineScope coroutineScope, @NotNull FlowCollector<? super T> flowCollector, @Nullable Continuation<? super Unit> continuation) {
            C06162 c06162 = new C06162(this.$periodMillis, this.$this_sample, continuation);
            c06162.L$0 = coroutineScope;
            c06162.L$1 = flowCollector;
            return c06162.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Flow<T> m2043debounceHG0u8IE(@NotNull Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m2002toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> debounceDuration(@NotNull Flow<? extends T> flow, @NotNull final Function1<? super T, Duration> function1) {
        return debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt.debounce.3
            ...
            @NotNull
            public final Long invoke(T t) {
                return Long.valueOf(DelayKt.m2002toDelayMillisLRDsOJo(function1.invoke(t).getRawValue()));
            }
        });
    }
    ...
    public static final ReceiveChannel<Unit> fixedPeriodTicker(@NotNull CoroutineScope coroutineScope, long j, long j2) {
        ...
        if (j2 >= 0) {
            return ProduceKt.produce$default(coroutineScope, null, 0, new C06153(j2, j, null), 1, null);
        }
    ...
    public static final <T> Flow<T> sample(@NotNull Flow<? extends T> flow, long j) {
        if (j > 0) {
            return FlowCoroutineKt.scopedFlow(new C06162(j, flow, null));
        }
    ...
    public static final <T> Flow<T> m2044sampleHG0u8IE(@NotNull Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m2002toDelayMillisLRDsOJo(j));
    }
