...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    public static final class AnonymousClass2<T> implements FlowCollector {
        ...
        public static final class C06171 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
            public int label;

            public C06171(Continuation<? super C06171> continuation) {
        ...
        public static final <T> Flow<T> m2047catch(@NotNull Flow<? extends T> flow, @NotNull Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        ...
        public static final <T> Flow<T> retry(@NotNull Flow<? extends T> flow, long j, @NotNull Function2<? super Throwable, ? super Continuation<? super Boolean>, ? extends Object> function2) {
            ...
            throw new IllegalArgumentException(androidx.viewpager2.adapter.OooO00o.OooO00o("Expected positive amount of retries, but had ", j).toString());
        }
