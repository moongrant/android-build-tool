...
final /* synthetic */ class FlowKt__LimitKt {
    ...
    public static final class C06181<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
        ...
        public C06181(Flow<? extends T> flow, Function3<? super FlowCollector<? super R>, ? super T, ? super Continuation<? super Boolean>, ? extends Object> function3, Continuation<? super C06181> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C06181 c06181 = new C06181(this.$this_transformWhile, this.$transform, continuation);
            c06181.L$0 = obj;
            return c06181;
        }
        ...
        public final Object invoke(@NotNull FlowCollector<? super R> flowCollector, @Nullable Continuation<? super Unit> continuation) {
            return ((C06181) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final java.lang.Object invokeSuspend(@org.jetbrains.annotations.NotNull java.lang.Object r6) {
            ...
            L3d:
                ...
                return r6
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__LimitKt.C06181.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
    ...
    public static final <T> Flow<T> drop(@NotNull final Flow<? extends T> flow, final int i) {
        ...
        throw new IllegalArgumentException(android.support.v4.media.OooO00o.OooO00o("Drop count should be non-negative, but had ", i).toString());
    }
    ...
    public static final <T> Flow<T> take(@NotNull Flow<? extends T> flow, int i) {
        ...
        throw new IllegalArgumentException(OooO0O0.OooO00o.OooO00o("Requested element count ", i, " should be positive").toString());
    }
    ...
    public static final <T, R> Flow<R> transformWhile(@NotNull Flow<? extends T> flow, @BuilderInference @NotNull Function3<? super FlowCollector<? super R>, ? super T, ? super Continuation<? super Boolean>, ? extends Object> function3) {
        return FlowKt.flow(new C06181(flow, function3, null));
    }
}
