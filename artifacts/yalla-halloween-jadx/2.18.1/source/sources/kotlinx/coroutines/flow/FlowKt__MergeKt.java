...
final /* synthetic */ class FlowKt__MergeKt {
    ...
    public static final class C06191<R, T> extends SuspendLambda implements Function3<FlowCollector<? super R>, T, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C06191(Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super C06191> continuation) {
            super(3, continuation);
            this.$transform = function2;
        }
        ...
        @Nullable
        public final Object invoke(@NotNull FlowCollector<? super R> flowCollector, T t, @Nullable Continuation<? super Unit> continuation) {
            C06191 c06191 = new C06191(this.$transform, continuation);
            c06191.L$0 = flowCollector;
            c06191.L$1 = t;
            return c06191.invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final java.lang.Object invokeSuspend(@org.jetbrains.annotations.NotNull java.lang.Object r6) {
            ...
            L45:
                ...
                return r6
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__MergeKt.C06191.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
    ...
    public static final <T> Flow<T> flattenMerge(@NotNull Flow<? extends Flow<? extends T>> flow, int i) {
        ...
        throw new IllegalArgumentException(android.support.v4.media.OooO00o.OooO00o("Expected positive concurrency level, but had ", i).toString());
    }
    ...
    public static final <T, R> Flow<R> mapLatest(@NotNull Flow<? extends T> flow, @BuilderInference @NotNull Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2) {
        return FlowKt.transformLatest(flow, new C06191(function2, null));
    }
