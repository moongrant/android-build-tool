...
final class StartedWhileSubscribed implements SharingStarted {
    ...
    public String toString() {
        ...
        if (this.stopTimeout > 0) {
            StringBuilder sbOooO0o0 = OooO00o.OooO00o.OooO0o0("stopTimeout=");
            sbOooO0o0.append(this.stopTimeout);
            sbOooO0o0.append("ms");
            listCreateListBuilder.add(sbOooO0o0.toString());
        }
        if (this.replayExpiration < Long.MAX_VALUE) {
            StringBuilder sbOooO0o1 = OooO00o.OooO00o.OooO0o0("replayExpiration=");
            sbOooO0o1.append(this.replayExpiration);
            sbOooO0o1.append("ms");
            listCreateListBuilder.add(sbOooO0o1.toString());
        }
        return o00oO0o.OooO0O0(OooO00o.OooO00o.OooO0o0("SharingStarted.WhileSubscribed("), CollectionsKt___CollectionsKt.joinToString$default(CollectionsKt.build(listCreateListBuilder), null, null, null, 0, null, null, 63, null), ')');
    }
}
