...
final class StateFlowSlot extends AbstractSharedFlowSlot<StateFlowImpl<?>> {
    ...
    public final Object awaitPending(@NotNull Continuation<? super Unit> continuation) {
        ...
        if (!z) {
            ...
            cancellableContinuationImpl.resumeWith(Result.m502constructorimpl(Unit.INSTANCE));
        }
    ...
    public final void makePending() {
        while (true) {
            ...
            if (obj == StateFlowKt.NONE) {
                ...
                if (z) {
                    Result.Companion companion = Result.INSTANCE;
                    ((CancellableContinuationImpl) obj).resumeWith(Result.m502constructorimpl(Unit.INSTANCE));
                    return;
                }
            }
        }
