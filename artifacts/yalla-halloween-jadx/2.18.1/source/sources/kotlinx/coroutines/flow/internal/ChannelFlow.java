...
public abstract class ChannelFlow<T> implements FusibleFlow<T> {
    ...
    public String toString() {
        ...
        if (this.context != EmptyCoroutineContext.INSTANCE) {
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("context=");
            sbOooO0o0.append(this.context);
            arrayList.add(sbOooO0o0.toString());
        }
        if (this.capacity != -3) {
            StringBuilder sbOooO0o1 = OooO00o.OooO0o0("capacity=");
            sbOooO0o1.append(this.capacity);
            arrayList.add(sbOooO0o1.toString());
        }
        if (this.onBufferOverflow != BufferOverflow.SUSPEND) {
            StringBuilder sbOooO0o2 = OooO00o.OooO0o0("onBufferOverflow=");
            sbOooO0o2.append(this.onBufferOverflow);
            arrayList.add(sbOooO0o2.toString());
        }
        StringBuilder sb = new StringBuilder();
        sb.append(DebugStringsKt.getClassSimpleName(this));
        sb.append('[');
        return o00oO0o.OooO0O0(sb, CollectionsKt___CollectionsKt.joinToString$default(arrayList, ", ", null, null, 0, null, null, 62, null), ']');
    }
}
