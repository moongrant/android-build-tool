...
public final class CombineKt$zipImpl$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
        ...
        public static final class AnonymousClass1<T> implements FlowCollector {
            ...
            public static final class C02761 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
                public final /* synthetic */ ReceiveChannel<Object> $second;
                public final /* synthetic */ FlowCollector<R> $this_unsafeFlow;
                public final /* synthetic */ Function3<T1, T2, Continuation<? super R>, Object> $transform;
                ...
                public C02761(ReceiveChannel<? extends Object> receiveChannel, FlowCollector<? super R> flowCollector, Function3<? super T1, ? super T2, ? super Continuation<? super R>, ? extends Object> function3, T1 t1, Continuation<? super C02761> continuation) {
                ...
                public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                    return new C02761(this.$second, this.$this_unsafeFlow, this.$transform, this.$value, continuation);
                }

                @Override // kotlin.jvm.functions.Function2
                @Nullable
                public final Object invoke(@NotNull Unit unit, @Nullable Continuation<? super Unit> continuation) {
                    return ((C02761) create(unit, continuation)).invokeSuspend(Unit.INSTANCE);
                }
                ...
                public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
                    Object objMo2015receiveCatchingJP2dKIU;
                    ...
                    if (i != 0) {
                        if (i == 1) {
                            ...
                            objMo2015receiveCatchingJP2dKIU = ((ChannelResult) obj).getHolder();
                        } else if (i == 2) {
                    ...
                    this.label = 1;
                    objMo2015receiveCatchingJP2dKIU = receiveChannel.mo2015receiveCatchingJP2dKIU(this);
                    if (objMo2015receiveCatchingJP2dKIU == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    FlowCollector flowCollector3 = this.$this_unsafeFlow;
                    if (objMo2015receiveCatchingJP2dKIU instanceof ChannelResult.Failed) {
                        Throwable thM2026exceptionOrNullimpl = ChannelResult.m2026exceptionOrNullimpl(objMo2015receiveCatchingJP2dKIU);
                        if (thM2026exceptionOrNullimpl == null) {
                            throw new AbortFlowException(flowCollector3);
                        }
                        throw thM2026exceptionOrNullimpl;
                    }
                    Function3<T1, T2, Continuation<? super R>, Object> function3 = this.$transform;
                    T1 t1 = this.$value;
                    if (objMo2015receiveCatchingJP2dKIU == NullSurrogateKt.NULL) {
                        objMo2015receiveCatchingJP2dKIU = null;
                    }
                    this.L$0 = flowCollector3;
                    this.label = 2;
                    obj = function3.invoke(t1, objMo2015receiveCatchingJP2dKIU, this);
            ...
            public final Object emit(T1 t1, @NotNull Continuation<? super Unit> continuation) {
                ...
                if (i2 == 0) {
                    ...
                    C02761 c02761 = new C02761(this.$second, this.$this_unsafeFlow, this.$transform, t1, null);
                    combineKt$zipImpl$1$1$2$1$emit$1.label = 1;
                    if (ChannelFlowKt.withContextUndispatched(coroutineContext, unit, obj2, c02761, combineKt$zipImpl$1$1$2$1$emit$1) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (i2 != 1) {
