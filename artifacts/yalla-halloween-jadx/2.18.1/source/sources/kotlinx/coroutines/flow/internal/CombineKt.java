    ...
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public static final class C02751<T> implements FlowCollector {
                ...
                public C02751(Channel<IndexedValue<Object>> channel, int i) {
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                try {
                    if (i == 0) {
                        ...
                        C02751 c02751 = new C02751(this.$resultChannel, i2);
                        this.label = 1;
                        if (flow.collect(c02751, this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    } else {
                        if (i != 1) {
        ...
        /* JADX WARN: Code duplicated, block: B:29:0x00e2 A[LOOP:0: B:29:0x00e2->B:52:?, LOOP_START, PHI: r5 r9
          0x00e2: PHI (r5v2 int) = (r5v1 int), (r5v3 int) binds: [B:26:0x00dd, B:52:?] A[DONT_GENERATE, DONT_INLINE]
          0x00e2: PHI (r9v4 kotlin.collections.IndexedValue) = (r9v3 kotlin.collections.IndexedValue), (r9v20 kotlin.collections.IndexedValue) binds: [B:26:0x00dd, B:52:?] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        /* JADX WARN: Code duplicated, block: B:50:0x0107 A[EDGE_INSN: B:50:0x0107->B:36:0x0107 BREAK  A[LOOP:0: B:29:0x00e2->B:52:?], SYNTHETIC] */
         ...
         */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:42:0x012b -> B:21:0x00ba). Please report as a decompilation issue!!! */
