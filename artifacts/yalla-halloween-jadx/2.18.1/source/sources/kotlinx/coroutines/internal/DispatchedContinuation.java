...
public final class DispatchedContinuation<T> extends DispatchedTask<T> implements CoroutineStackFrame, Continuation<T> {
    ...
    public final CancellableContinuationImpl<T> claimReusableCancellableContinuation() {
        ...
        while (true) {
            ...
            if (obj instanceof CancellableContinuationImpl) {
                ...
                throw new IllegalStateException(OooO00o.OooO00o("Inconsistent state ", obj));
            }
        }
    }
    ...
    public final void resumeCancellableWith(@NotNull Object result, @Nullable Function1<? super Throwable, Unit> onCancellation) {
        ...
        if (this.dispatcher.isDispatchNeeded(get$context())) {
            this._state = state;
            this.resumeMode = 1;
            this.dispatcher.mo2062dispatch(get$context(), this);
            return;
        }
        ...
        try {
            ...
            if (job == null || job.isActive()) {
                ...
                resumeWith(Result.m502constructorimpl(ResultKt.createFailure(cancellationException)));
                z = true;
            }
            if (!z) {
                Continuation<T> continuation = this.continuation;
    ...
    public void resumeWith(@NotNull Object result) {
        ...
        if (this.dispatcher.isDispatchNeeded(context)) {
            ...
            this.resumeMode = 0;
            this.dispatcher.mo2062dispatch(context, this);
            return;
        }
        EventLoop eventLoop$kotlinx_coroutines_core = ThreadLocalEventLoop.INSTANCE.getEventLoop$kotlinx_coroutines_core();
        if (eventLoop$kotlinx_coroutines_core.isUnconfinedLoopActive()) {
    ...
    public String toString() {
        StringBuilder sbOooO0o0 = OooO00o.OooO00o.OooO0o0("DispatchedContinuation[");
        sbOooO0o0.append(this.dispatcher);
        sbOooO0o0.append(", ");
        sbOooO0o0.append(DebugStringsKt.toDebugString(this.continuation));
        sbOooO0o0.append(']');
