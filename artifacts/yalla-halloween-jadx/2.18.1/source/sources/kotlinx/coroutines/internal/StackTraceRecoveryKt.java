...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM502constructorimpl2;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM502constructorimpl = Result.m502constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM502constructorimpl = Result.m502constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m505exceptionOrNullimpl(objM502constructorimpl) != null) {
            objM502constructorimpl = baseContinuationImplClass;
        }
        baseContinuationImplClassName = (String) objM502constructorimpl;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM502constructorimpl2 = Result.m502constructorimpl(StackTraceRecoveryKt.class.getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM502constructorimpl2 = Result.m502constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m505exceptionOrNullimpl(objM502constructorimpl2) != null) {
            objM502constructorimpl2 = stackTraceRecoveryClass;
        }
        stackTraceRecoveryClassName = (String) objM502constructorimpl2;
    }
    ...
    public static final StackTraceElement artificialFrame(@NotNull String str) {
        return new StackTraceElement(OooOo00.OooO0Oo("\b\b\b(", str), "\b", "\b", -1);
    }
    ...
    public static final boolean isArtificial(@NotNull StackTraceElement stackTraceElement) {
        return StringsKt.OooOoOO(stackTraceElement.getClassName(), "\b\b\b");
    }
