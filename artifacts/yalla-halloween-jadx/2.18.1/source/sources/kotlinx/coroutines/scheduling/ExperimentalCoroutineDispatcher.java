...
public class ExperimentalCoroutineDispatcher extends ExecutorCoroutineDispatcher {
    ...
    public final CoroutineDispatcher blocking(int parallelism) {
        ...
        throw new IllegalArgumentException(OooO00o.OooO00o("Expected positive parallelism level, but have ", parallelism).toString());
    }
    ...
    public void mo2062dispatch(@NotNull CoroutineContext context, @NotNull Runnable block) {
        try {
            ...
            DefaultExecutor.INSTANCE.mo2062dispatch(context, block);
        }
    }
    ...
    public final CoroutineDispatcher limited(int parallelism) {
        ...
        StringBuilder sbOooO0o0 = OooO00o.OooO00o.OooO0o0("Expected parallelism level lesser than core pool size (");
        sbOooO0o0.append(this.corePoolSize);
        sbOooO0o0.append("), but have ");
        sbOooO0o0.append(parallelism);
