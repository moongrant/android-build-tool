...
public final class MutexImpl implements Mutex, SelectClause2<Object, Mutex> {
    ...
    public final class LockCont extends LockWaiter {
        ...
        public String toString() {
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("LockCont[");
            sbOooO0o0.append(this.owner);
            sbOooO0o0.append(", ");
            sbOooO0o0.append(this.cont);
            sbOooO0o0.append("] for ");
            sbOooO0o0.append(MutexImpl.this);
    ...
    public final class LockSelect<R> extends LockWaiter {
        ...
        @NotNull
        public String toString() {
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("LockSelect[");
            sbOooO0o0.append(this.owner);
            sbOooO0o0.append(", ");
    ...
    public static final class LockedQueue extends LockFreeLinkedListHead {
        ...
        @NotNull
        public String toString() {
            return o0.OooO00o(OooO00o.OooO0o0("LockedQueue["), this.owner, ']');
        }
    }
        ...
        while (true) {
            ...
            if (obj2 instanceof Empty) {
                ...
                if (!(obj2 instanceof OpDescriptor)) {
                    throw new IllegalStateException(com.facebook.OooO00o.OooO00o("Illegal state ", obj2));
                }
    ...
    public boolean isLocked() {
        while (true) {
            ...
            if (!(obj instanceof OpDescriptor)) {
                throw new IllegalStateException(com.facebook.OooO00o.OooO00o("Illegal state ", obj));
            }
                ...
                if (empty.locked != MutexKt.UNLOCKED) {
                    ...
                    if (objPerformAtomicTrySelect == null) {
                        ...
                        if (objPerformAtomicTrySelect != MutexKt.LOCK_FAIL && objPerformAtomicTrySelect != AtomicKt.RETRY_ATOMIC) {
                            throw new IllegalStateException(com.facebook.OooO00o.OooO00o("performAtomicTrySelect(TryLockDesc) returned ", objPerformAtomicTrySelect));
                        }
                    }
                }
    ...
    public String toString() {
        while (true) {
            Object obj = this._state;
            if (obj instanceof Empty) {
                return o0.OooO00o(OooO00o.OooO0o0("Mutex["), ((Empty) obj).locked, ']');
            }
            if (!(obj instanceof OpDescriptor)) {
                if (obj instanceof LockedQueue) {
                    return o0.OooO00o(OooO00o.OooO0o0("Mutex["), ((LockedQueue) obj).owner, ']');
                }
                throw new IllegalStateException(com.facebook.OooO00o.OooO00o("Illegal state ", obj));
            }
            ((OpDescriptor) obj).perform(this);
            ...
            if (obj instanceof Empty) {
                if (owner == null) {
                    ...
                    if (!(empty.locked == owner)) {
                        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("Mutex is locked by ");
                        sbOooO0o0.append(empty.locked);
                        sbOooO0o0.append(" but expected ");
                ...
                if (owner != null) {
                    ...
                    if (!(lockedQueue.owner == owner)) {
                        StringBuilder sbOooO0o1 = OooO00o.OooO0o0("Mutex is locked by ");
                        sbOooO0o1.append(lockedQueue.owner);
                        sbOooO0o1.append(" but expected ");
                        sbOooO0o1.append(owner);
