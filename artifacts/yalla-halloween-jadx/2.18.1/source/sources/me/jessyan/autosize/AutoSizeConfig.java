...
public final class AutoSizeConfig {
    ...
    public AutoSizeConfig init(final Application application, boolean z, AutoAdaptStrategy autoAdaptStrategy) {
        ...
        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("designWidthInDp = ");
        sbOooO0o0.append(this.mDesignWidthInDp);
        sbOooO0o0.append(", designHeightInDp = ");
        sbOooO0o0.append(this.mDesignHeightInDp);
        sbOooO0o0.append(", screenWidth = ");
        sbOooO0o0.append(this.mScreenWidth);
        sbOooO0o0.append(", screenHeight = ");
        sbOooO0o0.append(this.mScreenHeight);
        AutoSizeLog.d(sbOooO0o0.toString());
        ...
        application.registerComponentCallbacks(new ComponentCallbacks() { // from class: me.jessyan.autosize.AutoSizeConfig.1
            ...
            public void onConfigurationChanged(Configuration configuration2) {
                if (configuration2 != null) {
                    if (configuration2.fontScale > ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE) {
