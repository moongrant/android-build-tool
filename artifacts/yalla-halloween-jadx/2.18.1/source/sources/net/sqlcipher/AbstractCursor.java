...
public abstract class AbstractCursor implements CrossProcessCursor, Cursor {
    ...
    public int getColumnIndexOrThrow(String str) {
        ...
        throw new IllegalArgumentException(OooO0OO.OooO00o("column '", str, "' does not exist"));
    }
    ...
    public boolean update(int i, Object obj) {
        ...
        if (lValueOf == null) {
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("null rowid. mRowIdColumnIndex = ");
            sbOooO0o0.append(this.mRowIdColumnIndex);
