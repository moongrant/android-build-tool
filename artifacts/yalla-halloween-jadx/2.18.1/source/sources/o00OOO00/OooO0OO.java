...
import p508o0o00oOo.o000O000;

/* JADX INFO: loaded from: classes.dex */
public final class OooO0OO extends Lambda implements Function2<oOO00O, Integer, Unit> {

    /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
    public final /* synthetic */ BaseFragmentActivity f31671Oooo0o;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooO0OO(BaseFragmentActivity baseFragmentActivity) {
        super(2);
        this.f31671Oooo0o = baseFragmentActivity;
    }
    ...
    public final Unit invoke(oOO00O ooo00o, Integer num) {
        ...
        if ((num.intValue() & 11) == 2 && composer.OooOo0()) {
            ...
            BaseFragmentActivity baseFragmentActivity = this.f31671Oooo0o;
            ...
            if (((Boolean) baseFragmentActivity.f11467OoooOO0.getValue()).booleanValue() && baseFragmentActivity.OooOo0()) {
                o000O000.OooO00o(composer, 0);
            }
