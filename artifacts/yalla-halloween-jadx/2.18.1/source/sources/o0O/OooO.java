...
public abstract class OooO extends zzc {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ BaseGmsClient f34993OooO0Oo;
    ...
    @BinderThread
    public OooO(BaseGmsClient baseGmsClient, @Nullable int i, Bundle bundle) {
        super(baseGmsClient, Boolean.TRUE);
        this.f34993OooO0Oo = baseGmsClient;
        this.zza = i;
        this.zzb = bundle;
    }
    ...
    public final /* bridge */ /* synthetic */ void OooO00o() {
        if (this.zza != 0) {
            this.f34993OooO0Oo.OooOO0O(1, null);
