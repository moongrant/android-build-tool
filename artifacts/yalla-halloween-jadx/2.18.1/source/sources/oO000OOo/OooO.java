...
public final class OooO extends oO0OO0oo.OooOo00.OooO0O0 {
    public OooO(p696oO0OO0oo.OooOO0O oooOO0O, p696oO0OO0oo.OooOOO0 oooOOO0, p696oO0OO0oo.OooOOO0 oooOOO1, boolean z) {
    ...
    public OooO(p696oO0OO0oo.OooOO0O oooOO0O, p696oO0OO0oo.OooOOO0 oooOOO0, p696oO0OO0oo.OooOOO0 oooOOO1, p696oO0OO0oo.OooOOO0[] oooOOO0Arr, boolean z) {
    ...
    public final p696oO0OO0oo.OooOo00 OooO00o(p696oO0OO0oo.OooOo00 oooOo00) {
        ...
        return new OooO(oooOO0O, oooOo07, oooOo08, new p696oO0OO0oo.OooOOO0[]{oooOo09}, this.f52790OooO0o0);
    }

    @Override // p696oO0OO0oo.OooOo00
    public final p696oO0OO0oo.OooOo00 OooO0OO() {
        return new OooO(null, OooO0o0(), OooO0o(), false);
    }

    @Override // p696oO0OO0oo.OooOo00
    public final p696oO0OO0oo.OooOo00 OooOOO0() {
        return OooOO0() ? this : new OooO(this.f52786OooO00o, this.f52787OooO0O0, this.f52788OooO0OO.OooOOO0(), this.f52789OooO0Oo, this.f52790OooO0o0);
    }
    ...
    public final p696oO0OO0oo.OooOo00 OooOOo() {
        ...
        int[] iArr = new int[5];
        OooOOOO.OooO0oO(oooOo00.f52578OooO0Oo, iArr);
        int[] iArr2 = new int[5];
        OooOOOO.OooO0oO(iArr, iArr2);
        int[] iArr3 = new int[5];
        OooOOOO.OooO0oO(oooOo01.f52578OooO0Oo, iArr3);
        OooOOOO.OooO0o(p697oO0OOo0o.Oooo0.OooO0O0(iArr3, iArr3, iArr3), iArr3);
        OooOOOO.OooO0O0(iArr, oooOo01.f52578OooO0Oo, iArr);
        OooOOOO.OooO0o(p399o0Oo00oo.o00000OO.OooOOoo(5, iArr), iArr);
        int[] iArr4 = new int[5];
        OooOOOO.OooO0o(p399o0Oo00oo.o00000OO.OooOo00(5, iArr2, iArr4), iArr4);
        OooOo00 oooOo03 = new OooOo00(iArr2);
        OooOOOO.OooO0oO(iArr3, iArr2);
        int[] iArr5 = oooOo03.f52578OooO0Oo;
        OooOOOO.OooO(iArr5, iArr, iArr5);
        int[] iArr6 = oooOo03.f52578OooO0Oo;
        OooOOOO.OooO(iArr6, iArr, iArr6);
        OooOo00 oooOo04 = new OooOo00(iArr);
        OooOOOO.OooO(iArr, oooOo03.f52578OooO0Oo, iArr);
        int[] iArr7 = oooOo04.f52578OooO0Oo;
        OooOOOO.OooO0O0(iArr7, iArr3, iArr7);
        int[] iArr8 = oooOo04.f52578OooO0Oo;
        OooOOOO.OooO(iArr8, iArr4, iArr8);
        OooOo00 oooOo05 = new OooOo00(iArr3);
        OooOOOO.OooOO0(oooOo00.f52578OooO0Oo, iArr3);
        if (!oooOo02.OooO0oo()) {
            int[] iArr9 = oooOo05.f52578OooO0Oo;
            OooOOOO.OooO0O0(iArr9, oooOo02.f52578OooO0Oo, iArr9);
        }
        return new OooO(oooOO0O, oooOo03, oooOo04, new p696oO0OO0oo.OooOOO0[]{oooOo05}, this.f52790OooO0o0);
    }
}
