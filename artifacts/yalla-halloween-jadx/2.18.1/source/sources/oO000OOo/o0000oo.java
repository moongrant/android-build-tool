...
public final class o0000oo {
    ...
    public static final int[] f52604OooO00o = {-1, 0, 0, -1, -2, -1, -1, -1, -1, -1, -1, -1};

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final int[] f52605OooO0O0 = {1, -2, 0, 2, 0, -2, 0, 2, 1, 0, 0, 0, -2, 1, 0, -2, -3, -1, -1, -1, -1, -1, -1, -1};

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final int[] f52606OooO0OO = {-1, 1, -1, -3, -1, 1, -1, -3, -2, -1, -1, -1, 1, -2, -1, 1, 2};

    public static void OooO00o(int[] iArr, int[] iArr2, int[] iArr3) {
        if (p399o0Oo00oo.o00000OO.OooO00o(12, iArr, iArr2, iArr3) != 0 || (iArr3[11] == -1 && p399o0Oo00oo.o00000OO.OooOO0O(12, iArr3, f52604OooO00o))) {
            OooO0O0(iArr3);
        }
    }
    ...
    public static void OooO0O0(int[] iArr) {
        ...
        iArr[4] = (int) j6;
        if ((j6 >> 32) != 0) {
            p399o0Oo00oo.o00000OO.OooOOO(12, iArr, 5);
        }
    }

    public static void OooO0OO(int[] iArr, int[] iArr2, int[] iArr3) {
        int[] iArr4 = new int[24];
        p697oO0OOo0o.o00O0O.OooO00o(iArr, iArr2, iArr4);
        OooO0Oo(iArr4, iArr3);
    }
    ...
    public static void OooO0Oo(int[] iArr, int[] iArr2) {
        ...
        iArr2[11] = (int) j28;
        OooO0o0((int) ((j28 >> 32) + 1), iArr2);
    }

    public static void OooO0o(int[] iArr, int[] iArr2) {
        int[] iArr3 = new int[24];
        p697oO0OOo0o.o00O0O.OooO0O0(iArr, iArr3);
        OooO0Oo(iArr3, iArr2);
    }
    ...
    public static void OooO0o0(int i, int[] iArr) {
        ...
        if ((j == 0 || p399o0Oo00oo.o00000OO.OooOOO(12, iArr, 5) == 0) && !(iArr[11] == -1 && p399o0Oo00oo.o00000OO.OooOO0O(12, iArr, f52604OooO00o))) {
            return;
        }
        OooO0O0(iArr);
    }
    ...
    public static void OooO0oO(int[] iArr, int i, int[] iArr2) {
        ...
        while (true) {
            ...
            if (i <= 0) {
                ...
                p697oO0OOo0o.o00O0O.OooO0O0(iArr2, iArr3);
            }
        }
    }

    public static void OooO0oo(int[] iArr, int[] iArr2, int[] iArr3) {
        if (p399o0Oo00oo.o00000OO.OooOo0O(12, iArr, iArr2, iArr3) != 0) {
            ...
            iArr3[4] = (int) j6;
            if ((j6 >> 32) != 0) {
                p399o0Oo00oo.o00000OO.OooO0oo(12, iArr3, 5);
            }
        }
    }
}
