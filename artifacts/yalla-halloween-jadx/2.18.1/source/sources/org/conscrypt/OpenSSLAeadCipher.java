...
public abstract class OpenSSLAeadCipher extends OpenSSLCipher {
    ...
    public void checkSupportedTagLength(int i) throws InvalidAlgorithmParameterException {
        if (i % 8 != 0) {
            throw new InvalidAlgorithmParameterException(OooO00o.OooO00o("Tag length must be a multiple of 8; was ", i));
        }
    }
    ...
    public void engineInitInternal(byte[] bArr, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (iv != null || iEVP_AEAD_nonce_length == 0) {
            if (iEVP_AEAD_nonce_length == 0 && iv != null) {
                StringBuilder sbOooO0o0 = OooO00o.OooO00o.OooO0o0("IV not used in ");
            ...
            if (iv != null && iv.length != iEVP_AEAD_nonce_length) {
                StringBuilder sbOooO00o = o00000O0.OooO00o("Expected IV length of ", iEVP_AEAD_nonce_length, " but was ");
                sbOooO00o.append(iv.length);
                throw new InvalidAlgorithmParameterException(sbOooO00o.toString());
            }
        } else {
            if (!zIsEncrypting) {
                StringBuilder sbOooO0o1 = OooO00o.OooO00o.OooO0o0("IV must be specified in ");
