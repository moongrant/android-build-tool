...
public abstract class OpenSSLCipherRSA extends CipherSpi {
    ...
    public byte[] engineDoFinal(byte[] bArr, int i, int i2) throws BadPaddingException, IllegalBlockSizeException {
        ...
        if (this.inputTooLarge) {
            throw new IllegalBlockSizeException(o0ooOOo.OooO00o(OooO00o.OooO0o0("input must be under "), this.buffer.length, " bytes"));
        }
    ...
    public void engineInitInternal(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec) throws InvalidKeyException, InvalidAlgorithmParameterException {
        if (i == 1 || i == 3) {
            ...
            if (i != 2 && i != 4) {
                throw new InvalidParameterException(android.support.v4.media.OooO00o.OooO00o("Unsupported opmode ", i));
            }
    ...
    public void engineSetMode(String str) throws NoSuchAlgorithmException {
        ...
        if (!"NONE".equals(upperCase) && !"ECB".equals(upperCase)) {
            throw new NoSuchAlgorithmException(OooOo00.OooO0Oo("mode not supported: ", str));
        }
    }
    ...
    public void engineSetPadding(String str) throws NoSuchPaddingException {
        ...
        if ("PKCS1PADDING".equals(upperCase)) {
            ...
            if (!"NOPADDING".equals(upperCase)) {
                throw new NoSuchPaddingException(OooOo00.OooO0Oo("padding not supported: ", str));
            }
            this.padding = 3;
        }
    }
    ...
    public int paddedBlockSizeBytes() {
        ...
        return this.padding == 1 ? (iKeySizeBytes - 1) - 10 : iKeySizeBytes;
    }
    ...
    public void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        if (algorithmParameterSpec == null) {
            ...
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("unknown param type: ");
            sbOooO0o0.append(algorithmParameterSpec.getClass().getName());
    ...
    public void engineInit(int i, Key key, AlgorithmParameters algorithmParameters, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        if (algorithmParameters == null) {
            ...
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("unknown param type: ");
            sbOooO0o0.append(algorithmParameters.getClass().getName());
            throw new InvalidAlgorithmParameterException(sbOooO0o0.toString());
        }
    }
    ...
    public int engineDoFinal(byte[] bArr, int i, int i2, byte[] bArr2, int i3) throws BadPaddingException, IllegalBlockSizeException, ShortBufferException {
        ...
        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("output buffer is too small ");
        sbOooO0o0.append(bArr2.length);
        sbOooO0o0.append(" < ");
