...
final class OpenSSLECGroupContext {
    ...
    public static OpenSSLECGroupContext getInstance(ECParameterSpec eCParameterSpec) throws InvalidAlgorithmParameterException {
        ...
        if (!(field instanceof ECFieldFp)) {
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("unhandled field class ");
            sbOooO0o0.append(field.getClass().getName());
            throw new InvalidParameterException(sbOooO0o0.toString());
        }
