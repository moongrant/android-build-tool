...
public abstract class OpenSSLEvpCipher extends OpenSSLCipher {
    ...
    public int doFinalInternal(byte[] bArr, int i, int i2) throws BadPaddingException, IllegalBlockSizeException, ShortBufferException {
        ...
        if (length >= i2) {
            ...
            if (iEVP_CipherFinal_ex2 > length) {
                throw new ShortBufferException(o00O00OO.OooO00o("buffer is too short: ", iEVP_CipherFinal_ex2, " > ", length));
            }
    ...
    public void engineInitInternal(byte[] bArr, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (jEVP_get_cipherbyname == 0) {
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("Cannot find name for key length = ");
            sbOooO0o0.append(bArr.length * 8);
            sbOooO0o0.append(" and mode = ");
        ...
        if (iv != null || iEVP_CIPHER_iv_length == 0) {
            if (iEVP_CIPHER_iv_length == 0 && iv != null) {
                StringBuilder sbOooO0o1 = OooO00o.OooO0o0("IV not used in ");
                sbOooO0o1.append(this.mode);
                sbOooO0o1.append(" mode");
                throw new InvalidAlgorithmParameterException(sbOooO0o1.toString());
            }
            if (iv != null && iv.length != iEVP_CIPHER_iv_length) {
                StringBuilder sbOooO00o = o00000O0.OooO00o("expected IV length of ", iEVP_CIPHER_iv_length, " but was ");
                sbOooO00o.append(iv.length);
                throw new InvalidAlgorithmParameterException(sbOooO00o.toString());
            }
        } else {
            if (!zIsEncrypting) {
                StringBuilder sbOooO0o2 = OooO00o.OooO0o0("IV must be specified in ");
                sbOooO0o2.append(this.mode);
                sbOooO0o2.append(" mode");
                throw new InvalidAlgorithmParameterException(sbOooO0o2.toString());
            }
    ...
    public int updateInternal(byte[] bArr, int i, int i2, byte[] bArr2, int i3, int i4) throws ShortBufferException {
        ...
        if (length < i4) {
            throw new ShortBufferException(o00O00OO.OooO00o("output buffer too small during update: ", length, " < ", i4));
        }
