...
public final class OpenSSLRSAKeyFactory extends KeyFactorySpi {
    ...
    public PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("Must use RSAPublicKeySpec or PKCS8EncodedKeySpec; was ");
        sbOooO0o0.append(keySpec.getClass().getName());
        throw new InvalidKeySpecException(sbOooO0o0.toString());
    }
    ...
    public PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("Must use RSAPublicKeySpec or X509EncodedKeySpec; was ");
        sbOooO0o0.append(keySpec.getClass().getName());
        throw new InvalidKeySpecException(sbOooO0o0.toString());
    }
    ...
    public <T extends KeySpec> T engineGetKeySpec(Key key, Class<T> cls) throws InvalidKeySpecException {
        ...
        if (z3 && PKCS8EncodedKeySpec.class.isAssignableFrom(cls)) {
            ...
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("Encoding type must be PKCS#8; was ");
            sbOooO0o0.append(key.getFormat());
            throw new InvalidKeySpecException(sbOooO0o0.toString());
        }
        if (!z || !X509EncodedKeySpec.class.isAssignableFrom(cls)) {
            StringBuilder sbOooO0o1 = OooO00o.OooO0o0("Unsupported key type and key spec combination; key=");
            sbOooO0o1.append(key.getClass().getName());
            sbOooO0o1.append(", keySpec=");
            sbOooO0o1.append(cls.getName());
            throw new InvalidKeySpecException(sbOooO0o1.toString());
        }
        ...
        StringBuilder sbOooO0o2 = OooO00o.OooO0o0("Encoding type must be X.509; was ");
        sbOooO0o2.append(key.getFormat());
        throw new InvalidKeySpecException(sbOooO0o2.toString());
    }
    ...
    public Key engineTranslateKey(Key key) throws InvalidKeyException {
        ...
        if (!(key instanceof PublicKey) || !"X.509".equals(key.getFormat())) {
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("Key must be an RSA public or private key; was ");
            sbOooO0o0.append(key.getClass().getName());
