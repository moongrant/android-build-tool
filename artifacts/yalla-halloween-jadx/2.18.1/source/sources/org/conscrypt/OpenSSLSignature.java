...
public class OpenSSLSignature extends SignatureSpi {
    ...
    public static abstract class RSAPSSPadding extends OpenSSLSignature {
        ...
        public final void engineSetParameter(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidAlgorithmParameterException {
            ...
            if (jcaDigestAlgorithmStandardName == null) {
                StringBuilder sbOooO0o0 = OooO00o.OooO0o0("Unsupported content digest algorithm: ");
            ...
            if (jcaDigestAlgorithmStandardName2 == null) {
                StringBuilder sbOooO0o1 = OooO00o.OooO0o0("Unsupported MGF1 digest algorithm: ");
            ...
            try {
                ...
                if (trailerField != 1) {
                    throw new InvalidAlgorithmParameterException(Oooo0.OooO00o("Unsupported trailer field: ", trailerField, ". Only ", 1, " supported"));
                }
                ...
                throw new ProviderException(OooOo00.OooO0Oo("Failed to obtain EVP_MD for ", jcaDigestAlgorithmStandardName2), e);
            }
        }
    }
    ...
    private void checkEngineType(OpenSSLKey openSSLKey) throws InvalidKeyException {
        ...
        if (i == 1) {
            ...
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("Signature initialized as ");
            sbOooO0o0.append(this.engineType);
            sbOooO0o0.append(" (not RSA)");
            throw new InvalidKeyException(sbOooO0o0.toString());
        }
        if (i != 2) {
            StringBuilder sbOooO0o1 = OooO00o.OooO0o0("Key must be of type ");
        ...
        StringBuilder sbOooO0o2 = OooO00o.OooO0o0("Signature initialized as ");
