...
public final class OpenSSLSignatureRawRSA extends SignatureSpi {
    ...
    public byte[] engineSign() throws SignatureException {
        ...
        if (this.inputIsTooLong) {
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("input length ");
            sbOooO0o0.append(this.inputOffset);
            sbOooO0o0.append(" != ");
            throw new SignatureException(o0ooOOo.OooO00o(sbOooO0o0, this.inputBuffer.length, " (modulus size)"));
        }
    ...
    public boolean engineVerify(byte[] bArr) throws SignatureException {
        ...
        if (length > bArr2.length) {
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("Input signature length is too large: ");
            sbOooO0o0.append(bArr.length);
            sbOooO0o0.append(" > ");
            sbOooO0o0.append(this.inputBuffer.length);
            throw new SignatureException(sbOooO0o0.toString());
        }
