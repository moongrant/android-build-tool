...
public final class OpenSSLX509Certificate extends X509Certificate {
    ...
    public void checkValidity(Date date) throws CertificateNotYetValidException, CertificateExpiredException {
        if (getNotBefore().compareTo(date) > 0) {
            StringBuilder sbOooO0o0 = OooO00o.OooO0o0("Certificate not valid until ");
            sbOooO0o0.append(getNotBefore().toString());
            sbOooO0o0.append(" (compared to ");
            sbOooO0o0.append(date.toString());
            sbOooO0o0.append(")");
            throw new CertificateNotYetValidException(sbOooO0o0.toString());
        }
        if (getNotAfter().compareTo(date) >= 0) {
            return;
        }
        StringBuilder sbOooO0o1 = OooO00o.OooO0o0("Certificate expired at ");
        sbOooO0o1.append(getNotAfter().toString());
        sbOooO0o1.append(" (compared to ");
        sbOooO0o1.append(date.toString());
        sbOooO0o1.append(")");
        throw new CertificateExpiredException(sbOooO0o1.toString());
    }
