...
final class SSLParametersImpl implements Cloneable {
    ...
    private static String[] getDefaultCipherSuites(boolean z, boolean z2) {
        if (z) {
            return z2 ? SSLUtils.concat(NativeCrypto.DEFAULT_PSK_CIPHER_SUITES, NativeCrypto.DEFAULT_X509_CIPHER_SUITES, new String[]{NativeCrypto.TLS_EMPTY_RENEGOTIATION_INFO_SCSV}) : SSLUtils.concat(NativeCrypto.DEFAULT_X509_CIPHER_SUITES, new String[]{NativeCrypto.TLS_EMPTY_RENEGOTIATION_INFO_SCSV});
        }
        return z2 ? SSLUtils.concat(NativeCrypto.DEFAULT_PSK_CIPHER_SUITES, new String[]{NativeCrypto.TLS_EMPTY_RENEGOTIATION_INFO_SCSV}) : new String[]{NativeCrypto.TLS_EMPTY_RENEGOTIATION_INFO_SCSV};
    }
    ...
    public void setEnabledProtocols(String[] strArr) {
        ...
        String[] strArrFilterFromProtocols = filterFromProtocols(strArr, NativeCrypto.OBSOLETE_PROTOCOL_SSLV3);
