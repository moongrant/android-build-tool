...
public abstract class o000oOoO {
    ...
    /* JADX WARN: Type inference failed for: r3v3, types: [java.util.HashMap, java.util.Map<java.lang.Integer, com.yallatech.support.platform.callback.YCSDKCallbackManagerImpl$OooO00o>] */
    public final void OooO0OO(YCSDKCallbackManager yCSDKCallbackManager, final YCSDKCallback yCSDKCallback) {
        ...
        YCSDKCallbackManagerImpl.OooO00o callback = new YCSDKCallbackManagerImpl.OooO00o() { // from class: OooO0Oo.Oooo0
            ...
            public final void OooO00o(int i, Intent intent) {
                o000oOoO this$0 = this.f113OooO00o;
        ...
        ((YCSDKCallbackManagerImpl) yCSDKCallbackManager).f26326OooO00o.put(Integer.valueOf(iOooO00o), callback);
    }

    public boolean OooO0Oo(@NotNull Context context, @NotNull BaseReq baseReq, @NotNull o00oO0o startActivityDelegate) {
        ...
        try {
            startActivityDelegate.OooO00o(intent, OooO0o0());
            return true;
