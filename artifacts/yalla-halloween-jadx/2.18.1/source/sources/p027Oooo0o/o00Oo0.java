...
public final class o00Oo0 implements OooOOO<OooO0OO>, OooO0OO {
    ...
    @NotNull
    public final LayoutDirection f1976Oooo;

    /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
    @NotNull
    public final o000O00O f1977Oooo0o;

    /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
    @NotNull
    public final o00O0O f1978Oooo0oO;

    /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
    public final boolean f1979Oooo0oo;
    ...
    public static final class OooO0O0 implements OooO0OO.OooO00o {
        ...
        public final /* synthetic */ Ref.ObjectRef<o00O0O.OooO00o> f1981OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final /* synthetic */ int f1982OooO0OO;

        public OooO0O0(Ref.ObjectRef<o00O0O.OooO00o> objectRef, int i) {
            this.f1981OooO0O0 = objectRef;
            this.f1982OooO0OO = i;
        }

        @Override // o0O0O00.OooO0OO.OooO00o
        public final boolean OooO00o() {
            return o00Oo0.this.OooO0O0(this.f1981OooO0O0.element, this.f1982OooO0OO);
        }
    }
    ...
    public o00Oo0(@NotNull o000O00O state, @NotNull o00O0O beyondBoundsInfo, boolean z, @NotNull LayoutDirection layoutDirection) {
        ...
        this.f1977Oooo0o = state;
        this.f1978Oooo0oO = beyondBoundsInfo;
        this.f1979Oooo0oo = z;
        this.f1976Oooo = layoutDirection;
    }

    public static final boolean OooO0OO(o00O0O.OooO00o oooO00o, o00Oo0 o00oo1) {
        return oooO00o.f1975OooO0O0 < o00oo1.f1977Oooo0o.OooO0oO().OooO00o() - 1;
    }
    ...
    public final <T> T OooO00o(int i, @NotNull Function1<? super OooO0OO.OooO00o, ? extends T> block) {
        ...
        objectRef.element = (T) this.f1978Oooo0oO.OooO00o(this.f1977Oooo0o.OooO0o0(), ((oo000o) CollectionsKt.last((List) this.f1977Oooo0o.OooO0oO().OooO0O0())).getIndex());
        T tInvoke = null;
        while (tInvoke == null && OooO0O0((o00O0O.OooO00o) objectRef.element, i)) {
            o00O0O.OooO00o oooO00o = (o00O0O.OooO00o) objectRef.element;
            int i2 = oooO00o.f1974OooO00o;
            int i3 = oooO00o.f1975OooO0O0;
            if (i == 1) {
                i2--;
            } else {
                if (i == 2) {
                    ...
                    if (!(i == 5)) {
                        if (!(i == 6)) {
                            if (i == 3) {
                                int i4 = OooO00o.$EnumSwitchMapping$0[this.f1976Oooo.ordinal()];
                                if (i4 != 1) {
                                    if (i4 == 2) {
                                        if (this.f1979Oooo0oo) {
                                            i2--;
                                        } else {
                                            i3++;
                                        }
                                    }
                                } else if (this.f1979Oooo0oo) {
                                    i3++;
                                } else {
                                    i2--;
                                }
                                ...
                                int i5 = OooO00o.$EnumSwitchMapping$0[this.f1976Oooo.ordinal()];
                                if (i5 != 1) {
                                    if (i5 == 2) {
                                        if (this.f1979Oooo0oo) {
                                            i3++;
            ...
            T t = (T) this.f1978Oooo0oO.OooO00o(i2, i3);
            this.f1978Oooo0oO.OooO0o0((o00O0O.OooO00o) objectRef.element);
            objectRef.element = t;
            o000Oo0 o000oo0OooO0oo = this.f1977Oooo0o.OooO0oo();
        ...
        this.f1978Oooo0oO.OooO0o0((o00O0O.OooO00o) objectRef.element);
        o000Oo0 o000oo0OooO0oo2 = this.f1977Oooo0o.OooO0oo();
    ...
    public final boolean OooO0O0(o00O0O.OooO00o oooO00o, int i) {
        if (!(i == 1)) {
            ...
            if (!(i == 5)) {
                if (!(i == 6)) {
                    if (i == 3) {
                        int i2 = OooO00o.$EnumSwitchMapping$0[this.f1976Oooo.ordinal()];
                        if (i2 != 1) {
                            if (i2 != 2) {
                        ...
                        int i3 = OooO00o.$EnumSwitchMapping$0[this.f1976Oooo.ordinal()];
                        if (i3 != 1) {
                            if (i3 != 2) {
                                throw new NoWhenBranchMatchedException();
                            }
        ...
        } else if (oooO00o.f1974OooO00o <= 0) {
            return false;
        }
        return true;
    }
