...
public final class o00OO00O<K, V> extends o00OO000<K, V, V> {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00OO00O(@NotNull o00OO<K, V> map) {
        super(map);
    ...
    public final boolean contains(Object obj) {
        return this.f4105Oooo0o.containsValue(obj);
    }
    ...
    public final boolean containsAll(@NotNull Collection<? extends Object> elements) {
        ...
        while (it.hasNext()) {
            if (!this.f4105Oooo0o.containsValue(it.next())) {
                return false;
            }
        }
        return true;
    ...
    public final Iterator iterator() {
        ...
        return new o0O00o0(o00oo2, ((o00000) o00oo2.OooO0OO().f4103OooO0OO.entrySet()).iterator());
    }
    ...
    public final boolean remove(Object obj) {
        ...
        do {
            if (!((o00Oo00) it).hasNext()) {
                next = null;
                break;
            }
            next = ((o00OOOOo) it).next();
        } while (!Intrinsics.areEqual(((Map.Entry) next).getValue(), obj));
        Map.Entry entry = (Map.Entry) next;
        if (entry == null) {
            return false;
        }
        o00oo2.remove(entry.getKey());
        return true;
    }
