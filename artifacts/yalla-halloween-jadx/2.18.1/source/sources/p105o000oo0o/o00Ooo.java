...
public abstract class o00Ooo {
    ...
    public final DataSetObservable f29922OooO00o = new DataSetObservable();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public DataSetObserver f29923OooO0O0;

    public final void OooO() {
        synchronized (this) {
            DataSetObserver dataSetObserver = this.f29923OooO0O0;
            if (dataSetObserver != null) {
                dataSetObserver.onChanged();
            }
        }
        this.f29922OooO00o.notifyChanged();
    }
    ...
    public void OooOO0(@NonNull DataSetObserver dataSetObserver) {
        this.f29922OooO00o.registerObserver(dataSetObserver);
    }
    ...
    public void OooOOO(@NonNull ViewGroup viewGroup) {
    }
    ...
    public void OooOOOO(@NonNull DataSetObserver dataSetObserver) {
        this.f29922OooO00o.unregisterObserver(dataSetObserver);
    }
}
