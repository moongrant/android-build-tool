...
public final /* synthetic */ class o00O0O implements Observer {
    ...
    public final /* synthetic */ int f31962OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final /* synthetic */ Object f31963OooO0O0;

    public /* synthetic */ o00O0O(Object obj, int i) {
        this.f31962OooO00o = i;
        this.f31963OooO0O0 = obj;
    }

    @Override // androidx.lifecycle.Observer
    public final void onChanged(Object obj) {
        boolean z = false;
        switch (this.f31962OooO00o) {
            case 0:
                ((FriendsListFragment) this.f31963OooO0O0).lambda$initObserver$0((Long) obj);
                break;
            case 1:
                RoomInfoProfileFragment.m81initDataObserver$lambda9((RoomInfoProfileFragment) this.f31963OooO0O0, (String) obj);
                break;
            case 2:
                final o00O00OO this$0 = (o00O00OO) this.f31963OooO0O0;
                Boolean it = (Boolean) obj;
                Intrinsics.checkNotNullParameter(this$0, "this$0");
                Intrinsics.checkNotNullExpressionValue(it, "it");
                if (it.booleanValue()) {
                    com.yalla.support.common.util.o00O0O.OooO(this$0.f32523OooO0Oo);
                } else {
                    com.yalla.support.common.util.o00O0O.OooO00o(this$0.f32523OooO0Oo);
                }
                boolean zBooleanValue = it.booleanValue();
                View viewFindViewById = this$0.f32520OooO00o.findViewById(R.id.rv_mic);
                final LinearLayout linearLayout = (LinearLayout) this$0.f32520OooO00o.findViewById(R.id.v_room_content);
                ...
                if (intRef.element != intRef2.element) {
                    TipsBubbleView tipsBubbleView = this$0.f32527OooO0oo;
                    ...
                    valueAnimatorOfInt.setDuration(this$0.f32529OooOO0O);
                    valueAnimatorOfInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: o00OoOo.o00O00
                        ...
                        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                            ...
                            if (i2 > end.element) {
                                TipsBubbleView tipsBubbleView2 = this$1.f32527OooO0oo;
                            ...
                            TipsBubbleView tipsBubbleView3 = this$1.f32527OooO0oo;
                ...
                break;
            case 3:
                AccountProtectionActivity this$1 = (AccountProtectionActivity) this.f31963OooO0O0;
                int i = AccountProtectionActivity.f21711OooooO0;
                Intrinsics.checkNotNullParameter(this$1, "this$0");
                this$1.OooOooo().getAccountPrivacy();
                break;
            case 4:
                PostDetailActivity this$2 = (PostDetailActivity) this.f31963OooO0O0;
                PostDetailActivity.OooO00o oooO00o = PostDetailActivity.f22417o0O0O00;
                Intrinsics.checkNotNullParameter(this$2, "this$0");
                this$2.OooOooO().f50591OooOOo.Oooo00o(true, true, true);
                break;
            case 5:
                TopicDetailActivity this$3 = (TopicDetailActivity) this.f31963OooO0O0;
                ...
                break;
            case 6:
                o00O0OO0 this$4 = (o00O0OO0) this.f31963OooO0O0;
                ...
                break;
            case 7:
                PremiumActivity context = (PremiumActivity) this.f31963OooO0O0;
                ...
                break;
            case 8:
                TopicPostPopularFragment.m414initObserve$lambda5((TopicPostPopularFragment) this.f31963OooO0O0, (Long) obj);
                break;
            default:
                MainRoomRecommendFragment.m484onLazyInit$lambda1((MainRoomRecommendFragment) this.f31963OooO0O0, (Boolean) obj);
                break;
        }
    }
}
