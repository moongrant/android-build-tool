...
public final /* synthetic */ class o00O0O00 implements Observer {
    ...
    public final void onChanged(Object obj) {
        ...
        switch (this.f31999OooO00o) {
            case 0:
                RoomInfoMemberListFragment.m49initObserve$lambda12((RoomInfoMemberListFragment) this.f32000OooO0O0, obj);
                break;
            case 1:
                wa bindingDrawer = (wa) this.f32000OooO0O0;
                Intrinsics.checkNotNullParameter(bindingDrawer, "$bindingDrawer");
                bindingDrawer.f50879OooOO0.setText((String) obj);
                break;
            case 2:
                UntieAccountBindActivity this$0 = (UntieAccountBindActivity) this.f32000OooO0O0;
                ...
                if (response.getIsSuccess()) {
                    if (response.getData() != null) {
                        this$0.f21890Ooooo0o = (AccountBindInfo) response.getData();
                    }
                }
                break;
            case 3:
                YallaTeamMessageActivity this$1 = (YallaTeamMessageActivity) this.f32000OooO0O0;
                ...
                TextView textView = this$1.f22255OooooO0;
                if (iIntValue <= 0) {
                    if (textView != null) {
                ...
                break;
            case 4:
                m this$2 = (m) this.f32000OooO0O0;
                Intrinsics.checkNotNullParameter(this$2, "this$0");
                this$2.OooOO0O().f49972OooO0OO.setText(o00O0.OooO0O0(String.valueOf((Long) obj)));
                break;
            case 5:
                FriendListFragment.m331initData$lambda2((FriendListFragment) this.f32000OooO0O0, (Pair) obj);
                break;
            default:
                RoomMemberConveneListDialog this$3 = (RoomMemberConveneListDialog) this.f32000OooO0O0;
                CheckConveneMemberStatusModel checkConveneMemberStatusModel = (CheckConveneMemberStatusModel) obj;
                Intrinsics.checkNotNullParameter(this$3, "this$0");
                this$3.f24168OooooO0 = checkConveneMemberStatusModel;
                if (checkConveneMemberStatusModel != null && checkConveneMemberStatusModel.getState() == 0) {
                    z = true;
                }
                boolean z2 = !z;
                this$3.f24169OooooOO = z2;
                if (z2) {
                    SearchLayout searchLayout = this$3.OooOOO().f49175OooO0oO;
