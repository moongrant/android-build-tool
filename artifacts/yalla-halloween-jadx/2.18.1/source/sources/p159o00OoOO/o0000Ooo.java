...
public final /* synthetic */ class o0000Ooo implements Observer {
    ...
    public final /* synthetic */ int f32418OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final /* synthetic */ Object f32419OooO0O0;

    public /* synthetic */ o0000Ooo(Object obj, int i) {
        this.f32418OooO00o = i;
        this.f32419OooO0O0 = obj;
    }
    ...
    public final void onChanged(Object obj) {
        switch (this.f32418OooO00o) {
            case 0:
                MixedRoomActivity mixedRoomActivity = (MixedRoomActivity) this.f32419OooO0O0;
                int i = MixedRoomActivity.f11764o00000oO;
                mixedRoomActivity.OooOoOO();
                mixedRoomActivity.finish();
                break;
            case 1:
                PhoneBindActivity this$0 = (PhoneBindActivity) this.f32419OooO0O0;
                int i2 = PhoneBindActivity.f21800OooooO0;
                Intrinsics.checkNotNullParameter(this$0, "this$0");
                this$0.finish();
                break;
            case 2:
                PrivateChatActivity this$1 = (PrivateChatActivity) this.f32419OooO0O0;
                ...
                if (apiResult.isSuccess()) {
                    ...
                    if (friendChatModel != null) {
                        ...
                        ((YallaChatVM) this$1.f22176Oooooo0.getValue()).toYallaChat(friendChatModel);
                    }
                } else {
                    ...
                    if (code2 == 2077) {
                        ...
                        ((YallaChatVM) this$1.f22176Oooooo0.getValue()).setFriendChatModel(friendChatModel2);
                        ((YallaChatVM) this$1.f22176Oooooo0.getValue()).yallaChatLogin();
                    } else if (code2 == 2078) {
                        ...
                        ((YallaChatVM) this$1.f22176Oooooo0.getValue()).setFriendChatModel(friendChatModel3);
                        ((YallaChatVM) this$1.f22176Oooooo0.getValue()).getYallaChatDialogBindShow().setValue(Boolean.TRUE);
                    } else if (code2 != 2080) {
                        ...
                        ((YallaChatVM) this$1.f22176Oooooo0.getValue()).getYallaChatDialogFriendNoBindShow().setValue(Boolean.TRUE);
                    }
                }
                break;
            case 3:
                RoomSettingActivity this$2 = (RoomSettingActivity) this.f32419OooO0O0;
                ...
                for (RoomItemInfoModel roomItemInfoModel : this$2.f22971Ooooo00) {
                ...
                break;
            case 4:
                UserInfoActivity this$3 = (UserInfoActivity) this.f32419OooO0O0;
                Integer num = (Integer) obj;
                UserInfoActivity.OooO00o oooO00o5 = UserInfoActivity.f23452o0ooOO0;
                Intrinsics.checkNotNullParameter(this$3, "this$0");
                if ((num == null) || (num != null && num.intValue() == 0)) {
                    this$3.Oooo00o().f50399OooO0Oo.f49988OooO0Oo.f50059OooOo0O.setVisibility(4);
                } else {
                    this$3.Oooo00o().f50399OooO0Oo.f49988OooO0Oo.f50059OooOo0O.setVisibility(0);
                    Integer value4 = OooOOO.f41216OooO00o.OooOOO().getValue();
                    Intrinsics.checkNotNull(value4);
                    int iIntValue = value4.intValue();
                    if (iIntValue == 1 || iIntValue == 8) {
                        TextView textView = this$3.Oooo00o().f50399OooO0Oo.f49988OooO0Oo.f50059OooOo0O;
                        StringBuilder sb = new StringBuilder();
                        sb.append(num);
                        sb.append('+');
                        textView.setText(sb.toString());
                    } else {
                        TextView textView2 = this$3.Oooo00o().f50399OooO0Oo.f49988OooO0Oo.f50059OooOo0O;
                ...
                break;
            default:
                MessageListFragment.m383initObserver$lambda4((MessageListFragment) this.f32419OooO0O0, (Integer) obj);
                break;
        }
    }
}
