...
public final class o0OOO0OO {
    ...
    public static final o0OOO00 f37432OooO00o;

    static {
        if (o0OO0oO0.f37430OooO0o0 && o0OO0oO0.f37428OooO0Oo) {
            int i = o00OO00O.f37328OooO00o;
        }
        f37432OooO00o = new o0OOO00();
    }
    ...
    public static int OooO0OO(CharSequence charSequence) {
        ...
        StringBuilder sbOooO0o0 = OooO00o.OooO0o0("UTF-8 length does not fit in int: ");
    ...
    public static boolean OooO0Oo(byte[] bArr, int i, int i2) {
        return f37432OooO00o.OooO00o(bArr, i, i2);
    }
}
