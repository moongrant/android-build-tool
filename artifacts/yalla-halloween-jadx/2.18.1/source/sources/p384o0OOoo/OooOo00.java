...
public final class OooOo00 {
    ...
    public static final TimeZone f38852OooO00o = TimeZone.getTimeZone("UTC");
    ...
    public static Date OooO0O0(String str, ParsePosition parsePosition) throws ParseException {
        ...
        try {
            ...
            int i3 = index + 4;
            int iOooO0OO5 = OooO0OO(str, index, i3);
            if (OooO00o(str, i3, '-')) {
                i3++;
            }
            int i4 = i3 + 2;
            int iOooO0OO6 = OooO0OO(str, i3, i4);
            if (OooO00o(str, i4, '-')) {
                i4++;
            }
            int i5 = i4 + 2;
            int iOooO0OO7 = OooO0OO(str, i4, i5);
            ...
            if (zOooO00o) {
                int i6 = i5 + 1;
                int i7 = i6 + 2;
                iOooO0OO4 = OooO0OO(str, i6, i7);
                if (OooO00o(str, i7, ':')) {
                    i7++;
                }
                int i8 = i7 + 2;
                iOooO0OO = OooO0OO(str, i7, i8);
                if (OooO00o(str, i8, ':')) {
                    i8++;
                }
    ...
    public static int OooO0OO(String str, int i, int i2) throws NumberFormatException {
        int i3;
        int i4;
        ...
        if (i < i2) {
            ...
            if (iDigit < 0) {
                StringBuilder sbOooO0o0 = OooO00o.OooO0o0("Invalid number: ");
                sbOooO0o0.append(str.substring(i, i2));
        ...
        while (i4 < i2) {
            ...
            if (iDigit2 < 0) {
                StringBuilder sbOooO0o1 = OooO00o.OooO0o0("Invalid number: ");
                sbOooO0o1.append(str.substring(i, i2));
