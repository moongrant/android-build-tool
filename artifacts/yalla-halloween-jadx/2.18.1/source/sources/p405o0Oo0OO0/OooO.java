...
import p404o0Oo0OO.OooO0O0;
import p404o0Oo0OO.OooO0OO;
import p589o0oOooO0.o0;
import p589o0oOooO0.o0O00000;
import p589o0oOooO0.o0O0000O;
import p589o0oOooO0.o0O00o0;
import p589o0oOooO0.oo00oO;
import p647o0ooOOOO.c6;
import p647o0ooOOOO.d6;
...
public final class OooO extends Drawable {
    ...
    public boolean f39039OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public int f39040OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @NotNull
    public ImageView.ScaleType f39041OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final OooO0OO f39042OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @NotNull
    public final OooOo f39043OooO0o0;

    public OooO(@NotNull OooOo oooOo, @NotNull OooOO0 oooOO1) {
        this.f39043OooO0o0 = oooOo;
        this.f39039OooO00o = true;
        this.f39041OooO0OO = ImageView.ScaleType.MATRIX;
        this.f39042OooO0Oo = new OooO0OO(oooOo, oooOO1);
    }

    public final void OooO00o(boolean z) {
        if (this.f39039OooO00o == z) {
            return;
        }
        this.f39039OooO00o = z;
        invalidateSelf();
    }

    public final void OooO0O0(int i) {
        if (this.f39040OooO0O0 == i) {
            return;
        }
        this.f39040OooO0O0 = i;
        invalidateSelf();
    }
    ...
    public final void draw(@Nullable Canvas canvas) {
        ...
        if (this.f39039OooO00o || canvas3 == null) {
            return;
        }
        OooO0OO oooO0OO = this.f39042OooO0Oo;
        int i2 = this.f39040OooO0O0;
        ImageView.ScaleType scaleType = this.f39041OooO0OO;
        e6 e6Var = oooO0OO.f39022OooO00o;
        float width3 = canvas.getWidth();
        float height = canvas.getHeight();
        c6 c6Var = oooO0OO.f39023OooO0O0.f39067OooO0O0;
        float f2 = (float) c6Var.f48891OooO00o;
        float f3 = (float) c6Var.f48892OooO0O0;
        ...
        if (width3 != ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE && height != ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE && f2 != ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE && f3 != ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE) {
            e6Var.f48893OooO00o = ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
            e6Var.f48894OooO0O0 = ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE;
            e6Var.f48895OooO0OO = 1.0f;
            e6Var.f48896OooO0Oo = 1.0f;
            e6Var.f48897OooO0o0 = false;
            ...
            float f8 = height / f3;
            float f9 = width3 / f2;
            switch (d6.$EnumSwitchMapping$0[scaleType.ordinal()]) {
                case 1:
                    e6Var.f48893OooO00o = f4;
                    e6Var.f48894OooO0O0 = f5;
                    break;
                case 2:
                    if (f6 > f7) {
                        e6Var.f48897OooO0o0 = false;
                        e6Var.f48895OooO0OO = f8;
                        e6Var.f48896OooO0Oo = f8;
                        e6Var.f48893OooO00o = OooOO0.OooO00o(f2, f8, width3, 2.0f);
                    } else {
                        e6Var.f48897OooO0o0 = true;
                        e6Var.f48895OooO0OO = f9;
                        e6Var.f48896OooO0Oo = f9;
                        e6Var.f48894OooO0O0 = OooOO0.OooO00o(f3, f9, height, 2.0f);
                    }
                    break;
                case 3:
                ...
                case 6:
                    if (f6 > f7) {
                        ...
                        e6Var.f48895OooO0OO = f9;
                        e6Var.f48896OooO0Oo = f9;
                        e6Var.f48894OooO0O0 = height - (f3 * f9);
                    } else {
                        e6Var.f48897OooO0o0 = false;
                        e6Var.f48895OooO0OO = f8;
                        e6Var.f48896OooO0Oo = f8;
                        e6Var.f48893OooO00o = width3 - (f2 * f8);
                    }
                    break;
                case 7:
                    Math.max(f9, f8);
                    e6Var.f48897OooO0o0 = f9 > f8;
                    e6Var.f48895OooO0OO = f9;
                    e6Var.f48896OooO0Oo = f8;
                    break;
                default:
        ...
        OooO0OO.OooO00o oooO00o6 = oooO0OO.f39029OooO0o0;
        if (oooO00o6.f39031OooO00o != canvas.getWidth() || oooO00o6.f39032OooO0O0 != canvas.getHeight()) {
            oooO00o6.f39033OooO0OO.clear();
        }
        oooO00o6.f39031OooO00o = canvas.getWidth();
        oooO00o6.f39032OooO0O0 = canvas.getHeight();
        List<o0O00000> list = oooO0OO.f39023OooO0O0.f39071OooO0o0;
        ArrayList arrayList = new ArrayList();
        for (o0O00000 o0o00000 : list) {
            OooO0O0.OooO00o oooO00o7 = (i2 < 0 || i2 >= o0o00000.f47168OooO0O0.size() || o0o00000.f47168OooO0O0.get(i2).f47169OooO00o <= 0.0d) ? null : new OooO0O0.OooO00o(o0o00000.f47167OooO00o, o0o00000.f47168OooO0O0.get(i2));
            if (oooO00o7 != null) {
        ...
        while (it2.hasNext()) {
            ...
            String str3 = oooO00o8.f39024OooO00o;
            if (str3 == null || Intrinsics.areEqual(oooO0OO.f39030OooO0oO.f39044OooO00o.get(str3), Boolean.TRUE)) {
                i2 = i2;
                it2 = it2;
            } else {
                Bitmap bitmap = oooO0OO.f39030OooO0oO.f39045OooO0O0.get(str3);
                if (bitmap == null) {
                    bitmap = oooO0OO.f39023OooO0O0.f39073OooO0oo.get(str3);
                }
                if (bitmap != null) {
                    Matrix matrixOooO00o = oooO0OO.OooO00o(oooO00o8.f39025OooO0O0.f47171OooO0OO);
                    Paint paintOooO00o = oooO0OO.f39026OooO0OO.OooO00o();
                    paintOooO00o.setAntiAlias(oooO0OO.f39023OooO0O0.f39066OooO00o);
                    paintOooO00o.setFilterBitmap(oooO0OO.f39023OooO0O0.f39066OooO00o);
                    paintOooO00o.setAlpha((int) (oooO00o8.f39025OooO0O0.f47169OooO00o * ((double) KotlinVersion.MAX_COMPONENT_VALUE)));
                    o0O0000O o0o0000o2 = oooO00o8.f39025OooO0O0;
                    oo00oO oo00oo2 = o0o0000o2.f47172OooO0Oo;
                    if (oo00oo2 != null) {
                        canvas.save();
                        paintOooO00o.reset();
                        Path pathOooO0O0 = oooO0OO.f39026OooO0OO.OooO0O0();
                        oo00oo2.OooO00o(pathOooO0O0);
                        pathOooO0O0.transform(matrixOooO00o);
                        canvas4.clipPath(pathOooO0O0);
                        matrixOooO00o.preScale((float) (oooO00o8.f39025OooO0O0.f47170OooO0O0.f48891OooO00o / ((double) bitmap.getWidth())), (float) (oooO00o8.f39025OooO0O0.f47170OooO0O0.f48891OooO00o / ((double) bitmap.getWidth())));
                        canvas4.drawBitmap(bitmap, matrixOooO00o, paintOooO00o);
                        canvas.restore();
                    } else {
                        matrixOooO00o.preScale((float) (o0o0000o2.f47170OooO0O0.f48891OooO00o / ((double) bitmap.getWidth())), (float) (oooO00o8.f39025OooO0O0.f47170OooO0O0.f48891OooO00o / ((double) bitmap.getWidth())));
                        canvas4.drawBitmap(bitmap, matrixOooO00o, paintOooO00o);
                    }
                    if (oooO0OO.f39030OooO0oO.f39051OooO0oo) {
                        oooO0OO.f39027OooO0Oo.clear();
                        oooO0OO.f39030OooO0oO.f39051OooO0oo = false;
                    }
                    String str4 = oooO00o8.f39024OooO00o;
                    if (str4 != null) {
                        String drawingText = oooO0OO.f39030OooO0oO.f39046OooO0OO.get(str4);
                        if (drawingText == null || (drawingTextPaint = oooO0OO.f39030OooO0oO.f39047OooO0Oo.get(str4)) == null) {
                            i2 = i2;
                            bitmapCreateBitmap = null;
                        } else {
                            Bitmap bitmap2 = oooO0OO.f39027OooO0Oo.get(str4);
                            if (bitmap2 != null) {
                                ...
                                if (drawingTextPaint.measureText(drawingText) > bitmap.getWidth()) {
                                    ...
                                    drawingText = OooOo00.OooO0Oo(drawingText, "...");
                                }
                        ...
                        StaticLayout it3 = oooO0OO.f39030OooO0oO.f39049OooO0o0.get(str4);
                        if (it3 != null && (bitmapCreateBitmap = oooO0OO.f39027OooO0Oo.get(str4)) == null) {
                            ...
                            HashMap<String, Bitmap> map2 = oooO0OO.f39027OooO0Oo;
                        ...
                        if (bitmapCreateBitmap != null) {
                            Paint paintOooO00o2 = oooO0OO.f39026OooO0OO.OooO00o();
                            paintOooO00o2.setAntiAlias(oooO0OO.f39023OooO0O0.f39066OooO00o);
                            oo00oO oo00oo3 = oooO00o8.f39025OooO0O0.f47172OooO0Oo;
                            if (oo00oo3 != null) {
                                canvas.save();
                                ...
                                Path pathOooO0O1 = oooO0OO.f39026OooO0OO.OooO0O0();
                                oo00oo3.OooO00o(pathOooO0O1);
                                canvas4.drawPath(pathOooO0O1, paintOooO00o2);
                                canvas.restore();
                            } else {
                                paintOooO00o2.setFilterBitmap(oooO0OO.f39023OooO0O0.f39066OooO00o);
            ...
            Matrix matrixOooO00o2 = oooO0OO.OooO00o(oooO00o8.f39025OooO0O0.f47171OooO0OO);
            Canvas canvas7 = canvas4;
            for (Iterator it4 = oooO00o8.f39025OooO0O0.f47173OooO0o0.iterator(); it4.hasNext(); it4 = it) {
                SVGAVideoShapeEntity sVGAVideoShapeEntity = (SVGAVideoShapeEntity) it4.next();
                if (sVGAVideoShapeEntity.f19442OooO0o0 != null) {
                    it = it4;
                } else {
                    Path path = o0.f47166OooO00o;
                    path.reset();
                    SVGAVideoShapeEntity.Type type = sVGAVideoShapeEntity.f19438OooO00o;
                    if (type == SVGAVideoShapeEntity.Type.shape) {
                        ?? r9 = sVGAVideoShapeEntity.f19439OooO0O0;
                        ...
                        ?? r10 = sVGAVideoShapeEntity.f19439OooO0O0;
                        ...
                        if (number != null) {
                            ?? r11 = sVGAVideoShapeEntity.f19439OooO0O0;
                            ...
                            if (number2 != null) {
                                ?? r12 = sVGAVideoShapeEntity.f19439OooO0O0;
                                ...
                                if (number3 != null) {
                                    ?? r13 = sVGAVideoShapeEntity.f19439OooO0O0;
                        ...
                        if (type == SVGAVideoShapeEntity.Type.rect) {
                            ?? r3 = sVGAVideoShapeEntity.f19439OooO0O0;
                            ...
                            if (number5 != null) {
                                ?? r14 = sVGAVideoShapeEntity.f19439OooO0O0;
                                ...
                                if (number6 != null) {
                                    ?? r15 = sVGAVideoShapeEntity.f19439OooO0O0;
                                    ...
                                    if (number7 != null) {
                                        ?? r16 = sVGAVideoShapeEntity.f19439OooO0O0;
                                        ...
                                        if (number8 != null) {
                                            ?? r17 = sVGAVideoShapeEntity.f19439OooO0O0;
                    ...
                    Path path2 = new Path();
                    sVGAVideoShapeEntity.f19442OooO0o0 = path2;
                    path2.set(path);
                }
                if (sVGAVideoShapeEntity.f19442OooO0o0 != null) {
                    Paint paintOooO00o3 = oooO0OO.f39026OooO0OO.OooO00o();
                    paintOooO00o3.reset();
                    paintOooO00o3.setAntiAlias(oooO0OO.f39023OooO0O0.f39066OooO00o);
                    double d = oooO00o8.f39025OooO0O0.f47169OooO00o;
                    double d2 = KotlinVersion.MAX_COMPONENT_VALUE;
                    paintOooO00o3.setAlpha((int) (d * d2));
                    Path pathOooO0O2 = oooO0OO.f39026OooO0OO.OooO0O0();
                    pathOooO0O2.reset();
                    OooO0OO.OooO00o oooO00o9 = oooO0OO.f39029OooO0o0;
                    if (!oooO00o9.f39033OooO0OO.containsKey(sVGAVideoShapeEntity)) {
                        Path path3 = new Path();
                        path3.set(sVGAVideoShapeEntity.f19442OooO0o0);
                        oooO00o9.f39033OooO0OO.put(sVGAVideoShapeEntity, path3);
                    }
                    Path path4 = oooO00o9.f39033OooO0OO.get(sVGAVideoShapeEntity);
                    if (path4 == null) {
                        Intrinsics.throwNpe();
                    }
                    pathOooO0O2.addPath(path4);
                    OooO0OO.OooO0O0 oooO0O0 = oooO0OO.f39026OooO0OO;
                    oooO0O0.f39038OooO0o0.reset();
                    Matrix matrix3 = oooO0O0.f39038OooO0o0;
                    matrix3.reset();
                    Matrix matrix4 = sVGAVideoShapeEntity.f19441OooO0Oo;
                    if (matrix4 != null) {
                        matrix3.postConcat(matrix4);
                    }
                    matrix3.postConcat(matrixOooO00o2);
                    pathOooO0O2.transform(matrix3);
                    SVGAVideoShapeEntity.OooO00o oooO00o10 = sVGAVideoShapeEntity.f19440OooO0OO;
                    if (oooO00o10 != null && (i = oooO00o10.f19443OooO00o) != 0) {
                        paintOooO00o3.setStyle(Paint.Style.FILL);
                        paintOooO00o3.setColor(i);
                        paintOooO00o3.setAlpha(Math.min(KotlinVersion.MAX_COMPONENT_VALUE, Math.max(0, (int) (oooO00o8.f39025OooO0O0.f47169OooO00o * d2))));
                        if (oooO00o8.f39025OooO0O0.f47172OooO0Oo != null) {
                            canvas.save();
                        }
                        oo00oO oo00oo4 = oooO00o8.f39025OooO0O0.f47172OooO0Oo;
                        if (oo00oo4 != null) {
                            OooO0OO.OooO0O0 oooO0O1 = oooO0OO.f39026OooO0OO;
                            oooO0O1.f39036OooO0OO.reset();
                            Path path5 = oooO0O1.f39036OooO0OO;
                    ...
                    SVGAVideoShapeEntity.OooO00o oooO00o11 = sVGAVideoShapeEntity.f19440OooO0OO;
                    if (oooO00o11 != null) {
                        float f10 = 0;
                        if (oooO00o11.f19445OooO0OO > f10) {
                            paintOooO00o3.setStyle(Paint.Style.STROKE);
                            SVGAVideoShapeEntity.OooO00o oooO00o12 = sVGAVideoShapeEntity.f19440OooO0OO;
                            if (oooO00o12 != null) {
                                paintOooO00o3.setColor(oooO00o12.f19444OooO0O0);
                                c = 0;
                                paintOooO00o3.setAlpha(Math.min(KotlinVersion.MAX_COMPONENT_VALUE, Math.max(0, (int) (oooO00o8.f39025OooO0O0.f47169OooO00o * d2))));
                            } else {
                                c = 0;
                            }
                            matrixOooO00o2.getValues(oooO0OO.f39028OooO0o);
                            float[] fArr2 = oooO0OO.f39028OooO0o;
                            if (fArr2[c] == ZegoAudioProcessing.ZegoVoiceChangerCategory.NONE) {
                                ...
                                if (d3 * d6 != d4 * d5) {
                                    ...
                                    fAbs = Math.abs(oooO0OO.f39022OooO00o.f48897OooO0o0 ? (float) dSqrt : (float) dSqrt2);
                                    sVGAVideoShapeEntity = sVGAVideoShapeEntity;
                                }
                                oooO00o = sVGAVideoShapeEntity.f19440OooO0OO;
                                if (oooO00o != null) {
                                    paintOooO00o3.setStrokeWidth(oooO00o.f19445OooO0OO * fAbs);
                                }
                                oooO00o2 = sVGAVideoShapeEntity.f19440OooO0OO;
                                if (oooO00o2 != null && (str2 = oooO00o2.f19446OooO0Oo) != null) {
                                    if (StringsKt.OooO(str2, "butt")) {
                                        paintOooO00o3.setStrokeCap(Paint.Cap.BUTT);
                                    } else if (StringsKt.OooO(str2, "round")) {
                                        paintOooO00o3.setStrokeCap(Paint.Cap.ROUND);
                                    } else if (StringsKt.OooO(str2, "square")) {
                                        paintOooO00o3.setStrokeCap(Paint.Cap.SQUARE);
                                    }
                                }
                                oooO00o3 = sVGAVideoShapeEntity.f19440OooO0OO;
                                if (oooO00o3 != null && (str = oooO00o3.f19448OooO0o0) != null) {
                                    if (StringsKt.OooO(str, "miter")) {
                                        paintOooO00o3.setStrokeJoin(Paint.Join.MITER);
                                    } else if (StringsKt.OooO(str, "round")) {
                                        paintOooO00o3.setStrokeJoin(Paint.Join.ROUND);
                                    } else if (StringsKt.OooO(str, "bevel")) {
                                        paintOooO00o3.setStrokeJoin(Paint.Join.BEVEL);
                                    }
                                }
                                oooO00o4 = sVGAVideoShapeEntity.f19440OooO0OO;
                                if (oooO00o4 != null) {
                                    paintOooO00o3.setStrokeMiter(oooO00o4.f19447OooO0o * fAbs);
                                }
                                oooO00o5 = sVGAVideoShapeEntity.f19440OooO0OO;
                                if (oooO00o5 != null && (fArr = oooO00o5.f19449OooO0oO) != null && fArr.length == 3 && (fArr[0] > f10 || fArr[1] > f10)) {
                                ...
                                oo00oo = oooO00o8.f39025OooO0O0.f47172OooO0Oo;
                                if (oo00oo != null) {
                                    OooO0OO.OooO0O0 oooO0O2 = oooO0OO.f39026OooO0OO;
                                    oooO0O2.f39036OooO0OO.reset();
                                    Path path6 = oooO0O2.f39036OooO0OO;
                            ...
                            oo00oo = oooO00o8.f39025OooO0O0.f47172OooO0Oo;
                            if (oo00oo != null) {
                                OooO0OO.OooO0O0 oooO0O3 = oooO0OO.f39026OooO0OO;
                                oooO0O3.f39036OooO0OO.reset();
                                Path path7 = oooO0O3.f39036OooO0OO;
            ...
            String str6 = oooO00o8.f39024OooO00o;
            if (str6 != null) {
                Function2<Canvas, Integer, Boolean> function2 = oooO0OO.f39030OooO0oO.f39048OooO0o.get(str6);
                if (function2 != null) {
                    Matrix matrixOooO00o3 = oooO0OO.OooO00o(oooO00o8.f39025OooO0O0.f47171OooO0OO);
                    canvas.save();
                    canvas4.concat(matrixOooO00o3);
                    function2.invoke(canvas4, Integer.valueOf(i2));
                    canvas.restore();
                }
                Function4<Canvas, Integer, Integer, Integer, Boolean> function4 = oooO0OO.f39030OooO0oO.f39050OooO0oO.get(str6);
                if (function4 != null) {
                    Matrix matrixOooO00o4 = oooO0OO.OooO00o(oooO00o8.f39025OooO0O0.f47171OooO0OO);
                    canvas.save();
                    canvas4.concat(matrixOooO00o4);
                    function4.invoke(canvas4, Integer.valueOf(i2), Integer.valueOf((int) oooO00o8.f39025OooO0O0.f47170OooO0O0.f48891OooO00o), Integer.valueOf((int) oooO00o8.f39025OooO0O0.f47170OooO0O0.f48892OooO0O0));
                    canvas.restore();
                }
            }
            canvas3 = canvas8;
        ...
        int i3 = i2;
        for (o0O00o0 o0o00o1 : oooO0OO.f39023OooO0O0.f39070OooO0o) {
            if (o0o00o1.f47174OooO00o == i3 && (soundPool = oooO0OO.f39023OooO0O0.f39072OooO0oO) != null && (num = o0o00o1.f47176OooO0OO) != null) {
                o0o00o1.f47177OooO0Oo = Integer.valueOf(soundPool.play(num.intValue(), 1.0f, 1.0f, 1, 0, 1.0f));
            }
            if (o0o00o1.f47175OooO0O0 <= i3) {
                Integer num2 = o0o00o1.f47177OooO0Oo;
                if (num2 != null) {
                    int iIntValue = num2.intValue();
                    SoundPool soundPool2 = oooO0OO.f39023OooO0O0.f39072OooO0oO;
                    if (soundPool2 != null) {
                        soundPool2.stop(iIntValue);
                    }
                }
                o0o00o1.f47177OooO0Oo = null;
            }
        }
    }
