...
public final class oO000O0O extends oO0Oo {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public oO000O0O(@NotNull oO00000o permissionBuilder) {
    ...
    public final void OooO00o() {
        if (!this.f39127OooO00o.f39119OooO0o0.contains("android.permission.SYSTEM_ALERT_WINDOW")) {
            OooO0O0();
            return;
        }
        if (Build.VERSION.SDK_INT < 23 || this.f39127OooO00o.OooO0Oo() < 23) {
            ...
            this.f39127OooO00o.f39119OooO0o0.remove("android.permission.SYSTEM_ALERT_WINDOW");
            OooO0O0();
        } else {
