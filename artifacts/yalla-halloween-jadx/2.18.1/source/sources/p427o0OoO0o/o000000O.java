...
public final class o000000O {
    ...
    public static class OooO0O0<T> implements Comparator<T> {
        ...
        public final OooO00o<T> f39886Oooo;

        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final Rect f39887Oooo0o = new Rect();

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final Rect f39888Oooo0oO = new Rect();

        /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
        public final boolean f39889Oooo0oo;

        public OooO0O0(boolean z, OooO00o<T> oooO00o) {
            this.f39889Oooo0oo = z;
            this.f39886Oooo = oooO00o;
        }

        @Override // java.util.Comparator
        public final int compare(T t, T t2) {
            Rect rect = this.f39887Oooo0o;
            Rect rect2 = this.f39888Oooo0oO;
            ((o000000.OooO00o) this.f39886Oooo).OooO00o(t, rect);
            ((o000000.OooO00o) this.f39886Oooo).OooO00o(t2, rect2);
            int i = rect.top;
            int i2 = rect2.top;
            if (i < i2) {
                return -1;
    ...
    public static boolean OooO0OO(@NonNull Rect rect, @NonNull Rect rect2, int i) {
        if (i == 17) {
            int i2 = rect.right;
            int i3 = rect2.right;
