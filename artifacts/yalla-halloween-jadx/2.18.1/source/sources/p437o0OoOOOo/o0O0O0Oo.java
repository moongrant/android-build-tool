...
public final /* synthetic */ class o0O0O0Oo implements View.OnClickListener {
    ...
    public final /* synthetic */ int f40084Oooo0o;

    /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
    public final /* synthetic */ Object f40085Oooo0oO;

    public /* synthetic */ o0O0O0Oo(Object obj, int i) {
        this.f40084Oooo0o = i;
        this.f40085Oooo0oO = obj;
    }

    @Override // android.view.View.OnClickListener
    public final void onClick(View view) {
        switch (this.f40084Oooo0o) {
            case 0:
                OooO00o.this.OooO00o();
                break;
            default:
                UntieAccountBindActivity context = (UntieAccountBindActivity) this.f40085Oooo0oO;
                int i = UntieAccountBindActivity.f21887OooooOO;
                Intrinsics.checkNotNullParameter(context, "this$0");
                AccountBindInfo accountBindInfo = context.f21890Ooooo0o;
                if (accountBindInfo != null) {
                    if (!Oooo000.OooO0O0(accountBindInfo.getIsPh())) {
                        ...
                        oo0ooo0.OooOo0o(new oO000OOo(context));
                        oo0ooo0.OooOOO0();
                    } else if (!context.OooOoo().f50678OooO0Oo.isShown()) {
