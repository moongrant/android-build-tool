...
public final class o00Ooo {
    ...
    public static class OooO0O0 {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final HashMap f40236OooO00o = new HashMap();

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final oo000o f40237OooO0O0 = new oo000o();
    }

    static {
        o00Ooo o00ooo2 = new o00Ooo();
        f40231OooO0O0 = o00ooo2;
        OooO0O0(o00ooo2);
    }

    public static void OooO0O0(o00Ooo o00ooo2) {
        o00ooo2.OooO00o(f40234OooO0o0);
        o00ooo2.OooO00o(f40232OooO0OO);
        o00ooo2.OooO00o(f40233OooO0Oo);
    }
    ...
    public final void OooO00o(String[][] strArr) {
        ...
        while (i < length) {
            ...
            OooO00o oooO00o = this.f40235OooO00o;
            oooO00o.f40236OooO00o.put(str, Integer.valueOf(i2));
            oo000o oo000oVar = oooO00o.f40237OooO0O0;
            oo000o.OooO00o[] oooO00oArr = oo000oVar.f40238OooO00o;
            int i3 = Integer.MAX_VALUE;
            int i4 = i2 & Integer.MAX_VALUE;
            int length2 = i4 % oooO00oArr.length;
            oo000o.OooO00o oooO00o2 = oooO00oArr[length2];
            while (true) {
                if (oooO00o2 == null) {
                    if (oo000oVar.f40239OooO0O0 >= oo000oVar.f40240OooO0OO) {
                        oo000o.OooO00o[] oooO00oArr2 = oo000oVar.f40238OooO00o;
                        int length3 = oooO00oArr2.length;
                        int i5 = (length3 * 2) + 1;
                        oo000o.OooO00o[] oooO00oArr3 = new oo000o.OooO00o[i5];
                        oo000oVar.f40240OooO0OO = (int) (i5 * 0.75f);
                        oo000oVar.f40238OooO00o = oooO00oArr3;
                        while (true) {
                            int i6 = length3 - 1;
                            if (length3 <= 0) {
                                break;
                            }
                            oo000o.OooO00o oooO00o3 = oooO00oArr2[i6];
                            while (oooO00o3 != null) {
                                oo000o.OooO00o oooO00o4 = oooO00o3.f40243OooO0OO;
                                int i7 = (oooO00o3.f40241OooO00o & i3) % i5;
                                oooO00o3.f40243OooO0OO = oooO00oArr3[i7];
                        ...
                        oooO00oArr = oo000oVar.f40238OooO00o;
                        length2 = i4 % oooO00oArr.length;
                    }
                    oooO00oArr[length2] = new oo000o.OooO00o(i2, str, oooO00oArr[length2]);
                    oo000oVar.f40239OooO0O0++;
                    break;
                }
                if (oooO00o2.f40241OooO00o == i2) {
                    oooO00o2.f40242OooO0O0 = str;
                    break;
                }
                oooO00o2 = oooO00o2.f40243OooO0OO;
            }
            i++;
            c = 0;
        }
