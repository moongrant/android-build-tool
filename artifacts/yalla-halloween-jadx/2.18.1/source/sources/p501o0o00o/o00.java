...
public final class o00 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ o000 f41393Oooo0o;
    ...
    public o00(o000 o000Var) {
        super(0);
        this.f41393Oooo0o = o000Var;
    }
    ...
    public final Unit invoke() {
        boolean z;
        boolean z2;
        o000 o000Var = this.f41393Oooo0o;
        GiftPropModel giftPropModel = o000Var.f41410OooOo0O;
        if (giftPropModel != null) {
            giftPropModel.setLocalCount(o000Var.f41409OooOo00);
        }
        o000 o000Var2 = this.f41393Oooo0o;
        GiftPropModel giftPropModel2 = o000Var2.f41410OooOo0O;
        boolean z3 = false;
        if (giftPropModel2 != null && OooO00o.$EnumSwitchMapping$0[o000Var2.f41394OooO.ordinal()] == 1) {
            OooOo.OooO0OO("102021", o000oOoO.OooO00o(new Pair("Giftid", Integer.valueOf(giftPropModel2.getGiftId()))));
        }
        o000 o000Var3 = this.f41393Oooo0o;
        FragmentActivity activity = o000Var3.f41395OooO0oO;
        GiftPropModel giftPropModel3 = o000Var3.f41410OooOo0O;
        o000OOo0 o000ooo1 = new o000OOo0(o000Var3);
        Intrinsics.checkNotNullParameter(activity, "activity");
        if (giftPropModel3 == null) {
            o000ooo1.invoke(giftPropModel3);
        } else {
            ...
            if (typeUser == GiftPropTypeUser.Hot.getValue()) {
                ...
                if (giftPropModel3.getTypePay() == GiftPropTypePay.Coin.getValue() || localCount <= oOO00O.OooO0o(OooOOO.f41216OooO00o.OooO0OO().getValue())) {
                    z = false;
                } else {
                    z = true;
                }
                if (giftPropModel3.getTypePay() == GiftPropTypePay.Crystal.getValue() || localCount <= oOO00O.OooO0o(OooOOO.f41216OooO00o.OooO0o().getValue())) {
                    z2 = false;
                } else {
                    z2 = true;
                }
                ...
                if (value != null) {
                    ...
                    if (!zBooleanValue || premiumLevelOooO00o.getValue() <= 0) {
                        ...
                        oo0ooo0.OooOo0o(new o00OO0O0(premiumLevelOooO00o));
                ...
                if (value2 != null && value2.getFirst().intValue() == VipState.VipFrozen.getValue()) {
                    ...
                    oo0ooo1.OooOo0o(o00OO0OO.f41511Oooo0o);
                    ...
                    if (oOO00O.OooO0Oo(value3 != null ? value3.getSecond() : null, 0) <= 0) {
                        ...
                        oo0ooo2.OooOo0o(oo0O.f41533Oooo0o);
                ...
                if (oooO00o.OooO00o().OooOOo0()) {
                    ...
                    o000ooo1.invoke(null);
                } else if (o00O.f43140OooO00o.OooO0o0() < giftPropModel3.getSendLvLimit()) {
                    ...
                    oo0ooo3.OooOo0o(o00OO.f41505Oooo0o);
        ...
        GiftPropModel giftPropModel4 = this.f41393Oooo0o.f41410OooOo0O;
        if (giftPropModel4 != null && giftPropModel4.isCustomMade()) {
            z3 = true;
        }
        if (z3) {
            o000.OooOOOO(this.f41393Oooo0o);
        }
