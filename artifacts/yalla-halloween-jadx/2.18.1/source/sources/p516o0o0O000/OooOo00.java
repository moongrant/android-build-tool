...
public final class OooOo00 {
    @RequiresApi(api = 24)
    public static final void OooO00o(@NotNull Context context, @NotNull String title, @NotNull String description, long j, long j2, @NotNull Function1 isSuccess) {
    ...
    public static final int OooO0O0(Context context) {
        ...
        try {
            if (cursorQuery.getCount() > 0) {
                ...
                i = cursorQuery.getInt(cursorQuery.getColumnIndex(ao.d));
            }
            CloseableKt.closeFinally(cursorQuery, null);
            return i;
        } catch (Throwable th) {
