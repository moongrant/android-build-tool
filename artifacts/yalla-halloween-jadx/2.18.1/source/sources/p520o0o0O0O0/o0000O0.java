...
@DebugMetadata(c = "com.yalla.yalla.data.repository.ImMessageRepo$sendVoiceMessage$1$1", f = "ImMessageRepo.kt", i = {}, l = {98}, m = "invokeSuspend", n = {}, s = {})
public final class o0000O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f42414Oooo0o;

    /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
    public final /* synthetic */ ChatMessage f42415Oooo0oO;

    /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
    public final /* synthetic */ MutableLiveData<Boolean> f42416Oooo0oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0000O0(ChatMessage chatMessage, MutableLiveData<Boolean> mutableLiveData, Continuation<? super o0000O0> continuation) {
        super(2, continuation);
        this.f42415Oooo0oO = chatMessage;
        this.f42416Oooo0oo = mutableLiveData;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o0000O0(this.f42415Oooo0oO, this.f42416Oooo0oo, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws InvalidProtocolBufferException, BadPaddingException, IllegalBlockSizeException {
        ...
        int i = this.f42414Oooo0o;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            if (this.f42415Oooo0oO.getVoiceInfo() == null) {
                this.f42416Oooo0oo.postValue(Boxing.boxBoolean(false));
                return Unit.INSTANCE;
            }
            ChatMessage.VoiceInfo voiceInfo = this.f42415Oooo0oO.getVoiceInfo();
            Intrinsics.checkNotNull(voiceInfo);
            long targetId = this.f42415Oooo0oO.getTargetId();
            String mid = this.f42415Oooo0oO.getMid();
        ...
        if (imResult.getBody() != null) {
            MessageIM.SendVoiceReply from = MessageIM.SendVoiceReply.parseFrom(imResult.getBody());
            if (from != null) {
                ChatMessage chatMessage = this.f42415Oooo0oO;
                MutableLiveData<Boolean> mutableLiveData = this.f42416Oooo0oo;
                OooO00o.OooO00o().OooO00o(from.getTime());
        ...
        o0OOO0o.f42810OooO00o.OooO0oO(this.f42415Oooo0oO.getMid(), false);
        this.f42416Oooo0oo.postValue(Boxing.boxBoolean(false));
        return Unit.INSTANCE;
    }
}
