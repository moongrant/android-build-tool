...
public final class o00O extends o00OO0O0.OooO0O0 {
    ...
    public final /* synthetic */ Function1<Response<ArrayList<TopicInfoModel>>, Unit> f42665OooO00o;

    public static final class OooO00o extends o00000O0<AbsJavaBeanApiList<ArrayList<TopicInfoModel>>> {
    }

    /* JADX WARN: Multi-variable type inference failed */
    public o00O(Function1<? super Response<ArrayList<TopicInfoModel>>, Unit> function1) {
        this.f42665OooO00o = function1;
    }

    @Override // o00OoOO0.o00OO0O0.OooO0O0, o00OoOO0.o00OO0O0.OooO00o
    public final void onError(@Nullable String str, @Nullable String str2) {
        super.onError(str, str2);
        this.f42665OooO00o.invoke(new Response<>(false, null, false, new Error(str != null ? Integer.valueOf(Integer.parseInt(str)) : null, str2), 6, null));
    }
    ...
    public final void onFinish(@Nullable String str) {
        ...
        this.f42665OooO00o.invoke(response);
    }
}
