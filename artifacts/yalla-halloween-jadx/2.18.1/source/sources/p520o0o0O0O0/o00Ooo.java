...
public final class o00Ooo {
    ...
    @NotNull
    public static final o00Ooo f42751OooO00o = new o00Ooo();

    @DebugMetadata(c = "com.yalla.yalla.data.repository.GiftBlindBoxRepo", f = "GiftBlindBoxRepo.kt", i = {}, l = {10}, m = "getGiftBlindBoxRecordList", n = {}, s = {})
    public static final class OooO00o extends ContinuationImpl {

        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public /* synthetic */ Object f42752Oooo0o;

        /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
        public int f42754Oooo0oo;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f42752Oooo0o = obj;
            this.f42754Oooo0oo |= Integer.MIN_VALUE;
            return o00Ooo.this.OooO00o(0, this);
        }
    }

    /* JADX WARN: Code duplicated, block: B:7:0x0015  */
    @Nullable
    public final Object OooO00o(int i, @NotNull Continuation<? super ApiResult<List<GiftBlindBoxRecordModel>>> continuation) {
        OooO00o oooO00o;
        if (continuation instanceof OooO00o) {
            oooO00o = (OooO00o) continuation;
            int i2 = oooO00o.f42754Oooo0oo;
            if ((i2 & Integer.MIN_VALUE) != 0) {
                oooO00o.f42754Oooo0oo = i2 - Integer.MIN_VALUE;
            } else {
        ...
        Object giftBlindBoxRecordList = oooO00o.f42752Oooo0o;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i3 = oooO00o.f42754Oooo0oo;
        String str = "";
        try {
            if (i3 == 0) {
                ResultKt.throwOnFailure(giftBlindBoxRecordList);
                o00oO0o o00oo0o2 = o00oO0o.f40841OooO00o;
                GiftBlindBoxService giftBlindBoxServiceOooO00o = o00oO0o.OooO00o();
                oooO00o.f42754Oooo0oo = 1;
                giftBlindBoxRecordList = giftBlindBoxServiceOooO00o.getGiftBlindBoxRecordList(i, oooO00o);
                if (giftBlindBoxRecordList == coroutine_suspended) {
