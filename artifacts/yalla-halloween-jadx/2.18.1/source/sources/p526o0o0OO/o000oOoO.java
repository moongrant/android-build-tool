...
public final class o000oOoO extends OooOo {
    public final YallaTeamMessage OooO0O0(String str, long j) {
        ...
        yallaTeamMessage.setUid(((Number) OooO00o.OooO00o(OooOOO.f41216OooO00o)).longValue());
    ...
    public final void OooO0OO(@NotNull MessageIM.Message msg, boolean z) {
        ...
        if (msg.getHead() == 2102) {
            ...
            if (type == 43) {
                ...
                Integer value2 = OooOOO.f41216OooO00o.OooOOO().getValue();
            ...
            Integer value3 = OooOOO.f41216OooO00o.OooOOO().getValue();
    ...
    public final void OooO0Oo(String str) {
        ...
        if (OooO00o() || (activityOooO0O0 instanceof FriendRequestMessageActivity) || App.f11457Oooo0o) {
            return;
        }
