...
public final class o000OO00 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ o000O f43136Oooo0o;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o000OO00(o000O o000o, Continuation<? super o000OO00> continuation) {
        super(2, continuation);
        this.f43136Oooo0o = o000o;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o000OO00(this.f43136Oooo0o, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        o000O o000o = this.f43136Oooo0o;
        int i = o000o.f43134OooO00o;
        o00O00.OooO0O0("Socket MessageErrorHandler code = " + i + " message = " + o000o.f43135OooO0O0);
        if (i == -1) {
            ToastUtil.f12567OooO00o.OooO00o(R.string.not_network);
        } else if (i == 500) {
            ToastUtil.f12567OooO00o.OooO00o(R.string.Unknown_Failure);
        } else if (i == 630) {
            ToastUtil.f12567OooO00o.OooO0O0(o000O0O0.OooO0OO(R.string.message_expired));
        } else if (i == 400) {
            ToastUtil.f12567OooO00o.OooO00o(R.string.wrong_parameter);
        } else if (i == 401) {
            ToastUtil.f12567OooO00o.OooO00o(R.string.error_unauthorized);
        } else if (i == 600) {
            ToastUtil.f12567OooO00o.OooO00o(R.string.Friends_Already);
        } else if (i != 601) {
            Context context = null;
            switch (i) {
                case 603:
                    ToastUtil.f12567OooO00o.OooO00o(R.string.ADD_FREIND_NEED_VALIDATION);
                    break;
                case 604:
                    ToastUtil.f12567OooO00o.OooO00o(R.string.On_His_Blacklist);
                    break;
                case 605:
                    ToastUtil.f12567OooO00o.OooO00o(R.string.friend_limit);
                    break;
                case 606:
                    ToastUtil.f12567OooO00o.OooO00o(R.string.friend_user_limit);
                    break;
                case 607:
                    ToastUtil.f12567OooO00o.OooO00o(R.string.friended_too_often);
                    break;
                case 608:
                ...
                case 609:
                    ...
                    break;
                case 610:
                    ToastUtil.f12567OooO00o.OooO00o(R.string.microom_code_1013);
                    break;
                case 611:
                ...
                case 613:
                    ...
                    break;
                case 614:
                    BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), Dispatchers.getIO(), null, new o0OO00O(null), 2, null);
                    break;
                default:
                    switch (i) {
                        case 616:
                            ToastUtil.f12567OooO00o.OooO00o(R.string.error_friend_add_unacceptable_word);
                            break;
                        case 617:
                            oo0o0Oo.OooO0O0(CommonError.Other_Device_Login, null, 2, null, CommonErrorHandler.INSTANCE);
                            break;
                        ...
                        default:
                            switch (i) {
                                case 641:
                                    ToastUtil.f12567OooO00o.OooO0O0(o000O0O0.OooO0OO(R.string.message_send_frequently));
                                    break;
                                case 642:
                                    ToastUtil.f12567OooO00o.OooO0O0(o000O0O0.OooO0OO(R.string.message_send_limited));
                                    break;
                                case 643:
                                ...
                                case 644:
                                    ...
                                    break;
                                case 645:
                                    Context contextOooO0O2 = OooO0O0.f20502OooO00o.OooO0O0();
                                    if (contextOooO0O2 == null) {
                                        Context context4 = o0000O.f2657OooO00o;
                                        if (context4 != null) {
                                            context = context4;
                                        } else {
                                            Intrinsics.throwUninitializedPropertyAccessException(d.R);
                                ...
                                default:
                                    switch (i) {
                                        ...
                                        case 654:
                                            ...
                                            break;
                                        case 655:
                                            ToastUtil.f12567OooO00o.OooO0O0(o000O0O0.OooO0OO(R.string.face_has_expired));
                                        ...
                                        case 656:
                                            ...
                                            break;
                                        default:
                                            ToastUtil.f12567OooO00o.OooO0O0(o000O0O0.OooO0OO(R.string.Unknown_Failure));
                                            break;
                                    }
                                    break;
                            }
            ...
            ToastUtil.f12567OooO00o.OooO00o(R.string.microom_code_1003);
        }
