...
public final class o0O000o0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ LoginActivity f43545Oooo0o;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0O000o0(LoginActivity loginActivity, Continuation<? super o0O000o0> continuation) {
        super(2, continuation);
        this.f43545Oooo0o = loginActivity;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o0O000o0(this.f43545Oooo0o, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        BaseActivityK.OooOoo0(this.f43545Oooo0o, null, 0L, 3, null);
