...
public final class o0oO0Ooo extends Lambda implements Function1<View, Unit> {
    ...
    public final /* synthetic */ LoginActivity f43597Oooo0o;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0oO0Ooo(LoginActivity loginActivity) {
        super(1);
        this.f43597Oooo0o = loginActivity;
    }
    ...
    public final Unit invoke(View view) {
        ...
        WebActivity.f22108OoooooO.OooO00o(this.f43597Oooo0o, webPageInfo);
