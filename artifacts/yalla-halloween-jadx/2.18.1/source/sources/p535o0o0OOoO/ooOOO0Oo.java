...
public final class ooOOO0Oo extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MainSearchActivity f43734Oooo0o;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ooOOO0Oo(MainSearchActivity mainSearchActivity) {
        super(0);
        this.f43734Oooo0o = mainSearchActivity;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        MainSearchActivity activity = this.f43734Oooo0o;
