...
public final class o00O0OOO extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MixedRoomActivity f44709Oooo0o;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00O0OOO(MixedRoomActivity mixedRoomActivity) {
        super(0);
        this.f44709Oooo0o = mixedRoomActivity;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        o00O0OO onLogin = new o00O0OO(this.f44709Oooo0o);
