...
public final class o00OOOOo extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MixedRoomActivity f44735Oooo0o;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00OOOOo(MixedRoomActivity mixedRoomActivity) {
        super(0);
        this.f44735Oooo0o = mixedRoomActivity;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        if (this.f44735Oooo0o != null) {
            o00OOOO0 onLogin = o00OOOO0.f44734Oooo0o;
