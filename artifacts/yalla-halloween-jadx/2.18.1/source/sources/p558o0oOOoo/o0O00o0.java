...
public final class o0O00o0 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MixedRoomActivity f44784Oooo0o;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0O00o0(MixedRoomActivity mixedRoomActivity) {
        super(0);
        this.f44784Oooo0o = mixedRoomActivity;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        o0oOO onLogin = new o0oOO(this.f44784Oooo0o);
