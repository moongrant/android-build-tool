...
public final class o0000O0O extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ VehicleStoreActivity f45146Oooo0o;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0000O0O(VehicleStoreActivity vehicleStoreActivity) {
        super(0);
        this.f45146Oooo0o = vehicleStoreActivity;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        PremiumActivity.OooO00o oooO00o = PremiumActivity.f23360o0ooOOo;
        VehicleStoreActivity vehicleStoreActivity = this.f45146Oooo0o;
