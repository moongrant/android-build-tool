...
public final class o0OOOO0o extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ EventModel f47005Oooo0o;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0OOOO0o(EventModel eventModel) {
        super(0);
        this.f47005Oooo0o = eventModel;
    }
    ...
    public final Unit invoke() {
        ...
        EventModel eventModel = this.f47005Oooo0o;
