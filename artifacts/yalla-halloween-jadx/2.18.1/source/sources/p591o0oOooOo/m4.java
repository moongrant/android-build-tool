...
@DebugMetadata(c = "com.yalla.yalla.ui.screen.event.EventDisplayScreenKt$EventDisplayToolbar$1$3$1", f = "EventDisplayScreen.kt", i = {}, l = {133}, m = "invokeSuspend", n = {}, s = {})
public final class m4 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {

    /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
    public int f47284Oooo0o;

    /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
    public final /* synthetic */ EventViewModel f47285Oooo0oO;

    @DebugMetadata(c = "com.yalla.yalla.ui.screen.event.EventDisplayScreenKt$EventDisplayToolbar$1$3$1$1", f = "EventDisplayScreen.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    public static final class OooO00o extends SuspendLambda implements Function2<EventCreateStateModel, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public /* synthetic */ Object f47286Oooo0o;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            EventCreateStateModel eventCreateStateModel = (EventCreateStateModel) this.f47286Oooo0o;
            o0O00000.OooO0OO("Room_explore_Everts_establish");
    ...
    @DebugMetadata(c = "com.yalla.yalla.ui.screen.event.EventDisplayScreenKt$EventDisplayToolbar$1$3$1$2", f = "EventDisplayScreen.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    public static final class OooO0O0 extends SuspendLambda implements Function2<ApiResult<EventCreateStateModel>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ EventViewModel f47287Oooo0o;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(EventViewModel eventViewModel, Continuation<? super OooO0O0> continuation) {
            super(2, continuation);
            this.f47287Oooo0o = eventViewModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0O0(this.f47287Oooo0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            IntrinsicsKt.getCOROUTINE_SUSPENDED();
            ResultKt.throwOnFailure(obj);
            this.f47287Oooo0o.getShowLoadingDialog().setValue(Boxing.boxBoolean(false));
            return Unit.INSTANCE;
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public m4(EventViewModel eventViewModel, Continuation<? super m4> continuation) {
        super(2, continuation);
        this.f47285Oooo0oO = eventViewModel;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new m4(this.f47285Oooo0oO, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f47284Oooo0o;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            EventViewModel eventViewModel = this.f47285Oooo0oO;
            ...
            OooO0O0 oooO0O0 = new OooO0O0(this.f47285Oooo0oO, null);
            this.f47284Oooo0o = 1;
