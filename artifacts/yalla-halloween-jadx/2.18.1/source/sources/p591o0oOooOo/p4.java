...
public final class p4 extends Lambda implements Function0<Unit> {

    /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
    public final /* synthetic */ EventModel f47324Oooo0o;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public p4(EventModel eventModel) {
        super(0);
        this.f47324Oooo0o = eventModel;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        EventModel model = this.f47324Oooo0o;
