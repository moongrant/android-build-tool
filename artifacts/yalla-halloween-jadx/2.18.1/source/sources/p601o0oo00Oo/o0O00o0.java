...
public final class o0O00o0 extends o0O00OO<String> {

    /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
    public final /* synthetic */ MomentDetailView f48176Oooo0oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0O00o0(MomentDetailView momentDetailView, FragmentActivity fragmentActivity) {
        super(fragmentActivity);
        this.f48176Oooo0oo = momentDetailView;
    }
    ...
    public final void OooO00o(@NotNull View view, @NotNull SpannableStringModel<String> model) {
        ...
        MomentDetailView momentDetailView = this.f48176Oooo0oo;
