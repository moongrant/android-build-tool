...
public final class o0OoOoOo extends Lambda implements Function1<Boolean, Unit> {
    ...
    public final /* synthetic */ MomentDetailView f48227Oooo0o;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0OoOoOo(MomentDetailView momentDetailView) {
        super(1);
        this.f48227Oooo0o = momentDetailView;
    }

    @Override // kotlin.jvm.functions.Function1
    public final Unit invoke(Boolean bool) {
        MomentDetailView momentDetailView = this.f48227Oooo0o;
        if (!momentDetailView.f24952Ooooo00 && momentDetailView.f24938Oooo != MomentAdapterTag.MomentEditRecord) {
            ...
            Activity activity = this.f48227Oooo0o.getActivity();
            MomentDetailView momentDetailView2 = this.f48227Oooo0o;
