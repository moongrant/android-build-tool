...
public final class o0oO0Ooo extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MomentDetailView f48232Oooo0o;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0oO0Ooo(MomentDetailView momentDetailView) {
        super(0);
        this.f48232Oooo0o = momentDetailView;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        o0O00OOO onLogin = new o0O00OOO(this.f48232Oooo0o);
