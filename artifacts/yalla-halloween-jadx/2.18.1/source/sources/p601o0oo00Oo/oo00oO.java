...
public final class oo00oO extends o0O00OO<String> {

    /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
    public final /* synthetic */ MomentDetailView f48264Oooo0oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public oo00oO(MomentDetailView momentDetailView, FragmentActivity fragmentActivity) {
        super(fragmentActivity);
        this.f48264Oooo0oo = momentDetailView;
    }
    ...
    public final void OooO00o(@NotNull View view, @NotNull SpannableStringModel<String> model) {
        ...
        MomentDetailView momentDetailView = this.f48264Oooo0oo;
