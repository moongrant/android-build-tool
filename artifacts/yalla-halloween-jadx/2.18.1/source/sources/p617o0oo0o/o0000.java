...
public final class o0000 {
    ...
    @NotNull
    public List<SystemConversationModel> f48470OooO00o = new ArrayList();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public final SystemConversationModel f48471OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @NotNull
    public final SystemConversationModel f48472OooO0OO;
    ...
    public o0000() {
        ...
        this.f48471OooO0O0 = systemConversationModel;
        SystemConversationModel systemConversationModel2 = new SystemConversationModel(MessageModelHeadType.TypeYallaTeam);
        this.f48472OooO0OO = systemConversationModel2;
        this.f48470OooO00o.clear();
        this.f48470OooO00o.add(systemConversationModel);
        this.f48470OooO00o.add(systemConversationModel2);
    }
}
