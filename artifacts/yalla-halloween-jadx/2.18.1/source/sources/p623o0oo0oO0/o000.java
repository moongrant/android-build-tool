...
public final class o000 implements YCSDKCallback {
    ...
    public final /* synthetic */ Function1<BaseResp, Unit> f48627OooO00o;

    /* JADX WARN: Multi-variable type inference failed */
    public o000(Function1<? super BaseResp, Unit> function1) {
        this.f48627OooO00o = function1;
    }
    ...
    public final void onResult(@NotNull BaseResp result) {
        ...
        o00O00.OooO0O0("YallaChatSDK toGroupJoinisSuccess = " + result.isSuccess() + "code = " + result.getCode() + " message = " + result.getMsg());
        this.f48627OooO00o.invoke(result);
