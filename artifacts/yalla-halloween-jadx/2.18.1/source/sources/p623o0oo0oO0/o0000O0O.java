...
public final class o0000O0O implements YCSDKCallback {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final /* synthetic */ Function1<BaseResp, Unit> f48634OooO00o;

    /* JADX WARN: Multi-variable type inference failed */
    public o0000O0O(Function1<? super BaseResp, Unit> function1) {
        this.f48634OooO00o = function1;
    }
    ...
    public final void onResult(@NotNull BaseResp result) {
        ...
        o00O00.OooO0O0("YallaChatSDK toConversationRequestisSuccess = " + result.isSuccess() + "code = " + result.getCode() + " message = " + result.getMsg());
        this.f48634OooO00o.invoke(result);
