...
public final class ooooO000 implements ooo0o {

    /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
    public oO f52202Oooo0o;

    public ooooO000(oO oOVar) {
        this.f52202Oooo0o = oOVar;
    }

    @Override // p677o0oooo0o.ooo0o
    public final InputStream OooO00o() {
        return new oOO0OO0O(this.f52202Oooo0o);
    }
    ...
    public final oO0OO0O OooO0o0() throws IOException {
        InputStream inputStreamOooO00o = OooO00o();
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
        byte[] bArr = new byte[4096];
        while (true) {
            int i = inputStreamOooO00o.read(bArr, 0, 4096);
            if (i < 0) {
