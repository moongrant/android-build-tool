...
public final class o000 extends Lambda implements Function1<RenewCustomizeTheme, Unit> {
    ...
    public final /* synthetic */ RoomThemeCustomizeFragment f24460Oooo0o;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o000(RoomThemeCustomizeFragment roomThemeCustomizeFragment) {
        super(1);
        this.f24460Oooo0o = roomThemeCustomizeFragment;
    }
    ...
    public final Unit invoke(RenewCustomizeTheme renewCustomizeTheme) {
        ...
        if (renewCustomizeTheme2 != null) {
            ToastUtil.f12567OooO00o.OooO0O0(p254o00ooO0O.o000O0O0.OooO0OO(R.string.room_dialog_theme_customize_renewals_successful));
            p498o0o00Oo0.OooOOO.f41216OooO00o.OooO0OO().postValue(Long.valueOf(renewCustomizeTheme2.getBalance()));
            this.f24460Oooo0o.loadData();
        }
