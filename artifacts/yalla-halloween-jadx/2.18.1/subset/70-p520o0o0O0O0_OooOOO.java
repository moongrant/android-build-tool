...
public final class OooOOO extends o00O00OO {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    @NotNull
    public static final OooOOO f42227OooO00o = new OooOOO();
    ...
    public static final class OooO00o extends ContinuationImpl {
        ...
        public int f42228Oooo;

        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public OooOO0O f42229Oooo0o;

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public /* synthetic */ Object f42230Oooo0oO;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f42230Oooo0oO = obj;
            this.f42228Oooo |= Integer.MIN_VALUE;
            return OooOOO.this.OooO00o(this);
        }
    }
    ...
    public static final class OooO0O0 extends ContinuationImpl {
        ...
        /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
        public int f42232Oooo;

        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public String f42233Oooo0o;

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public /* synthetic */ Object f42234Oooo0oO;
        ...
        @Nullable
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f42234Oooo0oO = obj;
            this.f42232Oooo |= Integer.MIN_VALUE;
            return OooOOO.this.OooO0Oo(0L, null, this);
        }
    }
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public final /* synthetic */ ApiResult<RoomThemeAccept> f42236Oooo0o;

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public final /* synthetic */ String f42237Oooo0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(ApiResult<RoomThemeAccept> apiResult, String str, Continuation<? super OooO0OO> continuation) {
            super(2, continuation);
            this.f42236Oooo0o = apiResult;
            this.f42237Oooo0oO = str;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0OO(this.f42236Oooo0o, this.f42237Oooo0oO, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int code2 = this.f42236Oooo0o.getError().getCode();
            if (code2 == 1062) {
                ToastUtil.f12567OooO00o.OooO0O0(o000O0O0.OooO0OO(R.string.message_accept_failed_not_friend));
            } else if (code2 != 1202) {
                switch (code2) {
                    case i.b /* 2050 */:
                        ToastUtil.f12567OooO00o.OooO0O0(o000O0O0.OooO0OO(R.string.message_room_theme_you_has_it));
                        break;
                    case 2051:
                        p491o0o00O00.OooO0OO.OooO00o().OooOOo().OooOO0o(this.f42237Oooo0oO, ChatMessage.GiveRoomThemeInfo.ThemeState.ThemeHasReceived.getValue());
                        break;
                    case NativeConstants.SSL_SIGN_RSA_PSS_RSAE_SHA256 /* 2052 */:
                        ToastUtil.f12567OooO00o.OooO0O0(o000O0O0.OooO0OO(R.string.message_theme_has_invalid));
                        p491o0o00O00.OooO0OO.OooO00o().OooOOo().OooOO0o(this.f42237Oooo0oO, ChatMessage.GiveRoomThemeInfo.ThemeState.ThemeHasExpired.getValue());
                        break;
                    default:
                        ApiError error = this.f42236Oooo0o.getError();
    ...
    public static final class OooO0o extends ContinuationImpl {
        ...
        /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
        public String f42239Oooo0o;

        /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
        public int f42240Oooo0oO;

        /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
        public /* synthetic */ Object f42241Oooo0oo;

        /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
        public int f42242OoooO00;
        ...
        @Nullable
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f42241Oooo0oo = obj;
            this.f42242OoooO00 |= Integer.MIN_VALUE;
            return OooOOO.this.OooO0o0(0L, null, 0, this);
        }
    }

    public static /* synthetic */ ChatMessage OooOO0(long j, int i, String str, String str2, int i2) {
        OooOOO oooOOO = f42227OooO00o;
        if ((i2 & 8) != 0) {
            str2 = "";
        }
        return oooOOO.OooO(j, i, str, str2, 0L, false);
    }
    ...
    public static ChatMessage OooOO0O(long j, int i, int i2, String giftUrl, String mid, long j2, boolean z, boolean z2, boolean z3, int i3) {
        ...
        ChatMessage chatMessageOooO0O0 = oooOOO.OooO0O0(mid, j, j2, z);
    ...
    public final Object OooO00o(@NotNull Continuation<? super Unit> continuation) throws InvalidProtocolBufferException {
        ...
        if (continuation instanceof OooO00o) {
            ...
            int i = oooO00o.f42228Oooo;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO00o.f42228Oooo = i - Integer.MIN_VALUE;
            } else {
        ...
        Object obj = oooO00o.f42230Oooo0oO;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = oooO00o.f42228Oooo;
        if (i2 == 0) {
            ResultKt.throwOnFailure(obj);
            OooOO0O oooOO0O2 = new OooOO0O();
            p490o0o00O0.OooOOO OooOOo2 = p491o0o00O00.OooO0OO.OooO00o().OooOOo();
            long jLongValue = ((Number) kotlin.reflect.jvm.internal.impl.types.OooO00o.OooO00o(p498o0o00Oo0.OooOOO.f41216OooO00o)).longValue();
            oooO00o.f42229Oooo0o = oooOO0O2;
            oooO00o.f42228Oooo = 1;
    ...
    public final ChatMessage OooO0O0(String str, long j, long j2, boolean z) {
        ...
        chatMessage.setUid(f42227OooO00o.OooO0OO());
        if (j2 <= 0) {
            synchronized (o0OoOo0.f43133OooO00o) {
                jCurrentTimeMillis = System.currentTimeMillis() + oo0O.OooO00o.OooO00o().f53340OooO00o;
            }
        ...
        if (!(str.length() > 0)) {
            str = o0OoOo0.f43133OooO00o.OooO00o(Long.valueOf(j));
        }
    ...
    public final Object OooO0Oo(long j, @NotNull String str, @NotNull Continuation<? super ApiResult<RoomThemeAccept>> continuation) {
        ...
        if (continuation instanceof OooO0O0) {
            ...
            int i = oooO0O0.f42232Oooo;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO0O0.f42232Oooo = i - Integer.MIN_VALUE;
            } else {
        ...
        Object roomThemeAccept = oooO0O0.f42234Oooo0oO;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = oooO0O0.f42232Oooo;
        String str3 = "";
        try {
            if (i2 == 0) {
                ...
                oooO0O0.f42233Oooo0o = str2;
                oooO0O0.f42232Oooo = 1;
            ...
            OooOOO oooOOO = f42227OooO00o;
            oooOOO.OooOoOO(str2, roomThemeAccept2.getStatus());
            oooOOO.OooO0oO(oooOOO.OooO0o(false, str2));
            return roomThemeAccept;
        } catch (IOException e) {
    ...
    public final ChatMessage OooO0o(boolean z, @NotNull String mid) {
        ...
        ChatMessage chatMessageOooO0oo = p491o0o00O00.OooO0OO.OooO00o().OooOOo().OooO0oo(((Number) kotlin.reflect.jvm.internal.impl.types.OooO00o.OooO00o(p498o0o00Oo0.OooOOO.f41216OooO00o)).longValue(), mid);
        if (chatMessageOooO0oo != null && (userInfoOooO00o = o000O00.OooO00o(chatMessageOooO0oo.getTargetId())) != null) {
            String strOooO0O0 = o00O0O.f42677OooO00o.OooO0O0(chatMessageOooO0oo.getTargetId(), userInfoOooO00o.getUserName());
    ...
    public final Object OooO0o0(long j, @NotNull String str, int i, @NotNull Continuation<? super ApiResult<RoomThemeGiveState>> continuation) {
        ...
        if (continuation instanceof OooO0o) {
            ...
            int i3 = oooO0o.f42242OoooO00;
            if ((i3 & Integer.MIN_VALUE) != 0) {
                oooO0o.f42242OoooO00 = i3 - Integer.MIN_VALUE;
            } else {
        ...
        Object roomThemeGivenInfo = oooO0o.f42241Oooo0oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i4 = oooO0o.f42242OoooO00;
        String str3 = "";
        try {
            if (i4 == 0) {
                ...
                o0o0000.OooO00o oooO00o = o0o0000.OooO00o.f40768OooO00o;
                MainApiService mainApiServiceOooO0OO = o0o0000.OooO00o.OooO0OO();
                oooO0o.f42239Oooo0o = str;
                i2 = i;
                oooO0o.f42240Oooo0oO = i2;
                oooO0o.f42242OoooO00 = 1;
                ...
                int i5 = oooO0o.f42240Oooo0oO;
                str2 = oooO0o.f42239Oooo0o;
                ResultKt.throwOnFailure(roomThemeGivenInfo);
                i2 = i5;
            }
            ...
            f42227OooO00o.OooOoOO(str2, roomThemeGiveState.getStatus());
            return roomThemeGivenInfo;
        } catch (IOException e) {
            ApiError apiErrorOooO00o = com.app.base.app.appConfig.apiDataModela.OooO0O0.OooO00o(e, OooO00o.OooO00o.OooO0o0("time out "), "WebAPIException", 1, "time out");
            o0OOO0o o0ooo0o2 = o0OOO0o.f42120OooO00o;
    ...
    public final void OooO0oO(@NotNull ChatMessage chatMessage) {
        ...
        Long lOooO0OO = p491o0o00O00.OooO0OO.OooO00o().OooOOoo().OooO0OO(chatMessage.getUid(), chatMessage.getTargetId());
        ...
        if (contentType == 1) {
            conversation.setMessage(StringsKt.OooOo00(chatMessage.getMessage(), "''", "'"));
        ...
        Integer numOooOO0o = p491o0o00O00.OooO0OO.OooO00o().OooOOoo().OooOO0o(conversation.getUid(), conversation.getTargetId());
        ...
        p491o0o00O00.OooO0OO.OooO00o().OooOOoo().OooO0oO(conversation);
    }
    ...
    public final void OooOoOO(String str, int i) {
        p491o0o00O00.OooO0OO.OooO00o().OooOOo().OooOO0o(str, i);
    }
}
