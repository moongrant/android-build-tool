...
public final class OooO0O0 extends o00Oo0 {
    ...
    public final OooO0o OooO0oO() {
        ...
        throw new NullPointerException("null cannot be cast to non-null type com.yallatech.support.platform.group.join.Request");
    }

    @Override // p003OooO0o0.o00Oo0
    @NotNull
    public final BaseResp OooO00o(int i, @Nullable String str) {
        GroupJoinResponse.INSTANCE.getClass();
        GroupJoinResponse groupJoinResponse = new GroupJoinResponse();
        groupJoinResponse.setCode(i);
        if (str == null) {
            str = "";
        }
        groupJoinResponse.setMsg(str);
