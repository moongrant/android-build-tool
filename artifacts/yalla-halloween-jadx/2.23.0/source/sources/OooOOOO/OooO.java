...
public final class OooO extends oo000o {
    ...
    @NotNull
    public final OooOOOO f182OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @NotNull
    public final String f183OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public final String f184OooO0Oo;

    public OooO(@NotNull OooOOOO shareClient) {
        Intrinsics.checkNotNullParameter(shareClient, "shareClient");
        this.f182OooO0O0 = shareClient;
        this.f183OooO0OO = "A ContentProvider must add in the AndroidManifest.xml for App(%s).";
        this.f184OooO0Oo = "com.yallatech.support.platform.YallaChatContentProvider";
    }
    ...
    public static String OooO0oO(String url) {
        ...
        if (o000O.f56902OooO0O0) {
            Log.e(o000O.f56901OooO00o, msg2);
        }
    ...
    public static void OooO0oo(ShareRequest shareRequest) {
        ...
        if (o000O.f56902OooO0O0) {
            Log.e(o000O.f56901OooO00o, msg3);
        }
    }
    ...
    public final void OooO0o(ShareRequest shareRequest) throws YallaException {
        ...
        OooOOOO oooOOOO = this.f182OooO0O0;
        Unit unit = null;
        cursorQuery = null;
            ...
            if (ylMedia4 instanceof YLImage) {
                ...
                if (z) {
                    ...
                    if (packageManager != null) {
                        String strStringPlus = Intrinsics.stringPlus(this.f184OooO0Oo, thirdApplicationId$lib_release);
                        if (packageManager.resolveContentProvider(strStringPlus, 0) == null) {
                            String str = String.format(this.f183OooO0OO, Arrays.copyOf(new Object[]{strStringPlus}, 1));
                    ...
                    if (!StringsKt.Oooo00o(imagePath2, "content")) {
    ...
    public final void OooO0o0() {
        OooOOOO oooOOOO = this.f182OooO0O0;
        final OooO0OO oooO0OOOooO = oooOOOO.OooO0oO();
        if (oooO0OOOooO == null) {
            oooO0OOOooO = null;
        } else if (oo000o.OooO0Oo()) {
            YCSDKOpenKit.INSTANCE.dispatchToIO$lib_release(new Runnable() { // from class: OooOOOO.OooO0o
                @Override // java.lang.Runnable
                public final void run() {
                    OooO this$0 = this.f189OooO0Oo;
                    Intrinsics.checkNotNullParameter(this$0, "this$0");
                    OooO0OO this_apply = oooO0OOOooO;
                    Intrinsics.checkNotNullParameter(this_apply, "$this_apply");
                    try {
                        this$0.OooO0o(this_apply.f188OooO0OO);
                    } catch (Exception e) {
                        String message = e.getMessage();
                        if (message == null) {
                            message = "";
                        }
                        OooOOOO oooOOOO2 = this$0.f182OooO0O0;
                        oooOOOO2.getClass();
                        oooOOOO2.OooO0Oo(ShareResponse.INSTANCE.createShareResponse(ResponseInfo.UnknownHost, message));
                    }
                }
            });
        } else {
            try {
                OooO0o(oooO0OOOooO.f188OooO0OO);
            } catch (Exception e) {
                String message = e.getMessage();
                if (message == null) {
                    message = "";
