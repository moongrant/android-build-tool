...
public class OooO extends OooO0O0 {
    ...
    public static class OooO00o extends OooO0O0.OooO0OO {
        ...
        public void OooO0o0() {
            int[][] iArr = this.f220Oooo00o;
            int[][] iArr2 = new int[iArr.length][];
            for (int length = iArr.length - 1; length >= 0; length--) {
                int[] iArr3 = this.f220Oooo00o[length];
                iArr2[length] = iArr3 != null ? (int[]) iArr3.clone() : null;
            }
            this.f220Oooo00o = iArr2;
        }
    ...
    public OooO00o OooO0O0() {
        return new OooO00o(this.f219OooOOo0, this, null);
    }

    @Override // OooOo.OooO0O0
    public void OooO0o0(@NonNull OooO0O0.OooO0OO oooO0OO) {
        this.f237OooO0Oo = oooO0OO;
        ...
        if (oooO0OO instanceof OooO00o) {
            this.f219OooOOo0 = (OooO00o) oooO0OO;
        }
    }
    ...
    public Drawable mutate() {
        if (!this.f218OooOOo) {
            super.mutate();
            this.f219OooOOo0.OooO0o0();
            this.f218OooOOo = true;
        }
        return this;
    }
    ...
    public boolean onStateChange(@NonNull int[] iArr) {
        ...
        int iOooO0o = this.f219OooOOo0.OooO0o(iArr);
        if (iOooO0o < 0) {
            iOooO0o = this.f219OooOOo0.OooO0o(StateSet.WILD_CARD);
        }
