...
public final class OooO0O0 {
    ...
    public static final HashMap f401OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final HashMap f402OooO0O0;
    ...
    static {
        ...
        f402OooO0O0 = map2;
        DynamicRange dynamicRange2 = DynamicRange.f3400OooO0Oo;
        map.put(1L, dynamicRange2);
        map2.put(dynamicRange2, Collections.singletonList(1L));
        map.put(2L, DynamicRange.f3402OooO0o0);
        ...
        while (true) {
            ...
            dynamicRange = DynamicRange.f3404OooO0oo;
            if (!zHasNext) {
                break;
            } else {
                f401OooO00o.put((Long) it.next(), dynamicRange);
            }
        }
        f402OooO0O0.put(dynamicRange, listAsList);
        List listAsList2 = Arrays.asList(1024L, 2048L, 256L, 512L);
        Iterator it2 = listAsList2.iterator();
        while (true) {
            boolean zHasNext2 = it2.hasNext();
            DynamicRange dynamicRange5 = DynamicRange.f3398OooO;
            if (!zHasNext2) {
                f402OooO0O0.put(dynamicRange5, listAsList2);
                return;
            }
            f401OooO00o.put((Long) it2.next(), dynamicRange5);
        }
    }
    ...
    public static Long OooO00o(@NonNull DynamicRange dynamicRange, @NonNull DynamicRangeProfiles dynamicRangeProfiles) {
        List<Long> list = (List) f402OooO0O0.get(dynamicRange);
        if (list == null) {
            return null;
        }
    ...
    public static DynamicRange OooO0O0(long j) {
        return (DynamicRange) f401OooO00o.get(Long.valueOf(j));
    }
}
