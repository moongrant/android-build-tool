...
public final class ActivityResult implements Parcelable {
    ...
    public final int f2200OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @Nullable
    public final Intent f2201OooO0o0;
    ...
    public final void writeToParcel(@NonNull Parcel parcel, int i) {
        parcel.writeInt(this.f2200OooO0Oo);
        Intent intent = this.f2201OooO0o0;
    ...
    public ActivityResult(Parcel parcel) {
        this.f2200OooO0Oo = parcel.readInt();
        this.f2201OooO0o0 = parcel.readInt() == 0 ? null : (Intent) Intent.CREATOR.createFromParcel(parcel);
    }
}
