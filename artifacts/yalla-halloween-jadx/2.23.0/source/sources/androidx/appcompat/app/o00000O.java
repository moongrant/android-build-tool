...
public final class o00000O {
    ...
    public static o00000O f2419OooO0Oo;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public long f2420OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public long f2421OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public int f2422OooO0OO;
    ...
    public final void OooO00o(double d, double d2, long j) {
        ...
        if (dSin3 >= 1.0d) {
            this.f2422OooO0OO = 1;
            this.f2420OooO00o = -1L;
            this.f2421OooO0O0 = -1L;
        } else {
            if (dSin3 <= -1.0d) {
                this.f2422OooO0OO = 0;
                this.f2420OooO00o = -1L;
            ...
            this.f2420OooO00o = Math.round((dSin2 + dAcos) * 8.64E7d) + 946728000000L;
            long jRound = Math.round((dSin2 - dAcos) * 8.64E7d) + 946728000000L;
            this.f2421OooO0O0 = jRound;
            if (jRound >= j || this.f2420OooO00o <= j) {
                this.f2422OooO0OO = 1;
            } else {
                this.f2422OooO0OO = 0;
            }
