...
public class ActionMenuView extends LinearLayoutCompat implements androidx.appcompat.view.menu.OooO.OooO0O0, androidx.appcompat.view.menu.OooOOOO {
    ...
    public androidx.appcompat.view.menu.OooO f2773OooOOoo;

    /* JADX INFO: renamed from: OooOo, reason: collision with root package name */
    public androidx.appcompat.view.menu.OooOOO.OooO00o f2774OooOo;

    /* JADX INFO: renamed from: OooOo0, reason: collision with root package name */
    public int f2775OooOo0;

    /* JADX INFO: renamed from: OooOo00, reason: collision with root package name */
    public Context f2776OooOo00;

    /* JADX INFO: renamed from: OooOo0O, reason: collision with root package name */
    public boolean f2777OooOo0O;

    /* JADX INFO: renamed from: OooOo0o, reason: collision with root package name */
    public ActionMenuPresenter f2778OooOo0o;

    /* JADX INFO: renamed from: OooOoO, reason: collision with root package name */
    public boolean f2779OooOoO;

    /* JADX INFO: renamed from: OooOoO0, reason: collision with root package name */
    public androidx.appcompat.view.menu.OooO.OooO00o f2780OooOoO0;

    /* JADX INFO: renamed from: OooOoOO, reason: collision with root package name */
    public int f2781OooOoOO;

    /* JADX INFO: renamed from: OooOoo, reason: collision with root package name */
    public final int f2782OooOoo;

    /* JADX INFO: renamed from: OooOoo0, reason: collision with root package name */
    public final int f2783OooOoo0;

    /* JADX INFO: renamed from: OooOooO, reason: collision with root package name */
    public OooO0o f2784OooOooO;

    public static class LayoutParams extends LinearLayoutCompat.LayoutParams {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        @ViewDebug.ExportedProperty
        public boolean f2785OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        @ViewDebug.ExportedProperty
        public int f2786OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        @ViewDebug.ExportedProperty
        public int f2787OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        @ViewDebug.ExportedProperty
        public boolean f2788OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public boolean f2789OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        @ViewDebug.ExportedProperty
        public boolean f2790OooO0o0;
        ...
        public LayoutParams(LayoutParams layoutParams) {
            super(layoutParams);
            this.f2785OooO00o = layoutParams.f2785OooO00o;
        }

        public LayoutParams() {
            super(-2, -2);
            this.f2785OooO00o = false;
        }
    }
    ...
    public class OooO0OO implements androidx.appcompat.view.menu.OooO.OooO00o {
        ...
        public final boolean OooO00o(@NonNull androidx.appcompat.view.menu.OooO oooO, @NonNull MenuItem menuItem) {
            ...
            OooO0o oooO0o = ActionMenuView.this.f2784OooOooO;
            if (oooO0o == null) {
                return false;
            }
            ...
            if (z) {
                ...
                Toolbar.OooOO0O oooOO0O = toolbar.f3162Oooo0o0;
                zOnMenuItemSelected = oooOO0O != null ? androidx.appcompat.app.o00000O0.this.f2424OooO0O0.onMenuItemSelected(0, menuItem) : false;
            }
        ...
        public final void OooO0O0(@NonNull androidx.appcompat.view.menu.OooO oooO) {
            androidx.appcompat.view.menu.OooO.OooO00o oooO00o = ActionMenuView.this.f2780OooOoO0;
            if (oooO00o != null) {
    ...
    public final boolean OooO0Oo(androidx.appcompat.view.menu.OooOO0O oooOO0O) {
        return this.f2773OooOOoo.OooOOo0(oooOO0O, null, 0);
    }
    ...
    public Menu getMenu() {
        if (this.f2773OooOOoo == null) {
            Context context = getContext();
            androidx.appcompat.view.menu.OooO oooO = new androidx.appcompat.view.menu.OooO(context);
            this.f2773OooOOoo = oooO;
            oooO.f2577OooO0o0 = new OooO0OO();
            ActionMenuPresenter actionMenuPresenter = new ActionMenuPresenter(context);
            this.f2778OooOo0o = actionMenuPresenter;
            actionMenuPresenter.f2751OooOOOo = true;
            actionMenuPresenter.f2753OooOOo0 = true;
            androidx.appcompat.view.menu.OooOOO.OooO00o oooO0O0 = this.f2774OooOo;
            if (oooO0O0 == null) {
                oooO0O0 = new OooO0O0();
            }
            actionMenuPresenter.f2600OooO0oo = oooO0O0;
            this.f2773OooOOoo.OooO0O0(actionMenuPresenter, this.f2776OooOo00);
            ActionMenuPresenter actionMenuPresenter2 = this.f2778OooOo0o;
            actionMenuPresenter2.f2602OooOO0O = this;
            this.f2773OooOOoo = actionMenuPresenter2.f2597OooO0o;
        }
        return this.f2773OooOOoo;
    }

    @Nullable
    public Drawable getOverflowIcon() {
        getMenu();
        ActionMenuPresenter actionMenuPresenter = this.f2778OooOo0o;
        ActionMenuPresenter.OooO0o oooO0o = actionMenuPresenter.f2749OooOOO0;
        if (oooO0o != null) {
            return oooO0o.getDrawable();
        }
        if (actionMenuPresenter.f2750OooOOOO) {
            return actionMenuPresenter.f2748OooOOO;
        }
        return null;
    }

    public int getPopupTheme() {
        return this.f2775OooOo0;
    }
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        if (actionMenuPresenter != null) {
            ...
            if (this.f2778OooOo0o.OooOOO0()) {
                this.f2778OooOo0o.OooOO0o();
                this.f2778OooOo0o.OooOOOO();
            }
        }
    }
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (zOooO00o) {
            ...
            for (int i14 = 0; i14 < childCount; i14++) {
                ...
                if (childAt3.getVisibility() != 8 && !layoutParams2.f2785OooO00o) {
        ...
        for (int i17 = 0; i17 < childCount; i17++) {
            ...
            if (childAt4.getVisibility() != 8 && !layoutParams3.f2785OooO00o) {
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if (this.f2779OooOoO && (oooO = this.f2773OooOOoo) != null && size != this.f2781OooOoOO) {
            this.f2781OooOoOO = size;
            oooO.OooOOOo(true);
        }
        int childCount = getChildCount();
        if (!this.f2779OooOoO || childCount <= 0) {
        ...
        while (true) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                layoutParams2.f2789OooO0o = false;
                layoutParams2.f2787OooO0OO = 0;
                layoutParams2.f2786OooO0O0 = 0;
                layoutParams2.f2788OooO0Oo = false;
                ((LinearLayout.LayoutParams) layoutParams2).leftMargin = 0;
                ((LinearLayout.LayoutParams) layoutParams2).rightMargin = 0;
                layoutParams2.f2790OooO0o0 = z6 && ((ActionMenuItemView) childAt).OooOO0o();
                int i19 = layoutParams2.f2785OooO00o ? 1 : i10;
                ...
                layoutParams3.f2788OooO0Oo = !layoutParams3.f2785OooO00o && z7;
                layoutParams3.f2786OooO0O0 = i6;
                childAt.measure(View.MeasureSpec.makeMeasureSpec(i12 * i6, Pow2.MAX_POW2), iMakeMeasureSpec);
                iMax2 = Math.max(iMax2, i6);
                if (layoutParams2.f2788OooO0Oo) {
                    i15++;
                }
                if (layoutParams2.f2785OooO00o) {
                    z5 = true;
                }
                i10 -= i6;
        ...
        while (true) {
            ...
            while (i25 < childCount2) {
                ...
                boolean z10 = z9;
                if (layoutParams4.f2788OooO0Oo) {
                    int i26 = layoutParams4.f2786OooO0O0;
                    if (i26 < i23) {
                        j2 = 1 << i25;
                        i23 = i26;
                        i24 = 1;
            ...
            while (i28 < childCount2) {
                ...
                long j3 = 1 << i28;
                if ((j2 & j3) != 0) {
                    if (z8 && layoutParams5.f2790OooO0o0) {
                        r4 = 1;
                        r4 = 1;
                        if (i10 == 1) {
                    ...
                    layoutParams5.f2786OooO0O0 += r4;
                    layoutParams5.f2789OooO0o = r4;
                    i10--;
                } else if (layoutParams5.f2786OooO0O0 == i27) {
                    j |= j3;
                }
                i28++;
        ...
        if (i10 <= 0 || j == 0 || (i10 >= i13 - 1 && !z11 && iMax2 <= 1)) {
            ...
            if (!z11) {
                if ((j & 1) != 0 && !((LayoutParams) getChildAt(0).getLayoutParams()).f2790OooO0o0) {
                    fBitCount -= 0.5f;
                }
                int i35 = i34 - 1;
                if ((j & ((long) (1 << i35))) != 0 && !((LayoutParams) getChildAt(i35).getLayoutParams()).f2790OooO0o0) {
                    fBitCount -= 0.5f;
                }
            }
            ...
            for (int i37 = 0; i37 < i4; i37++) {
                if ((j & ((long) (1 << i37))) != 0) {
                    ...
                    if (childAt3 instanceof ActionMenuItemView) {
                        layoutParams6.f2787OooO0OO = i36;
                        layoutParams6.f2789OooO0o = true;
                        if (i37 == 0 && !layoutParams6.f2790OooO0o0) {
                            ((LinearLayout.LayoutParams) layoutParams6).leftMargin = (-i36) / 2;
                        }
                        z12 = true;
                    } else if (layoutParams6.f2785OooO00o) {
                        layoutParams6.f2787OooO0OO = i36;
                        layoutParams6.f2789OooO0o = true;
        ...
        if (z2) {
            ...
            while (i38 < i4) {
                ...
                if (layoutParams7.f2789OooO0o) {
                    i5 = i33;
                    childAt4.measure(View.MeasureSpec.makeMeasureSpec((layoutParams7.f2786OooO0O0 * i12) + layoutParams7.f2787OooO0OO, Pow2.MAX_POW2), i5);
                } else {
                    i5 = i33;
                }
                i38++;
    ...
    public void setExpandedActionViewsExclusive(boolean z) {
        this.f2778OooOo0o.f2756OooOo0 = z;
    }

    public void setOnMenuItemClickListener(OooO0o oooO0o) {
        this.f2784OooOooO = oooO0o;
    }
    ...
    public void setOverflowIcon(@Nullable Drawable drawable) {
        ...
        if (oooO0o != null) {
            ...
            actionMenuPresenter.f2750OooOOOO = true;
            actionMenuPresenter.f2748OooOOO = drawable;
        }
    }
    ...
    public void setPopupTheme(@StyleRes int i) {
        if (this.f2775OooOo0 != i) {
            this.f2775OooOo0 = i;
            if (i == 0) {
                this.f2776OooOo00 = getContext();
            } else {
                this.f2776OooOo00 = new ContextThemeWrapper(getContext(), i);
            }
        }
    }
    ...
    public void setPresenter(ActionMenuPresenter actionMenuPresenter) {
        this.f2778OooOo0o = actionMenuPresenter;
        actionMenuPresenter.f2602OooOO0O = this;
        this.f2773OooOOoo = actionMenuPresenter.f2597OooO0o;
    }
    ...
    public ActionMenuView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.f2783OooOoo0 = (int) (56.0f * f);
        this.f2782OooOoo = (int) (f * 4.0f);
        this.f2776OooOo00 = context;
        this.f2775OooOo0 = 0;
    }
