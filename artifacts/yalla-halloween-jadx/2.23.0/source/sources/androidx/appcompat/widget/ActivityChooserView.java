...
public class ActivityChooserView extends ViewGroup {
    ...
    public final FrameLayout f2792OooO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final OooOO0 f2793OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final View f2794OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final OooOO0O f2795OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final FrameLayout f2796OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final ImageView f2797OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public androidx.core.view.OooO0O0 f2798OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public final OooO0O0 f2799OooOO0O;

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    public ListPopupWindow f2800OooOO0o;

    /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
    public boolean f2801OooOOO;

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    public PopupWindow.OnDismissListener f2802OooOOO0;

    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public static class InnerLayout extends LinearLayout {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final int[] f2803OooO0Oo = {R.attr.background};

        public InnerLayout(Context context, AttributeSet attributeSet) {
            int resourceId;
            super(context, attributeSet);
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, f2803OooO0Oo);
    ...
    public class OooO extends DataSetObserver {
        ...
        public final void onChanged() {
            super.onChanged();
            ActivityChooserView.this.f2793OooO0Oo.getClass();
            throw null;
        }
    }
    ...
    public class OooO00o extends DataSetObserver {
        ...
        public final void onChanged() {
            super.onChanged();
            ActivityChooserView.this.f2793OooO0Oo.notifyDataSetChanged();
        }

        @Override // android.database.DataSetObserver
        public final void onInvalidated() {
            super.onInvalidated();
            ActivityChooserView.this.f2793OooO0Oo.notifyDataSetInvalidated();
        }
    }
    ...
    public class OooO0O0 implements ViewTreeObserver.OnGlobalLayoutListener {
        ...
        public final void onGlobalLayout() {
            ...
            if (activityChooserView.OooO0O0()) {
                ...
                androidx.core.view.OooO0O0 oooO0O0 = activityChooserView.f2798OooOO0;
                if (oooO0O0 == null || (oooO00o = oooO0O0.f5329OooO00o) == null) {
                    return;
                }
    ...
    public class OooO0o extends o00000O0 {
        ...
        public final boolean OooO0OO() {
            ActivityChooserView activityChooserView = ActivityChooserView.this;
            if (activityChooserView.OooO0O0() || !activityChooserView.f2801OooOOO) {
                return true;
            }
            activityChooserView.f2793OooO0Oo.getClass();
    ...
    public class OooOO0O implements AdapterView.OnItemClickListener, View.OnClickListener, View.OnLongClickListener, PopupWindow.OnDismissListener {
        ...
        public final void onClick(View view) {
            ActivityChooserView activityChooserView = ActivityChooserView.this;
            FrameLayout frameLayout = activityChooserView.f2792OooO;
            OooOO0 oooOO1 = activityChooserView.f2793OooO0Oo;
            if (view == frameLayout) {
                activityChooserView.OooO00o();
                oooOO1.getClass();
                throw null;
            }
            if (view != activityChooserView.f2796OooO0oO) {
        ...
        public final void onDismiss() {
            androidx.core.view.OooO0O0.OooO00o oooO00o;
            ActivityChooserView activityChooserView = ActivityChooserView.this;
            PopupWindow.OnDismissListener onDismissListener = activityChooserView.f2802OooOOO0;
        ...
        public final boolean onLongClick(View view) {
            ActivityChooserView activityChooserView = ActivityChooserView.this;
            if (view != activityChooserView.f2792OooO) {
                throw new IllegalArgumentException();
            }
            activityChooserView.f2793OooO0Oo.getClass();
            throw null;
    ...
    public final void OooO00o() {
        if (OooO0O0()) {
            ...
            if (viewTreeObserver.isAlive()) {
                viewTreeObserver.removeGlobalOnLayoutListener(this.f2799OooOO0O);
            }
        }
    }
    ...
    public androidx.appcompat.widget.OooO0o getDataModel() {
        this.f2793OooO0Oo.getClass();
        return null;
    }

    public ListPopupWindow getListPopupWindow() {
        if (this.f2800OooOO0o == null) {
            ListPopupWindow listPopupWindow = new ListPopupWindow(getContext());
            this.f2800OooOO0o = listPopupWindow;
            listPopupWindow.OooOO0o(this.f2793OooO0Oo);
            ListPopupWindow listPopupWindow2 = this.f2800OooOO0o;
            listPopupWindow2.f2925OooOOo = this;
            listPopupWindow2.f2937OooOoo0 = true;
            listPopupWindow2.f2936OooOoo.setFocusable(true);
            ListPopupWindow listPopupWindow3 = this.f2800OooOO0o;
            OooOO0O oooOO0O = this.f2795OooO0o0;
            listPopupWindow3.f2927OooOOoo = oooOO0O;
            listPopupWindow3.f2936OooOoo.setOnDismissListener(oooOO0O);
        }
        return this.f2800OooOO0o;
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        this.f2801OooOOO = false;
    }

    @Override // android.view.ViewGroup, android.view.View
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        this.f2794OooO0o.layout(0, 0, i3 - i, i4 - i2);
        if (OooO0O0()) {
            return;
        }
        OooO00o();
    ...
    public void setActivityChooserModel(androidx.appcompat.widget.OooO0o oooO0o) {
        OooOO0 oooOO1 = this.f2793OooO0Oo;
        ActivityChooserView.this.f2793OooO0Oo.getClass();
        oooOO1.notifyDataSetChanged();
        if (OooO0O0()) {
            OooO00o();
            if (OooO0O0() || !this.f2801OooOOO) {
                return;
            }
            oooOO1.getClass();
            throw new IllegalStateException("No data model. Did you call #setDataModel?");
    ...
    public void setExpandActivityOverflowButtonContentDescription(int i) {
        this.f2797OooO0oo.setContentDescription(getContext().getString(i));
    }

    public void setExpandActivityOverflowButtonDrawable(Drawable drawable) {
        this.f2797OooO0oo.setImageDrawable(drawable);
    }
    ...
    public void setOnDismissListener(PopupWindow.OnDismissListener onDismissListener) {
        this.f2802OooOOO0 = onDismissListener;
    }

    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public void setProvider(androidx.core.view.OooO0O0 oooO0O0) {
        this.f2798OooOO0 = oooO0O0;
    }
    ...
    public ActivityChooserView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.f2796OooO0oO = frameLayout2;
        ImageView imageView = (ImageView) frameLayout2.findViewById(i2);
        this.f2797OooO0oo = imageView;
        imageView.setImageDrawable(drawable);
        OooOO0 oooOO1 = new OooOO0();
        this.f2793OooO0Oo = oooOO1;
