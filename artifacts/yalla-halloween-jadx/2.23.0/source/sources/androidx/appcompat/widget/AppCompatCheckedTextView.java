...
public class AppCompatCheckedTextView extends CheckedTextView implements androidx.core.widget.Oooo000 {
    ...
    public final OooOO0 f2821OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final o00Oo0 f2822OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final OooO f2823OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    @NonNull
    public OooOOOO f2824OooO0oO;
    ...
    private OooOOOO getEmojiTextViewHelper() {
        if (this.f2824OooO0oO == null) {
            this.f2824OooO0oO = new OooOOOO(this);
        }
        return this.f2824OooO0oO;
    }

    @Override // android.widget.CheckedTextView, android.widget.TextView, android.view.View
    public final void drawableStateChanged() {
        super.drawableStateChanged();
        o00Oo0 o00oo1 = this.f2822OooO0o;
        if (o00oo1 != null) {
            o00oo1.OooO0O0();
        }
        OooO oooO = this.f2823OooO0o0;
        if (oooO != null) {
            oooO.OooO00o();
        }
        OooOO0 oooOO1 = this.f2821OooO0Oo;
        if (oooOO1 != null) {
            oooOO1.OooO00o();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f2822OooO0o.OooO0Oo();
    }

    @Nullable
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f2822OooO0o.OooO0o0();
    }
    ...
    public void setCheckMarkDrawable(@Nullable Drawable drawable) {
        ...
        OooOO0 oooOO1 = this.f2821OooO0Oo;
        if (oooOO1 != null) {
            if (oooOO1.f2971OooO0o) {
                oooOO1.f2971OooO0o = false;
            } else {
                oooOO1.f2971OooO0o = true;
                oooOO1.OooO00o();
            }
        }
    }
    ...
    public void setSupportCheckMarkTintList(@Nullable ColorStateList colorStateList) {
        OooOO0 oooOO1 = this.f2821OooO0Oo;
        if (oooOO1 != null) {
            oooOO1.f2968OooO0O0 = colorStateList;
            oooOO1.f2970OooO0Oo = true;
            oooOO1.OooO00o();
        }
    }
    ...
    public void setSupportCheckMarkTintMode(@Nullable PorterDuff.Mode mode) {
        OooOO0 oooOO1 = this.f2821OooO0Oo;
        if (oooOO1 != null) {
            oooOO1.f2969OooO0OO = mode;
            oooOO1.f2972OooO0o0 = true;
            oooOO1.OooO00o();
        }
    }
