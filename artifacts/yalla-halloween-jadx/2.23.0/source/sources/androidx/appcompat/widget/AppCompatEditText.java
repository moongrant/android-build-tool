...
public class AppCompatEditText extends EditText implements androidx.core.view.o00000O0, androidx.core.widget.Oooo000 {
    ...
    @Nullable
    public OooO00o f2825OooO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final OooO f2826OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final o00O0O f2827OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final o00Oo0 f2828OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final androidx.core.widget.OooOo00 f2829OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    @NonNull
    public final OooOOO f2830OooO0oo;
    ...
    private OooO00o getSuperCaller() {
        if (this.f2825OooO == null) {
            this.f2825OooO = new OooO00o();
        }
        return this.f2825OooO;
    }

    @Override // androidx.core.view.o00000O0
    @Nullable
    public final ContentInfoCompat OooO00o(@NonNull ContentInfoCompat contentInfoCompat) {
        return this.f2829OooO0oO.OooO00o(this, contentInfoCompat);
    }

    @Override // android.widget.TextView, android.view.View
    public final void drawableStateChanged() {
        super.drawableStateChanged();
        OooO oooO = this.f2826OooO0Oo;
        if (oooO != null) {
            oooO.OooO00o();
        }
        o00Oo0 o00oo1 = this.f2828OooO0o0;
        if (o00oo1 != null) {
            o00oo1.OooO0O0();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f2828OooO0o0.OooO0Oo();
    }

    @Nullable
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f2828OooO0o0.OooO0o0();
    }
    ...
    public TextClassifier getTextClassifier() {
        o00O0O o00o0o2;
        if (Build.VERSION.SDK_INT >= 28 || (o00o0o2 = this.f2827OooO0o) == null) {
    ...
    public InputConnection onCreateInputConnection(@NonNull EditorInfo editorInfo) {
        ...
        String[] stringArray;
        InputConnection oooOO0O;
        InputConnection inputConnectionOnCreateInputConnection = super.onCreateInputConnection(editorInfo);
        this.f2828OooO0o0.getClass();
        ...
        if (inputConnectionOnCreateInputConnection != null && i <= 30 && (strArrOooO0oO = ViewCompat.OooO0oO(this)) != null) {
            ...
            o0000OO.OooO oooO = new o0000OO.OooO(this);
            if (i >= 25) {
                oooOO0O = new o0000OO.OooOO0(inputConnectionOnCreateInputConnection, oooO);
            } else {
                String[] strArr = o0000OO.OooO0OO.f34116OooO00o;
                if (i >= 25) {
                ...
                if (strArr.length != 0) {
                    oooOO0O = new o0000OO.OooOO0O(inputConnectionOnCreateInputConnection, oooO);
                }
            }
            inputConnectionOnCreateInputConnection = oooOO0O;
        }
        return this.f2830OooO0oo.OooO0OO(inputConnectionOnCreateInputConnection, editorInfo);
    }
    ...
    public void setEmojiCompatEnabled(boolean z) {
        this.f2830OooO0oo.OooO0Oo(z);
    }

    @Override // android.widget.TextView
    public void setKeyListener(@Nullable KeyListener keyListener) {
        super.setKeyListener(this.f2830OooO0oo.OooO00o(keyListener));
    }
    ...
    public AppCompatEditText(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.f2826OooO0Oo = oooO;
        oooO.OooO0Oo(attributeSet, i);
        o00Oo0 o00oo1 = new o00Oo0(this);
        this.f2828OooO0o0 = o00oo1;
        o00oo1.OooO0o(attributeSet, i);
        o00oo1.OooO0O0();
        this.f2827OooO0o = new o00O0O(this);
        this.f2829OooO0oO = new androidx.core.widget.OooOo00();
        OooOOO oooOOO = new OooOOO(this);
        this.f2830OooO0oo = oooOOO;
