...
public class AppCompatToggleButton extends ToggleButton implements androidx.core.widget.Oooo000 {
    ...
    public final OooO f2880OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public OooOOOO f2881OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final o00Oo0 f2882OooO0o0;
    ...
    private OooOOOO getEmojiTextViewHelper() {
        if (this.f2881OooO0o == null) {
            this.f2881OooO0o = new OooOOOO(this);
        }
        return this.f2881OooO0o;
    }

    @Override // android.widget.ToggleButton, android.widget.CompoundButton, android.widget.TextView, android.view.View
    public final void drawableStateChanged() {
        super.drawableStateChanged();
        OooO oooO = this.f2880OooO0Oo;
        if (oooO != null) {
            oooO.OooO00o();
        }
        o00Oo0 o00oo1 = this.f2882OooO0o0;
        if (o00oo1 != null) {
            o00oo1.OooO0O0();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f2882OooO0o0.OooO0Oo();
    }

    @Nullable
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f2882OooO0o0.OooO0o0();
    }
