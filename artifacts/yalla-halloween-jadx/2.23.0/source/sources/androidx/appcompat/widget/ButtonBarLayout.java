...
public class ButtonBarLayout extends LinearLayout {
    ...
    public boolean f2883OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public int f2884OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public boolean f2885OooO0o0;
    ...
    public ButtonBarLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.f2883OooO0Oo = typedArrayObtainStyledAttributes.getBoolean(p012OooOo0O.o00O0O.ButtonBarLayout_allowStacking, true);
        typedArrayObtainStyledAttributes.recycle();
        if (getOrientation() == 1) {
            setStacked(this.f2883OooO0Oo);
        }
    }

    private void setStacked(boolean z) {
        if (this.f2885OooO0o0 != z) {
            if (!z || this.f2883OooO0Oo) {
                this.f2885OooO0o0 = z;
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if (this.f2883OooO0Oo) {
            if (size > this.f2884OooO0o && this.f2885OooO0o0) {
                setStacked(false);
            }
            this.f2884OooO0o = size;
        }
        if (this.f2885OooO0o0 || View.MeasureSpec.getMode(i) != 1073741824) {
            iMakeMeasureSpec = i;
            z = false;
        } else {
        ...
        if (this.f2883OooO0Oo && !this.f2885OooO0o0) {
    ...
    public void setAllowStacking(boolean z) {
        if (this.f2883OooO0Oo != z) {
            this.f2883OooO0Oo = z;
            if (!z && this.f2885OooO0o0) {
                setStacked(false);
            }
            requestLayout();
        }
