...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public int f2894OooO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public boolean f2895OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public int f2896OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public int f2897OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public int f2898OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public int f2899OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public float f2900OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public boolean f2901OooOO0O;

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    public int[] f2902OooOO0o;

    /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
    public Drawable f2903OooOOO;

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    public int[] f2904OooOOO0;

    /* JADX INFO: renamed from: OooOOOO, reason: collision with root package name */
    public int f2905OooOOOO;

    /* JADX INFO: renamed from: OooOOOo, reason: collision with root package name */
    public int f2906OooOOOo;

    /* JADX INFO: renamed from: OooOOo, reason: collision with root package name */
    public int f2907OooOOo;

    /* JADX INFO: renamed from: OooOOo0, reason: collision with root package name */
    public int f2908OooOOo0;
    ...
    public final void OooO0o(Canvas canvas, int i) {
        this.f2903OooOOO.setBounds(getPaddingLeft() + this.f2907OooOOo, i, (getWidth() - getPaddingRight()) - this.f2907OooOOo, this.f2906OooOOOo + i);
        this.f2903OooOOO.draw(canvas);
    }

    public final void OooO0oO(Canvas canvas, int i) {
        this.f2903OooOOO.setBounds(i, getPaddingTop() + this.f2907OooOOo, this.f2905OooOOOO + i, (getHeight() - getPaddingBottom()) - this.f2907OooOOo);
        this.f2903OooOOO.draw(canvas);
    }
    ...
    public final boolean OooOO0O(int i) {
        if (i == 0) {
            return (this.f2908OooOOo0 & 1) != 0;
        }
        if (i == getChildCount()) {
            return (this.f2908OooOOo0 & 4) != 0;
        }
        if ((this.f2908OooOOo0 & 2) == 0) {
            return false;
        }
    ...
    public int getBaseline() {
        int i;
        if (this.f2897OooO0o0 < 0) {
            return super.getBaseline();
        }
        int childCount = getChildCount();
        int i2 = this.f2897OooO0o0;
        if (childCount <= i2) {
        ...
        int iOooO00o = this.f2896OooO0o;
        if (this.f2898OooO0oO == 1 && (i = this.f2899OooO0oo & 112) != 48) {
            if (i == 16) {
                iOooO00o = OooO00o.OooO00o(((getBottom() - getTop()) - getPaddingTop()) - getPaddingBottom(), this.f2894OooO, 2, iOooO00o);
            } else if (i == 80) {
                iOooO00o = ((getBottom() - getTop()) - getPaddingBottom()) - this.f2894OooO;
            }
        }
    ...
    public int getBaselineAlignedChildIndex() {
        return this.f2897OooO0o0;
    }

    public Drawable getDividerDrawable() {
        return this.f2903OooOOO;
    }
    ...
    public int getDividerWidth() {
        return this.f2905OooOOOO;
    }

    @GravityInt
    public int getGravity() {
        return this.f2899OooO0oo;
    }

    public int getOrientation() {
        return this.f2898OooO0oO;
    }

    public int getShowDividers() {
        return this.f2908OooOOo0;
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int i;
        int bottom;
        if (this.f2903OooOOO == null) {
            return;
        }
        int i2 = 0;
        if (this.f2898OooO0oO == 1) {
            int virtualChildCount = getVirtualChildCount();
            while (i2 < virtualChildCount) {
                View childAt = getChildAt(i2);
                if (childAt != null && childAt.getVisibility() != 8 && OooOO0O(i2)) {
                    OooO0o(canvas, (childAt.getTop() - ((LinearLayout.LayoutParams) ((LayoutParams) childAt.getLayoutParams())).topMargin) - this.f2906OooOOOo);
                }
                i2++;
            }
            if (OooOO0O(virtualChildCount)) {
                ...
                if (childAt2 == null) {
                    bottom = (getHeight() - getPaddingBottom()) - this.f2906OooOOOo;
                } else {
        ...
        while (i2 < virtualChildCount2) {
            ...
            if (childAt3 != null && childAt3.getVisibility() != 8 && OooOO0O(i2)) {
                ...
                OooO0oO(canvas, zOooO00o ? childAt3.getRight() + ((LinearLayout.LayoutParams) layoutParams).rightMargin : (childAt3.getLeft() - ((LinearLayout.LayoutParams) layoutParams).leftMargin) - this.f2905OooOOOO);
            }
            i2++;
        }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.f2898OooO0oO == 1) {
            ...
            int virtualChildCount = getVirtualChildCount();
            int i18 = this.f2899OooO0oo;
            int i19 = i18 & 112;
            int i20 = 8388615 & i18;
            if (i19 != 16) {
                iOooO00o3 = i19 != 80 ? getPaddingTop() : ((getPaddingTop() + i4) - i2) - this.f2894OooO;
            } else {
                iOooO00o3 = OooO00o.OooO00o(i4 - i2, this.f2894OooO, 2, getPaddingTop());
            }
            int i21 = 0;
        ...
        int virtualChildCount2 = getVirtualChildCount();
        int i28 = this.f2899OooO0oo;
        int i29 = 8388615 & i28;
        int i30 = i28 & 112;
        boolean z2 = this.f2895OooO0Oo;
        int[] iArr = this.f2902OooOO0o;
        int[] iArr2 = this.f2904OooOOO0;
        ...
        if (absoluteGravity2 != 1) {
            iOooO00o = absoluteGravity2 != 5 ? getPaddingLeft() : ((getPaddingLeft() + i3) - i) - this.f2894OooO;
        } else {
            iOooO00o = OooO00o.OooO00o(i3 - i, this.f2894OooO, 2, getPaddingLeft());
        }
        if (zOooO00o) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (i30 == 1) {
            ...
            int i36 = this.f2897OooO0o0;
            boolean z12 = this.f2901OooOO0O;
            boolean z13 = true;
            int i37 = 0;
            int iMax5 = 0;
            int i38 = 0;
            ...
            while (i37 < virtualChildCount) {
                ...
                if (childAt4 == null) {
                    ...
                    if (childAt4.getVisibility() == i33) {
                        ...
                        if (OooOO0O(i37)) {
                            this.f2894OooO += this.f2906OooOOOo;
                        }
                        ...
                        if (mode2 == i34 && ((LinearLayout.LayoutParams) layoutParams5).height == 0 && f5 > f3) {
                            int i40 = this.f2894OooO;
                            this.f2894OooO = Math.max(i40, ((LinearLayout.LayoutParams) layoutParams5).topMargin + i40 + ((LinearLayout.LayoutParams) layoutParams5).bottomMargin);
                            ...
                            int i41 = f4 == f3 ? this.f2894OooO : 0;
                            z8 = true;
                            layoutParams4 = layoutParams5;
                            ...
                            int i42 = this.f2894OooO;
                            this.f2894OooO = Math.max(i42, i42 + measuredHeight2 + ((LinearLayout.LayoutParams) layoutParams4).topMargin + ((LinearLayout.LayoutParams) layoutParams4).bottomMargin + 0);
                            if (z12) {
                        ...
                        if (i36 >= 0 && i36 == i37 + 1) {
                            this.f2896OooO0o = this.f2894OooO;
                        }
            ...
            int i49 = iMax7;
            int i50 = i39;
            if (this.f2894OooO > 0 && OooOO0O(i47)) {
                this.f2894OooO += this.f2906OooOOOo;
            }
            int i51 = i45;
            if (z12 && (i51 == Integer.MIN_VALUE || i51 == 0)) {
                ...
                while (i53 < i47) {
                    ...
                    if (childAt5 == null) {
                        ...
                        int i54 = this.f2894OooO;
                        this.f2894OooO = Math.max(i54, i54 + i48 + ((LinearLayout.LayoutParams) layoutParams6).topMargin + ((LinearLayout.LayoutParams) layoutParams6).bottomMargin + 0);
                    }
                    i53++;
                    i52 = 0;
                }
            }
            int paddingBottom = getPaddingBottom() + getPaddingTop() + this.f2894OooO;
            this.f2894OooO = paddingBottom;
            int iResolveSizeAndState = View.resolveSizeAndState(Math.max(paddingBottom, getSuggestedMinimumHeight()), i2, 0);
            int i55 = (16777215 & iResolveSizeAndState) - this.f2894OooO;
            if (z14 || (i55 != 0 && f4 > 0.0f)) {
                float f6 = this.f2900OooOO0;
                if (f6 > 0.0f) {
                    f4 = f6;
                }
                this.f2894OooO = 0;
                ...
                while (i56 < i47) {
                    ...
                    if (childAt6.getVisibility() != 8) {
                        ...
                        if (i46 != 1073741824) {
                            ...
                            int i60 = this.f2894OooO;
                            this.f2894OooO = Math.max(i60, childAt6.getMeasuredHeight() + i60 + ((LinearLayout.LayoutParams) layoutParams7).topMargin + ((LinearLayout.LayoutParams) layoutParams7).bottomMargin + 0);
                            z13 = z7;
                            i50 = i25;
                            iMax9 = iMax11;
                        } else {
                        ...
                        int i61 = this.f2894OooO;
                        this.f2894OooO = Math.max(i61, childAt6.getMeasuredHeight() + i61 + ((LinearLayout.LayoutParams) layoutParams7).topMargin + ((LinearLayout.LayoutParams) layoutParams7).bottomMargin + 0);
                        z13 = z7;
                        i50 = i25;
                        iMax9 = iMax12;
                    }
                ...
                this.f2894OooO = getPaddingBottom() + getPaddingTop() + this.f2894OooO;
            } else {
        ...
        if (this.f2902OooOO0o == null || this.f2904OooOOO0 == null) {
            this.f2902OooOO0o = new int[4];
            this.f2904OooOOO0 = new int[4];
        }
        int[] iArr = this.f2902OooOO0o;
        int[] iArr2 = this.f2904OooOOO0;
        iArr[3] = -1;
        ...
        iArr2[1] = -1;
        iArr2[0] = -1;
        boolean z18 = this.f2895OooO0Oo;
        boolean z19 = this.f2901OooOO0O;
        ...
        while (i68 < virtualChildCount2) {
            ...
            if (childAt9 == null) {
                ...
                if (childAt9.getVisibility() == 8) {
                    ...
                    if (OooOO0O(i68)) {
                        this.f2894OooO += this.f2905OooOOOO;
                    }
                    ...
                    if (mode3 == 1073741824 && ((LinearLayout.LayoutParams) layoutParams9).width == 0 && f9 > 0.0f) {
                        if (z20) {
                            this.f2894OooO = ((LinearLayout.LayoutParams) layoutParams9).leftMargin + ((LinearLayout.LayoutParams) layoutParams9).rightMargin + this.f2894OooO;
                        } else {
                            int i71 = this.f2894OooO;
                            this.f2894OooO = Math.max(i71, ((LinearLayout.LayoutParams) layoutParams9).leftMargin + i71 + ((LinearLayout.LayoutParams) layoutParams9).rightMargin);
                        }
                        if (z18) {
                        ...
                        if (((LinearLayout.LayoutParams) layoutParams9).width == 0) {
                            ...
                            if (z20) {
                                this.f2894OooO = ((LinearLayout.LayoutParams) layoutParams3).leftMargin + measuredWidth + ((LinearLayout.LayoutParams) layoutParams3).rightMargin + 0 + this.f2894OooO;
                            } else {
                                int i75 = this.f2894OooO;
                                this.f2894OooO = Math.max(i75, i75 + measuredWidth + ((LinearLayout.LayoutParams) layoutParams3).leftMargin + ((LinearLayout.LayoutParams) layoutParams3).rightMargin + 0);
                            }
                            if (z) {
                        ...
                        if (z20) {
                            ...
                            int i76 = this.f2894OooO;
                            this.f2894OooO = Math.max(i76, i76 + measuredWidth + ((LinearLayout.LayoutParams) layoutParams3).leftMargin + ((LinearLayout.LayoutParams) layoutParams3).rightMargin + 0);
                        }
                        if (z) {
                            iMax13 = Math.max(measuredWidth, iMax13);
                        }
        ...
        int i77 = i66;
        int i78 = i70;
        if (this.f2894OooO > 0 && OooOO0O(virtualChildCount2)) {
            this.f2894OooO += this.f2905OooOOOO;
        }
        int i79 = iArr[1];
        int i80 = i69;
        if (i79 == -1 && iArr[0] == -1 && iArr[2] == -1) {
            ...
            if (z24 && (mode3 == Integer.MIN_VALUE || mode3 == 0)) {
                ...
                while (i14 < virtualChildCount2) {
                    ...
                    if (childAt3 == null) {
                        ...
                        if (z20) {
                            this.f2894OooO = ((LinearLayout.LayoutParams) layoutParams2).leftMargin + iMax13 + ((LinearLayout.LayoutParams) layoutParams2).rightMargin + 0 + this.f2894OooO;
                        } else {
                            int i81 = this.f2894OooO;
                            this.f2894OooO = Math.max(i81, i81 + iMax13 + ((LinearLayout.LayoutParams) layoutParams2).leftMargin + ((LinearLayout.LayoutParams) layoutParams2).rightMargin + 0);
                        }
                    }
                    i14++;
                    i13 = 0;
            ...
            int paddingRight = getPaddingRight() + getPaddingLeft() + this.f2894OooO;
            this.f2894OooO = paddingRight;
            int iResolveSizeAndState2 = View.resolveSizeAndState(Math.max(paddingRight, getSuggestedMinimumWidth()), i, 0);
            i3 = (16777215 & iResolveSizeAndState2) - this.f2894OooO;
            if (!z22 || (i3 != 0 && f8 > 0.0f)) {
                f = this.f2900OooOO0;
                if (f > 0.0f) {
                    f8 = f;
                ...
                while (i4 < virtualChildCount2) {
                    ...
                    if (childAt != null || childAt.getVisibility() == 8) {
                        ...
                        if (z20) {
                            this.f2894OooO = childAt.getMeasuredWidth() + ((LinearLayout.LayoutParams) layoutParams10).leftMargin + ((LinearLayout.LayoutParams) layoutParams10).rightMargin + 0 + this.f2894OooO;
                        } else {
                            int i84 = this.f2894OooO;
                            this.f2894OooO = Math.max(i84, childAt.getMeasuredWidth() + i84 + ((LinearLayout.LayoutParams) layoutParams10).leftMargin + ((LinearLayout.LayoutParams) layoutParams10).rightMargin + 0);
                        }
                        i9 = mode4;
                ...
                i5 = mode4;
                this.f2894OooO = getPaddingRight() + getPaddingLeft() + this.f2894OooO;
                i6 = iArr[1];
            ...
            while (i14 < virtualChildCount2) {
                ...
                if (childAt3 == null) {
                    ...
                    if (z20) {
                        ...
                        int i810 = this.f2894OooO;
                        this.f2894OooO = Math.max(i810, i810 + iMax13 + ((LinearLayout.LayoutParams) layoutParams2).leftMargin + ((LinearLayout.LayoutParams) layoutParams2).rightMargin + 0);
                    }
                }
                i14++;
                i13 = 0;
        ...
        int paddingRight2 = getPaddingRight() + getPaddingLeft() + this.f2894OooO;
        this.f2894OooO = paddingRight2;
        int iResolveSizeAndState3 = View.resolveSizeAndState(Math.max(paddingRight2, getSuggestedMinimumWidth()), i, 0);
        i3 = (16777215 & iResolveSizeAndState3) - this.f2894OooO;
        if (z22) {
            f = this.f2900OooOO0;
            if (f > 0.0f) {
                f8 = f;
    ...
    public void setDividerDrawable(Drawable drawable) {
        if (drawable == this.f2903OooOOO) {
            return;
        }
        this.f2903OooOOO = drawable;
        if (drawable != null) {
            this.f2905OooOOOO = drawable.getIntrinsicWidth();
            this.f2906OooOOOo = drawable.getIntrinsicHeight();
        } else {
            this.f2905OooOOOO = 0;
            this.f2906OooOOOo = 0;
        }
    ...
    public void setHorizontalGravity(int i) {
        int i2 = i & 8388615;
        int i3 = this.f2899OooO0oo;
        if ((8388615 & i3) != i2) {
            this.f2899OooO0oo = i2 | ((-8388616) & i3);
            requestLayout();
        }
    }
    ...
    public void setVerticalGravity(int i) {
        ...
        int i3 = this.f2899OooO0oo;
        if ((i3 & 112) != i2) {
            this.f2899OooO0oo = i2 | (i3 & (-113));
            requestLayout();
        }
    }

    public void setWeightSum(float f) {
        this.f2900OooOO0 = Math.max(0.0f, f);
    }
    ...
    public LinearLayoutCompat(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.f2895OooO0Oo = true;
        this.f2897OooO0o0 = -1;
        this.f2896OooO0o = 0;
        this.f2899OooO0oo = 8388659;
        ...
        this.f2900OooOO0 = typedArrayObtainStyledAttributes.getFloat(p012OooOo0O.o00O0O.LinearLayoutCompat_android_weightSum, -1.0f);
        this.f2897OooO0o0 = typedArrayObtainStyledAttributes.getInt(p012OooOo0O.o00O0O.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.f2901OooOO0O = typedArrayObtainStyledAttributes.getBoolean(p012OooOo0O.o00O0O.LinearLayoutCompat_measureWithLargestChild, false);
        ...
        this.f2908OooOOo0 = typedArrayObtainStyledAttributes.getInt(p012OooOo0O.o00O0O.LinearLayoutCompat_showDividers, 0);
        this.f2907OooOOo = typedArrayObtainStyledAttributes.getDimensionPixelSize(p012OooOo0O.o00O0O.LinearLayoutCompat_dividerPadding, 0);
