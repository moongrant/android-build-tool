...
public final class MenuPopupWindow extends ListPopupWindow implements o00000OO {
    ...
    public static final Method f2943Oooo00o;

    /* JADX INFO: renamed from: Oooo00O, reason: collision with root package name */
    public o00000OO f2944Oooo00O;

    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public static class MenuDropDownListView extends o000000O {

        /* JADX INFO: renamed from: OooOOOo, reason: collision with root package name */
        public final int f2945OooOOOo;

        /* JADX INFO: renamed from: OooOOo, reason: collision with root package name */
        public o00000OO f2946OooOOo;

        /* JADX INFO: renamed from: OooOOo0, reason: collision with root package name */
        public final int f2947OooOOo0;

        /* JADX INFO: renamed from: OooOOoo, reason: collision with root package name */
        public androidx.appcompat.view.menu.OooOO0O f2948OooOOoo;
        ...
        public MenuDropDownListView(Context context, boolean z) {
            ...
            if (1 == OooO00o.OooO00o(context.getResources().getConfiguration())) {
                this.f2945OooOOOo = 21;
                this.f2947OooOOo0 = 22;
            } else {
                this.f2945OooOOOo = 22;
                this.f2947OooOOo0 = 21;
            }
        }
        ...
        public final boolean onHoverEvent(MotionEvent motionEvent) {
            ...
            if (this.f2946OooOOo != null) {
                ...
                androidx.appcompat.view.menu.OooOO0O oooOO0O = this.f2948OooOOoo;
                if (oooOO0O != item) {
                    androidx.appcompat.view.menu.OooO oooO = oooO0o.f2618OooO0Oo;
                    if (oooOO0O != null) {
                        this.f2946OooOOo.OooOOO0(oooO, oooOO0O);
                    }
                    this.f2948OooOOoo = item;
                    if (item != null) {
                        this.f2946OooOOo.OooO0OO(oooO, item);
                    }
                }
            }
        ...
        public final boolean onKeyDown(int i, KeyEvent keyEvent) {
            ...
            if (listMenuItemView != null && i == this.f2945OooOOOo) {
                if (listMenuItemView.isEnabled() && listMenuItemView.getItemData().hasSubMenu()) {
                    performItemClick(listMenuItemView, getSelectedItemPosition(), getSelectedItemId());
                }
                return true;
            }
            if (listMenuItemView == null || i != this.f2947OooOOo0) {
                return super.onKeyDown(i, keyEvent);
            }
            setSelection(-1);
            ListAdapter adapter = getAdapter();
            (adapter instanceof HeaderViewListAdapter ? (androidx.appcompat.view.menu.OooO0o) ((HeaderViewListAdapter) adapter).getWrappedAdapter() : (androidx.appcompat.view.menu.OooO0o) adapter).f2618OooO0Oo.OooO0OO(false);
            return true;
        }

        public void setHoverListener(o00000OO o00000oo2) {
            this.f2946OooOOo = o00000oo2;
        }
    ...
    static {
        try {
            if (Build.VERSION.SDK_INT <= 28) {
                f2943Oooo00o = PopupWindow.class.getDeclaredMethod("setTouchModal", Boolean.TYPE);
            }
    ...
    public final void OooO0OO(@NonNull androidx.appcompat.view.menu.OooO oooO, @NonNull androidx.appcompat.view.menu.OooOO0O oooOO0O) {
        o00000OO o00000oo2 = this.f2944Oooo00O;
        if (o00000oo2 != null) {
