...
public final class OooOO0O {
    ...
    @NonNull
    public final CompoundButton f2973OooO00o;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public boolean f2977OooO0o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public ColorStateList f2974OooO0O0 = null;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public PorterDuff.Mode f2975OooO0OO = null;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public boolean f2976OooO0Oo = false;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public boolean f2978OooO0o0 = false;

    public OooOO0O(@NonNull CompoundButton compoundButton) {
        this.f2973OooO00o = compoundButton;
    }

    public final void OooO00o() {
        CompoundButton compoundButton = this.f2973OooO00o;
        Drawable drawableOooO00o = androidx.core.widget.OooO0OO.OooO00o(compoundButton);
        if (drawableOooO00o != null) {
            if (this.f2976OooO0Oo || this.f2978OooO0o0) {
                Drawable drawableMutate = drawableOooO00o.mutate();
                if (this.f2976OooO0Oo) {
                    o00000oo.o00Ooo.OooO0O0.OooO0oo(drawableMutate, this.f2974OooO0O0);
                }
                if (this.f2978OooO0o0) {
                    o00000oo.o00Ooo.OooO0O0.OooO(drawableMutate, this.f2975OooO0OO);
                }
    ...
    public final void OooO0O0(@Nullable AttributeSet attributeSet, int i) {
        ...
        ViewCompat.OooOOO(compoundButton, compoundButton.getContext(), iArr, attributeSet, o000oo0OooOOO0.f3326OooO0O0, i, 0);
        try {
