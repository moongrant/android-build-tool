...
public final class OooOo {
    ...
    @NonNull
    public final ImageView f2992OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public o000O000 f2993OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public int f2994OooO0OO = 0;

    public OooOo(@NonNull ImageView imageView) {
        this.f2992OooO00o = imageView;
    }

    public final void OooO00o() {
        o000O000 o000o001;
        ImageView imageView = this.f2992OooO00o;
        Drawable drawable = imageView.getDrawable();
        if (drawable != null) {
            o000000.OooO00o(drawable);
        }
        if (drawable == null || (o000o001 = this.f2993OooO0O0) == null) {
            return;
        }
    ...
    public final void OooO0O0(AttributeSet attributeSet, int i) {
        ...
        ViewCompat.OooOOO(imageView, imageView.getContext(), iArr, attributeSet, o000oo0OooOOO0.f3326OooO0O0, i, 0);
        try {
            Drawable drawable = imageView.getDrawable();
