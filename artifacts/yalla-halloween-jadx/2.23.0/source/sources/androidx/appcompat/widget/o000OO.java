...
public final class o000OO extends o0000OOO.OooO0OO implements View.OnClickListener {
    ...
    public static final /* synthetic */ int f3273OooOoOO = 0;

    /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
    public final SearchView f3274OooOOO;

    /* JADX INFO: renamed from: OooOOOO, reason: collision with root package name */
    public final SearchableInfo f3275OooOOOO;

    /* JADX INFO: renamed from: OooOOOo, reason: collision with root package name */
    public final Context f3276OooOOOo;

    /* JADX INFO: renamed from: OooOOo, reason: collision with root package name */
    public final int f3277OooOOo;

    /* JADX INFO: renamed from: OooOOo0, reason: collision with root package name */
    public final WeakHashMap<String, Drawable.ConstantState> f3278OooOOo0;

    /* JADX INFO: renamed from: OooOOoo, reason: collision with root package name */
    public int f3279OooOOoo;

    /* JADX INFO: renamed from: OooOo, reason: collision with root package name */
    public int f3280OooOo;

    /* JADX INFO: renamed from: OooOo0, reason: collision with root package name */
    public int f3281OooOo0;

    /* JADX INFO: renamed from: OooOo00, reason: collision with root package name */
    public ColorStateList f3282OooOo00;

    /* JADX INFO: renamed from: OooOo0O, reason: collision with root package name */
    public int f3283OooOo0O;

    /* JADX INFO: renamed from: OooOo0o, reason: collision with root package name */
    public int f3284OooOo0o;

    /* JADX INFO: renamed from: OooOoO, reason: collision with root package name */
    public int f3285OooOoO;

    /* JADX INFO: renamed from: OooOoO0, reason: collision with root package name */
    public int f3286OooOoO0;

    public static final class OooO00o {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final TextView f3287OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final TextView f3288OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final ImageView f3289OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final ImageView f3290OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final ImageView f3291OooO0o0;

        public OooO00o(View view) {
            this.f3287OooO00o = (TextView) view.findViewById(R.id.text1);
            this.f3288OooO0O0 = (TextView) view.findViewById(R.id.text2);
            this.f3289OooO0OO = (ImageView) view.findViewById(R.id.icon1);
            this.f3290OooO0Oo = (ImageView) view.findViewById(R.id.icon2);
            this.f3291OooO0o0 = (ImageView) view.findViewById(p012OooOo0O.Oooo000.edit_query);
        }
    }
    ...
    public o000OO(Context context, SearchView searchView, SearchableInfo searchableInfo, WeakHashMap<String, Drawable.ConstantState> weakHashMap) {
        ...
        this.f3286OooOoO0 = -1;
        this.f3285OooOoO = -1;
        this.f3274OooOOO = searchView;
        this.f3275OooOOOO = searchableInfo;
        this.f3277OooOOo = searchView.getSuggestionCommitIconResId();
        this.f3276OooOOOo = context;
        this.f3278OooOOo0 = weakHashMap;
    }
    ...
    public final void OooO0O0(View view, Cursor cursor) throws FileNotFoundException {
        ...
        int i2 = this.f3285OooOoO;
        int i3 = i2 != -1 ? cursor.getInt(i2) : 0;
        TextView textView = oooO00o.f3287OooO00o;
        if (textView != null) {
            String strOooO = OooO(cursor, this.f3281OooOo0);
        ...
        Context context = this.f3276OooOOOo;
        TextView textView2 = oooO00o.f3288OooO0O0;
        if (textView2 != null) {
            String strOooO2 = OooO(cursor, this.f3284OooOo0o);
            if (strOooO2 != null) {
                if (this.f3282OooOo00 == null) {
                    TypedValue typedValue = new TypedValue();
                    context.getTheme().resolveAttribute(p012OooOo0O.OooOOO0.textColorSearchUrl, typedValue, true);
                    this.f3282OooOo00 = context.getResources().getColorStateList(typedValue.resourceId);
                }
                SpannableString spannableString = new SpannableString(strOooO2);
                spannableString.setSpan(new TextAppearanceSpan(null, 0, 0, this.f3282OooOo00, null), 0, strOooO2.length(), 33);
                charSequenceOooO = spannableString;
            } else {
                charSequenceOooO = OooO(cursor, this.f3283OooOo0O);
            }
        ...
        ImageView imageView = oooO00o.f3289OooO0OO;
        if (imageView != null) {
            int i4 = this.f3280OooOo;
            if (i4 == -1) {
                drawableOooO0oO = null;
            } else {
                drawableOooO0oO = OooO0oO(cursor.getString(i4));
                if (drawableOooO0oO == null) {
                    ComponentName searchActivity = this.f3275OooOOOO.getSearchActivity();
                    String strFlattenToShortString = searchActivity.flattenToShortString();
                    WeakHashMap<String, Drawable.ConstantState> weakHashMap = this.f3278OooOOo0;
                    if (weakHashMap.containsKey(strFlattenToShortString)) {
                        ...
                        try {
                            ...
                            if (iconResource != 0) {
                                ...
                                if (drawable == null) {
                                    StringBuilder sbOooO00o = o0000O0.OooO00o("Invalid icon resource ", iconResource, " for ");
        ...
        ImageView imageView2 = oooO00o.f3290OooO0Oo;
        if (imageView2 == null) {
            i = 1;
        } else {
            int i5 = this.f3286OooOoO0;
        ...
        int i6 = this.f3279OooOOoo;
        ImageView imageView3 = oooO00o.f3291OooO0o0;
        if (i6 != 2 && (i6 != i || (i3 & 1) == 0)) {
    ...
    public final void OooO0OO(Cursor cursor) {
        try {
            ...
            if (cursor != null) {
                this.f3281OooOo0 = cursor.getColumnIndex("suggest_text_1");
                this.f3283OooOo0O = cursor.getColumnIndex("suggest_text_2");
                this.f3284OooOo0o = cursor.getColumnIndex("suggest_text_2_url");
                this.f3280OooOo = cursor.getColumnIndex("suggest_icon_1");
                this.f3286OooOoO0 = cursor.getColumnIndex("suggest_icon_2");
                this.f3285OooOoO = cursor.getColumnIndex("suggest_flags");
            }
        } catch (Exception e) {
    ...
    public final String OooO0Oo(Cursor cursor) {
        ...
        SearchableInfo searchableInfo = this.f3275OooOOOO;
    ...
    public final Drawable OooO0o(Uri uri) throws FileNotFoundException {
        ...
        try {
            Resources resourcesForApplication = this.f3276OooOOOo.getPackageManager().getResourcesForApplication(authority);
    ...
    public final View OooO0o0(ViewGroup viewGroup) {
        View viewInflate = this.f34136OooOOO0.inflate(this.f34134OooOO0O, viewGroup, false);
        viewInflate.setTag(new OooO00o(viewInflate));
        ((ImageView) viewInflate.findViewById(p012OooOo0O.Oooo000.edit_query)).setImageResource(this.f3277OooOOo);
        return viewInflate;
    }
    ...
    public final Cursor OooO0oo(SearchableInfo searchableInfo, String str) {
        ...
        return this.f3276OooOOOo.getContentResolver().query(builderFragment.build(), null, suggestSelection, strArr, null);
    }
    ...
    public final View getDropDownView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            View viewInflate = this.f34136OooOOO0.inflate(this.f34135OooOO0o, viewGroup, false);
            if (viewInflate != null) {
                ((OooO00o) viewInflate.getTag()).f3287OooO00o.setText(e.toString());
            }
            return viewInflate;
        }
    }
    ...
    public final View getView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            ((OooO00o) viewOooO0o0.getTag()).f3287OooO00o.setText(e.toString());
            return viewOooO0o0;
        }
    }
    ...
    public final void notifyDataSetChanged() {
        ...
        Cursor cursor = this.f34126OooO0o;
    ...
    public final void onClick(View view) {
        ...
        if (tag instanceof CharSequence) {
            this.f3274OooOOO.OooOOo((CharSequence) tag);
        }
    }
}
