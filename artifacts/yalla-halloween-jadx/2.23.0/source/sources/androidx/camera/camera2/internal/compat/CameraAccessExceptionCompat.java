...
public class CameraAccessExceptionCompat extends Exception {
    ...
    public final int f3385OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @VisibleForTesting
    public static final Set<Integer> f3384OooO0o0 = Collections.unmodifiableSet(new HashSet(Arrays.asList(4, 5, 1, 2, 3)));

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @VisibleForTesting
    public static final Set<Integer> f3383OooO0o = Collections.unmodifiableSet(new HashSet(Arrays.asList(Integer.valueOf(RtcEngineEvent.EvtType.EVT_LOOKUP_CHANNEL_SUCCESS), 10002)));
    ...
    public CameraAccessExceptionCompat(@Nullable RuntimeException runtimeException) {
        ...
        this.f3385OooO0Oo = RtcEngineEvent.EvtType.EVT_LOOKUP_CHANNEL_SUCCESS;
        if (f3384OooO0o0.contains(Integer.valueOf(RtcEngineEvent.EvtType.EVT_LOOKUP_CHANNEL_SUCCESS))) {
    ...
    public CameraAccessExceptionCompat(@NonNull CameraAccessException cameraAccessException) {
        ...
        this.f3385OooO0Oo = cameraAccessException.getReason();
    }
    ...
    public CameraAccessExceptionCompat(@Nullable AssertionError assertionError, @Nullable String str) {
        ...
        this.f3385OooO0Oo = 10002;
        if (f3384OooO0o0.contains(10002)) {
