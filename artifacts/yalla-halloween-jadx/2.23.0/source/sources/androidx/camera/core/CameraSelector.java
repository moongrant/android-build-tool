...
public final class CameraSelector {
    ...
    @NonNull
    public static final CameraSelector f3395OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @NonNull
    public static final CameraSelector f3396OooO0OO;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final LinkedHashSet<o000O> f3397OooO00o;
    ...
    static {
        ...
        f3395OooO0O0 = new CameraSelector(linkedHashSet);
        LinkedHashSet linkedHashSet2 = new LinkedHashSet();
        linkedHashSet2.add(new o000OO00(1));
        f3396OooO0OO = new CameraSelector(linkedHashSet2);
    }

    public CameraSelector(LinkedHashSet<o000O> linkedHashSet) {
        this.f3397OooO00o = linkedHashSet;
    }
    ...
    public final List OooO0O0(@NonNull ArrayList arrayList) {
        ...
        Iterator<o000O> it = this.f3397OooO00o.iterator();
        while (it.hasNext()) {
    ...
    public final Integer OooO0OO() {
        Integer num = null;
        for (o000O o000o : this.f3397OooO00o) {
            if (o000o instanceof o000OO00) {
                Integer numValueOf = Integer.valueOf(((o000OO00) o000o).f3705OooO0O0);
                if (num == null) {
                    num = numValueOf;
