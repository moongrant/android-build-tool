...
public interface CameraControlInternal extends CameraControl {
    ...
    public static final OooO00o f3527OooO00o = new OooO00o();
    ...
    public class OooO00o implements CameraControlInternal {
        ...
        @Override // androidx.camera.core.impl.CameraControlInternal
        @NonNull
        public final com.google.common.util.concurrent.OooO00o<List<Void>> OooO00o(@NonNull List<o000000O> list, int i, int i2) {
            return p030OoooO.OooOo00.OooO0Oo(Collections.emptyList());
        }

        @Override // androidx.camera.core.CameraControl
        @NonNull
        public final com.google.common.util.concurrent.OooO00o<Void> OooO0O0(float f) {
            return p030OoooO.OooOo00.OooO0Oo(null);
        }
    ...
    @NonNull
    com.google.common.util.concurrent.OooO00o<List<Void>> OooO00o(@NonNull List<o000000O> list, int i, int i2);
