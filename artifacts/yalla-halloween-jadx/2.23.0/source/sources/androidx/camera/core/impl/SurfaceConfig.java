...
public abstract class SurfaceConfig {
    ...
    public static Oooo000 OooO0o0(int i, int i2, @NonNull Size size, @NonNull Oooo0 oooo0) {
        ...
        Size size2 = p036OoooOOo.o0000oo.f1473OooO00o;
        int height = size.getHeight() * size.getWidth();
        if (i == 1) {
            if (height <= p036OoooOOo.o0000oo.OooO00o(oooo0.f3606OooO0O0.get(Integer.valueOf(i2)))) {
                configSize = ConfigSize.s720p;
            } else {
                if (height <= p036OoooOOo.o0000oo.OooO00o(oooo0.f3608OooO0Oo.get(Integer.valueOf(i2)))) {
                    configSize = ConfigSize.s1440p;
                }
            }
        } else if (height <= p036OoooOOo.o0000oo.OooO00o(oooo0.f3605OooO00o)) {
            configSize = ConfigSize.VGA;
        } else if (height <= p036OoooOOo.o0000oo.OooO00o(oooo0.f3607OooO0OO)) {
            configSize = ConfigSize.PREVIEW;
        } else if (height <= p036OoooOOo.o0000oo.OooO00o(oooo0.f3610OooO0o0)) {
            configSize = ConfigSize.RECORD;
        } else if (height <= p036OoooOOo.o0000oo.OooO00o(oooo0.OooO0O0().get(Integer.valueOf(i2)))) {
            configSize = ConfigSize.MAXIMUM;
        } else {
            Size size3 = oooo0.f3611OooO0oO.get(Integer.valueOf(i2));
            if (size3 != null) {
