...
public final class o00OOO0 {
    ...
    public static final class OooO00o {
        ...
        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        @NonNull
        public final o0o0Oo<?> f3748OooO0O0;
        ...
        public OooO00o(@NonNull SessionConfig sessionConfig, @NonNull o0o0Oo<?> o0o0oo) {
            this.f3747OooO00o = sessionConfig;
            this.f3748OooO0O0 = o0o0oo;
        }
    }

    public o00OOO0(@NonNull String str) {
    ...
    @NonNull
    public final Collection<o0o0Oo<?>> OooO0OO() {
        ArrayList arrayList = new ArrayList();
        for (Map.Entry entry : this.f3746OooO0O0.entrySet()) {
            if (((OooO00o) entry.getValue()).f3749OooO0OO) {
    ...
    public final void OooO0o(@NonNull String str, @NonNull SessionConfig sessionConfig, @NonNull o0o0Oo<?> o0o0oo) {
        LinkedHashMap linkedHashMap = this.f3746OooO0O0;
        if (linkedHashMap.containsKey(str)) {
            OooO00o oooO00o = new OooO00o(sessionConfig, o0o0oo);
