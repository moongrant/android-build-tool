...
public final class OooO00o {
    ...
    @Nullable
    public C0017OooO00o f4051OooOOO;
    ...
    public class C0017OooO00o implements o00O00o0.OooO00o<BufferProvider.State> {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final /* synthetic */ BufferProvider f4062OooO00o;

        public C0017OooO00o(BufferProvider bufferProvider) {
        ...
        public final void onError(@NonNull Throwable th) {
            ...
            if (oooO00o.f4050OooOO0o == this.f4062OooO00o) {
                ...
                executor.execute(new o00O0(oooO0o, th));
            }
        }
    }
    ...
    public class OooO0O0 implements OooOOO0<o000OO0O> {
        ...
        public final void onSuccess(o000OO0O o000oo0o2) {
                ...
                if (executor != null && j - oooO00o.f4058OooOo0 >= 200) {
                    ...
                    if (oooO00o.f4060OooOo0O == 2) {
                        ...
                        if (executor != null && oooO0o2 != null) {
                            executor.execute(new Runnable() { // from class: OooooO0.o00O0OOO
                                @Override // java.lang.Runnable
                                public final void run() {
                                    ((OooOO0O.OooO0OO) oooO0o2).f3977OooO0O0.f3969OoooOoo = oooO00o.f4059OooOo00;
                                }
                            });
                        }
                    }
            ...
            o00O000.OooO0o oooO0oOooO0Oo = bufferProvider.OooO0Oo();
            OooO0O0 oooO0O0 = oooO00o.f4052OooOOO0;
            Objects.requireNonNull(oooO0O0);
            oooO0oOooO0Oo.OooO(new OooOo00.OooO0O0(oooO0oOooO0Oo, oooO0O0), oooO00o.f4040OooO00o);
        }
    }
    ...
    public OooO00o(@NonNull p042OooooO0.o00O00o0 o00o00o1, @NonNull o0O0O00 o0o0o00, @Nullable Context context) throws AudioSourceAccessException {
        o0O0O00 o0o0o01 = new o0O0O00(o0o0o00);
        this.f4040OooO00o = o0o0o01;
        this.f4044OooO0o = TimeUnit.MILLISECONDS.toNanos(3000L);
        try {
            androidx.camera.video.internal.audio.OooO0o oooO0o = new androidx.camera.video.internal.audio.OooO0o(new androidx.camera.video.internal.audio.OooO0O0(o00o00o1, context), o00o00o1);
            this.f4043OooO0Oo = oooO0o;
            oooO0o.OooO00o(new OooO(), o0o0o01);
            this.f4045OooO0o0 = new androidx.camera.video.internal.audio.OooO(o00o00o1);
            this.f4060OooOo0O = o00o00o1.OooO00o();
    ...
    public final void OooO00o() {
        ...
        executor.execute(new Runnable() { // from class: OooooO0.oo0oOO0
            @Override // java.lang.Runnable
            public final void run() {
                OooOO0O oooOO0O = ((OooOO0O.OooO0OO) oooO0o).f3977OooO0O0;
    ...
    public final void OooO0O0(@Nullable BufferProvider<? extends o000OO0O> bufferProvider) {
        ...
        if (bufferProvider2 != null) {
            C0017OooO00o c0017OooO00o = this.f4051OooOOO;
            Objects.requireNonNull(c0017OooO00o);
            bufferProvider2.OooO0OO(c0017OooO00o);
        ...
        if (bufferProvider != null) {
            ...
            this.f4051OooOOO = new C0017OooO00o(bufferProvider);
            this.f4052OooOOO0 = new OooO0O0(bufferProvider);
            try {
                com.google.common.util.concurrent.OooO00o<? extends o000OO0O> oooO00oOooO0O0 = bufferProvider.OooO0O0();
                if (oooO00oOooO0O0.isDone()) {
                    state = (BufferProvider.State) oooO00oOooO0O0.get();
                }
    ...
    public final void OooO0o0() {
        ...
        if (executor != null && oooO0o != null && this.f4042OooO0OO.getAndSet(z2) != z2) {
            executor.execute(new Runnable(z2) { // from class: OooooO0.o00O0OO0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f1787OooO0Oo.getClass();
                }
            });
        }
        if (!z) {
        ...
        Objects.requireNonNull(oooO0O0);
        oooO0oOooO0Oo.OooO(new OooOo00.OooO0O0(oooO0oOooO0Oo, oooO0O0), this.f4040OooO00o);
    }
}
