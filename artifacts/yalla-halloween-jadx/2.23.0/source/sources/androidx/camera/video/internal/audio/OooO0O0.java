...
import p043OooooOO.o0O00;
import p043OooooOO.o0O000o0;
import p043OooooOO.o0O00O;
import p043OooooOO.o0O00O0o;
import p044OooooOo.o0O00OOO;
...
public final class OooO0O0 implements AudioStream {
    ...
    public final o00O00o0 f4069OooO0O0;
    ...
    public class OooO00o extends AudioManager$AudioRecordingCallback {
        ...
        public final void onRecordingConfigChanged(List<AudioRecordingConfiguration> list) {
            ...
            while (it.hasNext()) {
                AudioRecordingConfiguration audioRecordingConfigurationOooO00o = o00OO00O.OooO00o(it.next());
                if (o0O00.OooO00o(audioRecordingConfigurationOooO00o) == OooO0O0.this.f4068OooO00o.getAudioSessionId()) {
                    OooO0O0.this.OooO0OO(o0O00O0o.OooO0O0(audioRecordingConfigurationOooO00o));
                    return;
                }
            }
        }
    ...
    public OooO0O0(@NonNull o00O00o0 o00o00o1, @Nullable Context context) throws AudioStream.AudioStreamException, IllegalArgumentException {
        boolean z;
        int iOooO0o0 = o00o00o1.OooO0o0();
        int iOooO0Oo = o00o00o1.OooO0Oo();
        int iOooO00o = o00o00o1.OooO00o();
        ...
        if (!z) {
            throw new UnsupportedOperationException(String.format("The combination of sample rate %d, channel count %d and audio format %d is not supported.", Integer.valueOf(o00o00o1.OooO0o0()), Integer.valueOf(o00o00o1.OooO0Oo()), Integer.valueOf(o00o00o1.OooO00o())));
        }
        this.f4069OooO0O0 = o00o00o1;
        this.f4074OooO0oO = o00o00o1.OooO0OO();
        int minBufferSize = AudioRecord.getMinBufferSize(o00o00o1.OooO0o0(), o00o00o1.OooO0Oo() == 1 ? 16 : 12, o00o00o1.OooO00o());
        OooOOO0.OooO0o(null, minBufferSize > 0);
        int i = minBufferSize * 2;
        this.f4072OooO0o = i;
        int i2 = Build.VERSION.SDK_INT;
        AudioFormat audioFormatBuild = new AudioFormat.Builder().setSampleRate(o00o00o1.OooO0o0()).setChannelMask(o00o00o1.OooO0Oo() != 1 ? 12 : 16).setEncoding(o00o00o1.OooO00o()).build();
        AudioRecord.Builder builderOooO0O0 = o0O000o0.OooO0O0();
        if (i2 >= 31 && context != null) {
            o0O00O.OooO0OO(builderOooO0O0, context);
        }
        o0O000o0.OooO0Oo(builderOooO0O0, o00o00o1.OooO0O0());
        o0O000o0.OooO0OO(builderOooO0O0, audioFormatBuild);
        o0O000o0.OooO0o0(builderOooO0O0, i);
        AudioRecord audioRecordOooO00o = o0O000o0.OooO00o(builderOooO0O0);
    ...
    public final void OooO00o(@Nullable AudioStream.OooO00o oooO00o, @Nullable Executor executor) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (oooO00o2 != null) {
                o0O00O0o.OooO0Oo(audioRecord, oooO00o2);
            }
            if (oooO00o == null) {
                return;
            }
            ...
            o0O00O0o.OooO0OO(audioRecord, executor, this.f4077OooOO0O);
        }
    }
    ...
    public final void OooO0OO(final boolean z) {
        ...
        executor.execute(new Runnable() { // from class: OooooO0.o00OO000
    ...
    public final OooO0OO read(@NonNull ByteBuffer byteBuffer) {
        ...
        if (i > 0) {
            ...
            if (Build.VERSION.SDK_INT < 24) {
                ...
                if (o0O0O0O.OooO00o(o0O00OOO.class) != null) {
                    jNanoTime = -1;
                } else {
                    AudioTimestamp audioTimestamp = new AudioTimestamp();
                    if (o0O00.OooO0O0(audioRecord, audioTimestamp, 0) == 0) {
                        long jOooO00o = audioTimestamp.nanoTime + o00OO0O0.OooO00o(this.f4069OooO0O0.OooO0o0(), this.f4076OooOO0 - audioTimestamp.framePosition);
                        if (jOooO00o >= 0) {
                            jNanoTime = jOooO00o;
                        }
                    } else {
            ...
            this.f4076OooOO0 = o00OO0O0.OooO0O0(this.f4074OooO0oO, i) + this.f4076OooOO0;
        }
    ...
    public final void release() {
        ...
        if (i >= 29 && (oooO00o = this.f4077OooOO0O) != null) {
            o0O00O0o.OooO0Oo(audioRecord, oooO00o);
        }
        audioRecord.release();
    }
    ...
    public final void start() throws AudioStream.AudioStreamException {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            AudioRecordingConfiguration audioRecordingConfigurationOooO00o = o0O00O0o.OooO00o(audioRecord);
            z = audioRecordingConfigurationOooO00o != null && o0O00O0o.OooO0O0(audioRecordingConfigurationOooO00o);
        }
        OooO0OO(z);
    }
