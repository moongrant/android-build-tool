    ...
    public MeasureResult mo3measure3p2s80s(@NotNull MeasureScope measure, @NotNull List<? extends Measurable> measurables, long j) {
        ...
        while (true) {
            ...
            if (childData != null && childData.isTarget()) {
                placeableArr[i] = measurable.mo2794measureBRTryo0(j);
            }
            i++;
        }
        ...
        for (int i2 = 0; i2 < size3; i2++) {
            ...
            if (placeableArr[i2] == null) {
                placeableArr[i2] = measurable2.mo2794measureBRTryo0(j);
            }
        }
        if ((size == 0) == true) {
            placeable2 = null;
        ...
        return MeasureScope.CC.OooOOo0(measure, width3, height3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentMeasurePolicy$measure$3
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                ...
                for (Placeable placeable5 : placeableArr2) {
                    if (placeable5 != null) {
                        long jMo1326alignKFBX0sM = animatedContentMeasurePolicy.getRootScope().getContentAlignment().mo1326alignKFBX0sM(IntSizeKt.IntSize(placeable5.getWidth(), placeable5.getHeight()), IntSizeKt.IntSize(i3, i4), LayoutDirection.Ltr);
                        Placeable.PlacementScope.place$default(layout, placeable5, IntOffset.m3883getXimpl(jMo1326alignKFBX0sM), IntOffset.m3884getYimpl(jMo1326alignKFBX0sM), 0.0f, 4, null);
                    }
                }
            }
        }, 4, null);
