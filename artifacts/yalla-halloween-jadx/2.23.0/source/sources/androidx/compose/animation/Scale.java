...
public final /* data */ class Scale {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Float.compare(this.scale, scale.scale) == 0 && TransformOrigin.m2027equalsimpl0(this.transformOrigin, scale.transformOrigin) && Intrinsics.areEqual(this.animationSpec, scale.animationSpec);
    }
    ...
    public int hashCode() {
        return this.animationSpec.hashCode() + ((TransformOrigin.m2030hashCodeimpl(this.transformOrigin) + (Float.floatToIntBits(this.scale) * 31)) * 31);
    }

    @NotNull
    public String toString() {
        return "Scale(scale=" + this.scale + ", transformOrigin=" + ((Object) TransformOrigin.m2031toStringimpl(this.transformOrigin)) + ", animationSpec=" + this.animationSpec + ')';
    }
