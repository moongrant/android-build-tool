...
final class SizeAnimationModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public static final /* data */ class AnimData {
        ...
        public static /* synthetic */ AnimData m60copyO0kMr_c$default(AnimData animData, Animatable animatable, long j, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return animData.m62copyO0kMr_c(animatable, j);
        }
        ...
        public final AnimData m62copyO0kMr_c(@NotNull Animatable<IntSize, AnimationVector2D> anim, long startSize) {
        ...
        public boolean equals(@Nullable Object other) {
            ...
            return Intrinsics.areEqual(this.anim, animData.anim) && IntSize.m3923equalsimpl0(this.startSize, animData.startSize);
        }
        ...
        public int hashCode() {
            return IntSize.m3926hashCodeimpl(this.startSize) + (this.anim.hashCode() * 31);
        }

        /* JADX INFO: renamed from: setStartSize-ozmzZPI, reason: not valid java name */
        public final void m64setStartSizeozmzZPI(long j) {
            this.startSize = j;
        }

        @NotNull
        public String toString() {
            return "AnimData(anim=" + this.anim + ", startSize=" + ((Object) IntSize.m3928toStringimpl(this.startSize)) + ')';
        }
    ...
    public final long m59animateTomzRDjE0(long targetSize) {
        AnimData animData = getAnimData();
        if (animData == null) {
            animData = new AnimData(new Animatable(IntSize.m3917boximpl(targetSize), VectorConvertersKt.getVectorConverter(IntSize.INSTANCE), IntSize.m3917boximpl(IntSizeKt.IntSize(1, 1)), null, 8, null), targetSize, null);
        } else if (!IntSize.m3923equalsimpl0(targetSize, animData.getAnim().getTargetValue().getPackedValue())) {
            animData.m64setStartSizeozmzZPI(animData.getAnim().getValue().getPackedValue());
    ...
    public MeasureResult mo27measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j) {
        ...
        long jM59animateTomzRDjE0 = m59animateTomzRDjE0(IntSizeKt.IntSize(placeableMo2794measureBRTryo0.getWidth(), placeableMo2794measureBRTryo0.getHeight()));
        return MeasureScope.CC.OooOOo0(measure, IntSize.m3925getWidthimpl(jM59animateTomzRDjE0), IntSize.m3924getHeightimpl(jM59animateTomzRDjE0), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SizeAnimationModifier$measure$1
            {
                super(1);
            }
