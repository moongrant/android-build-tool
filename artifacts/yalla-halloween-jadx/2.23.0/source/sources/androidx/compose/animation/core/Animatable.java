...
public final class Animatable<T, V extends AnimationVector> {
    ...
    public static final class C05522 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        final /* synthetic */ T $targetValue;
        int label;
        final /* synthetic */ Animatable<T, V> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C05522(Animatable<T, V> animatable, T t, Continuation<? super C05522> continuation) {
            super(1, continuation);
            this.this$0 = animatable;
            this.$targetValue = t;
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@NotNull Continuation<?> continuation) {
            return new C05522(this.this$0, this.$targetValue, continuation);
        }
        ...
        public final Object invoke(@Nullable Continuation<? super Unit> continuation) {
            return ((C05522) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public static final class C05532 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        int label;
        final /* synthetic */ Animatable<T, V> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C05532(Animatable<T, V> animatable, Continuation<? super C05532> continuation) {
            super(1, continuation);
            this.this$0 = animatable;
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@NotNull Continuation<?> continuation) {
            return new C05532(this.this$0, continuation);
        }
        ...
        @Nullable
        public final Object invoke(@Nullable Continuation<? super Unit> continuation) {
            return ((C05532) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public final Object snapTo(T t, @NotNull Continuation<? super Unit> continuation) {
        Object objMutate$default = MutatorMutex.mutate$default(this.mutatorMutex, null, new C05522(this, t, null), continuation, 1, null);
    ...
    public final Object stop(@NotNull Continuation<? super Unit> continuation) {
        Object objMutate$default = MutatorMutex.mutate$default(this.mutatorMutex, null, new C05532(this, null), continuation, 1, null);
        return objMutate$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objMutate$default : Unit.INSTANCE;
    }
