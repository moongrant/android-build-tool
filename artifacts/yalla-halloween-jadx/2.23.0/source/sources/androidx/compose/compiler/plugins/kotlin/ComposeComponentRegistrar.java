...
@Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u0000 \t2\u00020\u0001:\u0001\tB\u0005¢\u0006\u0002\u0010\u0002J\u0018\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0016¨\u0006\n"}, d2 = {"Landroidx/compose/compiler/plugins/kotlin/ComposeComponentRegistrar;", "Lorg/jetbrains/kotlin/compiler/plugin/ComponentRegistrar;", "()V", "registerProjectComponents", "", "project", "Lorg/jetbrains/kotlin/com/intellij/mock/MockProject;", "configuration", "Lorg/jetbrains/kotlin/config/CompilerConfiguration;", "Companion", "compiler-hosted"}, k = 1, mv = {1, 8, 0}, xi = 48)
public final class ComposeComponentRegistrar implements ComponentRegistrar {
    ...
    @Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006J\u000e\u0010\u0007\u001a\u00020\b2\u0006\u0010\u0005\u001a\u00020\u0006J\u000e\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\f¨\u0006\r"}, d2 = {"Landroidx/compose/compiler/plugins/kotlin/ComposeComponentRegistrar$Companion;", "", "()V", "checkCompilerVersion", "", "configuration", "Lorg/jetbrains/kotlin/config/CompilerConfiguration;", "createComposeIrExtension", "Landroidx/compose/compiler/plugins/kotlin/ComposeIrGenerationExtension;", "registerCommonExtensions", "", "project", "Lorg/jetbrains/kotlin/com/intellij/openapi/project/Project;", "compiler-hosted"}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    public static final class Companion {
        ...
        public final boolean checkCompilerVersion(@NotNull CompilerConfiguration configuration) {
            ...
            try {
                ...
                if (Intrinsics.areEqual(str, "1.8.21") && messageCollector != null) {
                ...
                if (Intrinsics.areEqual(str, ServerProtocol.DIALOG_RETURN_SCOPES_TRUE) || Intrinsics.areEqual(version, "1.8.21") || Intrinsics.areEqual(version, str)) {
                    return true;
                }
                if (messageCollector == null) {
                    return false;
                }
                MessageCollector.report$default(messageCollector, CompilerMessageSeverity.ERROR, "This version (1.4.7) of the Compose Compiler requires Kotlin version 1.8.21 but you appear to be using Kotlin version " + version + " which is not known to be compatible.  Please consult the Compose-Kotlin compatibility map located at https://developer.android.com/jetpack/androidx/releases/compose-kotlin to choose a compatible version pair (or `suppressKotlinVersionCompatibilityCheck` but don't say I didn't warn you!).", (CompilerMessageSourceLocation) null, 4, (Object) null);
                return false;
            } catch (Throwable th) {
        ...
        public final ComposeIrGenerationExtension createComposeIrExtension(@NotNull CompilerConfiguration configuration) {
            ...
            Object obj = configuration.get(composeConfiguration.getINTRINSIC_REMEMBER_OPTIMIZATION_ENABLED_KEY(), Boolean.FALSE);
            ...
            return new ComposeIrGenerationExtension(z, z2, z3, z4, zBooleanValue, z5, str, (String) (StringsKt.isBlank(charSequence2) ? null : charSequence2), configuration.getBoolean(JVMConfigurationKeys.VALIDATE_IR));
        }
