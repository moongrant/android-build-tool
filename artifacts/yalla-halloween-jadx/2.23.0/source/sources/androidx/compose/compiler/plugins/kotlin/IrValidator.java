...
public final class IrValidator implements IrElementVisitorVoid {
    ...
    public final void error(IrElement element, String message) {
        String name;
        String strDumpSrc = IrSourcePrinterKt.dumpSrc(element);
        ...
        throw new Error(OooO0OO.OooO0OO(OooO0o.OooO0OO("Validation error (", message, ") for ", strDumpSrc, "...  "), strRender, " in ", name));
    }
