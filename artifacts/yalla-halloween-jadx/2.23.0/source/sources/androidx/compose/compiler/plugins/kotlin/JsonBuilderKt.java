...
public final class JsonBuilderKt {
    public static final void appendCsv(@NotNull Appendable appendable, @NotNull Function1<? super CsvBuilder, Unit> fn) {
        Intrinsics.checkNotNullParameter(appendable, "<this>");
        Intrinsics.checkNotNullParameter(fn, "fn");
        fn.invoke(new CsvBuilder(appendable));
    }

    public static final void appendJson(@NotNull Appendable appendable, @NotNull Function1<? super JsonBuilder, Unit> fn) throws IOException {
        Intrinsics.checkNotNullParameter(appendable, "<this>");
        Intrinsics.checkNotNullParameter(fn, "fn");
        new JsonBuilder(appendable, 1).with(fn);
    }

    public static final void write(@NotNull File file, @NotNull Function1<? super OutputStreamWriter, Unit> fn) throws IOException {
