...
public final class ModuleMetricsImpl implements ModuleMetrics {
    ...
    public final class ClassMetrics {
        ...
        /* JADX WARN: Code duplicated, block: B:34:0x0096 A[SYNTHETIC] */
        ...
        JsonBuilderKt.appendCsv(appendable, new Function1<CsvBuilder, Unit>() { // from class: androidx.compose.compiler.plugins.kotlin.ModuleMetricsImpl.appendComposablesCsv.1
            ...
            public final void invoke2(@NotNull CsvBuilder appendCsv) {
                ...
                appendCsv.row(new Function1<CsvBuilder, Unit>() { // from class: androidx.compose.compiler.plugins.kotlin.ModuleMetricsImpl.appendComposablesCsv.1.1
                    @Override // kotlin.jvm.functions.Function1
                    public /* bridge */ /* synthetic */ Unit invoke(CsvBuilder csvBuilder) throws IOException {
                        invoke2(csvBuilder);
                        return Unit.INSTANCE;
                    }

                    /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                    public final void invoke2(@NotNull CsvBuilder row) throws IOException {
                ...
                for (final FunctionMetrics functionMetrics : ModuleMetricsImpl.this.composables) {
                    appendCsv.row(new Function1<CsvBuilder, Unit>() { // from class: androidx.compose.compiler.plugins.kotlin.ModuleMetricsImpl.appendComposablesCsv.1.2
                        ...
                        public final void invoke2(@NotNull CsvBuilder row) throws IOException {
                            Intrinsics.checkNotNullParameter(row, "$this$row");
                            String strAsString = functionMetrics.getPackageName().asString();
                            Intrinsics.checkNotNullExpressionValue(strAsString, "fn.packageName.asString()");
                            row.col(strAsString);
                            row.col(functionMetrics.getName());
                            row.col(functionMetrics.getComposable());
                            row.col(functionMetrics.getSkippable());
                            row.col(functionMetrics.getRestartable());
                            row.col(functionMetrics.getReadonly());
                            row.col(functionMetrics.getInline());
                            row.col(functionMetrics.getIsLambda());
                            row.col(functionMetrics.getHasDefaults());
                            row.col(functionMetrics.getDefaultsGroup());
                            row.col(functionMetrics.getGroups());
                            row.col(functionMetrics.getCalls());
                        }
                    });
                }
            }
    ...
    public void appendModuleJson(@NotNull Appendable appendable) throws IOException {
        ...
        JsonBuilderKt.appendJson(appendable, new Function1<JsonBuilder, Unit>() { // from class: androidx.compose.compiler.plugins.kotlin.ModuleMetricsImpl.appendModuleJson.1
            ...
            /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(@NotNull JsonBuilder appendJson) throws IOException {
                Intrinsics.checkNotNullParameter(appendJson, "$this$appendJson");
                appendJson.entry("skippableComposables", ModuleMetricsImpl.this.skippableComposables);
                appendJson.entry("restartableComposables", ModuleMetricsImpl.this.restartableComposables);
                appendJson.entry("readonlyComposables", ModuleMetricsImpl.this.readonlyComposables);
                appendJson.entry("totalComposables", ModuleMetricsImpl.this.totalComposables);
                appendJson.entry("restartGroups", ModuleMetricsImpl.this.restartGroups);
                appendJson.entry("totalGroups", ModuleMetricsImpl.this.totalGroups);
                appendJson.entry("staticArguments", ModuleMetricsImpl.this.staticArguments);
                appendJson.entry("certainArguments", ModuleMetricsImpl.this.certainArguments);
                appendJson.entry("knownStableArguments", ModuleMetricsImpl.this.knownStableArguments);
                appendJson.entry("knownUnstableArguments", ModuleMetricsImpl.this.knownUnstableArguments);
                appendJson.entry("unknownStableArguments", ModuleMetricsImpl.this.unknownStableArguments);
                appendJson.entry("totalArguments", ModuleMetricsImpl.this.totalArguments);
                appendJson.entry("markedStableClasses", ModuleMetricsImpl.this.markedStableClasses);
                appendJson.entry("inferredStableClasses", ModuleMetricsImpl.this.inferredStableClasses);
                appendJson.entry("inferredUnstableClasses", ModuleMetricsImpl.this.inferredUnstableClasses);
                appendJson.entry("inferredUncertainClasses", ModuleMetricsImpl.this.inferredUncertainClasses);
                appendJson.entry("effectivelyStableClasses", ModuleMetricsImpl.this.effectivelyStableClasses);
                appendJson.entry("totalClasses", ModuleMetricsImpl.this.totalClasses);
                appendJson.entry("memoizedLambdas", ModuleMetricsImpl.this.memoizedLambdas);
                appendJson.entry("singletonLambdas", ModuleMetricsImpl.this.singletonLambdas);
                appendJson.entry("singletonComposableLambdas", ModuleMetricsImpl.this.singletonComposableLambdas);
                appendJson.entry("composableLambdas", ModuleMetricsImpl.this.composableLambdas);
                appendJson.entry("totalLambdas", ModuleMetricsImpl.this.totalLambdas);
            }
        });
    }
    ...
    public void saveMetricsTo(@NotNull String directory) throws IOException {
        ...
        JsonBuilderKt.write(new File(new File(directory), OooOOOO.OooO00o(StringsKt.OooOoO(StringsKt.OooOoO(StringsKt__StringsJVMKt.replace$default(this.name, '.', '_', false, 4, (Object) null), "<", ""), ">", ""), "-module.json")), new Function1<OutputStreamWriter, Unit>() { // from class: androidx.compose.compiler.plugins.kotlin.ModuleMetricsImpl.saveMetricsTo.1
            {
                super(1);
            }
            ...
            /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(@NotNull OutputStreamWriter write) throws IOException {
    ...
    public void saveReportsTo(@NotNull String directory) throws IOException {
        ...
        String strOooOoO = StringsKt.OooOoO(StringsKt.OooOoO(StringsKt__StringsJVMKt.replace$default(this.name, '.', '_', false, 4, (Object) null), "<", ""), ">", "");
        JsonBuilderKt.write(new File(file, OooOOOO.OooO00o(strOooOoO, "-composables.csv")), new Function1<OutputStreamWriter, Unit>() { // from class: androidx.compose.compiler.plugins.kotlin.ModuleMetricsImpl.saveReportsTo.1
            {
                super(1);
            }
        ...
        JsonBuilderKt.write(new File(file, OooOOOO.OooO00o(strOooOoO, "-composables.txt")), new Function1<OutputStreamWriter, Unit>() { // from class: androidx.compose.compiler.plugins.kotlin.ModuleMetricsImpl.saveReportsTo.2
            {
                super(1);
            }
        ...
        if (!this.logMessages.isEmpty()) {
            JsonBuilderKt.write(new File(file, OooOOOO.OooO00o(strOooOoO, "-composables.log")), new Function1<OutputStreamWriter, Unit>() { // from class: androidx.compose.compiler.plugins.kotlin.ModuleMetricsImpl.saveReportsTo.3
                {
                    super(1);
                }
                ...
                public final void invoke2(@NotNull OutputStreamWriter write) throws IOException {
                    ...
                    while (it.hasNext()) {
                        Appendable appendableAppend = write.append((CharSequence) it.next());
                        Intrinsics.checkNotNullExpressionValue(appendableAppend, "append(value)");
                        Intrinsics.checkNotNullExpressionValue(appendableAppend.append('\n'), "append('\\n')");
                    }
                }
        ...
        JsonBuilderKt.write(new File(file, OooOOOO.OooO00o(strOooOoO, "-classes.txt")), new Function1<OutputStreamWriter, Unit>() { // from class: androidx.compose.compiler.plugins.kotlin.ModuleMetricsImpl.saveReportsTo.4
            {
                super(1);
            }
