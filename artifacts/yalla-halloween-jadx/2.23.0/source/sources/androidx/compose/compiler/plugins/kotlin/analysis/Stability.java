...
public abstract class Stability {
    ...
    public static final class Parameter extends Stability {
        ...
        @NotNull
        public String toString() {
            return o000oOoO.OooO00o("Parameter(", this.parameter.getName().asString(), ")");
        }
    }
    ...
    public static final class Runtime extends Stability {
        ...
        @NotNull
        public String toString() {
            return o000oOoO.OooO00o("Runtime(", this.declaration.getName().asString(), ")");
        }
    }
    ...
    public static final class Unknown extends Stability {
        ...
        @NotNull
        public String toString() {
            return o000oOoO.OooO00o("Uncertain(", this.declaration.getName().asString(), ")");
        }
    }
