...
public final class Binding {
    ...
    public Binding(@Nullable String str, @NotNull Set<Bindings> observers) {
    ...
    public String toString() {
        ...
        return (token == null || (strOooO00o = o000oOoO.OooO00o("Binding(token = ", token, ")")) == null) ? OooO0OO.OooO00o.OooO00o("Binding(", this.value.getIndex(), ")") : strOooO00o;
    }
