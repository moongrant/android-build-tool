...
public abstract class AbstractComposeLowering extends IrElementTransformerVoid implements ModuleLoweringPass {
    ...
    public AbstractComposeLowering(@NotNull IrPluginContext context, @NotNull DeepCopySymbolRemapper symbolRemapper, @NotNull ModuleMetrics metrics) {
        IrClass owner;
        IrClass owner2;
        ...
        IrClassSymbol irClassSymbolReferenceClass = context.referenceClass(composeClassIds.getComposer());
        ...
        IrClassSymbol irClassSymbolReferenceClass2 = context.referenceClass(composeClassIds.getComposable());
        ...
        this.unsafeCoerceIntrinsic = LazyKt.lazy(new Function0<IrSimpleFunctionSymbol>() { // from class: androidx.compose.compiler.plugins.kotlin.lower.AbstractComposeLowering$unsafeCoerceIntrinsic$2
            ...
            public final IrSimpleFunctionSymbol invoke() {
                ...
                Intrinsics.checkNotNullExpressionValue(nameSpecial, "special(\"<unsafe-coerce>\")");
    ...
    @NotNull
    public final IrFunctionSymbol binaryOperator(@NotNull IrType irType, @NotNull Name name, @NotNull IrType paramType) {
    ...
    public final boolean hasDefaultValueSafe(@NotNull IrValueParameter irValueParameter) {
        ...
        Boolean boolIfAny = DFS.ifAny(CollectionsKt.listOf(irValueParameter), new OooO00o(), new Function1<IrValueParameter, Boolean>() { // from class: androidx.compose.compiler.plugins.kotlin.lower.AbstractComposeLowering.hasDefaultValueSafe.2
            @Override // kotlin.jvm.functions.Function1
    ...
    @Nullable
    public final IrExpression irStableExpression(@NotNull Stability stability, @NotNull Function1<? super IrTypeParameter, ? extends IrExpression> resolve) {
        ...
        while (it.hasNext()) {
            IrExpression irExpressionIrStableExpression = irStableExpression((Stability) it.next(), resolve);
    ...
    public final IrVariableImpl irTemporary(@NotNull IrExpression value, @NotNull String name, @NotNull IrType irType, boolean isVar, @NotNull IrDeclarationOrigin origin) {
        ...
        IrVariableImpl irVariableImpl = new IrVariableImpl(startOffset, endOffset, origin, irVariableSymbolImpl, nameIdentifier, irType, isVar, false, false);
    ...
    public final boolean isComposableLambdaInvoke(@NotNull IrCall irCall) {
        ...
        return (irExpression == null || (type = irExpression.getType()) == null || !hasComposableAnnotation((IrAnnotationContainer) type)) ? false : true;
    }
    ...
    public final boolean isInvoke(@NotNull IrCall irCall) {
        ...
        if (Intrinsics.areEqual(irDeclaration.getName(), OperatorNameConventions.INVOKE)) {
            ...
            if ((parentClassOrNull == null || (defaultType = IrUtilsKt.getDefaultType(parentClassOrNull)) == null || !IrTypeUtilsKt.isFunction(defaultType)) ? false : true) {
                return true;
            }
        }
        return false;
    ...
    private final boolean isStatic(IrCall irCall) {
        ...
        Map<String, Integer> stableFunctions = KnownStableConstructs.INSTANCE.getStableFunctions();
        String strAsString = kotlinFqName.asString();
        Intrinsics.checkNotNullExpressionValue(strAsString, "fqName.asString()");
        if (stableFunctions.containsKey(strAsString) || (IrUtilsKt.hasAnnotation(irCall.getSymbol().getOwner(), composeFqNames2.getStable()) && StabilityKt.knownStable(StabilityKt.stabilityOf(irCall.getType())))) {
