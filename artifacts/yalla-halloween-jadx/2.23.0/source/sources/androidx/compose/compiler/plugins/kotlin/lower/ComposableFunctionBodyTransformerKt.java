...
public final class ComposableFunctionBodyTransformerKt {
    ...
    public static final <A, B, C> void forEachWith(@NotNull List<? extends A> a, @NotNull List<? extends B> b, @NotNull List<? extends C> c, @NotNull Function3<? super A, ? super B, ? super C, Unit> fn) {
        ...
        for (int i = 0; i < size; i++) {
            fn.invoke(a.get(i), b.get(i), c.get(i));
        }
    }
    ...
    private static final <T> T getValue(GuardedLazy<? extends T> guardedLazy, Object obj, KProperty<?> kProperty) {
        Intrinsics.checkNotNullParameter(guardedLazy, "<this>");
