...
public final class CopyDefaultValuesFromExpectLowering extends IrElementTransformerVoid implements ModuleLoweringPass {
    ...
    public static final class SymbolRemapper extends DeepCopySymbolRemapper {
        final /* synthetic */ CopyDefaultValuesFromExpectLowering this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public SymbolRemapper(@NotNull CopyDefaultValuesFromExpectLowering this$0) {
        ...
        public IrClassSymbol getReferencedClass(@NotNull IrClassSymbol symbol) {
            ...
            return symbol.getDescriptor().isExpect() ? this.this$0.findActualForExpected(symbol.getOwner()).getSymbol() : super.getReferencedClass(symbol);
        }
        ...
        public IrClassifierSymbol getReferencedClassifier(@NotNull IrClassifierSymbol symbol) {
            ...
            if (symbol instanceof IrTypeParameterSymbol) {
                return this.this$0.remapExpectTypeParameter((IrTypeParameterSymbol) symbol).getSymbol();
            }
        ...
        public IrConstructorSymbol getReferencedConstructor(@NotNull IrConstructorSymbol symbol) {
            ...
            CopyDefaultValuesFromExpectLowering copyDefaultValuesFromExpectLowering = this.this$0;
        ...
        public IrEnumEntrySymbol getReferencedEnumEntry(@NotNull IrEnumEntrySymbol symbol) {
            Intrinsics.checkNotNullParameter(symbol, "symbol");
            return symbol.getDescriptor().isExpect() ? this.this$0.findActualForExpected(symbol.getOwner()).getSymbol() : super.getReferencedEnumEntry(symbol);
        }
        ...
        public IrPropertySymbol getReferencedProperty(@NotNull IrPropertySymbol symbol) {
            Intrinsics.checkNotNullParameter(symbol, "symbol");
            return symbol.getDescriptor().isExpect() ? this.this$0.findActualForExpected(symbol.getOwner()).getSymbol() : super.getReferencedProperty(symbol);
        }
        ...
        public IrSimpleFunctionSymbol getReferencedSimpleFunction(@NotNull IrSimpleFunctionSymbol symbol) {
            ...
            IrSimpleFunctionSymbol irSimpleFunctionSymbolReferenceFunction = IrUtilsKt.referenceFunction(this.this$0.symbolTable, (CallableDescriptor) propertyAccessorDescriptor);
        ...
        public IrValueSymbol getReferencedValue(@NotNull IrValueSymbol symbol) {
            ...
            Intrinsics.checkNotNullParameter(symbol, "symbol");
            IrValueParameter irValueParameterRemapExpectValue = this.this$0.remapExpectValue(symbol);
    ...
    public CopyDefaultValuesFromExpectLowering(@NotNull IrPluginContext pluginContext) {
        Intrinsics.checkNotNullParameter(pluginContext, "pluginContext");
        this.symbolTable = pluginContext.getSymbolTable();
    }
    ...
    private final IrExpressionBody remapExpectValueSymbols(IrExpressionBody irExpressionBody) {
        org.jetbrains.kotlin.ir.util.SymbolRemapper symbolRemapper = new SymbolRemapper(this);
