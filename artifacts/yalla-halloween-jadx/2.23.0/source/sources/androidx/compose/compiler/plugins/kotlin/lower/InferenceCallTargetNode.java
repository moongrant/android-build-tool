...
public final class InferenceCallTargetNode extends InferenceNode {
    ...
    public InferenceCallTargetNode(@NotNull ComposableTargetAnnotationsTransformer transformer, @NotNull IrCall element) {
        super(null);
        ...
        if (!ComposableTargetAnnotationsTransformerKt.isGenericFunction(getElement().getSymbol())) {
            ...
            if ((function.getBody() != null && function.getTypeParameters().isEmpty() ? function : null) != null) {
                inferenceNodeInferenceNodeOf = ComposableTargetAnnotationsTransformerKt.inferenceNodeOf((IrElement) function, transformer);
            }
        }
