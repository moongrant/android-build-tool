...
public final class WrapJsComposableLambdaLowering extends AbstractDecoysLowering {
    ...
    public WrapJsComposableLambdaLowering(@NotNull final IrPluginContext context, @NotNull final DeepCopySymbolRemapper symbolRemapper, @NotNull final ModuleMetrics metrics, @NotNull final IdSignatureSerializer signatureBuilder, boolean z) {
        ...
        this.rememberFunSymbol = LazyKt.lazy(new Function0<IrSimpleFunctionSymbol>() { // from class: androidx.compose.compiler.plugins.kotlin.lower.WrapJsComposableLambdaLowering$rememberFunSymbol$2
            ...
            public final IrSimpleFunctionSymbol invoke() {
                ...
                ComposerParamTransformer composerParamTransformer = new ComposerParamTransformer(context, symbolRemapper, this.decoysEnabled, metrics);
                ...
                ArrayList<IrSimpleFunction> arrayList = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(topLevelFunctions, 10));
                ...
                for (IrSimpleFunction irSimpleFunction2 : arrayList) {
                    if (irSimpleFunction2.getValueParameters().size() == 2 && !AdditionalIrUtilsKt.isVararg((IrValueParameter) CollectionsKt.first(irSimpleFunction2.getValueParameters()))) {
                        ...
                        DeepCopySymbolRemapper deepCopySymbolRemapper2 = symbolRemapper;
                        IdSignatureSerializer idSignatureSerializer = signatureBuilder;
                        ModuleMetrics moduleMetrics = metrics;
                        ...
                        if (!wrapJsComposableLambdaLowering.decoysEnabled) {
                            ...
                            CreateDecoysTransformer createDecoysTransformer = new CreateDecoysTransformer(irPluginContext, deepCopySymbolRemapper2, idSignatureSerializer, moduleMetrics);
    ...
    private final IrCall callRun(IrType returnType, IrFunctionExpressionImpl runBlock) {
        ...
        Intrinsics.checkNotNullExpressionValue(nameIdentifier, "identifier(\"run\")");
        IrCall irCallImpl = new IrCallImpl(-2, -2, returnType, getTopLevelFunction(new CallableId(fqName, nameIdentifier)), 1, 1, (IrStatementOrigin) null, (IrClassSymbol) null, 192, (DefaultConstructorMarker) null);
