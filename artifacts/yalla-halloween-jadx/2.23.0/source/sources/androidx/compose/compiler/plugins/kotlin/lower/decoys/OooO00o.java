...
public final /* synthetic */ class OooO00o {
    ...
    @NotNull
    public static IrExpression OooO0o0(DecoyTransformBase decoyTransformBase, @NotNull List valueArguments) {
        ...
        ArrayList arrayList = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(valueArguments, 10));
