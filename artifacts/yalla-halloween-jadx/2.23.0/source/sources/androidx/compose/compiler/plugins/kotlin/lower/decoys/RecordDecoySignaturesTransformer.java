...
public final class RecordDecoySignaturesTransformer extends AbstractDecoysLowering {
    ...
    public RecordDecoySignaturesTransformer(@NotNull IrPluginContext pluginContext, @NotNull DeepCopySymbolRemapper symbolRemapper, @NotNull IdSignatureSerializer signatureBuilder, @NotNull ModuleMetrics metrics, @NotNull KotlinMangler.IrMangler mangler) {
