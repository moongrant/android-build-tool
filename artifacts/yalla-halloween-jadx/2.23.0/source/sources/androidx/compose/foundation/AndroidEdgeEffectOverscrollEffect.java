...
public final class AndroidEdgeEffectOverscrollEffect implements OverscrollEffect {
    ...
    public AndroidEdgeEffectOverscrollEffect(@NotNull Context context, @NotNull OverscrollConfiguration overscrollConfig) {
        ...
        for (int i = 0; i < size; i++) {
            listListOf.get(i).setColor(ColorKt.m1724toArgb8_81llA(this.overscrollConfig.getGlowColor()));
        }
        Unit unit = Unit.INSTANCE;
        this.redrawSignal = SnapshotStateKt.mutableStateOf(unit, SnapshotStateKt.neverEqualPolicy());
        this.invalidationEnabled = true;
        this.containerSize = Size.INSTANCE.m1514getZeroNHjbRc();
        Function1<IntSize, Unit> function1 = new Function1<IntSize, Unit>() { // from class: androidx.compose.foundation.AndroidEdgeEffectOverscrollEffect$onNewSize$1
            ...
            public final void m165invokeozmzZPI(long j) {
                boolean z = !Size.m1501equalsimpl0(IntSizeKt.m3935toSizeozmzZPI(j), this.this$0.containerSize);
                this.this$0.containerSize = IntSizeKt.m3935toSizeozmzZPI(j);
                if (z) {
                    this.this$0.topEffect.setSize(IntSize.m3925getWidthimpl(j), IntSize.m3924getHeightimpl(j));
                    this.this$0.bottomEffect.setSize(IntSize.m3925getWidthimpl(j), IntSize.m3924getHeightimpl(j));
                    this.this$0.leftEffect.setSize(IntSize.m3924getHeightimpl(j), IntSize.m3925getWidthimpl(j));
                    this.this$0.rightEffect.setSize(IntSize.m3924getHeightimpl(j), IntSize.m3925getWidthimpl(j));
                    this.this$0.topEffectNegation.setSize(IntSize.m3925getWidthimpl(j), IntSize.m3924getHeightimpl(j));
                    this.this$0.bottomEffectNegation.setSize(IntSize.m3925getWidthimpl(j), IntSize.m3924getHeightimpl(j));
                    this.this$0.leftEffectNegation.setSize(IntSize.m3924getHeightimpl(j), IntSize.m3925getWidthimpl(j));
                    this.this$0.rightEffectNegation.setSize(IntSize.m3924getHeightimpl(j), IntSize.m3925getWidthimpl(j));
                }
                if (z) {
    ...
    private final boolean drawBottom(DrawScope drawScope, EdgeEffect edgeEffect, Canvas canvas) {
        ...
        canvas.translate(-Size.m1505getWidthimpl(this.containerSize), (-Size.m1502getHeightimpl(this.containerSize)) + drawScope.mo324toPx0680j_4(this.overscrollConfig.getDrawPadding().getBottom()));
    ...
    private final boolean drawLeft(DrawScope drawScope, EdgeEffect edgeEffect, Canvas canvas) {
        ...
        canvas.translate(-Size.m1502getHeightimpl(this.containerSize), drawScope.mo324toPx0680j_4(this.overscrollConfig.getDrawPadding().mo427calculateLeftPaddingu2uoSUM(drawScope.getLayoutDirection())));
        boolean zDraw = edgeEffect.draw(canvas);
        canvas.restoreToCount(iSave);
        return zDraw;
    }
    ...
    private final boolean drawRight(DrawScope drawScope, EdgeEffect edgeEffect, Canvas canvas) {
        int iSave = canvas.save();
        int iRoundToInt = MathKt.roundToInt(Size.m1505getWidthimpl(this.containerSize));
        float fMo428calculateRightPaddingu2uoSUM = this.overscrollConfig.getDrawPadding().mo428calculateRightPaddingu2uoSUM(drawScope.getLayoutDirection());
        canvas.rotate(90.0f);
        canvas.translate(0.0f, drawScope.mo324toPx0680j_4(fMo428calculateRightPaddingu2uoSUM) + (-iRoundToInt));
        boolean zDraw = edgeEffect.draw(canvas);
        canvas.restoreToCount(iSave);
        return zDraw;
    }
    ...
    private final boolean drawTop(DrawScope drawScope, EdgeEffect edgeEffect, Canvas canvas) {
        int iSave = canvas.save();
        canvas.translate(0.0f, drawScope.mo324toPx0680j_4(this.overscrollConfig.getDrawPadding().getTop()));
        boolean zDraw = edgeEffect.draw(canvas);
        canvas.restoreToCount(iSave);
        return zDraw;
    }
    ...
    private final float m158pullBottom0a9Yr6o(long scroll, long displacement) {
        float fM1436getXimpl = Offset.m1436getXimpl(displacement) / Size.m1505getWidthimpl(this.containerSize);
        float fM1437getYimpl = Offset.m1437getYimpl(scroll) / Size.m1502getHeightimpl(this.containerSize);
        EdgeEffectCompat edgeEffectCompat = EdgeEffectCompat.INSTANCE;
        return !(edgeEffectCompat.getDistanceCompat(this.bottomEffect) == 0.0f) ? Offset.m1437getYimpl(scroll) : Size.m1502getHeightimpl(this.containerSize) * (-edgeEffectCompat.onPullDistanceCompat(this.bottomEffect, -fM1437getYimpl, 1 - fM1436getXimpl));
    }
    ...
    private final float m159pullLeft0a9Yr6o(long scroll, long displacement) {
        float fM1437getYimpl = Offset.m1437getYimpl(displacement) / Size.m1502getHeightimpl(this.containerSize);
        float fM1436getXimpl = Offset.m1436getXimpl(scroll) / Size.m1505getWidthimpl(this.containerSize);
        EdgeEffectCompat edgeEffectCompat = EdgeEffectCompat.INSTANCE;
        return !(edgeEffectCompat.getDistanceCompat(this.leftEffect) == 0.0f) ? Offset.m1436getXimpl(scroll) : Size.m1505getWidthimpl(this.containerSize) * edgeEffectCompat.onPullDistanceCompat(this.leftEffect, fM1436getXimpl, 1 - fM1437getYimpl);
    }
    ...
    private final float m160pullRight0a9Yr6o(long scroll, long displacement) {
        ...
        float fM1436getXimpl = Offset.m1436getXimpl(scroll) / Size.m1505getWidthimpl(this.containerSize);
        EdgeEffectCompat edgeEffectCompat = EdgeEffectCompat.INSTANCE;
        return !((edgeEffectCompat.getDistanceCompat(this.rightEffect) > 0.0f ? 1 : (edgeEffectCompat.getDistanceCompat(this.rightEffect) == 0.0f ? 0 : -1)) == 0) ? Offset.m1436getXimpl(scroll) : Size.m1505getWidthimpl(this.containerSize) * (-edgeEffectCompat.onPullDistanceCompat(this.rightEffect, -fM1436getXimpl, fM1437getYimpl));
    }
    ...
    private final float m161pullTop0a9Yr6o(long scroll, long displacement) {
        ...
        float fM1437getYimpl = Offset.m1437getYimpl(scroll) / Size.m1502getHeightimpl(this.containerSize);
        EdgeEffectCompat edgeEffectCompat = EdgeEffectCompat.INSTANCE;
        return !((edgeEffectCompat.getDistanceCompat(this.topEffect) > 0.0f ? 1 : (edgeEffectCompat.getDistanceCompat(this.topEffect) == 0.0f ? 0 : -1)) == 0) ? Offset.m1437getYimpl(scroll) : Size.m1502getHeightimpl(this.containerSize) * edgeEffectCompat.onPullDistanceCompat(this.topEffect, fM1437getYimpl, fM1436getXimpl);
    }
    ...
    private final boolean m162releaseOppositeOverscrollk4lQ0M(long delta) {
        boolean zIsFinished;
        if (this.leftEffect.isFinished() || Offset.m1436getXimpl(delta) >= 0.0f) {
            zIsFinished = false;
        } else {
            EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.leftEffect, Offset.m1436getXimpl(delta));
            zIsFinished = this.leftEffect.isFinished();
        }
        if (!this.rightEffect.isFinished() && Offset.m1436getXimpl(delta) > 0.0f) {
            EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.rightEffect, Offset.m1436getXimpl(delta));
            zIsFinished = zIsFinished || this.rightEffect.isFinished();
        }
        if (!this.topEffect.isFinished() && Offset.m1437getYimpl(delta) < 0.0f) {
            EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.topEffect, Offset.m1437getYimpl(delta));
            zIsFinished = zIsFinished || this.topEffect.isFinished();
        }
        if (this.bottomEffect.isFinished() || Offset.m1437getYimpl(delta) <= 0.0f) {
            return zIsFinished;
        }
        EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.bottomEffect, Offset.m1437getYimpl(delta));
        return zIsFinished || this.bottomEffect.isFinished();
    }

    private final boolean stopOverscrollAnimation() {
        boolean z;
        long jM1515getCenteruvyYCjk = SizeKt.m1515getCenteruvyYCjk(this.containerSize);
        EdgeEffectCompat edgeEffectCompat = EdgeEffectCompat.INSTANCE;
        if (edgeEffectCompat.getDistanceCompat(this.leftEffect) == 0.0f) {
            z = false;
        } else {
            m159pullLeft0a9Yr6o(Offset.INSTANCE.m1452getZeroF1C5BW0(), jM1515getCenteruvyYCjk);
            z = true;
        }
        if (!(edgeEffectCompat.getDistanceCompat(this.rightEffect) == 0.0f)) {
            m160pullRight0a9Yr6o(Offset.INSTANCE.m1452getZeroF1C5BW0(), jM1515getCenteruvyYCjk);
            z = true;
        }
        if (!(edgeEffectCompat.getDistanceCompat(this.topEffect) == 0.0f)) {
            m161pullTop0a9Yr6o(Offset.INSTANCE.m1452getZeroF1C5BW0(), jM1515getCenteruvyYCjk);
            z = true;
        }
        if (edgeEffectCompat.getDistanceCompat(this.bottomEffect) == 0.0f) {
            return z;
        }
        m158pullBottom0a9Yr6o(Offset.INSTANCE.m1452getZeroF1C5BW0(), jM1515getCenteruvyYCjk);
        return true;
    }
    ...
    public Object mo163applyToFlingBMRW4eQ(long j, @NotNull Function2<? super Velocity, ? super Continuation<? super Velocity>, ? extends Object> function2, @NotNull Continuation<? super Unit> continuation) {
        AndroidEdgeEffectOverscrollEffect$applyToFling$1 androidEdgeEffectOverscrollEffect$applyToFling$1;
        float fM3990getXimpl;
        EdgeEffectCompat edgeEffectCompat;
        boolean z;
        float fM3991getYimpl;
        EdgeEffectCompat edgeEffectCompat2;
        long jM3993minusAH228Gc;
        AndroidEdgeEffectOverscrollEffect androidEdgeEffectOverscrollEffect;
        long jM3993minusAH228Gc2;
        ...
        if (i2 != 0) {
            ...
            jM3993minusAH228Gc = androidEdgeEffectOverscrollEffect$applyToFling$1.J$0;
            androidEdgeEffectOverscrollEffect = (AndroidEdgeEffectOverscrollEffect) androidEdgeEffectOverscrollEffect$applyToFling$1.L$0;
            ResultKt.throwOnFailure(objInvoke);
            jM3993minusAH228Gc2 = Velocity.m3993minusAH228Gc(jM3993minusAH228Gc, ((Velocity) objInvoke).getPackedValue());
            androidEdgeEffectOverscrollEffect.scrollCycleInProgress = false;
            if (Velocity.m3990getXimpl(jM3993minusAH228Gc2) > 0.0f) {
                EdgeEffectCompat.INSTANCE.onAbsorbCompat(androidEdgeEffectOverscrollEffect.leftEffect, MathKt.roundToInt(Velocity.m3990getXimpl(jM3993minusAH228Gc2)));
            } else if (Velocity.m3990getXimpl(jM3993minusAH228Gc2) < 0.0f) {
                EdgeEffectCompat.INSTANCE.onAbsorbCompat(androidEdgeEffectOverscrollEffect.rightEffect, -MathKt.roundToInt(Velocity.m3990getXimpl(jM3993minusAH228Gc2)));
            }
            if (Velocity.m3991getYimpl(jM3993minusAH228Gc2) > 0.0f) {
                EdgeEffectCompat.INSTANCE.onAbsorbCompat(androidEdgeEffectOverscrollEffect.topEffect, MathKt.roundToInt(Velocity.m3991getYimpl(jM3993minusAH228Gc2)));
            } else if (Velocity.m3991getYimpl(jM3993minusAH228Gc2) < 0.0f) {
                EdgeEffectCompat.INSTANCE.onAbsorbCompat(androidEdgeEffectOverscrollEffect.bottomEffect, -MathKt.roundToInt(Velocity.m3991getYimpl(jM3993minusAH228Gc2)));
            }
            if (!Velocity.m3989equalsimpl0(jM3993minusAH228Gc2, Velocity.INSTANCE.m4001getZero9UxMQ8M())) {
        ...
        ResultKt.throwOnFailure(objInvoke);
        if (Size.m1507isEmptyimpl(this.containerSize)) {
            Velocity velocityM3981boximpl = Velocity.m3981boximpl(j);
            androidEdgeEffectOverscrollEffect$applyToFling$1.label = 1;
            if (function2.invoke(velocityM3981boximpl, androidEdgeEffectOverscrollEffect$applyToFling$1) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
        }
        if (Velocity.m3990getXimpl(j) > 0.0f) {
            EdgeEffectCompat edgeEffectCompat3 = EdgeEffectCompat.INSTANCE;
            if (!(edgeEffectCompat3.getDistanceCompat(this.leftEffect) == 0.0f)) {
                edgeEffectCompat3.onAbsorbCompat(this.leftEffect, MathKt.roundToInt(Velocity.m3990getXimpl(j)));
                fM3990getXimpl = Velocity.m3990getXimpl(j);
            } else if (Velocity.m3990getXimpl(j) < 0.0f) {
                ...
                if (z) {
                    ...
                    edgeEffectCompat.onAbsorbCompat(this.rightEffect, -MathKt.roundToInt(Velocity.m3990getXimpl(j)));
                    fM3990getXimpl = Velocity.m3990getXimpl(j);
                }
            } else {
                fM3990getXimpl = 0.0f;
        ...
        if (Velocity.m3991getYimpl(j) > 0.0f) {
            EdgeEffectCompat edgeEffectCompat4 = EdgeEffectCompat.INSTANCE;
            if (!(edgeEffectCompat4.getDistanceCompat(this.topEffect) == 0.0f)) {
                edgeEffectCompat4.onAbsorbCompat(this.topEffect, MathKt.roundToInt(Velocity.m3991getYimpl(j)));
                fM3991getYimpl = Velocity.m3991getYimpl(j);
            } else if (Velocity.m3991getYimpl(j) < 0.0f) {
                edgeEffectCompat2 = EdgeEffectCompat.INSTANCE;
                if (edgeEffectCompat2.getDistanceCompat(this.bottomEffect) == 0.0f) {
                    fM3991getYimpl = 0.0f;
                } else {
                    edgeEffectCompat2.onAbsorbCompat(this.bottomEffect, -MathKt.roundToInt(Velocity.m3991getYimpl(j)));
                    fM3991getYimpl = Velocity.m3991getYimpl(j);
                }
            } else {
                fM3991getYimpl = 0.0f;
        ...
        long jVelocity = VelocityKt.Velocity(fM3990getXimpl, fM3991getYimpl);
        if (!Velocity.m3989equalsimpl0(jVelocity, Velocity.INSTANCE.m4001getZero9UxMQ8M())) {
            invalidateOverscroll();
        }
        jM3993minusAH228Gc = Velocity.m3993minusAH228Gc(j, jVelocity);
        Velocity velocityM3981boximpl2 = Velocity.m3981boximpl(jM3993minusAH228Gc);
        androidEdgeEffectOverscrollEffect$applyToFling$1.L$0 = this;
        androidEdgeEffectOverscrollEffect$applyToFling$1.J$0 = jM3993minusAH228Gc;
        androidEdgeEffectOverscrollEffect$applyToFling$1.label = 2;
        objInvoke = function2.invoke(velocityM3981boximpl2, androidEdgeEffectOverscrollEffect$applyToFling$1);
    ...
    public long mo164applyToScrollRhakbz0(long delta, int source, @NotNull Function1<? super Offset, Offset> performScroll) {
        float fM158pullBottom0a9Yr6o;
        boolean z;
        boolean z2;
        boolean z3;
        float fM160pullRight0a9Yr6o;
        Intrinsics.checkNotNullParameter(performScroll, "performScroll");
        if (Size.m1507isEmptyimpl(this.containerSize)) {
            return performScroll.invoke(Offset.m1425boximpl(delta)).getPackedValue();
        }
        boolean z4 = true;
        ...
        long packedValue = offset != null ? offset.getPackedValue() : SizeKt.m1515getCenteruvyYCjk(this.containerSize);
        float f = 0.0f;
        if (Offset.m1437getYimpl(delta) == 0.0f) {
            fM158pullBottom0a9Yr6o = 0.0f;
        } else {
            EdgeEffectCompat edgeEffectCompat = EdgeEffectCompat.INSTANCE;
            if (edgeEffectCompat.getDistanceCompat(this.topEffect) == 0.0f) {
                if (edgeEffectCompat.getDistanceCompat(this.bottomEffect) == 0.0f) {
                    ...
                    fM158pullBottom0a9Yr6o = m158pullBottom0a9Yr6o(delta, packedValue);
                    if (edgeEffectCompat.getDistanceCompat(this.bottomEffect) == 0.0f) {
                        this.bottomEffect.onRelease();
                    }
                }
            } else {
                fM158pullBottom0a9Yr6o = m161pullTop0a9Yr6o(delta, packedValue);
                if (edgeEffectCompat.getDistanceCompat(this.topEffect) == 0.0f) {
                    this.topEffect.onRelease();
                }
            }
        }
        if (!(Offset.m1436getXimpl(delta) == 0.0f)) {
            ...
            if (edgeEffectCompat2.getDistanceCompat(this.leftEffect) == 0.0f) {
                if (!(edgeEffectCompat2.getDistanceCompat(this.rightEffect) == 0.0f)) {
                    fM160pullRight0a9Yr6o = m160pullRight0a9Yr6o(delta, packedValue);
                    if (edgeEffectCompat2.getDistanceCompat(this.rightEffect) == 0.0f) {
                        this.rightEffect.onRelease();
                    }
                }
            } else {
                fM160pullRight0a9Yr6o = m159pullLeft0a9Yr6o(delta, packedValue);
                if (edgeEffectCompat2.getDistanceCompat(this.leftEffect) == 0.0f) {
                    this.leftEffect.onRelease();
                }
            }
            f = fM160pullRight0a9Yr6o;
        }
        long jOffset = OffsetKt.Offset(f, fM158pullBottom0a9Yr6o);
        if (!Offset.m1433equalsimpl0(jOffset, Offset.INSTANCE.m1452getZeroF1C5BW0())) {
            invalidateOverscroll();
        }
        long jM1440minusMKHz9U = Offset.m1440minusMKHz9U(delta, jOffset);
        long packedValue2 = performScroll.invoke(Offset.m1425boximpl(jM1440minusMKHz9U)).getPackedValue();
        long jM1440minusMKHz9U2 = Offset.m1440minusMKHz9U(jM1440minusMKHz9U, packedValue2);
        if (NestedScrollSource.m2594equalsimpl0(source, NestedScrollSource.INSTANCE.m2599getDragWNlRxjI())) {
            if (Offset.m1436getXimpl(jM1440minusMKHz9U2) > 0.5f) {
                m159pullLeft0a9Yr6o(jM1440minusMKHz9U2, packedValue);
            } else {
                if (Offset.m1436getXimpl(jM1440minusMKHz9U2) < -0.5f) {
                    m160pullRight0a9Yr6o(jM1440minusMKHz9U2, packedValue);
                } else {
                    z2 = false;
                }
                if (Offset.m1437getYimpl(jM1440minusMKHz9U2) > 0.5f) {
                    m161pullTop0a9Yr6o(jM1440minusMKHz9U2, packedValue);
                } else {
                    if (Offset.m1437getYimpl(jM1440minusMKHz9U2) < -0.5f) {
                        m158pullBottom0a9Yr6o(jM1440minusMKHz9U2, packedValue);
                    } else {
                        z3 = false;
                    }
                    if (!z2 || z3) {
        ...
        if (!m162releaseOppositeOverscrollk4lQ0M(delta) && !z) {
            z4 = false;
        }
        if (z4) {
            invalidateOverscroll();
        }
        return Offset.m1441plusMKHz9U(jOffset, packedValue2);
    }
