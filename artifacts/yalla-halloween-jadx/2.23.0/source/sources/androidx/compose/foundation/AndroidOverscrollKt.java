...
public final class AndroidOverscrollKt {
    ...
    static {
        StretchOverscrollNonClippingLayer = Build.VERSION.SDK_INT >= 31 ? LayoutModifierKt.layout(LayoutModifierKt.layout(Modifier.INSTANCE, new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.foundation.AndroidOverscrollKt$StretchOverscrollNonClippingLayer$1
            ...
            public final MeasureResult m166invoke3p2s80s(@NotNull MeasureScope layout, @NotNull Measurable measurable, long j) {
                Intrinsics.checkNotNullParameter(layout, "$this$layout");
                Intrinsics.checkNotNullParameter(measurable, "measurable");
                final Placeable placeableMo2794measureBRTryo0 = measurable.mo2794measureBRTryo0(j);
                final int iMo318roundToPx0680j_4 = layout.mo318roundToPx0680j_4(Dp.m3765constructorimpl(ClipScrollableContainerKt.getMaxSupportedElevation() * 2));
                return MeasureScope.CC.OooOOo0(layout, placeableMo2794measureBRTryo0.getMeasuredWidth() - iMo318roundToPx0680j_4, placeableMo2794measureBRTryo0.getMeasuredHeight() - iMo318roundToPx0680j_4, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.AndroidOverscrollKt$StretchOverscrollNonClippingLayer$1.1
                    ...
                    public final void invoke2(@NotNull Placeable.PlacementScope layout2) {
                        ...
                        Placeable.PlacementScope.placeWithLayer$default(layout2, placeable, ((-iMo318roundToPx0680j_4) / 2) - ((placeable.getWidth() - placeableMo2794measureBRTryo0.getMeasuredWidth()) / 2), ((-iMo318roundToPx0680j_4) / 2) - ((placeableMo2794measureBRTryo0.getHeight() - placeableMo2794measureBRTryo0.getMeasuredHeight()) / 2), 0.0f, null, 12, null);
                    }
                }, 4, null);
            }
            ...
            @NotNull
            /* JADX INFO: renamed from: invoke-3p2s80s, reason: not valid java name */
            public final MeasureResult m167invoke3p2s80s(@NotNull MeasureScope layout, @NotNull Measurable measurable, long j) {
                Intrinsics.checkNotNullParameter(layout, "$this$layout");
                Intrinsics.checkNotNullParameter(measurable, "measurable");
                final Placeable placeableMo2794measureBRTryo0 = measurable.mo2794measureBRTryo0(j);
                final int iMo318roundToPx0680j_4 = layout.mo318roundToPx0680j_4(Dp.m3765constructorimpl(ClipScrollableContainerKt.getMaxSupportedElevation() * 2));
                return MeasureScope.CC.OooOOo0(layout, placeableMo2794measureBRTryo0.getWidth() + iMo318roundToPx0680j_4, placeableMo2794measureBRTryo0.getHeight() + iMo318roundToPx0680j_4, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.AndroidOverscrollKt$StretchOverscrollNonClippingLayer$2.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
