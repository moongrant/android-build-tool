...
public final class BasicMarqueeKt {
    ...
    private static final float DefaultMarqueeVelocity = Dp.m3765constructorimpl(30);
    ...
    public static final Modifier m174basicMarquee1Mj1MLw(@NotNull Modifier basicMarquee, int i, int i2, int i3, int i4, @NotNull MarqueeSpacing spacing, float f) {
    ...
    public static /* synthetic */ Modifier m175basicMarquee1Mj1MLw$default(Modifier modifier, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f, int i5, Object obj) {
        ...
        if ((i5 & 2) != 0) {
            i2 = MarqueeAnimationMode.INSTANCE.m241getImmediatelyZbEOnfQ();
        }
        int i6 = i2;
        if ((i5 & 4) != 0) {
        ...
        int i7 = i3;
        if ((i5 & 8) != 0) {
            i4 = MarqueeAnimationMode.m235equalsimpl0(i6, MarqueeAnimationMode.INSTANCE.m241getImmediatelyZbEOnfQ()) ? i7 : 0;
        }
        int i8 = i4;
        if ((i5 & 16) != 0) {
    ...
    public static final AnimationSpec<Float> m176createMarqueeAnimationSpecZ4HSEVQ(int i, float f, int i2, int i3, float f2, Density density) {
        TweenSpec<Float> tweenSpecVelocityBasedTween = velocityBasedTween(Math.abs(density.mo324toPx0680j_4(f2)), f, i3);
