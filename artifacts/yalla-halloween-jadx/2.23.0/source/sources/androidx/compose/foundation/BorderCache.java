...
final /* data */ class BorderCache {
    ...
    public final ImageBitmap m177drawBorderCacheEMwLDEs(@NotNull CacheDrawScope drawBorderCache, long j, int i, @NotNull Function1<? super DrawScope, Unit> block) {
        CanvasDrawScope canvasDrawScope;
        Intrinsics.checkNotNullParameter(drawBorderCache, "$this$drawBorderCache");
        Intrinsics.checkNotNullParameter(block, "block");
        ImageBitmap imageBitmapM1873ImageBitmapx__hDU$default = this.imageBitmap;
        Canvas Canvas = this.canvas;
        ImageBitmapConfig imageBitmapConfigM1860boximpl = imageBitmapM1873ImageBitmapx__hDU$default != null ? ImageBitmapConfig.m1860boximpl(imageBitmapM1873ImageBitmapx__hDU$default.mo1545getConfig_sVssgQ()) : null;
        boolean z = false;
        if (!(imageBitmapConfigM1860boximpl == null ? false : ImageBitmapConfig.m1863equalsimpl0(imageBitmapConfigM1860boximpl.m1866unboximpl(), ImageBitmapConfig.INSTANCE.m1868getArgb8888_sVssgQ()))) {
            if (ImageBitmapConfig.m1862equalsimpl(i, imageBitmapM1873ImageBitmapx__hDU$default != null ? ImageBitmapConfig.m1860boximpl(imageBitmapM1873ImageBitmapx__hDU$default.mo1545getConfig_sVssgQ()) : null)) {
            }
            if (imageBitmapM1873ImageBitmapx__hDU$default != null || Canvas == null || Size.m1505getWidthimpl(drawBorderCache.m1342getSizeNHjbRc()) > imageBitmapM1873ImageBitmapx__hDU$default.getWidth() || Size.m1502getHeightimpl(drawBorderCache.m1342getSizeNHjbRc()) > imageBitmapM1873ImageBitmapx__hDU$default.getHeight() || !z) {
                imageBitmapM1873ImageBitmapx__hDU$default = ImageBitmapKt.m1873ImageBitmapx__hDU$default(IntSize.m3925getWidthimpl(j), IntSize.m3924getHeightimpl(j), i, false, null, 24, null);
                this.imageBitmap = imageBitmapM1873ImageBitmapx__hDU$default;
                Canvas = androidx.compose.ui.graphics.CanvasKt.Canvas(imageBitmapM1873ImageBitmapx__hDU$default);
                this.canvas = Canvas;
            }
            ...
            long jM3935toSizeozmzZPI = IntSizeKt.m3935toSizeozmzZPI(j);
            ...
            Canvas.save();
            androidx.compose.ui.graphics.drawscope.OooO0O0.Oooo0OO(canvasDrawScope, Color.INSTANCE.m1696getBlack0d7_KjU(), 0L, jM3935toSizeozmzZPI, 0.0f, null, null, BlendMode.INSTANCE.m1593getClear0nO6VwU(), 58, null);
            ...
            imageBitmapM1873ImageBitmapx__hDU$default.prepareToDraw();
            return imageBitmapM1873ImageBitmapx__hDU$default;
        }
        z = true;
        if (imageBitmapM1873ImageBitmapx__hDU$default != null) {
            imageBitmapM1873ImageBitmapx__hDU$default = ImageBitmapKt.m1873ImageBitmapx__hDU$default(IntSize.m3925getWidthimpl(j), IntSize.m3924getHeightimpl(j), i, false, null, 24, null);
            this.imageBitmap = imageBitmapM1873ImageBitmapx__hDU$default;
            Canvas = androidx.compose.ui.graphics.CanvasKt.Canvas(imageBitmapM1873ImageBitmapx__hDU$default);
            this.canvas = Canvas;
        ...
        long jM3935toSizeozmzZPI2 = IntSizeKt.m3935toSizeozmzZPI(j);
        ...
        drawParams5.m2113setSizeuvyYCjk(jM3935toSizeozmzZPI2);
        Canvas.save();
        androidx.compose.ui.graphics.drawscope.OooO0O0.Oooo0OO(canvasDrawScope, Color.INSTANCE.m1696getBlack0d7_KjU(), 0L, jM3935toSizeozmzZPI2, 0.0f, null, null, BlendMode.INSTANCE.m1593getClear0nO6VwU(), 58, null);
        block.invoke(canvasDrawScope);
        Canvas.restore();
        ...
        drawParams6.m2113setSizeuvyYCjk(size2);
        imageBitmapM1873ImageBitmapx__hDU$default.prepareToDraw();
        return imageBitmapM1873ImageBitmapx__hDU$default;
    }
