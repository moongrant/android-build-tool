...
public final class BorderKt {
    ...
    public static final Modifier m180borderxT4_qwU(@NotNull Modifier border, float f, long j, @NotNull Shape shape) {
    ...
    public static final Modifier m182borderziNgDLE(@NotNull Modifier border, float f, @NotNull Brush brush, @NotNull Shape shape) {
        Intrinsics.checkNotNullParameter(border, "$this$border");
    ...
    private static final RoundRect createInsetRoundedRect(float f, RoundRect roundRect) {
        return new RoundRect(f, f, roundRect.getWidth() - f, roundRect.getHeight() - f, m184shrinkKibmq7A(roundRect.m1486getTopLeftCornerRadiuskKHJgLs(), f), m184shrinkKibmq7A(roundRect.m1487getTopRightCornerRadiuskKHJgLs(), f), m184shrinkKibmq7A(roundRect.m1485getBottomRightCornerRadiuskKHJgLs(), f), m184shrinkKibmq7A(roundRect.m1484getBottomLeftCornerRadiuskKHJgLs(), f), null);
    }
    ...
    public static final Path createRoundRectPath(Path path, RoundRect roundRect, float f, boolean z) {
        ...
        if (!z) {
            ...
            path.mo1570opN5in7k0(path, Path, PathOperation.INSTANCE.m1934getDifferenceb3I0S0c());
        }
        return path;
    }
    ...
    public static final DrawResult m183drawRectBorderNsqcLGU(CacheDrawScope cacheDrawScope, final Brush brush, long j, long j2, boolean z, float f) {
        final long jM1452getZeroF1C5BW0 = z ? Offset.INSTANCE.m1452getZeroF1C5BW0() : j;
        final long jM1342getSizeNHjbRc = z ? cacheDrawScope.m1342getSizeNHjbRc() : j2;
        ...
        return cacheDrawScope.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderKt$drawRectBorder$1
            ...
            public final void invoke2(@NotNull ContentDrawScope onDrawWithContent) {
                Intrinsics.checkNotNullParameter(onDrawWithContent, "$this$onDrawWithContent");
                onDrawWithContent.drawContent();
                androidx.compose.ui.graphics.drawscope.OooO0O0.Oooo0O0(onDrawWithContent, brush, jM1452getZeroF1C5BW0, jM1342getSizeNHjbRc, 0.0f, stroke, null, 0, 104, null);
            }
        });
    }
    ...
    public static final long m184shrinkKibmq7A(long j, float f) {
        return CornerRadiusKt.CornerRadius(Math.max(0.0f, CornerRadius.m1411getXimpl(j) - f), Math.max(0.0f, CornerRadius.m1412getYimpl(j) - f));
    }
}
