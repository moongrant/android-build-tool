...
public final /* data */ class BorderModifierNodeElement extends ModifierNodeElement<BorderModifierNode> {
    ...
    public final BorderModifierNodeElement m191copy8Feqmps(float width, @NotNull Brush brush, @NotNull Shape shape) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Dp.m3770equalsimpl0(this.width, borderModifierNodeElement.width) && Intrinsics.areEqual(this.brush, borderModifierNodeElement.brush) && Intrinsics.areEqual(this.shape, borderModifierNodeElement.shape);
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return this.shape.hashCode() + ((this.brush.hashCode() + (Dp.m3771hashCodeimpl(this.width) * 31)) * 31);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void inspectableProperties(@NotNull InspectorInfo inspectorInfo) {
        OooOOO0.OooO00o(inspectorInfo, "<this>", OutlinedTextFieldKt.BorderId).set(ViewHierarchyConstants.DIMENSION_WIDTH_KEY, Dp.m3763boximpl(this.width));
        if (this.brush instanceof SolidColor) {
            inspectorInfo.getProperties().set("color", Color.m1660boximpl(((SolidColor) this.brush).getValue()));
            inspectorInfo.setValue(Color.m1660boximpl(((SolidColor) this.brush).getValue()));
        } else {
    ...
    public String toString() {
        return "BorderModifierNodeElement(width=" + ((Object) Dp.m3776toStringimpl(this.width)) + ", brush=" + this.brush + ", shape=" + this.shape + ')';
    }
