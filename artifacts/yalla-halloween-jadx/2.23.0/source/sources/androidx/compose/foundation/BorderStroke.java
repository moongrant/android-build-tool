...
public final class BorderStroke {
    ...
    public final BorderStroke m194copyD5KLDUw(float width, @NotNull Brush brush) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Dp.m3770equalsimpl0(this.width, borderStroke.width) && Intrinsics.areEqual(this.brush, borderStroke.brush);
    }
    ...
    public int hashCode() {
        return this.brush.hashCode() + (Dp.m3771hashCodeimpl(this.width) * 31);
    }

    @NotNull
    public String toString() {
        return "BorderStroke(width=" + ((Object) Dp.m3776toStringimpl(this.width)) + ", brush=" + this.brush + ')';
    }
