...
public final class Clickable_androidKt {
    ...
    public static final boolean m215isClickZmokQxo(@NotNull KeyEvent isClick) {
        Intrinsics.checkNotNullParameter(isClick, "$this$isClick");
        return KeyEventType.m2568equalsimpl0(KeyEvent_androidKt.m2576getTypeZmokQxo(isClick), KeyEventType.INSTANCE.m2573getKeyUpCS__XNY()) && m216isEnterZmokQxo(isClick);
    }
    ...
    private static final boolean m216isEnterZmokQxo(KeyEvent keyEvent) {
        int iM2582getNativeKeyCodeYVgTNJs = Key_androidKt.m2582getNativeKeyCodeYVgTNJs(KeyEvent_androidKt.m2575getKeyZmokQxo(keyEvent));
        return iM2582getNativeKeyCodeYVgTNJs == 23 || iM2582getNativeKeyCodeYVgTNJs == 66 || iM2582getNativeKeyCodeYVgTNJs == 160;
    }
    ...
    public static final boolean m217isPressZmokQxo(@NotNull KeyEvent isPress) {
        Intrinsics.checkNotNullParameter(isPress, "$this$isPress");
        return KeyEventType.m2568equalsimpl0(KeyEvent_androidKt.m2576getTypeZmokQxo(isPress), KeyEventType.INSTANCE.m2572getKeyDownCS__XNY()) && m216isEnterZmokQxo(isPress);
    }
}
