...
final class HoverableNode extends Modifier.Node implements PointerInputModifierNode {
    ...
    public static final class C06371 extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        public C06371(Continuation<? super C06371> continuation) {
            super(continuation);
        }
    ...
    public final Object emitExit(@NotNull Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C06371) {
            ...
            int i = c06371.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c06371.label = i - Integer.MIN_VALUE;
            } else {
        ...
        if (i2 == 0) {
            ...
            if (enter != null) {
                ...
                c06371.L$0 = this;
                c06371.label = 1;
                if (mutableInteractionSource.emit(exit, c06371) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                hoverableNode = this;
            }
        ...
        hoverableNode = (HoverableNode) c06371.L$0;
        ResultKt.throwOnFailure(obj);
    ...
    public void mo152onPointerEventH0pRuoY(@NotNull PointerEvent pointerEvent, @NotNull PointerEventPass pass, long bounds) {
        ...
        if (pass == PointerEventPass.Main) {
            ...
            if (PointerEventType.m2639equalsimpl0(type, companion.m2643getEnter7fucELk())) {
            ...
            } else if (PointerEventType.m2639equalsimpl0(type, companion.m2644getExit7fucELk())) {
