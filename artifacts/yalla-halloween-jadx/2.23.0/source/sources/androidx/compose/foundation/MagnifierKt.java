        ...
        if ((i & 2) != 0) {
            function2 = new Function1<Density, Offset>() { // from class: androidx.compose.foundation.MagnifierKt.magnifier.1
                ...
                public /* bridge */ /* synthetic */ Offset invoke(Density density) {
                    return Offset.m1425boximpl(m226invoketuRUvjQ(density));
                }

                /* JADX INFO: renamed from: invoke-tuRUvjQ, reason: not valid java name */
                public final long m226invoketuRUvjQ(@NotNull Density density) {
    ...
    public static final class AnonymousClass4 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
        ...
        public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public static final class C00371 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C00371(PlatformMagnifier platformMagnifier, Continuation<? super C00371> continuation) {
                ...
                public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                    return new C00371(this.$magnifier, continuation);
                }
            ...
            public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
                ...
                long jMo252getSizeYbymL2g = platformMagnifierCreate.mo252getSizeYbymL2g();
                ...
                if (function1Invoke$lambda$6 != null) {
                    function1Invoke$lambda$6.invoke(DpSize.m3851boximpl(density.mo322toDpSizekrfVVM(IntSizeKt.m3935toSizeozmzZPI(jMo252getSizeYbymL2g))));
                }
                longRef.element = jMo252getSizeYbymL2g;
                FlowKt.launchIn(FlowKt.onEach(this.$onNeedsUpdate, new C00371(platformMagnifierCreate, null)), coroutineScope);
                try {
                    ...
                    Flow flowSnapshotFlow = SnapshotStateKt.snapshotFlow(new Function0<Unit>() { // from class: androidx.compose.foundation.MagnifierKt.magnifier.4.1.2
                        ...
                        public final void invoke2() {
                            ...
                            platformMagnifier2.mo253updateWko1d7g(jInvoke$lambda$8, OffsetKt.m1455isSpecifiedk4lQ0M(packedValue) ? Offset.m1441plusMKHz9U(AnonymousClass4.invoke$lambda$1(mutableState2), packedValue) : Offset.INSTANCE.m1451getUnspecifiedF1C5BW0(), AnonymousClass4.invoke$lambda$5(state4));
                            long jMo252getSizeYbymL2g2 = platformMagnifierCreate.mo252getSizeYbymL2g();
                            Ref.LongRef longRef2 = longRef;
                            Density density3 = density2;
                            State<Function1<DpSize, Unit>> state6 = state5;
                            if (IntSize.m3923equalsimpl0(jMo252getSizeYbymL2g2, longRef2.element)) {
                                return;
                            }
                            longRef2.element = jMo252getSizeYbymL2g2;
                            Function1 function1Invoke$lambda$7 = AnonymousClass4.invoke$lambda$6(state6);
                            if (function1Invoke$lambda$7 != null) {
                                function1Invoke$lambda$7.invoke(DpSize.m3851boximpl(density3.mo322toDpSizekrfVVM(IntSizeKt.m3935toSizeozmzZPI(jMo252getSizeYbymL2g2))));
                            }
                        }
                    });
        ...
        public static final void invoke$lambda$2(MutableState<Offset> mutableState, long j) {
            mutableState.setValue(Offset.m1425boximpl(j));
        }
        ...
        public final Modifier invoke(@NotNull Modifier modifier, @Nullable Composer composer, int i) {
            if (OooOOO.OooO00o(modifier, "$this$composed", composer, -454877003)) {
            ...
            if (objRememberedValue == companion.getEmpty()) {
                objRememberedValue = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m1425boximpl(Offset.INSTANCE.m1451getUnspecifiedF1C5BW0()), null, 2, null);
            ...
            if (objRememberedValue2 == companion.getEmpty()) {
                objRememberedValue2 = SnapshotStateKt.derivedStateOf(new Function0<Offset>() { // from class: androidx.compose.foundation.MagnifierKt$magnifier$4$sourceCenterInRoot$2$1
                    ...
                    public /* bridge */ /* synthetic */ Offset invoke() {
                        return Offset.m1425boximpl(m228invokeF1C5BW0());
                    }
                    ...
                    public final long m228invokeF1C5BW0() {
                        ...
                        return (OffsetKt.m1455isSpecifiedk4lQ0M(MagnifierKt.AnonymousClass4.invoke$lambda$1(mutableState)) && OffsetKt.m1455isSpecifiedk4lQ0M(packedValue)) ? Offset.m1441plusMKHz9U(MagnifierKt.AnonymousClass4.invoke$lambda$1(mutableState), packedValue) : Offset.INSTANCE.m1451getUnspecifiedF1C5BW0();
                    }
                });
            ...
            if (objRememberedValue3 == companion.getEmpty()) {
                objRememberedValue3 = SnapshotStateKt.derivedStateOf(new Function0<Boolean>() { // from class: androidx.compose.foundation.MagnifierKt$magnifier$4$isMagnifierShown$2$1
                    ...
                    public final Boolean invoke() {
                        return Boolean.valueOf(OffsetKt.m1455isSpecifiedk4lQ0M(MagnifierKt.AnonymousClass4.invoke$lambda$8(state)));
                    }
                });
                ...
                objRememberedValue6 = new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.foundation.MagnifierKt$magnifier$4$4$1
                    ...
                    public final void invoke2(@NotNull SemanticsPropertyReceiver semantics) {
                        ...
                        semantics.set(magnifierPositionInRoot, new Function0<Offset>() { // from class: androidx.compose.foundation.MagnifierKt$magnifier$4$4$1.1
                            ...
                            @Override // kotlin.jvm.functions.Function0
                            public /* bridge */ /* synthetic */ Offset invoke() {
                                return Offset.m1425boximpl(m227invokeF1C5BW0());
                            }
