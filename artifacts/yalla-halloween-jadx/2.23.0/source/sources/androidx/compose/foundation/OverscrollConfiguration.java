...
public final class OverscrollConfiguration {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Color.m1671equalsimpl0(this.glowColor, overscrollConfiguration.glowColor) && Intrinsics.areEqual(this.drawPadding, overscrollConfiguration.drawPadding);
    }
    ...
    public int hashCode() {
        return this.drawPadding.hashCode() + (Color.m1677hashCodeimpl(this.glowColor) * 31);
    }

    @NotNull
    public String toString() {
        return "OverscrollConfiguration(glowColor=" + ((Object) Color.m1678toStringimpl(this.glowColor)) + ", drawPadding=" + this.drawPadding + ')';
    }
    ...
    public /* synthetic */ OverscrollConfiguration(long j, PaddingValues paddingValues, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? ColorKt.Color(4284900966L) : j, (i & 2) != 0 ? PaddingKt.m471PaddingValuesYgX7TsA$default(0.0f, 0.0f, 3, null) : paddingValues, null);
    }
}
