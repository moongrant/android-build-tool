...
final class ScrollingLayoutNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo248measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j) {
        ...
        final Placeable placeableMo2794measureBRTryo0 = measurable.mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j, 0, this.isVertical ? Constraints.m3733getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, this.isVertical ? Integer.MAX_VALUE : Constraints.m3732getMaxHeightimpl(j), 5, null));
        int iCoerceAtMost = RangesKt.coerceAtMost(placeableMo2794measureBRTryo0.getWidth(), Constraints.m3733getMaxWidthimpl(j));
        int iCoerceAtMost2 = RangesKt.coerceAtMost(placeableMo2794measureBRTryo0.getHeight(), Constraints.m3732getMaxHeightimpl(j));
        final int height = placeableMo2794measureBRTryo0.getHeight() - iCoerceAtMost2;
        int width = placeableMo2794measureBRTryo0.getWidth() - iCoerceAtMost;
        if (!this.isVertical) {
            height = width;
        }
        ...
        return MeasureScope.CC.OooOOo0(measure, iCoerceAtMost, iCoerceAtMost2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.ScrollingLayoutNode$measure$1
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.placeRelativeWithLayer$default(layout, placeableMo2794measureBRTryo0, this.this$0.getIsVertical() ? 0 : i, this.this$0.getIsVertical() ? i : 0, 0.0f, null, 12, null);
            }
        }, 4, null);
    }
