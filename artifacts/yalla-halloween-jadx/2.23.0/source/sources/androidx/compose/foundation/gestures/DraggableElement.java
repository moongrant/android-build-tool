...
public final class DraggableElement extends ModifierNodeElement<DraggableNode> {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!Intrinsics.areEqual(DraggableElement.class, other != null ? other.getClass() : null)) {
            return false;
        }
    ...
    public void inspectableProperties(@NotNull InspectorInfo inspectorInfo) {
        OooOOO0.OooO00o(inspectorInfo, "<this>", "draggable").set("canDrag", this.canDrag);
        inspectorInfo.getProperties().set("orientation", this.orientation);
        androidx.compose.foundation.OooO00o.OooO00o(this.reverseDirection, androidx.compose.foundation.OooO00o.OooO00o(this.enabled, inspectorInfo.getProperties(), "enabled", inspectorInfo), "reverseDirection", inspectorInfo).set("interactionSource", this.interactionSource);
