...
public final class DraggableNode extends DelegatingNode implements PointerInputModifierNode {
    ...
    public static final class C06531 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        int label;
        ...
        public C06531(Continuation<? super C06531> continuation) {
            super(continuation);
        }
    ...
    public final Object processDragCancel(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        ...
        velocityM3981boximpl = Velocity.m3981boximpl(Velocity.INSTANCE.m4001getZero9UxMQ8M());
        anonymousClass1.L$0 = null;
        anonymousClass1.L$1 = null;
        anonymousClass1.label = 2;
        if (function3.invoke(coroutineScope, velocityM3981boximpl, anonymousClass1) == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Unit.INSTANCE;
    ...
    public final Object processDragStart(CoroutineScope coroutineScope, DragEvent.DragStarted dragStarted, Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C06521) {
            ...
            int i = c06521.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c06521.label = i - Integer.MIN_VALUE;
            } else {
        ...
        Object obj = c06521.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c06521.label;
        if (i2 != 0) {
            if (i2 == 1) {
                DragEvent.DragStarted dragStarted2 = (DragEvent.DragStarted) c06521.L$2;
                CoroutineScope coroutineScope3 = (CoroutineScope) c06521.L$1;
                draggableNode = (DraggableNode) c06521.L$0;
                ResultKt.throwOnFailure(obj);
                dragStarted = dragStarted2;
                coroutineScope = coroutineScope3;
            } else if (i2 == 2) {
                start2 = (DragInteraction.Start) c06521.L$3;
                dragStarted = (DragEvent.DragStarted) c06521.L$2;
                coroutineScope2 = (CoroutineScope) c06521.L$1;
                draggableNode2 = (DraggableNode) c06521.L$0;
                ResultKt.throwOnFailure(obj);
                start = start2;
                coroutineScope = coroutineScope2;
                draggableNode = draggableNode2;
                ...
                offsetM1425boximpl = Offset.m1425boximpl(dragStarted.getStartPoint());
                c06521.L$0 = null;
                c06521.L$1 = null;
                c06521.L$2 = null;
                c06521.L$3 = null;
                c06521.label = 3;
                if (function3.invoke(coroutineScope, offsetM1425boximpl, c06521) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i2 != 3) {
        ...
        if (start3 != null && (mutableInteractionSource = this.interactionSource) != null) {
            ...
            c06521.L$0 = this;
            c06521.L$1 = coroutineScope;
            c06521.L$2 = dragStarted;
            c06521.label = 1;
            if (mutableInteractionSource.emit(cancel, c06521) == coroutine_suspended) {
                return coroutine_suspended;
            }
        }
        draggableNode = this;
        ...
        if (mutableInteractionSource2 != null) {
            c06521.L$0 = draggableNode;
            c06521.L$1 = coroutineScope;
            c06521.L$2 = dragStarted;
            c06521.L$3 = start;
            c06521.label = 2;
            if (mutableInteractionSource2.emit(start, c06521) == coroutine_suspended) {
                return coroutine_suspended;
            }
    ...
    public final Object processDragStop(CoroutineScope coroutineScope, DragEvent.DragStopped dragStopped, Continuation<? super Unit> continuation) {
        ...
        Object obj = c06531.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c06531.label;
        if (i2 != 0) {
            if (i2 == 1) {
                DragEvent.DragStopped dragStopped2 = (DragEvent.DragStopped) c06531.L$2;
                CoroutineScope coroutineScope2 = (CoroutineScope) c06531.L$1;
                draggableNode = (DraggableNode) c06531.L$0;
                ResultKt.throwOnFailure(obj);
        ...
        if (start != null) {
            ...
            if (mutableInteractionSource != null) {
                ...
                c06531.L$0 = this;
                c06531.L$1 = coroutineScope;
                c06531.L$2 = dragStopped;
                c06531.label = 1;
                if (mutableInteractionSource.emit(stop, c06531) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
            draggableNode = this;
        ...
        function3 = draggableNode.onDragStopped;
        velocityM3981boximpl = Velocity.m3981boximpl(dragStopped.getVelocity());
        c06531.L$0 = null;
        c06531.L$1 = null;
        c06531.L$2 = null;
        c06531.label = 2;
        if (function3.invoke(coroutineScope, velocityM3981boximpl, c06531) == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Unit.INSTANCE;
        draggableNode.dragInteraction = null;
