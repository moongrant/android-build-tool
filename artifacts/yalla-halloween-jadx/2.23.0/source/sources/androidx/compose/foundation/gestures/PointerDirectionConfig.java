...
public interface PointerDirectionConfig {
    ...
    float mo287crossAxisDeltak4lQ0M(long offset);

    /* JADX INFO: renamed from: mainAxisDelta-k-4lQ0M */
    float mo288mainAxisDeltak4lQ0M(long offset);

    /* JADX INFO: renamed from: offsetFromChanges-dBAh8RU */
    long mo289offsetFromChangesdBAh8RU(float mainChange, float crossChange);
}
