...
public final class ScrollExtensionsKt {
    ...
    public static final class C06571 extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        public C06571(Continuation<? super C06571> continuation) {
            super(continuation);
        }
    ...
    public static final class C06582 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C06582(Ref.FloatRef floatRef, float f, Continuation<? super C06582> continuation) {
            super(2, continuation);
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C06582 c06582 = new C06582(this.$consumed, this.$value, continuation);
            c06582.L$0 = obj;
            return c06582;
        }
        ...
        @Nullable
        public final Object invoke(@NotNull ScrollScope scrollScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C06582) create(scrollScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final class C06592 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
        int label;

        public C06592(Continuation<? super C06592> continuation) {
            super(2, continuation);
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C06592(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        @Nullable
        public final Object invoke(@NotNull ScrollScope scrollScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C06592) create(scrollScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final Object scrollBy(@NotNull ScrollableState scrollableState, float f, @NotNull Continuation<? super Float> continuation) {
        ...
        if (continuation instanceof C06571) {
            ...
            int i = c06571.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c06571.label = i - Integer.MIN_VALUE;
            } else {
        ...
        C06571 c06572 = c06571;
        Object obj = c06572.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c06572.label;
        if (i2 == 0) {
            ResultKt.throwOnFailure(obj);
            Ref.FloatRef floatRef2 = new Ref.FloatRef();
            C06582 c06582 = new C06582(floatRef2, f, null);
            c06572.L$0 = floatRef2;
            c06572.label = 1;
            if (OooO0o.OooO0o0(scrollableState, null, c06582, c06572, 1, null) == coroutine_suspended) {
                return coroutine_suspended;
            }
            floatRef = floatRef2;
        } else {
            ...
            floatRef = (Ref.FloatRef) c06572.L$0;
            ResultKt.throwOnFailure(obj);
        }
        return Boxing.boxFloat(floatRef.element);
    }
    ...
    public static final Object stopScroll(@NotNull ScrollableState scrollableState, @NotNull MutatePriority mutatePriority, @NotNull Continuation<? super Unit> continuation) {
        Object objScroll = scrollableState.scroll(mutatePriority, new C06592(null), continuation);
