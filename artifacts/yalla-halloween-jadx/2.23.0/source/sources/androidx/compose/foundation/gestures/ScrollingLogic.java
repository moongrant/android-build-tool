...
final class ScrollingLogic {
    ...
    public final long m335dispatchScroll3eAAhYA(@NotNull final ScrollScope dispatchScroll, long j, final int i) {
        ...
        Function1<Offset, Offset> function1 = new Function1<Offset, Offset>() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$dispatchScroll$performScroll$1
            ...
            public /* bridge */ /* synthetic */ Offset invoke(Offset offset) {
                return Offset.m1425boximpl(m346invokeMKHz9U(offset.getPackedValue()));
            }
            ...
            public final long m346invokeMKHz9U(long j2) {
                ...
                long jM2590dispatchPreScrollOzD1aCk = value.m2590dispatchPreScrollOzD1aCk(j2, i);
                long jM1440minusMKHz9U = Offset.m1440minusMKHz9U(j2, jM2590dispatchPreScrollOzD1aCk);
                ScrollingLogic scrollingLogic = this.this$0;
                long jM339reverseIfNeededMKHz9U = scrollingLogic.m339reverseIfNeededMKHz9U(scrollingLogic.m344toOffsettuRUvjQ(dispatchScroll.scrollBy(scrollingLogic.m343toFloatk4lQ0M(scrollingLogic.m339reverseIfNeededMKHz9U(jM1440minusMKHz9U)))));
                return Offset.m1441plusMKHz9U(Offset.m1441plusMKHz9U(jM2590dispatchPreScrollOzD1aCk, jM339reverseIfNeededMKHz9U), value.m2588dispatchPostScrollDzOQY0M(jM339reverseIfNeededMKHz9U, Offset.m1440minusMKHz9U(jM1440minusMKHz9U, jM339reverseIfNeededMKHz9U), i));
            }
        };
        return (this.overscrollEffect == null || !getShouldDispatchOverscroll()) ? function1.invoke(Offset.m1425boximpl(jM340singleAxisOffsetMKHz9U)).getPackedValue() : this.overscrollEffect.mo164applyToScrollRhakbz0(jM340singleAxisOffsetMKHz9U, i, function1);
    }

    /* JADX WARN: Code duplicated, block: B:7:0x0013  */
    @Nullable
    /* JADX INFO: renamed from: doFlingAnimation-QWom1Mo, reason: not valid java name */
    public final Object m336doFlingAnimationQWom1Mo(long j, @NotNull Continuation<? super Velocity> continuation) {
        ...
        return Velocity.m3981boximpl(longRef.element);
    }
    ...
    public final Object m337onDragStoppedsFctU(long j, @NotNull Continuation<? super Unit> continuation) {
        ...
        if (i2 == 0) {
            ...
            long jM341singleAxisVelocityAH228Gc = m341singleAxisVelocityAH228Gc(j);
            ...
            if (this.overscrollEffect == null || !getShouldDispatchOverscroll()) {
                Velocity velocityM3981boximpl = Velocity.m3981boximpl(jM341singleAxisVelocityAH228Gc);
                scrollingLogic$onDragStopped$1.L$0 = this;
                scrollingLogic$onDragStopped$1.label = 2;
                if (scrollingLogic$onDragStopped$performFling$1.invoke(velocityM3981boximpl, scrollingLogic$onDragStopped$1) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                ...
                if (overscrollEffect.mo163applyToFlingBMRW4eQ(jM341singleAxisVelocityAH228Gc, scrollingLogic$onDragStopped$performFling$1, scrollingLogic$onDragStopped$1) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
            scrollingLogic = this;
    ...
    public final long m338performRawScrollMKHz9U(long scroll) {
        return this.scrollableState.isScrollInProgress() ? Offset.INSTANCE.m1452getZeroF1C5BW0() : m344toOffsettuRUvjQ(reverseIfNeeded(this.scrollableState.dispatchRawDelta(reverseIfNeeded(m343toFloatk4lQ0M(scroll)))));
    }
    ...
    public final long m339reverseIfNeededMKHz9U(long j) {
        return this.reverseDirection ? Offset.m1443timestuRUvjQ(j, -1.0f) : j;
    }
    ...
    public final long m340singleAxisOffsetMKHz9U(long j) {
        return this.orientation == Orientation.Horizontal ? Offset.m1430copydBAh8RU$default(j, 0.0f, 0.0f, 1, null) : Offset.m1430copydBAh8RU$default(j, 0.0f, 0.0f, 2, null);
    }
    ...
    public final long m341singleAxisVelocityAH228Gc(long j) {
        return this.orientation == Orientation.Horizontal ? Velocity.m3986copyOhffZ5M$default(j, 0.0f, 0.0f, 1, null) : Velocity.m3986copyOhffZ5M$default(j, 0.0f, 0.0f, 2, null);
    }
    ...
    public final long m345updateQWom1Mo(long j, float f) {
        return this.orientation == Orientation.Horizontal ? Velocity.m3986copyOhffZ5M$default(j, f, 0.0f, 2, null) : Velocity.m3986copyOhffZ5M$default(j, 0.0f, f, 1, null);
    }
}
