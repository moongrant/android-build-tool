...
public final class SnapFlingBehaviorKt {
    ...
    private static final float MinFlingVelocityDp = Dp.m3765constructorimpl(400);
    ...
    public static final class C06731 extends ContinuationImpl {
        float F$0;
        float F$1;
        Object L$0;
        Object L$1;
        ...
        public C06731(Continuation<? super C06731> continuation) {
            super(continuation);
        }
    ...
    public static final class C06751 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C06751(Continuation<? super C06751> continuation) {
            super(continuation);
        }
    ...
    public static final Object animateSnap(final ScrollScope scrollScope, float f, final float f2, AnimationState<Float, AnimationVector1D> animationState, AnimationSpec<Float> animationSpec, final Function1<? super Float, Unit> function1, Continuation<? super AnimationResult<Float, AnimationVector1D>> continuation) {
        ...
        if (continuation instanceof C06731) {
            ...
            int i = c06731.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c06731.label = i - Integer.MIN_VALUE;
            } else {
        ...
        C06731 c06732 = c06731;
        Object obj = c06732.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c06732.label;
        if (i2 == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            c06732.L$0 = animationState;
            c06732.L$1 = floatRef2;
            f3 = f;
            c06732.F$0 = f3;
            c06732.F$1 = fFloatValue;
            c06732.label = 1;
            if (SuspendAnimationKt.animateTo(animationState, fBoxFloat, animationSpec, !z, function2, c06732) == coroutine_suspended) {
                return coroutine_suspended;
            }
            floatRef = floatRef2;
            f4 = fFloatValue;
            ...
            f4 = c06732.F$1;
            float f5 = c06732.F$0;
            floatRef = (Ref.FloatRef) c06732.L$1;
            AnimationState<Float, AnimationVector1D> animationState3 = (AnimationState) c06732.L$0;
            ResultKt.throwOnFailure(obj);
            f3 = f5;
    ...
    public static final Object approach(ScrollScope scrollScope, float f, float f2, ApproachAnimation<Float, AnimationVector1D> approachAnimation, SnapLayoutInfoProvider snapLayoutInfoProvider, Density density, Function1<? super Float, Unit> function1, Continuation<? super AnimationResult<Float, AnimationVector1D>> continuation) {
        ...
        if (continuation instanceof C06751) {
            ...
            int i = c06751.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c06751.label = i - Integer.MIN_VALUE;
            } else {
        ...
        Object objApproachAnimation = c06752.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c06752.label;
        if (i2 == 0) {
            ...
            c06752.L$0 = snapLayoutInfoProvider;
            c06752.L$1 = density;
            c06752.label = 1;
            objApproachAnimation = approachAnimation.approachAnimation(scrollScope, fBoxFloat, fBoxFloat2, function1, c06752);
            ...
            density = (Density) c06752.L$1;
            snapLayoutInfoProvider = (SnapLayoutInfoProvider) c06752.L$0;
            ResultKt.throwOnFailure(objApproachAnimation);
        }
