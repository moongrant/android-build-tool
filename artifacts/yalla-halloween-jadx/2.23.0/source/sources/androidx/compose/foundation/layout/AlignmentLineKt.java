...
public final class AlignmentLineKt {
    ...
    public static final MeasureResult m359alignmentLineOffsetMeasuretjqqzMA(MeasureScope measureScope, final AlignmentLine alignmentLine, final float f, float f2, Measurable measurable, long j) {
        final Placeable placeableMo2794measureBRTryo0 = measurable.mo2794measureBRTryo0(getHorizontal(alignmentLine) ? Constraints.m3724copyZbe2FdA$default(j, 0, 0, 0, 0, 11, null) : Constraints.m3724copyZbe2FdA$default(j, 0, 0, 0, 0, 14, null));
        int i = placeableMo2794measureBRTryo0.get(alignmentLine);
        if (i == Integer.MIN_VALUE) {
            i = 0;
        }
        int height = getHorizontal(alignmentLine) ? placeableMo2794measureBRTryo0.getHeight() : placeableMo2794measureBRTryo0.getWidth();
        int iM3732getMaxHeightimpl = getHorizontal(alignmentLine) ? Constraints.m3732getMaxHeightimpl(j) : Constraints.m3733getMaxWidthimpl(j);
        Dp.Companion companion = Dp.INSTANCE;
        int i2 = iM3732getMaxHeightimpl - height;
        final int iCoerceIn = RangesKt.coerceIn((!Dp.m3770equalsimpl0(f, companion.m3785getUnspecifiedD9Ej5fM()) ? measureScope.mo318roundToPx0680j_4(f) : 0) - i, 0, i2);
        final int iCoerceIn2 = RangesKt.coerceIn(((!Dp.m3770equalsimpl0(f2, companion.m3785getUnspecifiedD9Ej5fM()) ? measureScope.mo318roundToPx0680j_4(f2) : 0) - height) + i, 0, i2 - iCoerceIn);
        final int width = getHorizontal(alignmentLine) ? placeableMo2794measureBRTryo0.getWidth() : Math.max(placeableMo2794measureBRTryo0.getWidth() + iCoerceIn + iCoerceIn2, Constraints.m3735getMinWidthimpl(j));
        final int iMax = getHorizontal(alignmentLine) ? Math.max(placeableMo2794measureBRTryo0.getHeight() + iCoerceIn + iCoerceIn2, Constraints.m3734getMinHeightimpl(j)) : placeableMo2794measureBRTryo0.getHeight();
        return MeasureScope.CC.OooOOo0(measureScope, width, iMax, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.AlignmentLineKt$alignmentLineOffsetMeasure$1
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                ...
                if (AlignmentLineKt.getHorizontal(alignmentLine)) {
                    ...
                    width2 = !Dp.m3770equalsimpl0(f, Dp.INSTANCE.m3785getUnspecifiedD9Ej5fM()) ? iCoerceIn : (width - iCoerceIn2) - placeableMo2794measureBRTryo0.getWidth();
                }
                if (AlignmentLineKt.getHorizontal(alignmentLine)) {
                    height2 = !Dp.m3770equalsimpl0(f, Dp.INSTANCE.m3785getUnspecifiedD9Ej5fM()) ? iCoerceIn : (iMax - iCoerceIn2) - placeableMo2794measureBRTryo0.getHeight();
                }
                Placeable.PlacementScope.placeRelative$default(layout, placeableMo2794measureBRTryo0, width2, height2, 0.0f, 4, null);
            }
        }, 4, null);
    }
    ...
    public static final Modifier m360paddingFrom4j6BHR0(@NotNull Modifier paddingFrom, @NotNull final AlignmentLine alignmentLine, final float f, final float f2) {
        ...
        return paddingFrom.then(new AlignmentLineOffsetDpElement(alignmentLine, f, f2, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.AlignmentLineKt$paddingFrom-4j6BHR0$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
                ...
                OooO00o.OooO00o(f, inspectorInfo.getProperties(), "before", inspectorInfo).set("after", Dp.m3763boximpl(f2));
            }
    ...
    public static final Modifier m362paddingFromY_r0B1c(@NotNull Modifier paddingFrom, @NotNull final AlignmentLine alignmentLine, final long j, final long j2) {
        Intrinsics.checkNotNullParameter(paddingFrom, "$this$paddingFrom");
        Intrinsics.checkNotNullParameter(alignmentLine, "alignmentLine");
        return paddingFrom.then(new AlignmentLineOffsetTextUnitElement(alignmentLine, j, j2, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.AlignmentLineKt$paddingFrom-Y_r0B1c$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
                androidx.compose.animation.OooOOO0.OooO00o(inspectorInfo, "$this$null", "paddingFrom").set("alignmentLine", alignmentLine);
                inspectorInfo.getProperties().set("before", TextUnit.m3936boximpl(j));
                inspectorInfo.getProperties().set("after", TextUnit.m3936boximpl(j2));
            }
    ...
    public static /* synthetic */ Modifier m363paddingFromY_r0B1c$default(Modifier modifier, AlignmentLine alignmentLine, long j, long j2, int i, Object obj) {
        if ((i & 2) != 0) {
            j = TextUnit.INSTANCE.m3957getUnspecifiedXSAIIZE();
        }
        long j3 = j;
        if ((i & 4) != 0) {
            j2 = TextUnit.INSTANCE.m3957getUnspecifiedXSAIIZE();
        }
    ...
    public static final Modifier m364paddingFromBaselineVpY3zN4(@NotNull Modifier paddingFromBaseline, float f, float f2) {
        Intrinsics.checkNotNullParameter(paddingFromBaseline, "$this$paddingFromBaseline");
        Dp.Companion companion = Dp.INSTANCE;
        return paddingFromBaseline.then(!Dp.m3770equalsimpl0(f, companion.m3785getUnspecifiedD9Ej5fM()) ? m361paddingFrom4j6BHR0$default(Modifier.INSTANCE, androidx.compose.ui.layout.AlignmentLineKt.getFirstBaseline(), f, 0.0f, 4, null) : Modifier.INSTANCE).then(!Dp.m3770equalsimpl0(f2, companion.m3785getUnspecifiedD9Ej5fM()) ? m361paddingFrom4j6BHR0$default(Modifier.INSTANCE, androidx.compose.ui.layout.AlignmentLineKt.getLastBaseline(), 0.0f, f2, 2, null) : Modifier.INSTANCE);
    }
    ...
    public static final Modifier m366paddingFromBaselinewCyjxdI(@NotNull Modifier paddingFromBaseline, long j, long j2) {
        Intrinsics.checkNotNullParameter(paddingFromBaseline, "$this$paddingFromBaseline");
        return paddingFromBaseline.then(!TextUnitKt.m3964isUnspecifiedR2X_6o(j) ? m363paddingFromY_r0B1c$default(Modifier.INSTANCE, androidx.compose.ui.layout.AlignmentLineKt.getFirstBaseline(), j, 0L, 4, null) : Modifier.INSTANCE).then(!TextUnitKt.m3964isUnspecifiedR2X_6o(j2) ? m363paddingFromY_r0B1c$default(Modifier.INSTANCE, androidx.compose.ui.layout.AlignmentLineKt.getLastBaseline(), 0L, j2, 2, null) : Modifier.INSTANCE);
    }
