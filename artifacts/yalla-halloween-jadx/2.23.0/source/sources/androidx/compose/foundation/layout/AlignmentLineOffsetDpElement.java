...
final class AlignmentLineOffsetDpElement extends ModifierNodeElement<AlignmentLineOffsetDpNode> {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetDpElement.alignmentLine) && Dp.m3770equalsimpl0(this.before, alignmentLineOffsetDpElement.before) && Dp.m3770equalsimpl0(this.after, alignmentLineOffsetDpElement.after);
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return Dp.m3771hashCodeimpl(this.after) + androidx.compose.foundation.OooO0o.OooO00o(this.before, this.alignmentLine.hashCode() * 31, 31);
    }
    ...
    private AlignmentLineOffsetDpElement(AlignmentLine alignmentLine, float f, float f2, Function1<? super InspectorInfo, Unit> inspectorInfo) {
        ...
        if (!((f >= 0.0f || Dp.m3770equalsimpl0(f, Dp.INSTANCE.m3785getUnspecifiedD9Ej5fM())) && (f2 >= 0.0f || Dp.m3770equalsimpl0(f2, Dp.INSTANCE.m3785getUnspecifiedD9Ej5fM())))) {
