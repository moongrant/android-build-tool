...
final /* data */ class BoxWithConstraintsScopeImpl implements BoxWithConstraintsScope, BoxScope {
    ...
    public static /* synthetic */ BoxWithConstraintsScopeImpl m419copy0kLqBqw$default(BoxWithConstraintsScopeImpl boxWithConstraintsScopeImpl, Density density, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return boxWithConstraintsScopeImpl.m421copy0kLqBqw(density, j);
    }
    ...
    public final BoxWithConstraintsScopeImpl m421copy0kLqBqw(@NotNull Density density, long constraints) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Intrinsics.areEqual(this.density, boxWithConstraintsScopeImpl.density) && Constraints.m3726equalsimpl0(this.constraints, boxWithConstraintsScopeImpl.constraints);
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getConstraints-msEJaDk */
    public long mo414getConstraintsmsEJaDk() {
        return this.constraints;
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMaxHeight-D9Ej5fM */
    public float mo415getMaxHeightD9Ej5fM() {
        return Constraints.m3728getHasBoundedHeightimpl(mo414getConstraintsmsEJaDk()) ? this.density.mo321toDpu2uoSUM(Constraints.m3732getMaxHeightimpl(mo414getConstraintsmsEJaDk())) : Dp.INSTANCE.m3784getInfinityD9Ej5fM();
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMaxWidth-D9Ej5fM */
    public float mo416getMaxWidthD9Ej5fM() {
        return Constraints.m3729getHasBoundedWidthimpl(mo414getConstraintsmsEJaDk()) ? this.density.mo321toDpu2uoSUM(Constraints.m3733getMaxWidthimpl(mo414getConstraintsmsEJaDk())) : Dp.INSTANCE.m3784getInfinityD9Ej5fM();
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMinHeight-D9Ej5fM */
    public float mo417getMinHeightD9Ej5fM() {
        return this.density.mo321toDpu2uoSUM(Constraints.m3734getMinHeightimpl(mo414getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMinWidth-D9Ej5fM */
    public float mo418getMinWidthD9Ej5fM() {
        return this.density.mo321toDpu2uoSUM(Constraints.m3735getMinWidthimpl(mo414getConstraintsmsEJaDk()));
    }

    public int hashCode() {
        return Constraints.m3736hashCodeimpl(this.constraints) + (this.density.hashCode() * 31);
    }
    ...
    public String toString() {
        return "BoxWithConstraintsScopeImpl(density=" + this.density + ", constraints=" + ((Object) Constraints.m3738toStringimpl(this.constraints)) + ')';
    }
