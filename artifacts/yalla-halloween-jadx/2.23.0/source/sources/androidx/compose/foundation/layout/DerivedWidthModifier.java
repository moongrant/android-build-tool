...
final class DerivedWidthModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public MeasureResult mo27measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j) {
        ...
        final Placeable placeableMo2794measureBRTryo0 = measurable.mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j, iIntValue, iIntValue, 0, 0, 12, null));
        return MeasureScope.CC.OooOOo0(measure, iIntValue, placeableMo2794measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.DerivedWidthModifier$measure$2
            {
                super(1);
            }
