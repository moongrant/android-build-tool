...
final class FixedDpInsets implements WindowInsets {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Dp.m3770equalsimpl0(this.leftDp, fixedDpInsets.leftDp) && Dp.m3770equalsimpl0(this.topDp, fixedDpInsets.topDp) && Dp.m3770equalsimpl0(this.rightDp, fixedDpInsets.rightDp) && Dp.m3770equalsimpl0(this.bottomDp, fixedDpInsets.bottomDp);
    }
    ...
    public int hashCode() {
        return Dp.m3771hashCodeimpl(this.bottomDp) + androidx.compose.foundation.OooO0o.OooO00o(this.rightDp, androidx.compose.foundation.OooO0o.OooO00o(this.topDp, Dp.m3771hashCodeimpl(this.leftDp) * 31, 31), 31);
    }

    @NotNull
    public String toString() {
        return "Insets(left=" + ((Object) Dp.m3776toStringimpl(this.leftDp)) + ", top=" + ((Object) Dp.m3776toStringimpl(this.topDp)) + ", right=" + ((Object) Dp.m3776toStringimpl(this.rightDp)) + ", bottom=" + ((Object) Dp.m3776toStringimpl(this.bottomDp)) + ')';
    }
