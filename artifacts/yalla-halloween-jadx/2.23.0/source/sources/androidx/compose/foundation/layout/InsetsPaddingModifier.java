...
public final class InsetsPaddingModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer, ModifierLocalProvider<WindowInsets> {
    ...
    public MeasureResult mo27measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j) {
        ...
        final Placeable placeableMo2794measureBRTryo0 = measurable.mo2794measureBRTryo0(ConstraintsKt.m3749offsetNN6EwU(j, -right, -bottom));
        return MeasureScope.CC.OooOOo0(measure, ConstraintsKt.m3747constrainWidthK40F9xA(j, placeableMo2794measureBRTryo0.getWidth() + right), ConstraintsKt.m3746constrainHeightK40F9xA(j, placeableMo2794measureBRTryo0.getHeight() + bottom), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.InsetsPaddingModifier$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.place$default(layout, placeableMo2794measureBRTryo0, left, top, 0.0f, 4, null);
            }
        }, 4, null);
    }
