...
final class LimitInsets implements WindowInsets {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Intrinsics.areEqual(this.insets, limitInsets.insets) && WindowInsetsSides.m556equalsimpl0(this.sides, limitInsets.sides);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getBottom(@NotNull Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        if (WindowInsetsSides.m557hasAnybkgdKaI$foundation_layout_release(this.sides, WindowInsetsSides.INSTANCE.m567getBottomJoeWqyM())) {
    ...
    public int getLeft(@NotNull Density density, @NotNull LayoutDirection layoutDirection) {
        ...
        if (WindowInsetsSides.m557hasAnybkgdKaI$foundation_layout_release(this.sides, layoutDirection == LayoutDirection.Ltr ? WindowInsetsSides.INSTANCE.m563getAllowLeftInLtrJoeWqyM$foundation_layout_release() : WindowInsetsSides.INSTANCE.m564getAllowLeftInRtlJoeWqyM$foundation_layout_release())) {
    ...
    public int getRight(@NotNull Density density, @NotNull LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        if (WindowInsetsSides.m557hasAnybkgdKaI$foundation_layout_release(this.sides, layoutDirection == LayoutDirection.Ltr ? WindowInsetsSides.INSTANCE.m565getAllowRightInLtrJoeWqyM$foundation_layout_release() : WindowInsetsSides.INSTANCE.m566getAllowRightInRtlJoeWqyM$foundation_layout_release())) {
    ...
    public int getTop(@NotNull Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        if (WindowInsetsSides.m557hasAnybkgdKaI$foundation_layout_release(this.sides, WindowInsetsSides.INSTANCE.m573getTopJoeWqyM())) {
    ...
    public int hashCode() {
        return WindowInsetsSides.m558hashCodeimpl(this.sides) + (this.insets.hashCode() * 31);
    }

    @NotNull
    public String toString() {
        return "(" + this.insets + " only " + ((Object) WindowInsetsSides.m560toStringimpl(this.sides)) + ')';
    }
