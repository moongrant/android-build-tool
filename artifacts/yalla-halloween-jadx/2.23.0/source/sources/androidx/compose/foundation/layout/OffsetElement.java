...
final class OffsetElement extends ModifierNodeElement<OffsetNode> {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Dp.m3770equalsimpl0(this.x, offsetElement.x) && Dp.m3770equalsimpl0(this.y, offsetElement.y) && this.rtlAware == offsetElement.rtlAware;
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return androidx.compose.foundation.OooO0o.OooO00o(this.y, Dp.m3771hashCodeimpl(this.x) * 31, 31) + (this.rtlAware ? 1231 : 1237);
    }
    ...
    public String toString() {
        ...
        sb.append((Object) Dp.m3776toStringimpl(this.x));
        sb.append(", y=");
        sb.append((Object) Dp.m3776toStringimpl(this.y));
        sb.append(", rtlAware=");
        return androidx.compose.animation.OooO0o.OooO00o(sb, this.rtlAware, ')');
    }
    ...
    public void update(@NotNull OffsetNode node) {
        ...
        node.m440setX0680j_4(this.x);
        node.m441setY0680j_4(this.y);
