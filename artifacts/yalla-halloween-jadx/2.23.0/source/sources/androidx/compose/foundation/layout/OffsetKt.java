...
public final class OffsetKt {
    ...
    public static final Modifier m434absoluteOffsetVpY3zN4(@NotNull Modifier absoluteOffset, final float f, final float f2) {
        ...
        return absoluteOffset.then(new OffsetElement(f, f2, false, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.OffsetKt.absoluteOffset.1
            ...
            /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
                OooO00o.OooO00o(f, androidx.compose.animation.OooOOO0.OooO00o(inspectorInfo, "$this$$receiver", "absoluteOffset"), "x", inspectorInfo).set("y", Dp.m3763boximpl(f2));
            }
    ...
    public static /* synthetic */ Modifier m435absoluteOffsetVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m434absoluteOffsetVpY3zN4(modifier, f, f2);
    }
    ...
    public static final Modifier m436offsetVpY3zN4(@NotNull Modifier offset, final float f, final float f2) {
        ...
        return offset.then(new OffsetElement(f, f2, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.OffsetKt.offset.1
            ...
            /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
                OooO00o.OooO00o(f, androidx.compose.animation.OooOOO0.OooO00o(inspectorInfo, "$this$$receiver", "offset"), "x", inspectorInfo).set("y", Dp.m3763boximpl(f2));
            }
    ...
    public static /* synthetic */ Modifier m437offsetVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m3765constructorimpl(0);
        }
        if ((i & 2) != 0) {
        ...
        return m436offsetVpY3zN4(modifier, f, f2);
    }
}
