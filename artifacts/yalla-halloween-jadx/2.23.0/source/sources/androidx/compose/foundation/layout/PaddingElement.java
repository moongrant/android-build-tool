...
final class PaddingElement extends ModifierNodeElement<PaddingNode> {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return paddingElement != null && Dp.m3770equalsimpl0(this.start, paddingElement.start) && Dp.m3770equalsimpl0(this.top, paddingElement.top) && Dp.m3770equalsimpl0(this.end, paddingElement.end) && Dp.m3770equalsimpl0(this.bottom, paddingElement.bottom) && this.rtlAware == paddingElement.rtlAware;
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return androidx.compose.foundation.OooO0o.OooO00o(this.bottom, androidx.compose.foundation.OooO0o.OooO00o(this.end, androidx.compose.foundation.OooO0o.OooO00o(this.top, Dp.m3771hashCodeimpl(this.start) * 31, 31), 31), 31) + (this.rtlAware ? 1231 : 1237);
    }
    ...
    public final void m465setBottom0680j_4(float f) {
        this.bottom = f;
    }

    /* JADX INFO: renamed from: setEnd-0680j_4, reason: not valid java name */
    public final void m466setEnd0680j_4(float f) {
        this.end = f;
    }
    ...
    public final void m467setStart0680j_4(float f) {
        this.start = f;
    }

    /* JADX INFO: renamed from: setTop-0680j_4, reason: not valid java name */
    public final void m468setTop0680j_4(float f) {
        this.top = f;
    }
    ...
    private PaddingElement(float f, float f2, float f3, float f4, boolean z, Function1<? super InspectorInfo, Unit> inspectorInfo) {
        ...
        if (f >= 0.0f || Dp.m3770equalsimpl0(f, Dp.INSTANCE.m3785getUnspecifiedD9Ej5fM())) {
            float f5 = this.top;
            if (f5 >= 0.0f || Dp.m3770equalsimpl0(f5, Dp.INSTANCE.m3785getUnspecifiedD9Ej5fM())) {
                float f6 = this.end;
                if (f6 >= 0.0f || Dp.m3770equalsimpl0(f6, Dp.INSTANCE.m3785getUnspecifiedD9Ej5fM())) {
                    float f7 = this.bottom;
                    if (f7 >= 0.0f || Dp.m3770equalsimpl0(f7, Dp.INSTANCE.m3785getUnspecifiedD9Ej5fM())) {
                        z2 = true;
                    } else {
                        z2 = false;
                    }
    ...
    public void update(@NotNull PaddingNode node) {
        ...
        node.m487setStart0680j_4(this.start);
        node.m488setTop0680j_4(this.top);
        node.m486setEnd0680j_4(this.end);
        node.m485setBottom0680j_4(this.bottom);
    ...
    public /* synthetic */ PaddingElement(float f, float f2, float f3, float f4, boolean z, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m3765constructorimpl(0) : f, (i & 2) != 0 ? Dp.m3765constructorimpl(0) : f2, (i & 4) != 0 ? Dp.m3765constructorimpl(0) : f3, (i & 8) != 0 ? Dp.m3765constructorimpl(0) : f4, z, function1, null);
    }
}
