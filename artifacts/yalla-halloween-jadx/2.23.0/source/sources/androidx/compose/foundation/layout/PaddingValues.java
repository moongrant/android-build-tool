...
public interface PaddingValues {
    ...
    public static final class Absolute implements PaddingValues {
        ...
        private static /* synthetic */ void m489getBottomD9Ej5fM$annotations() {
        }

        @Stable
        /* JADX INFO: renamed from: getLeft-D9Ej5fM$annotations, reason: not valid java name */
        private static /* synthetic */ void m490getLeftD9Ej5fM$annotations() {
        }

        @Stable
        /* JADX INFO: renamed from: getRight-D9Ej5fM$annotations, reason: not valid java name */
        private static /* synthetic */ void m491getRightD9Ej5fM$annotations() {
        }

        @Stable
        /* JADX INFO: renamed from: getTop-D9Ej5fM$annotations, reason: not valid java name */
        private static /* synthetic */ void m492getTopD9Ej5fM$annotations() {
        }
        ...
        public float mo427calculateLeftPaddingu2uoSUM(@NotNull LayoutDirection layoutDirection) {
        ...
        public float mo428calculateRightPaddingu2uoSUM(@NotNull LayoutDirection layoutDirection) {
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            return this.right;
        }
        ...
        public boolean equals(@Nullable Object other) {
            ...
            return Dp.m3770equalsimpl0(this.left, absolute.left) && Dp.m3770equalsimpl0(this.top, absolute.top) && Dp.m3770equalsimpl0(this.right, absolute.right) && Dp.m3770equalsimpl0(this.bottom, absolute.bottom);
        }

        public int hashCode() {
            return Dp.m3771hashCodeimpl(this.bottom) + androidx.compose.foundation.OooO0o.OooO00o(this.right, androidx.compose.foundation.OooO0o.OooO00o(this.top, Dp.m3771hashCodeimpl(this.left) * 31, 31), 31);
        }

        @NotNull
        public String toString() {
            return "PaddingValues.Absolute(left=" + ((Object) Dp.m3776toStringimpl(this.left)) + ", top=" + ((Object) Dp.m3776toStringimpl(this.top)) + ", right=" + ((Object) Dp.m3776toStringimpl(this.right)) + ", bottom=" + ((Object) Dp.m3776toStringimpl(this.bottom)) + ')';
        }
        ...
        public /* synthetic */ Absolute(float f, float f2, float f3, float f4, int i, DefaultConstructorMarker defaultConstructorMarker) {
            this((i & 1) != 0 ? Dp.m3765constructorimpl(0) : f, (i & 2) != 0 ? Dp.m3765constructorimpl(0) : f2, (i & 4) != 0 ? Dp.m3765constructorimpl(0) : f3, (i & 8) != 0 ? Dp.m3765constructorimpl(0) : f4, null);
        }
    }
    ...
    /* JADX INFO: renamed from: calculateLeftPadding-u2uoSUM */
    float mo427calculateLeftPaddingu2uoSUM(@NotNull LayoutDirection layoutDirection);

    /* JADX INFO: renamed from: calculateRightPadding-u2uoSUM */
    float mo428calculateRightPaddingu2uoSUM(@NotNull LayoutDirection layoutDirection);
