...
final class PaddingValuesModifier extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo248measure3p2s80s(@NotNull final MeasureScope measure, @NotNull Measurable measurable, long j) {
        ...
        boolean z = false;
        float f = 0;
        if (Dp.m3764compareTo0680j_4(this.paddingValues.mo427calculateLeftPaddingu2uoSUM(measure.getLayoutDirection()), Dp.m3765constructorimpl(f)) >= 0 && Dp.m3764compareTo0680j_4(this.paddingValues.getTop(), Dp.m3765constructorimpl(f)) >= 0 && Dp.m3764compareTo0680j_4(this.paddingValues.mo428calculateRightPaddingu2uoSUM(measure.getLayoutDirection()), Dp.m3765constructorimpl(f)) >= 0 && Dp.m3764compareTo0680j_4(this.paddingValues.getBottom(), Dp.m3765constructorimpl(f)) >= 0) {
            z = true;
        }
        if (!z) {
            throw new IllegalArgumentException("Padding must be non-negative".toString());
        }
        int iMo318roundToPx0680j_4 = measure.mo318roundToPx0680j_4(this.paddingValues.mo428calculateRightPaddingu2uoSUM(measure.getLayoutDirection())) + measure.mo318roundToPx0680j_4(this.paddingValues.mo427calculateLeftPaddingu2uoSUM(measure.getLayoutDirection()));
        int iMo318roundToPx0680j_5 = measure.mo318roundToPx0680j_4(this.paddingValues.getBottom()) + measure.mo318roundToPx0680j_4(this.paddingValues.getTop());
        ...
        return MeasureScope.CC.OooOOo0(measure, ConstraintsKt.m3747constrainWidthK40F9xA(j, placeableMo2794measureBRTryo0.getWidth() + iMo318roundToPx0680j_4), ConstraintsKt.m3746constrainHeightK40F9xA(j, placeableMo2794measureBRTryo0.getHeight() + iMo318roundToPx0680j_5), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.PaddingValuesModifier$measure$2
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.place$default(layout, placeableMo2794measureBRTryo0, measure.mo318roundToPx0680j_4(this.getPaddingValues().mo427calculateLeftPaddingu2uoSUM(measure.getLayoutDirection())), measure.mo318roundToPx0680j_4(this.getPaddingValues().getTop()), 0.0f, 4, null);
            }
        }, 4, null);
    }
