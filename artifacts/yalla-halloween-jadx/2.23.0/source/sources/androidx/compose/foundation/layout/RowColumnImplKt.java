    ...
    public static final MeasurePolicy m501rowColumnMeasurePolicyTDGSqEk(@NotNull final LayoutOrientation orientation, @NotNull final Function5<? super Integer, ? super int[], ? super LayoutDirection, ? super Density, ? super int[], Unit> arrangement, final float f, @NotNull final SizeMode crossAxisSize, @NotNull final CrossAxisAlignment crossAxisAlignment) {
        ...
        return new MeasurePolicy() { // from class: androidx.compose.foundation.layout.RowColumnImplKt$rowColumnMeasurePolicy$1
            ...
            public int maxIntrinsicHeight(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull List<? extends IntrinsicMeasurable> measurables, int i) {
                ...
                return ((Number) RowColumnImplKt.MaxIntrinsicHeightMeasureBlock(orientation).invoke(measurables, Integer.valueOf(i), Integer.valueOf(intrinsicMeasureScope.mo318roundToPx0680j_4(f)))).intValue();
            }
            ...
            public int maxIntrinsicWidth(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull List<? extends IntrinsicMeasurable> measurables, int i) {
                Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                return ((Number) RowColumnImplKt.MaxIntrinsicWidthMeasureBlock(orientation).invoke(measurables, Integer.valueOf(i), Integer.valueOf(intrinsicMeasureScope.mo318roundToPx0680j_4(f)))).intValue();
            }
            ...
            public MeasureResult mo3measure3p2s80s(@NotNull final MeasureScope measure, @NotNull List<? extends Measurable> measurables, long j) {
                ...
                final RowColumnMeasureHelperResult rowColumnMeasureHelperResultM503measureWithoutPlacing_EkL_Y = rowColumnMeasurementHelper.m503measureWithoutPlacing_EkL_Y(measure, j, 0, measurables.size());
                if (orientation == LayoutOrientation.Horizontal) {
                    crossAxisSize2 = rowColumnMeasureHelperResultM503measureWithoutPlacing_EkL_Y.getMainAxisSize();
                    mainAxisSize = rowColumnMeasureHelperResultM503measureWithoutPlacing_EkL_Y.getCrossAxisSize();
                } else {
                    crossAxisSize2 = rowColumnMeasureHelperResultM503measureWithoutPlacing_EkL_Y.getCrossAxisSize();
                    mainAxisSize = rowColumnMeasureHelperResultM503measureWithoutPlacing_EkL_Y.getMainAxisSize();
                }
                return MeasureScope.CC.OooOOo0(measure, crossAxisSize2, mainAxisSize, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.RowColumnImplKt$rowColumnMeasurePolicy$1$measure$1
                    ...
                    public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                        ...
                        rowColumnMeasurementHelper.placeHelper(layout, rowColumnMeasureHelperResultM503measureWithoutPlacing_EkL_Y, 0, measure.getLayoutDirection());
                    }
                }, 4, null);
            }
            ...
            public int minIntrinsicHeight(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull List<? extends IntrinsicMeasurable> measurables, int i) {
                Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                return ((Number) RowColumnImplKt.MinIntrinsicHeightMeasureBlock(orientation).invoke(measurables, Integer.valueOf(i), Integer.valueOf(intrinsicMeasureScope.mo318roundToPx0680j_4(f)))).intValue();
            }
            ...
            public int minIntrinsicWidth(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull List<? extends IntrinsicMeasurable> measurables, int i) {
                Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                return ((Number) RowColumnImplKt.MinIntrinsicWidthMeasureBlock(orientation).invoke(measurables, Integer.valueOf(i), Integer.valueOf(intrinsicMeasureScope.mo318roundToPx0680j_4(f)))).intValue();
            }
        };
    }
}
