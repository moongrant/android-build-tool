...
public final class SpacerKt {
    ...
    public static final void Spacer(@NotNull Modifier modifier, @Nullable Composer composer, int i) {
        if (androidx.compose.animation.OooOOO.OooO00o(modifier, "modifier", composer, -72882467)) {
        ...
        Updater.m1316setimpl(composerM1309constructorimpl, spacerMeasurePolicy, companion.getSetMeasurePolicy());
        ...
        function3ModifierMaterializerOf.invoke(SkippableUpdater.m1300boximpl(SkippableUpdater.m1301constructorimpl(composer)), composer, Integer.valueOf((i2 >> 3) & 112));
