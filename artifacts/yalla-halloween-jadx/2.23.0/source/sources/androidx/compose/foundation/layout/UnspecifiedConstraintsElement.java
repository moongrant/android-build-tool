...
final class UnspecifiedConstraintsElement extends ModifierNodeElement<UnspecifiedConstraintsNode> {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Dp.m3770equalsimpl0(this.minWidth, unspecifiedConstraintsElement.minWidth) && Dp.m3770equalsimpl0(this.minHeight, unspecifiedConstraintsElement.minHeight);
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return Dp.m3771hashCodeimpl(this.minHeight) + (Dp.m3771hashCodeimpl(this.minWidth) * 31);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void inspectableProperties(@NotNull InspectorInfo inspectorInfo) {
        OooO00o.OooO00o(this.minWidth, androidx.compose.animation.OooOOO0.OooO00o(inspectorInfo, "<this>", "defaultMinSize"), "minWidth", inspectorInfo).set("minHeight", Dp.m3763boximpl(this.minHeight));
    }
