...
final class UnspecifiedConstraintsNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public int maxIntrinsicHeight(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull IntrinsicMeasurable measurable, int i) {
        ...
        return RangesKt.coerceAtLeast(measurable.maxIntrinsicHeight(i), !Dp.m3770equalsimpl0(this.minHeight, Dp.INSTANCE.m3785getUnspecifiedD9Ej5fM()) ? intrinsicMeasureScope.mo318roundToPx0680j_4(this.minHeight) : 0);
    }
    ...
    public int maxIntrinsicWidth(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull IntrinsicMeasurable measurable, int i) {
        Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return RangesKt.coerceAtLeast(measurable.maxIntrinsicWidth(i), !Dp.m3770equalsimpl0(this.minWidth, Dp.INSTANCE.m3785getUnspecifiedD9Ej5fM()) ? intrinsicMeasureScope.mo318roundToPx0680j_4(this.minWidth) : 0);
    }
    ...
    public MeasureResult mo248measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j) {
        ...
        final Placeable placeableMo2794measureBRTryo0 = measurable.mo2794measureBRTryo0(ConstraintsKt.Constraints((Dp.m3770equalsimpl0(f, companion.m3785getUnspecifiedD9Ej5fM()) || Constraints.m3735getMinWidthimpl(j) != 0) ? Constraints.m3735getMinWidthimpl(j) : RangesKt.coerceAtLeast(RangesKt.coerceAtMost(measure.mo318roundToPx0680j_4(this.minWidth), Constraints.m3733getMaxWidthimpl(j)), 0), Constraints.m3733getMaxWidthimpl(j), (Dp.m3770equalsimpl0(this.minHeight, companion.m3785getUnspecifiedD9Ej5fM()) || Constraints.m3734getMinHeightimpl(j) != 0) ? Constraints.m3734getMinHeightimpl(j) : RangesKt.coerceAtLeast(RangesKt.coerceAtMost(measure.mo318roundToPx0680j_4(this.minHeight), Constraints.m3732getMaxHeightimpl(j)), 0), Constraints.m3732getMaxHeightimpl(j)));
        return MeasureScope.CC.OooOOo0(measure, placeableMo2794measureBRTryo0.getWidth(), placeableMo2794measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.UnspecifiedConstraintsNode$measure$1
            {
                super(1);
            }
    ...
    public int minIntrinsicHeight(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull IntrinsicMeasurable measurable, int i) {
        Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return RangesKt.coerceAtLeast(measurable.minIntrinsicHeight(i), !Dp.m3770equalsimpl0(this.minHeight, Dp.INSTANCE.m3785getUnspecifiedD9Ej5fM()) ? intrinsicMeasureScope.mo318roundToPx0680j_4(this.minHeight) : 0);
    }
    ...
    public int minIntrinsicWidth(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull IntrinsicMeasurable measurable, int i) {
        Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return RangesKt.coerceAtLeast(measurable.minIntrinsicWidth(i), !Dp.m3770equalsimpl0(this.minWidth, Dp.INSTANCE.m3785getUnspecifiedD9Ej5fM()) ? intrinsicMeasureScope.mo318roundToPx0680j_4(this.minWidth) : 0);
    }
    ...
    public /* synthetic */ UnspecifiedConstraintsNode(float f, float f2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.INSTANCE.m3785getUnspecifiedD9Ej5fM() : f, (i & 2) != 0 ? Dp.INSTANCE.m3785getUnspecifiedD9Ej5fM() : f2, null);
    }
