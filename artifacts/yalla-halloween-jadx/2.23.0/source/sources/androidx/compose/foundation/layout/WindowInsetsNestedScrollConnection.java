...
final class WindowInsetsNestedScrollConnection implements NestedScrollConnection, WindowInsetsAnimationControlListener {
    ...
    public final Object m551flinghuYlsQE(long j, float f, boolean z, Continuation<? super Velocity> continuation) throws Throwable {
        ...
        if (i2 == 0) {
            ...
            if (i2 != 1) {
                if (i2 == 2) {
                    ...
                    ResultKt.throwOnFailure(obj);
                    return Velocity.m3981boximpl(windowInsetsNestedScrollConnection2.sideCalculator.mo505consumedVelocityQWom1Mo(j3, floatRef.element));
                }
                if (i2 != 3) {
                ...
                ResultKt.throwOnFailure(obj);
                return Velocity.m3981boximpl(windowInsetsNestedScrollConnection3.sideCalculator.mo505consumedVelocityQWom1Mo(j4, 0.0f));
            }
    ...
    private final long m552scroll8S9VItk(long available, float scrollAmount) {
        Job job = this.animationJob;
        if (job != null) {
            job.cancel((CancellationException) new WindowInsetsAnimationCancelledException());
            this.animationJob = null;
        ...
        if (!(scrollAmount == 0.0f)) {
            if (this.windowInsets.isVisible() != (scrollAmount > 0.0f) || windowInsetsAnimationController != null) {
                if (windowInsetsAnimationController == null) {
                    this.partialConsumption = 0.0f;
                    requestAnimationController();
                    return this.sideCalculator.mo504consumedOffsetsMKHz9U(available);
                }
    ...
    public Object mo331onPostFlingRZ2iAVY(long j, long j2, @NotNull Continuation<? super Velocity> continuation) {
        return m551flinghuYlsQE(j2, this.sideCalculator.showMotion(Velocity.m3990getXimpl(j2), Velocity.m3991getYimpl(j2)), true, continuation);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* JADX INFO: renamed from: onPostScroll-DzOQY0M */
    public long mo332onPostScrollDzOQY0M(long consumed, long available, int source) {
        return m552scroll8S9VItk(available, this.sideCalculator.showMotion(Offset.m1436getXimpl(available), Offset.m1437getYimpl(available)));
    }
    ...
    public Object mo333onPreFlingQWom1Mo(long j, @NotNull Continuation<? super Velocity> continuation) {
        return m551flinghuYlsQE(j, this.sideCalculator.hideMotion(Velocity.m3990getXimpl(j), Velocity.m3991getYimpl(j)), false, continuation);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* JADX INFO: renamed from: onPreScroll-OzD1aCk */
    public long mo334onPreScrollOzD1aCk(long available, int source) {
        return m552scroll8S9VItk(available, this.sideCalculator.hideMotion(Offset.m1436getXimpl(available), Offset.m1437getYimpl(available)));
    }
