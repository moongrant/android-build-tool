...
public final class WindowInsetsSides {
    ...
    public static final class Companion {
        ...
        public final int m563getAllowLeftInLtrJoeWqyM$foundation_layout_release() {
            return WindowInsetsSides.AllowLeftInLtr;
        }

        /* JADX INFO: renamed from: getAllowLeftInRtl-JoeWqyM$foundation_layout_release, reason: not valid java name */
        public final int m564getAllowLeftInRtlJoeWqyM$foundation_layout_release() {
            return WindowInsetsSides.AllowLeftInRtl;
        }

        /* JADX INFO: renamed from: getAllowRightInLtr-JoeWqyM$foundation_layout_release, reason: not valid java name */
        public final int m565getAllowRightInLtrJoeWqyM$foundation_layout_release() {
            return WindowInsetsSides.AllowRightInLtr;
        }

        /* JADX INFO: renamed from: getAllowRightInRtl-JoeWqyM$foundation_layout_release, reason: not valid java name */
        public final int m566getAllowRightInRtlJoeWqyM$foundation_layout_release() {
            return WindowInsetsSides.AllowRightInRtl;
        }

        /* JADX INFO: renamed from: getBottom-JoeWqyM, reason: not valid java name */
        public final int m567getBottomJoeWqyM() {
            return WindowInsetsSides.Bottom;
        }

        /* JADX INFO: renamed from: getEnd-JoeWqyM, reason: not valid java name */
        public final int m568getEndJoeWqyM() {
            return WindowInsetsSides.End;
        }

        /* JADX INFO: renamed from: getHorizontal-JoeWqyM, reason: not valid java name */
        public final int m569getHorizontalJoeWqyM() {
            return WindowInsetsSides.Horizontal;
        }

        /* JADX INFO: renamed from: getLeft-JoeWqyM, reason: not valid java name */
        public final int m570getLeftJoeWqyM() {
            return WindowInsetsSides.Left;
        }

        /* JADX INFO: renamed from: getRight-JoeWqyM, reason: not valid java name */
        public final int m571getRightJoeWqyM() {
            return WindowInsetsSides.Right;
        }

        /* JADX INFO: renamed from: getStart-JoeWqyM, reason: not valid java name */
        public final int m572getStartJoeWqyM() {
            return WindowInsetsSides.Start;
        }

        /* JADX INFO: renamed from: getTop-JoeWqyM, reason: not valid java name */
        public final int m573getTopJoeWqyM() {
            return WindowInsetsSides.Top;
        }

        /* JADX INFO: renamed from: getVertical-JoeWqyM, reason: not valid java name */
        public final int m574getVerticalJoeWqyM() {
            return WindowInsetsSides.Vertical;
        }
    }

    static {
        int iM554constructorimpl = m554constructorimpl(8);
        AllowLeftInLtr = iM554constructorimpl;
        int iM554constructorimpl2 = m554constructorimpl(4);
        AllowRightInLtr = iM554constructorimpl2;
        int iM554constructorimpl3 = m554constructorimpl(2);
        AllowLeftInRtl = iM554constructorimpl3;
        int iM554constructorimpl4 = m554constructorimpl(1);
        AllowRightInRtl = iM554constructorimpl4;
        Start = m559plusgK_yJZ4(iM554constructorimpl, iM554constructorimpl4);
        End = m559plusgK_yJZ4(iM554constructorimpl2, iM554constructorimpl3);
        int iM554constructorimpl5 = m554constructorimpl(16);
        Top = iM554constructorimpl5;
        int iM554constructorimpl6 = m554constructorimpl(32);
        Bottom = iM554constructorimpl6;
        int iM559plusgK_yJZ4 = m559plusgK_yJZ4(iM554constructorimpl, iM554constructorimpl3);
        Left = iM559plusgK_yJZ4;
        int iM559plusgK_yJZ5 = m559plusgK_yJZ4(iM554constructorimpl2, iM554constructorimpl4);
        Right = iM559plusgK_yJZ5;
        Horizontal = m559plusgK_yJZ4(iM559plusgK_yJZ4, iM559plusgK_yJZ5);
        Vertical = m559plusgK_yJZ4(iM554constructorimpl5, iM554constructorimpl6);
    }
    ...
    public static final /* synthetic */ WindowInsetsSides m553boximpl(int i) {
        return new WindowInsetsSides(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m554constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m555equalsimpl(int i, Object obj) {
    ...
    public static final boolean m557hasAnybkgdKaI$foundation_layout_release(int i, int i2) {
        return (i & i2) != 0;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m558hashCodeimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: plus-gK_yJZ4, reason: not valid java name */
    public static final int m559plusgK_yJZ4(int i, int i2) {
        return m554constructorimpl(i | i2);
    }

    @NotNull
    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m560toStringimpl(int i) {
        return oo000o.OooO00o(new StringBuilder("WindowInsetsSides("), m561valueToStringimpl(i), ')');
    }

    /* JADX INFO: renamed from: valueToString-impl, reason: not valid java name */
    private static final String m561valueToStringimpl(int i) {
