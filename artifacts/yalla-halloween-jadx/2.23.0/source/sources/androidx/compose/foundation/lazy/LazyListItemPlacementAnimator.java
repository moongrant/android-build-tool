...
public final class LazyListItemPlacementAnimator {
    ...
    private final void initializeNode(LazyListMeasuredItem item, int mainAxisOffset) {
        long jM584getOffsetBjo55l4 = item.m584getOffsetBjo55l4(0);
        long jM3879copyiSbpLlY$default = item.getIsVertical() ? IntOffset.m3879copyiSbpLlY$default(jM584getOffsetBjo55l4, 0, mainAxisOffset, 1, null) : IntOffset.m3879copyiSbpLlY$default(jM584getOffsetBjo55l4, mainAxisOffset, 0, 2, null);
        int placeablesCount = item.getPlaceablesCount();
        for (int i = 0; i < placeablesCount; i++) {
            LazyLayoutAnimateItemModifierNode node = getNode(item.getParentData(i));
            if (node != null) {
                long jM584getOffsetBjo55l5 = item.m584getOffsetBjo55l4(i);
                long jIntOffset = IntOffsetKt.IntOffset(IntOffset.m3883getXimpl(jM584getOffsetBjo55l5) - IntOffset.m3883getXimpl(jM584getOffsetBjo55l4), IntOffset.m3884getYimpl(jM584getOffsetBjo55l5) - IntOffset.m3884getYimpl(jM584getOffsetBjo55l4));
    ...
    private final void startAnimationsIfNeeded(LazyListMeasuredItem item) {
        ...
        for (int i = 0; i < placeablesCount; i++) {
            LazyLayoutAnimateItemModifierNode node = getNode(item.getParentData(i));
            if (node != null) {
                long jM584getOffsetBjo55l4 = item.m584getOffsetBjo55l4(i);
                long rawOffset = node.getRawOffset();
                if (!IntOffset.m3882equalsimpl0(rawOffset, LazyLayoutAnimateItemModifierNode.INSTANCE.m622getNotInitializednOccac()) && !IntOffset.m3882equalsimpl0(rawOffset, jM584getOffsetBjo55l4)) {
                    node.m618animatePlacementDeltagyyYBs(IntOffsetKt.IntOffset(IntOffset.m3883getXimpl(jM584getOffsetBjo55l4) - IntOffset.m3883getXimpl(rawOffset), IntOffset.m3884getYimpl(jM584getOffsetBjo55l4) - IntOffset.m3884getYimpl(rawOffset)));
                }
                node.m621setRawOffsetgyyYBs(jM584getOffsetBjo55l4);
            }
        }
    }
        ...
        while (i5 < size2) {
            ...
            if (!getHasAnimations(lazyListMeasuredItem2)) {
                ...
                while (i6 < placeablesCount) {
                    ...
                    int i7 = size2;
                    if (node != null && !IntOffset.m3882equalsimpl0(node.getRawOffset(), LazyLayoutAnimateItemModifierNode.INSTANCE.m622getNotInitializednOccac())) {
                        long rawOffset = node.getRawOffset();
                ...
                if (index == -1 || lazyListMeasuredItem2.getIndex() == index) {
                    long jM584getOffsetBjo55l4 = lazyListMeasuredItem2.m584getOffsetBjo55l4(0);
                    initializeNode(lazyListMeasuredItem2, lazyListMeasuredItem2.getIsVertical() ? IntOffset.m3884getYimpl(jM584getOffsetBjo55l4) : IntOffset.m3883getXimpl(jM584getOffsetBjo55l4));
                } else if (index < i3) {
