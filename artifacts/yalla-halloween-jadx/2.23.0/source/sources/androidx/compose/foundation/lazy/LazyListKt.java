        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new Function2<LazyLayoutMeasureScope, Constraints, LazyListMeasureResult>() { // from class: androidx.compose.foundation.lazy.LazyListKt$rememberLazyListMeasurePolicy$1$1
                ...
                public /* bridge */ /* synthetic */ LazyListMeasureResult invoke(LazyLayoutMeasureScope lazyLayoutMeasureScope, Constraints constraints) {
                    return m579invoke0kLqBqw(lazyLayoutMeasureScope, constraints.getValue());
                }

                @NotNull
                /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                public final LazyListMeasureResult m579invoke0kLqBqw(@NotNull final LazyLayoutMeasureScope lazyLayoutMeasureScope, final long j) {
                    int i5;
                    float spacing;
                    long jIntOffset;
                    ...
                    final int i6 = iMo318roundToPx0680j_6 + iMo318roundToPx0680j_7;
                    final int i7 = iMo318roundToPx0680j_4 + iMo318roundToPx0680j_5;
                    boolean z3 = z2;
                    int i8 = z3 ? i6 : i7;
                    if (z3 && !z) {
                        i5 = iMo318roundToPx0680j_6;
                    } else if (z3 && z) {
                        i5 = iMo318roundToPx0680j_7;
                    } else {
                        i5 = (z3 || z) ? iMo318roundToPx0680j_5 : iMo318roundToPx0680j_4;
                    }
                    final int i9 = i8 - i5;
                    final long jM3749offsetNN6EwU = ConstraintsKt.m3749offsetNN6EwU(j, -i7, -i6);
                    ...
                    lazyListItemProviderInvoke.getItemScope().setMaxSize(Constraints.m3733getMaxWidthimpl(jM3749offsetNN6EwU), Constraints.m3732getMaxHeightimpl(jM3749offsetNN6EwU));
                    if (z2) {
                    ...
                    int iM3732getMaxHeightimpl = z2 ? Constraints.m3732getMaxHeightimpl(j) - i6 : Constraints.m3733getMaxWidthimpl(j) - i7;
                    ...
                    final boolean z6 = z;
                    final int i10 = i5;
                    LazyListMeasuredItemProvider lazyListMeasuredItemProvider = new LazyListMeasuredItemProvider(jM3749offsetNN6EwU, z5, lazyListItemProviderInvoke, lazyLayoutMeasureScope, itemCount, iMo318roundToPx0680j_8, horizontal6, vertical6, z6, i10, i9, j2) { // from class: androidx.compose.foundation.lazy.LazyListKt$rememberLazyListMeasurePolicy$1$1$measuredItemProvider$1
...

                        {
                            ...
                            this.$spaceBetweenItems = iMo318roundToPx0680j_8;
                    ...
                    lazyListState.m587setPremeasureConstraintsBRTryo0$foundation_release(lazyListMeasuredItemProvider.getChildConstraints());
                        ...
                        try {
                            ...
                            LazyListMeasureResult lazyListMeasureResultM581measureLazyListCD5nmq0 = LazyListMeasureKt.m581measureLazyListCD5nmq0(itemCount, lazyListMeasuredItemProvider, iM3732getMaxHeightimpl, i5, i9, iMo318roundToPx0680j_8, iUpdateScrollPositionIfTheFirstItemWasMoved$foundation_release, firstVisibleItemScrollOffset, lazyListState.getScrollToBeConsumed(), jM3749offsetNN6EwU, z2, lazyListItemProviderInvoke.getHeaderIndexes(), vertical4, horizontal4, z, lazyLayoutMeasureScope, lazyListState.getPlacementAnimator(), i, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(lazyListItemProviderInvoke, lazyListState.getPinnedItems(), lazyListState.getBeyondBoundsInfo()), new Function3<Integer, Integer, Function1<? super Placeable.PlacementScope, ? extends Unit>, MeasureResult>() { // from class: androidx.compose.foundation.lazy.LazyListKt$rememberLazyListMeasurePolicy$1$1.2
                                ...
                                public final MeasureResult invoke(int i11, int i12, @NotNull Function1<? super Placeable.PlacementScope, Unit> placement) {
                                    ...
                                    return lazyLayoutMeasureScope.layout(ConstraintsKt.m3747constrainWidthK40F9xA(j, i11 + i7), ConstraintsKt.m3746constrainHeightK40F9xA(j, i12 + i6), MapsKt.emptyMap(), placement);
                                }
                            });
                            lazyListState.applyMeasureResult$foundation_release(lazyListMeasureResultM581measureLazyListCD5nmq0);
                            return lazyListMeasureResultM581measureLazyListCD5nmq0;
                        } catch (Throwable th) {
                            snapshotCreateNonObservableSnapshot.restoreCurrent(snapshotMakeCurrent);
                            throw th;
                        }
