...
public final class LazyListMeasureKt {
    ...
    public static final LazyListMeasureResult m581measureLazyListCD5nmq0(int i, @NotNull LazyListMeasuredItemProvider measuredItemProvider, int i2, int i3, int i4, int i5, int i6, int i7, float f, long j, boolean z, @NotNull List<Integer> headerIndexes, @Nullable Arrangement.Vertical vertical, @Nullable Arrangement.Horizontal horizontal, boolean z2, @NotNull Density density, @NotNull LazyListItemPlacementAnimator placementAnimator, int i8, @NotNull List<Integer> pinnedItems, @NotNull Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> layout) {
        ...
        if (i <= 0) {
            return new LazyListMeasureResult(null, 0, false, 0.0f, layout.invoke(Integer.valueOf(Constraints.m3735getMinWidthimpl(j)), Integer.valueOf(Constraints.m3734getMinHeightimpl(j)), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.LazyListMeasureKt$measureLazyList$1
        ...
        int iM3747constrainWidthK40F9xA = ConstraintsKt.m3747constrainWidthK40F9xA(j, z ? iMax4 : sizeWithSpacings5);
        if (z) {
            iMax4 = sizeWithSpacings5;
        }
        int iM3746constrainHeightK40F9xA = ConstraintsKt.m3746constrainHeightK40F9xA(j, iMax4);
        int i43 = sizeWithSpacings5;
        float f3 = f2;
        int i44 = i10;
        final List<LazyListMeasuredItem> listCalculateItemsOffsets = calculateItemsOffsets(arrayDeque, listCreateItemsBeforeList, listCreateItemsAfterList, iM3747constrainWidthK40F9xA, iM3746constrainHeightK40F9xA, i43, i2, i37, z, vertical, horizontal, z2, density);
        LazyListMeasuredItem lazyListMeasuredItem4 = lazyListMeasuredItem2;
        placementAnimator.onMeasured((int) f3, iM3747constrainWidthK40F9xA, iM3746constrainHeightK40F9xA, listCalculateItemsOffsets, measuredItemProvider, z);
        final LazyListMeasuredItem lazyListMeasuredItemFindOrComposeLazyListHeader = headerIndexes.isEmpty() ^ true ? LazyListHeadersKt.findOrComposeLazyListHeader(listCalculateItemsOffsets, measuredItemProvider, headerIndexes, i3, iM3747constrainWidthK40F9xA, iM3746constrainHeightK40F9xA) : null;
        boolean z4 = i44 < i || i43 > i2;
        MeasureResult measureResultInvoke = layout.invoke(Integer.valueOf(iM3747constrainWidthK40F9xA), Integer.valueOf(iM3746constrainHeightK40F9xA), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.LazyListMeasureKt$measureLazyList$5
