...
public final class LazyListMeasuredItem implements LazyListItemInfo {
    ...
    private final long m582copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
    ...
    private final int m583getMainAxisgyyYBs(long j) {
    ...
    public final long m584getOffsetBjo55l4(int index) {
    ...
    public final void place(@NotNull Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < placeablesCount; i++) {
            ...
            long jM584getOffsetBjo55l4 = m584getOffsetBjo55l4(i);
            ...
            if (lazyLayoutAnimateItemModifierNode != null) {
                ...
                long jOooO00o = OooO0o.OooO00o(jM619getPlacementDeltanOccac, IntOffset.m3884getYimpl(jM584getOffsetBjo55l4), IntOffset.m3883getXimpl(jM619getPlacementDeltanOccac) + IntOffset.m3883getXimpl(jM584getOffsetBjo55l4));
                if ((m583getMainAxisgyyYBs(jM584getOffsetBjo55l4) <= mainAxisSize && m583getMainAxisgyyYBs(jOooO00o) <= mainAxisSize) || (m583getMainAxisgyyYBs(jM584getOffsetBjo55l4) >= i2 && m583getMainAxisgyyYBs(jOooO00o) >= i2)) {
                    lazyLayoutAnimateItemModifierNode.cancelAnimation();
                }
                jM584getOffsetBjo55l4 = jOooO00o;
            }
            if (this.reverseLayout) {
                jM584getOffsetBjo55l4 = IntOffsetKt.IntOffset(this.isVertical ? IntOffset.m3883getXimpl(jM584getOffsetBjo55l4) : (this.mainAxisLayoutSize - IntOffset.m3883getXimpl(jM584getOffsetBjo55l4)) - getMainAxisSize(placeable), this.isVertical ? (this.mainAxisLayoutSize - IntOffset.m3884getYimpl(jM584getOffsetBjo55l4)) - getMainAxisSize(placeable) : IntOffset.m3884getYimpl(jM584getOffsetBjo55l4));
            }
            long j = this.visualOffset;
            long jOooO00o2 = OooO0o.OooO00o(j, IntOffset.m3884getYimpl(jM584getOffsetBjo55l4), IntOffset.m3883getXimpl(j) + IntOffset.m3883getXimpl(jM584getOffsetBjo55l4));
            if (this.isVertical) {
