...
public final class LazyListStateKt {
    ...
    public static final LazyListState rememberLazyListState(final int i, final int i2, @Nullable Composer composer, int i3, int i4) {
        ...
        LazyListState lazyListState = (LazyListState) RememberSaveableKt.m1322rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) objRememberedValue, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
