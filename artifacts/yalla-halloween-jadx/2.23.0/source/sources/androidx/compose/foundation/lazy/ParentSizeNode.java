...
final class ParentSizeNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo248measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j) {
        ...
        int iM3735getMinWidthimpl = iRoundToInt != Integer.MAX_VALUE ? iRoundToInt : Constraints.m3735getMinWidthimpl(j);
        int iM3734getMinHeightimpl = iRoundToInt2 != Integer.MAX_VALUE ? iRoundToInt2 : Constraints.m3734getMinHeightimpl(j);
        if (iRoundToInt == Integer.MAX_VALUE) {
            iRoundToInt = Constraints.m3733getMaxWidthimpl(j);
        }
        if (iRoundToInt2 == Integer.MAX_VALUE) {
            iRoundToInt2 = Constraints.m3732getMaxHeightimpl(j);
        }
        final Placeable placeableMo2794measureBRTryo0 = measurable.mo2794measureBRTryo0(ConstraintsKt.Constraints(iM3735getMinWidthimpl, iRoundToInt, iM3734getMinHeightimpl, iRoundToInt2));
        return MeasureScope.CC.OooOOo0(measure, placeableMo2794measureBRTryo0.getWidth(), placeableMo2794measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.ParentSizeNode$measure$1
            {
                super(1);
            }
