...
public final class GridItemSpan {
    ...
    public static final /* synthetic */ GridItemSpan m589boximpl(long j) {
        return new GridItemSpan(j);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m590constructorimpl(long j) {
        return j;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m591equalsimpl(long j, Object obj) {
    ...
    public static final int m593getCurrentLineSpanimpl(long j) {
        return (int) j;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m594hashCodeimpl(long j) {
        return (int) (j ^ (j >>> 32));
    }
    ...
    public boolean equals(Object obj) {
        return m591equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m594hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m595toStringimpl(this.packedValue);
    }
