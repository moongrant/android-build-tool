...
final class GridSlotCache implements Function2<Density, Constraints, LazyGridSlots> {
    ...
    public /* bridge */ /* synthetic */ LazyGridSlots invoke(Density density, Constraints constraints) {
        return m597invoke0kLqBqw(density, constraints.getValue());
    }

    @NotNull
    /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
    public LazyGridSlots m597invoke0kLqBqw(@NotNull Density density, long constraints) {
        Intrinsics.checkNotNullParameter(density, "density");
        if (this.cachedSizes != null && Constraints.m3726equalsimpl0(this.cachedConstraints, constraints)) {
        ...
        LazyGridSlots lazyGridSlotsInvoke = this.calculation.invoke(density, Constraints.m3721boximpl(constraints));
