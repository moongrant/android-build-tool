...
public abstract class LazyGridMeasuredItemProvider {
    ...
    public static /* synthetic */ LazyGridMeasuredItem m612getAndMeasure3p2s80s$default(LazyGridMeasuredItemProvider lazyGridMeasuredItemProvider, int i, int i2, long j, int i3, Object obj) {
        if (obj != null) {
        ...
        return lazyGridMeasuredItemProvider.m613getAndMeasure3p2s80s(i, i2, j);
    }
    ...
    public final LazyGridMeasuredItem m613getAndMeasure3p2s80s(int index, int mainAxisSpacing, long constraints) {
        ...
        List<Placeable> listMo632measure0kLqBqw = this.measureScope.mo632measure0kLqBqw(index, constraints);
        if (Constraints.m3731getHasFixedWidthimpl(constraints)) {
            iM3734getMinHeightimpl = Constraints.m3735getMinWidthimpl(constraints);
        } else {
            if (!Constraints.m3730getHasFixedHeightimpl(constraints)) {
                throw new IllegalArgumentException("Failed requirement.".toString());
            }
            iM3734getMinHeightimpl = Constraints.m3734getMinHeightimpl(constraints);
        }
        return createItem(index, key, contentType, iM3734getMinHeightimpl, mainAxisSpacing, listMo632measure0kLqBqw);
    }
