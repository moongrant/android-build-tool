...
public final class LazyLayoutAnimateItemModifierNode extends Modifier.Node {
    ...
    public static final class Companion {
        ...
        public final long m622getNotInitializednOccac() {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                ...
                IntOffset intOffsetM3874boximpl = IntOffset.m3874boximpl(IntOffset.INSTANCE.m3893getZeronOccac());
                this.label = 1;
            ...
            LazyLayoutAnimateItemModifierNode.this.m617setPlacementDeltagyyYBs(IntOffset.INSTANCE.m3893getZeronOccac());
    ...
    public LazyLayoutAnimateItemModifierNode(@NotNull FiniteAnimationSpec<IntOffset> placementAnimationSpec) {
        ...
        this.placementDeltaAnimation = new Animatable<>(IntOffset.m3874boximpl(companion.m3893getZeronOccac()), VectorConvertersKt.getVectorConverter(companion), null, null, 12, null);
        this.placementDelta = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m3874boximpl(companion.m3893getZeronOccac()), null, 2, null);
    }
    ...
    public final void m617setPlacementDeltagyyYBs(long j) {
        this.placementDelta.setValue(IntOffset.m3874boximpl(j));
    }

    /* JADX INFO: renamed from: animatePlacementDelta--gyyYBs, reason: not valid java name */
    public final void m618animatePlacementDeltagyyYBs(long delta) {
        long jM619getPlacementDeltanOccac = m619getPlacementDeltanOccac();
        long jIntOffset = IntOffsetKt.IntOffset(IntOffset.m3883getXimpl(jM619getPlacementDeltanOccac) - IntOffset.m3883getXimpl(delta), IntOffset.m3884getYimpl(jM619getPlacementDeltanOccac) - IntOffset.m3884getYimpl(delta));
        m617setPlacementDeltagyyYBs(jIntOffset);
    ...
    public final long m619getPlacementDeltanOccac() {
    ...
    public void onDetach() {
        m617setPlacementDeltagyyYBs(IntOffset.INSTANCE.m3893getZeronOccac());
    ...
    public final void m621setRawOffsetgyyYBs(long j) {
        this.rawOffset = j;
    }
}
