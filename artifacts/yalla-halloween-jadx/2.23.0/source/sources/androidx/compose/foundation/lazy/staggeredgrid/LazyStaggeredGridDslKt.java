...
public final class LazyStaggeredGridDslKt {
    ...
    public static final class C071310 extends Lambda implements Function4<LazyStaggeredGridItemScope, Integer, Composer, Integer, Unit> {
        final /* synthetic */ Function5<LazyStaggeredGridItemScope, Integer, T, Composer, Integer, Unit> $itemContent;
        final /* synthetic */ T[] $items;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C071310(Function5<? super LazyStaggeredGridItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> function5, T[] tArr) {
            super(4);
    ...
    public static final class C07143 extends Lambda implements Function1<Integer, Object> {
        final /* synthetic */ Function2<Integer, T, Object> $contentType;
        final /* synthetic */ List<T> $items;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C07143(Function2<? super Integer, ? super T, ? extends Object> function2, List<? extends T> list) {
            super(1);
    ...
    public static final class C07155 extends Lambda implements Function4<LazyStaggeredGridItemScope, Integer, Composer, Integer, Unit> {
        final /* synthetic */ Function5<LazyStaggeredGridItemScope, Integer, T, Composer, Integer, Unit> $itemContent;
        final /* synthetic */ List<T> $items;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C07155(Function5<? super LazyStaggeredGridItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> function5, List<? extends T> list) {
            super(4);
            this.$itemContent = function5;
            this.$items = list;
        }
    ...
    public static final class C07178 extends Lambda implements Function1<Integer, Object> {
        final /* synthetic */ Function2<Integer, T, Object> $contentType;
        final /* synthetic */ T[] $items;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C07178(Function2<? super Integer, ? super T, ? extends Object> function2, T[] tArr) {
            super(1);
            this.$contentType = function2;
            this.$items = tArr;
        }
    ...
    public static final void m644LazyHorizontalStaggeredGridcJHQLPU(@NotNull final StaggeredGridCells rows, @Nullable Modifier modifier, @Nullable LazyStaggeredGridState lazyStaggeredGridState, @Nullable PaddingValues paddingValues, boolean z, @Nullable Arrangement.Vertical vertical, float f, @Nullable FlingBehavior flingBehavior, boolean z2, @NotNull final Function1<? super LazyStaggeredGridScope, Unit> content, @Nullable Composer composer, final int i, final int i2) {
        ...
        Arrangement.Vertical verticalM390spacedBy0680j_4;
        ...
        if (i16 == 0) {
            ...
            if (i5 != 0) {
                ...
                if (i7 != 0) {
                    ...
                    if ((i2 & ConstantsKt.MINIMUM_BLOCK_SIZE) != 0) {
                        ...
                        if (i4 != 4 && (1533916891 & i3) == 306783378 && composerStartRestartGroup.getSkipping()) {
                            ...
                            if ((i & 1) != 0 || composerStartRestartGroup.getDefaultsInvalid()) {
                                ...
                                if (i9 != 0) {
                                    verticalM390spacedBy0680j_4 = Arrangement.INSTANCE.m390spacedBy0680j_4(Dp.m3765constructorimpl(0));
                                } else {
                                    verticalM390spacedBy0680j_4 = vertical2;
                                }
                                if (i11 != 0) {
                                ...
                                modifier3 = modifier2;
                                vertical2 = verticalM390spacedBy0680j_4;
                            ...
                            LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i17 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i17 & 29360128) | (i18 & 7168) | 56 | (57344 & i19) | (i19 & 458752) | (i17 & 3670016) | (i18 & 234881024), (i3 >> 27) & 14, 0);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                            }
                            modifier4 = modifier3;
                        ...
                        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridDslKt$LazyHorizontalStaggeredGrid$1
                            ...
                            public final void invoke(@Nullable Composer composer2, int i20) {
                                LazyStaggeredGridDslKt.m644LazyHorizontalStaggeredGridcJHQLPU(rows, modifier4, lazyStaggeredGridState3, paddingValues4, z6, vertical3, f2, flingBehavior4, z7, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                            }
                        });
                    }
                    i15 = 805306368;
                    ...
                    if (i4 != 4) {
                        ...
                        LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i110 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i110 & 29360128) | (i111 & 7168) | 56 | (57344 & i112) | (i112 & 458752) | (i110 & 3670016) | (i111 & 234881024), (i3 >> 27) & 14, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                        modifier4 = modifier3;
                        ...
                        LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i113 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i113 & 29360128) | (i114 & 7168) | 56 | (57344 & i115) | (i115 & 458752) | (i113 & 3670016) | (i114 & 234881024), (i3 >> 27) & 14, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                        modifier4 = modifier3;
                ...
                if ((i2 & ConstantsKt.MINIMUM_BLOCK_SIZE) != 0) {
                    ...
                    if (i4 != 4) {
                        ...
                        LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i116 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i116 & 29360128) | (i117 & 7168) | 56 | (57344 & i118) | (i118 & 458752) | (i116 & 3670016) | (i117 & 234881024), (i3 >> 27) & 14, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                        modifier4 = modifier3;
                        ...
                        LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i119 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i119 & 29360128) | (i1110 & 7168) | 56 | (57344 & i1111) | (i1111 & 458752) | (i119 & 3670016) | (i1110 & 234881024), (i3 >> 27) & 14, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                        modifier4 = modifier3;
                ...
                if (i4 != 4) {
                    ...
                    LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i1112 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i1112 & 29360128) | (i1113 & 7168) | 56 | (57344 & i1114) | (i1114 & 458752) | (i1112 & 3670016) | (i1113 & 234881024), (i3 >> 27) & 14, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
                    ...
                    LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i1115 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i1115 & 29360128) | (i1116 & 7168) | 56 | (57344 & i1117) | (i1117 & 458752) | (i1115 & 3670016) | (i1116 & 234881024), (i3 >> 27) & 14, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
            ...
            if (i7 != 0) {
                ...
                if ((i2 & ConstantsKt.MINIMUM_BLOCK_SIZE) != 0) {
                    ...
                    if (i4 != 4) {
                        ...
                        LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i1118 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i1118 & 29360128) | (i1119 & 7168) | 56 | (57344 & i11110) | (i11110 & 458752) | (i1118 & 3670016) | (i1119 & 234881024), (i3 >> 27) & 14, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                        modifier4 = modifier3;
                        ...
                        LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i11111 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i11111 & 29360128) | (i11112 & 7168) | 56 | (57344 & i11113) | (i11113 & 458752) | (i11111 & 3670016) | (i11112 & 234881024), (i3 >> 27) & 14, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                        modifier4 = modifier3;
                ...
                if (i4 != 4) {
                    ...
                    LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i11114 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i11114 & 29360128) | (i11115 & 7168) | 56 | (57344 & i11116) | (i11116 & 458752) | (i11114 & 3670016) | (i11115 & 234881024), (i3 >> 27) & 14, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
                    ...
                    LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i11117 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i11117 & 29360128) | (i11118 & 7168) | 56 | (57344 & i11119) | (i11119 & 458752) | (i11117 & 3670016) | (i11118 & 234881024), (i3 >> 27) & 14, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
            ...
            if ((i2 & ConstantsKt.MINIMUM_BLOCK_SIZE) != 0) {
                ...
                if (i4 != 4) {
                    ...
                    LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i111110 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i111110 & 29360128) | (i111111 & 7168) | 56 | (57344 & i111112) | (i111112 & 458752) | (i111110 & 3670016) | (i111111 & 234881024), (i3 >> 27) & 14, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
                    ...
                    LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i111113 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i111113 & 29360128) | (i111114 & 7168) | 56 | (57344 & i111115) | (i111115 & 458752) | (i111113 & 3670016) | (i111114 & 234881024), (i3 >> 27) & 14, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
            ...
            if (i4 != 4) {
                ...
                LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i111116 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i111116 & 29360128) | (i111117 & 7168) | 56 | (57344 & i111118) | (i111118 & 458752) | (i111116 & 3670016) | (i111117 & 234881024), (i3 >> 27) & 14, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier4 = modifier3;
                ...
                LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i111119 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i111119 & 29360128) | (i1111110 & 7168) | 56 | (57344 & i1111111) | (i1111111 & 458752) | (i111119 & 3670016) | (i1111110 & 234881024), (i3 >> 27) & 14, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier4 = modifier3;
        ...
        if (i5 != 0) {
            ...
            if (i7 != 0) {
                ...
                if ((i2 & ConstantsKt.MINIMUM_BLOCK_SIZE) != 0) {
                    ...
                    if (i4 != 4) {
                        ...
                        LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i1111112 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i1111112 & 29360128) | (i1111113 & 7168) | 56 | (57344 & i1111114) | (i1111114 & 458752) | (i1111112 & 3670016) | (i1111113 & 234881024), (i3 >> 27) & 14, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                        modifier4 = modifier3;
                        ...
                        LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i1111115 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i1111115 & 29360128) | (i1111116 & 7168) | 56 | (57344 & i1111117) | (i1111117 & 458752) | (i1111115 & 3670016) | (i1111116 & 234881024), (i3 >> 27) & 14, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                        modifier4 = modifier3;
                ...
                if (i4 != 4) {
                    ...
                    LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i1111118 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i1111118 & 29360128) | (i1111119 & 7168) | 56 | (57344 & i11111110) | (i11111110 & 458752) | (i1111118 & 3670016) | (i1111119 & 234881024), (i3 >> 27) & 14, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
                    ...
                    LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i11111111 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i11111111 & 29360128) | (i11111112 & 7168) | 56 | (57344 & i11111113) | (i11111113 & 458752) | (i11111111 & 3670016) | (i11111112 & 234881024), (i3 >> 27) & 14, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
            ...
            if ((i2 & ConstantsKt.MINIMUM_BLOCK_SIZE) != 0) {
                ...
                if (i4 != 4) {
                    ...
                    LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i11111114 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i11111114 & 29360128) | (i11111115 & 7168) | 56 | (57344 & i11111116) | (i11111116 & 458752) | (i11111114 & 3670016) | (i11111115 & 234881024), (i3 >> 27) & 14, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
                    ...
                    LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i11111117 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i11111117 & 29360128) | (i11111118 & 7168) | 56 | (57344 & i11111119) | (i11111119 & 458752) | (i11111117 & 3670016) | (i11111118 & 234881024), (i3 >> 27) & 14, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
            ...
            if (i4 != 4) {
                ...
                LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i111111110 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i111111110 & 29360128) | (i111111111 & 7168) | 56 | (57344 & i111111112) | (i111111112 & 458752) | (i111111110 & 3670016) | (i111111111 & 234881024), (i3 >> 27) & 14, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier4 = modifier3;
                ...
                LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i111111113 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i111111113 & 29360128) | (i111111114 & 7168) | 56 | (57344 & i111111115) | (i111111115 & 458752) | (i111111113 & 3670016) | (i111111114 & 234881024), (i3 >> 27) & 14, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier4 = modifier3;
        ...
        if (i7 != 0) {
            ...
            if ((i2 & ConstantsKt.MINIMUM_BLOCK_SIZE) != 0) {
                ...
                if (i4 != 4) {
                    ...
                    LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i111111116 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i111111116 & 29360128) | (i111111117 & 7168) | 56 | (57344 & i111111118) | (i111111118 & 458752) | (i111111116 & 3670016) | (i111111117 & 234881024), (i3 >> 27) & 14, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
                    ...
                    LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i111111119 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i111111119 & 29360128) | (i1111111110 & 7168) | 56 | (57344 & i1111111111) | (i1111111111 & 458752) | (i111111119 & 3670016) | (i1111111110 & 234881024), (i3 >> 27) & 14, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
            ...
            if (i4 != 4) {
                ...
                LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i1111111112 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i1111111112 & 29360128) | (i1111111113 & 7168) | 56 | (57344 & i1111111114) | (i1111111114 & 458752) | (i1111111112 & 3670016) | (i1111111113 & 234881024), (i3 >> 27) & 14, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier4 = modifier3;
                ...
                LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i1111111115 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i1111111115 & 29360128) | (i1111111116 & 7168) | 56 | (57344 & i1111111117) | (i1111111117 & 458752) | (i1111111115 & 3670016) | (i1111111116 & 234881024), (i3 >> 27) & 14, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier4 = modifier3;
        ...
        if ((i2 & ConstantsKt.MINIMUM_BLOCK_SIZE) != 0) {
            ...
            if (i4 != 4) {
                ...
                LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i1111111118 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i1111111118 & 29360128) | (i1111111119 & 7168) | 56 | (57344 & i11111111110) | (i11111111110 & 458752) | (i1111111118 & 3670016) | (i1111111119 & 234881024), (i3 >> 27) & 14, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier4 = modifier3;
                ...
                LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i11111111111 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i11111111111 & 29360128) | (i11111111112 & 7168) | 56 | (57344 & i11111111113) | (i11111111113 & 458752) | (i11111111111 & 3670016) | (i11111111112 & 234881024), (i3 >> 27) & 14, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier4 = modifier3;
        ...
        if (i4 != 4) {
            ...
            LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i11111111114 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i11111111114 & 29360128) | (i11111111115 & 7168) | 56 | (57344 & i11111111116) | (i11111111116 & 458752) | (i11111111114 & 3670016) | (i11111111115 & 234881024), (i3 >> 27) & 14, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
            ...
            LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(rows, vertical2, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & 112) | (i11111111117 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, fM3765constructorimpl, vertical2.getSpacing(), content, composerStartRestartGroup, (i11111111117 & 29360128) | (i11111111118 & 7168) | 56 | (57344 & i11111111119) | (i11111111119 & 458752) | (i11111111117 & 3670016) | (i11111111118 & 234881024), (i3 >> 27) & 14, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
    ...
    public static final void m645LazyVerticalStaggeredGridzadm560(@NotNull final StaggeredGridCells columns, @Nullable Modifier modifier, @Nullable LazyStaggeredGridState lazyStaggeredGridState, @Nullable PaddingValues paddingValues, boolean z, float f, @Nullable Arrangement.Horizontal horizontal, @Nullable FlingBehavior flingBehavior, boolean z2, @NotNull final Function1<? super LazyStaggeredGridScope, Unit> content, @Nullable Composer composer, final int i, final int i2) {
        ...
        PaddingValues paddingValuesM469PaddingValues0680j_4;
        float fM3765constructorimpl;
        Arrangement.Horizontal horizontalM390spacedBy0680j_4;
        FlingBehavior flingBehavior2;
        boolean z4;
        LazyStaggeredGridState lazyStaggeredGridState2;
        Modifier modifier3;
        ...
        if (i16 == 0) {
            ...
            if (i5 != 0) {
                ...
                if (i7 != 0) {
                    ...
                    if ((i2 & ConstantsKt.MINIMUM_BLOCK_SIZE) != 0) {
                        ...
                        if (i4 != 4 && (1533916891 & i3) == 306783378 && composerStartRestartGroup.getSkipping()) {
                            ...
                            if ((i & 1) != 0 || composerStartRestartGroup.getDefaultsInvalid()) {
                                ...
                                if (i11 != 0) {
                                    horizontalM390spacedBy0680j_4 = Arrangement.INSTANCE.m390spacedBy0680j_4(Dp.m3765constructorimpl(0));
                                } else {
                                    horizontalM390spacedBy0680j_4 = horizontal;
                                }
                                if ((i2 & 128) != 0) {
                                    flingBehavior2 = ScrollableDefaults.INSTANCE.flingBehavior(composerStartRestartGroup, 6);
                                    i3 &= -29360129;
                            ...
                            int i17 = i3 >> 3;
                            int i18 = i3 << 3;
                            Arrangement.Horizontal horizontal3 = horizontalM390spacedBy0680j_4;
                            PaddingValues paddingValues5 = paddingValues3;
                            LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i17 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i18) | (i18 & 458752) | (i17 & 3670016) | (i17 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                            }
                            modifier4 = modifier3;
                        ...
                        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridDslKt$LazyVerticalStaggeredGrid$1
                            ...
                            public final void invoke(@Nullable Composer composer2, int i19) {
                                LazyStaggeredGridDslKt.m645LazyVerticalStaggeredGridzadm560(columns, modifier4, lazyStaggeredGridState3, paddingValues4, z6, f4, horizontal2, flingBehavior4, z7, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                            }
                        });
                    }
                    i15 = 805306368;
                    ...
                    if (i4 != 4) {
                        ...
                        int i19 = i3 >> 3;
                        int i110 = i3 << 3;
                        Arrangement.Horizontal horizontal4 = horizontalM390spacedBy0680j_4;
                        PaddingValues paddingValues6 = paddingValues3;
                        LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i19 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i110) | (i110 & 458752) | (i19 & 3670016) | (i19 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                        modifier4 = modifier3;
                        ...
                        int i111 = i3 >> 3;
                        int i112 = i3 << 3;
                        Arrangement.Horizontal horizontal5 = horizontalM390spacedBy0680j_4;
                        PaddingValues paddingValues7 = paddingValues3;
                        LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i111 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i112) | (i112 & 458752) | (i111 & 3670016) | (i111 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                        modifier4 = modifier3;
                ...
                if ((i2 & ConstantsKt.MINIMUM_BLOCK_SIZE) != 0) {
                    ...
                    if (i4 != 4) {
                        ...
                        int i113 = i3 >> 3;
                        int i114 = i3 << 3;
                        Arrangement.Horizontal horizontal6 = horizontalM390spacedBy0680j_4;
                        PaddingValues paddingValues8 = paddingValues3;
                        LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i113 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i114) | (i114 & 458752) | (i113 & 3670016) | (i113 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                        modifier4 = modifier3;
                        ...
                        int i115 = i3 >> 3;
                        int i116 = i3 << 3;
                        Arrangement.Horizontal horizontal7 = horizontalM390spacedBy0680j_4;
                        PaddingValues paddingValues9 = paddingValues3;
                        LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i115 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i116) | (i116 & 458752) | (i115 & 3670016) | (i115 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                        modifier4 = modifier3;
                ...
                if (i4 != 4) {
                    ...
                    int i117 = i3 >> 3;
                    int i118 = i3 << 3;
                    Arrangement.Horizontal horizontal8 = horizontalM390spacedBy0680j_4;
                    PaddingValues paddingValues10 = paddingValues3;
                    LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i117 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i118) | (i118 & 458752) | (i117 & 3670016) | (i117 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
                    ...
                    int i119 = i3 >> 3;
                    int i1110 = i3 << 3;
                    Arrangement.Horizontal horizontal9 = horizontalM390spacedBy0680j_4;
                    PaddingValues paddingValues11 = paddingValues3;
                    LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i119 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i1110) | (i1110 & 458752) | (i119 & 3670016) | (i119 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
            ...
            if (i7 != 0) {
                ...
                if ((i2 & ConstantsKt.MINIMUM_BLOCK_SIZE) != 0) {
                    ...
                    if (i4 != 4) {
                        ...
                        int i1111 = i3 >> 3;
                        int i1112 = i3 << 3;
                        Arrangement.Horizontal horizontal10 = horizontalM390spacedBy0680j_4;
                        PaddingValues paddingValues12 = paddingValues3;
                        LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i1111 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i1112) | (i1112 & 458752) | (i1111 & 3670016) | (i1111 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                        modifier4 = modifier3;
                        ...
                        int i1113 = i3 >> 3;
                        int i1114 = i3 << 3;
                        Arrangement.Horizontal horizontal11 = horizontalM390spacedBy0680j_4;
                        PaddingValues paddingValues13 = paddingValues3;
                        LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i1113 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i1114) | (i1114 & 458752) | (i1113 & 3670016) | (i1113 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                        modifier4 = modifier3;
                ...
                if (i4 != 4) {
                    ...
                    int i1115 = i3 >> 3;
                    int i1116 = i3 << 3;
                    Arrangement.Horizontal horizontal12 = horizontalM390spacedBy0680j_4;
                    PaddingValues paddingValues14 = paddingValues3;
                    LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i1115 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i1116) | (i1116 & 458752) | (i1115 & 3670016) | (i1115 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
                    ...
                    int i1117 = i3 >> 3;
                    int i1118 = i3 << 3;
                    Arrangement.Horizontal horizontal13 = horizontalM390spacedBy0680j_4;
                    PaddingValues paddingValues15 = paddingValues3;
                    LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i1117 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i1118) | (i1118 & 458752) | (i1117 & 3670016) | (i1117 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
            ...
            if ((i2 & ConstantsKt.MINIMUM_BLOCK_SIZE) != 0) {
                ...
                if (i4 != 4) {
                    ...
                    int i1119 = i3 >> 3;
                    int i11110 = i3 << 3;
                    Arrangement.Horizontal horizontal14 = horizontalM390spacedBy0680j_4;
                    PaddingValues paddingValues16 = paddingValues3;
                    LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i1119 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i11110) | (i11110 & 458752) | (i1119 & 3670016) | (i1119 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
                    ...
                    int i11111 = i3 >> 3;
                    int i11112 = i3 << 3;
                    Arrangement.Horizontal horizontal15 = horizontalM390spacedBy0680j_4;
                    PaddingValues paddingValues17 = paddingValues3;
                    LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i11111 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i11112) | (i11112 & 458752) | (i11111 & 3670016) | (i11111 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
            ...
            if (i4 != 4) {
                ...
                int i11113 = i3 >> 3;
                int i11114 = i3 << 3;
                Arrangement.Horizontal horizontal16 = horizontalM390spacedBy0680j_4;
                PaddingValues paddingValues18 = paddingValues3;
                LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i11113 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i11114) | (i11114 & 458752) | (i11113 & 3670016) | (i11113 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier4 = modifier3;
                ...
                int i11115 = i3 >> 3;
                int i11116 = i3 << 3;
                Arrangement.Horizontal horizontal17 = horizontalM390spacedBy0680j_4;
                PaddingValues paddingValues19 = paddingValues3;
                LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i11115 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i11116) | (i11116 & 458752) | (i11115 & 3670016) | (i11115 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier4 = modifier3;
        ...
        if (i5 != 0) {
            ...
            if (i7 != 0) {
                ...
                if ((i2 & ConstantsKt.MINIMUM_BLOCK_SIZE) != 0) {
                    ...
                    if (i4 != 4) {
                        ...
                        int i11117 = i3 >> 3;
                        int i11118 = i3 << 3;
                        Arrangement.Horizontal horizontal18 = horizontalM390spacedBy0680j_4;
                        PaddingValues paddingValues110 = paddingValues3;
                        LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i11117 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i11118) | (i11118 & 458752) | (i11117 & 3670016) | (i11117 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                        modifier4 = modifier3;
                        ...
                        int i11119 = i3 >> 3;
                        int i111110 = i3 << 3;
                        Arrangement.Horizontal horizontal19 = horizontalM390spacedBy0680j_4;
                        PaddingValues paddingValues111 = paddingValues3;
                        LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i11119 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i111110) | (i111110 & 458752) | (i11119 & 3670016) | (i11119 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                        modifier4 = modifier3;
                ...
                if (i4 != 4) {
                    ...
                    int i111111 = i3 >> 3;
                    int i111112 = i3 << 3;
                    Arrangement.Horizontal horizontal110 = horizontalM390spacedBy0680j_4;
                    PaddingValues paddingValues112 = paddingValues3;
                    LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i111111 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i111112) | (i111112 & 458752) | (i111111 & 3670016) | (i111111 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
                    ...
                    int i111113 = i3 >> 3;
                    int i111114 = i3 << 3;
                    Arrangement.Horizontal horizontal111 = horizontalM390spacedBy0680j_4;
                    PaddingValues paddingValues113 = paddingValues3;
                    LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i111113 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i111114) | (i111114 & 458752) | (i111113 & 3670016) | (i111113 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
            ...
            if ((i2 & ConstantsKt.MINIMUM_BLOCK_SIZE) != 0) {
                ...
                if (i4 != 4) {
                    ...
                    int i111115 = i3 >> 3;
                    int i111116 = i3 << 3;
                    Arrangement.Horizontal horizontal112 = horizontalM390spacedBy0680j_4;
                    PaddingValues paddingValues114 = paddingValues3;
                    LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i111115 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i111116) | (i111116 & 458752) | (i111115 & 3670016) | (i111115 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
                    ...
                    int i111117 = i3 >> 3;
                    int i111118 = i3 << 3;
                    Arrangement.Horizontal horizontal113 = horizontalM390spacedBy0680j_4;
                    PaddingValues paddingValues115 = paddingValues3;
                    LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i111117 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i111118) | (i111118 & 458752) | (i111117 & 3670016) | (i111117 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
            ...
            if (i4 != 4) {
                ...
                int i111119 = i3 >> 3;
                int i1111110 = i3 << 3;
                Arrangement.Horizontal horizontal114 = horizontalM390spacedBy0680j_4;
                PaddingValues paddingValues116 = paddingValues3;
                LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i111119 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i1111110) | (i1111110 & 458752) | (i111119 & 3670016) | (i111119 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier4 = modifier3;
                ...
                int i1111111 = i3 >> 3;
                int i1111112 = i3 << 3;
                Arrangement.Horizontal horizontal115 = horizontalM390spacedBy0680j_4;
                PaddingValues paddingValues117 = paddingValues3;
                LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i1111111 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i1111112) | (i1111112 & 458752) | (i1111111 & 3670016) | (i1111111 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier4 = modifier3;
        ...
        if (i7 != 0) {
            ...
            if ((i2 & ConstantsKt.MINIMUM_BLOCK_SIZE) != 0) {
                ...
                if (i4 != 4) {
                    ...
                    int i1111113 = i3 >> 3;
                    int i1111114 = i3 << 3;
                    Arrangement.Horizontal horizontal116 = horizontalM390spacedBy0680j_4;
                    PaddingValues paddingValues118 = paddingValues3;
                    LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i1111113 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i1111114) | (i1111114 & 458752) | (i1111113 & 3670016) | (i1111113 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
                    ...
                    int i1111115 = i3 >> 3;
                    int i1111116 = i3 << 3;
                    Arrangement.Horizontal horizontal117 = horizontalM390spacedBy0680j_4;
                    PaddingValues paddingValues119 = paddingValues3;
                    LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i1111115 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i1111116) | (i1111116 & 458752) | (i1111115 & 3670016) | (i1111115 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
            ...
            if (i4 != 4) {
                ...
                int i1111117 = i3 >> 3;
                int i1111118 = i3 << 3;
                Arrangement.Horizontal horizontal118 = horizontalM390spacedBy0680j_4;
                PaddingValues paddingValues1110 = paddingValues3;
                LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i1111117 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i1111118) | (i1111118 & 458752) | (i1111117 & 3670016) | (i1111117 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier4 = modifier3;
                ...
                int i1111119 = i3 >> 3;
                int i11111110 = i3 << 3;
                Arrangement.Horizontal horizontal119 = horizontalM390spacedBy0680j_4;
                PaddingValues paddingValues1111 = paddingValues3;
                LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i1111119 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i11111110) | (i11111110 & 458752) | (i1111119 & 3670016) | (i1111119 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier4 = modifier3;
        ...
        if ((i2 & ConstantsKt.MINIMUM_BLOCK_SIZE) != 0) {
            ...
            if (i4 != 4) {
                ...
                int i11111111 = i3 >> 3;
                int i11111112 = i3 << 3;
                Arrangement.Horizontal horizontal1110 = horizontalM390spacedBy0680j_4;
                PaddingValues paddingValues1112 = paddingValues3;
                LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i11111111 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i11111112) | (i11111112 & 458752) | (i11111111 & 3670016) | (i11111111 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier4 = modifier3;
                ...
                int i11111113 = i3 >> 3;
                int i11111114 = i3 << 3;
                Arrangement.Horizontal horizontal1111 = horizontalM390spacedBy0680j_4;
                PaddingValues paddingValues1113 = paddingValues3;
                LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i11111113 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i11111114) | (i11111114 & 458752) | (i11111113 & 3670016) | (i11111113 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier4 = modifier3;
        ...
        if (i4 != 4) {
            ...
            int i11111115 = i3 >> 3;
            int i11111116 = i3 << 3;
            Arrangement.Horizontal horizontal1112 = horizontalM390spacedBy0680j_4;
            PaddingValues paddingValues1114 = paddingValues3;
            LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i11111115 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i11111116) | (i11111116 & 458752) | (i11111115 & 3670016) | (i11111115 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
            ...
            int i11111117 = i3 >> 3;
            int i11111118 = i3 << 3;
            Arrangement.Horizontal horizontal1113 = horizontalM390spacedBy0680j_4;
            PaddingValues paddingValues1115 = paddingValues3;
            LazyStaggeredGridKt.m650LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(columns, horizontalM390spacedBy0680j_4, paddingValues3, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & 112) | (i11111117 & 896)), modifier3, paddingValues3, z5, flingBehavior3, z4, f3, horizontalM390spacedBy0680j_4.getSpacing(), content, composerStartRestartGroup, ((i3 << 6) & 7168) | 56 | (57344 & i11111118) | (i11111118 & 458752) | (i11111117 & 3670016) | (i11111117 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
    ...
    public static final <T> void itemsIndexed(@NotNull LazyStaggeredGridScope lazyStaggeredGridScope, @NotNull List<? extends T> items, @Nullable Function2<? super Integer, ? super T, ? extends Object> function2, @NotNull Function2<? super Integer, ? super T, ? extends Object> contentType, @Nullable Function2<? super Integer, ? super T, StaggeredGridItemSpan> function3, @NotNull Function5<? super LazyStaggeredGridItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> itemContent) {
        ...
        Intrinsics.checkNotNullParameter(contentType, "contentType");
        Intrinsics.checkNotNullParameter(itemContent, "itemContent");
        lazyStaggeredGridScope.items(items.size(), function2 != null ? new LazyStaggeredGridDslKt$itemsIndexed$2$1(function2, items) : null, new C07143(contentType, items), function3 != null ? new LazyStaggeredGridDslKt$itemsIndexed$4$1(function3, items) : null, ComposableLambdaKt.composableLambdaInstance(284833944, true, new C07155(itemContent, items)));
    }
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new LazyStaggeredGridSlotCache(new Function2<Density, Constraints, LazyStaggeredGridSlots>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridDslKt$rememberColumnSlots$1$1
                ...
                public /* bridge */ /* synthetic */ LazyStaggeredGridSlots invoke(Density density, Constraints constraints) {
                    return m646invoke0kLqBqw(density, constraints.getValue());
                }

                @NotNull
                /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                public final LazyStaggeredGridSlots m646invoke0kLqBqw(@NotNull Density $receiver, long j) {
                    ...
                    int[] iArrCalculateCrossAxisCellSizes = staggeredGridCells2.calculateCrossAxisCellSizes($receiver, iM3733getMaxWidthimpl, $receiver.mo318roundToPx0680j_4(horizontal2.getSpacing()));
                    int[] iArr = new int[iArrCalculateCrossAxisCellSizes.length];
                    horizontal2.arrange($receiver, iM3733getMaxWidthimpl, iArrCalculateCrossAxisCellSizes, layoutDirection, iArr);
    ...
    private static final Function2<Density, Constraints, LazyStaggeredGridSlots> rememberRowSlots(final StaggeredGridCells staggeredGridCells, final Arrangement.Vertical vertical, final PaddingValues paddingValues, Composer composer, int i) {
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new LazyStaggeredGridSlotCache(new Function2<Density, Constraints, LazyStaggeredGridSlots>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridDslKt$rememberRowSlots$1$1
                ...
                @Override // kotlin.jvm.functions.Function2
                public /* bridge */ /* synthetic */ LazyStaggeredGridSlots invoke(Density density, Constraints constraints) {
                    return m647invoke0kLqBqw(density, constraints.getValue());
                }

                @NotNull
                /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                public final LazyStaggeredGridSlots m647invoke0kLqBqw(@NotNull Density $receiver, long j) {
                    Intrinsics.checkNotNullParameter($receiver, "$this$$receiver");
                    ...
                    int[] iArrCalculateCrossAxisCellSizes = staggeredGridCells2.calculateCrossAxisCellSizes($receiver, iM3732getMaxHeightimpl, $receiver.mo318roundToPx0680j_4(vertical2.getSpacing()));
                    int[] iArr = new int[iArrCalculateCrossAxisCellSizes.length];
                    vertical2.arrange($receiver, iM3732getMaxHeightimpl, iArrCalculateCrossAxisCellSizes, iArr);
                    return new LazyStaggeredGridSlots(iArr, iArrCalculateCrossAxisCellSizes);
                }
            });
            composer.updateRememberedValue(objRememberedValue);
