...
public final class LazyStaggeredGridItemProviderKt {
    @Composable
    @NotNull
    public static final Function0<LazyStaggeredGridItemProvider> rememberStaggeredGridItemProviderLambda(@NotNull final LazyStaggeredGridState state, @NotNull Function1<? super LazyStaggeredGridScope, Unit> content, @Nullable Composer composer, int i) {
