...
public final class LazyStaggeredGridMeasuredItem implements LazyStaggeredGridItemInfo {
    ...
    private final long m663copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
    ...
    private final int m664getMainAxisgyyYBs(long j) {
    ...
    public final void place(@NotNull Placeable.PlacementScope scope, @NotNull LazyStaggeredGridMeasureContext context) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (lazyLayoutAnimateItemModifierNode != null) {
                ...
                if ((m664getMainAxisgyyYBs(offset) <= height && m664getMainAxisgyyYBs(jOooO00o) <= height) || (m664getMainAxisgyyYBs(offset) >= i2 && m664getMainAxisgyyYBs(jOooO00o) >= i2)) {
                    lazyLayoutAnimateItemModifierNode.cancelAnimation();
                }
                offset = jOooO00o;
            }
            if (context.getReverseLayout()) {
                offset = IntOffsetKt.IntOffset(this.isVertical ? IntOffset.m3883getXimpl(offset) : (this.mainAxisLayoutSize - IntOffset.m3883getXimpl(offset)) - (this.isVertical ? placeable.getHeight() : placeable.getWidth()), this.isVertical ? (this.mainAxisLayoutSize - IntOffset.m3884getYimpl(offset)) - (this.isVertical ? placeable.getHeight() : placeable.getWidth()) : IntOffset.m3884getYimpl(offset));
            }
            long contentOffset = context.getContentOffset();
            Placeable.PlacementScope.m2840placeRelativeWithLayeraW9wM$default(scope, placeable, OooO0o.OooO00o(contentOffset, IntOffset.m3884getYimpl(offset), IntOffset.m3883getXimpl(contentOffset) + IntOffset.m3883getXimpl(offset)), 0.0f, null, 6, null);
        }
    }
