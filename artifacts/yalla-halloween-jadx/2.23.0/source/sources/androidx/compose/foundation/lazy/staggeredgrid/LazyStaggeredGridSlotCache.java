...
final class LazyStaggeredGridSlotCache implements Function2<Density, Constraints, LazyStaggeredGridSlots> {
    ...
    public /* bridge */ /* synthetic */ LazyStaggeredGridSlots invoke(Density density, Constraints constraints) {
        return m665invoke0kLqBqw(density, constraints.getValue());
    }

    @NotNull
    /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
    public LazyStaggeredGridSlots m665invoke0kLqBqw(@NotNull Density density, long constraints) {
        ...
        LazyStaggeredGridSlots lazyStaggeredGridSlotsInvoke = this.calculation.invoke(density, Constraints.m3721boximpl(constraints));
