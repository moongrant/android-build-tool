...
final class ConsumeAllFlingOnDirection implements NestedScrollConnection {
    ...
    public final long m677consumeOnOrientation8S9VItk(long j, @NotNull Orientation orientation) {
        Intrinsics.checkNotNullParameter(orientation, "orientation");
        return orientation == Orientation.Vertical ? Offset.m1430copydBAh8RU$default(j, 0.0f, 0.0f, 2, null) : Offset.m1430copydBAh8RU$default(j, 0.0f, 0.0f, 1, null);
    }

    /* JADX INFO: renamed from: consumeOnOrientation-QWom1Mo, reason: not valid java name */
    public final long m678consumeOnOrientationQWom1Mo(long j, @NotNull Orientation orientation) {
        Intrinsics.checkNotNullParameter(orientation, "orientation");
        return orientation == Orientation.Vertical ? Velocity.m3986copyOhffZ5M$default(j, 0.0f, 0.0f, 2, null) : Velocity.m3986copyOhffZ5M$default(j, 0.0f, 0.0f, 1, null);
    }
    ...
    public Object mo331onPostFlingRZ2iAVY(long j, long j2, @NotNull Continuation<? super Velocity> continuation) {
        return Velocity.m3981boximpl(m678consumeOnOrientationQWom1Mo(j2, this.orientation));
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* JADX INFO: renamed from: onPostScroll-DzOQY0M */
    public long mo332onPostScrollDzOQY0M(long consumed, long available, int source) {
        return NestedScrollSource.m2594equalsimpl0(source, NestedScrollSource.INSTANCE.m2600getFlingWNlRxjI()) ? m677consumeOnOrientation8S9VItk(available, this.orientation) : Offset.INSTANCE.m1452getZeroF1C5BW0();
    }
