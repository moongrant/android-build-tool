...
public final class PagerLayoutInfoKt {
    public static final int getMainAxisViewportSize(@NotNull PagerLayoutInfo pagerLayoutInfo) {
        ...
        return pagerLayoutInfo.getOrientation() == Orientation.Vertical ? IntSize.m3924getHeightimpl(pagerLayoutInfo.mo688getViewportSizeYbymL2g()) : IntSize.m3925getWidthimpl(pagerLayoutInfo.mo688getViewportSizeYbymL2g());
    }
