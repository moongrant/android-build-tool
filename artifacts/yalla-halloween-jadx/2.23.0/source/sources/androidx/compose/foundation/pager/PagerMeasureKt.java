...
public final class PagerMeasureKt {
    ...
    private static final List<MeasuredPage> calculatePagesOffsets(LazyLayoutMeasureScope lazyLayoutMeasureScope, List<MeasuredPage> list, List<MeasuredPage> list2, List<MeasuredPage> list3, int i, int i2, int i3, int i4, int i5, Orientation orientation, boolean z, Density density, int i6, int i7) {
        ...
        if (z2) {
            ...
            Arrangement.HorizontalOrVertical horizontalOrVerticalM393spacedBy0680j_4 = Arrangement.Absolute.INSTANCE.m393spacedBy0680j_4(lazyLayoutMeasureScope.mo321toDpu2uoSUM(i7));
            if (orientation == Orientation.Vertical) {
                horizontalOrVerticalM393spacedBy0680j_4.arrange(density, i9, iArr, iArr2);
            } else {
                horizontalOrVerticalM393spacedBy0680j_4.arrange(density, i9, iArr, LayoutDirection.Ltr, iArr2);
            }
    ...
    public static final PagerMeasureResult m691measurePagerntgEbfI(@NotNull final LazyLayoutMeasureScope measurePager, int i, @NotNull final PagerLazyLayoutItemProvider pagerItemProvider, int i2, int i3, int i4, int i5, int i6, int i7, float f, long j, @NotNull final Orientation orientation, @Nullable final Alignment.Vertical vertical, @Nullable final Alignment.Horizontal horizontal, final boolean z, final long j2, final int i8, int i9, @NotNull List<Integer> pinnedPages, @NotNull Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> layout) {
        ...
        int iM3746constrainHeightK40F9xA;
        ...
        if (i <= 0) {
            return new PagerMeasureResult(CollectionsKt.emptyList(), 0, i8, i5, i4, orientation, -i3, i2 + i4, false, 0.0f, null, null, 0, false, layout.invoke(Integer.valueOf(Constraints.m3735getMinWidthimpl(j)), Integer.valueOf(Constraints.m3734getMinHeightimpl(j)), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$2
        ...
        final long jConstraints$default = ConstraintsKt.Constraints$default(0, orientation == orientation3 ? Constraints.m3733getMaxWidthimpl(j) : i8, 0, orientation != orientation3 ? Constraints.m3732getMaxHeightimpl(j) : i8, 5, null);
        int i29 = i6;
        if (i29 >= i) {
            i29 = i - 1;
            i10 = 0;
        ...
        while (i34 < 0 && i29 > 0) {
            ...
            MeasuredPage measuredPageM690getAndMeasureSGf7dI0 = m690getAndMeasureSGf7dI0(measurePager, i35, jConstraints$default, pagerItemProvider, j2, orientation, horizontal, vertical, measurePager.getLayoutDirection(), z, i8);
            arrayDeque4.add(i36, measuredPageM690getAndMeasureSGf7dI0);
            iMax4 = Math.max(iMax4, measuredPageM690getAndMeasureSGf7dI0.getCrossAxisSize());
            i34 += i37;
            i28 = i36;
            iCoerceAtLeast = i37;
            i29 = i35;
        ...
        while (true) {
            ...
            int i55 = iMax4;
            int i56 = i40;
            MeasuredPage measuredPageM690getAndMeasureSGf7dI1 = m690getAndMeasureSGf7dI0(measurePager, i44, jConstraints$default, pagerItemProvider, j2, orientation, horizontal, vertical, measurePager.getLayoutDirection(), z, i8);
            i50 += i56;
            if (i50 > i33 || i51 == i52 - 1) {
                iMax3 = Math.max(i55, measuredPageM690getAndMeasureSGf7dI1.getCrossAxisSize());
                arrayDeque3 = arrayDeque5;
                arrayDeque3.add(measuredPageM690getAndMeasureSGf7dI1);
            } else {
                i49 -= i56;
                arrayDeque3 = arrayDeque5;
                iMax3 = i55;
        ...
        if (i50 < i42) {
            ...
            while (i58 < i3 && i48 > 0) {
                ...
                MeasuredPage measuredPageM690getAndMeasureSGf7dI2 = m690getAndMeasureSGf7dI0(measurePager, i48, jConstraints$default, pagerItemProvider, j2, orientation, horizontal, vertical, measurePager.getLayoutDirection(), z, i8);
                arrayDeque6.add(0, measuredPageM690getAndMeasureSGf7dI2);
                iMax5 = Math.max(iMax5, measuredPageM690getAndMeasureSGf7dI2.getCrossAxisSize());
                i58 += i40;
            ...
            listCreatePagesBeforeList = createPagesBeforeList(i15, i9, pinnedPages, new Function1<Integer, MeasuredPage>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$extraPagesBefore$1
                ...
                public final MeasuredPage invoke(int i62) {
                    ...
                    return PagerMeasureKt.m690getAndMeasureSGf7dI0(lazyLayoutMeasureScope, i62, jConstraints$default, pagerItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope.getLayoutDirection(), z, i8);
                }
            });
            ...
            iM3747constrainWidthK40F9xA = ConstraintsKt.m3747constrainWidthK40F9xA(j, i23);
            if (orientation == orientation2) {
                iMax2 = i20;
            }
            iM3746constrainHeightK40F9xA = ConstraintsKt.m3746constrainHeightK40F9xA(j, iMax2);
            listCalculatePagesOffsets = calculatePagesOffsets(measurePager, arrayDeque2, listCreatePagesBeforeList, listCreatePagesAfterList, iM3747constrainWidthK40F9xA, iM3746constrainHeightK40F9xA, i20, i2, i60, orientation, z, measurePager, i5, i8);
            if (z3) {
            ...
            if (orientation == Orientation.Vertical) {
                i25 = iM3746constrainHeightK40F9xA;
            } else {
                i25 = iM3747constrainWidthK40F9xA;
            }
            if (list.isEmpty()) {
                measuredPage7 = null;
                z6 = true;
            ...
            MeasureResult measureResultInvoke = layout.invoke(Integer.valueOf(iM3747constrainWidthK40F9xA), Integer.valueOf(iM3746constrainHeightK40F9xA), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$6
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
        ...
        listCreatePagesBeforeList = createPagesBeforeList(i15, i9, pinnedPages, new Function1<Integer, MeasuredPage>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$extraPagesBefore$1
            ...
            public final MeasuredPage invoke(int i64) {
                LazyLayoutMeasureScope lazyLayoutMeasureScope = measurePager;
                return PagerMeasureKt.m690getAndMeasureSGf7dI0(lazyLayoutMeasureScope, i64, jConstraints$default, pagerItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope.getLayoutDirection(), z, i8);
            }
        });
        size2 = listCreatePagesBeforeList.size();
        iMax = i63;
        ...
        iM3746constrainHeightK40F9xA = ConstraintsKt.m3746constrainHeightK40F9xA(j, iMax2);
        listCalculatePagesOffsets = calculatePagesOffsets(measurePager, arrayDeque2, listCreatePagesBeforeList, listCreatePagesAfterList, iM3747constrainWidthK40F9xA, iM3746constrainHeightK40F9xA, i20, i2, i62, orientation, z, measurePager, i5, i8);
        if (z3) {
            list = listCalculatePagesOffsets;
        } else {
            arrayList = new ArrayList(listCalculatePagesOffsets.size());
        ...
        MeasureResult measureResultInvoke2 = layout.invoke(Integer.valueOf(iM3747constrainWidthK40F9xA), Integer.valueOf(iM3746constrainHeightK40F9xA), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$6
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
