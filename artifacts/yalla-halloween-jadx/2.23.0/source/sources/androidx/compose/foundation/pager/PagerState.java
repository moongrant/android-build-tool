...
public abstract class PagerState implements ScrollableState {
    ...
    public static final class C07191 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        int label;
        ...
        public C07191(Continuation<? super C07191> continuation) {
            super(continuation);
        }
    ...
    public static /* synthetic */ Object scroll$suspendImpl(PagerState pagerState, MutatePriority mutatePriority, Function2<? super ScrollScope, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        C07191 c07191;
        if (continuation instanceof C07191) {
            c07191 = (C07191) continuation;
            int i = c07191.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c07191.label = i - Integer.MIN_VALUE;
            } else {
                c07191 = pagerState.new C07191(continuation);
            }
        } else {
            c07191 = pagerState.new C07191(continuation);
        }
        Object obj = c07191.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c07191.label;
        if (i2 != 0) {
            if (i2 == 1) {
                function2 = (Function2) c07191.L$2;
                mutatePriority = (MutatePriority) c07191.L$1;
                pagerState = (PagerState) c07191.L$0;
                ResultKt.throwOnFailure(obj);
            } else {
                if (i2 != 2) {
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        ...
        ResultKt.throwOnFailure(obj);
        c07191.L$0 = pagerState;
        c07191.L$1 = mutatePriority;
        c07191.L$2 = function2;
        c07191.label = 1;
        if (pagerState.awaitScrollDependencies(c07191) == coroutine_suspended) {
            return coroutine_suspended;
        }
        ...
        c07191.L$2 = null;
        c07191.label = 2;
        if (scrollableState.scroll(mutatePriority, function2, c07191) == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Unit.INSTANCE;
    }
    ...
    public final long m695getUpDownDifferenceF1C5BW0$foundation_release() {
    ...
    public final void m696setPremeasureConstraintsBRTryo0$foundation_release(long j) {
    ...
    public final void m697setUpDownDifferencek4lQ0M$foundation_release(long j) {
        this.upDownDifference.setValue(Offset.m1425boximpl(j));
    }
    ...
    public PagerState(int i, float f) {
        ...
        this.upDownDifference = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m1425boximpl(Offset.INSTANCE.m1452getZeroF1C5BW0()), null, 2, null);
