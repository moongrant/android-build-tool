...
public final class AbsoluteRoundedCornerShape extends CornerBasedShape {
    ...
    private final long m714toRadiusBz7bX_o(float f) {
    ...
    public Outline mo710createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, @NotNull LayoutDirection layoutDirection) {
        ...
        return ((((topStart + topEnd) + bottomEnd) + bottomStart) > 0.0f ? 1 : ((((topStart + topEnd) + bottomEnd) + bottomStart) == 0.0f ? 0 : -1)) == 0 ? new Outline.Rectangle(SizeKt.m1526toRectuvyYCjk(size)) : new Outline.Rounded(RoundRectKt.m1488RoundRectZAM2FJo(SizeKt.m1526toRectuvyYCjk(size), CornerRadiusKt.CornerRadius$default(topStart, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(topEnd, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(bottomEnd, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(bottomStart, 0.0f, 2, null)));
    }
