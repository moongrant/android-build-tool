...
public final class AndroidCursorHandle_androidKt {
    ...
    static {
        float fM3765constructorimpl = Dp.m3765constructorimpl(25);
        CursorHandleHeight = fM3765constructorimpl;
        CursorHandleWidth = Dp.m3765constructorimpl(Dp.m3765constructorimpl(fM3765constructorimpl * 2.0f) / 2.4142137f);
    }

    @Composable
    @ComposableInferredTarget(scheme = "[androidx.compose.ui.UiComposable[androidx.compose.ui.UiComposable]]")
    /* JADX INFO: renamed from: CursorHandle-ULxng0E, reason: not valid java name */
    public static final void m730CursorHandleULxng0E(final long j, @NotNull final Modifier modifier, @Nullable final Function2<? super Composer, ? super Integer, Unit> function2, @Nullable Composer composer, final int i) {
        final int i2;
        ...
        if ((i2 & 731) == 146 && composerStartRestartGroup.getSkipping()) {
            ...
            AndroidSelectionHandles_androidKt.m863HandlePopupULxng0E(j, HandleReferencePoint.TopMiddle, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1458480226, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$1
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$2
            ...
            public final void invoke(@Nullable Composer composer2, int i3) {
                AndroidCursorHandle_androidKt.m730CursorHandleULxng0E(j, modifier, function2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    public static final void DefaultCursorHandle(@NotNull final Modifier modifier, @Nullable Composer composer, final int i) {
        ...
        if ((i2 & 11) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            SpacerKt.Spacer(drawCursorHandle(SizeKt.m525sizeVpY3zN4(modifier, CursorHandleWidth, CursorHandleHeight)), composerStartRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final Modifier drawCursorHandle(@NotNull Modifier modifier) {
        ...
        return ComposedModifierKt.composed$default(modifier, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt.drawCursorHandle.1
            ...
            public final Modifier invoke(@NotNull Modifier modifier2, @Nullable Composer composer, int i) {
                if (OooOOO.OooO00o(modifier2, "$this$composed", composer, -2126899193)) {
                ...
                Color colorM1660boximpl = Color.m1660boximpl(handleColor);
                composer.startReplaceableGroup(1157296644);
                boolean zChanged = composer.changed(colorM1660boximpl);
                ...
                if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue = new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1
                        ...
                        public final DrawResult invoke(@NotNull CacheDrawScope drawWithCache) {
                            ...
                            final float fM1505getWidthimpl = Size.m1505getWidthimpl(drawWithCache.m1342getSizeNHjbRc()) / 2.0f;
                            final ImageBitmap imageBitmapCreateHandleImage = AndroidSelectionHandles_androidKt.createHandleImage(drawWithCache, fM1505getWidthimpl);
                            final ColorFilter colorFilterM1711tintxETnrds$default = ColorFilter.Companion.m1711tintxETnrds$default(ColorFilter.INSTANCE, handleColor, 0, 2, null);
                            return drawWithCache.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1.1
                                ...
                                public final void invoke2(@NotNull ContentDrawScope onDrawWithContent) {
                                    ...
                                    transform.mo2120rotateUv8p0NA(45.0f, Offset.INSTANCE.m1452getZeroF1C5BW0());
