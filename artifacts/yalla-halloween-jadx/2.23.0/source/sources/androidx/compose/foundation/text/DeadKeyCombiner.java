...
public final class DeadKeyCombiner {
    ...
    public final Integer m751consumeZmokQxo(@NotNull KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
        int iM2577getUtf16CodePointZmokQxo = KeyEvent_androidKt.m2577getUtf16CodePointZmokQxo(event);
        if ((Integer.MIN_VALUE & iM2577getUtf16CodePointZmokQxo) != 0) {
            this.deadKeyCode = Integer.valueOf(iM2577getUtf16CodePointZmokQxo & Integer.MAX_VALUE);
            return null;
        }
        Integer num = this.deadKeyCode;
        if (num == null) {
            return Integer.valueOf(iM2577getUtf16CodePointZmokQxo);
        }
        this.deadKeyCode = null;
        Integer numValueOf = Integer.valueOf(KeyCharacterMap.getDeadChar(num.intValue(), iM2577getUtf16CodePointZmokQxo));
        Integer num2 = numValueOf.intValue() == 0 ? null : numValueOf;
        return num2 == null ? Integer.valueOf(iM2577getUtf16CodePointZmokQxo) : num2;
    }
}
