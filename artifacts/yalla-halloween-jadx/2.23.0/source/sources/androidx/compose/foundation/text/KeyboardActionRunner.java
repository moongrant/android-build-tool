...
public final class KeyboardActionRunner implements KeyboardActionScope {
    ...
    public void mo754defaultKeyboardActionKlQnJC8(int imeAction) {
        ImeAction.Companion companion = ImeAction.INSTANCE;
        if (ImeAction.m3455equalsimpl0(imeAction, companion.m3470getNexteUduSuo())) {
            getFocusManager().mo1373moveFocus3ESFkO8(FocusDirection.INSTANCE.m1368getNextdhqQ8s());
            return;
        }
        if (ImeAction.m3455equalsimpl0(imeAction, companion.m3472getPreviouseUduSuo())) {
            getFocusManager().mo1373moveFocus3ESFkO8(FocusDirection.INSTANCE.m1370getPreviousdhqQ8s());
            return;
        }
        if (!ImeAction.m3455equalsimpl0(imeAction, companion.m3468getDoneeUduSuo())) {
            if (ImeAction.m3455equalsimpl0(imeAction, companion.m3469getGoeUduSuo()) ? true : ImeAction.m3455equalsimpl0(imeAction, companion.m3473getSearcheUduSuo()) ? true : ImeAction.m3455equalsimpl0(imeAction, companion.m3474getSendeUduSuo()) ? true : ImeAction.m3455equalsimpl0(imeAction, companion.m3467getDefaulteUduSuo())) {
                return;
            }
            ImeAction.m3455equalsimpl0(imeAction, companion.m3471getNoneeUduSuo());
        } else {
    ...
    public final void m755runActionKlQnJC8(int imeAction) {
        Function1<KeyboardActionScope, Unit> onSend;
        ImeAction.Companion companion = ImeAction.INSTANCE;
        Unit unit = null;
        if (ImeAction.m3455equalsimpl0(imeAction, companion.m3468getDoneeUduSuo())) {
            onSend = getKeyboardActions().getOnDone();
        } else if (ImeAction.m3455equalsimpl0(imeAction, companion.m3469getGoeUduSuo())) {
            onSend = getKeyboardActions().getOnGo();
        } else if (ImeAction.m3455equalsimpl0(imeAction, companion.m3470getNexteUduSuo())) {
            onSend = getKeyboardActions().getOnNext();
        } else if (ImeAction.m3455equalsimpl0(imeAction, companion.m3472getPreviouseUduSuo())) {
            onSend = getKeyboardActions().getOnPrevious();
        } else if (ImeAction.m3455equalsimpl0(imeAction, companion.m3473getSearcheUduSuo())) {
            onSend = getKeyboardActions().getOnSearch();
        } else if (ImeAction.m3455equalsimpl0(imeAction, companion.m3474getSendeUduSuo())) {
            onSend = getKeyboardActions().getOnSend();
        } else {
            if (!(ImeAction.m3455equalsimpl0(imeAction, companion.m3467getDefaulteUduSuo()) ? true : ImeAction.m3455equalsimpl0(imeAction, companion.m3471getNoneeUduSuo()))) {
        ...
        if (unit == null) {
            mo754defaultKeyboardActionKlQnJC8(imeAction);
        }
    }
