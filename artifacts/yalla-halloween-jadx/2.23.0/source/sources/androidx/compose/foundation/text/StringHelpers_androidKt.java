...
public final class StringHelpers_androidKt {
    ...
    public static final int findFollowingBreak(@NotNull String str, int i) {
        ...
        if (emojiCompatIfLoaded != null) {
            ...
            OooOo00 oooOo00 = emojiCompatIfLoaded.f5592OooO0o0.f5595OooO0O0;
            oooOo00.getClass();
            if (i < 0 || i >= str.length()) {
                spanEnd = -1;
                ...
                if (oooOoArr.length > 0) {
                    ...
                    spanEnd = ((OooOo00.OooO0OO) oooOo00.OooO0OO(str, Math.max(0, i - 16), Math.min(str.length(), i + 16), Integer.MAX_VALUE, true, new OooOo00.OooO0OO(i))).f5635OooO0OO;
                }
            } else {
                spanEnd = ((OooOo00.OooO0OO) oooOo00.OooO0OO(str, Math.max(0, i - 16), Math.min(str.length(), i + 16), Integer.MAX_VALUE, true, new OooOo00.OooO0OO(i))).f5635OooO0OO;
            }
        ...
        if (emojiCompatIfLoaded != null) {
            ...
            if (iMax < 0 || iMax >= str.length()) {
                ...
                if (oooOoArr.length > 0) {
                    ...
                    spanStart = ((OooOo00.OooO0OO) oooOo00.OooO0OO(str, Math.max(0, iMax - 16), Math.min(str.length(), iMax + 16), Integer.MAX_VALUE, true, new OooOo00.OooO0OO(iMax))).f5634OooO0O0;
                }
            } else {
                spanStart = ((OooOo00.OooO0OO) oooOo00.OooO0OO(str, Math.max(0, iMax - 16), Math.min(str.length(), iMax + 16), Integer.MAX_VALUE, true, new OooOo00.OooO0OO(iMax))).f5634OooO0O0;
            }
