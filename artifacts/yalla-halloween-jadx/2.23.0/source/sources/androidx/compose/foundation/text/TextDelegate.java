...
public final class TextDelegate {
    ...
    public static /* synthetic */ TextLayoutResult m789layoutNN6EwU$default(TextDelegate textDelegate, long j, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult, int i, Object obj) {
        if ((i & 4) != 0) {
            textLayoutResult = null;
        }
        return textDelegate.m792layoutNN6EwU(j, layoutDirection, textLayoutResult);
    }

    /* JADX INFO: renamed from: layoutText-K40F9xA, reason: not valid java name */
    private final MultiParagraph m790layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        layoutIntrinsics(layoutDirection);
        int iM3735getMinWidthimpl = Constraints.m3735getMinWidthimpl(constraints);
        boolean z = false;
        int iM3733getMaxWidthimpl = ((this.softWrap || TextOverflow.m3711equalsimpl0(this.overflow, TextOverflow.INSTANCE.m3719getEllipsisgIe3tQ8())) && Constraints.m3729getHasBoundedWidthimpl(constraints)) ? Constraints.m3733getMaxWidthimpl(constraints) : Integer.MAX_VALUE;
        if (!this.softWrap && TextOverflow.m3711equalsimpl0(this.overflow, TextOverflow.INSTANCE.m3719getEllipsisgIe3tQ8())) {
            z = true;
        }
        int i = z ? 1 : this.maxLines;
        if (iM3735getMinWidthimpl != iM3733getMaxWidthimpl) {
            iM3733getMaxWidthimpl = RangesKt.coerceIn(getMaxIntrinsicWidth(), iM3735getMinWidthimpl, iM3733getMaxWidthimpl);
        }
        return new MultiParagraph(getNonNullIntrinsics(), ConstraintsKt.Constraints$default(0, iM3733getMaxWidthimpl, 0, Constraints.m3732getMaxHeightimpl(constraints), 5, null), i, TextOverflow.m3711equalsimpl0(this.overflow, TextOverflow.INSTANCE.m3719getEllipsisgIe3tQ8()), null);
    }
    ...
    public final TextLayoutResult m792layoutNN6EwU(long constraints, @NotNull LayoutDirection layoutDirection, @Nullable TextLayoutResult prevResult) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        if (prevResult != null && TextLayoutHelperKt.m825canReuse7_7YC6M(prevResult, this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, constraints)) {
            return prevResult.m3281copyO0kMr_c(new TextLayoutInput(prevResult.getLayoutInput().getText(), this.style, prevResult.getLayoutInput().getPlaceholders(), prevResult.getLayoutInput().getMaxLines(), prevResult.getLayoutInput().getSoftWrap(), prevResult.getLayoutInput().getOverflow(), prevResult.getLayoutInput().getDensity(), prevResult.getLayoutInput().getLayoutDirection(), prevResult.getLayoutInput().getFontFamilyResolver(), constraints, (DefaultConstructorMarker) null), ConstraintsKt.m3744constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(prevResult.getMultiParagraph().getWidth()), TextDelegateKt.ceilToIntPx(prevResult.getMultiParagraph().getHeight()))));
        }
        MultiParagraph multiParagraphM790layoutTextK40F9xA = m790layoutTextK40F9xA(constraints, layoutDirection);
        return new TextLayoutResult(new TextLayoutInput(this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, constraints, (DefaultConstructorMarker) null), multiParagraphM790layoutTextK40F9xA, ConstraintsKt.m3744constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(multiParagraphM790layoutTextK40F9xA.getWidth()), TextDelegateKt.ceilToIntPx(multiParagraphM790layoutTextK40F9xA.getHeight()))), null);
    }
    ...
    public /* synthetic */ TextDelegate(AnnotatedString annotatedString, TextStyle textStyle, int i, int i2, boolean z, int i3, Density density, FontFamily.Resolver resolver, List list, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, (i4 & 4) != 0 ? Integer.MAX_VALUE : i, (i4 & 8) != 0 ? 1 : i2, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? TextOverflow.INSTANCE.m3718getClipgIe3tQ8() : i3, density, resolver, (i4 & PSKKeyManager.MAX_KEY_LENGTH_BYTES) != 0 ? CollectionsKt.emptyList() : list, null);
    }
}
