...
public final class TextFieldKeyInputKt {
    ...
    public static final Modifier m809textFieldKeyInput2WJ9YEU(@NotNull Modifier textFieldKeyInput, @NotNull final TextFieldState state, @NotNull final TextFieldSelectionManager manager, @NotNull final TextFieldValue value, @NotNull final Function1<? super TextFieldValue, Unit> onValueChange, final boolean z, final boolean z2, @NotNull final OffsetMapping offsetMapping, @NotNull final UndoManager undoManager, final int i) {
        ...
        return ComposedModifierKt.composed$default(textFieldKeyInput, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.TextFieldKeyInputKt$textFieldKeyInput$2
            ...
            public /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function1<KeyEvent, Boolean> {
                ...
                public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                    return m811invokeZmokQxo(keyEvent.m2564unboximpl());
                }

                @NotNull
                /* JADX INFO: renamed from: invoke-ZmokQxo, reason: not valid java name */
                public final Boolean m811invokeZmokQxo(@NotNull android.view.KeyEvent p0) {
                    Intrinsics.checkNotNullParameter(p0, "p0");
                    return Boolean.valueOf(((TextFieldKeyInput) this.receiver).m808processZmokQxo(p0));
                }
            }
            ...
            public final Modifier invoke(@NotNull Modifier modifier, @Nullable Composer composer, int i2) {
                if (OooOOO.OooO00o(modifier, "$this$composed", composer, 2057323757)) {
