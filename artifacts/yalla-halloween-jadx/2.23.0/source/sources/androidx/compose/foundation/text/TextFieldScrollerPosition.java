...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(@NotNull Orientation initialOrientation, float f) {
        ...
        this.previousSelection = TextRange.INSTANCE.m3315getZerod9O1mEE();
    ...
    public final int m815getOffsetToFollow5zctL8(long selection) {
        if (TextRange.m3310getStartimpl(selection) != TextRange.m3310getStartimpl(this.previousSelection)) {
            return TextRange.m3310getStartimpl(selection);
        }
        return TextRange.m3305getEndimpl(selection) != TextRange.m3305getEndimpl(this.previousSelection) ? TextRange.m3305getEndimpl(selection) : TextRange.m3308getMinimpl(selection);
    }
    ...
    public final void m817setPreviousSelection5zctL8(long j) {
