...
public final class TextLayoutResultProxy {
    ...
    private final long m826coercedInVisibleBoundsOfInputTextMKHz9U(long j) {
        Rect zero;
        ...
        return TextLayoutResultProxyKt.m832coerceIn3MmeM6k(j, zero);
    }
    ...
    public static /* synthetic */ int m827getOffsetForPosition3MmeM6k$default(TextLayoutResultProxy textLayoutResultProxy, long j, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return textLayoutResultProxy.m829getOffsetForPosition3MmeM6k(j, z);
    }

    /* JADX INFO: renamed from: relativeToInputText-MK-Hz9U, reason: not valid java name */
    private final long m828relativeToInputTextMKHz9U(long j) {
        Offset offsetM1425boximpl;
        LayoutCoordinates layoutCoordinates = this.innerTextFieldCoordinates;
        if (layoutCoordinates == null) {
            return j;
        }
        LayoutCoordinates layoutCoordinates2 = this.decorationBoxCoordinates;
        if (layoutCoordinates2 != null) {
            offsetM1425boximpl = Offset.m1425boximpl((layoutCoordinates.isAttached() && layoutCoordinates2.isAttached()) ? layoutCoordinates.mo2802localPositionOfR5De75A(layoutCoordinates2, j) : j);
        } else {
            offsetM1425boximpl = null;
        }
        return offsetM1425boximpl != null ? offsetM1425boximpl.getPackedValue() : j;
    }
    ...
    public final int getLineForVerticalPosition(float vertical) {
        return this.value.getLineForVerticalPosition(Offset.m1437getYimpl(m828relativeToInputTextMKHz9U(m826coercedInVisibleBoundsOfInputTextMKHz9U(OffsetKt.Offset(0.0f, vertical)))));
    }

    /* JADX INFO: renamed from: getOffsetForPosition-3MmeM6k, reason: not valid java name */
    public final int m829getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        if (coerceInVisibleBounds) {
            position = m826coercedInVisibleBoundsOfInputTextMKHz9U(position);
        }
        return this.value.m3282getOffsetForPositionk4lQ0M(m828relativeToInputTextMKHz9U(position));
    }
    ...
    public final boolean m830isPositionOnTextk4lQ0M(long offset) {
        long jM828relativeToInputTextMKHz9U = m828relativeToInputTextMKHz9U(m826coercedInVisibleBoundsOfInputTextMKHz9U(offset));
        int lineForVerticalPosition = this.value.getLineForVerticalPosition(Offset.m1437getYimpl(jM828relativeToInputTextMKHz9U));
        return Offset.m1436getXimpl(jM828relativeToInputTextMKHz9U) >= this.value.getLineLeft(lineForVerticalPosition) && Offset.m1436getXimpl(jM828relativeToInputTextMKHz9U) <= this.value.getLineRight(lineForVerticalPosition);
    }
