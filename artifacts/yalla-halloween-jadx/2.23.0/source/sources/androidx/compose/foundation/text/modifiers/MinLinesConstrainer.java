...
public final class MinLinesConstrainer {
    ...
    public final long m836coerceMinLinesOh53vG4$foundation_release(long inConstraints, int minLines) {
        float height = this.oneLineHeightCache;
        float height2 = this.lineHeightCache;
        if (Float.isNaN(height) || Float.isNaN(height2)) {
            height = ParagraphKt.m3208ParagraphUdtVg6A(MinLinesConstrainerKt.EmptyTextReplacement, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (64 & 32) != 0 ? CollectionsKt.emptyList() : null, (64 & 64) != 0 ? CollectionsKt.emptyList() : null, (64 & 128) != 0 ? Integer.MAX_VALUE : 1, (64 & PSKKeyManager.MAX_KEY_LENGTH_BYTES) != 0 ? false : false).getHeight();
            height2 = ParagraphKt.m3208ParagraphUdtVg6A(MinLinesConstrainerKt.TwoLineTextReplacement, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (64 & 32) != 0 ? CollectionsKt.emptyList() : null, (64 & 64) != 0 ? CollectionsKt.emptyList() : null, (64 & 128) != 0 ? Integer.MAX_VALUE : 2, (64 & PSKKeyManager.MAX_KEY_LENGTH_BYTES) != 0 ? false : false).getHeight() - height;
            this.oneLineHeightCache = height;
            this.lineHeightCache = height2;
        }
        return ConstraintsKt.Constraints(Constraints.m3735getMinWidthimpl(inConstraints), Constraints.m3733getMaxWidthimpl(inConstraints), minLines != 1 ? RangesKt.coerceAtMost(RangesKt.coerceAtLeast(MathKt.roundToInt((height2 * (minLines - 1)) + height), 0), Constraints.m3732getMaxHeightimpl(inConstraints)) : Constraints.m3734getMinHeightimpl(inConstraints), Constraints.m3732getMaxHeightimpl(inConstraints));
    }
