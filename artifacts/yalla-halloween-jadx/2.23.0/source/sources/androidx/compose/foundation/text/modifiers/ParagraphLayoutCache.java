...
public final class ParagraphLayoutCache {
    ...
    private final Paragraph m844layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ParagraphIntrinsics layoutDirection2 = setLayoutDirection(layoutDirection);
        return ParagraphKt.m3210Paragraph_EkL_Y(layoutDirection2, LayoutUtilsKt.m833finalConstraintstfFHcEY(constraints, this.softWrap, this.overflow, layoutDirection2.getMaxIntrinsicWidth()), LayoutUtilsKt.m834finalMaxLinesxdlQI24(this.softWrap, this.overflow, this.maxLines), TextOverflow.m3711equalsimpl0(this.overflow, TextOverflow.INSTANCE.m3719getEllipsisgIe3tQ8()));
    }
    ...
    private final void markDirty() {
        ...
        this.prevConstraints = Constraints.INSTANCE.m3741fixedJhjzzOo(0, 0);
    ...
    private final boolean m845newLayoutWillBeDifferentK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        if (Constraints.m3726equalsimpl0(constraints, this.prevConstraints)) {
            return false;
        }
        return Constraints.m3733getMaxWidthimpl(constraints) != Constraints.m3733getMaxWidthimpl(this.prevConstraints) || ((float) Constraints.m3732getMaxHeightimpl(constraints)) < paragraph.getHeight() || paragraph.getDidExceedMaxLines();
    }
    ...
    public final boolean m847layoutWithConstraintsK40F9xA(long constraints, @NotNull LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        boolean z = true;
        if (this.minLines > 1) {
            ...
            constraints = minLinesConstrainerFrom.m836coerceMinLinesOh53vG4$foundation_release(constraints, this.minLines);
        }
        boolean z2 = false;
        if (m845newLayoutWillBeDifferentK40F9xA(constraints, layoutDirection)) {
            Paragraph paragraphM844layoutTextK40F9xA = m844layoutTextK40F9xA(constraints, layoutDirection);
            this.prevConstraints = constraints;
            long jM3744constrain4WqzIAM = ConstraintsKt.m3744constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(paragraphM844layoutTextK40F9xA.getWidth()), TextDelegateKt.ceilToIntPx(paragraphM844layoutTextK40F9xA.getHeight())));
            this.layoutSize = jM3744constrain4WqzIAM;
            if (!TextOverflow.m3711equalsimpl0(this.overflow, TextOverflow.INSTANCE.m3720getVisiblegIe3tQ8()) && (IntSize.m3925getWidthimpl(jM3744constrain4WqzIAM) < paragraphM844layoutTextK40F9xA.getWidth() || IntSize.m3924getHeightimpl(jM3744constrain4WqzIAM) < paragraphM844layoutTextK40F9xA.getHeight())) {
                z2 = true;
            }
            this.didOverflow = z2;
            this.paragraph = paragraphM844layoutTextK40F9xA;
            return true;
        }
        if (!Constraints.m3726equalsimpl0(constraints, this.prevConstraints)) {
            Paragraph paragraph = this.paragraph;
            Intrinsics.checkNotNull(paragraph);
            long jM3744constrain4WqzIAM2 = ConstraintsKt.m3744constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(paragraph.getWidth()), TextDelegateKt.ceilToIntPx(paragraph.getHeight())));
            this.layoutSize = jM3744constrain4WqzIAM2;
            if (TextOverflow.m3711equalsimpl0(this.overflow, TextOverflow.INSTANCE.m3720getVisiblegIe3tQ8()) || (IntSize.m3925getWidthimpl(jM3744constrain4WqzIAM2) >= paragraph.getWidth() && IntSize.m3924getHeightimpl(jM3744constrain4WqzIAM2) >= paragraph.getHeight())) {
                z = false;
            }
            this.didOverflow = z;
        }
    ...
    public final void m848setLayoutSizeozmzZPI$foundation_release(long j) {
        this.layoutSize = j;
    }
    ...
    public final TextLayoutResult slowCreateTextLayoutResultOrNull() {
        ...
        long jM3724copyZbe2FdA$default = Constraints.m3724copyZbe2FdA$default(this.prevConstraints, 0, 0, 0, 0, 10, null);
        return new TextLayoutResult(new TextLayoutInput(annotatedString, this.style, CollectionsKt.emptyList(), this.maxLines, this.softWrap, this.overflow, density, layoutDirection, this.fontFamilyResolver, jM3724copyZbe2FdA$default, (DefaultConstructorMarker) null), new MultiParagraph(new MultiParagraphIntrinsics(annotatedString, this.style, (List<AnnotatedString.Range<Placeholder>>) CollectionsKt.emptyList(), density, this.fontFamilyResolver), jM3724copyZbe2FdA$default, this.maxLines, TextOverflow.m3711equalsimpl0(this.overflow, TextOverflow.INSTANCE.m3719getEllipsisgIe3tQ8()), null), this.layoutSize, null);
    }

    /* JADX INFO: renamed from: update-L6sJoHM, reason: not valid java name */
    public final void m849updateL6sJoHM(@NotNull String text, @NotNull TextStyle style, @NotNull FontFamily.Resolver fontFamilyResolver, int overflow, boolean softWrap, int maxLines, int minLines) {
    ...
    public /* synthetic */ ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m3718getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, null);
    }
}
