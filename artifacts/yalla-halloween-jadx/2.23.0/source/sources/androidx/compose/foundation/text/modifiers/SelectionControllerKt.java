...
public final class SelectionControllerKt {
    ...
    public static final Modifier makeSelectionModifier(final SelectionRegistrar selectionRegistrar, final long j, final Function0<? extends LayoutCoordinates> function0, final Function0<TextLayoutResult> function1, boolean z) {
        if (z) {
            ?? r12 = new TextDragObserver() { // from class: androidx.compose.foundation.text.modifiers.SelectionControllerKt$makeSelectionModifier$longPressDragObserver$1
                ...
                /* JADX WARN: Multi-variable type inference failed */
                {
                    ...
                    this.lastPosition = companion.m1452getZeroF1C5BW0();
                ...
                public void mo796onDragk4lQ0M(long delta) {
                    ...
                    if (layoutCoordinatesInvoke != null) {
                        ...
                        if (layoutCoordinatesInvoke.isAttached() && SelectionRegistrarKt.hasSelection(selectionRegistrar2, j2)) {
                            long jM1441plusMKHz9U = Offset.m1441plusMKHz9U(this.dragTotalDistance, delta);
                            this.dragTotalDistance = jM1441plusMKHz9U;
                            long jM1441plusMKHz9U2 = Offset.m1441plusMKHz9U(this.lastPosition, jM1441plusMKHz9U);
                            if (SelectionControllerKt.m855outOfBoundary2x9bVx0(function2.invoke(), this.lastPosition, jM1441plusMKHz9U2) || !selectionRegistrar2.mo927notifySelectionUpdate5iVPX68(layoutCoordinatesInvoke, jM1441plusMKHz9U2, this.lastPosition, false, SelectionAdjustment.INSTANCE.getCharacterWithWordAccelerate())) {
                                return;
                            }
                            this.lastPosition = jM1441plusMKHz9U2;
                            this.dragTotalDistance = Offset.INSTANCE.m1452getZeroF1C5BW0();
                        }
                    }
                }
                ...
                public void mo797onStartk4lQ0M(long startPoint) {
                    ...
                    if (layoutCoordinatesInvoke != null) {
                        ...
                        if (SelectionControllerKt.m855outOfBoundary2x9bVx0(function2.invoke(), startPoint, startPoint)) {
                            selectionRegistrar2.notifySelectionUpdateSelectAll(j2);
                        } else {
                            selectionRegistrar2.mo928notifySelectionUpdateStartd4ec7I(layoutCoordinatesInvoke, startPoint, SelectionAdjustment.INSTANCE.getWord());
                        }
        ...
        ?? r11 = new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.modifiers.SelectionControllerKt$makeSelectionModifier$mouseSelectionObserver$1
            private long lastPosition = Offset.INSTANCE.m1452getZeroF1C5BW0();
            ...
            public boolean mo856onDrag3MmeM6k(long dragPosition, @NotNull SelectionAdjustment adjustment) {
                ...
                if (!selectionRegistrar2.mo927notifySelectionUpdate5iVPX68(layoutCoordinatesInvoke, dragPosition, this.lastPosition, false, adjustment)) {
                    return true;
                }
            ...
            public boolean mo857onExtendk4lQ0M(long downPosition) {
                ...
                if (selectionRegistrar2.mo927notifySelectionUpdate5iVPX68(layoutCoordinatesInvoke, downPosition, this.lastPosition, false, SelectionAdjustment.INSTANCE.getNone())) {
            ...
            public boolean mo858onExtendDragk4lQ0M(long dragPosition) {
                ...
                if (!selectionRegistrar2.mo927notifySelectionUpdate5iVPX68(layoutCoordinatesInvoke, dragPosition, this.lastPosition, false, SelectionAdjustment.INSTANCE.getNone())) {
                    return true;
                }
                this.lastPosition = dragPosition;
                return true;
            ...
            public boolean mo859onStart3MmeM6k(long downPosition, @NotNull SelectionAdjustment adjustment) {
                ...
                selectionRegistrar2.mo928notifySelectionUpdateStartd4ec7I(layoutCoordinatesInvoke, downPosition, adjustment);
                this.lastPosition = downPosition;
                return SelectionRegistrarKt.hasSelection(selectionRegistrar2, j2);
            }
    ...
    public static final boolean m855outOfBoundary2x9bVx0(TextLayoutResult textLayoutResult, long j, long j2) {
        if (textLayoutResult == null) {
            return false;
        }
        int length = textLayoutResult.getLayoutInput().getText().getText().length();
        int iM3282getOffsetForPositionk4lQ0M = textLayoutResult.m3282getOffsetForPositionk4lQ0M(j);
        int iM3282getOffsetForPositionk4lQ0M2 = textLayoutResult.m3282getOffsetForPositionk4lQ0M(j2);
        int i = length - 1;
        return (iM3282getOffsetForPositionk4lQ0M >= i && iM3282getOffsetForPositionk4lQ0M2 >= i) || (iM3282getOffsetForPositionk4lQ0M < 0 && iM3282getOffsetForPositionk4lQ0M2 < 0);
    }
}
