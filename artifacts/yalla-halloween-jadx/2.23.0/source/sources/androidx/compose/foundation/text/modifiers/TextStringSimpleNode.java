...
public final class TextStringSimpleNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public final void doInvalidations(boolean drawChanged, boolean textChanged, boolean layoutChanged) {
        ...
        if (textChanged || layoutChanged) {
            getLayoutCache().m849updateL6sJoHM(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines);
    ...
    public void draw(@NotNull ContentDrawScope contentDrawScope) {
        ...
        if (didOverflow) {
            Rect rectM1476Recttz77jQw = RectKt.m1476Recttz77jQw(Offset.INSTANCE.m1452getZeroF1C5BW0(), SizeKt.Size(IntSize.m3925getWidthimpl(getLayoutCache().getLayoutSize()), IntSize.m3924getHeightimpl(getLayoutCache().getLayoutSize())));
            canvas.save();
        ...
        try {
            ...
            if (brush != null) {
                ...
                if (!(jM1747invoke0d7_KjU != companion.m1706getUnspecified0d7_KjU())) {
                    jM1747invoke0d7_KjU = this.style.m3331getColor0d7_KjU() != companion.m1706getUnspecified0d7_KjU() ? this.style.m3331getColor0d7_KjU() : companion.m1696getBlack0d7_KjU();
                }
                OooO00o.OooO0O0(paragraph, canvas, jM1747invoke0d7_KjU, shadow2, textDecoration2, drawStyle2, 0, 32, null);
            }
        } finally {
            if (didOverflow) {
                canvas.restore();
    ...
    public MeasureResult mo248measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j) {
        ...
        boolean zM847layoutWithConstraintsK40F9xA = layoutCache.m847layoutWithConstraintsK40F9xA(j, measure.getLayoutDirection());
        ...
        if (zM847layoutWithConstraintsK40F9xA) {
        ...
        final Placeable placeableMo2794measureBRTryo0 = measurable.mo2794measureBRTryo0(Constraints.INSTANCE.m3741fixedJhjzzOo(IntSize.m3925getWidthimpl(layoutSize), IntSize.m3924getHeightimpl(layoutSize)));
        int iM3925getWidthimpl = IntSize.m3925getWidthimpl(layoutSize);
        int iM3924getHeightimpl = IntSize.m3924getHeightimpl(layoutSize);
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return measure.layout(iM3925getWidthimpl, iM3924getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.modifiers.TextStringSimpleNode$measure$1
            {
                super(1);
            }
    ...
    public final boolean m862updateLayoutRelatedArgsHuAbxIM(@NotNull TextStyle style, int minLines, int maxLines, boolean softWrap, @NotNull FontFamily.Resolver fontFamilyResolver, int overflow) {
        Intrinsics.checkNotNullParameter(style, "style");
    ...
    public /* synthetic */ TextStringSimpleNode(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, ColorProducer colorProducer, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m3718getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, (i4 & 128) != 0 ? null : colorProducer, null);
    }
