...
public final class AndroidSelectionHandles_androidKt {
    ...
    public static final void DefaultSelectionHandle(@NotNull final Modifier modifier, final boolean z, @NotNull final ResolvedTextDirection direction, final boolean z2, @Nullable Composer composer, final int i) {
        ...
        if ((i2 & 5851) == 1170 && composerStartRestartGroup.getSkipping()) {
            ...
            SpacerKt.Spacer(drawSelectionHandle(SizeKt.m525sizeVpY3zN4(modifier, SelectionHandlesKt.getHandleWidth(), SelectionHandlesKt.getHandleHeight()), z, direction, z2), composerStartRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m863HandlePopupULxng0E(final long j, @NotNull final HandleReferencePoint handleReferencePoint, @NotNull final Function2<? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, final int i) {
        int i2;
        ...
        if ((i2 & 731) == 146 && composerStartRestartGroup.getSkipping()) {
            ...
            long jIntOffset = IntOffsetKt.IntOffset(MathKt.roundToInt(Offset.m1436getXimpl(j)), MathKt.roundToInt(Offset.m1437getYimpl(j)));
            IntOffset intOffsetM3874boximpl = IntOffset.m3874boximpl(jIntOffset);
            composerStartRestartGroup.startReplaceableGroup(511388516);
            boolean zChanged = composerStartRestartGroup.changed(intOffsetM3874boximpl) | composerStartRestartGroup.changed(handleReferencePoint);
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$HandlePopup$1
            ...
            public final void invoke(@Nullable Composer composer2, int i3) {
                AndroidSelectionHandles_androidKt.m863HandlePopupULxng0E(j, handleReferencePoint, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    public static final void m864SelectionHandle8fL75g(final long j, final boolean z, @NotNull final ResolvedTextDirection direction, final boolean z2, @NotNull final Modifier modifier, @Nullable final Function2<? super Composer, ? super Integer, Unit> function2, @Nullable Composer composer, final int i) {
        int i2;
        Intrinsics.checkNotNullParameter(direction, "direction");
        Intrinsics.checkNotNullParameter(modifier, "modifier");
            ...
            m863HandlePopupULxng0E(j, isLeft(z, direction, z2) ? HandleReferencePoint.TopRight : HandleReferencePoint.TopLeft, ComposableLambdaKt.composableLambda(composerStartRestartGroup, 732099485, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$SelectionHandle$1
                ...
                public final void invoke(@Nullable Composer composer2, int i4) {
                    ...
                    if (function2 == null) {
                        ...
                        Offset offsetM1425boximpl = Offset.m1425boximpl(j);
                        final boolean z3 = z;
                        final long j2 = j;
                        composer2.startReplaceableGroup(511388516);
                        boolean zChanged = composer2.changed(boolValueOf) | composer2.changed(offsetM1425boximpl);
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$SelectionHandle$2
            ...
            public final void invoke(@Nullable Composer composer2, int i4) {
                AndroidSelectionHandles_androidKt.m864SelectionHandle8fL75g(j, z, direction, z2, modifier, function2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    public static final ImageBitmap createHandleImage(@NotNull CacheDrawScope cacheDrawScope, float f) {
        ...
        if (imageBitmap == null || canvas == null || iCeil > imageBitmap.getWidth() || iCeil > imageBitmap.getHeight()) {
            imageBitmap = ImageBitmapKt.m1873ImageBitmapx__hDU$default(iCeil, iCeil, ImageBitmapConfig.INSTANCE.m1867getAlpha8_sVssgQ(), false, null, 24, null);
        ...
        drawParams2.m2113setSizeuvyYCjk(jSize);
        canvas2.save();
        androidx.compose.ui.graphics.drawscope.OooO0O0.Oooo0OO(canvasDrawScope2, Color.INSTANCE.m1696getBlack0d7_KjU(), 0L, canvasDrawScope2.mo2108getSizeNHjbRc(), 0.0f, null, null, BlendMode.INSTANCE.m1593getClear0nO6VwU(), 58, null);
        androidx.compose.ui.graphics.drawscope.OooO0O0.Oooo0OO(canvasDrawScope2, ColorKt.Color(4278190080L), Offset.INSTANCE.m1452getZeroF1C5BW0(), androidx.compose.ui.geometry.SizeKt.Size(f, f), 0.0f, null, null, 0, 120, null);
