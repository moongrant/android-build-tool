...
public interface Selectable {
    ...
    long mo869getHandlePositiondBAh8RU(@NotNull Selection selection, boolean isStartHandle);
    ...
    long mo870getRangeOfLineContainingjx7JFs(int offset);
    ...
    Pair<Selection, Boolean> mo871updateSelectionqCDeeow(long startHandlePosition, long endHandlePosition, @Nullable Offset previousHandlePosition, boolean isStartHandle, @NotNull LayoutCoordinates containerLayoutCoordinates, @NotNull SelectionAdjustment adjustment, @Nullable Selection previousSelection);
}
