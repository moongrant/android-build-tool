...
public final /* data */ class SelectionHandleInfo {
    ...
    public static /* synthetic */ SelectionHandleInfo m883copyUv8p0NA$default(SelectionHandleInfo selectionHandleInfo, Handle handle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return selectionHandleInfo.m885copyUv8p0NA(handle, j);
    }
    ...
    public final SelectionHandleInfo m885copyUv8p0NA(@NotNull Handle handle, long position) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return this.handle == selectionHandleInfo.handle && Offset.m1433equalsimpl0(this.position, selectionHandleInfo.position);
    }
    ...
    public final long m886getPositionF1C5BW0() {
        return this.position;
    }

    public int hashCode() {
        return Offset.m1438hashCodeimpl(this.position) + (this.handle.hashCode() * 31);
    }

    @NotNull
    public String toString() {
        return "SelectionHandleInfo(handle=" + this.handle + ", position=" + ((Object) Offset.m1444toStringimpl(this.position)) + ')';
    }
