...
public final class SelectionManager {
    ...
    public static final class C07352 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
        ...
        public C07352(Function1<? super Offset, Unit> function1, Continuation<? super C07352> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C07352 c07352 = new C07352(this.$onTap, continuation);
            c07352.L$0 = obj;
            return c07352;
        }
        ...
        public final Object invoke(@NotNull AwaitPointerEventScope awaitPointerEventScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C07352) create(awaitPointerEventScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (pointerInputChange != null) {
                this.$onTap.invoke(Offset.m1425boximpl(pointerInputChange.getPosition()));
            }
    ...
    public static final class C07371 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ Function0<Unit> $block;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C07371(Function0<Unit> function0, Continuation<? super C07371> continuation) {
            super(2, continuation);
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C07371 c07371 = SelectionManager.this.new C07371(this.$block, continuation);
            c07371.L$0 = obj;
            return c07371;
        }
        ...
        public final Object invoke(@NotNull PointerInputScope pointerInputScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C07371) create(pointerInputScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
            ...
            if (i == 0) {
                ...
                Function1<Offset, Unit> function1 = new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.onClearSelectionRequested.1.1
                    ...
                    public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                        m918invokek4lQ0M(offset.getPackedValue());
                        return Unit.INSTANCE;
                    }

                    /* JADX INFO: renamed from: invoke-k-4lQ0M, reason: not valid java name */
                    public final void m918invokek4lQ0M(long j) {
                        function0.invoke();
                    }
                };
                this.label = 1;
    ...
    public SelectionManager(@NotNull SelectionRegistrarImpl selectionRegistrar) {
        ...
        this.dragBeginPosition = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m1425boximpl(companion.m1452getZeroF1C5BW0()), null, 2, null);
        this.dragTotalDistance = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m1425boximpl(companion.m1452getZeroF1C5BW0()), null, 2, null);
        ...
        selectionRegistrar.setOnSelectionUpdateStartCallback$foundation_release(new Function3<LayoutCoordinates, Offset, SelectionAdjustment, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.2
            ...
            public /* bridge */ /* synthetic */ Unit invoke(LayoutCoordinates layoutCoordinates, Offset offset, SelectionAdjustment selectionAdjustment) {
                m915invoked4ec7I(layoutCoordinates, offset.getPackedValue(), selectionAdjustment);
                return Unit.INSTANCE;
            }

            /* JADX INFO: renamed from: invoke-d-4ec7I, reason: not valid java name */
            public final void m915invoked4ec7I(@NotNull LayoutCoordinates layoutCoordinates, long j, @NotNull SelectionAdjustment selectionMode) {
                Intrinsics.checkNotNullParameter(layoutCoordinates, "layoutCoordinates");
                Intrinsics.checkNotNullParameter(selectionMode, "selectionMode");
                Offset offsetM900convertToContainerCoordinatesQ7Q5hAU = SelectionManager.this.m900convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, j);
                if (offsetM900convertToContainerCoordinatesQ7Q5hAU != null) {
                    SelectionManager.this.m906startSelection9KIMszo(offsetM900convertToContainerCoordinatesQ7Q5hAU.getPackedValue(), false, selectionMode);
        ...
        selectionRegistrar.setOnSelectionUpdateCallback$foundation_release(new Function5<LayoutCoordinates, Offset, Offset, Boolean, SelectionAdjustment, Boolean>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.4
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(LayoutCoordinates layoutCoordinates, Offset offset, Offset offset2, Boolean bool, SelectionAdjustment selectionAdjustment) {
                return m916invoke5iVPX68(layoutCoordinates, offset.getPackedValue(), offset2.getPackedValue(), bool.booleanValue(), selectionAdjustment);
            }

            @NotNull
            /* JADX INFO: renamed from: invoke-5iVPX68, reason: not valid java name */
            public final Boolean m916invoke5iVPX68(@NotNull LayoutCoordinates layoutCoordinates, long j, long j2, boolean z, @NotNull SelectionAdjustment selectionMode) {
                Intrinsics.checkNotNullParameter(layoutCoordinates, "layoutCoordinates");
                Intrinsics.checkNotNullParameter(selectionMode, "selectionMode");
                return Boolean.valueOf(SelectionManager.this.m914updateSelectionRHHTvR4$foundation_release(SelectionManager.this.m900convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, j), SelectionManager.this.m900convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, j2), z, selectionMode));
            }
        });
        selectionRegistrar.setOnSelectionUpdateEndCallback$foundation_release(new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.5
            ...
            public final void invoke2() {
                ...
                SelectionManager.this.m901setCurrentDragPosition_kEHs6E(null);
            }
        });
        ...
        selectionRegistrar.setAfterSelectableUnsubscribe$foundation_release(new Function1<Long, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.7
            ...
            public final void invoke(long j) {
                ...
                SelectionManager.this.m905setStartHandlePosition_kEHs6E(null);
                SelectionManager.this.m904setEndHandlePosition_kEHs6E(null);
            }
        });
    }
    ...
    public final Offset m900convertToContainerCoordinatesQ7Q5hAU(LayoutCoordinates layoutCoordinates, long offset) {
        LayoutCoordinates layoutCoordinates2 = this.containerLayoutCoordinates;
        if (layoutCoordinates2 == null || !layoutCoordinates2.isAttached()) {
            return null;
        }
        return Offset.m1425boximpl(requireContainerCoordinates$foundation_release().mo2802localPositionOfR5De75A(layoutCoordinates, offset));
    }
    ...
    public final Object detectNonConsumingTap(PointerInputScope pointerInputScope, Function1<? super Offset, Unit> function1, Continuation<? super Unit> continuation) {
        Object objAwaitEachGesture = ForEachGestureKt.awaitEachGesture(pointerInputScope, new C07352(function1, null), continuation);
    ...
    private final Rect getContentRect() {
        ...
        long jMo2802localPositionOfR5De75A = layoutCoordinates3.mo2802localPositionOfR5De75A(layoutCoordinates, anchorSelectable$foundation_release.mo869getHandlePositiondBAh8RU(selection, true));
        long jMo2802localPositionOfR5De75A2 = layoutCoordinates3.mo2802localPositionOfR5De75A(layoutCoordinates2, anchorSelectable$foundation_release2.mo869getHandlePositiondBAh8RU(selection, false));
        long jMo2803localToRootMKHz9U = layoutCoordinates3.mo2803localToRootMKHz9U(jMo2802localPositionOfR5De75A);
        long jMo2803localToRootMKHz9U2 = layoutCoordinates3.mo2803localToRootMKHz9U(jMo2802localPositionOfR5De75A2);
        return new Rect(Math.min(Offset.m1436getXimpl(jMo2803localToRootMKHz9U), Offset.m1436getXimpl(jMo2803localToRootMKHz9U2)), Math.min(Offset.m1437getYimpl(layoutCoordinates3.mo2803localToRootMKHz9U(layoutCoordinates3.mo2802localPositionOfR5De75A(layoutCoordinates, OffsetKt.Offset(0.0f, anchorSelectable$foundation_release.getBoundingBox(selection.getStart().getOffset()).getTop())))), Offset.m1437getYimpl(layoutCoordinates3.mo2803localToRootMKHz9U(layoutCoordinates3.mo2802localPositionOfR5De75A(layoutCoordinates2, OffsetKt.Offset(0.0f, anchorSelectable$foundation_release2.getBoundingBox(selection.getEnd().getOffset()).getTop()))))), Math.max(Offset.m1436getXimpl(jMo2803localToRootMKHz9U), Offset.m1436getXimpl(jMo2803localToRootMKHz9U2)), Math.max(Offset.m1437getYimpl(jMo2803localToRootMKHz9U), Offset.m1437getYimpl(jMo2803localToRootMKHz9U2)) + ((float) (((double) SelectionHandlesKt.getHandleHeight()) * 4.0d)));
    }
    ...
    private final Modifier onClearSelectionRequested(Modifier modifier, Function0<Unit> function0) {
        return getHasFocus() ? SuspendingPointerInputFilterKt.pointerInput(modifier, Unit.INSTANCE, new C07371(function0, null)) : modifier;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: setCurrentDragPosition-_kEHs6E, reason: not valid java name */
    public final void m901setCurrentDragPosition_kEHs6E(Offset offset) {
        this.currentDragPosition.setValue(offset);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: setDragBeginPosition-k-4lQ0M, reason: not valid java name */
    public final void m902setDragBeginPositionk4lQ0M(long j) {
        this.dragBeginPosition.setValue(Offset.m1425boximpl(j));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: setDragTotalDistance-k-4lQ0M, reason: not valid java name */
    public final void m903setDragTotalDistancek4lQ0M(long j) {
        this.dragTotalDistance.setValue(Offset.m1425boximpl(j));
    }
    ...
    public final void m904setEndHandlePosition_kEHs6E(Offset offset) {
        this.endHandlePosition.setValue(offset);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: setStartHandlePosition-_kEHs6E, reason: not valid java name */
    public final void m905setStartHandlePosition_kEHs6E(Offset offset) {
        this.startHandlePosition.setValue(offset);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: startSelection-9KIMszo, reason: not valid java name */
    public final void m906startSelection9KIMszo(long position, boolean isStartHandle, SelectionAdjustment adjustment) {
        m913updateSelection3R_tFg$foundation_release(position, position, null, isStartHandle, adjustment);
    }
    ...
    public final void updateHandleOffsets() {
        ...
        if (selection == null || layoutCoordinates == null || !layoutCoordinates.isAttached() || layoutCoordinates2 == null || layoutCoordinates3 == null) {
            m905setStartHandlePosition_kEHs6E(null);
            m904setEndHandlePosition_kEHs6E(null);
            return;
        }
        boolean z = true;
        long jMo2802localPositionOfR5De75A = layoutCoordinates.mo2802localPositionOfR5De75A(layoutCoordinates2, anchorSelectable$foundation_release.mo869getHandlePositiondBAh8RU(selection, true));
        long jMo2802localPositionOfR5De75A2 = layoutCoordinates.mo2802localPositionOfR5De75A(layoutCoordinates3, anchorSelectable$foundation_release2.mo869getHandlePositiondBAh8RU(selection, false));
        Rect rectVisibleBounds = SelectionManagerKt.visibleBounds(layoutCoordinates);
        Offset offsetM1425boximpl = Offset.m1425boximpl(jMo2802localPositionOfR5De75A);
        offsetM1425boximpl.getPackedValue();
        if (!(SelectionManagerKt.m920containsInclusiveUv8p0NA(rectVisibleBounds, jMo2802localPositionOfR5De75A) || getDraggingHandle() == Handle.SelectionStart)) {
            offsetM1425boximpl = null;
        }
        m905setStartHandlePosition_kEHs6E(offsetM1425boximpl);
        Offset offsetM1425boximpl2 = Offset.m1425boximpl(jMo2802localPositionOfR5De75A2);
        offsetM1425boximpl2.getPackedValue();
        if (!SelectionManagerKt.m920containsInclusiveUv8p0NA(rectVisibleBounds, jMo2802localPositionOfR5De75A2) && getDraggingHandle() != Handle.SelectionEnd) {
            z = false;
        }
        m904setEndHandlePosition_kEHs6E(z ? offsetM1425boximpl2 : null);
    }
    ...
    public final void m907contextMenuOpenAdjustmentk4lQ0M(long position) {
        Selection selection = getSelection();
        if (selection != null ? TextRange.m3304getCollapsedimpl(selection.m877toTextRanged9O1mEE()) : true) {
            m906startSelection9KIMszo(position, true, SelectionAdjustment.INSTANCE.getWord());
        }
    }
    ...
    public final Offset m908getCurrentDragPosition_m7T9E() {
        return (Offset) this.currentDragPosition.getValue();
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getDragBeginPosition-F1C5BW0$foundation_release, reason: not valid java name */
    public final long m909getDragBeginPositionF1C5BW0$foundation_release() {
    ...
    public final long m910getDragTotalDistanceF1C5BW0$foundation_release() {
    ...
    public final Offset m911getEndHandlePosition_m7T9E() {
    ...
    public final Modifier getModifier() {
        ...
        Modifier modifierOnKeyEvent = KeyInputModifierKt.onKeyEvent(FocusableKt.focusable$default(FocusChangedModifierKt.onFocusChanged(FocusRequesterModifierKt.focusRequester(OnGloballyPositionedModifierKt.onGloballyPositioned(onClearSelectionRequested(modifierSelectionMagnifier, new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager$modifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m917invokeZmokQxo(keyEvent.m2564unboximpl());
            }

            @NotNull
            /* JADX INFO: renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m917invokeZmokQxo(@NotNull android.view.KeyEvent it) {
                boolean z;
                Intrinsics.checkNotNullParameter(it, "it");
                if (SelectionManager_androidKt.m921isCopyKeyEventZmokQxo(it)) {
    ...
    public final Offset m912getStartHandlePosition_m7T9E() {
    ...
    public final TextDragObserver handleDragObserver(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.SelectionManager.handleDragObserver.1
            ...
            public void mo795onDownk4lQ0M(long point) {
                ...
                long jM887getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m887getAdjustedCoordinatesk4lQ0M(anchorSelectable$foundation_release.mo869getHandlePositiondBAh8RU(selection, isStartHandle));
                SelectionManager selectionManager = SelectionManager.this;
                selectionManager.m901setCurrentDragPosition_kEHs6E(Offset.m1425boximpl(selectionManager.requireContainerCoordinates$foundation_release().mo2802localPositionOfR5De75A(layoutCoordinates, jM887getAdjustedCoordinatesk4lQ0M)));
            ...
            public void mo796onDragk4lQ0M(long delta) {
                SelectionManager selectionManager = SelectionManager.this;
                selectionManager.m903setDragTotalDistancek4lQ0M(Offset.m1441plusMKHz9U(selectionManager.m910getDragTotalDistanceF1C5BW0$foundation_release(), delta));
                long jM1441plusMKHz9U = Offset.m1441plusMKHz9U(SelectionManager.this.m909getDragBeginPositionF1C5BW0$foundation_release(), SelectionManager.this.m910getDragTotalDistanceF1C5BW0$foundation_release());
                if (SelectionManager.this.m914updateSelectionRHHTvR4$foundation_release(Offset.m1425boximpl(jM1441plusMKHz9U), Offset.m1425boximpl(SelectionManager.this.m909getDragBeginPositionF1C5BW0$foundation_release()), isStartHandle, SelectionAdjustment.INSTANCE.getCharacterWithWordAccelerate())) {
                    SelectionManager.this.m902setDragBeginPositionk4lQ0M(jM1441plusMKHz9U);
                    SelectionManager.this.m903setDragTotalDistancek4lQ0M(Offset.INSTANCE.m1452getZeroF1C5BW0());
                }
            }
            ...
            public void mo797onStartk4lQ0M(long startPoint) {
                LayoutCoordinates layoutCoordinates;
                long jMo869getHandlePositiondBAh8RU;
                SelectionManager.this.hideSelectionToolbar$foundation_release();
                Selection selection = SelectionManager.this.getSelection();
                ...
                if (isStartHandle) {
                    ...
                    jMo869getHandlePositiondBAh8RU = selectable.mo869getHandlePositiondBAh8RU(selection, true);
                } else {
                    Intrinsics.checkNotNull(selectable2);
                    jMo869getHandlePositiondBAh8RU = selectable2.mo869getHandlePositiondBAh8RU(selection, false);
                }
                long jM887getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m887getAdjustedCoordinatesk4lQ0M(jMo869getHandlePositiondBAh8RU);
                SelectionManager selectionManager = SelectionManager.this;
                selectionManager.m902setDragBeginPositionk4lQ0M(selectionManager.requireContainerCoordinates$foundation_release().mo2802localPositionOfR5De75A(layoutCoordinates, jM887getAdjustedCoordinatesk4lQ0M));
                SelectionManager.this.m903setDragTotalDistancek4lQ0M(Offset.INSTANCE.m1452getZeroF1C5BW0());
            }
    ...
    public final void setContainerLayoutCoordinates(@Nullable LayoutCoordinates layoutCoordinates) {
        ...
        Offset offsetM1425boximpl = layoutCoordinates != null ? Offset.m1425boximpl(LayoutCoordinatesKt.positionInWindow(layoutCoordinates)) : null;
        if (Intrinsics.areEqual(this.previousPosition, offsetM1425boximpl)) {
            return;
        }
        this.previousPosition = offsetM1425boximpl;
        updateHandleOffsets();
    ...
    public final boolean m913updateSelection3R_tFg$foundation_release(long startHandlePosition, long endHandlePosition, @Nullable Offset previousHandlePosition, boolean isStartHandle, @NotNull SelectionAdjustment adjustment) {
        Intrinsics.checkNotNullParameter(adjustment, "adjustment");
        setDraggingHandle(isStartHandle ? Handle.SelectionStart : Handle.SelectionEnd);
        m901setCurrentDragPosition_kEHs6E(isStartHandle ? Offset.m1425boximpl(startHandlePosition) : Offset.m1425boximpl(endHandlePosition));
        LinkedHashMap linkedHashMap = new LinkedHashMap();
        List<Selectable> listSort = this.selectionRegistrar.sort(requireContainerCoordinates$foundation_release());
        int size = listSort.size();
        Selection selectionMerge = null;
        ...
        while (i < size) {
            ...
            Pair<Selection, Boolean> pairMo871updateSelectionqCDeeow = selectable.mo871updateSelectionqCDeeow(startHandlePosition, endHandlePosition, previousHandlePosition, isStartHandle, requireContainerCoordinates$foundation_release(), adjustment, this.selectionRegistrar.getSubselections().get(Long.valueOf(selectable.getSelectableId())));
            Selection selectionComponent1 = pairMo871updateSelectionqCDeeow.component1();
            z = z || pairMo871updateSelectionqCDeeow.component2().booleanValue();
    ...
    public final boolean m914updateSelectionRHHTvR4$foundation_release(@Nullable Offset newPosition, @Nullable Offset previousPosition, boolean isStartHandle, @NotNull SelectionAdjustment adjustment) {
        Selection selection;
        Offset offsetM900convertToContainerCoordinatesQ7Q5hAU;
        Intrinsics.checkNotNullParameter(adjustment, "adjustment");
        ...
        if (selectable == null) {
            offsetM900convertToContainerCoordinatesQ7Q5hAU = null;
        } else {
            LayoutCoordinates layoutCoordinates = selectable.getLayoutCoordinates();
            Intrinsics.checkNotNull(layoutCoordinates);
            offsetM900convertToContainerCoordinatesQ7Q5hAU = m900convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, SelectionHandlesKt.m887getAdjustedCoordinatesk4lQ0M(selectable.mo869getHandlePositiondBAh8RU(selection, !isStartHandle)));
        }
        if (offsetM900convertToContainerCoordinatesQ7Q5hAU == null) {
            return false;
        }
        long packedValue = offsetM900convertToContainerCoordinatesQ7Q5hAU.getPackedValue();
        long packedValue2 = isStartHandle ? newPosition.getPackedValue() : packedValue;
        if (!isStartHandle) {
            packedValue = newPosition.getPackedValue();
        }
        return m913updateSelection3R_tFg$foundation_release(packedValue2, packedValue, previousPosition, isStartHandle, adjustment);
    }
}
