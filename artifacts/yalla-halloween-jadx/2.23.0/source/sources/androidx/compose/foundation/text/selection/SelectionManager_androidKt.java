...
public final class SelectionManager_androidKt {
    ...
    public static final boolean m921isCopyKeyEventZmokQxo(@NotNull KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        return KeyMapping_androidKt.getPlatformDefaultKeyMapping().mo753mapZmokQxo(keyEvent) == KeyCommand.COPY;
    }
    ...
    public static final class AnonymousClass1 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
        ...
        public static final void invoke$lambda$2(MutableState<IntSize> mutableState, long j) {
            mutableState.setValue(IntSize.m3917boximpl(j));
        }

        @Composable
        @NotNull
        public final Modifier invoke(@NotNull Modifier modifier, @Nullable Composer composer, int i) {
            if (OooOOO.OooO00o(modifier, "$this$composed", composer, -1914520728)) {
            ...
            if (objRememberedValue == companion.getEmpty()) {
                objRememberedValue = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m3917boximpl(IntSize.INSTANCE.m3930getZeroYbymL2g()), null, 2, null);
            ...
            Function0<Offset> function0 = new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt.selectionMagnifier.1.1
                ...
                public /* bridge */ /* synthetic */ Offset invoke() {
                    return Offset.m1425boximpl(m922invokeF1C5BW0());
                }

                /* JADX INFO: renamed from: invoke-F1C5BW0, reason: not valid java name */
                public final long m922invokeF1C5BW0() {
                    return SelectionManagerKt.m919calculateSelectionMagnifierCenterAndroidO0kMr_c(selectionManager, AnonymousClass1.invoke$lambda$1(mutableState));
                }
            };
                    ...
                    public final Modifier invoke2(@NotNull final Function0<Offset> center) {
                        ...
                        Function1<Density, Offset> function1 = new Function1<Density, Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$selectionMagnifier$1$2$1.1
                            ...
                            public /* bridge */ /* synthetic */ Offset invoke(Density density2) {
                                return Offset.m1425boximpl(m923invoketuRUvjQ(density2));
                            }

                            /* JADX INFO: renamed from: invoke-tuRUvjQ, reason: not valid java name */
                            public final long m923invoketuRUvjQ(@NotNull Density magnifier) {
                        ...
                        return MagnifierKt.magnifier$default(companion2, function1, null, 0.0f, textDefault, new Function1<DpSize, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$selectionMagnifier$1$2$1.2
                            ...
                            public /* bridge */ /* synthetic */ Unit invoke(DpSize dpSize) {
                                m924invokeEaSLcWc(dpSize.getPackedValue());
                                return Unit.INSTANCE;
                            }

                            /* JADX INFO: renamed from: invoke-EaSLcWc, reason: not valid java name */
                            public final void m924invokeEaSLcWc(long j) {
                                MutableState<IntSize> mutableState3 = mutableState2;
                                Density density3 = density2;
                                SelectionManager_androidKt.AnonymousClass1.invoke$lambda$2(mutableState3, IntSizeKt.IntSize(density3.mo318roundToPx0680j_4(DpSize.m3863getWidthD9Ej5fM(j)), density3.mo318roundToPx0680j_4(DpSize.m3861getHeightD9Ej5fM(j))));
                            }
                        }, 6, null);
                    }
                };
