...
public final class TextFieldSelectionManager {
    ...
    public final TextFieldValue m932createTextFieldValueFDrldGo(AnnotatedString annotatedString, long selection) {
    ...
    public static /* synthetic */ void m933deselect_kEHs6E$foundation_release$default(TextFieldSelectionManager textFieldSelectionManager, Offset offset, int i, Object obj) {
        if ((i & 1) != 0) {
            offset = null;
        }
        textFieldSelectionManager.m936deselect_kEHs6E$foundation_release(offset);
    }
    ...
    private final Rect getContentRect() {
        ...
        if (textFieldState != null) {
            ...
            if (textFieldState != null) {
                int iOriginalToTransformed = this.offsetMapping.originalToTransformed(TextRange.m3310getStartimpl(getValue$foundation_release().getSelection()));
                int iOriginalToTransformed2 = this.offsetMapping.originalToTransformed(TextRange.m3305getEndimpl(getValue$foundation_release().getSelection()));
                TextFieldState textFieldState2 = this.state;
                long jM1452getZeroF1C5BW0 = (textFieldState2 == null || (layoutCoordinates4 = textFieldState2.getLayoutCoordinates()) == null) ? Offset.INSTANCE.m1452getZeroF1C5BW0() : layoutCoordinates4.mo2803localToRootMKHz9U(m939getHandlePositiontuRUvjQ$foundation_release(true));
                TextFieldState textFieldState3 = this.state;
                long jM1452getZeroF1C5BW1 = (textFieldState3 == null || (layoutCoordinates3 = textFieldState3.getLayoutCoordinates()) == null) ? Offset.INSTANCE.m1452getZeroF1C5BW0() : layoutCoordinates3.mo2803localToRootMKHz9U(m939getHandlePositiontuRUvjQ$foundation_release(false));
                TextFieldState textFieldState4 = this.state;
                float fM1437getYimpl2 = 0.0f;
                if (textFieldState4 == null || (layoutCoordinates2 = textFieldState4.getLayoutCoordinates()) == null) {
                    fM1437getYimpl = 0.0f;
                } else {
                    TextLayoutResultProxy layoutResult = textFieldState.getLayoutResult();
                    fM1437getYimpl = Offset.m1437getYimpl(layoutCoordinates2.mo2803localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult == null || (value2 = layoutResult.getValue()) == null || (cursorRect2 = value2.getCursorRect(iOriginalToTransformed)) == null) ? 0.0f : cursorRect2.getTop())));
                }
                ...
                if (textFieldState5 != null && (layoutCoordinates = textFieldState5.getLayoutCoordinates()) != null) {
                    ...
                    fM1437getYimpl2 = Offset.m1437getYimpl(layoutCoordinates.mo2803localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult2 == null || (value = layoutResult2.getValue()) == null || (cursorRect = value.getCursorRect(iOriginalToTransformed2)) == null) ? 0.0f : cursorRect.getTop())));
                }
                return new Rect(Math.min(Offset.m1436getXimpl(jM1452getZeroF1C5BW0), Offset.m1436getXimpl(jM1452getZeroF1C5BW1)), Math.min(fM1437getYimpl, fM1437getYimpl2), Math.max(Offset.m1436getXimpl(jM1452getZeroF1C5BW0), Offset.m1436getXimpl(jM1452getZeroF1C5BW1)), (textFieldState.getTextDelegate().getDensity().getDensity() * Dp.m3765constructorimpl(25)) + Math.max(Offset.m1437getYimpl(jM1452getZeroF1C5BW0), Offset.m1437getYimpl(jM1452getZeroF1C5BW1)));
            }
        }
    ...
    public final void m934setCurrentDragPosition_kEHs6E(Offset offset) {
    ...
    public final void updateSelection(TextFieldValue value, int transformedStartOffset, int transformedEndOffset, boolean isStartHandle, SelectionAdjustment adjustment) {
        ...
        long jTextRange = TextRangeKt.TextRange(this.offsetMapping.originalToTransformed(TextRange.m3310getStartimpl(value.getSelection())), this.offsetMapping.originalToTransformed(TextRange.m3305getEndimpl(value.getSelection())));
        TextFieldState textFieldState = this.state;
        long jM929getTextFieldSelectionbb3KNj8 = TextFieldSelectionDelegateKt.m929getTextFieldSelectionbb3KNj8((textFieldState == null || (layoutResult = textFieldState.getLayoutResult()) == null) ? null : layoutResult.getValue(), transformedStartOffset, transformedEndOffset, TextRange.m3304getCollapsedimpl(jTextRange) ? null : TextRange.m3298boximpl(jTextRange), isStartHandle, adjustment);
        long jTextRange2 = TextRangeKt.TextRange(this.offsetMapping.transformedToOriginal(TextRange.m3310getStartimpl(jM929getTextFieldSelectionbb3KNj8)), this.offsetMapping.transformedToOriginal(TextRange.m3305getEndimpl(jM929getTextFieldSelectionbb3KNj8)));
        if (TextRange.m3303equalsimpl0(jTextRange2, value.getSelection())) {
            return;
        }
        HapticFeedback hapticFeedback = this.hapticFeedBack;
        if (hapticFeedback != null) {
            hapticFeedback.mo2238performHapticFeedbackCdsT49E(HapticFeedbackType.INSTANCE.m2247getTextHandleMove5zf0vsI());
        }
        this.onValueChange.invoke(m932createTextFieldValueFDrldGo(value.getAnnotatedString(), jTextRange2));
        TextFieldState textFieldState2 = this.state;
    ...
    public final void m935contextMenuOpenAdjustmentk4lQ0M(long position) {
        TextLayoutResultProxy layoutResult;
        TextFieldState textFieldState = this.state;
        if (textFieldState == null || (layoutResult = textFieldState.getLayoutResult()) == null) {
            return;
        }
        int iM827getOffsetForPosition3MmeM6k$default = TextLayoutResultProxy.m827getOffsetForPosition3MmeM6k$default(layoutResult, position, false, 2, null);
        if (TextRange.m3301containsimpl(getValue$foundation_release().getSelection(), iM827getOffsetForPosition3MmeM6k$default)) {
            return;
        }
        updateSelection(getValue$foundation_release(), iM827getOffsetForPosition3MmeM6k$default, iM827getOffsetForPosition3MmeM6k$default, false, SelectionAdjustment.INSTANCE.getWord());
    }

    public final void copy$foundation_release(boolean cancelSelection) {
        if (TextRange.m3304getCollapsedimpl(getValue$foundation_release().getSelection())) {
            return;
        }
        ...
        if (cancelSelection) {
            int iM3307getMaximpl = TextRange.m3307getMaximpl(getValue$foundation_release().getSelection());
            this.onValueChange.invoke(m932createTextFieldValueFDrldGo(getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(iM3307getMaximpl, iM3307getMaximpl)));
    ...
    public final TextDragObserver cursorDragObserver$foundation_release() {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$cursorDragObserver$1
            ...
            public void mo795onDownk4lQ0M(long point) {
                this.this$0.setDraggingHandle(Handle.Cursor);
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.m934setCurrentDragPosition_kEHs6E(Offset.m1425boximpl(SelectionHandlesKt.m887getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m939getHandlePositiontuRUvjQ$foundation_release(true))));
            }

            @Override // androidx.compose.foundation.text.TextDragObserver
            /* JADX INFO: renamed from: onDrag-k-4lQ0M */
            public void mo796onDragk4lQ0M(long delta) {
                TextLayoutResultProxy layoutResult;
                TextLayoutResult value;
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.dragTotalDistance = Offset.m1441plusMKHz9U(textFieldSelectionManager.dragTotalDistance, delta);
                ...
                textFieldSelectionManager2.m934setCurrentDragPosition_kEHs6E(Offset.m1425boximpl(Offset.m1441plusMKHz9U(textFieldSelectionManager2.dragBeginPosition, textFieldSelectionManager2.dragTotalDistance)));
                OffsetMapping offsetMapping = textFieldSelectionManager2.getOffsetMapping();
                Offset offsetM937getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m937getCurrentDragPosition_m7T9E();
                Intrinsics.checkNotNull(offsetM937getCurrentDragPosition_m7T9E);
                int iTransformedToOriginal = offsetMapping.transformedToOriginal(value.m3282getOffsetForPositionk4lQ0M(offsetM937getCurrentDragPosition_m7T9E.getPackedValue()));
                long jTextRange = TextRangeKt.TextRange(iTransformedToOriginal, iTransformedToOriginal);
                if (TextRange.m3303equalsimpl0(jTextRange, textFieldSelectionManager2.getValue$foundation_release().getSelection())) {
                    return;
                }
                ...
                textFieldSelectionManager2.getOnValueChange$foundation_release().invoke(textFieldSelectionManager2.m932createTextFieldValueFDrldGo(textFieldSelectionManager2.getValue$foundation_release().getAnnotatedString(), jTextRange));
            }

            @Override // androidx.compose.foundation.text.TextDragObserver
            /* JADX INFO: renamed from: onStart-k-4lQ0M */
            public void mo797onStartk4lQ0M(long startPoint) {
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.dragBeginPosition = SelectionHandlesKt.m887getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m939getHandlePositiontuRUvjQ$foundation_release(true));
                TextFieldSelectionManager textFieldSelectionManager2 = this.this$0;
                textFieldSelectionManager2.m934setCurrentDragPosition_kEHs6E(Offset.m1425boximpl(textFieldSelectionManager2.dragBeginPosition));
                this.this$0.dragTotalDistance = Offset.INSTANCE.m1452getZeroF1C5BW0();
                this.this$0.setDraggingHandle(Handle.Cursor);
            }
            ...
            public void onStop() {
                ...
                this.this$0.m934setCurrentDragPosition_kEHs6E(null);
            }
    ...
    public final void cut$foundation_release() {
        ...
        int iM3308getMinimpl = TextRange.m3308getMinimpl(getValue$foundation_release().getSelection());
        this.onValueChange.invoke(m932createTextFieldValueFDrldGo(annotatedStringPlus, TextRangeKt.TextRange(iM3308getMinimpl, iM3308getMinimpl)));
        setHandleState(HandleState.None);
    ...
    public final void m936deselect_kEHs6E$foundation_release(@Nullable Offset position) {
        HandleState handleState;
        if (!TextRange.m3304getCollapsedimpl(getValue$foundation_release().getSelection())) {
            TextFieldState textFieldState = this.state;
            TextLayoutResultProxy layoutResult = textFieldState != null ? textFieldState.getLayoutResult() : null;
            this.onValueChange.invoke(TextFieldValue.m3522copy3r_uNRQ$default(getValue$foundation_release(), (AnnotatedString) null, TextRangeKt.TextRange((position == null || layoutResult == null) ? TextRange.m3307getMaximpl(getValue$foundation_release().getSelection()) : this.offsetMapping.transformedToOriginal(TextLayoutResultProxy.m827getOffsetForPosition3MmeM6k$default(layoutResult, position.getPackedValue(), false, 2, null))), (TextRange) null, 5, (Object) null));
        }
        if (position == null) {
    ...
    public final Offset m937getCurrentDragPosition_m7T9E() {
        return (Offset) this.currentDragPosition.getValue();
    }

    /* JADX INFO: renamed from: getCursorPosition-tuRUvjQ$foundation_release, reason: not valid java name */
    public final long m938getCursorPositiontuRUvjQ$foundation_release(@NotNull Density density) {
        ...
        return OffsetKt.Offset((density.mo324toPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness()) / 2) + cursorRect.getLeft(), cursorRect.getBottom());
    }
    ...
    public final long m939getHandlePositiontuRUvjQ$foundation_release(boolean isStartHandle) {
        long selection = getValue$foundation_release().getSelection();
        int iM3310getStartimpl = isStartHandle ? TextRange.m3310getStartimpl(selection) : TextRange.m3305getEndimpl(selection);
        TextFieldState textFieldState = this.state;
        TextLayoutResultProxy layoutResult = textFieldState != null ? textFieldState.getLayoutResult() : null;
        Intrinsics.checkNotNull(layoutResult);
        return TextSelectionDelegateKt.getSelectionHandleCoordinates(layoutResult.getValue(), this.offsetMapping.originalToTransformed(iM3310getStartimpl), isStartHandle, TextRange.m3309getReversedimpl(getValue$foundation_release().getSelection()));
    }
    ...
    public final TextDragObserver handleDragObserver$foundation_release(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$handleDragObserver$1
            ...
            public void mo795onDownk4lQ0M(long point) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.m934setCurrentDragPosition_kEHs6E(Offset.m1425boximpl(SelectionHandlesKt.m887getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m939getHandlePositiontuRUvjQ$foundation_release(isStartHandle))));
            }
            ...
            public void mo796onDragk4lQ0M(long delta) {
                ...
                int iM3282getOffsetForPositionk4lQ0M;
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.dragTotalDistance = Offset.m1441plusMKHz9U(textFieldSelectionManager.dragTotalDistance, delta);
                TextFieldState state = this.this$0.getState();
                if (state != null && (layoutResult = state.getLayoutResult()) != null && (value = layoutResult.getValue()) != null) {
                    ...
                    if (z) {
                        Offset offsetM937getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m937getCurrentDragPosition_m7T9E();
                        Intrinsics.checkNotNull(offsetM937getCurrentDragPosition_m7T9E);
                        iOriginalToTransformed = value.m3282getOffsetForPositionk4lQ0M(offsetM937getCurrentDragPosition_m7T9E.getPackedValue());
                    } else {
                        iOriginalToTransformed = textFieldSelectionManager2.getOffsetMapping().originalToTransformed(TextRange.m3310getStartimpl(textFieldSelectionManager2.getValue$foundation_release().getSelection()));
                    }
                    int i = iOriginalToTransformed;
                    if (z) {
                        iM3282getOffsetForPositionk4lQ0M = textFieldSelectionManager2.getOffsetMapping().originalToTransformed(TextRange.m3305getEndimpl(textFieldSelectionManager2.getValue$foundation_release().getSelection()));
                    } else {
                        Offset offsetM937getCurrentDragPosition_m7T9E2 = textFieldSelectionManager2.m937getCurrentDragPosition_m7T9E();
                        Intrinsics.checkNotNull(offsetM937getCurrentDragPosition_m7T9E2);
                        iM3282getOffsetForPositionk4lQ0M = value.m3282getOffsetForPositionk4lQ0M(offsetM937getCurrentDragPosition_m7T9E2.getPackedValue());
                    }
                    textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), i, iM3282getOffsetForPositionk4lQ0M, z, SelectionAdjustment.INSTANCE.getCharacter());
                }
            ...
            public void mo797onStartk4lQ0M(long startPoint) {
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.dragBeginPosition = SelectionHandlesKt.m887getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m939getHandlePositiontuRUvjQ$foundation_release(isStartHandle));
                TextFieldSelectionManager textFieldSelectionManager2 = this.this$0;
                textFieldSelectionManager2.m934setCurrentDragPosition_kEHs6E(Offset.m1425boximpl(textFieldSelectionManager2.dragBeginPosition));
                this.this$0.dragTotalDistance = Offset.INSTANCE.m1452getZeroF1C5BW0();
                this.this$0.setDraggingHandle(isStartHandle ? Handle.SelectionStart : Handle.SelectionEnd);
    ...
    public final void paste$foundation_release() {
        ...
        int length = text.length() + TextRange.m3308getMinimpl(getValue$foundation_release().getSelection());
        this.onValueChange.invoke(m932createTextFieldValueFDrldGo(annotatedStringPlus, TextRangeKt.TextRange(length, length)));
        setHandleState(HandleState.None);
        UndoManager undoManager = this.undoManager;
        if (undoManager != null) {
            undoManager.forceNextSnapshot();
    ...
    public final void selectAll$foundation_release() {
        TextFieldValue textFieldValueM932createTextFieldValueFDrldGo = m932createTextFieldValueFDrldGo(getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(0, getValue$foundation_release().getText().length()));
        this.onValueChange.invoke(textFieldValueM932createTextFieldValueFDrldGo);
        this.oldValue = TextFieldValue.m3522copy3r_uNRQ$default(this.oldValue, (AnnotatedString) null, textFieldValueM932createTextFieldValueFDrldGo.getSelection(), (TextRange) null, 5, (Object) null);
        TextFieldState textFieldState = this.state;
        if (textFieldState == null) {
            return;
        }
    ...
    public final void showSelectionToolbar$foundation_release() {
        ...
        Function0<Unit> function1 = (TextRange.m3304getCollapsedimpl(getValue$foundation_release().getSelection()) || z) ? null : new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$copy$1
            {
                super(0);
            }
        ...
        Function0<Unit> function2 = (TextRange.m3304getCollapsedimpl(getValue$foundation_release().getSelection()) || !getEditable() || z) ? null : new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$cut$1
            {
                super(0);
            }
        ...
        Function0<Unit> function3 = TextRange.m3306getLengthimpl(getValue$foundation_release().getSelection()) != getValue$foundation_release().getText().length() ? new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$selectAll$1
            {
                super(0);
            }
    ...
    public TextFieldSelectionManager(@Nullable UndoManager undoManager) {
        ...
        this.dragBeginPosition = companion.m1452getZeroF1C5BW0();
        this.dragTotalDistance = companion.m1452getZeroF1C5BW0();
        ...
        this.touchSelectionObserver = new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$touchSelectionObserver$1
            ...
            public void mo796onDragk4lQ0M(long delta) {
                ...
                if (state != null && (layoutResult = state.getLayoutResult()) != null) {
                    ...
                    int iIntValue = num != null ? num.intValue() : layoutResult.m829getOffsetForPosition3MmeM6k(textFieldSelectionManager2.dragBeginPosition, false);
                    Offset offsetM937getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m937getCurrentDragPosition_m7T9E();
                    Intrinsics.checkNotNull(offsetM937getCurrentDragPosition_m7T9E);
                    textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), iIntValue, layoutResult.m829getOffsetForPosition3MmeM6k(offsetM937getCurrentDragPosition_m7T9E.getPackedValue(), false), false, SelectionAdjustment.INSTANCE.getWord());
                }
                TextFieldState state2 = this.this$0.getState();
                if (state2 == null) {
                    return;
            ...
            public void mo797onStartk4lQ0M(long startPoint) {
                ...
                this.this$0.hideSelectionToolbar$foundation_release();
                TextFieldState state2 = this.this$0.getState();
                if (!((state2 == null || (layoutResult3 = state2.getLayoutResult()) == null || !layoutResult3.m830isPositionOnTextk4lQ0M(startPoint)) ? false : true) && (state = this.this$0.getState()) != null && (layoutResult2 = state.getLayoutResult()) != null) {
                    TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                    int iTransformedToOriginal = textFieldSelectionManager.getOffsetMapping().transformedToOriginal(TextLayoutResultProxy.getLineEnd$default(layoutResult2, layoutResult2.getLineForVerticalPosition(Offset.m1437getYimpl(startPoint)), false, 2, null));
                    HapticFeedback hapticFeedBack = textFieldSelectionManager.getHapticFeedBack();
                    if (hapticFeedBack != null) {
                        hapticFeedBack.mo2238performHapticFeedbackCdsT49E(HapticFeedbackType.INSTANCE.m2247getTextHandleMove5zf0vsI());
                    }
                    TextFieldValue textFieldValueM932createTextFieldValueFDrldGo = textFieldSelectionManager.m932createTextFieldValueFDrldGo(textFieldSelectionManager.getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(iTransformedToOriginal, iTransformedToOriginal));
                    textFieldSelectionManager.enterSelectionMode$foundation_release();
                    textFieldSelectionManager.getOnValueChange$foundation_release().invoke(textFieldValueM932createTextFieldValueFDrldGo);
                    return;
                }
                if (this.this$0.getValue$foundation_release().getText().length() == 0) {
                    return;
                ...
                if (state3 != null && (layoutResult = state3.getLayoutResult()) != null) {
                    TextFieldSelectionManager textFieldSelectionManager2 = this.this$0;
                    int iM827getOffsetForPosition3MmeM6k$default = TextLayoutResultProxy.m827getOffsetForPosition3MmeM6k$default(layoutResult, startPoint, false, 2, null);
                    textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), iM827getOffsetForPosition3MmeM6k$default, iM827getOffsetForPosition3MmeM6k$default, false, SelectionAdjustment.INSTANCE.getWord());
                    textFieldSelectionManager2.dragBeginOffsetInText = Integer.valueOf(iM827getOffsetForPosition3MmeM6k$default);
                }
                this.this$0.dragBeginPosition = startPoint;
                TextFieldSelectionManager textFieldSelectionManager3 = this.this$0;
                textFieldSelectionManager3.m934setCurrentDragPosition_kEHs6E(Offset.m1425boximpl(textFieldSelectionManager3.dragBeginPosition));
                this.this$0.dragTotalDistance = Offset.INSTANCE.m1452getZeroF1C5BW0();
            }
        ...
        this.mouseSelectionObserver = new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$mouseSelectionObserver$1
            ...
            public boolean mo856onDrag3MmeM6k(long dragPosition, @NotNull SelectionAdjustment adjustment) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                int iM829getOffsetForPosition3MmeM6k = layoutResult.m829getOffsetForPosition3MmeM6k(dragPosition, false);
                ...
                textFieldSelectionManager.updateSelection(value$foundation_release, num.intValue(), iM829getOffsetForPosition3MmeM6k, false, adjustment);
                return true;
            }
            ...
            public boolean mo858onExtendDragk4lQ0M(long dragPosition) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.updateSelection(textFieldSelectionManager.getValue$foundation_release(), textFieldSelectionManager.getOffsetMapping().originalToTransformed(TextRange.m3310getStartimpl(textFieldSelectionManager.getValue$foundation_release().getSelection())), layoutResult.m829getOffsetForPosition3MmeM6k(dragPosition, false), false, SelectionAdjustment.INSTANCE.getNone());
                return true;
            }
            ...
            public boolean mo859onStart3MmeM6k(long downPosition, @NotNull SelectionAdjustment adjustment) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.dragBeginOffsetInText = Integer.valueOf(TextLayoutResultProxy.m827getOffsetForPosition3MmeM6k$default(layoutResult, downPosition, false, 2, null));
                int iM827getOffsetForPosition3MmeM6k$default = TextLayoutResultProxy.m827getOffsetForPosition3MmeM6k$default(layoutResult, textFieldSelectionManager.dragBeginPosition, false, 2, null);
                textFieldSelectionManager.updateSelection(textFieldSelectionManager.getValue$foundation_release(), iM827getOffsetForPosition3MmeM6k$default, iM827getOffsetForPosition3MmeM6k$default, false, adjustment);
                return true;
            }
        };
    }
