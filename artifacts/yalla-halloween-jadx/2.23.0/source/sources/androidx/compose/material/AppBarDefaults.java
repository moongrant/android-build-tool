...
public final class AppBarDefaults {
    ...
    private static final float TopAppBarElevation = Dp.m3765constructorimpl(4);
    private static final float BottomAppBarElevation = Dp.m3765constructorimpl(8);

    @NotNull
    private static final PaddingValues ContentPadding = PaddingKt.m473PaddingValuesa9UjIt4$default(AppBarKt.AppBarHorizontalPadding, 0.0f, AppBarKt.AppBarHorizontalPadding, 0.0f, 10, null);

    private AppBarDefaults() {
    }

    /* JADX INFO: renamed from: getBottomAppBarElevation-D9Ej5fM, reason: not valid java name */
    public final float m951getBottomAppBarElevationD9Ej5fM() {
    ...
    public final float m952getTopAppBarElevationD9Ej5fM() {
