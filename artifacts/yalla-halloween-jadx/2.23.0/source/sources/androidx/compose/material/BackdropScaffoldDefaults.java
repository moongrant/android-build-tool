...
public final class BackdropScaffoldDefaults {
    ...
    private static final float PeekHeight = Dp.m3765constructorimpl(56);
    private static final float HeaderHeight = Dp.m3765constructorimpl(48);
    private static final float FrontLayerElevation = Dp.m3765constructorimpl(1);

    private BackdropScaffoldDefaults() {
    }

    /* JADX INFO: renamed from: getFrontLayerElevation-D9Ej5fM, reason: not valid java name */
    public final float m958getFrontLayerElevationD9Ej5fM() {
    ...
    public final long getFrontLayerScrimColor(@Nullable Composer composer, int i) {
        ...
        long jM1669copywmQWz5c$default = Color.m1669copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1027getSurface0d7_KjU(), 0.6f, 0.0f, 0.0f, 0.0f, 14, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return jM1669copywmQWz5c$default;
    }
    ...
    public final Shape getFrontLayerShape(@Nullable Composer composer, int i) {
        ...
        float f = 16;
        CornerBasedShape cornerBasedShapeCopy$default = CornerBasedShape.copy$default(MaterialTheme.INSTANCE.getShapes(composer, 6).getLarge(), CornerSizeKt.m719CornerSize0680j_4(Dp.m3765constructorimpl(f)), CornerSizeKt.m719CornerSize0680j_4(Dp.m3765constructorimpl(f)), null, null, 12, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final float m959getHeaderHeightD9Ej5fM() {
        return HeaderHeight;
    }

    /* JADX INFO: renamed from: getPeekHeight-D9Ej5fM, reason: not valid java name */
    public final float m960getPeekHeightD9Ej5fM() {
        return PeekHeight;
    }
}
