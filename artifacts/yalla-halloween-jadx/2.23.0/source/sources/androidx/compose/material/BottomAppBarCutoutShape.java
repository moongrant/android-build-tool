...
final /* data */ class BottomAppBarCutoutShape implements Shape {
    ...
    private final void addCutoutShape(Path path, LayoutDirection layoutDirection, Density density) {
        float fMo324toPx0680j_4 = density.mo324toPx0680j_4(AppBarKt.BottomAppBarCutoutOffset);
        float f = 2 * fMo324toPx0680j_4;
        long jSize = SizeKt.Size(this.fabPlacement.getWidth() + f, this.fabPlacement.getHeight() + f);
        float left = this.fabPlacement.getLeft() - fMo324toPx0680j_4;
        float fM1505getWidthimpl = Size.m1505getWidthimpl(jSize) + left;
        float fM1502getHeightimpl = Size.m1502getHeightimpl(jSize) / 2.0f;
        OutlineKt.addOutline(path, this.cutoutShape.mo218createOutlinePq9zytI(jSize, layoutDirection, density));
        path.mo1573translatek4lQ0M(OffsetKt.Offset(left, -fM1502getHeightimpl));
        if (Intrinsics.areEqual(this.cutoutShape, RoundedCornerShapeKt.getCircleShape())) {
            addRoundedEdges(path, left, fM1505getWidthimpl, fM1502getHeightimpl, density.mo324toPx0680j_4(AppBarKt.BottomAppBarRoundedEdgeRadius), 0.0f);
        }
    }
    ...
    public Outline mo218createOutlinePq9zytI(long size, @NotNull LayoutDirection layoutDirection, @NotNull Density density) {
        ...
        Path.addRect(new Rect(0.0f, 0.0f, Size.m1505getWidthimpl(size), Size.m1502getHeightimpl(size)));
        Path Path2 = AndroidPath_androidKt.Path();
        addCutoutShape(Path2, layoutDirection, density);
        Path2.mo1570opN5in7k0(Path, Path2, PathOperation.INSTANCE.m1934getDifferenceb3I0S0c());
