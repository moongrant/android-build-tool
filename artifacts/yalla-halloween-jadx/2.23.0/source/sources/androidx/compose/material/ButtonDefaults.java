...
public final class ButtonDefaults {
    ...
    static {
        float fM3765constructorimpl = Dp.m3765constructorimpl(16);
        ButtonHorizontalPadding = fM3765constructorimpl;
        float f = 8;
        float fM3765constructorimpl2 = Dp.m3765constructorimpl(f);
        ButtonVerticalPadding = fM3765constructorimpl2;
        PaddingValues paddingValuesM472PaddingValuesa9UjIt4 = PaddingKt.m472PaddingValuesa9UjIt4(fM3765constructorimpl, fM3765constructorimpl2, fM3765constructorimpl, fM3765constructorimpl2);
        ContentPadding = paddingValuesM472PaddingValuesa9UjIt4;
        MinWidth = Dp.m3765constructorimpl(64);
        MinHeight = Dp.m3765constructorimpl(36);
        IconSize = Dp.m3765constructorimpl(18);
        IconSpacing = Dp.m3765constructorimpl(f);
        OutlinedBorderSize = Dp.m3765constructorimpl(1);
        float fM3765constructorimpl3 = Dp.m3765constructorimpl(f);
        TextButtonHorizontalPadding = fM3765constructorimpl3;
        TextButtonContentPadding = PaddingKt.m472PaddingValuesa9UjIt4(fM3765constructorimpl3, paddingValuesM472PaddingValuesa9UjIt4.getTop(), fM3765constructorimpl3, paddingValuesM472PaddingValuesa9UjIt4.getBottom());
    }
    ...
    public final ButtonColors m988buttonColorsro_MJ88(long j, long j2, long j3, long j4, @Nullable Composer composer, int i, int i2) {
        long jM1715compositeOverOWjLjI;
        composer.startReplaceableGroup(1870371134);
        long jM1023getPrimary0d7_KjU = (i2 & 1) != 0 ? MaterialTheme.INSTANCE.getColors(composer, 6).m1023getPrimary0d7_KjU() : j;
        long jM1041contentColorForek8zF_U = (i2 & 2) != 0 ? ColorsKt.m1041contentColorForek8zF_U(jM1023getPrimary0d7_KjU, composer, i & 14) : j2;
        if ((i2 & 4) != 0) {
            ...
            jM1715compositeOverOWjLjI = j3;
        }
        long jM1669copywmQWz5c$default = (i2 & 8) != 0 ? Color.m1669copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1022getOnSurface0d7_KjU(), ContentAlpha.INSTANCE.getDisabled(composer, 6), 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1870371134, i, -1, "androidx.compose.material.ButtonDefaults.buttonColors (Button.kt:405)");
        }
        DefaultButtonColors defaultButtonColors = new DefaultButtonColors(jM1023getPrimary0d7_KjU, jM1041contentColorForek8zF_U, jM1715compositeOverOWjLjI, jM1669copywmQWz5c$default, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ButtonElevation m989elevationR_JCAzs(float f, float f2, float f3, float f4, float f5, @Nullable Composer composer, int i, int i2) {
        composer.startReplaceableGroup(-737170518);
        float fM3765constructorimpl = (i2 & 1) != 0 ? Dp.m3765constructorimpl(2) : f;
        float fM3765constructorimpl2 = (i2 & 2) != 0 ? Dp.m3765constructorimpl(8) : f2;
        float fM3765constructorimpl3 = (i2 & 4) != 0 ? Dp.m3765constructorimpl(0) : f3;
        float fM3765constructorimpl4 = (i2 & 8) != 0 ? Dp.m3765constructorimpl(4) : f4;
        float fM3765constructorimpl5 = (i2 & 16) != 0 ? Dp.m3765constructorimpl(4) : f5;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-737170518, i, -1, "androidx.compose.material.ButtonDefaults.elevation (Button.kt:371)");
        }
        Object[] objArr = {Dp.m3763boximpl(fM3765constructorimpl), Dp.m3763boximpl(fM3765constructorimpl2), Dp.m3763boximpl(fM3765constructorimpl3), Dp.m3763boximpl(fM3765constructorimpl4), Dp.m3763boximpl(fM3765constructorimpl5)};
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new DefaultButtonElevation(fM3765constructorimpl, fM3765constructorimpl2, fM3765constructorimpl3, fM3765constructorimpl4, fM3765constructorimpl5, null);
    ...
    public final /* synthetic */ ButtonElevation m990elevationyajeYGU(float f, float f2, float f3, Composer composer, int i, int i2) {
        ...
        float f4 = 4;
        ButtonElevation buttonElevationM989elevationR_JCAzs = m989elevationR_JCAzs(fM3765constructorimpl, fM3765constructorimpl2, fM3765constructorimpl3, Dp.m3765constructorimpl(f4), Dp.m3765constructorimpl(f4), composer, (i & 14) | 27648 | (i & 112) | (i & 896) | ((i << 6) & 458752), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return buttonElevationM989elevationR_JCAzs;
    }
    ...
    public final float m991getIconSizeD9Ej5fM() {
        return IconSize;
    }

    /* JADX INFO: renamed from: getIconSpacing-D9Ej5fM, reason: not valid java name */
    public final float m992getIconSpacingD9Ej5fM() {
        return IconSpacing;
    }

    /* JADX INFO: renamed from: getMinHeight-D9Ej5fM, reason: not valid java name */
    public final float m993getMinHeightD9Ej5fM() {
        return MinHeight;
    }

    /* JADX INFO: renamed from: getMinWidth-D9Ej5fM, reason: not valid java name */
    public final float m994getMinWidthD9Ej5fM() {
        return MinWidth;
    }
    ...
    public final float m995getOutlinedBorderSizeD9Ej5fM() {
    ...
    public final ButtonColors m996outlinedButtonColorsRGew2ao(long j, long j2, long j3, @Nullable Composer composer, int i, int i2) {
        ...
        long jM1023getPrimary0d7_KjU = (i2 & 2) != 0 ? MaterialTheme.INSTANCE.getColors(composer, 6).m1023getPrimary0d7_KjU() : j2;
        long jM1669copywmQWz5c$default = (i2 & 4) != 0 ? Color.m1669copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1022getOnSurface0d7_KjU(), ContentAlpha.INSTANCE.getDisabled(composer, 6), 0.0f, 0.0f, 0.0f, 14, null) : j3;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-2124406093, i, -1, "androidx.compose.material.ButtonDefaults.outlinedButtonColors (Button.kt:428)");
        }
        DefaultButtonColors defaultButtonColors = new DefaultButtonColors(jM1027getSurface0d7_KjU, jM1023getPrimary0d7_KjU, jM1027getSurface0d7_KjU, jM1669copywmQWz5c$default, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ButtonColors m997textButtonColorsRGew2ao(long j, long j2, long j3, @Nullable Composer composer, int i, int i2) {
        composer.startReplaceableGroup(182742216);
        long jM1705getTransparent0d7_KjU = (i2 & 1) != 0 ? Color.INSTANCE.m1705getTransparent0d7_KjU() : j;
        long jM1023getPrimary0d7_KjU = (i2 & 2) != 0 ? MaterialTheme.INSTANCE.getColors(composer, 6).m1023getPrimary0d7_KjU() : j2;
        long jM1669copywmQWz5c$default = (i2 & 4) != 0 ? Color.m1669copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1022getOnSurface0d7_KjU(), ContentAlpha.INSTANCE.getDisabled(composer, 6), 0.0f, 0.0f, 0.0f, 14, null) : j3;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(182742216, i, -1, "androidx.compose.material.ButtonDefaults.textButtonColors (Button.kt:449)");
        }
        DefaultButtonColors defaultButtonColors = new DefaultButtonColors(jM1705getTransparent0d7_KjU, jM1023getPrimary0d7_KjU, jM1705getTransparent0d7_KjU, jM1669copywmQWz5c$default, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
