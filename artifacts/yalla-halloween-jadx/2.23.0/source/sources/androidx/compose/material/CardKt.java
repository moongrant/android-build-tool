...
public final class CardKt {
    ...
    public static final void m998Card9VG74zQ(@NotNull Function0<Unit> onClick, @Nullable Modifier modifier, @Nullable Shape shape, long j, long j2, @Nullable BorderStroke borderStroke, float f, @Nullable MutableInteractionSource mutableInteractionSource, @Nullable Indication indication, boolean z, @Nullable String str, @Nullable Role role, @NotNull Function2<? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, int i, int i2, int i3) {
        ...
        long jM1027getSurface0d7_KjU = (i3 & 8) != 0 ? MaterialTheme.INSTANCE.getColors(composer, 6).m1027getSurface0d7_KjU() : j;
        long jM1041contentColorForek8zF_U = (i3 & 16) != 0 ? ColorsKt.m1041contentColorForek8zF_U(jM1027getSurface0d7_KjU, composer, (i >> 9) & 14) : j2;
        BorderStroke borderStroke2 = (i3 & 32) != 0 ? null : borderStroke;
        float fM3765constructorimpl = (i3 & 64) != 0 ? Dp.m3765constructorimpl(1) : f;
        if ((i3 & 128) != 0) {
        ...
        SurfaceKt.m1184Surface9VG74zQ(onClick, modifier2, medium, jM1027getSurface0d7_KjU, jM1041contentColorForek8zF_U, borderStroke2, fM3765constructorimpl, mutableInteractionSource2, indication2, z2, str2, role2, content, composer, (i & 14) | (i & 112) | (i & 896) | (i & 7168) | (57344 & i) | (458752 & i) | (3670016 & i) | (29360128 & i) | (234881024 & i) | (i & 1879048192), (i2 & 14) | (i2 & 112) | (i2 & 896), 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m999CardFjzlyU(@Nullable Modifier modifier, @Nullable Shape shape, long j, long j2, @Nullable BorderStroke borderStroke, float f, @NotNull Function2<? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, int i, int i2) {
        Intrinsics.checkNotNullParameter(content, "content");
        ...
        long jM1027getSurface0d7_KjU = (i2 & 4) != 0 ? MaterialTheme.INSTANCE.getColors(composer, 6).m1027getSurface0d7_KjU() : j;
        long jM1041contentColorForek8zF_U = (i2 & 8) != 0 ? ColorsKt.m1041contentColorForek8zF_U(jM1027getSurface0d7_KjU, composer, (i >> 6) & 14) : j2;
        BorderStroke borderStroke2 = (i2 & 16) != 0 ? null : borderStroke;
        float fM3765constructorimpl = (i2 & 32) != 0 ? Dp.m3765constructorimpl(1) : f;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1956755640, i, -1, "androidx.compose.material.Card (Card.kt:58)");
        }
        SurfaceKt.m1185SurfaceFjzlyU(modifier2, medium, jM1027getSurface0d7_KjU, jM1041contentColorForek8zF_U, borderStroke2, fM3765constructorimpl, content, composer, (i & 14) | (i & 112) | (i & 896) | (i & 7168) | (57344 & i) | (458752 & i) | (i & 3670016), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final void m1000CardLPr_se0(@NotNull Function0<Unit> onClick, @Nullable Modifier modifier, boolean z, @Nullable Shape shape, long j, long j2, @Nullable BorderStroke borderStroke, float f, @Nullable MutableInteractionSource mutableInteractionSource, @NotNull Function2<? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, int i, int i2) {
        ...
        long jM1027getSurface0d7_KjU = (i2 & 16) != 0 ? MaterialTheme.INSTANCE.getColors(composer, 6).m1027getSurface0d7_KjU() : j;
        long jM1041contentColorForek8zF_U = (i2 & 32) != 0 ? ColorsKt.m1041contentColorForek8zF_U(jM1027getSurface0d7_KjU, composer, (i >> 12) & 14) : j2;
        BorderStroke borderStroke2 = (i2 & 64) != 0 ? null : borderStroke;
        float fM3765constructorimpl = (i2 & 128) != 0 ? Dp.m3765constructorimpl(1) : f;
        ...
        SurfaceKt.m1186SurfaceLPr_se0(onClick, modifier2, z2, medium, jM1027getSurface0d7_KjU, jM1041contentColorForek8zF_U, borderStroke2, fM3765constructorimpl, mutableInteractionSource2, content, composer, (i & 14) | (i & 112) | (i & 896) | (i & 7168) | (57344 & i) | (458752 & i) | (3670016 & i) | (29360128 & i) | (234881024 & i) | (i & 1879048192), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
