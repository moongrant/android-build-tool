...
public final class ComposableSingletons$BackdropScaffoldKt {
    ...
    @NotNull
    public static Function3<SnackbarHostState, Composer, Integer, Unit> f8lambda1 = ComposableLambdaKt.composableLambdaInstance(229445492, false, new Function3<SnackbarHostState, Composer, Integer, Unit>() { // from class: androidx.compose.material.ComposableSingletons$BackdropScaffoldKt$lambda-1$1
    ...
    public final Function3<SnackbarHostState, Composer, Integer, Unit> m1047getLambda1$material_release() {
        return f8lambda1;
    }
}
