...
final class DefaultButtonColors implements ButtonColors {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Color.m1671equalsimpl0(this.backgroundColor, defaultButtonColors.backgroundColor) && Color.m1671equalsimpl0(this.contentColor, defaultButtonColors.contentColor) && Color.m1671equalsimpl0(this.disabledBackgroundColor, defaultButtonColors.disabledBackgroundColor) && Color.m1671equalsimpl0(this.disabledContentColor, defaultButtonColors.disabledContentColor);
    }

    public int hashCode() {
        return Color.m1677hashCodeimpl(this.disabledContentColor) + OooOO0O.OooO0O0(this.disabledBackgroundColor, OooOO0O.OooO0O0(this.contentColor, Color.m1677hashCodeimpl(this.backgroundColor) * 31, 31), 31);
    }
