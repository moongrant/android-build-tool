...
final class DefaultButtonElevation implements ButtonElevation {
    ...
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                ...
                Dp dpM3763boximpl = Dp.m3763boximpl(this.$target);
                this.label = 1;
                if (animatable.snapTo(dpM3763boximpl, this) == coroutine_suspended) {
    ...
    public State<Dp> elevation(boolean z, @NotNull InteractionSource interactionSource, @Nullable Composer composer, int i) {
        ...
        if (z) {
            ...
            EffectsKt.LaunchedEffect(Dp.m3763boximpl(f2), new AnonymousClass3(animatable, this, f2, interaction, null), composer, 64);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-1598807317);
            EffectsKt.LaunchedEffect(Dp.m3763boximpl(f2), new AnonymousClass2(animatable, f2, null), composer, 64);
            composer.endReplaceableGroup();
        }
