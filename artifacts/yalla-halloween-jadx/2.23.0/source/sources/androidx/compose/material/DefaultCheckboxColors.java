...
final class DefaultCheckboxColors implements CheckboxColors {
    ...
    public State<Color> borderColor(boolean z, @NotNull ToggleableState state, @Nullable Composer composer, int i) {
        ...
        if (z) {
            ...
            stateRememberUpdatedState = SingleValueAnimationKt.m57animateColorAsStateKTwxG1Y(j2, AnimationSpecKt.tween$default(state == ToggleableState.Off ? 100 : 50, 0, null, 6, null), null, composer, 0, 4);
    ...
    public State<Color> checkmarkColor(@NotNull ToggleableState state, @Nullable Composer composer, int i) {
        ...
        State<Color> stateM57animateColorAsStateKTwxG1Y = SingleValueAnimationKt.m57animateColorAsStateKTwxG1Y(state == toggleableState ? this.uncheckedCheckmarkColor : this.checkedCheckmarkColor, AnimationSpecKt.tween$default(state == toggleableState ? 100 : 50, 0, null, 6, null), null, composer, 0, 4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return stateM57animateColorAsStateKTwxG1Y;
    }
