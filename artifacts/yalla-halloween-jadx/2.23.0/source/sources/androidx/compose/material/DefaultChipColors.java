...
final class DefaultChipColors implements ChipColors {
    ...
    public State<Color> backgroundColor(boolean z, @Nullable Composer composer, int i) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1660boximpl(z ? this.backgroundColor : this.disabledBackgroundColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public State<Color> contentColor(boolean z, @Nullable Composer composer, int i) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1660boximpl(z ? this.contentColor : this.disabledContentColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Color.m1671equalsimpl0(this.backgroundColor, defaultChipColors.backgroundColor) && Color.m1671equalsimpl0(this.contentColor, defaultChipColors.contentColor) && Color.m1671equalsimpl0(this.leadingIconContentColor, defaultChipColors.leadingIconContentColor) && Color.m1671equalsimpl0(this.disabledBackgroundColor, defaultChipColors.disabledBackgroundColor) && Color.m1671equalsimpl0(this.disabledContentColor, defaultChipColors.disabledContentColor) && Color.m1671equalsimpl0(this.disabledLeadingIconContentColor, defaultChipColors.disabledLeadingIconContentColor);
    }

    public int hashCode() {
        return Color.m1677hashCodeimpl(this.disabledLeadingIconContentColor) + OooOO0O.OooO0O0(this.disabledContentColor, OooOO0O.OooO0O0(this.disabledBackgroundColor, OooOO0O.OooO0O0(this.leadingIconContentColor, OooOO0O.OooO0O0(this.contentColor, Color.m1677hashCodeimpl(this.backgroundColor) * 31, 31), 31), 31), 31);
    }
    ...
    public State<Color> leadingIconContentColor(boolean z, @Nullable Composer composer, int i) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1660boximpl(z ? this.leadingIconContentColor : this.disabledLeadingIconContentColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
