...
final class DefaultElevationOverlay implements ElevationOverlay {
    ...
    public long mo1057apply7g2Lkgo(long j, float f, @Nullable Composer composer, int i) {
        ...
        if (Dp.m3764compareTo0680j_4(f, Dp.m3765constructorimpl(0)) > 0 && !colors.isLight()) {
            j = ColorKt.m1715compositeOverOWjLjI(ElevationOverlayKt.m1082calculateForegroundColorCLU3JFs(j, f, composer, (i & 112) | (i & 14)), j);
        }
        if (ComposerKt.isTraceInProgress()) {
