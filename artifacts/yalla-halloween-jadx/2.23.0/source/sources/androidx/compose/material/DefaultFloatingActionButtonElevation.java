...
final class DefaultFloatingActionButtonElevation implements FloatingActionButtonElevation {
    ...
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                ...
                float fM3779unboximpl = this.$animatable.getTargetValue().m3779unboximpl();
                Interaction focus = null;
                if (Dp.m3770equalsimpl0(fM3779unboximpl, this.this$0.pressedElevation)) {
                    focus = new PressInteraction.Press(Offset.INSTANCE.m1452getZeroF1C5BW0(), null);
                } else if (Dp.m3770equalsimpl0(fM3779unboximpl, this.this$0.hoveredElevation)) {
                    focus = new HoverInteraction.Enter();
                } else if (Dp.m3770equalsimpl0(fM3779unboximpl, this.this$0.focusedElevation)) {
                ...
                this.label = 1;
                if (ElevationKt.m1079animateElevationrAjV9yQ(animatable, f, focus, interaction, this) == coroutine_suspended) {
    ...
    public State<Dp> elevation(@NotNull InteractionSource interactionSource, @Nullable Composer composer, int i) {
        ...
        if (objRememberedValue3 == companion.getEmpty()) {
            objRememberedValue3 = new Animatable(Dp.m3763boximpl(f2), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, 4, null);
            composer.updateRememberedValue(objRememberedValue3);
        }
        composer.endReplaceableGroup();
        Animatable animatable = (Animatable) objRememberedValue3;
        EffectsKt.LaunchedEffect(Dp.m3763boximpl(f2), new AnonymousClass2(animatable, this, f2, interaction, null), composer, 64);
