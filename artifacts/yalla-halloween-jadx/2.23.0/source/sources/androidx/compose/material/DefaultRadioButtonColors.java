...
final class DefaultRadioButtonColors implements RadioButtonColors {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Color.m1671equalsimpl0(this.selectedColor, defaultRadioButtonColors.selectedColor) && Color.m1671equalsimpl0(this.unselectedColor, defaultRadioButtonColors.unselectedColor) && Color.m1671equalsimpl0(this.disabledColor, defaultRadioButtonColors.disabledColor);
    }

    public int hashCode() {
        return Color.m1677hashCodeimpl(this.disabledColor) + OooOO0O.OooO0O0(this.unselectedColor, Color.m1677hashCodeimpl(this.selectedColor) * 31, 31);
    }
    ...
    public State<Color> radioColor(boolean z, boolean z2, @Nullable Composer composer, int i) {
        ...
        if (z) {
            ...
            stateRememberUpdatedState = SingleValueAnimationKt.m57animateColorAsStateKTwxG1Y(j2, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, composer, 48, 4);
