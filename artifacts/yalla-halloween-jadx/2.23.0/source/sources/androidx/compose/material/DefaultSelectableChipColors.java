...
final class DefaultSelectableChipColors implements SelectableChipColors {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Color.m1671equalsimpl0(this.backgroundColor, defaultSelectableChipColors.backgroundColor) && Color.m1671equalsimpl0(this.contentColor, defaultSelectableChipColors.contentColor) && Color.m1671equalsimpl0(this.leadingIconColor, defaultSelectableChipColors.leadingIconColor) && Color.m1671equalsimpl0(this.disabledBackgroundColor, defaultSelectableChipColors.disabledBackgroundColor) && Color.m1671equalsimpl0(this.disabledContentColor, defaultSelectableChipColors.disabledContentColor) && Color.m1671equalsimpl0(this.disabledLeadingIconColor, defaultSelectableChipColors.disabledLeadingIconColor) && Color.m1671equalsimpl0(this.selectedBackgroundColor, defaultSelectableChipColors.selectedBackgroundColor) && Color.m1671equalsimpl0(this.selectedContentColor, defaultSelectableChipColors.selectedContentColor) && Color.m1671equalsimpl0(this.selectedLeadingIconColor, defaultSelectableChipColors.selectedLeadingIconColor);
    }

    public int hashCode() {
        return Color.m1677hashCodeimpl(this.selectedLeadingIconColor) + OooOO0O.OooO0O0(this.selectedContentColor, OooOO0O.OooO0O0(this.selectedBackgroundColor, OooOO0O.OooO0O0(this.disabledLeadingIconColor, OooOO0O.OooO0O0(this.disabledContentColor, OooOO0O.OooO0O0(this.disabledBackgroundColor, OooOO0O.OooO0O0(this.leadingIconColor, OooOO0O.OooO0O0(this.contentColor, Color.m1677hashCodeimpl(this.backgroundColor) * 31, 31), 31), 31), 31), 31), 31), 31);
    }
