...
public final class DividerKt {
    ...
    public static final void m1058DivideroMI9zvI(@Nullable Modifier modifier, long j, float f, float f2, @Nullable Composer composer, final int i, final int i2) {
        Modifier modifier2;
        int i3;
        long j2;
        ...
        if (i7 == 0) {
            ...
            if (i4 != 0) {
                ...
                if ((i3 & 5851) == 1170 || !composerStartRestartGroup.getSkipping()) {
                    ...
                    if ((i & 1) != 0 || composerStartRestartGroup.getDefaultsInvalid()) {
                        ...
                        if ((i2 & 2) != 0) {
                            jM1669copywmQWz5c$default = Color.m1669copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composerStartRestartGroup, 6).m1022getOnSurface0d7_KjU(), 0.12f, 0.0f, 0.0f, 0.0f, 14, null);
                        } else {
                    ...
                    if (fM3765constructorimpl2 == 0.0f) {
                        z = true;
                    } else {
                        z = false;
                    }
                    if (z) {
                        modifierM480paddingqDBjuR0$default = Modifier.INSTANCE;
                    } else {
                        modifierM480paddingqDBjuR0$default = PaddingKt.m480paddingqDBjuR0$default(Modifier.INSTANCE, fM3765constructorimpl2, 0.0f, 0.0f, 0.0f, 14, null);
                    }
                    composerStartRestartGroup.startReplaceableGroup(1228914189);
                    if (Dp.m3770equalsimpl0(fM3765constructorimpl, Dp.INSTANCE.m3783getHairlineD9Ej5fM())) {
                        fM3765constructorimpl3 = Dp.m3765constructorimpl(1.0f / ((Density) composerStartRestartGroup.consume(CompositionLocalsKt.getLocalDensity())).getDensity());
                    } else {
                        fM3765constructorimpl3 = fM3765constructorimpl;
                    }
                    composerStartRestartGroup.endReplaceableGroup();
                    BoxKt.Box(BackgroundKt.m169backgroundbw27NRU$default(SizeKt.m509height3ABfNKs(SizeKt.fillMaxWidth$default(modifier3.then(modifierM480paddingqDBjuR0$default), 0.0f, 1, null), fM3765constructorimpl3), jM1669copywmQWz5c$default, null, 2, null), composerStartRestartGroup, 0);
                    if (ComposerKt.isTraceInProgress()) {
                ...
                final float f4 = fM3765constructorimpl;
                scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.DividerKt$Divider$1
                    ...
                    public final void invoke(@Nullable Composer composer2, int i8) {
                        DividerKt.m1058DivideroMI9zvI(modifier4, j3, f4, f3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                    }
                });
            }
            i3 |= 3072;
            ...
            final long j4 = jM1669copywmQWz5c$default;
            final float f5 = fM3765constructorimpl;
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.DividerKt$Divider$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                ...
                public final void invoke(@Nullable Composer composer2, int i8) {
                    DividerKt.m1058DivideroMI9zvI(modifier5, j4, f5, f3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
        i3 |= 384;
        ...
        if (i4 != 0) {
            ...
            final float f6 = fM3765constructorimpl;
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.DividerKt$Divider$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                ...
                public final void invoke(@Nullable Composer composer2, int i8) {
                    DividerKt.m1058DivideroMI9zvI(modifier6, j5, f6, f3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
        i3 |= 3072;
        ...
        final float f7 = fM3765constructorimpl;
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.DividerKt$Divider$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            ...
            public final void invoke(@Nullable Composer composer2, int i8) {
                DividerKt.m1058DivideroMI9zvI(modifier7, j6, f7, f3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
}
