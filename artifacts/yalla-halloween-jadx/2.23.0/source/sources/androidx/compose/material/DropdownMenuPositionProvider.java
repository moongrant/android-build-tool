...
public final /* data */ class DropdownMenuPositionProvider implements PopupPositionProvider {
    ...
    public static /* synthetic */ DropdownMenuPositionProvider m1075copyrOJDEFc$default(DropdownMenuPositionProvider dropdownMenuPositionProvider, long j, Density density, Function2 function2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return dropdownMenuPositionProvider.m1077copyrOJDEFc(j, density, function2);
    }
    ...
    public long mo868calculatePositionllwVHH4(@NotNull IntRect anchorBounds, long windowSize, @NotNull LayoutDirection layoutDirection, long popupContentSize) {
        ...
        int iMo318roundToPx0680j_4 = this.density.mo318roundToPx0680j_4(MenuKt.getMenuVerticalMargin());
        int iMo318roundToPx0680j_5 = this.density.mo318roundToPx0680j_4(DpOffset.m3826getXD9Ej5fM(this.contentOffset));
        int iMo318roundToPx0680j_6 = this.density.mo318roundToPx0680j_4(DpOffset.m3828getYD9Ej5fM(this.contentOffset));
        int left = anchorBounds.getLeft() + iMo318roundToPx0680j_5;
        int right = (anchorBounds.getRight() - iMo318roundToPx0680j_5) - IntSize.m3925getWidthimpl(popupContentSize);
        int iM3925getWidthimpl = IntSize.m3925getWidthimpl(windowSize) - IntSize.m3925getWidthimpl(popupContentSize);
        if (layoutDirection == LayoutDirection.Ltr) {
            ...
            numArr[2] = Integer.valueOf(iM3925getWidthimpl);
            sequenceSequenceOf = SequencesKt.sequenceOf(numArr);
        } else {
            Integer[] numArr2 = new Integer[3];
            numArr2[0] = Integer.valueOf(right);
            numArr2[1] = Integer.valueOf(left);
            if (anchorBounds.getRight() <= IntSize.m3925getWidthimpl(windowSize)) {
                iM3925getWidthimpl = 0;
            }
            numArr2[2] = Integer.valueOf(iM3925getWidthimpl);
        ...
        } while (!(iIntValue >= 0 && IntSize.m3925getWidthimpl(popupContentSize) + iIntValue <= IntSize.m3925getWidthimpl(windowSize)));
        Integer num = (Integer) next;
        if (num != null) {
            right = num.intValue();
        }
        int iMax = Math.max(anchorBounds.getBottom() + iMo318roundToPx0680j_6, iMo318roundToPx0680j_4);
        int top = (anchorBounds.getTop() - iMo318roundToPx0680j_6) - IntSize.m3924getHeightimpl(popupContentSize);
        for (Object obj2 : SequencesKt.sequenceOf(Integer.valueOf(iMax), Integer.valueOf(top), Integer.valueOf(anchorBounds.getTop() - (IntSize.m3924getHeightimpl(popupContentSize) / 2)), Integer.valueOf((IntSize.m3924getHeightimpl(windowSize) - IntSize.m3924getHeightimpl(popupContentSize)) - iMo318roundToPx0680j_4))) {
            int iIntValue2 = ((Number) obj2).intValue();
            if (iIntValue2 >= iMo318roundToPx0680j_4 && IntSize.m3924getHeightimpl(popupContentSize) + iIntValue2 <= IntSize.m3924getHeightimpl(windowSize) - iMo318roundToPx0680j_4) {
                obj = obj2;
                break;
            }
        }
        ...
        this.onPositionCalculated.invoke(anchorBounds, new IntRect(right, top, IntSize.m3925getWidthimpl(popupContentSize) + right, IntSize.m3924getHeightimpl(popupContentSize) + top));
    ...
    public final DropdownMenuPositionProvider m1077copyrOJDEFc(long contentOffset, @NotNull Density density, @NotNull Function2<? super IntRect, ? super IntRect, Unit> onPositionCalculated) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return DpOffset.m3825equalsimpl0(this.contentOffset, dropdownMenuPositionProvider.contentOffset) && Intrinsics.areEqual(this.density, dropdownMenuPositionProvider.density) && Intrinsics.areEqual(this.onPositionCalculated, dropdownMenuPositionProvider.onPositionCalculated);
    }

    /* JADX INFO: renamed from: getContentOffset-RKDOV3M, reason: not valid java name */
    public final long m1078getContentOffsetRKDOV3M() {
        return this.contentOffset;
    }
    ...
    public int hashCode() {
        return this.onPositionCalculated.hashCode() + ((this.density.hashCode() + (DpOffset.m3830hashCodeimpl(this.contentOffset) * 31)) * 31);
    }

    @NotNull
    public String toString() {
        return "DropdownMenuPositionProvider(contentOffset=" + ((Object) DpOffset.m3833toStringimpl(this.contentOffset)) + ", density=" + this.density + ", onPositionCalculated=" + this.onPositionCalculated + ')';
    }
