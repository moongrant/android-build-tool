...
public final class ElevationOverlayKt {
    ...
    private static final ProvidableCompositionLocal<Dp> LocalAbsoluteElevation = CompositionLocalKt.compositionLocalOf$default(null, new Function0<Dp>() { // from class: androidx.compose.material.ElevationOverlayKt$LocalAbsoluteElevation$1
        ...
        public /* bridge */ /* synthetic */ Dp invoke() {
            return Dp.m3763boximpl(m1083invokeD9Ej5fM());
        }

        /* JADX INFO: renamed from: invoke-D9Ej5fM, reason: not valid java name */
        public final float m1083invokeD9Ej5fM() {
            return Dp.m3765constructorimpl(0);
        }
    }, 1, null);
    ...
    public static final long m1082calculateForegroundColorCLU3JFs(long j, float f, Composer composer, int i) {
        ...
        long jM1669copywmQWz5c$default = Color.m1669copywmQWz5c$default(ColorsKt.m1041contentColorForek8zF_U(j, composer, i & 14), ((((float) Math.log(f + 1)) * 4.5f) + 2.0f) / 100.0f, 0.0f, 0.0f, 0.0f, 14, null);
        if (ComposerKt.isTraceInProgress()) {
