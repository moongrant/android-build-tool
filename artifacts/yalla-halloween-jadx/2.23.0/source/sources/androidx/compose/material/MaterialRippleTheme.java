...
final class MaterialRippleTheme implements RippleTheme {
    ...
    public long mo1108defaultColorWaAFU9c(@Nullable Composer composer, int i) {
        ...
        long jM1279defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m1279defaultRippleColor5vOe2sY(((Color) composer.consume(ContentColorKt.getLocalContentColor())).m1680unboximpl(), MaterialTheme.INSTANCE.getColors(composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return jM1279defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(@Nullable Composer composer, int i) {
        ...
        RippleAlpha rippleAlphaM1278defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m1278defaultRippleAlphaDxMtmZc(((Color) composer.consume(ContentColorKt.getLocalContentColor())).m1680unboximpl(), MaterialTheme.INSTANCE.getColors(composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return rippleAlphaM1278defaultRippleAlphaDxMtmZc;
    }
}
