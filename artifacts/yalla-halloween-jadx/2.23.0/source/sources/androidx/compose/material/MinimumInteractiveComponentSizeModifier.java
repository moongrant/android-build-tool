...
final class MinimumInteractiveComponentSizeModifier implements LayoutModifier {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return DpSize.m3860equalsimpl0(this.size, minimumInteractiveComponentSizeModifier.size);
    }
    ...
    public int hashCode() {
        return DpSize.m3865hashCodeimpl(this.size);
    }
    ...
    public MeasureResult mo27measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j) {
        ...
        final int iMax = Math.max(placeableMo2794measureBRTryo0.getWidth(), measure.mo318roundToPx0680j_4(DpSize.m3863getWidthD9Ej5fM(this.size)));
        final int iMax2 = Math.max(placeableMo2794measureBRTryo0.getHeight(), measure.mo318roundToPx0680j_4(DpSize.m3861getHeightD9Ej5fM(this.size)));
        return MeasureScope.CC.OooOOo0(measure, iMax, iMax2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.MinimumInteractiveComponentSizeModifier$measure$1
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.place$default(layout, placeableMo2794measureBRTryo0, MathKt.roundToInt((iMax - placeableMo2794measureBRTryo0.getWidth()) / 2.0f), MathKt.roundToInt((iMax2 - placeableMo2794measureBRTryo0.getHeight()) / 2.0f), 0.0f, 4, null);
            }
        }, 4, null);
    }
