...
public final class RadioButtonDefaults {
    ...
    public final RadioButtonColors m1155colorsRGew2ao(long j, long j2, long j3, @Nullable Composer composer, int i, int i2) {
        ...
        long jM1669copywmQWz5c$default2 = (i2 & 4) != 0 ? Color.m1669copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1022getOnSurface0d7_KjU(), ContentAlpha.INSTANCE.getDisabled(composer, 6), 0.0f, 0.0f, 0.0f, 14, null) : j3;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1370708026, i, -1, "androidx.compose.material.RadioButtonDefaults.colors (RadioButton.kt:162)");
        }
        Color colorM1660boximpl = Color.m1660boximpl(jM1025getSecondary0d7_KjU);
        Color colorM1660boximpl2 = Color.m1660boximpl(jM1669copywmQWz5c$default);
        Color colorM1660boximpl3 = Color.m1660boximpl(jM1669copywmQWz5c$default2);
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new DefaultRadioButtonColors(jM1025getSecondary0d7_KjU, jM1669copywmQWz5c$default, jM1669copywmQWz5c$default2, null);
