...
public final class SnackbarDefaults {
    ...
    public final long getBackgroundColor(@Nullable Composer composer, int i) {
        ...
        long jM1715compositeOverOWjLjI = ColorKt.m1715compositeOverOWjLjI(Color.m1669copywmQWz5c$default(materialTheme.getColors(composer, 6).m1022getOnSurface0d7_KjU(), SnackbarOverlayAlpha, 0.0f, 0.0f, 0.0f, 14, null), materialTheme.getColors(composer, 6).m1027getSurface0d7_KjU());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return jM1715compositeOverOWjLjI;
    }

    @Composable
    @JvmName(name = "getPrimaryActionColor")
    public final long getPrimaryActionColor(@Nullable Composer composer, int i) {
        long jM1024getPrimaryVariant0d7_KjU;
        ...
        if (colors.isLight()) {
            jM1024getPrimaryVariant0d7_KjU = ColorKt.m1715compositeOverOWjLjI(Color.m1669copywmQWz5c$default(colors.m1027getSurface0d7_KjU(), 0.6f, 0.0f, 0.0f, 0.0f, 14, null), colors.m1023getPrimary0d7_KjU());
        } else {
            jM1024getPrimaryVariant0d7_KjU = colors.m1024getPrimaryVariant0d7_KjU();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return jM1024getPrimaryVariant0d7_KjU;
    }
}
