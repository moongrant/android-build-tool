    ...
    public static final class SnackbarDataImpl implements SnackbarData {
        ...
        public void dismiss() {
            if (this.continuation.isActive()) {
                ...
                cancellableContinuation.resumeWith(Result.m4213constructorimpl(SnackbarResult.Dismissed));
            }
        }
        ...
        public void performAction() {
            if (this.continuation.isActive()) {
                CancellableContinuation<SnackbarResult> cancellableContinuation = this.continuation;
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m4213constructorimpl(SnackbarResult.ActionPerformed));
            }
        }
    }
