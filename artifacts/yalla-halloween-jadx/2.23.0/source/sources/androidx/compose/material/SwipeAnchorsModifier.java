...
final class SwipeAnchorsModifier extends InspectorValueInfo implements LayoutModifier, OnRemeasuredModifier {
    ...
    public SwipeAnchorsModifier(@NotNull Function1<? super Density, Unit> onDensityChanged, @NotNull Function1<? super IntSize, Unit> onSizeChanged, @NotNull Function1<? super InspectorInfo, Unit> inspectorInfo) {
        super(inspectorInfo);
    ...
    public MeasureResult mo27measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j) {
        ...
        return MeasureScope.CC.OooOOo0(measure, placeableMo2794measureBRTryo0.getWidth(), placeableMo2794measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.SwipeAnchorsModifier$measure$1
            {
                super(1);
            }
    ...
    public void mo261onRemeasuredozmzZPI(long size) {
        this.onSizeChanged.invoke(IntSize.m3917boximpl(size));
    }
