...
public final class SwipeableKt$PreUpPostDownNestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public Object mo331onPostFlingRZ2iAVY(long j, long j2, @NotNull Continuation<? super Velocity> continuation) {
        ...
        if (i2 == 0) {
            ...
            float f = toFloat(OffsetKt.Offset(Velocity.m3990getXimpl(j2), Velocity.m3991getYimpl(j2)));
    ...
    public long mo332onPostScrollDzOQY0M(long consumed, long available, int source) {
        return NestedScrollSource.m2594equalsimpl0(source, NestedScrollSource.INSTANCE.m2599getDragWNlRxjI()) ? toOffset(this.$this_PreUpPostDownNestedScrollConnection.performDrag(toFloat(available))) : Offset.INSTANCE.m1452getZeroF1C5BW0();
    }
    ...
    public Object mo333onPreFlingQWom1Mo(long j, @NotNull Continuation<? super Velocity> continuation) {
        ...
        if (i2 == 0) {
            ResultKt.throwOnFailure(obj);
            float f = toFloat(OffsetKt.Offset(Velocity.m3990getXimpl(j), Velocity.m3991getYimpl(j)));
    ...
    public long mo334onPreScrollOzD1aCk(long available, int source) {
        ...
        return (f >= 0.0f || !NestedScrollSource.m2594equalsimpl0(source, NestedScrollSource.INSTANCE.m2599getDragWNlRxjI())) ? Offset.INSTANCE.m1452getZeroF1C5BW0() : toOffset(this.$this_PreUpPostDownNestedScrollConnection.performDrag(f));
    }
}
