...
public final class TabRowDefaults {
    ...
    private static final float DividerThickness = Dp.m3765constructorimpl(1);
    private static final float IndicatorHeight = Dp.m3765constructorimpl(2);
    private static final float ScrollableTabRowPadding = Dp.m3765constructorimpl(52);
    ...
    public final void m1215Divider9IZ8Weo(@Nullable Modifier modifier, float f, long j, @Nullable Composer composer, final int i, final int i2) {
        Modifier modifier2;
        int i3;
        float f2;
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowDefaults$Divider$1
            ...
            public final void invoke(@Nullable Composer composer2, int i8) {
                this.$tmp0_rcvr.m1215Divider9IZ8Weo(modifier3, f3, j2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
    ...
    public final void m1216Indicator9IZ8Weo(@Nullable Modifier modifier, float f, long j, @Nullable Composer composer, final int i, final int i2) {
        Modifier modifier2;
        int i3;
        float f2;
        ...
        if ((i & 896) == 0) {
            if ((i2 & 4) == 0) {
                jM1680unboximpl = j;
                int i6 = composerStartRestartGroup.changed(jM1680unboximpl) ? PSKKeyManager.MAX_KEY_LENGTH_BYTES : 128;
                i3 |= i6;
            } else {
                jM1680unboximpl = j;
            }
        ...
        if ((i2 & 8) == 0) {
            ...
            if ((i3 & 5851) == 1170 || !composerStartRestartGroup.getSkipping()) {
                ...
                BoxKt.Box(BackgroundKt.m169backgroundbw27NRU$default(SizeKt.m509height3ABfNKs(SizeKt.fillMaxWidth$default(modifier3, 0.0f, 1, null), f3), jM1680unboximpl, null, 2, null), composerStartRestartGroup, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
            } else {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowDefaults$Indicator$1
                ...
                public final void invoke(@Nullable Composer composer2, int i7) {
                    this.$tmp0_rcvr.m1216Indicator9IZ8Weo(modifier3, f3, j2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
        i3 |= 3072;
    ...
    public final Modifier tabIndicatorOffset(@NotNull Modifier modifier, @NotNull final TabPosition currentTabPosition) {
        ...
        return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.material.TabRowDefaults$tabIndicatorOffset$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(@NotNull Modifier modifier2, @Nullable Composer composer, int i) {
                if (androidx.compose.animation.OooOOO.OooO00o(modifier2, "$this$composed", composer, -398757863)) {
                ...
                State stateM71animateDpAsStateKz89ssw = AnimateAsStateKt.m71animateDpAsStateKz89ssw(currentTabPosition.getWidth(), AnimationSpecKt.tween$default(SQLiteDatabase.MAX_SQL_CACHE_SIZE, 0, EasingKt.getFastOutSlowInEasing(), 2, null), null, composer, 0, 4);
                Modifier modifierM528width3ABfNKs = SizeKt.m528width3ABfNKs(OffsetKt.m437offsetVpY3zN4$default(SizeKt.wrapContentSize$default(SizeKt.fillMaxWidth$default(modifier2, 0.0f, 1, null), Alignment.INSTANCE.getBottomStart(), false, 2, null), invoke$lambda$1(AnimateAsStateKt.m71animateDpAsStateKz89ssw(currentTabPosition.getLeft(), AnimationSpecKt.tween$default(SQLiteDatabase.MAX_SQL_CACHE_SIZE, 0, EasingKt.getFastOutSlowInEasing(), 2, null), null, composer, 0, 4)), 0.0f, 2, null), invoke$lambda$0(stateM71animateDpAsStateKz89ssw));
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
