...
public final class TabRowKt {
    private static final float ScrollableTabRowMinimumTabWidth = Dp.m3765constructorimpl(90);
    ...
    public static final void m1220ScrollableTabRowsKfQg0A(final int i, @Nullable Modifier modifier, long j, long j2, float f, @Nullable Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function3, @Nullable Function2<? super Composer, ? super Integer, Unit> function2, @NotNull final Function2<? super Composer, ? super Integer, Unit> tabs, @Nullable Composer composer, final int i2, final int i3) {
        ...
        int i11;
        Modifier modifier2;
        float fM1219getScrollableTabRowPaddingD9Ej5fM;
        Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function3ComposableLambda;
        Function2<? super Composer, ? super Integer, Unit> function2M1055getLambda2$material_release;
        int i12;
        ...
        if (i14 == 0) {
            ...
            if ((i2 & 7168) == 0) {
                if ((i3 & 8) == 0) {
                    ...
                    if (composerStartRestartGroup.changed(jM1041contentColorForek8zF_U)) {
                        i13 = 2048;
                    }
                    i4 |= i13;
                } else {
            ...
            if (i5 != 0) {
                ...
                if ((i3 & 128) != 0) {
                    ...
                    if ((23967451 & i4) == 4793490 || !composerStartRestartGroup.getSkipping()) {
                        ...
                        if ((i2 & 1) != 0 || composerStartRestartGroup.getDefaultsInvalid()) {
                            ...
                            if ((i3 & 8) != 0) {
                                jM1041contentColorForek8zF_U = ColorsKt.m1041contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i4 >> 6) & 14);
                                i4 &= -7169;
                            }
                            if (i5 != 0) {
                                fM1219getScrollableTabRowPaddingD9Ej5fM = TabRowDefaults.INSTANCE.m1219getScrollableTabRowPaddingD9Ej5fM();
                            } else {
                                fM1219getScrollableTabRowPaddingD9Ej5fM = f2;
                            }
                            if (i7 != 0) {
                                function3ComposableLambda = ComposableLambdaKt.composableLambda(composerStartRestartGroup, -655609869, true, new Function3<List<? extends TabPosition>, Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$1
                                    ...
                                    public final void invoke(@NotNull List<TabPosition> tabPositions, @Nullable Composer composer2, int i16) {
                                        ...
                                        tabRowDefaults.m1216Indicator9IZ8Weo(tabRowDefaults.tabIndicatorOffset(Modifier.INSTANCE, tabPositions.get(i)), 0.0f, 0L, composer2, 3072, 6);
                                        if (ComposerKt.isTraceInProgress()) {
                            ...
                            if (i9 != 0) {
                                function2M1055getLambda2$material_release = ComposableSingletons$TabRowKt.INSTANCE.m1055getLambda2$material_release();
                            } else {
                                function2M1055getLambda2$material_release = function2;
                            }
                        ...
                        final float f3 = fM1219getScrollableTabRowPaddingD9Ej5fM;
                        final Function2<? super Composer, ? super Integer, Unit> function7 = function2M1055getLambda2$material_release;
                        final Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function8 = function4;
                        final int i16 = i12;
                        SurfaceKt.m1185SurfaceFjzlyU(modifier2, null, primarySurface, jM1041contentColorForek8zF_U, null, 0.0f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1455860572, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$2
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            ...
                            public final void invoke(@Nullable Composer composer2, int i17) {
                                ...
                                SubcomposeLayoutKt.SubcomposeLayout(modifierClipToBounds, new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$2.1
                                    ...
                                    public final MeasureResult m1222invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j3) {
                                        Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                        int iMo318roundToPx0680j_4 = SubcomposeLayout.mo318roundToPx0680j_4(TabRowKt.ScrollableTabRowMinimumTabWidth);
                                        final int iMo318roundToPx0680j_5 = SubcomposeLayout.mo318roundToPx0680j_4(f4);
                                        long jM3724copyZbe2FdA$default = Constraints.m3724copyZbe2FdA$default(j3, iMo318roundToPx0680j_4, 0, 0, 0, 14, null);
                                        List<Measurable> listSubcompose = SubcomposeLayout.subcompose(TabSlots.Tabs, function9);
                                        final ArrayList<Placeable> arrayList = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(listSubcompose, 10));
                                        ...
                                        intRef.element = iMo318roundToPx0680j_5 * 2;
                                        ...
                                        return MeasureScope.CC.OooOOo0(SubcomposeLayout, i20, i21, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt.ScrollableTabRow.2.1.2
                                            ...
                                            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                                                ...
                                                int i24 = iMo318roundToPx0680j_5;
                                                ...
                                                for (Placeable placeable2 : list) {
                                                    ...
                                                    arrayList2.add(new TabPosition(subcomposeMeasureScope.mo321toDpu2uoSUM(width), subcomposeMeasureScope.mo321toDpu2uoSUM(placeable2.getWidth()), null));
                                                ...
                                                for (Measurable measurable : listSubcompose2) {
                                                    ...
                                                    Placeable placeableMo2794measureBRTryo0 = measurable.mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j4, i25, i25, 0, 0, 8, null));
                                                    Placeable.PlacementScope.placeRelative$default(layout, placeableMo2794measureBRTryo0, 0, intRef4.element - placeableMo2794measureBRTryo0.getHeight(), 0.0f, 4, null);
                                                    intRef3 = intRef3;
                                                    intRef4 = intRef4;
                                                    j4 = j4;
                                                }
                                                ...
                                                while (it2.hasNext()) {
                                                    Placeable.PlacementScope.placeRelative$default(layout, ((Measurable) it2.next()).mo2794measureBRTryo0(Constraints.INSTANCE.m3741fixedJhjzzOo(intRef5.element, intRef6.element)), 0, 0, 0.0f, 4, null);
                                                }
                                                scrollableTabData2.onLaidOut(SubcomposeLayout, iMo318roundToPx0680j_5, arrayList2, i22);
                                            }
                                        }, 4, null);
                                    }
                                }, composer2, 0, 0);
                        ...
                        function5 = function4;
                        f2 = fM1219getScrollableTabRowPaddingD9Ej5fM;
                        modifier3 = modifier2;
                    } else {
                        composerStartRestartGroup.skipToGroupEnd();
                        modifier3 = modifier;
                    ...
                    final long j4 = jM1041contentColorForek8zF_U;
                    final float f4 = f2;
                    final Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function9 = function5;
                    final Function2<? super Composer, ? super Integer, Unit> function10 = function2M1055getLambda2$material_release;
                    scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$3
                        ...
                        public final void invoke(@Nullable Composer composer2, int i17) {
                            TabRowKt.m1220ScrollableTabRowsKfQg0A(i, modifier4, j3, j4, f4, function9, function10, tabs, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), i3);
                        }
                    });
                }
                i11 = 12582912;
                ...
                if ((23967451 & i4) == 4793490) {
                    ...
                    final float f5 = fM1219getScrollableTabRowPaddingD9Ej5fM;
                    final Function2<? super Composer, ? super Integer, Unit> function13 = function2M1055getLambda2$material_release;
                    ...
                    SurfaceKt.m1185SurfaceFjzlyU(modifier2, null, primarySurface, jM1041contentColorForek8zF_U, null, 0.0f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1455860572, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$2
                        ...
                        public final void invoke(@Nullable Composer composer2, int i18) {
                            ...
                            SubcomposeLayoutKt.SubcomposeLayout(modifierClipToBounds, new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$2.1
                                ...
                                @NotNull
                                /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                                public final MeasureResult m1222invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j5) {
                                    Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                    int iMo318roundToPx0680j_4 = SubcomposeLayout.mo318roundToPx0680j_4(TabRowKt.ScrollableTabRowMinimumTabWidth);
                                    final int iMo318roundToPx0680j_5 = SubcomposeLayout.mo318roundToPx0680j_4(f6);
                                    long jM3724copyZbe2FdA$default = Constraints.m3724copyZbe2FdA$default(j5, iMo318roundToPx0680j_4, 0, 0, 0, 14, null);
                                    List<Measurable> listSubcompose = SubcomposeLayout.subcompose(TabSlots.Tabs, function15);
                                    final List<? extends Placeable> arrayList = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(listSubcompose, 10));
                                    Iterator<T> it = listSubcompose.iterator();
                                    while (it.hasNext()) {
                                        arrayList.add(((Measurable) it.next()).mo2794measureBRTryo0(jM3724copyZbe2FdA$default));
                                    }
                                    ...
                                    return MeasureScope.CC.OooOOo0(SubcomposeLayout, i20, i21, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt.ScrollableTabRow.2.1.2
                                        ...
                                        public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                                            ...
                                            for (Measurable measurable : listSubcompose2) {
                                                int i25 = intRef3.element;
                                                Placeable placeableMo2794measureBRTryo0 = measurable.mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j6, i25, i25, 0, 0, 8, null));
                                                Placeable.PlacementScope.placeRelative$default(layout, placeableMo2794measureBRTryo0, 0, intRef4.element - placeableMo2794measureBRTryo0.getHeight(), 0.0f, 4, null);
                                                intRef3 = intRef3;
                                                intRef4 = intRef4;
                                                j6 = j6;
                    ...
                    final float f6 = fM1219getScrollableTabRowPaddingD9Ej5fM;
                    final Function2<? super Composer, ? super Integer, Unit> function17 = function2M1055getLambda2$material_release;
                        ...
                        public final void invoke(@Nullable Composer composer2, int i19) {
                            ...
                            SubcomposeLayoutKt.SubcomposeLayout(modifierClipToBounds, new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$2.1
                                ...
                                public final MeasureResult m1222invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j5) {
                                    Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                    int iMo318roundToPx0680j_4 = SubcomposeLayout.mo318roundToPx0680j_4(TabRowKt.ScrollableTabRowMinimumTabWidth);
                                    final int iMo318roundToPx0680j_5 = SubcomposeLayout.mo318roundToPx0680j_4(f7);
                                    long jM3724copyZbe2FdA$default = Constraints.m3724copyZbe2FdA$default(j5, iMo318roundToPx0680j_4, 0, 0, 0, 14, null);
                ...
                final Function2<? super Composer, ? super Integer, Unit> function110 = function2M1055getLambda2$material_release;
                scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$3
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                    ...
                    public final void invoke(@Nullable Composer composer2, int i19) {
                        TabRowKt.m1220ScrollableTabRowsKfQg0A(i, modifier5, j5, j6, f7, function19, function110, tabs, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), i3);
                    }
                });
            }
            i4 |= 24576;
            ...
            if ((i3 & 128) != 0) {
                ...
                if ((23967451 & i4) == 4793490) {
                    ...
                    final float f8 = fM1219getScrollableTabRowPaddingD9Ej5fM;
                    final Function2<? super Composer, ? super Integer, Unit> function113 = function2M1055getLambda2$material_release;
                    ...
                    SurfaceKt.m1185SurfaceFjzlyU(modifier2, null, primarySurface, jM1041contentColorForek8zF_U, null, 0.0f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1455860572, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$2
                        ...
                        public final void invoke(@Nullable Composer composer2, int i110) {
                            ...
                            SubcomposeLayoutKt.SubcomposeLayout(modifierClipToBounds, new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$2.1
                                ...
                                @NotNull
                                /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                                public final MeasureResult m1222invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j7) {
                                    Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                    int iMo318roundToPx0680j_4 = SubcomposeLayout.mo318roundToPx0680j_4(TabRowKt.ScrollableTabRowMinimumTabWidth);
                                    final int iMo318roundToPx0680j_5 = SubcomposeLayout.mo318roundToPx0680j_4(f9);
                                    long jM3724copyZbe2FdA$default = Constraints.m3724copyZbe2FdA$default(j7, iMo318roundToPx0680j_4, 0, 0, 0, 14, null);
                                    ...
                                    return MeasureScope.CC.OooOOo0(SubcomposeLayout, i20, i21, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt.ScrollableTabRow.2.1.2
                                        ...
                                        public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                                            ...
                                            for (Measurable measurable : listSubcompose2) {
                                                int i25 = intRef3.element;
                                                Placeable placeableMo2794measureBRTryo0 = measurable.mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j8, i25, i25, 0, 0, 8, null));
                                                Placeable.PlacementScope.placeRelative$default(layout, placeableMo2794measureBRTryo0, 0, intRef4.element - placeableMo2794measureBRTryo0.getHeight(), 0.0f, 4, null);
                                                intRef3 = intRef3;
                                                intRef4 = intRef4;
                                                j8 = j8;
                    ...
                    final float f9 = fM1219getScrollableTabRowPaddingD9Ej5fM;
                    final Function2<? super Composer, ? super Integer, Unit> function117 = function2M1055getLambda2$material_release;
                        ...
                        public final void invoke(@Nullable Composer composer2, int i111) {
                            ...
                            SubcomposeLayoutKt.SubcomposeLayout(modifierClipToBounds, new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$2.1
                                ...
                                public final MeasureResult m1222invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j7) {
                                    Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                    int iMo318roundToPx0680j_4 = SubcomposeLayout.mo318roundToPx0680j_4(TabRowKt.ScrollableTabRowMinimumTabWidth);
                                    final int iMo318roundToPx0680j_5 = SubcomposeLayout.mo318roundToPx0680j_4(f10);
                                    long jM3724copyZbe2FdA$default = Constraints.m3724copyZbe2FdA$default(j7, iMo318roundToPx0680j_4, 0, 0, 0, 14, null);
                ...
                final long j8 = jM1041contentColorForek8zF_U;
                final float f10 = f2;
                final Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function119 = function5;
                final Function2<? super Composer, ? super Integer, Unit> function1110 = function2M1055getLambda2$material_release;
                scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$3
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                    ...
                    public final void invoke(@Nullable Composer composer2, int i111) {
                        TabRowKt.m1220ScrollableTabRowsKfQg0A(i, modifier6, j7, j8, f10, function119, function1110, tabs, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), i3);
                    }
                });
            }
            i11 = 12582912;
            ...
            if ((23967451 & i4) == 4793490) {
                ...
                final float f11 = fM1219getScrollableTabRowPaddingD9Ej5fM;
                final Function2<? super Composer, ? super Integer, Unit> function1113 = function2M1055getLambda2$material_release;
                ...
                SurfaceKt.m1185SurfaceFjzlyU(modifier2, null, primarySurface, jM1041contentColorForek8zF_U, null, 0.0f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1455860572, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$2
                    ...
                    public final void invoke(@Nullable Composer composer2, int i112) {
                        ...
                        SubcomposeLayoutKt.SubcomposeLayout(modifierClipToBounds, new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$2.1
                            ...
                            @NotNull
                            /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                            public final MeasureResult m1222invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j9) {
                                Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                int iMo318roundToPx0680j_4 = SubcomposeLayout.mo318roundToPx0680j_4(TabRowKt.ScrollableTabRowMinimumTabWidth);
                                final int iMo318roundToPx0680j_5 = SubcomposeLayout.mo318roundToPx0680j_4(f12);
                                long jM3724copyZbe2FdA$default = Constraints.m3724copyZbe2FdA$default(j9, iMo318roundToPx0680j_4, 0, 0, 0, 14, null);
                                ...
                                return MeasureScope.CC.OooOOo0(SubcomposeLayout, i20, i21, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt.ScrollableTabRow.2.1.2
                                    ...
                                    public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                                        ...
                                        for (Measurable measurable : listSubcompose2) {
                                            int i25 = intRef3.element;
                                            Placeable placeableMo2794measureBRTryo0 = measurable.mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j10, i25, i25, 0, 0, 8, null));
                                            Placeable.PlacementScope.placeRelative$default(layout, placeableMo2794measureBRTryo0, 0, intRef4.element - placeableMo2794measureBRTryo0.getHeight(), 0.0f, 4, null);
                                            intRef3 = intRef3;
                                            intRef4 = intRef4;
                                            j10 = j10;
                ...
                final float f12 = fM1219getScrollableTabRowPaddingD9Ej5fM;
                final Function2<? super Composer, ? super Integer, Unit> function1117 = function2M1055getLambda2$material_release;
                    ...
                    public final void invoke(@Nullable Composer composer2, int i113) {
                        ...
                        SubcomposeLayoutKt.SubcomposeLayout(modifierClipToBounds, new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$2.1
                            ...
                            public final MeasureResult m1222invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j9) {
                                Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                int iMo318roundToPx0680j_4 = SubcomposeLayout.mo318roundToPx0680j_4(TabRowKt.ScrollableTabRowMinimumTabWidth);
                                final int iMo318roundToPx0680j_5 = SubcomposeLayout.mo318roundToPx0680j_4(f13);
                                long jM3724copyZbe2FdA$default = Constraints.m3724copyZbe2FdA$default(j9, iMo318roundToPx0680j_4, 0, 0, 0, 14, null);
            ...
            final long j10 = jM1041contentColorForek8zF_U;
            final float f13 = f2;
            final Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function1119 = function5;
            final Function2<? super Composer, ? super Integer, Unit> function11110 = function2M1055getLambda2$material_release;
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$3
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                ...
                public final void invoke(@Nullable Composer composer2, int i113) {
                    TabRowKt.m1220ScrollableTabRowsKfQg0A(i, modifier7, j9, j10, f13, function1119, function11110, tabs, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), i3);
                }
            });
        }
        i4 |= 48;
        ...
        if (i5 != 0) {
            ...
            if ((i3 & 128) != 0) {
                ...
                if ((23967451 & i4) == 4793490) {
                    ...
                    final float f14 = fM1219getScrollableTabRowPaddingD9Ej5fM;
                    final Function2<? super Composer, ? super Integer, Unit> function11113 = function2M1055getLambda2$material_release;
                    ...
                    SurfaceKt.m1185SurfaceFjzlyU(modifier2, null, primarySurface, jM1041contentColorForek8zF_U, null, 0.0f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1455860572, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$2
                        ...
                        public final void invoke(@Nullable Composer composer2, int i114) {
                            ...
                            SubcomposeLayoutKt.SubcomposeLayout(modifierClipToBounds, new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$2.1
                                ...
                                @NotNull
                                /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                                public final MeasureResult m1222invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j11) {
                                    Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                    int iMo318roundToPx0680j_4 = SubcomposeLayout.mo318roundToPx0680j_4(TabRowKt.ScrollableTabRowMinimumTabWidth);
                                    final int iMo318roundToPx0680j_5 = SubcomposeLayout.mo318roundToPx0680j_4(f15);
                                    long jM3724copyZbe2FdA$default = Constraints.m3724copyZbe2FdA$default(j11, iMo318roundToPx0680j_4, 0, 0, 0, 14, null);
                                    ...
                                    return MeasureScope.CC.OooOOo0(SubcomposeLayout, i20, i21, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt.ScrollableTabRow.2.1.2
                                        ...
                                        public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                                            ...
                                            for (Measurable measurable : listSubcompose2) {
                                                int i25 = intRef3.element;
                                                Placeable placeableMo2794measureBRTryo0 = measurable.mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j12, i25, i25, 0, 0, 8, null));
                                                Placeable.PlacementScope.placeRelative$default(layout, placeableMo2794measureBRTryo0, 0, intRef4.element - placeableMo2794measureBRTryo0.getHeight(), 0.0f, 4, null);
                                                intRef3 = intRef3;
                                                intRef4 = intRef4;
                                                j12 = j12;
                    ...
                    final float f15 = fM1219getScrollableTabRowPaddingD9Ej5fM;
                    final Function2<? super Composer, ? super Integer, Unit> function11117 = function2M1055getLambda2$material_release;
                        ...
                        public final void invoke(@Nullable Composer composer2, int i115) {
                            ...
                            SubcomposeLayoutKt.SubcomposeLayout(modifierClipToBounds, new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$2.1
                                ...
                                public final MeasureResult m1222invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j11) {
                                    Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                    int iMo318roundToPx0680j_4 = SubcomposeLayout.mo318roundToPx0680j_4(TabRowKt.ScrollableTabRowMinimumTabWidth);
                                    final int iMo318roundToPx0680j_5 = SubcomposeLayout.mo318roundToPx0680j_4(f16);
                                    long jM3724copyZbe2FdA$default = Constraints.m3724copyZbe2FdA$default(j11, iMo318roundToPx0680j_4, 0, 0, 0, 14, null);
                ...
                final long j12 = jM1041contentColorForek8zF_U;
                final float f16 = f2;
                final Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function11119 = function5;
                final Function2<? super Composer, ? super Integer, Unit> function111110 = function2M1055getLambda2$material_release;
                scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$3
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                    ...
                    public final void invoke(@Nullable Composer composer2, int i115) {
                        TabRowKt.m1220ScrollableTabRowsKfQg0A(i, modifier8, j11, j12, f16, function11119, function111110, tabs, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), i3);
                    }
                });
            }
            i11 = 12582912;
            ...
            if ((23967451 & i4) == 4793490) {
                ...
                final float f17 = fM1219getScrollableTabRowPaddingD9Ej5fM;
                final Function2<? super Composer, ? super Integer, Unit> function111113 = function2M1055getLambda2$material_release;
                ...
                SurfaceKt.m1185SurfaceFjzlyU(modifier2, null, primarySurface, jM1041contentColorForek8zF_U, null, 0.0f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1455860572, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$2
                    ...
                    public final void invoke(@Nullable Composer composer2, int i116) {
                        ...
                        SubcomposeLayoutKt.SubcomposeLayout(modifierClipToBounds, new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$2.1
                            ...
                            @NotNull
                            /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                            public final MeasureResult m1222invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j13) {
                                Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                int iMo318roundToPx0680j_4 = SubcomposeLayout.mo318roundToPx0680j_4(TabRowKt.ScrollableTabRowMinimumTabWidth);
                                final int iMo318roundToPx0680j_5 = SubcomposeLayout.mo318roundToPx0680j_4(f18);
                                long jM3724copyZbe2FdA$default = Constraints.m3724copyZbe2FdA$default(j13, iMo318roundToPx0680j_4, 0, 0, 0, 14, null);
                                ...
                                return MeasureScope.CC.OooOOo0(SubcomposeLayout, i20, i21, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt.ScrollableTabRow.2.1.2
                                    ...
                                    public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                                        ...
                                        for (Measurable measurable : listSubcompose2) {
                                            int i25 = intRef3.element;
                                            Placeable placeableMo2794measureBRTryo0 = measurable.mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j14, i25, i25, 0, 0, 8, null));
                                            Placeable.PlacementScope.placeRelative$default(layout, placeableMo2794measureBRTryo0, 0, intRef4.element - placeableMo2794measureBRTryo0.getHeight(), 0.0f, 4, null);
                                            intRef3 = intRef3;
                                            intRef4 = intRef4;
                                            j14 = j14;
                ...
                final float f18 = fM1219getScrollableTabRowPaddingD9Ej5fM;
                final Function2<? super Composer, ? super Integer, Unit> function111117 = function2M1055getLambda2$material_release;
                    ...
                    public final void invoke(@Nullable Composer composer2, int i117) {
                        ...
                        SubcomposeLayoutKt.SubcomposeLayout(modifierClipToBounds, new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$2.1
                            ...
                            public final MeasureResult m1222invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j13) {
                                Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                int iMo318roundToPx0680j_4 = SubcomposeLayout.mo318roundToPx0680j_4(TabRowKt.ScrollableTabRowMinimumTabWidth);
                                final int iMo318roundToPx0680j_5 = SubcomposeLayout.mo318roundToPx0680j_4(f19);
                                long jM3724copyZbe2FdA$default = Constraints.m3724copyZbe2FdA$default(j13, iMo318roundToPx0680j_4, 0, 0, 0, 14, null);
            ...
            final long j14 = jM1041contentColorForek8zF_U;
            final float f19 = f2;
            final Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function111119 = function5;
            final Function2<? super Composer, ? super Integer, Unit> function1111110 = function2M1055getLambda2$material_release;
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$3
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                ...
                public final void invoke(@Nullable Composer composer2, int i117) {
                    TabRowKt.m1220ScrollableTabRowsKfQg0A(i, modifier9, j13, j14, f19, function111119, function1111110, tabs, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), i3);
                }
            });
        }
        i4 |= 24576;
        ...
        if ((i3 & 128) != 0) {
            ...
            if ((23967451 & i4) == 4793490) {
                ...
                final float f110 = fM1219getScrollableTabRowPaddingD9Ej5fM;
                final Function2<? super Composer, ? super Integer, Unit> function1111113 = function2M1055getLambda2$material_release;
                ...
                SurfaceKt.m1185SurfaceFjzlyU(modifier2, null, primarySurface, jM1041contentColorForek8zF_U, null, 0.0f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1455860572, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$2
                    ...
                    public final void invoke(@Nullable Composer composer2, int i118) {
                        ...
                        SubcomposeLayoutKt.SubcomposeLayout(modifierClipToBounds, new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$2.1
                            ...
                            @NotNull
                            /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                            public final MeasureResult m1222invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j15) {
                                Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                int iMo318roundToPx0680j_4 = SubcomposeLayout.mo318roundToPx0680j_4(TabRowKt.ScrollableTabRowMinimumTabWidth);
                                final int iMo318roundToPx0680j_5 = SubcomposeLayout.mo318roundToPx0680j_4(f111);
                                long jM3724copyZbe2FdA$default = Constraints.m3724copyZbe2FdA$default(j15, iMo318roundToPx0680j_4, 0, 0, 0, 14, null);
                                ...
                                return MeasureScope.CC.OooOOo0(SubcomposeLayout, i20, i21, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt.ScrollableTabRow.2.1.2
                                    ...
                                    public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                                        ...
                                        for (Measurable measurable : listSubcompose2) {
                                            int i25 = intRef3.element;
                                            Placeable placeableMo2794measureBRTryo0 = measurable.mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j16, i25, i25, 0, 0, 8, null));
                                            Placeable.PlacementScope.placeRelative$default(layout, placeableMo2794measureBRTryo0, 0, intRef4.element - placeableMo2794measureBRTryo0.getHeight(), 0.0f, 4, null);
                                            intRef3 = intRef3;
                                            intRef4 = intRef4;
                                            j16 = j16;
                ...
                final float f111 = fM1219getScrollableTabRowPaddingD9Ej5fM;
                final Function2<? super Composer, ? super Integer, Unit> function1111117 = function2M1055getLambda2$material_release;
                    ...
                    public final void invoke(@Nullable Composer composer2, int i119) {
                        ...
                        SubcomposeLayoutKt.SubcomposeLayout(modifierClipToBounds, new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$2.1
                            ...
                            public final MeasureResult m1222invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j15) {
                                Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                int iMo318roundToPx0680j_4 = SubcomposeLayout.mo318roundToPx0680j_4(TabRowKt.ScrollableTabRowMinimumTabWidth);
                                final int iMo318roundToPx0680j_5 = SubcomposeLayout.mo318roundToPx0680j_4(f112);
                                long jM3724copyZbe2FdA$default = Constraints.m3724copyZbe2FdA$default(j15, iMo318roundToPx0680j_4, 0, 0, 0, 14, null);
            ...
            final long j16 = jM1041contentColorForek8zF_U;
            final float f112 = f2;
            final Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function1111119 = function5;
            final Function2<? super Composer, ? super Integer, Unit> function11111110 = function2M1055getLambda2$material_release;
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$3
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                ...
                public final void invoke(@Nullable Composer composer2, int i119) {
                    TabRowKt.m1220ScrollableTabRowsKfQg0A(i, modifier10, j15, j16, f112, function1111119, function11111110, tabs, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), i3);
                }
            });
        }
        i11 = 12582912;
        ...
        if ((23967451 & i4) == 4793490) {
            ...
            final float f113 = fM1219getScrollableTabRowPaddingD9Ej5fM;
            final Function2<? super Composer, ? super Integer, Unit> function11111113 = function2M1055getLambda2$material_release;
            ...
            SurfaceKt.m1185SurfaceFjzlyU(modifier2, null, primarySurface, jM1041contentColorForek8zF_U, null, 0.0f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1455860572, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$2
                ...
                public final void invoke(@Nullable Composer composer2, int i1110) {
                    ...
                    SubcomposeLayoutKt.SubcomposeLayout(modifierClipToBounds, new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$2.1
                        ...
                        @NotNull
                        /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                        public final MeasureResult m1222invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j17) {
                            Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                            int iMo318roundToPx0680j_4 = SubcomposeLayout.mo318roundToPx0680j_4(TabRowKt.ScrollableTabRowMinimumTabWidth);
                            final int iMo318roundToPx0680j_5 = SubcomposeLayout.mo318roundToPx0680j_4(f114);
                            long jM3724copyZbe2FdA$default = Constraints.m3724copyZbe2FdA$default(j17, iMo318roundToPx0680j_4, 0, 0, 0, 14, null);
                            ...
                            return MeasureScope.CC.OooOOo0(SubcomposeLayout, i20, i21, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt.ScrollableTabRow.2.1.2
                                ...
                                public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                                    ...
                                    for (Measurable measurable : listSubcompose2) {
                                        int i25 = intRef3.element;
                                        Placeable placeableMo2794measureBRTryo0 = measurable.mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j18, i25, i25, 0, 0, 8, null));
                                        Placeable.PlacementScope.placeRelative$default(layout, placeableMo2794measureBRTryo0, 0, intRef4.element - placeableMo2794measureBRTryo0.getHeight(), 0.0f, 4, null);
                                        intRef3 = intRef3;
                                        intRef4 = intRef4;
                                        j18 = j18;
            ...
            final float f114 = fM1219getScrollableTabRowPaddingD9Ej5fM;
            final Function2<? super Composer, ? super Integer, Unit> function11111117 = function2M1055getLambda2$material_release;
                ...
                public final void invoke(@Nullable Composer composer2, int i1111) {
                    ...
                    SubcomposeLayoutKt.SubcomposeLayout(modifierClipToBounds, new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$2.1
                        ...
                        public final MeasureResult m1222invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j17) {
                            Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                            int iMo318roundToPx0680j_4 = SubcomposeLayout.mo318roundToPx0680j_4(TabRowKt.ScrollableTabRowMinimumTabWidth);
                            final int iMo318roundToPx0680j_5 = SubcomposeLayout.mo318roundToPx0680j_4(f115);
                            long jM3724copyZbe2FdA$default = Constraints.m3724copyZbe2FdA$default(j17, iMo318roundToPx0680j_4, 0, 0, 0, 14, null);
        ...
        final long j18 = jM1041contentColorForek8zF_U;
        final float f115 = f2;
        final Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function11111119 = function5;
        final Function2<? super Composer, ? super Integer, Unit> function111111110 = function2M1055getLambda2$material_release;
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
            ...
            public final void invoke(@Nullable Composer composer2, int i1111) {
                TabRowKt.m1220ScrollableTabRowsKfQg0A(i, modifier11, j17, j18, f115, function11111119, function111111110, tabs, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), i3);
            }
        });
    }
    ...
    public static final void m1221TabRowpAZo6Ak(final int i, @Nullable Modifier modifier, long j, long j2, @Nullable Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function3, @Nullable Function2<? super Composer, ? super Integer, Unit> function2, @NotNull final Function2<? super Composer, ? super Integer, Unit> tabs, @Nullable Composer composer, final int i2, final int i3) {
        ...
        int i6;
        int i7;
        final Function2<? super Composer, ? super Integer, Unit> function2M1054getLambda1$material_release;
        int i8;
        int i9;
        Modifier modifier2;
        Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function3ComposableLambda;
        ...
        if (i12 == 0) {
            ...
            if ((i2 & 7168) == 0) {
                jM1041contentColorForek8zF_U = j2;
                if ((i3 & 8) == 0 || !composerStartRestartGroup.changed(jM1041contentColorForek8zF_U)) {
            ...
            if (i5 != 0) {
                ...
                if (i7 != 0) {
                    if ((458752 & i2) == 0) {
                        function2M1054getLambda1$material_release = function2;
                        if (composerStartRestartGroup.changedInstance(function2M1054getLambda1$material_release)) {
                            i8 = 131072;
                        } else {
                            i8 = 65536;
                        }
                    ...
                    if ((i4 & 2995931) == 599186 || !composerStartRestartGroup.getSkipping()) {
                        ...
                        if ((i2 & 1) != 0 || composerStartRestartGroup.getDefaultsInvalid()) {
                            ...
                            if (i7 != 0) {
                                function2M1054getLambda1$material_release = ComposableSingletons$TabRowKt.INSTANCE.m1054getLambda1$material_release();
                            }
                        ...
                        long j3 = jM1041contentColorForek8zF_U;
                        i10 = i4;
                        composerStartRestartGroup.endDefaults();
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(-249175289, i10, -1, "androidx.compose.material.TabRow (TabRow.kt:128)");
                        }
                        function6 = function2M1054getLambda1$material_release;
                        SurfaceKt.m1185SurfaceFjzlyU(SelectableGroupKt.selectableGroup(modifier2), null, primarySurface, j3, null, 0.0f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1961746365, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(2);
                            ...
                            public final void invoke(@Nullable Composer composer2, int i14) {
                                ...
                                final Function2<Composer, Integer, Unit> function8 = function2M1054getLambda1$material_release;
                                ...
                                if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                                    objRememberedValue = new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1
                                        ...
                                        @Override // kotlin.jvm.functions.Function2
                                        public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeMeasureScope subcomposeMeasureScope, Constraints constraints) {
                                            return m1223invoke0kLqBqw(subcomposeMeasureScope, constraints.getValue());
                                        }

                                        @NotNull
                                        /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                                        public final MeasureResult m1223invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j4) {
                                            Object next;
                                            Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                            final int iM3733getMaxWidthimpl = Constraints.m3733getMaxWidthimpl(j4);
                                            List<Measurable> listSubcompose = SubcomposeLayout.subcompose(TabSlots.Tabs, function7);
                                            int size = listSubcompose.size();
                                            final int i16 = iM3733getMaxWidthimpl / size;
                                            final ArrayList arrayList = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(listSubcompose, 10));
                                            Iterator<T> it = listSubcompose.iterator();
                                            while (it.hasNext()) {
                                                arrayList.add(((Measurable) it.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j4, i16, i16, 0, 0, 12, null)));
                                            }
                                            ...
                                            for (int i17 = 0; i17 < size; i17++) {
                                                arrayList2.add(new TabPosition(Dp.m3765constructorimpl(SubcomposeLayout.mo321toDpu2uoSUM(i16) * i17), SubcomposeLayout.mo321toDpu2uoSUM(i16), null));
                                            }
                                            ...
                                            return MeasureScope.CC.OooOOo0(SubcomposeLayout, iM3733getMaxWidthimpl, height3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1.1
                                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                                /* JADX WARN: Multi-variable type inference failed */
                                                {
                                                    super(1);
                                                ...
                                                public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                                                    ...
                                                    while (it3.hasNext()) {
                                                        Placeable placeableMo2794measureBRTryo0 = ((Measurable) it3.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j5, 0, 0, 0, 0, 11, null));
                                                        Placeable.PlacementScope.placeRelative$default(layout, placeableMo2794measureBRTryo0, 0, i23 - placeableMo2794measureBRTryo0.getHeight(), 0.0f, 4, null);
                                                        i23 = i23;
                                                        j5 = j5;
                                                    }
                                                    SubcomposeMeasureScope subcomposeMeasureScope = SubcomposeLayout;
                                                    ...
                                                    int i25 = iM3733getMaxWidthimpl;
                                                    int i26 = i19;
                                                    Iterator<T> it4 = listSubcompose3.iterator();
                                                    while (it4.hasNext()) {
                                                        Placeable.PlacementScope.placeRelative$default(layout, ((Measurable) it4.next()).mo2794measureBRTryo0(Constraints.INSTANCE.m3741fixedJhjzzOo(i25, i26)), 0, 0, 0.0f, 4, null);
                                                    }
                                                }
                                            }, 4, null);
                                        }
                        ...
                        jM1041contentColorForek8zF_U = j3;
                        modifier3 = modifier2;
                    } else {
                        composerStartRestartGroup.skipToGroupEnd();
                        modifier3 = modifier;
                    ...
                    final long j5 = jM1041contentColorForek8zF_U;
                    ...
                    scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$3
                        ...
                        public final void invoke(@Nullable Composer composer2, int i14) {
                            TabRowKt.m1221TabRowpAZo6Ak(i, modifier4, j4, j5, function7, function8, tabs, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), i3);
                        }
                    });
                }
                i4 |= 196608;
                ...
                if ((i4 & 2995931) == 599186) {
                    ...
                    long j6 = jM1041contentColorForek8zF_U;
                    i10 = i4;
                    composerStartRestartGroup.endDefaults();
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(-249175289, i10, -1, "androidx.compose.material.TabRow (TabRow.kt:128)");
                    ...
                    function6 = function2M1054getLambda1$material_release;
                    SurfaceKt.m1185SurfaceFjzlyU(SelectableGroupKt.selectableGroup(modifier2), null, primarySurface, j6, null, 0.0f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1961746365, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        /* JADX WARN: Multi-variable type inference failed */
                        {
                            super(2);
                        ...
                        public final void invoke(@Nullable Composer composer2, int i14) {
                            ...
                            final Function2<? super Composer, ? super Integer, Unit> function10 = function2M1054getLambda1$material_release;
                            ...
                            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                                objRememberedValue = new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1
                                    ...
                                    @NotNull
                                    /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                                    public final MeasureResult m1223invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j7) {
                                        Object next;
                                        Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                        final int iM3733getMaxWidthimpl = Constraints.m3733getMaxWidthimpl(j7);
                                        List<Measurable> listSubcompose = SubcomposeLayout.subcompose(TabSlots.Tabs, function9);
                                        int size = listSubcompose.size();
                                        final int i16 = iM3733getMaxWidthimpl / size;
                                        final List<? extends Placeable> arrayList = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(listSubcompose, 10));
                                        Iterator<T> it = listSubcompose.iterator();
                                        while (it.hasNext()) {
                                            arrayList.add(((Measurable) it.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j7, i16, i16, 0, 0, 12, null)));
                                        }
                                        Iterator it2 = arrayList.iterator();
                                        if (it2.hasNext()) {
                                            next = it2.next();
                                        ...
                                        return MeasureScope.CC.OooOOo0(SubcomposeLayout, iM3733getMaxWidthimpl, height3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1.1
                                            ...
                                            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                                                ...
                                                Iterator<T> it3 = listSubcompose2.iterator();
                                                while (it3.hasNext()) {
                                                    Placeable placeableMo2794measureBRTryo0 = ((Measurable) it3.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j8, 0, 0, 0, 0, 11, null));
                                                    Placeable.PlacementScope.placeRelative$default(layout, placeableMo2794measureBRTryo0, 0, i23 - placeableMo2794measureBRTryo0.getHeight(), 0.0f, 4, null);
                                                    i23 = i23;
                                                    j8 = j8;
                                                }
                    ...
                    long j7 = jM1041contentColorForek8zF_U;
                    i10 = i4;
                    composerStartRestartGroup.endDefaults();
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(-249175289, i10, -1, "androidx.compose.material.TabRow (TabRow.kt:128)");
                    ...
                    function6 = function2M1054getLambda1$material_release;
                    SurfaceKt.m1185SurfaceFjzlyU(SelectableGroupKt.selectableGroup(modifier2), null, primarySurface, j7, null, 0.0f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1961746365, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        /* JADX WARN: Multi-variable type inference failed */
                        {
                            super(2);
                        ...
                        public final void invoke(@Nullable Composer composer2, int i14) {
                            ...
                            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                                objRememberedValue = new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1
                                    ...
                                    @NotNull
                                    /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                                    public final MeasureResult m1223invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j8) {
                                        Object next;
                                        Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                        final int iM3733getMaxWidthimpl = Constraints.m3733getMaxWidthimpl(j8);
                                        List<Measurable> listSubcompose = SubcomposeLayout.subcompose(TabSlots.Tabs, function9);
                                        int size = listSubcompose.size();
                                        final int i16 = iM3733getMaxWidthimpl / size;
                                        final List<? extends Placeable> arrayList = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(listSubcompose, 10));
                                        Iterator<T> it = listSubcompose.iterator();
                                        while (it.hasNext()) {
                                            arrayList.add(((Measurable) it.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j8, i16, i16, 0, 0, 12, null)));
                                        }
                                        Iterator it2 = arrayList.iterator();
                                        if (it2.hasNext()) {
                                            next = it2.next();
                                        ...
                                        return MeasureScope.CC.OooOOo0(SubcomposeLayout, iM3733getMaxWidthimpl, height3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1.1
                                            ...
                                            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                                                ...
                                                Iterator<T> it3 = listSubcompose2.iterator();
                                                while (it3.hasNext()) {
                                                    Placeable placeableMo2794measureBRTryo0 = ((Measurable) it3.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j9, 0, 0, 0, 0, 11, null));
                                                    Placeable.PlacementScope.placeRelative$default(layout, placeableMo2794measureBRTryo0, 0, i23 - placeableMo2794measureBRTryo0.getHeight(), 0.0f, 4, null);
                                                    i23 = i23;
                                                    j9 = j9;
                                                }
                ...
                final long j9 = jM1041contentColorForek8zF_U;
                final Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function9 = function5;
                ...
                scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$3
                    ...
                    public final void invoke(@Nullable Composer composer2, int i14) {
                        TabRowKt.m1221TabRowpAZo6Ak(i, modifier5, j8, j9, function9, function10, tabs, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), i3);
                    }
                });
            }
            i4 |= 24576;
            ...
            if (i7 != 0) {
                ...
                if ((i4 & 2995931) == 599186) {
                    ...
                    long j10 = jM1041contentColorForek8zF_U;
                    i10 = i4;
                    composerStartRestartGroup.endDefaults();
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(-249175289, i10, -1, "androidx.compose.material.TabRow (TabRow.kt:128)");
                    ...
                    function6 = function2M1054getLambda1$material_release;
                    SurfaceKt.m1185SurfaceFjzlyU(SelectableGroupKt.selectableGroup(modifier2), null, primarySurface, j10, null, 0.0f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1961746365, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        /* JADX WARN: Multi-variable type inference failed */
                        {
                            super(2);
                        ...
                        public final void invoke(@Nullable Composer composer2, int i14) {
                            ...
                            final Function2<? super Composer, ? super Integer, Unit> function12 = function2M1054getLambda1$material_release;
                            ...
                            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                                objRememberedValue = new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1
                                    ...
                                    @NotNull
                                    /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                                    public final MeasureResult m1223invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j11) {
                                        Object next;
                                        Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                        final int iM3733getMaxWidthimpl = Constraints.m3733getMaxWidthimpl(j11);
                                        ...
                                        Iterator<T> it = listSubcompose.iterator();
                                        while (it.hasNext()) {
                                            arrayList.add(((Measurable) it.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j11, i16, i16, 0, 0, 12, null)));
                                        }
                                        Iterator it2 = arrayList.iterator();
                                        if (it2.hasNext()) {
                                            next = it2.next();
                                        ...
                                        return MeasureScope.CC.OooOOo0(SubcomposeLayout, iM3733getMaxWidthimpl, height3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1.1
                                            ...
                                            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                                                ...
                                                Iterator<T> it3 = listSubcompose2.iterator();
                                                while (it3.hasNext()) {
                                                    Placeable placeableMo2794measureBRTryo0 = ((Measurable) it3.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j12, 0, 0, 0, 0, 11, null));
                                                    Placeable.PlacementScope.placeRelative$default(layout, placeableMo2794measureBRTryo0, 0, i23 - placeableMo2794measureBRTryo0.getHeight(), 0.0f, 4, null);
                                                    i23 = i23;
                                                    j12 = j12;
                                                }
                    ...
                    long j11 = jM1041contentColorForek8zF_U;
                    i10 = i4;
                    composerStartRestartGroup.endDefaults();
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(-249175289, i10, -1, "androidx.compose.material.TabRow (TabRow.kt:128)");
                    ...
                    function6 = function2M1054getLambda1$material_release;
                    SurfaceKt.m1185SurfaceFjzlyU(SelectableGroupKt.selectableGroup(modifier2), null, primarySurface, j11, null, 0.0f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1961746365, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        /* JADX WARN: Multi-variable type inference failed */
                        {
                            super(2);
                        ...
                        public final void invoke(@Nullable Composer composer2, int i14) {
                            ...
                            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                                objRememberedValue = new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1
                                    ...
                                    @NotNull
                                    /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                                    public final MeasureResult m1223invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j12) {
                                        Object next;
                                        Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                        final int iM3733getMaxWidthimpl = Constraints.m3733getMaxWidthimpl(j12);
                                        List<Measurable> listSubcompose = SubcomposeLayout.subcompose(TabSlots.Tabs, function11);
                                        int size = listSubcompose.size();
                                        final int i16 = iM3733getMaxWidthimpl / size;
                                        final List<? extends Placeable> arrayList = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(listSubcompose, 10));
                                        Iterator<T> it = listSubcompose.iterator();
                                        while (it.hasNext()) {
                                            arrayList.add(((Measurable) it.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j12, i16, i16, 0, 0, 12, null)));
                                        }
                                        Iterator it2 = arrayList.iterator();
                                        if (it2.hasNext()) {
                                            next = it2.next();
                                        ...
                                        return MeasureScope.CC.OooOOo0(SubcomposeLayout, iM3733getMaxWidthimpl, height3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1.1
                                            ...
                                            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                                                ...
                                                Iterator<T> it3 = listSubcompose2.iterator();
                                                while (it3.hasNext()) {
                                                    Placeable placeableMo2794measureBRTryo0 = ((Measurable) it3.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j13, 0, 0, 0, 0, 11, null));
                                                    Placeable.PlacementScope.placeRelative$default(layout, placeableMo2794measureBRTryo0, 0, i23 - placeableMo2794measureBRTryo0.getHeight(), 0.0f, 4, null);
                                                    i23 = i23;
                                                    j13 = j13;
                                                }
                ...
                final long j13 = jM1041contentColorForek8zF_U;
                final Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function11 = function5;
                ...
                scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$3
                    ...
                    public final void invoke(@Nullable Composer composer2, int i14) {
                        TabRowKt.m1221TabRowpAZo6Ak(i, modifier6, j12, j13, function11, function12, tabs, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), i3);
                    }
                });
            }
            i4 |= 196608;
            ...
            if ((i4 & 2995931) == 599186) {
                ...
                long j14 = jM1041contentColorForek8zF_U;
                i10 = i4;
                composerStartRestartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-249175289, i10, -1, "androidx.compose.material.TabRow (TabRow.kt:128)");
                ...
                function6 = function2M1054getLambda1$material_release;
                SurfaceKt.m1185SurfaceFjzlyU(SelectableGroupKt.selectableGroup(modifier2), null, primarySurface, j14, null, 0.0f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1961746365, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(2);
                    ...
                    public final void invoke(@Nullable Composer composer2, int i14) {
                        ...
                        final Function2<? super Composer, ? super Integer, Unit> function14 = function2M1054getLambda1$material_release;
                        ...
                        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                            objRememberedValue = new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1
                                ...
                                @NotNull
                                /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                                public final MeasureResult m1223invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j15) {
                                    Object next;
                                    Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                    final int iM3733getMaxWidthimpl = Constraints.m3733getMaxWidthimpl(j15);
                                    ...
                                    Iterator<T> it = listSubcompose.iterator();
                                    while (it.hasNext()) {
                                        arrayList.add(((Measurable) it.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j15, i16, i16, 0, 0, 12, null)));
                                    }
                                    Iterator it2 = arrayList.iterator();
                                    if (it2.hasNext()) {
                                        next = it2.next();
                                    ...
                                    return MeasureScope.CC.OooOOo0(SubcomposeLayout, iM3733getMaxWidthimpl, height3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1.1
                                        ...
                                        public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                                            ...
                                            Iterator<T> it3 = listSubcompose2.iterator();
                                            while (it3.hasNext()) {
                                                Placeable placeableMo2794measureBRTryo0 = ((Measurable) it3.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j16, 0, 0, 0, 0, 11, null));
                                                Placeable.PlacementScope.placeRelative$default(layout, placeableMo2794measureBRTryo0, 0, i23 - placeableMo2794measureBRTryo0.getHeight(), 0.0f, 4, null);
                                                i23 = i23;
                                                j16 = j16;
                                            }
                ...
                long j15 = jM1041contentColorForek8zF_U;
                i10 = i4;
                composerStartRestartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-249175289, i10, -1, "androidx.compose.material.TabRow (TabRow.kt:128)");
                ...
                function6 = function2M1054getLambda1$material_release;
                SurfaceKt.m1185SurfaceFjzlyU(SelectableGroupKt.selectableGroup(modifier2), null, primarySurface, j15, null, 0.0f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1961746365, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(2);
                    ...
                    public final void invoke(@Nullable Composer composer2, int i14) {
                        ...
                        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                            objRememberedValue = new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1
                                ...
                                @NotNull
                                /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                                public final MeasureResult m1223invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j16) {
                                    Object next;
                                    Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                    final int iM3733getMaxWidthimpl = Constraints.m3733getMaxWidthimpl(j16);
                                    List<Measurable> listSubcompose = SubcomposeLayout.subcompose(TabSlots.Tabs, function13);
                                    int size = listSubcompose.size();
                                    final int i16 = iM3733getMaxWidthimpl / size;
                                    final List<? extends Placeable> arrayList = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(listSubcompose, 10));
                                    Iterator<T> it = listSubcompose.iterator();
                                    while (it.hasNext()) {
                                        arrayList.add(((Measurable) it.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j16, i16, i16, 0, 0, 12, null)));
                                    }
                                    Iterator it2 = arrayList.iterator();
                                    if (it2.hasNext()) {
                                        next = it2.next();
                                    ...
                                    return MeasureScope.CC.OooOOo0(SubcomposeLayout, iM3733getMaxWidthimpl, height3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1.1
                                        ...
                                        public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                                            ...
                                            Iterator<T> it3 = listSubcompose2.iterator();
                                            while (it3.hasNext()) {
                                                Placeable placeableMo2794measureBRTryo0 = ((Measurable) it3.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j17, 0, 0, 0, 0, 11, null));
                                                Placeable.PlacementScope.placeRelative$default(layout, placeableMo2794measureBRTryo0, 0, i23 - placeableMo2794measureBRTryo0.getHeight(), 0.0f, 4, null);
                                                i23 = i23;
                                                j17 = j17;
                                            }
            ...
            final long j17 = jM1041contentColorForek8zF_U;
            final Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function13 = function5;
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$3
                ...
                public final void invoke(@Nullable Composer composer2, int i14) {
                    TabRowKt.m1221TabRowpAZo6Ak(i, modifier7, j16, j17, function13, function14, tabs, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), i3);
                }
            });
        }
        i4 |= 48;
        ...
        if (i5 != 0) {
            ...
            if (i7 != 0) {
                ...
                if ((i4 & 2995931) == 599186) {
                    ...
                    long j18 = jM1041contentColorForek8zF_U;
                    i10 = i4;
                    composerStartRestartGroup.endDefaults();
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(-249175289, i10, -1, "androidx.compose.material.TabRow (TabRow.kt:128)");
                    ...
                    function6 = function2M1054getLambda1$material_release;
                    SurfaceKt.m1185SurfaceFjzlyU(SelectableGroupKt.selectableGroup(modifier2), null, primarySurface, j18, null, 0.0f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1961746365, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        /* JADX WARN: Multi-variable type inference failed */
                        {
                            super(2);
                        ...
                        public final void invoke(@Nullable Composer composer2, int i14) {
                            ...
                            Modifier modifierFillMaxWidth$default = SizeKt.fillMaxWidth$default(Modifier.INSTANCE, 0.0f, 1, null);
                            final Function2<? super Composer, ? super Integer, Unit> function15 = tabs;
                            final Function2<? super Composer, ? super Integer, Unit> function16 = function2M1054getLambda1$material_release;
                            ...
                            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                                objRememberedValue = new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1
                                    ...
                                    @NotNull
                                    /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                                    public final MeasureResult m1223invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j19) {
                                        Object next;
                                        Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                        final int iM3733getMaxWidthimpl = Constraints.m3733getMaxWidthimpl(j19);
                                        List<Measurable> listSubcompose = SubcomposeLayout.subcompose(TabSlots.Tabs, function15);
                                        int size = listSubcompose.size();
                                        final int i16 = iM3733getMaxWidthimpl / size;
                                        final List<? extends Placeable> arrayList = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(listSubcompose, 10));
                                        Iterator<T> it = listSubcompose.iterator();
                                        while (it.hasNext()) {
                                            arrayList.add(((Measurable) it.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j19, i16, i16, 0, 0, 12, null)));
                                        }
                                        Iterator it2 = arrayList.iterator();
                                        if (it2.hasNext()) {
                                            next = it2.next();
                                        ...
                                        return MeasureScope.CC.OooOOo0(SubcomposeLayout, iM3733getMaxWidthimpl, height3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1.1
                                            ...
                                            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                                                ...
                                                Iterator<T> it3 = listSubcompose2.iterator();
                                                while (it3.hasNext()) {
                                                    Placeable placeableMo2794measureBRTryo0 = ((Measurable) it3.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j110, 0, 0, 0, 0, 11, null));
                                                    Placeable.PlacementScope.placeRelative$default(layout, placeableMo2794measureBRTryo0, 0, i23 - placeableMo2794measureBRTryo0.getHeight(), 0.0f, 4, null);
                                                    i23 = i23;
                                                    j110 = j110;
                                                }
                    ...
                    long j19 = jM1041contentColorForek8zF_U;
                    i10 = i4;
                    composerStartRestartGroup.endDefaults();
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(-249175289, i10, -1, "androidx.compose.material.TabRow (TabRow.kt:128)");
                    ...
                    function6 = function2M1054getLambda1$material_release;
                    SurfaceKt.m1185SurfaceFjzlyU(SelectableGroupKt.selectableGroup(modifier2), null, primarySurface, j19, null, 0.0f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1961746365, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        /* JADX WARN: Multi-variable type inference failed */
                        {
                            super(2);
                        ...
                        public final void invoke(@Nullable Composer composer2, int i14) {
                            ...
                            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                                objRememberedValue = new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1
                                    ...
                                    @NotNull
                                    /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                                    public final MeasureResult m1223invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j110) {
                                        Object next;
                                        Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                        final int iM3733getMaxWidthimpl = Constraints.m3733getMaxWidthimpl(j110);
                                        List<Measurable> listSubcompose = SubcomposeLayout.subcompose(TabSlots.Tabs, function15);
                                        int size = listSubcompose.size();
                                        final int i16 = iM3733getMaxWidthimpl / size;
                                        final List<? extends Placeable> arrayList = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(listSubcompose, 10));
                                        Iterator<T> it = listSubcompose.iterator();
                                        while (it.hasNext()) {
                                            arrayList.add(((Measurable) it.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j110, i16, i16, 0, 0, 12, null)));
                                        }
                                        Iterator it2 = arrayList.iterator();
                                        if (it2.hasNext()) {
                                            next = it2.next();
                                        ...
                                        return MeasureScope.CC.OooOOo0(SubcomposeLayout, iM3733getMaxWidthimpl, height3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1.1
                                            ...
                                            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                                                ...
                                                Iterator<T> it3 = listSubcompose2.iterator();
                                                while (it3.hasNext()) {
                                                    Placeable placeableMo2794measureBRTryo0 = ((Measurable) it3.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j111, 0, 0, 0, 0, 11, null));
                                                    Placeable.PlacementScope.placeRelative$default(layout, placeableMo2794measureBRTryo0, 0, i23 - placeableMo2794measureBRTryo0.getHeight(), 0.0f, 4, null);
                                                    i23 = i23;
                                                    j111 = j111;
                                                }
                ...
                final long j111 = jM1041contentColorForek8zF_U;
                final Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function15 = function5;
                ...
                scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$3
                    ...
                    public final void invoke(@Nullable Composer composer2, int i14) {
                        TabRowKt.m1221TabRowpAZo6Ak(i, modifier8, j110, j111, function15, function16, tabs, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), i3);
                    }
                });
            }
            i4 |= 196608;
            ...
            if ((i4 & 2995931) == 599186) {
                ...
                long j112 = jM1041contentColorForek8zF_U;
                i10 = i4;
                composerStartRestartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-249175289, i10, -1, "androidx.compose.material.TabRow (TabRow.kt:128)");
                ...
                function6 = function2M1054getLambda1$material_release;
                SurfaceKt.m1185SurfaceFjzlyU(SelectableGroupKt.selectableGroup(modifier2), null, primarySurface, j112, null, 0.0f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1961746365, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(2);
                    ...
                    public final void invoke(@Nullable Composer composer2, int i14) {
                        ...
                        final Function2<? super Composer, ? super Integer, Unit> function18 = function2M1054getLambda1$material_release;
                        final Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function19 = function5;
                        final int i15 = i10;
                        composer2.startReplaceableGroup(1618982084);
                        ...
                        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                            objRememberedValue = new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1
                                ...
                                @NotNull
                                /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                                public final MeasureResult m1223invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j113) {
                                    Object next;
                                    Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                    final int iM3733getMaxWidthimpl = Constraints.m3733getMaxWidthimpl(j113);
                                    ...
                                    Iterator<T> it = listSubcompose.iterator();
                                    while (it.hasNext()) {
                                        arrayList.add(((Measurable) it.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j113, i16, i16, 0, 0, 12, null)));
                                    }
                                    Iterator it2 = arrayList.iterator();
                                    if (it2.hasNext()) {
                                        next = it2.next();
                                    ...
                                    return MeasureScope.CC.OooOOo0(SubcomposeLayout, iM3733getMaxWidthimpl, height3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1.1
                                        ...
                                        public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                                            ...
                                            Iterator<T> it3 = listSubcompose2.iterator();
                                            while (it3.hasNext()) {
                                                Placeable placeableMo2794measureBRTryo0 = ((Measurable) it3.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j114, 0, 0, 0, 0, 11, null));
                                                Placeable.PlacementScope.placeRelative$default(layout, placeableMo2794measureBRTryo0, 0, i23 - placeableMo2794measureBRTryo0.getHeight(), 0.0f, 4, null);
                                                i23 = i23;
                                                j114 = j114;
                                            }
                ...
                jM1041contentColorForek8zF_U = j112;
                modifier3 = modifier2;
            } else {
                composerStartRestartGroup.startDefaults();
                if ((i2 & 1) != 0) {
                ...
                long j113 = jM1041contentColorForek8zF_U;
                i10 = i4;
                composerStartRestartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-249175289, i10, -1, "androidx.compose.material.TabRow (TabRow.kt:128)");
                ...
                function6 = function2M1054getLambda1$material_release;
                SurfaceKt.m1185SurfaceFjzlyU(SelectableGroupKt.selectableGroup(modifier2), null, primarySurface, j113, null, 0.0f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1961746365, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(2);
                    ...
                    public final void invoke(@Nullable Composer composer2, int i14) {
                        ...
                        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                            objRememberedValue = new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1
                                ...
                                @NotNull
                                /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                                public final MeasureResult m1223invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j114) {
                                    Object next;
                                    Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                    final int iM3733getMaxWidthimpl = Constraints.m3733getMaxWidthimpl(j114);
                                    List<Measurable> listSubcompose = SubcomposeLayout.subcompose(TabSlots.Tabs, function17);
                                    int size = listSubcompose.size();
                                    final int i16 = iM3733getMaxWidthimpl / size;
                                    final List<? extends Placeable> arrayList = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(listSubcompose, 10));
                                    Iterator<T> it = listSubcompose.iterator();
                                    while (it.hasNext()) {
                                        arrayList.add(((Measurable) it.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j114, i16, i16, 0, 0, 12, null)));
                                    }
                                    Iterator it2 = arrayList.iterator();
                                    if (it2.hasNext()) {
                                        next = it2.next();
                                    ...
                                    return MeasureScope.CC.OooOOo0(SubcomposeLayout, iM3733getMaxWidthimpl, height3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1.1
                                        ...
                                        public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                                            ...
                                            Iterator<T> it3 = listSubcompose2.iterator();
                                            while (it3.hasNext()) {
                                                Placeable placeableMo2794measureBRTryo0 = ((Measurable) it3.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j115, 0, 0, 0, 0, 11, null));
                                                Placeable.PlacementScope.placeRelative$default(layout, placeableMo2794measureBRTryo0, 0, i23 - placeableMo2794measureBRTryo0.getHeight(), 0.0f, 4, null);
                                                i23 = i23;
                                                j115 = j115;
                                            }
                ...
                jM1041contentColorForek8zF_U = j113;
                modifier3 = modifier2;
            }
            scopeUpdateScopeEndRestartGroup = composerStartRestartGroup.endRestartGroup();
            if (scopeUpdateScopeEndRestartGroup == null) {
            ...
            final long j115 = jM1041contentColorForek8zF_U;
            final Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function17 = function5;
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$3
                ...
                public final void invoke(@Nullable Composer composer2, int i14) {
                    TabRowKt.m1221TabRowpAZo6Ak(i, modifier9, j114, j115, function17, function18, tabs, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), i3);
                }
            });
        }
        i4 |= 24576;
        ...
        if (i7 != 0) {
            ...
            if ((i4 & 2995931) == 599186) {
                ...
                long j116 = jM1041contentColorForek8zF_U;
                i10 = i4;
                composerStartRestartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-249175289, i10, -1, "androidx.compose.material.TabRow (TabRow.kt:128)");
                ...
                function6 = function2M1054getLambda1$material_release;
                SurfaceKt.m1185SurfaceFjzlyU(SelectableGroupKt.selectableGroup(modifier2), null, primarySurface, j116, null, 0.0f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1961746365, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(2);
                    ...
                    public final void invoke(@Nullable Composer composer2, int i14) {
                        ...
                        Modifier modifierFillMaxWidth$default = SizeKt.fillMaxWidth$default(Modifier.INSTANCE, 0.0f, 1, null);
                        final Function2<? super Composer, ? super Integer, Unit> function19 = tabs;
                        final Function2<? super Composer, ? super Integer, Unit> function110 = function2M1054getLambda1$material_release;
                        ...
                        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                            objRememberedValue = new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1
                                ...
                                @NotNull
                                /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                                public final MeasureResult m1223invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j117) {
                                    Object next;
                                    Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                    final int iM3733getMaxWidthimpl = Constraints.m3733getMaxWidthimpl(j117);
                                    List<Measurable> listSubcompose = SubcomposeLayout.subcompose(TabSlots.Tabs, function19);
                                    int size = listSubcompose.size();
                                    final int i16 = iM3733getMaxWidthimpl / size;
                                    final List<? extends Placeable> arrayList = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(listSubcompose, 10));
                                    Iterator<T> it = listSubcompose.iterator();
                                    while (it.hasNext()) {
                                        arrayList.add(((Measurable) it.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j117, i16, i16, 0, 0, 12, null)));
                                    }
                                    Iterator it2 = arrayList.iterator();
                                    if (it2.hasNext()) {
                                        next = it2.next();
                                    ...
                                    return MeasureScope.CC.OooOOo0(SubcomposeLayout, iM3733getMaxWidthimpl, height3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1.1
                                        ...
                                        public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                                            ...
                                            Iterator<T> it3 = listSubcompose2.iterator();
                                            while (it3.hasNext()) {
                                                Placeable placeableMo2794measureBRTryo0 = ((Measurable) it3.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j118, 0, 0, 0, 0, 11, null));
                                                Placeable.PlacementScope.placeRelative$default(layout, placeableMo2794measureBRTryo0, 0, i23 - placeableMo2794measureBRTryo0.getHeight(), 0.0f, 4, null);
                                                i23 = i23;
                                                j118 = j118;
                                            }
                ...
                jM1041contentColorForek8zF_U = j116;
                modifier3 = modifier2;
            } else {
                composerStartRestartGroup.startDefaults();
                if ((i2 & 1) != 0) {
                ...
                long j117 = jM1041contentColorForek8zF_U;
                i10 = i4;
                composerStartRestartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-249175289, i10, -1, "androidx.compose.material.TabRow (TabRow.kt:128)");
                ...
                function6 = function2M1054getLambda1$material_release;
                SurfaceKt.m1185SurfaceFjzlyU(SelectableGroupKt.selectableGroup(modifier2), null, primarySurface, j117, null, 0.0f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1961746365, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(2);
                    ...
                    public final void invoke(@Nullable Composer composer2, int i14) {
                        ...
                        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                            objRememberedValue = new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1
                                ...
                                @NotNull
                                /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                                public final MeasureResult m1223invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j118) {
                                    Object next;
                                    Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                    final int iM3733getMaxWidthimpl = Constraints.m3733getMaxWidthimpl(j118);
                                    List<Measurable> listSubcompose = SubcomposeLayout.subcompose(TabSlots.Tabs, function19);
                                    int size = listSubcompose.size();
                                    final int i16 = iM3733getMaxWidthimpl / size;
                                    final List<? extends Placeable> arrayList = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(listSubcompose, 10));
                                    Iterator<T> it = listSubcompose.iterator();
                                    while (it.hasNext()) {
                                        arrayList.add(((Measurable) it.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j118, i16, i16, 0, 0, 12, null)));
                                    }
                                    Iterator it2 = arrayList.iterator();
                                    if (it2.hasNext()) {
                                        next = it2.next();
                                    ...
                                    return MeasureScope.CC.OooOOo0(SubcomposeLayout, iM3733getMaxWidthimpl, height3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1.1
                                        ...
                                        public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                                            ...
                                            Iterator<T> it3 = listSubcompose2.iterator();
                                            while (it3.hasNext()) {
                                                Placeable placeableMo2794measureBRTryo0 = ((Measurable) it3.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j119, 0, 0, 0, 0, 11, null));
                                                Placeable.PlacementScope.placeRelative$default(layout, placeableMo2794measureBRTryo0, 0, i23 - placeableMo2794measureBRTryo0.getHeight(), 0.0f, 4, null);
                                                i23 = i23;
                                                j119 = j119;
                                            }
                ...
                jM1041contentColorForek8zF_U = j117;
                modifier3 = modifier2;
            }
            scopeUpdateScopeEndRestartGroup = composerStartRestartGroup.endRestartGroup();
            if (scopeUpdateScopeEndRestartGroup == null) {
            ...
            final long j119 = jM1041contentColorForek8zF_U;
            final Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function19 = function5;
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$3
                ...
                public final void invoke(@Nullable Composer composer2, int i14) {
                    TabRowKt.m1221TabRowpAZo6Ak(i, modifier10, j118, j119, function19, function110, tabs, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), i3);
                }
            });
        }
        i4 |= 196608;
        ...
        if ((i4 & 2995931) == 599186) {
            ...
            long j1110 = jM1041contentColorForek8zF_U;
            i10 = i4;
            composerStartRestartGroup.endDefaults();
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-249175289, i10, -1, "androidx.compose.material.TabRow (TabRow.kt:128)");
            ...
            function6 = function2M1054getLambda1$material_release;
            SurfaceKt.m1185SurfaceFjzlyU(SelectableGroupKt.selectableGroup(modifier2), null, primarySurface, j1110, null, 0.0f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1961746365, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                ...
                public final void invoke(@Nullable Composer composer2, int i14) {
                    ...
                    final Function2<? super Composer, ? super Integer, Unit> function112 = function2M1054getLambda1$material_release;
                    ...
                    if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                        objRememberedValue = new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1
                            ...
                            @NotNull
                            /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                            public final MeasureResult m1223invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j1111) {
                                Object next;
                                Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                final int iM3733getMaxWidthimpl = Constraints.m3733getMaxWidthimpl(j1111);
                                ...
                                Iterator<T> it = listSubcompose.iterator();
                                while (it.hasNext()) {
                                    arrayList.add(((Measurable) it.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j1111, i16, i16, 0, 0, 12, null)));
                                }
                                Iterator it2 = arrayList.iterator();
                                if (it2.hasNext()) {
                                    next = it2.next();
                                ...
                                return MeasureScope.CC.OooOOo0(SubcomposeLayout, iM3733getMaxWidthimpl, height3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1.1
                                    ...
                                    public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                                        ...
                                        Iterator<T> it3 = listSubcompose2.iterator();
                                        while (it3.hasNext()) {
                                            Placeable placeableMo2794measureBRTryo0 = ((Measurable) it3.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j1112, 0, 0, 0, 0, 11, null));
                                            Placeable.PlacementScope.placeRelative$default(layout, placeableMo2794measureBRTryo0, 0, i23 - placeableMo2794measureBRTryo0.getHeight(), 0.0f, 4, null);
                                            i23 = i23;
                                            j1112 = j1112;
                                        }
            ...
            jM1041contentColorForek8zF_U = j1110;
            modifier3 = modifier2;
        } else {
            composerStartRestartGroup.startDefaults();
            if ((i2 & 1) != 0) {
            ...
            long j1111 = jM1041contentColorForek8zF_U;
            i10 = i4;
            composerStartRestartGroup.endDefaults();
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-249175289, i10, -1, "androidx.compose.material.TabRow (TabRow.kt:128)");
            ...
            function6 = function2M1054getLambda1$material_release;
            SurfaceKt.m1185SurfaceFjzlyU(SelectableGroupKt.selectableGroup(modifier2), null, primarySurface, j1111, null, 0.0f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1961746365, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                ...
                public final void invoke(@Nullable Composer composer2, int i14) {
                    ...
                    if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                        objRememberedValue = new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1
                            ...
                            @NotNull
                            /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                            public final MeasureResult m1223invoke0kLqBqw(@NotNull final SubcomposeMeasureScope SubcomposeLayout, final long j1112) {
                                Object next;
                                Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                final int iM3733getMaxWidthimpl = Constraints.m3733getMaxWidthimpl(j1112);
                                List<Measurable> listSubcompose = SubcomposeLayout.subcompose(TabSlots.Tabs, function111);
                                int size = listSubcompose.size();
                                final int i16 = iM3733getMaxWidthimpl / size;
                                final List<? extends Placeable> arrayList = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(listSubcompose, 10));
                                Iterator<T> it = listSubcompose.iterator();
                                while (it.hasNext()) {
                                    arrayList.add(((Measurable) it.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j1112, i16, i16, 0, 0, 12, null)));
                                }
                                Iterator it2 = arrayList.iterator();
                                if (it2.hasNext()) {
                                    next = it2.next();
                                ...
                                return MeasureScope.CC.OooOOo0(SubcomposeLayout, iM3733getMaxWidthimpl, height3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1.1
                                    ...
                                    public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                                        ...
                                        Iterator<T> it3 = listSubcompose2.iterator();
                                        while (it3.hasNext()) {
                                            Placeable placeableMo2794measureBRTryo0 = ((Measurable) it3.next()).mo2794measureBRTryo0(Constraints.m3724copyZbe2FdA$default(j1113, 0, 0, 0, 0, 11, null));
                                            Placeable.PlacementScope.placeRelative$default(layout, placeableMo2794measureBRTryo0, 0, i23 - placeableMo2794measureBRTryo0.getHeight(), 0.0f, 4, null);
                                            i23 = i23;
                                            j1113 = j1113;
                                        }
            ...
            jM1041contentColorForek8zF_U = j1111;
            modifier3 = modifier2;
        }
        scopeUpdateScopeEndRestartGroup = composerStartRestartGroup.endRestartGroup();
        if (scopeUpdateScopeEndRestartGroup == null) {
        ...
        final long j1113 = jM1041contentColorForek8zF_U;
        final Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function111 = function5;
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$3
            ...
            public final void invoke(@Nullable Composer composer2, int i14) {
                TabRowKt.m1221TabRowpAZo6Ak(i, modifier11, j1112, j1113, function111, function112, tabs, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), i3);
            }
        });
    }
}
