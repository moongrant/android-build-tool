...
public final class TextFieldDefaultsKt {
    ...
    public static final State<BorderStroke> m1240animateBorderStrokeAsStateNuRrP5Q(boolean z, boolean z2, InteractionSource interactionSource, TextFieldColors textFieldColors, float f, float f2, Composer composer, int i) {
        ...
        if (z) {
            ...
            stateRememberUpdatedState = AnimateAsStateKt.m71animateDpAsStateKz89ssw(f3, AnimationSpecKt.tween$default(TextFieldImplKt.AnimationDuration, 0, null, 6, null), null, composer, 48, 4);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(1685712164);
            stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Dp.m3763boximpl(f2), composer, (i >> 15) & 14);
            composer.endReplaceableGroup();
        }
        State<BorderStroke> stateRememberUpdatedState2 = SnapshotStateKt.rememberUpdatedState(new BorderStroke(((Dp) stateRememberUpdatedState.getValue()).m3779unboximpl(), new SolidColor(stateIndicatorColor.getValue().m1680unboximpl(), null), null), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
