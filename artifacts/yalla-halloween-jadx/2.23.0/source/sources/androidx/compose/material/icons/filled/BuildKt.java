...
public final class BuildKt {
    ...
    public static final ImageVector getBuild(@NotNull Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Build", Dp.m3765constructorimpl(24.0f), Dp.m3765constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderOooO00o = oo0o0Oo.OooO00o(22.7f, 19.0f, -9.1f, -9.1f);
        pathBuilderOooO00o.curveToRelative(0.9f, -2.3f, 0.4f, -5.0f, -1.5f, -6.9f);
        pathBuilderOooO00o.curveToRelative(-2.0f, -2.0f, -5.0f, -2.4f, -7.4f, -1.3f);
        pathBuilderOooO00o.lineTo(9.0f, 6.0f);
        pathBuilderOooO00o.lineTo(6.0f, 9.0f);
        pathBuilderOooO00o.lineTo(1.6f, 4.7f);
        pathBuilderOooO00o.curveTo(0.4f, 7.1f, 0.9f, 10.1f, 2.9f, 12.1f);
        pathBuilderOooO00o.curveToRelative(1.9f, 1.9f, 4.6f, 2.4f, 6.9f, 1.5f);
        pathBuilderOooO00o.lineToRelative(9.1f, 9.1f);
        pathBuilderOooO00o.curveToRelative(0.4f, 0.4f, 1.0f, 0.4f, 1.4f, 0.0f);
        pathBuilderOooO00o.lineToRelative(2.3f, -2.3f);
        pathBuilderOooO00o.curveToRelative(0.5f, -0.4f, 0.5f, -1.1f, 0.1f, -1.4f);
