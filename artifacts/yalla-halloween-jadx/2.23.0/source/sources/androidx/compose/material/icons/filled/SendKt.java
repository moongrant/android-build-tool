...
public final class SendKt {
    ...
    public static final ImageVector getSend(@NotNull Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Send", Dp.m3765constructorimpl(24.0f), Dp.m3765constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderOooO00o = o0O0O00.OooO00o(2.01f, 21.0f, 23.0f, 12.0f);
        pathBuilderOooO00o.lineTo(2.01f, 3.0f);
        pathBuilderOooO00o.lineTo(2.0f, 10.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m2213addPathoIyEayM$default(builder, o000000.OooO00o(pathBuilderOooO00o, 15.0f, 2.0f, -15.0f, 2.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM1995getButtKaPHkGw, iM2005getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
