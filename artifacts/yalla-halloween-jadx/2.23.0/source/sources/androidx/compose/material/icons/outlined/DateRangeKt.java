...
public final class DateRangeKt {
    ...
    public static final ImageVector getDateRange(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.DateRange", Dp.m3765constructorimpl(24.0f), Dp.m3765constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        o00000.OooO00o(pathBuilder, 7.0f, 13.0f, -2.0f);
        ...
        o00000.OooO00o(pathBuilder, 5.0f, 6.0f, 2.0f);
        ...
        pathBuilder.horizontalLineToRelative(14.0f);
        pathBuilder.close();
        o000000O.OooO00o(pathBuilder, 15.0f, 13.0f, 2.0f, -2.0f);
        pathBuilder.horizontalLineToRelative(-2.0f);
        pathBuilder.verticalLineToRelative(2.0f);
        pathBuilder.close();
