...
public final class AddCircleKt {
    ...
    public static final ImageVector getAddCircle(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.AddCircle", Dp.m3765constructorimpl(24.0f), Dp.m3765constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderOooO00o.moveTo(16.0f, 13.0f);
        ...
        pathBuilderOooO00o.verticalLineToRelative(-3.0f);
        pathBuilderOooO00o.lineTo(8.0f, 13.0f);
        ...
        pathBuilderOooO00o.horizontalLineToRelative(3.0f);
        pathBuilderOooO00o.lineTo(11.0f, 8.0f);
        pathBuilderOooO00o.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderOooO00o.reflectiveCurveToRelative(1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderOooO00o.verticalLineToRelative(3.0f);
        pathBuilderOooO00o.horizontalLineToRelative(3.0f);
        pathBuilderOooO00o.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m2213addPathoIyEayM$default(builder, o00000O0.OooO00o(pathBuilderOooO00o, -0.45f, 1.0f, -1.0f, 1.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM1995getButtKaPHkGw, iM2005getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
