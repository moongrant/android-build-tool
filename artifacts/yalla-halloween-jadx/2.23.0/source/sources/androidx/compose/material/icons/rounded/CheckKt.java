...
public final class CheckKt {
    ...
    public static final ImageVector getCheck(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Check", Dp.m3765constructorimpl(24.0f), Dp.m3765constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderOooO00o = o0O0O00.OooO00o(9.0f, 16.17f, 5.53f, 12.7f);
        ...
        pathBuilderOooO00o.lineToRelative(4.18f, 4.18f);
        pathBuilderOooO00o.curveToRelative(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        pathBuilderOooO00o.lineTo(20.29f, 7.71f);
        pathBuilderOooO00o.curveToRelative(0.39f, -0.39f, 0.39f, -1.02f, 0.0f, -1.41f);
        pathBuilderOooO00o.curveToRelative(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        pathBuilderOooO00o.lineTo(9.0f, 16.17f);
