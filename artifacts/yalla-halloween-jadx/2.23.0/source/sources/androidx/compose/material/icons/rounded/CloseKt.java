...
public final class CloseKt {
    ...
    public static final ImageVector getClose(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Close", Dp.m3765constructorimpl(24.0f), Dp.m3765constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderOooO00o = o000Oo0.OooO00o(18.3f, 5.71f);
        pathBuilderOooO00o.curveToRelative(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        pathBuilderOooO00o.lineTo(12.0f, 10.59f);
        pathBuilderOooO00o.lineTo(7.11f, 5.7f);
        pathBuilderOooO00o.curveToRelative(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        pathBuilderOooO00o.curveToRelative(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
        pathBuilderOooO00o.lineTo(10.59f, 12.0f);
        pathBuilderOooO00o.lineTo(5.7f, 16.89f);
        pathBuilderOooO00o.curveToRelative(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
        pathBuilderOooO00o.curveToRelative(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        pathBuilderOooO00o.lineTo(12.0f, 13.41f);
        pathBuilderOooO00o.lineToRelative(4.89f, 4.89f);
        pathBuilderOooO00o.curveToRelative(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        pathBuilderOooO00o.curveToRelative(0.39f, -0.39f, 0.39f, -1.02f, 0.0f, -1.41f);
        pathBuilderOooO00o.lineTo(13.41f, 12.0f);
        pathBuilderOooO00o.lineToRelative(4.89f, -4.89f);
        pathBuilderOooO00o.curveToRelative(0.38f, -0.38f, 0.38f, -1.02f, 0.0f, -1.4f);
