...
public final class KeyboardArrowDownKt {
    ...
    public static final ImageVector getKeyboardArrowDown(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.KeyboardArrowDown", Dp.m3765constructorimpl(24.0f), Dp.m3765constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderOooO00o = o0O0O00.OooO00o(8.12f, 9.29f, 12.0f, 13.17f);
        ...
        pathBuilderOooO00o.curveToRelative(-0.39f, 0.39f, -1.02f, 0.39f, -1.41f, 0.0f);
        pathBuilderOooO00o.lineTo(6.7f, 10.7f);
        pathBuilderOooO00o.curveToRelative(-0.39f, -0.39f, -0.39f, -1.02f, 0.0f, -1.41f);
