...
public final class KeyboardArrowUpKt {
    ...
    public static final ImageVector getKeyboardArrowUp(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.KeyboardArrowUp", Dp.m3765constructorimpl(24.0f), Dp.m3765constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderOooO00o = o0O0O00.OooO00o(8.12f, 14.71f, 12.0f, 10.83f);
        pathBuilderOooO00o.lineToRelative(3.88f, 3.88f);
        ...
        pathBuilderOooO00o.lineTo(12.7f, 8.71f);
        pathBuilderOooO00o.curveToRelative(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        pathBuilderOooO00o.lineTo(6.7f, 13.3f);
        pathBuilderOooO00o.curveToRelative(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
        pathBuilderOooO00o.curveToRelative(0.39f, 0.38f, 1.03f, 0.39f, 1.42f, 0.0f);
