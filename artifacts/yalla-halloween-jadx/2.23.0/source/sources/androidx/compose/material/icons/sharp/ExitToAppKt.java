...
public final class ExitToAppKt {
    ...
    public static final ImageVector getExitToApp(@NotNull Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.ExitToApp", Dp.m3765constructorimpl(24.0f), Dp.m3765constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderOooO00o = o0O0O00.OooO00o(10.09f, 15.59f, 11.5f, 17.0f);
        ...
        pathBuilderOooO00o.horizontalLineTo(3.0f);
        pathBuilderOooO00o.verticalLineToRelative(2.0f);
        pathBuilderOooO00o.horizontalLineToRelative(9.67f);
        pathBuilderOooO00o.lineToRelative(-2.58f, 2.59f);
        pathBuilderOooO00o.close();
        pathBuilderOooO00o.moveTo(21.0f, 3.0f);
        pathBuilderOooO00o.horizontalLineTo(3.0f);
        ...
        pathBuilderOooO00o.horizontalLineTo(3.0f);
        pathBuilderOooO00o.verticalLineToRelative(6.0f);
        pathBuilderOooO00o.horizontalLineToRelative(18.0f);
        pathBuilderOooO00o.verticalLineTo(3.0f);
        pathBuilderOooO00o.close();
