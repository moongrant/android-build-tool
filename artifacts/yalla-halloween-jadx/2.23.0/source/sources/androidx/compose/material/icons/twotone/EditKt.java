...
public final class EditKt {
    ...
    public static final ImageVector getEdit(@NotNull Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Edit", Dp.m3765constructorimpl(24.0f), Dp.m3765constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderOooO00o = o000Oo0.OooO00o(20.71f, 7.04f);
        pathBuilderOooO00o.curveToRelative(0.39f, -0.39f, 0.39f, -1.02f, 0.0f, -1.41f);
        pathBuilderOooO00o.lineToRelative(-2.34f, -2.34f);
        pathBuilderOooO00o.curveToRelative(-0.2f, -0.2f, -0.45f, -0.29f, -0.71f, -0.29f);
        pathBuilderOooO00o.reflectiveCurveToRelative(-0.51f, 0.1f, -0.7f, 0.29f);
        pathBuilderOooO00o.lineToRelative(-1.83f, 1.83f);
        pathBuilderOooO00o.lineToRelative(3.75f, 3.75f);
        pathBuilderOooO00o.lineToRelative(1.83f, -1.83f);
        pathBuilderOooO00o.close();
        pathBuilderOooO00o.moveTo(3.0f, 17.25f);
        pathBuilderOooO00o.verticalLineTo(21.0f);
        pathBuilderOooO00o.horizontalLineToRelative(3.75f);
        pathBuilderOooO00o.lineTo(17.81f, 9.94f);
        pathBuilderOooO00o.lineToRelative(-3.75f, -3.75f);
        pathBuilderOooO00o.lineTo(3.0f, 17.25f);
        pathBuilderOooO00o.close();
        pathBuilderOooO00o.moveTo(5.92f, 19.0f);
        pathBuilderOooO00o.horizontalLineTo(5.0f);
        pathBuilderOooO00o.verticalLineToRelative(-0.92f);
        pathBuilderOooO00o.lineToRelative(9.06f, -9.06f);
        pathBuilderOooO00o.lineToRelative(0.92f, 0.92f);
        pathBuilderOooO00o.lineTo(5.92f, 19.0f);
        pathBuilderOooO00o.close();
        ImageVector imageVectorBuild = ImageVector.Builder.m2213addPathoIyEayM$default(builder, pathBuilderOooO00o.getNodes(), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM1995getButtKaPHkGw2, iM2005getBevelLxFBmk9, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
