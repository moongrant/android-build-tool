...
public final class NotificationsKt {
    ...
    public static final ImageVector getNotifications(@NotNull Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Notifications", Dp.m3765constructorimpl(24.0f), Dp.m3765constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderOooO00o = o000Oo0.OooO00o(12.0f, 6.5f);
        pathBuilderOooO00o.curveToRelative(-2.49f, 0.0f, -4.0f, 2.02f, -4.0f, 4.5f);
        pathBuilderOooO00o.verticalLineToRelative(6.0f);
        pathBuilderOooO00o.horizontalLineToRelative(8.0f);
        pathBuilderOooO00o.verticalLineToRelative(-6.0f);
        pathBuilderOooO00o.curveToRelative(0.0f, -2.48f, -1.51f, -4.5f, -4.0f, -4.5f);
        ...
        PathBuilder pathBuilderOooO00o2 = o000Oo0.OooO00o(12.0f, 22.0f);
        pathBuilderOooO00o2.curveToRelative(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f);
        pathBuilderOooO00o2.horizontalLineToRelative(-4.0f);
        pathBuilderOooO00o2.curveToRelative(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        pathBuilderOooO00o2.close();
        pathBuilderOooO00o2.moveTo(18.0f, 16.0f);
        pathBuilderOooO00o2.verticalLineToRelative(-5.0f);
        pathBuilderOooO00o2.curveToRelative(0.0f, -3.07f, -1.63f, -5.64f, -4.5f, -6.32f);
        pathBuilderOooO00o2.lineTo(13.5f, 4.0f);
        pathBuilderOooO00o2.curveToRelative(0.0f, -0.83f, -0.67f, -1.5f, -1.5f, -1.5f);
        pathBuilderOooO00o2.reflectiveCurveToRelative(-1.5f, 0.67f, -1.5f, 1.5f);
        pathBuilderOooO00o2.verticalLineToRelative(0.68f);
        pathBuilderOooO00o2.curveTo(7.64f, 5.36f, 6.0f, 7.92f, 6.0f, 11.0f);
        pathBuilderOooO00o2.verticalLineToRelative(5.0f);
        pathBuilderOooO00o2.lineToRelative(-2.0f, 2.0f);
        pathBuilderOooO00o2.verticalLineToRelative(1.0f);
        pathBuilderOooO00o2.horizontalLineToRelative(16.0f);
        pathBuilderOooO00o2.verticalLineToRelative(-1.0f);
        pathBuilderOooO00o2.lineToRelative(-2.0f, -2.0f);
        pathBuilderOooO00o2.close();
        pathBuilderOooO00o2.moveTo(16.0f, 17.0f);
        pathBuilderOooO00o2.lineTo(8.0f, 17.0f);
        pathBuilderOooO00o2.verticalLineToRelative(-6.0f);
        pathBuilderOooO00o2.curveToRelative(0.0f, -2.48f, 1.51f, -4.5f, 4.0f, -4.5f);
        pathBuilderOooO00o2.reflectiveCurveToRelative(4.0f, 2.02f, 4.0f, 4.5f);
        pathBuilderOooO00o2.verticalLineToRelative(6.0f);
        pathBuilderOooO00o2.close();
