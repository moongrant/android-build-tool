...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1108defaultColorWaAFU9c(@Nullable Composer composer, int i) {
        ...
        long jM1279defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m1279defaultRippleColor5vOe2sY(Color.INSTANCE.m1696getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public RippleAlpha rippleAlpha(@Nullable Composer composer, int i) {
        ...
        RippleAlpha rippleAlphaM1278defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m1278defaultRippleAlphaDxMtmZc(Color.INSTANCE.m1696getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
