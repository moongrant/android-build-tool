...
public abstract class Ripple implements Indication {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return this.bounded == ripple.bounded && Dp.m3770equalsimpl0(this.radius, ripple.radius) && Intrinsics.areEqual(this.color, ripple.color);
    }
    ...
    public final IndicationInstance rememberUpdatedInstance(@NotNull InteractionSource interactionSource, @Nullable Composer composer, int i) {
        ...
        long jM1680unboximpl = (this.color.getValue().m1680unboximpl() > Color.INSTANCE.m1706getUnspecified0d7_KjU() ? 1 : (this.color.getValue().m1680unboximpl() == Color.INSTANCE.m1706getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? this.color.getValue().m1680unboximpl() : rippleTheme.mo1108defaultColorWaAFU9c(composer, 0);
        composer.endReplaceableGroup();
        RippleIndicationInstance rippleIndicationInstanceMo1269rememberUpdatedRippleInstance942rkJo = mo1269rememberUpdatedRippleInstance942rkJo(interactionSource, this.bounded, this.radius, SnapshotStateKt.rememberUpdatedState(Color.m1660boximpl(jM1680unboximpl), composer, 0), SnapshotStateKt.rememberUpdatedState(rippleTheme.rippleAlpha(composer, 0), composer, 0), composer, (i & 14) | ((i << 12) & 458752));
        EffectsKt.LaunchedEffect(rippleIndicationInstanceMo1269rememberUpdatedRippleInstance942rkJo, interactionSource, new AnonymousClass1(interactionSource, rippleIndicationInstanceMo1269rememberUpdatedRippleInstance942rkJo, null), composer, ((i << 3) & 112) | 520);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return rippleIndicationInstanceMo1269rememberUpdatedRippleInstance942rkJo;
    }

    @Composable
    @NotNull
    /* JADX INFO: renamed from: rememberUpdatedRippleInstance-942rkJo */
    public abstract RippleIndicationInstance mo1269rememberUpdatedRippleInstance942rkJo(@NotNull InteractionSource interactionSource, boolean z, float f, @NotNull State<Color> state, @NotNull State<RippleAlpha> state2, @Nullable Composer composer, int i);
