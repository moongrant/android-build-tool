...
public final class RippleAlpha {
    ...
    public int hashCode() {
        return Float.floatToIntBits(this.pressedAlpha) + Oooo0.OooO00o(this.hoveredAlpha, Oooo0.OooO00o(this.focusedAlpha, Float.floatToIntBits(this.draggedAlpha) * 31, 31), 31);
    }
    ...
    public String toString() {
        ...
        return OooO00o.OooO00o(sb, this.pressedAlpha, ')');
    }
}
