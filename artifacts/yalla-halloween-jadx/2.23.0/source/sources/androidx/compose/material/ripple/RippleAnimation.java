...
public final class RippleAnimation {
    ...
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        ...
        public static final class C01042 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            int label;
            final /* synthetic */ RippleAnimation this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C01042(RippleAnimation rippleAnimation, Continuation<? super C01042> continuation) {
                super(2, continuation);
                this.this$0 = rippleAnimation;
            }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new C01042(RippleAnimation.this, null), 3, null);
    ...
    public static final class C07942 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        private /* synthetic */ Object L$0;
        int label;
        ...
        public C07942(Continuation<? super C07942> continuation) {
            super(2, continuation);
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C07942 c07942 = RippleAnimation.this.new C07942(continuation);
            c07942.L$0 = obj;
            return c07942;
        }
        ...
        @Nullable
        public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Job> continuation) {
            return ((C07942) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public final Object fadeOut(Continuation<? super Unit> continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C07942(null), continuation);
        return objCoroutineScope == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCoroutineScope : Unit.INSTANCE;
    }
    ...
    public final void m1271draw4WTKRHQ(@NotNull DrawScope draw, long j) {
        Intrinsics.checkNotNullParameter(draw, "$this$draw");
        if (this.startRadius == null) {
            this.startRadius = Float.valueOf(RippleAnimationKt.m1273getRippleStartRadiusuvyYCjk(draw.mo2108getSizeNHjbRc()));
        }
        if (this.targetRadius == null) {
            this.targetRadius = Float.isNaN(this.radius) ? Float.valueOf(RippleAnimationKt.m1272getRippleEndRadiuscSwnlzA(draw, this.bounded, draw.mo2108getSizeNHjbRc())) : Float.valueOf(draw.mo324toPx0680j_4(this.radius));
        }
        if (this.origin == null) {
            this.origin = Offset.m1425boximpl(draw.mo2107getCenterF1C5BW0());
        }
        if (this.targetCenter == null) {
            this.targetCenter = Offset.m1425boximpl(OffsetKt.Offset(Size.m1505getWidthimpl(draw.mo2108getSizeNHjbRc()) / 2.0f, Size.m1502getHeightimpl(draw.mo2108getSizeNHjbRc()) / 2.0f));
        }
        ...
        float fM1436getXimpl = Offset.m1436getXimpl(offset.getPackedValue());
        Offset offset2 = this.targetCenter;
        Intrinsics.checkNotNull(offset2);
        float fLerp2 = MathHelpersKt.lerp(fM1436getXimpl, Offset.m1436getXimpl(offset2.getPackedValue()), this.animatedCenterPercent.getValue().floatValue());
        Offset offset3 = this.origin;
        Intrinsics.checkNotNull(offset3);
        float fM1437getYimpl = Offset.m1437getYimpl(offset3.getPackedValue());
        Offset offset4 = this.targetCenter;
        Intrinsics.checkNotNull(offset4);
        long jOffset = OffsetKt.Offset(fLerp2, MathHelpersKt.lerp(fM1437getYimpl, Offset.m1437getYimpl(offset4.getPackedValue()), this.animatedCenterPercent.getValue().floatValue()));
        long jM1669copywmQWz5c$default = Color.m1669copywmQWz5c$default(j, Color.m1672getAlphaimpl(j) * fFloatValue, 0.0f, 0.0f, 0.0f, 14, null);
        if (!this.bounded) {
            OooO0O0.OooOo(draw, jM1669copywmQWz5c$default, fLerp, jOffset, 0.0f, null, null, 0, 120, null);
            return;
        }
        float fM1505getWidthimpl = Size.m1505getWidthimpl(draw.mo2108getSizeNHjbRc());
        float fM1502getHeightimpl = Size.m1502getHeightimpl(draw.mo2108getSizeNHjbRc());
