...
public final class RippleAnimationKt {
    private static final float BoundedRippleExtraRadius = Dp.m3765constructorimpl(10);
    ...
    public static final float m1272getRippleEndRadiuscSwnlzA(@NotNull Density getRippleEndRadius, boolean z, long j) {
        Intrinsics.checkNotNullParameter(getRippleEndRadius, "$this$getRippleEndRadius");
        float fM1434getDistanceimpl = Offset.m1434getDistanceimpl(OffsetKt.Offset(Size.m1505getWidthimpl(j), Size.m1502getHeightimpl(j))) / 2.0f;
        return z ? fM1434getDistanceimpl + getRippleEndRadius.mo324toPx0680j_4(BoundedRippleExtraRadius) : fM1434getDistanceimpl;
    }

    /* JADX INFO: renamed from: getRippleStartRadius-uvyYCjk, reason: not valid java name */
    public static final float m1273getRippleStartRadiusuvyYCjk(long j) {
        return Math.max(Size.m1505getWidthimpl(j), Size.m1502getHeightimpl(j)) * 0.3f;
    }
}
