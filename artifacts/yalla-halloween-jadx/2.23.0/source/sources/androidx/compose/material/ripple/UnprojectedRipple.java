...
final class UnprojectedRipple extends RippleDrawable {
    ...
    private final long m1281calculateRippleColor5vOe2sY(long color, float alpha) {
        if (Build.VERSION.SDK_INT < 28) {
            alpha *= 2;
        }
        return Color.m1669copywmQWz5c$default(color, RangesKt.coerceAtMost(alpha, 1.0f), 0.0f, 0.0f, 0.0f, 14, null);
    }
    ...
    public final void m1282setColorDxMtmZc(long color, float alpha) {
        long jM1281calculateRippleColor5vOe2sY = m1281calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (color2 == null ? false : Color.m1671equalsimpl0(color2.m1680unboximpl(), jM1281calculateRippleColor5vOe2sY)) {
            return;
        }
        this.rippleColor = Color.m1660boximpl(jM1281calculateRippleColor5vOe2sY);
        setColor(ColorStateList.valueOf(ColorKt.m1724toArgb8_81llA(jM1281calculateRippleColor5vOe2sY)));
    }
