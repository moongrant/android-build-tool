...
public final class BroadcastFrameClock implements MonotonicFrameClock {
    ...
    public static final class FrameAwaiter<R> {
        ...
        public final void resume(long timeNanos) {
            ...
            try {
                ...
                objM4213constructorimpl = Result.m4213constructorimpl(this.onFrame.invoke(Long.valueOf(timeNanos)));
            } catch (Throwable th) {
    ...
    public final void fail(Throwable cause) {
        synchronized (this.lock) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                Result.Companion companion = Result.INSTANCE;
                continuation.resumeWith(Result.m4213constructorimpl(ResultKt.createFailure(cause)));
            }
            this.awaiters.clear();
    ...
    public <R> Object withFrameNanos(@NotNull Function1<? super Long, ? extends R> function1, @NotNull Continuation<? super R> continuation) throws Throwable {
        ...
        synchronized (this.lock) {
            ...
            if (th != null) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m4213constructorimpl(ResultKt.createFailure(th)));
            } else {
