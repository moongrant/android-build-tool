...
public final class ComposerImpl implements Composer {
    ...
    public final void invokeMovableContentLambda(final MovableContent<Object> content, PersistentCompositionLocalMap locals, final Object parameter, boolean force) {
        ...
        try {
            ...
            m1287startBaiHCIY(202, ComposerKt.getCompositionLocalMap(), GroupKind.INSTANCE.m1297getGroupULZAiWs(), locals);
    ...
    private final void m1287startBaiHCIY(int key, Object objectKey, int kind, Object data) {
        ...
        boolean z = kind != companion.m1297getGroupULZAiWs();
        ...
        boolean z2 = !(kind != companion.m1298getNodeULZAiWs()) && this.reusing;
    ...
    private final void startGroup(int key) {
        m1287startBaiHCIY(key, null, GroupKind.INSTANCE.m1297getGroupULZAiWs(), null);
    }
    ...
    public void sourceInformationMarkerStart(int key, @NotNull String sourceInformation) {
        Intrinsics.checkNotNullParameter(sourceInformation, "sourceInformation");
        if (this.sourceInformationEnabled) {
            m1287startBaiHCIY(key, null, GroupKind.INSTANCE.m1297getGroupULZAiWs(), sourceInformation);
        }
    }
    ...
    public void startDefaults() {
        m1287startBaiHCIY(-127, null, GroupKind.INSTANCE.m1297getGroupULZAiWs(), null);
    }

    @Override // androidx.compose.runtime.Composer
    @ComposeCompilerApi
    public void startMovableGroup(int key, @Nullable Object dataKey) {
        m1287startBaiHCIY(key, dataKey, GroupKind.INSTANCE.m1297getGroupULZAiWs(), null);
    }

    @Override // androidx.compose.runtime.Composer
    public void startNode() {
        m1287startBaiHCIY(125, null, GroupKind.INSTANCE.m1298getNodeULZAiWs(), null);
    ...
    public void startProviders(@NotNull final ProvidedValue<?>[] values) {
        ...
        m1287startBaiHCIY(202, ComposerKt.getCompositionLocalMap(), GroupKind.INSTANCE.m1297getGroupULZAiWs(), persistentCompositionLocalMapUpdateProviderMapGroup);
    }
    ...
    public void startReusableGroup(int key, @Nullable Object dataKey) {
        ...
        m1287startBaiHCIY(key, null, GroupKind.INSTANCE.m1297getGroupULZAiWs(), dataKey);
    }

    @Override // androidx.compose.runtime.Composer
    public void startReusableNode() {
        m1287startBaiHCIY(125, null, GroupKind.INSTANCE.m1299getReusableNodeULZAiWs(), null);
        this.nodeExpected = true;
    }
