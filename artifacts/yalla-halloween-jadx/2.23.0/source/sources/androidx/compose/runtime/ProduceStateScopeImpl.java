...
final class ProduceStateScopeImpl<T> implements ProduceStateScope<T>, MutableState<T> {
    ...
    @Nullable
    public Object awaitDispose(@NotNull Function0<Unit> function0, @NotNull Continuation<?> continuation) {
