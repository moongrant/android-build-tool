...
public final class SkippableUpdater<T> {
    ...
    public static final /* synthetic */ SkippableUpdater m1300boximpl(Composer composer) {
        return new SkippableUpdater(composer);
    }

    @NotNull
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static <T> Composer m1301constructorimpl(@NotNull Composer composer) {
        Intrinsics.checkNotNullParameter(composer, "composer");
        return composer;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m1302equalsimpl(Composer composer, Object obj) {
        return (obj instanceof SkippableUpdater) && Intrinsics.areEqual(composer, ((SkippableUpdater) obj).getComposer());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1303equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m1304hashCodeimpl(Composer composer) {
    ...
    public static final void m1306updateimpl(Composer composer, @NotNull Function1<? super Updater<T>, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        composer.startReplaceableGroup(509942095);
        block.invoke(Updater.m1308boximpl(Updater.m1309constructorimpl(composer)));
        composer.endReplaceableGroup();
    }

    public boolean equals(Object obj) {
        return m1302equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m1304hashCodeimpl(this.composer);
    }

    public String toString() {
        return m1305toStringimpl(this.composer);
    }
