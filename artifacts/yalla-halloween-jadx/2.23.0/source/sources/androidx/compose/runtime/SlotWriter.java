...
public final class SlotWriter {
    ...
    public final void verifyDataAnchors$runtime_release() {
        ...
        while (i2 < size$runtime_release) {
            ...
            if (!(iDataIndex <= length)) {
                throw new IllegalStateException(p022Oooo00O.OooOO0.OooO00o("Data index, ", iDataIndex, ", out of bound at ", i2).toString());
            }
            if (iDataAnchor < 0 && !z) {
                if (!(i == i2)) {
                    throw new IllegalStateException(p022Oooo00O.OooOO0.OooO00o("Expected the slot gap owner to be ", i, " found gap at ", i2).toString());
                }
                z = true;
            }
            i2++;
    ...
    public final Object set(int index, @Nullable Object value) {
        ...
        StringBuilder sbOooO00o = o0000O0.OooO00o("Write to an invalid slot index ", index, " for group ");
        sbOooO00o.append(this.currentGroup);
        ComposerKt.composeRuntimeError(sbOooO00o.toString().toString());
        throw new KotlinNothingValueException();
    }
