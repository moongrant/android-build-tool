...
public final class Updater<T> {
    ...
    public static final /* synthetic */ Updater m1308boximpl(Composer composer) {
        return new Updater(composer);
    }

    @NotNull
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static <T> Composer m1309constructorimpl(@NotNull Composer composer) {
        Intrinsics.checkNotNullParameter(composer, "composer");
        return composer;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m1310equalsimpl(Composer composer, Object obj) {
        return (obj instanceof Updater) && Intrinsics.areEqual(composer, ((Updater) obj).getComposer());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1311equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m1312hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* JADX INFO: renamed from: init-impl, reason: not valid java name */
    public static final void m1313initimpl(Composer composer, @NotNull final Function1<? super T, Unit> block) {
    ...
    public static final void m1314reconcileimpl(Composer composer, @NotNull final Function1<? super T, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    public static final void m1315setimpl(Composer composer, int i, @NotNull Function2<? super T, ? super Integer, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        if (composer.getInserting() || !Intrinsics.areEqual(composer.rememberedValue(), Integer.valueOf(i))) {
            androidx.compose.animation.OooO0O0.OooO00o(i, composer, i, block);
        }
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m1317toStringimpl(Composer composer) {
        return "Updater(composer=" + composer + ')';
    }

    /* JADX INFO: renamed from: update-impl, reason: not valid java name */
    public static final void m1318updateimpl(Composer composer, int i, @NotNull Function2<? super T, ? super Integer, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    public boolean equals(Object obj) {
        return m1310equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m1312hashCodeimpl(this.composer);
    }

    public String toString() {
        return m1317toStringimpl(this.composer);
    }
    ...
    /* JADX INFO: renamed from: update-impl, reason: not valid java name */
    public static final <V> void m1319updateimpl(Composer composer, V v, @NotNull Function2<? super T, ? super V, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        boolean inserting = composer.getInserting();
    ...
    /* JADX INFO: renamed from: set-impl, reason: not valid java name */
    public static final <V> void m1316setimpl(Composer composer, V v, @NotNull Function2<? super T, ? super V, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
