...
public final class NestedMutableSnapshot extends MutableSnapshot {
    ...
    public NestedMutableSnapshot(int i, @NotNull SnapshotIdSet invalid, @Nullable Function1<Object, Unit> function1, @Nullable Function1<Object, Unit> function2, @NotNull MutableSnapshot parent) {
        super(i, invalid, function1, function2);
        Intrinsics.checkNotNullParameter(invalid, "invalid");
        Intrinsics.checkNotNullParameter(parent, "parent");
        this.parent = parent;
        parent.mo1323nestedActivated$runtime_release(this);
    }
    ...
    private final void deactivate() {
        ...
        this.parent.mo1324nestedDeactivated$runtime_release(this);
    }
