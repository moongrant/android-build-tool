...
public final /* data */ class BiasAlignment implements Alignment {
    ...
    public static final /* data */ class Horizontal implements Alignment.Horizontal {
        ...
        public int align(int size, int space, @NotNull LayoutDirection layoutDirection) {
            ...
            return MathKt.roundToInt((1 + (layoutDirection == LayoutDirection.Ltr ? this.bias : (-1) * this.bias)) * ((space - size) / 2.0f));
        }
        ...
        public String toString() {
            return androidx.compose.animation.OooO00o.OooO00o(new StringBuilder("Horizontal(bias="), this.bias, ')');
        }
    }
    ...
    public static final /* data */ class Vertical implements Alignment.Vertical {
        ...
        public int align(int size, int space) {
            return MathKt.roundToInt((1 + this.bias) * ((space - size) / 2.0f));
        }
        ...
        @NotNull
        public String toString() {
            return androidx.compose.animation.OooO00o.OooO00o(new StringBuilder("Vertical(bias="), this.bias, ')');
        }
    }
    ...
    public long mo1326alignKFBX0sM(long size, long space, @NotNull LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        float fM3925getWidthimpl = (IntSize.m3925getWidthimpl(space) - IntSize.m3925getWidthimpl(size)) / 2.0f;
        float fM3924getHeightimpl = (IntSize.m3924getHeightimpl(space) - IntSize.m3924getHeightimpl(size)) / 2.0f;
        float f = 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt(((layoutDirection == LayoutDirection.Ltr ? this.horizontalBias : (-1) * this.horizontalBias) + f) * fM3925getWidthimpl), MathKt.roundToInt((f + this.verticalBias) * fM3924getHeightimpl));
    }
    ...
    public String toString() {
        ...
        return androidx.compose.animation.OooO00o.OooO00o(sb, this.verticalBias, ')');
    }
}
