...
public final class CombinedModifier implements Modifier {
    ...
    public String toString() {
        return oo000o.OooO00o(new StringBuilder("["), (String) foldIn("", new Function2<String, Modifier.Element, String>() { // from class: androidx.compose.ui.CombinedModifier.toString.1
