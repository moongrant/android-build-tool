...
public final class ComposedModifierKt {
    ...
    public static final Modifier materializeModifier(@NotNull final Composer composer, @NotNull Modifier modifier) {
        ...
        Modifier modifier2 = (Modifier) modifier.foldIn(Modifier.INSTANCE, new Function2<Modifier, Modifier.Element, Modifier>() { // from class: androidx.compose.ui.ComposedModifierKt$materialize$result$1
            ...
            public final Modifier invoke(@NotNull Modifier acc, @NotNull Modifier.Element element) {
                ...
                return acc.then(modifierMaterializeModifier);
            }
        });
    ...
    public static final Modifier materializeWithCompositionLocalInjectionInternal(@NotNull Composer composer, @NotNull Modifier modifier) {
        Intrinsics.checkNotNullParameter(composer, "<this>");
        Intrinsics.checkNotNullParameter(modifier, "modifier");
        return modifier == Modifier.INSTANCE ? modifier : materializeModifier(composer, OooO00o.OooO00o(new CompositionLocalMapInjectionElement(composer.getCurrentCompositionLocalMap()), modifier));
    }
