...
final /* data */ class PainterElement extends ModifierNodeElement<PainterNode> {
    ...
    public int hashCode() {
        ...
        int iOooO00o = Oooo0.OooO00o(this.alpha, (this.contentScale.hashCode() + ((this.alignment.hashCode() + ((iHashCode + r1) * 31)) * 31)) * 31, 31);
    ...
    public void update(@NotNull PainterNode node) {
        ...
        boolean z = this.sizeToIntrinsics;
        boolean z2 = sizeToIntrinsics != z || (z && !Size.m1501equalsimpl0(node.getPainter().getIntrinsicSize(), this.painter.getIntrinsicSize()));
