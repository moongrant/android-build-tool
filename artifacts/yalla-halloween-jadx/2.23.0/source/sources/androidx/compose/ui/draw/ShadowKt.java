...
public final class ShadowKt {
    ...
    public static final Modifier m1347shadows4CzXII(@NotNull Modifier shadow, final float f, @NotNull final Shape shape, final boolean z, final long j, final long j2) {
        Intrinsics.checkNotNullParameter(shadow, "$this$shadow");
        Intrinsics.checkNotNullParameter(shape, "shape");
        if (Dp.m3764compareTo0680j_4(f, Dp.m3765constructorimpl(0)) > 0 || z) {
            return InspectableValueKt.inspectableWrapper(shadow, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.ui.draw.ShadowKt$shadow-s4CzXII$$inlined$debugInspectorInfo$1
                ...
                public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
                    ...
                    androidx.compose.foundation.OooO00o.OooO00o(z, inspectorInfo.getProperties(), "clip", inspectorInfo).set("ambientColor", Color.m1660boximpl(j));
                    inspectorInfo.getProperties().set("spotColor", Color.m1660boximpl(j2));
                }
                ...
                public final void invoke2(@NotNull GraphicsLayerScope graphicsLayer) {
                    ...
                    graphicsLayer.mo1837setAmbientShadowColor8_81llA(j);
                    graphicsLayer.mo1839setSpotShadowColor8_81llA(j2);
                }
            }));
        }
        return shadow;
    ...
    public static /* synthetic */ Modifier m1348shadows4CzXII$default(Modifier modifier, float f, Shape shape, boolean z, long j, long j2, int i, Object obj) {
        boolean z2;
        Shape rectangleShape = (i & 2) != 0 ? RectangleShapeKt.getRectangleShape() : shape;
        if ((i & 4) != 0) {
            z2 = false;
            if (Dp.m3764compareTo0680j_4(f, Dp.m3765constructorimpl(0)) > 0) {
                z2 = true;
            }
        } else {
            z2 = z;
        }
        return m1347shadows4CzXII(modifier, f, rectangleShape, z2, (i & 8) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : j, (i & 16) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : j2);
    }
    ...
    public static final /* synthetic */ Modifier m1349shadowziNgDLE(Modifier shadow, float f, Shape shape, boolean z) {
        Intrinsics.checkNotNullParameter(shadow, "$this$shadow");
        Intrinsics.checkNotNullParameter(shape, "shape");
        return m1347shadows4CzXII(shadow, f, shape, z, GraphicsLayerScopeKt.getDefaultShadowColor(), GraphicsLayerScopeKt.getDefaultShadowColor());
    }

    /* JADX INFO: renamed from: shadow-ziNgDLE$default, reason: not valid java name */
    public static /* synthetic */ Modifier m1350shadowziNgDLE$default(Modifier modifier, float f, Shape shape, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
        ...
        return m1349shadowziNgDLE(modifier, f, shape, z);
    }
}
