...
public final class FocusDirection {
    ...
    private static final int Next = m1353constructorimpl(1);
    private static final int Previous = m1353constructorimpl(2);
    private static final int Left = m1353constructorimpl(3);
    private static final int Right = m1353constructorimpl(4);
    private static final int Up = m1353constructorimpl(5);
    private static final int Down = m1353constructorimpl(6);
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m1359getEnterdhqQ8s$annotations() {
        }

        @ExperimentalComposeUiApi
        /* JADX INFO: renamed from: getExit-dhqQ-8s$annotations, reason: not valid java name */
        public static /* synthetic */ void m1360getExitdhqQ8s$annotations() {
        }
        ...
        public static /* synthetic */ void m1361getIndhqQ8s$annotations() {
        }
    ...
    public static final /* synthetic */ FocusDirection m1352boximpl(int i) {
        return new FocusDirection(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m1353constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m1354equalsimpl(int i, Object obj) {
        return (obj instanceof FocusDirection) && i == ((FocusDirection) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1355equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m1356hashCodeimpl(int i) {
        return i;
    }

    @NotNull
    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m1357toStringimpl(int i) {
        if (m1355equalsimpl0(i, Next)) {
            return "Next";
        }
        if (m1355equalsimpl0(i, Previous)) {
            return "Previous";
        }
        if (m1355equalsimpl0(i, Left)) {
            return "Left";
        }
        if (m1355equalsimpl0(i, Right)) {
            return "Right";
        }
        if (m1355equalsimpl0(i, Up)) {
            return "Up";
        }
        if (m1355equalsimpl0(i, Down)) {
            return "Down";
        }
        if (m1355equalsimpl0(i, Enter)) {
            return "Enter";
        }
        return m1355equalsimpl0(i, Exit) ? "Exit" : "Invalid FocusDirection";
    }

    public boolean equals(Object obj) {
        return m1354equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m1356hashCodeimpl(this.value);
    }

    @NotNull
    public String toString() {
        return m1357toStringimpl(this.value);
    }
