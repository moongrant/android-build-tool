                ...
                while (true) {
                    ...
                    if (!zHasNext) {
                        ...
                        while (it4.hasNext()) {
                            ...
                            if (focusEventModifierNode.getNode().getIsAttached()) {
                                int iM2994constructorimpl = NodeKind.m2994constructorimpl(i);
                                int i5 = i3;
                                ...
                                while (node != null) {
                                    if (node instanceof FocusTargetNode) {
                                    ...
                                    } else if (((node.getKindSet() & iM2994constructorimpl) != 0 ? i4 : i3) == 0 || !(node instanceof DelegatingNode)) {
                                        it2 = it4;
                                    } else {
                                        ...
                                        int i7 = i3;
                                        while (delegate != null) {
                                            if (((delegate.getKindSet() & iM2994constructorimpl) != 0 ? i4 : i3) != 0) {
                                                i7++;
                                                if (i7 == i4) {
                                                    node = delegate;
                                                } else {
                                                ...
                                                if ((nodePop.getKindSet() & iM2994constructorimpl) != 0) {
                                                    ...
                                                    while (nodePop != null) {
                                                        if (nodePop instanceof FocusTargetNode) {
                                                            ...
                                                            if (((nodePop.getKindSet() & iM2994constructorimpl) != 0 ? 1 : i3) != 0 && (nodePop instanceof DelegatingNode)) {
                                                                ...
                                                                while (delegate2 != null) {
                                                                    if (((delegate2.getKindSet() & iM2994constructorimpl) != 0 ? 1 : i3) != 0) {
                                                                        i8++;
                                                                        if (i8 == 1) {
                                                                            i3 = 0;
                                                                            node2 = delegate2;
                    ...
                    if (focusPropertiesModifierNode.getNode().getIsAttached()) {
                        ...
                        while (node3 != null) {
                            ...
                            } else if (((node3.getKindSet() & iM2994constructorimpl2) != 0) && (node3 instanceof DelegatingNode)) {
                                int i9 = 0;
                                for (Modifier.Node delegate3 = ((DelegatingNode) node3).getDelegate(); delegate3 != null; delegate3 = delegate3.getChild()) {
                                    if ((delegate3.getKindSet() & iM2994constructorimpl2) != 0) {
                                        i9++;
                                        if (i9 == 1) {
                                            node3 = delegate3;
                                        } else {
                        ...
                        while (mutableVector6.isNotEmpty()) {
                            ...
                            if ((nodePop2.getAggregateChildKindSet() & iM2994constructorimpl2) == 0) {
                                DelegatableNodeKt.addLayoutNodeChildren(mutableVector6, nodePop2);
                            } else {
                                while (nodePop2 != null) {
                                    if ((nodePop2.getKindSet() & iM2994constructorimpl2) != 0) {
                                        ...
                                        while (nodePop2 != null) {
                                            ...
                                            } else if (((nodePop2.getKindSet() & iM2994constructorimpl2) != 0) && (nodePop2 instanceof DelegatingNode)) {
                                                int i10 = 0;
                                                for (Modifier.Node delegate4 = ((DelegatingNode) nodePop2).getDelegate(); delegate4 != null; delegate4 = delegate4.getChild()) {
                                                    if ((delegate4.getKindSet() & iM2994constructorimpl2) != 0) {
                                                        i10++;
                                                        if (i10 == 1) {
                                                            nodePop2 = delegate4;
                                                        } else {
