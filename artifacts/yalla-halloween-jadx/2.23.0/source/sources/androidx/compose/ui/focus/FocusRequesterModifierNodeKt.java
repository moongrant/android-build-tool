    ...
    public static final boolean captureFocus(@NotNull FocusRequesterModifierNode focusRequesterModifierNode) {
        ...
        while (node != null) {
            if (!(node instanceof FocusTargetNode)) {
                if (((node.getKindSet() & iM2994constructorimpl) != 0) && (node instanceof DelegatingNode)) {
                    int i = 0;
                            ...
                            if (!(nodePop instanceof FocusTargetNode)) {
                                if (((nodePop.getKindSet() & iM2994constructorimpl) != 0) && (nodePop instanceof DelegatingNode)) {
                                    ...
                                    for (Modifier.Node delegate$ui_release2 = ((DelegatingNode) nodePop).getDelegate(); delegate$ui_release2 != null; delegate$ui_release2 = delegate$ui_release2.getChild()) {
                                        if ((delegate$ui_release2.getKindSet() & iM2994constructorimpl) != 0) {
                                            i2++;
                                            if (i2 == 1) {
                    ...
                    if ((nodePop.getKindSet() & iM2994constructorimpl) != 0) {
                        ...
                        while (nodePop != null) {
                            if (nodePop instanceof FocusTargetNode) {
                                ...
                                return focusTargetNode2.fetchFocusProperties$ui_release().getCanFocus() ? FocusTransactionsKt.requestFocus(focusTargetNode2) : TwoDimensionalFocusSearchKt.m1397findChildCorrespondingToFocusEnterOMvw8(focusTargetNode2, FocusDirection.INSTANCE.m1364getEnterdhqQ8s(), new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusRequesterModifierNodeKt$requestFocus$1$1
                                    @Override // kotlin.jvm.functions.Function1
                                    @NotNull
                                    public final Boolean invoke(@NotNull FocusTargetNode it) {
                                        Intrinsics.checkNotNullParameter(it, "it");
