...
public final class FocusTransactionsKt {
    ...
    public static final CustomDestinationResult m1384performCustomClearFocusMxy_nc0(@NotNull FocusTargetNode performCustomClearFocus, int i) {
        ...
        if (i2 != 1) {
            ...
            if (i2 == 3) {
                ...
                CustomDestinationResult customDestinationResultM1384performCustomClearFocusMxy_nc0 = m1384performCustomClearFocusMxy_nc0(activeChild, i);
                if (customDestinationResultM1384performCustomClearFocusMxy_nc0 == CustomDestinationResult.None) {
                    customDestinationResultM1384performCustomClearFocusMxy_nc0 = null;
                }
                return customDestinationResultM1384performCustomClearFocusMxy_nc0 == null ? m1386performCustomExitMxy_nc0(performCustomClearFocus, i) : customDestinationResultM1384performCustomClearFocusMxy_nc0;
            }
            if (i2 != 4) {
                throw new NoWhenBranchMatchedException();
            }
    ...
    private static final CustomDestinationResult m1385performCustomEnterMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        if (!focusTargetNode.isProcessingCustomEnter) {
            focusTargetNode.isProcessingCustomEnter = true;
            try {
                FocusRequester focusRequesterInvoke = focusTargetNode.fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m1352boximpl(i));
    ...
    private static final CustomDestinationResult m1386performCustomExitMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        if (!focusTargetNode.isProcessingCustomExit) {
            focusTargetNode.isProcessingCustomExit = true;
            try {
                FocusRequester focusRequesterInvoke = focusTargetNode.fetchFocusProperties$ui_release().getExit().invoke(FocusDirection.m1352boximpl(i));
                FocusRequester.Companion companion = FocusRequester.INSTANCE;
                if (focusRequesterInvoke != companion.getDefault()) {
                    if (focusRequesterInvoke == companion.getCancel()) {
                        return CustomDestinationResult.Cancelled;
    ...
    public static final CustomDestinationResult m1387performCustomRequestFocusMxy_nc0(@NotNull FocusTargetNode performCustomRequestFocus, int i) {
        ...
        if (i2 == 3) {
            ...
            if (activeChild != null) {
                return m1384performCustomClearFocusMxy_nc0(activeChild, i);
            }
            throw new IllegalStateException("Required value was null.".toString());
        }
        if (i2 != 4) {
        ...
        if (i4 == 1) {
            return m1385performCustomEnterMxy_nc0(focusTargetNode, i);
        }
        if (i4 == 2) {
            return CustomDestinationResult.Cancelled;
        }
        if (i4 == 3) {
            return m1387performCustomRequestFocusMxy_nc0(focusTargetNode, i);
        }
        if (i4 != 4) {
            throw new NoWhenBranchMatchedException();
        }
        CustomDestinationResult customDestinationResultM1387performCustomRequestFocusMxy_nc0 = m1387performCustomRequestFocusMxy_nc0(focusTargetNode, i);
        CustomDestinationResult customDestinationResult = customDestinationResultM1387performCustomRequestFocusMxy_nc0 == CustomDestinationResult.None ? null : customDestinationResultM1387performCustomRequestFocusMxy_nc0;
        return customDestinationResult == null ? m1385performCustomEnterMxy_nc0(focusTargetNode, i) : customDestinationResult;
    }
    ...
    public static final boolean requestFocus(@NotNull FocusTargetNode focusTargetNode) {
        Intrinsics.checkNotNullParameter(focusTargetNode, "<this>");
        int i = WhenMappings.$EnumSwitchMapping$0[m1387performCustomRequestFocusMxy_nc0(focusTargetNode, FocusDirection.INSTANCE.m1364getEnterdhqQ8s()).ordinal()];
        if (i == 1) {
    ...
    private static final boolean requestFocusForChild(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2) {
        ...
        int iM2994constructorimpl2 = NodeKind.m2994constructorimpl(LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY);
        if (!focusTargetNode.getNode().getIsAttached()) {
            throw new IllegalStateException("visitAncestors called on an unattached node".toString());
        }
        ...
        loop4: while (layoutNodeRequireLayoutNode2 != null) {
            if ((OooO00o.OooO0O0(layoutNodeRequireLayoutNode2) & iM2994constructorimpl2) != 0) {
                while (parent2 != null) {
                    if ((parent2.getKindSet() & iM2994constructorimpl2) != 0) {
                        ...
                        while (nodePop2 != null) {
                            ...
                            if (((nodePop2.getKindSet() & iM2994constructorimpl2) != 0) && (nodePop2 instanceof DelegatingNode)) {
                                int i3 = 0;
                                for (Modifier.Node delegate$ui_release2 = ((DelegatingNode) nodePop2).getDelegate(); delegate$ui_release2 != null; delegate$ui_release2 = delegate$ui_release2.getChild()) {
                                    if ((delegate$ui_release2.getKindSet() & iM2994constructorimpl2) != 0) {
                                        i3++;
                                        if (i3 == 1) {
