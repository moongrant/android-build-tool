...
public final class CornerRadiusKt {
    ...
    public static final long CornerRadius(float f, float f2) {
        return CornerRadius.m1405constructorimpl((((long) Float.floatToIntBits(f2)) & 4294967295L) | (Float.floatToIntBits(f) << 32));
    }
    ...
    public static final long m1422lerp3Ry4LBc(long j, long j2, float f) {
        return CornerRadius(MathHelpersKt.lerp(CornerRadius.m1411getXimpl(j), CornerRadius.m1411getXimpl(j2), f), MathHelpersKt.lerp(CornerRadius.m1412getYimpl(j), CornerRadius.m1412getYimpl(j2), f));
    }
}
