...
public final class OffsetKt {
    ...
    public static final long Offset(float f, float f2) {
        return Offset.m1428constructorimpl((((long) Float.floatToIntBits(f2)) & 4294967295L) | (Float.floatToIntBits(f) << 32));
    }

    /* JADX INFO: renamed from: isFinite-k-4lQ0M, reason: not valid java name */
    public static final boolean m1453isFinitek4lQ0M(long j) {
    ...
    public static /* synthetic */ void m1454isFinitek4lQ0M$annotations(long j) {
    }

    /* JADX INFO: renamed from: isSpecified-k-4lQ0M, reason: not valid java name */
    public static final boolean m1455isSpecifiedk4lQ0M(long j) {
        return j != Offset.INSTANCE.m1451getUnspecifiedF1C5BW0();
    }

    @Stable
    /* JADX INFO: renamed from: isSpecified-k-4lQ0M$annotations, reason: not valid java name */
    public static /* synthetic */ void m1456isSpecifiedk4lQ0M$annotations(long j) {
    }

    /* JADX INFO: renamed from: isUnspecified-k-4lQ0M, reason: not valid java name */
    public static final boolean m1457isUnspecifiedk4lQ0M(long j) {
        return j == Offset.INSTANCE.m1451getUnspecifiedF1C5BW0();
    }

    @Stable
    /* JADX INFO: renamed from: isUnspecified-k-4lQ0M$annotations, reason: not valid java name */
    public static /* synthetic */ void m1458isUnspecifiedk4lQ0M$annotations(long j) {
    }

    @Stable
    /* JADX INFO: renamed from: lerp-Wko1d7g, reason: not valid java name */
    public static final long m1459lerpWko1d7g(long j, long j2, float f) {
        return Offset(MathHelpersKt.lerp(Offset.m1436getXimpl(j), Offset.m1436getXimpl(j2), f), MathHelpersKt.lerp(Offset.m1437getYimpl(j), Offset.m1437getYimpl(j2), f));
    }

    /* JADX INFO: renamed from: takeOrElse-3MmeM6k, reason: not valid java name */
    public static final long m1460takeOrElse3MmeM6k(long j, @NotNull Function0<Offset> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        return m1455isSpecifiedk4lQ0M(j) ? j : block.invoke().getPackedValue();
    }
}
