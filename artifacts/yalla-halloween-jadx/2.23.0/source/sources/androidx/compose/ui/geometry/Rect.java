...
public final /* data */ class Rect {
    ...
    public static /* synthetic */ void m1461getSizeNHjbRc$annotations() {
    }
    ...
    public final boolean m1462containsk4lQ0M(long offset) {
        return Offset.m1436getXimpl(offset) >= this.left && Offset.m1436getXimpl(offset) < this.right && Offset.m1437getYimpl(offset) >= this.top && Offset.m1437getYimpl(offset) < this.bottom;
    }
    ...
    public final long m1463getBottomCenterF1C5BW0() {
    ...
    public final long m1467getCenterLeftF1C5BW0() {
    ...
    public final long m1468getCenterRightF1C5BW0() {
    ...
    public final long m1469getSizeNHjbRc() {
    ...
    public final long m1470getTopCenterF1C5BW0() {
    ...
    public int hashCode() {
        return Float.floatToIntBits(this.bottom) + Oooo0.OooO00o(this.right, Oooo0.OooO00o(this.top, Float.floatToIntBits(this.left) * 31, 31), 31);
    }
    ...
    public final Rect m1473translatek4lQ0M(long offset) {
        return new Rect(Offset.m1436getXimpl(offset) + this.left, Offset.m1437getYimpl(offset) + this.top, Offset.m1436getXimpl(offset) + this.right, Offset.m1437getYimpl(offset) + this.bottom);
    }
}
