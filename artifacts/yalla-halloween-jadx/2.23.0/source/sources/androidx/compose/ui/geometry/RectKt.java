...
public final class RectKt {
    ...
    public static final Rect m1474Rect0a9Yr6o(long j, long j2) {
        return new Rect(Offset.m1436getXimpl(j), Offset.m1437getYimpl(j), Offset.m1436getXimpl(j2), Offset.m1437getYimpl(j2));
    }

    @Stable
    @NotNull
    /* JADX INFO: renamed from: Rect-3MmeM6k, reason: not valid java name */
    public static final Rect m1475Rect3MmeM6k(long j, float f) {
        return new Rect(Offset.m1436getXimpl(j) - f, Offset.m1437getYimpl(j) - f, Offset.m1436getXimpl(j) + f, Offset.m1437getYimpl(j) + f);
    }

    @Stable
    @NotNull
    /* JADX INFO: renamed from: Rect-tz77jQw, reason: not valid java name */
    public static final Rect m1476Recttz77jQw(long j, long j2) {
        return new Rect(Offset.m1436getXimpl(j), Offset.m1437getYimpl(j), Size.m1505getWidthimpl(j2) + Offset.m1436getXimpl(j), Size.m1502getHeightimpl(j2) + Offset.m1437getYimpl(j));
    }
