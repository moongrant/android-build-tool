...
public final class Size {
    ...
    public static final /* synthetic */ Size m1493boximpl(long j) {
        return new Size(j);
    }

    @Stable
    /* JADX INFO: renamed from: component1-impl, reason: not valid java name */
    public static final float m1494component1impl(long j) {
        return m1505getWidthimpl(j);
    }

    @Stable
    /* JADX INFO: renamed from: component2-impl, reason: not valid java name */
    public static final float m1495component2impl(long j) {
        return m1502getHeightimpl(j);
    }
    ...
    public static final long m1497copyxjbvk4A(long j, float f, float f2) {
        return SizeKt.Size(f, f2);
    }

    /* JADX INFO: renamed from: copy-xjbvk4A$default, reason: not valid java name */
    public static /* synthetic */ long m1498copyxjbvk4A$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m1505getWidthimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m1502getHeightimpl(j);
        }
        return m1497copyxjbvk4A(j, f, f2);
    }

    @Stable
    /* JADX INFO: renamed from: div-7Ah8Wj8, reason: not valid java name */
    public static final long m1499div7Ah8Wj8(long j, float f) {
        return SizeKt.Size(m1505getWidthimpl(j) / f, m1502getHeightimpl(j) / f);
    }
    ...
    public static final float m1502getHeightimpl(long j) {
        if (!(j != Unspecified)) {
    ...
    public static final float m1503getMaxDimensionimpl(long j) {
        return Math.max(Math.abs(m1505getWidthimpl(j)), Math.abs(m1502getHeightimpl(j)));
    }
    ...
    public static final float m1504getMinDimensionimpl(long j) {
        return Math.min(Math.abs(m1505getWidthimpl(j)), Math.abs(m1502getHeightimpl(j)));
    }
    ...
    public static final float m1505getWidthimpl(long j) {
        if (!(j != Unspecified)) {
            throw new IllegalStateException("Size is unspecified".toString());
        }
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
    ...
    public static final boolean m1507isEmptyimpl(long j) {
        return m1505getWidthimpl(j) <= 0.0f || m1502getHeightimpl(j) <= 0.0f;
    }

    @Stable
    /* JADX INFO: renamed from: times-7Ah8Wj8, reason: not valid java name */
    public static final long m1508times7Ah8Wj8(long j, float f) {
        return SizeKt.Size(m1505getWidthimpl(j) * f, m1502getHeightimpl(j) * f);
    }
    ...
    public static String m1509toStringimpl(long j) {
        if (!(j != INSTANCE.m1513getUnspecifiedNHjbRc())) {
            return "Size.Unspecified";
        }
        return "Size(" + GeometryUtilsKt.toStringAsFixed(m1505getWidthimpl(j), 1) + ", " + GeometryUtilsKt.toStringAsFixed(m1502getHeightimpl(j), 1) + ')';
    }

    public boolean equals(Object obj) {
        return m1500equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m1506hashCodeimpl(this.packedValue);
    }

    @NotNull
    public String toString() {
        return m1509toStringimpl(this.packedValue);
    }
