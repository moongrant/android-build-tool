...
public final class SizeKt {
    ...
    public static final long Size(float f, float f2) {
        return Size.m1496constructorimpl((((long) Float.floatToIntBits(f2)) & 4294967295L) | (Float.floatToIntBits(f) << 32));
    }

    /* JADX INFO: renamed from: getCenter-uvyYCjk, reason: not valid java name */
    public static final long m1515getCenteruvyYCjk(long j) {
        return OffsetKt.Offset(Size.m1505getWidthimpl(j) / 2.0f, Size.m1502getHeightimpl(j) / 2.0f);
    }

    @Stable
    /* JADX INFO: renamed from: getCenter-uvyYCjk$annotations, reason: not valid java name */
    public static /* synthetic */ void m1516getCenteruvyYCjk$annotations(long j) {
    }

    /* JADX INFO: renamed from: isSpecified-uvyYCjk, reason: not valid java name */
    public static final boolean m1517isSpecifieduvyYCjk(long j) {
        return j != Size.INSTANCE.m1513getUnspecifiedNHjbRc();
    }

    @Stable
    /* JADX INFO: renamed from: isSpecified-uvyYCjk$annotations, reason: not valid java name */
    public static /* synthetic */ void m1518isSpecifieduvyYCjk$annotations(long j) {
    }

    /* JADX INFO: renamed from: isUnspecified-uvyYCjk, reason: not valid java name */
    public static final boolean m1519isUnspecifieduvyYCjk(long j) {
        return j == Size.INSTANCE.m1513getUnspecifiedNHjbRc();
    }

    @Stable
    /* JADX INFO: renamed from: isUnspecified-uvyYCjk$annotations, reason: not valid java name */
    public static /* synthetic */ void m1520isUnspecifieduvyYCjk$annotations(long j) {
    }

    @Stable
    /* JADX INFO: renamed from: lerp-VgWVRYQ, reason: not valid java name */
    public static final long m1521lerpVgWVRYQ(long j, long j2, float f) {
        return Size(MathHelpersKt.lerp(Size.m1505getWidthimpl(j), Size.m1505getWidthimpl(j2), f), MathHelpersKt.lerp(Size.m1502getHeightimpl(j), Size.m1502getHeightimpl(j2), f));
    }

    /* JADX INFO: renamed from: takeOrElse-TmRCtEA, reason: not valid java name */
    public static final long m1522takeOrElseTmRCtEA(long j, @NotNull Function0<Size> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        return (j > Size.INSTANCE.m1513getUnspecifiedNHjbRc() ? 1 : (j == Size.INSTANCE.m1513getUnspecifiedNHjbRc() ? 0 : -1)) != 0 ? j : block.invoke().getPackedValue();
    }

    @Stable
    /* JADX INFO: renamed from: times-d16Qtg0, reason: not valid java name */
    public static final long m1525timesd16Qtg0(int i, long j) {
        return Size.m1508times7Ah8Wj8(j, i);
    }

    @Stable
    @NotNull
    /* JADX INFO: renamed from: toRect-uvyYCjk, reason: not valid java name */
    public static final Rect m1526toRectuvyYCjk(long j) {
        return RectKt.m1476Recttz77jQw(Offset.INSTANCE.m1452getZeroF1C5BW0(), j);
    }

    @Stable
    /* JADX INFO: renamed from: times-d16Qtg0, reason: not valid java name */
    public static final long m1523timesd16Qtg0(double d, long j) {
        return Size.m1508times7Ah8Wj8(j, (float) d);
    }

    @Stable
    /* JADX INFO: renamed from: times-d16Qtg0, reason: not valid java name */
    public static final long m1524timesd16Qtg0(float f, long j) {
        return Size.m1508times7Ah8Wj8(j, f);
    }
}
