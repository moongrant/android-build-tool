...
public final class AndroidCanvas implements Canvas {
    ...
    private final void drawLines(List<Offset> points, Paint paint, int stepBy) {
        if (points.size() >= 2) {
            ...
            while (i < points.size() - 1) {
                ...
                this.internalCanvas.drawLine(Offset.m1436getXimpl(packedValue), Offset.m1437getYimpl(packedValue), Offset.m1436getXimpl(packedValue2), Offset.m1437getYimpl(packedValue2), internalPaint);
                i += stepBy;
            }
        }
    }
    ...
    private final void drawPoints(List<Offset> points, Paint paint) {
        ...
        for (int i = 0; i < size; i++) {
            long packedValue = points.get(i).getPackedValue();
            this.internalCanvas.drawPoint(Offset.m1436getXimpl(packedValue), Offset.m1437getYimpl(packedValue), paint.getInternalPaint());
        }
    }
    ...
    public void mo1530clipPathmtrdDE(@NotNull Path path, int clipOp) {
        Intrinsics.checkNotNullParameter(path, "path");
        android.graphics.Canvas canvas = this.internalCanvas;
        if (!(path instanceof AndroidPath)) {
            throw new UnsupportedOperationException("Unable to obtain android.graphics.Path");
        }
        canvas.clipPath(((AndroidPath) path).getInternalPath(), m1541toRegionOp7u2Bmg(clipOp));
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* JADX INFO: renamed from: clipRect-N_I0leg, reason: not valid java name */
    public void mo1531clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp) {
        this.internalCanvas.clipRect(left, top, right, bottom, m1541toRegionOp7u2Bmg(clipOp));
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* JADX INFO: renamed from: clipRect-mtrdD-E, reason: not valid java name */
    public final /* synthetic */ void mo1532clipRectmtrdDE(androidx.compose.ui.geometry.Rect rect, int i) {
        o0000O00.OooO00o(this, rect, i);
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* JADX INFO: renamed from: concat-58bKbWc, reason: not valid java name */
    public void mo1533concat58bKbWc(@NotNull float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        if (MatrixKt.m1900isIdentity58bKbWc(matrix)) {
            return;
        }
        android.graphics.Matrix matrix2 = new android.graphics.Matrix();
        AndroidMatrixConversions_androidKt.m1548setFromEL8BTi8(matrix2, matrix);
    ...
    public final /* synthetic */ void drawArc(androidx.compose.ui.geometry.Rect rect, float f, float f2, boolean z, Paint paint) {
        o0000O00.OooO0O0(this, rect, f, f2, z, paint);
    }

    @Override // androidx.compose.ui.graphics.Canvas
    public final /* synthetic */ void drawArcRad(androidx.compose.ui.geometry.Rect rect, float f, float f2, boolean z, Paint paint) {
        o0000O00.OooO0OO(this, rect, f, f2, z, paint);
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* JADX INFO: renamed from: drawCircle-9KIMszo, reason: not valid java name */
    public void mo1534drawCircle9KIMszo(long center, float radius, @NotNull Paint paint) {
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawCircle(Offset.m1436getXimpl(center), Offset.m1437getYimpl(center), radius, paint.getInternalPaint());
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* JADX INFO: renamed from: drawImage-d-4ec7I, reason: not valid java name */
    public void mo1535drawImaged4ec7I(@NotNull ImageBitmap image, long topLeftOffset, @NotNull Paint paint) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawBitmap(AndroidImageBitmap_androidKt.asAndroidBitmap(image), Offset.m1436getXimpl(topLeftOffset), Offset.m1437getYimpl(topLeftOffset), paint.getInternalPaint());
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* JADX INFO: renamed from: drawImageRect-HPBpro0, reason: not valid java name */
    public void mo1536drawImageRectHPBpro0(@NotNull ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, @NotNull Paint paint) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(paint, "paint");
        android.graphics.Canvas canvas = this.internalCanvas;
        Bitmap bitmapAsAndroidBitmap = AndroidImageBitmap_androidKt.asAndroidBitmap(image);
        Rect rect = this.srcRect;
        rect.left = IntOffset.m3883getXimpl(srcOffset);
        rect.top = IntOffset.m3884getYimpl(srcOffset);
        rect.right = IntSize.m3925getWidthimpl(srcSize) + IntOffset.m3883getXimpl(srcOffset);
        rect.bottom = IntSize.m3924getHeightimpl(srcSize) + IntOffset.m3884getYimpl(srcOffset);
        Unit unit = Unit.INSTANCE;
        Rect rect2 = this.dstRect;
        rect2.left = IntOffset.m3883getXimpl(dstOffset);
        rect2.top = IntOffset.m3884getYimpl(dstOffset);
        rect2.right = IntSize.m3925getWidthimpl(dstSize) + IntOffset.m3883getXimpl(dstOffset);
        rect2.bottom = IntSize.m3924getHeightimpl(dstSize) + IntOffset.m3884getYimpl(dstOffset);
    ...
    public void mo1537drawLineWko1d7g(long p1, long p2, @NotNull Paint paint) {
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawLine(Offset.m1436getXimpl(p1), Offset.m1437getYimpl(p1), Offset.m1436getXimpl(p2), Offset.m1437getYimpl(p2), paint.getInternalPaint());
    }

    @Override // androidx.compose.ui.graphics.Canvas
    public final /* synthetic */ void drawOval(androidx.compose.ui.geometry.Rect rect, Paint paint) {
        o0000O00.OooO0Oo(this, rect, paint);
    }
    ...
    public void mo1538drawPointsO7TthRY(int pointMode, @NotNull List<Offset> points, @NotNull Paint paint) {
        Intrinsics.checkNotNullParameter(points, "points");
        Intrinsics.checkNotNullParameter(paint, "paint");
        PointMode.Companion companion = PointMode.INSTANCE;
        if (PointMode.m1943equalsimpl0(pointMode, companion.m1947getLinesr_lszbg())) {
            drawLines(points, paint, 2);
        } else if (PointMode.m1943equalsimpl0(pointMode, companion.m1949getPolygonr_lszbg())) {
            drawLines(points, paint, 1);
        } else if (PointMode.m1943equalsimpl0(pointMode, companion.m1948getPointsr_lszbg())) {
    ...
    public void mo1539drawRawPointsO7TthRY(int pointMode, @NotNull float[] points, @NotNull Paint paint) {
        Intrinsics.checkNotNullParameter(points, "points");
        Intrinsics.checkNotNullParameter(paint, "paint");
        if (points.length % 2 != 0) {
    ...
    public final /* synthetic */ void drawRect(androidx.compose.ui.geometry.Rect rect, Paint paint) {
        o0000O00.OooO0o0(this, rect, paint);
    }
    ...
    public void mo1540drawVerticesTPEHhCM(@NotNull Vertices vertices, int blendMode, @NotNull Paint paint) {
        Intrinsics.checkNotNullParameter(vertices, "vertices");
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawVertices(AndroidVertexMode_androidKt.m1584toAndroidVertexModeJOOmi9M(vertices.getVertexMode()), vertices.getPositions().length, vertices.getPositions(), 0, vertices.getTextureCoordinates(), 0, vertices.getColors(), 0, vertices.getIndices(), 0, vertices.getIndices().length, paint.getInternalPaint());
    }
    ...
    public final /* synthetic */ void skewRad(float f, float f2) {
        o0000O00.OooO0o(this, f, f2);
    }

    @NotNull
    /* JADX INFO: renamed from: toRegionOp--7u2Bmg, reason: not valid java name */
    public final Region.Op m1541toRegionOp7u2Bmg(int i) {
        return ClipOp.m1654equalsimpl0(i, ClipOp.INSTANCE.m1658getDifferencertfAjoo()) ? Region.Op.DIFFERENCE : Region.Op.INTERSECT;
    }
