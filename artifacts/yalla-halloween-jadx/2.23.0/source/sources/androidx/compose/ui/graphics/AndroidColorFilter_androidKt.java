...
public final class AndroidColorFilter_androidKt {
    ...
    public static final ColorFilter m1542actualColorMatrixColorFilterjHGOpc(@NotNull float[] colorMatrix) {
    ...
    public static final ColorFilter m1543actualLightingColorFilterOWjLjI(long j, long j2) {
        return new ColorFilter(new LightingColorFilter(ColorKt.m1724toArgb8_81llA(j), ColorKt.m1724toArgb8_81llA(j2)));
    }

    @NotNull
    /* JADX INFO: renamed from: actualTintColorFilter-xETnrds, reason: not valid java name */
    public static final ColorFilter m1544actualTintColorFilterxETnrds(long j, int i) {
        return new ColorFilter(Build.VERSION.SDK_INT >= 29 ? BlendModeColorFilterHelper.INSTANCE.m1622BlendModeColorFilterxETnrds(j, i) : new PorterDuffColorFilter(ColorKt.m1724toArgb8_81llA(j), AndroidBlendMode_androidKt.m1529toPorterDuffModes9anfk8(i)));
    }
