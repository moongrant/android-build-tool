...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(@NotNull android.graphics.Paint internalPaint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m1620getSrcOver0nO6VwU();
    }
    ...
    public long mo1551getColor0d7_KjU() {
    ...
    public int mo1552getFilterQualityfv9h1I() {
    ...
    public int mo1553getStrokeCapKaPHkGw() {
    ...
    public int mo1554getStrokeJoinLxFBmk8() {
    ...
    public int mo1555getStyleTiuSbCo() {
    ...
    public void mo1556setBlendModes9anfk8(int i) {
        if (BlendMode.m1589equalsimpl0(this._blendMode, i)) {
            return;
        }
        this._blendMode = i;
        AndroidPaint_androidKt.m1562setNativeBlendModeGB0RdKg(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* JADX INFO: renamed from: setColor-8_81llA, reason: not valid java name */
    public void mo1557setColor8_81llA(long j) {
        AndroidPaint_androidKt.m1563setNativeColor4WTKRHQ(this.internalPaint, j);
    }
    ...
    public void mo1558setFilterQualityvDHp3xo(int i) {
        AndroidPaint_androidKt.m1564setNativeFilterQuality50PEsBU(this.internalPaint, i);
    }
    ...
    public void mo1559setStrokeCapBeK7IIE(int i) {
        AndroidPaint_androidKt.m1565setNativeStrokeCapCSYIeUk(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* JADX INFO: renamed from: setStrokeJoin-Ww9F2mQ, reason: not valid java name */
    public void mo1560setStrokeJoinWw9F2mQ(int i) {
        AndroidPaint_androidKt.m1566setNativeStrokeJoinkLtJ_vA(this.internalPaint, i);
    }
    ...
    public void mo1561setStylek9PVt8s(int i) {
        AndroidPaint_androidKt.m1567setNativeStyle5YerkU(this.internalPaint, i);
    }
