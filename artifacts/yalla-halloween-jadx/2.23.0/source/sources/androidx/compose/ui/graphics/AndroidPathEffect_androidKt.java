...
public final class AndroidPathEffect_androidKt {
    ...
    public static final PathEffect m1574actualStampedPathEffect7aD1DOk(@NotNull Path shape, float f, float f2, int i) {
        Intrinsics.checkNotNullParameter(shape, "shape");
        if (shape instanceof AndroidPath) {
            return new AndroidPathEffect(new PathDashPathEffect(((AndroidPath) shape).getInternalPath(), f, f2, m1575toAndroidPathDashPathEffectStyleoQv6xUo(i)));
        }
    ...
    public static final PathDashPathEffect.Style m1575toAndroidPathDashPathEffectStyleoQv6xUo(int i) {
        StampedPathEffectStyle.Companion companion = StampedPathEffectStyle.INSTANCE;
        if (StampedPathEffectStyle.m1981equalsimpl0(i, companion.m1985getMorphYpspkwk())) {
            return PathDashPathEffect.Style.MORPH;
        }
        if (StampedPathEffectStyle.m1981equalsimpl0(i, companion.m1986getRotateYpspkwk())) {
            return PathDashPathEffect.Style.ROTATE;
        }
        return StampedPathEffectStyle.m1981equalsimpl0(i, companion.m1987getTranslateYpspkwk()) ? PathDashPathEffect.Style.TRANSLATE : PathDashPathEffect.Style.TRANSLATE;
    }
