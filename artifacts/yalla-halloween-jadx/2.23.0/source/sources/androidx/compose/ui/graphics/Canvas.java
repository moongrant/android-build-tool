...
public interface Canvas {
    ...
    public static final class DefaultImpls {
        ...
        public static void m1648clipRectmtrdDE(@NotNull Canvas canvas, @NotNull Rect rect, int i) {
            Intrinsics.checkNotNullParameter(rect, "rect");
            o0000O00.OooO00o(canvas, rect, i);
        }
        ...
        public static void drawArc(@NotNull Canvas canvas, @NotNull Rect rect, float f, float f2, boolean z, @NotNull Paint paint) {
            ...
            o0000O00.OooO0O0(canvas, rect, f, f2, z, paint);
        }
        ...
        public static void drawArcRad(@NotNull Canvas canvas, @NotNull Rect rect, float f, float f2, boolean z, @NotNull Paint paint) {
            Intrinsics.checkNotNullParameter(rect, "rect");
            Intrinsics.checkNotNullParameter(paint, "paint");
            o0000O00.OooO0OO(canvas, rect, f, f2, z, paint);
        }
        ...
        public static void drawOval(@NotNull Canvas canvas, @NotNull Rect rect, @NotNull Paint paint) {
            Intrinsics.checkNotNullParameter(rect, "rect");
            Intrinsics.checkNotNullParameter(paint, "paint");
            o0000O00.OooO0Oo(canvas, rect, paint);
        }
        ...
        public static void drawRect(@NotNull Canvas canvas, @NotNull Rect rect, @NotNull Paint paint) {
            Intrinsics.checkNotNullParameter(rect, "rect");
            Intrinsics.checkNotNullParameter(paint, "paint");
            o0000O00.OooO0o0(canvas, rect, paint);
        }

        @Deprecated
        public static void skewRad(@NotNull Canvas canvas, float f, float f2) {
            o0000O00.OooO0o(canvas, f, f2);
        }
    }

    /* JADX INFO: renamed from: clipPath-mtrdD-E */
    void mo1530clipPathmtrdDE(@NotNull Path path, int clipOp);

    /* JADX INFO: renamed from: clipRect-N_I0leg */
    void mo1531clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp);

    /* JADX INFO: renamed from: clipRect-mtrdD-E */
    void mo1532clipRectmtrdDE(@NotNull Rect rect, int clipOp);

    /* JADX INFO: renamed from: concat-58bKbWc */
    void mo1533concat58bKbWc(@NotNull float[] matrix);
    ...
    void mo1534drawCircle9KIMszo(long center, float radius, @NotNull Paint paint);

    /* JADX INFO: renamed from: drawImage-d-4ec7I */
    void mo1535drawImaged4ec7I(@NotNull ImageBitmap image, long topLeftOffset, @NotNull Paint paint);

    /* JADX INFO: renamed from: drawImageRect-HPBpro0 */
    void mo1536drawImageRectHPBpro0(@NotNull ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, @NotNull Paint paint);

    /* JADX INFO: renamed from: drawLine-Wko1d7g */
    void mo1537drawLineWko1d7g(long p1, long p2, @NotNull Paint paint);
    ...
    void mo1538drawPointsO7TthRY(int pointMode, @NotNull List<Offset> points, @NotNull Paint paint);

    /* JADX INFO: renamed from: drawRawPoints-O7TthRY */
    void mo1539drawRawPointsO7TthRY(int pointMode, @NotNull float[] points, @NotNull Paint paint);
    ...
    void mo1540drawVerticesTPEHhCM(@NotNull Vertices vertices, int blendMode, @NotNull Paint paint);
