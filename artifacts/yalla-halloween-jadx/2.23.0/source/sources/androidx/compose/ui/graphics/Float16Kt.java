...
public final class Float16Kt {
    ...
    public static final short m1812maxAoSsdG0(short s, short s2) {
        if (Float16.m1785isNaNimpl(s) || Float16.m1785isNaNimpl(s2)) {
            return Float16.INSTANCE.m1807getNaNslo4al4();
        }
        return Float16.m1772compareTo41bOqos(s, s2) >= 0 ? s : s2;
    }

    /* JADX INFO: renamed from: min-AoSsdG0, reason: not valid java name */
    public static final short m1813minAoSsdG0(short s, short s2) {
        if (Float16.m1785isNaNimpl(s) || Float16.m1785isNaNimpl(s2)) {
            return Float16.INSTANCE.m1807getNaNslo4al4();
        }
        return Float16.m1772compareTo41bOqos(s, s2) <= 0 ? s : s2;
