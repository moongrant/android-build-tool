...
public final class MatrixKt {
    ...
    public static final float m1899dotp89u6pk(float[] fArr, int i, float[] fArr2, int i2) {
        int i3 = i * 4;
    ...
    public static final boolean m1900isIdentity58bKbWc(@NotNull float[] isIdentity) {
