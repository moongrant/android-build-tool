...
public final class PointMode {
    ...
    private static final int Points = m1941constructorimpl(0);
    private static final int Lines = m1941constructorimpl(1);
    private static final int Polygon = m1941constructorimpl(2);
    ...
    public static final /* synthetic */ PointMode m1940boximpl(int i) {
        return new PointMode(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m1941constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m1942equalsimpl(int i, Object obj) {
        return (obj instanceof PointMode) && i == ((PointMode) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1943equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m1944hashCodeimpl(int i) {
        return i;
    }

    @NotNull
    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m1945toStringimpl(int i) {
        if (m1943equalsimpl0(i, Points)) {
            return "Points";
        }
        if (m1943equalsimpl0(i, Lines)) {
            return "Lines";
        }
        return m1943equalsimpl0(i, Polygon) ? "Polygon" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
