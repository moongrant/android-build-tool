...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private long transformOrigin = TransformOrigin.INSTANCE.m2033getCenterSzJe1aQ();

    @NotNull
    private Shape shape = RectangleShapeKt.getRectangleShape();
    private int compositingStrategy = CompositingStrategy.INSTANCE.m1755getAutoNrFUSI();
    private long size = Size.INSTANCE.m1513getUnspecifiedNHjbRc();
    ...
    public final void reset() {
        ...
        mo1837setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo1839setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo1840setTransformOrigin__ExYCQ(TransformOrigin.INSTANCE.m2033getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        mo1838setCompositingStrategyaDBOjCE(CompositingStrategy.INSTANCE.m1755getAutoNrFUSI());
        m1954setSizeuvyYCjk(Size.INSTANCE.m1513getUnspecifiedNHjbRc());
    }
    ...
    public void mo1837setAmbientShadowColor8_81llA(long j) {
    ...
    public void mo1838setCompositingStrategyaDBOjCE(int i) {
    ...
    public void m1954setSizeuvyYCjk(long j) {
        this.size = j;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* JADX INFO: renamed from: setSpotShadowColor-8_81llA */
    public void mo1839setSpotShadowColor8_81llA(long j) {
        this.spotShadowColor = j;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* JADX INFO: renamed from: setTransformOrigin-__ExYCQ */
    public void mo1840setTransformOrigin__ExYCQ(long j) {
