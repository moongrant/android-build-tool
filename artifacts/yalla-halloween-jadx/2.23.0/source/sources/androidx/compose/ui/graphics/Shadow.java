...
public final class Shadow {
    ...
    public static /* synthetic */ Shadow m1963copyqcb84PM$default(Shadow shadow, long j, long j2, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            j = shadow.color;
        }
        long j3 = j;
        ...
        return shadow.m1966copyqcb84PM(j3, j4, f);
    }
    ...
    public static /* synthetic */ void m1964getColor0d7_KjU$annotations() {
    }

    @Stable
    /* JADX INFO: renamed from: getOffset-F1C5BW0$annotations, reason: not valid java name */
    public static /* synthetic */ void m1965getOffsetF1C5BW0$annotations() {
    }

    @NotNull
    /* JADX INFO: renamed from: copy-qcb84PM, reason: not valid java name */
    public final Shadow m1966copyqcb84PM(long color, long offset, float blurRadius) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (Color.m1671equalsimpl0(this.color, shadow.color) && Offset.m1433equalsimpl0(this.offset, shadow.offset)) {
    ...
    public int hashCode() {
        return Float.floatToIntBits(this.blurRadius) + ((Offset.m1438hashCodeimpl(this.offset) + (Color.m1677hashCodeimpl(this.color) * 31)) * 31);
    }

    @NotNull
    public String toString() {
        StringBuilder sb = new StringBuilder("Shadow(color=");
        sb.append((Object) Color.m1678toStringimpl(this.color));
        sb.append(", offset=");
        sb.append((Object) Offset.m1444toStringimpl(this.offset));
    ...
    public /* synthetic */ Shadow(long j, long j2, float f, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? ColorKt.Color(4278190080L) : j, (i & 2) != 0 ? Offset.INSTANCE.m1452getZeroF1C5BW0() : j2, (i & 4) != 0 ? 0.0f : f, null);
    }
}
