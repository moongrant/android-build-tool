...
public final class ShadowKt {
    ...
    public static final Shadow lerp(@NotNull Shadow start, @NotNull Shadow stop, float f) {
        ...
        return new Shadow(ColorKt.m1721lerpjxsXWHM(start.getColor(), stop.getColor(), f), OffsetKt.m1459lerpWko1d7g(start.getOffset(), stop.getOffset(), f), MathHelpersKt.lerp(start.getBlurRadius(), stop.getBlurRadius(), f), null);
    }
}
