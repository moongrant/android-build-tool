...
final class SimpleGraphicsLayerModifier extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void invalidateLayerBlock() {
        NodeCoordinator wrapped = DelegatableNodeKt.m2893requireCoordinator64DMado(this, NodeKind.m2994constructorimpl(2)).getWrapped();
        if (wrapped != null) {
    ...
    public MeasureResult mo248measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j) {
        ...
        return MeasureScope.CC.OooOOo0(measure, placeableMo2794measureBRTryo0.getWidth(), placeableMo2794measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.graphics.SimpleGraphicsLayerModifier$measure$1
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.placeWithLayer$default(layout, placeableMo2794measureBRTryo0, 0, 0, 0.0f, this.layerBlock, 4, null);
            }
        }, 4, null);
    }
    ...
    public final void m1973setAmbientShadowColor8_81llA(long j) {
    ...
    public final void m1974setCompositingStrategyaDBOjCE(int i) {
    ...
    public final void m1975setSpotShadowColor8_81llA(long j) {
        this.spotShadowColor = j;
    }

    /* JADX INFO: renamed from: setTransformOrigin-__ExYCQ, reason: not valid java name */
    public final void m1976setTransformOrigin__ExYCQ(long j) {
    ...
    public /* synthetic */ SimpleGraphicsLayerModifier(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, long j2, long j3, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(f, f2, f3, f4, f5, f6, f7, f8, f9, f10, j, shape, z, renderEffect, j2, j3, (i2 & 65536) != 0 ? CompositingStrategy.INSTANCE.m1755getAutoNrFUSI() : i, null);
    }
    ...
    private SimpleGraphicsLayerModifier(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, long j2, long j3, int i) {
        ...
        this.layerBlock = new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.ui.graphics.SimpleGraphicsLayerModifier$layerBlock$1
            ...
            public final void invoke2(@NotNull GraphicsLayerScope graphicsLayerScope) {
                ...
                graphicsLayerScope.mo1840setTransformOrigin__ExYCQ(this.this$0.getTransformOrigin());
                ...
                graphicsLayerScope.mo1837setAmbientShadowColor8_81llA(this.this$0.getAmbientShadowColor());
                graphicsLayerScope.mo1839setSpotShadowColor8_81llA(this.this$0.getSpotShadowColor());
                graphicsLayerScope.mo1838setCompositingStrategyaDBOjCE(this.this$0.getCompositingStrategy());
            }
        };
    }
}
