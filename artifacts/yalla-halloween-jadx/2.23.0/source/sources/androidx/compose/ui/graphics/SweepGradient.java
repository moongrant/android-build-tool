...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader mo1645createShaderuvyYCjk(long size) {
        ...
        if (OffsetKt.m1457isUnspecifiedk4lQ0M(this.center)) {
            jOffset = SizeKt.m1515getCenteruvyYCjk(size);
        } else {
            jOffset = OffsetKt.Offset((Offset.m1436getXimpl(this.center) > Float.POSITIVE_INFINITY ? 1 : (Offset.m1436getXimpl(this.center) == Float.POSITIVE_INFINITY ? 0 : -1)) == 0 ? Size.m1505getWidthimpl(size) : Offset.m1436getXimpl(this.center), Offset.m1437getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m1502getHeightimpl(size) : Offset.m1437getYimpl(this.center));
        }
        return ShaderKt.m1961SweepGradientShader9KIMszo(jOffset, this.colors, this.stops);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Offset.m1433equalsimpl0(this.center, sweepGradient.center) && Intrinsics.areEqual(this.colors, sweepGradient.colors) && Intrinsics.areEqual(this.stops, sweepGradient.stops);
    }

    public int hashCode() {
        int iHashCode = (this.colors.hashCode() + (Offset.m1438hashCodeimpl(this.center) * 31)) * 31;
    ...
    public String toString() {
        ...
        StringBuilder sbOooO00o = p004OooO0oO.o0OoOo0.OooO00o("SweepGradient(", str, "colors=");
        sbOooO00o.append(this.colors);
        sbOooO00o.append(", stops=");
        sbOooO00o.append(this.stops);
        sbOooO00o.append(')');
