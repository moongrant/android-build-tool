...
public final class TileMode {
    ...
    private static final int Clamp = m2009constructorimpl(0);
    private static final int Repeated = m2009constructorimpl(1);
    private static final int Mirror = m2009constructorimpl(2);
    private static final int Decal = m2009constructorimpl(3);
    ...
    public static final /* synthetic */ TileMode m2008boximpl(int i) {
        return new TileMode(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m2009constructorimpl(int i) {
        return i;
    }
    ...
    public static String m2013toStringimpl(int i) {
        if (m2011equalsimpl0(i, Clamp)) {
            return "Clamp";
        }
        if (m2011equalsimpl0(i, Repeated)) {
            return "Repeated";
        }
        if (m2011equalsimpl0(i, Mirror)) {
            return "Mirror";
        }
        return m2011equalsimpl0(i, Decal) ? "Decal" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
