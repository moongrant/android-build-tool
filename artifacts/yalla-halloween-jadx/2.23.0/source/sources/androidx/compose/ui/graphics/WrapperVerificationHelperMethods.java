...
public final class WrapperVerificationHelperMethods {
    ...
    public final void m2045setBlendModeGB0RdKg(@NotNull android.graphics.Paint paint, int mode) {
        Intrinsics.checkNotNullParameter(paint, "paint");
        paint.setBlendMode(AndroidBlendMode_androidKt.m1528toAndroidBlendModes9anfk8(mode));
    }
}
