...
public final class ColorModel {
    ...
    static {
        long j = 3;
        long j2 = j << 32;
        Rgb = m2047constructorimpl((((long) 0) & 4294967295L) | j2);
        Xyz = m2047constructorimpl((((long) 1) & 4294967295L) | j2);
        Lab = m2047constructorimpl(j2 | (((long) 2) & 4294967295L));
        Cmyk = m2047constructorimpl((j & 4294967295L) | (((long) 4) << 32));
    }
    ...
    public static final /* synthetic */ ColorModel m2046boximpl(long j) {
        return new ColorModel(j);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m2047constructorimpl(long j) {
        return j;
    }
    ...
    public static final int m2050getComponentCountimpl(long j) {
        return (int) (j >> 32);
    }
    ...
    public static String m2052toStringimpl(long j) {
        if (m2049equalsimpl0(j, Rgb)) {
            return "Rgb";
        }
        if (m2049equalsimpl0(j, Xyz)) {
            return "Xyz";
        }
        if (m2049equalsimpl0(j, Lab)) {
            return "Lab";
        }
        return m2049equalsimpl0(j, Cmyk) ? "Cmyk" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }

    public boolean equals(Object obj) {
        return m2048equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m2051hashCodeimpl(this.packedValue);
    }

    @NotNull
    public String toString() {
        return m2052toStringimpl(this.packedValue);
    }
