...
public abstract class ColorSpace {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (this.id == colorSpace.id && Intrinsics.areEqual(this.name, colorSpace.name)) {
            return ColorModel.m2049equalsimpl0(this.model, colorSpace.model);
        }
        return false;
    }
    ...
    public final float[] fromXyz(float x, float y, float z) {
        float[] fArr = new float[ColorModel.m2050getComponentCountimpl(this.model)];
        fArr[0] = x;
        fArr[1] = y;
        fArr[2] = z;
        return fromXyz(fArr);
    ...
    public final int getComponentCount() {
        return ColorModel.m2050getComponentCountimpl(this.model);
    }
    ...
    public int hashCode() {
        return ((ColorModel.m2051hashCodeimpl(this.model) + (this.name.hashCode() * 31)) * 31) + this.id;
    }
    ...
    public String toString() {
        return this.name + " (id=" + this.id + ", model=" + ((Object) ColorModel.m2052toStringimpl(this.model)) + ')';
    }
