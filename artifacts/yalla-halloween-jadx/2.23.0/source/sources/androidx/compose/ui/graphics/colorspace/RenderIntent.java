...
public final class RenderIntent {
    ...
    private static final int Perceptual = m2068constructorimpl(0);
    private static final int Relative = m2068constructorimpl(1);
    private static final int Saturation = m2068constructorimpl(2);
    private static final int Absolute = m2068constructorimpl(3);
    ...
    public static final /* synthetic */ RenderIntent m2067boximpl(int i) {
    ...
    public static String m2072toStringimpl(int i) {
        if (m2070equalsimpl0(i, Perceptual)) {
            return "Perceptual";
        }
        if (m2070equalsimpl0(i, Relative)) {
            return "Relative";
        }
        if (m2070equalsimpl0(i, Saturation)) {
            return "Saturation";
        }
        return m2070equalsimpl0(i, Absolute) ? "Absolute" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
