...
public final class DrawTransformKt {
    ...
    public static final void m2191rotateRad0AR0LA0(@NotNull DrawTransform rotateRad, float f, long j) {
        Intrinsics.checkNotNullParameter(rotateRad, "$this$rotateRad");
        rotateRad.mo2120rotateUv8p0NA(DegreesKt.degrees(f), j);
    }

    /* JADX INFO: renamed from: rotateRad-0AR0LA0$default, reason: not valid java name */
    public static /* synthetic */ void m2192rotateRad0AR0LA0$default(DrawTransform rotateRad, float f, long j, int i, Object obj) {
        if ((i & 2) != 0) {
            j = rotateRad.mo2118getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(rotateRad, "$this$rotateRad");
        rotateRad.mo2120rotateUv8p0NA(DegreesKt.degrees(f), j);
    }
    ...
    public static final void m2193scale0AR0LA0(@NotNull DrawTransform scale, float f, long j) {
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        scale.mo2121scale0AR0LA0(f, f, j);
    }

    /* JADX INFO: renamed from: scale-0AR0LA0$default, reason: not valid java name */
    public static /* synthetic */ void m2194scale0AR0LA0$default(DrawTransform scale, float f, long j, int i, Object obj) {
        if ((i & 2) != 0) {
            j = scale.mo2118getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        scale.mo2121scale0AR0LA0(f, f, j);
    }
