...
public final /* synthetic */ class OooO0OO {
    public static long OooO00o(DrawTransform drawTransform) {
        float f = 2;
        return OffsetKt.Offset(Size.m1505getWidthimpl(drawTransform.mo2119getSizeNHjbRc()) / f, Size.m1502getHeightimpl(drawTransform.mo2119getSizeNHjbRc()) / f);
    }
    ...
    public static /* synthetic */ void OooO0OO(DrawTransform drawTransform, Path path, int i, int i2, Object obj) {
        ...
        drawTransform.mo2116clipPathmtrdDE(path, i);
    }
    ...
    public static /* synthetic */ void OooO0Oo(DrawTransform drawTransform, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
        ...
        if ((i2 & 4) != 0) {
            f3 = Size.m1505getWidthimpl(drawTransform.mo2119getSizeNHjbRc());
        }
        if ((i2 & 8) != 0) {
            f4 = Size.m1502getHeightimpl(drawTransform.mo2119getSizeNHjbRc());
        }
        if ((i2 & 16) != 0) {
            i = ClipOp.INSTANCE.m1659getIntersectrtfAjoo();
        }
        drawTransform.mo2117clipRectN_I0leg(f, f2, f3, f4, i);
    }
    ...
    public static /* synthetic */ void OooO0o(DrawTransform drawTransform, float f, float f2, long j, int i, Object obj) {
        ...
        if ((i & 4) != 0) {
            j = drawTransform.mo2118getCenterF1C5BW0();
        }
        drawTransform.mo2121scale0AR0LA0(f, f2, j);
    }
    ...
    public static /* synthetic */ void OooO0o0(DrawTransform drawTransform, float f, long j, int i, Object obj) {
        ...
        drawTransform.mo2120rotateUv8p0NA(f, j);
    }
