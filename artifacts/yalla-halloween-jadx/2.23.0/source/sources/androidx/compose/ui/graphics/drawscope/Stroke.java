...
public final class Stroke extends DrawStyle {
    ...
    private static final int DefaultCap = StrokeCap.INSTANCE.m1995getButtKaPHkGw();
    private static final int DefaultJoin = StrokeJoin.INSTANCE.m2006getMiterLxFBmk8();
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (this.width == stroke.width) {
            return ((this.miter > stroke.miter ? 1 : (this.miter == stroke.miter ? 0 : -1)) == 0) && StrokeCap.m1991equalsimpl0(this.cap, stroke.cap) && StrokeJoin.m2001equalsimpl0(this.join, stroke.join) && Intrinsics.areEqual(this.pathEffect, stroke.pathEffect);
        }
        return false;
    }
    ...
    public int hashCode() {
        int iM2002hashCodeimpl = (StrokeJoin.m2002hashCodeimpl(this.join) + ((StrokeCap.m1992hashCodeimpl(this.cap) + Oooo0.OooO00o(this.miter, Float.floatToIntBits(this.width) * 31, 31)) * 31)) * 31;
        PathEffect pathEffect = this.pathEffect;
        return iM2002hashCodeimpl + (pathEffect != null ? pathEffect.hashCode() : 0);
    }

    @NotNull
    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + ((Object) StrokeCap.m1993toStringimpl(this.cap)) + ", join=" + ((Object) StrokeJoin.m2003toStringimpl(this.join)) + ", pathEffect=" + this.pathEffect + ')';
    }
