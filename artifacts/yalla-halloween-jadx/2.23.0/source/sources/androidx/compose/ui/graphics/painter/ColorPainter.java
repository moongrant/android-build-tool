...
public final class ColorPainter extends Painter {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return (other instanceof ColorPainter) && Color.m1671equalsimpl0(this.color, ((ColorPainter) other).color);
    }
    ...
    public int hashCode() {
        return Color.m1677hashCodeimpl(this.color);
    }

    @Override // androidx.compose.ui.graphics.painter.Painter
    public void onDraw(@NotNull DrawScope drawScope) {
        Intrinsics.checkNotNullParameter(drawScope, "<this>");
        OooO0O0.Oooo0OO(drawScope, this.color, 0L, 0L, this.alpha, null, this.colorFilter, 0, 86, null);
    }

    @NotNull
    public String toString() {
        return "ColorPainter(color=" + ((Object) Color.m1678toStringimpl(this.color)) + ')';
    }
