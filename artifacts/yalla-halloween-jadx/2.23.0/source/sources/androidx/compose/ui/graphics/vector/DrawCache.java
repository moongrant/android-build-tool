...
public final class DrawCache {
    ...
    private long size = IntSize.INSTANCE.m3930getZeroYbymL2g();

    @NotNull
    private final CanvasDrawScope cacheScope = new CanvasDrawScope();

    private final void clear(DrawScope drawScope) {
        OooO0O0.Oooo0OO(drawScope, Color.INSTANCE.m1696getBlack0d7_KjU(), 0L, 0L, 0.0f, null, null, BlendMode.INSTANCE.m1593getClear0nO6VwU(), 62, null);
    }
    ...
    public final void m2208drawCachedImageCJJARo(long size, @NotNull Density density, @NotNull LayoutDirection layoutDirection, @NotNull Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Intrinsics.checkNotNullParameter(block, "block");
        this.scopeDensity = density;
        this.layoutDirection = layoutDirection;
        ImageBitmap imageBitmapM1873ImageBitmapx__hDU$default = this.mCachedImage;
        Canvas Canvas = this.cachedCanvas;
        if (imageBitmapM1873ImageBitmapx__hDU$default == null || Canvas == null || IntSize.m3925getWidthimpl(size) > imageBitmapM1873ImageBitmapx__hDU$default.getWidth() || IntSize.m3924getHeightimpl(size) > imageBitmapM1873ImageBitmapx__hDU$default.getHeight()) {
            imageBitmapM1873ImageBitmapx__hDU$default = ImageBitmapKt.m1873ImageBitmapx__hDU$default(IntSize.m3925getWidthimpl(size), IntSize.m3924getHeightimpl(size), 0, false, null, 28, null);
            Canvas = CanvasKt.Canvas(imageBitmapM1873ImageBitmapx__hDU$default);
            this.mCachedImage = imageBitmapM1873ImageBitmapx__hDU$default;
            this.cachedCanvas = Canvas;
        }
        this.size = size;
        CanvasDrawScope canvasDrawScope = this.cacheScope;
        long jM3935toSizeozmzZPI = IntSizeKt.m3935toSizeozmzZPI(size);
    ...
    public final void drawInto(@NotNull DrawScope target, float alpha, @Nullable ColorFilter colorFilter) {
        ...
        OooO0O0.OooOoO(target, imageBitmap, 0L, this.size, 0L, 0L, alpha, null, colorFilter, 0, 0, 858, null);
    }
