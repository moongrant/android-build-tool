...
public final class ImageVector {
    ...
    public static final class Builder {
        ...
        public static final class GroupParams {
            ...
            public /* synthetic */ GroupParams(String str, float f, float f2, float f3, float f4, float f5, float f6, float f7, List list, List list2, int i, DefaultConstructorMarker defaultConstructorMarker) {
                this((i & 1) != 0 ? "" : str, (i & 2) != 0 ? 0.0f : f, (i & 4) != 0 ? 0.0f : f2, (i & 8) != 0 ? 0.0f : f3, (i & 16) != 0 ? 1.0f : f4, (i & 32) == 0 ? f5 : 1.0f, (i & 64) != 0 ? 0.0f : f6, (i & 128) == 0 ? f7 : 0.0f, (i & PSKKeyManager.MAX_KEY_LENGTH_BYTES) != 0 ? VectorKt.getEmptyPath() : list, (i & ConstantsKt.MINIMUM_BLOCK_SIZE) != 0 ? new ArrayList() : list2);
            }
        }
        ...
        public static /* synthetic */ Builder m2213addPathoIyEayM$default(Builder builder, List list, int i, String str, Brush brush, float f, Brush brush2, float f2, float f3, int i2, int i3, float f4, float f5, float f6, float f7, int i4, Object obj) {
            return builder.m2214addPathoIyEayM(list, (i4 & 2) != 0 ? VectorKt.getDefaultFillType() : i, (i4 & 4) != 0 ? "" : str, (i4 & 8) != 0 ? null : brush, (i4 & 16) != 0 ? 1.0f : f, (i4 & 32) == 0 ? brush2 : null, (i4 & 64) != 0 ? 1.0f : f2, (i4 & 128) != 0 ? 0.0f : f3, (i4 & PSKKeyManager.MAX_KEY_LENGTH_BYTES) != 0 ? VectorKt.getDefaultStrokeLineCap() : i2, (i4 & ConstantsKt.MINIMUM_BLOCK_SIZE) != 0 ? VectorKt.getDefaultStrokeLineJoin() : i3, (i4 & LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) != 0 ? 4.0f : f4, (i4 & 2048) != 0 ? 0.0f : f5, (i4 & 4096) == 0 ? f6 : 1.0f, (i4 & 8192) == 0 ? f7 : 0.0f);
        }
        ...
        public /* synthetic */ Builder(String str, float f, float f2, float f3, float f4, long j, int i, boolean z, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this((i2 & 1) != 0 ? "" : str, f, f2, f3, f4, (i2 & 32) != 0 ? Color.INSTANCE.m1706getUnspecified0d7_KjU() : j, (i2 & 64) != 0 ? BlendMode.INSTANCE.m1618getSrcIn0nO6VwU() : i, (i2 & 128) != 0 ? false : z, (DefaultConstructorMarker) null);
        }
        ...
        public /* synthetic */ Builder(String str, float f, float f2, float f3, float f4, long j, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this((i2 & 1) != 0 ? "" : str, f, f2, f3, f4, (i2 & 32) != 0 ? Color.INSTANCE.m1706getUnspecified0d7_KjU() : j, (i2 & 64) != 0 ? BlendMode.INSTANCE.m1618getSrcIn0nO6VwU() : i, (DefaultConstructorMarker) null);
        }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!Intrinsics.areEqual(this.name, imageVector.name) || !Dp.m3770equalsimpl0(this.defaultWidth, imageVector.defaultWidth) || !Dp.m3770equalsimpl0(this.defaultHeight, imageVector.defaultHeight)) {
            return false;
        }
        if (this.viewportWidth == imageVector.viewportWidth) {
            return ((this.viewportHeight > imageVector.viewportHeight ? 1 : (this.viewportHeight == imageVector.viewportHeight ? 0 : -1)) == 0) && Intrinsics.areEqual(this.root, imageVector.root) && Color.m1671equalsimpl0(this.tintColor, imageVector.tintColor) && BlendMode.m1589equalsimpl0(this.tintBlendMode, imageVector.tintBlendMode) && this.autoMirror == imageVector.autoMirror;
        }
        return false;
    }
    ...
    public int hashCode() {
        return ((BlendMode.m1590hashCodeimpl(this.tintBlendMode) + OooOO0O.OooO0O0(this.tintColor, (this.root.hashCode() + Oooo0.OooO00o(this.viewportHeight, Oooo0.OooO00o(this.viewportWidth, OooO0o.OooO00o(this.defaultHeight, OooO0o.OooO00o(this.defaultWidth, this.name.hashCode() * 31, 31), 31), 31), 31)) * 31, 31)) * 31) + (this.autoMirror ? 1231 : 1237);
    }
