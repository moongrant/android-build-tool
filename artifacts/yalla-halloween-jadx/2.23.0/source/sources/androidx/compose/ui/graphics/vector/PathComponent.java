...
public final class PathComponent extends VNode {
    ...
    private final void updateRenderPath() {
        ...
        if (Intrinsics.areEqual(this.renderPath, this.path)) {
            ...
            int iMo1569getFillTypeRgk1Os = this.renderPath.mo1569getFillTypeRgk1Os();
            this.renderPath.rewind();
            this.renderPath.mo1571setFillTypeoQ8Xj4U(iMo1569getFillTypeRgk1Os);
        }
    ...
    public void draw(@NotNull DrawScope drawScope) {
        ...
        if (brush != null) {
            OooO0O0.Oooo000(drawScope, this.renderPath, brush, this.fillAlpha, null, null, 0, 56, null);
        }
        ...
        if (brush2 != null) {
            ...
            OooO0O0.Oooo000(drawScope, this.renderPath, brush2, this.strokeAlpha, stroke, null, 0, 48, null);
        }
    }
    ...
    public final void m2220setPathFillTypeoQ8Xj4U(int i) {
        this.pathFillType = i;
        this.renderPath.mo1571setFillTypeoQ8Xj4U(i);
        invalidate();
    }
    ...
    public final void m2221setStrokeLineCapBeK7IIE(int i) {
    ...
    public final void m2222setStrokeLineJoinWw9F2mQ(int i) {
