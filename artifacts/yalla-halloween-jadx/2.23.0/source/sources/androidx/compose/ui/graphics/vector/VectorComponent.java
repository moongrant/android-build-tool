...
public final class VectorComponent extends VNode {
    ...
    public VectorComponent() {
        ...
        this.previousDrawSize = Size.INSTANCE.m1513getUnspecifiedNHjbRc();
    ...
    public final void draw(@NotNull DrawScope drawScope, float f, @Nullable ColorFilter colorFilter) {
        ...
        if (this.isDirty || !Size.m1501equalsimpl0(this.previousDrawSize, drawScope.mo2108getSizeNHjbRc())) {
            this.root.setScaleX(Size.m1505getWidthimpl(drawScope.mo2108getSizeNHjbRc()) / this.viewportWidth);
            this.root.setScaleY(Size.m1502getHeightimpl(drawScope.mo2108getSizeNHjbRc()) / this.viewportHeight);
            this.cacheDrawScope.m2208drawCachedImageCJJARo(IntSizeKt.IntSize((int) Math.ceil(Size.m1505getWidthimpl(drawScope.mo2108getSizeNHjbRc())), (int) Math.ceil(Size.m1502getHeightimpl(drawScope.mo2108getSizeNHjbRc()))), drawScope, drawScope.getLayoutDirection(), this.drawVectorBlock);
            this.isDirty = false;
            this.previousDrawSize = drawScope.mo2108getSizeNHjbRc();
        }
