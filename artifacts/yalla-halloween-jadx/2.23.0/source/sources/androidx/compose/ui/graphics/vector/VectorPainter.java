...
public final class VectorPainter extends Painter {
    ...
    @NotNull
    private final MutableState size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m1493boximpl(Size.INSTANCE.m1514getZeroNHjbRc()), null, 2, null);
    ...
    public long getIntrinsicSize() {
        return m2227getSizeNHjbRc$ui_release();
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getSize-NH-jbRc$ui_release, reason: not valid java name */
    public final long m2227getSizeNHjbRc$ui_release() {
    ...
    public final void m2228setSizeuvyYCjk$ui_release(long j) {
        this.size.setValue(Size.m1493boximpl(j));
    }
}
