...
public final class VectorPath extends VectorNode {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!(this.strokeLineWidth == vectorPath.strokeLineWidth) || !StrokeCap.m1991equalsimpl0(this.strokeLineCap, vectorPath.strokeLineCap) || !StrokeJoin.m2001equalsimpl0(this.strokeLineJoin, vectorPath.strokeLineJoin)) {
            return false;
        }
        ...
        if (this.trimPathEnd == vectorPath.trimPathEnd) {
            return ((this.trimPathOffset > vectorPath.trimPathOffset ? 1 : (this.trimPathOffset == vectorPath.trimPathOffset ? 0 : -1)) == 0) && PathFillType.m1921equalsimpl0(this.pathFillType, vectorPath.pathFillType) && Intrinsics.areEqual(this.pathData, vectorPath.pathData);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int iOooO00o = Oooo0.OooO00o(this.fillAlpha, (iHashCode + (brush != null ? brush.hashCode() : 0)) * 31, 31);
        Brush brush2 = this.stroke;
        return PathFillType.m1922hashCodeimpl(this.pathFillType) + Oooo0.OooO00o(this.trimPathOffset, Oooo0.OooO00o(this.trimPathEnd, Oooo0.OooO00o(this.trimPathStart, Oooo0.OooO00o(this.strokeLineMiter, (StrokeJoin.m2002hashCodeimpl(this.strokeLineJoin) + ((StrokeCap.m1992hashCodeimpl(this.strokeLineCap) + Oooo0.OooO00o(this.strokeLineWidth, Oooo0.OooO00o(this.strokeAlpha, (iOooO00o + (brush2 != null ? brush2.hashCode() : 0)) * 31, 31), 31)) * 31)) * 31, 31), 31), 31), 31);
    }
