...
public final class HapticFeedbackType {
    ...
    public static final class Companion {
        ...
        public final int m2246getLongPress5zf0vsI() {
            return PlatformHapticFeedbackType.INSTANCE.m2248getLongPress5zf0vsI();
        }

        /* JADX INFO: renamed from: getTextHandleMove-5zf0vsI, reason: not valid java name */
        public final int m2247getTextHandleMove5zf0vsI() {
            return PlatformHapticFeedbackType.INSTANCE.m2249getTextHandleMove5zf0vsI();
        }

        @NotNull
        public final List<HapticFeedbackType> values() {
            return CollectionsKt.listOf((Object[]) new HapticFeedbackType[]{HapticFeedbackType.m2239boximpl(m2246getLongPress5zf0vsI()), HapticFeedbackType.m2239boximpl(m2247getTextHandleMove5zf0vsI())});
        }
    }
    ...
    public static final /* synthetic */ HapticFeedbackType m2239boximpl(int i) {
    ...
    public static String m2244toStringimpl(int i) {
        ...
        if (m2242equalsimpl0(i, companion.m2246getLongPress5zf0vsI())) {
            return "LongPress";
        }
        return m2242equalsimpl0(i, companion.m2247getTextHandleMove5zf0vsI()) ? "TextHandleMove" : "Invalid";
    }
