...
public final class InputModeManagerImpl implements InputModeManager {
    ...
    public int mo2259getInputModeaOaMEAU() {
    ...
    public boolean mo2260requestInputModeiuPiT84(int inputMode) {
        return this.onRequestInputModeChange.invoke(InputMode.m2250boximpl(inputMode)).booleanValue();
    }

    /* JADX INFO: renamed from: setInputMode-iuPiT84, reason: not valid java name */
    public void m2261setInputModeiuPiT84(int i) {
        this.inputMode.setValue(InputMode.m2250boximpl(i));
    }
    ...
    private InputModeManagerImpl(int i, Function1<? super InputMode, Boolean> onRequestInputModeChange) {
        ...
        this.inputMode = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(InputMode.m2250boximpl(i), null, 2, null);
    }
}
