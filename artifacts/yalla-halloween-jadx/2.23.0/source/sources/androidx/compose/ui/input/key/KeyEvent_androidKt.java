...
public final class KeyEvent_androidKt {
    ...
    public static final long m2575getKeyZmokQxo(@NotNull android.view.KeyEvent key) {
        Intrinsics.checkNotNullParameter(key, "$this$key");
        return Key_androidKt.Key(key.getKeyCode());
    }

    /* JADX INFO: renamed from: getType-ZmokQxo, reason: not valid java name */
    public static final int m2576getTypeZmokQxo(@NotNull android.view.KeyEvent type) {
        Intrinsics.checkNotNullParameter(type, "$this$type");
        int action = type.getAction();
        if (action != 0) {
            return action != 1 ? KeyEventType.INSTANCE.m2574getUnknownCS__XNY() : KeyEventType.INSTANCE.m2573getKeyUpCS__XNY();
        }
        return KeyEventType.INSTANCE.m2572getKeyDownCS__XNY();
    }

    /* JADX INFO: renamed from: getUtf16CodePoint-ZmokQxo, reason: not valid java name */
    public static final int m2577getUtf16CodePointZmokQxo(@NotNull android.view.KeyEvent utf16CodePoint) {
    ...
    public static final boolean m2578isAltPressedZmokQxo(@NotNull android.view.KeyEvent isAltPressed) {
    ...
    public static final boolean m2579isCtrlPressedZmokQxo(@NotNull android.view.KeyEvent isCtrlPressed) {
    ...
    public static final boolean m2580isMetaPressedZmokQxo(@NotNull android.view.KeyEvent isMetaPressed) {
    ...
    public static final boolean m2581isShiftPressedZmokQxo(@NotNull android.view.KeyEvent isShiftPressed) {
