...
public interface SoftKeyboardInterceptionModifierNode extends DelegatableNode {
    ...
    boolean mo2262onInterceptKeyBeforeSoftKeyboardZmokQxo(@NotNull android.view.KeyEvent event);

    /* JADX INFO: renamed from: onPreInterceptKeyBeforeSoftKeyboard-ZmokQxo */
    boolean mo2263onPreInterceptKeyBeforeSoftKeyboardZmokQxo(@NotNull android.view.KeyEvent event);
}
