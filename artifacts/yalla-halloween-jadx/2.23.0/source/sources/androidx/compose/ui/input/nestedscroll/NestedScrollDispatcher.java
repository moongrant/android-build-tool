...
public final class NestedScrollDispatcher {
    ...
    public final Object m2587dispatchPostFlingRZ2iAVY(long j, long j2, @NotNull Continuation<? super Velocity> continuation) {
        ...
        Object objMo331onPostFlingRZ2iAVY = nestedScrollDispatcher$dispatchPostFling$2.result;
        ...
        if (i2 == 0) {
            ...
            if (parent$ui_release != null) {
                ...
                objMo331onPostFlingRZ2iAVY = parent$ui_release.mo331onPostFlingRZ2iAVY(j, j2, nestedScrollDispatcher$dispatchPostFling$2);
    ...
    public final long m2588dispatchPostScrollDzOQY0M(long consumed, long available, int source) {
        NestedScrollConnection parent$ui_release = getParent$ui_release();
        return parent$ui_release != null ? parent$ui_release.mo332onPostScrollDzOQY0M(consumed, available, source) : Offset.INSTANCE.m1452getZeroF1C5BW0();
    }

    /* JADX WARN: Code duplicated, block: B:7:0x0013  */
    @Nullable
    /* JADX INFO: renamed from: dispatchPreFling-QWom1Mo, reason: not valid java name */
    public final Object m2589dispatchPreFlingQWom1Mo(long j, @NotNull Continuation<? super Velocity> continuation) {
        ...
        Object objMo333onPreFlingQWom1Mo = nestedScrollDispatcher$dispatchPreFling$1.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        ...
        if (i2 == 0) {
            ...
            if (parent$ui_release != null) {
                ...
                objMo333onPreFlingQWom1Mo = parent$ui_release.mo333onPreFlingQWom1Mo(j, nestedScrollDispatcher$dispatchPreFling$1);
    ...
    public final long m2590dispatchPreScrollOzD1aCk(long available, int source) {
        NestedScrollConnection parent$ui_release = getParent$ui_release();
        return parent$ui_release != null ? parent$ui_release.mo334onPreScrollOzD1aCk(available, source) : Offset.INSTANCE.m1452getZeroF1C5BW0();
    }
