...
public final class NestedScrollNode extends Modifier.Node implements ModifierLocalModifierNode, NestedScrollConnection {
    ...
    private final NestedScrollConnection getParentConnection() {
        if (getIsAttached()) {
            return (NestedScrollConnection) OooO0O0.OooO00o(this, NestedScrollNodeKt.getModifierLocalNestedScroll());
        }
        return null;
    }
    ...
    private final NestedScrollNode getParentModifierLocal() {
        if (getIsAttached()) {
            return (NestedScrollNode) OooO0O0.OooO00o(this, NestedScrollNodeKt.getModifierLocalNestedScroll());
        }
        return null;
    }
    ...
    public Object mo331onPostFlingRZ2iAVY(long j, long j2, @NotNull Continuation<? super Velocity> continuation) {
        ...
        Object objMo331onPostFlingRZ2iAVY = nestedScrollNode$onPostFling$1.result;
        ...
        if (i2 != 0) {
            if (i2 == 1) {
                ...
                ResultKt.throwOnFailure(objMo331onPostFlingRZ2iAVY);
                j4 = j7;
                j3 = j8;
            } else {
                if (i2 != 2) {
            ...
            jM4001getZero9UxMQ8M = ((Velocity) objMo331onPostFlingRZ2iAVY).getPackedValue();
            j5 = j6;
            return Velocity.m3981boximpl(Velocity.m3994plusAH228Gc(j5, jM4001getZero9UxMQ8M));
        }
        ResultKt.throwOnFailure(objMo331onPostFlingRZ2iAVY);
        ...
        objMo331onPostFlingRZ2iAVY = nestedScrollConnection.mo331onPostFlingRZ2iAVY(j, j2, nestedScrollNode$onPostFling$1);
        if (objMo331onPostFlingRZ2iAVY == coroutine_suspended) {
            return coroutine_suspended;
        }
        nestedScrollNode = this;
        long packedValue = ((Velocity) objMo331onPostFlingRZ2iAVY).getPackedValue();
        NestedScrollConnection parentConnection = nestedScrollNode.getParentConnection();
        if (parentConnection != null) {
            long jM3994plusAH228Gc = Velocity.m3994plusAH228Gc(j3, packedValue);
            long jM3993minusAH228Gc = Velocity.m3993minusAH228Gc(j4, packedValue);
            ...
            objMo331onPostFlingRZ2iAVY = parentConnection.mo331onPostFlingRZ2iAVY(jM3994plusAH228Gc, jM3993minusAH228Gc, nestedScrollNode$onPostFling$1);
            if (objMo331onPostFlingRZ2iAVY == coroutine_suspended) {
                return coroutine_suspended;
            }
            j6 = packedValue;
    ...
    public long mo332onPostScrollDzOQY0M(long consumed, long available, int source) {
        long jMo332onPostScrollDzOQY0M = this.connection.mo332onPostScrollDzOQY0M(consumed, available, source);
        NestedScrollConnection parentConnection = getParentConnection();
        return Offset.m1441plusMKHz9U(jMo332onPostScrollDzOQY0M, parentConnection != null ? parentConnection.mo332onPostScrollDzOQY0M(Offset.m1441plusMKHz9U(consumed, jMo332onPostScrollDzOQY0M), Offset.m1440minusMKHz9U(available, jMo332onPostScrollDzOQY0M), source) : Offset.INSTANCE.m1452getZeroF1C5BW0());
    }
    ...
    public Object mo333onPreFlingQWom1Mo(long j, @NotNull Continuation<? super Velocity> continuation) {
        ...
        Object objMo333onPreFlingQWom1Mo = nestedScrollNode$onPreFling$1.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        ...
        if (i2 != 0) {
            if (i2 == 1) {
                ...
                ResultKt.throwOnFailure(objMo333onPreFlingQWom1Mo);
            } else {
                if (i2 != 2) {
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                }
            ...
            return Velocity.m3981boximpl(Velocity.m3994plusAH228Gc(j2, ((Velocity) objMo333onPreFlingQWom1Mo).getPackedValue()));
        }
        ResultKt.throwOnFailure(objMo333onPreFlingQWom1Mo);
        NestedScrollConnection parentConnection = getParentConnection();
        if (parentConnection != null) {
            ...
            objMo333onPreFlingQWom1Mo = parentConnection.mo333onPreFlingQWom1Mo(j, nestedScrollNode$onPreFling$1);
            if (objMo333onPreFlingQWom1Mo == coroutine_suspended) {
                return coroutine_suspended;
            }
            nestedScrollNode = this;
        } else {
        ...
        long j3 = j;
        j2 = jM4001getZero9UxMQ8M;
        NestedScrollConnection nestedScrollConnection = nestedScrollNode.connection;
        long jM3993minusAH228Gc = Velocity.m3993minusAH228Gc(j3, j2);
        nestedScrollNode$onPreFling$1.L$0 = null;
        nestedScrollNode$onPreFling$1.J$0 = j2;
        nestedScrollNode$onPreFling$1.label = 2;
        objMo333onPreFlingQWom1Mo = nestedScrollConnection.mo333onPreFlingQWom1Mo(jM3993minusAH228Gc, nestedScrollNode$onPreFling$1);
        if (objMo333onPreFlingQWom1Mo == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Velocity.m3981boximpl(Velocity.m3994plusAH228Gc(j2, ((Velocity) objMo333onPreFlingQWom1Mo).getPackedValue()));
        jM4001getZero9UxMQ8M = ((Velocity) objMo333onPreFlingQWom1Mo).getPackedValue();
        long j4 = j;
        j2 = jM4001getZero9UxMQ8M;
        NestedScrollConnection nestedScrollConnection2 = nestedScrollNode.connection;
        long jM3993minusAH228Gc2 = Velocity.m3993minusAH228Gc(j4, j2);
        nestedScrollNode$onPreFling$1.L$0 = null;
        nestedScrollNode$onPreFling$1.J$0 = j2;
        nestedScrollNode$onPreFling$1.label = 2;
        objMo333onPreFlingQWom1Mo = nestedScrollConnection2.mo333onPreFlingQWom1Mo(jM3993minusAH228Gc2, nestedScrollNode$onPreFling$1);
        if (objMo333onPreFlingQWom1Mo == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Velocity.m3981boximpl(Velocity.m3994plusAH228Gc(j2, ((Velocity) objMo333onPreFlingQWom1Mo).getPackedValue()));
    ...
    public long mo334onPreScrollOzD1aCk(long available, int source) {
        NestedScrollConnection parentConnection = getParentConnection();
        long jMo334onPreScrollOzD1aCk = parentConnection != null ? parentConnection.mo334onPreScrollOzD1aCk(available, source) : Offset.INSTANCE.m1452getZeroF1C5BW0();
        return Offset.m1441plusMKHz9U(jMo334onPreScrollOzD1aCk, this.connection.mo334onPreScrollOzD1aCk(Offset.m1440minusMKHz9U(available, jMo334onPreScrollOzD1aCk), source));
    }
    ...
    public final void updateNode$ui_release(@NotNull NestedScrollConnection connection, @Nullable NestedScrollDispatcher dispatcher) {
        Intrinsics.checkNotNullParameter(connection, "connection");
        this.connection = connection;
