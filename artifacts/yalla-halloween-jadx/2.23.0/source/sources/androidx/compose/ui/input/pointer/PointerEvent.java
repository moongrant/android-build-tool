...
public final class PointerEvent {
    ...
    public PointerEvent(@NotNull List<PointerInputChange> changes, @Nullable InternalPointerEvent internalPointerEvent) {
        ...
        this.buttons = PointerButtons.m2623constructorimpl(motionEvent$ui_release != null ? motionEvent$ui_release.getButtonState() : 0);
        MotionEvent motionEvent$ui_release2 = getMotionEvent$ui_release();
        this.keyboardModifiers = PointerKeyboardModifiers.m2738constructorimpl(motionEvent$ui_release2 != null ? motionEvent$ui_release2.getMetaState() : 0);
        ...
        if (motionEvent$ui_release == null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (PointerEventKt.changedToUpIgnoreConsumed(pointerInputChange)) {
                    return PointerEventType.INSTANCE.m2647getRelease7fucELk();
                }
                if (PointerEventKt.changedToDownIgnoreConsumed(pointerInputChange)) {
                    return PointerEventType.INSTANCE.m2646getPress7fucELk();
                }
            }
            return PointerEventType.INSTANCE.m2645getMove7fucELk();
        }
                ...
                if (actionMasked != 2) {
                    switch (actionMasked) {
                        ...
                        case 7:
                            break;
                        case 8:
                            return PointerEventType.INSTANCE.m2648getScroll7fucELk();
                        case 9:
                            return PointerEventType.INSTANCE.m2643getEnter7fucELk();
                        case 10:
                            return PointerEventType.INSTANCE.m2644getExit7fucELk();
                        default:
                            return PointerEventType.INSTANCE.m2649getUnknown7fucELk();
                    }
                }
                return PointerEventType.INSTANCE.m2645getMove7fucELk();
            }
    ...
    public final PointerEvent copy(@NotNull List<PointerInputChange> changes, @Nullable MotionEvent motionEvent) {
        ...
        while (i < size) {
            ...
            linkedHashMap.put(PointerId.m2669boximpl(pointerInputChange.getId()), pointerInputChange);
            long jM2688getIdJ3iCeTQ = pointerInputChange.getId();
            long uptimeMillis = pointerInputChange.getUptimeMillis();
            long jM2689getPositionF1C5BW0 = pointerInputChange.getPosition();
            long jM2689getPositionF1C5BW1 = pointerInputChange.getPosition();
            boolean pressed = pointerInputChange.getPressed();
            float pressure = pointerInputChange.getPressure();
            int iM2692getTypeT8wyACA = pointerInputChange.getType();
            InternalPointerEvent internalPointerEvent = this.internalPointerEvent;
            int i2 = i;
            arrayList.add(new PointerInputEventData(jM2688getIdJ3iCeTQ, uptimeMillis, jM2689getPositionF1C5BW0, jM2689getPositionF1C5BW1, pressed, pressure, iM2692getTypeT8wyACA, internalPointerEvent != null && internalPointerEvent.m2619issuesEnterExitEvent0FcD4WY(pointerInputChange.getId()), null, 0L, 768, null));
            i = i2 + 1;
        }
    ...
    public final void m2633setTypeEhbLWgg$ui_release(int i) {
        this.type = i;
    }
