...
public final class PointerEventKt {
    ...
    public static final void consumePositionChange(@NotNull PointerInputChange pointerInputChange) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "<this>");
        if (Offset.m1433equalsimpl0(positionChange(pointerInputChange), Offset.INSTANCE.m1452getZeroF1C5BW0())) {
            return;
        }
        pointerInputChange.consume();
    }
    ...
    public static final boolean m2634isOutOfBoundsO0kMr_c(@NotNull PointerInputChange isOutOfBounds, long j) {
        Intrinsics.checkNotNullParameter(isOutOfBounds, "$this$isOutOfBounds");
        long jM2689getPositionF1C5BW0 = isOutOfBounds.getPosition();
        float fM1436getXimpl = Offset.m1436getXimpl(jM2689getPositionF1C5BW0);
        float fM1437getYimpl = Offset.m1437getYimpl(jM2689getPositionF1C5BW0);
        return fM1436getXimpl < 0.0f || fM1436getXimpl > ((float) IntSize.m3925getWidthimpl(j)) || fM1437getYimpl < 0.0f || fM1437getYimpl > ((float) IntSize.m3924getHeightimpl(j));
    }

    /* JADX INFO: renamed from: isOutOfBounds-jwHxaWs, reason: not valid java name */
    public static final boolean m2635isOutOfBoundsjwHxaWs(@NotNull PointerInputChange isOutOfBounds, long j, long j2) {
        Intrinsics.checkNotNullParameter(isOutOfBounds, "$this$isOutOfBounds");
        if (!PointerType.m2747equalsimpl0(isOutOfBounds.getType(), PointerType.INSTANCE.m2754getTouchT8wyACA())) {
            return m2634isOutOfBoundsO0kMr_c(isOutOfBounds, j);
        }
        long jM2689getPositionF1C5BW0 = isOutOfBounds.getPosition();
        float fM1436getXimpl = Offset.m1436getXimpl(jM2689getPositionF1C5BW0);
        float fM1437getYimpl = Offset.m1437getYimpl(jM2689getPositionF1C5BW0);
        return fM1436getXimpl < (-Size.m1505getWidthimpl(j2)) || fM1436getXimpl > Size.m1505getWidthimpl(j2) + ((float) IntSize.m3925getWidthimpl(j)) || fM1437getYimpl < (-Size.m1502getHeightimpl(j2)) || fM1437getYimpl > Size.m1502getHeightimpl(j2) + ((float) IntSize.m3924getHeightimpl(j));
    }
    ...
    private static final long positionChangeInternal(PointerInputChange pointerInputChange, boolean z) {
        long jM1440minusMKHz9U = Offset.m1440minusMKHz9U(pointerInputChange.getPosition(), pointerInputChange.getPreviousPosition());
        return (z || !pointerInputChange.isConsumed()) ? jM1440minusMKHz9U : Offset.INSTANCE.m1452getZeroF1C5BW0();
    }
    ...
    public static final boolean positionChanged(@NotNull PointerInputChange pointerInputChange) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "<this>");
        return !Offset.m1433equalsimpl0(positionChangeInternal(pointerInputChange, false), Offset.INSTANCE.m1452getZeroF1C5BW0());
    }

    public static final boolean positionChangedIgnoreConsumed(@NotNull PointerInputChange pointerInputChange) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "<this>");
        return !Offset.m1433equalsimpl0(positionChangeInternal(pointerInputChange, true), Offset.INSTANCE.m1452getZeroF1C5BW0());
    }
}
