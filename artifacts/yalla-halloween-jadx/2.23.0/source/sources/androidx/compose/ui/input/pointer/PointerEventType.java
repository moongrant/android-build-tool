...
public final class PointerEventType {
    ...
    private static final int Unknown = m2637constructorimpl(0);
    private static final int Press = m2637constructorimpl(1);
    private static final int Release = m2637constructorimpl(2);
    private static final int Move = m2637constructorimpl(3);
    private static final int Enter = m2637constructorimpl(4);
    private static final int Exit = m2637constructorimpl(5);
    private static final int Scroll = m2637constructorimpl(6);
    ...
    public static final /* synthetic */ PointerEventType m2636boximpl(int i) {
        return new PointerEventType(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m2637constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m2638equalsimpl(int i, Object obj) {
        return (obj instanceof PointerEventType) && i == ((PointerEventType) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2639equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m2640hashCodeimpl(int i) {
        return i;
    }
    ...
    public static String m2641toStringimpl(int i) {
        if (m2639equalsimpl0(i, Press)) {
            return "Press";
        }
        if (m2639equalsimpl0(i, Release)) {
            return "Release";
        }
        if (m2639equalsimpl0(i, Move)) {
            return "Move";
        }
        if (m2639equalsimpl0(i, Enter)) {
            return "Enter";
        }
        if (m2639equalsimpl0(i, Exit)) {
            return "Exit";
        }
        return m2639equalsimpl0(i, Scroll) ? "Scroll" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
