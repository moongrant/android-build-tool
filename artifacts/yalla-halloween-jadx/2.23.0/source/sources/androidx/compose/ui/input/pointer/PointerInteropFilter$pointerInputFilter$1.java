...
public final class PointerInteropFilter$pointerInputFilter$1 extends PointerInputFilter {
    ...
    private final void dispatchToView(PointerEvent pointerEvent) {
        ...
        if (z) {
            if (this.state == PointerInteropFilter.DispatchToViewState.Dispatching) {
                ...
                long jMo2803localToRootMKHz9U = layoutCoordinates.mo2803localToRootMKHz9U(Offset.INSTANCE.m1452getZeroF1C5BW0());
                final PointerInteropFilter pointerInteropFilter = this.this$0;
                PointerInteropUtils_androidKt.m2734toCancelMotionEventScoped4ec7I(pointerEvent, jMo2803localToRootMKHz9U, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$2
                    {
                        super(1);
                    }
        ...
        long jMo2803localToRootMKHz9U2 = layoutCoordinates2.mo2803localToRootMKHz9U(Offset.INSTANCE.m1452getZeroF1C5BW0());
        final PointerInteropFilter pointerInteropFilter2 = this.this$0;
        PointerInteropUtils_androidKt.m2735toMotionEventScoped4ec7I(pointerEvent, jMo2803localToRootMKHz9U2, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$3
    ...
    public void mo2710onPointerEventH0pRuoY(@NotNull PointerEvent pointerEvent, @NotNull PointerEventPass pass, long bounds) {
        boolean z;
        boolean z2;
