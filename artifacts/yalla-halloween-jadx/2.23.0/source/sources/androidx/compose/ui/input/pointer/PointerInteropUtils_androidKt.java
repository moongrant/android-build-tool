...
public final class PointerInteropUtils_androidKt {
    ...
    public static final void m2734toCancelMotionEventScoped4ec7I(@NotNull PointerEvent toCancelMotionEventScope, long j, @NotNull Function1<? super MotionEvent, Unit> block) {
        Intrinsics.checkNotNullParameter(toCancelMotionEventScope, "$this$toCancelMotionEventScope");
        Intrinsics.checkNotNullParameter(block, "block");
        m2736toMotionEventScopeubNVwUQ(toCancelMotionEventScope, j, block, true);
    }

    /* JADX INFO: renamed from: toMotionEventScope-d-4ec7I, reason: not valid java name */
    public static final void m2735toMotionEventScoped4ec7I(@NotNull PointerEvent toMotionEventScope, long j, @NotNull Function1<? super MotionEvent, Unit> block) {
        Intrinsics.checkNotNullParameter(toMotionEventScope, "$this$toMotionEventScope");
        Intrinsics.checkNotNullParameter(block, "block");
        m2736toMotionEventScopeubNVwUQ(toMotionEventScope, j, block, false);
    }

    /* JADX INFO: renamed from: toMotionEventScope-ubNVwUQ, reason: not valid java name */
    private static final void m2736toMotionEventScopeubNVwUQ(PointerEvent pointerEvent, long j, Function1<? super MotionEvent, Unit> function1, boolean z) {
        ...
        motionEvent$ui_release.offsetLocation(-Offset.m1436getXimpl(j), -Offset.m1437getYimpl(j));
