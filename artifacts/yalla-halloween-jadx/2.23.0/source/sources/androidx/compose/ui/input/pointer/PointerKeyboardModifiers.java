...
public final class PointerKeyboardModifiers {
    ...
    public static final /* synthetic */ PointerKeyboardModifiers m2737boximpl(int i) {
    ...
    public static String m2742toStringimpl(int i) {
        return androidx.compose.animation.core.OooO0OO.OooO00o("PointerKeyboardModifiers(packedValue=", i, ')');
    }

    public boolean equals(Object obj) {
        return m2739equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m2741hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m2742toStringimpl(this.packedValue);
    }
