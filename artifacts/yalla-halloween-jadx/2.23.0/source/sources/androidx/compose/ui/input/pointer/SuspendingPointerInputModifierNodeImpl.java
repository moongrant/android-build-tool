...
public final class SuspendingPointerInputModifierNodeImpl extends Modifier.Node implements SuspendingPointerInputModifierNode, PointerInputScope, Density {
    ...
    public final class PointerEventHandlerCoroutine<R> implements AwaitPointerEventScope, Density, Continuation<R> {
        ...
        public long mo2602getExtendedTouchPaddingNHjbRc() {
            return this.this$0.mo2711getExtendedTouchPaddingNHjbRc();
        }
        ...
        public long mo2603getSizeYbymL2g() {
        ...
        public final void offerPointerEvent(@NotNull PointerEvent event, @NotNull PointerEventPass pass) {
            ...
            this.pointerAwaiter = null;
            cancellableContinuation.resumeWith(Result.m4213constructorimpl(event));
        }
            ...
            try {
                if (i2 == 0) {
                    ...
                    if (j <= 0 && (cancellableContinuation = this.pointerAwaiter) != null) {
                        ...
                        cancellableContinuation.resumeWith(Result.m4213constructorimpl(ResultKt.createFailure(new PointerEventTimeoutCancellationException(j))));
                    }
    ...
    public SuspendingPointerInputModifierNodeImpl(@NotNull Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object> pointerInputHandler) {
        ...
        this.boundsSize = IntSize.INSTANCE.m3930getZeroYbymL2g();
    }
    ...
    public <R> Object awaitPointerEventScope(@NotNull Function2<? super AwaitPointerEventScope, ? super Continuation<? super R>, ? extends Object> function2, @NotNull Continuation<? super R> continuation) throws Throwable {
        ...
        synchronized (this.pointerHandlers) {
            ...
            Result.Companion companion = Result.INSTANCE;
            continuationCreateCoroutine.resumeWith(Result.m4213constructorimpl(Unit.INSTANCE));
        }
    ...
    @Override // androidx.compose.ui.input.pointer.PointerInputScope
    /* JADX INFO: renamed from: getExtendedTouchPadding-NH-jbRc */
    public long mo2711getExtendedTouchPaddingNHjbRc() {
        long jOooOO0 = androidx.compose.ui.unit.OooO00o.OooOO0(this, getViewConfiguration().mo2923getMinimumTouchTargetSizeMYxV2XQ());
        long boundsSize = getBoundsSize();
        return SizeKt.Size(Math.max(0.0f, Size.m1505getWidthimpl(jOooOO0) - IntSize.m3925getWidthimpl(boundsSize)) / 2.0f, Math.max(0.0f, Size.m1502getHeightimpl(jOooOO0) - IntSize.m3924getHeightimpl(boundsSize)) / 2.0f);
    }
