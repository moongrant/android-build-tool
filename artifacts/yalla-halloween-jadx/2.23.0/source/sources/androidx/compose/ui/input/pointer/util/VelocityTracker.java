...
public final class VelocityTracker {
    ...
    private long currentPointerPositionAccumulator = Offset.INSTANCE.m1452getZeroF1C5BW0();

    /* JADX INFO: renamed from: addPosition-Uv8p0NA, reason: not valid java name */
    public final void m2767addPositionUv8p0NA(long timeMillis, long position) {
        this.xVelocityTracker.addDataPoint(timeMillis, Offset.m1436getXimpl(position));
        this.yVelocityTracker.addDataPoint(timeMillis, Offset.m1437getYimpl(position));
    }

    /* JADX INFO: renamed from: calculateVelocity-9UxMQ8M, reason: not valid java name */
    public final long m2768calculateVelocity9UxMQ8M() {
    ...
    public final void m2770setCurrentPointerPositionAccumulatork4lQ0M$ui_release(long j) {
