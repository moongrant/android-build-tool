...
public final class VelocityTrackerKt {
    ...
    public static final void addPointerInputChange(@NotNull VelocityTracker velocityTracker, @NotNull PointerInputChange event) {
        ...
        if (PointerEventKt.changedToDownIgnoreConsumed(event)) {
            velocityTracker.m2770setCurrentPointerPositionAccumulatork4lQ0M$ui_release(event.getPosition());
        ...
        while (i < size) {
            ...
            long jM1440minusMKHz9U = Offset.m1440minusMKHz9U(historicalChange.getPosition(), previousPosition);
            long position = historicalChange.getPosition();
            velocityTracker.m2770setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m1441plusMKHz9U(velocityTracker.getCurrentPointerPositionAccumulator(), jM1440minusMKHz9U));
            velocityTracker.m2767addPositionUv8p0NA(historicalChange.getUptimeMillis(), velocityTracker.getCurrentPointerPositionAccumulator());
            i++;
            previousPosition = position;
        }
        velocityTracker.m2770setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m1441plusMKHz9U(velocityTracker.getCurrentPointerPositionAccumulator(), Offset.m1440minusMKHz9U(event.getPosition(), previousPosition)));
        velocityTracker.m2767addPositionUv8p0NA(event.getUptimeMillis(), velocityTracker.getCurrentPointerPositionAccumulator());
    }
