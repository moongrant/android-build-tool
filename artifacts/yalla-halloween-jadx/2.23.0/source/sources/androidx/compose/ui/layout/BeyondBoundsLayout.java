...
public interface BeyondBoundsLayout {
    ...
    public static final class LayoutDirection {
        ...
        private static final int Before = m2772constructorimpl(1);
        private static final int After = m2772constructorimpl(2);
        private static final int Left = m2772constructorimpl(3);
        private static final int Right = m2772constructorimpl(4);
        private static final int Above = m2772constructorimpl(5);
        private static final int Below = m2772constructorimpl(6);
        ...
        public static final /* synthetic */ LayoutDirection m2771boximpl(int i) {
            return new LayoutDirection(i);
        }

        /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
        public static int m2772constructorimpl(int i) {
            return i;
        }

        /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
        public static boolean m2773equalsimpl(int i, Object obj) {
            return (obj instanceof LayoutDirection) && i == ((LayoutDirection) obj).getValue();
        }

        /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m2774equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
        public static int m2775hashCodeimpl(int i) {
            return i;
        }
        ...
        public static String m2776toStringimpl(int i) {
            if (m2774equalsimpl0(i, Before)) {
                return "Before";
            }
            if (m2774equalsimpl0(i, After)) {
                return "After";
            }
            if (m2774equalsimpl0(i, Left)) {
                return "Left";
            }
            if (m2774equalsimpl0(i, Right)) {
                return "Right";
            }
            if (m2774equalsimpl0(i, Above)) {
                return "Above";
            }
            return m2774equalsimpl0(i, Below) ? "Below" : "invalid LayoutDirection";
        }

        public boolean equals(Object obj) {
            return m2773equalsimpl(this.value, obj);
        }

        public int hashCode() {
            return m2775hashCodeimpl(this.value);
        }

        @NotNull
        public String toString() {
            return m2776toStringimpl(this.value);
        }
    ...
    <T> T mo628layouto7g1Pn8(int direction, @NotNull Function1<? super BeyondBoundsScope, ? extends T> block);
}
