...
public interface ContentScale {
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo2785computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM2791computeFillMaxDimensioniLBOSCw = ContentScaleKt.m2791computeFillMaxDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM2791computeFillMaxDimensioniLBOSCw, fM2791computeFillMaxDimensioniLBOSCw);
            }
        };
        ...
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public long mo2785computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM2792computeFillMinDimensioniLBOSCw = ContentScaleKt.m2792computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM2792computeFillMinDimensioniLBOSCw, fM2792computeFillMinDimensioniLBOSCw);
            }
        };
        ...
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public long mo2785computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM2790computeFillHeightiLBOSCw = ContentScaleKt.m2790computeFillHeightiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM2790computeFillHeightiLBOSCw, fM2790computeFillHeightiLBOSCw);
            }
        };
        ...
        private static final ContentScale FillWidth = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillWidth$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public long mo2785computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM2793computeFillWidthiLBOSCw = ContentScaleKt.m2793computeFillWidthiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM2793computeFillWidthiLBOSCw, fM2793computeFillWidthiLBOSCw);
            }
        };
        ...
        private static final ContentScale Inside = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Inside$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public long mo2785computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                if (Size.m1505getWidthimpl(srcSize) <= Size.m1505getWidthimpl(dstSize) && Size.m1502getHeightimpl(srcSize) <= Size.m1502getHeightimpl(dstSize)) {
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public long mo2785computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                return ScaleFactorKt.ScaleFactor(ContentScaleKt.m2793computeFillWidthiLBOSCw(srcSize, dstSize), ContentScaleKt.m2790computeFillHeightiLBOSCw(srcSize, dstSize));
            }
        };
    ...
    long mo2785computeScaleFactorH7hwNQA(long srcSize, long dstSize);
}
