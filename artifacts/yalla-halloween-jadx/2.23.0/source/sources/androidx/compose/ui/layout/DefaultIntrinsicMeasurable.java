...
public final class DefaultIntrinsicMeasurable implements Measurable {
    ...
    public Placeable mo2794measureBRTryo0(long constraints) {
        if (this.widthHeight == IntrinsicWidthHeight.Width) {
            return new FixedSizeIntrinsicsPlaceable(this.minMax == IntrinsicMinMax.Max ? this.measurable.maxIntrinsicWidth(Constraints.m3732getMaxHeightimpl(constraints)) : this.measurable.minIntrinsicWidth(Constraints.m3732getMaxHeightimpl(constraints)), Constraints.m3732getMaxHeightimpl(constraints));
        }
        return new FixedSizeIntrinsicsPlaceable(Constraints.m3733getMaxWidthimpl(constraints), this.minMax == IntrinsicMinMax.Max ? this.measurable.maxIntrinsicHeight(Constraints.m3733getMaxWidthimpl(constraints)) : this.measurable.minIntrinsicHeight(Constraints.m3733getMaxWidthimpl(constraints)));
    }
