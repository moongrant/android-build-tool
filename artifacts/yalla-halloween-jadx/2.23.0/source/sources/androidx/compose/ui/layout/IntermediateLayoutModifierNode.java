...
public final class IntermediateLayoutModifierNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final class IntermediateMeasurablePlaceable extends Placeable implements Measurable {
        ...
        public Placeable mo2794measureBRTryo0(long constraints) {
            ...
            if (this.this$0.getIsIntermediateChangeActive()) {
                placeableMo2794measureBRTryo0 = this.wrappedMeasurable.mo2794measureBRTryo0(constraints);
                m2837setMeasurementConstraintsBRTryo0(constraints);
                m2836setMeasuredSizeozmzZPI(IntSizeKt.IntSize(placeableMo2794measureBRTryo0.getWidth(), placeableMo2794measureBRTryo0.getHeight()));
            } else {
                ...
                placeableMo2794measureBRTryo0 = measurable.mo2794measureBRTryo0(constraints2.getValue());
                ...
                m2837setMeasurementConstraintsBRTryo0(constraints3.getValue());
                m2836setMeasuredSizeozmzZPI(intermediateLayoutModifierNode.getIsIntermediateChangeActive() ? IntSizeKt.IntSize(placeableMo2794measureBRTryo0.getWidth(), placeableMo2794measureBRTryo0.getHeight()) : intermediateLayoutModifierNode.intermediateMeasureScope.getLookaheadSize());
            }
            this.wrappedPlaceable = placeableMo2794measureBRTryo0;
            return this;
        }
        ...
        public void mo2795placeAtf8xVGno(long position, float zIndex, @Nullable Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            Unit unit;
            if (!this.this$0.getIsIntermediateChangeActive()) {
                position = IntOffset.INSTANCE.m3893getZeronOccac();
            }
            if (layerBlock != null) {
                Placeable placeable = this.wrappedPlaceable;
                if (placeable != null) {
                    Placeable.PlacementScope.INSTANCE.m2847placeWithLayeraW9wM(placeable, position, zIndex, layerBlock);
                    unit = Unit.INSTANCE;
                } else {
                    unit = null;
                }
            ...
            if (placeable2 != null) {
                Placeable.PlacementScope.INSTANCE.m2842place70tqf50(placeable2, position, zIndex);
    ...
    public final class IntermediateMeasureScopeImpl implements IntermediateMeasureScope, CoroutineScope {
        private long lookaheadSize = IntSize.INSTANCE.m3930getZeroYbymL2g();
        ...
        public final /* synthetic */ long mo2798localLookaheadPositionOfdBAh8RU(LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2) {
        ...
        public void m2799setLookaheadSizeozmzZPI(long j) {
    ...
    public final MeasureResult m2796intermediateMeasureTeuZzU(@NotNull MeasureScope intermediateMeasure, @NotNull Measurable measurable, long j, long j2, long j3) {
        Intrinsics.checkNotNullParameter(intermediateMeasure, "$this$intermediateMeasure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        this.intermediateMeasureScope.m2799setLookaheadSizeozmzZPI(j2);
        this.lookaheadConstraints = Constraints.m3721boximpl(j3);
        ...
        return this.measureBlock.invoke(this.intermediateMeasureScope, intermediateMeasurablePlaceable, Constraints.m3721boximpl(j));
    }
    ...
    public final int maxIntermediateIntrinsicHeight$ui_release(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull IntrinsicMeasurable measurable, int i) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.maxHeight$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$maxIntermediateIntrinsicHeight$1
            ...
            public final MeasureResult mo2800measure3p2s80s(@NotNull MeasureScope maxHeight, @NotNull Measurable intrinsicMeasurable, long j) {
                Intrinsics.checkNotNullParameter(maxHeight, "$this$maxHeight");
                Intrinsics.checkNotNullParameter(intrinsicMeasurable, "intrinsicMeasurable");
                return this.this$0.getMeasureBlock$ui_release().invoke(this.this$0.intermediateMeasureScope, intrinsicMeasurable, Constraints.m3721boximpl(j));
            }
    ...
    public final int maxIntermediateIntrinsicWidth$ui_release(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull IntrinsicMeasurable measurable, int i) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.maxWidth$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$maxIntermediateIntrinsicWidth$1
            ...
            public final MeasureResult mo2800measure3p2s80s(@NotNull MeasureScope maxWidth, @NotNull Measurable intrinsicMeasurable, long j) {
    ...
    public MeasureResult mo248measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j) {
        ...
        return MeasureScope.CC.OooOOo0(measure, placeableMo2794measureBRTryo0.getWidth(), placeableMo2794measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$measure$1$1
            {
                super(1);
            }
    ...
    public final int minIntermediateIntrinsicHeight$ui_release(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull IntrinsicMeasurable measurable, int i) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.minHeight$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$minIntermediateIntrinsicHeight$1
            ...
            @NotNull
            /* JADX INFO: renamed from: measure-3p2s80s */
            public final MeasureResult mo2800measure3p2s80s(@NotNull MeasureScope minHeight, @NotNull Measurable intrinsicMeasurable, long j) {
    ...
    public final int minIntermediateIntrinsicWidth$ui_release(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull IntrinsicMeasurable measurable, int i) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.minWidth$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$minIntermediateIntrinsicWidth$1
            ...
            @NotNull
            /* JADX INFO: renamed from: measure-3p2s80s */
            public final MeasureResult mo2800measure3p2s80s(@NotNull MeasureScope minWidth, @NotNull Measurable intrinsicMeasurable, long j) {
    ...
    public void onAttach() {
        ...
        if (lookaheadRoot != null && lookaheadRoot.getIsVirtualLookaheadRoot()) {
            ...
            int iM2994constructorimpl = NodeKind.m2994constructorimpl(ConstantsKt.MINIMUM_BLOCK_SIZE);
