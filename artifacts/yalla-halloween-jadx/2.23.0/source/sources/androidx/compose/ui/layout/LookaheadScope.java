...
public interface LookaheadScope {
    ...
    public final /* synthetic */ class CC {
        ...
        public static Modifier OooO00o(LookaheadScope lookaheadScope, @NotNull Modifier modifier, @NotNull final Function4 measure) {
            ...
            return LookaheadScopeKt.intermediateLayout(modifier, new Function3<IntermediateMeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.ui.layout.LookaheadScope.intermediateLayout.1
                ...
                public /* bridge */ /* synthetic */ MeasureResult invoke(IntermediateMeasureScope intermediateMeasureScope, Measurable measurable, Constraints constraints) {
                    return m2817invoke3p2s80s(intermediateMeasureScope, measurable, constraints.getValue());
                }

                @NotNull
                /* JADX INFO: renamed from: invoke-3p2s80s, reason: not valid java name */
                public final MeasureResult m2817invoke3p2s80s(@NotNull IntermediateMeasureScope intermediateLayout, @NotNull Measurable measurable, long j) {
                    Intrinsics.checkNotNullParameter(intermediateLayout, "$this$intermediateLayout");
                    Intrinsics.checkNotNullParameter(measurable, "measurable");
                    return measure.invoke(intermediateLayout, measurable, Constraints.m3721boximpl(j), IntSize.m3917boximpl(intermediateLayout.mo2797getLookaheadSizeYbymL2g()));
                }
            });
        }
        ...
        public static long OooO0O0(LookaheadScope lookaheadScope, @NotNull LayoutCoordinates localLookaheadPositionOf, @NotNull LayoutCoordinates coordinates) {
            ...
            return lookaheadScope.toLookaheadCoordinates(localLookaheadPositionOf).mo2802localPositionOfR5De75A(lookaheadScope.toLookaheadCoordinates(coordinates), Offset.INSTANCE.m1452getZeroF1C5BW0());
        }
    }
    ...
    long mo2798localLookaheadPositionOfdBAh8RU(@NotNull LayoutCoordinates layoutCoordinates, @NotNull LayoutCoordinates layoutCoordinates2);
