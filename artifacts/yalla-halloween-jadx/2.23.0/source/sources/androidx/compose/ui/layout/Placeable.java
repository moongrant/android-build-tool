...
public abstract class Placeable implements Measured {
    ...
    private long apparentToRealOffset = IntOffset.INSTANCE.m3893getZeronOccac();
    ...
    public static abstract class PlacementScope {
        ...
        public static /* synthetic */ void m2838place70tqf50$default(PlacementScope placementScope, Placeable placeable, long j, float f, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m2842place70tqf50(placeable, j, f);
        }
        ...
        public static /* synthetic */ void m2839placeRelative70tqf50$default(PlacementScope placementScope, Placeable placeable, long j, float f, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m2845placeRelative70tqf50(placeable, j, f);
        }
        ...
        public static /* synthetic */ void m2840placeRelativeWithLayeraW9wM$default(PlacementScope placementScope, Placeable placeable, long j, float f, Function1 function1, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m2846placeRelativeWithLayeraW9wM(placeable, j, f2, function1);
        }
        ...
        public static /* synthetic */ void m2841placeWithLayeraW9wM$default(PlacementScope placementScope, Placeable placeable, long j, float f, Function1 function1, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m2847placeWithLayeraW9wM(placeable, j, f2, function1);
        }
        ...
        public final void place(@NotNull Placeable placeable, int i, int i2, float f) {
            ...
            placeable.mo2795placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m3883getXimpl(j) + IntOffset.m3883getXimpl(jIntOffset), IntOffset.m3884getYimpl(j) + IntOffset.m3884getYimpl(jIntOffset)), f, null);
        }

        /* JADX INFO: renamed from: place-70tqf50, reason: not valid java name */
        public final void m2842place70tqf50(@NotNull Placeable place, long j, float f) {
            Intrinsics.checkNotNullParameter(place, "$this$place");
            long j2 = place.apparentToRealOffset;
            place.mo2795placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m3883getXimpl(j2) + IntOffset.m3883getXimpl(j), IntOffset.m3884getYimpl(j2) + IntOffset.m3884getYimpl(j)), f, null);
        }

        /* JADX INFO: renamed from: placeApparentToRealOffset-aW-9-wM$ui_release, reason: not valid java name */
        public final void m2843placeApparentToRealOffsetaW9wM$ui_release(@NotNull Placeable placeApparentToRealOffset, long j, float f, @Nullable Function1<? super GraphicsLayerScope, Unit> function1) {
            ...
            placeApparentToRealOffset.mo2795placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m3883getXimpl(j2) + IntOffset.m3883getXimpl(j), IntOffset.m3884getYimpl(j2) + IntOffset.m3884getYimpl(j)), f, function1);
        }

        /* JADX INFO: renamed from: placeAutoMirrored-aW-9-wM$ui_release, reason: not valid java name */
        public final void m2844placeAutoMirroredaW9wM$ui_release(@NotNull Placeable placeAutoMirrored, long j, float f, @Nullable Function1<? super GraphicsLayerScope, Unit> function1) {
            ...
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                ...
                placeAutoMirrored.mo2795placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m3883getXimpl(j2) + IntOffset.m3883getXimpl(j), IntOffset.m3884getYimpl(j2) + IntOffset.m3884getYimpl(j)), f, function1);
                return;
            }
            long jIntOffset = IntOffsetKt.IntOffset((getParentWidth() - placeAutoMirrored.getWidth()) - IntOffset.m3883getXimpl(j), IntOffset.m3884getYimpl(j));
            long j3 = placeAutoMirrored.apparentToRealOffset;
            placeAutoMirrored.mo2795placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m3883getXimpl(j3) + IntOffset.m3883getXimpl(jIntOffset), IntOffset.m3884getYimpl(j3) + IntOffset.m3884getYimpl(jIntOffset)), f, function1);
        }
        ...
        public final void placeRelative(@NotNull Placeable placeable, int i, int i2, float f) {
            ...
            long jIntOffset2 = IntOffsetKt.IntOffset((getParentWidth() - placeable.getWidth()) - IntOffset.m3883getXimpl(jIntOffset), IntOffset.m3884getYimpl(jIntOffset));
            long j2 = placeable.apparentToRealOffset;
            placeable.mo2795placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m3883getXimpl(j2) + IntOffset.m3883getXimpl(jIntOffset2), IntOffset.m3884getYimpl(j2) + IntOffset.m3884getYimpl(jIntOffset2)), f, null);
        }

        /* JADX INFO: renamed from: placeRelative-70tqf50, reason: not valid java name */
        public final void m2845placeRelative70tqf50(@NotNull Placeable placeRelative, long j, float f) {
            Intrinsics.checkNotNullParameter(placeRelative, "$this$placeRelative");
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                long j2 = placeRelative.apparentToRealOffset;
                placeRelative.mo2795placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m3883getXimpl(j2) + IntOffset.m3883getXimpl(j), IntOffset.m3884getYimpl(j2) + IntOffset.m3884getYimpl(j)), f, null);
                return;
            }
            long jIntOffset = IntOffsetKt.IntOffset((getParentWidth() - placeRelative.getWidth()) - IntOffset.m3883getXimpl(j), IntOffset.m3884getYimpl(j));
            long j3 = placeRelative.apparentToRealOffset;
            placeRelative.mo2795placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m3883getXimpl(j3) + IntOffset.m3883getXimpl(jIntOffset), IntOffset.m3884getYimpl(j3) + IntOffset.m3884getYimpl(jIntOffset)), f, null);
        }
        ...
        public final void placeRelativeWithLayer(@NotNull Placeable placeable, int i, int i2, float f, @NotNull Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            ...
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                long j = placeable.apparentToRealOffset;
                placeable.mo2795placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m3883getXimpl(j) + IntOffset.m3883getXimpl(jIntOffset), IntOffset.m3884getYimpl(j) + IntOffset.m3884getYimpl(jIntOffset)), f, layerBlock);
                return;
            }
            long jIntOffset2 = IntOffsetKt.IntOffset((getParentWidth() - placeable.getWidth()) - IntOffset.m3883getXimpl(jIntOffset), IntOffset.m3884getYimpl(jIntOffset));
            long j2 = placeable.apparentToRealOffset;
            placeable.mo2795placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m3883getXimpl(j2) + IntOffset.m3883getXimpl(jIntOffset2), IntOffset.m3884getYimpl(j2) + IntOffset.m3884getYimpl(jIntOffset2)), f, layerBlock);
        }

        /* JADX INFO: renamed from: placeRelativeWithLayer-aW-9-wM, reason: not valid java name */
        public final void m2846placeRelativeWithLayeraW9wM(@NotNull Placeable placeRelativeWithLayer, long j, float f, @NotNull Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            Intrinsics.checkNotNullParameter(placeRelativeWithLayer, "$this$placeRelativeWithLayer");
            Intrinsics.checkNotNullParameter(layerBlock, "layerBlock");
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                long j2 = placeRelativeWithLayer.apparentToRealOffset;
                placeRelativeWithLayer.mo2795placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m3883getXimpl(j2) + IntOffset.m3883getXimpl(j), IntOffset.m3884getYimpl(j2) + IntOffset.m3884getYimpl(j)), f, layerBlock);
                return;
            }
            long jIntOffset = IntOffsetKt.IntOffset((getParentWidth() - placeRelativeWithLayer.getWidth()) - IntOffset.m3883getXimpl(j), IntOffset.m3884getYimpl(j));
            long j3 = placeRelativeWithLayer.apparentToRealOffset;
            placeRelativeWithLayer.mo2795placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m3883getXimpl(j3) + IntOffset.m3883getXimpl(jIntOffset), IntOffset.m3884getYimpl(j3) + IntOffset.m3884getYimpl(jIntOffset)), f, layerBlock);
        }
        ...
        public final void m2847placeWithLayeraW9wM(@NotNull Placeable placeWithLayer, long j, float f, @NotNull Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            Intrinsics.checkNotNullParameter(placeWithLayer, "$this$placeWithLayer");
            Intrinsics.checkNotNullParameter(layerBlock, "layerBlock");
            long j2 = placeWithLayer.apparentToRealOffset;
            placeWithLayer.mo2795placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m3883getXimpl(j2) + IntOffset.m3883getXimpl(j), IntOffset.m3884getYimpl(j2) + IntOffset.m3884getYimpl(j)), f, layerBlock);
        }
    }

    private final void onMeasuredSizeChanged() {
        this.width = RangesKt.coerceIn(IntSize.m3925getWidthimpl(this.measuredSize), Constraints.m3735getMinWidthimpl(this.measurementConstraints), Constraints.m3733getMaxWidthimpl(this.measurementConstraints));
        this.height = RangesKt.coerceIn(IntSize.m3924getHeightimpl(this.measuredSize), Constraints.m3734getMinHeightimpl(this.measurementConstraints), Constraints.m3732getMaxHeightimpl(this.measurementConstraints));
        this.apparentToRealOffset = IntOffsetKt.IntOffset((this.width - IntSize.m3925getWidthimpl(this.measuredSize)) / 2, (this.height - IntSize.m3924getHeightimpl(this.measuredSize)) / 2);
    }
    ...
    public int getMeasuredHeight() {
        return IntSize.m3924getHeightimpl(this.measuredSize);
    }
    ...
    public int getMeasuredWidth() {
        return IntSize.m3925getWidthimpl(this.measuredSize);
    }
    ...
    public abstract void mo2795placeAtf8xVGno(long position, float zIndex, @Nullable Function1<? super GraphicsLayerScope, Unit> layerBlock);

    /* JADX INFO: renamed from: setMeasuredSize-ozmzZPI, reason: not valid java name */
    public final void m2836setMeasuredSizeozmzZPI(long j) {
        if (IntSize.m3923equalsimpl0(this.measuredSize, j)) {
            return;
        }
        this.measuredSize = j;
    ...
    public final void m2837setMeasurementConstraintsBRTryo0(long j) {
        if (Constraints.m3726equalsimpl0(this.measurementConstraints, j)) {
            return;
        }
