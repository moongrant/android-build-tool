...
public final class ScaleFactor {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m2863getUnspecified_hLwfpc$annotations() {
        }

        /* JADX INFO: renamed from: getUnspecified-_hLwfpc, reason: not valid java name */
        public final long m2864getUnspecified_hLwfpc() {
    ...
    public static final /* synthetic */ ScaleFactor m2848boximpl(long j) {
        return new ScaleFactor(j);
    }

    @Stable
    /* JADX INFO: renamed from: component1-impl, reason: not valid java name */
    public static final float m2849component1impl(long j) {
        return m2857getScaleXimpl(j);
    }

    @Stable
    /* JADX INFO: renamed from: component2-impl, reason: not valid java name */
    public static final float m2850component2impl(long j) {
        return m2858getScaleYimpl(j);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m2851constructorimpl(long j) {
        return j;
    }

    /* JADX INFO: renamed from: copy-8GGzs04, reason: not valid java name */
    public static final long m2852copy8GGzs04(long j, float f, float f2) {
        return ScaleFactorKt.ScaleFactor(f, f2);
    }

    /* JADX INFO: renamed from: copy-8GGzs04$default, reason: not valid java name */
    public static /* synthetic */ long m2853copy8GGzs04$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m2857getScaleXimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m2858getScaleYimpl(j);
        }
        return m2852copy8GGzs04(j, f, f2);
    }

    @Stable
    /* JADX INFO: renamed from: div-44nBxM0, reason: not valid java name */
    public static final long m2854div44nBxM0(long j, float f) {
        return ScaleFactorKt.ScaleFactor(m2857getScaleXimpl(j) / f, m2858getScaleYimpl(j) / f);
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m2855equalsimpl(long j, Object obj) {
        return (obj instanceof ScaleFactor) && j == ((ScaleFactor) obj).getPackedValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2856equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public static final float m2857getScaleXimpl(long j) {
        if (!(j != Unspecified)) {
    ...
    public static final float m2858getScaleYimpl(long j) {
        if (!(j != Unspecified)) {
            throw new IllegalStateException("ScaleFactor is unspecified".toString());
        }
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
    ...
    public static int m2859hashCodeimpl(long j) {
        return (int) (j ^ (j >>> 32));
    }

    @Stable
    /* JADX INFO: renamed from: times-44nBxM0, reason: not valid java name */
    public static final long m2860times44nBxM0(long j, float f) {
        return ScaleFactorKt.ScaleFactor(m2857getScaleXimpl(j) * f, m2858getScaleYimpl(j) * f);
    }

    @NotNull
    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m2861toStringimpl(long j) {
        return "ScaleFactor(" + ScaleFactorKt.roundToTenths(m2857getScaleXimpl(j)) + ", " + ScaleFactorKt.roundToTenths(m2858getScaleYimpl(j)) + ')';
    }
    ...
    public int hashCode() {
        return m2859hashCodeimpl(this.packedValue);
    }

    @NotNull
    public String toString() {
        return m2861toStringimpl(this.packedValue);
    }
