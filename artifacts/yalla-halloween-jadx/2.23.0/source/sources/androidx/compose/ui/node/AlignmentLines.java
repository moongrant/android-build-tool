...
public abstract class AlignmentLines {
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        while (true) {
            jOffset = mo2878calculatePositionInParentR5De75A(initialCoordinator, jOffset);
        ...
        int iRoundToInt = alignmentLine instanceof HorizontalAlignmentLine ? MathKt.roundToInt(Offset.m1437getYimpl(jOffset)) : MathKt.roundToInt(Offset.m1436getXimpl(jOffset));
    ...
    public abstract long mo2878calculatePositionInParentR5De75A(@NotNull NodeCoordinator nodeCoordinator, long j);
