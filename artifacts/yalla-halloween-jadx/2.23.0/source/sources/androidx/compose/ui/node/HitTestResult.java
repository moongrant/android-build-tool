...
public final class HitTestResult implements List<Modifier.Node>, KMappedMarker {
    ...
    private final long m2913findBestHitDistanceptXAw2c() {
        ...
        if (i <= lastIndex) {
            while (true) {
                long jM2905constructorimpl = DistanceAndInLayer.m2905constructorimpl(this.distanceFromEdgeAndInLayer[i]);
                if (DistanceAndInLayer.m2904compareToS_HNhKs(jM2905constructorimpl, jDistanceAndInLayer) < 0) {
                    jDistanceAndInLayer = jM2905constructorimpl;
                }
                if (DistanceAndInLayer.m2908getDistanceimpl(jDistanceAndInLayer) < 0.0f && DistanceAndInLayer.m2910isInLayerimpl(jDistanceAndInLayer)) {
    ...
    public final boolean hasHit() {
        long jM2913findBestHitDistanceptXAw2c = m2913findBestHitDistanceptXAw2c();
        return DistanceAndInLayer.m2908getDistanceimpl(jM2913findBestHitDistanceptXAw2c) < 0.0f && DistanceAndInLayer.m2910isInLayerimpl(jM2913findBestHitDistanceptXAw2c);
    }
    ...
    public final boolean isHitInMinimumTouchTargetBetter(float distanceFromEdge, boolean isInLayer) {
        ...
        return DistanceAndInLayer.m2904compareToS_HNhKs(m2913findBestHitDistanceptXAw2c(), HitTestResultKt.DistanceAndInLayer(distanceFromEdge, isInLayer)) > 0;
    }
    ...
    public final void speculativeHit(@NotNull Modifier.Node node, float distanceFromEdge, boolean isInLayer, @NotNull Function0<Unit> childHitTest) {
        ...
        hitInMinimumTouchTarget(node, distanceFromEdge, isInLayer, childHitTest);
        if (this.hitDepth + 1 < CollectionsKt.getLastIndex(this) && DistanceAndInLayer.m2904compareToS_HNhKs(jM2913findBestHitDistanceptXAw2c, m2913findBestHitDistanceptXAw2c()) > 0) {
