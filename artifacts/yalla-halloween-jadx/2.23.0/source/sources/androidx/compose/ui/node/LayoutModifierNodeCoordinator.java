...
public final class LayoutModifierNodeCoordinator extends NodeCoordinator {
    ...
    public final class LookaheadDelegateForLayoutModifierNode extends LookaheadDelegate {
        ...
        public Placeable mo2794measureBRTryo0(long constraints) {
            ...
            layoutModifierNodeCoordinator.lookaheadConstraints = Constraints.m3721boximpl(constraints);
            ...
            Intrinsics.checkNotNull(lookaheadDelegate);
            set_measureResult(layoutModifierNode.mo248measure3p2s80s(this, lookaheadDelegate, constraints));
            return this;
        }
    ...
    static {
        ...
        Paint.mo1557setColor8_81llA(Color.INSTANCE.m1697getBlue0d7_KjU());
    ...
    /* JADX INFO: renamed from: measure-BRTryo0 */
    public Placeable mo2794measureBRTryo0(long constraints) {
        MeasureResult measureResultMo248measure3p2s80s;
        m2837setMeasurementConstraintsBRTryo0(constraints);
        ...
        if (layoutModifierNode instanceof IntermediateLayoutModifierNode) {
            ...
            measureResultMo248measure3p2s80s = intermediateLayoutModifierNode.m2796intermediateMeasureTeuZzU(this, wrappedNonNull, constraints, jIntSize, constraints2.getValue());
        } else {
            measureResultMo248measure3p2s80s = layoutModifierNode.mo248measure3p2s80s(this, getWrappedNonNull(), constraints);
        }
        setMeasureResult$ui_release(measureResultMo248measure3p2s80s);
        onMeasured();
        return this;
    }
    ...
    public void mo2795placeAtf8xVGno(long position, float zIndex, @Nullable Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        ...
        int iM3925getWidthimpl = IntSize.m3925getWidthimpl(getMeasuredSize());
        ...
        Placeable.PlacementScope.parentWidth = iM3925getWidthimpl;
