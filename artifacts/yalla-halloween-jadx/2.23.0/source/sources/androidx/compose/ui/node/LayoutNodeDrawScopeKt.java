...
public final class LayoutNodeDrawScopeKt {
    ...
    public static final Modifier.Node nextDrawNode(DelegatableNode delegatableNode) {
        ...
        int iM2994constructorimpl2 = NodeKind.m2994constructorimpl(2);
        Modifier.Node child = delegatableNode.getNode().getChild();
        if (child == null || (child.getAggregateChildKindSet() & iM2994constructorimpl) == 0) {
            return null;
        }
        while (child != null && (child.getKindSet() & iM2994constructorimpl2) == 0) {
