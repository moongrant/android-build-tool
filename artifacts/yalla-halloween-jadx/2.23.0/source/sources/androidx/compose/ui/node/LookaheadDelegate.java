...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public final void set_measureResult(MeasureResult measureResult) {
        ...
        if (measureResult != null) {
            m2836setMeasuredSizeozmzZPI(IntSizeKt.IntSize(measureResult.getWidth(), measureResult.getHeight()));
            unit = Unit.INSTANCE;
        } else {
            unit = null;
        }
        if (unit == null) {
            m2836setMeasuredSizeozmzZPI(IntSize.INSTANCE.m3930getZeroYbymL2g());
        }
    ...
    public final Placeable m2945performingMeasureK40F9xA(long constraints, @NotNull Function0<? extends MeasureResult> block) {
    ...
    public final void mo2795placeAtf8xVGno(long position, float zIndex, @Nullable Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        if (!IntOffset.m3882equalsimpl0(getPosition(), position)) {
            m2947setPositiongyyYBs(position);
    ...
    public final long m2946positionInBjo55l4$ui_release(@NotNull LookaheadDelegate ancestor) {
        Intrinsics.checkNotNullParameter(ancestor, "ancestor");
        long jM3893getZeronOccac = IntOffset.INSTANCE.m3893getZeronOccac();
        ...
        while (!Intrinsics.areEqual(lookaheadDelegate, ancestor)) {
            ...
            jM3893getZeronOccac = androidx.compose.foundation.lazy.OooO0o.OooO00o(position, IntOffset.m3884getYimpl(jM3893getZeronOccac), IntOffset.m3883getXimpl(position) + IntOffset.m3883getXimpl(jM3893getZeronOccac));
        ...
        return jM3893getZeronOccac;
    }

    @Override // androidx.compose.ui.node.LookaheadCapablePlaceable
    public void replace$ui_release() {
        mo2795placeAtf8xVGno(getPosition(), 0.0f, null);
    }

    /* JADX INFO: renamed from: setPosition--gyyYBs, reason: not valid java name */
    public void m2947setPositiongyyYBs(long j) {
        this.position = j;
    }
}
