...
public abstract class NodeCoordinator extends LookaheadCapablePlaceable implements Measurable, LayoutCoordinates, OwnerScope, Function1<Canvas, Unit> {
    ...
    @NotNull
    private static final float[] tmpMatrix = Matrix.m1876constructorimpl$default(null, 1, null);
    ...
    private static final HitTestSource PointerInputSource = new HitTestSource() { // from class: androidx.compose.ui.node.NodeCoordinator$Companion$PointerInputSource$1
        ...
        public void mo2989childHitTestYqVAtuI(@NotNull LayoutNode layoutNode, long pointerPosition, @NotNull HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
            Intrinsics.checkNotNullParameter(layoutNode, "layoutNode");
            Intrinsics.checkNotNullParameter(hitTestResult, "hitTestResult");
            layoutNode.m2919hitTestM_7yMNQ$ui_release(pointerPosition, hitTestResult, isTouchEvent, isInLayer);
        }

        @Override // androidx.compose.ui.node.NodeCoordinator.HitTestSource
        /* JADX INFO: renamed from: entityType-OLwlOKw, reason: not valid java name */
        public int mo2990entityTypeOLwlOKw() {
        ...
        public boolean interceptOutOfBoundsChildEvents(@org.jetbrains.annotations.NotNull androidx.compose.ui.Modifier.Node r10) {
            /*
                ...
                r0 = 16
                int r1 = androidx.compose.ui.node.NodeKind.m2994constructorimpl(r0)
                r2 = 0
                r3 = r2
            Ld:
                r4 = 0
    ...
    private static final HitTestSource SemanticsSource = new HitTestSource() { // from class: androidx.compose.ui.node.NodeCoordinator$Companion$SemanticsSource$1
        ...
        public void mo2989childHitTestYqVAtuI(@NotNull LayoutNode layoutNode, long pointerPosition, @NotNull HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
            Intrinsics.checkNotNullParameter(layoutNode, "layoutNode");
            Intrinsics.checkNotNullParameter(hitTestResult, "hitTestResult");
            layoutNode.m2920hitTestSemanticsM_7yMNQ$ui_release(pointerPosition, hitTestResult, isTouchEvent, isInLayer);
        }
    ...
    public interface HitTestSource {
        /* JADX INFO: renamed from: childHitTest-YqVAtuI */
        void mo2989childHitTestYqVAtuI(@NotNull LayoutNode layoutNode, long pointerPosition, @NotNull HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer);

        /* JADX INFO: renamed from: entityType-OLwlOKw */
        int mo2990entityTypeOLwlOKw();
    ...
    public NodeCoordinator(@NotNull LayoutNode layoutNode) {
        ...
        this.position = IntOffset.INSTANCE.m3893getZeronOccac();
    ...
    private final long m2966ancestorToLocalR5De75A(NodeCoordinator ancestor, long offset) {
        if (ancestor == this) {
            return offset;
        }
        NodeCoordinator nodeCoordinator = this.wrappedBy;
        return (nodeCoordinator == null || Intrinsics.areEqual(ancestor, nodeCoordinator)) ? m2977fromParentPositionMKHz9U(offset) : m2977fromParentPositionMKHz9U(nodeCoordinator.m2966ancestorToLocalR5De75A(ancestor, offset));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void drawContainedDrawModifiers(Canvas canvas) {
        Modifier.Node nodeM2980headH91voCI = m2980headH91voCI(NodeKind.m2994constructorimpl(4));
        if (nodeM2980headH91voCI == null) {
            performDraw(canvas);
        } else {
            getLayoutNode().getMDrawScope$ui_release().m2929drawx_KDEd0$ui_release(canvas, IntSizeKt.m3935toSizeozmzZPI(mo2801getSizeYbymL2g()), this, nodeM2980headH91voCI);
        }
    }

    private final void fromParentRect(MutableRect bounds, boolean clipBounds) {
        float fM3883getXimpl = IntOffset.m3883getXimpl(getPosition());
        bounds.setLeft(bounds.getLeft() - fM3883getXimpl);
        bounds.setRight(bounds.getRight() - fM3883getXimpl);
        float fM3884getYimpl = IntOffset.m3884getYimpl(getPosition());
        bounds.setTop(bounds.getTop() - fM3884getYimpl);
        bounds.setBottom(bounds.getBottom() - fM3884getYimpl);
        OwnedLayer ownedLayer = this.layer;
        if (ownedLayer != null) {
            ownedLayer.mapBounds(bounds, true);
            if (this.isClipping && clipBounds) {
                bounds.intersect(0.0f, 0.0f, IntSize.m3925getWidthimpl(mo2801getSizeYbymL2g()), IntSize.m3924getHeightimpl(mo2801getSizeYbymL2g()));
                bounds.isEmpty();
            }
        }
    }
    ...
    private final boolean m2967hasNodeH91voCI(int type) {
        Modifier.Node nodeHeadNode = headNode(NodeKindKt.m3003getIncludeSelfInTraversalH91voCI(type));
        return nodeHeadNode != null && DelegatableNodeKt.m2891has64DMado(nodeHeadNode, type);
    }
    ...
    public final void m2968hit1hIXUjU(final Modifier.Node node, final HitTestSource hitTestSource, final long j, final HitTestResult hitTestResult, final boolean z, final boolean z2) {
        if (node == null) {
            mo2914hitTestChildYqVAtuI(hitTestSource, j, hitTestResult, z, z2);
        } else {
            hitTestResult.hit(node, z2, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$hit$1
                ...
                /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    this.this$0.m2968hit1hIXUjU(NodeCoordinatorKt.m2992nextUntilhw7D004(node, hitTestSource.mo2990entityTypeOLwlOKw(), NodeKind.m2994constructorimpl(2)), hitTestSource, j, hitTestResult, z, z2);
                }
            });
        }
    }
    ...
    public final void m2969hitNearJHbHoSQ(final Modifier.Node node, final HitTestSource hitTestSource, final long j, final HitTestResult hitTestResult, final boolean z, final boolean z2, final float f) {
        if (node == null) {
            mo2914hitTestChildYqVAtuI(hitTestSource, j, hitTestResult, z, z2);
        } else {
            hitTestResult.hitInMinimumTouchTarget(node, f, z2, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$hitNear$1
                ...
                /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    this.this$0.m2969hitNearJHbHoSQ(NodeCoordinatorKt.m2992nextUntilhw7D004(node, hitTestSource.mo2990entityTypeOLwlOKw(), NodeKind.m2994constructorimpl(2)), hitTestSource, j, hitTestResult, z, z2, f);
                }
            });
        }
    }
    ...
    private final long m2970offsetFromEdgeMKHz9U(long pointerPosition) {
        float fM1436getXimpl = Offset.m1436getXimpl(pointerPosition);
        float fMax = Math.max(0.0f, fM1436getXimpl < 0.0f ? -fM1436getXimpl : fM1436getXimpl - getMeasuredWidth());
        float fM1437getYimpl = Offset.m1437getYimpl(pointerPosition);
        return OffsetKt.Offset(fMax, Math.max(0.0f, fM1437getYimpl < 0.0f ? -fM1437getYimpl : fM1437getYimpl - getMeasuredHeight()));
    }

    /* JADX INFO: renamed from: placeSelf-f8xVGno, reason: not valid java name */
    private final void m2971placeSelff8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        updateLayerBlock$default(this, layerBlock, false, 2, null);
        if (!IntOffset.m3882equalsimpl0(getPosition(), position)) {
            m2985setPositiongyyYBs(position);
            getLayoutNode().getLayoutDelegate().getMeasurePassDelegate().notifyChildrenUsingCoordinatesWhilePlacing();
            OwnedLayer ownedLayer = this.layer;
            if (ownedLayer != null) {
                ownedLayer.mo3042movegyyYBs(position);
            } else {
                NodeCoordinator nodeCoordinator = this.wrappedBy;
                if (nodeCoordinator != null) {
    ...
    public static /* synthetic */ Object propagateRelocationRequest$suspendImpl(NodeCoordinator nodeCoordinator, Rect rect, Continuation<? super Unit> continuation) {
        ...
        Object objPropagateRelocationRequest = nodeCoordinator2.propagateRelocationRequest(rect.m1473translatek4lQ0M(nodeCoordinator2.localBoundingBoxOf(nodeCoordinator, false).m1471getTopLeftF1C5BW0()), continuation);
    ...
    public final void m2972speculativeHitJHbHoSQ(final Modifier.Node node, final HitTestSource hitTestSource, final long j, final HitTestResult hitTestResult, final boolean z, final boolean z2, final float f) {
        if (node == null) {
            mo2914hitTestChildYqVAtuI(hitTestSource, j, hitTestResult, z, z2);
            ...
            hitTestResult.speculativeHit(node, f, z2, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$speculativeHit$1
                ...
                /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    this.this$0.m2972speculativeHitJHbHoSQ(NodeCoordinatorKt.m2992nextUntilhw7D004(node, hitTestSource.mo2990entityTypeOLwlOKw(), NodeKind.m2994constructorimpl(2)), hitTestSource, j, hitTestResult, z, z2, f);
                }
            });
        } else {
            m2972speculativeHitJHbHoSQ(NodeCoordinatorKt.m2992nextUntilhw7D004(node, hitTestSource.mo2990entityTypeOLwlOKw(), NodeKind.m2994constructorimpl(2)), hitTestSource, j, hitTestResult, z, z2, f);
        }
    }
    ...
    private final void m2973transformFromAncestorEL8BTi8(NodeCoordinator ancestor, float[] matrix) {
        if (Intrinsics.areEqual(ancestor, this)) {
            return;
        }
        NodeCoordinator nodeCoordinator = this.wrappedBy;
        Intrinsics.checkNotNull(nodeCoordinator);
        nodeCoordinator.m2973transformFromAncestorEL8BTi8(ancestor, matrix);
        if (!IntOffset.m3882equalsimpl0(getPosition(), IntOffset.INSTANCE.m3893getZeronOccac())) {
            float[] fArr = tmpMatrix;
            Matrix.m1885resetimpl(fArr);
            Matrix.m1896translateimpl$default(fArr, -IntOffset.m3883getXimpl(getPosition()), -IntOffset.m3884getYimpl(getPosition()), 0.0f, 4, null);
            Matrix.m1893timesAssign58bKbWc(matrix, fArr);
        }
        OwnedLayer ownedLayer = this.layer;
        if (ownedLayer != null) {
            ownedLayer.mo3039inverseTransform58bKbWc(matrix);
        }
    }

    /* JADX INFO: renamed from: transformToAncestor-EL8BTi8, reason: not valid java name */
    private final void m2974transformToAncestorEL8BTi8(NodeCoordinator ancestor, float[] matrix) {
        NodeCoordinator nodeCoordinator = this;
        while (!Intrinsics.areEqual(nodeCoordinator, ancestor)) {
            OwnedLayer ownedLayer = nodeCoordinator.layer;
            if (ownedLayer != null) {
                ownedLayer.mo3044transform58bKbWc(matrix);
            }
            long position = nodeCoordinator.getPosition();
            if (!IntOffset.m3882equalsimpl0(position, IntOffset.INSTANCE.m3893getZeronOccac())) {
                float[] fArr = tmpMatrix;
                Matrix.m1885resetimpl(fArr);
                Matrix.m1896translateimpl$default(fArr, IntOffset.m3883getXimpl(position), IntOffset.m3884getYimpl(position), 0.0f, 4, null);
                Matrix.m1893timesAssign58bKbWc(matrix, fArr);
            }
    ...
    private final void updateLayerParameters(boolean invokeOnLayoutChange) {
        ...
        reusableGraphicsLayerScope.m1954setSizeuvyYCjk(IntSizeKt.m3935toSizeozmzZPI(mo2801getSizeYbymL2g()));
    ...
    public final long m2975calculateMinimumTouchTargetPaddingE7KxVPU(long minimumTouchTargetSize) {
        return SizeKt.Size(Math.max(0.0f, (Size.m1505getWidthimpl(minimumTouchTargetSize) - getMeasuredWidth()) / 2.0f), Math.max(0.0f, (Size.m1502getHeightimpl(minimumTouchTargetSize) - getMeasuredHeight()) / 2.0f));
    }

    /* JADX INFO: renamed from: distanceInMinimumTouchTarget-tz77jQw, reason: not valid java name */
    public final float m2976distanceInMinimumTouchTargettz77jQw(long pointerPosition, long minimumTouchTargetSize) {
        if (getMeasuredWidth() >= Size.m1505getWidthimpl(minimumTouchTargetSize) && getMeasuredHeight() >= Size.m1502getHeightimpl(minimumTouchTargetSize)) {
            return Float.POSITIVE_INFINITY;
        }
        long jM2975calculateMinimumTouchTargetPaddingE7KxVPU = m2975calculateMinimumTouchTargetPaddingE7KxVPU(minimumTouchTargetSize);
        float fM1505getWidthimpl = Size.m1505getWidthimpl(jM2975calculateMinimumTouchTargetPaddingE7KxVPU);
        float fM1502getHeightimpl = Size.m1502getHeightimpl(jM2975calculateMinimumTouchTargetPaddingE7KxVPU);
        long jM2970offsetFromEdgeMKHz9U = m2970offsetFromEdgeMKHz9U(pointerPosition);
        if ((fM1505getWidthimpl > 0.0f || fM1502getHeightimpl > 0.0f) && Offset.m1436getXimpl(jM2970offsetFromEdgeMKHz9U) <= fM1505getWidthimpl && Offset.m1437getYimpl(jM2970offsetFromEdgeMKHz9U) <= fM1502getHeightimpl) {
            return Offset.m1435getDistanceSquaredimpl(jM2970offsetFromEdgeMKHz9U);
        }
        return Float.POSITIVE_INFINITY;
    }
    ...
    public final void draw(@NotNull Canvas canvas) {
        ...
        float fM3883getXimpl = IntOffset.m3883getXimpl(getPosition());
        float fM3884getYimpl = IntOffset.m3884getYimpl(getPosition());
        canvas.translate(fM3883getXimpl, fM3884getYimpl);
    ...
    public final void drawBorder(@NotNull Canvas canvas, @NotNull Paint paint) {
        ...
        canvas.drawRect(new Rect(0.5f, 0.5f, IntSize.m3925getWidthimpl(getMeasuredSize()) - 0.5f, IntSize.m3924getHeightimpl(getMeasuredSize()) - 0.5f), paint);
    }
    ...
    public final NodeCoordinator findCommonAncestor$ui_release(@NotNull NodeCoordinator other) {
        ...
        if (layoutNode == layoutNode2) {
            ...
            int iM2994constructorimpl = NodeKind.m2994constructorimpl(2);
            ...
            for (Modifier.Node parent$ui_release = tail2.getNode().getParent(); parent$ui_release != null; parent$ui_release = parent$ui_release.getParent()) {
                if ((parent$ui_release.getKindSet() & iM2994constructorimpl) != 0 && parent$ui_release == tail) {
                    return other;
                }
            }
            return this;
    ...
    public long m2977fromParentPositionMKHz9U(long position) {
        long jM3895minusNvtHpc = IntOffsetKt.m3895minusNvtHpc(position, getPosition());
        OwnedLayer ownedLayer = this.layer;
        return ownedLayer != null ? ownedLayer.mo3041mapOffset8S9VItk(jM3895minusNvtHpc, true) : jM3895minusNvtHpc;
    }
    ...
    public final long m2978getLastMeasurementConstraintsmsEJaDk$ui_release() {
    ...
    public final long m2979getMinimumTouchTargetSizeNHjbRc() {
        return this.layerDensity.mo325toSizeXkaWNTQ(getLayoutNode().getViewConfiguration().mo2923getMinimumTouchTargetSizeMYxV2XQ());
    }
    ...
    public java.lang.Object getParentData() {
        /*
            ...
            r1 = 64
            int r2 = androidx.compose.ui.node.NodeKind.m2994constructorimpl(r1)
            boolean r0 = r0.m2957hasH91voCI$ui_release(r2)
            r2 = 0
            if (r0 == 0) goto Lb2
            r12.getTail()
    ...
    public final long mo2801getSizeYbymL2g() {
    ...
    public final Modifier.Node m2980headH91voCI(int type) {
        boolean zM3003getIncludeSelfInTraversalH91voCI = NodeKindKt.m3003getIncludeSelfInTraversalH91voCI(type);
        Modifier.Node tail = getTail();
        if (!zM3003getIncludeSelfInTraversalH91voCI && (tail = tail.getParent()) == null) {
            return null;
        }
        for (Modifier.Node nodeHeadNode = headNode(zM3003getIncludeSelfInTraversalH91voCI); nodeHeadNode != null && (nodeHeadNode.getAggregateChildKindSet() & type) != 0; nodeHeadNode = nodeHeadNode.getChild()) {
    ...
    public final void m2981hitTestYqVAtuI(@NotNull HitTestSource hitTestSource, long pointerPosition, @NotNull HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        Intrinsics.checkNotNullParameter(hitTestSource, "hitTestSource");
        Intrinsics.checkNotNullParameter(hitTestResult, "hitTestResult");
        Modifier.Node nodeM2980headH91voCI = m2980headH91voCI(hitTestSource.mo2990entityTypeOLwlOKw());
        if (!m2988withinLayerBoundsk4lQ0M(pointerPosition)) {
            if (isTouchEvent) {
                ...
                if (((Float.isInfinite(fM2976distanceInMinimumTouchTargettz77jQw) || Float.isNaN(fM2976distanceInMinimumTouchTargettz77jQw)) ? false : true) && hitTestResult.isHitInMinimumTouchTargetBetter(fM2976distanceInMinimumTouchTargettz77jQw, false)) {
                    m2969hitNearJHbHoSQ(nodeM2980headH91voCI, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, false, fM2976distanceInMinimumTouchTargettz77jQw);
                    return;
                }
                return;
            }
        ...
        if (nodeM2980headH91voCI == null) {
            mo2914hitTestChildYqVAtuI(hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
            return;
        }
        if (m2982isPointerInBoundsk4lQ0M(pointerPosition)) {
            m2968hit1hIXUjU(nodeM2980headH91voCI, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
            return;
        }
        float fM2976distanceInMinimumTouchTargettz77jQw2 = !isTouchEvent ? Float.POSITIVE_INFINITY : m2976distanceInMinimumTouchTargettz77jQw(pointerPosition, m2979getMinimumTouchTargetSizeNHjbRc());
        if (((Float.isInfinite(fM2976distanceInMinimumTouchTargettz77jQw2) || Float.isNaN(fM2976distanceInMinimumTouchTargettz77jQw2)) ? false : true) && hitTestResult.isHitInMinimumTouchTargetBetter(fM2976distanceInMinimumTouchTargettz77jQw2, isInLayer)) {
            m2969hitNearJHbHoSQ(nodeM2980headH91voCI, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, fM2976distanceInMinimumTouchTargettz77jQw2);
        } else {
            m2972speculativeHitJHbHoSQ(nodeM2980headH91voCI, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, fM2976distanceInMinimumTouchTargettz77jQw2);
        }
    }

    /* JADX INFO: renamed from: hitTestChild-YqVAtuI */
    public void mo2914hitTestChildYqVAtuI(@NotNull HitTestSource hitTestSource, long pointerPosition, @NotNull HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        Intrinsics.checkNotNullParameter(hitTestSource, "hitTestSource");
        Intrinsics.checkNotNullParameter(hitTestResult, "hitTestResult");
        NodeCoordinator nodeCoordinator = this.wrapped;
        if (nodeCoordinator != null) {
            nodeCoordinator.m2981hitTestYqVAtuI(hitTestSource, nodeCoordinator.m2977fromParentPositionMKHz9U(pointerPosition), hitTestResult, isTouchEvent, isInLayer);
        }
    }
    ...
    public final boolean m2982isPointerInBoundsk4lQ0M(long pointerPosition) {
        float fM1436getXimpl = Offset.m1436getXimpl(pointerPosition);
        float fM1437getYimpl = Offset.m1437getYimpl(pointerPosition);
        return fM1436getXimpl >= 0.0f && fM1437getYimpl >= 0.0f && fM1436getXimpl < ((float) getMeasuredWidth()) && fM1437getYimpl < ((float) getMeasuredHeight());
    }
    ...
    public Rect localBoundingBoxOf(@NotNull LayoutCoordinates sourceCoordinates, boolean clipBounds) {
        ...
        rectCache.setRight(IntSize.m3925getWidthimpl(sourceCoordinates.mo2801getSizeYbymL2g()));
        rectCache.setBottom(IntSize.m3924getHeightimpl(sourceCoordinates.mo2801getSizeYbymL2g()));
    ...
    public long mo2802localPositionOfR5De75A(@NotNull LayoutCoordinates sourceCoordinates, long relativeToSource) {
        Intrinsics.checkNotNullParameter(sourceCoordinates, "sourceCoordinates");
        if (sourceCoordinates instanceof LookaheadLayoutCoordinatesImpl) {
            return Offset.m1445unaryMinusF1C5BW0(sourceCoordinates.mo2802localPositionOfR5De75A(this, Offset.m1445unaryMinusF1C5BW0(relativeToSource)));
        }
        NodeCoordinator coordinator = toCoordinator(sourceCoordinates);
        coordinator.onCoordinatesUsed$ui_release();
        NodeCoordinator nodeCoordinatorFindCommonAncestor$ui_release = findCommonAncestor$ui_release(coordinator);
        while (coordinator != nodeCoordinatorFindCommonAncestor$ui_release) {
            relativeToSource = coordinator.m2986toParentPositionMKHz9U(relativeToSource);
            coordinator = coordinator.wrappedBy;
            Intrinsics.checkNotNull(coordinator);
        }
        return m2966ancestorToLocalR5De75A(nodeCoordinatorFindCommonAncestor$ui_release, relativeToSource);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* JADX INFO: renamed from: localToRoot-MK-Hz9U */
    public long mo2803localToRootMKHz9U(long relativeToLocal) {
        if (!isAttached()) {
            throw new IllegalStateException(ExpectAttachedLayoutCoordinates.toString());
        }
        onCoordinatesUsed$ui_release();
        for (NodeCoordinator nodeCoordinator = this; nodeCoordinator != null; nodeCoordinator = nodeCoordinator.wrappedBy) {
            relativeToLocal = nodeCoordinator.m2986toParentPositionMKHz9U(relativeToLocal);
        }
    ...
    public long mo2804localToWindowMKHz9U(long relativeToLocal) {
        return LayoutNodeKt.requireOwner(getLayoutNode()).mo3047calculatePositionInWindowMKHz9U(mo2803localToRootMKHz9U(relativeToLocal));
    }
    ...
    public void onMeasureResultChanged(int r10, int r11) {
        ...
        L13:
            ...
            r9.m2836setMeasuredSizeozmzZPI(r10)
            r10 = 0
            r9.updateLayerParameters(r10)
            r11 = 4
            int r11 = androidx.compose.ui.node.NodeKind.m2994constructorimpl(r11)
            boolean r0 = androidx.compose.ui.node.NodeKindKt.m3003getIncludeSelfInTraversalH91voCI(r11)
    ...
    public final void onMeasured() {
        /*
            ...
            int r1 = androidx.compose.ui.node.NodeKind.m2994constructorimpl(r0)
            boolean r1 = r13.m2967hasNodeH91voCI(r1)
            if (r1 == 0) goto Lc1
            ...
            int r0 = androidx.compose.ui.node.NodeKind.m2994constructorimpl(r0)     // Catch: java.lang.Throwable -> Lb7
            boolean r3 = androidx.compose.ui.node.NodeKindKt.m3003getIncludeSelfInTraversalH91voCI(r0)     // Catch: java.lang.Throwable -> Lb7
            if (r3 == 0) goto L25
        ...
        L48:
            ...
            r6.mo224onRemeasuredozmzZPI(r8)     // Catch: java.lang.Throwable -> Lb7
            goto La2
        L58:
    ...
    public final void onPlaced() {
        /*
            r11 = this;
            r0 = 128(0x80, float:1.794E-43)
            int r0 = androidx.compose.ui.node.NodeKind.m2994constructorimpl(r0)
            boolean r1 = androidx.compose.ui.node.NodeKindKt.m3003getIncludeSelfInTraversalH91voCI(r0)
    ...
    public final Placeable m2983performingMeasureK40F9xA(long constraints, @NotNull Function0<? extends Placeable> block) {
    ...
    public void mo2795placeAtf8xVGno(long position, float zIndex, @Nullable Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        m2971placeSelff8xVGno(position, zIndex, layerBlock);
    }

    /* JADX INFO: renamed from: placeSelfApparentToRealOffset-f8xVGno, reason: not valid java name */
    public final void m2984placeSelfApparentToRealOffsetf8xVGno(long position, float zIndex, @Nullable Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        long jM2833getApparentToRealOffsetnOccac = getApparentToRealOffset();
        m2971placeSelff8xVGno(androidx.compose.foundation.lazy.OooO0o.OooO00o(jM2833getApparentToRealOffsetnOccac, IntOffset.m3884getYimpl(position), IntOffset.m3883getXimpl(jM2833getApparentToRealOffsetnOccac) + IntOffset.m3883getXimpl(position)), zIndex, layerBlock);
    }
        ...
        if (ownedLayer != null) {
            if (this.isClipping) {
                if (clipToMinimumTouchTargetSize) {
                    long jM2979getMinimumTouchTargetSizeNHjbRc = m2979getMinimumTouchTargetSizeNHjbRc();
                    float fM1505getWidthimpl = Size.m1505getWidthimpl(jM2979getMinimumTouchTargetSizeNHjbRc) / 2.0f;
                    float fM1502getHeightimpl = Size.m1502getHeightimpl(jM2979getMinimumTouchTargetSizeNHjbRc) / 2.0f;
                    bounds.intersect(-fM1505getWidthimpl, -fM1502getHeightimpl, IntSize.m3925getWidthimpl(mo2801getSizeYbymL2g()) + fM1505getWidthimpl, IntSize.m3924getHeightimpl(mo2801getSizeYbymL2g()) + fM1502getHeightimpl);
                } else if (clipBounds) {
                    bounds.intersect(0.0f, 0.0f, IntSize.m3925getWidthimpl(mo2801getSizeYbymL2g()), IntSize.m3924getHeightimpl(mo2801getSizeYbymL2g()));
                }
                if (bounds.isEmpty()) {
    ...
    public void replace$ui_release() {
        mo2795placeAtf8xVGno(getPosition(), this.zIndex, this.layerBlock);
    }
    ...
    public void m2985setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public final boolean shouldSharePointerInputWithSiblings() {
        /*
            ...
            r0 = 16
            int r1 = androidx.compose.ui.node.NodeKind.m2994constructorimpl(r0)
            boolean r1 = androidx.compose.ui.node.NodeKindKt.m3003getIncludeSelfInTraversalH91voCI(r1)
            androidx.compose.ui.Modifier$Node r1 = r11.headNode(r1)
            r2 = 0
            if (r1 != 0) goto L12
            return r2
        L12:
            int r3 = androidx.compose.ui.node.NodeKind.m2994constructorimpl(r0)
    ...
    public long m2986toParentPositionMKHz9U(long position) {
        OwnedLayer ownedLayer = this.layer;
        if (ownedLayer != null) {
            position = ownedLayer.mo3041mapOffset8S9VItk(position, false);
        }
        return IntOffsetKt.m3897plusNvtHpc(position, getPosition());
    }
    ...
    public final Rect touchBoundsInRoot() {
        ...
        MutableRect rectCache = getRectCache();
        long jM2975calculateMinimumTouchTargetPaddingE7KxVPU = m2975calculateMinimumTouchTargetPaddingE7KxVPU(m2979getMinimumTouchTargetSizeNHjbRc());
        rectCache.setLeft(-Size.m1505getWidthimpl(jM2975calculateMinimumTouchTargetPaddingE7KxVPU));
        rectCache.setTop(-Size.m1502getHeightimpl(jM2975calculateMinimumTouchTargetPaddingE7KxVPU));
        rectCache.setRight(Size.m1505getWidthimpl(jM2975calculateMinimumTouchTargetPaddingE7KxVPU) + getMeasuredWidth());
        rectCache.setBottom(Size.m1502getHeightimpl(jM2975calculateMinimumTouchTargetPaddingE7KxVPU) + getMeasuredHeight());
        NodeCoordinator nodeCoordinator = this;
    ...
    public void mo2805transformFromEL8BTi8(@NotNull LayoutCoordinates sourceCoordinates, @NotNull float[] matrix) {
        Intrinsics.checkNotNullParameter(sourceCoordinates, "sourceCoordinates");
        ...
        coordinator.m2974transformToAncestorEL8BTi8(nodeCoordinatorFindCommonAncestor$ui_release, matrix);
        m2973transformFromAncestorEL8BTi8(nodeCoordinatorFindCommonAncestor$ui_release, matrix);
    }
    ...
    public final void updateLayerBlock(@Nullable Function1<? super GraphicsLayerScope, Unit> layerBlock, boolean forceUpdateLayerParameters) {
        ...
        ownedLayerCreateLayer.mo3043resizeozmzZPI(getMeasuredSize());
        ownedLayerCreateLayer.mo3042movegyyYBs(getPosition());
    ...
    public final /* synthetic */ <T> void m2987visitNodesaLcG6gQ(int type, Function1<? super T, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        boolean zM3003getIncludeSelfInTraversalH91voCI = NodeKindKt.m3003getIncludeSelfInTraversalH91voCI(type);
        Modifier.Node tail = getTail();
        if (!zM3003getIncludeSelfInTraversalH91voCI && (tail = tail.getParent()) == null) {
    ...
    public long mo2806windowToLocalMKHz9U(long relativeToWindow) {
        if (!isAttached()) {
            throw new IllegalStateException(ExpectAttachedLayoutCoordinates.toString());
        }
        LayoutCoordinates layoutCoordinatesFindRootCoordinates = LayoutCoordinatesKt.findRootCoordinates(this);
        return mo2802localPositionOfR5De75A(layoutCoordinatesFindRootCoordinates, Offset.m1440minusMKHz9U(LayoutNodeKt.requireOwner(getLayoutNode()).mo3046calculateLocalPositionMKHz9U(relativeToWindow), LayoutCoordinatesKt.positionInRoot(layoutCoordinatesFindRootCoordinates)));
    }
    ...
    public final boolean m2988withinLayerBoundsk4lQ0M(long pointerPosition) {
        if (!OffsetKt.m1453isFinitek4lQ0M(pointerPosition)) {
            return false;
        }
        OwnedLayer ownedLayer = this.layer;
        return ownedLayer == null || !this.isClipping || ownedLayer.mo3040isInLayerk4lQ0M(pointerPosition);
    }
