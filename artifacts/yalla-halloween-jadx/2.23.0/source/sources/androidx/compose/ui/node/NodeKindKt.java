...
public final class NodeKindKt {
    ...
    private static final void autoInvalidateNodeSelf(Modifier.Node node, int i, int i2) {
        if (i2 != 0 || node.getShouldAutoInvalidate()) {
            if (((NodeKind.m2994constructorimpl(2) & i) != 0) && (node instanceof LayoutModifierNode)) {
                LayoutModifierNodeKt.invalidateMeasurement((LayoutModifierNode) node);
                if (i2 == 2) {
                    DelegatableNodeKt.m2893requireCoordinator64DMado(node, NodeKind.m2994constructorimpl(2)).onRelease();
                }
            }
            if (((NodeKind.m2994constructorimpl(PSKKeyManager.MAX_KEY_LENGTH_BYTES) & i) != 0) && (node instanceof GlobalPositionAwareModifierNode)) {
                DelegatableNodeKt.requireLayoutNode(node).invalidateMeasurements$ui_release();
            }
            if (((NodeKind.m2994constructorimpl(4) & i) != 0) && (node instanceof DrawModifierNode)) {
                DrawModifierNodeKt.invalidateDraw((DrawModifierNode) node);
            }
            if (((NodeKind.m2994constructorimpl(8) & i) != 0) && (node instanceof SemanticsModifierNode)) {
                SemanticsModifierNodeKt.invalidateSemantics((SemanticsModifierNode) node);
            }
            if (((NodeKind.m2994constructorimpl(64) & i) != 0) && (node instanceof ParentDataModifierNode)) {
                ParentDataModifierNodeKt.invalidateParentData((ParentDataModifierNode) node);
            }
            if (((NodeKind.m2994constructorimpl(LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) & i) != 0) && (node instanceof FocusTargetNode)) {
                if (i2 == 2) {
                    node.onReset();
                } else {
            ...
            if (((NodeKind.m2994constructorimpl(2048) & i) != 0) && (node instanceof FocusPropertiesModifierNode)) {
            ...
            if (((i & NodeKind.m2994constructorimpl(4096)) != 0) && (node instanceof FocusEventModifierNode)) {
    ...
    public static final int calculateNodeKindSetFrom(@NotNull Modifier.Node node) {
        ...
        int iM2994constructorimpl = NodeKind.m2994constructorimpl(1);
        if (node instanceof LayoutModifierNode) {
            iM2994constructorimpl |= NodeKind.m2994constructorimpl(2);
        }
        if (node instanceof DrawModifierNode) {
            iM2994constructorimpl |= NodeKind.m2994constructorimpl(4);
        }
        if (node instanceof SemanticsModifierNode) {
            iM2994constructorimpl |= NodeKind.m2994constructorimpl(8);
        }
        if (node instanceof PointerInputModifierNode) {
            iM2994constructorimpl |= NodeKind.m2994constructorimpl(16);
        }
        if (node instanceof ModifierLocalModifierNode) {
            iM2994constructorimpl |= NodeKind.m2994constructorimpl(32);
        }
        if (node instanceof ParentDataModifierNode) {
            iM2994constructorimpl |= NodeKind.m2994constructorimpl(64);
        }
        if (node instanceof LayoutAwareModifierNode) {
            iM2994constructorimpl |= NodeKind.m2994constructorimpl(128);
        }
        if (node instanceof GlobalPositionAwareModifierNode) {
            iM2994constructorimpl |= NodeKind.m2994constructorimpl(PSKKeyManager.MAX_KEY_LENGTH_BYTES);
        }
        if (node instanceof IntermediateLayoutModifierNode) {
            iM2994constructorimpl |= NodeKind.m2994constructorimpl(ConstantsKt.MINIMUM_BLOCK_SIZE);
        }
        if (node instanceof FocusTargetNode) {
            iM2994constructorimpl |= NodeKind.m2994constructorimpl(LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY);
        }
        if (node instanceof FocusPropertiesModifierNode) {
            iM2994constructorimpl |= NodeKind.m2994constructorimpl(2048);
        }
        if (node instanceof FocusEventModifierNode) {
            iM2994constructorimpl |= NodeKind.m2994constructorimpl(4096);
        }
        if (node instanceof KeyInputModifierNode) {
            iM2994constructorimpl |= NodeKind.m2994constructorimpl(8192);
        }
        if (node instanceof RotaryInputModifierNode) {
            iM2994constructorimpl |= NodeKind.m2994constructorimpl(16384);
        }
        if (node instanceof CompositionLocalConsumerModifierNode) {
            iM2994constructorimpl |= NodeKind.m2994constructorimpl(ShareRequest.THUMB_DATA_SIZE_LIMIT);
        }
        return node instanceof SoftKeyboardInterceptionModifierNode ? iM2994constructorimpl | NodeKind.m2994constructorimpl(131072) : iM2994constructorimpl;
    }
    ...
    public static final boolean m3002contains64DMado(int i, int i2) {
        return (i & i2) != 0;
    }

    /* JADX INFO: renamed from: getIncludeSelfInTraversal-H91voCI, reason: not valid java name */
    public static final boolean m3003getIncludeSelfInTraversalH91voCI(int i) {
        return (i & NodeKind.m2994constructorimpl(128)) != 0;
    }
    ...
    public static final int m3004or64DMado(int i, int i2) {
        return i | i2;
    }
    ...
    public static final int calculateNodeKindSetFrom(@NotNull Modifier.Element element) {
        ...
        return ((element instanceof OnPlacedModifier) || (element instanceof OnRemeasuredModifier)) ? iM2994constructorimpl | NodeKind.m2994constructorimpl(128) : iM2994constructorimpl;
    }
}
