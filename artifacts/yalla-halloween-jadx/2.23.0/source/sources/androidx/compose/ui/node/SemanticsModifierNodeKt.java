...
public final class SemanticsModifierNodeKt {
    ...
    public static final Rect touchBoundsInRoot(@NotNull Modifier.Node node, boolean z) {
        ...
        if (node.getNode().getIsAttached()) {
            return !z ? LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m2893requireCoordinator64DMado(node, NodeKind.m2994constructorimpl(8))) : DelegatableNodeKt.m2893requireCoordinator64DMado(node, NodeKind.m2994constructorimpl(8)).touchBoundsInRoot();
        }
