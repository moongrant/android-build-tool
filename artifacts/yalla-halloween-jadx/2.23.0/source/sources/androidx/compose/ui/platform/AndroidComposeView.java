...
public final class AndroidComposeView extends ViewGroup implements Owner, ViewRootForTest, PositionCalculator, DefaultLifecycleObserver {
    ...
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0007\b\u0007\u0018\u00002\u00020\u0001B\u0017\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\b\u001a\u00020\u0007¢\u0006\u0004\b\f\u0010\rR\u0017\u0010\u0003\u001a\u00020\u00028\u0006¢\u0006\f\n\u0004\b\u0003\u0010\u0004\u001a\u0004\b\u0005\u0010\u0006R\u0017\u0010\b\u001a\u00020\u00078\u0006¢\u0006\f\n\u0004\b\b\u0010\t\u001a\u0004\b\n\u0010\u000b¨\u0006\u000e"}, d2 = {"Landroidx/compose/ui/platform/AndroidComposeView$ViewTreeOwners;", "", "Landroidx/lifecycle/LifecycleOwner;", "lifecycleOwner", "Landroidx/lifecycle/LifecycleOwner;", "getLifecycleOwner", "()Landroidx/lifecycle/LifecycleOwner;", "Lo000OO00/OooO0o;", "savedStateRegistryOwner", "Lo000OO00/OooO0o;", "getSavedStateRegistryOwner", "()Lo000OO00/OooO0o;", "<init>", "(Landroidx/lifecycle/LifecycleOwner;Lo000OO00/OooO0o;)V", "ui_release"}, k = 1, mv = {1, 8, 0})
    public static final class ViewTreeOwners {
        ...
        @NotNull
        private final o000OO00.OooO0o savedStateRegistryOwner;

        public ViewTreeOwners(@NotNull LifecycleOwner lifecycleOwner, @NotNull o000OO00.OooO0o savedStateRegistryOwner) {
        ...
        @NotNull
        public final o000OO00.OooO0o getSavedStateRegistryOwner() {
    ...
    public AndroidComposeView(@NotNull Context context, @NotNull CoroutineContext coroutineContext) {
        ...
        this.lastDownPointerPosition = companion.m1451getUnspecifiedF1C5BW0();
        ...
        Modifier modifierOnKeyEvent = KeyInputModifierKt.onKeyEvent(companion2, new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m3074invokeZmokQxo(keyEvent.m2564unboximpl());
            }

            @NotNull
            /* JADX INFO: renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m3074invokeZmokQxo(@NotNull android.view.KeyEvent it) {
                Intrinsics.checkNotNullParameter(it, "it");
                FocusDirection focusDirectionMo3048getFocusDirectionP8AzH3I = this.this$0.mo3048getFocusDirectionP8AzH3I(it);
                return (focusDirectionMo3048getFocusDirectionP8AzH3I == null || !KeyEventType.m2568equalsimpl0(KeyEvent_androidKt.m2576getTypeZmokQxo(it), KeyEventType.INSTANCE.m2572getKeyDownCS__XNY())) ? Boolean.FALSE : Boolean.valueOf(this.this$0.getFocusOwner().mo1373moveFocus3ESFkO8(focusDirectionMo3048getFocusDirectionP8AzH3I.getValue()));
            }
        });
        ...
        this.viewToWindowMatrix = Matrix.m1876constructorimpl$default(null, 1, null);
        this.windowToViewMatrix = Matrix.m1876constructorimpl$default(null, 1, null);
        this.lastMatrixRecalculationAnimationTime = -1L;
        this.windowPosition = companion.m1450getInfiniteF1C5BW0();
        ...
        this.globalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() { // from class: androidx.compose.ui.platform.OooO0o
            ...
            public final void onGlobalLayout() {
                AndroidComposeView.globalLayoutListener$lambda$1(this.f4174OooO0Oo);
            }
        };
        this.scrollChangedListener = new ViewTreeObserver.OnScrollChangedListener() { // from class: androidx.compose.ui.platform.OooO
            ...
            public final void onScrollChanged() {
                AndroidComposeView.scrollChangedListener$lambda$2(this.f4173OooO0Oo);
            }
        };
        this.touchModeChangeListener = new ViewTreeObserver.OnTouchModeChangeListener() { // from class: androidx.compose.ui.platform.OooOO0
            ...
            public final void onTouchModeChanged(boolean z) {
                AndroidComposeView.touchModeChangeListener$lambda$3(this.f4175OooO0Oo, z);
            }
        };
        ...
        this._inputModeManager = new InputModeManagerImpl(isInTouchMode() ? InputMode.INSTANCE.m2258getTouchaOaMEAU() : InputMode.INSTANCE.m2257getKeyboardaOaMEAU(), new Function1<InputMode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$_inputModeManager$1
            {
                super(1);
            }
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(InputMode inputMode) {
                return m3073invokeiuPiT84(inputMode.getValue());
            }

            @NotNull
            /* JADX INFO: renamed from: invoke-iuPiT84, reason: not valid java name */
            public final Boolean m3073invokeiuPiT84(int i) {
                boolean zRequestFocusFromTouch;
                InputMode.Companion companion3 = InputMode.INSTANCE;
                if (InputMode.m2253equalsimpl0(i, companion3.m2258getTouchaOaMEAU())) {
                    zRequestFocusFromTouch = this.this$0.isInTouchMode();
                } else if (InputMode.m2253equalsimpl0(i, companion3.m2257getKeyboardaOaMEAU())) {
        ...
        this.sendHoverExitEvent = new OooOO0O(this, objArr2 == true ? 1 : 0);
    ...
    private final int m3067component1VKZWuLQ(long j) {
        return (int) ULong.m4387constructorimpl(j >>> 32);
    }

    /* JADX INFO: renamed from: component2-VKZWuLQ, reason: not valid java name */
    private final int m3068component2VKZWuLQ(long j) {
        return (int) ULong.m4387constructorimpl(j & 4294967295L);
    }

    /* JADX INFO: renamed from: convertMeasureSpec-I7RO_PI, reason: not valid java name */
    private final long m3069convertMeasureSpecI7RO_PI(int measureSpec) {
        int mode = View.MeasureSpec.getMode(measureSpec);
        int size = View.MeasureSpec.getSize(measureSpec);
        if (mode == Integer.MIN_VALUE) {
            return m3071packZIaKswc(0, size);
        }
        if (mode == 0) {
            return m3071packZIaKswc(0, Integer.MAX_VALUE);
        }
        if (mode == 1073741824) {
            return m3071packZIaKswc(size, size);
        }
    ...
    private final int m3070handleMotionEvent8iAsVTc(MotionEvent motionEvent) {
        ...
        try {
            ...
            try {
                ...
                int iM3072sendMotionEvent8iAsVTc = m3072sendMotionEvent8iAsVTc(motionEvent);
                Trace.endSection();
                this.forceUseMatrixCache = false;
                return iM3072sendMotionEvent8iAsVTc;
            } catch (Throwable th) {
                Trace.endSection();
                throw th;
            }
    ...
    private final boolean handleRotaryEvent(MotionEvent event) {
        ...
        if (i >= 26) {
            ...
            fOooO00o = androidx.core.view.o0000OO0.OooO00o.OooO0O0(viewConfiguration);
        } else {
            fOooO00o = androidx.core.view.o0000OO0.OooO00o(viewConfiguration, context);
        }
        return getFocusOwner().dispatchRotaryEvent(new RotaryScrollEvent(fOooO00o * f, (i >= 26 ? androidx.core.view.o0000OO0.OooO00o.OooO00o(viewConfiguration) : androidx.core.view.o0000OO0.OooO00o(viewConfiguration, getContext())) * f, event.getEventTime()));
    }
    ...
    private final long m3071packZIaKswc(int a, int b) {
        return ULong.m4387constructorimpl(ULong.m4387constructorimpl(b) | ULong.m4387constructorimpl(ULong.m4387constructorimpl(a) << 32));
    }
    ...
    private final void recalculateWindowViewTransforms() {
        this.matrixToWindow.mo3082calculateMatrixToWindowEL8BTi8(this, this.viewToWindowMatrix);
        InvertMatrixKt.m3106invertToJiSxe2E(this.viewToWindowMatrix, this.windowToViewMatrix);
    }
    ...
    public static final void sendHoverExitEvent$lambda$5(AndroidComposeView this$0) {
        ...
        this$0.m3072sendMotionEvent8iAsVTc(motionEvent);
    }

    /* JADX INFO: renamed from: sendMotionEvent-8iAsVTc, reason: not valid java name */
    private final int m3072sendMotionEvent8iAsVTc(MotionEvent motionEvent) {
        PointerInputEventData pointerInputEventData;
        if (this.keyboardModifiersRequireUpdate) {
            this.keyboardModifiersRequireUpdate = false;
            this._windowInfo.m3137setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m2738constructorimpl(motionEvent.getMetaState()));
        }
        ...
        if (pointerInputEventData2 != null) {
            this.lastDownPointerPosition = pointerInputEventData2.m2703getPositionF1C5BW0();
        }
        int iM2708processBIzXfog = this.pointerInputEventProcessor.m2708processBIzXfog(pointerInputEventConvertToPointerInputEvent$ui_release, this, isInBounds(motionEvent));
        int actionMasked = motionEvent.getActionMasked();
        if ((actionMasked != 0 && actionMasked != 5) || ProcessResult.m2763getDispatchedToAPointerInputModifierimpl(iM2708processBIzXfog)) {
            return iM2708processBIzXfog;
        }
    ...
    public final void sendSimulatedEvent(MotionEvent motionEvent, int action, long eventTime, boolean forceHover) {
        ...
        while (i3 < pointerCount) {
            ...
            long jMo2756localToScreenMKHz9U = mo2756localToScreenMKHz9U(OffsetKt.Offset(pointerCoords.x, pointerCoords.y));
            pointerCoords.x = Offset.m1436getXimpl(jMo2756localToScreenMKHz9U);
            pointerCoords.y = Offset.m1437getYimpl(jMo2756localToScreenMKHz9U);
            i3++;
        }
        ...
        this.pointerInputEventProcessor.m2708processBIzXfog(pointerInputEventConvertToPointerInputEvent$ui_release, this, true);
        event.recycle();
    }
    ...
    public static final void touchModeChangeListener$lambda$3(AndroidComposeView this$0, boolean z) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0._inputModeManager.m2261setInputModeiuPiT84(z ? InputMode.INSTANCE.m2258getTouchaOaMEAU() : InputMode.INSTANCE.m2257getKeyboardaOaMEAU());
    }

    private final void updatePositionCacheAndDispatch() {
        getLocationOnScreen(this.tmpPositionArray);
        long j = this.globalPosition;
        int iM3875component1impl = IntOffset.m3875component1impl(j);
        int iM3876component2impl = IntOffset.m3876component2impl(j);
        int[] iArr = this.tmpPositionArray;
        boolean z = false;
        int i = iArr[0];
        if (iM3875component1impl != i || iM3876component2impl != iArr[1]) {
            this.globalPosition = IntOffsetKt.IntOffset(i, iArr[1]);
            if (iM3875component1impl != Integer.MAX_VALUE && iM3876component2impl != Integer.MAX_VALUE) {
    ...
    public final void addAndroidView(@NotNull AndroidViewHolder view, @NotNull final LayoutNode layoutNode) {
        ...
        ViewCompat.OooOOOO(view, new androidx.core.view.OooO00o() { // from class: androidx.compose.ui.platform.AndroidComposeView.addAndroidView.1
            ...
            public void onInitializeAccessibilityNodeInfo(@NotNull View host, @NotNull o0000O.o0Oo0oo info) {
                ...
                info.f34023OooO0O0 = iIntValue;
                info.f34022OooO00o.setParent(androidComposeView, iIntValue);
    ...
    public long mo3046calculateLocalPositionMKHz9U(long positionInWindow) {
        recalculateWindowPosition();
        return Matrix.m1882mapMKHz9U(this.windowToViewMatrix, positionInWindow);
    }

    @Override // androidx.compose.ui.node.Owner
    /* JADX INFO: renamed from: calculatePositionInWindow-MK-Hz9U */
    public long mo3047calculatePositionInWindowMKHz9U(long localPosition) {
        recalculateWindowPosition();
        return Matrix.m1882mapMKHz9U(this.viewToWindowMatrix, localPosition);
    }

    @Override // android.view.View
    public boolean canScrollHorizontally(int direction) {
        return this.accessibilityDelegate.m3075canScroll0AR0LA0$ui_release(false, direction, this.lastDownPointerPosition);
    }

    @Override // android.view.View
    public boolean canScrollVertically(int direction) {
        return this.accessibilityDelegate.m3075canScroll0AR0LA0$ui_release(true, direction, this.lastDownPointerPosition);
    }
    ...
    public boolean dispatchGenericMotionEvent(@NotNull MotionEvent event) {
        ...
        return (isBadMotionEvent(event) || !isAttachedToWindow()) ? super.dispatchGenericMotionEvent(event) : ProcessResult.m2763getDispatchedToAPointerInputModifierimpl(m3070handleMotionEvent8iAsVTc(event));
    }
    ...
    public boolean dispatchHoverEvent(@NotNull MotionEvent event) {
        ...
        return ProcessResult.m2763getDispatchedToAPointerInputModifierimpl(m3070handleMotionEvent8iAsVTc(event));
    }
    ...
    public boolean dispatchKeyEvent(@NotNull android.view.KeyEvent event) {
        ...
        this._windowInfo.m3137setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m2738constructorimpl(event.getMetaState()));
        return getFocusOwner().mo1375dispatchKeyEventZmokQxo(KeyEvent.m2559constructorimpl(event)) || super.dispatchKeyEvent(event);
    }

    @Override // android.view.ViewGroup, android.view.View
    public boolean dispatchKeyEventPreIme(@NotNull android.view.KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
        return (isFocused() && getFocusOwner().mo1374dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent.m2559constructorimpl(event))) || super.dispatchKeyEventPreIme(event);
    }
    ...
    public boolean dispatchTouchEvent(@NotNull MotionEvent motionEvent) {
        ...
        int iM3070handleMotionEvent8iAsVTc = m3070handleMotionEvent8iAsVTc(motionEvent);
        if (ProcessResult.m2762getAnyMovementConsumedimpl(iM3070handleMotionEvent8iAsVTc)) {
            getParent().requestDisallowInterceptTouchEvent(true);
        }
        return ProcessResult.m2763getDispatchedToAPointerInputModifierimpl(iM3070handleMotionEvent8iAsVTc);
    }
    ...
    public FocusDirection mo3048getFocusDirectionP8AzH3I(@NotNull android.view.KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        long jM2575getKeyZmokQxo = KeyEvent_androidKt.m2575getKeyZmokQxo(keyEvent);
        Key.Companion companion = Key.INSTANCE;
        if (Key.m2267equalsimpl0(jM2575getKeyZmokQxo, companion.m2503getTabEK5gGoQ())) {
            return FocusDirection.m1352boximpl(KeyEvent_androidKt.m2581isShiftPressedZmokQxo(keyEvent) ? FocusDirection.INSTANCE.m1370getPreviousdhqQ8s() : FocusDirection.INSTANCE.m1368getNextdhqQ8s());
        }
        if (Key.m2267equalsimpl0(jM2575getKeyZmokQxo, companion.m2344getDirectionRightEK5gGoQ())) {
            return FocusDirection.m1352boximpl(FocusDirection.INSTANCE.m1371getRightdhqQ8s());
        }
        if (Key.m2267equalsimpl0(jM2575getKeyZmokQxo, companion.m2343getDirectionLeftEK5gGoQ())) {
            return FocusDirection.m1352boximpl(FocusDirection.INSTANCE.m1367getLeftdhqQ8s());
        }
        if (Key.m2267equalsimpl0(jM2575getKeyZmokQxo, companion.m2345getDirectionUpEK5gGoQ())) {
            return FocusDirection.m1352boximpl(FocusDirection.INSTANCE.m1372getUpdhqQ8s());
        }
        if (Key.m2267equalsimpl0(jM2575getKeyZmokQxo, companion.m2340getDirectionDownEK5gGoQ())) {
            return FocusDirection.m1352boximpl(FocusDirection.INSTANCE.m1363getDowndhqQ8s());
        }
        if (Key.m2267equalsimpl0(jM2575getKeyZmokQxo, companion.m2339getDirectionCenterEK5gGoQ()) ? true : Key.m2267equalsimpl0(jM2575getKeyZmokQxo, companion.m2353getEnterEK5gGoQ()) ? true : Key.m2267equalsimpl0(jM2575getKeyZmokQxo, companion.m2445getNumPadEnterEK5gGoQ())) {
            return FocusDirection.m1352boximpl(FocusDirection.INSTANCE.m1364getEnterdhqQ8s());
        }
        if (Key.m2267equalsimpl0(jM2575getKeyZmokQxo, companion.m2282getBackEK5gGoQ()) ? true : Key.m2267equalsimpl0(jM2575getKeyZmokQxo, companion.m2356getEscapeEK5gGoQ())) {
            return FocusDirection.m1352boximpl(FocusDirection.INSTANCE.m1365getExitdhqQ8s());
        }
        return null;
    }
    ...
    public long mo2756localToScreenMKHz9U(long localPosition) {
        recalculateWindowPosition();
        long jM1882mapMKHz9U = Matrix.m1882mapMKHz9U(this.viewToWindowMatrix, localPosition);
        return OffsetKt.Offset(Offset.m1436getXimpl(this.windowPosition) + Offset.m1436getXimpl(jM1882mapMKHz9U), Offset.m1437getYimpl(this.windowPosition) + Offset.m1437getYimpl(jM1882mapMKHz9U));
    }
    ...
    public void mo3049measureAndLayout0kLqBqw(@NotNull LayoutNode layoutNode, long constraints) {
        Intrinsics.checkNotNullParameter(layoutNode, "layoutNode");
        Trace.beginSection("AndroidOwner:measureAndLayout");
        try {
            this.measureAndLayoutDelegate.m2950measureAndLayout0kLqBqw(layoutNode, constraints);
    ...
    public void onAttachedToWindow() {
        ...
        o000OO00.OooO0o oooO0oOooO00o = o000OO00.OooO.OooO00o(this);
        ViewTreeOwners viewTreeOwners = getViewTreeOwners();
        ...
        this._inputModeManager.m2261setInputModeiuPiT84(isInTouchMode() ? InputMode.INSTANCE.m2258getTouchaOaMEAU() : InputMode.INSTANCE.m2257getKeyboardaOaMEAU());
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        try {
            ...
            long jM3069convertMeasureSpecI7RO_PI = m3069convertMeasureSpecI7RO_PI(widthMeasureSpec);
            int iM4387constructorimpl = (int) ULong.m4387constructorimpl(jM3069convertMeasureSpecI7RO_PI >>> 32);
            int iM4387constructorimpl2 = (int) ULong.m4387constructorimpl(jM3069convertMeasureSpecI7RO_PI & 4294967295L);
            long jM3069convertMeasureSpecI7RO_PI2 = m3069convertMeasureSpecI7RO_PI(heightMeasureSpec);
            long jConstraints = ConstraintsKt.Constraints(iM4387constructorimpl, iM4387constructorimpl2, (int) ULong.m4387constructorimpl(jM3069convertMeasureSpecI7RO_PI2 >>> 32), (int) ULong.m4387constructorimpl(4294967295L & jM3069convertMeasureSpecI7RO_PI2));
            Constraints constraints = this.onMeasureConstraints;
            boolean zM3726equalsimpl0 = false;
            if (constraints == null) {
                this.onMeasureConstraints = Constraints.m3721boximpl(jConstraints);
                this.wasMeasuredWithMultipleConstraints = false;
            } else {
                if (constraints != null) {
                    zM3726equalsimpl0 = Constraints.m3726equalsimpl0(constraints.getValue(), jConstraints);
                }
                if (!zM3726equalsimpl0) {
                    this.wasMeasuredWithMultipleConstraints = true;
                }
            }
            this.measureAndLayoutDelegate.m2951updateRootConstraintsBRTryo0(jConstraints);
    ...
    public long mo2757screenToLocalMKHz9U(long positionOnScreen) {
        recalculateWindowPosition();
        return Matrix.m1882mapMKHz9U(this.windowToViewMatrix, OffsetKt.Offset(Offset.m1436getXimpl(positionOnScreen) - Offset.m1436getXimpl(this.windowPosition), Offset.m1437getYimpl(positionOnScreen) - Offset.m1437getYimpl(this.windowPosition)));
    }

    @Override // androidx.compose.ui.node.RootForTest
    /* JADX INFO: renamed from: sendKeyEvent-ZmokQxo */
    public boolean mo3050sendKeyEventZmokQxo(@NotNull android.view.KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        return getFocusOwner().mo1374dispatchInterceptedSoftKeyboardEventZmokQxo(keyEvent) || getFocusOwner().mo1375dispatchKeyEventZmokQxo(keyEvent);
    }
    ...
    private final void recalculateWindowPosition(MotionEvent motionEvent) {
        ...
        recalculateWindowViewTransforms();
        long jM1882mapMKHz9U = Matrix.m1882mapMKHz9U(this.viewToWindowMatrix, OffsetKt.Offset(motionEvent.getX(), motionEvent.getY()));
        this.windowPosition = OffsetKt.Offset(motionEvent.getRawX() - Offset.m1436getXimpl(jM1882mapMKHz9U), motionEvent.getRawY() - Offset.m1437getYimpl(jM1882mapMKHz9U));
    }
}
