...
public final /* data */ class DeviceRenderNodeData {
    ...
    public int hashCode() {
        ...
        int iOooO00o = androidx.compose.animation.Oooo0.OooO00o(this.pivotY, androidx.compose.animation.Oooo0.OooO00o(this.pivotX, androidx.compose.animation.Oooo0.OooO00o(this.cameraDistance, androidx.compose.animation.Oooo0.OooO00o(this.rotationY, androidx.compose.animation.Oooo0.OooO00o(this.rotationX, androidx.compose.animation.Oooo0.OooO00o(this.rotationZ, (((androidx.compose.animation.Oooo0.OooO00o(this.elevation, androidx.compose.animation.Oooo0.OooO00o(this.translationY, androidx.compose.animation.Oooo0.OooO00o(this.translationX, androidx.compose.animation.Oooo0.OooO00o(this.scaleY, androidx.compose.animation.Oooo0.OooO00o(this.scaleX, ((((((((((((((int) (j ^ (j >>> 32))) * 31) + this.left) * 31) + this.top) * 31) + this.right) * 31) + this.bottom) * 31) + this.width) * 31) + this.height) * 31, 31), 31), 31), 31), 31) + this.ambientShadowColor) * 31) + this.spotShadowColor) * 31, 31), 31), 31), 31), 31), 31);
        ...
        int iOooO00o2 = androidx.compose.animation.Oooo0.OooO00o(this.alpha, (i + (z2 ? 1 : z2)) * 31, 31);
        RenderEffect renderEffect = this.renderEffect;
        return CompositingStrategy.m1752hashCodeimpl(this.compositingStrategy) + ((iOooO00o2 + (renderEffect == null ? 0 : renderEffect.hashCode())) * 31);
    }
    ...
    public final void m3099setCompositingStrategyaDBOjCE(int i) {
