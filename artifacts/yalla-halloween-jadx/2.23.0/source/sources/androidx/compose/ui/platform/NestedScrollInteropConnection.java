...
public final class NestedScrollInteropConnection implements NestedScrollConnection {
    ...
    public Object mo331onPostFlingRZ2iAVY(long j, long j2, @NotNull Continuation<? super Velocity> continuation) {
        if (!this.nestedScrollChildHelper.OooO00o(NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m3990getXimpl(j2)), NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m3991getYimpl(j2)), true)) {
            j2 = Velocity.INSTANCE.m4001getZero9UxMQ8M();
        }
    ...
    public long mo332onPostScrollDzOQY0M(long consumed, long available, int source) {
        if (!this.nestedScrollChildHelper.OooOO0(NestedScrollInteropConnectionKt.m3127getScrollAxesk4lQ0M(available), NestedScrollInteropConnectionKt.m3129toViewTypeGyEprt8(source))) {
        ...
        this.nestedScrollChildHelper.OooO0o(NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m1436getXimpl(consumed)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m1437getYimpl(consumed)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m1436getXimpl(available)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m1437getYimpl(available)), null, NestedScrollInteropConnectionKt.m3129toViewTypeGyEprt8(source), this.consumedScrollCache);
        return NestedScrollInteropConnectionKt.m3128toOffsetUv8p0NA(this.consumedScrollCache, available);
    }
    ...
    public Object mo333onPreFlingQWom1Mo(long j, @NotNull Continuation<? super Velocity> continuation) {
        if (!this.nestedScrollChildHelper.OooO0O0(NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m3990getXimpl(j)), NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m3991getYimpl(j)))) {
    ...
    public long mo334onPreScrollOzD1aCk(long available, int source) {
        ...
        ArraysKt___ArraysJvmKt.fill$default(this.consumedScrollCache, 0, 0, 0, 6, (Object) null);
        this.nestedScrollChildHelper.OooO0OO(NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m1436getXimpl(available)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m1437getYimpl(available)), this.consumedScrollCache, null, NestedScrollInteropConnectionKt.m3129toViewTypeGyEprt8(source));
        return NestedScrollInteropConnectionKt.m3128toOffsetUv8p0NA(this.consumedScrollCache, available);
    }
}
