...
public final class NestedScrollInteropConnectionKt {
    ...
    public static final int m3127getScrollAxesk4lQ0M(long j) {
        int i = Math.abs(Offset.m1436getXimpl(j)) >= 0.5f ? 1 : 0;
        return Math.abs(Offset.m1437getYimpl(j)) >= 0.5f ? i | 2 : i;
    }
    ...
    public static final long m3128toOffsetUv8p0NA(int[] iArr, long j) {
        return OffsetKt.Offset(Offset.m1436getXimpl(j) >= 0.0f ? RangesKt.coerceAtMost(reverseAxis(iArr[0]), Offset.m1436getXimpl(j)) : RangesKt.coerceAtLeast(reverseAxis(iArr[0]), Offset.m1436getXimpl(j)), Offset.m1437getYimpl(j) >= 0.0f ? RangesKt.coerceAtMost(reverseAxis(iArr[1]), Offset.m1437getYimpl(j)) : RangesKt.coerceAtLeast(reverseAxis(iArr[1]), Offset.m1437getYimpl(j)));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: toViewType-GyEprt8, reason: not valid java name */
    public static final int m3129toViewTypeGyEprt8(int i) {
        return !NestedScrollSource.m2594equalsimpl0(i, NestedScrollSource.INSTANCE.m2599getDragWNlRxjI()) ? 1 : 0;
    }
