...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public RenderNodeApi23(@NotNull AndroidComposeView ownerView) {
        ...
        this.internalCompositingStrategy = CompositingStrategy.INSTANCE.m1755getAutoNrFUSI();
    ...
    public final int getLayerType$ui_release() {
        return CompositingStrategy.m1751equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.INSTANCE.m1757getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    public void record(@NotNull CanvasHolder canvasHolder, @Nullable Path clipPath, @NotNull Function1<? super androidx.compose.ui.graphics.Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            androidCanvas.save();
            androidx.compose.ui.graphics.o0000O00.OooOOO0(androidCanvas, clipPath, 0, 2, null);
        }
    ...
    public void mo3094setCompositingStrategyaDBOjCE(int i) {
        CompositingStrategy.Companion companion = CompositingStrategy.INSTANCE;
        if (CompositingStrategy.m1751equalsimpl0(i, companion.m1757getOffscreenNrFUSI())) {
            this.renderNode.setLayerType(2);
            this.renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m1751equalsimpl0(i, companion.m1756getModulateAlphaNrFUSI())) {
