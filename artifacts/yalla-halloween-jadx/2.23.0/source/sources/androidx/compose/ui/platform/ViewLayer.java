...
public final class ViewLayer extends View implements OwnedLayer, GraphicLayerInfo {
    ...
    public ViewLayer(@NotNull AndroidComposeView ownerView, @NotNull DrawChildContainer container, @NotNull Function1<? super Canvas, Unit> drawBlock, @NotNull Function0<Unit> invalidateParentLayer) {
        ...
        this.mTransformOrigin = TransformOrigin.INSTANCE.m2033getCenterSzJe1aQ();
    ...
    public void mo3039inverseTransform58bKbWc(@NotNull float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        float[] fArrM3108calculateInverseMatrixbWbORWo = this.matrixCache.m3108calculateInverseMatrixbWbORWo(this);
    ...
    public boolean mo3040isInLayerk4lQ0M(long position) {
        ...
        if (this.clipToBounds) {
            return 0.0f <= fM1436getXimpl && fM1436getXimpl < ((float) getWidth()) && 0.0f <= fM1437getYimpl && fM1437getYimpl < ((float) getHeight());
        }
        if (getClipToOutline()) {
    ...
    public void mapBounds(@NotNull MutableRect rect, boolean inverse) {
        ...
        if (!inverse) {
            androidx.compose.ui.graphics.Matrix.m1884mapimpl(this.matrixCache.m3109calculateMatrixGrdbGEg(this), rect);
            return;
        }
        float[] fArrM3108calculateInverseMatrixbWbORWo = this.matrixCache.m3108calculateInverseMatrixbWbORWo(this);
        if (fArrM3108calculateInverseMatrixbWbORWo != null) {
    ...
    public long mo3041mapOffset8S9VItk(long point, boolean inverse) {
        if (!inverse) {
            return androidx.compose.ui.graphics.Matrix.m1882mapMKHz9U(this.matrixCache.m3109calculateMatrixGrdbGEg(this), point);
        }
        float[] fArrM3108calculateInverseMatrixbWbORWo = this.matrixCache.m3108calculateInverseMatrixbWbORWo(this);
    ...
    public void mo3042movegyyYBs(long position) {
        ...
        if (iM3883getXimpl != getLeft()) {
            offsetLeftAndRight(iM3883getXimpl - getLeft());
            this.matrixCache.invalidate();
        }
        int iM3884getYimpl = IntOffset.m3884getYimpl(position);
        if (iM3884getYimpl != getTop()) {
            offsetTopAndBottom(iM3884getYimpl - getTop());
            this.matrixCache.invalidate();
        }
    }
    ...
    public void mo3043resizeozmzZPI(long size) {
        ...
        if (iM3925getWidthimpl == getWidth() && iM3924getHeightimpl == getHeight()) {
            return;
        }
        float f = iM3925getWidthimpl;
        setPivotX(TransformOrigin.m2028getPivotFractionXimpl(this.mTransformOrigin) * f);
        float f2 = iM3924getHeightimpl;
        setPivotY(TransformOrigin.m2029getPivotFractionYimpl(this.mTransformOrigin) * f2);
        this.outlineResolver.m3132updateuvyYCjk(SizeKt.Size(f, f2));
        updateOutlineResolver();
        layout(getLeft(), getTop(), getLeft() + iM3925getWidthimpl, getTop() + iM3924getHeightimpl);
        resetClipBounds();
        this.matrixCache.invalidate();
    }
    ...
    public void mo3044transform58bKbWc(@NotNull float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        androidx.compose.ui.graphics.Matrix.m1893timesAssign58bKbWc(matrix, this.matrixCache.m3109calculateMatrixGrdbGEg(this));
    }
    ...
    public void mo3045updateLayerPropertiesdDxrwY(float scaleX, float scaleY, float alpha, float translationX, float translationY, float shadowElevation, float rotationX, float rotationY, float rotationZ, float cameraDistance, long transformOrigin, @NotNull Shape shape, boolean clip, @Nullable RenderEffect renderEffect, long ambientShadowColor, long spotShadowColor, int compositingStrategy, @NotNull LayoutDirection layoutDirection, @NotNull Density density) {
        ...
        setPivotX(TransformOrigin.m2028getPivotFractionXimpl(this.mTransformOrigin) * getWidth());
        setPivotY(TransformOrigin.m2029getPivotFractionYimpl(this.mTransformOrigin) * getHeight());
        ...
        if (i >= 28) {
            ...
            viewLayerVerificationHelper28.setOutlineAmbientShadowColor(this, ColorKt.m1724toArgb8_81llA(ambientShadowColor));
            viewLayerVerificationHelper28.setOutlineSpotShadowColor(this, ColorKt.m1724toArgb8_81llA(spotShadowColor));
        }
        if (i >= 31) {
        ...
        if (CompositingStrategy.m1751equalsimpl0(compositingStrategy, companion.m1757getOffscreenNrFUSI())) {
            setLayerType(2, null);
        } else if (CompositingStrategy.m1751equalsimpl0(compositingStrategy, companion.m1756getModulateAlphaNrFUSI())) {
            setLayerType(0, null);
            z = false;
        } else {
            setLayerType(0, null);
