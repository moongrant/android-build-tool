...
@Metadata(d1 = {"\u0000<\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010 \n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\u001a\u0018\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0001\u001a\u00020\u00002\u0006\u0010\u0003\u001a\u00020\u0002H\u0000\u001a\u0018\u0010\u0006\u001a\u00020\u00042\u0006\u0010\u0001\u001a\u00020\u00002\u0006\u0010\u0003\u001a\u00020\u0002H\u0000\u001a\f\u0010\b\u001a\u00020\u0007*\u00020\u0000H\u0000\u001a\u0016\u0010\u000b\u001a\u00020\u00072\f\u0010\n\u001a\b\u0012\u0004\u0012\u00020\u00000\tH\u0002\u001a\u0014\u0010\u000f\u001a\n \u000e*\u0004\u0018\u00010\r0\r*\u00020\fH\u0002\u001a\u001c\u0010\u0013\u001a\n \u000e*\u0004\u0018\u00010\u00120\u0012*\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u0000H\u0002\"\u0018\u0010\u0014\u001a\u00020\u0007*\u00020\f8BX\u0082\u0004¢\u0006\u0006\u001a\u0004\b\u0014\u0010\u0015¨\u0006\u0016"}, d2 = {"Landroidx/compose/ui/semantics/SemanticsNode;", "node", "Lo0000O/o0Oo0oo;", "info", "", "setCollectionInfo", "setCollectionItemInfo", "", "hasCollectionInfo", "", "items", "calculateIfHorizontallyStacked", "Landroidx/compose/ui/semantics/CollectionInfo;", "Lo0000O/o0Oo0oo$OooO0OO;", "kotlin.jvm.PlatformType", "toAccessibilityCollectionInfo", "Landroidx/compose/ui/semantics/CollectionItemInfo;", "itemNode", "Lo0000O/o0Oo0oo$OooO0o;", "toAccessibilityCollectionItemInfo", "isLazyCollection", "(Landroidx/compose/ui/semantics/CollectionInfo;)Z", "ui_release"}, k = 2, mv = {1, 8, 0})
...
public final class CollectionInfoKt {
    private static final boolean calculateIfHorizontallyStacked(List<SemanticsNode> list) {
        ...
        if (list.size() == 0 || list.size() == 1) {
            ...
            while (i < lastIndex) {
                ...
                listEmptyList.add(Offset.m1425boximpl(OffsetKt.Offset(Math.abs(Offset.m1436getXimpl(semanticsNode4.getBoundsInRoot().m1466getCenterF1C5BW0()) - Offset.m1436getXimpl(semanticsNode3.getBoundsInRoot().m1466getCenterF1C5BW0())), Math.abs(Offset.m1437getYimpl(semanticsNode4.getBoundsInRoot().m1466getCenterF1C5BW0()) - Offset.m1437getYimpl(semanticsNode3.getBoundsInRoot().m1466getCenterF1C5BW0())))));
        ...
        if (listEmptyList.size() == 1) {
            ...
            if (1 <= lastIndex2) {
                int i2 = 1;
                while (true) {
                    objFirst = Offset.m1425boximpl(Offset.m1441plusMKHz9U(((Offset) objFirst).getPackedValue(), ((Offset) listEmptyList.get(i2)).getPackedValue()));
                    if (i2 == lastIndex2) {
                        break;
                    }
                    i2++;
        ...
        return Offset.m1427component2impl(packedValue) < Offset.m1426component1impl(packedValue);
    }
    ...
    public static final void setCollectionInfo(@NotNull SemanticsNode node, @NotNull o0Oo0oo info) {
        ...
        if (!arrayList.isEmpty()) {
            ...
            info.OooOO0O(o0Oo0oo.OooO0OO.OooO00o(zCalculateIfHorizontallyStacked ? 1 : arrayList.size(), zCalculateIfHorizontallyStacked ? arrayList.size() : 1, 0, false));
        }
    }

    public static final void setCollectionItemInfo(@NotNull SemanticsNode node, @NotNull o0Oo0oo info) {
        Intrinsics.checkNotNullParameter(node, "node");
        Intrinsics.checkNotNullParameter(info, "info");
        SemanticsConfiguration config = node.getConfig();
        SemanticsProperties semanticsProperties = SemanticsProperties.INSTANCE;
        ...
        if (collectionItemInfo != null) {
            info.OooOO0o(toAccessibilityCollectionItemInfo(collectionItemInfo, node));
        }
    ...
    private static final o0Oo0oo.OooO0OO toAccessibilityCollectionInfo(CollectionInfo collectionInfo) {
        return o0Oo0oo.OooO0OO.OooO00o(collectionInfo.getRowCount(), collectionInfo.getColumnCount(), 0, false);
    }

    private static final o0Oo0oo.OooO0o toAccessibilityCollectionItemInfo(CollectionItemInfo collectionItemInfo, SemanticsNode semanticsNode) {
        return o0Oo0oo.OooO0o.OooO00o(collectionItemInfo.getRowIndex(), collectionItemInfo.getRowSpan(), collectionItemInfo.getColumnIndex(), collectionItemInfo.getColumnSpan(), false, ((Boolean) semanticsNode.getConfig().getOrElse(SemanticsProperties.INSTANCE.getSelected(), new Function0<Boolean>() { // from class: androidx.compose.ui.platform.accessibility.CollectionInfoKt.toAccessibilityCollectionItemInfo.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // kotlin.jvm.functions.Function0
            @NotNull
            public final Boolean invoke() {
