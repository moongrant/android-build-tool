...
public final class PrimitiveResources_androidKt {
    ...
    public static final float dimensionResource(@DimenRes int i, @Nullable Composer composer, int i2) {
        ...
        float fM3765constructorimpl = Dp.m3765constructorimpl(((Context) composer.consume(AndroidCompositionLocals_androidKt.getLocalContext())).getResources().getDimension(i) / ((Density) composer.consume(CompositionLocalsKt.getLocalDensity())).getDensity());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        return fM3765constructorimpl;
    }
