...
public final class AnnotatedString implements CharSequence {
    ...
    public static final class Builder implements Appendable {
        ...
        public static final /* data */ class MutableRange<T> {
            ...
            public String toString() {
                ...
                sb.append(this.end);
                sb.append(", tag=");
                return oo000o.OooO00o(sb, this.tag, ')');
            }
    ...
    public final AnnotatedString m3188subSequence5zctL8(long range) {
        return subSequence(TextRange.m3308getMinimpl(range), TextRange.m3307getMaximpl(range));
    }
