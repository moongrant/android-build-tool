...
public interface Paragraph {
    ...
    int mo3173getOffsetForPositionk4lQ0M(long position);
    ...
    long mo3174getWordBoundaryjx7JFs(int offset);

    boolean isLineEllipsized(int lineIndex);

    /* JADX INFO: renamed from: paint-LG529CI */
    void mo3175paintLG529CI(@NotNull Canvas canvas, long color, @Nullable Shadow shadow, @Nullable TextDecoration textDecoration, @Nullable DrawStyle drawStyle, int blendMode);

    /* JADX INFO: renamed from: paint-RPmYEkk */
    void mo3176paintRPmYEkk(@NotNull Canvas canvas, long color, @Nullable Shadow shadow, @Nullable TextDecoration textDecoration);

    /* JADX INFO: renamed from: paint-hn5TExg */
    void mo3177painthn5TExg(@NotNull Canvas canvas, @NotNull Brush brush, float alpha, @Nullable Shadow shadow, @Nullable TextDecoration textDecoration, @Nullable DrawStyle drawStyle, int blendMode);
}
