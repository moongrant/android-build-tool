...
public final /* data */ class ParagraphInfo {
    ...
    public int hashCode() {
        return Float.floatToIntBits(this.bottom) + Oooo0.OooO00o(this.top, ((((((((this.paragraph.hashCode() * 31) + this.startIndex) * 31) + this.endIndex) * 31) + this.startLineIndex) * 31) + this.endLineIndex) * 31, 31);
    }
    ...
    public final Rect toGlobal(@NotNull Rect rect) {
        ...
        return rect.m1473translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    /* JADX INFO: renamed from: toGlobal-GEjPoXI, reason: not valid java name */
    public final long m3206toGlobalGEjPoXI(long j) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m3310getStartimpl(j)), toGlobalIndex(TextRange.m3305getEndimpl(j)));
    }
    ...
    public final long m3207toLocalMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m1436getXimpl(j), Offset.m1437getYimpl(j) - this.top);
    }
    ...
    public final Path toGlobal(@NotNull Path path) {
        ...
        path.mo1573translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }
