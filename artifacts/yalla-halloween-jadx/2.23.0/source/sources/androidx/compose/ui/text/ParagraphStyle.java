...
public final class ParagraphStyle {
    ...
    public static /* synthetic */ ParagraphStyle m3212copyElsmlbk$default(ParagraphStyle paragraphStyle, TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return paragraphStyle.m3216copyElsmlbk(textAlign, textDirection2, j2, textIndent);
    }

    /* JADX INFO: renamed from: copy-xPh5V4g$default, reason: not valid java name */
    public static /* synthetic */ ParagraphStyle m3215copyxPh5V4g$default(ParagraphStyle paragraphStyle, TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, int i, Object obj) {
        if ((i & 1) != 0) {
            textAlign = paragraphStyle.textAlign;
        }
        if ((i & 2) != 0) {
        ...
        return paragraphStyle.m3219copyxPh5V4g(textAlign, textDirection2, j2, textIndent2, platformParagraphStyle2, lineHeightStyle);
    }
    ...
    public final /* synthetic */ ParagraphStyle m3216copyElsmlbk(TextAlign textAlign, TextDirection textDirection, long lineHeight, TextIndent textIndent) {
    ...
    public final /* synthetic */ ParagraphStyle m3218copyciSxzs0(TextAlign textAlign, TextDirection textDirection, long lineHeight, TextIndent textIndent, PlatformParagraphStyle platformStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens) {
    ...
    public final /* synthetic */ ParagraphStyle m3219copyxPh5V4g(TextAlign textAlign, TextDirection textDirection, long lineHeight, TextIndent textIndent, PlatformParagraphStyle platformStyle, LineHeightStyle lineHeightStyle) {
    ...
    public int hashCode() {
        ...
        int iM3668hashCodeimpl = (textAlign != null ? TextAlign.m3668hashCodeimpl(textAlign.getValue()) : 0) * 31;
        TextDirection textDirection = this.textDirection;
        int iM3947hashCodeimpl = (TextUnit.m3947hashCodeimpl(this.lineHeight) + ((iM3668hashCodeimpl + (textDirection != null ? TextDirection.m3681hashCodeimpl(textDirection.getValue()) : 0)) * 31)) * 31;
        TextIndent textIndent = this.textIndent;
        int iHashCode = (iM3947hashCodeimpl + (textIndent != null ? textIndent.hashCode() : 0)) * 31;
        ...
        int iM3602hashCodeimpl = (iHashCode3 + (lineBreak != null ? LineBreak.m3602hashCodeimpl(lineBreak.getMask()) : 0)) * 31;
        Hyphens hyphens = this.hyphens;
        int iM3587hashCodeimpl = (iM3602hashCodeimpl + (hyphens != null ? Hyphens.m3587hashCodeimpl(hyphens.getValue()) : 0)) * 31;
        TextMotion textMotion = this.textMotion;
        return iM3587hashCodeimpl + (textMotion != null ? textMotion.hashCode() : 0);
    }

    @Stable
    @NotNull
    public final ParagraphStyle merge(@Nullable ParagraphStyle other) {
        return other == null ? this : ParagraphStyleKt.m3228fastMergeHtYhynw(this, other.textAlign, other.textDirection, other.lineHeight, other.textIndent, other.platformStyle, other.lineHeightStyle, other.lineBreak, other.hyphens, other.textMotion);
    }
    ...
    public String toString() {
        return "ParagraphStyle(textAlign=" + this.textAlign + ", textDirection=" + this.textDirection + ", lineHeight=" + ((Object) TextUnit.m3953toStringimpl(this.lineHeight)) + ", textIndent=" + this.textIndent + ", platformStyle=" + this.platformStyle + ", lineHeightStyle=" + this.lineHeightStyle + ", lineBreak=" + this.lineBreak + ", hyphens=" + this.hyphens + ", textMotion=" + this.textMotion + ')';
    }
    ...
    private ParagraphStyle(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, TextMotion textMotion) {
        ...
        this.textAlignOrDefault = textAlign != null ? textAlign.getValue() : TextAlign.INSTANCE.m3676getStarte0LSkKk();
        this.lineBreakOrDefault = lineBreak != null ? lineBreak.getMask() : LineBreak.INSTANCE.m3607getSimplerAG3T2k();
        this.hyphensOrDefault = hyphens != null ? hyphens.getValue() : Hyphens.INSTANCE.m3591getNonevmbZdU8();
        if (TextUnit.m3943equalsimpl0(j, TextUnit.INSTANCE.m3957getUnspecifiedXSAIIZE())) {
            return;
        }
        if (TextUnit.m3946getValueimpl(j) >= 0.0f) {
            return;
        }
        throw new IllegalStateException(("lineHeight can't be negative (" + TextUnit.m3946getValueimpl(j) + ')').toString());
    }
    ...
    public /* synthetic */ ParagraphStyle(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, TextMotion textMotion, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : textAlign, (i & 2) != 0 ? null : textDirection, (i & 4) != 0 ? TextUnit.INSTANCE.m3957getUnspecifiedXSAIIZE() : j, (i & 8) != 0 ? null : textIndent, (i & 16) != 0 ? null : platformParagraphStyle, (i & 32) != 0 ? null : lineHeightStyle, (i & 64) != 0 ? null : lineBreak, (i & 128) != 0 ? null : hyphens, (i & PSKKeyManager.MAX_KEY_LENGTH_BYTES) == 0 ? textMotion : null, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ ParagraphStyle(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : textAlign, (i & 2) != 0 ? null : textDirection, (i & 4) != 0 ? TextUnit.INSTANCE.m3957getUnspecifiedXSAIIZE() : j, (i & 8) != 0 ? null : textIndent, null);
    }
    ...
    public /* synthetic */ ParagraphStyle(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : textAlign, (i & 2) != 0 ? null : textDirection, (i & 4) != 0 ? TextUnit.INSTANCE.m3957getUnspecifiedXSAIIZE() : j, (i & 8) != 0 ? null : textIndent, (i & 16) != 0 ? null : platformParagraphStyle, (i & 32) == 0 ? lineHeightStyle : null, null);
    }
    ...
    public /* synthetic */ ParagraphStyle(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : textAlign, (i & 2) != 0 ? null : textDirection, (i & 4) != 0 ? TextUnit.INSTANCE.m3957getUnspecifiedXSAIIZE() : j, (i & 8) != 0 ? null : textIndent, (i & 16) != 0 ? null : platformParagraphStyle, (i & 32) != 0 ? null : lineHeightStyle, (i & 64) != 0 ? null : lineBreak, (i & 128) == 0 ? hyphens : null, (DefaultConstructorMarker) null);
    }
