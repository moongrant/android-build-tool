...
public final class Placeholder {
    ...
    public static /* synthetic */ Placeholder m3229copyK8Q__8$default(Placeholder placeholder, long j, long j2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            j = placeholder.width;
        }
        long j3 = j;
        ...
        return placeholder.m3230copyK8Q__8(j3, j4, i);
    }

    @NotNull
    /* JADX INFO: renamed from: copy-K8Q-__8, reason: not valid java name */
    public final Placeholder m3230copyK8Q__8(long width, long height, int placeholderVerticalAlign) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return TextUnit.m3943equalsimpl0(this.width, placeholder.width) && TextUnit.m3943equalsimpl0(this.height, placeholder.height) && PlaceholderVerticalAlign.m3237equalsimpl0(this.placeholderVerticalAlign, placeholder.placeholderVerticalAlign);
    }
    ...
    public int hashCode() {
        return PlaceholderVerticalAlign.m3238hashCodeimpl(this.placeholderVerticalAlign) + ((TextUnit.m3947hashCodeimpl(this.height) + (TextUnit.m3947hashCodeimpl(this.width) * 31)) * 31);
    }

    @NotNull
    public String toString() {
        return "Placeholder(width=" + ((Object) TextUnit.m3953toStringimpl(this.width)) + ", height=" + ((Object) TextUnit.m3953toStringimpl(this.height)) + ", placeholderVerticalAlign=" + ((Object) PlaceholderVerticalAlign.m3239toStringimpl(this.placeholderVerticalAlign)) + ')';
    }
    ...
    private Placeholder(long j, long j2, int i) {
        ...
        if (!(!TextUnitKt.m3964isUnspecifiedR2X_6o(j2))) {
