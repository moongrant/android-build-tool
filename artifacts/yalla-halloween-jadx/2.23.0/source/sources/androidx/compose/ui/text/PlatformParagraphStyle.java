...
public final class PlatformParagraphStyle {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return this.includeFontPadding == platformParagraphStyle.includeFontPadding && EmojiSupportMatch.m3192equalsimpl0(this.emojiSupportMatch, platformParagraphStyle.emojiSupportMatch);
    }
    ...
    public int hashCode() {
        return EmojiSupportMatch.m3193hashCodeimpl(this.emojiSupportMatch) + ((this.includeFontPadding ? 1231 : 1237) * 31);
    }
    ...
    public String toString() {
        return "PlatformParagraphStyle(includeFontPadding=" + this.includeFontPadding + ", emojiSupportMatch=" + ((Object) EmojiSupportMatch.m3194toStringimpl(this.emojiSupportMatch)) + ')';
    }
    ...
    public PlatformParagraphStyle(boolean z) {
        ...
        this.emojiSupportMatch = EmojiSupportMatch.INSTANCE.m3196getDefault_3YsG6Y();
    }
    ...
    public /* synthetic */ PlatformParagraphStyle(int i, boolean z, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? EmojiSupportMatch.INSTANCE.m3196getDefault_3YsG6Y() : i, (i2 & 2) != 0 ? true : z, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ PlatformParagraphStyle(int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? EmojiSupportMatch.INSTANCE.m3196getDefault_3YsG6Y() : i, (DefaultConstructorMarker) null);
    }

    public PlatformParagraphStyle() {
        this(EmojiSupportMatch.INSTANCE.m3196getDefault_3YsG6Y(), true, (DefaultConstructorMarker) null);
    }
}
