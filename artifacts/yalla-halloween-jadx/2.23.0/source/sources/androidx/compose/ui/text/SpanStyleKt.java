...
public final class SpanStyleKt {
    ...
    static {
        ...
        DefaultBackgroundColor = companion.m1705getTransparent0d7_KjU();
        DefaultColor = companion.m1696getBlack0d7_KjU();
    }
    ...
    public static final SpanStyle m3274fastMergedSHsh3o(@NotNull SpanStyle fastMerge, long j, @Nullable Brush brush, float f, long j2, @Nullable FontWeight fontWeight, @Nullable FontStyle fontStyle, @Nullable FontSynthesis fontSynthesis, @Nullable FontFamily fontFamily, @Nullable String str, long j3, @Nullable BaselineShift baselineShift, @Nullable TextGeometricTransform textGeometricTransform, @Nullable LocaleList localeList, long j4, @Nullable TextDecoration textDecoration, @Nullable Shadow shadow, @Nullable PlatformSpanStyle platformSpanStyle, @Nullable DrawStyle drawStyle) {
        boolean z;
        boolean z2;
        Shadow shadow2;
        ...
        if ((!TextUnitKt.m3964isUnspecifiedR2X_6o(j2)) && !TextUnit.m3943equalsimpl0(j2, fastMerge.getFontSize())) {
            shadow2 = shadow;
            ...
            if ((fontStyle2 != null || Intrinsics.areEqual(fontStyle2, fastMerge.getFontStyle())) && ((fontWeight2 == null || Intrinsics.areEqual(fontWeight2, fastMerge.getFontWeight())) && (fontFamily == null || fontFamily == fastMerge.getFontFamily()))) {
                z = true;
                if (!(!TextUnitKt.m3964isUnspecifiedR2X_6o(j3)) && !TextUnit.m3943equalsimpl0(j3, fastMerge.getLetterSpacing())) {
                    shadow2 = shadow;
                    platformSpanStyle2 = platformSpanStyle;
                    drawStyle2 = drawStyle;
                    ...
                    if (!z4) {
                        ...
                        if (j4 != Color.INSTANCE.m1706getUnspecified0d7_KjU()) {
                            z2 = true;
                        } else {
                            z2 = false;
                        }
                    ...
                    if (z2 || Color.m1671equalsimpl0(j4, fastMerge.getBackground())) {
                        shadow2 = shadow;
            ...
            if ((j != Color.INSTANCE.m1706getUnspecified0d7_KjU()) && !Color.m1671equalsimpl0(j, fastMerge.getTextForegroundStyle().mo3578getColor0d7_KjU())) {
                shadow2 = shadow;
                platformSpanStyle2 = platformSpanStyle;
                drawStyle2 = drawStyle;
                z = true;
                ...
                z = true;
                if (!(!TextUnitKt.m3964isUnspecifiedR2X_6o(j3))) {
                }
        ...
        TextForegroundStyle textForegroundStyleMerge = fastMerge.getTextForegroundStyle().merge(brush != null ? TextForegroundStyle.INSTANCE.from(brush, f) : TextForegroundStyle.INSTANCE.m3690from8_81llA(j));
        FontFamily fontFamily2 = fontFamily == null ? fastMerge.getFontFamily() : fontFamily;
        long fontSize = !TextUnitKt.m3964isUnspecifiedR2X_6o(j2) ? j2 : fastMerge.getFontSize();
        if (fontWeight2 == null) {
        ...
        long letterSpacing = !TextUnitKt.m3964isUnspecifiedR2X_6o(j3) ? j3 : fastMerge.getLetterSpacing();
        ...
        long background = j4 != Color.INSTANCE.m1706getUnspecified0d7_KjU() ? z : false ? j4 : fastMerge.getBackground();
    ...
    public static final SpanStyle lerp(@NotNull SpanStyle start, @NotNull SpanStyle stop, float f) {
        ...
        long jM3275lerpTextUnitInheritableC3pnCVY = m3275lerpTextUnitInheritableC3pnCVY(start.getFontSize(), stop.getFontSize(), f);
        ...
        long jM3275lerpTextUnitInheritableC3pnCVY2 = m3275lerpTextUnitInheritableC3pnCVY(start.getLetterSpacing(), stop.getLetterSpacing(), f);
        BaselineShift baselineShift = start.getBaselineShift();
        float fM3570unboximpl = baselineShift != null ? baselineShift.m3570unboximpl() : BaselineShift.m3565constructorimpl(0.0f);
        BaselineShift baselineShift2 = stop.getBaselineShift();
        float fM3577lerpjWV1Mfo = BaselineShiftKt.m3577lerpjWV1Mfo(fM3570unboximpl, baselineShift2 != null ? baselineShift2.m3570unboximpl() : BaselineShift.m3565constructorimpl(0.0f), f);
        ...
        long jM1721lerpjxsXWHM = ColorKt.m1721lerpjxsXWHM(start.getBackground(), stop.getBackground(), f);
        ...
        return new SpanStyle(textForegroundStyleLerp, jM3275lerpTextUnitInheritableC3pnCVY, fontWeightLerp, fontStyle, fontSynthesis, fontFamily, str, jM3275lerpTextUnitInheritableC3pnCVY2, BaselineShift.m3564boximpl(fM3577lerpjWV1Mfo), textGeometricTransformLerp, localeList, jM1721lerpjxsXWHM, textDecoration, ShadowKt.lerp(shadow, shadow2, f), lerpPlatformStyle(start.getPlatformStyle(), stop.getPlatformStyle(), f), (DrawStyle) lerpDiscrete(start.getDrawStyle(), stop.getDrawStyle(), f), (DefaultConstructorMarker) null);
    }
    ...
    public static final long m3275lerpTextUnitInheritableC3pnCVY(long j, long j2, float f) {
        return (TextUnitKt.m3964isUnspecifiedR2X_6o(j) || TextUnitKt.m3964isUnspecifiedR2X_6o(j2)) ? ((TextUnit) lerpDiscrete(TextUnit.m3936boximpl(j), TextUnit.m3936boximpl(j2), f)).getPackedValue() : TextUnitKt.m3966lerpC3pnCVY(j, j2, f);
    }
    ...
    public static final SpanStyle resolveSpanStyleDefaults(@NotNull SpanStyle style) {
        ...
        TextForegroundStyle textForegroundStyleTakeOrElse = style.getTextForegroundStyle().takeOrElse(new Function0<TextForegroundStyle>() { // from class: androidx.compose.ui.text.SpanStyleKt.resolveSpanStyleDefaults.1
            ...
            public final TextForegroundStyle invoke() {
                return TextForegroundStyle.INSTANCE.m3690from8_81llA(SpanStyleKt.DefaultColor);
            }
        });
        long fontSize = TextUnitKt.m3964isUnspecifiedR2X_6o(style.getFontSize()) ? DefaultFontSize : style.getFontSize();
        ...
        FontSynthesis fontSynthesisM3412boximpl = FontSynthesis.m3412boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m3421getAllGVVA2EU());
        ...
        long letterSpacing = TextUnitKt.m3964isUnspecifiedR2X_6o(style.getLetterSpacing()) ? DefaultLetterSpacing : style.getLetterSpacing();
        BaselineShift baselineShift = style.getBaselineShift();
        BaselineShift baselineShiftM3564boximpl = BaselineShift.m3564boximpl(baselineShift != null ? baselineShift.m3570unboximpl() : BaselineShift.INSTANCE.m3574getNoney9eOQZs());
        ...
        if (!(background != Color.INSTANCE.m1706getUnspecified0d7_KjU())) {
        ...
        return new SpanStyle(textForegroundStyleTakeOrElse, fontSize, fontWeight2, fontStyleM3403boximpl, fontSynthesisM3412boximpl, fontFamily2, str, letterSpacing, baselineShiftM3564boximpl, textGeometricTransform2, localeList2, j, textDecoration2, shadow2, platformStyle, drawStyle, (DefaultConstructorMarker) null);
    }
}
