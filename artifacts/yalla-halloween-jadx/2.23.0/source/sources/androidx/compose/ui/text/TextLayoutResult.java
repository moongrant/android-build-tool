...
public final class TextLayoutResult {
    ...
    public static /* synthetic */ TextLayoutResult m3280copyO0kMr_c$default(TextLayoutResult textLayoutResult, TextLayoutInput textLayoutInput, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textLayoutResult.m3281copyO0kMr_c(textLayoutInput, j);
    }
    ...
    public final TextLayoutResult m3281copyO0kMr_c(@NotNull TextLayoutInput layoutInput, long size) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!Intrinsics.areEqual(this.layoutInput, textLayoutResult.layoutInput) || !Intrinsics.areEqual(this.multiParagraph, textLayoutResult.multiParagraph) || !IntSize.m3923equalsimpl0(this.size, textLayoutResult.size)) {
            return false;
        }
    ...
    public final boolean getDidOverflowHeight() {
        return this.multiParagraph.getDidExceedMaxLines() || ((float) IntSize.m3924getHeightimpl(this.size)) < this.multiParagraph.getHeight();
    }

    public final boolean getDidOverflowWidth() {
        return ((float) IntSize.m3925getWidthimpl(this.size)) < this.multiParagraph.getWidth();
    }
    ...
    public final int m3282getOffsetForPositionk4lQ0M(long position) {
        return this.multiParagraph.m3201getOffsetForPositionk4lQ0M(position);
    }
    ...
    public final long m3284getWordBoundaryjx7JFs(int offset) {
        return this.multiParagraph.m3202getWordBoundaryjx7JFs(offset);
    }

    public int hashCode() {
        return this.placeholderRects.hashCode() + Oooo0.OooO00o(this.lastBaseline, Oooo0.OooO00o(this.firstBaseline, (IntSize.m3926hashCodeimpl(this.size) + ((this.multiParagraph.hashCode() + (this.layoutInput.hashCode() * 31)) * 31)) * 31, 31), 31);
    }
    ...
    public String toString() {
        return "TextLayoutResult(layoutInput=" + this.layoutInput + ", multiParagraph=" + this.multiParagraph + ", size=" + ((Object) IntSize.m3928toStringimpl(this.size)) + ", firstBaseline=" + this.firstBaseline + ", lastBaseline=" + this.lastBaseline + ", placeholderRects=" + this.placeholderRects + ')';
    }
