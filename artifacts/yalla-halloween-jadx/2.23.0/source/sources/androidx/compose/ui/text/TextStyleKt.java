...
public final class TextStyleKt {
    ...
    public static final int m3342resolveTextDirectionYj3eThk(@NotNull LayoutDirection layoutDirection, @Nullable TextDirection textDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        TextDirection.Companion companion = TextDirection.INSTANCE;
        if (textDirection == null ? false : TextDirection.m3680equalsimpl0(textDirection.getValue(), companion.m3684getContents_7Xco())) {
            int i = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i == 1) {
                return companion.m3685getContentOrLtrs_7Xco();
            }
            if (i == 2) {
                return companion.m3686getContentOrRtls_7Xco();
            }
        ...
        if (i2 == 1) {
            return companion.m3687getLtrs_7Xco();
        }
        if (i2 == 2) {
            return companion.m3688getRtls_7Xco();
        }
        throw new NoWhenBranchMatchedException();
    }
}
