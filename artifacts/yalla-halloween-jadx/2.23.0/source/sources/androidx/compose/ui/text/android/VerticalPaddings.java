...
public final class VerticalPaddings {
    ...
    public static final /* synthetic */ VerticalPaddings m3343boximpl(long j) {
    ...
    public static final int m3347getBottomPaddingimpl(long j) {
        return (int) (j & 4294967295L);
    }

    /* JADX INFO: renamed from: getTopPadding-impl, reason: not valid java name */
    public static final int m3348getTopPaddingimpl(long j) {
        return (int) (j >> 32);
    }
    ...
    public static String m3350toStringimpl(long j) {
