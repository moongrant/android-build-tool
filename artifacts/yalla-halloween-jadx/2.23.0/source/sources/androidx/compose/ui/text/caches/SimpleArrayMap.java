        ...
        if (i2 <= 1) {
            ...
            if (iArr.length <= 8 || i2 >= iArr.length / 3) {
                if (index < i3) {
                    int i4 = index + 1;
                    int i5 = i3 + 1;
                    ArraysKt___ArraysJvmKt.copyInto(iArr, iArr, index, i4, i5);
                    Object[] objArr2 = this.keyValues;
                    ArraysKt.copyInto(objArr2, objArr2, i, i4 << 1, i5 << 1);
                }
                Object[] objArr3 = this.keyValues;
                int i6 = i3 << 1;
                objArr3[i6] = null;
                ...
                if (index < i3) {
                    int i8 = index + 1;
                    int i9 = i3 + 1;
                    ArraysKt___ArraysJvmKt.copyInto(iArr, this.hashes, index, i8, i9);
                    ArraysKt.copyInto(objArr, this.keyValues, i, i8 << 1, i9 << 1);
                }
            }
            if (i2 != this._size) {
                throw new ConcurrentModificationException();
