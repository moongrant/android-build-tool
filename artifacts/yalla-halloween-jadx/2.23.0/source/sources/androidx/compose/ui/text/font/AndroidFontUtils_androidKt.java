...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m3361getAndroidTypefaceStyleFO1MlWM(@NotNull FontWeight fontWeight, int i) {
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0, FontStyle.m3406equalsimpl0(i, FontStyle.INSTANCE.m3410getItalic_LCdwA()));
    }
}
