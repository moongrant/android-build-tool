...
public final class DeviceFontFamilyName {
    ...
    public static final /* synthetic */ DeviceFontFamilyName m3372boximpl(String str) {
        return new DeviceFontFamilyName(str);
    }

    @NotNull
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static String m3373constructorimpl(@NotNull String name) {
    ...
    public static boolean m3374equalsimpl(String str, Object obj) {
        return (obj instanceof DeviceFontFamilyName) && Intrinsics.areEqual(str, ((DeviceFontFamilyName) obj).m3378unboximpl());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3375equalsimpl0(String str, String str2) {
        return Intrinsics.areEqual(str, str2);
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m3376hashCodeimpl(String str) {
        return str.hashCode();
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m3377toStringimpl(String str) {
        return "DeviceFontFamilyName(name=" + str + ')';
    }

    public boolean equals(Object obj) {
        return m3374equalsimpl(this.name, obj);
    }
    ...
    public int hashCode() {
        return m3376hashCodeimpl(this.name);
    }

    public String toString() {
        return m3377toStringimpl(this.name);
    }

    /* JADX INFO: renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ String m3378unboximpl() {
        return this.name;
    }
}
