...
final class DeviceFontFamilyNameFont extends AndroidFont {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return DeviceFontFamilyName.m3375equalsimpl0(this.familyName, deviceFontFamilyNameFont.familyName) && Intrinsics.areEqual(getWeight(), deviceFontFamilyNameFont.getWeight()) && FontStyle.m3406equalsimpl0(getStyle(), deviceFontFamilyNameFont.getStyle()) && Intrinsics.areEqual(getVariationSettings(), deviceFontFamilyNameFont.getVariationSettings());
    }
    ...
    public int hashCode() {
        return getVariationSettings().hashCode() + ((FontStyle.m3407hashCodeimpl(getStyle()) + ((getWeight().hashCode() + (DeviceFontFamilyName.m3376hashCodeimpl(this.familyName) * 31)) * 31)) * 31);
    }

    @Nullable
    public final android.graphics.Typeface loadCached(@NotNull Context context) {
        Intrinsics.checkNotNullParameter(context, "context");
        return PlatformTypefacesKt.PlatformTypefaces().mo3431optionalOnDeviceFontFamilyByName78DK7lM(this.familyName, getWeight(), getStyle(), getVariationSettings(), context);
    }

    @NotNull
    public String toString() {
        return "Font(familyName=\"" + ((Object) DeviceFontFamilyName.m3377toStringimpl(this.familyName)) + "\", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m3408toStringimpl(getStyle())) + ')';
    }
    ...
    private DeviceFontFamilyNameFont(String familyName, FontWeight weight, int i, FontVariation.Settings variationSettings) {
        super(FontLoadingStrategy.INSTANCE.m3399getOptionalLocalPKNRLFQ(), NamedFontLoader.INSTANCE, variationSettings, null);
