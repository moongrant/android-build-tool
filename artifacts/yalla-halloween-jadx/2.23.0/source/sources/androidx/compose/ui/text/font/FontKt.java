...
public final class FontKt {
    ...
    public static final Font m3384FontF3nL8kk(int i, @NotNull FontWeight weight, int i2, int i3, @NotNull FontVariation.Settings variationSettings) {
    ...
    public static /* synthetic */ Font m3385FontF3nL8kk$default(int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        if ((i4 & 4) != 0) {
            i2 = FontStyle.INSTANCE.m3411getNormal_LCdwA();
        }
        if ((i4 & 8) != 0) {
            i3 = FontLoadingStrategy.INSTANCE.m3398getBlockingPKNRLFQ();
        }
        if ((i4 & 16) != 0) {
            settings = FontVariation.INSTANCE.m3426Settings6EWAqTQ(fontWeight, i2, new FontVariation.Setting[0]);
        }
        return m3384FontF3nL8kk(i, fontWeight, i2, i3, settings);
    }
    ...
    public static final /* synthetic */ Font m3386FontRetOiIg(int i, FontWeight weight, int i2) {
        Intrinsics.checkNotNullParameter(weight, "weight");
        return new ResourceFont(i, weight, i2, null, FontLoadingStrategy.INSTANCE.m3398getBlockingPKNRLFQ(), 8, null);
    }

    /* JADX INFO: renamed from: Font-RetOiIg$default, reason: not valid java name */
    public static /* synthetic */ Font m3387FontRetOiIg$default(int i, FontWeight fontWeight, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        if ((i3 & 4) != 0) {
        ...
        return m3386FontRetOiIg(i, fontWeight, i2);
    }

    @Stable
    @NotNull
    /* JADX INFO: renamed from: Font-YpTlLL0, reason: not valid java name */
    public static final Font m3388FontYpTlLL0(int i, @NotNull FontWeight weight, int i2, int i3) {
        Intrinsics.checkNotNullParameter(weight, "weight");
    ...
    public static /* synthetic */ Font m3389FontYpTlLL0$default(int i, FontWeight fontWeight, int i2, int i3, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        if ((i4 & 4) != 0) {
        ...
        return m3388FontYpTlLL0(i, fontWeight, i2, i3);
    }
