...
public final class FontListFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public final Object preload(@NotNull FontFamily fontFamily, @NotNull PlatformFontLoader platformFontLoader, @NotNull Continuation<? super Unit> continuation) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (FontLoadingStrategy.m3393equalsimpl0(font.getLoadingStrategy(), FontLoadingStrategy.INSTANCE.m3397getAsyncPKNRLFQ())) {
                arrayList.add(font);
            }
        }
        ArrayList arrayList2 = new ArrayList(arrayList.size());
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            arrayList2.add(TuplesKt.to(font2.getWeight(), FontStyle.m3403boximpl(font2.getStyle())));
        }
        ...
        for (int i4 = 0; i4 < size4; i4++) {
            ...
            int iM3409unboximpl = ((FontStyle) pair.component2()).m3409unboximpl();
            List list = (List) FontListFontFamilyTypefaceAdapterKt.firstImmediatelyAvailable(fontMatcher.m3402matchFontRetOiIg(fonts, fontWeight, iM3409unboximpl), new TypefaceRequest(fontFamily, fontWeight, iM3409unboximpl, FontSynthesis.INSTANCE.m3421getAllGVVA2EU(), platformFontLoader.getCacheKey(), null), this.asyncTypefaceCache, platformFontLoader, new Function1<TypefaceRequest, Unit>() { // from class: androidx.compose.ui.text.font.FontListFontFamilyTypefaceAdapter$preload$2$1
    ...
    public TypefaceResult resolve(@NotNull TypefaceRequest typefaceRequest, @NotNull PlatformFontLoader platformFontLoader, @NotNull Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, @NotNull Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        ...
        Pair pairFirstImmediatelyAvailable = FontListFontFamilyTypefaceAdapterKt.firstImmediatelyAvailable(fontMatcher.m3402matchFontRetOiIg(((FontListFontFamily) typefaceRequest.getFontFamily()).getFonts(), typefaceRequest.getFontWeight(), typefaceRequest.m3447getFontStyle_LCdwA()), typefaceRequest, this.asyncTypefaceCache, platformFontLoader, createDefaultTypeface);
