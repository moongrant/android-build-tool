        ...
        for (int i = 0; i < size; i++) {
            ...
            if (FontLoadingStrategy.m3393equalsimpl0(loadingStrategy, companion.m3398getBlockingPKNRLFQ())) {
                synchronized (asyncTypefaceCache.cacheLock) {
                    ...
                    if (asyncTypefaceResult != null) {
                        objLoadBlocking = asyncTypefaceResult.m3371unboximpl();
                    } else {
                ...
                if (objLoadBlocking != null) {
                    return TuplesKt.to(listMutableListOf, FontSynthesis_androidKt.m3425synthesizeTypefaceFxwP2eA(typefaceRequest.m3448getFontSynthesisGVVA2EU(), objLoadBlocking, font, typefaceRequest.getFontWeight(), typefaceRequest.m3447getFontStyle_LCdwA()));
                }
            ...
            if (FontLoadingStrategy.m3393equalsimpl0(loadingStrategy, companion.m3399getOptionalLocalPKNRLFQ())) {
                synchronized (asyncTypefaceCache.cacheLock) {
                    ...
                    if (asyncTypefaceResult2 != null) {
                        objM4213constructorimpl = asyncTypefaceResult2.m3371unboximpl();
                    } else {
                        Unit unit2 = Unit.INSTANCE;
                        try {
                            Result.Companion companion2 = Result.INSTANCE;
                            objM4213constructorimpl = Result.m4213constructorimpl(platformFontLoader.loadBlocking(font));
                        } catch (Throwable th) {
                        ...
                        if (Result.m4219isFailureimpl(objM4213constructorimpl)) {
                            objM4213constructorimpl = null;
                        }
                        AsyncTypefaceCache.put$default(asyncTypefaceCache, font, platformFontLoader, objM4213constructorimpl, false, 8, null);
                    }
                }
                if (objM4213constructorimpl != null) {
                    return TuplesKt.to(listMutableListOf, FontSynthesis_androidKt.m3425synthesizeTypefaceFxwP2eA(typefaceRequest.m3448getFontSynthesisGVVA2EU(), objM4213constructorimpl, font, typefaceRequest.getFontWeight(), typefaceRequest.m3447getFontStyle_LCdwA()));
                }
            } else {
                if (!FontLoadingStrategy.m3393equalsimpl0(loadingStrategy, companion.m3397getAsyncPKNRLFQ())) {
                    throw new IllegalStateException("Unknown font type " + font);
                }
                AsyncTypefaceCache.AsyncTypefaceResult asyncTypefaceResultM3363get1ASDuI8 = asyncTypefaceCache.m3363get1ASDuI8(font, platformFontLoader);
                if (asyncTypefaceResultM3363get1ASDuI8 != null) {
                    if (!AsyncTypefaceCache.AsyncTypefaceResult.m3369isPermanentFailureimpl(asyncTypefaceResultM3363get1ASDuI8.m3371unboximpl()) && asyncTypefaceResultM3363get1ASDuI8.m3371unboximpl() != null) {
                        return TuplesKt.to(listMutableListOf, FontSynthesis_androidKt.m3425synthesizeTypefaceFxwP2eA(typefaceRequest.m3448getFontSynthesisGVVA2EU(), asyncTypefaceResultM3363get1ASDuI8.m3371unboximpl(), font, typefaceRequest.getFontWeight(), typefaceRequest.m3447getFontStyle_LCdwA()));
                    }
