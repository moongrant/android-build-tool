...
public final class FontSynthesis {
    ...
    private static final int None = m3413constructorimpl(0);
    private static final int All = m3413constructorimpl(1);
    private static final int Weight = m3413constructorimpl(2);
    private static final int Style = m3413constructorimpl(3);
    ...
    public static final /* synthetic */ FontSynthesis m3412boximpl(int i) {
        return new FontSynthesis(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m3413constructorimpl(int i) {
        return i;
    }
    ...
    public static int m3416hashCodeimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: isStyleOn-impl$ui_text_release, reason: not valid java name */
    public static final boolean m3417isStyleOnimpl$ui_text_release(int i) {
        return m3415equalsimpl0(i, All) || m3415equalsimpl0(i, Style);
    }

    /* JADX INFO: renamed from: isWeightOn-impl$ui_text_release, reason: not valid java name */
    public static final boolean m3418isWeightOnimpl$ui_text_release(int i) {
        return m3415equalsimpl0(i, All) || m3415equalsimpl0(i, Weight);
    }

    @NotNull
    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m3419toStringimpl(int i) {
        if (m3415equalsimpl0(i, None)) {
            return "None";
        }
        if (m3415equalsimpl0(i, All)) {
            return "All";
        }
        if (m3415equalsimpl0(i, Weight)) {
            return "Weight";
        }
        return m3415equalsimpl0(i, Style) ? "Style" : "Invalid";
    }
    ...
    public int hashCode() {
        return m3416hashCodeimpl(this.value);
    }
