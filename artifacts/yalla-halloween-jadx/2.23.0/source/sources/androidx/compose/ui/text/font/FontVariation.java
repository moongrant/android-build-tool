...
public final class FontVariation {
    ...
    public static final class SettingTextUnit implements Setting {
        ...
        public boolean equals(@Nullable Object other) {
            ...
            return Intrinsics.areEqual(getAxisName(), settingTextUnit.getAxisName()) && TextUnit.m3943equalsimpl0(this.value, settingTextUnit.value);
        }
        ...
        public int hashCode() {
            return TextUnit.m3947hashCodeimpl(this.value) + (getAxisName().hashCode() * 31);
        }

        @NotNull
        public String toString() {
            return "FontVariation.Setting(axisName='" + getAxisName() + "', value=" + ((Object) TextUnit.m3953toStringimpl(this.value)) + ')';
        }
        ...
        public float toVariationValue(@Nullable Density density) {
            ...
            return density.getFontScale() * TextUnit.m3946getValueimpl(this.value);
        }
    ...
    public static final class Settings {
        ...
        public Settings(@NotNull Setting... settings) {
            ...
            while (true) {
                ...
                if (!(list.size() == 1)) {
                    throw new IllegalArgumentException(oo000o.OooO00o(o0OoOo0.OooO00o("'", str, "' must be unique. Actual [ ["), CollectionsKt___CollectionsKt.joinToString$default(list, null, null, null, 0, null, null, 63, null), ']').toString());
                }
    ...
    public final Settings m3426Settings6EWAqTQ(@NotNull FontWeight weight, int style, @NotNull Setting... settings) {
    ...
    public final Setting m3427opticalSizingR2X_6o(long textSize) {
        if (TextUnit.m3949isSpimpl(textSize)) {
