...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(@NotNull TypefaceRequest typefaceRequest, @NotNull PlatformFontLoader platformFontLoader, @NotNull Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, @NotNull Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        android.graphics.Typeface typefaceMo3530getNativeTypefacePYhJU0U;
        ...
        if (fontFamily == null ? true : fontFamily instanceof DefaultFontFamily) {
            typefaceMo3530getNativeTypefacePYhJU0U = this.platformTypefaceResolver.mo3429createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m3447getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            typefaceMo3530getNativeTypefacePYhJU0U = this.platformTypefaceResolver.mo3430createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m3447getFontStyle_LCdwA());
        } else {
            ...
            typefaceMo3530getNativeTypefacePYhJU0U = ((AndroidTypeface) typeface).mo3530getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m3447getFontStyle_LCdwA(), typefaceRequest.m3448getFontSynthesisGVVA2EU());
        }
        return new TypefaceResult.Immutable(typefaceMo3530getNativeTypefacePYhJU0U, false, 2, null);
    }
}
