...
public final class CursorAnchorInfoBuilderKt {
    ...
    public static final CursorAnchorInfo build(@NotNull CursorAnchorInfo.Builder builder, @NotNull TextFieldValue textFieldValue, @NotNull TextLayoutResult textLayoutResult, @NotNull Matrix matrix) {
        ...
        int iM3308getMinimpl = TextRange.m3308getMinimpl(textFieldValue.getSelection());
        builder.setSelectionRange(iM3308getMinimpl, TextRange.m3307getMaximpl(textFieldValue.getSelection()));
        setInsertionMarker(builder, iM3308getMinimpl, textLayoutResult);
        TextRange composition = textFieldValue.getComposition();
        int iM3308getMinimpl2 = composition != null ? TextRange.m3308getMinimpl(composition.getPackedValue()) : -1;
        TextRange composition2 = textFieldValue.getComposition();
        int iM3307getMaximpl = composition2 != null ? TextRange.m3307getMaximpl(composition2.getPackedValue()) : -1;
        boolean z = false;
        if (iM3308getMinimpl2 >= 0 && iM3308getMinimpl2 < iM3307getMaximpl) {
            z = true;
        }
        if (z) {
            builder.setComposingText(iM3308getMinimpl2, textFieldValue.getText().subSequence(iM3308getMinimpl2, iM3307getMaximpl));
        }
