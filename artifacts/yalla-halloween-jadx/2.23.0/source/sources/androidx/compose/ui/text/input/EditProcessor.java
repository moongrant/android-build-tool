...
public final class EditProcessor {
    ...
    @NotNull
    private TextFieldValue mBufferState = new TextFieldValue(AnnotatedStringKt.emptyAnnotatedString(), TextRange.INSTANCE.m3315getZerod9O1mEE(), (TextRange) null, (DefaultConstructorMarker) null);
    ...
    private final String generateBatchErrorMessage(List<? extends EditCommand> editCommands, final EditCommand failedCommand) throws IOException {
        ...
        sb.append("Error while applying EditCommand batch to buffer (length=" + this.mBuffer.getLength$ui_text_release() + ", composition=" + this.mBuffer.m3449getCompositionMzsxiRA$ui_text_release() + ", selection=" + ((Object) TextRange.m3313toStringimpl(this.mBuffer.m3450getSelectiond9O1mEE$ui_text_release())) + "):");
        ...
        CollectionsKt___CollectionsKt.joinTo(editCommands, sb, (124 & 2) != 0 ? ", " : "\n", (124 & 4) != 0 ? "" : null, (124 & 8) == 0 ? null : "", (124 & 16) != 0 ? -1 : 0, (124 & 32) != 0 ? "..." : null, (124 & 64) != 0 ? null : new Function1<EditCommand, CharSequence>() { // from class: androidx.compose.ui.text.input.EditProcessor$generateBatchErrorMessage$1$1
            ...
            public final CharSequence invoke(@NotNull EditCommand it) {
                ...
                StringBuilder sbOooO00o = o00OO.OooO00o(failedCommand == it ? " > " : "   ");
    ...
    public final TextFieldValue apply(@NotNull List<? extends EditCommand> editCommands) {
        ...
        try {
            ...
            TextFieldValue textFieldValue = new TextFieldValue(this.mBuffer.toAnnotatedString$ui_text_release(), this.mBuffer.m3450getSelectiond9O1mEE$ui_text_release(), this.mBuffer.m3449getCompositionMzsxiRA$ui_text_release(), (DefaultConstructorMarker) null);
    ...
    public final void reset(@NotNull TextFieldValue value, @Nullable TextInputSession textInputSession) {
        ...
        boolean z = true;
        boolean z2 = !Intrinsics.areEqual(value.getComposition(), this.mBuffer.m3449getCompositionMzsxiRA$ui_text_release());
        boolean z3 = false;
        ...
        } else if (TextRange.m3303equalsimpl0(this.mBufferState.getSelection(), value.getSelection())) {
            z = false;
        } else {
            this.mBuffer.setSelection$ui_text_release(TextRange.m3308getMinimpl(value.getSelection()), TextRange.m3307getMaximpl(value.getSelection()));
            z3 = true;
            z = false;
        }
        if (value.getComposition() == null) {
            this.mBuffer.commitComposition$ui_text_release();
        } else if (!TextRange.m3304getCollapsedimpl(value.getComposition().getPackedValue())) {
            this.mBuffer.setComposition$ui_text_release(TextRange.m3308getMinimpl(value.getComposition().getPackedValue()), TextRange.m3307getMaximpl(value.getComposition().getPackedValue()));
        }
        if (z || (!z3 && z2)) {
            this.mBuffer.commitComposition$ui_text_release();
            value = TextFieldValue.m3522copy3r_uNRQ$default(value, (AnnotatedString) null, 0L, (TextRange) null, 3, (Object) null);
        }
