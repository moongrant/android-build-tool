...
public final class ImeOptions {
    ...
    public static /* synthetic */ ImeOptions m3475copyuxg59PA$default(ImeOptions imeOptions, boolean z, int i, boolean z2, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
        ...
        return imeOptions.m3476copyuxg59PA(z, i5, z3, i6, i3);
    }

    @NotNull
    /* JADX INFO: renamed from: copy-uxg59PA, reason: not valid java name */
    public final ImeOptions m3476copyuxg59PA(boolean singleLine, int capitalization, boolean autoCorrect, int keyboardType, int imeAction) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return this.singleLine == imeOptions.singleLine && KeyboardCapitalization.m3485equalsimpl0(this.capitalization, imeOptions.capitalization) && this.autoCorrect == imeOptions.autoCorrect && KeyboardType.m3500equalsimpl0(this.keyboardType, imeOptions.keyboardType) && ImeAction.m3455equalsimpl0(this.imeAction, imeOptions.imeAction);
    }
    ...
    public int hashCode() {
        return ImeAction.m3456hashCodeimpl(this.imeAction) + ((KeyboardType.m3501hashCodeimpl(this.keyboardType) + ((((KeyboardCapitalization.m3486hashCodeimpl(this.capitalization) + ((this.singleLine ? 1231 : 1237) * 31)) * 31) + (this.autoCorrect ? 1231 : 1237)) * 31)) * 31);
    }

    @NotNull
    public String toString() {
        return "ImeOptions(singleLine=" + this.singleLine + ", capitalization=" + ((Object) KeyboardCapitalization.m3487toStringimpl(this.capitalization)) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + ((Object) KeyboardType.m3502toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m3457toStringimpl(this.imeAction)) + ')';
    }
    ...
    public /* synthetic */ ImeOptions(boolean z, int i, boolean z2, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? false : z, (i4 & 2) != 0 ? KeyboardCapitalization.INSTANCE.m3494getNoneIUNYP9k() : i, (i4 & 4) != 0 ? true : z2, (i4 & 8) != 0 ? KeyboardType.INSTANCE.m3520getTextPjHm6EE() : i2, (i4 & 16) != 0 ? ImeAction.INSTANCE.m3467getDefaulteUduSuo() : i3, null);
    }
}
