...
public final class InputState_androidKt {
    ...
    public static final ExtractedText toExtractedText(@NotNull TextFieldValue textFieldValue) {
        ...
        extractedText.selectionStart = TextRange.m3308getMinimpl(textFieldValue.getSelection());
        extractedText.selectionEnd = TextRange.m3307getMaximpl(textFieldValue.getSelection());
