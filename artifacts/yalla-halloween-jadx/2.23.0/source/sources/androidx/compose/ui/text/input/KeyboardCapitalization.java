...
public final class KeyboardCapitalization {
    ...
    private static final int None = m3483constructorimpl(0);
    private static final int Characters = m3483constructorimpl(1);
    private static final int Words = m3483constructorimpl(2);
    private static final int Sentences = m3483constructorimpl(3);
    ...
    public static final /* synthetic */ KeyboardCapitalization m3482boximpl(int i) {
        return new KeyboardCapitalization(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m3483constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m3484equalsimpl(int i, Object obj) {
        return (obj instanceof KeyboardCapitalization) && i == ((KeyboardCapitalization) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3485equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m3486hashCodeimpl(int i) {
        return i;
    }

    @NotNull
    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m3487toStringimpl(int i) {
        if (m3485equalsimpl0(i, None)) {
            return "None";
        }
        if (m3485equalsimpl0(i, Characters)) {
            return "Characters";
        }
        if (m3485equalsimpl0(i, Words)) {
            return "Words";
        }
        return m3485equalsimpl0(i, Sentences) ? "Sentences" : "Invalid";
    }

    public boolean equals(Object obj) {
        return m3484equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m3486hashCodeimpl(this.value);
    }

    @NotNull
    public String toString() {
        return m3487toStringimpl(this.value);
    }
