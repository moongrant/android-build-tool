...
public final class KeyboardType {
    ...
    private static final int Text = m3498constructorimpl(1);
    private static final int Ascii = m3498constructorimpl(2);
    private static final int Number = m3498constructorimpl(3);
    private static final int Phone = m3498constructorimpl(4);
    private static final int Uri = m3498constructorimpl(5);
    private static final int Email = m3498constructorimpl(6);
    private static final int Password = m3498constructorimpl(7);
    private static final int NumberPassword = m3498constructorimpl(8);
    private static final int Decimal = m3498constructorimpl(9);
    ...
    public static final /* synthetic */ KeyboardType m3497boximpl(int i) {
        return new KeyboardType(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m3498constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m3499equalsimpl(int i, Object obj) {
        return (obj instanceof KeyboardType) && i == ((KeyboardType) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3500equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m3501hashCodeimpl(int i) {
        return i;
    }

    @NotNull
    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m3502toStringimpl(int i) {
        if (m3500equalsimpl0(i, Text)) {
            return "Text";
        }
        if (m3500equalsimpl0(i, Ascii)) {
            return "Ascii";
        }
        if (m3500equalsimpl0(i, Number)) {
            return "Number";
        }
        if (m3500equalsimpl0(i, Phone)) {
            return "Phone";
        }
        if (m3500equalsimpl0(i, Uri)) {
            return "Uri";
        }
        if (m3500equalsimpl0(i, Email)) {
            return "Email";
        }
        if (m3500equalsimpl0(i, Password)) {
            return "Password";
        }
        if (m3500equalsimpl0(i, NumberPassword)) {
            return "NumberPassword";
        }
        return m3500equalsimpl0(i, Decimal) ? "Decimal" : "Invalid";
    }

    public boolean equals(Object obj) {
        return m3499equalsimpl(this.value, obj);
    }
