...
public final class TextFieldValueKt {
    ...
    public static final AnnotatedString getSelectedText(@NotNull TextFieldValue textFieldValue) {
        ...
        return textFieldValue.getAnnotatedString().m3188subSequence5zctL8(textFieldValue.getSelection());
    }

    @NotNull
    public static final AnnotatedString getTextAfterSelection(@NotNull TextFieldValue textFieldValue, int i) {
        Intrinsics.checkNotNullParameter(textFieldValue, "<this>");
        return textFieldValue.getAnnotatedString().subSequence(TextRange.m3307getMaximpl(textFieldValue.getSelection()), Math.min(TextRange.m3307getMaximpl(textFieldValue.getSelection()) + i, textFieldValue.getText().length()));
    }

    @NotNull
    public static final AnnotatedString getTextBeforeSelection(@NotNull TextFieldValue textFieldValue, int i) {
        Intrinsics.checkNotNullParameter(textFieldValue, "<this>");
        return textFieldValue.getAnnotatedString().subSequence(Math.max(0, TextRange.m3308getMinimpl(textFieldValue.getSelection()) - i), TextRange.m3308getMinimpl(textFieldValue.getSelection()));
    }
}
