...
public final class AndroidFontListTypeface implements AndroidTypeface {
    ...
    public AndroidFontListTypeface(@NotNull FontListFontFamily fontFamily, @NotNull Context context, @Nullable List<Pair<FontWeight, FontStyle>> list, @NotNull FontMatcher fontMatcher2) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (FontLoadingStrategy.m3393equalsimpl0(font.getLoadingStrategy(), FontLoadingStrategy.INSTANCE.m3398getBlockingPKNRLFQ())) {
                arrayList2.add(font);
            }
        }
        if (list != null) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                arrayList3.add((Font) CollectionsKt.firstOrNull((List) this.fontMatcher.m3402matchFontRetOiIg(arrayList2, pair.component1(), pair.component2().m3409unboximpl())));
            }
    ...
    public Typeface mo3530getNativeTypefacePYhJU0U(@NotNull FontWeight fontWeight, int fontStyle, int synthesis) {
        ...
        Font font = (Font) CollectionsKt.firstOrNull((List) this.fontMatcher.m3402matchFontRetOiIg(new ArrayList(this.loadedTypefaces.keySet()), fontWeight, fontStyle));
        if (font == null) {
        ...
        Object objM3425synthesizeTypefaceFxwP2eA = FontSynthesis_androidKt.m3425synthesizeTypefaceFxwP2eA(synthesis, typeface, font, fontWeight, fontStyle);
        Intrinsics.checkNotNull(objM3425synthesizeTypefaceFxwP2eA, "null cannot be cast to non-null type android.graphics.Typeface");
        return (Typeface) objM3425synthesizeTypefaceFxwP2eA;
    }
