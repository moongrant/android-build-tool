...
public final class AndroidGenericFontFamilyTypeface implements AndroidTypeface {
    ...
    private final Typeface m3531buildStyledTypefaceFO1MlWM(FontWeight fontWeight, int fontStyle) {
        return Build.VERSION.SDK_INT < 28 ? Typeface.create(this.nativeTypeface, AndroidFontUtils_androidKt.m3361getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle)) : TypefaceHelperMethodsApi28.INSTANCE.create(this.nativeTypeface, fontWeight.getWeight(), FontStyle.m3406equalsimpl0(fontStyle, FontStyle.INSTANCE.m3410getItalic_LCdwA()));
    }
    ...
    public Typeface mo3530getNativeTypefacePYhJU0U(@NotNull FontWeight fontWeight, int fontStyle, int synthesis) {
        ...
        Typeface typefaceM3531buildStyledTypefaceFO1MlWM = m3531buildStyledTypefaceFO1MlWM(fontWeight, fontStyle);
        Intrinsics.checkNotNullExpressionValue(typefaceM3531buildStyledTypefaceFO1MlWM, "buildStyledTypeface(fontWeight, fontStyle)");
        return typefaceM3531buildStyledTypefaceFO1MlWM;
    }
}
