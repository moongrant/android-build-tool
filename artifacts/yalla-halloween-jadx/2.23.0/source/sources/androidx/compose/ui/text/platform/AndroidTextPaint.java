...
public final class AndroidTextPaint extends TextPaint {
    ...
    public static /* synthetic */ void m3541setBrush12SF9DM$default(AndroidTextPaint androidTextPaint, Brush brush, long j, float f, int i, Object obj) {
        if ((i & 4) != 0) {
            f = Float.NaN;
        }
        androidTextPaint.m3544setBrush12SF9DM(brush, j, f);
    }

    /* JADX INFO: renamed from: getBlendMode-0nO6VwU, reason: not valid java name */
    public final int m3542getBlendMode0nO6VwU() {
        return this.composePaint.mo1550getBlendMode0nO6VwU();
    }
    ...
    public final void m3543setBlendModes9anfk8(int i) {
        this.composePaint.mo1556setBlendModes9anfk8(i);
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:15:0x002c, code lost:
        ...
        if ((r9 != androidx.compose.ui.geometry.Size.INSTANCE.m1513getUnspecifiedNHjbRc()) != false) goto L16;
     */
    /* JADX INFO: renamed from: setBrush-12SF9DM, reason: not valid java name */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void m3544setBrush12SF9DM(@Nullable Brush brush, long size, float alpha) {
        ...
        brush.mo1623applyToPq9zytI(size, this.composePaint, Float.isNaN(alpha) ? this.composePaint.getAlpha() : RangesKt.coerceIn(alpha, 0.0f, 1.0f));
    }

    /* JADX INFO: renamed from: setColor-8_81llA, reason: not valid java name */
    public final void m3545setColor8_81llA(long color) {
        if (color != Color.INSTANCE.m1706getUnspecified0d7_KjU()) {
            this.composePaint.mo1557setColor8_81llA(color);
            this.composePaint.setShader(null);
        }
    }
    ...
    public final void setDrawStyle(@Nullable DrawStyle drawStyle) {
        ...
        if (Intrinsics.areEqual(drawStyle, Fill.INSTANCE)) {
            this.composePaint.mo1561setStylek9PVt8s(PaintingStyle.INSTANCE.m1912getFillTiuSbCo());
            return;
        }
        if (drawStyle instanceof Stroke) {
            this.composePaint.mo1561setStylek9PVt8s(PaintingStyle.INSTANCE.m1913getStrokeTiuSbCo());
            Stroke stroke = (Stroke) drawStyle;
            this.composePaint.setStrokeWidth(stroke.getWidth());
            this.composePaint.setStrokeMiterLimit(stroke.getMiter());
            this.composePaint.mo1560setStrokeJoinWw9F2mQ(stroke.getJoin());
            this.composePaint.mo1559setStrokeCapBeK7IIE(stroke.getCap());
    ...
    public final void setShadow(@Nullable Shadow shadow) {
        ...
        if (Intrinsics.areEqual(shadow, Shadow.INSTANCE.getNone())) {
            ...
            setShadowLayer(TextPaintExtensions_androidKt.correctBlurRadius(this.shadow.getBlurRadius()), Offset.m1436getXimpl(this.shadow.getOffset()), Offset.m1437getYimpl(this.shadow.getOffset()), ColorKt.m1724toArgb8_81llA(this.shadow.getColor()));
        }
    }
