...
public final class SpannableExtensions_androidKt {
    ...
    private static final MetricAffectingSpan m3551createLetterSpacingSpaneAf_CNQ(long j, Density density) {
        ...
        if (TextUnitType.m3974equalsimpl0(jM3945getTypeUIouoOA, companion.m3978getEmUIouoOA())) {
            return new LetterSpacingSpanEm(TextUnit.m3946getValueimpl(j));
        }
        return null;
    }
    ...
    private static final boolean getNeedsLetterSpacingSpan(SpanStyle spanStyle) {
        long jM3945getTypeUIouoOA = TextUnit.m3945getTypeUIouoOA(spanStyle.getLetterSpacing());
        TextUnitType.Companion companion = TextUnitType.INSTANCE;
        return TextUnitType.m3974equalsimpl0(jM3945getTypeUIouoOA, companion.m3979getSpUIouoOA()) || TextUnitType.m3974equalsimpl0(TextUnit.m3945getTypeUIouoOA(spanStyle.getLetterSpacing()), companion.m3978getEmUIouoOA());
    }

    private static final boolean hasFontAttributes(TextStyle textStyle) {
        return TextPaintExtensions_androidKt.hasFontAttributes(textStyle.toSpanStyle()) || textStyle.m3334getFontSynthesisZQGJjVo() != null;
    }
    ...
    private static final float m3552resolveLineHeightInPxo2QH7mI(long j, float f, Density density) {
        long jM3945getTypeUIouoOA = TextUnit.m3945getTypeUIouoOA(j);
        TextUnitType.Companion companion = TextUnitType.INSTANCE;
        if (TextUnitType.m3974equalsimpl0(jM3945getTypeUIouoOA, companion.m3979getSpUIouoOA())) {
        ...
        if (TextUnitType.m3974equalsimpl0(jM3945getTypeUIouoOA, companion.m3978getEmUIouoOA())) {
            return TextUnit.m3946getValueimpl(j) * f;
        }
        return Float.NaN;
    }

    /* JADX INFO: renamed from: setBackground-RPmYEkk, reason: not valid java name */
    public static final void m3553setBackgroundRPmYEkk(@NotNull Spannable setBackground, long j, int i, int i2) {
        Intrinsics.checkNotNullParameter(setBackground, "$this$setBackground");
        if (j != Color.INSTANCE.m1706getUnspecified0d7_KjU()) {
            setSpan(setBackground, new BackgroundColorSpan(ColorKt.m1724toArgb8_81llA(j)), i, i2);
        }
    }

    /* JADX INFO: renamed from: setBaselineShift-0ocSgnM, reason: not valid java name */
    private static final void m3554setBaselineShift0ocSgnM(Spannable spannable, BaselineShift baselineShift, int i, int i2) {
        if (baselineShift != null) {
            setSpan(spannable, new BaselineShiftSpan(baselineShift.m3570unboximpl()), i, i2);
        }
    }
    ...
    private static final void setBrush(Spannable spannable, Brush brush, float f, int i, int i2) {
        if (brush != null) {
            if (brush instanceof SolidColor) {
                m3555setColorRPmYEkk(spannable, ((SolidColor) brush).getValue(), i, i2);
    ...
    public static final void m3555setColorRPmYEkk(@NotNull Spannable setColor, long j, int i, int i2) {
        Intrinsics.checkNotNullParameter(setColor, "$this$setColor");
        if (j != Color.INSTANCE.m1706getUnspecified0d7_KjU()) {
            setSpan(setColor, new ForegroundColorSpan(ColorKt.m1724toArgb8_81llA(j)), i, i2);
        }
    }
    ...
    private static final void setFontAttributes(final Spannable spannable, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, final Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        ...
        flattenFontStylesAndApply(hasFontAttributes(textStyle) ? new SpanStyle(0L, 0L, textStyle.getFontWeight(), textStyle.m3333getFontStyle4Lr2A7w(), textStyle.m3334getFontSynthesisZQGJjVo(), textStyle.getFontFamily(), (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65475, (DefaultConstructorMarker) null) : null, arrayList, new Function3<SpanStyle, Integer, Integer, Unit>() { // from class: androidx.compose.ui.text.platform.extensions.SpannableExtensions_androidKt.setFontAttributes.1
            ...
            public final void invoke(@NotNull SpanStyle spanStyle, int i2, int i3) {
                ...
                FontStyle fontStyleM3403boximpl = FontStyle.m3403boximpl(fontStyle != null ? fontStyle.m3409unboximpl() : FontStyle.INSTANCE.m3411getNormal_LCdwA());
                FontSynthesis fontSynthesis = spanStyle.getFontSynthesis();
                spannable2.setSpan(new TypefaceSpan(function5.invoke(fontFamily, fontWeight, fontStyleM3403boximpl, FontSynthesis.m3412boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m3421getAllGVVA2EU()))), i2, i3, 33);
            }
        });
    }
    ...
    public static final void m3556setFontSizeKmRG4DE(@NotNull Spannable setFontSize, long j, @NotNull Density density, int i, int i2) {
        ...
        if (TextUnitType.m3974equalsimpl0(jM3945getTypeUIouoOA, companion.m3979getSpUIouoOA())) {
            ...
            setSpan(setFontSize, new RelativeSizeSpan(TextUnit.m3946getValueimpl(j)), i, i2);
        }
    }
    ...
    public static final void m3557setLineHeightKmRG4DE(@NotNull Spannable setLineHeight, long j, float f, @NotNull Density density, @NotNull LineHeightStyle lineHeightStyle) {
        Intrinsics.checkNotNullParameter(setLineHeight, "$this$setLineHeight");
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(lineHeightStyle, "lineHeightStyle");
        float fM3552resolveLineHeightInPxo2QH7mI = m3552resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(fM3552resolveLineHeightInPxo2QH7mI)) {
            return;
        }
        setSpan(setLineHeight, new LineHeightStyleSpan(fM3552resolveLineHeightInPxo2QH7mI, 0, ((setLineHeight.length() == 0) || StringsKt.last(setLineHeight) == '\n') ? setLineHeight.length() + 1 : setLineHeight.length(), LineHeightStyle.Trim.m3656isTrimFirstLineTopimpl$ui_text_release(lineHeightStyle.getTrim()), LineHeightStyle.Trim.m3657isTrimLastLineBottomimpl$ui_text_release(lineHeightStyle.getTrim()), lineHeightStyle.getAlignment()), 0, setLineHeight.length());
    }

    /* JADX INFO: renamed from: setLineHeight-r9BaKPg, reason: not valid java name */
    public static final void m3558setLineHeightr9BaKPg(@NotNull Spannable setLineHeight, long j, float f, @NotNull Density density) {
        Intrinsics.checkNotNullParameter(setLineHeight, "$this$setLineHeight");
        Intrinsics.checkNotNullParameter(density, "density");
        float fM3552resolveLineHeightInPxo2QH7mI = m3552resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(fM3552resolveLineHeightInPxo2QH7mI)) {
        ...
        setSpan(setLineHeight, new LineHeightSpan(fM3552resolveLineHeightInPxo2QH7mI), 0, setLineHeight.length());
    }
    ...
    private static final void setShadow(Spannable spannable, Shadow shadow, int i, int i2) {
        if (shadow != null) {
            setSpan(spannable, new ShadowSpan(ColorKt.m1724toArgb8_81llA(shadow.getColor()), Offset.m1436getXimpl(shadow.getOffset()), Offset.m1437getYimpl(shadow.getOffset()), TextPaintExtensions_androidKt.correctBlurRadius(shadow.getBlurRadius())), i, i2);
        }
    }
    ...
    private static final void setSpanStyle(Spannable spannable, AnnotatedString.Range<SpanStyle> range, Density density) {
        ...
        m3554setBaselineShift0ocSgnM(spannable, item.getBaselineShift(), start, end);
        m3555setColorRPmYEkk(spannable, item.m3269getColor0d7_KjU(), start, end);
        setBrush(spannable, item.getBrush(), item.getAlpha(), start, end);
        setTextDecoration(spannable, item.getTextDecoration(), start, end);
        m3556setFontSizeKmRG4DE(spannable, item.getFontSize(), density, start, end);
        ...
        m3553setBackgroundRPmYEkk(spannable, item.getBackground(), start, end);
    ...
    public static final void setSpanStyles(@NotNull Spannable spannable, @NotNull TextStyle contextTextStyle, @NotNull List<AnnotatedString.Range<SpanStyle>> spanStyles, @NotNull Density density, @NotNull Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> resolveTypeface) {
        MetricAffectingSpan metricAffectingSpanM3551createLetterSpacingSpaneAf_CNQ;
        Intrinsics.checkNotNullParameter(spannable, "<this>");
        ...
        if (z) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (start2 >= 0 && start2 < spannable.length() && end2 > start2 && end2 <= spannable.length() && (metricAffectingSpanM3551createLetterSpacingSpaneAf_CNQ = m3551createLetterSpacingSpaneAf_CNQ(item.getLetterSpacing(), density)) != null) {
                    setSpan(spannable, metricAffectingSpanM3551createLetterSpacingSpaneAf_CNQ, start2, end2);
                }
            }
        }
    }
    ...
    public static final void setTextIndent(@NotNull Spannable spannable, @Nullable TextIndent textIndent, float f, @NotNull Density density) {
        float fM3946getValueimpl;
        Intrinsics.checkNotNullParameter(spannable, "<this>");
        Intrinsics.checkNotNullParameter(density, "density");
        if (textIndent != null) {
            if ((TextUnit.m3943equalsimpl0(textIndent.getFirstLine(), TextUnitKt.getSp(0)) && TextUnit.m3943equalsimpl0(textIndent.getRestLine(), TextUnitKt.getSp(0))) || TextUnitKt.m3964isUnspecifiedR2X_6o(textIndent.getFirstLine()) || TextUnitKt.m3964isUnspecifiedR2X_6o(textIndent.getRestLine())) {
                return;
            }
            long jM3945getTypeUIouoOA = TextUnit.m3945getTypeUIouoOA(textIndent.getFirstLine());
            TextUnitType.Companion companion = TextUnitType.INSTANCE;
            float fM3946getValueimpl2 = 0.0f;
            if (TextUnitType.m3974equalsimpl0(jM3945getTypeUIouoOA, companion.m3979getSpUIouoOA())) {
                fM3946getValueimpl = density.mo323toPxR2X_6o(textIndent.getFirstLine());
            } else {
                fM3946getValueimpl = TextUnitType.m3974equalsimpl0(jM3945getTypeUIouoOA, companion.m3978getEmUIouoOA()) ? TextUnit.m3946getValueimpl(textIndent.getFirstLine()) * f : 0.0f;
            }
            long jM3945getTypeUIouoOA2 = TextUnit.m3945getTypeUIouoOA(textIndent.getRestLine());
            if (TextUnitType.m3974equalsimpl0(jM3945getTypeUIouoOA2, companion.m3979getSpUIouoOA())) {
                fM3946getValueimpl2 = density.mo323toPxR2X_6o(textIndent.getRestLine());
            } else if (TextUnitType.m3974equalsimpl0(jM3945getTypeUIouoOA2, companion.m3978getEmUIouoOA())) {
                fM3946getValueimpl2 = TextUnit.m3946getValueimpl(textIndent.getRestLine()) * f;
            }
            setSpan(spannable, new LeadingMarginSpan.Standard((int) Math.ceil(fM3946getValueimpl), (int) Math.ceil(fM3946getValueimpl2)), 0, spannable.length());
        }
    }
}
