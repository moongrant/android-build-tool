...
public final class TextPaintExtensions_androidKt {
    ...
    public static final SpanStyle applySpanStyle(@NotNull AndroidTextPaint androidTextPaint, @NotNull SpanStyle style, @NotNull Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> resolveTypeface, @NotNull Density density, boolean z) {
        ...
        long jM3945getTypeUIouoOA = TextUnit.m3945getTypeUIouoOA(style.getFontSize());
        TextUnitType.Companion companion = TextUnitType.INSTANCE;
        if (TextUnitType.m3974equalsimpl0(jM3945getTypeUIouoOA, companion.m3979getSpUIouoOA())) {
            androidTextPaint.setTextSize(density.mo323toPxR2X_6o(style.getFontSize()));
        } else if (TextUnitType.m3974equalsimpl0(jM3945getTypeUIouoOA, companion.m3978getEmUIouoOA())) {
            androidTextPaint.setTextSize(TextUnit.m3946getValueimpl(style.getFontSize()) * androidTextPaint.getTextSize());
        }
        if (hasFontAttributes(style)) {
            ...
            androidTextPaint.setTypeface(resolveTypeface.invoke(fontFamily, fontWeight, fontStyleM3403boximpl, FontSynthesis.m3412boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m3421getAllGVVA2EU())));
        }
        ...
        androidTextPaint.m3545setColor8_81llA(style.m3269getColor0d7_KjU());
        androidTextPaint.m3544setBrush12SF9DM(style.getBrush(), Size.INSTANCE.m1513getUnspecifiedNHjbRc(), style.getAlpha());
        ...
        if (TextUnitType.m3974equalsimpl0(TextUnit.m3945getTypeUIouoOA(style.getLetterSpacing()), companion.m3979getSpUIouoOA())) {
            if (!(TextUnit.m3946getValueimpl(style.getLetterSpacing()) == 0.0f)) {
                float textScaleX = androidTextPaint.getTextScaleX() * androidTextPaint.getTextSize();
                float fMo323toPxR2X_6o = density.mo323toPxR2X_6o(style.getLetterSpacing());
                if (!(textScaleX == 0.0f)) {
                    androidTextPaint.setLetterSpacing(fMo323toPxR2X_6o / textScaleX);
                }
            } else if (TextUnitType.m3974equalsimpl0(TextUnit.m3945getTypeUIouoOA(style.getLetterSpacing()), companion.m3978getEmUIouoOA())) {
                androidTextPaint.setLetterSpacing(TextUnit.m3946getValueimpl(style.getLetterSpacing()));
            }
        } else if (TextUnitType.m3974equalsimpl0(TextUnit.m3945getTypeUIouoOA(style.getLetterSpacing()), companion.m3978getEmUIouoOA())) {
            androidTextPaint.setLetterSpacing(TextUnit.m3946getValueimpl(style.getLetterSpacing()));
        }
        return m3559generateFallbackSpanStyle62GTOB8(style.getLetterSpacing(), z, style.getBackground(), style.getBaselineShift());
    }
    ...
    private static final SpanStyle m3559generateFallbackSpanStyle62GTOB8(long j, boolean z, long j2, BaselineShift baselineShift) {
        boolean z2;
        boolean z3;
        long jM1706getUnspecified0d7_KjU = j2;
        if (z && TextUnitType.m3974equalsimpl0(TextUnit.m3945getTypeUIouoOA(j), TextUnitType.INSTANCE.m3979getSpUIouoOA())) {
        ...
        boolean z4 = (Color.m1671equalsimpl0(jM1706getUnspecified0d7_KjU, companion.m1706getUnspecified0d7_KjU()) || Color.m1671equalsimpl0(jM1706getUnspecified0d7_KjU, companion.m1705getTransparent0d7_KjU())) ? false : true;
        if (baselineShift != null) {
            z3 = BaselineShift.m3567equalsimpl0(baselineShift.m3570unboximpl(), BaselineShift.INSTANCE.m3574getNoney9eOQZs()) ? false : true;
        }
        if (!z2 && !z4 && !z3) {
            return null;
        }
        long jM3957getUnspecifiedXSAIIZE = z2 ? j : TextUnit.INSTANCE.m3957getUnspecifiedXSAIIZE();
        if (!z4) {
            jM1706getUnspecified0d7_KjU = companion.m1706getUnspecified0d7_KjU();
        }
        return new SpanStyle(0L, 0L, (FontWeight) null, (FontStyle) null, (FontSynthesis) null, (FontFamily) null, (String) null, jM3957getUnspecifiedXSAIIZE, z3 ? baselineShift : null, (TextGeometricTransform) null, (LocaleList) null, jM1706getUnspecified0d7_KjU, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 63103, (DefaultConstructorMarker) null);
    }
    ...
    public static final void setTextMotion(@NotNull AndroidTextPaint androidTextPaint, @Nullable TextMotion textMotion) {
        ...
        int iM3697getLinearity4e0Vf04$ui_text_release = textMotion.getLinearity();
        TextMotion.Linearity.Companion companion = TextMotion.Linearity.INSTANCE;
        if (TextMotion.Linearity.m3701equalsimpl0(iM3697getLinearity4e0Vf04$ui_text_release, companion.m3706getLinear4e0Vf04())) {
            androidTextPaint.setFlags(androidTextPaint.getFlags() | 64);
            androidTextPaint.setHinting(0);
        } else if (TextMotion.Linearity.m3701equalsimpl0(iM3697getLinearity4e0Vf04$ui_text_release, companion.m3705getFontHinting4e0Vf04())) {
            androidTextPaint.getFlags();
            androidTextPaint.setHinting(1);
        } else if (!TextMotion.Linearity.m3701equalsimpl0(iM3697getLinearity4e0Vf04$ui_text_release, companion.m3707getNone4e0Vf04())) {
            androidTextPaint.getFlags();
        } else {
            androidTextPaint.getFlags();
            androidTextPaint.setHinting(0);
