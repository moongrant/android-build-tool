...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
    ...
    private final Paint.Cap m3560toAndroidCapBeK7IIE(int i) {
        StrokeCap.Companion companion = StrokeCap.INSTANCE;
        if (StrokeCap.m1991equalsimpl0(i, companion.m1995getButtKaPHkGw())) {
            return Paint.Cap.BUTT;
        }
        if (StrokeCap.m1991equalsimpl0(i, companion.m1996getRoundKaPHkGw())) {
            return Paint.Cap.ROUND;
        }
        return StrokeCap.m1991equalsimpl0(i, companion.m1997getSquareKaPHkGw()) ? Paint.Cap.SQUARE : Paint.Cap.BUTT;
    }

    /* JADX INFO: renamed from: toAndroidJoin-Ww9F2mQ, reason: not valid java name */
    private final Paint.Join m3561toAndroidJoinWw9F2mQ(int i) {
        StrokeJoin.Companion companion = StrokeJoin.INSTANCE;
        if (StrokeJoin.m2001equalsimpl0(i, companion.m2006getMiterLxFBmk8())) {
            return Paint.Join.MITER;
        }
        if (StrokeJoin.m2001equalsimpl0(i, companion.m2007getRoundLxFBmk8())) {
            return Paint.Join.ROUND;
        }
        return StrokeJoin.m2001equalsimpl0(i, companion.m2005getBevelLxFBmk8()) ? Paint.Join.BEVEL : Paint.Join.MITER;
    }
    ...
    public void updateDrawState(@Nullable TextPaint textPaint) {
        if (textPaint != null) {
            ...
            if (drawStyle instanceof Stroke) {
                ...
                textPaint.setStrokeJoin(m3561toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).getJoin()));
                textPaint.setStrokeCap(m3560toAndroidCapBeK7IIE(((Stroke) this.drawStyle).getCap()));
