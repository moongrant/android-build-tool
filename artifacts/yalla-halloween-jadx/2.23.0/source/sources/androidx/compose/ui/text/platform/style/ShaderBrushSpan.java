...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public ShaderBrushSpan(@NotNull ShaderBrush shaderBrush, float f) {
        ...
        this.alpha = f;
        this.size = Size.INSTANCE.m1513getUnspecifiedNHjbRc();
    }
    ...
    public final void m3563setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public void updateDrawState(@NotNull TextPaint textPaint) {
        ...
        if (this.size == Size.INSTANCE.m1513getUnspecifiedNHjbRc()) {
            return;
        }
        Pair<Size, ? extends Shader> pair = this.cachedShader;
        Shader shaderMo1645createShaderuvyYCjk = (pair == null || !Size.m1501equalsimpl0(pair.getFirst().getPackedValue(), this.size)) ? this.shaderBrush.mo1645createShaderuvyYCjk(this.size) : pair.getSecond();
        textPaint.setShader(shaderMo1645createShaderuvyYCjk);
        this.cachedShader = TuplesKt.to(Size.m1493boximpl(this.size), shaderMo1645createShaderuvyYCjk);
    }
}
