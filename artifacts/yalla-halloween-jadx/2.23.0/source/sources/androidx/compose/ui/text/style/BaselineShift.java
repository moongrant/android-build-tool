...
public final class BaselineShift {
    ...
    private static final float Superscript = m3565constructorimpl(0.5f);
    private static final float Subscript = m3565constructorimpl(-0.5f);
    private static final float None = m3565constructorimpl(0.0f);
    ...
    public static final /* synthetic */ BaselineShift m3564boximpl(float f) {
        return new BaselineShift(f);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static float m3565constructorimpl(float f) {
        return f;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m3566equalsimpl(float f, Object obj) {
        return (obj instanceof BaselineShift) && Float.compare(f, ((BaselineShift) obj).m3570unboximpl()) == 0;
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3567equalsimpl0(float f, float f2) {
        return Float.compare(f, f2) == 0;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m3568hashCodeimpl(float f) {
        return Float.floatToIntBits(f);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m3569toStringimpl(float f) {
        return "BaselineShift(multiplier=" + f + ')';
    }

    public boolean equals(Object obj) {
        return m3566equalsimpl(this.multiplier, obj);
    }
    ...
    public int hashCode() {
        return m3568hashCodeimpl(this.multiplier);
    }

    public String toString() {
        return m3569toStringimpl(this.multiplier);
    }
