...
public final class LineHeightStyle {
    ...
    public static final class Alignment {
        ...
        private static final float Top = m3641constructorimpl(0.0f);
        private static final float Center = m3641constructorimpl(0.5f);
        private static final float Proportional = m3641constructorimpl(-1.0f);
        private static final float Bottom = m3641constructorimpl(1.0f);
        ...
        public static final /* synthetic */ Alignment m3640boximpl(float f) {
            return new Alignment(f);
        }

        /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
        public static float m3641constructorimpl(float f) {
            boolean z = true;
            if (!(0.0f <= f && f <= 1.0f)) {
                if (!(f == -1.0f)) {
                    z = false;
        ...
        public static boolean m3642equalsimpl(float f, Object obj) {
            return (obj instanceof Alignment) && Float.compare(f, ((Alignment) obj).getTopRatio()) == 0;
        }

        /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m3643equalsimpl0(float f, float f2) {
            return Float.compare(f, f2) == 0;
        }

        /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
        public static int m3644hashCodeimpl(float f) {
            return Float.floatToIntBits(f);
        }

        @NotNull
        /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
        public static String m3645toStringimpl(float f) {
            if (f == Top) {
        ...
        public boolean equals(Object obj) {
            return m3642equalsimpl(this.topRatio, obj);
        }

        public int hashCode() {
            return m3644hashCodeimpl(this.topRatio);
        }

        @NotNull
        public String toString() {
            return m3645toStringimpl(this.topRatio);
        }
    ...
    @Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u000b\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0087@\u0018\u0000 \u00162\u00020\u0001:\u0001\u0016B\u0014\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003ø\u0001\u0000¢\u0006\u0004\b\u0004\u0010\u0005J\u001a\u0010\u0006\u001a\u00020\u00072\b\u0010\b\u001a\u0004\u0018\u00010\u0001HÖ\u0003¢\u0006\u0004\b\t\u0010\nJ\u0010\u0010\u000b\u001a\u00020\u0003HÖ\u0001¢\u0006\u0004\b\f\u0010\u0005J\u000f\u0010\r\u001a\u00020\u0007H\u0000¢\u0006\u0004\b\u000e\u0010\u000fJ\u000f\u0010\u0010\u001a\u00020\u0007H\u0000¢\u0006\u0004\b\u0011\u0010\u000fJ\u000f\u0010\u0012\u001a\u00020\u0013H\u0016¢\u0006\u0004\b\u0014\u0010\u0015R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000\u0088\u0001\u0002\u0092\u0001\u00020\u0003ø\u0001\u0000\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\u0017"}, d2 = {"Landroidx/compose/ui/text/style/LineHeightStyle$Trim;", "", AppMeasurementSdk.ConditionalUserProperty.VALUE, "", "constructor-impl", "(I)I", "equals", "", "other", "equals-impl", "(ILjava/lang/Object;)Z", "hashCode", "hashCode-impl", "isTrimFirstLineTop", "isTrimFirstLineTop-impl$ui_text_release", "(I)Z", "isTrimLastLineBottom", "isTrimLastLineBottom-impl$ui_text_release", "toString", "", "toString-impl", "(I)Ljava/lang/String;", "Companion", "ui-text_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    @JvmInline
    public static final class Trim {
        ...
        @NotNull
        public static final Companion INSTANCE = new Companion(null);
        private static final int FirstLineTop = m3652constructorimpl(1);
        private static final int LastLineBottom = m3652constructorimpl(16);
        private static final int Both = m3652constructorimpl(17);
        private static final int None = m3652constructorimpl(0);
        ...
        /* JADX INFO: renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Trim m3651boximpl(int i) {
            return new Trim(i);
        }

        /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
        private static int m3652constructorimpl(int i) {
            return i;
        }
        ...
        public static final boolean m3656isTrimFirstLineTopimpl$ui_text_release(int i) {
            return (i & 1) > 0;
        }

        /* JADX INFO: renamed from: isTrimLastLineBottom-impl$ui_text_release, reason: not valid java name */
        public static final boolean m3657isTrimLastLineBottomimpl$ui_text_release(int i) {
            return (i & 16) > 0;
        }
        ...
        @NotNull
        public String toString() {
            return m3658toStringimpl(this.value);
        }
    ...
    static {
        ...
        Default = new LineHeightStyle(Alignment.INSTANCE.m3649getProportionalPIaL0Z0(), Trim.INSTANCE.m3660getBothEVpEnUU(), defaultConstructorMarker);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Alignment.m3643equalsimpl0(this.alignment, lineHeightStyle.alignment) && Trim.m3654equalsimpl0(this.trim, lineHeightStyle.trim);
    }
    ...
    public int hashCode() {
        return Trim.m3655hashCodeimpl(this.trim) + (Alignment.m3644hashCodeimpl(this.alignment) * 31);
    }

    @NotNull
    public String toString() {
        return "LineHeightStyle(alignment=" + ((Object) Alignment.m3645toStringimpl(this.alignment)) + ", trim=" + ((Object) Trim.m3658toStringimpl(this.trim)) + ')';
    }
