...
public final class TextMotion {
    ...
    public static final class Linearity {
        ...
        private static final int Linear = m3699constructorimpl(1);
        private static final int FontHinting = m3699constructorimpl(2);
        private static final int None = m3699constructorimpl(3);
        ...
        public static final /* synthetic */ Linearity m3698boximpl(int i) {
            return new Linearity(i);
        }

        /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
        private static int m3699constructorimpl(int i) {
            return i;
        }
        ...
        public static String m3703toStringimpl(int i) {
            if (m3701equalsimpl0(i, Linear)) {
                return "Linearity.Linear";
            }
            if (m3701equalsimpl0(i, FontHinting)) {
                return "Linearity.FontHinting";
            }
            return m3701equalsimpl0(i, None) ? "Linearity.None" : "Invalid";
        }
    ...
    static {
        ...
        Static = new TextMotion(companion.m3705getFontHinting4e0Vf04(), false, defaultConstructorMarker);
        Animated = new TextMotion(companion.m3706getLinear4e0Vf04(), true, defaultConstructorMarker);
    }
    ...
    public static /* synthetic */ TextMotion m3695copyJdDtMQo$ui_text_release$default(TextMotion textMotion, int i, boolean z, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return textMotion.m3696copyJdDtMQo$ui_text_release(i, z);
    }

    @NotNull
    /* JADX INFO: renamed from: copy-JdDtMQo$ui_text_release, reason: not valid java name */
    public final TextMotion m3696copyJdDtMQo$ui_text_release(int linearity, boolean subpixelTextPositioning) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Linearity.m3701equalsimpl0(this.linearity, textMotion.linearity) && this.subpixelTextPositioning == textMotion.subpixelTextPositioning;
    }
    ...
    public int hashCode() {
        return (Linearity.m3702hashCodeimpl(this.linearity) * 31) + (this.subpixelTextPositioning ? 1231 : 1237);
    }
