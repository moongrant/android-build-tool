...
public final /* data */ class DpRect {
    ...
    public static /* synthetic */ DpRect m3837copya9UjIt4$default(DpRect dpRect, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = dpRect.left;
        }
        if ((i & 2) != 0) {
        ...
        return dpRect.m3846copya9UjIt4(f, f2, f3, f4);
    }
    ...
    public final DpRect m3846copya9UjIt4(float left, float top, float right, float bottom) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Dp.m3770equalsimpl0(this.left, dpRect.left) && Dp.m3770equalsimpl0(this.top, dpRect.top) && Dp.m3770equalsimpl0(this.right, dpRect.right) && Dp.m3770equalsimpl0(this.bottom, dpRect.bottom);
    }
    ...
    public int hashCode() {
        return Dp.m3771hashCodeimpl(this.bottom) + OooO0o.OooO00o(this.right, OooO0o.OooO00o(this.top, Dp.m3771hashCodeimpl(this.left) * 31, 31), 31);
    }

    @NotNull
    public String toString() {
        return "DpRect(left=" + ((Object) Dp.m3776toStringimpl(this.left)) + ", top=" + ((Object) Dp.m3776toStringimpl(this.top)) + ", right=" + ((Object) Dp.m3776toStringimpl(this.right)) + ", bottom=" + ((Object) Dp.m3776toStringimpl(this.bottom)) + ')';
    }
    ...
    private DpRect(long j, long j2) {
        this(DpOffset.m3826getXD9Ej5fM(j), DpOffset.m3828getYD9Ej5fM(j), Dp.m3765constructorimpl(DpSize.m3863getWidthD9Ej5fM(j2) + DpOffset.m3826getXD9Ej5fM(j)), Dp.m3765constructorimpl(DpSize.m3861getHeightD9Ej5fM(j2) + DpOffset.m3828getYD9Ej5fM(j)), null);
    }
}
