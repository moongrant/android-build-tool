...
public final /* data */ class IntRect {
    ...
    public static /* synthetic */ void m3901getSizeYbymL2g$annotations() {
    }
    ...
    public final boolean m3902containsgyyYBs(long offset) {
        return IntOffset.m3883getXimpl(offset) >= this.left && IntOffset.m3883getXimpl(offset) < this.right && IntOffset.m3884getYimpl(offset) >= this.top && IntOffset.m3884getYimpl(offset) < this.bottom;
    }
    ...
    public final long m3903getBottomCenternOccac() {
    ...
    public final long m3904getBottomLeftnOccac() {
    ...
    public final long m3907getCenterLeftnOccac() {
    ...
    public final long m3908getCenterRightnOccac() {
    ...
    public final long m3909getSizeYbymL2g() {
    ...
    public final long m3910getTopCenternOccac() {
    ...
    public final IntRect m3913translategyyYBs(long offset) {
        return new IntRect(IntOffset.m3883getXimpl(offset) + this.left, IntOffset.m3884getYimpl(offset) + this.top, IntOffset.m3883getXimpl(offset) + this.right, IntOffset.m3884getYimpl(offset) + this.bottom);
    }
}
