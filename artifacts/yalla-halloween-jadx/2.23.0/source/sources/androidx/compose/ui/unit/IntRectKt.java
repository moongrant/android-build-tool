...
public final class IntRectKt {
    ...
    public static final IntRect m3914IntRectE1MhUcY(long j, long j2) {
        return new IntRect(IntOffset.m3883getXimpl(j), IntOffset.m3884getYimpl(j), IntOffset.m3883getXimpl(j2), IntOffset.m3884getYimpl(j2));
    }

    @Stable
    @NotNull
    /* JADX INFO: renamed from: IntRect-VbeCjmY, reason: not valid java name */
    public static final IntRect m3915IntRectVbeCjmY(long j, long j2) {
        return new IntRect(IntOffset.m3883getXimpl(j), IntOffset.m3884getYimpl(j), IntSize.m3925getWidthimpl(j2) + IntOffset.m3883getXimpl(j), IntSize.m3924getHeightimpl(j2) + IntOffset.m3884getYimpl(j));
    }

    @Stable
    @NotNull
    /* JADX INFO: renamed from: IntRect-ar5cAso, reason: not valid java name */
    public static final IntRect m3916IntRectar5cAso(long j, int i) {
        return new IntRect(IntOffset.m3883getXimpl(j) - i, IntOffset.m3884getYimpl(j) - i, IntOffset.m3883getXimpl(j) + i, IntOffset.m3884getYimpl(j) + i);
    }
