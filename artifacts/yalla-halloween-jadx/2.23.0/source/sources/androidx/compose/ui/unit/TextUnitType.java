...
public final class TextUnitType {
    ...
    private static final long Unspecified = m3972constructorimpl(0);
    private static final long Sp = m3972constructorimpl(4294967296L);
    private static final long Em = m3972constructorimpl(8589934592L);
    ...
    public static final /* synthetic */ TextUnitType m3971boximpl(long j) {
    ...
    public static boolean m3973equalsimpl(long j, Object obj) {
        return (obj instanceof TextUnitType) && j == ((TextUnitType) obj).getType();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3974equalsimpl0(long j, long j2) {
        return j == j2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m3975hashCodeimpl(long j) {
        return (int) (j ^ (j >>> 32));
    }

    @NotNull
    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m3976toStringimpl(long j) {
        if (m3974equalsimpl0(j, Unspecified)) {
            return "Unspecified";
        }
        if (m3974equalsimpl0(j, Sp)) {
            return "Sp";
        }
        return m3974equalsimpl0(j, Em) ? "Em" : "Invalid";
    }

    public boolean equals(Object obj) {
        return m3973equalsimpl(this.type, obj);
    }

    public int hashCode() {
        return m3975hashCodeimpl(this.type);
    }

    @NotNull
    public String toString() {
        return m3976toStringimpl(this.type);
    }
