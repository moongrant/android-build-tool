...
public class AndroidViewHolder extends ViewGroup implements o0O0O00, ComposeNodeLifecycleCallback {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                ...
                if (this.$consumed) {
                    ...
                    long jM4001getZero9UxMQ8M = Velocity.INSTANCE.m4001getZero9UxMQ8M();
                    this.label = 2;
                    if (nestedScrollDispatcher.m2587dispatchPostFlingRZ2iAVY(j, jM4001getZero9UxMQ8M, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    NestedScrollDispatcher nestedScrollDispatcher2 = this.this$0.dispatcher;
                    long jM4001getZero9UxMQ8M2 = Velocity.INSTANCE.m4001getZero9UxMQ8M();
                    long j2 = this.$viewVelocity;
                    this.label = 1;
                    if (nestedScrollDispatcher2.m2587dispatchPostFlingRZ2iAVY(jM4001getZero9UxMQ8M2, j2, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                }
            } else {
    ...
    public static final class C08511 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C08511(long j, Continuation<? super C08511> continuation) {
            super(2, continuation);
            this.$toBeConsumed = j;
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return AndroidViewHolder.this.new C08511(this.$toBeConsumed, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (nestedScrollDispatcher.m2589dispatchPreFlingQWom1Mo(j, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
        ...
        layoutNode.setMeasurePolicy(new MeasurePolicy() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5
            ...
            public MeasureResult mo3measure3p2s80s(@NotNull MeasureScope measure, @NotNull List<? extends Measurable> measurables, long j) {
                ...
                if (this.$this_run.getChildCount() == 0) {
                    return MeasureScope.CC.OooOOo0(measure, Constraints.m3735getMinWidthimpl(j), Constraints.m3734getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5$measure$1
                        /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                ...
                if (Constraints.m3735getMinWidthimpl(j) != 0) {
                    this.$this_run.getChildAt(0).setMinimumWidth(Constraints.m3735getMinWidthimpl(j));
                }
                if (Constraints.m3734getMinHeightimpl(j) != 0) {
                    this.$this_run.getChildAt(0).setMinimumHeight(Constraints.m3734getMinHeightimpl(j));
                }
                AndroidViewHolder androidViewHolder = this.$this_run;
                ...
                Intrinsics.checkNotNull(layoutParams);
                int iObtainMeasureSpec = androidViewHolder.obtainMeasureSpec(iM3735getMinWidthimpl, iM3733getMaxWidthimpl, layoutParams.width);
                AndroidViewHolder androidViewHolder2 = this.$this_run;
                ...
                androidViewHolder.measure(iObtainMeasureSpec, androidViewHolder2.obtainMeasureSpec(iM3734getMinHeightimpl, iM3732getMaxHeightimpl, layoutParams2.height));
    ...
    public boolean onNestedPreFling(@NotNull View target, float velocityX, float velocityY) {
        ...
        BuildersKt__Builders_commonKt.launch$default(this.dispatcher.getCoroutineScope(), null, null, new C08511(VelocityKt.Velocity(AndroidViewHolder_androidKt.toComposeVelocity(velocityX), AndroidViewHolder_androidKt.toComposeVelocity(velocityY)), null), 3, null);
        return false;
    }
    ...
    public void onNestedPreScroll(@NotNull View target, int dx, int dy, @NotNull int[] consumed, int type) {
        ...
        if (isNestedScrollingEnabled()) {
            long jM2590dispatchPreScrollOzD1aCk = this.dispatcher.m2590dispatchPreScrollOzD1aCk(OffsetKt.Offset(AndroidViewHolder_androidKt.toComposeOffset(dx), AndroidViewHolder_androidKt.toComposeOffset(dy)), AndroidViewHolder_androidKt.toNestedScrollSource(type));
            consumed[0] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m1436getXimpl(jM2590dispatchPreScrollOzD1aCk));
            consumed[1] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m1437getYimpl(jM2590dispatchPreScrollOzD1aCk));
        }
    }
    ...
    public void onNestedScroll(@NotNull View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type, @NotNull int[] consumed) {
        ...
        Intrinsics.checkNotNullParameter(consumed, "consumed");
        if (isNestedScrollingEnabled()) {
            long jM2588dispatchPostScrollDzOQY0M = this.dispatcher.m2588dispatchPostScrollDzOQY0M(OffsetKt.Offset(AndroidViewHolder_androidKt.toComposeOffset(dxConsumed), AndroidViewHolder_androidKt.toComposeOffset(dyConsumed)), OffsetKt.Offset(AndroidViewHolder_androidKt.toComposeOffset(dxUnconsumed), AndroidViewHolder_androidKt.toComposeOffset(dyUnconsumed)), AndroidViewHolder_androidKt.toNestedScrollSource(type));
            consumed[0] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m1436getXimpl(jM2588dispatchPostScrollDzOQY0M));
            consumed[1] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m1437getYimpl(jM2588dispatchPostScrollDzOQY0M));
        }
    }
    ...
    public void onNestedScroll(@NotNull View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type) {
        Intrinsics.checkNotNullParameter(target, "target");
        if (isNestedScrollingEnabled()) {
            this.dispatcher.m2588dispatchPostScrollDzOQY0M(OffsetKt.Offset(AndroidViewHolder_androidKt.toComposeOffset(dxConsumed), AndroidViewHolder_androidKt.toComposeOffset(dyConsumed)), OffsetKt.Offset(AndroidViewHolder_androidKt.toComposeOffset(dxUnconsumed), AndroidViewHolder_androidKt.toComposeOffset(dyUnconsumed)), AndroidViewHolder_androidKt.toNestedScrollSource(type));
        }
    }
}
