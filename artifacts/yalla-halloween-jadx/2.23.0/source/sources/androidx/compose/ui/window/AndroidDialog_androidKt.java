...
public final class AndroidDialog_androidKt {
    ...
    public static final void Dialog(@NotNull final Function0<Unit> onDismissRequest, @Nullable DialogProperties dialogProperties, @NotNull final Function2<? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, final int i, final int i2) {
        ...
        if (i5 == 0) {
            ...
            if ((i3 & 731) == 146 || !composerStartRestartGroup.getSkipping()) {
                ...
                dialogId = (UUID) RememberSaveableKt.m1322rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) new Function0<UUID>() { // from class: androidx.compose.ui.window.AndroidDialog_androidKt$Dialog$dialogId$1
    ...
    public static final void DialogLayout(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 91) == 18 && composerStartRestartGroup.getSkipping()) {
            ...
            C08531 c08531 = new MeasurePolicy() { // from class: androidx.compose.ui.window.AndroidDialog_androidKt.DialogLayout.1
                ...
                public final MeasureResult mo3measure3p2s80s(@NotNull MeasureScope Layout, @NotNull List<? extends Measurable> measurables, long j) {
                    ...
                    int width3 = placeable != null ? placeable.getWidth() : Constraints.m3735getMinWidthimpl(j);
                    if (!arrayList.isEmpty()) {
                    ...
                    return MeasureScope.CC.OooOOo0(Layout, width3, placeable2 != null ? placeable2.getHeight() : Constraints.m3734getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.window.AndroidDialog_androidKt$DialogLayout$1$measure$1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        /* JADX WARN: Multi-variable type inference failed */
                        {
                            super(1);
            ...
            Updater.m1316setimpl(composerM1309constructorimpl, c08531, companion.getSetMeasurePolicy());
