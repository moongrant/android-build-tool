...
final class DialogWrapper extends OooOo00 implements ViewRootForInspector {
    ...
    public DialogWrapper(@NotNull Function0<Unit> onDismissRequest, @NotNull DialogProperties properties, @NotNull View composeView, @NotNull LayoutDirection layoutDirection, @NotNull Density density, @NotNull UUID dialogId) {
        ...
        o000OO00.OooO00o(window, this.properties.getDecorFitsSystemWindows());
        Context context = getContext();
        Intrinsics.checkNotNullExpressionValue(context, "context");
        DialogLayout dialogLayout = new DialogLayout(context, window);
        dialogLayout.setTag(R.id.compose_view_saveable_id_tag, "Dialog:" + dialogId);
        dialogLayout.setClipChildren(false);
        dialogLayout.setElevation(density.mo324toPx0680j_4(fM3765constructorimpl));
        ...
        Function1<Oooo000, Unit> onBackPressed = new Function1<Oooo000, Unit>() { // from class: androidx.compose.ui.window.DialogWrapper.2
            {
                super(1);
            }

            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(Oooo000 oooo000) {
                invoke2(oooo000);
                return Unit.INSTANCE;
            }

            /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(@NotNull Oooo000 addCallback) {
        ...
        onBackPressedDispatcher.OooO00o(this, new o000oOoO(true, onBackPressed));
    }
