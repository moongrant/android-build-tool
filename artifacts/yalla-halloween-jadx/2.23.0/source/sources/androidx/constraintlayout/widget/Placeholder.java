...
public class Placeholder extends View {
    ...
    public int f5174OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public int f5175OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public View f5176OooO0o0;
    ...
    public final void OooO00o(AttributeSet attributeSet) {
        super.setVisibility(this.f5175OooO0o);
        this.f5174OooO0Oo = -1;
        if (attributeSet != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == OooO.ConstraintLayout_placeholder_content) {
                    this.f5174OooO0Oo = typedArrayObtainStyledAttributes.getResourceId(index, this.f5174OooO0Oo);
                } else if (index == OooO.ConstraintLayout_placeholder_placeholder_emptyVisibility) {
                    this.f5175OooO0o = typedArrayObtainStyledAttributes.getInt(index, this.f5175OooO0o);
                }
            }
    ...
    public View getContent() {
        return this.f5176OooO0o0;
    }

    public int getEmptyVisibility() {
        return this.f5175OooO0o;
    }
    ...
    public void setContentId(int i) {
        ...
        if (this.f5174OooO0Oo == i) {
            return;
        }
        View view = this.f5176OooO0o0;
        if (view != null) {
            view.setVisibility(0);
            ((ConstraintLayout.LayoutParams) this.f5176OooO0o0.getLayoutParams()).f4978OooooOo = false;
            this.f5176OooO0o0 = null;
        }
        this.f5174OooO0Oo = i;
