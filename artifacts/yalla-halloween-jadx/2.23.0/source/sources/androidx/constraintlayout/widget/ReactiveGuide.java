...
public class ReactiveGuide extends View implements OooOO0.OooO00o {
    ...
    public int f5177OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public int f5178OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public boolean f5179OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public boolean f5180OooO0oO;

    public ReactiveGuide(Context context) {
        super(context);
        this.f5177OooO0Oo = -1;
        this.f5179OooO0o0 = false;
        this.f5178OooO0o = 0;
        this.f5180OooO0oO = true;
        ...
        if (attributeSet != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == OooO.ConstraintLayout_ReactiveGuide_reactiveGuide_valueId) {
                    this.f5177OooO0Oo = typedArrayObtainStyledAttributes.getResourceId(index, this.f5177OooO0Oo);
                } else if (index == OooO.ConstraintLayout_ReactiveGuide_reactiveGuide_animateChange) {
                    this.f5179OooO0o0 = typedArrayObtainStyledAttributes.getBoolean(index, this.f5179OooO0o0);
                } else if (index == OooO.ConstraintLayout_ReactiveGuide_reactiveGuide_applyToConstraintSet) {
                    this.f5178OooO0o = typedArrayObtainStyledAttributes.getResourceId(index, this.f5178OooO0o);
                } else if (index == OooO.ConstraintLayout_ReactiveGuide_reactiveGuide_applyToAllConstraintSets) {
                    this.f5180OooO0oO = typedArrayObtainStyledAttributes.getBoolean(index, this.f5180OooO0oO);
                }
            }
            typedArrayObtainStyledAttributes.recycle();
        }
        if (this.f5177OooO0Oo != -1) {
            ConstraintLayout.getSharedValues().OooO00o(this.f5177OooO0Oo, this);
        }
    }
    ...
    public int getApplyToConstraintSetId() {
        return this.f5178OooO0o;
    }

    public int getAttributeId() {
        return this.f5177OooO0Oo;
    }
    ...
    public void setAttributeId(int i) {
        ...
        int i2 = this.f5177OooO0Oo;
        if (i2 != -1 && (hashSet = sharedValues.f5163OooO00o.get(Integer.valueOf(i2))) != null) {
