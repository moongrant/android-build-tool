...
public class CoordinatorLayout extends ViewGroup implements oo0o0Oo, o0O0O00 {
    ...
    public static final Class<?>[] f5183OooOo;

    /* JADX INFO: renamed from: OooOo0o, reason: collision with root package name */
    public static final String f5184OooOo0o;

    /* JADX INFO: renamed from: OooOoO, reason: collision with root package name */
    public static final OooOO0 f5185OooOoO;

    /* JADX INFO: renamed from: OooOoO0, reason: collision with root package name */
    public static final ThreadLocal<Map<String, Constructor<Behavior>>> f5186OooOoO0;

    /* JADX INFO: renamed from: OooOoOO, reason: collision with root package name */
    public static final OooOO0O f5187OooOoOO;

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    public final int[] f5188OooO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final ArrayList f5189OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final ArrayList f5190OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final o00000.OooO0OO<View> f5191OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final ArrayList f5192OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final int[] f5193OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public boolean f5194OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public boolean f5195OooOO0O;

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    public final int[] f5196OooOO0o;

    /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
    public View f5197OooOOO;

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    public View f5198OooOOO0;

    /* JADX INFO: renamed from: OooOOOO, reason: collision with root package name */
    public OooO f5199OooOOOO;

    /* JADX INFO: renamed from: OooOOOo, reason: collision with root package name */
    public boolean f5200OooOOOo;

    /* JADX INFO: renamed from: OooOOo, reason: collision with root package name */
    public boolean f5201OooOOo;

    /* JADX INFO: renamed from: OooOOo0, reason: collision with root package name */
    public WindowInsetsCompat f5202OooOOo0;

    /* JADX INFO: renamed from: OooOOoo, reason: collision with root package name */
    public Drawable f5203OooOOoo;

    /* JADX INFO: renamed from: OooOo0, reason: collision with root package name */
    public OooO00o f5204OooOo0;

    /* JADX INFO: renamed from: OooOo00, reason: collision with root package name */
    public ViewGroup.OnHierarchyChangeListener f5205OooOo00;

    /* JADX INFO: renamed from: OooOo0O, reason: collision with root package name */
    public final o000000 f5206OooOo0O;
    ...
    public class OooO00o implements o000000O {
        ...
        public final WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
            ...
            if (!o000OO.OooO0OO.OooO00o(coordinatorLayout.f5202OooOOo0, windowInsetsCompat)) {
                coordinatorLayout.f5202OooOOo0 = windowInsetsCompat;
                boolean z = windowInsetsCompat.OooO0o() > 0;
                coordinatorLayout.f5201OooOOo = z;
                ...
                if (!oooOo00.OooOOO()) {
                    ...
                    for (int i = 0; i < childCount; i++) {
                        ...
                        if (ViewCompat.OooO0o.OooO0O0(childAt) && ((OooO0o) childAt.getLayoutParams()).f5211OooO00o != null && oooOo00.OooOOO()) {
                            break;
                        }
                    }
                }
    ...
    public class OooO0OO implements ViewGroup.OnHierarchyChangeListener {
        ...
        public final void onChildViewAdded(View view, View view2) {
            ViewGroup.OnHierarchyChangeListener onHierarchyChangeListener = CoordinatorLayout.this.f5205OooOo00;
        ...
        public final void onChildViewRemoved(View view, View view2) {
            ...
            ViewGroup.OnHierarchyChangeListener onHierarchyChangeListener = coordinatorLayout.f5205OooOo00;
            if (onHierarchyChangeListener != null) {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public SparseArray<Parcelable> f5227OooO0o;
        ...
        public SavedState(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f5227OooO0o = new SparseArray<>(i);
            for (int i2 = 0; i2 < i; i2++) {
                this.f5227OooO0o.append(iArr[i2], parcelableArray[i2]);
            }
        }
        ...
        public final void writeToParcel(Parcel parcel, int i) {
            ...
            SparseArray<Parcelable> sparseArray = this.f5227OooO0o;
            int size = sparseArray != null ? sparseArray.size() : 0;
            parcel.writeInt(size);
            int[] iArr = new int[size];
            Parcelable[] parcelableArr = new Parcelable[size];
            for (int i2 = 0; i2 < size; i2++) {
                iArr[i2] = this.f5227OooO0o.keyAt(i2);
                parcelableArr[i2] = this.f5227OooO0o.valueAt(i2);
            }
    ...
    static {
        ...
        f5184OooOo0o = r0 != null ? r0.getName() : null;
        f5185OooOoO = new OooOO0();
        f5183OooOo = new Class[]{Context.class, AttributeSet.class};
        f5186OooOoO0 = new ThreadLocal<>();
        f5187OooOoOO = new OooOO0O(12);
    }
    ...
    public static Rect OooO0o0() {
        Rect rect = (Rect) f5187OooOoOO.OooO0O0();
    ...
    public static void OooOO0O(int i, Rect rect, Rect rect2, OooO0o oooO0o, int i2, int i3) {
        int iWidth;
        int iHeight;
        int i4 = oooO0o.f5213OooO0OO;
        if (i4 == 0) {
            i4 = 17;
        }
        int absoluteGravity = Gravity.getAbsoluteGravity(i4, i);
        int i5 = oooO0o.f5214OooO0Oo;
        if ((i5 & 7) == 0) {
            i5 |= 8388611;
        }
        if ((i5 & 112) == 0) {
    ...
    public static void OooOo0O(int i, View view) {
        OooO0o oooO0o = (OooO0o) view.getLayoutParams();
        int i2 = oooO0o.f5219OooOO0;
        if (i2 != i) {
            WeakHashMap<View, o000O0Oo> weakHashMap = ViewCompat.f5334OooO00o;
            view.offsetTopAndBottom(i - i2);
            oooO0o.f5219OooOO0 = i;
        }
    }

    @NonNull
    public final ArrayList OooO(@NonNull View view) {
        Oooo000<View, ArrayList<View>> oooo000 = this.f5191OooO0o0.f33730OooO0O0;
        int i = oooo000.f38816OooO0o;
        ArrayList arrayList = null;
        for (int i2 = 0; i2 < i; i2++) {
            ArrayList<View> arrayListOooOO0o = oooo000.OooOO0o(i2);
            if (arrayListOooOO0o != null && arrayListOooOO0o.contains(view)) {
                if (arrayList == null) {
                    arrayList = new ArrayList();
                }
                arrayList.add(oooo000.OooO0oo(i2));
            }
        }
        ArrayList arrayList2 = this.f5192OooO0oO;
        arrayList2.clear();
        if (arrayList != null) {
    ...
    public final void OooO0oO(@NonNull View view) {
        ArrayList<View> orDefault = this.f5191OooO0o0.f33730OooO0O0.getOrDefault(view, null);
        if (orDefault == null || orDefault.isEmpty()) {
            return;
        }
        for (int i = 0; i < orDefault.size(); i++) {
            View view2 = orDefault.get(i);
            Behavior behavior = ((OooO0o) view2.getLayoutParams()).f5211OooO00o;
            if (behavior != null) {
    ...
    public final void OooOO0(View view, Rect rect) {
        ThreadLocal<Matrix> threadLocal = o00000.OooO0o.f33733OooO00o;
        rect.set(0, 0, view.getWidth(), view.getHeight());
        ThreadLocal<Matrix> threadLocal2 = o00000.OooO0o.f33733OooO00o;
        ...
        ThreadLocal<RectF> threadLocal3 = o00000.OooO0o.f33734OooO0O0;
    ...
    public final void OooOOOO(int i) {
        ...
        ArrayList arrayList2 = this.f5189OooO0Oo;
        ...
        while (true) {
            ...
            if (i10 == 0 && view2.getVisibility() == 8) {
                ...
                while (i12 < i11) {
                    if (oooO0o.f5221OooOO0o == ((View) arrayList2.get(i12))) {
                        ...
                        if (oooO0o2.f5220OooOO0O != null) {
                            ...
                            if (z4 && (behavior = r16.f5211OooO00o) != null) {
                                behavior.OooO0Oo(this, view, oooO0o2.f5220OooOO0O);
                            }
                ...
                if (oooO0o3.f5217OooO0oO != 0 && !rectOooO0o1.isEmpty()) {
                    int absoluteGravity = Gravity.getAbsoluteGravity(oooO0o3.f5217OooO0oO, iOooO0Oo);
                ...
                if (oooO0o3.f5218OooO0oo != 0 && view3.getVisibility() == 0) {
                    ...
                    if (ViewCompat.OooOO0O.OooO0OO(view3) && view3.getWidth() > 0 && view3.getHeight() > 0) {
                        ...
                        Behavior behavior2 = oooO0o4.f5211OooO00o;
                        ...
                        if (rectOooO0o6.isEmpty()) {
                            ...
                            int absoluteGravity2 = Gravity.getAbsoluteGravity(oooO0o4.f5218OooO0oo, iOooO0Oo);
                            if ((absoluteGravity2 & 48) != 48 || (i8 = (rectOooO0o6.top - ((ViewGroup.MarginLayoutParams) oooO0o4).topMargin) - oooO0o4.f5219OooOO0) >= (i9 = rectOooO0o0.top)) {
                                z = false;
                            } else {
                                OooOo0O(i9 - i8, view3);
                                z = true;
                            }
                            if ((absoluteGravity2 & 80) == 80 && (height = ((getHeight() - rectOooO0o6.bottom) - ((ViewGroup.MarginLayoutParams) oooO0o4).bottomMargin) + oooO0o4.f5219OooOO0) < (i7 = rectOooO0o0.bottom)) {
                            ...
                            if ((absoluteGravity2 & 3) != 3 || (i5 = (rectOooO0o6.left - ((ViewGroup.MarginLayoutParams) oooO0o4).leftMargin) - oooO0o4.f5210OooO) >= (i6 = rectOooO0o0.left)) {
                                z2 = false;
                            } else {
                                OooOo0(i6 - i5, view3);
                                z2 = true;
                            }
                            if ((absoluteGravity2 & 5) != 5 || (width = ((getWidth() - rectOooO0o6.right) - ((ViewGroup.MarginLayoutParams) oooO0o4).rightMargin) + oooO0o4.f5210OooO) >= (i4 = rectOooO0o0.right)) {
                                z3 = z2;
                            } else {
                ...
                if (i != 2) {
                    rect = rect3;
                    rect.set(((OooO0o) view3.getLayoutParams()).f5226OooOOo0);
                    if (rect.equals(rectOooO0o1)) {
                        arrayList = arrayList3;
                        i3 = i15;
                    } else {
                        ((OooO0o) view3.getLayoutParams()).f5226OooOOo0.set(rectOooO0o1);
                    }
                    i10 = i;
                } else {
                    rect = rect3;
                ...
                while (true) {
                    ...
                    Behavior behavior3 = oooO0o5.f5211OooO00o;
                    if (behavior3 != null && behavior3.OooO0O0(view4, view3)) {
                        if (i == 0 && oooO0o5.f5225OooOOOo) {
                            oooO0o5.f5225OooOOOo = false;
                        } else {
                            if (i != 2) {
    ...
    public final void OooOOOo(int i, @NonNull View view) {
        OooO0o oooO0o = (OooO0o) view.getLayoutParams();
        View view2 = oooO0o.f5220OooOO0O;
        int i2 = 0;
        if (view2 == null && oooO0o.f5215OooO0o != -1) {
        ...
        if (i3 < 0) {
            ...
            if (this.f5202OooOOo0 != null) {
                WeakHashMap<View, o000O0Oo> weakHashMap = ViewCompat.f5334OooO00o;
                if (ViewCompat.OooO0o.OooO0O0(this) && !ViewCompat.OooO0o.OooO0O0(view)) {
                    rectOooO0o2.left = this.f5202OooOOo0.OooO0Oo() + rectOooO0o2.left;
                    rectOooO0o2.top = this.f5202OooOOo0.OooO0o() + rectOooO0o2.top;
                    rectOooO0o2.right -= this.f5202OooOOo0.OooO0o0();
                    rectOooO0o2.bottom -= this.f5202OooOOo0.OooO0OO();
                }
            }
            Rect rectOooO0o3 = OooO0o0();
            int i4 = oooO0o3.f5213OooO0OO;
            if ((i4 & 7) == 0) {
                i4 |= 8388611;
            }
            if ((i4 & 112) == 0) {
    ...
    public final boolean OooOOo(MotionEvent motionEvent, int i) {
        ...
        ArrayList arrayList = this.f5190OooO0o;
        arrayList.clear();
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            OooO0o oooO0o = (OooO0o) view.getLayoutParams();
            Behavior behavior = oooO0o.f5211OooO00o;
            if (!(zOooO0oO || z2) || actionMasked == 0) {
                if (!zOooO0oO && behavior != null) {
                    ...
                    if (zOooO0oO) {
                        this.f5198OooOOO0 = view;
                    }
                }
                if (oooO0o.f5211OooO00o == null) {
                    oooO0o.f5223OooOOO0 = false;
                }
                boolean z3 = oooO0o.f5223OooOOO0;
                if (z3) {
                    z = true;
                } else {
                    z = z3 | false;
                    oooO0o.f5223OooOOO0 = z;
                }
                z2 = z && !z3;
                if (z && !z2) {
                    break;
    ...
    public final void OooOo00(boolean z) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            Behavior behavior = ((OooO0o) childAt.getLayoutParams()).f5211OooO00o;
            if (behavior != null) {
                long jUptimeMillis = SystemClock.uptimeMillis();
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ((OooO0o) getChildAt(i2).getLayoutParams()).f5223OooOOO0 = false;
        }
        this.f5198OooOOO0 = null;
        this.f5194OooOO0 = false;
    }
    ...
    public final void OooOo0o() {
        ...
        if (this.f5204OooOo0 == null) {
            this.f5204OooOo0 = new OooO00o();
        }
        ViewCompat.OooOOO.OooOo0(this, this.f5204OooOo0);
    ...
    public final boolean drawChild(Canvas canvas, View view, long j) {
        Behavior behavior = ((OooO0o) view.getLayoutParams()).f5211OooO00o;
        if (behavior != null) {
            behavior.getClass();
        }
    ...
    public final void drawableStateChanged() {
        ...
        Drawable drawable = this.f5203OooOOoo;
        boolean state = false;
    ...
    public final List<View> getDependencySortedChildren() {
        OooOOoo();
        return Collections.unmodifiableList(this.f5189OooO0Oo);
    }

    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public final WindowInsetsCompat getLastWindowInsets() {
        return this.f5202OooOOo0;
    }

    @Override // android.view.ViewGroup
    public int getNestedScrollAxes() {
        o000000 o000000Var = this.f5206OooOo0O;
        return o000000Var.f5414OooO0O0 | o000000Var.f5413OooO00o;
    }

    @Nullable
    public Drawable getStatusBarBackground() {
        return this.f5203OooOOoo;
    }
    ...
    public final void onAttachedToWindow() {
        ...
        OooOo00(false);
        if (this.f5200OooOOOo) {
            if (this.f5199OooOOOO == null) {
                this.f5199OooOOOO = new OooO();
            }
            getViewTreeObserver().addOnPreDrawListener(this.f5199OooOOOO);
        }
        if (this.f5202OooOOo0 == null) {
            WeakHashMap<View, o000O0Oo> weakHashMap = ViewCompat.f5334OooO00o;
            if (ViewCompat.OooO0o.OooO0O0(this)) {
    ...
    public final void onDetachedFromWindow() {
        ...
        OooOo00(false);
        if (this.f5200OooOOOo && this.f5199OooOOOO != null) {
            getViewTreeObserver().removeOnPreDrawListener(this.f5199OooOOOO);
        }
        View view = this.f5197OooOOO;
        if (view != null) {
            onStopNestedScroll(view);
        }
        this.f5195OooOO0O = false;
    }

    @Override // android.view.View
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (!this.f5201OooOOo || this.f5203OooOOoo == null) {
            return;
        }
        WindowInsetsCompat windowInsetsCompat = this.f5202OooOOo0;
        int iOooO0o = windowInsetsCompat != null ? windowInsetsCompat.OooO0o() : 0;
        if (iOooO0o > 0) {
            this.f5203OooOOoo.setBounds(0, 0, getWidth(), iOooO0o);
            this.f5203OooOOoo.draw(canvas);
        }
    }
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        WeakHashMap<View, o000O0Oo> weakHashMap = ViewCompat.f5334OooO00o;
        int iOooO0Oo = ViewCompat.OooO.OooO0Oo(this);
        ArrayList arrayList = this.f5189OooO0Oo;
        int size = arrayList.size();
        for (int i5 = 0; i5 < size; i5++) {
            View view = (View) arrayList.get(i5);
            if (view.getVisibility() != 8 && ((behavior = ((OooO0o) view.getLayoutParams()).f5211OooO00o) == null || !behavior.OooO0oo(this, view, iOooO0Oo))) {
    ...
    public final void onMeasure(int i, int i2) {
        ...
        while (true) {
            ...
            Oooo000<View, ArrayList<View>> oooo000 = this.f5191OooO0o0.f33730OooO0O0;
            int i14 = oooo000.f38816OooO0o;
            int i15 = 0;
            while (true) {
                if (i15 < i14) {
                    ArrayList<View> arrayListOooOO0o = oooo000.OooOO0o(i15);
        ...
        if (z != this.f5200OooOOOo) {
            if (z) {
                if (this.f5195OooOO0O) {
                    if (this.f5199OooOOOO == null) {
                        this.f5199OooOOOO = new OooO();
                    }
                    getViewTreeObserver().addOnPreDrawListener(this.f5199OooOOOO);
                }
                this.f5200OooOOOo = true;
            } else {
                if (this.f5195OooOO0O && this.f5199OooOOOO != null) {
                    getViewTreeObserver().removeOnPreDrawListener(this.f5199OooOOOO);
                }
                this.f5200OooOOOo = false;
            }
        }
        ...
        boolean z5 = this.f5202OooOOo0 != null && ViewCompat.OooO0o.OooO0O0(this);
        ArrayList arrayList2 = this.f5189OooO0Oo;
            ...
            if (view.getVisibility() == 8) {
                ...
                if (i22 < 0 || mode == 0) {
                    ...
                    if (z5 || ViewCompat.OooO0o.OooO0O0(view)) {
                        ...
                        int iOooO0o0 = this.f5202OooOOo0.OooO0o0() + this.f5202OooOOo0.OooO0Oo();
                        int iOooO0OO = this.f5202OooOOo0.OooO0OO() + this.f5202OooOOo0.OooO0o();
    ...
    public final boolean onNestedPreFling(View view, float f, float f2) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childAt.getVisibility() != 8) {
                OooO0o oooO0o = (OooO0o) childAt.getLayoutParams();
                if (oooO0o.OooO00o(0) && (behavior = oooO0o.f5211OooO00o) != null) {
    ...
    public final void onRestoreInstanceState(Parcelable parcelable) {
        ...
        SparseArray<Parcelable> sparseArray = savedState.f5227OooO0o;
        int childCount = getChildCount();
        for (int i = 0; i < childCount; i++) {
            View childAt = getChildAt(i);
            int id = childAt.getId();
            Behavior behavior = OooOOO0(childAt).f5211OooO00o;
    ...
    public final Parcelable onSaveInstanceState() {
        ...
        savedState.f5227OooO0o = sparseArray;
        return savedState;
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        zOooOOo = false;
        Behavior behavior = ((OooO0o) this.f5198OooOOO0.getLayoutParams()).f5211OooO00o;
        if (behavior != null) {
            zOooOOoo = behavior.OooOOoo(this, this.f5198OooOOO0, motionEvent);
        } else {
            zOooOOoo = false;
        }
        motionEventObtain = null;
    ...
    public final void requestDisallowInterceptTouchEvent(boolean z) {
        ...
        if (!z || this.f5194OooOO0) {
            return;
        }
        OooOo00(false);
        this.f5194OooOO0 = true;
    }
    ...
    public void setOnHierarchyChangeListener(ViewGroup.OnHierarchyChangeListener onHierarchyChangeListener) {
        this.f5205OooOo00 = onHierarchyChangeListener;
    }

    public void setStatusBarBackground(@Nullable Drawable drawable) {
        Drawable drawable2 = this.f5203OooOOoo;
        if (drawable2 != drawable) {
            if (drawable2 != null) {
                drawable2.setCallback(null);
            }
            Drawable drawableMutate = drawable != null ? drawable.mutate() : null;
            this.f5203OooOOoo = drawableMutate;
            if (drawableMutate != null) {
                if (drawableMutate.isStateful()) {
                    this.f5203OooOOoo.setState(getDrawableState());
                }
                Drawable drawable3 = this.f5203OooOOoo;
                WeakHashMap<View, o000O0Oo> weakHashMap = ViewCompat.f5334OooO00o;
                o00Ooo.OooO0OO.OooO0O0(drawable3, ViewCompat.OooO.OooO0Oo(this));
                this.f5203OooOOoo.setVisible(getVisibility() == 0, false);
                this.f5203OooOOoo.setCallback(this);
            }
            WeakHashMap<View, o000O0Oo> weakHashMap2 = ViewCompat.f5334OooO00o;
    ...
    public void setVisibility(int i) {
        ...
        this.f5203OooOOoo.setVisible(z, false);
    }

    @Override // android.view.View
    public final boolean verifyDrawable(Drawable drawable) {
        return super.verifyDrawable(drawable) || drawable == this.f5203OooOOoo;
    }

    public CoordinatorLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, o00oO0o.coordinatorLayoutStyle);
    }
    ...
    public final void onNestedPreScroll(View view, int i, int i2, int[] iArr, int i3) {
        ...
        for (int i4 = 0; i4 < childCount; i4++) {
            ...
            if (childAt.getVisibility() != 8) {
                OooO0o oooO0o = (OooO0o) childAt.getLayoutParams();
                if (oooO0o.OooO00o(i3) && (behavior = oooO0o.f5211OooO00o) != null) {
                    int[] iArr2 = this.f5193OooO0oo;
                    iArr2[0] = 0;
                    iArr2[1] = 0;
                    behavior.OooOO0O(this, childAt, view, i, i2, iArr2, i3);
                    int[] iArr3 = this.f5193OooO0oo;
    ...
    public final void onNestedScroll(View view, int i, int i2, int i3, int i4, int i5) {
        onNestedScroll(view, i, i2, i3, i4, 0, this.f5188OooO);
    }

    @Override // androidx.core.view.oo0o0Oo
    public final void onNestedScrollAccepted(View view, View view2, int i, int i2) {
        this.f5206OooOo0O.OooO00o(i, i2);
        this.f5197OooOOO = view2;
        int childCount = getChildCount();
        ...
        for (int i3 = 0; i3 < childCount; i3++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (behavior != null) {
                    ...
                    z |= zOooOOo0;
                    if (i2 == 0) {
                        oooO0o.f5222OooOOO = zOooOOo0;
                    } else if (i2 == 1) {
                        oooO0o.f5224OooOOOO = zOooOOo0;
                    }
                } else if (i2 == 0) {
                    oooO0o.f5222OooOOO = false;
                } else if (i2 == 1) {
                    oooO0o.f5224OooOOOO = false;
                }
            }
        }
        return z;
    ...
    public final void onStopNestedScroll(View view, int i) {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            if (oooO0o.OooO00o(i)) {
                ...
                oooO0o.f5225OooOOOo = false;
            }
        }
        this.f5197OooOOO = null;
    }

    public CoordinatorLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i) {
        TypedArray typedArrayObtainStyledAttributes;
        super(context, attributeSet, i);
        this.f5189OooO0Oo = new ArrayList();
        this.f5191OooO0o0 = new o00000.OooO0OO<>();
        this.f5190OooO0o = new ArrayList();
        this.f5192OooO0oO = new ArrayList();
        this.f5193OooO0oo = new int[2];
        this.f5188OooO = new int[2];
        this.f5206OooOo0O = new o000000();
        if (i == 0) {
            typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, o0OOO0o.CoordinatorLayout, 0, o0ooOOo.Widget_Support_CoordinatorLayout);
        } else {
            typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, o0OOO0o.CoordinatorLayout, i, 0);
        }
        if (Build.VERSION.SDK_INT >= 29) {
            if (i == 0) {
                saveAttributeDataForStyleable(context, o0OOO0o.CoordinatorLayout, attributeSet, typedArrayObtainStyledAttributes, 0, o0ooOOo.Widget_Support_CoordinatorLayout);
            } else {
                saveAttributeDataForStyleable(context, o0OOO0o.CoordinatorLayout, attributeSet, typedArrayObtainStyledAttributes, i, 0);
            }
        }
        int resourceId = typedArrayObtainStyledAttributes.getResourceId(o0OOO0o.CoordinatorLayout_keylines, 0);
        if (resourceId != 0) {
            Resources resources = context.getResources();
            int[] intArray = resources.getIntArray(resourceId);
            this.f5196OooOO0o = intArray;
        ...
        this.f5203OooOOoo = typedArrayObtainStyledAttributes.getDrawable(o0OOO0o.CoordinatorLayout_statusBarBackground);
    ...
    public final void onNestedScroll(@NonNull View view, int i, int i2, int i3, int i4, int i5, @NonNull int[] iArr) {
        ...
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            if (childAt.getVisibility() != 8) {
                OooO0o oooO0o = (OooO0o) childAt.getLayoutParams();
                if (oooO0o.OooO00o(i5) && (behavior = oooO0o.f5211OooO00o) != null) {
                    int[] iArr2 = this.f5193OooO0oo;
                    iArr2[0] = 0;
                    iArr2[1] = 0;
    ...
    public static class OooO0o extends ViewGroup.MarginLayoutParams {
        ...
        /* JADX INFO: renamed from: OooO, reason: collision with root package name */
        public int f5210OooO;

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public Behavior f5211OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public boolean f5212OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final int f5213OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f5214OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final int f5215OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final int f5216OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public int f5217OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public int f5218OooO0oo;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public int f5219OooOO0;

        /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
        public View f5220OooOO0O;

        /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
        public View f5221OooOO0o;

        /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
        public boolean f5222OooOOO;

        /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
        public boolean f5223OooOOO0;

        /* JADX INFO: renamed from: OooOOOO, reason: collision with root package name */
        public boolean f5224OooOOOO;

        /* JADX INFO: renamed from: OooOOOo, reason: collision with root package name */
        public boolean f5225OooOOOo;

        /* JADX INFO: renamed from: OooOOo0, reason: collision with root package name */
        public final Rect f5226OooOOo0;

        public OooO0o() {
            super(-2, -2);
            this.f5212OooO0O0 = false;
            this.f5213OooO0OO = 0;
            this.f5214OooO0Oo = 0;
            this.f5216OooO0o0 = -1;
            this.f5215OooO0o = -1;
            this.f5217OooO0oO = 0;
            this.f5218OooO0oo = 0;
            this.f5226OooOOo0 = new Rect();
        }

        public final boolean OooO00o(int i) {
            if (i == 0) {
                return this.f5222OooOOO;
            }
            if (i != 1) {
                return false;
            }
        ...
        public final void OooO0O0(@Nullable Behavior behavior) {
            Behavior behavior2 = this.f5211OooO00o;
            if (behavior2 != behavior) {
                if (behavior2 != null) {
                    behavior2.OooO0o();
                }
                this.f5211OooO00o = behavior;
                this.f5212OooO0O0 = true;
                if (behavior != null) {
        ...
        public OooO0o(@NonNull Context context, @Nullable AttributeSet attributeSet) {
            ...
            this.f5218OooO0oo = 0;
            this.f5226OooOOo0 = new Rect();
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, o0OOO0o.CoordinatorLayout_Layout);
            this.f5213OooO0OO = typedArrayObtainStyledAttributes.getInteger(o0OOO0o.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.f5215OooO0o = typedArrayObtainStyledAttributes.getResourceId(o0OOO0o.CoordinatorLayout_Layout_layout_anchor, -1);
            this.f5214OooO0Oo = typedArrayObtainStyledAttributes.getInteger(o0OOO0o.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.f5216OooO0o0 = typedArrayObtainStyledAttributes.getInteger(o0OOO0o.CoordinatorLayout_Layout_layout_keyline, -1);
            this.f5217OooO0oO = typedArrayObtainStyledAttributes.getInt(o0OOO0o.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.f5218OooO0oo = typedArrayObtainStyledAttributes.getInt(o0OOO0o.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            int i = o0OOO0o.CoordinatorLayout_Layout_layout_behavior;
            boolean zHasValue = typedArrayObtainStyledAttributes.hasValue(i);
            this.f5212OooO0O0 = zHasValue;
            if (zHasValue) {
                String string = typedArrayObtainStyledAttributes.getString(i);
                String str = CoordinatorLayout.f5184OooOo0o;
                if (TextUtils.isEmpty(string)) {
                    ...
                    if (string.startsWith(".")) {
                        ...
                        String str2 = CoordinatorLayout.f5184OooOo0o;
                        if (!TextUtils.isEmpty(str2)) {
                            string = str2 + '.' + string;
                        }
                    }
                    try {
                        ThreadLocal<Map<String, Constructor<Behavior>>> threadLocal = CoordinatorLayout.f5186OooOoO0;
                        ...
                        if (constructor == null) {
                            constructor = Class.forName(string, false, context.getClassLoader()).getConstructor(CoordinatorLayout.f5183OooOo);
                ...
                this.f5211OooO00o = behaviorNewInstance;
            }
            typedArrayObtainStyledAttributes.recycle();
            Behavior behavior = this.f5211OooO00o;
            if (behavior != null) {
                behavior.OooO0OO(this);
            }
        }
