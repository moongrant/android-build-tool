...
public class FileProvider extends ContentProvider {
    ...
    public static class OooO0OO implements OooO0O0 {
        ...
        public final String f5273OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final HashMap<String, File> f5274OooO0O0 = new HashMap<>();

        public OooO0OO(String str) {
            this.f5273OooO00o = str;
        }
        ...
        public final Uri OooO00o(File file) {
            try {
                ...
                for (Map.Entry<String, File> entry2 : this.f5274OooO0O0.entrySet()) {
                ...
                return new Uri.Builder().scheme("content").authority(this.f5273OooO00o).encodedPath(Uri.encode(entry.getKey()) + '/' + Uri.encode(path2.endsWith("/") ? canonicalPath.substring(path2.length()) : canonicalPath.substring(path2.length() + 1), "/")).build();
        ...
        public final File OooO0O0(Uri uri) {
            ...
            File file = this.f5274OooO0O0.get(strDecode);
            if (file == null) {
        ...
        while (true) {
            ...
            if (next == 2) {
                ...
                if (externalStorageDirectory != null) {
                    ...
                    try {
                        oooO0OO.f5274OooO0O0.put(attributeValue, fileBuildPath.getCanonicalFile());
                    } catch (IOException e) {
    ...
    public int delete(@NonNull Uri uri, @Nullable String str, @Nullable String[] strArr) {
        return this.mStrategy.OooO0O0(uri).delete() ? 1 : 0;
    }

    @Override // android.content.ContentProvider
    @Nullable
    public String getType(@NonNull Uri uri) {
        File fileOooO0O0 = this.mStrategy.OooO0O0(uri);
    ...
    public ParcelFileDescriptor openFile(@NonNull Uri uri, @NonNull String str) throws FileNotFoundException {
        return ParcelFileDescriptor.open(this.mStrategy.OooO0O0(uri), modeToMode(str));
    }
