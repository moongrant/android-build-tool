...
public abstract class OooO0O0 {
    ...
    public OooO00o f5329OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public InterfaceC0123OooO0O0 f5330OooO0O0;
    ...
    public interface InterfaceC0123OooO0O0 {
    }
    ...
    public void OooO0oo(@Nullable androidx.appcompat.view.menu.OooOO0O.OooO00o oooO00o) {
        if (this.f5330OooO0O0 != null) {
            Log.w("ActionProvider(support)", "setVisibilityListener: Setting a new ActionProvider.VisibilityListener when one is already set. Are you reusing this " + getClass().getSimpleName() + " instance while it is still in use somewhere else?");
        }
        this.f5330OooO0O0 = oooO00o;
    }
}
