...
public final class o0OoOo0 {
    ...
    public static boolean f5449OooO00o = false;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static Method f5450OooO0O0 = null;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static boolean f5451OooO0OO = false;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public static Field f5452OooO0Oo;
    ...
    public static boolean OooO00o(@NonNull View view, @NonNull KeyEvent keyEvent) {
        ...
        if (Build.VERSION.SDK_INT < 28) {
            ArrayList<WeakReference<View>> arrayList = ViewCompat.o00Ooo.f5349OooO0Oo;
            ...
            WeakReference<KeyEvent> weakReference = o00ooo2.f5352OooO0OO;
            if (weakReference == null || weakReference.get() != keyEvent) {
                o00ooo2.f5352OooO0OO = new WeakReference<>(keyEvent);
                if (o00ooo2.f5351OooO0O0 == null) {
                    o00ooo2.f5351OooO0O0 = new SparseArray<>();
                }
                SparseArray<WeakReference<View>> sparseArray = o00ooo2.f5351OooO0O0;
    ...
    public static boolean OooO0O0(@NonNull OooO00o oooO00o, @Nullable View view, @Nullable Window.Callback callback, @NonNull KeyEvent keyEvent) {
        ...
        if (callback instanceof Activity) {
            ...
            if (window.hasFeature(8)) {
                ...
                if (keyEvent.getKeyCode() == 82 && actionBar != null) {
                    if (!f5449OooO00o) {
                        try {
                            f5450OooO0O0 = actionBar.getClass().getMethod("onMenuKeyEvent", KeyEvent.class);
                        } catch (NoSuchMethodException unused) {
                        }
                        f5449OooO00o = true;
                    }
                    Method method = f5450OooO0O0;
                    if (method != null) {
                        try {
        ...
        if (!f5451OooO0OO) {
            try {
                ...
                f5452OooO0Oo = declaredField;
                declaredField.setAccessible(true);
            } catch (NoSuchFieldException unused3) {
            }
            f5451OooO0OO = true;
        }
        Field field = f5452OooO0Oo;
        if (field != null) {
            try {
