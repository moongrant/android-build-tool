...
public final class TextViewCompat {
    ...
    public static class OooOO0 implements ActionMode.Callback {
        ...
        public final ActionMode.Callback f5525OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final TextView f5526OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public Class<?> f5527OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public Method f5528OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public boolean f5529OooO0o = false;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public boolean f5530OooO0o0;

        public OooOO0(ActionMode.Callback callback, TextView textView) {
            this.f5525OooO00o = callback;
            this.f5526OooO0O0 = textView;
        }

        @Override // android.view.ActionMode.Callback
        public final boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            return this.f5525OooO00o.onActionItemClicked(actionMode, menuItem);
        }

        @Override // android.view.ActionMode.Callback
        public final boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            return this.f5525OooO00o.onCreateActionMode(actionMode, menu);
        }

        @Override // android.view.ActionMode.Callback
        public final void onDestroyActionMode(ActionMode actionMode) {
            this.f5525OooO00o.onDestroyActionMode(actionMode);
        }
        ...
        public final boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
            boolean z;
            String str;
            TextView textView = this.f5526OooO0O0;
            Context context = textView.getContext();
            PackageManager packageManager = context.getPackageManager();
            if (!this.f5529OooO0o) {
                this.f5529OooO0o = true;
                try {
                    Class<?> cls = Class.forName("com.android.internal.view.menu.MenuBuilder");
                    this.f5527OooO0OO = cls;
                    this.f5528OooO0Oo = cls.getDeclaredMethod("removeItemAt", Integer.TYPE);
                    this.f5530OooO0o0 = true;
                } catch (ClassNotFoundException | NoSuchMethodException unused) {
                    this.f5527OooO0OO = null;
                    this.f5528OooO0Oo = null;
                    this.f5530OooO0o0 = false;
                }
            }
            try {
                Method declaredMethod = (this.f5530OooO0o0 && this.f5527OooO0OO.isInstance(menu)) ? this.f5528OooO0Oo : menu.getClass().getDeclaredMethod("removeItemAt", Integer.TYPE);
            ...
            return this.f5525OooO00o.onPrepareActionMode(actionMode, menu);
        }
    }
    ...
    public static o00O0O.OooO00o OooO00o(@NonNull TextView textView) {
        ...
        if (i >= 28) {
            return new o00O0O.OooO00o(OooO.OooO0O0(textView));
        }
    ...
    public static ActionMode.Callback OooO0o0(@Nullable ActionMode.Callback callback) {
        return (!(callback instanceof OooOO0) || Build.VERSION.SDK_INT < 26) ? callback : ((OooOO0) callback).f5525OooO00o;
    }
}
