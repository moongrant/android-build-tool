...
public abstract class AbsSavedState implements Parcelable {
    ...
    public final Parcelable f5532OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public static final AbsSavedState f5531OooO0o0 = new AbsSavedState() { // from class: androidx.customview.view.AbsSavedState.1
    };
    public static final Parcelable.Creator<AbsSavedState> CREATOR = new OooO00o();

    public AbsSavedState() {
        this.f5532OooO0Oo = null;
    }
    ...
    public class OooO00o implements Parcelable.ClassLoaderCreator<AbsSavedState> {
        ...
        public final Object createFromParcel(Parcel parcel) {
            if (parcel.readParcelable(null) == null) {
                return AbsSavedState.f5531OooO0o0;
            }
    ...
    public AbsSavedState(@NonNull Parcelable parcelable) {
        if (parcelable != null) {
            this.f5532OooO0Oo = parcelable == f5531OooO0o0 ? null : parcelable;
            return;
        }
    ...
    public AbsSavedState(@NonNull Parcel parcel, @Nullable ClassLoader classLoader) {
        ...
        this.f5532OooO0Oo = parcelable == null ? f5531OooO0o0 : parcelable;
    }
}
