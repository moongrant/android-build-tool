...
public class EmojiCompatInitializer implements o000OOo0.OooO0O0<Boolean> {
    ...
    public static class OooO0O0 implements EmojiCompat.OooOOO0 {
        ...
        public final Context f5606OooO00o;

        public OooO0O0(Context context) {
            this.f5606OooO00o = context.getApplicationContext();
        }
        ...
        public final void OooO00o(@NonNull final EmojiCompat.OooOOO oooOOO) {
            ...
            threadPoolExecutor.execute(new Runnable() { // from class: androidx.emoji2.text.OooOO0O
                ...
                public final void run() {
                    EmojiCompatInitializer.OooO0O0 oooO0O0 = this.f5611OooO0Oo;
                    EmojiCompat.OooOOO oooOOO2 = oooOOO;
                    ThreadPoolExecutor threadPoolExecutor2 = threadPoolExecutor;
                    oooO0O0.getClass();
                    try {
                        Oooo000 oooo000OooO00o = OooO0o.OooO00o(oooO0O0.f5606OooO00o);
                        if (oooo000OooO00o == null) {
                            throw new RuntimeException("EmojiCompat font provider not available on this device.");
                        }
                        Oooo000.OooO0O0 oooO0O1 = (Oooo000.OooO0O0) oooo000OooO00o.f5598OooO00o;
                        synchronized (oooO0O1.f5642OooO0Oo) {
                            oooO0O1.f5643OooO0o = threadPoolExecutor2;
                        }
                        oooo000OooO00o.f5598OooO00o.OooO00o(new OooOOO0(oooOOO2, threadPoolExecutor2));
                    } catch (Throwable th) {
                        oooOOO2.OooO00o(th);
    ...
    public static class OooO0OO implements Runnable {
        ...
        public final void run() {
            try {
                int i = o00000O0.f34291OooO00o;
                o00000O0.OooO00o.OooO00o("EmojiCompat.EmojiCompatInitializer.run");
    ...
    public final Boolean create(@NonNull Context context) {
        ...
        if (EmojiCompat.f5585OooOO0O == null) {
            synchronized (EmojiCompat.f5584OooOO0) {
                if (EmojiCompat.f5585OooOO0O == null) {
                    EmojiCompat.f5585OooOO0O = new EmojiCompat(oooO00o);
                }
            }
        }
        OooO0O0(context);
    ...
    public final void OooO0O0(@NonNull Context context) {
        ...
        synchronized (o000OOo0.OooO00o.f34893OooO0o0) {
            try {
                objOooO0O0 = oooO00oOooO0OO.f34894OooO00o.get(ProcessLifecycleInitializer.class);
                if (objOooO0O0 == null) {
