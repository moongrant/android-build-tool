...
public class OooOo extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    public class OooO extends oo000o {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ oo000o f5917OooO0Oo;

        public OooO(oo000o oo000oVar) {
            this.f5917OooO0Oo = oo000oVar;
        }

        @Override // androidx.fragment.app.oo000o
        @Nullable
        public final View OooO0O0(int i) {
            oo000o oo000oVar = this.f5917OooO0Oo;
            return oo000oVar.OooO0OO() ? oo000oVar.OooO0O0(i) : OooOo.this.onFindViewById(i);
        }

        @Override // androidx.fragment.app.oo000o
        public final boolean OooO0OO() {
            return this.f5917OooO0Oo.OooO0OO() || OooOo.this.onHasView();
        }
    }
    ...
    public class OooO00o implements Runnable {
        ...
        public final void run() {
            ...
            oooOo.mOnDismissListener.onDismiss(oooOo.mDialog);
        }
    }
    ...
    public class OooO0O0 implements DialogInterface.OnCancelListener {
        ...
        public final void onCancel(@Nullable DialogInterface dialogInterface) {
            OooOo oooOo = OooOo.this;
            if (oooOo.mDialog != null) {
                oooOo.onCancel(oooOo.mDialog);
            }
        }
    }
    ...
    public class OooO0o implements Observer<LifecycleOwner> {
        ...
        public final void onChanged(LifecycleOwner lifecycleOwner) {
            if (lifecycleOwner != null) {
                OooOo oooOo = OooOo.this;
                if (oooOo.mShowsDialog) {
                    View viewRequireView = oooOo.requireView();
                    if (viewRequireView.getParent() != null) {
                        throw new IllegalStateException("DialogFragment can not be attached to a container view");
                    }
                    if (oooOo.mDialog != null) {
                        if (FragmentManager.Oooo0O0(3)) {
                            Log.d("FragmentManager", "DialogFragment " + this + " setting the content view on " + oooOo.mDialog);
                        }
                        oooOo.mDialog.setContentView(viewRequireView);
                    }
                }
            }
        }
    ...
    public Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        return new androidx.activity.OooOo00(requireContext(), getTheme());
    }
    ...
    public void onStart() {
        ...
        if (dialog != null) {
            ...
            o000OO00.OooO.OooO0O0(decorView, this);
        }
    }
    ...
    @NonNull
    public final androidx.activity.OooOo00 requireComponentDialog() {
        Dialog dialogRequireDialog = requireDialog();
        if (dialogRequireDialog instanceof androidx.activity.OooOo00) {
            return (androidx.activity.OooOo00) dialogRequireDialog;
        }
    ...
    public int show(@NonNull o0000O00 o0000o00, @Nullable String str) {
        this.mDismissed = false;
        this.mShownByMe = true;
        o0000o00.OooO0OO(0, this, str, 1);
        this.mViewDestroyed = false;
        int iOooO0oO = ((androidx.fragment.app.OooO00o) o0000o00).OooO0oO(false);
        this.mBackStackId = iOooO0oO;
        return iOooO0oO;
    }

    public OooOo(@LayoutRes int i) {
        super(i);
        this.mDismissRunnable = new OooO00o();
        this.mOnCancelListener = new OooO0O0();
        this.mOnDismissListener = new OooO0OO();
