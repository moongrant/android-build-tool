...
@RequiresApi(21)
public final class o0000O0O extends o000 {

    public class OooO00o implements Transition.TransitionListener {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final /* synthetic */ View f5985OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final /* synthetic */ ArrayList f5986OooO0O0;

        public OooO00o(View view, ArrayList arrayList) {
            this.f5985OooO00o = view;
            this.f5986OooO0O0 = arrayList;
        }
        ...
        public final void onTransitionEnd(Transition transition) {
            ...
            this.f5985OooO00o.setVisibility(8);
            ArrayList arrayList = this.f5986OooO0O0;
    ...
    public class OooO0O0 extends Transition.EpicenterCallback {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final /* synthetic */ Rect f5987OooO00o;

        public OooO0O0(Rect rect) {
            this.f5987OooO00o = rect;
        }

        @Override // android.transition.Transition.EpicenterCallback
        public final Rect onGetEpicenter(Transition transition) {
            Rect rect = this.f5987OooO00o;
    ...
    public static boolean OooOOoo(Transition transition) {
        return (o000.OooO0oo(transition.getTargetIds()) && o000.OooO0oo(transition.getTargetNames()) && o000.OooO0oo(transition.getTargetTypes())) ? false : true;
    }
    ...
    public final void OooO0O0(@NonNull ArrayList arrayList, @NonNull Object obj) {
        ...
        if (OooOOoo(transition) || !o000.OooO0oo(transition.getTargets())) {
            return;
        }
        int size = arrayList.size();
        while (i < size) {
    ...
    public final void OooOO0o(@NonNull Object obj, @Nullable Object obj2, @Nullable ArrayList arrayList, @Nullable Object obj3, @Nullable ArrayList arrayList2) {
        ((Transition) obj).addListener(new o000OO(this, obj2, arrayList, obj3, arrayList2));
    }
    ...
    public final void OooOOO0(@Nullable View view, @NonNull Object obj) {
        if (view != null) {
            ...
            ((Transition) obj).setEpicenterCallback(new o0000O0(rect));
        }
    }

    @Override // androidx.fragment.app.o000
    public final void OooOOOO(@NonNull Object obj, @NonNull p063o0000oO.oo000o oo000oVar, @NonNull p045Oooooo.o0000oo o0000ooVar) {
        ((Transition) obj).addListener(new o0000O(o0000ooVar));
    }
    ...
    public final void OooOOOo(@NonNull Object obj, @NonNull View view, @NonNull ArrayList<View> arrayList) {
        ...
        int size = arrayList.size();
        for (int i = 0; i < size; i++) {
            o000.OooO0Oo(arrayList.get(i), targets);
        }
        targets.add(view);
        arrayList.add(view);
