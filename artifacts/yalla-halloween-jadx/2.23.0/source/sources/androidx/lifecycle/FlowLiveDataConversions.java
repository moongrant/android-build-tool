...
public final class FlowLiveDataConversions {
    ...
    public static final class AnonymousClass1<T> extends SuspendLambda implements Function2<ProducerScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        public static final class C01301 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public C01301(LiveData<T> liveData, Observer<T> observer, Continuation<? super C01301> continuation) {
            ...
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                return new C01301(this.$this_asFlow, this.$observer, continuation);
            }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            observer = new Observer() { // from class: androidx.lifecycle.OooO0O0
                ...
                public final void onChanged(Object obj2) {
                    producerScope2.mo5731trySendJP2dKIU(obj2);
                }
            };
            ...
            this.L$1 = observer;
            this.label = 1;
            if (BuildersKt.withContext(immediate, c01301, this) == coroutine_suspended) {
            ...
            Function0<Unit> function0 = new Function0<Unit>() { // from class: androidx.lifecycle.FlowLiveDataConversions.asFlow.1.2
                ...
                public final void invoke2() {
                    BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, Dispatchers.getMain().getImmediate(), null, new C01311(liveData, observer, null), 2, null);
                }
            };
            this.L$0 = null;
            this.L$1 = null;
    ...
    public static final class C08581<T> extends SuspendLambda implements Function2<LiveDataScope<T>, Continuation<? super Unit>, Object> {
        ...
        public C08581(Flow<? extends T> flow, Continuation<? super C08581> continuation) {
            super(2, continuation);
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C08581 c08581 = new C08581(this.$this_asLiveData, continuation);
            c08581.L$0 = obj;
            return c08581;
        }
        ...
        public final Object invoke(@NotNull LiveDataScope<T> liveDataScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C08581) create(liveDataScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> LiveData<T> asLiveData(@NotNull Flow<? extends T> flow, @NotNull CoroutineContext context, long j) {
        Intrinsics.checkNotNullParameter(flow, "<this>");
        Intrinsics.checkNotNullParameter(context, "context");
        NetworkStateUtil.NetworkStateLiveData networkStateLiveData = (LiveData<T>) CoroutineLiveDataKt.liveData(context, j, new C08581(flow, null));
