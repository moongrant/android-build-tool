...
public final class ProcessLifecycleOwner implements LifecycleOwner {
    ...
    @NotNull
    private final Runnable delayedPauseRunnable = new Runnable() { // from class: androidx.lifecycle.OooOOO0
        @Override // java.lang.Runnable
        public final void run() {
            ProcessLifecycleOwner.delayedPauseRunnable$lambda$0(this.f6059OooO0Oo);
        }
    };
