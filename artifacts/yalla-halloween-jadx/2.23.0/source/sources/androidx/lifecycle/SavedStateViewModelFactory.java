...
public final class SavedStateViewModelFactory extends ViewModelProvider.OnRequeryFactory implements ViewModelProvider.Factory {
    ...
    public SavedStateViewModelFactory(@Nullable Application application, @NotNull o000OO00.OooO0o owner) {
        this(application, owner, null);
        Intrinsics.checkNotNullParameter(owner, "owner");
    }

    @SuppressLint({"LambdaLast"})
    public SavedStateViewModelFactory(@Nullable Application application, @NotNull o000OO00.OooO0o owner, @Nullable Bundle bundle) {
