    ...
    public static class NewInstanceFactory implements Factory {
        ...
        public <T extends ViewModel> T create(@NotNull Class<T> modelClass) throws InvocationTargetException {
            ...
            try {
                ...
                throw new RuntimeException(androidx.compose.compiler.plugins.kotlin.OooO00o.OooO00o("Cannot create an instance of ", modelClass), e);
            } catch (InstantiationException e2) {
                throw new RuntimeException(androidx.compose.compiler.plugins.kotlin.OooO00o.OooO00o("Cannot create an instance of ", modelClass), e2);
            } catch (NoSuchMethodException e3) {
                throw new RuntimeException(androidx.compose.compiler.plugins.kotlin.OooO00o.OooO00o("Cannot create an instance of ", modelClass), e3);
            }
        }
    }
        ...
        private final <T extends ViewModel> T create(Class<T> modelClass, Application app) {
            if (AndroidViewModel.class.isAssignableFrom(modelClass)) {
                try {
                    ...
                    throw new RuntimeException(androidx.compose.compiler.plugins.kotlin.OooO00o.OooO00o("Cannot create an instance of ", modelClass), e4);
                }
            }
            return (T) super.create(modelClass);
        }
