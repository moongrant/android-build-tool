...
public final class OooO0o implements Runnable {
    ...
    public final /* synthetic */ MediaBrowserServiceCompat.OooOOOO f6113OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ IBinder f6114OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ String f6115OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final /* synthetic */ MediaBrowserServiceCompat.OooOOO f6116OooO0oO;
    ...
    public OooO0o(MediaBrowserServiceCompat.OooOOO oooOOO, MediaBrowserServiceCompat.OooOo00 oooOo00, String str, IBinder iBinder) {
        this.f6116OooO0oO = oooOOO;
        this.f6113OooO0Oo = oooOo00;
        this.f6115OooO0o0 = str;
        this.f6114OooO0o = iBinder;
    }
    ...
    public final void run() {
        IBinder iBinderOooO00o = ((MediaBrowserServiceCompat.OooOo00) this.f6113OooO0Oo).OooO00o();
        MediaBrowserServiceCompat.OooOOO oooOOO = this.f6116OooO0oO;
        MediaBrowserServiceCompat.OooO0O0 orDefault = MediaBrowserServiceCompat.this.f6072OooO0oO.getOrDefault(iBinderOooO00o, null);
        String str = this.f6115OooO0o0;
        if (orDefault == null) {
        ...
        IBinder iBinder = this.f6114OooO0o;
        boolean z = true;
        boolean z2 = false;
        if (iBinder == null) {
        ...
        if (list != null) {
            ...
            while (it.hasNext()) {
                if (iBinder == it.next().f34865OooO00o) {
                    it.remove();
                    z2 = true;
                }
            }
