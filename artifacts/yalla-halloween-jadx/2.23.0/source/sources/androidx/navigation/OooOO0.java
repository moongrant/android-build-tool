...
public class OooOO0 extends Navigator<OooO> {
    ...
    @NotNull
    public final OooOOOO f6896OooO0OO;

    public OooOO0(@NotNull OooOOOO navigatorProvider) {
        Intrinsics.checkNotNullParameter(navigatorProvider, "navigatorProvider");
        this.f6896OooO0OO = navigatorProvider;
    }
    ...
    public final void OooO0Oo(@NotNull List<NavBackStackEntry> entries, @Nullable OooOOO0 oooOOO0, @Nullable Navigator.OooO00o oooO00o) {
        ...
        for (NavBackStackEntry navBackStackEntry : entries) {
            ...
            int i = oooO.f6835OooOOO;
            String str = oooO.f6838OooOOOo;
            if (!((i == 0 && str == null) ? false : true)) {
                StringBuilder sb = new StringBuilder("no start destination defined via app:startDestination for ");
                int i2 = oooO.f6821OooOO0;
            ...
            if (navDestinationOooO == null) {
                if (oooO.f6837OooOOOO == null) {
                    String strValueOf = oooO.f6838OooOOOo;
                    if (strValueOf == null) {
                        strValueOf = String.valueOf(oooO.f6835OooOOO);
                    }
                    oooO.f6837OooOOOO = strValueOf;
                }
                String str2 = oooO.f6837OooOOOO;
                Intrinsics.checkNotNull(str2);
                throw new IllegalArgumentException(o000oOoO.OooO00o("navigation destination ", str2, " is not a direct child of this NavGraph"));
            }
            this.f6896OooO0OO.OooO0O0(navDestinationOooO.f6816OooO0Oo).OooO0Oo(CollectionsKt.listOf(OooO0O0().OooO00o(navDestinationOooO, navDestinationOooO.OooO0O0(arguments))), oooOOO0, oooO00o);
        }
    }
