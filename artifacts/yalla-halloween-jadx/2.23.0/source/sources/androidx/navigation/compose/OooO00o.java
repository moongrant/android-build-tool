...
public final class OooO00o extends ViewModel {
    ...
    @NotNull
    public final UUID f7004OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public WeakReference<SaveableStateHolder> f7005OooO0O0;
    ...
    public OooO00o(@NotNull SavedStateHandle savedStateHandle) {
        ...
        this.f7004OooO00o = uuidRandomUUID;
    }

    @Override // androidx.lifecycle.ViewModel
    public final void onCleared() {
        super.onCleared();
        WeakReference<SaveableStateHolder> weakReference = this.f7005OooO0O0;
        ...
        if (saveableStateHolder != null) {
            saveableStateHolder.removeState(this.f7004OooO00o);
        }
        WeakReference<SaveableStateHolder> weakReference3 = this.f7005OooO0O0;
