...
public final class OooOOO extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ OooOo00.OooO00o f7026OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ NavBackStackEntry f7027OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooOOO(OooOo00.OooO00o oooO00o, NavBackStackEntry navBackStackEntry) {
        super(2);
        this.f7026OooO0Oo = oooO00o;
        this.f7027OooO0o0 = navBackStackEntry;
    }
    ...
    public final Unit invoke(Composer composer, Integer num) {
        ...
        if ((iIntValue & 11) == 2 && composer2.getSkipping()) {
            ...
            this.f7026OooO0Oo.f7039OooOOO.invoke(this.f7027OooO0o0, composer2, 8);
            if (ComposerKt.isTraceInProgress()) {
