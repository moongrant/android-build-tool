...
public final class o00Ooo extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ NavBackStackEntry f7046OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ AnimatedContentScope f7047OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00Ooo(NavBackStackEntry navBackStackEntry, AnimatedContentScope animatedContentScope) {
        super(2);
        this.f7046OooO0Oo = navBackStackEntry;
        this.f7047OooO0o0 = animatedContentScope;
    }
    ...
    public final Unit invoke(Composer composer, Integer num) {
        ...
        if ((iIntValue & 11) == 2 && composer2.getSkipping()) {
            ...
            NavBackStackEntry navBackStackEntry = this.f7046OooO0Oo;
            ...
            ((OooO.OooO00o) destination).f7000OooOOO0.invoke(this.f7047OooO0o0, navBackStackEntry, composer2, 72);
            if (ComposerKt.isTraceInProgress()) {
