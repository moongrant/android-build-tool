...
public final /* data */ class PagingPlaceholderKey implements Parcelable {
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        return (obj instanceof PagingPlaceholderKey) && this.f7271OooO0Oo == ((PagingPlaceholderKey) obj).f7271OooO0Oo;
    }

    /* JADX INFO: renamed from: hashCode, reason: from getter */
    public final int getF7271OooO0Oo() {
        return this.f7271OooO0Oo;
    }

    @NotNull
    public final String toString() {
        return OooO0O0.OooO00o(new StringBuilder("PagingPlaceholderKey(index="), this.f7271OooO0Oo, ')');
    }

    @Override // android.os.Parcelable
    public final void writeToParcel(@NotNull Parcel parcel, int i) {
        Intrinsics.checkNotNullParameter(parcel, "parcel");
        parcel.writeInt(this.f7271OooO0Oo);
    }
}
