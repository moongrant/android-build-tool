...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public final SparseIntArray f7444OooO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public boolean f7445OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public int[] f7446OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public int f7447OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public View[] f7448OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final SparseIntArray f7449OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public OooO0O0 f7450OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public final Rect f7451OooOO0O;
    ...
    public static abstract class OooO0O0 {
        ...
        public final SparseIntArray f7454OooO00o = new SparseIntArray();

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final SparseIntArray f7455OooO0O0 = new SparseIntArray();
        ...
        public final void OooO0Oo() {
            this.f7454OooO00o.clear();
        }
    }

    public GridLayoutManager(Context context, AttributeSet attributeSet, int i, int i2) {
        super(context, attributeSet, i, i2);
        this.f7445OooO0Oo = false;
        this.f7447OooO0o0 = -1;
        this.f7449OooO0oo = new SparseIntArray();
        this.f7444OooO = new SparseIntArray();
        this.f7450OooOO0 = new OooO00o();
        this.f7451OooOO0O = new Rect();
        OooOOo0(RecyclerView.Oooo000.getProperties(context, attributeSet, i, i2).f7647OooO0O0);
    }

    public final void OooOO0O(int i) {
        int i2;
        int[] iArr = this.f7446OooO0o;
        int i3 = this.f7447OooO0o0;
    ...
    public final int OooOOO(int i, RecyclerView.o00Ooo o00ooo2, RecyclerView.o0OOO0o o0ooo0o2) {
        if (!o0ooo0o2.f7674OooO0oO) {
            return this.f7450OooOO0.OooO0O0(i, this.f7447OooO0o0);
        }
        int i2 = this.f7444OooO.get(i, -1);
        if (i2 != -1) {
            return i2;
        }
        int iOooO0O0 = o00ooo2.OooO0O0(i);
        if (iOooO0O0 != -1) {
            return this.f7450OooOO0.OooO0O0(iOooO0O0, this.f7447OooO0o0);
        }
    ...
    public final int OooOOO0(int i, RecyclerView.o00Ooo o00ooo2, RecyclerView.o0OOO0o o0ooo0o2) {
        if (!o0ooo0o2.f7674OooO0oO) {
            return this.f7450OooOO0.OooO00o(i, this.f7447OooO0o0);
        }
        int iOooO0O0 = o00ooo2.OooO0O0(i);
        if (iOooO0O0 != -1) {
            return this.f7450OooOO0.OooO00o(iOooO0O0, this.f7447OooO0o0);
        }
    ...
    public final int OooOOOO(int i, RecyclerView.o00Ooo o00ooo2, RecyclerView.o0OOO0o o0ooo0o2) {
        if (!o0ooo0o2.f7674OooO0oO) {
            return this.f7450OooOO0.OooO0OO(i);
        }
        int i2 = this.f7449OooO0oo.get(i, -1);
        if (i2 != -1) {
            return i2;
        }
        int iOooO0O0 = o00ooo2.OooO0O0(i);
        if (iOooO0O0 != -1) {
            return this.f7450OooOO0.OooO0OO(iOooO0O0);
        }
        Log.w("GridLayoutManager", "Cannot find span size for pre layout position. It is not cached, not in the adapter. Pos:" + i);
        return 1;
    }
    ...
    public final void OooOOOo(View view, int i, boolean z) {
        ...
        int iOooOO0o = OooOO0o(layoutParams.f7453OooO0oo, layoutParams.f7452OooO);
    ...
    public final void collectPrefetchPositionsForLayoutState(RecyclerView.o0OOO0o o0ooo0o2, LinearLayoutManager.OooO0OO oooO0OO, RecyclerView.Oooo000.OooO0OO oooO0OO2) {
        int iOooO0OO = this.f7447OooO0o0;
        for (int i = 0; i < this.f7447OooO0o0; i++) {
            int i2 = oooO0OO.f7469OooO0Oo;
            if (!(i2 >= 0 && i2 < o0ooo0o2.OooO0O0()) || iOooO0OO <= 0) {
                return;
            }
            int i3 = oooO0OO.f7469OooO0Oo;
            ((o000oOoO.OooO0O0) oooO0OO2).OooO00o(i3, Math.max(0, oooO0OO.f7472OooO0oO));
            iOooO0OO -= this.f7450OooOO0.OooO0OO(i3);
            oooO0OO.f7469OooO0Oo += oooO0OO.f7471OooO0o0;
        }
    }
    ...
    public final void layoutChunk(RecyclerView.o00Ooo o00ooo2, RecyclerView.o0OOO0o o0ooo0o2, LinearLayoutManager.OooO0OO oooO0OO, LinearLayoutManager.OooO0O0 oooO0O0) {
        ...
        int i14 = getChildCount() > 0 ? this.f7446OooO0o[this.f7447OooO0o0] : 0;
        if (z2) {
            OooOOo();
        }
        boolean z3 = oooO0OO.f7471OooO0o0 == 1;
        int iOooOOO = this.f7447OooO0o0;
        if (!z3) {
            iOooOOO = OooOOO(oooO0OO.f7469OooO0Oo, o00ooo2, o0ooo0o2) + OooOOOO(oooO0OO.f7469OooO0Oo, o00ooo2, o0ooo0o2);
        }
        int i15 = 0;
        while (i15 < this.f7447OooO0o0) {
            int i16 = oooO0OO.f7469OooO0Oo;
            if (!(i16 >= 0 && i16 < o0ooo0o2.OooO0O0()) || iOooOOO <= 0) {
                break;
            }
            int i17 = oooO0OO.f7469OooO0Oo;
            int iOooOOOO = OooOOOO(i17, o00ooo2, o0ooo0o2);
            if (iOooOOOO > this.f7447OooO0o0) {
                throw new IllegalArgumentException(p022Oooo00O.OooOO0.OooO0O0(p041Ooooo0o.o00000.OooO00o("Item at position ", i17, " requires ", iOooOOOO, " spans but GridLayoutManager has only "), this.f7447OooO0o0, " spans."));
            }
            iOooOOO -= iOooOOOO;
            if (iOooOOO < 0 || (viewOooO0O0 = oooO0OO.OooO0O0(o00ooo2)) == null) {
                break;
            }
            this.f7448OooO0oO[i15] = viewOooO0O0;
            i15++;
        }
        if (i15 == 0) {
        ...
        int i18 = 0;
        while (i != i2) {
            View view = this.f7448OooO0oO[i];
            LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
            int iOooOOOO2 = OooOOOO(getPosition(view), o00ooo2, o0ooo0o2);
            layoutParams.f7452OooO = iOooOOOO2;
            layoutParams.f7453OooO0oo = i18;
            i18 += iOooOOOO2;
            i += i3;
        }
        float f = 0.0f;
        ...
        for (int i20 = 0; i20 < i15; i20++) {
            View view2 = this.f7448OooO0oO[i20];
            ...
            calculateItemDecorationsForChild(view2, this.f7451OooOO0O);
            OooOOOo(view2, iOooOO0, z);
            int iOooO0OO = this.mOrientationHelper.OooO0OO(view2);
            if (iOooO0OO > i19) {
                i19 = iOooO0OO;
            }
            float fOooO0Oo = (this.mOrientationHelper.OooO0Oo(view2) * 1.0f) / ((LayoutParams) view2.getLayoutParams()).f7452OooO;
            if (fOooO0Oo > f) {
                f = fOooO0Oo;
            }
        }
        if (z2) {
            OooOO0O(Math.max(Math.round(f * this.f7447OooO0o0), i14));
            i19 = 0;
            for (int i21 = 0; i21 < i15; i21++) {
                View view3 = this.f7448OooO0oO[i21];
        ...
        for (int i22 = 0; i22 < i15; i22++) {
            View view4 = this.f7448OooO0oO[i22];
            if (this.mOrientationHelper.OooO0OO(view4) != i19) {
                LayoutParams layoutParams2 = (LayoutParams) view4.getLayoutParams();
                Rect rect = layoutParams2.f7635OooO0o0;
                ...
                int iOooOO0o = OooOO0o(layoutParams2.f7453OooO0oo, layoutParams2.f7452OooO);
                if (this.mOrientation == 1) {
        ...
        int i25 = 0;
        oooO0O0.f7461OooO00o = i19;
        if (this.mOrientation == 1) {
            if (oooO0OO.f7470OooO0o == -1) {
                i13 = oooO0OO.f7467OooO0O0;
                i12 = i13 - i19;
            } else {
                int i26 = oooO0OO.f7467OooO0O0;
                i12 = i26;
                i13 = i19 + i26;
            }
            i7 = 0;
            ...
            if (oooO0OO.f7470OooO0o == -1) {
                i5 = oooO0OO.f7467OooO0O0;
                i4 = i5 - i19;
            } else {
                int i27 = oooO0OO.f7467OooO0O0;
                i4 = i27;
                i5 = i19 + i27;
            }
            i6 = 0;
        ...
        while (i25 < i15) {
            View view5 = this.f7448OooO0oO[i25];
            LayoutParams layoutParams3 = (LayoutParams) view5.getLayoutParams();
            if (this.mOrientation == 1) {
                if (isLayoutRTL()) {
                    iOooO0Oo2 = getPaddingLeft() + this.f7446OooO0o[this.f7447OooO0o0 - layoutParams3.f7453OooO0oo];
                    paddingLeft = iOooO0Oo2 - this.mOrientationHelper.OooO0Oo(view5);
                } else {
                    paddingLeft = this.f7446OooO0o[layoutParams3.f7453OooO0oo] + getPaddingLeft();
                ...
                int paddingTop = getPaddingTop() + this.f7446OooO0o[layoutParams3.f7453OooO0oo];
                i9 = i5;
                i10 = i7;
                i11 = paddingTop;
            ...
            oooO0O0.f7464OooO0Oo |= view5.hasFocusable();
            i25++;
            i5 = i9;
            i7 = i10;
            i6 = i11;
        ...
        Arrays.fill(this.f7448OooO0oO, (Object) null);
    }
    ...
    public final void onAnchorReady(RecyclerView.o00Ooo o00ooo2, RecyclerView.o0OOO0o o0ooo0o2, LinearLayoutManager.OooO00o oooO00o, int i) {
        ...
        OooOOo();
        if (o0ooo0o2.OooO0O0() > 0 && !o0ooo0o2.f7674OooO0oO) {
            boolean z = i == 1;
            int iOooOOO = OooOOO(oooO00o.f7457OooO0O0, o00ooo2, o0ooo0o2);
            if (z) {
                while (iOooOOO > 0) {
                    int i2 = oooO00o.f7457OooO0O0;
                    if (i2 <= 0) {
                        break;
                    }
                    int i3 = i2 - 1;
                    oooO00o.f7457OooO0O0 = i3;
                    iOooOOO = OooOOO(i3, o00ooo2, o0ooo0o2);
                }
            } else {
                int iOooO0O0 = o0ooo0o2.OooO0O0() - 1;
                int i4 = oooO00o.f7457OooO0O0;
                while (i4 < iOooO0O0) {
                    int i5 = i4 + 1;
                ...
                oooO00o.f7457OooO0O0 = i4;
            }
        }
        View[] viewArr = this.f7448OooO0oO;
        if (viewArr == null || viewArr.length != this.f7447OooO0o0) {
            this.f7448OooO0oO = new View[this.f7447OooO0o0];
        }
    }
    ...
    */
    public final View onFocusSearchFailed(View view, int i, RecyclerView.o00Ooo o00ooo2, RecyclerView.o0OOO0o o0ooo0o2) {
        ...
        int i7 = layoutParams.f7453OooO0oo;
        int i8 = layoutParams.f7452OooO + i7;
        ...
        while (i11 != childCount) {
            ...
            if (!childAt.hasFocusable() || iOooOOO1 == iOooOOO0) {
                ...
                int i12 = layoutParams2.f7453OooO0oo;
                view2 = viewFindContainingItemView;
                int i13 = layoutParams2.f7452OooO + i12;
                ...
                if (!(childAt.hasFocusable() && view4 == null) && (childAt.hasFocusable() || view5 != null)) {
                    ...
                    if (!childAt.hasFocusable()) {
                        if (view4 == null) {
                            ...
                            if (isViewPartiallyVisible(childAt, false, true)) {
                                ...
                                if (z) {
                                    if (childAt.hasFocusable()) {
                                        ...
                                        int i14 = layoutParams2.f7453OooO0oo;
                            ...
                            if (z) {
                                if (childAt.hasFocusable()) {
                                    ...
                                    int i15 = layoutParams2.f7453OooO0oo;
                                    iMin2 = Math.min(i13, i8) - Math.max(i12, i7);
                                    i10 = i15;
                                    iMin = i3;
                                    view5 = childAt;
                        ...
                        if (z) {
                            if (childAt.hasFocusable()) {
                                ...
                                int i16 = layoutParams2.f7453OooO0oo;
                                iMin2 = Math.min(i13, i8) - Math.max(i12, i7);
                                i10 = i16;
                                iMin = i3;
                                view5 = childAt;
                    ...
                    if (z) {
                        if (childAt.hasFocusable()) {
                            ...
                            int i17 = layoutParams2.f7453OooO0oo;
                            iMin2 = Math.min(i13, i8) - Math.max(i12, i7);
                            i10 = i17;
                            iMin = i3;
                            view5 = childAt;
                ...
                if (z) {
                    if (childAt.hasFocusable()) {
                        ...
                        int i18 = layoutParams2.f7453OooO0oo;
                        iMin2 = Math.min(i13, i8) - Math.max(i12, i7);
                        i10 = i18;
                        iMin = i3;
                        view5 = childAt;
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.Oooo000
    public final void onInitializeAccessibilityNodeInfo(@NonNull RecyclerView.o00Ooo o00ooo2, @NonNull RecyclerView.o0OOO0o o0ooo0o2, @NonNull o0000O.o0Oo0oo o0oo0oo2) {
        super.onInitializeAccessibilityNodeInfo(o00ooo2, o0ooo0o2, o0oo0oo2);
        o0oo0oo2.OooOO0(GridView.class.getName());
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Oooo000
    public final void onInitializeAccessibilityNodeInfoForItem(RecyclerView.o00Ooo o00ooo2, RecyclerView.o0OOO0o o0ooo0o2, View view, o0000O.o0Oo0oo o0oo0oo2) {
        ViewGroup.LayoutParams layoutParams = view.getLayoutParams();
        if (!(layoutParams instanceof LayoutParams)) {
            super.onInitializeAccessibilityNodeInfoForItem(view, o0oo0oo2);
            return;
        }
        LayoutParams layoutParams2 = (LayoutParams) layoutParams;
        int iOooOOO0 = OooOOO0(layoutParams2.OooO00o(), o00ooo2, o0ooo0o2);
        if (this.mOrientation == 0) {
            o0oo0oo2.OooOO0o(o0000O.o0Oo0oo.OooO0o.OooO00o(layoutParams2.f7453OooO0oo, layoutParams2.f7452OooO, iOooOOO0, 1, false, false));
        } else {
            o0oo0oo2.OooOO0o(o0000O.o0Oo0oo.OooO0o.OooO00o(iOooOOO0, 1, layoutParams2.f7453OooO0oo, layoutParams2.f7452OooO, false, false));
        }
    }
    ...
    public final void onItemsAdded(RecyclerView recyclerView, int i, int i2) {
        this.f7450OooOO0.OooO0Oo();
        this.f7450OooOO0.f7455OooO0O0.clear();
    }
    ...
    public void onLayoutChildren(RecyclerView.o00Ooo o00ooo2, RecyclerView.o0OOO0o o0ooo0o2) {
        boolean z = o0ooo0o2.f7674OooO0oO;
        SparseIntArray sparseIntArray = this.f7444OooO;
        SparseIntArray sparseIntArray2 = this.f7449OooO0oo;
        if (z) {
            int childCount = getChildCount();
            for (int i = 0; i < childCount; i++) {
                LayoutParams layoutParams = (LayoutParams) getChildAt(i).getLayoutParams();
                int iOooO00o = layoutParams.OooO00o();
                sparseIntArray2.put(iOooO00o, layoutParams.f7452OooO);
                sparseIntArray.put(iOooO00o, layoutParams.f7453OooO0oo);
            }
        }
    ...
    public final boolean supportsPredictiveItemAnimations() {
        return this.mPendingSavedState == null && !this.f7445OooO0Oo;
    }
    ...
    public static class LayoutParams extends RecyclerView.LayoutParams {
        ...
        /* JADX INFO: renamed from: OooO, reason: collision with root package name */
        public int f7452OooO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public int f7453OooO0oo;
