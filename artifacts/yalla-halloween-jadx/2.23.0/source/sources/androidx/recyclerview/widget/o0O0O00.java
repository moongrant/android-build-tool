...
public abstract class o0O0O00 {
    ...
    public final RecyclerView.Oooo000 f7813OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public int f7814OooO0O0 = Integer.MIN_VALUE;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final Rect f7815OooO0OO = new Rect();

    public o0O0O00(RecyclerView.Oooo000 oooo000) {
        this.f7813OooO00o = oooo000;
    }
    ...
    public final int OooOOO0() {
        if (Integer.MIN_VALUE == this.f7814OooO0O0) {
            return 0;
        }
        return OooOO0o() - this.f7814OooO0O0;
    }
