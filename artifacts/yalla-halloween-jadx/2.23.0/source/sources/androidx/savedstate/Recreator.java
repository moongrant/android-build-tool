...
public final class Recreator implements LifecycleEventObserver {
    ...
    public static final class OooO00o implements androidx.savedstate.OooO00o.OooO0O0 {
        ...
        public final Bundle saveState() {
            ...
            bundle.putStringArrayList("classes_to_restore", new ArrayList<>(this.f7953OooO00o));
            return bundle;
        }
    }
    ...
    public final void onStateChanged(@NotNull LifecycleOwner source, @NotNull Lifecycle.Event event) {
        ...
        OooO0o oooO0o = this.f7952OooO0Oo;
        ...
        for (String str : stringArrayList) {
            try {
                Class<? extends U> clsAsSubclass = Class.forName(str, false, Recreator.class.getClassLoader()).asSubclass(androidx.savedstate.OooO00o.InterfaceC0163OooO00o.class);
                ...
                try {
                    ...
                    try {
                        ...
                        ((androidx.savedstate.OooO00o.InterfaceC0163OooO00o) objNewInstance).onRecreated(oooO0o);
                    } catch (Exception e) {
                ...
                throw new RuntimeException(o000oOoO.OooO00o("Class ", str, " wasn't found"), e3);
            }
        }
    }
}
