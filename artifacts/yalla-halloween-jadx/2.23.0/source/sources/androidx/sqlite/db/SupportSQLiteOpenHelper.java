...
public interface SupportSQLiteOpenHelper extends Closeable {
    ...
    public static final class Configuration {
        ...
        @JvmField
        @NotNull
        public final Context f7984OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        @JvmField
        @Nullable
        public final String f7985OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        @JvmField
        @NotNull
        public final OooO00o f7986OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        @JvmField
        public final boolean f7987OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        @JvmField
        public final boolean f7988OooO0o0;

        public Configuration(@NotNull Context context, @Nullable String str, @NotNull OooO00o callback, boolean z) {
            Intrinsics.checkNotNullParameter(context, "context");
            Intrinsics.checkNotNullParameter(callback, "callback");
            this.f7984OooO00o = context;
            this.f7985OooO0O0 = str;
            this.f7986OooO0OO = callback;
            this.f7987OooO0Oo = z;
            this.f7988OooO0o0 = false;
        }
    }
    ...
    public static abstract class OooO00o {
        ...
        public static void OooO00o(String str) {
            if (StringsKt.OooOO0o(str, SQLiteDatabase.MEMORY)) {
                return;
            }
