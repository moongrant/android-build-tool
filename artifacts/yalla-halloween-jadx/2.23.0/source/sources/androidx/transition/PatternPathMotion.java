...
public class PatternPathMotion extends PathMotion {
    ...
    public final Path f8192OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final Matrix f8193OooO0O0;

    public PatternPathMotion() {
        Path path = new Path();
        this.f8192OooO00o = path;
        this.f8193OooO0O0 = new Matrix();
    ...
    public final void OooO0O0(Path path) {
        ...
        path.transform(matrix, this.f8192OooO00o);
    }

    @SuppressLint({"RestrictedApi"})
    public PatternPathMotion(@NonNull Context context, @NonNull AttributeSet attributeSet) {
        this.f8192OooO00o = new Path();
        this.f8193OooO0O0 = new Matrix();
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, o0O0O00.f34974OooO);
        try {
