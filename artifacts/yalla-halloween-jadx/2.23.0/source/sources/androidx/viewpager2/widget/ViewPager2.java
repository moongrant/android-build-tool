...
public final class ViewPager2 extends ViewGroup {
    ...
    public abstract class AccessibilityProvider {
        ...
        public void onLmInitializeAccessibilityNodeInfo(@NonNull o0Oo0oo o0oo0oo2) {
        }
    ...
    public class BasicAccessibilityProvider extends AccessibilityProvider {
        ...
        public void onLmInitializeAccessibilityNodeInfo(@NonNull o0Oo0oo o0oo0oo2) {
            ...
            o0Oo0oo.OooO00o oooO00o = o0Oo0oo.OooO00o.f34031OooOO0O;
            o0oo0oo2.getClass();
            o0oo0oo2.f34022OooO00o.removeAction((AccessibilityNodeInfo.AccessibilityAction) oooO00o.f34040OooO00o);
            o0oo0oo2.f34022OooO00o.removeAction((AccessibilityNodeInfo.AccessibilityAction) o0Oo0oo.OooO00o.f34030OooOO0.f34040OooO00o);
            o0oo0oo2.OooOOOO(false);
        }
    ...
    public class LinearLayoutManagerImpl extends LinearLayoutManager {
        ...
        public void onInitializeAccessibilityNodeInfo(@NonNull RecyclerView.o00Ooo o00ooo2, @NonNull RecyclerView.o0OOO0o o0ooo0o2, @NonNull o0Oo0oo o0oo0oo2) {
            super.onInitializeAccessibilityNodeInfo(o00ooo2, o0ooo0o2, o0oo0oo2);
            ViewPager2.this.mAccessibilityProvider.onLmInitializeAccessibilityNodeInfo(o0oo0oo2);
        }
    ...
    public class PageAwareAccessibilityProvider extends AccessibilityProvider {
        private final o0000O.o000OOo mActionPageBackward;
        private final o0000O.o000OOo mActionPageForward;
        private RecyclerView.OooOOO mAdapterDataObserver;

        public PageAwareAccessibilityProvider() {
            super();
            this.mActionPageForward = new o0000O.o000OOo() { // from class: androidx.viewpager2.widget.ViewPager2.PageAwareAccessibilityProvider.1
                @Override // o0000O.o000OOo
                public boolean perform(@NonNull View view, @Nullable o0000O.o000OOo.OooO00o oooO00o) {
                    PageAwareAccessibilityProvider.this.setCurrentItemFromAccessibilityCommand(((ViewPager2) view).getCurrentItem() + 1);
                    return true;
                }
            };
            this.mActionPageBackward = new o0000O.o000OOo() { // from class: androidx.viewpager2.widget.ViewPager2.PageAwareAccessibilityProvider.2
                @Override // o0000O.o000OOo
                public boolean perform(@NonNull View view, @Nullable o0000O.o000OOo.OooO00o oooO00o) {
                    PageAwareAccessibilityProvider.this.setCurrentItemFromAccessibilityCommand(((ViewPager2) view).getCurrentItem() - 1);
                    return true;
        ...
        private void addCollectionInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            accessibilityNodeInfo.setCollectionInfo((AccessibilityNodeInfo.CollectionInfo) o0Oo0oo.OooO0OO.OooO00o(itemCount, itemCount2, 0, false).f34044OooO00o);
        }
        ...
        public void updatePageAccessibilityActions() {
            ...
            if (ViewPager2.this.getOrientation() != 0) {
                if (ViewPager2.this.mCurrentItem < itemCount - 1) {
                    ViewCompat.OooOOO0(viewPager2, new o0Oo0oo.OooO00o(R.id.accessibilityActionPageDown, (String) null), null, this.mActionPageForward);
                }
                if (ViewPager2.this.mCurrentItem > 0) {
                    ViewCompat.OooOOO0(viewPager2, new o0Oo0oo.OooO00o(R.id.accessibilityActionPageUp, (String) null), null, this.mActionPageBackward);
                    return;
                }
                return;
            }
            ...
            if (ViewPager2.this.mCurrentItem < itemCount - 1) {
                ViewCompat.OooOOO0(viewPager2, new o0Oo0oo.OooO00o(i2, (String) null), null, this.mActionPageForward);
            }
            if (ViewPager2.this.mCurrentItem > 0) {
                ViewCompat.OooOOO0(viewPager2, new o0Oo0oo.OooO00o(i, (String) null), null, this.mActionPageBackward);
            }
        }
    }
