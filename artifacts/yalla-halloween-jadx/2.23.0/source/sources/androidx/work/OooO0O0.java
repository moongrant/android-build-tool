...
public final class OooO0O0 {
    ...
    public static final String f8386OooO0O0 = o000oOoO.OooO0o0("Data");

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final OooO0O0 f8387OooO0OO;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final HashMap f8388OooO00o;

    public static final class OooO00o {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final HashMap f8389OooO00o = new HashMap();
        ...
        public final void OooO00o(@NonNull HashMap map) {
            for (Map.Entry entry : map.entrySet()) {
                ...
                HashMap map2 = this.f8389OooO00o;
                if (value == null) {
                    map2.put(str, null);
                } else {
                    ...
                    if (cls == Boolean.class || cls == Byte.class || cls == Integer.class || cls == Long.class || cls == Float.class || cls == Double.class || cls == String.class || cls == Boolean[].class || cls == Byte[].class || cls == Integer[].class || cls == Long[].class || cls == Float[].class || cls == Double[].class || cls == String[].class) {
                        ...
                        if (cls == boolean[].class) {
                            ...
                            String str2 = OooO0O0.f8386OooO0O0;
                            ...
                            String str3 = OooO0O0.f8386OooO0O0;
                            ...
                            int[] iArr = (int[]) value;
                            String str4 = OooO0O0.f8386OooO0O0;
                            ...
                            String str5 = OooO0O0.f8386OooO0O0;
                            ...
                            String str6 = OooO0O0.f8386OooO0O0;
                            ...
                            String str7 = OooO0O0.f8386OooO0O0;
    ...
    public static byte[] OooO0O0(@NonNull OooO0O0 oooO0O0) throws Throwable {
        ...
        try {
            try {
                ...
                try {
                    objectOutputStream.writeInt(oooO0O0.f8388OooO00o.size());
                    for (Map.Entry entry : oooO0O0.f8388OooO00o.entrySet()) {
    ...
    public final boolean equals(Object obj) {
        ...
        HashMap map = this.f8388OooO00o;
        Set<String> setKeySet = map.keySet();
        if (!setKeySet.equals(oooO0O0.f8388OooO00o.keySet())) {
            return false;
        }
        for (String str : setKeySet) {
            Object obj2 = map.get(str);
            Object obj3 = oooO0O0.f8388OooO00o.get(str);
    ...
    public final int hashCode() {
        return this.f8388OooO00o.hashCode() * 31;
    }
    ...
    public OooO0O0(@NonNull OooO0O0 oooO0O0) {
        this.f8388OooO00o = new HashMap(oooO0O0.f8388OooO00o);
    }

    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public OooO0O0(@NonNull HashMap map) {
        this.f8388OooO00o = new HashMap(map);
    }
}
