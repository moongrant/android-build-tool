...
public class AWS4Signer extends AbstractAWSSigner implements ServiceAwareSigner, RegionAwareSigner {
    ...
    public static final Log f8991OooO0o0 = LogFactory.OooO00o(AWS4Signer.class);

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public String f8992OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public String f8993OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final boolean f8994OooO0Oo;

    public static class HeaderSigningResult {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final String f8995OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final String f8996OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final byte[] f8997OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final byte[] f8998OooO0Oo;

        public HeaderSigningResult(byte[] bArr, String str, byte[] bArr2, String str2) {
            this.f8995OooO00o = str;
            this.f8996OooO0O0 = str2;
            this.f8997OooO0OO = bArr;
            this.f8998OooO0Oo = bArr2;
        }
    }
    ...
    public static String OooOOOo(DefaultRequest defaultRequest) {
        ...
        arrayList.addAll(defaultRequest.f8979OooO0Oo.keySet());
    ...
    public final void OooO00o(String str) {
        this.f8992OooO0O0 = str;
    }

    @Override // com.amazonaws.auth.RegionAwareSigner
    public final void OooO0O0(String str) {
        this.f8993OooO0OO = str;
    }
    ...
    public final void OooO0OO(DefaultRequest defaultRequest, AWSCredentials aWSCredentials) {
        ...
        String strOooO00o = this.f8993OooO0OO;
        if (strOooO00o == null) {
            strOooO00o = AwsHostNameUtils.OooO00o(uri.getHost(), this.f8992OooO0O0);
        }
        String str2 = str + "/" + strOooO00o + "/" + OooOOOO(defaultRequest.f8981OooO0o0) + "/aws4_request";
        ...
        HashMap map = defaultRequest.f8979OooO0Oo;
        ...
        URI uri2 = defaultRequest.f8981OooO0o0;
        String strOooO00o2 = this.f8993OooO0OO;
        if (strOooO00o2 == null) {
            strOooO00o2 = AwsHostNameUtils.OooO00o(uri2.getHost(), this.f8992OooO0O0);
        }
        String strOooOOOO = OooOOOO(defaultRequest.f8981OooO0o0);
        String str5 = str + "/" + strOooO00o2 + "/" + strOooOOOO + "/aws4_request";
        String strOooO00o3 = HttpUtils.OooO00o(defaultRequest.f8981OooO0o0.getPath(), defaultRequest.f8976OooO00o, false);
        StringBuilder sb = new StringBuilder();
        sb.append(defaultRequest.f8983OooO0oo.toString());
        sb.append("\n");
        sb.append(AbstractAWSSigner.OooO0oO(strOooO00o3, this.f8994OooO0Oo));
        sb.append("\n");
        sb.append(HttpUtils.OooO0o0(defaultRequest) ? "" : AbstractAWSSigner.OooO0o(defaultRequest.f8978OooO0OO));
        sb.append("\n");
        ...
        String strOooO00o4 = o000oOoO.OooO00o("AWS4 Canonical Request: '\"", string, "\"");
        Log log = f8991OooO0o0;
        log.OooO0oO(strOooO00o4);
        ...
        String strOooO00o5 = o00O00OO.OooO00o("Credential=", str4);
        ...
        StringBuilder sbOooO0OO = OooO0o.OooO0OO("AWS4-HMAC-SHA256 ", strOooO00o5, ", ", str10, ", ");
        sbOooO0OO.append(string2);
        defaultRequest.OooO00o("Authorization", sbOooO0OO.toString());
    ...
    public String OooOOO(DefaultRequest defaultRequest) {
        ...
        if (HttpUtils.OooO0o0(defaultRequest)) {
            ...
            inputStreamOooO0o0 = strOooO0O0 == null ? new ByteArrayInputStream(new byte[0]) : new ByteArrayInputStream(strOooO0O0.getBytes(StringUtils.f9590OooO00o));
        } else {
            inputStreamOooO0o0 = AbstractAWSSigner.OooO0o0(defaultRequest);
        }
        inputStreamOooO0o0.mark(-1);
        try {
            MessageDigest messageDigest = AbstractAWSSigner.f9009OooO00o.get();
            messageDigest.reset();
    ...
    public final String OooOOOO(URI uri) {
        String str = this.f8992OooO0O0;
        if (str != null) {
            return str;
        }
        Pattern pattern = AwsHostNameUtils.f9574OooO00o;
        String host = uri.getHost();
        if (!host.endsWith(".amazonaws.com")) {
            throw new IllegalArgumentException(o000oOoO.OooO00o("Cannot parse a service name from an unrecognized endpoint (", host, ")."));
        }
        String strSubstring = host.substring(0, host.indexOf(".amazonaws.com"));
        if (strSubstring.endsWith(".s3") || AwsHostNameUtils.f9574OooO00o.matcher(strSubstring).matches()) {
            return "s3";
        }
