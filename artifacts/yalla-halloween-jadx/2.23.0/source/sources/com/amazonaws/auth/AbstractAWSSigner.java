...
public abstract class AbstractAWSSigner implements Signer {
    ...
    public static final ThreadLocal<MessageDigest> f9009OooO00o = new ThreadLocal<MessageDigest>() { // from class: com.amazonaws.auth.AbstractAWSSigner.1
    ...
    public static int OooO(DefaultRequest defaultRequest) {
        int i = defaultRequest.f8984OooOO0;
        AtomicInteger atomicInteger = SDKGlobalConfiguration.f8989OooO00o;
        return atomicInteger.get() != 0 ? atomicInteger.get() : i;
    }

    public static byte[] OooO0Oo(String str) {
        try {
            MessageDigest messageDigest = f9009OooO00o.get();
            messageDigest.reset();
            messageDigest.update(str.getBytes(StringUtils.f9590OooO00o));
    ...
    public static InputStream OooO0o0(DefaultRequest defaultRequest) {
        try {
            ...
            if (inputStream.markSupported()) {
                return defaultRequest.f8975OooO;
            }
    ...
    public static byte[] OooOO0O(SigningAlgorithm signingAlgorithm, String str, byte[] bArr) {
        try {
            return OooOO0o(str.getBytes(StringUtils.f9590OooO00o), bArr, signingAlgorithm);
        } catch (Exception e) {
    ...
    public static String OooOOO0(SigningAlgorithm signingAlgorithm, String str, byte[] bArr) {
        try {
            return Base64.OooO0O0(OooOO0o(bArr, str.getBytes(StringUtils.f9590OooO00o), signingAlgorithm));
        } catch (Exception e) {
            throw new AmazonClientException("Unable to calculate a request signature: " + e.getMessage(), e);
        }
    }
