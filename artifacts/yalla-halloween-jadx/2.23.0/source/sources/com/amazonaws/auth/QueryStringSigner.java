    ...
    public final void OooO0OO(DefaultRequest defaultRequest, AWSCredentials aWSCredentials) {
        ...
        if (zEquals) {
            ...
            if (HttpUtils.OooO0OO(uri)) {
                StringBuilder sbOooO0O0 = o000Oo0.OooO0O0(strOooO00o, CertificateUtil.DELIMITER);
                sbOooO0O0.append(uri.getPort());
                strOooO00o = sbOooO0O0.toString();
            }
            sb2.append(strOooO00o);
            sb2.append("\n");
            String strConcat = defaultRequest.f8981OooO0o0.getPath() != null ? "" + defaultRequest.f8981OooO0o0.getPath() : "";
            if (defaultRequest.f8976OooO00o != null) {
                if (strConcat.length() > 0 && !strConcat.endsWith("/") && !defaultRequest.f8976OooO00o.startsWith("/")) {
                    strConcat = strConcat.concat("/");
                }
                StringBuilder sbOooO00o = o00OO.OooO00o(strConcat);
                sbOooO00o.append(defaultRequest.f8976OooO00o);
        ...
        defaultRequest.OooO0O0("Signature", AbstractAWSSigner.OooOOO0(signingAlgorithm, aWSCredentialsOooOO0.OooO0OO(), string.getBytes(StringUtils.f9590OooO00o)));
    }
}
