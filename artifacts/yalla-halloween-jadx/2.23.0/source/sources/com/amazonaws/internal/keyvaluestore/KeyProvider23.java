...
class KeyProvider23 {
    ...
    public static final Log f9128OooO00o = LogFactory.OooO00o(KeyProvider23.class);
    ...
    public final synchronized void OooO00o(String str) {
        try {
            ...
            f9128OooO00o.OooO0Oo("Error in deleting the key for keyAlias: " + str + " from Android KeyStore.", e);
        }
    }
    ...
    public final synchronized Key OooO0O0(String str) throws KeyNotGeneratedException {
        ...
        try {
            ...
            f9128OooO00o.OooO0oo("Generated the encryption key identified by the keyAlias: " + str + " using AndroidKeyStore");
        } catch (Exception e) {
