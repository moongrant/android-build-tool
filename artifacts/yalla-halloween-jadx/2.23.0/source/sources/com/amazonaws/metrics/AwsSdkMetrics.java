...
public enum AwsSdkMetrics {
    ...
    public static class MetricRegistry {
        ...
        public final HashSet f9133OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public volatile Set<MetricType> f9134OooO0O0;

        public MetricRegistry() {
            HashSet hashSet = new HashSet();
            this.f9133OooO00o = hashSet;
            ...
            this.f9134OooO0O0 = Collections.unmodifiableSet(new HashSet(hashSet));
        }
    }
    ...
    public static void OooO00o(List list) {
        ...
        synchronized (metricRegistry.f9133OooO00o) {
            if (metricRegistry.f9133OooO00o.addAll(list)) {
                metricRegistry.f9134OooO0O0 = Collections.unmodifiableSet(new HashSet(metricRegistry.f9133OooO00o));
            }
        }
    }
    ...
    public static <T extends RequestMetricCollector> T OooO0OO() {
        ...
        return (T) RequestMetricCollector.f9135OooO00o;
    }
}
