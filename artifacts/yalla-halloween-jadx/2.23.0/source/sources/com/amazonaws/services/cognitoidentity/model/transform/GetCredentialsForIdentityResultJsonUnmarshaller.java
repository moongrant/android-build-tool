...
public class GetCredentialsForIdentityResultJsonUnmarshaller implements Unmarshaller<GetCredentialsForIdentityResult, JsonUnmarshallerContext> {
    ...
    public final GetCredentialsForIdentityResult OooO00o(JsonUnmarshallerContext jsonUnmarshallerContext) throws Exception {
        ...
        AwsJsonReader awsJsonReader = jsonUnmarshallerContext2.f9563OooO00o;
        ...
        while (awsJsonReader.hasNext()) {
            ...
            if (strOooO0o0.equals("IdentityId")) {
                ...
                getCredentialsForIdentityResult.f9263OooO0Oo = jsonUnmarshallerContext2.f9563OooO00o.OooO0o();
            } else if (strOooO0o0.equals("Credentials")) {
                if (CredentialsJsonUnmarshaller.f9265OooO00o == null) {
                    CredentialsJsonUnmarshaller.f9265OooO00o = new CredentialsJsonUnmarshaller();
                }
                CredentialsJsonUnmarshaller.f9265OooO00o.getClass();
                getCredentialsForIdentityResult.f9264OooO0o0 = CredentialsJsonUnmarshaller.OooO0O0(jsonUnmarshallerContext2);
            } else {
