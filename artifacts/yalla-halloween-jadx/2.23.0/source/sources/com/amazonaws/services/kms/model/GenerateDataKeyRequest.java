...
public class GenerateDataKeyRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public final HashMap f9279OooO0oO = new HashMap();

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final ArrayList f9280OooO0oo = new ArrayList();
    ...
    public final boolean equals(Object obj) {
        ...
        HashMap map = generateDataKeyRequest.f9279OooO0oO;
        boolean z = map == null;
        HashMap map2 = this.f9279OooO0oO;
        if (z ^ (map2 == null)) {
            return false;
        }
        ...
        ArrayList arrayList = generateDataKeyRequest.f9280OooO0oo;
        boolean z2 = arrayList == null;
        ArrayList arrayList2 = this.f9280OooO0oo;
    ...
    public final int hashCode() {
        HashMap map = this.f9279OooO0oO;
        int iHashCode = ((((((map == null ? 0 : map.hashCode()) + 961) * 31) + 0) * 31) + 0) * 31;
        ArrayList arrayList = this.f9280OooO0oo;
