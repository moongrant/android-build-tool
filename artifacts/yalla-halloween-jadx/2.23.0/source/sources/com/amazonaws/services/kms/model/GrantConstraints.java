...
public class GrantConstraints implements Serializable {
    ...
    public final HashMap f9286OooO0Oo = new HashMap();

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final HashMap f9287OooO0o0 = new HashMap();
    ...
    public final boolean equals(Object obj) {
        ...
        HashMap map = grantConstraints.f9286OooO0Oo;
        boolean z = map == null;
        HashMap map2 = this.f9286OooO0Oo;
        if (z ^ (map2 == null)) {
            return false;
        }
        ...
        HashMap map3 = grantConstraints.f9287OooO0o0;
        boolean z2 = map3 == null;
        HashMap map4 = this.f9287OooO0o0;
        if (z2 ^ (map4 == null)) {
            return false;
        }
    ...
    public final int hashCode() {
        HashMap map = this.f9286OooO0Oo;
        int iHashCode = ((map == null ? 0 : map.hashCode()) + 31) * 31;
        HashMap map2 = this.f9287OooO0o0;
