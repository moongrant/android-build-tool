...
public abstract class AbstractS3ResponseHandler<T> implements HttpResponseHandler<AmazonWebServiceResponse<T>> {
    ...
    public static final Log f9304OooO00o = LogFactory.OooO00o(S3MetadataResponseHandler.class);

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final HashSet f9305OooO0O0;

    static {
        HashSet hashSet = new HashSet();
        f9305OooO0O0 = hashSet;
        hashSet.add("Date");
        hashSet.add("Server");
    ...
    public static AmazonWebServiceResponse OooO0OO(HttpResponse httpResponse) {
        ...
        amazonWebServiceResponse.f8966OooO0O0 = new S3ResponseMetadata(map2);
    ...
    public static void OooO0Oo(HttpResponse httpResponse, ObjectMetadata objectMetadata) {
        ...
        for (Map.Entry<String, String> entry : map.entrySet()) {
            ...
            if (key.startsWith("x-amz-meta-")) {
                objectMetadata.f9412OooO0Oo.put(key.substring(11), entry.getValue());
            } else {
                boolean zContains = f9305OooO0O0.contains(key);
                Log log = f9304OooO00o;
                if (zContains) {
                    ...
                    try {
                        ...
                        objectMetadata.f9414OooO0o0.put(key, DateUtils.OooO0o0(value));
                    } catch (Exception e) {
                        log.OooOO0O("Unable to parse last modified date: " + entry.getValue(), e);
                    }
                } else if (key.equalsIgnoreCase("Content-Length")) {
                    try {
                        objectMetadata.f9414OooO0o0.put(key, Long.valueOf(Long.parseLong(entry.getValue())));
                    } catch (NumberFormatException e2) {
                        log.OooOO0O("Unable to parse content length: " + entry.getValue(), e2);
                    }
                } else if (key.equalsIgnoreCase("ETag")) {
                    objectMetadata.f9414OooO0o0.put(key, ServiceUtils.OooO00o(entry.getValue()));
                } else if (key.equalsIgnoreCase("Expires")) {
                    try {
                        objectMetadata.f9413OooO0o = DateUtils.OooO0o0(entry.getValue());
                    } catch (Exception e3) {
                    ...
                    try {
                        objectMetadata.f9414OooO0o0.put(key, Integer.valueOf(Integer.parseInt(entry.getValue())));
                    ...
                    objectMetadata.f9414OooO0o0.put(key, entry.getValue());
                }
            }
        }
    }
