...
public class CompleteMultipartUploadRetryCondition implements RetryPolicy.RetryCondition {
    ...
    public final int f9306OooO0O0 = 3;
    ...
    public final boolean OooO00o(AmazonClientException amazonClientException, int i) {
        ...
        return (amazonS3Exception != null && amazonS3Exception.OooO00o() != null && amazonS3Exception.f8949OooO0o != null && amazonS3Exception.OooO00o().contains("InternalError") && amazonS3Exception.f8949OooO0o.contains("Please try again.")) && i < this.f9306OooO0O0;
    }
}
