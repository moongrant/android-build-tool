...
public class DigestValidationInputStream extends SdkDigestInputStream {
    ...
    public final byte[] f9309OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public boolean f9310OooO0o0;
    ...
    public DigestValidationInputStream(SdkFilterInputStream sdkFilterInputStream, MessageDigest messageDigest, byte[] bArr) {
        ...
        this.f9310OooO0o0 = false;
        this.f9309OooO0Oo = bArr;
    }

    public final void OooO00o() {
        byte[] bArr = this.f9309OooO0Oo;
        if (bArr == null || this.f9310OooO0o0) {
            return;
        }
        this.f9310OooO0o0 = true;
