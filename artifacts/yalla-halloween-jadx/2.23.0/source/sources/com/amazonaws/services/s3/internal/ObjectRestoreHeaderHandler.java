...
public class ObjectRestoreHeaderHandler<T extends ObjectRestoreResult> implements HeaderHandler<T> {
    ...
    public static final Pattern f9321OooO00o = Pattern.compile("expiry-date=\"(.*?)\"");

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final Pattern f9322OooO0O0 = Pattern.compile("ongoing-request=\"(.*?)\"");

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final Log f9323OooO0OO = LogFactory.OooO00o(ObjectRestoreHeaderHandler.class);

    public static void OooO0O0(ObjectRestoreResult objectRestoreResult, HttpResponse httpResponse) {
        Date dateOooO0o0;
        String str = httpResponse.f9093OooO0Oo.get("x-amz-restore");
        if (str != null) {
            Matcher matcher = f9321OooO00o.matcher(str);
            if (matcher.find()) {
                ...
                try {
                    ...
                    f9323OooO0OO.OooOO0O("Error parsing expiry-date from x-amz-restore header.", e);
                    dateOooO0o0 = null;
                }
            } else {
                dateOooO0o0 = null;
            ...
            Matcher matcher2 = f9322OooO0O0.matcher(str);
