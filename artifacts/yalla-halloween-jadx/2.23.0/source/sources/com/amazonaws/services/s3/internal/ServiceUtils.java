...
public class ServiceUtils {
    ...
    public static final Log f9341OooO00o = LogFactory.OooO00o(ServiceUtils.class);
    ...
    public static boolean OooO0O0(AmazonWebServiceRequest amazonWebServiceRequest, S3ClientOptions s3ClientOptions) {
        ...
        if (amazonWebServiceRequest instanceof GetObjectRequest) {
            long[] jArr = ((GetObjectRequest) amazonWebServiceRequest).f9393OooO0oo;
        ...
        ObjectMetadata objectMetadata = putObjectRequest.f9354OooOO0O;
        if (objectMetadata != null && ((String) objectMetadata.f9414OooO0o0.get("x-amz-server-side-encryption")) != null) {
            return true;
        }
        if (putObjectRequest.f9359OooOOOo != null) {
            return (SSEAlgorithm.KMS.getAlgorithm() == null && putObjectRequest.f9359OooOOOo.f9437OooO0Oo == null) ? false : true;
        }
        return false;
    }
}
