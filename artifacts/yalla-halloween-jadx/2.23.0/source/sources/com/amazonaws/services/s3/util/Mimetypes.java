...
public final class Mimetypes {
    ...
    public static final Log f9555OooO0O0 = LogFactory.OooO00o(Mimetypes.class);

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static Mimetypes f9556OooO0OO = null;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final HashMap<String, String> f9557OooO00o;

    public Mimetypes() {
        HashMap<String, String> map = new HashMap<>();
        this.f9557OooO00o = map;
    ...
    public static synchronized Mimetypes OooO00o() {
        Mimetypes mimetypes = f9556OooO0OO;
        if (mimetypes != null) {
            return mimetypes;
        }
        f9556OooO0OO = new Mimetypes();
        if (f9555OooO0O0.OooO0O0()) {
            HashMap<String, String> map = f9556OooO0OO.f9557OooO00o;
            for (String str : map.keySet()) {
                f9555OooO0O0.OooO0oO("Setting mime type for extension '" + str + "' to '" + map.get(str) + "'");
            }
        }
        return f9556OooO0OO;
    }
