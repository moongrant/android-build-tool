...
public class AwsHostNameUtils {
    ...
    public static final Pattern f9574OooO00o = Pattern.compile("^(?:.+\\.)?s3[.-]([a-z0-9-]+)$");
    ...
    public static String OooO00o(String str, String str2) {
        ...
        Iterator it = Collections.unmodifiableList(InternalConfig.Factory.f9118OooO00o.f9116OooO0o).iterator();
        while (true) {
            if (!it.hasNext()) {
                str3 = null;
                break;
            ...
            if (str.matches(hostRegexToRegionMapping.f9108OooO00o)) {
                str3 = hostRegexToRegionMapping.f9109OooO0O0;
                break;
            }
        }
        if (str3 != null) {
    ...
    public static String OooO0O0(String str) {
        Matcher matcher = f9574OooO00o.matcher(str);
        if (matcher.matches()) {
