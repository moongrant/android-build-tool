...
class Base64Codec {
    ...
    public final byte[] f9575OooO00o = CodecUtils.OooO00o("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/");

    public static class LazyHolder {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public static final byte[] f9576OooO00o;
    ...
    public static int OooO0O0(byte b) {
        byte b2 = LazyHolder.f9576OooO00o[b];
        if (b2 > -1) {
            return b2;
        }
