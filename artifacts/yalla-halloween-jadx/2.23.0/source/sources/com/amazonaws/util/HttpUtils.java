...
public class HttpUtils {
    ...
    public static final Pattern f9581OooO00o = Pattern.compile(Pattern.quote("+") + "|" + Pattern.quote("*") + "|" + Pattern.quote("%7E") + "|" + Pattern.quote("%2F"));
    ...
    public static String OooO0Oo(String str, boolean z) {
        ...
        try {
            ...
            Matcher matcher = f9581OooO00o.matcher(strEncode);
    ...
    public static boolean OooO0o0(DefaultRequest defaultRequest) {
        return HttpMethodName.POST.equals(defaultRequest.f8983OooO0oo) && (defaultRequest.f8975OooO == null);
    }
}
