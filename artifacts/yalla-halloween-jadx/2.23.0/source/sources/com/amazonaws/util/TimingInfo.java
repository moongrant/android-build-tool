...
public class TimingInfo {
    ...
    public final long f9591OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public Long f9592OooO0O0;
    ...
    public void OooO0O0() {
        this.f9592OooO0O0 = Long.valueOf(System.nanoTime());
    }
    ...
    public final String toString() {
        Double dValueOf;
        Long l = this.f9592OooO0O0;
        if (l != null) {
            dValueOf = Double.valueOf(TimeUnit.NANOSECONDS.toMicros(l.longValue() - this.f9591OooO00o) / 1000.0d);
        } else {
            dValueOf = null;
        }
