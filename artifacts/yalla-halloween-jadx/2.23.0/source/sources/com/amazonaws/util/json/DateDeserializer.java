...
public class DateDeserializer implements Oooo000<Date>, oo000o<Date> {
    ...
    public Date deserialize(Oooo0 oooo0, Type type, OooOo oooOo) {
    ...
    public Oooo0 serialize(Date date, Type type, o00Ooo o00ooo2) {
        o00Oo0 o00oo1;
        synchronized (this.mIso8601DateFormat) {
            o00oo1 = new o00Oo0(this.mIso8601DateFormat.format(date));
        }
        return o00oo1;
    }
}
