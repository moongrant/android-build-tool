...
public class ProxyBillingActivity extends Activity {
    ...
    @Nullable
    public ResultReceiver f9676OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public boolean f9677OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @Nullable
    public ResultReceiver f9678OooO0o0;
    ...
    public final void onActivityResult(int i, int i2, @Nullable Intent intent) {
        ...
        if (i == 100) {
            int i3 = zzb.zzi(intent, "ProxyBillingActivity").f9655OooO00o;
            if (i2 != -1) {
            ...
            ResultReceiver resultReceiver = this.f9676OooO0Oo;
            ...
            ResultReceiver resultReceiver2 = this.f9678OooO0o0;
    ...
    public final void onCreate(@Nullable Bundle bundle) {
        ...
        if (bundle != null) {
            ...
            this.f9677OooO0o = bundle.getBoolean("send_cancelled_broadcast_if_finished", false);
            if (bundle.containsKey("result_receiver")) {
                this.f9676OooO0Oo = (ResultReceiver) bundle.getParcelable("result_receiver");
                return;
            } else {
                if (bundle.containsKey("in_app_message_result_receiver")) {
                    this.f9678OooO0o0 = (ResultReceiver) bundle.getParcelable("in_app_message_result_receiver");
                    return;
                }
                return;
            }
        ...
        if (getIntent().hasExtra("BUY_INTENT")) {
            ...
            this.f9676OooO0Oo = (ResultReceiver) getIntent().getParcelableExtra("result_receiver");
        } else if (getIntent().hasExtra("IN_APP_MESSAGE_INTENT")) {
            pendingIntent = (PendingIntent) getIntent().getParcelableExtra("IN_APP_MESSAGE_INTENT");
            this.f9678OooO0o0 = (ResultReceiver) getIntent().getParcelableExtra("in_app_message_result_receiver");
            i = 101;
        } else {
            pendingIntent = null;
        }
    ...
    public final void onDestroy() {
        super.onDestroy();
        if (isFinishing() && this.f9677OooO0o) {
            Intent intentOooO00o = OooO00o();
    ...
    public final void onSaveInstanceState(@NonNull Bundle bundle) {
        ...
        bundle.putBoolean("send_cancelled_broadcast_if_finished", this.f9677OooO0o);
    }
}
