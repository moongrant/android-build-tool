...
public final class RoomTreasureBox {
    ...
    public static final class TreasureBoxDrawNotify extends GeneratedMessageV3 implements TreasureBoxDrawNotifyOrBuilder {
        ...
        public int hashCode() {
            ...
            if (hasRoomboxTop()) {
                roomboxLevel = o000000O.OooO00o(roomboxLevel, 37, 3, 53) + getRoomboxTop().hashCode();
            }
            if (getAwardUsersCount() > 0) {
                roomboxLevel = o000000O.OooO00o(roomboxLevel, 37, 4, 53) + getAwardUsersList().hashCode();
            }
