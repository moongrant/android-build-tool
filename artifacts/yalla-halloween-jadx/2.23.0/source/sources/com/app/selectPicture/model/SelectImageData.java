...
public class SelectImageData implements Parcelable {
    ...
    public ArrayList<Uri> f9785OooO0Oo;
    ...
    public SelectImageData() {
        this.f9785OooO0Oo = null;
    }

    public final ArrayList<Uri> OooO00o() {
        if (this.f9785OooO0Oo == null) {
            this.f9785OooO0Oo = new ArrayList<>();
        }
        return this.f9785OooO0Oo;
    }
    ...
    public final String toString() {
        return "SelectImageData{, selectUri=" + this.f9785OooO0Oo + '}';
    }

    @Override // android.os.Parcelable
    public final void writeToParcel(Parcel parcel, int i) {
        parcel.writeTypedList(this.f9785OooO0Oo);
    }

    public SelectImageData(Parcel parcel) {
        this.f9785OooO0Oo = null;
        this.f9785OooO0Oo = parcel.createTypedArrayList(Uri.CREATOR);
    }
}
