...
public class QiNiuImageInfoSingleAsyncTask extends AsyncTask<String, Integer, String> {
    ...
    private OooO0OO<ImageInfoModel> mResultCallback;
    ...
    public QiNiuImageInfoSingleAsyncTask addResultCallback(OooO0OO<ImageInfoModel> oooO0OO) {
        this.mResultCallback = oooO0OO;
        return this;
    }
    ...
    public void onPostExecute(String str) {
        ...
        OooO0OO<ImageInfoModel> oooO0OO = this.mResultCallback;
        if (oooO0OO != null) {
            oooO0OO.result(z, imageInfoModel);
        }
    }
