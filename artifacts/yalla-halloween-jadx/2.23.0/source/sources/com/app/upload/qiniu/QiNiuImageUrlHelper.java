...
public class QiNiuImageUrlHelper {
    ...
    public static String getBlurUrl(String str, int i, int i2) {
        ...
        return isGifUrl(str) ? stringMerge(url, imageMogr2_blur, OooOO0.OooO00o(slash, i, "x", i2), format_jpg) : stringMerge(url, imageMogr2_blur, OooOO0.OooO00o(slash, i, "x", i2));
    }
