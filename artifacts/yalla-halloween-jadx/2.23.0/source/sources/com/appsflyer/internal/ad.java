...
public final class ad implements Runnable {
    ...
    private static void valueOf(boolean z, String str, String str2, String str3, String str4) {
        if (ag.AFInAppEventParameterName != null) {
            StringBuilder sbOooO0OO = OooO0o.OooO0OO("Validate callback parameters: ", str, ZegoConstants.ZegoVideoDataAuxPublishingStream, str2, ZegoConstants.ZegoVideoDataAuxPublishingStream);
            sbOooO0OO.append(str3);
            AFLogger.valueOf(sbOooO0OO.toString());
            if (z) {
