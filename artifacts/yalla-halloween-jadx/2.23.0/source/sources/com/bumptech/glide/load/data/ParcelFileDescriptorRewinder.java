...
public final class ParcelFileDescriptorRewinder implements OooO<ParcelFileDescriptor> {
    ...
    public final InternalRewinder f9969OooO00o;

    @RequiresApi(21)
    public static final class InternalRewinder {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final ParcelFileDescriptor f9970OooO00o;

        public InternalRewinder(ParcelFileDescriptor parcelFileDescriptor) {
            this.f9970OooO00o = parcelFileDescriptor;
        }

        public ParcelFileDescriptor rewind() throws IOException {
            ParcelFileDescriptor parcelFileDescriptor = this.f9970OooO00o;
            try {
    ...
    public ParcelFileDescriptorRewinder(ParcelFileDescriptor parcelFileDescriptor) {
        this.f9969OooO00o = new InternalRewinder(parcelFileDescriptor);
    }
    ...
    public final ParcelFileDescriptor OooO00o() throws IOException {
        return this.f9969OooO00o.rewind();
    }
}
