...
public class BaseViewHolder extends RecyclerView.o0O0O00 {
    ...
    public class OooO00o implements View.OnClickListener {
        ...
        public final void onClick(View view) {
            ...
            if (baseViewHolder.adapter.f10101OooO0oo != null) {
                baseViewHolder.adapter.f10101OooO0oo.OooO0OO(baseViewHolder.adapter, view, baseViewHolder.getClickPosition());
            }
        }
    }
    ...
    public class OooO0O0 implements View.OnLongClickListener {
        ...
        public final boolean onLongClick(View view) {
            BaseViewHolder baseViewHolder = BaseViewHolder.this;
            if (baseViewHolder.adapter.f10093OooO == null) {
                return false;
            }
            BaseQuickAdapter.OooO0OO oooO0OO = baseViewHolder.adapter.f10093OooO;
            BaseQuickAdapter unused = baseViewHolder.adapter;
            oooO0OO.OooO0O0(view, baseViewHolder.getClickPosition());
            return true;
        }
    }
