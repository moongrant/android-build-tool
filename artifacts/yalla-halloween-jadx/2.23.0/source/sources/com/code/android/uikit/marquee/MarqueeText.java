...
public final class MarqueeText extends AppCompatTextView {
    ...
    public int f10149OooOO0O;

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    public int f10150OooOO0o;
    ...
    public static void OooOO0o(MarqueeText marqueeText) {
        o0ooOOo o0ooooo = o000O0.f10356OooO0OO;
        if (o0ooooo == null) {
    ...
    public int getLayoutDirection() {
        return this.f10149OooOO0O;
    }

    @Override // android.view.View
    public int getTextDirection() {
        return this.f10150OooOO0o;
    }
    ...
    public TextDirectionHeuristic getTextDirectionHeuristic() {
        ...
        Intrinsics.checkNotNullExpressionValue(textDirectionHeuristic, "super.getTextDirectionHeuristic()");
    ...
    public final void setLeftToRight(boolean isLTR) {
        this.f10149OooOO0O = !isLTR ? 1 : 0;
        this.f10150OooOO0o = isLTR ? 3 : 4;
    }
    ...
    public MarqueeText(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        this.f10149OooOO0O = 1;
        this.f10150OooOO0o = 4;
    }
}
