...
public final class o00Oo0 {
    ...
    public static final class OooO00o extends Lambda implements Function1<DisposableEffectScope, DisposableEffectResult> {
        ...
        public final /* synthetic */ State<LifecycleOwner> f10375OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ State<Function1<Lifecycle.Event, Unit>> f10376OooO0o0;
        ...
        public OooO00o(State<? extends LifecycleOwner> state, State<? extends Function1<? super Lifecycle.Event, Unit>> state2) {
            super(1);
            this.f10375OooO0Oo = state;
            this.f10376OooO0o0 = state2;
        }
        ...
        public final DisposableEffectResult invoke(DisposableEffectScope disposableEffectScope) {
            ...
            Lifecycle lifecycle = this.f10375OooO0Oo.getValue().getLifecycle();
            final State<Function1<Lifecycle.Event, Unit>> state = this.f10376OooO0o0;
    ...
    public static final class OooO0O0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function1<Lifecycle.Event, Unit> f10377OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f10378OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public OooO0O0(Function1<? super Lifecycle.Event, Unit> function1, int i) {
            super(2);
            this.f10377OooO0Oo = function1;
            this.f10378OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f10378OooO0o0 | 1);
            o00Oo0.OooO0O0(this.f10377OooO0Oo, composer, iUpdateChangedFlags);
    ...
    public static final class OooO0OO extends Lambda implements Function1<DisposableEffectScope, DisposableEffectResult> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ State<LifecycleOwner> f10379OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ State<Function0<Unit>> f10380OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ Lifecycle.Event f10381OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public OooO0OO(State<? extends LifecycleOwner> state, Lifecycle.Event event, State<? extends Function0<Unit>> state2) {
            super(1);
            this.f10379OooO0Oo = state;
            this.f10381OooO0o0 = event;
            this.f10380OooO0o = state2;
        }
        ...
        public final DisposableEffectResult invoke(DisposableEffectScope disposableEffectScope) {
            DisposableEffectScope DisposableEffect = disposableEffectScope;
            Intrinsics.checkNotNullParameter(DisposableEffect, "$this$DisposableEffect");
            Lifecycle lifecycle = this.f10379OooO0Oo.getValue().getLifecycle();
            final Lifecycle.Event event = this.f10381OooO0o0;
            final State<Function0<Unit>> state = this.f10380OooO0o;
    ...
    public static final class OooO0o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Lifecycle.Event f10382OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f10383OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ Function0<Unit> f10384OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(Lifecycle.Event event, Function0<Unit> function0, int i) {
            super(2);
            this.f10382OooO0Oo = event;
            this.f10384OooO0o0 = function0;
            this.f10383OooO0o = i;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f10383OooO0o | 1);
            o00Oo0.OooO00o(this.f10382OooO0Oo, this.f10384OooO0o0, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
