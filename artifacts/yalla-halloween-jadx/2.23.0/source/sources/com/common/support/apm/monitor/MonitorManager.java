...
public final class MonitorManager {
    ...
    public final int convertToModuleStatus(int errorCode) {
        ...
        if (errorCode != -100) {
            if (-399 <= errorCode && errorCode <= -200) {
                z = true;
            }
            if (z) {
                return 1;
    ...
    public static /* synthetic */ void writeMonitorLog$sailfish_release$default(MonitorManager monitorManager, DataMetricModel dataMetricModel, int i, Throwable th, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            i = 0;
        }
        if ((i2 & 4) != 0) {
        ...
        monitorManager.writeMonitorLog$sailfish_release(dataMetricModel, i, th);
    }

    public static /* synthetic */ void writeMonitorLogForInit$sailfish_release$default(MonitorManager monitorManager, StatusMetricModel statusMetricModel, long j, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = 0;
        }
        monitorManager.writeMonitorLogForInit$sailfish_release(statusMetricModel, j, i);
    }
    ...
    public final void init$sailfish_release(@NotNull o00OOOO0 okHttpClient) {
    ...
    public final void writeMonitorLog$sailfish_release(@NotNull DataMetricModel dataMetric, int errorCode, @Nullable Throwable throwable) {
        String string;
        Intrinsics.checkNotNullParameter(dataMetric, "dataMetric");
        Sailfish.INSTANCE.writeMonitorLog(MonitorLogHelper.INSTANCE.create(dataMetric.getType(), 0, 1, errorCode, (throwable == null || (string = throwable.toString()) == null) ? "" : string));
    }

    public final void writeMonitorLogForInit$sailfish_release(@NotNull StatusMetricModel statusMetric, long initSpendTime, int errorCode) {
        Intrinsics.checkNotNullParameter(statusMetric, "statusMetric");
        Sailfish.INSTANCE.writeMonitorLog(MonitorLogHelper.INSTANCE.createInit(statusMetric.getType(), statusMetric.getStatus(), getModuleErrorType(errorCode), initSpendTime, errorCode, ""));
    }
    ...
    private final void updateHttpCallDataMetric(DataMetricModel dataMetric, ConsecutiveEventIntGenerator generator, boolean isSuccess, int errorCode, Throwable throwable) {
        if (isSuccess) {
            ...
            writeMonitorLog$sailfish_release(dataMetric, errorCode, throwable);
        }
    }
