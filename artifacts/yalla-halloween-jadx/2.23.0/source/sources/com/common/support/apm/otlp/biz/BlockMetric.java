...
@Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\u0018\u0000 \n2\u00020\u0001:\u0001\nB\u0005¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\tR\u0016\u0010\u0003\u001a\n \u0005*\u0004\u0018\u00010\u00040\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u000b"}, d2 = {"Lcom/common/support/apm/otlp/biz/BlockMetric;", "", "()V", "blockCounter", "Lio/opentelemetry/api/metrics/LongCounter;", "kotlin.jvm.PlatformType", "counter", "", "isForeground", "", "Companion", "sailfish_release"}, k = 1, mv = {1, 5, 1}, xi = 48)
public final class BlockMetric {
    ...
    private final LongCounter blockCounter = YallaOtlpSdk.INSTANCE.getMeterProvider().OooO0OO().OooO00o(METER_NAME_BLOCK).build();

    @NotNull
    private static final String ATTRIBUTE_KEY_PROCESS_STATUS = "process.status";
    private static final AttributeKey<Long> processStatusKey = OooO0o.OooO0OO(ATTRIBUTE_KEY_PROCESS_STATUS);
    ...
    public final void counter(boolean isForeground) {
        ...
        LoggerKt.logD$default(null, new Function0<String>() { // from class: com.common.support.apm.otlp.biz.BlockMetric.counter.1
            ...
            public final String invoke() {
                return Intrinsics.stringPlus("BlockCounter processStatus: ", Long.valueOf(j));
            }
        }, 1, null);
        this.blockCounter.OooO0O0(OooO.OooO0OO(processStatusKey, Long.valueOf(j)));
    }
}
