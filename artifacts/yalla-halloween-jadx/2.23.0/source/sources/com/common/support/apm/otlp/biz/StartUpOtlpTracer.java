...
public final class StartUpOtlpTracer {
    ...
    public final Span startApplicationSpan(@NotNull String name, long time, @NotNull Span parentSpan) {
        ...
        Span spanOooO00o = this.tracer.OooO00o(name).OooO0o0(SpanKind.CLIENT).OooO0o(time, TimeUnit.NANOSECONDS).OooO0OO(OooO0O0.OooO00o().OooO0o0(parentSpan)).OooO0O0().OooO00o();
    ...
    public final Span startColdSpan(@NotNull String name, long time) {
        Intrinsics.checkNotNullParameter(name, "name");
        Span spanOooO00o = this.tracer.OooO00o(name).OooO0o0(SpanKind.CLIENT).OooO0o(time, TimeUnit.NANOSECONDS).OooO0oO("2").OooO0O0().OooO00o();
        Intrinsics.checkNotNullExpressionValue(spanOooO00o, "tracer.spanBuilder(name)…(true)\n      .startSpan()");
    ...
    public final Span startWarmSpan(@NotNull String name) {
        Intrinsics.checkNotNullParameter(name, "name");
        Span spanOooO00o = this.tracer.OooO00o(name).OooO0o0(SpanKind.CLIENT).OooO0O0().OooO0oO("3").OooO00o();
    ...
    public final void endFirstScreenSpan(boolean result) {
        ...
        if (result) {
            ...
            span3.OooO0oO(StatusCode.ERROR);
        }
