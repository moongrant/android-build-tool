...
@Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\b\u0003\n\u0002\u0010\b\n\u0000\bÆ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J.\u0010\u0003\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00050\u00040\u0004\"\u0004\b\u0000\u0010\u00052\f\u0010\u0006\u001a\b\u0012\u0004\u0012\u0002H\u00050\u00042\u0006\u0010\u0007\u001a\u00020\b¨\u0006\t"}, d2 = {"Lcom/common/support/apm/utils/ListSplitUtil;", "", "()V", "split", "", "T", "dataList", "groupSize", "", "sailfish_release"}, k = 1, mv = {1, 5, 1}, xi = 48)
    ...
    public final <T> List<List<T>> split(@NotNull List<? extends T> dataList, int groupSize) {
        ...
        if (i > 0) {
            ...
            while (true) {
                ...
                arrayList.add(dataList.subList(i4, i5));
                if (i3 >= i) {
                    break;
                }
                i2 = i3;
