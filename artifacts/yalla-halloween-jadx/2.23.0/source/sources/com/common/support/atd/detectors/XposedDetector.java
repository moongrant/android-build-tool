...
public final class XposedDetector extends AbstractDetector {
    ...
    private final boolean checkByPackageName(Context context, String pkgName) {
        ...
        while (it.hasNext()) {
            if (Intrinsics.areEqual(it.next().packageName, pkgName)) {
                return true;
            }
        }
        return false;
                    ...
                    while (true) {
                        ...
                        if (r5 == 0) {
                            for (String str : linkedHashSet) {
                                if (StringsKt.OooO0o(str, "com.saurik.substrate")) {
                                    bufferedReader.close();
                                    return true;
                                }
                                if (StringsKt.OooO0o(str, "XposedBridge.jar")) {
                                    bufferedReader.close();
                                    return true;
                                }
                            }
                        ...
                        if (StringsKt.OooOO0O((String) objectRef.element, ".so") || StringsKt.OooOO0O((String) objectRef.element, ".jar")) {
    ...
    private final boolean checkXposedByThrow(String key) {
        try {
            ...
            for (StackTraceElement stackTraceElement : stackTrace) {
                ...
                if (StringsKt.OooO0o(className, key)) {
                    return true;
                }
            }
            return false;
