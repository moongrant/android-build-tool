...
public final class VirtualApkApi extends BaseApi {
    ...
    public final void requestPackageList(@NotNull String localHash, @NotNull Function1<? super BaseServerResponse<PackageRespModel>, Unit> onSuccess) {
        ...
        o00OOOOo o00oooooPost = post(REQUEST_PATH, new Pair<>("VersionHex", localHash));
        ...
        async(o00oooooPost, respType, new Function2<Integer, Throwable, Unit>() { // from class: com.common.support.atd.network.VirtualApkApi.requestPackageList.1
