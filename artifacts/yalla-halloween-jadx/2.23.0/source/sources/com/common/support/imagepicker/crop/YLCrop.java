...
public final class YLCrop extends ImagePicker implements Crop {
    ...
    */
    ...
    /* JADX INFO: renamed from: enterCrop$lambda-1$lambda-0, reason: not valid java name */
    public static final void m4020enterCrop$lambda1$lambda0(YLCrop this$0, int i, int i2) {
    ...
    public void enterCrop(final int width, final int height) {
        ...
        if (checkCropSupported()) {
            ...
            if (baseMediaCanvasLayout != null && (baseMediaCropLayout = this.mMediaCrop) != null) {
                baseMediaCropLayout.showCrop$crop_release(baseMediaCanvasLayout, this.mCropInfo, new Runnable() { // from class: o00OooO0.o00000O
                    @Override // java.lang.Runnable
                    public final void run() {
                        YLCrop.m4020enterCrop$lambda1$lambda0(this.f38531OooO0Oo, width, height);
                    }
                });
                unit = Unit.INSTANCE;
            }
