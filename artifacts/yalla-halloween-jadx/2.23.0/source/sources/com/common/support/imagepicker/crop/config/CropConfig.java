...
public final /* data */ class CropConfig {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("CropConfig(scaleEnabled=");
        sb.append(this.scaleEnabled);
        sb.append(", showCropFrame=");
        sb.append(this.showCropFrame);
        sb.append(", cropColor=");
        sb.append(this.cropColor);
        sb.append(", shadowBackgroundColor=");
        return OooO0O0.OooO00o(sb, this.shadowBackgroundColor, ')');
    }
