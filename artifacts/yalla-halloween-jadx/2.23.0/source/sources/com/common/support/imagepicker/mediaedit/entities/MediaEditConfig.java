...
public final /* data */ class MediaEditConfig implements Parcelable {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("MediaEditConfig(rootPath=");
        sb.append(this.rootPath);
        sb.append(", saveToAlbum=");
        sb.append(this.saveToAlbum);
        sb.append(", needCompress=");
        sb.append(this.needCompress);
        sb.append(", needDeduplication=");
        return OooO0o.OooO00o(sb, this.needDeduplication, ')');
    }
