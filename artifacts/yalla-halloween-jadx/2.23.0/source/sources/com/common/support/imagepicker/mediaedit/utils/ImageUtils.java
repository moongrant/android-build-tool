...
public final class ImageUtils {
    ...
    private final String getImagePathFromUri(Context context, Uri uri) {
        ...
        if (StringsKt.OooOO0o("content", uri.getScheme())) {
            return getFilePathFromMediaStore(context, uri);
        }
        if (StringsKt.OooOO0o(ShareInternalUtility.STAGING_PARAM, uri.getScheme())) {
            return uri.getPath();
        }
        return null;
    }
    ...
    public final String getImageExtension(@NotNull Context context, @NotNull Uri uri) {
        ...
        try {
            ...
            try {
                ...
                String strOooOoO = StringsKt.OooOoO(str, "image/", "");
    ...
    public final int[] getImageWidthHeight(@NotNull File file) {
        ...
        try {
            ...
            Object objM4213constructorimpl = Result.m4213constructorimpl(ResultKt.createFailure(th));
            int[] iArr = {0, 0};
            if (Result.m4219isFailureimpl(objM4213constructorimpl)) {
                objM4213constructorimpl = iArr;
            }
            return (int[]) objM4213constructorimpl;
        }
    }
    ...
    public final int[] getImageWidthHeight2(@NotNull Context context, @NotNull Uri uri) {
        ...
        try {
            ...
            Result.Companion companion2 = Result.INSTANCE;
            if (Result.m4216exceptionOrNullimpl(Result.m4213constructorimpl(ResultKt.createFailure(th))) != null) {
                return new int[]{0, 0};
            }
    ...
    public final int[] getImageWidthHeight(@NotNull Context context, @NotNull Uri uri) {
        ...
        try {
            ...
            objM4213constructorimpl = Result.m4213constructorimpl(obj);
        } catch (Throwable th3) {
            Result.Companion companion2 = Result.INSTANCE;
            objM4213constructorimpl = Result.m4213constructorimpl(ResultKt.createFailure(th3));
        }
        if (!Result.m4219isFailureimpl(objM4213constructorimpl)) {
            obj2 = objM4213constructorimpl;
        }
        return (int[]) obj2;
    }
}
