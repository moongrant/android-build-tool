...
public final class MediaEditPostProcessor {
    ...
    public abstract class BaseTask {
        ...
        /* JADX INFO: renamed from: setComplete$lambda-1, reason: not valid java name */
        public static final void m4022setComplete$lambda1(MediaEditPostProcessor this$0) {
        ...
        public final void setComplete(@Nullable AlbumItem item) {
            ...
            handler.post(new Runnable() { // from class: com.common.support.imagepicker.mediaedit.utils.OooO00o
                ...
                public final void run() {
                    MediaEditPostProcessor.BaseTask.m4022setComplete$lambda1(mediaEditPostProcessor);
                }
            });
        }
