...
public final class OffScreenRender {
    ...
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\u0012\u0010\u0002\u001a\u00020\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005H&¨\u0006\u0006"}, d2 = {"Lcom/common/support/imagepicker/mediaedit/utils/OffScreenRender$Callback;", "", "onBitmap", "", "bitmap", "Landroid/graphics/Bitmap;", "mediaedit_release"}, k = 1, mv = {1, 7, 1}, xi = 48)
    public interface Callback {
        void onBitmap(@Nullable Bitmap bitmap);
    }

    @Metadata(d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J$\u0010\u0005\u001a\u0004\u0018\u00010\u00062\u0006\u0010\u0007\u001a\u00020\b2\b\b\u0002\u0010\t\u001a\u00020\n2\b\b\u0002\u0010\u000b\u001a\u00020\nJ\u001c\u0010\f\u001a\u0004\u0018\u00010\u00062\b\u0010\r\u001a\u0004\u0018\u00010\u00062\b\u0010\u000e\u001a\u0004\u0018\u00010\u000fJ\u0010\u0010\u0010\u001a\u0004\u0018\u00010\u00062\u0006\u0010\u0011\u001a\u00020\u0012R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0013"}, d2 = {"Lcom/common/support/imagepicker/mediaedit/utils/OffScreenRender$Companion;", "", "()V", "TAG", "", "decodeBitmapSync", "Landroid/graphics/Bitmap;", ShareConstants.MEDIA_URI, "Landroid/net/Uri;", ViewHierarchyConstants.DIMENSION_WIDTH_KEY, "", ViewHierarchyConstants.DIMENSION_HEIGHT_KEY, "getCropBitmap", "sourceBitmap", "cropInfo", "Lcom/common/support/imagepicker/crop/entites/CropInfo;", "getSourceBitmap", "source", "Lcom/common/support/imagepicker/dataprovider/entities/AlbumItemWrapper;", "mediaedit_release"}, k = 1, mv = {1, 7, 1}, xi = 48)
    public static final class Companion {
        ...
        public final Bitmap decodeBitmapSync(@NotNull Uri uri, int width, int height) {
            ...
            try {
                OooOOOO oooOOOOOooO0o = com.bumptech.glide.OooO0OO.OooO0oo(ImagePickerContextUtil.INSTANCE.getSAppContext()).OooO0oo().o000oOoO(uri).OooOo0O(width, height).OooO0o();
                oooOOOOOooO0o.getClass();
                OooO0o oooO0o = new OooO0o();
                oooOOOOOooO0o.OoooO(oooO0o, oooO0o, oooOOOOOooO0o, o000000O.f54562OooO0O0);
                Bitmap bitmap = (Bitmap) oooO0o.get();
                ImagePickerLogUtil.d(OffScreenRender.TAG, "decodeBitmapSync: " + bitmap.getWidth() + ", " + bitmap.getHeight());
                return Bitmap.createBitmap(bitmap);
            } catch (Exception e) {
                StringBuilder sb = new StringBuilder("decodeBitmapSync, exception=");
                e.printStackTrace();
                sb.append(Unit.INSTANCE);
                ImagePickerLogUtil.d(OffScreenRender.TAG, sb.toString());
                return null;
            }
        }
    ...
    /* JADX INFO: renamed from: decodeBitmap$lambda-1, reason: not valid java name */
    public static final void m4023decodeBitmap$lambda1(AlbumItem image, int i, Ref.IntRef targetHeight, OffScreenRender this$0, final LoadTask task) {
        Intrinsics.checkNotNullParameter(image, "$image");
        Intrinsics.checkNotNullParameter(targetHeight, "$targetHeight");
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(task, "$task");
        final Bitmap bitmapDecodeBitmapSync = INSTANCE.decodeBitmapSync(image.getContentUri(), i, targetHeight.element);
        this$0.uiHandler.post(new Runnable() { // from class: com.common.support.imagepicker.mediaedit.utils.OooO0OO
            @Override // java.lang.Runnable
            public final void run() {
                OffScreenRender.m4024decodeBitmap$lambda1$lambda0(task, bitmapDecodeBitmapSync);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: decodeBitmap$lambda-1$lambda-0, reason: not valid java name */
    public static final void m4024decodeBitmap$lambda1$lambda0(LoadTask task, Bitmap bitmap) {
        Intrinsics.checkNotNullParameter(task, "$task");
    ...
    public final LoadTask decodeBitmap(@NotNull final AlbumItem image, @Nullable Callback callback) {
        ...
        loadTask.setRunnable(new Runnable() { // from class: com.common.support.imagepicker.mediaedit.utils.OooO0O0
            @Override // java.lang.Runnable
            public final void run() {
                OffScreenRender.m4023decodeBitmap$lambda1(image, 1280, intRef, this, loadTask);
            }
        });
