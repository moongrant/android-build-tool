...
class CustomGestureDetector {
    ...
    public CustomGestureDetector(Context context, OnGestureListener onGestureListener) {
        ...
        this.mDetector = new ScaleGestureDetector(context, new ScaleGestureDetector.OnScaleGestureListener() { // from class: com.common.support.imagepicker.preview.attacher.CustomGestureDetector.1
    ...
    private float getActiveX(MotionEvent motionEvent) {
        int activePointerIndex = getActivePointerIndex(motionEvent);
        if (activePointerIndex == -1) {
            return motionEvent.getX();
        }
        try {
            return motionEvent.getX(activePointerIndex);
    ...
    private float getActiveY(MotionEvent motionEvent) {
        ...
        try {
            return motionEvent.getY(activePointerIndex);
        } catch (Exception unused) {
            return motionEvent.getY();
        }
    }
