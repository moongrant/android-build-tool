...
public final class YLVideoView extends FrameLayout implements DefaultLifecycleObserver, VideoView {
    ...
    @Metadata(d1 = {"\u00008\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u0007\n\u0000\b\u0082\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J$\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\n\u0010\u0007\u001a\u00060\bj\u0002`\t2\u0006\u0010\n\u001a\u00020\u000bH\u0016J\b\u0010\f\u001a\u00020\u0004H\u0016J(\u0010\r\u001a\u00020\u00042\u0006\u0010\u000e\u001a\u00020\u000f2\u0006\u0010\u0010\u001a\u00020\u000f2\u0006\u0010\u0011\u001a\u00020\u000f2\u0006\u0010\u0012\u001a\u00020\u0013H\u0016¨\u0006\u0014"}, d2 = {"Lcom/common/support/imagepicker/preview/component/video/widget/YLVideoView$MyListener;", "Lcom/common/support/imagepicker/player/MediaPlayer$Listener;", "(Lcom/common/support/imagepicker/preview/component/video/widget/YLVideoView;)V", "onError", "", "player", "Lcom/common/support/imagepicker/player/MediaPlayer;", "e", "Ljava/lang/Exception;", "Lkotlin/Exception;", "renderErrorMsg", "", "onRenderedFirstFrame", "onVideoSizeChanged", ViewHierarchyConstants.DIMENSION_WIDTH_KEY, "", ViewHierarchyConstants.DIMENSION_HEIGHT_KEY, "unAppliedRotationDegrees", "pixelWidthHeightRatio", "", "preview_release"}, k = 1, mv = {1, 7, 1}, xi = 48)
    ...
    private final void loadVideoCover() {
        ...
        if (playerSource != null) {
            ...
            if (!(scheme2 != null && StringsKt.Oooo00o(scheme2, "http"))) {
            ...
            if (thumbnailUri != null && (scheme = thumbnailUri.getScheme()) != null) {
                ...
                z = StringsKt.Oooo00o(scheme, "http");
            }
            if (z) {
            ...
            ImagePickerLogUtil imagePickerLogUtil = ImagePickerLogUtil.INSTANCE;
            StringBuilder sb = new StringBuilder("coverUri = ");
            sb.append(thumbnailUri != null ? thumbnailUri.toString() : null);
            imagePickerLogUtil.w("YLVideoView", sb.toString());
        }
    }
    ...
    public BaseViewAttacher mo4027getViewAttacher() {
