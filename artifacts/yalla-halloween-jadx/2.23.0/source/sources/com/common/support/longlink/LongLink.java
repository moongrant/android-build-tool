...
public interface LongLink<IN> {
    ...
    public static final class Companion {
        ...
        @NotNull
        public final <IN, OUT> LongLink<IN> createWebSocketLongLink(@NotNull Context context, @NotNull Protocol<IN, OUT> protocol, @NotNull MessageHandler<OUT> messageHandler, @NotNull o00OOOO0 okHttpClient, @NotNull final o00OOOOo originalRequest, @NotNull ReconnectionConfig reconnectionConfig, @NotNull PulseAdapter pulseAdapter, @Nullable CoroutineContext coroutineParentContext) {
            Intrinsics.checkNotNullParameter(context, "context");
            Intrinsics.checkNotNullParameter(protocol, "protocol");
            Intrinsics.checkNotNullParameter(messageHandler, "messageHandler");
            ...
            Intrinsics.checkNotNullParameter(reconnectionConfig, "reconnectionConfig");
            Intrinsics.checkNotNullParameter(pulseAdapter, "pulseAdapter");
            return create(context, protocol, messageHandler, new WebSocketConnectionFactory(okHttpClient, new Function0<o00OOOOo>() { // from class: com.common.support.longlink.LongLink$Companion$createWebSocketLongLink$1
                {
                    super(0);
                }
        ...
        @NotNull
        public final <IN, OUT> LongLink<IN> createWebSocketLongLink(@NotNull Context context, @NotNull Protocol<IN, OUT> protocol, @NotNull MessageHandler<OUT> messageHandler, @NotNull o00OOOO0 okHttpClient, @NotNull Function0<o00OOOOo> originalRequest, @NotNull ReconnectionConfig reconnectionConfig, @NotNull PulseAdapter pulseAdapter, @Nullable CoroutineContext coroutineParentContext) {
            Intrinsics.checkNotNullParameter(context, "context");
            Intrinsics.checkNotNullParameter(protocol, "protocol");
            Intrinsics.checkNotNullParameter(messageHandler, "messageHandler");
            Intrinsics.checkNotNullParameter(okHttpClient, "okHttpClient");
