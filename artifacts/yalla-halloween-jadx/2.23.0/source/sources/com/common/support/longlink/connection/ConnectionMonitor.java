...
public final class ConnectionMonitor<IN> implements Closeable {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public static final class C01901 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public C01901(ConnectionMonitor<IN> connectionMonitor, Continuation<? super C01901> continuation) {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                ...
                C01901 c01901 = new C01901(this.this$0, null);
                this.label = 1;
    ...
    public static final class C08861 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C08861(ConnectionMonitor<IN> connectionMonitor, Continuation<? super C08861> continuation) {
            super(continuation);
            this.this$0 = connectionMonitor;
        }
    ...
    public static final class C08871 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C08871(ConnectionMonitor<IN> connectionMonitor, Continuation<? super C08871> continuation) {
            super(2, continuation);
            this.this$0 = connectionMonitor;
        }
    ...
    public static final class C08881 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        int label;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C08881(ConnectionMonitor<IN> connectionMonitor, Continuation<? super C08881> continuation) {
            super(continuation);
            this.this$0 = connectionMonitor;
        }
    ...
    public final Object delay(Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C08861) {
            ...
            if ((i & Integer.MIN_VALUE) != 0) {
                ...
                c08861 = new C08861(this, continuation);
            }
        } else {
            c08861 = new C08861(this, continuation);
        }
        Object obj = c08861.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c08861.label;
        try {
            if (i2 == 0) {
                ...
                c08861.label = 1;
                if (deferredAsync$default.await(c08861) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i2 != 1) {
    ...
    public final void onNetworkStateChanged(NetworkState state) {
        if (state.isConnected()) {
            this.reconnectionJob = this.longLink.launch$longlink_release(new C08871(this, null));
        } else {
    ...
    public final Object reconnectIfNeeded(Connection connection, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (continuation instanceof C08881) {
            c08881 = (C08881) continuation;
            int i = c08881.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c08881.label = i - Integer.MIN_VALUE;
            } else {
                c08881 = new C08881(this, continuation);
            }
        } else {
            c08881 = new C08881(this, continuation);
        }
        Object obj = c08881.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c08881.label;
        try {
            if (i2 == 0) {
                ...
                mutex = this.mutex;
                c08881.L$0 = this;
                c08881.L$1 = connection;
                c08881.L$2 = mutex;
                c08881.label = 1;
                if (mutex.lock(null, c08881) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                ...
                if (i2 != 1) {
                    ...
                    mutex2 = (Mutex) c08881.L$1;
                    connectionMonitor2 = (ConnectionMonitor) c08881.L$0;
                    try {
                        ResultKt.throwOnFailure(obj);
                ...
                Mutex mutex3 = (Mutex) c08881.L$2;
                Connection connection2 = (Connection) c08881.L$1;
                connectionMonitor = (ConnectionMonitor) c08881.L$0;
                ResultKt.throwOnFailure(obj);
                mutex = mutex3;
            ...
            c08881.L$0 = connectionMonitor;
            c08881.L$1 = mutex;
            c08881.L$2 = null;
            c08881.label = 2;
            if (connectionMonitor.delay(c08881) == coroutine_suspended) {
                return coroutine_suspended;
            }
            mutex2 = mutex;
