...
public final class MessageReader extends LoopTask {
    ...
    private final byte[] read() throws IOException {
        ...
        StringBuilder sbOooO00o = o0000O0.OooO00o("Out of buffer! pkg total length is ", iBodyLength, ", read buffer length is ");
        sbOooO00o.append(this.readBuffer.getLength());
        throw new ReadException(sbOooO00o.toString());
    }
