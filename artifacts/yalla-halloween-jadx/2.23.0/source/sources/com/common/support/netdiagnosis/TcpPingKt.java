        ...
        while (true) {
            ...
            try {
                ...
                if (i4 == 0) {
                    ...
                    sb.append(str);
                    sb.append(':');
                    return new TcpPingResult(oo000o.OooO00o(sb, str2, '\n'), -1);
                }
                i3++;
                ...
                sb2.append(str2);
                sb2.append("/tcp - ");
                strOooO00o = oo000o.OooO00o(sb2, b == -3 ? "TimeOut" : "NotReach", '\n');
            }
            int iCurrentTimeMillis = (int) (System.currentTimeMillis() - jCurrentTimeMillis);
            String str5 = strOooO00o + str4 + inetAddress + ':' + str2 + "/tcp - time=" + iCurrentTimeMillis + "ms\n";
