...
public final class CustomChannel<T> {
    ...
    public static final class C08901 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C08901(CustomChannel<T> customChannel, Continuation<? super C08901> continuation) {
            super(2, continuation);
            this.this$0 = customChannel;
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C08901(this.this$0, continuation);
        }
    ...
    public static final class C08911 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C08911(CustomChannel<T> customChannel, Continuation<? super C08911> continuation) {
            super(2, continuation);
            this.this$0 = customChannel;
        }
    ...
    public static final class C08921 extends ContinuationImpl {
        Object L$0;
        int label;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C08921(CustomChannel<T> customChannel, Continuation<? super C08921> continuation) {
            super(continuation);
            this.this$0 = customChannel;
        }
    ...
    public static final class C08931 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C08931(CustomChannel<T> customChannel, Continuation<? super C08931> continuation) {
            super(2, continuation);
            this.this$0 = customChannel;
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C08931(this.this$0, continuation);
        }
    ...
    public final void arouseQueuePolling() {
        BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new C08901(this, null), 3, null);
    }
    ...
    public final Object executeItem(CoroutineScope coroutineScope, T t, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (continuation instanceof C08921) {
            ...
            if ((i & Integer.MIN_VALUE) != 0) {
                c08921.label = i - Integer.MIN_VALUE;
            } else {
                c08921 = new C08921(this, continuation);
            }
        } else {
            c08921 = new C08921(this, continuation);
        }
        ...
        if (i2 != 0) {
            if (i2 == 1) {
                customChannel = (CustomChannel) c08921.L$0;
                ResultKt.throwOnFailure(obj);
            } else {
                if (i2 != 2) {
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        ...
        if (function3 != null) {
            c08921.L$0 = this;
            c08921.label = 1;
            if (function3.invoke(coroutineScope, t, c08921) == coroutine_suspended) {
        ...
        c08921.L$0 = customChannel;
        c08921.label = 2;
        CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(IntrinsicsKt.intercepted(c08921), 1);
        cancellableContinuationImpl.initCancellability();
        customChannel.outContinuationState.setValue(cancellableContinuationImpl);
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            DebugProbesKt.probeCoroutineSuspended(c08921);
        }
    ...
    public final void clear() {
        BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, Dispatchers.getMain(), null, new C08911(this, null), 2, null);
    }
    ...
    public final void resume() {
        BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new C08931(this, null), 3, null);
    }
