...
public final class RoomGiftVideoPlayManager {
    ...
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\u0010\u0004\u001a\u00020\u0003*\u00020\u00002\u0006\u0010\u0002\u001a\u00020\u0001H\u008a@"}, d2 = {"Lkotlinx/coroutines/CoroutineScope;", "Lcom/common/support/roomgiftplayer/VideoModel;", "videoModel", "", "<anonymous>"}, k = 3, mv = {1, 8, 0})
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i != 0) {
                ...
                if (videoModel2.isDownloadUrl()) {
                    ...
                    File file3 = new File(y0.OooO0OO(), fileNameByUrl);
                    if (file3.exists()) {
    ...
    public static final class C08941 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
    ...
    public final Object realPlay(File file, VideoModel videoModel, Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C08941) {
            c08941 = (C08941) continuation;
            int i = c08941.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c08941.label = i - Integer.MIN_VALUE;
            } else {
                c08941 = new C08941(continuation);
            }
        } else {
            c08941 = new C08941(continuation);
        }
        Object objPlay = c08941.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c08941.label;
        ...
        if (i2 == 0) {
            ...
            if (i3 == 1 || i3 == 2) {
                ...
                c08941.L$0 = this;
                c08941.L$1 = videoModel;
                c08941.label = 1;
                if (yyEvaVideoView.play(file, videoModel, c08941) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                ...
                if (svgaView2 != null) {
                    ...
                    c08941.L$1 = videoModel;
                    c08941.label = 2;
                    objPlay = svgaView2.play(file, videoModel, c08941);
            ...
            videoModel = (VideoModel) c08941.L$1;
            roomGiftVideoPlayManager = (RoomGiftVideoPlayManager) c08941.L$0;
            ResultKt.throwOnFailure(objPlay);
            RoomGiftVideoPlayDownloadManager.INSTANCE.log("play YYEva end url: " + videoModel.getUrl());
        } else {
            if (i2 != 2) {
            ...
            videoModel2 = (VideoModel) c08941.L$1;
            roomGiftVideoPlayManager2 = (RoomGiftVideoPlayManager) c08941.L$0;
            ResultKt.throwOnFailure(objPlay);
