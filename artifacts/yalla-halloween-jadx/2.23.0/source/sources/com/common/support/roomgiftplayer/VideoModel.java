...
public final /* data */ class VideoModel {
    ...
    @Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0016\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\b¨\u0006\t"}, d2 = {"Lcom/common/support/roomgiftplayer/VideoModel$Companion;", "", "()V", "of", "Lcom/common/support/roomgiftplayer/VideoModel;", "url", "", "type", "Lcom/common/support/roomgiftplayer/VideoType;", "RoomGiftVideoPlayer_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    public VideoModel(@NotNull String url, @NotNull VideoType type, int i, @Nullable Object obj) {
        ...
        this.fileNameByUrl = LazyKt.lazy(new Function0<String>() { // from class: com.common.support.roomgiftplayer.VideoModel$fileNameByUrl$2
            ...
            public final String invoke() {
                if (StringsKt.OooOO0O(this.this$0.getUrl(), ".mp4")) {
                    return this.this$0.getUrl().hashCode() + ".mp4";
                }
                if (!StringsKt.OooOO0O(this.this$0.getUrl(), ".svga")) {
    ...
    public String toString() {
        return o0OoOo0.OooO00o(super.toString(), "  ", getFileNameByUrl());
    }
