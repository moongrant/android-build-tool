...
public final class AuthenticationTokenHeader implements Parcelable {
    ...
    public AuthenticationTokenHeader(@NotNull String str, @NotNull String str2, @NotNull String str3) {
        androidx.compose.compiler.plugins.kotlin.lower.OooO0OO.OooO00o(str, "alg", str2, "typ", str3, "kid");
        this.alg = str;
        this.typ = str2;
        this.kid = str3;
    }
    ...
    public int hashCode() {
        return this.kid.hashCode() + o0OO00O.OooO00o(this.typ, o0OO00O.OooO00o(this.alg, 527, 31), 31);
    }
