...
public class FacebookException extends RuntimeException {
    ...
    public static final void m4036_init_$lambda0(String str, boolean z) {
        if (z) {
            try {
    ...
    public FacebookException(@Nullable String str) {
        ...
        FeatureManager.checkFeature(FeatureManager.Feature.ErrorReport, new OooOO0(str));
    }
    ...
    public FacebookException(@Nullable String str, @NotNull Object... args) {
        ...
        if (str == null) {
            ...
            strOooO00o = OooO0O0.OooO0O0.OooO00o(objArrCopyOf, objArrCopyOf.length, str, "java.lang.String.format(this, *args)");
        }
        this(strOooO00o);
    }
