...
public final class RequestProgress {
    ...
    public static final void m4051reportProgress$lambda0(GraphRequest.Callback callback, long j, long j2) {
    ...
    public final void reportProgress() {
        if (this.progress > this.lastReportedProgress) {
            ...
            if ((handler == null ? null : Boolean.valueOf(handler.post(new Runnable() { // from class: com.facebook.oo000o
                @Override // java.lang.Runnable
                public final void run() {
                    RequestProgress.m4051reportProgress$lambda0(callback, j2, j);
                }
            }))) == null) {
