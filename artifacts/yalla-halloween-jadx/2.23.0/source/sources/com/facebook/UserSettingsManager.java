...
public final class UserSettingsManager {
    ...
    public static final class UserSetting {
        ...
        public final boolean m4053getValue() {
    ...
    public static final boolean getAdvertiserIDCollectionEnabled() {
        ...
        try {
            ...
            return advertiserIDCollectionEnabled.m4053getValue();
        } catch (Throwable th) {
    ...
    public static final boolean getAutoInitEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return autoInitEnabled.m4053getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    public static final boolean getAutoLogAppEventsEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return autoLogAppEventsEnabled.m4053getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    public static final boolean getCodelessSetupEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return codelessSetupEnabled.m4053getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    public static final boolean getMonitorEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return monitorEnabled.m4053getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
        ...
        try {
            ...
            if (userSetting.getValue() == null || jCurrentTimeMillis - userSetting.getLastTS() >= TIMEOUT_7D) {
                ...
                if (isFetchingCodelessStatus.compareAndSet(false, true)) {
                    FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.o00oO0o
                        @Override // java.lang.Runnable
                        public final void run() {
                            UserSettingsManager.m4052initializeCodelessSetupEnabledAsync$lambda0(jCurrentTimeMillis);
                        }
                    });
                }
            }
    ...
    public static final void m4052initializeCodelessSetupEnabledAsync$lambda0(long j) {
        if (CrashShieldHandler.isObjectCrashing(UserSettingsManager.class)) {
            return;
        }
        try {
            if (advertiserIDCollectionEnabled.m4053getValue()) {
    ...
    private final void logIfSDKSettingsChanged() {
        ...
        try {
            if (isInitialized.get() && FacebookSdk.isInitialized()) {
                Context applicationContext = FacebookSdk.getApplicationContext();
                int i3 = 0;
                int i4 = ((autoInitEnabled.m4053getValue() ? 1 : 0) << 0) | 0 | ((autoLogAppEventsEnabled.m4053getValue() ? 1 : 0) << 1) | ((advertiserIDCollectionEnabled.m4053getValue() ? 1 : 0) << 2) | ((monitorEnabled.m4053getValue() ? 1 : 0) << 3);
