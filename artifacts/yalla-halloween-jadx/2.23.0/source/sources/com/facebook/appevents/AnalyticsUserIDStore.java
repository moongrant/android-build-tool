...
public final class AnalyticsUserIDStore {
    ...
    public static final void initStore() {
        ...
        InternalAppEventsLogger.INSTANCE.getAnalyticsExecutor().execute(new OooO00o());
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: initStore$lambda-0, reason: not valid java name */
    public static final void m4054initStore$lambda0() {
        INSTANCE.initAndWait();
    }
    ...
    public static final void setUserID(@Nullable String id) {
        ...
        InternalAppEventsLogger.INSTANCE.getAnalyticsExecutor().execute(new OooO0O0(id, 0));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: setUserID$lambda-1, reason: not valid java name */
    public static final void m4055setUserID$lambda1(String str) {
        lock.writeLock().lock();
        try {
            userID = str;
