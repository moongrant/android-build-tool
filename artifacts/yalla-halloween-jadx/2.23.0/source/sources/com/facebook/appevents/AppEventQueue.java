...
public final class AppEventQueue {
    ...
    public static final void add(@NotNull AccessTokenAppIdPair accessTokenAppId, @NotNull AppEvent appEvent) {
        ...
        try {
            ...
            singleThreadExecutor.execute(new o000O000(1, accessTokenAppId, appEvent));
        } catch (Throwable th) {
    ...
    public static final void m4056add$lambda3(AccessTokenAppIdPair accessTokenAppId, AppEvent appEvent) {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
        ...
        try {
            ...
            graphRequestNewPostRequest.setCallback(new GraphRequest.Callback() { // from class: com.facebook.appevents.OooO0OO
                ...
                public final void onCompleted(GraphResponse graphResponse) {
                    AppEventQueue.m4057buildRequestForSession$lambda4(accessTokenAppId, graphRequestNewPostRequest, appEvents, flushState, graphResponse);
                }
            });
    ...
    public static final void m4057buildRequestForSession$lambda4(AccessTokenAppIdPair accessTokenAppId, GraphRequest postRequest, SessionEventsState appEvents, FlushStatistics flushState, GraphResponse response) {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
    ...
    public static final void flush(@NotNull FlushReason reason) {
        ...
        try {
            ...
            singleThreadExecutor.execute(new OooO0o(reason, 0));
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, AppEventQueue.class);
        }
    }
    ...
    public static final void m4058flush$lambda2(FlushReason reason) {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
    ...
    public static final void m4059flushRunnable$lambda0() {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
    ...
    public static final void handleResponse(@NotNull AccessTokenAppIdPair accessTokenAppId, @NotNull GraphRequest request, @NotNull GraphResponse response, @NotNull SessionEventsState appEvents, @NotNull FlushStatistics flushState) {
        ...
        try {
            ...
            if (flushResult == flushResult2) {
                FacebookSdk.getExecutor().execute(new oO0Oo(2, accessTokenAppId, appEvents));
            }
    ...
    public static final void m4060handleResponse$lambda5(AccessTokenAppIdPair accessTokenAppId, SessionEventsState appEvents) {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
    ...
    public static final void m4061persistToDisk$lambda1() {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
