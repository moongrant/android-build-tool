...
public final class AppEventsLoggerImpl {
    ...
    public static final class Companion {
        ...
        public static final void m4062initializeLib$lambda4(Context context, AppEventsLoggerImpl logger) {
        ...
        public final void initializeTimersIfNeeded() {
            synchronized (AppEventsLoggerImpl.access$getStaticLock$cp()) {
                ...
                scheduledThreadPoolExecutorAccess$getBackgroundExecutor$cp.scheduleAtFixedRate(oooOO0O, 0L, 86400L, TimeUnit.SECONDS);
            }
        }

        /* JADX INFO: Access modifiers changed from: private */
        /* JADX INFO: renamed from: initializeTimersIfNeeded$lambda-6, reason: not valid java name */
        public static final void m4063initializeTimersIfNeeded$lambda6() {
        ...
        public final void initializeLib(@NotNull Context context, @Nullable String applicationId) {
            ...
            if (FacebookSdk.getAutoLogAppEventsEnabled()) {
                ...
                scheduledThreadPoolExecutorAccess$getBackgroundExecutor$cp.execute(new OooOOO0(context, appEventsLoggerImpl));
            }
        }
