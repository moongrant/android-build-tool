...
public final class AppEventsManager {
    ...
    public static final class AnonymousClass1 implements FetchedAppSettingsManager.FetchedAppSettingsCallback {
        ...
        public static final void m4064onSuccess$lambda0(boolean z) {
            if (z) {
        ...
        public static final void m4065onSuccess$lambda1(boolean z) {
            if (z) {
        ...
        public static final void m4066onSuccess$lambda2(boolean z) {
            if (z) {
                ModelManager.enable();
            }
        }
        ...
        public static final void m4067onSuccess$lambda3(boolean z) {
            if (z) {
        ...
        public static final void m4068onSuccess$lambda4(boolean z) {
            if (z) {
        ...
        public static final void m4069onSuccess$lambda5(boolean z) {
            if (z) {
        ...
        public void onSuccess(@Nullable FetchedAppSettings fetchedAppSettings) {
            ...
            FeatureManager.checkFeature(FeatureManager.Feature.AAM, new OooOOO());
            FeatureManager.checkFeature(FeatureManager.Feature.RestrictiveDataFiltering, new OooOOOO());
            FeatureManager.checkFeature(FeatureManager.Feature.PrivacyProtection, new OooOo00());
            FeatureManager.checkFeature(FeatureManager.Feature.EventDeactivation, new oo0ooO());
            FeatureManager.checkFeature(FeatureManager.Feature.IapLogging, new o000OO());
            FeatureManager.checkFeature(FeatureManager.Feature.CloudBridge, new OooOo());
        }
    }
