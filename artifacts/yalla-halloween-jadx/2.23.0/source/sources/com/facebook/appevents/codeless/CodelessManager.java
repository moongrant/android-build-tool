...
public final class CodelessManager {
    ...
    private final void checkCodelessSession(String applicationId) {
        ...
        try {
            ...
            FacebookSdk.getExecutor().execute(new OooO0O0(applicationId, 0));
        } catch (Throwable th) {
    ...
    public static final void m4079checkCodelessSession$lambda1(String str) {
        ...
        try {
            ...
            JSONObject graphObject = companion.newPostRequestWithBundle(null, str4, bundle, null).executeAndWait().getGraphObject();
        ...
        try {
            ...
            if (isCodelessEnabled.get()) {
                ...
                if (Intrinsics.areEqual(appSettingsWithoutQuery == null ? null : Boolean.valueOf(appSettingsWithoutQuery.getCodelessEventsEnabled()), Boolean.TRUE) || INSTANCE.isDebugOnEmulator()) {
                    ...
                    viewIndexingTrigger2.setOnShakeListener(new ViewIndexingTrigger.OnShakeListener() { // from class: com.facebook.appevents.codeless.OooO0OO
                        @Override // com.facebook.appevents.codeless.ViewIndexingTrigger.OnShakeListener
                        public final void onShake() {
                            CodelessManager.m4080onActivityResumed$lambda0(appSettingsWithoutQuery, applicationId);
                        }
                    });
    ...
    public static final void m4080onActivityResumed$lambda0(FetchedAppSettings fetchedAppSettings, String appId) {
        if (CrashShieldHandler.isObjectCrashing(CodelessManager.class)) {
            return;
        }
        try {
