...
public final class ViewIndexer {
    ...
    public static final class Companion {
        ...
        public static final void m4084buildAppIndexingRequest$lambda0(GraphResponse it) {
        ...
        public final GraphRequest buildAppIndexingRequest(@Nullable String appIndex, @Nullable AccessToken accessToken, @Nullable String appId, @NotNull String requestType) {
            ...
            graphRequestNewPostRequest.setCallback(new OooO());
    ...
    public static final void m4082schedule$lambda0(ViewIndexer this$0, TimerTask indexingTask) {
        if (CrashShieldHandler.isObjectCrashing(ViewIndexer.class)) {
            return;
        }
        try {
    ...
    private final void sendToServer(String tree) {
        ...
        try {
            FacebookSdk.getExecutor().execute(new o0000oo(2, tree, this));
        } catch (Throwable th) {
    ...
    public static final void m4083sendToServer$lambda1(String tree, ViewIndexer this$0) {
        if (CrashShieldHandler.isObjectCrashing(ViewIndexer.class)) {
            return;
        }
        try {
    ...
    public final void schedule() {
        ...
        try {
            try {
                FacebookSdk.getExecutor().execute(new o00oOoo(1, this, new TimerTask() { // from class: com.facebook.appevents.codeless.ViewIndexer$schedule$indexingTask$1
