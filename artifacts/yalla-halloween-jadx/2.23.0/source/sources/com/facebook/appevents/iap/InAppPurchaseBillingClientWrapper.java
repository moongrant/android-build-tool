...
public final class InAppPurchaseBillingClientWrapper {
        ...
        public Object invoke(@NotNull Object proxy, @NotNull Method m, @Nullable Object[] args) {
            ...
            try {
                ...
                if (Intrinsics.areEqual(m.getName(), InAppPurchaseBillingClientWrapper.METHOD_ON_BILLING_SETUP_FINISHED)) {
                    ...
                    if (StringsKt.OooOO0O(name, InAppPurchaseBillingClientWrapper.METHOD_ON_BILLING_SERVICE_DISCONNECTED)) {
    ...
    public static final void m4089queryPurchaseHistory$lambda0(InAppPurchaseBillingClientWrapper this$0, Runnable queryPurchaseHistoryRunnable) {
        if (CrashShieldHandler.isObjectCrashing(InAppPurchaseBillingClientWrapper.class)) {
            return;
        }
        try {
    ...
    public final void queryPurchaseHistory(@NotNull String skuType, @NotNull Runnable queryPurchaseHistoryRunnable) {
        ...
        try {
            Intrinsics.checkNotNullParameter(skuType, "skuType");
            Intrinsics.checkNotNullParameter(queryPurchaseHistoryRunnable, "queryPurchaseHistoryRunnable");
            queryPurchaseHistoryAsync(skuType, new OooO(0, this, queryPurchaseHistoryRunnable));
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
        }
    }
