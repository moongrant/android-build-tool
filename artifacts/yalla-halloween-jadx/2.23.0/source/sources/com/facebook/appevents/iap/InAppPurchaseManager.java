...
public final class InAppPurchaseManager {
    ...
    private final boolean usingBillingLib2Plus() {
        ...
        try {
            ...
            return (applicationInfo == null || (string = applicationInfo.metaData.getString(GOOGLE_BILLINGCLIENT_VERSION)) == null || Integer.parseInt((String) StringsKt__StringsKt.split$default(string, new String[]{"."}, false, 3, 2, (Object) null).get(0)) < 2) ? false : true;
