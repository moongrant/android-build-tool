...
public final class ActivityLifecycleTracker {
    ...
    public static final void m4090onActivityCreated$lambda1() {
    ...
    public final void onActivityPaused(Activity activity) {
        ...
        singleThreadExecutor.execute(new Runnable() { // from class: com.facebook.appevents.internal.OooO0O0
            ...
            public final void run() {
                ActivityLifecycleTracker.m4091onActivityPaused$lambda6(jCurrentTimeMillis, activityName);
            }
        });
    }
    ...
    public static final void m4091onActivityPaused$lambda6(final long j, final String activityName) {
        ...
        if (foregroundActivityCount.get() <= 0) {
            Runnable runnable = new Runnable() { // from class: com.facebook.appevents.internal.OooO00o
                @Override // java.lang.Runnable
                public final void run() {
                    ActivityLifecycleTracker.m4092onActivityPaused$lambda6$lambda4(j, activityName);
                }
            };
            synchronized (currentFutureLock) {
    ...
    public static final void m4092onActivityPaused$lambda6$lambda4(long j, String activityName) {
        Intrinsics.checkNotNullParameter(activityName, "$activityName");
        if (currentSession == null) {
            currentSession = new SessionInfo(Long.valueOf(j), null, null, 4, null);
        }
    ...
    public static final void onActivityResumed(@NotNull Activity activity) {
        ...
        singleThreadExecutor.execute(new Runnable() { // from class: com.facebook.appevents.internal.OooO0OO
            @Override // java.lang.Runnable
            public final void run() {
                ActivityLifecycleTracker.m4093onActivityResumed$lambda2(jCurrentTimeMillis, activityName, applicationContext);
            }
        });
    }
    ...
    public static final void m4093onActivityResumed$lambda2(long j, String activityName, Context appContext) {
        SessionInfo sessionInfo;
        Intrinsics.checkNotNullParameter(activityName, "$activityName");
        SessionInfo sessionInfo2 = currentSession;
    ...
    public static final void startTracking(@NotNull Application application, @Nullable String appId2) {
        ...
        if (tracking.compareAndSet(false, true)) {
            ...
            FeatureManager.checkFeature(FeatureManager.Feature.CodelessEvents, new o000OOo());
            appId = appId2;
    ...
    public static final void m4094startTracking$lambda0(boolean z) {
        if (z) {
