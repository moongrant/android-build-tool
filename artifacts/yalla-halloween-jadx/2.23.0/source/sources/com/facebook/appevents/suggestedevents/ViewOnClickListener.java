...
public final class ViewOnClickListener implements View.OnClickListener {
    ...
    public static final class Companion {
        ...
        public final boolean queryHistoryAndProcess(String pathID, String buttonText) {
            ...
            Utility.runOnNonUiThread(new o000O0(i, strQueryEvent, buttonText));
            return true;
        }

        /* JADX INFO: Access modifiers changed from: private */
        /* JADX INFO: renamed from: queryHistoryAndProcess$lambda-0, reason: not valid java name */
        public static final void m4105queryHistoryAndProcess$lambda0(String queriedEvent, String buttonText) {
    ...
    private final void predictAndProcess(final String pathID, final String buttonText, final JSONObject viewData) {
        ...
        try {
            Utility.runOnNonUiThread(new Runnable() { // from class: o00OooOO.o000O00O
                @Override // java.lang.Runnable
                public final void run() {
                    ViewOnClickListener.m4104predictAndProcess$lambda0(viewData, buttonText, this, pathID);
                }
            });
        } catch (Throwable th) {
    ...
    public static final void m4104predictAndProcess$lambda0(JSONObject viewData, String buttonText, ViewOnClickListener this$0, String pathID) {
        if (CrashShieldHandler.isObjectCrashing(ViewOnClickListener.class)) {
            return;
        }
        try {
    ...
    private ViewOnClickListener(View view, View view2, String str) {
        ...
        Intrinsics.checkNotNullExpressionValue(lowerCase, "(this as java.lang.String).toLowerCase()");
        this.activityName = StringsKt.OooOoO(lowerCase, "activity", "");
    }
}
