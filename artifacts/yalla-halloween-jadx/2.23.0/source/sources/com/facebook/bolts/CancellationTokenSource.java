...
public final class CancellationTokenSource implements Closeable {
    ...
    public static final void m4106cancelAfter$lambda6$lambda5(CancellationTokenSource this$0) {
    ...
    private final void cancelAfter(long delay, TimeUnit timeUnit) {
        ...
        synchronized (this.lock) {
            ...
            cancelScheduledCancellation();
            if (delay != -1) {
                this.scheduledCancellation = this.executor.schedule(new Runnable() { // from class: com.facebook.bolts.OooO00o
                    @Override // java.lang.Runnable
                    public final void run() {
                        CancellationTokenSource.m4106cancelAfter$lambda6$lambda5(this.f10618OooO0Oo);
                    }
                }, delay, timeUnit);
            }
            Unit unit = Unit.INSTANCE;
