...
public final class Task<TResult> {
    ...
    public static final class Companion {
        ...
        public static final void m4112call$lambda2(CancellationToken cancellationToken, com.facebook.bolts.TaskCompletionSource tcs, Callable callable) {
            ...
            try {
                executor.execute(new Runnable() { // from class: com.facebook.bolts.OooOOOO
                    ...
                    public final void run() {
                        Task.Companion.m4113completeAfterTask$lambda7(ct, tcs, continuation, task);
                    }
                });
            } catch (Exception e) {
        ...
        public static final void m4113completeAfterTask$lambda7(final CancellationToken cancellationToken, final com.facebook.bolts.TaskCompletionSource tcs, Continuation continuation, Task task) {
            Intrinsics.checkNotNullParameter(tcs, "$tcs");
            ...
            try {
                ...
                if (task2 == null) {
                    ...
                    task2.continueWith(new Continuation() { // from class: com.facebook.bolts.OooOo
                        @Override // com.facebook.bolts.Continuation
                        public final Object then(Task task3) {
                            return Task.Companion.m4114completeAfterTask$lambda7$lambda6(cancellationToken, tcs, task3);
                        }
                    });
                }
            } catch (CancellationException unused) {
        ...
        public static final Void m4114completeAfterTask$lambda7$lambda6(CancellationToken cancellationToken, com.facebook.bolts.TaskCompletionSource tcs, Task task) {
            Intrinsics.checkNotNullParameter(tcs, "$tcs");
            Intrinsics.checkNotNullParameter(task, "task");
            if (cancellationToken != null && cancellationToken.isCancellationRequested()) {
                tcs.setCancelled();
        ...
        public final <TContinuationResult, TResult> void completeImmediately(final com.facebook.bolts.TaskCompletionSource<TContinuationResult> tcs, final Continuation<TResult, TContinuationResult> continuation, final Task<TResult> task, Executor executor, final CancellationToken ct) {
            try {
                executor.execute(new Runnable() { // from class: com.facebook.bolts.OooOOO
                    @Override // java.lang.Runnable
                    public final void run() {
                        Task.Companion.m4115completeImmediately$lambda5(ct, tcs, continuation, task);
                    }
                });
            } catch (Exception e) {
                tcs.setError(new ExecutorException(e));
        ...
        public static final void m4115completeImmediately$lambda5(CancellationToken cancellationToken, com.facebook.bolts.TaskCompletionSource tcs, Continuation continuation, Task task) {
            Intrinsics.checkNotNullParameter(tcs, "$tcs");
            Intrinsics.checkNotNullParameter(continuation, "$continuation");
            Intrinsics.checkNotNullParameter(task, "$task");
            if (cancellationToken != null && cancellationToken.isCancellationRequested()) {
        ...
        public static final void m4116delay$lambda0(com.facebook.bolts.TaskCompletionSource tcs) {
            Intrinsics.checkNotNullParameter(tcs, "$tcs");
        ...
        public static final void m4117delay$lambda1(ScheduledFuture scheduledFuture, com.facebook.bolts.TaskCompletionSource tcs) {
            Intrinsics.checkNotNullParameter(tcs, "$tcs");
        ...
        public static final Void m4118whenAny$lambda4(AtomicBoolean isAnyTaskComplete, com.facebook.bolts.TaskCompletionSource firstCompleted, Task it) {
        ...
        public static final Void m4119whenAnyResult$lambda3(AtomicBoolean isAnyTaskComplete, com.facebook.bolts.TaskCompletionSource firstCompleted, Task it) {
            Intrinsics.checkNotNullParameter(isAnyTaskComplete, "$isAnyTaskComplete");
            Intrinsics.checkNotNullParameter(firstCompleted, "$firstCompleted");
            Intrinsics.checkNotNullParameter(it, "it");
            if (isAnyTaskComplete.compareAndSet(false, true)) {
        ...
        public final Task<Void> delay$facebook_bolts_release(long delay, @NotNull ScheduledExecutorService executor, @Nullable CancellationToken cancellationToken) {
            ...
            int i = 1;
            ScheduledFuture<?> scheduledFutureSchedule = executor.schedule(new o0O00O(taskCompletionSource, i), delay, TimeUnit.MILLISECONDS);
            if (cancellationToken != null) {
                cancellationToken.register(new o000O0O.OooOO0(i, scheduledFutureSchedule, taskCompletionSource));
            }
        ...
        public final Task<Task<?>> whenAny(@NotNull Collection<? extends Task<?>> tasks) {
            ...
            Iterator<? extends Task<?>> it = tasks.iterator();
            while (it.hasNext()) {
                it.next().continueWith(new Continuation() { // from class: com.facebook.bolts.OooOo00
                    @Override // com.facebook.bolts.Continuation
                    public final Object then(Task task) {
                        return Task.Companion.m4118whenAny$lambda4(atomicBoolean, taskCompletionSource, task);
                    }
                });
            }
            return taskCompletionSource.getTask();
        ...
        public final <TResult> Task<Task<TResult>> whenAnyResult(@NotNull Collection<Task<TResult>> tasks) {
            ...
            while (it.hasNext()) {
                it.next().continueWith(new Continuation() { // from class: com.facebook.bolts.OooOO0O
                    @Override // com.facebook.bolts.Continuation
                    public final Object then(Task task) {
                        return Task.Companion.m4119whenAnyResult$lambda3(atomicBoolean, taskCompletionSource, task);
                    }
                });
            }
            return taskCompletionSource.getTask();
        ...
        public final <TResult> Task<TResult> call(@NotNull final Callable<TResult> callable, @NotNull Executor executor, @Nullable final CancellationToken ct) {
            ...
            try {
                executor.execute(new Runnable() { // from class: com.facebook.bolts.OooOOO0
                    @Override // java.lang.Runnable
                    public final void run() {
                        Task.Companion.m4112call$lambda2(ct, taskCompletionSource, callable);
                    }
                });
            } catch (Exception e) {
    ...
    public static final Void m4107continueWith$lambda10$lambda9(com.facebook.bolts.TaskCompletionSource tcs, Continuation continuation, Executor executor, CancellationToken cancellationToken, Task task) {
        Intrinsics.checkNotNullParameter(tcs, "$tcs");
        Intrinsics.checkNotNullParameter(continuation, "$continuation");
        Intrinsics.checkNotNullParameter(executor, "$executor");
        Intrinsics.checkNotNullParameter(task, "task");
    ...
    public static final Void m4108continueWithTask$lambda12$lambda11(com.facebook.bolts.TaskCompletionSource tcs, Continuation continuation, Executor executor, CancellationToken cancellationToken, Task task) {
        Intrinsics.checkNotNullParameter(tcs, "$tcs");
        Intrinsics.checkNotNullParameter(continuation, "$continuation");
        Intrinsics.checkNotNullParameter(executor, "$executor");
        Intrinsics.checkNotNullParameter(task, "task");
    ...
    public static final Task m4109makeVoid$lambda8(Task task) {
        Intrinsics.checkNotNullParameter(task, "task");
        if (task.isCancelled()) {
            return INSTANCE.cancelled();
        }
    ...
    public static final Task m4110onSuccess$lambda13(CancellationToken cancellationToken, Continuation continuation, Task task) {
        Intrinsics.checkNotNullParameter(continuation, "$continuation");
        Intrinsics.checkNotNullParameter(task, "task");
        if (cancellationToken != null && cancellationToken.isCancellationRequested()) {
            return INSTANCE.cancelled();
    ...
    public static final Task m4111onSuccessTask$lambda14(CancellationToken cancellationToken, Continuation continuation, Task task) {
        Intrinsics.checkNotNullParameter(continuation, "$continuation");
        Intrinsics.checkNotNullParameter(task, "task");
        if (cancellationToken != null && cancellationToken.isCancellationRequested()) {
            return INSTANCE.cancelled();
    ...
    public final Task<Void> makeVoid() {
        return continueWithTask(new OooO());
    }
        ...
        try {
            ...
            if (!zIsCompleted && (list = this.continuations) != null) {
                list.add(new Continuation() { // from class: com.facebook.bolts.OooO0OO
                    @Override // com.facebook.bolts.Continuation
                    public final Object then(Task task) {
                        return Task.m4107continueWith$lambda10$lambda9(taskCompletionSource, continuation, executor, ct, task);
                    }
                });
            }
            Unit unit = Unit.INSTANCE;
        ...
        try {
            ...
            if (!zIsCompleted && (list = this.continuations) != null) {
                list.add(new Continuation() { // from class: com.facebook.bolts.OooO0o
                    @Override // com.facebook.bolts.Continuation
                    public final Object then(Task task) {
                        return Task.m4108continueWithTask$lambda12$lambda11(taskCompletionSource, continuation, executor, ct, task);
                    }
                });
            }
            Unit unit = Unit.INSTANCE;
    ...
    public final <TContinuationResult> Task<TContinuationResult> onSuccess(@NotNull final Continuation<TResult, TContinuationResult> continuation, @NotNull Executor executor, @Nullable final CancellationToken ct) {
        ...
        return continueWithTask(new Continuation() { // from class: com.facebook.bolts.OooO0O0
            @Override // com.facebook.bolts.Continuation
            public final Object then(Task task) {
                return Task.m4110onSuccess$lambda13(ct, continuation, task);
            }
        }, executor);
    }
    ...
    public final <TContinuationResult> Task<TContinuationResult> onSuccessTask(@NotNull final Continuation<TResult, Task<TContinuationResult>> continuation, @NotNull Executor executor, @Nullable final CancellationToken ct) {
        Intrinsics.checkNotNullParameter(continuation, "continuation");
        Intrinsics.checkNotNullParameter(executor, "executor");
        return continueWithTask(new Continuation() { // from class: com.facebook.bolts.OooOO0
            @Override // com.facebook.bolts.Continuation
            public final Object then(Task task) {
                return Task.m4111onSuccessTask$lambda14(ct, continuation, task);
            }
        }, executor);
    }
