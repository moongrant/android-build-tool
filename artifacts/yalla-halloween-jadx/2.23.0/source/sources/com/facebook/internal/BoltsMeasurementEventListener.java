...
public final class BoltsMeasurementEventListener extends BroadcastReceiver {
    ...
    private final void close() {
        ...
        try {
            o0Oo0oo o0oo0ooOooO00o = o0Oo0oo.OooO00o(this.applicationContext);
            Intrinsics.checkNotNullExpressionValue(o0oo0ooOooO00o, "getInstance(applicationContext)");
            o0oo0ooOooO00o.OooO0Oo(this);
        } catch (Throwable th) {
    ...
    private final void open() {
        ...
        try {
            o0Oo0oo o0oo0ooOooO00o = o0Oo0oo.OooO00o(this.applicationContext);
            Intrinsics.checkNotNullExpressionValue(o0oo0ooOooO00o, "getInstance(applicationContext)");
            o0oo0ooOooO00o.OooO0O0(this, new IntentFilter(MEASUREMENT_EVENT_NOTIFICATION_NAME));
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
        }
    }
