...
public abstract class FacebookDialogBase<CONTENT, RESULT> implements FacebookDialog<CONTENT, RESULT> {
    ...
    @NotNull
    public final p011OooOo0.OooOO0<CONTENT, CallbackManager.ActivityResultParameters> createActivityResultContractForShowingDialog(@Nullable final CallbackManager callbackManager, @NotNull final Object mode) {
        Intrinsics.checkNotNullParameter(mode, "mode");
        return new p011OooOo0.OooOO0<CONTENT, CallbackManager.ActivityResultParameters>(this) { // from class: com.facebook.internal.FacebookDialogBase.createActivityResultContractForShowingDialog.1
            final /* synthetic */ FacebookDialogBase<CONTENT, RESULT> this$0;
    ...
    public final void setRequestCode(int i) {
        if (!(!FacebookSdk.isFacebookRequestCode(i))) {
            throw new IllegalArgumentException(OooO0OO.OooO00o.OooO00o("Request code ", i, " cannot be within the range reserved by the Facebook SDK.").toString());
        }
        this.requestCodeField = i;
    }
    ...
    public void showImpl(CONTENT content, @NotNull Object mode) {
        ...
        if (getActivityContext() instanceof androidx.activity.result.OooOO0) {
            ComponentCallbacks2 activityContext = getActivityContext();
            if (activityContext == null) {
                throw new NullPointerException("null cannot be cast to non-null type androidx.activity.result.ActivityResultRegistryOwner");
            }
            DialogPresenter dialogPresenter = DialogPresenter.INSTANCE;
            androidx.activity.result.OooO activityResultRegistry = ((androidx.activity.result.OooOO0) activityContext).getActivityResultRegistry();
    ...
    public final void startActivityForResult(@NotNull Intent intent, int requestCode) {
        ...
        if (activityContext instanceof androidx.activity.result.OooOO0) {
            DialogPresenter dialogPresenter = DialogPresenter.INSTANCE;
            androidx.activity.result.OooO activityResultRegistry = ((androidx.activity.result.OooOO0) activityContext).getActivityResultRegistry();
    ...
    @Override // com.facebook.FacebookDialog
    @NotNull
    public p011OooOo0.OooOO0<CONTENT, CallbackManager.ActivityResultParameters> createActivityResultContractForShowingDialog(@Nullable CallbackManager callbackManager) {
