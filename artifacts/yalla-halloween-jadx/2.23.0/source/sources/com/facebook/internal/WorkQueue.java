...
public final class WorkQueue {
    ...
    public static final class Companion {
        ...
        public final void m4145assert(boolean condition) {
            if (!condition) {
    ...
    public final class WorkNode implements WorkItem {
        ...
        public final WorkNode addToList(@Nullable WorkNode list, boolean addToFront) {
            ...
            companion.m4145assert(this.next == null);
            companion.m4145assert(this.prev == null);
            if (list == null) {
                this.prev = this;
                this.next = this;
                list = this;
        ...
        public final void verify(boolean shouldBeRunning) {
            ...
            companion.m4145assert(workNode == this);
            WorkNode workNode4 = this.next;
            if (workNode4 == null || (workNode2 = workNode4.prev) == null) {
                workNode2 = this;
            }
            companion.m4145assert(workNode2 == this);
            companion.m4145assert(getIsRunning() == shouldBeRunning);
        }
    }
    ...
    private final void execute(final WorkNode node) {
        this.executor.execute(new Runnable() { // from class: com.facebook.internal.o0ooOOo
            @Override // java.lang.Runnable
            public final void run() {
                WorkQueue.m4144execute$lambda2(node, this);
            }
        });
    }
    ...
    public static final void m4144execute$lambda2(WorkNode node, WorkQueue this$0) {
    ...
    public final void validate() {
        ...
        try {
            ...
            INSTANCE.m4145assert(this.runningCount == i);
            Unit unit = Unit.INSTANCE;
            reentrantLock.unlock();
        } catch (Throwable th) {
            reentrantLock.unlock();
