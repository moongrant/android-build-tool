...
public final class InstrumentData {
    ...
    public static final class Companion {
        ...
        public final Type getType(String filename) {
            if (StringsKt.Oooo00o(filename, InstrumentUtility.CRASH_REPORT_PREFIX)) {
                return Type.CrashReport;
            }
            if (StringsKt.Oooo00o(filename, InstrumentUtility.CRASH_SHIELD_PREFIX)) {
                return Type.CrashShield;
            }
            if (StringsKt.Oooo00o(filename, InstrumentUtility.THREAD_CHECK_PREFIX)) {
                return Type.ThreadCheck;
            }
            if (StringsKt.Oooo00o(filename, InstrumentUtility.ANALYSIS_REPORT_PREFIX)) {
                return Type.Analysis;
            }
            return StringsKt.Oooo00o(filename, InstrumentUtility.ANR_REPORT_PREFIX) ? Type.AnrReport : Type.Unknown;
        }
    }
