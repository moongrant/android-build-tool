...
public final class ANRHandler {
    ...
    public static final void sendANRReports() {
        ...
        try {
            ...
            final List listSortedWith = CollectionsKt.sortedWith(arrayList2, new OooO0OO(i));
            ...
            InstrumentUtility.sendReports("anr_reports", jSONArray, new GraphRequest.Callback() { // from class: o0O00o0.OooO0o
                @Override // com.facebook.GraphRequest.Callback
                public final void onCompleted(GraphResponse graphResponse) {
                    ANRHandler.m4155sendANRReports$lambda5(listSortedWith, graphResponse);
                }
            });
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, ANRHandler.class);
    ...
    public static final int m4154sendANRReports$lambda2(InstrumentData instrumentData, InstrumentData o2) {
        if (CrashShieldHandler.isObjectCrashing(ANRHandler.class)) {
            return 0;
        }
        try {
    ...
    public static final void m4155sendANRReports$lambda5(List validReports, GraphResponse response) {
        if (CrashShieldHandler.isObjectCrashing(ANRHandler.class)) {
            return;
        }
        try {
