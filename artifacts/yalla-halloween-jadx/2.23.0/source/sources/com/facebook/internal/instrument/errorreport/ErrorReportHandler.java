...
import p174o00Ooooo.o00O000o;
import p174o00Ooooo.o00oOoo;
...
public final class ErrorReportHandler {
    ...
    public static final File[] listErrorReportFiles() {
        ...
        File[] fileArrListFiles = instrumentReportDir.listFiles(new o00O000o());
    ...
    public static final boolean m4158listErrorReportFiles$lambda3(File file, String name) {
    ...
    public static final void sendErrorReports() {
        ...
        CollectionsKt.sortWith(arrayList, new o00oOoo());
        JSONArray jSONArray = new JSONArray();
        for (int i2 = 0; i2 < arrayList.size() && i2 < 1000; i2++) {
            jSONArray.put(arrayList.get(i2));
        }
        InstrumentUtility.sendReports("error_reports", jSONArray, new GraphRequest.Callback() { // from class: o00Ooooo.o00O000
            @Override // com.facebook.GraphRequest.Callback
            public final void onCompleted(GraphResponse graphResponse) {
                ErrorReportHandler.m4160sendErrorReports$lambda2(arrayList, graphResponse);
            }
        });
    }
    ...
    public static final int m4159sendErrorReports$lambda0(ErrorReportData errorReportData, ErrorReportData o2) {
    ...
    public static final void m4160sendErrorReports$lambda2(ArrayList validReports, GraphResponse response) {
