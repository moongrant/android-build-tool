...
public final class OidcSecurityUtil {
    ...
    public static final PublicKey getPublicKeyFromString(@NotNull String key) {
        ...
        byte[] bArrDecode = Base64.decode(StringsKt.OooOoO(StringsKt.OooOoO(StringsKt.OooOoO(key, "\n", ""), "-----BEGIN PUBLIC KEY-----", ""), "-----END PUBLIC KEY-----", ""), 0);
    ...
    public static final String getRawKeyFromEndPoint(@NotNull final String kid) {
        ...
        FacebookSdk.getExecutor().execute(new Runnable() { // from class: o00o0000.OooO
            @Override // java.lang.Runnable
            public final void run() {
                OidcSecurityUtil.m4161getRawKeyFromEndPoint$lambda1(url, objectRef, kid, reentrantLock, conditionNewCondition);
            }
        });
        reentrantLock.lock();
        try {
    ...
    public static final void m4161getRawKeyFromEndPoint$lambda1(URL openIdKeyUrl, Ref.ObjectRef result, String kid, ReentrantLock lock, Condition condition) {
