...
public final class CustomTabLoginMethodHandler extends WebLoginMethodHandler {
    ...
    private final void onCustomTabComplete(String url, LoginClient.Request request) {
        int i;
        if (url != null) {
            if (StringsKt.Oooo00o(url, Validate.CUSTOM_TAB_REDIRECT_URI_PREFIX) || StringsKt.Oooo00o(url, super.getValidRedirectURI())) {
                ...
                if (Utility.isNullOrEmpty(string) && Utility.isNullOrEmpty(string2) && i == -1) {
                    if (urlQueryString.containsKey("access_token")) {
                        ...
                        FacebookSdk.getExecutor().execute(new OooO00o(0, this, request, urlQueryString));
                        return;
                    }
                }
    ...
    public static final void m4162onCustomTabComplete$lambda0(CustomTabLoginMethodHandler this$0, LoginClient.Request request, Bundle values) {
