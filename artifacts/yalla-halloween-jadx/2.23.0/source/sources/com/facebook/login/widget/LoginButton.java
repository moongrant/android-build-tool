...
public class LoginButton extends FacebookButtonBase {
    ...
    @Nullable
    private androidx.activity.result.OooO0O0<Collection<? extends String>> androidXLoginCaller;
    ...
    public void onAttachedToWindow() {
        ...
        try {
            ...
            if (getContext() instanceof OooOO0) {
                this.androidXLoginCaller = ((OooOO0) getContext()).getActivityResultRegistry().OooO0Oo("facebook-login", getLoginManager().createLogInActivityResultContract(this.callbackManager, this.loggerID), new androidx.activity.result.OooO00o<CallbackManager.ActivityResultParameters>() { // from class: com.facebook.login.widget.LoginButton.1
    ...
    public void onDetachedFromWindow() {
        ...
        try {
            ...
            androidx.activity.result.OooO0O0<Collection<? extends String>> oooO0O0 = this.androidXLoginCaller;
            if (oooO0O0 != null) {
                oooO0O0.OooO0OO();
            }
            AccessTokenTracker accessTokenTracker = this.accessTokenTracker;
        ...
        try {
            ...
            try {
                ...
                if (typedArrayObtainStyledAttributes.hasValue(i3)) {
                    this.customButtonRadius = Float.valueOf(typedArrayObtainStyledAttributes.getDimension(i3, 0.0f));
                }
    ...
    public void setButtonIcon() {
        ...
        try {
            setCompoundDrawablesWithIntrinsicBounds(o00Oo0.OooO00o(getContext(), com.facebook.common.R.drawable.com_facebook_button_icon), (Drawable) null, (Drawable) null, (Drawable) null);
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
        }
    }
