...
public final class c {
    ...
    public static final class DialogInterfaceOnKeyListenerC0193c implements DialogInterface.OnKeyListener {
        final /* synthetic */ x a;

        public DialogInterfaceOnKeyListenerC0193c(x xVar) {
            this.a = xVar;
        }
    ...
    public final void a(@NotNull Context context, @NotNull t tVar, @NotNull x xVar) throws JSONException, UnsupportedEncodingException {
        ...
        ag agVar = ag.a;
        ag.a("Config Params: ".concat(String.valueOf(map)));
        ...
        if (!(map == null || map.isEmpty())) {
            for (Map.Entry<String, ? extends Object> entry : map.entrySet()) {
                ...
                if (Intrinsics.areEqual("xid", key)) {
                    ...
                    a(jSONObject3, "geeid", RemoteConfigConstants$RequestFieldKey.PACKAGE_NAME, "displayName", "appVer", "build", "clientVersion");
                }
            }
        }
        ...
        if (str4 == null || StringsKt.isBlank(str4)) {
            ...
            sb.append(lowerCase);
            jSONObject2.put("language", sb.toString());
        } else {
            jSONObject2.put("language", tVar.d);
        }
        ...
        try {
            ...
            jSONObject4.put(RemoteConfigConstants$RequestFieldKey.PACKAGE_NAME, context.getPackageName());
            ...
            try {
                ...
                jSONObject4.put("zid", ai.a(context));
    ...
    public final void b(Context context, t tVar, x xVar) {
        ...
        if (dVar != null) {
            dVar.setOnKeyListener(new DialogInterfaceOnKeyListenerC0193c(xVar));
        }
