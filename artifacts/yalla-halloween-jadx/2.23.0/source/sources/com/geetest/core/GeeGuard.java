...
public class GeeGuard {
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ...
            try {
                HttpURLConnection httpURLConnection = (HttpURLConnection) ((URLConnection) FirebasePerfUrlConnection.instrument(new URL("https://riskct.geetest.com/g2/api/v1/client_report").openConnection()));
