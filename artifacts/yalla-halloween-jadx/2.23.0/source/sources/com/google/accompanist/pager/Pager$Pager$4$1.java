...
public final class Pager$Pager$4$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f10821OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ Oooo000 f10822OooO0o0;

    public static final class OooO00o extends Lambda implements Function0<Boolean> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Oooo000 f10823OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(Oooo000 oooo000) {
            super(0);
            this.f10823OooO0Oo = oooo000;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Boolean invoke() {
            return Boolean.valueOf(this.f10823OooO0Oo.isScrollInProgress());
        }
    }
    ...
    public static final class OooO0O0 implements FlowCollector<Boolean> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Oooo000 f10824OooO0Oo;

        public OooO0O0(Oooo000 oooo000) {
            this.f10824OooO0Oo = oooo000;
        }

        @Override // kotlinx.coroutines.flow.FlowCollector
        public final Object emit(Boolean bool, Continuation continuation) {
            bool.booleanValue();
            this.f10824OooO0Oo.OooOO0O(null);
            return Unit.INSTANCE;
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public Pager$Pager$4$1(Oooo000 oooo000, Continuation<? super Pager$Pager$4$1> continuation) {
        super(2, continuation);
        this.f10822OooO0o0 = oooo000;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new Pager$Pager$4$1(this.f10822OooO0o0, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f10821OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            Oooo000 oooo000 = this.f10822OooO0o0;
            final Flow flowSnapshotFlow = SnapshotStateKt.snapshotFlow(new OooO00o(oooo000));
            Flow flowDrop = FlowKt.drop(new Flow<Boolean>() { // from class: com.google.accompanist.pager.Pager$Pager$4$1$invokeSuspend$$inlined$filter$1
                ...
                public static final class AnonymousClass2<T> implements FlowCollector {
                    ...
                    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
                    public final /* synthetic */ FlowCollector f10826OooO0Oo;
                    ...
                    public static final class AnonymousClass1 extends ContinuationImpl {
                        ...
                        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
                        public /* synthetic */ Object f10827OooO0Oo;

                        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
                        public int f10829OooO0o0;
                        ...
                        @Nullable
                        public final Object invokeSuspend(@NotNull Object obj) {
                            this.f10827OooO0Oo = obj;
                            this.f10829OooO0o0 |= Integer.MIN_VALUE;
                            return AnonymousClass2.this.emit(null, this);
                        }
                    }

                    public AnonymousClass2(FlowCollector flowCollector) {
                        this.f10826OooO0Oo = flowCollector;
                    }
                    ...
                    public final Object emit(Object obj, @NotNull Continuation continuation) {
                        ...
                        if (continuation instanceof AnonymousClass1) {
                            ...
                            int i = anonymousClass1.f10829OooO0o0;
                            if ((i & Integer.MIN_VALUE) != 0) {
                                anonymousClass1.f10829OooO0o0 = i - Integer.MIN_VALUE;
                            } else {
                        ...
                        Object obj2 = anonymousClass1.f10827OooO0Oo;
                        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                        int i2 = anonymousClass1.f10829OooO0o0;
                        if (i2 == 0) {
                            ResultKt.throwOnFailure(obj2);
                            if (!((Boolean) obj).booleanValue()) {
                                anonymousClass1.f10829OooO0o0 = 1;
                                if (this.f10826OooO0Oo.emit(obj, anonymousClass1) == coroutine_suspended) {
