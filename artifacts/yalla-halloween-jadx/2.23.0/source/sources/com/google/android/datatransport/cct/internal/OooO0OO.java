...
public final class OooO0OO extends NetworkConnectionInfo {
    ...
    public final boolean equals(Object obj) {
        ...
        NetworkConnectionInfo.NetworkType networkType = this.f10870OooO00o;
        if (networkType != null ? networkType.equals(networkConnectionInfo.OooO0O0()) : networkConnectionInfo.OooO0O0() == null) {
            NetworkConnectionInfo.MobileSubtype mobileSubtype = this.f10871OooO0O0;
    ...
    public final String toString() {
        return "NetworkConnectionInfo{networkType=" + this.f10870OooO00o + ", mobileSubtype=" + this.f10871OooO0O0 + "}";
    }
}
