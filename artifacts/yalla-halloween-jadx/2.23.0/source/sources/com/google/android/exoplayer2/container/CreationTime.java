...
public final class CreationTime implements Metadata.Entry {
    ...
    public final long f11669OooO0Oo;
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof CreationTime) {
            return this.f11669OooO0Oo == ((CreationTime) obj).f11669OooO0Oo;
        }
        return false;
    }

    public final int hashCode() {
        return OooOO0.OooO00o(this.f11669OooO0Oo);
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        parcel.writeLong(this.f11669OooO0Oo);
    }

    public CreationTime(Parcel parcel) {
        this.f11669OooO0Oo = parcel.readLong();
    }
}
