...
public final class MediaCodecUtil {
    ...
    public static final Pattern f12497OooO00o = Pattern.compile("^\\D?(\\d+)$");

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @GuardedBy("MediaCodecUtil.class")
    public static final HashMap<OooO00o, List<com.google.android.exoplayer2.mediacodec.OooO0o>> f12498OooO0O0 = new HashMap<>();

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static int f12499OooO0OO = -1;
    ...
    public static final class OooO00o {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final String f12500OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final boolean f12501OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final boolean f12502OooO0OO;

        public OooO00o(String str, boolean z, boolean z2) {
            this.f12500OooO00o = str;
            this.f12501OooO0O0 = z;
            this.f12502OooO0OO = z2;
        }
        ...
        public final boolean equals(@Nullable Object obj) {
            ...
            return TextUtils.equals(this.f12500OooO00o, oooO00o.f12500OooO00o) && this.f12501OooO0O0 == oooO00o.f12501OooO0O0 && this.f12502OooO0OO == oooO00o.f12502OooO0OO;
        }

        public final int hashCode() {
            return ((o0OO00O.OooO00o(this.f12500OooO00o, 31, 31) + (this.f12501OooO0O0 ? 1231 : 1237)) * 31) + (this.f12502OooO0OO ? 1231 : 1237);
        }
    }
    ...
    public static final class OooO0o implements OooO0O0 {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final int f12503OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        @Nullable
        public MediaCodecInfo[] f12504OooO0O0;

        public OooO0o(boolean z, boolean z2) {
            this.f12503OooO00o = (z || z2) ? 1 : 0;
        }

        @Override // com.google.android.exoplayer2.mediacodec.MediaCodecUtil.OooO0O0
        public final MediaCodecInfo OooO00o(int i) {
            if (this.f12504OooO0O0 == null) {
                this.f12504OooO0O0 = new MediaCodecList(this.f12503OooO00o).getCodecInfos();
            }
            return this.f12504OooO0O0[i];
        }
        ...
        public final int OooO0Oo() {
            ...
            return this.f12504OooO0O0.length;
        }
    ...
    public static int OooO() throws DecoderQueryException {
        ...
        if (f12499OooO0OO == -1) {
            int iMax = 0;
            List<com.google.android.exoplayer2.mediacodec.OooO0o> listOooO0o0 = OooO0o0("video/avc", false, false);
            ...
            if (oooO0o != null) {
                ...
                iMax = Math.max(iMax2, o0O00.f40595OooO00o >= 21 ? 345600 : 172800);
            }
            f12499OooO0OO = iMax;
        }
        return f12499OooO0OO;
    }

    public static void OooO00o(String str, ArrayList arrayList) {
        if ("audio/raw".equals(str)) {
            if (o0O00.f40595OooO00o < 26 && o0O00.f40596OooO0O0.equals("R9") && arrayList.size() == 1 && ((com.google.android.exoplayer2.mediacodec.OooO0o) arrayList.get(0)).f12519OooO00o.equals("OMX.MTK.AUDIO.DECODER.RAW")) {
            ...
            Collections.sort(arrayList, new o0OOO00(new o000()));
        }
        int i = o0O00.f40595OooO00o;
        if (i < 21 && arrayList.size() > 1) {
            String str2 = ((com.google.android.exoplayer2.mediacodec.OooO0o) arrayList.get(0)).f12519OooO00o;
            if ("OMX.SEC.mp3.dec".equals(str2) || "OMX.SEC.MP3.Decoder".equals(str2) || "OMX.brcm.audio.mp3.decoder".equals(str2)) {
                Collections.sort(arrayList, new o0OOO00(new o000O000()));
            }
        }
        if (i >= 32 || arrayList.size() <= 1 || !"OMX.qti.audio.decoder.flac".equals(((com.google.android.exoplayer2.mediacodec.OooO0o) arrayList.get(0)).f12519OooO00o)) {
            return;
        }
    ...
    @Nullable
    public static String OooO0O0(OooOo oooOo) {
        Pair<Integer, Integer> pairOooO0Oo;
        if ("audio/eac3-joc".equals(oooOo.f11211OooOOOO)) {
            return "audio/eac3";
        }
        if (!"video/dolby-vision".equals(oooOo.f11211OooOOOO) || (pairOooO0Oo = OooO0Oo(oooOo)) == null) {
            return null;
        }
    ...
    @Nullable
    public static Pair<Integer, Integer> OooO0Oo(OooOo oooOo) {
        int i;
        int i2;
        int i3;
        int i4;
        ...
        int i15 = 4;
        String str2 = oooOo.f11208OooOO0o;
        if (zEquals) {
            if (strArrSplit.length < 3) {
                o000O00.OooO00o("Ignoring malformed Dolby Vision codec string: ", str2, "MediaCodecUtil");
            } else {
                Matcher matcher = f12497OooO00o.matcher(strArrSplit[1]);
                if (matcher.matches()) {
                    ...
                    if (numValueOf2 == null) {
                        o000O00.OooO00o("Unknown Dolby Vision profile string: ", strGroup, "MediaCodecUtil");
                    } else {
                        ...
                        o000O00.OooO00o("Unknown Dolby Vision level string: ", str3, "MediaCodecUtil");
                    }
                } else {
                    o000O00.OooO00o("Ignoring malformed Dolby Vision codec string: ", str2, "MediaCodecUtil");
                }
        ...
        switch (str4) {
            case "av01":
                if (strArrSplit.length < 4) {
                    o000O00.OooO00o("Ignoring malformed AV1 codec string: ", str2, "MediaCodecUtil");
                } else {
                    try {
                        ...
                        if (i16 != 0) {
                            Oooo000.OooO0O0("Unknown AV1 profile: ", i16, "MediaCodecUtil");
                        } else if (i18 == 8 || i18 == 10) {
                            if (i18 == 8) {
                                i = 1;
                            } else {
                                o00O0OO o00o0oo2 = oooOo.f11223OooOoOO;
                                i = (o00o0oo2 == null || !(o00o0oo2.f40749OooO0oO != null || (i2 = o00o0oo2.f40747OooO0o) == 7 || i2 == 6)) ? 2 : 4096;
                            }
                            switch (i17) {
                                case 0:
                                    i3 = -1;
                            ...
                            Oooo000.OooO0O0("Unknown AV1 level: ", i17, "MediaCodecUtil");
                        } else {
                            Oooo000.OooO0O0("Unknown AV1 bit depth: ", i18, "MediaCodecUtil");
                        }
            ...
            case "avc2":
                if (strArrSplit.length < 2) {
                    o000O00.OooO00o("Ignoring malformed AVC codec string: ", str2, "MediaCodecUtil");
                } else {
                    try {
                        ...
                        if (i7 == -1) {
                            Oooo000.OooO0O0("Unknown AVC profile: ", i5, "MediaCodecUtil");
                        } else {
                            switch (i6) {
                                case 10:
                                    i14 = 1;
                            ...
                            Oooo000.OooO0O0("Unknown AVC level: ", i6, "MediaCodecUtil");
                        }
            ...
            case "hvc1":
                if (strArrSplit.length < 4) {
                    o000O00.OooO00o("Ignoring malformed HEVC codec string: ", str2, "MediaCodecUtil");
                } else {
                    Matcher matcher2 = f12497OooO00o.matcher(strArrSplit[1]);
                    if (matcher2.matches()) {
                        ...
                        if ("1".equals(strGroup2)) {
                            ...
                            i9 = (o00o0oo3 == null || o00o0oo3.f40747OooO0o != 6) ? 2 : 4096;
                        } else {
                            o000O00.OooO00o("Unknown HEVC profile string: ", strGroup2, "MediaCodecUtil");
                        }
                        ...
                        o000O00.OooO00o("Unknown HEVC level string: ", str5, "MediaCodecUtil");
                    } else {
                        o000O00.OooO00o("Ignoring malformed HEVC codec string: ", str2, "MediaCodecUtil");
                    }
                }
            ...
            case "mp4a":
                if (strArrSplit.length != 3) {
                    o000O00.OooO00o("Ignoring malformed MP4A codec string: ", str2, "MediaCodecUtil");
                } else {
                    try {
                        if ("audio/mp4a-latm".equals(o00OO0OO.OooO0o0(Integer.parseInt(strArrSplit[1], 16)))) {
            ...
            case "vp09":
                if (strArrSplit.length < 3) {
                    o000O00.OooO00o("Ignoring malformed VP9 codec string: ", str2, "MediaCodecUtil");
                } else {
                    try {
                        ...
                        if (i12 == -1) {
                            Oooo000.OooO0O0("Unknown VP9 profile: ", i21, "MediaCodecUtil");
                        } else {
                            if (i22 == 10) {
                                i14 = 1;
                            } else if (i22 == 11) {
                                ...
                                Oooo000.OooO0O0("Unknown VP9 level: ", i22, "MediaCodecUtil");
                            } else {
                                i14 = 256;
                            }
                            i13 = -1;
    ...
    public static ArrayList<com.google.android.exoplayer2.mediacodec.OooO0o> OooO0o(OooO00o oooO00o, OooO0O0 oooO0O0) throws DecoderQueryException {
        String strOooO0OO;
        String str;
        String str2;
        int i;
        ...
        try {
            ArrayList<com.google.android.exoplayer2.mediacodec.OooO0o> arrayList = new ArrayList<>();
            String str3 = oooO00o2.f12500OooO00o;
                ...
                if (!(i3 >= 29 && mediaCodecInfoOooO00o.isAlias())) {
                    ...
                    if (OooO0oO(mediaCodecInfoOooO00o, name, zOooO0o0, str3) && (strOooO0OO = OooO0OO(mediaCodecInfoOooO00o, name, str3)) != null) {
                        try {
                            ...
                            boolean z3 = oooO00o2.f12502OooO0OO;
                            if ((z3 || !zOooO0OO) && (!z3 || zOooO0O0)) {
                                ...
                                boolean z4 = oooO00o2.f12501OooO0O0;
                                if ((z4 || !zOooO0OO2) && (!z4 || zOooO0O1)) {
                                    ...
                                    if (i3 >= 29) {
                                        ...
                                        String strOooO0O0 = com.google.common.base.OooO0OO.OooO0O0(mediaCodecInfoOooO00o.getName());
                                        if (strOooO0O0.startsWith("omx.google.") || strOooO0O0.startsWith("c2.android.") || strOooO0O0.startsWith("c2.google.")) {
                                            z2 = false;
                                        }
                                        zIsVendor = z2;
                                    }
                                    if (!(zOooO0o0 && z4 == zOooO0O1) && (zOooO0o0 || z4)) {
                                        ...
                                        if (!z && zOooO0O1) {
                                            try {
                                                arrayList.add(com.google.android.exoplayer2.mediacodec.OooO0o.OooO0oo(str2 + ".secure", str3, str, capabilitiesForType, zIsHardwareAccelerated, zOooO0oo, zIsVendor, true));
                                                return arrayList;
                                            } catch (Exception e) {
                                                e = e;
                                        ...
                                        z = zOooO0o0;
                                        try {
                                            arrayList.add(com.google.android.exoplayer2.mediacodec.OooO0o.OooO0oo(name, str3, strOooO0OO, capabilitiesForType, zIsHardwareAccelerated, zOooO0oo, zIsVendor, false));
                                        } catch (Exception e2) {
                                            e = e2;
                                            str2 = name;
                                            if (o0O00.f40595OooO00o <= 23 || arrayList.isEmpty()) {
                                                Log.OooO0OO("MediaCodecUtil", "Failed to query codec " + str2 + " (" + str + ")");
                                                throw e;
                                            }
    ...
    public static synchronized List<com.google.android.exoplayer2.mediacodec.OooO0o> OooO0o0(String str, boolean z, boolean z2) throws DecoderQueryException {
        ...
        HashMap<OooO00o, List<com.google.android.exoplayer2.mediacodec.OooO0o>> map = f12498OooO0O0;
        List<com.google.android.exoplayer2.mediacodec.OooO0o> list = map.get(oooO00o);
        if (list != null) {
            return list;
        }
        int i = o0O00.f40595OooO00o;
        ArrayList<com.google.android.exoplayer2.mediacodec.OooO0o> arrayListOooO0o = OooO0o(oooO00o, i >= 21 ? new OooO0o(z, z2) : new OooO0OO());
        if (z && arrayListOooO0o.isEmpty() && 21 <= i && i <= 23) {
            arrayListOooO0o = OooO0o(oooO00o, new OooO0OO());
            if (!arrayListOooO0o.isEmpty()) {
                Log.OooO0o("MediaCodecUtil", "MediaCodecList API didn't list secure decoder for: " + str + ". Assuming: " + arrayListOooO0o.get(0).f12519OooO00o);
            }
        }
    ...
    public static boolean OooO0oO(MediaCodecInfo mediaCodecInfo, String str, boolean z, String str2) {
        ...
        if (i < 18 && "OMX.MTK.AUDIO.DECODER.AAC".equals(str)) {
            ...
            if ("a70".equals(str3) || ("Xiaomi".equals(o0O00.f40597OooO0OO) && str3.startsWith("HM"))) {
                return false;
            }
        }
        if (i == 16 && "OMX.qcom.audio.decoder.mp3".equals(str)) {
            String str4 = o0O00.f40596OooO0O0;
            if ("dlxu".equals(str4) || "protou".equals(str4) || "ville".equals(str4) || "villeplus".equals(str4) || "villec2".equals(str4) || str4.startsWith("gee") || "C6602".equals(str4) || "C6603".equals(str4) || "C6606".equals(str4) || "C6616".equals(str4) || "L36h".equals(str4) || "SO-02E".equals(str4)) {
                return false;
            }
        }
        if (i == 16 && "OMX.qcom.audio.decoder.aac".equals(str)) {
            String str5 = o0O00.f40596OooO0O0;
            if ("C1504".equals(str5) || "C1505".equals(str5) || "C1604".equals(str5) || "C1605".equals(str5)) {
                return false;
            }
        }
        if (i < 24 && (("OMX.SEC.aac.dec".equals(str) || "OMX.Exynos.AAC.Decoder".equals(str)) && "samsung".equals(o0O00.f40597OooO0OO))) {
            String str6 = o0O00.f40596OooO0O0;
            if (str6.startsWith("zeroflte") || str6.startsWith("zerolte") || str6.startsWith("zenlte") || "SC-05G".equals(str6) || "marinelteatt".equals(str6) || "404SC".equals(str6) || "SC-04G".equals(str6) || "SCV31".equals(str6)) {
                return false;
            }
        }
        if (i <= 19 && "OMX.SEC.vp8.dec".equals(str) && "samsung".equals(o0O00.f40597OooO0OO)) {
            String str7 = o0O00.f40596OooO0O0;
            if (str7.startsWith("d2") || str7.startsWith("serrano") || str7.startsWith("jflte") || str7.startsWith("santos") || str7.startsWith("t0")) {
                return false;
            }
        }
        if (i <= 19 && o0O00.f40596OooO0O0.startsWith("jflte") && "OMX.qcom.video.decoder.vp8".equals(str)) {
            return false;
        }
    ...
    public static boolean OooO0oo(MediaCodecInfo mediaCodecInfo, String str) {
        ...
        if (o00OO0OO.OooOO0(str)) {
            return true;
        }
        String strOooO0O0 = com.google.common.base.OooO0OO.OooO0O0(mediaCodecInfo.getName());
        if (strOooO0O0.startsWith("arc.")) {
            return false;
        }
        if (strOooO0O0.startsWith("omx.google.") || strOooO0O0.startsWith("omx.ffmpeg.")) {
            return true;
        }
        if ((strOooO0O0.startsWith("omx.sec.") && strOooO0O0.contains(".sw.")) || strOooO0O0.equals("omx.qcom.video.decoder.hevcswvdec") || strOooO0O0.startsWith("c2.android.") || strOooO0O0.startsWith("c2.google.")) {
            return true;
        }
        return (strOooO0O0.startsWith("omx.") || strOooO0O0.startsWith("c2.")) ? false : true;
    }
}
