...
public final class OooO00o {
    ...
    public final int f14321OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final C0216OooO00o[] f14322OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final OooO0O0[] f14323OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final HashMap f14324OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final HashMap f14325OooO0o0;

    /* JADX INFO: renamed from: com.google.android.exoplayer2.util.OooO00o$OooO00o, reason: collision with other inner class name */
    public static final class C0216OooO00o {
        public C0216OooO00o(String str) {
        }
    }
    ...
    public OooO00o(String str, String str2) throws GlUtil.GlException {
        ...
        this.f14321OooO00o = iGlCreateProgram;
        GlUtil.OooO0O0();
        ...
        this.f14324OooO0Oo = new HashMap();
        int[] iArr2 = new int[1];
        GLES20.glGetProgramiv(iGlCreateProgram, 35721, iArr2, 0);
        this.f14322OooO0O0 = new C0216OooO00o[iArr2[0]];
        int i2 = 0;
        while (i2 < iArr2[0]) {
            int i3 = this.f14321OooO00o;
            int[] iArr3 = new int[i];
            ...
            C0216OooO00o c0216OooO00o = new C0216OooO00o(str3);
            this.f14322OooO0O0[i2] = c0216OooO00o;
            this.f14324OooO0Oo.put(str3, c0216OooO00o);
            i2++;
            i = 1;
        }
        this.f14325OooO0o0 = new HashMap();
        int i6 = 1;
        int[] iArr4 = new int[1];
        GLES20.glGetProgramiv(this.f14321OooO00o, 35718, iArr4, 0);
        this.f14323OooO0OO = new OooO0O0[iArr4[0]];
        int i7 = 0;
        while (i7 < iArr4[0]) {
            int i8 = this.f14321OooO00o;
            ...
            this.f14323OooO0OO[i7] = oooO0O0;
            this.f14325OooO0o0.put(str4, oooO0O0);
            i7++;
            i6 = 1;
        }
        GlUtil.OooO0O0();
    ...
    public final int OooO0O0(String str) throws GlUtil.GlException {
        int iGlGetAttribLocation = GLES20.glGetAttribLocation(this.f14321OooO00o, str);
