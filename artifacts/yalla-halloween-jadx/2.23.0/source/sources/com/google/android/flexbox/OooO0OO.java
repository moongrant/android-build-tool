...
public final class OooO0OO {
    ...
    public final com.google.android.flexbox.OooO00o f14509OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public boolean[] f14510OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @Nullable
    public int[] f14511OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @Nullable
    public long[] f14512OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @Nullable
    public long[] f14513OooO0o0;

    public static class OooO00o {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public List<com.google.android.flexbox.OooO0O0> f14514OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public int f14515OooO0O0;
    }

    public static class OooO0O0 implements Comparable<OooO0O0> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f14516OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public int f14517OooO0o0;

        @Override // java.lang.Comparable
        public final int compareTo(@NonNull OooO0O0 oooO0O0) {
            OooO0O0 oooO0O1 = oooO0O0;
            int i = this.f14517OooO0o0;
            int i2 = oooO0O1.f14517OooO0o0;
            return i != i2 ? i - i2 : this.f14516OooO0Oo - oooO0O1.f14516OooO0Oo;
        }

        @NonNull
        public final String toString() {
            StringBuilder sb = new StringBuilder("Order{order=");
            sb.append(this.f14517OooO0o0);
            sb.append(", index=");
            return androidx.compose.foundation.layout.OooO0O0.OooO00o(sb, this.f14516OooO0Oo, '}');
        }
    }

    public OooO0OO(com.google.android.flexbox.OooO00o oooO00o) {
        this.f14509OooO00o = oooO00o;
    }
    ...
    public static int[] OooOOo(int i, ArrayList arrayList, SparseIntArray sparseIntArray) {
        ...
        while (it.hasNext()) {
            ...
            int i3 = oooO0O0.f14516OooO0Oo;
            iArr[i2] = i3;
            sparseIntArray.append(i3, oooO0O0.f14517OooO0o0);
            i2++;
        }
        return iArr;
    }
    ...
    public final void OooO(int i) {
        int[] iArr = this.f14511OooO0OO;
        if (iArr == null) {
            if (i < 10) {
                i = 10;
            }
            this.f14511OooO0OO = new int[i];
        } else if (iArr.length < i) {
            int length = iArr.length * 2;
            if (length >= i) {
                i = length;
            }
            this.f14511OooO0OO = Arrays.copyOf(iArr, i);
        }
    }
    ...
    public final void OooO00o(List<com.google.android.flexbox.OooO0O0> list, com.google.android.flexbox.OooO0O0 oooO0O0, int i, int i2) {
        oooO0O0.f14504OooOOO0 = i2;
        this.f14509OooO00o.OooO0o(oooO0O0);
        oooO0O0.f14506OooOOOo = i;
        list.add(oooO0O0);
    }
    ...
    public final void OooO0O0(OooO00o oooO00o, int i, int i2, int i3, int i4, int i5, @Nullable List<com.google.android.flexbox.OooO0O0> list) {
        ...
        int i13;
        boolean z5;
        com.google.android.flexbox.OooO00o oooO00o2 = this.f14509OooO00o;
        ...
        oooO00o.f14514OooO00o = arrayList;
        boolean z6 = i5 == -1;
        ...
        com.google.android.flexbox.OooO0O0 oooO0O0 = new com.google.android.flexbox.OooO0O0();
        int i14 = i4;
        oooO0O0.f14505OooOOOO = i14;
        int i15 = paddingStart + paddingEnd;
        oooO0O0.f14497OooO0o0 = i15;
        ...
        while (i14 < flexItemCount) {
            ...
            if (viewOooO0oO == null) {
                if (i14 == flexItemCount - 1) {
                    z = z6;
                    z5 = oooO0O0.f14499OooO0oo - oooO0O0.f14491OooO != 0;
                    if (z5) {
                ...
                if (viewOooO0oO.getVisibility() == 8) {
                    int i19 = oooO0O0.f14491OooO + 1;
                    oooO0O0.f14491OooO = i19;
                    int i20 = oooO0O0.f14499OooO0oo + 1;
                    oooO0O0.f14499OooO0oo = i20;
                    ...
                    if (viewOooO0oO instanceof CompoundButton) {
                        ...
                        flexItem.o0ooOOo(iOooOo);
                        if (iO0000oO == i13) {
                            iO0000oO = minimumHeight;
                        }
                        flexItem.Oooo0O0(iO0000oO);
                    }
                    FlexItem flexItem2 = (FlexItem) viewOooO0oO.getLayoutParams();
                    if (flexItem2.OooOOo() == 4) {
                        oooO0O0.f14503OooOOO.add(Integer.valueOf(i14));
                    }
                    int width = zOooOO0 ? flexItem2.getWidth() : flexItem2.getHeight();
                    if (flexItem2.OoooO00() != -1.0f && mode == 1073741824) {
                        width = Math.round(size * flexItem2.OoooO00());
                    }
                    if (zOooOO0) {
                        iOooO0Oo = oooO00o2.OooO0O0(i, flexItem2.o0000() + flexItem2.oo0o0Oo() + i15, width);
                        int iOooO0Oo2 = oooO00o2.OooO0Oo(i2, flexItem2.o0OOO0o() + flexItem2.Oooo0() + paddingTop + paddingBottom + i17, flexItem2.getHeight());
                        viewOooO0oO.measure(iOooO0Oo, iOooO0Oo2);
                        OooOo0O(viewOooO0oO, i14, iOooO0Oo, iOooO0Oo2);
                    } else {
                        int iOooO0O0 = oooO00o2.OooO0O0(i2, flexItem2.o0000() + flexItem2.oo0o0Oo() + paddingTop + paddingBottom + i17, flexItem2.getWidth());
                        iOooO0Oo = oooO00o2.OooO0Oo(i, flexItem2.o0OOO0o() + flexItem2.Oooo0() + i15, width);
                    ...
                    int i21 = oooO0O0.f14497OooO0o0;
                    int iO0000 = (zOooOO0 ? flexItem2.o0000() : flexItem2.o0OOO0o()) + (zOooOO0 ? flexItem2.oo0o0Oo() : flexItem2.Oooo0()) + (zOooOO0 ? viewOooO0oO.getMeasuredWidth() : viewOooO0oO.getMeasuredHeight());
                    ...
                    if (z2) {
                        if (oooO0O0.f14499OooO0oo - oooO0O0.f14491OooO > 0) {
                            ...
                            i17 += oooO0O0.f14498OooO0oO;
                        } else {
                            arrayList = arrayList;
                        }
                        if (zOooOO0) {
                            if (flexItem2.getHeight() == -1) {
                                viewOooO0oO.measure(iOooO0Oo, oooO00o2.OooO0Oo(i2, oooO00o2.getPaddingBottom() + oooO00o2.getPaddingTop() + flexItem2.Oooo0() + flexItem2.o0OOO0o() + i17, flexItem2.getHeight()));
                                OooO0OO(i14, viewOooO0oO);
                            }
                        } else if (flexItem2.getWidth() == -1) {
                            viewOooO0oO.measure(oooO00o2.OooO0O0(i2, oooO00o2.getPaddingRight() + oooO00o2.getPaddingLeft() + flexItem2.oo0o0Oo() + flexItem2.o0000() + i17, flexItem2.getWidth()), iOooO0Oo);
                            OooO0OO(i14, viewOooO0oO);
                        }
                        oooO0O0 = new com.google.android.flexbox.OooO0O0();
                        z3 = true;
                        oooO0O0.f14499OooO0oo = 1;
                        i15 = i8;
                        oooO0O0.f14497OooO0o0 = i15;
                        oooO0O0.f14505OooOOOO = i14;
                        ...
                        i15 = i8;
                        z3 = true;
                        oooO0O0.f14499OooO0oo++;
                        i10 = i9 + 1;
                        i11 = i16;
                    }
                    oooO0O0.f14508OooOOo0 |= flexItem2.Oooo0o0() != 0.0f ? z3 : false;
                    oooO0O0.f14507OooOOo |= flexItem2.OooOo00() != 0.0f ? z3 : false;
                    int[] iArr = this.f14511OooO0OO;
                    if (iArr != null) {
                        iArr[i14] = arrayList.size();
                    }
                    oooO0O0.f14497OooO0o0 = (zOooOO0 ? flexItem2.o0000() : flexItem2.o0OOO0o()) + (zOooOO0 ? flexItem2.oo0o0Oo() : flexItem2.Oooo0()) + (zOooOO0 ? viewOooO0oO.getMeasuredWidth() : viewOooO0oO.getMeasuredHeight()) + oooO0O0.f14497OooO0o0;
                    oooO0O0.f14500OooOO0 += flexItem2.Oooo0o0();
                    oooO0O0.f14501OooOO0O += flexItem2.OooOo00();
                    oooO00o2.OooO00o(viewOooO0oO, i14, i10, oooO0O0);
                    int iMax = Math.max(i11, oooO00o2.OooO0o0(viewOooO0oO) + (zOooOO0 ? flexItem2.o0OOO0o() : flexItem2.o0000()) + (zOooOO0 ? flexItem2.Oooo0() : flexItem2.oo0o0Oo()) + (zOooOO0 ? viewOooO0oO.getMeasuredHeight() : viewOooO0oO.getMeasuredWidth()));
                    oooO0O0.f14498OooO0oO = Math.max(oooO0O0.f14498OooO0oO, iMax);
                    if (zOooOO0) {
                        if (oooO00o2.getFlexWrap() != 2) {
                            oooO0O0.f14502OooOO0o = Math.max(oooO0O0.f14502OooOO0o, viewOooO0oO.getBaseline() + flexItem2.Oooo0());
                        } else {
                            oooO0O0.f14502OooOO0o = Math.max(oooO0O0.f14502OooOO0o, (viewOooO0oO.getMeasuredHeight() - viewOooO0oO.getBaseline()) + flexItem2.o0OOO0o());
                        }
                    }
                    if (i14 == flexItemCount + (-1) && oooO0O0.f14499OooO0oo - oooO0O0.f14491OooO != 0) {
                        OooO00o(arrayList, oooO0O0, i14, i17);
                        i17 += oooO0O0.f14498OooO0oO;
                    }
                    i12 = i5;
                    if (i12 == -1 || arrayList.size() <= 0 || arrayList.get(arrayList.size() - 1).f14506OooOOOo < i12 || i14 < i12 || z) {
                        z4 = z;
                    } else {
                        i17 = -oooO0O0.f14498OooO0oO;
                        z4 = true;
    ...
    public final void OooO0OO(int i, View view) {
        ...
        if (measuredWidth >= flexItem.OooOo()) {
            if (measuredWidth > flexItem.Ooooo0o()) {
                measuredWidth = flexItem.Ooooo0o();
            } else {
                z = false;
            }
            if (measuredHeight < flexItem.o0000oO()) {
                measuredHeight = flexItem.o0000oO();
            ...
            if (z2) {
                ...
                this.f14509OooO00o.OooO0oo(i, view);
            }
        }
    ...
    public final ArrayList OooO0o(int i) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            FlexItem flexItem = (FlexItem) this.f14509OooO00o.OooO0OO(i2).getLayoutParams();
            OooO0O0 oooO0O0 = new OooO0O0();
            oooO0O0.f14517OooO0o0 = flexItem.getOrder();
            oooO0O0.f14516OooO0Oo = i2;
            arrayList.add(oooO0O0);
        }
        return arrayList;
    }
    ...
    public final void OooO0oO(int i, int i2, int i3) {
        int mode;
        int size;
        com.google.android.flexbox.OooO00o oooO00o = this.f14509OooO00o;
        ...
        if (mode == 1073741824) {
            ...
            if (flexLinesInternal.size() == 1) {
                flexLinesInternal.get(0).f14498OooO0oO = size - i3;
                return;
            }
            if (flexLinesInternal.size() >= 2) {
                ...
                if (alignContent == 1) {
                    com.google.android.flexbox.OooO0O0 oooO0O0 = new com.google.android.flexbox.OooO0O0();
                    oooO0O0.f14498OooO0oO = size - sumOfCrossSize;
                    ...
                    while (i4 < size3) {
                        ...
                        if (i4 != flexLinesInternal.size() - 1) {
                            ...
                            if (i4 == flexLinesInternal.size() - 2) {
                                oooO0O1.f14498OooO0oO = Math.round(f + size2);
                                f = 0.0f;
                            } else {
                                oooO0O1.f14498OooO0oO = Math.round(size2);
                            }
                            int i5 = oooO0O1.f14498OooO0oO;
                            float f2 = (size2 - i5) + f;
                            if (f2 > 1.0f) {
                                oooO0O1.f14498OooO0oO = i5 + 1;
                                f2 -= 1.0f;
                            } else if (f2 < -1.0f) {
                                oooO0O1.f14498OooO0oO = i5 - 1;
                                f2 += 1.0f;
                ...
                if (alignContent == 5 && sumOfCrossSize < size) {
                    ...
                    while (i4 < size6) {
                        ...
                        float f4 = oooO0O4.f14498OooO0oO + size5;
                        if (i4 == flexLinesInternal.size() - 1) {
                            f4 += f3;
                            f3 = 0.0f;
                        }
    ...
    public final void OooO0oo(int i, int i2, int i3) {
        ...
        boolean[] zArr = this.f14510OooO0O0;
        if (zArr == null) {
            if (flexItemCount < 10) {
                flexItemCount = 10;
            }
            this.f14510OooO0O0 = new boolean[flexItemCount];
        ...
        for (int i5 = iArr != null ? iArr[i3] : 0; i5 < size2; i5++) {
            ...
            int i6 = oooO0O0.f14497OooO0o0;
            if (i6 < size && oooO0O0.f14508OooOOo0) {
                OooOO0o(i, i2, oooO0O0, size, i4, false);
            } else if (i6 > size && oooO0O0.f14507OooOOo) {
    ...
    public final void OooOO0(int i) {
        ...
        if (jArr == null) {
            ...
            this.f14512OooO0Oo = new long[i];
        } else if (jArr.length < i) {
            int length = jArr.length * 2;
            if (length >= i) {
                i = length;
            }
            this.f14512OooO0Oo = Arrays.copyOf(jArr, i);
        }
    }

    public final void OooOO0O(int i) {
        long[] jArr = this.f14513OooO0o0;
        if (jArr == null) {
            if (i < 10) {
                i = 10;
            }
            this.f14513OooO0o0 = new long[i];
        } else if (jArr.length < i) {
            int length = jArr.length * 2;
            if (length >= i) {
                i = length;
            }
            this.f14513OooO0o0 = Arrays.copyOf(jArr, i);
        }
    }
    ...
    public final void OooOO0o(int i, int i2, com.google.android.flexbox.OooO0O0 oooO0O0, int i3, int i4, boolean z) {
        ...
        View view;
        double d2;
        float f2 = oooO0O0.f14500OooOO0;
        if (f2 <= 0.0f || i3 < (i5 = oooO0O0.f14497OooO0o0)) {
            return;
        }
        float f3 = (i3 - i5) / f2;
        oooO0O0.f14497OooO0o0 = i4 + oooO0O0.f14496OooO0o;
        if (!z) {
            oooO0O0.f14498OooO0oO = Integer.MIN_VALUE;
        }
        int i7 = 0;
        boolean z2 = false;
        int i8 = 0;
        float f4 = 0.0f;
        while (i7 < oooO0O0.f14499OooO0oo) {
            int i9 = oooO0O0.f14505OooOOOO + i7;
            com.google.android.flexbox.OooO00o oooO00o3 = this.f14509OooO00o;
            ...
            if (viewOooO0oO == null || viewOooO0oO.getVisibility() == 8) {
                ...
                if (flexDirection == 0 || flexDirection == 1) {
                    ...
                    long[] jArr2 = this.f14513OooO0o0;
                    if (jArr2 != null) {
                        measuredHeight = (int) (jArr2[i9] >> 32);
                    }
                    if (this.f14510OooO0O0[i9] || flexItem.Oooo0o0() <= 0.0f) {
                        i6 = i5;
                        f = f3;
                        oooO00o = r1;
                    } else {
                        float fOooo0o0 = (flexItem.Oooo0o0() * f3) + measuredWidth;
                        if (i7 == oooO0O0.f14499OooO0oo - 1) {
                            fOooo0o0 += f4;
                            f4 = 0.0f;
                        }
                        int iRound = Math.round(fOooo0o0);
                        if (iRound > flexItem.Ooooo0o()) {
                            iRound = flexItem.Ooooo0o();
                            this.f14510OooO0O0[i9] = true;
                            oooO0O0.f14500OooOO0 -= flexItem.Oooo0o0();
                            i6 = i5;
                            f = f3;
                            z2 = true;
                        } else {
                        ...
                        int iOooOOO0 = OooOOO0(i2, flexItem, oooO0O0.f14504OooOOO0);
                    ...
                    iMax = Math.max(i8, oooO00o.OooO0o0(viewOooO0oO) + measuredHeight + flexItem.Oooo0() + flexItem.o0OOO0o());
                    oooO0O0.f14497OooO0o0 = measuredWidth + flexItem.oo0o0Oo() + flexItem.o0000() + oooO0O0.f14497OooO0o0;
                } else {
                    int measuredHeight2 = viewOooO0oO.getMeasuredHeight();
                    long[] jArr3 = this.f14513OooO0o0;
                    if (jArr3 != null) {
                        measuredHeight2 = (int) (jArr3[i9] >> 32);
                    }
                    int measuredWidth2 = viewOooO0oO.getMeasuredWidth();
                    long[] jArr4 = this.f14513OooO0o0;
                    if (jArr4 != null) {
                    ...
                    if (this.f14510OooO0O0[i9] || flexItem.Oooo0o0() <= 0.0f) {
                        ...
                        int iOooOOO = OooOOO(i, flexItem, oooO0O0.f14504OooOOO0);
                    ...
                    iMax = Math.max(i8, oooO00o2.OooO0o0(view) + measuredWidth2 + flexItem.oo0o0Oo() + flexItem.o0000());
                    oooO0O0.f14497OooO0o0 = measuredHeight2 + flexItem.Oooo0() + flexItem.o0OOO0o() + oooO0O0.f14497OooO0o0;
                    i6 = i5;
                    f = f3;
                }
                oooO0O0.f14498OooO0oO = Math.max(oooO0O0.f14498OooO0oO, iMax);
        ...
        int i10 = i5;
        if (!z2 || i10 == oooO0O0.f14497OooO0o0) {
            return;
        }
    ...
    public final int OooOOO(int i, FlexItem flexItem, int i2) {
        com.google.android.flexbox.OooO00o oooO00o = this.f14509OooO00o;
        int iOooO0O0 = oooO00o.OooO0O0(i, oooO00o.getPaddingRight() + oooO00o.getPaddingLeft() + flexItem.oo0o0Oo() + flexItem.o0000() + i2, flexItem.getWidth());
        int size = View.MeasureSpec.getSize(iOooO0O0);
        if (size > flexItem.Ooooo0o()) {
            return View.MeasureSpec.makeMeasureSpec(flexItem.Ooooo0o(), View.MeasureSpec.getMode(iOooO0O0));
        }
    ...
    public final int OooOOO0(int i, FlexItem flexItem, int i2) {
        com.google.android.flexbox.OooO00o oooO00o = this.f14509OooO00o;
        int iOooO0Oo = oooO00o.OooO0Oo(i, oooO00o.getPaddingBottom() + oooO00o.getPaddingTop() + flexItem.Oooo0() + flexItem.o0OOO0o() + i2, flexItem.getHeight());
        ...
        return size < flexItem.o0000oO() ? View.MeasureSpec.makeMeasureSpec(flexItem.o0000oO(), View.MeasureSpec.getMode(iOooO0Oo)) : iOooO0Oo;
    }
    ...
    public final void OooOOOO(View view, com.google.android.flexbox.OooO0O0 oooO0O0, int i, int i2, int i3, int i4) {
        ...
        int i5 = oooO0O0.f14498OooO0oO;
        if (alignItems != 0) {
            if (alignItems == 1) {
                if (oooO00o.getFlexWrap() != 2) {
                    int i6 = i2 + i5;
                    view.layout(i, (i6 - view.getMeasuredHeight()) - flexItem.o0OOO0o(), i3, i6 - flexItem.o0OOO0o());
                    return;
                } else {
            ...
            if (alignItems == 2) {
                int measuredHeight = (((i5 - view.getMeasuredHeight()) + flexItem.Oooo0()) - flexItem.o0OOO0o()) / 2;
                if (oooO00o.getFlexWrap() != 2) {
            ...
            if (alignItems == 3) {
                if (oooO00o.getFlexWrap() != 2) {
                    int iMax = Math.max(oooO0O0.f14502OooOO0o - view.getBaseline(), flexItem.Oooo0());
                    view.layout(i, i2 + iMax, i3, i4 + iMax);
                    return;
                } else {
                    int iMax2 = Math.max(view.getBaseline() + (oooO0O0.f14502OooOO0o - view.getMeasuredHeight()), flexItem.o0OOO0o());
    ...
    public final void OooOOOo(View view, com.google.android.flexbox.OooO0O0 oooO0O0, boolean z, int i, int i2, int i3, int i4) {
        ...
        if (alignItems != 0) {
            if (alignItems == 1) {
                if (!z) {
                    view.layout(((i + i5) - view.getMeasuredWidth()) - flexItem.o0000(), i2, ((i3 + i5) - view.getMeasuredWidth()) - flexItem.o0000(), i4);
                    return;
                }
                view.layout(view.getMeasuredWidth() + (i - i5) + flexItem.oo0o0Oo(), i2, view.getMeasuredWidth() + (i3 - i5) + flexItem.oo0o0Oo(), i4);
                return;
            }
            if (alignItems == 2) {
        ...
        if (z) {
            view.layout(i - flexItem.o0000(), i2, i3 - flexItem.o0000(), i4);
        } else {
            view.layout(i + flexItem.oo0o0Oo(), i2, i3 + flexItem.oo0o0Oo(), i4);
        }
    }
    ...
    public final void OooOOo0(int i, int i2, com.google.android.flexbox.OooO0O0 oooO0O0, int i3, int i4, boolean z) {
        ...
        while (i6 < oooO0O0.f14499OooO0oo) {
            int i8 = oooO0O0.f14505OooOOOO + i6;
            com.google.android.flexbox.OooO00o oooO00o2 = this.f14509OooO00o;
            ...
            if (viewOooO0oO == null || viewOooO0oO.getVisibility() == 8) {
                ...
                if (flexDirection == 0 || flexDirection == 1) {
                    ...
                    if (this.f14510OooO0O0[i8] || flexItem.OooOo00() <= 0.0f) {
                        f2 = f2;
                        z2 = z2;
                    } else {
                        ...
                        if (iRound < flexItem.OooOo()) {
                            ...
                            this.f14510OooO0O0[i8] = true;
                            oooO0O0.f14501OooOO0O -= flexItem.OooOo00();
                        } else {
                    ...
                    iMax = Math.max(i7, oooO00o2.OooO0o0(r11) + measuredHeight + flexItem.Oooo0() + flexItem.o0OOO0o());
                    oooO0O0.f14497OooO0o0 = measuredWidth + flexItem.oo0o0Oo() + flexItem.o0000() + oooO0O0.f14497OooO0o0;
                } else {
                    int measuredHeight3 = viewOooO0oO.getMeasuredHeight();
                    long[] jArr3 = this.f14513OooO0o0;
                    ...
                    if (this.f14510OooO0O0[i8] || flexItem.OooOo00() <= 0.0f) {
                        ...
                        if (iRound2 < flexItem.o0000oO()) {
                            iO0000oO = flexItem.o0000oO();
                            this.f14510OooO0O0[i8] = true;
                            oooO0O0.f14501OooOO0O -= flexItem.OooOo00();
                            z2 = true;
                        } else {
                        ...
                        int iOooOOO = OooOOO(i, flexItem, oooO0O0.f14504OooOOO0);
                        int iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(iO0000oO, Pow2.MAX_POW2);
                        viewOooO0oO.measure(iOooOOO, iMakeMeasureSpec2);
                        measuredWidth2 = viewOooO0oO.getMeasuredWidth();
                    ...
                    iMax = Math.max(i7, oooO00o.OooO0o0(view) + measuredWidth2 + flexItem.oo0o0Oo() + flexItem.o0000());
                    oooO0O0.f14497OooO0o0 = measuredHeight3 + flexItem.Oooo0() + flexItem.o0OOO0o() + oooO0O0.f14497OooO0o0;
                    f2 = f2;
                }
                oooO0O0.f14498OooO0oO = Math.max(oooO0O0.f14498OooO0oO, iMax);
                i7 = iMax;
        ...
        if (!z2 || i5 == oooO0O0.f14497OooO0o0) {
            return;
        }
    ...
    public final void OooOOoo(View view, int i, int i2) {
        FlexItem flexItem = (FlexItem) view.getLayoutParams();
        int iOo0o0Oo = (i - flexItem.oo0o0Oo()) - flexItem.o0000();
        com.google.android.flexbox.OooO00o oooO00o = this.f14509OooO00o;
        int iMin = Math.min(Math.max(iOo0o0Oo - oooO00o.OooO0o0(view), flexItem.OooOo()), flexItem.Ooooo0o());
        long[] jArr = this.f14513OooO0o0;
    ...
    public final void OooOo0(int i) {
        ...
        if (oooO00o.getAlignItems() != 4) {
            for (com.google.android.flexbox.OooO0O0 oooO0O0 : oooO00o.getFlexLinesInternal()) {
                for (Integer num : oooO0O0.f14503OooOOO) {
                    View viewOooO0oO2 = oooO00o.OooO0oO(num.intValue());
                    if (flexDirection == 0 || flexDirection == 1) {
                        OooOo00(viewOooO0oO2, oooO0O0.f14498OooO0oO, num.intValue());
                    } else {
                        if (flexDirection != 2 && flexDirection != 3) {
                            throw new IllegalArgumentException(android.support.v4.media.OooO00o.OooO00o("Invalid flex direction: ", flexDirection));
                        }
                        OooOOoo(viewOooO0oO2, oooO0O0.f14498OooO0oO, num.intValue());
                    }
                }
            }
            return;
        ...
        for (int i2 = iArr != null ? iArr[i] : 0; i2 < size; i2++) {
            ...
            int i3 = oooO0O1.f14499OooO0oo;
            for (int i4 = 0; i4 < i3; i4++) {
                int i5 = oooO0O1.f14505OooOOOO + i4;
                if (i4 < oooO00o.getFlexItemCount() && (viewOooO0oO = oooO00o.OooO0oO(i5)) != null && viewOooO0oO.getVisibility() != 8) {
                    ...
                    if (flexItem.OooOOo() == -1 || flexItem.OooOOo() == 4) {
                        if (flexDirection == 0 || flexDirection == 1) {
                            OooOo00(viewOooO0oO, oooO0O1.f14498OooO0oO, i5);
                        } else {
                            if (flexDirection != 2 && flexDirection != 3) {
                                throw new IllegalArgumentException(android.support.v4.media.OooO00o.OooO00o("Invalid flex direction: ", flexDirection));
                            }
                            OooOOoo(viewOooO0oO, oooO0O1.f14498OooO0oO, i5);
                        }
                    }
                }
            }
    ...
    public final void OooOo00(View view, int i, int i2) {
        FlexItem flexItem = (FlexItem) view.getLayoutParams();
        int iOooo0 = (i - flexItem.Oooo0()) - flexItem.o0OOO0o();
        com.google.android.flexbox.OooO00o oooO00o = this.f14509OooO00o;
        int iMin = Math.min(Math.max(iOooo0 - oooO00o.OooO0o0(view), flexItem.o0000oO()), flexItem.o0000O0O());
        long[] jArr = this.f14513OooO0o0;
