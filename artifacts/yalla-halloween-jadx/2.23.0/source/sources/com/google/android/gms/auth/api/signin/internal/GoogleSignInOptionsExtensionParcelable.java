...
public class GoogleSignInOptionsExtensionParcelable extends AbstractSafeParcelable {
    ...
    public final int f14562OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @SafeParcelable.Field(getter = "getBundle", id = 3)
    public final Bundle f14563OooO0o;
    ...
    public GoogleSignInOptionsExtensionParcelable(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) int i2, @SafeParcelable.Param(id = 3) Bundle bundle) {
        this.f14562OooO0Oo = i;
        this.f14564OooO0o0 = i2;
        this.f14563OooO0o = bundle;
    }

    @KeepForSdk
    public int getType() {
        return this.f14564OooO0o0;
    }

    @Override // android.os.Parcelable
    public final void writeToParcel(@NonNull Parcel parcel, int i) {
        int iBeginObjectHeader = SafeParcelWriter.beginObjectHeader(parcel);
        SafeParcelWriter.writeInt(parcel, 1, this.f14562OooO0Oo);
        SafeParcelWriter.writeInt(parcel, 2, getType());
        SafeParcelWriter.writeBundle(parcel, 3, this.f14563OooO0o, false);
