...
public final class CloudMessage extends AbstractSafeParcelable {
    ...
    public final Intent f14570OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @GuardedBy("this")
    public OooOO0 f14571OooO0o0;
    ...
    public CloudMessage(@NonNull @SafeParcelable.Param(id = 1) Intent intent) {
        this.f14570OooO0Oo = intent;
    }

    @Nullable
    public String getCollapseKey() {
        return this.f14570OooO0Oo.getStringExtra("collapse_key");
    }

    @NonNull
    public synchronized Map<String, String> getData() {
        if (this.f14571OooO0o0 == null) {
            Bundle extras = this.f14570OooO0Oo.getExtras();
            ...
            this.f14571OooO0o0 = oooOO1;
        }
        return this.f14571OooO0o0;
    }

    @Nullable
    public String getFrom() {
        return this.f14570OooO0Oo.getStringExtra("from");
    }

    @NonNull
    public Intent getIntent() {
        return this.f14570OooO0Oo;
    }

    @Nullable
    public String getMessageId() {
        Intent intent = this.f14570OooO0Oo;
    ...
    public String getMessageType() {
        return this.f14570OooO0Oo.getStringExtra("message_type");
    }
    ...
    public byte[] getRawData() {
        return this.f14570OooO0Oo.getByteArrayExtra("rawData");
    }

    @Nullable
    public String getSenderId() {
        return this.f14570OooO0Oo.getStringExtra("google.c.sender.id");
    }
    ...
    @Nullable
    public String getTo() {
        return this.f14570OooO0Oo.getStringExtra("google.to");
    }
    ...
    public void writeToParcel(@NonNull Parcel parcel, int i) {
        ...
        SafeParcelWriter.writeParcelable(parcel, 1, this.f14570OooO0Oo, i, false);
