...
public abstract class CloudMessagingReceiver extends BroadcastReceiver {
    ...
    public final ExecutorService f14572OooO00o;
    ...
    public CloudMessagingReceiver() {
        ...
        this.f14572OooO00o = Executors.unconfigurableExecutorService(threadPoolExecutor);
    }
    ...
    public final void onReceive(@NonNull final Context context, @NonNull final Intent intent) {
        ...
        this.f14572OooO00o.execute(new Runnable() { // from class: com.google.android.gms.cloudmessaging.zze
