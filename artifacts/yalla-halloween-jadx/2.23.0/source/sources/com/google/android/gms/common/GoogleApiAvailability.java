...
import p252o00ooO0o.o000;
import p252o00ooO0o.o0000OO0;
...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    @GuardedBy("mLock")
    public String f14619OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final Object f14617OooO0OO = new Object();

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public static final GoogleApiAvailability f14618OooO0Oo = new GoogleApiAvailability();
    ...
    public final void OooO0OO(Context context, int i, @Nullable PendingIntent pendingIntent) {
        ...
        if (i == 18) {
            new o000(this, context).sendEmptyMessageDelayed(1, 120000L);
            return;
        }
        ...
        o00O0O o00o0o2 = new o00O0O(context, null);
        o00o0o2.f33952OooOOO0 = true;
        o00o0o2.f33957OooOOoo.flags |= 16;
        o00o0o2.f33945OooO0o0 = o00O0O.OooO0O0(strZaf);
        o0OoOo0 o0oooo0 = new o0OoOo0();
        o0oooo0.f33981OooO0O0 = o00O0O.OooO0O0(strZae);
        o00o0o2.OooO0Oo(o0oooo0);
        if (DeviceProperties.isWearable(context)) {
            Preconditions.checkState(PlatformVersion.isAtLeastKitKatWatch());
            o00o0o2.f33957OooOOoo.icon = context.getApplicationInfo().icon;
            o00o0o2.f33948OooOO0 = 2;
            if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                o00o0o2.f33941OooO0O0.add(new NotificationCompat$Action(com.google.android.gms.base.R.drawable.common_full_open_on_phone, resources.getString(com.google.android.gms.base.R.string.common_open_on_phone), pendingIntent));
            } else {
                o00o0o2.f33946OooO0oO = pendingIntent;
            }
        } else {
            o00o0o2.f33957OooOOoo.icon = android.R.drawable.stat_sys_warning;
            o00o0o2.f33957OooOOoo.tickerText = o00O0O.OooO0O0(resources.getString(com.google.android.gms.base.R.string.common_google_play_services_notification_ticker));
            o00o0o2.f33957OooOOoo.when = System.currentTimeMillis();
            o00o0o2.f33946OooO0oO = pendingIntent;
            o00o0o2.f33944OooO0o = o00O0O.OooO0O0(strZae);
        }
        if (PlatformVersion.isAtLeastO()) {
            Preconditions.checkState(PlatformVersion.isAtLeastO());
            synchronized (f14617OooO0OO) {
                str = this.f14619OooO0O0;
            }
            if (str == null) {
                ...
                if (notificationChannel == null) {
                    notificationManager.createNotificationChannel(o0000OO0.OooO00o(strZab));
                } else if (!strZab.contentEquals(notificationChannel.getName())) {
                    notificationChannel.setName(strZab);
                    notificationManager.createNotificationChannel(notificationChannel);
                }
            }
            o00o0o2.f33956OooOOo0 = str;
        }
        Notification notificationOooO00o = o00o0o2.OooO00o();
        if (i == 1 || i == 2 || i == 3) {
            GooglePlayServicesUtilLight.f14623OooO00o.set(false);
            i2 = 10436;
        } else {
            i2 = 39789;
        }
