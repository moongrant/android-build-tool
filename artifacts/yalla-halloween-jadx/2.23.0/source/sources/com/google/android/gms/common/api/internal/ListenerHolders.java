...
public class ListenerHolders {
    ...
    public final Set<ListenerHolder<?>> f14759OooO00o = Collections.newSetFromMap(new WeakHashMap());
    ...
    public final <L> ListenerHolder<L> zaa(@NonNull L l, @NonNull Looper looper, @NonNull String str) {
        ...
        this.f14759OooO00o.add(listenerHolderCreateListenerHolder);
        return listenerHolderCreateListenerHolder;
    }

    public final void zab() {
        Set<ListenerHolder<?>> set = this.f14759OooO00o;
