...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    public static final OooO00o f14960OooOOO = new OooO00o(new String[0]);

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    @Nullable
    @SafeParcelable.Field(getter = "getMetadata", id = 4)
    public final Bundle f14961OooO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @SafeParcelable.VersionField(id = 1000)
    public final int f14962OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public Bundle f14963OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @SafeParcelable.Field(getter = "getColumns", id = 1)
    public final String[] f14964OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    @SafeParcelable.Field(getter = "getWindows", id = 2)
    public final CursorWindow[] f14965OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    @SafeParcelable.Field(getter = "getStatusCode", id = 3)
    public final int f14966OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public int[] f14967OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public int f14968OooOO0O;

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    public boolean f14969OooOO0o;

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    public final boolean f14970OooOOO0;

    public DataHolder(Builder builder, int i) {
        this(builder.f14971OooO00o, OooO0OO(builder), i, null);
    }

    public static CursorWindow[] OooO0OO(Builder builder) {
        if (builder.f14971OooO00o.length == 0) {
            return new CursorWindow[0];
        }
        ArrayList<HashMap<String, Object>> arrayList = builder.f14972OooO0O0;
        int size = arrayList.size();
        CursorWindow cursorWindow = new CursorWindow(false);
        ArrayList arrayList2 = new ArrayList();
        arrayList2.add(cursorWindow);
        String[] strArr = builder.f14971OooO00o;
    ...
    public static DataHolder empty(int i) {
        return new DataHolder(f14960OooOOO, i);
    }

    public final void OooO00o(int i, String str) {
        Bundle bundle = this.f14963OooO0o;
        ...
        if (i < 0 || i >= this.f14968OooOO0O) {
            throw new CursorIndexOutOfBoundsException(i, this.f14968OooOO0O);
        }
    }
    ...
    public void close() {
        synchronized (this) {
            if (!this.f14969OooOO0o) {
                this.f14969OooOO0o = true;
                int i = 0;
                while (true) {
                    CursorWindow[] cursorWindowArr = this.f14965OooO0oO;
    ...
    public final void finalize() throws Throwable {
        try {
            if (this.f14970OooOOO0 && this.f14965OooO0oO.length > 0 && !isClosed()) {
                close();
    ...
    public boolean getBoolean(@NonNull String str, int i, int i2) {
        OooO00o(i, str);
        return Long.valueOf(this.f14965OooO0oO[i2].getLong(i, this.f14963OooO0o.getInt(str))).longValue() == 1;
    }
    ...
    public byte[] getByteArray(@NonNull String str, int i, int i2) {
        OooO00o(i, str);
        return this.f14965OooO0oO[i2].getBlob(i, this.f14963OooO0o.getInt(str));
    }

    @KeepForSdk
    public int getCount() {
        return this.f14968OooOO0O;
    }

    @KeepForSdk
    public int getInteger(@NonNull String str, int i, int i2) {
        OooO00o(i, str);
        return this.f14965OooO0oO[i2].getInt(i, this.f14963OooO0o.getInt(str));
    }

    @KeepForSdk
    public long getLong(@NonNull String str, int i, int i2) {
        OooO00o(i, str);
        return this.f14965OooO0oO[i2].getLong(i, this.f14963OooO0o.getInt(str));
    }

    @Nullable
    @KeepForSdk
    public Bundle getMetadata() {
        return this.f14961OooO;
    }

    @KeepForSdk
    public int getStatusCode() {
        return this.f14966OooO0oo;
    }
    ...
    public String getString(@NonNull String str, int i, int i2) {
        OooO00o(i, str);
        return this.f14965OooO0oO[i2].getString(i, this.f14963OooO0o.getInt(str));
    }
    ...
    public int getWindowIndex(int i) {
        int length;
        int i2 = 0;
        Preconditions.checkState(i >= 0 && i < this.f14968OooOO0O);
        while (true) {
            int[] iArr = this.f14967OooOO0;
            length = iArr.length;
            if (i2 >= length) {
                break;
            }
    ...
    public boolean hasColumn(@NonNull String str) {
        return this.f14963OooO0o.containsKey(str);
    }

    @KeepForSdk
    public boolean hasNull(@NonNull String str, int i, int i2) {
        OooO00o(i, str);
        return this.f14965OooO0oO[i2].isNull(i, this.f14963OooO0o.getInt(str));
    }
    ...
    public final void writeToParcel(@NonNull Parcel parcel, int i) {
        ...
        SafeParcelWriter.writeStringArray(parcel, 1, this.f14964OooO0o0, false);
        SafeParcelWriter.writeTypedArray(parcel, 2, this.f14965OooO0oO, i, false);
        SafeParcelWriter.writeInt(parcel, 3, getStatusCode());
        SafeParcelWriter.writeBundle(parcel, 4, getMetadata(), false);
        SafeParcelWriter.writeInt(parcel, 1000, this.f14962OooO0Oo);
    ...
    public final double zaa(@NonNull String str, int i, int i2) {
        OooO00o(i, str);
        return this.f14965OooO0oO[i2].getDouble(i, this.f14963OooO0o.getInt(str));
    }

    public final float zab(@NonNull String str, int i, int i2) {
        OooO00o(i, str);
        return this.f14965OooO0oO[i2].getFloat(i, this.f14963OooO0o.getInt(str));
    }

    public final void zac(@NonNull String str, int i, int i2, @NonNull CharArrayBuffer charArrayBuffer) {
        OooO00o(i, str);
        this.f14965OooO0oO[i2].copyStringToBuffer(i, this.f14963OooO0o.getInt(str), charArrayBuffer);
    }

    public final void zad() {
        this.f14963OooO0o = new Bundle();
        int i = 0;
        while (true) {
            String[] strArr = this.f14964OooO0o0;
            if (i >= strArr.length) {
                break;
            }
            this.f14963OooO0o.putInt(strArr[i], i);
            i++;
        }
        CursorWindow[] cursorWindowArr = this.f14965OooO0oO;
        this.f14967OooOO0 = new int[cursorWindowArr.length];
        int numRows = 0;
        for (int i2 = 0; i2 < cursorWindowArr.length; i2++) {
            this.f14967OooOO0[i2] = numRows;
            numRows += cursorWindowArr[i2].getNumRows() - (numRows - cursorWindowArr[i2].getStartPosition());
        }
        this.f14968OooOO0O = numRows;
    }
    ...
    public static class Builder {
        ...
        public final String[] f14971OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final ArrayList<HashMap<String, Object>> f14972OooO0O0 = new ArrayList<>();

        public /* synthetic */ Builder(String[] strArr) {
            this.f14971OooO00o = (String[]) Preconditions.checkNotNull(strArr);
            new HashMap();
        }
        ...
        public DataHolder build(int i, @NonNull Bundle bundle) {
            return new DataHolder(this.f14971OooO00o, DataHolder.OooO0OO(this), i, bundle);
        }
    }
    ...
    public DataHolder(@SafeParcelable.Param(id = 1000) int i, @SafeParcelable.Param(id = 1) String[] strArr, @SafeParcelable.Param(id = 2) CursorWindow[] cursorWindowArr, @SafeParcelable.Param(id = 3) int i2, @Nullable @SafeParcelable.Param(id = 4) Bundle bundle) {
        this.f14969OooOO0o = false;
        this.f14970OooOOO0 = true;
        this.f14962OooO0Oo = i;
        this.f14964OooO0o0 = strArr;
        this.f14965OooO0oO = cursorWindowArr;
        this.f14966OooO0oo = i2;
        this.f14961OooO = bundle;
    }
    ...
    public DataHolder(@NonNull String[] strArr, @NonNull CursorWindow[] cursorWindowArr, int i, @Nullable Bundle bundle) {
        this.f14969OooOO0o = false;
        this.f14970OooOOO0 = true;
        this.f14962OooO0Oo = 1;
        this.f14964OooO0o0 = (String[]) Preconditions.checkNotNull(strArr);
        this.f14965OooO0oO = (CursorWindow[]) Preconditions.checkNotNull(cursorWindowArr);
        this.f14966OooO0oo = i;
        this.f14961OooO = bundle;
        zad();
    }
}
