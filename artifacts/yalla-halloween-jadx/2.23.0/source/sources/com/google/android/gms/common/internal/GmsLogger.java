...
public final class GmsLogger {
    ...
    public final String f15083OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @Nullable
    public final String f15084OooO0O0;
    ...
    public final String OooO00o(String str) {
        String str2 = this.f15084OooO0O0;
        return str2 == null ? str : str2.concat(str);
    }

    @KeepForSdk
    public boolean canLog(int i) {
        return Log.isLoggable(this.f15083OooO00o, i);
    }
    ...
    public void efmt(@NonNull String str, @NonNull @FormatString String str2, @NonNull Object... objArr) {
        if (canLog(6)) {
            ...
            String str3 = this.f15084OooO0O0;
            if (str3 != null) {
    ...
    public void wfmt(@NonNull String str, @NonNull @FormatString String str2, @NonNull Object... objArr) {
        if (canLog(5)) {
            ...
            Log.w(this.f15083OooO00o, strConcat);
        }
    }
    ...
    public GmsLogger(@NonNull String str, @Nullable String str2) {
        ...
        this.f15083OooO00o = str;
        if (str2 == null || str2.length() <= 0) {
            this.f15084OooO0O0 = null;
        } else {
            this.f15084OooO0O0 = str2;
        }
    }
