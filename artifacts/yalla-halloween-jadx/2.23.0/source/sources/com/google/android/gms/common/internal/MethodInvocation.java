...
public class MethodInvocation extends AbstractSafeParcelable {
    ...
    public final void writeToParcel(@NonNull Parcel parcel, int i) {
        ...
        SafeParcelWriter.writeInt(parcel, 1, this.f15089OooO0Oo);
        SafeParcelWriter.writeInt(parcel, 2, this.f15091OooO0o0);
        SafeParcelWriter.writeInt(parcel, 3, this.f15090OooO0o);
        SafeParcelWriter.writeLong(parcel, 4, this.f15092OooO0oO);
        SafeParcelWriter.writeLong(parcel, 5, this.f15093OooO0oo);
        SafeParcelWriter.writeString(parcel, 6, this.f15088OooO, false);
        SafeParcelWriter.writeString(parcel, 7, this.f15094OooOO0, false);
        SafeParcelWriter.writeInt(parcel, 8, this.f15095OooOO0O);
        SafeParcelWriter.writeInt(parcel, 9, this.f15096OooOO0o);
    ...
    public MethodInvocation(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) int i2, @SafeParcelable.Param(id = 3) int i3, @SafeParcelable.Param(id = 4) long j, @SafeParcelable.Param(id = 5) long j2, @Nullable @SafeParcelable.Param(id = 6) String str, @Nullable @SafeParcelable.Param(id = 7) String str2, @SafeParcelable.Param(id = 8) int i4, @SafeParcelable.Param(id = 9) int i5) {
        this.f15089OooO0Oo = i;
        this.f15091OooO0o0 = i2;
        this.f15090OooO0o = i3;
        this.f15092OooO0oO = j;
        this.f15093OooO0oo = j2;
        this.f15088OooO = str;
        this.f15094OooOO0 = str2;
        this.f15095OooOO0O = i4;
        this.f15096OooOO0o = i5;
    }
}
