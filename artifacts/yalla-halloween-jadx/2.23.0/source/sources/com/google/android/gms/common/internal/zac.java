...
public final class zac {
    ...
    @GuardedBy("sCache")
    public static final Oooo000<String, String> f15123OooO00o = new Oooo000<>();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @Nullable
    @GuardedBy("sCache")
    public static Locale f15124OooO0O0;
    ...
    public static String OooO0O0(Context context, String str) {
        Oooo000<String, String> oooo000 = f15123OooO00o;
        synchronized (oooo000) {
            Locale localeOooO0OO = o00oO0o.OooO00o(context.getResources().getConfiguration()).OooO0OO(0);
            if (!localeOooO0OO.equals(f15124OooO0O0)) {
                oooo000.clear();
                f15124OooO0O0 = localeOooO0OO;
            }
            String orDefault = oooo000.getOrDefault(str, null);
            if (orDefault != null) {
                return orDefault;
            }
