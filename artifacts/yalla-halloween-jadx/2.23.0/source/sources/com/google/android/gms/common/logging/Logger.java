...
public class Logger {
    ...
    public final String f15178OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final String f15179OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final int f15180OooO0OO;
    ...
    public Logger(@NonNull String str, @NonNull String... strArr) {
        ...
        this.f15179OooO0O0 = string;
        this.f15178OooO00o = str;
        new GmsLogger(str);
        int i = 2;
        while (i <= 7 && !Log.isLoggable(this.f15178OooO00o, i)) {
            i++;
        }
        this.f15180OooO0OO = i;
    }
