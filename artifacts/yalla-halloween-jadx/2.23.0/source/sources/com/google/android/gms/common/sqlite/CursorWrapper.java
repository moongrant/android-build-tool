...
public class CursorWrapper extends android.database.CursorWrapper implements CrossProcessCursor {
    ...
    public final AbstractWindowedCursor f15238OooO0Oo;
    ...
    public CursorWrapper(@NonNull Cursor cursor) {
        ...
        this.f15238OooO0Oo = (AbstractWindowedCursor) cursor;
    }

    @Override // android.database.CrossProcessCursor
    @KeepForSdk
    public void fillWindow(int i, @NonNull CursorWindow cursorWindow) {
        this.f15238OooO0Oo.fillWindow(i, cursorWindow);
    }
    ...
    public CursorWindow getWindow() {
        return this.f15238OooO0Oo.getWindow();
    }
    ...
    public final boolean onMove(int i, int i2) {
        return this.f15238OooO0Oo.onMove(i, i2);
    }

    @KeepForSdk
    public void setWindow(@Nullable CursorWindow cursorWindow) {
        this.f15238OooO0Oo.setWindow(cursorWindow);
    }
}
