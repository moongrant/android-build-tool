...
import p262o00ooo0O.o00O00;
import p262o00ooo0O.o00O000o;
import p262o00ooo0O.o00O00O;
import p262o00ooo0O.o00oOoo;
import p262o00ooo0O.o0O0ooO;
...
public final class DynamiteModule {
    ...
    public static Boolean f15319OooO0O0 = null;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @Nullable
    @GuardedBy("DynamiteModule.class")
    public static String f15320OooO0OO = null;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @GuardedBy("DynamiteModule.class")
    public static boolean f15321OooO0Oo = false;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @Nullable
    @GuardedBy("DynamiteModule.class")
    public static Boolean f15322OooO0o = null;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @GuardedBy("DynamiteModule.class")
    public static int f15323OooO0o0 = -1;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    @Nullable
    @GuardedBy("DynamiteModule.class")
    public static zzq f15326OooOO0 = null;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    @Nullable
    @GuardedBy("DynamiteModule.class")
    public static zzr f15327OooOO0O = null;

    @KeepForSdk
    public static final int REMOTE = 1;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final Context f15328OooO00o;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public static final ThreadLocal f15324OooO0oO = new ThreadLocal();

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public static final o00O00 f15325OooO0oo = new o00O00();

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    public static final OooO00o f15318OooO = new OooO00o();
    ...
    public static int OooO00o(Context context, String str, boolean z, boolean z2) throws Throwable {
        ...
        try {
            boolean z4 = true;
            Cursor cursorQuery = context.getContentResolver().query(new Uri.Builder().scheme("content").authority("com.google.android.gms.chimera").path(true != z ? "api" : "api_force_staging").appendPath(str).appendQueryParameter("requestStartTime", String.valueOf(((Long) f15325OooO0oo.get()).longValue())).build(), null, null, null, null);
            if (cursorQuery != null) {
                try {
                    if (cursorQuery.moveToFirst()) {
                        ...
                        if (i > 0) {
                            synchronized (DynamiteModule.class) {
                                f15320OooO0OO = cursorQuery.getString(2);
                                int columnIndex = cursorQuery.getColumnIndex("loaderVersion");
                                if (columnIndex >= 0) {
                                    f15323OooO0o0 = cursorQuery.getInt(columnIndex);
                                }
                            ...
                            o00O00O o00o00o2 = (o00O00O) f15324OooO0oO.get();
                            if (o00o00o2 == null || o00o00o2.f41065OooO00o != null) {
                                z4 = false;
                            } else {
                                o00o00o2.f41065OooO00o = cursorQuery;
                            }
    ...
    public static boolean OooO0OO(Context context) {
        ...
        if (bool.equals(null) || bool.equals(f15322OooO0o)) {
            return true;
        }
        boolean zBooleanValue = false;
        if (f15322OooO0o == null) {
    ...
    public static DynamiteModule load(@NonNull Context context, @NonNull VersionPolicy versionPolicy, @NonNull String str) throws LoadingException {
        ...
        Cursor cursor2;
        ThreadLocal threadLocal = f15324OooO0oO;
        o00O00O o00o00o4 = (o00O00O) threadLocal.get();
        o00O00O o00o00o5 = new o00O00O(0);
        threadLocal.set(o00o00o5);
        o00O00 o00o01 = f15325OooO0oo;
        long jLongValue = ((Long) o00o01.get()).longValue();
        try {
            o00o01.set(Long.valueOf(SystemClock.elapsedRealtime()));
            VersionPolicy.SelectionResult selectionResultSelectModule = versionPolicy.selectModule(context, str, f15318OooO);
                    ...
                    if (i2 == 1 || selectionResultSelectModule.remoteVersion != 0) {
                        if (i2 == -1) {
                            ...
                            if (jLongValue == 0) {
                                ...
                                o00o01.set(Long.valueOf(jLongValue));
                            }
                            cursor2 = o00o00o5.f41065OooO00o;
                            if (cursor2 != null) {
                                cursor2.close();
                            }
                            threadLocal.set(o00o00o4);
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (bool.booleanValue()) {
                                    ...
                                    synchronized (DynamiteModule.class) {
                                        zzrVar = f15327OooOO0O;
                                    }
                                    if (zzrVar != null) {
                                        throw new LoadingException("DynamiteLoaderV2 was not cached.");
                                    }
                                    o00o00o3 = (o00O00O) threadLocal.get();
                                    if (o00o00o3 != null || o00o00o3.f41065OooO00o == null) {
                                        throw new LoadingException("No result cursor");
                                    }
                                    Context applicationContext = context.getApplicationContext();
                                    Cursor cursor3 = o00o00o3.f41065OooO00o;
                                    ObjectWrapper.wrap(null);
                                    synchronized (DynamiteModule.class) {
                                        boolValueOf = Boolean.valueOf(f15323OooO0o0 >= 2);
                                    }
                                    ...
                                    if (iZze >= 3) {
                                        o00o00o2 = (o00O00O) threadLocal.get();
                                        if (o00o00o2 != null) {
                                            throw new LoadingException("No cached result cursor holder");
                                        }
                                        iObjectWrapperZzh = zzqVarOooO0Oo.zzi(ObjectWrapper.wrap(context), str, i, ObjectWrapper.wrap(o00o00o2.f41065OooO00o));
                                    } else if (iZze == 2) {
                            ...
                            if (jLongValue == 0) {
                                f15325OooO0oo.remove();
                            } else {
                                f15325OooO0oo.set(Long.valueOf(jLongValue));
                            }
                            Cursor cursor4 = o00o00o5.f41065OooO00o;
                            if (cursor4 != null) {
                                cursor4.close();
                            }
                            f15324OooO0oO.set(o00o00o4);
            ...
            Cursor cursor5 = o00o00o5.f41065OooO00o;
            if (cursor5 != null) {
                cursor5.close();
            }
            f15324OooO0oO.set(o00o00o4);
                                ...
                                if (f15321OooO0Oo) {
                                    ...
                                    if (bool2.equals(null)) {
                                        ...
                                        try {
                                            ...
                                            String str2 = f15320OooO0OO;
                                            if (str2 != null && !str2.isEmpty()) {
                                                ClassLoader classLoaderZza = zzb.zza();
                                                if (classLoaderZza == null) {
                                                    if (Build.VERSION.SDK_INT >= 29) {
                                                        o00oOoo.OooO00o();
                                                        String str3 = f15320OooO0OO;
                                                        Preconditions.checkNotNull(str3);
                                                        classLoaderZza = o0O0ooO.OooO00o(str3, ClassLoader.getSystemClassLoader());
                                                    } else {
                                                        String str4 = f15320OooO0OO;
                                                        Preconditions.checkNotNull(str4);
                                                        classLoaderZza = new o00O000o(ClassLoader.getSystemClassLoader(), str4);
                                                    }
                                                }
                ...
                try {
                    if (zzqVarOooO0Oo != null) {
                        try {
                            ...
                            if (iZze >= 3) {
                                ThreadLocal threadLocal = f15324OooO0oO;
                                o00O00O o00o00o2 = (o00O00O) threadLocal.get();
                                if (o00o00o2 == null || (cursor2 = o00o00o2.f41065OooO00o) == null) {
                                    cursor = (Cursor) ObjectWrapper.unwrap(zzqVarOooO0Oo.zzk(ObjectWrapper.wrap(context), str, z, ((Long) f15325OooO0oo.get()).longValue()));
                                    if (cursor != null) {
                                        try {
                                            if (cursor.moveToFirst()) {
                                                int i = cursor.getInt(0);
                                                if (i > 0) {
                                                    o00O00O o00o00o3 = (o00O00O) threadLocal.get();
                                                    if (o00o00o3 == null || o00o00o3.f41065OooO00o != null) {
                                                        z2 = false;
                                                    } else {
                                                        o00o00o3.f41065OooO00o = cursor;
                                                    }
    ...
    public IBinder instantiate(@NonNull String str) throws LoadingException {
        try {
            return (IBinder) this.f15328OooO00o.getClassLoader().loadClass(str).newInstance();
