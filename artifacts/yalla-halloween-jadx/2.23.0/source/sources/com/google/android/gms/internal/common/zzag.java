...
public abstract class zzag extends zzac implements List, RandomAccess {
    ...
    public static final o0O00 f15361OooO0o0 = new o0O00(OooO0O0.f15355OooO0oo, 0);

    public static OooO0O0 OooO0o(int i, Object[] objArr) {
        return i == 0 ? OooO0O0.f15355OooO0oo : new OooO0O0(objArr, i);
    }
    ...
    public static zzag zzj(Iterable iterable) {
        ...
        zzadVar.zzb(next);
        zzadVar.zzc(it);
        zzadVar.f41073OooO0OO = true;
        return OooO0o(zzadVar.f41072OooO0O0, zzadVar.f41071OooO00o);
    }
    ...
    public zzag subList(int i, int i2) {
        ...
        return i3 == 0 ? OooO0O0.f15355OooO0oo : new OooO00o(this, i, i3);
    }
    ...
    public final zzak listIterator(int i) {
        ...
        return isEmpty() ? f15361OooO0o0 : new o0O00(this, i);
    }
}
