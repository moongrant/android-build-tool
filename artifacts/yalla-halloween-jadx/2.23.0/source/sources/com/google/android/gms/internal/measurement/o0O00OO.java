...
public final class o0O00OO extends o0oO0Ooo {
    ...
    public static final Class f15536OooO0OO = Collections.unmodifiableList(Collections.emptyList()).getClass();
    ...
    public final void OooO00o(long j, Object obj) {
        ...
        if (list instanceof zzlq) {
            ...
            if (f15536OooO0OO.isAssignableFrom(list.getClass())) {
                return;
            }
            if ((list instanceof o0oOo0O0) && (list instanceof zzli)) {
    ...
    public final void OooO0O0(long j, Object obj, Object obj2) {
        ...
        if (list4.isEmpty()) {
            if (list4 instanceof zzlq) {
                ...
                listZzd = ((list4 instanceof o0oOo0O0) && (list4 instanceof zzli)) ? ((zzli) list4).zzd(size) : new ArrayList(size);
            }
            o0oo0000.OooOOo(j, obj, listZzd);
            list2 = listZzd;
        } else {
            if (f15536OooO0OO.isAssignableFrom(list4.getClass())) {
                ...
                list = zzlpVar;
            } else if ((list4 instanceof o0oOo0O0) && (list4 instanceof zzli)) {
