...
public final class zzah implements zzap {
    ...
    public final Double f15656OooO0Oo;

    public zzah(Double d) {
        if (d == null) {
            this.f15656OooO0Oo = Double.valueOf(Double.NaN);
        } else {
            this.f15656OooO0Oo = d;
        }
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof zzah) {
            return this.f15656OooO0Oo.equals(((zzah) obj).f15656OooO0Oo);
        }
        return false;
    }

    public final int hashCode() {
        return this.f15656OooO0Oo.hashCode();
    }
    ...
    public final zzap zzd() {
        return new zzah(this.f15656OooO0Oo);
    }

    @Override // com.google.android.gms.internal.measurement.zzap
    public final Boolean zzg() {
        Double d = this.f15656OooO0Oo;
        boolean z = false;
