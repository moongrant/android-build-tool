...
public final class zzef {
    ...
    public static volatile zzef f15681OooOO0;

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    public volatile zzcc f15682OooO;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final String f15683OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final Clock f15684OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final ExecutorService f15685OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final AppMeasurementSdk f15686OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public int f15687OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @GuardedBy("listenerList")
    public final ArrayList f15688OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public boolean f15689OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final String f15690OooO0oo;
    ...
    public zzef(Context context, String str, String str2, String str3, Bundle bundle) {
        ...
        if (str == null) {
            ...
            if (z4) {
                this.f15683OooO00o = str;
            } else {
                this.f15683OooO00o = "FA";
            }
        }
        this.f15684OooO0O0 = DefaultClock.getInstance();
        zzbx.zza();
        ...
        this.f15685OooO0OO = Executors.unconfigurableExecutorService(threadPoolExecutor);
        this.f15686OooO0Oo = new AppMeasurementSdk(this);
        this.f15688OooO0o0 = new ArrayList();
        try {
            try {
                if (zziq.zzc(context, "google_app_id", com.google.android.gms.measurement.internal.zzfv.zza(context)) != null) {
                    ...
                    if (!z3) {
                        this.f15690OooO0oo = null;
                        this.f15689OooO0oO = true;
                        Log.w(this.f15683OooO00o, "Disabling data collection. Found google_app_id in strings.xml but Google Analytics for Firebase is missing. Remove this value or add Google Analytics for Firebase to resume data collection.");
                        return;
                    }
                }
        ...
        if (z) {
            this.f15690OooO0oo = str2;
        } else {
            this.f15690OooO0oo = "fa";
            if (str2 == null || str3 == null) {
                if ((str2 == null) ^ (str3 == null)) {
                    Log.w(this.f15683OooO00o, "Specified origin or custom app id is null. Both parameters will be ignored.");
                }
            } else {
                Log.v(this.f15683OooO00o, "Deferring to Google Analytics for Firebase for event data collection. https://firebase.google.com/docs/analytics");
            }
        }
        OooO0OO(new o0OOO0o(this, str2, str3, context, bundle));
        Application application = (Application) context.getApplicationContext();
        if (application == null) {
            Log.w(this.f15683OooO00o, "Unable to register lifecycle notifications. Application null.");
        } else {
    ...
    public static zzef zzg(Context context, String str, String str2, String str3, Bundle bundle) {
        ...
        if (f15681OooOO0 == null) {
            synchronized (zzef.class) {
                if (f15681OooOO0 == null) {
                    f15681OooOO0 = new zzef(context, str, str2, str3, bundle);
                }
            }
        }
        return f15681OooOO0;
    ...
    public final void OooO00o(Exception exc, boolean z, boolean z2) {
        this.f15689OooO0oO |= z;
        String str = this.f15683OooO00o;
        if (z) {
    ...
    public final void OooO0OO(o000O0o o000o0o2) {
        this.f15685OooO0OO.execute(o000o0o2);
    }
    ...
    public final void zzC(com.google.android.gms.measurement.internal.zzhg zzhgVar) {
        ...
        synchronized (this.f15688OooO0o0) {
            for (int i = 0; i < this.f15688OooO0o0.size(); i++) {
                if (zzhgVar.equals(((Pair) this.f15688OooO0o0.get(i)).first)) {
                    Log.w(this.f15683OooO00o, "OnEventListener already registered.");
                    return;
                }
            }
            o000O00 o000o01 = new o000O00(zzhgVar);
            this.f15688OooO0o0.add(new Pair(zzhgVar, o000o01));
            if (this.f15682OooO != null) {
                try {
                    this.f15682OooO.registerOnMeasurementEventListener(o000o01);
                    return;
                } catch (BadParcelableException | NetworkOnMainThreadException | RemoteException | IllegalArgumentException | IllegalStateException | NullPointerException | SecurityException | UnsupportedOperationException unused) {
                    Log.w(this.f15683OooO00o, "Failed to register event listener on calling thread. Trying again on the dynamite thread.");
                }
            }
    ...
    public final void zzK(com.google.android.gms.measurement.internal.zzhf zzhfVar) {
        ...
        if (this.f15682OooO != null) {
            try {
                this.f15682OooO.setEventInterceptor(o000oo1);
                return;
            } catch (BadParcelableException | NetworkOnMainThreadException | RemoteException | IllegalArgumentException | IllegalStateException | NullPointerException | SecurityException | UnsupportedOperationException unused) {
                Log.w(this.f15683OooO00o, "Failed to set event interceptor on calling thread. Trying again on the dynamite thread.");
            }
        }
    ...
    public final void zzP(com.google.android.gms.measurement.internal.zzhg zzhgVar) {
        ...
        synchronized (this.f15688OooO0o0) {
            int i = 0;
            while (true) {
                if (i >= this.f15688OooO0o0.size()) {
                    pair = null;
                    break;
                } else {
                    if (zzhgVar.equals(((Pair) this.f15688OooO0o0.get(i)).first)) {
                        pair = (Pair) this.f15688OooO0o0.get(i);
                        break;
                    }
                    i++;
                }
            ...
            if (pair == null) {
                Log.w(this.f15683OooO00o, "OnEventListener had not been registered.");
                return;
            }
            this.f15688OooO0o0.remove(pair);
            o000O00 o000o01 = (o000O00) pair.second;
            if (this.f15682OooO != null) {
                try {
                    this.f15682OooO.unregisterOnMeasurementEventListener(o000o01);
                    return;
                } catch (BadParcelableException | NetworkOnMainThreadException | RemoteException | IllegalArgumentException | IllegalStateException | NullPointerException | SecurityException | UnsupportedOperationException unused) {
                    Log.w(this.f15683OooO00o, "Failed to unregister event listener on calling thread. Trying again on the dynamite thread.");
                }
            }
    ...
    public final long zzb() {
        ...
        long jNextLong = new Random(System.nanoTime() ^ this.f15684OooO0O0.currentTimeMillis()).nextLong();
        int i = this.f15687OooO0o + 1;
        this.f15687OooO0o = i;
