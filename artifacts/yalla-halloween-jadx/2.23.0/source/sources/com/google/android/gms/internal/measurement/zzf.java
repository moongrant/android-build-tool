...
public final class zzf {
    ...
    public final zzax f15691OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final zzg f15692OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final zzg f15693OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final zzj f15694OooO0Oo;

    public zzf() {
        zzax zzaxVar = new zzax();
        this.f15691OooO00o = zzaxVar;
        zzg zzgVar = new zzg(null, zzaxVar);
        this.f15693OooO0OO = zzgVar;
        this.f15692OooO0O0 = zzgVar.zza();
        zzj zzjVar = new zzj();
        this.f15694OooO0Oo = zzjVar;
    ...
    public final zzap zza(zzg zzgVar, zzgy... zzgyVarArr) {
        ...
        for (zzgy zzgyVar : zzgyVarArr) {
            ...
            zzh.zzc(this.f15693OooO0OO);
            if ((zzapVarZza instanceof zzaq) || (zzapVarZza instanceof zzao)) {
                zzapVarZza = this.f15691OooO00o.zza(zzgVar, zzapVarZza);
            }
        }
        return zzapVarZza;
    }
