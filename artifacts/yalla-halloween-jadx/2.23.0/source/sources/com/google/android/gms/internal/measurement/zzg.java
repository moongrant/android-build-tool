...
public final class zzg {
    ...
    public final zzax f15695OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final HashMap f15696OooO0O0 = new HashMap();

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final HashMap f15697OooO0OO = new HashMap();
    public final zzg zza;

    public zzg(zzg zzgVar, zzax zzaxVar) {
        this.zza = zzgVar;
        this.f15695OooO00o = zzaxVar;
    }

    public final zzg zza() {
        return new zzg(this, this.f15695OooO00o);
    }

    public final zzap zzb(zzap zzapVar) {
        return this.f15695OooO00o.zza(this, zzapVar);
    }
    ...
    public final zzap zzc(zzae zzaeVar) {
        ...
        while (itZzk.hasNext()) {
            zzapVarZza = this.f15695OooO00o.zza(this, zzaeVar.zze(((Integer) itZzk.next()).intValue()));
    ...
    public final zzap zzd(String str) {
        HashMap map = this.f15696OooO0O0;
    ...
    public final void zze(String str, zzap zzapVar) {
        if (this.f15697OooO0OO.containsKey(str)) {
            return;
        }
        HashMap map = this.f15696OooO0O0;
        if (zzapVar == null) {
    ...
    public final void zzf(String str, zzap zzapVar) {
        zze(str, zzapVar);
        this.f15697OooO0OO.put(str, Boolean.TRUE);
    }
    ...
    public final boolean zzh(String str) {
        if (this.f15696OooO0O0.containsKey(str)) {
            return true;
        }
        zzg zzgVar = this.zza;
        if (zzgVar != null) {
