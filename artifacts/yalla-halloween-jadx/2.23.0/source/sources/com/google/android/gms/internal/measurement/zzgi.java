...
public final class zzgi extends zzlb implements zzmj {
    ...
    public zzgi() {
        o0O00o00 o0o00o01 = o0O00o00.f15538OooO0oO;
        this.zzd = o0o00o01;
        this.zze = o0o00o01;
    ...
    public static void OooOOOO(zzgi zzgiVar) {
        zzgiVar.zzd = o0O00o00.f15538OooO0oO;
    }
    ...
    public static void OooOOo0(zzgi zzgiVar) {
        zzgiVar.zze = o0O00o00.f15538OooO0oO;
    }

    public static void OooOOoo(zzgi zzgiVar) {
        zzgiVar.zzf = o0O.f15517OooO0oO;
    }

    public static void OooOo0(zzgi zzgiVar) {
        zzgiVar.zzg = o0O.f15517OooO0oO;
    }
    ...
    public final Object OooOO0o(int i) {
        ...
        int i3 = 0;
        if (i2 == 2) {
            return new o0OO000(zza, "\u0001\u0004\u0000\u0000\u0001\u0004\u0004\u0000\u0004\u0000\u0001\u0015\u0002\u0015\u0003\u001b\u0004\u001b", new Object[]{"zzd", "zze", "zzf", zzfr.class, "zzg", zzgk.class});
        }
        if (i2 == 3) {
            return new zzgi();
        }
