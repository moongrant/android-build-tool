...
public final class zzhb {
    ...
    public static UserManager f15706OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static volatile boolean f15707OooO0O0 = !zzb();
    ...
    public static boolean zza(Context context) {
        boolean z;
        if (zzb() && !f15707OooO0O0) {
            synchronized (zzhb.class) {
                if (!f15707OooO0O0) {
                    int i = 1;
                    while (true) {
                        if (i <= 2) {
                            if (f15706OooO00o == null) {
                                f15706OooO00o = (UserManager) context.getSystemService(UserManager.class);
                            }
                            UserManager userManager = f15706OooO00o;
                            if (userManager == null) {
                                z = true;
                            } else {
                                try {
