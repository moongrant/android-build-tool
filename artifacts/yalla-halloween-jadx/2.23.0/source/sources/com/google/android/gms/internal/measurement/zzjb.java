...
public abstract class zzjb extends zziw implements Set {
    ...
    @CheckForNull
    public transient zzja f15741OooO0o0;
    ...
    public static zzjb OooO0oo(int i, Object... objArr) {
        if (i == 0) {
            return o00OOO00.f15498OooOO0o;
        }
        if (i == 1) {
            Object obj = objArr[0];
            obj.getClass();
            return new o00OOO0(obj);
        }
        ...
        return new o00OOO00(objArr, objArr2, i3, i2, i4);
    }
    ...
    public o00OO OooO0o() {
        ...
        o00OO0O0 o00oo0o1 = zzja.f15740OooO0o0;
    ...
    public final boolean equals(@CheckForNull Object obj) {
        ...
        if ((obj instanceof zzjb) && (this instanceof o00OOO00)) {
            zzjb zzjbVar = (zzjb) obj;
            zzjbVar.getClass();
            if ((zzjbVar instanceof o00OOO00) && hashCode() != obj.hashCode()) {
                return false;
            }
        }
        if (obj == this) {
    ...
    public final zzja zzg() {
        zzja zzjaVar = this.f15741OooO0o0;
        if (zzjaVar != null) {
            return zzjaVar;
        }
        o00OO o00ooOooO0o = OooO0o();
        this.f15741OooO0o0 = o00ooOooO0o;
        return o00ooOooO0o;
    }
}
