...
public abstract class zzka implements Iterable, Serializable {
    public static final zzka zzb = new o0oOOo(zzlj.zzd);

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public int f15743OooO0Oo = 0;
    ...
    public static int OooO0o0(int i, int i2, int i3) {
        ...
        if (i2 < i) {
            throw new IndexOutOfBoundsException(p022Oooo00O.OooOO0.OooO00o("Beginning index larger than ending index: ", i, ", ", i2));
        }
        throw new IndexOutOfBoundsException(p022Oooo00O.OooOO0.OooO00o("End index: ", i2, " >= ", i3));
    }
    ...
    public final int hashCode() {
        int iOooO0O0 = this.f15743OooO0Oo;
        if (iOooO0O0 == 0) {
            int iZzd = zzd();
    ...
    public final String toString() {
        ...
        objArr[2] = zzd() <= 50 ? o0OO.OooO00o(this) : o0OO.OooO00o(zzf(0, 47)).concat("...");
