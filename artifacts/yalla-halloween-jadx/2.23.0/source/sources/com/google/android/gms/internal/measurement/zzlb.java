...
public abstract class zzlb<MessageType extends zzlb<MessageType, BuilderType>, BuilderType extends zzkx<MessageType, BuilderType>> extends zzjk<MessageType, BuilderType> {
    ...
    public final int OooO00o(o0OO000o o0oo000o) {
        ...
        int iOooO0OO2 = OooO0OO(o0oo000o);
        if (iOooO0OO2 < 0) {
    ...
    public final int OooO0OO(o0OO000o o0oo000o) {
        if (o0oo000o != null) {
            return o0oo000o.OooO0o0(this);
        }
        return o0O0oo00.f15553OooO0OO.OooO00o(getClass()).OooO0o0(this);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return o0O0oo00.f15553OooO0OO.OooO00o(getClass()).OooO0oO(this, (zzlb) obj);
    }

    public final int hashCode() {
        if (OooOO0O()) {
            return o0O0oo00.f15553OooO0OO.OooO00o(getClass()).OooO0OO(this);
        }
        int i = this.zzb;
        if (i != 0) {
            return i;
        }
        int iOooO0OO = o0O0oo00.f15553OooO0OO.OooO00o(getClass()).OooO0OO(this);
        this.zzb = iOooO0OO;
        return iOooO0OO;
    }
    ...
    public final String toString() {
        ...
        char[] cArr = o0O0OOOo.f15545OooO00o;
        StringBuilder sb = new StringBuilder();
        sb.append("# ");
        sb.append(string);
        o0O0OOOo.OooO0OO(this, sb, 0);
        return sb.toString();
    }
    ...
    public final void zzbQ(zzki zzkiVar) throws IOException {
        o0OO000o o0oo000oOooO00o = o0O0oo00.f15553OooO0OO.OooO00o(getClass());
        o0O00000 o0o00000 = zzkiVar.f15746OooO00o;
        if (o0o00000 == null) {
            o0o00000 = new o0O00000(zzkiVar);
        }
        o0oo000oOooO00o.OooO0O0(this, o0o00000);
    }
