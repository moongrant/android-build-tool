...
public final class zzz {
    ...
    public final TreeMap f15835OooO00o = new TreeMap();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final TreeMap f15836OooO0O0 = new TreeMap();

    public final void zza(String str, int i, zzao zzaoVar, String str2) {
        TreeMap treeMap;
        if ("create".equals(str2)) {
            treeMap = this.f15836OooO0O0;
        } else {
            if (!"edit".equals(str2)) {
                throw new IllegalStateException("Unknown callback type: ".concat(String.valueOf(str2)));
            }
            treeMap = this.f15835OooO00o;
        }
    ...
    public final void zzb(zzg zzgVar, zzab zzabVar) {
        ...
        TreeMap treeMap = this.f15835OooO00o;
        ...
        TreeMap treeMap2 = this.f15836OooO0O0;
