...
public abstract class zzx implements Map, Serializable {
    ...
    @CheckForNull
    public transient zzy f15858OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @CheckForNull
    public transient zzr f15859OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @CheckForNull
    public transient zzy f15860OooO0o0;
    ...
    public final /* bridge */ /* synthetic */ Set keySet() {
        zzy zzyVar = this.f15860OooO0o0;
        if (zzyVar != null) {
            return zzyVar;
        }
        OooO0o oooO0oOooO0OO = OooO0OO();
        this.f15860OooO0o0 = oooO0oOooO0OO;
    ...
    public final zzr values() {
        zzr zzrVar = this.f15859OooO0o;
        if (zzrVar != null) {
            return zzrVar;
        }
        OooO oooOOooO00o = OooO00o();
        this.f15859OooO0o = oooOOooO00o;
        return oooOOooO00o;
    }
    ...
    public final zzy entrySet() {
        zzy zzyVar = this.f15858OooO0Oo;
        if (zzyVar != null) {
            return zzyVar;
        }
        OooO0OO oooO0OOOooO0O0 = OooO0O0();
        this.f15858OooO0Oo = oooO0OOOooO0O0;
