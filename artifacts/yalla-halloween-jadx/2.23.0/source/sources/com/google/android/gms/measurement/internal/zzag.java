...
import p269o00ooooo.oO000Oo0;
import p269o00ooooo.oo0OOoo;

/* JADX INFO: loaded from: classes3.dex */
public final class zzag extends oO000Oo0 {

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public Boolean f15872OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public oo0OOoo f15873OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public Boolean f15874OooO0Oo;

    public zzag(zzgd zzgdVar) {
        super(zzgdVar);
        this.f15873OooO0OO = new oo0OOoo() { // from class: com.google.android.gms.measurement.internal.zzae
    ...
    public final Boolean OooO0OO(@Size(min = 1) String str) {
        ...
        if (bundleOooO0O0 == null) {
            o0O0OO0.OooO00o(this.f41276OooO00o, "Failed to load metadata: Metadata bundle is null");
            return null;
        }
    ...
    public final boolean OooO0Oo() {
        if (this.f15872OooO0O0 == null) {
            Boolean boolOooO0OO = OooO0OO("app_measurement_lite");
            this.f15872OooO0O0 = boolOooO0OO;
            if (boolOooO0OO == null) {
                this.f15872OooO0O0 = Boolean.FALSE;
            }
        }
        return this.f15872OooO0O0.booleanValue() || !this.f41276OooO00o.zzN();
    }
    ...
    public final double zza(String str, zzef zzefVar) {
        ...
        String strZza = this.f15873OooO0OO.zza(str, zzefVar.zzb());
    ...
    public final int zzc() {
        return this.f41276OooO00o.zzv().zzai(201500000, true) ? 100 : 25;
    }
    ...
    public final String zzo(String str, zzef zzefVar) {
        return str == null ? (String) zzefVar.zza(null) : (String) zzefVar.zza(this.f15873OooO0OO.zza(str, zzefVar.zzb()));
    }
    ...
    public final boolean zzt(String str) {
        return "1".equals(this.f15873OooO0OO.zza(str, "gaia_collection_enabled"));
    }
    ...
    public final boolean zzw(String str) {
        return "1".equals(this.f15873OooO0OO.zza(str, "measurement.event_sampling_enabled"));
    }

    @EnsuresNonNull({"this.isMainProcess"})
    public final boolean zzy() {
        if (this.f15874OooO0Oo == null) {
            synchronized (this) {
                if (this.f15874OooO0Oo == null) {
                    ApplicationInfo applicationInfo = this.f41276OooO00o.zzaw().getApplicationInfo();
                    ...
                    if (applicationInfo != null) {
                        ...
                        this.f15874OooO0Oo = Boolean.valueOf(z);
                    }
                    if (this.f15874OooO0Oo == null) {
                        this.f15874OooO0Oo = Boolean.TRUE;
                        this.f41276OooO00o.zzaA().zzd().zza("My process not in the list of running processes");
                    }
                }
            }
        }
        return this.f15874OooO0Oo.booleanValue();
    }
}
