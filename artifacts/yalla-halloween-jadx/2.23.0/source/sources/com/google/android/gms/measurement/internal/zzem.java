...
import p269o00ooooo.o0OO00o0;
import p269o00ooooo.o0OO0oO0;

/* JADX INFO: loaded from: classes3.dex */
public final class zzem extends o0OO0oO0 {

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final o0OO00o0 f15918OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public boolean f15919OooO0Oo;

    public zzem(zzgd zzgdVar) {
        super(zzgdVar);
        Context contextZzaw = this.f41276OooO00o.zzaw();
        this.f41276OooO00o.zzf();
        this.f15918OooO0OO = new o0OO00o0(this, contextZzaw);
    }
    ...
    public final SQLiteDatabase OooO0OO() throws SQLiteException {
        if (this.f15919OooO0Oo) {
            return null;
        }
        SQLiteDatabase writableDatabase = this.f15918OooO0OO.getWritableDatabase();
        if (writableDatabase != null) {
            return writableDatabase;
        }
        this.f15919OooO0Oo = true;
        return null;
    }
    ...
    public final boolean zzo(zzau zzauVar) {
        ...
        this.f41276OooO00o.zzaA().zzh().zza("Event is too long for local database. Sending event directly to service");
        return false;
    }
    ...
    public final boolean zzp(zzlk zzlkVar) {
        ...
        this.f41276OooO00o.zzaA().zzh().zza("User property too long for local database. Sending directly to service");
        return false;
    }
}
