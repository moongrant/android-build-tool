...
public final class zzeo {
    ...
    public static final AtomicReference f15920OooO0O0 = new AtomicReference();

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final AtomicReference f15921OooO0OO = new AtomicReference();

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public static final AtomicReference f15922OooO0Oo = new AtomicReference();

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final zzen f15923OooO00o;

    public zzeo(zzen zzenVar) {
        this.f15923OooO00o = zzenVar;
    }
    ...
    public final String OooO0O0(Bundle bundle) {
        ...
        if (!this.f15923OooO00o.zza()) {
            return bundle.toString();
        }
        StringBuilder sbOooO00o = o00OO.OooO00o("Bundle[{");
    ...
    public final String OooO0OO(zzau zzauVar) {
        String string;
        zzen zzenVar = this.f15923OooO00o;
        if (!zzenVar.zza()) {
    ...
    public final String OooO0Oo(String str) {
        ...
        return !this.f15923OooO00o.zza() ? str : OooO0oO(str, zzhc.zzc, zzhc.zza, f15920OooO0O0);
    }
    ...
    public final String OooO0o(String str) {
        ...
        if (this.f15923OooO00o.zza()) {
            return str.startsWith("_exp_") ? o000oOoO.OooO00o("experiment_id(", str, ")") : OooO0oO(str, zzhe.zzb, zzhe.zza, f15922OooO0Oo);
        }
        return str;
    }
    ...
    public final String OooO0o0(String str) {
        ...
        return !this.f15923OooO00o.zza() ? str : OooO0oO(str, zzhd.zzb, zzhd.zza, f15921OooO0OO);
    }
}
