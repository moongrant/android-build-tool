...
public final class zzhb {
    ...
    public final boolean equals(Object obj) {
        ...
        while (true) {
            char c2 = 1;
            if (i >= length) {
                return this.f16025OooO0O0 == zzhbVar.f16025OooO0O0;
            }
            zzha zzhaVar = zzhaVarArrValues[i];
            Boolean bool = (Boolean) this.f16024OooO00o.get(zzhaVar);
            if (bool == null) {
                c = 0;
            } else {
                c = bool.booleanValue() ? (char) 1 : (char) 2;
            }
            Boolean bool2 = (Boolean) zzhbVar.f16024OooO00o.get(zzhaVar);
            if (bool2 == null) {
                c2 = 0;
    ...
    public final int hashCode() {
        int i = this.f16025OooO0O0 * 17;
        for (Boolean bool : this.f16024OooO00o.values()) {
    ...
    public final int zza() {
        return this.f16025OooO0O0;
    }

    public final zzhb zzd(zzhb zzhbVar) {
        EnumMap enumMap = new EnumMap(zzha.class);
        for (zzha zzhaVar : zzha.values()) {
            Boolean boolValueOf = (Boolean) this.f16024OooO00o.get(zzhaVar);
            Boolean bool = (Boolean) zzhbVar.f16024OooO00o.get(zzhaVar);
            if (boolValueOf == null) {
                boolValueOf = bool;
            } else if (bool != null) {
    ...
    public final zzhb zze(zzhb zzhbVar) {
        ...
        for (zzha zzhaVar : zzha.values()) {
            Boolean bool = (Boolean) this.f16024OooO00o.get(zzhaVar);
            if (bool == null) {
                bool = (Boolean) zzhbVar.f16024OooO00o.get(zzhaVar);
            }
            enumMap.put(zzhaVar, bool);
        }
        return new zzhb(enumMap, this.f16025OooO0O0);
    }

    public final Boolean zzf() {
        return (Boolean) this.f16024OooO00o.get(zzha.AD_STORAGE);
    }

    public final Boolean zzg() {
        return (Boolean) this.f16024OooO00o.get(zzha.ANALYTICS_STORAGE);
    }
    ...
    public final String zzi() {
        ...
        int length = zzhaVarArr.length;
        for (int i = 0; i < 2; i++) {
            Boolean bool = (Boolean) this.f16024OooO00o.get(zzhaVarArr[i]);
    ...
    public final boolean zzl() {
        Iterator it = this.f16024OooO00o.values().iterator();
        while (it.hasNext()) {
    ...
    public final boolean zzm(zzhb zzhbVar) {
        return zzn(zzhbVar, (zzha[]) this.f16024OooO00o.keySet().toArray(new zzha[0]));
    }
