...
import p269o00ooooo.oOO0OO0O;

/* JADX INFO: loaded from: classes3.dex */
public final class zzkg {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final Context f16070OooO00o;

    public zzkg(Context context) {
        Preconditions.checkNotNull(context);
        this.f16070OooO00o = context;
    }

    public final zzet OooO00o() {
        return zzgd.zzp(this.f16070OooO00o, null, null).zzaA();
    }

    @MainThread
    public final int zza(final Intent intent, int i, final int i2) {
        zzgd zzgdVarZzp = zzgd.zzp(this.f16070OooO00o, null, null);
        ...
        if ("com.google.android.gms.measurement.UPLOAD".equals(action)) {
            zzh(new Runnable() { // from class: com.google.android.gms.measurement.internal.zzkd
                ...
                public final void run() {
                    ...
                    zzkf zzkfVar = (zzkf) zzkgVar.f16070OooO00o;
                    if (zzkfVar.zzc(i3)) {
    ...
    public final IBinder zzb(Intent intent) {
        ...
        if ("com.google.android.gms.measurement.START".equals(action)) {
            return new zzgv(zzlh.zzt(this.f16070OooO00o), null);
        }
    ...
    public final void zzh(Runnable runnable) {
        zzlh zzlhVarZzt = zzlh.zzt(this.f16070OooO00o);
        zzlhVarZzt.zzaB().zzp(new oOO0OO0O(zzlhVarZzt, runnable));
    }
    ...
    public final boolean zzi(final JobParameters jobParameters) {
        ...
        zzh(new Runnable() { // from class: com.google.android.gms.measurement.internal.zzkc
            ...
            public final void run() {
                ...
                ((zzkf) zzkgVar.f16070OooO00o).zzb(jobParameters2, false);
            }
        });
        return true;
    }
