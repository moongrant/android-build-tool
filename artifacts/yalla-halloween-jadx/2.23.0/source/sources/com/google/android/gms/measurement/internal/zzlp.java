...
import p269o00ooooo.O0OO00;
import p269o00ooooo.oO000Oo;

/* JADX INFO: loaded from: classes3.dex */
public final class zzlp extends oO000Oo {

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public static final String[] f16112OooO0oO = {"firebase_", "google_", "ga_"};

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public static final String[] f16113OooO0oo = {"_err"};

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public SecureRandom f16114OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final AtomicLong f16115OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public Integer f16116OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public int f16117OooO0o0;

    public zzlp(zzgd zzgdVar) {
        super(zzgdVar);
        this.f16116OooO0o = null;
        this.f16115OooO0Oo = new AtomicLong(0L);
    }
    ...
    public static void OooOOO(O0OO00 o0oo00, String str, int i, String str2, String str3, int i2) {
    ...
    public static boolean zzan(String str) {
        return !f16113OooO0oo[0].equals(str);
    }
    ...
    public final void OooO(Bundle bundle, long j) {
        ...
        if (j2 != 0) {
            this.f41276OooO00o.zzaA().zzk().zzb("Params already contained engagement", Long.valueOf(j2));
        } else {
            j2 = 0;
        }
    ...
    public final void OooO00o() {
        ...
        if (jNextLong == 0) {
            ...
            if (jNextLong == 0) {
                this.f41276OooO00o.zzaA().zzk().zza("Utils falling back to Random for random id");
            }
        }
        this.f16115OooO0Oo.set(jNextLong);
    }
    ...
    public final SecureRandom OooO0oo() {
        zzg();
        if (this.f16114OooO0OO == null) {
            this.f16114OooO0OO = new SecureRandom();
        }
        return this.f16114OooO0OO;
    }
    ...
    public final void OooOO0O(Bundle bundle, Bundle bundle2) {
        ...
        for (String str : bundle2.keySet()) {
            if (!bundle.containsKey(str)) {
                this.f41276OooO00o.zzv().OooOOOO(bundle, str, bundle2.get(str));
            }
        }
    }
    ...
    public final void OooOOOo(String str, String str2, Bundle bundle, List list, boolean z) {
        ...
        zzpq.zzc();
        String str4 = null;
        int i2 = (zzagVarZzf.f41276OooO00o.zzf().zzs(null, zzeg.zzaz) && zzagVarZzf.f41276OooO00o.zzv().zzai(231100000, true)) ? 35 : 0;
        int i3 = 0;
    ...
    public final int OooOOoo(String str, String str2, Object obj, Bundle bundle, List list, boolean z, boolean z2) {
        ...
        if (!zOooOoO0) {
            ...
            zzjzVarZzt.zzg();
            zzjzVarZzt.zza();
            if (zzjzVarZzt.OooO0o() && zzjzVarZzt.f41276OooO00o.zzv().zzm() < 200900) {
                return 25;
            }
            zzgdVar.zzf();
    ...
    public final boolean OooOo0(String str, String str2, int i, Object obj) {
        if (obj != null && !(obj instanceof Long) && !(obj instanceof Float) && !(obj instanceof Integer) && !(obj instanceof Byte) && !(obj instanceof Short) && !(obj instanceof Boolean) && !(obj instanceof Double)) {
            ...
            if (string.codePointCount(0, string.length()) > i) {
                this.f41276OooO00o.zzaA().zzl().zzd("Value is too long; discarded. Value kind, name, value length", str, str2, Integer.valueOf(string.length()));
                return false;
            }
        }
        return true;
    ...
    public final Bundle Oooo(boolean z, Uri uri) {
        ...
        try {
            ...
            this.f41276OooO00o.zzaA().zzk().zzb("Install referrer url isn't a hierarchical URI", e);
            return null;
        }
    }
    ...
    public final void zzQ(com.google.android.gms.internal.measurement.zzcf zzcfVar, boolean z) {
        ...
        try {
            ...
            this.f41276OooO00o.zzaA().zzk().zzb("Error returning boolean value to wrapper", e);
        }
    }
    ...
    public final void zzR(com.google.android.gms.internal.measurement.zzcf zzcfVar, ArrayList arrayList) {
        ...
        try {
            ...
            this.f41276OooO00o.zzaA().zzk().zzb("Error returning bundle list to wrapper", e);
        }
    }
    ...
    public final void zzS(com.google.android.gms.internal.measurement.zzcf zzcfVar, Bundle bundle) {
        try {
            ...
            this.f41276OooO00o.zzaA().zzk().zzb("Error returning bundle value to wrapper", e);
        }
    }
    ...
    public final void zzT(com.google.android.gms.internal.measurement.zzcf zzcfVar, byte[] bArr) {
        ...
        try {
            ...
            this.f41276OooO00o.zzaA().zzk().zzb("Error returning byte array to wrapper", e);
        }
    }
    ...
    public final void zzU(com.google.android.gms.internal.measurement.zzcf zzcfVar, int i) {
        ...
        try {
            ...
            this.f41276OooO00o.zzaA().zzk().zzb("Error returning int value to wrapper", e);
        }
    }
    ...
    public final void zzV(com.google.android.gms.internal.measurement.zzcf zzcfVar, long j) {
        ...
        try {
            ...
            this.f41276OooO00o.zzaA().zzk().zzb("Error returning long value to wrapper", e);
        }
    }
    ...
    public final void zzW(com.google.android.gms.internal.measurement.zzcf zzcfVar, String str) {
        ...
        try {
            ...
            this.f41276OooO00o.zzaA().zzk().zzb("Error returning string value to wrapper", e);
        }
    }

    public final boolean zzai(int i, boolean z) {
        Boolean bool = this.f41276OooO00o.zzt().f16066OooO0o0;
        if (zzm() < i / 1000) {
    ...
    public final int zzm() {
        if (this.f16116OooO0o == null) {
            this.f16116OooO0o = Integer.valueOf(GoogleApiAvailabilityLight.getInstance().getApkVersion(this.f41276OooO00o.zzaw()) / 1000);
        }
        return this.f16116OooO0o.intValue();
    }

    public final int zzo(int i) {
        return GoogleApiAvailabilityLight.getInstance().isGooglePlayServicesAvailable(this.f41276OooO00o.zzaw(), 12451000);
    }

    public final long zzq() {
        long andIncrement;
        long j;
        if (this.f16115OooO0Oo.get() != 0) {
            synchronized (this.f16115OooO0Oo) {
                this.f16115OooO0Oo.compareAndSet(-1L, 1L);
                andIncrement = this.f16115OooO0Oo.getAndIncrement();
            }
            return andIncrement;
        }
        synchronized (this.f16115OooO0Oo) {
            long jNextLong = new Random(System.nanoTime() ^ this.f41276OooO00o.zzax().currentTimeMillis()).nextLong();
            int i = this.f16117OooO0o0 + 1;
            this.f16117OooO0o0 = i;
            j = jNextLong + ((long) i);
        }
        return j;
    }
