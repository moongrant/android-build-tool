...
public class ProviderInstaller {
    ...
    public static final GoogleApiAvailabilityLight f16121OooO00o = GoogleApiAvailabilityLight.getInstance();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final Object f16122OooO0O0 = new Object();

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @GuardedBy("ProviderInstaller.lock")
    public static Method f16123OooO0OO = null;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @GuardedBy("ProviderInstaller.lock")
    public static Method f16124OooO0Oo = null;
    ...
    public static void OooO00o(Context context, String str) throws GooglePlayServicesNotAvailableException {
        try {
            if (f16123OooO0OO == null) {
                f16123OooO0OO = context.getClassLoader().loadClass(str).getMethod("insertProvider", Context.class);
            }
            f16123OooO0OO.invoke(null, context);
        } catch (Exception e) {
    ...
    public static void installIfNeeded(@NonNull Context context) throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException {
        ...
        f16121OooO00o.verifyGooglePlayServicesIsAvailable(context, 11925000);
        synchronized (f16122OooO0O0) {
            ...
            if (remoteContext != null) {
                try {
                    if (f16124OooO0Oo == null) {
                        Class<?> cls = Long.TYPE;
                        f16124OooO0Oo = remoteContext.getClassLoader().loadClass("com.google.android.gms.common.security.ProviderInstallerImpl").getMethod("reportRequestStats", Context.class, cls, cls);
                    }
                    f16124OooO0Oo.invoke(null, context, Long.valueOf(jElapsedRealtime), Long.valueOf(jElapsedRealtime2));
                } catch (Exception e2) {
