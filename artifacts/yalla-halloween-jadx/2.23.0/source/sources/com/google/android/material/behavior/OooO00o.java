...
public final class OooO00o implements o000OOo {
    ...
    public final boolean perform(@NonNull View view, @Nullable o000OOo.OooO00o oooO00o) {
        ...
        int i = swipeDismissBehavior.f16356OooO0o0;
        if ((i == 0 && z2) || (i == 1 && !z2)) {
            z = true;
        }
        ...
        view.setAlpha(0.0f);
        SwipeDismissBehavior.OooO0O0 oooO0O0 = swipeDismissBehavior.f16352OooO0O0;
        if (oooO0O0 != null) {
