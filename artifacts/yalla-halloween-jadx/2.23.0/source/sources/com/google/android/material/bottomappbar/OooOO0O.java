...
public final class OooOO0O extends AnimatorListenerAdapter {
    ...
    public final /* synthetic */ BottomAppBar f16417OooO0Oo;

    public OooOO0O(BottomAppBar bottomAppBar) {
        this.f16417OooO0Oo = bottomAppBar;
    }

    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
    public final void onAnimationStart(Animator animator) {
        BottomAppBar bottomAppBar = this.f16417OooO0Oo;
        bottomAppBar.f16385o00oO0O.onAnimationStart(animator);
