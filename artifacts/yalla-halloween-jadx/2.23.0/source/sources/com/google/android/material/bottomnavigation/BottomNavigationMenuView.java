...
public class BottomNavigationMenuView extends NavigationBarMenuView {
    ...
    public final int f16424Oooo0;

    /* JADX INFO: renamed from: Oooo0O0, reason: collision with root package name */
    public final int f16425Oooo0O0;

    /* JADX INFO: renamed from: Oooo0OO, reason: collision with root package name */
    public final int f16426Oooo0OO;

    /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
    public boolean f16427Oooo0o;

    /* JADX INFO: renamed from: Oooo0o0, reason: collision with root package name */
    public final int f16428Oooo0o0;

    /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
    public final ArrayList f16429Oooo0oO;

    public BottomNavigationMenuView(@NonNull Context context) {
        super(context);
        this.f16429Oooo0oO = new ArrayList();
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(-2, -2);
        layoutParams.gravity = 17;
        setLayoutParams(layoutParams);
        Resources resources = getResources();
        this.f16424Oooo0 = resources.getDimensionPixelSize(o00000O.design_bottom_navigation_item_max_width);
        this.f16425Oooo0O0 = resources.getDimensionPixelSize(o00000O.design_bottom_navigation_item_min_width);
        this.f16426Oooo0OO = resources.getDimensionPixelSize(o00000O.design_bottom_navigation_active_item_max_width);
        this.f16428Oooo0o0 = resources.getDimensionPixelSize(o00000O.design_bottom_navigation_active_item_min_width);
    }
    ...
    public final void onMeasure(int i, int i2) {
        ...
        int childCount = getChildCount();
        ArrayList arrayList = this.f16429Oooo0oO;
        arrayList.clear();
        ...
        int i5 = this.f16426Oooo0OO;
        if (zOooO0o && this.f16427Oooo0o) {
            View childAt = getChildAt(getSelectedItemPosition());
            int visibility = childAt.getVisibility();
            int iMax = this.f16428Oooo0o0;
            if (visibility != 8) {
            ...
            int iMin = Math.min(size - (this.f16425Oooo0O0 * i6), Math.min(iMax, i5));
            int i7 = size - iMin;
            int iMin2 = Math.min(i7 / (i6 != 0 ? i6 : 1), this.f16424Oooo0);
            int i8 = i7 - (i6 * iMin2);
            int iOooO00o = 0;
            while (iOooO00o < childCount) {
                ...
                iOooO00o = o0O0O00.OooO00o(i4, arrayList, iOooO00o, 1);
            }
        } else {
            ...
            while (iOooO00o2 < childCount) {
                ...
                iOooO00o2 = o0O0O00.OooO00o(i3, arrayList, iOooO00o2, 1);
            }
        }
        int measuredWidth = 0;
