...
public class ChipGroup extends FlowLayout {
    ...
    public static final int f16712OooOOO = o0000O0O.Widget_MaterialComponents_ChipGroup;

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    @Dimension
    public int f16713OooO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    @Dimension
    public int f16714OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    @Nullable
    public OooO0o f16715OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public final com.google.android.material.internal.OooO0O0<Chip> f16716OooOO0O;

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    public final int f16717OooOO0o;

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    @NonNull
    public final OooO f16718OooOOO0;
    ...
    public class OooO implements ViewGroup.OnHierarchyChangeListener {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public ViewGroup.OnHierarchyChangeListener f16719OooO0Oo;
        ...
        public final void onChildViewAdded(View view, View view2) {
            ...
            if (view == chipGroup && (view2 instanceof Chip)) {
                ...
                com.google.android.material.internal.OooO0O0<Chip> oooO0O0 = chipGroup.f16716OooOO0O;
                Chip chip = (Chip) view2;
                oooO0O0.f17203OooO00o.put(Integer.valueOf(chip.getId()), chip);
                if (chip.isChecked()) {
                    oooO0O0.OooO00o(chip);
                }
                chip.setInternalOnCheckedChangeListener(new com.google.android.material.internal.OooO00o(oooO0O0));
            }
            ViewGroup.OnHierarchyChangeListener onHierarchyChangeListener = this.f16719OooO0Oo;
        ...
        public final void onChildViewRemoved(View view, View view2) {
            ...
            if (view == chipGroup && (view2 instanceof Chip)) {
                ...
                oooO0O0.f17203OooO00o.remove(Integer.valueOf(chip.getId()));
                oooO0O0.f17204OooO0O0.remove(Integer.valueOf(chip.getId()));
            }
            ViewGroup.OnHierarchyChangeListener onHierarchyChangeListener = this.f16719OooO0Oo;
            if (onHierarchyChangeListener != null) {
    ...
    public int getCheckedChipId() {
        return this.f16716OooOO0O.OooO0OO();
    }

    @NonNull
    public List<Integer> getCheckedChipIds() {
        return this.f16716OooOO0O.OooO0O0(this);
    }

    @Dimension
    public int getChipSpacingHorizontal() {
        return this.f16714OooO0oo;
    }

    @Dimension
    public int getChipSpacingVertical() {
        return this.f16713OooO;
    }

    @Override // android.view.View
    public final void onFinishInflate() {
        super.onFinishInflate();
        int i = this.f16717OooOO0o;
        if (i != -1) {
            com.google.android.material.internal.OooO0O0<Chip> oooO0O0 = this.f16716OooOO0O;
            OooOOO0<T> oooOOO0 = (OooOOO0) oooO0O0.f17203OooO00o.get(Integer.valueOf(i));
    ...
    public final void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setCollectionInfo((AccessibilityNodeInfo.CollectionInfo) o0Oo0oo.OooO0OO.OooO00o(getRowCount(), this.f17139OooO0o ? getVisibleChipCount() : -1, this.f16716OooOO0O.f17206OooO0Oo ? 1 : 2, false).f34044OooO00o);
    }
    ...
    public void setChipSpacingHorizontal(@Dimension int i) {
        if (this.f16714OooO0oo != i) {
            this.f16714OooO0oo = i;
            setItemSpacing(i);
            requestLayout();
        }
    }
    ...
    public void setOnCheckedStateChangeListener(@Nullable OooO0o oooO0o) {
        this.f16715OooOO0 = oooO0o;
    }

    @Override // android.view.ViewGroup
    public void setOnHierarchyChangeListener(ViewGroup.OnHierarchyChangeListener onHierarchyChangeListener) {
        this.f16718OooOOO0.f16719OooO0Oo = onHierarchyChangeListener;
    }

    public void setSelectionRequired(boolean z) {
        this.f16716OooOO0O.f17207OooO0o0 = z;
    }
    ...
    public void setSingleSelection(boolean z) {
        com.google.android.material.internal.OooO0O0<Chip> oooO0O0 = this.f16716OooOO0O;
        if (oooO0O0.f17206OooO0Oo != z) {
            oooO0O0.f17206OooO0Oo = z;
            boolean z2 = !oooO0O0.f17204OooO0O0.isEmpty();
            Iterator it = oooO0O0.f17203OooO00o.values().iterator();
            while (it.hasNext()) {
    ...
    public ChipGroup(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f16716OooOO0O = oooO0O0;
        OooO oooO = new OooO();
        this.f16718OooOOO0 = oooO;
        ...
        this.f16717OooOO0o = typedArrayOooO0Oo.getResourceId(o000OO.ChipGroup_checkedChip, -1);
        typedArrayOooO0Oo.recycle();
        oooO0O0.f17205OooO0OO = new OooO00o();
