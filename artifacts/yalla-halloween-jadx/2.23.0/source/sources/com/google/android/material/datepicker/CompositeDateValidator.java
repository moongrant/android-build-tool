...
public final class CompositeDateValidator implements CalendarConstraints.DateValidator {
    ...
    @NonNull
    public final OooO0o f16820OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @NonNull
    public final List<CalendarConstraints.DateValidator> f16821OooO0o0;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public static final OooO00o f16818OooO0o = new OooO00o();

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public static final OooO0O0 f16819OooO0oO = new OooO0O0();
    ...
    public class OooO00o implements OooO0o {
        ...
        public final boolean OooO00o(long j, @NonNull List list) {
            ...
            while (it.hasNext()) {
                ...
                if (dateValidator != null && dateValidator.Oooo(j)) {
                    return true;
                }
            }
            return false;
    ...
    public class OooO0OO implements Parcelable.Creator<CompositeDateValidator> {
        ...
        public final CompositeDateValidator createFromParcel(@NonNull Parcel parcel) {
            ...
            OooO0o oooO0o = CompositeDateValidator.f16819OooO0oO;
            if (i != 2 && i == 1) {
                oooO0o = CompositeDateValidator.f16818OooO0o;
            }
            arrayList.getClass();
    ...
    public CompositeDateValidator(ArrayList arrayList, OooO0o oooO0o) {
        this.f16821OooO0o0 = arrayList;
        this.f16820OooO0Oo = oooO0o;
    }

    @Override // com.google.android.material.datepicker.CalendarConstraints.DateValidator
    public final boolean Oooo(long j) {
        return this.f16820OooO0Oo.OooO00o(j, this.f16821OooO0o0);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return this.f16821OooO0o0.equals(compositeDateValidator.f16821OooO0o0) && this.f16820OooO0Oo.getId() == compositeDateValidator.f16820OooO0Oo.getId();
    }

    public final int hashCode() {
        return this.f16821OooO0o0.hashCode();
    }

    @Override // android.os.Parcelable
    public final void writeToParcel(@NonNull Parcel parcel, int i) {
        parcel.writeList(this.f16821OooO0o0);
        parcel.writeInt(this.f16820OooO0Oo.getId());
    }
}
