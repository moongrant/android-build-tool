...
public class DateValidatorPointForward implements CalendarConstraints.DateValidator {
    ...
    public final long f16823OooO0Oo;
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof DateValidatorPointForward) && this.f16823OooO0Oo == ((DateValidatorPointForward) obj).f16823OooO0Oo;
    }

    public final int hashCode() {
        return Arrays.hashCode(new Object[]{Long.valueOf(this.f16823OooO0Oo)});
    }

    @Override // android.os.Parcelable
    public final void writeToParcel(@NonNull Parcel parcel, int i) {
        parcel.writeLong(this.f16823OooO0Oo);
    }
}
