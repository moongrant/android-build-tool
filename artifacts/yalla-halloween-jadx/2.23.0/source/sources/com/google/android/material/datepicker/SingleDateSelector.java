...
public class SingleDateSelector implements DateSelector<Long> {
    ...
    @Nullable
    public CharSequence f16927OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @Nullable
    public Long f16928OooO0o0;
    ...
    public class OooO00o implements Parcelable.Creator<SingleDateSelector> {
        ...
        public final SingleDateSelector createFromParcel(@NonNull Parcel parcel) {
            ...
            singleDateSelector.f16928OooO0o0 = (Long) parcel.readValue(Long.class.getClassLoader());
    ...
    @Override // com.google.android.material.datepicker.DateSelector
    public final int Oooo0o(Context context) {
        return b1.OooO0OO(p270o0O0000o.o00000.materialCalendarTheme, context, MaterialDatePicker.class.getCanonicalName()).data;
    }
    ...
    public final String getError() {
        if (TextUtils.isEmpty(this.f16927OooO0Oo)) {
            return null;
        }
        return this.f16927OooO0Oo.toString();
    }

    @Override // com.google.android.material.datepicker.DateSelector
    public final boolean o00000o0() {
        return this.f16928OooO0o0 != null;
    }
    ...
    public final void o0000OOO(long j) {
        this.f16928OooO0o0 = Long.valueOf(j);
    }

    @Override // com.google.android.material.datepicker.DateSelector
    @Nullable
    public final Long o0000oo() {
        return this.f16928OooO0o0;
    }
    ...
    public final View o00ooo(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, CalendarConstraints calendarConstraints, @NonNull o00oO0o.OooO00o oooO00o) {
        View viewInflate = layoutInflater.inflate(p270o0O0000o.o0000O00.mtrl_picker_text_input_date, viewGroup, false);
        TextInputLayout textInputLayout = (TextInputLayout) viewInflate.findViewById(p270o0O0000o.o0000Ooo.mtrl_picker_text_input_date);
    ...
    public final void writeToParcel(@NonNull Parcel parcel, int i) {
        parcel.writeValue(this.f16928OooO0o0);
    }
}
