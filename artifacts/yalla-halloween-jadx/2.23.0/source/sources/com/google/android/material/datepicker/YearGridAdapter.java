...
public final class YearGridAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public final OooOo00<?> f16929OooO00o;
    ...
    public YearGridAdapter(OooOo00<?> oooOo00) {
        this.f16929OooO00o = oooOo00;
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public final int getItemCount() {
        return this.f16929OooO00o.f16904OooO0oO.f16804OooO;
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public final void onBindViewHolder(@NonNull RecyclerView.o0O0O00 o0o0o00, int i) {
        ViewHolder viewHolder = (ViewHolder) o0o0o00;
        OooOo00<?> oooOo00 = this.f16929OooO00o;
        int i2 = oooOo00.f16904OooO0oO.f16805OooO0Oo.f16859OooO0o + i;
        ...
        OooO0O0 oooO0O0 = oooOo00.f16907OooOO0O;
        Calendar calendarOooO0oo = o0000.OooO0oo();
        OooO00o oooO00o = calendarOooO0oo.get(1) == i2 ? oooO0O0.f16880OooO0o : oooO0O0.f16879OooO0Oo;
        Iterator it = oooOo00.f16902OooO0o.o00000oo().iterator();
        while (it.hasNext()) {
            calendarOooO0oo.setTimeInMillis(((Long) it.next()).longValue());
            if (calendarOooO0oo.get(1) == i2) {
                oooO00o = oooO0O0.f16881OooO0o0;
            }
        }
    ...
    public final RecyclerView.o0O0O00 onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new ViewHolder((TextView) LayoutInflater.from(viewGroup.getContext()).inflate(p270o0O0000o.o0000O00.mtrl_calendar_year, viewGroup, false));
    }
}
