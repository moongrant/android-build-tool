...
public class MaterialDividerItemDecoration extends RecyclerView.OooOo {
    ...
    public static final int f16978OooO = o0000O0O.Widget_MaterialComponents_MaterialDivider;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    @NonNull
    public Drawable f16979OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final int f16980OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @ColorInt
    public int f16981OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public int f16982OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final int f16983OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final int f16984OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final boolean f16985OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final Rect f16986OooO0oo;
    ...
    public MaterialDividerItemDecoration(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.f16986OooO0oo = new Rect();
        TypedArray typedArrayOooO0Oo = o00oO0o.OooO0Oo(context, attributeSet, o000OO.MaterialDivider, i2, f16978OooO, new int[0]);
        this.f16981OooO0OO = c1.OooO00o(context, typedArrayOooO0Oo, o000OO.MaterialDivider_dividerColor).getDefaultColor();
        this.f16980OooO0O0 = typedArrayOooO0Oo.getDimensionPixelSize(o000OO.MaterialDivider_dividerThickness, context.getResources().getDimensionPixelSize(o00000O.material_divider_thickness));
        this.f16984OooO0o0 = typedArrayOooO0Oo.getDimensionPixelOffset(o000OO.MaterialDivider_dividerInsetStart, 0);
        this.f16983OooO0o = typedArrayOooO0Oo.getDimensionPixelOffset(o000OO.MaterialDivider_dividerInsetEnd, 0);
        this.f16985OooO0oO = typedArrayOooO0Oo.getBoolean(o000OO.MaterialDivider_lastItemDecorated, true);
        typedArrayOooO0Oo.recycle();
        ShapeDrawable shapeDrawable = new ShapeDrawable();
        int i3 = this.f16981OooO0OO;
        this.f16981OooO0OO = i3;
        this.f16979OooO00o = shapeDrawable;
    ...
    public final void getItemOffsets(@NonNull Rect rect, @NonNull View view, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.o0OOO0o o0ooo0o2) {
        ...
        if (OooO0Oo(recyclerView, view)) {
            int i = this.f16982OooO0Oo;
            int i2 = this.f16980OooO0O0;
            if (i == 1) {
                rect.bottom = i2;
            } else {
                rect.right = i2;
    ...
    public final void onDraw(@NonNull Canvas canvas, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.o0OOO0o o0ooo0o2) {
        ...
        int i = this.f16982OooO0Oo;
        int i2 = this.f16980OooO0O0;
        Rect rect = this.f16986OooO0oo;
        int i3 = this.f16983OooO0o;
        int i4 = this.f16984OooO0o0;
        int i5 = 0;
        if (i != 1) {
            canvas.save();
            ...
            while (i5 < childCount) {
                ...
                if (OooO0Oo(recyclerView, childAt)) {
                    ...
                    this.f16979OooO00o.setBounds(iRound - i2, i6, iRound, i7);
                    this.f16979OooO00o.draw(canvas);
                }
                i5++;
            }
            canvas.restore();
        ...
        while (i5 < childCount2) {
            ...
            if (OooO0Oo(recyclerView, childAt2)) {
                ...
                this.f16979OooO00o.setBounds(i8, iRound2 - i2, i9, iRound2);
                this.f16979OooO00o.draw(canvas);
            }
            i5++;
        }
