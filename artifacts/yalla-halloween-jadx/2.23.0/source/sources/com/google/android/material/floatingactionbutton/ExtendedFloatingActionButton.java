...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.OooO0O0 {
    ...
    public int f16992OooOo;

    /* JADX INFO: renamed from: OooOoO, reason: collision with root package name */
    @NonNull
    public final OooOO0 f16993OooOoO;

    /* JADX INFO: renamed from: OooOoO0, reason: collision with root package name */
    @NonNull
    public final OooOO0 f16994OooOoO0;

    /* JADX INFO: renamed from: OooOoOO, reason: collision with root package name */
    public final OooOOO0 f16995OooOoOO;

    /* JADX INFO: renamed from: OooOoo, reason: collision with root package name */
    public final int f16996OooOoo;

    /* JADX INFO: renamed from: OooOoo0, reason: collision with root package name */
    public final OooOO0O f16997OooOoo0;

    /* JADX INFO: renamed from: OooOooO, reason: collision with root package name */
    public int f16998OooOooO;

    /* JADX INFO: renamed from: OooOooo, reason: collision with root package name */
    public int f16999OooOooo;

    /* JADX INFO: renamed from: Oooo0, reason: collision with root package name */
    public boolean f17000Oooo0;

    /* JADX INFO: renamed from: Oooo000, reason: collision with root package name */
    @NonNull
    public final ExtendedFloatingActionButtonBehavior f17001Oooo000;

    /* JADX INFO: renamed from: Oooo00O, reason: collision with root package name */
    public boolean f17002Oooo00O;

    /* JADX INFO: renamed from: Oooo00o, reason: collision with root package name */
    public boolean f17003Oooo00o;

    /* JADX INFO: renamed from: Oooo0O0, reason: collision with root package name */
    @NonNull
    public ColorStateList f17004Oooo0O0;

    /* JADX INFO: renamed from: Oooo0OO, reason: collision with root package name */
    public int f17005Oooo0OO;

    /* JADX INFO: renamed from: Oooo0o0, reason: collision with root package name */
    public int f17006Oooo0o0;

    /* JADX INFO: renamed from: Oooo0o, reason: collision with root package name */
    public static final int f16988Oooo0o = o0000O0O.Widget_MaterialComponents_ExtendedFloatingActionButton_Icon;

    /* JADX INFO: renamed from: Oooo0oO, reason: collision with root package name */
    public static final OooO0O0 f16989Oooo0oO = new OooO0O0();

    /* JADX INFO: renamed from: Oooo0oo, reason: collision with root package name */
    public static final OooO0OO f16990Oooo0oo = new OooO0OO();

    /* JADX INFO: renamed from: Oooo, reason: collision with root package name */
    public static final OooO0o f16987Oooo = new OooO0o();

    /* JADX INFO: renamed from: OoooO00, reason: collision with root package name */
    public static final OooO f16991OoooO00 = new OooO();
    ...
    public class OooOO0 extends o0O00O.OooO0O0 {
        ...
        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final OooOOO f17012OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final boolean f17013OooO0oo;

        public OooOO0(o0O00O.OooO00o oooO00o, OooOOO oooOOO, boolean z) {
            super(ExtendedFloatingActionButton.this, oooO00o);
            this.f17012OooO0oO = oooOOO;
            this.f17013OooO0oo = z;
        }
        ...
        public final void OooO00o() {
            ...
            extendedFloatingActionButton.f17003Oooo00o = false;
            extendedFloatingActionButton.setHorizontallyScrolling(false);
            ViewGroup.LayoutParams layoutParams = extendedFloatingActionButton.getLayoutParams();
            if (layoutParams == null) {
                return;
            }
            OooOOO oooOOO = this.f17012OooO0oO;
        ...
        public final void OooO0O0() {
            ExtendedFloatingActionButton extendedFloatingActionButton = ExtendedFloatingActionButton.this;
            boolean z = this.f17013OooO0oo;
            extendedFloatingActionButton.f17002Oooo00O = z;
            ViewGroup.LayoutParams layoutParams = extendedFloatingActionButton.getLayoutParams();
            if (layoutParams == null) {
                return;
            }
            if (!z) {
                extendedFloatingActionButton.f17005Oooo0OO = layoutParams.width;
                extendedFloatingActionButton.f17006Oooo0o0 = layoutParams.height;
            }
            OooOOO oooOOO = this.f17012OooO0oO;
            layoutParams.width = oooOOO.OooO00o().width;
            layoutParams.height = oooOOO.OooO00o().height;
        ...
        public final boolean OooO0Oo() {
            ExtendedFloatingActionButton extendedFloatingActionButton = ExtendedFloatingActionButton.this;
            return this.f17013OooO0oo == extendedFloatingActionButton.f17002Oooo00O || extendedFloatingActionButton.getIcon() == null || TextUtils.isEmpty(extendedFloatingActionButton.getText());
        }

        @Override // o0O00O.OooOOO0
        public final int OooO0o() {
            return this.f17013OooO0oo ? o000000O.mtrl_extended_fab_change_size_expand_motion_spec : o000000O.mtrl_extended_fab_change_size_collapse_motion_spec;
        }

        @Override // o0O00O.OooO0O0, o0O00O.OooOOO0
        @NonNull
        public final AnimatorSet OooO0oO() {
            o0O000.OooOOO oooOOO = this.f41672OooO0o;
            if (oooOOO == null) {
                if (this.f41673OooO0o0 == null) {
                    this.f41673OooO0o0 = o0O000.OooOOO.OooO0O0(OooO0o(), this.f41668OooO00o);
                }
                oooOOO = this.f41673OooO0o0;
                oooOOO.getClass();
            }
            boolean zOooO0oO = oooOOO.OooO0oO(ViewHierarchyConstants.DIMENSION_WIDTH_KEY);
            OooOOO oooOOO2 = this.f17012OooO0oO;
            ExtendedFloatingActionButton extendedFloatingActionButton = ExtendedFloatingActionButton.this;
            if (zOooO0oO) {
        ...
        public final void onAnimationStart(Animator animator) {
            o0O00O.OooO00o oooO00o = this.f41671OooO0Oo;
            Animator animator2 = oooO00o.f41667OooO00o;
            if (animator2 != null) {
                animator2.cancel();
            }
            oooO00o.f41667OooO00o = animator;
            boolean z = this.f17013OooO0oo;
            ExtendedFloatingActionButton extendedFloatingActionButton = ExtendedFloatingActionButton.this;
            extendedFloatingActionButton.f17002Oooo00O = z;
            extendedFloatingActionButton.f17003Oooo00o = true;
    ...
    public class OooOO0O extends o0O00O.OooO0O0 {
        ...
        public final void OooO00o() {
            this.f41671OooO0Oo.f41667OooO00o = null;
            ExtendedFloatingActionButton extendedFloatingActionButton = ExtendedFloatingActionButton.this;
            extendedFloatingActionButton.f16992OooOo = 0;
            if (this.f17014OooO0oO) {
                return;
            }
        ...
        @Override // o0O00O.OooOOO0
        public final boolean OooO0Oo() {
            int i = ExtendedFloatingActionButton.f16988Oooo0o;
            ExtendedFloatingActionButton extendedFloatingActionButton = ExtendedFloatingActionButton.this;
            if (extendedFloatingActionButton.getVisibility() == 0) {
                if (extendedFloatingActionButton.f16992OooOo == 1) {
                    return true;
                }
            } else if (extendedFloatingActionButton.f16992OooOo != 2) {
                return true;
            }
            return false;
        }
        ...
        public final void onAnimationStart(Animator animator) {
            ...
            oooO00o.f41667OooO00o = animator;
            this.f17014OooO0oO = false;
            ExtendedFloatingActionButton extendedFloatingActionButton = ExtendedFloatingActionButton.this;
            extendedFloatingActionButton.setVisibility(0);
            extendedFloatingActionButton.f16992OooOo = 1;
        }
    }
    ...
    public class OooOOO0 extends o0O00O.OooO0O0 {
        ...
        public final void OooO00o() {
            this.f41671OooO0Oo.f41667OooO00o = null;
            ExtendedFloatingActionButton.this.f16992OooOo = 0;
        }
        ...
        public final boolean OooO0Oo() {
            ...
            ExtendedFloatingActionButton extendedFloatingActionButton = ExtendedFloatingActionButton.this;
            if (extendedFloatingActionButton.getVisibility() != 0) {
                if (extendedFloatingActionButton.f16992OooOo != 2) {
                    return false;
                }
            } else if (extendedFloatingActionButton.f16992OooOo == 1) {
                return false;
            }
            return true;
        }
        ...
        public final void onAnimationStart(Animator animator) {
            ...
            ExtendedFloatingActionButton extendedFloatingActionButton = ExtendedFloatingActionButton.this;
            extendedFloatingActionButton.setVisibility(0);
            extendedFloatingActionButton.f16992OooOo = 2;
        }
    }
    ...
    */
    public static void OooO0o0(ExtendedFloatingActionButton extendedFloatingActionButton, int i) {
        ...
        boolean z;
        if (i == 0) {
            oooO0O0 = extendedFloatingActionButton.f16995OooOoOO;
        } else if (i == 1) {
            oooO0O0 = extendedFloatingActionButton.f16997OooOoo0;
        } else if (i == 2) {
            oooO0O0 = extendedFloatingActionButton.f16994OooOoO0;
        } else {
            if (i != 3) {
                throw new IllegalStateException(android.support.v4.media.OooO00o.OooO00o("Unknown strategy type: ", i));
            }
            oooO0O0 = extendedFloatingActionButton.f16993OooOoO;
        }
        if (oooO0O0.OooO0Oo()) {
            return;
        }
        ...
        if (ViewCompat.OooOO0O.OooO0OO(extendedFloatingActionButton)) {
            ...
            if (!z2 && extendedFloatingActionButton.f17000Oooo0) {
        ...
        if (i == 2) {
            ...
            if (layoutParams != null) {
                ...
                extendedFloatingActionButton.f17005Oooo0OO = extendedFloatingActionButton.getWidth();
                extendedFloatingActionButton.f17006Oooo0o0 = extendedFloatingActionButton.getHeight();
            }
        }
        extendedFloatingActionButton.measure(0, 0);
        AnimatorSet animatorSetOooO0oO = oooO0O0.OooO0oO();
        animatorSetOooO0oO.addListener(new o0O00O.OooO0o(oooO0O0));
        Iterator<Animator.AnimatorListener> it = oooO0O0.f41670OooO0OO.iterator();
        while (it.hasNext()) {
    ...
    public o0O000.OooOOO getExtendMotionSpec() {
        return this.f16993OooOoO.f41672OooO0o;
    }

    @Nullable
    public o0O000.OooOOO getHideMotionSpec() {
        return this.f16997OooOoo0.f41672OooO0o;
    }

    @Nullable
    public o0O000.OooOOO getShowMotionSpec() {
        return this.f16995OooOoOO.f41672OooO0o;
    }

    @Nullable
    public o0O000.OooOOO getShrinkMotionSpec() {
        return this.f16994OooOoO0.f41672OooO0o;
    }

    @Override // com.google.android.material.button.MaterialButton, android.widget.TextView, android.view.View
    public final void onAttachedToWindow() {
        super.onAttachedToWindow();
        if (this.f17002Oooo00O && TextUtils.isEmpty(getText()) && getIcon() != null) {
            this.f17002Oooo00O = false;
            this.f16994OooOoO0.OooO0O0();
        }
    }
    ...
    public void setExtendMotionSpec(@Nullable o0O000.OooOOO oooOOO) {
        this.f16993OooOoO.f41672OooO0o = oooOOO;
    }
    ...
    public void setExtended(boolean z) {
        if (this.f17002Oooo00O == z) {
            return;
        }
        OooOO0 oooOO1 = z ? this.f16993OooOoO : this.f16994OooOoO0;
        if (oooOO1.OooO0Oo()) {
            return;
        }
        oooOO1.OooO0O0();
    ...
    public void setHideMotionSpec(@Nullable o0O000.OooOOO oooOOO) {
        this.f16997OooOoo0.f41672OooO0o = oooOOO;
    }
    ...
    public final void setPadding(int i, int i2, int i3, int i4) {
        ...
        if (!this.f17002Oooo00O || this.f17003Oooo00o) {
            return;
        }
        WeakHashMap<View, o000O0Oo> weakHashMap = ViewCompat.f5334OooO00o;
        this.f16998OooOooO = ViewCompat.OooO.OooO0o(this);
        this.f16999OooOooo = ViewCompat.OooO.OooO0o0(this);
    }
    ...
    public final void setPaddingRelative(int i, int i2, int i3, int i4) {
        ...
        this.f16998OooOooO = i;
        this.f16999OooOooo = i3;
    }

    public void setShowMotionSpec(@Nullable o0O000.OooOOO oooOOO) {
        this.f16995OooOoOO.f41672OooO0o = oooOOO;
    }
    ...
    public void setShrinkMotionSpec(@Nullable o0O000.OooOOO oooOOO) {
        this.f16994OooOoO0.f41672OooO0o = oooOOO;
    }
    ...
    public void setTextColor(int i) {
        ...
        this.f17004Oooo0O0 = getTextColors();
    }
    ...
    public static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public Rect f17007OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final boolean f17008OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final boolean f17009OooO0OO;

        public ExtendedFloatingActionButtonBehavior() {
            this.f17008OooO0O0 = false;
            this.f17009OooO0OO = true;
        }
        ...
        public final boolean OooO0oo(@NonNull CoordinatorLayout coordinatorLayout, @NonNull View view, int i) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (!(view2 instanceof AppBarLayout)) {
                    ViewGroup.LayoutParams layoutParams = view2.getLayoutParams();
                    if ((layoutParams instanceof CoordinatorLayout.OooO0o ? ((CoordinatorLayout.OooO0o) layoutParams).f5211OooO00o instanceof BottomSheetBehavior : false) && OooOo0(view2, extendedFloatingActionButton)) {
                        break;
                    }
                } else {
        ...
        public final boolean OooOo0(@NonNull View view, @NonNull ExtendedFloatingActionButton extendedFloatingActionButton) {
            ...
            boolean z = this.f17008OooO0O0;
            boolean z2 = this.f17009OooO0OO;
            if (!((z || z2) && oooO0o.f5215OooO0o == view.getId())) {
                return false;
            }
        ...
        public final boolean OooOo00(CoordinatorLayout coordinatorLayout, @NonNull AppBarLayout appBarLayout, @NonNull ExtendedFloatingActionButton extendedFloatingActionButton) {
            ...
            boolean z = this.f17008OooO0O0;
            boolean z2 = this.f17009OooO0OO;
            if (!((z || z2) && oooO0o.f5215OooO0o == appBarLayout.getId())) {
                return false;
            }
            if (this.f17007OooO00o == null) {
                this.f17007OooO00o = new Rect();
            }
            Rect rect = this.f17007OooO00o;
        ...
        public ExtendedFloatingActionButtonBehavior(@NonNull Context context, @Nullable AttributeSet attributeSet) {
            ...
            this.f17008OooO0O0 = typedArrayObtainStyledAttributes.getBoolean(o000OO.ExtendedFloatingActionButton_Behavior_Layout_behavior_autoHide, false);
            this.f17009OooO0OO = typedArrayObtainStyledAttributes.getBoolean(o000OO.ExtendedFloatingActionButton_Behavior_Layout_behavior_autoShrink, true);
    ...
    public ExtendedFloatingActionButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.f16995OooOoOO = oooOOO0;
        OooOO0O oooOO0O = new OooOO0O(oooO00o);
        this.f16997OooOoo0 = oooOO0O;
        this.f17002Oooo00O = true;
        this.f17003Oooo00o = false;
        this.f17000Oooo0 = false;
        Context context2 = getContext();
        this.f17001Oooo000 = new ExtendedFloatingActionButtonBehavior(context2, attributeSet);
        ...
        this.f16996OooOoo = typedArrayOooO0Oo.getDimensionPixelSize(o000OO.ExtendedFloatingActionButton_collapsedSize, -1);
        ...
        this.f16993OooOoO = oooOO1;
        OooOO0 oooOO2 = new OooOO0(oooO00o2, new OooO00o(), false);
        this.f16994OooOoO0 = oooOO2;
        oooOOO0.f41672OooO0o = oooOOOOooO00o;
        oooOO0O.f41672OooO0o = oooOOOOooO00o2;
        oooOO1.f41672OooO0o = oooOOOOooO00o3;
        oooOO2.f41672OooO0o = oooOOOOooO00o4;
        typedArrayOooO0Oo.recycle();
        setShapeAppearanceModel(new com.google.android.material.shape.OooO0O0(com.google.android.material.shape.OooO0O0.OooO0Oo(context2, attributeSet, i, i2, com.google.android.material.shape.OooO0O0.f17626OooOOO0)));
        this.f17004Oooo0O0 = getTextColors();
    }
