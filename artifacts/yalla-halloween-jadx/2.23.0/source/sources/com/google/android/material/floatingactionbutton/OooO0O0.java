...
public final class OooO0O0 implements ExtendedFloatingActionButton.OooOOO {
    ...
    public final /* synthetic */ ExtendedFloatingActionButton.OooOOO f17043OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final /* synthetic */ ExtendedFloatingActionButton f17044OooO0O0;

    public OooO0O0(ExtendedFloatingActionButton extendedFloatingActionButton, OooO00o oooO00o) {
        this.f17044OooO0O0 = extendedFloatingActionButton;
        this.f17043OooO00o = oooO00o;
    }
    ...
    public final ViewGroup.LayoutParams OooO00o() {
        int i = this.f17044OooO0O0.f17006Oooo0o0;
        if (i == 0) {
            i = -2;
        }
    ...
    public final int getHeight() {
        ...
        ExtendedFloatingActionButton extendedFloatingActionButton = this.f17044OooO0O0;
        int i = extendedFloatingActionButton.f17006Oooo0o0;
        ExtendedFloatingActionButton.OooOOO oooOOO = this.f17043OooO00o;
        if (i != -1) {
    ...
    public final int getPaddingEnd() {
        return this.f17044OooO0O0.f16999OooOooo;
    }

    @Override // com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.OooOOO
    public final int getPaddingStart() {
        return this.f17044OooO0O0.f16998OooOooO;
    }
