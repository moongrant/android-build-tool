...
public class FlowLayout extends ViewGroup {
    ...
    public int f17138OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public boolean f17139OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public int f17140OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public int f17141OooO0oO;
    ...
    public final void OooO0O0(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.f17138OooO0Oo = typedArrayObtainStyledAttributes.getDimensionPixelSize(o000OO.FlowLayout_lineSpacing, 0);
        this.f17140OooO0o0 = typedArrayObtainStyledAttributes.getDimensionPixelSize(o000OO.FlowLayout_itemSpacing, 0);
        typedArrayObtainStyledAttributes.recycle();
    }

    public int getItemSpacing() {
        return this.f17140OooO0o0;
    }

    public int getLineSpacing() {
        return this.f17138OooO0Oo;
    }

    public int getRowCount() {
        return this.f17141OooO0oO;
    }
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int iOooO0OO;
        if (getChildCount() == 0) {
            this.f17141OooO0oO = 0;
            return;
        }
        this.f17141OooO0oO = 1;
        ...
        for (int i7 = 0; i7 < getChildCount(); i7++) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (!this.f17139OooO0o && measuredWidth2 > i5) {
                    i6 = this.f17138OooO0Oo + paddingTop;
                    this.f17141OooO0oO++;
                    measuredWidth = paddingRight;
                }
                childAt.setTag(o0000Ooo.row_index_key, Integer.valueOf(this.f17141OooO0oO - 1));
                ...
                measuredWidth += childAt.getMeasuredWidth() + iOooO0OO + iOooO0O0 + this.f17140OooO0o0;
        ...
        for (int i9 = 0; i9 < getChildCount(); i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (childAt.getMeasuredWidth() + paddingLeft + i5 > paddingRight && !OooO00o()) {
                    ...
                    i7 = this.f17138OooO0Oo + paddingTop;
                }
                ...
                int measuredWidth2 = childAt.getMeasuredWidth() + i5 + i4 + this.f17140OooO0o0 + paddingLeft;
    ...
    public void setItemSpacing(int i) {
        this.f17140OooO0o0 = i;
    }

    public void setLineSpacing(int i) {
        this.f17138OooO0Oo = i;
    }
