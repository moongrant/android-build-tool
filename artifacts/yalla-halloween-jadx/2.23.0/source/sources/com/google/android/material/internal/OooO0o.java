...
public final class OooO0o {
    ...
    public static final ThreadLocal<Matrix> f17279OooO00o = new ThreadLocal<>();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final ThreadLocal<RectF> f17280OooO0O0 = new ThreadLocal<>();
    ...
    public static void OooO0OO(@NonNull ViewGroup viewGroup, @NonNull View view, @NonNull Rect rect) {
        ThreadLocal<Matrix> threadLocal = f17279OooO00o;
        ...
        ThreadLocal<RectF> threadLocal2 = f17280OooO0O0;
