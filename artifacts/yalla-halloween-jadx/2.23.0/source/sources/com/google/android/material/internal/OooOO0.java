...
public final class OooOO0 implements ValueAnimator.AnimatorUpdateListener {
    ...
    @Nullable
    public final View f17281OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final float[] f17282OooO0o = new float[2];

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @Nullable
    public final View f17283OooO0o0;

    public OooOO0(@Nullable ActionMenuView actionMenuView, @Nullable ActionMenuView actionMenuView2) {
        this.f17281OooO0Oo = actionMenuView;
        this.f17283OooO0o0 = actionMenuView2;
    }

    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
    public final void onAnimationUpdate(@NonNull ValueAnimator valueAnimator) {
        float fFloatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        float[] fArr = this.f17282OooO0o;
        if (fFloatValue <= 0.5f) {
        ...
        View view = this.f17281OooO0Oo;
        if (view != null) {
            view.setAlpha(fArr[0]);
        }
        View view2 = this.f17283OooO0o0;
        if (view2 != null) {
