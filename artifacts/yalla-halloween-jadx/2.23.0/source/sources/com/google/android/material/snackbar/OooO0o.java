...
public final class OooO0o implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final /* synthetic */ BaseTransientBottomBar f17829OooO0Oo;

    public OooO0o(BaseTransientBottomBar baseTransientBottomBar) {
        this.f17829OooO0Oo = baseTransientBottomBar;
    }
    ...
    public final void onAnimationUpdate(@NonNull ValueAnimator valueAnimator) {
        ...
        this.f17829OooO0Oo.f17789OooO.setTranslationY(iIntValue);
    }
}
