...
import p279o0O00o0o.o00Oo0;

/* JADX INFO: loaded from: classes3.dex */
public final class Snackbar extends BaseTransientBottomBar<Snackbar> {

    /* JADX INFO: renamed from: OooOoo, reason: collision with root package name */
    public static final int[] f17840OooOoo = {o00000.snackbarButtonStyle, o00000.snackbarTextViewStyle};

    /* JADX INFO: renamed from: OooOoOO, reason: collision with root package name */
    @Nullable
    public final AccessibilityManager f17841OooOoOO;

    /* JADX INFO: renamed from: OooOoo0, reason: collision with root package name */
    public boolean f17842OooOoo0;
    ...
    public Snackbar(@NonNull Context context, @NonNull ViewGroup viewGroup, @NonNull SnackbarContentLayout snackbarContentLayout, @NonNull SnackbarContentLayout snackbarContentLayout2) {
        ...
        this.f17841OooOoOO = (AccessibilityManager) viewGroup.getContext().getSystemService("accessibility");
    }
    ...
    public static Snackbar OooO0oo(@NonNull ViewGroup viewGroup, @StringRes int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(f17840OooOoo);
        ...
        ((SnackbarContentLayout) snackbar.f17789OooO.getChildAt(0)).getMessageView().setText(text);
        snackbar.f17799OooOO0O = 0;
        return snackbar;
    }

    @NonNull
    @CanIgnoreReturnValue
    public final void OooO(@StringRes int i, View.OnClickListener onClickListener) {
        CharSequence text = this.f17797OooO0oo.getText(i);
        Button actionView = ((SnackbarContentLayout) this.f17789OooO.getChildAt(0)).getActionView();
        if (TextUtils.isEmpty(text)) {
            actionView.setVisibility(8);
            actionView.setOnClickListener(null);
            this.f17842OooOoo0 = false;
        } else {
            this.f17842OooOoo0 = true;
            actionView.setVisibility(0);
            actionView.setText(text);
            actionView.setOnClickListener(new o00Oo0(0, this, onClickListener));
        }
    }
    ...
    public final int OooO0oO() {
        int i = this.f17799OooOO0O;
        if (i == -2) {
            return -2;
        }
        int i2 = Build.VERSION.SDK_INT;
        AccessibilityManager accessibilityManager = this.f17841OooOoOO;
        if (i2 >= 29) {
            return accessibilityManager.getRecommendedTimeoutMillis(i, (this.f17842OooOoo0 ? 4 : 0) | 1 | 2);
        }
        if (this.f17842OooOoo0 && accessibilityManager.isTouchExplorationEnabled()) {
            return -2;
        }
        return i;
    }
    ...
    public final void OooOO0() {
        ...
        BaseTransientBottomBar.OooO0OO oooO0OO = this.f17808OooOo00;
        synchronized (oooOO0OOooO0O0.f17832OooO00o) {
            if (oooOO0OOooO0O0.OooO0OO(oooO0OO)) {
                ...
                oooO0OO2.f17838OooO0O0 = iOooO0oO;
                oooOO0OOooO0O0.f17833OooO0O0.removeCallbacksAndMessages(oooO0OO2);
                oooOO0OOooO0O0.OooO0o(oooOO0OOooO0O0.f17834OooO0OO);
                return;
            }
            OooOO0O.OooO0OO oooO0OO3 = oooOO0OOooO0O0.f17835OooO0Oo;
            boolean z = false;
            if (oooO0OO3 != null) {
                if (oooO0OO != null && oooO0OO3.f17837OooO00o.get() == oooO0OO) {
                    z = true;
                }
            }
            if (z) {
                oooOO0OOooO0O0.f17835OooO0Oo.f17838OooO0O0 = iOooO0oO;
            } else {
                oooOO0OOooO0O0.f17835OooO0Oo = new OooOO0O.OooO0OO(iOooO0oO, oooO0OO);
            }
            OooOO0O.OooO0OO oooO0OO4 = oooOO0OOooO0O0.f17834OooO0OO;
            if (oooO0OO4 == null || !oooOO0OOooO0O0.OooO00o(oooO0OO4, 4)) {
                oooOO0OOooO0O0.f17834OooO0OO = null;
                OooOO0O.OooO0OO oooO0OO5 = oooOO0OOooO0O0.f17835OooO0Oo;
                if (oooO0OO5 != null) {
                    oooOO0OOooO0O0.f17834OooO0OO = oooO0OO5;
                    oooOO0OOooO0O0.f17835OooO0Oo = null;
                    OooOO0O.OooO0O0 oooO0O0 = oooO0OO5.f17837OooO00o.get();
                    if (oooO0O0 != null) {
                        oooO0O0.show();
                    } else {
                        oooOO0OOooO0O0.f17834OooO0OO = null;
