...
public class SnackbarContentLayout extends LinearLayout implements o0OoOo0 {
    ...
    public TextView f17843OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final TimeInterpolator f17844OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public Button f17845OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public int f17846OooO0oO;
    ...
    public final boolean OooO00o(int i, int i2, int i3) {
        ...
        if (this.f17843OooO0Oo.getPaddingTop() == i2 && this.f17843OooO0Oo.getPaddingBottom() == i3) {
            return z;
        }
        TextView textView = this.f17843OooO0Oo;
    ...
    public Button getActionView() {
        return this.f17845OooO0o0;
    }

    public TextView getMessageView() {
        return this.f17843OooO0Oo;
    }

    @Override // android.view.View
    public final void onFinishInflate() {
        super.onFinishInflate();
        this.f17843OooO0Oo = (TextView) findViewById(o0000Ooo.snackbar_text);
        this.f17845OooO0o0 = (Button) findViewById(o0000Ooo.snackbar_action);
    }
    ...
    public final void onMeasure(int i, int i2) {
        ...
        Layout layout = this.f17843OooO0Oo.getLayout();
        boolean z2 = layout != null && layout.getLineCount() > 1;
        if (!z2 || this.f17846OooO0oO <= 0 || this.f17845OooO0o0.getMeasuredWidth() <= this.f17846OooO0oO) {
            if (!z2) {
    ...
    public void setMaxInlineActionWidth(int i) {
        this.f17846OooO0oO = i;
    }

    public SnackbarContentLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        super(context, attributeSet);
        this.f17844OooO0o = o0O00OO.OooO00o.OooO0Oo(context, o00000.motionEasingEmphasizedInterpolator, o0O000.OooO0O0.f41572OooO0O0);
    }
}
