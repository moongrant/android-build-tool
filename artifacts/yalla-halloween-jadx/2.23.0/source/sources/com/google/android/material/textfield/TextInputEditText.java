...
public class TextInputEditText extends AppCompatEditText {
    ...
    public final Rect f17978OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public boolean f17979OooOO0O;
    ...
    public final void getFocusedRect(@Nullable Rect rect) {
        ...
        TextInputLayout textInputLayout = getTextInputLayout();
        if (!(textInputLayout != null && this.f17979OooOO0O) || rect == null) {
            return;
        }
        Rect rect2 = this.f17978OooOO0;
    ...
    public final boolean getGlobalVisibleRect(@Nullable Rect rect, @Nullable Point point) {
        TextInputLayout textInputLayout = getTextInputLayout();
        return textInputLayout != null && this.f17979OooOO0O ? textInputLayout.getGlobalVisibleRect(rect, point) : super.getGlobalVisibleRect(rect, point);
    }
    ...
    public CharSequence getHint() {
        TextInputLayout textInputLayout = getTextInputLayout();
        return (textInputLayout == null || !textInputLayout.f18012Oooo000) ? super.getHint() : textInputLayout.getHint();
    }
    ...
    public final void onAttachedToWindow() {
        ...
        TextInputLayout textInputLayout = getTextInputLayout();
        if (textInputLayout != null && textInputLayout.f18012Oooo000 && super.getHint() == null && Build.MANUFACTURER.toLowerCase(Locale.ENGLISH).equals("meizu")) {
            setHint("");
        }
    }
