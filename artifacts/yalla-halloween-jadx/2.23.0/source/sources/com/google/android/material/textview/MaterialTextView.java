...
public class MaterialTextView extends AppCompatTextView {
    ...
    public final void OooOO0o(@NonNull Resources.Theme theme, int i) {
        ...
        for (int i2 = 0; i2 < 2 && iOooO0OO < 0; i2++) {
            iOooO0OO = c1.OooO0OO(context, typedArrayObtainStyledAttributes, iArr[i2], -1);
        }
    ...
    public final void OooOOO0(@Nullable AttributeSet attributeSet, int i, int i2) {
        Context context = getContext();
        if (b1.OooO0O0(context, o00000.textAppearanceLineHeightEnabled, true)) {
            ...
            for (int i3 = 0; i3 < 2 && iOooO0OO < 0; i3++) {
                iOooO0OO = c1.OooO0OO(context, typedArrayObtainStyledAttributes, iArr2[i3], -1);
            }
            typedArrayObtainStyledAttributes.recycle();
            if (iOooO0OO != -1) {
                return;
