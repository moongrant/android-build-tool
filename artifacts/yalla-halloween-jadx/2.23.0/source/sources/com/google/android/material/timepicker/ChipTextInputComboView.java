...
class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public final Chip f18160OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final EditText f18161OooO0o0;
    ...
    public class OooO00o extends oo000o {
        ...
        public final void afterTextChanged(Editable editable) {
            ...
            if (zIsEmpty) {
                chipTextInputComboView.f18160OooO0Oo.setText(ChipTextInputComboView.OooO00o(chipTextInputComboView, "00"));
                return;
            }
            String strOooO00o = ChipTextInputComboView.OooO00o(chipTextInputComboView, editable);
            Chip chip = chipTextInputComboView.f18160OooO0Oo;
    ...
    public final boolean isChecked() {
        return this.f18160OooO0Oo.isChecked();
    }
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            this.f18161OooO0o0.setImeHintLocales(getContext().getResources().getConfiguration().getLocales());
        }
    }

    @Override // android.widget.Checkable
    public final void setChecked(boolean z) {
        Chip chip = this.f18160OooO0Oo;
        chip.setChecked(z);
        int i = z ? 0 : 4;
        EditText editText = this.f18161OooO0o0;
    ...
    public final void setOnClickListener(@Nullable View.OnClickListener onClickListener) {
        this.f18160OooO0Oo.setOnClickListener(onClickListener);
    }

    @Override // android.view.View
    public final void setTag(int i, Object obj) {
        this.f18160OooO0Oo.setTag(i, obj);
    }

    @Override // android.widget.Checkable
    public final void toggle() {
        this.f18160OooO0Oo.toggle();
    }
