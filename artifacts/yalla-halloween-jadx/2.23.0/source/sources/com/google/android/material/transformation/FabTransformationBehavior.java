...
import com.android.billingclient.api.o0000oo;
...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    public final Rect f18213OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final RectF f18214OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final int[] f18215OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final RectF f18216OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public float f18217OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public float f18218OooO0oo;

    public class OooO00o extends AnimatorListenerAdapter {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ boolean f18219OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ View f18220OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ View f18221OooO0o0;

        public OooO00o(boolean z, View view, View view2) {
            this.f18219OooO0Oo = z;
            this.f18221OooO0o0 = view;
            this.f18220OooO0o = view2;
        }

        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        public final void onAnimationEnd(Animator animator) {
            if (this.f18219OooO0Oo) {
                return;
            }
            this.f18221OooO0o0.setVisibility(4);
            View view = this.f18220OooO0o;
            view.setAlpha(1.0f);
        ...
        public final void onAnimationStart(Animator animator) {
            if (this.f18219OooO0Oo) {
                this.f18221OooO0o0.setVisibility(0);
                View view = this.f18220OooO0o;
                view.setAlpha(0.0f);
    ...
    public static class OooO0O0 {
        ...
        @Nullable
        public OooOOO f18222OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public OooOo00 f18223OooO0O0;
    }

    public FabTransformationBehavior() {
        this.f18213OooO0OO = new Rect();
        this.f18214OooO0Oo = new RectF();
        this.f18216OooO0o0 = new RectF();
        this.f18215OooO0o = new int[2];
    }
    ...
    public static Pair OooOo0O(float f, float f2, boolean z, @NonNull OooO0O0 oooO0O0) {
        ...
        if (f == 0.0f || f2 == 0.0f) {
            oooOOOOOooO0o = oooO0O0.f18222OooO00o.OooO0o("translationXLinear");
            oooOOOOOooO0o2 = oooO0O0.f18222OooO00o.OooO0o("translationYLinear");
        } else if ((!z || f2 >= 0.0f) && (z || f2 <= 0.0f)) {
            oooOOOOOooO0o = oooO0O0.f18222OooO00o.OooO0o("translationXCurveDownwards");
            oooOOOOOooO0o2 = oooO0O0.f18222OooO00o.OooO0o("translationYCurveDownwards");
        } else {
            oooOOOOOooO0o = oooO0O0.f18222OooO00o.OooO0o("translationXCurveUpwards");
            oooOOOOOooO0o2 = oooO0O0.f18222OooO00o.OooO0o("translationYCurveUpwards");
        }
    ...
    public static float OooOoO0(@NonNull OooO0O0 oooO0O0, @NonNull OooOOOO oooOOOO, float f) {
        long j = oooOOOO.f41584OooO00o;
        OooOOOO oooOOOOOooO0o = oooO0O0.f18222OooO00o.OooO0o("expansion");
        float interpolation = oooOOOO.OooO0O0().getInterpolation((((oooOOOOOooO0o.f41584OooO00o + oooOOOOOooO0o.f41585OooO0O0) + 17) - j) / oooOOOO.f41585OooO0O0);
    ...
    public final float OooOo(@NonNull View view, @NonNull View view2, @NonNull OooOo00 oooOo00) {
        RectF rectF = this.f18214OooO0Oo;
        RectF rectF2 = this.f18216OooO0o0;
        OooOoO(view, rectF);
        rectF.offset(this.f18217OooO0oO, this.f18218OooO0oo);
        OooOoO(view2, rectF2);
        oooOo00.getClass();
    ...
    public final AnimatorSet OooOo0(@NonNull View view, @NonNull View view2, boolean z, boolean z2) {
        ...
        if (z) {
            this.f18217OooO0oO = view.getTranslationX();
            this.f18218OooO0oo = view.getTranslationY();
        }
        ...
        oooO0O0OooOoOO.f18222OooO00o.OooO0o("elevation").OooO00o(objectAnimatorOfFloat);
        arrayList4.add(objectAnimatorOfFloat);
        RectF rectF = this.f18214OooO0Oo;
        float fOooOo0o = OooOo0o(view, view2, oooO0O0OooOoOO.f18223OooO0O0);
        float fOooOo = OooOo(view, view2, oooO0O0OooOoOO.f18223OooO0O0);
        ...
        float fOooOo0o2 = OooOo0o(view, view2, oooO0O0OooOoOO.f18223OooO0O0);
        float fOooOo2 = OooOo(view, view2, oooO0O0OooOoOO.f18223OooO0O0);
        ...
        if (z4 && (view instanceof ImageView)) {
            ...
            if (drawable == null) {
                ...
                if (z) {
                    ...
                    objectAnimatorOfInt2 = ObjectAnimator.ofInt(drawable, OooOO0.f41577OooO00o, 0);
                } else {
                    objectAnimatorOfInt2 = ObjectAnimator.ofInt(drawable, OooOO0.f41577OooO00o, 255);
                }
                objectAnimatorOfInt2.addUpdateListener(new com.google.android.material.transformation.OooO00o(view2));
                oooO0O0OooOoOO.f18222OooO00o.OooO0o("iconFade").OooO00o(objectAnimatorOfInt2);
        ...
        if (z4) {
            ...
            OooOo00 oooOo00 = oooO0O0OooOoOO.f18223OooO0O0;
            OooOoO(view, rectF);
            rectF.offset(this.f18217OooO0oO, this.f18218OooO0oo);
            OooOoO(view2, rectF2);
            rectF2.offset(-OooOo0o(view, view2, oooOo00), 0.0f);
            float fCenterX = rectF.centerX() - rectF2.left;
            OooOo00 oooOo01 = oooO0O0OooOoOO.f18223OooO0O0;
            OooOoO(view, rectF);
            rectF.offset(this.f18217OooO0oO, this.f18218OooO0oo);
            OooOoO(view2, rectF2);
            ...
            OooOOOO oooOOOOOooO0o = oooO0O0OooOoOO.f18222OooO00o.OooO0o("expansion");
            if (z) {
                if (!z2) {
                    oooO0O4.setRevealInfo(new com.google.android.material.circularreveal.OooO0O0.OooO0o(fCenterX, fCenterY, fWidth2));
                }
                if (z2) {
                    fWidth2 = oooO0O4.getRevealInfo().f16801OooO0OO;
                }
                animatorSetOooO00o = com.google.android.material.circularreveal.OooO00o.OooO00o(oooO0O4, fCenterX, fCenterY, o0000oo.OooO00o(fCenterX, fCenterY, fWidth, fHeight));
                animatorSetOooO00o.addListener(new OooO0OO(oooO0O4));
                long j = oooOOOOOooO0o.f41584OooO00o;
                int i2 = (int) fCenterX;
                int i3 = (int) fCenterY;
                if (j > 0) {
                ...
                float f = oooO0O4.getRevealInfo().f16801OooO0OO;
                ...
                long j2 = oooOOOOOooO0o.f41584OooO00o;
                int i4 = (int) fCenterX;
                int i5 = (int) fCenterY;
                ...
                Oooo000<String, OooOOOO> oooo000 = oooO0O0OooOoOO.f18222OooO00o.f41579OooO00o;
                int i6 = oooo000.f38816OooO0o;
                int i7 = 0;
                while (i7 < i6) {
                    Oooo000<String, OooOOOO> oooo001 = oooo000;
                    OooOOOO oooOOOOOooOO0o = oooo000.OooOO0o(i7);
                    jMax = Math.max(jMax, oooOOOOOooOO0o.f41584OooO00o + oooOOOOOooOO0o.f41585OooO0O0);
                    i7++;
                ...
                long j3 = oooOOOOOooO0o.f41584OooO00o + oooOOOOOooO0o.f41585OooO0O0;
                if (j3 < jMax) {
        ...
        if (z4) {
            ...
            if (z3) {
                ...
                objectAnimatorOfInt = ObjectAnimator.ofInt(oooO0O5, com.google.android.material.circularreveal.OooO0O0.OooO0OO.f16798OooO00o, i8);
            } else {
                objectAnimatorOfInt = ObjectAnimator.ofInt(oooO0O5, com.google.android.material.circularreveal.OooO0O0.OooO0OO.f16798OooO00o, colorForState);
            }
            objectAnimatorOfInt.setEvaluator(o0O000.OooO0o.f41576OooO00o);
            oooO0O1 = oooO0O0;
            oooO0O1.f18222OooO00o.OooO0o("color").OooO00o(objectAnimatorOfInt);
        ...
        if (z5) {
            ...
            if (viewGroup == null) {
                ...
                if (z3) {
                    if (!z2) {
                        OooO.f41570OooO00o.set(viewGroup, Float.valueOf(0.0f));
                    }
                    i = 0;
                    objectAnimatorOfFloat4 = ObjectAnimator.ofFloat(viewGroup, OooO.f41570OooO00o, 1.0f);
                } else {
                    i = 0;
                    objectAnimatorOfFloat4 = ObjectAnimator.ofFloat(viewGroup, OooO.f41570OooO00o, 0.0f);
                }
                oooO0O1.f18222OooO00o.OooO0o("contentFade").OooO00o(objectAnimatorOfFloat4);
