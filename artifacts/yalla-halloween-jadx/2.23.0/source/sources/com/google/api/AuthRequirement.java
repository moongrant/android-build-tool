...
public final class AuthRequirement extends GeneratedMessageV3 implements MessageOrBuilder {
    ...
    public static final AuthRequirement f18255OooO0oO = new AuthRequirement();

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public static final OooO00o f18256OooO0oo = new OooO00o();

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public volatile Object f18257OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public byte f18258OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public volatile Object f18259OooO0o0;
    ...
    public static final class OooO0O0 extends GeneratedMessageV3.Builder<OooO0O0> implements MessageOrBuilder {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public Object f18260OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public Object f18261OooO0o0;

        public OooO0O0() {
            this.f18260OooO0Oo = "";
            this.f18261OooO0o0 = "";
            AuthRequirement authRequirement = AuthRequirement.f18255OooO0oO;
        }
        ...
        public final AuthRequirement buildPartial() {
            ...
            authRequirement.f18257OooO0Oo = this.f18260OooO0Oo;
            authRequirement.f18259OooO0o0 = this.f18261OooO0o0;
            onBuilt();
        ...
        public final void OooO0o(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws Throwable {
            ...
            try {
                try {
                    AuthRequirement.f18256OooO0oo.getClass();
        ...
        public final void OooO0o0(AuthRequirement authRequirement) {
            if (authRequirement == AuthRequirement.f18255OooO0oO) {
                return;
            }
            if (!authRequirement.OooO0OO().isEmpty()) {
                this.f18260OooO0Oo = authRequirement.f18257OooO0Oo;
                onChanged();
            }
            if (!authRequirement.OooO0O0().isEmpty()) {
                this.f18261OooO0o0 = authRequirement.f18259OooO0o0;
                onChanged();
            }
            onChanged();
        }
        ...
        public final Message getDefaultInstanceForType() {
            return AuthRequirement.f18255OooO0oO;
        }

        @Override // com.google.protobuf.GeneratedMessageV3.Builder, com.google.protobuf.Message.Builder, com.google.protobuf.MessageOrBuilder
        public final Descriptors.Descriptor getDescriptorForType() {
            return o000O00O.f42720OooOO0O;
        }

        @Override // com.google.protobuf.GeneratedMessageV3.Builder
        public final GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return o000O00O.f42721OooOO0o.ensureFieldAccessorsInitialized(AuthRequirement.class, OooO0O0.class);
        }
    ...
    public AuthRequirement(GeneratedMessageV3.Builder<?> builder) {
        super(builder);
        this.f18258OooO0o = (byte) -1;
    }

    public final String OooO0O0() {
        Object obj = this.f18259OooO0o0;
        if (obj instanceof String) {
            return (String) obj;
        }
        String stringUtf8 = ((ByteString) obj).toStringUtf8();
        this.f18259OooO0o0 = stringUtf8;
        return stringUtf8;
    }

    public final String OooO0OO() {
        Object obj = this.f18257OooO0Oo;
        if (obj instanceof String) {
            return (String) obj;
        }
        String stringUtf8 = ((ByteString) obj).toStringUtf8();
        this.f18257OooO0Oo = stringUtf8;
        return stringUtf8;
    }
    ...
    public final int getSerializedSize() {
        ...
        int iComputeStringSize = GeneratedMessageV3.isStringEmpty(this.f18257OooO0Oo) ? 0 : 0 + GeneratedMessageV3.computeStringSize(1, this.f18257OooO0Oo);
        if (!GeneratedMessageV3.isStringEmpty(this.f18259OooO0o0)) {
            iComputeStringSize += GeneratedMessageV3.computeStringSize(2, this.f18259OooO0o0);
        }
    ...
    public final int hashCode() {
        ...
        int iHashCode = this.unknownFields.hashCode() + ((OooO0O0().hashCode() + ((((OooO0OO().hashCode() + o000Oo0.OooO00o(o000O00O.f42720OooOO0O, 779, 37, 1, 53)) * 37) + 2) * 53)) * 29);
    ...
    public final Message.Builder newBuilderForType() {
        return f18255OooO0oO.toBuilder();
    }
    ...
    public final void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        if (!GeneratedMessageV3.isStringEmpty(this.f18257OooO0Oo)) {
            GeneratedMessageV3.writeString(codedOutputStream, 1, this.f18257OooO0Oo);
        }
        if (!GeneratedMessageV3.isStringEmpty(this.f18259OooO0o0)) {
            GeneratedMessageV3.writeString(codedOutputStream, 2, this.f18259OooO0o0);
        }
            ...
            try {
                try {
                    try {
                        ...
                        if (tag != 0) {
                            if (tag == 10) {
                                this.f18257OooO0Oo = codedInputStream.readStringRequireUtf8();
                            } else if (tag != 18) {
                                if (!parseUnknownField(codedInputStream, builderNewBuilder, extensionRegistryLite, tag)) {
                                }
                            } else {
                                this.f18259OooO0o0 = codedInputStream.readStringRequireUtf8();
                            }
                        }
                        z = true;
                    } catch (InvalidProtocolBufferException e) {
