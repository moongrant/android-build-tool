...
public final class ServiceAccountDelegationInfo extends GeneratedMessageV3 implements MessageOrBuilder {
    ...
    public int f18996OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public volatile Object f18997OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public Object f18998OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public byte f18999OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public static final ServiceAccountDelegationInfo f18995OooO0oo = new ServiceAccountDelegationInfo();

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    public static final OooO00o f18994OooO = new OooO00o();
    ...
    public static final class FirstPartyPrincipal extends GeneratedMessageV3 implements MessageOrBuilder {
        ...
        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public static final FirstPartyPrincipal f19000OooO0oO = new FirstPartyPrincipal();

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public static final OooO00o f19001OooO0oo = new OooO00o();

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public volatile Object f19002OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public byte f19003OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public Struct f19004OooO0o0;
        ...
        public static final class OooO0O0 extends GeneratedMessageV3.Builder<OooO0O0> implements MessageOrBuilder {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public Object f19005OooO0Oo;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public Struct f19006OooO0o0;

            public OooO0O0() {
                this.f19005OooO0Oo = "";
                FirstPartyPrincipal firstPartyPrincipal = FirstPartyPrincipal.f19000OooO0oO;
            }
            ...
            public final FirstPartyPrincipal buildPartial() {
                ...
                firstPartyPrincipal.f19002OooO0Oo = this.f19005OooO0Oo;
                firstPartyPrincipal.f19004OooO0o0 = this.f19006OooO0o0;
                onBuilt();
            ...
            public final void OooO0Oo() {
                super.clear();
                this.f19005OooO0Oo = "";
                this.f19006OooO0o0 = null;
            }

            public final void OooO0o(FirstPartyPrincipal firstPartyPrincipal) {
                if (firstPartyPrincipal == FirstPartyPrincipal.f19000OooO0oO) {
                    return;
                }
                if (!firstPartyPrincipal.OooO0O0().isEmpty()) {
                    this.f19005OooO0Oo = firstPartyPrincipal.f19002OooO0Oo;
                    onChanged();
                }
                if (firstPartyPrincipal.f19004OooO0o0 != null) {
                    Struct structOooO0OO = firstPartyPrincipal.OooO0OO();
                    Struct struct = this.f19006OooO0o0;
                    if (struct != null) {
                        this.f19006OooO0o0 = Struct.newBuilder(struct).mergeFrom(structOooO0OO).buildPartial();
                    } else {
                        this.f19006OooO0o0 = structOooO0OO;
                    }
                    onChanged();
                }
                onChanged();
            ...
            public final void OooO0oO(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws Throwable {
                ...
                try {
                    try {
                        FirstPartyPrincipal.f19001OooO0oo.getClass();
            ...
            public final Message getDefaultInstanceForType() {
                return FirstPartyPrincipal.f19000OooO0oO;
            }

            @Override // com.google.protobuf.GeneratedMessageV3.Builder, com.google.protobuf.Message.Builder, com.google.protobuf.MessageOrBuilder
            public final Descriptors.Descriptor getDescriptorForType() {
                return o0O0O0o0.OooO00o.f41937OooOOO0;
            }

            @Override // com.google.protobuf.GeneratedMessageV3.Builder
            public final GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
                return o0O0O0o0.OooO00o.f41936OooOOO.ensureFieldAccessorsInitialized(FirstPartyPrincipal.class, OooO0O0.class);
            }
        ...
        public FirstPartyPrincipal(GeneratedMessageV3.Builder<?> builder) {
            super(builder);
            this.f19003OooO0o = (byte) -1;
        }

        public final String OooO0O0() {
            Object obj = this.f19002OooO0Oo;
            if (obj instanceof String) {
                return (String) obj;
            }
            String stringUtf8 = ((ByteString) obj).toStringUtf8();
            this.f19002OooO0Oo = stringUtf8;
            return stringUtf8;
        }

        public final Struct OooO0OO() {
            Struct struct = this.f19004OooO0o0;
        ...
        public final boolean equals(Object obj) {
            ...
            Struct struct = this.f19004OooO0o0;
            if ((struct != null) != (firstPartyPrincipal.f19004OooO0o0 != null)) {
                return false;
            }
        ...
        public final int getSerializedSize() {
            ...
            int iComputeStringSize = GeneratedMessageV3.isStringEmpty(this.f19002OooO0Oo) ? 0 : 0 + GeneratedMessageV3.computeStringSize(1, this.f19002OooO0Oo);
            if (this.f19004OooO0o0 != null) {
        ...
        public final int hashCode() {
            ...
            int iHashCode = OooO0O0().hashCode() + o000Oo0.OooO00o(o0O0O0o0.OooO00o.f41937OooOOO0, 779, 37, 1, 53);
            if (this.f19004OooO0o0 != null) {
        ...
        public final Message.Builder newBuilderForType() {
            return f19000OooO0oO.toBuilder();
        }
        ...
        public final void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            if (!GeneratedMessageV3.isStringEmpty(this.f19002OooO0Oo)) {
                GeneratedMessageV3.writeString(codedOutputStream, 1, this.f19002OooO0Oo);
            }
            if (this.f19004OooO0o0 != null) {
            ...
            while (!z) {
                try {
                    try {
                        ...
                        if (tag != 0) {
                            if (tag == 10) {
                                this.f19002OooO0Oo = codedInputStream.readStringRequireUtf8();
                            } else if (tag != 18) {
                                ...
                                this.f19004OooO0o0 = struct2;
                                if (builder != null) {
                                    builder.mergeFrom(struct2);
                                    this.f19004OooO0o0 = builder.buildPartial();
                                }
                            }
                        }
                        z = true;
    ...
    public static /* synthetic */ class OooO0O0 {
        ...
        public static final /* synthetic */ int[] f19007OooO00o;
        ...
        static {
            ...
            try {
                f19007OooO00o[AuthorityCase.THIRD_PARTY_PRINCIPAL.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f19007OooO00o[AuthorityCase.AUTHORITY_NOT_SET.ordinal()] = 3;
    ...
    public static final class OooO0OO extends GeneratedMessageV3.Builder<OooO0OO> implements MessageOrBuilder {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f19008OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public Object f19009OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public GeneratedMessageV3 f19010OooO0o0;

        public OooO0OO() {
            this.f19008OooO0Oo = 0;
            this.f19009OooO0o = "";
            ServiceAccountDelegationInfo serviceAccountDelegationInfo = ServiceAccountDelegationInfo.f18995OooO0oo;
        }
        ...
        public final ServiceAccountDelegationInfo buildPartial() {
            ...
            serviceAccountDelegationInfo.f18997OooO0o = this.f19009OooO0o;
            int i = this.f19008OooO0Oo;
            if (i == 1) {
                serviceAccountDelegationInfo.f18998OooO0o0 = this.f19010OooO0o0;
            }
            if (i == 2) {
                serviceAccountDelegationInfo.f18998OooO0o0 = this.f19010OooO0o0;
            }
            serviceAccountDelegationInfo.f18996OooO0Oo = i;
            onBuilt();
        ...
        public final void OooO0o(ServiceAccountDelegationInfo serviceAccountDelegationInfo) {
            ...
            if (serviceAccountDelegationInfo == ServiceAccountDelegationInfo.f18995OooO0oo) {
                return;
            }
            if (!serviceAccountDelegationInfo.OooO0Oo().isEmpty()) {
                this.f19009OooO0o = serviceAccountDelegationInfo.f18997OooO0o;
                onChanged();
            }
            int i = OooO0O0.f19007OooO00o[serviceAccountDelegationInfo.OooO0O0().ordinal()];
            if (i == 1) {
                FirstPartyPrincipal firstPartyPrincipalOooO0OO = serviceAccountDelegationInfo.OooO0OO();
                if (this.f19008OooO0Oo != 1 || (generatedMessageV3 = this.f19010OooO0o0) == (firstPartyPrincipal = FirstPartyPrincipal.f19000OooO0oO)) {
                    this.f19010OooO0o0 = firstPartyPrincipalOooO0OO;
                } else {
                    ...
                    this.f19010OooO0o0 = builder.buildPartial();
                }
                onChanged();
                this.f19008OooO0Oo = 1;
            } else if (i == 2) {
                ThirdPartyPrincipal thirdPartyPrincipalOooO0o0 = serviceAccountDelegationInfo.OooO0o0();
                if (this.f19008OooO0Oo != 2 || (generatedMessageV4 = this.f19010OooO0o0) == (thirdPartyPrincipal = ThirdPartyPrincipal.f19011OooO0o)) {
                    this.f19010OooO0o0 = thirdPartyPrincipalOooO0o0;
                } else {
                    ...
                    this.f19010OooO0o0 = builder2.buildPartial();
                }
                onChanged();
                this.f19008OooO0Oo = 2;
            }
            onChanged();
        }
        ...
        public final void OooO0oO(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws Throwable {
            ...
            try {
                try {
                    ServiceAccountDelegationInfo.f18994OooO.getClass();
        ...
        @Override // com.google.protobuf.MessageLiteOrBuilder, com.google.protobuf.MessageOrBuilder
        public final Message getDefaultInstanceForType() {
            return ServiceAccountDelegationInfo.f18995OooO0oo;
        }

        @Override // com.google.protobuf.GeneratedMessageV3.Builder, com.google.protobuf.Message.Builder, com.google.protobuf.MessageOrBuilder
        public final Descriptors.Descriptor getDescriptorForType() {
            return o0O0O0o0.OooO00o.f41934OooOO0O;
        }

        @Override // com.google.protobuf.GeneratedMessageV3.Builder
        public final GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return o0O0O0o0.OooO00o.f41935OooOO0o.ensureFieldAccessorsInitialized(ServiceAccountDelegationInfo.class, OooO0OO.class);
        }
    ...
    public static final class ThirdPartyPrincipal extends GeneratedMessageV3 implements MessageOrBuilder {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public static final ThirdPartyPrincipal f19011OooO0o = new ThirdPartyPrincipal();

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public static final OooO00o f19012OooO0oO = new OooO00o();

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public Struct f19013OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public byte f19014OooO0o0;
        ...
        public static final class OooO0O0 extends GeneratedMessageV3.Builder<OooO0O0> implements MessageOrBuilder {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public Struct f19015OooO0Oo;

            public OooO0O0() {
                ThirdPartyPrincipal thirdPartyPrincipal = ThirdPartyPrincipal.f19011OooO0o;
            }
            ...
            public final ThirdPartyPrincipal buildPartial() {
                ...
                thirdPartyPrincipal.f19013OooO0Oo = this.f19015OooO0Oo;
                onBuilt();
            ...
            public final void OooO0Oo() {
                super.clear();
                this.f19015OooO0Oo = null;
            }

            public final void OooO0o(ThirdPartyPrincipal thirdPartyPrincipal) {
                if (thirdPartyPrincipal == ThirdPartyPrincipal.f19011OooO0o) {
                    return;
                }
                if (thirdPartyPrincipal.f19013OooO0Oo != null) {
                    Struct structOooO0O0 = thirdPartyPrincipal.OooO0O0();
                    Struct struct = this.f19015OooO0Oo;
                    if (struct != null) {
                        this.f19015OooO0Oo = Struct.newBuilder(struct).mergeFrom(structOooO0O0).buildPartial();
                    } else {
                        this.f19015OooO0Oo = structOooO0O0;
                    }
                    onChanged();
                }
                onChanged();
            ...
            public final void OooO0oO(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws Throwable {
                ...
                try {
                    try {
                        ThirdPartyPrincipal.f19012OooO0oO.getClass();
            ...
            @Override // com.google.protobuf.MessageLiteOrBuilder, com.google.protobuf.MessageOrBuilder
            public final Message getDefaultInstanceForType() {
                return ThirdPartyPrincipal.f19011OooO0o;
            }

            @Override // com.google.protobuf.GeneratedMessageV3.Builder, com.google.protobuf.Message.Builder, com.google.protobuf.MessageOrBuilder
            public final Descriptors.Descriptor getDescriptorForType() {
                return o0O0O0o0.OooO00o.f41938OooOOOO;
            }

            @Override // com.google.protobuf.GeneratedMessageV3.Builder
            public final GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
                return o0O0O0o0.OooO00o.f41939OooOOOo.ensureFieldAccessorsInitialized(ThirdPartyPrincipal.class, OooO0O0.class);
            }
        ...
        public ThirdPartyPrincipal(GeneratedMessageV3.Builder<?> builder) {
            super(builder);
            this.f19014OooO0o0 = (byte) -1;
        }

        public final Struct OooO0O0() {
            Struct struct = this.f19013OooO0Oo;
            return struct == null ? Struct.getDefaultInstance() : struct;
        }
        ...
        public final boolean equals(Object obj) {
            ...
            Struct struct = this.f19013OooO0Oo;
            if ((struct != null) != (thirdPartyPrincipal.f19013OooO0Oo != null)) {
                return false;
            }
        ...
        public final int getSerializedSize() {
            ...
            int serializedSize = this.unknownFields.getSerializedSize() + (this.f19013OooO0Oo != null ? 0 + CodedOutputStream.computeMessageSize(1, OooO0O0()) : 0);
            this.memoizedSize = serializedSize;
            return serializedSize;
        }
        ...
        public final int hashCode() {
            ...
            int iHashCode = o0O0O0o0.OooO00o.f41938OooOOOO.hashCode() + 779;
            if (this.f19013OooO0Oo != null) {
                iHashCode = o000000O.OooO00o(iHashCode, 37, 1, 53) + OooO0O0().hashCode();
            }
            int iHashCode2 = this.unknownFields.hashCode() + (iHashCode * 29);
            this.memoizedHashCode = iHashCode2;
            return iHashCode2;
                        ...
                        try {
                            ...
                            if (tag != 0) {
                                if (tag != 10) {
                                    ...
                                    Struct.Builder builder = struct != null ? struct.toBuilder() : null;
                                    Struct struct2 = (Struct) codedInputStream.readMessage(Struct.parser(), extensionRegistryLite);
                                    this.f19013OooO0Oo = struct2;
                                    if (builder != null) {
                                        builder.mergeFrom(struct2);
                                        this.f19013OooO0Oo = builder.buildPartial();
                                    }
                                }
                            }
                            z = true;
    ...
    public ServiceAccountDelegationInfo(GeneratedMessageV3.Builder<?> builder) {
        super(builder);
        this.f18996OooO0Oo = 0;
        this.f18999OooO0oO = (byte) -1;
    }

    public final AuthorityCase OooO0O0() {
        int i = this.f18996OooO0Oo;
        if (i == 0) {
    ...
    public final FirstPartyPrincipal OooO0OO() {
        return this.f18996OooO0Oo == 1 ? (FirstPartyPrincipal) this.f18998OooO0o0 : FirstPartyPrincipal.f19000OooO0oO;
    }

    public final String OooO0Oo() {
        Object obj = this.f18997OooO0o;
        if (obj instanceof String) {
            return (String) obj;
        }
        String stringUtf8 = ((ByteString) obj).toStringUtf8();
        this.f18997OooO0o = stringUtf8;
        return stringUtf8;
    }
    ...
    public final ThirdPartyPrincipal OooO0o0() {
        return this.f18996OooO0Oo == 2 ? (ThirdPartyPrincipal) this.f18998OooO0o0 : ThirdPartyPrincipal.f19011OooO0o;
    }
    ...
    public final int getSerializedSize() {
        ...
        int iComputeMessageSize = this.f18996OooO0Oo == 1 ? 0 + CodedOutputStream.computeMessageSize(1, (FirstPartyPrincipal) this.f18998OooO0o0) : 0;
        if (this.f18996OooO0Oo == 2) {
            iComputeMessageSize += CodedOutputStream.computeMessageSize(2, (ThirdPartyPrincipal) this.f18998OooO0o0);
        }
        if (!GeneratedMessageV3.isStringEmpty(this.f18997OooO0o)) {
            iComputeMessageSize += GeneratedMessageV3.computeStringSize(3, this.f18997OooO0o);
        }
    ...
    public final int hashCode() {
        ...
        int iHashCode2 = OooO0Oo().hashCode() + o000Oo0.OooO00o(o0O0O0o0.OooO00o.f41934OooOO0O, 779, 37, 3, 53);
        int i2 = this.f18996OooO0Oo;
        if (i2 != 1) {
            if (i2 == 2) {
    ...
    @Override // com.google.protobuf.MessageLite, com.google.protobuf.Message
    public final Message.Builder newBuilderForType() {
        return f18995OooO0oo.toBuilder();
    }
    ...
    @Override // com.google.protobuf.GeneratedMessageV3, com.google.protobuf.AbstractMessage, com.google.protobuf.MessageLite
    public final void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        if (this.f18996OooO0Oo == 1) {
            codedOutputStream.writeMessage(1, (FirstPartyPrincipal) this.f18998OooO0o0);
        }
        if (this.f18996OooO0Oo == 2) {
            codedOutputStream.writeMessage(2, (ThirdPartyPrincipal) this.f18998OooO0o0);
        }
        if (!GeneratedMessageV3.isStringEmpty(this.f18997OooO0o)) {
            GeneratedMessageV3.writeString(codedOutputStream, 3, this.f18997OooO0o);
        }
        this.unknownFields.writeTo(codedOutputStream);
    }
            ...
            try {
                try {
                    try {
                        ...
                        if (tag != 0) {
                            if (tag == 10) {
                                FirstPartyPrincipal.OooO0O0 builder = this.f18996OooO0Oo == 1 ? ((FirstPartyPrincipal) this.f18998OooO0o0).toBuilder() : null;
                                MessageLite message = codedInputStream.readMessage(FirstPartyPrincipal.f19001OooO0oo, extensionRegistryLite);
                                this.f18998OooO0o0 = message;
                                if (builder != null) {
                                    builder.OooO0o((FirstPartyPrincipal) message);
                                    this.f18998OooO0o0 = builder.buildPartial();
                                }
                                this.f18996OooO0Oo = 1;
                            } else if (tag == 18) {
                                ThirdPartyPrincipal.OooO0O0 builder2 = this.f18996OooO0Oo == 2 ? ((ThirdPartyPrincipal) this.f18998OooO0o0).toBuilder() : null;
                                MessageLite message2 = codedInputStream.readMessage(ThirdPartyPrincipal.f19012OooO0oO, extensionRegistryLite);
                                this.f18998OooO0o0 = message2;
                                if (builder2 != null) {
                                    builder2.OooO0o((ThirdPartyPrincipal) message2);
                                    this.f18998OooO0o0 = builder2.buildPartial();
                                }
                                this.f18996OooO0Oo = 2;
                            } else if (tag != 26) {
                                if (!parseUnknownField(codedInputStream, builderNewBuilder, extensionRegistryLite, tag)) {
                                }
                            } else {
                                this.f18997OooO0o = codedInputStream.readStringRequireUtf8();
                            }
                        }
                        z = true;
                    } catch (IOException e) {
