...
public final class o000oOoO {
    ...
    public static String OooO00o(int i, int i2, String str) {
        if (i < 0) {
            return oo0o0Oo.OooO00o("%s (%s) must not be negative", str, Integer.valueOf(i));
        }
        if (i2 >= 0) {
            return oo0o0Oo.OooO00o("%s (%s) must not be greater than size (%s)", str, Integer.valueOf(i), Integer.valueOf(i2));
        }
        throw new IllegalArgumentException(p166o00Ooo00.o0OOO0o.OooO00o(26, "negative size: ", i2));
    }

    public static void OooO0O0(long j, String str, boolean z) {
        if (!z) {
            throw new IllegalArgumentException(oo0o0Oo.OooO00o(str, Long.valueOf(j)));
        }
    }

    public static void OooO0OO(String str, int i, boolean z) {
        if (!z) {
            throw new IllegalArgumentException(oo0o0Oo.OooO00o(str, Integer.valueOf(i)));
        }
    }
    ...
    public static void OooO0o(boolean z, String str, @CheckForNull Object obj) {
        if (!z) {
            throw new IllegalArgumentException(oo0o0Oo.OooO00o(str, obj));
        }
    }
    ...
    public static void OooO0oO(boolean z, String str, @CheckForNull Object obj, @CheckForNull Object obj2) {
        if (!z) {
            throw new IllegalArgumentException(oo0o0Oo.OooO00o(str, obj, obj2));
        }
    }
    ...
    public static void OooO0oo(int i, int i2) {
        ...
        if (i < 0 || i >= i2) {
            if (i < 0) {
                strOooO00o = oo0o0Oo.OooO00o("%s (%s) must not be negative", "index", Integer.valueOf(i));
            } else {
                if (i2 < 0) {
                    throw new IllegalArgumentException(p166o00Ooo00.o0OOO0o.OooO00o(26, "negative size: ", i2));
                }
                strOooO00o = oo0o0Oo.OooO00o("%s (%s) must be less than size (%s)", "index", Integer.valueOf(i), Integer.valueOf(i2));
            }
    ...
    public static void OooOO0O(int i, int i2, int i3) {
        ...
        if (i < 0 || i2 < i || i2 > i3) {
            if (i < 0 || i > i3) {
                ...
                strOooO00o = (i2 < 0 || i2 > i3) ? OooO00o(i2, i3, "end index") : oo0o0Oo.OooO00o("end index (%s) must not be less than start index (%s)", Integer.valueOf(i2), Integer.valueOf(i));
            }
            throw new IndexOutOfBoundsException(strOooO00o);
        }
    }
    ...
    public static void OooOO0o(String str, @CheckForNull Object obj, boolean z) {
        if (!z) {
            throw new IllegalStateException(oo0o0Oo.OooO00o(str, obj));
        }
    }
