...
public final class EnumHashBiMap<K extends Enum<K>, V> extends OooO0O0<K, V> {
    ...
    public transient Class<K> f19112OooO;

    @GwtIncompatible
    private void readObject(ObjectInputStream objectInputStream) throws ClassNotFoundException, IOException {
        objectInputStream.defaultReadObject();
        this.f19112OooO = (Class) objectInputStream.readObject();
        OooO0o0(new EnumMap(this.f19112OooO), new HashMap((this.f19112OooO.getEnumConstants().length * 3) / 2));
    ...
    private void writeObject(ObjectOutputStream objectOutputStream) throws IOException {
        ...
        objectOutputStream.writeObject(this.f19112OooO);
