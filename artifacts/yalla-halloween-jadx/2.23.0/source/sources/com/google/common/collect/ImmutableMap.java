...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
    ...
    @CheckForNull
    @LazyInit
    public transient ImmutableSet<Map.Entry<K, V>> f19164OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @RetainedWith
    @CheckForNull
    @LazyInit
    public transient ImmutableCollection<V> f19165OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @RetainedWith
    @CheckForNull
    @LazyInit
    public transient ImmutableSet<K> f19166OooO0o0;

    @DoNotMock
    public static class OooO00o<K, V> {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public Object[] f19167OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public int f19168OooO0O0 = 0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public C0229OooO00o f19169OooO0OO;
        ...
        public static final class C0229OooO00o {

            /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
            public final Object f19170OooO00o;

            /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
            public final Object f19171OooO0O0;

            /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
            public final Object f19172OooO0OO;

            public C0229OooO00o(Object obj, Object obj2, Object obj3) {
                this.f19170OooO00o = obj;
                this.f19171OooO0O0 = obj2;
                this.f19172OooO0OO = obj3;
            }

            public final IllegalArgumentException OooO00o() {
                Object obj = this.f19170OooO00o;
                String strValueOf = String.valueOf(obj);
                String strValueOf2 = String.valueOf(this.f19171OooO0O0);
                String strValueOf3 = String.valueOf(obj);
                String strValueOf4 = String.valueOf(this.f19172OooO0OO);
                ...
                return new IllegalArgumentException(androidx.compose.material.OooO00o.OooO0O0(sb, " and ", strValueOf3, "=", strValueOf4));
            }
        }

        public OooO00o(int i) {
            this.f19167OooO00o = new Object[i * 2];
        }

        public final o0OoO00O OooO00o(boolean z) {
            C0229OooO00o c0229OooO00o;
            C0229OooO00o c0229OooO00o2;
            if (z && (c0229OooO00o2 = this.f19169OooO0OO) != null) {
                throw c0229OooO00o2.OooO00o();
            }
            o0OoO00O o0ooo00oOooOO0O = o0OoO00O.OooOO0O(this.f19168OooO0O0, this.f19167OooO00o, this);
            if (!z || (c0229OooO00o = this.f19169OooO0OO) == null) {
        ...
        public OooO00o<K, V> OooO0OO(K k, V v) {
            int i = (this.f19168OooO0O0 + 1) * 2;
            Object[] objArr = this.f19167OooO00o;
            if (i > objArr.length) {
                this.f19167OooO00o = Arrays.copyOf(objArr, ImmutableCollection.OooO0O0.OooO0O0(objArr.length, i));
            }
            oo000o.OooO00o(k, v);
            Object[] objArr2 = this.f19167OooO00o;
        ...
        public OooO00o OooO0o0(Set set) {
            if (set instanceof Collection) {
                int size = (set.size() + this.f19168OooO0O0) * 2;
                Object[] objArr = this.f19167OooO00o;
                if (size > objArr.length) {
                    this.f19167OooO00o = Arrays.copyOf(objArr, ImmutableCollection.OooO0O0.OooO0O0(objArr.length, size));
                }
            }
    ...
    public static class OooO0OO<K, V> implements Serializable {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final Object[] f19174OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final Object[] f19175OooO0o0;
        ...
        public OooO0OO(ImmutableMap<K, V> immutableMap) {
            ...
            this.f19174OooO0Oo = objArr;
            this.f19175OooO0o0 = objArr2;
        }
        ...
        public final Object readResolve() {
            Object[] objArr = this.f19174OooO0Oo;
            boolean z = objArr instanceof ImmutableSet;
            Object[] objArr2 = this.f19175OooO0o0;
            if (!z) {
    ...
    public ImmutableSet<Map.Entry<K, V>> entrySet() {
        ImmutableSet<Map.Entry<K, V>> immutableSet = this.f19164OooO0Oo;
        if (immutableSet != null) {
            return immutableSet;
        }
        ImmutableSet<Map.Entry<K, V>> immutableSetOooO0OO = OooO0OO();
        this.f19164OooO0Oo = immutableSetOooO0OO;
    ...
    public ImmutableSet<K> keySet() {
        ImmutableSet<K> immutableSet = this.f19166OooO0o0;
        if (immutableSet != null) {
            return immutableSet;
        }
        ImmutableSet<K> immutableSetOooO0Oo = OooO0Oo();
        this.f19166OooO0o0 = immutableSetOooO0Oo;
        return immutableSetOooO0Oo;
    }
    ...
    public ImmutableCollection<V> values() {
        ImmutableCollection<V> immutableCollection = this.f19165OooO0o;
        if (immutableCollection != null) {
            return immutableCollection;
        }
        ImmutableCollection<V> immutableCollectionOooO0o0 = OooO0o0();
        this.f19165OooO0o = immutableCollectionOooO0o0;
