...
public abstract class ImmutableMultiset<E> extends o0O0ooO<E> implements o0oOO<E> {
    ...
    @CheckForNull
    @LazyInit
    public transient ImmutableSet<o0oOO.OooO00o<E>> f19179OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @CheckForNull
    @LazyInit
    public transient o0O00 f19180OooO0o0;

    public class OooO00o extends o0OO0<E> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f19181OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ Iterator f19182OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        @CheckForNull
        public E f19183OooO0o0;

        public OooO00o(o0OO0 o0oo1) {
            this.f19182OooO0o = o0oo1;
        }

        @Override // java.util.Iterator
        public final boolean hasNext() {
            return this.f19181OooO0Oo > 0 || this.f19182OooO0o.hasNext();
        }

        @Override // java.util.Iterator
        public final E next() {
            if (this.f19181OooO0Oo <= 0) {
                o0oOO.OooO00o oooO00o = (o0oOO.OooO00o) this.f19182OooO0o.next();
                this.f19183OooO0o0 = (E) oooO00o.getElement();
                this.f19181OooO0Oo = oooO00o.getCount();
            }
            this.f19181OooO0Oo--;
            E e = this.f19183OooO0o0;
    ...
    public final class OooO0OO extends o00O00<o0oOO.OooO00o<E>> {
        ...
        public final boolean contains(@CheckForNull Object obj) {
            ...
            return oooO00o.getCount() > 0 && ImmutableMultiset.this.o000OOo(oooO00o.getElement()) == oooO00o.getCount();
        }
    ...
    public static class OooO0o<E> implements Serializable {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final ImmutableMultiset<E> f19185OooO0Oo;

        public OooO0o(ImmutableMultiset<E> immutableMultiset) {
            this.f19185OooO0Oo = immutableMultiset;
        }

        public Object readResolve() {
            return this.f19185OooO0Oo.entrySet();
        }
    }
    ...
    public final ImmutableList<E> OooO00o() {
        o0O00 o0o01 = this.f19180OooO0o0;
        if (o0o01 != null) {
            return o0o01;
        }
        ImmutableList<E> immutableListOooO00o = super.OooO00o();
        this.f19180OooO0o0 = (o0O00) immutableListOooO00o;
    ...
    public final ImmutableSet<o0oOO.OooO00o<E>> entrySet() {
        ImmutableSet<o0oOO.OooO00o<E>> oooO0OO = this.f19179OooO0o;
        if (oooO0OO == null) {
            oooO0OO = isEmpty() ? o0O00O0o.f19566OooOOO0 : new OooO0OO();
            this.f19179OooO0o = oooO0OO;
        }
        return oooO0OO;
    }
