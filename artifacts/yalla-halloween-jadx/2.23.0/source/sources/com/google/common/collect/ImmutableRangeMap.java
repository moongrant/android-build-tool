...
public class ImmutableRangeMap<K extends Comparable<?>, V> implements o0OoOoOo<K, V>, Serializable {
    ...
    public static final ImmutableRangeMap<Comparable<?>, Object> f19186OooO0o;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final transient ImmutableList<Range<K>> f19187OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final transient ImmutableList<V> f19188OooO0o0;

    public static class OooO00o<K extends Comparable<?>, V> implements Serializable {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final ImmutableMap<Range<K>, V> f19189OooO0Oo;

        public OooO00o(ImmutableMap<Range<K>, V> immutableMap) {
            this.f19189OooO0Oo = immutableMap;
        }
        ...
        public Object readResolve() {
            Range range;
            ImmutableMap<Range<K>, V> immutableMap = this.f19189OooO0Oo;
            if (immutableMap.isEmpty()) {
                return ImmutableRangeMap.f19186OooO0o;
            }
            ...
            while (it.hasNext()) {
                ...
                key.getClass();
                value.getClass();
                com.google.common.base.o000oOoO.OooO0o(true ^ key.f19363OooO0Oo.equals(key.f19364OooO0o0), "Range must not be empty, but was %s", key);
                arrayList.add(new o000O0O0(key, value));
            }
            Range<Comparable> range2 = Range.f19362OooO0o;
            Range.OooO00o oooO00o = Range.OooO00o.f19365OooO0Oo;
            oooO00o.getClass();
            ...
            while (i < arrayList.size()) {
                ...
                if (i > 0) {
                    ...
                    range3.getClass();
                    Object obj = range4.f19364OooO0o0;
                    o00000O0 o00000o1 = range3.f19363OooO0Oo;
                    int iCompareTo = o00000o1.compareTo(obj);
                    o00000O0 o00000o2 = range3.f19364OooO0o0;
                    o00000O0 o00000o3 = range4.f19363OooO0Oo;
                    if (iCompareTo <= 0 && o00000o3.compareTo(o00000o2) <= 0) {
                        int iCompareTo2 = o00000o1.compareTo(o00000o3);
                        o00000O0 o00000o4 = range4.f19364OooO0o0;
                        ...
                        if (iCompareTo2 >= 0 && iCompareTo3 <= 0) {
                            ...
                            com.google.common.base.o000oOoO.OooO0oO(o00000o1.compareTo(o00000o2) <= 0, "intersection is undefined for disconnected ranges %s and %s", range3, range4);
                            range = new Range(o00000o1, o00000o2);
                        } else {
                            range = range4;
                        }
                        if (!range.f19363OooO0Oo.equals(range.f19364OooO0o0)) {
    ...
    static {
        ...
        f19186OooO0o = new ImmutableRangeMap<>(o0o01, o0o01);
    }

    public ImmutableRangeMap(o0O00 o0o01, o0O00 o0o02) {
        this.f19187OooO0Oo = o0o01;
        this.f19188OooO0o0 = o0o02;
    }

    @Override // com.google.common.collect.o0OoOoOo
    /* JADX INFO: renamed from: OooO0O0, reason: merged with bridge method [inline-methods] */
    public final ImmutableMap<Range<K>, V> OooO00o() {
        ImmutableList<Range<K>> immutableList = this.f19187OooO0Oo;
        if (immutableList.isEmpty()) {
            return o0OoO00O.f19626OooOO0;
        }
        Range<Comparable> range = Range.f19362OooO0o;
        return new ImmutableSortedMap(new o0O00OO(immutableList, Range.OooO00o.f19365OooO0Oo), this.f19188OooO0o0, null);
    }
