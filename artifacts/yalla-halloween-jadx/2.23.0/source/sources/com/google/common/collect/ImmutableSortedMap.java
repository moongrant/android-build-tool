...
public final class ImmutableSortedMap<K, V> extends o00oOoo<K, V> implements NavigableMap<K, V> {
    ...
    public static final ImmutableSortedMap<Comparable, Object> f19200OooOO0;

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    @CheckForNull
    public final transient ImmutableSortedMap<K, V> f19201OooO;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final transient o0O00OO<K> f19202OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final transient ImmutableList<V> f19203OooO0oo;
    ...
    public class OooO00o extends o000OO00<K, V> {
        ...
        public class C0230OooO00o extends ImmutableList<Map.Entry<K, V>> {
            public C0230OooO00o() {
            }
            ...
            public final Object get(int i) {
                ...
                return new AbstractMap.SimpleImmutableEntry(ImmutableSortedMap.this.f19202OooO0oO.OooO00o().get(i), ImmutableSortedMap.this.f19203OooO0oo.get(i));
            }
    ...
    public static class OooO0O0<K, V> extends ImmutableMap.OooO00o<K, V> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public transient Object[] f19206OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final Comparator<? super K> f19207OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public transient Object[] f19208OooO0o0;

        public OooO0O0(Comparator<? super K> comparator) {
            super(4);
            comparator.getClass();
            this.f19207OooO0o = comparator;
            this.f19206OooO0Oo = new Object[4];
            this.f19208OooO0o0 = new Object[4];
        }
        ...
        public final ImmutableMap.OooO00o OooO0OO(Object obj, Object obj2) {
            int i = this.f19168OooO0O0 + 1;
            Object[] objArr = this.f19206OooO0Oo;
            if (i > objArr.length) {
                int iOooO0O0 = ImmutableCollection.OooO0O0.OooO0O0(objArr.length, i);
                this.f19206OooO0Oo = Arrays.copyOf(this.f19206OooO0Oo, iOooO0O0);
                this.f19208OooO0o0 = Arrays.copyOf(this.f19208OooO0o0, iOooO0O0);
            }
            oo000o.OooO00o(obj, obj2);
            Object[] objArr2 = this.f19206OooO0Oo;
            int i2 = this.f19168OooO0O0;
            objArr2[i2] = obj;
            this.f19208OooO0o0[i2] = obj2;
            this.f19168OooO0O0 = i2 + 1;
            return this;
        }
        ...
        public final ImmutableSortedMap<K, V> OooO0O0() {
            int i = this.f19168OooO0O0;
            Comparator<? super K> comparator = this.f19207OooO0o;
            if (i == 0) {
                return ImmutableSortedMap.OooOOO0(comparator);
            }
            if (i == 1) {
                Object obj = this.f19206OooO0Oo[0];
                Objects.requireNonNull(obj);
                Object obj2 = this.f19208OooO0o0[0];
            ...
            Object[] objArrCopyOf = Arrays.copyOf(this.f19206OooO0Oo, i);
            Arrays.sort(objArrCopyOf, comparator);
            int i2 = this.f19168OooO0O0;
            Object[] objArr = new Object[i2];
            for (int i3 = 0; i3 < this.f19168OooO0O0; i3++) {
                if (i3 > 0) {
                    int i4 = i3 - 1;
    ...
    public static class OooO0OO<K, V> extends ImmutableMap.OooO0OO<K, V> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final Comparator<? super K> f19209OooO0o;

        public OooO0OO(ImmutableSortedMap<K, V> immutableSortedMap) {
            super(immutableSortedMap);
            this.f19209OooO0o = immutableSortedMap.f19202OooO0oO.f19219OooO0oO;
        }

        @Override // com.google.common.collect.ImmutableMap.OooO0OO
        public final ImmutableMap.OooO00o OooO00o(int i) {
            return new OooO0O0(this.f19209OooO0o);
        }
    }

    static {
        o0O00OO o0o00ooOooOo00 = ImmutableSortedSet.OooOo00(o0O0o.f19585OooO0Oo);
        ImmutableList.OooO0O0 oooO0O0 = ImmutableList.f19157OooO0o0;
        f19200OooOO0 = new ImmutableSortedMap<>(o0o00ooOooOo00, o0O00.f19536OooO0oo, null);
    }
    ...
    public ImmutableSortedMap(o0O00OO<K> o0o00oo2, ImmutableList<V> immutableList, @CheckForNull ImmutableSortedMap<K, V> immutableSortedMap) {
        this.f19202OooO0oO = o0o00oo2;
        this.f19203OooO0oo = immutableList;
        this.f19201OooO = immutableSortedMap;
    }

    public static <K, V> ImmutableSortedMap<K, V> OooOOO0(Comparator<? super K> comparator) {
        return o0O0o.f19585OooO0Oo.equals(comparator) ? (ImmutableSortedMap<K, V>) f19200OooOO0 : new ImmutableSortedMap<>(ImmutableSortedSet.OooOo00(comparator), o0O00.f19536OooO0oo, null);
    }
    ...
    public final boolean OooO0oO() {
        return this.f19202OooO0oO.OooO0o() || this.f19203OooO0oo.OooO0o();
    }

    @Override // com.google.common.collect.ImmutableMap
    /* JADX INFO: renamed from: OooO0oo */
    public final ImmutableSet keySet() {
        return this.f19202OooO0oO;
    }

    @Override // com.google.common.collect.ImmutableMap
    /* JADX INFO: renamed from: OooOO0 */
    public final ImmutableCollection<V> values() {
        return this.f19203OooO0oo;
    }
    ...
    public final ImmutableSortedMap<K, V> OooOOO(int i, int i2) {
        ...
        o0O00OO<K> o0o00oo2 = this.f19202OooO0oO;
        return i == i2 ? OooOOO0(o0o00oo2.f19219OooO0oO) : new ImmutableSortedMap<>(o0o00oo2.OooOooO(i, i2), this.f19203OooO0oo.subList(i, i2), null);
    }
    ...
    public final ImmutableSortedMap<K, V> headMap(K k, boolean z) {
        k.getClass();
        return OooOOO(0, this.f19202OooO0oO.OooOooo(k, z));
    }
    ...
    public final ImmutableSortedMap<K, V> subMap(K k, boolean z, K k2, boolean z2) {
        k.getClass();
        k2.getClass();
        com.google.common.base.o000oOoO.OooO0oO(this.f19202OooO0oO.f19219OooO0oO.compare(k, k2) <= 0, "expected fromKey <= toKey but %s > %s", k, k2);
    ...
    public final ImmutableSortedMap<K, V> tailMap(K k, boolean z) {
        k.getClass();
        return OooOOO(this.f19202OooO0oO.Oooo000(k, z), size());
    }
    ...
    public final Comparator<? super K> comparator() {
        return this.f19202OooO0oO.f19219OooO0oO;
    }

    @Override // java.util.NavigableMap
    public final NavigableSet descendingKeySet() {
        return this.f19202OooO0oO.descendingSet();
    }

    @Override // java.util.NavigableMap
    public final NavigableMap descendingMap() {
        ImmutableSortedMap<K, V> immutableSortedMap = this.f19201OooO;
        if (immutableSortedMap != null) {
            return immutableSortedMap;
        }
        boolean zIsEmpty = isEmpty();
        o0O00OO<K> o0o00oo2 = this.f19202OooO0oO;
        return zIsEmpty ? OooOOO0(o0O000.OooO00o(o0o00oo2.f19219OooO0oO).OooO0O0()) : new ImmutableSortedMap((o0O00OO) o0o00oo2.descendingSet(), this.f19203OooO0oo.OooOOo0(), this);
    }
    ...
    public final K firstKey() {
        return this.f19202OooO0oO.first();
    }
    ...
    public final V get(@CheckForNull Object obj) {
        int iIndexOf = this.f19202OooO0oO.indexOf(obj);
        if (iIndexOf == -1) {
            return null;
        }
        return this.f19203OooO0oo.get(iIndexOf);
    }
    ...
    public final K lastKey() {
        return this.f19202OooO0oO.last();
    }
    ...
    public final int size() {
        return this.f19203OooO0oo.size();
    }
