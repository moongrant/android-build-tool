...
public final class MutableClassToInstanceMap<B> extends o000<Class<? extends B>, B> implements Serializable {
    ...
    public final Map<Class<? extends B>, B> f19283OooO0Oo;

    public static final class OooO0O0<B> implements Serializable {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final Map<Class<? extends B>, B> f19285OooO0Oo;

        public OooO0O0(Map<Class<? extends B>, B> map) {
            this.f19285OooO0Oo = map;
        }

        public Object readResolve() {
            return new MutableClassToInstanceMap(this.f19285OooO0Oo);
        }
    }

    public MutableClassToInstanceMap(Map<Class<? extends B>, B> map) {
        map.getClass();
        this.f19283OooO0Oo = map;
    }

    @CanIgnoreReturnValue
    @CheckForNull
    public static <B, T extends B> T OooO0OO(Class<T> cls, @CheckForNull B b) {
        Map<Class<?>, Class<?>> map = com.google.common.primitives.OooOO0O.f19753OooO00o;
        cls.getClass();
        Class<T> cls2 = (Class) com.google.common.primitives.OooOO0O.f19753OooO00o.get(cls);
        if (cls2 != null) {
            cls = cls2;
        }
        return cls.cast(b);
    ...
    public class OooO00o extends o000O00O<Map.Entry<Class<? extends B>, B>> {
        ...
        public class C0231OooO00o extends oo0oO0<Map.Entry<Class<? extends B>, B>, Map.Entry<Class<? extends B>, B>> {
        ...
        public final Set<Map.Entry<Class<? extends B>, B>> OooO00o() {
            return MutableClassToInstanceMap.this.f19283OooO0Oo.entrySet();
        }
        ...
        public final Iterator<Map.Entry<Class<? extends B>, B>> iterator() {
            return new C0231OooO00o(OooO00o().iterator());
        }
