...
public class TreeBasedTable<R, C, V> extends o0O0o0<R, C, V> {
    ...
    public class OooO00o extends o0oOo0O0<R, C, V>.OooO0O0 implements SortedMap<C, V> {
        ...
        @CheckForNull
        public transient SortedMap<C, V> f19366OooO;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        @CheckForNull
        public final C f19367OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        @CheckForNull
        public final C f19368OooO0oo;

        public OooO00o(@CheckForNull R r, @CheckForNull C c, C c2) {
            super(r);
            this.f19367OooO0oO = c;
            this.f19368OooO0oo = c2;
            if (c == null || c2 == null) {
                return;
            }
            comparator();
        ...
        public final Map OooO0O0() {
            OooO0o();
            SortedMap<C, V> sortedMapTailMap = this.f19366OooO;
            if (sortedMapTailMap == null) {
                return null;
            }
            C c = this.f19367OooO0oO;
            if (c != null) {
                sortedMapTailMap = sortedMapTailMap.tailMap(c);
            }
            C c2 = this.f19368OooO0oo;
        ...
        public final void OooO0OO() {
            OooO0o();
            SortedMap<C, V> sortedMap = this.f19366OooO;
            if (sortedMap == null || !sortedMap.isEmpty()) {
                return;
            }
            TreeBasedTable.this.f19649OooO0o.remove(this.f19655OooO0Oo);
            this.f19366OooO = null;
        ...
        public final void OooO0o() {
            ...
            if (sortedMap == null || (sortedMap.isEmpty() && treeBasedTable.f19649OooO0o.containsKey(r))) {
                this.f19366OooO = (SortedMap) treeBasedTable.f19649OooO0o.get(r);
            }
        }
        ...
        public final boolean OooO0o0(@CheckForNull Object obj) {
            ...
            if (this.f19367OooO0oO != null) {
                comparator();
                throw null;
            }
            if (this.f19368OooO0oo == null) {
                return true;
            }
            comparator();
            throw null;
        ...
        public final SortedMap<C, V> headMap(C c) {
            c.getClass();
            com.google.common.base.o000oOoO.OooO0Oo(OooO0o0(c));
            return new OooO00o(this.f19655OooO0Oo, this.f19367OooO0oO, c);
        }
        ...
        public final SortedMap<C, V> subMap(C c, C c2) {
            ...
            com.google.common.base.o000oOoO.OooO0Oo(z);
            return new OooO00o(this.f19655OooO0Oo, c, c2);
        }
        ...
        public final SortedMap<C, V> tailMap(C c) {
            c.getClass();
            com.google.common.base.o000oOoO.OooO0Oo(OooO0o0(c));
            return new OooO00o(this.f19655OooO0Oo, c, this.f19368OooO0oo);
        }
    }
