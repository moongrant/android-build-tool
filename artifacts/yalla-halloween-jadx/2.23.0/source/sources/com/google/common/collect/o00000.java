...
public abstract class o00000 {
    ...
    public static final OooO00o f19395OooO00o = new OooO00o();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final OooO0O0 f19396OooO0O0 = new OooO0O0(-1);

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final OooO0O0 f19397OooO0OO = new OooO0O0(1);

    public class OooO00o extends o00000 {
        public static o00000 OooO0oO(int i) {
            if (i < 0) {
                return o00000.f19396OooO0O0;
            }
            return i > 0 ? o00000.f19397OooO0OO : o00000.f19395OooO00o;
        }
    ...
    public static final class OooO0O0 extends o00000 {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final int f19398OooO0Oo;

        public OooO0O0(int i) {
            this.f19398OooO0Oo = i;
        }
