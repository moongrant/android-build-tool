...
public abstract class o00000O0<C extends Comparable> implements Comparable<o00000O0<C>>, Serializable {
    ...
    public final C f19420OooO0Oo = "";

    public static final class OooO00o extends o00000O0<Comparable<?>> {

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public static final OooO00o f19421OooO0o0 = new OooO00o();

        private Object readResolve() {
            return f19421OooO0o0;
        }
    ...
    public static final class OooO0O0 extends o00000O0<Comparable<?>> {
        ...
        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public static final OooO0O0 f19422OooO0o0 = new OooO0O0();

        private Object readResolve() {
            return f19422OooO0o0;
        }
    ...
    public int compareTo(o00000O0<C> o00000o1) {
        if (o00000o1 == OooO0O0.f19422OooO0o0) {
            return 1;
        }
        if (o00000o1 == OooO00o.f19421OooO0o0) {
            return -1;
        }
        C c = o00000o1.f19420OooO0Oo;
        Range<Comparable> range = Range.f19362OooO0o;
        int iCompareTo = this.f19420OooO0Oo.compareTo(c);
        if (iCompareTo != 0) {
            return iCompareTo;
        }
        return 0;
