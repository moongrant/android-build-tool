...
public final class o00OOOO0<K, V> extends oo0O.OooOO0O<K, Collection<V>> {
    ...
    @Weak
    public final o00OO<K, V> f19528OooO0oO;
    ...
    public class OooO00o extends oo0O.OooO0O0<K, Collection<V>> {
        ...
        public class C0234OooO00o implements com.google.common.base.OooOOO0<K, Collection<V>> {
            public C0234OooO00o() {
            }

            @Override // com.google.common.base.OooOOO0
            public final Object apply(@ParametricNullness Object obj) {
                return o00OOOO0.this.f19528OooO0oO.get(obj);
            }
        }
        ...
        public final Iterator<Map.Entry<K, Collection<V>>> iterator() {
            Set<K> setKeySet = o00OOOO0.this.f19528OooO0oO.keySet();
            return new o00OO0O0(setKeySet.iterator(), new C0234OooO00o());
        }
        ...
        public final boolean remove(@CheckForNull Object obj) {
            ...
            o00OOOO0.this.f19528OooO0oO.keySet().remove(entry.getKey());
            return true;
        }
    }
    ...
    public final void clear() {
        this.f19528OooO0oO.clear();
    }

    @Override // java.util.AbstractMap, java.util.Map
    public final boolean containsKey(@CheckForNull Object obj) {
        return this.f19528OooO0oO.containsKey(obj);
    }
    ...
    public final Object get(@CheckForNull Object obj) {
        if (containsKey(obj)) {
            return this.f19528OooO0oO.get(obj);
        }
        return null;
    }
    ...
    public final Object remove(@CheckForNull Object obj) {
        if (containsKey(obj)) {
            return this.f19528OooO0oO.OooO00o(obj);
        }
        return null;
    }
    ...
    public final int size() {
        return this.f19528OooO0oO.keySet().size();
    }
}
