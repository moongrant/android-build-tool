...
public final class o00OOOOo<K, V> extends OooO<K, V> {
    ...
    public transient com.google.common.base.o0O0O00<? extends List<V>> f19531OooOO0;

    public o00OOOOo(Map map, o00OOO0O.OooO00o oooO00o) {
        super(map);
        this.f19531OooOO0 = oooO00o;
    }

    @GwtIncompatible
    private void readObject(ObjectInputStream objectInputStream) throws ClassNotFoundException, IOException {
        objectInputStream.defaultReadObject();
        this.f19531OooOO0 = (com.google.common.base.o0O0O00) objectInputStream.readObject();
    ...
    private void writeObject(ObjectOutputStream objectOutputStream) throws IOException {
        ...
        objectOutputStream.writeObject(this.f19531OooOO0);
        objectOutputStream.writeObject(this.f19307OooO0oo);
    }
