...
public final class o0O00o00<T> extends o0O000<T> implements Serializable {
    ...
    public final boolean equals(@CheckForNull Object obj) {
        ...
        if (obj instanceof o0O00o00) {
            return this.f19576OooO0Oo.equals(((o0O00o00) obj).f19576OooO0Oo);
        }
        return false;
    }

    public final int hashCode() {
        return -this.f19576OooO0Oo.hashCode();
    }

    public final String toString() {
        String strValueOf = String.valueOf(this.f19576OooO0Oo);
