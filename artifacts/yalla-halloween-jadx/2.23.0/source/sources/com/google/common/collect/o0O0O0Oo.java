...
public final class o0O0O0Oo {
    ...
    public static final class OooO<E> extends o000O0<E> implements NavigableSet<E>, Serializable {
        ...
        public final NavigableSet<E> f19578OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        @CheckForNull
        public transient OooO<E> f19579OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final SortedSet<E> f19580OooO0o0;

        public OooO(NavigableSet<E> navigableSet) {
            navigableSet.getClass();
            this.f19578OooO0Oo = navigableSet;
            this.f19580OooO0o0 = Collections.unmodifiableSortedSet(navigableSet);
        }

        @Override // com.google.common.collect.o000O00O, com.google.common.collect.o0000O, com.google.common.collect.o000Oo0
        public final Object OooO00o() {
            return this.f19580OooO0o0;
        }
        ...
        public final E ceiling(@ParametricNullness E e) {
            return this.f19578OooO0Oo.ceiling(e);
        }

        @Override // java.util.NavigableSet
        public final Iterator<E> descendingIterator() {
            Iterator<E> itDescendingIterator = this.f19578OooO0Oo.descendingIterator();
        ...
        public final NavigableSet<E> descendingSet() {
            OooO<E> oooO = this.f19579OooO0o;
            if (oooO != null) {
                return oooO;
            }
            OooO<E> oooO2 = new OooO<>(this.f19578OooO0Oo.descendingSet());
            this.f19579OooO0o = oooO2;
            oooO2.f19579OooO0o = this;
            return oooO2;
        }
        ...
        public final NavigableSet<E> subSet(@ParametricNullness E e, boolean z, @ParametricNullness E e2, boolean z2) {
            return o0O0O0Oo.OooO0oO(this.f19578OooO0Oo.subSet(e, z, e2, z2));
        }

        @Override // java.util.NavigableSet
        public final NavigableSet<E> tailSet(@ParametricNullness E e, boolean z) {
            return o0O0O0Oo.OooO0oO(this.f19578OooO0Oo.tailSet(e, z));
        }
    }

    public static class OooO00o<E> extends o00oO0o.OooO00o<E> implements Set<E> {
        public OooO00o(Set<E> set, com.google.common.base.o0OoOo0<? super E> o0oooo0) {
            super(set, o0oooo0);
        }
    ...
    public static class OooO0O0<E> extends OooO00o<E> implements SortedSet<E> {
        public OooO0O0(SortedSet<E> sortedSet, com.google.common.base.o0OoOo0<? super E> o0oooo0) {
            super(sortedSet, o0oooo0);
        }

        @Override // java.util.SortedSet
        @CheckForNull
        public final Comparator<? super E> comparator() {
            return ((SortedSet) this.f19534OooO0Oo).comparator();
        }
        ...
        public final SortedSet<E> headSet(@ParametricNullness E e) {
            return new OooO0O0(((SortedSet) this.f19534OooO0Oo).headSet(e), this.f19535OooO0o0);
        }

        @Override // java.util.SortedSet
        @ParametricNullness
        public final E last() {
            SortedSet sortedSetHeadSet = (SortedSet) this.f19534OooO0Oo;
            while (true) {
                E e = (Object) sortedSetHeadSet.last();
                if (this.f19535OooO0o0.apply(e)) {
                    return e;
                }
        ...
        public final SortedSet<E> subSet(@ParametricNullness E e, @ParametricNullness E e2) {
            return new OooO0O0(((SortedSet) this.f19534OooO0Oo).subSet(e, e2), this.f19535OooO0o0);
        }

        @Override // java.util.SortedSet
        public final SortedSet<E> tailSet(@ParametricNullness E e) {
            return new OooO0O0(((SortedSet) this.f19534OooO0Oo).tailSet(e), this.f19535OooO0o0);
        }
    }
    ...
    public static OooO00o OooO0O0(Set set, com.google.common.base.o0OoOo0 o0oooo0) {
        if (!(set instanceof SortedSet)) {
            if (!(set instanceof OooO00o)) {
                set.getClass();
                return new OooO00o(set, o0oooo0);
            }
            OooO00o oooO00o = (OooO00o) set;
            com.google.common.base.o0OoOo0 o0oooo1 = oooO00o.f19535OooO0o0;
            o0oooo1.getClass();
            return new OooO00o((Set) oooO00o.f19534OooO0Oo, new com.google.common.base.o00O0O(Arrays.asList(o0oooo1, o0oooo0)));
        }
        SortedSet sortedSet = (SortedSet) set;
        if (!(sortedSet instanceof OooO00o)) {
            sortedSet.getClass();
            return new OooO0O0(sortedSet, o0oooo0);
        }
        OooO00o oooO00o2 = (OooO00o) sortedSet;
        com.google.common.base.o0OoOo0 o0oooo2 = oooO00o2.f19535OooO0o0;
        o0oooo2.getClass();
        return new OooO0O0((SortedSet) oooO00o2.f19534OooO0Oo, new com.google.common.base.o00O0O(Arrays.asList(o0oooo2, o0oooo0)));
    }
