...
public final class o0O0OO0<R, C, V> extends ImmutableTable<R, C, V> {
    ...
    public final R f19582OooO0o;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final C f19583OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final V f19584OooO0oo;

    public o0O0OO0(R r, C c, V v) {
        r.getClass();
        this.f19582OooO0o = r;
        c.getClass();
        this.f19583OooO0oO = c;
        v.getClass();
        this.f19584OooO0oo = v;
    }

    @Override // com.google.common.collect.ImmutableTable
    public final ImmutableMap<C, Map<R, V>> OooOO0() {
        return ImmutableMap.OooO(this.f19583OooO0oO, ImmutableMap.OooO(this.f19582OooO0o, this.f19584OooO0oo));
    }
    ...
    public final ImmutableSet<o0O.OooO00o<R, C, V>> OooO0o0() {
        o0OO000o o0oo000oOooO0oO = ImmutableTable.OooO0oO(this.f19582OooO0o, this.f19583OooO0oO, this.f19584OooO0oo);
    ...
    public final ImmutableCollection<V> OooOOO() {
        int i = ImmutableSet.f19194OooO0o;
        return new o0O0O0o0(this.f19584OooO0oo);
    }
    ...
    public final ImmutableMap<R, Map<C, V>> OooO0O0() {
        return ImmutableMap.OooO(this.f19582OooO0o, ImmutableMap.OooO(this.f19583OooO0oO, this.f19584OooO0oo));
    }
