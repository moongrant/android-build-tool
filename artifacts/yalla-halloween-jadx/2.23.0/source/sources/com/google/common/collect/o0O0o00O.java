...
public final class o0O0o00O<R, C, V> extends o0O00OOO<R, C, V> {
    ...
    public static final o0O0o00O f19588OooOO0;

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    public final int[] f19589OooO;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final o0OoO00O f19590OooO0o;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final o0OoO00O f19591OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final int[] f19592OooO0oo;

    static {
        ImmutableList.OooO0O0 oooO0O0 = ImmutableList.f19157OooO0o0;
        o0O00 o0o01 = o0O00.f19536OooO0oo;
        int i = ImmutableSet.f19194OooO0o;
        o0O00O0o<Object> o0o00o0o = o0O00O0o.f19566OooOOO0;
        f19588OooOO0 = new o0O0o00O(o0o01, o0o00o0o, o0o00o0o);
    }
    ...
    public o0O0o00O(o0O00 o0o01, ImmutableSet immutableSet, ImmutableSet immutableSet2) {
        ...
        this.f19592OooO0oo = iArr;
        this.f19589OooO = iArr2;
        ...
        this.f19590OooO0o = (o0OoO00O) oooO00o2.OooO0O0();
        ...
        this.f19591OooO0oO = (o0OoO00O) oooO00o3.OooO0O0();
    }

    @Override // com.google.common.collect.ImmutableTable
    public final ImmutableMap<C, Map<R, V>> OooOO0() {
        return ImmutableMap.OooO0O0(this.f19591OooO0oO);
    }
    ...
    public final ImmutableTable.OooO00o OooOO0o() {
        ...
        return ImmutableTable.OooO00o.OooO00o(this, this.f19592OooO0oo, iArr);
    }
    ...
    public final ImmutableMap<R, Map<C, V>> OooO0O0() {
        return ImmutableMap.OooO0O0(this.f19590OooO0o);
    }

    @Override // com.google.common.collect.o0O00OOO
    public final o0O.OooO00o<R, C, V> OooOOo(int i) {
        Map.Entry entry = (Map.Entry) this.f19590OooO0o.entrySet().OooO00o().get(this.f19592OooO0oo[i]);
        ImmutableMap immutableMap = (ImmutableMap) entry.getValue();
        Map.Entry entry2 = (Map.Entry) immutableMap.entrySet().OooO00o().get(this.f19589OooO[i]);
        return ImmutableTable.OooO0oO(entry.getKey(), entry2.getKey(), entry2.getValue());
    }

    @Override // com.google.common.collect.o0O00OOO
    public final V OooOOoo(int i) {
        ImmutableMap immutableMap = (ImmutableMap) this.f19590OooO0o.values().OooO00o().get(this.f19592OooO0oo[i]);
        return immutableMap.values().OooO00o().get(this.f19589OooO[i]);
    }

    @Override // com.google.common.collect.o0O
    public final int size() {
        return this.f19592OooO0oo.length;
    }
}
