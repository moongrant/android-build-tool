...
import p301o0O0o0Oo.OooOo;

/* JADX INFO: loaded from: classes3.dex */
public final class OooO0OO {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public static final Pattern f20218OooO0Oo = Pattern.compile("[0-9]+s");

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public static final Charset f20219OooO0o0 = Charset.forName("UTF-8");

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final Context f20220OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final p298o0O0o00o.OooO0OO<o0Oo0oo> f20221OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final OooOo f20222OooO0OO = new OooOo();

    public OooO0OO(@NonNull Context context, @NonNull p298o0O0o00o.OooO0OO<o0Oo0oo> oooO0OO) {
        this.f20220OooO00o = context;
        this.f20221OooO0O0 = oooO0OO;
    }
    ...
    public static void OooO0O0(HttpURLConnection httpURLConnection, @Nullable String str, @NonNull String str2, @NonNull String str3) {
        ...
        String str4 = null;
        if (errorStream != null) {
            BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(errorStream, f20219OooO0o0));
            try {
    ...
    public static long OooO0Oo(String str) {
        Preconditions.checkArgument(f20218OooO0Oo.matcher(str).matches(), "Invalid Expiration Timestamp.");
    ...
    public static OooO0O0 OooO0o(HttpURLConnection httpURLConnection) throws IOException, AssertionError {
        ...
        JsonReader jsonReader = new JsonReader(new InputStreamReader(inputStream, f20219OooO0o0));
        Long lValueOf = 0L;
    ...
    public final HttpURLConnection OooO0OO(URL url, String str) throws FirebaseInstallationsException {
        ...
        try {
            ...
            Context context = this.f20220OooO00o;
            httpURLConnection.addRequestProperty("X-Android-Package", context.getPackageName());
            o0Oo0oo o0oo0oo2 = this.f20221OooO0O0.get();
            if (o0oo0oo2 != null) {
                try {
                    httpURLConnection.addRequestProperty("x-firebase-client", (String) Tasks.await(o0oo0oo2.OooO00o()));
