...
public final class OooO0o {
    ...
    public static final class OooO00o extends FilterInputStream {
        ...
        public long f20267OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public long f20268OooO0o0;

        public OooO00o(InputStream inputStream) {
            super(inputStream);
            this.f20268OooO0o0 = -1L;
            this.f20267OooO0Oo = 1048577L;
        }

        @Override // java.io.FilterInputStream, java.io.InputStream
        public final int available() throws IOException {
            return (int) Math.min(((FilterInputStream) this).in.available(), this.f20267OooO0Oo);
        }

        @Override // java.io.FilterInputStream, java.io.InputStream
        public final synchronized void mark(int i) {
            ((FilterInputStream) this).in.mark(i);
            this.f20268OooO0o0 = this.f20267OooO0Oo;
        }

        @Override // java.io.FilterInputStream, java.io.InputStream
        public final int read() throws IOException {
            if (this.f20267OooO0Oo == 0) {
                return -1;
            }
        ...
        public final synchronized void reset() throws IOException {
            ...
            if (this.f20268OooO0o0 == -1) {
                throw new IOException("Mark not set");
            }
            ((FilterInputStream) this).in.reset();
            this.f20267OooO0Oo = this.f20268OooO0o0;
        }

        @Override // java.io.FilterInputStream, java.io.InputStream
        public final long skip(long j) throws IOException {
            long jSkip = ((FilterInputStream) this).in.skip(Math.min(j, this.f20267OooO0Oo));
            this.f20267OooO0Oo -= jSkip;
            return jSkip;
        }

        @Override // java.io.FilterInputStream, java.io.InputStream
        public final int read(byte[] bArr, int i, int i2) throws IOException {
            long j = this.f20267OooO0Oo;
            if (j == 0) {
                return -1;
            }
            int i3 = ((FilterInputStream) this).in.read(bArr, i, (int) Math.min(i2, j));
            if (i3 != -1) {
                this.f20267OooO0Oo -= (long) i3;
            }
            return i3;
        }
    }
