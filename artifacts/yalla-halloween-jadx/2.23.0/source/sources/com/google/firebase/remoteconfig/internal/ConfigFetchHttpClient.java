...
public class ConfigFetchHttpClient {
    ...
    public static final Pattern f20519OooO0oo = Pattern.compile("^[^:]+:([0-9]+):(android|ios|web):([0-9a-f]+)");

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final Context f20520OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final String f20521OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final String f20522OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final String f20523OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final long f20524OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final String f20525OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final long f20526OooO0oO;

    public ConfigFetchHttpClient(Context context, String str, String str2, String str3, long j, long j2) {
        this.f20520OooO00o = context;
        this.f20521OooO0O0 = str;
        this.f20522OooO0OO = str2;
        Matcher matcher = f20519OooO0oo.matcher(str);
        this.f20523OooO0Oo = matcher.matches() ? matcher.group(1) : null;
        this.f20525OooO0o0 = str3;
        this.f20524OooO0o = j;
        this.f20526OooO0oO = j2;
    }
    ...
    public final JSONObject OooO00o(String str, String str2, Map<String, String> map, Long l) throws FirebaseRemoteConfigClientException {
        ...
        map2.put(RemoteConfigConstants$RequestFieldKey.APP_ID, this.f20521OooO0O0);
        Context context = this.f20520OooO00o;
        ...
        try {
            ...
            if (packageInfo != null) {
                ...
                map2.put(RemoteConfigConstants$RequestFieldKey.APP_BUILD, Long.toString(i >= 28 ? OooO.OooO0O0(packageInfo) : packageInfo.versionCode));
            }
    ...
    public final HttpURLConnection OooO0O0() throws FirebaseRemoteConfigException {
        try {
            return (HttpURLConnection) new URL(String.format("https://firebaseremoteconfig.googleapis.com/v1/projects/%s/namespaces/%s:fetch", this.f20523OooO0Oo, this.f20525OooO0o0)).openConnection();
        } catch (IOException e) {
    ...
    public ConfigFetchHandler.FetchResponse fetch(HttpURLConnection httpURLConnection, String str, String str2, Map<String, String> map, String str3, Map<String, String> map2, Long l, Date date) throws FirebaseRemoteConfigException {
        ...
        httpURLConnection.setConnectTimeout((int) timeUnit.toMillis(this.f20524OooO0o));
        httpURLConnection.setReadTimeout((int) timeUnit.toMillis(this.f20526OooO0oO));
        httpURLConnection.setRequestProperty("If-None-Match", str3);
        httpURLConnection.setRequestProperty("X-Goog-Api-Key", this.f20522OooO0OO);
        Context context = this.f20520OooO00o;
        ...
        try {
            try {
                ...
                try {
                    Date date2 = o000000O.f42546OooO0oO;
                    JSONObject jSONObject3 = new JSONObject();
                    Date date3 = o000000O.f42546OooO0oO;
                    ...
                    o000000O o000000o2 = new o000000O(jSONObject3, date, jSONArray2, jSONObject4, string != null ? Long.parseLong(string) : 0L);
                    try {
                        z = !jSONObjectOooO0OO.get("state").equals("NO_CHANGE");
                    } catch (JSONException unused8) {
                        z = true;
                    }
                    return !z ? new ConfigFetchHandler.FetchResponse(1, o000000o2, null) : new ConfigFetchHandler.FetchResponse(0, o000000o2, headerField);
