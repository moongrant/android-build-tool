...
public final class ReflectiveTypeAdapterFactory implements o0OOO0o {
    ...
    public class OooO00o extends OooO0OO {
        ...
        public final /* synthetic */ boolean f20660OooO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Field f20661OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ o0ooOOo f20662OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ boolean f20663OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ OooOOO0 f20664OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ TypeToken f20665OooO0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(String str, boolean z, boolean z2, Field field, boolean z3, o0ooOOo o0ooooo, OooOOO0 oooOOO0, TypeToken typeToken, boolean z4) {
            super(str, z, z2);
            this.f20661OooO0Oo = field;
            this.f20663OooO0o0 = z3;
            this.f20662OooO0o = o0ooooo;
            this.f20664OooO0oO = oooOOO0;
            this.f20665OooO0oo = typeToken;
            this.f20660OooO = z4;
        }
        ...
        public final void OooO00o(JsonReader jsonReader, Object obj) throws IllegalAccessException, IOException {
            Object obj2 = this.f20662OooO0o.read(jsonReader);
            if (obj2 == null && this.f20660OooO) {
                return;
            }
            this.f20661OooO0Oo.set(obj, obj2);
        }

        @Override // com.google.gson.internal.bind.ReflectiveTypeAdapterFactory.OooO0OO
        public final void OooO0O0(JsonWriter jsonWriter, Object obj) throws IllegalAccessException, IOException {
            Object obj2 = this.f20661OooO0Oo.get(obj);
            boolean z = this.f20663OooO0o0;
            o0ooOOo oooO0o = this.f20662OooO0o;
            if (!z) {
                oooO0o = new OooO0o(this.f20664OooO0oO, oooO0o, this.f20665OooO0oo.getType());
            }
        ...
        public final boolean OooO0OO(Object obj) throws IllegalAccessException, IOException {
            return this.f20667OooO0O0 && this.f20661OooO0Oo.get(obj) != obj;
        }
    }

    public static final class OooO0O0<T> extends o0ooOOo<T> {
        private final Map<String, OooO0OO> boundFields;
        private final oo000o<T> constructor;

        public OooO0O0(oo000o<T> oo000oVar, Map<String, OooO0OO> map) {
        ...
        public T read(JsonReader jsonReader) throws IOException {
            ...
            try {
                ...
                while (jsonReader.hasNext()) {
                    ...
                    if (oooO0OO == null || !oooO0OO.f20668OooO0OO) {
            ...
            try {
                for (OooO0OO oooO0OO : this.boundFields.values()) {
                    if (oooO0OO.OooO0OO(t)) {
                        jsonWriter.name(oooO0OO.f20666OooO00o);
    ...
    public static abstract class OooO0OO {
        ...
        public final String f20666OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final boolean f20667OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final boolean f20668OooO0OO;

        public OooO0OO(String str, boolean z, boolean z2) {
            this.f20666OooO00o = str;
            this.f20667OooO0O0 = z;
            this.f20668OooO0OO = z2;
        }
    ...
    private OooO0OO createBoundField(OooOOO0 oooOOO0, Field field, String str, TypeToken<?> typeToken, boolean z, boolean z2) {
        ...
        o0ooOOo<?> typeAdapter = jsonAdapter != null ? this.jsonAdapterFactory.getTypeAdapter(this.constructorConstructor, oooOOO0, typeToken, jsonAdapter) : null;
            ...
            while (i < length) {
                ...
                if (zExcludeField || zExcludeField2) {
                    try {
                        ...
                        if (oooO0OO3 != null) {
                            throw new IllegalArgumentException(type + " declares multiple JSON fields named " + oooO0OO3.f20666OooO00o);
                        }
                    } catch (Exception e) {
