...
public final class GetOperationRequest extends GeneratedMessageV3 implements MessageOrBuilder {
    ...
    public static final GetOperationRequest f20759OooO0o = new GetOperationRequest();

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public static final OooO00o f20760OooO0oO = new OooO00o();

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public volatile Object f20761OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public byte f20762OooO0o0;
    ...
    public static final class OooO0O0 extends GeneratedMessageV3.Builder<OooO0O0> implements MessageOrBuilder {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public Object f20763OooO0Oo;

        public OooO0O0() {
            this.f20763OooO0Oo = "";
            GetOperationRequest getOperationRequest = GetOperationRequest.f20759OooO0o;
        }
        ...
        public final void OooO0Oo(GetOperationRequest getOperationRequest) {
            if (getOperationRequest == GetOperationRequest.f20759OooO0o) {
                return;
            }
            if (!getOperationRequest.getName().isEmpty()) {
                this.f20763OooO0Oo = getOperationRequest.f20761OooO0Oo;
                onChanged();
            }
            onChanged();
        }
        ...
        public final void OooO0o0(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws Throwable {
            ...
            try {
                try {
                    GetOperationRequest.f20760OooO0oO.getClass();
        ...
        public final Message build() {
            ...
            getOperationRequest.f20761OooO0Oo = this.f20763OooO0Oo;
            onBuilt();
        ...
        public final Message getDefaultInstanceForType() {
            return GetOperationRequest.f20759OooO0o;
        }

        @Override // com.google.protobuf.GeneratedMessageV3.Builder, com.google.protobuf.Message.Builder, com.google.protobuf.MessageOrBuilder
        public final Descriptors.Descriptor getDescriptorForType() {
            return o000O0O0.f42874OooO0OO;
        }

        @Override // com.google.protobuf.GeneratedMessageV3.Builder
        public final GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return o000O0O0.f42875OooO0Oo.ensureFieldAccessorsInitialized(GetOperationRequest.class, OooO0O0.class);
        }
    ...
    public GetOperationRequest(GeneratedMessageV3.Builder<?> builder) {
        super(builder);
        this.f20762OooO0o0 = (byte) -1;
    }

    @Override // com.google.protobuf.MessageLite, com.google.protobuf.Message
    /* JADX INFO: renamed from: OooO0O0, reason: merged with bridge method [inline-methods] */
    public final OooO0O0 toBuilder() {
        if (this == f20759OooO0o) {
            return new OooO0O0();
        }
    ...
    public final int getSerializedSize() {
        ...
        int serializedSize = this.unknownFields.getSerializedSize() + (GeneratedMessageV3.isStringEmpty(this.f20761OooO0Oo) ? 0 : 0 + GeneratedMessageV3.computeStringSize(1, this.f20761OooO0Oo));
    ...
    public final int hashCode() {
        ...
        int iHashCode = this.unknownFields.hashCode() + ((getName().hashCode() + o000Oo0.OooO00o(o000O0O0.f42874OooO0OO, 779, 37, 1, 53)) * 29);
    ...
    public final void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        if (!GeneratedMessageV3.isStringEmpty(this.f20761OooO0Oo)) {
            GeneratedMessageV3.writeString(codedOutputStream, 1, this.f20761OooO0Oo);
        }
                    ...
                    try {
                        ...
                        if (tag != 0) {
                            if (tag != 10) {
                                ...
                                this.f20761OooO0Oo = codedInputStream.readStringRequireUtf8();
                            }
                        }
                        z = true;
                    } catch (InvalidProtocolBufferException e) {
