...
public final class WaitOperationRequest extends GeneratedMessageV3 implements MessageOrBuilder {
    ...
    public static final WaitOperationRequest f20805OooO0oO = new WaitOperationRequest();

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public static final OooO00o f20806OooO0oo = new OooO00o();

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public volatile Object f20807OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public byte f20808OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public Duration f20809OooO0o0;
    ...
    public static final class OooO0O0 extends GeneratedMessageV3.Builder<OooO0O0> implements MessageOrBuilder {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public Object f20810OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public Duration f20811OooO0o0;

        public OooO0O0() {
            this.f20810OooO0Oo = "";
            WaitOperationRequest waitOperationRequest = WaitOperationRequest.f20805OooO0oO;
        }
        ...
        public final WaitOperationRequest buildPartial() {
            ...
            waitOperationRequest.f20807OooO0Oo = this.f20810OooO0Oo;
            waitOperationRequest.f20809OooO0o0 = this.f20811OooO0o0;
            onBuilt();
        ...
        public final void OooO0Oo() {
            super.clear();
            this.f20810OooO0Oo = "";
            this.f20811OooO0o0 = null;
        }

        public final void OooO0o(WaitOperationRequest waitOperationRequest) {
            if (waitOperationRequest == WaitOperationRequest.f20805OooO0oO) {
                return;
            }
            if (!waitOperationRequest.getName().isEmpty()) {
                this.f20810OooO0Oo = waitOperationRequest.f20807OooO0Oo;
                onChanged();
            }
            if (waitOperationRequest.f20809OooO0o0 != null) {
                Duration durationOooO0O0 = waitOperationRequest.OooO0O0();
                Duration duration = this.f20811OooO0o0;
                if (duration != null) {
                    this.f20811OooO0o0 = Duration.newBuilder(duration).mergeFrom(durationOooO0O0).buildPartial();
                } else {
                    this.f20811OooO0o0 = durationOooO0O0;
                }
                onChanged();
            }
            onChanged();
        ...
        public final void OooO0oO(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws Throwable {
            ...
            try {
                try {
                    WaitOperationRequest.f20806OooO0oo.getClass();
        ...
        public final Message getDefaultInstanceForType() {
            return WaitOperationRequest.f20805OooO0oO;
        }

        @Override // com.google.protobuf.GeneratedMessageV3.Builder, com.google.protobuf.Message.Builder, com.google.protobuf.MessageOrBuilder
        public final Descriptors.Descriptor getDescriptorForType() {
            return o000O0O0.f42884OooOOO0;
        }

        @Override // com.google.protobuf.GeneratedMessageV3.Builder
        public final GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return o000O0O0.f42883OooOOO.ensureFieldAccessorsInitialized(WaitOperationRequest.class, OooO0O0.class);
        }
    ...
    public WaitOperationRequest(GeneratedMessageV3.Builder<?> builder) {
        super(builder);
        this.f20808OooO0o = (byte) -1;
    }

    public final Duration OooO0O0() {
        Duration duration = this.f20809OooO0o0;
    ...
    public final boolean equals(Object obj) {
        ...
        Duration duration = this.f20809OooO0o0;
        if ((duration != null) != (waitOperationRequest.f20809OooO0o0 != null)) {
            return false;
        }
    ...
    @Override // com.google.protobuf.MessageLiteOrBuilder, com.google.protobuf.MessageOrBuilder
    public final Message getDefaultInstanceForType() {
        return f20805OooO0oO;
    }

    public final String getName() {
        Object obj = this.f20807OooO0Oo;
        if (obj instanceof String) {
            return (String) obj;
        }
        String stringUtf8 = ((ByteString) obj).toStringUtf8();
        this.f20807OooO0Oo = stringUtf8;
        return stringUtf8;
    }

    @Override // com.google.protobuf.GeneratedMessageV3, com.google.protobuf.MessageLite, com.google.protobuf.Message
    public final Parser<WaitOperationRequest> getParserForType() {
        return f20806OooO0oo;
    }
    ...
    public final int getSerializedSize() {
        ...
        int iComputeStringSize = GeneratedMessageV3.isStringEmpty(this.f20807OooO0Oo) ? 0 : 0 + GeneratedMessageV3.computeStringSize(1, this.f20807OooO0Oo);
        if (this.f20809OooO0o0 != null) {
    ...
    public final int hashCode() {
        ...
        int iHashCode = getName().hashCode() + o000Oo0.OooO00o(o000O0O0.f42884OooOOO0, 779, 37, 1, 53);
        if (this.f20809OooO0o0 != null) {
    ...
    public final Message.Builder newBuilderForType() {
        return f20805OooO0oO.toBuilder();
    }
    ...
    public final void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        if (!GeneratedMessageV3.isStringEmpty(this.f20807OooO0Oo)) {
            GeneratedMessageV3.writeString(codedOutputStream, 1, this.f20807OooO0Oo);
        }
        if (this.f20809OooO0o0 != null) {
        ...
        while (!z) {
            try {
                try {
                    ...
                    if (tag != 0) {
                        if (tag == 10) {
                            this.f20807OooO0Oo = codedInputStream.readStringRequireUtf8();
                        } else if (tag != 18) {
                            ...
                            this.f20809OooO0o0 = duration2;
                            if (builder != null) {
                                builder.mergeFrom(duration2);
                                this.f20809OooO0o0 = builder.buildPartial();
                            }
                        }
                    }
                    z = true;
