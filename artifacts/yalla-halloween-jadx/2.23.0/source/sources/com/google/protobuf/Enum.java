...
public final class Enum extends GeneratedMessageV3 implements EnumOrBuilder {
    ...
    public int hashCode() {
        ...
        if (getEnumvalueCount() > 0) {
            iHashCode = getEnumvalueList().hashCode() + o000000O.OooO00o(iHashCode, 37, 2, 53);
        }
        if (getOptionsCount() > 0) {
            iHashCode = getOptionsList().hashCode() + o000000O.OooO00o(iHashCode, 37, 3, 53);
        }
        if (hasSourceContext()) {
            iHashCode = getSourceContext().hashCode() + o000000O.OooO00o(iHashCode, 37, 4, 53);
        }
        int iHashCode2 = getUnknownFields().hashCode() + ((o000000O.OooO00o(iHashCode, 37, 5, 53) + this.syntax_) * 29);
