...
public final class FieldMask extends GeneratedMessageV3 implements FieldMaskOrBuilder {
    ...
    public int getSerializedSize() {
        ...
        for (int i2 = 0; i2 < this.paths_.size(); i2++) {
            iOooO0Oo = OooO0O0.OooO0Oo(this.paths_, i2, iOooO0Oo);
        }
        int serializedSize = getUnknownFields().getSerializedSize() + (getPathsList().size() * 1) + 0 + iOooO0Oo;
    ...
    public int hashCode() {
        ...
        if (getPathsCount() > 0) {
            iHashCode = o000000O.OooO00o(iHashCode, 37, 1, 53) + getPathsList().hashCode();
        }
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        ...
        while (iOooO00o < this.paths_.size()) {
            iOooO00o = OooO0OO.OooO00o(this.paths_, iOooO00o, codedOutputStream, 1, iOooO00o, 1);
        }
