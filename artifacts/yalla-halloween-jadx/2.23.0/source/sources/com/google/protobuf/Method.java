...
public final class Method extends GeneratedMessageV3 implements MethodOrBuilder {
    ...
    public int hashCode() {
        ...
        if (getOptionsCount() > 0) {
            iHashBoolean = getOptionsList().hashCode() + o000000O.OooO00o(iHashBoolean, 37, 6, 53);
        }
        int iHashCode = getUnknownFields().hashCode() + ((o000000O.OooO00o(iHashBoolean, 37, 7, 53) + this.syntax_) * 29);
