...
public class RepeatedFieldBuilder<MType extends GeneratedMessage, BType extends GeneratedMessage.Builder, IType extends MessageOrBuilder> implements GeneratedMessage.BuilderParent {
    ...
    private List<MType> f20815messages;
    ...
    private void ensureBuilders() {
        if (this.builders == null) {
            this.builders = new ArrayList(this.f20815messages.size());
            for (int i = 0; i < this.f20815messages.size(); i++) {
    ...
    private void ensureMutableMessageList() {
        ...
        this.f20815messages = new ArrayList(this.f20815messages);
    ...
    public RepeatedFieldBuilder<MType, BType, IType> addAllMessages(Iterable<? extends MType> iterable) {
        ...
        if (size >= 0) {
            List<MType> list = this.f20815messages;
    ...
    public List<MType> build() {
        ...
        if (!z2 && this.builders == null) {
            return this.f20815messages;
        }
        if (!z2) {
            int i = 0;
            while (true) {
                if (i >= this.f20815messages.size()) {
                    z = true;
                    break;
                }
                MType mtype = this.f20815messages.get(i);
        ...
        ensureMutableMessageList();
        for (int i2 = 0; i2 < this.f20815messages.size(); i2++) {
            this.f20815messages.set(i2, (MType) getMessage(i2, true));
        }
        List<MType> listUnmodifiableList = Collections.unmodifiableList(this.f20815messages);
        this.f20815messages = listUnmodifiableList;
        this.isMessagesListMutable = false;
        return listUnmodifiableList;
    }

    public void clear() {
        this.f20815messages = Collections.emptyList();
        this.isMessagesListMutable = false;
        List<SingleFieldBuilder<MType, BType, IType>> list = this.builders;
        if (list != null) {
    ...
    public BType getBuilder(int i) {
        ...
        SingleFieldBuilder<MType, BType, IType> singleFieldBuilder = this.builders.get(i);
        if (singleFieldBuilder == null) {
            SingleFieldBuilder<MType, BType, IType> singleFieldBuilder2 = new SingleFieldBuilder<>(this.f20815messages.get(i), this, this.isClean);
    ...
    public int getCount() {
        return this.f20815messages.size();
    }
    ...
    public IType getMessageOrBuilder(int i) {
        List<SingleFieldBuilder<MType, BType, IType>> list = this.builders;
        if (list == null) {
            return this.f20815messages.get(i);
        }
        SingleFieldBuilder<MType, BType, IType> singleFieldBuilder = list.get(i);
        return singleFieldBuilder == null ? this.f20815messages.get(i) : (IType) singleFieldBuilder.getMessageOrBuilder();
    }
    ...
    public boolean isEmpty() {
        return this.f20815messages.isEmpty();
    }
    ...
    public RepeatedFieldBuilder<MType, BType, IType> setMessage(int i, MType mtype) {
        ...
        Internal.checkNotNull(mtype);
        ensureMutableMessageList();
        this.f20815messages.set(i, mtype);
        List<SingleFieldBuilder<MType, BType, IType>> list = this.builders;
    ...
    public RepeatedFieldBuilder<MType, BType, IType> addMessage(int i, MType mtype) {
        Internal.checkNotNull(mtype);
        ensureMutableMessageList();
        this.f20815messages.add(i, mtype);
        List<SingleFieldBuilder<MType, BType, IType>> list = this.builders;
        if (list != null) {
            list.add(i, null);
        }
    ...
    public BType addBuilder(int i, MType mtype) {
        ...
        ensureBuilders();
        SingleFieldBuilder<MType, BType, IType> singleFieldBuilder = new SingleFieldBuilder<>(mtype, this, this.isClean);
        this.f20815messages.add(i, null);
