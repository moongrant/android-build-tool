...
public final class PluginProtos {
    ...
    public static final class CodeGeneratorRequest extends GeneratedMessageV3 implements CodeGeneratorRequestOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i2 = 0; i2 < this.fileToGenerate_.size(); i2++) {
                iOooO0Oo = OooO0O0.OooO0Oo(this.fileToGenerate_, i2, iOooO0Oo);
            }
            int size = (getFileToGenerateList().size() * 1) + iOooO0Oo + 0;
            if ((this.bitField0_ & 1) != 0) {
        ...
        public int hashCode() {
            ...
            if (getFileToGenerateCount() > 0) {
                iHashCode = o000000O.OooO00o(iHashCode, 37, 1, 53) + getFileToGenerateList().hashCode();
            }
            if (hasParameter()) {
                iHashCode = o000000O.OooO00o(iHashCode, 37, 2, 53) + getParameter().hashCode();
            }
            if (getProtoFileCount() > 0) {
                iHashCode = o000000O.OooO00o(iHashCode, 37, 15, 53) + getProtoFileList().hashCode();
            }
            if (hasCompilerVersion()) {
                iHashCode = o000000O.OooO00o(iHashCode, 37, 3, 53) + getCompilerVersion().hashCode();
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            while (iOooO00o < this.fileToGenerate_.size()) {
                iOooO00o = OooO0OO.OooO00o(this.fileToGenerate_, iOooO00o, codedOutputStream, 1, iOooO00o, 1);
            }
            if ((this.bitField0_ & 1) != 0) {
    ...
    public static final class CodeGeneratorResponse extends GeneratedMessageV3 implements CodeGeneratorResponseOrBuilder {
        ...
        public static final class File extends GeneratedMessageV3 implements FileOrBuilder {
            ...
            public int hashCode() {
                ...
                int iHashCode = getDescriptor().hashCode() + 779;
                if (hasName()) {
                    iHashCode = o000000O.OooO00o(iHashCode, 37, 1, 53) + getName().hashCode();
                }
                if (hasInsertionPoint()) {
                    iHashCode = o000000O.OooO00o(iHashCode, 37, 2, 53) + getInsertionPoint().hashCode();
                }
                if (hasContent()) {
                    iHashCode = o000000O.OooO00o(iHashCode, 37, 15, 53) + getContent().hashCode();
                }
                if (hasGeneratedCodeInfo()) {
                    iHashCode = o000000O.OooO00o(iHashCode, 37, 16, 53) + getGeneratedCodeInfo().hashCode();
                }
                int iHashCode2 = getUnknownFields().hashCode() + (iHashCode * 29);
                this.memoizedHashCode = iHashCode2;
                return iHashCode2;
        ...
        public int hashCode() {
            ...
            int iHashCode = getDescriptor().hashCode() + 779;
            if (hasError()) {
                iHashCode = o000000O.OooO00o(iHashCode, 37, 1, 53) + getError().hashCode();
            }
            if (hasSupportedFeatures()) {
                iHashCode = o000000O.OooO00o(iHashCode, 37, 2, 53) + Internal.hashLong(getSupportedFeatures());
            }
            if (getFileCount() > 0) {
                iHashCode = o000000O.OooO00o(iHashCode, 37, 15, 53) + getFileList().hashCode();
            }
            int iHashCode2 = getUnknownFields().hashCode() + (iHashCode * 29);
            this.memoizedHashCode = iHashCode2;
            return iHashCode2;
    ...
    public static final class Version extends GeneratedMessageV3 implements VersionOrBuilder {
        ...
        public int hashCode() {
            ...
            int iHashCode = getDescriptor().hashCode() + 779;
            if (hasMajor()) {
                iHashCode = o000000O.OooO00o(iHashCode, 37, 1, 53) + getMajor();
            }
            if (hasMinor()) {
                iHashCode = o000000O.OooO00o(iHashCode, 37, 2, 53) + getMinor();
            }
            if (hasPatch()) {
                iHashCode = o000000O.OooO00o(iHashCode, 37, 3, 53) + getPatch();
            }
            if (hasSuffix()) {
                iHashCode = o000000O.OooO00o(iHashCode, 37, 4, 53) + getSuffix().hashCode();
            }
            int iHashCode2 = getUnknownFields().hashCode() + (iHashCode * 29);
            this.memoizedHashCode = iHashCode2;
            return iHashCode2;
