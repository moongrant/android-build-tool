...
public final class FieldMaskUtil {
    ...
    public static FieldMask fromFieldNumbers(Class<? extends Message> cls, Iterable<Integer> iterable) {
        ...
        for (Integer num : iterable) {
            ...
            o000oOoO.OooO0o0(fieldDescriptorFindFieldByNumber != null, String.format("%s is not a valid field number for %s.", num, cls));
    ...
    public static FieldMask fromJsonString(String str) {
        o0OO00O o0oo00o2 = new o0OO00O(new o0ooOOo(new OooO0o.OooO0OO(",".charAt(0))));
        str.getClass();
        FieldMask.Builder builderNewBuilder = FieldMask.newBuilder();
        Iterator<String> itOooO00o = o0oo00o2.f19090OooO0O0.OooO00o(o0oo00o2, str);
    ...
    public static FieldMask fromStringList(Iterable<String> iterable) {
        return fromStringList(OooO00o.f19063OooO0Oo, iterable);
    }
    ...
    public static FieldMask fromStringList(Descriptors.Descriptor descriptor, Iterable<String> iterable) {
        descriptor.getClass();
        return fromStringList(new oo000o(descriptor), iterable);
    }
        ...
        for (String str : iterable) {
            if (!str.isEmpty()) {
                if (optional.OooO0O0() && !isValid(optional.OooO00o(), str)) {
                    StringBuilder sbOooO0O0 = o000Oo0.OooO0O0(str, " is not a valid path for ");
    ...
    public static FieldMask fromFieldNumbers(Class<? extends Message> cls, int... iArr) {
        ...
        if (iArr.length == 0) {
            ...
            oooO00o = new com.google.common.primitives.OooO0o.OooO00o(0, iArr.length, iArr);
        }
