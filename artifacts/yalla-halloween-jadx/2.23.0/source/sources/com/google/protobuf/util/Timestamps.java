...
public final class Timestamps {
    ...
    public static Timestamp add(Timestamp timestamp, Duration duration) {
        ...
        long jOooO00o = OooO0OO.OooO00o(timestamp.getSeconds(), duration.getSeconds());
    ...
    public static Duration between(Timestamp timestamp, Timestamp timestamp2) {
        ...
        return Durations.normalizedDuration(OooO0OO.OooO0OO(timestamp2.getSeconds(), timestamp.getSeconds()), OooO0O0.OooO00o(timestamp2.getNanos(), timestamp.getNanos()));
    }
    ...
    public static Timestamp normalizedTimestamp(long j, int i) {
        ...
        if (j2 <= -1000000000 || j2 >= 1000000000) {
            j = OooO0OO.OooO00o(j, j2 / 1000000000);
            i = (int) (j2 % 1000000000);
        }
        if (i < 0) {
            i = (int) (((long) i) + 1000000000);
            j = OooO0OO.OooO0OO(j, 1L);
        }
    ...
    public static Timestamp parse(String str) throws ParseException {
        ...
        if (iIndexOf == -1) {
            throw new ParseException(o000oOoO.OooO00o("Failed to parse timestamp: invalid timestamp \"", str, "\""), 0);
        }
    ...
    public static Timestamp subtract(Timestamp timestamp, Duration duration) {
        checkValid(timestamp);
        Durations.checkValid(duration);
        return normalizedTimestamp(OooO0OO.OooO0OO(timestamp.getSeconds(), duration.getSeconds()), OooO0O0.OooO00o(timestamp.getNanos(), duration.getNanos()));
    }

    public static long toMicros(Timestamp timestamp) {
        checkValid(timestamp);
        return OooO0OO.OooO00o(OooO0OO.OooO0O0(timestamp.getSeconds(), AnimationKt.MillisToNanos), ((long) timestamp.getNanos()) / 1000);
    }

    public static long toMillis(Timestamp timestamp) {
        checkValid(timestamp);
        return OooO0OO.OooO00o(OooO0OO.OooO0O0(timestamp.getSeconds(), 1000L), ((long) timestamp.getNanos()) / AnimationKt.MillisToNanos);
    }

    public static long toNanos(Timestamp timestamp) {
        checkValid(timestamp);
        return OooO0OO.OooO00o(OooO0OO.OooO0O0(timestamp.getSeconds(), 1000000000L), timestamp.getNanos());
    }
