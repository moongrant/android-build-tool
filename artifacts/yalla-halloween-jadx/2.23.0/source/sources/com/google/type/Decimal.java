...
import p324o0O0ooo.o00O0;

/* JADX INFO: loaded from: classes2.dex */
public final class Decimal extends GeneratedMessageV3 implements MessageOrBuilder {

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public static final Decimal f21107OooO0o = new Decimal();

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public static final OooO00o f21108OooO0oO = new OooO00o();

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public volatile Object f21109OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public byte f21110OooO0o0;
    ...
    public static final class OooO0O0 extends GeneratedMessageV3.Builder<OooO0O0> implements MessageOrBuilder {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public Object f21111OooO0Oo;

        public OooO0O0() {
            this.f21111OooO0Oo = "";
            Decimal decimal = Decimal.f21107OooO0o;
        }
        ...
        public final void OooO0Oo(Decimal decimal) {
            if (decimal == Decimal.f21107OooO0o) {
                return;
            }
            if (!decimal.getValue().isEmpty()) {
                this.f21111OooO0Oo = decimal.f21109OooO0Oo;
                onChanged();
            }
            onChanged();
        }
        ...
        public final void OooO0o0(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws Throwable {
            ...
            try {
                try {
                    Decimal.f21108OooO0oO.getClass();
        ...
        public final Message build() {
            ...
            decimal.f21109OooO0Oo = this.f21111OooO0Oo;
            onBuilt();
        ...
        public final Message getDefaultInstanceForType() {
            return Decimal.f21107OooO0o;
        }

        @Override // com.google.protobuf.GeneratedMessageV3.Builder, com.google.protobuf.Message.Builder, com.google.protobuf.MessageOrBuilder
        public final Descriptors.Descriptor getDescriptorForType() {
            return o00O0.f42922OooO00o;
        }

        @Override // com.google.protobuf.GeneratedMessageV3.Builder
        public final GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return o00O0.f42923OooO0O0.ensureFieldAccessorsInitialized(Decimal.class, OooO0O0.class);
        }
    ...
    public Decimal(GeneratedMessageV3.Builder<?> builder) {
        super(builder);
        this.f21110OooO0o0 = (byte) -1;
    }

    @Override // com.google.protobuf.MessageLite, com.google.protobuf.Message
    /* JADX INFO: renamed from: OooO0O0, reason: merged with bridge method [inline-methods] */
    public final OooO0O0 toBuilder() {
        if (this == f21107OooO0o) {
            return new OooO0O0();
        }
    ...
    public final int getSerializedSize() {
        ...
        int serializedSize = this.unknownFields.getSerializedSize() + (GeneratedMessageV3.isStringEmpty(this.f21109OooO0Oo) ? 0 : 0 + GeneratedMessageV3.computeStringSize(1, this.f21109OooO0Oo));
    ...
    public final String getValue() {
        Object obj = this.f21109OooO0Oo;
        if (obj instanceof String) {
            return (String) obj;
        }
        String stringUtf8 = ((ByteString) obj).toStringUtf8();
        this.f21109OooO0Oo = stringUtf8;
        return stringUtf8;
    }
    ...
    public final int hashCode() {
        ...
        int iHashCode = this.unknownFields.hashCode() + ((getValue().hashCode() + o000Oo0.OooO00o(o00O0.f42922OooO00o, 779, 37, 1, 53)) * 29);
    ...
    public final void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        if (!GeneratedMessageV3.isStringEmpty(this.f21109OooO0Oo)) {
            GeneratedMessageV3.writeString(codedOutputStream, 1, this.f21109OooO0Oo);
        }
                    ...
                    try {
                        ...
                        if (tag != 0) {
                            if (tag != 10) {
                                ...
                                this.f21109OooO0Oo = codedInputStream.readStringRequireUtf8();
                            }
                        }
                        z = true;
                    } catch (InvalidProtocolBufferException e) {
