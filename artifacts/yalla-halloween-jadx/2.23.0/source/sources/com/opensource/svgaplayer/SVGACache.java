...
public final class SVGACache {
    ...
    @NotNull
    public static Type f21257OooO00o = Type.DEFAULT;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public static String f21258OooO0O0 = "/";
    ...
    public static String OooO0o0() {
        if (!Intrinsics.areEqual(f21258OooO0O0, "/")) {
            File file = new File(f21258OooO0O0);
            if (!file.exists()) {
                file.mkdirs();
            }
        }
        return f21258OooO0O0;
    }
}
