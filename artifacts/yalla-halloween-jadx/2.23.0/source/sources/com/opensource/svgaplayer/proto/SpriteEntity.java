...
public final class SpriteEntity extends Message<SpriteEntity, Builder> {
    ...
    public static final class ProtoAdapter_SpriteEntity extends ProtoAdapter<SpriteEntity> {
        ...
        public int encodedSize(SpriteEntity spriteEntity) {
            String str = spriteEntity.imageKey;
            int iEncodedSizeWithTag = FrameEntity.ADAPTER.asRepeated().encodedSizeWithTag(2, spriteEntity.frames) + (str != null ? ProtoAdapter.STRING.encodedSizeWithTag(1, str) : 0);
            String str2 = spriteEntity.matteKey;
            return spriteEntity.unknownFields().OooO0o0() + iEncodedSizeWithTag + (str2 != null ? ProtoAdapter.STRING.encodedSizeWithTag(3, str2) : 0);
        }

        @Override // com.squareup.wire.ProtoAdapter
        public SpriteEntity redact(SpriteEntity spriteEntity) throws IOException {
    ...
    public SpriteEntity(String str, List<FrameEntity> list, String str2) {
        this(str, list, str2, ByteString.f60866OooO0oO);
    }
    ...
    public int hashCode() {
        ...
        int iHashCode2 = (this.frames.hashCode() + ((iHashCode + (str != null ? str.hashCode() : 0)) * 37)) * 37;
