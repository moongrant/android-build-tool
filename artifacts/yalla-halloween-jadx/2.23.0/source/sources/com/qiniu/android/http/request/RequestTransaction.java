...
public class RequestTransaction {
    ...
    public void completeParts(boolean z, String str, String str2, List<Map<String, Object>> list, final RequestCompleteHandler requestCompleteHandler) {
        ...
        String strOooO00o = o0OoOo0.OooO00o("/buckets/" + this.token.bucket, "/objects/" + resumeV2EncodeKey(this.key), o00O00OO.OooO00o("/uploads/", str2));
    ...
    public void initPart(boolean z, final RequestCompleteHandler requestCompleteHandler) {
        ...
        map.put("Content-Type", "application/octet-stream");
        map.put("User-Agent", this.userAgent);
        this.regionRequest.post(o0OoOo0.OooO00o("/buckets/" + this.token.bucket, "/objects/" + resumeV2EncodeKey(this.key), "/uploads"), z, null, map, new RequestShouldRetryHandler() { // from class: com.qiniu.android.http.request.RequestTransaction.11
            @Override // com.qiniu.android.http.request.handler.RequestShouldRetryHandler
            public boolean shouldRetry(ResponseInfo responseInfo, JSONObject jSONObject) {
                return !responseInfo.isOK();
            }
    ...
    public void makeFile(long j, String str, String[] strArr, boolean z, final RequestCompleteHandler requestCompleteHandler) {
        ...
        if (map2 != null) {
            for (String str5 : map2.keySet()) {
                ...
                if (str6 != null) {
                    StringBuilder sbOooO00o = p004OooO0oO.o0OoOo0.OooO00o("/", str5, "/");
                    sbOooO00o.append(UrlSafeBase64.encodeToString(str6));
                    strOooO00o = OooOOOO.OooO00o(strOooO00o, sbOooO00o.toString());
                }
            }
        }
        ...
        if (map3 != null) {
            for (String str7 : map3.keySet()) {
                ...
                if (str8 != null) {
                    StringBuilder sbOooO00o2 = p004OooO0oO.o0OoOo0.OooO00o("/", str7, "/");
                    sbOooO00o2.append(UrlSafeBase64.encodeToString(str8));
                    strOooO00o = OooOOOO.OooO00o(strOooO00o, sbOooO00o2.toString());
                }
            }
        }
