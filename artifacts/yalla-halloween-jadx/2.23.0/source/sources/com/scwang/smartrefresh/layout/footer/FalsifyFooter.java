...
public class FalsifyFooter extends InternalAbstract implements OooO0o {

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public OooOO0O f21427OooO0oO;
    ...
    public final void OooO00o(@NonNull OooOO0O oooOO0O, int i, int i2) {
        this.f21427OooO0oO = oooOO0O;
        SmartRefreshLayout.this.f21341Oooo0oO = false;
    }

    @Override // com.scwang.smartrefresh.layout.internal.InternalAbstract, o0OO0o.OooOO0
    public final void OooO0o(@NonNull OooOOO0 oooOOO0, int i, int i2) {
        OooOO0O oooOO0O = this.f21427OooO0oO;
        if (oooOO0O != null) {
            ((SmartRefreshLayout.OooOOO) oooOO0O).OooO0Oo(RefreshState.None);
            ((SmartRefreshLayout.OooOOO) this.f21427OooO0oO).OooO0Oo(RefreshState.LoadFinish);
        }
    }
