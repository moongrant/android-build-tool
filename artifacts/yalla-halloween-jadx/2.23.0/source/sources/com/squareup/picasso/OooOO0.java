...
public final class OooOO0 extends o00oO0o {
    ...
    public static final UriMatcher f21718OooO0O0;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final Context f21719OooO00o;

    static {
        UriMatcher uriMatcher = new UriMatcher(-1);
        f21718OooO0O0 = uriMatcher;
    ...
    public OooOO0(Context context) {
        this.f21719OooO00o = context;
    }

    @Override // com.squareup.picasso.o00oO0o
    public final boolean OooO0O0(o00Ooo o00ooo2) {
        Uri uri = o00ooo2.f21794OooO0Oo;
        return "content".equals(uri.getScheme()) && ContactsContract.Contacts.CONTENT_URI.getHost().equals(uri.getHost()) && f21718OooO0O0.match(o00ooo2.f21794OooO0Oo) != -1;
    }
    ...
    public final o00oO0o.OooO00o OooO0o0(o00Ooo o00ooo2) throws IOException {
        ...
        ContentResolver contentResolver = this.f21719OooO00o.getContentResolver();
        Uri uriLookupContact = o00ooo2.f21794OooO0Oo;
        int iMatch = f21718OooO0O0.match(uriLookupContact);
        if (iMatch != 1) {
            if (iMatch != 2) {
                if (iMatch == 3) {
