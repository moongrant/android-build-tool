...
public final class o000000O {
    ...
    public static final StringBuilder f21773OooO00o = new StringBuilder();
    ...
    public static String OooO0OO(o00Ooo o00ooo2) {
        StringBuilder sb = f21773OooO00o;
        ...
        if (uri != null) {
            ...
            sb.append(o00ooo2.f21796OooO0o0);
        }
        sb.append('\n');
        float f = o00ooo2.f21801OooOO0o;
        if (f != 0.0f) {
            sb.append("rotation:");
            sb.append(f);
            if (o00ooo2.f21804OooOOOO) {
                sb.append('@');
                sb.append(o00ooo2.f21803OooOOO0);
                sb.append('x');
                sb.append(o00ooo2.f21802OooOOO);
            }
            sb.append('\n');
        }
        if (o00ooo2.OooO00o()) {
            sb.append("resize:");
            sb.append(o00ooo2.f21797OooO0oO);
            sb.append('x');
            sb.append(o00ooo2.f21798OooO0oo);
            sb.append('\n');
        }
        if (o00ooo2.f21790OooO) {
            sb.append("centerCrop");
            sb.append('\n');
        } else if (o00ooo2.f21799OooOO0) {
            sb.append("centerInside");
            sb.append('\n');
        }
        List<o0O0O00> list = o00ooo2.f21795OooO0o;
        if (list != null) {
            int size = list.size();
    ...
    public static String OooO0o(OooO0OO oooO0OO, String str) {
        ...
        if (oooO00o != null) {
            sb.append(oooO00o.f21678OooO0O0.OooO0O0());
        }
        ...
        if (arrayList != null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                sb.append(((com.squareup.picasso.OooO00o) arrayList.get(i)).f21678OooO0O0.OooO0O0());
            }
        }
        return sb.toString();
    }
