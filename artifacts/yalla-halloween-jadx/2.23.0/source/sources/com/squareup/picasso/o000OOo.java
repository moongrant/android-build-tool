...
public final class o000OOo implements Downloader {
    ...
    public static volatile HttpResponseCache f21774OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final Object f21775OooO0OO = new Object();

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public static final OooO00o f21776OooO0Oo = new OooO00o();

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final Context f21777OooO00o;
    ...
    public o000OOo(Context context) {
        this.f21777OooO00o = context.getApplicationContext();
    }
    ...
    public final Downloader.OooO00o OooO00o(Uri uri, int i) throws IOException {
        String string;
        Context context = this.f21777OooO00o;
        if (f21774OooO0O0 == null) {
            try {
                synchronized (f21775OooO0OO) {
                    if (f21774OooO0O0 == null) {
        ...
        if (i != 0) {
            if ((NetworkPolicy.OFFLINE.index & i) != 0) {
                ...
                StringBuilder sb = f21776OooO0Oo.get();
                sb.setLength(0);
