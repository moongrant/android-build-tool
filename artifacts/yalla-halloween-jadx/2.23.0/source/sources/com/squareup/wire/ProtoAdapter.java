...
public abstract class ProtoAdapter<E> {
    ...
    public final E decode(@NotNull InputStream stream) throws IOException {
        ...
        return decode(o000O0Oo.OooO0O0(o000O0Oo.OooO0oo(stream)));
    }
    ...
    public final void encode(@NotNull OutputStream stream, E value) throws IOException {
        Intrinsics.checkNotNullParameter(stream, "stream");
        o00 o00VarOooO00o = o000O0Oo.OooO00o(o000O0Oo.OooO0o0(stream));
        encode(o00VarOooO00o, value);
        o00VarOooO00o.OooOO0o();
    }

    @NotNull
    public final ByteString encodeByteString(E value) throws IOException {
        o00000O o00000o = new o00000O();
        encode(o00000o, value);
    ...
    public final E decode(@NotNull o0000 source) throws IOException {
    ...
    public void encode(@NotNull ReverseProtoWriter writer, E value) throws IOException {
        Intrinsics.checkNotNullParameter(writer, "writer");
        writer.writeForward$wire_runtime(new ProtoAdapterKt.C09301(this, value));
    }

    public final void encode(@NotNull o0000Ooo sink, E value) throws IOException {
    ...
    public static final class EnumConstantNotFoundException extends IllegalArgumentException {
        ...
        public EnumConstantNotFoundException(int i, @Nullable KClass<?> kClass) {
            Class javaClass;
            StringBuilder sbOooO00o = o0000O0.OooO00o("Unknown enum tag ", i, " for ");
            String name = null;
            if (kClass != null && (javaClass = JvmClassMappingKt.getJavaClass((KClass) kClass)) != null) {
                name = javaClass.getName();
            }
            sbOooO00o.append((Object) name);
