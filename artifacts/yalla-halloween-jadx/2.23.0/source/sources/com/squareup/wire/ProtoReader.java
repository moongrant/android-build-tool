...
public final class ProtoReader {
    ...
    @NotNull
    private final List<o00000O> bufferStack;
    private long limit;
    ...
    @NotNull
    private final o0000 source;
    private int state;
    private int tag;

    public ProtoReader(@NotNull o0000 source) {
    ...
    private final void skipGroup(int expectedEndTag) throws IOException {
        while (this.pos < this.limit && !this.source.oo000o()) {
    ...
    public final ByteString m4189forEachTag(@NotNull Function1<? super Integer, ? extends Object> tagHandler) throws IOException {
    ...
    public final long beginMessage() throws IOException {
        ...
        if (i > this.bufferStack.size()) {
            this.bufferStack.add(new o00000O());
        }
    ...
    public final ByteString endMessageAndGetUnknownFields(long token) throws IOException {
        ...
        if (this.pos == this.limit || i == 0) {
            this.limit = token;
            o00000O o00000o = this.bufferStack.get(i);
            return o00000o.f60177OooO0o0 > 0 ? o00000o.Oooo0o0() : ByteString.f60866OooO0oO;
        }
        throw new IOException("Expected to end at " + this.limit + " but was " + this.pos);
    }
