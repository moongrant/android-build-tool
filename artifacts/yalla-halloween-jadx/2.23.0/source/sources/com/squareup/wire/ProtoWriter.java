...
public final class ProtoWriter {
    ...
    public ProtoWriter(@NotNull o0000Ooo sink) {
    ...
    public final void writeVarint32(int value) throws IOException {
        while ((value & (-128)) != 0) {
            this.sink.o00oO0o((value & 127) | 128);
            value >>>= 7;
        }
        this.sink.o00oO0o(value);
    }

    public final void writeVarint64(long value) throws IOException {
        while (((-128) & value) != 0) {
            this.sink.o00oO0o((((int) value) & 127) | 128);
            value >>>= 7;
        }
        this.sink.o00oO0o((int) value);
    }
}
