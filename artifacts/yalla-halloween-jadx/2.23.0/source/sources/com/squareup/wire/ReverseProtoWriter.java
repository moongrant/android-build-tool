...
public final class ReverseProtoWriter {
    ...
    @NotNull
    private o00000O tail = new o00000O();

    @NotNull
    private o00000O head = new o00000O();

    @NotNull
    private final o00000O.OooO00o cursor = new o00000O.OooO00o();
    ...
    public ReverseProtoWriter() {
        ...
        this.forwardBuffer = LazyKt.lazy(lazyThreadSafetyMode, (Function0) new Function0<o00000O>() { // from class: com.squareup.wire.ReverseProtoWriter$forwardBuffer$2
    ...
    private final void emitCurrentSegment() throws IOException {
        ...
        this.head.Oooo000(this.tail);
        o00000O o00000o = this.tail;
        this.tail = this.head;
        this.head = o00000o;
        this.array = bArr2;
        this.arrayLimit = 0;
    ...
    public final o00000O getForwardBuffer() {
        return (o00000O) this.forwardBuffer.getValue();
    }
    ...
    private final void require(int minByteCount) throws IOException {
        ...
        o00000O.OooO00o oooO00o = this.cursor;
        oooO00o.getClass();
        boolean z = false;
        if (!(minByteCount > 0)) {
        ...
        o00000O o00000o = oooO00o.f60179OooO0Oo;
        if (o00000o == null) {
            throw new IllegalStateException("not attached to a buffer".toString());
        }
        if (!oooO00o.f60181OooO0o0) {
            throw new IllegalStateException("expandBuffer() only permitted for read/write buffers".toString());
        }
        long j = o00000o.f60177OooO0o0;
        o0O0ooO o0o0oooOooooOo = o00000o.OooooOo(minByteCount);
        int i = 8192 - o0o0oooOooooOo.f60251OooO0OO;
        o0o0oooOooooOo.f60251OooO0OO = 8192;
        o00000o.f60177OooO0o0 = ((long) i) + j;
        oooO00o.f60180OooO0o = o0o0oooOooooOo;
        oooO00o.f60182OooO0oO = j;
        oooO00o.f60183OooO0oo = o0o0oooOooooOo.f60249OooO00o;
        oooO00o.f60178OooO = 8192 - i;
        oooO00o.f60184OooOO0 = 8192;
        o00000O.OooO00o oooO00o2 = this.cursor;
        if (oooO00o2.f60182OooO0oO == 0) {
            int i2 = oooO00o2.f60184OooOO0;
            byte[] bArr = oooO00o2.f60183OooO0oo;
        ...
        byte[] bArr2 = this.cursor.f60183OooO0oo;
        Intrinsics.checkNotNull(bArr2);
        this.array = bArr2;
        this.arrayLimit = this.cursor.f60184OooOO0;
    }

    public final int getByteCount() {
        return (this.array.length - this.arrayLimit) + ((int) this.tail.f60177OooO0o0);
    }
