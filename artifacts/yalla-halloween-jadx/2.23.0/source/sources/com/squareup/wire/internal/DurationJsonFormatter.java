...
public final class DurationJsonFormatter implements JsonFormatter<Duration> {
    ...
    public /* bridge */ /* synthetic */ Object toStringOrNumber(Duration duration) {
        return toStringOrNumber2(o000OO00.OooO00o(duration));
    }
    ...
    public String toStringOrNumber2(@NotNull Duration value) {
        ...
        if (nano == 0) {
            return OooO0O0.OooO00o(new Object[]{str, Long.valueOf(seconds)}, 2, "%s%ds", "format(this, *args)");
        }
        if (nano % DurationKt.NANOS_IN_MILLIS == 0) {
            return OooO0O0.OooO00o(new Object[]{str, Long.valueOf(seconds), Long.valueOf(((long) nano) / AnimationKt.MillisToNanos)}, 3, "%s%d.%03ds", "format(this, *args)");
        }
        return nano % 1000 == 0 ? OooO0O0.OooO00o(new Object[]{str, Long.valueOf(seconds), Long.valueOf(((long) nano) / 1000)}, 3, "%s%d.%06ds", "format(this, *args)") : OooO0O0.OooO00o(new Object[]{str, Long.valueOf(seconds), Long.valueOf(((long) nano) / 1)}, 3, "%s%d.%09ds", "format(this, *args)");
    }
}
