...
public final class Internal {
    ...
    public static final <T> List<T> m4190redactElements(@NotNull List<? extends T> list, @NotNull ProtoAdapter<T> protoAdapter) {
        return Internal__InternalKt.m4192redactElements(list, protoAdapter);
    }
    ...
    @NotNull
    /* JADX INFO: renamed from: -redactElements, reason: not valid java name */
    public static final <K, V> Map<K, V> m4191redactElements(@NotNull Map<K, ? extends V> map, @NotNull ProtoAdapter<V> protoAdapter) {
        return Internal__InternalKt.m4193redactElements(map, protoAdapter);
    }
