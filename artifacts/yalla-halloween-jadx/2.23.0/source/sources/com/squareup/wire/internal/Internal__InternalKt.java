...
final /* synthetic */ class Internal__InternalKt {
    ...
    public static final <T> List<T> m4192redactElements(@NotNull List<? extends T> list, @NotNull ProtoAdapter<T> adapter) {
    ...
    public static final void checkElementsNotNull(@NotNull List<?> list) {
        ...
        while (i < size) {
            int i2 = i + 1;
            if (list.get(i) == null) {
                throw new NullPointerException(OooO00o.OooO00o("Element at index ", i, " is null"));
            }
            i = i2;
        }
    }
    ...
    public static final <T> T immutableCopyOfStruct(@NotNull String name, T t) {
        ...
        if (!(t instanceof Map)) {
            StringBuilder sbOooO00o = o0OoOo0.OooO00o("struct value ", name, " must be a JSON type (null, Boolean, Double, String, List, or Map) but was ");
            sbOooO00o.append(getTypeName$Internal__InternalKt(t));
            sbOooO00o.append(": ");
            sbOooO00o.append(t);
    ...
    @NotNull
    /* JADX INFO: renamed from: -redactElements, reason: not valid java name */
    public static final <K, V> Map<K, V> m4193redactElements(@NotNull Map<K, ? extends V> map, @NotNull ProtoAdapter<V> adapter) {
