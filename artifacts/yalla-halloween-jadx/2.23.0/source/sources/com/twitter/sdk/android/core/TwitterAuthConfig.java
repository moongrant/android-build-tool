...
public class TwitterAuthConfig implements Parcelable {
    ...
    public final String f21976OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final String f21977OooO0o0;
    ...
    public TwitterAuthConfig(String str, String str2) {
        ...
        this.f21976OooO0Oo = str.trim();
        this.f21977OooO0o0 = str2.trim();
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        parcel.writeString(this.f21976OooO0Oo);
        parcel.writeString(this.f21977OooO0o0);
    }

    public TwitterAuthConfig(Parcel parcel) {
        this.f21976OooO0Oo = parcel.readString();
        this.f21977OooO0o0 = parcel.readString();
    }
}
