    ...
    public static void OooO00o(ArrayList arrayList, ArrayList arrayList2) {
        if (arrayList != null) {
            ...
            while (it.hasNext()) {
                ...
                oooOOO0.f22309OooO00o += i2;
                oooOOO0.f22310OooO0O0 += i2;
            }
        }
    }
    ...
    public static void OooO0O0(ArrayList arrayList, ArrayList arrayList2) {
        ...
        while (it.hasNext()) {
            ...
            while (i2 < size) {
                ...
                int i6 = iArr[1];
                int i7 = i6 - i5;
                if (i6 < oooOOO0.f22309OooO00o) {
                    i += i7;
                    i4++;
                } else if (i6 < oooOOO0.f22310OooO0O0) {
                    i3 += i7;
                }
                i2++;
            }
            int i8 = i3 + i;
            oooOOO0.f22309OooO00o -= i8;
            oooOOO0.f22310OooO0O0 -= i8;
            i2 = i4;
        }
    }
}
