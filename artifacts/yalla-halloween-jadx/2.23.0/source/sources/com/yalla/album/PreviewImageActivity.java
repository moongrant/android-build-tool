...
import p358o0OOOooO.o000O0Oo;

/* JADX INFO: loaded from: classes4.dex */
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Lcom/yalla/album/PreviewImageActivity;", "Landroidx/appcompat/app/AppCompatActivity;", "<init>", "()V", "LibSelectPicture_release"}, k = 1, mv = {1, 8, 0})
...
public final class PreviewImageActivity extends AppCompatActivity {
    ...
    public static final /* synthetic */ int f22538OooO0o0 = 0;
    ...
    public static final class OooO00o extends BaseQuickAdapter<String, BaseViewHolder> {
        ...
        public final /* synthetic */ ViewPager2 f22539OooOo;

        /* JADX INFO: renamed from: OooOoO, reason: collision with root package name */
        public final /* synthetic */ PreviewImageActivity f22540OooOoO;

        /* JADX INFO: renamed from: OooOoO0, reason: collision with root package name */
        public final /* synthetic */ ViewGroup f22541OooOoO0;
        ...
        public OooO00o(ArrayList<String> arrayList, ViewPager2 viewPager2, ViewGroup viewGroup, PreviewImageActivity previewImageActivity, int i) {
            super(i, arrayList);
            this.f22539OooOo = viewPager2;
            this.f22541OooOoO0 = viewGroup;
            this.f22540OooOoO = previewImageActivity;
        }
        ...
        public final void OooO0oO(BaseViewHolder helper, String str) {
            ...
            o00O0OOO.OooO0OO oooO0OO = o00O0OO.OooO0OO.f36535OooO00o;
            final ViewPager2 viewPager2 = this.f22539OooOo;
            oooO0OO.OooO00o(viewPager2.getContext(), item, photoView);
            final ViewGroup viewGroup = this.f22541OooOoO0;
            final PreviewImageActivity previewImageActivity = this.f22540OooOoO;
            photoView.setOnClickListener(new View.OnClickListener() { // from class: o0OOOooO.o000OO0O
                ...
                public final void onClick(View view) {
                    ...
                    ViewGroup titleParent = viewGroup;
                    Intrinsics.checkNotNullExpressionValue(titleParent, "titleParent");
                    titleParent.setVisibility((titleParent.getVisibility() == 0) ^ true ? 0 : 8);
                    Window window = this$0.getWindow();
                    if (titleParent.getVisibility() == 0) {
    ...
    public static final class OooO0O0 extends ViewPager2.OnPageChangeCallback {
        ...
        public final /* synthetic */ TextView f22542OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final /* synthetic */ ArrayList f22543OooO0O0;

        public OooO0O0(TextView textView, ArrayList arrayList) {
            this.f22542OooO00o = textView;
            this.f22543OooO0O0 = arrayList;
        }

        @Override // androidx.viewpager2.widget.ViewPager2.OnPageChangeCallback
        public final void onPageSelected(int i) {
            this.f22542OooO00o.setText((i + 1) + "/" + this.f22543OooO0O0.size());
        }
    }
    ...
    public final void onCreate(@Nullable Bundle bundle) {
        ...
        int i = o0OO0.OooO00o.select_picture_color_FF161619;
        Object obj = ContextCompat.f5271OooO00o;
        ...
        setContentView(OooO0o.activity_preview_images);
        int i2 = 0;
        ...
        findViewById(OooO0OO.picture_left).setOnClickListener(new o000O0Oo(this, i2));
        ...
        if (viewPager2 != null) {
            viewPager2.setAdapter(new OooO00o(stringArrayListExtra, viewPager2, viewGroup, this, OooO0o.layout_show_image_select));
