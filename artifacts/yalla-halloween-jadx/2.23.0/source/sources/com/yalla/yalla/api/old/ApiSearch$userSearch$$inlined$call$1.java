...
public final class ApiSearch$userSearch$$inlined$call$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<List<UserInfo>>>, Object> {
    ...
    public final /* synthetic */ o0O0ooO f22701OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ApiSearch$userSearch$$inlined$call$1(o0O0ooO o0o0ooo, Continuation continuation) {
        super(2, continuation);
        this.f22701OooO0o0 = o0o0ooo;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new ApiSearch$userSearch$$inlined$call$1(this.f22701OooO0o0, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        try {
            if (i == 0) {
                ...
                o0O0ooO o0o0ooo = this.f22701OooO0o0;
