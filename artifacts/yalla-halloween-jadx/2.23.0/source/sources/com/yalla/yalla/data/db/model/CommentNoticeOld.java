...
public class CommentNoticeOld {
    ...
    public CommentMessageModel toCommentMessageModel() {
        ...
        commentMessageModel.setFrom((CommentMessageModel.FromBean) oOo00OO0.OooO00o(this.from, CommentMessageModel.FromBean.class));
        commentMessageModel.setMoment((CommentMessageModel.MomentBean) oOo00OO0.OooO00o(this.moment, CommentMessageModel.MomentBean.class));
    ...
    public String toString() {
        ...
        sb.append("', hostId=");
        return Oooo000.OooO0OO(sb, this.hostId, '}');
    }
}
