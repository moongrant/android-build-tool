...
public final class MicEmojiManager$loadUrlConfig$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f22832OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            String url = o000OOo0.OooO0OO("/Webservers/Bar/EmojiConfig");
            Intrinsics.checkNotNullParameter(url, "url");
            o0O0ooO o0o0ooo = new o0O0ooO(url, 0);
            o0o0ooo.OooO0O0(Boxing.boxInt(1), "type");
            MicEmojiManager$loadUrlConfig$1$invokeSuspend$$inlined$call$1 micEmojiManager$loadUrlConfig$1$invokeSuspend$$inlined$call$1 = new MicEmojiManager$loadUrlConfig$1$invokeSuspend$$inlined$call$1(o0o0ooo, null);
            this.f22832OooO0Oo = 1;
        ...
        if (apiResult.isSuccess()) {
            s0.f45256OooO00o.postValue(apiResult.getData());
        }
