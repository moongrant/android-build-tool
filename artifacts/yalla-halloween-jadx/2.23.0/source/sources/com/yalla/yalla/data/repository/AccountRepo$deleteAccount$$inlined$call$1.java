...
public final class AccountRepo$deleteAccount$$inlined$call$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Response<String>>, Object> {
    ...
    public int f22875OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ int f22876OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ o0O00oO0 f22877OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final /* synthetic */ Integer f22878OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final /* synthetic */ String f22879OooO0oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AccountRepo$deleteAccount$$inlined$call$1(o0O00oO0 o0o00oo1, Continuation continuation, int i, Integer num, String str) {
        super(2, continuation);
        this.f22877OooO0o0 = o0o00oo1;
        this.f22876OooO0o = i;
        this.f22878OooO0oO = num;
        this.f22879OooO0oo = str;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new AccountRepo$deleteAccount$$inlined$call$1(this.f22877OooO0o0, continuation, this.f22876OooO0o, this.f22878OooO0oO, this.f22879OooO0oo);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
        ...
        int i = this.f22875OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            final o0O00oO0 o0o00oo1 = this.f22877OooO0o0;
            this.f22875OooO0Oo = 1;
            ...
            params.put("reasonType", String.valueOf(this.f22876OooO0o));
            Integer num = this.f22878OooO0oO;
            if (num != null) {
                params.put("reasonTypeTwo", String.valueOf(num.intValue()));
            }
            String str = this.f22879OooO0oo;
            if (str != null) {
                params.put("inputText", str);
            }
            OooO0OO.OooO0OO(o0000O.f44100OooOoo, "/Webservers/User/CancelAccount", params, callback);
