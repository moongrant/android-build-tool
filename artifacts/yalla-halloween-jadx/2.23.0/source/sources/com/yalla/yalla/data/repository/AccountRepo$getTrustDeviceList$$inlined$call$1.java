...
public final class AccountRepo$getTrustDeviceList$$inlined$call$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<List<TrustedDevice>>>, Object> {
    ...
    public int f22894OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ o0O0ooO f22895OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AccountRepo$getTrustDeviceList$$inlined$call$1(o0O0ooO o0o0ooo, Continuation continuation) {
        super(2, continuation);
        this.f22895OooO0o0 = o0o0ooo;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new AccountRepo$getTrustDeviceList$$inlined$call$1(this.f22895OooO0o0, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f22894OooO0Oo;
        Object obj2 = null;
        try {
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                o0O0ooO o0o0ooo = this.f22895OooO0o0;
