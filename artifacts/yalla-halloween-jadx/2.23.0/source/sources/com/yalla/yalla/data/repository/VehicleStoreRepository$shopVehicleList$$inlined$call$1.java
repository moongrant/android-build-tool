...
public final class VehicleStoreRepository$shopVehicleList$$inlined$call$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Response<List<ShopVehicleListModel>>>, Object> {
    ...
    public int f23257OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ String f23258OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ o0O00oO0 f23259OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public VehicleStoreRepository$shopVehicleList$$inlined$call$1(o0O00oO0 o0o00oo1, Continuation continuation, String str) {
        super(2, continuation);
        this.f23259OooO0o0 = o0o00oo1;
        this.f23258OooO0o = str;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new VehicleStoreRepository$shopVehicleList$$inlined$call$1(this.f23259OooO0o0, continuation, this.f23258OooO0o);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
        ...
        int i = this.f23257OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            final o0O00oO0 o0o00oo1 = this.f23259OooO0o0;
            this.f23257OooO0Oo = 1;
            ...
            String vehicleType = this.f23258OooO0o;
            Intrinsics.checkNotNullParameter(vehicleType, "vehicleType");
            LinkedHashMap params = oO00o000.OooO00o();
            Intrinsics.checkNotNullExpressionValue(params, "params");
            params.put("vehicleType", vehicleType);
            OooO0OO.OooO0O0(null, o0000O.f44100OooOoo, "/Webservers/Shop/ShopVehicleList", params, oooO0O0);
