...
public final class VoteRepo$getUserInfo$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f23296OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ long f23297OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ long f23298OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final /* synthetic */ MutableLiveData<ApiResult<RoomUserInfoDTO>> f23299OooO0oO;
    ...
    public VoteRepo$getUserInfo$1$1(long j, long j2, MutableLiveData<ApiResult<RoomUserInfoDTO>> mutableLiveData, Continuation<? super VoteRepo$getUserInfo$1$1> continuation) {
        ...
        this.f23298OooO0o0 = j;
        this.f23297OooO0o = j2;
        this.f23299OooO0oO = mutableLiveData;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new VoteRepo$getUserInfo$1$1(this.f23298OooO0o0, this.f23297OooO0o, this.f23299OooO0oO, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f23296OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            String url = o000OOo0.OooO0OO("Webservers/Bar/GetUserInfo");
            Intrinsics.checkNotNullParameter(url, "url");
            o0O0ooO o0o0ooo = new o0O0ooO(url, 0);
            o0o0ooo.OooO0O0(Boxing.boxLong(this.f23298OooO0o0), "touserid");
            o0o0ooo.OooO0O0(Boxing.boxLong(this.f23297OooO0o), "barid");
            VoteRepo$getUserInfo$1$1$invokeSuspend$$inlined$call$1 voteRepo$getUserInfo$1$1$invokeSuspend$$inlined$call$1 = new VoteRepo$getUserInfo$1$1$invokeSuspend$$inlined$call$1(o0o0ooo, null);
            this.f23296OooO0Oo = 1;
        ...
        this.f23299OooO0oO.postValue((ApiResult) obj);
