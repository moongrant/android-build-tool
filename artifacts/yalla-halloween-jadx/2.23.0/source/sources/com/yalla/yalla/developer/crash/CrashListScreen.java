...
@Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0005\bÇ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0006\u0010\u0007J\u0013\u0010\u0004\u001a\u00020\u0003*\u00020\u0002H\u0017¢\u0006\u0004\b\u0004\u0010\u0005¨\u0006\b"}, d2 = {"Lcom/yalla/yalla/developer/crash/CrashListScreen;", "Lo0o0OOO0/o00O00O;", "Landroidx/compose/foundation/layout/ColumnScope;", "", "Content", "(Landroidx/compose/foundation/layout/ColumnScope;Landroidx/compose/runtime/Composer;I)V", "<init>", "()V", "Common_YallaRelease"}, k = 1, mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nCrashListScreen.kt\nKotlin\n*S Kotlin\n*F\n+ 1 CrashListScreen.kt\ncom/yalla/yalla/developer/crash/CrashListScreen\n+ 2 ViewModel.kt\nandroidx/lifecycle/viewmodel/compose/ViewModelKt\n+ 3 Box.kt\nandroidx/compose/foundation/layout/BoxKt\n+ 4 Layout.kt\nandroidx/compose/ui/layout/LayoutKt\n+ 5 Composables.kt\nandroidx/compose/runtime/ComposablesKt\n+ 6 Composer.kt\nandroidx/compose/runtime/Updater\n*L\n1#1,67:1\n81#2,11:68\n66#3,6:79\n72#3:113\n76#3:118\n78#4,11:85\n91#4:117\n456#5,8:96\n464#5,3:110\n467#5,3:114\n4144#6,6:104\n*S KotlinDebug\n*F\n+ 1 CrashListScreen.kt\ncom/yalla/yalla/developer/crash/CrashListScreen\n*L\n27#1:68,11\n44#1:79,6\n44#1:113\n44#1:118\n44#1:85,11\n44#1:117\n44#1:96,8\n44#1:110,3\n44#1:114,3\n44#1:104,6\n*E\n"})
public final class CrashListScreen extends o00O00O {
    ...
    public static final class OooO00o extends Lambda implements Function3<RowScope, Composer, Integer, Unit> {
        ...
        public final /* synthetic */ CrashListViewModel f23347OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(CrashListViewModel crashListViewModel) {
            super(3);
            this.f23347OooO0Oo = crashListViewModel;
        }
        ...
        public final Unit invoke(RowScope rowScope, Composer composer, Integer num) {
            ...
            if ((iIntValue & 81) == 16 && composer2.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-585971246, iIntValue, -1, "com.yalla.yalla.developer.crash.CrashListScreen.Content.<anonymous> (CrashListScreen.kt:28)");
                }
                TextKt.m1251Text4IGK_g("clear all", PaddingKt.m476padding3ABfNKs(ClickableKt.m202clickableXHw0xAI$default(Modifier.INSTANCE, false, null, null, new com.yalla.yalla.developer.crash.OooO0OO(this.f23347OooO0Oo), 7, null), Dp.m3765constructorimpl(10)), o0oO0O0o.f46946OooO0O0, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 6, 0, 131064);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ CrashListViewModel f23348OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(CrashListViewModel crashListViewModel, Continuation<? super OooO0O0> continuation) {
            super(2, continuation);
            this.f23348OooO0Oo = crashListViewModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0O0(this.f23348OooO0Oo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            CrashListViewModel crashListViewModel = this.f23348OooO0Oo;
    ...
    public static final class OooO0OO extends Lambda implements Function1<LazyListScope, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ CrashListViewModel f23349OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(CrashListViewModel crashListViewModel) {
            super(1);
            this.f23349OooO0Oo = crashListViewModel;
        }
        ...
        public final Unit invoke(LazyListScope lazyListScope) {
            ...
            final SnapshotStateList<Pair<String, File>> listLiveData = this.f23349OooO0Oo.getListLiveData();
            final CrashListScreen$Content$3$1$invoke$$inlined$items$default$1 crashListScreen$Content$3$1$invoke$$inlined$items$default$1 = CrashListScreen$Content$3$1$invoke$$inlined$items$default$1.f23343OooO0Oo;
            LazyColumn.items(listLiveData.size(), null, new Function1<Integer, Object>() { // from class: com.yalla.yalla.developer.crash.CrashListScreen$Content$3$1$invoke$$inlined$items$default$3
                ...
                public final Unit invoke(LazyItemScope lazyItemScope, Integer num, Composer composer, Integer num2) {
                    ...
                    if ((i & 731) == 146 && composer2.getSkipping()) {
                        ...
                        CardKt.m999CardFjzlyU(ClickableKt.m202clickableXHw0xAI$default(SizeKt.fillMaxWidth$default(PaddingKt.m476padding3ABfNKs(Modifier.INSTANCE, Dp.m3765constructorimpl(10)), 0.0f, 1, null), false, null, null, new OooO0o(pair), 7, null), null, o000OOo.OooO0OO(composer2).f37704OooO0OO, 0L, null, 0.0f, ComposableLambdaKt.composableLambda(composer2, 1194592952, true, new OooO(pair)), composer2, 1572864, 58);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                    }
    ...
    public static final class OooO0o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ int f23351OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ ColumnScope f23352OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(ColumnScope columnScope, int i) {
            super(2);
            this.f23352OooO0o0 = columnScope;
            this.f23351OooO0o = i;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f23351OooO0o | 1);
            CrashListScreen.this.Content(this.f23352OooO0o0, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public void Content(@NotNull ColumnScope columnScope, @Nullable Composer composer, int i) {
        ...
        if ((i & 1) == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            composer2 = composerStartRestartGroup;
            t1.OooO00o("Crash Log", 0.0f, 0L, null, null, null, null, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -585971246, true, new OooO00o(crashListViewModel)), null, composerStartRestartGroup, 12582918, 382);
            ...
            if (crashListViewModel.getListLiveData().isEmpty()) {
                ...
                TextKt.m1251Text4IGK_g("no data ", boxScopeInstance.align(companion, companion2.getCenter()), 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 6, 0, 131068);
