...
public final /* data */ class BadgePersonal {
    ...
    public String toString() {
        int i = this.rank;
        int i2 = this.sumStars;
        int i3 = this.copperNum;
        int i4 = this.silverNum;
        int i5 = this.goldNum;
        int i6 = this.diamondNum;
        boolean z = this.openDiamondMedal;
        StringBuilder sbOooO00o = o00000.OooO00o("BadgePersonal(rank=", i, ", sumStars=", i2, ", copperNum=");
        OooOOO0.OooO00o(sbOooO00o, i3, ", silverNum=", i4, ", goldNum=");
        OooOOO0.OooO00o(sbOooO00o, i5, ", diamondNum=", i6, ", openDiamondMedal=");
        sbOooO00o.append(z);
        sbOooO00o.append(")");
