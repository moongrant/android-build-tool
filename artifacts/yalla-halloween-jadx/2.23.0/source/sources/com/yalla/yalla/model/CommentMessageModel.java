...
public class CommentMessageModel extends AbsJavaBean {
    ...
    public MomentSendContentModel getMsgObj() {
        ...
        try {
            MomentSendContentModel momentSendContentModel2 = (MomentSendContentModel) oOo00OO0.OooO0O0(this.msg, new TypeToken<MomentSendContentModel>() { // from class: com.yalla.yalla.model.CommentMessageModel.1
            }.getType());
