...
public final class MoreTag {
    ...
    public static final MoreTag dislike = new MoreTag("dislike", 0, oO00OOo0.event_unSubscribe_confirm);
    public static final MoreTag hide = new MoreTag("hide", 1, oO00OOo0.Hide);
    public static final MoreTag reply = new MoreTag("reply", 2, oO00OOo0.reply);
    public static final MoreTag copy = new MoreTag("copy", 3, oO00OOo0.Copy);
    public static final MoreTag delete = new MoreTag("delete", 4, oO00OOo0.Delete);
    public static final MoreTag repost = new MoreTag("repost", 5, oO00OOo0.Repost);
    public static final MoreTag report = new MoreTag("report", 6, oO00OOo0.Report);
    public static final MoreTag deletePost = new MoreTag("deletePost", 7, oO00OOo0.Delete_Post);
    ...
    static {
        ...
        postRemoveOutOfTopic = new MoreTag("postRemoveOutOfTopic", 10, oO00OOo0.Remove_Post);
        DisableTheUser = new MoreTag("DisableTheUser", 11, oO00OOo0.Topic_No_Entry);
        postTopOfUser = new MoreTag("postTopOfUser", 12, i);
        postUnTopOfUser = new MoreTag("postUnTopOfUser", 13, i2);
        postEdit = new MoreTag("postEdit", 14, oO00OOo0.Moment_Edit_Page_Title);
        postEditHistory = new MoreTag("postEditHistory", 15, oO00OOo0.Moment_Edit_History_Select);
        $VALUES = $values();
    }
