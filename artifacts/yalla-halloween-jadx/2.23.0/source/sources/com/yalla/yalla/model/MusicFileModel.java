...
public final /* data */ class MusicFileModel {
    ...
    public int hashCode() {
        return this.songList.hashCode() + ((o0OO00O.OooO00o(this.filePath, this.fileName.hashCode() * 31, 31) + this.songsCount) * 31);
    }
    ...
    public String toString() {
        ...
        StringBuilder sbOooO0OO = OooO0o.OooO0OO("MusicFileModel(fileName=", str, ", filePath=", str2, ", songsCount=");
        sbOooO0OO.append(i);
        sbOooO0OO.append(", songList=");
