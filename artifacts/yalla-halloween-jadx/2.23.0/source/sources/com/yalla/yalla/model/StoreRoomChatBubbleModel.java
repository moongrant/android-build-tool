...
public final /* data */ class StoreRoomChatBubbleModel {
    ...
    public int hashCode() {
        int iOooO00o = o0OO00O.OooO00o(this.bubbleColour, o0OO00O.OooO00o(this.backgroundUrl, this.attachedPicUrl.hashCode() * 31, 31), 31);
        boolean z = this.canBuy;
        ?? r1 = z;
        if (z) {
            r1 = 1;
        }
        int iOooO00o2 = o0OO00O.OooO00o(this.h5Url, (((((((((((iOooO00o + r1) * 31) + this.canBuyUserType) * 31) + this.dayNum) * 31) + this.exclusiveLv) * 31) + this.flagType) * 31) + this.frozenDay) * 31, 31);
        boolean z2 = this.isHave;
        ?? r2 = z2;
        if (z2) {
            r2 = 1;
        }
        int iOooO00o3 = o0OO00O.OooO00o(this.replyColour, (((o0OO00O.OooO00o(this.picUrl, (((((((iOooO00o2 + r2) * 31) + this.limitNum) * 31) + this.obtainType) * 31) + this.obtainLevel) * 31, 31) + this.price) * 31) + this.promotionPrice) * 31, 31);
        boolean z3 = this.selected;
        return this.bubbleText.hashCode() + o0OO00O.OooO00o(this.waresName, (((((iOooO00o3 + (z3 ? 1 : z3)) * 31) + this.shopId) * 31) + this.timeLong) * 31, 31);
    }
    ...
    public String toString() {
        ...
        StringBuilder sbOooO0OO = OooO0o.OooO0OO("StoreRoomChatBubbleModel(attachedPicUrl=", str, ", backgroundUrl=", str2, ", bubbleColour=");
        sbOooO0OO.append(str3);
        sbOooO0OO.append(", canBuy=");
        sbOooO0OO.append(z);
        sbOooO0OO.append(", canBuyUserType=");
        OooOOO0.OooO00o(sbOooO0OO, i, ", dayNum=", i2, ", exclusiveLv=");
        OooOOO0.OooO00o(sbOooO0OO, i3, ", flagType=", i4, ", frozenDay=");
        sbOooO0OO.append(i5);
        sbOooO0OO.append(", h5Url=");
        sbOooO0OO.append(str4);
        sbOooO0OO.append(", isHave=");
        sbOooO0OO.append(z2);
        sbOooO0OO.append(", limitNum=");
        sbOooO0OO.append(i6);
        sbOooO0OO.append(", obtainType=");
        OooOOO0.OooO00o(sbOooO0OO, i7, ", obtainLevel=", i8, ", picUrl=");
        sbOooO0OO.append(str5);
        sbOooO0OO.append(", price=");
        sbOooO0OO.append(i9);
        sbOooO0OO.append(", promotionPrice=");
        sbOooO0OO.append(i10);
        sbOooO0OO.append(", replyColour=");
        sbOooO0OO.append(str6);
        sbOooO0OO.append(", selected=");
        sbOooO0OO.append(z3);
        sbOooO0OO.append(", shopId=");
        sbOooO0OO.append(i11);
        sbOooO0OO.append(", timeLong=");
        sbOooO0OO.append(i12);
        sbOooO0OO.append(", waresName=");
        sbOooO0OO.append(str7);
        sbOooO0OO.append(", bubbleText=");
        return o0O00o0.OooO0O0(sbOooO0OO, str8, ")");
    }
