...
public final /* data */ class SupportInfo implements Serializable {
    ...
    public static final /* data */ class UserData extends UserInfoModel {
        ...
        @Override // com.yalla.yalla.model.user.UserInfoModel, com.yalla.yalla.data.db.table.UserInfo
        @NotNull
        public String toString() {
            return oO00Oo00.OooO00o("UserData(number=", this.number, ", num=", this.num, ")");
        }
    ...
    @NotNull
    public String toString() {
        return "SupportInfo(updateAt=" + this.updateAt + ", data=" + this.data + ")";
    }
