...
public final class MomentCommentDetailModel implements Serializable {
    ...
    public final MomentSendContentModel getContent() {
        ...
        Object objOooO0O0 = oOo00OO0.OooO0O0(this.content, new TypeToken<MomentSendContentModel>() { // from class: com.yalla.yalla.model.moment.MomentCommentDetailModel.getContent.1
        }.getType());
    ...
    public final MomentCommentDetailModel setLocalCommentResultModel(@Nullable MomentCommentResultModel commentResultModel) {
        if (commentResultModel != null) {
            ...
            T value2 = o000000O.OooOOO().getValue();
            Intrinsics.checkNotNull(value2);
            this.sex = ((Number) value2).intValue();
            T value3 = o000000O.OooOO0o().getValue();
    ...
    public String toString() {
        ...
        sb.append(", content='");
        sb.append(str4);
        o000Oo0.OooO0O0.OooO00o(sb, "', num=", num, ", createTime=");
        sb.append(j2);
        sb.append(", isDel=");
        sb.append(z);
        sb.append(", son=");
