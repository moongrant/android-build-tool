...
public final class MomentEditModel implements Serializable {
    ...
    public final boolean isInEditChanged(@NotNull String content) {
        ...
        return (oo000o.OooO0O0(this.listSendPostImage, this.httpImagesFromEditMomentDetailUrl, new Function1<String, String>() { // from class: com.yalla.yalla.model.moment.MomentEditModel.isInEditChanged.1
    ...
    public final List<String> localImages() {
        ...
        for (String str : this.listSendPostImage) {
            if ((!StringsKt.isBlank(str)) && !o0000O0O.OooO0Oo(str)) {
                arrayList.add(str);
            }
        }
        return arrayList;
