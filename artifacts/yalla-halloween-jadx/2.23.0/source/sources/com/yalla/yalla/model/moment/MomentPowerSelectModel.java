...
public final class MomentPowerSelectModel implements Serializable {
    ...
    public final void setPower(int i) {
        if (i == MomentTypePower.Open.getValue()) {
            this.resId = oO00OOO.icon_moment_power_public;
            this.title = o0000.OooO0OO(oO00OOo0.Public);
            this.content = o0000.OooO0OO(oO00OOo0.All_users);
        } else if (i == MomentTypePower.Friend.getValue()) {
            this.resId = oO00OOO.icon_moment_power_friend;
            this.title = o0000.OooO0OO(oO00OOo0.Friends);
            this.content = o0000.OooO0OO(oO00OOo0.Friends_in_Yalla);
        } else if (i == MomentTypePower.Self.getValue()) {
            this.resId = oO00OOO.icon_moment_power_private;
            this.title = o0000.OooO0OO(oO00OOo0.Private);
            this.content = o0000.OooO0OO(oO00OOo0.Only_me);
        }
        this.power = i;
    }
