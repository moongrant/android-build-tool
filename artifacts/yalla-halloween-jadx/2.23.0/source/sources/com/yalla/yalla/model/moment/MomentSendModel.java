...
public final class MomentSendModel implements Serializable {
    ...
    public final MomentForwardContent getForwardContent() {
        try {
            if (o0000O0O.OooO0o(this.forwardContentStr)) {
                return (MomentForwardContent) OooOO0.OooO0O0(MomentForwardContent.class, this.forwardContentStr);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public final MomentPoll getMomentPoll() {
        try {
            if (this.type == 21 && o0000O0O.OooO0o(this.forwardContentStr)) {
                return (MomentPoll) OooOO0.OooO0O0(MomentPoll.class, this.forwardContentStr);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public final boolean isInEdit() {
        return o0000O0O.OooO0o(this.editToken);
    }
    ...
    public final List<MomentSelectMedia> localMedias() {
        ...
        for (MomentSelectMedia momentSelectMedia : this.listSendPostMedia) {
            if ((!StringsKt.isBlank(momentSelectMedia.getPath())) && !o0000O0O.OooO0Oo(momentSelectMedia.getPath())) {
    ...
    public String toString() {
        ...
        String strOooO00o = OooOO0.OooO00o(this.content);
        String strOooO00o2 = OooOO0.OooO00o(this.poll);
