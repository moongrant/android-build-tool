...
public final /* data */ class RoomMemberTaskInfoModel {
    ...
    public int hashCode() {
        ...
        return o0OO00O.OooO00o(this.taskPic, o0OO00O.OooO00o(this.taskName, (((o0OO00O.OooO00o(this.taskDesc, ((((((int) (j ^ (j >>> 32))) * 31) + ((int) ((j2 >>> 32) ^ j2))) * 31) + this.state) * 31, 31) + this.unitRewardVal) * 31) + this.taskId) * 31, 31), 31) + this.taskType;
    }
    ...
    public RoomMemberTaskInfoModel(long j, long j2, int i, @NotNull String str, int i2, int i3, @NotNull String str2, @NotNull String str3, int i4) {
        OooO0OO.OooO00o(str, "taskDesc", str2, "taskName", str3, "taskPic");
        this.completedVal = j;
        this.currVal = j2;
        this.state = i;
        this.taskDesc = str;
