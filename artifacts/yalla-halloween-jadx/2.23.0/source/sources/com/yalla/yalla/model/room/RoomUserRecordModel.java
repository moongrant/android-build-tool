...
public final /* data */ class RoomUserRecordModel {
    ...
    public int hashCode() {
        ...
        int iOooO00o = (o0OO00O.OooO00o(this.nickName, (((((((o0OO00O.OooO00o(this.headUrl, (o0OO00O.OooO00o(this.execUserName, ((((int) (j ^ (j >>> 32))) * 31) + ((int) (j2 ^ (j2 >>> 32)))) * 31, 31) + this.execUserPosition) * 31, 31) + this.id) * 31) + this.isForbid) * 31) + this.isVip) * 31) + this.kaVipLv) * 31, 31) + this.nvipLv) * 31;
    ...
    public String toString() {
        ...
        sbOooO00o.append(i6);
        OooO0O0.OooO00o(sbOooO00o, ", prettyId=", j3, ", roomId=");
        sbOooO00o.append(j4);
    ...
    public RoomUserRecordModel(long j, long j2, @NotNull String str, int i, @NotNull String str2, int i2, int i3, int i4, int i5, @NotNull String str3, int i6, long j3, long j4, int i7, int i8, long j5, int i9) {
        OooO0OO.OooO00o(str, "execUserName", str2, "headUrl", str3, "nickName");
        this.createTime = j;
        this.execUserId = j2;
