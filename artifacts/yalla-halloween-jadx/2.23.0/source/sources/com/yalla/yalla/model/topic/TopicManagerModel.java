...
public final /* data */ class TopicManagerModel {
    ...
    public int hashCode() {
        long j = this.id;
        long j2 = this.userId;
        int iOooO00o = o0OO00O.OooO00o(this.nickName, ((((int) (j ^ (j >>> 32))) * 31) + ((int) (j2 ^ (j2 >>> 32)))) * 31, 31);
        long j3 = this.prettyId;
        return ((((o0OO00O.OooO00o(this.headUrl, (iOooO00o + ((int) ((j3 >>> 32) ^ j3))) * 31, 31) + this.sex) * 31) + this.vip) * 31) + this.vipLevel;
    }
    ...
    public String toString() {
        ...
        OooO0O0.OooO00o(sbOooO00o, ", prettyId=", j3, ", headUrl=");
