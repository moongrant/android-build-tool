...
public final class AccountScreen extends o00O00O {
    ...
    public static final class OooO00o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ int f23557OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ ColumnScope f23558OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(ColumnScope columnScope, int i) {
            super(2);
            this.f23558OooO0o0 = columnScope;
            this.f23557OooO0o = i;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f23557OooO0o | 1);
            AccountScreen.this.Content(this.f23558OooO0o0, composer, iUpdateChangedFlags);
    ...
    public void Content(@NotNull ColumnScope columnScope, @Nullable Composer composer, int i) {
        ...
        if ((i2 & 11) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1109845429, i2, -1, "com.yalla.yalla.module.account.ui.screen.AccountScreen.Content (AccountScreen.kt:37)");
            }
            o0000oo.OooO00o(columnScope, composerStartRestartGroup, i2 & 14);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public long mo4198getWindowBackgroundColorWaAFU9c(@Nullable Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1775514352, i, -1, "com.yalla.yalla.module.account.ui.screen.AccountScreen.getWindowBackgroundColor (AccountScreen.kt:46)");
        }
