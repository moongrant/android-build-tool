...
import p442o0OoOoO0.o00O;
import p442o0OoOoO0.o00O0OO0;
import p508o0o0O.OooOO0O;
import p641o0ooOOOO.b2;

/* JADX INFO: loaded from: classes4.dex */
@StabilityInferred(parameters = 0)
@Metadata(d1 = {"\u0000<\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0007\b\u0007\u0018\u0000 \u00192\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0001\u001aB\u0007¢\u0006\u0004\b\u0017\u0010\u0018J&\u0010\n\u001a\u0004\u0018\u00010\t2\u0006\u0010\u0004\u001a\u00020\u00032\b\u0010\u0006\u001a\u0004\u0018\u00010\u00052\b\u0010\b\u001a\u0004\u0018\u00010\u0007H\u0016J\u001a\u0010\u000b\u001a\u00020\u00022\u0006\u0010\u0004\u001a\u00020\u00032\b\u0010\u0006\u001a\u0004\u0018\u00010\u0005H\u0016J\b\u0010\r\u001a\u00020\fH\u0014R\u001b\u0010\u0013\u001a\u00020\u000e8BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u000f\u0010\u0010\u001a\u0004\b\u0011\u0010\u0012R\u0016\u0010\u0015\u001a\u00020\u00148\u0002@\u0002X\u0082.¢\u0006\u0006\n\u0004\b\u0015\u0010\u0016¨\u0006\u001b"}, d2 = {"Lcom/yalla/yalla/module/event/ui/page/EventDisplayChildFragment;", "Lo0o0O/OooOO0O;", "Lo0ooOOOO/b2;", "Landroid/view/LayoutInflater;", "inflater", "Landroid/view/ViewGroup;", "container", "Landroid/os/Bundle;", "savedInstanceState", "Landroid/view/View;", "onCreateView", "getViewBinding", "", "onLazyInit", "Lcom/yalla/yalla/module/event/vm/EventViewModel;", "eventVM$delegate", "Lkotlin/Lazy;", "getEventVM", "()Lcom/yalla/yalla/module/event/vm/EventViewModel;", "eventVM", "Lcom/yalla/yalla/module/event/ui/screen/EventPage;", "eventPage", "Lcom/yalla/yalla/module/event/ui/screen/EventPage;", "<init>", "()V", "Companion", "OooO00o", "Event_YallaRelease"}, k = 1, mv = {1, 8, 0})
...
public final class EventDisplayChildFragment extends OooOO0O<b2> {
    ...
    @NotNull
    private final Lazy eventVM = o000O0o.OooO0O0(this, Reflection.getOrCreateKotlinClass(EventViewModel.class), new Function0<ViewModelStore>() { // from class: com.yalla.yalla.module.event.ui.page.EventDisplayChildFragment$special$$inlined$activityViewModels$default$1
        {
            super(0);
        }
        ...
        public final /* synthetic */ Function0 f23642OooO0Oo = null;
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f23642OooO0Oo;
        ...
        public final Unit invoke(Composer composer, Integer num) {
            ...
            if ((iIntValue & 11) == 2 && composer2.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(1943171731, iIntValue, -1, "com.yalla.yalla.module.event.ui.page.EventDisplayChildFragment.onLazyInit.<anonymous> (EventDisplayChildFragment.kt:39)");
                }
                ...
                if (i == 1) {
                    ...
                    o00O.OooO00o(eventDisplayChildFragment.getEventVM(), composer2, 0);
                    ...
                    o00O0OO0.OooO00o(eventDisplayChildFragment.getEventVM(), composer2, 0);
                    composer2.endReplaceableGroup();
                }
                if (ComposerKt.isTraceInProgress()) {
    ...
    public void onLazyInit() {
        super.onLazyInit();
        ComposeView composeView = getBinding().f57540OooO0O0;
        Intrinsics.checkNotNullExpressionValue(composeView, "binding.displayChildComposeView");
        o000OOo.OooO0Oo(composeView, ComposableLambdaKt.composableLambdaInstance(1943171731, true, new OooO0O0()));
    }

    @Override // p508o0o0O.OooOO0O
    @NotNull
    public b2 getViewBinding(@NotNull LayoutInflater inflater, @Nullable ViewGroup container) {
        Intrinsics.checkNotNullParameter(inflater, "inflater");
        b2 b2VarInflate = b2.inflate(inflater, container, false);
        Intrinsics.checkNotNullExpressionValue(b2VarInflate, "inflate(inflater, container, false)");
        return b2VarInflate;
    }
}
