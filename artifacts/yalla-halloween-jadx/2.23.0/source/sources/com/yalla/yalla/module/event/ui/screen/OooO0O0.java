...
public final class OooO0O0 extends Lambda implements Function1<Long, Unit> {
    ...
    public final /* synthetic */ EventCreateViewModel f23872OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooO0O0(EventCreateViewModel eventCreateViewModel) {
        super(1);
        this.f23872OooO0Oo = eventCreateViewModel;
    }

    @Override // kotlin.jvm.functions.Function1
    public final Unit invoke(Long l) {
        long jLongValue = l.longValue();
        EventCreateViewModel eventCreateViewModel = this.f23872OooO0Oo;
