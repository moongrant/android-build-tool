...
public final class OooO0OO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ VideoTimelinePlayView f24620OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ Uri f24621OooO0o0;
    ...
    public OooO0OO(VideoTimelinePlayView videoTimelinePlayView, Uri uri, Continuation<? super OooO0OO> continuation) {
        ...
        this.f24620OooO0Oo = videoTimelinePlayView;
        this.f24621OooO0o0 = uri;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new OooO0OO(this.f24620OooO0Oo, this.f24621OooO0o0, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        VideoTimelinePlayView videoTimelinePlayView = this.f24620OooO0Oo;
        videoTimelinePlayView.f24641OooOOOo = mediaMetadataRetriever;
        Uri uri = this.f24621OooO0o0;
        videoTimelinePlayView.f24669OoooO0 = new VideoTimelinePlayView.OooO0O0(uri);
        try {
            MediaMetadataRetriever mediaMetadataRetriever2 = videoTimelinePlayView.f24641OooOOOo;
            ...
            MediaMetadataRetriever mediaMetadataRetriever3 = videoTimelinePlayView.f24641OooOOOo;
            ...
            videoTimelinePlayView.f24630OooO0Oo = Long.parseLong(strExtractMetadata);
            MediaMetadataRetriever mediaMetadataRetriever4 = videoTimelinePlayView.f24641OooOOOo;
            Intrinsics.checkNotNull(mediaMetadataRetriever4);
            String strExtractMetadata2 = mediaMetadataRetriever4.extractMetadata(18);
            MediaMetadataRetriever mediaMetadataRetriever5 = videoTimelinePlayView.f24641OooOOOo;
            Intrinsics.checkNotNull(mediaMetadataRetriever5);
            String strExtractMetadata3 = mediaMetadataRetriever5.extractMetadata(19);
            MediaMetadataRetriever mediaMetadataRetriever6 = videoTimelinePlayView.f24641OooOOOo;
            ...
            if (numBoxInt != null && numBoxInt.intValue() == 90) {
                ...
                videoTimelinePlayView.f24632OooO0o0 = Integer.parseInt(strExtractMetadata3);
                Intrinsics.checkNotNull(strExtractMetadata2);
                videoTimelinePlayView.f24631OooO0o = Integer.parseInt(strExtractMetadata2);
                ...
                Intrinsics.checkNotNull(strExtractMetadata2);
                videoTimelinePlayView.f24632OooO0o0 = Integer.parseInt(strExtractMetadata2);
                Intrinsics.checkNotNull(strExtractMetadata3);
                videoTimelinePlayView.f24631OooO0o = Integer.parseInt(strExtractMetadata3);
            }
            int i = videoTimelinePlayView.f24632OooO0o0;
        } catch (Exception unused) {
        }
        videoTimelinePlayView.f24670OoooO00.set(true);
