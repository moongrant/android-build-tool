...
public final class WebEventRepository$registerEventApkEnterRoomLog$$inlined$call$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Response<String>>, Object> {
    ...
    public final /* synthetic */ EnterRoomParentPage f24918OooO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public int f24919OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ ArrayList f24920OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ o0O00oO0 f24921OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final /* synthetic */ ArrayList f24922OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final /* synthetic */ String f24923OooO0oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WebEventRepository$registerEventApkEnterRoomLog$$inlined$call$1(o0O00oO0 o0o00oo1, Continuation continuation, ArrayList arrayList, ArrayList arrayList2, String str, EnterRoomParentPage enterRoomParentPage) {
        super(2, continuation);
        this.f24921OooO0o0 = o0o00oo1;
        this.f24920OooO0o = arrayList;
        this.f24922OooO0oO = arrayList2;
        this.f24923OooO0oo = str;
        this.f24918OooO = enterRoomParentPage;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new WebEventRepository$registerEventApkEnterRoomLog$$inlined$call$1(this.f24921OooO0o0, continuation, this.f24920OooO0o, this.f24922OooO0oO, this.f24923OooO0oo, this.f24918OooO);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
        ...
        int i = this.f24919OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            final o0O00oO0 o0o00oo1 = this.f24921OooO0o0;
            this.f24919OooO0Oo = 1;
            ...
            String roomId = this.f24923OooO0oo;
            Intrinsics.checkNotNullParameter(roomId, "roomId");
            EnterRoomParentPage sourcePage = this.f24918OooO;
            Intrinsics.checkNotNullParameter(sourcePage, "sourcePage");
            Intrinsics.checkNotNullParameter(callback, "callback");
            StringBuffer stringBuffer = new StringBuffer();
            ArrayList<String> arrayList = this.f24920OooO0o;
            ...
            ArrayList<String> arrayList2 = this.f24922OooO0oO;
            if (arrayList2 != null) {
            ...
            enterRoomLogJsonValue.setUserId(String.valueOf(params.get("userid")));
            ...
            OooO0OO.OooO0OO(o0000O.f44162o0000oO, "/Webservers/Apk/EnterRoomLog", params, callback);
