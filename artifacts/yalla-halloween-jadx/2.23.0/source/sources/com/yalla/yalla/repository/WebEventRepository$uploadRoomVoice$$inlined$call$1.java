...
public final class WebEventRepository$uploadRoomVoice$$inlined$call$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Response<String>>, Object> {
    ...
    public int f24933OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ List f24934OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ o0O00oO0 f24935OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final /* synthetic */ long f24936OooO0oO;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WebEventRepository$uploadRoomVoice$$inlined$call$1(o0O00oO0 o0o00oo1, Continuation continuation, List list, long j) {
        super(2, continuation);
        this.f24935OooO0o0 = o0o00oo1;
        this.f24934OooO0o = list;
        this.f24936OooO0oO = j;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new WebEventRepository$uploadRoomVoice$$inlined$call$1(this.f24935OooO0o0, continuation, this.f24934OooO0o, this.f24936OooO0oO);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
        ...
        int i = this.f24933OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            final o0O00oO0 o0o00oo1 = this.f24935OooO0o0;
            this.f24933OooO0Oo = 1;
            ...
            for (RoomVoiceModule.TimeVoice timeVoice : this.f24934OooO0o) {
                if (timeVoice != null) {
            ...
            String roomId = String.valueOf(this.f24936OooO0oO);
            ...
            userVoiceLogJsonValue.setUserId(String.valueOf(params.get("userid")));
            ...
            OooO0OO.OooO0OO(o0000O.f44162o0000oO, "/Webservers/Apk/UserVoiceLog", params, callback);
