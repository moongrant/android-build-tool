...
public final class OooOOO implements OooO00o {
    ...
    public final void OooO0O0(int i, @Nullable Object obj) {
        ...
        switch (i) {
            case 1000300:
                RoomPkStartModel startModel = (RoomPkStartModel) p140o00OOooo.OooOO0.OooO0O0(RoomPkStartModel.class, new String((byte[]) obj, Charsets.UTF_8));
                if (startModel != null) {
                ...
                break;
            case 1000301:
                RoomPKResultModel resultModel = (RoomPKResultModel) p140o00OOooo.OooOO0.OooO0O0(RoomPKResultModel.class, new String((byte[]) obj, Charsets.UTF_8));
                if (resultModel != null) {
                    com.yalla.yalla.service.room.OooO0O0.f24995OoooOOO.OooO00o().f25028Oooo.postValue(resultModel);
