    ...
    public final void OooO0O0(int i, @Nullable Object obj) {
        ...
        switch (i) {
            case 1000200:
                ...
                if (from != null) {
                    p592o0oo00O.OooOOO0.OooO0OO(OooO00o.C0319OooO00o.OooO00o(this), "type = " + i + "  data = " + from);
                    ...
                    if (value != null && value.longValue() == roomId) {
                        ...
                        oooO00o.OooO00o().f25038Oooo0oo.postValue(treasureBoxProgressModel);
                    }
                }
                break;
            case 1000201:
                ...
                if (box != null) {
                    p592o0oo00O.OooOOO0.OooO0OO(OooO00o.C0319OooO00o.OooO00o(this), "type = " + i + "  data = " + box);
