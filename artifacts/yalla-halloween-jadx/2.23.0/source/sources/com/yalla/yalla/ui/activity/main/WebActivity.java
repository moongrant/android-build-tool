...
import p486o0o00O00.o0000O0O;
import p486o0o00O00.o0O00O;
import p486o0o00O00.o0O00O0o;
import p486o0o00O00.o0O00OO;
import p486o0o00O00.o0O00OOO;
import p486o0o00O00.o0OoO00O;
import p486o0o00O00.o0oO0Ooo;
...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0007\u0018\u00002\u00020\u0001:\u0001\u0004B\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0005"}, d2 = {"Lcom/yalla/yalla/ui/activity/main/WebActivity;", "Lcom/yalla/yalla/base/activity/BaseFragmentActivity;", "<init>", "()V", "OooO00o", "Common_YallaRelease"}, k = 1, mv = {1, 8, 0})
...
public final class WebActivity extends BaseFragmentActivity {
    ...
    public static final /* synthetic */ int f25584OooOoO0 = 0;

    /* JADX INFO: renamed from: OooOOo, reason: collision with root package name */
    @Nullable
    public ValueCallback<Uri[]> f25585OooOOo;

    /* JADX INFO: renamed from: OooOOo0, reason: collision with root package name */
    public boolean f25586OooOOo0;

    /* JADX INFO: renamed from: OooOOoo, reason: collision with root package name */
    public boolean f25587OooOOoo;

    /* JADX INFO: renamed from: OooOo0O, reason: collision with root package name */
    public WebPageInfo f25591OooOo0O;

    /* JADX INFO: renamed from: OooOo0o, reason: collision with root package name */
    @Nullable
    public BaseWebView2 f25592OooOo0o;

    /* JADX INFO: renamed from: OooOo00, reason: collision with root package name */
    @NotNull
    public String f25590OooOo00 = "";

    /* JADX INFO: renamed from: OooOo0, reason: collision with root package name */
    public boolean f25589OooOo0 = true;

    /* JADX INFO: renamed from: OooOo, reason: collision with root package name */
    @NotNull
    public final ViewModelLazy f25588OooOo = new ViewModelLazy(Reflection.getOrCreateKotlinClass(WebVM.class), new Function0<ViewModelStore>() { // from class: com.yalla.yalla.ui.activity.main.WebActivity$special$$inlined$viewModels$default$2
        {
            super(0);
        }
        ...
        public final /* synthetic */ Function0 f25605OooO0Oo = null;
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f25605OooO0Oo;
        ...
        public final Unit invoke(RowScope rowScope, Composer composer, Integer num) {
            ...
            if ((iIntValue & 81) == 16 && composer2.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(1394700094, iIntValue, -1, "com.yalla.yalla.ui.activity.main.WebActivity.WebToolbar.<anonymous> (WebActivity.kt:240)");
                }
                ...
                if (webActivity.OooOoO0().getShowMenuRefresh() || webActivity.OooOoO0().getShowMenuShare() || webActivity.OooOoO0().getShowMenuOpenInBrowser()) {
                    Painter painterPainterResource = PainterResources_androidKt.painterResource(oOo00OO0.icon_web_more, composer2, 0);
                    if (webActivity.OooOoO0().getToolbarGreenStyle()) {
                        composer2.startReplaceableGroup(-80032978);
                        j = o000OOo.OooO0OO(composer2).f37715OooOOOO;
                    } else {
                        composer2.startReplaceableGroup(-80032946);
                        j = o000OOo.OooO0OO(composer2).f37713OooOOO;
                    }
                    composer2.endReplaceableGroup();
                    t1.OooO0O0(painterPainterResource, j, false, new o00O0O(webActivity), composer2, 8, 4);
                }
                if (ComposerKt.isTraceInProgress()) {
    ...
    public static final class OooO0OO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ o0O0o000 f25596OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(o0O0o000 o0o0o000) {
            super(2);
            this.f25596OooO0o0 = o0o0o000;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            ...
            if ((iIntValue & 11) == 2 && composer2.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-1795074764, iIntValue, -1, "com.yalla.yalla.ui.activity.main.WebActivity.ToolbarMenuPopup.<anonymous> (WebActivity.kt:272)");
                }
                float f = 8;
                Modifier modifierM169backgroundbw27NRU$default = BackgroundKt.m169backgroundbw27NRU$default(com.facebook.OooOo.OooO0O0(f, SizeKt.m528width3ABfNKs(ShadowKt.m1348shadows4CzXII$default(PaddingKt.m476padding3ABfNKs(Modifier.INSTANCE, Dp.m3765constructorimpl(f)), Dp.m3765constructorimpl(f), RoundedCornerShapeKt.m727RoundedCornerShape0680j_4(Dp.m3765constructorimpl(f)), false, 0L, 0L, 28, null), Dp.m3765constructorimpl(200))), o000OOo.OooO0OO(composer2).f37703OooO0O0, null, 2, null);
                ...
                if (webActivity.OooOoO0().getShowMenuRefresh()) {
                    AndroidMenu_androidKt.DropdownMenuItem(new Oooo0(webActivity), null, false, null, null, o0000O0O.f48265OooO00o, composer2, 196608, 30);
                }
                composer2.endReplaceableGroup();
                composer2.startReplaceableGroup(101643762);
                if (webActivity.OooOoO0().getShowMenuShare()) {
                    AndroidMenu_androidKt.DropdownMenuItem(new o000oOoO(webActivity, this.f25596OooO0o0), null, false, null, null, o0000O0O.f48266OooO0O0, composer2, 196608, 30);
                }
                composer2.endReplaceableGroup();
                composer2.startReplaceableGroup(573493018);
                if (webActivity.OooOoO0().getShowMenuOpenInBrowser()) {
                    AndroidMenu_androidKt.DropdownMenuItem(new o0OoOo0(webActivity), null, false, null, null, o0000O0O.f48267OooO0OO, composer2, 196608, 30);
                }
    ...
    public static final class OooO0o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f25598OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(int i) {
            super(2);
            this.f25598OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f25598OooO0o0 | 1);
            int i = WebActivity.f25584OooOoO0;
    ...
    public static final class OooOO0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f25600OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0(int i) {
            super(2);
            this.f25600OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f25600OooO0o0 | 1);
            int i = WebActivity.f25584OooOoO0;
    ...
    public static final class OooOO0O extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final Unit invoke(Composer composer, Integer num) {
            ...
            if ((iIntValue & 11) == 2 && composer2.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(1016459477, iIntValue, -1, "com.yalla.yalla.ui.activity.main.WebActivity.onCreate.<anonymous> (WebActivity.kt:117)");
                }
                o000OOo.OooO00o(true, ComposableLambdaKt.composableLambda(composer2, 991379352, true, new o00Oo0(WebActivity.this)), composer2, 54);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
            }
    ...
    public static final class OooOOO0 implements Observer<Object> {
        ...
        public final void onChanged(Object obj) {
            ...
            WebActivity webActivity = WebActivity.this;
            if (!webActivity.f25586OooOOo0 || (baseWebView2 = webActivity.f25592OooOo0o) == null) {
                return;
            }
            baseWebView2.reload();
        }
    ...
    public static final void OooOo(WebActivity webActivity, Composer composer, int i) {
        ...
        if ((i & 1) == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            m3.OooO00o((o0O0o000) viewModel, null, composerStartRestartGroup, 8, 2);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new o0oO0Ooo(webActivity, i));
    }
    ...
    public static final void OooOo0o(WebActivity webActivity, Composer composer, int i) {
        ...
        composerStartRestartGroup.endReplaceableGroup();
        webActivity.f25591OooOo0O = (WebPageInfo) objRememberedValue;
        o00000O.OooO0O0(!webActivity.OooOoO0().getStatusBarBlackIcon(), composerStartRestartGroup, 0, 0);
        WebPageInfo webPageInfo = webActivity.f25591OooOo0O;
        if (webPageInfo == null) {
            Intrinsics.throwUninitializedPropertyAccessException("webPageInfo");
            webPageInfo = null;
        }
        EffectsKt.LaunchedEffect(webPageInfo, new o0OoO00O(webActivity, null), composerStartRestartGroup, 72);
        ...
        Modifier modifierM480paddingqDBjuR0$default = PaddingKt.m480paddingqDBjuR0$default(BackgroundKt.m169backgroundbw27NRU$default(modifierFillMaxSize$default, webPageInfo2.f32827OooOOOO, null, 2, null), 0.0f, 0.0f, 0.0f, bottom, 7, null);
        ...
        ViewModel viewModel = ViewModelKt.viewModel(o0O0o000.class, current, null, null, current instanceof HasDefaultViewModelProviderFactory ? ((HasDefaultViewModelProviderFactory) current).getDefaultViewModelCreationExtras() : CreationExtras.Empty.INSTANCE, composerStartRestartGroup, 36936, 0);
        composerStartRestartGroup.endReplaceableGroup();
        oOOO0O0o.OooO0O0(new o0O00O0o(webActivity, (o0O0o000) viewModel), companion.then(webActivity.OooOoO0().getShowToolbar() ? SizeKt.fillMaxSize$default(PaddingKt.m480paddingqDBjuR0$default(WindowInsetsPadding_androidKt.statusBarsPadding(companion), 0.0f, Dp.m3765constructorimpl(50), 0.0f, 0.0f, 13, null), 0.0f, 1, null) : SizeKt.fillMaxSize$default(companion, 0.0f, 1, null)), new o0O00O(webActivity), composerStartRestartGroup, 0, 0);
        ...
        if (webActivity.OooOoO0().getShowCloseAdIcon()) {
            ImageKt.Image(PainterResources_androidKt.painterResource(oOo00OO0.icon_ad_web_close, composerStartRestartGroup, 0), (String) null, o0O0O00.OooO0O0(SizeKt.m523size3ABfNKs(PaddingKt.m476padding3ABfNKs(WindowInsetsPadding_androidKt.statusBarsPadding(boxScopeInstance.align(companion, companion2.getTopEnd())), Dp.m3765constructorimpl(16)), Dp.m3765constructorimpl(17)), false, false, 0L, false, null, null, null, o0O00OO.f48348OooO0Oo, 253), (Alignment) null, (ContentScale) null, 0.0f, (ColorFilter) null, composerStartRestartGroup, 56, 120);
        }
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new o0O00OOO(webActivity, i));
    }
    ...
    public final void OooOo0(Composer composer, int i) {
        ...
        Density density = (Density) androidx.compose.material.OooO00o.OooO00o(composerStartRestartGroup, 193852281);
        int iOooO0Oo = o000000.OooO0Oo(Float.valueOf(density.mo324toPx0680j_4(Dp.m3765constructorimpl(50)))) + WindowInsets_androidKt.getStatusBars(WindowInsets.INSTANCE, composerStartRestartGroup, 8).getTop(density);
        composerStartRestartGroup.endReplaceableGroup();
        composerStartRestartGroup.startReplaceableGroup(1729797275);
        ViewModelStoreOwner current = LocalViewModelStoreOwner.INSTANCE.getCurrent(composerStartRestartGroup, 6);
        if (current == null) {
        ...
        ViewModel viewModel = ViewModelKt.viewModel(o0O0o000.class, current, null, null, current instanceof HasDefaultViewModelProviderFactory ? ((HasDefaultViewModelProviderFactory) current).getDefaultViewModelCreationExtras() : CreationExtras.Empty.INSTANCE, composerStartRestartGroup, 36936, 0);
        composerStartRestartGroup.endReplaceableGroup();
        AndroidPopup_androidKt.m4004PopupK5zGePQ(Alignment.INSTANCE.getTopEnd(), IntOffsetKt.IntOffset(-o000000.OooO0Oo(Float.valueOf(((Density) composerStartRestartGroup.consume(CompositionLocalsKt.getLocalDensity())).mo324toPx0680j_4(Dp.m3765constructorimpl(8)))), iOooO0Oo), new OooO0O0(), new PopupProperties(true, false, false, null, false, false, 62, null), ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1795074764, true, new OooO0OO((o0O0o000) viewModel)), composerStartRestartGroup, 27654, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ScopeUpdateScope scopeUpdateScopeEndRestartGroup = composerStartRestartGroup.endRestartGroup();
    ...
    public final void OooOo0O(Composer composer, int i) {
        ...
        if (OooOoO0().getShowToolbar() || OooOoO0().isLoadError()) {
            ...
            int i2 = OooOoO0().getBackIconIsClose() ? oOo00OO0.btn_header_close : oOo00OO0.icv_arrow_back;
            if (!OooOoO0().getShowToolbar() || OooOoO0().getToolbarGreenStyle()) {
                composerStartRestartGroup.startReplaceableGroup(-1701527811);
                j = o000OOo.OooO0OO(composerStartRestartGroup).f37715OooOOOO;
                composerStartRestartGroup.endReplaceableGroup();
            } else {
            ...
            long j3 = OooOoO0().getToolbarGreenStyle() ? o000OOo.OooO0OO(composerStartRestartGroup).f37716OooOOOo : o0oO0O0o.f46945OooO00o;
            composerStartRestartGroup.endReplaceableGroup();
            composer2 = composerStartRestartGroup;
            t1.OooO00o(toolbarTitle, 0.0f, j2, Integer.valueOf(i2), null, null, null, ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1394700094, true, new OooO()), WindowInsetsPadding_androidKt.statusBarsPadding(BackgroundKt.m169backgroundbw27NRU$default(companion, j3, null, 2, null)), composerStartRestartGroup, 12582912, 114);
    ...
    public final WebVM OooOoO0() {
        return (WebVM) this.f25588OooOo.getValue();
    }

    @Override // com.yalla.yalla.ui.activity.BaseAppCompatActivity, android.app.Activity
    public final void finish() {
        if (this.f25587OooOOoo) {
            Intent intent = new Intent();
            intent.putExtra("INSTAGRAG_LOGIN_URI", this.f25590OooOo00);
    ...
    public final void onActivityResult(int i, int i2, @Nullable Intent intent) {
        ...
        if (i != 1 || (valueCallback = this.f25585OooOOo) == null) {
            return;
        }
        if (i2 != -1) {
            ...
            this.f25585OooOOo = null;
        } else {
            if (intent == null || (data = intent.getData()) == null) {
                return;
            }
            ValueCallback<Uri[]> valueCallback2 = this.f25585OooOOo;
    ...
    public final void onBackPressed() {
        if (this.f25589OooOo0) {
            BaseWebView2 baseWebView2 = this.f25592OooOo0o;
            boolean z = false;
            ...
            BaseWebView2 baseWebView3 = this.f25592OooOo0o;
    ...
    public final void onCreate(@Nullable Bundle bundle) {
        ...
        LiveEventBus.get("refreshUniqueIDPage").observe(this, new OooOOO0());
    }
    ...
    public final void onPause() {
        super.onPause();
        WebPageInfo webPageInfo = this.f25591OooOo0O;
        if (webPageInfo == null) {
            return;
        }
        WebPageInfo webPageInfo2 = null;
        if (webPageInfo.f32817OooO0Oo == WebFrom.RoomMainBanner) {
            HashMap map = new HashMap();
            BaseWebView2 baseWebView2 = this.f25592OooOo0o;
            String title = baseWebView2 != null ? baseWebView2.getTitle() : null;
            if ((title == null || StringsKt.isBlank(title)) || StringsKt.Oooo00o(title, "http")) {
                WebPageInfo webPageInfo3 = this.f25591OooOo0O;
                if (webPageInfo3 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("webPageInfo");
                    webPageInfo3 = null;
                }
                title = webPageInfo3.f32820OooO0oO;
            }
            map.put(ShareConstants.WEB_DIALOG_PARAM_TITLE, title);
            o0OO000.OooO0O0("401005", MapsKt.mapOf(new Pair("staytime", Integer.valueOf((int) this.f22760OooOOOO))));
        }
        WebPageInfo webPageInfo4 = this.f25591OooOo0O;
        if (webPageInfo4 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("webPageInfo");
        } else {
            webPageInfo2 = webPageInfo4;
        }
        if (webPageInfo2.f32817OooO0Oo == WebFrom.ActivityNotice) {
            o0OO000.OooO0O0("402004", MapsKt.mapOf(new Pair("staytime", Integer.valueOf((int) this.f22760OooOOOO))));
        }
    }
}
