...
public final class o000O0Oo extends Lambda implements Function1<Pair<? extends Integer, ? extends ChatMessage>, Unit> {
    ...
    public final /* synthetic */ PrivateChatActivity f25817OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o000O0Oo(PrivateChatActivity privateChatActivity) {
        super(1);
        this.f25817OooO0Oo = privateChatActivity;
    }
    ...
    public final Unit invoke(Pair<? extends Integer, ? extends ChatMessage> pair) {
        ...
        PrivateChatActivity privateChatActivity = this.f25817OooO0Oo;
        ...
        if (pair2 != null) {
            ...
            if (second.getGiveRoomThemeInfo() != null) {
                ...
                x3 x3Var = new x3(privateChatActivity, new o000O(privateChatActivity, second), o000OO00.f25820OooO0Oo);
                privateChatActivity.f25703OooOoO = x3Var;
                ...
                x3Var.OooOO0o(giveRoomThemeInfo.getThemeBgImgUrl(), iIntValue, giveRoomThemeInfo.getThemeVideoUrl(), isAcceptMsg);
