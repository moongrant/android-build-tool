...
public final class o0O000Oo extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f25929OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ androidx.paging.o0OOO0o<SystemMessage> f25930OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ SystemMessageActivity f25931OooO0o0;
    ...
    public o0O000Oo(SystemMessageActivity systemMessageActivity, androidx.paging.o0OOO0o<SystemMessage> o0ooo0o2, Continuation<? super o0O000Oo> continuation) {
        ...
        this.f25931OooO0o0 = systemMessageActivity;
        this.f25930OooO0o = o0ooo0o2;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o0O000Oo(this.f25931OooO0o0, this.f25930OooO0o, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f25929OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            com.yalla.yalla.ui.adapter.o00 o00Var = this.f25931OooO0o0.f25767OooOo00;
            if (o00Var == null) {
                Intrinsics.throwUninitializedPropertyAccessException("adapter");
                o00Var = null;
            }
            androidx.paging.o0OOO0o<SystemMessage> it = this.f25930OooO0o;
            Intrinsics.checkNotNullExpressionValue(it, "it");
            this.f25929OooO0Oo = 1;
            if (o00Var.OooO0OO(it, this) == coroutine_suspended) {
