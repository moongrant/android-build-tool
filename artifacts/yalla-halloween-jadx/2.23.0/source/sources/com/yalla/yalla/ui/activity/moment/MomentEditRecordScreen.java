...
public final class MomentEditRecordScreen extends o00O00O {
    ...
    public static final class OooO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ int f26101OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ long f26102OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(long j, int i) {
            super(2);
            this.f26102OooO0o0 = j;
            this.f26101OooO0o = i;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f26101OooO0o | 1);
            MomentEditRecordScreen.this.ListContent(this.f26102OooO0o0, composer, iUpdateChangedFlags);
    ...
    public static final class OooO00o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f26104OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ ColumnScope f26105OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(ColumnScope columnScope, int i) {
            super(2);
            this.f26105OooO0o0 = columnScope;
            this.f26104OooO0o = i;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f26104OooO0o | 1);
            MomentEditRecordScreen.this.Content(this.f26105OooO0o0, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final /* synthetic */ MomentRecordEditVM f26106OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ long f26107OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(MomentRecordEditVM momentRecordEditVM, long j, Continuation<? super OooO0O0> continuation) {
            super(2, continuation);
            this.f26106OooO0Oo = momentRecordEditVM;
            this.f26107OooO0o0 = j;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0O0(this.f26106OooO0Oo, this.f26107OooO0o0, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            MomentRecordEditVM.loadData$default(this.f26106OooO0Oo, this.f26107OooO0o0, false, 2, null);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0OO extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MomentRecordEditVM f26108OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ long f26109OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(MomentRecordEditVM momentRecordEditVM, long j) {
            super(0);
            this.f26108OooO0Oo = momentRecordEditVM;
            this.f26109OooO0o0 = j;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            MomentRecordEditVM.loadData$default(this.f26108OooO0Oo, this.f26109OooO0o0, false, 2, null);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ MutableState<p515o0o0O0O0.o0Oo0oo> f26110OooO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MomentRecordEditVM f26111OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f26112OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ long f26113OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ LazyListState f26114OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ FragmentActivity f26115OooO0oo;
        ...
        public OooO0o(int i, long j, LazyListState lazyListState, MutableState mutableState, FragmentActivity fragmentActivity, MomentRecordEditVM momentRecordEditVM) {
            super(2);
            this.f26111OooO0Oo = momentRecordEditVM;
            this.f26113OooO0o0 = j;
            this.f26112OooO0o = i;
            this.f26114OooO0oO = lazyListState;
            this.f26115OooO0oo = fragmentActivity;
            this.f26110OooO = mutableState;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            ...
            if ((iIntValue & 11) == 2 && composer2.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-1927003388, iIntValue, -1, "com.yalla.yalla.ui.activity.moment.MomentEditRecordScreen.ListContent.<anonymous> (MomentEditRecordScreen.kt:98)");
                }
                MomentRecordEditVM momentRecordEditVM = this.f26111OooO0Oo;
                ContentState value = momentRecordEditVM.getContentState().getValue();
                long j = this.f26113OooO0o0;
                ...
                LazyListState lazyListState = this.f26114OooO0oO;
                MomentRecordEditVM momentRecordEditVM2 = this.f26111OooO0Oo;
                FragmentActivity fragmentActivity = this.f26115OooO0oo;
                MutableState<p515o0o0O0O0.o0Oo0oo> mutableState = this.f26110OooO;
                o0000Ooo.OooO0o0(value, false, null, null, null, null, (Function0) objRememberedValue, ComposableLambdaKt.composableLambda(composer2, -1851030462, true, new o000oOoO(this.f26112OooO0o, this.f26113OooO0o0, lazyListState, mutableState, fragmentActivity, momentRecordEditVM2)), composer2, 12582912, 62);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public final void ListContent(long j, Composer composer, int i) {
        ...
        if ((i2 & 11) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            if (objRememberedValue2 == companion.getEmpty()) {
                objRememberedValue2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(new p515o0o0O0O0.o0Oo0oo(lazyListStateRememberLazyListState), null, 2, null);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final p515o0o0O0O0.o0Oo0oo ListContent$lambda$3(MutableState<p515o0o0O0O0.o0Oo0oo> mutableState) {
    ...
    public void Content(@NotNull ColumnScope columnScope, @Nullable Composer composer, int i) {
        ...
        if ((i & 1) == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            long j = o00O.OooO0O0((NavBackStackEntry) composerStartRestartGroup.consume(o00O.f53592OooO00o), composerStartRestartGroup).getLong("momentId");
            ...
            composer2 = composerStartRestartGroup;
            t1.OooO00o(StringResources_androidKt.stringResource(oO00OOo0.Moment_Edit_Record_Title, composerStartRestartGroup, 0), 0.0f, 0L, null, null, null, null, null, null, composerStartRestartGroup, 0, 510);
            TextKt.m1251Text4IGK_g(StringResources_androidKt.stringResource(oO00OOo0.Moment_Edit_Record_Tips, composer2, 0), PaddingKt.m477paddingVpY3zN4(BackgroundKt.m169backgroundbw27NRU$default(SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), o0oO0O0o.f47079o000o0O0, null, 2, null), Dp.m3765constructorimpl(10), Dp.m3765constructorimpl(8)), o0oO0O0o.f46969OooOoO0, TextUnitKt.getSp(12), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 3072, 0, 131056);
