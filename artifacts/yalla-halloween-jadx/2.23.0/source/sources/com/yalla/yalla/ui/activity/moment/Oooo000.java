...
public final class Oooo000 extends Lambda implements Function3<LazyItemScope, Composer, Integer, Unit> {
    ...
    public final /* synthetic */ MomentRecordEditVM f26238OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ long f26239OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public Oooo000(MomentRecordEditVM momentRecordEditVM, long j, int i) {
        super(3);
        this.f26238OooO0Oo = momentRecordEditVM;
        this.f26239OooO0o0 = j;
    }
    ...
    public final Unit invoke(LazyItemScope lazyItemScope, Composer composer, Integer num) {
        ...
        if ((iIntValue & 81) == 16 && composer2.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(315383475, iIntValue, -1, "com.yalla.yalla.ui.activity.moment.MomentEditRecordScreen.ListContent.<anonymous>.<anonymous>.<anonymous>.<anonymous> (MomentEditRecordScreen.kt:126)");
            }
            MomentRecordEditVM momentRecordEditVM = this.f26238OooO0Oo;
            LoadMoreState value = momentRecordEditVM.getLoadMoreState().getValue();
            long j = this.f26239OooO0o0;
            ...
            u0.OooO0O0(momentRecordEditVM.getLoadMoreState().getValue(), null, composer2, 0, 2);
            if (ComposerKt.isTraceInProgress()) {
