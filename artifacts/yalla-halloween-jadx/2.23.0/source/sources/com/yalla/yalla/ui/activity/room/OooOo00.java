...
public final class OooOo00 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ RoomBanEnterUser f26601OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooOo00(RoomBanEnterUser roomBanEnterUser) {
        super(0);
        this.f26601OooO0Oo = roomBanEnterUser;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        RoomBanEnterUser roomBanEnterUser = this.f26601OooO0Oo;
