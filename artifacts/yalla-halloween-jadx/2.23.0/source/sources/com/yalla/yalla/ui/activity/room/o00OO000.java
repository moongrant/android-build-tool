...
public final class o00OO000 extends Lambda implements Function1<ProfileLimitModel, Unit> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ RoomSettingActivity f26879OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00OO000(RoomSettingActivity roomSettingActivity) {
        super(1);
        this.f26879OooO0Oo = roomSettingActivity;
    }
    ...
    public final Unit invoke(ProfileLimitModel profileLimitModel) {
        ...
        RoomSettingActivity roomSettingActivity = this.f26879OooO0Oo;
