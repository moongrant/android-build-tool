...
public final class RecAdapterTag extends RecyclerView.Adapter<ViewHolder> {
    ...
    @Nullable
    public final List<CategoryModel> f27449OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @Nullable
    public Context f27450OooO0O0;
    ...
    public static final class ViewHolder extends RecyclerView.o0O0O00 {
        ...
        public ViewHolder(@NotNull View itemView) {
            ...
            View viewFindViewById = itemView.findViewById(oO00O0oO.item_tag_tv_tag);
        ...
        public final void setData(@NotNull CategoryModel model, int position, int size) {
            ...
            int i = position % 3;
            if (i == 0) {
                this.tvTag.setBackgroundResource(oOo00OO0.bg_round_tag_bg_ced5de);
            } else if (i == 1) {
                this.tvTag.setBackgroundResource(oOo00OO0.bg_round_tag_bg_f1d8b6);
            } else {
                if (i != 2) {
                    return;
                }
                this.tvTag.setBackgroundResource(oOo00OO0.bg_round_tag_bg_c6c1bd);
            }
        }
    }
    ...
    public RecAdapterTag(@Nullable List<? extends CategoryModel> list) {
        this.f27449OooO00o = list;
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public final int getItemCount() {
        List<CategoryModel> list = this.f27449OooO00o;
        if (list != null) {
            return list.size();
        }
        return 0;
    ...
    public final RecyclerView.o0O0O00 onCreateViewHolder(ViewGroup parent, int i) {
        ...
        this.f27450OooO0O0 = context;
        View view = LayoutInflater.from(context).inflate(oO00OO0O.item_tag, parent, false);
