...
public final class o0OoOo0 {
    ...
    @NotNull
    public static final OooO00o f27671OooO00o = new OooO00o();

    public static final class OooO00o extends androidx.recyclerview.widget.OooOo.OooO<FriendInfo> {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public boolean f27672OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        @NotNull
        public String f27673OooO0O0 = "";
        ...
        public final boolean OooO00o(FriendInfo friendInfo, FriendInfo friendInfo2) {
            ...
            if (this.f27672OooO00o || !Intrinsics.areEqual(oldItem.getFriend().getMemoName(), newItem.getFriend().getMemoName()) || oldItem.getFriend().getInRoom() != newItem.getFriend().getInRoom()) {
                return false;
            }
            ...
            if (!Intrinsics.areEqual(numValueOf2, userInfo5 != null ? Integer.valueOf(userInfo5.getVipState()) : null) || !(!StringsKt.isBlank(this.f27673OooO0O0))) {
                return false;
            }
            UserInfo userInfo6 = newItem.getUserInfo();
            if (!((userInfo6 == null || (userName = userInfo6.getUserName()) == null || !StringsKt__StringsKt.contains(userName, this.f27673OooO0O0, true)) ? false : true)) {
                return false;
            }
            UserInfo userInfo7 = newItem.getUserInfo();
            if (!((userInfo7 == null || (userIdx = userInfo7.getUserIdx()) == null || !StringsKt__StringsKt.contains(userIdx, this.f27673OooO0O0, true)) ? false : true)) {
                return false;
            }
            String memoName = newItem.getFriend().getMemoName();
            return memoName != null && StringsKt__StringsKt.contains(memoName, this.f27673OooO0O0, true);
        }
