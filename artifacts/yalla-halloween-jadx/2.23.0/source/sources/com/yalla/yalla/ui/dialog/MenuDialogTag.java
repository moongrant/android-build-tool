...
public final class MenuDialogTag {
    ...
    static {
        ...
        MenuDialogTag menuDialogTag2 = new MenuDialogTag("reply", 1, oO00OOo0.reply);
        reply = menuDialogTag2;
        MenuDialogTag menuDialogTag3 = new MenuDialogTag("copy", 2, oO00OOo0.Copy);
        copy = menuDialogTag3;
        MenuDialogTag menuDialogTag4 = new MenuDialogTag("copyEvent", 3, oO00OOo0.Copy_Evnet);
        copyEvent = menuDialogTag4;
        MenuDialogTag menuDialogTag5 = new MenuDialogTag("delete", 4, oO00OOo0.Delete);
        delete = menuDialogTag5;
        MenuDialogTag menuDialogTag6 = new MenuDialogTag("repost", 5, oO00OOo0.Repost);
        repost = menuDialogTag6;
        MenuDialogTag menuDialogTag7 = new MenuDialogTag("report", 6, oO00OOo0.Report);
        report = menuDialogTag7;
        MenuDialogTag menuDialogTag8 = new MenuDialogTag("dislike", 7, oO00OOo0.event_unSubscribe_confirm);
        dislike = menuDialogTag8;
        MenuDialogTag menuDialogTag9 = new MenuDialogTag(ShareDialog.WEB_SHARE_DIALOG, 8, oO00OOo0.share);
        share = menuDialogTag9;
        MenuDialogTag menuDialogTag10 = new MenuDialogTag("deletePost", 9, oO00OOo0.Delete_Post);
        deletePost = menuDialogTag10;
        int i = oO00OOo0.user_top_pin_post;
        MenuDialogTag menuDialogTag11 = new MenuDialogTag("postTopOfTopic", 10, i);
        postTopOfTopic = menuDialogTag11;
        int i2 = oO00OOo0.user_top_unpin_post;
        MenuDialogTag menuDialogTag12 = new MenuDialogTag("postUnTopOfTopic", 11, i2);
        postUnTopOfTopic = menuDialogTag12;
        MenuDialogTag menuDialogTag13 = new MenuDialogTag("postRemoveOutOfTopic", 12, oO00OOo0.Remove_Post);
        postRemoveOutOfTopic = menuDialogTag13;
        MenuDialogTag menuDialogTag14 = new MenuDialogTag("DisableTheUser", 13, oO00OOo0.Topic_No_Entry);
        ...
        $VALUES = new MenuDialogTag[]{menuDialogTag, menuDialogTag2, menuDialogTag3, menuDialogTag4, menuDialogTag5, menuDialogTag6, menuDialogTag7, menuDialogTag8, menuDialogTag9, menuDialogTag10, menuDialogTag11, menuDialogTag12, menuDialogTag13, menuDialogTag14, menuDialogTag15, menuDialogTag16};
    }
