...
public class CrystalDetailFragment extends com.yalla.yalla.base.fragment.OooO00o {
    ...
    public class OooO00o extends p564o0oOo0OO.o000O<GoldModel> {
        ...
        public final void OooO0oO(BaseViewHolder baseViewHolder, Object obj) {
            ...
            try {
                ...
                Integer numValueOf = p567o0oOo0o0.o00000O0.f56213OooO0O0.get(key);
                if (numValueOf == null) {
                ...
                viewHolder.setTextColor(i2, com.code.android.util.o0000.OooO00o(oO00O0o.crystal_mall_text_color));
    ...
    private void getBillData(final boolean z) {
        this.vm.userBill(String.valueOf(this.pageIndex), FeedbackType.Recharge).observe(requireActivity(), new p377o0OOoOo.o0000OO0(new OooOOOO(), new Function1() { // from class: com.yalla.yalla.ui.fragment.OooOo00
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return this.f28236OooO0Oo.lambda$getBillData$3(z, (ApiError) obj);
            }
        }, new Function1() { // from class: com.yalla.yalla.ui.fragment.OooOo
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return this.f28234OooO0Oo.lambda$getBillData$4(z, (ApiResult) obj);
            }
        }, false));
    }

    private void initView() {
        this.recyclerView = (RecyclerView) this.rootView.findViewById(oO00O0oO.crystal_detail_list_view);
        XRefreshLayout xRefreshLayout = (XRefreshLayout) this.rootView.findViewById(oO00O0oO.crystal_pullToRefreshView);
        this.mXRefreshLayout = xRefreshLayout;
        xRefreshLayout.setOnRefreshListener(new p562o0oOo0O.o000oOoO() { // from class: com.yalla.yalla.ui.fragment.OooOOO0
            @Override // p562o0oOo0O.o000oOoO
            public final void OooO0O0() {
                this.f28233OooO0Oo.lambda$initView$0();
            }
        });
        this.mXRefreshLayout.setOnLoadMoreListener(new p562o0oOo0O.o000oOoO() { // from class: com.yalla.yalla.ui.fragment.OooOOO
            @Override // p562o0oOo0O.o000oOoO
            public final void OooO0O0() {
                this.f28232OooO0Oo.lambda$initView$1();
            }
        });
        ...
        this.adapter.Oooo000(oO00OOo0.blank_no_crystal_transaction_history);
    ...
    public View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        if (this.rootView == null) {
            this.rootView = layoutInflater.inflate(oO00OO0O.fragment_crystal_detail, viewGroup, false);
        }
