...
public final class GuessGiftListFragment extends p508o0o0O.OooOO0O<o8> {
    ...
    public final void changePageSelected(int position) {
        ...
        getBinding().f58532OooO0O0.setSelected(position == 0);
        getBinding().f58534OooO0Oo.setSelected(position == 1);
        getBinding().f58536OooO0o0.setSelected(position == 2);
        getBinding().f58533OooO0OO.setSelected(position == 3);
        ...
        if (position == 1) {
            imageView = getBinding().f58534OooO0Oo;
        } else if (position != 2) {
            imageView = position != 3 ? getBinding().f58532OooO0O0 : getBinding().f58533OooO0OO;
        } else {
            imageView = getBinding().f58536OooO0o0;
        }
    ...
    private final void loadGiftTable(List<MoraGiftListModel> giftIds) {
        ...
        oooO00o.f43911OooO0OO = giftIds.get(0).getImageUrl();
        oooO00o.f43909OooO00o = 0;
        oooO00o.OooO0Oo(getBinding().f58532OooO0O0);
        o0OOo0O.OooOO0.OooO00o oooO00o2 = new o0OOo0O.OooOO0.OooO00o(getContext());
        oooO00o2.OooO00o(p543o0oO0O00.OooO.OooO0O0());
        oooO00o2.f43911OooO0OO = giftIds.get(1).getImageUrl();
        oooO00o2.f43909OooO00o = 0;
        oooO00o2.OooO0Oo(getBinding().f58534OooO0Oo);
        o0OOo0O.OooOO0.OooO00o oooO00o3 = new o0OOo0O.OooOO0.OooO00o(getContext());
        oooO00o3.OooO00o(p543o0oO0O00.OooO.OooO0O0());
        oooO00o3.f43911OooO0OO = giftIds.get(2).getImageUrl();
        oooO00o3.f43909OooO00o = 0;
        oooO00o3.OooO0Oo(getBinding().f58536OooO0o0);
        o0OOo0O.OooOO0.OooO00o oooO00o4 = new o0OOo0O.OooOO0.OooO00o(getContext());
        oooO00o4.OooO00o(p543o0oO0O00.OooO.OooO0O0());
        oooO00o4.f43911OooO0OO = giftIds.get(3).getImageUrl();
        oooO00o4.f43909OooO00o = 0;
        oooO00o4.OooO0Oo(getBinding().f58533OooO0OO);
    }
    ...
    @Override // p508o0o0O.OooOO0O, android.view.View.OnClickListener
    public void onClick(@Nullable View v) {
        super.onClick(v);
        if (Intrinsics.areEqual(v, getBinding().f58532OooO0O0)) {
            getBinding().f58535OooO0o.setCurrentItem(0, false);
            return;
        }
        if (Intrinsics.areEqual(v, getBinding().f58534OooO0Oo)) {
            getBinding().f58535OooO0o.setCurrentItem(1, false);
        } else if (Intrinsics.areEqual(v, getBinding().f58536OooO0o0)) {
            getBinding().f58535OooO0o.setCurrentItem(2, false);
        } else if (Intrinsics.areEqual(v, getBinding().f58533OooO0OO)) {
            getBinding().f58535OooO0o.setCurrentItem(3, false);
        }
    }
    ...
    public void onLazyInit() {
        super.onLazyInit();
        List<MoraGiftListModel> value = com.yalla.yalla.service.room.OooO0O0.f24995OoooOOO.OooO00o().f25015OooOOoo.getValue();
        if (value == null || value.size() < 4) {
            return;
        }
        changePageSelected$default(this, 0, 1, null);
        loadGiftTable(value);
        getBinding().f58532OooO0O0.setOnClickListener(this);
        getBinding().f58534OooO0Oo.setOnClickListener(this);
        getBinding().f58536OooO0o0.setOnClickListener(this);
        getBinding().f58533OooO0OO.setOnClickListener(this);
        int i = 0;
        int i2 = 4;
        ...
        getBinding().f58535OooO0o.setAdapter(new OooO0O0(this.mContext));
        getBinding().f58535OooO0o.setOffscreenPageLimit(1);
        getBinding().f58535OooO0o.registerOnPageChangeCallback(new OooO00o());
    }
