...
import p198o00o0OoO.o00O0O0;
import p564o0oOo0OO.o000O;
import p579o0oOoo.oO0OOO00;
import p584o0oOooO0.oO00OO0O;
import p584o0oOooO0.oO00OOo0;
import p584o0oOooO0.oOo00OO0;
import p641o0ooOOOO.j2;

/* JADX INFO: loaded from: classes4.dex */
@StabilityInferred(parameters = 0)
@Metadata(d1 = {"\u0000F\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\b\u0007\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007¢\u0006\u0004\b!\u0010\"J\b\u0010\u0004\u001a\u00020\u0003H\u0002J\b\u0010\u0005\u001a\u00020\u0003H\u0002J\u0010\u0010\b\u001a\u00020\u00032\u0006\u0010\u0007\u001a\u00020\u0006H\u0002J\u0012\u0010\u000b\u001a\u00020\u00032\b\b\u0002\u0010\n\u001a\u00020\tH\u0002J\u001a\u0010\u0010\u001a\u00020\u00022\u0006\u0010\r\u001a\u00020\f2\b\u0010\u000f\u001a\u0004\u0018\u00010\u000eH\u0016J\b\u0010\u0011\u001a\u00020\u0003H\u0014J\b\u0010\u0012\u001a\u00020\u0003H\u0016J\b\u0010\u0013\u001a\u00020\u0003H\u0016J\b\u0010\u0014\u001a\u00020\u0003H\u0016R\u001b\u0010\u001a\u001a\u00020\u00158BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u0016\u0010\u0017\u001a\u0004\b\u0018\u0010\u0019R!\u0010 \u001a\b\u0012\u0004\u0012\u00020\u001c0\u001b8BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u001d\u0010\u0017\u001a\u0004\b\u001e\u0010\u001f¨\u0006#"}, d2 = {"Lcom/yalla/yalla/ui/fragment/moment/MainMomentsTopicNewFragment;", "Lo0o0O/OooOO0O;", "Lo0ooOOOO/j2;", "", "initObserver", "initView", "", "position", "joinTopic", "", "isRefresh", "loadData", "Landroid/view/LayoutInflater;", "inflater", "Landroid/view/ViewGroup;", "container", "getViewBinding", "onLazyInit", "onDestroy", "onResume", "scrollTopRefresh", "Lcom/yalla/yalla/ui/vm/moment/MomentTopicVM;", "vm$delegate", "Lkotlin/Lazy;", "getVm", "()Lcom/yalla/yalla/ui/vm/moment/MomentTopicVM;", "vm", "Lo0oOo0OO/o000O;", "Lcom/yalla/yalla/model/topic/TopicInfoModel;", "baseAdapter$delegate", "getBaseAdapter", "()Lo0oOo0OO/o000O;", "baseAdapter", "<init>", "()V", "Common_YallaRelease"}, k = 1, mv = {1, 8, 0})
...
public final class MainMomentsTopicNewFragment extends p508o0o0O.OooOO0O<j2> {
    ...
    public static final class OooO extends Lambda implements Function1<ApiResult<List<TopicInfoModel>>, Unit> {
        ...
        public final /* synthetic */ boolean f28681OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(boolean z) {
            super(1);
            this.f28681OooO0o0 = z;
        }
        ...
        public final Unit invoke(ApiResult<List<TopicInfoModel>> apiResult) {
            ...
            XRefreshLayout xRefreshLayout = mainMomentsTopicNewFragment.getBinding().f58160OooO0OO;
            boolean zIsSuccess = it.isSuccess();
            List<TopicInfoModel> data = it.getData();
            boolean z = data == null || data.isEmpty();
            boolean z2 = this.f28681OooO0o0;
            xRefreshLayout.OooOooo(z2, zIsSuccess, z);
            o000O baseAdapter = mainMomentsTopicNewFragment.getBaseAdapter();
    ...
    public static final class OooO00o extends Lambda implements Function0<oo0o0Oo> {
        ...
        public final oo0o0Oo invoke() {
            MainMomentsTopicNewFragment mainMomentsTopicNewFragment = MainMomentsTopicNewFragment.this;
            final oo0o0Oo oo0o0oo = new oo0o0Oo(mainMomentsTopicNewFragment.getContext(), oO00OO0O.item_topic_recommend);
            oo0o0oo.f10098OooO0o = new BaseQuickAdapter.OooO0o() { // from class: o0o0OO0O.o00OOO0
            ...
            oo0o0oo.f10101OooO0oo = new o00O0O0(mainMomentsTopicNewFragment);
            oo0o0oo.OooOooo(oOo00OO0.ic_empty_message_system);
            oo0o0oo.Oooo000(oO00OOo0.no_recommend_topic);
            oo0o0oo.Oooo0OO(new o000OOo(mainMomentsTopicNewFragment));
            return oo0o0oo;
        }
    }

    @SourceDebugExtension({"SMAP\nMainMomentsTopicNewFragment.kt\nKotlin\n*S Kotlin\n*F\n+ 1 MainMomentsTopicNewFragment.kt\ncom/yalla/yalla/ui/fragment/moment/MainMomentsTopicNewFragment$initObserver$1\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,172:1\n1864#2,3:173\n*S KotlinDebug\n*F\n+ 1 MainMomentsTopicNewFragment.kt\ncom/yalla/yalla/ui/fragment/moment/MainMomentsTopicNewFragment$initObserver$1\n*L\n46#1:173,3\n*E\n"})
    public static final class OooO0O0 implements Observer<TopicFollowChange> {
        ...
        public final void onChanged(TopicFollowChange topicFollowChange) {
            ...
            MainMomentsTopicNewFragment mainMomentsTopicNewFragment = MainMomentsTopicNewFragment.this;
            List<T> list = mainMomentsTopicNewFragment.getBaseAdapter().f10111OooOOoo;
            ...
            for (Object obj : list) {
                ...
                if (topicInfoModel.getId() == topicFollowChange2.getTopicId()) {
                    ...
                    mainMomentsTopicNewFragment.getBaseAdapter().notifyItemChanged(i);
                    return;
                }
                i = i2;
            }
    ...
    public static final class OooO0OO extends Lambda implements Function1<FollowTopicModel, Unit> {
        ...
        public final /* synthetic */ TopicInfoModel f28684OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f28685OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MainMomentsTopicNewFragment f28686OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(TopicInfoModel topicInfoModel, MainMomentsTopicNewFragment mainMomentsTopicNewFragment, int i) {
            super(1);
            this.f28684OooO0Oo = topicInfoModel;
            this.f28686OooO0o0 = mainMomentsTopicNewFragment;
            this.f28685OooO0o = i;
        }

        @Override // kotlin.jvm.functions.Function1
        public final Unit invoke(FollowTopicModel followTopicModel) {
            this.f28684OooO0Oo.setJoin(1);
            this.f28686OooO0o0.getBaseAdapter().notifyItemChanged(this.f28685OooO0o);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0o extends Lambda implements Function1<List<TopicInfoModel>, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ boolean f28687OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MainMomentsTopicNewFragment f28688OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(MainMomentsTopicNewFragment mainMomentsTopicNewFragment, boolean z) {
            super(1);
            this.f28687OooO0Oo = z;
            this.f28688OooO0o0 = mainMomentsTopicNewFragment;
        }
        ...
        public final Unit invoke(List<TopicInfoModel> list) {
            ...
            if (list2 != null) {
                boolean z = this.f28687OooO0Oo;
                MainMomentsTopicNewFragment mainMomentsTopicNewFragment = this.f28688OooO0o0;
                if (z) {
                    mainMomentsTopicNewFragment.getBaseAdapter().f10111OooOOoo.addAll(0, list2);
                    mainMomentsTopicNewFragment.getBaseAdapter().notifyDataSetChanged();
                    mainMomentsTopicNewFragment.getBinding().f58159OooO0O0.scrollToPosition(0);
                } else {
    ...
    public MainMomentsTopicNewFragment() {
        ...
        this.vm = androidx.fragment.app.o000O0o.OooO0O0(this, Reflection.getOrCreateKotlinClass(MomentTopicVM.class), new Function0<ViewModelStore>() { // from class: com.yalla.yalla.ui.fragment.moment.MainMomentsTopicNewFragment$special$$inlined$viewModels$default$3
            {
                super(0);
            }
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ Function0 f28692OooO0Oo = null;
            ...
            public final CreationExtras invoke() {
                ...
                Function0 function0 = this.f28692OooO0Oo;
    ...
    private final void initView() {
        getBinding().f58160OooO0OO.setOnRefreshListener(new p562o0oOo0O.o000oOoO() { // from class: o00o0OoO.oOO00O
            @Override // p562o0oOo0O.o000oOoO
            public final void OooO0O0() {
                MainMomentsTopicNewFragment.initView$lambda$0((MainMomentsTopicNewFragment) this);
            }
        });
        getBinding().f58160OooO0OO.setOnLoadMoreListener(new p562o0oOo0O.o000oOoO() { // from class: o0o0OO0O.o00OOO00
            @Override // p562o0oOo0O.o000oOoO
            public final void OooO0O0() {
                MainMomentsTopicNewFragment.initView$lambda$1(this.f53455OooO0Oo);
            }
        });
        getBinding().f58159OooO0O0.setLayoutManager(new FixLinearLayoutManager(getContext()));
        getBinding().f58159OooO0O0.setAdapter(getBaseAdapter());
        oO0OOO00 oo0ooo00 = oO0OOO00.f56606OooO00o;
        RecyclerView recyclerView = getBinding().f58159OooO0O0;
        Intrinsics.checkNotNullExpressionValue(recyclerView, "binding.rvMomentRecommend");
        oO0OOO00.OooO0O0(recyclerView);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$0(MainMomentsTopicNewFragment this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.loadData(true);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$1(MainMomentsTopicNewFragment this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public final void loadData(boolean isRefresh) {
        getVm().circleNewList(isRefresh).observe(getViewLifecycleOwner(), new p377o0OOoOo.o0000OO0(new OooO0o(this, isRefresh), null, new OooO(isRefresh), false, 10));
    }
    ...
    public void scrollTopRefresh() {
        try {
            getBinding().f58160OooO0OO.OooOoOO();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public j2 getViewBinding(@NotNull LayoutInflater inflater, @Nullable ViewGroup container) {
        ...
        j2 j2VarInflate = j2.inflate(inflater);
        Intrinsics.checkNotNullExpressionValue(j2VarInflate, "inflate(inflater)");
        return j2VarInflate;
    }
}
