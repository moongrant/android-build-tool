...
public final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ MomentFollowingVM f28800OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooO0O0(MomentFollowingVM momentFollowingVM, Continuation<? super OooO0O0> continuation) {
        super(2, continuation);
        this.f28800OooO0Oo = momentFollowingVM;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new OooO0O0(this.f28800OooO0Oo, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        this.f28800OooO0Oo.setSupportHidePost(true);
