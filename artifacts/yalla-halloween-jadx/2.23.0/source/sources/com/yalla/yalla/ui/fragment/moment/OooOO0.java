...
public final class OooOO0 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MomentFollowingVM f28804OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooOO0(MomentFollowingVM momentFollowingVM) {
        super(0);
        this.f28804OooO0Oo = momentFollowingVM;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        MomentFollowingVM momentFollowingVM = this.f28804OooO0Oo;
