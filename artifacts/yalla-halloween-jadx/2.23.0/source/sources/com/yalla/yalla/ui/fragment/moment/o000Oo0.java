...
public final class o000Oo0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ MomentFeaturedVM f28869OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o000Oo0(MomentFeaturedVM momentFeaturedVM, Continuation<? super o000Oo0> continuation) {
        super(2, continuation);
        this.f28869OooO0Oo = momentFeaturedVM;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o000Oo0(this.f28869OooO0Oo, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        MomentFeaturedVM momentFeaturedVM = this.f28869OooO0Oo;
