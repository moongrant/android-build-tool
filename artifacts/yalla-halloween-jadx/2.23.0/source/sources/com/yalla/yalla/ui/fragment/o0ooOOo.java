...
public final class o0ooOOo extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MainExploreFragment f28948OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0ooOOo(MainExploreFragment mainExploreFragment) {
        super(0);
        this.f28948OooO0Oo = mainExploreFragment;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        o0OO000.OooO00o("101031");
        Context context = this.f28948OooO0Oo.getContext();
        if (context != null) {
