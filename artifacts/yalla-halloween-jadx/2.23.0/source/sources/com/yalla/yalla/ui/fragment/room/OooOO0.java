...
public final class OooOO0 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ RoomInfoMomentListVM f28958OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooOO0(RoomInfoMomentListVM roomInfoMomentListVM) {
        super(0);
        this.f28958OooO0Oo = roomInfoMomentListVM;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        RoomInfoMomentListVM roomInfoMomentListVM = this.f28958OooO0Oo;
