...
public final class OooOOOO extends Lambda implements Function1<LazyListScope, Unit> {
    ...
    public final /* synthetic */ RoomInfoMomentListVM f28962OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ MutableState<p515o0o0O0O0.o0Oo0oo> f28963OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ RoomInfoMomentFragment f28964OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooOOOO(RoomInfoMomentListVM roomInfoMomentListVM, RoomInfoMomentFragment roomInfoMomentFragment, MutableState<p515o0o0O0O0.o0Oo0oo> mutableState) {
        super(1);
        this.f28962OooO0Oo = roomInfoMomentListVM;
        this.f28964OooO0o0 = roomInfoMomentFragment;
        this.f28963OooO0o = mutableState;
    }
    ...
    public final Unit invoke(LazyListScope lazyListScope) {
        ...
        RoomInfoMomentListVM roomInfoMomentListVM = this.f28962OooO0Oo;
        ...
        final RoomInfoMomentFragment roomInfoMomentFragment = this.f28964OooO0o0;
        final MutableState<p515o0o0O0O0.o0Oo0oo> mutableState = this.f28963OooO0o;
        LazyColumn.items(size, null, function1, ComposableLambdaKt.composableLambdaInstance(-1091073711, true, new Function4<LazyItemScope, Integer, Composer, Integer, Unit>() { // from class: com.yalla.yalla.ui.fragment.room.RoomInfoMomentFragment$initView$1$1$3$2$1$invoke$$inlined$itemsIndexed$default$3
            ...
            public final Unit invoke(LazyItemScope lazyItemScope, Integer num, Composer composer, Integer num2) {
                ...
                if ((i & 731) == 146 && composer2.getSkipping()) {
                    ...
                    o0000oo.OooO00o(momentDetailModel, iIntValue, o0oo0oo2, momentAdapterTag, roomInfoMomentFragment2.getActivity(), EnterRoomParentPage.Moments_Room_SharedRoom, new OooOO0O(roomInfoMomentFragment2), false, false, null, false, 0L, null, null, null, null, composer2, (i2 & 112) | 232968, 0, 65408);
        ...
        if (roomInfoMomentListVM.getListData().size() > 0) {
            ...
            LazyListScope.CC.OooO(LazyColumn, null, null, o0oOO.f53519OooO00o, 3, null);
        }
        return Unit.INSTANCE;
    }
}
