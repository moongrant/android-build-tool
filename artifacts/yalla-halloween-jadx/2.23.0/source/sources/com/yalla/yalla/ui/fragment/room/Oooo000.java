...
public final class Oooo000 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ RoomInfoMomentFragment f28974OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public Oooo000(RoomInfoMomentFragment roomInfoMomentFragment) {
        super(2);
        this.f28974OooO0Oo = roomInfoMomentFragment;
    }
    ...
    public final Unit invoke(Composer composer, Integer num) {
        ...
        if ((iIntValue & 11) == 2 && composer2.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(493337289, iIntValue, -1, "com.yalla.yalla.ui.fragment.room.RoomInfoMomentFragment.initView.<anonymous>.<anonymous> (RoomInfoMomentFragment.kt:74)");
            }
            ...
            RoomInfoMomentFragment roomInfoMomentFragment = this.f28974OooO0Oo;
            ...
            ((p515o0o0O0O0.o0Oo0oo) mutableState.getValue()).OooO0O0(roomInfoMomentListVM.getListData().size(), null, composer2, ConstantsKt.MINIMUM_BLOCK_SIZE, 2);
            composer2.startReplaceableGroup(1157296644);
