...
public final class o0Oo0oo extends Lambda implements Function1<ApiResult<ThemeBoughtModel>, Unit> {
    ...
    public final /* synthetic */ RoomThemeStoreFragment f29140OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0Oo0oo(RoomThemeStoreFragment roomThemeStoreFragment) {
        super(1);
        this.f29140OooO0Oo = roomThemeStoreFragment;
    }
    ...
    public final Unit invoke(ApiResult<ThemeBoughtModel> apiResult) {
        ...
        RoomThemeStoreFragment roomThemeStoreFragment = this.f29140OooO0Oo;
        ...
        w3 w3Var = roomThemeStoreFragment.themePreviewDialog;
        if (w3Var != null) {
            w3Var.OooO0O0();
        }
