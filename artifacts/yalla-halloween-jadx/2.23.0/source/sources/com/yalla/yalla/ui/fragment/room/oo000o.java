...
public final class oo000o extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ RoomThemeStoreFragment f29145OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ ThemeModel f29146OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public oo000o(RoomThemeStoreFragment roomThemeStoreFragment, ThemeModel themeModel) {
        super(0);
        this.f29145OooO0Oo = roomThemeStoreFragment;
        this.f29146OooO0o0 = themeModel;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        this.f29145OooO0Oo.showSend(this.f29146OooO0o0);
