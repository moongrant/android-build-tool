...
public final class ReportScreen extends o00O00O {
    ...
    public static final class OooO00o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ int f29597OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ ColumnScope f29598OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(ColumnScope columnScope, int i) {
            super(2);
            this.f29598OooO0o0 = columnScope;
            this.f29597OooO0o = i;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f29597OooO0o | 1);
            ReportScreen.this.Content(this.f29598OooO0o0, composer, iUpdateChangedFlags);
    ...
    public static final class OooO0O0 extends Lambda implements Function3<RowScope, Composer, Integer, Unit> {
        ...
        public final /* synthetic */ boolean f29599OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(boolean z) {
            super(3);
            this.f29599OooO0Oo = z;
        }
        ...
        public final Unit invoke(RowScope rowScope, Composer composer, Integer num) {
            ...
            if ((iIntValue & 81) == 16 && composer2.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(473083938, iIntValue, -1, "com.yalla.yalla.ui.screen.report.ReportScreen.ReportTitleBar.<anonymous> (ReportScreen.kt:82)");
                }
                if (this.f29599OooO0Oo) {
                    ImageKt.Image(PainterResources_androidKt.painterResource(oOo00OO0.event_preview_close, composer2, 0), (String) null, o0O0O00.OooO0O0(SizeKt.m523size3ABfNKs(Modifier.INSTANCE, Dp.m3765constructorimpl(24)), false, false, 0L, false, null, null, null, com.yalla.yalla.ui.screen.report.OooO00o.f29589OooO0Oo, 253), (Alignment) null, (ContentScale) null, 0.0f, (ColorFilter) null, composer2, 56, 120);
                }
                if (ComposerKt.isTraceInProgress()) {
    ...
    public static final class OooO0OO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ boolean f29601OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ String f29602OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f29603OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ int f29604OooO0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(String str, boolean z, int i, int i2) {
            super(2);
            this.f29602OooO0o0 = str;
            this.f29601OooO0o = z;
            this.f29603OooO0oO = i;
            this.f29604OooO0oo = i2;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            ReportScreen.this.ReportTitleBar(this.f29602OooO0o0, this.f29601OooO0o, composer, RecomposeScopeImplKt.updateChangedFlags(this.f29603OooO0oO | 1), this.f29604OooO0oo);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final Bundle bundleOf(int reportType, long sourceId, @Nullable List<ReportFromData> messagesList, @Nullable Long extendSourceId, @Nullable Boolean fromRoomPage, @Nullable Integer privateChatReportType, @Nullable String friendRequestMessage, @Nullable Integer viewSourceType) {
        ...
        return o00Ooo.OooO0O0(TuplesKt.to(PARAM_DATA, new ReportParam(reportType, Long.valueOf(sourceId), null, null, null, messagesList, extendSourceId, null, num, privateChatReportType, friendRequestMessage)));
    }
    ...
    public void Content(@NotNull ColumnScope columnScope, @Nullable Composer composer, int i) {
        ...
        if ((i2 & 11) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            o00OO00O.f54418OooO00o.OooO0OO(columnScope, false, composerStartRestartGroup, (i2 & 14) | 432);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public final void ReportTitleBar(@NotNull String title, boolean z, @Nullable Composer composer, int i, int i2) {
        ...
        if (i4 == 0) {
            ...
            if ((i3 & 91) == 18 || !composerStartRestartGroup.getSkipping()) {
                ...
                t1.OooO00o(title, 0.0f, 0L, null, null, null, null, ComposableLambdaKt.composableLambda(composerStartRestartGroup, 473083938, true, new OooO0O0(z3)), null, composerStartRestartGroup, (i3 & 14) | 12582912, 382);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                z2 = z3;
