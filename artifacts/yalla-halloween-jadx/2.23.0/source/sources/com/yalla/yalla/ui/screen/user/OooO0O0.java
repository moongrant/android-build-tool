...
public final class OooO0O0 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ FollowingVM f29976OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ FollowUserInfoModel f29977OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooO0O0(FollowingVM followingVM, FollowUserInfoModel followUserInfoModel) {
        super(0);
        this.f29976OooO0Oo = followingVM;
        this.f29977OooO0o0 = followUserInfoModel;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        FollowingVM followingVM = this.f29976OooO0Oo;
        FollowUserInfoModel followUserInfoModel = this.f29977OooO0o0;
