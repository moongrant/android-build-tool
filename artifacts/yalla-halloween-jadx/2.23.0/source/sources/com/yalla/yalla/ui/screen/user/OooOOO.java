...
public final class OooOOO extends Lambda implements Function1<LazyGridScope, Unit> {
    ...
    public final /* synthetic */ HeadFrameViewModel f29984OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooOOO(HeadFrameViewModel headFrameViewModel) {
        super(1);
        this.f29984OooO0Oo = headFrameViewModel;
    }
    ...
    public final Unit invoke(LazyGridScope lazyGridScope) {
        ...
        HeadFrameViewModel headFrameViewModel = this.f29984OooO0Oo;
        final OooOOO0 oooOOO0 = new OooOOO0(headFrameViewModel);
        if (!CollectionUtils.isEmpty(headFrameViewModel.getUnLockHeaddressList())) {
            LazyGridScope.CC.OooO00o(LazyVerticalGrid, null, OooOO0.f29982OooO0Oo, null, o0OO0O0.f54980OooO00o, 5, null);
        ...
        if (!CollectionUtils.isEmpty(headFrameViewModel.getLockHeaddressList())) {
            LazyGridScope.CC.OooO00o(LazyVerticalGrid, null, OooOO0O.f29983OooO0Oo, null, o0OO0O0.f54981OooO0O0, 5, null);
