...
public final class o00oO0o extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ VisitorUserInfoModel f30188OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ UserVisitorVM f30189OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00oO0o(VisitorUserInfoModel visitorUserInfoModel, UserVisitorVM userVisitorVM) {
        super(0);
        this.f30188OooO0Oo = visitorUserInfoModel;
        this.f30189OooO0o0 = userVisitorVM;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        String vid;
        VisitorUserInfoModel visitorUserInfoModel = this.f30188OooO0Oo;
        if (!visitorUserInfoModel.getIsnew() && (vid = visitorUserInfoModel.getVid()) != null) {
            this.f30189OooO0o0.visitorClick(vid);
        }
        Context context = o000O0.f10354OooO00o;
        Activity activityOooO0O0 = com.code.android.util.OooO0O0.OooO0O0();
        if (activityOooO0O0 != null) {
            UserInfoActivity.OooO00o.OooO0OO(UserInfoActivity.f27240Oooo0o, activityOooO0O0, String.valueOf(visitorUserInfoModel.getUserId()), false, 12);
        }
