...
public final class CrossRecyclerView extends RecyclerView {
    ...
    public int f30373OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public int f30374OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public int f30375OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public int f30376OooO0oO;
    ...
    public final boolean onInterceptTouchEvent(@Nullable MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            this.f30375OooO0o0 = motionEvent.getPointerId(0);
            Intrinsics.checkNotNull(motionEvent);
            this.f30374OooO0o = (int) (motionEvent.getX() + 0.5f);
            this.f30376OooO0oO = (int) (motionEvent.getY() + 0.5f);
        ...
        if (actionMasked != 2) {
            ...
            this.f30375OooO0o0 = motionEvent.getPointerId(actionIndex);
            this.f30374OooO0o = (int) (motionEvent.getX(actionIndex) + 0.5f);
            this.f30376OooO0oO = (int) (motionEvent.getY(actionIndex) + 0.5f);
            return super.onInterceptTouchEvent(motionEvent);
        }
        int iFindPointerIndex = motionEvent.findPointerIndex(this.f30375OooO0o0);
        ...
        int i = x - this.f30374OooO0o;
        int i2 = y - this.f30376OooO0oO;
        ...
        boolean z = zCanScrollHorizontally && Math.abs(i) > this.f30373OooO0Oo && (Math.abs(i) >= Math.abs(i2) || zCanScrollVertically);
        if (zCanScrollVertically && Math.abs(i2) > this.f30373OooO0Oo && (Math.abs(i2) >= Math.abs(i) || zCanScrollHorizontally)) {
            z = true;
        }
    ...
    public void setScrollingTouchSlop(int slopConstant) {
        ...
        if (slopConstant == 0) {
            this.f30373OooO0Oo = viewConfiguration.getScaledTouchSlop();
        } else {
            if (slopConstant != 1) {
                return;
            }
            Method method = o0000OO0.f5420OooO00o;
            this.f30373OooO0Oo = viewConfiguration.getScaledPagingTouchSlop();
        }
    }
