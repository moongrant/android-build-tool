...
public final class GiftView extends ConstraintLayout {
    ...
    public boolean f30466OooO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public final t2 f30467OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @NotNull
    public String f30468OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @Nullable
    public GiftPropModel f30469OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    @NotNull
    public String f30470OooO0oO;
    ...
    public static final void setNewGift$lambda$0(GiftView this$0) {
        ...
        scaleAnimation.setAnimationListener(new p1(this$0));
        this$0.f30467OooO0Oo.f58847OooO0OO.startAnimation(scaleAnimation);
    }

    @Nullable
    /* JADX INFO: renamed from: getData, reason: from getter */
    public final GiftPropModel getF30469OooO0o0() {
        return this.f30469OooO0o0;
    }
    ...
    public final void setSelectedGift(boolean selected) {
        ...
        if (lifecycleOwner != null) {
            t2 t2Var = this.f30467OooO0Oo;
            if (!selected) {
                View view = t2Var.f58844OooO;
                Intrinsics.checkNotNullExpressionValue(view, "binding.selectBg");
                o000OO00.OooO0OO(view);
                boolean zIsBlank = StringsKt.isBlank(this.f30468OooO0o);
                SVGAView sVGAView = t2Var.f58847OooO0OO;
                if (zIsBlank) {
                    sVGAView.clearAnimation();
                } else {
                    sVGAView.OooOO0O(this.f30470OooO0oO, lifecycleOwner);
                }
                if (this.f30466OooO) {
            ...
            boolean zIsBlank2 = StringsKt.isBlank(this.f30468OooO0o);
            ...
            if (zIsBlank2) {
                ...
                sVGAView2.OooOO0O(this.f30468OooO0o, lifecycleOwner);
                sVGAView2.OooOO0o();
            }
            LinearLayoutCompat linearLayoutCompat2 = t2Var.f58851OooO0oO;
            Intrinsics.checkNotNullExpressionValue(linearLayoutCompat2, "binding.layoutGiftBackpackTimeTag");
    ...
    public GiftView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        t2 t2VarInflate = t2.inflate(LayoutInflater.from(context), this, true);
        Intrinsics.checkNotNullExpressionValue(t2VarInflate, "inflate(LayoutInflater.from(context), this, true)");
        this.f30467OooO0Oo = t2VarInflate;
        this.f30468OooO0o = "";
        this.f30470OooO0oO = "";
    }
}
