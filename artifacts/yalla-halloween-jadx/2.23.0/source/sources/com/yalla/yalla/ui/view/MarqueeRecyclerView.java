...
public final class MarqueeRecyclerView extends RecyclerView {
    ...
    @Nullable
    public CoroutineScope f30496OooO0Oo;
    ...
    public final void onAttachedToWindow() {
        ...
        if (this.f30496OooO0Oo == null) {
            this.f30496OooO0Oo = CoroutineScopeKt.MainScope();
        }
        CoroutineScope coroutineScope = this.f30496OooO0Oo;
        if (coroutineScope != null) {
            BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new u1(zOooO0o0, this, null), 3, null);
        }
    }
