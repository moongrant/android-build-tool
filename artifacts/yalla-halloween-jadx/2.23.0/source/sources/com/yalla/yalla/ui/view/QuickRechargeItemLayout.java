...
public final class QuickRechargeItemLayout extends FrameLayout {
    ...
    public QuickRechargeItemLayout(@NotNull Context context) {
        ...
        Intrinsics.checkNotNullExpressionValue(h9.inflate(LayoutInflater.from(getContext()), this, true), "inflate(LayoutInflater.from(context), this, true)");
    }
