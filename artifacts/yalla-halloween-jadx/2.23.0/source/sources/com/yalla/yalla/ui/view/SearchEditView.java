...
import p641o0ooOOOO.zb;

/* JADX INFO: loaded from: classes5.dex */
@StabilityInferred(parameters = 0)
@Metadata(d1 = {"\u0000F\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u000e\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u000f\n\u0002\u0018\u0002\n\u0002\b\u000b\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0004\b\u0007\u0018\u00002\u00020\u0001B'\b\u0007\u0012\u0006\u00100\u001a\u00020/\u0012\n\b\u0002\u00102\u001a\u0004\u0018\u000101\u0012\b\b\u0002\u00104\u001a\u000203¢\u0006\u0004\b5\u00106J\u0006\u0010\u0003\u001a\u00020\u0002R\u0017\u0010\t\u001a\u00020\u00048\u0006¢\u0006\f\n\u0004\b\u0005\u0010\u0006\u001a\u0004\b\u0007\u0010\bR\"\u0010\u0011\u001a\u00020\n8\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\u000b\u0010\f\u001a\u0004\b\r\u0010\u000e\"\u0004\b\u000f\u0010\u0010R*\u0010\u001a\u001a\n\u0012\u0004\u0012\u00020\u0013\u0018\u00010\u00128\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\u0014\u0010\u0015\u001a\u0004\b\u0016\u0010\u0017\"\u0004\b\u0018\u0010\u0019R*\u0010\u001e\u001a\n\u0012\u0004\u0012\u00020\u0013\u0018\u00010\u00128\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\u001b\u0010\u0015\u001a\u0004\b\u001c\u0010\u0017\"\u0004\b\u001d\u0010\u0019R*\u0010\"\u001a\n\u0012\u0004\u0012\u00020\u0013\u0018\u00010\u00128\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\u001f\u0010\u0015\u001a\u0004\b \u0010\u0017\"\u0004\b!\u0010\u0019R0\u0010*\u001a\u0010\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\u0013\u0018\u00010#8\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b$\u0010%\u001a\u0004\b&\u0010'\"\u0004\b(\u0010)R0\u0010.\u001a\u0010\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\u0013\u0018\u00010#8\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b+\u0010%\u001a\u0004\b,\u0010'\"\u0004\b-\u0010)¨\u00067"}, d2 = {"Lcom/yalla/yalla/ui/view/SearchEditView;", "Landroid/widget/LinearLayout;", "Landroid/widget/EditText;", "getEditText", "Lo0ooOOOO/zb;", "OooO0Oo", "Lo0ooOOOO/zb;", "getBinding", "()Lo0ooOOOO/zb;", "binding", "", "OooO0o0", "Ljava/lang/String;", "getEditContent", "()Ljava/lang/String;", "setEditContent", "(Ljava/lang/String;)V", "editContent", "Lkotlin/Function0;", "", "OooO0o", "Lkotlin/jvm/functions/Function0;", "getBackgroundListener", "()Lkotlin/jvm/functions/Function0;", "setBackgroundListener", "(Lkotlin/jvm/functions/Function0;)V", "backgroundListener", "OooO0oO", "getForegroundListener", "setForegroundListener", "foregroundListener", "OooO0oo", "getDeleteListener", "setDeleteListener", "deleteListener", "Lkotlin/Function1;", "OooO", "Lkotlin/jvm/functions/Function1;", "getEditTextChangedListener", "()Lkotlin/jvm/functions/Function1;", "setEditTextChangedListener", "(Lkotlin/jvm/functions/Function1;)V", "editTextChangedListener", "OooOO0", "getSearchListener", "setSearchListener", "searchListener", "Landroid/content/Context;", "context", "Landroid/util/AttributeSet;", "attrs", "", "defStyle", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "Common_YallaRelease"}, k = 1, mv = {1, 8, 0})
...
public final class SearchEditView extends LinearLayout {
    ...
    public static final /* synthetic */ int f30621OooOO0O = 0;
    ...
    public static final class OooO0OO extends Lambda implements Function4<CharSequence, Integer, Integer, Integer, Unit> {
        ...
        public final Unit invoke(CharSequence charSequence, Integer num, Integer num2, Integer num3) {
            ...
            if (StringsKt.isBlank(searchEditView.getEditContent())) {
                ImageView imageView = searchEditView.getBinding().f59514OooO0Oo;
                Intrinsics.checkNotNullExpressionValue(imageView, "binding.ivDelete");
                o000OO00.OooO0O0(imageView);
                searchEditView.getBinding().f59515OooO0o.setTextColor(o0000.OooO00o(oO00O0o.color_333333_25));
            } else {
                ImageView imageView2 = searchEditView.getBinding().f59514OooO0Oo;
                Intrinsics.checkNotNullExpressionValue(imageView2, "binding.ivDelete");
                o000OO00.OooOOOO(imageView2);
                searchEditView.getBinding().f59515OooO0o.setTextColor(o0000.OooO00o(oO00O0o.rec_color_00D8C9));
            }
    ...
    public static final class OooO0o extends Lambda implements Function1<View, Unit> {
        ...
        public final Unit invoke(View view) {
            ...
            Intrinsics.checkNotNullParameter(it, "it");
            SearchEditView searchEditView = SearchEditView.this;
            searchEditView.getBinding().f59512OooO0O0.setText("");
    ...
    public final EditText getEditText() {
        EditText editText = this.binding.f59512OooO0O0;
    ...
    public SearchEditView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        zb zbVarInflate = zb.inflate(LayoutInflater.from(context), this, true);
        Intrinsics.checkNotNullExpressionValue(zbVarInflate, "inflate(LayoutInflater.from(context), this, true)");
        this.binding = zbVarInflate;
        this.editContent = "";
        ImageView imageView = zbVarInflate.f59513OooO0OO;
        Intrinsics.checkNotNullExpressionValue(imageView, "binding.ivBg");
        o000OO00.OooO(imageView, new OooO00o());
        ImageView imageView2 = zbVarInflate.f59516OooO0o0;
        Intrinsics.checkNotNullExpressionValue(imageView2, "binding.ivFg");
        o000OO00.OooO(imageView2, new OooO0O0());
        EditText editText = zbVarInflate.f59512OooO0O0;
        Intrinsics.checkNotNullExpressionValue(editText, "binding.etSearch");
        o000Oo0 o000oo1 = new o000Oo0();
        OooO0OO listener = new OooO0OO();
        Intrinsics.checkNotNullParameter(listener, "listener");
        o000oo1.f45517OooO0Oo = listener;
        editText.addTextChangedListener(o000oo1);
        zbVarInflate.f59512OooO0O0.setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: o0o0OoOO.q2
            @Override // android.widget.TextView.OnEditorActionListener
            public final boolean onEditorAction(TextView textView, int i2, KeyEvent keyEvent) {
                Function1<? super String, Unit> function1;
                int i3 = SearchEditView.f30621OooOO0O;
                SearchEditView this$0 = this.f55652OooO00o;
