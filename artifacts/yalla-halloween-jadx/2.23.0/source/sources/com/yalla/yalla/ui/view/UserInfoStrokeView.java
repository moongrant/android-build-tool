...
public final class UserInfoStrokeView extends AppCompatImageView {
    ...
    private final void setKaVipStrokeResource(int kaVipLevel) {
        if (kaVipLevel == VipLevel.Vip1.getValue()) {
            setBackgroundResource(oOo00OO0.room_user_info_dialog_stroke_ka_vip_1);
            return;
        }
        if (kaVipLevel == VipLevel.Vip2.getValue()) {
            setBackgroundResource(oOo00OO0.room_user_info_dialog_stroke_ka_vip_2);
            return;
        }
        if (kaVipLevel == VipLevel.Vip3.getValue()) {
            setBackgroundResource(oOo00OO0.room_user_info_dialog_stroke_ka_vip_3);
            return;
        }
        if (kaVipLevel == VipLevel.Vip4.getValue()) {
            setBackgroundResource(oOo00OO0.room_user_info_dialog_stroke_ka_vip_4);
            return;
        }
        if (kaVipLevel == VipLevel.Vip5.getValue()) {
            setBackgroundResource(oOo00OO0.room_user_info_dialog_stroke_ka_vip_5);
        } else if (kaVipLevel == VipLevel.Vip6.getValue()) {
            setBackgroundResource(oO00OOO.room_user_info_dialog_stroke_ka_vip_6);
        } else {
            setVisibility(8);
        }
    }
    ...
    private final void setVipStrokeResource(int vipLevel) {
        if (vipLevel == PremiumLevel.Premium3.getValue()) {
            setBackgroundResource(oOo00OO0.room_user_info_dialog_stroke_aristocrat_3);
            return;
        }
        if (vipLevel == PremiumLevel.Premium4.getValue()) {
            setBackgroundResource(oOo00OO0.room_user_info_dialog_stroke_aristocrat_4);
        } else if (vipLevel == PremiumLevel.Premium5.getValue()) {
            setBackgroundResource(oOo00OO0.room_user_info_dialog_stroke_aristocrat_5);
        } else {
            setVisibility(8);
        }
    }
    ...
    public /* synthetic */ UserInfoStrokeView(Context context, AttributeSet attributeSet, int i, int i2) {
