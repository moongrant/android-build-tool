...
public final class GiftCustomMadeTipsView extends ConstraintLayout {
    ...
    public static final /* synthetic */ int f30994OooO0oO = 0;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public final ob f30995OooO0Oo;
    ...
    @Nullable
    public GiftPropModel f30997OooO0o0;
    ...
    public static final class OooO00o extends Lambda implements Function1<View, Unit> {
        ...
        public final Unit invoke(View view) {
            ...
            if (showCustomMadeGiftListener != null) {
                showCustomMadeGiftListener.invoke(giftCustomMadeTipsView.f30997OooO0o0);
            }
    ...
    public final void setData(@NotNull GiftPropModel giftPropModel) {
        ...
        this.f30997OooO0o0 = giftPropModel;
    ...
    public final void setLeftToRight(boolean isLTR) {
        if (isLTR) {
            this.f30995OooO0Oo.f58551OooO0O0.setScaleX(-1.0f);
        }
    }
    ...
    public void setVisibility(int visibility) {
        ...
        if (visibility == 8) {
            SVGAView sVGAView = this.f30995OooO0Oo.f58551OooO0O0;
    ...
    public GiftCustomMadeTipsView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        ob obVarInflate = ob.inflate(LayoutInflater.from(context), this, true);
        Intrinsics.checkNotNullExpressionValue(obVarInflate, "inflate(LayoutInflater.from(context), this, true)");
        this.f30995OooO0Oo = obVarInflate;
        ConstraintLayout constraintLayout = obVarInflate.f58550OooO00o;
