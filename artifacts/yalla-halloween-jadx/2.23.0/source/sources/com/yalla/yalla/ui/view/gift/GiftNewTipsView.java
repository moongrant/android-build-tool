...
public final class GiftNewTipsView extends ConstraintLayout {
    ...
    @Nullable
    public GiftPropModel f31004OooO0o0;
    ...
    public static final class OooO00o extends Lambda implements Function1<View, Unit> {
        ...
        public final Unit invoke(View view) {
            ...
            if (viewClickListener != null) {
                viewClickListener.invoke(giftNewTipsView.f31004OooO0o0);
            }
    ...
    public final void setData(@Nullable GiftPropModel gift) {
        this.f31004OooO0o0 = gift;
        if (gift != null) {
            String string = StringsKt.trim((CharSequence) gift.getImageUrl()).toString();
            SVGAView sVGAView = this.f31002OooO0Oo.f58312OooO0O0;
    ...
    public GiftNewTipsView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        kb kbVarInflate = kb.inflate(LayoutInflater.from(context), this, true);
        Intrinsics.checkNotNullExpressionValue(kbVarInflate, "inflate(LayoutInflater.from(context), this, true)");
        this.f31002OooO0Oo = kbVarInflate;
        TextView textView = kbVarInflate.f58313OooO0OO;
        Intrinsics.checkNotNullExpressionValue(textView, "binding.text");
        o000OO00.OooO(textView, new OooO00o());
        SVGAView sVGAView = kbVarInflate.f58312OooO0O0;
        Intrinsics.checkNotNullExpressionValue(sVGAView, "binding.giftImage");
