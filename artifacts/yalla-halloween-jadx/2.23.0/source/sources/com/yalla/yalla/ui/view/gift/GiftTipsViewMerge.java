...
public final class GiftTipsViewMerge extends ConstraintLayout {
    ...
    @Nullable
    public GiftPropModel f31010OooO0o0;
    ...
    public static final class OooO00o extends Lambda implements Function1<View, Unit> {
        ...
        public final Unit invoke(View view) {
            ...
            if (viewClickListener != null) {
                viewClickListener.invoke(giftTipsViewMerge.f31010OooO0o0);
            }
    ...
    public GiftTipsViewMerge(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        mb mbVarInflate = mb.inflate(LayoutInflater.from(context), this, true);
        Intrinsics.checkNotNullExpressionValue(mbVarInflate, "inflate(LayoutInflater.from(context), this, true)");
        this.f31008OooO0Oo = mbVarInflate;
        Intrinsics.checkNotNullParameter(context, "context");
        Context context2 = o000O0.f10354OooO00o;
        Intrinsics.checkNotNullParameter(context, "<set-?>");
        o000O0.f10354OooO00o = context;
        ConstraintLayout constraintLayout = mbVarInflate.f58432OooO0o;
        Intrinsics.checkNotNullExpressionValue(constraintLayout, "binding.layoutRoot");
        o000OO00.OooO(constraintLayout, new OooO00o());
        MarqueeText marqueeText = mbVarInflate.f58430OooO0OO;
