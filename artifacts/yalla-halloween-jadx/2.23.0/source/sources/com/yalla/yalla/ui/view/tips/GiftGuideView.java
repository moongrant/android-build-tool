...
public final class GiftGuideView extends ViewGroup implements View.OnClickListener {
    ...
    public static final class OooO00o extends OooO0OO {
        ...
        @NotNull
        public final List<Rect> f31369OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final int f31370OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final boolean f31371OooO0OO;

        public OooO00o(@NotNull ArrayList hollowRect) {
            Intrinsics.checkNotNullParameter(hollowRect, "hollowRect");
            this.f31369OooO00o = hollowRect;
            this.f31370OooO0O0 = o0000O0.OooO00o(20);
            this.f31371OooO0OO = OooO.OooO0o0();
        }
    ...
    public GiftGuideView(@NotNull Context context) {
        ...
        this.f31364OooO0Oo = view;
        addView(view);
        Paint paint = new Paint();
        this.f31366OooO0o0 = paint;
        paint.setAntiAlias(true);
        paint.setAlpha(0);
        paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.SRC_IN));
        setBackgroundColor(o0000.OooO00o(oO00O0o.color_alpha_70));
    }

    @Override // android.view.View.OnClickListener
    public final void onClick(@NotNull View view) {
        Intrinsics.checkNotNullParameter(view, "view");
        int i = this.f31368OooO0oo;
        if (i == 0) {
            o0OO000.OooO00o("101063");
        } else if (i == 1 || i == 2) {
            o0OO000.OooO00o("101064");
        }
        int i2 = this.f31368OooO0oo;
        if (i2 == this.f31365OooO0o - 1) {
            OooO0O0 oooO0O0 = this.f31363OooO;
            if (oooO0O0 != null) {
                com.yalla.yalla.ui.view.tips.OooO00o.OooOO0o(((o0OOOO00) oooO0O0).f56214OooO00o);
                return;
            }
            return;
        }
        this.f31368OooO0oo = i2 + 1;
        OooO0OO oooO0OO = this.f31367OooO0oO;
        Intrinsics.checkNotNull(oooO0OO);
        View next = this.f31364OooO0Oo;
        int i3 = this.f31368OooO0oo;
        ((OooO00o) oooO0OO).getClass();
        Intrinsics.checkNotNullParameter(next, "next");
        int i4 = (i3 == 0 || i3 == 1 || i3 != 2) ? oOo00OO0.pic_gift_tips_next : oOo00OO0.pic_gift_guide_get_it;
    ...
    public final void onDraw(@NotNull Canvas canvas) {
        ...
        Intrinsics.checkNotNull(oooO0OO);
        Rect hollowRect = ((OooO00o) oooO0OO).f31369OooO00o.get(this.f31368OooO0oo);
        canvas.save();
        canvas.clipRect(hollowRect);
        canvas.drawRect(hollowRect, this.f31366OooO0o0);
        canvas.restore();
        OooO0OO oooO0OO2 = this.f31367OooO0oO;
        ...
        Intrinsics.checkNotNullParameter(hollowRect, "hollowRect");
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        boolean z = oooO00o.f31371OooO0OO;
        int i2 = oooO00o.f31370OooO0O0;
        if (i == 0) {
            OooO00o.OooO00o(new Rect(hollowRect), canvas, oOo00OO0.pic_dot_line_step_one);
            Drawable drawableOooO0O0 = o0000.OooO0O0(oOo00OO0.pic_gift_guide_arrow_left);
            ...
            drawableOooO0O0.draw(canvas);
            Drawable drawableOooO0O1 = o0000.OooO0O0(oOo00OO0.pic_select_a_gift);
        ...
        if (i == 1) {
            Pair pairOooO00o = OooO00o.OooO00o(hollowRect, canvas, oOo00OO0.pic_dot_line_step_two);
            Drawable drawableOooO0O2 = o0000.OooO0O0(oOo00OO0.pic_gift_guide_arrow_down);
            ...
            Drawable drawableOooO0O3 = o0000.OooO0O0(oOo00OO0.pic_select_a_receiver);
        ...
        Pair pairOooO00o2 = OooO00o.OooO00o(hollowRect, canvas, oOo00OO0.pic_dot_line_step_three);
        Drawable drawableOooO0O4 = o0000.OooO0O0(oOo00OO0.pic_gift_guide_arrow_down);
        ...
        Drawable drawableOooO0O5 = o0000.OooO0O0(oOo00OO0.pic_send_step_three);
        ...
        Drawable drawableOooO0O6 = o0000.OooO0O0(oOo00OO0.pic_hourse_step_three);
    ...
    public final void onFinishInflate() {
        ...
        this.f31364OooO0Oo.setOnClickListener(this);
    }

    @Override // android.view.ViewGroup, android.view.View
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        int measuredWidth = getMeasuredWidth() / 2;
        View view = this.f31364OooO0Oo;
        int measuredWidth2 = measuredWidth - (view.getMeasuredWidth() / 2);
        int iOooO00o = o0000O00.OooO00o() / 3;
        view.layout(measuredWidth2, iOooO00o, view.getMeasuredWidth() + measuredWidth2, view.getMeasuredHeight() + iOooO00o);
    }
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if (Result.m4216exceptionOrNullimpl(objM4213constructorimpl) != null) {
            double d = ((double) o0ooOOo.f45529OooO00o) / 2.5d;
    ...
    public final void setHollowAdapter(@NotNull OooO0OO adapter) {
        ...
        this.f31367OooO0oO = adapter;
        adapter.getClass();
        this.f31365OooO0o = 3;
        this.f31368OooO0oo = 0;
        OooO0OO oooO0OO = this.f31367OooO0oO;
        Intrinsics.checkNotNull(oooO0OO);
        View next = this.f31364OooO0Oo;
        ((OooO00o) oooO0OO).getClass();
        Intrinsics.checkNotNullParameter(next, "next");
        next.setBackgroundResource(oOo00OO0.pic_gift_tips_next);
        requestLayout();
        invalidate();
    }
