...
public final class RoomLuckyNumberVM extends o0O0O00 {
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<LiveDataScope<ApiResult<RoomMemberListModel<List<RoomLuckyNumberHistoryModel>>>>, Continuation<? super Unit>, Object> {
        ...
        public int f31470OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ boolean f31471OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f31472OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ RoomLuckyNumberVM f31473OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ long f31474OooO0oo;
        ...
        public OooO00o(boolean z, RoomLuckyNumberVM roomLuckyNumberVM, long j, Continuation<? super OooO00o> continuation) {
            ...
            this.f31471OooO0o = z;
            this.f31473OooO0oO = roomLuckyNumberVM;
            this.f31474OooO0oo = j;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO00o oooO00o = new OooO00o(this.f31471OooO0o, this.f31473OooO0oO, this.f31474OooO0oo, continuation);
            oooO00o.f31472OooO0o0 = obj;
            return oooO00o;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f31470OooO0Oo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f31472OooO0o0;
            ...
            ResultKt.throwOnFailure(obj);
            liveDataScope = (LiveDataScope) this.f31472OooO0o0;
            boolean z = this.f31471OooO0o;
            RoomLuckyNumberVM roomLuckyNumberVM = this.f31473OooO0oO;
            if (z) {
            ...
            this.f31472OooO0o0 = liveDataScope;
            this.f31470OooO0Oo = 1;
            String str = o000oOoO.f44280OooOOO0;
            o0O0ooO o0o0oooOooO00o = o00oOoo.OooO00o(str, "url", str, 0);
            o0o0oooOooO00o.OooO0O0(Boxing.boxLong(this.f31474OooO0oo), "roomid");
            o0o0oooOooO00o.OooO0O0(Boxing.boxInt(i2), "pageindex");
            o0o0oooOooO00o.OooO0O0(Boxing.boxInt(20), "pagesize");
            o0o0oooOooO00o.OooO00o();
            obj = OooOOO.OooO0Oo(new RoomLuckyNumberRepo$luckyNumberRecord$$inlined$call$1(o0o0oooOooO00o, null), this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f31472OooO0o0 = null;
            this.f31470OooO0Oo = 2;
