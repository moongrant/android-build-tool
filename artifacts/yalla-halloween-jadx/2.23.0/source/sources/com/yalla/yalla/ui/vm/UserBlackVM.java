...
public final class UserBlackVM extends o0O0O00 {
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<LiveDataScope<Boolean>, Continuation<? super Unit>, Object> {
        ...
        public final /* synthetic */ boolean f31514OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f31515OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ long f31516OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(long j, boolean z, Continuation continuation) {
            super(2, continuation);
            this.f31514OooO0o = z;
            this.f31516OooO0oO = j;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO00o oooO00o = new OooO00o(this.f31516OooO0oO, this.f31514OooO0o, continuation);
            oooO00o.f31515OooO0o0 = obj;
            return oooO00o;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                ...
                boolean z = this.f31514OooO0o;
                long j = this.f31516OooO0oO;
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public UserBlackVM f31517OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public int f31519OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ long f31520OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(long j, Continuation<? super OooO0O0> continuation) {
            super(2, continuation);
            this.f31520OooO0oO = j;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return UserBlackVM.this.new OooO0O0(this.f31520OooO0oO, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31519OooO0o0;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                UserBlackVM userBlackVM2 = UserBlackVM.this;
                this.f31517OooO0Oo = userBlackVM2;
                this.f31519OooO0o0 = 1;
                Object objOooO0o = oOOO00Oo.f44992OooO00o.OooO0o(this.f31520OooO0oO, this);
                ...
                userBlackVM = this.f31517OooO0Oo;
                ResultKt.throwOnFailure(obj);
            }
