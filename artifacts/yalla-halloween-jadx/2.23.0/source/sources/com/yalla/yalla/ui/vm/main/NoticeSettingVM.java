...
@Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\t\b\u0007\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u000f\u0010\u0010J\u0006\u0010\u0003\u001a\u00020\u0002J\u000e\u0010\u0006\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0004J\u000e\u0010\u0007\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0004R\u001d\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u00040\b8\u0006¢\u0006\f\n\u0004\b\t\u0010\n\u001a\u0004\b\u000b\u0010\fR\u001d\u0010\r\u001a\b\u0012\u0004\u0012\u00020\u00040\b8\u0006¢\u0006\f\n\u0004\b\r\u0010\n\u001a\u0004\b\u000e\u0010\f¨\u0006\u0011"}, d2 = {"Lcom/yalla/yalla/ui/vm/main/NoticeSettingVM;", "Lo0Oo00oO/o0O0O00;", "", "loadNoticeSetting", "", "open", "changeFriendRequestNotice", "changePrivateChatNotice", "Landroidx/lifecycle/MutableLiveData;", "friendRequest", "Landroidx/lifecycle/MutableLiveData;", "getFriendRequest", "()Landroidx/lifecycle/MutableLiveData;", "privateChat", "getPrivateChat", "<init>", "()V", "Common_YallaRelease"}, k = 1, mv = {1, 8, 0})
public final class NoticeSettingVM extends o0O0O00 {
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public int f31805OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ NoticeSettingVM f31806OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ boolean f31807OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(boolean z, NoticeSettingVM noticeSettingVM, Continuation<? super OooO00o> continuation) {
            super(2, continuation);
            this.f31807OooO0o0 = z;
            this.f31806OooO0o = noticeSettingVM;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO00o(this.f31807OooO0o0, this.f31806OooO0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
            ...
            int i = this.f31805OooO0Oo;
            boolean z = this.f31807OooO0o0;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                j0 j0Var = j0.f44845OooO00o;
                this.f31805OooO0Oo = 1;
                j0Var.getClass();
                obj = BuildersKt.withContext(Dispatchers.getIO(), new UserConfigRepo$changeFriendRequestNotice$$inlined$call$1(j0Var, null, z), this);
            ...
            NoticeSettingVM noticeSettingVM = this.f31806OooO0o;
            if (isSuccess) {
                ...
                o0000o00OooOO0o.OooO0o("friendRequestNotice" + o000000O.OooOOo0().getValue(), z);
            } else {
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31808OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                j0 j0Var = j0.f44845OooO00o;
                this.f31808OooO0Oo = 1;
                j0Var.getClass();
                obj = BuildersKt.withContext(Dispatchers.getIO(), new UserConfigRepo$loadFriendRequestNotice$$inlined$call$1(j0Var, null), this);
                if (obj == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
    ...
    public NoticeSettingVM() {
        ...
        this.friendRequest = new MutableLiveData<>(Boolean.valueOf(o0000o00OooOO0o.OooO0O0("friendRequestNotice" + o000000O.OooOOo0().getValue(), true)));
        this.privateChat = new MutableLiveData<>(Boolean.valueOf(o00Oo0.OooOO0o().OooOOO0()));
    }
    ...
    public final void changePrivateChatNotice(boolean open) {
        ...
        o0000o00OooOO0o.getClass();
        o000000O o000000o2 = o000000O.f46674OooO00o;
        o0000o00OooOO0o.OooO0o("privateChatNotice" + o000000O.OooOOo0().getValue(), open);
