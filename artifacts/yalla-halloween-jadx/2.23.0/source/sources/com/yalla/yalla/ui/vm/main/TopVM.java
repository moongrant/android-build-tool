...
@Metadata(d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0011\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0010!\n\u0002\b\t\b\u0007\u0018\u0000 \u00192\u00020\u0001:\u0001\u001aB\u0007¢\u0006\u0004\b\u0017\u0010\u0018J\u001b\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00050\u00042\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0006\u0010\u0007J\u000e\u0010\b\u001a\u00020\u00052\u0006\u0010\u0003\u001a\u00020\u0002J\u000e\u0010\t\u001a\u00020\u00052\u0006\u0010\u0003\u001a\u00020\u0002R(\u0010\f\u001a\b\u0012\u0004\u0012\u00020\u000b0\n8\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\f\u0010\r\u001a\u0004\b\u000e\u0010\u000f\"\u0004\b\u0010\u0010\u0011R\u001d\u0010\u0013\u001a\b\u0012\u0004\u0012\u00020\u00020\u00128\u0006¢\u0006\f\n\u0004\b\u0013\u0010\u0014\u001a\u0004\b\u0015\u0010\u0016¨\u0006\u001b"}, d2 = {"Lcom/yalla/yalla/ui/vm/main/TopVM;", "Lo0Oo00oO/o0O0O00;", "", "rankType", "", "", "getDialogResource", "(Ljava/lang/String;)[Ljava/lang/Integer;", "getWidowBgColor", "getBgResource", "Landroidx/lifecycle/MutableLiveData;", "Lcom/yalla/yalla/model/TopRankData;", "updateTopRank", "Landroidx/lifecycle/MutableLiveData;", "getUpdateTopRank", "()Landroidx/lifecycle/MutableLiveData;", "setUpdateTopRank", "(Landroidx/lifecycle/MutableLiveData;)V", "", "titles", "Ljava/util/List;", "getTitles", "()Ljava/util/List;", "<init>", "()V", "Companion", "OooO00o", "Common_YallaRelease"}, k = 1, mv = {1, 8, 0})
public final class TopVM extends o0O0O00 {
    ...
    @NotNull
    private final List<String> titles = CollectionsKt.mutableListOf(o0000.OooO0OO(oO00OOo0.Hourly), o0000.OooO0OO(oO00OOo0.Daily), o0000.OooO0OO(oO00OOo0.Weekly), o0000.OooO0OO(oO00OOo0.Monthly));
    ...
    public final int getBgResource(@NotNull String rankType) {
        ...
        int i = oOo00OO0.main_top_room_gift_shape;
        if (Intrinsics.areEqual(rankType, TYPE_ROOM_GIFT)) {
            return i;
        }
        if (Intrinsics.areEqual(rankType, TYPE_GIFT_SENT)) {
            return oOo00OO0.main_top_gift_sent_shape;
        }
        if (Intrinsics.areEqual(rankType, TYPE_GIFT_RECEIVE)) {
            return oOo00OO0.main_top_room_gift_receive;
        }
        return Intrinsics.areEqual(rankType, TYPE_YALLA_BILLION) ? oOo00OO0.main_top_yalla_billionare_shape : i;
    }

    @NotNull
    public final Integer[] getDialogResource(@NotNull String rankType) {
        Intrinsics.checkNotNullParameter(rankType, "rankType");
        int i = oO00OOo0.Room_gifts_sent;
        int i2 = oO00OOo0.Room_gifts_sent_Explanation;
        Integer[] numArr = {Integer.valueOf(i), Integer.valueOf(i2)};
        if (Intrinsics.areEqual(rankType, TYPE_ROOM_GIFT)) {
            numArr[0] = Integer.valueOf(i);
            numArr[1] = Integer.valueOf(i2);
        } else if (Intrinsics.areEqual(rankType, TYPE_GIFT_SENT)) {
            numArr[0] = Integer.valueOf(oO00OOo0.Gifts_sent);
            numArr[1] = Integer.valueOf(oO00OOo0.Gifts_sent_Explanation);
        } else if (Intrinsics.areEqual(rankType, TYPE_GIFT_RECEIVE)) {
            numArr[0] = Integer.valueOf(oO00OOo0.Gifts_received);
            numArr[1] = Integer.valueOf(oO00OOo0.Gifts_received_Explanation);
        } else if (Intrinsics.areEqual(rankType, TYPE_YALLA_BILLION)) {
            numArr[0] = Integer.valueOf(oO00OOo0.Gold_Recharge);
            numArr[1] = Integer.valueOf(oO00OOo0.Gold_Recharge_Explanation);
        }
        return numArr;
    }
