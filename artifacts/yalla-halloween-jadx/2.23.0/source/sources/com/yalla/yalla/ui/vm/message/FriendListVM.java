...
@Metadata(d1 = {"\u0000H\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0007\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0016\u0010\u0017J\u0012\u0010\u0005\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00040\u00030\u0002J\u001a\u0010\b\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00040\u00030\u00022\u0006\u0010\u0007\u001a\u00020\u0006J\f\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\n0\tJ\u000e\u0010\u000f\u001a\u00020\u000e2\u0006\u0010\r\u001a\u00020\fJ\u0012\u0010\u0012\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00110\u00100\tJ\u001a\u0010\u0015\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00140\u00100\t2\u0006\u0010\u0013\u001a\u00020\f¨\u0006\u0018"}, d2 = {"Lcom/yalla/yalla/ui/vm/message/FriendListVM;", "Lo0Oo00oO/o0O0O00;", "Lkotlinx/coroutines/flow/Flow;", "Landroidx/paging/o0OOO0o;", "Lcom/yalla/yalla/data/db/table/FriendInfo;", "loadFriendInfoList", "", "searchText", "searchFriendAsFlow", "Landroidx/lifecycle/LiveData;", "", "loadFriendCount", "", "friendId", "", "updateInRoomState", "Lcom/yalla/yalla/model/http/ApiResult;", "Lcom/yalla/yalla/model/FriendInRoomModel;", "loadFriendInRoomList", "userId", "Lcom/yalla/yalla/model/CheckUserInRoomModel;", "loadUserInRoomInfo", "<init>", "()V", "Common_YallaRelease"}, k = 1, mv = {1, 8, 0})
public final class FriendListVM extends o0O0O00 {
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<LiveDataScope<ApiResult<FriendInRoomModel>>, Continuation<? super Unit>, Object> {
        ...
        public /* synthetic */ Object f31899OooO0o0;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f31899OooO0o0;
            ...
            this.f31899OooO0o0 = liveDataScope;
            this.f31898OooO0Oo = 1;
            obj = ooo0o0o.OooO0Oo(this);
            ...
            if (!(oO00000o.f47196OooO0OO != null)) {
                oO00000o.f47196OooO0OO = BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), Dispatchers.getIO(), null, new oO00000(z, null), 2, null);
            }
            if (apiResult.isSuccess()) {
                ...
                if (friendInRoomModel2 != null && (data = friendInRoomModel2.getData()) != null) {
                    ...
                    while (it.hasNext()) {
                        ...
                        o0o00OooOOo2.OooOOO(((Number) androidx.compose.ui.graphics.colorspace.OooO0OO.OooO0O0()).longValue(), userId, true);
                    }
                }
            }
            this.f31899OooO0o0 = null;
    ...
    public static final class OooO0O0 extends Lambda implements Function0<androidx.paging.o0O0O00<Integer, FriendInfo>> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO0O0 f31900OooO0Oo = new OooO0O0();
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<LiveDataScope<ApiResult<CheckUserInRoomModel>>, Continuation<? super Unit>, Object> {
        ...
        public final /* synthetic */ long f31902OooO0o;
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0OO oooO0OO = new OooO0OO(this.f31902OooO0o, continuation);
            oooO0OO.f31903OooO0o0 = obj;
            return oooO0OO;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            String url = o000OOo0.OooO0OO("/Webservers/User/UserInBar");
            Intrinsics.checkNotNullParameter(url, "url");
            o0O0ooO o0o0ooo = new o0O0ooO(url, 0);
            o0o0ooo.OooO0O0(Boxing.boxLong(this.f31902OooO0o), "touserid");
            o0o0ooo.OooO00o();
            obj = OooOOO.OooO0Oo(new UserInfoRepo$getUserInRoomInfo$$inlined$call$1(o0o0ooo, null), this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
    ...
    public static final class OooO0o extends Lambda implements Function0<androidx.paging.o0O0O00<Integer, FriendInfo>> {
        ...
        public OooO0o(String str) {
            super(0);
            this.f31904OooO0Oo = str;
        }

        @Override // kotlin.jvm.functions.Function0
        public final androidx.paging.o0O0O00<Integer, FriendInfo> invoke() {
            String searchText = this.f31904OooO0Oo;
    ...
    public final LiveData<Integer> loadFriendCount() {
        o0O00 o0o00OooOOo = o000OOo.OooO00o().OooOOo();
        o000000O o000000o2 = o000000O.f46674OooO00o;
        return FlowLiveDataConversions.asLiveData$default(o0o00OooOOo.OooO0o(((Number) androidx.compose.ui.graphics.colorspace.OooO0OO.OooO0O0()).longValue()), ViewModelKt.getViewModelScope(this).getCoroutineContext(), 0L, 2, (Object) null);
    }
    ...
    public final Flow<o0OOO0o<FriendInfo>> loadFriendInfoList() {
        ...
        OooO0O0 pagingSourceFactory = OooO0O0.f31900OooO0Oo;
    ...
    public final void updateInRoomState(long friendId) {
        o0O00 o0o00OooOOo = o000OOo.OooO00o().OooOOo();
        o000000O o000000o2 = o000000O.f46674OooO00o;
        o0o00OooOOo.OooOOO(((Number) androidx.compose.ui.graphics.colorspace.OooO0OO.OooO0O0()).longValue(), friendId, false);
    }
}
