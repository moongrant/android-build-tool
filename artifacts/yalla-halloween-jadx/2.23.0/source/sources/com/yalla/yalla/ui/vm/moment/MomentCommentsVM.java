...
public final class MomentCommentsVM extends BaseMomentDetailVM {
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<Integer, Continuation<? super p143o00Oo000.OooO<MomentCommentDetailModel>>, Object> {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            ...
            oooO00o.f32167OooO0o0 = ((Number) obj).intValue();
            return oooO00o;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Integer num, Continuation<? super p143o00Oo000.OooO<MomentCommentDetailModel>> continuation) {
    ...
    private final void getComments() {
        setCommentsPagerState(new p143o00Oo000.OooO0O0<>(ViewModelKt.getViewModelScope(this), new OooO00o(null)));
    }
    ...
    public final void addComment(@NotNull MomentCommentDetailModel data) {
        ...
        p143o00Oo000.OooO0O0<MomentCommentDetailModel> commentsPagerState = getCommentsPagerState();
        if (commentsPagerState != null && (list3 = commentsPagerState.f37663OooO0Oo) != null) {
            z = list3.isEmpty();
        }
        if (z) {
            p143o00Oo000.OooO0O0<MomentCommentDetailModel> commentsPagerState2 = getCommentsPagerState();
            if (commentsPagerState2 != null && (list2 = commentsPagerState2.f37663OooO0Oo) != null) {
                list2.add(data);
            }
        } else {
            p143o00Oo000.OooO0O0<MomentCommentDetailModel> commentsPagerState3 = getCommentsPagerState();
            if (commentsPagerState3 != null && (list = commentsPagerState3.f37663OooO0Oo) != null) {
                list.add(0, data);
            }
        }
        p143o00Oo000.OooO0O0<MomentCommentDetailModel> commentsPagerState4 = getCommentsPagerState();
    ...
    /* JADX WARN: Multi-variable type inference failed */
    @Nullable
    public final p143o00Oo000.OooO0O0<MomentCommentDetailModel> getCommentsPagerState() {
        return (p143o00Oo000.OooO0O0) this.commentsPagerState.getValue();
    }
    ...
    public final void setCommentsPagerState(@Nullable p143o00Oo000.OooO0O0<MomentCommentDetailModel> oooO0O0) {
        this.commentsPagerState.setValue(oooO0O0);
    }
