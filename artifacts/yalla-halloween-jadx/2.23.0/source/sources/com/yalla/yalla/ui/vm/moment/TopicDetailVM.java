...
public final class TopicDetailVM extends BaseMomentDetailVM {
    ...
    public static final class OooO00o extends Lambda implements Function1<Response<ArrayList<UserInfo>>, Unit> {
        ...
        public final /* synthetic */ o0OOO0o<ArrayList<UserInfo>> f32379OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(o0OOO0o<ArrayList<UserInfo>> o0ooo0o2) {
            super(1);
            this.f32379OooO0o0 = o0ooo0o2;
        }
        ...
        public final Unit invoke(Response<ArrayList<UserInfo>> response) {
            ...
            this.f32379OooO0o0.postValue(it);
    ...
    public static final class OooO0O0 extends Lambda implements Function1<Response<Integer>, Unit> {
        ...
        public final /* synthetic */ o0OOO0o<Integer> f32380OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ boolean f32381OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ TopicDetailVM f32382OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(o0OOO0o<Integer> o0ooo0o2, TopicDetailVM topicDetailVM, boolean z) {
            super(1);
            this.f32380OooO0Oo = o0ooo0o2;
            this.f32382OooO0o0 = topicDetailVM;
            this.f32381OooO0o = z;
        }
        ...
        public final Unit invoke(Response<Integer> response) {
            ...
            Intrinsics.checkNotNullParameter(it, "it");
            this.f32380OooO0Oo.postValue(it);
            boolean isSuccess = it.getIsSuccess();
            TopicDetailVM topicDetailVM = this.f32382OooO0o0;
            if (isSuccess) {
                topicDetailVM.isFollow().postValue(Boolean.valueOf(this.f32381OooO0o));
            } else {
    ...
    @NotNull
    public final o0OOO0o<ArrayList<UserInfo>> circleAdmin(@NotNull String circleId) {
        Intrinsics.checkNotNullParameter(circleId, "circleId");
        o0OOO0o<ArrayList<UserInfo>> o0ooo0o2 = new o0OOO0o<>();
        OooO00o listener = new OooO00o(o0ooo0o2);
        Intrinsics.checkNotNullParameter(circleId, "circleId");
        Intrinsics.checkNotNullParameter(listener, "listener");
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), null, null, new b0(circleId, listener, null), 3, null);
        return o0ooo0o2;
    }

    @NotNull
    public final o0OOO0o<Integer> followTopic(boolean follow) {
        o0OOO0o<Integer> o0ooo0o2 = new o0OOO0o<>();
        TopicInfoModel value = this.topicDetailLocal.getValue();
        if (value != null) {
            long id = value.getId();
            OooO0O0 listener = new OooO0O0(o0ooo0o2, this, follow);
            Intrinsics.checkNotNullParameter(listener, "listener");
            BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), null, null, new d0(id, follow, listener, null), 3, null);
        }
        return o0ooo0o2;
    }
    ...
    @NotNull
    public final o0OOO0o<TopicInfoModel> getTopicDetailLiveData() {
    ...
    public final void loadTopicDetail() {
        ...
        if (value != null) {
            ...
            Intrinsics.checkNotNullParameter(listener, "listener");
            BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), null, null, new g0(id, listener, null), 3, null);
        }
    }
