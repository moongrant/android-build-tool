...
public final class ReportVm extends o0O0O00 {
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<o0OO00O<ApiResult<Object>>, Continuation<? super Unit>, Object> {

        /* JADX INFO: renamed from: OooO, reason: collision with root package name */
        public final /* synthetic */ Long f32518OooO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f32519OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f32521OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ Integer f32522OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ int f32523OooO0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(Integer num, int i, Long l, Continuation<? super OooO0O0> continuation) {
            super(2, continuation);
            this.f32522OooO0oO = num;
            this.f32523OooO0oo = i;
            this.f32518OooO = l;
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0O0 oooO0O0 = ReportVm.this.new OooO0O0(this.f32522OooO0oO, this.f32523OooO0oo, this.f32518OooO, continuation);
            oooO0O0.f32521OooO0o0 = obj;
            return oooO0O0;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            o0OO00O o0oo00o2;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f32519OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                o0OO00O o0oo00o3 = (o0OO00O) this.f32521OooO0o0;
                ReportVm reportVm = ReportVm.this;
                List<ReportFromData> messagesList = reportVm.getMessagesList();
                String strOooO0O0 = !(messagesList == null || messagesList.isEmpty()) ? oO000Oo0.OooO0O0(OooOO0.OooO00o(reportVm.getMessagesList())) : null;
                String strOooO0O1 = reportVm.getFriendRequestMessage() != null ? oO000Oo0.OooO0O0(reportVm.getFriendRequestMessage()) : null;
                m mVar = m.f44870OooO00o;
                int reportType = reportVm.getReportType();
                Long sourceId = reportVm.getSourceId();
                Integer num = this.f32522OooO0oO;
                Integer numBoxInt = Boxing.boxInt(this.f32523OooO0oo);
                Long l = this.f32518OooO;
                this.f32521OooO0o0 = o0oo00o3;
                this.f32519OooO0Oo = 1;
                Object objOooO0O0 = mVar.OooO0O0(reportType, sourceId, num, numBoxInt, l, strOooO0O0, strOooO0O1, this);
                ...
                o0oo00o2 = (o0OO00O) this.f32521OooO0o0;
                ResultKt.throwOnFailure(obj);
            }
    ...
    public static /* synthetic */ o0OO00O report$default(ReportVm reportVm, int i, Integer num, Long l, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            l = null;
        }
    ...
    @NotNull
    public final o0OO00O<ApiResult<Object>> report(int reasonId, @Nullable Integer categoryId, @Nullable Long extendSourceId) {
        return o0ooOOo.OooO00o(this, new OooO0O0(categoryId, reasonId, extendSourceId, null));
    }
