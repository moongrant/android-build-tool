...
public final class UserOutFitVM extends o0O0O00 {
    ...
    @NotNull
    private final p143o00Oo000.OooO0O0<ShopVehicleListModel> myVehiclesPager;
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<Integer, Continuation<? super OooO<ShopVehicleListModel>>, Object> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f32779OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ int f32780OooO0o0;
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            ...
            oooO00o.f32780OooO0o0 = ((Number) obj).intValue();
            return oooO00o;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Integer num, Continuation<? super OooO<ShopVehicleListModel>> continuation) {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f32779OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                if (this.f32780OooO0o0 != 1) {
                    return new OooO(new ArrayList());
                }
                n0 n0Var = n0.f44911OooO00o;
                this.f32779OooO0Oo = 1;
                n0Var.getClass();
                String url = o000OOo0.OooO0OO("Webservers/Shop/ShopVehicleList");
                Intrinsics.checkNotNullParameter(url, "url");
                o0O0ooO o0o0ooo = new o0O0ooO(url, 0);
                o0o0ooo.OooO0O0("1", "vehicleType");
                obj = OooOOO.OooO0Oo(new VehicleStoreRepository$shopVehicleListV2$$inlined$call$1(o0o0ooo, null), this);
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<o0OO00O<ApiResult<String>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f32781OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ ShopVehicleListModel f32782OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f32783OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ UserOutFitVM f32784OooO0oO;
        ...
        public OooO0O0(ShopVehicleListModel shopVehicleListModel, UserOutFitVM userOutFitVM, Continuation<? super OooO0O0> continuation) {
            super(2, continuation);
            this.f32782OooO0o = shopVehicleListModel;
            this.f32784OooO0oO = userOutFitVM;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0O0 oooO0O0 = new OooO0O0(this.f32782OooO0o, this.f32784OooO0oO, continuation);
            oooO0O0.f32783OooO0o0 = obj;
            return oooO0O0;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            o0OO00O o0oo00o2;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f32781OooO0Oo;
            ShopVehicleListModel shopVehicleListModel = this.f32782OooO0o;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                o0OO00O o0oo00o3 = (o0OO00O) this.f32783OooO0o0;
                n0 n0Var = n0.f44911OooO00o;
                long shopId = shopVehicleListModel.getShopId();
                boolean zIsSelected = shopVehicleListModel.isSelected();
                this.f32783OooO0o0 = o0oo00o3;
                this.f32781OooO0Oo = 1;
                n0Var.getClass();
                String url = o000OOo0.OooO0OO("/Webservers/User/UserVehicleEdit");
                Intrinsics.checkNotNullParameter(url, "url");
                o0O0ooO o0o0ooo = new o0O0ooO(url, 0);
                o0o0ooo.OooO0O0(Boxing.boxLong(shopId), "vehicleid");
                o0o0ooo.OooO0O0(Boxing.boxInt(zIsSelected ? 1 : 0), "type");
                Object objOooO0Oo = OooOOO.OooO0Oo(new VehicleStoreRepository$userVehicleEditV2$$inlined$call$1(o0o0ooo, null), this);
                ...
                o0oo00o2 = (o0OO00O) this.f32783OooO0o0;
                ResultKt.throwOnFailure(obj);
            }
            ApiResult apiResult = (ApiResult) obj;
            if (apiResult.isSuccess()) {
                UserOutFitVM userOutFitVM = this.f32784OooO0oO;
                Iterator<ShopVehicleListModel> it = userOutFitVM.getMyVehiclesPager().f37663OooO0Oo.iterator();
                int i2 = 0;
                while (true) {
                    if (!it.hasNext()) {
                        i2 = -1;
                ...
                if (i2 >= 0 && !Intrinsics.areEqual(userOutFitVM.getMyVehiclesPager().f37663OooO0Oo.get(i2), shopVehicleListModel)) {
                    userOutFitVM.getMyVehiclesPager().f37663OooO0Oo.get(i2).setSelected(false);
                }
    ...
    public UserOutFitVM() {
        ...
        this.myVehiclesPager = new p143o00Oo000.OooO0O0<>(ViewModelKt.getViewModelScope(this), new OooO00o(null));
    }
    ...
    @NotNull
    public final p143o00Oo000.OooO0O0<ShopVehicleListModel> getMyVehiclesPager() {
    ...
    @NotNull
    public final o0OO00O<ApiResult<String>> useVehicleEdit(@NotNull ShopVehicleListModel item) {
        Intrinsics.checkNotNullParameter(item, "item");
        return o0ooOOo.OooO00o(this, new OooO0O0(item, this, null));
    }
}
