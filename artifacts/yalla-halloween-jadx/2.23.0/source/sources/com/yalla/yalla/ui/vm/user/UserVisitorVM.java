...
@Metadata(d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\b\u0007\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0010\u0010\u0011J\b\u0010\u0003\u001a\u00020\u0002H\u0002J\u000e\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u0004R\u0016\u0010\b\u001a\u00020\u00048\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\b\u0010\tR\u001d\u0010\f\u001a\b\u0012\u0004\u0012\u00020\u000b0\n8\u0006¢\u0006\f\n\u0004\b\f\u0010\r\u001a\u0004\b\u000e\u0010\u000f¨\u0006\u0012"}, d2 = {"Lcom/yalla/yalla/ui/vm/user/UserVisitorVM;", "Lo0Oo00oO/o0O0O00;", "", "have100", "", "vid", "", "visitorClick", "dataSort", "Ljava/lang/String;", "Lo00Oo000/OooO0O0;", "Lcom/yalla/yalla/model/user/VisitorUserInfoModel;", "userVisitorPager", "Lo00Oo000/OooO0O0;", "getUserVisitorPager", "()Lo00Oo000/OooO0O0;", "<init>", "()V", "Common_YallaRelease"}, k = 1, mv = {1, 8, 0})
public final class UserVisitorVM extends o0O0O00 {
    ...
    @NotNull
    private final p143o00Oo000.OooO0O0<VisitorUserInfoModel> userVisitorPager = new p143o00Oo000.OooO0O0<>(ViewModelKt.getViewModelScope(this), new OooO00o(null));
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<Integer, Continuation<? super OooO<VisitorUserInfoModel>>, Object> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f32785OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ int f32787OooO0o0;
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            ...
            oooO00o.f32787OooO0o0 = ((Number) obj).intValue();
            return oooO00o;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Integer num, Continuation<? super OooO<VisitorUserInfoModel>> continuation) {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i2 = this.f32785OooO0Oo;
            UserVisitorVM userVisitorVM = UserVisitorVM.this;
            boolean z = false;
            if (i2 == 0) {
                ResultKt.throwOnFailure(obj);
                int i3 = this.f32787OooO0o0;
                if (i3 == 1) {
                    userVisitorVM.dataSort = "";
                }
                UserInfoRepo userInfoRepo = UserInfoRepo.f23204OooO00o;
                String str = userVisitorVM.dataSort;
                this.f32787OooO0o0 = i3;
                this.f32785OooO0Oo = 1;
                userInfoRepo.getClass();
                String url = o000OOo0.OooO0OO("/Webservers/Messages/UserVisitorlist");
                Intrinsics.checkNotNullParameter(url, "url");
                o0O0ooO o0o0ooo = new o0O0ooO(url, 0);
                o0o0ooo.OooO0O0(Boxing.boxInt(i3), "pageindex");
                o0o0ooo.OooO0O0(str, "datesort");
                o0o0ooo.OooO00o();
                Object objOooO0Oo = OooOOO.OooO0Oo(new UserInfoRepo$loadUserVisitorList$$inlined$call$1(o0o0ooo, null), this);
            ...
            if (apiResult.isSuccess() && i == 1) {
                ...
                ooo00oooOooOooo.OooO(((Number) OooO0OO.OooO0O0()).longValue());
            }
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f32788OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ UserVisitorVM f32789OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ String f32790OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(String str, UserVisitorVM userVisitorVM, Continuation<? super OooO0O0> continuation) {
            super(2, continuation);
            this.f32790OooO0o0 = str;
            this.f32789OooO0o = userVisitorVM;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0O0(this.f32790OooO0o0, this.f32789OooO0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f32788OooO0Oo;
            Object obj2 = null;
            String str = this.f32790OooO0o0;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                UserInfoRepo userInfoRepo = UserInfoRepo.f23204OooO00o;
                this.f32788OooO0Oo = 1;
                userInfoRepo.getClass();
                String url = o000OOo0.OooO0OO("/Webservers/Messages/VisitorLogClick");
                Intrinsics.checkNotNullParameter(url, "url");
                o0O0ooO o0o0ooo = new o0O0ooO(url, 0);
                o0o0ooo.OooO0O0(str, "vid");
                o0o0ooo.OooO00o();
                obj = OooOOO.OooO0Oo(new UserInfoRepo$clickVisitor$$inlined$call$1(o0o0ooo, null), this);
            ...
            if (((ApiResult) obj).isSuccess()) {
                for (Object obj3 : this.f32789OooO0o.getUserVisitorPager().f37663OooO0Oo) {
    ...
    public final boolean have100() {
        return this.userVisitorPager.f37663OooO0Oo.size() >= 100;
    }

    @NotNull
    public final p143o00Oo000.OooO0O0<VisitorUserInfoModel> getUserVisitorPager() {
