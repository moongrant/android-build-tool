...
public final /* data */ class BridgeBean {
    ...
    public int hashCode() {
        return this.callback.hashCode() + o0OO00O.OooO00o(this.params, o0OO00O.OooO00o(this.api, this.bridge.hashCode() * 31, 31), 31);
    }

    @NotNull
    public String toString() {
        return "BridgeBean(bridge=" + this.bridge + ", api=" + this.api + ", params=" + this.params + ", callback=" + this.callback + ')';
    }
}
