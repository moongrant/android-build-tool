...
public final class WebBrowser extends ConstraintLayout implements View.OnClickListener {
    ...
    public static final class OooO extends Lambda implements Function2<Integer, p611o0oo0o.o00O0O, Unit> {
        public OooO() {
            super(2);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Integer num, p611o0oo0o.o00O0O o00o0o2) {
            num.intValue();
            p611o0oo0o.o00O0O i = o00o0o2;
            Intrinsics.checkNotNullParameter(i, "i");
            Object obj = i.f57006OooO0O0;
    ...
    public final class OooO0O0 extends WebChromeClient {
        ...
        public final /* synthetic */ WebBrowser f32936OooO00o;

        public OooO0O0(WebBrowser this$0) {
            Intrinsics.checkNotNullParameter(this$0, "this$0");
            this.f32936OooO00o = this$0;
        }
        ...
        public final void onProgressChanged(@Nullable WebView webView, int i) {
            ...
            ProgressBar progressBar = this.f32936OooO00o.progressBar;
            if (progressBar == null) {
        ...
        public final void onReceivedTitle(@Nullable WebView webView, @Nullable String str) {
            ...
            WebBrowser webBrowser = this.f32936OooO00o;
    ...
    public final class OooO0OO extends WebViewClient {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final /* synthetic */ WebBrowser f32937OooO00o;

        public OooO0OO(WebBrowser this$0) {
            Intrinsics.checkNotNullParameter(this$0, "this$0");
            this.f32937OooO00o = this$0;
        }
        ...
        public final void onPageFinished(@NotNull WebView view, @Nullable String str) {
            ...
            WebBrowser webBrowser = this.f32937OooO00o;
        ...
        public final void onReceivedError(@Nullable WebView webView, @Nullable WebResourceRequest webResourceRequest, @Nullable WebResourceError webResourceError) {
            ...
            this.f32937OooO00o.loadError = true;
        }
        ...
        public final boolean shouldOverrideUrlLoading(@Nullable WebView webView, @Nullable WebResourceRequest webResourceRequest) {
            ...
            if (webResourceRequest != null && (url = webResourceRequest.getUrl()) != null) {
                ...
                if (StringsKt.Oooo00o(string, "intent://") && webBrowser.canOpenIntent(string)) {
                ...
                if (StringsKt.Oooo00o(string, "https") && webView != null) {
    ...
    private final boolean canDownloadFile(String url) {
        return StringsKt.Oooo00o(url, "https://files.yalla.chat/download/apk");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final boolean canOpenIntent(String url) {
        return StringsKt.Oooo00o(url, "intent://play.app.goo.gl/?link=https://play.google.com/store/apps/details?id%3Dcom.yallatech.yallachat#Intent;");
    }
    ...
    private final String createJsForInject() {
        ...
        StringBuilder sbOooO00o = o00OO.OooO00o(jsFromAssets2);
        Iterator<T> it = this.jsBridges.iterator();
        while (it.hasNext()) {
            sbOooO00o.append(StringsKt.OooOoO(jsFromAssets, "$bridge", ((o00Oo0) it.next()).OooO00o()));
        }
    ...
    private final void initWebView() {
        ...
        getWebView().setDownloadListener(new DownloadListener() { // from class: o0oo0OOO.i1
            @Override // android.webkit.DownloadListener
            public final void onDownloadStart(String str, String str2, String str3, String str4, long j) {
                WebBrowser.m4206initWebView$lambda0(this.f56903OooO00o, str, str2, str3, str4, j);
            }
        });
    }
    ...
    public static final void m4206initWebView$lambda0(WebBrowser this$0, String url, String str, String str2, String str3, long j) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        ...
        if (this$0.canDownloadFile(url)) {
            ...
            try {
                ...
                e.printStackTrace();
                o000OOo0.OooO00o(context, new OooO00o.OooO00o.OooO00o.OooO00o.OooOOO0.o00Ooo.OooO0OO(context));
            }
        }
    }
    ...
    public final void openCamera() {
        ...
        if (ContextCompat.OooO00o(appCompatActivity, "android.permission.CAMERA") != 0) {
            ...
            OooO00o.OooO0Oo(appCompatActivity2, new String[]{"android.permission.CAMERA"}, 3);
            return;
        }
        try {
    ...
    public final void showMediaDlg() {
        ...
        String string = getResources().getString(o00000.base_platform_camera);
        Intrinsics.checkNotNullExpressionValue(string, "resources.getString(R.string.base_platform_camera)");
        p611o0oo0o.o00O0O o00o0o2 = new p611o0oo0o.o00O0O(string, 2);
        String string2 = getResources().getString(o00000.base_platform_album);
        Intrinsics.checkNotNullExpressionValue(string2, "resources.getString(R.string.base_platform_album)");
        p611o0oo0o.o00O0O o00o0o3 = new p611o0oo0o.o00O0O(string2, 1);
        arrayList.add(o00o0o2);
        arrayList.add(o00o0o3);
        Context context = getContext();
        Intrinsics.checkNotNullExpressionValue(context, "context");
        o000oOoO.OooO00o(context, arrayList, new OooO()).setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: o0oo0OOO.j1
            @Override // android.content.DialogInterface.OnCancelListener
            public final void onCancel(DialogInterface dialogInterface) {
                WebBrowser.m4207showMediaDlg$lambda11(this.f56904OooO0Oo, dialogInterface);
            }
        });
    }
    ...
    public static final void m4207showMediaDlg$lambda11(WebBrowser this$0, DialogInterface dialogInterface) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public final void addJavaBridge(@NotNull o00Oo0... js) {
        ...
        for (o00Oo0 o00oo1 : bridges) {
            o00o0o2.f159OooO0O0.put(o00oo1.OooO00o(), o00oo1);
        }
    }
    ...
    public void onFinishInflate() {
        ...
        View viewInflate = LayoutInflater.from(getContext()).inflate(o000000O.base_platform_layout_browser, this);
        View viewFindViewById = viewInflate.findViewById(o000000.webView);
        ...
        View viewFindViewById2 = viewInflate.findViewById(o000000.tvWebTitle);
        ...
        View viewFindViewById3 = viewInflate.findViewById(o000000.progressBar);
        ...
        View viewFindViewById4 = viewInflate.findViewById(o000000.ivWebClose);
