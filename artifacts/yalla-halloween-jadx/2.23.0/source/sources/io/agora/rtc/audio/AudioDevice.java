...
class AudioDevice {
    ...
    private int CheckAudioStatus(int i) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            if (i == 0) {
                ...
                while (it.hasNext()) {
                    if (o00OO00O.OooO00o(it.next()).getClientAudioSessionId() != audioSessionId) {
                        i2 = 1033;
                    }
                }
            }
    ...
    private int InitPlayback(int i, int i2, int i3, int i4) {
        ...
        StringBuilder sbOooO00o2 = o0000O0.OooO00o("Java playback buffer size is ", i6, ", duration is ");
        sbOooO00o2.append((i6 * 1000) / ((i * i2) * 2));
        sbOooO00o2.append(" ms");
        Logging.d("AudioDevice Java", sbOooO00o2.toString());
