...
public final class GrpcUtil$Http2Error {
    ...
    static {
        ...
        GrpcUtil$Http2Error grpcUtil$Http2Error9 = new GrpcUtil$Http2Error("CANCEL", 8, 8, Status.f33009OooO0o0);
        ...
        Status status3 = Status.f33011OooO0oo;
        GrpcUtil$Http2Error grpcUtil$Http2Error12 = new GrpcUtil$Http2Error("ENHANCE_YOUR_CALM", 11, 11, Oooo000.OooO00o(status3.f33014OooO0O0, "Bandwidth exhausted") ? status3 : new Status(status3.f33013OooO00o, "Bandwidth exhausted", status3.f33015OooO0OO));
        ENHANCE_YOUR_CALM = grpcUtil$Http2Error12;
        Status status4 = Status.f33010OooO0oO;
        if (!Oooo000.OooO00o(status4.f33014OooO0O0, "Permission denied as protocol is not secure enough to call")) {
            status4 = new Status(status4.f33013OooO00o, "Permission denied as protocol is not secure enough to call", status4.f33015OooO0OO);
        }
        ...
        GrpcUtil$Http2Error grpcUtil$Http2Error14 = new GrpcUtil$Http2Error("HTTP_1_1_REQUIRED", 13, 13, Status.f33008OooO0o);
    ...
    public GrpcUtil$Http2Error(String str, int i, int i2, Status status) {
        ...
        if (str2 == null) {
            ...
            Throwable th = status.f33015OooO0OO;
            Status.Code code = status.f33013OooO00o;
            String str3 = status.f33014OooO0O0;
            status = str3 == null ? new Status(code, str2, th) : new Status(code, o0OoOo0.OooO00o(str3, "\n", str2), th);
        }
        this.status = status;
    }
