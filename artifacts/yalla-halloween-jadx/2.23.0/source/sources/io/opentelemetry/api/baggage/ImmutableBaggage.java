...
final class ImmutableBaggage extends ImmutableKeyValuePairs<String, BaggageEntry> implements Baggage {
    ...
    public static final Baggage f33022OooO0o0 = new ImmutableBaggage(new Builder().f33023OooO00o.toArray());

    public static class Builder implements BaggageBuilder {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final ArrayList f33023OooO00o = new ArrayList();
    }
    ...
    public final Context OooO0o0(Context context) {
        return context.OooO0Oo(BaggageContextKey.f33021OooO00o, this);
    }
}
