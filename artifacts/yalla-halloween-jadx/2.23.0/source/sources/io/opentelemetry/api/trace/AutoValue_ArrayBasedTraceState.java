...
final class AutoValue_ArrayBasedTraceState extends ArrayBasedTraceState {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof ArrayBasedTraceState) {
            return this.f33059OooO00o.equals(((ArrayBasedTraceState) obj).OooO0O0());
        }
        return false;
    }

    public final int hashCode() {
        return this.f33059OooO00o.hashCode() ^ 1000003;
    }

    public final String toString() {
        return "ArrayBasedTraceState{entries=" + this.f33059OooO00o + "}";
    }
}
