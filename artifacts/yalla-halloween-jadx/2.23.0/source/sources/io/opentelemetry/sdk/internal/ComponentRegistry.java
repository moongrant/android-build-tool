...
public final class ComponentRegistry<V> {
    ...
    public final ConcurrentHashMap f33202OooO00o = new ConcurrentHashMap();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final Function<InstrumentationLibraryInfo, V> f33203OooO0O0;

    public ComponentRegistry(Function<InstrumentationLibraryInfo, V> function) {
        this.f33203OooO0O0 = function;
    }
    ...
    public final V OooO00o(String str, @Nullable String str2, @Nullable String str3) {
        ...
        ConcurrentHashMap concurrentHashMap = this.f33202OooO00o;
        V v = (V) concurrentHashMap.get(instrumentationLibraryInfoOooO00o);
        if (v != null) {
            return v;
        }
        V vApply = this.f33203OooO0O0.apply(instrumentationLibraryInfoOooO00o);
