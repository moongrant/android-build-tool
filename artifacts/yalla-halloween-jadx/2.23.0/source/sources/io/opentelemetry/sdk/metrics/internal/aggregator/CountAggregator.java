...
final class CountAggregator extends AbstractAggregator<Long> {
    ...
    public final AggregationTemporality f33331OooO0o0;

    public static final class CompatHandle extends AggregatorHandle<Long> {

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final AtomicLong f33332OooO0OO;
        ...
        public final Long OooO00o() {
            return Long.valueOf(this.f33332OooO0OO.getAndSet(0L));
        }

        @Override // io.opentelemetry.sdk.metrics.internal.aggregator.AggregatorHandle
        public final void OooO0OO(long j) {
            this.f33332OooO0OO.getAndAdd(1L);
        }

        private CompatHandle() {
            this.f33332OooO0OO = new AtomicLong();
        }
    }
    ...
    public static final class Handle extends AggregatorHandle<Long> {
        ...
        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final LongAdder f33333OooO0OO;
        ...
        @Override // io.opentelemetry.sdk.metrics.internal.aggregator.AggregatorHandle
        public final Long OooO00o() {
            return Long.valueOf(this.f33333OooO0OO.sumThenReset());
        }

        @Override // io.opentelemetry.sdk.metrics.internal.aggregator.AggregatorHandle
        public final void OooO0OO(long j) {
            this.f33333OooO0OO.add(1L);
        }

        private Handle() {
            this.f33333OooO0OO = OooO0O0.OooO00o();
        }
    }
    ...
    public final MetricData OooO0Oo(Map<Attributes, Long> map, long j, long j2, long j3) {
        ...
        AggregationTemporality aggregationTemporality2 = this.f33331OooO0o0;
