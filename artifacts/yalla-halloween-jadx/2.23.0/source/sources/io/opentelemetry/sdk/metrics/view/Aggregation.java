...
public abstract class Aggregation {
    ...
    public static final ThrottlingLogger f33409OooO00o = new ThrottlingLogger(Logger.getLogger(Aggregation.class.getName()));

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final List<Double> f33410OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final Aggregation f33411OooO0OO;
    ...
    class AnonymousClass1 extends Aggregation {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function f33412OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ String f33413OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass1(Function function, String str) {
            super(0);
            this.f33412OooO0Oo = function;
            this.f33413OooO0o0 = str;
        }
        ...
        public final AggregatorFactory OooO00o(InstrumentDescriptor instrumentDescriptor) {
            return (AggregatorFactory) this.f33412OooO0Oo.apply(instrumentDescriptor);
        }

        public final String toString() {
            return this.f33413OooO0o0;
        }
    }
    ...
    public static /* synthetic */ class AnonymousClass2 {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public static final /* synthetic */ int[] f33414OooO00o;
        ...
        static {
            ...
            try {
                f33414OooO00o[InstrumentType.UP_DOWN_COUNTER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f33414OooO00o[InstrumentType.OBSERVABLE_SUM.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f33414OooO00o[InstrumentType.OBSERVABLE_UP_DOWN_SUM.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f33414OooO00o[InstrumentType.HISTOGRAM.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f33414OooO00o[InstrumentType.OBSERVABLE_GAUGE.ordinal()] = 6;
    ...
    static {
        ...
        f33410OooO0O0 = listUnmodifiableList;
        new AnonymousClass1(new OooO0O0(), "none");
        f33411OooO0OO = new AnonymousClass1(new OooO0OO(), NewFriendsOld.State_Default);
        ...
        new AnonymousClass1(new Function() { // from class: io.opentelemetry.sdk.metrics.view.OooO
            ...
            public final Object apply(Object obj) {
                ThrottlingLogger throttlingLogger = Aggregation.f33409OooO00o;
