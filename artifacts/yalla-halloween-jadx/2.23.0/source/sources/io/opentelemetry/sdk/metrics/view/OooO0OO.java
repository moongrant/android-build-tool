...
public final /* synthetic */ class OooO0OO implements Function {
    ...
    public final Object apply(Object obj) {
        ...
        switch (Aggregation.AnonymousClass2.f33414OooO00o[instrumentDescriptor.OooO0Oo().ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
            ...
            case 5:
                return new HistogramAggregatorFactory(AggregationTemporality.CUMULATIVE, Aggregation.f33410OooO0O0);
            case 6:
                return io.opentelemetry.sdk.metrics.internal.aggregator.OooO00o.OooO00o();
            default:
                Aggregation.f33409OooO00o.OooO00o(Level.WARNING, "Unable to find default aggregation for instrument: " + instrumentDescriptor);
                return null;
        }
    }
}
