...
public final class SemanticAttributes {
    ...
    public static final InternalAttributeKeyImpl f33519OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final InternalAttributeKeyImpl f33520OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final InternalAttributeKeyImpl f33521OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public static final InternalAttributeKeyImpl f33522OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public static final InternalAttributeKeyImpl f33523OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public static final InternalAttributeKeyImpl f33524OooO0o0;
    ...
    static {
        ...
        OooO0o.OooO0OO("net.peer.port");
        f33519OooO00o = OooO0o.OooO0o0("net.peer.name");
        OooO0o.OooO0o0("net.host.ip");
        OooO0o.OooO0OO("net.host.port");
        ...
        OooO0o.OooO0OO("thread.id");
        OooO0o.OooO0o0("thread.name");
        OooO0o.OooO0o0("code.function");
        OooO0o.OooO0o0("code.namespace");
        OooO0o.OooO0o0("code.filepath");
        OooO0o.OooO0OO("code.lineno");
        f33520OooO0O0 = OooO0o.OooO0o0("http.method");
        f33521OooO0OO = OooO0o.OooO0o0("http.url");
        f33522OooO0Oo = OooO0o.OooO0o0("http.target");
        OooO0o.OooO0o0("http.host");
        f33524OooO0o0 = OooO0o.OooO0o0("http.scheme");
        f33523OooO0o = OooO0o.OooO0OO("http.status_code");
        OooO0o.OooO0o0("http.flavor");
        OooO0o.OooO0o0("http.user_agent");
        OooO0o.OooO0OO("http.request_content_length");
        OooO0o.OooO0OO("http.request_content_length_uncompressed");
        OooO0o.OooO0OO("http.response_content_length");
        OooO0o.OooO0OO("http.response_content_length_uncompressed");
        ...
        OooO0o.OooO0OO("aws.dynamodb.limit");
        ...
        OooO0o.OooO0OO("aws.dynamodb.table_count");
        OooO0o.OooO00o("aws.dynamodb.scan_forward");
        OooO0o.OooO0OO("aws.dynamodb.segment");
        OooO0o.OooO0OO("aws.dynamodb.total_segments");
        OooO0o.OooO0OO("aws.dynamodb.count");
        OooO0o.OooO0OO("aws.dynamodb.scanned_count");
        ...
        OooO0o.OooO0OO("messaging.message_payload_size_bytes");
        OooO0o.OooO0OO("messaging.message_payload_compressed_size_bytes");
