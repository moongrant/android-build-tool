    ...
    public static final class Companion {
        ...
        public final void checkBoundsIndexes$kotlin_stdlib(int startIndex, int endIndex, int size) {
            ...
            if (startIndex > endIndex) {
                throw new IllegalArgumentException(OooOO0.OooO00o("startIndex: ", startIndex, " > endIndex: ", endIndex));
            }
        }

        public final void checkElementIndex$kotlin_stdlib(int index, int size) {
            if (index < 0 || index >= size) {
                throw new IndexOutOfBoundsException(OooOO0.OooO00o("index: ", index, ", size: ", size));
            }
        }
        ...
        public final void checkRangeIndexes$kotlin_stdlib(int fromIndex, int toIndex, int size) {
            ...
            if (fromIndex > toIndex) {
                throw new IllegalArgumentException(OooOO0.OooO00o("fromIndex: ", fromIndex, " > toIndex: ", toIndex));
            }
        }
