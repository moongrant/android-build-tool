...
final class RingBuffer<T> extends AbstractList<T> implements RandomAccess {
    ...
    public RingBuffer(@NotNull Object[] buffer, int i) {
        ...
        if (i <= buffer.length) {
            ...
            StringBuilder sbOooO00o = o0000O0.OooO00o("ring buffer filled size: ", i, " cannot be larger than the buffer size: ");
    ...
    public final void removeFirst(int n) {
        ...
        if (!(n <= size())) {
            StringBuilder sbOooO00o = o0000O0.OooO00o("n shouldn't be greater than the buffer size: n = ", n, ", size = ");
