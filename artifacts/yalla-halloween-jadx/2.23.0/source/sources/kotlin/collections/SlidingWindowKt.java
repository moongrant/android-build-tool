...
public final class SlidingWindowKt {
    ...
    public static final class AnonymousClass1<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super List<? extends T>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Code duplicated, block: B:82:0x0106 A[SYNTHETIC] */
    ...
    public static final void checkWindowSizeStep(int i, int i2) {
        if (i > 0 && i2 > 0) {
            ...
            throw new IllegalArgumentException((i != i2 ? o0O00o0.OooO00o("Both size ", i, " and step ", i2, " must be greater than zero.") : OooO0OO.OooO00o.OooO00o("size ", i, " must be greater than zero.")).toString());
        }
    }
