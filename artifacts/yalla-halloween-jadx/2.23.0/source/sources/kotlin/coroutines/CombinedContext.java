...
public final class CombinedContext implements CoroutineContext, Serializable {
    ...
    public String toString() {
        return oo000o.OooO00o(new StringBuilder("["), (String) fold("", new Function2<String, CoroutineContext.Element, String>() { // from class: kotlin.coroutines.CombinedContext.toString.1
            @Override // kotlin.jvm.functions.Function2
            @NotNull
