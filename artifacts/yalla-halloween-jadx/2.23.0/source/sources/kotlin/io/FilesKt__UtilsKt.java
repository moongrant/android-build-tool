...
public class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    public static final String getInvariantSeparatorsPath(@NotNull File file) {
        ...
        return c != '/' ? StringsKt__StringsJVMKt.replace$default(path, File.separatorChar, '/', false, 4, (Object) null) : path;
    }
    ...
    public static final File resolve(@NotNull File file, @NotNull File relative) {
        ...
        if ((string.length() == 0) || StringsKt__StringsKt.endsWith$default(string, File.separatorChar, false, 2, (Object) null)) {
            return new File(string + relative);
        }
        StringBuilder sbOooO00o = o00OO.OooO00o(string);
        sbOooO00o.append(File.separatorChar);
        sbOooO00o.append(relative);
        return new File(sbOooO00o.toString());
    }
