...
public class Base64 {
    ...
    private final void checkDestinationBounds(int destinationSize, int destinationOffset, int capacityNeeded) {
        if (destinationOffset < 0 || destinationOffset > destinationSize) {
            throw new IndexOutOfBoundsException(OooOO0.OooO00o("destination offset: ", destinationOffset, ", destination size: ", destinationSize));
        }
    ...
    private final int decodeSize(byte[] source, int startIndex, int endIndex) {
        ...
        if (i == 1) {
            throw new IllegalArgumentException(OooOO0.OooO00o("Input should have at list 2 symbols for Base64 decoding, startIndex: ", startIndex, ", endIndex: ", endIndex));
        }
        if (this.isMimeScheme) {
