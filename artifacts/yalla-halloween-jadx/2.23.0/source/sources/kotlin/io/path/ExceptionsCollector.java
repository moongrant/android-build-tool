...
import androidx.compose.ui.graphics.o00000;
import androidx.compose.ui.graphics.o00000OO;
...
final class ExceptionsCollector {
    ...
    public final void collect(@NotNull Exception exception) {
        ...
        if (this.collectedExceptions.size() < this.limit) {
            if (this.path != null) {
                o00O0O.OooO0O0();
                Throwable thInitCause = o00000OO.OooO0O0(String.valueOf(this.path)).initCause(exception);
                Intrinsics.checkNotNull(thInitCause, "null cannot be cast to non-null type java.nio.file.FileSystemException");
                exception = o00000.OooO0O0(thInitCause);
            }
