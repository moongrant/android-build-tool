...
public final class FileVisitorBuilderImpl implements FileVisitorBuilder {
    ...
    private final void checkNotDefined(Object function, String name) {
        if (function != null) {
            throw new IllegalStateException(androidx.camera.core.impl.OooOOOO.OooO00o(name, " was already defined"));
        }
    }
    ...
    public final FileVisitor<Path> build() {
        checkIsNotBuilt();
        this.isBuilt = true;
        return OooO0O0.OooO00o(new FileVisitorImpl(this.onPreVisitDirectory, this.onVisitFile, this.onVisitFileFailed, this.onPostVisitDirectory));
    }
