...
final class PathRelativizer {
    ...
    public final Path tryRelativeTo(@NotNull Path path, @NotNull Path base) {
        ...
        if (Intrinsics.areEqual(r, pathNormalize) || !Intrinsics.areEqual(pathNormalize, emptyPath)) {
            ...
            r = StringsKt.OooOO0O(string, separator) ? pathRelativize.getFileSystem().getPath(StringsKt.dropLast(string, pathRelativize.getFileSystem().getSeparator().length()), new String[0]) : pathRelativize;
        }
