...
import androidx.compose.ui.graphics.o000O0o;
import androidx.compose.ui.graphics.o000Oo0;
...
public final class PathTreeWalk implements Sequence<Path> {
    ...
    public static final class C09491 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Path>, Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        Object L$1;
        Object L$2;
        Object L$3;
        ...
        public C09491(Continuation<? super C09491> continuation) {
            super(2, continuation);
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C09491 c09491 = PathTreeWalk.this.new C09491(continuation);
            c09491.L$0 = obj;
            return c09491;
        }
        ...
        public final java.lang.Object invokeSuspend(@org.jetbrains.annotations.NotNull java.lang.Object r15) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlin.io.path.PathTreeWalk.C09491.invokeSuspend(java.lang.Object):java.lang.Object");
        }

        @Override // kotlin.jvm.functions.Function2
        @Nullable
        public final Object invoke(@NotNull SequenceScope<? super Path> sequenceScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C09491) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    private final Iterator<Path> dfsIterator() {
        return SequencesKt.iterator(new C09491(null));
    }
    ...
    private final Object yieldIfNeeded(SequenceScope<? super Path> sequenceScope, PathNode pathNode, DirectoryEntriesReader directoryEntriesReader, Function1<? super List<PathNode>, Unit> function1, Continuation<? super Unit> continuation) throws FileSystemLoopException {
        ...
        if (Files.isDirectory(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))) {
            if (PathTreeWalkKt.createsCycle(pathNode)) {
                o000Oo0.OooO0OO();
                throw o000O0o.OooO0O0(path.toString());
            }
