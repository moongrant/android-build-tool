...
public class Intrinsics {
    ...
    public static void checkHasClass(String str) throws ClassNotFoundException {
        ...
        try {
            ...
            throw ((ClassNotFoundException) sanitizeStackTrace(new ClassNotFoundException(o000oOoO.OooO00o("Class ", strReplace, " is not found. Please update the Kotlin runtime to the latest version"), e)));
        }
    }
