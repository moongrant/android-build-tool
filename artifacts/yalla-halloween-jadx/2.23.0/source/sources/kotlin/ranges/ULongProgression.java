...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final ULongProgression m5457fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM4387constructorimpl = ((int) ULong.m4387constructorimpl(j ^ ULong.m4387constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM4387constructorimpl2 = (iM4387constructorimpl + ((int) ULong.m4387constructorimpl(j2 ^ ULong.m4387constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return iM4387constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m4433toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) ULong.m4433toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m5431getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
}
