...
final class ULongProgressionIterator implements Iterator<ULong>, KMappedMarker {
    ...
    public /* bridge */ /* synthetic */ ULong next() {
        return ULong.m4381boximpl(m5458nextsVKNKU());
    }

    /* JADX INFO: renamed from: next-s-VKNKU, reason: not valid java name */
    public long m5458nextsVKNKU() {
        long j = this.next;
        if (j != this.finalElement) {
            this.next = ULong.m4387constructorimpl(this.step + j);
        } else {
            if (!this.hasNext) {
    ...
    private ULongProgressionIterator(long j, long j2, long j3) {
        ...
        if (j3 <= 0 ? Long.compare(j4, j5) < 0 : Long.compare(j4, j5) > 0) {
            z = false;
        }
        this.hasNext = z;
        this.step = ULong.m4387constructorimpl(j3);
