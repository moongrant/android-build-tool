...
public final class KCallables {
    ...
    public static final class C09511<R> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        int label;
        ...
        public C09511(Continuation<? super C09511> continuation) {
            super(continuation);
        }
    ...
    public static final <R> Object callSuspendBy(@NotNull KCallable<? extends R> kCallable, @NotNull Map<KParameter, ? extends Object> map, @NotNull Continuation<? super R> continuation) throws IllegalCallableAccessException {
        ...
        if (continuation instanceof C09511) {
            ...
            int i = c09511.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c09511.label = i - Integer.MIN_VALUE;
            } else {
        ...
        Object objCallDefaultMethod$kotlin_reflection = c09511.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c09511.label;
        if (i2 == 0) {
            ...
            c09511.L$0 = kCallable;
            c09511.L$1 = map;
            c09511.L$2 = kCallableImplAsKCallableImpl;
            c09511.label = 1;
            objCallDefaultMethod$kotlin_reflection = kCallableImplAsKCallableImpl.callDefaultMethod$kotlin_reflection(map, c09511);
            if (objCallDefaultMethod$kotlin_reflection == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                DebugProbesKt.probeCoroutineSuspended(c09511);
            }
            ...
            kCallable = (KCallable) c09511.L$0;
            ResultKt.throwOnFailure(objCallDefaultMethod$kotlin_reflection);
        }
