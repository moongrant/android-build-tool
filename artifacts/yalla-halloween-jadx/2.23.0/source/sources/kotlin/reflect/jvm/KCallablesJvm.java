...
public final class KCallablesJvm {
    public static final boolean isAccessible(@NotNull KCallable<?> kCallable) {
        ...
        if (kCallable instanceof KMutableProperty) {
            ...
            Member memberMo5494getMember = (kCallableImplAsKCallableImpl == null || (defaultCaller = kCallableImplAsKCallableImpl.getDefaultCaller()) == null) ? null : defaultCaller.mo5494getMember();
            AccessibleObject accessibleObject = memberMo5494getMember instanceof AccessibleObject ? (AccessibleObject) memberMo5494getMember : null;
