            ...
            public final Caller<? extends Executable> invoke() {
                ...
                if (constructor instanceof Constructor) {
                    ...
                    if (Modifier.isStatic(method.getModifiers())) {
                        callerCreateJvmStaticInObjectCaller = this.this$0.getDescriptor().getAnnotations().mo5497findAnnotation(UtilKt.getJVM_STATIC()) != null ? this.this$0.createJvmStaticInObjectCaller(method) : this.this$0.createStaticMethodCaller(method);
                    } else {
        ...
        this.defaultCaller = LazyKt.lazy(lazyThreadSafetyMode, (Function0) new Function0<Caller<? extends Executable>>() { // from class: kotlin.reflect.jvm.internal.KFunctionImpl$defaultCaller$2
            ...
            public final Caller<? extends Executable> invoke() {
                ...
                if (jvmFunctionSignatureMapSignature instanceof JvmFunctionSignature.KotlinFunction) {
                    ...
                    Member memberMo5494getMember = this.this$0.getCaller().mo5494getMember();
                    Intrinsics.checkNotNull(memberMo5494getMember);
                    genericDeclarationFindDefaultConstructor = container.findDefaultMethod(methodName, methodDesc, !Modifier.isStatic(memberMo5494getMember.getModifiers()));
                ...
                } else if (this.this$0.getDescriptor().getAnnotations().mo5497findAnnotation(UtilKt.getJVM_STATIC()) != null) {
