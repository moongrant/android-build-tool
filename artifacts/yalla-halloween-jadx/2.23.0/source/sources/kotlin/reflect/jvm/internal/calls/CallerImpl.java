...
public abstract class CallerImpl<M extends Member> implements Caller<M> {
    ...
    public static final class AccessorForHiddenBoundConstructor extends CallerImpl<java.lang.reflect.Constructor<?>> implements BoundCaller {
        ...
        public AccessorForHiddenBoundConstructor(@NotNull java.lang.reflect.Constructor<?> constructor, @Nullable Object obj) {
            ...
            super(constructor, declaringClass, cls, (Type[]) (genericParameterTypes.length <= 2 ? new Type[0] : ArraysKt.copyOfRange(genericParameterTypes, 1, genericParameterTypes.length - 1)), null);
        ...
        public Object call(@NotNull Object[] args) {
            ...
            checkArguments(args);
            java.lang.reflect.Constructor<?> constructorMo5494getMember = mo5494getMember();
            SpreadBuilder spreadBuilder = new SpreadBuilder(3);
            spreadBuilder.add(this.boundReceiver);
            spreadBuilder.addSpread(args);
            spreadBuilder.add(null);
            return constructorMo5494getMember.newInstance(spreadBuilder.toArray(new Object[spreadBuilder.size()]));
        }
    }
    ...
    public static final class AccessorForHiddenConstructor extends CallerImpl<java.lang.reflect.Constructor<?>> {
        ...
        public AccessorForHiddenConstructor(@NotNull java.lang.reflect.Constructor<?> constructor) {
            ...
            Type[] genericParameterTypes = constructor.getGenericParameterTypes();
            Intrinsics.checkNotNullExpressionValue(genericParameterTypes, "constructor.genericParameterTypes");
            super(constructor, declaringClass, cls, (Type[]) (genericParameterTypes.length <= 1 ? new Type[0] : ArraysKt.copyOfRange(genericParameterTypes, 0, genericParameterTypes.length - 1)), null);
        }
    ...
    public static final class Constructor extends CallerImpl<java.lang.reflect.Constructor<?>> {
        ...
        public Object call(@NotNull Object[] args) {
            Intrinsics.checkNotNullParameter(args, "args");
            checkArguments(args);
            return mo5494getMember().newInstance(Arrays.copyOf(args, args.length));
        }
    }
    ...
    public static abstract class FieldGetter extends CallerImpl<Field> {
        ...
        public static final class BoundInstance extends FieldGetter implements BoundCaller {
            ...
            public Object call(@NotNull Object[] args) {
                Intrinsics.checkNotNullParameter(args, "args");
                checkArguments(args);
                return mo5494getMember().get(this.boundReceiver);
            }
        }
        ...
        public Object call(@NotNull Object[] args) {
            Intrinsics.checkNotNullParameter(args, "args");
            checkArguments(args);
            return mo5494getMember().get(getInstanceClass() != null ? ArraysKt.first(args) : null);
        }
    ...
    public static abstract class FieldSetter extends CallerImpl<Field> {
        ...
        public static final class BoundInstance extends FieldSetter implements BoundCaller {
            ...
            public Object call(@NotNull Object[] args) throws IllegalAccessException {
                Intrinsics.checkNotNullParameter(args, "args");
                checkArguments(args);
                mo5494getMember().set(this.boundReceiver, ArraysKt.first(args));
        ...
        public static final class BoundJvmStaticInObject extends FieldSetter implements BoundCaller {
            ...
            public Object call(@NotNull Object[] args) throws IllegalAccessException {
                Intrinsics.checkNotNullParameter(args, "args");
                checkArguments(args);
                mo5494getMember().set(null, ArraysKt.last(args));
                return Unit.INSTANCE;
            }
        }
        ...
        public Object call(@NotNull Object[] args) throws IllegalAccessException {
            Intrinsics.checkNotNullParameter(args, "args");
            checkArguments(args);
            mo5494getMember().set(getInstanceClass() != null ? ArraysKt.first(args) : null, ArraysKt.last(args));
            return Unit.INSTANCE;
        }
    ...
    public static abstract class Method extends CallerImpl<java.lang.reflect.Method> {
        ...
        public final Object callMethod(@Nullable Object instance, @NotNull Object[] args) {
            Intrinsics.checkNotNullParameter(args, "args");
            return this.isVoidMethod ? Unit.INSTANCE : mo5494getMember().invoke(instance, Arrays.copyOf(args, args.length));
        }
    ...
    public final M mo5494getMember() {
        return this.member;
    }
