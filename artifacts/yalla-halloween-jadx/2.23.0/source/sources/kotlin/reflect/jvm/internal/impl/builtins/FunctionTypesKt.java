...
public final class FunctionTypesKt {
    public static final int contextFunctionTypeParamsCount(@NotNull KotlinType kotlinType) {
        ...
        AnnotationDescriptor annotationDescriptorMo5497findAnnotation = kotlinType.getAnnotations().mo5497findAnnotation(StandardNames.FqNames.contextFunctionTypeParams);
        if (annotationDescriptorMo5497findAnnotation == null) {
            return 0;
        }
        ConstantValue constantValue = (ConstantValue) MapsKt.getValue(annotationDescriptorMo5497findAnnotation.getAllValueArguments(), StandardNames.CONTEXT_FUNCTION_TYPE_PARAMETER_COUNT_NAME);
    ...
    public static final Name extractParameterNameFromFunctionTypeArgument(@NotNull KotlinType kotlinType) {
        String value;
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        AnnotationDescriptor annotationDescriptorMo5497findAnnotation = kotlinType.getAnnotations().mo5497findAnnotation(StandardNames.FqNames.parameterName);
        if (annotationDescriptorMo5497findAnnotation == null) {
            return null;
        }
        Object objSingleOrNull = CollectionsKt.singleOrNull(annotationDescriptorMo5497findAnnotation.getAllValueArguments().values());
    ...
    public static final boolean isBuiltinFunctionalType(@NotNull KotlinType kotlinType) {
        ...
        return classifierDescriptorMo5502getDeclarationDescriptor != null && isBuiltinFunctionalClassDescriptor(classifierDescriptorMo5502getDeclarationDescriptor);
    }

    public static final boolean isFunctionType(@NotNull KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor = kotlinType.getConstructor().mo5502getDeclarationDescriptor();
        return (classifierDescriptorMo5502getDeclarationDescriptor != null ? getFunctionalClassKind(classifierDescriptorMo5502getDeclarationDescriptor) : null) == FunctionClassKind.Function;
    }

    public static final boolean isSuspendFunctionType(@NotNull KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor = kotlinType.getConstructor().mo5502getDeclarationDescriptor();
        return (classifierDescriptorMo5502getDeclarationDescriptor != null ? getFunctionalClassKind(classifierDescriptorMo5502getDeclarationDescriptor) : null) == FunctionClassKind.SuspendFunction;
    }

    private static final boolean isTypeAnnotatedWithExtensionFunctionType(KotlinType kotlinType) {
        return kotlinType.getAnnotations().mo5497findAnnotation(StandardNames.FqNames.extensionFunctionType) != null;
    }
