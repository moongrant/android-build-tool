...
public final class ReflectionTypes {
    ...
    public final ClassDescriptor find(String str, int i) {
        ...
        ClassifierDescriptor classifierDescriptorMo5504getContributedClassifier = getKotlinReflectScope().mo5504getContributedClassifier(nameIdentifier, NoLookupLocation.FROM_REFLECTION);
