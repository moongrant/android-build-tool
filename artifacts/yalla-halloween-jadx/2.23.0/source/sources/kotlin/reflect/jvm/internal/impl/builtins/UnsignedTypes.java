...
public final class UnsignedTypes {
    ...
    public static final boolean isUnsignedType(@NotNull KotlinType type) {
        ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor;
        Intrinsics.checkNotNullParameter(type, "type");
        if (TypeUtils.noExpectedType(type) || (classifierDescriptorMo5502getDeclarationDescriptor = type.getConstructor().mo5502getDeclarationDescriptor()) == null) {
            return false;
        }
        return INSTANCE.isUnsignedClass(classifierDescriptorMo5502getDeclarationDescriptor);
    }
