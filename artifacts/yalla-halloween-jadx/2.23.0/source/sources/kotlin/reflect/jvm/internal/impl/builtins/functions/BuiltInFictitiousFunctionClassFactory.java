...
public final class BuiltInFictitiousFunctionClassFactory implements ClassDescriptorFactory {
    ...
    public ClassDescriptor createClass(@NotNull ClassId classId) {
        ...
        if (!StringsKt.OooO0o(strAsString, "Function")) {
            return null;
        }
    ...
    public boolean shouldCreateClass(@NotNull FqName packageFqName, @NotNull Name name) {
        ...
        return (StringsKt.Oooo00o(strAsString, "Function") || StringsKt.Oooo00o(strAsString, "KFunction") || StringsKt.Oooo00o(strAsString, "SuspendFunction") || StringsKt.Oooo00o(strAsString, "KSuspendFunction")) && FunctionClassKind.Companion.parseClassName(strAsString, packageFqName) != null;
    }
}
