...
public final class DescriptorUtilKt {
    ...
    public static final ClassDescriptor resolveClassByFqName(@NotNull ModuleDescriptor moduleDescriptor, @NotNull FqName fqName, @NotNull LookupLocation lookupLocation) {
        ...
        ClassifierDescriptor classifierDescriptorMo5504getContributedClassifier2 = memberScope.mo5504getContributedClassifier(nameShortName, lookupLocation);
        ClassDescriptor classDescriptor = classifierDescriptorMo5504getContributedClassifier2 instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo5504getContributedClassifier2 : null;
        if (classDescriptor != null) {
        ...
        if (classDescriptorResolveClassByFqName == null || (unsubstitutedInnerClassesScope = classDescriptorResolveClassByFqName.getUnsubstitutedInnerClassesScope()) == null) {
            classifierDescriptorMo5504getContributedClassifier = null;
        } else {
            Name nameShortName2 = fqName.shortName();
            Intrinsics.checkNotNullExpressionValue(nameShortName2, "fqName.shortName()");
            classifierDescriptorMo5504getContributedClassifier = unsubstitutedInnerClassesScope.mo5504getContributedClassifier(nameShortName2, lookupLocation);
        }
