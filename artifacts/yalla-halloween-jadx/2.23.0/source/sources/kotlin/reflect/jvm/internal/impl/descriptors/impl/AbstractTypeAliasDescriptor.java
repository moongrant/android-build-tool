    ...
    public AbstractTypeAliasDescriptor(@NotNull DeclarationDescriptor containingDeclaration, @NotNull Annotations annotations, @NotNull Name name, @NotNull SourceElement sourceElement, @NotNull DescriptorVisibility visibilityImpl) {
        ...
        this.typeConstructor = new TypeConstructor() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor$typeConstructor$1
            ...
            public KotlinBuiltIns getBuiltIns() {
                return DescriptorUtilsKt.getBuiltIns(mo5502getDeclarationDescriptor());
            }
            ...
            public Collection<KotlinType> mo5503getSupertypes() {
                Collection<KotlinType> collectionMo5503getSupertypes = mo5502getDeclarationDescriptor().getUnderlyingType().getConstructor().mo5503getSupertypes();
                Intrinsics.checkNotNullExpressionValue(collectionMo5503getSupertypes, "declarationDescriptor.un…pe.constructor.supertypes");
            ...
            public String toString() {
                return "[typealias " + mo5502getDeclarationDescriptor().getName().asString() + ']';
            }

            @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
            @NotNull
            /* JADX INFO: renamed from: getDeclarationDescriptor */
            public TypeAliasDescriptor mo5502getDeclarationDescriptor() {
                return this.this$0;
            }
        };
    }
        ...
        return TypeUtils.contains(getUnderlyingType(), new Function1<UnwrappedType, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor.isInner.1
            ...
            public final Boolean invoke(UnwrappedType type) {
                ...
                if (!KotlinTypeKt.isError(type)) {
                    ...
                    ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor = type.getConstructor().mo5502getDeclarationDescriptor();
                    if ((classifierDescriptorMo5502getDeclarationDescriptor instanceof TypeParameterDescriptor) && !Intrinsics.areEqual(((TypeParameterDescriptor) classifierDescriptorMo5502getDeclarationDescriptor).getContainingDeclaration(), abstractTypeAliasDescriptor)) {
                        z = true;
                    }
                }
