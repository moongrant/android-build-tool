...
public final class JvmPackageScope implements MemberScope {
    ...
    public ClassifierDescriptor mo5504getContributedClassifier(@NotNull Name name, @NotNull LookupLocation location) {
        ...
        ClassDescriptor classDescriptorMo5504getContributedClassifier = this.javaScope.mo5504getContributedClassifier(name, location);
        if (classDescriptorMo5504getContributedClassifier != null) {
            return classDescriptorMo5504getContributedClassifier;
        }
        ClassifierDescriptor classifierDescriptor = null;
        for (MemberScope memberScope : getKotlinScopes()) {
            ClassifierDescriptor classifierDescriptorMo5504getContributedClassifier = memberScope.mo5504getContributedClassifier(name, location);
            if (classifierDescriptorMo5504getContributedClassifier != null) {
                if (!(classifierDescriptorMo5504getContributedClassifier instanceof ClassifierDescriptorWithTypeParameters) || !((ClassifierDescriptorWithTypeParameters) classifierDescriptorMo5504getContributedClassifier).isExpect()) {
