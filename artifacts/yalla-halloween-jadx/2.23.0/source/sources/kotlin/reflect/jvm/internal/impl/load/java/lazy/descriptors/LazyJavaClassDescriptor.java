...
public final class LazyJavaClassDescriptor extends ClassDescriptorBase implements JavaClassDescriptor {
    ...
    public final class LazyJavaClassTypeConstructor extends AbstractClassTypeConstructor {
        ...
        private final FqName getPurelyImplementsFqNameFromAnnotation() {
            ...
            AnnotationDescriptor annotationDescriptorMo5497findAnnotation = annotations.mo5497findAnnotation(PURELY_IMPLEMENTS_ANNOTATION);
        ...
        public Collection<KotlinType> computeSupertypes() {
            ...
            while (true) {
                ...
                if (kotlinTypeEnhanceSuperType.getConstructor().mo5502getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor) {
                    arrayList2.add(next);
                }
            ...
            if (!arrayList2.isEmpty()) {
                ...
                ClassDescriptor classDescriptorMo5502getDeclarationDescriptor = mo5502getDeclarationDescriptor();
                ...
                errorReporter.reportIncompleteHierarchy(classDescriptorMo5502getDeclarationDescriptor, arrayList3);
            }
        ...
        public ClassDescriptor mo5502getDeclarationDescriptor() {
    ...
    public Collection<ClassDescriptor> getSealedSubclasses() {
        ...
        while (it.hasNext()) {
            ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor = this.c.getTypeResolver().transformJavaType((JavaClassifierType) it.next(), attributes$default).getConstructor().mo5502getDeclarationDescriptor();
