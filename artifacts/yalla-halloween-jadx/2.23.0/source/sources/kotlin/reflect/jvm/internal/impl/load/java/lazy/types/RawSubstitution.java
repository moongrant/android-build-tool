...
public final class RawSubstitution extends TypeSubstitution {
    ...
    private final KotlinType eraseType(KotlinType kotlinType, JavaTypeAttributes javaTypeAttributes) {
        ...
        if (classifierDescriptorMo5502getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            return eraseType(this.typeParameterUpperBoundEraser.getErasedUpperBound((TypeParameterDescriptor) classifierDescriptorMo5502getDeclarationDescriptor, javaTypeAttributes.markIsRaw(true)), javaTypeAttributes);
        }
        if (!(classifierDescriptorMo5502getDeclarationDescriptor instanceof ClassDescriptor)) {
            throw new IllegalStateException(("Unexpected declaration kind: " + classifierDescriptorMo5502getDeclarationDescriptor).toString());
        }
        ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor2 = FlexibleTypesKt.upperIfFlexible(kotlinType).getConstructor().mo5502getDeclarationDescriptor();
        if (classifierDescriptorMo5502getDeclarationDescriptor2 instanceof ClassDescriptor) {
            Pair<SimpleType, Boolean> pairEraseInflexibleBasedOnClassDescriptor = eraseInflexibleBasedOnClassDescriptor(FlexibleTypesKt.lowerIfFlexible(kotlinType), (ClassDescriptor) classifierDescriptorMo5502getDeclarationDescriptor, lowerTypeAttr);
            ...
            Pair<SimpleType, Boolean> pairEraseInflexibleBasedOnClassDescriptor2 = eraseInflexibleBasedOnClassDescriptor(FlexibleTypesKt.upperIfFlexible(kotlinType), (ClassDescriptor) classifierDescriptorMo5502getDeclarationDescriptor2, upperTypeAttr);
        ...
        throw new IllegalStateException(("For some reason declaration for upper bound is not a class but \"" + classifierDescriptorMo5502getDeclarationDescriptor2 + "\" while for lower it's \"" + classifierDescriptorMo5502getDeclarationDescriptor + Typography.quote).toString());
    }
    ...
    public TypeProjectionImpl mo5507get(@NotNull KotlinType key) {
