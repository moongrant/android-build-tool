...
public final class RawTypeImpl extends FlexibleType implements RawType {
    ...
    public MemberScope getMemberScope() {
        ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor = getConstructor().mo5502getDeclarationDescriptor();
        ...
        throw new IllegalStateException(("Incorrect classifier: " + getConstructor().mo5502getDeclarationDescriptor()).toString());
    }
    ...
    public String render(@NotNull DescriptorRenderer renderer, @NotNull DescriptorRendererOptions options) {
        ...
        List listZip = CollectionsKt.zip(listRender$renderArguments, listRender$renderArguments2);
