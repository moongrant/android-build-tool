...
public final class JavaTypeEnhancement {
    ...
    private final SimpleResult enhanceInflexible(SimpleType simpleType, Function1<? super Integer, JavaTypeQualifiers> function1, int i, TypeComponentPosition typeComponentPosition, boolean z, boolean z2) {
        ...
        ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor = simpleType.getConstructor().mo5502getDeclarationDescriptor();
        ...
        ClassifierDescriptor classifierDescriptorEnhanceMutability = TypeEnhancementKt.enhanceMutability(classifierDescriptorMo5502getDeclarationDescriptor, javaTypeQualifiersInvoke, typeComponentPosition);
