    ...
    public static final class Class extends GeneratedMessageLite.ExtendableMessage<Class> implements ClassOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.ExtendableBuilder<Class, Builder> implements ClassOrBuilder {
            ...
            private void ensureMultiFieldValueClassUnderlyingTypeIdIsMutable() {
                if ((this.bitField0_ & ZegoConstants.ErrorMask.RoomServerErrorMask) != 1048576) {
                    this.multiFieldValueClassUnderlyingTypeId_ = new ArrayList(this.multiFieldValueClassUnderlyingTypeId_);
                    this.bitField0_ |= ZegoConstants.ErrorMask.RoomServerErrorMask;
                }
            }
            ...
            public Class buildPartial() {
                ...
                if ((i & ShareRequest.THUMB_DATA_SIZE_LIMIT) == 32768) {
                    i2 |= 8;
                }
            ...
            public Builder setInlineClassUnderlyingPropertyName(int i) {
                this.bitField0_ |= ShareRequest.THUMB_DATA_SIZE_LIMIT;
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (getSealedSubclassFqNameList().size() > 0) {
                codedOutputStream.writeRawVarint32(Constants.ERR_ENCRYPTED_STREAM_NOT_ALLOWED_PUBLISHED);
                    ...
                    try {
                        ...
                        switch (tag) {
                            ...
                            case 170:
                                ...
                                if ((i & PSKKeyManager.MAX_KEY_LENGTH_BYTES) != 256 && codedInputStream.getBytesUntilLimit() > 0) {
                                    this.contextReceiverTypeId_ = new ArrayList();
                                    i |= PSKKeyManager.MAX_KEY_LENGTH_BYTES;
                                }
                                while (codedInputStream.getBytesUntilLimit() > 0) {
                            ...
                            case 186:
                                ...
                                break;
                            case 192:
                                if ((i & ZegoConstants.ErrorMask.RoomServerErrorMask) != 1048576) {
                                    this.multiFieldValueClassUnderlyingTypeId_ = new ArrayList();
                                    i |= ZegoConstants.ErrorMask.RoomServerErrorMask;
                                }
                            ...
                            case 194:
                                ...
                                if ((i & ZegoConstants.ErrorMask.RoomServerErrorMask) != 1048576 && codedInputStream.getBytesUntilLimit() > 0) {
                                    this.multiFieldValueClassUnderlyingTypeId_ = new ArrayList();
                                    i |= ZegoConstants.ErrorMask.RoomServerErrorMask;
                                }
                                while (codedInputStream.getBytesUntilLimit() > 0) {
                            ...
                            case SQLiteDatabase.MAX_SQL_CACHE_SIZE /* 250 */:
                                ...
                                if ((i & Configuration.BLOCK_SIZE) != 4194304 && codedInputStream.getBytesUntilLimit() > 0) {
                                    this.versionRequirement_ = new ArrayList();
                                    i |= Configuration.BLOCK_SIZE;
                                }
                                while (codedInputStream.getBytesUntilLimit() > 0) {
        ...
        private Function(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
            ...
            while (!z) {
                try {
                        ...
                        try {
                            ...
                            switch (tag) {
                                ...
                                case 42:
                                    ...
                                    continue;
                                case 50:
                                    int i3 = (i == true ? 1 : 0) & LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY;
                                    i = i;
                                    if (i3 != 1024) {
                                        this.valueParameter_ = new ArrayList();
                                        i = (i == true ? 1 : 0) | LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY;
                                    }
                                    this.valueParameter_.add((ValueParameter) codedInputStream.readMessage(ValueParameter.PARSER, extensionRegistryLite));
                                    continue;
                                case 56:
                                ...
                                case 72:
                                    ...
                                    continue;
                                case 82:
                                    int i4 = (i == true ? 1 : 0) & PSKKeyManager.MAX_KEY_LENGTH_BYTES;
                                    i = i;
                                    if (i4 != 256) {
                                        this.contextReceiverType_ = new ArrayList();
                                        i = (i == true ? 1 : 0) | PSKKeyManager.MAX_KEY_LENGTH_BYTES;
                                    }
                                    this.contextReceiverType_.add((Type) codedInputStream.readMessage(Type.PARSER, extensionRegistryLite));
                                    continue;
                                case 88:
                                    int i5 = (i == true ? 1 : 0) & ConstantsKt.MINIMUM_BLOCK_SIZE;
                                    i = i;
                                    if (i5 != 512) {
                                        this.contextReceiverTypeId_ = new ArrayList();
                                        i = (i == true ? 1 : 0) | ConstantsKt.MINIMUM_BLOCK_SIZE;
                                    }
                                    this.contextReceiverTypeId_.add(Integer.valueOf(codedInputStream.readInt32()));
                                    continue;
                                case 90:
                                    int iPushLimit = codedInputStream.pushLimit(codedInputStream.readRawVarint32());
                                    int i6 = (i == true ? 1 : 0) & ConstantsKt.MINIMUM_BLOCK_SIZE;
                                    i = i;
                                ...
                                case SQLiteDatabase.MAX_SQL_CACHE_SIZE /* 250 */:
                                    ...
                                    continue;
                                case 258:
                                    Contract.Builder builder4 = (this.bitField0_ & PSKKeyManager.MAX_KEY_LENGTH_BYTES) == 256 ? this.contract_.toBuilder() : null;
                    ...
                    if (((i == true ? 1 : 0) & LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) == 1024) {
                        this.valueParameter_ = Collections.unmodifiableList(this.valueParameter_);
                    }
                    if (((i == true ? 1 : 0) & PSKKeyManager.MAX_KEY_LENGTH_BYTES) == 256) {
                        this.contextReceiverType_ = Collections.unmodifiableList(this.contextReceiverType_);
                    }
                    if (((i == true ? 1 : 0) & ConstantsKt.MINIMUM_BLOCK_SIZE) == 512) {
                        this.contextReceiverTypeId_ = Collections.unmodifiableList(this.contextReceiverTypeId_);
                    }
                        ...
                        try {
                            ...
                            switch (tag) {
                                ...
                                case 88:
                                    ...
                                    continue;
                                case 98:
                                    int i3 = (i == true ? 1 : 0) & PSKKeyManager.MAX_KEY_LENGTH_BYTES;
                                    i = i;
                                    if (i3 != 256) {
                                        this.contextReceiverType_ = new ArrayList();
                                        i = (i == true ? 1 : 0) | PSKKeyManager.MAX_KEY_LENGTH_BYTES;
                                    ...
                                    continue;
                                case 104:
                                    int i4 = (i == true ? 1 : 0) & ConstantsKt.MINIMUM_BLOCK_SIZE;
                                    i = i;
                                    if (i4 != 512) {
                                        this.contextReceiverTypeId_ = new ArrayList();
                                        i = (i == true ? 1 : 0) | ConstantsKt.MINIMUM_BLOCK_SIZE;
                    ...
                    try {
                        ...
                        switch (tag) {
                            ...
                            case 72:
                                ...
                                continue;
                            case 82:
                                builder = (this.bitField0_ & PSKKeyManager.MAX_KEY_LENGTH_BYTES) == 256 ? this.outerType_.toBuilder() : null;
