...
public final class ClassMapperLite {
    ...
    @NotNull
    private static final String f33603kotlin = CollectionsKt___CollectionsKt.joinToString$default(CollectionsKt.listOf((Object[]) new Character[]{'k', 'o', 't', 'l', 'i', 'n'}), "", null, null, 0, null, null, 62, null);
    ...
    static {
        ...
        if (progressionLastElement >= 0) {
            ...
            while (true) {
                ...
                sb2.append(str);
                sb2.append('/');
                linkedHashMap.put(o0O00o0.OooO0O0(sb2, (String) listListOf.get(i), "Array"), "[" + ((String) listListOf.get(i2)));
        ...
        linkedHashMap.put(f33603kotlin + "/Unit", "V");
        ...
        for (String str2 : CollectionsKt.listOf((Object[]) new String[]{"String", "CharSequence", "Throwable", "Cloneable", "Number", "Comparable", "Enum"})) {
            map$lambda$0$add(linkedHashMap, str2, o00O00OO.OooO00o("java/lang/", str2));
        }
        for (String str3 : CollectionsKt.listOf((Object[]) new String[]{"Iterator", "Collection", "List", "Set", "Map", "ListIterator"})) {
            map$lambda$0$add(linkedHashMap, o00O00OO.OooO00o("collections/", str3), o00O00OO.OooO00o("java/util/", str3));
            map$lambda$0$add(linkedHashMap, o00O00OO.OooO00o("collections/Mutable", str3), o00O00OO.OooO00o("java/util/", str3));
        }
        ...
        for (int i3 = 0; i3 < 23; i3++) {
            String strOooO00o = OooO00o.OooO00o("Function", i3);
            StringBuilder sb3 = new StringBuilder();
            String str4 = f33603kotlin;
            sb3.append(str4);
            sb3.append("/jvm/functions/Function");
            sb3.append(i3);
            map$lambda$0$add(linkedHashMap, strOooO00o, sb3.toString());
            map$lambda$0$add(linkedHashMap, OooO00o.OooO00o("reflect/KFunction", i3), OooOOOO.OooO00o(str4, "/reflect/KFunction"));
        }
        for (String str5 : CollectionsKt.listOf((Object[]) new String[]{"Char", "Byte", "Short", "Int", "Float", "Long", "Double", "String", "Enum"})) {
            map$lambda$0$add(linkedHashMap, OooOOOO.OooO00o(str5, ".Companion"), androidx.compose.material.OooO00o.OooO0O0(new StringBuilder(), f33603kotlin, "/jvm/internal/", str5, "CompanionObject"));
        }
        map = linkedHashMap;
    }
    ...
    private static final void map$lambda$0$add(Map<String, String> map2, String str, String str2) {
        map2.put(f33603kotlin + '/' + str, "L" + str2 + ';');
    }
