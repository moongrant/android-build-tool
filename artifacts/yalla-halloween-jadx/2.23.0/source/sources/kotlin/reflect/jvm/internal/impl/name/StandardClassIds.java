...
public final class StandardClassIds {
    ...
    static {
        ...
        LinkedHashMap linkedHashMap2 = new LinkedHashMap(RangesKt.coerceAtLeast(MapsKt.mapCapacity(CollectionsKt__IterablesKt.collectionSizeOrDefault(set2, 10)), 16));
