        ...
        for (DeclarationDescriptor declarationDescriptor : ResolutionScope.DefaultImpls.getContributedDescriptors$default(memberScope, DescriptorKindFilter.CLASSIFIERS, null, 2, null)) {
            if (declarationDescriptor instanceof ClassDescriptor) {
                ...
                if (classDescriptor2.isExpect()) {
                    ...
                    ClassifierDescriptor classifierDescriptorMo5504getContributedClassifier = memberScope.mo5504getContributedClassifier(name, NoLookupLocation.WHEN_GET_ALL_DESCRIPTORS);
                    classDescriptor2 = classifierDescriptorMo5504getContributedClassifier instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo5504getContributedClassifier : classifierDescriptorMo5504getContributedClassifier instanceof TypeAliasDescriptor ? ((TypeAliasDescriptor) classifierDescriptorMo5504getContributedClassifier).getClassDescriptor() : null;
                }
