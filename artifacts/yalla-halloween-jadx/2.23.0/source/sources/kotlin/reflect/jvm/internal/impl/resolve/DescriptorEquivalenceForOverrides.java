...
public final class DescriptorEquivalenceForOverrides {
    ...
    public static final boolean areCallableDescriptorsEquivalent$lambda$0(boolean z, final CallableDescriptor a, final CallableDescriptor b, TypeConstructor c1, TypeConstructor c2) {
        ...
        ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor = c1.mo5502getDeclarationDescriptor();
        ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor2 = c2.mo5502getDeclarationDescriptor();
        if ((classifierDescriptorMo5502getDeclarationDescriptor instanceof TypeParameterDescriptor) && (classifierDescriptorMo5502getDeclarationDescriptor2 instanceof TypeParameterDescriptor)) {
            return INSTANCE.areTypeParametersEquivalent((TypeParameterDescriptor) classifierDescriptorMo5502getDeclarationDescriptor, (TypeParameterDescriptor) classifierDescriptorMo5502getDeclarationDescriptor2, z, new Function2<DeclarationDescriptor, DeclarationDescriptor, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.resolve.DescriptorEquivalenceForOverrides$areCallableDescriptorsEquivalent$overridingUtil$1$1
