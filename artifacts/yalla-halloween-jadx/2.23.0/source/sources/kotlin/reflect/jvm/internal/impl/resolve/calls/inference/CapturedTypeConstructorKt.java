        ...
        if (!(typeSubstitution instanceof IndexedParametersSubstitution)) {
            return new DelegatedTypeSubstitution(typeSubstitution) { // from class: kotlin.reflect.jvm.internal.impl.resolve.calls.inference.CapturedTypeConstructorKt.wrapWithCapturingSubstitution.2
                ...
                public TypeProjection mo5507get(@NotNull KotlinType key) {
                    ...
                    TypeProjection typeProjectionMo5507get = super.mo5507get(key);
                    if (typeProjectionMo5507get == null) {
                        return null;
                    }
                    ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor = key.getConstructor().mo5502getDeclarationDescriptor();
                    return CapturedTypeConstructorKt.createCapturedIfNeeded(typeProjectionMo5507get, classifierDescriptorMo5502getDeclarationDescriptor instanceof TypeParameterDescriptor ? (TypeParameterDescriptor) classifierDescriptorMo5502getDeclarationDescriptor : null);
                }
            };
        }
