...
public final class DescriptorUtilsKt {
    ...
    public static final ClassDescriptor getAnnotationClass(@NotNull AnnotationDescriptor annotationDescriptor) {
        ...
        ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor = annotationDescriptor.getType().getConstructor().mo5502getDeclarationDescriptor();
        if (classifierDescriptorMo5502getDeclarationDescriptor instanceof ClassDescriptor) {
            return (ClassDescriptor) classifierDescriptorMo5502getDeclarationDescriptor;
        }
        return null;
    }
    ...
    public static final ClassDescriptor getSuperClassNotAny(@NotNull ClassDescriptor classDescriptor) {
        ...
        for (KotlinType kotlinType : classDescriptor.getDefaultType().getConstructor().mo5503getSupertypes()) {
            if (!KotlinBuiltIns.isAnyOrNullableAny(kotlinType)) {
                ...
                if (DescriptorUtils.isClassOrEnumClass(classifierDescriptorMo5502getDeclarationDescriptor)) {
    ...
    public static final ClassDescriptor resolveTopLevelClass(@NotNull ModuleDescriptor moduleDescriptor, @NotNull FqName topLevelClassFqName, @NotNull LookupLocation location) {
        ...
        ClassifierDescriptor classifierDescriptorMo5504getContributedClassifier = memberScope.mo5504getContributedClassifier(nameShortName, location);
