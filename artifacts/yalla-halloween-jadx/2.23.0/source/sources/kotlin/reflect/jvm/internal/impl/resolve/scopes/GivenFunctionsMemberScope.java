...
public abstract class GivenFunctionsMemberScope extends MemberScopeImpl {
    ...
    public final List<DeclarationDescriptor> createFakeOverrides(List<? extends FunctionDescriptor> list) {
        ...
        Collection<KotlinType> collectionMo5503getSupertypes = this.containingClass.getTypeConstructor().mo5503getSupertypes();
        Intrinsics.checkNotNullExpressionValue(collectionMo5503getSupertypes, "containingClass.typeConstructor.supertypes");
        ArrayList arrayList2 = new ArrayList();
        Iterator it = collectionMo5503getSupertypes.iterator();
        while (it.hasNext()) {
