...
public final class SubstitutingScope implements MemberScope {
    ...
    public ClassifierDescriptor mo5504getContributedClassifier(@NotNull Name name, @NotNull LookupLocation location) {
        ...
        if (classifierDescriptorMo5504getContributedClassifier != null) {
            return (ClassifierDescriptor) substitute(classifierDescriptorMo5504getContributedClassifier);
        }
        return null;
    }
    ...
    public void mo5508recordLookup(@NotNull Name name, @NotNull LookupLocation lookupLocation) {
