...
public final class MemberDeserializer {
    ...
    private final List<ValueParameterDescriptor> valueParameters(List<ProtoBuf.ValueParameter> list, final MessageLite messageLite, final AnnotatedCallableKind annotatedCallableKind) {
        ...
        for (Object obj : list) {
            ...
            if (protoContainerAsProtoContainer == null || !OooO00o.OooO00o(Flags.HAS_ANNOTATIONS, flags, "HAS_ANNOTATIONS.get(flags)")) {
            ...
            boolean zOooO00o = OooO00o.OooO00o(Flags.DECLARES_DEFAULT_VALUE, flags, "DECLARES_DEFAULT_VALUE.get(flags)");
            boolean zOooO00o2 = OooO00o.OooO00o(Flags.IS_CROSSINLINE, flags, "IS_CROSSINLINE.get(flags)");
            boolean zOooO00o3 = OooO00o.OooO00o(Flags.IS_NOINLINE, flags, "IS_NOINLINE.get(flags)");
            ...
            arrayList2.add(new ValueParameterDescriptorImpl(callableDescriptor, null, i, empty, name, kotlinTypeType, zOooO00o, zOooO00o2, zOooO00o3, kotlinTypeType2, NO_SOURCE));
    ...
    public final PropertyDescriptor loadProperty(@NotNull ProtoBuf.Property proto) {
        ...
        ProtoEnumFlags protoEnumFlags = ProtoEnumFlags.INSTANCE;
        DeserializedPropertyDescriptor deserializedPropertyDescriptor4 = new DeserializedPropertyDescriptor(containingDeclaration, null, annotations, protoEnumFlags.modality(Flags.MODALITY.get(flags)), ProtoEnumFlagsUtilsKt.descriptorVisibility(protoEnumFlags, Flags.VISIBILITY.get(flags)), OooO00o.OooO00o(Flags.IS_VAR, flags, "IS_VAR.get(flags)"), NameResolverUtilKt.getName(this.c.getNameResolver(), proto.getName()), ProtoEnumFlagsUtilsKt.memberKind(protoEnumFlags, Flags.MEMBER_KIND.get(flags)), OooO00o.OooO00o(Flags.IS_LATEINIT, flags, "IS_LATEINIT.get(flags)"), OooO00o.OooO00o(Flags.IS_CONST, flags, "IS_CONST.get(flags)"), OooO00o.OooO00o(Flags.IS_EXTERNAL_PROPERTY, flags, "IS_EXTERNAL_PROPERTY.get(flags)"), OooO00o.OooO00o(Flags.IS_DELEGATED, flags, "IS_DELEGATED.get(flags)"), OooO00o.OooO00o(Flags.IS_EXPECT_PROPERTY, flags, "IS_EXPECT_PROPERTY.get(flags)"), proto, this.c.getNameResolver(), this.c.getTypeTable(), this.c.getVersionRequirementTable(), this.c.getContainerSource());
        DeserializationContext deserializationContext = this.c;
        List<ProtoBuf.TypeParameter> typeParameterList = proto.getTypeParameterList();
        Intrinsics.checkNotNullExpressionValue(typeParameterList, "proto.typeParameterList");
        ...
        boolean zOooO00o = OooO00o.OooO00o(Flags.HAS_GETTER, flags, "HAS_GETTER.get(flags)");
        if (zOooO00o && ProtoTypeTableUtilKt.hasReceiver(proto)) {
            property = proto;
        ...
        boolean zOooO00o2 = OooO00o.OooO00o(Flags.HAS_ANNOTATIONS, flags, "HAS_ANNOTATIONS.get(flags)");
        ...
        int accessorFlags = Flags.getAccessorFlags(zOooO00o2, visibility, flagField2.get(flags), false, false, false);
        if (zOooO00o) {
            int getterFlags = proto.hasGetterFlags() ? proto.getGetterFlags() : accessorFlags;
            boolean zOooO00o3 = OooO00o.OooO00o(Flags.IS_NOT_DEFAULT, getterFlags, "IS_NOT_DEFAULT.get(getterFlags)");
            boolean zOooO00o4 = OooO00o.OooO00o(Flags.IS_EXTERNAL_ACCESSOR, getterFlags, "IS_EXTERNAL_ACCESSOR.get(getterFlags)");
            boolean zOooO00o5 = OooO00o.OooO00o(Flags.IS_INLINE_ACCESSOR, getterFlags, "IS_INLINE_ACCESSOR.get(getterFlags)");
            ...
            if (zOooO00o3) {
                ...
                propertyGetterDescriptorImplCreateDefaultGetter = new PropertyGetterDescriptorImpl(deserializedPropertyDescriptor, annotations2, protoEnumFlags2.modality(flagField2.get(getterFlags)), ProtoEnumFlagsUtilsKt.descriptorVisibility(protoEnumFlags2, flagField.get(getterFlags)), !zOooO00o3, zOooO00o4, zOooO00o5, deserializedPropertyDescriptor.getKind(), null, SourceElement.NO_SOURCE);
            } else {
        ...
        if (OooO00o.OooO00o(Flags.HAS_SETTER, flags, "HAS_SETTER.get(flags)")) {
            if (proto.hasSetterFlags()) {
                accessorFlags = proto.getSetterFlags();
            }
            int i3 = accessorFlags;
            boolean zOooO00o6 = OooO00o.OooO00o(Flags.IS_NOT_DEFAULT, i3, "IS_NOT_DEFAULT.get(setterFlags)");
            boolean zOooO00o7 = OooO00o.OooO00o(Flags.IS_EXTERNAL_ACCESSOR, i3, "IS_EXTERNAL_ACCESSOR.get(setterFlags)");
            boolean zOooO00o8 = OooO00o.OooO00o(Flags.IS_INLINE_ACCESSOR, i3, "IS_INLINE_ACCESSOR.get(setterFlags)");
            ...
            if (zOooO00o6) {
                ...
                PropertySetterDescriptorImpl propertySetterDescriptorImpl = new PropertySetterDescriptorImpl(deserializedPropertyDescriptor2, annotations3, protoEnumFlags3.modality(flagField2.get(i3)), ProtoEnumFlagsUtilsKt.descriptorVisibility(protoEnumFlags3, flagField.get(i3)), !zOooO00o6, zOooO00o7, zOooO00o8, deserializedPropertyDescriptor2.getKind(), null, SourceElement.NO_SOURCE);
        ...
        if (OooO00o.OooO00o(Flags.HAS_CONSTANT, flags, "HAS_CONSTANT.get(flags)")) {
