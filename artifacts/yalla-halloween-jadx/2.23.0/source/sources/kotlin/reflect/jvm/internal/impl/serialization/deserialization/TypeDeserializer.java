...
public final class TypeDeserializer {
    ...
    private final SimpleType transformRuntimeFunctionTypeToSuspendFunction(KotlinType kotlinType) {
        ...
        FqName fqNameSafe = classifierDescriptorMo5502getDeclarationDescriptor != null ? DescriptorUtilsKt.getFqNameSafe(classifierDescriptorMo5502getDeclarationDescriptor) : null;
    ...
    public final SimpleType simpleType(@NotNull final ProtoBuf.Type proto, boolean z) {
        ...
        if (ErrorUtils.isError(typeConstructor.mo5502getDeclarationDescriptor())) {
        ...
        if (z && (classifierDescriptorMo5502getDeclarationDescriptor instanceof TypeAliasDescriptor)) {
            KotlinTypeFactory kotlinTypeFactory = KotlinTypeFactory.INSTANCE;
            SimpleType simpleTypeComputeExpandedType = KotlinTypeFactory.computeExpandedType((TypeAliasDescriptor) classifierDescriptorMo5502getDeclarationDescriptor, list);
