...
public abstract class AbstractTypeConstructor extends ClassifierBasedTypeConstructor {
    ...
    public final class ModuleViewTypeConstructor implements TypeConstructor {
        ...
        public ModuleViewTypeConstructor(@NotNull final AbstractTypeConstructor abstractTypeConstructor, KotlinTypeRefiner kotlinTypeRefiner) {
            ...
            this.refinedSupertypes$delegate = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, (Function0) new Function0<List<? extends KotlinType>>() { // from class: kotlin.reflect.jvm.internal.impl.types.AbstractTypeConstructor$ModuleViewTypeConstructor$refinedSupertypes$2
                ...
                public final List<? extends KotlinType> invoke() {
                    return KotlinTypeRefinerKt.refineTypes(this.this$0.kotlinTypeRefiner, abstractTypeConstructor.mo5503getSupertypes());
                }
            });
        }
        ...
        public ClassifierDescriptor mo5502getDeclarationDescriptor() {
            return this.this$0.mo5502getDeclarationDescriptor();
        }
        ...
        public List<KotlinType> mo5503getSupertypes() {
        ...
        this.supertypes = storageManager.createLazyValueWithPostCompute(new Function0<Supertypes>() { // from class: kotlin.reflect.jvm.internal.impl.types.AbstractTypeConstructor$supertypes$1
            ...
            public final void invoke2(@NotNull AbstractTypeConstructor.Supertypes supertypes) {
                ...
                if (this.this$0.getShouldReportCyclicScopeWithCompanionWarning()) {
                    ...
                    Function1<TypeConstructor, Iterable<? extends KotlinType>> function2 = new Function1<TypeConstructor, Iterable<? extends KotlinType>>() { // from class: kotlin.reflect.jvm.internal.impl.types.AbstractTypeConstructor$supertypes$3.2
                        {
                            super(1);
                        }
                    ...
                    supertypeLoopChecker2.findLoopsInSupertypesAndDisconnect(abstractTypeConstructor4, collectionFindLoopsInSupertypesAndDisconnect, function2, new Function1<KotlinType, Unit>() { // from class: kotlin.reflect.jvm.internal.impl.types.AbstractTypeConstructor$supertypes$3.3
                        {
                            super(1);
                        }
    ...
    public final Collection<KotlinType> computeNeighbours(TypeConstructor typeConstructor, boolean z) {
        ...
        Collection<KotlinType> supertypes = typeConstructor.mo5503getSupertypes();
