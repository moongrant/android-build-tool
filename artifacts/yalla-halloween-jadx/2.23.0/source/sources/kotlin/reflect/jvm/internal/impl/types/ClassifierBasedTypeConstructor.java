...
public abstract class ClassifierBasedTypeConstructor implements TypeConstructor {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor = mo5502getDeclarationDescriptor();
        ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor2 = typeConstructor.mo5502getDeclarationDescriptor();
        if (classifierDescriptorMo5502getDeclarationDescriptor2 != null && hasMeaningfulFqName(classifierDescriptorMo5502getDeclarationDescriptor) && hasMeaningfulFqName(classifierDescriptorMo5502getDeclarationDescriptor2)) {
            return isSameClassifier(classifierDescriptorMo5502getDeclarationDescriptor2);
        }
        return false;
    }
    ...
    public abstract ClassifierDescriptor mo5502getDeclarationDescriptor();
    ...
    public int hashCode() {
        ...
        ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor = mo5502getDeclarationDescriptor();
        int iHashCode = hasMeaningfulFqName(classifierDescriptorMo5502getDeclarationDescriptor) ? DescriptorUtils.getFqName(classifierDescriptorMo5502getDeclarationDescriptor).hashCode() : System.identityHashCode(this);
