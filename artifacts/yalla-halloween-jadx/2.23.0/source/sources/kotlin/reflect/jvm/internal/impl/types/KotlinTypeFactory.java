...
public final class KotlinTypeFactory {
    ...
    private final MemberScope computeMemberScope(TypeConstructor typeConstructor, List<? extends TypeProjection> list, KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        if (classifierDescriptorMo5502getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            return ((TypeParameterDescriptor) classifierDescriptorMo5502getDeclarationDescriptor).getDefaultType().getMemberScope();
        }
        if (classifierDescriptorMo5502getDeclarationDescriptor instanceof ClassDescriptor) {
            if (kotlinTypeRefiner == null) {
                kotlinTypeRefiner = DescriptorUtilsKt.getKotlinTypeRefiner(DescriptorUtilsKt.getModule(classifierDescriptorMo5502getDeclarationDescriptor));
            }
            return list.isEmpty() ? ModuleAwareClassDescriptorKt.getRefinedUnsubstitutedMemberScopeIfPossible((ClassDescriptor) classifierDescriptorMo5502getDeclarationDescriptor, kotlinTypeRefiner) : ModuleAwareClassDescriptorKt.getRefinedMemberScopeIfPossible((ClassDescriptor) classifierDescriptorMo5502getDeclarationDescriptor, TypeConstructorSubstitution.Companion.create(typeConstructor, list), kotlinTypeRefiner);
        }
        if (classifierDescriptorMo5502getDeclarationDescriptor instanceof TypeAliasDescriptor) {
            ErrorScopeKind errorScopeKind = ErrorScopeKind.SCOPE_FOR_ABBREVIATION_TYPE;
            String string = ((TypeAliasDescriptor) classifierDescriptorMo5502getDeclarationDescriptor).getName().toString();
        ...
        throw new IllegalStateException("Unsupported classifier: " + classifierDescriptorMo5502getDeclarationDescriptor + " for constructor: " + typeConstructor);
    }
    ...
    public final ExpandedTypeOrRefinedConstructor refineConstructor(TypeConstructor typeConstructor, KotlinTypeRefiner kotlinTypeRefiner, List<? extends TypeProjection> list) {
        ...
        ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor = typeConstructor.mo5502getDeclarationDescriptor();
        if (classifierDescriptorMo5502getDeclarationDescriptor == null || (classifierDescriptorRefineDescriptor = kotlinTypeRefiner.refineDescriptor(classifierDescriptorMo5502getDeclarationDescriptor)) == null) {
            return null;
        }
    ...
    public static final SimpleType simpleType(@NotNull final TypeAttributes attributes, @NotNull final TypeConstructor constructor, @NotNull final List<? extends TypeProjection> arguments, final boolean z, @Nullable KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        Intrinsics.checkNotNullParameter(constructor, "constructor");
        Intrinsics.checkNotNullParameter(arguments, "arguments");
        if (!attributes.isEmpty() || !arguments.isEmpty() || z || constructor.mo5502getDeclarationDescriptor() == null) {
        ...
        Intrinsics.checkNotNull(classifierDescriptorMo5502getDeclarationDescriptor);
        SimpleType defaultType = classifierDescriptorMo5502getDeclarationDescriptor.getDefaultType();
