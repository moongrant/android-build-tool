...
public interface ClassicTypeSystemContext extends TypeSystemCommonBackendContext, TypeSystemInferenceExtensionContext {
    ...
    public static final class DefaultImpls {
        ...
        public static TypeArgumentListMarker asArgumentList(@NotNull ClassicTypeSystemContext classicTypeSystemContext, @NotNull SimpleTypeMarker receiver) {
            ...
            StringBuilder sbOooO00o = OooO00o.OooO00o("ClassicTypeSystemContext couldn't handle: ", receiver, ", ");
            sbOooO00o.append(Reflection.getOrCreateKotlinClass(receiver.getClass()));
        ...
        public static SimpleTypeMarker captureFromArguments(@NotNull ClassicTypeSystemContext classicTypeSystemContext, @NotNull SimpleTypeMarker type, @NotNull CaptureStatus status) {
            ...
            StringBuilder sbOooO00o = OooO00o.OooO00o("ClassicTypeSystemContext couldn't handle: ", type, ", ");
            sbOooO00o.append(Reflection.getOrCreateKotlinClass(type.getClass()));
            throw new IllegalArgumentException(sbOooO00o.toString().toString());
        }
        ...
        public static FqNameUnsafe getClassFqNameUnsafe(@NotNull ClassicTypeSystemContext classicTypeSystemContext, @NotNull TypeConstructorMarker receiver) {
            ...
            if (receiver instanceof TypeConstructor) {
                ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor = ((TypeConstructor) receiver).mo5502getDeclarationDescriptor();
                Intrinsics.checkNotNull(classifierDescriptorMo5502getDeclarationDescriptor, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.ClassDescriptor");
                return DescriptorUtilsKt.getFqNameUnsafe((ClassDescriptor) classifierDescriptorMo5502getDeclarationDescriptor);
            }
            throw new IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + Reflection.getOrCreateKotlinClass(receiver.getClass())).toString());
        }
        ...
        public static PrimitiveType getPrimitiveArrayType(@NotNull ClassicTypeSystemContext classicTypeSystemContext, @NotNull TypeConstructorMarker receiver) {
            ...
            if (receiver instanceof TypeConstructor) {
                ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor = ((TypeConstructor) receiver).mo5502getDeclarationDescriptor();
                Intrinsics.checkNotNull(classifierDescriptorMo5502getDeclarationDescriptor, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.ClassDescriptor");
                return KotlinBuiltIns.getPrimitiveArrayType((ClassDescriptor) classifierDescriptorMo5502getDeclarationDescriptor);
            }
            throw new IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + Reflection.getOrCreateKotlinClass(receiver.getClass())).toString());
        }
        ...
        public static PrimitiveType getPrimitiveType(@NotNull ClassicTypeSystemContext classicTypeSystemContext, @NotNull TypeConstructorMarker receiver) {
            ...
            if (receiver instanceof TypeConstructor) {
                ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor = ((TypeConstructor) receiver).mo5502getDeclarationDescriptor();
                Intrinsics.checkNotNull(classifierDescriptorMo5502getDeclarationDescriptor, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.ClassDescriptor");
                return KotlinBuiltIns.getPrimitiveType((ClassDescriptor) classifierDescriptorMo5502getDeclarationDescriptor);
            }
            throw new IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + Reflection.getOrCreateKotlinClass(receiver.getClass())).toString());
        }
        ...
        public static TypeParameterMarker getTypeParameterClassifier(@NotNull ClassicTypeSystemContext classicTypeSystemContext, @NotNull TypeConstructorMarker receiver) {
            ...
            if (receiver instanceof TypeConstructor) {
                ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor = ((TypeConstructor) receiver).mo5502getDeclarationDescriptor();
                if (classifierDescriptorMo5502getDeclarationDescriptor instanceof TypeParameterDescriptor) {
                    return (TypeParameterDescriptor) classifierDescriptorMo5502getDeclarationDescriptor;
                }
                return null;
            }
            throw new IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + Reflection.getOrCreateKotlinClass(receiver.getClass())).toString());
        ...
        public static boolean identicalArguments(@NotNull ClassicTypeSystemContext classicTypeSystemContext, @NotNull SimpleTypeMarker a, @NotNull SimpleTypeMarker b) {
            ...
            if (!(a instanceof SimpleType)) {
                StringBuilder sbOooO00o = OooO00o.OooO00o("ClassicTypeSystemContext couldn't handle: ", a, ", ");
                sbOooO00o.append(Reflection.getOrCreateKotlinClass(a.getClass()));
                throw new IllegalArgumentException(sbOooO00o.toString().toString());
            }
            if (b instanceof SimpleType) {
                return ((SimpleType) a).getArguments() == ((SimpleType) b).getArguments();
            }
            StringBuilder sbOooO00o2 = OooO00o.OooO00o("ClassicTypeSystemContext couldn't handle: ", b, ", ");
            sbOooO00o2.append(Reflection.getOrCreateKotlinClass(b.getClass()));
            throw new IllegalArgumentException(sbOooO00o2.toString().toString());
        }
        ...
        public static boolean isClassTypeConstructor(@NotNull ClassicTypeSystemContext classicTypeSystemContext, @NotNull TypeConstructorMarker receiver) {
            Intrinsics.checkNotNullParameter(receiver, "$receiver");
            if (receiver instanceof TypeConstructor) {
                return ((TypeConstructor) receiver).mo5502getDeclarationDescriptor() instanceof ClassDescriptor;
            }
            throw new IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + Reflection.getOrCreateKotlinClass(receiver.getClass())).toString());
        }
        ...
        public static boolean isCommonFinalClassConstructor(@NotNull ClassicTypeSystemContext classicTypeSystemContext, @NotNull TypeConstructorMarker receiver) {
            ...
            if (receiver instanceof TypeConstructor) {
                ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor = ((TypeConstructor) receiver).mo5502getDeclarationDescriptor();
                ClassDescriptor classDescriptor = classifierDescriptorMo5502getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo5502getDeclarationDescriptor : null;
        ...
        public static boolean isUnderKotlinPackage(@NotNull ClassicTypeSystemContext classicTypeSystemContext, @NotNull TypeConstructorMarker receiver) {
            ...
            if (receiver instanceof TypeConstructor) {
                ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor = ((TypeConstructor) receiver).mo5502getDeclarationDescriptor();
                return classifierDescriptorMo5502getDeclarationDescriptor != null && KotlinBuiltIns.isUnderKotlinPackage(classifierDescriptorMo5502getDeclarationDescriptor);
            }
            throw new IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + Reflection.getOrCreateKotlinClass(receiver.getClass())).toString());
        }
        ...
        public static TypeCheckerState.SupertypesPolicy substitutionSupertypePolicy(@NotNull final ClassicTypeSystemContext classicTypeSystemContext, @NotNull SimpleTypeMarker type) {
            ...
            if (type instanceof SimpleType) {
                ...
                return new TypeCheckerState.SupertypesPolicy.DoCustomTransform() { // from class: kotlin.reflect.jvm.internal.impl.types.checker.ClassicTypeSystemContext$substitutionSupertypePolicy$2
                    ...
                    public SimpleTypeMarker mo5506transformType(@NotNull TypeCheckerState state, @NotNull KotlinTypeMarker type2) {
        ...
        public static Collection<KotlinTypeMarker> supertypes(@NotNull ClassicTypeSystemContext classicTypeSystemContext, @NotNull TypeConstructorMarker receiver) {
            Intrinsics.checkNotNullParameter(receiver, "$receiver");
            if (receiver instanceof TypeConstructor) {
                Collection<KotlinType> collectionMo5503getSupertypes = ((TypeConstructor) receiver).mo5503getSupertypes();
                Intrinsics.checkNotNullExpressionValue(collectionMo5503getSupertypes, "this.supertypes");
                return collectionMo5503getSupertypes;
            }
            throw new IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + Reflection.getOrCreateKotlinClass(receiver.getClass())).toString());
        }
