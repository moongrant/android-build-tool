    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> collectionMo5503getSupertypes = capturedTypeConstructorImpl.mo5503getSupertypes();
                ArrayList arrayList = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(collectionMo5503getSupertypes, 10));
        ...
        if (constructor instanceof IntegerValueTypeConstructor) {
            Collection<KotlinType> collectionMo5503getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo5503getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(collectionMo5503getSupertypes2, 10));
            Iterator<T> it2 = collectionMo5503getSupertypes2.iterator();
            while (it2.hasNext()) {
        ...
        Collection<KotlinType> collectionMo5503getSupertypes3 = intersectionTypeConstructor.mo5503getSupertypes();
        ArrayList arrayList3 = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(collectionMo5503getSupertypes3, 10));
        Iterator<T> it3 = collectionMo5503getSupertypes3.iterator();
        while (it3.hasNext()) {
