    ...
    public final SimpleType intersectTypes$descriptors(@NotNull List<? extends SimpleType> types) {
        ...
        for (SimpleType simpleType : types) {
            if (simpleType.getConstructor() instanceof IntersectionTypeConstructor) {
                Collection<KotlinType> collectionMo5503getSupertypes = simpleType.getConstructor().mo5503getSupertypes();
                Intrinsics.checkNotNullExpressionValue(collectionMo5503getSupertypes, "type.constructor.supertypes");
                Collection<KotlinType> collection = collectionMo5503getSupertypes;
