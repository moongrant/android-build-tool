...
public final class UtilsKt {
    ...
    private static final String debugInfo(TypeConstructor typeConstructor) {
        ...
        for (DeclarationDescriptor declarationDescriptorMo5502getDeclarationDescriptor = typeConstructor.mo5502getDeclarationDescriptor(); declarationDescriptorMo5502getDeclarationDescriptor != null; declarationDescriptorMo5502getDeclarationDescriptor = declarationDescriptorMo5502getDeclarationDescriptor.getContainingDeclaration()) {
            debugInfo$lambda$1$unaryPlus("fqName: " + DescriptorRenderer.FQ_NAMES_IN_TYPES.render(declarationDescriptorMo5502getDeclarationDescriptor), sb);
            debugInfo$lambda$1$unaryPlus("javaClass: " + declarationDescriptorMo5502getDeclarationDescriptor.getClass().getCanonicalName(), sb);
        }
    ...
    public static final KotlinType findCorrespondingSupertype(@NotNull KotlinType subtype, @NotNull KotlinType supertype, @NotNull TypeCheckingProcedureCallbacks typeCheckingProcedureCallbacks) {
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            for (KotlinType immediateSupertype : constructor2.mo5503getSupertypes()) {
