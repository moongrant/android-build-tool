...
public class ErrorScope implements MemberScope {
    ...
    public ErrorScope(@NotNull ErrorScopeKind kind, @NotNull String... formatParams) {
        ...
        this.debugMessage = OooO0O0.OooO00o(objArrCopyOf, objArrCopyOf.length, debugMessage, "format(this, *args)");
    }
    ...
    public String toString() {
        return oo000o.OooO00o(new StringBuilder("ErrorScope{"), this.debugMessage, '}');
    }
