...
public final class TypeUtilsKt {
    ...
    private static final boolean containsSelfTypeParameter(KotlinType kotlinType, TypeConstructor typeConstructor, Set<? extends TypeParameterDescriptor> set) {
        ...
        ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters = classifierDescriptorMo5502getDeclarationDescriptor instanceof ClassifierDescriptorWithTypeParameters ? (ClassifierDescriptorWithTypeParameters) classifierDescriptorMo5502getDeclarationDescriptor : null;
    ...
    public static final boolean containsTypeAliasParameters(@NotNull KotlinType kotlinType) {
        ...
        return contains(kotlinType, new Function1<UnwrappedType, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.types.typeUtil.TypeUtilsKt.containsTypeAliasParameters.1
            ...
            public final Boolean invoke(@NotNull UnwrappedType it) {
                ...
                ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor = it.getConstructor().mo5502getDeclarationDescriptor();
                return Boolean.valueOf(classifierDescriptorMo5502getDeclarationDescriptor != null ? TypeUtilsKt.isTypeAliasParameter(classifierDescriptorMo5502getDeclarationDescriptor) : false);
            }
        });
    }
    ...
    public static final KotlinType getRepresentativeUpperBound(@NotNull TypeParameterDescriptor typeParameterDescriptor) {
        ...
        while (true) {
            ...
            Object next = it.next();
            ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor = ((KotlinType) next).getConstructor().mo5502getDeclarationDescriptor();
    ...
    public static final boolean requiresTypeAliasExpansion(@NotNull KotlinType kotlinType) {
        ...
        return contains(kotlinType, new Function1<UnwrappedType, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.types.typeUtil.TypeUtilsKt.requiresTypeAliasExpansion.1
            ...
            public final Boolean invoke(@NotNull UnwrappedType it) {
                ...
                ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor = it.getConstructor().mo5502getDeclarationDescriptor();
                boolean z = false;
                if (classifierDescriptorMo5502getDeclarationDescriptor != null && ((classifierDescriptorMo5502getDeclarationDescriptor instanceof TypeAliasDescriptor) || (classifierDescriptorMo5502getDeclarationDescriptor instanceof TypeParameterDescriptor))) {
                    z = true;
                }
    ...
    private static final void extractTypeParametersFromUpperBounds(KotlinType kotlinType, KotlinType kotlinType2, Set<TypeParameterDescriptor> set, Set<? extends TypeParameterDescriptor> set2) {
        ...
        if (classifierDescriptorMo5502getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            if (!Intrinsics.areEqual(kotlinType.getConstructor(), kotlinType2.getConstructor())) {
                set.add(classifierDescriptorMo5502getDeclarationDescriptor);
                return;
            }
            for (KotlinType upperBound : ((TypeParameterDescriptor) classifierDescriptorMo5502getDeclarationDescriptor).getUpperBounds()) {
                Intrinsics.checkNotNullExpressionValue(upperBound, "upperBound");
                extractTypeParametersFromUpperBounds(upperBound, kotlinType2, set, set2);
            }
            return;
        }
        ClassifierDescriptor classifierDescriptorMo5502getDeclarationDescriptor2 = kotlinType.getConstructor().mo5502getDeclarationDescriptor();
        ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters = classifierDescriptorMo5502getDeclarationDescriptor2 instanceof ClassifierDescriptorWithTypeParameters ? (ClassifierDescriptorWithTypeParameters) classifierDescriptorMo5502getDeclarationDescriptor2 : null;
        List<TypeParameterDescriptor> declaredTypeParameters = classifierDescriptorWithTypeParameters != null ? classifierDescriptorWithTypeParameters.getDeclaredTypeParameters() : null;
        int i = 0;
