...
public final class SubSequence<T> implements Sequence<T>, DropTakeSequence<T> {
    ...
    public SubSequence(@NotNull Sequence<? extends T> sequence, int i, int i2) {
        ...
        this.endIndex = i2;
        if (!(i >= 0)) {
            throw new IllegalArgumentException(OooO00o.OooO00o("startIndex should be non-negative, but is ", i).toString());
        }
        if (!(i2 >= 0)) {
            throw new IllegalArgumentException(OooO00o.OooO00o("endIndex should be non-negative, but is ", i2).toString());
        }
        if (!(i2 >= i)) {
            throw new IllegalArgumentException(OooOO0.OooO00o("endIndex should be not less than startIndex, but was ", i2, " < ", i).toString());
        }
    }
