...
public class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final CharSequence padEnd(@NotNull CharSequence charSequence, int i, char c) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        if (i < 0) {
            throw new IllegalArgumentException(OooO0OO.OooO00o.OooO00o("Desired length ", i, " is less than zero."));
        }
    ...
    public static CharSequence removeRange(@NotNull CharSequence charSequence, int i, int i2) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        if (i2 < i) {
            throw new IndexOutOfBoundsException(o0O00o0.OooO00o("End index (", i2, ") is less than start index (", i, ")."));
        }
        if (i2 == i) {
            return charSequence.subSequence(0, charSequence.length());
        }
    ...
    public static final String replaceAfter(@NotNull String str, char c, @NotNull String str2, @NotNull String str3) {
        OooO0OO.OooO00o(str, "<this>", str2, "replacement", str3, "missingDelimiterValue");
    ...
    public static String substringAfter(@NotNull String str, @NotNull String str2, @NotNull String str3) {
        OooO0OO.OooO00o(str, "<this>", str2, "delimiter", str3, "missingDelimiterValue");
    ...
    public static final boolean toBooleanStrict(@NotNull String str) {
        ...
        throw new IllegalArgumentException(o00O00OO.OooO00o("The string doesn't represent a boolean value: ", str));
    }
    ...
    public static final CharSequence trim(@NotNull CharSequence charSequence, @NotNull Function1<? super Character, Boolean> predicate) {
        ...
        boolean z = false;
        while (i <= length) {
            boolean zBooleanValue = ((Boolean) OooO00o.OooO00o(charSequence, !z ? i : length, predicate)).booleanValue();
            if (z) {
                if (!zBooleanValue) {
                    break;
                }
    ...
    public static final CharSequence trimEnd(@NotNull CharSequence charSequence, @NotNull Function1<? super Character, Boolean> predicate) {
        ...
        while (true) {
            int i = length - 1;
            if (!((Boolean) OooO00o.OooO00o(charSequence, length, predicate)).booleanValue()) {
    ...
    public static final CharSequence trimStart(@NotNull CharSequence charSequence, @NotNull Function1<? super Character, Boolean> function1) {
        int iOooO00o = p028Oooo0oO.o0O00o0.OooO00o(charSequence, "<this>", function1, "predicate");
        for (int i = 0; i < iOooO00o; i++) {
            if (!((Boolean) OooO00o.OooO00o(charSequence, i, function1)).booleanValue()) {
    ...
    public static final CharSequence removeRange(@NotNull CharSequence charSequence, @NotNull IntRange range) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(range, "range");
        return removeRange(charSequence, range.getStart().intValue(), OooO0O0.OooO00o(range, 1));
    }
    ...
    public static final CharSequence replaceRange(@NotNull CharSequence charSequence, @NotNull IntRange range, @NotNull CharSequence replacement) {
        ...
        Intrinsics.checkNotNullParameter(range, "range");
        Intrinsics.checkNotNullParameter(replacement, "replacement");
        return replaceRange(charSequence, range.getStart().intValue(), OooO0O0.OooO00o(range, 1), replacement);
    }
