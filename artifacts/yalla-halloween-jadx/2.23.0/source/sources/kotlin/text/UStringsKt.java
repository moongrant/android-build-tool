...
public final class UStringsKt {
    ...
    public static final String m5537toStringJSWoG40(long j, int i) {
    ...
    public static final String m5538toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m5539toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m5540toStringolVBNx4(short s, int i) {
    ...
    public static final UByte toUByteOrNull(@NotNull String str, int i) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m4308constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m4225boximpl(UByte.m4231constructorimpl((byte) data));
    }
    ...
    public static final UInt toUIntOrNull(@NotNull String str, int i) {
        ...
        int iM4308constructorimpl = UInt.m4308constructorimpl(i);
        int i4 = 119304647;
        int i5 = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i6, i5 ^ Integer.MIN_VALUE) > 0) {
                if (i5 == i4) {
                    i5 = (int) ((((long) (-1)) & 4294967295L) / (((long) iM4308constructorimpl) & 4294967295L));
                    if (Integer.compare(i6, i5 ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM4308constructorimpl2 = UInt.m4308constructorimpl(i3 * iM4308constructorimpl);
            int iM4308constructorimpl3 = UInt.m4308constructorimpl(UInt.m4308constructorimpl(iDigitOf) + iM4308constructorimpl2);
            if (Integer.compare(iM4308constructorimpl3 ^ Integer.MIN_VALUE, iM4308constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = iM4308constructorimpl3;
            i4 = 119304647;
        }
        return UInt.m4302boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(@NotNull String str, int i) {
        ...
        long jM4387constructorimpl = ULong.m4387constructorimpl(i);
        long j = 0;
        long jM4387constructorimpl2 = 0;
        ...
        while (i2 < length) {
            ...
            int i3 = i2;
            long j3 = jM4387constructorimpl2 ^ Long.MIN_VALUE;
            long j4 = jM4387constructorimpl;
            ...
            long jM4387constructorimpl3 = ULong.m4387constructorimpl(jM4387constructorimpl2 * j4);
            jM4387constructorimpl2 = ULong.m4387constructorimpl(ULong.m4387constructorimpl(((long) UInt.m4308constructorimpl(iDigitOf)) & 4294967295L) + jM4387constructorimpl3);
            if (Long.compare(jM4387constructorimpl2 ^ Long.MIN_VALUE, jM4387constructorimpl3 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i2 = i3 + 1;
            jM4387constructorimpl = j4;
            j = 0;
        }
        return ULong.m4381boximpl(jM4387constructorimpl2);
    }
    ...
    public static final UShort toUShortOrNull(@NotNull String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m4308constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m4488boximpl(UShort.m4494constructorimpl((short) data));
    }
}
