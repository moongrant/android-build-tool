...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    public static final class DefaultImpls {
        public static int compareTo(@NotNull ComparableTimeMark comparableTimeMark, @NotNull ComparableTimeMark other) {
            ...
            return Duration.m5551compareToLRDsOJo(comparableTimeMark.mo5543minusUwyO8pc(other), Duration.INSTANCE.m5654getZEROUwyO8pc());
        }
        ...
        public static ComparableTimeMark m5547minusLRDsOJo(@NotNull ComparableTimeMark comparableTimeMark, long j) {
            return comparableTimeMark.mo5544plusLRDsOJo(Duration.m5604unaryMinusUwyO8pc(j));
        }
    }
    ...
    ComparableTimeMark mo5542minusLRDsOJo(long duration);

    /* JADX INFO: renamed from: minus-UwyO8pc */
    long mo5543minusUwyO8pc(@NotNull ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    @NotNull
    /* JADX INFO: renamed from: plus-LRDsOJo */
    ComparableTimeMark mo5544plusLRDsOJo(long duration);
}
