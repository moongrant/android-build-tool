...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public final long m5682adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m5694constructorimpl(LongSaturatedMathKt.m5680saturatingAddpTJri5U(timeMark, duration));
    }

    /* JADX INFO: renamed from: differenceBetween-fRLX17w, reason: not valid java name */
    public final long m5683differenceBetweenfRLX17w(long one, long another) {
    ...
    public final long m5684elapsedFrom6eNON_k(long timeMark) {
        return LongSaturatedMathKt.saturatingDiff(read(), timeMark);
    }

    @Override // kotlin.time.TimeSource.WithComparableMarks, kotlin.time.TimeSource
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m5691boximpl(m5685markNowz9LOYto());
    }

    /* JADX INFO: renamed from: markNow-z9LOYto, reason: not valid java name */
    public long m5685markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m5694constructorimpl(read());
    }
