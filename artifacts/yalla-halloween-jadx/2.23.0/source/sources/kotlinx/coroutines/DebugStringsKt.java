...
public final class DebugStringsKt {
    ...
    public static final String toDebugString(@NotNull Continuation<?> continuation) {
        ...
        try {
            ...
            objM4213constructorimpl = Result.m4213constructorimpl(continuation + '@' + getHexAddress(continuation));
        } catch (Throwable th) {
        ...
        if (Result.m4216exceptionOrNullimpl(objM4213constructorimpl) != null) {
            objM4213constructorimpl = continuation.getClass().getName() + '@' + getHexAddress(continuation);
        }
        return (String) objM4213constructorimpl;
    }
}
