...
public class JobSupport implements Job, ChildJob, ParentJob, SelectClause0 {
        ...
        public final void addExceptionLocked(@NotNull Throwable exception) {
            ...
            if (!(obj instanceof Throwable)) {
                if (!(obj instanceof ArrayList)) {
                    throw new IllegalStateException(Oooo0.OooO0O0("State is ", obj));
                }
        ...
        while (true) {
            ...
            if (!incomplete.getIsActive()) {
                ...
                if (objTryMakeCompleting == JobSupportKt.COMPLETING_ALREADY) {
                    throw new IllegalStateException(Oooo0.OooO0O0("Cannot happen in ", state$kotlinx_coroutines_core));
                }
    ...
    public CancellationException getChildJobCancellationCause() {
        ...
        if (state$kotlinx_coroutines_core instanceof Finishing) {
            ...
            if (state$kotlinx_coroutines_core instanceof Incomplete) {
                throw new IllegalStateException(Oooo0.OooO0O0("Cannot be cancelling child in this state: ", state$kotlinx_coroutines_core));
            }
            rootCause = null;
        }
    ...
    public final String toDebugString() {
        ...
        sb.append('{');
        return oo000o.OooO00o(sb, stateString(getState$kotlinx_coroutines_core()), '}');
    }
