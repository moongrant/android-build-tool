...
public final class HandlerContext extends HandlerDispatcher {
    ...
    public static final void m5726invokeOnTimeout$lambda3(HandlerContext handlerContext, Runnable runnable) {
        ...
        if (this.handler.postDelayed(block, RangesKt.coerceAtMost(timeMillis, DurationKt.MAX_MILLIS))) {
            return new DisposableHandle() { // from class: kotlinx.coroutines.android.OooO00o
                ...
                public final void dispose() {
                    HandlerContext.m5726invokeOnTimeout$lambda3(this.f33610OooO0Oo, block);
                }
            };
        }
        cancelOnRejection(context, block);
    ...
    public void mo5777scheduleResumeAfterDelay(long timeMillis, @NotNull final CancellableContinuation<? super Unit> continuation) {
