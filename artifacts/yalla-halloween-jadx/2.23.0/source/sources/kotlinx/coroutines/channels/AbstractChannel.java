...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
            ...
            while (true) {
                ...
                if (objPollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause != null) {
                        ...
                        orCreateCancellableContinuation.resumeWith(Result.m4213constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                        break;
                    }
                    Result.Companion companion2 = Result.INSTANCE;
                    orCreateCancellableContinuation.resumeWith(Result.m4213constructorimpl(Boxing.boxBoolean(false)));
                    break;
                }
    ...
    public static class ReceiveElement<E> extends Receive<E> {
        ...
        public void resumeReceiveClosed(@NotNull Closed<?> closed) {
            if (this.receiveMode == 1) {
                this.cont.resumeWith(Result.m4213constructorimpl(ChannelResult.m5736boximpl(ChannelResult.INSTANCE.m5749closedJP2dKIU(closed.closeCause))));
                return;
            }
            CancellableContinuation<Object> cancellableContinuation = this.cont;
            Result.Companion companion = Result.INSTANCE;
            cancellableContinuation.resumeWith(Result.m4213constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
        }

        @Nullable
        public final Object resumeValue(E value) {
            return this.receiveMode == 1 ? ChannelResult.m5736boximpl(ChannelResult.INSTANCE.m5751successJP2dKIU(value)) : value;
        }
    ...
    public static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        public void completeResumeReceive(E value) throws Throwable {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m5736boximpl(ChannelResult.INSTANCE.m5751successJP2dKIU(value)) : value, this.select.getCompletion(), resumeOnCancellationFun(value));
        }
        ...
        public void resumeReceiveClosed(@NotNull Closed<?> closed) throws Throwable {
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m5736boximpl(ChannelResult.INSTANCE.m5749closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                }
            }
        }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) throws Throwable {
        ...
        if (!z) {
            if (i != 1) {
                ...
                UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m5736boximpl(z ? companion.m5749closedJP2dKIU(((Closed) obj).closeCause) : companion.m5751successJP2dKIU(obj)), selectInstance.getCompletion());
                return;
            }
        }
        if (i == 0) {
        ...
        if (i == 1 && selectInstance.trySelect()) {
            UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m5736boximpl(ChannelResult.INSTANCE.m5749closedJP2dKIU(((Closed) obj).closeCause)), selectInstance.getCompletion());
        }
    }
    ...
    public void onCancelIdempotent(boolean wasClosed) {
        ...
        Object objM5767constructorimpl$default = InlineList.m5767constructorimpl$default(null, 1, null);
        while (true) {
            LockFreeLinkedListNode prevNode = closedForSend.getPrevNode();
            if (prevNode instanceof LockFreeLinkedListHead) {
                mo5728onCancelIdempotentListww6eGU(objM5767constructorimpl$default, closedForSend);
                return;
            } else if (prevNode.mo5775remove()) {
                objM5767constructorimpl$default = InlineList.m5772plusFjFbRPM(objM5767constructorimpl$default, (Send) prevNode);
            } else {
                prevNode.helpRemove();
            }
        }
    ...
    public void mo5728onCancelIdempotentListww6eGU(@NotNull Object list, @NotNull Closed<?> closed) {
        if (list == null) {
            return;
        }
    ...
    public final Object mo5729receiveCatchingJP2dKIU(@NotNull Continuation<? super ChannelResult<? extends E>> continuation) throws Throwable {
        ...
        if (i2 == 0) {
            ...
            Object objPollInternal = pollInternal();
            if (objPollInternal != AbstractChannelKt.POLL_FAILED) {
                return objPollInternal instanceof Closed ? ChannelResult.INSTANCE.m5749closedJP2dKIU(((Closed) objPollInternal).closeCause) : ChannelResult.INSTANCE.m5751successJP2dKIU(objPollInternal);
            }
    ...
    public final Object mo5730tryReceivePtdJZtk() {
        Object objPollInternal = pollInternal();
        if (objPollInternal == AbstractChannelKt.POLL_FAILED) {
            return ChannelResult.INSTANCE.m5750failurePtdJZtk();
        }
        return objPollInternal instanceof Closed ? ChannelResult.INSTANCE.m5749closedJP2dKIU(((Closed) objPollInternal).closeCause) : ChannelResult.INSTANCE.m5751successJP2dKIU(objPollInternal);
    }
