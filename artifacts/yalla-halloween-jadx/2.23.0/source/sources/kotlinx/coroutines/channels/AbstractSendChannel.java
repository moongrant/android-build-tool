...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    private final String getQueueDebugStateString() {
        ...
        StringBuilder sbOooO0O0 = o000Oo0.OooO0O0(string, ",queueSize=");
    ...
    private final void helpClose(Closed<?> closed) {
        ...
        while (true) {
            ...
            if (receive == null) {
                break;
            } else if (receive.mo5775remove()) {
                objM5767constructorimpl$default = InlineList.m5772plusFjFbRPM(objM5767constructorimpl$default, receive);
            } else {
                receive.helpRemove();
            }
        }
        if (objM5767constructorimpl$default != null) {
            if (objM5767constructorimpl$default instanceof ArrayList) {
                ArrayList arrayList = (ArrayList) objM5767constructorimpl$default;
                for (int size = arrayList.size() - 1; -1 < size; size--) {
                    ((Receive) arrayList.get(size)).resumeReceiveClosed(closed);
                }
            } else {
                ((Receive) objM5767constructorimpl$default).resumeReceiveClosed(closed);
            }
        }
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 == null || (undeliveredElementExceptionCallUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) == null) {
            ...
            continuation.resumeWith(Result.m4213constructorimpl(ResultKt.createFailure(sendException)));
        } else {
            ...
            continuation.resumeWith(Result.m4213constructorimpl(ResultKt.createFailure(undeliveredElementExceptionCallUndeliveredElementCatchingException$default)));
        }
    }
            ...
            if (objOfferSelectInternal != AbstractChannelKt.OFFER_FAILED && objOfferSelectInternal != AtomicKt.RETRY_ATOMIC) {
                if (objOfferSelectInternal == AbstractChannelKt.OFFER_SUCCESS) {
                    ...
                    if (!(objOfferSelectInternal instanceof Closed)) {
                        throw new IllegalStateException(Oooo0.OooO0O0("offerSelectInternal returned ", objOfferSelectInternal));
                    }
    ...
    public final Object sendSuspend(E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        while (true) {
            if (isFullImpl()) {
                ...
                if (objEnqueueSend != AbstractChannelKt.ENQUEUE_FAILED && !(objEnqueueSend instanceof Receive)) {
                    throw new IllegalStateException(Oooo0.OooO0O0("enqueueSend returned ", objEnqueueSend));
                }
                objOfferInternal = offerInternal(e);
                if (objOfferInternal == AbstractChannelKt.OFFER_SUCCESS) {
                    Result.Companion companion = Result.INSTANCE;
                    orCreateCancellableContinuation.resumeWith(Result.m4213constructorimpl(Unit.INSTANCE));
                    break;
                }
                if (objOfferInternal != AbstractChannelKt.OFFER_FAILED) {
                    if (objOfferInternal instanceof Closed) {
                        throw new IllegalStateException(Oooo0.OooO0O0("offerInternal returned ", objOfferInternal));
                    }
    ...
    public void invokeOnClose(@NotNull Function1<? super Throwable, Unit> handler) {
        ...
        if (!z2) {
            ...
            if (obj != AbstractChannelKt.HANDLER_INVOKED) {
                throw new IllegalStateException(Oooo000.OooO00o("Another handler was already registered: ", obj));
            }
    ...
    public final Object mo5731trySendJP2dKIU(E element) {
        ...
        if (objOfferInternal == AbstractChannelKt.OFFER_FAILED) {
            Closed<?> closedForSend = getClosedForSend();
            return closedForSend == null ? ChannelResult.INSTANCE.m5750failurePtdJZtk() : ChannelResult.INSTANCE.m5749closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        }
        if (objOfferInternal instanceof Closed) {
            return ChannelResult.INSTANCE.m5749closedJP2dKIU(helpCloseAndGetSendException((Closed) objOfferInternal));
        }
        throw new IllegalStateException(Oooo0.OooO0O0("trySend returned ", objOfferInternal));
    }
