...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo5729receiveCatchingJP2dKIU(@NotNull Continuation<? super ChannelResult<? extends E>> continuation) {
        Object objMo5729receiveCatchingJP2dKIU = this._channel.mo5729receiveCatchingJP2dKIU(continuation);
        IntrinsicsKt.getCOROUTINE_SUSPENDED();
        return objMo5729receiveCatchingJP2dKIU;
    }
    ...
    public Object mo5730tryReceivePtdJZtk() {
        return this._channel.mo5730tryReceivePtdJZtk();
    }
    ...
    public Object mo5731trySendJP2dKIU(E element) {
        return this._channel.mo5731trySendJP2dKIU(element);
    }
