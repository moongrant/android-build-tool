...
public final class ChannelResult<T> {
    ...
    public static final class Companion {
        ...
        public final <E> Object m5749closedJP2dKIU(@Nullable Throwable cause) {
            return ChannelResult.m5737constructorimpl(new Closed(cause));
        }

        @InternalCoroutinesApi
        @NotNull
        /* JADX INFO: renamed from: failure-PtdJZtk, reason: not valid java name */
        public final <E> Object m5750failurePtdJZtk() {
            return ChannelResult.m5737constructorimpl(ChannelResult.failed);
        }

        @InternalCoroutinesApi
        @NotNull
        /* JADX INFO: renamed from: success-JP2dKIU, reason: not valid java name */
        public final <E> Object m5751successJP2dKIU(E value) {
            return ChannelResult.m5737constructorimpl(value);
        }
    }
    ...
    public static final /* synthetic */ ChannelResult m5736boximpl(Object obj) {
    ...
    public static <T> Object m5737constructorimpl(@Nullable Object obj) {
        return obj;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m5738equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof ChannelResult) && Intrinsics.areEqual(obj, ((ChannelResult) obj2).getHolder());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m5739equalsimpl0(Object obj, Object obj2) {
        return Intrinsics.areEqual(obj, obj2);
    }

    @Nullable
    /* JADX INFO: renamed from: exceptionOrNull-impl, reason: not valid java name */
    public static final Throwable m5740exceptionOrNullimpl(Object obj) {
    ...
    public static final T m5741getOrNullimpl(Object obj) {
    ...
    public static final T m5742getOrThrowimpl(Object obj) throws Throwable {
        Throwable th;
        if (!(obj instanceof Failed)) {
            return obj;
        }
        if (!(obj instanceof Closed) || (th = ((Closed) obj).cause) == null) {
            throw new IllegalStateException(Oooo0.OooO0O0("Trying to call 'getOrThrow' on a failed channel result: ", obj));
        }
        throw th;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m5743hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public static final boolean m5744isClosedimpl(Object obj) {
        return obj instanceof Closed;
    }

    /* JADX INFO: renamed from: isFailure-impl, reason: not valid java name */
    public static final boolean m5745isFailureimpl(Object obj) {
        return obj instanceof Failed;
    }

    /* JADX INFO: renamed from: isSuccess-impl, reason: not valid java name */
    public static final boolean m5746isSuccessimpl(Object obj) {
        return !(obj instanceof Failed);
    }

    @NotNull
    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m5747toStringimpl(Object obj) {
    ...
    public boolean equals(Object obj) {
        return m5738equalsimpl(this.holder, obj);
    }

    public int hashCode() {
        return m5743hashCodeimpl(this.holder);
    }

    @NotNull
    public String toString() {
        return m5747toStringimpl(this.holder);
    }
