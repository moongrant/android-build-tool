...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    public final void closeSubscriber(Subscriber<E> subscriber) {
        ...
        do {
            ...
            if (!(obj instanceof State)) {
                throw new IllegalStateException(Oooo0.OooO0O0("Invalid state ", obj));
            }
    ...
    public Object mo5731trySendJP2dKIU(E element) {
        Closed closedOfferInternal = offerInternal(element);
        return closedOfferInternal != null ? ChannelResult.INSTANCE.m5749closedJP2dKIU(closedOfferInternal.getSendException()) : ChannelResult.INSTANCE.m5751successJP2dKIU(Unit.INSTANCE);
    }
