...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(@NotNull SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m5746isSuccessimpl(objMo5731trySendJP2dKIU)) {
                return true;
            }
            Throwable thM5740exceptionOrNullimpl = ChannelResult.m5740exceptionOrNullimpl(objMo5731trySendJP2dKIU);
    ...
    Object mo5731trySendJP2dKIU(E element);
}
