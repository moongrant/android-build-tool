...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM4213constructorimpl = Result.m4213constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM4213constructorimpl = Result.m4213constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m4219isFailureimpl(objM4213constructorimpl) ? null : objM4213constructorimpl);
    ...
    private final void installSignalHandler() {
        try {
            Signal.handle(new Signal("TRAP"), new o0Oo0oo());
        } catch (Throwable unused) {
        }
    }

    /* JADX INFO: renamed from: installSignalHandler$lambda-1, reason: not valid java name */
    private static final void m5753installSignalHandler$lambda1(Signal signal) {
