...
public final class DebugProbesImpl {
    ...
    private final void build(Job job, Map<Job, DebugCoroutineInfoImpl> map, StringBuilder sb, String str) {
        ...
        if (debugCoroutineInfoImpl != null) {
            ...
            OooO0O0.OooO00o(sbOooO00o, getDebugString(job), ", continuation is ", str2, " at line ");
            sbOooO00o.append(stackTraceElement);
            sbOooO00o.append('\n');
            sb.append(sbOooO00o.toString());
            str = str + '\t';
        } else if (!(job instanceof ScopeCoroutine)) {
            StringBuilder sbOooO00o2 = o00OO.OooO00o(str);
            sbOooO00o2.append(getDebugString(job));
            sbOooO00o2.append('\n');
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> coroutineTrace) {
        ...
        try {
            ...
            objM4213constructorimpl = Result.m4213constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
        ...
        StackTraceElement[] stackTraceElementArr = (StackTraceElement[]) objM4213constructorimpl;
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        try {
            ...
            objM4213constructorimpl = Result.m4213constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(objNewInstance, 1));
            if (Result.m4219isFailureimpl(objM4213constructorimpl)) {
                objM4213constructorimpl = null;
            }
            return (Function1) objM4213constructorimpl;
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM4213constructorimpl = Result.m4213constructorimpl(ResultKt.createFailure(th));
        }
    ...
    private final boolean isInternalMethod(StackTraceElement stackTraceElement) {
        return StringsKt.Oooo00o(stackTraceElement.getClassName(), "kotlinx.coroutines");
    }
    ...
    public final Object[] dumpCoroutinesInfoAsJsonAndReferences() {
        ...
        for (DebugCoroutineInfo debugCoroutineInfo : listDumpCoroutinesInfo) {
            ...
            StringBuilder sbOooO00o = o0OoOo0.OooO00o("\n                {\n                    \"name\": ", stringWithQuotes, ",\n                    \"id\": ");
            CoroutineId coroutineId = (CoroutineId) context.get(CoroutineId.INSTANCE);
            if (coroutineId != null) {
                lValueOf = Long.valueOf(coroutineId.getId());
            }
            sbOooO00o.append(lValueOf);
            sbOooO00o.append(",\n                    \"dispatcher\": ");
            sbOooO00o.append(stringWithQuotes2);
            sbOooO00o.append(",\n                    \"sequenceNumber\": ");
            sbOooO00o.append(debugCoroutineInfo.getSequenceNumber());
            sbOooO00o.append(",\n                    \"state\": \"");
            sbOooO00o.append(debugCoroutineInfo.getState());
            sbOooO00o.append("\"\n                } \n                ");
            arrayList3.add(StringsKt.trimIndent(sbOooO00o.toString()));
            arrayList2.add(debugCoroutineInfo.getLastObservedFrame());
            arrayList.add(debugCoroutineInfo.getLastObservedThread());
        }
        Object[] objArr = new Object[4];
        objArr[0] = oo000o.OooO00o(new StringBuilder("["), CollectionsKt___CollectionsKt.joinToString$default(arrayList3, null, null, null, 0, null, null, 63, null), ']');
    ...
    public final String enhanceStackTraceWithThreadDumpAsJson(@NotNull DebugCoroutineInfo info) {
        ...
        return oo000o.OooO00o(new StringBuilder("["), CollectionsKt___CollectionsKt.joinToString$default(arrayList, null, null, null, 0, null, null, 63, null), ']');
    }
