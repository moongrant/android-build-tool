...
final /* synthetic */ class FlowKt__ContextKt {
    ...
    public static final <T> Flow<T> buffer(@NotNull Flow<? extends T> flow, int i, @NotNull BufferOverflow bufferOverflow) {
        ...
        boolean z = true;
        if (!(i >= 0 || i == -2 || i == -1)) {
            throw new IllegalArgumentException(android.support.v4.media.OooO00o.OooO00o("Buffer size should be non-negative, BUFFERED, or CONFLATED, but was ", i).toString());
        }
