...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final class C10483 extends SuspendLambda implements Function2<ProducerScope<? super Unit>, Continuation<? super Unit>, Object> {
        ...
        public C10483(long j, long j2, Continuation<? super C10483> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C10483 c10483 = new C10483(this.$initialDelayMillis, this.$delayMillis, continuation);
            c10483.L$0 = obj;
            return c10483;
        }
        ...
        public final java.lang.Object invokeSuspend(@org.jetbrains.annotations.NotNull java.lang.Object r8) {
            ...
            L51:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__DelayKt.C10483.invokeSuspend(java.lang.Object):java.lang.Object");
        }
        ...
        public final Object invoke(@NotNull ProducerScope<? super Unit> producerScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C10483) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public static final class C10492<T> extends SuspendLambda implements Function3<CoroutineScope, FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        ...
        public C10492(long j, Flow<? extends T> flow, Continuation<? super C10492> continuation) {
        ...
        public final Object invoke(@NotNull CoroutineScope coroutineScope, @NotNull FlowCollector<? super T> flowCollector, @Nullable Continuation<? super Unit> continuation) {
            C10492 c10492 = new C10492(this.$periodMillis, this.$this_sample, continuation);
            c10492.L$0 = coroutineScope;
            c10492.L$1 = flowCollector;
            return c10492.invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public static final <T> Flow<T> m5757debounceHG0u8IE(@NotNull Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m5716toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> debounceDuration(@NotNull Flow<? extends T> flow, @NotNull final Function1<? super T, Duration> function1) {
        return debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt.debounce.3
            ...
            @NotNull
            public final Long invoke(T t) {
                return Long.valueOf(DelayKt.m5716toDelayMillisLRDsOJo(function1.invoke(t).getRawValue()));
            }
        });
    }
    ...
    public static final ReceiveChannel<Unit> fixedPeriodTicker(@NotNull CoroutineScope coroutineScope, long j, long j2) {
        ...
        if (j2 >= 0) {
            return ProduceKt.produce$default(coroutineScope, null, 0, new C10483(j2, j, null), 1, null);
        }
    ...
    public static final <T> Flow<T> sample(@NotNull Flow<? extends T> flow, long j) {
        if (j > 0) {
            return FlowCoroutineKt.scopedFlow(new C10492(j, flow, null));
        }
    ...
    public static final <T> Flow<T> m5758sampleHG0u8IE(@NotNull Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m5716toDelayMillisLRDsOJo(j));
    }
