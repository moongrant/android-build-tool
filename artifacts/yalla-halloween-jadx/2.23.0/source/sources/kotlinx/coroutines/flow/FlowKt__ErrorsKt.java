...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt", f = "Errors.kt", i = {0}, l = {Constants.ERR_PUBLISH_STREAM_FORMAT_NOT_SUPPORTED}, m = "catchImpl", n = {"fromDownstream"}, s = {"L$0"})
    ...
    public static final class AnonymousClass2<T> implements FlowCollector {
        ...
        public static final class C10501 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
            int label;

            public C10501(Continuation<? super C10501> continuation) {
            ...
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                return new C10501(continuation);
            }
            ...
            public final Object invoke(@NotNull Throwable th, @Nullable Continuation<? super Boolean> continuation) {
                return ((C10501) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
            }
        }
        ...
        public static final <T> Flow<T> m5761catch(@NotNull Flow<? extends T> flow, @NotNull Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        ...
        public static final <T> Flow<T> retry(@NotNull Flow<? extends T> flow, long j, @NotNull Function2<? super Throwable, ? super Continuation<? super Boolean>, ? extends Object> function2) {
            ...
            throw new IllegalArgumentException(androidx.compose.ui.input.key.OooO00o.OooO00o("Expected positive amount of retries, but had ", j).toString());
        }
