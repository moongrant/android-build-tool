...
final /* synthetic */ class FlowKt__ReduceKt {
    ...
    public static final class C10551<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C10551(Continuation<? super C10551> continuation) {
            super(continuation);
        }
    ...
    @Metadata(k = 3, mv = {1, 6, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", f = "Reduce.kt", i = {0, 0}, l = {183}, m = "firstOrNull", n = {ReportItem.QualityKeyResult, "collector$iv"}, s = {"L$0", "L$1"})
    public static final class C10563<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C10563(Continuation<? super C10563> continuation) {
            super(continuation);
        }
    ...
    public static final class C10571<T, R> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    public static final class C10581<T> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        public C10581(Continuation<? super C10581> continuation) {
            super(continuation);
        }
    ...
    public static final class C10601<T> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        public C10601(Continuation<? super C10601> continuation) {
            super(continuation);
        }
    ...
    public static final class C10621<S, T extends S> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    public static final class C10632<T> implements FlowCollector {
        final /* synthetic */ Ref.ObjectRef<Object> $accumulator;
        final /* synthetic */ Function3<S, T, Continuation<? super S>, Object> $operation;

        /* JADX WARN: Multi-variable type inference failed */
        public C10632(Ref.ObjectRef<Object> objectRef, Function3<? super S, ? super T, ? super Continuation<? super S>, ? extends Object> function3) {
            this.$accumulator = objectRef;
            this.$operation = function3;
        }
    ...
    public static final class C10641<T> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        public C10641(Continuation<? super C10641> continuation) {
            super(continuation);
        }
    ...
    public static final class C10661<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C10661(Continuation<? super C10661> continuation) {
            super(continuation);
        }
    ...
    public static final <T> Object firstOrNull(@NotNull Flow<? extends T> flow, @NotNull Continuation<? super T> continuation) {
        ...
        AbortFlowException e;
        FlowCollector<T> flowCollector;
        if (continuation instanceof C10551) {
            c10551 = (C10551) continuation;
            int i = c10551.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c10551.label = i - Integer.MIN_VALUE;
            } else {
                c10551 = new C10551(continuation);
            }
        } else {
            c10551 = new C10551(continuation);
        }
        Object obj = c10551.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c10551.label;
        if (i2 == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            try {
                c10551.L$0 = objectRef2;
                c10551.L$1 = flowCollector2;
                c10551.label = 1;
                if (flow.collect(flowCollector2, c10551) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            } catch (AbortFlowException e2) {
            ...
            flowCollector = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$1) c10551.L$1;
            objectRef = (Ref.ObjectRef) c10551.L$0;
            try {
                ResultKt.throwOnFailure(obj);
            } catch (AbortFlowException e3) {
                e = e3;
    ...
    public static final <T, R> Object fold(@NotNull Flow<? extends T> flow, R r, @NotNull Function3<? super R, ? super T, ? super Continuation<? super R>, ? extends Object> function3, @NotNull Continuation<? super R> continuation) {
        ...
        if (continuation instanceof C10571) {
            ...
            int i = c10571.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c10571.label = i - Integer.MIN_VALUE;
            } else {
        ...
        if (i2 == 0) {
            ...
            c10571.L$0 = objectRef2;
            c10571.label = 1;
            if (flow.collect(anonymousClass2, c10571) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c10571.L$0;
            ResultKt.throwOnFailure(obj);
        }
        return objectRef.element;
    }
    ...
    public static final <T> Object last(@NotNull Flow<? extends T> flow, @NotNull Continuation<? super T> continuation) {
        C10581 c10581;
        Ref.ObjectRef objectRef;
        if (continuation instanceof C10581) {
            c10581 = (C10581) continuation;
            int i = c10581.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c10581.label = i - Integer.MIN_VALUE;
            } else {
                c10581 = new C10581(continuation);
            }
        } else {
            c10581 = new C10581(continuation);
        }
        Object obj = c10581.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c10581.label;
        if (i2 == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            c10581.L$0 = objectRef2;
            c10581.label = 1;
            if (flow.collect(flowCollector, c10581) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c10581.L$0;
            ResultKt.throwOnFailure(obj);
        }
        T t = objectRef.element;
        if (t != NullSurrogateKt.NULL) {
    ...
    public static final <T> Object lastOrNull(@NotNull Flow<? extends T> flow, @NotNull Continuation<? super T> continuation) {
        ...
        if (continuation instanceof C10601) {
            ...
            int i = c10601.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c10601.label = i - Integer.MIN_VALUE;
            } else {
        ...
        if (i2 == 0) {
            ...
            c10601.L$0 = objectRef2;
            c10601.label = 1;
            if (flow.collect(flowCollector, c10601) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c10601.L$0;
            ResultKt.throwOnFailure(obj);
        }
        return objectRef.element;
    }
    ...
    public static final <S, T extends S> Object reduce(@NotNull Flow<? extends T> flow, @NotNull Function3<? super S, ? super T, ? super Continuation<? super S>, ? extends Object> function3, @NotNull Continuation<? super S> continuation) {
        C10621 c10621;
        Ref.ObjectRef objectRef;
        if (continuation instanceof C10621) {
            c10621 = (C10621) continuation;
            int i = c10621.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c10621.label = i - Integer.MIN_VALUE;
            } else {
                c10621 = new C10621(continuation);
            }
        } else {
            c10621 = new C10621(continuation);
        }
        Object obj = c10621.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c10621.label;
        if (i2 == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            FlowCollector<? super Object> c10632 = new C10632<>(objectRef2, function3);
            c10621.L$0 = objectRef2;
            c10621.label = 1;
            if (flow.collect(c10632, c10621) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c10621.L$0;
            ResultKt.throwOnFailure(obj);
        }
        T t = objectRef.element;
        if (t != NullSurrogateKt.NULL) {
    ...
    public static final <T> Object single(@NotNull Flow<? extends T> flow, @NotNull Continuation<? super T> continuation) {
        ...
        if (continuation instanceof C10641) {
            ...
            int i = c10641.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c10641.label = i - Integer.MIN_VALUE;
            } else {
        ...
        if (i2 == 0) {
            ...
            c10641.L$0 = objectRef2;
            c10641.label = 1;
            if (flow.collect(flowCollector, c10641) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c10641.L$0;
            ResultKt.throwOnFailure(obj);
        }
        T t = objectRef.element;
        if (t != NullSurrogateKt.NULL) {
    ...
    public static final <T> Object singleOrNull(@NotNull Flow<? extends T> flow, @NotNull Continuation<? super T> continuation) {
        ...
        if (continuation instanceof C10661) {
            ...
            int i = c10661.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c10661.label = i - Integer.MIN_VALUE;
            } else {
        ...
        if (i2 == 0) {
            ...
            try {
                c10661.L$0 = objectRef2;
                c10661.L$1 = flowCollector2;
                c10661.label = 1;
                if (flow.collect(flowCollector2, c10661) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            } catch (AbortFlowException e2) {
            ...
            flowCollector = (FlowKt__ReduceKt$singleOrNull$$inlined$collectWhile$1) c10661.L$1;
            objectRef = (Ref.ObjectRef) c10661.L$0;
            try {
                ResultKt.throwOnFailure(obj);
            } catch (AbortFlowException e3) {
                e = e3;
    ...
    public static final <T> Object firstOrNull(@NotNull Flow<? extends T> flow, @NotNull Function2<? super T, ? super Continuation<? super Boolean>, ? extends Object> function2, @NotNull Continuation<? super T> continuation) {
        ...
        AbortFlowException e;
        FlowCollector<? super Object> flowCollector;
        if (continuation instanceof C10563) {
            c10563 = (C10563) continuation;
            int i = c10563.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c10563.label = i - Integer.MIN_VALUE;
            } else {
                c10563 = new C10563(continuation);
            }
        } else {
            c10563 = new C10563(continuation);
        }
        Object obj = c10563.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c10563.label;
        if (i2 == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            try {
                c10563.L$0 = objectRef2;
                c10563.L$1 = flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2;
                c10563.label = 1;
                if (flow.collect(flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2, c10563) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            } catch (AbortFlowException e2) {
            ...
            flowCollector = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2) c10563.L$1;
            objectRef = (Ref.ObjectRef) c10563.L$0;
            try {
                ResultKt.throwOnFailure(obj);
            } catch (AbortFlowException e3) {
                e = e3;
