...
final class StateFlowSlot extends AbstractSharedFlowSlot<StateFlowImpl<?>> {
    ...
    @Nullable
    public final Object awaitPending(@NotNull Continuation<? super Unit> continuation) throws Throwable {
        boolean z = true;
    ...
    public final void makePending() {
        while (true) {
            ...
            if (obj == StateFlowKt.NONE) {
                ...
                if (z) {
                    Result.Companion companion = Result.INSTANCE;
                    ((CancellableContinuationImpl) obj).resumeWith(Result.m4213constructorimpl(Unit.INSTANCE));
                    return;
                }
            }
        }
