...
public final class SelectBuilderImpl<R> extends LockFreeLinkedListHead implements SelectBuilder<R>, SelectInstance<R>, Continuation<R>, CoroutineStackFrame {
    ...
    public static final class AtomicSelectOp extends AtomicOp<Object> {
        ...
        public String toString() {
            return Oooo000.OooO0OO(new StringBuilder("AtomicSelectOp(sequence="), getOpSequence(), ')');
        }
    }
    ...
    public final void handleBuilderException(@NotNull Throwable e) {
        if (trySelect()) {
            ...
            resumeWith(Result.m4213constructorimpl(ResultKt.createFailure(e)));
        } else {
        ...
        while (true) {
            ...
            if (obj == SelectKt.UNDECIDED) {
                ...
                if (z) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    continuationIntercepted.resumeWith(Result.m4213constructorimpl(ResultKt.createFailure(exception)));
                    return;
                }
            }
        }
    ...
    public void resumeWith(@NotNull Object result) {
        while (true) {
            ...
            if (obj == SelectKt.UNDECIDED) {
                ...
                if (z) {
                    if (!Result.m4219isFailureimpl(result)) {
                        this.uCont.resumeWith(result);
                        return;
                    }
                    Continuation<R> continuation = this.uCont;
                    Throwable thM4216exceptionOrNullimpl = Result.m4216exceptionOrNullimpl(result);
                    Intrinsics.checkNotNull(thM4216exceptionOrNullimpl);
                    continuation.resumeWith(Result.m4213constructorimpl(ResultKt.createFailure(thM4216exceptionOrNullimpl)));
                    return;
                }
            }
        }
    ...
    public boolean trySelect() {
        ...
        throw new IllegalStateException(Oooo0.OooO0O0("Unexpected trySelectIdempotent result ", objTrySelectOther));
    }
