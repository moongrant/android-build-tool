...
public final class TasksKt {
        ...
        if (task.isComplete()) {
            ...
            task.addOnCompleteListener(DirectExecutor.INSTANCE, new OnCompleteListener() { // from class: kotlinx.coroutines.tasks.OooO00o
                ...
                public final void onComplete(Task task2) {
                    TasksKt.m5789asDeferredImpl$lambda0(completableDeferredCompletableDeferred$default, task2);
                }
            });
        }
    ...
    public static final void m5789asDeferredImpl$lambda0(CompletableDeferred completableDeferred, Task task) {
        Exception exception = task.getException();
        if (exception != null) {
        ...
        task.addOnCompleteListener(DirectExecutor.INSTANCE, new OnCompleteListener() { // from class: kotlinx.coroutines.tasks.TasksKt$awaitImpl$2$1
            ...
            public final void onComplete(@NotNull Task<T> task2) {
                ...
                if (exception2 != null) {
                    ...
                    continuation2.resumeWith(Result.m4213constructorimpl(ResultKt.createFailure(exception2)));
                } else {
                    if (task2.isCanceled()) {
                    ...
                    continuation3.resumeWith(Result.m4213constructorimpl(task2.getResult()));
                }
            }
        });
        if (cancellationTokenSource != null) {
