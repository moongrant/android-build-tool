...
public class SupportHelper implements SupportSQLiteOpenHelper {
    ...
    public SupportHelper(final SupportSQLiteOpenHelper.Configuration configuration, byte[] bArr, SQLiteDatabaseHook sQLiteDatabaseHook, boolean z) {
        SQLiteDatabase.loadLibs(configuration.f7984OooO00o);
        this.passphrase = bArr;
        this.clearPassphrase = z;
        this.standardHelper = new SQLiteOpenHelper(configuration.f7984OooO00o, configuration.f7985OooO0O0, null, configuration.f7986OooO0OO.f7989OooO00o, sQLiteDatabaseHook) { // from class: net.sqlcipher.database.SupportHelper.1
            @Override // net.sqlcipher.database.SQLiteOpenHelper
            public void onConfigure(SQLiteDatabase sQLiteDatabase) {
                configuration.f7986OooO0OO.OooO0O0(sQLiteDatabase);
            }

            @Override // net.sqlcipher.database.SQLiteOpenHelper
            public void onCreate(SQLiteDatabase sQLiteDatabase) {
                configuration.f7986OooO0OO.OooO0OO(sQLiteDatabase);
            }

            @Override // net.sqlcipher.database.SQLiteOpenHelper
            public void onDowngrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
                configuration.f7986OooO0OO.OooO0Oo(sQLiteDatabase, i, i2);
            }
            ...
            public void onUpgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
                configuration.f7986OooO0OO.OooO0o(sQLiteDatabase, i, i2);
            }
        };
    }
