...
public abstract class OooO0OO extends o00O0O {

    public static class OooO extends OooO0OO {

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public boolean f33745OooO0oO = false;
        ...
        public final void OooO0o0(View view, float f) {
            ...
            if (this.f33745OooO0oO) {
                return;
            }
            try {
                method = view.getClass().getMethod("setProgress", Float.TYPE);
            } catch (NoSuchMethodException unused) {
                this.f33745OooO0oO = true;
                method = null;
            }
            if (method != null) {
                try {
    ...
    public static class OooO0O0 extends OooO0OO {
        ...
        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final float[] f33746OooO0oO = new float[1];

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public ConstraintAttribute f33747OooO0oo;

        @Override // p413o0Oo0oo.o00O0O
        public final void OooO0OO(ConstraintAttribute constraintAttribute) {
            this.f33747OooO0oo = constraintAttribute;
        }

        @Override // o000000.OooO0OO
        public final void OooO0o0(View view, float f) {
            float fOooO00o = OooO00o(f);
            float[] fArr = this.f33746OooO0oO;
            fArr[0] = fOooO00o;
            o000000.OooO00o.OooO0O0(this.f33747OooO0oo, view, fArr);
        }
    }

    /* JADX INFO: renamed from: o000000.OooO0OO$OooO0OO, reason: collision with other inner class name */
    public static class C0390OooO0OO extends OooO0OO {
        @Override // o000000.OooO0OO
        public final void OooO0o0(View view, float f) {
