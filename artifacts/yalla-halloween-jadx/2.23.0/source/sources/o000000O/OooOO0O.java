...
public final class OooOO0O {
    ...
    public static final HashMap<String, Constructor<? extends OooO0o>> f33791OooO0O0;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final HashMap<Integer, ArrayList<OooO0o>> f33792OooO00o = new HashMap<>();
    ...
    public final void OooO00o(Oooo0 oooo0) {
        Integer numValueOf = Integer.valueOf(oooo0.f33863OooO0OO);
        HashMap<Integer, ArrayList<OooO0o>> map = this.f33792OooO00o;
        ...
        if (arrayList2 != null) {
            for (OooO0o oooO0o : arrayList2) {
                String str = ((ConstraintLayout.LayoutParams) oooo0.f33862OooO0O0.getLayoutParams()).f4971OoooOo0;
                String str2 = oooO0o.f33769OooO0OO;
    ...
    public final void OooO0O0(OooO0o oooO0o) {
        Integer numValueOf = Integer.valueOf(oooO0o.f33768OooO0O0);
        HashMap<Integer, ArrayList<OooO0o>> map = this.f33792OooO00o;
        if (!map.containsKey(numValueOf)) {
            map.put(Integer.valueOf(oooO0o.f33768OooO0O0), new ArrayList<>());
        }
        ArrayList<OooO0o> arrayList = map.get(Integer.valueOf(oooO0o.f33768OooO0O0));
        if (arrayList != null) {
        ...
        try {
            ...
            while (eventType != 1) {
                if (eventType != 2) {
                    ...
                    HashMap<String, Constructor<? extends OooO0o>> map3 = f33791OooO0O0;
                    if (map3.containsKey(name)) {
                        ...
                        if (oooO0o != null && (map2 = oooO0o.f33770OooO0Oo) != null) {
                            ConstraintAttribute.OooO0Oo(context, xmlResourceParser, map2);
                        }
                    } else if (name.equalsIgnoreCase("CustomMethod") && oooO0o != null && (map = oooO0o.f33770OooO0Oo) != null) {
