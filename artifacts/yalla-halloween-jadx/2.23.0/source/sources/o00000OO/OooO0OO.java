...
public interface OooO0OO extends IInterface {
    ...
    public static final String f33986OooO0OO = "androidx$core$app$unusedapprestrictions$IUnusedAppRestrictionsBackportService".replace(Typography.dollar, '.');

    public static abstract class OooO00o extends Binder implements OooO0OO {
        public OooO00o() {
            attachInterface(this, OooO0OO.f33986OooO0OO);
        }
        ...
        public final boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            OooO0O0 oooO00o;
            String str = OooO0OO.f33986OooO0OO;
            if (i >= 1 && i <= 16777215) {
            ...
            if (strongBinder == null) {
                ...
                IInterface iInterfaceQueryLocalInterface = strongBinder.queryLocalInterface(OooO0O0.f33985OooO0O0);
