...
public final class OooO {
    ...
    public static final OooO0o f34046OooO00o = new OooO0o(0);
    ...
    public static OooOo OooO00o(@NonNull Context context, @NonNull OooOO0 oooOO1) throws PackageManager.NameNotFoundException {
        ...
        String str = oooOO1.f34054OooO00o;
        ...
        String str3 = oooOO1.f34055OooO0O0;
        if (!str2.equals(str3)) {
        ...
        OooO0o oooO0o = f34046OooO00o;
        Collections.sort(arrayList, oooO0o);
        List<List<byte[]>> listOooO0O0 = oooOO1.f34057OooO0Oo;
        if (listOooO0O0 == null) {
        ...
        try {
            cursorOooO00o = OooO00o.OooO00o(context.getContentResolver(), uriBuild, new String[]{"_id", "file_id", "font_ttc_index", "font_variation_settings", "font_weight", "font_italic", "result_code"}, "query = ?", new String[]{oooOO1.f34056OooO0OO}, null, null);
