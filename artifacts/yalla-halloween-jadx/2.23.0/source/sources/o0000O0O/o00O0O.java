...
public final class o00O0O implements Spannable {
    ...
    public static final class OooO00o {
        ...
        @NonNull
        public final TextPaint f34103OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        @Nullable
        public final TextDirectionHeuristic f34104OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final int f34105OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final int f34106OooO0Oo;
        ...
        public OooO00o(@NonNull TextPaint textPaint, @NonNull TextDirectionHeuristic textDirectionHeuristic, int i, int i2) {
            ...
            this.f34103OooO00o = textPaint;
            this.f34104OooO0O0 = textDirectionHeuristic;
            this.f34105OooO0OO = i;
            this.f34106OooO0Oo = i2;
        }

        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public final boolean OooO00o(@NonNull OooO00o oooO00o) {
            int i = Build.VERSION.SDK_INT;
            if (this.f34105OooO0OO != oooO00o.f34105OooO0OO || this.f34106OooO0Oo != oooO00o.f34106OooO0Oo) {
                return false;
            }
            TextPaint textPaint = this.f34103OooO00o;
            if (textPaint.getTextSize() != oooO00o.f34103OooO00o.getTextSize()) {
                return false;
            }
            float textScaleX = textPaint.getTextScaleX();
            TextPaint textPaint2 = oooO00o.f34103OooO00o;
        ...
        public final boolean equals(@Nullable Object obj) {
            ...
            return OooO00o(oooO00o) && this.f34104OooO0O0 == oooO00o.f34104OooO0O0;
        }

        public final int hashCode() {
            int i = Build.VERSION.SDK_INT;
            int i2 = this.f34106OooO0Oo;
            int i3 = this.f34105OooO0OO;
            TextDirectionHeuristic textDirectionHeuristic = this.f34104OooO0O0;
            TextPaint textPaint = this.f34103OooO00o;
        ...
        public final String toString() {
            ...
            sb.append(", textDir=" + this.f34104OooO0O0);
            sb.append(", breakStrategy=" + this.f34105OooO0OO);
            sb.append(", hyphenationFrequency=" + this.f34106OooO0Oo);
            sb.append("}");
            return sb.toString();
        }
        ...
        public OooO00o(@NonNull PrecomputedText.Params params) {
            this.f34103OooO00o = params.getTextPaint();
            this.f34104OooO0O0 = params.getTextDirection();
            this.f34105OooO0OO = params.getBreakStrategy();
            this.f34106OooO0Oo = params.getHyphenationFrequency();
        }
    }
}
