...
public abstract class o0000O00 {
    ...
    @NotNull
    public final ReentrantLock f34375OooO00o = new ReentrantLock(true);

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public final MutableStateFlow<List<NavBackStackEntry>> f34376OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @NotNull
    public final MutableStateFlow<Set<NavBackStackEntry>> f34377OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public boolean f34378OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @NotNull
    public final StateFlow<Set<NavBackStackEntry>> f34379OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @NotNull
    public final StateFlow<List<NavBackStackEntry>> f34380OooO0o0;

    public o0000O00() {
        MutableStateFlow<List<NavBackStackEntry>> MutableStateFlow = StateFlowKt.MutableStateFlow(CollectionsKt.emptyList());
        this.f34376OooO0O0 = MutableStateFlow;
        MutableStateFlow<Set<NavBackStackEntry>> MutableStateFlow2 = StateFlowKt.MutableStateFlow(SetsKt.emptySet());
        this.f34377OooO0OO = MutableStateFlow2;
        this.f34380OooO0o0 = FlowKt.asStateFlow(MutableStateFlow);
        this.f34379OooO0o = FlowKt.asStateFlow(MutableStateFlow2);
    }
    ...
    public void OooO0O0(@NotNull NavBackStackEntry entry) {
        ...
        MutableStateFlow<Set<NavBackStackEntry>> mutableStateFlow = this.f34377OooO0OO;
    ...
    public void OooO0OO(@NotNull NavBackStackEntry popUpTo, boolean z) {
        ...
        ReentrantLock reentrantLock = this.f34375OooO00o;
        reentrantLock.lock();
        try {
            MutableStateFlow<List<NavBackStackEntry>> mutableStateFlow = this.f34376OooO0O0;
    ...
    public void OooO0Oo(@NotNull NavBackStackEntry popUpTo, boolean z) {
        ...
        StateFlow<List<NavBackStackEntry>> stateFlow = this.f34380OooO0o0;
        if (z2) {
