...
public final class o0Oo0oo extends SupportSQLiteOpenHelper.OooO00o {

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @Nullable
    public OooO f34808OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @NotNull
    public final OooO00o f34809OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public final String f34810OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @NotNull
    public final String f34811OooO0o0;
    ...
    public static abstract class OooO00o {
        ...
        @JvmField
        public final int f34812OooO00o;

        public OooO00o(int i) {
            this.f34812OooO00o = i;
        }
    ...
    public static class OooO0O0 {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        @JvmField
        public final boolean f34813OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        @JvmField
        @Nullable
        public final String f34814OooO0O0;

        public OooO0O0(boolean z, @Nullable String str) {
            this.f34813OooO00o = z;
            this.f34814OooO0O0 = str;
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0Oo0oo(@NotNull OooO configuration, @NotNull OooO00o delegate, @NotNull String identityHash, @NotNull String legacyHash) {
        super(delegate.f34812OooO00o);
        Intrinsics.checkNotNullParameter(configuration, "configuration");
        Intrinsics.checkNotNullParameter(delegate, "delegate");
        Intrinsics.checkNotNullParameter(identityHash, "identityHash");
        Intrinsics.checkNotNullParameter(legacyHash, "legacyHash");
        this.f34808OooO0O0 = configuration;
        this.f34809OooO0OO = delegate;
        this.f34810OooO0Oo = identityHash;
        this.f34811OooO0o0 = legacyHash;
    }
    ...
    public final void OooO0OO(@NotNull SupportSQLiteDatabase db) {
        ...
        try {
            ...
            OooO00o oooO00o = this.f34809OooO0OO;
            oooO00o.OooO00o(db);
            if (!z) {
                OooO0O0 oooO0O0OooO0oO = oooO00o.OooO0oO(db);
                if (!oooO0O0OooO0oO.f34813OooO00o) {
                    throw new IllegalStateException("Pre-packaged database has an invalid schema: " + oooO0O0OooO0oO.f34814OooO0O0);
                }
            }
            OooO0oO(db);
            oooO00o.OooO0OO(db);
    ...
    public final void OooO0o(@NotNull SupportSQLiteDatabase db, int i, int i2) {
        ...
        boolean z2;
        Intrinsics.checkNotNullParameter(db, "db");
        OooO oooO = this.f34808OooO0O0;
        OooO00o oooO00o = this.f34809OooO0OO;
        boolean z3 = false;
        if (oooO != null) {
            RoomDatabase.OooO0OO oooO0OO = oooO.f34692OooO0Oo;
            oooO0OO.getClass();
            if (i != i2) {
                boolean z4 = i2 > i;
                ...
                while (true) {
                    ...
                    TreeMap treeMap = (TreeMap) oooO0OO.f7912OooO00o.get(Integer.valueOf(iIntValue));
                    if (treeMap != null) {
            ...
            if (listEmptyList != null) {
                ...
                while (it2.hasNext()) {
                    ((o00000O0) it2.next()).OooO00o(db);
                }
                OooO0O0 oooO0O0OooO0oO = oooO00o.OooO0oO(db);
                if (!oooO0O0OooO0oO.f34813OooO00o) {
                    throw new IllegalStateException("Migration didn't properly handle: " + oooO0O0OooO0oO.f34814OooO0O0);
                }
                oooO00o.OooO0o0();
                OooO0oO(db);
                z3 = true;
        ...
        OooO oooO2 = this.f34808OooO0O0;
        if (oooO2 == null || oooO2.OooO00o(i, i2)) {
    ...
    public final void OooO0o0(@NotNull SupportSQLiteDatabase db) {
        ...
        try {
            ...
            OooO00o oooO00o = this.f34809OooO0OO;
            if (z) {
                Cursor cursorQuery2 = db.query(new p422o0OoO0o.OooOOOO("SELECT identity_hash FROM room_master_table WHERE id = 42 LIMIT 1"));
                try {
                    String string = cursorQuery2.moveToFirst() ? cursorQuery2.getString(0) : null;
                    CloseableKt.closeFinally(cursorQuery2, null);
                    String str = this.f34810OooO0Oo;
                    if (!Intrinsics.areEqual(str, string) && !Intrinsics.areEqual(this.f34811OooO0o0, string)) {
                        throw new IllegalStateException(p031OoooO0.o00Ooo.OooO00o("Room cannot verify the data integrity. Looks like you've changed schema but forgot to update the version number. You can simply fix this by increasing the version number. Expected identity hash: ", str, ", found: ", string));
                    }
                } catch (Throwable th) {
                    try {
                        throw th;
    ...
    public final void OooO0oO(SupportSQLiteDatabase supportSQLiteDatabase) {
        ...
        String hash = this.f34810OooO0Oo;
