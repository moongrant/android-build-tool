...
public final class OooO0o extends Lambda implements Function1<Long, Boolean> {
    ...
    public final /* synthetic */ OooO0OO f36081OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ int f36082OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooO0o(OooO0OO oooO0OO, int i) {
        super(1);
        this.f36081OooO0Oo = oooO0OO;
        this.f36082OooO0o0 = i;
    }
    ...
    public final Boolean invoke(Long l) {
        ...
        OooO0OO oooO0OO = this.f36081OooO0Oo;
        com.airbnb.lottie.OooOO0 composition = oooO0OO.getComposition();
        boolean z = true;
        if (composition != null) {
            MutableState mutableState = oooO0OO.f36054OooOO0O;
            ...
            MutableState mutableState2 = oooO0OO.f36050OooO0o0;
            if (fOooO0Oo < 0.0f) {
                ...
                MutableState mutableState3 = oooO0OO.f36049OooO0o;
                int i2 = this.f36082OooO0o0;
                if (iOooO0o0 > i2) {
                    mutableState2.setValue(Float.valueOf(((Number) oooO0OO.f36055OooOO0o.getValue()).floatValue()));
