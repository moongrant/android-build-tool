...
public interface OooOOO {
    ...
    public static final class OooO00o implements OooOOO {
        ...
        @NotNull
        public final String f36083OooO00o = "lottie/guide_send_gift.json";

        public final boolean equals(Object obj) {
            if (obj instanceof OooO00o) {
                return Intrinsics.areEqual(this.f36083OooO00o, ((OooO00o) obj).f36083OooO00o);
            }
            return false;
        }

        public final int hashCode() {
            return this.f36083OooO00o.hashCode();
        }

        public final String toString() {
            return "Asset(assetName=" + this.f36083OooO00o + ')';
        }
    }
