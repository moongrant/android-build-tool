...
public final class o00Oo0 {
    ...
    public static final Object OooO0O0(Context context, OooOOO oooOOO, String str, String str2, String str3, String str4, Continuation continuation) throws Throwable {
        ...
        if (continuation instanceof o000oOoO) {
            ...
            int i = o000oooo2.f36104OooO;
            if ((i & Integer.MIN_VALUE) != 0) {
                o000oooo2.f36104OooO = i - Integer.MIN_VALUE;
            } else {
        ...
        Object result = o000oooo2.f36109OooO0oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = o000oooo2.f36104OooO;
        if (i2 != 0) {
            if (i2 == 1) {
                str7 = (String) o000oooo2.f36108OooO0oO;
                String str9 = o000oooo2.f36106OooO0o;
                String str10 = o000oooo2.f36107OooO0o0;
                context2 = (Context) o000oooo2.f36105OooO0Oo;
                ResultKt.throwOnFailure(result);
                str6 = str9;
                str5 = str10;
            } else if (i2 == 2) {
                oooOO1 = (com.airbnb.lottie.OooOO0) o000oooo2.f36108OooO0oO;
                str8 = o000oooo2.f36106OooO0o;
                str6 = o000oooo2.f36107OooO0o0;
                Context context3 = (Context) o000oooo2.f36105OooO0Oo;
                ResultKt.throwOnFailure(result);
                context2 = context3;
                o000oooo2.f36105OooO0Oo = oooOO1;
                o000oooo2.f36107OooO0o0 = null;
                o000oooo2.f36106OooO0o = null;
                o000oooo2.f36108OooO0oO = null;
                o000oooo2.f36104OooO = 3;
                if (!oooOO1.f8728OooO0o0.isEmpty() || (objWithContext2 = BuildersKt.withContext(Dispatchers.getIO(), new Oooo000(context2, oooOO1, str6, str8, null), o000oooo2)) != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                }
                ...
                oooOO1 = (com.airbnb.lottie.OooOO0) o000oooo2.f36105OooO0Oo;
                ResultKt.throwOnFailure(result);
            }
            return oooOO1;
        }
        ...
        o000oooo2.f36105OooO0Oo = context;
        str5 = str;
        o000oooo2.f36107OooO0o0 = str5;
        str6 = str2;
        o000oooo2.f36106OooO0o = str6;
        o000oooo2.f36108OooO0oO = str3;
        o000oooo2.f36104OooO = 1;
        ...
        o000oooo2.f36105OooO0Oo = context2;
        o000oooo2.f36107OooO0o0 = str6;
        o000oooo2.f36106OooO0o = str7;
        o000oooo2.f36108OooO0oO = oooOO2;
        o000oooo2.f36104OooO = 2;
        if (!(!oooOO2.f8726OooO0Oo.isEmpty()) || (objWithContext = BuildersKt.withContext(Dispatchers.getIO(), new Oooo0(context2, oooOO2, str5, null), o000oooo2)) != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
        ...
        o000oooo2.f36108OooO0oO = null;
        o000oooo2.f36104OooO = 3;
        objWithContext2 = !oooOO1.f8728OooO0o0.isEmpty() ? Unit.INSTANCE : Unit.INSTANCE;
        if (objWithContext2 == coroutine_suspended) {
            return coroutine_suspended;
        }
        return oooOO1;
    ...
    public static final o00oO0o<com.airbnb.lottie.OooOO0> OooO0OO(Context context, OooOOO oooOOO, String str, boolean z) {
        ...
        if (oooOOO instanceof OooOOO.OooO0O0) {
            ...
            return StringsKt.OooOO0O(null, "zip") ? com.airbnb.lottie.OooOO0O.OooO00o(null, new com.airbnb.lottie.Oooo000(new ZipInputStream(fileInputStream))) : com.airbnb.lottie.OooOO0O.OooO00o(null, new com.airbnb.lottie.OooOo00(fileInputStream));
        }
        ...
        if (!Intrinsics.areEqual(str, "__LottieInternalDefaultCacheKey__")) {
            String str2 = ((OooOOO.OooO00o) oooOOO).f36083OooO00o;
            HashMap map = com.airbnb.lottie.OooOO0O.f8737OooO00o;
            return com.airbnb.lottie.OooOO0O.OooO00o(null, new com.airbnb.lottie.OooOOO(context.getApplicationContext(), str2, null));
        }
        String str3 = ((OooOOO.OooO00o) oooOOO).f36083OooO00o;
        HashMap map2 = com.airbnb.lottie.OooOO0O.f8737OooO00o;
