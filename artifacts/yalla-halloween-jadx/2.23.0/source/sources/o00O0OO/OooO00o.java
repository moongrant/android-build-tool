...
public final class OooO00o {
    ...
    public static final HashMap<String, String> f36533OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final HashMap<String, Boolean> f36534OooO0O0;
    ...
    public static boolean OooO0O0(Context context, Uri uri) throws Throwable {
        ...
        String filePath = OooOOO0.OooO0O0(context, uri);
                    ...
                    try {
                        if (Build.VERSION.SDK_INT >= 29) {
                            ...
                            if (objArr == true) {
                                ...
                                it = f36533OooO00o.keySet().iterator();
                                while (it.hasNext()) {
                                ...
                                if (f36534OooO0O0.containsKey(strSubstring.toLowerCase())) {
                                    bool = Boolean.TRUE;
                                }
                            ...
                            try {
                                ...
                                Uri uriOooO0OO = OooOOO0.OooO0OO(context, filePath, true);
