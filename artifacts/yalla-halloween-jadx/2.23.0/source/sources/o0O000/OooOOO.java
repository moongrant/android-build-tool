...
public final class OooOOO {
    ...
    public final Oooo000<String, OooOOOO> f41579OooO00o = new Oooo000<>();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final Oooo000<String, PropertyValuesHolder[]> f41580OooO0O0 = new Oooo000<>();
    ...
    public static OooOOO OooO0OO(@NonNull ArrayList arrayList) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if ((interpolator instanceof AccelerateDecelerateInterpolator) || interpolator == null) {
                interpolator = OooO0O0.f41572OooO0O0;
            } else if (interpolator instanceof AccelerateInterpolator) {
                interpolator = OooO0O0.f41573OooO0OO;
            } else if (interpolator instanceof DecelerateInterpolator) {
                interpolator = OooO0O0.f41574OooO0Oo;
            }
            OooOOOO oooOOOO = new OooOOOO(startDelay, duration, interpolator);
            oooOOOO.f41587OooO0Oo = objectAnimator.getRepeatCount();
            oooOOOO.f41588OooO0o0 = objectAnimator.getRepeatMode();
            oooOOO.f41579OooO00o.put(propertyName, oooOOOO);
        }
        return oooOOO;
    }
    ...
    public final OooOOOO OooO0o(String str) {
        Oooo000<String, OooOOOO> oooo000 = this.f41579OooO00o;
        if (oooo000.getOrDefault(str, null) != null) {
            return oooo000.getOrDefault(str, null);
        }
    ...
    public final PropertyValuesHolder[] OooO0o0(String str) {
        ...
        PropertyValuesHolder[] orDefault = this.f41580OooO0O0.getOrDefault(str, null);
    ...
    public final boolean OooO0oO(String str) {
        return this.f41580OooO0O0.getOrDefault(str, null) != null;
    }

    public final void OooO0oo(String str, PropertyValuesHolder[] propertyValuesHolderArr) {
        this.f41580OooO0O0.put(str, propertyValuesHolderArr);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof OooOOO) {
            return this.f41579OooO00o.equals(((OooOOO) obj).f41579OooO00o);
        }
        return false;
    }

    public final int hashCode() {
        return this.f41579OooO00o.hashCode();
    }

    @NonNull
    public final String toString() {
        return "\n" + OooOOO.class.getName() + '{' + Integer.toHexString(System.identityHashCode(this)) + " timings: " + this.f41579OooO00o + "}\n";
    }
}
