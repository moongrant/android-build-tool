...
public final class oo0o0Oo extends LifecycleCallback {
    ...
    public final ArrayList f41650OooO0o0;

    public oo0o0Oo(LifecycleFragment lifecycleFragment) {
        super(lifecycleFragment);
        this.f41650OooO0o0 = new ArrayList();
    ...
    public final void OooO0OO(o00oO0o o00oo0o2) {
        synchronized (this.f41650OooO0o0) {
            this.f41650OooO0o0.add(new WeakReference(o00oo0o2));
        }
    }
    ...
    public final void onStop() {
        synchronized (this.f41650OooO0o0) {
            Iterator it = this.f41650OooO0o0.iterator();
            while (it.hasNext()) {
