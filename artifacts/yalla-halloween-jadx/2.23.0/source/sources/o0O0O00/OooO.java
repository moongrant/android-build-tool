...
public final class OooO {
    ...
    public final androidx.constraintlayout.core.widgets.OooO0o f41836OooO00o;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final androidx.constraintlayout.core.widgets.OooO0o f41839OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public OooO0O0.InterfaceC0449OooO0O0 f41840OooO0o;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final OooO0O0.OooO00o f41842OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final ArrayList<Oooo000> f41843OooO0oo;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public boolean f41837OooO0O0 = true;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public boolean f41838OooO0OO = true;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final ArrayList<o0OoOo0> f41841OooO0o0 = new ArrayList<>();

    public OooO(androidx.constraintlayout.core.widgets.OooO0o oooO0o) {
        new ArrayList();
        this.f41840OooO0o = null;
        this.f41842OooO0oO = new OooO0O0.OooO00o();
        this.f41843OooO0oo = new ArrayList<>();
        this.f41836OooO00o = oooO0o;
        this.f41839OooO0Oo = oooO0o;
    }
    ...
    public final void OooO00o(OooOO0 oooOO1, int i, int i2, ArrayList arrayList, Oooo000 oooo000) {
        ...
        if (o0oooo0.f41889OooO0OO == null) {
            androidx.constraintlayout.core.widgets.OooO0o oooO0o = this.f41836OooO00o;
            if (o0oooo0 == oooO0o.f4338OooO0Oo || o0oooo0 == oooO0o.f4340OooO0o0) {
                return;
            }
            if (oooo000 == null) {
                oooo000 = new Oooo000(o0oooo0);
                arrayList.add(oooo000);
            }
            o0oooo0.f41889OooO0OO = oooo000;
            oooo000.f41879OooO0O0.add(o0oooo0);
            OooOO0 oooOO2 = o0oooo0.f41894OooO0oo;
            for (OooO0o oooO0o2 : oooOO2.f41869OooOO0O) {
                if (oooO0o2 instanceof OooOO0) {
                    OooO00o((OooOO0) oooO0o2, i, 0, arrayList, oooo000);
                }
            }
            OooOO0 oooOO3 = o0oooo0.f41886OooO;
            for (OooO0o oooO0o3 : oooOO3.f41869OooOO0O) {
                if (oooO0o3 instanceof OooOO0) {
                    OooO00o((OooOO0) oooO0o3, i, 1, arrayList, oooo000);
                }
            }
            if (i == 1 && (o0oooo0 instanceof Oooo0)) {
                for (OooO0o oooO0o4 : ((Oooo0) o0oooo0).f41875OooOO0O.f41869OooOO0O) {
                    if (oooO0o4 instanceof OooOO0) {
                        OooO00o((OooOO0) oooO0o4, i, 2, arrayList, oooo000);
                    }
                }
            }
            Iterator it = oooOO2.f41870OooOO0o.iterator();
            while (it.hasNext()) {
                OooO00o((OooOO0) it.next(), i, 0, arrayList, oooo000);
            }
            Iterator it2 = oooOO3.f41870OooOO0o.iterator();
            while (it2.hasNext()) {
                OooO00o((OooOO0) it2.next(), i, 1, arrayList, oooo000);
            }
            if (i == 1 && (o0oooo0 instanceof Oooo0)) {
                Iterator it3 = ((Oooo0) o0oooo0).f41875OooOO0O.f41870OooOO0o.iterator();
                while (it3.hasNext()) {
    ...
    public final void OooO0O0(androidx.constraintlayout.core.widgets.OooO0o oooO0o) {
        ...
        for (ConstraintWidget constraintWidget : oooO0o.f60905o0OOO0o) {
            ...
            if (constraintWidget.f4403o0OoOo0 == 8) {
                constraintWidget.f4335OooO00o = true;
            } else {
                float f = constraintWidget.f4359OooOoO0;
                if (f < 1.0f && dimensionBehaviour4 == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
                    constraintWidget.f4355OooOo00 = 2;
                }
                float f2 = constraintWidget.f4362OooOoo0;
                if (f2 < 1.0f && dimensionBehaviour5 == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
                    constraintWidget.f4354OooOo0 = 2;
                }
                if (constraintWidget.f4385OoooOoo > 0.0f) {
                    ...
                    if (dimensionBehaviour4 == dimensionBehaviour6 && (dimensionBehaviour5 == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT || dimensionBehaviour5 == ConstraintWidget.DimensionBehaviour.FIXED)) {
                        constraintWidget.f4355OooOo00 = 3;
                        ...
                        constraintWidget.f4354OooOo0 = 3;
                    } else if (dimensionBehaviour4 == dimensionBehaviour6 && dimensionBehaviour5 == dimensionBehaviour6) {
                        if (constraintWidget.f4355OooOo00 == 0) {
                            constraintWidget.f4355OooOo00 = 3;
                        }
                        if (constraintWidget.f4354OooOo0 == 0) {
                            constraintWidget.f4354OooOo0 = 3;
                        }
                    }
                }
                ...
                if (dimensionBehaviour4 == dimensionBehaviour7 && constraintWidget.f4355OooOo00 == 1 && (constraintAnchor2.f4329OooO0o == null || constraintAnchor.f4329OooO0o == null)) {
                    dimensionBehaviour4 = ConstraintWidget.DimensionBehaviour.WRAP_CONTENT;
                }
                ConstraintAnchor constraintAnchor3 = constraintWidget.f4375Oooo0oo;
                ConstraintAnchor constraintAnchor4 = constraintWidget.f4372Oooo0o;
                if (dimensionBehaviour5 == dimensionBehaviour7 && constraintWidget.f4354OooOo0 == 1 && (constraintAnchor4.f4329OooO0o == null || constraintAnchor3.f4329OooO0o == null)) {
                    dimensionBehaviour5 = ConstraintWidget.DimensionBehaviour.WRAP_CONTENT;
                }
                ConstraintWidget.DimensionBehaviour dimensionBehaviour8 = dimensionBehaviour5;
                OooOo oooOo = constraintWidget.f4338OooO0Oo;
                oooOo.f41890OooO0Oo = dimensionBehaviour4;
                int i2 = constraintWidget.f4355OooOo00;
                oooOo.f41887OooO00o = i2;
                Oooo0 oooo0 = constraintWidget.f4340OooO0o0;
                oooo0.f41890OooO0Oo = dimensionBehaviour8;
                int i3 = constraintWidget.f4354OooOo0;
                oooo0.f41887OooO00o = i3;
                ...
                if ((dimensionBehaviour4 == dimensionBehaviour9 || dimensionBehaviour4 == ConstraintWidget.DimensionBehaviour.FIXED || dimensionBehaviour4 == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) && (dimensionBehaviour8 == dimensionBehaviour9 || dimensionBehaviour8 == ConstraintWidget.DimensionBehaviour.FIXED || dimensionBehaviour8 == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT)) {
                    ...
                    if (dimensionBehaviour4 == dimensionBehaviour9) {
                        iOooOo0O = (oooO0o.OooOo0O() - constraintAnchor2.f4331OooO0oO) - constraintAnchor.f4331OooO0oO;
                        dimensionBehaviour4 = ConstraintWidget.DimensionBehaviour.FIXED;
                    }
                    int iOooOOOo = constraintWidget.OooOOOo();
                    if (dimensionBehaviour8 == dimensionBehaviour9) {
                        int iOooOOOo2 = (oooO0o.OooOOOo() - constraintAnchor4.f4331OooO0oO) - constraintAnchor3.f4331OooO0oO;
                    ...
                    constraintWidget.f4338OooO0Oo.f41892OooO0o0.OooO0Oo(constraintWidget.OooOo0O());
                    constraintWidget.f4340OooO0o0.f41892OooO0o0.OooO0Oo(constraintWidget.OooOOOo());
                    constraintWidget.f4335OooO00o = true;
                } else {
                    ConstraintAnchor[] constraintAnchorArr = constraintWidget.f4376OoooO;
                    if (dimensionBehaviour4 != dimensionBehaviour7 || (dimensionBehaviour8 != (dimensionBehaviour3 = ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) && dimensionBehaviour8 != ConstraintWidget.DimensionBehaviour.FIXED)) {
                        ...
                        if (dimensionBehaviour != dimensionBehaviour7 && (dimensionBehaviour4 == (dimensionBehaviour2 = ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) || dimensionBehaviour4 == ConstraintWidget.DimensionBehaviour.FIXED)) {
                            if (i3 == 3) {
                                ...
                                float f3 = constraintWidget.f4385OoooOoo;
                                ...
                                constraintWidget.f4340OooO0o0.f41892OooO0o0.f41871OooOOO0 = constraintWidget.OooOOOo();
                            } else if (i3 == 2) {
                                ConstraintWidget.DimensionBehaviour dimensionBehaviour11 = oooO0o.f4381OoooOOO[1];
                            ...
                            } else if (constraintAnchorArr[2].f4329OooO0o == null || constraintAnchorArr[3].f4329OooO0o == null) {
                        ...
                        if (dimensionBehaviour4 != dimensionBehaviour7 && dimensionBehaviour == dimensionBehaviour7) {
                            if (i2 == 1 || i3 == 1) {
                                ...
                                constraintWidget.f4338OooO0Oo.f41892OooO0o0.f41871OooOOO0 = constraintWidget.OooOo0O();
                                constraintWidget.f4340OooO0o0.f41892OooO0o0.f41871OooOOO0 = constraintWidget.OooOOOo();
                            } else if (i3 == 2 && i2 == 2) {
                        ...
                        int i4 = (int) ((iOooOOOo3 * constraintWidget.f4385OoooOoo) + 0.5f);
                        ...
                        dimensionBehaviour = dimensionBehaviour8;
                        if (i2 == 2) {
                            ConstraintWidget.DimensionBehaviour dimensionBehaviour17 = oooO0o.f4381OoooOOO[0];
                        ...
                        } else if (constraintAnchorArr[0].f4329OooO0o == null || constraintAnchorArr[1].f4329OooO0o == null) {
    ...
    public final void OooO0OO() {
        ArrayList<o0OoOo0> arrayList = this.f41841OooO0o0;
        arrayList.clear();
        androidx.constraintlayout.core.widgets.OooO0o oooO0o = this.f41839OooO0Oo;
        oooO0o.f4338OooO0Oo.OooO0o();
        oooO0o.f4340OooO0o0.OooO0o();
        arrayList.add(oooO0o.f4338OooO0Oo);
        arrayList.add(oooO0o.f4340OooO0o0);
        ...
        for (ConstraintWidget constraintWidget : oooO0o.f60905o0OOO0o) {
            if (constraintWidget instanceof androidx.constraintlayout.core.widgets.OooOO0) {
                ...
                if (constraintWidget.OooOoo()) {
                    if (constraintWidget.f4336OooO0O0 == null) {
                        constraintWidget.f4336OooO0O0 = new OooO0OO(0, constraintWidget);
                    }
                    if (hashSet == null) {
                        hashSet = new HashSet();
                    }
                    hashSet.add(constraintWidget.f4336OooO0O0);
                } else {
                    arrayList.add(constraintWidget.f4338OooO0Oo);
                }
                if (constraintWidget.OooOooO()) {
                    if (constraintWidget.f4337OooO0OO == null) {
                        constraintWidget.f4337OooO0OO = new OooO0OO(1, constraintWidget);
                    }
                    if (hashSet == null) {
                        hashSet = new HashSet();
                    }
                    hashSet.add(constraintWidget.f4337OooO0OO);
                } else {
                    arrayList.add(constraintWidget.f4340OooO0o0);
                }
        ...
        for (o0OoOo0 o0oooo0 : arrayList) {
            if (o0oooo0.f41888OooO0O0 != oooO0o) {
                o0oooo0.OooO0Oo();
            }
        }
        ArrayList<Oooo000> arrayList2 = this.f41843OooO0oo;
        arrayList2.clear();
        androidx.constraintlayout.core.widgets.OooO0o oooO0o2 = this.f41836OooO00o;
        OooO0o0(oooO0o2.f4338OooO0Oo, 0, arrayList2);
        OooO0o0(oooO0o2.f4340OooO0o0, 1, arrayList2);
        this.f41837OooO0O0 = false;
    }
    ...
    public final int OooO0Oo(androidx.constraintlayout.core.widgets.OooO0o oooO0o, int i) {
        ...
        long jMax2 = 0;
        while (i3 < size) {
            o0OoOo0 o0oooo0 = arrayList2.get(i3).f41878OooO00o;
            if (!(o0oooo0 instanceof OooO0OO) ? !(i != 0 ? (o0oooo0 instanceof Oooo0) : (o0oooo0 instanceof OooOo)) : ((OooO0OO) o0oooo0).f41891OooO0o != i) {
                OooOO0 oooOO1 = (i == 0 ? oooO0o.f4338OooO0Oo : oooO0o.f4340OooO0o0).f41894OooO0oo;
                OooOO0 oooOO2 = (i == 0 ? oooO0o.f4338OooO0Oo : oooO0o.f4340OooO0o0).f41886OooO;
                boolean zContains = o0oooo0.f41894OooO0oo.f41870OooOO0o.contains(oooOO1);
                OooOO0 oooOO3 = o0oooo0.f41886OooO;
                boolean zContains2 = oooOO3.f41870OooOO0o.contains(oooOO2);
                long jOooOO1 = o0oooo0.OooOO0();
                OooOO0 oooOO4 = o0oooo0.f41894OooO0oo;
                if (zContains && zContains2) {
                    long jOooO0O0 = Oooo000.OooO0O0(oooOO4, 0L);
                    long jOooO00o = Oooo000.OooO00o(oooOO3, 0L);
                    long j2 = jOooO0O0 - jOooOO1;
                    int i4 = oooOO3.f41864OooO0o;
                    ...
                    long j5 = oooOO4.f41864OooO0o;
                    long j6 = j4 - j5;
                    if (j6 >= j5) {
                        j6 -= j5;
                    }
                    ConstraintWidget constraintWidget = o0oooo0.f41888OooO0O0;
                    if (i == 0) {
                        f = constraintWidget.f4391Oooooo;
                    } else if (i == 1) {
                        f = constraintWidget.f4393OoooooO;
                    } else {
                    ...
                    float f2 = j;
                    jOooOO0 = (((long) oooOO4.f41864OooO0o) + ((((long) ((f2 * f) + 0.5f)) + jOooOO1) + ((long) OooOo.OooO0o.OooO00o(1.0f, f, f2, 0.5f)))) - ((long) oooOO3.f41864OooO0o);
                } else {
                    arrayList = arrayList2;
                    i2 = size;
                    if (zContains) {
                        jMax = Math.max(Oooo000.OooO0O0(oooOO4, oooOO4.f41864OooO0o), ((long) oooOO4.f41864OooO0o) + jOooOO1);
                    } else if (zContains2) {
                        jMax = Math.max(-Oooo000.OooO00o(oooOO3, oooOO3.f41864OooO0o), ((long) (-oooOO3.f41864OooO0o)) + jOooOO1);
                    } else {
                        jOooOO0 = (o0oooo0.OooOO0() + ((long) oooOO4.f41864OooO0o)) - ((long) oooOO3.f41864OooO0o);
                    }
                    jOooOO0 = jMax;
                }
            } else {
    ...
    public final void OooO0o(ConstraintWidget constraintWidget, ConstraintWidget.DimensionBehaviour dimensionBehaviour, int i, ConstraintWidget.DimensionBehaviour dimensionBehaviour2, int i2) {
        OooO0O0.OooO00o oooO00o = this.f41842OooO0oO;
        ...
        this.f41840OooO0o.OooO0O0(constraintWidget, oooO00o);
    ...
    public final void OooO0o0(o0OoOo0 o0oooo0, int i, ArrayList<Oooo000> arrayList) {
        OooOO0 oooOO1;
        Iterator it = o0oooo0.f41894OooO0oo.f41869OooOO0O.iterator();
        while (true) {
            boolean zHasNext = it.hasNext();
            oooOO1 = o0oooo0.f41886OooO;
            if (!zHasNext) {
                break;
            }
            ...
            if (oooO0o instanceof OooOO0) {
                ...
                OooO00o(((o0OoOo0) oooO0o).f41894OooO0oo, i, 0, arrayList, null);
            }
        }
        for (OooO0o oooO0o2 : oooOO1.f41869OooOO0O) {
            if (oooO0o2 instanceof OooOO0) {
                OooO00o((OooOO0) oooO0o2, i, 1, arrayList, null);
            } else if (oooO0o2 instanceof o0OoOo0) {
                OooO00o(((o0OoOo0) oooO0o2).f41886OooO, i, 1, arrayList, null);
            }
        }
        if (i == 1) {
            for (OooO0o oooO0o3 : ((Oooo0) o0oooo0).f41875OooOO0O.f41869OooOO0O) {
                if (oooO0o3 instanceof OooOO0) {
    ...
    public final void OooO0oO() {
        OooO00o oooO00o;
        for (ConstraintWidget constraintWidget : this.f41836OooO00o.f60905o0OOO0o) {
            if (!constraintWidget.f4335OooO00o) {
                ConstraintWidget.DimensionBehaviour[] dimensionBehaviourArr = constraintWidget.f4381OoooOOO;
                boolean z = false;
                ConstraintWidget.DimensionBehaviour dimensionBehaviour = dimensionBehaviourArr[0];
                ConstraintWidget.DimensionBehaviour dimensionBehaviour2 = dimensionBehaviourArr[1];
                int i = constraintWidget.f4355OooOo00;
                ...
                OooOO0O oooOO0O = constraintWidget.f4338OooO0Oo.f41892OooO0o0;
                boolean z3 = oooOO0O.f41868OooOO0;
                OooOO0O oooOO0O2 = constraintWidget.f4340OooO0o0.f41892OooO0o0;
                boolean z4 = oooOO0O2.f41868OooOO0;
                if (z3 && z4) {
                    ConstraintWidget.DimensionBehaviour dimensionBehaviour4 = ConstraintWidget.DimensionBehaviour.FIXED;
                    OooO0o(constraintWidget, dimensionBehaviour4, oooOO0O.f41866OooO0oO, dimensionBehaviour4, oooOO0O2.f41866OooO0oO);
                    constraintWidget.f4335OooO00o = true;
                } else if (z3 && z) {
                    OooO0o(constraintWidget, ConstraintWidget.DimensionBehaviour.FIXED, oooOO0O.f41866OooO0oO, dimensionBehaviour3, oooOO0O2.f41866OooO0oO);
                    ...
                    OooO0o(constraintWidget, dimensionBehaviour3, oooOO0O.f41866OooO0oO, ConstraintWidget.DimensionBehaviour.FIXED, oooOO0O2.f41866OooO0oO);
                ...
                if (constraintWidget.f4335OooO00o && (oooO00o = constraintWidget.f4340OooO0o0.f41876OooOO0o) != null) {
                    oooO00o.OooO0Oo(constraintWidget.f4389OooooOO);
                }
            }
        }
    }
