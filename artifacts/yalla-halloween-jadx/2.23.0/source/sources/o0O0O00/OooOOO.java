...
public final class OooOOO {
    public static o000oOoO OooO00o(ConstraintWidget constraintWidget, int i, ArrayList<o000oOoO> arrayList, o000oOoO o000oooo2) {
        boolean z;
        int i2;
        int i3 = i == 0 ? constraintWidget.f4405o0ooOOo : constraintWidget.f4406o0ooOoO;
        if (i3 != -1 && (o000oooo2 == null || i3 != o000oooo2.f41882OooO0O0)) {
            for (int i4 = 0; i4 < arrayList.size(); i4++) {
                o000oOoO o000oooo3 = arrayList.get(i4);
                if (o000oooo3.f41882OooO0O0 == i3) {
                    if (o000oooo2 != null) {
        ...
        if (o000oooo2 == null) {
            if (constraintWidget instanceof oo0o0Oo.OooO0O0) {
                ...
                int i5 = 0;
                while (true) {
                    if (i5 >= oooO0O0.f60904o0Oo0oo) {
                        i2 = -1;
                        break;
                    }
                    ConstraintWidget constraintWidget2 = oooO0O0.f60903o0OOO0o[i5];
                    if ((i == 0 && (i2 = constraintWidget2.f4405o0ooOOo) != -1) || (i == 1 && (i2 = constraintWidget2.f4406o0ooOoO) != -1)) {
                        break;
                    }
                    i5++;
                }
        ...
        if (z) {
            if (constraintWidget instanceof androidx.constraintlayout.core.widgets.OooOO0) {
                ...
                oooOO1.f4501oo0o0Oo.OooO0OO(oooOO1.f4497o0O0O00 == 0 ? 1 : 0, o000oooo2, arrayList);
            }
            int i7 = o000oooo2.f41882OooO0O0;
            if (i == 0) {
                constraintWidget.f4405o0ooOOo = i7;
                constraintWidget.f4373Oooo0o0.OooO0OO(i, o000oooo2, arrayList);
                constraintWidget.f4374Oooo0oO.OooO0OO(i, o000oooo2, arrayList);
            } else {
                constraintWidget.f4406o0ooOoO = i7;
                constraintWidget.f4372Oooo0o.OooO0OO(i, o000oooo2, arrayList);
                constraintWidget.f4365Oooo.OooO0OO(i, o000oooo2, arrayList);
                constraintWidget.f4375Oooo0oo.OooO0OO(i, o000oooo2, arrayList);
            }
            constraintWidget.f4379OoooO0O.OooO0OO(i, o000oooo2, arrayList);
        }
        return o000oooo2;
    }
