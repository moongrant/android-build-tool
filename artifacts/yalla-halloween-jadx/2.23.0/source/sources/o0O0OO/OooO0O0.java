...
public final class OooO0O0 {
    ...
    public static final zzjb f41977OooO00o = zzjb.zzi("_in", "_xa", "_xu", "_aq", "_aa", "_ai", "_ac", "campaign_details", "_ug", "_iapx", "_exp_set", "_exp_clear", "_exp_activate", "_exp_timeout", "_exp_expire");

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final zzja f41978OooO0O0 = zzja.zzj("_e", "_f", "_iap", "_s", "_au", "_ui", "_cd");

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final zzja f41979OooO0OO = zzja.zzi(DebugKt.DEBUG_PROPERTY_VALUE_AUTO, "app", "am");

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public static final zzja f41980OooO0Oo = zzja.zzh("_r", "_dbg");

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public static final zzja f41981OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public static final zzja f41982OooO0o0;

    static {
        zzix zzixVar = new zzix();
        zzixVar.zza(zzhe.zza);
        zzixVar.zza(zzhe.zzb);
        f41982OooO0o0 = zzixVar.zzb();
        f41981OooO0o = zzja.zzh("^_ltv_[A-Z]{3}$", "^_cc[1-5]{1}$");
    }
    ...
    public static boolean OooO0OO(String str) {
        return !f41979OooO0OO.contains(str);
    }
    ...
    public static boolean OooO0Oo(String str, String str2) {
        ...
        if (f41982OooO0o0.contains(str2)) {
            return false;
        }
        zzja zzjaVar = f41981OooO0o;
        int size = zzjaVar.size();
        int i = 0;
        while (i < size) {
