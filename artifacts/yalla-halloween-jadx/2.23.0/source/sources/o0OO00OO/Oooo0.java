...
public abstract class Oooo0 implements o0o0Oo {
    ...
    public o0OO000.OooO0O0 OooO00o(String str, BarcodeFormat barcodeFormat, EnumMap enumMap) throws WriterException {
        if (str.isEmpty()) {
        ...
        o0OO000.OooO0O0 oooO0O0 = new o0OO000.OooO0O0(iMax, iMax2);
        int i4 = 0;
        while (i4 < length) {
            if (zArrOooO0OO[i4]) {
