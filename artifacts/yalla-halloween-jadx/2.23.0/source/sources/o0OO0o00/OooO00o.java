...
public final class OooO00o {
    ...
    @NotNull
    public static final Set<String> f43194OooO00o = SetsKt.setOf((Object[]) new String[]{"android.permission.ACCESS_BACKGROUND_LOCATION", "android.permission.SYSTEM_ALERT_WINDOW", "android.permission.WRITE_SETTINGS", "android.permission.MANAGE_EXTERNAL_STORAGE", "android.permission.REQUEST_INSTALL_PACKAGES"});

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @TargetApi(29)
    @NotNull
    public static final Map<String, String> f43195OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @TargetApi(30)
    @NotNull
    public static final Map<String, String> f43196OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @TargetApi(31)
    @NotNull
    public static final Map<String, String> f43197OooO0Oo;
    ...
    static {
        ...
        f43195OooO0O0 = mapMapOf;
        f43196OooO0OO = mapMapOf;
        ...
        f43197OooO0Oo = MapsKt.toMap(mutableMap);
    }
}
