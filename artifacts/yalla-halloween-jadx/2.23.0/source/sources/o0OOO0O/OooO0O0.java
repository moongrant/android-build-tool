...
public final class OooO0O0 extends o0OOO0O.OooO00o {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    @NotNull
    public MediaPlayer f43570OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public final MediaMetadataRetriever f43571OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @NotNull
    public String f43572OooO0OO;
    ...
    public static final class OooO00o implements MediaPlayer.OnCompletionListener {
        ...
        public final void onCompletion(MediaPlayer mediaPlayer) {
            o0OOO0O.OooO0OO.OooO00o completionListener = OooO0O0.this.getCompletionListener();
    ...
    /* JADX INFO: renamed from: o0OOO0O.OooO0O0$OooO0O0, reason: collision with other inner class name */
    public static final class C0457OooO0O0 implements MediaPlayer.OnPreparedListener {
        public C0457OooO0O0() {
        }

        @Override // android.media.MediaPlayer.OnPreparedListener
        public final void onPrepared(MediaPlayer mediaPlayer) {
            o0OOO0O.OooO0OO.OooO0o preparedListener = OooO0O0.this.getPreparedListener();
    ...
    public static final class OooO0OO implements MediaPlayer.OnErrorListener {
        ...
        public final boolean onError(MediaPlayer mediaPlayer, int i, int i2) {
            o0OOO0O.OooO0OO.OooO0O0 errorListener = OooO0O0.this.getErrorListener();
    ...
    public static final class OooO0o implements MediaPlayer.OnInfoListener {
        ...
        public final boolean onInfo(MediaPlayer mediaPlayer, int i, int i2) {
            o0OOO0O.OooO0OO.InterfaceC0458OooO0OO firstFrameListener;
    ...
    public OooO0O0() {
        super(null, 1, null);
        this.f43571OooO0O0 = new MediaMetadataRetriever();
    }

    @Override // o0OOO0O.OooO0OO
    @NotNull
    public final o0OOO0O0.OooO0O0 getVideoInfo() throws Exception {
        String str = this.f43572OooO0OO;
        if (str == null) {
        ...
        MediaMetadataRetriever mediaMetadataRetriever = this.f43571OooO0O0;
        String str2 = this.f43572OooO0OO;
        if (str2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("dataPath");
        }
        ...
        return new o0OOO0O0.OooO0O0(i, Integer.parseInt(strExtractMetadata4));
    }

    @Override // o0OOO0O.OooO0OO
    public final void initMediaPlayer() {
        MediaPlayer mediaPlayer = new MediaPlayer();
        this.f43570OooO00o = mediaPlayer;
        mediaPlayer.setOnCompletionListener(new OooO00o());
        MediaPlayer mediaPlayer2 = this.f43570OooO00o;
        if (mediaPlayer2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("mediaPlayer");
        }
        mediaPlayer2.setOnPreparedListener(new C0457OooO0O0());
        MediaPlayer mediaPlayer3 = this.f43570OooO00o;
        if (mediaPlayer3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("mediaPlayer");
        }
        mediaPlayer3.setOnErrorListener(new OooO0OO());
        MediaPlayer mediaPlayer4 = this.f43570OooO00o;
    ...
    public final void pause() {
        MediaPlayer mediaPlayer = this.f43570OooO00o;
        if (mediaPlayer == null) {
            Intrinsics.throwUninitializedPropertyAccessException("mediaPlayer");
        }
        mediaPlayer.pause();
