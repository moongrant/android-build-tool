...
public final class Cookie {
    ...
    public static final class Companion {
        ...
        public static boolean OooO0O0(String str, String str2) {
            ...
            if (StringsKt.OooOO0O(str, str2) && str.charAt((str.length() - str2.length()) - 1) == '.') {
                byte[] bArr = o0O000o0.f57386OooO00o;
                Intrinsics.checkNotNullParameter(str, "<this>");
                if (!o0O000o0.f57390OooO0o.matches(str)) {
                    return true;
                }
            }
            return false;
        ...
        @JvmStatic
        @Nullable
        public static Cookie OooO0OO(@NotNull o00OO url, @NotNull String setCookie) {
            long j;
            String str;
            ...
            Intrinsics.checkNotNullParameter(setCookie, "setCookie");
            char c = ';';
            int iOooO0oO = o0O000o0.OooO0oO(setCookie, ';', 0, 0, 6);
            char c2 = '=';
            int iOooO0oO2 = o0O000o0.OooO0oO(setCookie, '=', 0, iOooO0oO, 2);
            if (iOooO0oO2 != iOooO0oO) {
                String strOooOoO = o0O000o0.OooOoO(0, iOooO0oO2, setCookie);
                if (!(strOooOoO.length() == 0) && o0O000o0.OooOOO0(strOooOoO) == -1) {
                    String strOooOoO2 = o0O000o0.OooOoO(iOooO0oO2 + 1, iOooO0oO, setCookie);
                    if (o0O000o0.OooOOO0(strOooOoO2) == -1) {
                        int i = iOooO0oO + 1;
                        ...
                        while (true) {
                            ...
                            if (i >= length) {
                                ...
                                if (str4.length() != str3.length() && PublicSuffixDatabase.f60857OooO0oO.OooO00o(str3) == null) {
                                    break;
                                }
                                String strSubstring = "/";
                                if (str2 == null || !StringsKt.Oooo00o(str2, "/")) {
                            ...
                            int iOooO0o = o0O000o0.OooO0o(setCookie, c, i, length);
                            int iOooO0o2 = o0O000o0.OooO0o(setCookie, c2, i, iOooO0o);
                            String strOooOoO3 = o0O000o0.OooOoO(i, iOooO0o2, setCookie);
                            String strOooOoO4 = iOooO0o2 < iOooO0o ? o0O000o0.OooOoO(iOooO0o2 + 1, iOooO0o, setCookie) : "";
                            if (StringsKt.OooOO0o(strOooOoO3, "expires")) {
                                try {
                                    jOooO0o0 = OooO0o0(strOooOoO4.length(), strOooOoO4);
                                    z3 = true;
                                } catch (NumberFormatException | IllegalArgumentException unused) {
                                }
                            } else if (StringsKt.OooOO0o(strOooOoO3, "max-age")) {
                                try {
                                    ...
                                    if (StringsKt.Oooo00o(strOooOoO4, "-")) {
                                        j3 = Long.MIN_VALUE;
                                    }
                                    j2 = j3;
                                }
                                z3 = true;
                            } else if (StringsKt.OooOO0o(strOooOoO3, "domain")) {
                                if (!(!StringsKt.OooOO0O(strOooOoO4, "."))) {
                                    throw new IllegalArgumentException("Failed requirement.".toString());
                                }
                                String strOooO0O1 = o0O000O.OooO0O0(StringsKt.removePrefix(strOooOoO4, (CharSequence) "."));
                                if (strOooO0O1 == null) {
                                    throw new IllegalArgumentException();
                                }
                                str3 = strOooO0O1;
                                z4 = false;
                            } else if (StringsKt.OooOO0o(strOooOoO3, "path")) {
                                str2 = strOooOoO4;
                            } else if (StringsKt.OooOO0o(strOooOoO3, "secure")) {
                                z = true;
                            } else if (StringsKt.OooOO0o(strOooOoO3, "httponly")) {
                                z2 = true;
                            }
                            i = iOooO0o + 1;
                            c = ';';
        ...
        @JvmStatic
        @NotNull
        public static List OooO0Oo(@NotNull o00OO url, @NotNull oo0O headers) {
            List listEmptyList;
            Intrinsics.checkNotNullParameter(url, "url");
            ...
            while (i2 < length) {
                int i3 = i2 + 1;
                if (StringsKt.OooOO0o("Set-Cookie", headers.OooO0OO(i2))) {
                    if (arrayList2 == null) {
        ...
        public static long OooO0o0(int i, String str) {
            ...
            GregorianCalendar gregorianCalendar = new GregorianCalendar(o0O000o0.f57391OooO0o0);
    ...
    @JvmStatic
    @Nullable
    public static final Cookie parse(@NotNull o00OO o00oo2, @NotNull String str) {
        INSTANCE.getClass();
        return Companion.OooO0OO(o00oo2, str);
    }

    @JvmStatic
    @NotNull
    public static final List<Cookie> parseAll(@NotNull o00OO o00oo2, @NotNull oo0O oo0o) {
        INSTANCE.getClass();
        return Companion.OooO0Oo(o00oo2, oo0o);
    }
    ...
    public int hashCode() {
        int iOooO00o = o0OO00O.OooO00o(this.value, o0OO00O.OooO00o(this.name, 527, 31), 31);
        long j = this.expiresAt;
        return ((((((o0OO00O.OooO00o(this.path, o0OO00O.OooO00o(this.domain, (iOooO00o + ((int) (j ^ (j >>> 32)))) * 31, 31), 31) + (this.secure ? 1231 : 1237)) * 31) + (this.httpOnly ? 1231 : 1237)) * 31) + (this.persistent ? 1231 : 1237)) * 31) + (this.hostOnly ? 1231 : 1237);
    }
    ...
    public final boolean matches(@NotNull o00OO url) {
        boolean zOooO0O0;
        Intrinsics.checkNotNullParameter(url, "url");
        if (this.hostOnly) {
            zOooO0O0 = Intrinsics.areEqual(url.f57206OooO0Oo, this.domain);
        } else {
            Companion companion = INSTANCE;
            String str = url.f57206OooO0Oo;
        ...
        companion2.getClass();
        String strOooO0O0 = url.OooO0O0();
        if (Intrinsics.areEqual(strOooO0O0, str3) || (StringsKt.Oooo00o(strOooO0O0, str3) && (StringsKt.OooOO0O(str3, "/") || strOooO0O0.charAt(str3.length()) == '/'))) {
            return !this.secure || url.f57211OooOO0;
        }
        return false;
    }
    ...
    public final String toString$okhttp(boolean forObsoleteRfc2965) {
        ...
        if (persistent()) {
            if (expiresAt() == Long.MIN_VALUE) {
                ...
                jc.OooO00o oooO00o = jc.f59711OooO00o;
                Intrinsics.checkNotNullParameter(date, "<this>");
                String str = jc.f59711OooO00o.get().format(date);
