...
public final class OpenSSLProvider extends Provider {
    ...
    private void putECDHKeyAgreementImplClass(String str) {
        ...
        String str2 = PREFIX;
        putImplClassWithKeyConstraints("KeyAgreement.ECDH", androidx.camera.core.impl.OooOOOO.OooO00o(str2, str), o0O00o0.OooO0O0(sb, str2, "OpenSSLKeyHolder|java.security.interfaces.ECPrivateKey"), "PKCS#8");
    }
    ...
    private void putMacImplClass(String str, String str2) {
        StringBuilder sb = new StringBuilder();
        String str3 = PREFIX;
        putImplClassWithKeyConstraints(o00O00OO.OooO00o("Mac.", str), androidx.camera.core.impl.OooOOOO.OooO00o(str3, str2), o0O00o0.OooO0O0(sb, str3, "OpenSSLKeyHolder"), "RAW");
    }

    private void putRAWRSASignatureImplClass(String str) {
        StringBuilder sb = new StringBuilder();
        String str2 = PREFIX;
        putImplClassWithKeyConstraints("Signature.NONEwithRSA", androidx.camera.core.impl.OooOOOO.OooO00o(str2, str), androidx.compose.material.OooO00o.OooO0O0(sb, str2, "OpenSSLRSAPrivateKey|java.security.interfaces.RSAPrivateKey|", str2, "OpenSSLRSAPublicKey|java.security.interfaces.RSAPublicKey"), null);
    }

    private void putRSACipherImplClass(String str, String str2) {
        StringBuilder sb = new StringBuilder();
        String str3 = PREFIX;
        putImplClassWithKeyConstraints(o00O00OO.OooO00o("Cipher.", str), androidx.camera.core.impl.OooOOOO.OooO00o(str3, str2), androidx.compose.material.OooO00o.OooO0O0(sb, str3, "OpenSSLRSAPrivateKey|java.security.interfaces.RSAPrivateKey|", str3, "OpenSSLRSAPublicKey|java.security.interfaces.RSAPublicKey"), null);
    }

    private void putSignatureImplClass(String str, String str2) {
        StringBuilder sb = new StringBuilder();
        String str3 = PREFIX;
        putImplClassWithKeyConstraints(o00O00OO.OooO00o("Signature.", str), androidx.camera.core.impl.OooOOOO.OooO00o(str3, str2), o0O00o0.OooO0O0(sb, str3, "OpenSSLKeyHolder|java.security.interfaces.RSAPrivateKey|java.security.interfaces.ECPrivateKey|java.security.interfaces.RSAPublicKey"), "PKCS#8|X.509");
    }

    private void putSymmetricCipherImplClass(String str, String str2) {
        putImplClassWithKeyConstraints(o00O00OO.OooO00o("Cipher.", str), o0O00o0.OooO0O0(new StringBuilder(), PREFIX, str2), null, "RAW");
    }
    ...
    public OpenSSLProvider(String str, boolean z) {
        ...
        StringBuilder sb = new StringBuilder();
        String str2 = PREFIX;
        String strOooO0O0 = o0O00o0.OooO0O0(sb, str2, "OpenSSLContextImpl");
        String str3 = strOooO0O0 + "$TLSv13";
        put("SSLContext.SSL", str3);
        put("SSLContext.TLS", str3);
        put("SSLContext.TLSv1", strOooO0O0 + "$TLSv1");
        put("SSLContext.TLSv1.1", strOooO0O0 + "$TLSv11");
        put("SSLContext.TLSv1.2", strOooO0O0 + "$TLSv12");
        ...
        StringBuilder sbOooO00o = OooOO0O.OooO00o(this, "Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.22", "AES", "Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.42", "AES");
        sbOooO00o.append(str2);
        sbOooO00o.append("IvParameters$ChaCha20");
        put("AlgorithmParameters.ChaCha20", sbOooO00o.toString());
        OooOOO0.OooO00o(new StringBuilder(), str2, "IvParameters$DESEDE", this, "AlgorithmParameters.DESEDE");
        OooOOO0.OooO00o(OooOO0O.OooO00o(this, "Alg.Alias.AlgorithmParameters.TDEA", "DESEDE", "Alg.Alias.AlgorithmParameters.1.2.840.113549.3.7", "DESEDE"), str2, "GCMParameters", this, "AlgorithmParameters.GCM");
        put("Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.6", CodePackage.GCM);
        StringBuilder sbOooO00o2 = OooOO0O.OooO00o(this, "Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.26", CodePackage.GCM, "Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.46", CodePackage.GCM);
        sbOooO00o2.append(str2);
        sbOooO00o2.append("OAEPParameters");
        put("AlgorithmParameters.OAEP", sbOooO00o2.toString());
        put("AlgorithmParameters.PSS", str2 + "PSSParameters");
        put("AlgorithmParameters.EC", str2 + "ECParameters");
        OooOOO0.OooO00o(new StringBuilder(), str2, "OpenSSLMessageDigestJDK$SHA1", this, "MessageDigest.SHA-1");
        put("Alg.Alias.MessageDigest.SHA1", "SHA-1");
        OooOOO0.OooO00o(OooOO0O.OooO00o(this, "Alg.Alias.MessageDigest.SHA", "SHA-1", "Alg.Alias.MessageDigest.1.3.14.3.2.26", "SHA-1"), str2, "OpenSSLMessageDigestJDK$SHA224", this, "MessageDigest.SHA-224");
        OooOOO0.OooO00o(OooOO0O.OooO00o(this, "Alg.Alias.MessageDigest.SHA224", "SHA-224", "Alg.Alias.MessageDigest.2.16.840.1.101.3.4.2.4", "SHA-224"), str2, "OpenSSLMessageDigestJDK$SHA256", this, "MessageDigest.SHA-256");
        OooOOO0.OooO00o(OooOO0O.OooO00o(this, "Alg.Alias.MessageDigest.SHA256", "SHA-256", "Alg.Alias.MessageDigest.2.16.840.1.101.3.4.2.1", "SHA-256"), str2, "OpenSSLMessageDigestJDK$SHA384", this, "MessageDigest.SHA-384");
        OooOOO0.OooO00o(OooOO0O.OooO00o(this, "Alg.Alias.MessageDigest.SHA384", "SHA-384", "Alg.Alias.MessageDigest.2.16.840.1.101.3.4.2.2", "SHA-384"), str2, "OpenSSLMessageDigestJDK$SHA512", this, "MessageDigest.SHA-512");
        OooOOO0.OooO00o(OooOO0O.OooO00o(this, "Alg.Alias.MessageDigest.SHA512", "SHA-512", "Alg.Alias.MessageDigest.2.16.840.1.101.3.4.2.3", "SHA-512"), str2, "OpenSSLMessageDigestJDK$MD5", this, "MessageDigest.MD5");
        put("Alg.Alias.MessageDigest.1.2.840.113549.2.5", "MD5");
        put("KeyGenerator.ARC4", str2 + "KeyGeneratorImpl$ARC4");
        StringBuilder sbOooO00o3 = OooOO0O.OooO00o(this, "Alg.Alias.KeyGenerator.RC4", "ARC4", "Alg.Alias.KeyGenerator.1.2.840.113549.3.4", "ARC4");
        sbOooO00o3.append(str2);
        sbOooO00o3.append("KeyGeneratorImpl$AES");
        put("KeyGenerator.AES", sbOooO00o3.toString());
        put("KeyGenerator.ChaCha20", str2 + "KeyGeneratorImpl$ChaCha20");
        OooOOO0.OooO00o(new StringBuilder(), str2, "KeyGeneratorImpl$DESEDE", this, "KeyGenerator.DESEDE");
        ...
        OooOOO0.OooO00o(OooOO0O.OooO00o(this, "Alg.Alias.KeyGenerator.HMAC-MD5", "HmacMD5", "Alg.Alias.KeyGenerator.HMAC/MD5", "HmacMD5"), str2, "KeyGeneratorImpl$HmacSHA1", this, "KeyGenerator.HmacSHA1");
        put("Alg.Alias.KeyGenerator.1.2.840.113549.2.7", "HmacSHA1");
        put("Alg.Alias.KeyGenerator.1.3.6.1.5.5.8.1.2", "HmacSHA1");
        OooOOO0.OooO00o(OooOO0O.OooO00o(this, "Alg.Alias.KeyGenerator.HMAC-SHA1", "HmacSHA1", "Alg.Alias.KeyGenerator.HMAC/SHA1", "HmacSHA1"), str2, "KeyGeneratorImpl$HmacSHA224", this, "KeyGenerator.HmacSHA224");
        put("Alg.Alias.KeyGenerator.1.2.840.113549.2.8", "HmacSHA224");
        OooOOO0.OooO00o(OooOO0O.OooO00o(this, "Alg.Alias.KeyGenerator.HMAC-SHA224", "HmacSHA224", "Alg.Alias.KeyGenerator.HMAC/SHA224", "HmacSHA224"), str2, "KeyGeneratorImpl$HmacSHA256", this, "KeyGenerator.HmacSHA256");
        put("Alg.Alias.KeyGenerator.1.2.840.113549.2.9", "HmacSHA256");
        put("Alg.Alias.KeyGenerator.2.16.840.1.101.3.4.2.1", "HmacSHA256");
        OooOOO0.OooO00o(OooOO0O.OooO00o(this, "Alg.Alias.KeyGenerator.HMAC-SHA256", "HmacSHA256", "Alg.Alias.KeyGenerator.HMAC/SHA256", "HmacSHA256"), str2, "KeyGeneratorImpl$HmacSHA384", this, "KeyGenerator.HmacSHA384");
        put("Alg.Alias.KeyGenerator.1.2.840.113549.2.10", "HmacSHA384");
        OooOOO0.OooO00o(OooOO0O.OooO00o(this, "Alg.Alias.KeyGenerator.HMAC-SHA384", "HmacSHA384", "Alg.Alias.KeyGenerator.HMAC/SHA384", "HmacSHA384"), str2, "KeyGeneratorImpl$HmacSHA512", this, "KeyGenerator.HmacSHA512");
        put("Alg.Alias.KeyGenerator.1.2.840.113549.2.11", "HmacSHA512");
        OooOOO0.OooO00o(OooOO0O.OooO00o(this, "Alg.Alias.KeyGenerator.HMAC-SHA512", "HmacSHA512", "Alg.Alias.KeyGenerator.HMAC/SHA512", "HmacSHA512"), str2, "OpenSSLRSAKeyPairGenerator", this, "KeyPairGenerator.RSA");
        put("Alg.Alias.KeyPairGenerator.1.2.840.113549.1.1.1", "RSA");
        OooOOO0.OooO00o(OooOO0O.OooO00o(this, "Alg.Alias.KeyPairGenerator.1.2.840.113549.1.1.7", "RSA", "Alg.Alias.KeyPairGenerator.2.5.8.1.1", "RSA"), str2, "OpenSSLECKeyPairGenerator", this, "KeyPairGenerator.EC");
        OooOOO0.OooO00o(OooOO0O.OooO00o(this, "Alg.Alias.KeyPairGenerator.1.2.840.10045.2.1", "EC", "Alg.Alias.KeyPairGenerator.1.3.133.16.840.63.0.2", "EC"), str2, "OpenSSLRSAKeyFactory", this, "KeyFactory.RSA");
        put("Alg.Alias.KeyFactory.1.2.840.113549.1.1.1", "RSA");
        OooOOO0.OooO00o(OooOO0O.OooO00o(this, "Alg.Alias.KeyFactory.1.2.840.113549.1.1.7", "RSA", "Alg.Alias.KeyFactory.2.5.8.1.1", "RSA"), str2, "OpenSSLECKeyFactory", this, "KeyFactory.EC");
        OooOOO0.OooO00o(OooOO0O.OooO00o(this, "Alg.Alias.KeyFactory.1.2.840.10045.2.1", "EC", "Alg.Alias.KeyFactory.1.3.133.16.840.63.0.2", "EC"), str2, "DESEDESecretKeyFactory", this, "SecretKeyFactory.DESEDE");
        ...
        OooOOO0.OooO00o(OooOO0O.OooO00o(this, "Alg.Alias.Mac.HMAC/SHA512", "HmacSHA512", "Alg.Alias.Mac.PBEWITHHMACSHA512", "HmacSHA512"), str2, "OpenSSLX509CertificateFactory", this, "CertificateFactory.X509");
