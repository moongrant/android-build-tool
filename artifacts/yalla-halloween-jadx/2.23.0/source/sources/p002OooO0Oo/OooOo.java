...
public final class OooOo extends oo000o implements OooO00o {
    ...
    public final void OooO0O0(@NotNull String message) {
        ...
        OooOOO oooOOO = this.f114OooO0O0;
    ...
    public final void OooO0o(OooO0o oooO0o) {
        OooOOO oooOOO = this.f114OooO0O0;
        try {
            o00Oo0.OooO00o oooO00o = oooOOO.f136OooO0oo;
            if (oooO00o != null) {
                oooO00o.OooO00o();
            }
            OooOOO0 oooOOO0 = oooOOO.f133OooO0o;
            oooOOO0.getClass();
            Intrinsics.checkNotNullParameter(this, "bizClient");
            oooOOO0.f106OooO0OO = this;
            OooOOO0 oooOOO1 = oooOOO.f133OooO0o;
            Bundle bundleOooO0oO = OooO0oO();
            o0Oo0oo o0oo0oo2 = oooOOO.f132OooO0Oo;
            oooOOO1.OooO0O0(oooO0o, 6, bundleOooO0oO, o0oo0oo2 == null ? null : o0oo0oo2.f144OooO0O0);
        } catch (Exception e) {
    ...
    public final Bundle OooO0oO() {
        ...
        String access_token = oooOo00OooO.f115OooO0OO.getAccess_token();
        if (access_token == null) {
            access_token = "";
        }
        OooOo00 oooOo00OooO2 = oooOOO.OooO0oO();
        Intrinsics.checkNotNull(oooOo00OooO2);
        String open_id = oooOo00OooO2.f115OooO0OO.getOpen_id();
        if (open_id == null) {
            open_id = "";
        }
        OooOo00 oooOo00OooO3 = oooOOO.OooO0oO();
        Intrinsics.checkNotNull(oooOo00OooO3);
        String target_open_id = oooOo00OooO3.f115OooO0OO.getTarget_open_id();
        if (target_open_id == null) {
            target_open_id = "";
        }
        OooOo00 oooOo00OooO4 = oooOOO.OooO0oO();
        Intrinsics.checkNotNull(oooOo00OooO4);
        String third_party_nick_name = oooOo00OooO4.f115OooO0OO.getThird_party_nick_name();
        ...
        String target_third_party_nick_name = oooOo00OooO5.f115OooO0OO.getTarget_third_party_nick_name();
