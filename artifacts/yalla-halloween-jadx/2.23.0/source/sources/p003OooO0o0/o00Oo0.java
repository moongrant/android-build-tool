...
public abstract class o00Oo0 {
    ...
    @NotNull
    public final OooO0o.OooO00o f129OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @Nullable
    public ArrayList<oo000o> f130OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public int f131OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @Nullable
    public o0Oo0oo f132OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @NotNull
    public final OooOOO0 f133OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public boolean f134OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    @Nullable
    public OooO0O0 f135OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    @Nullable
    public OooO00o f136OooO0oo;
    ...
    public o00Oo0(@NotNull OooO0o.OooO00o fragment) {
        ...
        this.f129OooO00o = fragment;
        this.f131OooO0OO = -1;
        OooOOO0 oooOOO0 = new OooOOO0();
        this.f133OooO0o = oooOOO0;
        ...
        oooOOO0.f104OooO00o = oooO0O0RegisterForActivityResult;
    }
    ...
    public final void OooO0O0() {
        ArrayList<oo000o> arrayList = this.f130OooO0O0;
        if (arrayList != null) {
            Iterator<oo000o> it = arrayList.iterator();
            while (it.hasNext()) {
                it.next().f148OooO00o = Boolean.TRUE;
            }
        }
        this.f134OooO0o0 = true;
    }

    public final void OooO0OO(@NotNull o0Oo0oo request) {
        Intrinsics.checkNotNullParameter(request, "request");
        o0Oo0oo o0oo0oo2 = this.f132OooO0Oo;
        if (o0oo0oo2 != null && this.f131OooO0OO >= 0) {
            return;
        }
        this.f134OooO0o0 = false;
        if (o0oo0oo2 != null) {
            return;
        }
        this.f132OooO0Oo = request;
        this.f130OooO0O0 = OooO0o();
        OooO0oo();
    }
    ...
    public final void OooO0Oo(@NotNull BaseResp response) {
        ...
        this.f130OooO0O0 = null;
        this.f131OooO0OO = -1;
        this.f132OooO0Oo = null;
        if (this.f134OooO0o0 || (oooO0O0 = this.f135OooO0oO) == null) {
            return;
        }
    ...
    public final FragmentActivity OooO0o0() {
        FragmentActivity fragmentActivityRequireActivity = this.f129OooO00o.requireActivity();
    ...
    public final void OooO0oo() {
        ...
        ArrayList<oo000o> arrayList2 = this.f130OooO0O0;
        if (arrayList2 != null) {
            int i = this.f131OooO0OO;
            Intrinsics.checkNotNull(arrayList2);
            if (i < arrayList2.size() - 1) {
                int i2 = this.f131OooO0OO + 1;
                this.f131OooO0OO = i2;
                if (i2 < 0 || (arrayList = this.f130OooO0O0) == null) {
                    oo000oVar = null;
                } else {
                    Intrinsics.checkNotNull(arrayList);
                    if (arrayList.size() > this.f131OooO0OO) {
                        ArrayList<oo000o> arrayList3 = this.f130OooO0O0;
                        Intrinsics.checkNotNull(arrayList3);
                        oo000oVar = arrayList3.get(this.f131OooO0OO);
                    } else {
                        oo000oVar = null;
                    }
                }
                if ((oo000oVar == null ? false : Intrinsics.areEqual(oo000oVar.f148OooO00o, Boolean.TRUE)) || oo000oVar == null) {
                    return;
                }
                oo000oVar.OooO0o0();
            }
