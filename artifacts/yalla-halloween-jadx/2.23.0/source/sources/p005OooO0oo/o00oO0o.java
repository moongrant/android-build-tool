...
public final class o00oO0o extends Oooo000 {
    ...
    public final boolean getCarrier(@NotNull String data) {
        ...
        Object systemService = this.f157OooO00o.getContext().getSystemService("phone");
        if (systemService instanceof TelephonyManager) {
            ...
            if (completion != null) {
                ...
                o0oooo0.OooO0Oo("name", networkOperatorName);
                OooOo00 oooOo00 = new OooOo00();
                oooOo00.f20602OooO0Oo.add(o0oooo0);
                o0OoOo0 o0oooo1 = new o0OoOo0();
                o0oooo1.OooO0OO("carriers", oooOo00);
                OooO0OO(o0oooo1, completion.getCompletion().getFunctionID());
                return true;
            }
        }
        return false;
    ...
    public final boolean getNetworkStatus(@NotNull String data) {
        ...
        Intrinsics.checkNotNullParameter(data, "data");
        Object systemService = this.f157OooO00o.getContext().getSystemService("connectivity");
        ...
        if (activeNetworkInfo == null) {
            ...
            switch (activeNetworkInfo.getSubtype()) {
                ...
                default:
                    ...
                    if (!StringsKt.OooOO0o(subtypeName, "TD-SCDMA") && !StringsKt.OooOO0o(subtypeName, "WCDMA")) {
                        StringsKt.OooOO0o(subtypeName, "CDMA2000");
                    }
                    break;
            }
            netUtil$NetworkType = NetUtil$NetworkType.NETWORK_NO;
        ...
        o0oooo0.OooO0OO(AnalyticsEvents.PARAMETER_SHARE_DIALOG_CONTENT_STATUS, numValueOf == null ? o000oOoO.f20713OooO0Oo : new o00Oo0(numValueOf));
        Integer numValueOf2 = Integer.valueOf(netUtil$NetworkType.getValue());
        o0oooo0.OooO0OO("accessTechnology", numValueOf2 == null ? o000oOoO.f20713OooO0Oo : new o00Oo0(numValueOf2));
    ...
    public final boolean getSystemInfo(@NotNull String data) {
        ...
        o0OoOo0 o0oooo0 = new o0OoOo0();
        o0oooo0.OooO0Oo("name", Constants.OS);
        o0oooo0.OooO0Oo(ServerProtocol.FALLBACK_DIALOG_PARAM_VERSION, String.valueOf(Build.VERSION.SDK_INT));
        OooO0OO(o0oooo0, completion.getCompletion().getFunctionID());
        return true;
    }
}
