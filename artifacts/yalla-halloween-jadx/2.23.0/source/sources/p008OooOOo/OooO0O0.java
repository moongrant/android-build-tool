...
public interface OooO0O0 extends IInterface {
    ...
    public static abstract class OooO00o extends Binder implements OooO0O0 {
        ...
        public static class C0000OooO00o implements OooO0O0 {
            ...
            public final IBinder f201OooO0Oo;

            public C0000OooO00o(IBinder iBinder) {
                this.f201OooO0Oo = iBinder;
            }
            ...
            public final void OooOO0O(Bundle bundle, String str) throws RemoteException {
                ...
                try {
                    ...
                    this.f201OooO0Oo.transact(5, parcelObtain, parcelObtain2, 0);
            ...
            public final void OooOOo0(Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    this.f201OooO0Oo.transact(4, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
                } finally {
                    parcelObtain2.recycle();
                    parcelObtain.recycle();
        ...
        public final boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 4) {
                parcel.enforceInterface("android.support.customtabs.ICustomTabsCallback");
                ((o0OO00O) this).OooOOo0(parcel.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(parcel) : null);
                parcel2.writeNoException();
                return true;
            }
            if (i == 5) {
