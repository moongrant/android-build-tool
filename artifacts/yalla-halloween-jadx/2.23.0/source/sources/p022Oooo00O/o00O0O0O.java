...
public final class o00O0O0O extends CameraCaptureSession.CaptureCallback {
    ...
    public final List<CameraCaptureSession.CaptureCallback> OooO0O0(CaptureRequest captureRequest) {
        List<CameraCaptureSession.CaptureCallback> list = (List) this.f619OooO00o.get(captureRequest);
    ...
    public final void onCaptureBufferLost(@NonNull CameraCaptureSession cameraCaptureSession, @NonNull CaptureRequest captureRequest, @NonNull Surface surface, long j) {
        ...
        while (it.hasNext()) {
            o0OOo000.OooO00o(it.next(), cameraCaptureSession, captureRequest, surface, j);
        }
    }
    ...
    public final void onCaptureSequenceAborted(@NonNull CameraCaptureSession cameraCaptureSession, int i) {
        Iterator it = this.f619OooO00o.values().iterator();
        while (it.hasNext()) {
        ...
        OooO00o oooO00o = this.f620OooO0O0;
        if (oooO00o != null) {
            o00OOO0 o00ooo1 = (o00OOO0) ((oo0O) oooO00o).f904OooO0Oo;
            synchronized (o00ooo1.f629OooO00o) {
                if (o00ooo1.f639OooOO0o == o00OOO0.OooO0o.OPENED) {
                    o00ooo1.OooOO0o(o00ooo1.f635OooO0oO);
                }
            }
        }
    }
