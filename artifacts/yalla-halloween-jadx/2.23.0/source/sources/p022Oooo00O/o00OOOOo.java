...
public final class o00OOOOo {
    ...
    @NonNull
    public final Executor f652OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final Object f653OooO0O0 = new Object();
    ...
    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @GuardedBy("mLock")
    public final LinkedHashSet f655OooO0Oo = new LinkedHashSet();

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @GuardedBy("mLock")
    public final LinkedHashSet f657OooO0o0 = new LinkedHashSet();

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final OooO00o f656OooO0o = new OooO00o();
    ...
    public class OooO00o extends CameraDevice.StateCallback {
        ...
        public final void OooO00o() {
            ...
            synchronized (o00OOOOo.this.f653OooO0O0) {
                arrayListOooO0o0 = o00OOOOo.this.OooO0o0();
                o00OOOOo.this.f657OooO0o0.clear();
                o00OOOOo.this.f654OooO0OO.clear();
                o00OOOOo.this.f655OooO0Oo.clear();
            }
        ...
        public final void OooO0O0() {
            ...
            synchronized (o00OOOOo.this.f653OooO0O0) {
                linkedHashSet.addAll(o00OOOOo.this.f657OooO0o0);
                linkedHashSet.addAll(o00OOOOo.this.f654OooO0OO);
            }
            o00OOOOo.this.f652OooO00o.execute(new Runnable() { // from class: Oooo00O.o00OOOO0
                @Override // java.lang.Runnable
                public final void run() {
                    for (o0oO0O0o o0oo0o0o2 : linkedHashSet) {
    ...
    public final ArrayList OooO0OO() {
        ArrayList arrayList;
        synchronized (this.f653OooO0O0) {
            arrayList = new ArrayList(this.f655OooO0Oo);
        }
        return arrayList;
    }
    ...
    public final ArrayList OooO0Oo() {
        ArrayList arrayList;
        synchronized (this.f653OooO0O0) {
            arrayList = new ArrayList(this.f657OooO0o0);
        }
        return arrayList;
    }
    ...
    public final void OooO0o(@NonNull o0oO0O0o o0oo0o0o2) {
        synchronized (this.f653OooO0O0) {
            this.f657OooO0o0.add(o0oo0o0o2);
        }
    }
