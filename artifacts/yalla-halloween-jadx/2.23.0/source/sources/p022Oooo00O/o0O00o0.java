...
public final class o0O00o0 {
    ...
    public final oO00O0o0 f720OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final OooO f721OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final boolean f722OooO0OO;

    @RequiresApi(33)
    public static final class OooO00o {
        @Nullable
        @DoNotInline
        public static DynamicRange OooO00o(@NonNull oO00O0o0 oo00o0o0) {
            Long l = (Long) oo00o0o0.OooO00o(CameraCharacteristics.REQUEST_RECOMMENDED_TEN_BIT_DYNAMIC_RANGE_PROFILE);
            if (l != null) {
    ...
    public o0O00o0(@NonNull oO00O0o0 oo00o0o0) {
        this.f720OooO00o = oo00o0o0;
        this.f721OooO0O0 = OooO.OooO00o(oo00o0o0);
    ...
    public static boolean OooO00o(@NonNull DynamicRange dynamicRange, @NonNull DynamicRange dynamicRange2) {
        ...
        int i2 = dynamicRange2.f3405OooO00o;
        if (i == 2 && i2 == 1) {
            return false;
        }
        if (i != 2 && i != 0 && i != i2) {
        ...
        int i3 = dynamicRange.f3406OooO0O0;
        return i3 == 0 || i3 == dynamicRange2.f3406OooO0O0;
    }
    ...
    public static DynamicRange OooO0OO(@NonNull DynamicRange dynamicRange, @NonNull LinkedHashSet linkedHashSet, @NonNull HashSet hashSet) {
        if (dynamicRange.f3405OooO00o == 1) {
            return null;
        }
        ...
        while (it.hasNext()) {
            ...
            if (dynamicRange2.f3405OooO00o != 1 && OooO0O0(dynamicRange, dynamicRange2, hashSet)) {
    ...
    public static void OooO0Oo(@NonNull HashSet hashSet, @NonNull DynamicRange dynamicRange, @NonNull OooO oooO) {
        ...
        Set<DynamicRange> setOooO0OO = oooO.f400OooO00o.OooO0OO(dynamicRange);
