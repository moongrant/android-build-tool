...
public final class o0000 {
    ...
    public final o000O000 f1041OooO00o = (o000O000) o0000O.OooO00o(o000O000.class);

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final o000OOo f1042OooO0O0;

    public o0000(@NonNull String str) {
        this.f1042OooO0O0 = new o000OOo(str);
    }
    ...
    public final Size[] OooO00o(@NonNull Size[] sizeArr, int i) {
        ...
        o000OOo o000ooo2 = this.f1042OooO0O0;
        o000ooo2.getClass();
        if (((o0000OO0) o0000O.OooO00o(o0000OO0.class)) == null) {
            listEmptyList = new ArrayList();
        } else {
            String str = Build.BRAND;
            boolean z = "OnePlus".equalsIgnoreCase(str) && "OnePlus6".equalsIgnoreCase(Build.DEVICE);
            String str2 = o000ooo2.f1070OooO00o;
            if (z) {
