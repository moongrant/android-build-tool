...
public final class OooOOOO {
    ...
    public static final Rational f1388OooO00o = new Rational(4, 3);

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final Rational f1389OooO0O0 = new Rational(3, 4);

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final Rational f1390OooO0OO = new Rational(16, 9);

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public static final Rational f1391OooO0Oo = new Rational(9, 16);

    @RequiresApi(21)
    public static final class OooO00o implements Comparator<Rational> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final RectF f1392OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final Rational f1393OooO0o0;

        public OooO00o(@NonNull Rational rational, @Nullable Rational rational2) {
            this.f1393OooO0o0 = rational2 == null ? new Rational(4, 3) : rational2;
            this.f1392OooO0Oo = OooO0O0(rational);
        }
        ...
        public final RectF OooO0O0(Rational rational) {
            ...
            Rational rational2 = this.f1393OooO0o0;
