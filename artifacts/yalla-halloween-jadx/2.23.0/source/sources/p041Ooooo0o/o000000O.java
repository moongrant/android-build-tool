...
public final class o000000O implements o0000O {
    ...
    public static final o000000 f1761OooO0Oo = new o000000();

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public static final Timebase f1762OooO0o0 = Timebase.UPTIME;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final o0000O f1763OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final Function<EncoderProfilesProxy.VideoProfileProxy, EncoderProfilesProxy.VideoProfileProxy> f1764OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final HashMap f1765OooO0OO;

    public o000000O(@NonNull o0000O o0000o2) {
        o000000 o000000Var = f1761OooO0Oo;
        this.f1765OooO0OO = new HashMap();
        this.f1763OooO00o = o0000o2;
        this.f1764OooO0O0 = o000000Var;
    }

    @Override // androidx.camera.core.impl.o0000O
    public final boolean OooO00o(int i) {
        return this.f1763OooO00o.OooO00o(i) && OooO0OO(i) != null;
    }
    ...
    public final EncoderProfilesProxy OooO0OO(int i) {
        ...
        HashMap map = this.f1765OooO0OO;
        if (map.containsKey(Integer.valueOf(i))) {
            return (EncoderProfilesProxy) map.get(Integer.valueOf(i));
        }
        o0000O o0000o2 = this.f1763OooO00o;
        ...
        if (o0000o2.OooO00o(i)) {
            ...
            if (encoderProfilesProxyOooO0O0 != null) {
                ...
                EncoderProfilesProxy.VideoProfileProxy videoProfileProxyApply = this.f1764OooO0O0.apply(oooOO0OOooO00o);
