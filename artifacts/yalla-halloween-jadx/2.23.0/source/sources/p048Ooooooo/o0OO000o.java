...
public final class o0OO000o {
    ...
    public final boolean f2053OooO00o;

    public o0OO000o() {
        this.f2053OooO00o = ((o0O0OOO0) o0O0O0O.OooO00o(o0O0OOO0.class)) != null;
    }
    ...
    /* JADX WARN: Code duplicated, block: B:110:0x018e  */
    /* JADX WARN: Code duplicated, block: B:112:0x0192  */
    /* JADX WARN: Code duplicated, block: B:143:0x0299  */
    /* JADX WARN: Code duplicated, block: B:145:0x02a2  */
    @NonNull
    public final MediaCodec OooO00o(@NonNull MediaFormat mediaFormat) throws InvalidConfigException {
        Integer numValueOf;
        Integer numValueOf2;
        ...
        Integer num = null;
        try {
            if (this.f2053OooO00o && mediaFormat.containsKey("frame-rate")) {
            ...
            try {
                ...
                if (((o0O0OO0) o0O0O0O.OooO00o(o0O0OO0.class)) == null) {
                                ...
                                if ("LGE".equalsIgnoreCase(str) && "LG-X230".equalsIgnoreCase(Build.MODEL)) {
                                    ...
                                    if ("positivo".equalsIgnoreCase(str) && "twist 2 pro".equalsIgnoreCase(Build.MODEL)) {
                                        ...
                                        if ("Huawei".equalsIgnoreCase(str) && "mha-l29".equalsIgnoreCase(Build.MODEL)) {
                                            ...
                                            if (o0O0OO0.f1821OooO00o.contains(Build.MODEL.toLowerCase(Locale.US)) && "video/avc".equalsIgnoreCase(mediaFormat.getString("mime"))) {
                ...
                String strOooO0O0 = o0O00o0.OooO0O0(sb, "[End] Dump MediaCodecList", "\n");
