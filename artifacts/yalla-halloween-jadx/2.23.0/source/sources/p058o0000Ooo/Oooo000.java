...
public final class Oooo000 {
    ...
    public final float f34230OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final float f34231OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final float f34232OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final float f34233OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final float f34234OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final float f34235OooO0o0;

    public Oooo000(float f, float f2, float f3, float f4, float f5, float f6) {
        this.f34230OooO00o = f;
        this.f34231OooO0O0 = f2;
        this.f34232OooO0OO = f3;
        this.f34233OooO0Oo = f4;
        this.f34235OooO0o0 = f5;
        this.f34234OooO0o = f6;
    }
    ...
    public static Oooo000 OooO00o(@ColorInt int i) {
        ...
        float[][] fArr = Oooo0.f34229OooO0Oo;
        float[] fArr2 = fArr[0];
        ...
        float[][] fArr5 = Oooo0.f34226OooO00o;
        float[] fArr6 = fArr5[0];
        ...
        float[] fArr9 = o00oo0o2.f34251OooO0oO;
        float f7 = fArr9[0] * f4;
        float f8 = fArr9[1] * f5;
        float f9 = fArr9[2] * f6;
        float fAbs = Math.abs(f7);
        float f10 = o00oo0o2.f34252OooO0oo;
        ...
        float f18 = f15 * o00oo0o2.f34246OooO0O0;
        float f19 = o00oo0o2.f34245OooO00o;
        double d2 = f18 / f19;
        float f20 = o00oo0o2.f34253OooOO0;
        float f21 = o00oo0o2.f34248OooO0Oo;
        float fPow4 = ((float) Math.pow(d2, f20 * f21)) * 100.0f;
        Math.sqrt(fPow4 / 100.0f);
        float f22 = f19 + 4.0f;
        float fPow5 = ((float) Math.pow(1.64d - Math.pow(0.29d, o00oo0o2.f34249OooO0o), 0.73d)) * ((float) Math.pow((((((((float) (Math.cos(((((double) (((double) f16) < 20.14d ? 360.0f + f16 : f16)) * 3.141592653589793d) / 180.0d) + 2.0d) + 3.8d)) * 0.25f) * 3846.1538f) * o00oo0o2.f34250OooO0o0) * o00oo0o2.f34247OooO0OO) * ((float) Math.sqrt((f12 * f12) + (f11 * f11)))) / (f14 + 0.305f), 0.9d));
        float fSqrt = fPow5 * ((float) Math.sqrt(((double) fPow4) / 100.0d));
        float f23 = o00oo0o2.f34244OooO * fSqrt;
        Math.sqrt((fPow5 * f21) / f22);
        float f24 = (1.7f * fPow4) / ((0.007f * fPow4) + 1.0f);
        float fLog = ((float) Math.log((f23 * 0.0228f) + 1.0f)) * 43.85965f;
        double d3 = f17;
        return new Oooo000(f16, fSqrt, fPow4, f24, fLog * ((float) Math.cos(d3)), fLog * ((float) Math.sin(d3)));
    }
    ...
    public static Oooo000 OooO0O0(@FloatRange(from = 0.0d, to = TextSelectionMouseDetectorKt.ClicksSlop) float f, @FloatRange(from = 0.0d, to = DoubleCompanionObject.POSITIVE_INFINITY, toInclusive = false) float f2, @FloatRange(from = 0.0d, to = 360.0d) float f3) {
        o00oO0o o00oo0o2 = o00oO0o.f34243OooOO0O;
        float f4 = o00oo0o2.f34248OooO0Oo;
        double d = ((double) f) / 100.0d;
        Math.sqrt(d);
        float f5 = o00oo0o2.f34245OooO00o + 4.0f;
        float f6 = o00oo0o2.f34244OooO * f2;
        Math.sqrt(((f2 / ((float) Math.sqrt(d))) * o00oo0o2.f34248OooO0Oo) / f5);
    ...
    public final int OooO0OO(@NonNull o00oO0o o00oo0o2) {
        float fSqrt;
        float f = this.f34231OooO0O0;
        double d = f;
        float f2 = this.f34232OooO0OO;
        if (d != 0.0d) {
            double d2 = f2;
            if (d2 == 0.0d) {
                fSqrt = 0.0f;
        ...
        float fPow = (float) Math.pow(((double) fSqrt) / Math.pow(1.64d - Math.pow(0.29d, o00oo0o2.f34249OooO0o), 0.73d), 1.1111111111111112d);
        double d3 = (this.f34230OooO00o * 3.1415927f) / 180.0f;
        float fCos = ((float) (Math.cos(2.0d + d3) + 3.8d)) * 0.25f;
        float fPow2 = o00oo0o2.f34245OooO00o * ((float) Math.pow(((double) f2) / 100.0d, (1.0d / ((double) o00oo0o2.f34248OooO0Oo)) / ((double) o00oo0o2.f34253OooOO0)));
        float f3 = fCos * 3846.1538f * o00oo0o2.f34250OooO0o0 * o00oo0o2.f34247OooO0OO;
        float f4 = fPow2 / o00oo0o2.f34246OooO0O0;
        ...
        float fOooO00o = OooO00o.OooO00o(f7, 261.0f, f8 - (891.0f * f6), 1403.0f);
        float fOooO00o2 = OooO00o.OooO00o(f7, 6300.0f, f8 - (f6 * 220.0f), 1403.0f);
        float fMax = (float) Math.max(0.0d, (((double) Math.abs(f9)) * 27.13d) / (400.0d - ((double) Math.abs(f9))));
        float fSignum = Math.signum(f9);
        float f10 = 100.0f / o00oo0o2.f34252OooO0oo;
