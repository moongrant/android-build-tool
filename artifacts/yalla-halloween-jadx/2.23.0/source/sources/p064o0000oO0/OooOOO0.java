...
public abstract class OooOOO0 implements Interpolator {
    ...
    public final float[] f34302OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final float f34303OooO0O0;

    public OooOOO0(float[] fArr) {
        this.f34302OooO00o = fArr;
        this.f34303OooO0O0 = 1.0f / (fArr.length - 1);
    }
    ...
    public final float getInterpolation(float f) {
        ...
        float[] fArr = this.f34302OooO00o;
        int iMin = Math.min((int) ((fArr.length - 1) * f), fArr.length - 2);
        float f2 = this.f34303OooO0O0;
        float fOooO00o = OooO00o.OooO00o(iMin, f2, f, f2);
        float f3 = fArr[iMin];
