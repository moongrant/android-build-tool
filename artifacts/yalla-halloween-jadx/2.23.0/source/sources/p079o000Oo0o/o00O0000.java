...
public final class o00O0000 {
    ...
    public static class OooO00o implements TypeEvaluator<OooOOO.OooO00o[]> {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public OooOOO.OooO00o[] f35077OooO00o;

        @Override // android.animation.TypeEvaluator
        public final OooOOO.OooO00o[] evaluate(float f, OooOOO.OooO00o[] oooO00oArr, OooOOO.OooO00o[] oooO00oArr2) {
            OooOOO.OooO00o[] oooO00oArr3 = oooO00oArr;
            OooOOO.OooO00o[] oooO00oArr4 = oooO00oArr2;
            if (!OooOOO.OooO00o(oooO00oArr3, oooO00oArr4)) {
                throw new IllegalArgumentException("Can't interpolate between two incompatible pathData");
            }
            if (!OooOOO.OooO00o(this.f35077OooO00o, oooO00oArr3)) {
                this.f35077OooO00o = OooOOO.OooO0o0(oooO00oArr3);
            }
            for (int i = 0; i < oooO00oArr3.length; i++) {
                OooOOO.OooO00o oooO00o = this.f35077OooO00o[i];
                OooOOO.OooO00o oooO00o2 = oooO00oArr3[i];
                OooOOO.OooO00o oooO00o3 = oooO00oArr4[i];
                oooO00o.getClass();
                oooO00o.f33993OooO00o = oooO00o2.f33993OooO00o;
                int i2 = 0;
                while (true) {
                    float[] fArr = oooO00o2.f33994OooO0O0;
                    if (i2 < fArr.length) {
                        oooO00o.f33994OooO0O0[i2] = (oooO00o3.f33994OooO0O0[i2] * f) + ((1.0f - f) * fArr[i2]);
                        i2++;
                    }
                }
            }
            return this.f35077OooO00o;
        }
    }
            ...
            if (next == 2) {
                ...
                if (name.equals("objectAnimator")) {
                    ...
                    if (name.equals("animator")) {
                        ...
                        TypedArray typedArrayOooO0oo = oo000o.OooO0oo(resources2, theme2, attributeSet, o000O0O0.f34996OooO0oo);
                        ...
                        while (true) {
                            ...
                            if (eventType != i9) {
                                ...
                                if (xmlResourceParser.getName().equals(str2)) {
                                    TypedArray typedArrayOooO0oo2 = oo000o.OooO0oo(resources2, theme2, attributeSetAsAttributeSet, o000O0O0.f34988OooO);
                                    ...
                                    while (true) {
                                        ...
                                        if (xmlResourceParser.getName().equals("keyframe")) {
                                            int[] iArr = o000O0O0.f34997OooOO0;
                                            if (i10 == 4) {
                                    ...
                                    if (arrayList5 == null || (size = arrayList5.size()) <= 0) {
                                        ...
                                        i6 = 3;
                                        if (i10 == 3) {
                                            propertyValuesHolderOooO0OO.setEvaluator(o0O0ooO.f35079OooO00o);
                                        }
                                    }
                                    i4 = 0;
                                    i3 = 1;
    ...
    public static PropertyValuesHolder OooO0OO(TypedArray typedArray, int i, int i2, int i3, String str) {
        ...
        if (i == 2) {
            ...
            OooOOO.OooO00o[] oooO00oArrOooO0OO = OooOOO.OooO0OO(string);
            OooOOO.OooO00o[] oooO00oArrOooO0OO2 = OooOOO.OooO0OO(string2);
            ...
            if (oooO00oArrOooO0OO2 == null) {
                ...
                if (!OooOOO.OooO00o(oooO00oArrOooO0OO, oooO00oArrOooO0OO2)) {
        ...
        o0O0ooO o0o0ooo = i == 3 ? o0O0ooO.f35079OooO00o : null;
        if (z3) {
            if (z) {
            ...
            if (!z) {
                ...
                if (propertyValuesHolder == null && o0o0ooo != null) {
                    propertyValuesHolder.setEvaluator(o0o0ooo);
    ...
    public static ValueAnimator OooO0o0(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ObjectAnimator objectAnimator, XmlResourceParser xmlResourceParser) throws Resources.NotFoundException {
        ...
        TypedArray typedArrayOooO0oo = oo000o.OooO0oo(resources, theme, attributeSet, o000O0O0.f34995OooO0oO);
        TypedArray typedArrayOooO0oo2 = oo000o.OooO0oo(resources, theme, attributeSet, o000O0O0.f34998OooOO0O);
        ...
        if (typedArrayOooO0oo2 != null) {
            ...
            if (strOooO0o != null) {
                ...
                Path pathOooO0Oo = OooOOO.OooO0Oo(strOooO0o);
