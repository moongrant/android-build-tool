...
public abstract class OooOO0O {
    ...
    public final DataSetObservable f35080OooO00o = new DataSetObservable();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public DataSetObserver f35081OooO0O0;

    public final void OooO() {
        synchronized (this) {
            DataSetObserver dataSetObserver = this.f35081OooO0O0;
            if (dataSetObserver != null) {
                dataSetObserver.onChanged();
            }
        }
        this.f35080OooO00o.notifyChanged();
    }
    ...
    public void OooOO0(@NonNull DataSetObserver dataSetObserver) {
        this.f35080OooO00o.registerObserver(dataSetObserver);
    }
    ...
    public void OooOOOo(@NonNull DataSetObserver dataSetObserver) {
        this.f35080OooO00o.unregisterObserver(dataSetObserver);
    }
}
