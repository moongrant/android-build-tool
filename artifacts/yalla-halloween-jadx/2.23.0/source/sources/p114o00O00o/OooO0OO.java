...
public final class OooO0OO implements Closeable {
    ...
    @NonNull
    public final HttpURLConnection f36397OooO0Oo;

    public OooO0OO(@NonNull HttpURLConnection httpURLConnection) {
        this.f36397OooO0Oo = httpURLConnection;
    }
    ...
    public final String OooO00o() {
        boolean z;
        HttpURLConnection httpURLConnection = this.f36397OooO0Oo;
        try {
