...
public final class OooOO0 {
    ...
    @NonNull
    public final OooO f36398OooO00o;

    public OooOO0(@NonNull OooO0OO.OooO00o oooO00o) {
        this.f36398OooO00o = oooO00o;
    }
    ...
    public final File OooO0O0() {
        OooO0OO.OooO00o oooO00o = (OooO0OO.OooO00o) this.f36398OooO00o;
        oooO00o.getClass();
        File file = new File(oooO00o.f8719OooO00o.getCacheDir(), "lottie_network_cache");
        if (file.isFile()) {
            file.delete();
        }
        if (!file.exists()) {
