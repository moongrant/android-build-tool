...
public final class o0Oo0oo {
    public static String OooO00o(Context context, String str) {
        ...
        try {
            ...
            HashMap<String, String> map = o0OOO0o.f36636OooO00o;
            if (!TextUtils.isEmpty(strSubstring)) {
                Boolean bool = Boolean.FALSE;
                if (o0OOO0o.f36637OooO0O0.containsKey(o0OOO0o.OooO0OO(strSubstring).toLowerCase())) {
                    bool = Boolean.TRUE;
                }
                if (bool.booleanValue() && (iLastIndexOf = strSubstring.lastIndexOf(o0OOO0o.OooO0OO(strSubstring))) > 0 && iLastIndexOf < strSubstring.length()) {
    ...
    public static String OooO0O0(Context context, String str) {
        File file = new File(o0O00o0.OooO0O0(new StringBuilder(), (Environment.getExternalStorageState().equals("mounted") || !Environment.isExternalStorageRemovable()) ? context.getExternalCacheDir().getPath() : context.getCacheDir().getPath(), "/MyPhoto"));
        if (!file.exists()) {
            file.mkdirs();
        }
        return file + o000oOoO.OooO00o("/", str, ".png");
    }
