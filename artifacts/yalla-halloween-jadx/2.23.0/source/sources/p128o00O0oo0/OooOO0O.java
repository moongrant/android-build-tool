...
public final class OooOO0O implements OooO0o<InputStream> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final Uri f36942OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public InputStream f36943OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final OooOOO f36944OooO0o0;

    public static class OooO00o implements OooOOO0 {

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public static final String[] f36945OooO0O0 = {"_data"};

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final ContentResolver f36946OooO00o;

        public OooO00o(ContentResolver contentResolver) {
            this.f36946OooO00o = contentResolver;
        }

        @Override // p128o00O0oo0.OooOOO0
        public final Cursor OooO00o(Uri uri) {
            return this.f36946OooO00o.query(MediaStore.Images.Thumbnails.EXTERNAL_CONTENT_URI, f36945OooO0O0, "kind = 1 AND image_id = ?", new String[]{uri.getLastPathSegment()}, null);
        }
    }

    public static class OooO0O0 implements OooOOO0 {

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public static final String[] f36947OooO0O0 = {"_data"};

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final ContentResolver f36948OooO00o;

        public OooO0O0(ContentResolver contentResolver) {
            this.f36948OooO00o = contentResolver;
        }

        @Override // p128o00O0oo0.OooOOO0
        public final Cursor OooO00o(Uri uri) {
            return this.f36948OooO00o.query(MediaStore.Video.Thumbnails.EXTERNAL_CONTENT_URI, f36947OooO0O0, "kind = 1 AND video_id = ?", new String[]{uri.getLastPathSegment()}, null);
        }
    }

    @VisibleForTesting
    public OooOO0O(Uri uri, OooOOO oooOOO) {
        this.f36942OooO0Oo = uri;
        this.f36944OooO0o0 = oooOOO;
    }

    public static OooOO0O OooO0OO(Context context, Uri uri, OooOOO0 oooOOO0) {
        return new OooOO0O(uri, new OooOOO(OooO0OO.OooO0O0(context).f9854OooO0oO.OooO0O0().OooO0o(), oooOOO0, OooO0OO.OooO0O0(context).f9855OooO0oo, context.getContentResolver()));
    }
    ...
    public final void OooO0O0() {
        InputStream inputStream = this.f36943OooO0o;
        if (inputStream != null) {
            try {
                inputStream.close();
    ...
    public final void OooO0Oo(@NonNull Priority priority, @NonNull OooO0o.OooO00o<? super InputStream> oooO00o) throws Throwable {
        try {
            ...
            this.f36943OooO0o = inputStreamOooO0o0;
    ...
    public final InputStream OooO0o0() throws Throwable {
        ...
        File file;
        Uri uriFromFile;
        Uri uri = this.f36942OooO0Oo;
        OooOOO oooOOO = this.f36944OooO0o0;
        oooOOO.getClass();
        ?? r5 = 0;
        InputStream inputStreamOpenInputStream2 = null;
        boolean z = false;
        try {
            cursorOooO00o = oooOOO.f36949OooO00o.OooO00o(uri);
            if (cursorOooO00o != null) {
                try {
                    ...
                    contentResolver = oooOOO.f36951OooO0OO;
                    if (zIsEmpty) {
                    ...
                    if (inputStreamOpenInputStream != null) {
                        try {
                            try {
                                ...
                                iOooO00o = com.bumptech.glide.load.OooO00o.OooO00o(oooOOO.f36950OooO0O0, inputStreamOpenInputStream2, oooOOO.f36952OooO0Oo);
                    ...
                    if (iOooO00o != -1) {
                        return new com.bumptech.glide.load.data.OooOO0O(inputStreamOpenInputStream, iOooO00o);
                    }
