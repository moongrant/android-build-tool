...
public final class o000O000 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ long f38044OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ int f38045OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o000O000(long j, int i) {
        super(2);
        this.f38044OooO0Oo = j;
        this.f38045OooO0o0 = i;
    }
    ...
    public final Unit invoke(Composer composer, Integer num) {
        ...
        if ((iIntValue & 11) == 2 && composer2.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(552764422, iIntValue, -1, "com.code.android.uikit.marquee.MarqueeText.<anonymous>.<anonymous>.<anonymous> (MarqueeTextComp.kt:150)");
            }
            long j = this.f38044OooO0Oo;
            ...
            long jM1705getTransparent0d7_KjU = companion3.m1705getTransparent0d7_KjU();
            int i = this.f38045OooO0o0;
            o000OO.OooO0OO(j, jM1705getTransparent0d7_KjU, composer2, ((i >> 9) & 14) | 48);
            SpacerKt.Spacer(OooOO0O.OooO00o(rowScopeInstance, companion, 1.0f, false, 2, null), composer2, 0);
            o000OO.OooO0OO(companion3.m1705getTransparent0d7_KjU(), j, composer2, ((i >> 6) & 112) | 6);
