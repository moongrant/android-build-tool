...
import p616o0oo0oO.o0000OO0;
import p616o0oo0oO.o000O00;
import p616o0oo0oO.o000OO;
import p616o0oo0oO.o000Oo0;
...
public final class OooOOO {
    ...
    @NotNull
    public static final OooO00o f38604OooO00o = OooO00o.f38605OooO0Oo;

    public static final class OooO00o extends Lambda implements Function3<o000O00, Integer, Integer, Integer> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO00o f38605OooO0Oo = new OooO00o();
        ...
        public final Integer invoke(o000O00 o000o01, Integer num, Integer num2) {
            o000O00 layoutInfo = o000o01;
    ...
    @Composable
    public static o000 OooO00o(@NotNull Oooo000 state, float f, @Nullable Composer composer, int i) {
        ...
        SpringSpec springSpec = o000Oo0.f57107OooO00o;
        ...
        Intrinsics.checkNotNullParameter(state, "state");
        Object snapIndex = f38604OooO00o;
        ...
        LazyListState lazyListState = state.f38643OooO00o;
        o0000OO0.OooO0O0 oooO0O0 = o0000OO0.f57100OooO00o;
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new o000OO(lazyListState, oooO0O0);
            composer.updateRememberedValue(objRememberedValue);
        }
        composer.endReplaceableGroup();
        o000OO layoutInfo = (o000OO) objRememberedValue;
        layoutInfo.f57105OooO0OO.setValue(Integer.valueOf(((Density) composer.consume(CompositionLocalsKt.getLocalDensity())).mo318roundToPx0680j_4(f)));
        composer.endReplaceableGroup();
        Intrinsics.checkNotNullParameter(layoutInfo, "layoutInfo");
        Intrinsics.checkNotNullParameter(snapIndex, "snapIndex");
        ...
        if (zChanged2 || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
            objRememberedValue2 = new o000(layoutInfo, decayAnimationSpecRememberSplineBasedDecay, springSpec);
            composer.updateRememberedValue(objRememberedValue2);
        }
        composer.endReplaceableGroup();
        o000 o000Var = (o000) objRememberedValue2;
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
        if (ComposerKt.isTraceInProgress()) {
