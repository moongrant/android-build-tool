...
public final class o00O0 {
    ...
    public static final long f38688OooO00o = ColorKt.Color$default(0.0f, 0.0f, 0.0f, 0.3f, null, 16, null);

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public static final OooO00o f38689OooO0O0 = OooO00o.f38690OooO0Oo;

    public static final class OooO00o extends Lambda implements Function1<Color, Color> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO00o f38690OooO0Oo = new OooO00o();
        ...
        public final Color invoke(Color color) {
            return Color.m1660boximpl(ColorKt.m1715compositeOverOWjLjI(o00O0.f38688OooO00o, color.m1680unboximpl()));
        }
    }

    @Composable
    @NotNull
    public static final o00O00OO OooO00o(@Nullable Composer composer) {
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new o00O00OO(view, window2);
            composer.updateRememberedValue(objRememberedValue);
        }
        composer.endReplaceableGroup();
        o00O00OO o00o00oo2 = (o00O00OO) objRememberedValue;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
