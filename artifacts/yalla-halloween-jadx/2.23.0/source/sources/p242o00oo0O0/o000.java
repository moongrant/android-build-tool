...
public final class o000 extends o0000OO0 {
    ...
    public final o00Oo00 f40414OooOOO0 = new o00Oo00();

    /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
    public final o0000O0O f40413OooOOO = new o0000O0O();
    ...
    public final p230o00oOoO0.o000 OooO0oO(byte[] bArr, int i, boolean z) throws SubtitleDecoderException {
        int i2;
        ...
        boolean z2;
        o000 o000Var = this;
        o00Oo00 o00oo00 = o000Var.f40414OooOOO0;
        o00oo00.OooOooo(i, bArr);
        ArrayList arrayList = new ArrayList();
        try {
            int i4 = o000O000.f40445OooO00o;
            ...
            if (!(strOooO0oO != null && strOooO0oO.startsWith("WEBVTT"))) {
                o00oo00.Oooo00O(i5);
                throw ParserException.OooO00o("Expected WEBVTT. Got " + o00oo00.OooO0oO(), null);
            }
            while (!TextUtils.isEmpty(o00oo00.OooO0oO())) {
            }
            ...
            while (true) {
                ...
                int i10 = i6;
                while (i9 == -1) {
                    i10 = o00oo00.f40592OooO0O0;
                    String strOooO0oO2 = o00oo00.OooO0oO();
                    if (strOooO0oO2 == null) {
                        i9 = i6;
                ...
                if (i9 == i7) {
                    ...
                    if (i9 != 2) {
                        ...
                        if (i9 == 3) {
                            ...
                            String strOooO0oO3 = o00oo00.OooO0oO();
                            if (strOooO0oO3 == null) {
                                o000ooOooO0Oo = null;
                            } else {
                                Pattern pattern2 = o0000OO0.f40420OooO00o;
                                Matcher matcher2 = pattern2.matcher(strOooO0oO3);
                                if (matcher2.matches()) {
                                    o000ooOooO0Oo = o0000OO0.OooO0Oo(null, matcher2, o00oo00, arrayList);
                                } else {
                                    String strOooO0oO4 = o00oo00.OooO0oO();
                                    if (strOooO0oO4 == null) {
                                        o000ooOooO0Oo = null;
                                    } else {
                                        Matcher matcher3 = pattern2.matcher(strOooO0oO4);
                                        if (matcher3.matches()) {
                                            o000ooOooO0Oo = o0000OO0.OooO0Oo(strOooO0oO3.trim(), matcher3, o00oo00, arrayList);
                                        } else {
                                            o000ooOooO0Oo = null;
                                        }
                                    }
                        ...
                        o00oo00.OooO0oO();
                        o0000O0O o0000o0o2 = o000Var.f40413OooOOO;
                        StringBuilder sb = o0000o0o2.f40419OooO0O0;
                        sb.setLength(i6);
                        ...
                        int i12 = o00oo00.f40592OooO0O0;
                        o00Oo00 o00oo01 = o0000o0o2.f40418OooO00o;
                        o00oo01.OooOooo(i12, bArr2);
                        o00oo01.Oooo00O(i11);
                        ArrayList arrayList3 = new ArrayList();
                        while (true) {
                            o0000O0O.OooO0OO(o00oo01);
                            if (o00oo01.f40593OooO0OO - o00oo01.f40592OooO0O0 >= 5 && "::cue".equals(o00oo01.OooOOoo(5))) {
                                int i13 = o00oo01.f40592OooO0O0;
                                String strOooO0O0 = o0000O0O.OooO0O0(o00oo01, sb);
                                if (strOooO0O0 == null) {
                                    strSubstring = null;
                                    ...
                                    if ("(".equals(strOooO0O0)) {
                                        int i14 = o00oo01.f40592OooO0O0;
                                        int i15 = o00oo01.f40593OooO0OO;
                                        int i16 = i6;
                                        while (i14 < i15 && i16 == 0) {
                                            int i17 = i14 + 1;
                                            i16 = ((char) o00oo01.f40591OooO00o[i14]) == ')' ? i7 : i6;
                                            i14 = i17;
                                        }
                                        strSubstring = o00oo01.OooOOoo((i14 - 1) - o00oo01.f40592OooO0O0).trim();
                                    } else {
                                        strSubstring = null;
                                    }
                                    if (!")".equals(o0000O0O.OooO0O0(o00oo01, sb))) {
                                        strSubstring = null;
                                    }
                                }
                            } else {
                            ...
                            if (strSubstring == null || !"{".equals(o0000O0O.OooO0O0(o00oo01, sb))) {
                                break;
                            }
                            ...
                            if (!"".equals(strSubstring)) {
                                ...
                                if (iIndexOf != i8) {
                                    Matcher matcher4 = o0000O0O.f40416OooO0OO.matcher(strSubstring.substring(iIndexOf));
                                    if (matcher4.matches()) {
                                        String strGroup2 = matcher4.group(i7);
                                        strGroup2.getClass();
                                        webvttCssStyle.f13500OooO0Oo = strGroup2;
                                    }
                                    strSubstring = strSubstring.substring(i6, iIndexOf);
                                }
                                int i18 = o0O00.f40595OooO00o;
                                String[] strArrSplit = strSubstring.split("\\.", i8);
                                String str = strArrSplit[i6];
                                int iIndexOf2 = str.indexOf(35);
                                if (iIndexOf2 != i8) {
                                    webvttCssStyle.f13498OooO0O0 = str.substring(i6, iIndexOf2);
                                    webvttCssStyle.f13497OooO00o = str.substring(iIndexOf2 + 1);
                                } else {
                                    webvttCssStyle.f13498OooO0O0 = str;
                                }
                                if (strArrSplit.length > i7) {
                                    int length = strArrSplit.length;
                                    o00O000o.OooO00o(length <= strArrSplit.length ? i7 : i6);
                                    webvttCssStyle.f13499OooO0OO = new HashSet(Arrays.asList((String[]) Arrays.copyOfRange(strArrSplit, i7, length)));
                                }
                            }
                            int i19 = i6;
                            String str2 = null;
                            while (i19 == 0) {
                                int i20 = o00oo01.f40592OooO0O0;
                                String strOooO0O1 = o0000O0O.OooO0O0(o00oo01, sb);
                                int i21 = (strOooO0O1 == null || "}".equals(strOooO0O1)) ? i7 : i6;
                                if (i21 == 0) {
                                    o00oo01.Oooo00O(i20);
                                    o0000O0O.OooO0OO(o00oo01);
                                    String strOooO00o = o0000O0O.OooO00o(o00oo01, sb);
                                    if (!"".equals(strOooO00o) && CertificateUtil.DELIMITER.equals(o0000O0O.OooO0O0(o00oo01, sb))) {
                                        o0000O0O.OooO0OO(o00oo01);
                                        ...
                                        while (true) {
                                            ...
                                            int i22 = o00oo01.f40592OooO0O0;
                                            boolean z4 = z3;
                                            String strOooO0O2 = o0000O0O.OooO0O0(o00oo01, sb);
                                            if (strOooO0O2 == null) {
                                                string = null;
                                                break;
                                            }
                                        ...
                                        if (string == null || "".equals(string)) {
                                            ...
                                            int i23 = o00oo01.f40592OooO0O0;
                                            String strOooO0O3 = o0000O0O.OooO0O0(o00oo01, sb);
                                            if (";".equals(strOooO0O3)) {
                                                if ("color".equals(strOooO00o)) {
                                                    webvttCssStyle.f13501OooO0o = oo00o.OooO00o(string, true);
                                                    webvttCssStyle.f13503OooO0oO = true;
                                                } else if ("background-color".equals(strOooO00o)) {
                                                    webvttCssStyle.f13504OooO0oo = oo00o.OooO00o(string, true);
                                                    webvttCssStyle.f13496OooO = true;
                                                } else if ("ruby-position".equals(strOooO00o)) {
                                                    if ("over".equals(string)) {
                                                        webvttCssStyle.f13511OooOOOo = 1;
                                                    } else if ("under".equals(string)) {
                                                        webvttCssStyle.f13511OooOOOo = 2;
                                                        i3 = 1;
                                                    }
                                                    ...
                                                    if (matcher.matches()) {
                                                        ...
                                                        if (b != 0) {
                                                            i3 = 1;
                                                            if (b != 1) {
                                                                webvttCssStyle.f13508OooOOO = 2;
                                                            } else {
                                                                if (b == 2) {
                                                                    throw new IllegalStateException();
                                                                }
                                                                webvttCssStyle.f13508OooOOO = 1;
                                                            }
                                                        } else {
                                                            i3 = 1;
                                                            webvttCssStyle.f13508OooOOO = 3;
                                                        }
                                                        String strGroup3 = matcher.group(i3);
                                                        strGroup3.getClass();
                                                        webvttCssStyle.f13510OooOOOO = Float.parseFloat(strGroup3);
                                                    } else {
                                                ...
                                                if ("color".equals(strOooO00o)) {
                                                    ...
                                                    if (matcher.matches()) {
                                                        ...
                                                        strGroup4.getClass();
                                                        webvttCssStyle.f13510OooOOOO = Float.parseFloat(strGroup4);
                                                    }
                                                }
                                                i3 = 1;
                                            } else {
