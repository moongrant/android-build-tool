...
public final class o00Oo00 {
    ...
    public byte[] f40591OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public int f40592OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public int f40593OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public static final char[] f40588OooO0Oo = {'\r', '\n'};

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public static final char[] f40590OooO0o0 = {'\n'};

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public static final ImmutableSet<Charset> f40589OooO0o = ImmutableSet.OooOO0(5, OooO.f19057OooO00o, OooO.f19059OooO0OO, OooO.f19061OooO0o, OooO.f19060OooO0Oo, OooO.f19062OooO0o0);

    public o00Oo00() {
        this.f40591OooO00o = o0O00.f40599OooO0o;
    }

    public final int OooO() {
        byte[] bArr = this.f40591OooO00o;
        int i = this.f40592OooO0O0;
        int i2 = i + 1;
        int i3 = i2 + 1;
        int i4 = (bArr[i] & UByte.MAX_VALUE) | ((bArr[i2] & UByte.MAX_VALUE) << 8);
        int i5 = i3 + 1;
        int i6 = i4 | ((bArr[i3] & UByte.MAX_VALUE) << 16);
        this.f40592OooO0O0 = i5 + 1;
    ...
    public final void OooO00o(int i) {
        byte[] bArr = this.f40591OooO00o;
        if (i > bArr.length) {
            this.f40591OooO00o = Arrays.copyOf(bArr, i);
        }
    }

    public final char OooO0O0(Charset charset) {
        o00O000o.OooO0O0(f40589OooO0o.contains(charset), "Unsupported charset: " + charset);
    ...
    public final int OooO0OO(Charset charset) {
        ...
        int i5;
        int i6;
        if (charset.equals(OooO.f19059OooO0OO) || charset.equals(OooO.f19057OooO00o)) {
            int i7 = this.f40593OooO0OO;
            int i8 = this.f40592OooO0O0;
            if (i7 - i8 >= 1) {
                long j = this.f40591OooO00o[i8] & UByte.MAX_VALUE;
                char c = (char) j;
                o000oOoO.OooO0O0(j, "Out of range: %s", ((long) c) == j);
                b = (byte) c;
                i = 1;
            } else {
                i = 2;
                if (charset.equals(OooO.f19061OooO0o) && !charset.equals(OooO.f19060OooO0Oo)) {
                    if (charset.equals(OooO.f19062OooO0o0)) {
                        i5 = this.f40593OooO0OO;
                        i6 = this.f40592OooO0O0;
                        if (i5 - i6 >= 2) {
                            byte[] bArr = this.f40591OooO00o;
                            byte b3 = bArr[i6 + 1];
                            b2 = bArr[i6];
                ...
                i2 = this.f40593OooO0OO;
                i3 = this.f40592OooO0O0;
                if (i2 - i3 < 2) {
                    if (charset.equals(OooO.f19062OooO0o0)) {
                        i5 = this.f40593OooO0OO;
                        i6 = this.f40592OooO0O0;
                        if (i5 - i6 >= 2) {
                            byte[] bArr2 = this.f40591OooO00o;
                            byte b4 = bArr2[i6 + 1];
                            b2 = bArr2[i6];
                            i4 = b4 << 8;
                        }
            ...
            i = 2;
            if (charset.equals(OooO.f19061OooO0o)) {
                i2 = this.f40593OooO0OO;
                i3 = this.f40592OooO0O0;
                if (i2 - i3 < 2) {
                    if (charset.equals(OooO.f19062OooO0o0)) {
        ...
        long j2 = b;
        char c2 = (char) j2;
        o000oOoO.OooO0O0(j2, "Out of range: %s", ((long) c2) == j2);
        return (c2 << 16) + i;
    }

    public final void OooO0Oo(int i, int i2, byte[] bArr) {
        System.arraycopy(this.f40591OooO00o, this.f40592OooO0O0, bArr, i, i2);
        this.f40592OooO0O0 += i2;
    }
    ...
    public final char OooO0o0(Charset charset, char[] cArr) {
        ...
        if (iOooO0OO != 0) {
            ...
            if (z) {
                this.f40592OooO0O0 += iOooO0OO & 65535;
                return c;
            }
        }
        return (char) 0;
    ...
    public final String OooO0oO() {
        return OooO0oo(OooO.f19059OooO0OO);
    }
    ...
    public final String OooO0oo(Charset charset) {
        ...
        byte b2;
        o00O000o.OooO0O0(f40589OooO0o.contains(charset), "Unsupported charset: " + charset);
        if (this.f40593OooO0OO - this.f40592OooO0O0 == 0) {
            return null;
        }
        ...
        if (charset.equals(OooO.f19059OooO0OO) || charset.equals(charset2)) {
            i = 1;
        } else {
            if (!charset.equals(OooO.f19061OooO0o) && !charset.equals(OooO.f19062OooO0o0) && !charset.equals(OooO.f19060OooO0Oo)) {
                throw new IllegalArgumentException("Unsupported charset: " + charset);
            }
            i = 2;
        }
        int i2 = this.f40592OooO0O0;
        while (true) {
            int i3 = this.f40593OooO0OO;
            if (i2 >= i3 - (i - 1)) {
                i2 = i3;
                break;
            }
            if (charset.equals(OooO.f19059OooO0OO) || charset.equals(OooO.f19057OooO00o)) {
                byte b3 = this.f40591OooO00o[i2];
                int i4 = o0O00.f40595OooO00o;
                if (b3 == 10 || b3 == 13) {
                    break;
                }
                if (!charset.equals(OooO.f19061OooO0o) || charset.equals(OooO.f19060OooO0Oo)) {
                    bArr = this.f40591OooO00o;
                    if (bArr[i2] == 0) {
                        b = bArr[i2 + 1];
            ...
            } else if (charset.equals(OooO.f19061OooO0o)) {
                bArr = this.f40591OooO00o;
                if (bArr[i2] == 0) {
                    b = bArr[i2 + 1];
        ...
        String strOooOo00 = OooOo00(i2 - this.f40592OooO0O0, charset);
        if (this.f40592OooO0O0 != this.f40593OooO0OO && OooO0o0(charset, f40588OooO0Oo) == '\r') {
            OooO0o0(charset, f40590OooO0o0);
        }
        return strOooOo00;
    }
    ...
    public final String OooOOOo() {
        int i = this.f40593OooO0OO;
        int i2 = this.f40592OooO0O0;
        if (i - i2 == 0) {
            return null;
        }
        while (i2 < this.f40593OooO0OO && this.f40591OooO00o[i2] != 0) {
            i2++;
        }
        byte[] bArr = this.f40591OooO00o;
        int i3 = this.f40592OooO0O0;
        int i4 = o0O00.f40595OooO00o;
        String str = new String(bArr, i3, i2 - i3, OooO.f19059OooO0OO);
        this.f40592OooO0O0 = i2;
        if (i2 < this.f40593OooO0OO) {
            this.f40592OooO0O0 = i2 + 1;
        }
        return str;
    }
    ...
    public final String OooOOo0(int i) {
        ...
        int i2 = this.f40592OooO0O0;
        int i3 = (i2 + i) - 1;
        int i4 = (i3 >= this.f40593OooO0OO || this.f40591OooO00o[i3] != 0) ? i : i - 1;
        byte[] bArr = this.f40591OooO00o;
        int i5 = o0O00.f40595OooO00o;
        String str = new String(bArr, i2, i4, OooO.f19059OooO0OO);
        this.f40592OooO0O0 += i;
        return str;
    }

    public final String OooOOoo(int i) {
        return OooOo00(i, OooO.f19059OooO0OO);
    }
    ...
    public final String OooOo00(int i, Charset charset) {
        String str = new String(this.f40591OooO00o, this.f40592OooO0O0, i, charset);
        this.f40592OooO0O0 += i;
        return str;
    }
    ...
    public final Charset OooOoo() {
        ...
        if (i - i2 >= 3) {
            ...
            if (bArr[i2] == -17 && bArr[i2 + 1] == -69 && bArr[i2 + 2] == -65) {
                this.f40592OooO0O0 = i2 + 3;
                return OooO.f19059OooO0OO;
            }
        }
        if (i - i2 < 2) {
            return null;
        ...
        this.f40592OooO0O0 = i2 + 2;
        return OooO.f19062OooO0o0;
    }

    public final long OooOoo0() {
        int i;
        int i2;
        long j = this.f40591OooO00o[this.f40592OooO0O0];
        int i3 = 7;
        while (true) {
            if (i3 >= 0) {
                int i4 = 1 << i3;
        ...
        for (i = 1; i < i2; i++) {
            byte b = this.f40591OooO00o[this.f40592OooO0O0 + i];
            if ((b & 192) != 128) {
    ...
    public final void OooOooo(int i, byte[] bArr) {
        this.f40591OooO00o = bArr;
        this.f40593OooO0OO = i;
        this.f40592OooO0O0 = 0;
    }

    public final void Oooo000(int i) {
        o00O000o.OooO00o(i >= 0 && i <= this.f40591OooO00o.length);
        this.f40593OooO0OO = i;
    }

    public final void Oooo00O(int i) {
        o00O000o.OooO00o(i >= 0 && i <= this.f40593OooO0OO);
        this.f40592OooO0O0 = i;
    }

    public final void Oooo00o(int i) {
        Oooo00O(this.f40592OooO0O0 + i);
    }

    public o00Oo00(int i) {
        this.f40591OooO00o = new byte[i];
        this.f40593OooO0OO = i;
    }

    public o00Oo00(byte[] bArr) {
        this.f40591OooO00o = bArr;
        this.f40593OooO0OO = bArr.length;
    }

    public o00Oo00(byte[] bArr, int i) {
        this.f40591OooO00o = bArr;
        this.f40593OooO0OO = i;
    }
}
