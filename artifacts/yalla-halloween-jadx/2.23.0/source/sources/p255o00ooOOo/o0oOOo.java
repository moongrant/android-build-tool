...
public abstract class o0oOOo extends zzc {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ BaseGmsClient f41044OooO0Oo;
    ...
    @BinderThread
    public o0oOOo(BaseGmsClient baseGmsClient, @Nullable int i, Bundle bundle) {
        super(baseGmsClient, Boolean.TRUE);
        this.f41044OooO0Oo = baseGmsClient;
        this.zza = i;
        this.zzb = bundle;
    }
    ...
    public final /* bridge */ /* synthetic */ void OooO00o() {
        int i = this.zza;
        BaseGmsClient baseGmsClient = this.f41044OooO0Oo;
        if (i != 0) {
