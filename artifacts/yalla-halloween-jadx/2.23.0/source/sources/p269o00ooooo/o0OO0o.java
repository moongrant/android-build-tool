...
public final class o0OO0o implements Runnable {
    ...
    public final /* synthetic */ zzez f41194OooO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final URL f41195OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final o0OOooO0 f41196OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final byte[] f41197OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final String f41198OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final Map f41199OooO0oo;

    public o0OO0o(zzez zzezVar, String str, URL url, byte[] bArr, Map map, o0OOooO0 o0ooooo0) {
        this.f41194OooO = zzezVar;
        Preconditions.checkNotEmpty(str);
        Preconditions.checkNotNull(url);
        Preconditions.checkNotNull(o0ooooo0);
        this.f41195OooO0Oo = url;
        this.f41197OooO0o0 = bArr;
        this.f41196OooO0o = o0ooooo0;
        this.f41198OooO0oO = str;
        this.f41199OooO0oo = map;
    }
    ...
    public final void run() throws Throwable {
        ...
        byte[] bArr;
        int i3;
        String str = this.f41198OooO0oO;
        zzez zzezVar = this.f41194OooO;
        zzezVar.zzaz();
        zzgd zzgdVar = zzezVar.f41276OooO00o;
        int i4 = 0;
        OutputStream outputStream2 = null;
        try {
            URLConnection uRLConnectionOpenConnection = this.f41195OooO0Oo.openConnection();
            ...
            try {
                Map map5 = this.f41199OooO0oo;
                if (map5 != null) {
                    for (Map.Entry entry : map5.entrySet()) {
                        httpURLConnection.addRequestProperty((String) entry.getKey(), (String) entry.getValue());
                    }
                }
                byte[] bArr2 = this.f41197OooO0o0;
                if (bArr2 != null) {
                    byte[] bArrOooOoo0 = zzezVar.f41477OooO0O0.zzu().OooOoo0(bArr2);
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    try {
                                        ...
                                        o0oo0o01 = new o0OO0o00(this.f41198OooO0oO, this.f41196OooO0o, responseCode, null, byteArray, headerFields);
                                    } catch (Throwable th) {
                                        th = th;
                                        if (inputStream != null) {
                                            inputStream.close();
                                ...
                                zzgaVarZzaB = zzgdVar.zzaB();
                                o0oo0o01 = new o0OO0o00(this.f41198OooO0oO, this.f41196OooO0o, i, iOException, null, map);
                            } catch (Throwable th3) {
                                th = th3;
                                i2 = responseCode;
                                map2 = map3;
                                ...
                                zzgdVar.zzaB().zzp(new o0OO0o00(this.f41198OooO0oO, this.f41196OooO0o, i2, null, null, map2));
                                throw th;
                            }
                    ...
                    httpURLConnection.disconnect();
                    zzgaVarZzaB = zzgdVar.zzaB();
                    o0oo0o01 = new o0OO0o00(this.f41198OooO0oO, this.f41196OooO0o, responseCode, null, byteArray2, headerFields2);
                }
