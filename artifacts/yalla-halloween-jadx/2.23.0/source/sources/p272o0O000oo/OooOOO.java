...
public final class OooOOO {
    ...
    public static int OooO0OO(@AttrRes int i, @NonNull View view) {
        ...
        TypedValue typedValueOooO0OO = b1.OooO0OO(i, view.getContext(), view.getClass().getCanonicalName());
    ...
    public static boolean OooO0Oo(@ColorInt int i) {
        boolean z;
        if (i != 0) {
            ThreadLocal<double[]> threadLocal = OooOO0.f33987OooO00o;
