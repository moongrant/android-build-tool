...
public final class o00O0OO0 {
    ...
    public static final Descriptors.Descriptor f42808OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final GeneratedMessageV3.FieldAccessorTable f42809OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final Descriptors.Descriptor f42810OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public static final GeneratedMessageV3.FieldAccessorTable f42811OooO0Oo;

    static {
        GeneratedMessage.GeneratedExtension generatedExtensionNewFileScopedGeneratedExtension = GeneratedMessage.newFileScopedGeneratedExtension(RoutingRule.class, RoutingRule.f18778OooO0o);
        ...
        f42808OooO00o = descriptor;
        f42809OooO0O0 = new GeneratedMessageV3.FieldAccessorTable(descriptor, new String[]{"RoutingParameters"});
        Descriptors.Descriptor descriptor2 = fileDescriptorInternalBuildGeneratedFileFrom.getMessageTypes().get(1);
        f42810OooO0OO = descriptor2;
        f42811OooO0Oo = new GeneratedMessageV3.FieldAccessorTable(descriptor2, new String[]{"Field", "PathTemplate"});
