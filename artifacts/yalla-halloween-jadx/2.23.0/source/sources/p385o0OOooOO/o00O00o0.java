...
public final class o00O00o0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f44347OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ long f44348OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00O00o0(long j, Continuation<? super o00O00o0> continuation) {
        super(2, continuation);
        this.f44348OooO0o0 = j;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o00O00o0(this.f44348OooO0o0, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            if (o0OoOo0.OooO0o0(0, value != null ? Boxing.boxInt(value.size()) : null) <= 1) {
                ...
                this.f44347OooO0Oo = 1;
                Object objOooO0Oo = OooOOO.OooO0Oo(new o00O0(this.f44348OooO0o0, null), this);
