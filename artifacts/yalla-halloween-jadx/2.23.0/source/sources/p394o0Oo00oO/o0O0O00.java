...
public class o0O0O00 extends ViewModel {
    public static final int $stable = 8;

    @NotNull
    private final Lazy showLoadingDialog$delegate = LazyKt.lazy(OooO00o.f44407OooO0Oo);

    public static final class OooO00o extends Lambda implements Function0<MutableState<Boolean>> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO00o f44407OooO0Oo = new OooO00o();
