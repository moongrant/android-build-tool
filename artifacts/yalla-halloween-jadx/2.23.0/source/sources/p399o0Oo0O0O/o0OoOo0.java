...
public final class o0OoOo0 implements o00O0O {
    ...
    @Nullable
    public Activity f44424OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @NotNull
    public final Oooo0 f44425OooO0o0 = new Oooo0();

    public static final class OooO00o extends Lambda implements Function2<Composer, Integer, Unit> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Triple<MutableState<Boolean>, ComposeView, Boolean> f44426OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ Window f44427OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ String f44428OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ Function3<MutableState<Boolean>, Composer, Integer, Unit> f44429OooO0oO;
        ...
        public OooO00o(Triple<? extends MutableState<Boolean>, ComposeView, Boolean> triple, String str, Window window, Function3<? super MutableState<Boolean>, ? super Composer, ? super Integer, Unit> function3) {
            super(2);
            this.f44426OooO0Oo = triple;
            this.f44428OooO0o0 = str;
            this.f44427OooO0o = window;
            this.f44429OooO0oO = function3;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            ...
            if ((iIntValue & 11) == 2 && composer2.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(396755257, iIntValue, -1, "com.yalla.yalla.base.activity.ComposeDialogProxy.showDialog.<anonymous> (ComposeDialogProxy.kt:41)");
                }
                Triple<MutableState<Boolean>, ComposeView, Boolean> triple = this.f44426OooO0Oo;
                if (!triple.getFirst().getValue().booleanValue() && TextUtils.isEmpty(this.f44428OooO0o0)) {
                    new Handler(Looper.getMainLooper()).postDelayed(new com.facebook.OooO00o(1, this.f44427OooO0o, triple), 0L);
                }
                o000OOo.OooO00o(p382o0OOoo0o.o0OoOo0.OooO00o(composer2, 8), ComposableLambdaKt.composableLambda(composer2, 1777301820, true, new o000oOoO(this.f44429OooO0oO, triple)), composer2, 48);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public final boolean OooO00o(@NotNull String tag) {
        ...
        if (!OooO0OO.OooO00o(this.f44424OooO0Oo)) {
            return false;
        }
        Activity activity = this.f44424OooO0Oo;
        Intrinsics.checkNotNull(activity);
        View decorView = activity.getWindow().getDecorView();
        Intrinsics.checkNotNull(decorView, "null cannot be cast to non-null type android.view.ViewGroup");
        ViewGroup decorView2 = (ViewGroup) decorView;
        Oooo0 oooo0 = this.f44425OooO0o0;
        oooo0.getClass();
        Intrinsics.checkNotNullParameter(tag, "tag");
        Intrinsics.checkNotNullParameter(decorView2, "decorView");
        HashMap<String, Triple<MutableState<Boolean>, ComposeView, Boolean>> map = oooo0.f44420OooO00o;
    ...
    public final MutableState<Boolean> showDialog(@Nullable String tag, @NotNull Function3<? super MutableState<Boolean>, ? super Composer, ? super Integer, Unit> content) {
        ...
        Oooo0 oooo0 = this.f44425OooO0o0;
        if (zIsEmpty) {
            Activity activity2 = this.f44424OooO0Oo;
            ...
            Activity activity3 = this.f44424OooO0Oo;
        ...
        if (triple.getThird().booleanValue()) {
            o000OOo.OooO0Oo(triple.getSecond(), ComposableLambdaKt.composableLambdaInstance(396755257, true, new OooO00o(triple, tag, window, content)));
        }
