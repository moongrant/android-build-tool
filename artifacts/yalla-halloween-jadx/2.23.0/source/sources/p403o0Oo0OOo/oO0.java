...
public final class oO0 implements oOo00ooO {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final RoomDatabase f44605OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final oO0OO00o f44606OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final oOo000Oo f44607OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final oOo0000O f44608OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final oOo000o0 f44609OooO0o0;

    public class OooO00o implements Callable<Integer> {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final /* synthetic */ RoomSQLiteQuery f44610OooO00o;

        public OooO00o(RoomSQLiteQuery roomSQLiteQuery) {
            this.f44610OooO00o = roomSQLiteQuery;
        }

        @Override // java.util.concurrent.Callable
        public final Integer call() throws Exception {
            Cursor cursorOooO0O0 = o000O.OooO0O0.OooO0O0(oO0.this.f44605OooO00o, this.f44610OooO00o);
            try {
    ...
    public class OooO0O0 implements Callable<Integer> {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final /* synthetic */ RoomSQLiteQuery f44612OooO00o;

        public OooO0O0(RoomSQLiteQuery roomSQLiteQuery) {
            this.f44612OooO00o = roomSQLiteQuery;
        }

        @Override // java.util.concurrent.Callable
        public final Integer call() throws Exception {
            Cursor cursorOooO0O0 = o000O.OooO0O0.OooO0O0(oO0.this.f44605OooO00o, this.f44612OooO00o);
            try {
                return (!cursorOooO0O0.moveToFirst() || cursorOooO0O0.isNull(0)) ? null : Integer.valueOf(cursorOooO0O0.getInt(0));
            } finally {
                cursorOooO0O0.close();
    ...
    public class OooO0OO implements Callable<Integer> {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final /* synthetic */ RoomSQLiteQuery f44614OooO00o;

        public OooO0OO(RoomSQLiteQuery roomSQLiteQuery) {
            this.f44614OooO00o = roomSQLiteQuery;
        }

        @Override // java.util.concurrent.Callable
        public final Integer call() throws Exception {
            Cursor cursorOooO0O0 = o000O.OooO0O0.OooO0O0(oO0.this.f44605OooO00o, this.f44614OooO00o);
            try {
                return (!cursorOooO0O0.moveToFirst() || cursorOooO0O0.isNull(0)) ? null : Integer.valueOf(cursorOooO0O0.getInt(0));
            } finally {
                cursorOooO0O0.close();
        ...
        public final void finalize() {
            this.f44614OooO00o.release();
        }
    }

    public oO0(YlAppDataBase ylAppDataBase) {
        this.f44605OooO00o = ylAppDataBase;
        this.f44606OooO0O0 = new oO0OO00o(ylAppDataBase);
        this.f44607OooO0OO = new oOo000Oo(ylAppDataBase);
        this.f44608OooO0Oo = new oOo0000O(ylAppDataBase);
        this.f44609OooO0o0 = new oOo000o0(ylAppDataBase);
    }

    @Override // p403o0Oo0OOo.oOo00ooO
    public final void OooO(long j) {
        RoomDatabase roomDatabase = this.f44605OooO00o;
        roomDatabase.OooO0O0();
        oOo0000O ooo0000o = this.f44608OooO0Oo;
        SupportSQLiteStatement supportSQLiteStatementOooO00o = ooo0000o.OooO00o();
        ...
        try {
            ...
            roomDatabase.OooOO0();
            ooo0000o.OooO0OO(supportSQLiteStatementOooO00o);
        }
    }
    ...
    public final void OooO00o(long j) {
        RoomDatabase roomDatabase = this.f44605OooO00o;
        roomDatabase.OooO0O0();
        oOo000Oo ooo000oo = this.f44607OooO0OO;
        SupportSQLiteStatement supportSQLiteStatementOooO00o = ooo000oo.OooO00o();
        supportSQLiteStatementOooO00o.bindLong(1, 0);
        supportSQLiteStatementOooO00o.bindLong(2, j);
        roomDatabase.OooO0OO();
        try {
            ...
            roomDatabase.OooOO0();
            ooo000oo.OooO0OO(supportSQLiteStatementOooO00o);
        }
    }
    ...
    public final void OooO0O0(SimpleMessage simpleMessage) {
        ...
        roomDatabase.OooO0OO();
        try {
            this.f44606OooO0O0.OooO0o(simpleMessage);
            roomDatabase.OooOOO0();
        } finally {
            roomDatabase.OooOO0();
        }
    ...
    public final SimpleMessage OooO0OO(long j) {
        ...
        try {
            ...
            int iOooO00o2 = o000O.OooO00o.OooO00o(cursorOooO0O0, "type");
            int iOooO00o3 = o000O.OooO00o.OooO00o(cursorOooO0O0, "time");
            int iOooO00o4 = o000O.OooO00o.OooO00o(cursorOooO0O0, "content");
            int iOooO00o5 = o000O.OooO00o.OooO00o(cursorOooO0O0, "activityNum");
            int iOooO00o6 = o000O.OooO00o.OooO00o(cursorOooO0O0, "fansNum");
            int iOooO00o7 = o000O.OooO00o.OooO00o(cursorOooO0O0, "visitorNum");
    ...
    public final Flow<Integer> OooO0o(long j) {
        ...
        return o000O0O0.OooO0OO.OooO00o(this.f44605OooO00o, new String[]{"SimpleMessageTable"}, oooO0O0);
    }
    ...
    public final Flow<Integer> OooO0o0(long j) {
        ...
        return o000O0O0.OooO0OO.OooO00o(this.f44605OooO00o, new String[]{"SimpleMessageTable"}, oooO0OO);
    }
    ...
    public final void OooO0oo(long j) {
        RoomDatabase roomDatabase = this.f44605OooO00o;
        roomDatabase.OooO0O0();
        oOo000o0 ooo000o0 = this.f44609OooO0o0;
        SupportSQLiteStatement supportSQLiteStatementOooO00o = ooo000o0.OooO00o();
        supportSQLiteStatementOooO00o.bindLong(1, 0);
        supportSQLiteStatementOooO00o.bindLong(2, j);
        roomDatabase.OooO0OO();
        try {
            ...
            roomDatabase.OooOO0();
            ooo000o0.OooO0OO(supportSQLiteStatementOooO00o);
        }
    }
    ...
    public final Flow<Integer> OooOO0(long j) {
        ...
        return o000O0O0.OooO0OO.OooO00o(this.f44605OooO00o, new String[]{"SimpleMessageTable"}, oooO00o);
    }
}
