...
public final class e0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f44814OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ Function1<Response<ArrayList<TopicInfoModel>>, Unit> f44815OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ int f44816OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public e0(int i, Function1<? super Response<ArrayList<TopicInfoModel>>, Unit> function1, Continuation<? super e0> continuation) {
        super(2, continuation);
        this.f44816OooO0o0 = i;
        this.f44815OooO0o = function1;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new e0(this.f44816OooO0o0, this.f44815OooO0o, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f44814OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            this.f44814OooO0Oo = 1;
            String strOooO0Oo = o000OOo0.OooO0Oo(o0000O.f44158o0000o);
            o0O0ooO o0o0oooOooO00o = o00oOoo.OooO00o(strOooO0Oo, "url", strOooO0Oo, 0);
            o0o0oooOooO00o.OooO0O0(String.valueOf(this.f44816OooO0o0), "pageindex");
            objOooO0Oo = OooOOO.OooO0Oo(new TopicRepo$loadJoinTopic$$inlined$call$1(o0o0oooOooO00o, null), this);
        ...
        Function1<Response<ArrayList<TopicInfoModel>>, Unit> function1 = this.f44815OooO0o;
        if (zIsSuccess) {
