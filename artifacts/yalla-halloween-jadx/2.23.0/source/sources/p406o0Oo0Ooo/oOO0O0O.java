...
public final class oOO0O0O {
    ...
    @NotNull
    public static final oOO0O0O f44944OooO00o = new oOO0O0O();
    ...
    public static final class OooO00o extends ContinuationImpl {
        ...
        public /* synthetic */ Object f44945OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f44946OooO0o;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f44945OooO0Oo = obj;
            this.f44946OooO0o |= Integer.MIN_VALUE;
            return oOO0O0O.this.OooO00o(0L, this);
        }
    }
    ...
    public static final class OooO0O0 extends ContinuationImpl {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public /* synthetic */ Object f44948OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f44949OooO0o;
        ...
        @Nullable
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f44948OooO0Oo = obj;
            this.f44949OooO0o |= Integer.MIN_VALUE;
            return oOO0O0O.this.OooO0Oo(this);
        }
    }
    ...
    public static final class OooO0OO extends ContinuationImpl {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public /* synthetic */ Object f44951OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f44952OooO0o;
        ...
        @Nullable
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f44951OooO0Oo = obj;
            this.f44952OooO0o |= Integer.MIN_VALUE;
            return oOO0O0O.this.OooO0o0(0L, this);
        }
    }
    ...
    public static String OooO0O0(long j, @NotNull String defaultValue) {
        ...
        String strOooO00o = o0o00OooOOo.OooO00o(((Number) androidx.compose.ui.graphics.colorspace.OooO0OO.OooO0O0()).longValue(), j);
    ...
    public static void OooO0OO(long j, @NotNull TextView tagView, @NotNull String defaultValue, @NotNull Function1 block) {
        ...
        tagView.setTag(oO00O0oO.tag_friend_memo_name_tag, Long.valueOf(j));
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), Dispatchers.getIO(), null, new oOO0OO0O(j, tagView, defaultValue, null, block), 2, null);
    }
    ...
    public static void OooO0o(@NotNull Friend friend) {
        ...
        o0O00 o0o00OooOOo = o000OOo.OooO00o().OooOOo();
        o000000O o000000o2 = o000000O.f46674OooO00o;
        Friend friendOooO0OO = o0o00OooOOo.OooO0OO(((Number) androidx.compose.ui.graphics.colorspace.OooO0OO.OooO0O0()).longValue(), friend.getFriendId());
        ...
        o000OOo.OooO00o().OooOOo().OooOO0o(friend);
    }
    ...
    public final Object OooO00o(long j, @NotNull Continuation<? super ApiResult<Integer>> continuation) {
        ...
        if (continuation instanceof OooO00o) {
            ...
            int i = oooO00o.f44946OooO0o;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO00o.f44946OooO0o = i - Integer.MIN_VALUE;
            } else {
    ...
    public final Object OooO0Oo(@NotNull Continuation<? super ApiResult<FriendInRoomModel>> continuation) {
        ...
        if (continuation instanceof OooO0O0) {
            ...
            int i = oooO0O0.f44949OooO0o;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO0O0.f44949OooO0o = i - Integer.MIN_VALUE;
            } else {
        ...
        Object objUserCompanionsInRoomList = oooO0O0.f44948OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = oooO0O0.f44949OooO0o;
        try {
            if (i2 == 0) {
                ResultKt.throwOnFailure(objUserCompanionsInRoomList);
                MainApiService mainApiServiceOooO00o = o0000O00.OooO00o();
                oooO0O0.f44949OooO0o = 1;
    ...
    public final Object OooO0o0(long j, @NotNull Continuation<? super ApiResult<List<UserInfoModel>>> continuation) {
        ...
        if (continuation instanceof OooO0OO) {
            ...
            int i = oooO0OO.f44952OooO0o;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO0OO.f44952OooO0o = i - Integer.MIN_VALUE;
            } else {
        ...
        Object objUserCompanionsList = oooO0OO2.f44951OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = oooO0OO2.f44952OooO0o;
        try {
            if (i2 == 0) {
                ResultKt.throwOnFailure(objUserCompanionsList);
                MainApiService mainApiServiceOooO00o = o0000O00.OooO00o();
                oooO0OO2.f44952OooO0o = 1;
