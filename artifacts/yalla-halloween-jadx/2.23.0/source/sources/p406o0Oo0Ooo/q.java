...
public final class q {
    ...
    @NotNull
    public static final q f45097OooO00o = new q();
    ...
    public static final class OooO00o extends ContinuationImpl {
        ...
        public /* synthetic */ Object f45098OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f45099OooO0o;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f45098OooO0Oo = obj;
            this.f45099OooO0o |= Integer.MIN_VALUE;
            return q.this.OooO00o(null, this);
        }
    }
    ...
    public final Object OooO00o(@NotNull String str, @NotNull Continuation<? super ApiResult<String>> continuation) {
        ...
        if (continuation instanceof OooO00o) {
            ...
            int i = oooO00o.f45099OooO0o;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO00o.f45099OooO0o = i - Integer.MIN_VALUE;
            } else {
        ...
        Object objYallaChatBindTask = oooO00o.f45098OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = oooO00o.f45099OooO0o;
        try {
            if (i2 == 0) {
                ResultKt.throwOnFailure(objYallaChatBindTask);
                TaskService taskServiceOooO00o = o000O0Oo.OooO00o();
                oooO00o.f45099OooO0o = 1;
