...
public final class u extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f45151OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ Function1<Response<TopicCreateCheckModel>, Unit> f45152OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public u(Function1<? super Response<TopicCreateCheckModel>, Unit> function1, Continuation<? super u> continuation) {
        super(2, continuation);
        this.f45152OooO0o0 = function1;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new u(this.f45152OooO0o0, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f45151OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            this.f45151OooO0Oo = 1;
            String strOooO0Oo = o000OOo0.OooO0Oo(o0000O.f44152o0000OOO);
            objOooO0Oo = OooOOO.OooO0Oo(new TopicRepo$checkCreateTopicState$$inlined$call$1(o00oOoo.OooO00o(strOooO0Oo, "url", strOooO0Oo, 0), null), this);
        ...
        Function1<Response<TopicCreateCheckModel>, Unit> function1 = this.f45152OooO0o0;
        if (zIsSuccess) {
