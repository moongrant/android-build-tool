...
public final class w extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f45156OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ Function1<Response<Boolean>, Unit> f45157OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ String f45158OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public w(String str, Function1<? super Response<Boolean>, Unit> function1, Continuation<? super w> continuation) {
        super(2, continuation);
        this.f45158OooO0o0 = str;
        this.f45157OooO0o = function1;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new w(this.f45158OooO0o0, this.f45157OooO0o, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f45156OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            String strOooOO0 = o0000O0O.OooOO0(this.f45158OooO0o0);
            this.f45156OooO0Oo = 1;
            ...
            o0o0ooo.OooO0O0(String.valueOf(1), "type");
        ...
        Function1<Response<Boolean>, Unit> function1 = this.f45157OooO0o;
        if (zIsSuccess) {
