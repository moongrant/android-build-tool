...
public final class o00Oo0 extends Oooo000 {
    ...
    public final double[] f45315OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final double[][] f45316OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final double[] f45317OooO0OO;

    public o00Oo0(double[] dArr, double[][] dArr2) {
        int length = dArr.length;
        int length2 = dArr2[0].length;
        this.f45317OooO0OO = new double[length2];
        this.f45315OooO00o = dArr;
        this.f45316OooO0O0 = dArr2;
        if (length2 > 2) {
            double d = 0.0d;
            int i = 0;
            while (i < dArr.length) {
    ...
    public final double OooO0O0(double d) {
        ...
        double d3;
        double dOooO0o0;
        double[] dArr = this.f45315OooO00o;
        int length = dArr.length;
        double d4 = dArr[0];
        double[][] dArr2 = this.f45316OooO0O0;
        if (d <= d4) {
            d2 = dArr2[0][0];
            d3 = d - d4;
            dOooO0o0 = OooO0o0(d4);
    ...
    public final void OooO0OO(double d, double[] dArr) {
        double[] dArr2 = this.f45315OooO00o;
        int length = dArr2.length;
        double[][] dArr3 = this.f45316OooO0O0;
        int i = 0;
        int length2 = dArr3[0].length;
        double d2 = dArr2[0];
        double[] dArr4 = this.f45317OooO0OO;
        if (d <= d2) {
            OooO0o(d2, dArr4);
    ...
    public final void OooO0Oo(double d, float[] fArr) {
        ...
        int length2 = dArr2[0].length;
        double d2 = dArr[0];
        double[] dArr3 = this.f45317OooO0OO;
        if (d <= d2) {
            OooO0o(d2, dArr3);
            for (int i2 = 0; i2 < length2; i2++) {
