...
public final class o0000O00 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f45494OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ int f45495OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ int f45496OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0000O00(int i, int i2, Continuation<? super o0000O00> continuation) {
        super(2, continuation);
        this.f45496OooO0o0 = i;
        this.f45495OooO0o = i2;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o0000O00(this.f45496OooO0o0, this.f45495OooO0o, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f45494OooO0Oo;
        int i2 = this.f45496OooO0o0;
        try {
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                int i3 = this.f45495OooO0o;
                MainApiService mainApiServiceOooO00o = p377o0OOoOo.o0000O00.OooO00o();
                this.f45494OooO0Oo = 1;
