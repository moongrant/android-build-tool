...
public final class o000OOo implements TextureView.SurfaceTextureListener {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ OooO f46068OooO0Oo;

    public class OooO00o implements OooOOO0<SurfaceRequest.Result> {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final /* synthetic */ SurfaceTexture f46069OooO00o;

        public OooO00o(SurfaceTexture surfaceTexture) {
            this.f46069OooO00o = surfaceTexture;
        }
        ...
        public final void onSuccess(SurfaceRequest.Result result) {
            ...
            this.f46069OooO00o.release();
            OooO oooO = o000OOo.this.f46068OooO0Oo;
    ...
    public o000OOo(OooO oooO) {
        this.f46068OooO0Oo = oooO;
    }
    ...
    public final void onSurfaceTextureAvailable(@NonNull SurfaceTexture surfaceTexture, int i, int i2) {
        ...
        oooO.f4101OooO0oo.f3513OooOO0O.OooO00o();
    }
    ...
    public final boolean onSurfaceTextureDestroyed(@NonNull SurfaceTexture surfaceTexture) {
        ...
        o00O000.OooO0o oooO0o = oooO.f4100OooO0oO;
        if (oooO0o == null) {
            o00O0O0.OooO00o("TextureViewImpl", "SurfaceTexture about to be destroyed");
            return true;
        }
        OooO00o oooO00o = new OooO00o(surfaceTexture);
        oooO0o.OooO(new OooOo00.OooO0O0(oooO0o, oooO00o), ContextCompat.OooO0OO(oooO.f4099OooO0o0.getContext()));
    ...
    public final void onSurfaceTextureUpdated(@NonNull SurfaceTexture surfaceTexture) {
        o00O000.OooO00o<Void> andSet = this.f46068OooO0Oo.f4103OooOO0O.getAndSet(null);
        if (andSet != null) {
            andSet.OooO0O0(null);
        }
    }
