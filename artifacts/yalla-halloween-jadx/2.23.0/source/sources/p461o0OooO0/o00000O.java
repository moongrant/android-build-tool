...
public final class o00000O {
    ...
    public static final Charset f46628OooO0O0 = Charset.forName("UTF-8");

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final OooOo00 f46629OooO00o;

    public o00000O(OooOo00 oooOo00) {
        this.f46629OooO00o = oooOo00;
    }
    ...
    public final Map<String, String> OooO0O0(String str, boolean z) throws Throwable {
        ...
        Exception e;
        OooOo00 oooOo00 = this.f46629OooO00o;
            ...
            if (length != 0) {
                ...
                try {
                    try {
                        ...
                        try {
                            HashMap mapOooO00o = OooO00o(o000oOoO.OooOO0o(fileInputStream));
                            o000oOoO.OooO00o(fileInputStream, "Failed to close user metadata file.");
                            return mapOooO00o;
                        } catch (Exception e2) {
                            e = e2;
                        ...
                        th = th;
                        r8 = length;
                        o000oOoO.OooO00o(r8, "Failed to close user metadata file.");
                        throw th;
                    }
                } catch (Exception e3) {
    ...
    public final String OooO0OO(String str) {
        FileInputStream fileInputStream;
        File fileOooO0O0 = this.f46629OooO00o.OooO0O0(str, "user-data");
        ?? r4 = 0;
        if (fileOooO0O0.exists()) {
            ...
            try {
                if (r3 != 0) {
                    try {
                        fileInputStream = new FileInputStream(fileOooO0O0);
                        try {
                            JSONObject jSONObject = new JSONObject(o000oOoO.OooOO0o(fileInputStream));
                        ...
                        th = th;
                        o000oOoO.OooO00o(r4, "Failed to close user metadata file.");
                        throw th;
                    }
                }
            } catch (Throwable th2) {
