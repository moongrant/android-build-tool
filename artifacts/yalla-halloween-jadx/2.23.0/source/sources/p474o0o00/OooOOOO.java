...
public final class OooOOOO implements Observer<Object> {
    ...
    public final /* synthetic */ AccountProtectionActivity f47218OooO0Oo;

    public OooOOOO(AccountProtectionActivity accountProtectionActivity) {
        this.f47218OooO0Oo = accountProtectionActivity;
    }

    @Override // androidx.lifecycle.Observer
    public final void onChanged(Object obj) {
        int i = AccountProtectionActivity.f25146OooOo0O;
        AccountProtectionActivity accountProtectionActivity = this.f47218OooO0Oo;
