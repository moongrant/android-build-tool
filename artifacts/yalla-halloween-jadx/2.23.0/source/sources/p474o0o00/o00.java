...
public final class o00 extends Lambda implements Function1<View, Unit> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ LoginOnRoomDialogActivity f47225OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00(LoginOnRoomDialogActivity loginOnRoomDialogActivity) {
        super(1);
        this.f47225OooO0Oo = loginOnRoomDialogActivity;
    }
    ...
    public final Unit invoke(View view) {
        ...
        LoginOnRoomDialogActivity loginOnRoomDialogActivity = this.f47225OooO0Oo;
