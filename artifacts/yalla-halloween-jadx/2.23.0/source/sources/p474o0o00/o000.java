...
public final class o000 extends Lambda implements Function1<View, Unit> {
    ...
    public final /* synthetic */ LoginActivity f47226OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o000(LoginActivity loginActivity) {
        super(1);
        this.f47226OooO0Oo = loginActivity;
    }
    ...
    public final Unit invoke(View view) {
        ...
        WebActivity.OooO00o.OooO00o(this.f47226OooO0Oo, webPageInfo);
