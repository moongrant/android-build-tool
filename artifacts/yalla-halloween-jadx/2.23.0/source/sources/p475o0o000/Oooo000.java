...
public class Oooo000 {
    ...
    public static MutableLiveData OooO00o(@NotNull Function0 initializer) {
        ...
        OooO00o.f24973OooO00o.add(new o0OOO0o(mutableLiveData, initializer));
    ...
    public static MutableStateFlow OooO0O0(@NotNull Function0 initializer) {
        ...
        ArrayList arrayList = OooO00o.f24973OooO00o;
        OooO00o.f24974OooO0O0.add(new o00000O0(MutableStateFlow, initializer));
    ...
    public static MutableState OooO0OO(@NotNull Function0 initializer) {
        ...
        ArrayList arrayList = OooO00o.f24973OooO00o;
        OooO00o.f24975OooO0OO.add(new o00000O(mutableStateMutableStateOf$default, initializer));
