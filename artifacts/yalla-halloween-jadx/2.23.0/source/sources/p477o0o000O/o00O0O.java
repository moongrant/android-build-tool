...
public final class o00O0O extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ int f47617OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00O0O(int i, Continuation<? super o00O0O> continuation) {
        super(2, continuation);
        this.f47617OooO0Oo = i;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o00O0O(this.f47617OooO0Oo, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        oo0O oo0o = (oo0O) CollectionsKt.getOrNull(OooO00o.f24979OooO0oO.f47380OooOO0O, this.f47617OooO0Oo - 1);
