...
public final class OooOo extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        ResultKt.throwOnFailure(obj);
        this.f47690OooO0Oo = 1;
        if (DelayKt.delay(60000L, this) == coroutine_suspended) {
            return coroutine_suspended;
        }
        OooOo00 oooOo00 = OooOo00.f47691OooO00o;
        this.f47690OooO0Oo = 2;
        if (OooOo00.OooO00o(oooOo00, this) == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Unit.INSTANCE;
    }
