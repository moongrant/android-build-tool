...
public final class o0Oo0oo {
    ...
    @NotNull
    public static final Lazy f47701OooO00o = LazyKt.lazy(OooO00o.f47702OooO0Oo);

    public static final class OooO00o extends Lambda implements Function0<SimpleDateFormat> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO00o f47702OooO0Oo = new OooO00o();
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public CustomLogModel f47703OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ CustomLogModel f47704OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public int f47705OooO0o0;
        ...
        /* JADX INFO: renamed from: o0o000oO.o0Oo0oo$OooO0O0$OooO0O0, reason: collision with other inner class name */
        @DebugMetadata(c = "com.yalla.yalla.statistical.net.FLog$equipPhoneInfo$1$2", f = "FLog.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
        public static final class C0481OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Boolean>, Object> {
            public C0481OooO0O0(Continuation<? super C0481OooO0O0> continuation) {
                super(2, continuation);
            }
            ...
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                return new C0481OooO0O0(continuation);
            }

            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Boolean> continuation) {
                return new C0481OooO0O0(continuation).invokeSuspend(Unit.INSTANCE);
            }
        ...
        public OooO0O0(CustomLogModel customLogModel, Continuation<? super OooO0O0> continuation) {
            super(2, continuation);
            this.f47704OooO0o = customLogModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0O0(this.f47704OooO0o, continuation);
        }
        ...
        /* JADX WARN: Code duplicated, block: B:30:0x0087 A[Catch: Exception -> 0x009e, NumberFormatException -> 0x00a0, TryCatch #2 {NumberFormatException -> 0x00a0, Exception -> 0x009e, blocks: (B:8:0x001a, B:43:0x00a4, B:45:0x00c7, B:46:0x00cd, B:13:0x0029, B:30:0x0087, B:16:0x002f, B:26:0x0075, B:19:0x0036, B:21:0x0062), top: B:52:0x0010 }] */
        ...
        /* JADX WARN: Code duplicated, block: B:45:0x00c7 A[Catch: Exception -> 0x009e, NumberFormatException -> 0x00a0, TryCatch #2 {NumberFormatException -> 0x00a0, Exception -> 0x009e, blocks: (B:8:0x001a, B:43:0x00a4, B:45:0x00c7, B:46:0x00cd, B:13:0x0029, B:30:0x0087, B:16:0x002f, B:26:0x0075, B:19:0x0036, B:21:0x0062), top: B:52:0x0010 }] */
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f47705OooO0o0;
            boolean z = true;
            CustomLogModel customLogModel3 = this.f47704OooO0o;
            try {
                if (i == 0) {
                    ResultKt.throwOnFailure(obj);
                    customLogModel3.setTime(o0Oo0oo.OooO0O0());
                    NetworkType networkType = NetworkStateUtil.INSTANCE.networkType(o000O0.OooO00o());
                    ...
                    if (Intrinsics.areEqual("INFO", customLogModel3.getLevel())) {
                        ...
                        this.f47703OooO0Oo = customLogModel3;
                        this.f47705OooO0o0 = 1;
                    ...
                    customLogModel3.addParams("operator", NetworkStateUtil.INSTANCE.networkOperatorName(o000O0.OooO00o()));
                ...
                if (i == 1) {
                    ...
                    if (i == 2) {
                        ...
                        if (obj == null) {
                            ...
                            this.f47703OooO0Oo = customLogModel;
                            this.f47705OooO0o0 = 3;
                    ...
                    customLogModel2 = this.f47703OooO0Oo;
                    ResultKt.throwOnFailure(obj);
                }
                if (obj != null) {
                    customLogModel = customLogModel2;
                ...
                return Unit.INSTANCE;
                if (obj == null) {
                    C0481OooO0O0 c0481OooO0O0 = new C0481OooO0O0(null);
                    this.f47703OooO0Oo = customLogModel;
                    this.f47705OooO0o0 = 2;
                    obj = TimeoutKt.withTimeoutOrNull(5000L, c0481OooO0O0, this);
                    if (obj == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    if (obj == null) {
    ...
    public static String OooO0O0() {
        String str = ((SimpleDateFormat) f47701OooO00o.getValue()).format(new Date(System.currentTimeMillis()));
    ...
    public static void OooO0OO(@NotNull RoomEventType tag) {
        ...
        customLogModel.addParams("room_id", String.valueOf(oooO00o.OooO00o().f25001OooO0Oo.getValue()));
        customLogModel.addParams("room_idx", String.valueOf(oooO00o.OooO00o().f25000OooO0OO.getValue()));
