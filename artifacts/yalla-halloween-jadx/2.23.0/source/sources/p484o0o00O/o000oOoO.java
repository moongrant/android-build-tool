...
public final class o000oOoO extends Lambda implements Function1<View, Unit> {
    ...
    public final /* synthetic */ MomentReplyHeaderView f47743OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o000oOoO(MomentReplyHeaderView momentReplyHeaderView) {
        super(1);
        this.f47743OooO0Oo = momentReplyHeaderView;
    }
    ...
    public final Unit invoke(View view) {
        ...
        MomentReplyHeaderView momentReplyHeaderView = this.f47743OooO0Oo;
