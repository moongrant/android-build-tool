...
public final class o00oO0o extends Lambda implements Function1<View, Unit> {
    ...
    public final /* synthetic */ MomentReplyHeaderView f47747OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00oO0o(MomentReplyHeaderView momentReplyHeaderView) {
        super(1);
        this.f47747OooO0Oo = momentReplyHeaderView;
    }
    ...
    public final Unit invoke(View view) {
        ...
        MomentReplyHeaderView momentReplyHeaderView = this.f47747OooO0Oo;
