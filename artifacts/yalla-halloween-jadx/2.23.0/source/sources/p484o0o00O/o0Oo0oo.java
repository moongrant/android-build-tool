...
public final class o0Oo0oo extends Lambda implements Function1<View, Unit> {
    ...
    public final /* synthetic */ MomentReplyHeaderView f47751OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0Oo0oo(MomentReplyHeaderView momentReplyHeaderView) {
        super(1);
        this.f47751OooO0Oo = momentReplyHeaderView;
    }
    ...
    public final Unit invoke(View view) {
        ...
        MomentReplyHeaderView momentReplyHeaderView = this.f47751OooO0Oo;
