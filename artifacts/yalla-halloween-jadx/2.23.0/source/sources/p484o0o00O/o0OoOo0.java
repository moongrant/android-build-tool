...
public final class o0OoOo0 extends Lambda implements Function1<View, Unit> {
    ...
    public final /* synthetic */ MomentReplyHeaderView f47752OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0OoOo0(MomentReplyHeaderView momentReplyHeaderView) {
        super(1);
        this.f47752OooO0Oo = momentReplyHeaderView;
    }
    ...
    public final Unit invoke(View view) {
        ...
        MomentReplyHeaderView momentReplyHeaderView = this.f47752OooO0Oo;
