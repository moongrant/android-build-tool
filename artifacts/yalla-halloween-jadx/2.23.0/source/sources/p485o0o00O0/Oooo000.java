...
public final class Oooo000 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ AddTopicListActivity f47773OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public Oooo000(AddTopicListActivity addTopicListActivity) {
        super(2);
        this.f47773OooO0Oo = addTopicListActivity;
    }
    ...
    public final Unit invoke(Composer composer, Integer num) {
        ...
        if ((iIntValue & 11) == 2 && composer2.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(548062655, iIntValue, -1, "com.yalla.yalla.ui.activity.moment.AddTopicListActivity.initView.<anonymous> (AddTopicListActivity.kt:156)");
            }
            ...
            t1.OooO00o(StringResources_androidKt.stringResource(oO00OOo0.Add_a_topic, composer2, 0), 0.0f, 0L, Integer.valueOf(oOo00OO0.icv_close), null, null, null, null, null, composer2, 0, YallaTeamMessage.JumpId.RoomList_Recommended);
            ...
            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = new OooOOO(current, null);
            ...
            AddTopicListActivity addTopicListActivity = this.f47773OooO0Oo;
            j1Var.OooO00o(new OooOOOO(addTopicListActivity), new OooOo00(addTopicListActivity), new OooOo(addTopicListActivity), null, strStringResource, 0L, false, 0L, null, 0, null, null, null, 0L, 0L, 0, composer2, 1572864, 2097152, 65448);
