...
public final class o000OOo extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MomentDetailActivity f47825OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o000OOo(MomentDetailActivity momentDetailActivity) {
        super(0);
        this.f47825OooO0Oo = momentDetailActivity;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        int i = MomentDetailActivity.f26057Oooo0;
        MomentDetailActivity momentDetailActivity = this.f47825OooO0Oo;
