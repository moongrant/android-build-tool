...
public final class o000OOo0 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MomentDetailActivity f47826OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o000OOo0(MomentDetailActivity momentDetailActivity) {
        super(0);
        this.f47826OooO0Oo = momentDetailActivity;
    }
    ...
    public final Unit invoke() {
        ...
        MomentDetailActivity momentDetailActivity = this.f47826OooO0Oo;
