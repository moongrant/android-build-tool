...
public final class o00O0000 extends Lambda implements Function3<RowScope, Composer, Integer, Unit> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ MomentDetailActivity f47833OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00O0000(MomentDetailActivity momentDetailActivity) {
        super(3);
        this.f47833OooO0Oo = momentDetailActivity;
    }
    ...
    public final Unit invoke(RowScope rowScope, Composer composer, Integer num) {
        ...
        if ((iIntValue & 81) == 16 && composer2.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(618776751, iIntValue, -1, "com.yalla.yalla.ui.activity.moment.MomentDetailActivity.initView.<anonymous>.<anonymous>.<anonymous> (MomentDetailActivity.kt:293)");
            }
            ...
            MomentDetailActivity momentDetailActivity = this.f47833OooO0Oo;
