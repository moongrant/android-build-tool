...
public final class o00O0OO implements Observer<Object> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ MomentReplyActivity f47843OooO0Oo;

    public o00O0OO(MomentReplyActivity momentReplyActivity) {
        this.f47843OooO0Oo = momentReplyActivity;
    }
    ...
    public final void onChanged(@NotNull Object result) {
        ...
        if (((Boolean) result).booleanValue()) {
            MomentReplyActivity momentReplyActivity = this.f47843OooO0Oo;
            ...
            if (headerLayout != null) {
                ...
                MomentCommentDetailModel currentComment3 = momentReplyActivity.OooOoO().getCurrentComment();
                Intrinsics.checkNotNull(currentComment3);
                headerLayout.setTitle(o0000O.OooO00o(string, oo0ooO.OooO00o(currentComment3.getNum())));
            }
        }
    }
}
