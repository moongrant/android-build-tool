...
public final class oO00O0o implements Observer<OnTopPostForTopicModel> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ TopicDetailActivity f48045OooO0Oo;

    public oO00O0o(TopicDetailActivity topicDetailActivity) {
        this.f48045OooO0Oo = topicDetailActivity;
    }
    ...
    public final void onChanged(OnTopPostForTopicModel onTopPostForTopicModel) {
        ...
        TopicDetailActivity topicDetailActivity = this.f48045OooO0Oo;
