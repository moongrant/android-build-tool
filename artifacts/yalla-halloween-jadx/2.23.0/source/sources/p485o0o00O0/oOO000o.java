...
public final class oOO000o implements Observer<String> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ TopicInfoActivity f48141OooO0Oo;

    public oOO000o(TopicInfoActivity topicInfoActivity) {
        this.f48141OooO0Oo = topicInfoActivity;
    }

    @Override // androidx.lifecycle.Observer
    public final void onChanged(String str) {
        String it = str;
        TopicInfoActivity topicInfoActivity = this.f48141OooO0Oo;
        ...
        if (topicInfoModel.isOwner()) {
            ...
            topicInfoModel2.setImage(it);
            topicInfoActivity.OooOoO().setTopicHead(it);
        }
    }
}
