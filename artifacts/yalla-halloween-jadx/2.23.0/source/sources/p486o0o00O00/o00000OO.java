...
public final class o00000OO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ RedemptionCodeVm f48255OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ String f48256OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00000OO(RedemptionCodeVm redemptionCodeVm, String str, Continuation<? super o00000OO> continuation) {
        super(2, continuation);
        this.f48255OooO0Oo = redemptionCodeVm;
        this.f48256OooO0o0 = str;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o00000OO(this.f48255OooO0Oo, this.f48256OooO0o0, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        Function1<String, Unit> searchTextSetter = this.f48255OooO0Oo.getSearchTextSetter();
        if (searchTextSetter != null) {
            String codeKey = this.f48256OooO0o0;
