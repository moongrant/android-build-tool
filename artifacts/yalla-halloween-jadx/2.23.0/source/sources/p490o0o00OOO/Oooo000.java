...
public final class Oooo000 {
    ...
    public static final class OooO extends Lambda implements Function0<Unit> {
        ...
        public final /* synthetic */ MutableState<Boolean> f48520OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(MutableState<Boolean> mutableState) {
            super(0);
            this.f48520OooO0Oo = mutableState;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            p490o0o00OOO.Oooo0 onLogin = new p490o0o00OOO.Oooo0(this.f48520OooO0Oo);
    ...
    public static final class OooO00o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ int f48521OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(int i) {
            super(2);
            this.f48521OooO0Oo = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            Oooo000.OooO00o(composer, RecomposeScopeImplKt.updateChangedFlags(this.f48521OooO0Oo | 1));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ State<Integer> f48522OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f48523OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(MutableState mutableState, State state, Continuation continuation) {
            super(2, continuation);
            this.f48522OooO0Oo = state;
            this.f48523OooO0o0 = mutableState;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0O0(this.f48523OooO0o0, this.f48522OooO0Oo, continuation);
        }
    ...
    public static final class OooO0OO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ int f48524OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(int i) {
            super(2);
            this.f48524OooO0Oo = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            Oooo000.OooO00o(composer, RecomposeScopeImplKt.updateChangedFlags(this.f48524OooO0Oo | 1));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ int f48525OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(int i) {
            super(2);
            this.f48525OooO0Oo = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            Oooo000.OooO00o(composer, RecomposeScopeImplKt.updateChangedFlags(this.f48525OooO0Oo | 1));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0 extends Lambda implements Function1<LayoutCoordinates, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooOO0 f48526OooO0Oo = new OooOO0();
        ...
        public final Unit invoke(LayoutCoordinates layoutCoordinates) {
            ...
            o00000O o00000o = o00000O.f54664OooO00o;
            o00000O.f54665OooO0O0.setValue(IntOffset.m3874boximpl(IntOffsetKt.IntOffset(com.code.android.util.o000000.OooO0Oo(Float.valueOf(Offset.m1436getXimpl(jPositionInWindow))), o0000O0.OooO00o(-50))));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0O extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function0<Unit> f48527OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0O(Function0<Unit> function0) {
            super(0);
            this.f48527OooO0Oo = function0;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            this.f48527OooO0Oo.invoke();
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOOO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function0<Unit> f48528OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f48529OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO(int i, Function0 function0) {
            super(2);
            this.f48528OooO0Oo = function0;
            this.f48529OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f48529OooO0o0 | 1);
            Oooo000.OooO0O0(this.f48528OooO0Oo, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOOO0 extends Lambda implements Function1<ContentDrawScope, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooOOO0 f48530OooO0Oo = new OooOOO0();
        ...
        public final Unit invoke(ContentDrawScope contentDrawScope) {
            ...
            float f2 = 100;
            androidx.compose.ui.graphics.drawscope.OooO0O0.Oooo0o(drawWithContent, j, OffsetKt.Offset(o0000O0.OooO00o(f), -o0000O0.OooO00o(4)), SizeKt.Size(o0000O0.OooO00o(19), o0000O0.OooO00o(13)), CornerRadiusKt.CornerRadius(drawWithContent.mo324toPx0680j_4(Dp.m3765constructorimpl(f2)), drawWithContent.mo324toPx0680j_4(Dp.m3765constructorimpl(f2))), null, 0.0f, null, 0, 240, null);
            Canvas nativeCanvas = AndroidCanvas_androidKt.getNativeCanvas(drawWithContent.getDrawContext().getCanvas());
            String strValueOf = String.valueOf(RangesKt.coerceIn(com.yalla.yalla.service.room.OooO00o.f24979OooO0oO.OooO0oO(), 0, 99));
            ...
            paint.setColor(o0000.OooO00o(oO00O0o.color_333333));
    ...
    public static final class OooOOOO extends Lambda implements Function1<LayoutCoordinates, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooOOOO f48531OooO0Oo = new OooOOOO();
    ...
    public static final class OooOo extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function0<Unit> f48532OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f48533OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOo(int i, Function0 function0) {
            super(2);
            this.f48532OooO0Oo = function0;
            this.f48533OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f48533OooO0o0 | 1);
            Oooo000.OooO0OO(this.f48532OooO0Oo, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOo00 extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function0<Unit> f48534OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOo00(Function0<Unit> function0) {
            super(0);
            this.f48534OooO0Oo = function0;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            this.f48534OooO0Oo.invoke();
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class Oooo0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ int f48535OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public Oooo0(int i) {
            super(2);
            this.f48535OooO0Oo = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            Oooo000.OooO0Oo(composer, RecomposeScopeImplKt.updateChangedFlags(this.f48535OooO0Oo | 1));
            return Unit.INSTANCE;
        }
    }

    /* JADX INFO: renamed from: o0o00OOO.Oooo000$Oooo000, reason: collision with other inner class name */
    public static final class C0484Oooo000 extends Lambda implements Function0<Unit> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ FragmentActivity f48536OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C0484Oooo000(FragmentActivity fragmentActivity) {
            super(0);
            this.f48536OooO0Oo = fragmentActivity;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            o0OO000.OooO00o("102060");
            FragmentActivity fragmentActivity = this.f48536OooO0Oo;
            if (fragmentActivity != null) {
                new oOO0O00O(fragmentActivity).OooO();
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class o000000 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ int f48537OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public o000000(int i) {
            super(2);
            this.f48537OooO0Oo = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            Oooo000.OooOO0(composer, RecomposeScopeImplKt.updateChangedFlags(this.f48537OooO0Oo | 1));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class o000OOo extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final o000OOo f48538OooO0Oo = new o000OOo();
        ...
        public final Unit invoke() {
            ...
            boolean zAreEqual;
            RoomLoginInformation roomLoginInformation = MixedRoomDataSource.OooO0o0().f23461OooO0o0;
            if (roomLoginInformation == null) {
                z = !com.yalla.yalla.service.room.OooO00o.f24979OooO0oO.f47373OooO0OO.getValue().booleanValue();
                if (z) {
                    str = "102055";
                } else {
                    str = "102056";
                ...
                o0OO000.OooO00o(str);
                p351o0OOOo0O.OooO.OooO0O0().OooO00o().OooOOOO(z);
                if (!z) {
                    mixedRoomDataSourceOooO0o0 = MixedRoomDataSource.OooO0o0();
                    if (mixedRoomDataSourceOooO0o0.f23458OooO == null) {
                        mixedRoomDataSourceOooO0o0.f23458OooO = new HashMap<>();
                    }
                    HashMap<Long, Boolean> map = mixedRoomDataSourceOooO0o0.f23458OooO;
                    Intrinsics.checkNotNullExpressionValue(map, "getInstance().muteSoundMap");
                ...
                com.yalla.yalla.service.room.OooO00o.f24979OooO0oO.f47373OooO0OO.setValue(Boolean.valueOf(z));
            } else {
                ...
                if (zAreEqual) {
                    ...
                    if (!z) {
                        ...
                        HashMap<Long, Boolean> map2 = mixedRoomDataSourceOooO0o0.f23458OooO;
                        Intrinsics.checkNotNullExpressionValue(map2, "getInstance().muteSoundMap");
                        while (r1.hasNext()) {
                            p351o0OOOo0O.OooOO0 oooOO0OooO00o2 = p351o0OOOo0O.OooO.OooO0O0().OooO00o();
                    ...
                    p592o0oo00O.OooOOO0.OooO00o(102, "RoomBottomDefaultComp", "switchMuteSound: 语音未登录房间静音被取消", null);
                }
            }
            return Unit.INSTANCE;
        }
    ...
    public static final class o000oOoO extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MixedRoomActivity f48539OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public o000oOoO(MixedRoomActivity mixedRoomActivity) {
            super(0);
            this.f48539OooO0Oo = mixedRoomActivity;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            MixedRoomActivity mixedRoomActivity = this.f48539OooO0Oo;
            if (mixedRoomActivity != null) {
                p490o0o00OOO.o000oOoO onLogin = new p490o0o00OOO.o000oOoO(mixedRoomActivity);
                Intrinsics.checkNotNullParameter(onLogin, "onLogin");
                o000000O o000000o2 = o000000O.f46674OooO00o;
                if (Intrinsics.areEqual(o000000O.OooOo0O().getValue(), Boolean.TRUE)) {
                    onLogin.invoke();
    ...
    public static final class o00O0O extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final o00O0O f48540OooO0Oo = new o00O0O();
        ...
        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            o0OO000.OooO0O0("102223", MapsKt.mapOf(new Pair("usertype", com.yalla.yalla.service.room.OooO0O0.f24995OoooOOO.OooO00o().f25008OooOO0o.getValue())));
            p490o0o00OOO.o0OoOo0 onLogin = p490o0o00OOO.o0OoOo0.f48668OooO0Oo;
            Intrinsics.checkNotNullParameter(onLogin, "onLogin");
            o000000O o000000o2 = o000000O.f46674OooO00o;
            if (Intrinsics.areEqual(o000000O.OooOo0O().getValue(), Boolean.TRUE)) {
                onLogin.invoke();
    ...
    public static final class o00Oo0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MutableLiveData<Pair<Integer, Integer>> f48541OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f48542OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public o00Oo0(int i, MutableLiveData mutableLiveData) {
            super(2);
            this.f48541OooO0Oo = mutableLiveData;
            this.f48542OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f48542OooO0o0 | 1);
            Oooo000.OooO0o(this.f48541OooO0Oo, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class o00Ooo extends Lambda implements Function1<LayoutCoordinates, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MutableLiveData<Pair<Integer, Integer>> f48543OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public o00Ooo(MutableLiveData<Pair<Integer, Integer>> mutableLiveData) {
            super(1);
            this.f48543OooO0Oo = mutableLiveData;
        }
        ...
        public final Unit invoke(LayoutCoordinates layoutCoordinates) {
            LayoutCoordinates it = layoutCoordinates;
            Intrinsics.checkNotNullParameter(it, "it");
            this.f48543OooO0Oo.setValue(new Pair<>(Integer.valueOf((int) Offset.m1436getXimpl(it.mo2804localToWindowMKHz9U(Offset.INSTANCE.m1452getZeroF1C5BW0()))), Integer.valueOf(IntSize.m3925getWidthimpl(it.mo2801getSizeYbymL2g()))));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class o00oO0o extends Lambda implements Function1<Context, View> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MutableState<View> f48544OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public o00oO0o(MutableState<View> mutableState) {
            super(1);
            this.f48544OooO0Oo = mutableState;
        }
        ...
        public final View invoke(Context context) {
            ...
            MutableState<View> mutableState = this.f48544OooO0Oo;
    ...
    public static final class o0O0O00 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ p489o0o00OO0.OooO0o f48545OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f48546OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public o0O0O00(p489o0o00OO0.OooO0o oooO0o, int i) {
            super(2);
            this.f48545OooO0Oo = oooO0o;
            this.f48546OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f48546OooO0o0 | 1);
            Oooo000.OooO(this.f48545OooO0Oo, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class o0OO00O extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final o0OO00O f48547OooO0Oo = new o0OO00O();
        ...
        public final Unit invoke() {
            ...
            if (MixedRoomDataSource.OooO0o0().f23461OooO0o0 != null) {
                RoomLiveService roomLiveService = RoomLiveService.f25058OooOo00;
                if (roomLiveService != null) {
                    RoomLoginInformation.RoomBean room = MixedRoomDataSource.OooO0o0().f23461OooO0o0.getRoom();
                    Intrinsics.checkNotNull(room);
                    zAreEqual = Intrinsics.areEqual(roomLiveService.OooO0OO(room.getId()), Boolean.TRUE);
                } else {
                    zAreEqual = false;
                ...
                if (zAreEqual) {
                    ...
                    boolean z = !o000000Var.f47372OooO0O0.getValue().booleanValue();
                    if (z) {
                        o0OO000.OooO00o("102057");
                    } else {
                        o0OO000.OooO00o("102058");
                    }
                    p592o0oo00O.OooOOO0.OooO0OO("麦变更", "switchMuteMike muteMike " + z);
                    o000000Var.f47372OooO0O0.setValue(Boolean.valueOf(z));
                } else {
                    p592o0oo00O.OooOOO0.OooO00o(102, "RoomBottomDefaultComp", "switchMuteMike: 语音未登录房间切换静麦被取消", null);
                }
            }
            return Unit.INSTANCE;
        }
    ...
    public static final class o0OOO0o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ State<Boolean> f48548OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ MutableState<TipsBubbleView> f48549OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MutableState<View> f48550OooO0o0;
        ...
        public o0OOO0o(State<Boolean> state, MutableState<View> mutableState, MutableState<TipsBubbleView> mutableState2, Continuation<? super o0OOO0o> continuation) {
            super(2, continuation);
            this.f48548OooO0Oo = state;
            this.f48550OooO0o0 = mutableState;
            this.f48549OooO0o = mutableState2;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new o0OOO0o(this.f48548OooO0Oo, this.f48550OooO0o0, this.f48549OooO0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            IntrinsicsKt.getCOROUTINE_SUSPENDED();
            ResultKt.throwOnFailure(obj);
            boolean zBooleanValue = this.f48548OooO0Oo.getValue().booleanValue();
            View value = this.f48550OooO0o0.getValue();
            TipsBubbleView value2 = this.f48549OooO0o.getValue();
    ...
    public static final class o0Oo0oo extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ int f48551OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public o0Oo0oo(int i) {
            super(2);
            this.f48551OooO0Oo = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            Oooo000.OooO0oO(composer, RecomposeScopeImplKt.updateChangedFlags(this.f48551OooO0Oo | 1));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class o0OoOo0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ int f48552OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public o0OoOo0(int i) {
            super(2);
            this.f48552OooO0Oo = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            Oooo000.OooO0o0(composer, RecomposeScopeImplKt.updateChangedFlags(this.f48552OooO0Oo | 1));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class o0ooOOo extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MixedRoomActivity f48553OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ MutableState<TipsBubbleView> f48554OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MutableState<View> f48555OooO0o0;
        ...
        public o0ooOOo(MixedRoomActivity mixedRoomActivity, MutableState<View> mutableState, MutableState<TipsBubbleView> mutableState2, Continuation<? super o0ooOOo> continuation) {
            super(2, continuation);
            this.f48553OooO0Oo = mixedRoomActivity;
            this.f48555OooO0o0 = mutableState;
            this.f48554OooO0o = mutableState2;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new o0ooOOo(this.f48553OooO0Oo, this.f48555OooO0o0, this.f48554OooO0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            IntrinsicsKt.getCOROUTINE_SUSPENDED();
            ResultKt.throwOnFailure(obj);
            MixedRoomActivity mixedRoomActivity = this.f48553OooO0Oo;
            if (mixedRoomActivity != null) {
                MutableState<View> mutableState = this.f48555OooO0o0;
                if (mutableState.getValue() != null) {
                    View value = mutableState.getValue();
                    Intrinsics.checkNotNull(value);
                    ViewGroup viewGroup = (ViewGroup) mixedRoomActivity.findViewById(oO00O0oO.v_room_root);
                    if (viewGroup.findViewWithTag("room_chat_tips") != null) {
                        tipsBubbleView = null;
                    } else {
                        String strOooO0OO = o0000.OooO0OO(oO00OOo0.tips_room_message_hello);
                    ...
                    if (tipsBubbleView != null) {
                        tipsBubbleView.setDismissListener(new p490o0o00OOO.o00Ooo(mixedRoomActivity, tipsBubbleView));
                    }
                    this.f48554OooO0o.setValue(tipsBubbleView);
                }
            }
            return Unit.INSTANCE;
        }
    ...
    public static final class oo000o extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MixedRoomActivity f48556OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MutableState<TipsBubbleView> f48557OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public oo000o(MutableState mutableState, MixedRoomActivity mixedRoomActivity) {
            super(0);
            this.f48556OooO0Oo = mixedRoomActivity;
            this.f48557OooO0o0 = mutableState;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            MixedRoomActivity mixedRoomActivity = this.f48556OooO0Oo;
            if (mixedRoomActivity != null) {
                MutableState<TipsBubbleView> mutableState = this.f48557OooO0o0;
                Oooo000.OooOO0O(mixedRoomActivity, mutableState.getValue());
                mutableState.setValue(null);
            }
            p490o0o00OOO.o00O0O onLogin = new p490o0o00OOO.o00O0O(mixedRoomActivity);
            Intrinsics.checkNotNullParameter(onLogin, "onLogin");
            o000000O o000000o2 = o000000O.f46674OooO00o;
            if (Intrinsics.areEqual(o000000O.OooOo0O().getValue(), Boolean.TRUE)) {
                onLogin.invoke();
    ...
    public static final class oo0o0Oo extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ int f48558OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public oo0o0Oo(int i) {
            super(2);
            this.f48558OooO0Oo = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            Oooo000.OooO0oo(composer, RecomposeScopeImplKt.updateChangedFlags(this.f48558OooO0Oo | 1));
            return Unit.INSTANCE;
        }
    }
    ...
    @Composable
    public static final void OooO(@NotNull p489o0o00OO0.OooO0o dataMedium, @Nullable Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1146213151, i, -1, "com.yalla.yalla.ui.activity.room.live.bottom.RoomBottomDefaultComp (RoomBottomDefaultComp.kt:68)");
        }
        Modifier.Companion companion = Modifier.INSTANCE;
        Modifier modifierM509height3ABfNKs = androidx.compose.foundation.layout.SizeKt.m509height3ABfNKs(androidx.compose.foundation.layout.SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), Dp.m3765constructorimpl(58));
        ...
        OooO0Oo(composerStartRestartGroup, 0);
        OooO0oO(composerStartRestartGroup, 0);
        OooO0o(dataMedium.f48482OooO00o, composerStartRestartGroup, 8);
        OooO00o(composerStartRestartGroup, 0);
        composerStartRestartGroup.endReplaceableGroup();
        composerStartRestartGroup.endNode();
        composerStartRestartGroup.endReplaceableGroup();
        composerStartRestartGroup.endReplaceableGroup();
        p490o0o00OOO.o000OOo.f48620OooO00o.OooO00o(composerStartRestartGroup, 6);
    ...
    public static final void OooO00o(Composer composer, int i) {
        ...
        if (i == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            State stateObserveAsState = LiveDataAdapterKt.observeAsState(com.yalla.yalla.service.room.OooO0O0.f24995OoooOOO.OooO00o().f25008OooOO0o, composerStartRestartGroup, 8);
            ...
            if (((Boolean) mutableState.getValue()).booleanValue()) {
                ...
                if (!(!StringsKt.isBlank((String) o000000Var.f47390OooOo00.getValue())) || o000000Var.OooO0oO() <= 0) {
    ...
    public static final void OooO0O0(Function0<Unit> function0, Composer composer, int i) {
        ...
        if ((i2 & 11) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            p100o000oOoo.o0000O0 o0000o0OooO0O0 = p417o0OoO0.o00Oo0.OooO0O0((String) com.yalla.yalla.service.room.OooO00o.f24979OooO0oO.f47390OooOo00.getValue(), null, composerStartRestartGroup, 0, 1);
            Modifier modifierOnGloballyPositioned = OnGloballyPositionedModifierKt.onGloballyPositioned(androidx.compose.foundation.layout.SizeKt.m523size3ABfNKs(Modifier.INSTANCE, Dp.m3765constructorimpl(36)), OooOO0.f48526OooO0Oo);
            ...
            composerStartRestartGroup.endReplaceableGroup();
            ImageKt.Image(o0000o0OooO0O0, (String) null, ClipKt.clip(PaddingKt.m476padding3ABfNKs(BorderKt.m182borderziNgDLE(DrawModifierKt.drawWithContent(com.code.android.util.o0O0O00.OooO0O0(modifierOnGloballyPositioned, false, false, 0L, false, null, null, null, (Function0) objRememberedValue, 253), OooOOO0.f48530OooO0Oo), Dp.m3765constructorimpl(1), Brush.Companion.m1633verticalGradient8A3gB4$default(Brush.INSTANCE, CollectionsKt.listOf((Object[]) new Color[]{Color.m1660boximpl(o0oO0O0o.f46993OoooOo0), Color.m1660boximpl(o0oO0O0o.f47112o00O0O)}), 0.0f, 0.0f, 0, 14, (Object) null), RoundedCornerShapeKt.getCircleShape()), Dp.m3765constructorimpl(3)), RoundedCornerShapeKt.getCircleShape()), (Alignment) null, (ContentScale) null, 0.0f, (ColorFilter) null, composerStartRestartGroup, 48, 120);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final void OooO0OO(Function0<Unit> function0, Composer composer, int i) {
        ...
        if ((i2 & 11) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            Painter painterPainterResource = PainterResources_androidKt.painterResource(oO00OOO.icon_room_bottom_hand, composerStartRestartGroup, 0);
            Modifier modifierOnGloballyPositioned = OnGloballyPositionedModifierKt.onGloballyPositioned(ComposedModifierKt.composed$default(Modifier.INSTANCE, null, new p490o0o00OOO.o00Oo0(true), 1, null), OooOOOO.f48531OooO0Oo);
            composerStartRestartGroup.startReplaceableGroup(1157296644);
            boolean zChanged = composerStartRestartGroup.changed(function0);
            Object objRememberedValue = composerStartRestartGroup.rememberedValue();
            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            ...
            composerStartRestartGroup.endReplaceableGroup();
            IconKt.m1103Iconww6aTOc(painterPainterResource, (String) null, com.code.android.util.o0O0O00.OooO0O0(modifierOnGloballyPositioned, false, false, 0L, false, null, null, null, (Function0) objRememberedValue, 253), com.yalla.yalla.service.room.OooO00o.f24979OooO0oO.OooOO0O() ? o0oO0O0o.f46993OoooOo0 : o0oO0O0o.f46946OooO0O0, composerStartRestartGroup, 56, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final void OooO0Oo(Composer composer, int i) {
        ...
        if (i == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            if (((Boolean) SnapshotStateKt.collectAsState(com.yalla.yalla.service.room.OooO00o.f24979OooO0oO.f47371OooO00o, null, composerStartRestartGroup, 8, 1).getValue()).booleanValue()) {
                ...
                com.code.android.util.OooOO0.OooO0Oo(Dp.m3765constructorimpl(8), null, composerStartRestartGroup, 6, 2);
                ImageKt.Image(PainterResources_androidKt.painterResource(oO00OOO.room_activity_mic_emoji, composerStartRestartGroup, 0), (String) null, com.code.android.util.o0O0O00.OooO0O0(ComposedModifierKt.composed$default(Modifier.INSTANCE, null, new p490o0o00OOO.o00Oo0(true), 1, null), false, false, 0L, false, null, null, null, new C0484Oooo000(fragmentActivity), 253), (Alignment) null, ContentScale.INSTANCE.getCrop(), 0.0f, (ColorFilter) null, composerStartRestartGroup, 24632, 104);
            }
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
    ...
    public static final void OooO0o(MutableLiveData<Pair<Integer, Integer>> mutableLiveData, Composer composer, int i) {
        ...
        com.code.android.util.OooOO0.OooO0Oo(Dp.m3765constructorimpl(8), null, composerStartRestartGroup, 6, 2);
        boolean zBooleanValue = ((Boolean) com.yalla.yalla.service.room.OooO00o.f24991OooOo0.f47431OooO00o.getValue()).booleanValue();
        composerStartRestartGroup.startReplaceableGroup(2033672659);
        composerStartRestartGroup.startReplaceableGroup(2033672663);
        if (zBooleanValue) {
            o000000O o000000o2 = o000000O.f46674OooO00o;
            if (Intrinsics.areEqual(LiveDataAdapterKt.observeAsState(o000000O.OooOo0O(), composerStartRestartGroup, 8).getValue(), Boolean.TRUE)) {
                z = true;
            } else {
                z = false;
            }
        ...
        if (z) {
            ...
            float f = 2;
            modifierOooO00o = ZIndexModifierKt.zIndex(com.code.android.util.o0O0O00.OooO00o(com.code.android.util.o0O0O00.OooO00o(modifierOnGloballyPositioned, fM3765constructorimpl, Color.m1660boximpl(j), null, Dp.m3763boximpl(Dp.m3765constructorimpl(f)), 20), Dp.m3765constructorimpl(27), Color.m1660boximpl(Color.m1669copywmQWz5c$default(j, 0.5f, 0.0f, 0.0f, 0.0f, 14, null)), null, Dp.m3763boximpl(Dp.m3765constructorimpl(f)), 20), 1.0f);
        } else {
            ...
            if (z2) {
                ...
                modifierOooO00o = o0000Ooo.OooO00o(Modifier.INSTANCE, zOooO0oo || (oo000oVar.OooO0o() > 0) || ((Boolean) oo000oVar.f47494OooOO0.getValue()).booleanValue() || ((Boolean) com.yalla.yalla.service.room.OooO00o.f24980OooO0oo.f47467OooO00o.getValue()).booleanValue() || ((Boolean) oo000oVar.f47489OooO0Oo.getValue()).booleanValue(), 0L, Dp.m3765constructorimpl(3), false, false, Dp.m3765constructorimpl(28), Dp.m3765constructorimpl(0), 0.0f, 826);
            } else {
                modifierOooO00o = Modifier.INSTANCE;
            }
        }
        composerStartRestartGroup.endReplaceableGroup();
        ImageKt.Image(PainterResources_androidKt.painterResource(oO00OOO.icon_room_bottom_menu, composerStartRestartGroup, 0), (String) null, com.code.android.util.o0O0O00.OooO0O0(ComposedModifierKt.composed$default(Modifier.INSTANCE.then(modifierOooO00o), null, new p490o0o00OOO.o00Oo0(true), 1, null), false, false, 0L, false, null, null, null, o00O0O.f48540OooO0Oo, 253), (Alignment) null, ContentScale.INSTANCE.getCrop(), 0.0f, (ColorFilter) null, composerStartRestartGroup, 24632, 104);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ScopeUpdateScope scopeUpdateScopeEndRestartGroup = composerStartRestartGroup.endRestartGroup();
    ...
    public static final void OooO0o0(Composer composer, int i) {
        ...
        if (i == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            Object objConsume = composerStartRestartGroup.consume(AndroidCompositionLocals_androidKt.getLocalLifecycleOwner());
            ImageKt.Image(PainterResources_androidKt.painterResource(oOo00OO0.icon_room_bottom_game_box, composerStartRestartGroup, 0), (String) null, com.code.android.util.o0O0O00.OooO0O0(androidx.compose.foundation.layout.SizeKt.m523size3ABfNKs(PaddingKt.m480paddingqDBjuR0$default(Modifier.INSTANCE, 0.0f, 0.0f, Dp.m3765constructorimpl(8), 0.0f, 11, null), Dp.m3765constructorimpl(35)), false, false, 0L, false, null, null, null, new o000oOoO(objConsume instanceof MixedRoomActivity ? (MixedRoomActivity) objConsume : null), 253), (Alignment) null, ContentScale.INSTANCE.getCrop(), 0.0f, (ColorFilter) null, composerStartRestartGroup, 24632, 104);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final void OooO0oO(Composer composer, int i) {
        ...
        if (i == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            float f = 35;
            Modifier modifierOooO0O0 = com.code.android.util.o0O0O00.OooO0O0(AnimationModifierKt.animateContentSize$default(BackgroundKt.m169backgroundbw27NRU$default(ClipKt.clip(androidx.compose.foundation.layout.SizeKt.m509height3ABfNKs(companion2, Dp.m3765constructorimpl(f)), RoundedCornerShapeKt.getCircleShape()), o0oO0O0o.f46963OooOo, null, 2, null), null, null, 3, null), false, false, 0L, false, null, null, null, new oo000o(mutableState2, mixedRoomActivity), 253);
            ...
            ImageKt.Image(PainterResources_androidKt.painterResource(oO00OOO.icon_room_bottom_message, composerStartRestartGroup, 0), (String) null, ComposedModifierKt.composed$default(companion2, null, new p490o0o00OOO.o00Oo0(false), 1, null), (Alignment) null, ContentScale.INSTANCE.getCrop(), 0.0f, (ColorFilter) null, composerStartRestartGroup, 24632, 104);
            p475o0o000.o000000 o000000Var = com.yalla.yalla.service.room.OooO00o.f24979OooO0oO;
            State stateCollectAsState = SnapshotStateKt.collectAsState(o000000Var.f47371OooO00o, null, composerStartRestartGroup, 8, 1);
            ...
            if (Intrinsics.areEqual(LiveDataAdapterKt.observeAsState((MutableLiveData) com.yalla.yalla.service.room.OooO00o.f24988OooOOo.f47362OooO0OO.getValue(), composer3, 8).getValue(), Boolean.TRUE)) {
                State stateCollectAsState2 = SnapshotStateKt.collectAsState(o000000Var.f47371OooO00o, null, composer3, 8, 1);
                Modifier modifierM528width3ABfNKs = androidx.compose.foundation.layout.SizeKt.m528width3ABfNKs(companion2, ((Boolean) stateCollectAsState2.getValue()).booleanValue() ? Dp.m3765constructorimpl(f) : Dp.m3765constructorimpl(119));
                ...
                AndroidView_androidKt.AndroidView((Function1) objRememberedValue3, modifierM528width3ABfNKs, null, composer3, 0, 4);
    ...
    public static final void OooO0oo(Composer composer, int i) {
        ...
        if (i == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            p475o0o000.o000000 o000000Var = com.yalla.yalla.service.room.OooO00o.f24979OooO0oO;
            if (((Boolean) SnapshotStateKt.collectAsState(o000000Var.f47371OooO00o, null, composerStartRestartGroup, 8, 1).getValue()).booleanValue()) {
                com.code.android.util.OooOO0.OooO0Oo(Dp.m3765constructorimpl(8), null, composerStartRestartGroup, 6, 2);
                ImageKt.Image(PainterResources_androidKt.painterResource(((Boolean) SnapshotStateKt.collectAsState(o000000Var.f47372OooO0O0, null, composerStartRestartGroup, 8, 1).getValue()).booleanValue() ? oO00OOO.icon_room_bottom_mic_off : oO00OOO.icon_room_bottom_mic_on, composerStartRestartGroup, 0), (String) null, com.code.android.util.o0O0O00.OooO0O0(ComposedModifierKt.composed$default(Modifier.INSTANCE, null, new p490o0o00OOO.o00Oo0(true), 1, null), false, false, 0L, false, null, null, null, o0OO00O.f48547OooO0Oo, 253), (Alignment) null, ContentScale.INSTANCE.getCrop(), 0.0f, (ColorFilter) null, composerStartRestartGroup, 24632, 104);
            }
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
    ...
    public static final void OooOO0(Composer composer, int i) {
        ...
        if (i == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            com.code.android.util.OooOO0.OooO0Oo(Dp.m3765constructorimpl(8), null, composerStartRestartGroup, 6, 2);
            ImageKt.Image(PainterResources_androidKt.painterResource(((Boolean) SnapshotStateKt.collectAsState(com.yalla.yalla.service.room.OooO00o.f24979OooO0oO.f47373OooO0OO, null, composerStartRestartGroup, 8, 1).getValue()).booleanValue() ? oO00OOO.icon_room_bottom_sound_off : oO00OOO.icon_room_bottom_sound_on, composerStartRestartGroup, 0), (String) null, com.code.android.util.o0O0O00.OooO0O0(ComposedModifierKt.composed$default(Modifier.INSTANCE, null, new p490o0o00OOO.o00Oo0(true), 1, null), false, false, 0L, false, null, null, null, o000OOo.f48538OooO0Oo, 253), (Alignment) null, ContentScale.INSTANCE.getCrop(), 0.0f, (ColorFilter) null, composerStartRestartGroup, 24632, 104);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final void OooOO0O(MixedRoomActivity mixedRoomActivity, TipsBubbleView tipsBubbleView) {
        ...
        if (tipsBubbleView == null || !o000OO00.OooO0o0(tipsBubbleView)) {
            return;
        }
        ((MutableLiveData) com.yalla.yalla.service.room.OooO00o.f24988OooOOo.f47362OooO0OO.getValue()).setValue(Boolean.FALSE);
        p409o0Oo0o0o.o0O0O00 o0o0o00OooO0o0 = p408o0Oo0o0O.o00Oo0.OooO0o0();
        o0o0o00OooO0o0.getClass();
        com.google.firebase.messaging.o0OO00O.OooO00o("roomChat", o000000O.OooOOo0().getValue(), o0o0o00OooO0o0, false);
        ViewGroup viewGroup = (ViewGroup) mixedRoomActivity.findViewById(oO00O0oO.v_room_root);
