...
public final class o00OO0OO extends Lambda implements Function0<Object> {
    ...
    public final /* synthetic */ PremiumActivity f49032OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ PayOrder f49033OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00OO0OO(PremiumActivity premiumActivity, PayOrder payOrder) {
        super(0);
        this.f49032OooO0Oo = premiumActivity;
        this.f49033OooO0o0 = payOrder;
    }

    @Override // kotlin.jvm.functions.Function0
    @Nullable
    public final Object invoke() {
        PremiumActivity premiumActivity = this.f49032OooO0Oo;
        ...
        PayOrder payOrder = this.f49033OooO0o0;
