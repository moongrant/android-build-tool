...
public final class o0OO0o extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ UserInfoActivity f49096OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0OO0o(UserInfoActivity userInfoActivity) {
        super(0);
        this.f49096OooO0Oo = userInfoActivity;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        UserInfoActivity userInfoActivity = this.f49096OooO0Oo;
