...
public final class oO00Oo0 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ UserInfoEditActivity f49145OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public oO00Oo0(UserInfoEditActivity userInfoEditActivity) {
        super(0);
        this.f49145OooO0Oo = userInfoEditActivity;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        int i = UserInfoEditBioActivity.f27311OooOo;
        UserInfoEditActivity context = this.f49145OooO0Oo;
        context.getClass();
