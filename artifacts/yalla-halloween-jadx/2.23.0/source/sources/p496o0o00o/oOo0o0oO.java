...
public final class oOo0o0oO extends Lambda implements Function1<String, Unit> {
    ...
    public final /* synthetic */ UserWelfareMallActivity f49188OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public oOo0o0oO(UserWelfareMallActivity userWelfareMallActivity) {
        super(1);
        this.f49188OooO0Oo = userWelfareMallActivity;
    }
    ...
    public final Unit invoke(String str) {
        ...
        if (!(url == null || StringsKt.isBlank(url))) {
            ...
            WebActivity.OooO00o.OooO00o(this.f49188OooO0Oo, webPageInfo);
        }
