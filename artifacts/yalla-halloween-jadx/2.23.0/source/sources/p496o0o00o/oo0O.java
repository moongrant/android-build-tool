...
public final class oo0O extends Lambda implements Function1<String, Unit> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ PremiumActivity f49197OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public oo0O(PremiumActivity premiumActivity) {
        super(1);
        this.f49197OooO0Oo = premiumActivity;
    }
    ...
    public final Unit invoke(String str) {
        ...
        if (!(url == null || StringsKt.isBlank(url))) {
            ...
            WebActivity.OooO00o.OooO00o(this.f49197OooO0Oo, webPageInfo);
        }
