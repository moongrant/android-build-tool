...
public final class oO0O0Oo0 extends Lambda implements Function1<View, Unit> {
    ...
    public final /* synthetic */ ChatModel f49578OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public oO0O0Oo0(ChatModel chatModel) {
        super(1);
        this.f49578OooO0Oo = chatModel;
    }
    ...
    public final Unit invoke(View view) {
        ...
        RoomUserInfoModel newFrom = this.f49578OooO0Oo.getNewFrom();
