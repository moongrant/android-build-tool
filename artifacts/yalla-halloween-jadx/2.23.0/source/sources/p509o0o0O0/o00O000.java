...
public final class o00O000 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MomentVideoVM f50735OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00O000(MomentVideoVM momentVideoVM) {
        super(0);
        this.f50735OooO0Oo = momentVideoVM;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        MomentVideoVM momentVideoVM = this.f50735OooO0Oo;
        ...
        if (o0OoOo0.OooO00o(currentMomentDetail != null ? Boolean.valueOf(MomentStateKt.isApprovedState(currentMomentDetail)) : null)) {
            MomentVideoVM.toInputCommentOrReply$default(this.f50735OooO0Oo, null, null, false, 4, null);
