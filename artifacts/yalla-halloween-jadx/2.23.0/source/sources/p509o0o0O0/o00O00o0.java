...
public final class o00O00o0 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MomentVideoVM f50768OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00O00o0(MomentVideoVM momentVideoVM) {
        super(0);
        this.f50768OooO0Oo = momentVideoVM;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        MomentVideoVM momentVideoVM = this.f50768OooO0Oo;
