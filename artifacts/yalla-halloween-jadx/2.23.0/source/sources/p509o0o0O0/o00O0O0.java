...
public final class o00O0O0 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MomentVideoVM f50822OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ TempAtVM f50823OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ CoroutineScope f50824OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00O0O0(TempAtVM tempAtVM, MomentVideoVM momentVideoVM, CoroutineScope coroutineScope) {
        super(0);
        this.f50822OooO0Oo = momentVideoVM;
        this.f50824OooO0o0 = coroutineScope;
        this.f50823OooO0o = tempAtVM;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        MomentVideoVM momentVideoVM = this.f50822OooO0Oo;
        ...
        if (o0OoOo0.OooO00o(currentMomentDetail != null ? Boolean.valueOf(MomentStateKt.isApprovedState(currentMomentDetail)) : null)) {
            MomentVideoVM.toInputCommentOrReply$default(this.f50822OooO0Oo, null, null, false, 4, null);
            int i = AtFriendsActivity.f25620OooOooO;
            AtFriendsActivity.OooO00o.OooO00o(new o00O0O00(this.f50823OooO0o, momentVideoVM, this.f50824OooO0o0));
