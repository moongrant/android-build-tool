...
public final class o00OO {
    ...
    @NotNull
    public static final o00OO f50892OooO00o = new o00OO();

    public static final class OooO extends Lambda implements Function2<Composer, Integer, Unit> {

        /* JADX INFO: renamed from: OooO, reason: collision with root package name */
        public final /* synthetic */ int f50893OooO;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f50895OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ String f50896OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ Function0<Unit> f50897OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ Function0<Unit> f50898OooO0oo;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public final /* synthetic */ int f50899OooOO0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(String str, int i, Function0<Unit> function0, Function0<Unit> function1, int i2, int i3) {
            super(2);
            this.f50896OooO0o0 = str;
            this.f50895OooO0o = i;
            this.f50897OooO0oO = function0;
            this.f50898OooO0oo = function1;
            this.f50893OooO = i2;
            this.f50899OooOO0 = i3;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            o00OO.this.OooO0OO(this.f50896OooO0o0, this.f50895OooO0o, this.f50897OooO0oO, this.f50898OooO0oo, composer, RecomposeScopeImplKt.updateChangedFlags(this.f50893OooO | 1), this.f50899OooOO0);
    ...
    public static final class OooO00o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ Function1<Integer, Unit> f50901OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ Modifier f50902OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f50903OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ int f50904OooO0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public OooO00o(Modifier modifier, Function1<? super Integer, Unit> function1, int i, int i2) {
            super(2);
            this.f50902OooO0o0 = modifier;
            this.f50901OooO0o = function1;
            this.f50903OooO0oO = i;
            this.f50904OooO0oo = i2;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            o00OO.this.OooO00o(this.f50902OooO0o0, this.f50901OooO0o, composer, RecomposeScopeImplKt.updateChangedFlags(this.f50903OooO0oO | 1), this.f50904OooO0oo);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0O0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ Function1<Integer, Unit> f50906OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ Modifier f50907OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f50908OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ int f50909OooO0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public OooO0O0(Modifier modifier, Function1<? super Integer, Unit> function1, int i, int i2) {
            super(2);
            this.f50907OooO0o0 = modifier;
            this.f50906OooO0o = function1;
            this.f50908OooO0oO = i;
            this.f50909OooO0oo = i2;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            o00OO.this.OooO00o(this.f50907OooO0o0, this.f50906OooO0o, composer, RecomposeScopeImplKt.updateChangedFlags(this.f50908OooO0oO | 1), this.f50909OooO0oo);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0OO extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function0<Unit> f50910OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(Function0<Unit> function0) {
            super(0);
            this.f50910OooO0Oo = function0;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            Function0<Unit> function0 = this.f50910OooO0Oo;
            if (function0 != null) {
                function0.invoke();
            }
            return Unit.INSTANCE;
    ...
    public static final class OooO0o extends Lambda implements Function1<coil.request.OooO00o.C0170OooO00o, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ int f50911OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(int i) {
            super(1);
            this.f50911OooO0Oo = i;
        }
    ...
    public static final class OooOO0 extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function0<Unit> f50912OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0(Function0<Unit> function0) {
            super(0);
            this.f50912OooO0Oo = function0;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            Function0<Unit> function0 = this.f50912OooO0Oo;
            if (function0 != null) {
                function0.invoke();
            }
            return Unit.INSTANCE;
    ...
    public final void OooO00o(@Nullable Modifier modifier, @Nullable Function1<? super Integer, Unit> function1, @Nullable Composer composer, int i, int i2) {
        ...
        if (i5 == 0) {
            ...
            if ((i3 & 91) == 18 || !composerStartRestartGroup.getSkipping()) {
                ...
                if (!((Boolean) LiveDataAdapterKt.observeAsState(o000000O.OooOo0O(), Boolean.FALSE, composerStartRestartGroup, 56).getValue()).booleanValue()) {
                    if (ComposerKt.isTraceInProgress()) {
                ...
                Modifier modifierAlign = BoxScopeInstance.INSTANCE.align(SizeKt.m528width3ABfNKs(companion, Dp.m3765constructorimpl(74)), companion2.getBottomEnd());
                ...
                f50892OooO00o.OooO0O0(((i3 >> 3) & 14) | 48, 0, composerStartRestartGroup, function2);
        ...
        if ((i3 & 91) == 18) {
            ...
            Modifier modifierAlign2 = BoxScopeInstance.INSTANCE.align(SizeKt.m528width3ABfNKs(companion4, Dp.m3765constructorimpl(74)), companion5.getBottomEnd());
            composerStartRestartGroup.startReplaceableGroup(-483455358);
            MeasurePolicy measurePolicyOooO00o4 = androidx.compose.material.OooO0o.OooO00o(companion5, Arrangement.INSTANCE.getTop(), composerStartRestartGroup, 0, -1323940314);
            currentCompositeKeyHash2 = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
            ...
            composerM1309constructorimpl2 = Updater.m1309constructorimpl(composerStartRestartGroup);
            function2OooO00o2 = androidx.compose.animation.OooO.OooO00o(companion6, composerM1309constructorimpl2, measurePolicyOooO00o4, composerM1309constructorimpl2, currentCompositionLocalMap4);
            ...
            MeasurePolicy measurePolicyOooO00o5 = OooOOO.OooO00o(companion8, false, composerStartRestartGroup, 0, -1323940314);
            currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
            ...
            composerM1309constructorimpl = Updater.m1309constructorimpl(composerStartRestartGroup);
            function2OooO00o = androidx.compose.animation.OooO.OooO00o(companion9, composerM1309constructorimpl, measurePolicyOooO00o5, composerM1309constructorimpl, currentCompositionLocalMap5);
            if (composerM1309constructorimpl.getInserting()) {
                androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1309constructorimpl, currentCompositeKeyHash, function2OooO00o);
            } else {
                androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash, composerM1309constructorimpl, currentCompositeKeyHash, function2OooO00o);
            ...
            Modifier modifierAlign3 = BoxScopeInstance.INSTANCE.align(SizeKt.m528width3ABfNKs(companion7, Dp.m3765constructorimpl(74)), companion8.getBottomEnd());
            composerStartRestartGroup.startReplaceableGroup(-483455358);
            MeasurePolicy measurePolicyOooO00o6 = androidx.compose.material.OooO0o.OooO00o(companion8, Arrangement.INSTANCE.getTop(), composerStartRestartGroup, 0, -1323940314);
            currentCompositeKeyHash2 = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
            ...
            composerM1309constructorimpl2 = Updater.m1309constructorimpl(composerStartRestartGroup);
            function2OooO00o2 = androidx.compose.animation.OooO.OooO00o(companion9, composerM1309constructorimpl2, measurePolicyOooO00o6, composerM1309constructorimpl2, currentCompositionLocalMap6);
            if (composerM1309constructorimpl2.getInserting()) {
                androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1309constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
            } else {
                androidx.compose.animation.OooO0O0.OooO00o(currentCompositeKeyHash2, composerM1309constructorimpl2, currentCompositeKeyHash2, function2OooO00o2);
    ...
    public final void OooO0O0(int i, int i2, Composer composer, Function1 function1) {
        ...
        if ((i3 & 91) == 18 && composerStartRestartGroup.getSkipping()) {
            ...
            if (zChanged || objRememberedValue2 == companion.getEmpty()) {
                objRememberedValue2 = new o00OOO00(mutableState, null);
            ...
            State stateObserveAsState = LiveDataAdapterKt.observeAsState(OooOo.f45669OooO00o, 0, composerStartRestartGroup, 56);
            ...
            Integer config = (Integer) stateObserveAsState.getValue();
            Intrinsics.checkNotNullExpressionValue(config, "config");
            int iOooO0Oo = oOOOOo0O.OooO0Oo(config.intValue());
            composerStartRestartGroup.startReplaceableGroup(1157296644);
            boolean zChanged2 = composerStartRestartGroup.changed(mutableState);
            Object objRememberedValue3 = composerStartRestartGroup.rememberedValue();
            if (zChanged2 || objRememberedValue3 == companion.getEmpty()) {
                objRememberedValue3 = new o00OOO0(mutableState);
            ...
            if (zChanged3 || objRememberedValue4 == companion.getEmpty()) {
                objRememberedValue4 = new o00OOO0O(function1, mutableState);
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new o0o0Oo(this, function1, i, i2));
    }
    ...
    public final void OooO0OO(String str, int i, Function0<Unit> function0, Function0<Unit> function1, Composer composer, int i2, int i3) {
        ...
        if (i9 == 0) {
            ...
            if (i5 != 0) {
                ...
                if ((46811 & i4) == 9362 || !composerStartRestartGroup.getSkipping()) {
                    ...
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(212612748, i4, -1, "com.yalla.yalla.ui.composable.moment.MomentSendAnimIcon.ItemView (MomentSendAnimIcon.kt:115)");
                    }
                    ...
                    Modifier modifierBorder = BorderKt.border(ClipKt.clip(SizeKt.m523size3ABfNKs(companion, Dp.m3765constructorimpl(74)), RoundedCornerShapeKt.getCircleShape()), new BorderStroke(fM3765constructorimpl, new SolidColor(jM1705getTransparent0d7_KjU, null), null), RoundedCornerShapeKt.getCircleShape());
                    composerStartRestartGroup.startReplaceableGroup(1157296644);
                    ...
                    if (o0000O0O.OooO0oO(str3)) {
                        ...
                        function6 = function5;
                        function7 = function4;
                        OooOo00.OooO00o(str3, true, 3, null, (Function0) objRememberedValue3, companion.then(modifierOooO0O0), composerStartRestartGroup, (i4 & 14) | 432, 8);
                        composerStartRestartGroup.endReplaceableGroup();
                    } else {
                        function6 = function5;
                        function7 = function4;
                        if (o0000O0O.OooO0o0(str3)) {
            ...
            if ((46811 & i4) == 9362) {
                ...
                companion = Modifier.INSTANCE;
                Modifier modifierBorder2 = BorderKt.border(ClipKt.clip(SizeKt.m523size3ABfNKs(companion, Dp.m3765constructorimpl(74)), RoundedCornerShapeKt.getCircleShape()), new BorderStroke(fM3765constructorimpl2, new SolidColor(jM1705getTransparent0d7_KjU2, null), null), RoundedCornerShapeKt.getCircleShape());
                composerStartRestartGroup.startReplaceableGroup(1157296644);
                zChanged = composerStartRestartGroup.changed(function5);
                objRememberedValue = composerStartRestartGroup.rememberedValue();
                if (zChanged) {
                ...
                companion = Modifier.INSTANCE;
                Modifier modifierBorder3 = BorderKt.border(ClipKt.clip(SizeKt.m523size3ABfNKs(companion, Dp.m3765constructorimpl(74)), RoundedCornerShapeKt.getCircleShape()), new BorderStroke(fM3765constructorimpl3, new SolidColor(jM1705getTransparent0d7_KjU3, null), null), RoundedCornerShapeKt.getCircleShape());
                composerStartRestartGroup.startReplaceableGroup(1157296644);
                zChanged = composerStartRestartGroup.changed(function5);
                objRememberedValue = composerStartRestartGroup.rememberedValue();
                if (zChanged) {
        ...
        if (i5 != 0) {
            ...
            if ((46811 & i4) == 9362) {
                ...
                float fM3765constructorimpl4 = Dp.m3765constructorimpl(0);
                long jM1705getTransparent0d7_KjU4 = Color.INSTANCE.m1705getTransparent0d7_KjU();
                companion = Modifier.INSTANCE;
                Modifier modifierBorder4 = BorderKt.border(ClipKt.clip(SizeKt.m523size3ABfNKs(companion, Dp.m3765constructorimpl(74)), RoundedCornerShapeKt.getCircleShape()), new BorderStroke(fM3765constructorimpl4, new SolidColor(jM1705getTransparent0d7_KjU4, null), null), RoundedCornerShapeKt.getCircleShape());
                composerStartRestartGroup.startReplaceableGroup(1157296644);
                zChanged = composerStartRestartGroup.changed(function5);
                objRememberedValue = composerStartRestartGroup.rememberedValue();
                if (zChanged) {
                ...
                float fM3765constructorimpl5 = Dp.m3765constructorimpl(0);
                long jM1705getTransparent0d7_KjU5 = Color.INSTANCE.m1705getTransparent0d7_KjU();
                companion = Modifier.INSTANCE;
                Modifier modifierBorder5 = BorderKt.border(ClipKt.clip(SizeKt.m523size3ABfNKs(companion, Dp.m3765constructorimpl(74)), RoundedCornerShapeKt.getCircleShape()), new BorderStroke(fM3765constructorimpl5, new SolidColor(jM1705getTransparent0d7_KjU5, null), null), RoundedCornerShapeKt.getCircleShape());
                composerStartRestartGroup.startReplaceableGroup(1157296644);
                zChanged = composerStartRestartGroup.changed(function5);
                objRememberedValue = composerStartRestartGroup.rememberedValue();
                if (zChanged) {
        ...
        if ((46811 & i4) == 9362) {
            ...
            float fM3765constructorimpl6 = Dp.m3765constructorimpl(0);
            long jM1705getTransparent0d7_KjU6 = Color.INSTANCE.m1705getTransparent0d7_KjU();
            companion = Modifier.INSTANCE;
            Modifier modifierBorder6 = BorderKt.border(ClipKt.clip(SizeKt.m523size3ABfNKs(companion, Dp.m3765constructorimpl(74)), RoundedCornerShapeKt.getCircleShape()), new BorderStroke(fM3765constructorimpl6, new SolidColor(jM1705getTransparent0d7_KjU6, null), null), RoundedCornerShapeKt.getCircleShape());
            composerStartRestartGroup.startReplaceableGroup(1157296644);
            zChanged = composerStartRestartGroup.changed(function5);
            objRememberedValue = composerStartRestartGroup.rememberedValue();
            if (zChanged) {
            ...
            float fM3765constructorimpl7 = Dp.m3765constructorimpl(0);
            long jM1705getTransparent0d7_KjU7 = Color.INSTANCE.m1705getTransparent0d7_KjU();
            companion = Modifier.INSTANCE;
            Modifier modifierBorder7 = BorderKt.border(ClipKt.clip(SizeKt.m523size3ABfNKs(companion, Dp.m3765constructorimpl(74)), RoundedCornerShapeKt.getCircleShape()), new BorderStroke(fM3765constructorimpl7, new SolidColor(jM1705getTransparent0d7_KjU7, null), null), RoundedCornerShapeKt.getCircleShape());
            composerStartRestartGroup.startReplaceableGroup(1157296644);
            zChanged = composerStartRestartGroup.changed(function5);
            objRememberedValue = composerStartRestartGroup.rememberedValue();
            if (zChanged) {
