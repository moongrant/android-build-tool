...
public final class o0O0ooO {
    ...
    public static final class OooO00o extends Lambda implements Function0<Unit> {
        ...
        public final /* synthetic */ MomentVideoVM f51162OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ TempAtVM f51163OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ CoroutineScope f51164OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(TempAtVM tempAtVM, MomentVideoVM momentVideoVM, CoroutineScope coroutineScope) {
            super(0);
            this.f51162OooO0Oo = momentVideoVM;
            this.f51164OooO0o0 = coroutineScope;
            this.f51163OooO0o = tempAtVM;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            o0OO000.OooO00o("106117");
            o00O0000 onLogin = new o00O0000(this.f51163OooO0o, this.f51162OooO0Oo, this.f51164OooO0o0);
    ...
    public static final class OooO0O0 extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f51165OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(MomentVideoVM momentVideoVM) {
            super(0);
            this.f51165OooO0Oo = momentVideoVM;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            o0OO000.OooO00o("106116");
            o00oOoo onLogin = new o00oOoo(this.f51165OooO0Oo);
            Intrinsics.checkNotNullParameter(onLogin, "onLogin");
            o000000O o000000o2 = o000000O.f46674OooO00o;
            if (Intrinsics.areEqual(o000000O.OooOo0O().getValue(), Boolean.TRUE)) {
                onLogin.invoke();
    ...
    public static final class OooO0OO extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f51166OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(MomentVideoVM momentVideoVM) {
            super(0);
            this.f51166OooO0Oo = momentVideoVM;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            o0OO000.OooO00o("106118");
            o00O000 onLogin = new o00O000(this.f51166OooO0Oo);
            Intrinsics.checkNotNullParameter(onLogin, "onLogin");
            o000000O o000000o2 = o000000O.f46674OooO00o;
            if (Intrinsics.areEqual(o000000O.OooOo0O().getValue(), Boolean.TRUE)) {
                onLogin.invoke();
    ...
    public static final class OooO0o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ int f51167OooO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ boolean f51168OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ MutableState<String> f51169OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ boolean f51170OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ Modifier f51171OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ int f51172OooO0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(boolean z, boolean z2, MutableState<String> mutableState, Modifier modifier, int i, int i2) {
            super(2);
            this.f51168OooO0Oo = z;
            this.f51170OooO0o0 = z2;
            this.f51169OooO0o = mutableState;
            this.f51171OooO0oO = modifier;
            this.f51172OooO0oo = i;
            this.f51167OooO = i2;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            o0O0ooO.OooO00o(this.f51168OooO0Oo, this.f51170OooO0o0, this.f51169OooO0o, this.f51171OooO0oO, composer, RecomposeScopeImplKt.updateChangedFlags(this.f51172OooO0oo | 1), this.f51167OooO);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final void OooO00o(boolean z, boolean z2, @Nullable MutableState<String> mutableState, @Nullable Modifier modifier, @Nullable Composer composer, int i, int i2) {
        ...
        if (i8 == 0) {
            ...
            if (i4 != 0) {
                ...
                if ((i3 & 5851) == 1170 || !composerStartRestartGroup.getSkipping()) {
                    ...
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(-347334828, i6, -1, "com.yalla.yalla.ui.composable.moment.MomentInputCoverComment (MomentInputCoverComment.kt:23)");
                    }
                    ...
                    composerStartRestartGroup.endReplaceableGroup();
                    o00O000o.OooO00o(z3, z5, mutableState2, new OooO00o(tempAtVM, momentVideoVM, coroutineScope), new OooO0O0(momentVideoVM), new OooO0OO(momentVideoVM), modifier3, composerStartRestartGroup, (i6 & 14) | (i6 & 112) | (i6 & 896) | ((i6 << 9) & 3670016), 0);
                    if (ComposerKt.isTraceInProgress()) {
            ...
            if ((i3 & 5851) == 1170) {
                ...
                composerStartRestartGroup.endReplaceableGroup();
                o00O000o.OooO00o(z3, z5, mutableState2, new OooO00o(tempAtVM2, momentVideoVM, coroutineScope2), new OooO0O0(momentVideoVM), new OooO0OO(momentVideoVM), modifier3, composerStartRestartGroup, (i6 & 14) | (i6 & 112) | (i6 & 896) | ((i6 << 9) & 3670016), 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier2 = modifier3;
                ...
                composerStartRestartGroup.endReplaceableGroup();
                o00O000o.OooO00o(z3, z5, mutableState2, new OooO00o(tempAtVM3, momentVideoVM, coroutineScope3), new OooO0O0(momentVideoVM), new OooO0OO(momentVideoVM), modifier3, composerStartRestartGroup, (i6 & 14) | (i6 & 112) | (i6 & 896) | ((i6 << 9) & 3670016), 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier2 = modifier3;
        ...
        if (i4 != 0) {
            ...
            if ((i3 & 5851) == 1170) {
                ...
                composerStartRestartGroup.endReplaceableGroup();
                o00O000o.OooO00o(z3, z5, mutableState2, new OooO00o(tempAtVM4, momentVideoVM, coroutineScope4), new OooO0O0(momentVideoVM), new OooO0OO(momentVideoVM), modifier3, composerStartRestartGroup, (i6 & 14) | (i6 & 112) | (i6 & 896) | ((i6 << 9) & 3670016), 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier2 = modifier3;
                ...
                composerStartRestartGroup.endReplaceableGroup();
                o00O000o.OooO00o(z3, z5, mutableState2, new OooO00o(tempAtVM5, momentVideoVM, coroutineScope5), new OooO0O0(momentVideoVM), new OooO0OO(momentVideoVM), modifier3, composerStartRestartGroup, (i6 & 14) | (i6 & 112) | (i6 & 896) | ((i6 << 9) & 3670016), 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier2 = modifier3;
        ...
        if ((i3 & 5851) == 1170) {
            ...
            composerStartRestartGroup.endReplaceableGroup();
            o00O000o.OooO00o(z3, z5, mutableState2, new OooO00o(tempAtVM6, momentVideoVM, coroutineScope6), new OooO0O0(momentVideoVM), new OooO0OO(momentVideoVM), modifier3, composerStartRestartGroup, (i6 & 14) | (i6 & 112) | (i6 & 896) | ((i6 << 9) & 3670016), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier2 = modifier3;
            ...
            composerStartRestartGroup.endReplaceableGroup();
            o00O000o.OooO00o(z3, z5, mutableState2, new OooO00o(tempAtVM7, momentVideoVM, coroutineScope7), new OooO0O0(momentVideoVM), new OooO0OO(momentVideoVM), modifier3, composerStartRestartGroup, (i6 & 14) | (i6 & 112) | (i6 & 896) | ((i6 << 9) & 3670016), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier2 = modifier3;
