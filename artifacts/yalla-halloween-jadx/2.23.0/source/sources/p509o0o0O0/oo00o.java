...
public final class oo00o extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MomentVideoVM f51332OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public oo00o(MomentVideoVM momentVideoVM) {
        super(0);
        this.f51332OooO0Oo = momentVideoVM;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        MomentVideoVM momentVideoVM = this.f51332OooO0Oo;
