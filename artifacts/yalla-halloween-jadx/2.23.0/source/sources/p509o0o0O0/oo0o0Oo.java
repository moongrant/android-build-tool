...
public final class oo0o0Oo {
    ...
    public static final class OooO00o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ Modifier f51367OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f51368OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(Modifier modifier, int i) {
            super(2);
            this.f51367OooO0Oo = modifier;
            this.f51368OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f51368OooO0o0 | 1);
            oo0o0Oo.OooO00o(this.f51367OooO0Oo, composer, iUpdateChangedFlags);
    ...
    public static final class OooO0O0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Modifier f51369OooO0Oo;
        ...
        public final Unit invoke(Composer composer, Integer num) {
            ...
            oo0o0Oo.OooO00o(this.f51369OooO0Oo, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final void OooO00o(@NotNull Modifier modifier, @Nullable Composer composer, int i) {
        ...
        if ((i2 & 11) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(328890977, i, -1, "com.yalla.yalla.ui.composable.moment.MomentDayAddressAndMoreComp (MomentDayAddressAndMoreComp.kt:20)");
            }
            ...
            if (momentDetailModel.getCreateTime() != 0) {
                sb.append(o0000oo.OooO0Oo(momentDetailModel.getCreateTime(), System.currentTimeMillis()));
            }
            ...
            if (momentDetailModel.getType() == MomentType.YallaTeam.getValue()) {
                ...
                sb.append(StringResources_androidKt.stringResource(oO00OOo0.MessageFragment_item_YallaTeam, composerStartRestartGroup, 0));
            }
            composerStartRestartGroup.endReplaceableGroup();
            composerStartRestartGroup.startReplaceableGroup(1438847359);
            if (momentDetailModel.getIsEdited()) {
                sb.append(" • ");
                sb.append(StringResources_androidKt.stringResource(oO00OOo0.Moment_Detail_Edit_Tag, composerStartRestartGroup, 0));
            }
            composerStartRestartGroup.endReplaceableGroup();
            ...
            if (TextUtils.isEmpty(sb.toString())) {
                ...
                if (momentDetailModel.getPower() > 0) {
                    ImageKt.Image(PainterResources_androidKt.painterResource(momentDetailModel.getPower() == 1 ? oO00OOO.icon_authority_friends : oO00OOO.icon_authority_own, composer2, 0), (String) null, SizeKt.m523size3ABfNKs(companion, Dp.m3765constructorimpl(15)), (Alignment) null, (ContentScale) null, 0.0f, (ColorFilter) null, composer2, 440, 120);
                }
