...
public final class a {
    ...
    public static final void OooO00o(@Nullable String str, boolean z, @Nullable Function0 function0, @Nullable Composer composer, int i, int i2) {
        ...
        if (i6 == 0) {
            ...
            if ((i3 & 731) == 146 || !composerStartRestartGroup.getSkipping()) {
                ...
                if ((i & 1) != 0 || composerStartRestartGroup.getDefaultsInvalid()) {
                    ...
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(-1380050966, i4, -1, "com.yalla.yalla.ui.dialog.OldLoadingDialogCompose (OldLoadingDialogCompose.kt:27)");
                    }
                    if (z) {
                        ...
                        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                            objRememberedValue = new O0O0(function2);
                            composerStartRestartGroup.updateRememberedValue(objRememberedValue);
                        }
                        composerStartRestartGroup.endReplaceableGroup();
                        AndroidDialog_androidKt.Dialog((Function0) objRememberedValue, new DialogProperties(true, true, null, false, false, 20, null), ComposableLambdaKt.composableLambda(composerStartRestartGroup, -434339684, true, new O0OO00(strStringResource, i4)), composerStartRestartGroup, 432, 0);
                    }
                    if (ComposerKt.isTraceInProgress()) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Oo0000(i, i2, str2, function3, z));
        }
        i3 |= 384;
        function1 = function0;
        if ((i3 & 731) == 146) {
