...
public final class m1 extends Lambda implements Function1<View, Unit> {
    ...
    public final /* synthetic */ t1 f52425OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public m1(t1 t1Var) {
        super(1);
        this.f52425OooO0Oo = t1Var;
    }
    ...
    public final Unit invoke(View view) {
        ...
        AppCompatEditText view2 = this.f52425OooO0Oo.OooOOOO().f58834OooO0O0;
        ...
        OooOO0O.OooO00o(view2.getContext().getApplicationContext(), new Handler(), inputMethodManagerOooO00o, view2.getWindowToken(), 0);
