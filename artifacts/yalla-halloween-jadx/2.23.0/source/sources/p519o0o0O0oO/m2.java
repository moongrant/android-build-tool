...
public final class m2 extends Lambda implements Function1<RoomUserInfoDTO, Unit> {
    ...
    public static final m2 f52426OooO0Oo = new m2();
    ...
    public final Unit invoke(RoomUserInfoDTO roomUserInfoDTO) {
        ...
        if (roomUserInfoDTO2 != null) {
            OooO0O0.f24995OoooOOO.OooO00o().f25040OoooO0.postValue(NewRoomUserInfoTransformutilsKt.transformToModel(roomUserInfoDTO2));
        }
