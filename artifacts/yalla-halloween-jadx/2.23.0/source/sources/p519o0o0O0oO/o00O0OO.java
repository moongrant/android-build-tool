...
public final class o00O0OO {
    ...
    public static final class OooO00o extends Lambda implements Function3<MutableState<Boolean>, Composer, Integer, Unit> {
        ...
        public final /* synthetic */ Ref.ObjectRef<MutableState<Boolean>> f52556OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ Ref.ObjectRef<String> f52557OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ Ref.ObjectRef<String> f52558OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ Function0<Unit> f52559OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ Function0<Unit> f52560OooO0oo;
        ...
        public OooO00o(Ref.ObjectRef<MutableState<Boolean>> objectRef, Ref.ObjectRef<String> objectRef2, Ref.ObjectRef<String> objectRef3, Function0<Unit> function0, Function0<Unit> function1) {
            super(3);
            this.f52556OooO0Oo = objectRef;
            this.f52558OooO0o0 = objectRef2;
            this.f52557OooO0o = objectRef3;
            this.f52559OooO0oO = function0;
            this.f52560OooO0oo = function1;
        }
        ...
        public final Unit invoke(MutableState<Boolean> mutableState, Composer composer, Integer num) {
            ...
            if ((i & 91) == 18 && composer2.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(1130815616, i, -1, "com.yalla.yalla.ui.dialog.CenterTextDialogUtil.showOpenNobleDialog.<anonymous> (CenterTextDialogUtil.kt:43)");
                }
                this.f52556OooO0Oo.element = it;
                oo000o.OooO0Oo(it, this.f52558OooO0o0.element, this.f52557OooO0o.element, null, false, false, null, this.f52559OooO0oO, o0000.OooO0OO(oO00OOo0.OK), false, null, false, this.f52560OooO0oo, null, false, false, null, oo0o0O0.f53023OooO0Oo, null, null, composer2, i & 14, 12582912, 913016);
                if (ComposerKt.isTraceInProgress()) {
        ...
        if (iHashCode != -1298587734) {
            if (iHashCode != -841454749) {
                if (iHashCode == 613961165 && uiType.equals("unJoin&unFollow")) {
                    objectRef.element = o0000.OooO0OO(oO00OOo0.un_join_and_follow);
                    objectRef2.element = o0000.OooO0OO(oO00OOo0.un_join_and_follow_content);
                }
            } else if (uiType.equals("unJoin")) {
                objectRef.element = o0000.OooO0OO(oO00OOo0.Unjoin);
                objectRef2.element = o0000.OooO0OO(oO00OOo0.un_join_content);
            }
        } else if (uiType.equals("unFollow")) {
            objectRef.element = o0000.OooO0OO(oO00OOo0.Unfollow);
            objectRef2.element = o0000.OooO0OO(oO00OOo0.un_follow_content);
        }
