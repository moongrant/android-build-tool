...
public final class s4 extends Lambda implements Function4<ColumnScope, UserMyOutFitModel, Composer, Integer, Unit> {
    ...
    public final /* synthetic */ Function4<ColumnScope, UserMyOutFitModel, Composer, Integer, Unit> f53140OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ int f53141OooO0o0;
    ...
    public s4(Function4<? super ColumnScope, ? super UserMyOutFitModel, ? super Composer, ? super Integer, Unit> function4, int i) {
        super(4);
        this.f53140OooO0Oo = function4;
        this.f53141OooO0o0 = i;
    }
    ...
    public final Unit invoke(ColumnScope columnScope, UserMyOutFitModel userMyOutFitModel, Composer composer, Integer num) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(2097826284, iIntValue, -1, "com.yalla.yalla.ui.dialog.UserOutFitDialog.onAddProfilePreViewDialog.<anonymous>.<anonymous>.<anonymous>.<anonymous> (UserOutFitDialog.kt:134)");
        }
        this.f53140OooO0Oo.invoke(PagerProfileItem, it, composer2, Integer.valueOf((iIntValue & 14) | 64 | ((this.f53141OooO0o0 >> 6) & 896)));
        if (ComposerKt.isTraceInProgress()) {
