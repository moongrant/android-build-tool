...
public final class t2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ LifecycleOwner f53155OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ MutableState<WebView> f53156OooO0o0;

    public static final class OooO00o extends Lambda implements Function1<Long, Unit> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MutableState<WebView> f53157OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(MutableState<WebView> mutableState) {
            super(1);
            this.f53157OooO0Oo = mutableState;
        }

        @Override // kotlin.jvm.functions.Function1
        public final Unit invoke(Long l) {
            WebView value = this.f53157OooO0Oo.getValue();
            if (value != null) {
                oO000Oo0.OooO0OO(value);
            }
    ...
    public t2(LifecycleOwner lifecycleOwner, MutableState<WebView> mutableState, Continuation<? super t2> continuation) {
        ...
        this.f53155OooO0Oo = lifecycleOwner;
        this.f53156OooO0o0 = mutableState;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new t2(this.f53155OooO0Oo, this.f53156OooO0o0, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        o000000O.OooO0O0().observe(this.f53155OooO0Oo, new q2.OooO(new OooO00o(this.f53156OooO0o0)));
        return Unit.INSTANCE;
    }
}
