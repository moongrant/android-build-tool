...
public final class w0 extends o00O0O {

    /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
    public final int f53181OooOOO;

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    @NotNull
    public final List<ChatModel> f53182OooOOO0;

    /* JADX INFO: renamed from: OooOOOO, reason: collision with root package name */
    public final long f53183OooOOOO;

    /* JADX INFO: renamed from: OooOOOo, reason: collision with root package name */
    public final boolean f53184OooOOOo;

    /* JADX INFO: renamed from: OooOOo, reason: collision with root package name */
    @NotNull
    public final Lazy f53185OooOOo;

    /* JADX INFO: renamed from: OooOOo0, reason: collision with root package name */
    @NotNull
    public final Function0<Unit> f53186OooOOo0;

    /* JADX INFO: renamed from: OooOOoo, reason: collision with root package name */
    @NotNull
    public final Lazy f53187OooOOoo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Code duplicated, block: B:32:0x011d  */
    /* JADX WARN: Multi-variable type inference failed */
    public w0(@NotNull MixedRoomActivity context, @NotNull ArrayList chatListClone, int i, long j, boolean z, @NotNull o0000O0 dislike) {
        ...
        this.f53182OooOOO0 = chatListClone;
        this.f53181OooOOO = i;
        this.f53183OooOOOO = j;
        this.f53184OooOOOo = z;
        this.f53186OooOOo0 = dislike;
        Lazy lazy = LazyKt.lazy(new v0(this));
        this.f53185OooOOo = lazy;
        this.f53187OooOOoo = LazyKt.lazy(new u0(this));
        ...
        while (true) {
            ...
            if (newFrom2 != null && (userId = newFrom2.getUserId()) != null) {
                ...
                ChatModel chatModel2 = (ChatModel) this.f53187OooOOoo.getValue();
                if ((chatModel2 == null || (newFrom = chatModel2.getNewFrom()) == null || (userId2 = newFrom.getUserId()) == null || jLongValue != userId2.getValue().longValue()) ? false : true) {
                    ChatModel chatModel3 = (ChatModel) this.f53187OooOOoo.getValue();
                ...
                reportFromData.setRoomId(this.f53183OooOOOO);
                arrayList.add(reportFromData);
            }
        }
        ChatModel chatModel4 = (ChatModel) this.f53187OooOOoo.getValue();
        if (chatModel4 != null) {
            ...
            if (type == 0 || type == 1 || (type == 3 ? chatModel4.getGiftid() > 0 : type == 7 || type == 16 || ((type == 11 || type == 12) && !chatModel4.getIsSkillCard()))) {
                OooOOO0(o0000.OooO0OO(oO00OOo0.Room_Reply));
            }
            int type2 = chatModel4.getType();
            if (type2 == 0 || type2 == 7) {
                if (chatModel4.getType() != 7) {
                    OooOOO0(o0000.OooO0OO(oO00OOo0.Copy));
                }
                ...
                if (l == null || jLongValue2 != l.longValue()) {
                    OooOOO0(o0000.OooO0OO(oO00OOo0.Report));
                    OooOOO0(o0000.OooO0OO(oO00OOo0.Remove));
                }
            }
            if (this.f53184OooOOOo) {
                RoomUserInfoModel newFrom5 = this.f53182OooOOO0.get(this.f53181OooOOO).getNewFrom();
                ...
                if (l2 != null && jLongValue3 == l2.longValue()) {
                    OooOOO0(o0000.OooO0OO(oO00OOo0.Switch_chat_box));
                } else {
                    RoomUserInfoDTO.ChatBubbleInfo value = newFrom5.getBubbleInfo().getValue();
                    if ((value == null || value.getIsDefaultBubble()) ? false : true) {
                        OooOOO0(o0000.OooO0OO(oO00OOo0.Chat_Box));
                    }
                }
            }
            OooOOo0(new t0(this, chatModel4, context, arrayList));
            if (!this.f38233OooO0oo.isEmpty()) {
                OooOO0o();
            }
        }
    }
