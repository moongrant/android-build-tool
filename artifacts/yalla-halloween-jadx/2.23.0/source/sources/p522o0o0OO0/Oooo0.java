...
public final class Oooo0 extends Lambda implements Function1<SystemMessage, Unit> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ MessageBoxFragment f53430OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public Oooo0(MessageBoxFragment messageBoxFragment) {
        super(1);
        this.f53430OooO0Oo = messageBoxFragment;
    }

    @Override // kotlin.jvm.functions.Function1
    public final Unit invoke(SystemMessage systemMessage) {
        SystemMessage systemMessage2 = systemMessage;
        Oooo000 oooo000 = this.f53430OooO0Oo.f28503OooOOOo;
        if (oooo000 == null) {
