...
public final class o00O0O extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f53433OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ MessageBoxFragment f53434OooO0o0;
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<o0OOO0o<ConversationWithUser>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f53435OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ MessageBoxFragment f53436OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f53437OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(MessageBoxFragment messageBoxFragment, Continuation<? super OooO00o> continuation) {
            super(2, continuation);
            this.f53436OooO0o = messageBoxFragment;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO00o oooO00o = new OooO00o(this.f53436OooO0o, continuation);
            oooO00o.f53437OooO0o0 = obj;
            return oooO00o;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f53435OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                o0OOO0o o0ooo0o2 = (o0OOO0o) this.f53437OooO0o0;
                OooO0OO oooO0OO = this.f53436OooO0o.f28505OooOOo0;
                if (oooO0OO == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("adapterMessageChat");
                    oooO0OO = null;
                }
                this.f53435OooO0Oo = 1;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00O0O(MessageBoxFragment messageBoxFragment, Continuation<? super o00O0O> continuation) {
        super(2, continuation);
        this.f53434OooO0o0 = messageBoxFragment;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o00O0O(this.f53434OooO0o0, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = this.f53433OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            MessageBoxFragment messageBoxFragment = this.f53434OooO0o0;
            SharedFlow sharedFlowOooO0O0 = ((oO0Oo0o0) messageBoxFragment.f28502OooOOOO.getValue()).OooO0O0();
            OooO00o oooO00o = new OooO00o(messageBoxFragment, null);
            this.f53433OooO0Oo = 1;
