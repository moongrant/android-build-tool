...
public final class o0OoOo0 extends Lambda implements Function1<YallaTeamMessage, Unit> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ MessageBoxFragment f53444OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0OoOo0(MessageBoxFragment messageBoxFragment) {
        super(1);
        this.f53444OooO0Oo = messageBoxFragment;
    }

    @Override // kotlin.jvm.functions.Function1
    public final Unit invoke(YallaTeamMessage yallaTeamMessage) {
        YallaTeamMessage yallaTeamMessage2 = yallaTeamMessage;
        Oooo000 oooo000 = this.f53444OooO0Oo.f28503OooOOOo;
        if (oooo000 == null) {
