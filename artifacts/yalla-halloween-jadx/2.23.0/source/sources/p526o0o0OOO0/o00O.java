...
public final class o00O {
    ...
    @NotNull
    public static final ProvidableCompositionLocal<NavBackStackEntry> f53592OooO00o = CompositionLocalKt.compositionLocalOf$default(null, OooO00o.f53594OooO0Oo, 1, null);

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public static final ProvidableCompositionLocal<o00000O> f53593OooO0O0 = CompositionLocalKt.compositionLocalOf$default(null, OooO0O0.f53595OooO0Oo, 1, null);

    public static final class OooO00o extends Lambda implements Function0<NavBackStackEntry> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO00o f53594OooO0Oo = new OooO00o();
    ...
    public static final class OooO0O0 extends Lambda implements Function0<o00000O> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO0O0 f53595OooO0Oo = new OooO0O0();
    ...
    public static final Bundle OooO0O0(@NotNull NavBackStackEntry navBackStackEntry, @Nullable Composer composer) {
        ...
        o00000O o00000o = (o00000O) composer.consume(f53593OooO0O0);
        composer.startReplaceableGroup(-492369756);
        Object objRememberedValue = composer.rememberedValue();
        if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
            if (o00000o.OooO0oo() == null) {
                ...
                NavBackStackEntry navBackStackEntryOooO0oo = o00000o.OooO0oo();
