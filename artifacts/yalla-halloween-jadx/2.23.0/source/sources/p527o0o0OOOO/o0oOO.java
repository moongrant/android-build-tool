...
public final class o0oOO {
    ...
    public static final class OooO extends Lambda implements Function0<Unit> {
        ...
        public final /* synthetic */ FriendRequestDetailVM f53664OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f53665OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(FriendRequestDetailVM friendRequestDetailVM, MutableState<Boolean> mutableState) {
            super(0);
            this.f53664OooO0Oo = friendRequestDetailVM;
            this.f53665OooO0o0 = mutableState;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            if (!this.f53664OooO0Oo.isBlack()) {
                o0OO000.OooO00o("104039");
            }
            this.f53665OooO0o0.setValue(Boolean.TRUE);
    ...
    public static final class OooO00o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ String f53666OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f53667OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(String str, int i) {
            super(2);
            this.f53666OooO0Oo = str;
            this.f53667OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f53667OooO0o0 | 1);
            o0oOO.OooO00o(this.f53666OooO0Oo, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ FriendRequestDetailVM f53668OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ FriendRequestMessage f53669OooO0o0;
        ...
        public OooO0O0(FriendRequestDetailVM friendRequestDetailVM, FriendRequestMessage friendRequestMessage, Continuation<? super OooO0O0> continuation) {
            ...
            this.f53668OooO0Oo = friendRequestDetailVM;
            this.f53669OooO0o0 = friendRequestMessage;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0O0(this.f53668OooO0Oo, this.f53669OooO0o0, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            this.f53668OooO0Oo.checkIsFriendAndBlock(this.f53669OooO0o0.getTargetUserId());
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0OO extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ FriendRequestDetailVM f53670OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ LifecycleOwner f53671OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ FriendRequestMessage f53672OooO0o0;
        ...
        public OooO0OO(FriendRequestDetailVM friendRequestDetailVM, FriendRequestMessage friendRequestMessage, LifecycleOwner lifecycleOwner) {
            super(0);
            this.f53670OooO0Oo = friendRequestDetailVM;
            this.f53672OooO0o0 = friendRequestMessage;
            this.f53671OooO0o = lifecycleOwner;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            FriendRequestMessage friendRequestMessage = this.f53672OooO0o0;
            long targetUserId = friendRequestMessage.getTargetUserId();
            FriendRequestDetailVM friendRequestDetailVM = this.f53670OooO0Oo;
            friendRequestDetailVM.blockUser(targetUserId, !friendRequestDetailVM.isBlack(), friendRequestMessage.getState()).observe(this.f53671OooO0o, new o0OoOo0(o0O00o0.f53645OooO0Oo));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0o extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO0o f53673OooO0Oo = new OooO0o();
    ...
    public static final class OooOO0 extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ FriendRequestMessage f53674OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0(FriendRequestMessage friendRequestMessage) {
            super(0);
            this.f53674OooO0Oo = friendRequestMessage;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            o0OO000.OooO00o("104040");
            ReportScreen reportScreen = ReportScreen.INSTANCE;
            FriendRequestMessage friendRequestMessage = this.f53674OooO0Oo;
            oo0oOO0.OooO0o0(reportScreen, ReportScreen.bundleOf(2, friendRequestMessage.getTargetUserId(), (244 & 4) != 0 ? null : null, (244 & 8) != 0 ? null : null, (244 & 16) != 0 ? null : null, (244 & 32) != 0 ? null : null, (244 & 64) != 0 ? null : friendRequestMessage.getMessage(), (244 & 128) != 0 ? null : 2), false, null, 12);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0O extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ FriendRequestMessage f53675OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f53676OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0O(FriendRequestMessage friendRequestMessage, int i) {
            super(2);
            this.f53675OooO0Oo = friendRequestMessage;
            this.f53676OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f53676OooO0o0 | 1);
            o0oOO.OooO0O0(this.f53675OooO0Oo, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOOO extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ FriendRequestDetailVM f53677OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ LifecycleOwner f53678OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ FriendRequestMessage f53679OooO0o0;
        ...
        public OooOOO(FriendRequestDetailVM friendRequestDetailVM, FriendRequestMessage friendRequestMessage, LifecycleOwner lifecycleOwner) {
            super(0);
            this.f53677OooO0Oo = friendRequestDetailVM;
            this.f53679OooO0o0 = friendRequestMessage;
            this.f53678OooO0o = lifecycleOwner;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            o0OO000.OooO00o("104037");
            this.f53677OooO0Oo.applyFriendRequest(true, this.f53679OooO0o0.getTargetUserId()).observe(this.f53678OooO0o, new o0OoOo0(o0oOOo.f53693OooO0Oo));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOOO0 extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ FriendRequestDetailVM f53680OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ LifecycleOwner f53681OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ FriendRequestMessage f53682OooO0o0;
        ...
        public OooOOO0(FriendRequestDetailVM friendRequestDetailVM, FriendRequestMessage friendRequestMessage, LifecycleOwner lifecycleOwner) {
            super(0);
            this.f53680OooO0Oo = friendRequestDetailVM;
            this.f53682OooO0o0 = friendRequestMessage;
            this.f53681OooO0o = lifecycleOwner;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            o0OO000.OooO00o("104038");
            this.f53680OooO0Oo.applyFriendRequest(false, this.f53682OooO0o0.getTargetUserId()).observe(this.f53681OooO0o, new o0OoOo0(oo00oO.f53694OooO0Oo));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOOOO extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ FriendRequestMessage f53683OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOOO(FriendRequestMessage friendRequestMessage) {
            super(0);
            this.f53683OooO0Oo = friendRequestMessage;
        }
        ...
        public final Unit invoke() {
            ...
            if (activityOooO0O0 != null) {
                ...
                PrivateChatActivity.OooO00o.OooO00o(activityOooO0O0, Long.valueOf(this.f53683OooO0Oo.getTargetUserId()));
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOo extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooOo f53684OooO0Oo = new OooOo();
    ...
    public static final class OooOo00 extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooOo00 f53685OooO0Oo = new OooOo00();
    ...
    public static final class Oooo0 extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ long f53686OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public Oooo0(long j) {
            super(0);
            this.f53686OooO0Oo = j;
        }
        ...
        public final Unit invoke() {
            ...
            Activity activityOooO0O0 = com.code.android.util.OooO0O0.OooO0O0();
            if (activityOooO0O0 != null) {
                UserInfoActivity.OooO00o.OooO0OO(UserInfoActivity.f27240Oooo0o, activityOooO0O0, String.valueOf(this.f53686OooO0Oo), false, 12);
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class Oooo000 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ FriendRequestMessage f53687OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f53688OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public Oooo000(FriendRequestMessage friendRequestMessage, int i) {
            super(2);
            this.f53687OooO0Oo = friendRequestMessage;
            this.f53688OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f53688OooO0o0 | 1);
            o0oOO.OooO0OO(this.f53687OooO0Oo, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class o000oOoO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ long f53689OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f53690OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ FriendRequestMessage f53691OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public o000oOoO(long j, FriendRequestMessage friendRequestMessage, int i) {
            super(2);
            this.f53689OooO0Oo = j;
            this.f53691OooO0o0 = friendRequestMessage;
            this.f53690OooO0o = i;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f53690OooO0o | 1);
            o0oOO.OooO0Oo(this.f53689OooO0Oo, this.f53691OooO0o0, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class o0OoOo0 implements Observer, FunctionAdapter {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function1 f53692OooO0Oo;

        public o0OoOo0(Function1 function) {
            Intrinsics.checkNotNullParameter(function, "function");
            this.f53692OooO0Oo = function;
        }
        ...
        public final boolean equals(@Nullable Object obj) {
            ...
            return Intrinsics.areEqual(this.f53692OooO0Oo, ((FunctionAdapter) obj).getFunctionDelegate());
        }
        ...
        public final int hashCode() {
            return this.f53692OooO0Oo.hashCode();
        }

        @Override // androidx.lifecycle.Observer
        public final /* synthetic */ void onChanged(Object obj) {
            this.f53692OooO0Oo.invoke(obj);
        }
    }
    ...
    public static final void OooO00o(String str, Composer composer, int i) {
        ...
        if ((i2 & 11) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(202519101, i, -1, "com.yalla.yalla.ui.screen.message.RequestMessage (FriendRequestDetailScreen.kt:247)");
            }
            float f = 16;
            Modifier modifierM476padding3ABfNKs = PaddingKt.m476padding3ABfNKs(BorderKt.m180borderxT4_qwU(BackgroundKt.m168backgroundbw27NRU(SizeKt.m511heightInVpY3zN4$default(SizeKt.fillMaxWidth$default(PaddingKt.m478paddingVpY3zN4$default(Modifier.INSTANCE, Dp.m3765constructorimpl(f), 0.0f, 2, null), 0.0f, 1, null), Dp.m3765constructorimpl(80), 0.0f, 2, null), o000OOo.OooO0OO(composerStartRestartGroup).f37704OooO0OO, RoundedCornerShapeKt.m727RoundedCornerShape0680j_4(Dp.m3765constructorimpl(f))), Dp.m3765constructorimpl((float) 0.5d), o000OOo.OooO0OO(composerStartRestartGroup).f37706OooO0o, RoundedCornerShapeKt.m727RoundedCornerShape0680j_4(Dp.m3765constructorimpl(f))), Dp.m3765constructorimpl(f));
    ...
    public static final void OooO0O0(FriendRequestMessage friendRequestMessage, Composer composer, int i) {
        ...
        String strStringResource = friendRequestDetailVM.isBlack() ? "" : StringResources_androidKt.stringResource(oO00OOo0.Add_Block_This_User_Title, composerStartRestartGroup, 0);
        composerStartRestartGroup.endReplaceableGroup();
        oo000o.OooO0Oo(mutableState, strStringResource, StringResources_androidKt.stringResource(friendRequestDetailVM.isBlack() ? oO00OOo0.Unblock_this_user : oO00OOo0.Add_Block_This_User_Content, composerStartRestartGroup, 0), null, false, false, null, null, null, false, null, false, new OooO0OO(friendRequestDetailVM, friendRequestMessage, lifecycleOwner), null, false, false, null, OooO0o.f53673OooO0Oo, null, null, composerStartRestartGroup, 6, 12582912, 913400);
        Arrangement.HorizontalOrVertical center = Arrangement.INSTANCE.getCenter();
        Alignment.Vertical centerVertically = Alignment.INSTANCE.getCenterVertically();
        Modifier.Companion companion = Modifier.INSTANCE;
        Modifier modifierOooO00o = p445o0OoOoo.o0oOO.OooO00o(16, SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), 0.0f, 2, null, composerStartRestartGroup, 693286680);
        ...
        TextKt.m1251Text4IGK_g(StringResources_androidKt.stringResource(friendRequestDetailVM.isBlack() ? oO00OOo0.Unblock : oO00OOo0.Block, composerStartRestartGroup, 0), o0O0O00.OooO0O0(companion, false, false, 0L, false, null, null, null, new OooO(friendRequestDetailVM, mutableState), 253), o000OOo.OooO0OO(composerStartRestartGroup).f37711OooOO0O, TextUnitKt.getSp(12), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composerStartRestartGroup, 3072, 0, 131056);
        SurfaceKt.m1185SurfaceFjzlyU(SizeKt.m525sizeVpY3zN4(PaddingKt.m478paddingVpY3zN4$default(companion, Dp.m3765constructorimpl(12), 0.0f, 2, null), Dp.m3765constructorimpl(1), Dp.m3765constructorimpl(10)), null, o000OOo.OooO0OO(composerStartRestartGroup).f37711OooOO0O, 0L, null, 0.0f, o00OOOO0.f53622OooO00o, composerStartRestartGroup, 1572870, 58);
        TextKt.m1251Text4IGK_g(StringResources_androidKt.stringResource(oO00OOo0.Report, composerStartRestartGroup, 0), o0O0O00.OooO0O0(companion, false, false, 0L, false, null, null, null, new OooOO0(friendRequestMessage), 253), o000OOo.OooO0OO(composerStartRestartGroup).f37711OooOO0O, TextUnitKt.getSp(12), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composerStartRestartGroup, 3072, 0, 131056);
    ...
    public static final void OooO0OO(FriendRequestMessage friendRequestMessage, Composer composer, int i) {
        ...
        Modifier.Companion companion = Modifier.INSTANCE;
        float f = 16;
        Modifier modifierOooO00o = p445o0OoOoo.o0oOO.OooO00o(f, SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), 0.0f, 2, null, composerStartRestartGroup, 693286680);
        ...
        if (numValueOf != null && numValueOf.intValue() == 0) {
            ...
            String strStringResource = StringResources_androidKt.stringResource(oO00OOo0.Decline, composerStartRestartGroup, 0);
            TextButtonStyle textButtonStyle = TextButtonStyle.GreenOutLined;
            FontWeight.Companion companion3 = FontWeight.INSTANCE;
            float f2 = 44;
            composer2 = composerStartRestartGroup;
            o00000O0.OooO00o(strStringResource, 0L, companion3.getNormal(), textButtonStyle, null, null, null, 0.0f, null, false, false, 0L, false, null, null, null, null, null, SizeKt.m509height3ABfNKs(androidx.compose.foundation.layout.OooOO0O.OooO00o(rowScopeInstance, companion, 1.0f, false, 2, null), Dp.m3765constructorimpl(f2)), new OooOOO0(friendRequestDetailVM, friendRequestMessage, lifecycleOwner), composerStartRestartGroup, 3456, 0, 262130);
            com.code.android.util.OooOO0.OooO0Oo(Dp.m3765constructorimpl(f), null, composer2, 6, 2);
            o00000O0.OooO00o(StringResources_androidKt.stringResource(oO00OOo0.Accept, composer2, 0), 0L, companion3.getNormal(), TextButtonStyle.Green, null, null, null, 0.0f, null, false, false, 0L, false, null, null, null, null, null, SizeKt.m509height3ABfNKs(androidx.compose.foundation.layout.OooOO0O.OooO00o(rowScopeInstance, companion, 1.0f, false, 2, null), Dp.m3765constructorimpl(f2)), new OooOOO(friendRequestDetailVM, friendRequestMessage, lifecycleOwner), composer2, 3456, 0, 262130);
            composer2.endReplaceableGroup();
        } else {
            composer2 = composerStartRestartGroup;
            if (numValueOf != null && numValueOf.intValue() == 1) {
                composer2.startReplaceableGroup(159326504);
                o00000O0.OooO00o(StringResources_androidKt.stringResource(oO00OOo0.Chat, composer2, 0), 0L, FontWeight.INSTANCE.getNormal(), TextButtonStyle.Green, null, null, null, 0.0f, null, false, false, 0L, false, null, null, null, null, null, SizeKt.m509height3ABfNKs(androidx.compose.foundation.layout.OooOO0O.OooO00o(rowScopeInstance, companion, 1.0f, false, 2, null), Dp.m3765constructorimpl(44)), new OooOOOO(friendRequestMessage), composer2, 3456, 0, 262130);
                composer2.endReplaceableGroup();
                ...
                if (friendRequestDetailVM.getHaveRejectOperation()) {
                    ...
                    String strStringResource2 = StringResources_androidKt.stringResource(oO00OOo0.Declined, composer2, 0);
                    TextButtonStyle textButtonStyle2 = TextButtonStyle.GreyDisable;
                    FontWeight.Companion companion4 = FontWeight.INSTANCE;
                    float f3 = 44;
                    o00000O0.OooO00o(strStringResource2, 0L, companion4.getNormal(), textButtonStyle2, null, null, null, 0.0f, null, false, false, 0L, false, null, null, null, null, null, SizeKt.m509height3ABfNKs(androidx.compose.foundation.layout.OooOO0O.OooO00o(rowScopeInstance, companion, 1.0f, false, 2, null), Dp.m3765constructorimpl(f3)), OooOo00.f53685OooO0Oo, composer2, 805309824, 805306368, 261618);
                    com.code.android.util.OooOO0.OooO0Oo(Dp.m3765constructorimpl(f), null, composer2, 6, 2);
                    o00000O0.OooO00o(StringResources_androidKt.stringResource(oO00OOo0.Accept, composer2, 0), 0L, companion4.getNormal(), TextButtonStyle.GreyOutlinedDisable, null, null, null, 0.0f, null, false, false, 0L, false, null, null, null, null, null, SizeKt.m509height3ABfNKs(androidx.compose.foundation.layout.OooOO0O.OooO00o(rowScopeInstance, companion, 1.0f, false, 2, null), Dp.m3765constructorimpl(f3)), OooOo.f53684OooO0Oo, composer2, 805309824, 805306368, 261618);
                    composer2.endReplaceableGroup();
                } else {
                    composer2.startReplaceableGroup(159328057);
                    com.code.android.util.OooOO0.OooO0o(Dp.m3765constructorimpl(20), null, composer2, 6, 2);
                    TextKt.m1251Text4IGK_g(StringResources_androidKt.stringResource(oO00OOo0.friend_request_declined, composer2, 0), (Modifier) null, o000OOo.OooO0OO(composer2).f37714OooOOO0, TextUnitKt.getSp(13), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 3072, 0, 131058);
                    composer2.endReplaceableGroup();
                }
                composer2.endReplaceableGroup();
                ...
                com.code.android.util.OooOO0.OooO0o(Dp.m3765constructorimpl(20), null, composer2, 6, 2);
                TextKt.m1251Text4IGK_g(StringResources_androidKt.stringResource(oO00OOo0.friend_request_expired, composer2, 0), (Modifier) null, o000OOo.OooO0OO(composer2).f37714OooOOO0, TextUnitKt.getSp(13), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 3072, 0, 131058);
                composer2.endReplaceableGroup();
            } else {
    ...
    public static final void OooO0Oo(long j, FriendRequestMessage friendRequestMessage, Composer composer, int i) {
        ...
        composerStartRestartGroup.endReplaceableGroup();
        float f = 16;
        Modifier modifierOooO00o = p445o0OoOoo.o0oOO.OooO00o(f, o0O0O00.OooO0O0(companion2, false, false, 0L, false, null, null, null, (Function0) objRememberedValue, 253), 0.0f, 2, null, composerStartRestartGroup, 693286680);
        ...
        oooOOOO.OooO(userHeader, userInfo2 != null ? userInfo2.getUserHeaderFrame() : null, 0.0f, null, ClipKt.clip(SizeKt.m523size3ABfNKs(companion2, Dp.m3765constructorimpl(60)), RoundedCornerShapeKt.getCircleShape()), composerStartRestartGroup, 262144, 12);
        float f2 = 8;
        ...
        oooOOOO.OooOOOo(userName, 0L, false, 0L, 0, 0, null, false, rowScopeInstance.weight(companion2, 1.0f, false), composerStartRestartGroup, Pow2.MAX_POW2, 254);
        float f3 = 6;
        ...
        oooOOOO.OooOOO0(userInfo4 != null ? Integer.valueOf(userInfo4.getUserLevel()) : null, 0L, 0L, null, composerStartRestartGroup, ShareRequest.THUMB_DATA_SIZE_LIMIT, 14);
        composerStartRestartGroup.endReplaceableGroup();
        ...
        composerStartRestartGroup.startReplaceableGroup(693286680);
        MeasurePolicy measurePolicyOooO00o4 = androidx.compose.material.OooO.OooO00o(arrangement, centerVertically3, composerStartRestartGroup, 48, -1323940314);
        ...
        oooOOOO.OooO0o(userInfo5 != null ? Integer.valueOf(userInfo5.getCountryId()) : null, PaddingKt.m480paddingqDBjuR0$default(companion2, 0.0f, 0.0f, Dp.m3765constructorimpl(f3), 0.0f, 11, null), composerStartRestartGroup, 560, 0);
        UserInfo userInfo6 = (UserInfo) mutableStateOooO0o0.getValue();
        oooOOOO.OooO0oO(userInfo6 != null ? Integer.valueOf(userInfo6.getSex()) : null, SizeKt.m523size3ABfNKs(PaddingKt.m480paddingqDBjuR0$default(companion2, 0.0f, 0.0f, Dp.m3765constructorimpl(f3), 0.0f, 11, null), Dp.m3765constructorimpl(f)), composerStartRestartGroup, 560, 0);
        UserInfo userInfo7 = (UserInfo) mutableStateOooO0o0.getValue();
        oooOOOO.OooOo00(userInfo7 != null ? Integer.valueOf(userInfo7.getIdLevel()) : null, SizeKt.m523size3ABfNKs(PaddingKt.m480paddingqDBjuR0$default(companion2, 0.0f, 0.0f, Dp.m3765constructorimpl(f3), 0.0f, 11, null), Dp.m3765constructorimpl(f)), composerStartRestartGroup, 560, 0);
        UserInfo userInfo8 = (UserInfo) mutableStateOooO0o0.getValue();
        p517o0o0O0o.OooOOOO.OooOo0(null, userInfo8 != null ? Integer.valueOf(userInfo8.getVipLevel()) : null, null, 0.0f, SizeKt.m523size3ABfNKs(PaddingKt.m480paddingqDBjuR0$default(companion2, 0.0f, 0.0f, Dp.m3765constructorimpl(f3), 0.0f, 11, null), Dp.m3765constructorimpl(f)), composerStartRestartGroup, 286720, 13);
        ...
        p517o0o0O0o.OooOOOO.OooOOo(boolValueOf, userInfo10 != null ? Integer.valueOf(userInfo10.getPremiumLevel()) : null, false, 0.0f, SizeKt.m523size3ABfNKs(PaddingKt.m480paddingqDBjuR0$default(companion2, 0.0f, 0.0f, Dp.m3765constructorimpl(f3), 0.0f, 11, null), Dp.m3765constructorimpl(f)), composerStartRestartGroup, 286720, 12);
        UserInfo userInfo11 = (UserInfo) mutableStateOooO0o0.getValue();
        oooOOOO.OooOOO(userInfo11 != null ? userInfo11.getMedal() : null, null, 0.0f, null, composerStartRestartGroup, ShareRequest.THUMB_DATA_SIZE_LIMIT, 14);
        composerStartRestartGroup.endReplaceableGroup();
        composerStartRestartGroup.endNode();
        composerStartRestartGroup.endReplaceableGroup();
        composerStartRestartGroup.endReplaceableGroup();
        ...
        composerStartRestartGroup.endReplaceableGroup();
        composerStartRestartGroup.endReplaceableGroup();
        com.code.android.util.OooOO0.OooO0Oo(Dp.m3765constructorimpl(24), null, composerStartRestartGroup, 6, 2);
        IconKt.m1103Iconww6aTOc(PainterResources_androidKt.painterResource(oOo00OO0.icv_arrow, composerStartRestartGroup, 0), (String) null, o0O0O00.OooO0Oo(SizeKt.m523size3ABfNKs(companion2, Dp.m3765constructorimpl(20)), composerStartRestartGroup, 6), o000OOo.OooO0OO(composerStartRestartGroup).f37711OooOO0O, composerStartRestartGroup, 56, 0);
        if (androidx.compose.material.OooOO0.OooO0O0(composerStartRestartGroup)) {
            ComposerKt.traceEventEnd();
        }
        ScopeUpdateScope scopeUpdateScopeEndRestartGroup = composerStartRestartGroup.endRestartGroup();
    ...
    public static final void OooO0o0(Composer composer, int i) {
        ...
        if (i == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            androidx.compose.animation.OooOO0.OooO00o(0, function3ModifierMaterializerOf, SkippableUpdater.m1300boximpl(SkippableUpdater.m1301constructorimpl(composerStartRestartGroup)), composerStartRestartGroup, 2058660585);
            ColumnScopeInstance columnScopeInstance = ColumnScopeInstance.INSTANCE;
            t1.OooO00o(StringResources_androidKt.stringResource(oO00OOo0.Friend_Request, composerStartRestartGroup, 0), 0.0f, 0L, null, null, null, null, null, null, composerStartRestartGroup, 0, 510);
            ...
            if (jLongValue <= 0) {
                EffectsKt.LaunchedEffect(Unit.INSTANCE, new o00OOOOo(null), composerStartRestartGroup, 70);
            }
            composerStartRestartGroup.endReplaceableGroup();
            composerStartRestartGroup.startReplaceableGroup(1729797275);
            ViewModelStoreOwner current = LocalViewModelStoreOwner.INSTANCE.getCurrent(composerStartRestartGroup, 6);
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new o00Oo00(i));
    }
}
