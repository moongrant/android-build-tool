...
public final class oO000o00 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ PostUserModel f53833OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public oO000o00(PostUserModel postUserModel) {
        super(0);
        this.f53833OooO0Oo = postUserModel;
    }
    ...
    public final Unit invoke() {
        ...
        if (activityOooO0O0 != null) {
            oO000Oo onLogin = new oO000Oo(activityOooO0O0, this.f53833OooO0Oo);
