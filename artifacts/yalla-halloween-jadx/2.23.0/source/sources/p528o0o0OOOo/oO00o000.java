...
public final class oO00o000 extends Lambda implements Function1<ApiResult<PraiseCommentResultModel>, Unit> {
    ...
    public final /* synthetic */ MutableState<Boolean> f53896OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public oO00o000(MutableState<Boolean> mutableState) {
        super(1);
        this.f53896OooO0Oo = mutableState;
    }
    ...
    public final Unit invoke(ApiResult<PraiseCommentResultModel> apiResult) {
        ...
        this.f53896OooO0Oo.setValue(Boolean.FALSE);
