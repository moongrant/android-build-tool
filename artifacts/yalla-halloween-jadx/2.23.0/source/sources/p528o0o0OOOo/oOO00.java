...
public final class oOO00 {
    ...
    public static final class OooO extends Lambda implements Function1<OooOOOO, Unit> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f54106OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ MomentCommentsVM f54107OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MomentReplyVM f54108OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(MomentVideoVM momentVideoVM, MomentReplyVM momentReplyVM, MomentCommentsVM momentCommentsVM) {
            super(1);
            this.f54106OooO0Oo = momentVideoVM;
            this.f54108OooO0o0 = momentReplyVM;
            this.f54107OooO0o = momentCommentsVM;
        }
        ...
        public final Unit invoke(OooOOOO oooOOOO) {
            ...
            MomentVideoVM momentVideoVM = this.f54106OooO0Oo;
            MomentDetailModel currentMomentDetail = momentVideoVM.getCurrentMomentDetail();
            if (currentMomentDetail != null) {
                MomentReplyVM momentReplyVM = this.f54108OooO0o0;
                MomentCommentsVM momentCommentsVM = this.f54107OooO0o;
                ...
                OooOOO0.OooO("WRM 添加 \n\t currentMomentDetailId = " + lValueOf + " \n\t currentCommentId = " + momentVideoVM.getCurrentCommentId() + " \n\t currentReplyId = " + momentVideoVM.getCurrentReplyId() + " \n sendCommentOrReply sendModel = " + p140o00OOooo.OooOO0.OooO00o(momentSendCommentModelInitSendContent));
                momentVideoVM.sendCommentOrReply(momentSendCommentModelInitSendContent, new oOO00O0(it, momentSendCommentModelInitSendContent, momentVideoVM, momentReplyVM, momentCommentsVM));
            }
    ...
    public static final class OooO00o extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f54109OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(MomentVideoVM momentVideoVM) {
            super(0);
            this.f54109OooO0Oo = momentVideoVM;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            this.f54109OooO0Oo.getShowFastInputPanel().setValue(Boolean.FALSE);
            return Unit.INSTANCE;
        }
    }

    public static final class OooO0O0 extends Lambda implements Function0<o000oOoO> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f54110OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(MomentVideoVM momentVideoVM) {
            super(0);
            this.f54110OooO0Oo = momentVideoVM;
        }

        @Override // kotlin.jvm.functions.Function0
        public final o000oOoO invoke() {
            MomentVideoVM momentVideoVM = this.f54110OooO0Oo;
            MomentDetailModel currentMomentDetail = momentVideoVM.getCurrentMomentDetail();
            ...
            return o000O.OooO00o(lValueOf, currentCommentId, currentReplyId);
        }
    }

    public static final class OooO0OO extends Lambda implements Function1<o000oOoO, Unit> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f54111OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(MomentVideoVM momentVideoVM) {
            super(1);
            this.f54111OooO0Oo = momentVideoVM;
        }
        ...
        public final Unit invoke(o000oOoO o000oooo2) {
            ...
            Intrinsics.checkNotNullParameter(it, "it");
            MomentVideoVM momentVideoVM = this.f54111OooO0Oo;
            MomentDetailModel currentMomentDetail = momentVideoVM.getCurrentMomentDetail();
            Long lValueOf = currentMomentDetail != null ? Long.valueOf(currentMomentDetail.getId()) : null;
            Long currentCommentId = momentVideoVM.getCurrentCommentId();
            Long currentReplyId = momentVideoVM.getCurrentReplyId();
            HashMap<String, o000oOoO> map = o000O.f44463OooO00o;
            o000O.OooO0O0(lValueOf, currentCommentId, currentReplyId, it);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0o extends Lambda implements Function1<Boolean, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f54112OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f54113OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(MomentVideoVM momentVideoVM, MutableState<Boolean> mutableState) {
            super(1);
            this.f54112OooO0Oo = momentVideoVM;
            this.f54113OooO0o0 = mutableState;
        }

        @Override // kotlin.jvm.functions.Function1
        public final Unit invoke(Boolean bool) {
            boolean zBooleanValue = bool.booleanValue();
            OooOOO0.OooO0OO("onPanelVisibleChanged", "visible2 = " + zBooleanValue);
            OooOOO0.OooO0O0("WRM 添加 onPanelVisibleChanged visible1 = " + zBooleanValue);
            this.f54113OooO0o0.setValue(Boolean.valueOf(zBooleanValue));
            if (!zBooleanValue) {
                this.f54112OooO0Oo.getShowFastInputPanel().setValue(Boolean.FALSE);
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ BoxScope f54114OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f54115OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0(BoxScope boxScope, int i) {
            super(2);
            this.f54114OooO0Oo = boxScope;
            this.f54115OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f54115OooO0o0 | 1);
            oOO00.OooO00o(this.f54114OooO0Oo, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final void OooO00o(@NotNull BoxScope boxScope, @Nullable Composer composer, int i) {
        ...
        if ((i2 & 11) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1662944582, i, -1, "com.yalla.yalla.ui.screen.moment.media.MomentVideoInputPanel (MomentVideoInputPanel.kt:30)");
            }
            ...
            com.code.android.util.OooOO0.OooO00o(o0oO0O0o.f46969OooOoO0, ((Boolean) mutableState.getValue()).booleanValue(), null, null, null, new OooO00o(momentVideoVM), composerStartRestartGroup, 0, 28);
            composer2 = composerStartRestartGroup;
            o00O0OOO.OooO00o(momentVideoVM.getShowFastInputPanel(), momentVideoVM.getNeedShowEmojiFacePanel(), false, momentVideoVM.getReplyUserInfo(), new OooO0O0(momentVideoVM), new OooO0OO(momentVideoVM), new OooO0o(momentVideoVM, mutableState), new OooO(momentVideoVM, momentReplyVM, momentCommentsVM), null, null, boxScope.align(Modifier.INSTANCE, Alignment.INSTANCE.getBottomCenter()), composerStartRestartGroup, 4096, 0, 772);
            if (ComposerKt.isTraceInProgress()) {
