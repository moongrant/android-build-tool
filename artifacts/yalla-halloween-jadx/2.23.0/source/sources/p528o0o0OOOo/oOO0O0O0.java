...
public final class oOO0O0O0 {
    ...
    public static final class OooO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ RowScope f54237OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f54238OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MomentDetailModel f54239OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f54240OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(RowScope rowScope, MomentDetailModel momentDetailModel, MutableState<Boolean> mutableState, int i) {
            super(2);
            this.f54237OooO0Oo = rowScope;
            this.f54239OooO0o0 = momentDetailModel;
            this.f54238OooO0o = mutableState;
            this.f54240OooO0oO = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f54240OooO0oO | 1);
            MomentDetailModel momentDetailModel = this.f54239OooO0o0;
            MutableState<Boolean> mutableState = this.f54238OooO0o;
            oOO0O0O0.OooO0O0(this.f54237OooO0Oo, momentDetailModel, mutableState, composer, iUpdateChangedFlags);
    ...
    public static final class OooO00o extends Lambda implements Function1<IntSize, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Density f54241OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MutableState<Dp> f54242OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(Density density, MutableState<Dp> mutableState) {
            super(1);
            this.f54241OooO0Oo = density;
            this.f54242OooO0o0 = mutableState;
        }

        @Override // kotlin.jvm.functions.Function1
        public final Unit invoke(IntSize intSize) {
            this.f54242OooO0o0.setValue(Dp.m3763boximpl(this.f54241OooO0Oo.mo321toDpu2uoSUM(IntSize.m3925getWidthimpl(intSize.getPackedValue()))));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0O0 extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MomentDetailModel f54243OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ Context f54244OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(MomentDetailModel momentDetailModel, Context context) {
            super(0);
            this.f54243OooO0Oo = momentDetailModel;
            this.f54244OooO0o0 = context;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            String circleName;
            MomentDetailModel momentDetailModel = this.f54243OooO0Oo;
            ...
            if ((content != null ? content.getCircleId() : 0L) > 0) {
                ...
                TopicDetailActivity.OooO00o.OooO00o(this.f54244OooO0o0, topicInfoModel);
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0OO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Modifier f54245OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f54246OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MomentDetailModel f54247OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f54248OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(Modifier modifier, MomentDetailModel momentDetailModel, int i, int i2) {
            super(2);
            this.f54245OooO0Oo = modifier;
            this.f54247OooO0o0 = momentDetailModel;
            this.f54246OooO0o = i;
            this.f54248OooO0oO = i2;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f54246OooO0o | 1);
            MomentDetailModel momentDetailModel = this.f54247OooO0o0;
            int i = this.f54248OooO0oO;
            oOO0O0O0.OooO00o(this.f54245OooO0Oo, momentDetailModel, composer, iUpdateChangedFlags, i);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0o extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ AppCompatActivity f54249OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MomentDetailModel f54250OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(AppCompatActivity appCompatActivity, MomentDetailModel momentDetailModel) {
            super(0);
            this.f54249OooO0Oo = appCompatActivity;
            this.f54250OooO0o0 = momentDetailModel;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            AppCompatActivity appCompatActivity = this.f54249OooO0Oo;
            if (appCompatActivity != null) {
                UserInfoActivity.OooO00o.OooO0OO(UserInfoActivity.f27240Oooo0o, appCompatActivity, oo0ooO.OooO00o(this.f54250OooO0o0.getUserId()), false, 12);
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public static final void OooO00o(Modifier modifier, MomentDetailModel momentDetailModel, Composer composer, int i, int i2) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1278466005, i, -1, "com.yalla.yalla.ui.screen.moment.media.MomentTopicEnterContent (VideoLeftArea.kt:119)");
        }
        ...
        if (momentDetailModel.getContent() == null) {
            ...
            if (o0OoOo0.OooOO0(content != null ? Long.valueOf(content.getCircleId()) : null) <= 0 || momentDetailModel.getCircleDisbanded()) {
                ...
                float f = 14;
                Modifier modifierClip = ClipKt.clip(SizeKt.m509height3ABfNKs(PaddingKt.m480paddingqDBjuR0$default(companion2.then(modifier3), 0.0f, Dp.m3765constructorimpl(12), 0.0f, 0.0f, 13, null), Dp.m3765constructorimpl(27)), RoundedCornerShapeKt.m727RoundedCornerShape0680j_4(Dp.m3765constructorimpl(f)));
                ...
                ImageKt.Image(PainterResources_androidKt.painterResource(oO00OOO.ic_video_topic_enter_bg, composerStartRestartGroup, 0), (String) null, o0O0O00.OooO0Oo(ClipKt.clip(SizeKt.fillMaxHeight$default(SizeKt.m528width3ABfNKs(companion2, ((Dp) mutableState.getValue()).m3779unboximpl()), 0.0f, 1, null), RoundedCornerShapeKt.m727RoundedCornerShape0680j_4(Dp.m3765constructorimpl(f))), composerStartRestartGroup, 0), (Alignment) null, ContentScale.INSTANCE.getCrop(), 0.0f, (ColorFilter) null, composerStartRestartGroup, 24632, 104);
                Modifier modifierOooO0O0 = o0O0O00.OooO0O0(SizeKt.fillMaxHeight$default(SizeKt.wrapContentWidth$default(companion2, null, false, 3, null), 0.0f, 1, null), false, false, 0L, false, null, null, null, new OooO0O0(momentDetailModel, context), 253);
    ...
    public static final void OooO0O0(@NotNull RowScope rowScope, @NotNull MomentDetailModel videoDetailModel, @NotNull MutableState<Boolean> isExpanded, @Nullable Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(2014264416, i, -1, "com.yalla.yalla.ui.screen.moment.media.VideoLeftArea (VideoLeftArea.kt:70)");
        }
        ...
        Modifier modifierOooO00o = OooOO0O.OooO00o(rowScope, PaddingKt.m480paddingqDBjuR0$default(companion, Dp.m3765constructorimpl(16), 0.0f, Dp.m3765constructorimpl(43), 0.0f, 10, null), 1.0f, false, 2, null);
        ...
        TextKt.m1251Text4IGK_g(o00O00OO.OooO00o("@", videoDetailModel.getNickName()), o0O0O00.OooO0O0(PaddingKt.m480paddingqDBjuR0$default(companion, 0.0f, Dp.m3765constructorimpl(10), 0.0f, 0.0f, 13, null), false, false, 0L, false, null, null, null, new OooO0o(appCompatActivity, videoDetailModel), 255), o0oO0O0o.f46946OooO0O0, TextUnitKt.getSp(16), (FontStyle) null, FontWeight.INSTANCE.getMedium(), (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, TextOverflow.INSTANCE.m3719getEllipsisgIe3tQ8(), false, 1, 0, (Function1<? super TextLayoutResult, Unit>) null, new TextStyle(0L, 0L, (FontWeight) null, (FontStyle) null, (FontSynthesis) null, (FontFamily) null, (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (DrawStyle) null, (TextAlign) null, (TextDirection) null, 0L, (TextIndent) null, new PlatformTextStyle(false), (LineHeightStyle) null, (LineBreak) null, (Hyphens) null, (TextMotion) null, 16252927, (DefaultConstructorMarker) null), composerStartRestartGroup, 199680, 3120, 55248);
        ...
        if (content2 != null) {
            if (content2.length() > 0) {
                modifier = null;
                Modifier modifierAnimateContentSize$default = AnimationModifierKt.animateContentSize$default(SizeKt.fillMaxWidth$default(PaddingKt.m480paddingqDBjuR0$default(companion, 0.0f, Dp.m3765constructorimpl(8), 0.0f, 0.0f, 13, null), 0.0f, 1, null), null, null, 3, null);
                MomentSendContentModel content3 = videoDetailModel.getContent();
                String str = content2;
                composer2 = composerStartRestartGroup;
                p515o0o0O0O0.OooO0OO.OooO0O0(modifierAnimateContentSize$default, str, isExpanded, content3 != null ? content3.getAt() : null, null, null, composer2, (i & 896) | 4096, 48);
            } else {
                composer2 = composerStartRestartGroup;
                modifier = null;
            }
