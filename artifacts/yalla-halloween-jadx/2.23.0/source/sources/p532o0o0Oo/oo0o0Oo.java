...
public final class oo0o0Oo {
    ...
    public static final AtomicReference<byte[]> f54578OooO00o = new AtomicReference<>();

    public static final class OooO0O0 {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final int f54581OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final int f54582OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final byte[] f54583OooO0OO;

        public OooO0O0(@NonNull byte[] bArr, int i, int i2) {
            this.f54583OooO0OO = bArr;
            this.f54581OooO00o = i;
            this.f54582OooO0O0 = i2;
        }
    }
    ...
    public static ByteBuffer OooO0O0(@NonNull InputStream inputStream) throws IOException {
        ...
        AtomicReference<byte[]> atomicReference = f54578OooO00o;
    ...
    public static class OooO00o extends InputStream {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        @NonNull
        public final ByteBuffer f54579OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public int f54580OooO0o0 = -1;

        public OooO00o(@NonNull ByteBuffer byteBuffer) {
            this.f54579OooO0Oo = byteBuffer;
        }

        @Override // java.io.InputStream
        public final int available() {
            return this.f54579OooO0Oo.remaining();
        }

        @Override // java.io.InputStream
        public final synchronized void mark(int i) {
            this.f54580OooO0o0 = this.f54579OooO0Oo.position();
        }
        ...
        public final int read() {
            ByteBuffer byteBuffer = this.f54579OooO0Oo;
        ...
        public final synchronized void reset() throws IOException {
            int i = this.f54580OooO0o0;
            if (i == -1) {
                throw new IOException("Cannot reset to unset mark position");
            }
            this.f54579OooO0Oo.position(i);
        }
