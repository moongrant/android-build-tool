...
public final class o00O {
    ...
    @NotNull
    public static final o00O f54730OooO00o = new o00O();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final float f54731OooO0O0 = Dp.m3765constructorimpl(42);
    ...
    public static final class OooO00o extends Lambda implements Function1<LazyListScope, Unit> {
        ...
        public static final OooO00o f54732OooO0Oo = new OooO00o();
        ...
        public final Unit invoke(LazyListScope lazyListScope) {
            ...
            final SnapshotStateList<Long> snapshotStateList = com.yalla.yalla.service.room.OooO00o.f24981OooOO0.f47414OooO0OO;
            final oo0oOO0 oo0ooo0 = oo0oOO0.f54848OooO0Oo;
            LazyRow.items(snapshotStateList.size(), oo0ooo0 != null ? new Function1<Integer, Object>() { // from class: com.yalla.yalla.ui.screen.room.live.LiveRoomScreenTopSofaList$Content$1$1$invoke$$inlined$itemsIndexed$default$1
                ...
                public final Object invoke(Integer num) {
                    ...
                    return oo0ooo0.invoke(Integer.valueOf(iIntValue), snapshotStateList.get(iIntValue));
                }
                ...
                public final Unit invoke(LazyItemScope lazyItemScope, Integer num, Composer composer, Integer num2) {
                    ...
                    if ((i & 731) == 146 && composer2.getSkipping()) {
                        ...
                        int i2 = (i & 112) | (i & 14);
                        o00O.OooO0O0(o00O.f54730OooO00o, ((Number) snapshotStateList.get(iIntValue)).longValue(), iIntValue, composer2, ((i2 >> 6) & 14) | 384 | (i2 & 112));
                        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final class OooO0O0 extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO0O0 f54733OooO0Oo = new OooO0O0();
        ...
        public final Unit invoke() {
            com.yalla.yalla.service.room.OooO00o.f24981OooOO0.f47412OooO00o.setValue(Boolean.TRUE);
            o0OO000.OooO00o("102085");
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0OO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f54735OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(int i) {
            super(2);
            this.f54735OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f54735OooO0o0 | 1);
            o00O.this.OooO00o(composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    Caused by: java.lang.NullPointerException: Cannot invoke "jadx.core.dex.instructions.args.InsnArg.getType()" because "arg" is null
    	...
    	... 5 more
     */
    public static final void OooO0O0(o00O o00o2, long j, int i, Composer composer, int i2) {
        int i3;
        ...
        if ((i2 & 896) == 0) {
            i3 |= composerStartRestartGroup.changed(o00o2) ? PSKKeyManager.MAX_KEY_LENGTH_BYTES : 128;
        }
        if ((i3 & 651) == 130 && composerStartRestartGroup.getSkipping()) {
            composerStartRestartGroup.skipToGroupEnd();
        } else {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(166864323, i2, -1, "com.yalla.yalla.ui.screen.room.live.LiveRoomScreenTopSofaList.SofaItem (LiveRoomScreenTopSofaList.kt:96)");
            }
            ...
            if (roomUserInfoModelOooO0o0 == 0) {
                ...
                scopeUpdateScopeEndRestartGroup.updateScope(new o00OO0O0(o00o2, j, i, i2));
                return;
            }
            Modifier.Companion companion = Modifier.INSTANCE;
            float f = 30;
            Modifier modifierOooO0O0 = o0O0O00.OooO0O0(SizeKt.m525sizeVpY3zN4(companion, f54731OooO0O0, Dp.m3765constructorimpl(f)), false, false, 0L, false, null, null, null, new o00OO000(roomUserInfoModelOooO0o0), 253);
            ...
            ImageKt.Image(o00Oo0.OooO0O0((String) SnapshotStateKt.collectAsState(roomUserInfoModelOooO0o0.getUserHeader(), null, composerStartRestartGroup, 8, 1).getValue(), null, composerStartRestartGroup, 0, 1), (String) null, BorderKt.m180borderxT4_qwU(boxScopeInstance2.align(ClipKt.clip(SizeKt.m523size3ABfNKs(companion, Dp.m3765constructorimpl(f)), RoundedCornerShapeKt.getCircleShape()), companion2.getCenter()), Dp.m3765constructorimpl(1), o0oO0O0o.f46967OooOo0o, RoundedCornerShapeKt.getCircleShape()), (Alignment) null, ContentScale.INSTANCE.getCrop(), 0.0f, (ColorFilter) null, composerStartRestartGroup, 24624, 104);
            ...
            if (((Boolean) SnapshotStateKt.collectAsState(roomUserInfoModelOooO0o0.getSilenced(), null, composerStartRestartGroup, 8, 1).getValue()).booleanValue()) {
                ...
                IconKt.m1103Iconww6aTOc(PainterResources_androidKt.painterResource(oOo00OO0.ic_room_banned, composerStartRestartGroup, 0), (String) null, SizeKt.m523size3ABfNKs(PaddingKt.m480paddingqDBjuR0$default(boxScopeInstance2.align(companion, companion2.getTopEnd()), 0.0f, 0.0f, Dp.m3765constructorimpl(6), 0.0f, 11, null), Dp.m3765constructorimpl(14)), o0oO0O0o.f47001Oooooo, composerStartRestartGroup, 56, 0);
            } else {
                boxScopeInstance = boxScopeInstance2;
            }
            ...
            o0ooooo.OooO0OO(iIntValue, iIntValue2, PaddingKt.m480paddingqDBjuR0$default(boxScopeInstance3.align(companion, companion2.getBottomStart()), Dp.m3765constructorimpl(2), 0.0f, 0.0f, 0.0f, 14, null), composerStartRestartGroup, 3072, 0);
            if (roomUserInfoModelOooO0o0.needShowPremiumJustForCompose(composerStartRestartGroup, r13)) {
                ...
                OooOOOO.OooOOoo(((Boolean) SnapshotStateKt.collectAsState(roomUserInfoModelOooO0o0.isPremium(), null, composerStartRestartGroup, r13, 1).getValue()).booleanValue(), PremiumLevel.INSTANCE.of((Integer) SnapshotStateKt.collectAsState(roomUserInfoModelOooO0o0.getPremiumLevel(), null, composerStartRestartGroup, 8, 1).getValue()), false, 0.0f, SizeKt.m523size3ABfNKs(boxScopeInstance3.align(companion, companion2.getBottomEnd()), Dp.m3765constructorimpl(16)), composerStartRestartGroup, 262144, 12);
                composerStartRestartGroup.endReplaceableGroup();
            } else {
                composerStartRestartGroup.startReplaceableGroup(206948365);
                OooOOOO oooOOOO2 = OooOOOO.f51970OooO00o;
                OooOOOO.OooOo0((Integer) SnapshotStateKt.collectAsState(roomUserInfoModelOooO0o0.getVipState(), null, composerStartRestartGroup, r13, 1).getValue(), (Integer) SnapshotStateKt.collectAsState(roomUserInfoModelOooO0o0.getVipLevel(), null, composerStartRestartGroup, r13, 1).getValue(), (Boolean) SnapshotStateKt.collectAsState(roomUserInfoModelOooO0o0.getShowVIP(), null, composerStartRestartGroup, r13, 1).getValue(), 0.0f, SizeKt.m523size3ABfNKs(boxScopeInstance3.align(companion, companion2.getBottomEnd()), Dp.m3765constructorimpl(16)), composerStartRestartGroup, 262144, 8);
                composerStartRestartGroup.endReplaceableGroup();
            }
        ...
        scopeUpdateScopeEndRestartGroup2.updateScope(new o00OO00O(o00o2, j, i, i2));
    }
    ...
    public final void OooO00o(@Nullable Composer composer, int i) {
        ...
        if ((i & 1) == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            Alignment.Companion companion2 = Alignment.INSTANCE;
            MeasurePolicy measurePolicyOooO00o = androidx.compose.material.OooOOO.OooO00o(companion2, start, composerStartRestartGroup, 0, -1323940314);
            int currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
            CompositionLocalMap currentCompositionLocalMap = composerStartRestartGroup.getCurrentCompositionLocalMap();
            ComposeUiNode.Companion companion3 = ComposeUiNode.INSTANCE;
            Function0<ComposeUiNode> constructor = companion3.getConstructor();
            ...
            LazyDslKt.LazyRow(SizeKt.m530widthInVpY3zN4$default(companion, 0.0f, Dp.m3765constructorimpl(f54731OooO0O0 * 4.5f), 1, null), lazyListStateRememberLazyListState, null, false, null, null, null, false, OooO00o.f54732OooO0Oo, composerStartRestartGroup, 100663302, 252);
            ...
            Modifier modifierOooO0O0 = o0O0O00.OooO0O0(BackgroundKt.m168backgroundbw27NRU(SizeKt.m523size3ABfNKs(companion, Dp.m3765constructorimpl(30)), o0oO0O0o.f46947OooO0OO, RoundedCornerShapeKt.getCircleShape()), false, false, 0L, false, null, null, null, OooO0O0.f54733OooO0Oo, 253);
            ...
            Function2 function2OooO00o2 = OooO.OooO00o(companion3, composerM1309constructorimpl2, measurePolicyColumnMeasurePolicy, composerM1309constructorimpl2, currentCompositionLocalMap2);
            ...
            Painter painterPainterResource = PainterResources_androidKt.painterResource(oOo00OO0.icon_room_online_num_f, composerStartRestartGroup, 0);
            long j = o0oO0O0o.f46946OooO0O0;
            IconKt.m1103Iconww6aTOc(painterPainterResource, (String) null, SizeKt.m523size3ABfNKs(companion, Dp.m3765constructorimpl(12)), j, composerStartRestartGroup, 440, 0);
            composer2 = composerStartRestartGroup;
            TextKt.m1251Text4IGK_g(String.valueOf(((Number) SnapshotStateKt.collectAsState(com.yalla.yalla.service.room.OooO00o.f24981OooOO0.f47413OooO0O0, null, composerStartRestartGroup, 8, 1).getValue()).intValue()), (Modifier) null, j, TextUnitKt.getSp(10), (FontStyle) null, FontWeight.INSTANCE.getMedium(), (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 199680, 0, 131026);
