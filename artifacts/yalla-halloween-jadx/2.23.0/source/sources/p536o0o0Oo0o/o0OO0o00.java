...
public final class o0OO0o00 extends Lambda implements Function1<String, Unit> {
    ...
    public final /* synthetic */ FragmentActivity f54985OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0OO0o00(FragmentActivity fragmentActivity) {
        super(1);
        this.f54985OooO0Oo = fragmentActivity;
    }
    ...
    public final Unit invoke(String str) {
        ...
        if (!(url == null || StringsKt.isBlank(url))) {
            ...
            WebActivity.OooO00o.OooO00o(this.f54985OooO0Oo, webPageInfo);
        }
