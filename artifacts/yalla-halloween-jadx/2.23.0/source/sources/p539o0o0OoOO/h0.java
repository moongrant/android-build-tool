...
public final class h0 implements MeasurePolicy {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public static final h0 f55550OooO00o = new h0();

    @SourceDebugExtension({"SMAP\nBottomSheetDialogProperties.kt\nKotlin\n*S Kotlin\n*F\n+ 1 BottomSheetDialogProperties.kt\ncom/yalla/yalla/ui/view/BottomSheetDialogPropertiesKt$BottomSheetDialogLayout$1$measure$1\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,594:1\n1855#2,2:595\n*S KotlinDebug\n*F\n+ 1 BottomSheetDialogProperties.kt\ncom/yalla/yalla/ui/view/BottomSheetDialogPropertiesKt$BottomSheetDialogLayout$1$measure$1\n*L\n575#1:595,2\n*E\n"})
    public static final class OooO00o extends Lambda implements Function1<Placeable.PlacementScope, Unit> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ List<Placeable> f55551OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(ArrayList arrayList) {
            super(1);
            this.f55551OooO0Oo = arrayList;
        }
        ...
        public final Unit invoke(Placeable.PlacementScope placementScope) {
            ...
            Iterator<T> it = this.f55551OooO0Oo.iterator();
            while (it.hasNext()) {
    ...
    public final MeasureResult mo3measure3p2s80s(@NotNull MeasureScope Layout, @NotNull List<? extends Measurable> measurables, long j) {
        ...
        while (it.hasNext()) {
            arrayList.add(((Measurable) it.next()).mo2794measureBRTryo0(j));
        }
        ...
        return MeasureScope.CC.OooOOo0(Layout, width3, placeable2 != null ? placeable2.getHeight() : Constraints.m3734getMinHeightimpl(j), null, new OooO00o(arrayList), 4, null);
    }
