...
public final class k2 extends Lambda implements Function1<View, Unit> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ ScrollableView f55582OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public k2(ScrollableView scrollableView) {
        super(1);
        this.f55582OooO0Oo = scrollableView;
    }
    ...
    public final Unit invoke(View view) {
        ...
        ScrollableView scrollableView = this.f55582OooO0Oo;
        ...
        if (!Intrinsics.areEqual(it.getTag(), Integer.valueOf(scrollableView.f30609OooO0oo))) {
