...
public final class t0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f55684OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ int f55685OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ Oooo000 f55686OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public t0(Oooo000 oooo000, int i, Continuation<? super t0> continuation) {
        super(2, continuation);
        this.f55686OooO0o0 = oooo000;
        this.f55685OooO0o = i;
    }
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new t0(this.f55686OooO0o0, this.f55685OooO0o, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f55684OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            this.f55684OooO0Oo = 1;
            Saver<Oooo000, ?> saver = Oooo000.f38642OooO0oo;
            if (this.f55686OooO0o0.OooOO0(this.f55685OooO0o, 0.0f, this) == coroutine_suspended) {
