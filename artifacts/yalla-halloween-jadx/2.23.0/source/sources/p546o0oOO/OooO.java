...
public final class OooO {
    ...
    public static final class OooO00o extends Lambda implements Function1<LayoutCoordinates, Unit> {
        ...
        public final /* synthetic */ Density f55832OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MutableState<Dp> f55833OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(Density density, MutableState<Dp> mutableState) {
            super(1);
            this.f55832OooO0Oo = density;
            this.f55833OooO0o0 = mutableState;
        }
        ...
        public final Unit invoke(LayoutCoordinates layoutCoordinates) {
            ...
            this.f55833OooO0o0.setValue(Dp.m3763boximpl(this.f55832OooO0Oo.mo321toDpu2uoSUM(IntSize.m3925getWidthimpl(it.mo2801getSizeYbymL2g()))));
    ...
    public static final class OooO0O0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ BoxScope f55834OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ float f55835OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ float f55836OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f55837OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(BoxScope boxScope, float f, float f2, int i) {
            super(2);
            this.f55834OooO0Oo = boxScope;
            this.f55836OooO0o0 = f;
            this.f55835OooO0o = f2;
            this.f55837OooO0oO = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f55837OooO0oO | 1);
            float f = this.f55836OooO0o0;
            float f2 = this.f55835OooO0o;
            OooO.OooO00o(this.f55834OooO0Oo, f, f2, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final void OooO00o(@NotNull BoxScope CustomSliderProgressText, float f, float f2, @Nullable Composer composer, int i) {
        ...
        if ((i2 & 731) == 146 && composerStartRestartGroup.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-317276403, i, -1, "com.code.android.uikit.slider.CustomSliderProgressText (CustomSliderProgressText.kt:20)");
            }
            ...
            Modifier modifierM436offsetVpY3zN4 = OffsetKt.m436offsetVpY3zN4(CustomSliderProgressText.align(Modifier.INSTANCE, Alignment.INSTANCE.getCenterStart()), Dp.m3765constructorimpl(Dp.m3765constructorimpl(4) + Dp.m3765constructorimpl(f - Dp.m3765constructorimpl(((Dp) mutableState.getValue()).m3779unboximpl() / 2))), fM3765constructorimpl);
            ...
            composer2 = composerStartRestartGroup;
            TextKt.m1251Text4IGK_g(str, modifierOnGloballyPositioned, o0oO0O0o.f46960OooOOo, TextUnitKt.getSp(10), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 3072, 0, 131056);
            if (ComposerKt.isTraceInProgress()) {
