...
public final class o0OO000 {
    ...
    public static final void OooO00o(int i, @Nullable Composer composer, @NotNull MutableState showDialog, @NotNull String filePath) {
        ...
        if ((i2 & 91) == 18 && composerStartRestartGroup.getSkipping()) {
            ...
            OooOOO0.OooO00o(showDialog, false, false, null, null, 0, 0, 0.0f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1936463275, true, new o0O0oo00(filePath, i2)), composerStartRestartGroup, (i2 & 14) | 100663296, 254);
            if (ComposerKt.isTraceInProgress()) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new o0O(i, showDialog, filePath));
    }
}
