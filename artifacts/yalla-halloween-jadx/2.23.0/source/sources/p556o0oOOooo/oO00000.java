...
public final class oO00000 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MomentDetailCommentItemView f56087OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public oO00000(MomentDetailCommentItemView momentDetailCommentItemView) {
        super(0);
        this.f56087OooO0Oo = momentDetailCommentItemView;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        MomentDetailCommentItemView momentDetailCommentItemView = this.f56087OooO0Oo;
        ...
        ImageView imageView = momentDetailCommentItemView.f31082OooO0Oo.f58350OooOOO0;
