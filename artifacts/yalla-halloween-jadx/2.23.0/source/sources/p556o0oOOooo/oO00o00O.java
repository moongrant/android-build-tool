...
public final class oO00o00O extends Lambda implements Function0<Unit> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ MomentReplyItemView f56119OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public oO00o00O(MomentReplyItemView momentReplyItemView) {
        super(0);
        this.f56119OooO0Oo = momentReplyItemView;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        MomentReplyItemView momentReplyItemView = this.f56119OooO0Oo;
        ...
        momentReplyItemView.f31131OooO0Oo.f59285OooOO0.setVisibility(4);
