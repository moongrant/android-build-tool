...
public final class oO0Ooooo extends Lambda implements Function1<PraiseCommentResultModel, Unit> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ MomentDetailCommentFragment f56140OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ MomentDetailCommentItemView f56141OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ MomentReplyModel f56142OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public oO0Ooooo(MomentDetailCommentFragment momentDetailCommentFragment, MomentReplyModel momentReplyModel, MomentDetailCommentItemView momentDetailCommentItemView) {
        super(1);
        this.f56140OooO0Oo = momentDetailCommentFragment;
        this.f56142OooO0o0 = momentReplyModel;
        this.f56141OooO0o = momentDetailCommentItemView;
    }
    ...
    public final Unit invoke(PraiseCommentResultModel praiseCommentResultModel) {
        ...
        MomentDetailCommentFragment momentDetailCommentFragment = this.f56140OooO0Oo;
        ...
        if (mPostDetailModel != null) {
            ...
            MomentReplyModel momentReplyModel = this.f56142OooO0o0;
            if (z) {
            ...
            MomentDetailCommentItemView momentDetailCommentItemView = this.f56141OooO0o;
            if (zIsPraise) {
                momentDetailCommentItemView.f31082OooO0Oo.f58349OooOOO.setImageResource(oOo00OO0.ic_moment_comment_praise_gray);
            } else {
                ...
                momentDetailCommentItemView.f31082OooO0Oo.f58352OooOOOo.OooOO0o();
            }
            ...
            momentDetailCommentItemView.f31082OooO0Oo.f58348OooOO0o.setText(OooOOOO.OooO0o(momentReplyModel.getPraiseNum(), false));
            momentDetailCommentItemView.f31082OooO0Oo.f58348OooOO0o.setTextColor(o0000.OooO00o(momentReplyModel.isPraise() ? oO00O0o.color_333333 : oO00O0o.color_333333_65));
        }
