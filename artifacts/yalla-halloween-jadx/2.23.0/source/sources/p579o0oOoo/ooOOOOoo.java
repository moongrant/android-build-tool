...
public final class ooOOOOoo {
    ...
    public static final String OooO00o(@Nullable Integer num) {
        ...
        if (num != null && num.intValue() == deleteType) {
            return o0000.OooO0OO(oO00OOo0.pornography_or_violence);
        }
        ...
        if (num != null && num.intValue() == deleteType2) {
            return o0000.OooO0OO(oO00OOo0.terrorism_or_bloodiness);
        }
        ...
        if (num != null && num.intValue() == deleteType3) {
            return o0000.OooO0OO(oO00OOo0.deception_or_illegal_action);
        }
        ...
        if (num != null && num.intValue() == deleteType4) {
            return o0000.OooO0OO(oO00OOo0.advertisements);
        }
        ...
        if (num != null && num.intValue() == deleteType5) {
            return o0000.OooO0OO(oO00OOo0.copying_another_person_s_post);
        }
        ...
        if (num != null && num.intValue() == deleteType6) {
            return o0000.OooO0OO(oO00OOo0.abusing_or_insulting_others);
        }
        ...
        if (num != null && num.intValue() == deleteType7) {
            return o0000.OooO0OO(oO00OOo0.Contains_special_sensitive_information);
        }
        ...
        if (num != null && num.intValue() == deleteType8) {
            return o0000.OooO0OO(oO00OOo0.moment_delete_type_other);
        }
        ...
        if (num != null && num.intValue() == deleteType9) {
            return o0000.OooO0OO(oO00OOo0.report_delete_post_reply_nudity_or_sexual_activity);
        }
        ...
        if (num != null && num.intValue() == deleteType10) {
            return o0000.OooO0OO(oO00OOo0.report_delete_post_reply_violence);
        }
        ...
        if (num != null && num.intValue() == deleteType11) {
            return o0000.OooO0OO(oO00OOo0.report_delete_post_reply_hate_speech);
        }
        ...
        if (num != null && num.intValue() == deleteType12) {
            return o0000.OooO0OO(oO00OOo0.report_delete_post_reply_bullying_or_harassment);
        }
        ...
        if (num != null && num.intValue() == deleteType13) {
            return o0000.OooO0OO(oO00OOo0.report_delete_post_reply_false_information);
        }
        ...
        if (num != null && num.intValue() == deleteType14) {
            return o0000.OooO0OO(oO00OOo0.report_delete_post_reply_fraud);
        }
        ...
        if (num != null && num.intValue() == deleteType15) {
            return o0000.OooO0OO(oO00OOo0.report_delete_post_reply_spam);
        }
        ...
        if (num != null && num.intValue() == deleteType16) {
            return o0000.OooO0OO(oO00OOo0.report_delete_post_reply_impersonation);
        }
        ...
        if (num != null && num.intValue() == deleteType17) {
            return o0000.OooO0OO(oO00OOo0.report_delete_post_reply_sale_or_use_of_illegal_or_regulated_goods);
        }
        ...
        if (num != null && num.intValue() == deleteType18) {
            return o0000.OooO0OO(oO00OOo0.sale_yalla_golds_accounts);
        }
        ...
        if (num != null && num.intValue() == deleteType19) {
            return o0000.OooO0OO(oO00OOo0.Religion_Politics);
        }
        ...
        if (num != null && num.intValue() == deleteType20) {
            return o0000.OooO0OO(oO00OOo0.pretend_official);
        }
        ...
        if (num != null && num.intValue() == deleteType21) {
            return o0000.OooO0OO(oO00OOo0.Promote_competitive_apps);
        }
        ...
        if (num != null && num.intValue() == deleteType22) {
            return o0000.OooO0OO(oO00OOo0.Junk);
        }
        ...
        if (num != null && num.intValue() == deleteType23) {
            return o0000.OooO0OO(oO00OOo0.Advertisement);
        }
        return (num != null && num.intValue() == DeleteNotificationType.CODE_POST_OFFICIAL_DELETE_Type_116.getDeleteType()) ? o0000.OooO0OO(oO00OOo0.Others) : o0000.OooO0OO(oO00OOo0.report_delete_post_reply_common_msg);
    }
}
