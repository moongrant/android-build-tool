...
public final class ooooO0O0 extends OooO0OO<Bitmap> {

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final /* synthetic */ CancellableContinuation<Bitmap> f56729OooO0oO;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ooooO0O0(CancellableContinuationImpl cancellableContinuationImpl) {
        super(0);
        this.f56729OooO0oO = cancellableContinuationImpl;
    }
    ...
    public final void OooO0OO(Object obj) {
        ...
        CancellableContinuation<Bitmap> cancellableContinuation = this.f56729OooO0oO;
