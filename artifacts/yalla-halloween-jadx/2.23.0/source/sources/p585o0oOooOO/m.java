...
public final class m implements TextWatcher {
    ...
    public final MessageEditText f56776OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final p f56777OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public int f56778OooO0o0;
    ...
    public class OooO00o implements p.OooO00o {
        ...
        public final void OooO00o(int i, int i2, int i3, String str) {
            m.this.OooO00o(i, i2, i3);
        }
    }

    public m(MessageEditText messageEditText) {
        System.currentTimeMillis();
        this.f56778OooO0o0 = 0;
        this.f56776OooO0Oo = messageEditText;
        this.f56777OooO0o = new p(new OooO00o());
    }

    public final void OooO00o(int i, int i2, int i3) {
        h next;
        MessageEditText messageEditText = this.f56776OooO0Oo;
        ...
        int i5 = i3 - i2;
        k spanManager = messageEditText.getSpanManager();
        spanManager.OooO00o();
    ...
    public final void afterTextChanged(Editable editable) {
        this.f56778OooO0o0 = editable.length();
    }
    ...
    public final void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        ...
        p pVar = this.f56777OooO0o;
        pVar.OooO00o(jCurrentTimeMillis);
        if (i == 0 && i2 == (i4 = this.f56778OooO0o0) && i3 == 0 && i4 > 0) {
        ...
        ((o000OOo0) messageEditText.getSpanKeyListener()).OooO00o(str);
    }
}
