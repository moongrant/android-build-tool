...
public final class OooOOOO {
    ...
    public static final /* synthetic */ int f56797OooO00o = 0;
    ...
    public static String OooO0o0(long j) {
        ...
        if (j > 999900000) {
            ...
            return androidx.camera.core.impl.OooOOOO.OooO00o(f3 >= 0.0f ? str : "0.0", "B");
        }
        if (j > 999900) {
            ...
            return androidx.camera.core.impl.OooOOOO.OooO00o(f2 >= 0.0f ? str2 : "0.0", "M");
        }
        if (j >= 1000) {
            ...
            return androidx.camera.core.impl.OooOOOO.OooO00o(f >= 0.0f ? str3 : "0.0", "K");
        }
        if (j < 0) {
            return AppEventsConstants.EVENT_PARAM_VALUE_NO;
        }
