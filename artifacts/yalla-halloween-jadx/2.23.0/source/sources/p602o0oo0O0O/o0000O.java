...
public final class o0000O implements YCSDKCallback {
    ...
    public final /* synthetic */ Function1<BaseResp, Unit> f56872OooO00o;

    /* JADX WARN: Multi-variable type inference failed */
    public o0000O(Function1<? super BaseResp, Unit> function1) {
        this.f56872OooO00o = function1;
    }
    ...
    public final void onResult(@NotNull BaseResp result) {
        ...
        OooOOO0.OooO0O0("YallaChatSDK toConversationRequestisSuccess = " + result.isSuccess() + "code = " + result.getCode() + " message = " + result.getMsg());
        this.f56872OooO00o.invoke(result);
