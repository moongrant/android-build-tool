...
public final class o000O0o implements YCSDKCallback {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final /* synthetic */ Function1<BaseResp, Unit> f56889OooO00o;

    /* JADX WARN: Multi-variable type inference failed */
    public o000O0o(Function1<? super BaseResp, Unit> function1) {
        this.f56889OooO00o = function1;
    }
    ...
    public final void onResult(@NotNull BaseResp result) {
        ...
        OooOOO0.OooO0O0("YallaChatSDK toGroupJoinisSuccess = " + result.isSuccess() + "code = " + result.getCode() + " message = " + result.getMsg());
        this.f56889OooO00o.invoke(result);
