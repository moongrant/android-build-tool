...
import com.facebook.appevents.OooO0O0;
...
public final class o0000O00 extends o00000O0 implements SurfaceTexture.OnFrameAvailableListener {

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    @Nullable
    public SurfaceTexture f56980OooOO0O;

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    @NotNull
    public final Lazy f56981OooOO0o;

    /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
    public int f56982OooOOO;

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    public boolean f56983OooOOO0;

    /* JADX INFO: renamed from: OooOOOO, reason: collision with root package name */
    public int f56984OooOOOO;

    /* JADX INFO: renamed from: OooOOOo, reason: collision with root package name */
    public boolean f56985OooOOOo;

    /* JADX INFO: renamed from: OooOOo, reason: collision with root package name */
    public boolean f56986OooOOo;

    /* JADX INFO: renamed from: OooOOo0, reason: collision with root package name */
    @Nullable
    public MediaFormat f56987OooOOo0;

    public static final class OooO00o extends Lambda implements Function0<MediaCodec.BufferInfo> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO00o f56988OooO0Oo = new OooO00o();
    ...
    public o0000O00(@NotNull m1 playerEva) {
        super(playerEva);
        Intrinsics.checkNotNullParameter(playerEva, "playerEva");
        this.f56981OooOO0o = LazyKt.lazy(OooO00o.f56988OooO0Oo);
    }
    ...
    public final void OooO0o0() {
        ...
        Handler handler = this.f56973OooO0o0.f56994OooO0O0;
        if (handler != null) {
            handler.post(new o000(this, 1));
        }
    }

    public final void OooO0oO(final MediaCodec mediaCodec, final MediaExtractor mediaExtractor) {
        Handler handler = this.f56973OooO0o0.f56994OooO0O0;
        if (handler != null) {
            handler.post(new Runnable() { // from class: o0oo0Oo.o0000
                @Override // java.lang.Runnable
                public final void run() {
                    o0000O00 this$0 = this.f56966OooO0Oo;
                    ...
                    try {
                        ...
                        o00O000 o00o001 = (o00O000) this$0.f56976OooOO0.getValue();
                        o00o001.f57028OooO0O0 = 0L;
                        o00o001.f57029OooO0OO = 0L;
                        this$0.f56971OooO0Oo.f56961OooOo.OooO0OO();
                        m1 m1Var = this$0.f56971OooO0Oo;
                        m1Var.f56955OooOOO0 = -1;
                        evaJniUtil.releaseTexture(m1Var.f56944OooO0O0);
                    } catch (Throwable tr) {
    ...
    public final void OooO0oo(MediaCodec mediaCodec, MediaExtractor mediaExtractor) {
        ...
        m1 m1Var2 = this.f56971OooO0Oo;
        int i3 = 0;
        if (m1Var2.f56960OooOOoo > 0) {
            sampleTime = ((int) (mediaExtractor.getSampleTime() / ((long) (DurationKt.NANOS_IN_MILLIS / m1Var2.f56949OooO0oO)))) - 1;
        ...
        boolean z9 = false;
        boolean z10 = false;
        o0000O00 o0000o02 = this;
        while (!z9) {
            if (o0000o02.f56970OooO) {
                Intrinsics.checkNotNullParameter("EvaAnimPlayer.HardDecoder", ViewHierarchyConstants.TAG_KEY);
                Intrinsics.checkNotNullParameter("stop decode", "msg");
                OooO0oO(mediaCodec, mediaExtractor);
                return;
            }
            if (!o0000o02.f56986OooOOo) {
                if (!z8) {
                    ...
                    if (iDequeueInputBuffer >= 0) {
                        ...
                        if (sampleData < 0) {
                            ...
                            String msg2 = OooOO0.OooO00o("submitted frame ", i6, " to dec, size=", sampleData);
                            Intrinsics.checkNotNullParameter("EvaAnimPlayer.HardDecoder", ViewHierarchyConstants.TAG_KEY);
                        ...
                        if (z9) {
                            ...
                            if (iDequeueOutputBuffer == -1) {
                                ...
                                if (iDequeueOutputBuffer == -2) {
                                    ...
                                    o0000o01.f56987OooOOo0 = outputFormat;
                                    ...
                                    String msg4 = "decoder output format changed: " + o0000o01.f56987OooOOo0;
                                    Intrinsics.checkNotNullParameter("EvaAnimPlayer.HardDecoder", ViewHierarchyConstants.TAG_KEY);
                                    ...
                                    if ((((MediaCodec.BufferInfo) lazy.getValue()).flags & 4) != 0) {
                                        i = o0000o01.f56974OooO0oO - 1;
                                        o0000o01.f56974OooO0oO = i;
                                        m1Var2.OooO0o0(i);
                                        if (o0000o01.f56974OooO0oO <= 0) {
                                            z7 = true;
                                        } else {
                                            z7 = false;
                                        }
                                    ...
                                    z2 = !z9;
                                    z3 = z;
                                    lazy2 = o0000o01.f56976OooOO0;
                                    if (z2) {
                                        i5 = i5;
                                        o00o001 = (o00O000) lazy2.getValue();
                                        lazy3 = lazy2;
                                        j = ((MediaCodec.BufferInfo) lazy.getValue()).presentationTimeUs;
                                        m1Var = m1Var2;
                                        j2 = o00o001.f57029OooO0OO;
                                        if (j2 == 0) {
                                            o00o001.f57029OooO0OO = System.nanoTime() / ((long) 1000);
                                            o00o001.f57028OooO0O0 = j;
                                            iDequeueOutputBuffer = iDequeueOutputBuffer;
                                            z2 = z2;
                                            i4 = i4;
                                            o0000o02 = o0000o01;
                                        } else {
                                            z6 = o00o001.f57031OooO0o0;
                                            j3 = o00o001.f57027OooO00o;
                                            if (z6) {
                                                o00o001.f57028OooO0O0 = j - (j3 / ((long) 30));
                                                o00o001.f57031OooO0o0 = false;
                                            }
                                            j4 = o00o001.f57030OooO0Oo;
                                            if (j4 == 0) {
                                                j4 = j - o00o001.f57028OooO0O0;
                                            }
                                            if (j4 < 0) {
                                                j4 = 0;
                                            ...
                                            o00o001.f57029OooO0OO += j7;
                                            o00o001.f57028OooO0O0 += j7;
                                        }
                                        boolean z11 = o0000o02.f56985OooOOOo;
                                        if (z2 || z11) {
                                            z4 = false;
                                        } else {
                                            z4 = true;
                                        ...
                                        o0000o2.f57013OooO0o0 = i7;
                                        it = o0000o2.f57010OooO0OO.iterator();
                                        while (it.hasNext()) {
                                            ((com.yy.yyeva.mix.OooO00o) it.next()).getClass();
                                        }
                                        o0000o02.onVideoRender(i7, m1Var2.f56965OooOo0o.f56939OooO0O0);
                                        i4 = i7 + 1;
                                        ...
                                        if (i > 0) {
                                            ...
                                            mediaCodec.flush();
                                            o00O000 o00o002 = (o00O000) lazy3.getValue();
                                            o00o002.f57028OooO0O0 = 0L;
                                            o00o002.f57029OooO0OO = 0L;
                                            onVideoRestart();
                                            i4 = 0;
                                            z10 = true;
                                            z5 = false;
                                        ...
                                        if (z9) {
                                            i2 = 0;
                                        } else if (m1Var2.f56964OooOo0O) {
                                            mediaCodec.stop();
                                            mediaCodec.release();
                                            if (mediaExtractor2 != null) {
                                                mediaExtractor.release();
                                            }
                                            o00O000 o00o003 = (o00O000) lazy3.getValue();
                                            o00o003.f57028OooO0O0 = 0L;
                                            o00o003.f57029OooO0OO = 0L;
                                            o0000o2.OooO0OO();
                                            i2 = 0;
                                            o0000o02.f56975OooO0oo = false;
                                        } else {
                                            i2 = 0;
                                            OooO0oO(mediaCodec, mediaExtractor);
                                        }
                                    ...
                                    o0000o02 = this;
                                    boolean z13 = o0000o02.f56985OooOOOo;
                                    if (z2) {
                                        z4 = false;
                                    } else {
                                        z4 = false;
                                    ...
                                    o0000o2.f57013OooO0o0 = i8;
                                    it = o0000o2.f57010OooO0OO.iterator();
                                    while (it.hasNext()) {
                                        ((com.yy.yyeva.mix.OooO00o) it.next()).getClass();
                                    }
                                    o0000o02.onVideoRender(i8, m1Var2.f56965OooOo0o.f56939OooO0O0);
                                    i4 = i8 + 1;
                                    ...
                                    if (i > 0) {
                                        ...
                                        mediaExtractor2.seekTo(0L, 2);
                                        mediaCodec.flush();
                                        o00O000 o00o004 = (o00O000) lazy3.getValue();
                                        o00o004.f57028OooO0O0 = 0L;
                                        o00o004.f57029OooO0OO = 0L;
                                        onVideoRestart();
                                        i4 = 0;
                                        z10 = true;
                                        z5 = false;
                                    ...
                                    if (z9) {
                                        ...
                                        o00O000 o00o005 = (o00O000) lazy3.getValue();
                                        o00o005.f57028OooO0O0 = 0L;
                                        o00o005.f57029OooO0OO = 0L;
                                        o0000o2.OooO0OO();
                                        i2 = 0;
                                        o0000o02.f56975OooO0oo = false;
                                    } else {
                ...
                if (z9) {
                    ...
                    if (iDequeueOutputBuffer == -1) {
                        ...
                        if (iDequeueOutputBuffer == -2) {
                            ...
                            String msg10 = "decoder output format changed: " + o0000o01.f56987OooOOo0;
                            Intrinsics.checkNotNullParameter("EvaAnimPlayer.HardDecoder", ViewHierarchyConstants.TAG_KEY);
                            ...
                            if (z2) {
                                ...
                                boolean z15 = o0000o02.f56985OooOOOo;
                                if (z2) {
                                    z4 = false;
                                } else {
                                    z4 = false;
                                ...
                                o0000o2.f57013OooO0o0 = i9;
                                it = o0000o2.f57010OooO0OO.iterator();
                                while (it.hasNext()) {
                                    ((com.yy.yyeva.mix.OooO00o) it.next()).getClass();
                                }
                                o0000o02.onVideoRender(i9, m1Var2.f56965OooOo0o.f56939OooO0O0);
                                i4 = i9 + 1;
                                ...
                                if (i > 0) {
                                    ...
                                    mediaExtractor2.seekTo(0L, 2);
                                    mediaCodec.flush();
                                    o00O000 o00o006 = (o00O000) lazy3.getValue();
                                    o00o006.f57028OooO0O0 = 0L;
                                    o00o006.f57029OooO0OO = 0L;
                                    onVideoRestart();
                                    i4 = 0;
                                    z10 = true;
                                    z5 = false;
                                ...
                                if (z9) {
                                    ...
                                    o00O000 o00o007 = (o00O000) lazy3.getValue();
                                    o00o007.f57028OooO0O0 = 0L;
                                    o00o007.f57029OooO0OO = 0L;
                                    o0000o2.OooO0OO();
                                    i2 = 0;
                                    o0000o02.f56975OooO0oo = false;
                                } else {
                            ...
                            o0000o02 = this;
                            boolean z17 = o0000o02.f56985OooOOOo;
                            if (z2) {
                                z4 = false;
                            } else {
                                z4 = false;
                            ...
                            o0000o2.f57013OooO0o0 = i10;
                            it = o0000o2.f57010OooO0OO.iterator();
                            while (it.hasNext()) {
                                ((com.yy.yyeva.mix.OooO00o) it.next()).getClass();
                            }
                            o0000o02.onVideoRender(i10, m1Var2.f56965OooOo0o.f56939OooO0O0);
                            i4 = i10 + 1;
                            ...
                            if (i > 0) {
                                ...
                                mediaExtractor2.seekTo(0L, 2);
                                mediaCodec.flush();
                                o00O000 o00o008 = (o00O000) lazy3.getValue();
                                o00o008.f57028OooO0O0 = 0L;
                                o00o008.f57029OooO0OO = 0L;
                                onVideoRestart();
                                i4 = 0;
                                z10 = true;
                                z5 = false;
                            ...
                            if (z9) {
                                ...
                                o00O000 o00o009 = (o00O000) lazy3.getValue();
                                o00o009.f57028OooO0O0 = 0L;
                                o00o009.f57029OooO0OO = 0L;
                                o0000o2.OooO0OO();
                                i2 = 0;
                                o0000o02.f56975OooO0oo = false;
                            } else {
    ...
    public final void onFrameAvailable(@Nullable SurfaceTexture surfaceTexture) {
        ...
        Handler handler = this.f56973OooO0o0.f56994OooO0O0;
        if (handler != null) {
            handler.post(new OooO0O0(this, 1));
        }
    }
}
