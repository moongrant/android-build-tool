...
public final class o0O000O {
    ...
    public static final InetAddress OooO00o(int i, int i2, String str) {
        ...
        while (true) {
            ...
            if (i14 <= i2 && StringsKt__StringsJVMKt.startsWith$default(str, "::", i11, false, 4, null)) {
                ...
                i6 = 0;
                while (i11 < i2) {
                    iOooOOo = o0O000o0.OooOOo(str.charAt(i11));
                    if (iOooOOo == -1) {
                        break;
                        break;
                    }
    ...
    public static final String OooO0O0(@NotNull String str) {
        ...
        int i = 0;
        int i2 = -1;
        if (!StringsKt.OooO0o(str, CertificateUtil.DELIMITER)) {
            try {
        ...
        InetAddress inetAddressOooO00o = (StringsKt.Oooo00o(str, "[") && StringsKt.OooOO0O(str, "]")) ? OooO00o(1, str.length() - 1, str) : OooO00o(0, str.length(), str);
        ...
        while (i < address.length) {
            if (i == i2) {
                ...
                o00000o.o00ooo(((b & UByte.MAX_VALUE) << 8) | (address[i + 1] & UByte.MAX_VALUE));
                i += 2;
            }
        }
