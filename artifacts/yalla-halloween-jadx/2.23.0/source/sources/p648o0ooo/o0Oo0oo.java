...
public final class o0Oo0oo extends Lambda implements Function3<Integer, Integer, Intent, Unit> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ oo000o f59780OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0Oo0oo(oo000o oo000oVar) {
        super(3);
        this.f59780OooO0Oo = oo000oVar;
    }
    ...
    public final Unit invoke(Integer num, Integer num2, Intent intent) {
        ...
        if (iIntValue == this.f59780OooO0Oo.f59786OooO0OO) {
            boolean z = true;
            if (iIntValue2 == -1) {
                ...
                OooOOO0.OooO0O0("Share Instagram onCancel");
            }
        }
