...
import p649o0ooo0.o00O0O0;
import p649o0ooo0.o00O0O0O;
import p655o0ooo0o0.o0000O;
import p655o0ooo0o0.o0000O0;
import p655o0ooo0o0.o0000O0O;
import p655o0ooo0o0.o0000oo;
...
public class o000O0O0 {
    ...
    @NotNull
    public static volatile o000O0O0 f60031OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final Logger f60032OooO0O0;
    ...
    /* JADX WARN: Code duplicated, block: B:26:0x0076 A[PHI: r1
      0x0076: PHI (r1v3 o0ooo00o.o000O0O0) = (r1v1 o0ooo00o.o000O0O0), (r1v4 o0ooo00o.o000O0O0) binds: [B:66:0x016b, B:25:0x0073] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    static {
        ...
        String jvmVersion;
        new OooO00o();
        o000O0O0 o000o0 = null;
        if (OooO00o.OooO0OO()) {
            for (Map.Entry<String, String> entry : o00O0O0.f59811OooO0O0.entrySet()) {
                String key = entry.getKey();
                String value = entry.getValue();
                Logger logger = Logger.getLogger(key);
                if (o00O0O0.f59810OooO00o.add(logger)) {
                    logger.setUseParentHandlers(false);
                    logger.setLevel(Log.isLoggable(value, 3) ? Level.FINE : Log.isLoggable(value, 4) ? Level.INFO : Level.WARNING);
                    logger.addHandler(o00O0O0O.f59814OooO00o);
                }
            }
            o000o0o1 = o000O0o.f60034OooO0Oo ? new o000O0o() : null;
            if (o000o0o1 == null) {
                o000o0 = o000Oo0.f60038OooO0o0 ? new o000Oo0() : null;
                Intrinsics.checkNotNull(o000o0);
                o000o0o1 = o000o0;
            }
        } else if (Intrinsics.areEqual("Conscrypt", Security.getProviders()[0].getName())) {
            o000o0o1 = o000O00O.f60028OooO0Oo ? new o000O00O() : null;
            if (o000o0o1 == null) {
                if (!Intrinsics.areEqual("BC", Security.getProviders()[0].getName())) {
                    if (o000O00.f60026OooO0Oo) {
                        o000o0o1 = new o000O00();
                    } else {
                        o000o0o1 = null;
                    }
                    if (o000o0o1 == null) {
                        if (Intrinsics.areEqual("OpenJSSE", Security.getProviders()[0].getName())) {
                            if (o000OO0O.f60036OooO0Oo) {
                                o000o0o1 = new o000OO0O();
                            } else {
                                o000o0o1 = null;
                            }
                            if (o000o0o1 == null) {
                                if (o000O0Oo.f60033OooO0OO) {
                                    o000o0o1 = new o000O0Oo();
                                } else {
                                    o000o0o1 = null;
                                }
                                if (o000o0o1 == null) {
                                    ...
                                    if (Integer.parseInt(jvmVersion) < 9) {
                                        ...
                                        o000o0 = new o000O0(putMethod, getMethod, removeMethod, clientProviderClass, serverProviderClass);
                                    }
                                    if (o000o0 != null) {
                                        o000o0o1 = o000o0;
                                    } else {
                            ...
                            if (o000o0o1 == null) {
                                ...
                                if (Integer.parseInt(jvmVersion) < 9) {
                                    ...
                                    o000o0 = new o000O0(putMethod2, getMethod2, removeMethod2, clientProviderClass2, serverProviderClass2);
                                }
                                if (o000o0 != null) {
                                    o000o0o1 = o000o0;
                                } else {
                    ...
                    if (o000o0o1 == null) {
                        ...
                        if (Integer.parseInt(jvmVersion) < 9) {
                            ...
                            o000o0 = new o000O0(putMethod3, getMethod3, removeMethod3, clientProviderClass3, serverProviderClass3);
                        }
                        if (o000o0 != null) {
                            o000o0o1 = o000o0;
                        } else {
                    ...
                    if (o000o0o1 == null) {
                        ...
                        if (o000o0o1 == null) {
                            ...
                            if (Integer.parseInt(jvmVersion) < 9) {
                                ...
                                o000o0 = new o000O0(putMethod4, getMethod4, removeMethod4, clientProviderClass4, serverProviderClass4);
                            }
                            if (o000o0 != null) {
                                o000o0o1 = o000o0;
                            } else {
                ...
                if (Intrinsics.areEqual("OpenJSSE", Security.getProviders()[0].getName())) {
                    ...
                    if (o000o0o1 == null) {
                        ...
                        if (Integer.parseInt(jvmVersion) < 9) {
                            ...
                            o000o0 = new o000O0(putMethod5, getMethod5, removeMethod5, clientProviderClass5, serverProviderClass5);
                        }
                        if (o000o0 != null) {
                            o000o0o1 = o000o0;
                        } else {
                    ...
                    if (o000o0o1 == null) {
                        ...
                        if (o000o0o1 == null) {
                            ...
                            if (Integer.parseInt(jvmVersion) < 9) {
                                ...
                                o000o0 = new o000O0(putMethod6, getMethod6, removeMethod6, clientProviderClass6, serverProviderClass6);
                            }
                            if (o000o0 != null) {
                                o000o0o1 = o000o0;
                            } else {
                ...
                try {
                    ...
                    if (Integer.parseInt(jvmVersion) < 9) {
                        try {
                            ...
                            o000o0 = new o000O0(putMethod7, getMethod7, removeMethod7, clientProviderClass7, serverProviderClass7);
            ...
            if (o000o0o1 == null) {
                ...
                if (o000o0o1 == null) {
                    ...
                    if (Integer.parseInt(jvmVersion) < 9) {
                        ...
                        o000o0 = new o000O0(putMethod8, getMethod8, removeMethod8, clientProviderClass8, serverProviderClass8);
                    }
                    if (o000o0 != null) {
                        o000o0o1 = o000o0;
                    } else {
        ...
        f60031OooO00o = o000o0o1;
        f60032OooO0O0 = Logger.getLogger(o00OOOO0.class.getName());
    }

    public static void OooO(@Nullable Throwable th, int i, @NotNull String message) {
        Intrinsics.checkNotNullParameter(message, "message");
        f60032OooO0O0.log(i == 5 ? Level.WARNING : Level.INFO, message, th);
    }

    public static /* synthetic */ void OooOO0(o000O0O0 o000o0o1, String str, int i, int i2) {
        if ((i2 & 2) != 0) {
            i = 4;
        }
        o000o0o1.getClass();
    ...
    public Object OooO0oO() {
        ...
        if (f60032OooO0O0.isLoggable(Level.FINE)) {
