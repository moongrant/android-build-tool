...
public final class o0000oo extends o0000O0O {
    ...
    @NotNull
    public final o0000O f60126OooO00o;

    public o0000oo(@NotNull o0000O trustRootIndex) {
        Intrinsics.checkNotNullParameter(trustRootIndex, "trustRootIndex");
        this.f60126OooO00o = trustRootIndex;
    }
    ...
    public final List OooO00o(@NotNull String hostname, @NotNull List chain) throws SSLPeerUnverifiedException {
        ...
        while (i < 9) {
            i++;
            X509Certificate x509Certificate2 = (X509Certificate) OooOOO.OooO0O0(arrayList, 1);
            X509Certificate x509CertificateOooO00o = this.f60126OooO00o.OooO00o(x509Certificate2);
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        return (obj instanceof o0000oo) && Intrinsics.areEqual(((o0000oo) obj).f60126OooO00o, this.f60126OooO00o);
    }

    public final int hashCode() {
        return this.f60126OooO00o.hashCode();
    }
}
