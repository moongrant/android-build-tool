...
public final class o000O0O0 extends AbstractList<ByteString> implements RandomAccess {

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public static final /* synthetic */ int f60213OooO0o = 0;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public final ByteString[] f60214OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @NotNull
    public final int[] f60215OooO0o0;

    public static final class OooO00o {
        public static void OooO00o(long j, o00000O o00000o, int i, List list, int i2, int i3, List list2) throws IOException {
            int i4;
            int i5;
            int i6;
            int i7;
            ...
            if (byteString.OooOO0(i8) == byteString2.OooOO0(i8)) {
                ...
                long j2 = 4;
                long j3 = (o00000o.f60177OooO0o0 / j2) + j + ((long) 2) + ((long) i12) + 1;
                o00000o.o0ooOOo(-i12);
                o00000o.o0ooOOo(i5);
                int i14 = i8 + i12;
                while (i8 < i14) {
                    o00000o.o0ooOOo(byteString.OooOO0(i8) & 255);
                    i8++;
                }
                if (i4 + 1 == i3) {
                    ...
                    o00000o.o0ooOOo(((Number) list2.get(i4)).intValue());
                    return;
                } else {
                    o00000O o00000o2 = new o00000O();
                    o00000o.o0ooOOo(((int) ((o00000o2.f60177OooO0o0 / j2) + j3)) * (-1));
                    OooO00o(j3, o00000o2, i14, list, i4, i3, list2);
                    o00000o.Oooo000(o00000o2);
                    return;
                }
            }
            int i15 = 1;
            ...
            long j4 = 4;
            long j5 = ((long) (i15 * 2)) + (o00000o.f60177OooO0o0 / j4) + j + ((long) 2);
            o00000o.o0ooOOo(i15);
            o00000o.o0ooOOo(i5);
            ...
            while (i4 < i3) {
                ...
                if (i18 == i6 && i8 + 1 == ((ByteString) list.get(i4)).OooO0o0()) {
                    ...
                    o00000o.o0ooOOo(((int) ((o00000o3.f60177OooO0o0 / j4) + j5)) * i10);
                    i7 = i6;
                    OooO00o(j5, o00000o3, i8 + 1, list, i4, i7, list2);
                }
                o00000o3 = o00000o3;
                i4 = i7;
                j4 = j4;
            ...
            o00000o.Oooo000(o00000o3);
        }

        @JvmStatic
        @NotNull
        public static o000O0O0 OooO0O0(@NotNull ByteString... byteStrings) throws IOException {
            Intrinsics.checkNotNullParameter(byteStrings, "byteStrings");
            int i = 0;
            if (byteStrings.length == 0) {
                return new o000O0O0(new ByteString[0], new int[]{0, -1});
            }
            ...
            for (int iOooO00o = 0; iOooO00o < length; iOooO00o = o0O0O00.OooO00o(-1, arrayList, iOooO00o, 1)) {
            ...
            OooO00o(0L, o00000o, 0, mutableList, 0, mutableList.size(), listMutableListOf);
            int[] iArr = new int[(int) (o00000o.f60177OooO0o0 / ((long) 4))];
            while (!o00000o.oo000o()) {
                iArr[i] = o00000o.readInt();
                i++;
            }
            ...
            return new o000O0O0((ByteString[]) objArrCopyOf, iArr);
        }
    }

    public o000O0O0(ByteString[] byteStringArr, int[] iArr) {
        this.f60214OooO0Oo = byteStringArr;
        this.f60215OooO0o0 = iArr;
    }
    ...
    public final Object get(int i) {
        return this.f60214OooO0Oo[i];
    }

    @Override // kotlin.collections.AbstractList, kotlin.collections.AbstractCollection
    /* JADX INFO: renamed from: getSize */
    public final int get_size() {
        return this.f60214OooO0Oo.length;
    }
