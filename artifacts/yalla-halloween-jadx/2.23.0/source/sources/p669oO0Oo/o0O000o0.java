...
public final class o0O000o0 extends Lambda implements Function3<BoxScope, Composer, Integer, Unit> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ boolean f60600OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0O000o0(boolean z) {
        super(3);
        this.f60600OooO0Oo = z;
    }
    ...
    public final Unit invoke(BoxScope boxScope, Composer composer, Integer num) {
        ...
        if ((iIntValue & 81) == 16 && composer2.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1688051862, iIntValue, -1, "com.yalla.yalla.ui.dialog.room.LiveRoomMemberUserRankDialog.onDialog.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous> (LiveRoomMemberUserRankDialog.kt:201)");
            }
            ...
            o0O00o0.f60622OooO00o.OooO00o(this.f60600OooO0Oo, composer2, 48);
            o0000Ooo.OooO00o(StringResources_androidKt.stringResource(oO00OOo0.live_room_member_rank_no_member, composer2, 0), 0, 0.0f, null, null, false, null, null, null, composer2, 0, 510);
