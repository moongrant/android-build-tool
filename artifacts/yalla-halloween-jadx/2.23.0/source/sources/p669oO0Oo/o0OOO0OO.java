...
public final class o0OOO0OO {
    ...
    @NotNull
    public static final o0OOO0OO f60716OooO00o = new o0OOO0OO();

    public static final class OooO extends Lambda implements Function2<Composer, Integer, Unit> {

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f60718OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(int i) {
            super(2);
            this.f60718OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f60718OooO0o0 | 1);
            o0OOO0OO.this.OooO00o(composer, iUpdateChangedFlags);
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final /* synthetic */ MutableState<String> f60719OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(MutableState<String> mutableState, Continuation<? super OooO00o> continuation) {
            super(2, continuation);
            this.f60719OooO0Oo = mutableState;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO00o(this.f60719OooO0Oo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (Intrinsics.areEqual(com.yalla.yalla.service.room.OooO00o.OooO0OO(), com.yalla.yalla.service.room.OooO0OO.AbstractC0318OooO0OO.OooO00o.f25053OooO00o)) {
                this.f60719OooO0Oo.setValue("");
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0O0 extends Lambda implements Function3<ColumnScope, Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MutableState<String> f60720OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f60721OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f60722OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(MutableState<String> mutableState, MutableState<Boolean> mutableState2, MutableState<Boolean> mutableState3) {
            super(3);
            this.f60720OooO0Oo = mutableState;
            this.f60722OooO0o0 = mutableState2;
            this.f60721OooO0o = mutableState3;
        }
        ...
        public final Unit invoke(ColumnScope columnScope, Composer composer, Integer num) {
            ...
            if ((((iIntValue & 14) == 0 ? (composer3.changed(TextDialog) ? 4 : 2) | iIntValue : iIntValue) & 91) == 18 && composer3.getSkipping()) {
                composer3.skipToGroupEnd();
            } else {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-202826242, iIntValue, -1, "com.yalla.yalla.ui.dialog.room.RoomLiveEnterPasswordDialog.OnDialog.<anonymous> (RoomLiveEnterPasswordDialog.kt:90)");
                }
                Modifier.Companion companion = Modifier.INSTANCE;
                Alignment.Companion companion2 = Alignment.INSTANCE;
                Modifier modifierAlign = TextDialog.align(companion, companion2.getCenterHorizontally());
                composer3.startReplaceableGroup(733328855);
                MeasurePolicy measurePolicyOooO00o = OooOOO.OooO00o(companion2, false, composer3, 0, -1323940314);
                ...
                MutableState<String> mutableState = this.f60720OooO0Oo;
                ...
                if (zChanged || objRememberedValue2 == companion4.getEmpty()) {
                    objRememberedValue2 = new o0OOOO00(mutableState);
                ...
                KeyboardOptions keyboardOptions = new KeyboardOptions(0, false, KeyboardType.INSTANCE.m3517getNumberPasswordPjHm6EE(), ImeAction.INSTANCE.m3468getDoneeUduSuo(), 3, null);
                Modifier modifierAlpha = AlphaKt.alpha(FocusRequesterModifierKt.focusRequester(SizeKt.m528width3ABfNKs(companion, Dp.m3765constructorimpl(1)), focusRequester), 0.0f);
                composer3.startReplaceableGroup(511388516);
                boolean zChanged2 = composer3.changed(mutableState);
                MutableState<Boolean> mutableState2 = this.f60722OooO0o0;
                ...
                if (zChanged3 || objRememberedValue3 == companion4.getEmpty()) {
                    objRememberedValue3 = new o0OOOO0o(mutableState, mutableState2);
                ...
                if (zChanged4 || objRememberedValue4 == companion4.getEmpty()) {
                    objRememberedValue4 = new o0OOo000(focusRequester, current, null);
                ...
                if (zChanged5 || objRememberedValue5 == companion4.getEmpty()) {
                    objRememberedValue5 = new o0o0000(mutableState2, null);
                ...
                if (mutableState2.getValue().booleanValue()) {
                    ...
                    j = o000OOo.OooO0OO(composer3).f37708OooO0oO;
                } else {
                    composer3.startReplaceableGroup(-1186904597);
                    j = o000OOo.OooO0OO(composer3).f37706OooO0o;
                }
                composer3.endReplaceableGroup();
                float f = 45;
                Modifier modifierOooO00o = p153o00OoO0.OooOO0.OooO00o(f, BorderKt.m180borderxT4_qwU(companion, fM3765constructorimpl, j, RoundedCornerShapeKt.m727RoundedCornerShape0680j_4(Dp.m3765constructorimpl(4))), composer3, 1618982084);
                MutableState<Boolean> mutableState3 = this.f60721OooO0o;
                ...
                if (zChanged6 || objRememberedValue6 == companion4.getEmpty()) {
                    objRememberedValue6 = new oO0Oo(focusRequester, current, mutableState3);
                    composer3.updateRememberedValue(objRememberedValue6);
                }
                composer3.endReplaceableGroup();
                Modifier modifierOooO0O0 = o0O0O00.OooO0O0(modifierOooO00o, false, false, 0L, false, null, null, null, (Function0) objRememberedValue6, 253);
                composer3.startReplaceableGroup(693286680);
                int i = 0;
                MeasurePolicy measurePolicyOooO00o2 = androidx.compose.material.OooOOO.OooO00o(companion2, Arrangement.INSTANCE.getStart(), composer3, 0, -1323940314);
                ...
                for (int i3 = 4; i2 < i3; i3 = 4) {
                    int i4 = i2;
                    ImageKt.Image(PainterResources_androidKt.painterResource(oOo00OO0.icon_room_lock_password, composer3, i), (String) null, PaddingKt.m476padding3ABfNKs(AlphaKt.alpha(SizeKt.m523size3ABfNKs(Modifier.INSTANCE, Dp.m3765constructorimpl(f)), mutableState.getValue().length() > i2 ? 1.0f : 0.0f), Dp.m3765constructorimpl(18)), (Alignment) null, (ContentScale) null, 0.0f, (ColorFilter) null, composer3, 56, 120);
                    if (i4 < 3) {
                        if (mutableState2.getValue().booleanValue()) {
                            composer3.startReplaceableGroup(-1719983759);
                            j2 = o000OOo.OooO0OO(composer3).f37708OooO0oO;
                        } else {
                            composer3.startReplaceableGroup(-1719983739);
                            j2 = o000OOo.OooO0OO(composer3).f37706OooO0o;
                        }
                        composer3.endReplaceableGroup();
                        t0.OooO0O0(null, 0.0f, j2, composer3, 0, 3);
                    }
                    i2 = i4 + 1;
                    i = 0;
                }
                ...
                composer3.endReplaceableGroup();
                float f2 = 12;
                com.code.android.util.OooOO0.OooO0o(Dp.m3765constructorimpl(f2), null, composer3, 6, 2);
                ...
                if (mutableState2.getValue().booleanValue()) {
                    ...
                    composer3.startReplaceableGroup(693286680);
                    MeasurePolicy measurePolicyOooO00o3 = androidx.compose.material.OooO.OooO00o(Arrangement.INSTANCE, centerVertically, composer3, 48, -1323940314);
                    ...
                    Painter painterPainterResource = PainterResources_androidKt.painterResource(oOo00OO0.icon_error_red, composer3, 0);
                    long j3 = o0oO0O0o.f47046o000O00O;
                    IconKt.m1103Iconww6aTOc(painterPainterResource, (String) null, SizeKt.m523size3ABfNKs(companion6, Dp.m3765constructorimpl(f2)), j3, composer3, 440, 0);
                    com.code.android.util.OooOO0.OooO0Oo(Dp.m3765constructorimpl(6), null, composer3, 6, 2);
                    z = false;
                    modifier = null;
                    composer2 = composer3;
                    TextKt.m1251Text4IGK_g(StringResources_androidKt.stringResource(oO00OOo0.dialog_error_tips, composer3, 0), (Modifier) null, j3, TextUnitKt.getSp(12), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 3072, 0, 131058);
                ...
                com.code.android.util.OooOO0.OooO0o(Dp.m3765constructorimpl(f2), modifier, composer2, 6, r10);
                ArrayList arrayList2 = com.yalla.yalla.service.room.OooO00o.f24973OooO00o;
                boolean zAreEqual = Intrinsics.areEqual(com.yalla.yalla.service.room.OooO00o.OooO0OO(), com.yalla.yalla.service.room.OooO0OO.AbstractC0318OooO0OO.OooO0O0.f25054OooO00o);
                if (mutableState.getValue().length() >= 4) {
                    z = true;
                }
                boolean z2 = z;
                ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer2, -1206005227, true, new o0oo0000(zAreEqual));
                TextButtonStyle textButtonStyle = z2 ? TextButtonStyle.Green : TextButtonStyle.GreyDisable;
                float f3 = 36;
                Modifier modifierOooO00o2 = o0oOO.OooO00o(f3, SizeKt.m509height3ABfNKs(SizeKt.fillMaxWidth$default(Modifier.INSTANCE, 0.0f, 1, modifier), Dp.m3765constructorimpl(f3)), 0.0f, 2, modifier, composer2, 1157296644);
                boolean zChanged7 = composer2.changed(mutableState);
                Object objRememberedValue7 = composer2.rememberedValue();
                if (zChanged7 || objRememberedValue7 == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue7 = new ooo0Oo0(mutableState);
                    composer2.updateRememberedValue(objRememberedValue7);
                }
                composer2.endReplaceableGroup();
                o00000O0.OooO0O0(composableLambda, textButtonStyle, null, null, null, 0.0f, null, z2, false, 0L, false, null, null, null, null, modifierOooO00o2, (Function0) objRememberedValue7, composer2, 6, 196608, 32636);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public static final class OooO0OO extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO0OO f60723OooO0Oo = new OooO0OO();
    ...
    public static final class OooO0o extends Lambda implements Function3<ColumnScope, Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f60724OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(MutableState<Boolean> mutableState) {
            super(3);
            this.f60724OooO0Oo = mutableState;
        }
        ...
        public final Unit invoke(ColumnScope columnScope, Composer composer, Integer num) {
            ...
            if ((iIntValue & 81) == 16 && composer2.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(1745262394, iIntValue, -1, "com.yalla.yalla.ui.dialog.room.RoomLiveEnterPasswordDialog.OnDialog.<anonymous> (RoomLiveEnterPasswordDialog.kt:209)");
                }
                ...
                EffectsKt.LaunchedEffect(Long.valueOf(com.yalla.yalla.service.room.OooO00o.f24978OooO0o0.OooO0o0()), new o(roomFollowAndJoinCheckVM, lifecycleOwner, mutableState, null), composer2, 64);
                Modifier.Companion companion2 = Modifier.INSTANCE;
                float f = 16;
                Modifier modifierClip = ClipKt.clip(SizeKt.fillMaxWidth$default(companion2, 0.0f, 1, null), RoundedCornerShapeKt.m729RoundedCornerShapea9UjIt4$default(0.0f, 0.0f, Dp.m3765constructorimpl(f), Dp.m3765constructorimpl(f), 3, null));
                long j = o0oO0O0o.f47079o000o0O0;
                Modifier modifierM169backgroundbw27NRU$default = BackgroundKt.m169backgroundbw27NRU$default(modifierClip, j, null, 2, null);
                ...
                MutableState<Boolean> mutableState2 = this.f60724OooO0Oo;
                long j2 = o0OOO0OO.OooO0OO(mutableState2) ? j : o000OOo.OooO0OO(composer2).f37707OooO0o0;
                composer2.endReplaceableGroup();
                Modifier modifierM169backgroundbw27NRU$default2 = BackgroundKt.m169backgroundbw27NRU$default(modifierFillMaxWidth$default, j2, null, 2, null);
                composer2.startReplaceableGroup(733328855);
                MeasurePolicy measurePolicyOooO00o2 = OooOOO.OooO00o(companion3, false, composer2, 0, -1323940314);
                int currentCompositeKeyHash2 = ComposablesKt.getCurrentCompositeKeyHash(composer2, 0);
                CompositionLocalMap currentCompositionLocalMap2 = composer2.getCurrentCompositionLocalMap();
                Function0<ComposeUiNode> constructor2 = companion4.getConstructor();
                Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3ModifierMaterializerOf2 = LayoutKt.modifierMaterializerOf(modifierM169backgroundbw27NRU$default2);
                if (!(composer2.getApplier() instanceof Applier)) {
                    ComposablesKt.invalidApplier();
                }
                composer2.startReusableNode();
                ...
                if (o0OOO0OO.OooO0OO(mutableState2)) {
                    BoxKt.Box(ShadowKt.m1348shadows4CzXII$default(SizeKt.m509height3ABfNKs(SizeKt.fillMaxWidth$default(boxScopeInstance.align(PaddingKt.m480paddingqDBjuR0$default(companion2, 0.0f, Dp.m3765constructorimpl(8), 0.0f, 0.0f, 13, null), companion3.getBottomCenter()), 0.0f, 1, null), Dp.m3765constructorimpl(f)), Dp.m3765constructorimpl(2), RoundedCornerShapeKt.m729RoundedCornerShapea9UjIt4$default(0.0f, 0.0f, Dp.m3765constructorimpl(f), Dp.m3765constructorimpl(f), 3, null), true, 0L, 0L, 24, null), composer2, 0);
                    BoxKt.Box(BackgroundKt.m168backgroundbw27NRU(boxScopeInstance.matchParentSize(companion2), o000OOo.OooO0OO(composer2).f37707OooO0o0, RoundedCornerShapeKt.m729RoundedCornerShapea9UjIt4$default(0.0f, 0.0f, Dp.m3765constructorimpl(f), Dp.m3765constructorimpl(f), 3, null)), composer2, 0);
                }
                composer2.endReplaceableGroup();
                ...
                if (zChanged || objRememberedValue2 == companion.getEmpty()) {
                    objRememberedValue2 = new oO00000(current2, mutableState2);
                    composer2.updateRememberedValue(objRememberedValue2);
                }
                composer2.endReplaceableGroup();
                Modifier modifierM480paddingqDBjuR0$default = PaddingKt.m480paddingqDBjuR0$default(o0O0O00.OooO0O0(modifierAlign, false, false, 0L, false, null, null, null, (Function0) objRememberedValue2, 253), 0.0f, 0.0f, 0.0f, Dp.m3765constructorimpl(15), 7, null);
                ...
                RowScopeInstance rowScopeInstance = RowScopeInstance.INSTANCE;
                TextKt.m1251Text4IGK_g(StringResources_androidKt.stringResource(oO00OOo0.password_dialog_more_features, composer2, 0), (Modifier) null, o000OOo.OooO0OO(composer2).f37711OooOO0O, TextUnitKt.getSp(14), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 3072, 0, 131058);
                com.code.android.util.OooOO0.OooO0Oo(Dp.m3765constructorimpl(3), null, composer2, 6, 2);
                IconKt.m1103Iconww6aTOc(PainterResources_androidKt.painterResource(oOo00OO0.icon_password_dialog_bottom, composer2, 0), (String) null, (Modifier) null, o000OOo.OooO0OO(composer2).f37711OooOO0O, composer2, 56, 4);
                composer2.endReplaceableGroup();
                composer2.endNode();
                composer2.endReplaceableGroup();
                composer2.endReplaceableGroup();
                ...
                if (o0OOO0OO.OooO0OO(mutableState2)) {
                    State stateObserveAsState = LiveDataAdapterKt.observeAsState(com.yalla.yalla.service.room.OooO0O0.f24995OoooOOO.OooO00o().f25007OooOO0O, Boolean.FALSE, composer2, 56);
                    boolean zBooleanValue = ((Boolean) mutableState.getValue()).booleanValue();
                    o0OOO0OO o0ooo0oo2 = o0OOO0OO.f60716OooO00o;
                    if (zBooleanValue) {
                        composer2.startReplaceableGroup(-1186897071);
                        o0OOO0OO.OooO0o0(o0ooo0oo2, roomFollowAndJoinCheckVM, lifecycleOwner, composer2, 448);
                        t0.OooO00o(null, 0.0f, 0L, composer2, 0, 7);
                        o0OOO0OO.OooO0Oo(o0ooo0oo2, roomFollowAndJoinCheckVM, lifecycleOwner, composer2, 448);
                        composer2.endReplaceableGroup();
                    } else if (!((Boolean) mutableState.getValue()).booleanValue()) {
                        Boolean isFollowRoom = (Boolean) stateObserveAsState.getValue();
                        Intrinsics.checkNotNullExpressionValue(isFollowRoom, "isFollowRoom");
                        if (isFollowRoom.booleanValue()) {
                            composer2.startReplaceableGroup(-1186896787);
                            o0OOO0OO.OooO0o(o0ooo0oo2, roomFollowAndJoinCheckVM, lifecycleOwner, composer2, 448);
                            composer2.endReplaceableGroup();
    ...
    public static final void OooO0O0(o0OOO0OO o0ooo0oo2, RoomFollowAndJoinCheckVM roomFollowAndJoinCheckVM, LifecycleOwner lifecycleOwner, Composer composer, int i) {
        o0ooo0oo2.getClass();
        ...
        Modifier modifierOooO0O0 = o0O0O00.OooO0O0(SizeKt.m509height3ABfNKs(SizeKt.fillMaxWidth$default(Modifier.INSTANCE, 0.0f, 1, null), Dp.m3765constructorimpl(50)), false, false, 0L, false, null, null, null, new o0OOO00(roomFollowAndJoinCheckVM, lifecycleOwner), 253);
        ...
        BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
        TextKt.m1251Text4IGK_g(StringResources_androidKt.stringResource(oO00OOo0.password_dialog_Follow_room, composerStartRestartGroup, 0), (Modifier) null, o000OOo.OooO0OO(composerStartRestartGroup).f37701OooO, TextUnitKt.getSp(16), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composerStartRestartGroup, 3072, 0, 131058);
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new o0OOO0(o0ooo0oo2, roomFollowAndJoinCheckVM, lifecycleOwner, i));
    }
    ...
    public static final void OooO0Oo(o0OOO0OO o0ooo0oo2, RoomFollowAndJoinCheckVM roomFollowAndJoinCheckVM, LifecycleOwner lifecycleOwner, Composer composer, int i) {
        o0ooo0oo2.getClass();
        ...
        Alignment center = Alignment.INSTANCE.getCenter();
        Modifier modifierOooO0O0 = o0O0O00.OooO0O0(SizeKt.m509height3ABfNKs(SizeKt.fillMaxWidth$default(Modifier.INSTANCE, 0.0f, 1, null), Dp.m3765constructorimpl(50)), false, false, 0L, false, null, null, null, new oO0000O(roomFollowAndJoinCheckVM, lifecycleOwner), 253);
        composerStartRestartGroup.startReplaceableGroup(733328855);
        MeasurePolicy measurePolicyRememberBoxMeasurePolicy = BoxKt.rememberBoxMeasurePolicy(center, false, composerStartRestartGroup, 6);
        composerStartRestartGroup.startReplaceableGroup(-1323940314);
        int currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
        ...
        OooOO0.OooO00o(0, function3ModifierMaterializerOf, SkippableUpdater.m1300boximpl(SkippableUpdater.m1301constructorimpl(composerStartRestartGroup)), composerStartRestartGroup, 2058660585);
        BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
        TextKt.m1251Text4IGK_g(StringResources_androidKt.stringResource(oO00OOo0.password_dialog_UnJoin_unFollow, composerStartRestartGroup, 0), (Modifier) null, o000OOo.OooO0OO(composerStartRestartGroup).f37701OooO, TextUnitKt.getSp(16), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composerStartRestartGroup, 3072, 0, 131058);
        if (androidx.compose.material.OooOO0.OooO0O0(composerStartRestartGroup)) {
            ComposerKt.traceEventEnd();
        }
        ScopeUpdateScope scopeUpdateScopeEndRestartGroup = composerStartRestartGroup.endRestartGroup();
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new oO0000Oo(o0ooo0oo2, roomFollowAndJoinCheckVM, lifecycleOwner, i));
    }

    public static final void OooO0o(o0OOO0OO o0ooo0oo2, RoomFollowAndJoinCheckVM roomFollowAndJoinCheckVM, LifecycleOwner lifecycleOwner, Composer composer, int i) {
        o0ooo0oo2.getClass();
        ...
        Alignment center = Alignment.INSTANCE.getCenter();
        Modifier modifierOooO0O0 = o0O0O00.OooO0O0(SizeKt.m509height3ABfNKs(SizeKt.fillMaxWidth$default(Modifier.INSTANCE, 0.0f, 1, null), Dp.m3765constructorimpl(50)), false, false, 0L, false, null, null, null, new oO0Ooooo(roomFollowAndJoinCheckVM, lifecycleOwner), 253);
        composerStartRestartGroup.startReplaceableGroup(733328855);
        MeasurePolicy measurePolicyRememberBoxMeasurePolicy = BoxKt.rememberBoxMeasurePolicy(center, false, composerStartRestartGroup, 6);
        composerStartRestartGroup.startReplaceableGroup(-1323940314);
        int currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
        ...
        OooOO0.OooO00o(0, function3ModifierMaterializerOf, SkippableUpdater.m1300boximpl(SkippableUpdater.m1301constructorimpl(composerStartRestartGroup)), composerStartRestartGroup, 2058660585);
        BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
        TextKt.m1251Text4IGK_g(StringResources_androidKt.stringResource(oO00OOo0.password_dialog_unFollow_Room, composerStartRestartGroup, 0), (Modifier) null, o000OOo.OooO0OO(composerStartRestartGroup).f37701OooO, TextUnitKt.getSp(16), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composerStartRestartGroup, 3072, 0, 131058);
        if (androidx.compose.material.OooOO0.OooO0O0(composerStartRestartGroup)) {
            ComposerKt.traceEventEnd();
        }
        ScopeUpdateScope scopeUpdateScopeEndRestartGroup = composerStartRestartGroup.endRestartGroup();
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new oO0o0o(o0ooo0oo2, roomFollowAndJoinCheckVM, lifecycleOwner, i));
    }
    ...
    public static final void OooO0o0(o0OOO0OO o0ooo0oo2, RoomFollowAndJoinCheckVM roomFollowAndJoinCheckVM, LifecycleOwner lifecycleOwner, Composer composer, int i) {
        ...
        Alignment center = Alignment.INSTANCE.getCenter();
        Modifier modifierOooO0O0 = o0O0O00.OooO0O0(SizeKt.m509height3ABfNKs(SizeKt.fillMaxWidth$default(Modifier.INSTANCE, 0.0f, 1, null), Dp.m3765constructorimpl(50)), false, false, 0L, false, null, null, null, new oO000(roomFollowAndJoinCheckVM, lifecycleOwner), 253);
        composerStartRestartGroup.startReplaceableGroup(733328855);
        MeasurePolicy measurePolicyRememberBoxMeasurePolicy = BoxKt.rememberBoxMeasurePolicy(center, false, composerStartRestartGroup, 6);
        composerStartRestartGroup.startReplaceableGroup(-1323940314);
        int currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
        ...
        OooOO0.OooO00o(0, function3ModifierMaterializerOf, SkippableUpdater.m1300boximpl(SkippableUpdater.m1301constructorimpl(composerStartRestartGroup)), composerStartRestartGroup, 2058660585);
        BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
        TextKt.m1251Text4IGK_g(StringResources_androidKt.stringResource(oO00OOo0.password_dialog_unJoin_room, composerStartRestartGroup, 0), (Modifier) null, o000OOo.OooO0OO(composerStartRestartGroup).f37701OooO, TextUnitKt.getSp(16), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composerStartRestartGroup, 3072, 0, 131058);
        if (androidx.compose.material.OooOO0.OooO0O0(composerStartRestartGroup)) {
            ComposerKt.traceEventEnd();
        }
        ScopeUpdateScope scopeUpdateScopeEndRestartGroup = composerStartRestartGroup.endRestartGroup();
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new oO000O0(o0ooo0oo2, roomFollowAndJoinCheckVM, lifecycleOwner, i));
    }
    ...
    public final void OooO00o(@Nullable Composer composer, int i) {
        ...
        if ((i & 1) == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            composerStartRestartGroup.endReplaceableGroup();
            composer2 = composerStartRestartGroup;
            oo000o.OooO0Oo(mutableState, StringResources_androidKt.stringResource(oO00OOo0.dialog_lock_tips, composerStartRestartGroup, 0), null, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -202826242, true, new OooO0O0(mutableState2, (MutableState) objRememberedValue5, mutableState3)), true, false, OooO0OO.f60723OooO0Oo, null, null, false, null, false, null, null, false, false, null, null, ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1745262394, true, new OooO0o(mutableState3)), null, composer2, 1797126, 100663296, 786308);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
