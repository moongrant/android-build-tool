...
public final class o0o0000 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ MutableState<Boolean> f60747OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0o0000(MutableState<Boolean> mutableState, Continuation<? super o0o0000> continuation) {
        super(2, continuation);
        this.f60747OooO0Oo = mutableState;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o0o0000(this.f60747OooO0Oo, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (Intrinsics.areEqual(OooO00o.OooO0OO(), OooO0OO.AbstractC0318OooO0OO.OooO00o.f25053OooO00o) && ((Number) OooO00o.f24978OooO0o0.f47492OooO0oO.getValue()).intValue() > 0) {
            this.f60747OooO0Oo.setValue(Boolean.TRUE);
        }
