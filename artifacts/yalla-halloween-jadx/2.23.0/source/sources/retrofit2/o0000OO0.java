...
public final class o0000OO0 {
    ...
    public static final Type[] f61111OooO00o = new Type[0];

    public static final class OooO00o implements GenericArrayType {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final Type f61112OooO0Oo;

        public OooO00o(Type type) {
            this.f61112OooO0Oo = type;
        }

        public final boolean equals(Object obj) {
            return (obj instanceof GenericArrayType) && o0000OO0.OooO0OO(this, (GenericArrayType) obj);
        }

        @Override // java.lang.reflect.GenericArrayType
        public final Type getGenericComponentType() {
            return this.f61112OooO0Oo;
        }

        public final int hashCode() {
            return this.f61112OooO0Oo.hashCode();
        }

        public final String toString() {
            return o0000OO0.OooOOOO(this.f61112OooO0Oo) + "[]";
        }
    }
    ...
    public static final class OooO0O0 implements ParameterizedType {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        @Nullable
        public final Type f61113OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final Type[] f61114OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final Type f61115OooO0o0;
        ...
        public OooO0O0(@Nullable Type type, Type type2, Type... typeArr) {
            ...
            for (Type type3 : typeArr) {
                ...
                o0000OO0.OooO0O0(type3);
            }
            this.f61113OooO0Oo = type;
            this.f61115OooO0o0 = type2;
            this.f61114OooO0o = (Type[]) typeArr.clone();
        }

        public final boolean equals(Object obj) {
            return (obj instanceof ParameterizedType) && o0000OO0.OooO0OO(this, (ParameterizedType) obj);
        }

        @Override // java.lang.reflect.ParameterizedType
        public final Type[] getActualTypeArguments() {
            return (Type[]) this.f61114OooO0o.clone();
        }

        @Override // java.lang.reflect.ParameterizedType
        @Nullable
        public final Type getOwnerType() {
            return this.f61113OooO0Oo;
        }

        @Override // java.lang.reflect.ParameterizedType
        public final Type getRawType() {
            return this.f61115OooO0o0;
        }

        public final int hashCode() {
            int iHashCode = Arrays.hashCode(this.f61114OooO0o) ^ this.f61115OooO0o0.hashCode();
            Type type = this.f61113OooO0Oo;
            return iHashCode ^ (type != null ? type.hashCode() : 0);
        }

        public final String toString() {
            Type[] typeArr = this.f61114OooO0o;
            int length = typeArr.length;
            Type type = this.f61115OooO0o0;
            if (length == 0) {
                return o0000OO0.OooOOOO(type);
            }
            StringBuilder sb = new StringBuilder((typeArr.length + 1) * 30);
            sb.append(o0000OO0.OooOOOO(type));
            sb.append("<");
            sb.append(o0000OO0.OooOOOO(typeArr[0]));
            for (int i = 1; i < typeArr.length; i++) {
                sb.append(", ");
                sb.append(o0000OO0.OooOOOO(typeArr[i]));
            }
            sb.append(">");
            return sb.toString();
        }
    ...
    public static final class OooO0OO implements WildcardType {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final Type f61116OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        @Nullable
        public final Type f61117OooO0o0;
        ...
        public OooO0OO(Type[] typeArr, Type[] typeArr2) {
            ...
            if (typeArr2.length != 1) {
                Type type = typeArr[0];
                type.getClass();
                o0000OO0.OooO0O0(type);
                this.f61117OooO0o0 = null;
                this.f61116OooO0Oo = typeArr[0];
                return;
            }
            Type type2 = typeArr2[0];
            type2.getClass();
            o0000OO0.OooO0O0(type2);
            if (typeArr[0] != Object.class) {
                throw new IllegalArgumentException();
            }
            this.f61117OooO0o0 = typeArr2[0];
            this.f61116OooO0Oo = Object.class;
        }

        public final boolean equals(Object obj) {
            return (obj instanceof WildcardType) && o0000OO0.OooO0OO(this, (WildcardType) obj);
        }

        @Override // java.lang.reflect.WildcardType
        public final Type[] getLowerBounds() {
            Type type = this.f61117OooO0o0;
            return type != null ? new Type[]{type} : o0000OO0.f61111OooO00o;
        }

        @Override // java.lang.reflect.WildcardType
        public final Type[] getUpperBounds() {
            return new Type[]{this.f61116OooO0Oo};
        }

        public final int hashCode() {
            Type type = this.f61117OooO0o0;
            return (type != null ? type.hashCode() + 31 : 1) ^ (this.f61116OooO0Oo.hashCode() + 31);
        }

        public final String toString() {
            Type type = this.f61117OooO0o0;
            if (type != null) {
                return "? super " + o0000OO0.OooOOOO(type);
            }
            Type type2 = this.f61116OooO0Oo;
            if (type2 == Object.class) {
                return "?";
            }
            return "? extends " + o0000OO0.OooOOOO(type2);
        }
    }
    ...
    public static o0 OooO00o(o0O0o o0o0o) throws IOException {
        p659o0oooO00.o00000O content = new p659o0oooO00.o00000O();
        o0o0o.OooOOo0().o00oO0O(content);
        o00OOO0 o00ooo0OooO0oO = o0o0o.OooO0oO();
        long jOooO0OO = o0o0o.OooO0OO();
        Intrinsics.checkNotNullParameter(content, "content");
        Intrinsics.checkNotNullParameter(content, "<this>");
        return new o0(o00ooo0OooO0oO, jOooO0OO, content);
    }
    ...
    public static Type OooO0o0(int i, ParameterizedType parameterizedType) {
        ...
        StringBuilder sbOooO00o = androidx.appcompat.widget.o0000O0.OooO00o("Index ", i, " not in range [0,");
    ...
    public static IllegalArgumentException OooOO0(Method method, @Nullable Exception exc, String str, Object... objArr) {
        StringBuilder sbOooO0O0 = o000Oo0.OooO0O0(String.format(str, objArr), "\n    for method ");
    ...
    public static IllegalArgumentException OooOO0O(Method method, int i, String str, Object... objArr) {
        StringBuilder sbOooO0O0 = o000Oo0.OooO0O0(str, " (parameter #");
            ...
            if (!(type5 instanceof TypeVariable)) {
                ...
                if (type5 instanceof WildcardType) {
                    ...
                    if (lowerBounds.length == 1) {
                        ...
                        type3 = wildcardType;
                        type3 = wildcardType;
                        return new OooO0OO(new Type[]{typeOooOOO0}, f61111OooO00o);
                    }
                }
                type3 = type5;
                type3 = wildcardType;
