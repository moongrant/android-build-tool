...
public final class RoomThemeCustomCreateVM extends o0O0O00 {
    ...
    public static final class OooO extends SuspendLambda implements Function2<LiveDataScope<p136o00OOOo0.OooO0OO>, Continuation<? super Unit>, Object> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f32604OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f32606OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ File f32607OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(File file, Continuation<? super OooO> continuation) {
            super(2, continuation);
            this.f32607OooO0oO = file;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO oooO = RoomThemeCustomCreateVM.this.new OooO(this.f32607OooO0oO, continuation);
            oooO.f32606OooO0o0 = obj;
            return oooO;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            this.f32606OooO0o0 = liveDataScope;
            this.f32604OooO0Oo = 1;
            obj = CloudFileRepo.OooO0o0(cloudFileRepo, cloudFileType, this.f32607OooO0oO, this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            roomThemeCustomCreateVM.getShowLoadingDialog().setValue(Boxing.boxBoolean(false));
            this.f32606OooO0o0 = null;
            this.f32604OooO0Oo = 2;
            if (liveDataScope.emit((p136o00OOOo0.OooO0OO) obj, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
        }
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f32608OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                r rVar = r.f45104OooO00o;
                this.f32608OooO0Oo = 1;
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<LiveDataScope<ApiResult<RenewCustomizeTheme>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f32610OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ String f32611OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f32612OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f32613OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ RoomThemeCustomCreateVM f32614OooO0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(String str, int i, RoomThemeCustomCreateVM roomThemeCustomCreateVM, Continuation<? super OooO0OO> continuation) {
            super(2, continuation);
            this.f32611OooO0o = str;
            this.f32613OooO0oO = i;
            this.f32614OooO0oo = roomThemeCustomCreateVM;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0OO oooO0OO = new OooO0OO(this.f32611OooO0o, this.f32613OooO0oO, this.f32614OooO0oo, continuation);
            oooO0OO.f32612OooO0o0 = obj;
            return oooO0OO;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            LiveDataScope liveDataScope;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f32610OooO0Oo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f32612OooO0o0;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            liveDataScope = (LiveDataScope) this.f32612OooO0o0;
            r rVar = r.f45104OooO00o;
            this.f32612OooO0o0 = liveDataScope;
            this.f32610OooO0Oo = 1;
            obj = rVar.OooOO0(this.f32611OooO0o, this.f32613OooO0oO, this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f32614OooO0oo.getShowLoadingDialog().setValue(Boxing.boxBoolean(false));
            this.f32612OooO0o0 = null;
            this.f32610OooO0Oo = 2;
    ...
    public static final class OooO0o extends SuspendLambda implements Function2<LiveDataScope<ApiResult<RenewCustomizeTheme>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f32615OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f32617OooO0o0;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            LiveDataScope liveDataScope;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f32615OooO0Oo;
            RoomThemeCustomCreateVM roomThemeCustomCreateVM = RoomThemeCustomCreateVM.this;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f32617OooO0o0;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            ResultKt.throwOnFailure(obj);
            liveDataScope = (LiveDataScope) this.f32617OooO0o0;
            OooOOO0.OooO0OO(o0OoOo0.OooO00o(RoomThemeCustomCreateVM.INSTANCE), "reNewThemeId: " + roomThemeCustomCreateVM.getReNewThemeId() + "  currentThemeType:" + roomThemeCustomCreateVM.getCurrentThemeType());
            r rVar = r.f45104OooO00o;
            ...
            this.f32617OooO0o0 = liveDataScope;
            this.f32615OooO0Oo = 1;
            obj = rVar.OooOO0O(reNewThemeId, currentThemeType, 1, this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            roomThemeCustomCreateVM.getShowLoadingDialog().setValue(Boxing.boxBoolean(false));
            this.f32617OooO0o0 = null;
            this.f32615OooO0Oo = 2;
            if (liveDataScope.emit((ApiResult) obj, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
    ...
    @NotNull
    public final LiveData<p136o00OOOo0.OooO0OO> uploadCustomImage(@NotNull File file) {
