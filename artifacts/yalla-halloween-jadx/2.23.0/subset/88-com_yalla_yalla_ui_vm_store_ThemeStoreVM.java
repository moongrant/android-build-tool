...
public final class ThemeStoreVM extends o0O0O00 {
    ...
    public static final class OooO extends SuspendLambda implements Function2<LiveDataScope<ApiResult<List<ThemeModel>>>, Continuation<? super Unit>, Object> {
        ...
        public int f32618OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f32619OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f32620OooO0o0;
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO oooO = new OooO(this.f32619OooO0o, continuation);
            oooO.f32620OooO0o0 = obj;
            return oooO;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f32618OooO0Oo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f32620OooO0o0;
            ...
            this.f32620OooO0o0 = liveDataScope;
            this.f32618OooO0Oo = 1;
            obj = rVar.OooO0oo(this.f32619OooO0o, this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f32620OooO0o0 = null;
            this.f32618OooO0Oo = 2;
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<LiveDataScope<ApiResult<List<CustomizeThemeModel>>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f32621OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f32622OooO0o0;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            LiveDataScope liveDataScope;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f32621OooO0Oo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f32622OooO0o0;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            liveDataScope = (LiveDataScope) this.f32622OooO0o0;
            r rVar = r.f45104OooO00o;
            this.f32622OooO0o0 = liveDataScope;
            this.f32621OooO0Oo = 1;
            obj = rVar.OooO0o0(this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f32622OooO0o0 = null;
            this.f32621OooO0Oo = 2;
            if (liveDataScope.emit(obj, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<LiveDataScope<ApiResult<Integer>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f32623OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f32624OooO0o0;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            LiveDataScope liveDataScope;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f32623OooO0Oo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f32624OooO0o0;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            liveDataScope = (LiveDataScope) this.f32624OooO0o0;
            r rVar = r.f45104OooO00o;
            this.f32624OooO0o0 = liveDataScope;
            this.f32623OooO0Oo = 1;
            obj = rVar.OooO0Oo(this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f32624OooO0o0 = null;
            this.f32623OooO0Oo = 2;
            if (liveDataScope.emit(obj, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<LiveDataScope<ApiResult<MyThemeListModel>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f32625OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f32626OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f32627OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f32628OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(int i, int i2, Continuation<? super OooO0OO> continuation) {
            super(2, continuation);
            this.f32626OooO0o = i;
            this.f32628OooO0oO = i2;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0OO oooO0OO = new OooO0OO(this.f32626OooO0o, this.f32628OooO0oO, continuation);
            oooO0OO.f32627OooO0o0 = obj;
            return oooO0OO;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            LiveDataScope liveDataScope;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f32625OooO0Oo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f32627OooO0o0;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            liveDataScope = (LiveDataScope) this.f32627OooO0o0;
            r rVar = r.f45104OooO00o;
            this.f32627OooO0o0 = liveDataScope;
            this.f32625OooO0Oo = 1;
            obj = rVar.OooO0o(this.f32626OooO0o, this.f32628OooO0oO, this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f32627OooO0o0 = null;
            this.f32625OooO0Oo = 2;
            if (liveDataScope.emit(obj, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
    ...
    public static final class OooO0o extends SuspendLambda implements Function2<LiveDataScope<ApiResult<List<ThemeListModel>>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f32629OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f32631OooO0o0;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            LiveDataScope liveDataScope;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f32629OooO0Oo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f32631OooO0o0;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            liveDataScope = (LiveDataScope) this.f32631OooO0o0;
            r rVar = r.f45104OooO00o;
            this.f32631OooO0o0 = liveDataScope;
            this.f32629OooO0Oo = 1;
            obj = rVar.OooO0oO(this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            ...
            this.f32631OooO0o0 = null;
            this.f32629OooO0Oo = 2;
            if (liveDataScope.emit(obj, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
    ...
    public static final class OooOO0 extends SuspendLambda implements Function2<LiveDataScope<ApiResult<ThemeBoughtModel>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f32632OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ long f32633OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f32634OooO0o0;
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooOO0 oooOO1 = new OooOO0(this.f32633OooO0o, continuation);
            oooOO1.f32634OooO0o0 = obj;
            return oooOO1;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            LiveDataScope liveDataScope;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f32632OooO0Oo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f32634OooO0o0;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            liveDataScope = (LiveDataScope) this.f32634OooO0o0;
            r rVar = r.f45104OooO00o;
            this.f32634OooO0o0 = liveDataScope;
            this.f32632OooO0Oo = 1;
            obj = rVar.OooO(this.f32633OooO0o, this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f32634OooO0o0 = null;
            this.f32632OooO0Oo = 2;
            if (liveDataScope.emit(obj, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
    ...
    public static final class OooOO0O extends SuspendLambda implements Function2<LiveDataScope<ApiResult<RenewCustomizeTheme>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f32635OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ long f32636OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f32637OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f32638OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0O(long j, int i, Continuation<? super OooOO0O> continuation) {
            super(2, continuation);
            this.f32636OooO0o = j;
            this.f32638OooO0oO = i;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooOO0O oooOO0O = new OooOO0O(this.f32636OooO0o, this.f32638OooO0oO, continuation);
            oooOO0O.f32637OooO0o0 = obj;
            return oooOO0O;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            LiveDataScope liveDataScope;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f32635OooO0Oo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f32637OooO0o0;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            liveDataScope = (LiveDataScope) this.f32637OooO0o0;
            r rVar = r.f45104OooO00o;
            long j = this.f32636OooO0o;
            int i2 = this.f32638OooO0oO;
            this.f32637OooO0o0 = liveDataScope;
            this.f32635OooO0Oo = 1;
            obj = rVar.OooOO0O(j, i2, 0, this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f32637OooO0o0 = null;
            this.f32635OooO0Oo = 2;
            if (liveDataScope.emit(obj, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
    ...
    public static final class OooOOO0 extends SuspendLambda implements Function2<LiveDataScope<ApiResult<String>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f32639OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ long f32640OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f32641OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ long f32642OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO0(long j, long j2, Continuation<? super OooOOO0> continuation) {
            super(2, continuation);
            this.f32640OooO0o = j;
            this.f32642OooO0oO = j2;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooOOO0 oooOOO0 = new OooOOO0(this.f32640OooO0o, this.f32642OooO0oO, continuation);
            oooOOO0.f32641OooO0o0 = obj;
            return oooOOO0;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            LiveDataScope liveDataScope;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f32639OooO0Oo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f32641OooO0o0;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            liveDataScope = (LiveDataScope) this.f32641OooO0o0;
            r rVar = r.f45104OooO00o;
            long j = this.f32640OooO0o;
            long j2 = this.f32642OooO0oO;
            this.f32641OooO0o0 = liveDataScope;
            this.f32639OooO0Oo = 1;
            obj = rVar.OooOO0o(j, j2, this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f32641OooO0o0 = null;
            this.f32639OooO0Oo = 2;
            if (liveDataScope.emit(obj, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
