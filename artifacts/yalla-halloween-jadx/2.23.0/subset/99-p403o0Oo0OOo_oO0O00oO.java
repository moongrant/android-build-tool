...
public final class oO0O00oO extends OooOOO0<SystemMessage> {
    public oO0O00oO(YlAppDataBase ylAppDataBase) {
        super(ylAppDataBase);
    }
    ...
    public final void OooO0Oo(SupportSQLiteStatement supportSQLiteStatement, SystemMessage systemMessage) {
        ...
        if (giftBlindTaskReward != null) {
            ...
            OooO00o.OooO0O0(supportSQLiteStatement, 29, 30, 31, 32);
        }
        ...
        if (giftBlindRankingReward != null) {
            ...
            OooO00o.OooO0O0(supportSQLiteStatement, 33, 34, 35, 36);
            supportSQLiteStatement.bindNull(37);
            supportSQLiteStatement.bindNull(38);
        }
        ...
        if (eventInfo == null) {
            OooO00o.OooO0O0(supportSQLiteStatement, 67, 68, 69, 70);
