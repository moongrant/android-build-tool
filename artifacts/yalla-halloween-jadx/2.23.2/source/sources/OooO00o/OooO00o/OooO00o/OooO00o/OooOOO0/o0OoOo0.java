...
public final class o0OoOo0 extends oo000o implements OooO0O0.OooO00o {
    ...
    public static final class OooO00o extends Lambda implements Function1<OooO0O0.OooOo00, Unit> {
        ...
        public final Unit invoke(OooO0O0.OooOo00 oooOo00) {
            ...
            if (o0oo0oo2 != null) {
                o0oo0oo2.f141OooO00o = OooO0O0.OooOo00.f108OooO0O0;
            }
            o00oo1.OooO0oo();
    ...
    public final void OooO0o() {
        o0Oo0oo o0oo0oo2;
        OooO0O0.OooOo00 appInfo = OooO0O0.OooOo00.f108OooO0O0;
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (unit == null) {
                                    ...
                                    if (h5.f57416OooO0O0) {
                                        Log.e(h5.f57415OooO00o, "Failed to query content resolver.");
                                    }
                                    b = -2;
                                }
                                if (b != 0) {
                                    o0oo0oo2 = o00oo1.f130OooO0Oo;
                                    if (o0oo0oo2 != null) {
                                ...
                                OooOOO0 oooOOO0 = o00oo1.f131OooO0o;
                                oooOOO0.getClass();
                                Intrinsics.checkNotNullParameter(callback, "callback");
                                oooOOO0.f106OooO0Oo = callback;
                                try {
                                    oooOOO0.getClass();
                                    ...
                                    o00oo1.OooO0Oo(o00oo1.OooO00o(100034, o00oo1.OooO0o0().getString(n5.base_platform_app_version_too_low)));
                                    return;
                                }
                            } catch (Throwable th2) {
                                if (cursor != null) {
        ...
        OooOOO0 oooOOO1 = o00oo1.f131OooO0o;
        oooOOO1.getClass();
        Intrinsics.checkNotNullParameter(callback2, "callback");
        oooOOO1.f106OooO0Oo = callback2;
        oooOOO1.getClass();
        Intrinsics.checkNotNullParameter(this, "bizClient");
        oooOOO1.f105OooO0OO = this;
    ...
    public final void OooO0o0() {
        if (oo000o.OooO0Oo()) {
            YCSDKOpenKit.INSTANCE.dispatchToIO$lib_release(new o000000(this, 0));
        } else {
            OooO0o();
        }
    }
