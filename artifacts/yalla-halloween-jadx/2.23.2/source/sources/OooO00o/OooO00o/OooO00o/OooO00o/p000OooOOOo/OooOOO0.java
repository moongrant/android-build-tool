...
public final class OooOOO0 extends Lambda implements Function1<WebAuthCodeBean, Unit> {
    ...
    public final Unit invoke(WebAuthCodeBean webAuthCodeBean) {
        ...
        if (Intrinsics.areEqual($receiver.getState(), this.f76OooO0Oo.f168OooO0OO.getStateCode())) {
            this.f77OooO0o0.f173OooO0O0.OooO0Oo(AuthResponse.Companion.OooO00o(AuthResponse.INSTANCE, $receiver.getAuthorizationCode(), 0, null, 4));
        }
