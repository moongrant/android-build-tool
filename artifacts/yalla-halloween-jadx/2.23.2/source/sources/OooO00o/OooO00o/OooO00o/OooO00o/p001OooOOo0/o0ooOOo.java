...
public final class o0ooOOo extends OooO0o.OooO00o {
    ...
    public static final class OooO00o implements o00Oo0.OooO0O0 {
        ...
        public final void OooO00o(@NotNull BaseResp response) {
            ...
            YCSDKOpenKit.INSTANCE.dispatchToMain$lib_release(new OooOOO0(0, response, o0ooOOo.this));
        }
    }
    ...
    public final void onCreate(@Nullable Bundle bundle) {
        ...
        ShareRequest shareRequest = OooO0O0.OooOOOO.f107OooO00o;
        if (shareRequest == null) {
            shareRequest = null;
        } else {
            OooOOOO oooOOOO = new OooOOOO(this);
            this.f81OooO0o = oooOOOO;
            oooOOOO.f133OooO0oO = new OooO00o();
            oooOOOO.f134OooO0oo = new OooO0O0();
            FragmentActivity fragmentActivity = this.f83OooO0oo;
            if (fragmentActivity == null) {
                Intrinsics.throwUninitializedPropertyAccessException("act");
                fragmentActivity = null;
            }
            this.f82OooO0oO = o000O0o.OooO0O0(fragmentActivity, new OooO0OO());
    ...
    public final void onDestroyView() {
        ...
        OooO0O0.OooOOOO.f107OooO00o = null;
