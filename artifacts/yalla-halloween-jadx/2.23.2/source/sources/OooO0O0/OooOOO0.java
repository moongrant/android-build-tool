...
public final class OooOOO0 {
    ...
    public androidx.activity.result.OooO0O0<Intent> f103OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public final ArrayList f104OooO0O0 = new ArrayList();

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @Nullable
    public OooO00o f105OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @Nullable
    public o0OoOo0.OooO00o f106OooO0Oo;
    ...
    public final OooOOO OooO00o(Intent intent) {
        ...
        if (oooOOO == null) {
            ...
            if (this.f104OooO0O0.remove(oooOOO.f100OooO00o)) {
                return oooOOO;
            }
            OooO00o oooO00o2 = this.f105OooO0OO;
            if (oooO00o2 == null) {
                unit = null;
            } else {
        ...
        if (unit == null && (oooO00o = this.f105OooO0OO) != null) {
    ...
    public final void OooO0O0(@NotNull OooO0o appInfo, int i, @NotNull Bundle requestData, @Nullable AppStatus appStatus) {
        ...
        androidx.activity.result.OooO0O0<Intent> oooO0O0 = this.f103OooO00o;
        if (oooO0O0 == null) {
