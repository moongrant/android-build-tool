...
import p607o0oo0OO.oO0O000;
import p607o0oo0OO.oO0O000o;
...
public final class OooOO0O {
    ...
    @NotNull
    public static final Pair<String, String>[] f109OooO00o = {new Pair<>("app_platform", "1"), new Pair<>("Platform", "1"), new Pair<>("Sdk-Version", "1.2.0")};

    /* JADX WARN: Code duplicated, block: B:148:0x0373  */
    /* JADX WARN: Code duplicated, block: B:149:0x0374 A[Catch: all -> 0x0378, TRY_LEAVE, TryCatch #8 {all -> 0x0378, blocks: (B:146:0x036e, B:149:0x0374), top: B:207:0x036e }] */
    /* JADX WARN: Code duplicated, block: B:161:0x0393 A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:162:0x0395  */
    /* JADX WARN: Code duplicated, block: B:163:0x0396 A[Catch: all -> 0x039a, TRY_LEAVE, TryCatch #12 {all -> 0x039a, blocks: (B:160:0x0390, B:163:0x0396), top: B:213:0x0390 }] */
    /* JADX WARN: Code duplicated, block: B:169:0x03a3 A[PHI: r0 r20
      0x03a3: PHI (r0v27 't' java.lang.Throwable) = (r0v31 't' java.lang.Throwable), (r0v32 't' java.lang.Throwable) binds: [B:167:0x03a0, B:153:0x037e] A[DONT_GENERATE, DONT_INLINE]
      0x03a3: PHI (r20v3 kotlin.jvm.internal.Ref$IntRef) = (r20v5 kotlin.jvm.internal.Ref$IntRef), (r20v7 kotlin.jvm.internal.Ref$IntRef) binds: [B:167:0x03a0, B:153:0x037e] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Code duplicated, block: B:213:0x0390 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    ...
    public static BizResponse OooO00o(@NotNull String appId, @NotNull OooO0O0.OooO0o appInfo) {
        ...
        Pair[] pairArr3 = (Pair[]) ArraysKt.plus(f109OooO00o, new Pair("open_version", "1.2.0"));
        if (pairArr2 == null) {
            z = true;
        ...
        oO0O000 request = new oO0O000(url, "POST", linkedHashMap, linkedHashMap2);
        ...
        for (int i3 = 3; intRef.element < i3; i3 = 3) {
            ...
            try {
                URL url2 = request.f57400OooO00o;
                String str = request.f57401OooO0O0;
                ...
                if (uRLConnection instanceof HttpsURLConnection) {
                    ...
                    try {
                        ...
                        Map<String, String> map = request.f57402OooO0OO;
                        if (!map.isEmpty()) {
                            for (String str2 : map.keySet()) {
                                uRLConnection.setRequestProperty(str2, map.get(str2));
                            }
                        }
                        Map<String, Object> map2 = request.f57403OooO0Oo;
                        if (Intrinsics.areEqual(str, "POST")) {
                            oO0O000o.OooO00o((HttpURLConnection) uRLConnection, map2);
