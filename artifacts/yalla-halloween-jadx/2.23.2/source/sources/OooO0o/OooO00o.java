...
public class OooO00o extends Fragment {
    ...
    public ViewStub f115OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @Nullable
    public WebBrowser f116OooO0o0;

    @Override // androidx.fragment.app.Fragment
    public final void onActivityResult(int i, int i2, @Nullable Intent intent) {
        super.onActivityResult(i, i2, intent);
        WebBrowser webBrowser = this.f116OooO0o0;
        if (webBrowser == null) {
            return;
        }
    ...
    public final View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        return LayoutInflater.from(getContext()).inflate(m5.base_platform_fragment_platform_web, viewGroup, false);
    }
    ...
    public final void onViewCreated(@NotNull View view, @Nullable Bundle bundle) {
        ...
        View viewFindViewById = view.findViewById(l5.webViewStub);
