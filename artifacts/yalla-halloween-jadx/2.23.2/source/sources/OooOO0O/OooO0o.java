...
public final class OooO0o extends oo000o implements OooO0O0.OooO00o {
    ...
    public final void OooO0O0(@NotNull String message) {
        ...
        this.f172OooO0O0.OooO0Oo(AuthResponse.Companion.OooO00o(AuthResponse.INSTANCE, null, -2002, message, 1));
    }
    ...
    public final void OooO0o(OooO0O0.OooO0o oooO0o) {
        OooO00o oooO00o = this.f172OooO0O0;
        try {
            o00Oo0.OooO00o oooO00o2 = oooO00o.f134OooO0oo;
            if (oooO00o2 != null) {
                oooO00o2.OooO00o();
            }
            OooOOO0 oooOOO0 = oooO00o.f131OooO0o;
            oooOOO0.getClass();
            Intrinsics.checkNotNullParameter(this, "bizClient");
            oooOOO0.f105OooO0OO = this;
            oooO00o.f131OooO0o.OooO0O0(oooO0o, 1, OooO0oO(), null);
        } catch (Exception e) {
    ...
    public final void OooO0o0() {
        ...
        OooOo00 oooOo00;
        OooO00o oooO00o = this.f172OooO0O0;
        o0Oo0oo o0oo0oo2 = oooO00o.f130OooO0Oo;
    ...
    public final Bundle OooO0oO() {
        ...
        String stateCode = oooO0O0OooO0oO.f168OooO0OO.getStateCode();
        String scope = "";
        if (stateCode == null) {
            stateCode = "";
        }
        ...
        String[] scope2 = oooO0O0OooO0oO2.f168OooO0OO.getScope();
