...
public final class OooO00o extends OooOo.OooO {
    ...
    public OooO0O0 f220OooOOoo;

    /* JADX INFO: renamed from: OooOo0, reason: collision with root package name */
    public int f221OooOo0;

    /* JADX INFO: renamed from: OooOo00, reason: collision with root package name */
    public OooOO0 f222OooOo00;

    /* JADX INFO: renamed from: OooOo0O, reason: collision with root package name */
    public int f223OooOo0O;

    /* JADX INFO: renamed from: OooOo0o, reason: collision with root package name */
    public boolean f224OooOo0o;

    public static class OooO implements TimeInterpolator {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public int[] f225OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public int f226OooO0O0;
        ...
        public OooO(AnimationDrawable animationDrawable, boolean z) {
            ...
            this.f226OooO0O0 = numberOfFrames;
            int[] iArr = this.f225OooO00o;
            if (iArr == null || iArr.length < numberOfFrames) {
                this.f225OooO00o = new int[numberOfFrames];
            }
            int[] iArr2 = this.f225OooO00o;
            int i = 0;
        ...
        public final float getInterpolation(float f) {
            int i = (int) ((f * this.f227OooO0OO) + 0.5f);
            int i2 = this.f226OooO0O0;
            int[] iArr = this.f225OooO00o;
            int i3 = 0;
            while (i3 < i2) {
                int i4 = iArr[i3];
            ...
            return (i3 / i2) + (i3 < i2 ? i / this.f227OooO0OO : 0.0f);
        }
    }
    ...
    public static class C0002OooO00o extends OooOO0 {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final Animatable f228OooO00o;

        public C0002OooO00o(Animatable animatable) {
            this.f228OooO00o = animatable;
        }

        @Override // OooOo.OooO00o.OooOO0
        public final void OooO0OO() {
            this.f228OooO00o.start();
        }

        @Override // OooOo.OooO00o.OooOO0
        public final void OooO0Oo() {
            this.f228OooO00o.stop();
        }
    }
    ...
    public static class OooO0O0 extends OooOo.OooO.OooO00o {
        ...
        public OooOOOO<Long> f229Oooo0;

        /* JADX INFO: renamed from: Oooo0O0, reason: collision with root package name */
        public Oooo000<Integer> f230Oooo0O0;
        ...
        public OooO0O0(@Nullable OooO0O0 oooO0O0, @NonNull OooO00o oooO00o, @Nullable Resources resources) {
            ...
            if (oooO0O0 != null) {
                this.f229Oooo0 = oooO0O0.f229Oooo0;
                this.f230Oooo0O0 = oooO0O0.f230Oooo0O0;
            } else {
                this.f229Oooo0 = new OooOOOO<>();
                this.f230Oooo0O0 = new Oooo000<>();
            }
        }

        @Override // OooOo.OooO.OooO00o, OooOo.OooO0O0.OooO0OO
        public final void OooO0o0() {
            this.f229Oooo0 = this.f229Oooo0.clone();
            this.f230Oooo0O0 = this.f230Oooo0O0.clone();
        }
    ...
    public static class OooO0OO extends OooOO0 {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final o00O00OO.OooO0o f231OooO00o;

        public OooO0OO(o00O00OO.OooO0o oooO0o) {
            this.f231OooO00o = oooO0o;
        }

        @Override // OooOo.OooO00o.OooOO0
        public final void OooO0OO() {
            this.f231OooO00o.start();
        }

        @Override // OooOo.OooO00o.OooOO0
        public final void OooO0Oo() {
            this.f231OooO00o.stop();
        }
    }
    ...
    public static class OooO0o extends OooOO0 {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final ObjectAnimator f232OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final boolean f233OooO0O0;
        ...
        public OooO0o(AnimationDrawable animationDrawable, boolean z, boolean z2) {
            ...
            objectAnimatorOfInt.setDuration(oooO.f227OooO0OO);
            objectAnimatorOfInt.setInterpolator(oooO);
            this.f233OooO0O0 = z2;
            this.f232OooO00o = objectAnimatorOfInt;
        }

        @Override // OooOo.OooO00o.OooOO0
        public final boolean OooO00o() {
            return this.f233OooO0O0;
        }

        @Override // OooOo.OooO00o.OooOO0
        public final void OooO0O0() {
            this.f232OooO00o.reverse();
        }
    ...
    public static OooO00o OooO0oO(@NonNull Context context, @Nullable Resources.Theme theme, @NonNull Resources resources, @NonNull AttributeSet attributeSet, @NonNull XmlResourceParser xmlResourceParser) throws XmlPullParserException, IOException {
        ...
        OooO0O0 oooO0O0 = oooO00o.f220OooOOoo;
        oooO0O0.f253OooO0Oo |= p015OooOoO0.OooO0o.OooO0O0(typedArrayOooO0oo);
        oooO0O0.f249OooO = typedArrayOooO0oo.getBoolean(p015OooOoO0.OooOO0.AnimatedStateListDrawableCompat_android_variablePadding, oooO0O0.f249OooO);
        oooO0O0.f260OooOO0o = typedArrayOooO0oo.getBoolean(p015OooOoO0.OooOO0.AnimatedStateListDrawableCompat_android_constantSize, oooO0O0.f260OooOO0o);
        oooO0O0.f274OooOoO0 = typedArrayOooO0oo.getInt(p015OooOoO0.OooOO0.AnimatedStateListDrawableCompat_android_enterFadeDuration, oooO0O0.f274OooOoO0);
        oooO0O0.f273OooOoO = typedArrayOooO0oo.getInt(p015OooOoO0.OooOO0.AnimatedStateListDrawableCompat_android_exitFadeDuration, oooO0O0.f273OooOoO);
        oooO00o.setDither(typedArrayOooO0oo.getBoolean(p015OooOoO0.OooOO0.AnimatedStateListDrawableCompat_android_dither, oooO0O0.f272OooOo0o));
        OooOo.OooO0O0.OooO0OO oooO0OO = oooO00o.f236OooO0Oo;
        int i3 = 0;
        if (resources != null) {
            ...
            int i5 = oooO0OO.f252OooO0OO;
            oooO0OO.f252OooO0OO = i4;
            if (i5 != i4) {
        ...
        while (true) {
            ...
            if (next3 == 2 && depth <= depth2) {
                if (xmlResourceParser.getName().equals("item")) {
                    ...
                    OooO0O0 oooO0O1 = oooO00o2.f220OooOOoo;
                    int iOooO00o = oooO0O1.OooO00o(drawableOooO0o);
                    oooO0O1.f219Oooo00o[iOooO00o] = iArrTrimStateSet;
                    oooO0O1.f230Oooo0O0.OooO0oo(iOooO00o, Integer.valueOf(resourceId));
                } else {
                    i = depth2;
                    if (xmlResourceParser.getName().equals("transition")) {
                        ...
                        if (drawableOooO0o2 == null) {
                            ...
                            if (xmlResourceParser.getName().equals("animated-vector")) {
                                drawableOooO0o2 = new o00O00OO.OooO0o(context);
                        ...
                        OooO0O0 oooO0O2 = oooO00o2.f220OooOOoo;
                        ...
                        long j5 = iOooO00o2;
                        oooO0O2.f229Oooo0.OooO0O0(j3, Long.valueOf(j5 | j4));
                        if (z) {
                            oooO0O2.f229Oooo0.OooO0O0((j2 << 32) | j, Long.valueOf(4294967296L | j5 | j4));
                        }
                    }
                    context2 = context;
                    theme2 = theme;
    ...
    public final OooOo.OooO0O0.OooO0OO OooO0O0() {
        return new OooO0O0(this.f220OooOOoo, this, null);
    }
    ...
    public final void OooO0o0(@NonNull OooOo.OooO0O0.OooO0OO oooO0OO) {
        ...
        if (oooO0OO instanceof OooO0O0) {
            this.f220OooOOoo = (OooO0O0) oooO0OO;
        }
    }
    ...
    public final void jumpToCurrentState() {
        ...
        OooOO0 oooOO1 = this.f222OooOo00;
        if (oooOO1 != null) {
            oooOO1.OooO0Oo();
            this.f222OooOo00 = null;
            OooO0Oo(this.f221OooOo0);
            this.f221OooOo0 = -1;
            this.f223OooOo0O = -1;
        }
    }
    ...
    public final Drawable mutate() {
        if (!this.f224OooOo0o) {
            super.mutate();
            this.f220OooOOoo.OooO0o0();
            this.f224OooOo0o = true;
        }
        return this;
    }
    ...
    public final boolean onStateChange(@NonNull int[] iArr) {
        ...
        OooOO0 c0002OooO00o;
        boolean z3;
        OooO0O0 oooO0O1 = this.f220OooOOoo;
        ...
        if (iOooO0o != i) {
            ...
            if (oooOO1 == null) {
                ...
                this.f223OooOo0O = -1;
                this.f221OooOo0 = -1;
                oooO0O0 = this.f220OooOOoo;
                if (i < 0) {
                    oooO0O0.getClass();
                    iIntValue = 0;
                } else {
                    iIntValue = ((Integer) oooO0O0.f230Oooo0O0.OooO0o(i, 0)).intValue();
                }
                if (iOooO0o < 0) {
                    iIntValue2 = 0;
                } else {
                    iIntValue2 = ((Integer) oooO0O0.f230Oooo0O0.OooO0o(iOooO0o, 0)).intValue();
                }
                if (iIntValue2 != 0 && iIntValue != 0) {
                    j = ((long) iIntValue2) | (((long) iIntValue) << 32);
                    iLongValue = (int) ((Long) oooO0O0.f229Oooo0.OooO0oO(j, -1L)).longValue();
                    if (iLongValue >= 0) {
                        if ((((Long) oooO0O0.f229Oooo0.OooO0oO(j, -1L)).longValue() & 8589934592L) != 0) {
                            z2 = true;
                        } else {
                            z2 = false;
                        }
                        ...
                        if (obj instanceof AnimationDrawable) {
                            if ((((Long) oooO0O0.f229Oooo0.OooO0oO(j, -1L)).longValue() & 4294967296L) != 0) {
                                z3 = true;
                            } else {
                                z3 = false;
                            }
                            c0002OooO00o = new OooO0o((AnimationDrawable) obj, z3, z2);
                        } else if (obj instanceof o00O00OO.OooO0o) {
                            c0002OooO00o = new OooO0OO((o00O00OO.OooO0o) obj);
                        } else if (obj instanceof Animatable) {
                            c0002OooO00o = new C0002OooO00o((Animatable) obj);
                        }
                        c0002OooO00o.OooO0OO();
                        this.f222OooOo00 = c0002OooO00o;
                        this.f223OooOo0O = i;
                        this.f221OooOo0 = iOooO0o;
                        z = true;
                    }
                }
                z = false;
            } else {
                if (iOooO0o != this.f221OooOo0) {
                    if (iOooO0o == this.f223OooOo0O && oooOO1.OooO00o()) {
                        oooOO1.OooO0O0();
                        this.f221OooOo0 = this.f223OooOo0O;
                        this.f223OooOo0O = iOooO0o;
                    } else {
                        i = this.f221OooOo0;
                        oooOO1.OooO0Oo();
                        this.f222OooOo00 = null;
