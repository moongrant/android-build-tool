...
public class ComponentActivity extends androidx.core.app.ComponentActivity implements ViewModelStoreOwner, HasDefaultViewModelProviderFactory, o00O0000.OooO0o, o00Oo0, androidx.activity.result.OooOO0, p050o00000Oo.OooO0o, p050o00000Oo.OooO, o0ooOOo, o0OOO0o, androidx.core.view.o00Oo0 {
    ...
    @NonNull
    final Oooo0 mFullyDrawnReporter;
    private final LifecycleRegistry mLifecycleRegistry;
    private final androidx.core.view.o00oO0o mMenuHostHelper;
    private final AtomicInteger mNextLocalRequestCode;
    private final OnBackPressedDispatcher mOnBackPressedDispatcher;
    private final CopyOnWriteArrayList<o000OO.OooO00o<Configuration>> mOnConfigurationChangedListeners;
    private final CopyOnWriteArrayList<o000OO.OooO00o<o00000O.Oooo0>> mOnMultiWindowModeChangedListeners;
    ...
    final o00O0000.OooO0OO mSavedStateRegistryController;
    ...
    public class OooO0O0 extends androidx.activity.result.OooO {
        ...
        public final void OooO0O0(int i, @NonNull p011OooOo0.OooOO0 oooOO1, Object obj) {
            ...
            if ("androidx.activity.result.contract.action.REQUEST_PERMISSIONS".equals(intentCreateIntent.getAction())) {
                ...
                o00000O.OooO0O0.OooO0o0(componentActivity, stringArrayExtra, i);
                return;
            }
            if (!"androidx.activity.result.contract.action.INTENT_SENDER_REQUEST".equals(intentCreateIntent.getAction())) {
                ...
                o00000O.OooO0O0.OooO00o.OooO0O0(componentActivity, intentCreateIntent, i, bundle);
                return;
            }
            ...
            try {
                IntentSender intentSender = intentSenderRequest.f2204OooO0Oo;
                Intent intent = intentSenderRequest.f2206OooO0o0;
                int i3 = intentSenderRequest.f2205OooO0o;
                int i4 = intentSenderRequest.f2207OooO0oO;
                int i5 = o00000O.OooO0O0.f33405OooO0OO;
                o00000O.OooO0O0.OooO00o.OooO0OO(componentActivity, intentSender, i, intent, i3, i4, 0, bundle);
    ...
    public static final class OooO0o {
        ...
        public Object f2145OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public ViewModelStore f2146OooO0O0;
    }
    ...
    public class OooOO0 implements OooO, ViewTreeObserver.OnDrawListener, Runnable {
        ...
        public final long f2147OooO0Oo = SystemClock.uptimeMillis() + 10000;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public boolean f2148OooO0o = false;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public Runnable f2149OooO0o0;
        ...
        public final void OooO0OO(@NonNull View view) {
            ...
            this.f2148OooO0o = true;
            view.getViewTreeObserver().addOnDrawListener(this);
        }

        @Override // java.util.concurrent.Executor
        public final void execute(Runnable runnable) {
            this.f2149OooO0o0 = runnable;
        ...
        public final void onDraw() {
            boolean z;
            Runnable runnable = this.f2149OooO0o0;
            if (runnable == null) {
                if (SystemClock.uptimeMillis() > this.f2147OooO0Oo) {
                    this.f2148OooO0o = false;
            ...
            runnable.run();
            this.f2149OooO0o0 = null;
            Oooo0 oooo0 = ComponentActivity.this.mFullyDrawnReporter;
            synchronized (oooo0.f2186OooO0O0) {
                z = oooo0.f2187OooO0OO;
            }
            if (z) {
                this.f2148OooO0o = false;
                ComponentActivity.this.getWindow().getDecorView().post(this);
    ...
    public ComponentActivity() {
        ...
        this.mMenuHostHelper = new androidx.core.view.o00oO0o(new Runnable() { // from class: androidx.activity.OooO0O0
            @Override // java.lang.Runnable
            public final void run() {
                this.f2172OooO0Oo.invalidateMenu();
            }
        });
        ...
        this.mFullyDrawnReporter = new Oooo0(oooOCreateFullyDrawnExecutor, new Function0() { // from class: androidx.activity.OooO0OO
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return this.f2173OooO0Oo.lambda$new$0();
            }
        });
        ...
        getLifecycle().addObserver(new LifecycleEventObserver() { // from class: androidx.activity.ComponentActivity.4
            ...
            public final void onStateChanged(@NonNull LifecycleOwner lifecycleOwner, @NonNull Lifecycle.Event event) {
                if (event == Lifecycle.Event.ON_DESTROY) {
                    ComponentActivity.this.mContextAwareHelper.f285OooO0O0 = null;
    ...
    private void initViewTreeOwners() {
        ...
        o00O0000.OooO.OooO0O0(getWindow().getDecorView(), this);
        View decorView = getWindow().getDecorView();
        Intrinsics.checkNotNullParameter(decorView, "<this>");
        Intrinsics.checkNotNullParameter(this, "onBackPressedDispatcherOwner");
        decorView.setTag(o00Ooo.view_tree_on_back_pressed_dispatcher_owner, this);
        View decorView2 = getWindow().getDecorView();
        Intrinsics.checkNotNullParameter(decorView2, "<this>");
        Intrinsics.checkNotNullParameter(this, "fullyDrawnReporterOwner");
        decorView2.setTag(o00Ooo.report_drawn, this);
    }
    ...
    public Bundle lambda$new$1() {
        ...
        oooO.getClass();
        HashMap map = oooO.f2210OooO0OO;
        bundle.putIntegerArrayList("KEY_COMPONENT_ACTIVITY_REGISTERED_RCS", new ArrayList<>(map.values()));
        bundle.putStringArrayList("KEY_COMPONENT_ACTIVITY_REGISTERED_KEYS", new ArrayList<>(map.keySet()));
        bundle.putStringArrayList("KEY_COMPONENT_ACTIVITY_LAUNCHED_KEYS", new ArrayList<>(oooO.f2213OooO0o0));
        bundle.putBundle("KEY_COMPONENT_ACTIVITY_PENDING_RESULT", (Bundle) oooO.f2215OooO0oo.clone());
        bundle.putSerializable("KEY_COMPONENT_ACTIVITY_RANDOM_OBJECT", oooO.f2208OooO00o);
        return bundle;
    }
    ...
    public void lambda$new$2(Context context) {
        ...
        if (bundleOooO00o != null) {
            ...
            oooO.f2213OooO0o0 = bundleOooO00o.getStringArrayList("KEY_COMPONENT_ACTIVITY_LAUNCHED_KEYS");
            oooO.f2208OooO00o = (Random) bundleOooO00o.getSerializable("KEY_COMPONENT_ACTIVITY_RANDOM_OBJECT");
            Bundle bundle = bundleOooO00o.getBundle("KEY_COMPONENT_ACTIVITY_PENDING_RESULT");
            Bundle bundle2 = oooO.f2215OooO0oo;
            bundle2.putAll(bundle);
            for (int i = 0; i < stringArrayList.size(); i++) {
                String str = stringArrayList.get(i);
                HashMap map = oooO.f2210OooO0OO;
                boolean zContainsKey = map.containsKey(str);
                HashMap map2 = oooO.f2209OooO0O0;
                if (zContainsKey) {
    ...
    public void addMenuProvider(@NonNull androidx.core.view.o0OOO0o o0ooo0o2) {
        androidx.core.view.o00oO0o o00oo0o2 = this.mMenuHostHelper;
    ...
    public final void addOnContextAvailableListener(@NonNull OooOo00.OooO0O0 listener) {
        ...
        Context context = oooO00o.f285OooO0O0;
        if (context != null) {
            listener.OooO00o(context);
        }
        oooO00o.f284OooO00o.add(listener);
    }
    ...
    public void ensureViewModelStore() {
        if (this.mViewModelStore == null) {
            ...
            if (oooO0o != null) {
                this.mViewModelStore = oooO0o.f2146OooO0O0;
            }
            if (this.mViewModelStore == null) {
    ...
    @NonNull
    public Oooo0 getFullyDrawnReporter() {
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        oooO00o.f285OooO0O0 = this;
        Iterator it = oooO00o.f284OooO00o.iterator();
        while (it.hasNext()) {
    ...
    public boolean onCreatePanelMenu(int i, @NonNull Menu menu) {
        ...
        Iterator<androidx.core.view.o0OOO0o> it = o00oo0o2.f5459OooO0O0.iterator();
        while (it.hasNext()) {
    ...
    public boolean onMenuItemSelected(int i, @NonNull MenuItem menuItem) {
        ...
        Iterator<androidx.core.view.o0OOO0o> it = this.mMenuHostHelper.f5459OooO0O0.iterator();
        while (it.hasNext()) {
    ...
    public void onMultiWindowModeChanged(boolean z) {
        ...
        Iterator<o000OO.OooO00o<o00000O.Oooo0>> it = this.mOnMultiWindowModeChangedListeners.iterator();
        while (it.hasNext()) {
            it.next().accept(new o00000O.Oooo0(z));
        }
    }
    ...
    public final Object onRetainNonConfigurationInstance() {
        ...
        if (viewModelStore == null && (oooO0o = (OooO0o) getLastNonConfigurationInstance()) != null) {
            viewModelStore = oooO0o.f2146OooO0O0;
        }
        if (viewModelStore == null && objOnRetainCustomNonConfigurationInstance == null) {
            return null;
        }
        OooO0o oooO0o2 = new OooO0o();
        oooO0o2.f2145OooO00o = objOnRetainCustomNonConfigurationInstance;
        oooO0o2.f2146OooO0O0 = viewModelStore;
        return oooO0o2;
    }
    ...
    public Context peekAvailableContext() {
        return this.mContextAwareHelper.f285OooO0O0;
    }
    ...
    public final void removeOnContextAvailableListener(@NonNull OooOo00.OooO0O0 listener) {
        ...
        oooO00o.getClass();
        Intrinsics.checkNotNullParameter(listener, "listener");
        oooO00o.f284OooO00o.remove(listener);
    }
    ...
    public void onMultiWindowModeChanged(boolean z, @NonNull Configuration configuration) {
        ...
        try {
            ...
            Iterator<o000OO.OooO00o<o00000O.Oooo0>> it = this.mOnMultiWindowModeChangedListeners.iterator();
            while (it.hasNext()) {
                it.next().accept(new o00000O.Oooo0(z, 0));
            }
        } catch (Throwable th) {
            this.mDispatchingOnMultiWindowModeChanged = false;
            throw th;
    ...
    public void addMenuProvider(@NonNull final androidx.core.view.o0OOO0o o0ooo0o2, @NonNull LifecycleOwner lifecycleOwner) {
        final androidx.core.view.o00oO0o o00oo0o2 = this.mMenuHostHelper;
        o00oo0o2.f5459OooO0O0.add(o0ooo0o2);
        o00oo0o2.f5458OooO00o.run();
        Lifecycle lifecycle = lifecycleOwner.getLifecycle();
        HashMap map = o00oo0o2.f5460OooO0OO;
        androidx.core.view.o00oO0o.OooO00o oooO00o = (androidx.core.view.o00oO0o.OooO00o) map.remove(o0ooo0o2);
        if (oooO00o != null) {
            oooO00o.f5461OooO00o.removeObserver(oooO00o.f5462OooO0O0);
            oooO00o.f5462OooO0O0 = null;
        }
        map.put(o0ooo0o2, new androidx.core.view.o00oO0o.OooO00o(lifecycle, new LifecycleEventObserver() { // from class: androidx.core.view.o00Ooo
            @Override // androidx.lifecycle.LifecycleEventObserver
    ...
    public void addMenuProvider(@NonNull final androidx.core.view.o0OOO0o o0ooo0o2, @NonNull LifecycleOwner lifecycleOwner, @NonNull final Lifecycle.State state) {
        ...
        map.put(o0ooo0o2, new androidx.core.view.o00oO0o.OooO00o(lifecycle, new LifecycleEventObserver() { // from class: androidx.core.view.oo000o
            @Override // androidx.lifecycle.LifecycleEventObserver
            public final void onStateChanged(LifecycleOwner lifecycleOwner2, Lifecycle.Event event) {
                o00oO0o o00oo0o3 = o00oo0o2;
                o00oo0o3.getClass();
                ...
                Runnable runnable = o00oo0o3.f5458OooO00o;
                CopyOnWriteArrayList<o0OOO0o> copyOnWriteArrayList = o00oo0o3.f5459OooO0O0;
