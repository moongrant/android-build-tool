...
public final class IntentSenderRequest implements Parcelable {
    ...
    @NotNull
    public final IntentSender f2204OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final int f2205OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @Nullable
    public final Intent f2206OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final int f2207OooO0oO;
    ...
    public IntentSenderRequest(@NotNull IntentSender intentSender, @Nullable Intent intent, int i, int i2) {
        ...
        this.f2204OooO0Oo = intentSender;
        this.f2206OooO0o0 = intent;
        this.f2205OooO0o = i;
        this.f2207OooO0oO = i2;
    }
    ...
    public final void writeToParcel(@NotNull Parcel dest, int i) {
        ...
        dest.writeParcelable(this.f2204OooO0Oo, i);
        dest.writeParcelable(this.f2206OooO0o0, i);
        dest.writeInt(this.f2205OooO0o);
        dest.writeInt(this.f2207OooO0oO);
    }
}
