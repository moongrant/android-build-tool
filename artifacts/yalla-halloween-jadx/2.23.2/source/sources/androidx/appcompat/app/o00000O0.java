...
public final class o00000O0 extends ActionBar {
    ...
    public final o000OO0O f2421OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final Window.Callback f2422OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final OooO f2423OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public boolean f2424OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public boolean f2425OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public boolean f2426OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final ArrayList<ActionBar.OooO00o> f2427OooO0oO = new ArrayList<>();

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final OooO00o f2428OooO0oo = new OooO00o();
    ...
    public class OooO00o implements Runnable {
        ...
        public final void run() {
            ...
            Window.Callback callback = o00000o1.f2422OooO0O0;
    ...
    public final class OooO0OO implements androidx.appcompat.view.menu.OooOOO.OooO00o {
        ...
        public final void OooO0O0(@NonNull androidx.appcompat.view.menu.OooO oooO, boolean z) {
            if (this.f2432OooO0Oo) {
                return;
            }
            this.f2432OooO0Oo = true;
            o00000O0 o00000o1 = o00000O0.this;
            o00000o1.f2421OooO00o.OooOOO();
            o00000o1.f2422OooO0O0.onPanelClosed(108, oooO);
            this.f2432OooO0Oo = false;
        }

        @Override // androidx.appcompat.view.menu.OooOOO.OooO00o
        public final boolean OooO0OO(@NonNull androidx.appcompat.view.menu.OooO oooO) {
            o00000O0.this.f2422OooO0O0.onMenuOpened(108, oooO);
            return true;
        }
    }
    ...
    public final class OooO0o implements androidx.appcompat.view.menu.OooO.OooO00o {
        ...
        public final void OooO0O0(@NonNull androidx.appcompat.view.menu.OooO oooO) {
            o00000O0 o00000o1 = o00000O0.this;
            boolean zOooO0o0 = o00000o1.f2421OooO00o.OooO0o0();
            Window.Callback callback = o00000o1.f2422OooO0O0;
            if (zOooO0o0) {
    ...
    public o00000O0(@NonNull Toolbar toolbar, @Nullable CharSequence charSequence, @NonNull AppCompatDelegateImpl.OooOOO oooOOO) {
        ...
        this.f2421OooO00o = o000oo0o2;
        oooOOO.getClass();
        this.f2422OooO0O0 = oooOOO;
        o000oo0o2.f3303OooOO0o = oooOOO;
        toolbar.setOnMenuItemClickListener(oooO0O0);
        o000oo0o2.setWindowTitle(charSequence);
        this.f2423OooO0OO = new OooO();
    }
    ...
    public final boolean OooO00o() {
        return this.f2421OooO00o.OooO0OO();
    }

    @Override // androidx.appcompat.app.ActionBar
    public final boolean OooO0O0() {
        o000OO0O o000oo0o2 = this.f2421OooO00o;
    ...
    public final void OooO0OO(boolean z) {
        if (z == this.f2425OooO0o) {
            return;
        }
        this.f2425OooO0o = z;
        ArrayList<ActionBar.OooO00o> arrayList = this.f2427OooO0oO;
    ...
    public final int OooO0Oo() {
        return this.f2421OooO00o.f3294OooO0O0;
    }

    @Override // androidx.appcompat.app.ActionBar
    public final boolean OooO0o() {
        o000OO0O o000oo0o2 = this.f2421OooO00o;
        Toolbar toolbar = o000oo0o2.f3293OooO00o;
        OooO00o oooO00o = this.f2428OooO0oo;
        toolbar.removeCallbacks(oooO00o);
        Toolbar toolbar2 = o000oo0o2.f3293OooO00o;
    ...
    public final Context OooO0o0() {
        return this.f2421OooO00o.getContext();
    }
    ...
    @Override // androidx.appcompat.app.ActionBar
    public final void OooO0oo() {
        this.f2421OooO00o.f3293OooO00o.removeCallbacks(this.f2428OooO0oo);
    }
    ...
    public final void OooOOO0(boolean z) {
        o000OO0O o000oo0o2 = this.f2421OooO00o;
        o000oo0o2.OooO((o000oo0o2.f3294OooO0O0 & (-5)) | 0);
    }

    @Override // androidx.appcompat.app.ActionBar
    public final void OooOOOO(CharSequence charSequence) {
        this.f2421OooO00o.setWindowTitle(charSequence);
    }

    public final Menu OooOOo0() {
        boolean z = this.f2426OooO0o0;
        o000OO0O o000oo0o2 = this.f2421OooO00o;
        if (!z) {
            OooO0OO oooO0OO = new OooO0OO();
            OooO0o oooO0o = new OooO0o();
            Toolbar toolbar = o000oo0o2.f3293OooO00o;
            toolbar.f3165OoooO00 = oooO0OO;
            toolbar.f3164OoooO0 = oooO0o;
            ActionMenuView actionMenuView = toolbar.f3125OooO0Oo;
            if (actionMenuView != null) {
                actionMenuView.f2772OooOo = oooO0OO;
                actionMenuView.f2778OooOoO0 = oooO0o;
            }
            this.f2426OooO0o0 = true;
        }
        return o000oo0o2.f3293OooO00o.getMenu();
    }
}
