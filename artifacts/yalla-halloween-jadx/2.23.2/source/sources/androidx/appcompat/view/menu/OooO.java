...
public class OooO implements o0000.OooO00o {
    ...
    public static final int[] f2568OooOoO0 = {1, 4, 5, 3, 2, 0};

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    public final ArrayList<OooOO0O> f2569OooO;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final Context f2570OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final Resources f2571OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public boolean f2572OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public boolean f2573OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final ArrayList<OooOO0O> f2574OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public OooO00o f2575OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final ArrayList<OooOO0O> f2576OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public boolean f2577OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public final ArrayList<OooOO0O> f2578OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public boolean f2579OooOO0O;

    /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
    public Drawable f2581OooOOO;

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    public CharSequence f2582OooOOO0;

    /* JADX INFO: renamed from: OooOOOO, reason: collision with root package name */
    public View f2583OooOOOO;

    /* JADX INFO: renamed from: OooOo, reason: collision with root package name */
    public boolean f2588OooOo;

    /* JADX INFO: renamed from: OooOo0O, reason: collision with root package name */
    public OooOO0O f2591OooOo0O;

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    public int f2580OooOO0o = 0;

    /* JADX INFO: renamed from: OooOOOo, reason: collision with root package name */
    public boolean f2584OooOOOo = false;

    /* JADX INFO: renamed from: OooOOo0, reason: collision with root package name */
    public boolean f2586OooOOo0 = false;

    /* JADX INFO: renamed from: OooOOo, reason: collision with root package name */
    public boolean f2585OooOOo = false;

    /* JADX INFO: renamed from: OooOOoo, reason: collision with root package name */
    public boolean f2587OooOOoo = false;

    /* JADX INFO: renamed from: OooOo00, reason: collision with root package name */
    public final ArrayList<OooOO0O> f2590OooOo00 = new ArrayList<>();

    /* JADX INFO: renamed from: OooOo0, reason: collision with root package name */
    public final CopyOnWriteArrayList<WeakReference<OooOOO>> f2589OooOo0 = new CopyOnWriteArrayList<>();

    /* JADX INFO: renamed from: OooOo0o, reason: collision with root package name */
    public boolean f2592OooOo0o = false;
    ...
    public OooO(Context context) {
        boolean zOooO0O0;
        boolean z = false;
        this.f2570OooO00o = context;
        Resources resources = context.getResources();
        this.f2571OooO0O0 = resources;
        this.f2574OooO0o = new ArrayList<>();
        this.f2576OooO0oO = new ArrayList<>();
        this.f2577OooO0oo = true;
        this.f2569OooO = new ArrayList<>();
        this.f2578OooOO0 = new ArrayList<>();
        this.f2579OooOO0O = true;
        if (resources.getConfiguration().keyboard != 1) {
            ViewConfiguration viewConfiguration = ViewConfiguration.get(context);
            Method method = o000O00.f5447OooO00o;
            if (Build.VERSION.SDK_INT >= 28) {
                zOooO0O0 = o000O00.OooO0O0.OooO0O0(viewConfiguration);
            } else {
    ...
    public final void OooO() {
        ...
        if (this.f2579OooOO0O) {
            CopyOnWriteArrayList<WeakReference<OooOOO>> copyOnWriteArrayList = this.f2589OooOo0;
            ...
            ArrayList<OooOO0O> arrayList = this.f2569OooO;
            ArrayList<OooOO0O> arrayList2 = this.f2578OooOO0;
            if (zOooOO0) {
                arrayList.clear();
                arrayList2.clear();
    ...
    public OooOO0O OooO00o(int i, int i2, int i3, CharSequence charSequence) {
        ...
        int i6 = (f2568OooOoO0[i5] << 16) | (65535 & i3);
        OooOO0O oooOO0O = new OooOO0O(this, i, i2, i3, i6, charSequence, this.f2580OooOO0o);
        ArrayList<OooOO0O> arrayList = this.f2574OooO0o;
        ...
        do {
            ...
            OooOOOo(true);
            return oooOO0O;
        } while (arrayList.get(size).f2628OooO0Oo > i6);
        i4 = size + 1;
        arrayList.add(i4, oooOO0O);
        OooOOOo(true);
        return oooOO0O;
    ...
    public final void OooO0O0(OooOOO oooOOO, Context context) {
        this.f2589OooOo0.add(new WeakReference<>(oooOOO));
        oooOOO.OooOO0O(context, this);
        this.f2579OooOO0O = true;
    }

    public final void OooO0OO(boolean z) {
        if (this.f2587OooOOoo) {
            return;
        }
        this.f2587OooOOoo = true;
        CopyOnWriteArrayList<WeakReference<OooOOO>> copyOnWriteArrayList = this.f2589OooOo0;
        for (WeakReference<OooOOO> weakReference : copyOnWriteArrayList) {
            OooOOO oooOOO = weakReference.get();
            if (oooOOO == null) {
        ...
        this.f2587OooOOoo = false;
    }

    public boolean OooO0Oo(OooOO0O oooOO0O) {
        CopyOnWriteArrayList<WeakReference<OooOOO>> copyOnWriteArrayList = this.f2589OooOo0;
        boolean zOooO0Oo = false;
        if (!copyOnWriteArrayList.isEmpty() && this.f2591OooOo0O == oooOO0O) {
            OooOoO0();
            for (WeakReference<OooOOO> weakReference : copyOnWriteArrayList) {
                OooOOO oooOOO = weakReference.get();
                if (oooOOO != null) {
    ...
    public final OooOO0O OooO0oO(int i, KeyEvent keyEvent) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            char c = zOooOOO ? oooOO0O.f2633OooOO0 : oooOO0O.f2632OooO0oo;
    ...
    public final void OooO0oo(ArrayList arrayList, int i, KeyEvent keyEvent) {
        ...
        if (keyEvent.getKeyData(keyData) || i == 67) {
            ArrayList<OooOO0O> arrayList2 = this.f2574OooO0o;
            int size = arrayList2.size();
            for (int i2 = 0; i2 < size; i2++) {
                OooOO0O oooOO0O = arrayList2.get(i2);
                if (oooOO0O.hasSubMenu()) {
                    oooOO0O.f2638OooOOOO.OooO0oo(arrayList, i, keyEvent);
                }
                char c = zOooOOO ? oooOO0O.f2633OooOO0 : oooOO0O.f2632OooO0oo;
                if (((modifiers & 69647) == ((zOooOOO ? oooOO0O.f2634OooOO0O : oooOO0O.f2624OooO) & 69647)) && c != 0) {
                    char[] cArr = keyData.meta;
    ...
    public final ArrayList<OooOO0O> OooOO0o() {
        boolean z = this.f2577OooO0oo;
        ArrayList<OooOO0O> arrayList = this.f2576OooO0oO;
        if (!z) {
            return arrayList;
        }
        arrayList.clear();
        ...
        this.f2577OooO0oo = false;
        this.f2579OooOO0O = true;
        return arrayList;
    }

    public boolean OooOOO() {
        return this.f2572OooO0OO;
    }

    public boolean OooOOO0() {
        return this.f2592OooOo0o;
    }

    public boolean OooOOOO() {
        return this.f2573OooO0Oo;
    }

    public void OooOOOo(boolean z) {
        if (this.f2584OooOOOo) {
            this.f2586OooOOo0 = true;
            if (z) {
                this.f2585OooOOo = true;
                return;
            }
            return;
        }
    ...
    public final boolean OooOOo0(MenuItem menuItem, OooOOO oooOOO, int i) {
        ...
        MenuItem.OnMenuItemClickListener onMenuItemClickListener = oooOO0O.f2639OooOOOo;
        if (onMenuItemClickListener == null || !onMenuItemClickListener.onMenuItemClick(oooOO0O)) {
            ...
            if (oooO.OooO0o0(oooO, oooOO0O)) {
                ...
                Intent intent = oooOO0O.f2631OooO0oO;
                if (intent != null) {
                    try {
                        oooO.f2570OooO00o.startActivity(intent);
                    } catch (ActivityNotFoundException e) {
                        Log.e("MenuItemImpl", "Can't find activity to handle intent; ignoring", e);
                        oooO0O0 = oooOO0O.f2650OooOoOO;
                        if (oooO0O0 == null) {
                        }
                        zExpandActionView = false;
                        oooO0O1 = oooOO0O.f2650OooOoOO;
                        if (oooO0O1 == null) {
                            z = false;
                        } else {
                            z = false;
                        ...
                        if (oooOO0O.OooO0o0()) {
                            ...
                            if (!oooOO0O.hasSubMenu()) {
                                OooOo oooOo2 = new OooOo(this.f2570OooO00o, this, oooOO0O);
                                oooOO0O.f2638OooOOOO = oooOo2;
                                oooOo2.setHeaderTitle(oooOO0O.f2630OooO0o0);
                            }
                            oooOo = oooOO0O.f2638OooOOOO;
                            if (z) {
                                oooO0O1.OooO0o(oooOo);
                            }
                            copyOnWriteArrayList = this.f2589OooOo0;
                            if (!copyOnWriteArrayList.isEmpty()) {
                                if (oooOOO != null) {
                                }
                                for (WeakReference<OooOOO> weakReference : copyOnWriteArrayList) {
                            ...
                            if (!oooOO0O.hasSubMenu()) {
                                OooOo oooOo3 = new OooOo(this.f2570OooO00o, this, oooOO0O);
                                oooOO0O.f2638OooOOOO = oooOo3;
                                oooOo3.setHeaderTitle(oooOO0O.f2630OooO0o0);
                            }
                            oooOo = oooOO0O.f2638OooOOOO;
                            if (z) {
                                oooO0O1.OooO0o(oooOo);
        ...
        if (oooOO0O.OooO0o0()) {
            ...
            if (!oooOO0O.hasSubMenu()) {
                OooOo oooOo4 = new OooOo(this.f2570OooO00o, this, oooOO0O);
                oooOO0O.f2638OooOOOO = oooOo4;
                oooOo4.setHeaderTitle(oooOO0O.f2630OooO0o0);
            }
            oooOo = oooOO0O.f2638OooOOOO;
            if (z) {
                oooO0O1.OooO0o(oooOo);
    ...
    public final void OooOo() {
        this.f2584OooOOOo = false;
        if (this.f2586OooOOo0) {
            this.f2586OooOOo0 = false;
            OooOOOo(this.f2585OooOOo);
        }
    }
    ...
    public final void OooOo0o(int i, CharSequence charSequence, int i2, Drawable drawable, View view) {
        if (view != null) {
            this.f2583OooOOOO = view;
            this.f2582OooOOO0 = null;
            this.f2581OooOOO = null;
        } else {
            if (i > 0) {
                this.f2582OooOOO0 = this.f2571OooO0O0.getText(i);
            } else if (charSequence != null) {
                this.f2582OooOOO0 = charSequence;
            }
            if (i2 > 0) {
                Object obj = ContextCompat.f5281OooO00o;
                this.f2581OooOOO = ContextCompat.OooO0OO.OooO0O0(this.f2570OooO00o, i2);
            } else if (drawable != null) {
                this.f2581OooOOO = drawable;
            }
            this.f2583OooOOOO = null;
        }
        OooOOOo(false);
    }
    ...
    public final void OooOoO0() {
        ...
        this.f2584OooOOOo = true;
        this.f2586OooOOo0 = false;
        this.f2585OooOOo = false;
    }
    ...
    public final int addIntentOptions(int i, int i2, int i3, ComponentName componentName, Intent[] intentArr, Intent intent, int i4, MenuItem[] menuItemArr) {
        int i5;
        PackageManager packageManager = this.f2570OooO00o.getPackageManager();
        ...
        for (int i6 = 0; i6 < size; i6++) {
            ...
            oooOO0OOooO00o.f2631OooO0oO = intent2;
    ...
    public final void clear() {
        OooOO0O oooOO0O = this.f2591OooOo0O;
        if (oooOO0O != null) {
            OooO0Oo(oooOO0O);
        }
        this.f2574OooO0o.clear();
        OooOOOo(true);
    }
    ...
    public final MenuItem findItem(int i) {
        ...
        int size = size();
        for (int i2 = 0; i2 < size; i2++) {
            OooOO0O oooOO0O = this.f2574OooO0o.get(i2);
            if (oooOO0O.f2625OooO00o == i) {
                return oooOO0O;
            }
            if (oooOO0O.hasSubMenu() && (menuItemFindItem = oooOO0O.f2638OooOOOO.findItem(i)) != null) {
    ...
    public final boolean hasVisibleItems() {
        ...
        int size = size();
        for (int i = 0; i < size; i++) {
            if (this.f2574OooO0o.get(i).isVisible()) {
                return true;
            }
        }
        return false;
    ...
    public final void removeGroup(int i) {
        ...
        int i3 = 0;
        while (true) {
            arrayList = this.f2574OooO0o;
            if (i3 >= size) {
                i3 = -1;
                break;
            } else if (arrayList.get(i3).f2626OooO0O0 == i) {
                break;
            } else {
                i3++;
            }
        ...
        if (i3 >= 0) {
            ...
            while (true) {
                int i4 = i2 + 1;
                if (i2 >= size2 || arrayList.get(i3).f2626OooO0O0 != i) {
                    break;
                }
    ...
    public final void removeItem(int i) {
        ...
        while (true) {
            ...
            if (i2 >= size) {
                i2 = -1;
                break;
            } else if (arrayList.get(i2).f2625OooO00o == i) {
                break;
            } else {
                i2++;
            }
    ...
    public final void setGroupVisible(int i, boolean z) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            OooOO0O oooOO0O = arrayList.get(i2);
            if (oooOO0O.f2626OooO0O0 == i) {
                int i3 = oooOO0O.f2643OooOo;
                int i4 = (i3 & (-9)) | (z ? 0 : 8);
                oooOO0O.f2643OooOo = i4;
                if (i3 != i4) {
                    z2 = true;
                }
            }
    ...
    public final int size() {
        return this.f2574OooO0o.size();
    }

    @Override // android.view.Menu
    public final MenuItem add(int i) {
        return OooO00o(0, 0, 0, this.f2571OooO0O0.getString(i));
    }

    @Override // android.view.Menu
    public final SubMenu addSubMenu(int i) {
        return addSubMenu(0, 0, 0, this.f2571OooO0O0.getString(i));
    }
    ...
    public SubMenu addSubMenu(int i, int i2, int i3, CharSequence charSequence) {
        ...
        OooOo oooOo = new OooOo(this.f2570OooO00o, this, oooOO0OOooO00o);
        oooOO0OOooO00o.f2638OooOOOO = oooOo;
        oooOo.setHeaderTitle(oooOO0OOooO00o.f2630OooO0o0);
        return oooOo;
    }

    @Override // android.view.Menu
    public final MenuItem add(int i, int i2, int i3, int i4) {
        return OooO00o(i, i2, i3, this.f2571OooO0O0.getString(i4));
    }

    @Override // android.view.Menu
    public final SubMenu addSubMenu(int i, int i2, int i3, int i4) {
        return addSubMenu(i, i2, i3, this.f2571OooO0O0.getString(i4));
    }
}
