...
public class AppCompatCheckBox extends CheckBox implements androidx.core.widget.OooOo, androidx.core.widget.Oooo000 {
    ...
    public final OooOO0O f2815OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final o00Oo0 f2816OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final OooO f2817OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public OooOOOO f2818OooO0oO;
    ...
    private OooOOOO getEmojiTextViewHelper() {
        if (this.f2818OooO0oO == null) {
            this.f2818OooO0oO = new OooOOOO(this);
        }
        return this.f2818OooO0oO;
    }

    @Override // android.widget.CompoundButton, android.widget.TextView, android.view.View
    public void drawableStateChanged() {
        super.drawableStateChanged();
        OooO oooO = this.f2817OooO0o0;
        if (oooO != null) {
            oooO.OooO00o();
        }
        o00Oo0 o00oo1 = this.f2816OooO0o;
        if (o00oo1 != null) {
            o00oo1.OooO0O0();
        }
    }
    ...
    public int getCompoundPaddingLeft() {
        ...
        OooOO0O oooOO0O = this.f2815OooO0Oo;
        if (oooOO0O != null) {
            oooOO0O.getClass();
        }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f2816OooO0o.OooO0Oo();
    }

    @Nullable
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f2816OooO0o.OooO0o0();
    }
