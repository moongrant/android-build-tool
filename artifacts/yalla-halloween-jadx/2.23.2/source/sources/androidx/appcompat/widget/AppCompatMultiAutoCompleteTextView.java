...
public class AppCompatMultiAutoCompleteTextView extends MultiAutoCompleteTextView implements androidx.core.widget.Oooo000 {

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public static final int[] f2833OooO0oO = {R.attr.popupBackground};

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final OooO f2834OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @NonNull
    public final OooOOO f2835OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final o00Oo0 f2836OooO0o0;
    ...
    public final void drawableStateChanged() {
        ...
        OooO oooO = this.f2834OooO0Oo;
        if (oooO != null) {
            oooO.OooO00o();
        }
        o00Oo0 o00oo1 = this.f2836OooO0o0;
        if (o00oo1 != null) {
            o00oo1.OooO0O0();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f2836OooO0o0.OooO0Oo();
    }

    @Nullable
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f2836OooO0o0.OooO0o0();
    }
    ...
    public final InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        ...
        return this.f2835OooO0o.OooO0OO(inputConnectionOnCreateInputConnection, editorInfo);
    }
    ...
    public void setEmojiCompatEnabled(boolean z) {
        this.f2835OooO0o.OooO0Oo(z);
    }

    @Override // android.widget.TextView
    public void setKeyListener(@Nullable KeyListener keyListener) {
        super.setKeyListener(this.f2835OooO0o.OooO00o(keyListener));
    }
    ...
    public AppCompatMultiAutoCompleteTextView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        o000Oo0 o000oo0OooOOO0 = o000Oo0.OooOOO0(getContext(), attributeSet, f2833OooO0oO, i);
