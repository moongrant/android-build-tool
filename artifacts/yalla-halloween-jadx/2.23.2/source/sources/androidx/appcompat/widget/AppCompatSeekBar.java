...
public class AppCompatSeekBar extends SeekBar {
    ...
    public final o000oOoO f2842OooO0Oo;
    ...
    public final void drawableStateChanged() {
        ...
        o000oOoO o000oooo2 = this.f2842OooO0Oo;
        Drawable drawable = o000oooo2.f3329OooO0o0;
        if (drawable == null || !drawable.isStateful()) {
            return;
        }
        SeekBar seekBar = o000oooo2.f3327OooO0Oo;
    ...
    public final void jumpDrawablesToCurrentState() {
        ...
        Drawable drawable = this.f2842OooO0Oo.f3329OooO0o0;
        if (drawable != null) {
    ...
    public final synchronized void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        this.f2842OooO0Oo.OooO0Oo(canvas);
    }
