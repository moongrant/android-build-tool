...
public class AppCompatSpinner extends Spinner {
    ...
    @StyleableRes
    public static final int[] f2843OooOO0o = {R.attr.spinnerMode};

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    public final OooOOO0 f2844OooO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final androidx.appcompat.widget.OooO f2845OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final o0OoOo0 f2846OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final Context f2847OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public SpinnerAdapter f2848OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final boolean f2849OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public int f2850OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public final Rect f2851OooOO0O;
    ...
    public class OooO implements OooOOO0, DialogInterface.OnClickListener {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        @VisibleForTesting
        public androidx.appcompat.app.OooO0O0 f2852OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public CharSequence f2853OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public ListAdapter f2854OooO0o0;
        ...
        public final boolean OooO00o() {
            androidx.appcompat.app.OooO0O0 oooO0O0 = this.f2852OooO0Oo;
            if (oooO0O0 != null) {
        ...
        public final CharSequence OooO0o0() {
            return this.f2853OooO0o;
        }

        @Override // androidx.appcompat.widget.AppCompatSpinner.OooOOO0
        public final void OooO0oO(CharSequence charSequence) {
            this.f2853OooO0o = charSequence;
        }
        ...
        public final void OooOO0(int i, int i2) {
            ...
            CharSequence charSequence = this.f2853OooO0o;
            if (charSequence != null) {
                oooO00o.setTitle(charSequence);
            }
            ListAdapter listAdapter = this.f2854OooO0o0;
            int selectedItemPosition = appCompatSpinner.getSelectedItemPosition();
            AlertController.OooO0O0 oooO0O0 = oooO00o.f2392OooO00o;
            oooO0O0.f2277OooOO0O = listAdapter;
            oooO0O0.f2278OooOO0o = this;
            oooO0O0.f2281OooOOOO = selectedItemPosition;
            oooO0O0.f2279OooOOO = true;
            androidx.appcompat.app.OooO0O0 oooO0O0Create = oooO00o.create();
            this.f2852OooO0Oo = oooO0O0Create;
            AlertController.RecycleListView recycleListView = oooO0O0Create.f2391OooO0o.f2234OooO0o;
            OooO0OO.OooO0Oo(recycleListView, i);
            OooO0OO.OooO0OO(recycleListView, i2);
            this.f2852OooO0Oo.show();
        }
        ...
        public final void onClick(DialogInterface dialogInterface, int i) {
            ...
            if (appCompatSpinner.getOnItemClickListener() != null) {
                appCompatSpinner.performItemClick(null, i, this.f2854OooO0o0.getItemId(i));
            }
            dismiss();
        }
    }
    ...
    public class OooO00o implements ViewTreeObserver.OnGlobalLayoutListener {
        ...
        public final void onGlobalLayout() {
            ...
            if (!appCompatSpinner.getInternalPopup().OooO00o()) {
                appCompatSpinner.f2844OooO.OooOO0(OooO0OO.OooO0O0(appCompatSpinner), OooO0OO.OooO00o(appCompatSpinner));
            }
    ...
    public static class OooOO0 implements ListAdapter, SpinnerAdapter {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final SpinnerAdapter f2857OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final ListAdapter f2858OooO0o0;

        public OooOO0(@Nullable SpinnerAdapter spinnerAdapter, @Nullable Resources.Theme theme) {
            this.f2857OooO0Oo = spinnerAdapter;
            if (spinnerAdapter instanceof ListAdapter) {
                this.f2858OooO0o0 = (ListAdapter) spinnerAdapter;
            }
            if (theme != null) {
        ...
        public final boolean areAllItemsEnabled() {
            ListAdapter listAdapter = this.f2858OooO0o0;
            if (listAdapter != null) {
        ...
        public final int getCount() {
            SpinnerAdapter spinnerAdapter = this.f2857OooO0Oo;
    ...
    public class OooOO0O extends ListPopupWindow implements OooOOO0 {
        ...
        public final Rect f2859Oooo0;

        /* JADX INFO: renamed from: Oooo00O, reason: collision with root package name */
        public CharSequence f2860Oooo00O;

        /* JADX INFO: renamed from: Oooo00o, reason: collision with root package name */
        public ListAdapter f2861Oooo00o;

        /* JADX INFO: renamed from: Oooo0O0, reason: collision with root package name */
        public int f2862Oooo0O0;
        ...
        public class OooO00o implements AdapterView.OnItemClickListener {
            ...
            public final void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                ...
                if (AppCompatSpinner.this.getOnItemClickListener() != null) {
                    AppCompatSpinner.this.performItemClick(view, i, oooOO0O.f2861Oooo00o.getItemId(i));
                }
                oooOO0O.dismiss();
            }
        }
        ...
        public class OooO0O0 implements ViewTreeObserver.OnGlobalLayoutListener {
            ...
            public final void onGlobalLayout() {
                ...
                if (!(ViewCompat.OooOO0O.OooO0O0(appCompatSpinner) && appCompatSpinner.getGlobalVisibleRect(oooOO0O.f2859Oooo0))) {
                    oooOO0O.dismiss();
                } else {
                    oooOO0O.OooOOo();
                    oooOO0O.show();
        ...
        public class OooO0OO implements PopupWindow.OnDismissListener {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ ViewTreeObserver.OnGlobalLayoutListener f2866OooO0Oo;

            public OooO0OO(OooO0O0 oooO0O0) {
                this.f2866OooO0Oo = oooO0O0;
            }
            ...
            public final void onDismiss() {
                ...
                if (viewTreeObserver != null) {
                    viewTreeObserver.removeGlobalOnLayoutListener(this.f2866OooO0Oo);
                }
            }
        }
        ...
        public OooOO0O(Context context, AttributeSet attributeSet, int i) {
            ...
            this.f2859Oooo0 = new Rect();
            this.f2923OooOOo = AppCompatSpinner.this;
            this.f2935OooOoo0 = true;
            this.f2934OooOoo.setFocusable(true);
            this.f2925OooOOoo = new OooO00o();
        }
        ...
        @Override // androidx.appcompat.widget.AppCompatSpinner.OooOOO0
        public final CharSequence OooO0o0() {
            return this.f2860Oooo00O;
        }

        @Override // androidx.appcompat.widget.AppCompatSpinner.OooOOO0
        public final void OooO0oO(CharSequence charSequence) {
            this.f2860Oooo00O = charSequence;
        }
        ...
        public final void OooOOo() {
            ...
            if (drawableOooO0o != null) {
                drawableOooO0o.getPadding(appCompatSpinner.f2851OooOO0O);
                i = o0O0ooO.OooO00o(appCompatSpinner) ? appCompatSpinner.f2851OooOO0O.right : -appCompatSpinner.f2851OooOO0O.left;
            } else {
                Rect rect = appCompatSpinner.f2851OooOO0O;
                rect.right = 0;
                rect.left = 0;
                i = 0;
            }
            ...
            int i2 = appCompatSpinner.f2850OooOO0;
            if (i2 == -2) {
                int iOooO00o = appCompatSpinner.OooO00o((SpinnerAdapter) this.f2861Oooo00o, OooO0o());
                int i3 = appCompatSpinner.getContext().getResources().getDisplayMetrics().widthPixels;
                Rect rect2 = appCompatSpinner.f2851OooOO0O;
            ...
            this.f2910OooO = o0O0ooO.OooO00o(appCompatSpinner) ? (((width - paddingRight) - this.f2915OooO0oo) - this.f2862Oooo0O0) + i : paddingLeft + this.f2862Oooo0O0 + i;
        }
    }
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public SavedState(Parcel parcel) {
            super(parcel);
            this.f2868OooO0Oo = parcel.readByte() != 0;
        }

        @Override // android.view.View.BaseSavedState, android.view.AbsSavedState, android.os.Parcelable
        public final void writeToParcel(Parcel parcel, int i) {
            super.writeToParcel(parcel, i);
            parcel.writeByte(this.f2868OooO0Oo ? (byte) 1 : (byte) 0);
        }
    }
    ...
    public final void drawableStateChanged() {
        ...
        androidx.appcompat.widget.OooO oooO = this.f2845OooO0Oo;
        if (oooO != null) {
            oooO.OooO00o();
        }
    }
    ...
    public int getDropDownHorizontalOffset() {
        OooOOO0 oooOOO0 = this.f2844OooO;
    ...
    public int getDropDownWidth() {
        return this.f2844OooO != null ? this.f2850OooOO0 : super.getDropDownWidth();
    }

    @VisibleForTesting
    public final OooOOO0 getInternalPopup() {
        return this.f2844OooO;
    }
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if (this.f2844OooO == null || View.MeasureSpec.getMode(i) != Integer.MIN_VALUE) {
            return;
        }
    ...
    public final void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (!savedState.f2868OooO0Oo || (viewTreeObserver = getViewTreeObserver()) == null) {
            return;
        }
    ...
    public final Parcelable onSaveInstanceState() {
        ...
        OooOOO0 oooOOO0 = this.f2844OooO;
        savedState.f2868OooO0Oo = oooOOO0 != null && oooOOO0.OooO00o();
        return savedState;
    }

    @Override // android.widget.Spinner, android.view.View
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        o0OoOo0 o0oooo1 = this.f2846OooO0o;
        if (o0oooo1 == null || !o0oooo1.onTouch(this, motionEvent)) {
    ...
    public void setAdapter(SpinnerAdapter spinnerAdapter) {
        if (!this.f2849OooO0oo) {
            this.f2848OooO0oO = spinnerAdapter;
            return;
        }
        super.setAdapter(spinnerAdapter);
        OooOOO0 oooOOO0 = this.f2844OooO;
        if (oooOOO0 != null) {
            Context context = this.f2847OooO0o0;
            if (context == null) {
                context = getContext();
            }
    ...
    public AppCompatSpinner(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) throws Throwable {
        ...
        this.f2845OooO0Oo = new androidx.appcompat.widget.OooO(this);
        int resourceId = typedArrayObtainStyledAttributes2.getResourceId(p012OooOo0O.o00O0O.Spinner_popupTheme, 0);
        if (resourceId != 0) {
            this.f2847OooO0o0 = new p016OooOoOO.o00Oo0(context, resourceId);
        } else {
            this.f2847OooO0o0 = context;
        }
        ?? r2 = -1;
        ?? r3 = 0;
        try {
            if (i2 == -1) {
                try {
                    typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, f2843OooOO0o, i, 0);
                    try {
                        ...
                        if (i2 != 0) {
                            OooO oooO = new OooO();
                            this.f2844OooO = oooO;
                            oooO.f2853OooO0o = typedArrayObtainStyledAttributes2.getString(p012OooOo0O.o00O0O.Spinner_android_prompt);
                        } else if (i2 == 1) {
                            OooOO0O oooOO0O = new OooOO0O(this.f2847OooO0o0, attributeSet, i);
                            o000Oo0 o000oo0OooOOO0 = o000Oo0.OooOOO0(this.f2847OooO0o0, attributeSet, p012OooOo0O.o00O0O.Spinner, i);
                            this.f2850OooOO0 = o000oo0OooOOO0.f3324OooO0O0.getLayoutDimension(p012OooOo0O.o00O0O.Spinner_android_dropDownWidth, -2);
                            oooOO0O.OooOOOO(o000oo0OooOOO0.OooO0o0(p012OooOo0O.o00O0O.Spinner_android_popupBackground));
                            oooOO0O.f2860Oooo00O = typedArrayObtainStyledAttributes2.getString(p012OooOo0O.o00O0O.Spinner_android_prompt);
                            o000oo0OooOOO0.OooOOO();
                            this.f2844OooO = oooOO0O;
                            this.f2846OooO0o = new o0OoOo0(this, this, oooOO0O);
                        }
                        ...
                        this.f2849OooO0oo = true;
                        spinnerAdapter = this.f2848OooO0oO;
                        if (spinnerAdapter != null) {
                            setAdapter(spinnerAdapter);
                            this.f2848OooO0oO = null;
                        }
                        this.f2845OooO0Oo.OooO0Oo(attributeSet, i);
                    }
                } catch (Exception e2) {
                    e = e2;
            ...
            if (i2 != 0) {
                OooO oooO2 = new OooO();
                this.f2844OooO = oooO2;
                oooO2.f2853OooO0o = typedArrayObtainStyledAttributes2.getString(p012OooOo0O.o00O0O.Spinner_android_prompt);
            } else if (i2 == 1) {
                OooOO0O oooOO0O2 = new OooOO0O(this.f2847OooO0o0, attributeSet, i);
                o000Oo0 o000oo0OooOOO1 = o000Oo0.OooOOO0(this.f2847OooO0o0, attributeSet, p012OooOo0O.o00O0O.Spinner, i);
                this.f2850OooOO0 = o000oo0OooOOO1.f3324OooO0O0.getLayoutDimension(p012OooOo0O.o00O0O.Spinner_android_dropDownWidth, -2);
                oooOO0O2.OooOOOO(o000oo0OooOOO1.OooO0o0(p012OooOo0O.o00O0O.Spinner_android_popupBackground));
                oooOO0O2.f2860Oooo00O = typedArrayObtainStyledAttributes2.getString(p012OooOo0O.o00O0O.Spinner_android_prompt);
                o000oo0OooOOO1.OooOOO();
                this.f2844OooO = oooOO0O2;
                this.f2846OooO0o = new o0OoOo0(this, this, oooOO0O2);
            }
            textArray = typedArrayObtainStyledAttributes2.getTextArray(p012OooOo0O.o00O0O.Spinner_android_entries);
            if (textArray != null) {
