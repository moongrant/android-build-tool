...
public class AppCompatTextView extends TextView implements androidx.core.widget.Oooo000 {
    ...
    @Nullable
    public OooO0O0 f2869OooO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final OooO f2870OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final o00O0O f2871OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final o00Oo0 f2872OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    @NonNull
    public OooOOOO f2873OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public boolean f2874OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    @Nullable
    public Future<o0000O0O.o00O0O> f2875OooOO0;
    ...
    private OooOOOO getEmojiTextViewHelper() {
        if (this.f2873OooO0oO == null) {
            this.f2873OooO0oO = new OooOOOO(this);
        }
        return this.f2873OooO0oO;
    }

    @Override // android.widget.TextView, android.view.View
    public final void drawableStateChanged() {
        super.drawableStateChanged();
        OooO oooO = this.f2870OooO0Oo;
        if (oooO != null) {
            oooO.OooO00o();
        }
        o00Oo0 o00oo1 = this.f2872OooO0o0;
        if (o00oo1 != null) {
            o00oo1.OooO0O0();
        }
    }
    ...
    public int getAutoSizeMaxTextSize() {
        if (o0O0ooO.f3356OooO0O0) {
            return super.getAutoSizeMaxTextSize();
        }
        o00Oo0 o00oo1 = this.f2872OooO0o0;
        if (o00oo1 != null) {
            return Math.round(o00oo1.f3335OooO.f3367OooO0o0);
        }
        return -1;
    }
    ...
    public int getAutoSizeMinTextSize() {
        ...
        o00Oo0 o00oo1 = this.f2872OooO0o0;
        if (o00oo1 != null) {
            return Math.round(o00oo1.f3335OooO.f3365OooO0Oo);
        }
        return -1;
    }
    ...
    public int getAutoSizeStepGranularity() {
        ...
        o00Oo0 o00oo1 = this.f2872OooO0o0;
        if (o00oo1 != null) {
            return Math.round(o00oo1.f3335OooO.f3364OooO0OO);
        }
        return -1;
    }
    ...
    public int[] getAutoSizeTextAvailableSizes() {
        ...
        o00Oo0 o00oo1 = this.f2872OooO0o0;
        return o00oo1 != null ? o00oo1.f3335OooO.f3366OooO0o : new int[0];
    }
    ...
    public int getAutoSizeTextType() {
        ...
        o00Oo0 o00oo1 = this.f2872OooO0o0;
        if (o00oo1 != null) {
            return o00oo1.f3335OooO.f3362OooO00o;
        }
        return 0;
    }
    ...
    public OooO00o getSuperCaller() {
        if (this.f2869OooO == null) {
            int i = Build.VERSION.SDK_INT;
            if (i >= 28) {
                this.f2869OooO = new OooO0OO();
            } else if (i >= 26) {
                this.f2869OooO = new OooO0O0();
            }
        }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f2872OooO0o0.OooO0Oo();
    }

    @Nullable
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f2872OooO0o0.OooO0o0();
    }

    @Override // android.widget.TextView
    public CharSequence getText() {
        Future<o0000O0O.o00O0O> future = this.f2875OooOO0;
        if (future != null) {
            try {
                this.f2875OooOO0 = null;
    ...
    public TextClassifier getTextClassifier() {
        o00O0O o00o0o2;
        if (Build.VERSION.SDK_INT >= 28 || (o00o0o2 = this.f2871OooO0o) == null) {
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        o00Oo0 o00oo1 = this.f2872OooO0o0;
        if (o00oo1 == null || o0O0ooO.f3356OooO0O0) {
            return;
        }
        o00oo1.f3335OooO.OooO00o();
    }
    ...
    public final void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        ...
        o00Oo0 o00oo1 = this.f2872OooO0o0;
        if (o00oo1 != null && !o0O0ooO.f3356OooO0O0) {
            oo000o oo000oVar = o00oo1.f3335OooO;
            if (oo000oVar.OooO() && oo000oVar.f3362OooO00o != 0) {
                z = true;
            }
        }
        if (z) {
    ...
    public void setTextMetricsParamsCompat(@NonNull o0000O0O.o00O0O.OooO00o oooO00o) {
        int i;
        TextDirectionHeuristic textDirectionHeuristic = oooO00o.f33591OooO0O0;
        ...
        getPaint().set(oooO00o.f33590OooO00o);
        TextViewCompat.OooO0OO.OooO0o0(this, oooO00o.f33592OooO0OO);
        TextViewCompat.OooO0OO.OooO0oo(this, oooO00o.f33593OooO0Oo);
    }

    @Override // android.widget.TextView
    public final void setTextSize(int i, float f) {
        boolean z = o0O0ooO.f3356OooO0O0;
        if (z) {
    ...
    public final void setTypeface(@Nullable Typeface typeface, int i) {
        ...
        if (typeface == null || i <= 0) {
            ...
            p052o00000oO.o00O0O o00o0o2 = p052o00000oO.OooOOOO.f33484OooO00o;
            if (context == null) {
                throw new IllegalArgumentException("Context cannot be null");
            }
            typefaceCreate = Typeface.create(typeface, i);
        }
        this.f2874OooO0oo = true;
