...
public final class OooO {
    ...
    @NonNull
    public final View f2947OooO00o;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public o000O000 f2950OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public o000O000 f2951OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public o000O000 f2952OooO0o0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public int f2949OooO0OO = -1;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final OooOOO0 f2948OooO0O0 = OooOOO0.OooO00o();

    public OooO(@NonNull View view) {
        this.f2947OooO00o = view;
    }

    public final void OooO(PorterDuff.Mode mode) {
        if (this.f2952OooO0o0 == null) {
            this.f2952OooO0o0 = new o000O000();
        }
        o000O000 o000o001 = this.f2952OooO0o0;
        o000o001.f3265OooO0O0 = mode;
        o000o001.f3266OooO0OO = true;
        OooO00o();
    }

    public final void OooO00o() {
        View view = this.f2947OooO00o;
        Drawable background = view.getBackground();
        if (background != null) {
            boolean z = false;
            if (this.f2950OooO0Oo != null) {
                if (this.f2951OooO0o == null) {
                    this.f2951OooO0o = new o000O000();
                }
                o000O000 o000o001 = this.f2951OooO0o;
                o000o001.f3264OooO00o = null;
                o000o001.f3267OooO0Oo = false;
                o000o001.f3265OooO0O0 = null;
                o000o001.f3266OooO0OO = false;
                ...
                if (colorStateListOooO0oO != null) {
                    ...
                    o000o001.f3264OooO00o = colorStateListOooO0oO;
                }
                PorterDuff.Mode modeOooO0oo = ViewCompat.OooOOO.OooO0oo(view);
                if (modeOooO0oo != null) {
                    o000o001.f3266OooO0OO = true;
                    o000o001.f3265OooO0O0 = modeOooO0oo;
                }
                if (o000o001.f3267OooO0Oo || o000o001.f3266OooO0OO) {
            ...
            o000O000 o000o002 = this.f2952OooO0o0;
            if (o000o002 != null) {
                OooOOO0.OooO0o0(background, o000o002, view.getDrawableState());
                return;
            }
            o000O000 o000o003 = this.f2950OooO0Oo;
            if (o000o003 != null) {
    ...
    public final void OooO0Oo(@Nullable AttributeSet attributeSet, int i) {
        ...
        View view2 = this.f2947OooO00o;
        ViewCompat.OooOOO(view2, view2.getContext(), iArr, attributeSet, o000oo0OooOOO0.f3324OooO0O0, i, 0);
        try {
            int i2 = p012OooOo0O.o00O0O.ViewBackgroundHelper_android_background;
            if (o000oo0OooOOO0.OooOO0o(i2)) {
                this.f2949OooO0OO = o000oo0OooOOO0.OooO(i2, -1);
                OooOOO0 oooOOO0 = this.f2948OooO0O0;
                Context context2 = view.getContext();
                int i3 = this.f2949OooO0OO;
                synchronized (oooOOO0) {
                    colorStateListOooO = oooOOO0.f2981OooO00o.OooO(i3, context2);
                }
    ...
    public final void OooO0o(int i) {
        ...
        OooOOO0 oooOOO0 = this.f2948OooO0O0;
        if (oooOOO0 != null) {
            Context context = this.f2947OooO00o.getContext();
            synchronized (oooOOO0) {
    ...
    public final void OooO0oO(ColorStateList colorStateList) {
        if (colorStateList != null) {
            if (this.f2950OooO0Oo == null) {
                this.f2950OooO0Oo = new o000O000();
            }
            o000O000 o000o001 = this.f2950OooO0Oo;
            o000o001.f3264OooO00o = colorStateList;
            o000o001.f3267OooO0Oo = true;
        } else {
            this.f2950OooO0Oo = null;
        }
        OooO00o();
    }
