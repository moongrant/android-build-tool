...
public class Oooo000 {
    ...
    public static final int[] f2993OooO0OO = {R.attr.indeterminateDrawable, R.attr.progressDrawable};

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final ProgressBar f2994OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public Bitmap f2995OooO0O0;

    public Oooo000(ProgressBar progressBar) {
        this.f2994OooO00o = progressBar;
    }

    public void OooO00o(AttributeSet attributeSet, int i) {
        ProgressBar progressBar = this.f2994OooO00o;
        o000Oo0 o000oo0OooOOO0 = o000Oo0.OooOOO0(progressBar.getContext(), attributeSet, f2993OooO0OO, i);
    ...
    public final Drawable OooO0O0(Drawable drawable, boolean z) {
        if (drawable instanceof p053o00000oo.oo000o) {
            ...
            if (drawable instanceof BitmapDrawable) {
                ...
                if (this.f2995OooO0O0 == null) {
                    this.f2995OooO0O0 = bitmap;
                }
