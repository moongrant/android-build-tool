...
public final class o000000 {
    ...
    public static final int[] f3192OooO00o = {R.attr.state_checked};

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final int[] f3193OooO0O0 = new int[0];

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final Rect f3194OooO0OO = new Rect();

    @RequiresApi(18)
    public static class OooO00o {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public static final boolean f3195OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public static final Method f3196OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public static final Field f3197OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final Field f3198OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public static final Field f3199OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public static final Field f3200OooO0o0;
    ...
    public static void OooO00o(@NonNull Drawable drawable) {
        ...
        if (state == null || state.length == 0) {
            drawable.setState(f3192OooO00o);
        } else {
            drawable.setState(f3193OooO0O0);
        }
    ...
    public static Rect OooO0O0(@NonNull Drawable drawable) {
        ...
        if (i >= 29) {
            boolean z = OooO00o.f3195OooO00o;
        } else if (OooO00o.f3195OooO00o) {
            try {
                Object objInvoke = OooO00o.f3196OooO0O0.invoke(drawableOooO0Oo, new Object[0]);
                if (objInvoke != null) {
                    return new Rect(OooO00o.f3197OooO0OO.getInt(objInvoke), OooO00o.f3198OooO0Oo.getInt(objInvoke), OooO00o.f3200OooO0o0.getInt(objInvoke), OooO00o.f3199OooO0o.getInt(objInvoke));
                }
