...
public final class o0000O {
    ...
    public static final ThreadLocal<TypedValue> f3232OooO00o = new ThreadLocal<>();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final int[] f3233OooO0O0 = {-16842910};

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final int[] f3234OooO0OO = {R.attr.state_focused};

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public static final int[] f3235OooO0Oo = {R.attr.state_pressed};

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public static final int[] f3237OooO0o0 = {R.attr.state_checked};

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public static final int[] f3236OooO0o = new int[0];

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public static final int[] f3238OooO0oO = new int[1];
    ...
    public static int OooO0O0(int i, @NonNull Context context) {
        ...
        if (colorStateListOooO0Oo != null && colorStateListOooO0Oo.isStateful()) {
            return colorStateListOooO0Oo.getColorForState(f3233OooO0O0, colorStateListOooO0Oo.getDefaultColor());
        }
        ThreadLocal<TypedValue> threadLocal = f3232OooO00o;
