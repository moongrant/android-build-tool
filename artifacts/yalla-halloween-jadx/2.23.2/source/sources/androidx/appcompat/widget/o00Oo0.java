...
public final class o00Oo0 {
    ...
    @NonNull
    public final oo000o f3335OooO;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    @NonNull
    public final TextView f3336OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public o000O000 f3337OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public o000O000 f3338OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public o000O000 f3339OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public o000O000 f3340OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public o000O000 f3341OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public o000O000 f3342OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public o000O000 f3343OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public int f3344OooOO0 = 0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public int f3345OooOO0O = -1;

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    public Typeface f3346OooOO0o;

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    public boolean f3347OooOOO0;
    ...
    public class OooO00o extends androidx.core.content.res.OooO00o.OooO {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final /* synthetic */ int f3348OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final /* synthetic */ int f3349OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final /* synthetic */ WeakReference f3350OooO0OO;

        public OooO00o(int i, int i2, WeakReference weakReference) {
            this.f3348OooO00o = i;
            this.f3349OooO0O0 = i2;
            this.f3350OooO0OO = weakReference;
        }
        ...
        public final void OooO0Oo(@NonNull Typeface typeface) {
            int i;
            if (Build.VERSION.SDK_INT >= 28 && (i = this.f3348OooO00o) != -1) {
                typeface = OooOO0.OooO00o(typeface, i, (this.f3349OooO0O0 & 2) != 0);
            }
            o00Oo0 o00oo1 = o00Oo0.this;
            if (o00oo1.f3347OooOOO0) {
                o00oo1.f3346OooOO0o = typeface;
                TextView textView = (TextView) this.f3350OooO0OO.get();
                if (textView != null) {
                    WeakHashMap<View, androidx.core.view.o000OOo0> weakHashMap = ViewCompat.f5341OooO00o;
                    if (ViewCompat.OooOO0O.OooO0O0(textView)) {
                        textView.post(new o00Ooo(textView, typeface, o00oo1.f3344OooOO0));
                    } else {
                        textView.setTypeface(typeface, o00oo1.f3344OooOO0);
                    }
                }
            }
        }
    ...
    public o00Oo0(@NonNull TextView textView) {
        this.f3336OooO00o = textView;
        this.f3335OooO = new oo000o(textView);
    }
    ...
    public static o000O000 OooO0OO(Context context, OooOOO0 oooOOO0, int i) {
        ...
        synchronized (oooOOO0) {
            colorStateListOooO = oooOOO0.f2981OooO00o.OooO(i, context);
        }
        ...
        if (oo000oVar.OooO()) {
            ...
            if (length > 0) {
                ...
                if (i == 0) {
                    ...
                    DisplayMetrics displayMetrics = oo000oVar.f3370OooOO0.getResources().getDisplayMetrics();
                    for (int i2 = 0; i2 < length; i2++) {
                        iArrCopyOf[i2] = Math.round(TypedValue.applyDimension(i, iArr[i2], displayMetrics));
                    }
                }
                oo000oVar.f3366OooO0o = oo000o.OooO0O0(iArrCopyOf);
                if (!oo000oVar.OooO0oo()) {
                    throw new IllegalArgumentException("None of the preset sizes is valid: " + Arrays.toString(iArr));
                }
            } else {
                oo000oVar.f3368OooO0oO = false;
            }
            if (oo000oVar.OooO0oO()) {
                oo000oVar.OooO00o();
            }
    ...
    public final void OooO00o(Drawable drawable, o000O000 o000o001) {
        ...
        OooOOO0.OooO0o0(drawable, o000o001, this.f3336OooO00o.getDrawableState());
    }

    public final void OooO0O0() {
        o000O000 o000o001 = this.f3337OooO0O0;
        TextView textView = this.f3336OooO00o;
        if (o000o001 != null || this.f3338OooO0OO != null || this.f3339OooO0Oo != null || this.f3341OooO0o0 != null) {
            Drawable[] compoundDrawables = textView.getCompoundDrawables();
            OooO00o(compoundDrawables[0], this.f3337OooO0O0);
            OooO00o(compoundDrawables[1], this.f3338OooO0OO);
            OooO00o(compoundDrawables[2], this.f3339OooO0Oo);
            OooO00o(compoundDrawables[3], this.f3341OooO0o0);
        }
        if (this.f3340OooO0o == null && this.f3342OooO0oO == null) {
            return;
        }
        Drawable[] drawableArrOooO00o = OooO0O0.OooO00o(textView);
        OooO00o(drawableArrOooO00o[0], this.f3340OooO0o);
        OooO00o(drawableArrOooO00o[2], this.f3342OooO0oO);
    }

    @Nullable
    public final ColorStateList OooO0Oo() {
        o000O000 o000o001 = this.f3343OooO0oo;
        if (o000o001 != null) {
            return o000o001.f3264OooO00o;
        }
        return null;
    }
    ...
    public final void OooO0o(@Nullable AttributeSet attributeSet, int i) {
        ...
        ViewCompat.OooOOO(textView, textView.getContext(), iArr, attributeSet, o000oo0OooOOO0.f3324OooO0O0, i, 0);
        ...
        Typeface typeface = this.f3346OooOO0o;
        if (typeface != null) {
            if (this.f3345OooOO0O == -1) {
                textView.setTypeface(typeface, this.f3344OooOO0);
            } else {
        ...
        if (typedArrayObtainStyledAttributes.hasValue(i16)) {
            oo000oVar.f3362OooO00o = typedArrayObtainStyledAttributes.getInt(i16, 0);
        }
        ...
        if (typedArrayObtainStyledAttributes.hasValue(i20) && (resourceId = typedArrayObtainStyledAttributes.getResourceId(i20, 0)) > 0) {
            ...
            if (length > 0) {
                ...
                oo000oVar.f3366OooO0o = oo000o.OooO0O0(iArr3);
                oo000oVar.OooO0oo();
            }
        ...
        if (!oo000oVar.OooO()) {
            oo000oVar.f3362OooO00o = 0;
        } else if (oo000oVar.f3362OooO00o == 1) {
            if (!oo000oVar.f3368OooO0oO) {
        ...
        if (o0O0ooO.f3356OooO0O0 && oo000oVar.f3362OooO00o != 0) {
            int[] iArr4 = oo000oVar.f3366OooO0o;
            if (iArr4.length > 0) {
                if (OooO.OooO00o(textView) != -1.0f) {
                    OooO.OooO0O0(textView, Math.round(oo000oVar.f3365OooO0Oo), Math.round(oo000oVar.f3367OooO0o0), Math.round(oo000oVar.f3364OooO0OO), 0);
                } else {
    ...
    public final void OooOO0(int i) {
        ...
        if (oo000oVar.OooO()) {
            if (i == 0) {
                oo000oVar.f3362OooO00o = 0;
                oo000oVar.f3365OooO0Oo = -1.0f;
                oo000oVar.f3367OooO0o0 = -1.0f;
                oo000oVar.f3364OooO0OO = -1.0f;
                oo000oVar.f3366OooO0o = new int[0];
                oo000oVar.f3363OooO0O0 = false;
                return;
            }
            if (i != 1) {
    ...
    public final void OooOO0O(@Nullable ColorStateList colorStateList) {
        if (this.f3343OooO0oo == null) {
            this.f3343OooO0oo = new o000O000();
        }
        o000O000 o000o001 = this.f3343OooO0oo;
        o000o001.f3264OooO00o = colorStateList;
        o000o001.f3267OooO0Oo = colorStateList != null;
        this.f3337OooO0O0 = o000o001;
        this.f3338OooO0OO = o000o001;
        this.f3339OooO0Oo = o000o001;
        this.f3341OooO0o0 = o000o001;
        this.f3340OooO0o = o000o001;
        this.f3342OooO0oO = o000o001;
    }
    ...
    public final void OooOO0o(@Nullable PorterDuff.Mode mode) {
        ...
        o000O000 o000o001 = this.f3343OooO0oo;
        o000o001.f3265OooO0O0 = mode;
        o000o001.f3266OooO0OO = mode != null;
        this.f3337OooO0O0 = o000o001;
        this.f3338OooO0OO = o000o001;
        this.f3339OooO0Oo = o000o001;
        this.f3341OooO0o0 = o000o001;
    ...
    public final void OooOOO0(Context context, o000Oo0 o000oo1) {
        String strOooOO0;
        this.f3344OooOO0 = o000oo1.OooO0oo(p012OooOo0O.o00O0O.TextAppearance_android_textStyle, this.f3344OooOO0);
        int i = Build.VERSION.SDK_INT;
        if (i >= 28) {
            int iOooO0oo = o000oo1.OooO0oo(p012OooOo0O.o00O0O.TextAppearance_android_textFontWeight, -1);
            this.f3345OooOO0O = iOooO0oo;
            if (iOooO0oo != -1) {
                this.f3344OooOO0 = (this.f3344OooOO0 & 2) | 0;
            }
        }
        ...
        if (!o000oo1.OooOO0o(i2) && !o000oo1.OooOO0o(p012OooOo0O.o00O0O.TextAppearance_fontFamily)) {
            ...
            if (o000oo1.OooOO0o(i3)) {
                this.f3347OooOOO0 = false;
                int iOooO0oo2 = o000oo1.OooO0oo(i3, 1);
                if (iOooO0oo2 == 1) {
                    this.f3346OooOO0o = Typeface.SANS_SERIF;
                    return;
                } else if (iOooO0oo2 == 2) {
                    this.f3346OooOO0o = Typeface.SERIF;
                    return;
                } else {
                    if (iOooO0oo2 != 3) {
                        return;
                    }
                    this.f3346OooOO0o = Typeface.MONOSPACE;
                    return;
                }
            }
            return;
        }
        this.f3346OooOO0o = null;
        int i4 = p012OooOo0O.o00O0O.TextAppearance_fontFamily;
        if (o000oo1.OooOO0o(i4)) {
            i2 = i4;
        }
        int i5 = this.f3345OooOO0O;
        int i6 = this.f3344OooOO0;
        if (!context.isRestricted()) {
            try {
                Typeface typefaceOooO0oO = o000oo1.OooO0oO(i2, this.f3344OooOO0, new OooO00o(i5, i6, new WeakReference(this.f3336OooO00o)));
                if (typefaceOooO0oO != null) {
                    if (i < 28 || this.f3345OooOO0O == -1) {
                        this.f3346OooOO0o = typefaceOooO0oO;
                    } else {
                        this.f3346OooOO0o = OooOO0.OooO00o(Typeface.create(typefaceOooO0oO, 0), this.f3345OooOO0O, (this.f3344OooOO0 & 2) != 0);
                    }
                }
                this.f3347OooOOO0 = this.f3346OooOO0o == null;
            } catch (Resources.NotFoundException | UnsupportedOperationException unused) {
            }
        }
        if (this.f3346OooOO0o != null || (strOooOO0 = o000oo1.OooOO0(i2)) == null) {
            return;
        }
        if (Build.VERSION.SDK_INT < 28 || this.f3345OooOO0O == -1) {
            this.f3346OooOO0o = Typeface.create(strOooOO0, this.f3344OooOO0);
        } else {
            this.f3346OooOO0o = OooOO0.OooO00o(Typeface.create(strOooOO0, 0), this.f3345OooOO0O, (this.f3344OooOO0 & 2) != 0);
        }
    }
}
