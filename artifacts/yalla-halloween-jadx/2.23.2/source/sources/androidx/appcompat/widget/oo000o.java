...
public final class oo000o {
    ...
    public static final RectF f3359OooOO0o = new RectF();

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    @SuppressLint({"BanConcurrentHashMap"})
    public static final ConcurrentHashMap<String, Method> f3360OooOOO0 = new ConcurrentHashMap<>();

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    @NonNull
    public final TextView f3361OooO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public TextPaint f3369OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public final Context f3370OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public final OooO0o f3371OooOO0O;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public int f3362OooO00o = 0;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public boolean f3363OooO0O0 = false;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public float f3364OooO0OO = -1.0f;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public float f3365OooO0Oo = -1.0f;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public float f3367OooO0o0 = -1.0f;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public int[] f3366OooO0o = new int[0];
    ...
    public oo000o(@NonNull TextView textView) {
        this.f3361OooO = textView;
        this.f3370OooOO0 = textView.getContext();
        if (Build.VERSION.SDK_INT >= 29) {
            this.f3371OooOO0O = new OooO();
        } else {
            this.f3371OooOO0O = new OooO0o();
        }
    }
    ...
    public static Method OooO0Oo(@NonNull String str) {
        try {
            ConcurrentHashMap<String, Method> concurrentHashMap = f3360OooOOO0;
    ...
    public final boolean OooO() {
        return !(this.f3361OooO instanceof AppCompatEditText);
    }

    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public final void OooO00o() {
        if (OooO() && this.f3362OooO00o != 0) {
            if (this.f3363OooO0O0) {
                if (this.f3361OooO.getMeasuredHeight() <= 0 || this.f3361OooO.getMeasuredWidth() <= 0) {
                    return;
                }
                int measuredWidth = this.f3371OooOO0O.OooO0O0(this.f3361OooO) ? ZegoConstants.ErrorMask.RoomServerErrorMask : (this.f3361OooO.getMeasuredWidth() - this.f3361OooO.getTotalPaddingLeft()) - this.f3361OooO.getTotalPaddingRight();
                int height = (this.f3361OooO.getHeight() - this.f3361OooO.getCompoundPaddingBottom()) - this.f3361OooO.getCompoundPaddingTop();
                if (measuredWidth <= 0 || height <= 0) {
                    return;
                }
                RectF rectF = f3359OooOO0o;
                synchronized (rectF) {
                    rectF.setEmpty();
                    rectF.right = measuredWidth;
                    rectF.bottom = height;
                    float fOooO0OO = OooO0OO(rectF);
                    if (fOooO0OO != this.f3361OooO.getTextSize()) {
                        OooO0o(fOooO0OO, 0);
                    }
                }
            }
            this.f3363OooO0O0 = true;
        }
    }

    public final int OooO0OO(RectF rectF) {
        CharSequence transformation;
        int length = this.f3366OooO0o.length;
        if (length == 0) {
        ...
        while (i2 <= i) {
            int i4 = (i2 + i) / 2;
            int i5 = this.f3366OooO0o[i4];
            TextView textView = this.f3361OooO;
            ...
            TextPaint textPaint = this.f3369OooO0oo;
            if (textPaint == null) {
                this.f3369OooO0oo = new TextPaint();
            } else {
                textPaint.reset();
            }
            this.f3369OooO0oo.set(textView.getPaint());
            this.f3369OooO0oo.setTextSize(i5);
            StaticLayout staticLayoutOooO00o = OooO0OO.OooO00o(text, (Layout.Alignment) OooO0o0("getLayoutAlignment", textView, Layout.Alignment.ALIGN_NORMAL), Math.round(rectF.right), iOooO0O0, this.f3361OooO, this.f3369OooO0oo, this.f3371OooOO0O);
        ...
        return this.f3366OooO0o[i3];
    }

    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public final void OooO0o(float f, int i) {
        Context context = this.f3370OooOO0;
    ...
    public final boolean OooO0oO() {
        if (OooO() && this.f3362OooO00o == 1) {
            if (!this.f3368OooO0oO || this.f3366OooO0o.length == 0) {
                int iFloor = ((int) Math.floor((this.f3367OooO0o0 - this.f3365OooO0Oo) / this.f3364OooO0OO)) + 1;
                int[] iArr = new int[iFloor];
                for (int i = 0; i < iFloor; i++) {
                    iArr[i] = Math.round((i * this.f3364OooO0OO) + this.f3365OooO0Oo);
                }
                this.f3366OooO0o = OooO0O0(iArr);
            }
            this.f3363OooO0O0 = true;
        } else {
            this.f3363OooO0O0 = false;
        }
        return this.f3363OooO0O0;
    }

    public final boolean OooO0oo() {
        int[] iArr = this.f3366OooO0o;
        int length = iArr.length;
        boolean z = length > 0;
        this.f3368OooO0oO = z;
        if (z) {
            this.f3362OooO00o = 1;
            this.f3365OooO0Oo = iArr[0];
            this.f3367OooO0o0 = iArr[length - 1];
            this.f3364OooO0OO = -1.0f;
        }
        return z;
    }
    ...
    public final void OooOO0(float f, float f2, float f3) throws IllegalArgumentException {
        ...
        this.f3362OooO00o = 1;
        this.f3365OooO0Oo = f;
        this.f3367OooO0o0 = f2;
        this.f3364OooO0OO = f3;
        this.f3368OooO0oO = false;
    }
}
