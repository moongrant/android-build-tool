...
public final class OooO0o implements AudioStream {
    ...
    public static class OooO00o {
        ...
        public OooO00o(@NonNull ByteBuffer byteBuffer, @NonNull AudioStream.OooO0O0 oooO0O0, int i, int i2) {
            ...
            if (iLimit != oooO0O0.OooO00o()) {
                StringBuilder sbOooO0O0 = o0000O0.OooO0O0("Byte buffer size is not match with packet info: ", iLimit, " != ");
                sbOooO0O0.append(oooO0O0.OooO00o());
        ...
        public final OooO0OO OooO00o(@NonNull ByteBuffer byteBuffer) {
            ...
            if (byteBuffer2.remaining() > byteBuffer.remaining()) {
                ...
                this.f4096OooO0Oo += o00OO000.OooO00o(this.f4094OooO0O0, o00OO000.OooO0O0(this.f4093OooO00o, iRemaining));
    ...
    public OooO0o(@NonNull OooO0O0 oooO0O0, @NonNull oOO00O ooo00o) {
        oo000o oo000oVar;
        if (oo000o.f1415OooO0o0 != null) {
            oo000oVar = oo000o.f1415OooO0o0;
        } else {
            synchronized (oo000o.class) {
                try {
                    if (oo000o.f1415OooO0o0 == null) {
                        oo000o.f1415OooO0o0 = new oo000o();
                    }
                } catch (Throwable th) {
                    throw th;
                }
    ...
    public final void OooO00o(@Nullable AudioStream.OooO00o oooO00o, @Nullable Executor executor) {
        ...
        this.f4085OooO0Oo.execute(new o00OO0O0(0, this, oooO00o, executor));
    }
    ...
    public final void OooO0OO() {
        if (this.f4091OooOO0O.get()) {
            ...
            if (this.f4091OooOO0O.get()) {
                this.f4085OooO0Oo.execute(new Runnable() { // from class: OooooO0.o00OOO0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f1794OooO0Oo.OooO0OO();
                    }
                });
            }
        }
    ...
    public final OooO0OO read(@NonNull ByteBuffer byteBuffer) {
        ...
        this.f4085OooO0Oo.execute(new Runnable() { // from class: OooooO0.o00OO0OO
            @Override // java.lang.Runnable
            public final void run() {
                OooO0o oooO0o = this.f1792OooO0Oo;
                ...
                StringBuilder sbOooO0O0 = o0000O0.OooO0O0("Update buffer size from ", i, " to ");
                sbOooO0O0.append(oooO0o.f4092OooOO0o);
                o00O0O0.OooO00o("BufferedAudioStream", sbOooO0O0.toString());
            }
        });
    ...
    public final void release() {
        ...
        this.f4085OooO0Oo.execute(new Runnable() { // from class: OooooO0.o00OOO00
            @Override // java.lang.Runnable
            public final void run() {
                OooO0o oooO0o = this.f1795OooO0Oo;
    ...
    public final void start() throws IllegalStateException, AudioStream.AudioStreamException {
        ...
        FutureTask futureTask = new FutureTask(new oo0O(this, 0), null);
    ...
    public final void stop() throws IllegalStateException {
        ...
        if (this.f4082OooO00o.getAndSet(false)) {
            this.f4085OooO0Oo.execute(new Runnable() { // from class: OooooO0.o00OO
                @Override // java.lang.Runnable
                public final void run() {
                    OooO0o oooO0o = this.f1779OooO0Oo;
                    oooO0o.f4091OooOO0O.set(false);
