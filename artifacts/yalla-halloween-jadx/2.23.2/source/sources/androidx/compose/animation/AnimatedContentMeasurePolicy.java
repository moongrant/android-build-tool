    ...
    public MeasureResult mo3measure3p2s80s(@NotNull MeasureScope measure, @NotNull List<? extends Measurable> measurables, long j) {
        ...
        while (true) {
            ...
            if (childData != null && childData.isTarget()) {
                placeableArr[i] = measurable.mo2804measureBRTryo0(j);
            }
            i++;
        }
        ...
        for (int i2 = 0; i2 < size3; i2++) {
            ...
            if (placeableArr[i2] == null) {
                placeableArr[i2] = measurable2.mo2804measureBRTryo0(j);
            }
        }
        if ((size == 0) == true) {
            placeable2 = null;
            ...
            if (lastIndex != 0) {
                ...
                while (intIteratorOooO00o.hasNext()) {
                    Placeable placeable3 = placeableArr[intIteratorOooO00o.nextInt()];
        ...
        if ((size == 0) == false) {
            ...
            if (lastIndex2 != 0) {
                ...
                IntIterator intIteratorOooO00o2 = OooO0OO.OooO00o(1, lastIndex2);
                while (intIteratorOooO00o2.hasNext()) {
                    Placeable placeable4 = placeableArr[intIteratorOooO00o2.nextInt()];
        ...
        this.rootScope.m26setMeasuredSizeozmzZPI$animation_release(IntSizeKt.IntSize(width3, height3));
        return MeasureScope.CC.OooOOo0(measure, width3, height3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentMeasurePolicy$measure$3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                ...
                for (Placeable placeable5 : placeableArr2) {
                    if (placeable5 != null) {
                        long jMo1337alignKFBX0sM = animatedContentMeasurePolicy.getRootScope().getContentAlignment().mo1337alignKFBX0sM(IntSizeKt.IntSize(placeable5.getWidth(), placeable5.getHeight()), IntSizeKt.IntSize(i3, i4), LayoutDirection.Ltr);
                        Placeable.PlacementScope.place$default(layout, placeable5, IntOffset.m3893getXimpl(jMo1337alignKFBX0sM), IntOffset.m3894getYimpl(jMo1337alignKFBX0sM), 0.0f, 4, null);
                    }
                }
            }
        }, 4, null);
