        ...
        public final TwoWayConverter<Color, AnimationVector4D> invoke(@NotNull final ColorSpace colorSpace) {
            ...
            return VectorConvertersKt.TwoWayConverter(new Function1<Color, AnimationVector4D>() { // from class: androidx.compose.animation.ColorVectorConverterKt$ColorToVector$1.1
                ...
                public /* bridge */ /* synthetic */ AnimationVector4D invoke(Color color) {
                    return m30invoke8_81llA(color.m1691unboximpl());
                }

                @NotNull
                /* JADX INFO: renamed from: invoke-8_81llA, reason: not valid java name */
                public final AnimationVector4D m30invoke8_81llA(long j) {
                    long jM1678convertvNxB06k = Color.m1678convertvNxB06k(j, ColorSpaces.INSTANCE.getOklab());
                    return new AnimationVector4D(Color.m1675component4impl(jM1678convertvNxB06k), Color.m1672component1impl(jM1678convertvNxB06k), Color.m1673component2impl(jM1678convertvNxB06k), Color.m1674component3impl(jM1678convertvNxB06k));
                }
                ...
                public /* bridge */ /* synthetic */ Color invoke(AnimationVector4D animationVector4D) {
                    return Color.m1671boximpl(m31invokevNxB06k(animationVector4D));
                }

                /* JADX INFO: renamed from: invoke-vNxB06k, reason: not valid java name */
                public final long m31invokevNxB06k(@NotNull AnimationVector4D vector) {
                    Intrinsics.checkNotNullParameter(vector, "vector");
                    return Color.m1678convertvNxB06k(ColorKt.Color(RangesKt.coerceIn(vector.getV2(), 0.0f, 1.0f), RangesKt.coerceIn(vector.getV3(), -0.5f, 0.5f), RangesKt.coerceIn(vector.getV4(), -0.5f, 0.5f), RangesKt.coerceIn(vector.getV1(), 0.0f, 1.0f), ColorSpaces.INSTANCE.getOklab()), colorSpace);
                }
            });
        }
    };
