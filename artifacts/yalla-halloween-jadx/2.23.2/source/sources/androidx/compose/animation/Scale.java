...
public final /* data */ class Scale {
    ...
    public static /* synthetic */ Scale m52copybnNdC4k$default(Scale scale, float f, long j, FiniteAnimationSpec finiteAnimationSpec, int i, Object obj) {
        if ((i & 1) != 0) {
            f = scale.scale;
        }
        if ((i & 2) != 0) {
        ...
        return scale.m54copybnNdC4k(f, j, finiteAnimationSpec);
    }
    ...
    public final Scale m54copybnNdC4k(float scale, long transformOrigin, @NotNull FiniteAnimationSpec<Float> animationSpec) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Float.compare(this.scale, scale.scale) == 0 && TransformOrigin.m2037equalsimpl0(this.transformOrigin, scale.transformOrigin) && Intrinsics.areEqual(this.animationSpec, scale.animationSpec);
    }
    ...
    public final long m55getTransformOriginSzJe1aQ() {
        return this.transformOrigin;
    }

    public int hashCode() {
        return this.animationSpec.hashCode() + ((TransformOrigin.m2040hashCodeimpl(this.transformOrigin) + (Float.floatToIntBits(this.scale) * 31)) * 31);
    }

    @NotNull
    public String toString() {
        return "Scale(scale=" + this.scale + ", transformOrigin=" + ((Object) TransformOrigin.m2041toStringimpl(this.transformOrigin)) + ", animationSpec=" + this.animationSpec + ')';
    }
