...
public final class SingleValueAnimationKt {
    ...
    public static final Animatable<Color, AnimationVector4D> m56Animatable8_81llA(long j) {
        return new Animatable<>(Color.m1671boximpl(j), ColorVectorConverterKt.getVectorConverter(Color.INSTANCE).invoke(Color.m1685getColorSpaceimpl(j)), null, null, 12, null);
    }
    ...
    public static final State<Color> m58animateColorAsStateeuL9pac(long j, @Nullable AnimationSpec<Color> animationSpec, @Nullable String str, @Nullable Function1<? super Color, Unit> function1, @Nullable Composer composer, int i, int i2) {
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = (TwoWayConverter) ColorVectorConverterKt.getVectorConverter(Color.INSTANCE).invoke(Color.m1685getColorSpaceimpl(j));
            composer.updateRememberedValue(objRememberedValue);
        }
        composer.endReplaceableGroup();
        int i3 = i << 6;
        State<Color> stateAnimateValueAsState = AnimateAsStateKt.animateValueAsState(Color.m1671boximpl(j), (TwoWayConverter) objRememberedValue, animationSpec2, null, str2, function2, composer, (i & 14) | 576 | (57344 & i3) | (i3 & 458752), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
