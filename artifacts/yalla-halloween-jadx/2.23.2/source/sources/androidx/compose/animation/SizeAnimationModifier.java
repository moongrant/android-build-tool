...
final class SizeAnimationModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public static final /* data */ class AnimData {
        ...
        public boolean equals(@Nullable Object other) {
            ...
            return Intrinsics.areEqual(this.anim, animData.anim) && IntSize.m3933equalsimpl0(this.startSize, animData.startSize);
        }
        ...
        public int hashCode() {
            return IntSize.m3936hashCodeimpl(this.startSize) + (this.anim.hashCode() * 31);
        }
        ...
        public String toString() {
            return "AnimData(anim=" + this.anim + ", startSize=" + ((Object) IntSize.m3938toStringimpl(this.startSize)) + ')';
        }
    ...
    public final long m59animateTomzRDjE0(long targetSize) {
        ...
        if (animData == null) {
            animData = new AnimData(new Animatable(IntSize.m3927boximpl(targetSize), VectorConvertersKt.getVectorConverter(IntSize.INSTANCE), IntSize.m3927boximpl(IntSizeKt.IntSize(1, 1)), null, 8, null), targetSize, null);
        } else if (!IntSize.m3933equalsimpl0(targetSize, animData.getAnim().getTargetValue().getPackedValue())) {
    ...
    public MeasureResult mo27measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j) {
        ...
        long jM59animateTomzRDjE0 = m59animateTomzRDjE0(IntSizeKt.IntSize(placeableMo2804measureBRTryo0.getWidth(), placeableMo2804measureBRTryo0.getHeight()));
        return MeasureScope.CC.OooOOo0(measure, IntSize.m3935getWidthimpl(jM59animateTomzRDjE0), IntSize.m3934getHeightimpl(jM59animateTomzRDjE0), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SizeAnimationModifier$measure$1
            {
                super(1);
            }
