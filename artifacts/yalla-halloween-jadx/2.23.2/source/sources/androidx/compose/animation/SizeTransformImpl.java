...
final class SizeTransformImpl implements SizeTransform {
    ...
    public FiniteAnimationSpec<IntSize> mo65createAnimationSpecTemP2vQ(long initialSize, long targetSize) {
        return this.sizeAnimationSpec.invoke(IntSize.m3927boximpl(initialSize), IntSize.m3927boximpl(targetSize));
    }
