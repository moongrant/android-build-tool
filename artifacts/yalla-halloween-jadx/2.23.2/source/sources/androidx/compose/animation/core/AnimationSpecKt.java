...
public final class AnimationSpecKt {
    ...
    public static final /* synthetic */ InfiniteRepeatableSpec infiniteRepeatable(DurationBasedAnimationSpec animation, RepeatMode repeatMode) {
        ...
        return new InfiniteRepeatableSpec(animation, repeatMode, StartOffset.m101constructorimpl$default(0, 0, 2, null), (DefaultConstructorMarker) null);
    }
    ...
    public static final <T> InfiniteRepeatableSpec<T> m80infiniteRepeatable9IiC70o(@NotNull DurationBasedAnimationSpec<T> animation, @NotNull RepeatMode repeatMode, long j) {
        Intrinsics.checkNotNullParameter(animation, "animation");
        Intrinsics.checkNotNullParameter(repeatMode, "repeatMode");
    ...
    public static /* synthetic */ InfiniteRepeatableSpec m81infiniteRepeatable9IiC70o$default(DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode, long j, int i, Object obj) {
        if ((i & 2) != 0) {
            repeatMode = RepeatMode.Restart;
        }
        if ((i & 4) != 0) {
            j = StartOffset.m101constructorimpl$default(0, 0, 2, null);
        }
        return m80infiniteRepeatable9IiC70o(durationBasedAnimationSpec, repeatMode, j);
    }
    ...
    public static final /* synthetic */ RepeatableSpec repeatable(int i, DurationBasedAnimationSpec animation, RepeatMode repeatMode) {
        Intrinsics.checkNotNullParameter(animation, "animation");
        Intrinsics.checkNotNullParameter(repeatMode, "repeatMode");
        return new RepeatableSpec(i, animation, repeatMode, StartOffset.m101constructorimpl$default(0, 0, 2, null), (DefaultConstructorMarker) null);
    }
    ...
    public static final <T> RepeatableSpec<T> m82repeatable91I0pcU(int i, @NotNull DurationBasedAnimationSpec<T> animation, @NotNull RepeatMode repeatMode, long j) {
        Intrinsics.checkNotNullParameter(animation, "animation");
        Intrinsics.checkNotNullParameter(repeatMode, "repeatMode");
    ...
    public static /* synthetic */ RepeatableSpec m83repeatable91I0pcU$default(int i, DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode, long j, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            repeatMode = RepeatMode.Restart;
        }
        if ((i2 & 8) != 0) {
        ...
        return m82repeatable91I0pcU(i, durationBasedAnimationSpec, repeatMode, j);
    }
