...
public final class CubicBezierEasing implements Easing {
    ...
    private final float evaluateCubic(float a, float b, float m) {
        float f = 3;
        float f2 = 1 - m;
        return (m * m * m) + (f * b * f2 * m * m) + (a * f * f2 * f2 * m);
    }
    ...
    public int hashCode() {
        return Float.floatToIntBits(this.d) + o0OoOo0.OooO00o(this.c, o0OoOo0.OooO00o(this.b, Float.floatToIntBits(this.a) * 31, 31), 31);
    }
