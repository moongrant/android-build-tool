...
public final class InfiniteAnimationPolicyKt {
    ...
    public static final class C05292<R> extends SuspendLambda implements Function1<Continuation<? super R>, Object> {
        final /* synthetic */ Function1<Long, R> $onFrame;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C05292(Function1<? super Long, ? extends R> function1, Continuation<? super C05292> continuation) {
        ...
        public final Continuation<Unit> create(@NotNull Continuation<?> continuation) {
            return new C05292(this.$onFrame, continuation);
        }
        ...
        public final Object invoke(@Nullable Continuation<? super R> continuation) {
            return ((C05292) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public static final <R> Object withInfiniteAnimationFrameNanos(@NotNull Function1<? super Long, ? extends R> function1, @NotNull Continuation<? super R> continuation) {
        ...
        return infiniteAnimationPolicy == null ? MonotonicFrameClockKt.withFrameNanos(function1, continuation) : infiniteAnimationPolicy.onInfiniteOperation(new C05292(function1, null), continuation);
    }
}
