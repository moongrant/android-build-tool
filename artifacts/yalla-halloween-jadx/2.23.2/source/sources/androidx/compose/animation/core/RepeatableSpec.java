...
public final class RepeatableSpec<T> implements FiniteAnimationSpec<T> {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return repeatableSpec.iterations == this.iterations && Intrinsics.areEqual(repeatableSpec.animation, this.animation) && repeatableSpec.repeatMode == this.repeatMode && StartOffset.m103equalsimpl0(repeatableSpec.initialStartOffset, this.initialStartOffset);
    }
    ...
    public int hashCode() {
        return StartOffset.m106hashCodeimpl(this.initialStartOffset) + ((this.repeatMode.hashCode() + ((this.animation.hashCode() + (this.iterations * 31)) * 31)) * 31);
    }
    ...
    public /* synthetic */ RepeatableSpec(int i, DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode, long j, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(i, durationBasedAnimationSpec, (i2 & 4) != 0 ? RepeatMode.Restart : repeatMode, (i2 & 8) != 0 ? StartOffset.m101constructorimpl$default(0, 0, 2, null) : j, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ RepeatableSpec(int i, DurationBasedAnimationSpec animation, RepeatMode repeatMode) {
        this(i, animation, repeatMode, StartOffset.m101constructorimpl$default(0, 0, 2, null), (DefaultConstructorMarker) null);
        Intrinsics.checkNotNullParameter(animation, "animation");
        Intrinsics.checkNotNullParameter(repeatMode, "repeatMode");
    }
}
