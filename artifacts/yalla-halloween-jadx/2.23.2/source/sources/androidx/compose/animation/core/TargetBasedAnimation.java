...
public final class TargetBasedAnimation<T, V extends AnimationVector> implements Animation<T, V> {
    ...
    public T getValueFromNanos(long playTimeNanos) {
        if (OooO00o.OooO00o(this, playTimeNanos)) {
    ...
    public V getVelocityVectorFromNanos(long playTimeNanos) {
        return !OooO00o.OooO00o(this, playTimeNanos) ? (V) this.animationSpec.getVelocityFromNanos(playTimeNanos, this.initialValueVector, this.targetValueVector, this.initialVelocityVector) : this.endVelocity;
    }
