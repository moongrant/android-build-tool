...
@Metadata(d1 = {"\u00008\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u0010\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nH\u0016J\u0010\u0010\u000b\u001a\u00020\b2\u0006\u0010\f\u001a\u00020\rH\u0016J\u0010\u0010\u000e\u001a\u00020\b2\u0006\u0010\f\u001a\u00020\u000fH\u0016J\f\u0010\u0010\u001a\u00020\b*\u00020\u0011H\u0002R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0012"}, d2 = {"Landroidx/compose/compiler/plugins/kotlin/lower/ComposableLambdaAnnotator;", "Lorg/jetbrains/kotlin/ir/visitors/IrElementVisitorVoid;", "context", "Lorg/jetbrains/kotlin/backend/common/extensions/IrPluginContext;", "(Lorg/jetbrains/kotlin/backend/common/extensions/IrPluginContext;)V", "composableSymbol", "Lorg/jetbrains/kotlin/ir/symbols/IrClassSymbol;", "visitElement", "", "element", "Lorg/jetbrains/kotlin/ir/IrElement;", "visitFunctionExpression", "expression", "Lorg/jetbrains/kotlin/ir/expressions/IrFunctionExpression;", "visitFunctionReference", "Lorg/jetbrains/kotlin/ir/expressions/IrFunctionReference;", "mark", "Lorg/jetbrains/kotlin/ir/declarations/IrFunction;", "compiler-hosted"}, k = 1, mv = {1, 8, 0}, xi = 48)
public final class ComposableLambdaAnnotator implements IrElementVisitorVoid {

    @NotNull
    private final IrClassSymbol composableSymbol;

    public ComposableLambdaAnnotator(@NotNull IrPluginContext irPluginContext) {
        IrClassSymbol irClassSymbolReferenceClass = irPluginContext.referenceClass(ComposeClassIds.INSTANCE.getComposable());
        Intrinsics.checkNotNull(irClassSymbolReferenceClass);
        this.composableSymbol = irClassSymbolReferenceClass;
    }
    ...
    private final void mark(IrFunction irFunction) {
        ...
        irFunction.setAnnotations(CollectionsKt.plus((Collection<? extends IrConstructorCallImpl>) irFunction.getAnnotations(), IrConstructorCallImpl.Companion.fromSymbolOwner$default(IrConstructorCallImpl.Companion, IrUtilsKt.getDefaultType(this.composableSymbol.getOwner()), (IrConstructorSymbol) SequencesKt.single(IrUtilsKt.getConstructors(this.composableSymbol)), (IrStatementOrigin) null, 4, (Object) null)));
    }
    ...
    public void visitFunctionExpression(@NotNull IrFunctionExpression expression) {
        if (IrInlineReferenceLocatorKt.isSyntheticComposableFunction(expression.getType())) {
            mark((IrFunction) expression.getFunction());
        }
