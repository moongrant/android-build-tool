...
public final class ComposableTargetAnnotationsTransformer extends AbstractComposeLowering {
    ...
    public ComposableTargetAnnotationsTransformer(@NotNull IrPluginContext irPluginContext, @NotNull ComposableSymbolRemapper composableSymbolRemapper, @NotNull final ModuleMetrics moduleMetrics) {
        super(irPluginContext, composableSymbolRemapper, moduleMetrics);
        ComposeClassIds composeClassIds = ComposeClassIds.INSTANCE;
        this.ComposableTargetClass = composableSymbolRemapper.getReferencedClassOrNull(getTopLevelClassOrNull(composeClassIds.getComposableTarget()));
        this.ComposableOpenTargetClass = composableSymbolRemapper.getReferencedClassOrNull(getTopLevelClassOrNull(composeClassIds.getComposableOpenTarget()));
        this.ComposableInferredTargetClass = composableSymbolRemapper.getReferencedClassOrNull(getTopLevelClassOrNull(composeClassIds.getComposableInferredTarget()));
    ...
    */
    ...
    public final Scheme toScheme(@NotNull IrType irType, @NotNull Item item) {
        ...
        return new Scheme(item2, arrayList, irTypeArgument != null ? toScheme$lambda$27$toScheme(this, item, irTypeArgument) : null, false, 8, null);
    }
    ...
    public IrExpression visitCall(@NotNull IrCall expression) {
        ...
        if (irFunction != null && (isComposableCall(expression) || hasComposableArguments(expression))) {
            ...
            if (!(Intrinsics.areEqual(fqNameWhenAvailable, composeFqNames.getGetCurrentComposerFullName()) ? true : Intrinsics.areEqual(fqNameWhenAvailable, composeFqNames.getComposableLambdaFullName()))) {
                ...
                ArrayList arrayList2 = new ArrayList(CollectionsKt.OooO0oo(mutableList));
