...
public final class ComposeInlineLambdaLocator {
    ...
    @NotNull
    private final Map<IrFunctionSymbol, IrValueParameter> inlineLambdaToParameter = new LinkedHashMap();

    public ComposeInlineLambdaLocator(@NotNull IrPluginContext irPluginContext) {
    ...
    public final void scan(@NotNull IrElement element) {
        IrVisitorsKt.acceptVoid(element, new IrElementVisitorVoid() { // from class: androidx.compose.compiler.plugins.kotlin.lower.ComposeInlineLambdaLocator.scan.1
            ...
            public void visitFunctionAccess(@NotNull IrFunctionAccessExpression expression) {
                ...
                if (IrInlineReferenceLocatorKt.isInlineFunctionCall(owner, ComposeInlineLambdaLocator.this.context)) {
                    for (IrValueParameter irValueParameter : owner.getValueParameters()) {
                        if (IrInlineReferenceLocatorKt.isInlineParameter(irValueParameter) && (valueArgument = expression.getValueArgument(irValueParameter.getIndex())) != null && (irFunctionSymbolUnwrapLambda = IrInlineReferenceLocatorKt.unwrapLambda(valueArgument)) != null) {
            ...
            public void visitValueParameter(@NotNull IrValueParameter declaration) {
                ...
                if (!z || !IrInlineReferenceLocatorKt.isInlineParameter(declaration) || (defaultValue = declaration.getDefaultValue()) == null || (expression = defaultValue.getExpression()) == null || (irFunctionSymbolUnwrapLambda = IrInlineReferenceLocatorKt.unwrapLambda(expression)) == null) {
                    return;
                }
