...
public final class DurableFunctionKeyTransformer extends DurableKeyTransformer {
    ...
    public DurableFunctionKeyTransformer(@NotNull IrPluginContext irPluginContext, @NotNull DeepCopySymbolRemapper deepCopySymbolRemapper, @NotNull ModuleMetrics moduleMetrics) {
        super(new DurableKeyVisitor(null, 1, null), irPluginContext, deepCopySymbolRemapper, moduleMetrics);
    ...
    public final IrClass buildClass(String filePath) {
        ...
        irClassBuilder.setName(Name.identifier(OooOOOO.OooO00o(PackagePartClassUtils.getFilePartShortName(str), "$KeyMeta")));
