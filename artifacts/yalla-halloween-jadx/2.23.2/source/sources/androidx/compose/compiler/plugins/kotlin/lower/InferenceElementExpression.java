...
public final class InferenceElementExpression extends InferenceNode {
    ...
    public InferenceElementExpression(@NotNull ComposableTargetAnnotationsTransformer composableTargetAnnotationsTransformer, @NotNull IrExpression irExpression) {
        super(null);
