...
public final class InferenceFunctionDeclaration extends InferenceFunction {
    ...
    public InferenceFunctionDeclaration(@NotNull ComposableTargetAnnotationsTransformer composableTargetAnnotationsTransformer, @NotNull IrFunction irFunction) {
    ...
    private final Scheme toScheme(IrFunction irFunction, Item item) {
        ...
        ArrayList arrayList = new ArrayList(CollectionsKt.OooO0oo(listParameters));
    ...
    public void updateScheme(@NotNull Scheme scheme) {
        ...
        ArrayList arrayList = new ArrayList(Math.min(CollectionsKt.OooO0oo(listParameters), CollectionsKt.OooO0oo(parameters)));
