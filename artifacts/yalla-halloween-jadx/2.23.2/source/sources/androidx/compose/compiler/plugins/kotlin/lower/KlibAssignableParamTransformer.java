...
public final class KlibAssignableParamTransformer extends AbstractComposeLowering {
    public KlibAssignableParamTransformer(@NotNull IrPluginContext irPluginContext, @NotNull DeepCopySymbolRemapper deepCopySymbolRemapper, @NotNull ModuleMetrics moduleMetrics) {
    ...
    public IrStatement visitFunction(@NotNull IrFunction declaration) {
        ...
        final ArrayList arrayList2 = new ArrayList(CollectionsKt.OooO0oo(arrayList));
        ...
        declaration.setBody((IrBody) (body != null ? new IrBlockBodyImpl(body.getStartOffset(), body.getEndOffset(), new Function1<IrBlockBody, Unit>() { // from class: androidx.compose.compiler.plugins.kotlin.lower.KlibAssignableParamTransformer$visitFunction$1$1
            ...
            public final void invoke2(@NotNull IrBlockBody irBlockBody) {
                irBlockBody.getStatements().addAll(arrayList2);
                ...
                ArrayList arrayList3 = new ArrayList(CollectionsKt.OooO0oo(statements));
                ...
                irBlockBody.getStatements().addAll(arrayList3);
            }
        }) : null));
        return super.visitFunction(declaration);
    }
