...
public abstract class AbstractDecoysLowering extends AbstractComposeLowering implements DecoyTransformBase {
    ...
    public AbstractDecoysLowering(@NotNull IrPluginContext irPluginContext, @NotNull DeepCopySymbolRemapper deepCopySymbolRemapper, @NotNull ModuleMetrics moduleMetrics, @NotNull IdSignatureSerializer idSignatureSerializer) {
