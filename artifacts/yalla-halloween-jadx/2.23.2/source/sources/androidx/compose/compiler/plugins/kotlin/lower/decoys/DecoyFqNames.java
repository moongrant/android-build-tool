...
public final class DecoyFqNames {
    ...
    static {
        ...
        Decoy = decoyClassIds.getDecoy().asSingleFqName();
        DecoyImplementation = decoyClassIds.getDecoyImplementation().asSingleFqName();
        DecoyImplementationDefaultsBitMask = decoyClassIds.getDecoyImplementationDefaultsBitMask().asSingleFqName();
