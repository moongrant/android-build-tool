...
public final class DecoyTransformBaseKt {
    public static final /* synthetic */ <T extends IrElement> T copyWithNewTypeParams(T t, IrFunction irFunction, IrFunction irFunction2) {
        ...
        IrElementTransformer deepCopyPreservingMetadata = new DeepCopyPreservingMetadata(symbolRemapper, new DecoyTransformBaseKt$copyWithNewTypeParams$1$typeParamRemapper$1(deepCopyTypeRemapper, irFunction, irFunction2), SymbolRenamer.DEFAULT.INSTANCE);
        deepCopyTypeRemapper.setDeepCopy((DeepCopyIrTreeWithSymbols) deepCopyPreservingMetadata);
        T t2 = (T) PatchDeclarationParentsKt.patchDeclarationParents(t.transform((DeepCopyIrTreeWithSymbols) deepCopyPreservingMetadata, (Object) null), (IrDeclarationParent) irFunction2);
