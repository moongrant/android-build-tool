...
abstract class AbstractClickableNode extends DelegatingNode implements PointerInputModifierNode, KeyInputModifierNode {
    ...
    public static final class InteractionData {
        ...
        private long centreOffset = Offset.INSTANCE.m1463getZeroF1C5BW0();
        ...
        public final void m158setCentreOffsetk4lQ0M(long j) {
            this.centreOffset = j;
        }
    ...
    public static /* synthetic */ void m152updateCommonXHw0xAI$default(AbstractClickableNode abstractClickableNode, MutableInteractionSource mutableInteractionSource, boolean z, String str, Role role, Function0 function0, int i, Object obj) {
        if (obj != null) {
        ...
        abstractClickableNode.m156updateCommonXHw0xAI(mutableInteractionSource, z, str, role, function0);
    }
    ...
    public boolean mo153onKeyEventZmokQxo(@NotNull KeyEvent event) {
        ...
        if (this.enabled && Clickable_androidKt.m219isPressZmokQxo(event)) {
            if (!this.interactionData.getCurrentKeyPressInteractions().containsKey(Key.m2274boximpl(KeyEvent_androidKt.m2585getKeyZmokQxo(event)))) {
                PressInteraction.Press press = new PressInteraction.Press(this.interactionData.getCentreOffset(), null);
                this.interactionData.getCurrentKeyPressInteractions().put(Key.m2274boximpl(KeyEvent_androidKt.m2585getKeyZmokQxo(event)), press);
        ...
        } else if (this.enabled && Clickable_androidKt.m217isClickZmokQxo(event)) {
            PressInteraction.Press pressRemove = this.interactionData.getCurrentKeyPressInteractions().remove(Key.m2274boximpl(KeyEvent_androidKt.m2585getKeyZmokQxo(event)));
            if (pressRemove != null) {
    ...
    public void mo154onPointerEventH0pRuoY(@NotNull PointerEvent pointerEvent, @NotNull PointerEventPass pass, long bounds) {
        ...
        getClickablePointerInputNode().mo154onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public final void m156updateCommonXHw0xAI(@NotNull MutableInteractionSource interactionSource, boolean enabled, @Nullable String onClickLabel, @Nullable Role role, @NotNull Function0<Unit> onClick) {
