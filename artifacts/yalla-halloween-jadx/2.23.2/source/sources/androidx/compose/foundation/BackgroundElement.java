...
final class BackgroundElement extends ModifierNodeElement<BackgroundNode> {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (backgroundElement != null && Color.m1682equalsimpl0(this.color, backgroundElement.color) && Intrinsics.areEqual(this.brush, backgroundElement.brush)) {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int iM1688hashCodeimpl = Color.m1688hashCodeimpl(this.color) * 31;
        Brush brush = this.brush;
        return this.shape.hashCode() + o0OoOo0.OooO00o(this.alpha, (iM1688hashCodeimpl + (brush != null ? brush.hashCode() : 0)) * 31, 31);
    }
    ...
    public /* synthetic */ BackgroundElement(long j, Brush brush, float f, Shape shape, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Color.INSTANCE.m1717getUnspecified0d7_KjU() : j, (i & 2) != 0 ? null : brush, f, shape, function1, null);
    }
    ...
    public void update(@NotNull BackgroundNode node) {
        ...
        node.m173setColor8_81llA(this.color);
