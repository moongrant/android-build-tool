...
public final class BackgroundKt {
    ...
    public static final Modifier m170backgroundbw27NRU(@NotNull Modifier background, final long j, @NotNull final Shape shape) {
        ...
        return background.then(new BackgroundElement(j, null, 1.0f, shape, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.BackgroundKt$background-bw27NRU$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.setValue(Color.m1671boximpl(j));
                inspectorInfo.getProperties().set("color", Color.m1671boximpl(j));
                inspectorInfo.getProperties().set("shape", shape);
            }
    ...
    public static /* synthetic */ Modifier m171backgroundbw27NRU$default(Modifier modifier, long j, Shape shape, int i, Object obj) {
        if ((i & 2) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        return m170backgroundbw27NRU(modifier, j, shape);
    }
}
