...
final class BackgroundNode extends Modifier.Node implements DrawModifierNode {
    ...
    private final void drawOutline(ContentDrawScope contentDrawScope) {
        Outline outlineMo220createOutlinePq9zytI;
        if (Size.m1511equalsimpl(contentDrawScope.mo2118getSizeNHjbRc(), this.lastSize) && contentDrawScope.getLayoutDirection() == this.lastLayoutDirection && Intrinsics.areEqual(this.lastShape, this.shape)) {
            outlineMo220createOutlinePq9zytI = this.lastOutline;
            Intrinsics.checkNotNull(outlineMo220createOutlinePq9zytI);
        } else {
            outlineMo220createOutlinePq9zytI = this.shape.mo220createOutlinePq9zytI(contentDrawScope.mo2118getSizeNHjbRc(), contentDrawScope.getLayoutDirection(), contentDrawScope);
        }
        if (!Color.m1682equalsimpl0(this.color, Color.INSTANCE.m1717getUnspecified0d7_KjU())) {
            OutlineKt.m1913drawOutlinewDX37Ww(contentDrawScope, outlineMo220createOutlinePq9zytI, this.color, (60 & 4) != 0 ? 1.0f : 0.0f, (60 & 8) != 0 ? Fill.INSTANCE : null, (60 & 16) != 0 ? null : null, (60 & 32) != 0 ? DrawScope.INSTANCE.m2148getDefaultBlendMode0nO6VwU() : 0);
        }
        Brush brush = this.brush;
        if (brush != null) {
            OutlineKt.m1912drawOutlinehn5TExg$default(contentDrawScope, outlineMo220createOutlinePq9zytI, brush, this.alpha, null, null, 0, 56, null);
        }
        this.lastOutline = outlineMo220createOutlinePq9zytI;
        this.lastSize = Size.m1504boximpl(contentDrawScope.mo2118getSizeNHjbRc());
    ...
    public final void m173setColor8_81llA(long j) {
        this.color = j;
    }
