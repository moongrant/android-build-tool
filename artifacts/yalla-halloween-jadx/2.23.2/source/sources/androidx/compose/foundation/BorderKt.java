...
public final class BorderKt {
    ...
    public static final Modifier border(@NotNull Modifier modifier, @NotNull BorderStroke border, @NotNull Shape shape) {
        ...
        return m184borderziNgDLE(modifier, border.getWidth(), border.getBrush(), shape);
    }
    ...
    public static final Modifier m182borderxT4_qwU(@NotNull Modifier border, float f, long j, @NotNull Shape shape) {
        Intrinsics.checkNotNullParameter(border, "$this$border");
        Intrinsics.checkNotNullParameter(shape, "shape");
        return m184borderziNgDLE(border, f, new SolidColor(j, null), shape);
    }
    ...
    public static final Modifier m184borderziNgDLE(@NotNull Modifier border, float f, @NotNull Brush brush, @NotNull Shape shape) {
        Intrinsics.checkNotNullParameter(border, "$this$border");
    ...
    private static final RoundRect createInsetRoundedRect(float f, RoundRect roundRect) {
        return new RoundRect(f, f, roundRect.getWidth() - f, roundRect.getHeight() - f, m186shrinkKibmq7A(roundRect.m1497getTopLeftCornerRadiuskKHJgLs(), f), m186shrinkKibmq7A(roundRect.m1498getTopRightCornerRadiuskKHJgLs(), f), m186shrinkKibmq7A(roundRect.m1496getBottomRightCornerRadiuskKHJgLs(), f), m186shrinkKibmq7A(roundRect.m1495getBottomLeftCornerRadiuskKHJgLs(), f), null);
    }
    ...
    public static final Path createRoundRectPath(Path path, RoundRect roundRect, float f, boolean z) {
        ...
        if (!z) {
            ...
            path.mo1581opN5in7k0(path, Path, PathOperation.INSTANCE.m1944getDifferenceb3I0S0c());
        }
        return path;
    }
    ...
    public static final DrawResult m185drawRectBorderNsqcLGU(CacheDrawScope cacheDrawScope, final Brush brush, long j, long j2, boolean z, float f) {
        final long jM1463getZeroF1C5BW0 = z ? Offset.INSTANCE.m1463getZeroF1C5BW0() : j;
        final long jM1353getSizeNHjbRc = z ? cacheDrawScope.m1353getSizeNHjbRc() : j2;
        ...
        return cacheDrawScope.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderKt$drawRectBorder$1
            ...
            public final void invoke2(@NotNull ContentDrawScope onDrawWithContent) {
                Intrinsics.checkNotNullParameter(onDrawWithContent, "$this$onDrawWithContent");
                onDrawWithContent.drawContent();
                androidx.compose.ui.graphics.drawscope.OooO0O0.Oooo0O0(onDrawWithContent, brush, jM1463getZeroF1C5BW0, jM1353getSizeNHjbRc, 0.0f, stroke, null, 0, 104, null);
            }
        });
    }
    ...
    public static final long m186shrinkKibmq7A(long j, float f) {
        return CornerRadiusKt.CornerRadius(Math.max(0.0f, CornerRadius.m1422getXimpl(j) - f), Math.max(0.0f, CornerRadius.m1423getYimpl(j) - f));
    }
}
