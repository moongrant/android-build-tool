...
public final /* data */ class BorderModifierNodeElement extends ModifierNodeElement<BorderModifierNode> {
    ...
    public static /* synthetic */ BorderModifierNodeElement m191copy8Feqmps$default(BorderModifierNodeElement borderModifierNodeElement, float f, Brush brush, Shape shape, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return borderModifierNodeElement.m193copy8Feqmps(f, brush, shape);
    }
    ...
    public final BorderModifierNodeElement m193copy8Feqmps(float width, @NotNull Brush brush, @NotNull Shape shape) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Dp.m3780equalsimpl0(this.width, borderModifierNodeElement.width) && Intrinsics.areEqual(this.brush, borderModifierNodeElement.brush) && Intrinsics.areEqual(this.shape, borderModifierNodeElement.shape);
    }
    ...
    public final float m194getWidthD9Ej5fM() {
        return this.width;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return this.shape.hashCode() + ((this.brush.hashCode() + (Dp.m3781hashCodeimpl(this.width) * 31)) * 31);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void inspectableProperties(@NotNull InspectorInfo inspectorInfo) {
        OooOOO0.OooO00o(inspectorInfo, "<this>", OutlinedTextFieldKt.BorderId).set(ViewHierarchyConstants.DIMENSION_WIDTH_KEY, Dp.m3773boximpl(this.width));
        if (this.brush instanceof SolidColor) {
            inspectorInfo.getProperties().set("color", Color.m1671boximpl(((SolidColor) this.brush).getValue()));
            inspectorInfo.setValue(Color.m1671boximpl(((SolidColor) this.brush).getValue()));
        } else {
    ...
    public String toString() {
        return "BorderModifierNodeElement(width=" + ((Object) Dp.m3786toStringimpl(this.width)) + ", brush=" + this.brush + ", shape=" + this.shape + ')';
    }
    ...
    public void update(@NotNull BorderModifierNode node) {
        ...
        node.m190setWidth0680j_4(this.width);
