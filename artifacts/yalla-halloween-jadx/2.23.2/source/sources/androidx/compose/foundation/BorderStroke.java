...
public final class BorderStroke {
    ...
    public static /* synthetic */ BorderStroke m195copyD5KLDUw$default(BorderStroke borderStroke, float f, Brush brush, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return borderStroke.m196copyD5KLDUw(f, brush);
    }

    @NotNull
    /* JADX INFO: renamed from: copy-D5KLDUw, reason: not valid java name */
    public final BorderStroke m196copyD5KLDUw(float width, @NotNull Brush brush) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Dp.m3780equalsimpl0(this.width, borderStroke.width) && Intrinsics.areEqual(this.brush, borderStroke.brush);
    }
    ...
    public int hashCode() {
        return this.brush.hashCode() + (Dp.m3781hashCodeimpl(this.width) * 31);
    }

    @NotNull
    public String toString() {
        return "BorderStroke(width=" + ((Object) Dp.m3786toStringimpl(this.width)) + ", brush=" + this.brush + ')';
    }
