...
final class ClickableElement extends ModifierNodeElement<ClickableNode> {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!Intrinsics.areEqual(ClickableElement.class, other != null ? other.getClass() : null)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        return this.onClick.hashCode() + ((iHashCode2 + (role != null ? Role.m3162hashCodeimpl(role.getValue()) : 0)) * 31);
    }
    ...
    public void update(@NotNull ClickableNode node) {
        ...
        node.m213updateXHw0xAI(this.interactionSource, this.enabled, this.onClickLabel, this.role, this.onClick);
    }
