...
final class ClickableNode extends AbstractClickableNode {
    ...
    public final void m213updateXHw0xAI(@NotNull MutableInteractionSource interactionSource, boolean enabled, @Nullable String onClickLabel, @Nullable Role role, @NotNull Function0<Unit> onClick) {
        Intrinsics.checkNotNullParameter(interactionSource, "interactionSource");
        Intrinsics.checkNotNullParameter(onClick, "onClick");
        m156updateCommonXHw0xAI(interactionSource, enabled, onClickLabel, role, onClick);
        getClickableSemanticsNode().m216updateUMe6uN4(enabled, onClickLabel, role, onClick, null, null);
