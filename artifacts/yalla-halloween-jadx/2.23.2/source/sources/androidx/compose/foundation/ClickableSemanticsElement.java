...
final class ClickableSemanticsElement extends ModifierNodeElement<ClickableSemanticsNode> {
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        int iHashCode = (i + (role != null ? role.hashCode() : 0)) * 31;
    ...
    public void update(@NotNull ClickableSemanticsNode node) {
        ...
        node.m216updateUMe6uN4(this.enabled, this.onClickLabel, this.role, this.onClick, this.onLongClickLabel, this.onLongClick);
    }
}
