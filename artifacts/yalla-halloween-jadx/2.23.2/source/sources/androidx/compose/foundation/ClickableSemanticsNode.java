...
final class ClickableSemanticsNode extends Modifier.Node implements SemanticsModifierNode {
    ...
    public void applySemantics(@NotNull SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        if (role != null) {
            ...
            SemanticsPropertiesKt.m3179setRolekuIjeqM(semanticsPropertyReceiver, role.getValue());
        }
    ...
    public final void m216updateUMe6uN4(boolean enabled, @Nullable String onClickLabel, @Nullable Role role, @NotNull Function0<Unit> onClick, @Nullable String onLongClickLabel, @Nullable Function0<Unit> onLongClick) {
