...
public final class Clickable_androidKt {
    ...
    public static final boolean m217isClickZmokQxo(@NotNull KeyEvent isClick) {
        Intrinsics.checkNotNullParameter(isClick, "$this$isClick");
        return KeyEventType.m2578equalsimpl0(KeyEvent_androidKt.m2586getTypeZmokQxo(isClick), KeyEventType.INSTANCE.m2583getKeyUpCS__XNY()) && m218isEnterZmokQxo(isClick);
    }
    ...
    private static final boolean m218isEnterZmokQxo(KeyEvent keyEvent) {
        int iM2592getNativeKeyCodeYVgTNJs = Key_androidKt.m2592getNativeKeyCodeYVgTNJs(KeyEvent_androidKt.m2585getKeyZmokQxo(keyEvent));
        return iM2592getNativeKeyCodeYVgTNJs == 23 || iM2592getNativeKeyCodeYVgTNJs == 66 || iM2592getNativeKeyCodeYVgTNJs == 160;
    }
    ...
    public static final boolean m219isPressZmokQxo(@NotNull KeyEvent isPress) {
        Intrinsics.checkNotNullParameter(isPress, "$this$isPress");
        return KeyEventType.m2578equalsimpl0(KeyEvent_androidKt.m2586getTypeZmokQxo(isPress), KeyEventType.INSTANCE.m2582getKeyDownCS__XNY()) && m218isEnterZmokQxo(isPress);
    }
}
