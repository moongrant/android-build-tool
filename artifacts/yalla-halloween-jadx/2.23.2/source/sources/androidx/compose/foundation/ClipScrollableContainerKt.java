...
public final class ClipScrollableContainerKt {
    ...
    private static final float MaxSupportedElevation = Dp.m3775constructorimpl(30);
    ...
    static {
        ...
        HorizontalScrollableClipModifier = ClipKt.clip(companion, new Shape() { // from class: androidx.compose.foundation.ClipScrollableContainerKt$HorizontalScrollableClipModifier$1
            ...
            public Outline mo220createOutlinePq9zytI(long size, @NotNull LayoutDirection layoutDirection, @NotNull Density density) {
                ...
                float fMo320roundToPx0680j_4 = density.mo320roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
                return new Outline.Rectangle(new Rect(0.0f, -fMo320roundToPx0680j_4, Size.m1516getWidthimpl(size), Size.m1513getHeightimpl(size) + fMo320roundToPx0680j_4));
            }
        });
        VerticalScrollableClipModifier = ClipKt.clip(companion, new Shape() { // from class: androidx.compose.foundation.ClipScrollableContainerKt$VerticalScrollableClipModifier$1
            ...
            public Outline mo220createOutlinePq9zytI(long size, @NotNull LayoutDirection layoutDirection, @NotNull Density density) {
                ...
                Intrinsics.checkNotNullParameter(density, "density");
                float fMo320roundToPx0680j_4 = density.mo320roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
                return new Outline.Rectangle(new Rect(-fMo320roundToPx0680j_4, 0.0f, Size.m1516getWidthimpl(size) + fMo320roundToPx0680j_4, Size.m1513getHeightimpl(size)));
            }
        });
    }
