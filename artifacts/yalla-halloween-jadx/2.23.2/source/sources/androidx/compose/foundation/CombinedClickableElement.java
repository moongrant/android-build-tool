...
final class CombinedClickableElement extends ModifierNodeElement<CombinedClickableNode> {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!Intrinsics.areEqual(CombinedClickableElement.class, other != null ? other.getClass() : null)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        int iHashCode3 = (this.onClick.hashCode() + ((iHashCode2 + (role != null ? Role.m3162hashCodeimpl(role.getValue()) : 0)) * 31)) * 31;
    ...
    public /* synthetic */ CombinedClickableElement(MutableInteractionSource mutableInteractionSource, boolean z, String str, Role role, Function0 function0, String str2, Function0 function1, Function0 function2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(mutableInteractionSource, z, str, (i & 8) != 0 ? null : role, function0, str2, function1, function2, null);
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void update(@NotNull CombinedClickableNode node) {
        Intrinsics.checkNotNullParameter(node, "node");
        node.m221updatecJG_KMw(this.interactionSource, this.enabled, this.onClickLabel, this.role, this.onClick, this.onLongClickLabel, this.onLongClick, this.onDoubleClick);
    }

    private CombinedClickableElement(MutableInteractionSource interactionSource, boolean z, String str, Role role, Function0<Unit> onClick, String str2, Function0<Unit> function0, Function0<Unit> function1) {
