...
final class CombinedClickableNode extends AbstractClickableNode {
    ...
    public final void m221updatecJG_KMw(@NotNull MutableInteractionSource interactionSource, boolean enabled, @Nullable String onClickLabel, @Nullable Role role, @NotNull Function0<Unit> onClick, @Nullable String onLongClickLabel, @Nullable Function0<Unit> onLongClick, @Nullable Function0<Unit> onDoubleClick) {
        ...
        m156updateCommonXHw0xAI(interactionSource, enabled, onClickLabel, role, onClick);
        getClickableSemanticsNode().m216updateUMe6uN4(enabled, onClickLabel, role, onClick, onLongClickLabel, onLongClick);
        getClickablePointerInputNode().update(enabled, interactionSource, onClick, onLongClick, onDoubleClick);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    private CombinedClickableNode(MutableInteractionSource interactionSource, boolean z, String str, Role role, Function0<Unit> onClick, String str2, Function0<Unit> function0, Function0<Unit> function1) {
        ...
        this.clickablePointerInputNode = (CombinedClickablePointerInputNode) delegate(new CombinedClickablePointerInputNode(z, interactionSource, onClick, getInteractionData(), this.onLongClick, function1));
    }
