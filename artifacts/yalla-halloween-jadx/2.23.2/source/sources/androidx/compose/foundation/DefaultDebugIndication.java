    ...
    public static final class DefaultDebugIndicationInstance implements IndicationInstance {
        ...
        public void drawIndication(@NotNull ContentDrawScope contentDrawScope) {
            ...
            if (this.isPressed.getValue().booleanValue()) {
                androidx.compose.ui.graphics.drawscope.OooO0O0.Oooo0OO(contentDrawScope, Color.m1680copywmQWz5c$default(Color.INSTANCE.m1707getBlack0d7_KjU(), 0.3f, 0.0f, 0.0f, 0.0f, 14, null), 0L, contentDrawScope.mo2118getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
            } else if (this.isHovered.getValue().booleanValue() || this.isFocused.getValue().booleanValue()) {
                androidx.compose.ui.graphics.drawscope.OooO0O0.Oooo0OO(contentDrawScope, Color.m1680copywmQWz5c$default(Color.INSTANCE.m1707getBlack0d7_KjU(), 0.1f, 0.0f, 0.0f, 0.0f, 14, null), 0L, contentDrawScope.mo2118getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
            }
        }
    }
