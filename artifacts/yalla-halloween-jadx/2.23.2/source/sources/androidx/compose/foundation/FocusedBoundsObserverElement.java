...
final class FocusedBoundsObserverElement extends ModifierNodeElement<FocusedBoundsObserverNode> {
    ...
    public FocusedBoundsObserverElement(@NotNull Function1<? super LayoutCoordinates, Unit> onPositioned) {
    ...
    public void inspectableProperties(@NotNull InspectorInfo inspectorInfo) {
        OooOOO0.OooO00o(inspectorInfo, "<this>", "onFocusedBoundsChanged").set("onPositioned", this.onPositioned);
    }
