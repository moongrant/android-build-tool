...
public final class PlatformMagnifierFactoryApi29Impl implements PlatformMagnifierFactory {
    ...
    public static final class PlatformMagnifierImpl extends PlatformMagnifierFactoryApi28Impl.PlatformMagnifierImpl {
        ...
        public void mo255updateWko1d7g(long sourceCenter, long magnifierCenter, float zoom) {
            ...
            if (OffsetKt.m1466isSpecifiedk4lQ0M(magnifierCenter)) {
                getMagnifier().show(Offset.m1447getXimpl(sourceCenter), Offset.m1448getYimpl(sourceCenter), Offset.m1447getXimpl(magnifierCenter), Offset.m1448getYimpl(magnifierCenter));
            } else {
                getMagnifier().show(Offset.m1447getXimpl(sourceCenter), Offset.m1448getYimpl(sourceCenter));
            }
        }
    }
    ...
    public PlatformMagnifierImpl create(@NotNull MagnifierStyle style, @NotNull View view, @NotNull Density density, float initialZoom) {
        ...
        long jMo327toSizeXkaWNTQ = density.mo327toSizeXkaWNTQ(style.getSize());
        float fMo326toPx0680j_4 = density.mo326toPx0680j_4(style.getCornerRadius());
        float fMo326toPx0680j_5 = density.mo326toPx0680j_4(style.getElevation());
        Magnifier.Builder builder = new Magnifier.Builder(view);
        if (jMo327toSizeXkaWNTQ != Size.INSTANCE.m1524getUnspecifiedNHjbRc()) {
            builder.setSize(MathKt.roundToInt(Size.m1516getWidthimpl(jMo327toSizeXkaWNTQ)), MathKt.roundToInt(Size.m1513getHeightimpl(jMo327toSizeXkaWNTQ)));
        }
        if (!Float.isNaN(fMo326toPx0680j_4)) {
            builder.setCornerRadius(fMo326toPx0680j_4);
        }
        if (!Float.isNaN(fMo326toPx0680j_5)) {
            builder.setElevation(fMo326toPx0680j_5);
        }
