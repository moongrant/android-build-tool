...
public final class ScrollKt {
    ...
    public static final ScrollState rememberScrollState(final int i, @Nullable Composer composer, int i2, int i3) {
        ...
        ScrollState scrollState = (ScrollState) RememberSaveableKt.m1333rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) objRememberedValue, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    private static final Modifier scroll(Modifier modifier, final ScrollState scrollState, final boolean z, final FlingBehavior flingBehavior, final boolean z2, final boolean z3) {
        return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.ScrollKt$scroll$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(@NotNull Modifier modifier2, @Nullable Composer composer, int i) {
                if (OooOOO.OooO0O0(modifier2, "$this$composed", composer, 1478351300)) {
                        ...
                        if (z6) {
                            ...
                            SemanticsPropertiesKt.scrollBy$default(semantics, null, new Function2<Float, Float, Boolean>() { // from class: androidx.compose.foundation.ScrollKt$scroll$2$semantics$1.1
                                ...
                                public static final class C00401 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                                    ...
                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                    public C00401(boolean z, ScrollState scrollState, float f, float f2, Continuation<? super C00401> continuation) {
                                    ...
                                    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                                        return new C00401(this.$isVertical, this.$state, this.$y, this.$x, continuation);
                                    }
                                ...
                                public final Boolean invoke(float f, float f2) {
                                    BuildersKt__Builders_commonKt.launch$default(coroutineScope2, null, null, new C00401(z7, scrollState5, f2, f, null), 3, null);
                                    return Boolean.TRUE;
                                }
                            }, 1, null);
                        }
