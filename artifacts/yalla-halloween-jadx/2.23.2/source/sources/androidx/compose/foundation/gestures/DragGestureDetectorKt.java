...
public final class DragGestureDetectorKt {
    ...
    private static final PointerDirectionConfig HorizontalPointerDirectionConfig = new PointerDirectionConfig() { // from class: androidx.compose.foundation.gestures.DragGestureDetectorKt$HorizontalPointerDirectionConfig$1
        ...
        public float mo289crossAxisDeltak4lQ0M(long offset) {
            return Offset.m1448getYimpl(offset);
        }

        @Override // androidx.compose.foundation.gestures.PointerDirectionConfig
        /* JADX INFO: renamed from: mainAxisDelta-k-4lQ0M, reason: not valid java name */
        public float mo290mainAxisDeltak4lQ0M(long offset) {
            return Offset.m1447getXimpl(offset);
        }

        @Override // androidx.compose.foundation.gestures.PointerDirectionConfig
        /* JADX INFO: renamed from: offsetFromChanges-dBAh8RU, reason: not valid java name */
        public long mo291offsetFromChangesdBAh8RU(float mainChange, float crossChange) {
    ...
    public static final class C06175 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ Function2<PointerInputChange, Offset, Unit> $onDrag;
        final /* synthetic */ Function0<Unit> $onDragCancel;
        final /* synthetic */ Function0<Unit> $onDragEnd;
        final /* synthetic */ Function1<Offset, Unit> $onDragStart;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C06175(Function1<? super Offset, Unit> function1, Function0<Unit> function0, Function0<Unit> function2, Function2<? super PointerInputChange, ? super Offset, Unit> function3, Continuation<? super C06175> continuation) {
            super(2, continuation);
            this.$onDragStart = function1;
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C06175 c06175 = new C06175(this.$onDragStart, this.$onDragEnd, this.$onDragCancel, this.$onDrag, continuation);
            c06175.L$0 = obj;
            return c06175;
        }
        ...
        @Nullable
        public final Object invoke(@NotNull AwaitPointerEventScope awaitPointerEventScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C06175) create(awaitPointerEventScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            try {
                    ...
                    if (i2 == 1) {
                        ...
                        if (i2 == 2) {
                            ...
                            if (pointerInputChange != null) {
                                this.$onDragStart.invoke(Offset.m1436boximpl(pointerInputChange.getPosition()));
                                ...
                                Function1<PointerInputChange, Unit> function1 = new Function1<PointerInputChange, Unit>() { // from class: androidx.compose.foundation.gestures.DragGestureDetectorKt.detectDragGesturesAfterLongPress.5.1
                                    ...
                                    public final void invoke2(@NotNull PointerInputChange it) {
                                        ...
                                        function2.invoke(it, Offset.m1436boximpl(PointerEventKt.positionChange(it)));
                                        it.consume();
                                    }
                                };
                                this.L$0 = awaitPointerEventScope;
                                this.label = 3;
                                obj = DragGestureDetectorKt.m284dragjO51t88(awaitPointerEventScope, id, function1, this);
                ...
                this.L$0 = awaitPointerEventScope;
                this.label = 2;
                obj = DragGestureDetectorKt.m274awaitLongPressOrCancellationrnUCldI(awaitPointerEventScope, id2, this);
                if (obj == coroutine_suspended) {
                    return coroutine_suspended;
                }
                pointerInputChange = (PointerInputChange) obj;
                if (pointerInputChange != null) {
                    ...
                    Function1<PointerInputChange, Unit> function4 = new Function1<PointerInputChange, Unit>() { // from class: androidx.compose.foundation.gestures.DragGestureDetectorKt.detectDragGesturesAfterLongPress.5.1
                        ...
                        public final void invoke2(@NotNull PointerInputChange it) {
                            Intrinsics.checkNotNullParameter(it, "it");
                            function3.invoke(it, Offset.m1436boximpl(PointerEventKt.positionChange(it)));
                            it.consume();
                        }
                    };
                    this.L$0 = awaitPointerEventScope;
                    this.label = 3;
                    obj = DragGestureDetectorKt.m284dragjO51t88(awaitPointerEventScope, id3, function4, this);
                    if (obj == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    awaitPointerEventScope2 = awaitPointerEventScope;
    ...
    public static final class C06215 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ Function0<Unit> $onDragCancel;
        final /* synthetic */ Function0<Unit> $onDragEnd;
        final /* synthetic */ Function1<Offset, Unit> $onDragStart;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C06215(Function1<? super Offset, Unit> function1, Function2<? super PointerInputChange, ? super Float, Unit> function2, Function0<Unit> function0, Function0<Unit> function3, Continuation<? super C06215> continuation) {
            super(2, continuation);
            this.$onDragStart = function1;
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C06215 c06215 = new C06215(this.$onDragStart, this.$onHorizontalDrag, this.$onDragEnd, this.$onDragCancel, continuation);
            c06215.L$0 = obj;
            return c06215;
        }
        ...
        @Nullable
        public final Object invoke(@NotNull AwaitPointerEventScope awaitPointerEventScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C06215) create(awaitPointerEventScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
                    ...
                    if (i == 2) {
                        ...
                        if (pointerInputChange != null) {
                            ...
                            Function1<PointerInputChange, Unit> function1 = new Function1<PointerInputChange, Unit>() { // from class: androidx.compose.foundation.gestures.DragGestureDetectorKt.detectHorizontalDragGestures.5.1
                                ...
                                public final void invoke2(@NotNull PointerInputChange it) {
                                    Intrinsics.checkNotNullParameter(it, "it");
                                    function2.invoke(it, Float.valueOf(Offset.m1447getXimpl(PointerEventKt.positionChange(it))));
                                    it.consume();
                                }
                            };
                            this.L$0 = null;
                            this.L$1 = null;
                            this.label = 3;
                            obj = DragGestureDetectorKt.m285horizontalDragjO51t88(awaitPointerEventScope2, id, function1, this);
                            if (obj == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                        }
            ...
            this.L$1 = floatRef2;
            this.label = 2;
            obj = DragGestureDetectorKt.m272awaitHorizontalPointerSlopOrCancellationgDDlDlE(awaitPointerEventScope, id2, type, function3, this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            awaitPointerEventScope2 = awaitPointerEventScope;
            ...
            if (pointerInputChange != null) {
                ...
                Function1<PointerInputChange, Unit> function5 = new Function1<PointerInputChange, Unit>() { // from class: androidx.compose.foundation.gestures.DragGestureDetectorKt.detectHorizontalDragGestures.5.1
                    ...
                    public final void invoke2(@NotNull PointerInputChange it) {
                        Intrinsics.checkNotNullParameter(it, "it");
                        function4.invoke(it, Float.valueOf(Offset.m1447getXimpl(PointerEventKt.positionChange(it))));
                        it.consume();
                    }
                };
                this.L$0 = null;
                this.L$1 = null;
                this.label = 3;
                obj = DragGestureDetectorKt.m285horizontalDragjO51t88(awaitPointerEventScope2, id3, function5, this);
                if (obj == coroutine_suspended) {
                    return coroutine_suspended;
                }
                if (((Boolean) obj).booleanValue()) {
    ...
    public static final class C06255 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ Function0<Unit> $onDragCancel;
        final /* synthetic */ Function0<Unit> $onDragEnd;
        final /* synthetic */ Function1<Offset, Unit> $onDragStart;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C06255(Function1<? super Offset, Unit> function1, Function2<? super PointerInputChange, ? super Float, Unit> function2, Function0<Unit> function0, Function0<Unit> function3, Continuation<? super C06255> continuation) {
            super(2, continuation);
            this.$onDragStart = function1;
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C06255 c06255 = new C06255(this.$onDragStart, this.$onVerticalDrag, this.$onDragEnd, this.$onDragCancel, continuation);
            c06255.L$0 = obj;
            return c06255;
        }
        ...
        @Nullable
        public final Object invoke(@NotNull AwaitPointerEventScope awaitPointerEventScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C06255) create(awaitPointerEventScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
                    ...
                    if (i == 2) {
                        ...
                        if (pointerInputChange != null) {
                            ...
                            Function1<PointerInputChange, Unit> function1 = new Function1<PointerInputChange, Unit>() { // from class: androidx.compose.foundation.gestures.DragGestureDetectorKt.detectVerticalDragGestures.5.1
                                ...
                                public final void invoke2(@NotNull PointerInputChange it) {
                                    Intrinsics.checkNotNullParameter(it, "it");
                                    function2.invoke(it, Float.valueOf(Offset.m1448getYimpl(PointerEventKt.positionChange(it))));
                                    it.consume();
                                }
                            };
                            this.L$0 = null;
                            this.L$1 = null;
                            this.label = 3;
                            obj = DragGestureDetectorKt.m288verticalDragjO51t88(awaitPointerEventScope2, id, function1, this);
                            if (obj == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                        }
            ...
            this.L$1 = floatRef2;
            this.label = 2;
            obj = DragGestureDetectorKt.m280awaitVerticalPointerSlopOrCancellationgDDlDlE(awaitPointerEventScope, id2, type, function3, this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            awaitPointerEventScope2 = awaitPointerEventScope;
            ...
            if (pointerInputChange != null) {
                ...
                Function1<PointerInputChange, Unit> function5 = new Function1<PointerInputChange, Unit>() { // from class: androidx.compose.foundation.gestures.DragGestureDetectorKt.detectVerticalDragGestures.5.1
                    ...
                    public final void invoke2(@NotNull PointerInputChange it) {
                        Intrinsics.checkNotNullParameter(it, "it");
                        function4.invoke(it, Float.valueOf(Offset.m1448getYimpl(PointerEventKt.positionChange(it))));
                        it.consume();
                    }
                };
                this.L$0 = null;
                this.L$1 = null;
                this.label = 3;
                obj = DragGestureDetectorKt.m288verticalDragjO51t88(awaitPointerEventScope2, id3, function5, this);
                if (obj == coroutine_suspended) {
                    return coroutine_suspended;
                }
                if (((Boolean) obj).booleanValue()) {
    ...
    static {
        float fM3775constructorimpl = Dp.m3775constructorimpl((float) 0.125d);
        mouseSlop = fM3775constructorimpl;
        float fM3775constructorimpl2 = Dp.m3775constructorimpl(18);
        defaultTouchSlop = fM3775constructorimpl2;
        mouseToTouchSlopRatio = fM3775constructorimpl / fM3775constructorimpl2;
    }
    ...
    public static final java.lang.Object m269awaitDragOrCancellationrnUCldI(@org.jetbrains.annotations.NotNull androidx.compose.ui.input.pointer.AwaitPointerEventScope r17, long r18, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super androidx.compose.ui.input.pointer.PointerInputChange> r20) {
        /*
            Method dump skipped, instruction units count: 222
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.DragGestureDetectorKt.m269awaitDragOrCancellationrnUCldI(androidx.compose.ui.input.pointer.AwaitPointerEventScope, long, kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* JADX INFO: renamed from: awaitDragOrUp-jO51t88, reason: not valid java name */
    private static final Object m270awaitDragOrUpjO51t88(AwaitPointerEventScope awaitPointerEventScope, long j, Function1<? super PointerInputChange, Boolean> function1, Continuation<? super PointerInputChange> continuation) {
        PointerInputChange pointerInputChange;
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (Boolean.valueOf(PointerId.m2682equalsimpl0(pointerInputChange.getId(), longRef.element)).booleanValue()) {
                    break;
                }
                i++;
            }
    ...
    public static final java.lang.Object m271awaitHorizontalDragOrCancellationrnUCldI(@org.jetbrains.annotations.NotNull androidx.compose.ui.input.pointer.AwaitPointerEventScope r17, long r18, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super androidx.compose.ui.input.pointer.PointerInputChange> r20) {
        /*
            Method dump skipped, instruction units count: 235
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.DragGestureDetectorKt.m271awaitHorizontalDragOrCancellationrnUCldI(androidx.compose.ui.input.pointer.AwaitPointerEventScope, long, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public static final java.lang.Object m273awaitHorizontalTouchSlopOrCancellationjO51t88(@org.jetbrains.annotations.NotNull androidx.compose.ui.input.pointer.AwaitPointerEventScope r20, long r21, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function2<? super androidx.compose.ui.input.pointer.PointerInputChange, ? super java.lang.Float, kotlin.Unit> r23, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super androidx.compose.ui.input.pointer.PointerInputChange> r24) {
        /*
            Method dump skipped, instruction units count: 517
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.DragGestureDetectorKt.m273awaitHorizontalTouchSlopOrCancellationjO51t88(androidx.compose.ui.input.pointer.AwaitPointerEventScope, long, kotlin.jvm.functions.Function2, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public static final Object m274awaitLongPressOrCancellationrnUCldI(@NotNull AwaitPointerEventScope awaitPointerEventScope, long j, @NotNull Continuation<? super PointerInputChange> continuation) {
        ...
        if (i2 == 0) {
            ResultKt.throwOnFailure(obj);
            if (m286isPointerUpDmW0f2w(awaitPointerEventScope.getCurrentEvent(), j)) {
                return null;
            }
            ...
            while (true) {
                ...
                if (PointerId.m2682equalsimpl0(pointerInputChange.getId(), j)) {
                    break;
                }
                i3++;
            }
    ...
    public static final java.lang.Object m275awaitPointerSlopOrCancellationwtdNQyU(@org.jetbrains.annotations.NotNull androidx.compose.ui.input.pointer.AwaitPointerEventScope r21, long r22, int r24, @org.jetbrains.annotations.NotNull androidx.compose.foundation.gestures.PointerDirectionConfig r25, boolean r26, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function2<? super androidx.compose.ui.input.pointer.PointerInputChange, ? super androidx.compose.ui.geometry.Offset, kotlin.Unit> r27, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super androidx.compose.ui.input.pointer.PointerInputChange> r28) {
        /*
            Method dump skipped, instruction units count: 502
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.DragGestureDetectorKt.m275awaitPointerSlopOrCancellationwtdNQyU(androidx.compose.ui.input.pointer.AwaitPointerEventScope, long, int, androidx.compose.foundation.gestures.PointerDirectionConfig, boolean, kotlin.jvm.functions.Function2, kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* JADX INFO: renamed from: awaitPointerSlopOrCancellation-wtdNQyU$$forInline, reason: not valid java name */
    private static final Object m276awaitPointerSlopOrCancellationwtdNQyU$$forInline(AwaitPointerEventScope awaitPointerEventScope, long j, int i, PointerDirectionConfig pointerDirectionConfig, boolean z, Function2<? super PointerInputChange, ? super Offset, Unit> function2, Continuation<? super PointerInputChange> continuation) {
        float f;
        PointerInputChange pointerInputChange;
        long jM1451minusMKHz9U;
        PointerInputChange pointerInputChange2;
        if (m286isPointerUpDmW0f2w(awaitPointerEventScope.getCurrentEvent(), j)) {
            return null;
        }
        float fM287pointerSlopE8SPZFQ = m287pointerSlopE8SPZFQ(awaitPointerEventScope.getViewConfiguration(), i);
        Ref.LongRef longRef = new Ref.LongRef();
        longRef.element = j;
        float f2 = 0.0f;
        float fMo289crossAxisDeltak4lQ0M = 0.0f;
        while (true) {
            InlineMarker.mark(0);
            Object objOooOo00 = androidx.compose.ui.input.pointer.OooO0O0.OooOo00(awaitPointerEventScope, null, continuation, 1, null);
            InlineMarker.mark(1);
            ...
            if (PointerEventKt.changedToUpIgnoreConsumed(pointerInputChange3)) {
                ...
                float fMo290mainAxisDeltak4lQ0M = f + (pointerDirectionConfig.mo290mainAxisDeltak4lQ0M(position) - pointerDirectionConfig.mo290mainAxisDeltak4lQ0M(previousPosition));
                fMo289crossAxisDeltak4lQ0M += pointerDirectionConfig.mo289crossAxisDeltak4lQ0M(position) - pointerDirectionConfig.mo289crossAxisDeltak4lQ0M(previousPosition);
                float fAbs = z ? Math.abs(fMo290mainAxisDeltak4lQ0M) : Offset.m1445getDistanceimpl(pointerDirectionConfig.mo291offsetFromChangesdBAh8RU(fMo290mainAxisDeltak4lQ0M, fMo289crossAxisDeltak4lQ0M));
                if (fAbs < fM287pointerSlopE8SPZFQ) {
                    ...
                    f = fMo290mainAxisDeltak4lQ0M;
                } else {
                    if (z) {
                        jM1451minusMKHz9U = pointerDirectionConfig.mo291offsetFromChangesdBAh8RU(fMo290mainAxisDeltak4lQ0M - (Math.signum(fMo290mainAxisDeltak4lQ0M) * fM287pointerSlopE8SPZFQ), fMo289crossAxisDeltak4lQ0M);
                    } else {
                        long jMo291offsetFromChangesdBAh8RU = pointerDirectionConfig.mo291offsetFromChangesdBAh8RU(fMo290mainAxisDeltak4lQ0M, fMo289crossAxisDeltak4lQ0M);
                        jM1451minusMKHz9U = Offset.m1451minusMKHz9U(jMo291offsetFromChangesdBAh8RU, Offset.m1454timestuRUvjQ(Offset.m1442divtuRUvjQ(jMo291offsetFromChangesdBAh8RU, fAbs), fM287pointerSlopE8SPZFQ));
                    }
                    function2.invoke(pointerInputChange3, Offset.m1436boximpl(jM1451minusMKHz9U));
                    if (pointerInputChange3.isConsumed()) {
                        return pointerInputChange3;
                    }
                    fMo289crossAxisDeltak4lQ0M = 0.0f;
                    f = 0.0f;
                }
                f2 = f;
            }
    ...
    public static /* synthetic */ Object m277awaitPointerSlopOrCancellationwtdNQyU$default(AwaitPointerEventScope awaitPointerEventScope, long j, int i, PointerDirectionConfig pointerDirectionConfig, boolean z, Function2 function2, Continuation continuation, int i2, Object obj) {
        Object obj2;
        PointerInputChange pointerInputChange;
        Object obj3;
        float fAbs;
        ...
        if (m286isPointerUpDmW0f2w(awaitPointerEventScope.getCurrentEvent(), id)) {
            return null;
        }
        float fM287pointerSlopE8SPZFQ = m287pointerSlopE8SPZFQ(awaitPointerEventScope.getViewConfiguration(), i);
        while (true) {
            float fMo290mainAxisDeltak4lQ0M = 0.0f;
            float fMo289crossAxisDeltak4lQ0M = 0.0f;
            while (true) {
                int i4 = 0;
                InlineMarker.mark(0);
                ...
                while (true) {
                    if (i5 >= size) {
                        fM287pointerSlopE8SPZFQ = fM287pointerSlopE8SPZFQ;
                        obj2 = pointerEventPass;
                        break;
                    }
                    obj2 = changes.get(i5);
                    fM287pointerSlopE8SPZFQ = fM287pointerSlopE8SPZFQ;
                    if (PointerId.m2682equalsimpl0(((PointerInputChange) obj2).getId(), id)) {
                        break;
                    }
                    i5++;
                    fM287pointerSlopE8SPZFQ = fM287pointerSlopE8SPZFQ;
                ...
                if (PointerEventKt.changedToUpIgnoreConsumed(pointerInputChange)) {
                    ...
                    fMo290mainAxisDeltak4lQ0M += horizontalPointerDirectionConfig.mo290mainAxisDeltak4lQ0M(position) - horizontalPointerDirectionConfig.mo290mainAxisDeltak4lQ0M(previousPosition);
                    fMo289crossAxisDeltak4lQ0M += horizontalPointerDirectionConfig.mo289crossAxisDeltak4lQ0M(position) - horizontalPointerDirectionConfig.mo289crossAxisDeltak4lQ0M(previousPosition);
                    fAbs = z2 ? Math.abs(fMo290mainAxisDeltak4lQ0M) : Offset.m1445getDistanceimpl(horizontalPointerDirectionConfig.mo291offsetFromChangesdBAh8RU(fMo290mainAxisDeltak4lQ0M, fMo289crossAxisDeltak4lQ0M));
                    if (fAbs < fM287pointerSlopE8SPZFQ) {
            ...
            if (z2) {
                jM1451minusMKHz9U = horizontalPointerDirectionConfig.mo291offsetFromChangesdBAh8RU(fMo290mainAxisDeltak4lQ0M - (Math.signum(fMo290mainAxisDeltak4lQ0M) * fM287pointerSlopE8SPZFQ), fMo289crossAxisDeltak4lQ0M);
                fM287pointerSlopE8SPZFQ = fM287pointerSlopE8SPZFQ;
            } else {
                long jMo291offsetFromChangesdBAh8RU = horizontalPointerDirectionConfig.mo291offsetFromChangesdBAh8RU(fMo290mainAxisDeltak4lQ0M, fMo289crossAxisDeltak4lQ0M);
                long jM1442divtuRUvjQ = Offset.m1442divtuRUvjQ(jMo291offsetFromChangesdBAh8RU, fAbs);
                fM287pointerSlopE8SPZFQ = fM287pointerSlopE8SPZFQ;
                jM1451minusMKHz9U = Offset.m1451minusMKHz9U(jMo291offsetFromChangesdBAh8RU, Offset.m1454timestuRUvjQ(jM1442divtuRUvjQ, fM287pointerSlopE8SPZFQ));
            }
            function2.invoke(pointerInputChange, Offset.m1436boximpl(jM1451minusMKHz9U));
            if (pointerInputChange.isConsumed()) {
    ...
    public static final java.lang.Object m278awaitTouchSlopOrCancellationjO51t88(@org.jetbrains.annotations.NotNull androidx.compose.ui.input.pointer.AwaitPointerEventScope r19, long r20, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function2<? super androidx.compose.ui.input.pointer.PointerInputChange, ? super androidx.compose.ui.geometry.Offset, kotlin.Unit> r22, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super androidx.compose.ui.input.pointer.PointerInputChange> r23) {
        /*
            Method dump skipped, instruction units count: 521
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.DragGestureDetectorKt.m278awaitTouchSlopOrCancellationjO51t88(androidx.compose.ui.input.pointer.AwaitPointerEventScope, long, kotlin.jvm.functions.Function2, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public static final java.lang.Object m279awaitVerticalDragOrCancellationrnUCldI(@org.jetbrains.annotations.NotNull androidx.compose.ui.input.pointer.AwaitPointerEventScope r17, long r18, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super androidx.compose.ui.input.pointer.PointerInputChange> r20) {
        /*
            Method dump skipped, instruction units count: 235
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.DragGestureDetectorKt.m279awaitVerticalDragOrCancellationrnUCldI(androidx.compose.ui.input.pointer.AwaitPointerEventScope, long, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public static final java.lang.Object m280awaitVerticalPointerSlopOrCancellationgDDlDlE(@org.jetbrains.annotations.NotNull androidx.compose.ui.input.pointer.AwaitPointerEventScope r21, long r22, int r24, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function2<? super androidx.compose.ui.input.pointer.PointerInputChange, ? super java.lang.Float, kotlin.Unit> r25, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super androidx.compose.ui.input.pointer.PointerInputChange> r26) {
        /*
            Method dump skipped, instruction units count: 509
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.DragGestureDetectorKt.m280awaitVerticalPointerSlopOrCancellationgDDlDlE(androidx.compose.ui.input.pointer.AwaitPointerEventScope, long, int, kotlin.jvm.functions.Function2, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public static final java.lang.Object m281awaitVerticalTouchSlopOrCancellationjO51t88(@org.jetbrains.annotations.NotNull androidx.compose.ui.input.pointer.AwaitPointerEventScope r20, long r21, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function2<? super androidx.compose.ui.input.pointer.PointerInputChange, ? super java.lang.Float, kotlin.Unit> r23, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super androidx.compose.ui.input.pointer.PointerInputChange> r24) {
        /*
            Method dump skipped, instruction units count: 517
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.DragGestureDetectorKt.m281awaitVerticalTouchSlopOrCancellationjO51t88(androidx.compose.ui.input.pointer.AwaitPointerEventScope, long, kotlin.jvm.functions.Function2, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public static final Object detectDragGesturesAfterLongPress(@NotNull PointerInputScope pointerInputScope, @NotNull Function1<? super Offset, Unit> function1, @NotNull Function0<Unit> function0, @NotNull Function0<Unit> function2, @NotNull Function2<? super PointerInputChange, ? super Offset, Unit> function3, @NotNull Continuation<? super Unit> continuation) {
        Object objAwaitEachGesture = ForEachGestureKt.awaitEachGesture(pointerInputScope, new C06175(function1, function0, function2, function3, null), continuation);
        return objAwaitEachGesture == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objAwaitEachGesture : Unit.INSTANCE;
    }
    ...
    public static final Object detectHorizontalDragGestures(@NotNull PointerInputScope pointerInputScope, @NotNull Function1<? super Offset, Unit> function1, @NotNull Function0<Unit> function0, @NotNull Function0<Unit> function2, @NotNull Function2<? super PointerInputChange, ? super Float, Unit> function3, @NotNull Continuation<? super Unit> continuation) {
        Object objAwaitEachGesture = ForEachGestureKt.awaitEachGesture(pointerInputScope, new C06215(function1, function3, function0, function2, null), continuation);
        return objAwaitEachGesture == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objAwaitEachGesture : Unit.INSTANCE;
    }
    ...
    public static final Object detectVerticalDragGestures(@NotNull PointerInputScope pointerInputScope, @NotNull Function1<? super Offset, Unit> function1, @NotNull Function0<Unit> function0, @NotNull Function0<Unit> function2, @NotNull Function2<? super PointerInputChange, ? super Float, Unit> function3, @NotNull Continuation<? super Unit> continuation) {
        Object objAwaitEachGesture = ForEachGestureKt.awaitEachGesture(pointerInputScope, new C06255(function1, function3, function0, function2, null), continuation);
        return objAwaitEachGesture == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objAwaitEachGesture : Unit.INSTANCE;
    }
    ...
    public static final java.lang.Object m282dragVnAYq1g(@org.jetbrains.annotations.NotNull androidx.compose.ui.input.pointer.AwaitPointerEventScope r19, long r20, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function1<? super androidx.compose.ui.input.pointer.PointerInputChange, kotlin.Unit> r22, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function1<? super androidx.compose.ui.input.pointer.PointerInputChange, java.lang.Float> r23, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function1<? super androidx.compose.ui.input.pointer.PointerInputChange, java.lang.Boolean> r24, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super androidx.compose.ui.input.pointer.PointerInputChange> r25) {
        /*
            Method dump skipped, instruction units count: 315
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.DragGestureDetectorKt.m282dragVnAYq1g(androidx.compose.ui.input.pointer.AwaitPointerEventScope, long, kotlin.jvm.functions.Function1, kotlin.jvm.functions.Function1, kotlin.jvm.functions.Function1, kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: drag-VnAYq1g$$forInline, reason: not valid java name */
    private static final Object m283dragVnAYq1g$$forInline(AwaitPointerEventScope awaitPointerEventScope, long j, Function1<? super PointerInputChange, Unit> function1, Function1<? super PointerInputChange, Float> function2, Function1<? super PointerInputChange, Boolean> function3, Continuation<? super PointerInputChange> continuation) {
        PointerInputChange pointerInputChange;
        PointerInputChange pointerInputChange2;
    ...
    public static final java.lang.Object m284dragjO51t88(@org.jetbrains.annotations.NotNull androidx.compose.ui.input.pointer.AwaitPointerEventScope r4, long r5, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function1<? super androidx.compose.ui.input.pointer.PointerInputChange, kotlin.Unit> r7, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super java.lang.Boolean> r8) {
        ...
        L3e:
            ...
            r0.L$1 = r7
            r0.label = r3
            java.lang.Object r8 = m269awaitDragOrCancellationrnUCldI(r4, r5, r0)
            if (r8 != r1) goto L4b
            return r1
        L4b:
    ...
    public static final float m287pointerSlopE8SPZFQ(@NotNull ViewConfiguration pointerSlop, int i) {
        Intrinsics.checkNotNullParameter(pointerSlop, "$this$pointerSlop");
        return PointerType.m2757equalsimpl0(i, PointerType.INSTANCE.m2762getMouseT8wyACA()) ? pointerSlop.getTouchSlop() * mouseToTouchSlopRatio : pointerSlop.getTouchSlop();
    }
