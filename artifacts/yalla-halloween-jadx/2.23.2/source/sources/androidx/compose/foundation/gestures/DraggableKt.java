...
public final class DraggableKt {
    ...
    public static final class C06261 extends SuspendLambda implements Function3<CoroutineScope, Offset, Continuation<? super Unit>, Object> {
        int label;
        ...
        public /* bridge */ /* synthetic */ Object invoke(CoroutineScope coroutineScope, Offset offset, Continuation<? super Unit> continuation) {
            return m305invoked4ec7I(coroutineScope, offset.getPackedValue(), continuation);
        }

        @Nullable
        /* JADX INFO: renamed from: invoke-d-4ec7I, reason: not valid java name */
        public final Object m305invoked4ec7I(@NotNull CoroutineScope coroutineScope, long j, @Nullable Continuation<? super Unit> continuation) {
            return new C06261(continuation).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final class AnonymousClass5 extends SuspendLambda implements Function3<CoroutineScope, Velocity, Continuation<? super Unit>, Object> {
        ...
        public /* bridge */ /* synthetic */ Object invoke(CoroutineScope coroutineScope, Velocity velocity, Continuation<? super Unit> continuation) {
            return m306invokeLuvzFrg(coroutineScope, velocity.getPackedValue(), continuation);
        }

        @Nullable
        /* JADX INFO: renamed from: invoke-LuvzFrg, reason: not valid java name */
        public final Object m306invokeLuvzFrg(@NotNull CoroutineScope coroutineScope, long j, @Nullable Continuation<? super Unit> continuation) {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                ...
                Float fBoxFloat = Boxing.boxFloat(DraggableKt.m303toFloatsFctU(j, this.$orientation));
                this.label = 1;
    ...
    public static final Object m300awaitDragSu4bsnU(AwaitPointerEventScope awaitPointerEventScope, PointerInputChange pointerInputChange, long j, final VelocityTracker velocityTracker, final SendChannel<? super DragEvent> sendChannel, final boolean z, Orientation orientation, Continuation<? super Boolean> continuation) {
        sendChannel.mo5733trySendJP2dKIU(new DragEvent.DragStarted(Offset.m1451minusMKHz9U(pointerInputChange.getPosition(), OffsetKt.Offset(Offset.m1447getXimpl(j) * Math.signum(Offset.m1447getXimpl(pointerInputChange.getPosition())), Offset.m1448getYimpl(j) * Math.signum(Offset.m1448getYimpl(pointerInputChange.getPosition())))), null));
        sendChannel.mo5733trySendJP2dKIU(new DragEvent.DragDelta(z ? Offset.m1454timestuRUvjQ(j, -1.0f) : j, null));
        return m301onDragOrUpAxegvzg(awaitPointerEventScope, orientation, pointerInputChange.getId(), new Function1<PointerInputChange, Unit>() { // from class: androidx.compose.foundation.gestures.DraggableKt$awaitDrag$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final void invoke2(@NotNull PointerInputChange event) {
                ...
                if (z) {
                    jPositionChange = Offset.m1454timestuRUvjQ(jPositionChange, -1.0f);
                }
                sendChannel2.mo5733trySendJP2dKIU(new DragEvent.DragDelta(jPositionChange, null));
            }
        }, continuation);
    }
    ...
    public static final java.lang.Object m301onDragOrUpAxegvzg(androidx.compose.ui.input.pointer.AwaitPointerEventScope r17, androidx.compose.foundation.gestures.Orientation r18, long r19, kotlin.jvm.functions.Function1<? super androidx.compose.ui.input.pointer.PointerInputChange, kotlin.Unit> r21, kotlin.coroutines.Continuation<? super java.lang.Boolean> r22) {
        /*
            Method dump skipped, instruction units count: 337
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.DraggableKt.m301onDragOrUpAxegvzg(androidx.compose.ui.input.pointer.AwaitPointerEventScope, androidx.compose.foundation.gestures.Orientation, long, kotlin.jvm.functions.Function1, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public static final float m302toFloat3MmeM6k(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Offset.m1448getYimpl(j) : Offset.m1447getXimpl(j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: toFloat-sF-c-tU, reason: not valid java name */
    public static final float m303toFloatsFctU(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Velocity.m4001getYimpl(j) : Velocity.m4000getXimpl(j);
    }
}
