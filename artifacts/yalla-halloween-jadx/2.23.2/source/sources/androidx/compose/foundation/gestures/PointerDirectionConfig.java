...
public interface PointerDirectionConfig {
    ...
    float mo289crossAxisDeltak4lQ0M(long offset);

    /* JADX INFO: renamed from: mainAxisDelta-k-4lQ0M */
    float mo290mainAxisDeltak4lQ0M(long offset);

    /* JADX INFO: renamed from: offsetFromChanges-dBAh8RU */
    long mo291offsetFromChangesdBAh8RU(float mainChange, float crossChange);
}
