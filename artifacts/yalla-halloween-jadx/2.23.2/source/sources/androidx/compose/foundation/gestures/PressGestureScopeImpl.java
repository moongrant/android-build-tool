...
final class PressGestureScopeImpl implements PressGestureScope, Density {
    ...
    public static final class C06301 extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        public C06301(Continuation<? super C06301> continuation) {
            super(continuation);
        }
    ...
    public static final class C06311 extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    public final Object reset(@NotNull Continuation<? super Unit> continuation) {
        ...
        if (i2 == 0) {
            ...
            c06301.L$0 = this;
            c06301.label = 1;
            if (Mutex.DefaultImpls.lock$default(mutex, null, c06301, 1, null) == coroutine_suspended) {
                return coroutine_suspended;
            }
            ...
            pressGestureScopeImpl = (PressGestureScopeImpl) c06301.L$0;
            ResultKt.throwOnFailure(obj);
        }
    ...
    public Object tryAwaitRelease(@NotNull Continuation<? super Boolean> continuation) {
        ...
        if (i2 == 0) {
            ...
            if (this.isReleased || this.isCanceled) {
                ...
                c06311.L$0 = this;
                c06311.label = 1;
                if (Mutex.DefaultImpls.lock$default(mutex, null, c06311, 1, null) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                pressGestureScopeImpl = this;
            }
        ...
        pressGestureScopeImpl = (PressGestureScopeImpl) c06311.L$0;
        ResultKt.throwOnFailure(obj);
