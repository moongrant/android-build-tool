...
public final class ScrollableKt {
    ...
    public static final class C06361 implements NestedScrollConnection {
        final /* synthetic */ boolean $enabled;
        final /* synthetic */ State<ScrollingLogic> $scrollLogic;

        public C06361(State<ScrollingLogic> state, boolean z) {
        ...
        public Object mo333onPostFlingRZ2iAVY(long j, long j2, @NotNull Continuation<? super Velocity> continuation) {
            ...
            Object objM338doFlingAnimationQWom1Mo = scrollableKt$scrollableNestedScrollConnection$1$onPostFling$1.result;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i2 = scrollableKt$scrollableNestedScrollConnection$1$onPostFling$1.label;
            if (i2 == 0) {
                ResultKt.throwOnFailure(objM338doFlingAnimationQWom1Mo);
                if (this.$enabled) {
                    ...
                    objM338doFlingAnimationQWom1Mo = value.m338doFlingAnimationQWom1Mo(j2, scrollableKt$scrollableNestedScrollConnection$1$onPostFling$1);
                ...
                Velocity velocityM3991boximpl = Velocity.m3991boximpl(jM4011getZero9UxMQ8M);
                State<ScrollingLogic> state = c06361.$scrollLogic;
                velocityM3991boximpl.getPackedValue();
                state.getValue().registerNestedFling(false);
                return velocityM3991boximpl;
            }
            if (i2 != 1) {
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
            j2 = scrollableKt$scrollableNestedScrollConnection$1$onPostFling$1.J$0;
            c06361 = (C06361) scrollableKt$scrollableNestedScrollConnection$1$onPostFling$1.L$0;
            ResultKt.throwOnFailure(objM338doFlingAnimationQWom1Mo);
            jM4011getZero9UxMQ8M = Velocity.m4003minusAH228Gc(j2, ((Velocity) objM338doFlingAnimationQWom1Mo).getPackedValue());
            Velocity velocityM3991boximpl2 = Velocity.m3991boximpl(jM4011getZero9UxMQ8M);
            State<ScrollingLogic> state2 = c06361.$scrollLogic;
            velocityM3991boximpl2.getPackedValue();
            state2.getValue().registerNestedFling(false);
            return velocityM3991boximpl2;
        }
        ...
        public long mo334onPostScrollDzOQY0M(long consumed, long available, int source) {
            return this.$enabled ? this.$scrollLogic.getValue().m340performRawScrollMKHz9U(available) : Offset.INSTANCE.m1463getZeroF1C5BW0();
        }
        ...
        public long mo336onPreScrollOzD1aCk(long available, int source) {
            if (NestedScrollSource.m2604equalsimpl0(source, NestedScrollSource.INSTANCE.m2610getFlingWNlRxjI())) {
    ...
    public static final java.lang.Object awaitScrollEvent(androidx.compose.ui.input.pointer.AwaitPointerEventScope r5, kotlin.coroutines.Continuation<? super androidx.compose.ui.input.pointer.PointerEvent> r6) {
        ...
        L44:
            ...
            int r4 = r4.m2658getScroll7fucELk()
            boolean r2 = androidx.compose.ui.input.pointer.PointerEventType.m2649equalsimpl0(r2, r4)
            if (r2 == 0) goto L38
            return r6
        */
    ...
    public static final Modifier pointerScrollable(Modifier modifier, MutableInteractionSource mutableInteractionSource, Orientation orientation, boolean z, ScrollableState scrollableState, FlingBehavior flingBehavior, OverscrollEffect overscrollEffect, boolean z2, Composer composer, int i) {
        ...
        C06351 c06351 = new Function1<PointerInputChange, Boolean>() { // from class: androidx.compose.foundation.gestures.ScrollableKt.pointerScrollable.1
            @Override // kotlin.jvm.functions.Function1
            @NotNull
            public final Boolean invoke(@NotNull PointerInputChange down) {
                Intrinsics.checkNotNullParameter(down, "down");
                return Boolean.valueOf(!PointerType.m2757equalsimpl0(down.getType(), PointerType.INSTANCE.m2762getMouseT8wyACA()));
            }
        };
    ...
    public static final Modifier scrollable(@NotNull Modifier modifier, @NotNull final ScrollableState state, @NotNull final Orientation orientation, @Nullable final OverscrollEffect overscrollEffect, final boolean z, final boolean z2, @Nullable final FlingBehavior flingBehavior, @Nullable final MutableInteractionSource mutableInteractionSource) {
        ...
        return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.gestures.ScrollableKt$scrollable$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(@NotNull Modifier modifier2, @Nullable Composer composer, int i) {
                if (OooOOO.OooO0O0(modifier2, "$this$composed", composer, -629830927)) {
