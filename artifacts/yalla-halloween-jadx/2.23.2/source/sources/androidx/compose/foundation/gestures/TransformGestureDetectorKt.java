...
public final class TransformGestureDetectorKt {
    ...
    private static final float m353anglek4lQ0M(long j) {
        if (Offset.m1447getXimpl(j) == 0.0f) {
            if (Offset.m1448getYimpl(j) == 0.0f) {
                return 0.0f;
            }
        }
        return ((-((float) Math.atan2(Offset.m1447getXimpl(j), Offset.m1448getYimpl(j)))) * 180.0f) / 3.1415927f;
    }
    ...
    public static final long calculateCentroid(@NotNull PointerEvent pointerEvent, boolean z) {
        ...
        long jM1463getZeroF1C5BW0 = Offset.INSTANCE.m1463getZeroF1C5BW0();
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                jM1463getZeroF1C5BW0 = Offset.m1452plusMKHz9U(jM1463getZeroF1C5BW0, z ? pointerInputChange.getPosition() : pointerInputChange.getPreviousPosition());
                i++;
            }
        }
        return i == 0 ? Offset.INSTANCE.m1462getUnspecifiedF1C5BW0() : Offset.m1442divtuRUvjQ(jM1463getZeroF1C5BW0, i);
    }
    ...
    public static final float calculateCentroidSize(@NotNull PointerEvent pointerEvent, boolean z) {
        ...
        float fM1445getDistanceimpl = 0.0f;
        if (Offset.m1444equalsimpl0(jCalculateCentroid, Offset.INSTANCE.m1462getUnspecifiedF1C5BW0())) {
            return 0.0f;
        }
        List<PointerInputChange> changes = pointerEvent.getChanges();
        int size = changes.size();
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                i++;
                fM1445getDistanceimpl = Offset.m1445getDistanceimpl(Offset.m1451minusMKHz9U(z ? pointerInputChange.getPosition() : pointerInputChange.getPreviousPosition(), jCalculateCentroid)) + fM1445getDistanceimpl;
            }
        }
        return fM1445getDistanceimpl / i;
    }
    ...
    public static final long calculatePan(@NotNull PointerEvent pointerEvent) {
        ...
        return Offset.m1444equalsimpl0(jCalculateCentroid, companion.m1462getUnspecifiedF1C5BW0()) ? companion.m1463getZeroF1C5BW0() : Offset.m1451minusMKHz9U(jCalculateCentroid, calculateCentroid(pointerEvent, false));
    }
    ...
    public static final float calculateRotation(@NotNull PointerEvent pointerEvent) {
        ...
        while (i4 < size2) {
            ...
            if (pointerInputChange2.getPressed() && pointerInputChange2.getPreviousPressed()) {
                ...
                long jM1451minusMKHz9U = Offset.m1451minusMKHz9U(pointerInputChange2.getPreviousPosition(), jCalculateCentroid2);
                long jM1451minusMKHz9U2 = Offset.m1451minusMKHz9U(position, jCalculateCentroid);
                float fM353anglek4lQ0M = m353anglek4lQ0M(jM1451minusMKHz9U2) - m353anglek4lQ0M(jM1451minusMKHz9U);
                float fM1445getDistanceimpl = Offset.m1445getDistanceimpl(Offset.m1452plusMKHz9U(jM1451minusMKHz9U2, jM1451minusMKHz9U)) / 2.0f;
                if (fM353anglek4lQ0M > 180.0f) {
                    fM353anglek4lQ0M -= 360.0f;
                } else if (fM353anglek4lQ0M < -180.0f) {
                    fM353anglek4lQ0M += 360.0f;
                }
                f3 += fM353anglek4lQ0M * fM1445getDistanceimpl;
                f2 += fM1445getDistanceimpl;
            }
            i4++;
            f = 0.0f;
        }
