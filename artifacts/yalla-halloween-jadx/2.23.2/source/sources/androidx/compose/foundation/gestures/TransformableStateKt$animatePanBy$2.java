...
public final class TransformableStateKt$animatePanBy$2 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            AnimationState animationState = new AnimationState(VectorConvertersKt.getVectorConverter(Offset.INSTANCE), Offset.m1436boximpl(this.$previous.element), null, 0L, 0L, false, 60, null);
            Offset offsetM1436boximpl = Offset.m1436boximpl(this.$offset);
            ...
            Function1<AnimationScope<Offset, AnimationVector2D>, Unit> function1 = new Function1<AnimationScope<Offset, AnimationVector2D>, Unit>() { // from class: androidx.compose.foundation.gestures.TransformableStateKt$animatePanBy$2.1
                ...
                public final void invoke2(@NotNull AnimationScope<Offset, AnimationVector2D> animateTo) {
                    ...
                    OooO.OooO00o(transformScope, 0.0f, Offset.m1451minusMKHz9U(animateTo.getValue().getPackedValue(), longRef.element), 0.0f, 5, null);
                    longRef.element = animateTo.getValue().getPackedValue();
                }
            };
            this.label = 1;
            if (SuspendAnimationKt.animateTo$default(animationState, offsetM1436boximpl, animationSpec, false, function1, this, 4, null) == coroutine_suspended) {
