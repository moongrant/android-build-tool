...
public final class TransformableStateKt {
    ...
    public static final class C06422 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ float $degrees;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C06422(float f, Continuation<? super C06422> continuation) {
            super(2, continuation);
            this.$degrees = f;
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C06422 c06422 = new C06422(this.$degrees, continuation);
            c06422.L$0 = obj;
            return c06422;
        }
        ...
        @Nullable
        public final Object invoke(@NotNull TransformScope transformScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C06422) create(transformScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            ((TransformScope) this.L$0).mo264transformByd4ec7I(1.0f, Offset.INSTANCE.m1463getZeroF1C5BW0(), this.$degrees);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class C06432 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
        int label;

        public C06432(Continuation<? super C06432> continuation) {
            super(2, continuation);
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C06432(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        @Nullable
        public final Object invoke(@NotNull TransformScope transformScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C06432) create(transformScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final class C06442 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ float $zoomFactor;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C06442(float f, Continuation<? super C06442> continuation) {
            super(2, continuation);
            this.$zoomFactor = f;
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C06442 c06442 = new C06442(this.$zoomFactor, continuation);
            c06442.L$0 = obj;
            return c06442;
        }
        ...
        @Nullable
        public final Object invoke(@NotNull TransformScope transformScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C06442) create(transformScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            ((TransformScope) this.L$0).mo264transformByd4ec7I(this.$zoomFactor, Offset.INSTANCE.m1463getZeroF1C5BW0(), 0.0f);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final Object m355animatePanByubNVwUQ(@NotNull TransformableState transformableState, long j, @NotNull AnimationSpec<Offset> animationSpec, @NotNull Continuation<? super Unit> continuation) {
        Ref.LongRef longRef = new Ref.LongRef();
        longRef.element = Offset.INSTANCE.m1463getZeroF1C5BW0();
    ...
    public static final Object m357panByd4ec7I(@NotNull TransformableState transformableState, long j, @NotNull Continuation<? super Unit> continuation) {
    ...
    public static final TransformableState rememberTransformableState(@NotNull Function3<? super Float, ? super Offset, ? super Float, Unit> onTransformation, @Nullable Composer composer, int i) {
        ...
        if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = TransformableState(new Function3<Float, Offset, Float, Unit>() { // from class: androidx.compose.foundation.gestures.TransformableStateKt$rememberTransformableState$1$1
                ...
                public final void m358invoked4ec7I(float f, long j, float f2) {
                    stateRememberUpdatedState.getValue().invoke(Float.valueOf(f), Offset.m1436boximpl(j), Float.valueOf(f2));
                }
            });
    ...
    public static final Object rotateBy(@NotNull TransformableState transformableState, float f, @NotNull Continuation<? super Unit> continuation) {
        Object objOooO00o = OooOO0.OooO00o(transformableState, null, new C06422(f, null), continuation, 1, null);
        return objOooO00o == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objOooO00o : Unit.INSTANCE;
    }
    ...
    public static final Object stopTransformation(@NotNull TransformableState transformableState, @NotNull MutatePriority mutatePriority, @NotNull Continuation<? super Unit> continuation) {
        Object objTransform = transformableState.transform(mutatePriority, new C06432(null), continuation);
    ...
    public static final Object zoomBy(@NotNull TransformableState transformableState, float f, @NotNull Continuation<? super Unit> continuation) {
        Object objOooO00o = OooOO0.OooO00o(transformableState, null, new C06442(f, null), continuation, 1, null);
        return objOooO00o == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objOooO00o : Unit.INSTANCE;
    }
}
