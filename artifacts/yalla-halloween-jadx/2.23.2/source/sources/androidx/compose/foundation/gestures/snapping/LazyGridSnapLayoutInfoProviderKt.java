...
public final class LazyGridSnapLayoutInfoProviderKt {
        ...
        return new SnapLayoutInfoProvider() { // from class: androidx.compose.foundation.gestures.snapping.LazyGridSnapLayoutInfoProviderKt.SnapLayoutInfoProvider.1
            ...
            public float calculateSnapStepSize(@NotNull Density density) {
                ...
                if (getLayoutInfo().getOrientation() == Orientation.Vertical) {
                    ...
                    while (i < size) {
                        iM3935getWidthimpl += IntSize.m3934getHeightimpl(singleAxisItems.get(i).getSize());
                        i++;
                    }
                } else {
                    ...
                    iM3935getWidthimpl = 0;
                    while (i < size2) {
                        iM3935getWidthimpl += IntSize.m3935getWidthimpl(singleAxisItems2.get(i).getSize());
                        i++;
                    }
                }
                return iM3935getWidthimpl / getSingleAxisItems().size();
            }
    ...
    public static final int getSingleAxisViewportSize(@NotNull LazyGridLayoutInfo lazyGridLayoutInfo) {
        ...
        return lazyGridLayoutInfo.getOrientation() == Orientation.Vertical ? IntSize.m3934getHeightimpl(lazyGridLayoutInfo.mo590getViewportSizeYbymL2g()) : IntSize.m3935getWidthimpl(lazyGridLayoutInfo.mo590getViewportSizeYbymL2g());
    }
    ...
    public static final int offsetOnMainAxis(@NotNull LazyGridItemInfo lazyGridItemInfo, @NotNull Orientation orientation) {
        ...
        return orientation == Orientation.Vertical ? IntOffset.m3894getYimpl(lazyGridItemInfo.getOffset()) : IntOffset.m3893getXimpl(lazyGridItemInfo.getOffset());
    }

    public static final int sizeOnMainAxis(@NotNull LazyGridItemInfo lazyGridItemInfo, @NotNull Orientation orientation) {
        Intrinsics.checkNotNullParameter(lazyGridItemInfo, "<this>");
        Intrinsics.checkNotNullParameter(orientation, "orientation");
        return orientation == Orientation.Vertical ? IntSize.m3934getHeightimpl(lazyGridItemInfo.getSize()) : IntSize.m3935getWidthimpl(lazyGridItemInfo.getSize());
    }
}
