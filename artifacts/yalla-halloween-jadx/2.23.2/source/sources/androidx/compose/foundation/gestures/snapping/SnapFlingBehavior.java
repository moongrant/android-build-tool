...
public final class SnapFlingBehavior implements FlingBehavior {
    ...
    public static final class C06451 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        Object L$3;
        ...
        public C06451(Continuation<? super C06451> continuation) {
            super(continuation);
        }
    ...
    public static final class C06463 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;

        public C06463(Continuation<? super C06463> continuation) {
            super(continuation);
        }
    ...
    public final Object longSnap(ScrollScope scrollScope, float f, final Function1<? super Float, Unit> function1, Continuation<? super AnimationResult<Float, AnimationVector1D>> continuation) {
        ...
        if (continuation instanceof C06451) {
            ...
            int i = c06451.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c06451.label = i - Integer.MIN_VALUE;
            } else {
        ...
        Object objRunApproach = c06452.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c06452.label;
        if (i2 != 0) {
            if (i2 == 1) {
                floatRef = (Ref.FloatRef) c06452.L$3;
                function2 = (Function1) c06452.L$2;
                ScrollScope scrollScope3 = (ScrollScope) c06452.L$1;
                snapFlingBehavior = (SnapFlingBehavior) c06452.L$0;
        ...
        c06452.L$0 = this;
        c06452.L$1 = scrollScope;
        c06452.L$2 = function1;
        c06452.L$3 = floatRef2;
        c06452.label = 1;
        objRunApproach = runApproach(scrollScope, fSignum, f, function3, c06452);
        ...
        c06452.L$3 = null;
        c06452.label = 2;
        objRunApproach = SnapFlingBehaviorKt.animateSnap(scrollScope2, fFloatValue, fFloatValue, animationStateCopy$default, animationSpec, function4, c06452);
    ...
    public int hashCode() {
        return Dp.m3781hashCodeimpl(this.shortSnapVelocityThreshold) + ((this.density.hashCode() + ((this.snapLayoutInfoProvider.hashCode() + ((this.lowVelocityAnimationSpec.hashCode() + ((this.highVelocityAnimationSpec.hashCode() + ((this.snapAnimationSpec.hashCode() + 0) * 31)) * 31)) * 31)) * 31)) * 31);
    }
    ...
    private SnapFlingBehavior(SnapLayoutInfoProvider snapLayoutInfoProvider, AnimationSpec<Float> lowVelocityAnimationSpec, DecayAnimationSpec<Float> highVelocityAnimationSpec, AnimationSpec<Float> snapAnimationSpec, Density density, float f) {
        ...
        this.velocityThreshold = density.mo326toPx0680j_4(f);
    ...
    public final Object performFling(@NotNull ScrollScope scrollScope, float f, @NotNull Function1<? super Float, Unit> function1, @NotNull Continuation<? super Float> continuation) throws Throwable {
        C06463 c06463;
        if (continuation instanceof C06463) {
            c06463 = (C06463) continuation;
            int i = c06463.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c06463.label = i - Integer.MIN_VALUE;
            } else {
                c06463 = new C06463(continuation);
            }
        } else {
            c06463 = new C06463(continuation);
        }
        Object objFling = c06463.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c06463.label;
        if (i2 == 0) {
            ResultKt.throwOnFailure(objFling);
            c06463.label = 1;
            objFling = fling(scrollScope, f, function1, c06463);
