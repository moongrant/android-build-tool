...
final class AlignmentLineOffsetTextUnitElement extends ModifierNodeElement<AlignmentLineOffsetTextUnitNode> {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetTextUnitElement.alignmentLine) && TextUnit.m3953equalsimpl0(this.before, alignmentLineOffsetTextUnitElement.before) && TextUnit.m3953equalsimpl0(this.after, alignmentLineOffsetTextUnitElement.after);
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return TextUnit.m3957hashCodeimpl(this.after) + ((TextUnit.m3957hashCodeimpl(this.before) + (this.alignmentLine.hashCode() * 31)) * 31);
    }
