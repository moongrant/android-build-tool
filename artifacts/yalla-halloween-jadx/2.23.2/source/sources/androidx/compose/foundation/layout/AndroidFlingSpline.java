...
final class AndroidFlingSpline {
    ...
    public static final class FlingResult {
        ...
        public static final float m387getDistanceCoefficientimpl(long j) {
            FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
            return Float.intBitsToFloat((int) (j >> 32));
        }

        /* JADX INFO: renamed from: getVelocityCoefficient-impl, reason: not valid java name */
        public static final float m388getVelocityCoefficientimpl(long j) {
            FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
    ...
    static {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            while (true) {
                ...
                f3 = 3.0f * f * f2;
                f4 = f * f * f;
                float fOooO00o = androidx.compose.animation.o00O0O.OooO00o(f, 0.35000002f, f2 * 0.175f, f3) + f4;
            ...
            while (true) {
                ...
                f7 = 3.0f * f5 * f6;
                f8 = f5 * f5 * f5;
                float fOooO00o2 = androidx.compose.animation.o00O0O.OooO00o(f6, f13, f5, f7) + f8;
    ...
    public final long m382flingPositionLfoxSSI(float time) {
        ...
        return FlingResult.m384constructorimpl((((long) Float.floatToIntBits(f)) & 4294967295L) | (Float.floatToIntBits(fOooO00o) << 32));
    }
}
