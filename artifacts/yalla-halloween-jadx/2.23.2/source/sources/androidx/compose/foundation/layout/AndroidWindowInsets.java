...
public final class AndroidWindowInsets implements WindowInsets {
    ...
    public AndroidWindowInsets(int i, @NotNull String name) {
        ...
        this.type = i;
        this.name = name;
        this.insets = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(p052o00000oO.OooOO0O.f33476OooO0o0, null, 2, null);
    ...
    public int getBottom(@NotNull Density density) {
        ...
        return getInsets$foundation_layout_release().f33480OooO0Oo;
    }
    ...
    public int getLeft(@NotNull Density density, @NotNull LayoutDirection layoutDirection) {
        ...
        return getInsets$foundation_layout_release().f33477OooO00o;
    }
    ...
    public int getRight(@NotNull Density density, @NotNull LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return getInsets$foundation_layout_release().f33479OooO0OO;
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getTop(@NotNull Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return getInsets$foundation_layout_release().f33478OooO0O0;
    }
    ...
    public String toString() {
        ...
        sb.append(this.name);
        sb.append('(');
        sb.append(getInsets$foundation_layout_release().f33477OooO00o);
        sb.append(", ");
        sb.append(getInsets$foundation_layout_release().f33478OooO0O0);
        sb.append(", ");
        sb.append(getInsets$foundation_layout_release().f33479OooO0OO);
        sb.append(", ");
        return OooO0O0.OooO00o(sb, getInsets$foundation_layout_release().f33480OooO0Oo, ')');
    }
    ...
    public final void update$foundation_layout_release(@NotNull WindowInsetsCompat windowInsetsCompat, int typeMask) {
        ...
        if (typeMask == 0 || (typeMask & this.type) != 0) {
            ...
            setVisible(windowInsetsCompat.f5389OooO00o.OooOOo0(this.type));
        }
    }
}
