...
public final class BoxKt {
    ...
    private static final MeasurePolicy EmptyBoxMeasurePolicy = new MeasurePolicy() { // from class: androidx.compose.foundation.layout.BoxKt$EmptyBoxMeasurePolicy$1
        ...
        public final MeasureResult mo3measure3p2s80s(@NotNull MeasureScope MeasurePolicy, @NotNull List<? extends Measurable> list, long j) {
            ...
            return MeasureScope.CC.OooOOo0(MeasurePolicy, Constraints.m3745getMinWidthimpl(j), Constraints.m3744getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$EmptyBoxMeasurePolicy$1$measure$1
    ...
    public static final void Box(@Nullable Modifier modifier, @Nullable Alignment alignment, boolean z, @NotNull Function3<? super BoxScope, ? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, int i, int i2) {
        ...
        androidx.compose.animation.OooOO0.OooO00o((i4 >> 3) & 112, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer)), composer, 2058660585);
    ...
    public static final MeasurePolicy boxMeasurePolicy(@NotNull final Alignment alignment, final boolean z) {
        ...
        return new MeasurePolicy() { // from class: androidx.compose.foundation.layout.BoxKt.boxMeasurePolicy.1
            ...
            public final MeasureResult mo3measure3p2s80s(@NotNull final MeasureScope MeasurePolicy, @NotNull final List<? extends Measurable> measurables, long j) {
                ...
                final Placeable placeableMo2804measureBRTryo0;
                int iMax;
                Intrinsics.checkNotNullParameter(MeasurePolicy, "$this$MeasurePolicy");
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                if (measurables.isEmpty()) {
                    return MeasureScope.CC.OooOOo0(MeasurePolicy, Constraints.m3745getMinWidthimpl(j), Constraints.m3744getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$boxMeasurePolicy$1$measure$1
                        /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                        public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                            Intrinsics.checkNotNullParameter(layout, "$this$layout");
                        }
                ...
                long jM3734copyZbe2FdA$default = z ? j : Constraints.m3734copyZbe2FdA$default(j, 0, 0, 0, 0, 10, null);
                if (measurables.size() == 1) {
                    ...
                    if (BoxKt.getMatchesParentSize(measurable)) {
                        ...
                        placeableMo2804measureBRTryo0 = measurable.mo2804measureBRTryo0(Constraints.INSTANCE.m3751fixedJhjzzOo(Constraints.m3745getMinWidthimpl(j), Constraints.m3744getMinHeightimpl(j)));
                        iMax = iM3744getMinHeightimpl;
                    } else {
                        Placeable placeableMo2804measureBRTryo1 = measurable.mo2804measureBRTryo0(jM3734copyZbe2FdA$default);
                        int iMax2 = Math.max(Constraints.m3745getMinWidthimpl(j), placeableMo2804measureBRTryo1.getWidth());
                        iMax = Math.max(Constraints.m3744getMinHeightimpl(j), placeableMo2804measureBRTryo1.getHeight());
                        placeableMo2804measureBRTryo0 = placeableMo2804measureBRTryo1;
                        iM3745getMinWidthimpl = iMax2;
                    }
                    final Alignment alignment2 = alignment;
                    final int i = iM3745getMinWidthimpl;
                    final int i2 = iMax;
                    return MeasureScope.CC.OooOOo0(MeasurePolicy, iM3745getMinWidthimpl, iMax, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$boxMeasurePolicy$1$measure$2
                        ...
                        public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                            Intrinsics.checkNotNullParameter(layout, "$this$layout");
                            BoxKt.placeInBox(layout, placeableMo2804measureBRTryo0, measurable, MeasurePolicy.getLayoutDirection(), i, i2, alignment2);
                        }
                    }, 4, null);
                }
                final Placeable[] placeableArr = new Placeable[measurables.size()];
                final Ref.IntRef intRef = new Ref.IntRef();
                intRef.element = Constraints.m3745getMinWidthimpl(j);
                final Ref.IntRef intRef2 = new Ref.IntRef();
                intRef2.element = Constraints.m3744getMinHeightimpl(j);
                ...
                for (int i3 = 0; i3 < size; i3++) {
                    ...
                    if (BoxKt.getMatchesParentSize(measurable2)) {
                        ...
                        Placeable placeableMo2804measureBRTryo2 = measurable2.mo2804measureBRTryo0(jM3734copyZbe2FdA$default);
                        placeableArr[i3] = placeableMo2804measureBRTryo2;
                        intRef.element = Math.max(intRef.element, placeableMo2804measureBRTryo2.getWidth());
                        intRef2.element = Math.max(intRef2.element, placeableMo2804measureBRTryo2.getHeight());
                    }
                }
                if (z2) {
                    ...
                    for (int i7 = 0; i7 < size2; i7++) {
                        ...
                        if (BoxKt.getMatchesParentSize(measurable3)) {
                            placeableArr[i7] = measurable3.mo2804measureBRTryo0(jConstraints);
                        }
                    }
                }
    ...
    public static final void placeInBox(Placeable.PlacementScope placementScope, Placeable placeable, Measurable measurable, LayoutDirection layoutDirection, int i, int i2, Alignment alignment) {
        ...
        BoxChildDataNode boxChildDataNode = getBoxChildDataNode(measurable);
        Placeable.PlacementScope.m2848place70tqf50$default(placementScope, placeable, ((boxChildDataNode == null || (alignment2 = boxChildDataNode.getAlignment()) == null) ? alignment : alignment2).mo1337alignKFBX0sM(IntSizeKt.IntSize(placeable.getWidth(), placeable.getHeight()), IntSizeKt.IntSize(i, i2), layoutDirection), 0.0f, 2, null);
    }
    ...
    public static final void Box(@NotNull final Modifier modifier, @Nullable Composer composer, final int i) {
        ...
        if ((i2 & 11) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            Function2 function2OooO00o = androidx.compose.animation.OooO.OooO00o(companion, composerM1320constructorimpl, measurePolicy, composerM1320constructorimpl, currentCompositionLocalMap);
            if (composerM1320constructorimpl.getInserting() || !Intrinsics.areEqual(composerM1320constructorimpl.rememberedValue(), Integer.valueOf(currentCompositeKeyHash))) {
                androidx.compose.animation.OooO0O0.OooO0O0(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
            }
            function3ModifierMaterializerOf.invoke(SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composerStartRestartGroup)), composerStartRestartGroup, Integer.valueOf((i3 >> 3) & 112));
