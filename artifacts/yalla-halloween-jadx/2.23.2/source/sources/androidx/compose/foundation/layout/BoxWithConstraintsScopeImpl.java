...
final /* data */ class BoxWithConstraintsScopeImpl implements BoxWithConstraintsScope, BoxScope {
    ...
    public static /* synthetic */ BoxWithConstraintsScopeImpl m421copy0kLqBqw$default(BoxWithConstraintsScopeImpl boxWithConstraintsScopeImpl, Density density, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return boxWithConstraintsScopeImpl.m423copy0kLqBqw(density, j);
    }
    ...
    public final BoxWithConstraintsScopeImpl m423copy0kLqBqw(@NotNull Density density, long constraints) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Intrinsics.areEqual(this.density, boxWithConstraintsScopeImpl.density) && Constraints.m3736equalsimpl0(this.constraints, boxWithConstraintsScopeImpl.constraints);
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getConstraints-msEJaDk */
    public long mo416getConstraintsmsEJaDk() {
        return this.constraints;
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMaxHeight-D9Ej5fM */
    public float mo417getMaxHeightD9Ej5fM() {
        return Constraints.m3738getHasBoundedHeightimpl(mo416getConstraintsmsEJaDk()) ? this.density.mo323toDpu2uoSUM(Constraints.m3742getMaxHeightimpl(mo416getConstraintsmsEJaDk())) : Dp.INSTANCE.m3794getInfinityD9Ej5fM();
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMaxWidth-D9Ej5fM */
    public float mo418getMaxWidthD9Ej5fM() {
        return Constraints.m3739getHasBoundedWidthimpl(mo416getConstraintsmsEJaDk()) ? this.density.mo323toDpu2uoSUM(Constraints.m3743getMaxWidthimpl(mo416getConstraintsmsEJaDk())) : Dp.INSTANCE.m3794getInfinityD9Ej5fM();
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMinHeight-D9Ej5fM */
    public float mo419getMinHeightD9Ej5fM() {
        return this.density.mo323toDpu2uoSUM(Constraints.m3744getMinHeightimpl(mo416getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMinWidth-D9Ej5fM */
    public float mo420getMinWidthD9Ej5fM() {
        return this.density.mo323toDpu2uoSUM(Constraints.m3745getMinWidthimpl(mo416getConstraintsmsEJaDk()));
    }

    public int hashCode() {
        return Constraints.m3746hashCodeimpl(this.constraints) + (this.density.hashCode() * 31);
    }
    ...
    public String toString() {
        return "BoxWithConstraintsScopeImpl(density=" + this.density + ", constraints=" + ((Object) Constraints.m3748toStringimpl(this.constraints)) + ')';
    }
