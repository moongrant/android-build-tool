...
public final class FlowLayoutKt {
    ...
    public static final void FlowColumn(@Nullable Modifier modifier, @Nullable Arrangement.Vertical vertical, @Nullable Arrangement.Horizontal horizontal, int i, @NotNull Function3<? super FlowColumnScope, ? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, int i2, int i3) {
        ...
        Function2 function2OooO00o = androidx.compose.animation.OooO.OooO00o(companion, composerM1320constructorimpl, measurePolicyColumnMeasurementHelper, composerM1320constructorimpl, currentCompositionLocalMap);
        if (composerM1320constructorimpl.getInserting() || !Intrinsics.areEqual(composerM1320constructorimpl.rememberedValue(), Integer.valueOf(currentCompositeKeyHash))) {
            androidx.compose.animation.OooO0O0.OooO0O0(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
        }
        androidx.compose.animation.OooOO0.OooO00o((i5 >> 3) & 112, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer)), composer, 2058660585);
    ...
    public static final void FlowRow(@Nullable Modifier modifier, @Nullable Arrangement.Horizontal horizontal, @Nullable Arrangement.Vertical vertical, int i, @NotNull Function3<? super FlowRowScope, ? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, int i2, int i3) {
        ...
        Composer composerM1320constructorimpl = Updater.m1320constructorimpl(composer);
        Function2 function2OooO00o = androidx.compose.animation.OooO.OooO00o(companion, composerM1320constructorimpl, measurePolicyRowMeasurementHelper, composerM1320constructorimpl, currentCompositionLocalMap);
        if (composerM1320constructorimpl.getInserting() || !Intrinsics.areEqual(composerM1320constructorimpl.rememberedValue(), Integer.valueOf(currentCompositeKeyHash))) {
            androidx.compose.animation.OooO0O0.OooO0O0(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, function2OooO00o);
        }
        androidx.compose.animation.OooOO0.OooO00o((i5 >> 3) & 112, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer)), composer, 2058660585);
    ...
    public static final FlowResult m425breakDownItemsw1Onq5I(@NotNull MeasureScope breakDownItems, @NotNull RowColumnMeasurementHelper measureHelper, @NotNull LayoutOrientation orientation, long j, int i) {
        Integer numValueOf;
        ...
        int iCeil = (int) Math.ceil(breakDownItems.mo326toPx0680j_4(measureHelper.getArrangementSpacing()));
        long jM445constructorimpl = OrientationIndependentConstraints.m445constructorimpl(iM3745getMinWidthimpl, iM3743getMaxWidthimpl, 0, iM3742getMaxHeightimpl);
        Measurable measurable = (Measurable) CollectionsKt.getOrNull(measurables, 0);
        Integer numValueOf2 = measurable != null ? Integer.valueOf(m427measureAndCache6m2dt9o(measurable, jM445constructorimpl, orientation, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutKt$breakDownItems$nextSize$1
        ...
        while (i3 < size) {
            ...
            Integer numValueOf3 = measurable2 != null ? Integer.valueOf(m427measureAndCache6m2dt9o(measurable2, jM445constructorimpl, orientation, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutKt$breakDownItems$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
            ...
            if (i8 >= measurables.size() || i8 - i5 >= i) {
                int iMin = Math.min(Math.max(iM3745getMinWidthimpl, i7), iM3743getMaxWidthimpl);
                ...
                i2 = iM3743getMaxWidthimpl;
                numValueOf3 = numValueOf;
                i5 = i8;
                i4 = 0;
                iM3745getMinWidthimpl = iMin;
            } else {
                if (i2 - (numValueOf3 != null ? numValueOf3.intValue() : 0) < 0) {
                    int iMin2 = Math.min(Math.max(iM3745getMinWidthimpl, i7), iM3743getMaxWidthimpl);
                    numArr[i6] = Integer.valueOf(i8);
                    i6++;
                    if (numValueOf3 != null) {
                        numValueOf = Integer.valueOf(numValueOf3.intValue() - iCeil);
        ...
        int iMax = iM3745getMinWidthimpl;
        long jM460toBoxConstraintsOenEA2s = OrientationIndependentConstraints.m460toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m449copyyUG9Ft0$default(jM445constructorimpl, iMax, 0, 0, 0, 14, null), orientation);
        int iIntValue2 = 0;
        int crossAxisSize = 0;
        int i9 = 0;
        Integer num = (Integer) ArraysKt.getOrNull(numArr, 0);
        while (num != null) {
            RowColumnMeasureHelperResult rowColumnMeasureHelperResultM505measureWithoutPlacing_EkL_Y = measureHelper.m505measureWithoutPlacing_EkL_Y(breakDownItems, jM460toBoxConstraintsOenEA2s, iIntValue2, num.intValue());
            crossAxisSize += rowColumnMeasureHelperResultM505measureWithoutPlacing_EkL_Y.getCrossAxisSize();
            iMax = Math.max(iMax, rowColumnMeasureHelperResultM505measureWithoutPlacing_EkL_Y.getMainAxisSize());
            mutableVector.add(rowColumnMeasureHelperResultM505measureWithoutPlacing_EkL_Y);
            iIntValue2 = num.intValue();
            i9++;
            num = (Integer) ArraysKt.getOrNull(numArr, i9);
        }
        return new FlowResult(Math.max(iMax, Constraints.m3745getMinWidthimpl(j)), Math.max(crossAxisSize, Constraints.m3744getMinHeightimpl(j)), mutableVector);
    }
    ...
    public static final MeasurePolicy columnMeasurementHelper(@NotNull Arrangement.Vertical verticalArrangement, @NotNull Arrangement.Horizontal horizontalArrangement, int i, @Nullable Composer composer, int i2) {
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = m426flowMeasurePolicybs7tms(LayoutOrientation.Vertical, getVerticalArrangement(verticalArrangement), verticalArrangement.getSpacing(), SizeMode.Wrap, CROSS_AXIS_ALIGNMENT_START, getHorizontalArrangement(horizontalArrangement), horizontalArrangement.getSpacing(), i);
    ...
    public static final MeasurePolicy m426flowMeasurePolicybs7tms(final LayoutOrientation layoutOrientation, final Function5<? super Integer, ? super int[], ? super LayoutDirection, ? super Density, ? super int[], Unit> function5, final float f, final SizeMode sizeMode, final CrossAxisAlignment crossAxisAlignment, final Function5<? super Integer, ? super int[], ? super LayoutDirection, ? super Density, ? super int[], Unit> function6, final float f2, final int i) {
        return new MeasurePolicy(function5, f, sizeMode, crossAxisAlignment, i, f2, function6) { // from class: androidx.compose.foundation.layout.FlowLayoutKt$flowMeasurePolicy$1
            ...
            public int maxIntrinsicHeight(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull List<? extends IntrinsicMeasurable> measurables, int i2) {
                ...
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                return this.$orientation == LayoutOrientation.Horizontal ? intrinsicCrossAxisSize(measurables, i2, intrinsicMeasureScope.mo320roundToPx0680j_4(this.$mainAxisArrangementSpacing), intrinsicMeasureScope.mo320roundToPx0680j_4(this.$crossAxisArrangementSpacing)) : maxIntrinsicMainAxisSize(measurables, i2, intrinsicMeasureScope.mo320roundToPx0680j_4(this.$mainAxisArrangementSpacing));
            }
            ...
            public int maxIntrinsicWidth(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull List<? extends IntrinsicMeasurable> measurables, int i2) {
                Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                return this.$orientation == LayoutOrientation.Horizontal ? maxIntrinsicMainAxisSize(measurables, i2, intrinsicMeasureScope.mo320roundToPx0680j_4(this.$mainAxisArrangementSpacing)) : intrinsicCrossAxisSize(measurables, i2, intrinsicMeasureScope.mo320roundToPx0680j_4(this.$mainAxisArrangementSpacing), intrinsicMeasureScope.mo320roundToPx0680j_4(this.$crossAxisArrangementSpacing));
            }
            ...
            public MeasureResult mo3measure3p2s80s(@NotNull final MeasureScope measure, @NotNull List<? extends Measurable> measurables, long j) {
                ...
                final FlowResult flowResultM425breakDownItemsw1Onq5I = FlowLayoutKt.m425breakDownItemsw1Onq5I(measure, rowColumnMeasurementHelper, this.$orientation, OrientationIndependentConstraints.m447constructorimpl(j, this.$orientation), this.$maxItemsInMainAxis);
                MutableVector<RowColumnMeasureHelperResult> items = flowResultM425breakDownItemsw1Onq5I.getItems();
                ...
                int size2 = ((items.getSize() - 1) * measure.mo320roundToPx0680j_4(this.$crossAxisArrangementSpacing)) + flowResultM425breakDownItemsw1Onq5I.getCrossAxisTotalSize();
                this.$crossAxisArrangement.invoke(Integer.valueOf(size2), iArr, measure.getLayoutDirection(), measure, iArr2);
                if (this.$orientation == LayoutOrientation.Horizontal) {
                    size2 = flowResultM425breakDownItemsw1Onq5I.getMainAxisTotalSize();
                    mainAxisTotalSize = size2;
                } else {
                    mainAxisTotalSize = flowResultM425breakDownItemsw1Onq5I.getMainAxisTotalSize();
                }
                return MeasureScope.CC.OooOOo0(measure, ConstraintsKt.m3757constrainWidthK40F9xA(j, size2), ConstraintsKt.m3756constrainHeightK40F9xA(j, mainAxisTotalSize), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutKt$flowMeasurePolicy$1$measure$2
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                    ...
                    public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                        Intrinsics.checkNotNullParameter(layout, "$this$layout");
                        MutableVector<RowColumnMeasureHelperResult> items2 = flowResultM425breakDownItemsw1Onq5I.getItems();
            ...
            public int minIntrinsicHeight(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull List<? extends IntrinsicMeasurable> measurables, int i2) {
                Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                return this.$orientation == LayoutOrientation.Horizontal ? intrinsicCrossAxisSize(measurables, i2, intrinsicMeasureScope.mo320roundToPx0680j_4(this.$mainAxisArrangementSpacing), intrinsicMeasureScope.mo320roundToPx0680j_4(this.$crossAxisArrangementSpacing)) : minIntrinsicMainAxisSize(measurables, i2, intrinsicMeasureScope.mo320roundToPx0680j_4(this.$mainAxisArrangementSpacing), intrinsicMeasureScope.mo320roundToPx0680j_4(this.$crossAxisArrangementSpacing));
            }
            ...
            public int minIntrinsicWidth(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull List<? extends IntrinsicMeasurable> measurables, int i2) {
                Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                return this.$orientation == LayoutOrientation.Horizontal ? minIntrinsicMainAxisSize(measurables, i2, intrinsicMeasureScope.mo320roundToPx0680j_4(this.$mainAxisArrangementSpacing), intrinsicMeasureScope.mo320roundToPx0680j_4(this.$crossAxisArrangementSpacing)) : intrinsicCrossAxisSize(measurables, i2, intrinsicMeasureScope.mo320roundToPx0680j_4(this.$mainAxisArrangementSpacing), intrinsicMeasureScope.mo320roundToPx0680j_4(this.$crossAxisArrangementSpacing));
            }
        };
    }
    ...
    private static final int m427measureAndCache6m2dt9o(Measurable measurable, long j, LayoutOrientation layoutOrientation, Function1<? super Placeable, Unit> function1) {
        if (!(RowColumnImplKt.getWeight(RowColumnImplKt.getRowColumnParentData(measurable)) == 0.0f)) {
            return mainAxisMin(measurable, layoutOrientation, Integer.MAX_VALUE);
        }
        Placeable placeableMo2804measureBRTryo0 = measurable.mo2804measureBRTryo0(OrientationIndependentConstraints.m460toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m449copyyUG9Ft0$default(j, 0, 0, 0, 0, 14, null), layoutOrientation));
        function1.invoke(placeableMo2804measureBRTryo0);
        return mainAxisSize(placeableMo2804measureBRTryo0, layoutOrientation);
    }
    ...
    public static final MeasurePolicy rowMeasurementHelper(@NotNull Arrangement.Horizontal horizontalArrangement, @NotNull Arrangement.Vertical verticalArrangement, int i, @Nullable Composer composer, int i2) {
        ...
        Object objRememberedValue = composer.rememberedValue();
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = m426flowMeasurePolicybs7tms(LayoutOrientation.Horizontal, getHorizontalArrangement(horizontalArrangement), horizontalArrangement.getSpacing(), SizeMode.Wrap, CROSS_AXIS_ALIGNMENT_TOP, getVerticalArrangement(verticalArrangement), verticalArrangement.getSpacing(), i);
            composer.updateRememberedValue(objRememberedValue);
        }
        composer.endReplaceableGroup();
        MeasurePolicy measurePolicy = (MeasurePolicy) objRememberedValue;
