...
final class InsetsPaddingValues implements PaddingValues {
    ...
    public float getBottom() {
        ...
        return density.mo323toDpu2uoSUM(this.insets.getBottom(density));
    }
    ...
    public float mo429calculateLeftPaddingu2uoSUM(@NotNull LayoutDirection layoutDirection) {
        ...
        Density density = this.density;
        return density.mo323toDpu2uoSUM(this.insets.getLeft(density, layoutDirection));
    }
    ...
    public float mo430calculateRightPaddingu2uoSUM(@NotNull LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Density density = this.density;
        return density.mo323toDpu2uoSUM(this.insets.getRight(density, layoutDirection));
    }
    ...
    public float getTop() {
        Density density = this.density;
        return density.mo323toDpu2uoSUM(this.insets.getTop(density));
    }
