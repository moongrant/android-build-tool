...
final class OffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo250measure3p2s80s(@NotNull final MeasureScope measure, @NotNull Measurable measurable, long j) {
        ...
        return MeasureScope.CC.OooOOo0(measure, placeableMo2804measureBRTryo0.getWidth(), placeableMo2804measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetNode$measure$1
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                ...
                if (this.this$0.getRtlAware()) {
                    Placeable.PlacementScope.placeRelative$default(layout, placeableMo2804measureBRTryo0, measure.mo320roundToPx0680j_4(this.this$0.getX()), measure.mo320roundToPx0680j_4(this.this$0.getY()), 0.0f, 4, null);
                } else {
                    Placeable.PlacementScope.place$default(layout, placeableMo2804measureBRTryo0, measure.mo320roundToPx0680j_4(this.this$0.getX()), measure.mo320roundToPx0680j_4(this.this$0.getY()), 0.0f, 4, null);
                }
            }
        }, 4, null);
    }
    ...
    public final void m442setX0680j_4(float f) {
        this.x = f;
    }

    /* JADX INFO: renamed from: setY-0680j_4, reason: not valid java name */
    public final void m443setY0680j_4(float f) {
        this.y = f;
    }
