...
public final class PaddingKt {
    ...
    public static final PaddingValues m471PaddingValues0680j_4(float f) {
    ...
    public static final PaddingValues m472PaddingValuesYgX7TsA(float f, float f2) {
    ...
    public static /* synthetic */ PaddingValues m473PaddingValuesYgX7TsA$default(float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m472PaddingValuesYgX7TsA(f, f2);
    }

    @Stable
    @NotNull
    /* JADX INFO: renamed from: PaddingValues-a9UjIt4, reason: not valid java name */
    public static final PaddingValues m474PaddingValuesa9UjIt4(float f, float f2, float f3, float f4) {
    ...
    public static /* synthetic */ PaddingValues m475PaddingValuesa9UjIt4$default(float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m3775constructorimpl(0);
        }
        if ((i & 2) != 0) {
        ...
        if ((i & 4) != 0) {
            f3 = Dp.m3775constructorimpl(0);
        }
        if ((i & 8) != 0) {
            f4 = Dp.m3775constructorimpl(0);
        }
        return m474PaddingValuesa9UjIt4(f, f2, f3, f4);
    }

    @Stable
    @NotNull
    /* JADX INFO: renamed from: absolutePadding-qDBjuR0, reason: not valid java name */
    public static final Modifier m476absolutePaddingqDBjuR0(@NotNull Modifier absolutePadding, final float f, final float f2, final float f3, final float f4) {
        ...
        return absolutePadding.then(new PaddingElement(f, f2, f3, f4, false, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.PaddingKt$absolutePadding$1
            ...
            public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
                OooO00o.OooO00o(f3, OooO00o.OooO00o(f2, OooO00o.OooO00o(f, androidx.compose.animation.OooOOO0.OooO00o(inspectorInfo, "$this$$receiver", "absolutePadding"), ViewHierarchyConstants.DIMENSION_LEFT_KEY, inspectorInfo), ViewHierarchyConstants.DIMENSION_TOP_KEY, inspectorInfo), "right", inspectorInfo).set("bottom", Dp.m3773boximpl(f4));
            }
    ...
    public static /* synthetic */ Modifier m477absolutePaddingqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m3775constructorimpl(0);
        }
        if ((i & 2) != 0) {
        ...
        return m476absolutePaddingqDBjuR0(modifier, f, f2, f3, f4);
    }
    ...
    public static final float calculateEndPadding(@NotNull PaddingValues paddingValues, @NotNull LayoutDirection layoutDirection) {
        ...
        return layoutDirection == LayoutDirection.Ltr ? paddingValues.mo430calculateRightPaddingu2uoSUM(layoutDirection) : paddingValues.mo429calculateLeftPaddingu2uoSUM(layoutDirection);
    }
    ...
    public static final float calculateStartPadding(@NotNull PaddingValues paddingValues, @NotNull LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(paddingValues, "<this>");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return layoutDirection == LayoutDirection.Ltr ? paddingValues.mo429calculateLeftPaddingu2uoSUM(layoutDirection) : paddingValues.mo430calculateRightPaddingu2uoSUM(layoutDirection);
    }
    ...
    public static final Modifier m478padding3ABfNKs(@NotNull Modifier padding, final float f) {
        ...
        return padding.then(new PaddingElement(f, f, f, f, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.PaddingKt.padding.3
            ...
            public final void invoke2(@NotNull InspectorInfo $receiver) {
                ...
                $receiver.setValue(Dp.m3773boximpl(f));
            }
        }, null));
    }
    ...
    public static final Modifier m479paddingVpY3zN4(@NotNull Modifier padding, final float f, final float f2) {
        Intrinsics.checkNotNullParameter(padding, "$this$padding");
        return padding.then(new PaddingElement(f, f2, f, f2, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.PaddingKt.padding.2
            ...
            /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
                OooO00o.OooO00o(f, androidx.compose.animation.OooOOO0.OooO00o(inspectorInfo, "$this$$receiver", "padding"), "horizontal", inspectorInfo).set("vertical", Dp.m3773boximpl(f2));
            }
    ...
    public static /* synthetic */ Modifier m480paddingVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m3775constructorimpl(0);
        }
        if ((i & 2) != 0) {
        ...
        return m479paddingVpY3zN4(modifier, f, f2);
    }

    @Stable
    @NotNull
    /* JADX INFO: renamed from: padding-qDBjuR0, reason: not valid java name */
    public static final Modifier m481paddingqDBjuR0(@NotNull Modifier padding, final float f, final float f2, final float f3, final float f4) {
        Intrinsics.checkNotNullParameter(padding, "$this$padding");
        return padding.then(new PaddingElement(f, f2, f3, f4, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.PaddingKt.padding.1
            ...
            /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
                OooO00o.OooO00o(f3, OooO00o.OooO00o(f2, OooO00o.OooO00o(f, androidx.compose.animation.OooOOO0.OooO00o(inspectorInfo, "$this$$receiver", "padding"), "start", inspectorInfo), ViewHierarchyConstants.DIMENSION_TOP_KEY, inspectorInfo), "end", inspectorInfo).set("bottom", Dp.m3773boximpl(f4));
            }
    ...
    public static /* synthetic */ Modifier m482paddingqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m3775constructorimpl(0);
        }
        if ((i & 2) != 0) {
        ...
        return m481paddingqDBjuR0(modifier, f, f2, f3, f4);
    }
}
