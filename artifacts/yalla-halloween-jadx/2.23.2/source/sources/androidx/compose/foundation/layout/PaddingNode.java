...
final class PaddingNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo250measure3p2s80s(@NotNull final MeasureScope measure, @NotNull Measurable measurable, long j) {
        ...
        int iMo320roundToPx0680j_4 = measure.mo320roundToPx0680j_4(this.end) + measure.mo320roundToPx0680j_4(this.start);
        int iMo320roundToPx0680j_5 = measure.mo320roundToPx0680j_4(this.bottom) + measure.mo320roundToPx0680j_4(this.top);
        ...
        return MeasureScope.CC.OooOOo0(measure, ConstraintsKt.m3757constrainWidthK40F9xA(j, placeableMo2804measureBRTryo0.getWidth() + iMo320roundToPx0680j_4), ConstraintsKt.m3756constrainHeightK40F9xA(j, placeableMo2804measureBRTryo0.getHeight() + iMo320roundToPx0680j_5), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.PaddingNode$measure$1
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                ...
                if (this.this$0.getRtlAware()) {
                    Placeable.PlacementScope.placeRelative$default(layout, placeableMo2804measureBRTryo0, measure.mo320roundToPx0680j_4(this.this$0.getStart()), measure.mo320roundToPx0680j_4(this.this$0.getTop()), 0.0f, 4, null);
                } else {
                    Placeable.PlacementScope.place$default(layout, placeableMo2804measureBRTryo0, measure.mo320roundToPx0680j_4(this.this$0.getStart()), measure.mo320roundToPx0680j_4(this.this$0.getTop()), 0.0f, 4, null);
                }
            }
        }, 4, null);
    }
    ...
    public final void m487setBottom0680j_4(float f) {
        this.bottom = f;
    }

    /* JADX INFO: renamed from: setEnd-0680j_4, reason: not valid java name */
    public final void m488setEnd0680j_4(float f) {
        this.end = f;
    }
    ...
    public final void m489setStart0680j_4(float f) {
        this.start = f;
    }

    /* JADX INFO: renamed from: setTop-0680j_4, reason: not valid java name */
    public final void m490setTop0680j_4(float f) {
        this.top = f;
    }
    ...
    public /* synthetic */ PaddingNode(float f, float f2, float f3, float f4, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m3775constructorimpl(0) : f, (i & 2) != 0 ? Dp.m3775constructorimpl(0) : f2, (i & 4) != 0 ? Dp.m3775constructorimpl(0) : f3, (i & 8) != 0 ? Dp.m3775constructorimpl(0) : f4, z, null);
    }
}
