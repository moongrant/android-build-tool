...
final class PaddingValuesInsets implements WindowInsets {
    ...
    public int getLeft(@NotNull Density density, @NotNull LayoutDirection layoutDirection) {
        ...
        return density.mo320roundToPx0680j_4(this.paddingValues.mo429calculateLeftPaddingu2uoSUM(layoutDirection));
    }
    ...
    public int getRight(@NotNull Density density, @NotNull LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return density.mo320roundToPx0680j_4(this.paddingValues.mo430calculateRightPaddingu2uoSUM(layoutDirection));
    }
    ...
    public String toString() {
        ...
        return "PaddingValues(" + ((Object) Dp.m3786toStringimpl(this.paddingValues.mo429calculateLeftPaddingu2uoSUM(layoutDirection))) + ", " + ((Object) Dp.m3786toStringimpl(this.paddingValues.getTop())) + ", " + ((Object) Dp.m3786toStringimpl(this.paddingValues.mo430calculateRightPaddingu2uoSUM(layoutDirection))) + ", " + ((Object) Dp.m3786toStringimpl(this.paddingValues.getBottom())) + ')';
    }
}
