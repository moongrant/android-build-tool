...
public final class RowKt {
    ...
    static {
        ...
        DefaultRowMeasurePolicy = RowColumnImplKt.m503rowColumnMeasurePolicyTDGSqEk(layoutOrientation, new Function5<Integer, int[], LayoutDirection, Density, int[], Unit>() { // from class: androidx.compose.foundation.layout.RowKt$DefaultRowMeasurePolicy$1
    ...
    public static final MeasurePolicy rowMeasurePolicy(@NotNull final Arrangement.Horizontal horizontalArrangement, @NotNull Alignment.Vertical verticalAlignment, @Nullable Composer composer, int i) {
        ...
        if (Intrinsics.areEqual(horizontalArrangement, Arrangement.INSTANCE.getStart()) && Intrinsics.areEqual(verticalAlignment, Alignment.INSTANCE.getTop())) {
            ...
            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                ...
                objRememberedValue = RowColumnImplKt.m503rowColumnMeasurePolicyTDGSqEk(layoutOrientation, new Function5<Integer, int[], LayoutDirection, Density, int[], Unit>() { // from class: androidx.compose.foundation.layout.RowKt$rowMeasurePolicy$1$1
                    {
                        super(5);
                    }
