...
final class SizeElement extends ModifierNodeElement<SizeNode> {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Dp.m3780equalsimpl0(this.minWidth, sizeElement.minWidth) && Dp.m3780equalsimpl0(this.minHeight, sizeElement.minHeight) && Dp.m3780equalsimpl0(this.maxWidth, sizeElement.maxWidth) && Dp.m3780equalsimpl0(this.maxHeight, sizeElement.maxHeight) && this.enforceIncoming == sizeElement.enforceIncoming;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return androidx.compose.foundation.OooO0o.OooO00o(this.maxHeight, androidx.compose.foundation.OooO0o.OooO00o(this.maxWidth, androidx.compose.foundation.OooO0o.OooO00o(this.minHeight, Dp.m3781hashCodeimpl(this.minWidth) * 31, 31), 31), 31) + (this.enforceIncoming ? 1231 : 1237);
    }
    ...
    public /* synthetic */ SizeElement(float f, float f2, float f3, float f4, boolean z, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.INSTANCE.m3795getUnspecifiedD9Ej5fM() : f, (i & 2) != 0 ? Dp.INSTANCE.m3795getUnspecifiedD9Ej5fM() : f2, (i & 4) != 0 ? Dp.INSTANCE.m3795getUnspecifiedD9Ej5fM() : f3, (i & 8) != 0 ? Dp.INSTANCE.m3795getUnspecifiedD9Ej5fM() : f4, z, function1, null);
    }
    ...
    public void update(@NotNull SizeNode node) {
        ...
        node.m541setMinWidth0680j_4(this.minWidth);
        node.m540setMinHeight0680j_4(this.minHeight);
        node.m539setMaxWidth0680j_4(this.maxWidth);
        node.m538setMaxHeight0680j_4(this.maxHeight);
