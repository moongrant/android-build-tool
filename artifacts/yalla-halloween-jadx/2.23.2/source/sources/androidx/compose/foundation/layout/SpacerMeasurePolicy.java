...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo3measure3p2s80s(@NotNull MeasureScope measure, @NotNull List<? extends Measurable> measurables, long j) {
        ...
        return MeasureScope.CC.OooOOo0(measure, Constraints.m3741getHasFixedWidthimpl(j) ? Constraints.m3743getMaxWidthimpl(j) : 0, Constraints.m3740getHasFixedHeightimpl(j) ? Constraints.m3742getMaxHeightimpl(j) : 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.SpacerMeasurePolicy$measure$1$1
