...
final class UnspecifiedConstraintsNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public int maxIntrinsicHeight(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull IntrinsicMeasurable measurable, int i) {
        ...
        return RangesKt.coerceAtLeast(measurable.maxIntrinsicHeight(i), !Dp.m3780equalsimpl0(this.minHeight, Dp.INSTANCE.m3795getUnspecifiedD9Ej5fM()) ? intrinsicMeasureScope.mo320roundToPx0680j_4(this.minHeight) : 0);
    }
    ...
    public int maxIntrinsicWidth(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull IntrinsicMeasurable measurable, int i) {
        Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return RangesKt.coerceAtLeast(measurable.maxIntrinsicWidth(i), !Dp.m3780equalsimpl0(this.minWidth, Dp.INSTANCE.m3795getUnspecifiedD9Ej5fM()) ? intrinsicMeasureScope.mo320roundToPx0680j_4(this.minWidth) : 0);
    }
    ...
    public MeasureResult mo250measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j) {
        ...
        final Placeable placeableMo2804measureBRTryo0 = measurable.mo2804measureBRTryo0(ConstraintsKt.Constraints((Dp.m3780equalsimpl0(f, companion.m3795getUnspecifiedD9Ej5fM()) || Constraints.m3745getMinWidthimpl(j) != 0) ? Constraints.m3745getMinWidthimpl(j) : RangesKt.coerceAtLeast(RangesKt.coerceAtMost(measure.mo320roundToPx0680j_4(this.minWidth), Constraints.m3743getMaxWidthimpl(j)), 0), Constraints.m3743getMaxWidthimpl(j), (Dp.m3780equalsimpl0(this.minHeight, companion.m3795getUnspecifiedD9Ej5fM()) || Constraints.m3744getMinHeightimpl(j) != 0) ? Constraints.m3744getMinHeightimpl(j) : RangesKt.coerceAtLeast(RangesKt.coerceAtMost(measure.mo320roundToPx0680j_4(this.minHeight), Constraints.m3742getMaxHeightimpl(j)), 0), Constraints.m3742getMaxHeightimpl(j)));
        return MeasureScope.CC.OooOOo0(measure, placeableMo2804measureBRTryo0.getWidth(), placeableMo2804measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.UnspecifiedConstraintsNode$measure$1
            {
                super(1);
            }
    ...
    public int minIntrinsicHeight(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull IntrinsicMeasurable measurable, int i) {
        Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return RangesKt.coerceAtLeast(measurable.minIntrinsicHeight(i), !Dp.m3780equalsimpl0(this.minHeight, Dp.INSTANCE.m3795getUnspecifiedD9Ej5fM()) ? intrinsicMeasureScope.mo320roundToPx0680j_4(this.minHeight) : 0);
    }
    ...
    public int minIntrinsicWidth(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull IntrinsicMeasurable measurable, int i) {
        Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return RangesKt.coerceAtLeast(measurable.minIntrinsicWidth(i), !Dp.m3780equalsimpl0(this.minWidth, Dp.INSTANCE.m3795getUnspecifiedD9Ej5fM()) ? intrinsicMeasureScope.mo320roundToPx0680j_4(this.minWidth) : 0);
    }
