...
public final class WindowInsetsSides {
    ...
    public static final class Companion {
        ...
        public final int m565getAllowLeftInLtrJoeWqyM$foundation_layout_release() {
            return WindowInsetsSides.AllowLeftInLtr;
        }

        /* JADX INFO: renamed from: getAllowLeftInRtl-JoeWqyM$foundation_layout_release, reason: not valid java name */
        public final int m566getAllowLeftInRtlJoeWqyM$foundation_layout_release() {
            return WindowInsetsSides.AllowLeftInRtl;
        }

        /* JADX INFO: renamed from: getAllowRightInLtr-JoeWqyM$foundation_layout_release, reason: not valid java name */
        public final int m567getAllowRightInLtrJoeWqyM$foundation_layout_release() {
            return WindowInsetsSides.AllowRightInLtr;
        }

        /* JADX INFO: renamed from: getAllowRightInRtl-JoeWqyM$foundation_layout_release, reason: not valid java name */
        public final int m568getAllowRightInRtlJoeWqyM$foundation_layout_release() {
            return WindowInsetsSides.AllowRightInRtl;
        }

        /* JADX INFO: renamed from: getBottom-JoeWqyM, reason: not valid java name */
        public final int m569getBottomJoeWqyM() {
            return WindowInsetsSides.Bottom;
        }

        /* JADX INFO: renamed from: getEnd-JoeWqyM, reason: not valid java name */
        public final int m570getEndJoeWqyM() {
            return WindowInsetsSides.End;
        }

        /* JADX INFO: renamed from: getHorizontal-JoeWqyM, reason: not valid java name */
        public final int m571getHorizontalJoeWqyM() {
            return WindowInsetsSides.Horizontal;
        }

        /* JADX INFO: renamed from: getLeft-JoeWqyM, reason: not valid java name */
        public final int m572getLeftJoeWqyM() {
            return WindowInsetsSides.Left;
        }

        /* JADX INFO: renamed from: getRight-JoeWqyM, reason: not valid java name */
        public final int m573getRightJoeWqyM() {
            return WindowInsetsSides.Right;
        }

        /* JADX INFO: renamed from: getStart-JoeWqyM, reason: not valid java name */
        public final int m574getStartJoeWqyM() {
            return WindowInsetsSides.Start;
        }

        /* JADX INFO: renamed from: getTop-JoeWqyM, reason: not valid java name */
        public final int m575getTopJoeWqyM() {
            return WindowInsetsSides.Top;
        }

        /* JADX INFO: renamed from: getVertical-JoeWqyM, reason: not valid java name */
        public final int m576getVerticalJoeWqyM() {
            return WindowInsetsSides.Vertical;
        }
    }

    static {
        int iM556constructorimpl = m556constructorimpl(8);
        AllowLeftInLtr = iM556constructorimpl;
        int iM556constructorimpl2 = m556constructorimpl(4);
        AllowRightInLtr = iM556constructorimpl2;
        int iM556constructorimpl3 = m556constructorimpl(2);
        AllowLeftInRtl = iM556constructorimpl3;
        int iM556constructorimpl4 = m556constructorimpl(1);
        AllowRightInRtl = iM556constructorimpl4;
        Start = m561plusgK_yJZ4(iM556constructorimpl, iM556constructorimpl4);
        End = m561plusgK_yJZ4(iM556constructorimpl2, iM556constructorimpl3);
        int iM556constructorimpl5 = m556constructorimpl(16);
        Top = iM556constructorimpl5;
        int iM556constructorimpl6 = m556constructorimpl(32);
        Bottom = iM556constructorimpl6;
        int iM561plusgK_yJZ4 = m561plusgK_yJZ4(iM556constructorimpl, iM556constructorimpl3);
        Left = iM561plusgK_yJZ4;
        int iM561plusgK_yJZ5 = m561plusgK_yJZ4(iM556constructorimpl2, iM556constructorimpl4);
        Right = iM561plusgK_yJZ5;
        Horizontal = m561plusgK_yJZ4(iM561plusgK_yJZ4, iM561plusgK_yJZ5);
        Vertical = m561plusgK_yJZ4(iM556constructorimpl5, iM556constructorimpl6);
    }
    ...
    public static final /* synthetic */ WindowInsetsSides m555boximpl(int i) {
        return new WindowInsetsSides(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m556constructorimpl(int i) {
        return i;
    }
    ...
    public static final boolean m559hasAnybkgdKaI$foundation_layout_release(int i, int i2) {
        return (i & i2) != 0;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m560hashCodeimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: plus-gK_yJZ4, reason: not valid java name */
    public static final int m561plusgK_yJZ4(int i, int i2) {
        return m556constructorimpl(i | i2);
    }

    @NotNull
    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m562toStringimpl(int i) {
        return oo000o.OooO0O0(new StringBuilder("WindowInsetsSides("), m563valueToStringimpl(i), ')');
    }

    /* JADX INFO: renamed from: valueToString-impl, reason: not valid java name */
    private static final String m563valueToStringimpl(int i) {
