...
final class WrapContentNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo250measure3p2s80s(@NotNull final MeasureScope measure, @NotNull Measurable measurable, long j) {
        ...
        int iM3745getMinWidthimpl = direction != direction2 ? 0 : Constraints.m3745getMinWidthimpl(j);
        Direction direction3 = this.direction;
        Direction direction4 = Direction.Horizontal;
        final Placeable placeableMo2804measureBRTryo0 = measurable.mo2804measureBRTryo0(ConstraintsKt.Constraints(iM3745getMinWidthimpl, (this.direction == direction2 || !this.unbounded) ? Constraints.m3743getMaxWidthimpl(j) : Integer.MAX_VALUE, direction3 == direction4 ? Constraints.m3744getMinHeightimpl(j) : 0, (this.direction == direction4 || !this.unbounded) ? Constraints.m3742getMaxHeightimpl(j) : Integer.MAX_VALUE));
        final int iCoerceIn = RangesKt.coerceIn(placeableMo2804measureBRTryo0.getWidth(), Constraints.m3745getMinWidthimpl(j), Constraints.m3743getMaxWidthimpl(j));
        final int iCoerceIn2 = RangesKt.coerceIn(placeableMo2804measureBRTryo0.getHeight(), Constraints.m3744getMinHeightimpl(j), Constraints.m3742getMaxHeightimpl(j));
        return MeasureScope.CC.OooOOo0(measure, iCoerceIn, iCoerceIn2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.WrapContentNode$measure$1
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.m2848place70tqf50$default(layout, placeableMo2804measureBRTryo0, this.this$0.getAlignmentCallback().invoke(IntSize.m3927boximpl(IntSizeKt.IntSize(iCoerceIn - placeableMo2804measureBRTryo0.getWidth(), iCoerceIn2 - placeableMo2804measureBRTryo0.getHeight())), measure.getLayoutDirection()).getPackedValue(), 0.0f, 2, null);
            }
        }, 4, null);
    }
