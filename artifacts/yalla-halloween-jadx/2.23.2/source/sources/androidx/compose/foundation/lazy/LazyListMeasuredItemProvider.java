...
public abstract class LazyListMeasuredItemProvider {
    ...
    public final LazyListMeasuredItem getAndMeasure(int index) {
        return createItem(index, this.itemProvider.getKey(index), this.itemProvider.getContentType(index), this.measureScope.mo634measure0kLqBqw(index, this.childConstraints));
    }
    ...
    private LazyListMeasuredItemProvider(long j, boolean z, LazyListItemProvider itemProvider, LazyLayoutMeasureScope measureScope) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, z ? Constraints.m3743getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, !z ? Constraints.m3742getMaxHeightimpl(j) : Integer.MAX_VALUE, 5, null);
    }
}
