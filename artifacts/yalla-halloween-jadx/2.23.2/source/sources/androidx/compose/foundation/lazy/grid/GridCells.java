...
public interface GridCells {
    ...
    public static final class Adaptive implements GridCells {
        ...
        public List<Integer> calculateCrossAxisCellSizes(@NotNull Density density, int i, int i2) {
            ...
            return LazyGridDslKt.calculateCellsCrossAxisSizeImpl(i, Math.max((i + i2) / (density.mo320roundToPx0680j_4(this.minSize) + i2), 1), i2);
        }
        ...
        private Adaptive(float f) {
            ...
            throw new IllegalArgumentException(("Provided min size " + ((Object) Dp.m3786toStringimpl(f)) + " should be larger than zero.").toString());
        }
    }
    ...
    public static final class FixedSize implements GridCells {
        ...
        public List<Integer> calculateCrossAxisCellSizes(@NotNull Density density, int i, int i2) {
            ...
            for (int iOooO00o = 0; iOooO00o < i5; iOooO00o = o00O.OooO00o(iMo320roundToPx0680j_4, arrayList2, iOooO00o, 1)) {
            }
            return arrayList2;
        }
        ...
        private FixedSize(float f) {
            ...
            throw new IllegalArgumentException(("Provided size " + ((Object) Dp.m3786toStringimpl(f)) + " should be larger than zero.").toString());
        }
    }
