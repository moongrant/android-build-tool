...
final class GridSlotCache implements Function2<Density, Constraints, LazyGridSlots> {
    ...
    public GridSlotCache(@NotNull Function2<? super Density, ? super Constraints, LazyGridSlots> calculation) {
    ...
    public /* bridge */ /* synthetic */ LazyGridSlots invoke(Density density, Constraints constraints) {
        return m599invoke0kLqBqw(density, constraints.getValue());
    }

    @NotNull
    /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
    public LazyGridSlots m599invoke0kLqBqw(@NotNull Density density, long constraints) {
        Intrinsics.checkNotNullParameter(density, "density");
        if (this.cachedSizes != null && Constraints.m3736equalsimpl0(this.cachedConstraints, constraints)) {
        ...
        LazyGridSlots lazyGridSlotsInvoke = this.calculation.invoke(density, Constraints.m3731boximpl(constraints));
