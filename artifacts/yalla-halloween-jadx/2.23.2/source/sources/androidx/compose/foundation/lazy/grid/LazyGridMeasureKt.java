...
public final class LazyGridMeasureKt {
    ...
    private static final List<LazyGridMeasuredItem> calculateExtraItems(List<Integer> list, LazyGridMeasuredItemProvider lazyGridMeasuredItemProvider, Function1<? super Integer, Constraints> function1, Function1<? super Integer, Boolean> function2) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (function2.invoke(Integer.valueOf(iIntValue)).booleanValue()) {
                LazyGridMeasuredItem lazyGridMeasuredItemM614getAndMeasure3p2s80s$default = LazyGridMeasuredItemProvider.m614getAndMeasure3p2s80s$default(lazyGridMeasuredItemProvider, iIntValue, 0, function1.invoke(Integer.valueOf(iIntValue)).getValue(), 2, null);
                if (arrayList == null) {
                    arrayList = new ArrayList();
                }
                arrayList.add(lazyGridMeasuredItemM614getAndMeasure3p2s80s$default);
            }
        }
    ...
    public static final LazyGridMeasureResult m611measureLazyGridZRKPzZ8(int i, @NotNull LazyGridMeasuredLineProvider measuredLineProvider, @NotNull LazyGridMeasuredItemProvider measuredItemProvider, int i2, int i3, int i4, int i5, int i6, int i7, float f, long j, boolean z, @Nullable Arrangement.Vertical vertical, @Nullable Arrangement.Horizontal horizontal, boolean z2, @NotNull Density density, @NotNull LazyGridItemPlacementAnimator placementAnimator, @NotNull LazyGridSpanLayoutProvider spanLayoutProvider, @NotNull List<Integer> pinnedItems, @NotNull Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> layout) {
        ...
        if (i <= 0) {
            return new LazyGridMeasureResult(null, 0, false, 0.0f, layout.invoke(Integer.valueOf(Constraints.m3745getMinWidthimpl(j)), Integer.valueOf(Constraints.m3744getMinHeightimpl(j)), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridMeasureKt$measureLazyGrid$1
        ...
        while (i35 < size2) {
            ...
            if (iIntValue >= 0 && iIntValue < index) {
                LazyGridMeasuredItem lazyGridMeasuredItemM614getAndMeasure3p2s80s$default = LazyGridMeasuredItemProvider.m614getAndMeasure3p2s80s$default(measuredItemProvider, iIntValue, 0, measuredLineProvider.m617itemConstraintsOenEA2s(iIntValue), 2, null);
        ...
        while (i44 < size3) {
            ...
            if (i45 + 1 <= iIntValue2 && iIntValue2 < i) {
                LazyGridMeasuredItem lazyGridMeasuredItemM614getAndMeasure3p2s80s$default2 = LazyGridMeasuredItemProvider.m614getAndMeasure3p2s80s$default(measuredItemProvider, iIntValue2, 0, measuredLineProvider.m617itemConstraintsOenEA2s(iIntValue2), 2, null);
                if (listEmptyList == null) {
                    listEmptyList = new ArrayList();
                }
                List list2 = listEmptyList;
                list2.add(lazyGridMeasuredItemM614getAndMeasure3p2s80s$default2);
                listEmptyList = list2;
            }
            i44++;
            size3 = size3;
        ...
        if (z) {
            iM3757constrainWidthK40F9xA = Constraints.m3743getMaxWidthimpl(j);
            i11 = i41;
        } else {
            i11 = i41;
            iM3757constrainWidthK40F9xA = ConstraintsKt.m3757constrainWidthK40F9xA(j, i11);
        }
        int iM3756constrainHeightK40F9xA = z ? ConstraintsKt.m3756constrainHeightK40F9xA(j, i11) : Constraints.m3742getMaxHeightimpl(j);
        int i49 = i11;
        final List<LazyGridMeasuredItem> listCalculateItemsOffsets = calculateItemsOffsets(arrayDeque, list, list3, iM3757constrainWidthK40F9xA, iM3756constrainHeightK40F9xA, i11, i2, i40, z, vertical, horizontal, z2, density);
        placementAnimator.onMeasured((int) f3, iM3757constrainWidthK40F9xA, iM3756constrainHeightK40F9xA, listCalculateItemsOffsets, measuredItemProvider, spanLayoutProvider, z);
        boolean z3 = i46 != i + (-1) || i49 > i2;
        MeasureResult measureResultInvoke = layout.invoke(Integer.valueOf(iM3757constrainWidthK40F9xA), Integer.valueOf(iM3756constrainHeightK40F9xA), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridMeasureKt$measureLazyGrid$3
