...
public final class LazyGridMeasuredItem implements LazyGridItemInfo {
    ...
    private final long m612copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
    ...
    private final int m613getMainAxisgyyYBs(long j) {
    ...
    public final void place(@NotNull Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < placeablesCount; i++) {
            ...
            if (lazyLayoutAnimateItemModifierNode != null) {
                ...
                if ((m613getMainAxisgyyYBs(offset) <= mainAxisSize && m613getMainAxisgyyYBs(jOooO00o) <= mainAxisSize) || (m613getMainAxisgyyYBs(offset) >= i2 && m613getMainAxisgyyYBs(jOooO00o) >= i2)) {
                    lazyLayoutAnimateItemModifierNode.cancelAnimation();
                }
                offset = jOooO00o;
            }
            if (this.reverseLayout) {
                offset = IntOffsetKt.IntOffset(this.isVertical ? IntOffset.m3893getXimpl(offset) : (this.mainAxisLayoutSize - IntOffset.m3893getXimpl(offset)) - getMainAxisSize(placeable), this.isVertical ? (this.mainAxisLayoutSize - IntOffset.m3894getYimpl(offset)) - getMainAxisSize(placeable) : IntOffset.m3894getYimpl(offset));
            }
            long j = this.visualOffset;
            long jOooO00o2 = OooO0o.OooO00o(j, IntOffset.m3894getYimpl(offset), IntOffset.m3893getXimpl(j) + IntOffset.m3893getXimpl(offset));
            if (this.isVertical) {
