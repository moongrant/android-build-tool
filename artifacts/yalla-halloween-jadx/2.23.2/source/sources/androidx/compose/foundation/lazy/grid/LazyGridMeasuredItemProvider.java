...
public abstract class LazyGridMeasuredItemProvider {
    ...
    public static /* synthetic */ LazyGridMeasuredItem m614getAndMeasure3p2s80s$default(LazyGridMeasuredItemProvider lazyGridMeasuredItemProvider, int i, int i2, long j, int i3, Object obj) {
        if (obj != null) {
        ...
        return lazyGridMeasuredItemProvider.m615getAndMeasure3p2s80s(i, i2, j);
    }
    ...
    public final LazyGridMeasuredItem m615getAndMeasure3p2s80s(int index, int mainAxisSpacing, long constraints) {
        ...
        List<Placeable> listMo634measure0kLqBqw = this.measureScope.mo634measure0kLqBqw(index, constraints);
        if (Constraints.m3741getHasFixedWidthimpl(constraints)) {
            iM3744getMinHeightimpl = Constraints.m3745getMinWidthimpl(constraints);
        } else {
            if (!Constraints.m3740getHasFixedHeightimpl(constraints)) {
                throw new IllegalArgumentException("Failed requirement.".toString());
            }
            iM3744getMinHeightimpl = Constraints.m3744getMinHeightimpl(constraints);
        }
        return createItem(index, key, contentType, iM3744getMinHeightimpl, mainAxisSpacing, listMo634measure0kLqBqw);
    }
