...
public final class LazyGridSpanLayoutProvider {
    ...
    private final List<GridItemSpan> getDefaultSpans(int currentSlotsPerLine) {
        ...
        for (int i = 0; i < currentSlotsPerLine; i++) {
            arrayList.add(GridItemSpan.m591boximpl(LazyGridSpanKt.GridItemSpan(1)));
        }
    ...
    public final LineConfiguration getLineConfiguration(int lineIndex) {
        ...
        while (i9 < this.slotsPerLine && i10 < getTotalSize()) {
            ...
            i10++;
            arrayList.add(GridItemSpan.m591boximpl(LazyGridSpanKt.GridItemSpan(firstItemKnownSpan)));
    ...
    public final int spanOf(int itemIndex, int maxSpan) {
        ...
        return GridItemSpan.m595getCurrentLineSpanimpl(interval.getValue().getSpan().invoke(lazyGridItemSpanScopeImpl, Integer.valueOf(itemIndex - interval.getStartIndex())).getPackedValue());
    }
