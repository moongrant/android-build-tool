...
public final class LazyGridStateKt {
    ...
    public static final LazyGridState rememberLazyGridState(final int i, final int i2, @Nullable Composer composer, int i3, int i4) {
        ...
        LazyGridState lazyGridState = (LazyGridState) RememberSaveableKt.m1333rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) objRememberedValue, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
