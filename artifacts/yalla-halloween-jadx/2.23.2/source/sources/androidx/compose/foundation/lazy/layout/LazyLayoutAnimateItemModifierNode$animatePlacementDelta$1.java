    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        try {
            ...
            if (!this.this$0.placementDeltaAnimation.isRunning()) {
                ...
                IntOffset intOffsetM3884boximpl = IntOffset.m3884boximpl(this.$totalDelta);
            ...
            final long jIntOffset = IntOffsetKt.IntOffset(IntOffset.m3893getXimpl(packedValue) - IntOffset.m3893getXimpl(j), IntOffset.m3894getYimpl(packedValue) - IntOffset.m3894getYimpl(j));
            ...
            Function1<Animatable<IntOffset, AnimationVector2D>, Unit> function1 = new Function1<Animatable<IntOffset, AnimationVector2D>, Unit>() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutAnimateItemModifierNode$animatePlacementDelta$1.1
                ...
                public final void invoke2(@NotNull Animatable<IntOffset, AnimationVector2D> animateTo) {
                    ...
                    long j2 = jIntOffset;
                    lazyLayoutAnimateItemModifierNode2.m619setPlacementDeltagyyYBs(IntOffsetKt.IntOffset(IntOffset.m3893getXimpl(packedValue2) - IntOffset.m3893getXimpl(j2), IntOffset.m3894getYimpl(packedValue2) - IntOffset.m3894getYimpl(j2)));
                }
            };
            this.L$0 = null;
            this.label = 2;
            if (Animatable.animateTo$default(animatable2, intOffsetM3884boximpl2, finiteAnimationSpec2, null, function1, this, 4, null) == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.this$0.setAnimationInProgress(false);
