...
public final class LazyLayoutAnimateItemModifierNode extends Modifier.Node {
    ...
    public static final class Companion {
        ...
        public final long m624getNotInitializednOccac() {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                ...
                Animatable animatable = LazyLayoutAnimateItemModifierNode.this.placementDeltaAnimation;
                IntOffset intOffsetM3884boximpl = IntOffset.m3884boximpl(IntOffset.INSTANCE.m3903getZeronOccac());
                this.label = 1;
                if (animatable.snapTo(intOffsetM3884boximpl, this) == coroutine_suspended) {
            ...
            LazyLayoutAnimateItemModifierNode.this.m619setPlacementDeltagyyYBs(IntOffset.INSTANCE.m3903getZeronOccac());
    ...
    public LazyLayoutAnimateItemModifierNode(@NotNull FiniteAnimationSpec<IntOffset> placementAnimationSpec) {
        ...
        this.isAnimationInProgress = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Boolean.FALSE, null, 2, null);
        this.rawOffset = NotInitialized;
        IntOffset.Companion companion = IntOffset.INSTANCE;
        this.placementDeltaAnimation = new Animatable<>(IntOffset.m3884boximpl(companion.m3903getZeronOccac()), VectorConvertersKt.getVectorConverter(companion), null, null, 12, null);
        this.placementDelta = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m3884boximpl(companion.m3903getZeronOccac()), null, 2, null);
    }
    ...
    public final void m619setPlacementDeltagyyYBs(long j) {
        this.placementDelta.setValue(IntOffset.m3884boximpl(j));
    }

    /* JADX INFO: renamed from: animatePlacementDelta--gyyYBs, reason: not valid java name */
    public final void m620animatePlacementDeltagyyYBs(long delta) {
        long jM621getPlacementDeltanOccac = m621getPlacementDeltanOccac();
        long jIntOffset = IntOffsetKt.IntOffset(IntOffset.m3893getXimpl(jM621getPlacementDeltanOccac) - IntOffset.m3893getXimpl(delta), IntOffset.m3894getYimpl(jM621getPlacementDeltanOccac) - IntOffset.m3894getYimpl(delta));
        m619setPlacementDeltagyyYBs(jIntOffset);
    ...
    public final long m621getPlacementDeltanOccac() {
    ...
    public void onDetach() {
        m619setPlacementDeltagyyYBs(IntOffset.INSTANCE.m3903getZeronOccac());
    ...
    public final void m623setRawOffsetgyyYBs(long j) {
        this.rawOffset = j;
    }
}
