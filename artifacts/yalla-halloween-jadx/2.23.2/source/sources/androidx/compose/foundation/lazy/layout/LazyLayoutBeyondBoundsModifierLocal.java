...
public final class LazyLayoutBeyondBoundsModifierLocal implements ModifierLocalProvider<BeyondBoundsLayout>, BeyondBoundsLayout {
    ...
    private final LazyLayoutBeyondBoundsInfo.Interval m626addNextIntervalFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval currentInterval, int direction) {
        int start = currentInterval.getStart();
        int end = currentInterval.getEnd();
        if (m628isForward4vf7U8o(direction)) {
            end++;
        } else {
            start--;
        }
    ...
    public final boolean m627hasMoreContentFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval interval, int i) {
        if (m629isOppositeToOrientation4vf7U8o(i)) {
            return false;
        }
        if (m628isForward4vf7U8o(i)) {
    ...
    private final boolean m628isForward4vf7U8o(int i) {
        BeyondBoundsLayout.LayoutDirection.Companion companion = BeyondBoundsLayout.LayoutDirection.INSTANCE;
        if (BeyondBoundsLayout.LayoutDirection.m2784equalsimpl0(i, companion.m2790getBeforehoxUOeE())) {
            return false;
        }
        if (!BeyondBoundsLayout.LayoutDirection.m2784equalsimpl0(i, companion.m2789getAfterhoxUOeE())) {
            if (BeyondBoundsLayout.LayoutDirection.m2784equalsimpl0(i, companion.m2788getAbovehoxUOeE())) {
                return this.reverseLayout;
            }
            if (BeyondBoundsLayout.LayoutDirection.m2784equalsimpl0(i, companion.m2791getBelowhoxUOeE())) {
                if (this.reverseLayout) {
                    return false;
                }
            } else if (BeyondBoundsLayout.LayoutDirection.m2784equalsimpl0(i, companion.m2792getLefthoxUOeE())) {
                ...
                if (!BeyondBoundsLayout.LayoutDirection.m2784equalsimpl0(i, companion.m2793getRighthoxUOeE())) {
    ...
    private final boolean m629isOppositeToOrientation4vf7U8o(int i) {
        BeyondBoundsLayout.LayoutDirection.Companion companion = BeyondBoundsLayout.LayoutDirection.INSTANCE;
        if (!(BeyondBoundsLayout.LayoutDirection.m2784equalsimpl0(i, companion.m2788getAbovehoxUOeE()) ? true : BeyondBoundsLayout.LayoutDirection.m2784equalsimpl0(i, companion.m2791getBelowhoxUOeE()))) {
            if (!(BeyondBoundsLayout.LayoutDirection.m2784equalsimpl0(i, companion.m2792getLefthoxUOeE()) ? true : BeyondBoundsLayout.LayoutDirection.m2784equalsimpl0(i, companion.m2793getRighthoxUOeE()))) {
                if (!(BeyondBoundsLayout.LayoutDirection.m2784equalsimpl0(i, companion.m2790getBeforehoxUOeE()) ? true : BeyondBoundsLayout.LayoutDirection.m2784equalsimpl0(i, companion.m2789getAfterhoxUOeE()))) {
                    LazyLayoutBeyondBoundsModifierLocalKt.unsupportedDirection();
                    throw new KotlinNothingValueException();
                }
    ...
    public <T> T mo630layouto7g1Pn8(final int direction, @NotNull Function1<? super BeyondBoundsLayout.BeyondBoundsScope, ? extends T> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        if (this.state.getItemCount() <= 0 || !this.state.getHasVisibleItems()) {
            return block.invoke(emptyBeyondBoundsScope);
        }
        int lastPlacedIndex = m628isForward4vf7U8o(direction) ? this.state.getLastPlacedIndex() : this.state.getFirstPlacedIndex();
        final Ref.ObjectRef objectRef = new Ref.ObjectRef();
        objectRef.element = (T) this.beyondBoundsInfo.addInterval(lastPlacedIndex, lastPlacedIndex);
        T tInvoke = null;
        while (tInvoke == null && m627hasMoreContentFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, direction)) {
            T t = (T) m626addNextIntervalFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, direction);
            ...
            tInvoke = block.invoke(new BeyondBoundsLayout.BeyondBoundsScope() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutBeyondBoundsModifierLocal$layout$2
                @Override // androidx.compose.ui.layout.BeyondBoundsLayout.BeyondBoundsScope
                public boolean getHasMoreContent() {
                    return this.this$0.m627hasMoreContentFR3nfPY(objectRef.element, direction);
                }
            });
        }
        this.beyondBoundsInfo.removeInterval((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element);
