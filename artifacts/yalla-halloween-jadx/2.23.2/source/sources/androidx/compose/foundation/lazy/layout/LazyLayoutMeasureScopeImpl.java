...
public final class LazyLayoutMeasureScopeImpl implements LazyLayoutMeasureScope, MeasureScope {
    ...
    public List<Placeable> mo634measure0kLqBqw(int index, long constraints) {
        ...
        for (int i = 0; i < size; i++) {
            arrayList.add(listSubcompose.get(i).mo2804measureBRTryo0(constraints));
        }
    ...
    public float mo321toDpGaN1DYA(long j) {
        return this.subcomposeMeasureScope.mo321toDpGaN1DYA(j);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* JADX INFO: renamed from: toDp-u2uoSUM */
    public float mo323toDpu2uoSUM(int i) {
        return this.subcomposeMeasureScope.mo323toDpu2uoSUM(i);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* JADX INFO: renamed from: toDpSize-k-rfVVM */
    public long mo324toDpSizekrfVVM(long j) {
        return this.subcomposeMeasureScope.mo324toDpSizekrfVVM(j);
    }
    ...
    public long mo327toSizeXkaWNTQ(long j) {
        return this.subcomposeMeasureScope.mo327toSizeXkaWNTQ(j);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* JADX INFO: renamed from: toSp-0xMU5do */
    public long mo328toSp0xMU5do(float f) {
        return this.subcomposeMeasureScope.mo328toSp0xMU5do(f);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* JADX INFO: renamed from: toSp-kPz2Gy4 */
    public long mo329toSpkPz2Gy4(float f) {
        return this.subcomposeMeasureScope.mo329toSpkPz2Gy4(f);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* JADX INFO: renamed from: toDp-u2uoSUM */
    public float mo322toDpu2uoSUM(float f) {
        return this.subcomposeMeasureScope.mo322toDpu2uoSUM(f);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* JADX INFO: renamed from: toSp-kPz2Gy4 */
    public long mo330toSpkPz2Gy4(int i) {
        return this.subcomposeMeasureScope.mo330toSpkPz2Gy4(i);
    }
}
