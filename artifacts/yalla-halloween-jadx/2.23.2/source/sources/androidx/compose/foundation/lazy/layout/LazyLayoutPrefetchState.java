...
public final class LazyLayoutPrefetchState {
    ...
    public interface Prefetcher {
        ...
        PrefetchHandle mo636schedulePrefetch0kLqBqw(int index, long constraints);
    }
    ...
    @NotNull
    /* JADX INFO: renamed from: schedulePrefetch-0kLqBqw, reason: not valid java name */
    public final PrefetchHandle m635schedulePrefetch0kLqBqw(int index, long constraints) {
        PrefetchHandle prefetchHandleMo636schedulePrefetch0kLqBqw;
        Prefetcher prefetcher = this.prefetcher;
        return (prefetcher == null || (prefetchHandleMo636schedulePrefetch0kLqBqw = prefetcher.mo636schedulePrefetch0kLqBqw(index, constraints)) == null) ? DummyHandle.INSTANCE : prefetchHandleMo636schedulePrefetch0kLqBqw;
    }
