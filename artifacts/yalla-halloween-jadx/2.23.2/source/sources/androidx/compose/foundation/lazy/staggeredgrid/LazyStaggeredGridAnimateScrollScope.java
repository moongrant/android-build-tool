...
public final class LazyStaggeredGridAnimateScrollScope implements LazyAnimateScrollScope {
    ...
    public float expectedDistanceTo(int index, int targetScrollOffset) {
        ...
        int iM3934getHeightimpl = 0;
        for (int i = 0; i < size; i++) {
            LazyStaggeredGridItemInfo lazyStaggeredGridItemInfo = visibleItemsInfo.get(i);
            iM3934getHeightimpl += this.state.getIsVertical() ? IntSize.m3934getHeightimpl(lazyStaggeredGridItemInfo.getSize()) : IntSize.m3935getWidthimpl(lazyStaggeredGridItemInfo.getSize());
        }
        int mainAxisItemSpacing = layoutInfo.getMainAxisItemSpacing() + (iM3934getHeightimpl / visibleItemsInfo.size());
    ...
    public Integer getTargetItemOffset(int index) {
        ...
        long jMo650getOffsetnOccac = lazyStaggeredGridItemInfoFindVisibleItem.getOffset();
        return Integer.valueOf(this.state.getIsVertical() ? IntOffset.m3894getYimpl(jMo650getOffsetnOccac) : IntOffset.m3893getXimpl(jMo650getOffsetnOccac));
    }
