...
public final class LazyStaggeredGridKt {
    ...
    public static final void m652LazyStaggeredGridLJWHXA8(@NotNull final LazyStaggeredGridState state, @NotNull final Orientation orientation, @NotNull final Function2<? super Density, ? super Constraints, LazyStaggeredGridSlots> slots, @Nullable Modifier modifier, @Nullable PaddingValues paddingValues, boolean z, @Nullable FlingBehavior flingBehavior, boolean z2, float f, float f2, @NotNull final Function1<? super LazyStaggeredGridScope, Unit> content, @Nullable Composer composer, final int i, final int i2, final int i3) {
        ...
        PaddingValues paddingValuesM471PaddingValues0680j_4 = (i3 & 16) != 0 ? PaddingKt.m471PaddingValues0680j_4(Dp.m3775constructorimpl(0)) : paddingValues;
        ...
        float fM3775constructorimpl = (i3 & PSKKeyManager.MAX_KEY_LENGTH_BYTES) != 0 ? Dp.m3775constructorimpl(0) : f;
        float fM3775constructorimpl2 = (i3 & ConstantsKt.MINIMUM_BLOCK_SIZE) != 0 ? Dp.m3775constructorimpl(0) : f2;
        ...
        Function2<LazyLayoutMeasureScope, Constraints, LazyStaggeredGridMeasureResult> function2M661rememberStaggeredGridMeasurePolicynbWgWpA = LazyStaggeredGridMeasurePolicyKt.m661rememberStaggeredGridMeasurePolicynbWgWpA(state, function0RememberStaggeredGridItemProviderLambda, paddingValuesM471PaddingValues0680j_4, z3, orientation, fM3775constructorimpl, fM3775constructorimpl2, slots, composerStartRestartGroup, (i5 & 7168) | (i5 & 896) | 8 | ((i4 << 9) & 57344) | (i6 & 458752) | (3670016 & i6) | ((i4 << 15) & 29360128));
        ...
        final PaddingValues paddingValues2 = paddingValuesM471PaddingValues0680j_4;
        final FlingBehavior flingBehavior3 = flingBehavior2;
        final boolean z7 = z4;
        final float f3 = fM3775constructorimpl;
        final float f4 = fM3775constructorimpl2;
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridKt$LazyStaggeredGrid$1
            ...
            public final void invoke(@Nullable Composer composer2, int i9) {
                LazyStaggeredGridKt.m652LazyStaggeredGridLJWHXA8(state, orientation, slots, modifier3, paddingValues2, z5, flingBehavior3, z7, f3, f4, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), RecomposeScopeImplKt.updateChangedFlags(i2), i3);
            }
        });
    }
