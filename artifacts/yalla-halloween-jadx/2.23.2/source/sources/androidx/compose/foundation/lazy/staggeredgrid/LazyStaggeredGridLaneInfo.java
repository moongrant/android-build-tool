...
public final class LazyStaggeredGridLaneInfo {
    ...
    public static final class SpannedItem {
        ...
        public SpannedItem(int i, @NotNull int[] gaps) {
    ...
    private final void ensureCapacity(int capacity, int newOffset) {
        if (!(capacity <= MaxCapacity)) {
            throw new IllegalArgumentException(OooO0OO.OooO00o.OooO00o("Requested item capacity ", capacity, " is larger than max supported: 131072!").toString());
        }
        int[] iArr = this.lanes;
    ...
    public final void ensureValidIndex(int requestedIndex) {
        ...
        if (i2 >= 0 && i2 < MaxCapacity) {
            ...
            if (i3 >= 0) {
                ...
                if (iArr3.length + i4 < MaxCapacity) {
