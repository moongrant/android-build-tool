...
public final class LazyStaggeredGridMeasureKt {
    ...
    private static final List<LazyStaggeredGridMeasuredItem> calculateExtraItems(LazyStaggeredGridMeasureContext lazyStaggeredGridMeasureContext, Function1<? super LazyStaggeredGridMeasuredItem, Unit> function1, Function1<? super Integer, Boolean> function2) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (function2.invoke(Integer.valueOf(iIntValue)).booleanValue()) {
                long jM656getSpanRangelOCCd4c = lazyStaggeredGridMeasureContext.m656getSpanRangelOCCd4c(lazyStaggeredGridMeasureContext.getItemProvider(), iIntValue, 0);
                if (arrayList == null) {
                    arrayList = new ArrayList();
                }
                LazyStaggeredGridMeasuredItem lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ = lazyStaggeredGridMeasureContext.getMeasuredItemProvider().m664getAndMeasurejy6DScQ(iIntValue, jM656getSpanRangelOCCd4c);
                function1.invoke(lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ);
                arrayList.add(lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ);
            }
        }
    ...
    private static final List<LazyStaggeredGridMeasuredItem> calculateVisibleItems(LazyStaggeredGridMeasureContext lazyStaggeredGridMeasureContext, ArrayDeque<LazyStaggeredGridMeasuredItem>[] arrayDequeArr, int[] iArr, int i) {
        ...
        while (true) {
            ...
            if (lazyStaggeredGridMeasuredItemRemoveFirst.getLane() == i3) {
                long jM669constructorimpl = SpanRange.m669constructorimpl(lazyStaggeredGridMeasuredItemRemoveFirst.getLane(), lazyStaggeredGridMeasuredItemRemoveFirst.getSpan());
                int iM659maxInRangejy6DScQ = m659maxInRangejy6DScQ(iArr, jM669constructorimpl);
                ...
                if (lazyStaggeredGridMeasuredItemRemoveFirst.getPlaceablesCount() != 0) {
                    lazyStaggeredGridMeasuredItemRemoveFirst.position(iM659maxInRangejy6DScQ, i6, i);
                    arrayList.add(lazyStaggeredGridMeasuredItemRemoveFirst);
                    int i7 = (int) (jM669constructorimpl & 4294967295L);
                    for (int i8 = (int) (jM669constructorimpl >> 32); i8 < i7; i8++) {
                        iArr[i8] = lazyStaggeredGridMeasuredItemRemoveFirst.getSizeWithSpacings() + iM659maxInRangejy6DScQ;
                    }
                }
            }
        }
    ...
    private static final void m658forEachnIS5qE8(long j, Function1<? super Integer, Unit> function1) {
    ...
    private static final int m659maxInRangejy6DScQ(int[] iArr, long j) {
        int i = (int) (j & 4294967295L);
    ...
    private static final LazyStaggeredGridMeasureResult measure(LazyStaggeredGridMeasureContext lazyStaggeredGridMeasureContext, int i, int[] iArr, int[] iArr2, boolean z) {
        ...
        boolean z3;
        int i8;
        LazyStaggeredGridMeasuredItem lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ;
        int iM659maxInRangejy6DScQ;
        boolean z4;
        int[] gaps;
        int i9;
        boolean z5;
        ...
        if (itemCount <= 0 || lazyStaggeredGridMeasureContext.getLaneCount() == 0) {
            return new LazyStaggeredGridMeasureResult(iArr, iArr2, 0.0f, MeasureScope.CC.OooOOo0(measureScope, Constraints.m3745getMinWidthimpl(lazyStaggeredGridMeasureContext.getConstraints()), Constraints.m3744getMinHeightimpl(lazyStaggeredGridMeasureContext.getConstraints()), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasureKt$measure$1$1
            ...
            }, 4, null), false, false, lazyStaggeredGridMeasureContext.getIsVertical(), itemCount, CollectionsKt.emptyList(), IntSizeKt.IntSize(Constraints.m3745getMinWidthimpl(lazyStaggeredGridMeasureContext.getConstraints()), Constraints.m3744getMinHeightimpl(lazyStaggeredGridMeasureContext.getConstraints())), -lazyStaggeredGridMeasureContext.getBeforeContentPadding(), lazyStaggeredGridMeasureContext.getAfterContentPadding() + lazyStaggeredGridMeasureContext.getMainAxisAvailableSize(), lazyStaggeredGridMeasureContext.getBeforeContentPadding(), lazyStaggeredGridMeasureContext.getAfterContentPadding(), lazyStaggeredGridMeasureContext.getMainAxisSpacing(), null);
        }
        ...
        while (true) {
            ...
            long jM656getSpanRangelOCCd4c = lazyStaggeredGridMeasureContext2.m656getSpanRangelOCCd4c(lazyStaggeredGridMeasureContext.getItemProvider(), iFindPreviousItemIndex, iIndexOf);
            int i23 = (int) (4294967295L & jM656getSpanRangelOCCd4c);
            int i24 = (int) (jM656getSpanRangelOCCd4c >> 32);
            int i25 = i23 - i24;
            lazyStaggeredGridMeasureContext.getLaneInfo().setLane(iFindPreviousItemIndex, i25 != 1 ? -2 : i24);
            LazyStaggeredGridMeasuredItem lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ2 = lazyStaggeredGridMeasureContext.getMeasuredItemProvider().m664getAndMeasurejy6DScQ(iFindPreviousItemIndex, jM656getSpanRangelOCCd4c);
            int iM659maxInRangejy6DScQ2 = m659maxInRangejy6DScQ(iArrCopyOf2, jM656getSpanRangelOCCd4c);
            ...
            for (int i26 = i24; i26 < i23; i26++) {
                ...
                iArrCopyOf2[i26] = lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ2.getSizeWithSpacings() + iM659maxInRangejy6DScQ2 + (gaps2 == null ? 0 : gaps2[i26]);
            }
        }
        ...
        while (iIndexOfMinValue$default2 != -1 && laneCount2 < lazyStaggeredGridMeasureContext.getLaneCount()) {
            ...
            if (i33 >= 0) {
                str = str2;
                long jM656getSpanRangelOCCd4c2 = lazyStaggeredGridMeasureContext2.m656getSpanRangelOCCd4c(lazyStaggeredGridMeasureContext.getItemProvider(), i33, iIndexOfMinValue$default2);
                LazyStaggeredGridMeasuredItem lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ3 = lazyStaggeredGridMeasureContext.getMeasuredItemProvider().m664getAndMeasurejy6DScQ(i33, jM656getSpanRangelOCCd4c2);
                i14 = i17;
                iArr7 = iArrCopyOf;
                iArr8 = iArrCopyOf2;
                int i35 = (int) (jM656getSpanRangelOCCd4c2 & 4294967295L);
                i15 = i27;
                i16 = itemCount;
                int i36 = (int) (jM656getSpanRangelOCCd4c2 >> 32);
                int i37 = i35 - i36;
                lazyStaggeredGridMeasureContext.getLaneInfo().setLane(i33, i37 != 1 ? -2 : i36);
                int sizeWithSpacings = lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ3.getSizeWithSpacings() + m659maxInRangejy6DScQ(iArr11, jM656getSpanRangelOCCd4c2);
                for (int i38 = i36; i38 < i35; i38++) {
                    iArr11[i38] = sizeWithSpacings;
                    iArrCopyOf3[i38] = i33;
                    arrayDequeArr[i38].addLast(lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ3);
                }
                if (iArr11[i36] <= lazyStaggeredGridMeasureContext.getMainAxisSpacing() + i15) {
                    lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ3.setVisible(false);
                }
                if (i37 != 1) {
        ...
        while (true) {
            ...
            if (!z2) {
                ...
                int[] iArr15 = iArr13;
                int i48 = laneCount;
                long jM656getSpanRangelOCCd4c3 = lazyStaggeredGridMeasureContext2.m656getSpanRangelOCCd4c(lazyStaggeredGridMeasureContext.getItemProvider(), iMaxOrThrow, iIndexOfMinValue$default);
                LazyStaggeredGridLaneInfo laneInfo = lazyStaggeredGridMeasureContext.getLaneInfo();
                i5 = (int) (jM656getSpanRangelOCCd4c3 & 4294967295L);
                i6 = (int) (jM656getSpanRangelOCCd4c3 >> 32);
                i7 = i5 - i6;
                if (i7 != 1) {
                    z3 = true;
                } else {
                ...
                lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ = lazyStaggeredGridMeasureContext.getMeasuredItemProvider().m664getAndMeasurejy6DScQ(iMaxOrThrow, jM656getSpanRangelOCCd4c3);
                iM659maxInRangejy6DScQ = m659maxInRangejy6DScQ(iArr3, jM656getSpanRangelOCCd4c3);
                if (i7 != 1) {
                    z4 = true;
                } else {
                    z4 = false;
                ...
                for (i9 = i6; i9 < i5; i9++) {
                    if (gaps != null) {
                        gaps[i9] = iM659maxInRangejy6DScQ - iArr3[i9];
                    }
                    iArrCopyOf3[i9] = iMaxOrThrow;
                    iArr3[i9] = lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ.getSizeWithSpacings() + iM659maxInRangejy6DScQ;
                    arrayDequeArr[i9].addLast(lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ);
                }
                ...
                if (iArr3[i6] <= lazyStaggeredGridMeasureContext.getMainAxisSpacing() + i4) {
                    lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ.setVisible(false);
                }
                ...
                int[] iArr17 = iArr13;
                int i412 = laneCount;
                long jM656getSpanRangelOCCd4c4 = lazyStaggeredGridMeasureContext2.m656getSpanRangelOCCd4c(lazyStaggeredGridMeasureContext.getItemProvider(), iMaxOrThrow, iIndexOfMinValue$default);
                LazyStaggeredGridLaneInfo laneInfo2 = lazyStaggeredGridMeasureContext.getLaneInfo();
                i5 = (int) (jM656getSpanRangelOCCd4c4 & 4294967295L);
                i6 = (int) (jM656getSpanRangelOCCd4c4 >> 32);
                i7 = i5 - i6;
                if (i7 != 1) {
                    z3 = true;
                } else {
                ...
                lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ = lazyStaggeredGridMeasureContext.getMeasuredItemProvider().m664getAndMeasurejy6DScQ(iMaxOrThrow, jM656getSpanRangelOCCd4c4);
                iM659maxInRangejy6DScQ = m659maxInRangejy6DScQ(iArr3, jM656getSpanRangelOCCd4c4);
                if (i7 != 1) {
                    z4 = true;
                } else {
                    z4 = false;
        ...
        if (z6) {
            ...
            while (true) {
                ...
                long jM656getSpanRangelOCCd4c5 = lazyStaggeredGridMeasureContext2.m656getSpanRangelOCCd4c(lazyStaggeredGridMeasureContext.getItemProvider(), iFindPreviousItemIndex2, iIndexOfMinValue$default3);
                int i59 = length4;
                int[] iArr21 = iArr11;
                int i60 = (int) (jM656getSpanRangelOCCd4c5 & 4294967295L);
                boolean z15 = z14;
                int i61 = mainAxisAvailableSize;
                int i62 = (int) (jM656getSpanRangelOCCd4c5 >> 32);
                int i63 = i60 - i62;
                lazyStaggeredGridMeasureContext.getLaneInfo().setLane(iFindPreviousItemIndex2, i63 != 1 ? -2 : i62);
                LazyStaggeredGridMeasuredItem lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ4 = lazyStaggeredGridMeasureContext.getMeasuredItemProvider().m664getAndMeasurejy6DScQ(iFindPreviousItemIndex2, jM656getSpanRangelOCCd4c5);
                int iM659maxInRangejy6DScQ3 = m659maxInRangejy6DScQ(iArr6, jM656getSpanRangelOCCd4c5);
                int[] gaps4 = i63 != 1 ? lazyStaggeredGridMeasureContext.getLaneInfo().getGaps(iFindPreviousItemIndex2) : null;
                while (i62 < i60) {
                    if (iArr6[i62] != iM659maxInRangejy6DScQ3) {
                        z15 = true;
                    }
                    arrayDequeArr[i62].addFirst(lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ4);
                    iArr20[i62] = iFindPreviousItemIndex2;
                    iArr6[i62] = lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ4.getSizeWithSpacings() + iM659maxInRangejy6DScQ3 + (gaps4 == null ? 0 : gaps4[i62]);
                    i62++;
                }
                iCoerceAtLeast = i58;
                length4 = i59;
        ...
        int iM3743getMaxWidthimpl = lazyStaggeredGridMeasureContext.getIsVertical() ? Constraints.m3743getMaxWidthimpl(lazyStaggeredGridMeasureContext.getConstraints()) : ConstraintsKt.m3757constrainWidthK40F9xA(lazyStaggeredGridMeasureContext.getConstraints(), ArraysKt.maxOrThrow(iArr4) + afterContentPadding);
        int iM3756constrainHeightK40F9xA = lazyStaggeredGridMeasureContext.getIsVertical() ? ConstraintsKt.m3756constrainHeightK40F9xA(lazyStaggeredGridMeasureContext.getConstraints(), ArraysKt.maxOrThrow(iArr4) + afterContentPadding) : Constraints.m3742getMaxHeightimpl(lazyStaggeredGridMeasureContext.getConstraints());
        int afterContentPadding2 = lazyStaggeredGridMeasureContext.getAfterContentPadding() + (Math.min(lazyStaggeredGridMeasureContext.getIsVertical() ? iM3756constrainHeightK40F9xA : iM3743getMaxWidthimpl, lazyStaggeredGridMeasureContext.getMainAxisAvailableSize()) - lazyStaggeredGridMeasureContext.getBeforeContentPadding());
        ...
        while (i69 < size2) {
            ...
            if (z11) {
                long jM656getSpanRangelOCCd4c6 = lazyStaggeredGridMeasureContext2.m656getSpanRangelOCCd4c(lazyStaggeredGridMeasureContext.getItemProvider(), iIntValue, 0);
                if (listEmptyList == null) {
                    listEmptyList = new ArrayList();
                }
                LazyStaggeredGridMeasuredItem lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ5 = lazyStaggeredGridMeasureContext.getMeasuredItemProvider().m664getAndMeasurejy6DScQ(iIntValue, jM656getSpanRangelOCCd4c6);
                sizeWithSpacings3 -= lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ5.getSizeWithSpacings();
                lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ5.position(sizeWithSpacings3, 0, afterContentPadding2);
                listEmptyList.add(lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ5);
            }
            i69++;
            pinnedItems = list2;
            size2 = i70;
        ...
        while (i74 < size3) {
            ...
            if (iIntValue2 >= i3) {
                ...
                if (lane2 == -2 || lane2 == -1) {
                    ...
                    while (true) {
                        if (i75 < length11) {
                            ...
                            if (iArrCopyOf3[i75] < iIntValue2) {
                                ...
                                z10 = false;
                                if (z10) {
                                    long jM656getSpanRangelOCCd4c7 = lazyStaggeredGridMeasureContext2.m656getSpanRangelOCCd4c(lazyStaggeredGridMeasureContext.getItemProvider(), iIntValue2, 0);
                                    if (listEmptyList2 == null) {
                                        listEmptyList2 = new ArrayList();
                                    }
                                    LazyStaggeredGridMeasuredItem lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ6 = lazyStaggeredGridMeasureContext.getMeasuredItemProvider().m664getAndMeasurejy6DScQ(iIntValue2, jM656getSpanRangelOCCd4c7);
                                    lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ6.position(i73, 0, afterContentPadding2);
                                    int sizeWithSpacings4 = lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ6.getSizeWithSpacings() + i73;
                                    listEmptyList2.add(lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ6);
                    ...
                    if (z10) {
                        long jM656getSpanRangelOCCd4c8 = lazyStaggeredGridMeasureContext2.m656getSpanRangelOCCd4c(lazyStaggeredGridMeasureContext.getItemProvider(), iIntValue2, 0);
                        if (listEmptyList2 == null) {
                            listEmptyList2 = new ArrayList();
                        }
                        LazyStaggeredGridMeasuredItem lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ7 = lazyStaggeredGridMeasureContext.getMeasuredItemProvider().m664getAndMeasurejy6DScQ(iIntValue2, jM656getSpanRangelOCCd4c8);
                        lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ7.position(i73, 0, afterContentPadding2);
                        int sizeWithSpacings5 = lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ7.getSizeWithSpacings() + i73;
                        listEmptyList2.add(lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ7);
                ...
                z10 = true;
                if (z10) {
                    long jM656getSpanRangelOCCd4c9 = lazyStaggeredGridMeasureContext2.m656getSpanRangelOCCd4c(lazyStaggeredGridMeasureContext.getItemProvider(), iIntValue2, 0);
                    if (listEmptyList2 == null) {
                        listEmptyList2 = new ArrayList();
                    }
                    LazyStaggeredGridMeasuredItem lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ8 = lazyStaggeredGridMeasureContext.getMeasuredItemProvider().m664getAndMeasurejy6DScQ(iIntValue2, jM656getSpanRangelOCCd4c9);
                    lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ8.position(i73, 0, afterContentPadding2);
                    int sizeWithSpacings6 = lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ8.getSizeWithSpacings() + i73;
                    listEmptyList2.add(lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ8);
            ...
            z10 = false;
            if (z10) {
                long jM656getSpanRangelOCCd4c10 = lazyStaggeredGridMeasureContext2.m656getSpanRangelOCCd4c(lazyStaggeredGridMeasureContext.getItemProvider(), iIntValue2, 0);
                if (listEmptyList2 == null) {
                    listEmptyList2 = new ArrayList();
                }
                LazyStaggeredGridMeasuredItem lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ9 = lazyStaggeredGridMeasureContext.getMeasuredItemProvider().m664getAndMeasurejy6DScQ(iIntValue2, jM656getSpanRangelOCCd4c10);
                lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ9.position(i73, 0, afterContentPadding2);
                int sizeWithSpacings7 = lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ9.getSizeWithSpacings() + i73;
                listEmptyList2.add(lazyStaggeredGridMeasuredItemM664getAndMeasurejy6DScQ9);
        ...
        lazyStaggeredGridMeasureContext.getState().getPlacementAnimator().onMeasured((int) scrollToBeConsumed, iM3743getMaxWidthimpl, iM3756constrainHeightK40F9xA, arrayList, lazyStaggeredGridMeasureContext.getMeasuredItemProvider(), lazyStaggeredGridMeasureContext.getIsVertical(), lazyStaggeredGridMeasureContext.getLaneCount());
        ...
        return new LazyStaggeredGridMeasureResult(iArr25, iArr24, scrollToBeConsumed, MeasureScope.CC.OooOOo0(measureScope, iM3743getMaxWidthimpl, iM3756constrainHeightK40F9xA, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasureKt$measure$1$29
        ...
        try {
            ...
            try {
                ...
                if (iArrUpdateScrollPositionIfTheFirstItemWasMoved$foundation_release.length == lazyStaggeredGridMeasureContext.getLaneCount()) {
                    ...
                    int i6 = 0;
                    while (i6 < laneCount) {
                        if (i6 >= iArrUpdateScrollPositionIfTheFirstItemWasMoved$foundation_release.length || (iM659maxInRangejy6DScQ = iArrUpdateScrollPositionIfTheFirstItemWasMoved$foundation_release[i6]) == -1) {
                            iM659maxInRangejy6DScQ = i6 == 0 ? 0 : m659maxInRangejy6DScQ(iArr, SpanRange.m669constructorimpl(0, i6)) + 1;
                        }
                        iArr[i6] = iM659maxInRangejy6DScQ;
