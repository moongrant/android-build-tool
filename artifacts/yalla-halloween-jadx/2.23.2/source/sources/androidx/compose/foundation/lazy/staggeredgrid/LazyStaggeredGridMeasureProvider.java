...
public abstract class LazyStaggeredGridMeasureProvider {
    ...
    private final long m663childConstraintsJhjzzOo(int requestedSlot, int requestedSpan) {
        int i;
        ...
        return this.isVertical ? Constraints.INSTANCE.m3753fixedWidthOenEA2s(i) : Constraints.INSTANCE.m3752fixedHeightOenEA2s(i);
    }
    ...
    public final LazyStaggeredGridMeasuredItem m664getAndMeasurejy6DScQ(int index, long span) {
        int i = (int) (span >> 32);
        int i2 = ((int) (span & 4294967295L)) - i;
        return createItem(index, i, i2, this.itemProvider.getKey(index), this.itemProvider.getContentType(index), this.measureScope.mo634measure0kLqBqw(index, m663childConstraintsJhjzzOo(i, i2)));
    }
