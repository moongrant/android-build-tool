...
final class LazyStaggeredGridSlotCache implements Function2<Density, Constraints, LazyStaggeredGridSlots> {
    ...
    public LazyStaggeredGridSlots m667invoke0kLqBqw(@NotNull Density density, long constraints) {
        ...
        LazyStaggeredGridSlots lazyStaggeredGridSlotsInvoke = this.calculation.invoke(density, Constraints.m3731boximpl(constraints));
