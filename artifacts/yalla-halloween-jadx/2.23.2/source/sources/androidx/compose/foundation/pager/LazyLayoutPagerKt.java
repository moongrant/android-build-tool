...
public final class LazyLayoutPagerKt {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        ...
        public static final class C00551 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public static final class C00561 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
                ...
                public C00561(PagerState pagerState, Continuation<? super C00561> continuation) {
                ...
                public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                    C00561 c00561 = new C00561(this.$state, continuation);
                    c00561.L$0 = obj;
                    return c00561;
                }
                ...
                public final java.lang.Object invokeSuspend(@org.jetbrains.annotations.NotNull java.lang.Object r14) {
                    ...
                    La2:
                        ...
                        long r0 = androidx.compose.ui.geometry.Offset.m1451minusMKHz9U(r0, r2)
                        r14.m699setUpDownDifferencek4lQ0M$foundation_release(r0)
                        kotlin.Unit r14 = kotlin.Unit.INSTANCE
                        return r14
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.pager.LazyLayoutPagerKt.AnonymousClass1.C00551.C00561.invokeSuspend(java.lang.Object):java.lang.Object");
                }
            }

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C00551(PointerInputScope pointerInputScope, PagerState pagerState, Continuation<? super C00551> continuation) {
                super(2, continuation);
            ...
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                return new C00551(this.$$this$pointerInput, this.$state, continuation);
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                if (i == 0) {
                    ...
                    this.label = 1;
                    if (ForEachGestureKt.awaitEachGesture(pointerInputScope, c00561, this) == coroutine_suspended) {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                C00551 c00551 = new C00551((PointerInputScope) this.L$0, this.$state, null);
                this.label = 1;
                if (CoroutineScopeKt.coroutineScope(c00551, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
    ...
    public static final void m681Pagerfs30GE4(@NotNull final Modifier modifier, @NotNull final PagerState state, @NotNull final PaddingValues contentPadding, final boolean z, @NotNull final Orientation orientation, @NotNull final SnapFlingBehavior flingBehavior, final boolean z2, int i, float f, @NotNull final PageSize pageSize, @NotNull final NestedScrollConnection pageNestedScrollConnection, @Nullable final Function1<? super Integer, ? extends Object> function1, @NotNull final Alignment.Horizontal horizontalAlignment, @NotNull final Alignment.Vertical verticalAlignment, @NotNull final Function4<? super PagerScope, ? super Integer, ? super Composer, ? super Integer, Unit> pageContent, @Nullable Composer composer, final int i2, final int i3, final int i4) {
        ...
        int i5 = (i4 & 128) != 0 ? 0 : i;
        float fM3775constructorimpl = (i4 & PSKKeyManager.MAX_KEY_LENGTH_BYTES) != 0 ? Dp.m3775constructorimpl(0) : f;
        ...
        int i12 = i2 >> 6;
        int i13 = i3 << 18;
        Function2<LazyLayoutMeasureScope, Constraints, MeasureResult> function2M694rememberPagerMeasurePolicyBxUkNYg = PagerMeasurePolicyKt.m694rememberPagerMeasurePolicyBxUkNYg(function0RememberPagerItemProviderLambda, state, contentPadding, z, orientation, i8, fM3775constructorimpl, pageSize, horizontalAlignment, verticalAlignment, (Function0) objRememberedValue2, composerStartRestartGroup, i9 | (i2 & 896) | i10 | i11 | (i12 & 458752) | (i12 & 3670016) | (i12 & 29360128) | (234881024 & i13) | (i13 & 1879048192), 0);
        int i14 = i2 >> 15;
        ...
        composerStartRestartGroup.endReplaceableGroup();
        LazyLayoutKt.LazyLayout(function0RememberPagerItemProviderLambda, NestedScrollModifierKt.nestedScroll$default(dragDirectionDetector(ScrollableKt.scrollable(OverscrollKt.overscroll(PagerBeyondBoundsModifierKt.pagerBeyondBoundsModifier(ClipScrollableContainerKt.clipScrollableContainer(LazyLayoutSemanticsKt.lazyLayoutSemantics(modifier.then(state.getRemeasurementModifier()).then(state.getAwaitLayoutModifier()).then(modifierPagerSemantics), function0RememberPagerItemProviderLambda, PagerSemanticsKt.rememberPagerSemanticState(state, z, orientation == Orientation.Vertical, composerStartRestartGroup, i7 | (i12 & 112)), orientation, z2, z, composerStartRestartGroup, (i6 & 7168) | (i12 & 57344) | ((i2 << 6) & 458752)), orientation), state, i8, z, orientation, composerStartRestartGroup, i9 | (i14 & 896) | i10 | i11), overscrollEffect), state, orientation, overscrollEffect, z2, scrollableDefaults.reverseDirection((LayoutDirection) composerStartRestartGroup.consume(CompositionLocalsKt.getLocalLayoutDirection()), orientation, z), pagerWrapperFlingBehavior, state.getInternalInteractionSource()), state), pageNestedScrollConnection, null, 2, null), state.getPrefetchState(), function2M694rememberPagerMeasurePolicyBxUkNYg, composerStartRestartGroup, 0, 0);
        if (ComposerKt.isTraceInProgress()) {
        ...
        final float f2 = fM3775constructorimpl;
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.pager.LazyLayoutPagerKt$Pager$2
            ...
            public final void invoke(@Nullable Composer composer2, int i15) {
                LazyLayoutPagerKt.m681Pagerfs30GE4(modifier, state, contentPadding, z, orientation, flingBehavior, z2, i8, f2, pageSize, pageNestedScrollConnection, function1, horizontalAlignment, verticalAlignment, pageContent, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), RecomposeScopeImplKt.updateChangedFlags(i3), i4);
            }
        });
    }
