...
public final class MeasuredPage implements PageInfo {
    ...
    private final long m682copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
    ...
    private final long m683getOffsetBjo55l4(int index) {
    ...
    public final void place(@NotNull Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            long jM683getOffsetBjo55l4 = m683getOffsetBjo55l4(i);
            if (this.reverseLayout) {
                jM683getOffsetBjo55l4 = IntOffsetKt.IntOffset(this.isVertical ? IntOffset.m3893getXimpl(jM683getOffsetBjo55l4) : (this.mainAxisLayoutSize - IntOffset.m3893getXimpl(jM683getOffsetBjo55l4)) - getMainAxisSize(placeable), this.isVertical ? (this.mainAxisLayoutSize - IntOffset.m3894getYimpl(jM683getOffsetBjo55l4)) - getMainAxisSize(placeable) : IntOffset.m3894getYimpl(jM683getOffsetBjo55l4));
            }
            long j = this.visualOffset;
            long jOooO00o = OooO0o.OooO00o(j, IntOffset.m3894getYimpl(jM683getOffsetBjo55l4), IntOffset.m3893getXimpl(j) + IntOffset.m3893getXimpl(jM683getOffsetBjo55l4));
            if (this.isVertical) {
                Placeable.PlacementScope.m2851placeWithLayeraW9wM$default(scope, placeable, jOooO00o, 0.0f, null, 6, null);
            } else {
                Placeable.PlacementScope.m2850placeRelativeWithLayeraW9wM$default(scope, placeable, jOooO00o, 0.0f, null, 6, null);
            }
        }
    }
