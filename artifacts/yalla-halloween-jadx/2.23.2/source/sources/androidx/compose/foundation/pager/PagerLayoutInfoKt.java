...
public final class PagerLayoutInfoKt {
    public static final int getMainAxisViewportSize(@NotNull PagerLayoutInfo pagerLayoutInfo) {
        ...
        return pagerLayoutInfo.getOrientation() == Orientation.Vertical ? IntSize.m3934getHeightimpl(pagerLayoutInfo.mo690getViewportSizeYbymL2g()) : IntSize.m3935getWidthimpl(pagerLayoutInfo.mo690getViewportSizeYbymL2g());
    }
