...
public final class AbsoluteRoundedCornerShapeKt {
    ...
    public static final AbsoluteRoundedCornerShape m717AbsoluteRoundedCornerShape0680j_4(float f) {
        return AbsoluteRoundedCornerShape(CornerSizeKt.m721CornerSize0680j_4(f));
    }

    @NotNull
    /* JADX INFO: renamed from: AbsoluteRoundedCornerShape-a9UjIt4, reason: not valid java name */
    public static final AbsoluteRoundedCornerShape m718AbsoluteRoundedCornerShapea9UjIt4(float f, float f2, float f3, float f4) {
        return new AbsoluteRoundedCornerShape(CornerSizeKt.m721CornerSize0680j_4(f), CornerSizeKt.m721CornerSize0680j_4(f2), CornerSizeKt.m721CornerSize0680j_4(f3), CornerSizeKt.m721CornerSize0680j_4(f4));
    }

    /* JADX INFO: renamed from: AbsoluteRoundedCornerShape-a9UjIt4$default, reason: not valid java name */
    public static /* synthetic */ AbsoluteRoundedCornerShape m719AbsoluteRoundedCornerShapea9UjIt4$default(float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m718AbsoluteRoundedCornerShapea9UjIt4(f, f2, f3, f4);
    }
