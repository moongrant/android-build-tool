...
public final class CutCornerShape extends CornerBasedShape {
    ...
    public Outline mo712createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, @NotNull LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m1516getWidthimpl(size) - topStart, 0.0f);
        Path.lineTo(Size.m1516getWidthimpl(size), topStart);
        float f2 = layoutDirection == layoutDirection2 ? bottomEnd : bottomStart;
        Path.lineTo(Size.m1516getWidthimpl(size), Size.m1513getHeightimpl(size) - f2);
        Path.lineTo(Size.m1516getWidthimpl(size) - f2, Size.m1513getHeightimpl(size));
        if (layoutDirection == layoutDirection2) {
            bottomEnd = bottomStart;
        }
        Path.lineTo(bottomEnd, Size.m1513getHeightimpl(size));
        Path.lineTo(0.0f, Size.m1513getHeightimpl(size) - bottomEnd);
        Path.close();
