...
final /* data */ class DpCornerSize implements CornerSize, InspectableValue {
    ...
    public static /* synthetic */ DpCornerSize m726copy0680j_4$default(DpCornerSize dpCornerSize, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            f = dpCornerSize.size;
        }
        return dpCornerSize.m727copy0680j_4(f);
    }

    @NotNull
    /* JADX INFO: renamed from: copy-0680j_4, reason: not valid java name */
    public final DpCornerSize m727copy0680j_4(float size) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return (other instanceof DpCornerSize) && Dp.m3780equalsimpl0(this.size, ((DpCornerSize) other).size);
    }
    ...
    public /* bridge */ /* synthetic */ Object getValueOverride() {
        return Dp.m3773boximpl(m728getValueOverrideD9Ej5fM());
    }

    /* JADX INFO: renamed from: getValueOverride-D9Ej5fM, reason: not valid java name */
    public float m728getValueOverrideD9Ej5fM() {
        return this.size;
    }
    ...
    public float mo720toPxTmRCtEA(long shapeSize, @NotNull Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.mo326toPx0680j_4(this.size);
    }
