...
public final class HeightInLinesModifierKt {
    ...
    public static final Modifier heightInLines(@NotNull Modifier modifier, @NotNull final TextStyle textStyle, final int i, final int i2) {
        ...
        return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.text.HeightInLinesModifierKt$heightInLines$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(@NotNull Modifier modifier2, @Nullable Composer composer, int i3) {
                if (OooOOO.OooO0O0(modifier2, "$this$composed", composer, 408240218)) {
                ...
                if (zChanged2 || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                    ...
                    FontStyle fontStyleM3343getFontStyle4Lr2A7w = textStyle3.m3343getFontStyle4Lr2A7w();
                    int iM3419unboximpl = fontStyleM3343getFontStyle4Lr2A7w != null ? fontStyleM3343getFontStyle4Lr2A7w.m3419unboximpl() : FontStyle.INSTANCE.m3421getNormal_LCdwA();
                    FontSynthesis fontSynthesisM3344getFontSynthesisZQGJjVo = textStyle3.m3344getFontSynthesisZQGJjVo();
                    objRememberedValue2 = resolver.mo3391resolveDPcqOEQ(fontFamily, fontWeight, iM3419unboximpl, fontSynthesisM3344getFontSynthesisZQGJjVo != null ? fontSynthesisM3344getFontSynthesisZQGJjVo.getValue() : FontSynthesis.INSTANCE.m3431getAllGVVA2EU());
                ...
                if (zChanged3 || objRememberedValue3 == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue3 = Integer.valueOf(IntSize.m3934getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(textStyle3, density, resolver, TextFieldDelegateKt.getEmptyTextReplacement(), 1)));
                ...
                if (zChanged4 || objRememberedValue4 == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue4 = Integer.valueOf(IntSize.m3934getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(textStyle3, density, resolver, TextFieldDelegateKt.getEmptyTextReplacement() + '\n' + TextFieldDelegateKt.getEmptyTextReplacement(), 2)));
                ...
                Modifier modifierM512heightInVpY3zN4 = SizeKt.m512heightInVpY3zN4(Modifier.INSTANCE, numValueOf != null ? density.mo323toDpu2uoSUM(numValueOf.intValue()) : Dp.INSTANCE.m3795getUnspecifiedD9Ej5fM(), numValueOf2 != null ? density.mo323toDpu2uoSUM(numValueOf2.intValue()) : Dp.INSTANCE.m3795getUnspecifiedD9Ej5fM());
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                composer.endReplaceableGroup();
                return modifierM512heightInVpY3zN4;
            }
    ...
    public static final void validateMinMaxLines(int i, int i2) {
        ...
        if (!(i <= i2)) {
            throw new IllegalArgumentException(OooO0O0.OooO0O0("minLines ", i, " must be less than or equal to maxLines ", i2).toString());
        }
    }
}
