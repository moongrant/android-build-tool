...
final /* data */ class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo27measure3p2s80s(@NotNull final MeasureScope measure, @NotNull Measurable measurable, long j) {
        ...
        final Placeable placeableMo2804measureBRTryo0 = measurable.mo2804measureBRTryo0(measurable.maxIntrinsicWidth(Constraints.m3742getMaxHeightimpl(j)) < Constraints.m3743getMaxWidthimpl(j) ? j : Constraints.m3734copyZbe2FdA$default(j, 0, Integer.MAX_VALUE, 0, 0, 13, null));
        final int iMin = Math.min(placeableMo2804measureBRTryo0.getWidth(), Constraints.m3743getMaxWidthimpl(j));
        return MeasureScope.CC.OooOOo0(measure, iMin, placeableMo2804measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.HorizontalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                ...
                this.getScrollerPosition().update(Orientation.Horizontal, TextFieldScrollKt.getCursorRectInScroller(measureScope, cursorOffset, transformedText, textLayoutResultProxyInvoke != null ? textLayoutResultProxyInvoke.getValue() : null, measure.getLayoutDirection() == LayoutDirection.Rtl, placeableMo2804measureBRTryo0.getWidth()), iMin, placeableMo2804measureBRTryo0.getWidth());
                Placeable.PlacementScope.placeRelative$default(layout, placeableMo2804measureBRTryo0, MathKt.roundToInt(-this.getScrollerPosition().getOffset()), 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
