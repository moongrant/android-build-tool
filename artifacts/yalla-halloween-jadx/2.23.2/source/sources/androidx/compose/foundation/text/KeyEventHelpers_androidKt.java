...
public final class KeyEventHelpers_androidKt {
    ...
    public static final boolean m754cancelsTextSelectionZmokQxo(@NotNull KeyEvent cancelsTextSelection) {
        Intrinsics.checkNotNullParameter(cancelsTextSelection, "$this$cancelsTextSelection");
        return cancelsTextSelection.getKeyCode() == 4 && KeyEventType.m2578equalsimpl0(KeyEvent_androidKt.m2586getTypeZmokQxo(cancelsTextSelection), KeyEventType.INSTANCE.m2583getKeyUpCS__XNY());
    }
