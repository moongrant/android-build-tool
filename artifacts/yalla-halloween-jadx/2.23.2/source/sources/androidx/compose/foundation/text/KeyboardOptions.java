...
public final class KeyboardOptions {
    ...
    public static /* synthetic */ KeyboardOptions m758copy3m2b7yw$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
        ...
        return keyboardOptions.m759copy3m2b7yw(i, z, i2, i3);
    }
    ...
    public final KeyboardOptions m759copy3m2b7yw(int capitalization, boolean autoCorrect, int keyboardType, int imeAction) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return KeyboardCapitalization.m3495equalsimpl0(this.capitalization, keyboardOptions.capitalization) && this.autoCorrect == keyboardOptions.autoCorrect && KeyboardType.m3510equalsimpl0(this.keyboardType, keyboardOptions.keyboardType) && ImeAction.m3465equalsimpl0(this.imeAction, keyboardOptions.imeAction);
    }
    ...
    public int hashCode() {
        return ImeAction.m3466hashCodeimpl(this.imeAction) + ((KeyboardType.m3511hashCodeimpl(this.keyboardType) + (((KeyboardCapitalization.m3496hashCodeimpl(this.capitalization) * 31) + (this.autoCorrect ? 1231 : 1237)) * 31)) * 31);
    }
    ...
    public String toString() {
        return "KeyboardOptions(capitalization=" + ((Object) KeyboardCapitalization.m3497toStringimpl(this.capitalization)) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + ((Object) KeyboardType.m3512toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m3467toStringimpl(this.imeAction)) + ')';
    }
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m3504getNoneIUNYP9k() : i, (i4 & 2) != 0 ? true : z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m3530getTextPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m3477getDefaulteUduSuo() : i3, null);
    }
}
