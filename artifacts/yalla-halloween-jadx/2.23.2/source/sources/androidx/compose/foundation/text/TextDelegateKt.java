...
public final class TextDelegateKt {
    ...
    public static final TextDelegate m795updateTextDelegaterm0N8CA(@NotNull TextDelegate current, @NotNull AnnotatedString text, @NotNull TextStyle style, @NotNull Density density, @NotNull FontFamily.Resolver fontFamilyResolver, boolean z, int i, int i2, int i3, @NotNull List<AnnotatedString.Range<Placeholder>> placeholders) {
        ...
        if (Intrinsics.areEqual(current.getText(), text) && Intrinsics.areEqual(current.getStyle(), style)) {
            if (current.getSoftWrap() == z) {
                if (TextOverflow.m3721equalsimpl0(current.getOverflow(), i)) {
