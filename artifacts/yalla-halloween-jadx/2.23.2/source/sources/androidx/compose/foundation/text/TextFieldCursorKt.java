...
public final class TextFieldCursorKt {
    ...
    private static final float DefaultCursorThickness = Dp.m3775constructorimpl(2);
        ...
        return z ? ComposedModifierKt.composed$default(modifier, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.TextFieldCursorKt.cursor.1
            ...
            public static final class C00641 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                public static final class C00651 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public C00651(Animatable<Float, AnimationVector1D> animatable, Continuation<? super C00651> continuation) {
                    ...
                    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                        return new C00651(this.$cursorAlpha, continuation);
                    }
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C00641(Animatable<Float, AnimationVector1D> animatable, Continuation<? super C00641> continuation) {
                    super(2, continuation);
                    this.$cursorAlpha = animatable;
                }
                ...
                @NotNull
                public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                    return new C00641(this.$cursorAlpha, continuation);
                }
                ...
                public final Object invokeSuspend(@NotNull Object obj) {
                    ...
                    if (i == 0) {
                        ...
                        C00651 c00651 = new C00651(this.$cursorAlpha, null);
                        this.label = 1;
                        if (BuildersKt.withContext(fixedMotionDurationScale, c00651, this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    } else {
                        if (i != 1) {
            ...
            public final Modifier invoke(@NotNull Modifier modifier2, @Nullable Composer composer, int i) {
                ...
                if (OooOOO.OooO0O0(modifier2, "$this$composed", composer, 1634330012)) {
                ...
                if (state.getHasFocus() && TextRange.m3314getCollapsedimpl(value.getSelection()) && z2) {
                    EffectsKt.LaunchedEffect(value.getAnnotatedString(), TextRange.m3308boximpl(value.getSelection()), new C00641(animatable, null), composer, ConstantsKt.MINIMUM_BLOCK_SIZE);
                    ...
                    modifierDrawWithContent = DrawModifierKt.drawWithContent(modifier2, new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.TextFieldCursorKt.cursor.1.2
                        ...
                        public final void invoke2(@NotNull ContentDrawScope drawWithContent) {
                            ...
                            int iOriginalToTransformed = offsetMapping2.originalToTransformed(TextRange.m3320getStartimpl(textFieldValue.getSelection()));
                            ...
                            float fMo326toPx0680j_4 = drawWithContent.mo326toPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness());
                            float f = fMo326toPx0680j_4 / 2;
                            float fCoerceAtMost = RangesKt.coerceAtMost(rect.getLeft() + f, Size.m1516getWidthimpl(drawWithContent.mo2118getSizeNHjbRc()) - f);
                            OooO0O0.OooOoo0(drawWithContent, brush2, OffsetKt.Offset(fCoerceAtMost, rect.getTop()), OffsetKt.Offset(fCoerceAtMost, rect.getBottom()), fMo326toPx0680j_4, 0, null, fCoerceIn, null, 0, 432, null);
                        }
                    });
                } else {
