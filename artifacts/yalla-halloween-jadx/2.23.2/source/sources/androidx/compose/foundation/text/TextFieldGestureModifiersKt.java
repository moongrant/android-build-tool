...
public final class TextFieldGestureModifiersKt {
    ...
    public static final class C07071 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ MouseSelectionObserver $observer;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C07071(MouseSelectionObserver mouseSelectionObserver, Continuation<? super C07071> continuation) {
            super(2, continuation);
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C07071 c07071 = new C07071(this.$observer, continuation);
            c07071.L$0 = obj;
            return c07071;
        }
        ...
        @Nullable
        public final Object invoke(@NotNull PointerInputScope pointerInputScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C07071) create(pointerInputScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final Modifier mouseDragGestureDetector(@NotNull Modifier modifier, @NotNull MouseSelectionObserver observer, boolean z) {
        Intrinsics.checkNotNullParameter(modifier, "<this>");
        Intrinsics.checkNotNullParameter(observer, "observer");
        return z ? SuspendingPointerInputFilterKt.pointerInput(Modifier.INSTANCE, observer, new C07071(observer, null)) : modifier;
    }
