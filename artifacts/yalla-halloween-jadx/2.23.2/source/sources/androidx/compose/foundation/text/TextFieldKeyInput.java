...
public final class TextFieldKeyInput {
    ...
    private final void commandExecutionContext(Function1<? super TextFieldPreparedSelection, Unit> block) {
        ...
        if (TextRange.m3313equalsimpl0(textFieldPreparedSelection.getSelection(), this.value.getSelection()) && Intrinsics.areEqual(textFieldPreparedSelection.getAnnotatedString(), this.value.getAnnotatedString())) {
            return;
        }
    ...
    private final CommitTextCommand m809typedCommandZmokQxo(KeyEvent event) {
        Integer numM753consumeZmokQxo;
        if (!TextFieldKeyInput_androidKt.m814isTypedEventZmokQxo(event) || (numM753consumeZmokQxo = this.keyCombiner.m753consumeZmokQxo(event)) == null) {
            return null;
        }
        String string = StringHelpers_jvmKt.appendCodePointX(new StringBuilder(), numM753consumeZmokQxo.intValue()).toString();
    ...
    public final boolean m810processZmokQxo(@NotNull KeyEvent event) {
        final KeyCommand keyCommandMo755mapZmokQxo;
        Intrinsics.checkNotNullParameter(event, "event");
        CommitTextCommand commitTextCommandM809typedCommandZmokQxo = m809typedCommandZmokQxo(event);
        if (commitTextCommandM809typedCommandZmokQxo != null) {
            if (!this.editable) {
                return false;
            }
            apply(commitTextCommandM809typedCommandZmokQxo);
            this.preparedSelectionState.resetCachedX();
            return true;
        }
        if (!KeyEventType.m2578equalsimpl0(KeyEvent_androidKt.m2586getTypeZmokQxo(event), KeyEventType.INSTANCE.m2582getKeyDownCS__XNY()) || (keyCommandMo755mapZmokQxo = this.keyMapping.mo755mapZmokQxo(event)) == null || (keyCommandMo755mapZmokQxo.getEditsText() && !this.editable)) {
            return false;
        }
        ...
        commandExecutionContext(new Function1<TextFieldPreparedSelection, Unit>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2
            ...
            public final void invoke2(@NotNull TextFieldPreparedSelection commandExecutionContext) {
                ...
                switch (WhenMappings.$EnumSwitchMapping$0[keyCommandMo755mapZmokQxo.ordinal()]) {
                    case 1:
                    ...
                    case 20:
                        List<EditCommand> listDeleteIfSelectedOr = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.3
                            ...
                            public final EditCommand invoke(@NotNull TextFieldPreparedSelection deleteIfSelectedOr) {
                                ...
                                return new DeleteSurroundingTextCommand(TextRange.m3315getEndimpl(deleteIfSelectedOr.getSelection()) - deleteIfSelectedOr.getPrecedingCharacterIndex(), 0);
                            }
                        });
                        ...
                        List<EditCommand> listDeleteIfSelectedOr2 = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.4
                            ...
                            public final EditCommand invoke(@NotNull TextFieldPreparedSelection deleteIfSelectedOr) {
                                ...
                                if (nextCharacterIndex != -1) {
                                    return new DeleteSurroundingTextCommand(0, nextCharacterIndex - TextRange.m3315getEndimpl(deleteIfSelectedOr.getSelection()));
                                }
                                return null;
                            }
                        });
                    ...
                    case 22:
                        List<EditCommand> listDeleteIfSelectedOr3 = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.5
                            ...
                            public final EditCommand invoke(@NotNull TextFieldPreparedSelection deleteIfSelectedOr) {
                                ...
                                return new DeleteSurroundingTextCommand(TextRange.m3315getEndimpl(deleteIfSelectedOr.getSelection()) - previousWordOffset.intValue(), 0);
                            }
                        });
                        ...
                        List<EditCommand> listDeleteIfSelectedOr4 = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.6
                            ...
                            public final EditCommand invoke(@NotNull TextFieldPreparedSelection deleteIfSelectedOr) {
                                ...
                                if (nextWordOffset != null) {
                                    return new DeleteSurroundingTextCommand(0, nextWordOffset.intValue() - TextRange.m3315getEndimpl(deleteIfSelectedOr.getSelection()));
                                }
                                return null;
                            }
                        });
                    ...
                    case 24:
                        List<EditCommand> listDeleteIfSelectedOr5 = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.7
                            ...
                            public final EditCommand invoke(@NotNull TextFieldPreparedSelection deleteIfSelectedOr) {
                                ...
                                return new DeleteSurroundingTextCommand(TextRange.m3315getEndimpl(deleteIfSelectedOr.getSelection()) - lineStartByOffset.intValue(), 0);
                            }
                        });
                        ...
                        List<EditCommand> listDeleteIfSelectedOr6 = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.8
                            ...
                            public final EditCommand invoke(@NotNull TextFieldPreparedSelection deleteIfSelectedOr) {
                                ...
                                if (lineEndByOffset != null) {
                                    return new DeleteSurroundingTextCommand(0, lineEndByOffset.intValue() - TextRange.m3315getEndimpl(deleteIfSelectedOr.getSelection()));
                                }
                                return null;
                            }
                        });
                    ...
                    case 26:
                        if (!this.getSingleLine()) {
                            ...
                            this.getState().getOnImeActionPerformed().invoke(ImeAction.m3462boximpl(this.imeAction));
                        }
                        break;
                    case 27:
                        if (!this.getSingleLine()) {
