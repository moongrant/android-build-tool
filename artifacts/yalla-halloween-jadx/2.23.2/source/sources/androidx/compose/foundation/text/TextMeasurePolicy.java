    ...
    public MeasureResult mo3measure3p2s80s(@NotNull MeasureScope measure, @NotNull List<? extends Measurable> measurables, long j) {
        ...
        if (listInvoke != null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                Pair pair = rect != null ? new Pair(measurables.get(i).mo2804measureBRTryo0(ConstraintsKt.Constraints$default(0, (int) Math.floor(rect.getWidth()), 0, (int) Math.floor(rect.getHeight()), 5, null)), IntOffset.m3884boximpl(IntOffsetKt.IntOffset(MathKt.roundToInt(rect.getLeft()), MathKt.roundToInt(rect.getTop())))) : null;
                if (pair != null) {
                    arrayList2.add(pair);
                }
            }
        ...
        return MeasureScope.CC.OooOOo0(measure, Constraints.m3743getMaxWidthimpl(j), Constraints.m3742getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.TextMeasurePolicy$measure$1
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                ...
                if (list != null) {
                    ...
                    for (int i2 = 0; i2 < size2; i2++) {
                        ...
                        Placeable.PlacementScope.m2848place70tqf50$default(layout, pair2.component1(), pair2.component2().getPackedValue(), 0.0f, 2, null);
                    }
                }
            }
        }, 4, null);
