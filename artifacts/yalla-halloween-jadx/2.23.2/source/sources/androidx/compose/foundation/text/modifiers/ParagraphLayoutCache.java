...
public final class ParagraphLayoutCache {
    ...
    private final Paragraph m858layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ParagraphIntrinsics layoutDirection2 = setLayoutDirection(layoutDirection);
        return ParagraphKt.m3220Paragraph_EkL_Y(layoutDirection2, LayoutUtilsKt.m847finalConstraintstfFHcEY(constraints, this.softWrap, this.overflow, layoutDirection2.getMaxIntrinsicWidth()), LayoutUtilsKt.m848finalMaxLinesxdlQI24(this.softWrap, this.overflow, this.maxLines), TextOverflow.m3721equalsimpl0(this.overflow, TextOverflow.INSTANCE.m3729getEllipsisgIe3tQ8()));
    }
    ...
    private final void markDirty() {
        ...
        this.prevConstraints = Constraints.INSTANCE.m3751fixedJhjzzOo(0, 0);
    ...
    private final boolean m859newLayoutWillBeDifferentK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        if (Constraints.m3736equalsimpl0(constraints, this.prevConstraints)) {
            return false;
        }
        return Constraints.m3743getMaxWidthimpl(constraints) != Constraints.m3743getMaxWidthimpl(this.prevConstraints) || ((float) Constraints.m3742getMaxHeightimpl(constraints)) < paragraph.getHeight() || paragraph.getDidExceedMaxLines();
    }
    ...
    public final int intrinsicHeight(int width, @NotNull LayoutDirection layoutDirection) {
        ...
        int iCeilToIntPx = TextDelegateKt.ceilToIntPx(m858layoutTextK40F9xA(ConstraintsKt.Constraints(0, width, 0, Integer.MAX_VALUE), layoutDirection).getHeight());
    ...
    public final boolean m861layoutWithConstraintsK40F9xA(long constraints, @NotNull LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        boolean z = true;
        if (this.minLines > 1) {
            ...
            constraints = minLinesConstrainerFrom.m850coerceMinLinesOh53vG4$foundation_release(constraints, this.minLines);
        }
        boolean z2 = false;
        if (m859newLayoutWillBeDifferentK40F9xA(constraints, layoutDirection)) {
            Paragraph paragraphM858layoutTextK40F9xA = m858layoutTextK40F9xA(constraints, layoutDirection);
            this.prevConstraints = constraints;
            long jM3754constrain4WqzIAM = ConstraintsKt.m3754constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(paragraphM858layoutTextK40F9xA.getWidth()), TextDelegateKt.ceilToIntPx(paragraphM858layoutTextK40F9xA.getHeight())));
            this.layoutSize = jM3754constrain4WqzIAM;
            if (!TextOverflow.m3721equalsimpl0(this.overflow, TextOverflow.INSTANCE.m3730getVisiblegIe3tQ8()) && (IntSize.m3935getWidthimpl(jM3754constrain4WqzIAM) < paragraphM858layoutTextK40F9xA.getWidth() || IntSize.m3934getHeightimpl(jM3754constrain4WqzIAM) < paragraphM858layoutTextK40F9xA.getHeight())) {
                z2 = true;
            }
            this.didOverflow = z2;
            this.paragraph = paragraphM858layoutTextK40F9xA;
            return true;
        }
        if (!Constraints.m3736equalsimpl0(constraints, this.prevConstraints)) {
            Paragraph paragraph = this.paragraph;
            Intrinsics.checkNotNull(paragraph);
            long jM3754constrain4WqzIAM2 = ConstraintsKt.m3754constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(paragraph.getWidth()), TextDelegateKt.ceilToIntPx(paragraph.getHeight())));
            this.layoutSize = jM3754constrain4WqzIAM2;
            if (TextOverflow.m3721equalsimpl0(this.overflow, TextOverflow.INSTANCE.m3730getVisiblegIe3tQ8()) || (IntSize.m3935getWidthimpl(jM3754constrain4WqzIAM2) >= paragraph.getWidth() && IntSize.m3934getHeightimpl(jM3754constrain4WqzIAM2) >= paragraph.getHeight())) {
                z = false;
            }
            this.didOverflow = z;
        }
    ...
    public final void setDensity$foundation_release(@Nullable Density density) {
        ...
        long jM838constructorimpl = density != null ? InlineDensity.m838constructorimpl(density) : InlineDensity.INSTANCE.m846getUnspecifiedL26CHvs();
        if (density2 == null) {
            this.density = density;
            this.lastDensity = jM838constructorimpl;
        } else if (density == null || !InlineDensity.m840equalsimpl0(this.lastDensity, jM838constructorimpl)) {
            this.density = density;
            this.lastDensity = jM838constructorimpl;
            markDirty();
        }
    ...
    public final void m862setLayoutSizeozmzZPI$foundation_release(long j) {
        this.layoutSize = j;
    }
    ...
    public final TextLayoutResult slowCreateTextLayoutResultOrNull() {
        ...
        long jM3734copyZbe2FdA$default = Constraints.m3734copyZbe2FdA$default(this.prevConstraints, 0, 0, 0, 0, 10, null);
        return new TextLayoutResult(new TextLayoutInput(annotatedString, this.style, CollectionsKt.emptyList(), this.maxLines, this.softWrap, this.overflow, density, layoutDirection, this.fontFamilyResolver, jM3734copyZbe2FdA$default, (DefaultConstructorMarker) null), new MultiParagraph(new MultiParagraphIntrinsics(annotatedString, this.style, (List<AnnotatedString.Range<Placeholder>>) CollectionsKt.emptyList(), density, this.fontFamilyResolver), jM3734copyZbe2FdA$default, this.maxLines, TextOverflow.m3721equalsimpl0(this.overflow, TextOverflow.INSTANCE.m3729getEllipsisgIe3tQ8()), null), this.layoutSize, null);
    }

    /* JADX INFO: renamed from: update-L6sJoHM, reason: not valid java name */
    public final void m863updateL6sJoHM(@NotNull String text, @NotNull TextStyle style, @NotNull FontFamily.Resolver fontFamilyResolver, int overflow, boolean softWrap, int maxLines, int minLines) {
    ...
    private ParagraphLayoutCache(String text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int i, boolean z, int i2, int i3) {
        ...
        this.maxLines = i2;
        this.minLines = i3;
        this.lastDensity = InlineDensity.INSTANCE.m846getUnspecifiedL26CHvs();
        this.layoutSize = IntSizeKt.IntSize(0, 0);
        this.prevConstraints = Constraints.INSTANCE.m3751fixedJhjzzOo(0, 0);
        this.cachedIntrinsicHeightInputWidth = -1;
        this.cachedIntrinsicHeight = -1;
    ...
    public /* synthetic */ ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m3728getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, null);
    }
}
