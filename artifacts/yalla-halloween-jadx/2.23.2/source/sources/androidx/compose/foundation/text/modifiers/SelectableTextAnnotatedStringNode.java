...
public final class SelectableTextAnnotatedStringNode extends DelegatingNode implements LayoutModifierNode, DrawModifierNode, GlobalPositionAwareModifierNode {
    ...
    public MeasureResult mo250measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j) {
        ...
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return this.delegate.m874measureNonExtension3p2s80s(measure, measurable, j);
    }
    ...
    private SelectableTextAnnotatedStringNode(AnnotatedString text, TextStyle style, FontFamily.Resolver fontFamilyResolver, Function1<? super TextLayoutResult, Unit> function1, int i, boolean z, int i2, int i3, List<AnnotatedString.Range<Placeholder>> list, Function1<? super List<Rect>, Unit> function2, SelectionController selectionController, ColorProducer colorProducer) {
        ...
        this.delegate = (TextAnnotatedStringNode) delegate(new TextAnnotatedStringNode(text, style, fontFamilyResolver, function1, i, z, i2, i3, list, function2, selectionController, colorProducer, null));
        if (selectionController == null) {
