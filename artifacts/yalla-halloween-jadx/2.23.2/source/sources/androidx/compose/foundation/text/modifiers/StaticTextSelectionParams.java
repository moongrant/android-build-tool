...
public class StaticTextSelectionParams {
    ...
    public boolean getShouldClip() {
        ...
        TextLayoutResult textLayoutResult = this.textLayoutResult;
        TextOverflow textOverflowM3718boximpl = (textLayoutResult == null || (layoutInput = textLayoutResult.getLayoutInput()) == null) ? null : TextOverflow.m3718boximpl(layoutInput.getOverflow());
        int iM3730getVisiblegIe3tQ8 = TextOverflow.INSTANCE.m3730getVisiblegIe3tQ8();
        if (textOverflowM3718boximpl == null) {
            return false;
        }
        return TextOverflow.m3721equalsimpl0(textOverflowM3718boximpl.getValue(), iM3730getVisiblegIe3tQ8);
    }
