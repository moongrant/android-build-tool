...
public final class TextAnnotatedStringNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public final void doInvalidations(boolean drawChanged, boolean textChanged, boolean layoutChanged, boolean callbacksChanged) {
        ...
        if (textChanged || layoutChanged || callbacksChanged) {
            getLayoutCache().m857updateZNqEYIc(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, this.placeholders);
            if (getIsAttached()) {
    ...
    public void draw(@NotNull ContentDrawScope contentDrawScope) {
        ...
        boolean z = true;
        boolean z2 = textLayoutResult.getHasVisualOverflow() && !TextOverflow.m3721equalsimpl0(this.overflow, TextOverflow.INSTANCE.m3730getVisiblegIe3tQ8());
        if (z2) {
            Rect rectM1487Recttz77jQw = RectKt.m1487Recttz77jQw(Offset.INSTANCE.m1463getZeroF1C5BW0(), SizeKt.Size(IntSize.m3935getWidthimpl(textLayoutResult.getSize()), IntSize.m3934getHeightimpl(textLayoutResult.getSize())));
            canvas.save();
        ...
        try {
            ...
            if (brush != null) {
                multiParagraph.m3215painthn5TExg(canvas, brush, (64 & 4) != 0 ? Float.NaN : this.style.getAlpha(), (64 & 8) != 0 ? null : shadow2, (64 & 16) != 0 ? null : textDecoration2, (64 & 32) != 0 ? null : drawStyle2, (64 & 64) != 0 ? DrawScope.INSTANCE.m2148getDefaultBlendMode0nO6VwU() : 0);
            } else {
                ...
                if (!(jMo1264invoke0d7_KjU != companion.m1717getUnspecified0d7_KjU())) {
                    jMo1264invoke0d7_KjU = (this.style.m3341getColor0d7_KjU() > companion.m1717getUnspecified0d7_KjU() ? 1 : (this.style.m3341getColor0d7_KjU() == companion.m1717getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? this.style.m3341getColor0d7_KjU() : companion.m1707getBlack0d7_KjU();
                }
                multiParagraph.m3213paintLG529CI(canvas, (32 & 2) != 0 ? Color.INSTANCE.m1717getUnspecified0d7_KjU() : jMo1264invoke0d7_KjU, (32 & 4) != 0 ? null : shadow2, (32 & 8) != 0 ? null : textDecoration2, (32 & 16) == 0 ? drawStyle2 : null, (32 & 32) != 0 ? DrawScope.INSTANCE.m2148getDefaultBlendMode0nO6VwU() : 0);
            }
            if (z2) {
                canvas.restore();
            }
    ...
    public MeasureResult mo250measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j) {
        ...
        boolean zM856layoutWithConstraintsK40F9xA = layoutCache.m856layoutWithConstraintsK40F9xA(j, measure.getLayoutDirection());
        ...
        if (zM856layoutWithConstraintsK40F9xA) {
        ...
        final Placeable placeableMo2804measureBRTryo0 = measurable.mo2804measureBRTryo0(Constraints.INSTANCE.m3751fixedJhjzzOo(IntSize.m3935getWidthimpl(textLayoutResult.getSize()), IntSize.m3934getHeightimpl(textLayoutResult.getSize())));
        int iM3935getWidthimpl = IntSize.m3935getWidthimpl(textLayoutResult.getSize());
        int iM3934getHeightimpl = IntSize.m3934getHeightimpl(textLayoutResult.getSize());
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return measure.layout(iM3935getWidthimpl, iM3934getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.modifiers.TextAnnotatedStringNode$measure$1
            {
                super(1);
            }
    ...
    public final MeasureResult m874measureNonExtension3p2s80s(@NotNull MeasureScope measureScope, @NotNull Measurable measurable, long constraints) {
        Intrinsics.checkNotNullParameter(measureScope, "measureScope");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return mo250measure3p2s80s(measureScope, measurable, constraints);
    }
    ...
    public final boolean m875updateLayoutRelatedArgsMPT68mk(@NotNull TextStyle style, @Nullable List<AnnotatedString.Range<Placeholder>> placeholders, int minLines, int maxLines, boolean softWrap, @NotNull FontFamily.Resolver fontFamilyResolver, int overflow) {
        Intrinsics.checkNotNullParameter(style, "style");
