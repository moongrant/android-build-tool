...
public final class AndroidSelectionHandles_androidKt {
    ...
    @Composable
    public static final void DefaultSelectionHandle(@NotNull final Modifier modifier, final boolean z, @NotNull final ResolvedTextDirection direction, final boolean z2, @Nullable Composer composer, final int i) {
        int i2;
        ...
        if ((i & 896) == 0) {
            i2 |= composerStartRestartGroup.changed(direction) ? PSKKeyManager.MAX_KEY_LENGTH_BYTES : 128;
        }
        if ((i & 7168) == 0) {
        ...
        if ((i2 & 5851) == 1170 && composerStartRestartGroup.getSkipping()) {
            ...
            SpacerKt.Spacer(drawSelectionHandle(SizeKt.m527sizeVpY3zN4(modifier, SelectionHandlesKt.getHandleWidth(), SelectionHandlesKt.getHandleHeight()), z, direction, z2), composerStartRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m877HandlePopupULxng0E(final long j, @NotNull final HandleReferencePoint handleReferencePoint, @NotNull final Function2<? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, final int i) {
        int i2;
        ...
        if ((i2 & 731) == 146 && composerStartRestartGroup.getSkipping()) {
            ...
            long jIntOffset = IntOffsetKt.IntOffset(MathKt.roundToInt(Offset.m1447getXimpl(j)), MathKt.roundToInt(Offset.m1448getYimpl(j)));
            IntOffset intOffsetM3884boximpl = IntOffset.m3884boximpl(jIntOffset);
            composerStartRestartGroup.startReplaceableGroup(511388516);
            boolean zChanged = composerStartRestartGroup.changed(intOffsetM3884boximpl) | composerStartRestartGroup.changed(handleReferencePoint);
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$HandlePopup$1
            ...
            public final void invoke(@Nullable Composer composer2, int i3) {
                AndroidSelectionHandles_androidKt.m877HandlePopupULxng0E(j, handleReferencePoint, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    public static final void m878SelectionHandle8fL75g(final long j, final boolean z, @NotNull final ResolvedTextDirection direction, final boolean z2, @NotNull final Modifier modifier, @Nullable final Function2<? super Composer, ? super Integer, Unit> function2, @Nullable Composer composer, final int i) {
        int i2;
        Intrinsics.checkNotNullParameter(direction, "direction");
        Intrinsics.checkNotNullParameter(modifier, "modifier");
        ...
        if ((374491 & i3) == 74898 && composerStartRestartGroup.getSkipping()) {
            ...
            m877HandlePopupULxng0E(j, isLeft(z, direction, z2) ? HandleReferencePoint.TopRight : HandleReferencePoint.TopLeft, ComposableLambdaKt.composableLambda(composerStartRestartGroup, 732099485, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$SelectionHandle$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                ...
                public final void invoke(@Nullable Composer composer2, int i4) {
                    ...
                    if (function2 == null) {
                        ...
                        Offset offsetM1436boximpl = Offset.m1436boximpl(j);
                        final boolean z3 = z;
                        final long j2 = j;
                        composer2.startReplaceableGroup(511388516);
                        boolean zChanged = composer2.changed(boolValueOf) | composer2.changed(offsetM1436boximpl);
                        ...
                        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                            objRememberedValue = new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$SelectionHandle$1$1$1
                                ...
                                public final void invoke2(@NotNull SemanticsPropertyReceiver semantics) {
                                    ...
                                    semantics.set(SelectionHandlesKt.getSelectionHandleInfoKey(), new SelectionHandleInfo(z3 ? Handle.SelectionStart : Handle.SelectionEnd, j2, null));
                                }
                            };
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$SelectionHandle$2
            ...
            public final void invoke(@Nullable Composer composer2, int i4) {
                AndroidSelectionHandles_androidKt.m878SelectionHandle8fL75g(j, z, direction, z2, modifier, function2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    public static final ImageBitmap createHandleImage(@NotNull CacheDrawScope cacheDrawScope, float f) {
        ...
        if (imageBitmap == null || canvas == null || iCeil > imageBitmap.getWidth() || iCeil > imageBitmap.getHeight()) {
            imageBitmap = ImageBitmapKt.m1883ImageBitmapx__hDU$default(iCeil, iCeil, ImageBitmapConfig.INSTANCE.m1877getAlpha8_sVssgQ(), false, null, 24, null);
        ...
        drawParams2.m2123setSizeuvyYCjk(jSize);
        canvas2.save();
        androidx.compose.ui.graphics.drawscope.OooO0O0.Oooo0OO(canvasDrawScope2, Color.INSTANCE.m1707getBlack0d7_KjU(), 0L, canvasDrawScope2.mo2118getSizeNHjbRc(), 0.0f, null, null, BlendMode.INSTANCE.m1604getClear0nO6VwU(), 58, null);
        androidx.compose.ui.graphics.drawscope.OooO0O0.Oooo0OO(canvasDrawScope2, ColorKt.Color(4278190080L), Offset.INSTANCE.m1463getZeroF1C5BW0(), androidx.compose.ui.geometry.SizeKt.Size(f, f), 0.0f, null, null, 0, 120, null);
        androidx.compose.ui.graphics.drawscope.OooO0O0.OooOo(canvasDrawScope2, ColorKt.Color(4278190080L), f, OffsetKt.Offset(f, f), 0.0f, null, null, 0, 120, null);
        canvas2.restore();
