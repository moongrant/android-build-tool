...
public interface Selectable {
    ...
    long mo883getHandlePositiondBAh8RU(@NotNull Selection selection, boolean isStartHandle);
    ...
    long mo884getRangeOfLineContainingjx7JFs(int offset);
    ...
    Pair<Selection, Boolean> mo885updateSelectionqCDeeow(long startHandlePosition, long endHandlePosition, @Nullable Offset previousHandlePosition, boolean isStartHandle, @NotNull LayoutCoordinates containerLayoutCoordinates, @NotNull SelectionAdjustment adjustment, @Nullable Selection previousSelection);
}
