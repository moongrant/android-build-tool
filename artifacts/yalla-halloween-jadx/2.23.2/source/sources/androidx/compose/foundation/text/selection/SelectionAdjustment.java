...
public interface SelectionAdjustment {
    ...
    public static final class Companion {
        ...
        private static final SelectionAdjustment None = new SelectionAdjustment() { // from class: androidx.compose.foundation.text.selection.SelectionAdjustment$Companion$None$1
            ...
            public long mo892adjustZXO7KMw(@NotNull TextLayoutResult textLayoutResult, long newRawSelectionRange, int previousHandleOffset, boolean isStartHandle, @Nullable TextRange previousSelectionRange) {
        ...
        private static final SelectionAdjustment Character = new SelectionAdjustment() { // from class: androidx.compose.foundation.text.selection.SelectionAdjustment$Companion$Character$1
            ...
            public long mo892adjustZXO7KMw(@NotNull TextLayoutResult textLayoutResult, long newRawSelectionRange, int previousHandleOffset, boolean isStartHandle, @Nullable TextRange previousSelectionRange) {
                Intrinsics.checkNotNullParameter(textLayoutResult, "textLayoutResult");
                if (TextRange.m3314getCollapsedimpl(newRawSelectionRange)) {
                    return SelectionAdjustmentKt.ensureAtLeastOneChar(textLayoutResult.getLayoutInput().getText().getText(), TextRange.m3320getStartimpl(newRawSelectionRange), StringsKt.getLastIndex(textLayoutResult.getLayoutInput().getText()), isStartHandle, previousSelectionRange != null ? TextRange.m3319getReversedimpl(previousSelectionRange.getPackedValue()) : false);
                }
                return newRawSelectionRange;
            }
        };
        ...
        private static final SelectionAdjustment Word = new SelectionAdjustment() { // from class: androidx.compose.foundation.text.selection.SelectionAdjustment$Companion$Word$1
            ...
            public long mo892adjustZXO7KMw(@NotNull TextLayoutResult textLayoutResult, long newRawSelectionRange, int previousHandleOffset, boolean isStartHandle, @Nullable TextRange previousSelectionRange) {
                Intrinsics.checkNotNullParameter(textLayoutResult, "textLayoutResult");
                return SelectionAdjustment.Companion.$$INSTANCE.m894adjustByBoundaryDvylE(textLayoutResult, newRawSelectionRange, new SelectionAdjustment$Companion$Word$1$adjust$1(textLayoutResult));
            }
        };
        ...
        private static final SelectionAdjustment Paragraph = new SelectionAdjustment() { // from class: androidx.compose.foundation.text.selection.SelectionAdjustment$Companion$Paragraph$1
            ...
            public long mo892adjustZXO7KMw(@NotNull TextLayoutResult textLayoutResult, long newRawSelectionRange, int previousHandleOffset, boolean isStartHandle, @Nullable TextRange previousSelectionRange) {
                Intrinsics.checkNotNullParameter(textLayoutResult, "textLayoutResult");
                return SelectionAdjustment.Companion.$$INSTANCE.m894adjustByBoundaryDvylE(textLayoutResult, newRawSelectionRange, new SelectionAdjustment$Companion$Paragraph$1$adjust$boundaryFun$1(textLayoutResult.getLayoutInput().getText()));
            }
        };
        ...
        private static final SelectionAdjustment CharacterWithWordAccelerate = new SelectionAdjustment() { // from class: androidx.compose.foundation.text.selection.SelectionAdjustment$Companion$CharacterWithWordAccelerate$1
            private final boolean isAtWordBoundary(TextLayoutResult textLayoutResult, int i) {
                long jM3294getWordBoundaryjx7JFs = textLayoutResult.m3294getWordBoundaryjx7JFs(i);
                return i == TextRange.m3320getStartimpl(jM3294getWordBoundaryjx7JFs) || i == TextRange.m3315getEndimpl(jM3294getWordBoundaryjx7JFs);
            }
            ...
            private final int snapToWordBoundary(TextLayoutResult textLayoutResult, int newRawOffset, int currentLine, int otherBoundaryOffset, boolean isStart, boolean isReversed) {
                long jM3294getWordBoundaryjx7JFs = textLayoutResult.m3294getWordBoundaryjx7JFs(newRawOffset);
                int iM3320getStartimpl = textLayoutResult.getLineForOffset(TextRange.m3320getStartimpl(jM3294getWordBoundaryjx7JFs)) == currentLine ? TextRange.m3320getStartimpl(jM3294getWordBoundaryjx7JFs) : textLayoutResult.getLineStart(currentLine);
                int iM3315getEndimpl = textLayoutResult.getLineForOffset(TextRange.m3315getEndimpl(jM3294getWordBoundaryjx7JFs)) == currentLine ? TextRange.m3315getEndimpl(jM3294getWordBoundaryjx7JFs) : TextLayoutResult.getLineEnd$default(textLayoutResult, currentLine, false, 2, null);
                if (iM3320getStartimpl == otherBoundaryOffset) {
                    return iM3315getEndimpl;
                }
                if (iM3315getEndimpl == otherBoundaryOffset) {
                    return iM3320getStartimpl;
                }
                int i = (iM3320getStartimpl + iM3315getEndimpl) / 2;
            ...
            public long mo892adjustZXO7KMw(@NotNull TextLayoutResult textLayoutResult, long newRawSelectionRange, int previousHandleOffset, boolean isStartHandle, @Nullable TextRange previousSelectionRange) {
                ...
                if (previousSelectionRange == null) {
                    return SelectionAdjustment.Companion.$$INSTANCE.getWord().mo892adjustZXO7KMw(textLayoutResult, newRawSelectionRange, previousHandleOffset, isStartHandle, previousSelectionRange);
                }
                if (TextRange.m3314getCollapsedimpl(newRawSelectionRange)) {
                    return SelectionAdjustmentKt.ensureAtLeastOneChar(textLayoutResult.getLayoutInput().getText().getText(), TextRange.m3320getStartimpl(newRawSelectionRange), StringsKt.getLastIndex(textLayoutResult.getLayoutInput().getText()), isStartHandle, TextRange.m3319getReversedimpl(previousSelectionRange.getPackedValue()));
                }
                if (isStartHandle) {
                    iUpdateSelectionBoundary2 = updateSelectionBoundary(textLayoutResult, TextRange.m3320getStartimpl(newRawSelectionRange), previousHandleOffset, TextRange.m3320getStartimpl(previousSelectionRange.getPackedValue()), TextRange.m3315getEndimpl(newRawSelectionRange), true, TextRange.m3319getReversedimpl(newRawSelectionRange));
                    iUpdateSelectionBoundary = TextRange.m3315getEndimpl(newRawSelectionRange);
                } else {
                    int iM3320getStartimpl = TextRange.m3320getStartimpl(newRawSelectionRange);
                    iUpdateSelectionBoundary = updateSelectionBoundary(textLayoutResult, TextRange.m3315getEndimpl(newRawSelectionRange), previousHandleOffset, TextRange.m3315getEndimpl(previousSelectionRange.getPackedValue()), TextRange.m3320getStartimpl(newRawSelectionRange), false, TextRange.m3319getReversedimpl(newRawSelectionRange));
                    iUpdateSelectionBoundary2 = iM3320getStartimpl;
                }
        ...
        public final long m894adjustByBoundaryDvylE(TextLayoutResult textLayoutResult, long newRawSelection, Function1<? super Integer, TextRange> boundaryFun) {
            if (textLayoutResult.getLayoutInput().getText().length() == 0) {
                return TextRange.INSTANCE.m3325getZerod9O1mEE();
            }
            int lastIndex = StringsKt.getLastIndex(textLayoutResult.getLayoutInput().getText());
            long packedValue = boundaryFun.invoke(Integer.valueOf(RangesKt.coerceIn(TextRange.m3320getStartimpl(newRawSelection), 0, lastIndex))).getPackedValue();
            long packedValue2 = boundaryFun.invoke(Integer.valueOf(RangesKt.coerceIn(TextRange.m3315getEndimpl(newRawSelection), 0, lastIndex))).getPackedValue();
            return TextRangeKt.TextRange(TextRange.m3319getReversedimpl(newRawSelection) ? TextRange.m3315getEndimpl(packedValue) : TextRange.m3320getStartimpl(packedValue), TextRange.m3319getReversedimpl(newRawSelection) ? TextRange.m3320getStartimpl(packedValue2) : TextRange.m3315getEndimpl(packedValue2));
        }
    ...
    long mo892adjustZXO7KMw(@NotNull TextLayoutResult textLayoutResult, long newRawSelectionRange, int previousHandleOffset, boolean isStartHandle, @Nullable TextRange previousSelectionRange);
}
