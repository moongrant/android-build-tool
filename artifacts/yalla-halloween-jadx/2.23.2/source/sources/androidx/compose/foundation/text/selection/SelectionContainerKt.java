                        ...
                        public final void invoke(@Nullable Composer composer3, int i7) {
                            ...
                            if (TouchMode_androidKt.isInTouchMode() && selectionManager2.getHasFocus() && (selection2 = selectionManager2.getSelection()) != null) {
                                ...
                                for (int i8 = 0; i8 < size; i8++) {
                                    ...
                                    Offset offsetM926getStartHandlePosition_m7T9E = zBooleanValue ? selectionManager3.m926getStartHandlePosition_m7T9E() : selectionManager3.m925getEndHandlePosition_m7T9E();
                                    ResolvedTextDirection direction = zBooleanValue ? selection2.getStart().getDirection() : selection2.getEnd().getDirection();
                                    if (offsetM926getStartHandlePosition_m7T9E != null) {
                                        AndroidSelectionHandles_androidKt.m878SelectionHandle8fL75g(offsetM926getStartHandlePosition_m7T9E.getPackedValue(), zBooleanValue, direction, selection2.getHandlesCrossed(), SuspendingPointerInputFilterKt.pointerInput(Modifier.INSTANCE, textDragObserver, new SelectionContainerKt$SelectionContainer$3$1$1$1$1$1(textDragObserver, null)), null, composer3, 196608);
                                    }
                                }
                            }
                            if (ComposerKt.isTraceInProgress()) {
