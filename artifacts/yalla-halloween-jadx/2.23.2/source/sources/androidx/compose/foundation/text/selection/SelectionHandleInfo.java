...
public final /* data */ class SelectionHandleInfo {
    ...
    public static /* synthetic */ SelectionHandleInfo m897copyUv8p0NA$default(SelectionHandleInfo selectionHandleInfo, Handle handle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return selectionHandleInfo.m899copyUv8p0NA(handle, j);
    }
    ...
    public final SelectionHandleInfo m899copyUv8p0NA(@NotNull Handle handle, long position) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return this.handle == selectionHandleInfo.handle && Offset.m1444equalsimpl0(this.position, selectionHandleInfo.position);
    }
    ...
    public final long m900getPositionF1C5BW0() {
        return this.position;
    }

    public int hashCode() {
        return Offset.m1449hashCodeimpl(this.position) + (this.handle.hashCode() * 31);
    }

    @NotNull
    public String toString() {
        return "SelectionHandleInfo(handle=" + this.handle + ", position=" + ((Object) Offset.m1455toStringimpl(this.position)) + ')';
    }
