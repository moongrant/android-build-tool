...
public final class SelectionHandlesKt {
    ...
    static {
        float f = 25;
        HandleWidth = Dp.m3775constructorimpl(f);
        HandleHeight = Dp.m3775constructorimpl(f);
    }

    /* JADX INFO: renamed from: getAdjustedCoordinates-k-4lQ0M, reason: not valid java name */
    public static final long m901getAdjustedCoordinatesk4lQ0M(long j) {
        return OffsetKt.Offset(Offset.m1447getXimpl(j), Offset.m1448getYimpl(j) - 1.0f);
    }
