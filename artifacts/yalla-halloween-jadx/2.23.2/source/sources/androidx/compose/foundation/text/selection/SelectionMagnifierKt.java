...
public final class SelectionMagnifierKt {
    ...
    private static final TwoWayConverter<Offset, AnimationVector2D> UnspecifiedSafeOffsetVectorConverter = VectorConvertersKt.TwoWayConverter(new Function1<Offset, AnimationVector2D>() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$UnspecifiedSafeOffsetVectorConverter$1
        ...
        public /* bridge */ /* synthetic */ AnimationVector2D invoke(Offset offset) {
            return m902invokek4lQ0M(offset.getPackedValue());
        }

        @NotNull
        /* JADX INFO: renamed from: invoke-k-4lQ0M, reason: not valid java name */
        public final AnimationVector2D m902invokek4lQ0M(long j) {
            return OffsetKt.m1466isSpecifiedk4lQ0M(j) ? new AnimationVector2D(Offset.m1447getXimpl(j), Offset.m1448getYimpl(j)) : SelectionMagnifierKt.UnspecifiedAnimationVector2D;
        }
        ...
        public /* bridge */ /* synthetic */ Offset invoke(AnimationVector2D animationVector2D) {
            return Offset.m1436boximpl(m903invoketuRUvjQ(animationVector2D));
        }

        /* JADX INFO: renamed from: invoke-tuRUvjQ, reason: not valid java name */
        public final long m903invoketuRUvjQ(@NotNull AnimationVector2D it) {
    ...
    public static final class C07091 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public C07091(State<Offset> state, Animatable<Offset, AnimationVector2D> animatable, Continuation<? super C07091> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C07091 c07091 = new C07091(this.$targetValue$delegate, this.$animatable, continuation);
            c07091.L$0 = obj;
            return c07091;
        }
            ...
            if (i == 0) {
                ...
                Flow flowSnapshotFlow = SnapshotStateKt.snapshotFlow(new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt.rememberAnimatedMagnifierPosition.1.1
                    ...
                    public /* bridge */ /* synthetic */ Offset invoke() {
                        return Offset.m1436boximpl(m905invokeF1C5BW0());
                    }

                    /* JADX INFO: renamed from: invoke-F1C5BW0, reason: not valid java name */
                    public final long m905invokeF1C5BW0() {
                ...
                FlowCollector<Offset> flowCollector = new FlowCollector<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt.rememberAnimatedMagnifierPosition.1.2
                    ...
                    public /* bridge */ /* synthetic */ Object emit(Offset offset, Continuation continuation) {
                        return m906emit3MmeM6k(offset.getPackedValue(), continuation);
                    }

                    @Nullable
                    /* JADX INFO: renamed from: emit-3MmeM6k, reason: not valid java name */
                    public final Object m906emit3MmeM6k(long j, @NotNull Continuation<? super Unit> continuation) {
                        if (OffsetKt.m1466isSpecifiedk4lQ0M(animatable.getValue().getPackedValue()) && OffsetKt.m1466isSpecifiedk4lQ0M(j)) {
                            if (!(Offset.m1448getYimpl(animatable.getValue().getPackedValue()) == Offset.m1448getYimpl(j))) {
                        ...
                        Object objSnapTo = animatable.snapTo(Offset.m1436boximpl(j), continuation);
    ...
    static {
        ...
        MagnifierSpringSpec = new SpringSpec<>(0.0f, 0.0f, Offset.m1436boximpl(jOffset), 3, null);
    }
    ...
    public static final State<Offset> rememberAnimatedMagnifierPosition(Function0<Offset> function0, Composer composer, int i) {
        ...
        if (objRememberedValue2 == companion.getEmpty()) {
            objRememberedValue2 = new Animatable(Offset.m1436boximpl(rememberAnimatedMagnifierPosition$lambda$1(state)), UnspecifiedSafeOffsetVectorConverter, Offset.m1436boximpl(OffsetDisplacementThreshold), null, 8, null);
            composer.updateRememberedValue(objRememberedValue2);
        }
        composer.endReplaceableGroup();
        Animatable animatable = (Animatable) objRememberedValue2;
        EffectsKt.LaunchedEffect(Unit.INSTANCE, new C07091(state, animatable, null), composer, 70);
    ...
    public static final class AnonymousClass1 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
        ...
        public final Modifier invoke(@NotNull Modifier modifier, @Nullable Composer composer, int i) {
            if (OooOOO.OooO0O0(modifier, "$this$composed", composer, 759876635)) {
            ...
            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$animatedSelectionMagnifier$1$1$1
                    ...
                    @Override // kotlin.jvm.functions.Function0
                    public /* bridge */ /* synthetic */ Offset invoke() {
                        return Offset.m1436boximpl(m904invokeF1C5BW0());
                    }

                    /* JADX INFO: renamed from: invoke-F1C5BW0, reason: not valid java name */
                    public final long m904invokeF1C5BW0() {
