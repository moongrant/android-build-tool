...
public final class TextFieldPreparedSelection extends BaseTextPreparedSelection<TextFieldPreparedSelection> {
    ...
    private final int jumpByPagesOffset(TextLayoutResultProxy textLayoutResultProxy, int i) {
        ...
        Rect cursorRect = textLayoutResultProxy.getValue().getCursorRect(getOffsetMapping().originalToTransformed(TextRange.m3315getEndimpl(this.currentValue.getSelection())));
        return getOffsetMapping().transformedToOriginal(textLayoutResultProxy.getValue().m3292getOffsetForPositionk4lQ0M(OffsetKt.Offset(cursorRect.getLeft(), (Size.m1513getHeightimpl(zero.m1480getSizeNHjbRc()) * i) + cursorRect.getTop())));
    }
    ...
    public final List<EditCommand> deleteIfSelectedOr(@NotNull Function1<? super TextFieldPreparedSelection, ? extends EditCommand> or) {
        ...
        if (!TextRange.m3314getCollapsedimpl(getSelection())) {
            return CollectionsKt.listOf((Object[]) new EditCommand[]{new CommitTextCommand("", 0), new SetSelectionCommand(TextRange.m3318getMinimpl(getSelection()), TextRange.m3318getMinimpl(getSelection()))});
        }
    ...
    public final TextFieldValue getValue() {
        return TextFieldValue.m3532copy3r_uNRQ$default(this.currentValue, getAnnotatedString(), getSelection(), (TextRange) null, 4, (Object) null);
    }
