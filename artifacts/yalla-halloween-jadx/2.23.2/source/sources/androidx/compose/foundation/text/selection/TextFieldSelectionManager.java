...
public final class TextFieldSelectionManager {
    ...
    public final TextFieldValue m946createTextFieldValueFDrldGo(AnnotatedString annotatedString, long selection) {
    ...
    public static /* synthetic */ void m947deselect_kEHs6E$foundation_release$default(TextFieldSelectionManager textFieldSelectionManager, Offset offset, int i, Object obj) {
        if ((i & 1) != 0) {
            offset = null;
        }
        textFieldSelectionManager.m950deselect_kEHs6E$foundation_release(offset);
    }
    ...
    private final Rect getContentRect() {
        ...
        if (textFieldState != null) {
            ...
            if (textFieldState != null) {
                int iOriginalToTransformed = this.offsetMapping.originalToTransformed(TextRange.m3320getStartimpl(getValue$foundation_release().getSelection()));
                int iOriginalToTransformed2 = this.offsetMapping.originalToTransformed(TextRange.m3315getEndimpl(getValue$foundation_release().getSelection()));
                TextFieldState textFieldState2 = this.state;
                long jM1463getZeroF1C5BW0 = (textFieldState2 == null || (layoutCoordinates4 = textFieldState2.getLayoutCoordinates()) == null) ? Offset.INSTANCE.m1463getZeroF1C5BW0() : layoutCoordinates4.mo2813localToRootMKHz9U(m953getHandlePositiontuRUvjQ$foundation_release(true));
                TextFieldState textFieldState3 = this.state;
                long jM1463getZeroF1C5BW1 = (textFieldState3 == null || (layoutCoordinates3 = textFieldState3.getLayoutCoordinates()) == null) ? Offset.INSTANCE.m1463getZeroF1C5BW0() : layoutCoordinates3.mo2813localToRootMKHz9U(m953getHandlePositiontuRUvjQ$foundation_release(false));
                TextFieldState textFieldState4 = this.state;
                float fM1448getYimpl2 = 0.0f;
                if (textFieldState4 == null || (layoutCoordinates2 = textFieldState4.getLayoutCoordinates()) == null) {
                    fM1448getYimpl = 0.0f;
                } else {
                    TextLayoutResultProxy layoutResult = textFieldState.getLayoutResult();
                    fM1448getYimpl = Offset.m1448getYimpl(layoutCoordinates2.mo2813localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult == null || (value2 = layoutResult.getValue()) == null || (cursorRect2 = value2.getCursorRect(iOriginalToTransformed)) == null) ? 0.0f : cursorRect2.getTop())));
                }
                ...
                if (textFieldState5 != null && (layoutCoordinates = textFieldState5.getLayoutCoordinates()) != null) {
                    ...
                    fM1448getYimpl2 = Offset.m1448getYimpl(layoutCoordinates.mo2813localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult2 == null || (value = layoutResult2.getValue()) == null || (cursorRect = value.getCursorRect(iOriginalToTransformed2)) == null) ? 0.0f : cursorRect.getTop())));
                }
                return new Rect(Math.min(Offset.m1447getXimpl(jM1463getZeroF1C5BW0), Offset.m1447getXimpl(jM1463getZeroF1C5BW1)), Math.min(fM1448getYimpl, fM1448getYimpl2), Math.max(Offset.m1447getXimpl(jM1463getZeroF1C5BW0), Offset.m1447getXimpl(jM1463getZeroF1C5BW1)), (textFieldState.getTextDelegate().getDensity().getDensity() * Dp.m3775constructorimpl(25)) + Math.max(Offset.m1448getYimpl(jM1463getZeroF1C5BW0), Offset.m1448getYimpl(jM1463getZeroF1C5BW1)));
            }
        }
    ...
    public final void m948setCurrentDragPosition_kEHs6E(Offset offset) {
    ...
    public final void updateSelection(TextFieldValue value, int transformedStartOffset, int transformedEndOffset, boolean isStartHandle, SelectionAdjustment adjustment) {
        ...
        long jTextRange = TextRangeKt.TextRange(this.offsetMapping.originalToTransformed(TextRange.m3320getStartimpl(value.getSelection())), this.offsetMapping.originalToTransformed(TextRange.m3315getEndimpl(value.getSelection())));
        TextFieldState textFieldState = this.state;
        long jM943getTextFieldSelectionbb3KNj8 = TextFieldSelectionDelegateKt.m943getTextFieldSelectionbb3KNj8((textFieldState == null || (layoutResult = textFieldState.getLayoutResult()) == null) ? null : layoutResult.getValue(), transformedStartOffset, transformedEndOffset, TextRange.m3314getCollapsedimpl(jTextRange) ? null : TextRange.m3308boximpl(jTextRange), isStartHandle, adjustment);
        long jTextRange2 = TextRangeKt.TextRange(this.offsetMapping.transformedToOriginal(TextRange.m3320getStartimpl(jM943getTextFieldSelectionbb3KNj8)), this.offsetMapping.transformedToOriginal(TextRange.m3315getEndimpl(jM943getTextFieldSelectionbb3KNj8)));
        if (TextRange.m3313equalsimpl0(jTextRange2, value.getSelection())) {
            return;
        }
        ...
        this.onValueChange.invoke(m946createTextFieldValueFDrldGo(value.getAnnotatedString(), jTextRange2));
        TextFieldState textFieldState2 = this.state;
    ...
    public final void m949contextMenuOpenAdjustmentk4lQ0M(long position) {
        TextLayoutResultProxy layoutResult;
        TextFieldState textFieldState = this.state;
        if (textFieldState == null || (layoutResult = textFieldState.getLayoutResult()) == null) {
            return;
        }
        int iM829getOffsetForPosition3MmeM6k$default = TextLayoutResultProxy.m829getOffsetForPosition3MmeM6k$default(layoutResult, position, false, 2, null);
        if (TextRange.m3311containsimpl(getValue$foundation_release().getSelection(), iM829getOffsetForPosition3MmeM6k$default)) {
            return;
        }
        updateSelection(getValue$foundation_release(), iM829getOffsetForPosition3MmeM6k$default, iM829getOffsetForPosition3MmeM6k$default, false, SelectionAdjustment.INSTANCE.getWord());
    }

    public final void copy$foundation_release(boolean cancelSelection) {
        if (TextRange.m3314getCollapsedimpl(getValue$foundation_release().getSelection())) {
            return;
        }
        ...
        if (cancelSelection) {
            int iM3317getMaximpl = TextRange.m3317getMaximpl(getValue$foundation_release().getSelection());
            this.onValueChange.invoke(m946createTextFieldValueFDrldGo(getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(iM3317getMaximpl, iM3317getMaximpl)));
    ...
    public final TextDragObserver cursorDragObserver$foundation_release() {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$cursorDragObserver$1
            ...
            public void mo797onDownk4lQ0M(long point) {
                ...
                textFieldSelectionManager.m948setCurrentDragPosition_kEHs6E(Offset.m1436boximpl(SelectionHandlesKt.m901getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m953getHandlePositiontuRUvjQ$foundation_release(true))));
            }
            ...
            public void mo798onDragk4lQ0M(long delta) {
                ...
                TextLayoutResult value;
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.dragTotalDistance = Offset.m1452plusMKHz9U(textFieldSelectionManager.dragTotalDistance, delta);
                ...
                textFieldSelectionManager2.m948setCurrentDragPosition_kEHs6E(Offset.m1436boximpl(Offset.m1452plusMKHz9U(textFieldSelectionManager2.dragBeginPosition, textFieldSelectionManager2.dragTotalDistance)));
                OffsetMapping offsetMapping = textFieldSelectionManager2.getOffsetMapping();
                Offset offsetM951getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m951getCurrentDragPosition_m7T9E();
                Intrinsics.checkNotNull(offsetM951getCurrentDragPosition_m7T9E);
                int iTransformedToOriginal = offsetMapping.transformedToOriginal(value.m3292getOffsetForPositionk4lQ0M(offsetM951getCurrentDragPosition_m7T9E.getPackedValue()));
                long jTextRange = TextRangeKt.TextRange(iTransformedToOriginal, iTransformedToOriginal);
                if (TextRange.m3313equalsimpl0(jTextRange, textFieldSelectionManager2.getValue$foundation_release().getSelection())) {
                    return;
                }
                ...
                textFieldSelectionManager2.getOnValueChange$foundation_release().invoke(textFieldSelectionManager2.m946createTextFieldValueFDrldGo(textFieldSelectionManager2.getValue$foundation_release().getAnnotatedString(), jTextRange));
            }
            ...
            public void mo799onStartk4lQ0M(long startPoint) {
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.dragBeginPosition = SelectionHandlesKt.m901getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m953getHandlePositiontuRUvjQ$foundation_release(true));
                TextFieldSelectionManager textFieldSelectionManager2 = this.this$0;
                textFieldSelectionManager2.m948setCurrentDragPosition_kEHs6E(Offset.m1436boximpl(textFieldSelectionManager2.dragBeginPosition));
                this.this$0.dragTotalDistance = Offset.INSTANCE.m1463getZeroF1C5BW0();
                this.this$0.setDraggingHandle(Handle.Cursor);
            }
            ...
            public void onStop() {
                ...
                this.this$0.m948setCurrentDragPosition_kEHs6E(null);
            }
    ...
    public final void cut$foundation_release() {
        ...
        int iM3318getMinimpl = TextRange.m3318getMinimpl(getValue$foundation_release().getSelection());
        this.onValueChange.invoke(m946createTextFieldValueFDrldGo(annotatedStringPlus, TextRangeKt.TextRange(iM3318getMinimpl, iM3318getMinimpl)));
        setHandleState(HandleState.None);
    ...
    public final void m950deselect_kEHs6E$foundation_release(@Nullable Offset position) {
        HandleState handleState;
        if (!TextRange.m3314getCollapsedimpl(getValue$foundation_release().getSelection())) {
            TextFieldState textFieldState = this.state;
            TextLayoutResultProxy layoutResult = textFieldState != null ? textFieldState.getLayoutResult() : null;
            this.onValueChange.invoke(TextFieldValue.m3532copy3r_uNRQ$default(getValue$foundation_release(), (AnnotatedString) null, TextRangeKt.TextRange((position == null || layoutResult == null) ? TextRange.m3317getMaximpl(getValue$foundation_release().getSelection()) : this.offsetMapping.transformedToOriginal(TextLayoutResultProxy.m829getOffsetForPosition3MmeM6k$default(layoutResult, position.getPackedValue(), false, 2, null))), (TextRange) null, 5, (Object) null));
        }
        if (position == null) {
    ...
    public final Offset m951getCurrentDragPosition_m7T9E() {
        return (Offset) this.currentDragPosition.getValue();
    }

    /* JADX INFO: renamed from: getCursorPosition-tuRUvjQ$foundation_release, reason: not valid java name */
    public final long m952getCursorPositiontuRUvjQ$foundation_release(@NotNull Density density) {
        ...
        return OffsetKt.Offset((density.mo326toPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness()) / 2) + cursorRect.getLeft(), cursorRect.getBottom());
    }
    ...
    public final long m953getHandlePositiontuRUvjQ$foundation_release(boolean isStartHandle) {
        long selection = getValue$foundation_release().getSelection();
        int iM3320getStartimpl = isStartHandle ? TextRange.m3320getStartimpl(selection) : TextRange.m3315getEndimpl(selection);
        TextFieldState textFieldState = this.state;
        TextLayoutResultProxy layoutResult = textFieldState != null ? textFieldState.getLayoutResult() : null;
        Intrinsics.checkNotNull(layoutResult);
        return TextSelectionDelegateKt.getSelectionHandleCoordinates(layoutResult.getValue(), this.offsetMapping.originalToTransformed(iM3320getStartimpl), isStartHandle, TextRange.m3319getReversedimpl(getValue$foundation_release().getSelection()));
    }
    ...
    public final TextDragObserver handleDragObserver$foundation_release(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$handleDragObserver$1
            ...
            public void mo797onDownk4lQ0M(long point) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.m948setCurrentDragPosition_kEHs6E(Offset.m1436boximpl(SelectionHandlesKt.m901getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m953getHandlePositiontuRUvjQ$foundation_release(isStartHandle))));
            }
            ...
            public void mo798onDragk4lQ0M(long delta) {
                ...
                int iM3292getOffsetForPositionk4lQ0M;
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.dragTotalDistance = Offset.m1452plusMKHz9U(textFieldSelectionManager.dragTotalDistance, delta);
                TextFieldState state = this.this$0.getState();
                if (state != null && (layoutResult = state.getLayoutResult()) != null && (value = layoutResult.getValue()) != null) {
                    ...
                    if (z) {
                        Offset offsetM951getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m951getCurrentDragPosition_m7T9E();
                        Intrinsics.checkNotNull(offsetM951getCurrentDragPosition_m7T9E);
                        iOriginalToTransformed = value.m3292getOffsetForPositionk4lQ0M(offsetM951getCurrentDragPosition_m7T9E.getPackedValue());
                    } else {
                        iOriginalToTransformed = textFieldSelectionManager2.getOffsetMapping().originalToTransformed(TextRange.m3320getStartimpl(textFieldSelectionManager2.getValue$foundation_release().getSelection()));
                    }
                    int i = iOriginalToTransformed;
                    if (z) {
                        iM3292getOffsetForPositionk4lQ0M = textFieldSelectionManager2.getOffsetMapping().originalToTransformed(TextRange.m3315getEndimpl(textFieldSelectionManager2.getValue$foundation_release().getSelection()));
                    } else {
                        Offset offsetM951getCurrentDragPosition_m7T9E2 = textFieldSelectionManager2.m951getCurrentDragPosition_m7T9E();
                        Intrinsics.checkNotNull(offsetM951getCurrentDragPosition_m7T9E2);
                        iM3292getOffsetForPositionk4lQ0M = value.m3292getOffsetForPositionk4lQ0M(offsetM951getCurrentDragPosition_m7T9E2.getPackedValue());
                    }
                    textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), i, iM3292getOffsetForPositionk4lQ0M, z, SelectionAdjustment.INSTANCE.getCharacter());
                }
            ...
            public void mo799onStartk4lQ0M(long startPoint) {
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.dragBeginPosition = SelectionHandlesKt.m901getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m953getHandlePositiontuRUvjQ$foundation_release(isStartHandle));
                TextFieldSelectionManager textFieldSelectionManager2 = this.this$0;
                textFieldSelectionManager2.m948setCurrentDragPosition_kEHs6E(Offset.m1436boximpl(textFieldSelectionManager2.dragBeginPosition));
                this.this$0.dragTotalDistance = Offset.INSTANCE.m1463getZeroF1C5BW0();
                this.this$0.setDraggingHandle(isStartHandle ? Handle.SelectionStart : Handle.SelectionEnd);
    ...
    public final void paste$foundation_release() {
        ...
        int length = text.length() + TextRange.m3318getMinimpl(getValue$foundation_release().getSelection());
        this.onValueChange.invoke(m946createTextFieldValueFDrldGo(annotatedStringPlus, TextRangeKt.TextRange(length, length)));
        setHandleState(HandleState.None);
        UndoManager undoManager = this.undoManager;
        if (undoManager != null) {
            undoManager.forceNextSnapshot();
    ...
    public final void selectAll$foundation_release() {
        TextFieldValue textFieldValueM946createTextFieldValueFDrldGo = m946createTextFieldValueFDrldGo(getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(0, getValue$foundation_release().getText().length()));
        this.onValueChange.invoke(textFieldValueM946createTextFieldValueFDrldGo);
        this.oldValue = TextFieldValue.m3532copy3r_uNRQ$default(this.oldValue, (AnnotatedString) null, textFieldValueM946createTextFieldValueFDrldGo.getSelection(), (TextRange) null, 5, (Object) null);
        TextFieldState textFieldState = this.state;
        if (textFieldState == null) {
            return;
        }
    ...
    public final void showSelectionToolbar$foundation_release() {
        ...
        Function0<Unit> function1 = (TextRange.m3314getCollapsedimpl(getValue$foundation_release().getSelection()) || z) ? null : new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$copy$1
            {
                super(0);
            }
        ...
        Function0<Unit> function2 = (TextRange.m3314getCollapsedimpl(getValue$foundation_release().getSelection()) || !getEditable() || z) ? null : new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$cut$1
            {
                super(0);
            }
        ...
        Function0<Unit> function3 = TextRange.m3316getLengthimpl(getValue$foundation_release().getSelection()) != getValue$foundation_release().getText().length() ? new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$selectAll$1
            {
                super(0);
            }
    ...
    public TextFieldSelectionManager(@Nullable UndoManager undoManager) {
        ...
        this.dragBeginPosition = companion.m1463getZeroF1C5BW0();
        ...
        this.touchSelectionObserver = new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$touchSelectionObserver$1
            ...
            public void mo798onDragk4lQ0M(long delta) {
                ...
                if (state != null && (layoutResult = state.getLayoutResult()) != null) {
                    ...
                    int iIntValue = num != null ? num.intValue() : layoutResult.m831getOffsetForPosition3MmeM6k(textFieldSelectionManager2.dragBeginPosition, false);
                    Offset offsetM951getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m951getCurrentDragPosition_m7T9E();
                    Intrinsics.checkNotNull(offsetM951getCurrentDragPosition_m7T9E);
                    textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), iIntValue, layoutResult.m831getOffsetForPosition3MmeM6k(offsetM951getCurrentDragPosition_m7T9E.getPackedValue(), false), false, SelectionAdjustment.INSTANCE.getWord());
                }
                TextFieldState state2 = this.this$0.getState();
                if (state2 == null) {
                    return;
            ...
            public void mo799onStartk4lQ0M(long startPoint) {
                ...
                this.this$0.hideSelectionToolbar$foundation_release();
                TextFieldState state2 = this.this$0.getState();
                if (!((state2 == null || (layoutResult3 = state2.getLayoutResult()) == null || !layoutResult3.m832isPositionOnTextk4lQ0M(startPoint)) ? false : true) && (state = this.this$0.getState()) != null && (layoutResult2 = state.getLayoutResult()) != null) {
                    TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                    int iTransformedToOriginal = textFieldSelectionManager.getOffsetMapping().transformedToOriginal(TextLayoutResultProxy.getLineEnd$default(layoutResult2, layoutResult2.getLineForVerticalPosition(Offset.m1448getYimpl(startPoint)), false, 2, null));
                    HapticFeedback hapticFeedBack = textFieldSelectionManager.getHapticFeedBack();
                    if (hapticFeedBack != null) {
                        hapticFeedBack.mo2248performHapticFeedbackCdsT49E(HapticFeedbackType.INSTANCE.m2257getTextHandleMove5zf0vsI());
                    }
                    TextFieldValue textFieldValueM946createTextFieldValueFDrldGo = textFieldSelectionManager.m946createTextFieldValueFDrldGo(textFieldSelectionManager.getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(iTransformedToOriginal, iTransformedToOriginal));
                    textFieldSelectionManager.enterSelectionMode$foundation_release();
                    textFieldSelectionManager.getOnValueChange$foundation_release().invoke(textFieldValueM946createTextFieldValueFDrldGo);
                    return;
                }
                if (this.this$0.getValue$foundation_release().getText().length() == 0) {
                    return;
                ...
                if (state3 != null && (layoutResult = state3.getLayoutResult()) != null) {
                    TextFieldSelectionManager textFieldSelectionManager2 = this.this$0;
                    int iM829getOffsetForPosition3MmeM6k$default = TextLayoutResultProxy.m829getOffsetForPosition3MmeM6k$default(layoutResult, startPoint, false, 2, null);
                    textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), iM829getOffsetForPosition3MmeM6k$default, iM829getOffsetForPosition3MmeM6k$default, false, SelectionAdjustment.INSTANCE.getWord());
                    textFieldSelectionManager2.dragBeginOffsetInText = Integer.valueOf(iM829getOffsetForPosition3MmeM6k$default);
                }
                this.this$0.dragBeginPosition = startPoint;
                TextFieldSelectionManager textFieldSelectionManager3 = this.this$0;
                textFieldSelectionManager3.m948setCurrentDragPosition_kEHs6E(Offset.m1436boximpl(textFieldSelectionManager3.dragBeginPosition));
                this.this$0.dragTotalDistance = Offset.INSTANCE.m1463getZeroF1C5BW0();
            }
        ...
        this.mouseSelectionObserver = new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$mouseSelectionObserver$1
            ...
            public boolean mo870onDrag3MmeM6k(long dragPosition, @NotNull SelectionAdjustment adjustment) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                int iM831getOffsetForPosition3MmeM6k = layoutResult.m831getOffsetForPosition3MmeM6k(dragPosition, false);
                ...
                textFieldSelectionManager.updateSelection(value$foundation_release, num.intValue(), iM831getOffsetForPosition3MmeM6k, false, adjustment);
                return true;
            }
            ...
            public boolean mo871onExtendk4lQ0M(long downPosition) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.updateSelection(textFieldSelectionManager.getValue$foundation_release(), textFieldSelectionManager.getOffsetMapping().originalToTransformed(TextRange.m3320getStartimpl(textFieldSelectionManager.getValue$foundation_release().getSelection())), TextLayoutResultProxy.m829getOffsetForPosition3MmeM6k$default(layoutResult, downPosition, false, 2, null), false, SelectionAdjustment.INSTANCE.getNone());
                return true;
            }
            ...
            public boolean mo872onExtendDragk4lQ0M(long dragPosition) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.updateSelection(textFieldSelectionManager.getValue$foundation_release(), textFieldSelectionManager.getOffsetMapping().originalToTransformed(TextRange.m3320getStartimpl(textFieldSelectionManager.getValue$foundation_release().getSelection())), layoutResult.m831getOffsetForPosition3MmeM6k(dragPosition, false), false, SelectionAdjustment.INSTANCE.getNone());
                return true;
            }
            ...
            public boolean mo873onStart3MmeM6k(long downPosition, @NotNull SelectionAdjustment adjustment) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.dragBeginOffsetInText = Integer.valueOf(TextLayoutResultProxy.m829getOffsetForPosition3MmeM6k$default(layoutResult, downPosition, false, 2, null));
                int iM829getOffsetForPosition3MmeM6k$default = TextLayoutResultProxy.m829getOffsetForPosition3MmeM6k$default(layoutResult, textFieldSelectionManager.dragBeginPosition, false, 2, null);
                textFieldSelectionManager.updateSelection(textFieldSelectionManager.getValue$foundation_release(), iM829getOffsetForPosition3MmeM6k$default, iM829getOffsetForPosition3MmeM6k$default, false, adjustment);
                return true;
            }
        };
    }
