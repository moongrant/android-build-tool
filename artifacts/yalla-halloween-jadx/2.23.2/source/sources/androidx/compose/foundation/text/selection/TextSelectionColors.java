...
public final class TextSelectionColors {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Color.m1682equalsimpl0(this.handleColor, textSelectionColors.handleColor) && Color.m1682equalsimpl0(this.backgroundColor, textSelectionColors.backgroundColor);
    }
    ...
    public int hashCode() {
        return Color.m1688hashCodeimpl(this.backgroundColor) + (Color.m1688hashCodeimpl(this.handleColor) * 31);
    }

    @NotNull
    public String toString() {
        return "SelectionColors(selectionHandleColor=" + ((Object) Color.m1689toStringimpl(this.handleColor)) + ", selectionBackgroundColor=" + ((Object) Color.m1689toStringimpl(this.backgroundColor)) + ')';
    }
