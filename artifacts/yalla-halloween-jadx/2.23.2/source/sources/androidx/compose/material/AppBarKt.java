...
public final class AppBarKt {
    private static final float AppBarHeight = Dp.m3775constructorimpl(56);
    ...
    static {
        ...
        AppBarHorizontalPadding = fM3775constructorimpl;
        Modifier.Companion companion = Modifier.INSTANCE;
        TitleInsetWithoutIcon = SizeKt.m530width3ABfNKs(companion, Dp.m3775constructorimpl(Dp.m3775constructorimpl(16) - fM3775constructorimpl));
        TitleIconModifier = SizeKt.m530width3ABfNKs(SizeKt.fillMaxHeight$default(companion, 0.0f, 1, null), Dp.m3775constructorimpl(Dp.m3775constructorimpl(72) - fM3775constructorimpl));
        BottomAppBarCutoutOffset = Dp.m3775constructorimpl(8);
        BottomAppBarRoundedEdgeRadius = Dp.m3775constructorimpl(f);
    }
    ...
    public static final void m968AppBarcelAv9A(final long j, final long j2, final float f, final PaddingValues paddingValues, final Shape shape, Modifier modifier, final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i, final int i2) {
        final int i3;
        int i4;
        int i5;
        int i6;
        ...
        if ((i2 & 4) == 0) {
            ...
            if (i6 != 0) {
                ...
                if ((2995931 & i3) == 599186 || !composerStartRestartGroup.getSkipping()) {
                    ...
                    int i9 = i3 << 6;
                    SurfaceKt.m1201SurfaceFjzlyU(modifier3, shape, j, j2, null, f, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1027830352, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$AppBar$1
                        ...
                        public final void invoke(@Nullable Composer composer2, int i10) {
                            ...
                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer2, 1296061040, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$AppBar$1.1
                                ...
                                public final void invoke(@Nullable Composer composer3, int i12) {
                                    ...
                                    Modifier modifierM511height3ABfNKs = SizeKt.m511height3ABfNKs(PaddingKt.padding(SizeKt.fillMaxWidth$default(Modifier.INSTANCE, 0.0f, 1, null), paddingValues2), AppBarKt.AppBarHeight);
                                    ...
                                    androidx.compose.animation.OooOO0.OooO00o((i15 >> 3) & 112, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer3)), composer3, 2058660585);
                ...
                scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$AppBar$2
                    ...
                    public final void invoke(@Nullable Composer composer2, int i10) {
                        AppBarKt.m968AppBarcelAv9A(j, j2, f, paddingValues, shape, modifier4, function3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                    }
                });
            }
            i3 |= 196608;
                    ...
                    public final void invoke(@Nullable Composer composer2, int i11) {
                        ...
                        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer2, 1296061040, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$AppBar$1.1
                            ...
                            public final void invoke(@Nullable Composer composer3, int i13) {
                                ...
                                androidx.compose.animation.OooOO0.OooO00o((i16 >> 3) & 112, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer3)), composer3, 2058660585);
                    ...
                    public final void invoke(@Nullable Composer composer2, int i12) {
                        ...
                        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer2, 1296061040, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$AppBar$1.1
                            ...
                            public final void invoke(@Nullable Composer composer3, int i14) {
                                ...
                                androidx.compose.animation.OooOO0.OooO00o((i17 >> 3) & 112, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer3)), composer3, 2058660585);
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$AppBar$2
                ...
                public final void invoke(@Nullable Composer composer2, int i12) {
                    AppBarKt.m968AppBarcelAv9A(j, j2, f, paddingValues, shape, modifier5, function3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
        i3 |= 384;
        ...
        if (i6 != 0) {
                    ...
                    public final void invoke(@Nullable Composer composer2, int i13) {
                        ...
                        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer2, 1296061040, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$AppBar$1.1
                            ...
                            public final void invoke(@Nullable Composer composer3, int i15) {
                                ...
                                androidx.compose.animation.OooOO0.OooO00o((i18 >> 3) & 112, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer3)), composer3, 2058660585);
                    ...
                    public final void invoke(@Nullable Composer composer2, int i14) {
                        ...
                        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer2, 1296061040, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$AppBar$1.1
                            ...
                            public final void invoke(@Nullable Composer composer3, int i16) {
                                ...
                                androidx.compose.animation.OooOO0.OooO00o((i19 >> 3) & 112, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer3)), composer3, 2058660585);
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$AppBar$2
                ...
                public final void invoke(@Nullable Composer composer2, int i14) {
                    AppBarKt.m968AppBarcelAv9A(j, j2, f, paddingValues, shape, modifier6, function3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
        i3 |= 196608;
                ...
                public final void invoke(@Nullable Composer composer2, int i15) {
                    ...
                    CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer2, 1296061040, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$AppBar$1.1
                        ...
                        public final void invoke(@Nullable Composer composer3, int i17) {
                            ...
                            androidx.compose.animation.OooOO0.OooO00o((i110 >> 3) & 112, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer3)), composer3, 2058660585);
                ...
                public final void invoke(@Nullable Composer composer2, int i16) {
                    ...
                    CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer2, 1296061040, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$AppBar$1.1
                        ...
                        public final void invoke(@Nullable Composer composer3, int i18) {
                            ...
                            androidx.compose.animation.OooOO0.OooO00o((i111 >> 3) & 112, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer3)), composer3, 2058660585);
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$AppBar$2
            ...
            public final void invoke(@Nullable Composer composer2, int i16) {
                AppBarKt.m968AppBarcelAv9A(j, j2, f, paddingValues, shape, modifier7, function3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
    ...
    public static final void m969BottomAppBarY1yfwus(@Nullable Modifier modifier, long j, long j2, @Nullable Shape shape, float f, @Nullable PaddingValues paddingValues, @NotNull final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, final int i, final int i2) {
        int i3;
        long primarySurface;
        long j3;
        Shape shape2;
        int i4;
        float fM966getBottomAppBarElevationD9Ej5fM;
        int i5;
        int i6;
        int i7;
        int i8;
        ...
        if (i12 == 0) {
            ...
            if (i4 != 0) {
                if ((57344 & i) == 0) {
                    fM966getBottomAppBarElevationD9Ej5fM = f;
                    if (composerStartRestartGroup.changed(fM966getBottomAppBarElevationD9Ej5fM)) {
                        i5 = 16384;
                    } else {
                        i5 = 8192;
                    }
                ...
                if ((i2 & 64) != 0) {
                    ...
                    if ((i3 & 2995931) == 599186 || !composerStartRestartGroup.getSkipping()) {
                        ...
                        if ((i & 1) != 0 || composerStartRestartGroup.getDefaultsInvalid()) {
                            ...
                            if ((i2 & 4) != 0) {
                                long jM1057contentColorForek8zF_U = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                                i3 &= -897;
                            ...
                            if (i4 != 0) {
                                fM966getBottomAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m966getBottomAppBarElevationD9Ej5fM();
                            }
                            if (i6 != 0) {
                                modifier3 = modifier2;
                        ...
                        long j7 = j3;
                        float f3 = fM966getBottomAppBarElevationD9Ej5fM;
                        shape3 = shape2;
                        ...
                        int i13 = i3 >> 3;
                        int i14 = i3 >> 6;
                        m968AppBarcelAv9A(j6, j7, f3, contentPadding, rectangleShape, modifier3, content, composerStartRestartGroup, (i13 & 112) | (i13 & 14) | (i14 & 896) | (i14 & 7168) | ((i3 << 15) & 458752) | (i3 & 3670016), 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                        modifier4 = modifier3;
                        ...
                        j5 = j3;
                        shape4 = shape2;
                        f2 = fM966getBottomAppBarElevationD9Ej5fM;
                    }
                    scopeUpdateScopeEndRestartGroup = composerStartRestartGroup.endRestartGroup();
                    if (scopeUpdateScopeEndRestartGroup == null) {
                        return;
                    ...
                    scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$BottomAppBar$1
                        ...
                        public final void invoke(@Nullable Composer composer2, int i15) {
                            AppBarKt.m969BottomAppBarY1yfwus(modifier4, j4, j5, shape4, f2, paddingValues2, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                        }
                    });
                }
                i8 = 1572864;
                ...
                if ((i3 & 2995931) == 599186) {
                    ...
                    if ((i & 1) != 0) {
                        ...
                        if ((i2 & 4) != 0) {
                            long jM1057contentColorForek8zF_U2 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                            i3 &= -897;
                        ...
                        if ((i2 & 4) != 0) {
                            long jM1057contentColorForek8zF_U3 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                            i3 &= -897;
                    ...
                    long j9 = j3;
                    float f4 = fM966getBottomAppBarElevationD9Ej5fM;
                    shape3 = shape2;
                    composerStartRestartGroup.endDefaults();
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(-1651948973, i3, -1, "androidx.compose.material.BottomAppBar (AppBar.kt:214)");
                    ...
                    int i15 = i3 >> 3;
                    int i16 = i3 >> 6;
                    m968AppBarcelAv9A(j8, j9, f4, contentPadding, rectangleShape, modifier3, content, composerStartRestartGroup, (i15 & 112) | (i15 & 14) | (i16 & 896) | (i16 & 7168) | ((i3 << 15) & 458752) | (i3 & 3670016), 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
                    ...
                    if ((i & 1) != 0) {
                        ...
                        if ((i2 & 4) != 0) {
                            long jM1057contentColorForek8zF_U4 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                            i3 &= -897;
                        ...
                        if ((i2 & 4) != 0) {
                            long jM1057contentColorForek8zF_U5 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                            i3 &= -897;
                    ...
                    long j11 = j3;
                    float f5 = fM966getBottomAppBarElevationD9Ej5fM;
                    shape3 = shape2;
                    composerStartRestartGroup.endDefaults();
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(-1651948973, i3, -1, "androidx.compose.material.BottomAppBar (AppBar.kt:214)");
                    ...
                    int i17 = i3 >> 3;
                    int i18 = i3 >> 6;
                    m968AppBarcelAv9A(j10, j11, f5, contentPadding, rectangleShape, modifier3, content, composerStartRestartGroup, (i17 & 112) | (i17 & 14) | (i18 & 896) | (i18 & 7168) | ((i3 << 15) & 458752) | (i3 & 3670016), 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
            ...
            if ((i2 & 64) != 0) {
                ...
                if ((i3 & 2995931) == 599186) {
                    ...
                    if ((i & 1) != 0) {
                        ...
                        if ((i2 & 4) != 0) {
                            long jM1057contentColorForek8zF_U6 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                            i3 &= -897;
                        ...
                        if ((i2 & 4) != 0) {
                            long jM1057contentColorForek8zF_U7 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                            i3 &= -897;
                    ...
                    long j13 = j3;
                    float f6 = fM966getBottomAppBarElevationD9Ej5fM;
                    shape3 = shape2;
                    composerStartRestartGroup.endDefaults();
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(-1651948973, i3, -1, "androidx.compose.material.BottomAppBar (AppBar.kt:214)");
                    ...
                    int i19 = i3 >> 3;
                    int i110 = i3 >> 6;
                    m968AppBarcelAv9A(j12, j13, f6, contentPadding, rectangleShape, modifier3, content, composerStartRestartGroup, (i19 & 112) | (i19 & 14) | (i110 & 896) | (i110 & 7168) | ((i3 << 15) & 458752) | (i3 & 3670016), 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
                    ...
                    if ((i & 1) != 0) {
                        ...
                        if ((i2 & 4) != 0) {
                            long jM1057contentColorForek8zF_U8 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                            i3 &= -897;
                        ...
                        if ((i2 & 4) != 0) {
                            long jM1057contentColorForek8zF_U9 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                            i3 &= -897;
                    ...
                    long j15 = j3;
                    float f7 = fM966getBottomAppBarElevationD9Ej5fM;
                    shape3 = shape2;
                    composerStartRestartGroup.endDefaults();
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(-1651948973, i3, -1, "androidx.compose.material.BottomAppBar (AppBar.kt:214)");
                    ...
                    int i111 = i3 >> 3;
                    int i112 = i3 >> 6;
                    m968AppBarcelAv9A(j14, j15, f7, contentPadding, rectangleShape, modifier3, content, composerStartRestartGroup, (i111 & 112) | (i111 & 14) | (i112 & 896) | (i112 & 7168) | ((i3 << 15) & 458752) | (i3 & 3670016), 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
            ...
            if ((i3 & 2995931) == 599186) {
                ...
                if ((i & 1) != 0) {
                    ...
                    if ((i2 & 4) != 0) {
                        long jM1057contentColorForek8zF_U10 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                        i3 &= -897;
                    ...
                    if ((i2 & 4) != 0) {
                        long jM1057contentColorForek8zF_U11 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                        i3 &= -897;
                ...
                long j17 = j3;
                float f8 = fM966getBottomAppBarElevationD9Ej5fM;
                shape3 = shape2;
                composerStartRestartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-1651948973, i3, -1, "androidx.compose.material.BottomAppBar (AppBar.kt:214)");
                ...
                int i113 = i3 >> 3;
                int i114 = i3 >> 6;
                m968AppBarcelAv9A(j16, j17, f8, contentPadding, rectangleShape, modifier3, content, composerStartRestartGroup, (i113 & 112) | (i113 & 14) | (i114 & 896) | (i114 & 7168) | ((i3 << 15) & 458752) | (i3 & 3670016), 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier4 = modifier3;
                ...
                if ((i & 1) != 0) {
                    ...
                    if ((i2 & 4) != 0) {
                        long jM1057contentColorForek8zF_U12 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                        i3 &= -897;
                    ...
                    if ((i2 & 4) != 0) {
                        long jM1057contentColorForek8zF_U13 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                        i3 &= -897;
                ...
                long j19 = j3;
                float f9 = fM966getBottomAppBarElevationD9Ej5fM;
                shape3 = shape2;
                composerStartRestartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-1651948973, i3, -1, "androidx.compose.material.BottomAppBar (AppBar.kt:214)");
                ...
                int i115 = i3 >> 3;
                int i116 = i3 >> 6;
                m968AppBarcelAv9A(j18, j19, f9, contentPadding, rectangleShape, modifier3, content, composerStartRestartGroup, (i115 & 112) | (i115 & 14) | (i116 & 896) | (i116 & 7168) | ((i3 << 15) & 458752) | (i3 & 3670016), 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier4 = modifier3;
        ...
        if (i4 != 0) {
            ...
            if ((i2 & 64) != 0) {
                ...
                if ((i3 & 2995931) == 599186) {
                    ...
                    if ((i & 1) != 0) {
                        ...
                        if ((i2 & 4) != 0) {
                            long jM1057contentColorForek8zF_U14 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                            i3 &= -897;
                        ...
                        if ((i2 & 4) != 0) {
                            long jM1057contentColorForek8zF_U15 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                            i3 &= -897;
                    ...
                    long j111 = j3;
                    float f10 = fM966getBottomAppBarElevationD9Ej5fM;
                    shape3 = shape2;
                    composerStartRestartGroup.endDefaults();
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(-1651948973, i3, -1, "androidx.compose.material.BottomAppBar (AppBar.kt:214)");
                    ...
                    int i117 = i3 >> 3;
                    int i118 = i3 >> 6;
                    m968AppBarcelAv9A(j110, j111, f10, contentPadding, rectangleShape, modifier3, content, composerStartRestartGroup, (i117 & 112) | (i117 & 14) | (i118 & 896) | (i118 & 7168) | ((i3 << 15) & 458752) | (i3 & 3670016), 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
                    ...
                    if ((i & 1) != 0) {
                        ...
                        if ((i2 & 4) != 0) {
                            long jM1057contentColorForek8zF_U16 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                            i3 &= -897;
                        ...
                        if ((i2 & 4) != 0) {
                            long jM1057contentColorForek8zF_U17 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                            i3 &= -897;
                    ...
                    long j113 = j3;
                    float f11 = fM966getBottomAppBarElevationD9Ej5fM;
                    shape3 = shape2;
                    composerStartRestartGroup.endDefaults();
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(-1651948973, i3, -1, "androidx.compose.material.BottomAppBar (AppBar.kt:214)");
                    ...
                    int i119 = i3 >> 3;
                    int i1110 = i3 >> 6;
                    m968AppBarcelAv9A(j112, j113, f11, contentPadding, rectangleShape, modifier3, content, composerStartRestartGroup, (i119 & 112) | (i119 & 14) | (i1110 & 896) | (i1110 & 7168) | ((i3 << 15) & 458752) | (i3 & 3670016), 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier4 = modifier3;
            ...
            if ((i3 & 2995931) == 599186) {
                ...
                if ((i & 1) != 0) {
                    ...
                    if ((i2 & 4) != 0) {
                        long jM1057contentColorForek8zF_U18 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                        i3 &= -897;
                    ...
                    if ((i2 & 4) != 0) {
                        long jM1057contentColorForek8zF_U19 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                        i3 &= -897;
                ...
                long j115 = j3;
                float f12 = fM966getBottomAppBarElevationD9Ej5fM;
                shape3 = shape2;
                composerStartRestartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-1651948973, i3, -1, "androidx.compose.material.BottomAppBar (AppBar.kt:214)");
                ...
                int i1111 = i3 >> 3;
                int i1112 = i3 >> 6;
                m968AppBarcelAv9A(j114, j115, f12, contentPadding, rectangleShape, modifier3, content, composerStartRestartGroup, (i1111 & 112) | (i1111 & 14) | (i1112 & 896) | (i1112 & 7168) | ((i3 << 15) & 458752) | (i3 & 3670016), 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier4 = modifier3;
                ...
                if ((i & 1) != 0) {
                    ...
                    if ((i2 & 4) != 0) {
                        long jM1057contentColorForek8zF_U110 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                        i3 &= -897;
                    ...
                    if ((i2 & 4) != 0) {
                        long jM1057contentColorForek8zF_U111 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                        i3 &= -897;
                ...
                long j117 = j3;
                float f13 = fM966getBottomAppBarElevationD9Ej5fM;
                shape3 = shape2;
                composerStartRestartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-1651948973, i3, -1, "androidx.compose.material.BottomAppBar (AppBar.kt:214)");
                ...
                int i1113 = i3 >> 3;
                int i1114 = i3 >> 6;
                m968AppBarcelAv9A(j116, j117, f13, contentPadding, rectangleShape, modifier3, content, composerStartRestartGroup, (i1113 & 112) | (i1113 & 14) | (i1114 & 896) | (i1114 & 7168) | ((i3 << 15) & 458752) | (i3 & 3670016), 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier4 = modifier3;
        ...
        if ((i2 & 64) != 0) {
            ...
            if ((i3 & 2995931) == 599186) {
                ...
                if ((i & 1) != 0) {
                    ...
                    if ((i2 & 4) != 0) {
                        long jM1057contentColorForek8zF_U112 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                        i3 &= -897;
                    ...
                    if ((i2 & 4) != 0) {
                        long jM1057contentColorForek8zF_U113 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                        i3 &= -897;
                ...
                long j119 = j3;
                float f14 = fM966getBottomAppBarElevationD9Ej5fM;
                shape3 = shape2;
                composerStartRestartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-1651948973, i3, -1, "androidx.compose.material.BottomAppBar (AppBar.kt:214)");
                ...
                int i1115 = i3 >> 3;
                int i1116 = i3 >> 6;
                m968AppBarcelAv9A(j118, j119, f14, contentPadding, rectangleShape, modifier3, content, composerStartRestartGroup, (i1115 & 112) | (i1115 & 14) | (i1116 & 896) | (i1116 & 7168) | ((i3 << 15) & 458752) | (i3 & 3670016), 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier4 = modifier3;
                ...
                if ((i & 1) != 0) {
                    ...
                    if ((i2 & 4) != 0) {
                        long jM1057contentColorForek8zF_U114 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                        i3 &= -897;
                    ...
                    if ((i2 & 4) != 0) {
                        long jM1057contentColorForek8zF_U115 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                        i3 &= -897;
                ...
                long j1111 = j3;
                float f15 = fM966getBottomAppBarElevationD9Ej5fM;
                shape3 = shape2;
                composerStartRestartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-1651948973, i3, -1, "androidx.compose.material.BottomAppBar (AppBar.kt:214)");
                ...
                int i1117 = i3 >> 3;
                int i1118 = i3 >> 6;
                m968AppBarcelAv9A(j1110, j1111, f15, contentPadding, rectangleShape, modifier3, content, composerStartRestartGroup, (i1117 & 112) | (i1117 & 14) | (i1118 & 896) | (i1118 & 7168) | ((i3 << 15) & 458752) | (i3 & 3670016), 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier4 = modifier3;
        ...
        if ((i3 & 2995931) == 599186) {
            ...
            if ((i & 1) != 0) {
                ...
                if ((i2 & 4) != 0) {
                    long jM1057contentColorForek8zF_U116 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                    i3 &= -897;
                ...
                if ((i2 & 4) != 0) {
                    long jM1057contentColorForek8zF_U117 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                    i3 &= -897;
            ...
            long j1113 = j3;
            float f16 = fM966getBottomAppBarElevationD9Ej5fM;
            shape3 = shape2;
            composerStartRestartGroup.endDefaults();
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1651948973, i3, -1, "androidx.compose.material.BottomAppBar (AppBar.kt:214)");
            ...
            int i1119 = i3 >> 3;
            int i11110 = i3 >> 6;
            m968AppBarcelAv9A(j1112, j1113, f16, contentPadding, rectangleShape, modifier3, content, composerStartRestartGroup, (i1119 & 112) | (i1119 & 14) | (i11110 & 896) | (i11110 & 7168) | ((i3 << 15) & 458752) | (i3 & 3670016), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
            ...
            if ((i & 1) != 0) {
                ...
                if ((i2 & 4) != 0) {
                    long jM1057contentColorForek8zF_U118 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                    i3 &= -897;
                ...
                if ((i2 & 4) != 0) {
                    long jM1057contentColorForek8zF_U119 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                    i3 &= -897;
            ...
            long j1115 = j3;
            float f17 = fM966getBottomAppBarElevationD9Ej5fM;
            shape3 = shape2;
            composerStartRestartGroup.endDefaults();
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1651948973, i3, -1, "androidx.compose.material.BottomAppBar (AppBar.kt:214)");
            ...
            int i11111 = i3 >> 3;
            int i11112 = i3 >> 6;
            m968AppBarcelAv9A(j1114, j1115, f17, contentPadding, rectangleShape, modifier3, content, composerStartRestartGroup, (i11111 & 112) | (i11111 & 14) | (i11112 & 896) | (i11112 & 7168) | ((i3 << 15) & 458752) | (i3 & 3670016), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
    ...
    public static final void m970TopAppBarHsRjFd4(@Nullable Modifier modifier, long j, long j2, float f, @Nullable PaddingValues paddingValues, @NotNull final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, final int i, final int i2) {
        Modifier modifier2;
        int i3;
        long j3;
        long j4;
        float fM967getTopAppBarElevationD9Ej5fM;
        int i4;
        ...
        if (i10 == 0) {
            if ((i & 7168) == 0) {
                fM967getTopAppBarElevationD9Ej5fM = f;
                i3 |= composerStartRestartGroup.changed(fM967getTopAppBarElevationD9Ej5fM) ? 2048 : LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY;
            }
            i4 = i2 & 16;
            if (i4 != 0) {
                if ((57344 & i) == 0) {
                ...
                if ((i2 & 32) != 0) {
                    ...
                    if ((374491 & i3) == 74898 || !composerStartRestartGroup.getSkipping()) {
                        ...
                        if ((i & 1) != 0 || composerStartRestartGroup.getDefaultsInvalid()) {
                            ...
                            if (i10 != 0) {
                                fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                            }
                            if (i4 != 0) {
                                modifier4 = modifier3;
                                j5 = primarySurface;
                                contentPadding = AppBarDefaults.INSTANCE.getContentPadding();
                                j6 = j4;
                                f2 = fM967getTopAppBarElevationD9Ej5fM;
                            } else {
                                modifier4 = modifier3;
                                j5 = primarySurface;
                            }
                            ...
                            int i11 = i3 >> 3;
                            m968AppBarcelAv9A(j5, j6, f2, contentPadding, RectangleShapeKt.getRectangleShape(), modifier4, content, composerStartRestartGroup, (i11 & 7168) | (i11 & 14) | 24576 | (i11 & 112) | (i11 & 896) | ((i3 << 15) & 458752) | (3670016 & (i3 << 3)), 0);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                            }
                            modifier5 = modifier4;
                        ...
                        int i12 = i3 >> 3;
                        m968AppBarcelAv9A(j5, j6, f2, contentPadding, RectangleShapeKt.getRectangleShape(), modifier4, content, composerStartRestartGroup, (i12 & 7168) | (i12 & 14) | 24576 | (i12 & 112) | (i12 & 896) | ((i3 << 15) & 458752) | (3670016 & (i3 << 3)), 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                        modifier5 = modifier4;
                        ...
                        j7 = j3;
                        j8 = j4;
                        f3 = fM967getTopAppBarElevationD9Ej5fM;
                    ...
                    scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$3
                        ...
                        public final void invoke(@Nullable Composer composer2, int i13) {
                            AppBarKt.m970TopAppBarHsRjFd4(modifier5, j7, j8, f3, paddingValues3, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                        }
                    });
                }
                i6 = 196608;
                ...
                if ((374491 & i3) == 74898) {
                    ...
                    if ((i & 1) != 0) {
                        ...
                        if ((i2 & 4) != 0) {
                            long jM1057contentColorForek8zF_U2 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                            i3 &= -897;
                            j4 = jM1057contentColorForek8zF_U2;
                        }
                        if (i10 != 0) {
                            fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                        }
                        ...
                        if ((i2 & 4) != 0) {
                            long jM1057contentColorForek8zF_U3 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                            i3 &= -897;
                            j4 = jM1057contentColorForek8zF_U3;
                        }
                        if (i10 != 0) {
                            fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                        }
                    ...
                    int i13 = i3 >> 3;
                    m968AppBarcelAv9A(j5, j6, f2, contentPadding, RectangleShapeKt.getRectangleShape(), modifier4, content, composerStartRestartGroup, (i13 & 7168) | (i13 & 14) | 24576 | (i13 & 112) | (i13 & 896) | ((i3 << 15) & 458752) | (3670016 & (i3 << 3)), 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier5 = modifier4;
                    ...
                    if ((i & 1) != 0) {
                        ...
                        if ((i2 & 4) != 0) {
                            long jM1057contentColorForek8zF_U4 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                            i3 &= -897;
                            j4 = jM1057contentColorForek8zF_U4;
                        }
                        if (i10 != 0) {
                            fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                        }
                        ...
                        if ((i2 & 4) != 0) {
                            long jM1057contentColorForek8zF_U5 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                            i3 &= -897;
                            j4 = jM1057contentColorForek8zF_U5;
                        }
                        if (i10 != 0) {
                            fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                        }
                    ...
                    int i14 = i3 >> 3;
                    m968AppBarcelAv9A(j5, j6, f2, contentPadding, RectangleShapeKt.getRectangleShape(), modifier4, content, composerStartRestartGroup, (i14 & 7168) | (i14 & 14) | 24576 | (i14 & 112) | (i14 & 896) | ((i3 << 15) & 458752) | (3670016 & (i3 << 3)), 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier5 = modifier4;
                ...
                if ((374491 & i3) == 74898) {
                    ...
                    if ((i & 1) != 0) {
                        ...
                        if ((i2 & 4) != 0) {
                            long jM1057contentColorForek8zF_U6 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                            i3 &= -897;
                            j4 = jM1057contentColorForek8zF_U6;
                        }
                        if (i10 != 0) {
                            fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                        }
                        ...
                        if ((i2 & 4) != 0) {
                            long jM1057contentColorForek8zF_U7 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                            i3 &= -897;
                            j4 = jM1057contentColorForek8zF_U7;
                        }
                        if (i10 != 0) {
                            fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                        }
                    ...
                    int i15 = i3 >> 3;
                    m968AppBarcelAv9A(j5, j6, f2, contentPadding, RectangleShapeKt.getRectangleShape(), modifier4, content, composerStartRestartGroup, (i15 & 7168) | (i15 & 14) | 24576 | (i15 & 112) | (i15 & 896) | ((i3 << 15) & 458752) | (3670016 & (i3 << 3)), 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier5 = modifier4;
                    ...
                    if ((i & 1) != 0) {
                        ...
                        if ((i2 & 4) != 0) {
                            long jM1057contentColorForek8zF_U8 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                            i3 &= -897;
                            j4 = jM1057contentColorForek8zF_U8;
                        }
                        if (i10 != 0) {
                            fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                        }
                        ...
                        if ((i2 & 4) != 0) {
                            long jM1057contentColorForek8zF_U9 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                            i3 &= -897;
                            j4 = jM1057contentColorForek8zF_U9;
                        }
                        if (i10 != 0) {
                            fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                        }
                    ...
                    int i16 = i3 >> 3;
                    m968AppBarcelAv9A(j5, j6, f2, contentPadding, RectangleShapeKt.getRectangleShape(), modifier4, content, composerStartRestartGroup, (i16 & 7168) | (i16 & 14) | 24576 | (i16 & 112) | (i16 & 896) | ((i3 << 15) & 458752) | (3670016 & (i3 << 3)), 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier5 = modifier4;
            ...
            if ((374491 & i3) == 74898) {
                ...
                if ((i & 1) != 0) {
                    ...
                    if ((i2 & 4) != 0) {
                        long jM1057contentColorForek8zF_U10 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                        i3 &= -897;
                        j4 = jM1057contentColorForek8zF_U10;
                    }
                    if (i10 != 0) {
                        fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                    }
                    ...
                    if ((i2 & 4) != 0) {
                        long jM1057contentColorForek8zF_U11 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                        i3 &= -897;
                        j4 = jM1057contentColorForek8zF_U11;
                    }
                    if (i10 != 0) {
                        fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                    }
                ...
                int i17 = i3 >> 3;
                m968AppBarcelAv9A(j5, j6, f2, contentPadding, RectangleShapeKt.getRectangleShape(), modifier4, content, composerStartRestartGroup, (i17 & 7168) | (i17 & 14) | 24576 | (i17 & 112) | (i17 & 896) | ((i3 << 15) & 458752) | (3670016 & (i3 << 3)), 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier5 = modifier4;
                ...
                if ((i & 1) != 0) {
                    ...
                    if ((i2 & 4) != 0) {
                        long jM1057contentColorForek8zF_U12 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                        i3 &= -897;
                        j4 = jM1057contentColorForek8zF_U12;
                    }
                    if (i10 != 0) {
                        fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                    }
                    ...
                    if ((i2 & 4) != 0) {
                        long jM1057contentColorForek8zF_U13 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                        i3 &= -897;
                        j4 = jM1057contentColorForek8zF_U13;
                    }
                    if (i10 != 0) {
                        fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                    }
                ...
                int i18 = i3 >> 3;
                m968AppBarcelAv9A(j5, j6, f2, contentPadding, RectangleShapeKt.getRectangleShape(), modifier4, content, composerStartRestartGroup, (i18 & 7168) | (i18 & 14) | 24576 | (i18 & 112) | (i18 & 896) | ((i3 << 15) & 458752) | (3670016 & (i3 << 3)), 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier5 = modifier4;
                ...
                if ((374491 & i3) == 74898) {
                    ...
                    if ((i & 1) != 0) {
                        ...
                        if ((i2 & 4) != 0) {
                            long jM1057contentColorForek8zF_U14 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                            i3 &= -897;
                            j4 = jM1057contentColorForek8zF_U14;
                        }
                        if (i10 != 0) {
                            fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                        }
                        ...
                        if ((i2 & 4) != 0) {
                            long jM1057contentColorForek8zF_U15 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                            i3 &= -897;
                            j4 = jM1057contentColorForek8zF_U15;
                        }
                        if (i10 != 0) {
                            fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                        }
                    ...
                    int i19 = i3 >> 3;
                    m968AppBarcelAv9A(j5, j6, f2, contentPadding, RectangleShapeKt.getRectangleShape(), modifier4, content, composerStartRestartGroup, (i19 & 7168) | (i19 & 14) | 24576 | (i19 & 112) | (i19 & 896) | ((i3 << 15) & 458752) | (3670016 & (i3 << 3)), 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier5 = modifier4;
                    ...
                    if ((i & 1) != 0) {
                        ...
                        if ((i2 & 4) != 0) {
                            long jM1057contentColorForek8zF_U16 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                            i3 &= -897;
                            j4 = jM1057contentColorForek8zF_U16;
                        }
                        if (i10 != 0) {
                            fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                        }
                        ...
                        if ((i2 & 4) != 0) {
                            long jM1057contentColorForek8zF_U17 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                            i3 &= -897;
                            j4 = jM1057contentColorForek8zF_U17;
                        }
                        if (i10 != 0) {
                            fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                        }
                    ...
                    int i110 = i3 >> 3;
                    m968AppBarcelAv9A(j5, j6, f2, contentPadding, RectangleShapeKt.getRectangleShape(), modifier4, content, composerStartRestartGroup, (i110 & 7168) | (i110 & 14) | 24576 | (i110 & 112) | (i110 & 896) | ((i3 << 15) & 458752) | (3670016 & (i3 << 3)), 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    modifier5 = modifier4;
            ...
            if ((374491 & i3) == 74898) {
                ...
                if ((i & 1) != 0) {
                    ...
                    if ((i2 & 4) != 0) {
                        long jM1057contentColorForek8zF_U18 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                        i3 &= -897;
                        j4 = jM1057contentColorForek8zF_U18;
                    }
                    if (i10 != 0) {
                        fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                    }
                    ...
                    if ((i2 & 4) != 0) {
                        long jM1057contentColorForek8zF_U19 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                        i3 &= -897;
                        j4 = jM1057contentColorForek8zF_U19;
                    }
                    if (i10 != 0) {
                        fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                    }
                ...
                int i111 = i3 >> 3;
                m968AppBarcelAv9A(j5, j6, f2, contentPadding, RectangleShapeKt.getRectangleShape(), modifier4, content, composerStartRestartGroup, (i111 & 7168) | (i111 & 14) | 24576 | (i111 & 112) | (i111 & 896) | ((i3 << 15) & 458752) | (3670016 & (i3 << 3)), 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier5 = modifier4;
                ...
                if ((i & 1) != 0) {
                    ...
                    if ((i2 & 4) != 0) {
                        long jM1057contentColorForek8zF_U110 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                        i3 &= -897;
                        j4 = jM1057contentColorForek8zF_U110;
                    }
                    if (i10 != 0) {
                        fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                    }
                    ...
                    if ((i2 & 4) != 0) {
                        long jM1057contentColorForek8zF_U111 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                        i3 &= -897;
                        j4 = jM1057contentColorForek8zF_U111;
                    }
                    if (i10 != 0) {
                        fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                    }
                ...
                int i112 = i3 >> 3;
                m968AppBarcelAv9A(j5, j6, f2, contentPadding, RectangleShapeKt.getRectangleShape(), modifier4, content, composerStartRestartGroup, (i112 & 7168) | (i112 & 14) | 24576 | (i112 & 112) | (i112 & 896) | ((i3 << 15) & 458752) | (3670016 & (i3 << 3)), 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier5 = modifier4;
            ...
            if ((374491 & i3) == 74898) {
                ...
                if ((i & 1) != 0) {
                    ...
                    if ((i2 & 4) != 0) {
                        long jM1057contentColorForek8zF_U112 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                        i3 &= -897;
                        j4 = jM1057contentColorForek8zF_U112;
                    }
                    if (i10 != 0) {
                        fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                    }
                    ...
                    if ((i2 & 4) != 0) {
                        long jM1057contentColorForek8zF_U113 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                        i3 &= -897;
                        j4 = jM1057contentColorForek8zF_U113;
                    }
                    if (i10 != 0) {
                        fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                    }
                ...
                int i113 = i3 >> 3;
                m968AppBarcelAv9A(j5, j6, f2, contentPadding, RectangleShapeKt.getRectangleShape(), modifier4, content, composerStartRestartGroup, (i113 & 7168) | (i113 & 14) | 24576 | (i113 & 112) | (i113 & 896) | ((i3 << 15) & 458752) | (3670016 & (i3 << 3)), 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier5 = modifier4;
                ...
                if ((i & 1) != 0) {
                    ...
                    if ((i2 & 4) != 0) {
                        long jM1057contentColorForek8zF_U114 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                        i3 &= -897;
                        j4 = jM1057contentColorForek8zF_U114;
                    }
                    if (i10 != 0) {
                        fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                    }
                    ...
                    if ((i2 & 4) != 0) {
                        long jM1057contentColorForek8zF_U115 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                        i3 &= -897;
                        j4 = jM1057contentColorForek8zF_U115;
                    }
                    if (i10 != 0) {
                        fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                    }
                ...
                int i114 = i3 >> 3;
                m968AppBarcelAv9A(j5, j6, f2, contentPadding, RectangleShapeKt.getRectangleShape(), modifier4, content, composerStartRestartGroup, (i114 & 7168) | (i114 & 14) | 24576 | (i114 & 112) | (i114 & 896) | ((i3 << 15) & 458752) | (3670016 & (i3 << 3)), 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier5 = modifier4;
        ...
        if ((374491 & i3) == 74898) {
            ...
            if ((i & 1) != 0) {
                ...
                if ((i2 & 4) != 0) {
                    long jM1057contentColorForek8zF_U116 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                    i3 &= -897;
                    j4 = jM1057contentColorForek8zF_U116;
                }
                if (i10 != 0) {
                    fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                }
                ...
                if ((i2 & 4) != 0) {
                    long jM1057contentColorForek8zF_U117 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                    i3 &= -897;
                    j4 = jM1057contentColorForek8zF_U117;
                }
                if (i10 != 0) {
                    fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                }
            ...
            int i115 = i3 >> 3;
            m968AppBarcelAv9A(j5, j6, f2, contentPadding, RectangleShapeKt.getRectangleShape(), modifier4, content, composerStartRestartGroup, (i115 & 7168) | (i115 & 14) | 24576 | (i115 & 112) | (i115 & 896) | ((i3 << 15) & 458752) | (3670016 & (i3 << 3)), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier5 = modifier4;
            ...
            if ((i & 1) != 0) {
                ...
                if ((i2 & 4) != 0) {
                    long jM1057contentColorForek8zF_U118 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                    i3 &= -897;
                    j4 = jM1057contentColorForek8zF_U118;
                }
                if (i10 != 0) {
                    fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                }
                ...
                if ((i2 & 4) != 0) {
                    long jM1057contentColorForek8zF_U119 = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 3) & 14);
                    i3 &= -897;
                    j4 = jM1057contentColorForek8zF_U119;
                }
                if (i10 != 0) {
                    fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                }
            ...
            int i116 = i3 >> 3;
            m968AppBarcelAv9A(j5, j6, f2, contentPadding, RectangleShapeKt.getRectangleShape(), modifier4, content, composerStartRestartGroup, (i116 & 7168) | (i116 & 14) | 24576 | (i116 & 112) | (i116 & 896) | ((i3 << 15) & 458752) | (3670016 & (i3 << 3)), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier5 = modifier4;
    ...
    /* JADX WARN: Code duplicated, block: B:96:0x0121 A[DONT_INVERT] */
    ...
    public static final void m971TopAppBarxWeB9s(@NotNull final Function2<? super Composer, ? super Integer, Unit> title, @Nullable Modifier modifier, @Nullable Function2<? super Composer, ? super Integer, Unit> function2, @Nullable Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, long j, long j2, float f, @Nullable Composer composer, final int i, final int i2) {
        final int i3;
        int i4;
        ...
        final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3M1062getLambda1$material_release;
        long primarySurface;
        ...
        if (i10 == 0) {
            ...
            if (i4 != 0) {
                ...
                if (i6 != 0) {
                    ...
                    if ((i3 & 2995931) == 599186 || !composerStartRestartGroup.getSkipping()) {
                        ...
                        if ((i & 1) != 0 || composerStartRestartGroup.getDefaultsInvalid()) {
                            ...
                            if (i6 != 0) {
                                function3M1062getLambda1$material_release = ComposableSingletons$AppBarKt.INSTANCE.m1062getLambda1$material_release();
                            } else {
                                function3M1062getLambda1$material_release = function5;
                            }
                            if ((i2 & 16) != 0) {
                                primarySurface = ColorsKt.getPrimarySurface(MaterialTheme.INSTANCE.getColors(composerStartRestartGroup, 6));
                                i3 &= -57345;
                            ...
                            if ((i2 & 32) != 0) {
                                jM1057contentColorForek8zF_U = ColorsKt.m1057contentColorForek8zF_U(primarySurface, composerStartRestartGroup, (i3 >> 12) & 14);
                                i3 &= -458753;
                            } else {
                                jM1057contentColorForek8zF_U = j4;
                            }
                            if (i8 != 0) {
                                fM967getTopAppBarElevationD9Ej5fM = AppBarDefaults.INSTANCE.m967getTopAppBarElevationD9Ej5fM();
                                ...
                                j5 = jM1057contentColorForek8zF_U;
                                fM967getTopAppBarElevationD9Ej5fM = f2;
                            }
                        } else {
                            composerStartRestartGroup.skipToGroupEnd();
                            if ((i2 & 16) != 0) {
                        ...
                        m968AppBarcelAv9A(primarySurface, j5, fM967getTopAppBarElevationD9Ej5fM, AppBarDefaults.INSTANCE.getContentPadding(), RectangleShapeKt.getRectangleShape(), modifier2, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1484077694, true, new Function3<RowScope, Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1
                            ...
                            public final void invoke(@NotNull RowScope AppBar, @Nullable Composer composer2, int i14) {
                                ...
                                if (function6 == null) {
                                    ...
                                    CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getHigh(composer2, 6)))}, function7, composer2, ((i16 >> 3) & 112) | 8);
                                    composer2.endReplaceableGroup();
                                    composer2.endNode();
                                    composer2.endReplaceableGroup();
                                    composer2.endReplaceableGroup();
                                ...
                                Modifier modifierOooO00o = androidx.compose.foundation.layout.OooOO0O.OooO00o(AppBar, SizeKt.fillMaxHeight$default(Modifier.INSTANCE, 0.0f, 1, null), 1.0f, false, 2, null);
                                Alignment.Vertical centerVertically2 = Alignment.INSTANCE.getCenterVertically();
                                final Function2<Composer, Integer, Unit> function8 = title;
                                final int i17 = i3;
                                composer2.startReplaceableGroup(693286680);
                                MeasurePolicy measurePolicyOooO0O1 = OooO0OO.OooO0O0(Arrangement.INSTANCE, centerVertically2, composer2, 48, -1323940314);
                                ...
                                TextKt.ProvideTextStyle(MaterialTheme.INSTANCE.getTypography(composer2, 6).getH6(), ComposableLambdaKt.composableLambda(composer2, -2021518195, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1$2$1
                                    ...
                                    public final void invoke(@Nullable Composer composer3, int i18) {
                                        ...
                                        if (ComposerKt.isTraceInProgress()) {
                                            ComposerKt.traceEventStart(-2021518195, i18, -1, "androidx.compose.material.TopAppBar.<anonymous>.<anonymous>.<anonymous> (AppBar.kt:108)");
                                        }
                                        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getHigh(composer3, 6)))}, function8, composer3, ((i17 << 3) & 112) | 8);
                                        if (ComposerKt.isTraceInProgress()) {
                                            ComposerKt.traceEventEnd();
                                        }
                                    }
                                ...
                                composer2.endReplaceableGroup();
                                ProvidedValue[] providedValueArr = {ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getMedium(composer2, 6)))};
                                final Function3<RowScope, Composer, Integer, Unit> function9 = function3M1062getLambda1$material_release;
                                final int i18 = i3;
                                CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer2, 1157662914, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1.3
                                    ...
                                    public final void invoke(@Nullable Composer composer3, int i19) {
                                        ...
                                        if (ComposerKt.isTraceInProgress()) {
                                            ComposerKt.traceEventStart(1157662914, i19, -1, "androidx.compose.material.TopAppBar.<anonymous>.<anonymous> (AppBar.kt:116)");
                                        }
                                        ...
                                        composer3.startReplaceableGroup(693286680);
                                        int i21 = i20 >> 3;
                                        MeasurePolicy measurePolicyRowMeasurePolicy = RowKt.rowMeasurePolicy(end, centerVertically3, composer3, (i21 & 112) | (i21 & 14));
                                        composer3.startReplaceableGroup(-1323940314);
                                        ...
                                        androidx.compose.animation.OooOO0.OooO00o((i22 >> 3) & 112, function3ModifierMaterializerOf3, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer3)), composer3, 2058660585);
                                        function10.invoke(RowScopeInstance.INSTANCE, composer3, Integer.valueOf(((i20 >> 6) & 112) | 6));
                                        composer3.endReplaceableGroup();
                                        composer3.endNode();
                                        composer3.endReplaceableGroup();
                                        composer3.endReplaceableGroup();
                    ...
                    final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function8 = function3M1062getLambda1$material_release;
                    ...
                    scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$2
                        ...
                        public final void invoke(@Nullable Composer composer2, int i14) {
                            AppBarKt.m971TopAppBarxWeB9s(title, modifier4, function7, function8, j6, j7, f3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                        }
                    });
                }
                i3 |= 3072;
                    ...
                    m968AppBarcelAv9A(primarySurface, j5, fM967getTopAppBarElevationD9Ej5fM, AppBarDefaults.INSTANCE.getContentPadding(), RectangleShapeKt.getRectangleShape(), modifier2, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1484077694, true, new Function3<RowScope, Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1
                        ...
                        public final void invoke(@NotNull RowScope AppBar, @Nullable Composer composer2, int i15) {
                            ...
                            if (function6 == null) {
                                ...
                                androidx.compose.animation.OooOO0.OooO00o(0, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer2)), composer2, 2058660585);
                                RowScopeInstance rowScopeInstance = RowScopeInstance.INSTANCE;
                                CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getHigh(composer2, 6)))}, function9, composer2, ((i17 >> 3) & 112) | 8);
                                composer2.endReplaceableGroup();
                                composer2.endNode();
                                composer2.endReplaceableGroup();
                                composer2.endReplaceableGroup();
                            ...
                            TextKt.ProvideTextStyle(MaterialTheme.INSTANCE.getTypography(composer2, 6).getH6(), ComposableLambdaKt.composableLambda(composer2, -2021518195, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1$2$1
                                ...
                                public final void invoke(@Nullable Composer composer3, int i19) {
                                    ...
                                    CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getHigh(composer3, 6)))}, function10, composer3, ((i18 << 3) & 112) | 8);
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
                                    }
                                }
                            ...
                            composer2.endReplaceableGroup();
                            ProvidedValue[] providedValueArr = {ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getMedium(composer2, 6)))};
                            final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function11 = function3M1062getLambda1$material_release;
                            final int i19 = i3;
                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer2, 1157662914, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1.3
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                /* JADX WARN: Multi-variable type inference failed */
                                ...
                                public final void invoke(@Nullable Composer composer3, int i110) {
                                    ...
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(1157662914, i110, -1, "androidx.compose.material.TopAppBar.<anonymous>.<anonymous> (AppBar.kt:116)");
                                    }
                                    Modifier modifierFillMaxHeight$default = SizeKt.fillMaxHeight$default(Modifier.INSTANCE, 0.0f, 1, null);
                                    Arrangement.Horizontal end = Arrangement.INSTANCE.getEnd();
                                    Alignment.Vertical centerVertically3 = Alignment.INSTANCE.getCenterVertically();
                                    Function3<RowScope, Composer, Integer, Unit> function12 = function11;
                                    int i20 = (i19 & 7168) | 438;
                                    composer3.startReplaceableGroup(693286680);
                                    int i21 = i20 >> 3;
                                    MeasurePolicy measurePolicyRowMeasurePolicy = RowKt.rowMeasurePolicy(end, centerVertically3, composer3, (i21 & 112) | (i21 & 14));
                                    composer3.startReplaceableGroup(-1323940314);
                                    ...
                                    androidx.compose.animation.OooOO0.OooO00o((i22 >> 3) & 112, function3ModifierMaterializerOf3, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer3)), composer3, 2058660585);
                                    function12.invoke(RowScopeInstance.INSTANCE, composer3, Integer.valueOf(((i20 >> 6) & 112) | 6));
                                    composer3.endReplaceableGroup();
                                    composer3.endNode();
                                    composer3.endReplaceableGroup();
                                    composer3.endReplaceableGroup();
                        ...
                        public final void invoke(@NotNull RowScope AppBar, @Nullable Composer composer2, int i16) {
                            ...
                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer2, 1157662914, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1.3
                                ...
                                public final void invoke(@Nullable Composer composer3, int i111) {
                                    ...
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(1157662914, i111, -1, "androidx.compose.material.TopAppBar.<anonymous>.<anonymous> (AppBar.kt:116)");
                                    }
                                    Modifier modifierFillMaxHeight$default = SizeKt.fillMaxHeight$default(Modifier.INSTANCE, 0.0f, 1, null);
                                    Arrangement.Horizontal end = Arrangement.INSTANCE.getEnd();
                                    Alignment.Vertical centerVertically3 = Alignment.INSTANCE.getCenterVertically();
                                    Function3<RowScope, Composer, Integer, Unit> function12 = function11;
                                    int i20 = (i110 & 7168) | 438;
                                    composer3.startReplaceableGroup(693286680);
                                    int i21 = i20 >> 3;
                                    MeasurePolicy measurePolicyRowMeasurePolicy = RowKt.rowMeasurePolicy(end, centerVertically3, composer3, (i21 & 112) | (i21 & 14));
                                    composer3.startReplaceableGroup(-1323940314);
                ...
                final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function10 = function3M1062getLambda1$material_release;
                ...
                scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$2
                    ...
                    public final void invoke(@Nullable Composer composer2, int i16) {
                        AppBarKt.m971TopAppBarxWeB9s(title, modifier5, function9, function10, j8, j9, f3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                    }
                });
            }
            i3 |= 384;
            ...
            if (i6 != 0) {
                    ...
                    m968AppBarcelAv9A(primarySurface, j5, fM967getTopAppBarElevationD9Ej5fM, AppBarDefaults.INSTANCE.getContentPadding(), RectangleShapeKt.getRectangleShape(), modifier2, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1484077694, true, new Function3<RowScope, Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1
                        ...
                        public final void invoke(@NotNull RowScope AppBar, @Nullable Composer composer2, int i17) {
                            ...
                            if (function6 == null) {
                                ...
                                androidx.compose.animation.OooOO0.OooO00o(0, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer2)), composer2, 2058660585);
                                RowScopeInstance rowScopeInstance = RowScopeInstance.INSTANCE;
                                CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getHigh(composer2, 6)))}, function11, composer2, ((i19 >> 3) & 112) | 8);
                                composer2.endReplaceableGroup();
                                composer2.endNode();
                                composer2.endReplaceableGroup();
                                composer2.endReplaceableGroup();
                            ...
                            TextKt.ProvideTextStyle(MaterialTheme.INSTANCE.getTypography(composer2, 6).getH6(), ComposableLambdaKt.composableLambda(composer2, -2021518195, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1$2$1
                                ...
                                public final void invoke(@Nullable Composer composer3, int i111) {
                                    ...
                                    CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getHigh(composer3, 6)))}, function12, composer3, ((i110 << 3) & 112) | 8);
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
                                    }
                                }
                            ...
                            composer2.endReplaceableGroup();
                            ProvidedValue[] providedValueArr = {ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getMedium(composer2, 6)))};
                            final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function13 = function3M1062getLambda1$material_release;
                            final int i111 = i3;
                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer2, 1157662914, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1.3
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                /* JADX WARN: Multi-variable type inference failed */
                                ...
                                public final void invoke(@Nullable Composer composer3, int i112) {
                                    ...
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(1157662914, i112, -1, "androidx.compose.material.TopAppBar.<anonymous>.<anonymous> (AppBar.kt:116)");
                                    }
                                    Modifier modifierFillMaxHeight$default = SizeKt.fillMaxHeight$default(Modifier.INSTANCE, 0.0f, 1, null);
                                    Arrangement.Horizontal end = Arrangement.INSTANCE.getEnd();
                                    Alignment.Vertical centerVertically3 = Alignment.INSTANCE.getCenterVertically();
                                    Function3<RowScope, Composer, Integer, Unit> function14 = function13;
                                    int i20 = (i111 & 7168) | 438;
                                    composer3.startReplaceableGroup(693286680);
                                    int i21 = i20 >> 3;
                                    MeasurePolicy measurePolicyRowMeasurePolicy = RowKt.rowMeasurePolicy(end, centerVertically3, composer3, (i21 & 112) | (i21 & 14));
                                    composer3.startReplaceableGroup(-1323940314);
                                    ...
                                    androidx.compose.animation.OooOO0.OooO00o((i22 >> 3) & 112, function3ModifierMaterializerOf3, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer3)), composer3, 2058660585);
                                    function14.invoke(RowScopeInstance.INSTANCE, composer3, Integer.valueOf(((i20 >> 6) & 112) | 6));
                                    composer3.endReplaceableGroup();
                                    composer3.endNode();
                                    composer3.endReplaceableGroup();
                                    composer3.endReplaceableGroup();
                        ...
                        public final void invoke(@NotNull RowScope AppBar, @Nullable Composer composer2, int i18) {
                            ...
                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer2, 1157662914, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1.3
                                ...
                                public final void invoke(@Nullable Composer composer3, int i113) {
                                    ...
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(1157662914, i113, -1, "androidx.compose.material.TopAppBar.<anonymous>.<anonymous> (AppBar.kt:116)");
                                    }
                                    Modifier modifierFillMaxHeight$default = SizeKt.fillMaxHeight$default(Modifier.INSTANCE, 0.0f, 1, null);
                                    Arrangement.Horizontal end = Arrangement.INSTANCE.getEnd();
                                    Alignment.Vertical centerVertically3 = Alignment.INSTANCE.getCenterVertically();
                                    Function3<RowScope, Composer, Integer, Unit> function14 = function13;
                                    int i20 = (i112 & 7168) | 438;
                                    composer3.startReplaceableGroup(693286680);
                                    int i21 = i20 >> 3;
                                    MeasurePolicy measurePolicyRowMeasurePolicy = RowKt.rowMeasurePolicy(end, centerVertically3, composer3, (i21 & 112) | (i21 & 14));
                                    composer3.startReplaceableGroup(-1323940314);
                ...
                final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function12 = function3M1062getLambda1$material_release;
                ...
                scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$2
                    ...
                    public final void invoke(@Nullable Composer composer2, int i18) {
                        AppBarKt.m971TopAppBarxWeB9s(title, modifier6, function11, function12, j10, j11, f3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                    }
                });
            }
            i3 |= 3072;
                ...
                m968AppBarcelAv9A(primarySurface, j5, fM967getTopAppBarElevationD9Ej5fM, AppBarDefaults.INSTANCE.getContentPadding(), RectangleShapeKt.getRectangleShape(), modifier2, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1484077694, true, new Function3<RowScope, Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1
                    ...
                    public final void invoke(@NotNull RowScope AppBar, @Nullable Composer composer2, int i19) {
                        ...
                        if (function6 == null) {
                            ...
                            ComposeUiNode.Companion companion = ComposeUiNode.INSTANCE;
                            Function0<ComposeUiNode> constructor = companion.getConstructor();
                            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3ModifierMaterializerOf = LayoutKt.modifierMaterializerOf(modifier7);
                            if (!(composer2.getApplier() instanceof Applier)) {
                                ComposablesKt.invalidApplier();
                            }
                            composer2.startReusableNode();
                            ...
                            androidx.compose.animation.OooOO0.OooO00o(0, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer2)), composer2, 2058660585);
                            RowScopeInstance rowScopeInstance = RowScopeInstance.INSTANCE;
                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getHigh(composer2, 6)))}, function13, composer2, ((i111 >> 3) & 112) | 8);
                            composer2.endReplaceableGroup();
                            composer2.endNode();
                            composer2.endReplaceableGroup();
                            composer2.endReplaceableGroup();
                        ...
                        TextKt.ProvideTextStyle(MaterialTheme.INSTANCE.getTypography(composer2, 6).getH6(), ComposableLambdaKt.composableLambda(composer2, -2021518195, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1$2$1
                            ...
                            public final void invoke(@Nullable Composer composer3, int i113) {
                                ...
                                CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getHigh(composer3, 6)))}, function14, composer3, ((i112 << 3) & 112) | 8);
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventEnd();
                                }
                            }
                        ...
                        composer2.endReplaceableGroup();
                        ProvidedValue[] providedValueArr = {ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getMedium(composer2, 6)))};
                        final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function15 = function3M1062getLambda1$material_release;
                        final int i113 = i3;
                        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer2, 1157662914, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1.3
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            ...
                            public final void invoke(@Nullable Composer composer3, int i114) {
                                ...
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventStart(1157662914, i114, -1, "androidx.compose.material.TopAppBar.<anonymous>.<anonymous> (AppBar.kt:116)");
                                }
                                Modifier modifierFillMaxHeight$default = SizeKt.fillMaxHeight$default(Modifier.INSTANCE, 0.0f, 1, null);
                                Arrangement.Horizontal end = Arrangement.INSTANCE.getEnd();
                                Alignment.Vertical centerVertically3 = Alignment.INSTANCE.getCenterVertically();
                                Function3<RowScope, Composer, Integer, Unit> function16 = function15;
                                int i20 = (i113 & 7168) | 438;
                                composer3.startReplaceableGroup(693286680);
                                int i21 = i20 >> 3;
                                MeasurePolicy measurePolicyRowMeasurePolicy = RowKt.rowMeasurePolicy(end, centerVertically3, composer3, (i21 & 112) | (i21 & 14));
                                composer3.startReplaceableGroup(-1323940314);
                                ...
                                androidx.compose.animation.OooOO0.OooO00o((i22 >> 3) & 112, function3ModifierMaterializerOf3, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer3)), composer3, 2058660585);
                                function16.invoke(RowScopeInstance.INSTANCE, composer3, Integer.valueOf(((i20 >> 6) & 112) | 6));
                                composer3.endReplaceableGroup();
                                composer3.endNode();
                                composer3.endReplaceableGroup();
                                composer3.endReplaceableGroup();
                    ...
                    public final void invoke(@NotNull RowScope AppBar, @Nullable Composer composer2, int i110) {
                        ...
                        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer2, 1157662914, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1.3
                            ...
                            public final void invoke(@Nullable Composer composer3, int i115) {
                                ...
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventStart(1157662914, i115, -1, "androidx.compose.material.TopAppBar.<anonymous>.<anonymous> (AppBar.kt:116)");
                                }
                                Modifier modifierFillMaxHeight$default = SizeKt.fillMaxHeight$default(Modifier.INSTANCE, 0.0f, 1, null);
                                Arrangement.Horizontal end = Arrangement.INSTANCE.getEnd();
                                Alignment.Vertical centerVertically3 = Alignment.INSTANCE.getCenterVertically();
                                Function3<RowScope, Composer, Integer, Unit> function16 = function15;
                                int i20 = (i114 & 7168) | 438;
                                composer3.startReplaceableGroup(693286680);
                                int i21 = i20 >> 3;
                                MeasurePolicy measurePolicyRowMeasurePolicy = RowKt.rowMeasurePolicy(end, centerVertically3, composer3, (i21 & 112) | (i21 & 14));
                                composer3.startReplaceableGroup(-1323940314);
            ...
            final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function14 = function3M1062getLambda1$material_release;
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$2
                ...
                public final void invoke(@Nullable Composer composer2, int i110) {
                    AppBarKt.m971TopAppBarxWeB9s(title, modifier7, function13, function14, j12, j13, f3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
        i3 |= 48;
        ...
        if (i4 != 0) {
            ...
            if (i6 != 0) {
                    ...
                    m968AppBarcelAv9A(primarySurface, j5, fM967getTopAppBarElevationD9Ej5fM, AppBarDefaults.INSTANCE.getContentPadding(), RectangleShapeKt.getRectangleShape(), modifier2, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1484077694, true, new Function3<RowScope, Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1
                        ...
                        public final void invoke(@NotNull RowScope AppBar, @Nullable Composer composer2, int i111) {
                            ...
                            if (function6 == null) {
                                ...
                                ComposeUiNode.Companion companion = ComposeUiNode.INSTANCE;
                                Function0<ComposeUiNode> constructor = companion.getConstructor();
                                Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3ModifierMaterializerOf = LayoutKt.modifierMaterializerOf(modifier8);
                                if (!(composer2.getApplier() instanceof Applier)) {
                                    ComposablesKt.invalidApplier();
                                }
                                composer2.startReusableNode();
                                ...
                                androidx.compose.animation.OooOO0.OooO00o(0, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer2)), composer2, 2058660585);
                                RowScopeInstance rowScopeInstance = RowScopeInstance.INSTANCE;
                                CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getHigh(composer2, 6)))}, function15, composer2, ((i113 >> 3) & 112) | 8);
                                composer2.endReplaceableGroup();
                                composer2.endNode();
                                composer2.endReplaceableGroup();
                                composer2.endReplaceableGroup();
                            ...
                            TextKt.ProvideTextStyle(MaterialTheme.INSTANCE.getTypography(composer2, 6).getH6(), ComposableLambdaKt.composableLambda(composer2, -2021518195, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1$2$1
                                ...
                                public final void invoke(@Nullable Composer composer3, int i115) {
                                    ...
                                    CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getHigh(composer3, 6)))}, function16, composer3, ((i114 << 3) & 112) | 8);
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
                                    }
                                }
                            ...
                            composer2.endReplaceableGroup();
                            ProvidedValue[] providedValueArr = {ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getMedium(composer2, 6)))};
                            final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function17 = function3M1062getLambda1$material_release;
                            final int i115 = i3;
                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer2, 1157662914, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1.3
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                /* JADX WARN: Multi-variable type inference failed */
                                ...
                                public final void invoke(@Nullable Composer composer3, int i116) {
                                    ...
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(1157662914, i116, -1, "androidx.compose.material.TopAppBar.<anonymous>.<anonymous> (AppBar.kt:116)");
                                    }
                                    Modifier modifierFillMaxHeight$default = SizeKt.fillMaxHeight$default(Modifier.INSTANCE, 0.0f, 1, null);
                                    Arrangement.Horizontal end = Arrangement.INSTANCE.getEnd();
                                    Alignment.Vertical centerVertically3 = Alignment.INSTANCE.getCenterVertically();
                                    Function3<RowScope, Composer, Integer, Unit> function18 = function17;
                                    int i20 = (i115 & 7168) | 438;
                                    composer3.startReplaceableGroup(693286680);
                                    int i21 = i20 >> 3;
                                    MeasurePolicy measurePolicyRowMeasurePolicy = RowKt.rowMeasurePolicy(end, centerVertically3, composer3, (i21 & 112) | (i21 & 14));
                                    composer3.startReplaceableGroup(-1323940314);
                                    ...
                                    androidx.compose.animation.OooOO0.OooO00o((i22 >> 3) & 112, function3ModifierMaterializerOf3, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer3)), composer3, 2058660585);
                                    function18.invoke(RowScopeInstance.INSTANCE, composer3, Integer.valueOf(((i20 >> 6) & 112) | 6));
                                    composer3.endReplaceableGroup();
                                    composer3.endNode();
                                    composer3.endReplaceableGroup();
                                    composer3.endReplaceableGroup();
                        ...
                        public final void invoke(@NotNull RowScope AppBar, @Nullable Composer composer2, int i112) {
                            ...
                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer2, 1157662914, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1.3
                                ...
                                public final void invoke(@Nullable Composer composer3, int i117) {
                                    ...
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(1157662914, i117, -1, "androidx.compose.material.TopAppBar.<anonymous>.<anonymous> (AppBar.kt:116)");
                                    }
                                    Modifier modifierFillMaxHeight$default = SizeKt.fillMaxHeight$default(Modifier.INSTANCE, 0.0f, 1, null);
                                    Arrangement.Horizontal end = Arrangement.INSTANCE.getEnd();
                                    Alignment.Vertical centerVertically3 = Alignment.INSTANCE.getCenterVertically();
                                    Function3<RowScope, Composer, Integer, Unit> function18 = function17;
                                    int i20 = (i116 & 7168) | 438;
                                    composer3.startReplaceableGroup(693286680);
                                    int i21 = i20 >> 3;
                                    MeasurePolicy measurePolicyRowMeasurePolicy = RowKt.rowMeasurePolicy(end, centerVertically3, composer3, (i21 & 112) | (i21 & 14));
                                    composer3.startReplaceableGroup(-1323940314);
                ...
                final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function16 = function3M1062getLambda1$material_release;
                ...
                scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$2
                    ...
                    public final void invoke(@Nullable Composer composer2, int i112) {
                        AppBarKt.m971TopAppBarxWeB9s(title, modifier8, function15, function16, j14, j15, f3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                    }
                });
            }
            i3 |= 3072;
                ...
                m968AppBarcelAv9A(primarySurface, j5, fM967getTopAppBarElevationD9Ej5fM, AppBarDefaults.INSTANCE.getContentPadding(), RectangleShapeKt.getRectangleShape(), modifier2, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1484077694, true, new Function3<RowScope, Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1
                    ...
                    public final void invoke(@NotNull RowScope AppBar, @Nullable Composer composer2, int i113) {
                        ...
                        if (function6 == null) {
                            ...
                            ComposeUiNode.Companion companion = ComposeUiNode.INSTANCE;
                            Function0<ComposeUiNode> constructor = companion.getConstructor();
                            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3ModifierMaterializerOf = LayoutKt.modifierMaterializerOf(modifier9);
                            if (!(composer2.getApplier() instanceof Applier)) {
                                ComposablesKt.invalidApplier();
                            }
                            composer2.startReusableNode();
                            ...
                            androidx.compose.animation.OooOO0.OooO00o(0, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer2)), composer2, 2058660585);
                            RowScopeInstance rowScopeInstance = RowScopeInstance.INSTANCE;
                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getHigh(composer2, 6)))}, function17, composer2, ((i115 >> 3) & 112) | 8);
                            composer2.endReplaceableGroup();
                            composer2.endNode();
                            composer2.endReplaceableGroup();
                            composer2.endReplaceableGroup();
                        ...
                        TextKt.ProvideTextStyle(MaterialTheme.INSTANCE.getTypography(composer2, 6).getH6(), ComposableLambdaKt.composableLambda(composer2, -2021518195, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1$2$1
                            ...
                            public final void invoke(@Nullable Composer composer3, int i117) {
                                ...
                                CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getHigh(composer3, 6)))}, function18, composer3, ((i116 << 3) & 112) | 8);
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventEnd();
                                }
                            }
                        ...
                        composer2.endReplaceableGroup();
                        ProvidedValue[] providedValueArr = {ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getMedium(composer2, 6)))};
                        final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function19 = function3M1062getLambda1$material_release;
                        final int i117 = i3;
                        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer2, 1157662914, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1.3
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            ...
                            public final void invoke(@Nullable Composer composer3, int i118) {
                                ...
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventStart(1157662914, i118, -1, "androidx.compose.material.TopAppBar.<anonymous>.<anonymous> (AppBar.kt:116)");
                                }
                                Modifier modifierFillMaxHeight$default = SizeKt.fillMaxHeight$default(Modifier.INSTANCE, 0.0f, 1, null);
                                Arrangement.Horizontal end = Arrangement.INSTANCE.getEnd();
                                Alignment.Vertical centerVertically3 = Alignment.INSTANCE.getCenterVertically();
                                Function3<RowScope, Composer, Integer, Unit> function110 = function19;
                                int i20 = (i117 & 7168) | 438;
                                composer3.startReplaceableGroup(693286680);
                                int i21 = i20 >> 3;
                                MeasurePolicy measurePolicyRowMeasurePolicy = RowKt.rowMeasurePolicy(end, centerVertically3, composer3, (i21 & 112) | (i21 & 14));
                                composer3.startReplaceableGroup(-1323940314);
                                ...
                                androidx.compose.animation.OooOO0.OooO00o((i22 >> 3) & 112, function3ModifierMaterializerOf3, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer3)), composer3, 2058660585);
                                function110.invoke(RowScopeInstance.INSTANCE, composer3, Integer.valueOf(((i20 >> 6) & 112) | 6));
                                composer3.endReplaceableGroup();
                                composer3.endNode();
                                composer3.endReplaceableGroup();
                                composer3.endReplaceableGroup();
                    ...
                    public final void invoke(@NotNull RowScope AppBar, @Nullable Composer composer2, int i114) {
                        ...
                        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer2, 1157662914, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1.3
                            ...
                            public final void invoke(@Nullable Composer composer3, int i119) {
                                ...
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventStart(1157662914, i119, -1, "androidx.compose.material.TopAppBar.<anonymous>.<anonymous> (AppBar.kt:116)");
                                }
                                Modifier modifierFillMaxHeight$default = SizeKt.fillMaxHeight$default(Modifier.INSTANCE, 0.0f, 1, null);
                                Arrangement.Horizontal end = Arrangement.INSTANCE.getEnd();
                                Alignment.Vertical centerVertically3 = Alignment.INSTANCE.getCenterVertically();
                                Function3<RowScope, Composer, Integer, Unit> function110 = function19;
                                int i20 = (i118 & 7168) | 438;
                                composer3.startReplaceableGroup(693286680);
                                int i21 = i20 >> 3;
                                MeasurePolicy measurePolicyRowMeasurePolicy = RowKt.rowMeasurePolicy(end, centerVertically3, composer3, (i21 & 112) | (i21 & 14));
                                composer3.startReplaceableGroup(-1323940314);
            ...
            final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function18 = function3M1062getLambda1$material_release;
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$2
                ...
                public final void invoke(@Nullable Composer composer2, int i114) {
                    AppBarKt.m971TopAppBarxWeB9s(title, modifier9, function17, function18, j16, j17, f3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
        i3 |= 384;
        ...
        if (i6 != 0) {
                ...
                m968AppBarcelAv9A(primarySurface, j5, fM967getTopAppBarElevationD9Ej5fM, AppBarDefaults.INSTANCE.getContentPadding(), RectangleShapeKt.getRectangleShape(), modifier2, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1484077694, true, new Function3<RowScope, Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1
                    ...
                    public final void invoke(@NotNull RowScope AppBar, @Nullable Composer composer2, int i115) {
                        ...
                        if (function6 == null) {
                            ...
                            ComposeUiNode.Companion companion = ComposeUiNode.INSTANCE;
                            Function0<ComposeUiNode> constructor = companion.getConstructor();
                            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3ModifierMaterializerOf = LayoutKt.modifierMaterializerOf(modifier10);
                            if (!(composer2.getApplier() instanceof Applier)) {
                                ComposablesKt.invalidApplier();
                            }
                            composer2.startReusableNode();
                            ...
                            androidx.compose.animation.OooOO0.OooO00o(0, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer2)), composer2, 2058660585);
                            RowScopeInstance rowScopeInstance = RowScopeInstance.INSTANCE;
                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getHigh(composer2, 6)))}, function19, composer2, ((i117 >> 3) & 112) | 8);
                            composer2.endReplaceableGroup();
                            composer2.endNode();
                            composer2.endReplaceableGroup();
                            composer2.endReplaceableGroup();
                        ...
                        TextKt.ProvideTextStyle(MaterialTheme.INSTANCE.getTypography(composer2, 6).getH6(), ComposableLambdaKt.composableLambda(composer2, -2021518195, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1$2$1
                            ...
                            public final void invoke(@Nullable Composer composer3, int i119) {
                                ...
                                CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getHigh(composer3, 6)))}, function110, composer3, ((i118 << 3) & 112) | 8);
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventEnd();
                                }
                            }
                        ...
                        composer2.endReplaceableGroup();
                        ProvidedValue[] providedValueArr = {ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getMedium(composer2, 6)))};
                        final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function111 = function3M1062getLambda1$material_release;
                        final int i119 = i3;
                        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer2, 1157662914, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1.3
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            ...
                            public final void invoke(@Nullable Composer composer3, int i1110) {
                                ...
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventStart(1157662914, i1110, -1, "androidx.compose.material.TopAppBar.<anonymous>.<anonymous> (AppBar.kt:116)");
                                }
                                Modifier modifierFillMaxHeight$default = SizeKt.fillMaxHeight$default(Modifier.INSTANCE, 0.0f, 1, null);
                                Arrangement.Horizontal end = Arrangement.INSTANCE.getEnd();
                                Alignment.Vertical centerVertically3 = Alignment.INSTANCE.getCenterVertically();
                                Function3<RowScope, Composer, Integer, Unit> function112 = function111;
                                int i20 = (i119 & 7168) | 438;
                                composer3.startReplaceableGroup(693286680);
                                int i21 = i20 >> 3;
                                MeasurePolicy measurePolicyRowMeasurePolicy = RowKt.rowMeasurePolicy(end, centerVertically3, composer3, (i21 & 112) | (i21 & 14));
                                composer3.startReplaceableGroup(-1323940314);
                                ...
                                androidx.compose.animation.OooOO0.OooO00o((i22 >> 3) & 112, function3ModifierMaterializerOf3, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer3)), composer3, 2058660585);
                                function112.invoke(RowScopeInstance.INSTANCE, composer3, Integer.valueOf(((i20 >> 6) & 112) | 6));
                                composer3.endReplaceableGroup();
                                composer3.endNode();
                                composer3.endReplaceableGroup();
                                composer3.endReplaceableGroup();
                    ...
                    public final void invoke(@NotNull RowScope AppBar, @Nullable Composer composer2, int i116) {
                        ...
                        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer2, 1157662914, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1.3
                            ...
                            public final void invoke(@Nullable Composer composer3, int i1111) {
                                ...
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventStart(1157662914, i1111, -1, "androidx.compose.material.TopAppBar.<anonymous>.<anonymous> (AppBar.kt:116)");
                                }
                                Modifier modifierFillMaxHeight$default = SizeKt.fillMaxHeight$default(Modifier.INSTANCE, 0.0f, 1, null);
                                Arrangement.Horizontal end = Arrangement.INSTANCE.getEnd();
                                Alignment.Vertical centerVertically3 = Alignment.INSTANCE.getCenterVertically();
                                Function3<RowScope, Composer, Integer, Unit> function112 = function111;
                                int i20 = (i1110 & 7168) | 438;
                                composer3.startReplaceableGroup(693286680);
                                int i21 = i20 >> 3;
                                MeasurePolicy measurePolicyRowMeasurePolicy = RowKt.rowMeasurePolicy(end, centerVertically3, composer3, (i21 & 112) | (i21 & 14));
                                composer3.startReplaceableGroup(-1323940314);
            ...
            final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function110 = function3M1062getLambda1$material_release;
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$2
                ...
                public final void invoke(@Nullable Composer composer2, int i116) {
                    AppBarKt.m971TopAppBarxWeB9s(title, modifier10, function19, function110, j18, j19, f3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
        i3 |= 3072;
            ...
            m968AppBarcelAv9A(primarySurface, j5, fM967getTopAppBarElevationD9Ej5fM, AppBarDefaults.INSTANCE.getContentPadding(), RectangleShapeKt.getRectangleShape(), modifier2, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1484077694, true, new Function3<RowScope, Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1
                ...
                public final void invoke(@NotNull RowScope AppBar, @Nullable Composer composer2, int i117) {
                    ...
                    if (function6 == null) {
                        ...
                        ComposeUiNode.Companion companion = ComposeUiNode.INSTANCE;
                        Function0<ComposeUiNode> constructor = companion.getConstructor();
                        Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3ModifierMaterializerOf = LayoutKt.modifierMaterializerOf(modifier11);
                        if (!(composer2.getApplier() instanceof Applier)) {
                            ComposablesKt.invalidApplier();
                        }
                        composer2.startReusableNode();
                        ...
                        androidx.compose.animation.OooOO0.OooO00o(0, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer2)), composer2, 2058660585);
                        RowScopeInstance rowScopeInstance = RowScopeInstance.INSTANCE;
                        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getHigh(composer2, 6)))}, function111, composer2, ((i119 >> 3) & 112) | 8);
                        composer2.endReplaceableGroup();
                        composer2.endNode();
                        composer2.endReplaceableGroup();
                        composer2.endReplaceableGroup();
                    ...
                    TextKt.ProvideTextStyle(MaterialTheme.INSTANCE.getTypography(composer2, 6).getH6(), ComposableLambdaKt.composableLambda(composer2, -2021518195, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1$2$1
                        ...
                        public final void invoke(@Nullable Composer composer3, int i1111) {
                            ...
                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getHigh(composer3, 6)))}, function112, composer3, ((i1110 << 3) & 112) | 8);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                            }
                        }
                    ...
                    composer2.endReplaceableGroup();
                    ProvidedValue[] providedValueArr = {ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getMedium(composer2, 6)))};
                    final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function113 = function3M1062getLambda1$material_release;
                    final int i1111 = i3;
                    CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer2, 1157662914, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1.3
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        /* JADX WARN: Multi-variable type inference failed */
                        ...
                        public final void invoke(@Nullable Composer composer3, int i1112) {
                            ...
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventStart(1157662914, i1112, -1, "androidx.compose.material.TopAppBar.<anonymous>.<anonymous> (AppBar.kt:116)");
                            }
                            Modifier modifierFillMaxHeight$default = SizeKt.fillMaxHeight$default(Modifier.INSTANCE, 0.0f, 1, null);
                            Arrangement.Horizontal end = Arrangement.INSTANCE.getEnd();
                            Alignment.Vertical centerVertically3 = Alignment.INSTANCE.getCenterVertically();
                            Function3<RowScope, Composer, Integer, Unit> function114 = function113;
                            int i20 = (i1111 & 7168) | 438;
                            composer3.startReplaceableGroup(693286680);
                            int i21 = i20 >> 3;
                            MeasurePolicy measurePolicyRowMeasurePolicy = RowKt.rowMeasurePolicy(end, centerVertically3, composer3, (i21 & 112) | (i21 & 14));
                            composer3.startReplaceableGroup(-1323940314);
                            ...
                            androidx.compose.animation.OooOO0.OooO00o((i22 >> 3) & 112, function3ModifierMaterializerOf3, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer3)), composer3, 2058660585);
                            function114.invoke(RowScopeInstance.INSTANCE, composer3, Integer.valueOf(((i20 >> 6) & 112) | 6));
                            composer3.endReplaceableGroup();
                            composer3.endNode();
                            composer3.endReplaceableGroup();
                            composer3.endReplaceableGroup();
                ...
                public final void invoke(@NotNull RowScope AppBar, @Nullable Composer composer2, int i118) {
                    ...
                    CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer2, 1157662914, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1.3
                        ...
                        public final void invoke(@Nullable Composer composer3, int i1113) {
                            ...
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventStart(1157662914, i1113, -1, "androidx.compose.material.TopAppBar.<anonymous>.<anonymous> (AppBar.kt:116)");
                            }
                            Modifier modifierFillMaxHeight$default = SizeKt.fillMaxHeight$default(Modifier.INSTANCE, 0.0f, 1, null);
                            Arrangement.Horizontal end = Arrangement.INSTANCE.getEnd();
                            Alignment.Vertical centerVertically3 = Alignment.INSTANCE.getCenterVertically();
                            Function3<RowScope, Composer, Integer, Unit> function114 = function113;
                            int i20 = (i1112 & 7168) | 438;
                            composer3.startReplaceableGroup(693286680);
                            int i21 = i20 >> 3;
                            MeasurePolicy measurePolicyRowMeasurePolicy = RowKt.rowMeasurePolicy(end, centerVertically3, composer3, (i21 & 112) | (i21 & 14));
                            composer3.startReplaceableGroup(-1323940314);
        ...
        final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function112 = function3M1062getLambda1$material_release;
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$2
            ...
            public final void invoke(@Nullable Composer composer2, int i118) {
                AppBarKt.m971TopAppBarxWeB9s(title, modifier11, function111, function112, j110, j111, f3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
