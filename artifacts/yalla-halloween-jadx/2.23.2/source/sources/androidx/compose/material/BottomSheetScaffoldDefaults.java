...
public final class BottomSheetScaffoldDefaults {
    ...
    private static final float SheetElevation = Dp.m3775constructorimpl(8);
    private static final float SheetPeekHeight = Dp.m3775constructorimpl(56);

    private BottomSheetScaffoldDefaults() {
    }

    /* JADX INFO: renamed from: getSheetElevation-D9Ej5fM, reason: not valid java name */
    public final float m994getSheetElevationD9Ej5fM() {
