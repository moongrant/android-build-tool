...
public final class ContentAlpha {
    ...
    private final float contentAlpha(float f, float f2, Composer composer, int i) {
        ...
        long jM1691unboximpl = ((Color) composer.consume(ContentColorKt.getLocalContentColor())).m1691unboximpl();
        if (!MaterialTheme.INSTANCE.getColors(composer, 6).isLight() ? ColorKt.m1733luminance8_81llA(jM1691unboximpl) >= 0.5d : ColorKt.m1733luminance8_81llA(jM1691unboximpl) <= 0.5d) {
            f = f2;
        }
        if (ComposerKt.isTraceInProgress()) {
