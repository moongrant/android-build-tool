...
final class DefaultSelectableChipColors implements SelectableChipColors {
    ...
    public State<Color> backgroundColor(boolean z, boolean z2, @Nullable Composer composer, int i) {
        ...
        if (z) {
            j = !z2 ? this.backgroundColor : this.selectedBackgroundColor;
        } else {
    ...
    public State<Color> contentColor(boolean z, boolean z2, @Nullable Composer composer, int i) {
        ...
        if (z) {
            j = !z2 ? this.contentColor : this.selectedContentColor;
        } else {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Color.m1682equalsimpl0(this.backgroundColor, defaultSelectableChipColors.backgroundColor) && Color.m1682equalsimpl0(this.contentColor, defaultSelectableChipColors.contentColor) && Color.m1682equalsimpl0(this.leadingIconColor, defaultSelectableChipColors.leadingIconColor) && Color.m1682equalsimpl0(this.disabledBackgroundColor, defaultSelectableChipColors.disabledBackgroundColor) && Color.m1682equalsimpl0(this.disabledContentColor, defaultSelectableChipColors.disabledContentColor) && Color.m1682equalsimpl0(this.disabledLeadingIconColor, defaultSelectableChipColors.disabledLeadingIconColor) && Color.m1682equalsimpl0(this.selectedBackgroundColor, defaultSelectableChipColors.selectedBackgroundColor) && Color.m1682equalsimpl0(this.selectedContentColor, defaultSelectableChipColors.selectedContentColor) && Color.m1682equalsimpl0(this.selectedLeadingIconColor, defaultSelectableChipColors.selectedLeadingIconColor);
    }

    public int hashCode() {
        return Color.m1688hashCodeimpl(this.selectedLeadingIconColor) + OooO.OooO00o(this.selectedContentColor, OooO.OooO00o(this.selectedBackgroundColor, OooO.OooO00o(this.disabledLeadingIconColor, OooO.OooO00o(this.disabledContentColor, OooO.OooO00o(this.disabledBackgroundColor, OooO.OooO00o(this.leadingIconColor, OooO.OooO00o(this.contentColor, Color.m1688hashCodeimpl(this.backgroundColor) * 31, 31), 31), 31), 31), 31), 31), 31);
    }
    ...
    public State<Color> leadingIconColor(boolean z, boolean z2, @Nullable Composer composer, int i) {
        ...
        if (z) {
            j = !z2 ? this.leadingIconColor : this.selectedLeadingIconColor;
        } else {
