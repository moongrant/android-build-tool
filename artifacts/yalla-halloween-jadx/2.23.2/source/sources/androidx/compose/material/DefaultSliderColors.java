...
final class DefaultSliderColors implements SliderColors {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Color.m1682equalsimpl0(this.thumbColor, defaultSliderColors.thumbColor) && Color.m1682equalsimpl0(this.disabledThumbColor, defaultSliderColors.disabledThumbColor) && Color.m1682equalsimpl0(this.activeTrackColor, defaultSliderColors.activeTrackColor) && Color.m1682equalsimpl0(this.inactiveTrackColor, defaultSliderColors.inactiveTrackColor) && Color.m1682equalsimpl0(this.disabledActiveTrackColor, defaultSliderColors.disabledActiveTrackColor) && Color.m1682equalsimpl0(this.disabledInactiveTrackColor, defaultSliderColors.disabledInactiveTrackColor) && Color.m1682equalsimpl0(this.activeTickColor, defaultSliderColors.activeTickColor) && Color.m1682equalsimpl0(this.inactiveTickColor, defaultSliderColors.inactiveTickColor) && Color.m1682equalsimpl0(this.disabledActiveTickColor, defaultSliderColors.disabledActiveTickColor) && Color.m1682equalsimpl0(this.disabledInactiveTickColor, defaultSliderColors.disabledInactiveTickColor);
    }

    public int hashCode() {
        return Color.m1688hashCodeimpl(this.disabledInactiveTickColor) + OooO.OooO00o(this.disabledActiveTickColor, OooO.OooO00o(this.inactiveTickColor, OooO.OooO00o(this.activeTickColor, OooO.OooO00o(this.disabledInactiveTrackColor, OooO.OooO00o(this.disabledActiveTrackColor, OooO.OooO00o(this.inactiveTrackColor, OooO.OooO00o(this.activeTrackColor, OooO.OooO00o(this.disabledThumbColor, Color.m1688hashCodeimpl(this.thumbColor) * 31, 31), 31), 31), 31), 31), 31), 31), 31);
    }
    ...
    public State<Color> thumbColor(boolean z, @Nullable Composer composer, int i) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1671boximpl(z ? this.thumbColor : this.disabledThumbColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
