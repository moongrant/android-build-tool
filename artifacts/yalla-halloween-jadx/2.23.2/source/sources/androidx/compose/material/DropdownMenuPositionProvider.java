...
public final /* data */ class DropdownMenuPositionProvider implements PopupPositionProvider {
    ...
    public static /* synthetic */ DropdownMenuPositionProvider m1091copyrOJDEFc$default(DropdownMenuPositionProvider dropdownMenuPositionProvider, long j, Density density, Function2 function2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return dropdownMenuPositionProvider.m1093copyrOJDEFc(j, density, function2);
    }
    ...
    public long mo882calculatePositionllwVHH4(@NotNull IntRect anchorBounds, long windowSize, @NotNull LayoutDirection layoutDirection, long popupContentSize) {
        ...
        int iMo320roundToPx0680j_4 = this.density.mo320roundToPx0680j_4(MenuKt.getMenuVerticalMargin());
        int iMo320roundToPx0680j_5 = this.density.mo320roundToPx0680j_4(DpOffset.m3836getXD9Ej5fM(this.contentOffset));
        int iMo320roundToPx0680j_6 = this.density.mo320roundToPx0680j_4(DpOffset.m3838getYD9Ej5fM(this.contentOffset));
        int left = anchorBounds.getLeft() + iMo320roundToPx0680j_5;
        int right = (anchorBounds.getRight() - iMo320roundToPx0680j_5) - IntSize.m3935getWidthimpl(popupContentSize);
        int iM3935getWidthimpl = IntSize.m3935getWidthimpl(windowSize) - IntSize.m3935getWidthimpl(popupContentSize);
        if (layoutDirection == LayoutDirection.Ltr) {
            Integer[] numArr = new Integer[3];
            numArr[0] = Integer.valueOf(left);
            numArr[1] = Integer.valueOf(right);
            if (anchorBounds.getLeft() < 0) {
                iM3935getWidthimpl = 0;
            }
            numArr[2] = Integer.valueOf(iM3935getWidthimpl);
            sequenceSequenceOf = SequencesKt.sequenceOf(numArr);
        } else {
            Integer[] numArr2 = new Integer[3];
            numArr2[0] = Integer.valueOf(right);
            numArr2[1] = Integer.valueOf(left);
            if (anchorBounds.getRight() <= IntSize.m3935getWidthimpl(windowSize)) {
                iM3935getWidthimpl = 0;
            }
            numArr2[2] = Integer.valueOf(iM3935getWidthimpl);
        ...
        } while (!(iIntValue >= 0 && IntSize.m3935getWidthimpl(popupContentSize) + iIntValue <= IntSize.m3935getWidthimpl(windowSize)));
        Integer num = (Integer) next;
        if (num != null) {
            right = num.intValue();
        }
        int iMax = Math.max(anchorBounds.getBottom() + iMo320roundToPx0680j_6, iMo320roundToPx0680j_4);
        int top = (anchorBounds.getTop() - iMo320roundToPx0680j_6) - IntSize.m3934getHeightimpl(popupContentSize);
        for (Object obj2 : SequencesKt.sequenceOf(Integer.valueOf(iMax), Integer.valueOf(top), Integer.valueOf(anchorBounds.getTop() - (IntSize.m3934getHeightimpl(popupContentSize) / 2)), Integer.valueOf((IntSize.m3934getHeightimpl(windowSize) - IntSize.m3934getHeightimpl(popupContentSize)) - iMo320roundToPx0680j_4))) {
            int iIntValue2 = ((Number) obj2).intValue();
            if (iIntValue2 >= iMo320roundToPx0680j_4 && IntSize.m3934getHeightimpl(popupContentSize) + iIntValue2 <= IntSize.m3934getHeightimpl(windowSize) - iMo320roundToPx0680j_4) {
                obj = obj2;
                break;
            }
        }
        ...
        this.onPositionCalculated.invoke(anchorBounds, new IntRect(right, top, IntSize.m3935getWidthimpl(popupContentSize) + right, IntSize.m3934getHeightimpl(popupContentSize) + top));
    ...
    public final DropdownMenuPositionProvider m1093copyrOJDEFc(long contentOffset, @NotNull Density density, @NotNull Function2<? super IntRect, ? super IntRect, Unit> onPositionCalculated) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return DpOffset.m3835equalsimpl0(this.contentOffset, dropdownMenuPositionProvider.contentOffset) && Intrinsics.areEqual(this.density, dropdownMenuPositionProvider.density) && Intrinsics.areEqual(this.onPositionCalculated, dropdownMenuPositionProvider.onPositionCalculated);
    }

    /* JADX INFO: renamed from: getContentOffset-RKDOV3M, reason: not valid java name */
    public final long m1094getContentOffsetRKDOV3M() {
        return this.contentOffset;
    }
    ...
    public int hashCode() {
        return this.onPositionCalculated.hashCode() + ((this.density.hashCode() + (DpOffset.m3840hashCodeimpl(this.contentOffset) * 31)) * 31);
    }

    @NotNull
    public String toString() {
        return "DropdownMenuPositionProvider(contentOffset=" + ((Object) DpOffset.m3843toStringimpl(this.contentOffset)) + ", density=" + this.density + ", onPositionCalculated=" + this.onPositionCalculated + ')';
    }
