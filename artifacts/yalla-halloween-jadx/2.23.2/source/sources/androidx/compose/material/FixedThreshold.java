...
public final /* data */ class FixedThreshold implements ThresholdConfig {
    ...
    public static /* synthetic */ FixedThreshold m1112copy0680j_4$default(FixedThreshold fixedThreshold, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            f = fixedThreshold.offset;
        }
        return fixedThreshold.m1113copy0680j_4(f);
    }

    @Override // androidx.compose.material.ThresholdConfig
    public float computeThreshold(@NotNull Density density, float f, float f2) {
        Intrinsics.checkNotNullParameter(density, "<this>");
        return (Math.signum(f2 - f) * density.mo326toPx0680j_4(this.offset)) + f;
    }

    @NotNull
    /* JADX INFO: renamed from: copy-0680j_4, reason: not valid java name */
    public final FixedThreshold m1113copy0680j_4(float offset) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return (other instanceof FixedThreshold) && Dp.m3780equalsimpl0(this.offset, ((FixedThreshold) other).offset);
    }

    public int hashCode() {
        return Dp.m3781hashCodeimpl(this.offset);
    }

    @NotNull
    public String toString() {
        return "FixedThreshold(offset=" + ((Object) Dp.m3786toStringimpl(this.offset)) + ')';
    }
