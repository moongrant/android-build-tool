...
public final class FloatingActionButtonDefaults {
    ...
    public final /* synthetic */ FloatingActionButtonElevation m1114elevationixp7dh8(float f, float f2, Composer composer, int i, int i2) {
        composer.startReplaceableGroup(-654132828);
        float fM3775constructorimpl = (i2 & 1) != 0 ? Dp.m3775constructorimpl(6) : f;
        float fM3775constructorimpl2 = (i2 & 2) != 0 ? Dp.m3775constructorimpl(12) : f2;
        ...
        float f3 = 8;
        FloatingActionButtonElevation floatingActionButtonElevationM1115elevationxZ9QkE = m1115elevationxZ9QkE(fM3775constructorimpl, fM3775constructorimpl2, Dp.m3775constructorimpl(f3), Dp.m3775constructorimpl(f3), composer, (i & 14) | 3456 | (i & 112) | ((i << 6) & 57344), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return floatingActionButtonElevationM1115elevationxZ9QkE;
    }

    @Composable
    @NotNull
    /* JADX INFO: renamed from: elevation-xZ9-QkE, reason: not valid java name */
    public final FloatingActionButtonElevation m1115elevationxZ9QkE(float f, float f2, float f3, float f4, @Nullable Composer composer, int i, int i2) {
        composer.startReplaceableGroup(380403812);
        if ((i2 & 1) != 0) {
            f = Dp.m3775constructorimpl(6);
        }
        float f5 = f;
        if ((i2 & 2) != 0) {
            f2 = Dp.m3775constructorimpl(12);
        }
        float f6 = f2;
        if ((i2 & 4) != 0) {
            f3 = Dp.m3775constructorimpl(8);
        }
        float f7 = f3;
        if ((i2 & 8) != 0) {
            f4 = Dp.m3775constructorimpl(8);
        }
        float f8 = f4;
        if (ComposerKt.isTraceInProgress()) {
        ...
        Object[] objArr = {Dp.m3773boximpl(f5), Dp.m3773boximpl(f6), Dp.m3773boximpl(f7), Dp.m3773boximpl(f8)};
