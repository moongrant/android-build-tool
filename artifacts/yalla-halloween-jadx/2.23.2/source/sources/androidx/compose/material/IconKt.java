...
public final class IconKt {
    ...
    @NotNull
    private static final Modifier DefaultIconSizeModifier = SizeKt.m525size3ABfNKs(Modifier.INSTANCE, Dp.m3775constructorimpl(24));

    @ComposableTarget(applier = "androidx.compose.ui.UiComposable")
    @Composable
    /* JADX INFO: renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m1120Iconww6aTOc(@NotNull ImageVector imageVector, @Nullable String str, @Nullable Modifier modifier, long j, @Nullable Composer composer, int i, int i2) {
        Intrinsics.checkNotNullParameter(imageVector, "imageVector");
        composer.startReplaceableGroup(-800853103);
        Modifier modifier2 = (i2 & 4) != 0 ? Modifier.INSTANCE : modifier;
        long jM1680copywmQWz5c$default = (i2 & 8) != 0 ? Color.m1680copywmQWz5c$default(((Color) composer.consume(ContentColorKt.getLocalContentColor())).m1691unboximpl(), ((Number) composer.consume(ContentAlphaKt.getLocalContentAlpha())).floatValue(), 0.0f, 0.0f, 0.0f, 14, null) : j;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-800853103, i, -1, "androidx.compose.material.Icon (Icon.kt:61)");
        }
        m1119Iconww6aTOc(VectorPainterKt.rememberVectorPainter(imageVector, composer, i & 14), str, modifier2, jM1680copywmQWz5c$default, composer, VectorPainter.$stable | (i & 112) | (i & 896) | (i & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    private static final Modifier defaultSizeFor(Modifier modifier, Painter painter) {
        return modifier.then((Size.m1512equalsimpl0(painter.getIntrinsicSize(), Size.INSTANCE.m1524getUnspecifiedNHjbRc()) || m1121isInfiniteuvyYCjk(painter.getIntrinsicSize())) ? DefaultIconSizeModifier : Modifier.INSTANCE);
    }

    /* JADX INFO: renamed from: isInfinite-uvyYCjk, reason: not valid java name */
    private static final boolean m1121isInfiniteuvyYCjk(long j) {
        return Float.isInfinite(Size.m1516getWidthimpl(j)) && Float.isInfinite(Size.m1513getHeightimpl(j));
    }

    @ComposableTarget(applier = "androidx.compose.ui.UiComposable")
    @Composable
    /* JADX INFO: renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m1118Iconww6aTOc(@NotNull ImageBitmap bitmap, @Nullable String str, @Nullable Modifier modifier, long j, @Nullable Composer composer, int i, int i2) {
        ...
        composer.endReplaceableGroup();
        m1119Iconww6aTOc((BitmapPainter) objRememberedValue, str, modifier2, jM1680copywmQWz5c$default, composer, (i & 112) | 8 | (i & 896) | (i & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    @Composable
    /* JADX INFO: renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m1119Iconww6aTOc(@NotNull final Painter painter, @Nullable final String str, @Nullable Modifier modifier, long j, @Nullable Composer composer, final int i, final int i2) {
        ...
        ColorFilter colorFilterM1722tintxETnrds$default = Color.m1682equalsimpl0(jM1680copywmQWz5c$default, Color.INSTANCE.m1717getUnspecified0d7_KjU()) ? null : ColorFilter.Companion.m1722tintxETnrds$default(ColorFilter.INSTANCE, jM1680copywmQWz5c$default, 0, 2, null);
            ...
            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material.IconKt$Icon$semantics$1$1
                    ...
                    public final void invoke2(@NotNull SemanticsPropertyReceiver semantics) {
                        ...
                        SemanticsPropertiesKt.m3179setRolekuIjeqM(semantics, Role.INSTANCE.m3168getImageo7Vup1c());
                    }
                };
        ...
        composerStartRestartGroup.endReplaceableGroup();
        final long j2 = jM1680copywmQWz5c$default;
        BoxKt.Box(PainterModifierKt.paint$default(defaultSizeFor(GraphicsLayerModifierKt.toolingGraphicsLayer(modifier2), painter), painter, false, null, ContentScale.INSTANCE.getFit(), 0.0f, colorFilterM1722tintxETnrds$default, 22, null).then(modifierSemantics$default), composerStartRestartGroup, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.IconKt$Icon$1
            ...
            public final void invoke(@Nullable Composer composer2, int i4) {
                IconKt.m1119Iconww6aTOc(painter, str, modifier3, j2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
}
