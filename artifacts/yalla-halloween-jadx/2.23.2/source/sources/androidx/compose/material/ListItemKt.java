...
public final class ListItemKt {
    ...
    public static final void BaselinesOffsetColumn(final List<Dp> list, Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i, final int i2) {
        ...
        MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material.ListItemKt.BaselinesOffsetColumn.1
            ...
            public final MeasureResult mo3measure3p2s80s(@NotNull MeasureScope Layout, @NotNull List<? extends Measurable> measurables, long j) {
                ...
                long jM3734copyZbe2FdA$default = Constraints.m3734copyZbe2FdA$default(j, 0, 0, 0, Integer.MAX_VALUE, 3, null);
                ...
                for (int i4 = 0; i4 < size2; i4++) {
                    ...
                    int iMax2 = Math.max(0, (Layout.mo320roundToPx0680j_4(list2.get(i4).m3789unboximpl()) - placeable.get(AlignmentLineKt.getFirstBaseline())) - height);
    ...
    public static final void m1122OffsetToBaselineOrCenterKz89ssw(final float f, Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i, final int i2) {
        int i3;
        ...
        if ((i3 & 731) == 146 && composerStartRestartGroup.getSkipping()) {
            ...
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material.ListItemKt$OffsetToBaselineOrCenter$1
                ...
                public final MeasureResult mo3measure3p2s80s(@NotNull MeasureScope Layout, @NotNull List<? extends Measurable> measurables, long j) {
                    int iMax;
                    final int iM3894getYimpl;
                    Intrinsics.checkNotNullParameter(Layout, "$this$Layout");
                    Intrinsics.checkNotNullParameter(measurables, "measurables");
                    final Placeable placeableMo2804measureBRTryo0 = measurables.get(0).mo2804measureBRTryo0(Constraints.m3734copyZbe2FdA$default(j, 0, 0, 0, 0, 11, null));
                    int i5 = placeableMo2804measureBRTryo0.get(AlignmentLineKt.getFirstBaseline());
                    if (i5 != Integer.MIN_VALUE) {
                        iM3894getYimpl = Layout.mo320roundToPx0680j_4(f) - i5;
                        iMax = Math.max(Constraints.m3744getMinHeightimpl(j), placeableMo2804measureBRTryo0.getHeight() + iM3894getYimpl);
                    } else {
                        iMax = Math.max(Constraints.m3744getMinHeightimpl(j), placeableMo2804measureBRTryo0.getHeight());
                        iM3894getYimpl = IntOffset.m3894getYimpl(Alignment.INSTANCE.getCenter().mo1337alignKFBX0sM(IntSize.INSTANCE.m3940getZeroYbymL2g(), IntSizeKt.IntSize(0, iMax - placeableMo2804measureBRTryo0.getHeight()), Layout.getLayoutDirection()));
                    }
                    return MeasureScope.CC.OooOOo0(Layout, placeableMo2804measureBRTryo0.getWidth(), iMax, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.ListItemKt$OffsetToBaselineOrCenter$1$measure$1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
                        ...
                        public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                            Intrinsics.checkNotNullParameter(layout, "$this$layout");
                            Placeable.PlacementScope.placeRelative$default(layout, placeableMo2804measureBRTryo0, 0, iM3894getYimpl, 0.0f, 4, null);
                        }
                    }, 4, null);
                }
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ListItemKt$OffsetToBaselineOrCenter$2
            ...
            public final void invoke(@Nullable Composer composer2, int i6) {
                ListItemKt.m1122OffsetToBaselineOrCenterKz89ssw(f, modifier2, function2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
