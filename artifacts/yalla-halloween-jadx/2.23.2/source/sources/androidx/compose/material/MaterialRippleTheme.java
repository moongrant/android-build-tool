...
final class MaterialRippleTheme implements RippleTheme {
    ...
    public long mo1124defaultColorWaAFU9c(@Nullable Composer composer, int i) {
        ...
        long jM1290defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m1290defaultRippleColor5vOe2sY(((Color) composer.consume(ContentColorKt.getLocalContentColor())).m1691unboximpl(), MaterialTheme.INSTANCE.getColors(composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
    ...
    public RippleAlpha rippleAlpha(@Nullable Composer composer, int i) {
        ...
        RippleAlpha rippleAlphaM1289defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m1289defaultRippleAlphaDxMtmZc(((Color) composer.consume(ContentColorKt.getLocalContentColor())).m1691unboximpl(), MaterialTheme.INSTANCE.getColors(composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
