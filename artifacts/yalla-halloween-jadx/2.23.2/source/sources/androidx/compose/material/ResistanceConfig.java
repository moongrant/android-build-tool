...
public final class ResistanceConfig {
    ...
    public int hashCode() {
        return Float.floatToIntBits(this.factorAtMax) + o0OoOo0.OooO00o(this.factorAtMin, Float.floatToIntBits(this.basis) * 31, 31);
    }
    ...
    public String toString() {
        ...
        return androidx.compose.animation.OooO00o.OooO00o(sb, this.factorAtMax, ')');
    }
