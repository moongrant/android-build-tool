...
public final class SnackbarDefaults {
    ...
    public final long getBackgroundColor(@Nullable Composer composer, int i) {
        ...
        long jM1726compositeOverOWjLjI = ColorKt.m1726compositeOverOWjLjI(Color.m1680copywmQWz5c$default(materialTheme.getColors(composer, 6).m1038getOnSurface0d7_KjU(), SnackbarOverlayAlpha, 0.0f, 0.0f, 0.0f, 14, null), materialTheme.getColors(composer, 6).m1043getSurface0d7_KjU());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return jM1726compositeOverOWjLjI;
    }

    @Composable
    @JvmName(name = "getPrimaryActionColor")
    public final long getPrimaryActionColor(@Nullable Composer composer, int i) {
        long jM1040getPrimaryVariant0d7_KjU;
        ...
        if (colors.isLight()) {
            jM1040getPrimaryVariant0d7_KjU = ColorKt.m1726compositeOverOWjLjI(Color.m1680copywmQWz5c$default(colors.m1043getSurface0d7_KjU(), 0.6f, 0.0f, 0.0f, 0.0f, 14, null), colors.m1039getPrimary0d7_KjU());
        } else {
            jM1040getPrimaryVariant0d7_KjU = colors.m1040getPrimaryVariant0d7_KjU();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return jM1040getPrimaryVariant0d7_KjU;
    }
}
