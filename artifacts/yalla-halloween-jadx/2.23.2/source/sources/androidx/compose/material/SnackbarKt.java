...
public final class SnackbarKt {
    ...
    private static final float HeightToFirstLine = Dp.m3775constructorimpl(30);
    private static final float HorizontalSpacing = Dp.m3775constructorimpl(16);
    private static final float SeparateButtonExtraY = Dp.m3775constructorimpl(2);
    private static final float SnackbarVerticalPadding = Dp.m3775constructorimpl(6);
    private static final float LongButtonVerticalOffset = Dp.m3775constructorimpl(12);
    private static final float SnackbarMinHeightOneLine = Dp.m3775constructorimpl(48);
    private static final float SnackbarMinHeightTwoLines = Dp.m3775constructorimpl(68);

    static {
        float f = 8;
        HorizontalSpacingButtonSide = Dp.m3775constructorimpl(f);
        TextEndExtraSpacing = Dp.m3775constructorimpl(f);
    }
    ...
    public static final void NewLineButtonSnackbar(final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function3, Composer composer, final int i) {
        ...
        if ((i2 & 91) == 18 && composerStartRestartGroup.getSkipping()) {
            ...
            Modifier modifierM482paddingqDBjuR0$default = PaddingKt.m482paddingqDBjuR0$default(modifierFillMaxWidth$default, f, 0.0f, f2, SeparateButtonExtraY, 2, null);
            ...
            Modifier modifierM482paddingqDBjuR0$default2 = PaddingKt.m482paddingqDBjuR0$default(AlignmentLineKt.m366paddingFromBaselineVpY3zN4(companion, HeightToFirstLine, LongButtonVerticalOffset), 0.0f, 0.0f, f2, 0.0f, 11, null);
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt.NewLineButtonSnackbar.2
            ...
            public final void invoke(@Nullable Composer composer2, int i3) {
                SnackbarKt.NewLineButtonSnackbar(function2, function3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    public static final void OneRowSnackbar(final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function3, Composer composer, final int i) {
        ...
        if ((i2 & 91) == 18 && composerStartRestartGroup.getSkipping()) {
            ...
            Modifier.Companion companion = Modifier.INSTANCE;
            Modifier modifierM482paddingqDBjuR0$default = PaddingKt.m482paddingqDBjuR0$default(companion, HorizontalSpacing, 0.0f, HorizontalSpacingButtonSide, 0.0f, 10, null);
                ...
                public final MeasureResult mo3measure3p2s80s(@NotNull MeasureScope Layout, @NotNull List<? extends Measurable> measurables, long j) {
                    ...
                    for (Measurable measurable : measurables) {
                        if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), str3)) {
                            ...
                            int iCoerceAtLeast = RangesKt.coerceAtLeast((Constraints.m3743getMaxWidthimpl(j) - placeableMo2804measureBRTryo0.getWidth()) - Layout.mo320roundToPx0680j_4(SnackbarKt.TextEndExtraSpacing), Constraints.m3745getMinWidthimpl(j));
                            String str4 = str2;
                            for (Measurable measurable2 : measurables) {
                                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), str4)) {
                                    final Placeable placeableMo2804measureBRTryo1 = measurable2.mo2804measureBRTryo0(Constraints.m3734copyZbe2FdA$default(j, 0, iCoerceAtLeast, 0, 0, 9, null));
                                    int i4 = placeableMo2804measureBRTryo1.get(androidx.compose.ui.layout.AlignmentLineKt.getFirstBaseline());
                                    if (!(i4 != Integer.MIN_VALUE)) {
                                        throw new IllegalArgumentException("No baselines for text".toString());
                                    }
                                    int i5 = placeableMo2804measureBRTryo1.get(androidx.compose.ui.layout.AlignmentLineKt.getLastBaseline());
                                    if (!(i5 != Integer.MIN_VALUE)) {
                                        throw new IllegalArgumentException("No baselines for text".toString());
                                    }
                                    boolean z = i4 == i5;
                                    final int iM3743getMaxWidthimpl = Constraints.m3743getMaxWidthimpl(j) - placeableMo2804measureBRTryo0.getWidth();
                                    if (z) {
                                        int iMax2 = Math.max(Layout.mo320roundToPx0680j_4(SnackbarKt.SnackbarMinHeightOneLine), placeableMo2804measureBRTryo0.getHeight());
                                        int height2 = (iMax2 - placeableMo2804measureBRTryo1.getHeight()) / 2;
                                        int i6 = placeableMo2804measureBRTryo0.get(androidx.compose.ui.layout.AlignmentLineKt.getFirstBaseline());
                                        int i7 = i6 != Integer.MIN_VALUE ? (i4 + height2) - i6 : 0;
                                        iMax = iMax2;
                                        height = i7;
                                        i3 = height2;
                                    } else {
                                        int iMo320roundToPx0680j_4 = Layout.mo320roundToPx0680j_4(SnackbarKt.HeightToFirstLine) - i4;
                                        iMax = Math.max(Layout.mo320roundToPx0680j_4(SnackbarKt.SnackbarMinHeightTwoLines), placeableMo2804measureBRTryo1.getHeight() + iMo320roundToPx0680j_4);
                                        i3 = iMo320roundToPx0680j_4;
                                        height = (iMax - placeableMo2804measureBRTryo0.getHeight()) / 2;
                                    }
                                    return MeasureScope.CC.OooOOo0(Layout, Constraints.m3743getMaxWidthimpl(j), iMax, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.SnackbarKt$OneRowSnackbar$2$measure$4
                                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                        {
                                            super(1);
                                        }
                                        ...
                                        public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                                            Intrinsics.checkNotNullParameter(layout, "$this$layout");
                                            Placeable.PlacementScope.placeRelative$default(layout, placeableMo2804measureBRTryo1, 0, i3, 0.0f, 4, null);
                                            Placeable.PlacementScope.placeRelative$default(layout, placeableMo2804measureBRTryo0, iM3743getMaxWidthimpl, height, 0.0f, 4, null);
                                        }
                                    }, 4, null);
                                }
                            }
            ...
            androidx.compose.animation.OooOO0.OooO00o(0, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composerStartRestartGroup)), composerStartRestartGroup, 2058660585);
            Modifier modifierM480paddingVpY3zN4$default = PaddingKt.m480paddingVpY3zN4$default(LayoutIdKt.layoutId(companion, ViewHierarchyConstants.TEXT_KEY), 0.0f, SnackbarVerticalPadding, 1, null);
            composerStartRestartGroup.startReplaceableGroup(733328855);
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt.OneRowSnackbar.3
            ...
            public final void invoke(@Nullable Composer composer2, int i3) {
                SnackbarKt.OneRowSnackbar(function2, function3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    public static final void m1183Snackbar7zSek6w(@Nullable Modifier modifier, @Nullable Function2<? super Composer, ? super Integer, Unit> function2, boolean z, @Nullable Shape shape, long j, long j2, float f, @NotNull final Function2<? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, final int i, final int i2) {
        int i3;
        ...
        if (i12 == 0) {
            ...
            if (i4 != 0) {
                ...
                if ((i & 458752) == 0) {
                    jM1043getSurface0d7_KjU = j2;
                    if ((i2 & 32) == 0 || !composerStartRestartGroup.changed(jM1043getSurface0d7_KjU)) {
                        i10 = 65536;
                    } else {
                        i10 = 131072;
                    }
                ...
                if ((i2 & 128) != 0) {
                    ...
                    if ((23967451 & i3) == 4793490 || !composerStartRestartGroup.getSkipping()) {
                        ...
                        if ((i & 1) != 0 || composerStartRestartGroup.getDefaultsInvalid()) {
                            ...
                            if (i6 != 0) {
                                fM3775constructorimpl = Dp.m3775constructorimpl(6);
                            }
                            ...
                            int i14 = i9 >> 6;
                            SurfaceKt.m1201SurfaceFjzlyU(modifier2, small, j4, jM1043getSurface0d7_KjU, null, fM3775constructorimpl, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -2084221700, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$1
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                /* JADX WARN: Multi-variable type inference failed */
                                {
                                    super(2);
                        ...
                        int i15 = i9 >> 6;
                        SurfaceKt.m1201SurfaceFjzlyU(modifier2, small, j5, jM1043getSurface0d7_KjU, null, fM3775constructorimpl, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -2084221700, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(2);
                    ...
                    scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$2
                        ...
                        public final void invoke(@Nullable Composer composer2, int i16) {
                            SnackbarKt.m1183Snackbar7zSek6w(modifier4, function4, z3, shape2, j6, j3, f3, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                        }
                    });
                }
                i8 = 12582912;
                ...
                if ((23967451 & i3) == 4793490) {
                    ...
                    int i16 = i9 >> 6;
                    SurfaceKt.m1201SurfaceFjzlyU(modifier2, small, j7, jM1043getSurface0d7_KjU, null, fM3775constructorimpl, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -2084221700, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        /* JADX WARN: Multi-variable type inference failed */
                        {
                            super(2);
                    ...
                    int i17 = i9 >> 6;
                    SurfaceKt.m1201SurfaceFjzlyU(modifier2, small, j8, jM1043getSurface0d7_KjU, null, fM3775constructorimpl, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -2084221700, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        /* JADX WARN: Multi-variable type inference failed */
                        {
                            super(2);
                ...
                scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$2
                    ...
                    public final void invoke(@Nullable Composer composer2, int i18) {
                        SnackbarKt.m1183Snackbar7zSek6w(modifier5, function5, z3, shape2, j9, j3, f3, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                    }
                });
            }
            i3 |= 384;
            ...
            if ((i2 & 128) != 0) {
                ...
                if ((23967451 & i3) == 4793490) {
                    ...
                    int i18 = i9 >> 6;
                    SurfaceKt.m1201SurfaceFjzlyU(modifier2, small, j10, jM1043getSurface0d7_KjU, null, fM3775constructorimpl, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -2084221700, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        /* JADX WARN: Multi-variable type inference failed */
                        {
                            super(2);
                    ...
                    int i19 = i9 >> 6;
                    SurfaceKt.m1201SurfaceFjzlyU(modifier2, small, j11, jM1043getSurface0d7_KjU, null, fM3775constructorimpl, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -2084221700, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        /* JADX WARN: Multi-variable type inference failed */
                        {
                            super(2);
                ...
                scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$2
                    ...
                    public final void invoke(@Nullable Composer composer2, int i110) {
                        SnackbarKt.m1183Snackbar7zSek6w(modifier6, function6, z3, shape2, j12, j3, f3, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                    }
                });
            }
            i8 = 12582912;
            ...
            if ((23967451 & i3) == 4793490) {
                ...
                int i110 = i9 >> 6;
                SurfaceKt.m1201SurfaceFjzlyU(modifier2, small, j13, jM1043getSurface0d7_KjU, null, fM3775constructorimpl, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -2084221700, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(2);
                ...
                int i111 = i9 >> 6;
                SurfaceKt.m1201SurfaceFjzlyU(modifier2, small, j14, jM1043getSurface0d7_KjU, null, fM3775constructorimpl, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -2084221700, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(2);
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$2
                ...
                public final void invoke(@Nullable Composer composer2, int i112) {
                    SnackbarKt.m1183Snackbar7zSek6w(modifier7, function7, z3, shape2, j15, j3, f3, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
        i3 |= 48;
        ...
        if (i4 != 0) {
            ...
            if ((i2 & 128) != 0) {
                ...
                if ((23967451 & i3) == 4793490) {
                    ...
                    int i112 = i9 >> 6;
                    SurfaceKt.m1201SurfaceFjzlyU(modifier2, small, j16, jM1043getSurface0d7_KjU, null, fM3775constructorimpl, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -2084221700, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        /* JADX WARN: Multi-variable type inference failed */
                        {
                            super(2);
                    ...
                    int i113 = i9 >> 6;
                    SurfaceKt.m1201SurfaceFjzlyU(modifier2, small, j17, jM1043getSurface0d7_KjU, null, fM3775constructorimpl, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -2084221700, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        /* JADX WARN: Multi-variable type inference failed */
                        {
                            super(2);
                ...
                scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$2
                    ...
                    public final void invoke(@Nullable Composer composer2, int i114) {
                        SnackbarKt.m1183Snackbar7zSek6w(modifier8, function8, z3, shape2, j18, j3, f3, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                    }
                });
            }
            i8 = 12582912;
            ...
            if ((23967451 & i3) == 4793490) {
                ...
                int i114 = i9 >> 6;
                SurfaceKt.m1201SurfaceFjzlyU(modifier2, small, j19, jM1043getSurface0d7_KjU, null, fM3775constructorimpl, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -2084221700, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(2);
                ...
                int i115 = i9 >> 6;
                SurfaceKt.m1201SurfaceFjzlyU(modifier2, small, j110, jM1043getSurface0d7_KjU, null, fM3775constructorimpl, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -2084221700, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(2);
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$2
                ...
                public final void invoke(@Nullable Composer composer2, int i116) {
                    SnackbarKt.m1183Snackbar7zSek6w(modifier9, function9, z3, shape2, j111, j3, f3, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
        i3 |= 384;
        ...
        if ((i2 & 128) != 0) {
            ...
            if ((23967451 & i3) == 4793490) {
                ...
                int i116 = i9 >> 6;
                SurfaceKt.m1201SurfaceFjzlyU(modifier2, small, j112, jM1043getSurface0d7_KjU, null, fM3775constructorimpl, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -2084221700, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(2);
                ...
                int i117 = i9 >> 6;
                SurfaceKt.m1201SurfaceFjzlyU(modifier2, small, j113, jM1043getSurface0d7_KjU, null, fM3775constructorimpl, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -2084221700, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(2);
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$2
                ...
                public final void invoke(@Nullable Composer composer2, int i118) {
                    SnackbarKt.m1183Snackbar7zSek6w(modifier10, function10, z3, shape2, j114, j3, f3, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
        i8 = 12582912;
        ...
        if ((23967451 & i3) == 4793490) {
            ...
            int i118 = i9 >> 6;
            SurfaceKt.m1201SurfaceFjzlyU(modifier2, small, j115, jM1043getSurface0d7_KjU, null, fM3775constructorimpl, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -2084221700, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
            ...
            int i119 = i9 >> 6;
            SurfaceKt.m1201SurfaceFjzlyU(modifier2, small, j116, jM1043getSurface0d7_KjU, null, fM3775constructorimpl, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -2084221700, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$2
            ...
            public final void invoke(@Nullable Composer composer2, int i1110) {
                SnackbarKt.m1183Snackbar7zSek6w(modifier11, function11, z3, shape2, j117, j3, f3, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
    ...
    public static final void m1184SnackbarsPrSdHI(@NotNull final SnackbarData snackbarData, @Nullable Modifier modifier, boolean z, @Nullable Shape shape, long j, long j2, long j3, float f, @Nullable Composer composer, final int i, final int i2) {
        int i3;
        int i4;
        boolean z2;
        int i5;
        ...
        if (i10 == 0) {
            ...
            if (i4 != 0) {
                ...
                if ((i & 458752) == 0) {
                    if ((i2 & 32) == 0) {
                        jM1043getSurface0d7_KjU = j2;
                        int i11 = composerStartRestartGroup.changed(jM1043getSurface0d7_KjU) ? 131072 : 65536;
                        i3 |= i11;
                    } else {
                        jM1043getSurface0d7_KjU = j2;
                    }
                ...
                if ((i3 & 23967451) == 4793490 || !composerStartRestartGroup.getSkipping()) {
                    ...
                    if (actionLabel != null) {
                        ...
                        composableLambda = ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1843479216, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$actionComposable$1
                            ...
                            public final void invoke(@Nullable Composer composer2, int i13) {
                                ...
                                ButtonColors buttonColorsM1013textButtonColorsRGew2ao = ButtonDefaults.INSTANCE.m1013textButtonColorsRGew2ao(0L, j8, 0L, composer2, ((i12 >> 15) & 112) | 3072, 5);
                                ...
                                ButtonKt.TextButton(function0, null, false, null, null, null, null, buttonColorsM1013textButtonColorsRGew2ao, null, ComposableLambdaKt.composableLambda(composer2, -929149933, true, new Function3<RowScope, Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$actionComposable$1.2
                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                    {
                                        super(3);
                                    }
                                    ...
                                    public final void invoke(@NotNull RowScope TextButton, @Nullable Composer composer3, int i14) {
                                        ...
                                        TextKt.m1261Text4IGK_g(str, (Modifier) null, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer3, 0, 0, 131070);
                                        if (ComposerKt.isTraceInProgress()) {
                                            ComposerKt.traceEventEnd();
                                        }
                                    }
                    ...
                    m1183Snackbar7zSek6w(PaddingKt.m478padding3ABfNKs(modifier2, Dp.m3775constructorimpl(12)), composableLambda, z3, small, j7, j6, fM3775constructorimpl, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -261845785, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$3
                        {
                            super(2);
                        }
                        ...
                        public final void invoke(@Nullable Composer composer2, int i13) {
                            ...
                            TextKt.m1261Text4IGK_g(snackbarData.getMessage(), (Modifier) null, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 0, 0, 131070);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                            }
                        }
                ...
                scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$4
                    ...
                    public final void invoke(@Nullable Composer composer2, int i13) {
                        SnackbarKt.m1184SnackbarsPrSdHI(snackbarData, modifier5, z4, shape3, j9, j10, j11, f2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                    }
                });
            }
            i3 |= 384;
            ...
            if ((i & 458752) == 0) {
                if ((i2 & 32) == 0) {
                    jM1043getSurface0d7_KjU = j2;
                    if (composerStartRestartGroup.changed(jM1043getSurface0d7_KjU)) {
                    }
                    i3 |= i11;
                } else {
                    jM1043getSurface0d7_KjU = j2;
                ...
                if (actionLabel != null) {
                    ...
                    composableLambda = ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1843479216, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$actionComposable$1
                        ...
                        public final void invoke(@Nullable Composer composer2, int i14) {
                            ...
                            ButtonColors buttonColorsM1013textButtonColorsRGew2ao = ButtonDefaults.INSTANCE.m1013textButtonColorsRGew2ao(0L, j12, 0L, composer2, ((i13 >> 15) & 112) | 3072, 5);
                            final SnackbarData snackbarData2 = snackbarData;
                            Function0<Unit> function0 = new Function0<Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$actionComposable$1.1
                                {
                                    super(0);
                ...
                if (actionLabel != null) {
                    ...
                    composableLambda = ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1843479216, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$actionComposable$1
                        ...
                        public final void invoke(@Nullable Composer composer2, int i15) {
                            ...
                            ButtonColors buttonColorsM1013textButtonColorsRGew2ao = ButtonDefaults.INSTANCE.m1013textButtonColorsRGew2ao(0L, j13, 0L, composer2, ((i14 >> 15) & 112) | 3072, 5);
                            final SnackbarData snackbarData2 = snackbarData;
                            Function0<Unit> function0 = new Function0<Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$actionComposable$1.1
                                {
                                    super(0);
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$4
                ...
                public final void invoke(@Nullable Composer composer2, int i15) {
                    SnackbarKt.m1184SnackbarsPrSdHI(snackbarData, modifier8, z5, shape4, j14, j15, j16, f2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
        i3 |= 48;
        ...
        if (i4 != 0) {
                ...
                if (actionLabel != null) {
                    ...
                    composableLambda = ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1843479216, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$actionComposable$1
                        ...
                        public final void invoke(@Nullable Composer composer2, int i16) {
                            ...
                            ButtonColors buttonColorsM1013textButtonColorsRGew2ao = ButtonDefaults.INSTANCE.m1013textButtonColorsRGew2ao(0L, j17, 0L, composer2, ((i15 >> 15) & 112) | 3072, 5);
                            final SnackbarData snackbarData2 = snackbarData;
                            Function0<Unit> function0 = new Function0<Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$actionComposable$1.1
                                {
                                    super(0);
                ...
                if (actionLabel != null) {
                    ...
                    composableLambda = ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1843479216, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$actionComposable$1
                        ...
                        public final void invoke(@Nullable Composer composer2, int i17) {
                            ...
                            ButtonColors buttonColorsM1013textButtonColorsRGew2ao = ButtonDefaults.INSTANCE.m1013textButtonColorsRGew2ao(0L, j18, 0L, composer2, ((i16 >> 15) & 112) | 3072, 5);
                            final SnackbarData snackbarData2 = snackbarData;
                            Function0<Unit> function0 = new Function0<Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$actionComposable$1.1
                                {
                                    super(0);
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$4
                ...
                public final void invoke(@Nullable Composer composer2, int i17) {
                    SnackbarKt.m1184SnackbarsPrSdHI(snackbarData, modifier11, z6, shape5, j19, j110, j111, f2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
        i3 |= 384;
            ...
            if (actionLabel != null) {
                ...
                composableLambda = ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1843479216, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$actionComposable$1
                    ...
                    public final void invoke(@Nullable Composer composer2, int i18) {
                        ...
                        ButtonColors buttonColorsM1013textButtonColorsRGew2ao = ButtonDefaults.INSTANCE.m1013textButtonColorsRGew2ao(0L, j112, 0L, composer2, ((i17 >> 15) & 112) | 3072, 5);
                        final SnackbarData snackbarData2 = snackbarData;
                        Function0<Unit> function0 = new Function0<Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$actionComposable$1.1
                            {
                                super(0);
            ...
            if (actionLabel != null) {
                ...
                composableLambda = ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1843479216, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$actionComposable$1
                    ...
                    public final void invoke(@Nullable Composer composer2, int i19) {
                        ...
                        ButtonColors buttonColorsM1013textButtonColorsRGew2ao = ButtonDefaults.INSTANCE.m1013textButtonColorsRGew2ao(0L, j113, 0L, composer2, ((i18 >> 15) & 112) | 3072, 5);
                        final SnackbarData snackbarData2 = snackbarData;
                        Function0<Unit> function0 = new Function0<Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$actionComposable$1.1
                            {
                                super(0);
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$4
            ...
            public final void invoke(@Nullable Composer composer2, int i19) {
                SnackbarKt.m1184SnackbarsPrSdHI(snackbarData, modifier14, z7, shape6, j114, j115, j116, f2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
    ...
    public static final void TextOnlySnackbar(final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        ...
        if ((i2 & 11) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            C07542 c07542 = new MeasurePolicy() { // from class: androidx.compose.material.SnackbarKt.TextOnlySnackbar.2
                @Override // androidx.compose.ui.layout.MeasurePolicy
                public final /* synthetic */ int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i3) {
                    return androidx.compose.ui.layout.OooO.OooO00o(this, intrinsicMeasureScope, list, i3);
                }
                ...
                public final MeasureResult mo3measure3p2s80s(@NotNull MeasureScope Layout, @NotNull List<? extends Measurable> measurables, long j) {
                    ...
                    final Placeable placeableMo2804measureBRTryo0 = ((Measurable) CollectionsKt.first((List) measurables)).mo2804measureBRTryo0(j);
                    int i3 = placeableMo2804measureBRTryo0.get(androidx.compose.ui.layout.AlignmentLineKt.getFirstBaseline());
                    int i4 = placeableMo2804measureBRTryo0.get(androidx.compose.ui.layout.AlignmentLineKt.getLastBaseline());
                    ...
                    final int iMax = Math.max(Layout.mo320roundToPx0680j_4(i3 == i4 ? SnackbarKt.SnackbarMinHeightOneLine : SnackbarKt.SnackbarMinHeightTwoLines), placeableMo2804measureBRTryo0.getHeight());
                    return MeasureScope.CC.OooOOo0(Layout, Constraints.m3743getMaxWidthimpl(j), iMax, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.SnackbarKt$TextOnlySnackbar$2$measure$4
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
                        ...
                        public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                            Intrinsics.checkNotNullParameter(layout, "$this$layout");
                            Placeable.PlacementScope.placeRelative$default(layout, placeableMo2804measureBRTryo0, 0, (iMax - placeableMo2804measureBRTryo0.getHeight()) / 2, 0.0f, 4, null);
                        }
                    }, 4, null);
                }
            ...
            Composer composerM1320constructorimpl = Updater.m1320constructorimpl(composerStartRestartGroup);
            Updater.m1327setimpl(composerM1320constructorimpl, c07542, companion2.getSetMeasurePolicy());
            Updater.m1327setimpl(composerM1320constructorimpl, currentCompositionLocalMap, companion2.getSetResolvedCompositionLocals());
            Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash = companion2.getSetCompositeKeyHash();
            if (composerM1320constructorimpl.getInserting() || !Intrinsics.areEqual(composerM1320constructorimpl.rememberedValue(), Integer.valueOf(currentCompositeKeyHash))) {
                androidx.compose.animation.OooO0O0.OooO0O0(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, setCompositeKeyHash);
            ...
            androidx.compose.animation.OooOO0.OooO00o(0, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composerStartRestartGroup)), composerStartRestartGroup, 2058660585);
            Modifier modifierM479paddingVpY3zN4 = PaddingKt.m479paddingVpY3zN4(companion, HorizontalSpacing, SnackbarVerticalPadding);
            composerStartRestartGroup.startReplaceableGroup(733328855);
