...
public final class SwipeableKt$PreUpPostDownNestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public Object mo333onPostFlingRZ2iAVY(long j, long j2, @NotNull Continuation<? super Velocity> continuation) {
        ...
        if (i2 == 0) {
            ...
            float f = toFloat(OffsetKt.Offset(Velocity.m4000getXimpl(j2), Velocity.m4001getYimpl(j2)));
    ...
    public long mo334onPostScrollDzOQY0M(long consumed, long available, int source) {
        return NestedScrollSource.m2604equalsimpl0(source, NestedScrollSource.INSTANCE.m2609getDragWNlRxjI()) ? toOffset(this.$this_PreUpPostDownNestedScrollConnection.performDrag(toFloat(available))) : Offset.INSTANCE.m1463getZeroF1C5BW0();
    }
    ...
    public Object mo335onPreFlingQWom1Mo(long j, @NotNull Continuation<? super Velocity> continuation) {
        ...
        if (i2 == 0) {
            ResultKt.throwOnFailure(obj);
            float f = toFloat(OffsetKt.Offset(Velocity.m4000getXimpl(j), Velocity.m4001getYimpl(j)));
    ...
    public long mo336onPreScrollOzD1aCk(long available, int source) {
        ...
        return (f >= 0.0f || !NestedScrollSource.m2604equalsimpl0(source, NestedScrollSource.INSTANCE.m2609getDragWNlRxjI())) ? Offset.INSTANCE.m1463getZeroF1C5BW0() : toOffset(this.$this_PreUpPostDownNestedScrollConnection.performDrag(f));
    }
}
