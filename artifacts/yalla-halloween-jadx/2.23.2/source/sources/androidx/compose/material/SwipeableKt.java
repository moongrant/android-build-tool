...
public final class SwipeableKt {
    ...
    public static final class C07571 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public C07571(T t, SwipeableState<T> swipeableState, Continuation<? super C07571> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C07571(this.$value, this.$swipeableState, continuation);
        }
    ...
    */
    ...
    public static final <T> SwipeableState<T> rememberSwipeableState(@NotNull final T initialValue, @Nullable final AnimationSpec<Float> animationSpec, @Nullable final Function1<? super T, Boolean> function1, @Nullable Composer composer, int i, int i2) {
        ...
        SwipeableState<T> swipeableState = (SwipeableState) RememberSaveableKt.m1333rememberSaveable(new Object[0], (Saver) SwipeableState.INSTANCE.Saver(animationSpec, function1), (String) null, (Function0) new Function0<SwipeableState<T>>() { // from class: androidx.compose.material.SwipeableKt.rememberSwipeableState.2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    ...
    public static final <T> SwipeableState<T> rememberSwipeableStateFor(@NotNull final T value, @NotNull final Function1<? super T, Unit> onValueChange, @Nullable AnimationSpec<Float> animationSpec, @Nullable Composer composer, int i, int i2) {
        ...
        int i3 = i & 8;
        EffectsKt.LaunchedEffect(value, mutableState.getValue(), new C07571(value, swipeableState, null), composer, (i & 14) | i3 | ConstantsKt.MINIMUM_BLOCK_SIZE);
    ...
    public static final <T> Modifier m1211swipeablepPrIpRY(@NotNull Modifier swipeable, @NotNull final SwipeableState<T> state, @NotNull final Map<Float, ? extends T> anchors, @NotNull final Orientation orientation, final boolean z, final boolean z2, @Nullable final MutableInteractionSource mutableInteractionSource, @NotNull final Function2<? super T, ? super T, ? extends ThresholdConfig> thresholds, @Nullable final ResistanceConfig resistanceConfig, final float f) {
        ...
        return ComposedModifierKt.composed(swipeable, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.material.SwipeableKt$swipeable-pPrIpRY$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("velocityThreshold", Dp.m3773boximpl(f));
            }
            ...
            public static final class AnonymousClass3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                public final Object invokeSuspend(@NotNull Object obj) {
                    ...
                    if (i == 0) {
                        ...
                        this.$state.setVelocityThreshold$material_release(this.$density.mo326toPx0680j_4(this.$velocityThreshold));
            ...
            public final Modifier invoke(@NotNull Modifier modifier, @Nullable Composer composer, int i) {
                if (OooOOO.OooO0O0(modifier, "$this$composed", composer, 43594985)) {
                ...
                composer.endReplaceableGroup();
                Modifier modifierDraggable = DraggableKt.draggable(companion, draggableState, orientation2, (252 & 4) != 0 ? true : z3, (252 & 8) != 0 ? null : mutableInteractionSource2, (252 & 16) != 0 ? false : zIsAnimationRunning, (252 & 32) != 0 ? new DraggableKt.C06261(null) : null, (252 & 64) != 0 ? new DraggableKt.AnonymousClass2(null) : (Function3) objRememberedValue, (252 & 128) != 0 ? false : z2);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                composer.endReplaceableGroup();
