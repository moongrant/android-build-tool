...
public final class TabPosition {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Dp.m3780equalsimpl0(this.left, tabPosition.left) && Dp.m3780equalsimpl0(this.width, tabPosition.width);
    }
    ...
    public final float m1223getRightD9Ej5fM() {
        return Dp.m3775constructorimpl(this.left + this.width);
    }
    ...
    public int hashCode() {
        return Dp.m3781hashCodeimpl(this.width) + (Dp.m3781hashCodeimpl(this.left) * 31);
    }

    @NotNull
    public String toString() {
        return "TabPosition(left=" + ((Object) Dp.m3786toStringimpl(this.left)) + ", right=" + ((Object) Dp.m3786toStringimpl(m1223getRightD9Ej5fM())) + ", width=" + ((Object) Dp.m3786toStringimpl(this.width)) + ')';
    }
