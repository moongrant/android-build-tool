...
public final class TextFieldDefaultsKt {
    ...
    public static final State<BorderStroke> m1250animateBorderStrokeAsStateNuRrP5Q(boolean z, boolean z2, InteractionSource interactionSource, TextFieldColors textFieldColors, float f, float f2, Composer composer, int i) {
        ...
        State<Color> stateIndicatorColor = textFieldColors.indicatorColor(z, z2, interactionSource, composer, (i & 14) | (i & 112) | (i & 896) | (i & 7168));
        ...
        if (z) {
            ...
            stateRememberUpdatedState = AnimateAsStateKt.m70animateDpAsStateAjpBEmI(f3, AnimationSpecKt.tween$default(TextFieldImplKt.AnimationDuration, 0, null, 6, null), null, null, composer, 48, 12);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(1685712164);
            stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Dp.m3773boximpl(f2), composer, (i >> 15) & 14);
            composer.endReplaceableGroup();
        }
        State<BorderStroke> stateRememberUpdatedState2 = SnapshotStateKt.rememberUpdatedState(new BorderStroke(stateRememberUpdatedState.getValue().m3789unboximpl(), new SolidColor(stateIndicatorColor.getValue().m1691unboximpl(), null), null), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
