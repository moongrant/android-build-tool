...
final class TextFieldMeasurePolicy implements MeasurePolicy {
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        for (Object obj2 : list) {
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) obj2), TextFieldImplKt.TextFieldId)) {
                ...
                return TextFieldKt.m1257calculateHeightO3s9Psw(iIntValue, iIntValue2 > 0, iIntValue2, iIntValue4, iIntValue3, intrinsicMeasurable4 != null ? function2.invoke(intrinsicMeasurable4, Integer.valueOf(i)).intValue() : 0, TextFieldImplKt.getZeroConstraints(), intrinsicMeasureScope.getDensity(), this.paddingValues);
            }
        }
    ...
    private final int intrinsicWidth(List<? extends IntrinsicMeasurable> measurables, int height, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> intrinsicMeasurer) {
        ...
        for (Object obj2 : measurables) {
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) obj2), TextFieldImplKt.TextFieldId)) {
                ...
                IntrinsicMeasurable intrinsicMeasurable4 = (IntrinsicMeasurable) obj;
                return TextFieldKt.m1258calculateWidthVsPV1Ek(iIntValue4, iIntValue3, iIntValue, iIntValue2, intrinsicMeasurable4 != null ? intrinsicMeasurer.invoke(intrinsicMeasurable4, Integer.valueOf(height)).intValue() : 0, TextFieldImplKt.getZeroConstraints());
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
    ...
    public MeasureResult mo3measure3p2s80s(@NotNull final MeasureScope measure, @NotNull List<? extends Measurable> measurables, long j) {
        ...
        Intrinsics.checkNotNullParameter(measurables, "measurables");
        final int iMo320roundToPx0680j_4 = measure.mo320roundToPx0680j_4(this.paddingValues.getTop());
        int iMo320roundToPx0680j_5 = measure.mo320roundToPx0680j_4(this.paddingValues.getBottom());
        final int iMo320roundToPx0680j_6 = measure.mo320roundToPx0680j_4(TextFieldKt.getTextFieldTopPadding());
        ...
        final Placeable placeableMo2804measureBRTryo0 = measurable != null ? measurable.mo2804measureBRTryo0(jM3734copyZbe2FdA$default) : null;
        ...
        int i = -iMo320roundToPx0680j_5;
        int i2 = -iWidthOrZero2;
        long jM3759offsetNN6EwU = ConstraintsKt.m3759offsetNN6EwU(jM3734copyZbe2FdA$default, i2, i);
        Iterator<T> it3 = measurables.iterator();
        do {
            if (!it3.hasNext()) {
                next3 = null;
        ...
        if (placeableMo2804measureBRTryo2 != null) {
            height = placeableMo2804measureBRTryo2.get(AlignmentLineKt.getLastBaseline());
            if (height == Integer.MIN_VALUE) {
                height = placeableMo2804measureBRTryo2.getHeight();
            }
        } else {
            height = 0;
        }
        final int iMax = Math.max(height, iMo320roundToPx0680j_4);
        long jM3759offsetNN6EwU2 = ConstraintsKt.m3759offsetNN6EwU(Constraints.m3734copyZbe2FdA$default(j, 0, 0, 0, 0, 11, null), i2, placeableMo2804measureBRTryo2 != null ? (i - iMo320roundToPx0680j_6) - iMax : (-iMo320roundToPx0680j_4) - iMo320roundToPx0680j_5);
        for (Measurable measurable4 : measurables) {
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable4), TextFieldImplKt.TextFieldId)) {
                final Placeable placeableMo2804measureBRTryo3 = measurable4.mo2804measureBRTryo0(jM3759offsetNN6EwU2);
                long jM3734copyZbe2FdA$default2 = Constraints.m3734copyZbe2FdA$default(jM3759offsetNN6EwU2, 0, 0, 0, 0, 14, null);
                ...
                final Placeable placeableMo2804measureBRTryo4 = measurable5 != null ? measurable5.mo2804measureBRTryo0(jM3734copyZbe2FdA$default2) : null;
                final int iM1258calculateWidthVsPV1Ek = TextFieldKt.m1258calculateWidthVsPV1Ek(TextFieldImplKt.widthOrZero(placeableMo2804measureBRTryo0), TextFieldImplKt.widthOrZero(placeableMo2804measureBRTryo1), placeableMo2804measureBRTryo3.getWidth(), TextFieldImplKt.widthOrZero(placeableMo2804measureBRTryo2), TextFieldImplKt.widthOrZero(placeableMo2804measureBRTryo4), j);
                final int iM1257calculateHeightO3s9Psw = TextFieldKt.m1257calculateHeightO3s9Psw(placeableMo2804measureBRTryo3.getHeight(), placeableMo2804measureBRTryo2 != null, iMax, TextFieldImplKt.heightOrZero(placeableMo2804measureBRTryo0), TextFieldImplKt.heightOrZero(placeableMo2804measureBRTryo1), TextFieldImplKt.heightOrZero(placeableMo2804measureBRTryo4), j, measure.getDensity(), this.paddingValues);
                final Placeable placeable = placeableMo2804measureBRTryo2;
                final int i3 = height;
                final Placeable placeable2 = placeableMo2804measureBRTryo1;
                return MeasureScope.CC.OooOOo0(measure, iM1258calculateWidthVsPV1Ek, iM1257calculateHeightO3s9Psw, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TextFieldMeasurePolicy$measure$1
                    ...
                    public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                        ...
                        if (placeable == null) {
                            TextFieldKt.placeWithoutLabel(layout, iM1258calculateWidthVsPV1Ek, iM1257calculateHeightO3s9Psw, placeableMo2804measureBRTryo3, placeableMo2804measureBRTryo4, placeableMo2804measureBRTryo0, placeable2, this.singleLine, measure.getDensity(), this.paddingValues);
                            return;
                        }
                        int iCoerceAtLeast = RangesKt.coerceAtLeast(iMo320roundToPx0680j_4 - i3, 0);
                        TextFieldKt.placeWithLabel(layout, iM1258calculateWidthVsPV1Ek, iM1257calculateHeightO3s9Psw, placeableMo2804measureBRTryo3, placeable, placeableMo2804measureBRTryo4, placeableMo2804measureBRTryo0, placeable2, this.singleLine, iCoerceAtLeast, iMo320roundToPx0680j_6 + iMax, this.animationProgress, measure.getDensity());
                    }
                }, 4, null);
            }
        }
