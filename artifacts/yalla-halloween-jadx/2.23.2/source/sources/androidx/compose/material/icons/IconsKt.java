...
public final class IconsKt {
    ...
    public static final ImageVector materialIcon(@NotNull String name, @NotNull Function1<? super ImageVector.Builder, ImageVector.Builder> block) {
        ...
        return block.invoke(new ImageVector.Builder(name, Dp.m3775constructorimpl(24.0f), Dp.m3775constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null)).build();
    }

    @NotNull
    /* JADX INFO: renamed from: materialPath-YwgOQQI, reason: not valid java name */
    public static final ImageVector.Builder m1265materialPathYwgOQQI(@NotNull ImageVector.Builder materialPath, float f, float f2, int i, @NotNull Function1<? super PathBuilder, Unit> pathBuilder) {
        ...
        return ImageVector.Builder.m2223addPathoIyEayM$default(materialPath, pathBuilder2.getNodes(), i, "", solidColor, f, null, f2, 1.0f, iM2005getButtKaPHkGw, iM2015getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
    }

    /* JADX INFO: renamed from: materialPath-YwgOQQI$default, reason: not valid java name */
    public static /* synthetic */ ImageVector.Builder m1266materialPathYwgOQQI$default(ImageVector.Builder materialPath, float f, float f2, int i, Function1 pathBuilder, int i2, Object obj) {
        ...
        PathBuilder pathBuilder2 = new PathBuilder();
        pathBuilder.invoke(pathBuilder2);
        return ImageVector.Builder.m2223addPathoIyEayM$default(materialPath, pathBuilder2.getNodes(), defaultFillType, "", solidColor, f3, null, f4, 1.0f, iM2005getButtKaPHkGw, iM2015getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
    }
}
