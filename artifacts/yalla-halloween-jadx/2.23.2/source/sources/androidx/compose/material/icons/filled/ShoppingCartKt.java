...
public final class ShoppingCartKt {
    ...
    public static final ImageVector getShoppingCart(@NotNull Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.ShoppingCart", Dp.m3775constructorimpl(24.0f), Dp.m3775constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderOooO00o = Oooo000.OooO00o(7.0f, 18.0f);
        ...
        pathBuilderOooO00o.moveTo(1.0f, 2.0f);
        ...
        pathBuilderOooO00o.lineToRelative(-1.35f, 2.45f);
        pathBuilderOooO00o.curveToRelative(-0.16f, 0.28f, -0.25f, 0.61f, -0.25f, 0.96f);
        pathBuilderOooO00o.curveToRelative(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        pathBuilderOooO00o.horizontalLineToRelative(12.0f);
        pathBuilderOooO00o.verticalLineToRelative(-2.0f);
        pathBuilderOooO00o.lineTo(7.42f, 15.0f);
        pathBuilderOooO00o.curveToRelative(-0.14f, 0.0f, -0.25f, -0.11f, -0.25f, -0.25f);
        pathBuilderOooO00o.lineToRelative(0.03f, -0.12f);
        pathBuilderOooO00o.lineToRelative(0.9f, -1.63f);
        ...
        pathBuilderOooO00o.curveToRelative(0.08f, -0.14f, 0.12f, -0.31f, 0.12f, -0.48f);
