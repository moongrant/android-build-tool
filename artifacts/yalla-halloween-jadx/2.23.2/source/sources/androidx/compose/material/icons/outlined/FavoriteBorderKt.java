...
public final class FavoriteBorderKt {
    ...
    public static final ImageVector getFavoriteBorder(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.FavoriteBorder", Dp.m3775constructorimpl(24.0f), Dp.m3775constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderOooO00o = Oooo000.OooO00o(16.5f, 3.0f);
        pathBuilderOooO00o.curveToRelative(-1.74f, 0.0f, -3.41f, 0.81f, -4.5f, 2.09f);
        pathBuilderOooO00o.curveTo(10.91f, 3.81f, 9.24f, 3.0f, 7.5f, 3.0f);
        pathBuilderOooO00o.curveTo(4.42f, 3.0f, 2.0f, 5.42f, 2.0f, 8.5f);
        pathBuilderOooO00o.curveToRelative(0.0f, 3.78f, 3.4f, 6.86f, 8.55f, 11.54f);
        pathBuilderOooO00o.lineTo(12.0f, 21.35f);
        pathBuilderOooO00o.lineToRelative(1.45f, -1.32f);
        pathBuilderOooO00o.curveTo(18.6f, 15.36f, 22.0f, 12.28f, 22.0f, 8.5f);
        pathBuilderOooO00o.curveTo(22.0f, 5.42f, 19.58f, 3.0f, 16.5f, 3.0f);
