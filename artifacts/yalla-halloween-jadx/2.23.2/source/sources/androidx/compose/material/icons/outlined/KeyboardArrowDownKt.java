...
public final class KeyboardArrowDownKt {
    ...
    public static final ImageVector getKeyboardArrowDown(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.KeyboardArrowDown", Dp.m3775constructorimpl(24.0f), Dp.m3775constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderOooO00o = o0OOO0.OooO00o(7.41f, 8.59f, 12.0f, 13.17f);
        pathBuilderOooO00o.lineToRelative(4.59f, -4.58f);
        pathBuilderOooO00o.lineTo(18.0f, 10.0f);
