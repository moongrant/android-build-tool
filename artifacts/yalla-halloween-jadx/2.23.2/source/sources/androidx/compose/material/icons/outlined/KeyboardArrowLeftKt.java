...
public final class KeyboardArrowLeftKt {
    ...
    public static final ImageVector getKeyboardArrowLeft(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.KeyboardArrowLeft", Dp.m3775constructorimpl(24.0f), Dp.m3775constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderOooO00o = o0OOO0.OooO00o(15.41f, 16.59f, 10.83f, 12.0f);
        pathBuilderOooO00o.lineToRelative(4.58f, -4.59f);
        pathBuilderOooO00o.lineTo(14.0f, 6.0f);
        pathBuilderOooO00o.lineToRelative(-6.0f, 6.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m2223addPathoIyEayM$default(builder, o0OoOo0.OooO00o(pathBuilderOooO00o, 6.0f, 6.0f, 1.41f, -1.41f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM2005getButtKaPHkGw, iM2015getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
