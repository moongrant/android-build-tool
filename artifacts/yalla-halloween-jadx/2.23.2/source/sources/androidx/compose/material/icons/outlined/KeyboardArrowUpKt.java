...
public final class KeyboardArrowUpKt {
    ...
    public static final ImageVector getKeyboardArrowUp(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.KeyboardArrowUp", Dp.m3775constructorimpl(24.0f), Dp.m3775constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderOooO00o = o0OOO0.OooO00o(7.41f, 15.41f, 12.0f, 10.83f);
        pathBuilderOooO00o.lineToRelative(4.59f, 4.58f);
        pathBuilderOooO00o.lineTo(18.0f, 14.0f);
