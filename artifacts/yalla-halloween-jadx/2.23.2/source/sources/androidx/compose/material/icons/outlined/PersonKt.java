...
public final class PersonKt {
    ...
    public static final ImageVector getPerson(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Person", Dp.m3775constructorimpl(24.0f), Dp.m3775constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderOooO00o = Oooo000.OooO00o(12.0f, 6.0f);
        ...
        pathBuilderOooO00o.reflectiveCurveToRelative(0.9f, -2.0f, 2.0f, -2.0f);
        pathBuilderOooO00o.moveToRelative(0.0f, 10.0f);
        pathBuilderOooO00o.curveToRelative(2.7f, 0.0f, 5.8f, 1.29f, 6.0f, 2.0f);
        pathBuilderOooO00o.lineTo(6.0f, 18.0f);
        pathBuilderOooO00o.curveToRelative(0.23f, -0.72f, 3.31f, -2.0f, 6.0f, -2.0f);
        pathBuilderOooO00o.moveToRelative(0.0f, -12.0f);
        pathBuilderOooO00o.curveTo(9.79f, 4.0f, 8.0f, 5.79f, 8.0f, 8.0f);
