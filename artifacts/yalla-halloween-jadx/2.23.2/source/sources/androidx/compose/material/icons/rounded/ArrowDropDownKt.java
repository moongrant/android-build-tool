...
public final class ArrowDropDownKt {
    ...
    public static final ImageVector getArrowDropDown(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.ArrowDropDown", Dp.m3775constructorimpl(24.0f), Dp.m3775constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderOooO00o = o0000O0.OooO00o(8.71f, 11.71f, 2.59f, 2.59f);
        pathBuilderOooO00o.curveToRelative(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        pathBuilderOooO00o.lineToRelative(2.59f, -2.59f);
        pathBuilderOooO00o.curveToRelative(0.63f, -0.63f, 0.18f, -1.71f, -0.71f, -1.71f);
        pathBuilderOooO00o.horizontalLineTo(9.41f);
        pathBuilderOooO00o.curveToRelative(-0.89f, 0.0f, -1.33f, 1.08f, -0.7f, 1.71f);
