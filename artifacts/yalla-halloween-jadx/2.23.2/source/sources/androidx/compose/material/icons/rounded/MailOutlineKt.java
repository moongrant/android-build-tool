...
public final class MailOutlineKt {
    ...
    public static final ImageVector getMailOutline(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.MailOutline", Dp.m3775constructorimpl(24.0f), Dp.m3775constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderOooO00o = o0OOO0.OooO00o(20.0f, 4.0f, 4.0f, 4.0f);
        ...
        pathBuilderOooO00o.moveTo(19.0f, 18.0f);
        pathBuilderOooO00o.lineTo(5.0f, 18.0f);
        pathBuilderOooO00o.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilderOooO00o.lineTo(4.0f, 8.0f);
        pathBuilderOooO00o.lineToRelative(6.94f, 4.34f);
        pathBuilderOooO00o.curveToRelative(0.65f, 0.41f, 1.47f, 0.41f, 2.12f, 0.0f);
        pathBuilderOooO00o.lineTo(20.0f, 8.0f);
        pathBuilderOooO00o.verticalLineToRelative(9.0f);
