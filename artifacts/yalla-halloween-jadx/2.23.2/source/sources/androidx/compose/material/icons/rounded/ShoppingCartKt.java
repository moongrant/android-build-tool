...
public final class ShoppingCartKt {
    ...
    public static final ImageVector getShoppingCart(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.ShoppingCart", Dp.m3775constructorimpl(24.0f), Dp.m3775constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderOooO00o.moveTo(1.0f, 3.0f);
        pathBuilderOooO00o.curveToRelative(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        pathBuilderOooO00o.horizontalLineToRelative(1.0f);
        ...
        pathBuilderOooO00o.horizontalLineToRelative(11.0f);
        ...
        pathBuilderOooO00o.lineToRelative(-0.67f, -1.43f);
        pathBuilderOooO00o.curveToRelative(-0.16f, -0.35f, -0.52f, -0.57f, -0.9f, -0.57f);
        pathBuilderOooO00o.lineTo(2.0f, 2.0f);
        pathBuilderOooO00o.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilderOooO00o.close();
