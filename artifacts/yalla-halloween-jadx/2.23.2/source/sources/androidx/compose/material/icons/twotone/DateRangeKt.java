...
public final class DateRangeKt {
    ...
    public static final ImageVector getDateRange(@NotNull Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.DateRange", Dp.m3775constructorimpl(24.0f), Dp.m3775constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder2.verticalLineToRelative(2.0f);
        pathBuilder2.close();
        o00O0O.OooO00o(pathBuilder2, 15.0f, 11.0f, 2.0f, 2.0f);
        pathBuilder2.horizontalLineToRelative(-2.0f);
        pathBuilder2.close();
