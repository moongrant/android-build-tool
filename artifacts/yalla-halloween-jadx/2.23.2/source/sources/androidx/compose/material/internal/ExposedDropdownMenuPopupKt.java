...
public final class ExposedDropdownMenuPopupKt {
    ...
    public static final class C07681 implements MeasurePolicy {
        public static final C07681 INSTANCE = new C07681();
        ...
        public final MeasureResult mo3measure3p2s80s(@NotNull MeasureScope Layout, @NotNull List<? extends Measurable> measurables, long j) {
            ...
            if (size == 1) {
                ...
                return MeasureScope.CC.OooOOo0(Layout, placeableMo2804measureBRTryo0.getWidth(), placeableMo2804measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt$SimpleStack$1$measure$2
                    {
                        super(1);
                    }
    ...
    public static final void ExposedDropdownMenuPopup(@Nullable Function0<Unit> function0, @NotNull final PopupPositionProvider popupPositionProvider, @NotNull final Function2<? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, final int i, final int i2) {
        ...
        if ((i5 & 731) == 146 && composerStartRestartGroup.getSkipping()) {
            ...
            UUID popupId = (UUID) RememberSaveableKt.m1333rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) new Function0<UUID>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupId$1
                @Override // kotlin.jvm.functions.Function0
                    ...
                    public final void invoke(@Nullable Composer composer3, int i6) {
                        ...
                        Modifier modifierAlpha = AlphaKt.alpha(OnRemeasuredModifierKt.onSizeChanged(modifierSemantics$default, new Function1<IntSize, Unit>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupLayout$1$1$1.2
                            ...
                            public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
                                m1268invokeozmzZPI(intSize.getPackedValue());
                                return Unit.INSTANCE;
                            }

                            /* JADX INFO: renamed from: invoke-ozmzZPI, reason: not valid java name */
                            public final void m1268invokeozmzZPI(long j) {
                                popupLayout2.m1270setPopupContentSizefhxjrPA(IntSize.m3927boximpl(j));
                        ...
                        ExposedDropdownMenuPopupKt.C07681 c07681 = ExposedDropdownMenuPopupKt.C07681.INSTANCE;
                        ...
                        Updater.m1327setimpl(composerM1320constructorimpl, c07681, companion.getSetMeasurePolicy());
                        ...
                        function3ModifierMaterializerOf.invoke(SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer3)), composer3, 0);
            ...
            Modifier modifierOnGloballyPositioned = OnGloballyPositionedModifierKt.onGloballyPositioned(Modifier.INSTANCE, new Function1<LayoutCoordinates, Unit>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt.ExposedDropdownMenuPopup.5
                ...
                public final void invoke2(@NotNull LayoutCoordinates childCoordinates) {
                    ...
                    long jMo2811getSizeYbymL2g = parentLayoutCoordinates.mo2811getSizeYbymL2g();
                    long jPositionInWindow = LayoutCoordinatesKt.positionInWindow(parentLayoutCoordinates);
                    popupLayout2.setParentBounds(IntRectKt.m3925IntRectVbeCjmY(IntOffsetKt.IntOffset(MathKt.roundToInt(Offset.m1447getXimpl(jPositionInWindow)), MathKt.roundToInt(Offset.m1448getYimpl(jPositionInWindow))), jMo2811getSizeYbymL2g));
                    popupLayout2.updatePosition();
                }
            });
