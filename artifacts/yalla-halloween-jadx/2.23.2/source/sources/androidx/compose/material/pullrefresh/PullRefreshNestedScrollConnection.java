...
final class PullRefreshNestedScrollConnection implements NestedScrollConnection {
    ...
    public long mo334onPostScrollDzOQY0M(long consumed, long available, int source) {
        if (this.enabled) {
            return (!NestedScrollSource.m2604equalsimpl0(source, NestedScrollSource.INSTANCE.m2609getDragWNlRxjI()) || Offset.m1448getYimpl(available) <= 0.0f) ? Offset.INSTANCE.m1463getZeroF1C5BW0() : OffsetKt.Offset(0.0f, this.onPull.invoke(Float.valueOf(Offset.m1448getYimpl(available))).floatValue());
        }
    ...
    public Object mo335onPreFlingQWom1Mo(long j, @NotNull Continuation<? super Velocity> continuation) {
        ...
        if (i2 == 0) {
            ...
            Float fBoxFloat = Boxing.boxFloat(Velocity.m4001getYimpl(j));
        ...
        return Velocity.m3991boximpl(VelocityKt.Velocity(f, ((Number) objInvoke).floatValue()));
    }
