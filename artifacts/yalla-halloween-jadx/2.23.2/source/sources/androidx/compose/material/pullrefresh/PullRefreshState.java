...
public final class PullRefreshState {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public static final class C01031 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
            final /* synthetic */ float $offset;
            int label;
            final /* synthetic */ PullRefreshState this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C01031(PullRefreshState pullRefreshState, float f, Continuation<? super C01031> continuation) {
            ...
            public final Continuation<Unit> create(@NotNull Continuation<?> continuation) {
                return new C01031(this.this$0, this.$offset, continuation);
            }
            ...
            public final Object invoke(@Nullable Continuation<? super Unit> continuation) {
                return ((C01031) create(continuation)).invokeSuspend(Unit.INSTANCE);
            }
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                ...
                C01031 c01031 = new C01031(PullRefreshState.this, this.$offset, null);
                this.label = 1;
                if (MutatorMutex.mutate$default(mutatorMutex, null, c01031, this, 1, null) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
