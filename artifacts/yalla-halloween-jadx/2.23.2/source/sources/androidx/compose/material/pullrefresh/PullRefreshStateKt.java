...
public final class PullRefreshStateKt {
    ...
    public static final PullRefreshState m1279rememberPullRefreshStateUuyPYSY(final boolean z, @NotNull Function0<Unit> onRefresh, float f, float f2, @Nullable Composer composer, int i, int i2) {
        Intrinsics.checkNotNullParameter(onRefresh, "onRefresh");
        composer.startReplaceableGroup(-174977512);
        if ((i2 & 4) != 0) {
            f = PullRefreshDefaults.INSTANCE.m1272getRefreshThresholdD9Ej5fM();
        }
        if ((i2 & 8) != 0) {
            f2 = PullRefreshDefaults.INSTANCE.m1273getRefreshingOffsetD9Ej5fM();
        }
        ...
        floatRef.element = density.mo326toPx0680j_4(f);
        floatRef2.element = density.mo326toPx0680j_4(f2);
