...
public final class AndroidRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    public void addRipple(@NotNull PressInteraction.Press interaction, @NotNull CoroutineScope scope) {
        ...
        rippleHostView.m1285addRippleKOepWvA(interaction, this.bounded, this.rippleSize, this.rippleRadius, this.color.getValue().m1691unboximpl(), this.rippleAlpha.getValue().getPressedAlpha(), this.onInvalidateRipple);
    ...
    public void drawIndication(@NotNull ContentDrawScope contentDrawScope) {
        ...
        this.rippleSize = contentDrawScope.mo2118getSizeNHjbRc();
        this.rippleRadius = Float.isNaN(this.radius) ? MathKt.roundToInt(RippleAnimationKt.m1283getRippleEndRadiuscSwnlzA(contentDrawScope, this.bounded, contentDrawScope.mo2118getSizeNHjbRc())) : contentDrawScope.mo320roundToPx0680j_4(this.radius);
        ...
        if (rippleHostView != null) {
            rippleHostView.m1286updateRipplePropertiesbiQXAtU(contentDrawScope.mo2118getSizeNHjbRc(), this.rippleRadius, jM1691unboximpl, pressedAlpha);
    ...
    private AndroidRippleIndicationInstance(boolean z, float f, State<Color> color, State<RippleAlpha> rippleAlpha, RippleContainer rippleContainer) {
        ...
        this.rippleSize = Size.INSTANCE.m1525getZeroNHjbRc();
        this.rippleRadius = -1;
