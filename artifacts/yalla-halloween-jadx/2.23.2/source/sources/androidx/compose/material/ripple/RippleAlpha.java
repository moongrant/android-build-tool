...
public final class RippleAlpha {
    ...
    public int hashCode() {
        return Float.floatToIntBits(this.pressedAlpha) + o0OoOo0.OooO00o(this.hoveredAlpha, o0OoOo0.OooO00o(this.focusedAlpha, Float.floatToIntBits(this.draggedAlpha) * 31, 31), 31);
    }
    ...
    public String toString() {
        ...
        return androidx.compose.animation.OooO00o.OooO00o(sb, this.pressedAlpha, ')');
    }
}
