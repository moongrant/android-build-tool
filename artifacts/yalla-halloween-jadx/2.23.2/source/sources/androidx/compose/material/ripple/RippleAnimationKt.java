...
public final class RippleAnimationKt {
    private static final float BoundedRippleExtraRadius = Dp.m3775constructorimpl(10);
    ...
    public static final float m1283getRippleEndRadiuscSwnlzA(@NotNull Density getRippleEndRadius, boolean z, long j) {
        Intrinsics.checkNotNullParameter(getRippleEndRadius, "$this$getRippleEndRadius");
        float fM1445getDistanceimpl = Offset.m1445getDistanceimpl(OffsetKt.Offset(Size.m1516getWidthimpl(j), Size.m1513getHeightimpl(j))) / 2.0f;
        return z ? fM1445getDistanceimpl + getRippleEndRadius.mo326toPx0680j_4(BoundedRippleExtraRadius) : fM1445getDistanceimpl;
    }

    /* JADX INFO: renamed from: getRippleStartRadius-uvyYCjk, reason: not valid java name */
    public static final float m1284getRippleStartRadiusuvyYCjk(long j) {
        return Math.max(Size.m1516getWidthimpl(j), Size.m1513getHeightimpl(j)) * 0.3f;
    }
}
