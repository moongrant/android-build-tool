...
public abstract class RippleIndicationInstance implements IndicationInstance {
    ...
    public final void m1287drawStateLayerH2RKhps(@NotNull DrawScope drawStateLayer, float f, long j) {
        Intrinsics.checkNotNullParameter(drawStateLayer, "$this$drawStateLayer");
        this.stateLayer.m1291drawStateLayerH2RKhps(drawStateLayer, f, j);
    }
