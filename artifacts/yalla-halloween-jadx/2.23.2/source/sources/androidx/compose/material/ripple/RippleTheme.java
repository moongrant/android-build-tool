...
public interface RippleTheme {
    ...
    public static final class Companion {
        ...
        public final RippleAlpha m1289defaultRippleAlphaDxMtmZc(long contentColor, boolean lightTheme) {
            if (lightTheme) {
                return ((double) ColorKt.m1733luminance8_81llA(contentColor)) > 0.5d ? RippleThemeKt.LightThemeHighContrastRippleAlpha : RippleThemeKt.LightThemeLowContrastRippleAlpha;
            }
            return RippleThemeKt.DarkThemeRippleAlpha;
        }

        /* JADX INFO: renamed from: defaultRippleColor-5vOe2sY, reason: not valid java name */
        public final long m1290defaultRippleColor5vOe2sY(long contentColor, boolean lightTheme) {
            return (lightTheme || ((double) ColorKt.m1733luminance8_81llA(contentColor)) >= 0.5d) ? contentColor : Color.INSTANCE.m1718getWhite0d7_KjU();
        }
    }

    @Composable
    /* JADX INFO: renamed from: defaultColor-WaAFU9c */
    long mo1124defaultColorWaAFU9c(@Nullable Composer composer, int i);
