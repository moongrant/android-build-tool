...
final class StateLayer {
    ...
    public final void m1291drawStateLayerH2RKhps(@NotNull DrawScope drawStateLayer, float f, long j) {
        Intrinsics.checkNotNullParameter(drawStateLayer, "$this$drawStateLayer");
        float fM1283getRippleEndRadiuscSwnlzA = Float.isNaN(f) ? RippleAnimationKt.m1283getRippleEndRadiuscSwnlzA(drawStateLayer, this.bounded, drawStateLayer.mo2118getSizeNHjbRc()) : drawStateLayer.mo326toPx0680j_4(f);
        float fFloatValue = this.animatedAlpha.getValue().floatValue();
        if (fFloatValue > 0.0f) {
            long jM1680copywmQWz5c$default = Color.m1680copywmQWz5c$default(j, fFloatValue, 0.0f, 0.0f, 0.0f, 14, null);
            if (!this.bounded) {
                OooO0O0.OooOo(drawStateLayer, jM1680copywmQWz5c$default, fM1283getRippleEndRadiuscSwnlzA, 0L, 0.0f, null, null, 0, 124, null);
                return;
            }
            float fM1516getWidthimpl = Size.m1516getWidthimpl(drawStateLayer.mo2118getSizeNHjbRc());
            float fM1513getHeightimpl = Size.m1513getHeightimpl(drawStateLayer.mo2118getSizeNHjbRc());
