...
final class UnprojectedRipple extends RippleDrawable {
    ...
    private final long m1292calculateRippleColor5vOe2sY(long color, float alpha) {
        if (Build.VERSION.SDK_INT < 28) {
            alpha *= 2;
        }
        return Color.m1680copywmQWz5c$default(color, RangesKt.coerceAtMost(alpha, 1.0f), 0.0f, 0.0f, 0.0f, 14, null);
    }
    ...
    public final void m1293setColorDxMtmZc(long color, float alpha) {
        long jM1292calculateRippleColor5vOe2sY = m1292calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (color2 == null ? false : Color.m1682equalsimpl0(color2.m1691unboximpl(), jM1292calculateRippleColor5vOe2sY)) {
            return;
        }
        this.rippleColor = Color.m1671boximpl(jM1292calculateRippleColor5vOe2sY);
        setColor(ColorStateList.valueOf(ColorKt.m1735toArgb8_81llA(jM1292calculateRippleColor5vOe2sY)));
    }
