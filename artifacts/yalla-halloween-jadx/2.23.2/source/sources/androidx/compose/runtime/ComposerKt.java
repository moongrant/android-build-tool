...
public final class ComposerKt {
    ...
    public static final Void composeRuntimeError(@NotNull String message) {
        ...
        throw new ComposeRuntimeError(p004OooO0oO.o000oOoO.OooO0O0("Compose Runtime internal error. Unexpected or incorrect use of the Compose internal runtime API (", message, "). Please report to Google or use https://goo.gle/compose-feedback"));
    }
