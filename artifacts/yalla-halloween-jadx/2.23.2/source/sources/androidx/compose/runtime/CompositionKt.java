...
public final class CompositionKt {
    ...
    public static final List<Pair<Exception, Boolean>> currentCompositionErrors() {
        ...
        ArrayList arrayList = new ArrayList(CollectionsKt.OooO0oo(currentErrors$runtime_release));
