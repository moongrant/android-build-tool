...
final class GroupKind {
    ...
    private static final int Group = m1300constructorimpl(0);
    private static final int Node = m1300constructorimpl(1);
    private static final int ReusableNode = m1300constructorimpl(2);
    ...
    public static final /* synthetic */ GroupKind m1299boximpl(int i) {
        return new GroupKind(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m1300constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m1301equalsimpl(int i, Object obj) {
        return (obj instanceof GroupKind) && i == ((GroupKind) obj).m1307unboximpl();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1302equalsimpl0(int i, int i2) {
        return i == i2;
    }
    ...
    public static final boolean m1304isNodeimpl(int i) {
        return i != INSTANCE.m1308getGroupULZAiWs();
    }

    /* JADX INFO: renamed from: isReusable-impl, reason: not valid java name */
    public static final boolean m1305isReusableimpl(int i) {
        return i != INSTANCE.m1309getNodeULZAiWs();
    }
