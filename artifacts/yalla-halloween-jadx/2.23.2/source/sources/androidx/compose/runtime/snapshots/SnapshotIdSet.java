...
public final class SnapshotIdSet implements Iterable<Integer>, KMappedMarker {
                ...
                if (j10 != j3) {
                    if (arrayList == null) {
                        ...
                        if (iArr3 != null) {
                            ...
                            for (int iOooO00o = 0; iOooO00o < length2; iOooO00o = o00O.OooO00o(iArr3[iOooO00o], arrayList, iOooO00o, 1)) {
                            }
                        }
                    }
    ...
    public String toString() {
        ...
        sb.append(" [");
        ArrayList arrayList = new ArrayList(CollectionsKt.OooO0oo(this));
        Iterator<Integer> it = iterator();
        while (it.hasNext()) {
            arrayList.add(String.valueOf(it.next().intValue()));
        }
        return oo000o.OooO0O0(sb, ListUtilsKt.fastJoinToString$default(arrayList, null, null, null, 0, null, null, 63, null), ']');
    }
}
