...
public final /* data */ class BiasAlignment implements Alignment {
    ...
    public long mo1337alignKFBX0sM(long size, long space, @NotNull LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        float fM3935getWidthimpl = (IntSize.m3935getWidthimpl(space) - IntSize.m3935getWidthimpl(size)) / 2.0f;
        float fM3934getHeightimpl = (IntSize.m3934getHeightimpl(space) - IntSize.m3934getHeightimpl(size)) / 2.0f;
        float f = 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt(((layoutDirection == LayoutDirection.Ltr ? this.horizontalBias : (-1) * this.horizontalBias) + f) * fM3935getWidthimpl), MathKt.roundToInt((f + this.verticalBias) * fM3934getHeightimpl));
    }
