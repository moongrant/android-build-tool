...
public final /* data */ class ZIndexElement extends ModifierNodeElement<ZIndexNode> {
    ...
    public void inspectableProperties(@NotNull InspectorInfo inspectorInfo) {
        OooOOO0.OooO00o(inspectorInfo, "<this>", "zIndex").set("zIndex", Float.valueOf(this.zIndex));
    }

    @NotNull
    public String toString() {
        return androidx.compose.animation.OooO00o.OooO00o(new StringBuilder("ZIndexElement(zIndex="), this.zIndex, ')');
    }
