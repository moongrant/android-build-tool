...
public final class AndroidAutofill implements Autofill {
    ...
    public AndroidAutofill(@NotNull View view, @NotNull AutofillTree autofillTree) {
        ...
        AutofillManager autofillManagerOooO00o = e0.OooO00o(view.getContext().getSystemService(OooOO0O.OooO00o()));
        if (autofillManagerOooO00o == null) {
            throw new IllegalStateException("Autofill service could not be located.".toString());
        }
        this.autofillManager = autofillManagerOooO00o;
