...
public final class BlurredEdgeTreatment {
    ...
    @NotNull
    private static final Shape Rectangle = m1344constructorimpl(RectangleShapeKt.getRectangleShape());

    @NotNull
    private static final Shape Unbounded = m1344constructorimpl(null);
    ...
    public static final /* synthetic */ BlurredEdgeTreatment m1343boximpl(Shape shape) {
        return new BlurredEdgeTreatment(shape);
    }

    @NotNull
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static Shape m1344constructorimpl(@Nullable Shape shape) {
        return shape;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m1345equalsimpl(Shape shape, Object obj) {
        return (obj instanceof BlurredEdgeTreatment) && Intrinsics.areEqual(shape, ((BlurredEdgeTreatment) obj).m1349unboximpl());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1346equalsimpl0(Shape shape, Shape shape2) {
        return Intrinsics.areEqual(shape, shape2);
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m1347hashCodeimpl(Shape shape) {
        if (shape == null) {
            return 0;
        }
    ...
    public static String m1348toStringimpl(Shape shape) {
        return "BlurredEdgeTreatment(shape=" + shape + ')';
    }

    public boolean equals(Object obj) {
        return m1345equalsimpl(this.shape, obj);
    }
    ...
    public int hashCode() {
        return m1347hashCodeimpl(this.shape);
    }

    public String toString() {
        return m1348toStringimpl(this.shape);
    }

    /* JADX INFO: renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ Shape m1349unboximpl() {
        return this.shape;
    }
}
