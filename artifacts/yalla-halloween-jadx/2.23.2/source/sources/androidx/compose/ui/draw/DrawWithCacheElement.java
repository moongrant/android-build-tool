...
final /* data */ class DrawWithCacheElement extends ModifierNodeElement<CacheDrawModifierNodeImpl> {
    ...
    public DrawWithCacheElement(@NotNull Function1<? super CacheDrawScope, DrawResult> onBuildDrawCache) {
    ...
    public void inspectableProperties(@NotNull InspectorInfo inspectorInfo) {
        OooOOO0.OooO00o(inspectorInfo, "<this>", "drawWithCache").set("onBuildDrawCache", this.onBuildDrawCache);
    }
