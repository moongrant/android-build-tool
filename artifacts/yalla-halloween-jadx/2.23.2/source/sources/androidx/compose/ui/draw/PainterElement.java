...
final /* data */ class PainterElement extends ModifierNodeElement<PainterNode> {
    ...
    public int hashCode() {
        ...
        int iOooO00o = o0OoOo0.OooO00o(this.alpha, (this.contentScale.hashCode() + ((this.alignment.hashCode() + ((iHashCode + r1) * 31)) * 31)) * 31, 31);
    ...
    public void inspectableProperties(@NotNull InspectorInfo inspectorInfo) {
        OooOOO0.OooO00o(inspectorInfo, "<this>", "paint").set("painter", this.painter);
        androidx.compose.foundation.OooO00o.OooO00o(this.sizeToIntrinsics, inspectorInfo.getProperties(), "sizeToIntrinsics", inspectorInfo).set("alignment", this.alignment);
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void update(@NotNull PainterNode node) {
        Intrinsics.checkNotNullParameter(node, "node");
        boolean sizeToIntrinsics = node.getSizeToIntrinsics();
        boolean z = this.sizeToIntrinsics;
        boolean z2 = sizeToIntrinsics != z || (z && !Size.m1512equalsimpl0(node.getPainter().getIntrinsicSize(), this.painter.getIntrinsicSize()));
