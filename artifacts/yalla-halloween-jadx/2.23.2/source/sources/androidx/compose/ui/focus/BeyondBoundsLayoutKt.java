...
public final class BeyondBoundsLayoutKt {
    ...
    public static final <T> T m1362searchBeyondBoundsOMvw8(@NotNull FocusTargetNode searchBeyondBounds, int i, @NotNull Function1<? super BeyondBoundsLayout.BeyondBoundsScope, ? extends T> block) {
        Modifier.Node nodePop;
        BeyondBoundsLayout beyondBoundsLayoutParent;
        int iM2790getBeforehoxUOeE;
        NodeChain nodes;
        ...
        if (FocusDirection.m1366equalsimpl0(i, companion.m1383getUpdhqQ8s())) {
            iM2790getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m2788getAbovehoxUOeE();
        } else if (FocusDirection.m1366equalsimpl0(i, companion.m1374getDowndhqQ8s())) {
            iM2790getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m2791getBelowhoxUOeE();
        } else if (FocusDirection.m1366equalsimpl0(i, companion.m1378getLeftdhqQ8s())) {
            iM2790getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m2792getLefthoxUOeE();
        } else if (FocusDirection.m1366equalsimpl0(i, companion.m1382getRightdhqQ8s())) {
            iM2790getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m2793getRighthoxUOeE();
        } else if (FocusDirection.m1366equalsimpl0(i, companion.m1379getNextdhqQ8s())) {
            iM2790getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m2789getAfterhoxUOeE();
        } else {
            if (!FocusDirection.m1366equalsimpl0(i, companion.m1381getPreviousdhqQ8s())) {
                throw new IllegalStateException("Unsupported direction for beyond bounds layout".toString());
            }
            iM2790getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m2790getBeforehoxUOeE();
        }
        return (T) beyondBoundsLayoutParent.mo630layouto7g1Pn8(iM2790getBeforehoxUOeE, block);
    }
}
