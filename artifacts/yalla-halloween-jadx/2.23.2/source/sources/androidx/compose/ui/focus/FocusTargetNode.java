...
public final class FocusTargetNode extends Modifier.Node implements FocusTargetModifierNode, ObserverModifierNode, ModifierLocalModifierNode {
    ...
    public final void m1393fetchCustomEnteraToIllA$ui_release(int focusDirection, @NotNull Function1<? super FocusRequester, Unit> block) {
        ...
        try {
            FocusRequester focusRequesterInvoke = fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m1363boximpl(focusDirection));
    ...
    public final void m1394fetchCustomExitaToIllA$ui_release(int focusDirection, @NotNull Function1<? super FocusRequester, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        ...
        try {
            FocusRequester focusRequesterInvoke = fetchFocusProperties$ui_release().getExit().invoke(FocusDirection.m1363boximpl(focusDirection));
            if (focusRequesterInvoke != FocusRequester.INSTANCE.getDefault()) {
                block.invoke(focusRequesterInvoke);
            }
        } finally {
