...
public final class CornerRadius {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m1431getZerokKHJgLs$annotations() {
        }

        /* JADX INFO: renamed from: getZero-kKHJgLs, reason: not valid java name */
        public final long m1432getZerokKHJgLs() {
    ...
    public static final /* synthetic */ CornerRadius m1413boximpl(long j) {
        return new CornerRadius(j);
    }

    @Stable
    /* JADX INFO: renamed from: component1-impl, reason: not valid java name */
    public static final float m1414component1impl(long j) {
        return m1422getXimpl(j);
    }

    @Stable
    /* JADX INFO: renamed from: component2-impl, reason: not valid java name */
    public static final float m1415component2impl(long j) {
        return m1423getYimpl(j);
    }
    ...
    public static final long m1417copyOHQCggk(long j, float f, float f2) {
        return CornerRadiusKt.CornerRadius(f, f2);
    }

    /* JADX INFO: renamed from: copy-OHQCggk$default, reason: not valid java name */
    public static /* synthetic */ long m1418copyOHQCggk$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m1422getXimpl(j);
        }
        if ((i & 2) != 0) {
        ...
        return m1417copyOHQCggk(j, f, f2);
    }

    @Stable
    /* JADX INFO: renamed from: div-Bz7bX_o, reason: not valid java name */
    public static final long m1419divBz7bX_o(long j, float f) {
        return CornerRadiusKt.CornerRadius(m1422getXimpl(j) / f, m1423getYimpl(j) / f);
    }
    ...
    public static final float m1422getXimpl(long j) {
    ...
    public static final float m1423getYimpl(long j) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
    ...
    public static final long m1425minusvF7bmM(long j, long j2) {
        return CornerRadiusKt.CornerRadius(m1422getXimpl(j) - m1422getXimpl(j2), m1423getYimpl(j) - m1423getYimpl(j2));
    }

    @Stable
    /* JADX INFO: renamed from: plus-vF7b-mM, reason: not valid java name */
    public static final long m1426plusvF7bmM(long j, long j2) {
        return CornerRadiusKt.CornerRadius(m1422getXimpl(j2) + m1422getXimpl(j), m1423getYimpl(j2) + m1423getYimpl(j));
    }

    @Stable
    /* JADX INFO: renamed from: times-Bz7bX_o, reason: not valid java name */
    public static final long m1427timesBz7bX_o(long j, float f) {
        return CornerRadiusKt.CornerRadius(m1422getXimpl(j) * f, m1423getYimpl(j) * f);
    }
    ...
    public static String m1428toStringimpl(long j) {
        if (m1422getXimpl(j) == m1423getYimpl(j)) {
            return "CornerRadius.circular(" + GeometryUtilsKt.toStringAsFixed(m1422getXimpl(j), 1) + ')';
        }
        return "CornerRadius.elliptical(" + GeometryUtilsKt.toStringAsFixed(m1422getXimpl(j), 1) + ", " + GeometryUtilsKt.toStringAsFixed(m1423getYimpl(j), 1) + ')';
    }

    @Stable
    /* JADX INFO: renamed from: unaryMinus-kKHJgLs, reason: not valid java name */
    public static final long m1429unaryMinuskKHJgLs(long j) {
        return CornerRadiusKt.CornerRadius(-m1422getXimpl(j), -m1423getYimpl(j));
    }

    public boolean equals(Object obj) {
        return m1420equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m1424hashCodeimpl(this.packedValue);
    }
