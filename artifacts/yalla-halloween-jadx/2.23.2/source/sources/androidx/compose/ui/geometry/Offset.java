...
public final class Offset {
    ...
    public static final /* synthetic */ Offset m1436boximpl(long j) {
        return new Offset(j);
    }

    @Stable
    /* JADX INFO: renamed from: component1-impl, reason: not valid java name */
    public static final float m1437component1impl(long j) {
        return m1447getXimpl(j);
    }

    @Stable
    /* JADX INFO: renamed from: component2-impl, reason: not valid java name */
    public static final float m1438component2impl(long j) {
        return m1448getYimpl(j);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m1439constructorimpl(long j) {
        return j;
    }

    /* JADX INFO: renamed from: copy-dBAh8RU, reason: not valid java name */
    public static final long m1440copydBAh8RU(long j, float f, float f2) {
        return OffsetKt.Offset(f, f2);
    }

    /* JADX INFO: renamed from: copy-dBAh8RU$default, reason: not valid java name */
    public static /* synthetic */ long m1441copydBAh8RU$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m1447getXimpl(j);
        }
        if ((i & 2) != 0) {
        ...
        return m1440copydBAh8RU(j, f, f2);
    }

    @Stable
    /* JADX INFO: renamed from: div-tuRUvjQ, reason: not valid java name */
    public static final long m1442divtuRUvjQ(long j, float f) {
        return OffsetKt.Offset(m1447getXimpl(j) / f, m1448getYimpl(j) / f);
    }
    ...
    public static final float m1445getDistanceimpl(long j) {
        return (float) Math.sqrt((m1448getYimpl(j) * m1448getYimpl(j)) + (m1447getXimpl(j) * m1447getXimpl(j)));
    }

    @Stable
    /* JADX INFO: renamed from: getDistanceSquared-impl, reason: not valid java name */
    public static final float m1446getDistanceSquaredimpl(long j) {
        return (m1448getYimpl(j) * m1448getYimpl(j)) + (m1447getXimpl(j) * m1447getXimpl(j));
    }
    ...
    public static final float m1447getXimpl(long j) {
        if (!(j != Unspecified)) {
    ...
    public static final float m1448getYimpl(long j) {
        if (!(j != Unspecified)) {
            throw new IllegalStateException("Offset is unspecified".toString());
        }
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
    ...
    public static int m1449hashCodeimpl(long j) {
        return (int) (j ^ (j >>> 32));
    }

    @Stable
    /* JADX INFO: renamed from: isValid-impl, reason: not valid java name */
    public static final boolean m1450isValidimpl(long j) {
        if ((Float.isNaN(m1447getXimpl(j)) || Float.isNaN(m1448getYimpl(j))) ? false : true) {
            return true;
        }
    ...
    public static final long m1451minusMKHz9U(long j, long j2) {
        return OffsetKt.Offset(m1447getXimpl(j) - m1447getXimpl(j2), m1448getYimpl(j) - m1448getYimpl(j2));
    }

    @Stable
    /* JADX INFO: renamed from: plus-MK-Hz9U, reason: not valid java name */
    public static final long m1452plusMKHz9U(long j, long j2) {
        return OffsetKt.Offset(m1447getXimpl(j2) + m1447getXimpl(j), m1448getYimpl(j2) + m1448getYimpl(j));
    }

    @Stable
    /* JADX INFO: renamed from: rem-tuRUvjQ, reason: not valid java name */
    public static final long m1453remtuRUvjQ(long j, float f) {
        return OffsetKt.Offset(m1447getXimpl(j) % f, m1448getYimpl(j) % f);
    }

    @Stable
    /* JADX INFO: renamed from: times-tuRUvjQ, reason: not valid java name */
    public static final long m1454timestuRUvjQ(long j, float f) {
        return OffsetKt.Offset(m1447getXimpl(j) * f, m1448getYimpl(j) * f);
    }
    ...
    public static String m1455toStringimpl(long j) {
        if (!OffsetKt.m1466isSpecifiedk4lQ0M(j)) {
            return "Offset.Unspecified";
        }
        return "Offset(" + GeometryUtilsKt.toStringAsFixed(m1447getXimpl(j), 1) + ", " + GeometryUtilsKt.toStringAsFixed(m1448getYimpl(j), 1) + ')';
    }

    @Stable
    /* JADX INFO: renamed from: unaryMinus-F1C5BW0, reason: not valid java name */
    public static final long m1456unaryMinusF1C5BW0(long j) {
        return OffsetKt.Offset(-m1447getXimpl(j), -m1448getYimpl(j));
    }

    public boolean equals(Object obj) {
        return m1443equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m1449hashCodeimpl(this.packedValue);
    }
