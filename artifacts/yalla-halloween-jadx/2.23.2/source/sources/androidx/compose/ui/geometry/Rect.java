...
public final /* data */ class Rect {
    ...
    public static /* synthetic */ void m1472getSizeNHjbRc$annotations() {
    }
    ...
    public final boolean m1473containsk4lQ0M(long offset) {
        return Offset.m1447getXimpl(offset) >= this.left && Offset.m1447getXimpl(offset) < this.right && Offset.m1448getYimpl(offset) >= this.top && Offset.m1448getYimpl(offset) < this.bottom;
    }
    ...
    public final long m1474getBottomCenterF1C5BW0() {
    ...
    public final long m1478getCenterLeftF1C5BW0() {
    ...
    public final long m1479getCenterRightF1C5BW0() {
    ...
    public final long m1480getSizeNHjbRc() {
    ...
    public final long m1481getTopCenterF1C5BW0() {
    ...
    public int hashCode() {
        return Float.floatToIntBits(this.bottom) + o0OoOo0.OooO00o(this.right, o0OoOo0.OooO00o(this.top, Float.floatToIntBits(this.left) * 31, 31), 31);
    }
    ...
    public final Rect m1484translatek4lQ0M(long offset) {
        return new Rect(Offset.m1447getXimpl(offset) + this.left, Offset.m1448getYimpl(offset) + this.top, Offset.m1447getXimpl(offset) + this.right, Offset.m1448getYimpl(offset) + this.bottom);
    }
}
