...
public final class RectKt {
    ...
    public static final Rect m1485Rect0a9Yr6o(long j, long j2) {
        return new Rect(Offset.m1447getXimpl(j), Offset.m1448getYimpl(j), Offset.m1447getXimpl(j2), Offset.m1448getYimpl(j2));
    }

    @Stable
    @NotNull
    /* JADX INFO: renamed from: Rect-3MmeM6k, reason: not valid java name */
    public static final Rect m1486Rect3MmeM6k(long j, float f) {
        return new Rect(Offset.m1447getXimpl(j) - f, Offset.m1448getYimpl(j) - f, Offset.m1447getXimpl(j) + f, Offset.m1448getYimpl(j) + f);
    }

    @Stable
    @NotNull
    /* JADX INFO: renamed from: Rect-tz77jQw, reason: not valid java name */
    public static final Rect m1487Recttz77jQw(long j, long j2) {
        return new Rect(Offset.m1447getXimpl(j), Offset.m1448getYimpl(j), Size.m1516getWidthimpl(j2) + Offset.m1447getXimpl(j), Size.m1513getHeightimpl(j2) + Offset.m1448getYimpl(j));
    }
