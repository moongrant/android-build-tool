...
public final class RoundRectKt {
    ...
    public static final RoundRect m1499RoundRectZAM2FJo(@NotNull Rect rect, long j, long j2, long j3, long j4) {
    ...
    public static final RoundRect m1501RoundRectgG7oq9Y(float f, float f2, float f3, float f4, long j) {
        return RoundRect(f, f2, f3, f4, CornerRadius.m1422getXimpl(j), CornerRadius.m1423getYimpl(j));
    }

    @NotNull
    /* JADX INFO: renamed from: RoundRect-sniSvfs, reason: not valid java name */
    public static final RoundRect m1502RoundRectsniSvfs(@NotNull Rect rect, long j) {
        Intrinsics.checkNotNullParameter(rect, "rect");
        return RoundRect(rect, CornerRadius.m1422getXimpl(j), CornerRadius.m1423getYimpl(j));
    }
    ...
    public static final Rect getSafeInnerRect(@NotNull RoundRect roundRect) {
        Intrinsics.checkNotNullParameter(roundRect, "<this>");
        float fMax = Math.max(CornerRadius.m1422getXimpl(roundRect.m1495getBottomLeftCornerRadiuskKHJgLs()), CornerRadius.m1422getXimpl(roundRect.m1497getTopLeftCornerRadiuskKHJgLs()));
        float fMax2 = Math.max(CornerRadius.m1423getYimpl(roundRect.m1497getTopLeftCornerRadiuskKHJgLs()), CornerRadius.m1423getYimpl(roundRect.m1498getTopRightCornerRadiuskKHJgLs()));
        return new Rect((fMax * 0.29289323f) + roundRect.getLeft(), (fMax2 * 0.29289323f) + roundRect.getTop(), roundRect.getRight() - (Math.max(CornerRadius.m1422getXimpl(roundRect.m1498getTopRightCornerRadiuskKHJgLs()), CornerRadius.m1422getXimpl(roundRect.m1496getBottomRightCornerRadiuskKHJgLs())) * 0.29289323f), roundRect.getBottom() - (Math.max(CornerRadius.m1423getYimpl(roundRect.m1496getBottomRightCornerRadiuskKHJgLs()), CornerRadius.m1423getYimpl(roundRect.m1495getBottomLeftCornerRadiuskKHJgLs())) * 0.29289323f));
    }
    ...
    public static final boolean isEllipse(@NotNull RoundRect roundRect) {
        Intrinsics.checkNotNullParameter(roundRect, "<this>");
        if (CornerRadius.m1422getXimpl(roundRect.m1497getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m1422getXimpl(roundRect.m1498getTopRightCornerRadiuskKHJgLs())) {
            if (CornerRadius.m1423getYimpl(roundRect.m1497getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m1423getYimpl(roundRect.m1498getTopRightCornerRadiuskKHJgLs())) {
                if (CornerRadius.m1422getXimpl(roundRect.m1498getTopRightCornerRadiuskKHJgLs()) == CornerRadius.m1422getXimpl(roundRect.m1496getBottomRightCornerRadiuskKHJgLs())) {
                    if (CornerRadius.m1423getYimpl(roundRect.m1498getTopRightCornerRadiuskKHJgLs()) == CornerRadius.m1423getYimpl(roundRect.m1496getBottomRightCornerRadiuskKHJgLs())) {
                        if (CornerRadius.m1422getXimpl(roundRect.m1496getBottomRightCornerRadiuskKHJgLs()) == CornerRadius.m1422getXimpl(roundRect.m1495getBottomLeftCornerRadiuskKHJgLs())) {
                            if ((CornerRadius.m1423getYimpl(roundRect.m1496getBottomRightCornerRadiuskKHJgLs()) == CornerRadius.m1423getYimpl(roundRect.m1495getBottomLeftCornerRadiuskKHJgLs())) && roundRect.getWidth() <= ((double) CornerRadius.m1422getXimpl(roundRect.m1497getTopLeftCornerRadiuskKHJgLs())) * 2.0d && roundRect.getHeight() <= ((double) CornerRadius.m1423getYimpl(roundRect.m1497getTopLeftCornerRadiuskKHJgLs())) * 2.0d) {
                                return true;
                            }
                        }
                    }
    ...
    public static final boolean isRect(@NotNull RoundRect roundRect) {
        ...
        boolean z6;
        Intrinsics.checkNotNullParameter(roundRect, "<this>");
        if (CornerRadius.m1422getXimpl(roundRect.m1497getTopLeftCornerRadiuskKHJgLs()) == 0.0f) {
            if (CornerRadius.m1422getXimpl(roundRect.m1498getTopRightCornerRadiuskKHJgLs()) == 0.0f) {
                z = true;
            } else {
                z = false;
            }
            if (z) {
                if (CornerRadius.m1422getXimpl(roundRect.m1495getBottomLeftCornerRadiuskKHJgLs()) == 0.0f) {
                    z2 = true;
                } else {
                    z2 = false;
                }
                if (z2) {
                    if (CornerRadius.m1422getXimpl(roundRect.m1496getBottomRightCornerRadiuskKHJgLs()) == 0.0f) {
                        z3 = true;
                    } else {
                        z3 = false;
                    }
                    ...
                    if (CornerRadius.m1423getYimpl(roundRect.m1496getBottomRightCornerRadiuskKHJgLs()) == 0.0f) {
                        z4 = true;
                    } else {
                        z4 = false;
                    }
                    ...
                    if (CornerRadius.m1423getYimpl(roundRect.m1495getBottomLeftCornerRadiuskKHJgLs()) == 0.0f) {
                        z5 = true;
                    } else {
                        z5 = false;
                    }
                ...
                if (CornerRadius.m1423getYimpl(roundRect.m1498getTopRightCornerRadiuskKHJgLs()) == 0.0f) {
                    z6 = true;
                } else {
                    z6 = false;
                }
            ...
            if (CornerRadius.m1423getYimpl(roundRect.m1497getTopLeftCornerRadiuskKHJgLs()) == 0.0f) {
                if (CornerRadius.m1422getXimpl(roundRect.m1498getTopRightCornerRadiuskKHJgLs()) == 0.0f) {
                    z = true;
                } else {
                    z = false;
    ...
    public static final boolean isSimple(@NotNull RoundRect roundRect) {
        Intrinsics.checkNotNullParameter(roundRect, "<this>");
        if (CornerRadius.m1422getXimpl(roundRect.m1497getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m1423getYimpl(roundRect.m1497getTopLeftCornerRadiuskKHJgLs())) {
            if (CornerRadius.m1422getXimpl(roundRect.m1497getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m1422getXimpl(roundRect.m1498getTopRightCornerRadiuskKHJgLs())) {
                if (CornerRadius.m1422getXimpl(roundRect.m1497getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m1423getYimpl(roundRect.m1498getTopRightCornerRadiuskKHJgLs())) {
                    if (CornerRadius.m1422getXimpl(roundRect.m1497getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m1422getXimpl(roundRect.m1496getBottomRightCornerRadiuskKHJgLs())) {
                        if (CornerRadius.m1422getXimpl(roundRect.m1497getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m1423getYimpl(roundRect.m1496getBottomRightCornerRadiuskKHJgLs())) {
                            if (CornerRadius.m1422getXimpl(roundRect.m1497getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m1422getXimpl(roundRect.m1495getBottomLeftCornerRadiuskKHJgLs())) {
                                if (CornerRadius.m1422getXimpl(roundRect.m1497getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m1423getYimpl(roundRect.m1495getBottomLeftCornerRadiuskKHJgLs())) {
                                    return true;
                                }
                            }
                        }
    ...
    public static final RoundRect lerp(@NotNull RoundRect start, @NotNull RoundRect stop, float f) {
        ...
        return new RoundRect(MathHelpersKt.lerp(start.getLeft(), stop.getLeft(), f), MathHelpersKt.lerp(start.getTop(), stop.getTop(), f), MathHelpersKt.lerp(start.getRight(), stop.getRight(), f), MathHelpersKt.lerp(start.getBottom(), stop.getBottom(), f), CornerRadiusKt.m1433lerp3Ry4LBc(start.m1497getTopLeftCornerRadiuskKHJgLs(), stop.m1497getTopLeftCornerRadiuskKHJgLs(), f), CornerRadiusKt.m1433lerp3Ry4LBc(start.m1498getTopRightCornerRadiuskKHJgLs(), stop.m1498getTopRightCornerRadiuskKHJgLs(), f), CornerRadiusKt.m1433lerp3Ry4LBc(start.m1496getBottomRightCornerRadiuskKHJgLs(), stop.m1496getBottomRightCornerRadiuskKHJgLs(), f), CornerRadiusKt.m1433lerp3Ry4LBc(start.m1495getBottomLeftCornerRadiuskKHJgLs(), stop.m1495getBottomLeftCornerRadiuskKHJgLs(), f), null);
    }

    @NotNull
    /* JADX INFO: renamed from: translate-Uv8p0NA, reason: not valid java name */
    public static final RoundRect m1503translateUv8p0NA(@NotNull RoundRect translate, long j) {
        Intrinsics.checkNotNullParameter(translate, "$this$translate");
        return new RoundRect(translate.getLeft() + Offset.m1447getXimpl(j), translate.getTop() + Offset.m1448getYimpl(j), translate.getRight() + Offset.m1447getXimpl(j), translate.getBottom() + Offset.m1448getYimpl(j), translate.m1497getTopLeftCornerRadiuskKHJgLs(), translate.m1498getTopRightCornerRadiuskKHJgLs(), translate.m1496getBottomRightCornerRadiuskKHJgLs(), translate.m1495getBottomLeftCornerRadiuskKHJgLs(), null);
    }
