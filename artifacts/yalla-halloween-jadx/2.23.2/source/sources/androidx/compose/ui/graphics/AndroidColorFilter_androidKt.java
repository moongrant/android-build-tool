...
public final class AndroidColorFilter_androidKt {
    ...
    public static final ColorFilter m1553actualColorMatrixColorFilterjHGOpc(@NotNull float[] colorMatrix) {
    ...
    public static final ColorFilter m1554actualLightingColorFilterOWjLjI(long j, long j2) {
        return new ColorFilter(new LightingColorFilter(ColorKt.m1735toArgb8_81llA(j), ColorKt.m1735toArgb8_81llA(j2)));
    }

    @NotNull
    /* JADX INFO: renamed from: actualTintColorFilter-xETnrds, reason: not valid java name */
    public static final ColorFilter m1555actualTintColorFilterxETnrds(long j, int i) {
        return new ColorFilter(Build.VERSION.SDK_INT >= 29 ? BlendModeColorFilterHelper.INSTANCE.m1633BlendModeColorFilterxETnrds(j, i) : new PorterDuffColorFilter(ColorKt.m1735toArgb8_81llA(j), AndroidBlendMode_androidKt.m1540toPorterDuffModes9anfk8(i)));
    }
