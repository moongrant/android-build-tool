...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(@NotNull android.graphics.Paint internalPaint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m1631getSrcOver0nO6VwU();
    }
    ...
    public long mo1562getColor0d7_KjU() {
    ...
    public int mo1563getFilterQualityfv9h1I() {
    ...
    public int mo1564getStrokeCapKaPHkGw() {
    ...
    public int mo1565getStrokeJoinLxFBmk8() {
    ...
    public int mo1566getStyleTiuSbCo() {
    ...
    public void mo1567setBlendModes9anfk8(int i) {
        if (BlendMode.m1600equalsimpl0(this._blendMode, i)) {
            return;
        }
        this._blendMode = i;
        AndroidPaint_androidKt.m1573setNativeBlendModeGB0RdKg(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* JADX INFO: renamed from: setColor-8_81llA, reason: not valid java name */
    public void mo1568setColor8_81llA(long j) {
        AndroidPaint_androidKt.m1574setNativeColor4WTKRHQ(this.internalPaint, j);
    }
    ...
    public void mo1569setFilterQualityvDHp3xo(int i) {
        AndroidPaint_androidKt.m1575setNativeFilterQuality50PEsBU(this.internalPaint, i);
    }
    ...
    public void mo1570setStrokeCapBeK7IIE(int i) {
        AndroidPaint_androidKt.m1576setNativeStrokeCapCSYIeUk(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* JADX INFO: renamed from: setStrokeJoin-Ww9F2mQ, reason: not valid java name */
    public void mo1571setStrokeJoinWw9F2mQ(int i) {
        AndroidPaint_androidKt.m1577setNativeStrokeJoinkLtJ_vA(this.internalPaint, i);
    }
    ...
    public void mo1572setStylek9PVt8s(int i) {
        AndroidPaint_androidKt.m1578setNativeStyle5YerkU(this.internalPaint, i);
    }
