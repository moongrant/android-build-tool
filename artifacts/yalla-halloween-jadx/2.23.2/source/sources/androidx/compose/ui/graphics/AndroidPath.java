...
public final class AndroidPath implements Path {
    ...
    public void mo1579addPathUv8p0NA(@NotNull Path path, long offset) {
        Intrinsics.checkNotNullParameter(path, "path");
        android.graphics.Path path2 = this.internalPath;
        if (!(path instanceof AndroidPath)) {
            throw new UnsupportedOperationException("Unable to obtain android.graphics.Path");
        }
        path2.addPath(((AndroidPath) path).getInternalPath(), Offset.m1447getXimpl(offset), Offset.m1448getYimpl(offset));
    }
    ...
    public void addRoundRect(@NotNull RoundRect roundRect) {
        ...
        this.radii[0] = CornerRadius.m1422getXimpl(roundRect.m1497getTopLeftCornerRadiuskKHJgLs());
        this.radii[1] = CornerRadius.m1423getYimpl(roundRect.m1497getTopLeftCornerRadiuskKHJgLs());
        this.radii[2] = CornerRadius.m1422getXimpl(roundRect.m1498getTopRightCornerRadiuskKHJgLs());
        this.radii[3] = CornerRadius.m1423getYimpl(roundRect.m1498getTopRightCornerRadiuskKHJgLs());
        this.radii[4] = CornerRadius.m1422getXimpl(roundRect.m1496getBottomRightCornerRadiuskKHJgLs());
        this.radii[5] = CornerRadius.m1423getYimpl(roundRect.m1496getBottomRightCornerRadiuskKHJgLs());
        this.radii[6] = CornerRadius.m1422getXimpl(roundRect.m1495getBottomLeftCornerRadiuskKHJgLs());
        this.radii[7] = CornerRadius.m1423getYimpl(roundRect.m1495getBottomLeftCornerRadiuskKHJgLs());
    ...
    public final /* synthetic */ void arcToRad(Rect rect, float f, float f2, boolean z) {
        o00Oo00.OooO00o(this, rect, f, f2, z);
    }
    ...
    public int mo1580getFillTypeRgk1Os() {
        return this.internalPath.getFillType() == android.graphics.Path.FillType.EVEN_ODD ? PathFillType.INSTANCE.m1935getEvenOddRgk1Os() : PathFillType.INSTANCE.m1936getNonZeroRgk1Os();
    }
    ...
    public boolean mo1581opN5in7k0(@NotNull Path path1, @NotNull Path path2, int operation) {
        android.graphics.Path.Op op;
        Intrinsics.checkNotNullParameter(path1, "path1");
        Intrinsics.checkNotNullParameter(path2, "path2");
        PathOperation.Companion companion = PathOperation.INSTANCE;
        if (PathOperation.m1940equalsimpl0(operation, companion.m1944getDifferenceb3I0S0c())) {
            op = android.graphics.Path.Op.DIFFERENCE;
        } else if (PathOperation.m1940equalsimpl0(operation, companion.m1945getIntersectb3I0S0c())) {
            op = android.graphics.Path.Op.INTERSECT;
        } else if (PathOperation.m1940equalsimpl0(operation, companion.m1946getReverseDifferenceb3I0S0c())) {
            op = android.graphics.Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m1940equalsimpl0(operation, companion.m1947getUnionb3I0S0c()) ? android.graphics.Path.Op.UNION : android.graphics.Path.Op.XOR;
        }
    ...
    public void mo1582setFillTypeoQ8Xj4U(int i) {
        this.internalPath.setFillType(PathFillType.m1931equalsimpl0(i, PathFillType.INSTANCE.m1935getEvenOddRgk1Os()) ? android.graphics.Path.FillType.EVEN_ODD : android.graphics.Path.FillType.WINDING);
    }

    @Override // androidx.compose.ui.graphics.Path
    /* JADX INFO: renamed from: transform-58bKbWc, reason: not valid java name */
    public void mo1583transform58bKbWc(@NotNull float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        AndroidMatrixConversions_androidKt.m1559setFromEL8BTi8(this.mMatrix, matrix);
        this.internalPath.transform(this.mMatrix);
    }

    @Override // androidx.compose.ui.graphics.Path
    /* JADX INFO: renamed from: translate-k-4lQ0M, reason: not valid java name */
    public void mo1584translatek4lQ0M(long offset) {
        this.mMatrix.reset();
        this.mMatrix.setTranslate(Offset.m1447getXimpl(offset), Offset.m1448getYimpl(offset));
        this.internalPath.transform(this.mMatrix);
    }
