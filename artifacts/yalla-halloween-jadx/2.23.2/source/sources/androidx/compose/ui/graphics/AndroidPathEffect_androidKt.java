...
public final class AndroidPathEffect_androidKt {
    ...
    public static final PathEffect m1585actualStampedPathEffect7aD1DOk(@NotNull Path shape, float f, float f2, int i) {
        Intrinsics.checkNotNullParameter(shape, "shape");
        if (shape instanceof AndroidPath) {
            return new AndroidPathEffect(new PathDashPathEffect(((AndroidPath) shape).getInternalPath(), f, f2, m1586toAndroidPathDashPathEffectStyleoQv6xUo(i)));
        }
    ...
    public static final PathDashPathEffect.Style m1586toAndroidPathDashPathEffectStyleoQv6xUo(int i) {
        StampedPathEffectStyle.Companion companion = StampedPathEffectStyle.INSTANCE;
        if (StampedPathEffectStyle.m1991equalsimpl0(i, companion.m1995getMorphYpspkwk())) {
            return PathDashPathEffect.Style.MORPH;
        }
        if (StampedPathEffectStyle.m1991equalsimpl0(i, companion.m1996getRotateYpspkwk())) {
            return PathDashPathEffect.Style.ROTATE;
        }
        return StampedPathEffectStyle.m1991equalsimpl0(i, companion.m1997getTranslateYpspkwk()) ? PathDashPathEffect.Style.TRANSLATE : PathDashPathEffect.Style.TRANSLATE;
    }
