...
public final class AndroidVertexMode_androidKt {
    ...
    public static final android.graphics.Canvas.VertexMode m1595toAndroidVertexModeJOOmi9M(int i) {
        VertexMode.Companion companion = VertexMode.INSTANCE;
        if (VertexMode.m2047equalsimpl0(i, companion.m2053getTrianglesc2xauaI())) {
            return android.graphics.Canvas.VertexMode.TRIANGLES;
        }
        if (VertexMode.m2047equalsimpl0(i, companion.m2052getTriangleStripc2xauaI())) {
            return android.graphics.Canvas.VertexMode.TRIANGLE_STRIP;
        }
        return VertexMode.m2047equalsimpl0(i, companion.m2051getTriangleFanc2xauaI()) ? android.graphics.Canvas.VertexMode.TRIANGLE_FAN : android.graphics.Canvas.VertexMode.TRIANGLES;
    }
}
