...
public final class ColorFilter {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ ColorFilter m1722tintxETnrds$default(Companion companion, long j, int i, int i2, Object obj) {
            if ((i2 & 2) != 0) {
                i = BlendMode.INSTANCE.m1629getSrcIn0nO6VwU();
            }
            return companion.m1725tintxETnrds(j, i);
        }

        @Stable
        @NotNull
        /* JADX INFO: renamed from: colorMatrix-jHG-Opc, reason: not valid java name */
        public final ColorFilter m1723colorMatrixjHGOpc(@NotNull float[] colorMatrix) {
            Intrinsics.checkNotNullParameter(colorMatrix, "colorMatrix");
            return AndroidColorFilter_androidKt.m1553actualColorMatrixColorFilterjHGOpc(colorMatrix);
        }

        @Stable
        @NotNull
        /* JADX INFO: renamed from: lighting--OWjLjI, reason: not valid java name */
        public final ColorFilter m1724lightingOWjLjI(long multiply, long add) {
            return AndroidColorFilter_androidKt.m1554actualLightingColorFilterOWjLjI(multiply, add);
        }

        @Stable
        @NotNull
        /* JADX INFO: renamed from: tint-xETnrds, reason: not valid java name */
        public final ColorFilter m1725tintxETnrds(long color, int blendMode) {
            return AndroidColorFilter_androidKt.m1555actualTintColorFilterxETnrds(color, blendMode);
        }
    }
