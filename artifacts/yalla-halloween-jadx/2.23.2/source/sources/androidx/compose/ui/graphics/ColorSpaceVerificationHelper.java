...
final class ColorSpaceVerificationHelper {
    ...
    /* JADX WARN: Type inference failed for: r6v0, types: [androidx.compose.ui.graphics.o00OO] */
    /* JADX WARN: Type inference failed for: r7v0, types: [androidx.compose.ui.graphics.o00OOO00] */
    @JvmStatic
    @NotNull
    @DoNotInline
    @RequiresApi(26)
    public static final ColorSpace androidColorSpace(@NotNull androidx.compose.ui.graphics.colorspace.ColorSpace colorSpace) {
        ...
        if (colorSpace instanceof Rgb) {
            ...
            if (transferParameters != null) {
                o00O0OOO.OooO00o();
                transferParametersOooO00o = o00O0OO0.OooO00o(transferParameters.getA(), transferParameters.getB(), transferParameters.getC(), transferParameters.getD(), transferParameters.getE(), transferParameters.getF(), transferParameters.getGamma());
            } else {
                transferParametersOooO00o = null;
            }
            if (transferParametersOooO00o != null) {
                oo0oOO0.OooO00o();
                rgbOooO00o = o00O0OO.OooO00o(colorSpace.getName(), ((Rgb) colorSpace).getPrimaries(), xyz$ui_graphics_release, transferParametersOooO00o);
            } else {
                oo0oOO0.OooO00o();
                ...
                ?? r6 = new DoubleUnaryOperator() { // from class: androidx.compose.ui.graphics.o00OO
                ...
                rgbOooO00o = oo0o0O0.OooO00o(name, primaries, xyz$ui_graphics_release, r6, new DoubleUnaryOperator() { // from class: androidx.compose.ui.graphics.o00OOO00
                    @Override // java.util.function.DoubleUnaryOperator
                    public final double applyAsDouble(double d) {
            ...
            colorSpaceOooO00o = o000.OooO00o(rgbOooO00o);
        } else {
    ...
    public static final androidx.compose.ui.graphics.colorspace.ColorSpace composeColorSpace(@NotNull final ColorSpace colorSpace) {
        ...
        if (!o000O.OooO00o(colorSpace)) {
            return ColorSpaces.INSTANCE.getSrgb();
        }
        ColorSpace.Rgb.TransferParameters transferParameters = o000O00.OooO00o(colorSpace).getTransferParameters();
        WhitePoint whitePoint = o000O00.OooO00o(colorSpace).getWhitePoint().length == 3 ? new WhitePoint(o000O00.OooO00o(colorSpace).getWhitePoint()[0], o000O00.OooO00o(colorSpace).getWhitePoint()[1], o000O00.OooO00o(colorSpace).getWhitePoint()[2]) : new WhitePoint(o000O00.OooO00o(colorSpace).getWhitePoint()[0], o000O00.OooO00o(colorSpace).getWhitePoint()[1]);
        ...
        String name = o000O00.OooO00o(colorSpace).getName();
        Intrinsics.checkNotNullExpressionValue(name, "this.name");
        float[] primaries = o000O00.OooO00o(colorSpace).getPrimaries();
        Intrinsics.checkNotNullExpressionValue(primaries, "this.primaries");
        return new Rgb(name, primaries, whitePoint, o000O00.OooO00o(colorSpace).getTransform(), new DoubleFunction() { // from class: androidx.compose.ui.graphics.o00OOO0
            @Override // androidx.compose.ui.graphics.colorspace.DoubleFunction
            public final double invoke(double d) {
                return ColorSpaceVerificationHelper.composeColorSpace$lambda$2(colorSpace, d);
            }
        }, new DoubleFunction() { // from class: androidx.compose.ui.graphics.o00OOO0O
            @Override // androidx.compose.ui.graphics.colorspace.DoubleFunction
            public final double invoke(double d) {
                return ColorSpaceVerificationHelper.composeColorSpace$lambda$3(colorSpace, d);
            }
        }, colorSpace.getMinValue(0), colorSpace.getMaxValue(0), transferParameters2, o000O00.OooO00o(colorSpace).getId());
    }
    ...
    public static final double composeColorSpace$lambda$2(ColorSpace this_composeColorSpace, double d) {
        ...
        return o000O00.OooO00o(this_composeColorSpace).getOetf().applyAsDouble(d);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final double composeColorSpace$lambda$3(ColorSpace this_composeColorSpace, double d) {
        Intrinsics.checkNotNullParameter(this_composeColorSpace, "$this_composeColorSpace");
        return o000O00.OooO00o(this_composeColorSpace).getEotf().applyAsDouble(d);
    }
}
