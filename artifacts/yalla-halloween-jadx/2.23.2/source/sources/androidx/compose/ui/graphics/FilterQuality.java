...
public final class FilterQuality {
    ...
    private static final int None = m1769constructorimpl(0);
    private static final int Low = m1769constructorimpl(1);
    private static final int Medium = m1769constructorimpl(2);
    private static final int High = m1769constructorimpl(3);
    ...
    public static final /* synthetic */ FilterQuality m1768boximpl(int i) {
    ...
    public static boolean m1770equalsimpl(int i, Object obj) {
        return (obj instanceof FilterQuality) && i == ((FilterQuality) obj).m1774unboximpl();
    }
    ...
    public static String m1773toStringimpl(int i) {
        if (m1771equalsimpl0(i, None)) {
            return "None";
        }
        if (m1771equalsimpl0(i, Low)) {
            return "Low";
        }
        if (m1771equalsimpl0(i, Medium)) {
            return "Medium";
        }
        return m1771equalsimpl0(i, High) ? "High" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
