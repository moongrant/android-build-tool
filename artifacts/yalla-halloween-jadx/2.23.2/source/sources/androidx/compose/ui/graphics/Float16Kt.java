...
public final class Float16Kt {
    ...
    public static final short m1822maxAoSsdG0(short s, short s2) {
        if (Float16.m1795isNaNimpl(s) || Float16.m1795isNaNimpl(s2)) {
            return Float16.INSTANCE.m1817getNaNslo4al4();
        }
        return Float16.m1782compareTo41bOqos(s, s2) >= 0 ? s : s2;
    }

    /* JADX INFO: renamed from: min-AoSsdG0, reason: not valid java name */
    public static final short m1823minAoSsdG0(short s, short s2) {
        if (Float16.m1795isNaNimpl(s) || Float16.m1795isNaNimpl(s2)) {
            return Float16.INSTANCE.m1817getNaNslo4al4();
        }
        return Float16.m1782compareTo41bOqos(s, s2) <= 0 ? s : s2;
