...
final /* data */ class GraphicsLayerElement extends ModifierNodeElement<SimpleGraphicsLayerModifier> {
    ...
    public final long m1830getAmbientShadowColor0d7_KjU() {
        return this.ambientShadowColor;
    }
    ...
    public final int m1831getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }
    ...
    public final long m1832getSpotShadowColor0d7_KjU() {
        return this.spotShadowColor;
    }

    /* JADX INFO: renamed from: getTransformOrigin-SzJe1aQ, reason: not valid java name */
    public final long m1833getTransformOriginSzJe1aQ() {
        return this.transformOrigin;
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int iHashCode = (this.shape.hashCode() + ((TransformOrigin.m2040hashCodeimpl(this.transformOrigin) + androidx.compose.animation.o0OoOo0.OooO00o(this.cameraDistance, androidx.compose.animation.o0OoOo0.OooO00o(this.rotationZ, androidx.compose.animation.o0OoOo0.OooO00o(this.rotationY, androidx.compose.animation.o0OoOo0.OooO00o(this.rotationX, androidx.compose.animation.o0OoOo0.OooO00o(this.shadowElevation, androidx.compose.animation.o0OoOo0.OooO00o(this.translationY, androidx.compose.animation.o0OoOo0.OooO00o(this.translationX, androidx.compose.animation.o0OoOo0.OooO00o(this.alpha, androidx.compose.animation.o0OoOo0.OooO00o(this.scaleY, Float.floatToIntBits(this.scaleX) * 31, 31), 31), 31), 31), 31), 31), 31), 31), 31)) * 31)) * 31;
        boolean z = this.clip;
        ?? r1 = z;
        if (z) {
            r1 = 1;
        ...
        return CompositingStrategy.m1762hashCodeimpl(this.compositingStrategy) + androidx.compose.material.OooO.OooO00o(this.spotShadowColor, androidx.compose.material.OooO.OooO00o(this.ambientShadowColor, (i + (renderEffect == null ? 0 : renderEffect.hashCode())) * 31, 31), 31);
    }
    ...
    public void inspectableProperties(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("transformOrigin", TransformOrigin.m2030boximpl(this.transformOrigin));
        ...
        inspectorInfo.getProperties().set("ambientShadowColor", Color.m1671boximpl(this.ambientShadowColor));
        inspectorInfo.getProperties().set("spotShadowColor", Color.m1671boximpl(this.spotShadowColor));
        inspectorInfo.getProperties().set("compositingStrategy", CompositingStrategy.m1758boximpl(this.compositingStrategy));
    }
    ...
    public void update(@NotNull SimpleGraphicsLayerModifier node) {
        ...
        node.m1986setTransformOrigin__ExYCQ(this.transformOrigin);
        node.setShape(this.shape);
        node.setClip(this.clip);
        node.setRenderEffect(this.renderEffect);
        node.m1983setAmbientShadowColor8_81llA(this.ambientShadowColor);
        node.m1985setSpotShadowColor8_81llA(this.spotShadowColor);
        node.m1984setCompositingStrategyaDBOjCE(this.compositingStrategy);
