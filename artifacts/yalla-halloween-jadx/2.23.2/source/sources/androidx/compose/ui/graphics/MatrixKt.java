...
public final class MatrixKt {
    ...
    public static final float m1909dotp89u6pk(float[] fArr, int i, float[] fArr2, int i2) {
        int i3 = i * 4;
    ...
    public static final boolean m1910isIdentity58bKbWc(@NotNull float[] isIdentity) {
