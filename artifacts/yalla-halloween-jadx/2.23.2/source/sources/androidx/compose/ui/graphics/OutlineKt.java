...
public final class OutlineKt {
    public static final void addOutline(@NotNull Path path, @NotNull Outline outline) {
        ...
        if (outline instanceof Outline.Rectangle) {
            ...
            o00Oo00.OooO0oO(path, ((Outline.Generic) outline).getPath(), 0L, 2, null);
        }
    }
    ...
    public static final void drawOutline(@NotNull Canvas canvas, @NotNull Outline outline, @NotNull Paint paint) {
        ...
        if (!(outline instanceof Outline.Rounded)) {
            ...
            if (roundRectPath != null) {
                ...
                canvas.drawRoundRect(rounded.getRoundRect().getLeft(), rounded.getRoundRect().getTop(), rounded.getRoundRect().getRight(), rounded.getRoundRect().getBottom(), CornerRadius.m1422getXimpl(rounded.getRoundRect().m1495getBottomLeftCornerRadiuskKHJgLs()), CornerRadius.m1423getYimpl(rounded.getRoundRect().m1495getBottomLeftCornerRadiuskKHJgLs()), paint);
            }
        }
    }

    /* JADX INFO: renamed from: drawOutline-hn5TExg, reason: not valid java name */
    public static final void m1911drawOutlinehn5TExg(@NotNull DrawScope drawOutline, @NotNull Outline outline, @NotNull Brush brush, float f, @NotNull DrawStyle style, @Nullable ColorFilter colorFilter, int i) {
        Path path;
        ...
        if (outline instanceof Outline.Rectangle) {
            ...
            drawOutline.mo2113drawRectAsUm42w(brush, topLeft(rect), size(rect), f, style, colorFilter, i);
            return;
        }
        if (outline instanceof Outline.Rounded) {
            Outline.Rounded rounded = (Outline.Rounded) outline;
            ...
            if (path == null) {
                ...
                drawOutline.mo2115drawRoundRectZuiqVtQ(brush, topLeft(roundRect), size(roundRect), CornerRadiusKt.CornerRadius$default(CornerRadius.m1422getXimpl(roundRect.m1495getBottomLeftCornerRadiuskKHJgLs()), 0.0f, 2, null), f, style, colorFilter, i);
                return;
            }
        } else {
            if (!(outline instanceof Outline.Generic)) {
        ...
        drawOutline.mo2109drawPathGBMwjPU(path, brush, f, style, colorFilter, i);
    }

    /* JADX INFO: renamed from: drawOutline-hn5TExg$default, reason: not valid java name */
    public static /* synthetic */ void m1912drawOutlinehn5TExg$default(DrawScope drawScope, Outline outline, Brush brush, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            f = 1.0f;
        }
        float f2 = f;
        ...
        m1911drawOutlinehn5TExg(drawScope, outline, brush, f2, drawStyle2, colorFilter2, i);
    }

    /* JADX INFO: renamed from: drawOutline-wDX37Ww, reason: not valid java name */
    public static final void m1913drawOutlinewDX37Ww(@NotNull DrawScope drawOutline, @NotNull Outline outline, long j, float f, @NotNull DrawStyle style, @Nullable ColorFilter colorFilter, int i) {
        Path path;
        Intrinsics.checkNotNullParameter(drawOutline, "$this$drawOutline");
        Intrinsics.checkNotNullParameter(outline, "outline");
        Intrinsics.checkNotNullParameter(style, "style");
        if (outline instanceof Outline.Rectangle) {
            Rect rect = ((Outline.Rectangle) outline).getRect();
            drawOutline.mo2114drawRectnJ9OG0(j, topLeft(rect), size(rect), f, style, colorFilter, i);
            return;
        }
        if (outline instanceof Outline.Rounded) {
            Outline.Rounded rounded = (Outline.Rounded) outline;
            ...
            if (path == null) {
                RoundRect roundRect = rounded.getRoundRect();
                drawOutline.mo2116drawRoundRectuAw5IA(j, topLeft(roundRect), size(roundRect), CornerRadiusKt.CornerRadius$default(CornerRadius.m1422getXimpl(roundRect.m1495getBottomLeftCornerRadiuskKHJgLs()), 0.0f, 2, null), style, f, colorFilter, i);
                return;
            }
        } else {
            if (!(outline instanceof Outline.Generic)) {
        ...
        drawOutline.mo2110drawPathLG529CI(path, j, f, style, colorFilter, i);
    }
    ...
    public static final boolean hasSameCornerRadius(RoundRect roundRect) {
        boolean z;
        boolean z2;
        if (CornerRadius.m1422getXimpl(roundRect.m1495getBottomLeftCornerRadiuskKHJgLs()) == CornerRadius.m1422getXimpl(roundRect.m1496getBottomRightCornerRadiuskKHJgLs())) {
            if (CornerRadius.m1422getXimpl(roundRect.m1496getBottomRightCornerRadiuskKHJgLs()) == CornerRadius.m1422getXimpl(roundRect.m1498getTopRightCornerRadiuskKHJgLs())) {
                if (CornerRadius.m1422getXimpl(roundRect.m1498getTopRightCornerRadiuskKHJgLs()) == CornerRadius.m1422getXimpl(roundRect.m1497getTopLeftCornerRadiuskKHJgLs())) {
                    z = true;
                } else {
                    z = false;
                }
        ...
        if (CornerRadius.m1423getYimpl(roundRect.m1495getBottomLeftCornerRadiuskKHJgLs()) == CornerRadius.m1423getYimpl(roundRect.m1496getBottomRightCornerRadiuskKHJgLs())) {
            if (CornerRadius.m1423getYimpl(roundRect.m1496getBottomRightCornerRadiuskKHJgLs()) == CornerRadius.m1423getYimpl(roundRect.m1498getTopRightCornerRadiuskKHJgLs())) {
                if (CornerRadius.m1423getYimpl(roundRect.m1498getTopRightCornerRadiuskKHJgLs()) == CornerRadius.m1423getYimpl(roundRect.m1497getTopLeftCornerRadiuskKHJgLs())) {
                    z2 = true;
                } else {
                    z2 = false;
                }
