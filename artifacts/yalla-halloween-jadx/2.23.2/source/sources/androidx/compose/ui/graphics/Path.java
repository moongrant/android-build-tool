...
public interface Path {
    ...
    public static final class Companion {
        ...
        public final Path m1924combinexh6zSI8(int operation, @NotNull Path path1, @NotNull Path path2) {
            Intrinsics.checkNotNullParameter(path1, "path1");
            Intrinsics.checkNotNullParameter(path2, "path2");
            Path Path = AndroidPath_androidKt.Path();
            if (Path.mo1581opN5in7k0(path1, path2, operation)) {
                return Path;
            }
    ...
    public static final class DefaultImpls {
        ...
        public static void arcToRad(@NotNull Path path, @NotNull Rect rect, float f, float f2, boolean z) {
            ...
            o00Oo00.OooO00o(path, rect, f, f2, z);
        }

        @Deprecated
        public static void rewind(@NotNull Path path) {
            o00Oo00.OooO0O0(path);
        }

        @Deprecated
        /* JADX INFO: renamed from: transform-58bKbWc, reason: not valid java name */
        public static void m1926transform58bKbWc(@NotNull Path path, @NotNull float[] matrix) {
            Intrinsics.checkNotNullParameter(matrix, "matrix");
            o00Oo00.OooO0OO(path, matrix);
        }
    }
    ...
    void mo1579addPathUv8p0NA(@NotNull Path path, long offset);
    ...
    boolean mo1581opN5in7k0(@NotNull Path path1, @NotNull Path path2, int operation);
    ...
    void mo1582setFillTypeoQ8Xj4U(int i);

    /* JADX INFO: renamed from: transform-58bKbWc */
    void mo1583transform58bKbWc(@NotNull float[] matrix);

    /* JADX INFO: renamed from: translate-k-4lQ0M */
    void mo1584translatek4lQ0M(long offset);
}
