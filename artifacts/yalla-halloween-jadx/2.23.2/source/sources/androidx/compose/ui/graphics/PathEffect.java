...
public interface PathEffect {
    ...
    public static final class Companion {
        ...
        public final PathEffect m1927stampedPathEffect7aD1DOk(@NotNull Path shape, float advance, float phase, int style) {
            Intrinsics.checkNotNullParameter(shape, "shape");
            return AndroidPathEffect_androidKt.m1585actualStampedPathEffect7aD1DOk(shape, advance, phase, style);
        }
    }
}
