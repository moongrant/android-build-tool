...
public final class PathOperation {
    ...
    private static final int Difference = m1938constructorimpl(0);
    private static final int Intersect = m1938constructorimpl(1);
    private static final int Union = m1938constructorimpl(2);
    private static final int Xor = m1938constructorimpl(3);
    private static final int ReverseDifference = m1938constructorimpl(4);
    ...
    public static final /* synthetic */ PathOperation m1937boximpl(int i) {
        return new PathOperation(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m1938constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m1939equalsimpl(int i, Object obj) {
        return (obj instanceof PathOperation) && i == ((PathOperation) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1940equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m1941hashCodeimpl(int i) {
        return i;
    }

    @NotNull
    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m1942toStringimpl(int i) {
        if (m1940equalsimpl0(i, Difference)) {
            return "Difference";
        }
        if (m1940equalsimpl0(i, Intersect)) {
            return "Intersect";
        }
        if (m1940equalsimpl0(i, Union)) {
            return "Union";
        }
        if (m1940equalsimpl0(i, Xor)) {
            return "Xor";
        }
        return m1940equalsimpl0(i, ReverseDifference) ? "ReverseDifference" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
