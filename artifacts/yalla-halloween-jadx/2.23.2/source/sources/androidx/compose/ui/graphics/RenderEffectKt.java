...
public final class RenderEffectKt {
    ...
    public static final BlurEffect m1960BlurEffect3YTHUZs(float f, float f2, int i) {
        return new BlurEffect(null, f, f2, i, null);
    }

    /* JADX INFO: renamed from: BlurEffect-3YTHUZs$default, reason: not valid java name */
    public static /* synthetic */ BlurEffect m1961BlurEffect3YTHUZs$default(float f, float f2, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = TileMode.INSTANCE.m2025getClamp3opZhB0();
        }
        return m1960BlurEffect3YTHUZs(f, f2, i);
    }
