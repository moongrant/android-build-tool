...
public final class Shadow {
    ...
    public static /* synthetic */ Shadow m1973copyqcb84PM$default(Shadow shadow, long j, long j2, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            j = shadow.color;
        }
        long j3 = j;
        ...
        return shadow.m1976copyqcb84PM(j3, j4, f);
    }
    ...
    public static /* synthetic */ void m1974getColor0d7_KjU$annotations() {
    }

    @Stable
    /* JADX INFO: renamed from: getOffset-F1C5BW0$annotations, reason: not valid java name */
    public static /* synthetic */ void m1975getOffsetF1C5BW0$annotations() {
    }

    @NotNull
    /* JADX INFO: renamed from: copy-qcb84PM, reason: not valid java name */
    public final Shadow m1976copyqcb84PM(long color, long offset, float blurRadius) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (Color.m1682equalsimpl0(this.color, shadow.color) && Offset.m1444equalsimpl0(this.offset, shadow.offset)) {
    ...
    public int hashCode() {
        return Float.floatToIntBits(this.blurRadius) + ((Offset.m1449hashCodeimpl(this.offset) + (Color.m1688hashCodeimpl(this.color) * 31)) * 31);
    }

    @NotNull
    public String toString() {
        StringBuilder sb = new StringBuilder("Shadow(color=");
        sb.append((Object) Color.m1689toStringimpl(this.color));
        sb.append(", offset=");
        sb.append((Object) Offset.m1455toStringimpl(this.offset));
        sb.append(", blurRadius=");
        return androidx.compose.animation.OooO00o.OooO00o(sb, this.blurRadius, ')');
    }
    ...
    public /* synthetic */ Shadow(long j, long j2, float f, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? ColorKt.Color(4278190080L) : j, (i & 2) != 0 ? Offset.INSTANCE.m1463getZeroF1C5BW0() : j2, (i & 4) != 0 ? 0.0f : f, null);
    }
}
