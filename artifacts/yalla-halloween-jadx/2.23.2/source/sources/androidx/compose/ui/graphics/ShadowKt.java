...
public final class ShadowKt {
    ...
    public static final Shadow lerp(@NotNull Shadow start, @NotNull Shadow stop, float f) {
        ...
        return new Shadow(ColorKt.m1732lerpjxsXWHM(start.getColor(), stop.getColor(), f), OffsetKt.m1470lerpWko1d7g(start.getOffset(), stop.getOffset(), f), MathHelpersKt.lerp(start.getBlurRadius(), stop.getBlurRadius(), f), null);
    }
}
