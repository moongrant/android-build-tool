...
public final class StampedPathEffectStyle {
    ...
    private static final int Translate = m1989constructorimpl(0);
    private static final int Rotate = m1989constructorimpl(1);
    private static final int Morph = m1989constructorimpl(2);
    ...
    public static final /* synthetic */ StampedPathEffectStyle m1988boximpl(int i) {
    ...
    public static String m1993toStringimpl(int i) {
        if (m1991equalsimpl0(i, Translate)) {
            return "Translate";
        }
        if (m1991equalsimpl0(i, Rotate)) {
            return "Rotate";
        }
        return m1991equalsimpl0(i, Morph) ? "Morph" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
