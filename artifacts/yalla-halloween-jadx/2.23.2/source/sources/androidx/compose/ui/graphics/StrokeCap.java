...
public final class StrokeCap {
    ...
    private static final int Butt = m1999constructorimpl(0);
    private static final int Round = m1999constructorimpl(1);
    private static final int Square = m1999constructorimpl(2);
    ...
    public static final /* synthetic */ StrokeCap m1998boximpl(int i) {
    ...
    public static String m2003toStringimpl(int i) {
        if (m2001equalsimpl0(i, Butt)) {
            return "Butt";
        }
        if (m2001equalsimpl0(i, Round)) {
            return "Round";
        }
        return m2001equalsimpl0(i, Square) ? "Square" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
