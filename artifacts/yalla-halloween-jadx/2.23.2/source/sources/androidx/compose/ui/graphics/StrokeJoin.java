...
public final class StrokeJoin {
    ...
    private static final int Miter = m2009constructorimpl(0);
    private static final int Round = m2009constructorimpl(1);
    private static final int Bevel = m2009constructorimpl(2);
    ...
    public static final /* synthetic */ StrokeJoin m2008boximpl(int i) {
    ...
    public static String m2013toStringimpl(int i) {
        if (m2011equalsimpl0(i, Miter)) {
            return "Miter";
        }
        if (m2011equalsimpl0(i, Round)) {
            return "Round";
        }
        return m2011equalsimpl0(i, Bevel) ? "Bevel" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
