...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader mo1656createShaderuvyYCjk(long size) {
        ...
        if (OffsetKt.m1468isUnspecifiedk4lQ0M(this.center)) {
            jOffset = SizeKt.m1526getCenteruvyYCjk(size);
        } else {
            jOffset = OffsetKt.Offset((Offset.m1447getXimpl(this.center) > Float.POSITIVE_INFINITY ? 1 : (Offset.m1447getXimpl(this.center) == Float.POSITIVE_INFINITY ? 0 : -1)) == 0 ? Size.m1516getWidthimpl(size) : Offset.m1447getXimpl(this.center), Offset.m1448getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m1513getHeightimpl(size) : Offset.m1448getYimpl(this.center));
        }
        return ShaderKt.m1971SweepGradientShader9KIMszo(jOffset, this.colors, this.stops);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Offset.m1444equalsimpl0(this.center, sweepGradient.center) && Intrinsics.areEqual(this.colors, sweepGradient.colors) && Intrinsics.areEqual(this.stops, sweepGradient.stops);
    }

    public int hashCode() {
        int iHashCode = (this.colors.hashCode() + (Offset.m1449hashCodeimpl(this.center) * 31)) * 31;
    ...
    public String toString() {
        ...
        StringBuilder sbOooO0O0 = p004OooO0oO.o0OoOo0.OooO0O0("SweepGradient(", str, "colors=");
        sbOooO0O0.append(this.colors);
        sbOooO0O0.append(", stops=");
        sbOooO0O0.append(this.stops);
        sbOooO0O0.append(')');
