...
public final class VertexMode {
    ...
    private static final int Triangles = m2045constructorimpl(0);
    private static final int TriangleStrip = m2045constructorimpl(1);
    private static final int TriangleFan = m2045constructorimpl(2);
    ...
    public static final /* synthetic */ VertexMode m2044boximpl(int i) {
    ...
    public static String m2049toStringimpl(int i) {
        if (m2047equalsimpl0(i, Triangles)) {
            return "Triangles";
        }
        if (m2047equalsimpl0(i, TriangleStrip)) {
            return "TriangleStrip";
        }
        return m2047equalsimpl0(i, TriangleFan) ? "TriangleFan" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
