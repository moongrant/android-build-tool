...
public abstract class ColorSpace {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (this.id == colorSpace.id && Intrinsics.areEqual(this.name, colorSpace.name)) {
            return ColorModel.m2059equalsimpl0(this.model, colorSpace.model);
        }
        return false;
    }
    ...
    public final float[] fromXyz(float x, float y, float z) {
        float[] fArr = new float[ColorModel.m2060getComponentCountimpl(this.model)];
        fArr[0] = x;
        fArr[1] = y;
        fArr[2] = z;
        return fromXyz(fArr);
    ...
    @NotNull
    public abstract float[] fromXyz(@NotNull float[] v);

    public final int getComponentCount() {
        return ColorModel.m2060getComponentCountimpl(this.model);
    }
    ...
    public int hashCode() {
        return ((ColorModel.m2061hashCodeimpl(this.model) + (this.name.hashCode() * 31)) * 31) + this.id;
    }
    ...
    public String toString() {
        return this.name + " (id=" + this.id + ", model=" + ((Object) ColorModel.m2062toStringimpl(this.model)) + ')';
    }
    ...
    @NotNull
    public abstract float[] toXyz(@NotNull float[] v);
