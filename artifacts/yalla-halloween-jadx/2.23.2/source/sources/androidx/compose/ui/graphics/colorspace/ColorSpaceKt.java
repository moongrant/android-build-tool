...
public final class ColorSpaceKt {
    ...
    public static final Connector m2070connectYBCOT_4(@NotNull ColorSpace connect, @NotNull ColorSpace destination, int i) {
        ...
        if (connect == colorSpaces.getSrgb()) {
            ...
            if (destination == colorSpaces.getOklab() && RenderIntent.m2080equalsimpl0(i, RenderIntent.INSTANCE.m2085getPerceptualuksYyKA())) {
                return Connector.INSTANCE.getSrgbToOklabPerceptual$ui_graphics_release();
            }
        } else if (connect == colorSpaces.getOklab() && destination == colorSpaces.getSrgb() && RenderIntent.m2080equalsimpl0(i, RenderIntent.INSTANCE.m2085getPerceptualuksYyKA())) {
        ...
        long jM2068getModelxdoWZVw = connect.getModel();
        ColorModel.Companion companion = ColorModel.INSTANCE;
        DefaultConstructorMarker defaultConstructorMarker = null;
        return (ColorModel.m2059equalsimpl0(jM2068getModelxdoWZVw, companion.m2066getRgbxdoWZVw()) && ColorModel.m2059equalsimpl0(destination.getModel(), companion.m2066getRgbxdoWZVw())) ? new Connector.RgbConnector((Rgb) connect, (Rgb) destination, i, defaultConstructorMarker) : new Connector(connect, destination, i, defaultConstructorMarker);
    }

    /* JADX INFO: renamed from: connect-YBCOT_4$default, reason: not valid java name */
    public static /* synthetic */ Connector m2071connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i2 & 2) != 0) {
            i = RenderIntent.INSTANCE.m2085getPerceptualuksYyKA();
        }
        return m2070connectYBCOT_4(colorSpace, colorSpace2, i);
    }
    ...
    public static final float[] inverse3x3(@NotNull float[] m) {
        ...
        fArr[1] = f11 / f13;
        fArr[2] = f12 / f13;
        fArr[3] = o0OoOo0.OooO00o(f2, f9, f3 * f8, f13);
        fArr[4] = o0OoOo0.OooO00o(f3, f7, f9 * f, f13);
        fArr[5] = o0OoOo0.OooO00o(f8, f, f7 * f2, f13);
        fArr[6] = o0OoOo0.OooO00o(f3, f5, f2 * f6, f13);
        fArr[7] = o0OoOo0.OooO00o(f6, f, f3 * f4, f13);
        fArr[8] = o0OoOo0.OooO00o(f2, f4, f * f5, f13);
        return fArr;
    }
    ...
    public static final ColorSpace adapt(@NotNull ColorSpace colorSpace, @NotNull WhitePoint whitePoint, @NotNull Adaptation adaptation) {
        ...
        if (!ColorModel.m2059equalsimpl0(colorSpace.getModel(), ColorModel.INSTANCE.m2066getRgbxdoWZVw())) {
            return colorSpace;
        }
