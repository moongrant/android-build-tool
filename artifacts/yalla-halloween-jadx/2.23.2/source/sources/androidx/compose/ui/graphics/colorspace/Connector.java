...
public class Connector {
    ...
    public static final class Companion {
        ...
        public final float[] m2075computeTransformYBCOT_4(ColorSpace source, ColorSpace destination, int intent) {
            if (!RenderIntent.m2080equalsimpl0(intent, RenderIntent.INSTANCE.m2084getAbsoluteuksYyKA())) {
                return null;
            }
            long model = source.getModel();
            ColorModel.Companion companion = ColorModel.INSTANCE;
            boolean zM2059equalsimpl0 = ColorModel.m2059equalsimpl0(model, companion.m2066getRgbxdoWZVw());
            boolean zM2059equalsimpl1 = ColorModel.m2059equalsimpl0(destination.getModel(), companion.m2066getRgbxdoWZVw());
            if (zM2059equalsimpl0 && zM2059equalsimpl1) {
                return null;
            }
            if (!zM2059equalsimpl0 && !zM2059equalsimpl1) {
                return null;
            }
            if (!zM2059equalsimpl0) {
                source = destination;
            }
            Intrinsics.checkNotNull(source, "null cannot be cast to non-null type androidx.compose.ui.graphics.colorspace.Rgb");
            Rgb rgb = (Rgb) source;
            float[] xyz$ui_graphics_release = zM2059equalsimpl0 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
            float[] xyz$ui_graphics_release2 = zM2059equalsimpl1 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
        ...
        public final Connector identity$ui_graphics_release(@NotNull final ColorSpace source) {
            ...
            final int iM2086getRelativeuksYyKA = RenderIntent.INSTANCE.m2086getRelativeuksYyKA();
            return new Connector(source, iM2086getRelativeuksYyKA) { // from class: androidx.compose.ui.graphics.colorspace.Connector$Companion$identity$1
                {
                    super(source, source, iM2086getRelativeuksYyKA, null);
                }
                ...
                public long mo2073transformToColorwmQWz5c$ui_graphics_release(float r, float g, float b, float a) {
    ...
    public static final class RgbConnector extends Connector {
        ...
        /* JADX INFO: renamed from: computeTransform-YBCOT_4, reason: not valid java name */
        private final float[] m2076computeTransformYBCOT_4(Rgb source, Rgb destination, int intent) {
        ...
        private RgbConnector(Rgb mSource, Rgb mDestination, int i) {
            ...
            this.mTransform = m2076computeTransformYBCOT_4(mSource, mDestination, i);
        }
    }
    ...
    static {
        ...
        SrgbToOklabPerceptual = new Connector(srgb, oklab, companion2.m2085getPerceptualuksYyKA(), defaultConstructorMarker);
        OklabToSrgbPerceptual = new Connector(colorSpaces.getOklab(), colorSpaces.getSrgb(), companion2.m2085getPerceptualuksYyKA(), defaultConstructorMarker);
    }
    ...
    public long mo2073transformToColorwmQWz5c$ui_graphics_release(float r, float g, float b, float a) {
        ...
        return this.transformDestination.mo2069xyzaToColorJlNiLsg$ui_graphics_release(f2, f, z$ui_graphics_release, a, this.destination);
    }
    ...
    private Connector(ColorSpace source, ColorSpace destination, int i) {
        ...
        long model = source.getModel();
        ColorModel.Companion companion = ColorModel.INSTANCE;
        this(source, destination, ColorModel.m2059equalsimpl0(model, companion.m2066getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(source, Illuminant.INSTANCE.getD50(), null, 2, null) : source, ColorModel.m2059equalsimpl0(destination.getModel(), companion.m2066getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(destination, Illuminant.INSTANCE.getD50(), null, 2, null) : destination, i, INSTANCE.m2075computeTransformYBCOT_4(source, destination, i), null);
    }
}
