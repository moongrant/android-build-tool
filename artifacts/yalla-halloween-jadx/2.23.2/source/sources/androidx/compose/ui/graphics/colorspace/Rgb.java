...
public final class Rgb extends ColorSpace {
    ...
    @NotNull
    private static final DoubleFunction DoubleIdentity = new OooOo00();
    ...
    public static final class Companion {
        ...
        private final float area(float[] primaries) {
            ...
            float fOooO00o = o00OOOOo.OooO00o(f, f6, (((f3 * f6) + ((f2 * f5) + (f * f4))) - (f4 * f5)) - (f2 * f3), 0.5f);
            return fOooO00o < 0.0f ? -fOooO00o : fOooO00o;
        }
        ...
        public final float[] computeXYZMatrix(float[] primaries, WhitePoint whitePoint) {
            ...
            float fOooO00o = o0OoOo0.OooO00o(f19, f20, f15, f14);
    ...
    public Rgb(@NotNull String name, @NotNull float[] primaries, @NotNull WhitePoint whitePoint, @Nullable float[] fArr, @NotNull DoubleFunction oetf, @NotNull DoubleFunction eotf, float f, float f2, @Nullable TransferParameters transferParameters, int i) {
        super(name, ColorModel.INSTANCE.m2066getRgbxdoWZVw(), i, null);
        ...
        this.oetfFunc = new OooOO0O(this);
        this.eotfOrig = eotf;
        ...
        this.eotfFunc = new OooOOO0(this);
    ...
    public long mo2069xyzaToColorJlNiLsg$ui_graphics_release(float x, float y, float z, float a, @NotNull ColorSpace colorSpace) {
    ...
    public Rgb(@NotNull String name, @NotNull float[] toXYZ, @NotNull Function1<? super Double, Double> oetf, @NotNull Function1<? super Double, Double> eotf) {
        ...
        Intrinsics.checkNotNullParameter(eotf, "eotf");
        Companion companion = INSTANCE;
        this(name, companion.computePrimaries$ui_graphics_release(toXYZ), companion.computeWhitePoint(toXYZ), null, new OooO(oetf, 0), new OooOO0(eotf), 0.0f, 1.0f, null, -1);
    }
    ...
    public Rgb(@NotNull String name, @NotNull float[] primaries, @NotNull WhitePoint whitePoint, @NotNull Function1<? super Double, Double> oetf, @NotNull final Function1<? super Double, Double> eotf, float f, float f2) {
        this(name, primaries, whitePoint, null, new OooO0O0(oetf), new DoubleFunction() { // from class: androidx.compose.ui.graphics.colorspace.OooO0o
            @Override // androidx.compose.ui.graphics.colorspace.DoubleFunction
            public final double invoke(double d) {
                return Rgb._init_$lambda$5((Function1) eotf, d);
            }
        }, f, f2, null, -1);
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(primaries, "primaries");
    ...
    public Rgb(@NotNull String name, @NotNull float[] primaries, @NotNull WhitePoint whitePoint, @NotNull TransferParameters function, int i) {
        DoubleFunction o0ooooo;
        DoubleFunction o000000o2;
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(primaries, "primaries");
        Intrinsics.checkNotNullParameter(whitePoint, "whitePoint");
        Intrinsics.checkNotNullParameter(function, "function");
        if (function.getE() == 0.0d) {
            if (function.getF() == 0.0d) {
                o0ooooo = new OooOOO(function);
            } else {
                o0ooooo = new o0ooOOo(function);
            }
        } else {
            o0ooooo = new o0ooOOo(function);
        }
        DoubleFunction doubleFunction = o0ooooo;
        if (function.getE() == 0.0d) {
            if (function.getF() == 0.0d) {
                o000000o2 = new OooOOOO(function);
            } else {
                o000000o2 = new o000000O(function);
            }
        } else {
            o000000o2 = new o000000O(function);
        }
        this(name, primaries, whitePoint, null, doubleFunction, o000000o2, 0.0f, 1.0f, function, i);
    }
    ...
    public Rgb(@NotNull String name, @NotNull float[] primaries, @NotNull WhitePoint whitePoint, final double d, float f, float f2, int i) {
        ...
        if (d == 1.0d) {
            ...
            doubleFunction = new DoubleFunction() { // from class: androidx.compose.ui.graphics.colorspace.OooOo
                @Override // androidx.compose.ui.graphics.colorspace.DoubleFunction
        ...
        if (d == 1.0d) {
            ...
            doubleFunction2 = new DoubleFunction() { // from class: androidx.compose.ui.graphics.colorspace.OooO0OO
                @Override // androidx.compose.ui.graphics.colorspace.DoubleFunction
                public final double invoke(double d2) {
