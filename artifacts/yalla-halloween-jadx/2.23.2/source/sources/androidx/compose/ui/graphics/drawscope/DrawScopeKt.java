...
public final class DrawScopeKt {
    ...
    public static final void m2184clipPathKD09W0M(@NotNull DrawScope clipPath, @NotNull Path path, int i, @NotNull Function1<? super DrawScope, Unit> block) {
        ...
        drawContext.getTransform().mo2126clipPathmtrdDE(path, i);
    ...
    public static /* synthetic */ void m2185clipPathKD09W0M$default(DrawScope clipPath, Path path, int i, Function1 block, int i2, Object obj) {
        if ((i2 & 2) != 0) {
    ...
    public static final void m2186clipRectrOu3jXo(@NotNull DrawScope clipRect, float f, float f2, float f3, float f4, int i, @NotNull Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(clipRect, "$this$clipRect");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = clipRect.getDrawContext();
        long jMo2124getSizeNHjbRc = drawContext.mo2124getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo2127clipRectN_I0leg(f, f2, f3, f4, i);
    ...
    public static /* synthetic */ void m2187clipRectrOu3jXo$default(DrawScope clipRect, float f, float f2, float f3, float f4, int i, Function1 block, int i2, Object obj) {
        float f5 = (i2 & 1) != 0 ? 0.0f : f;
        float f6 = (i2 & 2) != 0 ? 0.0f : f2;
        if ((i2 & 4) != 0) {
            f3 = Size.m1516getWidthimpl(clipRect.mo2118getSizeNHjbRc());
        }
        float f7 = f3;
        if ((i2 & 8) != 0) {
            f4 = Size.m1513getHeightimpl(clipRect.mo2118getSizeNHjbRc());
        }
        float f8 = f4;
        if ((i2 & 16) != 0) {
            i = ClipOp.INSTANCE.m1670getIntersectrtfAjoo();
        ...
        long jMo2124getSizeNHjbRc = drawContext.mo2124getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo2127clipRectN_I0leg(f5, f6, f7, f8, i);
        block.invoke(clipRect);
        drawContext.getCanvas().restore();
        drawContext.mo2125setSizeuvyYCjk(jMo2124getSizeNHjbRc);
    }
    ...
    public static final void m2188rotateRg1IO4c(@NotNull DrawScope rotate, float f, long j, @NotNull Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(rotate, "$this$rotate");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = rotate.getDrawContext();
        long jMo2124getSizeNHjbRc = drawContext.mo2124getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo2130rotateUv8p0NA(f, j);
        block.invoke(rotate);
        drawContext.getCanvas().restore();
        drawContext.mo2125setSizeuvyYCjk(jMo2124getSizeNHjbRc);
    }
    ...
    public static /* synthetic */ void m2189rotateRg1IO4c$default(DrawScope rotate, float f, long j, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            j = rotate.mo2117getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(rotate, "$this$rotate");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = rotate.getDrawContext();
    ...
    public static final void m2190rotateRadRg1IO4c(@NotNull DrawScope rotateRad, float f, long j, @NotNull Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(rotateRad, "$this$rotateRad");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = rotateRad.getDrawContext();
        long jMo2124getSizeNHjbRc = drawContext.mo2124getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo2130rotateUv8p0NA(DegreesKt.degrees(f), j);
    ...
    public static /* synthetic */ void m2191rotateRadRg1IO4c$default(DrawScope rotateRad, float f, long j, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            j = rotateRad.mo2117getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(rotateRad, "$this$rotateRad");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = rotateRad.getDrawContext();
    ...
    public static final void m2192scaleFgt4K4Q(@NotNull DrawScope scale, float f, float f2, long j, @NotNull Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = scale.getDrawContext();
        long jMo2124getSizeNHjbRc = drawContext.mo2124getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo2131scale0AR0LA0(f, f2, j);
        block.invoke(scale);
        drawContext.getCanvas().restore();
        drawContext.mo2125setSizeuvyYCjk(jMo2124getSizeNHjbRc);
    }
    ...
    public static /* synthetic */ void m2193scaleFgt4K4Q$default(DrawScope scale, float f, float f2, long j, Function1 block, int i, Object obj) {
        if ((i & 4) != 0) {
            j = scale.mo2117getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = scale.getDrawContext();
    ...
    public static final void m2194scaleRg1IO4c(@NotNull DrawScope scale, float f, long j, @NotNull Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = scale.getDrawContext();
        long jMo2124getSizeNHjbRc = drawContext.mo2124getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo2131scale0AR0LA0(f, f, j);
        block.invoke(scale);
        drawContext.getCanvas().restore();
        drawContext.mo2125setSizeuvyYCjk(jMo2124getSizeNHjbRc);
    }
    ...
    public static /* synthetic */ void m2195scaleRg1IO4c$default(DrawScope scale, float f, long j, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            j = scale.mo2117getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
