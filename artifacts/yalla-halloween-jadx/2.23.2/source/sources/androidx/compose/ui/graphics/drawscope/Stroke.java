...
public final class Stroke extends DrawStyle {
    ...
    private static final int DefaultCap = StrokeCap.INSTANCE.m2005getButtKaPHkGw();
    private static final int DefaultJoin = StrokeJoin.INSTANCE.m2016getMiterLxFBmk8();
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (this.width == stroke.width) {
            return ((this.miter > stroke.miter ? 1 : (this.miter == stroke.miter ? 0 : -1)) == 0) && StrokeCap.m2001equalsimpl0(this.cap, stroke.cap) && StrokeJoin.m2011equalsimpl0(this.join, stroke.join) && Intrinsics.areEqual(this.pathEffect, stroke.pathEffect);
        }
        return false;
    }
    ...
    public int hashCode() {
        int iM2012hashCodeimpl = (StrokeJoin.m2012hashCodeimpl(this.join) + ((StrokeCap.m2002hashCodeimpl(this.cap) + o0OoOo0.OooO00o(this.miter, Float.floatToIntBits(this.width) * 31, 31)) * 31)) * 31;
        PathEffect pathEffect = this.pathEffect;
        return iM2012hashCodeimpl + (pathEffect != null ? pathEffect.hashCode() : 0);
    }

    @NotNull
    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + ((Object) StrokeCap.m2003toStringimpl(this.cap)) + ", join=" + ((Object) StrokeJoin.m2013toStringimpl(this.join)) + ", pathEffect=" + this.pathEffect + ')';
    }
