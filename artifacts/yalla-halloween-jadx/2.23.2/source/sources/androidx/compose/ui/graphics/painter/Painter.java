...
public abstract class Painter {
    ...
    public static /* synthetic */ void m2216drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j, float f, ColorFilter colorFilter, int i, Object obj) {
        if (obj != null) {
        ...
        painter.m2217drawx_KDEd0(drawScope, j, f2, colorFilter);
    }
    ...
    public final void m2217drawx_KDEd0(@NotNull DrawScope draw, long j, float f, @Nullable ColorFilter colorFilter) {
        Intrinsics.checkNotNullParameter(draw, "$this$draw");
        configureAlpha(f);
        configureColorFilter(colorFilter);
        configureLayoutDirection(draw.getLayoutDirection());
        float fM1516getWidthimpl = Size.m1516getWidthimpl(draw.mo2118getSizeNHjbRc()) - Size.m1516getWidthimpl(j);
        float fM1513getHeightimpl = Size.m1513getHeightimpl(draw.mo2118getSizeNHjbRc()) - Size.m1513getHeightimpl(j);
        draw.getDrawContext().getTransform().inset(0.0f, 0.0f, fM1516getWidthimpl, fM1513getHeightimpl);
        if (f > 0.0f && Size.m1516getWidthimpl(j) > 0.0f && Size.m1513getHeightimpl(j) > 0.0f) {
            if (this.useLayer) {
                Rect rectM1487Recttz77jQw = RectKt.m1487Recttz77jQw(Offset.INSTANCE.m1463getZeroF1C5BW0(), SizeKt.Size(Size.m1516getWidthimpl(j), Size.m1513getHeightimpl(j)));
                Canvas canvas = draw.getDrawContext().getCanvas();
                try {
                    canvas.saveLayer(rectM1487Recttz77jQw, obtainPaint());
                    onDraw(draw);
                    canvas.restore();
                } catch (Throwable th) {
                    canvas.restore();
    ...
    public abstract long mo2211getIntrinsicSizeNHjbRc();
