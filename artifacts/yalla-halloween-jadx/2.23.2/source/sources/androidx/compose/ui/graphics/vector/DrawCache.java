...
public final class DrawCache {
    ...
    private long size = IntSize.INSTANCE.m3940getZeroYbymL2g();

    @NotNull
    private final CanvasDrawScope cacheScope = new CanvasDrawScope();

    private final void clear(DrawScope drawScope) {
        OooO0O0.Oooo0OO(drawScope, Color.INSTANCE.m1707getBlack0d7_KjU(), 0L, 0L, 0.0f, null, null, BlendMode.INSTANCE.m1604getClear0nO6VwU(), 62, null);
    }
    ...
    public final void m2218drawCachedImageCJJARo(long size, @NotNull Density density, @NotNull LayoutDirection layoutDirection, @NotNull Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Intrinsics.checkNotNullParameter(block, "block");
        this.scopeDensity = density;
        this.layoutDirection = layoutDirection;
        ImageBitmap imageBitmapM1883ImageBitmapx__hDU$default = this.mCachedImage;
        Canvas Canvas = this.cachedCanvas;
        if (imageBitmapM1883ImageBitmapx__hDU$default == null || Canvas == null || IntSize.m3935getWidthimpl(size) > imageBitmapM1883ImageBitmapx__hDU$default.getWidth() || IntSize.m3934getHeightimpl(size) > imageBitmapM1883ImageBitmapx__hDU$default.getHeight()) {
            imageBitmapM1883ImageBitmapx__hDU$default = ImageBitmapKt.m1883ImageBitmapx__hDU$default(IntSize.m3935getWidthimpl(size), IntSize.m3934getHeightimpl(size), 0, false, null, 28, null);
            Canvas = CanvasKt.Canvas(imageBitmapM1883ImageBitmapx__hDU$default);
            this.mCachedImage = imageBitmapM1883ImageBitmapx__hDU$default;
            this.cachedCanvas = Canvas;
        }
        this.size = size;
        CanvasDrawScope canvasDrawScope = this.cacheScope;
        long jM3945toSizeozmzZPI = IntSizeKt.m3945toSizeozmzZPI(size);
