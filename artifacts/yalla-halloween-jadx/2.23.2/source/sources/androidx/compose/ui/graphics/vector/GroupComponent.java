...
public final class GroupComponent extends VNode {
    ...
    private final void updateMatrix() {
        float[] fArrM1886constructorimpl$default = this.groupMatrix;
        if (fArrM1886constructorimpl$default == null) {
            fArrM1886constructorimpl$default = Matrix.m1886constructorimpl$default(null, 1, null);
            this.groupMatrix = fArrM1886constructorimpl$default;
        } else {
            Matrix.m1895resetimpl(fArrM1886constructorimpl$default);
        }
        Matrix.m1906translateimpl$default(fArrM1886constructorimpl$default, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, null);
        Matrix.m1898rotateZimpl(fArrM1886constructorimpl$default, this.rotation);
        Matrix.m1899scaleimpl(fArrM1886constructorimpl$default, this.scaleX, this.scaleY, 1.0f);
        Matrix.m1906translateimpl$default(fArrM1886constructorimpl$default, -this.pivotX, -this.pivotY, 0.0f, 4, null);
    }
    ...
    public void draw(@NotNull DrawScope drawScope) {
        ...
        if (fArr != null) {
            transform.mo2132transform58bKbWc(Matrix.m1884boximpl(fArr).m1907unboximpl());
        }
        Path path = this.clipPath;
