...
public final class ImageVector {
    ...
    public static final class Builder {
        ...
        public /* synthetic */ Builder(String str, float f, float f2, float f3, float f4, long j, int i, boolean z, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this((i2 & 1) != 0 ? "" : str, f, f2, f3, f4, (i2 & 32) != 0 ? Color.INSTANCE.m1717getUnspecified0d7_KjU() : j, (i2 & 64) != 0 ? BlendMode.INSTANCE.m1629getSrcIn0nO6VwU() : i, (i2 & 128) != 0 ? false : z, (DefaultConstructorMarker) null);
        }
        ...
        public /* synthetic */ Builder(String str, float f, float f2, float f3, float f4, long j, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this((i2 & 1) != 0 ? "" : str, f, f2, f3, f4, (i2 & 32) != 0 ? Color.INSTANCE.m1717getUnspecified0d7_KjU() : j, (i2 & 64) != 0 ? BlendMode.INSTANCE.m1629getSrcIn0nO6VwU() : i, (DefaultConstructorMarker) null);
        }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!Intrinsics.areEqual(this.name, imageVector.name) || !Dp.m3780equalsimpl0(this.defaultWidth, imageVector.defaultWidth) || !Dp.m3780equalsimpl0(this.defaultHeight, imageVector.defaultHeight)) {
            return false;
        }
        if (this.viewportWidth == imageVector.viewportWidth) {
            return ((this.viewportHeight > imageVector.viewportHeight ? 1 : (this.viewportHeight == imageVector.viewportHeight ? 0 : -1)) == 0) && Intrinsics.areEqual(this.root, imageVector.root) && Color.m1682equalsimpl0(this.tintColor, imageVector.tintColor) && BlendMode.m1600equalsimpl0(this.tintBlendMode, imageVector.tintBlendMode) && this.autoMirror == imageVector.autoMirror;
        }
        return false;
    }
    ...
    public int hashCode() {
        return ((BlendMode.m1601hashCodeimpl(this.tintBlendMode) + OooO.OooO00o(this.tintColor, (this.root.hashCode() + o0OoOo0.OooO00o(this.viewportHeight, o0OoOo0.OooO00o(this.viewportWidth, OooO0o.OooO00o(this.defaultHeight, OooO0o.OooO00o(this.defaultWidth, this.name.hashCode() * 31, 31), 31), 31), 31)) * 31, 31)) * 31) + (this.autoMirror ? 1231 : 1237);
    }
