...
public final class PathComponent extends VNode {
    ...
    private final void updateRenderPath() {
        ...
        if (Intrinsics.areEqual(this.renderPath, this.path)) {
            ...
            int iMo1580getFillTypeRgk1Os = this.renderPath.mo1580getFillTypeRgk1Os();
            this.renderPath.rewind();
            this.renderPath.mo1582setFillTypeoQ8Xj4U(iMo1580getFillTypeRgk1Os);
        }
    ...
    public final void m2230setPathFillTypeoQ8Xj4U(int i) {
        this.pathFillType = i;
        this.renderPath.mo1582setFillTypeoQ8Xj4U(i);
        invalidate();
    }
    ...
    public final void m2231setStrokeLineCapBeK7IIE(int i) {
    ...
    public final void m2232setStrokeLineJoinWw9F2mQ(int i) {
