...
public final class PathNodeKt {
    ...
    public static final void addPathNodes(char c, @NotNull List<PathNode> nodes, @NotNull float[] args, int i) {
        ...
        if (c == 'l') {
            ...
            while (i2 <= i7) {
                int i8 = i2 + 1;
                PathNode relativeLineTo = new PathNode.RelativeLineTo(args[i2], args[i8]);
        ...
        if (c == 'L') {
            ...
            while (i2 <= i9) {
                int i10 = i2 + 1;
                PathNode lineTo = new PathNode.LineTo(args[i2], args[i10]);
        ...
        if (c == 'h') {
            int i11 = i - 1;
            while (i2 <= i11) {
                PathNode relativeHorizontalTo = new PathNode.RelativeHorizontalTo(args[i2]);
        ...
        if (c == 'H') {
            int i12 = i - 1;
            while (i2 <= i12) {
                PathNode horizontalTo = new PathNode.HorizontalTo(args[i2]);
        ...
        if (c == 'v') {
            int i13 = i - 1;
            while (i2 <= i13) {
                PathNode relativeVerticalTo = new PathNode.RelativeVerticalTo(args[i2]);
        ...
        if (c == 'V') {
            int i14 = i - 1;
            while (i2 <= i14) {
                PathNode verticalTo = new PathNode.VerticalTo(args[i2]);
        ...
        if (c == 'c') {
            ...
            while (i2 <= i15) {
                int i16 = i2 + 1;
                PathNode relativeCurveTo = new PathNode.RelativeCurveTo(args[i2], args[i16], args[i2 + 2], args[i2 + 3], args[i2 + 4], args[i2 + 5]);
        ...
        if (c == 'C') {
            ...
            while (i2 <= i17) {
                int i18 = i2 + 1;
                PathNode curveTo = new PathNode.CurveTo(args[i2], args[i18], args[i2 + 2], args[i2 + 3], args[i2 + 4], args[i2 + 5]);
        ...
        if (c == 's') {
            ...
            while (i2 <= i19) {
                int i20 = i2 + 1;
                PathNode relativeReflectiveCurveTo = new PathNode.RelativeReflectiveCurveTo(args[i2], args[i20], args[i2 + 2], args[i2 + 3]);
        ...
        if (c == 'S') {
            ...
            while (i2 <= i21) {
                int i22 = i2 + 1;
                PathNode reflectiveCurveTo = new PathNode.ReflectiveCurveTo(args[i2], args[i22], args[i2 + 2], args[i2 + 3]);
        ...
        if (c == 'q') {
            ...
            while (i2 <= i23) {
                int i24 = i2 + 1;
                PathNode relativeQuadTo = new PathNode.RelativeQuadTo(args[i2], args[i24], args[i2 + 2], args[i2 + 3]);
        ...
        if (c == 'Q') {
            ...
            while (i2 <= i25) {
                int i26 = i2 + 1;
                PathNode quadTo = new PathNode.QuadTo(args[i2], args[i26], args[i2 + 2], args[i2 + 3]);
        ...
        if (c == 't') {
            ...
            while (i2 <= i27) {
                int i28 = i2 + 1;
                PathNode relativeReflectiveQuadTo = new PathNode.RelativeReflectiveQuadTo(args[i2], args[i28]);
        ...
        if (c == 'T') {
            ...
            while (i2 <= i29) {
                int i30 = i2 + 1;
                PathNode reflectiveQuadTo = new PathNode.ReflectiveQuadTo(args[i2], args[i30]);
        ...
        if (c == 'a') {
            ...
            for (int i32 = 0; i32 <= i31; i32 += 7) {
                int i33 = i32 + 1;
                PathNode relativeArcTo = new PathNode.RelativeArcTo(args[i32], args[i33], args[i32 + 2], Float.compare(args[i32 + 3], 0.0f) != 0, Float.compare(args[i32 + 4], 0.0f) != 0, args[i32 + 5], args[i32 + 6]);
        ...
        for (int i35 = 0; i35 <= i34; i35 += 7) {
            int i36 = i35 + 1;
            PathNode arcTo = new PathNode.ArcTo(args[i35], args[i36], args[i35 + 2], Float.compare(args[i35 + 3], 0.0f) != 0, Float.compare(args[i35 + 4], 0.0f) != 0, args[i35 + 5], args[i35 + 6]);
