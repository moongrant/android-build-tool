...
public final class VectorPainterKt {
    ...
    public static final VectorPainter rememberVectorPainter(@NotNull final ImageVector image, @Nullable Composer composer, int i) {
        ...
        return vectorPainterM2240rememberVectorPaintervIP8VLU;
    }
    ...
    public static final VectorPainter m2239rememberVectorPaintermlNsNFs(float f, float f2, float f3, float f4, @Nullable String str, long j, int i, @NotNull Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, int i2, int i3) {
        ...
        long jM1717getUnspecified0d7_KjU = (i3 & 32) != 0 ? Color.INSTANCE.m1717getUnspecified0d7_KjU() : j;
        int iM1629getSrcIn0nO6VwU = (i3 & 64) != 0 ? BlendMode.INSTANCE.m1629getSrcIn0nO6VwU() : i;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-964365210, i2, -1, "androidx.compose.ui.graphics.vector.rememberVectorPainter (VectorPainter.kt:73)");
        }
        VectorPainter vectorPainterM2240rememberVectorPaintervIP8VLU = m2240rememberVectorPaintervIP8VLU(f, f2, f5, f6, str2, jM1717getUnspecified0d7_KjU, iM1629getSrcIn0nO6VwU, false, content, composer, (i2 & 14) | 12582912 | (i2 & 112) | (i2 & 896) | (i2 & 7168) | (57344 & i2) | (458752 & i2) | (3670016 & i2) | ((i2 << 3) & 234881024), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final VectorPainter m2240rememberVectorPaintervIP8VLU(float f, float f2, float f3, float f4, @Nullable String str, long j, int i, boolean z, @NotNull Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, int i2, int i3) {
        Intrinsics.checkNotNullParameter(content, "content");
        ...
        float fMo326toPx0680j_5 = density.mo326toPx0680j_4(f2);
        if (Float.isNaN(f5)) {
            f5 = fMo326toPx0680j_4;
        }
        if (Float.isNaN(f6)) {
            f6 = fMo326toPx0680j_5;
        }
        Color colorM1671boximpl = Color.m1671boximpl(jM1717getUnspecified0d7_KjU);
        BlendMode blendModeM1597boximpl = BlendMode.m1597boximpl(iM1629getSrcIn0nO6VwU);
        int i4 = i2 >> 15;
        composer.startReplaceableGroup(511388516);
        boolean zChanged = composer.changed(colorM1671boximpl) | composer.changed(blendModeM1597boximpl);
        Object objRememberedValue = composer.rememberedValue();
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = !Color.m1682equalsimpl0(jM1717getUnspecified0d7_KjU, Color.INSTANCE.m1717getUnspecified0d7_KjU()) ? ColorFilter.INSTANCE.m1725tintxETnrds(jM1717getUnspecified0d7_KjU, iM1629getSrcIn0nO6VwU) : null;
        ...
        vectorPainter.m2238setSizeuvyYCjk$ui_release(SizeKt.Size(fMo326toPx0680j_4, fMo326toPx0680j_5));
