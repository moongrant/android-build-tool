...
public final class VectorPath extends VectorNode {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!(this.strokeLineWidth == vectorPath.strokeLineWidth) || !StrokeCap.m2001equalsimpl0(this.strokeLineCap, vectorPath.strokeLineCap) || !StrokeJoin.m2011equalsimpl0(this.strokeLineJoin, vectorPath.strokeLineJoin)) {
            return false;
        }
        ...
        if (this.trimPathEnd == vectorPath.trimPathEnd) {
            return ((this.trimPathOffset > vectorPath.trimPathOffset ? 1 : (this.trimPathOffset == vectorPath.trimPathOffset ? 0 : -1)) == 0) && PathFillType.m1931equalsimpl0(this.pathFillType, vectorPath.pathFillType) && Intrinsics.areEqual(this.pathData, vectorPath.pathData);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int iOooO00o = o0OoOo0.OooO00o(this.fillAlpha, (iHashCode + (brush != null ? brush.hashCode() : 0)) * 31, 31);
        Brush brush2 = this.stroke;
        return PathFillType.m1932hashCodeimpl(this.pathFillType) + o0OoOo0.OooO00o(this.trimPathOffset, o0OoOo0.OooO00o(this.trimPathEnd, o0OoOo0.OooO00o(this.trimPathStart, o0OoOo0.OooO00o(this.strokeLineMiter, (StrokeJoin.m2012hashCodeimpl(this.strokeLineJoin) + ((StrokeCap.m2002hashCodeimpl(this.strokeLineCap) + o0OoOo0.OooO00o(this.strokeLineWidth, o0OoOo0.OooO00o(this.strokeAlpha, (iOooO00o + (brush2 != null ? brush2.hashCode() : 0)) * 31, 31), 31)) * 31)) * 31, 31), 31), 31), 31);
    }
    ...
    public /* synthetic */ VectorPath(String str, List list, int i, Brush brush, float f, Brush brush2, float f2, float f3, int i2, int i3, float f4, float f5, float f6, float f7, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? "" : str, list, i, (i4 & 8) != 0 ? null : brush, (i4 & 16) != 0 ? 1.0f : f, (i4 & 32) != 0 ? null : brush2, (i4 & 64) != 0 ? 1.0f : f2, (i4 & 128) != 0 ? 0.0f : f3, (i4 & PSKKeyManager.MAX_KEY_LENGTH_BYTES) != 0 ? VectorKt.getDefaultStrokeLineCap() : i2, (i4 & ConstantsKt.MINIMUM_BLOCK_SIZE) != 0 ? VectorKt.getDefaultStrokeLineJoin() : i3, (i4 & LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) != 0 ? 4.0f : f4, (i4 & 2048) != 0 ? 0.0f : f5, (i4 & 4096) != 0 ? 1.0f : f6, (i4 & 8192) != 0 ? 0.0f : f7, null);
    }
