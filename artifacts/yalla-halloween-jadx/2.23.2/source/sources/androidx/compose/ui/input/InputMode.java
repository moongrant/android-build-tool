...
public final class InputMode {
    ...
    private static final int Touch = m2261constructorimpl(1);
    private static final int Keyboard = m2261constructorimpl(2);
    ...
    public static final class Companion {
        ...
        public final int m2267getKeyboardaOaMEAU() {
            return InputMode.Keyboard;
        }

        /* JADX INFO: renamed from: getTouch-aOaMEAU, reason: not valid java name */
        public final int m2268getTouchaOaMEAU() {
    ...
    public static final /* synthetic */ InputMode m2260boximpl(int i) {
    ...
    public static String m2265toStringimpl(int i) {
        if (m2263equalsimpl0(i, Touch)) {
            return "Touch";
        }
        return m2263equalsimpl0(i, Keyboard) ? "Keyboard" : "Error";
    }
