...
public final class KeyEventType {
    ...
    private static final int Unknown = m2576constructorimpl(0);
    private static final int KeyUp = m2576constructorimpl(1);
    private static final int KeyDown = m2576constructorimpl(2);
    ...
    public static final /* synthetic */ KeyEventType m2575boximpl(int i) {
    ...
    public static String m2580toStringimpl(int i) {
        if (m2578equalsimpl0(i, KeyUp)) {
            return "KeyUp";
        }
        if (m2578equalsimpl0(i, KeyDown)) {
            return "KeyDown";
        }
        return m2578equalsimpl0(i, Unknown) ? AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN : "Invalid";
    }
