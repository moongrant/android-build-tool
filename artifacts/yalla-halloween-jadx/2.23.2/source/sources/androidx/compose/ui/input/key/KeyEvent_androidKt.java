...
public final class KeyEvent_androidKt {
    ...
    public static final long m2585getKeyZmokQxo(@NotNull android.view.KeyEvent key) {
        Intrinsics.checkNotNullParameter(key, "$this$key");
        return Key_androidKt.Key(key.getKeyCode());
    }

    /* JADX INFO: renamed from: getType-ZmokQxo, reason: not valid java name */
    public static final int m2586getTypeZmokQxo(@NotNull android.view.KeyEvent type) {
        Intrinsics.checkNotNullParameter(type, "$this$type");
        int action = type.getAction();
        if (action != 0) {
            return action != 1 ? KeyEventType.INSTANCE.m2584getUnknownCS__XNY() : KeyEventType.INSTANCE.m2583getKeyUpCS__XNY();
        }
        return KeyEventType.INSTANCE.m2582getKeyDownCS__XNY();
    }

    /* JADX INFO: renamed from: getUtf16CodePoint-ZmokQxo, reason: not valid java name */
    public static final int m2587getUtf16CodePointZmokQxo(@NotNull android.view.KeyEvent utf16CodePoint) {
    ...
    public static final boolean m2588isAltPressedZmokQxo(@NotNull android.view.KeyEvent isAltPressed) {
    ...
    public static final boolean m2589isCtrlPressedZmokQxo(@NotNull android.view.KeyEvent isCtrlPressed) {
    ...
    public static final boolean m2590isMetaPressedZmokQxo(@NotNull android.view.KeyEvent isMetaPressed) {
    ...
    public static final boolean m2591isShiftPressedZmokQxo(@NotNull android.view.KeyEvent isShiftPressed) {
