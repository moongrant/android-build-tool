...
public interface SoftKeyboardInterceptionModifierNode extends DelegatableNode {
    ...
    boolean mo2272onInterceptKeyBeforeSoftKeyboardZmokQxo(@NotNull android.view.KeyEvent event);

    /* JADX INFO: renamed from: onPreInterceptKeyBeforeSoftKeyboard-ZmokQxo */
    boolean mo2273onPreInterceptKeyBeforeSoftKeyboardZmokQxo(@NotNull android.view.KeyEvent event);
}
