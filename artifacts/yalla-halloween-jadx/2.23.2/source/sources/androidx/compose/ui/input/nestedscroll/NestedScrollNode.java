...
public final class NestedScrollNode extends Modifier.Node implements ModifierLocalModifierNode, NestedScrollConnection {
    ...
    public Object mo333onPostFlingRZ2iAVY(long j, long j2, @NotNull Continuation<? super Velocity> continuation) {
        ...
        Object objMo333onPostFlingRZ2iAVY = nestedScrollNode$onPostFling$1.result;
        ...
        if (i2 != 0) {
            ...
            j5 = j6;
            return Velocity.m3991boximpl(Velocity.m4004plusAH228Gc(j5, jM4011getZero9UxMQ8M));
        }
        ResultKt.throwOnFailure(objMo333onPostFlingRZ2iAVY);
        ...
        objMo333onPostFlingRZ2iAVY = nestedScrollConnection.mo333onPostFlingRZ2iAVY(j, j2, nestedScrollNode$onPostFling$1);
        if (objMo333onPostFlingRZ2iAVY == coroutine_suspended) {
            return coroutine_suspended;
        }
        nestedScrollNode = this;
        long packedValue = ((Velocity) objMo333onPostFlingRZ2iAVY).getPackedValue();
        NestedScrollConnection parentConnection = nestedScrollNode.getParentConnection();
        if (parentConnection != null) {
            long jM4004plusAH228Gc = Velocity.m4004plusAH228Gc(j3, packedValue);
            long jM4003minusAH228Gc = Velocity.m4003minusAH228Gc(j4, packedValue);
            ...
            objMo333onPostFlingRZ2iAVY = parentConnection.mo333onPostFlingRZ2iAVY(jM4004plusAH228Gc, jM4003minusAH228Gc, nestedScrollNode$onPostFling$1);
            if (objMo333onPostFlingRZ2iAVY == coroutine_suspended) {
                return coroutine_suspended;
            }
            j6 = packedValue;
    ...
    public long mo334onPostScrollDzOQY0M(long consumed, long available, int source) {
        long jMo334onPostScrollDzOQY0M = this.connection.mo334onPostScrollDzOQY0M(consumed, available, source);
        NestedScrollConnection parentConnection = getParentConnection();
        return Offset.m1452plusMKHz9U(jMo334onPostScrollDzOQY0M, parentConnection != null ? parentConnection.mo334onPostScrollDzOQY0M(Offset.m1452plusMKHz9U(consumed, jMo334onPostScrollDzOQY0M), Offset.m1451minusMKHz9U(available, jMo334onPostScrollDzOQY0M), source) : Offset.INSTANCE.m1463getZeroF1C5BW0());
    }
    ...
    public Object mo335onPreFlingQWom1Mo(long j, @NotNull Continuation<? super Velocity> continuation) {
        ...
        Object objMo335onPreFlingQWom1Mo = nestedScrollNode$onPreFling$1.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        ...
        if (i2 != 0) {
            ...
            return Velocity.m3991boximpl(Velocity.m4004plusAH228Gc(j2, ((Velocity) objMo335onPreFlingQWom1Mo).getPackedValue()));
        }
        ResultKt.throwOnFailure(objMo335onPreFlingQWom1Mo);
        NestedScrollConnection parentConnection = getParentConnection();
        if (parentConnection != null) {
            ...
            objMo335onPreFlingQWom1Mo = parentConnection.mo335onPreFlingQWom1Mo(j, nestedScrollNode$onPreFling$1);
        ...
        long j3 = j;
        j2 = jM4011getZero9UxMQ8M;
        NestedScrollConnection nestedScrollConnection = nestedScrollNode.connection;
        long jM4003minusAH228Gc = Velocity.m4003minusAH228Gc(j3, j2);
        nestedScrollNode$onPreFling$1.L$0 = null;
        nestedScrollNode$onPreFling$1.J$0 = j2;
        nestedScrollNode$onPreFling$1.label = 2;
        objMo335onPreFlingQWom1Mo = nestedScrollConnection.mo335onPreFlingQWom1Mo(jM4003minusAH228Gc, nestedScrollNode$onPreFling$1);
        if (objMo335onPreFlingQWom1Mo == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Velocity.m3991boximpl(Velocity.m4004plusAH228Gc(j2, ((Velocity) objMo335onPreFlingQWom1Mo).getPackedValue()));
        ...
        long jM4003minusAH228Gc2 = Velocity.m4003minusAH228Gc(j4, j2);
        nestedScrollNode$onPreFling$1.L$0 = null;
        nestedScrollNode$onPreFling$1.J$0 = j2;
        nestedScrollNode$onPreFling$1.label = 2;
        objMo335onPreFlingQWom1Mo = nestedScrollConnection2.mo335onPreFlingQWom1Mo(jM4003minusAH228Gc2, nestedScrollNode$onPreFling$1);
        if (objMo335onPreFlingQWom1Mo == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Velocity.m3991boximpl(Velocity.m4004plusAH228Gc(j2, ((Velocity) objMo335onPreFlingQWom1Mo).getPackedValue()));
    ...
    public long mo336onPreScrollOzD1aCk(long available, int source) {
        NestedScrollConnection parentConnection = getParentConnection();
        long jMo336onPreScrollOzD1aCk = parentConnection != null ? parentConnection.mo336onPreScrollOzD1aCk(available, source) : Offset.INSTANCE.m1463getZeroF1C5BW0();
        return Offset.m1452plusMKHz9U(jMo336onPreScrollOzD1aCk, this.connection.mo336onPreScrollOzD1aCk(Offset.m1451minusMKHz9U(available, jMo336onPreScrollOzD1aCk), source));
    }
