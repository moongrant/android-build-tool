...
public final class MotionEventAdapter {
    ...
    private final PointerInputEventData createPointerInputEventData(PositionCalculator positionCalculator, MotionEvent motionEvent, int index, boolean pressed) {
        long j;
        long jMo2766localToScreenMKHz9U;
        long jM2631toRawOffsetdBAh8RU;
        long jMo2767screenToLocalMKHz9U;
        int toolType;
        int iM2765getUnknownT8wyACA;
        ArrayList arrayList;
        int historySize;
        int i;
        long jM1463getZeroF1C5BW0;
        float historicalX;
        float historicalY;
        boolean z;
        boolean z2;
        long jM2630getComposePointerId_I2yYro = m2630getComposePointerId_I2yYro(motionEvent.getPointerId(index));
        ...
        if (index != 0) {
            if (Build.VERSION.SDK_INT >= 29) {
                jM2631toRawOffsetdBAh8RU = MotionEventHelper.INSTANCE.m2631toRawOffsetdBAh8RU(motionEvent, index);
                jMo2767screenToLocalMKHz9U = positionCalculator.mo2767screenToLocalMKHz9U(jM2631toRawOffsetdBAh8RU);
            } else {
                j = jOffset;
                jMo2766localToScreenMKHz9U = positionCalculator.mo2766localToScreenMKHz9U(jOffset);
            }
            toolType = motionEvent.getToolType(index);
            if (toolType != 0) {
                iM2765getUnknownT8wyACA = PointerType.INSTANCE.m2765getUnknownT8wyACA();
            } else if (toolType != 1) {
                iM2765getUnknownT8wyACA = PointerType.INSTANCE.m2764getTouchT8wyACA();
            } else if (toolType != 2) {
                iM2765getUnknownT8wyACA = PointerType.INSTANCE.m2763getStylusT8wyACA();
            } else if (toolType != 3) {
                iM2765getUnknownT8wyACA = PointerType.INSTANCE.m2762getMouseT8wyACA();
            } else if (toolType != 4) {
                iM2765getUnknownT8wyACA = PointerType.INSTANCE.m2765getUnknownT8wyACA();
            } else {
                iM2765getUnknownT8wyACA = PointerType.INSTANCE.m2761getEraserT8wyACA();
            }
            int i2 = iM2765getUnknownT8wyACA;
            ...
            if (motionEvent.getActionMasked() == 8) {
                jM1463getZeroF1C5BW0 = OffsetKt.Offset(motionEvent.getAxisValue(10), (-motionEvent.getAxisValue(9)) + 0.0f);
            } else {
                jM1463getZeroF1C5BW0 = Offset.INSTANCE.m1463getZeroF1C5BW0();
            }
            long j2 = jM1463getZeroF1C5BW0;
            return new PointerInputEventData(jM2630getComposePointerId_I2yYro, motionEvent.getEventTime(), jMo2766localToScreenMKHz9U, j, pressed, pressure, i2, this.canHover.get(motionEvent.getPointerId(index), false), arrayList, j2, null);
        }
        jM2631toRawOffsetdBAh8RU = OffsetKt.Offset(motionEvent.getRawX(), motionEvent.getRawY());
        jMo2767screenToLocalMKHz9U = positionCalculator.mo2767screenToLocalMKHz9U(jM2631toRawOffsetdBAh8RU);
        jMo2766localToScreenMKHz9U = jM2631toRawOffsetdBAh8RU;
        j = jMo2767screenToLocalMKHz9U;
        toolType = motionEvent.getToolType(index);
        if (toolType != 0) {
            iM2765getUnknownT8wyACA = PointerType.INSTANCE.m2765getUnknownT8wyACA();
        } else if (toolType != 1) {
        ...
        int i3 = iM2765getUnknownT8wyACA;
        arrayList = new ArrayList(motionEvent.getHistorySize());
        historySize = motionEvent.getHistorySize();
        while (i < historySize) {
            historicalX = motionEvent.getHistoricalX(index, i);
        ...
        long j3 = jM1463getZeroF1C5BW0;
        return new PointerInputEventData(jM2630getComposePointerId_I2yYro, motionEvent.getEventTime(), jMo2766localToScreenMKHz9U, j, pressed, pressure, i3, this.canHover.get(motionEvent.getPointerId(index), false), arrayList, j3, null);
    }

    /* JADX INFO: renamed from: getComposePointerId-_I2yYro, reason: not valid java name */
    private final long m2630getComposePointerId_I2yYro(int motionEventPointerId) {
        long jValueAt;
        ...
        return PointerId.m2680constructorimpl(jValueAt);
    }
