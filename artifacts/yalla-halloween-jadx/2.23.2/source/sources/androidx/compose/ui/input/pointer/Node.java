...
public final class Node extends NodeParent {
    ...
    private final boolean hasPositionChanged(PointerEvent oldEvent, PointerEvent newEvent) {
        ...
        for (int i = 0; i < size; i++) {
            if (!Offset.m1444equalsimpl0(oldEvent.getChanges().get(i).getPosition(), newEvent.getChanges().get(i).getPosition())) {
                return true;
            }
        }
        return false;
    ...
    public void cleanUpHits(@NotNull InternalPointerEvent internalPointerEvent) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if ((pointerInputChange.getPressed() || (internalPointerEvent.m2629issuesEnterExitEvent0FcD4WY(pointerInputChange.getId()) && this.isIn)) ? false : true) {
                this.pointerIds.remove(PointerId.m2679boximpl(pointerInputChange.getId()));
            }
        }
        this.isIn = false;
        this.hasExited = PointerEventType.m2649equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m2654getExit7fucELk());
    }
    ...
    public boolean dispatchFinalEventPass(@org.jetbrains.annotations.NotNull androidx.compose.ui.input.pointer.InternalPointerEvent r14) {
        ...
        L1a:
            ...
            long r2 = r2.mo2811getSizeYbymL2g()
            androidx.compose.ui.Modifier$Node r4 = r13.modifierNode
            r5 = 16
            int r6 = androidx.compose.ui.node.NodeKind.m3004constructorimpl(r5)
            r7 = 0
            r8 = r7
        L32:
            r9 = 1
            ...
            r4.mo154onPointerEventH0pRuoY(r0, r9, r2)
            goto L87
        L41:
