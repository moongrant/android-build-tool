...
public final class PointerButtons {
    ...
    public static final /* synthetic */ PointerButtons m2632boximpl(int i) {
        return new PointerButtons(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m2633constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m2634equalsimpl(int i, Object obj) {
        return (obj instanceof PointerButtons) && i == ((PointerButtons) obj).getPackedValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2635equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m2636hashCodeimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m2637toStringimpl(int i) {
        return androidx.compose.animation.core.OooO0OO.OooO00o("PointerButtons(packedValue=", i, ')');
    }

    public boolean equals(Object obj) {
        return m2634equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m2636hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m2637toStringimpl(this.packedValue);
    }
