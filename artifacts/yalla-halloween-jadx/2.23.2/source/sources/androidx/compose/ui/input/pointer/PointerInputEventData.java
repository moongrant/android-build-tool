...
public final /* data */ class PointerInputEventData {
    ...
    public final PointerInputEventData m2711copygYeeOSc(long id, long uptime, long positionOnScreen, long position, boolean down, float pressure, int type, boolean issuesEnterExit, @NotNull List<HistoricalChange> historical, long scrollDelta) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return PointerId.m2682equalsimpl0(this.id, pointerInputEventData.id) && this.uptime == pointerInputEventData.uptime && Offset.m1444equalsimpl0(this.positionOnScreen, pointerInputEventData.positionOnScreen) && Offset.m1444equalsimpl0(this.position, pointerInputEventData.position) && this.down == pointerInputEventData.down && Float.compare(this.pressure, pointerInputEventData.pressure) == 0 && PointerType.m2757equalsimpl0(this.type, pointerInputEventData.type) && this.issuesEnterExit == pointerInputEventData.issuesEnterExit && Intrinsics.areEqual(this.historical, pointerInputEventData.historical) && Offset.m1444equalsimpl0(this.scrollDelta, pointerInputEventData.scrollDelta);
    }
    ...
    public final long m2712getIdJ3iCeTQ() {
        return this.id;
    }
    ...
    public final long m2713getPositionF1C5BW0() {
        return this.position;
    }

    /* JADX INFO: renamed from: getPositionOnScreen-F1C5BW0, reason: not valid java name */
    public final long m2714getPositionOnScreenF1C5BW0() {
        return this.positionOnScreen;
    }
    ...
    public final long m2715getScrollDeltaF1C5BW0() {
        return this.scrollDelta;
    }

    /* JADX INFO: renamed from: getType-T8wyACA, reason: not valid java name */
    public final int m2716getTypeT8wyACA() {
        return this.type;
    }
    ...
    public int hashCode() {
        int iM2683hashCodeimpl = PointerId.m2683hashCodeimpl(this.id) * 31;
        long j = this.uptime;
        int iM1449hashCodeimpl = (Offset.m1449hashCodeimpl(this.position) + ((Offset.m1449hashCodeimpl(this.positionOnScreen) + ((iM2683hashCodeimpl + ((int) (j ^ (j >>> 32)))) * 31)) * 31)) * 31;
        boolean z = this.down;
        ?? r1 = z;
        if (z) {
            r1 = 1;
        }
        int iM2758hashCodeimpl = (PointerType.m2758hashCodeimpl(this.type) + o0OoOo0.OooO00o(this.pressure, (iM1449hashCodeimpl + r1) * 31, 31)) * 31;
        boolean z2 = this.issuesEnterExit;
        return Offset.m1449hashCodeimpl(this.scrollDelta) + ((this.historical.hashCode() + ((iM2758hashCodeimpl + (z2 ? 1 : z2)) * 31)) * 31);
    }

    @NotNull
    public String toString() {
        return "PointerInputEventData(id=" + ((Object) PointerId.m2684toStringimpl(this.id)) + ", uptime=" + this.uptime + ", positionOnScreen=" + ((Object) Offset.m1455toStringimpl(this.positionOnScreen)) + ", position=" + ((Object) Offset.m1455toStringimpl(this.position)) + ", down=" + this.down + ", pressure=" + this.pressure + ", type=" + ((Object) PointerType.m2759toStringimpl(this.type)) + ", issuesEnterExit=" + this.issuesEnterExit + ", historical=" + this.historical + ", scrollDelta=" + ((Object) Offset.m1455toStringimpl(this.scrollDelta)) + ')';
    }
    ...
    public /* synthetic */ PointerInputEventData(long j, long j2, long j3, long j4, boolean z, float f, int i, boolean z2, List list, long j5, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, j2, j3, j4, z, f, i, (i2 & 128) != 0 ? false : z2, (i2 & PSKKeyManager.MAX_KEY_LENGTH_BYTES) != 0 ? new ArrayList() : list, (i2 & ConstantsKt.MINIMUM_BLOCK_SIZE) != 0 ? Offset.INSTANCE.m1463getZeroF1C5BW0() : j5, null);
    }
}
