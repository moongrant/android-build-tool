...
public final class PointerInputEventProcessor {
    ...
    public static /* synthetic */ int m2717processBIzXfog$default(PointerInputEventProcessor pointerInputEventProcessor, PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
            z = true;
        }
        return pointerInputEventProcessor.m2718processBIzXfog(pointerInputEvent, positionCalculator, z);
    }
    ...
    public final int m2718processBIzXfog(@NotNull PointerInputEvent pointerEvent, @NotNull PositionCalculator positionCalculator, boolean isInBounds) {
        boolean z;
        ...
        try {
            ...
            for (PointerInputChange pointerInputChange3 : internalPointerEventProduce.getChanges().values()) {
                if (z3 || PointerEventKt.changedToDownIgnoreConsumed(pointerInputChange3)) {
                    LayoutNode.m2925hitTestM_7yMNQ$ui_release$default(this.root, pointerInputChange3.getPosition(), this.hitResult, PointerType.m2757equalsimpl0(pointerInputChange3.getType(), PointerType.INSTANCE.m2764getTouchT8wyACA()), false, 8, null);
                    if (!this.hitResult.isEmpty()) {
                        this.hitPathTracker.m2628addHitPathKNwqfcY(pointerInputChange3.getId(), this.hitResult);
