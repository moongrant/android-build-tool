...
public final class VelocityTracker {
    ...
    private long currentPointerPositionAccumulator = Offset.INSTANCE.m1463getZeroF1C5BW0();

    /* JADX INFO: renamed from: addPosition-Uv8p0NA, reason: not valid java name */
    public final void m2777addPositionUv8p0NA(long timeMillis, long position) {
        this.xVelocityTracker.addDataPoint(timeMillis, Offset.m1447getXimpl(position));
        this.yVelocityTracker.addDataPoint(timeMillis, Offset.m1448getYimpl(position));
    }

    /* JADX INFO: renamed from: calculateVelocity-9UxMQ8M, reason: not valid java name */
    public final long m2778calculateVelocity9UxMQ8M() {
    ...
    public final void m2780setCurrentPointerPositionAccumulatork4lQ0M$ui_release(long j) {
