...
public interface ContentScale {
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo2795computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM2801computeFillMaxDimensioniLBOSCw = ContentScaleKt.m2801computeFillMaxDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM2801computeFillMaxDimensioniLBOSCw, fM2801computeFillMaxDimensioniLBOSCw);
            }
        };
        ...
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public long mo2795computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM2802computeFillMinDimensioniLBOSCw = ContentScaleKt.m2802computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM2802computeFillMinDimensioniLBOSCw, fM2802computeFillMinDimensioniLBOSCw);
            }
        };
        ...
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public long mo2795computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM2800computeFillHeightiLBOSCw = ContentScaleKt.m2800computeFillHeightiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM2800computeFillHeightiLBOSCw, fM2800computeFillHeightiLBOSCw);
            }
        };
        ...
        private static final ContentScale FillWidth = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillWidth$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public long mo2795computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM2803computeFillWidthiLBOSCw = ContentScaleKt.m2803computeFillWidthiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM2803computeFillWidthiLBOSCw, fM2803computeFillWidthiLBOSCw);
            }
        };
        ...
        private static final ContentScale Inside = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Inside$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public long mo2795computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                if (Size.m1516getWidthimpl(srcSize) <= Size.m1516getWidthimpl(dstSize) && Size.m1513getHeightimpl(srcSize) <= Size.m1513getHeightimpl(dstSize)) {
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public long mo2795computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                return ScaleFactorKt.ScaleFactor(ContentScaleKt.m2803computeFillWidthiLBOSCw(srcSize, dstSize), ContentScaleKt.m2800computeFillHeightiLBOSCw(srcSize, dstSize));
            }
        };
    ...
    long mo2795computeScaleFactorH7hwNQA(long srcSize, long dstSize);
}
