...
public final /* data */ class FixedScale implements ContentScale {
    ...
    public String toString() {
        return androidx.compose.animation.OooO00o.OooO00o(new StringBuilder("FixedScale(value="), this.value, ')');
    }
}
