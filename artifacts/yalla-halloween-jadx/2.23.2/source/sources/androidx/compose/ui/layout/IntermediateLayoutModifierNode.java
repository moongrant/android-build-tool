...
public final class IntermediateLayoutModifierNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final class IntermediateMeasurablePlaceable extends Placeable implements Measurable {
        ...
        public Placeable mo2804measureBRTryo0(long constraints) {
            ...
            if (this.this$0.getIsIntermediateChangeActive()) {
                placeableMo2804measureBRTryo0 = this.wrappedMeasurable.mo2804measureBRTryo0(constraints);
                m2847setMeasurementConstraintsBRTryo0(constraints);
                m2846setMeasuredSizeozmzZPI(IntSizeKt.IntSize(placeableMo2804measureBRTryo0.getWidth(), placeableMo2804measureBRTryo0.getHeight()));
            } else {
                ...
                placeableMo2804measureBRTryo0 = measurable.mo2804measureBRTryo0(constraints2.getValue());
                ...
                m2847setMeasurementConstraintsBRTryo0(constraints3.getValue());
                m2846setMeasuredSizeozmzZPI(intermediateLayoutModifierNode.getIsIntermediateChangeActive() ? IntSizeKt.IntSize(placeableMo2804measureBRTryo0.getWidth(), placeableMo2804measureBRTryo0.getHeight()) : intermediateLayoutModifierNode.intermediateMeasureScope.getLookaheadSize());
            }
            this.wrappedPlaceable = placeableMo2804measureBRTryo0;
            return this;
        }
        ...
        public void mo2805placeAtf8xVGno(long position, float zIndex, @Nullable Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            Unit unit;
            if (!this.this$0.getIsIntermediateChangeActive()) {
                position = IntOffset.INSTANCE.m3903getZeronOccac();
            }
            if (layerBlock != null) {
                Placeable placeable = this.wrappedPlaceable;
                if (placeable != null) {
                    Placeable.PlacementScope.INSTANCE.m2857placeWithLayeraW9wM(placeable, position, zIndex, layerBlock);
                    unit = Unit.INSTANCE;
                } else {
                    unit = null;
                }
            ...
            if (placeable2 != null) {
                Placeable.PlacementScope.INSTANCE.m2852place70tqf50(placeable2, position, zIndex);
    ...
    public final class IntermediateMeasureScopeImpl implements IntermediateMeasureScope, CoroutineScope {
        ...
        @Override // androidx.compose.ui.layout.LookaheadScope
        public final /* synthetic */ Modifier intermediateLayout(Modifier modifier, Function4 function4) {
            return LookaheadScope.CC.OooO00o(this, modifier, function4);
        }
        ...
        public MeasureResult layout(final int width, final int height, @NotNull final Map<AlignmentLine, Integer> alignmentLines, @NotNull final Function1<? super Placeable.PlacementScope, Unit> placementBlock) {
            ...
            return new MeasureResult(width, height, alignmentLines, this, intermediateLayoutModifierNode, placementBlock) { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$IntermediateMeasureScopeImpl$layout$1
                ...
                public void placeChildren() {
                    ...
                    NodeCoordinator coordinator = this.this$1.getCoordinator();
                    ...
                    boolean zConfigureForPlacingForAlignment = companion.configureForPlacingForAlignment(coordinator);
                    function1.invoke(companion);
                    if (coordinator != null) {
                        coordinator.setPlacingForAlignment$ui_release(zConfigureForPlacingForAlignment);
                    }
        ...
        public final /* synthetic */ long mo2808localLookaheadPositionOfdBAh8RU(LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2) {
            return LookaheadScope.CC.OooO0O0(this, layoutCoordinates, layoutCoordinates2);
        }
        ...
        public void m2809setLookaheadSizeozmzZPI(long j) {
    ...
    public final MeasureResult m2806intermediateMeasureTeuZzU(@NotNull MeasureScope intermediateMeasure, @NotNull Measurable measurable, long j, long j2, long j3) {
        Intrinsics.checkNotNullParameter(intermediateMeasure, "$this$intermediateMeasure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        this.intermediateMeasureScope.m2809setLookaheadSizeozmzZPI(j2);
        this.lookaheadConstraints = Constraints.m3731boximpl(j3);
        ...
        return this.measureBlock.invoke(this.intermediateMeasureScope, intermediateMeasurablePlaceable, Constraints.m3731boximpl(j));
    }
    ...
    public final int maxIntermediateIntrinsicHeight$ui_release(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull IntrinsicMeasurable measurable, int i) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.maxHeight$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$maxIntermediateIntrinsicHeight$1
            ...
            public final MeasureResult mo2810measure3p2s80s(@NotNull MeasureScope maxHeight, @NotNull Measurable intrinsicMeasurable, long j) {
                Intrinsics.checkNotNullParameter(maxHeight, "$this$maxHeight");
                Intrinsics.checkNotNullParameter(intrinsicMeasurable, "intrinsicMeasurable");
                return this.this$0.getMeasureBlock$ui_release().invoke(this.this$0.intermediateMeasureScope, intrinsicMeasurable, Constraints.m3731boximpl(j));
            }
    ...
    public final int maxIntermediateIntrinsicWidth$ui_release(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull IntrinsicMeasurable measurable, int i) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.maxWidth$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$maxIntermediateIntrinsicWidth$1
            ...
            public final MeasureResult mo2810measure3p2s80s(@NotNull MeasureScope maxWidth, @NotNull Measurable intrinsicMeasurable, long j) {
    ...
    public MeasureResult mo250measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j) {
        ...
        return MeasureScope.CC.OooOOo0(measure, placeableMo2804measureBRTryo0.getWidth(), placeableMo2804measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$measure$1$1
            {
                super(1);
            }
    ...
    public final int minIntermediateIntrinsicHeight$ui_release(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull IntrinsicMeasurable measurable, int i) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.minHeight$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$minIntermediateIntrinsicHeight$1
            ...
            @NotNull
            /* JADX INFO: renamed from: measure-3p2s80s */
            public final MeasureResult mo2810measure3p2s80s(@NotNull MeasureScope minHeight, @NotNull Measurable intrinsicMeasurable, long j) {
    ...
    public final int minIntermediateIntrinsicWidth$ui_release(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull IntrinsicMeasurable measurable, int i) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.minWidth$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$minIntermediateIntrinsicWidth$1
            ...
            @NotNull
            /* JADX INFO: renamed from: measure-3p2s80s */
            public final MeasureResult mo2810measure3p2s80s(@NotNull MeasureScope minWidth, @NotNull Measurable intrinsicMeasurable, long j) {
    ...
    public void onAttach() {
        ...
        LookaheadDelegate lookaheadDelegate = coordinator2.getLookaheadDelegate();
        ...
        if (lookaheadRoot != null && lookaheadRoot.getIsVirtualLookaheadRoot()) {
            ...
            int iM3004constructorimpl = NodeKind.m3004constructorimpl(ConstantsKt.MINIMUM_BLOCK_SIZE);
            ...
            while (layoutNodeRequireLayoutNode != null) {
                if ((androidx.compose.ui.focus.OooO00o.OooO00o(layoutNodeRequireLayoutNode) & iM3004constructorimpl) != 0) {
                    while (parent != null) {
