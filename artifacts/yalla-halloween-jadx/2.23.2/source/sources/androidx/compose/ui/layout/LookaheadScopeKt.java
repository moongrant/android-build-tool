...
public final class LookaheadScopeKt {
        ...
        if ((i3 & 731) == 146 && composerStartRestartGroup.getSkipping()) {
            ...
            LookaheadScope(ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1705879204, true, new Function3<LookaheadScope, Composer, Integer, Unit>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt.LookaheadLayout.1
                ...
                public final void invoke(@NotNull LookaheadScope LookaheadScope, @Nullable Composer composer2, int i5) {
                    ...
                    androidx.compose.animation.OooOO0.OooO00o((i7 >> 3) & 112, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer2)), composer2, 2058660585);
    ...
    public static final void LookaheadScope(@NotNull final Function3<? super LookaheadScope, ? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, final int i) {
        ...
        if ((i2 & 11) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            C08071 c08071 = new Function0<LayoutNode>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt.LookaheadScope.1
            ...
            if (composerStartRestartGroup.getInserting()) {
                composerStartRestartGroup.createNode(c08071);
            } else {
                composerStartRestartGroup.useNode();
            }
            Composer composerM1320constructorimpl = Updater.m1320constructorimpl(composerStartRestartGroup);
            Updater.m1324initimpl(composerM1320constructorimpl, new Function1<LayoutNode, Unit>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt$LookaheadScope$2$1
            ...
            Updater.m1327setimpl(composerM1320constructorimpl, lookaheadScopeImpl, new Function2<LayoutNode, LookaheadScopeImpl, Unit>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt$LookaheadScope$2$2
                @Override // kotlin.jvm.functions.Function2
