...
public final class RootMeasurePolicy extends LayoutNode.NoIntrinsicsMeasurePolicy {
    ...
    public MeasureResult mo3measure3p2s80s(@NotNull MeasureScope measure, @NotNull List<? extends Measurable> measurables, long j) {
        ...
        if (measurables.isEmpty()) {
            return MeasureScope.CC.OooOOo0(measure, Constraints.m3745getMinWidthimpl(j), Constraints.m3744getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.RootMeasurePolicy$measure$1
        ...
        if (measurables.size() == 1) {
            ...
            return MeasureScope.CC.OooOOo0(measure, ConstraintsKt.m3757constrainWidthK40F9xA(j, placeableMo2804measureBRTryo0.getWidth()), ConstraintsKt.m3756constrainHeightK40F9xA(j, placeableMo2804measureBRTryo0.getHeight()), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.RootMeasurePolicy$measure$2
                ...
                public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                    Intrinsics.checkNotNullParameter(layout, "$this$layout");
                    Placeable.PlacementScope.placeRelativeWithLayer$default(layout, placeableMo2804measureBRTryo0, 0, 0, 0.0f, null, 12, null);
                }
            }, 4, null);
        }
        ...
        for (int i = 0; i < size; i++) {
            arrayList.add(measurables.get(i).mo2804measureBRTryo0(j));
        }
        ...
        return MeasureScope.CC.OooOOo0(measure, ConstraintsKt.m3757constrainWidthK40F9xA(j, iMax), ConstraintsKt.m3756constrainHeightK40F9xA(j, iMax2), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.RootMeasurePolicy$measure$4
