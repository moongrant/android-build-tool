...
public abstract class AlignmentLines {
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        while (true) {
            jOffset = mo2888calculatePositionInParentR5De75A(initialCoordinator, jOffset);
        ...
        int iRoundToInt = alignmentLine instanceof HorizontalAlignmentLine ? MathKt.roundToInt(Offset.m1448getYimpl(jOffset)) : MathKt.roundToInt(Offset.m1447getXimpl(jOffset));
    ...
    public abstract long mo2888calculatePositionInParentR5De75A(@NotNull NodeCoordinator nodeCoordinator, long j);
