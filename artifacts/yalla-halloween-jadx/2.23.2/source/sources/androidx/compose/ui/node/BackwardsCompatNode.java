...
public final class BackwardsCompatNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode, PointerInputModifierNode, ModifierLocalModifierNode, ModifierLocalReadScope, ParentDataModifierNode, LayoutAwareModifierNode, GlobalPositionAwareModifierNode, FocusEventModifierNode, FocusPropertiesModifierNode, FocusRequesterModifierNode, OwnerScope, BuildDrawCacheParams {
    ...
    private final void initializeModifier(boolean duringAttach) {
        ...
        if ((NodeKind.m3004constructorimpl(32) & getKindSet()) != 0) {
        ...
        if ((NodeKind.m3004constructorimpl(4) & getKindSet()) != 0) {
        ...
        if ((NodeKind.m3004constructorimpl(2) & getKindSet()) != 0) {
        ...
        if ((NodeKind.m3004constructorimpl(128) & getKindSet()) != 0) {
                    ...
                    DelegatableNodeKt.requireOwner(this).registerOnLayoutCompletedListener(new Owner.OnLayoutCompletedListener() { // from class: androidx.compose.ui.node.BackwardsCompatNode.initializeModifier.2
                        ...
                        public void onLayoutComplete() {
                            if (BackwardsCompatNode.this.lastOnPlacedCoordinates == null) {
                                ...
                                backwardsCompatNode.onPlaced(DelegatableNodeKt.m2903requireCoordinator64DMado(backwardsCompatNode, NodeKind.m3004constructorimpl(128)));
                            }
                        }
                    });
                }
        ...
        if (((NodeKind.m3004constructorimpl(PSKKeyManager.MAX_KEY_LENGTH_BYTES) & getKindSet()) != 0) && (element instanceof OnGloballyPositionedModifier) && BackwardsCompatNodeKt.isChainUpdate(this)) {
            DelegatableNodeKt.requireLayoutNode(this).invalidateMeasurements$ui_release();
        }
        if (element instanceof FocusRequesterModifier) {
            ((FocusRequesterModifier) element).getFocusRequester().getFocusRequesterNodes$ui_release().add(this);
        }
        if (((NodeKind.m3004constructorimpl(16) & getKindSet()) != 0) && (element instanceof PointerInputModifier)) {
            ((PointerInputModifier) element).getPointerInputFilter().setLayoutCoordinates$ui_release(getCoordinator());
        }
        if ((NodeKind.m3004constructorimpl(8) & getKindSet()) != 0) {
    ...
    public <T> T getCurrent(@NotNull ModifierLocal<T> modifierLocal) {
        ...
        int iM3004constructorimpl = NodeKind.m3004constructorimpl(32);
                    ...
                    if ((parent.getKindSet() & iM3004constructorimpl) != 0) {
                        ...
                        while (Pop != 0) {
                            if (Pop instanceof ModifierLocalModifierNode) {
                                ...
                                if (((Pop.getKindSet() & iM3004constructorimpl) != 0) && (Pop instanceof DelegatingNode)) {
    ...
    public long mo1352getSizeNHjbRc() {
        return IntSizeKt.m3945toSizeozmzZPI(DelegatableNodeKt.m2903requireCoordinator64DMado(this, NodeKind.m3004constructorimpl(128)).mo2811getSizeYbymL2g());
    }
    ...
    public void mo154onPointerEventH0pRuoY(@NotNull PointerEvent pointerEvent, @NotNull PointerEventPass pass, long bounds) {
        ...
        Modifier.Element element = this.element;
        Intrinsics.checkNotNull(element, "null cannot be cast to non-null type androidx.compose.ui.input.pointer.PointerInputModifier");
        ((PointerInputModifier) element).getPointerInputFilter().mo2720onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }

    @Override // androidx.compose.ui.node.LayoutAwareModifierNode
    /* JADX INFO: renamed from: onRemeasured-ozmzZPI */
    public void mo226onRemeasuredozmzZPI(long size) {
        Modifier.Element element = this.element;
        if (element instanceof OnRemeasuredModifier) {
            ((OnRemeasuredModifier) element).mo263onRemeasuredozmzZPI(size);
        }
    }
