...
public abstract class DelegatingNode extends Modifier.Node {
    ...
    private final void validateDelegateKindSet(int delegateKindSet, Modifier.Node delegateNode) {
        int kindSet = getKindSet();
        if ((delegateKindSet & NodeKind.m3004constructorimpl(2)) != 0) {
            if (!((NodeKind.m3004constructorimpl(2) & kindSet) != 0) || (this instanceof LayoutModifierNode)) {
                return;
            }
    ...
    public final <T extends DelegatableNode> T delegate(@NotNull T delegatableNode) {
        ...
        if (getIsAttached()) {
            if ((iCalculateNodeKindSetFromIncludingDelegates & NodeKind.m3004constructorimpl(2)) != 0) {
                if ((kindSet & NodeKind.m3004constructorimpl(2)) != 0) {
    ...
    public final void undelegate(@NotNull DelegatableNode instance) {
        ...
        if (getIsAttached()) {
            if ((kindSet & NodeKind.m3004constructorimpl(2)) != 0) {
                if ((NodeKind.m3004constructorimpl(2) & iCalculateNodeKindSetFromIncludingDelegates) != 0) {
                    return;
                }
                NodeChain nodes = DelegatableNodeKt.requireLayoutNode(this).getNodes();
                getNode().updateCoordinator$ui_release(null);
