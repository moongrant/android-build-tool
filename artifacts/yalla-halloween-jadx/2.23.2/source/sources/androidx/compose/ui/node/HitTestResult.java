...
public final class HitTestResult implements List<Modifier.Node>, KMappedMarker {
    ...
    private final long m2923findBestHitDistanceptXAw2c() {
        ...
        if (i <= lastIndex) {
            while (true) {
                long jM2915constructorimpl = DistanceAndInLayer.m2915constructorimpl(this.distanceFromEdgeAndInLayer[i]);
                if (DistanceAndInLayer.m2914compareToS_HNhKs(jM2915constructorimpl, jDistanceAndInLayer) < 0) {
                    jDistanceAndInLayer = jM2915constructorimpl;
                }
                if (DistanceAndInLayer.m2918getDistanceimpl(jDistanceAndInLayer) < 0.0f && DistanceAndInLayer.m2920isInLayerimpl(jDistanceAndInLayer)) {
    ...
    public final boolean hasHit() {
        long jM2923findBestHitDistanceptXAw2c = m2923findBestHitDistanceptXAw2c();
        return DistanceAndInLayer.m2918getDistanceimpl(jM2923findBestHitDistanceptXAw2c) < 0.0f && DistanceAndInLayer.m2920isInLayerimpl(jM2923findBestHitDistanceptXAw2c);
    }
    ...
    public final boolean isHitInMinimumTouchTargetBetter(float distanceFromEdge, boolean isInLayer) {
        ...
        return DistanceAndInLayer.m2914compareToS_HNhKs(m2923findBestHitDistanceptXAw2c(), HitTestResultKt.DistanceAndInLayer(distanceFromEdge, isInLayer)) > 0;
    }
    ...
    public final void speculativeHit(@NotNull Modifier.Node node, float distanceFromEdge, boolean isInLayer, @NotNull Function0<Unit> childHitTest) {
        ...
        hitInMinimumTouchTarget(node, distanceFromEdge, isInLayer, childHitTest);
        if (this.hitDepth + 1 < CollectionsKt.getLastIndex(this) && DistanceAndInLayer.m2914compareToS_HNhKs(jM2923findBestHitDistanceptXAw2c, m2923findBestHitDistanceptXAw2c()) > 0) {
