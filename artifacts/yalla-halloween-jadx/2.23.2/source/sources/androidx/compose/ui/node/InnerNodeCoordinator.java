...
public final class InnerNodeCoordinator extends NodeCoordinator {
    ...
    static {
        ...
        Paint.mo1568setColor8_81llA(Color.INSTANCE.m1715getRed0d7_KjU());
    ...
    public void mo2924hitTestChildYqVAtuI(@NotNull NodeCoordinator.HitTestSource hitTestSource, long pointerPosition, @NotNull HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        boolean z;
        boolean z2;
        boolean z3;
        boolean z4;
        ...
        if (!hitTestSource.shouldHitTestChildren(getLayoutNode())) {
            z = isInLayer;
            z2 = false;
        } else if (m2998withinLayerBoundsk4lQ0M(pointerPosition)) {
            z = isInLayer;
            z2 = true;
            ...
            if ((Float.isInfinite(fM2986distanceInMinimumTouchTargettz77jQw) || Float.isNaN(fM2986distanceInMinimumTouchTargettz77jQw)) ? false : true) {
                z2 = true;
                z = false;
            } else {
                z = isInLayer;
            ...
            if (size > 0) {
                ...
                do {
                    ...
                    if (layoutNode.isPlaced()) {
                        hitTestSource.mo2999childHitTestYqVAtuI(layoutNode, pointerPosition, hitTestResult, isTouchEvent, z);
