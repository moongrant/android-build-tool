...
final class LayerPositionalProperties {
                        ...
                        if (this.rotationX == other.rotationX) {
                            if (this.rotationY == other.rotationY) {
                                if (this.rotationZ == other.rotationZ) {
                                    if ((this.cameraDistance == other.cameraDistance) && TransformOrigin.m2037equalsimpl0(this.transformOrigin, other.transformOrigin)) {
                                        return true;
                                    }
                                }
                            }
    ...
    public final void copyFrom(@NotNull GraphicsLayerScope scope) {
        ...
        this.transformOrigin = scope.mo1846getTransformOriginSzJe1aQ();
    }
}
