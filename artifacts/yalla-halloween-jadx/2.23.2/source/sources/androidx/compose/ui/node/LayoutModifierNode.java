...
public interface LayoutModifierNode extends DelegatableNode {
    ...
    public final /* synthetic */ class CC {
        public static int OooO00o(final LayoutModifierNode layoutModifierNode, @NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull IntrinsicMeasurable measurable, int i) {
            ...
            return NodeMeasuringIntrinsics.INSTANCE.maxHeight$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.node.LayoutModifierNode.maxIntrinsicHeight.1
                ...
                public final MeasureResult mo2810measure3p2s80s(@NotNull MeasureScope maxHeight, @NotNull Measurable intrinsicMeasurable, long j) {
                    ...
                    return LayoutModifierNode.this.mo250measure3p2s80s(maxHeight, intrinsicMeasurable, j);
                }
            }, intrinsicMeasureScope, measurable, i);
        }

        public static int OooO0O0(final LayoutModifierNode layoutModifierNode, @NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull IntrinsicMeasurable measurable, int i) {
            Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
            Intrinsics.checkNotNullParameter(measurable, "measurable");
            return NodeMeasuringIntrinsics.INSTANCE.maxWidth$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.node.LayoutModifierNode.maxIntrinsicWidth.1
                ...
                public final MeasureResult mo2810measure3p2s80s(@NotNull MeasureScope maxWidth, @NotNull Measurable intrinsicMeasurable, long j) {
                    ...
                    Intrinsics.checkNotNullParameter(intrinsicMeasurable, "intrinsicMeasurable");
                    return LayoutModifierNode.this.mo250measure3p2s80s(maxWidth, intrinsicMeasurable, j);
                }
            }, intrinsicMeasureScope, measurable, i);
        }

        public static int OooO0OO(final LayoutModifierNode layoutModifierNode, @NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull IntrinsicMeasurable measurable, int i) {
            Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
            Intrinsics.checkNotNullParameter(measurable, "measurable");
            return NodeMeasuringIntrinsics.INSTANCE.minHeight$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.node.LayoutModifierNode.minIntrinsicHeight.1
                ...
                public final MeasureResult mo2810measure3p2s80s(@NotNull MeasureScope minHeight, @NotNull Measurable intrinsicMeasurable, long j) {
                    ...
                    Intrinsics.checkNotNullParameter(intrinsicMeasurable, "intrinsicMeasurable");
                    return LayoutModifierNode.this.mo250measure3p2s80s(minHeight, intrinsicMeasurable, j);
                }
            }, intrinsicMeasureScope, measurable, i);
        }
        ...
        public static int OooO0Oo(final LayoutModifierNode layoutModifierNode, @NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull IntrinsicMeasurable measurable, int i) {
            ...
            return NodeMeasuringIntrinsics.INSTANCE.minWidth$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.node.LayoutModifierNode.minIntrinsicWidth.1
                ...
                public final MeasureResult mo2810measure3p2s80s(@NotNull MeasureScope minWidth, @NotNull Measurable intrinsicMeasurable, long j) {
                    ...
                    Intrinsics.checkNotNullParameter(intrinsicMeasurable, "intrinsicMeasurable");
                    return LayoutModifierNode.this.mo250measure3p2s80s(minWidth, intrinsicMeasurable, j);
                }
            }, intrinsicMeasureScope, measurable, i);
        }
    }
    ...
    @NotNull
    /* JADX INFO: renamed from: measure-3p2s80s */
    MeasureResult mo250measure3p2s80s(@NotNull MeasureScope measureScope, @NotNull Measurable measurable, long j);
