...
public abstract class LookaheadCapablePlaceable extends Placeable implements MeasureScopeWithLayoutNode {
    ...
    public final int get(@NotNull AlignmentLine alignmentLine) {
        ...
        if (getHasMeasureResult() && (iCalculateAlignmentLine = calculateAlignmentLine(alignmentLine)) != Integer.MIN_VALUE) {
            return iCalculateAlignmentLine + (alignmentLine instanceof VerticalAlignmentLine ? IntOffset.m3893getXimpl(getApparentToRealOffset()) : IntOffset.m3894getYimpl(getApparentToRealOffset()));
        }
