...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public final void set_measureResult(MeasureResult measureResult) {
        ...
        if (measureResult != null) {
            m2846setMeasuredSizeozmzZPI(IntSizeKt.IntSize(measureResult.getWidth(), measureResult.getHeight()));
            unit = Unit.INSTANCE;
        } else {
            unit = null;
        }
        if (unit == null) {
            m2846setMeasuredSizeozmzZPI(IntSize.INSTANCE.m3940getZeroYbymL2g());
        }
    ...
    public final Placeable m2955performingMeasureK40F9xA(long constraints, @NotNull Function0<? extends MeasureResult> block) {
    ...
    public final void mo2805placeAtf8xVGno(long position, float zIndex, @Nullable Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        if (!IntOffset.m3892equalsimpl0(getPosition(), position)) {
            m2957setPositiongyyYBs(position);
    ...
    public final long m2956positionInBjo55l4$ui_release(@NotNull LookaheadDelegate ancestor) {
        Intrinsics.checkNotNullParameter(ancestor, "ancestor");
        long jM3903getZeronOccac = IntOffset.INSTANCE.m3903getZeronOccac();
        ...
        while (!Intrinsics.areEqual(lookaheadDelegate, ancestor)) {
            ...
            jM3903getZeronOccac = androidx.compose.foundation.lazy.OooO0o.OooO00o(position, IntOffset.m3894getYimpl(jM3903getZeronOccac), IntOffset.m3893getXimpl(position) + IntOffset.m3893getXimpl(jM3903getZeronOccac));
    ...
    public void replace$ui_release() {
        mo2805placeAtf8xVGno(getPosition(), 0.0f, null);
    }

    /* JADX INFO: renamed from: setPosition--gyyYBs, reason: not valid java name */
    public void m2957setPositiongyyYBs(long j) {
        this.position = j;
    }
}
