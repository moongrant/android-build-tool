...
public final class MeasureAndLayoutDelegate {
    ...
    private final boolean m2958doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        if (layoutNode.getLookaheadRoot() == null) {
            return false;
        }
        boolean zM2931lookaheadRemeasure_Sx5XlM$ui_release = constraints != null ? layoutNode.m2931lookaheadRemeasure_Sx5XlM$ui_release(constraints) : LayoutNode.m2927lookaheadRemeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (zM2931lookaheadRemeasure_Sx5XlM$ui_release && parent$ui_release != null) {
        ...
        return zM2931lookaheadRemeasure_Sx5XlM$ui_release;
    }

    /* JADX INFO: renamed from: doRemeasure-sdFAvZA, reason: not valid java name */
    private final boolean m2959doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean zM2932remeasure_Sx5XlM$ui_release = constraints != null ? layoutNode.m2932remeasure_Sx5XlM$ui_release(constraints) : LayoutNode.m2928remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (zM2932remeasure_Sx5XlM$ui_release && parent$ui_release != null) {
        ...
        return zM2932remeasure_Sx5XlM$ui_release;
    }
    ...
    public final boolean remeasureAndRelayoutIfNeeded(LayoutNode layoutNode, boolean affectsLookahead) {
        ...
        boolean zM2958doLookaheadRemeasuresdFAvZA;
        boolean zM2959doRemeasuresdFAvZA;
        int i = 0;
        ...
        if (layoutNode.getLookaheadMeasurePending$ui_release() || layoutNode.getMeasurePending$ui_release()) {
            ...
            zM2958doLookaheadRemeasuresdFAvZA = (layoutNode.getLookaheadMeasurePending$ui_release() && affectsLookahead) ? m2958doLookaheadRemeasuresdFAvZA(layoutNode, constraints) : false;
            zM2959doRemeasuresdFAvZA = m2959doRemeasuresdFAvZA(layoutNode, constraints);
        } else {
            zM2959doRemeasuresdFAvZA = false;
            zM2958doLookaheadRemeasuresdFAvZA = false;
        }
        if ((zM2958doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual(layoutNode.isPlacedInLookahead(), Boolean.TRUE) && affectsLookahead) {
        ...
        return zM2959doRemeasuresdFAvZA;
    }
    ...
    private final void remeasureOnly(LayoutNode layoutNode) {
        ...
        if (layoutNode.getMeasurePending$ui_release() || layoutNode.getLookaheadMeasurePending$ui_release()) {
            ...
            if (layoutNode.getLookaheadMeasurePending$ui_release()) {
                m2958doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
            }
            m2959doRemeasuresdFAvZA(layoutNode, constraints);
        }
    }
    ...
    public final void m2960measureAndLayout0kLqBqw(@NotNull LayoutNode layoutNode, long constraints) {
        Intrinsics.checkNotNullParameter(layoutNode, "layoutNode");
        ...
        if (this.rootConstraints != null) {
            ...
            try {
                ...
                boolean zM2958doLookaheadRemeasuresdFAvZA = m2958doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m3731boximpl(constraints));
                m2959doRemeasuresdFAvZA(layoutNode, Constraints.m3731boximpl(constraints));
                if ((zM2958doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual(layoutNode.isPlacedInLookahead(), Boolean.TRUE)) {
                    layoutNode.lookaheadReplace$ui_release();
                }
                if (layoutNode.getLayoutPending$ui_release() && layoutNode.isPlaced()) {
                    layoutNode.replace$ui_release();
    ...
    public final void m2961updateRootConstraintsBRTryo0(long constraints) {
        ...
        this.rootConstraints = Constraints.m3731boximpl(constraints);
