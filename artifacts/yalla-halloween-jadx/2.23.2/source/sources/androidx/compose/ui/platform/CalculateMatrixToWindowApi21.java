...
final class CalculateMatrixToWindowApi21 implements CalculateMatrixToWindow {
    ...
    @NotNull
    private final float[] tmpMatrix = Matrix.m1886constructorimpl$default(null, 1, null);

    /* JADX INFO: renamed from: preConcat-tU-YjHk, reason: not valid java name */
    private final void m3093preConcattUYjHk(float[] fArr, android.graphics.Matrix matrix) {
        AndroidMatrixConversions_androidKt.m1560setFromtUYjHk(this.tmpMatrix, matrix);
        AndroidComposeView_androidKt.m3091preTransformJiSxe2E(fArr, this.tmpMatrix);
    }

    /* JADX INFO: renamed from: preTranslate-3XD1CNM, reason: not valid java name */
    private final void m3094preTranslate3XD1CNM(float[] fArr, float f, float f2) {
        Matrix.m1895resetimpl(this.tmpMatrix);
        Matrix.m1906translateimpl$default(this.tmpMatrix, f, f2, 0.0f, 4, null);
        AndroidComposeView_androidKt.m3091preTransformJiSxe2E(fArr, this.tmpMatrix);
    }

    /* JADX INFO: renamed from: transformMatrixToWindow-EL8BTi8, reason: not valid java name */
    private final void m3095transformMatrixToWindowEL8BTi8(View view, float[] matrix) {
        Object parent = view.getParent();
        if (parent instanceof View) {
            m3095transformMatrixToWindowEL8BTi8((View) parent, matrix);
            m3094preTranslate3XD1CNM(matrix, -view.getScrollX(), -view.getScrollY());
            m3094preTranslate3XD1CNM(matrix, view.getLeft(), view.getTop());
        } else {
            int[] iArr = this.tmpLocation;
            view.getLocationInWindow(iArr);
            m3094preTranslate3XD1CNM(matrix, -view.getScrollX(), -view.getScrollY());
            m3094preTranslate3XD1CNM(matrix, iArr[0], iArr[1]);
        }
        ...
        m3093preConcattUYjHk(matrix, viewMatrix);
    }

    @Override // androidx.compose.ui.platform.CalculateMatrixToWindow
    /* JADX INFO: renamed from: calculateMatrixToWindow-EL8BTi8 */
    public void mo3092calculateMatrixToWindowEL8BTi8(@NotNull View view, @NotNull float[] matrix) {
        Intrinsics.checkNotNullParameter(view, "view");
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        Matrix.m1895resetimpl(matrix);
        m3095transformMatrixToWindowEL8BTi8(view, matrix);
    }
}
