...
public final class DecodeHelper {
    ...
    private final float m3097decodeBaselineShifty9eOQZs() {
        return BaselineShift.m3575constructorimpl(decodeFloat());
    }
    ...
    private final Shadow decodeShadow() {
        return new Shadow(m3099decodeColor0d7_KjU(), OffsetKt.Offset(decodeFloat(), decodeFloat()), decodeFloat(), null);
    }
    ...
    private final long m3098decodeULongsVKNKU() {
        return ULong.m4389constructorimpl(this.parcel.readLong());
    }

    /* JADX INFO: renamed from: decodeColor-0d7_KjU, reason: not valid java name */
    public final long m3099decodeColor0d7_KjU() {
        return Color.m1677constructorimpl(m3098decodeULongsVKNKU());
    }

    /* JADX INFO: renamed from: decodeFontStyle-_-LCdwA, reason: not valid java name */
    public final int m3100decodeFontStyle_LCdwA() {
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 0) {
            return FontStyle.INSTANCE.m3421getNormal_LCdwA();
        }
        return bDecodeByte == 1 ? FontStyle.INSTANCE.m3420getItalic_LCdwA() : FontStyle.INSTANCE.m3421getNormal_LCdwA();
    }

    /* JADX INFO: renamed from: decodeFontSynthesis-GVVA2EU, reason: not valid java name */
    public final int m3101decodeFontSynthesisGVVA2EU() {
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 0) {
            return FontSynthesis.INSTANCE.m3432getNoneGVVA2EU();
        }
        if (bDecodeByte == 1) {
            return FontSynthesis.INSTANCE.m3431getAllGVVA2EU();
        }
        if (bDecodeByte == 3) {
            return FontSynthesis.INSTANCE.m3433getStyleGVVA2EU();
        }
        return bDecodeByte == 2 ? FontSynthesis.INSTANCE.m3434getWeightGVVA2EU() : FontSynthesis.INSTANCE.m3432getNoneGVVA2EU();
    }
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (bDecodeByte != 1) {
                ...
                if (bDecodeByte == 2) {
                    ...
                    mutableSpanStyle.m3130setFontSizeR2X_6o(m3102decodeTextUnitXSAIIZE());
                    ...
                    mutableSpanStyle.m3131setFontStylemLjRB2g(FontStyle.m3413boximpl(m3100decodeFontStyle_LCdwA()));
                    mutableSpanStyle2 = mutableSpanStyle;
                    ...
                    if (bDecodeByte == 6) {
                        ...
                        mutableSpanStyle.m3133setLetterSpacingR2X_6o(m3102decodeTextUnitXSAIIZE());
                    } else if (bDecodeByte == 8) {
                        if (dataAvailable() < 4) {
                            return mutableSpanStyle.toSpanStyle();
                        }
                        mutableSpanStyle.m3128setBaselineShift_isdbwI(BaselineShift.m3574boximpl(m3097decodeBaselineShifty9eOQZs()));
                        ...
                        mutableSpanStyle.m3127setBackground8_81llA(m3099decodeColor0d7_KjU());
                    ...
                    mutableSpanStyle.m3132setFontSynthesistDdu0R4(FontSynthesis.m3422boximpl(m3101decodeFontSynthesisGVVA2EU()));
                    mutableSpanStyle2 = mutableSpanStyle;
                }
            } else {
                if (dataAvailable() < 8) {
                ...
                mutableSpanStyle2.m3129setColor8_81llA(m3099decodeColor0d7_KjU());
            }
        }
        mutableSpanStyle = mutableSpanStyle2;
        return mutableSpanStyle.toSpanStyle();
    ...
    public final long m3102decodeTextUnitXSAIIZE() {
        long jM3988getEmUIouoOA;
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 1) {
            jM3988getEmUIouoOA = TextUnitType.INSTANCE.m3989getSpUIouoOA();
        } else {
            jM3988getEmUIouoOA = bDecodeByte == 2 ? TextUnitType.INSTANCE.m3988getEmUIouoOA() : TextUnitType.INSTANCE.m3990getUnspecifiedUIouoOA();
        }
        return TextUnitType.m3984equalsimpl0(jM3988getEmUIouoOA, TextUnitType.INSTANCE.m3990getUnspecifiedUIouoOA()) ? TextUnit.INSTANCE.m3967getUnspecifiedXSAIIZE() : TextUnitKt.m3968TextUnitanM5pPY(decodeFloat(), jM3988getEmUIouoOA);
    }
}
