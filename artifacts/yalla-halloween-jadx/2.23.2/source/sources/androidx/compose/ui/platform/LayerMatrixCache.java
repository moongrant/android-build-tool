...
public final class LayerMatrixCache<T> {
    ...
    public final float[] m3118calculateInverseMatrixbWbORWo(T target) {
        float[] fArrM1886constructorimpl$default = this.inverseMatrixCache;
        if (fArrM1886constructorimpl$default == null) {
            fArrM1886constructorimpl$default = androidx.compose.ui.graphics.Matrix.m1886constructorimpl$default(null, 1, null);
            this.inverseMatrixCache = fArrM1886constructorimpl$default;
        }
        if (this.isInverseDirty) {
            this.isInverseValid = InvertMatrixKt.m3116invertToJiSxe2E(m3119calculateMatrixGrdbGEg(target), fArrM1886constructorimpl$default);
            this.isInverseDirty = false;
        }
        if (this.isInverseValid) {
            return fArrM1886constructorimpl$default;
        }
        return null;
    }
    ...
    public final float[] m3119calculateMatrixGrdbGEg(T target) {
        float[] fArrM1886constructorimpl$default = this.matrixCache;
        if (fArrM1886constructorimpl$default == null) {
            fArrM1886constructorimpl$default = androidx.compose.ui.graphics.Matrix.m1886constructorimpl$default(null, 1, null);
            this.matrixCache = fArrM1886constructorimpl$default;
        }
        if (!this.isDirty) {
            return fArrM1886constructorimpl$default;
        }
        ...
        if (matrix2 == null || !Intrinsics.areEqual(matrix, matrix2)) {
            AndroidMatrixConversions_androidKt.m1560setFromtUYjHk(fArrM1886constructorimpl$default, matrix);
