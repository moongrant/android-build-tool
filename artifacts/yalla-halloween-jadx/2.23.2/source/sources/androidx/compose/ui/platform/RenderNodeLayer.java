...
public final class RenderNodeLayer implements OwnedLayer, GraphicLayerInfo {
    ...
    public RenderNodeLayer(@NotNull AndroidComposeView ownerView, @NotNull Function1<? super Canvas, Unit> drawBlock, @NotNull Function0<Unit> invalidateParentLayer) {
        ...
        this.transformOrigin = TransformOrigin.INSTANCE.m2043getCenterSzJe1aQ();
    ...
    public void drawLayer(@NotNull Canvas canvas) {
        ...
        canvas.mo1544concat58bKbWc(this.matrixCache.m3119calculateMatrixGrdbGEg(this.renderNode));
    ...
    public void mo3049inverseTransform58bKbWc(@NotNull float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        float[] fArrM3118calculateInverseMatrixbWbORWo = this.matrixCache.m3118calculateInverseMatrixbWbORWo(this.renderNode);
    ...
    public boolean mo3050isInLayerk4lQ0M(long position) {
        ...
        if (this.renderNode.getClipToBounds()) {
            return 0.0f <= fM1447getXimpl && fM1447getXimpl < ((float) this.renderNode.getWidth()) && 0.0f <= fM1448getYimpl && fM1448getYimpl < ((float) this.renderNode.getHeight());
        }
    ...
    public void mapBounds(@NotNull MutableRect rect, boolean inverse) {
        ...
        if (!inverse) {
            androidx.compose.ui.graphics.Matrix.m1894mapimpl(this.matrixCache.m3119calculateMatrixGrdbGEg(this.renderNode), rect);
            return;
        }
        float[] fArrM3118calculateInverseMatrixbWbORWo = this.matrixCache.m3118calculateInverseMatrixbWbORWo(this.renderNode);
        if (fArrM3118calculateInverseMatrixbWbORWo == null) {
    ...
    public long mo3051mapOffset8S9VItk(long point, boolean inverse) {
        if (!inverse) {
            return androidx.compose.ui.graphics.Matrix.m1892mapMKHz9U(this.matrixCache.m3119calculateMatrixGrdbGEg(this.renderNode), point);
        }
        float[] fArrM3118calculateInverseMatrixbWbORWo = this.matrixCache.m3118calculateInverseMatrixbWbORWo(this.renderNode);
    ...
    public void mo3052movegyyYBs(long position) {
        ...
        if (left == iM3893getXimpl && top == iM3894getYimpl) {
            return;
        }
        if (left != iM3893getXimpl) {
            this.renderNode.offsetLeftAndRight(iM3893getXimpl - left);
        }
        if (top != iM3894getYimpl) {
            this.renderNode.offsetTopAndBottom(iM3894getYimpl - top);
        }
        triggerRepaint();
    ...
    public void mo3053resizeozmzZPI(long size) {
        ...
        this.renderNode.setPivotX(TransformOrigin.m2038getPivotFractionXimpl(this.transformOrigin) * f);
        float f2 = iM3934getHeightimpl;
        this.renderNode.setPivotY(TransformOrigin.m2039getPivotFractionYimpl(this.transformOrigin) * f2);
        DeviceRenderNode deviceRenderNode = this.renderNode;
        if (deviceRenderNode.setPosition(deviceRenderNode.getLeft(), this.renderNode.getTop(), this.renderNode.getLeft() + iM3935getWidthimpl, this.renderNode.getTop() + iM3934getHeightimpl)) {
    ...
    public void mo3054transform58bKbWc(@NotNull float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        androidx.compose.ui.graphics.Matrix.m1903timesAssign58bKbWc(matrix, this.matrixCache.m3119calculateMatrixGrdbGEg(this.renderNode));
    }
    ...
    public void mo3055updateLayerPropertiesdDxrwY(float scaleX, float scaleY, float alpha, float translationX, float translationY, float shadowElevation, float rotationX, float rotationY, float rotationZ, float cameraDistance, long transformOrigin, @NotNull Shape shape, boolean clip, @Nullable RenderEffect renderEffect, long ambientShadowColor, long spotShadowColor, int compositingStrategy, @NotNull LayoutDirection layoutDirection, @NotNull Density density) {
        ...
        this.renderNode.setAmbientShadowColor(ColorKt.m1735toArgb8_81llA(ambientShadowColor));
        this.renderNode.setSpotShadowColor(ColorKt.m1735toArgb8_81llA(spotShadowColor));
        ...
        this.renderNode.setPivotX(TransformOrigin.m2038getPivotFractionXimpl(transformOrigin) * this.renderNode.getWidth());
        this.renderNode.setPivotY(TransformOrigin.m2039getPivotFractionYimpl(transformOrigin) * this.renderNode.getHeight());
        ...
        this.renderNode.mo3104setCompositingStrategyaDBOjCE(compositingStrategy);
