...
final class WrappedComposition implements Composition, LifecycleEventObserver {
    ...
    public WrappedComposition(@NotNull AndroidComposeView owner, @NotNull Composition original) {
        ...
        this.lastContent = ComposableSingletons$Wrapper_androidKt.INSTANCE.m3096getLambda1$ui_release();
    }
                ...
                if (WrappedComposition.this.addedToLifecycle == null) {
                    ...
                    original.setContent(ComposableLambdaKt.composableLambdaInstance(-2000640158, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.platform.WrappedComposition.setContent.1.1
                        ...
                        public static final class C01111 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                            ...
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            public C01111(WrappedComposition wrappedComposition, Continuation<? super C01111> continuation) {
                        ...
                        public final void invoke(@Nullable Composer composer, int i) {
                            ...
                            EffectsKt.LaunchedEffect(wrappedComposition.getOwner(), new C01111(wrappedComposition, null), composer, 72);
