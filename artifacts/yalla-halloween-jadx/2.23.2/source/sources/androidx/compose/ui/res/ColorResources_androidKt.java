...
public final class ColorResources_androidKt {
    ...
    public static final long colorResource(@ColorRes int i, @Nullable Composer composer, int i2) {
        ...
        long jM3148getColorWaAFU9c = ColorResourceHelper.INSTANCE.m3148getColorWaAFU9c((Context) composer.consume(AndroidCompositionLocals_androidKt.getLocalContext()), i);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        return jM3148getColorWaAFU9c;
    }
}
