...
public final /* data */ class ParagraphInfo {
    ...
    public int hashCode() {
        return Float.floatToIntBits(this.bottom) + o0OoOo0.OooO00o(this.top, ((((((((this.paragraph.hashCode() * 31) + this.startIndex) * 31) + this.endIndex) * 31) + this.startLineIndex) * 31) + this.endLineIndex) * 31, 31);
    }
    ...
    public final Rect toGlobal(@NotNull Rect rect) {
        ...
        return rect.m1484translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    /* JADX INFO: renamed from: toGlobal-GEjPoXI, reason: not valid java name */
    public final long m3216toGlobalGEjPoXI(long j) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m3320getStartimpl(j)), toGlobalIndex(TextRange.m3315getEndimpl(j)));
    }
    ...
    public final long m3217toLocalMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m1447getXimpl(j), Offset.m1448getYimpl(j) - this.top);
    }
    ...
    public String toString() {
        ...
        sb.append(this.top);
        sb.append(", bottom=");
        return androidx.compose.animation.OooO00o.OooO00o(sb, this.bottom, ')');
    }

    @NotNull
    public final Path toGlobal(@NotNull Path path) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        path.mo1584translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }
