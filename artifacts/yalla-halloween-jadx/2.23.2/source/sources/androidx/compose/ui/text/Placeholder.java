...
public final class Placeholder {
    ...
    public static /* synthetic */ Placeholder m3239copyK8Q__8$default(Placeholder placeholder, long j, long j2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            j = placeholder.width;
        }
        long j3 = j;
        ...
        return placeholder.m3240copyK8Q__8(j3, j4, i);
    }

    @NotNull
    /* JADX INFO: renamed from: copy-K8Q-__8, reason: not valid java name */
    public final Placeholder m3240copyK8Q__8(long width, long height, int placeholderVerticalAlign) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return TextUnit.m3953equalsimpl0(this.width, placeholder.width) && TextUnit.m3953equalsimpl0(this.height, placeholder.height) && PlaceholderVerticalAlign.m3247equalsimpl0(this.placeholderVerticalAlign, placeholder.placeholderVerticalAlign);
    }
    ...
    public int hashCode() {
        return PlaceholderVerticalAlign.m3248hashCodeimpl(this.placeholderVerticalAlign) + ((TextUnit.m3957hashCodeimpl(this.height) + (TextUnit.m3957hashCodeimpl(this.width) * 31)) * 31);
    }

    @NotNull
    public String toString() {
        return "Placeholder(width=" + ((Object) TextUnit.m3963toStringimpl(this.width)) + ", height=" + ((Object) TextUnit.m3963toStringimpl(this.height)) + ", placeholderVerticalAlign=" + ((Object) PlaceholderVerticalAlign.m3249toStringimpl(this.placeholderVerticalAlign)) + ')';
    }
    ...
    private Placeholder(long j, long j2, int i) {
        ...
        if (!(!TextUnitKt.m3974isUnspecifiedR2X_6o(j2))) {
