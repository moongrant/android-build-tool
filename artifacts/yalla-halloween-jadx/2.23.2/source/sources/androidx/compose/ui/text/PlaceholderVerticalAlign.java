...
public final class PlaceholderVerticalAlign {
    ...
    private static final int AboveBaseline = m3245constructorimpl(1);
    private static final int Top = m3245constructorimpl(2);
    private static final int Bottom = m3245constructorimpl(3);
    private static final int Center = m3245constructorimpl(4);
    private static final int TextTop = m3245constructorimpl(5);
    private static final int TextBottom = m3245constructorimpl(6);
    private static final int TextCenter = m3245constructorimpl(7);
    ...
    public static final /* synthetic */ PlaceholderVerticalAlign m3244boximpl(int i) {
    ...
    public static String m3249toStringimpl(int i) {
        if (m3247equalsimpl0(i, AboveBaseline)) {
            return "AboveBaseline";
        }
        if (m3247equalsimpl0(i, Top)) {
            return "Top";
        }
        if (m3247equalsimpl0(i, Bottom)) {
            return "Bottom";
        }
        if (m3247equalsimpl0(i, Center)) {
            return "Center";
        }
        if (m3247equalsimpl0(i, TextTop)) {
            return "TextTop";
        }
        if (m3247equalsimpl0(i, TextBottom)) {
            return "TextBottom";
        }
        return m3247equalsimpl0(i, TextCenter) ? "TextCenter" : "Invalid";
    }
