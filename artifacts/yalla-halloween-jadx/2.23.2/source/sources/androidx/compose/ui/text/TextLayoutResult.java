...
public final class TextLayoutResult {
    ...
    public static /* synthetic */ TextLayoutResult m3290copyO0kMr_c$default(TextLayoutResult textLayoutResult, TextLayoutInput textLayoutInput, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textLayoutResult.m3291copyO0kMr_c(textLayoutInput, j);
    }
    ...
    public final TextLayoutResult m3291copyO0kMr_c(@NotNull TextLayoutInput layoutInput, long size) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!Intrinsics.areEqual(this.layoutInput, textLayoutResult.layoutInput) || !Intrinsics.areEqual(this.multiParagraph, textLayoutResult.multiParagraph) || !IntSize.m3933equalsimpl0(this.size, textLayoutResult.size)) {
            return false;
        }
    ...
    public final boolean getDidOverflowHeight() {
        return this.multiParagraph.getDidExceedMaxLines() || ((float) IntSize.m3934getHeightimpl(this.size)) < this.multiParagraph.getHeight();
    }

    public final boolean getDidOverflowWidth() {
        return ((float) IntSize.m3935getWidthimpl(this.size)) < this.multiParagraph.getWidth();
    }
    ...
    public final int m3292getOffsetForPositionk4lQ0M(long position) {
        return this.multiParagraph.m3211getOffsetForPositionk4lQ0M(position);
    }
    ...
    public final long m3294getWordBoundaryjx7JFs(int offset) {
        return this.multiParagraph.m3212getWordBoundaryjx7JFs(offset);
    }

    public int hashCode() {
        return this.placeholderRects.hashCode() + o0OoOo0.OooO00o(this.lastBaseline, o0OoOo0.OooO00o(this.firstBaseline, (IntSize.m3936hashCodeimpl(this.size) + ((this.multiParagraph.hashCode() + (this.layoutInput.hashCode() * 31)) * 31)) * 31, 31), 31);
    }
    ...
    public String toString() {
        return "TextLayoutResult(layoutInput=" + this.layoutInput + ", multiParagraph=" + this.multiParagraph + ", size=" + ((Object) IntSize.m3938toStringimpl(this.size)) + ", firstBaseline=" + this.firstBaseline + ", lastBaseline=" + this.lastBaseline + ", placeholderRects=" + this.placeholderRects + ')';
    }
