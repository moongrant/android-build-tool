...
public final class TextPainterKt {
    private static final void clip(DrawTransform drawTransform, TextLayoutResult textLayoutResult) {
        if (!textLayoutResult.getHasVisualOverflow() || TextOverflow.m3721equalsimpl0(textLayoutResult.getLayoutInput().getOverflow(), TextOverflow.INSTANCE.m3730getVisiblegIe3tQ8())) {
            return;
        }
        OooO0OO.OooO0Oo(drawTransform, 0.0f, 0.0f, IntSize.m3935getWidthimpl(textLayoutResult.getSize()), IntSize.m3934getHeightimpl(textLayoutResult.getSize()), 0, 16, null);
    }

    /* JADX INFO: renamed from: drawText-JFhB2K4, reason: not valid java name */
    public static final void m3299drawTextJFhB2K4(@NotNull DrawScope drawText, @NotNull TextMeasurer textMeasurer, @NotNull AnnotatedString text, long j, @NotNull TextStyle style, int i, boolean z, int i2, @NotNull List<AnnotatedString.Range<Placeholder>> placeholders, long j2, int i3) {
        Intrinsics.checkNotNullParameter(drawText, "$this$drawText");
        Intrinsics.checkNotNullParameter(textMeasurer, "textMeasurer");
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(placeholders, "placeholders");
        TextLayoutResult textLayoutResultM3296measurexDpz5zY$default = TextMeasurer.m3296measurexDpz5zY$default(textMeasurer, text, style, i, z, i2, placeholders, m3307textLayoutConstraintsv_w8tDc(drawText, j2, j), drawText.getLayoutDirection(), drawText, null, false, 1536, null);
        DrawContext drawContext = drawText.getDrawContext();
        long jMo2124getSizeNHjbRc = drawContext.mo2124getSizeNHjbRc();
        drawContext.getCanvas().save();
        DrawTransform transform = drawContext.getTransform();
        transform.translate(Offset.m1447getXimpl(j), Offset.m1448getYimpl(j));
        clip(transform, textLayoutResultM3296measurexDpz5zY$default);
        textLayoutResultM3296measurexDpz5zY$default.getMultiParagraph().m3213paintLG529CI(drawText.getDrawContext().getCanvas(), (32 & 2) != 0 ? Color.INSTANCE.m1717getUnspecified0d7_KjU() : 0L, (32 & 4) != 0 ? null : null, (32 & 8) != 0 ? null : null, (32 & 16) == 0 ? null : null, (32 & 32) != 0 ? DrawScope.INSTANCE.m2148getDefaultBlendMode0nO6VwU() : i3);
    ...
    public static final void m3301drawTextLVfH_YU(@NotNull DrawScope drawText, @NotNull TextLayoutResult textLayoutResult, @NotNull Brush brush, long j, float f, @Nullable Shadow shadow, @Nullable TextDecoration textDecoration, @Nullable DrawStyle drawStyle, int i) {
        Intrinsics.checkNotNullParameter(drawText, "$this$drawText");
        ...
        textLayoutResult.getMultiParagraph().m3215painthn5TExg(drawText.getDrawContext().getCanvas(), brush, !Float.isNaN(f) ? f : textLayoutResult.getLayoutInput().getStyle().getAlpha(), shadow2, textDecoration2, drawStyle2, i);
        drawContext.getCanvas().restore();
        drawContext.mo2125setSizeuvyYCjk(jMo2124getSizeNHjbRc);
    }

    /* JADX INFO: renamed from: drawText-TPWCCtM, reason: not valid java name */
    public static final void m3303drawTextTPWCCtM(@NotNull DrawScope drawText, @NotNull TextMeasurer textMeasurer, @NotNull String text, long j, @NotNull TextStyle style, int i, boolean z, int i2, long j2, int i3) {
        Intrinsics.checkNotNullParameter(drawText, "$this$drawText");
        Intrinsics.checkNotNullParameter(textMeasurer, "textMeasurer");
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        TextLayoutResult textLayoutResultM3296measurexDpz5zY$default = TextMeasurer.m3296measurexDpz5zY$default(textMeasurer, new AnnotatedString(text, null, null, 6, null), style, i, z, i2, null, m3307textLayoutConstraintsv_w8tDc(drawText, j2, j), drawText.getLayoutDirection(), drawText, null, false, 1568, null);
        DrawContext drawContext = drawText.getDrawContext();
        long jMo2124getSizeNHjbRc = drawContext.mo2124getSizeNHjbRc();
        drawContext.getCanvas().save();
        DrawTransform transform = drawContext.getTransform();
    ...
    public static final void m3305drawTextd8rzKo(@NotNull DrawScope drawText, @NotNull TextLayoutResult textLayoutResult, long j, long j2, float f, @Nullable Shadow shadow, @Nullable TextDecoration textDecoration, @Nullable DrawStyle drawStyle, int i) {
        long jM3341getColor0d7_KjU;
        Intrinsics.checkNotNullParameter(drawText, "$this$drawText");
        Intrinsics.checkNotNullParameter(textLayoutResult, "textLayoutResult");
        Shadow shadow2 = shadow == null ? textLayoutResult.getLayoutInput().getStyle().getShadow() : shadow;
        TextDecoration textDecoration2 = textDecoration == null ? textLayoutResult.getLayoutInput().getStyle().getTextDecoration() : textDecoration;
        ...
        drawContext.getCanvas().save();
        DrawTransform transform = drawContext.getTransform();
        transform.translate(Offset.m1447getXimpl(j2), Offset.m1448getYimpl(j2));
        clip(transform, textLayoutResult);
        ...
        if (brush == null) {
            ...
            if (j != Color.INSTANCE.m1717getUnspecified0d7_KjU()) {
                jM3341getColor0d7_KjU = j;
            } else {
                jM3341getColor0d7_KjU = textLayoutResult.getLayoutInput().getStyle().m3341getColor0d7_KjU();
            }
            multiParagraph.m3213paintLG529CI(canvas, TextDrawStyleKt.m3699modulateDxMtmZc(jM3341getColor0d7_KjU, f), shadow2, textDecoration2, drawStyle2, i);
        } else {
            if (j == Color.INSTANCE.m1717getUnspecified0d7_KjU()) {
                textLayoutResult.getMultiParagraph().m3215painthn5TExg(drawText.getDrawContext().getCanvas(), brush, !Float.isNaN(f) ? f : textLayoutResult.getLayoutInput().getStyle().getAlpha(), shadow2, textDecoration2, drawStyle2, i);
            } else {
                ...
                multiParagraph2.m3213paintLG529CI(canvas2, TextDrawStyleKt.m3699modulateDxMtmZc(jM3341getColor0d7_KjU, f), shadow2, textDecoration2, drawStyle2, i);
            }
        }
        drawContext.getCanvas().restore();
        drawContext.mo2125setSizeuvyYCjk(jMo2124getSizeNHjbRc);
    ...
    private static final long m3307textLayoutConstraintsv_w8tDc(DrawScope drawScope, long j, long j2) {
        int iRoundToInt;
        int iRoundToInt2;
        int iRoundToInt3;
        ...
        boolean z = true;
        int iRoundToInt4 = 0;
        if (((j > companion.m1524getUnspecifiedNHjbRc() ? 1 : (j == companion.m1524getUnspecifiedNHjbRc() ? 0 : -1)) == 0) || Float.isNaN(Size.m1516getWidthimpl(j))) {
            iRoundToInt2 = MathKt.roundToInt((float) Math.ceil(Size.m1516getWidthimpl(drawScope.mo2118getSizeNHjbRc()) - Offset.m1447getXimpl(j2)));
            iRoundToInt = 0;
        } else {
            iRoundToInt = MathKt.roundToInt((float) Math.ceil(Size.m1516getWidthimpl(j)));
            iRoundToInt2 = iRoundToInt;
        }
        if (!(j == companion.m1524getUnspecifiedNHjbRc()) && !Float.isNaN(Size.m1513getHeightimpl(j))) {
            z = false;
        }
        if (z) {
            iRoundToInt3 = MathKt.roundToInt((float) Math.ceil(Size.m1513getHeightimpl(drawScope.mo2118getSizeNHjbRc()) - Offset.m1448getYimpl(j2)));
        } else {
            iRoundToInt4 = MathKt.roundToInt((float) Math.ceil(Size.m1513getHeightimpl(j)));
