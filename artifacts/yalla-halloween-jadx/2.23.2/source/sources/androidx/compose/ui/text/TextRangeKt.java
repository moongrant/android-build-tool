...
public final class TextRangeKt {
    public static final long TextRange(int i, int i2) {
        return TextRange.m3309constructorimpl(packWithCheck(i, i2));
    }

    /* JADX INFO: renamed from: coerceIn-8ffj60Q, reason: not valid java name */
    public static final long m3326coerceIn8ffj60Q(long j, int i, int i2) {
        int iCoerceIn = RangesKt.coerceIn(TextRange.m3320getStartimpl(j), i, i2);
        int iCoerceIn2 = RangesKt.coerceIn(TextRange.m3315getEndimpl(j), i, i2);
        return (iCoerceIn == TextRange.m3320getStartimpl(j) && iCoerceIn2 == TextRange.m3315getEndimpl(j)) ? j : TextRange(iCoerceIn, iCoerceIn2);
    }
    ...
    public static final String m3327substringFDrldGo(@NotNull CharSequence substring, long j) {
        Intrinsics.checkNotNullParameter(substring, "$this$substring");
        return substring.subSequence(TextRange.m3318getMinimpl(j), TextRange.m3317getMaximpl(j)).toString();
    }
