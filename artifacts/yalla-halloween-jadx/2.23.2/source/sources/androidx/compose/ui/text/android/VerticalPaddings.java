...
public final class VerticalPaddings {
    ...
    public static final /* synthetic */ VerticalPaddings m3353boximpl(long j) {
        return new VerticalPaddings(j);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m3354constructorimpl(long j) {
        return j;
    }
    ...
    public static final int m3357getBottomPaddingimpl(long j) {
        return (int) (j & 4294967295L);
    }

    /* JADX INFO: renamed from: getTopPadding-impl, reason: not valid java name */
    public static final int m3358getTopPaddingimpl(long j) {
        return (int) (j >> 32);
    }
