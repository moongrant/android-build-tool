...
public final class WordIterator {
    ...
    private final void checkOffsetIsValid(int offset) {
        ...
        StringBuilder sbOooO0O0 = o0000O0.OooO0O0("Invalid offset: ", offset, ". Valid range is [");
        sbOooO0O0.append(this.start);
        sbOooO0O0.append(" , ");
        throw new IllegalArgumentException(OooO0O0.OooO00o(sbOooO0O0, this.end, ']').toString());
    }
