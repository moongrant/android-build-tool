    ...
    public android.graphics.Typeface loadBlocking(@NotNull Font font) {
        ...
        if (FontLoadingStrategy.m3403equalsimpl0(loadingStrategy, companion.m3408getBlockingPKNRLFQ())) {
            ...
            if (!FontLoadingStrategy.m3403equalsimpl0(loadingStrategy, companion.m3409getOptionalLocalPKNRLFQ())) {
                ...
                throw new IllegalArgumentException("Unknown loading type " + ((Object) FontLoadingStrategy.m3405toStringimpl(font.getLoadingStrategy())));
            }
            try {
                Result.Companion companion2 = Result.INSTANCE;
                Context context3 = this.context;
                Intrinsics.checkNotNullExpressionValue(context3, "context");
                objM4215constructorimpl = Result.m4215constructorimpl(AndroidFontLoader_androidKt.load((ResourceFont) font, context3));
            } catch (Throwable th) {
                Result.Companion companion3 = Result.INSTANCE;
                objM4215constructorimpl = Result.m4215constructorimpl(ResultKt.createFailure(th));
            }
            typefaceLoad = (android.graphics.Typeface) (Result.m4221isFailureimpl(objM4215constructorimpl) ? null : objM4215constructorimpl);
        }
        FontVariation.Settings variationSettings = ((ResourceFont) font).getVariationSettings();
