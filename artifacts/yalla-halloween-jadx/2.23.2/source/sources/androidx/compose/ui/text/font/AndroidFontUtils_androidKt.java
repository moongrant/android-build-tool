...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m3371getAndroidTypefaceStyleFO1MlWM(@NotNull FontWeight fontWeight, int i) {
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0, FontStyle.m3416equalsimpl0(i, FontStyle.INSTANCE.m3420getItalic_LCdwA()));
    }
}
