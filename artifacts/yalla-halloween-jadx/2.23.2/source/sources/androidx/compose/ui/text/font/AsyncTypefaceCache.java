...
public final class AsyncTypefaceCache {
    ...
    @NotNull
    private final Object PermanentFailure = AsyncTypefaceResult.m3375constructorimpl(null);
    ...
    public static final class AsyncTypefaceResult {
        ...
        public static final /* synthetic */ AsyncTypefaceResult m3374boximpl(Object obj) {
            return new AsyncTypefaceResult(obj);
        }

        @NotNull
        /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
        public static Object m3375constructorimpl(@Nullable Object obj) {
            return obj;
        }

        /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
        public static boolean m3376equalsimpl(Object obj, Object obj2) {
            return (obj2 instanceof AsyncTypefaceResult) && Intrinsics.areEqual(obj, ((AsyncTypefaceResult) obj2).m3381unboximpl());
        }

        /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m3377equalsimpl0(Object obj, Object obj2) {
            return Intrinsics.areEqual(obj, obj2);
        }

        /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
        public static int m3378hashCodeimpl(Object obj) {
            if (obj == null) {
                return 0;
            }
            return obj.hashCode();
        ...
        public static final boolean m3379isPermanentFailureimpl(Object obj) {
            return obj == null;
        }

        /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
        public static String m3380toStringimpl(Object obj) {
            return "AsyncTypefaceResult(result=" + obj + ')';
        }

        public boolean equals(Object obj) {
            return m3376equalsimpl(this.result, obj);
        }
        ...
        public int hashCode() {
            return m3378hashCodeimpl(this.result);
        }

        public String toString() {
            return m3380toStringimpl(this.result);
        }

        /* JADX INFO: renamed from: unbox-impl, reason: not valid java name */
        public final /* synthetic */ Object m3381unboximpl() {
            return this.result;
        }
    }
    ...
    public static final /* data */ class Key {
        ...
        public String toString() {
            ...
            sb.append(this.font);
            sb.append(", loaderKey=");
            return androidx.compose.runtime.OooOOO0.OooO00o(sb, this.loaderKey, ')');
        }
    }
    ...
    public final AsyncTypefaceResult m3373get1ASDuI8(@NotNull Font font, @NotNull PlatformFontLoader platformFontLoader) {
    ...
    public final void put(@NotNull Font font, @NotNull PlatformFontLoader platformFontLoader, @Nullable Object result, boolean forever) {
        ...
        synchronized (this.cacheLock) {
            try {
                if (result == null) {
                    this.permanentCache.put(key, AsyncTypefaceResult.m3374boximpl(this.PermanentFailure));
                } else if (forever) {
                    this.permanentCache.put(key, AsyncTypefaceResult.m3374boximpl(AsyncTypefaceResult.m3375constructorimpl(result)));
                } else {
                    this.resultCache.put(key, AsyncTypefaceResult.m3374boximpl(AsyncTypefaceResult.m3375constructorimpl(result)));
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public final Object runCached(@NotNull Font font, @NotNull PlatformFontLoader platformFontLoader, boolean z, @NotNull Function1<? super Continuation<Object>, ? extends Object> function1, @NotNull Continuation<Object> continuation) {
        ...
        if (i2 == 0) {
            ...
            synchronized (this.cacheLock) {
                ...
                if (asyncTypefaceResult != null) {
                    return asyncTypefaceResult.m3381unboximpl();
                }
        ...
        synchronized (asyncTypefaceCache.cacheLock) {
            try {
                if (obj == null) {
                    asyncTypefaceCache.permanentCache.put(key, AsyncTypefaceResult.m3374boximpl(asyncTypefaceCache.PermanentFailure));
                } else if (z) {
                    asyncTypefaceCache.permanentCache.put(key, AsyncTypefaceResult.m3374boximpl(AsyncTypefaceResult.m3375constructorimpl(obj)));
                } else {
                    asyncTypefaceCache.resultCache.put(key, AsyncTypefaceResult.m3374boximpl(AsyncTypefaceResult.m3375constructorimpl(obj)));
                }
    ...
    public final Object runCachedBlocking(@NotNull Font font, @NotNull PlatformFontLoader platformFontLoader, @NotNull Function0<? extends Object> block) {
        ...
        synchronized (this.cacheLock) {
            try {
                ...
                if (asyncTypefaceResult != null) {
                    Object objM3381unboximpl = asyncTypefaceResult.m3381unboximpl();
                    InlineMarker.finallyStart(2);
                    InlineMarker.finallyEnd(2);
                    return objM3381unboximpl;
                }
                Unit unit = Unit.INSTANCE;
