...
public final class FontListFontFamilyTypefaceAdapter$preload$3$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Object>, Object> {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function1<Continuation<? super Object>, Object> {
        ...
        public static final class C01131 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Object>, Object> {
            final /* synthetic */ Font $font;
            final /* synthetic */ PlatformFontLoader $resourceLoader;
            int label;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C01131(PlatformFontLoader platformFontLoader, Font font, Continuation<? super C01131> continuation) {
            ...
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                return new C01131(this.$resourceLoader, this.$font, continuation);
            }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            try {
                if (i == 0) {
                    ResultKt.throwOnFailure(obj);
                    C01131 c01131 = new C01131(this.$resourceLoader, this.$font, null);
                    this.label = 1;
                    obj = TimeoutKt.withTimeout(15000L, c01131, this);
                    if (obj == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
