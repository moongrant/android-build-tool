...
public final class FontLoadingStrategy {
    ...
    private static final int Blocking = m3401constructorimpl(0);
    private static final int OptionalLocal = m3401constructorimpl(1);
    private static final int Async = m3401constructorimpl(2);
    ...
    public static final /* synthetic */ FontLoadingStrategy m3400boximpl(int i) {
        return new FontLoadingStrategy(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m3401constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m3402equalsimpl(int i, Object obj) {
        return (obj instanceof FontLoadingStrategy) && i == ((FontLoadingStrategy) obj).m3406unboximpl();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3403equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m3404hashCodeimpl(int i) {
        return i;
    }

    @NotNull
    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m3405toStringimpl(int i) {
        if (m3403equalsimpl0(i, Blocking)) {
            return "Blocking";
        }
        if (m3403equalsimpl0(i, OptionalLocal)) {
            return "Optional";
        }
        return m3403equalsimpl0(i, Async) ? "Async" : androidx.compose.animation.core.OooO0OO.OooO00o("Invalid(value=", i, ')');
    }
