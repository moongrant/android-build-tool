...
public final class FontSynthesis_androidKt {
    ...
    public static final Object m3435synthesizeTypefaceFxwP2eA(int i, @NotNull Object typeface, @NotNull Font font, @NotNull FontWeight requestedWeight, int i2) {
        boolean z;
        ...
        if (!FontSynthesis.m3428isWeightOnimpl$ui_text_release(i) || Intrinsics.areEqual(font.getWeight(), requestedWeight)) {
            z = false;
        } else {
        ...
        boolean z2 = FontSynthesis.m3427isStyleOnimpl$ui_text_release(i) && !FontStyle.m3416equalsimpl0(i2, font.getStyle());
        if (!z2 && !z) {
            return typeface;
        }
        if (Build.VERSION.SDK_INT < 28) {
            typefaceCreate = android.graphics.Typeface.create((android.graphics.Typeface) typeface, AndroidFontUtils_androidKt.getAndroidTypefaceStyle(z, z2 && FontStyle.m3416equalsimpl0(i2, FontStyle.INSTANCE.m3420getItalic_LCdwA())));
        } else {
            typefaceCreate = TypefaceHelperMethodsApi28.INSTANCE.create((android.graphics.Typeface) typeface, z ? requestedWeight.getWeight() : font.getWeight().getWeight(), z2 ? FontStyle.m3416equalsimpl0(i2, FontStyle.INSTANCE.m3420getItalic_LCdwA()) : FontStyle.m3416equalsimpl0(font.getStyle(), FontStyle.INSTANCE.m3420getItalic_LCdwA()));
        }
