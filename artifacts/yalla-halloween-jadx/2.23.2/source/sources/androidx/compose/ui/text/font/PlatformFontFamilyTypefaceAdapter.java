...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(@NotNull TypefaceRequest typefaceRequest, @NotNull PlatformFontLoader platformFontLoader, @NotNull Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, @NotNull Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        android.graphics.Typeface typefaceMo3540getNativeTypefacePYhJU0U;
        ...
        if (fontFamily == null ? true : fontFamily instanceof DefaultFontFamily) {
            typefaceMo3540getNativeTypefacePYhJU0U = this.platformTypefaceResolver.mo3439createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m3457getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            typefaceMo3540getNativeTypefacePYhJU0U = this.platformTypefaceResolver.mo3440createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m3457getFontStyle_LCdwA());
        } else {
            ...
            typefaceMo3540getNativeTypefacePYhJU0U = ((AndroidTypeface) typeface).mo3540getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m3457getFontStyle_LCdwA(), typefaceRequest.m3458getFontSynthesisGVVA2EU());
        }
        return new TypefaceResult.Immutable(typefaceMo3540getNativeTypefacePYhJU0U, false, 2, null);
    }
}
