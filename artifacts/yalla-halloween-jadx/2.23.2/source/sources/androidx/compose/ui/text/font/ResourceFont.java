...
public final class ResourceFont implements Font {
    ...
    public static /* synthetic */ ResourceFont m3448copyF3nL8kk$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings, int i4, Object obj) {
        if ((i4 & 1) != 0) {
        ...
        return resourceFont.m3451copyF3nL8kk(i, fontWeight2, i5, i6, settings);
    }

    /* JADX INFO: renamed from: copy-RetOiIg$default, reason: not valid java name */
    public static /* synthetic */ ResourceFont m3449copyRetOiIg$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            i = resourceFont.resId;
        }
        if ((i3 & 2) != 0) {
        ...
        return resourceFont.m3452copyRetOiIg(i, fontWeight, i2);
    }
    ...
    public final ResourceFont m3451copyF3nL8kk(int resId, @NotNull FontWeight weight, int style, int loadingStrategy, @NotNull FontVariation.Settings variationSettings) {
    ...
    public final ResourceFont m3452copyRetOiIg(int resId, @NotNull FontWeight weight, int style) {
        Intrinsics.checkNotNullParameter(weight, "weight");
        return m3448copyF3nL8kk$default(this, resId, weight, style, getLoadingStrategy(), null, 16, null);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return this.resId == resourceFont.resId && Intrinsics.areEqual(getWeight(), resourceFont.getWeight()) && FontStyle.m3416equalsimpl0(getStyle(), resourceFont.getStyle()) && Intrinsics.areEqual(this.variationSettings, resourceFont.variationSettings) && FontLoadingStrategy.m3403equalsimpl0(getLoadingStrategy(), resourceFont.getLoadingStrategy());
    }
    ...
    public int hashCode() {
        return this.variationSettings.hashCode() + ((FontLoadingStrategy.m3404hashCodeimpl(getLoadingStrategy()) + ((FontStyle.m3417hashCodeimpl(getStyle()) + ((getWeight().hashCode() + (this.resId * 31)) * 31)) * 31)) * 31);
    }

    @NotNull
    public String toString() {
        return "ResourceFont(resId=" + this.resId + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m3418toStringimpl(getStyle())) + ", loadingStrategy=" + ((Object) FontLoadingStrategy.m3405toStringimpl(getLoadingStrategy())) + ')';
    }
    ...
    public /* synthetic */ ResourceFont(int i, FontWeight fontWeight, int i2, FontVariation.Settings settings, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        int iM3421getNormal_LCdwA = (i4 & 4) != 0 ? FontStyle.INSTANCE.m3421getNormal_LCdwA() : i2;
        this(i, normal, iM3421getNormal_LCdwA, (i4 & 8) != 0 ? FontVariation.INSTANCE.m3436Settings6EWAqTQ(normal, iM3421getNormal_LCdwA, new FontVariation.Setting[0]) : settings, (i4 & 16) != 0 ? FontLoadingStrategy.INSTANCE.m3407getAsyncPKNRLFQ() : i3, null);
    }
}
