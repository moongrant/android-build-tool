...
public final /* data */ class TypefaceRequest {
    ...
    public static /* synthetic */ TypefaceRequest m3453copye1PVR60$default(TypefaceRequest typefaceRequest, FontFamily fontFamily, FontWeight fontWeight, int i, int i2, Object obj, int i3, Object obj2) {
        if ((i3 & 1) != 0) {
        ...
        return typefaceRequest.m3456copye1PVR60(fontFamily, fontWeight2, i4, i5, obj);
    }
    ...
    public final TypefaceRequest m3456copye1PVR60(@Nullable FontFamily fontFamily, @NotNull FontWeight fontWeight, int fontStyle, int fontSynthesis, @Nullable Object resourceLoaderCacheKey) {
    ...
    public final int m3457getFontStyle_LCdwA() {
        return this.fontStyle;
    }

    /* JADX INFO: renamed from: getFontSynthesis-GVVA2EU, reason: not valid java name */
    public final int m3458getFontSynthesisGVVA2EU() {
        return this.fontSynthesis;
    }
    ...
    public int hashCode() {
        ...
        int iM3426hashCodeimpl = (FontSynthesis.m3426hashCodeimpl(this.fontSynthesis) + ((FontStyle.m3417hashCodeimpl(this.fontStyle) + ((this.fontWeight.hashCode() + ((fontFamily == null ? 0 : fontFamily.hashCode()) * 31)) * 31)) * 31)) * 31;
        Object obj = this.resourceLoaderCacheKey;
        return iM3426hashCodeimpl + (obj != null ? obj.hashCode() : 0);
    }
    ...
    public String toString() {
        ...
        sb.append(", fontStyle=");
        sb.append((Object) FontStyle.m3418toStringimpl(this.fontStyle));
        sb.append(", fontSynthesis=");
        sb.append((Object) FontSynthesis.m3429toStringimpl(this.fontSynthesis));
        sb.append(", resourceLoaderCacheKey=");
        return androidx.compose.runtime.OooOOO0.OooO00o(sb, this.resourceLoaderCacheKey, ')');
    }
