...
public final class EditingBuffer {
    ...
    private final void setSelectionEnd(int i) {
        if (!(i >= 0)) {
            throw new IllegalArgumentException(android.support.v4.media.OooO00o.OooO00o("Cannot set selectionEnd to a negative value: ", i).toString());
        }
        this.selectionEnd = i;
    }
    ...
    private final void setSelectionStart(int i) {
        if (!(i >= 0)) {
            throw new IllegalArgumentException(android.support.v4.media.OooO00o.OooO00o("Cannot set selectionStart to a negative value: ", i).toString());
        }
    ...
    public final void delete$ui_text_release(int start, int end) {
        ...
        long jM3461updateRangeAfterDeletepWDy79M = EditingBufferKt.m3461updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.selectionStart, this.selectionEnd), jTextRange);
        setSelectionStart(TextRange.m3318getMinimpl(jM3461updateRangeAfterDeletepWDy79M));
        setSelectionEnd(TextRange.m3317getMaximpl(jM3461updateRangeAfterDeletepWDy79M));
        if (hasComposition$ui_text_release()) {
            long jM3461updateRangeAfterDeletepWDy79M2 = EditingBufferKt.m3461updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd), jTextRange);
            if (TextRange.m3314getCollapsedimpl(jM3461updateRangeAfterDeletepWDy79M2)) {
                commitComposition$ui_text_release();
            } else {
                this.compositionStart = TextRange.m3318getMinimpl(jM3461updateRangeAfterDeletepWDy79M2);
                this.compositionEnd = TextRange.m3317getMaximpl(jM3461updateRangeAfterDeletepWDy79M2);
            }
        }
    }
    ...
    public final TextRange m3459getCompositionMzsxiRA$ui_text_release() {
        if (hasComposition$ui_text_release()) {
            return TextRange.m3308boximpl(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd));
        }
        return null;
    }
    ...
    public final void setComposition$ui_text_release(int start, int end) {
        if (start < 0 || start > this.gapBuffer.getLength()) {
            StringBuilder sbOooO0O0 = o0000O0.OooO0O0("start (", start, ") offset is outside of text region ");
            sbOooO0O0.append(this.gapBuffer.getLength());
            throw new IndexOutOfBoundsException(sbOooO0O0.toString());
        }
        if (end < 0 || end > this.gapBuffer.getLength()) {
            StringBuilder sbOooO0O1 = o0000O0.OooO0O0("end (", end, ") offset is outside of text region ");
            sbOooO0O1.append(this.gapBuffer.getLength());
            throw new IndexOutOfBoundsException(sbOooO0O1.toString());
        }
        if (start >= end) {
            throw new IllegalArgumentException(androidx.compose.compiler.plugins.kotlin.lower.OooO0O0.OooO0O0("Do not set reversed or empty range: ", start, " > ", end));
        }
    ...
    public final void setSelection$ui_text_release(int start, int end) {
        ...
        if (start > end) {
            throw new IllegalArgumentException(androidx.compose.compiler.plugins.kotlin.lower.OooO0O0.OooO0O0("Do not set reversed range: ", start, " > ", end));
        }
    ...
    private EditingBuffer(AnnotatedString text, long j) {
        ...
        this.selectionStart = TextRange.m3318getMinimpl(j);
        this.selectionEnd = TextRange.m3317getMaximpl(j);
        this.compositionStart = -1;
        this.compositionEnd = -1;
        int iM3318getMinimpl = TextRange.m3318getMinimpl(j);
        int iM3317getMaximpl = TextRange.m3317getMaximpl(j);
        if (iM3318getMinimpl >= 0 && iM3318getMinimpl <= text.length()) {
            if (iM3317getMaximpl < 0 || iM3317getMaximpl > text.length()) {
                StringBuilder sbOooO0O0 = o0000O0.OooO0O0("end (", iM3317getMaximpl, ") offset is outside of text region ");
                sbOooO0O0.append(text.length());
                throw new IndexOutOfBoundsException(sbOooO0O0.toString());
            }
            if (iM3318getMinimpl > iM3317getMaximpl) {
                throw new IllegalArgumentException(androidx.compose.compiler.plugins.kotlin.lower.OooO0O0.OooO0O0("Do not set reversed range: ", iM3318getMinimpl, " > ", iM3317getMaximpl));
            }
            return;
        }
        StringBuilder sbOooO0O1 = o0000O0.OooO0O0("start (", iM3318getMinimpl, ") offset is outside of text region ");
        sbOooO0O1.append(text.length());
        throw new IndexOutOfBoundsException(sbOooO0O1.toString());
    }
