...
public final class ImeAction {
    ...
    private static final int Default = m3463constructorimpl(1);
    private static final int None = m3463constructorimpl(0);
    private static final int Go = m3463constructorimpl(2);
    private static final int Search = m3463constructorimpl(3);
    private static final int Send = m3463constructorimpl(4);
    private static final int Previous = m3463constructorimpl(5);
    private static final int Next = m3463constructorimpl(6);
    private static final int Done = m3463constructorimpl(7);
    ...
    public static final /* synthetic */ ImeAction m3462boximpl(int i) {
        return new ImeAction(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m3463constructorimpl(int i) {
        return i;
    }
    ...
    public static String m3467toStringimpl(int i) {
        if (m3465equalsimpl0(i, None)) {
            return "None";
        }
        if (m3465equalsimpl0(i, Default)) {
            return "Default";
        }
        if (m3465equalsimpl0(i, Go)) {
            return "Go";
        }
        if (m3465equalsimpl0(i, Search)) {
            return "Search";
        }
        if (m3465equalsimpl0(i, Send)) {
            return "Send";
        }
        if (m3465equalsimpl0(i, Previous)) {
            return "Previous";
        }
        if (m3465equalsimpl0(i, Next)) {
            return "Next";
        }
        return m3465equalsimpl0(i, Done) ? "Done" : "Invalid";
    }
