...
public final class AndroidGenericFontFamilyTypeface implements AndroidTypeface {
    ...
    private final Typeface m3541buildStyledTypefaceFO1MlWM(FontWeight fontWeight, int fontStyle) {
        return Build.VERSION.SDK_INT < 28 ? Typeface.create(this.nativeTypeface, AndroidFontUtils_androidKt.m3371getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle)) : TypefaceHelperMethodsApi28.INSTANCE.create(this.nativeTypeface, fontWeight.getWeight(), FontStyle.m3416equalsimpl0(fontStyle, FontStyle.INSTANCE.m3420getItalic_LCdwA()));
    }
    ...
    public Typeface mo3540getNativeTypefacePYhJU0U(@NotNull FontWeight fontWeight, int fontStyle, int synthesis) {
        ...
        Typeface typefaceM3541buildStyledTypefaceFO1MlWM = m3541buildStyledTypefaceFO1MlWM(fontWeight, fontStyle);
        Intrinsics.checkNotNullExpressionValue(typefaceM3541buildStyledTypefaceFO1MlWM, "buildStyledTypeface(fontWeight, fontStyle)");
        return typefaceM3541buildStyledTypefaceFO1MlWM;
    }
}
