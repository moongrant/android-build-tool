...
public final class AndroidParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    /* JADX WARN: Type inference failed for: r12v0, types: [java.lang.Object, java.util.Collection, java.util.List, java.util.List<androidx.compose.ui.text.AnnotatedString$Range<androidx.compose.ui.text.SpanStyle>>] */
    ...
    public AndroidParagraphIntrinsics(@NotNull String text, @NotNull TextStyle style, @NotNull List<AnnotatedString.Range<SpanStyle>> spanStyles, @NotNull List<AnnotatedString.Range<Placeholder>> placeholders, @NotNull FontFamily.Resolver fontFamilyResolver, @NotNull Density density) {
        ...
        this.textDirectionHeuristic = AndroidParagraphIntrinsics_androidKt.m3546resolveTextDirectionHeuristics9GRLPo0(style.m3350getTextDirectionmmuk1to(), style.getLocaleList());
        Function4<FontFamily, FontWeight, FontStyle, FontSynthesis, Typeface> function4 = new Function4<FontFamily, FontWeight, FontStyle, FontSynthesis, Typeface>() { // from class: androidx.compose.ui.text.platform.AndroidParagraphIntrinsics$resolveTypeface$1
            ...
            public /* bridge */ /* synthetic */ Typeface invoke(FontFamily fontFamily, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis) {
                return m3545invokeDPcqOEQ(fontFamily, fontWeight, fontStyle.m3419unboximpl(), fontSynthesis.getValue());
            }

            @NotNull
            /* JADX INFO: renamed from: invoke-DPcqOEQ, reason: not valid java name */
            public final Typeface m3545invokeDPcqOEQ(@Nullable FontFamily fontFamily, @NotNull FontWeight fontWeight, int i, int i2) {
                Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
                State<Object> stateMo3391resolveDPcqOEQ = this.this$0.getFontFamilyResolver().mo3391resolveDPcqOEQ(fontFamily, fontWeight, i, i2);
                if (stateMo3391resolveDPcqOEQ instanceof TypefaceResult.Immutable) {
                    Object value = stateMo3391resolveDPcqOEQ.getValue();
                    Intrinsics.checkNotNull(value, "null cannot be cast to non-null type android.graphics.Typeface");
                    return (Typeface) value;
                }
                TypefaceDirtyTrackerLinkedList typefaceDirtyTrackerLinkedList = new TypefaceDirtyTrackerLinkedList(stateMo3391resolveDPcqOEQ, this.this$0.resolvedTypefaces);
        ...
        if (spanStyleApplySpanStyle != null) {
            ...
            int i = 0;
            while (i < size) {
                spanStyles.add(i == 0 ? new AnnotatedString.Range<>(spanStyleApplySpanStyle, 0, this.text.length()) : this.spanStyles.get(i - 1));
                i++;
            }
        }
