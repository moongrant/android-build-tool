...
public final class PlaceholderExtensions_androidKt {
    ...
    private static final int m3557getSpanUnitR2X_6o(long j) {
        ...
        return TextUnitType.m3984equalsimpl0(jM3955getTypeUIouoOA, companion.m3988getEmUIouoOA()) ? 1 : 2;
    }

    /* JADX INFO: renamed from: getSpanUnit--R2X_6o$annotations, reason: not valid java name */
    private static /* synthetic */ void m3558getSpanUnitR2X_6o$annotations(long j) {
    }

    /* JADX INFO: renamed from: getSpanVerticalAlign-do9X-Gg, reason: not valid java name */
    private static final int m3559getSpanVerticalAligndo9XGg(int i) {
        PlaceholderVerticalAlign.Companion companion = PlaceholderVerticalAlign.INSTANCE;
        if (PlaceholderVerticalAlign.m3247equalsimpl0(i, companion.m3251getAboveBaselineJ6kI3mc())) {
            return 0;
        }
        if (PlaceholderVerticalAlign.m3247equalsimpl0(i, companion.m3257getTopJ6kI3mc())) {
            return 1;
        }
        if (PlaceholderVerticalAlign.m3247equalsimpl0(i, companion.m3252getBottomJ6kI3mc())) {
            return 2;
        }
        if (PlaceholderVerticalAlign.m3247equalsimpl0(i, companion.m3253getCenterJ6kI3mc())) {
            return 3;
        }
        if (PlaceholderVerticalAlign.m3247equalsimpl0(i, companion.m3256getTextTopJ6kI3mc())) {
            return 4;
        }
        if (PlaceholderVerticalAlign.m3247equalsimpl0(i, companion.m3254getTextBottomJ6kI3mc())) {
            return 5;
        }
        if (PlaceholderVerticalAlign.m3247equalsimpl0(i, companion.m3255getTextCenterJ6kI3mc())) {
            return 6;
        }
    ...
    private static /* synthetic */ void m3560getSpanVerticalAligndo9XGg$annotations(int i) {
    }
    ...
    private static final void setPlaceholder(Spannable spannable, Placeholder placeholder, int i, int i2, Density density) {
        ...
        SpannableExtensions_androidKt.setSpan(spannable, new PlaceholderSpan(TextUnit.m3956getValueimpl(placeholder.getWidth()), m3557getSpanUnitR2X_6o(placeholder.getWidth()), TextUnit.m3956getValueimpl(placeholder.getHeight()), m3557getSpanUnitR2X_6o(placeholder.getHeight()), density.getDensity() * density.getFontScale(), m3559getSpanVerticalAligndo9XGg(placeholder.getPlaceholderVerticalAlign())), i, i2);
    }
