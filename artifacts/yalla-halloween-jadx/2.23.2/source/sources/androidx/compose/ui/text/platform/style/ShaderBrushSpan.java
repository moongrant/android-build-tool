...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public ShaderBrushSpan(@NotNull ShaderBrush shaderBrush, float f) {
        ...
        this.alpha = f;
        this.size = Size.INSTANCE.m1524getUnspecifiedNHjbRc();
    }
    ...
    public final void m3573setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public void updateDrawState(@NotNull TextPaint textPaint) {
        ...
        if (this.size == Size.INSTANCE.m1524getUnspecifiedNHjbRc()) {
            return;
        }
        Pair<Size, ? extends Shader> pair = this.cachedShader;
        Shader shaderMo1656createShaderuvyYCjk = (pair == null || !Size.m1512equalsimpl0(pair.getFirst().getPackedValue(), this.size)) ? this.shaderBrush.mo1656createShaderuvyYCjk(this.size) : pair.getSecond();
        textPaint.setShader(shaderMo1656createShaderuvyYCjk);
        this.cachedShader = TuplesKt.to(Size.m1504boximpl(this.size), shaderMo1656createShaderuvyYCjk);
    }
}
