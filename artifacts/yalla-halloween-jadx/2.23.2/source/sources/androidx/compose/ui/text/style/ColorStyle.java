...
final /* data */ class ColorStyle implements TextForegroundStyle {
    ...
    public static /* synthetic */ ColorStyle m3589copy8_81llA$default(ColorStyle colorStyle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = colorStyle.value;
        }
        return colorStyle.m3591copy8_81llA(j);
    }
    ...
    public final ColorStyle m3591copy8_81llA(long value) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return (other instanceof ColorStyle) && Color.m1682equalsimpl0(this.value, ((ColorStyle) other).value);
    }

    @Override // androidx.compose.ui.text.style.TextForegroundStyle
    public float getAlpha() {
        return Color.m1683getAlphaimpl(mo3588getColor0d7_KjU());
    }
    ...
    public final long m3592getValue0d7_KjU() {
        return this.value;
    }

    public int hashCode() {
        return Color.m1688hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return "ColorStyle(value=" + ((Object) Color.m1689toStringimpl(this.value)) + ')';
    }
