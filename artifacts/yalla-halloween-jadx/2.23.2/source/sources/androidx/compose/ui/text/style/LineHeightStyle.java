...
public final class LineHeightStyle {
    ...
    public static final class Alignment {
        ...
        private static final float Top = m3651constructorimpl(0.0f);
        private static final float Center = m3651constructorimpl(0.5f);
        private static final float Proportional = m3651constructorimpl(-1.0f);
        private static final float Bottom = m3651constructorimpl(1.0f);
        ...
        public static final /* synthetic */ Alignment m3650boximpl(float f) {
            return new Alignment(f);
        }

        /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
        public static float m3651constructorimpl(float f) {
            boolean z = true;
            if (!(0.0f <= f && f <= 1.0f)) {
                if (!(f == -1.0f)) {
                    z = false;
        ...
        public static boolean m3652equalsimpl(float f, Object obj) {
            return (obj instanceof Alignment) && Float.compare(f, ((Alignment) obj).getTopRatio()) == 0;
        }

        /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m3653equalsimpl0(float f, float f2) {
            return Float.compare(f, f2) == 0;
        }

        /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
        public static int m3654hashCodeimpl(float f) {
            return Float.floatToIntBits(f);
        }

        @NotNull
        /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
        public static String m3655toStringimpl(float f) {
            if (f == Top) {
        ...
        public boolean equals(Object obj) {
            return m3652equalsimpl(this.topRatio, obj);
        }

        public int hashCode() {
            return m3654hashCodeimpl(this.topRatio);
        }

        @NotNull
        public String toString() {
            return m3655toStringimpl(this.topRatio);
        }
    ...
    public static final class Trim {
        ...
        @NotNull
        public static final Companion INSTANCE = new Companion(null);
        private static final int FirstLineTop = m3662constructorimpl(1);
        private static final int LastLineBottom = m3662constructorimpl(16);
        private static final int Both = m3662constructorimpl(17);
        private static final int None = m3662constructorimpl(0);
        ...
        /* JADX INFO: renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Trim m3661boximpl(int i) {
            return new Trim(i);
        }
        ...
        public static final boolean m3666isTrimFirstLineTopimpl$ui_text_release(int i) {
            return (i & 1) > 0;
        }

        /* JADX INFO: renamed from: isTrimLastLineBottom-impl$ui_text_release, reason: not valid java name */
        public static final boolean m3667isTrimLastLineBottomimpl$ui_text_release(int i) {
            return (i & 16) > 0;
        }
    ...
    static {
        ...
        Default = new LineHeightStyle(Alignment.INSTANCE.m3659getProportionalPIaL0Z0(), Trim.INSTANCE.m3670getBothEVpEnUU(), defaultConstructorMarker);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Alignment.m3653equalsimpl0(this.alignment, lineHeightStyle.alignment) && Trim.m3664equalsimpl0(this.trim, lineHeightStyle.trim);
    }
    ...
    public int hashCode() {
        return Trim.m3665hashCodeimpl(this.trim) + (Alignment.m3654hashCodeimpl(this.alignment) * 31);
    }

    @NotNull
    public String toString() {
        return "LineHeightStyle(alignment=" + ((Object) Alignment.m3655toStringimpl(this.alignment)) + ", trim=" + ((Object) Trim.m3668toStringimpl(this.trim)) + ')';
    }
