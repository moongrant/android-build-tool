...
public final class TextDirection {
    ...
    private static final int Ltr = m3688constructorimpl(1);
    private static final int Rtl = m3688constructorimpl(2);
    private static final int Content = m3688constructorimpl(3);
    private static final int ContentOrLtr = m3688constructorimpl(4);
    private static final int ContentOrRtl = m3688constructorimpl(5);
    ...
    public static final /* synthetic */ TextDirection m3687boximpl(int i) {
        return new TextDirection(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m3688constructorimpl(int i) {
        return i;
    }
    ...
    public static String m3692toStringimpl(int i) {
        if (m3690equalsimpl0(i, Ltr)) {
            return "Ltr";
        }
        if (m3690equalsimpl0(i, Rtl)) {
            return "Rtl";
        }
        if (m3690equalsimpl0(i, Content)) {
            return "Content";
        }
        if (m3690equalsimpl0(i, ContentOrLtr)) {
            return "ContentOrLtr";
        }
        return m3690equalsimpl0(i, ContentOrRtl) ? "ContentOrRtl" : "Invalid";
    }

    public boolean equals(Object obj) {
        return m3689equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m3691hashCodeimpl(this.value);
    }

    @NotNull
    public String toString() {
        return m3692toStringimpl(this.value);
    }
