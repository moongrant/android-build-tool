...
public final class TextDrawStyleKt {
    ...
    public static final TextForegroundStyle lerp(@NotNull TextForegroundStyle start, @NotNull TextForegroundStyle stop, float f) {
        ...
        return TextForegroundStyle.INSTANCE.m3700from8_81llA(ColorKt.m1732lerpjxsXWHM(start.mo3588getColor0d7_KjU(), stop.mo3588getColor0d7_KjU(), f));
    }

    /* JADX INFO: renamed from: modulate-DxMtmZc, reason: not valid java name */
    public static final long m3699modulateDxMtmZc(long j, float f) {
        return (Float.isNaN(f) || f >= 1.0f) ? j : Color.m1680copywmQWz5c$default(j, Color.m1683getAlphaimpl(j) * f, 0.0f, 0.0f, 0.0f, 14, null);
    }
