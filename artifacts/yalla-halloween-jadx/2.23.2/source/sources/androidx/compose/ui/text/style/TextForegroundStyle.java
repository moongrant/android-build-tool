...
public interface TextForegroundStyle {
    ...
    public final /* synthetic */ class CC {
        @NotNull
        public static TextForegroundStyle OooO00o(final TextForegroundStyle textForegroundStyle, @NotNull TextForegroundStyle other) {
            ...
            if (!z || (textForegroundStyle instanceof BrushStyle)) {
                return (z || !(textForegroundStyle instanceof BrushStyle)) ? other.takeOrElse(new Function0<TextForegroundStyle>() { // from class: androidx.compose.ui.text.style.TextForegroundStyle.merge.2
                    {
                        super(0);
                    }
        ...
        @NotNull
        public static TextForegroundStyle OooO0O0(TextForegroundStyle textForegroundStyle, @NotNull Function0 other) {
            Intrinsics.checkNotNullParameter(other, "other");
    ...
    public static final class Companion {
        ...
        public final TextForegroundStyle from(@Nullable Brush brush, float alpha) {
            ...
            if (brush instanceof SolidColor) {
                return m3700from8_81llA(TextDrawStyleKt.m3699modulateDxMtmZc(((SolidColor) brush).getValue(), alpha));
            }
        ...
        public final TextForegroundStyle m3700from8_81llA(long color) {
            return (color > Color.INSTANCE.m1717getUnspecified0d7_KjU() ? 1 : (color == Color.INSTANCE.m1717getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? new ColorStyle(color, null) : Unspecified.INSTANCE;
        }
    }
