...
public final class TextIndent {
    ...
    public static /* synthetic */ TextIndent m3701copyNB67dxo$default(TextIndent textIndent, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textIndent.m3702copyNB67dxo(j, j2);
    }

    @NotNull
    /* JADX INFO: renamed from: copy-NB67dxo, reason: not valid java name */
    public final TextIndent m3702copyNB67dxo(long firstLine, long restLine) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return TextUnit.m3953equalsimpl0(this.firstLine, textIndent.firstLine) && TextUnit.m3953equalsimpl0(this.restLine, textIndent.restLine);
    }
    ...
    public int hashCode() {
        return TextUnit.m3957hashCodeimpl(this.restLine) + (TextUnit.m3957hashCodeimpl(this.firstLine) * 31);
    }

    @NotNull
    public String toString() {
        return "TextIndent(firstLine=" + ((Object) TextUnit.m3963toStringimpl(this.firstLine)) + ", restLine=" + ((Object) TextUnit.m3963toStringimpl(this.restLine)) + ')';
    }
