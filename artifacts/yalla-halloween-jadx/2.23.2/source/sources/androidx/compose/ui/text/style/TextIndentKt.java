...
public final class TextIndentKt {
    ...
    public static final TextIndent lerp(@NotNull TextIndent start, @NotNull TextIndent stop, float f) {
        ...
        return new TextIndent(SpanStyleKt.m3285lerpTextUnitInheritableC3pnCVY(start.getFirstLine(), stop.getFirstLine(), f), SpanStyleKt.m3285lerpTextUnitInheritableC3pnCVY(start.getRestLine(), stop.getRestLine(), f), null);
    }
}
