...
public final class TextOverflow {
    ...
    private static final int Clip = m3719constructorimpl(1);
    private static final int Ellipsis = m3719constructorimpl(2);
    private static final int Visible = m3719constructorimpl(3);
    ...
    public static final /* synthetic */ TextOverflow m3718boximpl(int i) {
    ...
    public static String m3723toStringimpl(int i) {
        if (m3721equalsimpl0(i, Clip)) {
            return "Clip";
        }
        if (m3721equalsimpl0(i, Ellipsis)) {
            return "Ellipsis";
        }
        return m3721equalsimpl0(i, Visible) ? "Visible" : "Invalid";
    }
