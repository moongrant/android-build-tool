...
public final class Constraints {
    ...
    public static final class Companion {
        ...
        public final long m3750createConstraintsZbe2FdA$ui_unit_release(int minWidth, int maxWidth, int minHeight, int maxHeight) {
            long j;
            ...
            return Constraints.m3732constructorimpl((((long) i3) << 33) | j | (((long) minWidth) << Constraints.MinFocusHeight) | (((long) minHeight) << i5) | (((long) i4) << (i5 + 31)));
        }

        @Stable
        /* JADX INFO: renamed from: fixed-JhjzzOo, reason: not valid java name */
        public final long m3751fixedJhjzzOo(int width, int height) {
            if (width >= 0 && height >= 0) {
                return m3750createConstraintsZbe2FdA$ui_unit_release(width, width, height, height);
            }
        ...
        public final long m3752fixedHeightOenEA2s(int height) {
            if (height >= 0) {
                return m3750createConstraintsZbe2FdA$ui_unit_release(0, Integer.MAX_VALUE, height, height);
            }
        ...
        public final long m3753fixedWidthOenEA2s(int width) {
            if (width >= 0) {
                return m3750createConstraintsZbe2FdA$ui_unit_release(width, width, 0, Integer.MAX_VALUE);
            }
    ...
    public static final /* synthetic */ Constraints m3731boximpl(long j) {
        return new Constraints(j);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m3732constructorimpl(long j) {
        return j;
    }

    /* JADX INFO: renamed from: copy-Zbe2FdA, reason: not valid java name */
    public static final long m3733copyZbe2FdA(long j, int i, int i2, int i3, int i4) {
        boolean z = true;
        if (!(i3 >= 0 && i >= 0)) {
        ...
        if (z) {
            return INSTANCE.m3750createConstraintsZbe2FdA$ui_unit_release(i, i2, i3, i4);
        }
    ...
    public static /* synthetic */ long m3734copyZbe2FdA$default(long j, int i, int i2, int i3, int i4, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i = m3745getMinWidthimpl(j);
        }
        int i6 = i;
        if ((i5 & 2) != 0) {
            i2 = m3743getMaxWidthimpl(j);
        }
        int i7 = i2;
        if ((i5 & 4) != 0) {
            i3 = m3744getMinHeightimpl(j);
        }
        int i8 = i3;
        if ((i5 & 8) != 0) {
            i4 = m3742getMaxHeightimpl(j);
        }
        return m3733copyZbe2FdA(j, i6, i7, i8, i4);
    }
    ...
    private static final int m3737getFocusIndeximpl(long j) {
        return (int) (j & 3);
    }

    /* JADX INFO: renamed from: getHasBoundedHeight-impl, reason: not valid java name */
    public static final boolean m3738getHasBoundedHeightimpl(long j) {
        int iM3737getFocusIndeximpl = m3737getFocusIndeximpl(j);
        return (((int) (j >> (MinHeightOffsets[iM3737getFocusIndeximpl] + 31))) & HeightMask[iM3737getFocusIndeximpl]) != 0;
    }

    /* JADX INFO: renamed from: getHasBoundedWidth-impl, reason: not valid java name */
    public static final boolean m3739getHasBoundedWidthimpl(long j) {
        return (((int) (j >> 33)) & WidthMask[m3737getFocusIndeximpl(j)]) != 0;
    }
    ...
    public static final boolean m3740getHasFixedHeightimpl(long j) {
        return m3742getMaxHeightimpl(j) == m3744getMinHeightimpl(j);
    }
    ...
    public static final boolean m3741getHasFixedWidthimpl(long j) {
        return m3743getMaxWidthimpl(j) == m3745getMinWidthimpl(j);
    }

    /* JADX INFO: renamed from: getMaxHeight-impl, reason: not valid java name */
    public static final int m3742getMaxHeightimpl(long j) {
        int iM3737getFocusIndeximpl = m3737getFocusIndeximpl(j);
        int i = ((int) (j >> (MinHeightOffsets[iM3737getFocusIndeximpl] + 31))) & HeightMask[iM3737getFocusIndeximpl];
        if (i == 0) {
    ...
    public static final int m3743getMaxWidthimpl(long j) {
        int i = ((int) (j >> 33)) & WidthMask[m3737getFocusIndeximpl(j)];
        if (i == 0) {
            return Integer.MAX_VALUE;
        }
        return i - 1;
    ...
    public static final int m3744getMinHeightimpl(long j) {
        int iM3737getFocusIndeximpl = m3737getFocusIndeximpl(j);
        return ((int) (j >> MinHeightOffsets[iM3737getFocusIndeximpl])) & HeightMask[iM3737getFocusIndeximpl];
    }

    /* JADX INFO: renamed from: getMinWidth-impl, reason: not valid java name */
    public static final int m3745getMinWidthimpl(long j) {
        return ((int) (j >> MinFocusHeight)) & WidthMask[m3737getFocusIndeximpl(j)];
    }
    ...
    public static final boolean m3747isZeroimpl(long j) {
        return m3743getMaxWidthimpl(j) == 0 || m3742getMaxHeightimpl(j) == 0;
    }

    @NotNull
    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m3748toStringimpl(long j) {
        int iM3743getMaxWidthimpl = m3743getMaxWidthimpl(j);
        String strValueOf = iM3743getMaxWidthimpl == Integer.MAX_VALUE ? "Infinity" : String.valueOf(iM3743getMaxWidthimpl);
        int iM3742getMaxHeightimpl = m3742getMaxHeightimpl(j);
        return "Constraints(minWidth = " + m3745getMinWidthimpl(j) + ", maxWidth = " + strValueOf + ", minHeight = " + m3744getMinHeightimpl(j) + ", maxHeight = " + (iM3742getMaxHeightimpl != Integer.MAX_VALUE ? String.valueOf(iM3742getMaxHeightimpl) : "Infinity") + ')';
    }
