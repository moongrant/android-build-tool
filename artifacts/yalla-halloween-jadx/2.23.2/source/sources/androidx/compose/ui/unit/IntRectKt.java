...
public final class IntRectKt {
    ...
    public static final IntRect m3924IntRectE1MhUcY(long j, long j2) {
        return new IntRect(IntOffset.m3893getXimpl(j), IntOffset.m3894getYimpl(j), IntOffset.m3893getXimpl(j2), IntOffset.m3894getYimpl(j2));
    }

    @Stable
    @NotNull
    /* JADX INFO: renamed from: IntRect-VbeCjmY, reason: not valid java name */
    public static final IntRect m3925IntRectVbeCjmY(long j, long j2) {
        return new IntRect(IntOffset.m3893getXimpl(j), IntOffset.m3894getYimpl(j), IntSize.m3935getWidthimpl(j2) + IntOffset.m3893getXimpl(j), IntSize.m3934getHeightimpl(j2) + IntOffset.m3894getYimpl(j));
    }

    @Stable
    @NotNull
    /* JADX INFO: renamed from: IntRect-ar5cAso, reason: not valid java name */
    public static final IntRect m3926IntRectar5cAso(long j, int i) {
        return new IntRect(IntOffset.m3893getXimpl(j) - i, IntOffset.m3894getYimpl(j) - i, IntOffset.m3893getXimpl(j) + i, IntOffset.m3894getYimpl(j) + i);
    }
