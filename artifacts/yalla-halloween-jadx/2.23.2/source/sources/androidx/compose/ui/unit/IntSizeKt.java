...
public final class IntSizeKt {
    ...
    public static final long IntSize(int i, int i2) {
        return IntSize.m3930constructorimpl((((long) i2) & 4294967295L) | (((long) i) << 32));
    }

    /* JADX INFO: renamed from: getCenter-ozmzZPI, reason: not valid java name */
    public static final long m3941getCenterozmzZPI(long j) {
        return IntOffsetKt.IntOffset(IntSize.m3935getWidthimpl(j) / 2, IntSize.m3934getHeightimpl(j) / 2);
    }

    @Stable
    /* JADX INFO: renamed from: getCenter-ozmzZPI$annotations, reason: not valid java name */
    public static /* synthetic */ void m3942getCenterozmzZPI$annotations(long j) {
    }

    @Stable
    /* JADX INFO: renamed from: times-O0kMr_c, reason: not valid java name */
    public static final long m3943timesO0kMr_c(int i, long j) {
        return IntSize.m3937timesYEO4UFw(j, i);
    }

    @Stable
    @NotNull
    /* JADX INFO: renamed from: toIntRect-ozmzZPI, reason: not valid java name */
    public static final IntRect m3944toIntRectozmzZPI(long j) {
        return IntRectKt.m3925IntRectVbeCjmY(IntOffset.INSTANCE.m3903getZeronOccac(), j);
    }

    @Stable
    /* JADX INFO: renamed from: toSize-ozmzZPI, reason: not valid java name */
    public static final long m3945toSizeozmzZPI(long j) {
        return SizeKt.Size(IntSize.m3935getWidthimpl(j), IntSize.m3934getHeightimpl(j));
    }
}
