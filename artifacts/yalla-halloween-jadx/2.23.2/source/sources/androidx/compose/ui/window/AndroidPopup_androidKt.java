...
public final class AndroidPopup_androidKt {
    ...
    public static final class C08311 implements MeasurePolicy {
        public static final C08311 INSTANCE = new C08311();
        ...
        public final MeasureResult mo3measure3p2s80s(@NotNull MeasureScope Layout, @NotNull List<? extends Measurable> measurables, long j) {
            ...
            int i3 = 0;
            if (size == 1) {
                final Placeable placeableMo2804measureBRTryo0 = measurables.get(0).mo2804measureBRTryo0(j);
                return MeasureScope.CC.OooOOo0(Layout, placeableMo2804measureBRTryo0.getWidth(), placeableMo2804measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$SimpleStack$1$measure$2
                    {
                        super(1);
                    }
            ...
            for (int i4 = 0; i4 < size2; i4++) {
                arrayList.add(measurables.get(i4).mo2804measureBRTryo0(j));
            }
    ...
    public static final void Popup(@NotNull final PopupPositionProvider popupPositionProvider, @Nullable Function0<Unit> function0, @Nullable PopupProperties popupProperties, @NotNull final Function2<? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, final int i, final int i2) {
        ...
        if (i8 == 0) {
            ...
            if (i4 != 0) {
                ...
                if ((i7 & 5851) == 1170 || !composerStartRestartGroup.getSkipping()) {
                    ...
                    popupId = (UUID) RememberSaveableKt.m1333rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) new Function0<UUID>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$Popup$popupId$1
                        @Override // kotlin.jvm.functions.Function0
                            ...
                            public final void invoke(@Nullable Composer composer2, int i9) {
                                ...
                                Modifier modifierAlpha = AlphaKt.alpha(OnRemeasuredModifierKt.onSizeChanged(modifierSemantics$default, new Function1<IntSize, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$Popup$popupLayout$1$1$1.2
                                    ...
                                    public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
                                        m4015invokeozmzZPI(intSize.getPackedValue());
                                        return Unit.INSTANCE;
                                    }

                                    /* JADX INFO: renamed from: invoke-ozmzZPI, reason: not valid java name */
                                    public final void m4015invokeozmzZPI(long j) {
                                        popupLayout2.m4019setPopupContentSizefhxjrPA(IntSize.m3927boximpl(j));
                                ...
                                AndroidPopup_androidKt.C08311 c08311 = AndroidPopup_androidKt.C08311.INSTANCE;
                                ...
                                Updater.m1327setimpl(composerM1320constructorimpl2, c08311, companion.getSetMeasurePolicy());
                                Updater.m1327setimpl(composerM1320constructorimpl2, currentCompositionLocalMap, companion.getSetResolvedCompositionLocals());
                                Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash2 = companion.getSetCompositeKeyHash();
                                if (composerM1320constructorimpl2.getInserting() || !Intrinsics.areEqual(composerM1320constructorimpl2.rememberedValue(), Integer.valueOf(currentCompositeKeyHash2))) {
                                    OooO0O0.OooO0O0(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, setCompositeKeyHash2);
                                }
                                function3ModifierMaterializerOf.invoke(SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer2)), composer2, 0);
                    ...
                    Updater.m1327setimpl(composerM1320constructorimpl, measurePolicy, companion.getSetMeasurePolicy());
            ...
            if ((i7 & 5851) == 1170) {
                    ...
                    popupLayout3.setContent(compositionContextRememberCompositionContext, ComposableLambdaKt.composableLambdaInstance(1302892335, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$Popup$popupLayout$1$1$1
                        ...
                        public final void invoke(@Nullable Composer composer2, int i9) {
                            ...
                            Modifier modifierAlpha = AlphaKt.alpha(OnRemeasuredModifierKt.onSizeChanged(modifierSemantics$default, new Function1<IntSize, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$Popup$popupLayout$1$1$1.2
                                ...
                                /* JADX INFO: renamed from: invoke-ozmzZPI, reason: not valid java name */
                                public final void m4015invokeozmzZPI(long j) {
                                    popupLayout4.m4019setPopupContentSizefhxjrPA(IntSize.m3927boximpl(j));
                            ...
                            Composer composerM1320constructorimpl2 = Updater.m1320constructorimpl(composer2);
                            Updater.m1327setimpl(composerM1320constructorimpl2, c08311, companion2.getSetMeasurePolicy());
                            Updater.m1327setimpl(composerM1320constructorimpl2, currentCompositionLocalMap2, companion2.getSetResolvedCompositionLocals());
                ...
                composerM1320constructorimpl = Updater.m1320constructorimpl(composerStartRestartGroup);
                Updater.m1327setimpl(composerM1320constructorimpl, measurePolicy2, companion2.getSetMeasurePolicy());
                Updater.m1327setimpl(composerM1320constructorimpl, currentCompositionLocalMap2, companion2.getSetResolvedCompositionLocals());
                    ...
                    popupLayout5.setContent(compositionContextRememberCompositionContext, ComposableLambdaKt.composableLambdaInstance(1302892335, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$Popup$popupLayout$1$1$1
                        ...
                        public final void invoke(@Nullable Composer composer2, int i9) {
                            ...
                            Modifier modifierAlpha = AlphaKt.alpha(OnRemeasuredModifierKt.onSizeChanged(modifierSemantics$default, new Function1<IntSize, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$Popup$popupLayout$1$1$1.2
                                ...
                                /* JADX INFO: renamed from: invoke-ozmzZPI, reason: not valid java name */
                                public final void m4015invokeozmzZPI(long j) {
                                    popupLayout6.m4019setPopupContentSizefhxjrPA(IntSize.m3927boximpl(j));
                            ...
                            Composer composerM1320constructorimpl2 = Updater.m1320constructorimpl(composer2);
                            Updater.m1327setimpl(composerM1320constructorimpl2, c08311, companion3.getSetMeasurePolicy());
                            Updater.m1327setimpl(composerM1320constructorimpl2, currentCompositionLocalMap3, companion3.getSetResolvedCompositionLocals());
                ...
                composerM1320constructorimpl = Updater.m1320constructorimpl(composerStartRestartGroup);
                Updater.m1327setimpl(composerM1320constructorimpl, measurePolicy3, companion3.getSetMeasurePolicy());
                Updater.m1327setimpl(composerM1320constructorimpl, currentCompositionLocalMap3, companion3.getSetResolvedCompositionLocals());
        ...
        if (i4 != 0) {
            ...
            if ((i7 & 5851) == 1170) {
                    ...
                    popupLayout7.setContent(compositionContextRememberCompositionContext, ComposableLambdaKt.composableLambdaInstance(1302892335, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$Popup$popupLayout$1$1$1
                        ...
                        public final void invoke(@Nullable Composer composer2, int i9) {
                            ...
                            Modifier modifierAlpha = AlphaKt.alpha(OnRemeasuredModifierKt.onSizeChanged(modifierSemantics$default, new Function1<IntSize, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$Popup$popupLayout$1$1$1.2
                                ...
                                /* JADX INFO: renamed from: invoke-ozmzZPI, reason: not valid java name */
                                public final void m4015invokeozmzZPI(long j) {
                                    popupLayout8.m4019setPopupContentSizefhxjrPA(IntSize.m3927boximpl(j));
                            ...
                            Composer composerM1320constructorimpl2 = Updater.m1320constructorimpl(composer2);
                            Updater.m1327setimpl(composerM1320constructorimpl2, c08311, companion4.getSetMeasurePolicy());
                            Updater.m1327setimpl(composerM1320constructorimpl2, currentCompositionLocalMap4, companion4.getSetResolvedCompositionLocals());
                ...
                composerM1320constructorimpl = Updater.m1320constructorimpl(composerStartRestartGroup);
                Updater.m1327setimpl(composerM1320constructorimpl, measurePolicy4, companion4.getSetMeasurePolicy());
                    ...
                    popupLayout9.setContent(compositionContextRememberCompositionContext, ComposableLambdaKt.composableLambdaInstance(1302892335, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$Popup$popupLayout$1$1$1
                        ...
                        public final void invoke(@Nullable Composer composer2, int i9) {
                            ...
                            Modifier modifierAlpha = AlphaKt.alpha(OnRemeasuredModifierKt.onSizeChanged(modifierSemantics$default, new Function1<IntSize, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$Popup$popupLayout$1$1$1.2
                                ...
                                /* JADX INFO: renamed from: invoke-ozmzZPI, reason: not valid java name */
                                public final void m4015invokeozmzZPI(long j) {
                                    popupLayout10.m4019setPopupContentSizefhxjrPA(IntSize.m3927boximpl(j));
                            ...
                            Composer composerM1320constructorimpl2 = Updater.m1320constructorimpl(composer2);
                            Updater.m1327setimpl(composerM1320constructorimpl2, c08311, companion5.getSetMeasurePolicy());
                            Updater.m1327setimpl(composerM1320constructorimpl2, currentCompositionLocalMap5, companion5.getSetResolvedCompositionLocals());
                            Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash2 = companion5.getSetCompositeKeyHash();
                            if (composerM1320constructorimpl2.getInserting() || !Intrinsics.areEqual(composerM1320constructorimpl2.rememberedValue(), Integer.valueOf(currentCompositeKeyHash2))) {
                                OooO0O0.OooO0O0(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, setCompositeKeyHash2);
                            }
                            function3ModifierMaterializerOf5.invoke(SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer2)), composer2, 0);
                            composer2.startReplaceableGroup(2058660585);
                            composableLambda.invoke(composer2, 6);
                            composer2.endReplaceableGroup();
                            composer2.endNode();
                ...
                composerM1320constructorimpl = Updater.m1320constructorimpl(composerStartRestartGroup);
                Updater.m1327setimpl(composerM1320constructorimpl, measurePolicy5, companion5.getSetMeasurePolicy());
                Updater.m1327setimpl(composerM1320constructorimpl, currentCompositionLocalMap5, companion5.getSetResolvedCompositionLocals());
        ...
        if ((i7 & 5851) == 1170) {
                ...
                popupLayout11.setContent(compositionContextRememberCompositionContext, ComposableLambdaKt.composableLambdaInstance(1302892335, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$Popup$popupLayout$1$1$1
                    ...
                    public final void invoke(@Nullable Composer composer2, int i9) {
                        ...
                        Modifier modifierAlpha = AlphaKt.alpha(OnRemeasuredModifierKt.onSizeChanged(modifierSemantics$default, new Function1<IntSize, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$Popup$popupLayout$1$1$1.2
                            ...
                            /* JADX INFO: renamed from: invoke-ozmzZPI, reason: not valid java name */
                            public final void m4015invokeozmzZPI(long j) {
                                popupLayout12.m4019setPopupContentSizefhxjrPA(IntSize.m3927boximpl(j));
                        ...
                        Composer composerM1320constructorimpl2 = Updater.m1320constructorimpl(composer2);
                        Updater.m1327setimpl(composerM1320constructorimpl2, c08311, companion6.getSetMeasurePolicy());
                        Updater.m1327setimpl(composerM1320constructorimpl2, currentCompositionLocalMap6, companion6.getSetResolvedCompositionLocals());
                        Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash2 = companion6.getSetCompositeKeyHash();
                        if (composerM1320constructorimpl2.getInserting() || !Intrinsics.areEqual(composerM1320constructorimpl2.rememberedValue(), Integer.valueOf(currentCompositeKeyHash2))) {
                            OooO0O0.OooO0O0(currentCompositeKeyHash2, composerM1320constructorimpl2, currentCompositeKeyHash2, setCompositeKeyHash2);
                        }
                        function3ModifierMaterializerOf6.invoke(SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer2)), composer2, 0);
                        composer2.startReplaceableGroup(2058660585);
                        composableLambda.invoke(composer2, 6);
                        composer2.endReplaceableGroup();
                        composer2.endNode();
            ...
            composerM1320constructorimpl = Updater.m1320constructorimpl(composerStartRestartGroup);
            Updater.m1327setimpl(composerM1320constructorimpl, measurePolicy6, companion6.getSetMeasurePolicy());
            Updater.m1327setimpl(composerM1320constructorimpl, currentCompositionLocalMap6, companion6.getSetResolvedCompositionLocals());
                ...
                popupLayout13.setContent(compositionContextRememberCompositionContext, ComposableLambdaKt.composableLambdaInstance(1302892335, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$Popup$popupLayout$1$1$1
                    ...
                    public final void invoke(@Nullable Composer composer2, int i9) {
                        ...
                        Modifier modifierAlpha = AlphaKt.alpha(OnRemeasuredModifierKt.onSizeChanged(modifierSemantics$default, new Function1<IntSize, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$Popup$popupLayout$1$1$1.2
                            ...
                            /* JADX INFO: renamed from: invoke-ozmzZPI, reason: not valid java name */
                            public final void m4015invokeozmzZPI(long j) {
                                popupLayout14.m4019setPopupContentSizefhxjrPA(IntSize.m3927boximpl(j));
                        ...
                        Composer composerM1320constructorimpl2 = Updater.m1320constructorimpl(composer2);
                        Updater.m1327setimpl(composerM1320constructorimpl2, c08311, companion7.getSetMeasurePolicy());
                        Updater.m1327setimpl(composerM1320constructorimpl2, currentCompositionLocalMap7, companion7.getSetResolvedCompositionLocals());
            ...
            composerM1320constructorimpl = Updater.m1320constructorimpl(composerStartRestartGroup);
            Updater.m1327setimpl(composerM1320constructorimpl, measurePolicy7, companion7.getSetMeasurePolicy());
    ...
    public static final void m4014PopupK5zGePQ(@Nullable Alignment alignment, long j, @Nullable Function0<Unit> function0, @Nullable PopupProperties popupProperties, @NotNull final Function2<? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, final int i, final int i2) {
        ...
        if (i10 == 0) {
            ...
            if (i4 != 0) {
                ...
                if (i6 != 0) {
                    ...
                    if ((46811 & i3) == 9362 || !composerStartRestartGroup.getSkipping()) {
                        ...
                        IntOffset intOffsetM3884boximpl = IntOffset.m3884boximpl(jIntOffset);
                        composerStartRestartGroup.startReplaceableGroup(511388516);
                        zChanged = composerStartRestartGroup.changed(intOffsetM3884boximpl) | composerStartRestartGroup.changed(topStart);
                        objRememberedValue = composerStartRestartGroup.rememberedValue();
                    ...
                    scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt.Popup.1
                        ...
                        public final void invoke(@Nullable Composer composer2, int i12) {
                            AndroidPopup_androidKt.m4014PopupK5zGePQ(alignment3, j2, function2, popupProperties3, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                        }
                    });
                }
                i3 |= 3072;
                ...
                if ((46811 & i3) == 9362) {
                    ...
                    IntOffset intOffsetM3884boximpl2 = IntOffset.m3884boximpl(jIntOffset);
                    composerStartRestartGroup.startReplaceableGroup(511388516);
                    zChanged = composerStartRestartGroup.changed(intOffsetM3884boximpl2) | composerStartRestartGroup.changed(topStart);
                    objRememberedValue = composerStartRestartGroup.rememberedValue();
                    if (zChanged) {
                        objRememberedValue = new AlignmentOffsetPositionProvider(topStart, jIntOffset, defaultConstructorMarker);
                        composerStartRestartGroup.updateRememberedValue(objRememberedValue);
                    ...
                    IntOffset intOffsetM3884boximpl3 = IntOffset.m3884boximpl(jIntOffset);
                    composerStartRestartGroup.startReplaceableGroup(511388516);
                    zChanged = composerStartRestartGroup.changed(intOffsetM3884boximpl3) | composerStartRestartGroup.changed(topStart);
                    objRememberedValue = composerStartRestartGroup.rememberedValue();
                    if (zChanged) {
                        objRememberedValue = new AlignmentOffsetPositionProvider(topStart, jIntOffset, defaultConstructorMarker);
                        composerStartRestartGroup.updateRememberedValue(objRememberedValue);
            ...
            if (i6 != 0) {
                ...
                if ((46811 & i3) == 9362) {
                    ...
                    IntOffset intOffsetM3884boximpl4 = IntOffset.m3884boximpl(jIntOffset);
                    composerStartRestartGroup.startReplaceableGroup(511388516);
                    zChanged = composerStartRestartGroup.changed(intOffsetM3884boximpl4) | composerStartRestartGroup.changed(topStart);
                    objRememberedValue = composerStartRestartGroup.rememberedValue();
                    if (zChanged) {
                        objRememberedValue = new AlignmentOffsetPositionProvider(topStart, jIntOffset, defaultConstructorMarker);
                        composerStartRestartGroup.updateRememberedValue(objRememberedValue);
                    ...
                    IntOffset intOffsetM3884boximpl5 = IntOffset.m3884boximpl(jIntOffset);
                    composerStartRestartGroup.startReplaceableGroup(511388516);
                    zChanged = composerStartRestartGroup.changed(intOffsetM3884boximpl5) | composerStartRestartGroup.changed(topStart);
                    objRememberedValue = composerStartRestartGroup.rememberedValue();
                    if (zChanged) {
                        objRememberedValue = new AlignmentOffsetPositionProvider(topStart, jIntOffset, defaultConstructorMarker);
                        composerStartRestartGroup.updateRememberedValue(objRememberedValue);
            ...
            if ((46811 & i3) == 9362) {
                ...
                IntOffset intOffsetM3884boximpl6 = IntOffset.m3884boximpl(jIntOffset);
                composerStartRestartGroup.startReplaceableGroup(511388516);
                zChanged = composerStartRestartGroup.changed(intOffsetM3884boximpl6) | composerStartRestartGroup.changed(topStart);
                objRememberedValue = composerStartRestartGroup.rememberedValue();
                if (zChanged) {
                    objRememberedValue = new AlignmentOffsetPositionProvider(topStart, jIntOffset, defaultConstructorMarker);
                    composerStartRestartGroup.updateRememberedValue(objRememberedValue);
                ...
                IntOffset intOffsetM3884boximpl7 = IntOffset.m3884boximpl(jIntOffset);
                composerStartRestartGroup.startReplaceableGroup(511388516);
                zChanged = composerStartRestartGroup.changed(intOffsetM3884boximpl7) | composerStartRestartGroup.changed(topStart);
                objRememberedValue = composerStartRestartGroup.rememberedValue();
                if (zChanged) {
                    objRememberedValue = new AlignmentOffsetPositionProvider(topStart, jIntOffset, defaultConstructorMarker);
                    composerStartRestartGroup.updateRememberedValue(objRememberedValue);
        ...
        if (i4 != 0) {
            ...
            if (i6 != 0) {
                ...
                if ((46811 & i3) == 9362) {
                    ...
                    IntOffset intOffsetM3884boximpl8 = IntOffset.m3884boximpl(jIntOffset);
                    composerStartRestartGroup.startReplaceableGroup(511388516);
                    zChanged = composerStartRestartGroup.changed(intOffsetM3884boximpl8) | composerStartRestartGroup.changed(topStart);
                    objRememberedValue = composerStartRestartGroup.rememberedValue();
                    if (zChanged) {
                        objRememberedValue = new AlignmentOffsetPositionProvider(topStart, jIntOffset, defaultConstructorMarker);
                        composerStartRestartGroup.updateRememberedValue(objRememberedValue);
                    ...
                    IntOffset intOffsetM3884boximpl9 = IntOffset.m3884boximpl(jIntOffset);
                    composerStartRestartGroup.startReplaceableGroup(511388516);
                    zChanged = composerStartRestartGroup.changed(intOffsetM3884boximpl9) | composerStartRestartGroup.changed(topStart);
                    objRememberedValue = composerStartRestartGroup.rememberedValue();
                    if (zChanged) {
                        objRememberedValue = new AlignmentOffsetPositionProvider(topStart, jIntOffset, defaultConstructorMarker);
                        composerStartRestartGroup.updateRememberedValue(objRememberedValue);
            ...
            if ((46811 & i3) == 9362) {
                ...
                IntOffset intOffsetM3884boximpl10 = IntOffset.m3884boximpl(jIntOffset);
                composerStartRestartGroup.startReplaceableGroup(511388516);
                zChanged = composerStartRestartGroup.changed(intOffsetM3884boximpl10) | composerStartRestartGroup.changed(topStart);
                objRememberedValue = composerStartRestartGroup.rememberedValue();
                if (zChanged) {
                    objRememberedValue = new AlignmentOffsetPositionProvider(topStart, jIntOffset, defaultConstructorMarker);
                    composerStartRestartGroup.updateRememberedValue(objRememberedValue);
                ...
                IntOffset intOffsetM3884boximpl11 = IntOffset.m3884boximpl(jIntOffset);
                composerStartRestartGroup.startReplaceableGroup(511388516);
                zChanged = composerStartRestartGroup.changed(intOffsetM3884boximpl11) | composerStartRestartGroup.changed(topStart);
                objRememberedValue = composerStartRestartGroup.rememberedValue();
                if (zChanged) {
                    objRememberedValue = new AlignmentOffsetPositionProvider(topStart, jIntOffset, defaultConstructorMarker);
                    composerStartRestartGroup.updateRememberedValue(objRememberedValue);
        ...
        if (i6 != 0) {
            ...
            if ((46811 & i3) == 9362) {
                ...
                IntOffset intOffsetM3884boximpl12 = IntOffset.m3884boximpl(jIntOffset);
                composerStartRestartGroup.startReplaceableGroup(511388516);
                zChanged = composerStartRestartGroup.changed(intOffsetM3884boximpl12) | composerStartRestartGroup.changed(topStart);
                objRememberedValue = composerStartRestartGroup.rememberedValue();
                if (zChanged) {
                    objRememberedValue = new AlignmentOffsetPositionProvider(topStart, jIntOffset, defaultConstructorMarker);
                    composerStartRestartGroup.updateRememberedValue(objRememberedValue);
                ...
                IntOffset intOffsetM3884boximpl13 = IntOffset.m3884boximpl(jIntOffset);
                composerStartRestartGroup.startReplaceableGroup(511388516);
                zChanged = composerStartRestartGroup.changed(intOffsetM3884boximpl13) | composerStartRestartGroup.changed(topStart);
                objRememberedValue = composerStartRestartGroup.rememberedValue();
                if (zChanged) {
                    objRememberedValue = new AlignmentOffsetPositionProvider(topStart, jIntOffset, defaultConstructorMarker);
                    composerStartRestartGroup.updateRememberedValue(objRememberedValue);
        ...
        if ((46811 & i3) == 9362) {
            ...
            IntOffset intOffsetM3884boximpl14 = IntOffset.m3884boximpl(jIntOffset);
            composerStartRestartGroup.startReplaceableGroup(511388516);
            zChanged = composerStartRestartGroup.changed(intOffsetM3884boximpl14) | composerStartRestartGroup.changed(topStart);
            objRememberedValue = composerStartRestartGroup.rememberedValue();
            if (zChanged) {
                objRememberedValue = new AlignmentOffsetPositionProvider(topStart, jIntOffset, defaultConstructorMarker);
                composerStartRestartGroup.updateRememberedValue(objRememberedValue);
            ...
            IntOffset intOffsetM3884boximpl15 = IntOffset.m3884boximpl(jIntOffset);
            composerStartRestartGroup.startReplaceableGroup(511388516);
            zChanged = composerStartRestartGroup.changed(intOffsetM3884boximpl15) | composerStartRestartGroup.changed(topStart);
            objRememberedValue = composerStartRestartGroup.rememberedValue();
            if (zChanged) {
                objRememberedValue = new AlignmentOffsetPositionProvider(topStart, jIntOffset, defaultConstructorMarker);
                composerStartRestartGroup.updateRememberedValue(objRememberedValue);
    ...
    private static final void SimpleStack(Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i) {
        ...
        Updater.m1327setimpl(composerM1320constructorimpl, c08311, companion.getSetMeasurePolicy());
        Updater.m1327setimpl(composerM1320constructorimpl, currentCompositionLocalMap, companion.getSetResolvedCompositionLocals());
        Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash = companion.getSetCompositeKeyHash();
        if (composerM1320constructorimpl.getInserting() || !Intrinsics.areEqual(composerM1320constructorimpl.rememberedValue(), Integer.valueOf(currentCompositeKeyHash))) {
            OooO0O0.OooO0O0(currentCompositeKeyHash, composerM1320constructorimpl, currentCompositeKeyHash, setCompositeKeyHash);
        }
        OooOO0.OooO00o((i3 >> 3) & 112, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composer)), composer, 2058660585);
        OooO00o.OooO00o((i3 >> 9) & 14, function2, composer);
    }
