...
public class MotionHelper extends ConstraintHelper implements MotionLayout.OooOOOO {
    ...
    public boolean f4574OooOO0o;

    /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
    public float f4575OooOOO;

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    public boolean f4576OooOOO0;

    /* JADX INFO: renamed from: OooOOOO, reason: collision with root package name */
    public View[] f4577OooOOOO;

    public MotionHelper(Context context) {
        super(context);
        this.f4574OooOO0o = false;
        this.f4576OooOOO0 = false;
    }
        ...
        if (attributeSet != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == OooO.MotionHelper_onShow) {
                    this.f4574OooOO0o = typedArrayObtainStyledAttributes.getBoolean(index, this.f4574OooOO0o);
                } else if (index == OooO.MotionHelper_onHide) {
                    this.f4576OooOOO0 = typedArrayObtainStyledAttributes.getBoolean(index, this.f4576OooOOO0);
                }
            }
    ...
    public float getProgress() {
        return this.f4575OooOOO;
    }

    public void setProgress(float f) {
        this.f4575OooOOO = f;
        int i = 0;
        if (this.f4923OooO0o0 > 0) {
            this.f4577OooOOOO = OooOOO0((ConstraintLayout) getParent());
            while (i < this.f4923OooO0o0) {
                View view = this.f4577OooOOOO[i];
                i++;
            }
            return;
        }
