...
public class ContextCompat {
    ...
    public static final Object f5281OooO00o = new Object();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final Object f5282OooO0O0 = new Object();
    ...
    public static class OooOO0 {
        ...
        public static Intent OooO00o(Context context, @Nullable BroadcastReceiver broadcastReceiver, IntentFilter intentFilter, String str, Handler handler, int i) {
            ...
            throw new RuntimeException(o000oOoO.OooO0O0("Permission ", str2, " is required by your application to receive broadcasts, please add it to your manifest"));
        }
    ...
    public static int OooO00o(@NonNull Context context, @NonNull String str) {
        ...
        return new NotificationManagerCompat(context).OooO00o() ? 0 : -1;
    }
    ...
    public static ColorStateList OooO0O0(@ColorRes int i, @NonNull Context context) {
        ...
        synchronized (androidx.core.content.res.OooO00o.f5300OooO0OO) {
            SparseArray<androidx.core.content.res.OooO00o.OooO0OO> sparseArray = androidx.core.content.res.OooO00o.f5299OooO0O0.get(oooO0o);
            colorStateListOooO00o = null;
            if (sparseArray == null || sparseArray.size() <= 0 || (oooO0OO = sparseArray.get(i)) == null) {
                colorStateList = null;
            } else if (!oooO0OO.f5302OooO0O0.equals(resources.getConfiguration()) || (!(theme == null && oooO0OO.f5303OooO0OO == 0) && (theme == null || oooO0OO.f5303OooO0OO != theme.hashCode()))) {
                sparseArray.remove(i);
                colorStateList = null;
            } else {
                colorStateList = oooO0OO.f5301OooO00o;
            }
        }
    ...
    public static Executor OooO0OO(@NonNull Context context) {
        return Build.VERSION.SDK_INT >= 28 ? OooOO0O.OooO00o(context) : new o00Ooo(new Handler(context.getMainLooper()));
    }

    public static void OooO0Oo(@NonNull Context context, @NonNull Intent intent) {
        if (Build.VERSION.SDK_INT >= 26) {
            OooOO0.OooO0O0(context, intent);
        } else {
