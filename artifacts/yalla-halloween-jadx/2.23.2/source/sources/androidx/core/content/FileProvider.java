...
public class FileProvider extends ContentProvider {
    ...
    @Nullable
    @GuardedBy("this")
    private OooO0O0 mLocalPathStrategy;
    ...
    public interface OooO0O0 {
        ...
        File OooO0O0(Uri uri);
    }

    public static class OooO0OO implements OooO0O0 {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final String f5283OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final HashMap<String, File> f5284OooO0O0 = new HashMap<>();

        public OooO0OO(String str) {
            this.f5283OooO00o = str;
        }

        @Override // androidx.core.content.FileProvider.OooO0O0
        public final Uri OooO00o(File file) {
            try {
                String canonicalPath = file.getCanonicalPath();
                Map.Entry<String, File> entry = null;
                for (Map.Entry<String, File> entry2 : this.f5284OooO0O0.entrySet()) {
                ...
                if (entry == null) {
                    throw new IllegalArgumentException(o00O00OO.OooO00o("Failed to find configured root that contains ", canonicalPath));
                }
                String path2 = entry.getValue().getPath();
                return new Uri.Builder().scheme("content").authority(this.f5283OooO00o).encodedPath(Uri.encode(entry.getKey()) + '/' + Uri.encode(path2.endsWith("/") ? canonicalPath.substring(path2.length()) : canonicalPath.substring(path2.length() + 1), "/")).build();
        ...
        public final File OooO0O0(Uri uri) {
            ...
            File file = this.f5284OooO0O0.get(strDecode);
            if (file == null) {
                throw new IllegalArgumentException(o0000O0O.OooO00o("Unable to find configured root for ", uri));
            }
    ...
    public static XmlResourceParser getFileProviderPathsMetaData(Context context, String str, @Nullable ProviderInfo providerInfo, int i) {
        if (providerInfo == null) {
            throw new IllegalArgumentException(o00O00OO.OooO00o("Couldn't find meta-data for provider with authority ", str));
        }
    ...
    public static Uri getUriForFile(@NonNull Context context, @NonNull String str, @NonNull File file) {
        return getPathStrategy(context, str, 0).OooO00o(file);
    }
    ...
    private static int modeToMode(String str) {
        ...
        throw new IllegalArgumentException(o00O00OO.OooO00o("Invalid mode: ", str));
    }
        ...
        while (true) {
            ...
            if (next == 2) {
                ...
                if (TAG_ROOT_PATH.equals(name)) {
                    ...
                    File[] fileArrOooO0O0 = ContextCompat.OooO0O0.OooO0O0(context, null);
                    if (fileArrOooO0O0.length > 0) {
                        externalStorageDirectory = fileArrOooO0O0[0];
                    }
                } else if (TAG_EXTERNAL_CACHE.equals(name)) {
                    Object obj2 = ContextCompat.f5281OooO00o;
                    File[] fileArrOooO00o = ContextCompat.OooO0O0.OooO00o(context);
                ...
                if (externalStorageDirectory != null) {
                    ...
                    try {
                        oooO0OO.f5284OooO0O0.put(attributeValue, fileBuildPath.getCanonicalFile());
                    } catch (IOException e) {
    ...
    public int delete(@NonNull Uri uri, @Nullable String str, @Nullable String[] strArr) {
        return getLocalPathStrategy().OooO0O0(uri).delete() ? 1 : 0;
    }

    @Override // android.content.ContentProvider
    @Nullable
    public String getType(@NonNull Uri uri) {
        File fileOooO0O0 = getLocalPathStrategy().OooO0O0(uri);
        int iLastIndexOf = fileOooO0O0.getName().lastIndexOf(46);
        if (iLastIndexOf < 0) {
            return "application/octet-stream";
        }
        String mimeTypeFromExtension = MimeTypeMap.getSingleton().getMimeTypeFromExtension(fileOooO0O0.getName().substring(iLastIndexOf + 1));
    ...
    public ParcelFileDescriptor openFile(@NonNull Uri uri, @NonNull String str) throws FileNotFoundException {
        return ParcelFileDescriptor.open(getLocalPathStrategy().OooO0O0(uri), modeToMode(str));
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] strArr, @Nullable String str, @Nullable String[] strArr2, @Nullable String str2) {
        ...
        for (String str3 : strArr) {
            if ("_display_name".equals(str3)) {
                ...
                i = i2 + 1;
                objArr[i2] = queryParameter == null ? fileOooO0O0.getName() : queryParameter;
            } else {
                if ("_size".equals(str3)) {
                    strArr3[i2] = "_size";
                    i = i2 + 1;
                    objArr[i2] = Long.valueOf(fileOooO0O0.length());
                }
            }
            i2 = i;
        }
