...
public final class OooO00o {
    ...
    public static final ThreadLocal<TypedValue> f5298OooO00o = new ThreadLocal<>();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @GuardedBy("sColorStateCacheLock")
    public static final WeakHashMap<OooO0o, SparseArray<OooO0OO>> f5299OooO0O0 = new WeakHashMap<>(0);

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final Object f5300OooO0OO = new Object();
    ...
    public static abstract class OooO {
        ...
        public final void OooO0O0(@NonNull Typeface typeface) {
            new Handler(Looper.getMainLooper()).post(new o00Oo0(0, this, typeface));
        }
    ...
    public static class OooO0OO {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final ColorStateList f5301OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final Configuration f5302OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final int f5303OooO0OO;

        public OooO0OO(@NonNull ColorStateList colorStateList, @NonNull Configuration configuration, @Nullable Resources.Theme theme) {
            this.f5301OooO00o = colorStateList;
            this.f5302OooO0O0 = configuration;
            this.f5303OooO0OO = theme == null ? 0 : theme.hashCode();
        }
    }
    ...
    public static final class OooO0o {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final Resources f5304OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final Resources.Theme f5305OooO0O0;

        public OooO0o(@NonNull Resources resources, @Nullable Resources.Theme theme) {
            this.f5304OooO00o = resources;
            this.f5305OooO0O0 = theme;
        }
        ...
        public final boolean equals(Object obj) {
            ...
            return this.f5304OooO00o.equals(oooO0o.f5304OooO00o) && o000OO.OooO0OO.OooO00o(this.f5305OooO0O0, oooO0o.f5305OooO0O0);
        }

        public final int hashCode() {
            return o000OO.OooO0OO.OooO0O0(this.f5304OooO00o, this.f5305OooO0O0);
        }
    }
    ...
    public static final class OooOO0 {
        ...
        @RequiresApi(23)
        public static class C0122OooO00o {

            /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
            public static final Object f5306OooO00o = new Object();

            /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
            public static Method f5307OooO0O0;

            /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
            public static boolean f5308OooO0OO;
        }
        ...
        public static void OooO00o(@NonNull Resources.Theme theme) {
            ...
            synchronized (C0122OooO00o.f5306OooO00o) {
                if (C0122OooO00o.f5308OooO0OO) {
                    method = C0122OooO00o.f5307OooO0O0;
                    if (method != null) {
                    ...
                    try {
                        ...
                        C0122OooO00o.f5307OooO0O0 = declaredMethod;
                        declaredMethod.setAccessible(true);
                    } catch (NoSuchMethodException e) {
                        Log.i("ResourcesCompat", "Failed to retrieve rebase() method", e);
                    }
                    C0122OooO00o.f5308OooO0OO = true;
                    method = C0122OooO00o.f5307OooO0O0;
                    if (method != null) {
                        try {
                            method.invoke(theme, new Object[0]);
                            ...
                            C0122OooO00o.f5307OooO0O0 = null;
                        }
                    }
                }
                throw th;
    ...
    public static void OooO00o(@NonNull OooO0o oooO0o, @ColorRes int i, @NonNull ColorStateList colorStateList, @Nullable Resources.Theme theme) {
        synchronized (f5300OooO0OO) {
            WeakHashMap<OooO0o, SparseArray<OooO0OO>> weakHashMap = f5299OooO0O0;
            SparseArray<OooO0OO> sparseArray = weakHashMap.get(oooO0o);
            if (sparseArray == null) {
                sparseArray = new SparseArray<>();
                weakHashMap.put(oooO0o, sparseArray);
            }
            sparseArray.append(i, new OooO0OO(colorStateList, oooO0o.f5304OooO00o.getConfiguration(), theme));
        }
    }
    ...
    public static Typeface OooO0OO(@NonNull Context context, int i, @NonNull TypedValue typedValue, int i2, @Nullable OooO oooO, boolean z, boolean z2) {
        ...
        if (string.startsWith("res/")) {
            ...
            OooOo00<String, Typeface> oooOo00 = OooOOOO.f33485OooO0O0;
            typefaceOooO0Oo = oooOo00.get(OooOOOO.OooO0O0(resources, i, string, i3, i2));
            if (typefaceOooO0Oo != null) {
                ...
                try {
                    if (string.toLowerCase().endsWith(".xml")) {
                        ...
                        typefaceOooO0Oo = OooOOOO.f33484OooO00o.OooO0Oo(context, resources, i, string, i2);
                        if (typefaceOooO0Oo != null) {
                            oooOo00.put(OooOOOO.OooO0O0(resources, i, string, i4, i2), typefaceOooO0Oo);
                        }
                        if (oooO != null) {
                            if (typefaceOooO0Oo != null) {
                                oooO.OooO0O0(typefaceOooO0Oo);
