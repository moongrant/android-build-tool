...
public final class o00000O implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
    ...
    public final View f5429OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final Runnable f5430OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public ViewTreeObserver f5431OooO0o0;

    public o00000O(View view, Runnable runnable) {
        this.f5429OooO0Oo = view;
        this.f5431OooO0o0 = view.getViewTreeObserver();
        this.f5430OooO0o = runnable;
    }
    ...
    public final boolean onPreDraw() {
        boolean zIsAlive = this.f5431OooO0o0.isAlive();
        View view = this.f5429OooO0Oo;
        if (zIsAlive) {
            this.f5431OooO0o0.removeOnPreDrawListener(this);
        } else {
            view.getViewTreeObserver().removeOnPreDrawListener(this);
        }
        view.removeOnAttachStateChangeListener(this);
        this.f5430OooO0o.run();
        return true;
    }
