...
public final class o000O00 {
    ...
    public static final Method f5447OooO00o;
    ...
    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f5447OooO00o = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", new Class[0]);
    ...
    public static float OooO00o(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f5447OooO00o) != null) {
            try {
