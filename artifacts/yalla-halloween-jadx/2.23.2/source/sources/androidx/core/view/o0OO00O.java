...
public final class o0OO00O {
    ...
    public ViewParent f5463OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public ViewParent f5464OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final View f5465OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public boolean f5466OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public int[] f5467OooO0o0;

    public o0OO00O(@NonNull View view) {
        this.f5465OooO0OO = view;
    }

    public final void OooO(boolean z) {
        if (this.f5466OooO0Oo) {
            WeakHashMap<View, o000OOo0> weakHashMap = ViewCompat.f5341OooO00o;
            ViewCompat.OooOOO.OooOoO(this.f5465OooO0OO);
        }
        this.f5466OooO0Oo = z;
    }
    ...
    public final boolean OooO00o(float f, float f2, boolean z) {
        ...
        if (!this.f5466OooO0Oo || (viewParentOooO0oO = OooO0oO(0)) == null) {
            return false;
        }
        try {
            return o000O0O0.OooO00o(viewParentOooO0oO, this.f5465OooO0OO, f, f2, z);
    ...
    public final boolean OooO0O0(float f, float f2) {
        ...
        try {
            return o000O0O0.OooO0O0(viewParentOooO0oO, this.f5465OooO0OO, f, f2);
        } catch (AbstractMethodError e) {
    ...
    public final boolean OooO0OO(int i, int i2, @Nullable int[] iArr, @Nullable int[] iArr2, int i3) {
        ...
        int i5;
        int[] iArr3;
        if (!this.f5466OooO0Oo || (viewParentOooO0oO = OooO0oO(i3)) == null) {
            return false;
        }
        if (i == 0 && i2 == 0) {
            if (iArr2 == null) {
        ...
        if (iArr == null) {
            if (this.f5467OooO0o0 == null) {
                this.f5467OooO0o0 = new int[2];
            }
            iArr3 = this.f5467OooO0o0;
        } else {
            iArr3 = iArr;
        }
        iArr3[0] = 0;
        iArr3[1] = 0;
        View view2 = this.f5465OooO0OO;
        if (viewParentOooO0oO instanceof oo0o0Oo) {
            ((oo0o0Oo) viewParentOooO0oO).onNestedPreScroll(view2, i, i2, iArr3, i3);
        } else if (i3 == 0) {
            try {
                o000O0O0.OooO0OO(viewParentOooO0oO, view2, i, i2, iArr3);
            } catch (AbstractMethodError e) {
    ...
    public final boolean OooO0o(int i, int i2, int i3, int i4, @Nullable int[] iArr, int i5, @Nullable int[] iArr2) {
        ...
        int i7;
        int[] iArr3;
        if (!this.f5466OooO0Oo || (viewParentOooO0oO = OooO0oO(i5)) == null) {
            return false;
        }
        ...
        if (viewParentOooO0oO instanceof o0O0O00) {
            ...
            if (viewParentOooO0oO instanceof oo0o0Oo) {
                ...
                try {
                    o000O0O0.OooO0Oo(viewParentOooO0oO, view2, i, i2, i3, i4);
                } catch (AbstractMethodError e) {
    ...
    public final ViewParent OooO0oO(int i) {
        if (i == 0) {
            return this.f5463OooO00o;
        }
        if (i != 1) {
            return null;
        }
        return this.f5464OooO0O0;
    }
        ...
        if (this.f5466OooO0Oo) {
            ...
            for (ViewParent parent = view.getParent(); parent != null; parent = parent.getParent()) {
                ...
                if (z) {
                    ...
                    try {
                        zOooO0o = o000O0O0.OooO0o(parent, view2, view, i);
                    } catch (AbstractMethodError e) {
                ...
                if (zOooO0o) {
                    if (i2 == 0) {
                        this.f5463OooO00o = parent;
                    } else if (i2 == 1) {
                        this.f5464OooO0O0 = parent;
                    }
                    if (z) {
                        ((oo0o0Oo) parent).onNestedScrollAccepted(view2, view, i, i2);
                    } else if (i2 == 0) {
                        try {
                            o000O0O0.OooO0o0(parent, view2, view, i);
