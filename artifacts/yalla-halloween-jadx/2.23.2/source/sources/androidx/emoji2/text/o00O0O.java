...
public final class o00O0O extends SpannableStringBuilder {
    ...
    @NonNull
    public final Class<?> f5666OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @NonNull
    public final ArrayList f5667OooO0o0;

    public static class OooO00o implements TextWatcher, SpanWatcher {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final Object f5668OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final AtomicInteger f5669OooO0o0 = new AtomicInteger(0);

        public OooO00o(Object obj) {
            this.f5668OooO0Oo = obj;
        }

        @Override // android.text.TextWatcher
        public final void afterTextChanged(Editable editable) {
            ((TextWatcher) this.f5668OooO0Oo).afterTextChanged(editable);
        }

        @Override // android.text.TextWatcher
        public final void beforeTextChanged(CharSequence charSequence, int i, int i2, int i3) {
            ((TextWatcher) this.f5668OooO0Oo).beforeTextChanged(charSequence, i, i2, i3);
        }

        @Override // android.text.SpanWatcher
        public final void onSpanAdded(Spannable spannable, Object obj, int i, int i2) {
            if (this.f5669OooO0o0.get() <= 0 || !(obj instanceof OooOo)) {
                ((SpanWatcher) this.f5668OooO0Oo).onSpanAdded(spannable, obj, i, i2);
            }
        }
        ...
        public final void onSpanChanged(Spannable spannable, Object obj, int i, int i2, int i3, int i4) {
            ...
            if (this.f5669OooO0o0.get() <= 0 || !(obj instanceof OooOo)) {
                ...
                ((SpanWatcher) this.f5668OooO0Oo).onSpanChanged(spannable, obj, i5, i2, i6, i4);
            }
        }
        ...
        public final void onSpanRemoved(Spannable spannable, Object obj, int i, int i2) {
            if (this.f5669OooO0o0.get() <= 0 || !(obj instanceof OooOo)) {
                ((SpanWatcher) this.f5668OooO0Oo).onSpanRemoved(spannable, obj, i, i2);
            }
        }

        @Override // android.text.TextWatcher
        public final void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
            ((TextWatcher) this.f5668OooO0Oo).onTextChanged(charSequence, i, i2, i3);
        }
    }
    ...
    public o00O0O(@NonNull CharSequence charSequence, @NonNull Class cls) {
        super(charSequence);
        this.f5667OooO0o0 = new ArrayList();
        o000OO.OooOOO0.OooO0o0(cls, "watcherClass cannot be null");
        this.f5666OooO0Oo = cls;
    }

    public final void OooO00o() {
        int i = 0;
        while (true) {
            ArrayList arrayList = this.f5667OooO0o0;
            if (i >= arrayList.size()) {
                return;
            }
            ((OooO00o) arrayList.get(i)).f5669OooO0o0.incrementAndGet();
            i++;
        }
    }
    ...
    public final boolean OooO0Oo(@Nullable Object obj) {
        if (obj != null) {
            return this.f5666OooO0Oo == obj.getClass();
        }
        return false;
    }
    ...
    public final void OooO0o0() {
        ...
        while (true) {
            ...
            ((OooO00o) arrayList.get(i)).f5669OooO0o0.decrementAndGet();
            i++;
        }
    }
    ...
    public final <T> T[] getSpans(int i, int i2, @NonNull Class<T> cls) {
        ...
        for (int i3 = 0; i3 < oooO00oArr.length; i3++) {
            tArr[i3] = oooO00oArr[i3].f5668OooO0Oo;
        }
        return tArr;
    }
    ...
    public final void removeSpan(@Nullable Object obj) {
        ...
        if (oooO00oOooO0OO != null) {
            this.f5667OooO0o0.remove(oooO00oOooO0OO);
        }
    }
    ...
    public final CharSequence subSequence(int i, int i2) {
        return new o00O0O(this.f5666OooO0Oo, this, i, i2);
    }
