...
public final class FragmentContainerView extends FrameLayout {
    ...
    @NotNull
    public final ArrayList f5812OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @Nullable
    public View.OnApplyWindowInsetsListener f5813OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @NotNull
    public final ArrayList f5814OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public boolean f5815OooO0oO;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FragmentContainerView(@NotNull Context context) {
        super(context);
        Intrinsics.checkNotNullParameter(context, "context");
        this.f5812OooO0Oo = new ArrayList();
        this.f5814OooO0o0 = new ArrayList();
        this.f5815OooO0oO = true;
    }

    public final void OooO00o(View view) {
        if (this.f5814OooO0o0.contains(view)) {
            this.f5812OooO0Oo.add(view);
        }
    }
    ...
    public final WindowInsets dispatchApplyWindowInsets(@NotNull WindowInsets insets) {
        ...
        View.OnApplyWindowInsetsListener onApplyWindowInsetsListener = this.f5813OooO0o;
    ...
    public final void dispatchDraw(@NotNull Canvas canvas) {
        ...
        if (this.f5815OooO0oO) {
            Iterator it = this.f5812OooO0Oo.iterator();
            while (it.hasNext()) {
    ...
    public final boolean drawChild(@NotNull Canvas canvas, @NotNull View child, long j) {
        ...
        Intrinsics.checkNotNullParameter(child, "child");
        if (this.f5815OooO0oO) {
            ArrayList arrayList = this.f5812OooO0Oo;
    ...
    public final void endViewTransition(@NotNull View view) {
        ...
        this.f5814OooO0o0.remove(view);
        if (this.f5812OooO0Oo.remove(view)) {
            this.f5815OooO0oO = true;
        }
    ...
    public final void setDrawDisappearingViewsLast(boolean drawDisappearingViewsFirst) {
        this.f5815OooO0oO = drawDisappearingViewsFirst;
    }
    ...
    public FragmentContainerView(@NotNull Context context, @NotNull AttributeSet attrs, @NotNull FragmentManager fm) {
        ...
        if (classAttribute != null && fragmentOooOoo0 == null) {
            if (id == -1) {
                throw new IllegalStateException(p004OooO0oO.o000oOoO.OooO0O0("FragmentContainerView must have an android:id to add Fragment ", classAttribute, string != null ? " with tag ".concat(string) : ""));
            }
            o0OOO0o o0ooo0oOooo000 = fm.Oooo000();
            context.getClassLoader();
            Fragment fragmentInstantiate = Fragment.instantiate(FragmentManager.this.f5836OooOo0.f6054OooO0o0, classAttribute, null);
        ...
        for (o0000 o0000Var : fm.f5819OooO0OO.OooO0Oo()) {
