...
public class Oooo0 extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    public class OooO extends o00oO0o {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ o00oO0o f5936OooO0Oo;

        public OooO(o00oO0o o00oo0o2) {
            this.f5936OooO0Oo = o00oo0o2;
        }

        @Override // androidx.fragment.app.o00oO0o
        @Nullable
        public final View OooO0O0(int i) {
            o00oO0o o00oo0o2 = this.f5936OooO0Oo;
            return o00oo0o2.OooO0OO() ? o00oo0o2.OooO0O0(i) : Oooo0.this.onFindViewById(i);
        }

        @Override // androidx.fragment.app.o00oO0o
        public final boolean OooO0OO() {
            return this.f5936OooO0Oo.OooO0OO() || Oooo0.this.onHasView();
        }
    }
    ...
    public class OooO00o implements Runnable {
        ...
        public final void run() {
            ...
            oooo0.mOnDismissListener.onDismiss(oooo0.mDialog);
        }
    }
    ...
    public class OooO0O0 implements DialogInterface.OnCancelListener {
        ...
        public final void onCancel(@Nullable DialogInterface dialogInterface) {
            Oooo0 oooo0 = Oooo0.this;
            if (oooo0.mDialog != null) {
                oooo0.onCancel(oooo0.mDialog);
            }
        }
    }
    ...
    public class OooO0o implements Observer<LifecycleOwner> {
        ...
        public final void onChanged(LifecycleOwner lifecycleOwner) {
            if (lifecycleOwner != null) {
                Oooo0 oooo0 = Oooo0.this;
                if (oooo0.mShowsDialog) {
                    View viewRequireView = oooo0.requireView();
                    if (viewRequireView.getParent() != null) {
                        throw new IllegalStateException("DialogFragment can not be attached to a container view");
                    }
                    if (oooo0.mDialog != null) {
                        if (FragmentManager.Oooo0O0(3)) {
                            Log.d("FragmentManager", "DialogFragment " + this + " setting the content view on " + oooo0.mDialog);
                        }
                        oooo0.mDialog.setContentView(viewRequireView);
                    }
                }
            }
        }
    ...
    private void dismissInternal(boolean z, boolean z2, boolean z3) {
        ...
        if (z3) {
            ...
            parentFragmentManager2.OoooO0(i, 1);
        } else {
            ...
            parentFragmentManager3.OooOo0O(parentFragmentManager3.new Oooo000(i2), z);
        }
        this.mBackStackId = -1;
    }
    ...
    public Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        return new androidx.activity.OooOo(requireContext(), getTheme());
    }
    ...
    public void onStart() {
        ...
        if (dialog != null) {
            ...
            o00O0000.OooO.OooO0O0(decorView, this);
        }
    }
    ...
    @NonNull
    public final androidx.activity.OooOo requireComponentDialog() {
        Dialog dialogRequireDialog = requireDialog();
        if (dialogRequireDialog instanceof androidx.activity.OooOo) {
            return (androidx.activity.OooOo) dialogRequireDialog;
        }
    ...
    public int show(@NonNull o0000oo o0000ooVar, @Nullable String str) {
        this.mDismissed = false;
        this.mShownByMe = true;
        o0000ooVar.OooO0OO(0, this, str, 1);
        this.mViewDestroyed = false;
        int iOooO0oO = ((androidx.fragment.app.OooO00o) o0000ooVar).OooO0oO(false);
        this.mBackStackId = iOooO0oO;
        return iOooO0oO;
    }

    public Oooo0(@LayoutRes int i) {
        super(i);
        this.mDismissRunnable = new OooO00o();
        this.mOnCancelListener = new OooO0O0();
        this.mOnDismissListener = new OooO0OO();
