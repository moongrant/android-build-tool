...
public final class FragmentStrictMode {
    ...
    @NotNull
    public static final OooO00o f6069OooO00o = OooO00o.f6070OooO0OO;
    ...
    public static final class OooO00o {
        ...
        @JvmField
        @NotNull
        public static final OooO00o f6070OooO0OO = new OooO00o(SetsKt.emptySet(), MapsKt.emptyMap());

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        @NotNull
        public final Set<Flag> f6071OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        @NotNull
        public final LinkedHashMap f6072OooO0O0;

        public OooO00o(@NotNull Set flags, @NotNull Map allowedViolations) {
            Intrinsics.checkNotNullParameter(flags, "flags");
            Intrinsics.checkNotNullParameter(allowedViolations, "allowedViolations");
            this.f6071OooO00o = flags;
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            for (Map.Entry entry : allowedViolations.entrySet()) {
                linkedHashMap.put((String) entry.getKey(), (Set) entry.getValue());
            }
            this.f6072OooO0O0 = linkedHashMap;
        }
    }
    ...
    public static void OooO0O0(OooO00o oooO00o, final Violation violation) {
        Fragment fragment = violation.f6073OooO0Oo;
        final String name = fragment.getClass().getName();
        Flag flag = Flag.PENALTY_LOG;
        Set<Flag> set = oooO00o.f6071OooO00o;
        if (set.contains(flag)) {
            Log.d("FragmentStrictMode", "Policy violation in ".concat(name), violation);
        }
        if (set.contains(Flag.PENALTY_DEATH)) {
            Runnable runnable = new Runnable() { // from class: o0000o.o00000O0
            ...
            Handler handler = fragment.getParentFragmentManager().f5836OooOo0.f6053OooO0o;
    ...
    public static void OooO0OO(Violation violation) {
        if (FragmentManager.Oooo0O0(3)) {
            Log.d("FragmentManager", "StrictMode violation in ".concat(violation.f6073OooO0Oo.getClass().getName()), violation);
        }
    }
    ...
    public static final void OooO0Oo(@NotNull Fragment fragment, @NotNull String previousFragmentId) {
        ...
        if (OooO00o2.f6071OooO00o.contains(Flag.DETECT_FRAGMENT_REUSE) && OooO0o0(OooO00o2, fragment.getClass(), FragmentReuseViolation.class)) {
            OooO0O0(OooO00o2, fragmentReuseViolation);
        }
    }

    public static boolean OooO0o0(OooO00o oooO00o, Class cls, Class cls2) {
        Set set = (Set) oooO00o.f6072OooO0O0.get(cls.getName());
        if (set == null) {
            return true;
        }
