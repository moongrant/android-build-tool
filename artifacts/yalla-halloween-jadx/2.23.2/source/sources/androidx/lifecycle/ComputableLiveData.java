...
public abstract class ComputableLiveData<T> {
    ...
    public ComputableLiveData(@NotNull Executor executor) {
        ...
        this.refreshRunnable = new Runnable() { // from class: androidx.lifecycle.OooO00o
            @Override // java.lang.Runnable
            public final void run() {
                ComputableLiveData.refreshRunnable$lambda$0(this.f6077OooO0Oo);
            }
        };
        this.invalidationRunnable = new Runnable() { // from class: androidx.lifecycle.OooO0O0
            @Override // java.lang.Runnable
            public final void run() {
                ComputableLiveData.invalidationRunnable$lambda$1(this.f6078OooO0Oo);
            }
        };
    }
