...
public final class DispatchQueue {
    ...
    public final void dispatchAndEnqueue(@NotNull CoroutineContext context, @NotNull final Runnable runnable) {
        ...
        if (immediate.isDispatchNeeded(context) || canRun()) {
            immediate.mo5778dispatch(context, new Runnable() { // from class: androidx.lifecycle.OooO0o
                @Override // java.lang.Runnable
                public final void run() {
                    DispatchQueue.dispatchAndEnqueue$lambda$2$lambda$1(this.f6079OooO0Oo, runnable);
                }
            });
        } else {
            enqueue(runnable);
