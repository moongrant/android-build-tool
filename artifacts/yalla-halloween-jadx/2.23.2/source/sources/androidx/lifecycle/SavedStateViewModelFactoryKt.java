...
public final class SavedStateViewModelFactoryKt {
    ...
    public static final <T extends ViewModel> T newInstance(@NotNull Class<T> modelClass, @NotNull Constructor<T> constructor, @NotNull Object... params) {
        ...
        try {
            ...
            throw new RuntimeException(androidx.compose.compiler.plugins.kotlin.k1.OooO00o.OooO00o("Failed to access ", modelClass), e);
        } catch (InstantiationException e2) {
            throw new RuntimeException("A " + modelClass + " cannot be instantiated.", e2);
        } catch (InvocationTargetException e3) {
            throw new RuntimeException(androidx.compose.compiler.plugins.kotlin.k1.OooO00o.OooO00o("An exception happened in constructor of ", modelClass), e3.getCause());
        }
    }
}
