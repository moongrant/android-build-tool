...
public final class OooO implements Runnable {
    ...
    public final /* synthetic */ ResultReceiver f6125OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ String f6126OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final /* synthetic */ MediaBrowserServiceCompat.OooOOO f6127OooO0oO;
    ...
    public OooO(MediaBrowserServiceCompat.OooOOO oooOOO, MediaBrowserServiceCompat.OooOo00 oooOo00, String str, ResultReceiver resultReceiver) {
        this.f6127OooO0oO = oooOOO;
        this.f6124OooO0Oo = oooOo00;
        this.f6126OooO0o0 = str;
        this.f6125OooO0o = resultReceiver;
    }

    @Override // java.lang.Runnable
    public final void run() {
        IBinder iBinderOooO00o = ((MediaBrowserServiceCompat.OooOo00) this.f6124OooO0Oo).OooO00o();
        MediaBrowserServiceCompat.OooOOO oooOOO = this.f6127OooO0oO;
        if (MediaBrowserServiceCompat.this.f6099OooO0oO.getOrDefault(iBinderOooO00o, null) == null) {
            Log.w("MBServiceCompat", "getMediaItem for callback that isn't registered id=" + this.f6126OooO0o0);
            return;
        }
        MediaBrowserServiceCompat.this.getClass();
        int i = 2 & 2;
        ResultReceiver resultReceiver = this.f6125OooO0o;
        if (i != 0) {
