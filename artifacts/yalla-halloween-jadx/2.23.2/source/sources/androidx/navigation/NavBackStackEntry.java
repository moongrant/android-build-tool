...
public final class NavBackStackEntry implements LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, o00O0000.OooO0o {
    ...
    @Nullable
    private final oo00o viewModelStoreProvider;
    ...
    public static final class OooO extends Lambda implements Function0<SavedStateHandle> {
        ...
        public final SavedStateHandle invoke() {
            ...
            if (navBackStackEntry.getLifecycle().getState() != Lifecycle.State.DESTROYED) {
                return ((OooO0OO) new ViewModelProvider(navBackStackEntry, new OooO0O0(navBackStackEntry)).get(OooO0OO.class)).f9902OooO00o;
            }
    ...
    public static final class Companion {
        ...
        @NotNull
        public static NavBackStackEntry OooO00o(@Nullable Context context, @NotNull NavDestination destination, @Nullable Bundle bundle, @NotNull Lifecycle.State hostLifecycleState, @Nullable oo00o oo00oVar, @NotNull String id, @Nullable Bundle bundle2) {
            Intrinsics.checkNotNullParameter(destination, "destination");
            Intrinsics.checkNotNullParameter(hostLifecycleState, "hostLifecycleState");
            Intrinsics.checkNotNullParameter(id, "id");
            return new NavBackStackEntry(context, destination, bundle, hostLifecycleState, oo00oVar, id, bundle2, null);
        }

        public static /* synthetic */ NavBackStackEntry OooO0O0(Companion companion, Context context, NavDestination navDestination, Bundle bundle, Lifecycle.State state, o000O0 o000o0) {
            String string = UUID.randomUUID().toString();
            Intrinsics.checkNotNullExpressionValue(string, "randomUUID().toString()");
            companion.getClass();
            return OooO00o(context, navDestination, bundle, state, o000o0, string, null);
        }
    }
    ...
    public static final class OooO0OO extends ViewModel {
        ...
        @NotNull
        public final SavedStateHandle f9902OooO00o;

        public OooO0OO(@NotNull SavedStateHandle handle) {
            Intrinsics.checkNotNullParameter(handle, "handle");
            this.f9902OooO00o = handle;
        }
    }
    ...
    public /* synthetic */ NavBackStackEntry(Context context, NavDestination navDestination, Bundle bundle, Lifecycle.State state, oo00o oo00oVar, String str, Bundle bundle2, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, navDestination, bundle, state, oo00oVar, str, bundle2);
    }
    ...
    public ViewModelStore getViewModelStore() {
        ...
        oo00o oo00oVar = this.viewModelStoreProvider;
        if (oo00oVar != null) {
            return oo00oVar.OooO00o(this.id);
        }
    ...
    private NavBackStackEntry(Context context, NavDestination navDestination, Bundle bundle, Lifecycle.State state, oo00o oo00oVar, String str, Bundle bundle2) {
        this.context = context;
        this.destination = navDestination;
        this.immutableArgs = bundle;
        this.hostLifecycleState = state;
        this.viewModelStoreProvider = oo00oVar;
        this.id = str;
    ...
    public /* synthetic */ NavBackStackEntry(Context context, NavDestination navDestination, Bundle bundle, Lifecycle.State state, oo00o oo00oVar, String str, Bundle bundle2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        String str2;
        Bundle bundle3 = (i & 4) != 0 ? null : bundle;
        Lifecycle.State state2 = (i & 8) != 0 ? Lifecycle.State.CREATED : state;
        oo00o oo00oVar2 = (i & 16) != 0 ? null : oo00oVar;
        if ((i & 32) != 0) {
            String string = UUID.randomUUID().toString();
            Intrinsics.checkNotNullExpressionValue(string, "randomUUID().toString()");
            str2 = string;
        ...
        this(context, navDestination, bundle3, state2, oo00oVar2, str2, (i & 64) != 0 ? null : bundle2);
    }
