...
public final class OooOOOO {
    ...
    @NotNull
    public static final LinkedHashMap f10009OooO0O0 = new LinkedHashMap();

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    @NotNull
    public final LinkedHashMap f10010OooO00o = new LinkedHashMap();
    ...
    public final <T extends Navigator<?>> T OooO0O0(@NotNull String name) {
        ...
        T t = (T) this.f10010OooO00o.get(name);
        if (t != null) {
            return t;
        }
        throw new IllegalStateException(o000oOoO.OooO0O0("Could not find Navigator with name \"", name, "\". You must call NavController.addNavigator() for each navigation type."));
    }
}
