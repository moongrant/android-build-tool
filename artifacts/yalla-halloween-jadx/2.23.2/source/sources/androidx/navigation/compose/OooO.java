...
public final class OooO extends Navigator<OooO00o> {
    ...
    @NotNull
    public final MutableState<Boolean> f10092OooO0OO = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Boolean.FALSE, null, 2, null);
    ...
    public static final class OooO00o extends NavDestination {
        ...
        @Nullable
        public Function1<AnimatedContentTransitionScope<NavBackStackEntry>, EnterTransition> f10093OooOOO;

        /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
        @NotNull
        public final Function4<AnimatedContentScope, NavBackStackEntry, Composer, Integer, Unit> f10094OooOOO0;

        /* JADX INFO: renamed from: OooOOOO, reason: collision with root package name */
        @Nullable
        public Function1<AnimatedContentTransitionScope<NavBackStackEntry>, ExitTransition> f10095OooOOOO;

        /* JADX INFO: renamed from: OooOOOo, reason: collision with root package name */
        @Nullable
        public Function1<AnimatedContentTransitionScope<NavBackStackEntry>, EnterTransition> f10096OooOOOo;

        /* JADX INFO: renamed from: OooOOo0, reason: collision with root package name */
        @Nullable
        public Function1<AnimatedContentTransitionScope<NavBackStackEntry>, ExitTransition> f10097OooOOo0;

        public OooO00o(@NotNull OooO oooO, @NotNull ComposableLambda composableLambda) {
            super(oooO);
            this.f10094OooOOO0 = composableLambda;
        }
    }

    @Override // androidx.navigation.Navigator
    public final NavDestination OooO00o() {
        return new OooO00o(this, OooO0O0.f10100OooO00o);
    }
    ...
    public final void OooO0Oo(@NotNull List<NavBackStackEntry> list, @Nullable androidx.navigation.OooOOO0 oooOOO0, @Nullable Navigator.OooO00o oooO00o) {
        ...
        for (NavBackStackEntry backStackEntry : list) {
            o00O0O00 o00o0o00OooO0O0 = OooO0O0();
            Intrinsics.checkNotNullParameter(backStackEntry, "backStackEntry");
            MutableStateFlow<Set<NavBackStackEntry>> mutableStateFlow = o00o0o00OooO0O0.f35765OooO0OO;
            ...
            StateFlow<List<NavBackStackEntry>> stateFlow = o00o0o00OooO0O0.f35768OooO0o0;
            if (z) {
            ...
            o00o0o00OooO0O0.OooO0o0(backStackEntry);
        }
        this.f10092OooO0OO.setValue(Boolean.FALSE);
    }

    @Override // androidx.navigation.Navigator
    public final void OooO0o0(@NotNull NavBackStackEntry navBackStackEntry, boolean z) {
        OooO0O0().OooO0Oo(navBackStackEntry, z);
        this.f10092OooO0OO.setValue(Boolean.TRUE);
    }
}
