...
public final class OooOo {
    ...
    public static final class OooO00o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ SaveableStateHolder f10126OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f10127OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ Function2<Composer, Integer, Unit> f10128OooO0o0;
        ...
        public OooO00o(SaveableStateHolder saveableStateHolder, Function2<? super Composer, ? super Integer, Unit> function2, int i) {
            super(2);
            this.f10126OooO0Oo = saveableStateHolder;
            this.f10128OooO0o0 = function2;
            this.f10127OooO0o = i;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            ...
            if ((iIntValue & 11) == 2 && composer2.getSkipping()) {
                ...
                OooOo.OooO0O0(this.f10126OooO0Oo, this.f10128OooO0o0, composer2, ((this.f10127OooO0o >> 3) & 112) | 8);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public static final class OooO0O0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ NavBackStackEntry f10129OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ Function2<Composer, Integer, Unit> f10130OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ SaveableStateHolder f10131OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f10132OooO0oO;
        ...
        public OooO0O0(NavBackStackEntry navBackStackEntry, SaveableStateHolder saveableStateHolder, Function2<? super Composer, ? super Integer, Unit> function2, int i) {
            super(2);
            this.f10129OooO0Oo = navBackStackEntry;
            this.f10131OooO0o0 = saveableStateHolder;
            this.f10130OooO0o = function2;
            this.f10132OooO0oO = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f10132OooO0oO | 1);
            SaveableStateHolder saveableStateHolder = this.f10131OooO0o0;
            Function2<Composer, Integer, Unit> function2 = this.f10130OooO0o;
            OooOo.OooO00o(this.f10129OooO0Oo, saveableStateHolder, function2, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final void OooO0O0(SaveableStateHolder saveableStateHolder, Function2 function2, Composer composer, int i) {
        ...
        oooO00o.f10099OooO0O0 = new WeakReference<>(saveableStateHolder);
        saveableStateHolder.SaveableStateProvider(oooO00o.f10098OooO00o, function2, composerStartRestartGroup, (i & 112) | 520);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ScopeUpdateScope scopeUpdateScopeEndRestartGroup = composerStartRestartGroup.endRestartGroup();
