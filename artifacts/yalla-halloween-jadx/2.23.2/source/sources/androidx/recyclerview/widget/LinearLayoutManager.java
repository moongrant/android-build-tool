...
public class LinearLayoutManager extends RecyclerView.Oooo000 implements o00O0O.OooOO0O, RecyclerView.o0ooOOo.OooO0O0 {
    ...
    public static class OooO00o {
        ...
        public o000OOo f10550OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public int f10551OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public int f10552OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public boolean f10553OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public boolean f10554OooO0o0;
        ...
        public final void OooO00o() {
            this.f10552OooO0OO = this.f10553OooO0Oo ? this.f10550OooO00o.OooO0oO() : this.f10550OooO00o.OooOO0O();
        }

        public final void OooO0O0(int i, View view) {
            if (this.f10553OooO0Oo) {
                this.f10552OooO0OO = this.f10550OooO00o.OooOOO0() + this.f10550OooO00o.OooO0O0(view);
            } else {
                this.f10552OooO0OO = this.f10550OooO00o.OooO0o0(view);
            }
            this.f10551OooO0O0 = i;
        }

        public final void OooO0OO(int i, View view) {
            int iOooOOO0 = this.f10550OooO00o.OooOOO0();
            if (iOooOOO0 >= 0) {
                OooO0O0(i, view);
                return;
            }
            this.f10551OooO0O0 = i;
            if (!this.f10553OooO0Oo) {
                int iOooO0o0 = this.f10550OooO00o.OooO0o0(view);
                int iOooOO0O = iOooO0o0 - this.f10550OooO00o.OooOO0O();
                this.f10552OooO0OO = iOooO0o0;
                if (iOooOO0O > 0) {
                    int iOooO0oO = (this.f10550OooO00o.OooO0oO() - Math.min(0, (this.f10550OooO00o.OooO0oO() - iOooOOO0) - this.f10550OooO00o.OooO0O0(view))) - (this.f10550OooO00o.OooO0OO(view) + iOooO0o0);
                    if (iOooO0oO < 0) {
                        this.f10552OooO0OO -= Math.min(iOooOO0O, -iOooO0oO);
                        return;
                    }
                    return;
                }
            ...
            int iOooO0oO2 = (this.f10550OooO00o.OooO0oO() - iOooOOO0) - this.f10550OooO00o.OooO0O0(view);
            this.f10552OooO0OO = this.f10550OooO00o.OooO0oO() - iOooO0oO2;
            if (iOooO0oO2 > 0) {
                int iOooO0OO = this.f10552OooO0OO - this.f10550OooO00o.OooO0OO(view);
                int iOooOO0O2 = this.f10550OooO00o.OooOO0O();
                int iMin = iOooO0OO - (Math.min(this.f10550OooO00o.OooO0o0(view) - iOooOO0O2, 0) + iOooOO0O2);
                if (iMin < 0) {
                    this.f10552OooO0OO = Math.min(iOooO0oO2, -iMin) + this.f10552OooO0OO;
                }
            }
        }

        public final void OooO0Oo() {
            this.f10551OooO0O0 = -1;
            this.f10552OooO0OO = Integer.MIN_VALUE;
            this.f10553OooO0Oo = false;
            this.f10554OooO0o0 = false;
        }

        public final String toString() {
            StringBuilder sb = new StringBuilder("AnchorInfo{mPosition=");
            sb.append(this.f10551OooO0O0);
            sb.append(", mCoordinate=");
            sb.append(this.f10552OooO0OO);
            sb.append(", mLayoutFromEnd=");
            sb.append(this.f10553OooO0Oo);
            sb.append(", mValid=");
            return androidx.compose.animation.OooO0o.OooO00o(sb, this.f10554OooO0o0, '}');
        }
    }
    ...
    public static class OooO0O0 {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public int f10555OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public boolean f10556OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public boolean f10557OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public boolean f10558OooO0Oo;
    }

    public static class OooO0OO {

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public int f10561OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public int f10562OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f10563OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f10564OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public int f10565OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public int f10566OooO0oO;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public int f10568OooOO0;

        /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
        public boolean f10570OooOO0o;

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public boolean f10560OooO00o = true;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public int f10567OooO0oo = 0;

        /* JADX INFO: renamed from: OooO, reason: collision with root package name */
        public int f10559OooO = 0;

        /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
        public List<RecyclerView.o0O0O00> f10569OooOO0O = null;

        public final void OooO00o(View view) {
            int iOooO00o;
            int size = this.f10569OooOO0O.size();
            View view2 = null;
            int i = Integer.MAX_VALUE;
            for (int i2 = 0; i2 < size; i2++) {
                View view3 = this.f10569OooOO0O.get(i2).itemView;
                RecyclerView.LayoutParams layoutParams = (RecyclerView.LayoutParams) view3.getLayoutParams();
                if (view3 != view && !layoutParams.OooO0OO() && (iOooO00o = (layoutParams.OooO00o() - this.f10563OooO0Oo) * this.f10565OooO0o0) >= 0 && iOooO00o < i) {
                    view2 = view3;
                    if (iOooO00o == 0) {
                        break;
                    } else {
            ...
            if (view2 == null) {
                this.f10563OooO0Oo = -1;
            } else {
                this.f10563OooO0Oo = ((RecyclerView.LayoutParams) view2.getLayoutParams()).OooO00o();
            }
        }

        public final View OooO0O0(RecyclerView.o00Ooo o00ooo2) {
            List<RecyclerView.o0O0O00> list = this.f10569OooOO0O;
            if (list == null) {
                View viewOooO0Oo = o00ooo2.OooO0Oo(this.f10563OooO0Oo);
                this.f10563OooO0Oo += this.f10565OooO0o0;
                return viewOooO0Oo;
            }
            int size = list.size();
            for (int i = 0; i < size; i++) {
                View view = this.f10569OooOO0O.get(i).itemView;
                RecyclerView.LayoutParams layoutParams = (RecyclerView.LayoutParams) view.getLayoutParams();
                if (!layoutParams.OooO0OO() && this.f10563OooO0Oo == layoutParams.OooO00o()) {
                    OooO00o(view);
                    return view;
                }
            }
    ...
    public static class SavedState implements Parcelable {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f10571OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public boolean f10572OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public int f10573OooO0o0;
        ...
        public final void writeToParcel(Parcel parcel, int i) {
            parcel.writeInt(this.f10571OooO0Oo);
            parcel.writeInt(this.f10573OooO0o0);
            parcel.writeInt(this.f10572OooO0o ? 1 : 0);
        }

        public SavedState(Parcel parcel) {
            this.f10571OooO0Oo = parcel.readInt();
            this.f10573OooO0o0 = parcel.readInt();
            this.f10572OooO0o = parcel.readInt() == 1;
        }

        @SuppressLint({"UnknownNullness"})
        public SavedState(SavedState savedState) {
            this.f10571OooO0Oo = savedState.f10571OooO0Oo;
            this.f10573OooO0o0 = savedState.f10573OooO0o0;
            this.f10572OooO0o = savedState.f10572OooO0o;
        }
    }
    ...
    private int computeScrollExtent(RecyclerView.o0OOO0o o0ooo0o2) {
        ...
        ensureLayoutState();
        return o00000.OooO00o(o0ooo0o2, this.mOrientationHelper, findFirstVisibleChildClosestToStart(!this.mSmoothScrollbarEnabled, true), findFirstVisibleChildClosestToEnd(!this.mSmoothScrollbarEnabled, true), this, this.mSmoothScrollbarEnabled);
    }
    ...
    private int computeScrollOffset(RecyclerView.o0OOO0o o0ooo0o2) {
        ...
        ensureLayoutState();
        return o00000.OooO0O0(o0ooo0o2, this.mOrientationHelper, findFirstVisibleChildClosestToStart(!this.mSmoothScrollbarEnabled, true), findFirstVisibleChildClosestToEnd(!this.mSmoothScrollbarEnabled, true), this, this.mSmoothScrollbarEnabled, this.mShouldReverseLayout);
    }
    ...
    private int computeScrollRange(RecyclerView.o0OOO0o o0ooo0o2) {
        ...
        ensureLayoutState();
        return o00000.OooO0OO(o0ooo0o2, this.mOrientationHelper, findFirstVisibleChildClosestToStart(!this.mSmoothScrollbarEnabled, true), findFirstVisibleChildClosestToEnd(!this.mSmoothScrollbarEnabled, true), this, this.mSmoothScrollbarEnabled);
    }
    ...
    private void layoutForPredictiveAnimations(RecyclerView.o00Ooo o00ooo2, RecyclerView.o0OOO0o o0ooo0o2, int i, int i2) {
        if (!o0ooo0o2.f10736OooOO0O || getChildCount() == 0 || o0ooo0o2.f10733OooO0oO || !supportsPredictiveItemAnimations()) {
            return;
        }
        List<RecyclerView.o0O0O00> list = o00ooo2.f10720OooO0Oo;
        int size = list.size();
        ...
        this.mLayoutState.f10569OooOO0O = list;
        if (iOooO0OO > 0) {
            updateLayoutStateToFillStart(getPosition(getChildClosestToStart()), i);
            OooO0OO oooO0OO = this.mLayoutState;
            oooO0OO.f10567OooO0oo = iOooO0OO;
            oooO0OO.f10562OooO0OO = 0;
        ...
        if (iOooO0OO2 > 0) {
            ...
            oooO0OO2.f10567OooO0oo = iOooO0OO2;
            oooO0OO2.f10562OooO0OO = 0;
            oooO0OO2.OooO00o(null);
            fill(o00ooo2, this.mLayoutState, o0ooo0o2, false);
        }
        this.mLayoutState.f10569OooOO0O = null;
    }
    ...
    private void recycleByLayoutState(RecyclerView.o00Ooo o00ooo2, OooO0OO oooO0OO) {
        if (!oooO0OO.f10560OooO00o || oooO0OO.f10570OooOO0o) {
            return;
        }
        int i = oooO0OO.f10566OooO0oO;
        int i2 = oooO0OO.f10559OooO;
    ...
    private boolean updateAnchorFromChildren(RecyclerView.o00Ooo o00ooo2, RecyclerView.o0OOO0o o0ooo0o2, OooO00o oooO00o) {
        ...
        if (z2 != z3 || (viewFindReferenceChild = findReferenceChild(o00ooo2, o0ooo0o2, oooO00o.f10553OooO0Oo, z3)) == null) {
            return false;
        }
        ...
        if (!o0ooo0o2.f10733OooO0oO && supportsPredictiveItemAnimations()) {
            ...
            if (z4 || z) {
                if (oooO00o.f10553OooO0Oo) {
                    iOooOO0O = iOooO0oO;
                }
                oooO00o.f10552OooO0OO = iOooOO0O;
            }
        }
        return true;
    }
    ...
    private boolean updateAnchorFromPendingData(RecyclerView.o0OOO0o o0ooo0o2, OooO00o oooO00o) {
        int i;
        if (!o0ooo0o2.f10733OooO0oO && (i = this.mPendingScrollPosition) != -1) {
            if (i >= 0 && i < o0ooo0o2.OooO0O0()) {
                int i2 = this.mPendingScrollPosition;
                oooO00o.f10551OooO0O0 = i2;
                SavedState savedState = this.mPendingSavedState;
                if (savedState != null) {
                    if (savedState.f10571OooO0Oo >= 0) {
                        boolean z = savedState.f10572OooO0o;
                        oooO00o.f10553OooO0Oo = z;
                        if (z) {
                            oooO00o.f10552OooO0OO = this.mOrientationHelper.OooO0oO() - this.mPendingSavedState.f10573OooO0o0;
                        } else {
                            oooO00o.f10552OooO0OO = this.mOrientationHelper.OooOO0O() + this.mPendingSavedState.f10573OooO0o0;
                        }
                        return true;
                    }
                }
                if (this.mPendingScrollPositionOffset != Integer.MIN_VALUE) {
                    ...
                    oooO00o.f10553OooO0Oo = z2;
                    if (z2) {
                        oooO00o.f10552OooO0OO = this.mOrientationHelper.OooO0oO() - this.mPendingScrollPositionOffset;
                    } else {
                        oooO00o.f10552OooO0OO = this.mOrientationHelper.OooOO0O() + this.mPendingScrollPositionOffset;
                    }
                    return true;
                }
                ...
                if (viewFindViewByPosition == null) {
                    if (getChildCount() > 0) {
                        oooO00o.f10553OooO0Oo = (this.mPendingScrollPosition < getPosition(getChildAt(0))) == this.mShouldReverseLayout;
                    }
                    oooO00o.OooO00o();
                } else {
                    ...
                    if (this.mOrientationHelper.OooO0o0(viewFindViewByPosition) - this.mOrientationHelper.OooOO0O() < 0) {
                        oooO00o.f10552OooO0OO = this.mOrientationHelper.OooOO0O();
                        oooO00o.f10553OooO0Oo = false;
                        return true;
                    }
                    if (this.mOrientationHelper.OooO0oO() - this.mOrientationHelper.OooO0O0(viewFindViewByPosition) < 0) {
                        oooO00o.f10552OooO0OO = this.mOrientationHelper.OooO0oO();
                        oooO00o.f10553OooO0Oo = true;
                        return true;
                    }
                    oooO00o.f10552OooO0OO = oooO00o.f10553OooO0Oo ? this.mOrientationHelper.OooOOO0() + this.mOrientationHelper.OooO0O0(viewFindViewByPosition) : this.mOrientationHelper.OooO0o0(viewFindViewByPosition);
                }
                return true;
            }
    ...
    private void updateAnchorInfoForLayout(RecyclerView.o00Ooo o00ooo2, RecyclerView.o0OOO0o o0ooo0o2, OooO00o oooO00o) {
        ...
        oooO00o.OooO00o();
        oooO00o.f10551OooO0O0 = this.mStackFromEnd ? o0ooo0o2.OooO0O0() - 1 : 0;
    }

    private void updateLayoutState(int i, int i2, boolean z, RecyclerView.o0OOO0o o0ooo0o2) {
        int iOooOO0O;
        this.mLayoutState.f10570OooOO0o = resolveIsInfinite();
        this.mLayoutState.f10564OooO0o = i;
        ...
        oooO0OO.f10567OooO0oo = i3;
        if (!z2) {
            iMax = iMax2;
        }
        oooO0OO.f10559OooO = iMax;
        if (z2) {
            oooO0OO.f10567OooO0oo = this.mOrientationHelper.OooO0oo() + i3;
            View childClosestToEnd = getChildClosestToEnd();
            OooO0OO oooO0OO2 = this.mLayoutState;
            oooO0OO2.f10565OooO0o0 = this.mShouldReverseLayout ? -1 : 1;
            int position = getPosition(childClosestToEnd);
            OooO0OO oooO0OO3 = this.mLayoutState;
            oooO0OO2.f10563OooO0Oo = position + oooO0OO3.f10565OooO0o0;
            oooO0OO3.f10561OooO0O0 = this.mOrientationHelper.OooO0O0(childClosestToEnd);
            ...
            oooO0OO4.f10567OooO0oo = this.mOrientationHelper.OooOO0O() + oooO0OO4.f10567OooO0oo;
            OooO0OO oooO0OO5 = this.mLayoutState;
            oooO0OO5.f10565OooO0o0 = this.mShouldReverseLayout ? 1 : -1;
            int position2 = getPosition(childClosestToStart);
            OooO0OO oooO0OO6 = this.mLayoutState;
            oooO0OO5.f10563OooO0Oo = position2 + oooO0OO6.f10565OooO0o0;
            oooO0OO6.f10561OooO0O0 = this.mOrientationHelper.OooO0o0(childClosestToStart);
        ...
        oooO0OO7.f10562OooO0OO = i2;
        if (z) {
            oooO0OO7.f10562OooO0OO = i2 - iOooOO0O;
        }
        oooO0OO7.f10566OooO0oO = iOooOO0O;
    }

    private void updateLayoutStateToFillEnd(OooO00o oooO00o) {
        updateLayoutStateToFillEnd(oooO00o.f10551OooO0O0, oooO00o.f10552OooO0OO);
    }

    private void updateLayoutStateToFillStart(OooO00o oooO00o) {
        updateLayoutStateToFillStart(oooO00o.f10551OooO0O0, oooO00o.f10552OooO0OO);
    }
    ...
    public void calculateExtraLayoutSpace(@NonNull RecyclerView.o0OOO0o o0ooo0o2, @NonNull int[] iArr) {
        ...
        if (this.mLayoutState.f10564OooO0o == -1) {
            i = 0;
        } else {
            i = extraLayoutSpace;
            extraLayoutSpace = 0;
    ...
    public void collectInitialPrefetchPositions(int i, RecyclerView.Oooo000.OooO0OO oooO0OO) {
        ...
        if (savedState == null) {
            ...
            i2 = savedState.f10571OooO0Oo;
            if (i2 >= 0) {
                z = savedState.f10572OooO0o;
            } else {
                resolveShouldLayoutReverse();
                z = this.mShouldReverseLayout;
                i2 = this.mPendingScrollPosition;
        ...
        for (int i4 = 0; i4 < this.mInitialPrefetchItemCount && i2 >= 0 && i2 < i; i4++) {
            ((o0OoOo0.OooO0O0) oooO0OO).OooO00o(i2, 0);
            i2 += i3;
        }
    }
    ...
    public void collectPrefetchPositionsForLayoutState(RecyclerView.o0OOO0o o0ooo0o2, OooO0OO oooO0OO, RecyclerView.Oooo000.OooO0OO oooO0OO2) {
        int i = oooO0OO.f10563OooO0Oo;
        if (i < 0 || i >= o0ooo0o2.OooO0O0()) {
            return;
        }
        ((o0OoOo0.OooO0O0) oooO0OO2).OooO00o(i, Math.max(0, oooO0OO.f10566OooO0oO));
    }
    ...
    public int fill(RecyclerView.o00Ooo o00ooo2, OooO0OO oooO0OO, RecyclerView.o0OOO0o o0ooo0o2, boolean z) {
        int i = oooO0OO.f10562OooO0OO;
        int i2 = oooO0OO.f10566OooO0oO;
        if (i2 != Integer.MIN_VALUE) {
            if (i < 0) {
                oooO0OO.f10566OooO0oO = i2 + i;
            }
            recycleByLayoutState(o00ooo2, oooO0OO);
        }
        int i3 = oooO0OO.f10562OooO0OO + oooO0OO.f10567OooO0oo;
        OooO0O0 oooO0O0 = this.mLayoutChunkResult;
        while (true) {
            if (!oooO0OO.f10570OooOO0o && i3 <= 0) {
                break;
            }
            int i4 = oooO0OO.f10563OooO0Oo;
            if (!(i4 >= 0 && i4 < o0ooo0o2.OooO0O0())) {
                break;
            }
            oooO0O0.f10555OooO00o = 0;
            oooO0O0.f10556OooO0O0 = false;
            oooO0O0.f10557OooO0OO = false;
            oooO0O0.f10558OooO0Oo = false;
            layoutChunk(o00ooo2, o0ooo0o2, oooO0OO, oooO0O0);
            if (!oooO0O0.f10556OooO0O0) {
                int i5 = oooO0OO.f10561OooO0O0;
                int i6 = oooO0O0.f10555OooO00o;
                oooO0OO.f10561OooO0O0 = (oooO0OO.f10564OooO0o * i6) + i5;
                if (!oooO0O0.f10557OooO0OO || oooO0OO.f10569OooOO0O != null || !o0ooo0o2.f10733OooO0oO) {
                    oooO0OO.f10562OooO0OO -= i6;
                    i3 -= i6;
                }
                int i7 = oooO0OO.f10566OooO0oO;
                if (i7 != Integer.MIN_VALUE) {
                    int i8 = i7 + i6;
                    oooO0OO.f10566OooO0oO = i8;
                    int i9 = oooO0OO.f10562OooO0OO;
                    if (i9 < 0) {
                        oooO0OO.f10566OooO0oO = i8 + i9;
                    }
                    recycleByLayoutState(o00ooo2, oooO0OO);
                }
                if (z && oooO0O0.f10558OooO0Oo) {
                    break;
                }
            } else {
                break;
        ...
        return i - oooO0OO.f10562OooO0OO;
    }
    ...
    public void layoutChunk(RecyclerView.o00Ooo o00ooo2, RecyclerView.o0OOO0o o0ooo0o2, OooO0OO oooO0OO, OooO0O0 oooO0O0) {
        ...
        if (oooO0OO.f10569OooOO0O == null) {
            if (this.mShouldReverseLayout == (oooO0OO.f10564OooO0o == -1)) {
                addView(viewOooO0O0);
            } else {
        ...
        oooO0O0.f10555OooO00o = this.mOrientationHelper.OooO0OO(viewOooO0O0);
        if (this.mOrientation == 1) {
            ...
            if (oooO0OO.f10564OooO0o == -1) {
                int i4 = oooO0OO.f10561OooO0O0;
                i3 = i4;
                i2 = iOooO0Oo;
                i = i4 - oooO0O0.f10555OooO00o;
            } else {
                int i5 = oooO0OO.f10561OooO0O0;
                i = i5;
                i2 = iOooO0Oo;
                i3 = oooO0O0.f10555OooO00o + i5;
            }
        } else {
            int paddingTop = getPaddingTop();
            int iOooO0Oo2 = this.mOrientationHelper.OooO0Oo(viewOooO0O0) + paddingTop;
            if (oooO0OO.f10564OooO0o == -1) {
                int i6 = oooO0OO.f10561OooO0O0;
                i2 = i6;
                i = paddingTop;
                i3 = iOooO0Oo2;
                paddingLeft = i6 - oooO0O0.f10555OooO00o;
            } else {
                int i7 = oooO0OO.f10561OooO0O0;
                i = paddingTop;
                i2 = oooO0O0.f10555OooO00o + i7;
                i3 = iOooO0Oo2;
                paddingLeft = i7;
            }
        }
        ...
        oooO0O0.f10558OooO0Oo = viewOooO0O0.hasFocusable();
    }
    ...
    public View onFocusSearchFailed(View view, int i, RecyclerView.o00Ooo o00ooo2, RecyclerView.o0OOO0o o0ooo0o2) {
        ...
        OooO0OO oooO0OO = this.mLayoutState;
        oooO0OO.f10566OooO0oO = Integer.MIN_VALUE;
        oooO0OO.f10560OooO00o = false;
    ...
    public void onLayoutChildren(RecyclerView.o00Ooo o00ooo2, RecyclerView.o0OOO0o o0ooo0o2) {
        ...
        SavedState savedState = this.mPendingSavedState;
        if (savedState != null) {
            int i7 = savedState.f10571OooO0Oo;
            if (i7 >= 0) {
                this.mPendingScrollPosition = i7;
            }
        }
        ensureLayoutState();
        this.mLayoutState.f10560OooO00o = false;
        resolveShouldLayoutReverse();
        View focusedChild = getFocusedChild();
        OooO00o oooO00o = this.mAnchorInfo;
        if (!oooO00o.f10554OooO0o0 || this.mPendingScrollPosition != -1 || this.mPendingSavedState != null) {
            oooO00o.OooO0Oo();
            OooO00o oooO00o2 = this.mAnchorInfo;
            oooO00o2.f10553OooO0Oo = this.mShouldReverseLayout ^ this.mStackFromEnd;
            updateAnchorInfoForLayout(o00ooo2, o0ooo0o2, oooO00o2);
            this.mAnchorInfo.f10554OooO0o0 = true;
        ...
        OooO0OO oooO0OO = this.mLayoutState;
        oooO0OO.f10564OooO0o = oooO0OO.f10568OooOO0 >= 0 ? 1 : -1;
        int[] iArr = this.mReusableIntPair;
        iArr[0] = 0;
        iArr[1] = 0;
        calculateExtraLayoutSpace(o0ooo0o2, iArr);
        ...
        if (o0ooo0o2.f10733OooO0oO && (i5 = this.mPendingScrollPosition) != -1 && this.mPendingScrollPositionOffset != Integer.MIN_VALUE && (viewFindViewByPosition = findViewByPosition(i5)) != null) {
            if (this.mShouldReverseLayout) {
        ...
        if (!oooO00o3.f10553OooO0Oo ? !this.mShouldReverseLayout : this.mShouldReverseLayout) {
            i6 = 1;
        }
        ...
        this.mLayoutState.f10559OooO = 0;
        OooO00o oooO00o4 = this.mAnchorInfo;
        if (oooO00o4.f10553OooO0Oo) {
            updateLayoutStateToFillStart(oooO00o4);
            OooO0OO oooO0OO2 = this.mLayoutState;
            oooO0OO2.f10567OooO0oo = iOooOO0O;
            fill(o00ooo2, oooO0OO2, o0ooo0o2, false);
            OooO0OO oooO0OO3 = this.mLayoutState;
            i2 = oooO0OO3.f10561OooO0O0;
            int i9 = oooO0OO3.f10563OooO0Oo;
            int i10 = oooO0OO3.f10562OooO0OO;
            if (i10 > 0) {
                iOooO0oo += i10;
            }
            updateLayoutStateToFillEnd(this.mAnchorInfo);
            OooO0OO oooO0OO4 = this.mLayoutState;
            oooO0OO4.f10567OooO0oo = iOooO0oo;
            oooO0OO4.f10563OooO0Oo += oooO0OO4.f10565OooO0o0;
            fill(o00ooo2, oooO0OO4, o0ooo0o2, false);
            OooO0OO oooO0OO5 = this.mLayoutState;
            i = oooO0OO5.f10561OooO0O0;
            int i11 = oooO0OO5.f10562OooO0OO;
            if (i11 > 0) {
                updateLayoutStateToFillStart(i9, i2);
                OooO0OO oooO0OO6 = this.mLayoutState;
                oooO0OO6.f10567OooO0oo = i11;
                fill(o00ooo2, oooO0OO6, o0ooo0o2, false);
                i2 = this.mLayoutState.f10561OooO0O0;
            }
        } else {
            updateLayoutStateToFillEnd(oooO00o4);
            OooO0OO oooO0OO7 = this.mLayoutState;
            oooO0OO7.f10567OooO0oo = iOooO0oo;
            fill(o00ooo2, oooO0OO7, o0ooo0o2, false);
            OooO0OO oooO0OO8 = this.mLayoutState;
            int i12 = oooO0OO8.f10561OooO0O0;
            int i13 = oooO0OO8.f10563OooO0Oo;
            int i14 = oooO0OO8.f10562OooO0OO;
            if (i14 > 0) {
                iOooOO0O += i14;
            }
            updateLayoutStateToFillStart(this.mAnchorInfo);
            OooO0OO oooO0OO9 = this.mLayoutState;
            oooO0OO9.f10567OooO0oo = iOooOO0O;
            oooO0OO9.f10563OooO0Oo += oooO0OO9.f10565OooO0o0;
            fill(o00ooo2, oooO0OO9, o0ooo0o2, false);
            OooO0OO oooO0OO10 = this.mLayoutState;
            int i15 = oooO0OO10.f10561OooO0O0;
            int i16 = oooO0OO10.f10562OooO0OO;
            if (i16 > 0) {
                updateLayoutStateToFillEnd(i13, i12);
                OooO0OO oooO0OO11 = this.mLayoutState;
                oooO0OO11.f10567OooO0oo = i16;
                fill(o00ooo2, oooO0OO11, o0ooo0o2, false);
                i = this.mLayoutState.f10561OooO0O0;
            } else {
                i = i12;
            }
            i2 = i15;
        ...
        if (o0ooo0o2.f10733OooO0oO) {
            ...
            o000OOo o000ooo2 = this.mOrientationHelper;
            o000ooo2.f10844OooO0O0 = o000ooo2.OooOO0o();
        }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        if (getChildCount() > 0) {
            ...
            savedState2.f10572OooO0o = z;
            if (z) {
                View childClosestToEnd = getChildClosestToEnd();
                savedState2.f10573OooO0o0 = this.mOrientationHelper.OooO0oO() - this.mOrientationHelper.OooO0O0(childClosestToEnd);
                savedState2.f10571OooO0Oo = getPosition(childClosestToEnd);
            } else {
                View childClosestToStart = getChildClosestToStart();
                savedState2.f10571OooO0Oo = getPosition(childClosestToStart);
                savedState2.f10573OooO0o0 = this.mOrientationHelper.OooO0o0(childClosestToStart) - this.mOrientationHelper.OooOO0O();
            }
        } else {
            savedState2.f10571OooO0Oo = -1;
        }
        return savedState2;
    }

    @Override // androidx.recyclerview.widget.o00O0O.OooOO0O
    ...
    public int scrollBy(int i, RecyclerView.o00Ooo o00ooo2, RecyclerView.o0OOO0o o0ooo0o2) {
        ...
        ensureLayoutState();
        this.mLayoutState.f10560OooO00o = true;
        int i2 = i > 0 ? 1 : -1;
        int iAbs = Math.abs(i);
        updateLayoutState(i2, iAbs, true, o0ooo0o2);
        OooO0OO oooO0OO = this.mLayoutState;
        int iFill = fill(o00ooo2, oooO0OO, o0ooo0o2, false) + oooO0OO.f10566OooO0oO;
        if (iFill < 0) {
            return 0;
        }
        if (iAbs > iFill) {
        ...
        this.mLayoutState.f10568OooOO0 = i;
        return i;
    }
    ...
    public void setOrientation(int i) {
        ...
        if (i != this.mOrientation || this.mOrientationHelper == null) {
            o000OOo o000oooOooO00o = o000OOo.OooO00o(this, i);
            this.mOrientationHelper = o000oooOooO00o;
            this.mAnchorInfo.f10550OooO00o = o000oooOooO00o;
            this.mOrientation = i;
            requestLayout();
        }
    }
    ...
    private void updateLayoutStateToFillEnd(int i, int i2) {
        this.mLayoutState.f10562OooO0OO = this.mOrientationHelper.OooO0oO() - i2;
        OooO0OO oooO0OO = this.mLayoutState;
        oooO0OO.f10565OooO0o0 = this.mShouldReverseLayout ? -1 : 1;
        oooO0OO.f10563OooO0Oo = i;
        oooO0OO.f10564OooO0o = 1;
        oooO0OO.f10561OooO0O0 = i2;
        oooO0OO.f10566OooO0oO = Integer.MIN_VALUE;
    }

    private void updateLayoutStateToFillStart(int i, int i2) {
        this.mLayoutState.f10562OooO0OO = i2 - this.mOrientationHelper.OooOO0O();
        OooO0OO oooO0OO = this.mLayoutState;
        oooO0OO.f10563OooO0Oo = i;
        oooO0OO.f10565OooO0o0 = this.mShouldReverseLayout ? 1 : -1;
        oooO0OO.f10564OooO0o = -1;
    ...
    public LinearLayoutManager(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        setOrientation(properties.f10705OooO00o);
        setReverseLayout(properties.f10707OooO0OO);
        setStackFromEnd(properties.f10708OooO0Oo);
    }
}
