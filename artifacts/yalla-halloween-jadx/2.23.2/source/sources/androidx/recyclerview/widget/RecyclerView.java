...
import p108o000ooOO.o00O000;
import p108o000ooOO.o00O0000;
...
public class RecyclerView extends ViewGroup implements androidx.core.view.o0000Ooo, androidx.core.view.o0Oo0oo {
    ...
    o000000O mAccessibilityDelegate;
    ...
    androidx.recyclerview.widget.OooO mChildHelper;
    ...
    androidx.recyclerview.widget.o0OoOo0 mGapWorker;
    ...
    androidx.recyclerview.widget.o0OoOo0.OooO0O0 mPrefetchRegistry;
    ...
    private final o0000Ooo.OooO0O0 mViewInfoProcessCallback;
    final o0000Ooo mViewInfoStore;
    ...
    public static abstract class ItemAnimator {
        ...
        public OooO0O0 f10684OooO00o = null;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final ArrayList<OooO00o> f10685OooO0O0 = new ArrayList<>();

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public long f10686OooO0OO = 120;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public long f10687OooO0Oo = 120;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public long f10689OooO0o0 = 250;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public long f10688OooO0o = 250;
        ...
        public static class OooO0OO {
            ...
            /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
            public int f10690OooO00o;

            /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
            public int f10691OooO0O0;

            @NonNull
            public final void OooO00o(@NonNull o0O0O00 o0o0o00) {
                View view = o0o0o00.itemView;
                this.f10690OooO00o = view.getLeft();
                this.f10691OooO0O0 = view.getTop();
                view.getRight();
                view.getBottom();
            }
        }
        ...
        public final void OooO() {
            ArrayList<OooO00o> arrayList = this.f10685OooO0O0;
        ...
        public final void OooO0oo(@NonNull o0O0O00 o0o0o00) {
            OooO0O0 oooO0O0 = this.f10684OooO00o;
            if (oooO0O0 != null) {
    ...
    public class OooO implements androidx.recyclerview.widget.OooO.OooO0O0 {
        public OooO() {
        }
    ...
    public class OooO0o implements o0000Ooo.OooO0O0 {
        public OooO0o() {
        }
    }

    public class OooOO0 implements androidx.recyclerview.widget.OooO00o.InterfaceC0179OooO00o {
        public OooOO0() {
        }
        ...
        public final void OooO00o(androidx.recyclerview.widget.OooO00o.OooO0O0 oooO0O0) {
            ...
            RecyclerView recyclerView = RecyclerView.this;
            if (i == 1) {
                recyclerView.mLayout.onItemsAdded(recyclerView, oooO0O0.f10586OooO0O0, oooO0O0.f10588OooO0Oo);
                return;
            }
            if (i == 2) {
                recyclerView.mLayout.onItemsRemoved(recyclerView, oooO0O0.f10586OooO0O0, oooO0O0.f10588OooO0Oo);
            } else if (i == 4) {
                recyclerView.mLayout.onItemsUpdated(recyclerView, oooO0O0.f10586OooO0O0, oooO0O0.f10588OooO0Oo, oooO0O0.f10587OooO0OO);
            } else {
                if (i != 8) {
                    return;
                }
                recyclerView.mLayout.onItemsMoved(recyclerView, oooO0O0.f10586OooO0O0, oooO0O0.f10588OooO0Oo, 1);
            }
        }

        public final o0O0O00 OooO0O0(int i) {
            RecyclerView recyclerView = RecyclerView.this;
            o0O0O00 o0o0o00FindViewHolderForPosition = recyclerView.findViewHolderForPosition(i, true);
            if (o0o0o00FindViewHolderForPosition == null) {
                return null;
            }
            if (!recyclerView.mChildHelper.OooOO0O(o0o0o00FindViewHolderForPosition.itemView)) {
                return o0o0o00FindViewHolderForPosition;
            }
    ...
    public static /* synthetic */ class OooOO0O {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public static final /* synthetic */ int[] f10701OooO00o;
        ...
        static {
            ...
            try {
                f10701OooO00o[Adapter.StateRestorationPolicy.PREVENT_WHEN_EMPTY.ordinal()] = 2;
    ...
    public static abstract class Oooo000 {
        ...
        public static class OooO0o {
            ...
            /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
            public int f10705OooO00o;

            /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
            public int f10706OooO0O0;

            /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
            public boolean f10707OooO0OO;
        ...
        private void addViewInt(View view, int i, boolean z) {
            ...
            if (z || childViewHolderInt.isRemoved()) {
                p190o00o0O.OooOo<o0O0O00, o0000Ooo.OooO00o> oooOo = this.mRecyclerView.mViewInfoStore.f10837OooO00o;
                o0000Ooo.OooO00o orDefault = oooOo.getOrDefault(childViewHolderInt, null);
                if (orDefault == null) {
                    orDefault = o0000Ooo.OooO00o.OooO00o();
                    oooOo.put(childViewHolderInt, orDefault);
                }
                orDefault.f10840OooO00o |= 1;
            } else {
            ...
            if (childViewHolderInt.wasReturnedFromScrap() || childViewHolderInt.isScrap()) {
                ...
                if (iOooOO0 == -1) {
                    ...
                    throw new IllegalStateException(androidx.recyclerview.widget.OooO0o.OooO00o(this.mRecyclerView, sb));
                }
                if (iOooOO0 != i) {
                ...
                layoutParams.f10693OooO0o = true;
                o0ooOOo o0ooooo = this.mSmoothScroller;
                if (o0ooooo != null && o0ooooo.isRunning()) {
                    this.mSmoothScroller.onChildAttachedToWindow(view);
                }
            }
            if (layoutParams.f10695OooO0oO) {
                if (RecyclerView.sVerboseLoggingEnabled) {
                    Log.d(RecyclerView.TAG, "consuming pending invalidate on child " + layoutParams.f10692OooO0Oo);
                }
                childViewHolderInt.itemView.invalidate();
                layoutParams.f10695OooO0oO = false;
            }
        }
        ...
        public static OooO0o getProperties(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, o00O000.RecyclerView, i, i2);
            oooO0o.f10705OooO00o = typedArrayObtainStyledAttributes.getInt(o00O000.RecyclerView_android_orientation, 1);
            oooO0o.f10706OooO0O0 = typedArrayObtainStyledAttributes.getInt(o00O000.RecyclerView_spanCount, 1);
            oooO0o.f10707OooO0OO = typedArrayObtainStyledAttributes.getBoolean(o00O000.RecyclerView_reverseLayout, false);
            oooO0o.f10708OooO0Oo = typedArrayObtainStyledAttributes.getBoolean(o00O000.RecyclerView_stackFromEnd, false);
        ...
        public View findViewByPosition(int i) {
            ...
            for (int i2 = 0; i2 < childCount; i2++) {
                ...
                if (childViewHolderInt != null && childViewHolderInt.getLayoutPosition() == i && !childViewHolderInt.shouldIgnore() && (this.mRecyclerView.mState.f10733OooO0oO || !childViewHolderInt.isRemoved())) {
                    return childAt;
                }
            }
            return null;
        ...
        public int getBottomDecorationHeight(@NonNull View view) {
            return ((LayoutParams) view.getLayoutParams()).f10694OooO0o0.bottom;
        }

        @Nullable
        public View getChildAt(int i) {
            androidx.recyclerview.widget.OooO oooO = this.mChildHelper;
            if (oooO != null) {
                return oooO.OooO0Oo(i);
            }
            return null;
        }
        ...
        public int getDecoratedMeasuredHeight(@NonNull View view) {
            Rect rect = ((LayoutParams) view.getLayoutParams()).f10694OooO0o0;
        ...
        public int getLeftDecorationWidth(@NonNull View view) {
            return ((LayoutParams) view.getLayoutParams()).f10694OooO0o0.left;
        }
        ...
        public int getRightDecorationWidth(@NonNull View view) {
            return ((LayoutParams) view.getLayoutParams()).f10694OooO0o0.right;
        }
        ...
        public int getTopDecorationHeight(@NonNull View view) {
            return ((LayoutParams) view.getLayoutParams()).f10694OooO0o0.top;
        }

        public void getTransformedBoundingBox(@NonNull View view, boolean z, @NonNull Rect rect) {
            Matrix matrix;
            if (z) {
                Rect rect2 = ((LayoutParams) view.getLayoutParams()).f10694OooO0o0;
        ...
        public void ignoreView(@NonNull View view) {
            ...
            if (parent != recyclerView || recyclerView.indexOfChild(view) == -1) {
                throw new IllegalArgumentException(androidx.recyclerview.widget.OooO0o.OooO00o(this.mRecyclerView, new StringBuilder("View should be fully attached to be ignored")));
            }
            o0O0O00 childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
        ...
        public void onInitializeAccessibilityNodeInfo(o0000O.o0O0O00 o0o0o00) {
            RecyclerView recyclerView = this.mRecyclerView;
            onInitializeAccessibilityNodeInfo(recyclerView.mRecycler, recyclerView.mState, o0o0o00);
        }

        public void onInitializeAccessibilityNodeInfoForItem(@NonNull o00Ooo o00ooo2, @NonNull o0OOO0o o0ooo0o2, @NonNull View view, @NonNull o0000O.o0O0O00 o0o0o00) {
        }
        ...
        public void removeAndRecycleScrapInt(o00Ooo o00ooo2) {
            ...
            int size = o00ooo2.f10717OooO00o.size();
            int i = size - 1;
            while (true) {
                arrayList = o00ooo2.f10717OooO00o;
                if (i < 0) {
                    break;
                }
            ...
            arrayList.clear();
            ArrayList<o0O0O00> arrayList2 = o00ooo2.f10718OooO0O0;
            if (arrayList2 != null) {
                arrayList2.clear();
            }
            if (size > 0) {
        ...
        public void removeView(View view) {
            androidx.recyclerview.widget.OooO oooO = this.mChildHelper;
            OooO oooO2 = (OooO) oooO.f10574OooO00o;
            int iIndexOfChild = RecyclerView.this.indexOfChild(view);
            if (iIndexOfChild < 0) {
                return;
            }
            if (oooO.f10575OooO0O0.OooO0o(iIndexOfChild)) {
                oooO.OooOOO0(view);
            }
            oooO2.OooO0O0(iIndexOfChild);
        }
        ...
        public void onInitializeAccessibilityNodeInfo(@NonNull o00Ooo o00ooo2, @NonNull o0OOO0o o0ooo0o2, @NonNull o0000O.o0O0O00 o0o0o00) {
            ...
            o0o0o00.OooOO0o(o0000O.o0O0O00.OooOO0.OooO00o(getRowCountForAccessibility(o00ooo2, o0ooo0o2), getColumnCountForAccessibility(o00ooo2, o0ooo0o2), getSelectionModeForAccessibility(o00ooo2, o0ooo0o2), isLayoutHierarchical(o00ooo2, o0ooo0o2)));
        }

        public void onInitializeAccessibilityNodeInfoForItem(View view, o0000O.o0O0O00 o0o0o00) {
            o0O0O00 childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
            if (childViewHolderInt == null || childViewHolderInt.isRemoved() || this.mChildHelper.OooOO0O(childViewHolderInt.itemView)) {
                return;
            }
            RecyclerView recyclerView = this.mRecyclerView;
            onInitializeAccessibilityNodeInfoForItem(recyclerView.mRecycler, recyclerView.mState, view, o0o0o00);
        }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public Parcelable f10709OooO0o;
        ...
        public SavedState(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f10709OooO0o = parcel.readParcelable(classLoader == null ? Oooo000.class.getClassLoader() : classLoader);
        }

        @Override // androidx.customview.view.AbsSavedState, android.os.Parcelable
        public final void writeToParcel(Parcel parcel, int i) {
            parcel.writeParcelable(this.f5545OooO0Oo, i);
            parcel.writeParcelable(this.f10709OooO0o, 0);
        }
    }
    ...
    public static class o00Oo0 {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final SparseArray<OooO00o> f10710OooO00o = new SparseArray<>();

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public int f10711OooO0O0 = 0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final Set<Adapter<?>> f10712OooO0OO = Collections.newSetFromMap(new IdentityHashMap());

        public static class OooO00o {

            /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
            public final ArrayList<o0O0O00> f10713OooO00o = new ArrayList<>();

            /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
            public final int f10714OooO0O0 = 5;

            /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
            public long f10715OooO0OO = 0;

            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public long f10716OooO0Oo = 0;
        }

        public final OooO00o OooO00o(int i) {
            SparseArray<OooO00o> sparseArray = this.f10710OooO00o;
    ...
    public final class o00Ooo {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final ArrayList<o0O0O00> f10717OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public ArrayList<o0O0O00> f10718OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final ArrayList<o0O0O00> f10719OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final List<o0O0O00> f10720OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f10721OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public int f10722OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public o00Oo0 f10723OooO0oO;

        public o00Ooo() {
            ArrayList<o0O0O00> arrayList = new ArrayList<>();
            this.f10717OooO00o = arrayList;
            this.f10718OooO0O0 = null;
            this.f10719OooO0OO = new ArrayList<>();
            this.f10720OooO0Oo = Collections.unmodifiableList(arrayList);
            this.f10722OooO0o0 = 2;
            this.f10721OooO0o = 2;
        }
        ...
        public final void OooO(int i) {
            ...
            ArrayList<o0O0O00> arrayList = this.f10719OooO0OO;
            o0O0O00 o0o0o00 = arrayList.get(i);
            if (RecyclerView.sVerboseLoggingEnabled) {
                Log.d(RecyclerView.TAG, "CachedViewHolder to be recycled: " + o0o0o00);
            }
        ...
        public final void OooO00o(@NonNull o0O0O00 o0o0o00, boolean z) {
            ...
            View view = o0o0o00.itemView;
            RecyclerView recyclerView = RecyclerView.this;
            o000000O o000000o2 = recyclerView.mAccessibilityDelegate;
            if (o000000o2 != null) {
                o000000O.OooO00o oooO00o = o000000o2.f10825OooO0O0;
                ViewCompat.OooOOOO(view, oooO00o instanceof o000000O.OooO00o ? (androidx.core.view.OooO00o) oooO00o.f10827OooO0O0.remove(view) : null);
            }
            if (z) {
                ...
                if (RecyclerView.sVerboseLoggingEnabled) {
                    Log.d(RecyclerView.TAG, "dispatchViewRecycled: " + o0o0o00);
                }
            }
            ...
            ArrayList<o0O0O00> arrayList = o00oo0OooO0OO.OooO00o(itemViewType).f10713OooO00o;
            if (o00oo0OooO0OO.f10710OooO00o.get(itemViewType).f10714OooO0O0 <= arrayList.size()) {
                p054o0000OOo.OooO0o.OooO00o(o0o0o00.itemView);
            } else {
                if (RecyclerView.sDebugAssertionsEnabled && arrayList.contains(o0o0o00)) {
        ...
        public final int OooO0O0(int i) {
            ...
            if (i >= 0 && i < recyclerView.mState.OooO0O0()) {
                return !recyclerView.mState.f10733OooO0oO ? i : recyclerView.mAdapterHelper.OooO0o(i, 0);
            }
            StringBuilder sbOooO0O0 = o0000O0.OooO0O0("invalid position ", i, ". State item count is ");
            sbOooO0O0.append(recyclerView.mState.OooO0O0());
            sbOooO0O0.append(recyclerView.exceptionLabel());
            throw new IndexOutOfBoundsException(sbOooO0O0.toString());
        }

        public final o00Oo0 OooO0OO() {
            if (this.f10723OooO0oO == null) {
                this.f10723OooO0oO = new o00Oo0();
                OooO0o();
            }
            return this.f10723OooO0oO;
        }
        ...
        public final void OooO0o() {
            if (this.f10723OooO0oO != null) {
                ...
                o00Oo0 o00oo1 = this.f10723OooO0oO;
                o00oo1.f10712OooO0OO.add(recyclerView.mAdapter);
            }
        }
        ...
        public final void OooO0oO(Adapter<?> adapter, boolean z) {
            ...
            Set<Adapter<?>> set = o00oo1.f10712OooO0OO;
            set.remove(adapter);
            if (set.size() != 0 || z) {
                return;
            }
            int i = 0;
            while (true) {
                SparseArray<o00Oo0.OooO00o> sparseArray = o00oo1.f10710OooO00o;
                if (i >= sparseArray.size()) {
                    return;
                }
                ArrayList<o0O0O00> arrayList = sparseArray.get(sparseArray.keyAt(i)).f10713OooO00o;
        ...
        public final void OooO0oo() {
            ...
            if (RecyclerView.ALLOW_THREAD_GAP_WORK) {
                androidx.recyclerview.widget.o0OoOo0.OooO0O0 oooO0O0 = RecyclerView.this.mPrefetchRegistry;
                int[] iArr = oooO0O0.f10950OooO0OO;
                if (iArr != null) {
                    Arrays.fill(iArr, -1);
                }
                oooO0O0.f10951OooO0Oo = 0;
            }
        }
        ...
        public final void OooOO0O(o0O0O00 o0o0o00) {
            ...
            if (o0o0o00.isTmpDetached()) {
                ...
                sb2.append(o0o0o00);
                throw new IllegalArgumentException(androidx.recyclerview.widget.OooO0o.OooO00o(recyclerView, sb2));
            }
            if (o0o0o00.shouldIgnore()) {
                throw new IllegalArgumentException(androidx.recyclerview.widget.OooO0o.OooO00o(recyclerView, new StringBuilder("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle.")));
            }
            boolean zDoesTransientStatePreventRecycling = o0o0o00.doesTransientStatePreventRecycling();
            Adapter adapter = recyclerView.mAdapter;
            boolean z6 = adapter != null && zDoesTransientStatePreventRecycling && adapter.onFailedToRecycleView(o0o0o00);
            boolean z7 = RecyclerView.sDebugAssertionsEnabled;
            ArrayList<o0O0O00> arrayList = this.f10719OooO0OO;
            if (z7 && arrayList.contains(o0o0o00)) {
                StringBuilder sb3 = new StringBuilder("cached view received recycle internal? ");
                sb3.append(o0o0o00);
                throw new IllegalArgumentException(androidx.recyclerview.widget.OooO0o.OooO00o(recyclerView, sb3));
            }
            if (z6 || o0o0o00.isRecyclable()) {
                if (this.f10721OooO0o <= 0 || o0o0o00.hasAnyOfTheFlags(526)) {
                    z = false;
                } else {
                    int size = arrayList.size();
                    if (size >= this.f10721OooO0o && size > 0) {
                        OooO(0);
                        size--;
                    }
                    if (RecyclerView.ALLOW_THREAD_GAP_WORK && size > 0) {
                        androidx.recyclerview.widget.o0OoOo0.OooO0O0 oooO0O0 = recyclerView.mPrefetchRegistry;
                        int i = o0o0o00.mPosition;
                        if (oooO0O0.f10950OooO0OO == null) {
                            z3 = false;
                            break;
                        }
                        int i2 = oooO0O0.f10951OooO0Oo * 2;
                        int i3 = 0;
                        while (true) {
                            if (i3 >= i2) {
                                z3 = false;
                        ...
                        if (!z3) {
                            do {
                                ...
                                androidx.recyclerview.widget.o0OoOo0.OooO0O0 oooO0O1 = recyclerView.mPrefetchRegistry;
                                if (oooO0O1.f10950OooO0OO == null) {
                                    z4 = false;
                                    break;
                                    break;
                                }
                                int i5 = oooO0O1.f10951OooO0Oo * 2;
                                int i6 = 0;
                                while (true) {
                                    if (i6 >= i5) {
                                        z4 = false;
                                        ...
                                        if (oooO0O1.f10950OooO0OO[i6] == i4) {
                                            z4 = true;
                                            break;
                                        }
                                        i6 += 2;
        ...
        public final void OooOO0o(View view) {
            ...
            if (!zHasAnyOfTheFlags && childViewHolderInt.isUpdated() && !recyclerView.canReuseUpdatedViewHolder(childViewHolderInt)) {
                if (this.f10718OooO0O0 == null) {
                    this.f10718OooO0O0 = new ArrayList<>();
                }
                childViewHolderInt.setScrapContainer(this, true);
                this.f10718OooO0O0.add(childViewHolderInt);
                return;
            }
            if (childViewHolderInt.isInvalid() && !childViewHolderInt.isRemoved() && !recyclerView.mAdapter.hasStableIds()) {
                throw new IllegalArgumentException(androidx.recyclerview.widget.OooO0o.OooO00o(recyclerView, new StringBuilder("Called scrap view with an invalid view. Invalid views cannot be reused from scrap, they should rebound from recycler pool.")));
            }
            childViewHolderInt.setScrapContainer(this, false);
            this.f10717OooO00o.add(childViewHolderInt);
        }

        public final void OooOOO(o0O0O00 o0o0o00) {
            if (o0o0o00.mInChangeScrap) {
                this.f10718OooO0O0.remove(o0o0o00);
            } else {
                this.f10717OooO00o.remove(o0o0o00);
            }
        ...
        /* JADX WARN: Code duplicated, block: B:124:0x021d  */
        ...
        /* JADX WARN: Code duplicated, block: B:186:0x0353 A[EDGE_INSN: B:186:0x0353->B:187:0x0354 BREAK  A[LOOP:6: B:181:0x033c->B:345:?]] */
        /* JADX WARN: Code duplicated, block: B:228:0x0411  */
        /* JADX WARN: Code duplicated, block: B:234:0x0436  */
        /* JADX WARN: Code duplicated, block: B:236:0x043c  */
        /* JADX WARN: Code duplicated, block: B:240:0x0448  */
        /* JADX WARN: Code duplicated, block: B:242:0x044c  */
        /* JADX WARN: Code duplicated, block: B:249:0x0483  */
        /* JADX WARN: Code duplicated, block: B:251:0x0491  */
        /* JADX WARN: Code duplicated, block: B:255:0x0499  */
        /* JADX WARN: Code duplicated, block: B:257:0x049c  */
        /* JADX WARN: Code duplicated, block: B:260:0x04a6  */
        /* JADX WARN: Code duplicated, block: B:261:0x04b7  */
        /* JADX WARN: Code duplicated, block: B:264:0x04bf  */
        /* JADX WARN: Code duplicated, block: B:268:0x04dc  */
        /* JADX WARN: Code duplicated, block: B:271:0x04ec  */
        /* JADX WARN: Code duplicated, block: B:273:0x04f6  */
        ...
        /* JADX WARN: Code duplicated, block: B:283:0x0511  */
        /* JADX WARN: Code duplicated, block: B:285:0x0515  */
        /* JADX WARN: Code duplicated, block: B:286:0x051a  */
        /* JADX WARN: Code duplicated, block: B:288:0x0521 A[ADDED_TO_REGION] */
        /* JADX WARN: Code duplicated, block: B:292:0x052d  */
        /* JADX WARN: Code duplicated, block: B:295:0x0534  */
        /* JADX WARN: Code duplicated, block: B:299:0x053f  */
        /* JADX WARN: Code duplicated, block: B:300:0x054b  */
        /* JADX WARN: Code duplicated, block: B:302:0x0551  */
        /* JADX WARN: Code duplicated, block: B:303:0x055d  */
        /* JADX WARN: Code duplicated, block: B:306:0x0564 A[ADDED_TO_REGION] */
        /* JADX WARN: Code duplicated, block: B:318:0x00c5 A[SYNTHETIC] */
        /* JADX WARN: Code duplicated, block: B:323:0x00f9 A[SYNTHETIC] */
        /* JADX WARN: Code duplicated, block: B:328:0x01b3 A[SYNTHETIC] */
        ...
        /* JADX WARN: Instruction removed from duplicated block: B:77:0x0147, please report this as an issue */
        ...
        public final o0O0O00 OooOOO0(long j, int i) {
            ...
            int size;
            int i2;
            androidx.recyclerview.widget.OooO oooO;
            ...
            o0O0O00 o0o0o00;
            androidx.recyclerview.widget.OooO oooO2;
            int iIndexOfChild;
            androidx.recyclerview.widget.OooO.OooO00o oooO00o3;
            int iOooOO0;
            o0O0O00 childViewHolderInt2;
            int i5;
            boolean z7;
            o0O0O00 o0o0o01;
            int size4;
            ...
            boolean z8 = false;
            if (recyclerView.mState.f10733OooO0oO) {
                ArrayList<o0O0O00> arrayList4 = this.f10718OooO0O0;
                        ...
                        if (i6 >= size4) {
                            if (recyclerView.mAdapter.hasStableIds() && (iOooO0o2 = recyclerView.mAdapterHelper.OooO0o(i, 0)) > 0 && iOooO0o2 < recyclerView.mAdapter.getItemCount()) {
                                ...
                                while (true) {
                                    ...
                                    o0O0O00 o0o0o02 = this.f10718OooO0O0.get(i7);
                                    if (!o0o0o02.wasReturnedFromScrap() && o0o0o02.getItemId() == itemId) {
                                        o0o0o02.addFlags(32);
                            ...
                            o0o0o00CreateViewHolder = this.f10718OooO0O0.get(i6);
                ...
                arrayList = this.f10719OooO0OO;
                arrayList2 = this.f10717OooO00o;
                if (o0o0o00CreateViewHolder == null) {
                    size = arrayList2.size();
                    i2 = 0;
                    while (true) {
                        if (i2 < size) {
                            oooO = recyclerView.mChildHelper;
                            arrayList3 = oooO.f10576OooO0OO;
                            ...
                            while (true) {
                                ...
                                ((OooO) oooO.f10574OooO00o).getClass();
                            ...
                            if (view2 != null) {
                                ...
                                oooO2 = recyclerView.mChildHelper;
                                ...
                                if (iOooOO0 != -1) {
                                    ...
                                    throw new IllegalStateException(androidx.recyclerview.widget.OooO0o.OooO00o(recyclerView, sb));
                                }
                                ...
                                while (true) {
                                    if (i4 < size3) {
                                        ...
                                        if (o0o0o00.isInvalid() && o0o0o00.getLayoutPosition() == i && !o0o0o00.isAttachedToTransitionOverlay()) {
                                            arrayList.remove(i4);
                                            if (RecyclerView.sVerboseLoggingEnabled) {
                                                Log.d(RecyclerView.TAG, "getScrapOrHiddenOrCachedHolderForPosition(" + i + ") found match in cache: " + o0o0o00);
                                            }
                            ...
                            o0o0o00CreateViewHolder = childViewHolderInt;
                            break;
                        }
                        o0o0o01 = arrayList2.get(i2);
                        if (o0o0o01.wasReturnedFromScrap() && o0o0o01.getLayoutPosition() == i && !o0o0o01.isInvalid() && (recyclerView.mState.f10733OooO0oO || !o0o0o01.isRemoved())) {
                            o0o0o01.addFlags(32);
                    ...
                    if (o0o0o00CreateViewHolder != null) {
                        if (o0o0o00CreateViewHolder.isRemoved()) {
                            ...
                            if (i5 >= 0 || i5 >= recyclerView.mAdapter.getItemCount()) {
                                ...
                                throw new IndexOutOfBoundsException(androidx.recyclerview.widget.OooO0o.OooO00o(recyclerView, sb2));
                            }
                            z7 = (recyclerView.mState.f10733OooO0oO || recyclerView.mAdapter.getItemViewType(o0o0o00CreateViewHolder.mPosition) == o0o0o00CreateViewHolder.getItemViewType()) && (!recyclerView.mAdapter.hasStableIds() || o0o0o00CreateViewHolder.getItemId() == recyclerView.mAdapter.getItemId(o0o0o00CreateViewHolder.mPosition));
                        } else {
                            if (!RecyclerView.sDebugAssertionsEnabled && !recyclerView.mState.f10733OooO0oO) {
                                throw new IllegalStateException(androidx.recyclerview.widget.OooO0o.OooO00o(recyclerView, new StringBuilder("should not receive a removed view unless it is pre layout")));
                            }
                            z7 = recyclerView.mState.f10733OooO0oO;
                        }
                        if (z7) {
                            z = true;
                        } else {
                ...
                if (o0o0o00CreateViewHolder == null) {
                        ...
                        while (true) {
                            if (size5 < 0) {
                                ...
                                while (true) {
                                    size6--;
                                    if (size6 >= 0) {
                                        o0O0O00 o0o0o03 = arrayList.get(size6);
                                        if (o0o0o03.getItemId() == itemId2 && !o0o0o03.isAttachedToTransitionOverlay()) {
                                            if (itemViewType2 == o0o0o03.getItemViewType()) {
                                                arrayList.remove(size6);
                                                o0o0o00CreateViewHolder = o0o0o03;
                                                break;
                                            }
                                            OooO(size6);
                                        }
                            ...
                            o0O0O00 o0o0o04 = arrayList2.get(size5);
                            if (o0o0o04.getItemId() == itemId2 && !o0o0o04.wasReturnedFromScrap()) {
                                if (itemViewType2 == o0o0o04.getItemViewType()) {
                                    o0o0o04.addFlags(32);
                                    if (o0o0o04.isRemoved() && !recyclerView.mState.f10733OooO0oO) {
                                        o0o0o04.setFlags(2, 14);
                                    }
                                    o0o0o00CreateViewHolder = o0o0o04;
                                    break;
                                }
                                arrayList2.remove(size5);
                                recyclerView.removeDetachedView(o0o0o04.itemView, false);
                                o0O0O00 childViewHolderInt3 = RecyclerView.getChildViewHolderInt(o0o0o04.itemView);
                    ...
                    if (o0o0o00CreateViewHolder == null) {
                        ...
                        o00Oo0.OooO00o oooO00o4 = OooO0OO().f10710OooO00o.get(itemViewType2);
                        if (oooO00o4 == null) {
                            o0o0o00Remove = null;
                            break;
                        }
                        ArrayList<o0O0O00> arrayList5 = oooO00o4.f10713OooO00o;
                    ...
                    if (o0o0o00CreateViewHolder == null) {
                        ...
                        if (j != Long.MAX_VALUE) {
                            long j4 = this.f10723OooO0oO.OooO00o(itemViewType2).f10715OooO0OO;
                        ...
                        o00Oo0.OooO00o OooO00o2 = this.f10723OooO0oO.OooO00o(itemViewType2);
                        long j5 = OooO00o2.f10715OooO0OO;
                        if (j5 != 0) {
                            nanoTime3 = (nanoTime3 / 4) + ((j5 / 4) * 3);
                        }
                        OooO00o2.f10715OooO0OO = nanoTime3;
                        if (RecyclerView.sVerboseLoggingEnabled) {
                            Log.d(RecyclerView.TAG, "tryGetViewHolderForPositionByDeadline created new ViewHolder");
                        }
                    }
                }
                if (z && !recyclerView.mState.f10733OooO0oO && o0o0o00CreateViewHolder.hasAnyOfTheFlags(8192)) {
                    o0o0o00CreateViewHolder.setFlags(0, 8192);
                    if (recyclerView.mState.f10735OooOO0) {
                ...
                if (recyclerView.mState.f10733OooO0oO || !o0o0o00CreateViewHolder.isBound()) {
                    if (o0o0o00CreateViewHolder.isBound() || o0o0o00CreateViewHolder.needsUpdate() || o0o0o00CreateViewHolder.isInvalid()) {
                        if (!RecyclerView.sDebugAssertionsEnabled && o0o0o00CreateViewHolder.isRemoved()) {
                            ...
                            throw new IllegalStateException(androidx.recyclerview.widget.OooO0o.OooO00o(recyclerView, sb3));
                        }
                        ...
                        if (j != Long.MAX_VALUE) {
                            j3 = this.f10723OooO0oO.OooO00o(itemViewType).f10716OooO0Oo;
                        ...
                        if (o0o0o00CreateViewHolder.isTmpDetached()) {
                            recyclerView.attachViewToParent(o0o0o00CreateViewHolder.itemView, recyclerView.getChildCount(), o0o0o00CreateViewHolder.itemView.getLayoutParams());
                            z2 = true;
                        } else {
                            z2 = false;
                        }
                        ...
                        if (z2) {
                            recyclerView.detachViewFromParent(o0o0o00CreateViewHolder.itemView);
                        }
                        nanoTime = recyclerView.getNanoTime() - nanoTime4;
                        o00Oo0.OooO00o OooO00o3 = this.f10723OooO0oO.OooO00o(o0o0o00CreateViewHolder.getItemViewType());
                        j2 = OooO00o3.f10716OooO0Oo;
                        if (j2 != 0) {
                            nanoTime = (nanoTime / 4) + ((j2 / 4) * 3);
                        }
                        OooO00o3.f10716OooO0Oo = nanoTime;
                        if (recyclerView.isAccessibilityEnabled()) {
                            ...
                            o000000o2 = recyclerView.mAccessibilityDelegate;
                            if (o000000o2 != null) {
                                oooO00o2 = o000000o2.f10825OooO0O0;
                                if (oooO00o2 instanceof o000000O.OooO00o) {
                                    oooO00o2.getClass();
                                    accessibilityDelegateOooO0Oo = ViewCompat.OooO0Oo(view);
                                    if (accessibilityDelegateOooO0Oo != null) {
                                        if (accessibilityDelegateOooO0Oo instanceof androidx.core.view.OooO00o.C0123OooO00o) {
                                            oooO00o = ((androidx.core.view.OooO00o.C0123OooO00o) accessibilityDelegateOooO0Oo).f5335OooO00o;
                                        } else {
                                            oooO00o = new androidx.core.view.OooO00o(accessibilityDelegateOooO0Oo);
                                        }
                                    }
                                    if (oooO00o != null && oooO00o != oooO00o2) {
                                        oooO00o2.f10827OooO0O0.put(view, oooO00o);
                                    }
                                }
                    ...
                    layoutParams2.f10692OooO0Oo = o0o0o00CreateViewHolder;
                    if (z && z3) {
                        z8 = z4;
                    }
                    layoutParams2.f10695OooO0oO = z8;
            ...
            if (o0o0o00CreateViewHolder == null) {
                ...
                while (true) {
                    if (i2 < size) {
                        ...
                        if (view2 != null) {
                            ...
                            if (iOooOO0 != -1) {
                                ...
                                throw new IllegalStateException(androidx.recyclerview.widget.OooO0o.OooO00o(recyclerView, sb4));
                            }
                            recyclerView.mChildHelper.OooO0OO(iOooOO0);
                            OooOO0o(view2);
                            childViewHolderInt.addFlags(8224);
                    ...
                    o0o0o01 = arrayList2.get(i2);
                    if (o0o0o01.wasReturnedFromScrap()) {
                    }
                    i2++;
                }
                if (o0o0o00CreateViewHolder != null) {
                    if (o0o0o00CreateViewHolder.isRemoved()) {
                        ...
                        throw new IndexOutOfBoundsException(androidx.recyclerview.widget.OooO0o.OooO00o(recyclerView, sb5));
                    }
            ...
            if (recyclerView.mState.f10733OooO0oO) {
                if (o0o0o00CreateViewHolder.isBound()) {
                    ...
                    o00Oo0.OooO00o OooO00o4 = this.f10723OooO0oO.OooO00o(o0o0o00CreateViewHolder.getItemViewType());
                    j2 = OooO00o4.f10716OooO0Oo;
                    if (j2 != 0) {
                        nanoTime = (nanoTime / 4) + ((j2 / 4) * 3);
                    }
                    OooO00o4.f10716OooO0Oo = nanoTime;
                    if (recyclerView.isAccessibilityEnabled()) {
                        view = o0o0o00CreateViewHolder.itemView;
                    ...
                    o00Oo0.OooO00o OooO00o5 = this.f10723OooO0oO.OooO00o(o0o0o00CreateViewHolder.getItemViewType());
                    j2 = OooO00o5.f10716OooO0Oo;
                    if (j2 != 0) {
                        nanoTime = (nanoTime / 4) + ((j2 / 4) * 3);
                    }
                    OooO00o5.f10716OooO0Oo = nanoTime;
                    if (recyclerView.isAccessibilityEnabled()) {
                        view = o0o0o00CreateViewHolder.itemView;
                ...
                o00Oo0.OooO00o OooO00o6 = this.f10723OooO0oO.OooO00o(o0o0o00CreateViewHolder.getItemViewType());
                j2 = OooO00o6.f10716OooO0Oo;
                if (j2 != 0) {
                    nanoTime = (nanoTime / 4) + ((j2 / 4) * 3);
                }
                OooO00o6.f10716OooO0Oo = nanoTime;
                if (recyclerView.isAccessibilityEnabled()) {
                    view = o0o0o00CreateViewHolder.itemView;
                ...
                o00Oo0.OooO00o OooO00o7 = this.f10723OooO0oO.OooO00o(o0o0o00CreateViewHolder.getItemViewType());
                j2 = OooO00o7.f10716OooO0Oo;
                if (j2 != 0) {
                    nanoTime = (nanoTime / 4) + ((j2 / 4) * 3);
                }
                OooO00o7.f10716OooO0Oo = nanoTime;
                if (recyclerView.isAccessibilityEnabled()) {
                    view = o0o0o00CreateViewHolder.itemView;
        ...
        public final void OooOOOO() {
            ...
            this.f10721OooO0o = this.f10722OooO0o0 + (oooo000 != null ? oooo000.mPrefetchMaxCountObserved : 0);
            ArrayList<o0O0O00> arrayList = this.f10719OooO0OO;
            for (int size = arrayList.size() - 1; size >= 0 && arrayList.size() > this.f10721OooO0o; size--) {
                OooO(size);
            }
        }
    }
    ...
    public class o00oO0o extends OooOOO {
        ...
        public final void onChanged() {
            ...
            recyclerView.mState.f10731OooO0o = true;
        ...
        public final void onItemRangeChanged(int i, int i2, Object obj) {
            ...
            if (i2 < 1) {
                ...
                ArrayList<androidx.recyclerview.widget.OooO00o.OooO0O0> arrayList = oooO00o.f10580OooO0O0;
                arrayList.add(oooO00o.OooO0oo(4, i, i2, obj));
                oooO00o.f10583OooO0o |= 4;
                if (arrayList.size() == 1) {
                    z = true;
                }
            }
    ...
    public static abstract class o0O0O00 {
        ...
        public void offsetPosition(int i, boolean z) {
            ...
            if (this.itemView.getLayoutParams() != null) {
                ((LayoutParams) this.itemView.getLayoutParams()).f10693OooO0o = true;
            }
        }
        ...
        public String toString() {
            StringBuilder sbOooO0O0 = o000O0o.OooO0O0(getClass().isAnonymousClass() ? "ViewHolder" : getClass().getSimpleName(), "{");
    ...
    public static class o0OOO0o {
        ...
        public int f10737OooOO0o;

        /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
        public int f10738OooOOO;

        /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
        public long f10739OooOOO0;

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public int f10727OooO00o = -1;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public int f10728OooO0O0 = 0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public int f10729OooO0OO = 0;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f10730OooO0Oo = 1;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public int f10732OooO0o0 = 0;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public boolean f10731OooO0o = false;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public boolean f10733OooO0oO = false;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public boolean f10734OooO0oo = false;

        /* JADX INFO: renamed from: OooO, reason: collision with root package name */
        public boolean f10726OooO = false;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public boolean f10735OooOO0 = false;

        /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
        public boolean f10736OooOO0O = false;

        public final void OooO00o(int i) {
            if ((this.f10730OooO0Oo & i) != 0) {
                return;
            }
            throw new IllegalStateException("Layout state should be one of " + Integer.toBinaryString(i) + " but it is " + Integer.toBinaryString(this.f10730OooO0Oo));
        }

        public final int OooO0O0() {
            return this.f10733OooO0oO ? this.f10728OooO0O0 - this.f10729OooO0OO : this.f10732OooO0o0;
        }

        public final String toString() {
            StringBuilder sb = new StringBuilder("State{mTargetPosition=");
            sb.append(this.f10727OooO00o);
            sb.append(", mData=null, mItemCount=");
            sb.append(this.f10732OooO0o0);
            sb.append(", mIsMeasuring=");
            sb.append(this.f10726OooO);
            sb.append(", mPreviousLayoutItemCount=");
            sb.append(this.f10728OooO0O0);
            sb.append(", mDeletedInvisibleItemCountSincePreviousLayout=");
            sb.append(this.f10729OooO0OO);
            sb.append(", mStructureChanged=");
            sb.append(this.f10731OooO0o);
            sb.append(", mInPreLayout=");
            sb.append(this.f10733OooO0oO);
            sb.append(", mRunSimpleAnimations=");
            sb.append(this.f10735OooOO0);
            sb.append(", mRunPredictiveAnimations=");
            return androidx.compose.animation.OooO0o.OooO00o(sb, this.f10736OooOO0O, '}');
        }
    }
    ...
    public static abstract class o0ooOOo {
        ...
        public static class OooO00o {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public int f10743OooO0Oo = -1;

            /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
            public boolean f10744OooO0o = false;

            /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
            public int f10746OooO0oO = 0;

            /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
            public int f10740OooO00o = 0;

            /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
            public int f10741OooO0O0 = 0;

            /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
            public int f10742OooO0OO = Integer.MIN_VALUE;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public Interpolator f10745OooO0o0 = null;

            public final void OooO00o(RecyclerView recyclerView) {
                int i = this.f10743OooO0Oo;
                if (i >= 0) {
                    this.f10743OooO0Oo = -1;
                    recyclerView.jumpToPositionForSmoothScroller(i);
                    this.f10744OooO0o = false;
                    return;
                }
                if (!this.f10744OooO0o) {
                    this.f10746OooO0oO = 0;
                    return;
                }
                Interpolator interpolator = this.f10745OooO0o0;
                if (interpolator != null && this.f10742OooO0OO < 1) {
                    throw new IllegalStateException("If you provide an interpolator, you must set a positive duration");
                }
                int i2 = this.f10742OooO0OO;
                if (i2 < 1) {
                    throw new IllegalStateException("Scroll duration must be a positive number");
                }
                recyclerView.mViewFlinger.OooO0OO(this.f10740OooO00o, this.f10741OooO0O0, interpolator, i2);
                int i3 = this.f10746OooO0oO + 1;
                this.f10746OooO0oO = i3;
                if (i3 > 10) {
        ...
        public void onAnimation(int i, int i2) {
            ...
            if (this.mRunning) {
                ...
                boolean z = oooO00o.f10743OooO0Oo >= 0;
        ...
        public void start(RecyclerView recyclerView, Oooo000 oooo000) {
            ...
            oo0o0oo.f10749OooO0o.abortAnimation();
            if (this.mStarted) {
            ...
            recyclerView.mState.f10727OooO00o = i;
            this.mRunning = true;
            this.mPendingInitialRun = true;
        ...
        public final void stop() {
            if (this.mRunning) {
                this.mRunning = false;
                onStop();
                this.mRecyclerView.mState.f10727OooO00o = -1;
                this.mTargetView = null;
    ...
    public class oo0o0Oo implements Runnable {
        ...
        /* JADX INFO: renamed from: OooO, reason: collision with root package name */
        public boolean f10747OooO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f10748OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public OverScroller f10749OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public int f10750OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public Interpolator f10751OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public boolean f10752OooO0oo;

        public oo0o0Oo() {
            Interpolator interpolator = RecyclerView.sQuinticInterpolator;
            this.f10751OooO0oO = interpolator;
            this.f10752OooO0oo = false;
            this.f10747OooO = false;
            this.f10749OooO0o = new OverScroller(RecyclerView.this.getContext(), interpolator);
        }

        public final void OooO00o(int i, int i2) {
            RecyclerView recyclerView = RecyclerView.this;
            recyclerView.setScrollState(2);
            this.f10750OooO0o0 = 0;
            this.f10748OooO0Oo = 0;
            Interpolator interpolator = this.f10751OooO0oO;
            Interpolator interpolator2 = RecyclerView.sQuinticInterpolator;
            if (interpolator != interpolator2) {
                this.f10751OooO0oO = interpolator2;
                this.f10749OooO0o = new OverScroller(recyclerView.getContext(), interpolator2);
            }
            this.f10749OooO0o.fling(0, 0, i, i2, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE);
            OooO0O0();
        }

        public final void OooO0O0() {
            if (this.f10752OooO0oo) {
                this.f10747OooO = true;
                return;
            }
            RecyclerView recyclerView = RecyclerView.this;
        ...
        public final void OooO0OO(int i, int i2, @Nullable Interpolator interpolator, int i3) {
            ...
            if (this.f10751OooO0oO != interpolator) {
                this.f10751OooO0oO = interpolator;
                this.f10749OooO0o = new OverScroller(recyclerView.getContext(), interpolator);
            }
            this.f10750OooO0o0 = 0;
            this.f10748OooO0Oo = 0;
            recyclerView.setScrollState(2);
            this.f10749OooO0o.startScroll(0, 0, i, i2, i4);
            OooO0O0();
        }
        ...
        public final void run() {
            ...
            if (recyclerView.mLayout == null) {
                recyclerView.removeCallbacks(this);
                this.f10749OooO0o.abortAnimation();
                return;
            }
            this.f10747OooO = false;
            this.f10752OooO0oo = true;
            recyclerView.consumePendingUpdateOperations();
            OverScroller overScroller = this.f10749OooO0o;
            if (overScroller.computeScrollOffset()) {
                int currX = overScroller.getCurrX();
                int currY = overScroller.getCurrY();
                int i6 = currX - this.f10748OooO0Oo;
                int i7 = currY - this.f10750OooO0o0;
                this.f10748OooO0Oo = currX;
                this.f10750OooO0o0 = currY;
                ...
                if ((o0ooooo2 != null && o0ooooo2.isPendingInitialRun()) || !z) {
                    OooO0O0();
                    androidx.recyclerview.widget.o0OoOo0 o0oooo1 = recyclerView.mGapWorker;
                    if (o0oooo1 != null) {
                        o0oooo1.OooO00o(recyclerView, i4, i3);
                    }
                } else {
                    if (recyclerView.getOverScrollMode() != 2) {
                    ...
                    if (RecyclerView.ALLOW_THREAD_GAP_WORK) {
                        androidx.recyclerview.widget.o0OoOo0.OooO0O0 oooO0O0 = recyclerView.mPrefetchRegistry;
                        int[] iArr7 = oooO0O0.f10950OooO0OO;
                        if (iArr7 != null) {
                            Arrays.fill(iArr7, -1);
                        }
                        oooO0O0.f10951OooO0Oo = 0;
    ...
    private void addAnimatingView(o0O0O00 o0o0o00) {
        ...
        int iIndexOfChild = RecyclerView.this.indexOfChild(view);
        if (iIndexOfChild >= 0) {
            oooO.f10575OooO0O0.OooO0oo(iIndexOfChild);
            oooO.OooO(view);
        } else {
    ...
    private void dispatchLayoutStep1() {
        ...
        this.mState.f10726OooO = false;
        startInterceptRequestLayout();
        o0000Ooo o0000ooo = this.mViewInfoStore;
        o0000ooo.f10837OooO00o.clear();
        o0000ooo.f10838OooO0O0.OooO0Oo();
        onEnterLayoutOrScroll();
        processAdapterUpdatesAndSetAnimationFlags();
        saveFocusInfo();
        o0OOO0o o0ooo0o2 = this.mState;
        o0ooo0o2.f10734OooO0oo = o0ooo0o2.f10735OooOO0 && this.mItemsChanged;
        this.mItemsChanged = false;
        this.mItemsAddedOrRemoved = false;
        o0ooo0o2.f10733OooO0oO = o0ooo0o2.f10736OooOO0O;
        o0ooo0o2.f10732OooO0o0 = this.mAdapter.getItemCount();
        findMinMaxChildLayoutPositions(this.mMinMaxLayoutPositions);
        if (this.mState.f10735OooOO0) {
            ...
            for (int i = 0; i < iOooO0o0; i++) {
                ...
                if (!childViewHolderInt.shouldIgnore() && (!childViewHolderInt.isInvalid() || this.mAdapter.hasStableIds())) {
                    ...
                    p190o00o0O.OooOo<o0O0O00, o0000Ooo.OooO00o> oooOo = this.mViewInfoStore.f10837OooO00o;
                    o0000Ooo.OooO00o orDefault = oooOo.getOrDefault(childViewHolderInt, null);
                    if (orDefault == null) {
                        orDefault = o0000Ooo.OooO00o.OooO00o();
                        oooOo.put(childViewHolderInt, orDefault);
                    }
                    orDefault.f10841OooO0O0 = oooO0OO;
                    orDefault.f10840OooO00o |= 4;
                    if (this.mState.f10734OooO0oo && childViewHolderInt.isUpdated() && !childViewHolderInt.isRemoved() && !childViewHolderInt.shouldIgnore() && !childViewHolderInt.isInvalid()) {
                        this.mViewInfoStore.f10838OooO0O0.OooO(getChangedHolderKey(childViewHolderInt), childViewHolderInt);
                    }
                }
            }
        }
        if (this.mState.f10736OooOO0O) {
            saveOldPositions();
            o0OOO0o o0ooo0o3 = this.mState;
            boolean z = o0ooo0o3.f10731OooO0o;
            o0ooo0o3.f10731OooO0o = false;
            this.mLayout.onLayoutChildren(this.mRecycler, o0ooo0o3);
            this.mState.f10731OooO0o = z;
            for (int i2 = 0; i2 < this.mChildHelper.OooO0o0(); i2++) {
                ...
                if (!childViewHolderInt2.shouldIgnore()) {
                    o0000Ooo.OooO00o orDefault2 = this.mViewInfoStore.f10837OooO00o.getOrDefault(childViewHolderInt2, null);
                    if (!((orDefault2 == null || (orDefault2.f10840OooO00o & 4) == 0) ? false : true)) {
                        ...
                        if (zHasAnyOfTheFlags) {
                            ...
                            p190o00o0O.OooOo<o0O0O00, o0000Ooo.OooO00o> oooOo2 = this.mViewInfoStore.f10837OooO00o;
                            o0000Ooo.OooO00o orDefault3 = oooOo2.getOrDefault(childViewHolderInt2, null);
                            if (orDefault3 == null) {
                                orDefault3 = o0000Ooo.OooO00o.OooO00o();
                                oooOo2.put(childViewHolderInt2, orDefault3);
                            }
                            orDefault3.f10840OooO00o |= 2;
                            orDefault3.f10841OooO0O0 = oooO0OO2;
                        }
                    }
                }
            }
    ...
    private void dispatchLayoutStep2() {
        ...
        this.mState.f10732OooO0o0 = this.mAdapter.getItemCount();
        this.mState.f10729OooO0OO = 0;
        if (this.mPendingSavedState != null && this.mAdapter.canRestoreState()) {
            Parcelable parcelable = this.mPendingSavedState.f10709OooO0o;
            if (parcelable != null) {
        ...
        o0OOO0o o0ooo0o3 = this.mState;
        o0ooo0o3.f10731OooO0o = false;
        o0ooo0o3.f10735OooOO0 = o0ooo0o3.f10735OooOO0 && this.mItemAnimator != null;
        o0ooo0o3.f10730OooO0Oo = 4;
        onExitLayoutOrScroll();
        stopInterceptRequestLayout(false);
    }
    ...
    private void dispatchLayoutStep3() {
        ...
        if (o0ooo0o2.f10735OooOO0) {
            for (int iOooO0o0 = this.mChildHelper.OooO0o0() - 1; iOooO0o0 >= 0; iOooO0o0--) {
                ...
                if (!childViewHolderInt.shouldIgnore()) {
                    ...
                    ItemAnimator.OooO0OO oooO0OO = new ItemAnimator.OooO0OO();
                    oooO0OO.OooO00o(childViewHolderInt);
                    o0O0O00 o0o0o00 = (o0O0O00) this.mViewInfoStore.f10838OooO0O0.OooO0oO(changedHolderKey, null);
                    if (o0o0o00 == null || o0o0o00.shouldIgnore()) {
                        this.mViewInfoStore.OooO00o(childViewHolderInt, oooO0OO);
                    } else {
                        o0000Ooo.OooO00o orDefault = this.mViewInfoStore.f10837OooO00o.getOrDefault(o0o0o00, null);
                        boolean z = (orDefault == null || (orDefault.f10840OooO00o & 1) == 0) ? false : true;
                        o0000Ooo.OooO00o orDefault2 = this.mViewInfoStore.f10837OooO00o.getOrDefault(childViewHolderInt, null);
                        boolean z2 = (orDefault2 == null || (orDefault2.f10840OooO00o & 1) == 0) ? false : true;
            ...
            o0000Ooo o0000ooo = this.mViewInfoStore;
            o0000Ooo.OooO0O0 oooO0O0 = this.mViewInfoProcessCallback;
            p190o00o0O.OooOo<o0O0O00, o0000Ooo.OooO00o> oooOo = o0000ooo.f10837OooO00o;
            ...
            while (true) {
                ...
                o0O0O00 o0o0o00OooO0oo = oooOo.OooO0oo(i);
                o0000Ooo.OooO00o oooO00oOooOO0 = oooOo.OooOO0(i);
                int i2 = oooO00oOooOO0.f10840OooO00o;
                if ((i2 & 3) == 3) {
                    RecyclerView recyclerView = RecyclerView.this;
                    recyclerView.mLayout.removeAndRecycleView(o0o0o00OooO0oo.itemView, recyclerView.mRecycler);
                } else if ((i2 & 1) != 0) {
                    ItemAnimator.OooO0OO oooO0OO2 = oooO00oOooOO0.f10841OooO0O0;
                    if (oooO0OO2 == null) {
                        RecyclerView recyclerView2 = RecyclerView.this;
                        recyclerView2.mLayout.removeAndRecycleView(o0o0o00OooO0oo.itemView, recyclerView2.mRecycler);
                    } else {
                        ItemAnimator.OooO0OO oooO0OO3 = oooO00oOooOO0.f10842OooO0OO;
                        RecyclerView recyclerView3 = RecyclerView.this;
                        recyclerView3.mRecycler.OooOOO(o0o0o00OooO0oo);
                        recyclerView3.animateDisappearance(o0o0o00OooO0oo, oooO0OO2, oooO0OO3);
                    }
                } else if ((i2 & 14) == 14) {
                    RecyclerView.this.animateAppearance(o0o0o00OooO0oo, oooO00oOooOO0.f10841OooO0O0, oooO00oOooOO0.f10842OooO0OO);
                } else if ((i2 & 12) == 12) {
                    ItemAnimator.OooO0OO oooO0OO4 = oooO00oOooOO0.f10841OooO0O0;
                    ItemAnimator.OooO0OO oooO0OO5 = oooO00oOooOO0.f10842OooO0OO;
                    ...
                    ItemAnimator.OooO0OO oooO0OO6 = oooO00oOooOO0.f10841OooO0O0;
                ...
                oooO00oOooOO0.f10840OooO00o = 0;
                oooO00oOooOO0.f10841OooO0O0 = null;
                oooO00oOooOO0.f10842OooO0OO = null;
                o0000Ooo.OooO00o.f10839OooO0Oo.OooO00o(oooO00oOooOO0);
            }
        }
        this.mLayout.removeAndRecycleScrapInt(this.mRecycler);
        o0OOO0o o0ooo0o3 = this.mState;
        o0ooo0o3.f10728OooO0O0 = o0ooo0o3.f10732OooO0o0;
        this.mDataSetHasChangedAfterLayout = false;
        this.mDispatchItemsChangedEvent = false;
        o0ooo0o3.f10735OooOO0 = false;
        o0ooo0o3.f10736OooOO0O = false;
        this.mLayout.mRequestedSimpleAnimations = false;
        ArrayList<o0O0O00> arrayList = this.mRecycler.f10718OooO0O0;
        if (arrayList != null) {
            arrayList.clear();
        }
        ...
        onExitLayoutOrScroll();
        stopInterceptRequestLayout(false);
        o0000Ooo o0000ooo2 = this.mViewInfoStore;
        o0000ooo2.f10837OooO00o.clear();
        o0000ooo2.f10838OooO0O0.OooO0Oo();
        int[] iArr = this.mMinMaxLayoutPositions;
    ...
    private boolean findInterceptingOnItemTouchListener(MotionEvent motionEvent) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (o0oooo1.OooO0OO(motionEvent) && action != 3) {
    ...
    public static o0O0O00 getChildViewHolderInt(View view) {
        ...
        return ((LayoutParams) view.getLayoutParams()).f10692OooO0Oo;
    }

    public static void getDecoratedBoundsWithMarginsInt(View view, Rect rect) {
        LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
        Rect rect2 = layoutParams.f10694OooO0o0;
        ...
        for (int i = 0; i < iOooO0o0; i++) {
            ...
            if (childViewHolderInt != o0o0o00 && getChangedHolderKey(childViewHolderInt) == j) {
                ...
                if (adapter == null || !adapter.hasStableIds()) {
                    ...
                    sb.append(" \n View Holder 2:");
                    sb.append(o0o0o00);
                    throw new IllegalStateException(androidx.recyclerview.widget.OooO0o.OooO00o(this, sb));
                }
                StringBuilder sb2 = new StringBuilder("Two different ViewHolders have the same stable ID. Stable IDs in your adapter MUST BE unique and SHOULD NOT change.\n ViewHolder 1:");
                sb2.append(childViewHolderInt);
                sb2.append(" \n View Holder 2:");
                sb2.append(o0o0o00);
                throw new IllegalStateException(androidx.recyclerview.widget.OooO0o.OooO00o(this, sb2));
            }
        }
    ...
    private void initAutofill() {
        ...
        if ((i >= 26 ? ViewCompat.OooOo.OooO0OO(this) : 0) != 0 || i < 26) {
            return;
        }
        ViewCompat.OooOo.OooOOO0(this, 8);
    }

    private void initChildrenHelper() {
        this.mChildHelper = new androidx.recyclerview.widget.OooO(new OooO());
    }
    ...
    private boolean isPreferredNextFocus(View view, View view2, int i) {
        ...
        sb.append(i);
        throw new IllegalArgumentException(androidx.recyclerview.widget.OooO0o.OooO00o(this, sb));
    }
    ...
    private void nestedScrollByInternal(int i, int i2, @Nullable MotionEvent motionEvent, int i3) {
        ...
        androidx.recyclerview.widget.o0OoOo0 o0oooo1 = this.mGapWorker;
        if (o0oooo1 != null && (iReleaseHorizontalGlow != 0 || iReleaseVerticalGlow != 0)) {
            o0oooo1.OooO00o(this, iReleaseHorizontalGlow, iReleaseVerticalGlow);
        }
        stopNestedScroll(i3);
    }
    ...
    private void processAdapterUpdatesAndSetAnimationFlags() {
        ...
        if (this.mDataSetHasChangedAfterLayout) {
            ...
            oooO00o.OooOO0o(oooO00o.f10580OooO0O0);
            oooO00o.OooOO0o(oooO00o.f10581OooO0OO);
            oooO00o.f10583OooO0o = 0;
        ...
        this.mState.f10735OooOO0 = this.mFirstLayoutComplete && this.mItemAnimator != null && ((z = this.mDataSetHasChangedAfterLayout) || z3 || this.mLayout.mRequestedSimpleAnimations) && (!z || this.mAdapter.hasStableIds());
        o0OOO0o o0ooo0o2 = this.mState;
        if (o0ooo0o2.f10735OooOO0 && z3 && !this.mDataSetHasChangedAfterLayout && predictiveItemAnimationsEnabled()) {
            z2 = true;
        }
        o0ooo0o2.f10736OooOO0O = z2;
    }
    ...
    private void recoverFocusFromState() {
        ...
        o0O0O00 o0o0o00FindViewHolderForItemId = (this.mState.f10739OooOOO0 == -1 || !this.mAdapter.hasStableIds()) ? null : findViewHolderForItemId(this.mState.f10739OooOOO0);
        ...
        if (viewFindNextViewToFocus != null) {
            int i = this.mState.f10738OooOOO;
    ...
    private void requestChildOnScreen(@NonNull View view, @Nullable View view2) {
        ...
        if (layoutParams instanceof LayoutParams) {
            ...
            if (!layoutParams2.f10693OooO0o) {
                Rect rect = this.mTempRect;
                int i = rect.left;
                Rect rect2 = layoutParams2.f10694OooO0o0;
    ...
    private void resetFocusInfo() {
        o0OOO0o o0ooo0o2 = this.mState;
        o0ooo0o2.f10739OooOOO0 = -1L;
        o0ooo0o2.f10737OooOO0o = -1;
        o0ooo0o2.f10738OooOOO = -1;
    }
    ...
    private void saveFocusInfo() {
        ...
        this.mState.f10739OooOOO0 = this.mAdapter.hasStableIds() ? o0o0o00FindContainingViewHolder.getItemId() : -1L;
        o0OOO0o o0ooo0o2 = this.mState;
        if (this.mDataSetHasChangedAfterLayout) {
        ...
        o0ooo0o2.f10737OooOO0o = absoluteAdapterPosition;
        this.mState.f10738OooOOO = getDeepestFocusedViewWithId(o0o0o00FindContainingViewHolder.itemView);
    }
    ...
    private void setAdapterInternal(@Nullable Adapter<?> adapter, boolean z, boolean z2) {
        ...
        o00ooo2.f10717OooO00o.clear();
        o00ooo2.OooO0oo();
        o00ooo2.OooO0oO(adapter3, true);
        o00Oo0 o00oo0OooO0OO = o00ooo2.OooO0OO();
        if (adapter3 != null) {
            o00oo0OooO0OO.f10711OooO0O0--;
        }
        if (!z && o00oo0OooO0OO.f10711OooO0O0 == 0) {
            while (true) {
                SparseArray<o00Oo0.OooO00o> sparseArray = o00oo0OooO0OO.f10710OooO00o;
                if (i >= sparseArray.size()) {
                    break;
                }
                o00Oo0.OooO00o oooO00oValueAt = sparseArray.valueAt(i);
                Iterator<o0O0O00> it = oooO00oValueAt.f10713OooO00o.iterator();
                while (it.hasNext()) {
                    p054o0000OOo.OooO0o.OooO00o(it.next().itemView);
                }
                oooO00oValueAt.f10713OooO00o.clear();
                i++;
            }
        }
        if (adapter4 != null) {
    ...
    public void assertInLayoutOrScroll(String str) {
        ...
        if (str != null) {
            throw new IllegalStateException(androidx.recyclerview.widget.OooO0o.OooO00o(this, o0o0Oo.OooO00o(str)));
        }
        throw new IllegalStateException(androidx.recyclerview.widget.OooO0o.OooO00o(this, new StringBuilder("Cannot call this method unless RecyclerView is computing a layout or scrolling")));
    }
    ...
    public void assertNotInLayoutOrScroll(String str) {
        if (isComputingLayout()) {
            ...
            throw new IllegalStateException(androidx.recyclerview.widget.OooO0o.OooO00o(this, new StringBuilder("Cannot call this method while RecyclerView is computing a layout or scrolling")));
        }
        if (this.mDispatchScrollCounter > 0) {
            Log.w(TAG, "Cannot call this method in a scroll callback. Scroll callbacks mightbe run during a measure & layout pass where you cannot change theRecyclerView data. Any method call that might change the structureof the RecyclerView or the adapter contents should be postponed tothe next frame.", new IllegalStateException(androidx.recyclerview.widget.OooO0o.OooO00o(this, new StringBuilder(""))));
        }
    }
    ...
    public void clearOldPositions() {
        ...
        o00Ooo o00ooo2 = this.mRecycler;
        ArrayList<o0O0O00> arrayList = o00ooo2.f10719OooO0OO;
        int size = arrayList.size();
        for (int i2 = 0; i2 < size; i2++) {
            arrayList.get(i2).clearOldPosition();
        }
        ArrayList<o0O0O00> arrayList2 = o00ooo2.f10717OooO00o;
        int size2 = arrayList2.size();
        for (int i3 = 0; i3 < size2; i3++) {
            arrayList2.get(i3).clearOldPosition();
        }
        ArrayList<o0O0O00> arrayList3 = o00ooo2.f10718OooO0O0;
        if (arrayList3 != null) {
            int size3 = arrayList3.size();
            for (int i4 = 0; i4 < size3; i4++) {
                o00ooo2.f10718OooO0O0.get(i4).clearOldPosition();
            }
        }
    }
    ...
    public void consumePendingUpdateOperations() {
        if (!this.mFirstLayoutComplete || this.mDataSetHasChangedAfterLayout) {
            ...
            o0000oO.o000OOo.OooO00o.OooO00o(TRACE_ON_DATA_SET_CHANGE_LAYOUT_TAG);
            dispatchLayout();
        ...
        if (this.mAdapterHelper.OooO0oO()) {
            androidx.recyclerview.widget.OooO00o oooO00o = this.mAdapterHelper;
            int i2 = oooO00o.f10583OooO0o;
            if ((4 & i2) != 0) {
                if (!((i2 & 11) != 0)) {
                    int i3 = p063o0000oO.o000OOo.f33777OooO00o;
                    o0000oO.o000OOo.OooO00o.OooO00o(TRACE_HANDLE_ADAPTER_UPDATES_TAG);
                    startInterceptRequestLayout();
                    onEnterLayoutOrScroll();
                    this.mAdapterHelper.OooOO0();
            ...
            if (oooO00o.OooO0oO()) {
                int i4 = p063o0000oO.o000OOo.f33777OooO00o;
                o0000oO.o000OOo.OooO00o.OooO00o(TRACE_ON_DATA_SET_CHANGE_LAYOUT_TAG);
                dispatchLayout();
                o0000oO.o000OOo.OooO00o.OooO0O0();
            }
    ...
    public void dispatchLayout() {
        ...
        if (this.mState.f10730OooO0Oo == 1) {
            dispatchLayoutStep1();
            this.mLayout.setExactMeasureSpecsFrom(this);
            dispatchLayoutStep2();
        } else {
            androidx.recyclerview.widget.OooO00o oooO00o = this.mAdapterHelper;
            if (!oooO00o.f10581OooO0OO.isEmpty() && !oooO00o.f10580OooO0O0.isEmpty()) {
                z = true;
            }
    ...
    public final void fillRemainingScrollValues(o0OOO0o o0ooo0o2) {
        ...
        OverScroller overScroller = this.mViewFlinger.f10749OooO0o;
    ...
    public ViewGroup.LayoutParams generateDefaultLayoutParams() {
        ...
        throw new IllegalStateException(androidx.recyclerview.widget.OooO0o.OooO00o(this, new StringBuilder("RecyclerView has no LayoutManager")));
    }
    ...
    public int getAdapterPositionInRecyclerView(o0O0O00 o0o0o00) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            } else if (oooO0O0.f10586OooO0O0 <= i) {
                i += oooO0O0.f10588OooO0Oo;
            }
        }
        return i;
    ...
    @Nullable
    public o000000O getCompatAccessibilityDelegate() {
    ...
    public Rect getItemDecorInsetsForChild(View view) {
        LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
        boolean z = layoutParams.f10693OooO0o;
        Rect rect = layoutParams.f10694OooO0o0;
        if (!z) {
            return rect;
        }
        if (this.mState.f10733OooO0oO && (layoutParams.OooO0O0() || layoutParams.f10692OooO0Oo.isInvalid())) {
            return rect;
        }
        rect.set(0, 0, 0, 0);
        int size = this.mItemDecorations.size();
        ...
        layoutParams.f10693OooO0o = false;
        return rect;
    }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        if (stateListDrawable == null || drawable == null || stateListDrawable2 == null || drawable2 == null) {
            throw new IllegalArgumentException(androidx.recyclerview.widget.OooO0o.OooO00o(this, new StringBuilder("Trying to set fast scroller without both required drawables.")));
        }
        Resources resources = getContext().getResources();
        new androidx.recyclerview.widget.o000oOoO(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(o0O0ooO.fastscroll_default_thickness), resources.getDimensionPixelSize(o0O0ooO.fastscroll_minimum_range), resources.getDimensionPixelOffset(o0O0ooO.fastscroll_margin));
    }
    ...
    public boolean isNestedScrollingEnabled() {
        return getScrollingChildHelper().f5466OooO0Oo;
    }
    ...
    public void markItemDecorInsetsDirty() {
        int iOooO0oo = this.mChildHelper.OooO0oo();
        for (int i = 0; i < iOooO0oo; i++) {
            ((LayoutParams) this.mChildHelper.OooO0oO(i).getLayoutParams()).f10693OooO0o = true;
        }
        ArrayList<o0O0O00> arrayList = this.mRecycler.f10719OooO0OO;
        int size = arrayList.size();
        for (int i2 = 0; i2 < size; i2++) {
    ...
    public void offsetPositionRecordsForInsert(int i, int i2) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            ...
            if (o0o0o00 != null && o0o0o00.mPosition >= i) {
                if (sVerboseLoggingEnabled) {
                    Log.d(TAG, "offsetPositionRecordsForInsert cached " + i4 + " holder " + o0o0o00 + " now at position " + (o0o0o00.mPosition + i2));
                }
    ...
    public void offsetPositionRecordsForMove(int i, int i2) {
        ...
        for (int i12 = 0; i12 < size; i12++) {
            ...
            if (o0o0o00 != null && (i8 = o0o0o00.mPosition) >= i7 && i8 <= i6) {
                ...
                if (sVerboseLoggingEnabled) {
                    Log.d(TAG, "offsetPositionRecordsForMove cached child " + i12 + " holder " + o0o0o00);
                }
            }
        }
        requestLayout();
    ...
    public void offsetPositionRecordsForRemove(int i, int i2, boolean z) {
        ...
        while (true) {
            ...
            if (o0o0o00 != null) {
                ...
                if (i6 >= i3) {
                    if (sVerboseLoggingEnabled) {
                        Log.d(TAG, "offsetPositionRecordsForRemove cached " + size + " holder " + o0o0o00 + " now at position " + (o0o0o00.mPosition - i2));
                    }
    ...
    public void onAttachedToWindow() {
        ...
        if (ALLOW_THREAD_GAP_WORK) {
            ThreadLocal<androidx.recyclerview.widget.o0OoOo0> threadLocal = androidx.recyclerview.widget.o0OoOo0.f10943OooO0oo;
            androidx.recyclerview.widget.o0OoOo0 o0oooo1 = threadLocal.get();
            this.mGapWorker = o0oooo1;
            if (o0oooo1 == null) {
                this.mGapWorker = new androidx.recyclerview.widget.o0OoOo0();
                WeakHashMap<View, o000OOo0> weakHashMap = ViewCompat.f5341OooO00o;
                ...
                androidx.recyclerview.widget.o0OoOo0 o0oooo2 = this.mGapWorker;
                o0oooo2.f10945OooO0o = (long) (1.0E9f / refreshRate);
                threadLocal.set(o0oooo2);
            }
            androidx.recyclerview.widget.o0OoOo0 o0oooo3 = this.mGapWorker;
            o0oooo3.getClass();
            boolean z = sDebugAssertionsEnabled;
            ArrayList<RecyclerView> arrayList = o0oooo3.f10944OooO0Oo;
    ...
    public void onDetachedFromWindow() {
        androidx.recyclerview.widget.o0OoOo0 o0oooo1;
        ...
        while (o0000Ooo.OooO00o.f10839OooO0Oo.OooO0O0() != null) {
        }
        o00Ooo o00ooo2 = this.mRecycler;
        int i = 0;
        while (true) {
        ...
        while (true) {
            if (!(i3 < getChildCount())) {
                if (!ALLOW_THREAD_GAP_WORK || (o0oooo1 = this.mGapWorker) == null) {
                    return;
                }
                boolean zRemove = o0oooo1.f10944OooO0Oo.remove(this);
            ...
            ArrayList<p054o0000OOo.OooO> arrayList2 = p054o0000OOo.OooO0o.OooO0O0(childAt).f33626OooO00o;
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        int i5 = p063o0000oO.o000OOo.f33777OooO00o;
        o0000oO.o000OOo.OooO00o.OooO00o(TRACE_ON_LAYOUT_TAG);
        dispatchLayout();
        o0000oO.o000OOo.OooO00o.OooO0O0();
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.mAdapterUpdateDuringMeasure) {
            ...
            onExitLayoutOrScroll();
            o0OOO0o o0ooo0o2 = this.mState;
            if (o0ooo0o2.f10736OooOO0O) {
                o0ooo0o2.f10733OooO0oO = true;
            } else {
                this.mAdapterHelper.OooO0OO();
                this.mState.f10733OooO0oO = false;
            }
            this.mAdapterUpdateDuringMeasure = false;
            stopInterceptRequestLayout(false);
        } else if (this.mState.f10736OooOO0O) {
            setMeasuredDimension(getMeasuredWidth(), getMeasuredHeight());
            return;
        }
        Adapter adapter = this.mAdapter;
        if (adapter != null) {
            this.mState.f10732OooO0o0 = adapter.getItemCount();
        } else {
            this.mState.f10732OooO0o0 = 0;
        }
        startInterceptRequestLayout();
        this.mLayout.onMeasure(this.mRecycler, this.mState, i, i2);
        stopInterceptRequestLayout(false);
    ...
    public Parcelable onSaveInstanceState() {
        ...
        if (savedState2 != null) {
            savedState.f10709OooO0o = savedState2.f10709OooO0o;
        } else {
            Oooo000 oooo000 = this.mLayout;
            if (oooo000 != null) {
                savedState.f10709OooO0o = oooo000.onSaveInstanceState();
            } else {
                savedState.f10709OooO0o = null;
            }
        }
        return savedState;
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (this.mScrollState == 1) {
                ...
                androidx.recyclerview.widget.o0OoOo0 o0oooo1 = this.mGapWorker;
                if (o0oooo1 != null && (iReleaseHorizontalGlow != 0 || i3 != 0)) {
                    o0oooo1.OooO00o(this, iReleaseHorizontalGlow, i3);
                }
            }
        } else if (actionMasked == 3) {
            cancelScroll();
    ...
    public void recordAnimationInfoIfBouncedHiddenView(o0O0O00 o0o0o00, ItemAnimator.OooO0OO oooO0OO) {
        ...
        if (this.mState.f10734OooO0oo && o0o0o00.isUpdated() && !o0o0o00.isRemoved() && !o0o0o00.shouldIgnore()) {
            this.mViewInfoStore.f10838OooO0O0.OooO(getChangedHolderKey(o0o0o00), o0o0o00);
        }
        p190o00o0O.OooOo<o0O0O00, o0000Ooo.OooO00o> oooOo = this.mViewInfoStore.f10837OooO00o;
        o0000Ooo.OooO00o orDefault = oooOo.getOrDefault(o0o0o00, null);
        if (orDefault == null) {
            orDefault = o0000Ooo.OooO00o.OooO00o();
    ...
    /* JADX WARN: Instruction removed from duplicated block: B:13:0x003e, please report this as an issue */
    public boolean removeAnimatingView(View view) {
        ...
        int iIndexOfChild = RecyclerView.this.indexOfChild(view);
        if (iIndexOfChild != -1) {
            androidx.recyclerview.widget.OooO.OooO00o oooO00o = oooO.f10575OooO0O0;
    ...
    public void removeDetachedView(View view, boolean z) {
        ...
        if (childViewHolderInt != null) {
            ...
            sb2.append(view);
            throw new IllegalArgumentException(androidx.recyclerview.widget.OooO0o.OooO00o(this, sb2));
        }
        view.clearAnimation();
    ...
    public void saveOldPositions() {
        ...
        for (int i = 0; i < iOooO0oo; i++) {
            ...
            if (sDebugAssertionsEnabled && childViewHolderInt.mPosition == -1 && !childViewHolderInt.isRemoved()) {
                throw new IllegalStateException(androidx.recyclerview.widget.OooO0o.OooO00o(this, new StringBuilder("view holder cannot have position -1 unless it is removed")));
            }
            if (!childViewHolderInt.shouldIgnore()) {
    ...
    public void scrollStep(int i, int i2, @Nullable int[] iArr) {
        ...
        onEnterLayoutOrScroll();
        int i3 = p063o0000oO.o000OOo.f33777OooO00o;
        o0000oO.o000OOo.OooO00o.OooO00o(TRACE_SCROLL_TAG);
        fillRemainingScrollValues(this.mState);
    ...
    public void setAccessibilityDelegateCompat(@Nullable o000000O o000000o2) {
        this.mAccessibilityDelegate = o000000o2;
        ViewCompat.OooOOOO(this, o000000o2);
    }
    ...
    public void setItemAnimator(@Nullable ItemAnimator itemAnimator) {
        ...
        if (itemAnimator2 != null) {
            ...
            this.mItemAnimator.f10684OooO00o = null;
        }
        this.mItemAnimator = itemAnimator;
        if (itemAnimator != null) {
            itemAnimator.f10684OooO00o = this.mItemAnimatorListener;
        }
    }

    public void setItemViewCacheSize(int i) {
        o00Ooo o00ooo2 = this.mRecycler;
        o00ooo2.f10722OooO0o0 = i;
        o00ooo2.OooOOOO();
    }
    ...
    public void setLayoutManager(@Nullable Oooo000 oooo000) {
        androidx.recyclerview.widget.OooO.OooO0O0 oooO0O0;
        RecyclerView recyclerView;
        ...
        if (this.mLayout != null) {
            ...
            o00ooo3.f10717OooO00o.clear();
            o00ooo3.OooO0oo();
        }
        androidx.recyclerview.widget.OooO oooO = this.mChildHelper;
        oooO.f10575OooO0O0.OooO0oO();
        ArrayList arrayList = oooO.f10576OooO0OO;
        int size = arrayList.size();
        while (true) {
            size--;
            oooO0O0 = oooO.f10574OooO00o;
            if (size < 0) {
                break;
            }
        ...
        OooO oooO3 = (OooO) oooO0O0;
        int iOooO00o = oooO3.OooO00o();
        int i = 0;
        while (true) {
        ...
        if (oooo000 != null) {
            if (oooo000.mRecyclerView != null) {
                ...
                throw new IllegalArgumentException(androidx.recyclerview.widget.OooO0o.OooO00o(oooo000.mRecyclerView, sb));
            }
    ...
    public void setRecycledViewPool(@Nullable o00Oo0 o00oo1) {
        ...
        o00Oo0 o00oo2 = o00ooo2.f10723OooO0oO;
        if (o00oo2 != null) {
            o00oo2.f10711OooO0O0--;
        }
        o00ooo2.f10723OooO0oO = o00oo1;
        if (o00oo1 != null && recyclerView.getAdapter() != null) {
            o00ooo2.f10723OooO0oO.f10711OooO0O0++;
        }
        o00ooo2.OooO0o();
    }
    ...
    void setScrollState(int i) {
        ...
        if (sVerboseLoggingEnabled) {
            StringBuilder sbOooO0O0 = o0000O0.OooO0O0("setting scroll state to ", i, " from ");
            sbOooO0O0.append(this.mScrollState);
            Log.d(TAG, sbOooO0O0.toString(), new Exception());
        }
        this.mScrollState = i;
        if (i != 2) {
    ...
    public void stopInterceptRequestLayout(boolean z) {
        if (this.mInterceptRequestLayoutDepth < 1) {
            if (sDebugAssertionsEnabled) {
                throw new IllegalStateException(androidx.recyclerview.widget.OooO0o.OooO00o(this, new StringBuilder("stopInterceptRequestLayout was called more times than startInterceptRequestLayout.")));
            }
    ...
    public void viewRangeUpdate(int i, int i2, Object obj) {
        ...
        for (int i6 = 0; i6 < iOooO0oo; i6++) {
            ...
            if (childViewHolderInt != null && !childViewHolderInt.shouldIgnore() && (i4 = childViewHolderInt.mPosition) >= i && i4 < i5) {
                ...
                ((LayoutParams) viewOooO0oO.getLayoutParams()).f10693OooO0o = true;
            }
        }
        o00Ooo o00ooo2 = this.mRecycler;
        ArrayList<o0O0O00> arrayList = o00ooo2.f10719OooO0OO;
    ...
    public static abstract class Adapter<VH extends o0O0O00> {
        ...
        public final void bindViewHolder(@NonNull VH vh, int i) {
            ...
            if (z) {
                ...
                vh.setFlags(1, 519);
                int i2 = p063o0000oO.o000OOo.f33777OooO00o;
                o0000oO.o000OOo.OooO00o.OooO00o(RecyclerView.TRACE_BIND_VIEW_TAG);
            }
            ...
            if (RecyclerView.sDebugAssertionsEnabled) {
                if (vh.itemView.getParent() == null) {
                    ...
                    WeakHashMap<View, o000OOo0> weakHashMap = ViewCompat.f5341OooO00o;
                    if (ViewCompat.OooOO0O.OooO0O0(view) != vh.isTmpDetached()) {
                        throw new IllegalStateException("Temp-detached state out of sync with reality. holder.isTmpDetached(): " + vh.isTmpDetached() + ", attached to window: " + ViewCompat.OooOO0O.OooO0O0(vh.itemView) + ", holder: " + vh);
                    }
                }
                if (vh.itemView.getParent() == null) {
            ...
            if (z) {
                ...
                if (layoutParams instanceof LayoutParams) {
                    ((LayoutParams) layoutParams).f10693OooO0o = true;
                }
                int i3 = p063o0000oO.o000OOo.f33777OooO00o;
                o0000oO.o000OOo.OooO00o.OooO0O0();
            }
        ...
        public boolean canRestoreState() {
            int i = OooOO0O.f10701OooO00o[this.mStateRestorationPolicy.ordinal()];
            if (i != 1) {
        ...
        public final VH createViewHolder(@NonNull ViewGroup viewGroup, int i) {
            try {
                int i2 = p063o0000oO.o000OOo.f33777OooO00o;
                o0000oO.o000OOo.OooO00o.OooO00o(RecyclerView.TRACE_CREATE_VIEW_TAG);
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, o00O0000.recyclerViewStyle);
    }
    ...
    public void onExitLayoutOrScroll(boolean z) {
        ...
        if (i < 1) {
            if (sDebugAssertionsEnabled && i < 0) {
                throw new IllegalStateException(androidx.recyclerview.widget.OooO0o.OooO00o(this, new StringBuilder("layout or scroll counter cannot go below zero.Some calls are not matching")));
            }
            this.mLayoutOrScrollCounter = 0;
            if (z) {
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mViewInfoStore = new o0000Ooo();
        ...
        this.mItemAnimator = new androidx.recyclerview.widget.OooOO0O();
        this.mScrollState = 0;
        ...
        this.mPrefetchRegistry = ALLOW_THREAD_GAP_WORK ? new androidx.recyclerview.widget.o0OoOo0.OooO0O0() : null;
        ...
        if (i2 >= 26) {
            ...
            fOooO00o = o000O00.OooO00o.OooO00o(viewConfiguration);
        } else {
            fOooO00o = o000O00.OooO00o(viewConfiguration, context);
        }
        this.mScaledHorizontalScrollFactor = fOooO00o;
        if (i2 >= 26) {
            fOooO00o2 = o000O00.OooO00o.OooO0O0(viewConfiguration);
        } else {
            fOooO00o2 = o000O00.OooO00o(viewConfiguration, context);
        }
        ...
        setWillNotDraw(getOverScrollMode() == 2);
        this.mItemAnimator.f10684OooO00o = this.mItemAnimatorListener;
        initAdapterManager();
        initChildrenHelper();
        initAutofill();
        WeakHashMap<View, o000OOo0> weakHashMap = ViewCompat.f5341OooO00o;
        ...
        setAccessibilityDelegateCompat(new o000000O(this));
        int[] iArr = o00O000.RecyclerView;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, iArr, i, 0);
        ViewCompat.OooOOO(this, context, iArr, attributeSet, typedArrayObtainStyledAttributes, i, 0);
        String string = typedArrayObtainStyledAttributes.getString(o00O000.RecyclerView_layoutManager);
        if (typedArrayObtainStyledAttributes.getInt(o00O000.RecyclerView_android_descendantFocusability, -1) == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = typedArrayObtainStyledAttributes.getBoolean(o00O000.RecyclerView_android_clipToPadding, true);
        boolean z = typedArrayObtainStyledAttributes.getBoolean(o00O000.RecyclerView_fastScrollEnabled, false);
        this.mEnableFastScroller = z;
        if (z) {
            initFastScroller((StateListDrawable) typedArrayObtainStyledAttributes.getDrawable(o00O000.RecyclerView_fastScrollVerticalThumbDrawable), typedArrayObtainStyledAttributes.getDrawable(o00O000.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) typedArrayObtainStyledAttributes.getDrawable(o00O000.RecyclerView_fastScrollHorizontalThumbDrawable), typedArrayObtainStyledAttributes.getDrawable(o00O000.RecyclerView_fastScrollHorizontalTrackDrawable));
        }
        typedArrayObtainStyledAttributes.recycle();
        ...
        int i3 = p054o0000OOo.OooO0o.f33624OooO00o;
        Intrinsics.checkNotNullParameter(this, "<this>");
        setTag(p054o0000OOo.OooO0o.f33625OooO0O0, Boolean.TRUE);
    }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public o0O0O00 f10692OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public boolean f10693OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final Rect f10694OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public boolean f10695OooO0oO;

        public LayoutParams(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            this.f10694OooO0o0 = new Rect();
            this.f10693OooO0o = true;
            this.f10695OooO0oO = false;
        }

        public final int OooO00o() {
            return this.f10692OooO0Oo.getLayoutPosition();
        }

        public final boolean OooO0O0() {
            return this.f10692OooO0Oo.isUpdated();
        }

        public final boolean OooO0OO() {
            return this.f10692OooO0Oo.isRemoved();
        }
