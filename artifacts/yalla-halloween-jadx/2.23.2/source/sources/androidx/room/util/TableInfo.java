...
public final class TableInfo {
    ...
    @JvmField
    @NotNull
    public final String f11016OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @JvmField
    @NotNull
    public final Map<String, OooO00o> f11017OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @JvmField
    @NotNull
    public final Set<OooO0O0> f11018OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @JvmField
    @Nullable
    public final Set<OooO0o> f11019OooO0Oo;
    ...
    public static final class OooO00o {
        ...
        @JvmField
        @NotNull
        public final String f11020OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        @JvmField
        @NotNull
        public final String f11021OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        @JvmField
        public final boolean f11022OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        @JvmField
        public final int f11023OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        @JvmField
        public final int f11024OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        @JvmField
        @Nullable
        public final String f11025OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        @JvmField
        public final int f11026OooO0oO;

        /* JADX INFO: renamed from: androidx.room.util.TableInfo$OooO00o$OooO00o, reason: collision with other inner class name */
        public static final class C0181OooO00o {
            @JvmStatic
        ...
        public OooO00o(int i, int i2, @NotNull String name, @NotNull String type, @Nullable String str, boolean z) {
            ...
            this.f11020OooO00o = name;
            this.f11021OooO0O0 = type;
            this.f11022OooO0OO = z;
            this.f11023OooO0Oo = i;
            this.f11025OooO0o0 = str;
            this.f11024OooO0o = i2;
            if (type == null) {
                i3 = 5;
            } else {
                Locale US = Locale.US;
                ...
                if (StringsKt__StringsKt.contains$default(upperCase, "INT", false, 2, (Object) null)) {
                    i3 = 3;
                } else if (StringsKt__StringsKt.contains$default(upperCase, "CHAR", false, 2, (Object) null) || StringsKt__StringsKt.contains$default(upperCase, "CLOB", false, 2, (Object) null) || StringsKt__StringsKt.contains$default(upperCase, "TEXT", false, 2, (Object) null)) {
                    i3 = 2;
                } else if (StringsKt__StringsKt.contains$default(upperCase, "BLOB", false, 2, (Object) null)) {
                    i3 = 5;
                } else {
                    i3 = (StringsKt__StringsKt.contains$default(upperCase, "REAL", false, 2, (Object) null) || StringsKt__StringsKt.contains$default(upperCase, "FLOA", false, 2, (Object) null) || StringsKt__StringsKt.contains$default(upperCase, "DOUB", false, 2, (Object) null)) ? 4 : 1;
                }
            }
            this.f11026OooO0oO = i3;
        }
        ...
        */
        public final boolean equals(@Nullable Object obj) {
            ...
            if (this.f11023OooO0Oo != oooO00o.f11023OooO0Oo) {
                return false;
            }
            if (!Intrinsics.areEqual(this.f11020OooO00o, oooO00o.f11020OooO00o) || this.f11022OooO0OO != oooO00o.f11022OooO0OO) {
                return false;
            }
            int i = oooO00o.f11024OooO0o;
            String str = oooO00o.f11025OooO0o0;
            String str2 = this.f11025OooO0o0;
            int i2 = this.f11024OooO0o;
            if (i2 == 1 && i == 2 && str2 != null && !C0181OooO00o.OooO00o(str2, str)) {
                return false;
            }
            if (i2 == 2 && i == 1 && str != null && !C0181OooO00o.OooO00o(str, str2)) {
                return false;
            }
            if (i2 != 0 && i2 == i) {
            ...
            return this.f11026OooO0oO == oooO00o.f11026OooO0oO;
        }

        public final int hashCode() {
            return (((((this.f11020OooO00o.hashCode() * 31) + this.f11026OooO0oO) * 31) + (this.f11022OooO0OO ? 1231 : 1237)) * 31) + this.f11023OooO0Oo;
        }

        @NotNull
        public final String toString() {
            StringBuilder sb = new StringBuilder("Column{name='");
            sb.append(this.f11020OooO00o);
            sb.append("', type='");
            sb.append(this.f11021OooO0O0);
            sb.append("', affinity='");
            sb.append(this.f11026OooO0oO);
            sb.append("', notNull=");
            sb.append(this.f11022OooO0OO);
            sb.append(", primaryKeyPosition=");
            sb.append(this.f11023OooO0Oo);
            sb.append(", defaultValue='");
            String str = this.f11025OooO0o0;
            if (str == null) {
                str = "undefined";
            }
    ...
    public static final class OooO0O0 {
        ...
        @JvmField
        @NotNull
        public final String f11027OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        @JvmField
        @NotNull
        public final String f11028OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        @JvmField
        @NotNull
        public final String f11029OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        @JvmField
        @NotNull
        public final List<String> f11030OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        @JvmField
        @NotNull
        public final List<String> f11031OooO0o0;
        ...
        public OooO0O0(@NotNull String referenceTable, @NotNull String onDelete, @NotNull String onUpdate, @NotNull List<String> columnNames, @NotNull List<String> referenceColumnNames) {
            ...
            this.f11027OooO00o = referenceTable;
            this.f11028OooO0O0 = onDelete;
            this.f11029OooO0OO = onUpdate;
            this.f11030OooO0Oo = columnNames;
            this.f11031OooO0o0 = referenceColumnNames;
        }
        ...
        public final boolean equals(@Nullable Object obj) {
            ...
            if (Intrinsics.areEqual(this.f11027OooO00o, oooO0O0.f11027OooO00o) && Intrinsics.areEqual(this.f11028OooO0O0, oooO0O0.f11028OooO0O0) && Intrinsics.areEqual(this.f11029OooO0OO, oooO0O0.f11029OooO0OO) && Intrinsics.areEqual(this.f11030OooO0Oo, oooO0O0.f11030OooO0Oo)) {
                return Intrinsics.areEqual(this.f11031OooO0o0, oooO0O0.f11031OooO0o0);
            }
            return false;
        }

        public final int hashCode() {
            return this.f11031OooO0o0.hashCode() + ((this.f11030OooO0Oo.hashCode() + androidx.compose.animation.OooO0O0.OooO00o(this.f11029OooO0OO, androidx.compose.animation.OooO0O0.OooO00o(this.f11028OooO0O0, this.f11027OooO00o.hashCode() * 31, 31), 31)) * 31);
        }

        @NotNull
        public final String toString() {
            return "ForeignKey{referenceTable='" + this.f11027OooO00o + "', onDelete='" + this.f11028OooO0O0 + " +', onUpdate='" + this.f11029OooO0OO + "', columnNames=" + this.f11030OooO0Oo + ", referenceColumnNames=" + this.f11031OooO0o0 + '}';
        }
    }
    ...
    public static final class OooO0OO implements Comparable<OooO0OO> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        @NotNull
        public final String f11033OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final int f11034OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        @NotNull
        public final String f11035OooO0oO;

        public OooO0OO(int i, int i2, @NotNull String from, @NotNull String to) {
            Intrinsics.checkNotNullParameter(from, "from");
            Intrinsics.checkNotNullParameter(to, "to");
            this.f11032OooO0Oo = i;
            this.f11034OooO0o0 = i2;
            this.f11033OooO0o = from;
            this.f11035OooO0oO = to;
        }
        ...
        public final int compareTo(OooO0OO oooO0OO) {
            ...
            int i = this.f11032OooO0Oo - other.f11032OooO0Oo;
            return i == 0 ? this.f11034OooO0o0 - other.f11034OooO0o0 : i;
        }
    }
    ...
    public static final class OooO0o {
        ...
        @JvmField
        @NotNull
        public final String f11036OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        @JvmField
        public final boolean f11037OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        @JvmField
        @NotNull
        public final List<String> f11038OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        @JvmField
        @NotNull
        public final List<String> f11039OooO0Oo;
        ...
        public OooO0o(@NotNull String name, boolean z, @NotNull List<String> columns, @NotNull List<String> orders) {
            ...
            this.f11036OooO00o = name;
            this.f11037OooO0O0 = z;
            this.f11038OooO0OO = columns;
            this.f11039OooO0Oo = orders;
            if (orders.isEmpty()) {
        ...
        public final boolean equals(@Nullable Object obj) {
            ...
            if (this.f11037OooO0O0 != oooO0o.f11037OooO0O0 || !Intrinsics.areEqual(this.f11038OooO0OO, oooO0o.f11038OooO0OO) || !Intrinsics.areEqual(this.f11039OooO0Oo, oooO0o.f11039OooO0Oo)) {
                return false;
            }
            String str = this.f11036OooO00o;
            boolean zStartsWith$default = StringsKt__StringsJVMKt.startsWith$default(str, "index_", false, 2, null);
            String str2 = oooO0o.f11036OooO00o;
            return zStartsWith$default ? StringsKt__StringsJVMKt.startsWith$default(str2, "index_", false, 2, null) : Intrinsics.areEqual(str, str2);
        }

        public final int hashCode() {
            String str = this.f11036OooO00o;
            return this.f11039OooO0Oo.hashCode() + ((this.f11038OooO0OO.hashCode() + ((((StringsKt__StringsJVMKt.startsWith$default(str, "index_", false, 2, null) ? -1184239155 : str.hashCode()) * 31) + (this.f11037OooO0O0 ? 1 : 0)) * 31)) * 31);
        }

        @NotNull
        public final String toString() {
            return "Index{name='" + this.f11036OooO00o + "', unique=" + this.f11037OooO0O0 + ", columns=" + this.f11038OooO0OO + ", orders=" + this.f11039OooO0Oo + "'}";
        }
    }
    ...
    public TableInfo(@NotNull String name, @NotNull Map<String, OooO00o> columns, @NotNull Set<OooO0O0> foreignKeys, @Nullable Set<OooO0o> set) {
        ...
        this.f11016OooO00o = name;
        this.f11017OooO0O0 = columns;
        this.f11018OooO0OO = foreignKeys;
        this.f11019OooO0Oo = set;
    }
                ...
                while (cursorQuery2.moveToNext()) {
                    if (cursorQuery2.getInt(columnIndex7) == 0) {
                        ...
                        for (Object obj : listSorted) {
                            ...
                            if (((OooO0OO) obj).f11032OooO0Oo == i9) {
                                arrayList3.add(obj);
                            }
                            listSorted = list;
                        }
                        ...
                        for (OooO0OO oooO0OO : arrayList3) {
                            arrayList.add(oooO0OO.f11033OooO0o);
                            arrayList2.add(oooO0OO.f11035OooO0oO);
                        }
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        if (!Intrinsics.areEqual(this.f11016OooO00o, tableInfo.f11016OooO00o) || !Intrinsics.areEqual(this.f11017OooO0O0, tableInfo.f11017OooO0O0) || !Intrinsics.areEqual(this.f11018OooO0OO, tableInfo.f11018OooO0OO)) {
            return false;
        }
        Set<OooO0o> set2 = this.f11019OooO0Oo;
        if (set2 == null || (set = tableInfo.f11019OooO0Oo) == null) {
            return true;
        }
    ...
    public final int hashCode() {
        return this.f11018OooO0OO.hashCode() + ((this.f11017OooO0O0.hashCode() + (this.f11016OooO00o.hashCode() * 31)) * 31);
    }

    @NotNull
    public final String toString() {
        return "TableInfo{name='" + this.f11016OooO00o + "', columns=" + this.f11017OooO0O0 + ", foreignKeys=" + this.f11018OooO0OO + ", indices=" + this.f11019OooO0Oo + '}';
    }
}
