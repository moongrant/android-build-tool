...
public final class OooO00o {
    ...
    public boolean f11041OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @Nullable
    public Bundle f11042OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public boolean f11043OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @Nullable
    public Recreator.OooO00o f11045OooO0o0;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    @NotNull
    public final SafeIterableMap<String, OooO0O0> f11040OooO00o = new SafeIterableMap<>();

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public boolean f11044OooO0o = true;

    /* JADX INFO: renamed from: androidx.savedstate.OooO00o$OooO00o, reason: collision with other inner class name */
    public interface InterfaceC0182OooO00o {
    ...
    public final Bundle OooO00o(@NotNull String key) {
        ...
        if (!this.f11043OooO0Oo) {
            throw new IllegalStateException("You can consumeRestoredStateForKey only after super.onCreate of corresponding component".toString());
        }
        Bundle bundle = this.f11042OooO0OO;
        if (bundle == null) {
            return null;
        }
        Bundle bundle2 = bundle != null ? bundle.getBundle(key) : null;
        Bundle bundle3 = this.f11042OooO0OO;
        if (bundle3 != null) {
            bundle3.remove(key);
        }
        Bundle bundle4 = this.f11042OooO0OO;
        boolean z = false;
        if (bundle4 != null && !bundle4.isEmpty()) {
            z = true;
        }
        if (!z) {
            this.f11042OooO0OO = null;
        }
        return bundle2;
    }
    ...
    public final OooO0O0 OooO0O0() {
        ...
        for (Map.Entry<String, OooO0O0> components : this.f11040OooO00o) {
    ...
    public final void OooO0OO(@NotNull String key, @NotNull OooO0O0 provider) {
        ...
        if (!(this.f11040OooO00o.putIfAbsent(key, provider) == null)) {
