...
public class ChangeImageTransform extends Transition {
    ...
    public static final String[] f11208OooOoo0 = {"android:changeImageTransform:matrix", "android:changeImageTransform:bounds"};

    /* JADX INFO: renamed from: OooOoo, reason: collision with root package name */
    public static final OooO00o f11207OooOoo = new OooO00o();

    /* JADX INFO: renamed from: OooOooO, reason: collision with root package name */
    public static final OooO0O0 f11209OooOooO = new OooO0O0();
    ...
    public class OooO0O0 extends Property<ImageView, Matrix> {
        ...
        public final void set(ImageView imageView, Matrix matrix) {
            ...
            if (oOO00O.OooOOOO.f60140OooO00o) {
                try {
                    imageView2.animateTransform(matrix2);
                } catch (NoSuchMethodError unused) {
                    oOO00O.OooOOOO.f60140OooO00o = false;
                }
            }
        }
    }
    ...
    public static /* synthetic */ class OooO0OO {
        ...
        public static final /* synthetic */ int[] f11210OooO00o;
        ...
        static {
            ...
            try {
                f11210OooO00o[ImageView.ScaleType.CENTER_CROP.ordinal()] = 2;
    ...
    public final Animator OooOOO0(@NonNull ViewGroup viewGroup, @Nullable o00oO0o o00oo0o2, @Nullable o00oO0o o00oo0o3) {
        ...
        ImageView imageView = (ImageView) o00oo0o3.f60158OooO0O0;
        Drawable drawable = imageView.getDrawable();
        int intrinsicWidth = drawable.getIntrinsicWidth();
        int intrinsicHeight = drawable.getIntrinsicHeight();
        OooO0O0 oooO0O0 = f11209OooOooO;
        if (intrinsicWidth <= 0 || intrinsicHeight <= 0) {
            OooO00o oooO00o = f11207OooOoo;
            oOO00O.OooOo00.OooO00o oooO00o2 = oOO00O.OooOo00.f60141OooO00o;
            return ObjectAnimator.ofObject(imageView, oooO0O0, oooO00o, oooO00o2, oooO00o2);
        }
        if (matrix == null) {
            matrix = oOO00O.OooOo00.f60141OooO00o;
        }
        if (matrix2 == null) {
            matrix2 = oOO00O.OooOo00.f60141OooO00o;
        }
    ...
    public final void Oooo0OO(o00oO0o o00oo0o2) {
        ...
        if ((view instanceof ImageView) && view.getVisibility() == 0) {
            ...
            if (drawable.getIntrinsicWidth() <= 0 || drawable.getIntrinsicHeight() <= 0) {
                ...
                int i = OooO0OO.f11210OooO00o[imageView.getScaleType().ordinal()];
                if (i == 1) {
