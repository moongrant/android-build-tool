...
public class ParcelImpl implements Parcelable {
    ...
    public final OooOo f11347OooO0Oo;
    ...
    public ParcelImpl(OooOo oooOo) {
        this.f11347OooO0Oo = oooOo;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        new OooOo00(parcel).OooOo0o(this.f11347OooO0Oo);
    }

    public ParcelImpl(Parcel parcel) {
        this.f11347OooO0Oo = new OooOo00(parcel).OooOOO();
    }
}
