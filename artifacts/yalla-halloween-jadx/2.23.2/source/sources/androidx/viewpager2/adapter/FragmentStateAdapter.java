...
public abstract class FragmentStateAdapter extends RecyclerView.Adapter<FragmentViewHolder> implements StatefulAdapter {
    ...
    final OooOOOO<Fragment> mFragments;
    private boolean mHasStaleFragments;
    boolean mIsInGracePeriod;
    private final OooOOOO<Integer> mItemIdToViewHolder;
    final Lifecycle mLifecycle;
    private final OooOOOO<Fragment.SavedState> mSavedStates;
                    ...
                    for (int i = 0; i < FragmentStateAdapter.this.mFragments.OooOO0O(); i++) {
                        ...
                        if (fragmentOooOO0o.isAdded()) {
                            if (jOooO0oo != this.mPrimaryItemId) {
                                ...
                                oooO00o.OooOOO0(fragmentOooOO0o, state);
                                arrayList.add(FragmentStateAdapter.this.mFragmentEventDispatcher.dispatchMaxLifecyclePreUpdated(fragmentOooOO0o, state));
                            } else {
    ...
    private void ensureFragment(int i) {
        ...
        OooOOOO<Fragment> oooOOOO = this.mFragments;
        if (oooOOOO.f38559OooO0Oo) {
            oooOOOO.OooO0o();
        }
        if (OooOOO0.OooO0O0(oooOOOO.f38561OooO0o0, oooOOOO.f38562OooO0oO, itemId) >= 0) {
            return;
        }
    ...
    private boolean isFragmentViewBound(long j) {
        View view;
        OooOOOO<Integer> oooOOOO = this.mItemIdToViewHolder;
        if (oooOOOO.f38559OooO0Oo) {
            oooOOOO.OooO0o();
        }
    ...
    private void removeFragment(long j) {
        ...
        if (fragment.isAdded() && containsItem(j)) {
            ...
            Fragment.SavedState savedStateOoooOoO = this.mFragmentManager.OoooOoO(fragment);
            this.mFragmentEventDispatcher.dispatchPostEvents(listDispatchPreSavedInstanceState);
            this.mSavedStates.OooO(j, savedStateOoooOoO);
        }
    ...
    private void scheduleViewAttach(final Fragment fragment, @NonNull final FrameLayout frameLayout) {
        this.mFragmentManager.OoooOO0(new FragmentManager.OooOo00() { // from class: androidx.viewpager2.adapter.FragmentStateAdapter.2
    ...
    public void gcFragments() {
        ...
        for (int i = 0; i < this.mFragments.OooOO0O(); i++) {
            ...
            if (!containsItem(jOooO0oo)) {
                oooOO0O.add(Long.valueOf(jOooO0oo));
        ...
        if (!this.mIsInGracePeriod) {
            ...
            for (int i2 = 0; i2 < this.mFragments.OooOO0O(); i2++) {
                ...
                if (!isFragmentViewBound(jOooO0oo2)) {
                    oooOO0O.add(Long.valueOf(jOooO0oo2));
                }
            }
        }
    ...
    public void placeFragmentInViewHolder(@NonNull final FragmentViewHolder fragmentViewHolder) {
        ...
        if (shouldDelayFragmentTransactions()) {
            if (this.mFragmentManager.f5850Oooo00o) {
                return;
            }
    ...
    public FragmentStateAdapter(@NonNull FragmentManager fragmentManager, @NonNull Lifecycle lifecycle) {
        this.mFragments = new OooOOOO<>();
        this.mSavedStates = new OooOOOO<>();
        this.mItemIdToViewHolder = new OooOOOO<>();
