...
public final class Lifecycles {
    ...
    public static final class OooO00o extends ContinuationImpl {
        ...
        public Lifecycle f11725OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public /* synthetic */ Object f11726OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public Ref.ObjectRef f11727OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public int f11728OooO0oO;

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @Nullable
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f11726OooO0o = obj;
            this.f11728OooO0oO |= Integer.MIN_VALUE;
    ...
    public static final Object OooO00o(@NotNull Lifecycle lifecycle, @NotNull Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (continuation instanceof OooO00o) {
            ...
            int i = oooO00o.f11728OooO0oO;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO00o.f11728OooO0oO = i - Integer.MIN_VALUE;
            } else {
        ...
        Object obj = oooO00o.f11726OooO0o;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = oooO00o.f11728OooO0oO;
        if (i2 != 0) {
            if (i2 != 1) {
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
            objectRef = oooO00o.f11727OooO0o0;
            lifecycle2 = oooO00o.f11725OooO0Oo;
            try {
        ...
        try {
            oooO00o.f11725OooO0Oo = lifecycle;
            oooO00o.f11727OooO0o0 = objectRef2;
            oooO00o.f11728OooO0oO = 1;
