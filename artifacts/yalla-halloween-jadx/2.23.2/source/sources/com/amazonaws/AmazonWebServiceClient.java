...
public abstract class AmazonWebServiceClient {
    ...
    public static final Log f12043OooO = LogFactory.OooO00o(AmazonWebServiceClient.class);

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public volatile URI f12044OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public ClientConfiguration f12045OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final AmazonHttpClient f12046OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final CopyOnWriteArrayList f12047OooO0Oo = new CopyOnWriteArrayList();

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public volatile String f12048OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public volatile Signer f12049OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public volatile String f12050OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public volatile Region f12051OooO0oo;
    ...
    public AmazonWebServiceClient(ClientConfiguration clientConfiguration, UrlHttpClient urlHttpClient) {
        ...
        this.f12046OooO0OO = new AmazonHttpClient(clientConfiguration, urlHttpClient);
    }
    ...
    public final void OooO(AWSRequestMetrics aWSRequestMetrics, DefaultRequest defaultRequest, boolean z) {
        if (defaultRequest != null) {
            ...
            RequestMetricCollector requestMetricCollectorOooO0OO = defaultRequest.f12072OooO0oO.f12053OooO0o;
    ...
    public final String OooO0oO() {
        ...
        HttpClientConfig httpClientConfig = (HttpClientConfig) InternalConfig.Factory.f12208OooO00o.f12207OooO0o0.get(simpleName);
        String str = httpClientConfig != null ? httpClientConfig.f12200OooO00o : null;
        if (str != null) {
            return str;
        }
    ...
    public final Signer OooO0oo(String str, String str2, boolean z) {
        ...
        this.f12045OooO0O0.getClass();
        ConcurrentHashMap concurrentHashMap = SignerFactory.f12153OooO00o;
        InternalConfig internalConfig = InternalConfig.Factory.f12208OooO00o;
        internalConfig.getClass();
        if (str == null) {
            throw new IllegalArgumentException();
        }
        if (str2 != null) {
            signerConfig = (SignerConfig) internalConfig.f12203OooO0O0.get(o0OoOo0.OooO0O0(str, "/", str2));
            if (signerConfig == null && (signerConfig = (SignerConfig) internalConfig.f12204OooO0OO.get(str2)) == null) {
                signerConfig = (SignerConfig) internalConfig.f12205OooO0Oo.get(str);
                if (signerConfig == null) {
                    signerConfig = internalConfig.f12202OooO00o;
                }
            }
        } else {
            signerConfig = (SignerConfig) internalConfig.f12205OooO0Oo.get(str);
        ...
        Class cls = (Class) SignerFactory.f12153OooO00o.get(signerConfig.f12209OooO00o);
        if (cls == null) {
            throw new IllegalArgumentException();
        }
        try {
            ...
            synchronized (this) {
                this.f12051OooO0oo = RegionUtils.OooO00o(str2);
            }
            return signer;
    ...
    public final String OooOO0() {
        if (this.f12048OooO0o == null) {
            synchronized (this) {
                if (this.f12048OooO0o == null) {
                    this.f12048OooO0o = OooO0oO();
                    return this.f12048OooO0o;
                }
            }
        }
        return this.f12048OooO0o;
    ...
    public void OooOO0O(Region region) {
        ...
        if (region.f12326OooO0OO.containsKey(strOooOO0)) {
            strSubstring = (String) region.f12326OooO0OO.get(strOooOO0);
            int iIndexOf = strSubstring.indexOf("://");
            if (iIndexOf >= 0) {
                strSubstring = strSubstring.substring(iIndexOf + 3);
            }
        } else {
            strSubstring = String.format("%s.%s.%s", this.f12050OooO0oO, region.f12324OooO00o, region.f12325OooO0O0);
        }
        URI uriOooOO0o = OooOO0o(strSubstring);
        Signer signerOooO0oo = OooO0oo(strOooOO0, region.f12324OooO00o, false);
        synchronized (this) {
    ...
    public final URI OooOO0o(String str) {
        if (!str.contains("://")) {
            str = this.f12045OooO0O0.f12062OooO0Oo.toString() + "://" + str;
        }
        try {
            return new URI(str);
