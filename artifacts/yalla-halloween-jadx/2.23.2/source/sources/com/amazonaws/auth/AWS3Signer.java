...
public class AWS3Signer extends AbstractAWSSigner {
    ...
    public static final Log f12080OooO0O0 = LogFactory.OooO00o(AWS3Signer.class);

    public static ArrayList OooOOO(DefaultRequest defaultRequest) {
        ArrayList arrayList = new ArrayList();
        Iterator it = defaultRequest.f12069OooO0Oo.entrySet().iterator();
        while (it.hasNext()) {
    ...
    public final void OooO0OO(DefaultRequest defaultRequest, AWSCredentials aWSCredentials) {
        ...
        String strOooO00o = HttpUtils.OooO00o(defaultRequest.f12071OooO0o0.getPath(), defaultRequest.f12066OooO00o, false);
        ...
        sb.append("\n");
        sb.append(AbstractAWSSigner.OooO0o(defaultRequest.f12068OooO0OO));
        sb.append("\n");
        ...
        try {
            ...
            sb.append(new String(byteArrayOutputStream.toByteArray(), StringUtils.f12681OooO00o));
            String string = sb.toString();
            byte[] bArrOooO0Oo = AbstractAWSSigner.OooO0Oo(string);
            f12080OooO0O0.OooO0oO("Calculated StringToSign: ".concat(string));
