...
public class JsonResponseHandler<T> implements HttpResponseHandler<AmazonWebServiceResponse<T>> {
    ...
    public static final Log f12193OooO0O0 = LogFactory.OooO0O0("com.amazonaws.request");

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final Unmarshaller<T, JsonUnmarshallerContext> f12194OooO00o;
    ...
    public JsonResponseHandler(GetCredentialsForIdentityResultJsonUnmarshaller getCredentialsForIdentityResultJsonUnmarshaller) {
        this.f12194OooO00o = getCredentialsForIdentityResultJsonUnmarshaller;
    }
    ...
    public final Object OooO00o(HttpResponse httpResponse) throws Exception {
        ...
        Log log = f12193OooO0O0;
        log.OooOO0("Parsing service response JSON");
        Map<String, String> map = httpResponse.f12183OooO0Oo;
        String str = map.get("x-amz-crc32");
        InputStream gZIPInputStream = httpResponse.f12182OooO0OO;
        if (gZIPInputStream == null) {
            gZIPInputStream = new ByteArrayInputStream("{}".getBytes(StringUtils.f12681OooO00o));
        }
        ...
        AwsJsonReader awsJsonReaderOooO00o = JsonUtils.OooO00o(new InputStreamReader(gZIPInputStream, StringUtils.f12681OooO00o));
        try {
            AmazonWebServiceResponse amazonWebServiceResponse = new AmazonWebServiceResponse();
            T tOooO00o = this.f12194OooO00o.OooO00o(new JsonUnmarshallerContext(awsJsonReaderOooO00o));
            if (cRC32ChecksumCalculatingInputStream != null) {
                if (cRC32ChecksumCalculatingInputStream.f12668OooO0Oo.getValue() != Long.parseLong(str)) {
                    throw new CRC32MismatchException();
                }
            }
            amazonWebServiceResponse.f12055OooO00o = tOooO00o;
            HashMap map2 = new HashMap();
            map2.put("AWS_REQUEST_ID", map.get("x-amzn-RequestId"));
            amazonWebServiceResponse.f12056OooO0O0 = new ResponseMetadata(map2);
