...
public class RegionMetadataParser {
    ...
    @Deprecated
    public static ArrayList OooO0O0(FileInputStream fileInputStream) throws IOException {
        try {
            try {
                ...
                for (int i = 0; i < elementsByTagName.getLength(); i++) {
                    ...
                    if (nodeItem.getNodeType() == 1) {
                        ...
                        for (int i2 = 0; i2 < elementsByTagName2.getLength(); i2++) {
                            ...
                            region.f12326OooO0OO.put(strOooO00o, strOooO00o2);
                            region.f12327OooO0Oo.put(strOooO00o, Boolean.valueOf(ServerProtocol.DIALOG_RETURN_SCOPES_TRUE.equals(strOooO00o3)));
                            region.f12328OooO0o0.put(strOooO00o, Boolean.valueOf(ServerProtocol.DIALOG_RETURN_SCOPES_TRUE.equals(strOooO00o4)));
                        }
