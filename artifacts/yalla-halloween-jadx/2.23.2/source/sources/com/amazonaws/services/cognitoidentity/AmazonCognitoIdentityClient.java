...
public class AmazonCognitoIdentityClient extends AmazonWebServiceClient implements AmazonCognitoIdentity {
    ...
    public final AWSCredentialsProvider f12344OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public ArrayList f12345OooOO0O;
    ...
    public AmazonCognitoIdentityClient(AnonymousAWSCredentials anonymousAWSCredentials, ClientConfiguration clientConfiguration) {
        ...
        this.f12344OooOO0 = staticCredentialsProvider;
        ArrayList arrayList = new ArrayList();
        this.f12345OooOO0O = arrayList;
        arrayList.add(new ConcurrentModificationExceptionUnmarshaller());
        this.f12345OooOO0O.add(new DeveloperUserAlreadyRegisteredExceptionUnmarshaller());
        this.f12345OooOO0O.add(new ExternalServiceExceptionUnmarshaller());
        this.f12345OooOO0O.add(new InternalErrorExceptionUnmarshaller());
        this.f12345OooOO0O.add(new InvalidIdentityPoolConfigurationExceptionUnmarshaller());
        this.f12345OooOO0O.add(new InvalidParameterExceptionUnmarshaller());
        this.f12345OooOO0O.add(new LimitExceededExceptionUnmarshaller());
        this.f12345OooOO0O.add(new NotAuthorizedExceptionUnmarshaller());
        this.f12345OooOO0O.add(new ResourceConflictExceptionUnmarshaller());
        this.f12345OooOO0O.add(new ResourceNotFoundExceptionUnmarshaller());
        this.f12345OooOO0O.add(new TooManyRequestsExceptionUnmarshaller());
        this.f12345OooOO0O.add(new JsonErrorUnmarshaller());
        ...
        this.f12050OooO0oO = "cognito-identity";
        HandlerChainFactory handlerChainFactory = new HandlerChainFactory();
        this.f12047OooO0Oo.addAll(handlerChainFactory.OooO00o(RequestHandler.class, "/com/amazonaws/services/cognitoidentity/request.handlers"));
        this.f12047OooO0Oo.addAll(handlerChainFactory.OooO00o(RequestHandler2.class, "/com/amazonaws/services/cognitoidentity/request.handler2s"));
    }
    ...
    public final Response OooOOO(DefaultRequest defaultRequest, JsonResponseHandler jsonResponseHandler, ExecutionContext executionContext) {
        defaultRequest.f12071OooO0o0 = this.f12044OooO00o;
        ...
        try {
            AWSCredentials aWSCredentialsOooO00o = this.f12344OooOO0.OooO00o();
            aWSRequestMetrics.OooO0O0(field);
            executionContext.f12174OooO0Oo = aWSCredentialsOooO00o;
            return this.f12046OooO0OO.OooO0O0(defaultRequest, jsonResponseHandler, new JsonErrorResponseHandler(this.f12345OooOO0O), executionContext);
        } catch (Throwable th) {
    ...
    public final GetCredentialsForIdentityResult OooOOO0(GetCredentialsForIdentityRequest getCredentialsForIdentityRequest) throws AmazonClientException {
        ...
        ExecutionContext executionContext = new ExecutionContext(this.f12047OooO0Oo, System.getProperty("com.amazonaws.sdk.enableRuntimeProfiling") != null, this);
        ...
        try {
            ...
            try {
                ...
                if (defaultRequestOooO00o.f12075OooOO0O != null) {
                    throw new IllegalStateException("AWSRequestMetrics has already been set on this request");
                }
                defaultRequestOooO00o.f12075OooOO0O = aWSRequestMetrics;
                aWSRequestMetrics.OooO0O0(field2);
                GetCredentialsForIdentityResult getCredentialsForIdentityResult = (GetCredentialsForIdentityResult) OooOOO(defaultRequestOooO00o, new JsonResponseHandler(new GetCredentialsForIdentityResultJsonUnmarshaller()), executionContext).f12077OooO00o;
                aWSRequestMetrics.OooO0O0(field);
