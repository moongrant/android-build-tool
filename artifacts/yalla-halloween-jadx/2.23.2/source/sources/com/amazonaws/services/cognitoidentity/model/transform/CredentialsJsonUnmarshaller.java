...
class CredentialsJsonUnmarshaller implements Unmarshaller<Credentials, JsonUnmarshallerContext> {
    ...
    public static CredentialsJsonUnmarshaller f12355OooO00o;

    public static Credentials OooO0O0(JsonUnmarshallerContext jsonUnmarshallerContext) throws Exception {
        AwsJsonReader awsJsonReader = jsonUnmarshallerContext.f12654OooO00o;
        ...
        while (awsJsonReader.hasNext()) {
            ...
            AwsJsonReader awsJsonReader2 = jsonUnmarshallerContext.f12654OooO00o;
            if (zEquals) {
                SimpleTypeJsonUnmarshallers$StringJsonUnmarshaller.OooO0O0().getClass();
                credentials.f12346OooO0Oo = awsJsonReader2.OooO0o();
            } else if (strOooO0o0.equals("SecretKey")) {
                SimpleTypeJsonUnmarshallers$StringJsonUnmarshaller.OooO0O0().getClass();
                credentials.f12348OooO0o0 = awsJsonReader2.OooO0o();
            } else if (strOooO0o0.equals("SessionToken")) {
                SimpleTypeJsonUnmarshallers$StringJsonUnmarshaller.OooO0O0().getClass();
                credentials.f12347OooO0o = awsJsonReader2.OooO0o();
            } else if (strOooO0o0.equals("Expiration")) {
                if (SimpleTypeJsonUnmarshallers$DateJsonUnmarshaller.f12656OooO0O0 == null) {
                    SimpleTypeJsonUnmarshallers$DateJsonUnmarshaller.f12656OooO0O0 = new SimpleTypeJsonUnmarshallers$DateJsonUnmarshaller(TimestampFormat.UNIX_TIMESTAMP);
                }
                credentials.f12349OooO0oO = SimpleTypeJsonUnmarshallers$DateJsonUnmarshaller.f12656OooO0O0.OooO00o(jsonUnmarshallerContext);
            } else {
                awsJsonReader.OooO0OO();
            }
        }
