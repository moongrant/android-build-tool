...
public class EncryptRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public final HashMap f12363OooO0oO = new HashMap();

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final ArrayList f12364OooO0oo = new ArrayList();
    ...
    public final boolean equals(Object obj) {
        ...
        HashMap map = encryptRequest.f12363OooO0oO;
        boolean z = map == null;
        HashMap map2 = this.f12363OooO0oO;
        if (z ^ (map2 == null)) {
            return false;
        }
        ...
        ArrayList arrayList = encryptRequest.f12364OooO0oo;
        boolean z2 = arrayList == null;
        ArrayList arrayList2 = this.f12364OooO0oo;
    ...
    public final int hashCode() {
        HashMap map = this.f12363OooO0oO;
        int iHashCode = ((map == null ? 0 : map.hashCode()) + 29791) * 31;
        ArrayList arrayList = this.f12364OooO0oo;
