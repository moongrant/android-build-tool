...
public class GenerateDataKeyPairWithoutPlaintextRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public final HashMap f12367OooO0oO = new HashMap();

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final ArrayList f12368OooO0oo = new ArrayList();
    ...
    public final boolean equals(Object obj) {
        ...
        HashMap map = generateDataKeyPairWithoutPlaintextRequest.f12367OooO0oO;
        boolean z = map == null;
        HashMap map2 = this.f12367OooO0oO;
        if (z ^ (map2 == null)) {
            return false;
        }
        ...
        ArrayList arrayList = generateDataKeyPairWithoutPlaintextRequest.f12368OooO0oo;
        boolean z2 = arrayList == null;
        ArrayList arrayList2 = this.f12368OooO0oo;
    ...
    public final int hashCode() {
        HashMap map = this.f12367OooO0oO;
        int iHashCode = ((((((map == null ? 0 : map.hashCode()) + 31) * 31) + 0) * 31) + 0) * 31;
        ArrayList arrayList = this.f12368OooO0oo;
