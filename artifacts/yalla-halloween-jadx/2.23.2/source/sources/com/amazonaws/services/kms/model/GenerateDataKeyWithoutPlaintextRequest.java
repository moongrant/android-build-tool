...
public class GenerateDataKeyWithoutPlaintextRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public final HashMap f12371OooO0oO = new HashMap();

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final ArrayList f12372OooO0oo = new ArrayList();
    ...
    public final boolean equals(Object obj) {
        ...
        HashMap map = generateDataKeyWithoutPlaintextRequest.f12371OooO0oO;
        boolean z = map == null;
        HashMap map2 = this.f12371OooO0oO;
        if (z ^ (map2 == null)) {
            return false;
        }
        ...
        ArrayList arrayList = generateDataKeyWithoutPlaintextRequest.f12372OooO0oo;
        boolean z2 = arrayList == null;
        ArrayList arrayList2 = this.f12372OooO0oo;
    ...
    public final int hashCode() {
        HashMap map = this.f12371OooO0oO;
        int iHashCode = ((((((map == null ? 0 : map.hashCode()) + 961) * 31) + 0) * 31) + 0) * 31;
        ArrayList arrayList = this.f12372OooO0oo;
