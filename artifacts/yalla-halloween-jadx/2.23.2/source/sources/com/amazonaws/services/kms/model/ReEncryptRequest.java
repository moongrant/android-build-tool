...
public class ReEncryptRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public final HashMap f12388OooO0oO = new HashMap();

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final HashMap f12389OooO0oo = new HashMap();

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    public final ArrayList f12387OooO = new ArrayList();
    ...
    public final boolean equals(Object obj) {
        ...
        HashMap map = reEncryptRequest.f12388OooO0oO;
        boolean z = map == null;
        HashMap map2 = this.f12388OooO0oO;
        if (z ^ (map2 == null)) {
            return false;
        }
        ...
        HashMap map3 = reEncryptRequest.f12389OooO0oo;
        boolean z2 = map3 == null;
        HashMap map4 = this.f12389OooO0oo;
        if (z2 ^ (map4 == null)) {
            return false;
        }
        ...
        ArrayList arrayList = reEncryptRequest.f12387OooO;
        boolean z3 = arrayList == null;
        ArrayList arrayList2 = this.f12387OooO;
