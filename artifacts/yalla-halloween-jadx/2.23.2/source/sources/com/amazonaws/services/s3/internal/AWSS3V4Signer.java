...
public class AWSS3V4Signer extends AWS4Signer {
    ...
    public final String OooOOO(DefaultRequest defaultRequest) {
        ...
        AmazonWebServiceRequest amazonWebServiceRequest = defaultRequest.f12072OooO0oO;
        ...
        String str = (String) defaultRequest.f12069OooO0Oo.get("Content-Length");
        if (str != null) {
        ...
        byte[] bArr2 = AwsChunkedEncodingInputStream.f12100OooOOOo;
        if (j < 0) {
    ...
    public final void OooOOo(DefaultRequest defaultRequest, AWS4Signer.HeaderSigningResult headerSigningResult) {
        ...
        if ((amazonWebServiceRequest instanceof PutObjectRequest) || (amazonWebServiceRequest instanceof UploadPartRequest)) {
            InputStream inputStream = defaultRequest.f12065OooO;
            String str = headerSigningResult.f12085OooO00o;
            String str2 = headerSigningResult.f12086OooO0O0;
            byte[] bArr = headerSigningResult.f12087OooO0OO;
            byte[] bArr2 = new byte[bArr.length];
            System.arraycopy(bArr, 0, bArr2, 0, bArr.length);
            byte[] bArr3 = headerSigningResult.f12088OooO0Oo;
            byte[] bArr4 = new byte[bArr3.length];
            System.arraycopy(bArr3, 0, bArr4, 0, bArr3.length);
            defaultRequest.f12065OooO = new AwsChunkedEncodingInputStream(inputStream, bArr2, str, str2, BinaryUtils.OooO0O0(bArr4), this);
        }
    }
}
