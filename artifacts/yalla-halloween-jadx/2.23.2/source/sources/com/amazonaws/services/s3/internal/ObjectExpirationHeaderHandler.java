...
public class ObjectExpirationHeaderHandler<T extends ObjectExpirationResult> implements HeaderHandler<T> {
    ...
    public static final Pattern f12408OooO00o = Pattern.compile("expiry-date=\"(.*?)\"");

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final Pattern f12409OooO0O0 = Pattern.compile("rule-id=\"(.*?)\"");

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final Log f12410OooO0OO = LogFactory.OooO00o(ObjectExpirationHeaderHandler.class);

    public static void OooO0O0(ObjectExpirationResult objectExpirationResult, HttpResponse httpResponse) {
        Date dateOooO0o0;
        String str = httpResponse.f12183OooO0Oo.get("x-amz-expiration");
        if (str != null) {
            Matcher matcher = f12408OooO00o.matcher(str);
            if (matcher.find()) {
                ...
                try {
                    ...
                    f12410OooO0OO.OooOO0O("Error parsing expiry-date from x-amz-expiration header.", e);
                    dateOooO0o0 = null;
                }
            } else {
                dateOooO0o0 = null;
            ...
            Matcher matcher2 = f12409OooO0O0.matcher(str);
