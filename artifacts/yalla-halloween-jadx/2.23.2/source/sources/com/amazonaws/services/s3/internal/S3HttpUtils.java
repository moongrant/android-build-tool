...
public final class S3HttpUtils {
    ...
    public static final Pattern f12423OooO00o = Pattern.compile(Pattern.quote("+") + "|" + Pattern.quote("*") + "|" + Pattern.quote("%7E") + "|" + Pattern.quote("%2F") + "|" + Pattern.quote("%3A") + "|" + Pattern.quote("%27") + "|" + Pattern.quote("%28") + "|" + Pattern.quote("%29") + "|" + Pattern.quote("%21") + "|" + Pattern.quote("%5B") + "|" + Pattern.quote("%5D") + "|" + Pattern.quote("%24"));
    ...
    public static String OooO00o(String str, boolean z) {
        ...
        try {
            ...
            Matcher matcher = f12423OooO00o.matcher(strEncode);
