...
public class S3XmlResponseHandler<T> extends AbstractS3ResponseHandler<T> {
    ...
    public static final Log f12428OooO0o0 = LogFactory.OooO0O0("com.amazonaws.request");

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final Unmarshaller<T, InputStream> f12429OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public Map<String, String> f12430OooO0Oo;

    public S3XmlResponseHandler(Unmarshaller<T, InputStream> unmarshaller) {
        this.f12429OooO0OO = unmarshaller;
    }
    ...
    public AmazonWebServiceResponse<T> OooO00o(HttpResponse httpResponse) throws Exception {
        ...
        this.f12430OooO0Oo = httpResponse.f12183OooO0Oo;
        Unmarshaller<T, InputStream> unmarshaller = this.f12429OooO0OO;
        if (unmarshaller != null) {
            Log log = f12428OooO0o0;
            ...
            amazonWebServiceResponseOooO0OO.f12055OooO00o = tOooO00o;
        }
