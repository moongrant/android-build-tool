        ...
        if (list != null) {
            Collections.sort(list, new Comparator<PartETag>() { // from class: com.amazonaws.services.s3.model.transform.RequestXmlFactory.1
                ...
                public final int compare(PartETag partETag, PartETag partETag2) {
                    int i = partETag.f12510OooO00o;
                    int i2 = partETag2.f12510OooO00o;
                    if (i < i2) {
                        return -1;
                    }
                    return i > i2 ? 1 : 0;
            ...
            for (PartETag partETag : list) {
                ...
                xmlWriter.OooO0OO(Integer.toString(partETag.f12510OooO00o));
                xmlWriter.OooO00o();
                xmlWriter.OooO0O0("ETag");
                xmlWriter.OooO0OO(partETag.f12511OooO0O0);
                xmlWriter.OooO00o();
                xmlWriter.OooO00o();
            }
        }
        xmlWriter.OooO00o();
        return xmlWriter.toString().getBytes(StringUtils.f12681OooO00o);
    }
}
