...
public final class Mimetypes {
    ...
    public static final Log f12646OooO0O0 = LogFactory.OooO00o(Mimetypes.class);

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static Mimetypes f12647OooO0OO = null;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final HashMap<String, String> f12648OooO00o;

    public Mimetypes() {
        HashMap<String, String> map = new HashMap<>();
        this.f12648OooO00o = map;
        ...
        map.put("gif", MediaUtils.IMAGE_GIF);
        ...
        map.put("mp4", MediaUtils.VIDEO_MP4);
        ...
        map.put("png", MediaUtils.IMAGE_PNG);
    ...
    public static synchronized Mimetypes OooO00o() {
        Mimetypes mimetypes = f12647OooO0OO;
        if (mimetypes != null) {
            return mimetypes;
        }
        f12647OooO0OO = new Mimetypes();
        if (f12646OooO0O0.OooO0O0()) {
            HashMap<String, String> map = f12647OooO0OO.f12648OooO00o;
            for (String str : map.keySet()) {
                f12646OooO0O0.OooO0oO("Setting mime type for extension '" + str + "' to '" + map.get(str) + "'");
            }
        }
        return f12647OooO0OO;
    }
    ...
    public final String OooO0O0(File file) {
        ...
        Log log = f12646OooO0O0;
        if (iLastIndexOf > 0 && (i = iLastIndexOf + 1) < name.length()) {
            String strOooO00o = StringUtils.OooO00o(name.substring(i));
            HashMap<String, String> map = this.f12648OooO00o;
            if (map.containsKey(strOooO00o)) {
                String str = map.get(strOooO00o);
                if (!log.OooO0O0()) {
                    return str;
                }
                log.OooO0oO(oO00OOOo.OooO00o("Recognised extension '", strOooO00o, "', mimetype is: '", str, "'"));
                return str;
            }
            if (log.OooO0O0()) {
                log.OooO0oO("Extension '" + strOooO00o + "' is unrecognized in mime type listing, using default mime type: 'application/octet-stream'");
            }
        } else if (log.OooO0O0()) {
            log.OooO0oO("File name has no extension, mime type cannot be recognised for: ".concat(name));
        }
