...
public class AwsHostNameUtils {
    ...
    public static final Pattern f12665OooO00o = Pattern.compile("^(?:.+\\.)?s3[.-]([a-z0-9-]+)$");
    ...
    public static String OooO00o(String str, String str2) {
        ...
        Iterator it = Collections.unmodifiableList(InternalConfig.Factory.f12208OooO00o.f12206OooO0o).iterator();
        while (true) {
            if (!it.hasNext()) {
                str3 = null;
                break;
            ...
            if (str.matches(hostRegexToRegionMapping.f12198OooO00o)) {
                str3 = hostRegexToRegionMapping.f12199OooO0O0;
                break;
            }
        }
        if (str3 != null) {
    ...
    public static String OooO0O0(String str) {
        Matcher matcher = f12665OooO00o.matcher(str);
        if (matcher.matches()) {
