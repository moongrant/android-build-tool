...
public class DateUtils {
    ...
    public static final TimeZone f12669OooO00o = TimeZone.getTimeZone("GMT");

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final HashMap f12670OooO0O0 = new HashMap();
                ...
                if (threadLocal == null) {
                    threadLocal = new ThreadLocal<SimpleDateFormat>() { // from class: com.amazonaws.util.DateUtils.1
                        ...
                        public final SimpleDateFormat initialValue() {
                            ...
                            simpleDateFormat.setTimeZone(DateUtils.f12669OooO00o);
