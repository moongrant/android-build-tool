...
public class JsonUtils {
    ...
    public static final AwsJsonFactory f12693OooO00o = new GsonFactory();
    ...
    public static AwsJsonReader OooO00o(Reader reader) {
        ((GsonFactory) f12693OooO00o).getClass();
    ...
    public static Map OooO0Oo(BufferedReader bufferedReader) {
        ...
        try {
            ...
            JsonReader jsonReader = gsonReader.f12691OooO00o;
            ...
            while (gsonReader.hasNext()) {
                ...
                if (!gsonReader.OooO0Oo()) {
                    ...
                    ((GsonFactory.GsonReader) awsJsonReaderOooO00o).f12691OooO00o.beginArray();
                    ((GsonFactory.GsonWriter) awsJsonWriterOooO0O0).f12692OooO00o.beginArray();
                    while (true) {
                        try {
                            ...
                            if (AwsJsonToken.BEGIN_OBJECT.equals(awsJsonTokenOooO0oO2)) {
                                ...
                                jsonReader.endArray();
                                ((GsonFactory.GsonWriter) awsJsonWriterOooO0O0).f12692OooO00o.endArray();
                    ...
                    gsonWriter.f12692OooO00o.endArray();
                    ((GsonFactory.GsonWriter) awsJsonWriterOooO0O0).f12692OooO00o.flush();
                    gsonWriter.close();
