...
import p146o00Oo000.OooO;
import p146o00Oo000.OooOO0;
import p146o00Oo000.OooOO0O;
...
public final class QiNiuUploadSingle {
    ...
    private o0000Ooo progressCallback;
    ...
    public QiNiuUploadSingle addProgressCallback(o0000Ooo o0000ooo) {
        this.progressCallback = o0000ooo;
        return this;
    }
    ...
    public QiNiuUploadSingle toUpload(UploadModel uploadModel, boolean z) throws Throwable {
        ...
        String strOooO0Oo = OooOO0.OooO0Oo(appContext, path);
        Iterator<String> it = OooOO0.f37740OooO00o.keySet().iterator();
        while (it.hasNext()) {
        ...
        if (zBooleanValue) {
            ...
            if (OooOO0.f37741OooO0O0.containsKey(OooOO0.OooO0OO(path).toLowerCase())) {
                bool2 = Boolean.TRUE;
            }
        ...
        if (objArr != false) {
            ...
            if (i != 0) {
                try {
                    ...
                    path = OooOO0O.OooO0OO(bitmapCreateBitmap, OooOO0O.OooO00o(appContext2, path));
                } catch (Exception e2) {
                    e2.printStackTrace();
                }
            }
            if (z) {
                ...
                if (objArr2 == true) {
                    String str = OooOO0.f37740OooO00o.get(OooOO0.OooO0Oo(appContext3, path));
                    if ((!TextUtils.isEmpty(str) && "gif".equals(str.toLowerCase())) == true) {
                        ...
                        try {
                            ...
                            if (i4 >= 29) {
                                BitmapFactory.decodeStream(appContext3.getContentResolver().openInputStream(OooO.OooO00o(appContext3, path)), null, options2);
                            } else {
                            ...
                            try {
                                ...
                                bitmapDecodeStream = i4 >= 29 ? BitmapFactory.decodeStream(appContext3.getContentResolver().openInputStream(OooO.OooO00o(appContext3, path)), null, options3) : BitmapFactory.decodeFile(path, options3);
                            } catch (Exception e4) {
                                e4.printStackTrace();
                ...
                String str2 = uploadModel.getPath().hashCode() + OooOO0.OooO0OO(uploadModel.getPath());
                try {
                    ...
                    try {
                        ...
                        try {
                            try {
                                ...
                                if (bArrOooO0O0 == null) {
                                    bArrOooO0O0 = OooOO0.OooO0O0(Upload.getAppContext(), this.mModel.getPath());
                                }
                                bArr = bArrOooO0O0;
                                if (bArr == null) {
                                }
                ...
                bArrOooO0O0 = OooOO0.OooO0O0(Upload.getAppContext(), path);
            }
        }
        if (bArrOooO0O0 == null) {
            bArrOooO0O0 = OooOO0.OooO0O0(Upload.getAppContext(), this.mModel.getPath());
