...
public final class ad implements Runnable {
    ...
    private static void valueOf(boolean z, String str, String str2, String str3, String str4) {
        if (ag.AFInAppEventParameterName != null) {
            StringBuilder sbOooO00o = OooO0OO.OooO00o("Validate callback parameters: ", str, ZegoConstants.ZegoVideoDataAuxPublishingStream, str2, ZegoConstants.ZegoVideoDataAuxPublishingStream);
            sbOooO00o.append(str3);
            AFLogger.valueOf(sbOooO00o.toString());
            if (z) {
