...
public final class ak {
    ...
    boolean AFInAppEventParameterName = true ^ AppsFlyerProperties.getInstance().getBoolean(AppsFlyerProperties.DPM, false);
    ...
    private synchronized void values(String str, String str2, String str3) {
        try {
            ...
            this.AFKeystoreWrapper.put("platform", Constants.OS);
    ...
    public final synchronized void values(String str, PackageManager packageManager) {
        ...
        if (string != null) {
            ...
            try {
                ...
                AFInAppEventType(str, String.valueOf(i), appsFlyerProperties.getString(AppsFlyerProperties.CHANNEL), appsFlyerProperties.getString("preInstallName"));
