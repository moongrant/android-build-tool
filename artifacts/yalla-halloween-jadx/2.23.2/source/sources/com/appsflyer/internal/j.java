...
public final class j {
    ...
    public static boolean valueOf(String str) {
        ...
        StringBuilder sbOooO0O0 = o0OoOo0.OooO0O0("Validate if link ", str, " belongs to ESP domains: ");
        sbOooO0O0.append(Arrays.asList(AFKeystoreWrapper));
        AFLogger.AFKeystoreWrapper(sbOooO0O0.toString());
        try {
