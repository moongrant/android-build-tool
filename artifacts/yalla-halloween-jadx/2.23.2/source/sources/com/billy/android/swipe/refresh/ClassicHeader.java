...
public class ClassicHeader extends RelativeLayout {
    ...
    public TextView f12914OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public int f12915OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public ImageView f12916OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public ObjectAnimator f12917OooO0oO;
    ...
    public final void OooO00o() {
        ...
        this.f12916OooO0o0 = imageView;
        imageView.setVisibility(8);
        TextView textView = (TextView) findViewById(OooO00o.ssr_classics_title);
        this.f12914OooO0Oo = textView;
        textView.setText(OooO0OO.ssr_header_pulling);
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(this.f12916OooO0o0, "rotation", 0.0f, 3600.0f);
        this.f12917OooO0oO = objectAnimatorOfFloat;
        objectAnimatorOfFloat.setDuration(5000L);
        this.f12917OooO0oO.setInterpolator(null);
        this.f12917OooO0oO.setRepeatCount(-1);
        this.f12917OooO0oO.setRepeatMode(1);
    }
    ...
    public void setText(int i) {
        TextView textView;
        if (this.f12915OooO0o == i || (textView = this.f12914OooO0Oo) == null) {
            return;
        }
        this.f12915OooO0o = i;
        textView.setText(i);
