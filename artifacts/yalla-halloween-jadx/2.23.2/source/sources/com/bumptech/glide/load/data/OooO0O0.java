...
public abstract class OooO0O0<T> implements OooO0o<T> {
    ...
    public final String f13035OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public T f13036OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final AssetManager f13037OooO0o0;

    public OooO0O0(AssetManager assetManager, String str) {
        this.f13037OooO0o0 = assetManager;
        this.f13035OooO0Oo = str;
    }

    @Override // com.bumptech.glide.load.data.OooO0o
    public final void OooO0O0() {
        T t = this.f13036OooO0o;
        if (t == null) {
            return;
        }
        try {
    ...
    public final void OooO0Oo(@NonNull Priority priority, @NonNull OooO0o.OooO00o<? super T> oooO00o) {
        try {
            T tOooO0o0 = OooO0o0(this.f13037OooO0o0, this.f13035OooO0Oo);
            this.f13036OooO0o = tOooO0o0;
