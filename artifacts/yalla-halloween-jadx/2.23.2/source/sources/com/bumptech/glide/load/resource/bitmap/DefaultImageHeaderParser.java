...
public final class DefaultImageHeaderParser implements ImageHeaderParser {
    ...
    public static final byte[] f13070OooO00o = "Exif\u0000\u0000".getBytes(Charset.forName("UTF-8"));

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final int[] f13071OooO0O0 = {0, 1, 1, 2, 4, 8, 1, 1, 2, 4, 8, 4, 8};

    public static final class OooO00o implements Reader {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final ByteBuffer f13072OooO00o;

        public OooO00o(ByteBuffer byteBuffer) {
            this.f13072OooO00o = byteBuffer;
        ...
        public final int OooO0O0(int i, byte[] bArr) {
            ByteBuffer byteBuffer = this.f13072OooO00o;
    ...
    public static final class OooO0O0 {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final ByteBuffer f13073OooO00o;

        public OooO0O0(byte[] bArr, int i) {
            this.f13073OooO00o = (ByteBuffer) ByteBuffer.wrap(bArr).order(ByteOrder.BIG_ENDIAN).limit(i);
        }

        public final short OooO00o(int i) {
            ByteBuffer byteBuffer = this.f13073OooO00o;
    ...
    public static final class OooO0OO implements Reader {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final InputStream f13074OooO00o;

        public OooO0OO(InputStream inputStream) {
            this.f13074OooO00o = inputStream;
        }
        ...
        public final int OooO0O0(int i, byte[] bArr) throws IOException {
            int i2 = 0;
            int i3 = 0;
            while (i2 < i && (i3 = this.f13074OooO00o.read(bArr, i2, i - i2)) != -1) {
                i2 += i3;
            }
            if (i2 == 0 && i3 == -1) {
                throw new Reader.EndOfFileException();
        ...
        public final long skip(long j) throws IOException {
            ...
            long j2 = j;
            while (j2 > 0) {
                InputStream inputStream = this.f13074OooO00o;
    ...
    public static int OooO0o0(Reader reader, OooO0o oooO0o) throws IOException {
        try {
            int iOooO00o = reader.OooO00o();
            ...
            byte[] bArr = (byte[]) oooO0o.OooO0OO(iOooO0oO, byte[].class);
            try {
    ...
    public static int OooO0oo(Reader reader, byte[] bArr, int i) throws IOException {
        ...
        ByteBuffer byteBuffer = oooO0O0.f13073OooO00o;
            ...
            if (sOooO00o3 == 274) {
                ...
                if (sOooO00o4 >= s && sOooO00o4 <= 12) {
                    ...
                    if (i7 >= 0) {
                        ...
                        int i8 = i7 + f13071OooO0O0[sOooO00o4];
                        if (i8 <= 4) {
                            int i9 = i5 + 8;
