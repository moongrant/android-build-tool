...
public class BaseViewHolder extends RecyclerView.o0O0O00 {
    ...
    public class OooO00o implements View.OnClickListener {
        ...
        public final void onClick(View view) {
            ...
            if (baseViewHolder.adapter.f13179OooO0oo != null) {
                baseViewHolder.adapter.f13179OooO0oo.OooO0O0(baseViewHolder.adapter, view, baseViewHolder.getClickPosition());
            }
        }
    }
    ...
    public class OooO0O0 implements View.OnLongClickListener {
        ...
        public final boolean onLongClick(View view) {
            BaseViewHolder baseViewHolder = BaseViewHolder.this;
            if (baseViewHolder.adapter.f13171OooO == null) {
                return false;
            }
            BaseQuickAdapter.OooO0OO oooO0OO = baseViewHolder.adapter.f13171OooO;
            BaseQuickAdapter unused = baseViewHolder.adapter;
            oooO0OO.OooO00o(view, baseViewHolder.getClickPosition());
            return true;
        }
    }
    ...
    public int getClickPosition() {
        if (getLayoutPosition() >= this.adapter.OooOOO0()) {
            return getLayoutPosition() - this.adapter.OooOOO0();
        }
        return 0;
    }
    ...
    public BaseViewHolder addOnLongClickListener(@IdRes int i) {
        ...
        if (view != null) {
            ...
            view.setOnLongClickListener(new OooO0O0());
        }
        return this;
    }
