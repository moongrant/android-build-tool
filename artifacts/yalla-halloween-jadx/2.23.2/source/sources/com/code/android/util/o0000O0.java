...
public final class o0000O0 {
    public static final int OooO00o(float f) {
        return (int) (TypedValue.applyDimension(1, f, o000O00O.OooO00o().getResources().getDisplayMetrics()) + 0.5f);
    }

    public static final int OooO0O0(int i) {
        return (int) ((i / o000O00O.OooO00o().getResources().getDisplayMetrics().density) + 0.5f);
    }
    ...
    public static final float OooO0Oo(float f, @Nullable Composer composer) {
        ...
        float fMo322toDpu2uoSUM = ((Density) composer.consume(CompositionLocalsKt.getLocalDensity())).mo322toDpu2uoSUM(f);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return fMo322toDpu2uoSUM;
    }
    ...
    public static final float OooO0o0(int i, @Nullable Composer composer) {
        ...
        float fMo323toDpu2uoSUM = ((Density) composer.consume(CompositionLocalsKt.getLocalDensity())).mo323toDpu2uoSUM(i);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return fMo323toDpu2uoSUM;
    }
}
