...
public final class o000O0<VB extends o00O00o0.OooO00o> implements Lazy<VB> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public final KClass<VB> f13417OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @Nullable
    public final Function0<ViewGroup> f13418OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @NotNull
    public final Context f13419OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    @Nullable
    public VB f13420OooO0oO;

    /* JADX WARN: Multi-variable type inference failed */
    public o000O0(@NotNull KClass<VB> viewBindingClass, @NotNull Context context, @Nullable Function0<? extends ViewGroup> function0) {
        Intrinsics.checkNotNullParameter(viewBindingClass, "viewBindingClass");
        Intrinsics.checkNotNullParameter(context, "context");
        this.f13417OooO0Oo = viewBindingClass;
        this.f13419OooO0o0 = context;
        this.f13418OooO0o = function0;
    }

    @Override // kotlin.Lazy
    public final Object getValue() throws IllegalAccessException, InvocationTargetException {
        VB vb = this.f13420OooO0oO;
        if (vb != null) {
            return vb;
        }
        Context context = this.f13419OooO0o0;
        KClass<VB> kClass = this.f13417OooO0Oo;
        Function0<ViewGroup> function0 = this.f13418OooO0o;
        if (function0 == null) {
        ...
        this.f13420OooO0oO = vb3;
        return vb3;
    }

    @Override // kotlin.Lazy
    public final boolean isInitialized() {
        return this.f13420OooO0oO != null;
    }
}
