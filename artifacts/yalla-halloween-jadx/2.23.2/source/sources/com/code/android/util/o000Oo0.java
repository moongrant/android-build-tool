...
public final /* synthetic */ class o000Oo0 implements Runnable {
    ...
    public final /* synthetic */ ToastUtil f13436OooO0Oo = ToastUtil.f13356OooO00o;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ int f13437OooO0o = 0;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ CharSequence f13438OooO0o0;

    /* JADX WARN: Code duplicated, block: B:23:0x00b5  */
    @Override // java.lang.Runnable
    public final void run() {
        View viewInflate;
        ToastUtil utils = this.f13436OooO0Oo;
        Intrinsics.checkNotNullParameter(utils, "$utils");
        WeakReference<ToastUtil.OooO0O0> weakReference = ToastUtil.f13357OooO0O0;
        ...
        if (viewInflate != null) {
            oooO0OO.f13361OooO0OO = viewInflate;
            Toast toast = oooO0OO.f13359OooO00o;
            Intrinsics.checkNotNull(toast);
            toast.setView(oooO0OO.f13361OooO0OO);
        } else {
            Toast toast2 = oooO0OO.f13359OooO00o;
            Intrinsics.checkNotNull(toast2);
            View view = toast2.getView();
            oooO0OO.f13361OooO0OO = view;
            if (view != null) {
                Intrinsics.checkNotNull(view);
                if (view.findViewById(R.id.message) == null) {
                    int i2 = o000000O.android_util_toast_view;
                    Object systemService2 = o000O00O.OooO00o().getSystemService("layout_inflater");
                    ...
                    oooO0OO.f13361OooO0OO = viewInflate2;
                    Toast toast3 = oooO0OO.f13359OooO00o;
                    Intrinsics.checkNotNull(toast3);
                    toast3.setView(oooO0OO.f13361OooO0OO);
                }
            } else {
                int i3 = o000000O.android_util_toast_view;
                Object systemService3 = o000O00O.OooO00o().getSystemService("layout_inflater");
                ...
                oooO0OO.f13361OooO0OO = viewInflate3;
                Toast toast4 = oooO0OO.f13359OooO00o;
                Intrinsics.checkNotNull(toast4);
                toast4.setView(oooO0OO.f13361OooO0OO);
            }
            View view2 = oooO0OO.f13361OooO0OO;
            Intrinsics.checkNotNull(view2);
            ((TextView) view2.findViewById(R.id.message)).setText(charSequence);
        }
        Toast toast5 = oooO0OO.f13359OooO00o;
        if (toast5 == null) {
            return;
        }
        Intrinsics.checkNotNull(toast5);
        toast5.setDuration(this.f13437OooO0o);
        Toast toast6 = oooO0OO.f13359OooO00o;
