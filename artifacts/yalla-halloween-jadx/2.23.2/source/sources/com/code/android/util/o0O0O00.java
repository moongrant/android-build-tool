...
public final class o0O0O00 {
    ...
    public static final class OooO00o extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
        ...
        public static final OooO00o f13459OooO0Oo = new OooO00o();
        ...
        public final Modifier invoke(Modifier modifier, Composer composer, Integer num) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-319825248, iIntValue, -1, "com.code.android.util.rotationByLayoutDirection.<anonymous> (ModifierUtil.kt:146)");
            }
    ...
    public static Modifier OooO00o(Modifier addAroundCircle, float f, Color color, Brush brush, Dp dp, int i) {
        ...
        long jM1463getZeroF1C5BW0 = (i & 16) != 0 ? Offset.INSTANCE.m1463getZeroF1C5BW0() : 0L;
        Intrinsics.checkNotNullParameter(addAroundCircle, "$this$addAroundCircle");
        return DrawModifierKt.drawWithContent(addAroundCircle, new o0OOO0o(f, dp2, color2, jM1463getZeroF1C5BW0, brush2));
    }
    ...
    public static final Modifier OooO0OO(@NotNull Modifier modifier, @NotNull List<Color> colors, @NotNull Shape shape, boolean z) {
        ...
        return modifier.then(BackgroundKt.background$default(Modifier.INSTANCE, z ? Brush.Companion.m1644verticalGradient8A3gB4$default(Brush.INSTANCE, colors, 0.0f, 0.0f, 0, 14, (Object) null) : Brush.Companion.m1636horizontalGradient8A3gB4$default(Brush.INSTANCE, colors, 0.0f, 0.0f, 0, 14, (Object) null), shape, 0.0f, 4, null));
    }

    @Composable
    @NotNull
    public static final Modifier OooO0Oo(@NotNull Modifier modifier, @Nullable Composer composer, int i) {
        if (androidx.compose.animation.OooOOO.OooO0O0(modifier, "<this>", composer, -1896558232)) {
            ComposerKt.traceEventStart(-1896558232, i, -1, "com.code.android.util.rotationByLayoutDirection (ModifierUtil.kt:145)");
        }
        Modifier modifierComposed$default = ComposedModifierKt.composed$default(modifier, null, OooO00o.f13459OooO0Oo, 1, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
