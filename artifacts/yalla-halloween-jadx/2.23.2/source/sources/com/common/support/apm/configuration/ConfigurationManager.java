...
public final class ConfigurationManager {
    ...
    private final void fetchConfigFromServer(String appId, String uniqueId, int version) {
        ...
        o0O00O0o o0o00o0oCreateConfigRequest = configApi3.createConfigRequest(appId, uniqueId, version);
        ...
        BaseMonitorReportApi.asyncForMetric$default(configApi2, o0o00o0oCreateConfigRequest, respType, null, new Function1<BaseServerResponse<Configuration>, Unit>() { // from class: com.common.support.apm.configuration.ConfigurationManager.fetchConfigFromServer.1
            ...
            public final void invoke2(@Nullable final BaseServerResponse<Configuration> baseServerResponse) {
                ...
                if (data != null) {
                    LoggerKt.logD$default(null, new Function0<String>() { // from class: com.common.support.apm.configuration.ConfigurationManager$fetchConfigFromServer$1$2$1
                        ...
                        @NotNull
                        public final String invoke() {
                            return "Configuration fetch success, new configuration is " + JsonUtilKt.getGson().OooO0oo(data) + '!';
                        }
                    }, 1, null);
    ...
    private final Configuration loadLocalConfig(Context context) {
        ...
        LoggerKt.logD$default(null, new Function0<String>() { // from class: com.common.support.apm.configuration.ConfigurationManager.loadLocalConfig.1
            ...
            @NotNull
            public final String invoke() {
                return "Config json in sp is " + string;
            }
        }, 1, null);
    ...
    public final void updateConfig(Configuration configuration) {
        ...
        ArrayList arrayList = new ArrayList(CollectionsKt.OooO0oo(domains));
    ...
    public final void init(@NotNull Context context, @NotNull o0OoO00O okHttpClient) {
