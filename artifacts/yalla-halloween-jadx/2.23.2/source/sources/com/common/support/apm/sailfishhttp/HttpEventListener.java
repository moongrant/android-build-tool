...
public final class HttpEventListener extends o0 {
    ...
    @NotNull
    private static final o0.OooO0OO factory = new o0.OooO0OO() { // from class: com.common.support.apm.sailfishhttp.HttpEventListener$Companion$factory$1

        @NotNull
        private final AtomicLong nextCallId = new AtomicLong(1);

        @Override // o0ooOO0o.o0.OooO0OO
        @NotNull
        public o0 create(@NotNull o00OO call) {
            Intrinsics.checkNotNullParameter(call, "call");
            return new HttpEventListener(this.nextCallId.getAndIncrement(), call.OooO00o().f57828OooO00o.f57788OooO, call.OooO00o().f57829OooO0O0, System.nanoTime(), null);
        }
    ...
    public static final class Companion {
        ...
        @NotNull
        public final o0.OooO0OO getFactory$sailfish_release() {
    ...
    public void callEnd(@NotNull o00OO call) {
        ...
        if (this.isNetConnected) {
            ...
            HttpTracer.HttpExtendAttribute httpExtendAttribute = httpTracer != null ? httpTracer.getHttpExtendAttribute() : null;
    ...
    @Override // p641o0ooOO0o.o0
    public void callFailed(@NotNull o00OO call, @NotNull IOException exception) {
        Intrinsics.checkNotNullParameter(call, "call");
        ...
        HttpTracer httpTracer2 = this.httpTracer;
        if (httpTracer2 != null) {
            httpTracer2.setStatusAndHttpResponseCode(exception);
            httpTracer2.totalEnd$sailfish_release();
            httpTracer2.end();
        }
    ...
    @Override // p641o0ooOO0o.o0
    public void dnsEnd(@NotNull o00OO call, @NotNull String domainName, @NotNull List<? extends InetAddress> inetAddressList) {
        Intrinsics.checkNotNullParameter(call, "call");
    ...
    @Override // p641o0ooOO0o.o0
    public void requestBodyEnd(@NotNull o00OO call, long byteCount) {
        Intrinsics.checkNotNullParameter(call, "call");
    ...
    public void requestHeadersEnd(@NotNull o00OO call, @NotNull o0O00O0o request) {
        ...
        if (httpTracer != null) {
            ...
            String[] strArr = request.f57830OooO0OO.f57773OooO0Oo;
    ...
    @Override // p641o0ooOO0o.o0
    public void responseBodyEnd(@NotNull o00OO call, long byteCount) {
        Intrinsics.checkNotNullParameter(call, "call");
    ...
    public void responseHeadersEnd(@NotNull o00OO call, @NotNull o0O00o00 response) {
        ...
        if (httpTracer != null) {
            HttpTracer.HttpExtendAttribute httpExtendAttribute = httpTracer.getHttpExtendAttribute();
            String[] strArr = response.f57846OooO.f57773OooO0Oo;
            long length = strArr.length * 2;
            for (String str : strArr) {
                length += (long) str.length();
            }
            httpExtendAttribute.setResponseHeaderCount(length);
            httpTracer.setHttpResponseCode(response.f57850OooO0oO);
            httpTracer.setStatus(statusCode, response.f57848OooO0o);
        }
    }
    ...
    @Override // p641o0ooOO0o.o0
    public void secureConnectEnd(@NotNull o00OO call, @Nullable o0O0000O handshake) {
        Intrinsics.checkNotNullParameter(call, "call");
