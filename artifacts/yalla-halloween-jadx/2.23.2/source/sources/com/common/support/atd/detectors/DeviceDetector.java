...
public final class DeviceDetector extends AbstractDetector {
    ...
    private final String getBooId() throws Throwable {
        String strExec = UtilsKt.exec("cat /proc/sys/kernel/random/boot_id");
        return strExec == null || strExec.length() == 0 ? "" : strExec;
    }
    ...
    public void detect(@NotNull SecModel sailfishSecModel, @NotNull DetectResult resultForApi) {
        ...
        sailfishSecModel.setBootId(getBooId());
        ...
        resultForApi.setA25(sailfishSecModel.getBootId());
        resultForApi.setA26(sailfishSecModel.getSmid());
    }
}
