...
public final class YLAlbum extends ImagePicker implements Album {
    ...
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006¨\u0006\u0007"}, d2 = {"Lcom/common/support/imagepicker/album/YLAlbum$Companion;", "", "()V", "create", "Lcom/common/support/imagepicker/album/YLAlbum;", "activity", "Landroidx/fragment/app/FragmentActivity;", "album_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    public static final class C08601 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public static final class C02071 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public C02071(YLAlbum yLAlbum, List<AlbumSource> list, Function1<? super List<AlbumSource>, Unit> function1, Continuation<? super C02071> continuation) {
            ...
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                return new C02071(this.this$0, this.$albumList, this.$resultCallback, continuation);
            }
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C08601(Function1<? super List<AlbumSource>, Unit> function1, Continuation<? super C08601> continuation) {
            super(2, continuation);
            this.$resultCallback = function1;
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return YLAlbum.this.new C08601(this.$resultCallback, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                ...
                C02071 c02071 = new C02071(YLAlbum.this, listQuery, this.$resultCallback, null);
                this.label = 1;
                if (BuildersKt.withContext(main, c02071, this) == coroutine_suspended) {
    ...
    public final void loadDataPermissionGranted(Function1<? super List<AlbumSource>, Unit> resultCallback) {
        BuildersKt__Builders_commonKt.launch$default(LifecycleOwnerKt.getLifecycleScope(this.activity), Dispatchers.getIO(), null, new C08601(resultCallback, null), 2, null);
    }
