...
public final /* data */ class ImageParamEntity {
    ...
    public String toString() {
        return "ImageParamEntity(error=" + this.error + ", placeHolder=" + this.placeHolder + ", radius=" + this.radius + ", frame=" + this.frame + ")";
    }
