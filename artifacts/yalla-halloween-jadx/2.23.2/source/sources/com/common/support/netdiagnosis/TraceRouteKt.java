    ...
    public static final String traceRoute(@NotNull String host, int i, int i2, boolean z) {
        ...
        try {
            ...
            if (allByName.length == 0) {
                return o000oOoO.OooO0O0("Unable to resolve host ", host, ": No address associated with hostname");
            }
            ...
            if (inetAddress == null) {
                return o0oOO.OooO0O0(o0OoOo0.OooO0O0("Unable to resolve host ", host, ":No "), z ? "ipv6" : "ipv4", " address associated with hostname");
            }
            if (z) {
        ...
        for (int i2 = 1; i2 < i; i2++) {
            ...
            try {
                ...
                if (matcherTraceMatcher.find()) {
                    strOooO0O0 = oo000o.OooO0O0(o0o0Oo.OooO00o(strOooO0O0), printNormal(matcherTraceMatcher, (jCurrentTimeMillis2 - jCurrentTimeMillis) / ((long) 2), sb), '\n');
                } else {
                    Matcher matcherIpMatcher = ipMatcher(successMsg2);
                    if (matcherIpMatcher.find()) {
                        return oo000o.OooO0O0(o0o0Oo.OooO00o(strOooO0O0), printEnd(matcherIpMatcher, successMsg2, sb), '\n');
                    }
                    sb.append("\t\t * \t");
                    strOooO0O0 = strOooO0O0 + sb.toString() + '\n';
                }
            } catch (IOException e) {
                e.printStackTrace();
                return strOooO0O0;
