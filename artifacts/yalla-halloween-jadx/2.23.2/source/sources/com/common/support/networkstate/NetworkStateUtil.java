...
public final class NetworkStateUtil {
    ...
    private final NetworkType convert2NetworkType(int type, String name) {
        switch (type) {
            ...
            case 19:
            default:
                return (StringsKt__StringsJVMKt.equals(name, "TD-SCDMA", true) || StringsKt__StringsJVMKt.equals(name, "WCDMA", true) || StringsKt__StringsJVMKt.equals(name, "CDMA2000", true)) ? NetworkType.NETWORK_3G : NetworkType.NETWORK_UNKNOWN;
            case 20:
