...
public final class AlphaVideoView extends FrameLayout implements IRoomGiftVideoView {
    ...
    public final void resumeCoroutine(CancellableContinuation<? super Boolean> playVideoContainer, boolean result) {
        ...
        if (playVideoContainer.isActive()) {
            playVideoContainer.resumeWith(Result.m4215constructorimpl(Boolean.valueOf(result)));
        }
    }
    ...
    public final float getVolume() {
        OooO oooO = (OooO) this.exoPlayer.getExoPlayer();
        oooO.o00000();
        return oooO.f7170OoooOo0;
    }

    /* JADX WARN: Type inference failed for: r5v3, types: [android.view.View, o0OOO0oO.OooOO0] */
    @Override // com.common.support.roomgiftplayer.view.inter.IRoomGiftVideoView
    public void init(@NotNull AppCompatActivity activity) {
        ...
        playerController.f21386OooO0oO = new o0OOO0.OooO0O0() { // from class: com.common.support.roomgiftplayer.view.AlphaVideoView.init.1
            @Override // o0OOO0.OooO0O0
        ...
        if (playerController2 != null) {
            ?? r5 = playerController2.f21382OooO;
            if (r5 == 0) {
    ...
    /* JADX WARN: Type inference failed for: r0v2, types: [android.view.View, o0OOO0oO.OooOO0] */
    @Override // com.common.support.roomgiftplayer.view.inter.IRoomGiftVideoView
    @MainThread
    public void release() {
        reset();
        ...
        if (playerController != null) {
            ?? r0 = playerController.f21382OooO;
            if (r0 == 0) {
                Intrinsics.throwUninitializedPropertyAccessException("alphaVideoView");
            }
            r0.OooO0o0(this);
    ...
    public final void setVolume(float f) {
        ((OooO) this.exoPlayer.getExoPlayer()).o0OO00O(f);
        this.volume = f;
    }
