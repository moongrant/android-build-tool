    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            if (!this.$localFile.exists()) {
                ...
                cancellableContinuation.resumeWith(Result.m4215constructorimpl(Boxing.boxBoolean(false)));
                return Unit.INSTANCE;
            }
            GiftPlayReplaceInfo giftPlayReplaceInfo = this.$giftPlayReplaceInfo;
        ...
        yYEvaVideoView.setFetchResource(new o0OoOo0() { // from class: com.common.support.roomgiftplayer.view.YYEvaVideoView$play$2$1.2
            @Override // p615o0oo0o0.o0OoOo0
            public void releaseSrc(@NotNull List<OooO0OO> resources) {
                Intrinsics.checkNotNullParameter(resources, "resources");
                Iterator<T> it = resources.iterator();
                while (it.hasNext()) {
                    Bitmap bitmap = ((OooO0OO) it.next()).f32435OooO0O0;
                    if (bitmap != null) {
                        bitmap.recycle();
                    }
                }
            ...
            public void setImage(@NotNull OooO0OO resource, @NotNull Function2<? super Bitmap, ? super EvaSrc.FitType, Unit> result) {
                ...
                GiftPlayReplaceInfo.GiftPlayReplaceSingleInfo fromImage = giftPlayReplaceInfo3.getFromImage(resource.f32434OooO00o);
                if (fromImage != null) {
            ...
            public void setText(@NotNull OooO0OO resource, @NotNull Function2<? super String, ? super String, Unit> result) {
                ...
                GiftPlayReplaceInfo.GiftPlayReplaceSingleInfo fromText = giftPlayReplaceInfo3.getFromText(resource.f32434OooO00o);
                if (fromText != null) {
        ...
        yYEvaVideoView2.setAnimListener(new o000oOoO() { // from class: com.common.support.roomgiftplayer.view.YYEvaVideoView$play$2$1.3
            ...
            public void onVideoComplete() {
                ...
                if (cancellableContinuation2.isActive()) {
                    ...
                    cancellableContinuation3.resumeWith(Result.m4215constructorimpl(Boolean.TRUE));
                }
            }

            @Override // p615o0oo0o0.o000oOoO
            public boolean onVideoConfigReady(@NotNull o5 config) {
            ...
            @Override // p615o0oo0o0.o000oOoO
            public void onVideoRender(int frameIndex, @Nullable o5 config) {
            }
