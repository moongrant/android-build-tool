...
public final class UtilsKt {
    ...
    public static final void runDelayedOnUiThread(long j, @NotNull TimeUnit timeUnit, @NotNull Function0<Unit> block) {
        ...
        getMainHandler().postDelayed(new o00Ooo(block, 1), timeUnit.toMillis(j));
    }
    ...
    public static final void m4030runDelayedOnUiThread$lambda1(Function0 tmp0) {
        Intrinsics.checkNotNullParameter(tmp0, "$tmp0");
        tmp0.invoke();
    }

    public static final void runOnUiThread(@NotNull Function0<Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        getMainHandler().post(new o0000O00(block, 1));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: runOnUiThread$lambda-0, reason: not valid java name */
    public static final void m4031runOnUiThread$lambda0(Function0 block) {
        Intrinsics.checkNotNullParameter(block, "$block");
        block.invoke();
    }
}
