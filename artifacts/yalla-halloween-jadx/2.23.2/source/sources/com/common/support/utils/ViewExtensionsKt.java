...
public final class ViewExtensionsKt {
    ...
    public static final <T extends View> void clickWithTrigger(@NotNull final T t, final long j, @NotNull final Function1<? super T, Unit> block) {
        ...
        t.setOnClickListener(new View.OnClickListener() { // from class: com.common.support.utils.OooO0OO
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ViewExtensionsKt.m4032clickWithTrigger$lambda7(t, j, block, view);
            }
        });
    }
    ...
    public static final void m4032clickWithTrigger$lambda7(View this_clickWithTrigger, long j, Function1 block, View view) {
