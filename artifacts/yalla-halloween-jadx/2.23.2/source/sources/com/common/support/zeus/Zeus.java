...
public final class Zeus {
    ...
    public static final /* data */ class ZeusField {
        ...
        public String toString() {
            ...
            sb.append(this.al);
            sb.append(", sign=");
            return oo000o.OooO0O0(sb, this.sign, ')');
        }
    }
    ...
    @Metadata(k = 3, mv = {1, 7, 1}, xi = 48)
    public /* synthetic */ class C08821 extends FunctionReferenceImpl implements Function2<byte[], String, String> {
    ...
    @Metadata(k = 3, mv = {1, 7, 1}, xi = 48)
    public /* synthetic */ class C08832 extends FunctionReferenceImpl implements Function2<byte[], String, String> {
        public C08832(Object obj) {
            super(2, obj, SV2.class, "a3", "a3([BLjava/lang/String;)Ljava/lang/String;", 0);
        }
    ...
    private final ZeusField parseZeus(String zeus) {
        Integer intOrNull;
        List listSplit$default = StringsKt__StringsKt.split$default((CharSequence) zeus, new String[]{"_"}, false, 3, 2, (Object) null);
    ...
    public final ZeusEntity signWithHmac(@NotNull String data, @Nullable String postBody, @Nullable Long timestamp) {
        ...
        byte[] bytes = data.getBytes(charset);
        Intrinsics.checkNotNullExpressionValue(bytes, "(this as java.lang.String).getBytes(charset)");
        C08821 c08821 = new C08821(SV2.INSTANCE);
        if (postBody != null) {
            byte[] bytes2 = postBody.getBytes(charset);
            Intrinsics.checkNotNullExpressionValue(bytes2, "(this as java.lang.String).getBytes(charset)");
            bArr = bytes2;
        ...
        return sign$default(this, bytes, 2, c08821, null, timestamp, bArr, 8, null);
    }
    ...
    public final boolean verifySign(@NotNull String data, @NotNull String hera, @NotNull String zeus) {
        OooO00o.OooO00o(data, "data", hera, "hera", zeus, "zeus");
    ...
    public final ZeusEntity signWithHmac(@NotNull byte[] data, @Nullable byte[] postBody, @Nullable Long timestamp) {
        Intrinsics.checkNotNullParameter(data, "data");
        return sign$default(this, data, 2, new C08832(SV2.INSTANCE), null, timestamp, postBody, 8, null);
    }
