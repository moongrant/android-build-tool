...
public final class AuthenticationToken implements Parcelable {
    ...
    public int hashCode() {
        return this.signature.hashCode() + ((this.claims.hashCode() + ((this.header.hashCode() + androidx.compose.animation.OooO0O0.OooO00o(this.expectedNonce, androidx.compose.animation.OooO0O0.OooO00o(this.token, 527, 31), 31)) * 31)) * 31);
    }
