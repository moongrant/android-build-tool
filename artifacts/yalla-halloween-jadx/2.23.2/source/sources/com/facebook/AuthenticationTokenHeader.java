...
public final class AuthenticationTokenHeader implements Parcelable {
    ...
    public AuthenticationTokenHeader(@NotNull String str, @NotNull String str2, @NotNull String str3) {
        com.common.support.apm.netdetector.OooO00o.OooO00o(str, "alg", str2, "typ", str3, "kid");
        this.alg = str;
        this.typ = str2;
        this.kid = str3;
    }
    ...
    public int hashCode() {
        return this.kid.hashCode() + androidx.compose.animation.OooO0O0.OooO00o(this.typ, androidx.compose.animation.OooO0O0.OooO00o(this.alg, 527, 31), 31);
    }
