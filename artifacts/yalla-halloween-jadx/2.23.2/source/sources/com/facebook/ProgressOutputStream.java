...
public final class ProgressOutputStream extends FilterOutputStream implements RequestOutputStream {
        ...
        if (this.batchProgress > this.lastReportedProgress) {
            for (final GraphRequestBatch.Callback callback : this.requests.getCallbacks()) {
                if (callback instanceof GraphRequestBatch.OnProgressCallback) {
                    ...
                    if ((callbackHandler == null ? null : Boolean.valueOf(callbackHandler.post(new Runnable() { // from class: com.facebook.o000oOoO
                        @Override // java.lang.Runnable
                        public final void run() {
                            ProgressOutputStream.m4052reportBatchProgress$lambda0(callback, this);
                        }
                    }))) == null) {
    ...
    public static final void m4052reportBatchProgress$lambda0(GraphRequestBatch.Callback callback, ProgressOutputStream this$0) {
