...
public final class AnalyticsUserIDStore {
    ...
    public static final void initStore() {
        ...
        InternalAppEventsLogger.INSTANCE.getAnalyticsExecutor().execute(new OooO00o(0));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: initStore$lambda-0, reason: not valid java name */
    public static final void m4056initStore$lambda0() {
        INSTANCE.initAndWait();
    }
    ...
    public static final void setUserID(@Nullable String id) {
        ...
        InternalAppEventsLogger.INSTANCE.getAnalyticsExecutor().execute(new androidx.compose.ui.platform.OooOo00(id, 1));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: setUserID$lambda-1, reason: not valid java name */
    public static final void m4057setUserID$lambda1(String str) {
        lock.writeLock().lock();
        try {
            userID = str;
