...
public final class AppEventQueue {
        ...
        try {
            ...
            singleThreadExecutor.execute(new Runnable() { // from class: com.facebook.appevents.OooO
                ...
                public final void run() {
                    AppEventQueue.m4058add$lambda3(accessTokenAppId, appEvent);
                }
            });
        } catch (Throwable th) {
    ...
    public static final void m4058add$lambda3(AccessTokenAppIdPair accessTokenAppId, AppEvent appEvent) {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
    ...
    public static final GraphRequest buildRequestForSession(@NotNull final AccessTokenAppIdPair accessTokenAppId, @NotNull final SessionEventsState appEvents, boolean limitEventUsage, @NotNull final FlushStatistics flushState) {
        ...
        try {
            ...
            graphRequestNewPostRequest.setCallback(new GraphRequest.Callback() { // from class: com.facebook.appevents.OooO0O0
                @Override // com.facebook.GraphRequest.Callback
                public final void onCompleted(GraphResponse graphResponse) {
                    AppEventQueue.m4059buildRequestForSession$lambda4(accessTokenAppId, graphRequestNewPostRequest, appEvents, flushState, graphResponse);
                }
            });
    ...
    public static final void m4059buildRequestForSession$lambda4(AccessTokenAppIdPair accessTokenAppId, GraphRequest postRequest, SessionEventsState appEvents, FlushStatistics flushState, GraphResponse response) {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
    ...
    public static final void flush(@NotNull FlushReason reason) {
        ...
        try {
            ...
            singleThreadExecutor.execute(new OooO0OO(reason, 0));
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, AppEventQueue.class);
        }
    }
    ...
    public static final void m4060flush$lambda2(FlushReason reason) {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
        ...
        try {
            ...
            try {
                ...
                if (flushStatisticsSendEventsToServer != null) {
                    ...
                    o0Oo0oo.OooO00o(FacebookSdk.getApplicationContext()).OooO0OO(intent);
                }
            } catch (Exception e) {
    ...
    public static final void m4061flushRunnable$lambda0() {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
    ...
    public static final void handleResponse(@NotNull AccessTokenAppIdPair accessTokenAppId, @NotNull GraphRequest request, @NotNull GraphResponse response, @NotNull SessionEventsState appEvents, @NotNull FlushStatistics flushState) {
        ...
        try {
            ...
            if (flushResult == flushResult2) {
                FacebookSdk.getExecutor().execute(new o0O0OO0(i, accessTokenAppId, appEvents));
            }
    ...
    public static final void m4062handleResponse$lambda5(AccessTokenAppIdPair accessTokenAppId, SessionEventsState appEvents) {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
    ...
    public static final void persistToDisk() {
        ...
        try {
            singleThreadExecutor.execute(new OooO0o());
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, AppEventQueue.class);
        }
    }
    ...
    public static final void m4063persistToDisk$lambda1() {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
