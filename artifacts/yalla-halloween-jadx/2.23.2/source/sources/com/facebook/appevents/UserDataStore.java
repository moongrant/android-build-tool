...
public final class UserDataStore {
    ...
    public static final void clear() {
        ...
        try {
            InternalAppEventsLogger.INSTANCE.getAnalyticsExecutor().execute(new OooOo());
        } catch (Throwable th) {
    ...
    public static final void m4072clear$lambda2() {
        if (CrashShieldHandler.isObjectCrashing(UserDataStore.class)) {
            return;
        }
        try {
    ...
    public static final void setUserDataAndHash(@Nullable Bundle ud) {
        ...
        try {
            InternalAppEventsLogger.INSTANCE.getAnalyticsExecutor().execute(new androidx.compose.ui.text.input.OooO0OO(ud, 2));
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserDataStore.class);
        }
    }
    ...
    public static final void m4073setUserDataAndHash$lambda1(Bundle bundle) {
        if (CrashShieldHandler.isObjectCrashing(UserDataStore.class)) {
            return;
        }
        try {
    ...
    private final void writeDataIntoCache(String key, String value) {
        ...
        try {
            FacebookSdk.getExecutor().execute(new p002OooO0Oo.OooOOO0(1, key, value));
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
        }
    }
    ...
    public static final void m4074writeDataIntoCache$lambda0(String key, String value) {
        if (CrashShieldHandler.isObjectCrashing(UserDataStore.class)) {
            return;
        }
        try {
