...
public final class CodelessManager {
    ...
    private final void checkCodelessSession(String applicationId) {
        ...
        try {
            ...
            FacebookSdk.getExecutor().execute(new o000OOo0(applicationId, 1));
        } catch (Throwable th) {
    ...
    public static final void m4081checkCodelessSession$lambda1(String str) {
        ...
        try {
            ...
            if (isCodelessEnabled.get()) {
                ...
                if (Intrinsics.areEqual(appSettingsWithoutQuery == null ? null : Boolean.valueOf(appSettingsWithoutQuery.getCodelessEventsEnabled()), Boolean.TRUE) || INSTANCE.isDebugOnEmulator()) {
                    ...
                    viewIndexingTrigger2.setOnShakeListener(new o000O000(appSettingsWithoutQuery, applicationId));
    ...
    public static final void m4082onActivityResumed$lambda0(FetchedAppSettings fetchedAppSettings, String appId) {
        if (CrashShieldHandler.isObjectCrashing(CodelessManager.class)) {
            return;
        }
        try {
