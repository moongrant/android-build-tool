...
public final class CodelessMatcher {
            ...
            private final boolean isTheSameView(View targetView, PathComponent pathElement, int index) {
                ...
                if (!Intrinsics.areEqual(targetView.getClass().getCanonicalName(), pathElement.getClassName())) {
                    if (new Regex(".*android\\..*").matches(pathElement.getClassName())) {
                        List listSplit$default = StringsKt__StringsKt.split$default((CharSequence) pathElement.getClassName(), new String[]{CodelessMatcher.CURRENT_CLASS_NAME}, false, 0, 6, (Object) null);
    ...
    private final void startTracking() {
        ...
        try {
            if (Thread.currentThread() == Looper.getMainLooper().getThread()) {
                ...
                this.uiThreadHandler.post(new o000000(this, 1));
            }
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
        }
    ...
    public static final void m4083startTracking$lambda1(CodelessMatcher this$0) {
        if (CrashShieldHandler.isObjectCrashing(CodelessMatcher.class)) {
            return;
        }
        try {
