...
public final class ViewIndexer {
    ...
    public static final class Companion {
        ...
        public static final void m4086buildAppIndexingRequest$lambda0(GraphResponse it) {
        ...
        public final GraphRequest buildAppIndexingRequest(@Nullable String appIndex, @Nullable AccessToken accessToken, @Nullable String appId, @NotNull String requestType) {
            ...
            graphRequestNewPostRequest.setCallback(new OooO0O0());
    ...
    public static final void m4084schedule$lambda0(ViewIndexer this$0, TimerTask indexingTask) {
        if (CrashShieldHandler.isObjectCrashing(ViewIndexer.class)) {
            return;
        }
        try {
    ...
    private final void sendToServer(String tree) {
        ...
        try {
            FacebookSdk.getExecutor().execute(new OooOO0.OooO00o(3, tree, this));
        } catch (Throwable th) {
    ...
    public static final void m4085sendToServer$lambda1(String tree, ViewIndexer this$0) {
        if (CrashShieldHandler.isObjectCrashing(ViewIndexer.class)) {
            return;
        }
        try {
    ...
    public final void schedule() {
        ...
        try {
            try {
                FacebookSdk.getExecutor().execute(new OooO.OooO00o(1, this, new TimerTask() { // from class: com.facebook.appevents.codeless.ViewIndexer$schedule$indexingTask$1
