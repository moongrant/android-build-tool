...
public final class CancellationTokenSource implements Closeable {
    ...
    public static final void m4108cancelAfter$lambda6$lambda5(CancellationTokenSource this$0) {
    ...
    private final void cancelAfter(long delay, TimeUnit timeUnit) {
        ...
        synchronized (this.lock) {
            ...
            cancelScheduledCancellation();
            if (delay != -1) {
                this.scheduledCancellation = this.executor.schedule(new androidx.appcompat.app.OooOO0(this, 3), delay, timeUnit);
            }
            Unit unit = Unit.INSTANCE;
        }
    }
