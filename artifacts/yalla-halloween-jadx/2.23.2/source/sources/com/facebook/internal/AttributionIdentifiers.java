...
public final class AttributionIdentifiers {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        @Nullable
        public final AttributionIdentifiers getAttributionIdentifiers(@NotNull Context context) throws Throwable {
            Cursor cursor;
            Uri uri;
            String str;
            Uri uri2;
        ...
        public final boolean isTrackingLimited(@NotNull Context context) throws Throwable {
            Intrinsics.checkNotNullParameter(context, "context");
