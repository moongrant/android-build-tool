...
public class CustomTab {
    ...
    public final boolean openCustomTab(@NotNull Activity activity, @Nullable String packageName) {
        ...
        if (preparedSessionOnce != null) {
            intent.setPackage(preparedSessionOnce.f391OooO0OO.getPackageName());
        }
        Bundle bundle = new Bundle();
        p063o0000oO.Oooo0.OooO0O0(bundle, "android.support.customtabs.extra.SESSION", preparedSessionOnce == null ? null : preparedSessionOnce.f390OooO0O0.asBinder());
