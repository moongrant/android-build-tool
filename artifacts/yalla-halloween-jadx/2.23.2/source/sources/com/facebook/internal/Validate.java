...
public final class Validate {
    ...
    public static final void containsNoNullOrEmpty(@NotNull Collection<String> container, @NotNull String name) {
        ...
        for (String str : container) {
            if (str == null) {
                throw new NullPointerException(p004OooO0oO.o000oOoO.OooO0O0("Container '", name, "' cannot contain null values"));
            }
            if (!(str.length() > 0)) {
                throw new IllegalArgumentException(p004OooO0oO.o000oOoO.OooO0O0("Container '", name, "' cannot contain empty values").toString());
            }
        }
    }
    ...
    public static final void hasContentProvider(@NotNull Context context) {
        ...
        if (packageManager != null) {
            ...
            throw new IllegalStateException(OooO0O0.OooO0O0.OooO00o(new Object[]{strStringPlus}, 1, CONTENT_PROVIDER_NOT_FOUND_REASON, "java.lang.String.format(format, *args)").toString());
        }
    }
    ...
    public static final <T> void notEmpty(@NotNull Collection<? extends T> container, @NotNull String name) {
        ...
        if (!(!container.isEmpty())) {
            throw new IllegalArgumentException(p004OooO0oO.o000oOoO.OooO0O0("Container '", name, "' cannot be empty").toString());
        }
    }
    ...
    public static final void notNull(@Nullable Object arg, @NotNull String name) {
        Intrinsics.checkNotNullParameter(name, "name");
        if (arg == null) {
            throw new NullPointerException(p004OooO0oO.o000oOoO.OooO0O0("Argument '", name, "' cannot be null"));
        }
    }
    ...
    public static final String notNullOrEmpty(@Nullable String arg, @NotNull String name) {
        ...
        throw new IllegalArgumentException(p004OooO0oO.o000oOoO.OooO0O0("Argument '", name, "' cannot be null or empty").toString());
    }
    ...
    public static final void oneOf(@Nullable Object arg, @NotNull String name, @NotNull Object... values) {
        ...
        throw new IllegalArgumentException(p004OooO0oO.o000oOoO.OooO0O0("Argument '", name, "' was not one of the allowed values"));
    }
    ...
    public static final void notEmpty(@NotNull String arg, @NotNull String name) {
        ...
        Intrinsics.checkNotNullParameter(name, "name");
        if (!(arg.length() > 0)) {
            throw new IllegalArgumentException(p004OooO0oO.o000oOoO.OooO0O0("Argument '", name, "' cannot be empty").toString());
        }
    }
}
