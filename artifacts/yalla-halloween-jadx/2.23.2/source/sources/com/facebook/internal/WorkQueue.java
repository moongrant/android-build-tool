...
public final class WorkQueue {
    ...
    public static final class Companion {
        ...
        public final void m4147assert(boolean condition) {
            if (!condition) {
    ...
    public final class WorkNode implements WorkItem {
        ...
        public final WorkNode addToList(@Nullable WorkNode list, boolean addToFront) {
            ...
            companion.m4147assert(this.next == null);
            companion.m4147assert(this.prev == null);
            if (list == null) {
                this.prev = this;
                this.next = this;
                list = this;
        ...
        public final void verify(boolean shouldBeRunning) {
            ...
            companion.m4147assert(workNode == this);
            WorkNode workNode4 = this.next;
            if (workNode4 == null || (workNode2 = workNode4.prev) == null) {
                workNode2 = this;
            }
            companion.m4147assert(workNode2 == this);
            companion.m4147assert(getIsRunning() == shouldBeRunning);
        }
    }
    ...
    private final void execute(final WorkNode node) {
        this.executor.execute(new Runnable() { // from class: com.facebook.internal.o00oO0o
            @Override // java.lang.Runnable
            public final void run() {
                WorkQueue.m4146execute$lambda2(node, this);
            }
        });
    }
    ...
    public static final void m4146execute$lambda2(WorkNode node, WorkQueue this$0) {
    ...
    public final void validate() {
        ...
        try {
            ...
            INSTANCE.m4147assert(this.runningCount == i);
            Unit unit = Unit.INSTANCE;
            reentrantLock.unlock();
        } catch (Throwable th) {
            reentrantLock.unlock();
