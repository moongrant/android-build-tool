...
public final class ANRHandler {
    ...
    public static final void sendANRReports() {
        ...
        try {
            ...
            final List listSortedWith = CollectionsKt.sortedWith(arrayList2, new o00000O0());
            ...
            InstrumentUtility.sendReports("anr_reports", jSONArray, new GraphRequest.Callback() { // from class: o00oO0O0.o00000O
                @Override // com.facebook.GraphRequest.Callback
                public final void onCompleted(GraphResponse graphResponse) {
                    ANRHandler.m4157sendANRReports$lambda5(listSortedWith, graphResponse);
                }
            });
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, ANRHandler.class);
    ...
    public static final int m4156sendANRReports$lambda2(InstrumentData instrumentData, InstrumentData o2) {
        if (CrashShieldHandler.isObjectCrashing(ANRHandler.class)) {
            return 0;
        }
        try {
    ...
    public static final void m4157sendANRReports$lambda5(List validReports, GraphResponse response) {
        if (CrashShieldHandler.isObjectCrashing(ANRHandler.class)) {
            return;
        }
        try {
