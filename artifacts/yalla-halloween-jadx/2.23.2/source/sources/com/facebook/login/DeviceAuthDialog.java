...
public class DeviceAuthDialog extends androidx.fragment.app.Oooo0 {
    ...
    public static final void m4165_get_pollRequest_$lambda5(DeviceAuthDialog this$0, GraphResponse response) {
    ...
    private final GraphRequest getPollRequest() {
        ...
        return GraphRequest.INSTANCE.newPostRequestWithBundle(null, DEVICE_LOGIN_STATUS_ENDPOINT, bundle, new GraphRequest.Callback() { // from class: com.facebook.login.OooOO0
            @Override // com.facebook.GraphRequest.Callback
            public final void onCompleted(GraphResponse graphResponse) {
                DeviceAuthDialog.m4165_get_pollRequest_$lambda5(this.f13745OooO00o, graphResponse);
            }
        });
    }
    ...
    public static final void m4166initializeContentView$lambda2(DeviceAuthDialog this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.onCancel();
    }
    ...
    private final void onSuccess(final String accessToken, long expiresIn, Long dataAccessExpirationTime) {
        ...
        GraphRequest graphRequestNewGraphPathRequest = GraphRequest.INSTANCE.newGraphPathRequest(new AccessToken(accessToken, FacebookSdk.getApplicationId(), AppEventsConstants.EVENT_PARAM_VALUE_NO, null, null, null, null, date, null, date2, null, LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY, null), "me", new GraphRequest.Callback() { // from class: com.facebook.login.OooO0O0
            @Override // com.facebook.GraphRequest.Callback
            public final void onCompleted(GraphResponse graphResponse) {
                DeviceAuthDialog.m4167onSuccess$lambda10(this.f13734OooO00o, accessToken, date, date2, graphResponse);
            }
        });
    ...
    public static final void m4167onSuccess$lambda10(DeviceAuthDialog this$0, String accessToken, Date date, Date date2, GraphResponse response) {
    ...
    private final void presentConfirmation(final String userId, final PermissionsLists permissions, final String accessToken, String name, final Date expirationTime, final Date dataAccessExpirationTime) {
        ...
        builder.setMessage(string).setCancelable(true).setNegativeButton(strOooO00o, new DialogInterface.OnClickListener() { // from class: com.facebook.login.OooO0OO
            ...
            public final void onClick(DialogInterface dialogInterface, int i) {
                DeviceAuthDialog.m4168presentConfirmation$lambda6(this.f13739OooO0Oo, userId, permissions, accessToken, expirationTime, dataAccessExpirationTime, dialogInterface, i);
            }
        }).setPositiveButton(string3, new DialogInterface.OnClickListener() { // from class: com.facebook.login.OooO0o
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                DeviceAuthDialog.m4169presentConfirmation$lambda8(this.f13744OooO0Oo, dialogInterface, i);
            }
        });
        builder.create().show();
    }
    ...
    public static final void m4168presentConfirmation$lambda6(DeviceAuthDialog this$0, String userId, PermissionsLists permissions, String accessToken, Date date, Date date2, DialogInterface dialogInterface, int i) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public static final void m4169presentConfirmation$lambda8(DeviceAuthDialog this$0, DialogInterface dialogInterface, int i) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    private final void schedulePoll() {
        ...
        if (lValueOf != null) {
            this.scheduledPoll = DeviceAuthMethodHandler.INSTANCE.getBackgroundExecutor().schedule(new Runnable() { // from class: com.facebook.login.OooO
                @Override // java.lang.Runnable
                public final void run() {
                    DeviceAuthDialog.m4170schedulePoll$lambda3(this.f13730OooO0Oo);
                }
    ...
    public static final void m4170schedulePoll$lambda3(DeviceAuthDialog this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.poll();
    }
    ...
    public static final void m4171startLogin$lambda1(DeviceAuthDialog this$0, GraphResponse response) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(response, "response");
    ...
    public View initializeContentView(boolean isSmartLogin) {
        ...
        ((Button) viewFindViewById3).setOnClickListener(new OooOOO0(this, 0));
    ...
    public void startLogin(@NotNull LoginClient.Request request) {
        ...
        GraphRequest.INSTANCE.newPostRequestWithBundle(null, DEVICE_LOGIN_ENDPOINT, bundle, new GraphRequest.Callback() { // from class: com.facebook.login.OooOO0O
            @Override // com.facebook.GraphRequest.Callback
            public final void onCompleted(GraphResponse graphResponse) {
                DeviceAuthDialog.m4171startLogin$lambda1(this.f13746OooO00o, graphResponse);
            }
        }).executeAsync();
    }
}
