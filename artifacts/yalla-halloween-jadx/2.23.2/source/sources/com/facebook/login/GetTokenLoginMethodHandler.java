...
public final class GetTokenLoginMethodHandler extends LoginMethodHandler {
    ...
    public static final void m4172tryAuthorize$lambda1(GetTokenLoginMethodHandler this$0, LoginClient.Request request, Bundle bundle) {
    ...
    public int tryAuthorize(@NotNull final LoginClient.Request request) {
        ...
        getLoginClient().notifyBackgroundProcessingStart();
        PlatformServiceClient.CompletedListener completedListener = new PlatformServiceClient.CompletedListener() { // from class: com.facebook.login.OooOOO
            @Override // com.facebook.internal.PlatformServiceClient.CompletedListener
            public final void completed(Bundle bundle) {
                GetTokenLoginMethodHandler.m4172tryAuthorize$lambda1(this.f13747OooO00o, request, bundle);
            }
        };
