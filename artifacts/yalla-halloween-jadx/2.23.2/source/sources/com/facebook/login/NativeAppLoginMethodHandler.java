...
public abstract class NativeAppLoginMethodHandler extends LoginMethodHandler {
    ...
    private final void processSuccessResponse(final LoginClient.Request request, final Bundle extras) {
        if (extras.containsKey("code")) {
            ...
            if (!Utility.isNullOrEmpty(extras.getString("code"))) {
                FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.login.o000oOoO
                    @Override // java.lang.Runnable
                    public final void run() {
                        NativeAppLoginMethodHandler.m4180processSuccessResponse$lambda0(this.f13761OooO0Oo, request, extras);
                    }
                });
                return;
            }
    ...
    public static final void m4180processSuccessResponse$lambda0(NativeAppLoginMethodHandler this$0, LoginClient.Request request, Bundle extras) {
