...
public final class ac {
    ...
    public enum a {
        ...
        PARAM("1"),
        WEB_VIEW_HTTP(FeedbackType.Suggestions),
        WEB_VIEW_SSL(FeedbackType.Recharge),
        USER_ERROR("4"),
        WEB_CALLBACK_ERROR(FeedbackType.Others),
        NET("6");
