...
public final class c {
    ...
    public static final class DialogInterfaceOnKeyListenerC0212c implements DialogInterface.OnKeyListener {
        final /* synthetic */ x a;

        public DialogInterfaceOnKeyListenerC0212c(x xVar) {
            this.a = xVar;
        }
    ...
    public final void b(Context context, t tVar, x xVar) {
        ...
        if (dVar != null) {
            dVar.setOnKeyListener(new DialogInterfaceOnKeyListenerC0212c(xVar));
        }
