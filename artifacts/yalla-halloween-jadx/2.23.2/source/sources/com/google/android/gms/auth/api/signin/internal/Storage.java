...
public class Storage {
    ...
    public static final ReentrantLock f14090OooO0OO = new ReentrantLock();

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @Nullable
    @GuardedBy("sLk")
    public static Storage f14091OooO0Oo;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final ReentrantLock f14092OooO00o = new ReentrantLock();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @GuardedBy("mLk")
    public final SharedPreferences f14093OooO0O0;

    @VisibleForTesting
    public Storage(Context context) {
        this.f14093OooO0O0 = context.getSharedPreferences("com.google.android.gms.signin", 0);
    }

    public static final String OooO0Oo(String str, String str2) {
        return OooO0O0.OooO00o(new StringBuilder(str.length() + 1 + String.valueOf(str2).length()), str, CertificateUtil.DELIMITER, str2);
    }
    ...
    public static Storage getInstance(@NonNull Context context) {
        ...
        ReentrantLock reentrantLock = f14090OooO0OO;
        reentrantLock.lock();
        try {
            if (f14091OooO0Oo == null) {
                f14091OooO0Oo = new Storage(context.getApplicationContext());
            }
            return f14091OooO0Oo;
        } finally {
    ...
    public final String OooO00o(@NonNull String str) {
        ReentrantLock reentrantLock = this.f14092OooO00o;
        reentrantLock.lock();
        try {
            return this.f14093OooO0O0.getString(str, null);
        } finally {
            reentrantLock.unlock();
        }
    }
    ...
    public final void OooO0O0(@NonNull String str) {
        ...
        reentrantLock.lock();
        try {
            this.f14093OooO0O0.edit().remove(str).apply();
        } finally {
            reentrantLock.unlock();
        }
    }
    ...
    public final void OooO0OO(@NonNull String str, @NonNull String str2) {
        ...
        reentrantLock.lock();
        try {
            this.f14093OooO0O0.edit().putString(str, str2).apply();
        } finally {
            reentrantLock.unlock();
        }
    }
    ...
    public void clear() {
        ...
        reentrantLock.lock();
        try {
            this.f14093OooO0O0.edit().clear().apply();
        } finally {
            reentrantLock.unlock();
        }
    }
