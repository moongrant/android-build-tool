...
public class GooglePlayServicesUtilLight {
    ...
    public static boolean f14148OooO0O0 = false;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @VisibleForTesting
    public static boolean f14149OooO0OO = false;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    @VisibleForTesting
    @KeepForSdk
    public static final AtomicBoolean f14147OooO00o = new AtomicBoolean();

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public static final AtomicBoolean f14150OooO0Oo = new AtomicBoolean();
    ...
    public static void cancelAvailabilityErrorNotifications(@NonNull Context context) {
        if (f14147OooO00o.getAndSet(true)) {
            return;
        }
        try {
    ...
    public static boolean honorsDebugCertificates(@NonNull Context context) {
        ...
        return f14148OooO0O0 || !DeviceProperties.isUserBuild();
    }
    ...
    public static int isGooglePlayServicesAvailable(@NonNull Context context, int i) {
        ...
        if (!"com.google.android.gms".equals(context.getPackageName()) && !f14150OooO0Oo.get()) {
