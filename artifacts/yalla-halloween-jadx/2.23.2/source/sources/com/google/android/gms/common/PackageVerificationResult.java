...
public class PackageVerificationResult {
    ...
    public final boolean f14156OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @Nullable
    public final String f14157OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @Nullable
    public final Throwable f14158OooO0OO;

    public PackageVerificationResult(boolean z, @Nullable String str, @Nullable Throwable th) {
        this.f14156OooO00o = z;
        this.f14157OooO0O0 = str;
        this.f14158OooO0OO = th;
    }
    ...
    public final void zzb() {
        if (this.f14156OooO00o) {
            return;
        }
        String strConcat = "PackageVerificationRslt: ".concat(String.valueOf(this.f14157OooO0O0));
        Throwable th = this.f14158OooO0OO;
        if (th == null) {
