...
public final class Api<O extends ApiOptions> {
    ...
    public final AbstractClientBuilder<?, O> f14167OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final ClientKey<?> f14168OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final String f14169OooO0OO;
    ...
    public <C extends Client> Api(@NonNull String str, @NonNull AbstractClientBuilder<C, O> abstractClientBuilder, @NonNull ClientKey<C> clientKey) {
        ...
        this.f14167OooO00o = abstractClientBuilder;
        this.f14168OooO0O0 = clientKey;
    }

    @NonNull
    public final AbstractClientBuilder<?, O> zaa() {
        return this.f14167OooO00o;
    }

    @NonNull
    public final AnyClientKey<?> zab() {
        return this.f14168OooO0O0;
    }
