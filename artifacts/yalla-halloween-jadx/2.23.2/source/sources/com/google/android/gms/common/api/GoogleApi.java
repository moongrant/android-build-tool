...
public abstract class GoogleApi<O extends Api.ApiOptions> implements HasApiKey<O> {
    ...
    public final StatusExceptionMapper f14184OooO;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final Context f14185OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @Nullable
    public final String f14186OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final Api<O> f14187OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final O f14188OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final Looper f14189OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final ApiKey<O> f14190OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final int f14191OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    @NotOnlyInitialized
    public final zabv f14192OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    @NonNull
    public final GoogleApiManager f14193OooOO0;
    ...
    public static class Settings {
        ...
        public static class Builder {
            ...
            /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
            public StatusExceptionMapper f14194OooO00o;

            /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
            public Looper f14195OooO0O0;
            ...
            public Settings build() {
                if (this.f14194OooO00o == null) {
                    this.f14194OooO00o = new ApiExceptionMapper();
                }
                if (this.f14195OooO0O0 == null) {
                    this.f14195OooO0O0 = Looper.getMainLooper();
                }
                return new Settings(this.f14194OooO00o, this.f14195OooO0O0);
            }
            ...
            public Builder setMapper(@NonNull StatusExceptionMapper statusExceptionMapper) {
                ...
                this.f14194OooO00o = statusExceptionMapper;
                return this;
            }
        }
    ...
    public final ClientSettings.Builder OooO00o() {
        ...
        if (!(o instanceof Api.ApiOptions.HasGoogleSignInAccountOptions) || (googleSignInAccount2 = ((Api.ApiOptions.HasGoogleSignInAccountOptions) o).getGoogleSignInAccount()) == null) {
            account = o instanceof Api.ApiOptions.HasAccountOptions ? ((Api.ApiOptions.HasAccountOptions) o).getAccount() : null;
        } else {
            account = googleSignInAccount2.getAccount();
        }
        builder.zab(account);
        Set<Scope> setEmptySet = (!(o instanceof Api.ApiOptions.HasGoogleSignInAccountOptions) || (googleSignInAccount = ((Api.ApiOptions.HasGoogleSignInAccountOptions) o).getGoogleSignInAccount()) == null) ? Collections.emptySet() : googleSignInAccount.getRequestedScopes();
        builder.zaa(setEmptySet);
        Context context = this.f14185OooO00o;
    ...
    public final <TResult, A extends Api.AnyClient> Task<TResult> OooO0O0(int i, @NonNull TaskApiCall<A, TResult> taskApiCall) {
        ...
        this.f14193OooOO0.zax(this, i, taskApiCall, taskCompletionSource, this.f14184OooO);
    ...
    public <A extends Api.AnyClient, T extends BaseImplementation.ApiMethodImpl<? extends Result, A>> T doBestEffortWrite(@NonNull T t) {
        t.zak();
        this.f14193OooOO0.zaw(this, 2, t);
        return t;
    }
    ...
    public <A extends Api.AnyClient, T extends BaseImplementation.ApiMethodImpl<? extends Result, A>> T doRead(@NonNull T t) {
        t.zak();
        this.f14193OooOO0.zaw(this, 0, t);
        return t;
    }
    ...
    public <A extends Api.AnyClient, T extends RegisterListenerMethod<A, ?>, U extends UnregisterListenerMethod<A, ?>> Task<Void> doRegisterEventListener(@NonNull T t, @NonNull U u) {
        ...
        return this.f14193OooOO0.zaq(this, t, u, new Runnable() { // from class: com.google.android.gms.common.api.zad
    ...
    public <A extends Api.AnyClient, T extends BaseImplementation.ApiMethodImpl<? extends Result, A>> T doWrite(@NonNull T t) {
        t.zak();
        this.f14193OooOO0.zaw(this, 1, t);
        return t;
    }
    ...
    public final ApiKey<O> getApiKey() {
        return this.f14190OooO0o0;
    }

    @NonNull
    @KeepForSdk
    public O getApiOptions() {
        return this.f14188OooO0Oo;
    }

    @NonNull
    @KeepForSdk
    public Context getApplicationContext() {
        return this.f14185OooO00o;
    }

    @NonNull
    @KeepForSdk
    public Looper getLooper() {
        return this.f14189OooO0o;
    }

    @NonNull
    @KeepForSdk
    public <L> ListenerHolder<L> registerListener(@NonNull L l, @NonNull String str) {
        return ListenerHolders.createListenerHolder(l, this.f14189OooO0o, str);
    }

    public final int zaa() {
        return this.f14191OooO0oO;
    }

    /* JADX WARN: Multi-variable type inference failed */
    @WorkerThread
    public final Api.Client zab(Looper looper, zabq<O> zabqVar) {
        Api.Client clientBuildClient = ((Api.AbstractClientBuilder) Preconditions.checkNotNull(this.f14187OooO0OO.zaa())).buildClient(this.f14185OooO00o, looper, OooO00o().build(), this.f14188OooO0Oo, (GoogleApiClient.ConnectionCallbacks) zabqVar, (GoogleApiClient.OnConnectionFailedListener) zabqVar);
        String str = this.f14186OooO0O0;
    ...
    public Task<Boolean> doUnregisterEventListener(@NonNull ListenerHolder.ListenerKey<?> listenerKey, int i) {
        ...
        return this.f14193OooOO0.zar(this, listenerKey, i);
    }
    ...
    public GoogleApi(@NonNull Context context, @Nullable Activity activity, Api<O> api, O o, Settings settings) {
        ...
        this.f14185OooO00o = context.getApplicationContext();
        ...
        this.f14186OooO0O0 = str;
        this.f14187OooO0OO = api;
        this.f14188OooO0Oo = o;
        this.f14189OooO0o = settings.zab;
        ApiKey<O> apiKeyZaa = ApiKey.zaa(api, o, str);
        this.f14190OooO0o0 = apiKeyZaa;
        this.f14192OooO0oo = new zabv(this);
        GoogleApiManager googleApiManagerZam = GoogleApiManager.zam(this.f14185OooO00o);
        this.f14193OooOO0 = googleApiManagerZam;
        this.f14191OooO0oO = googleApiManagerZam.zaa();
        this.f14184OooO = settings.zaa;
    ...
    public <A extends Api.AnyClient> Task<Void> doRegisterEventListener(@NonNull RegistrationMethods<A, ?> registrationMethods) {
        ...
        return this.f14193OooOO0.zaq(this, registrationMethods.register, registrationMethods.zaa, registrationMethods.zab);
    }
