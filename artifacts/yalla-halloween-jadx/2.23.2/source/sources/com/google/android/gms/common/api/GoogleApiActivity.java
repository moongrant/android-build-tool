...
public class GoogleApiActivity extends Activity implements DialogInterface.OnCancelListener {
    ...
    public final void onCreate(@Nullable Bundle bundle) {
        ...
        if (bundle != null) {
            this.f14196OooO0Oo = bundle.getInt("resolution");
        }
        if (this.f14196OooO0Oo != 1) {
            ...
            try {
                ...
                if (extras.getBoolean("notify_manager", true)) {
                    ...
                    String strOooO00o = OooO0O0.OooO00o(new StringBuilder(string.length() + 36), "Activity not found while launching ", string, ".");
                    if (Build.FINGERPRINT.contains("generic")) {
                        strOooO00o = strOooO00o.concat(" This may occur when resolving Google Play services connection issues on emulators with Google APIs but not Google Play Store.");
                    }
                    Log.e("GoogleApiActivity", strOooO00o, e);
                }
                this.f14196OooO0Oo = 1;
                finish();
    ...
    public final void onSaveInstanceState(@NonNull Bundle bundle) {
        bundle.putInt("resolution", this.f14196OooO0Oo);
