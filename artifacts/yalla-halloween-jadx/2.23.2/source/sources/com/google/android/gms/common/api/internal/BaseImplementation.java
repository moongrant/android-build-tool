...
public class BaseImplementation {
    ...
    public static abstract class ApiMethodImpl<R extends Result, A extends Api.AnyClient> extends BasePendingResult<R> implements ResultHolder<R> {
        ...
        @KeepForSdk
        public final Api.AnyClientKey<A> f14235OooOOOo;

        /* JADX INFO: renamed from: OooOOo0, reason: collision with root package name */
        @Nullable
        @KeepForSdk
        public final Api<?> f14236OooOOo0;

        @KeepForSdk
        public ApiMethodImpl(@NonNull Api<?> api, @NonNull GoogleApiClient googleApiClient) {
            super((GoogleApiClient) Preconditions.checkNotNull(googleApiClient, "GoogleApiClient must not be null"));
            Preconditions.checkNotNull(api, "Api must not be null");
            this.f14235OooOOOo = (Api.AnyClientKey<A>) api.zab();
            this.f14236OooOOo0 = api;
        }
        ...
        public final Api<?> getApi() {
            return this.f14236OooOOo0;
        }

        @NonNull
        @KeepForSdk
        public final Api.AnyClientKey<A> getClientKey() {
            return this.f14235OooOOOo;
        }
