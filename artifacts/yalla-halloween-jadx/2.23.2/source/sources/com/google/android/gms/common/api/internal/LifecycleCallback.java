...
public class LifecycleCallback {
    ...
    @NonNull
    @KeepForSdk
    public final LifecycleFragment f14277OooO0Oo;

    @KeepForSdk
    public LifecycleCallback(@NonNull LifecycleFragment lifecycleFragment) {
        this.f14277OooO0Oo = lifecycleFragment;
    }

    @NonNull
    @KeepForSdk
    public static LifecycleFragment OooO00o(@NonNull LifecycleActivity lifecycleActivity) {
    ...
    public static LifecycleFragment getFragment(@NonNull Activity activity) {
        return OooO00o(new LifecycleActivity(activity));
    }
