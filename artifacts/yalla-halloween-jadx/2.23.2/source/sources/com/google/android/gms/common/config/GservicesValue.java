...
import p255o00ooOO.o000O0;
import p255o00ooOO.o000O00;
import p255o00ooOO.o000O00O;
import p255o00ooOO.o000O0Oo;
import p255o00ooOO.o000OO0O;
...
public abstract class GservicesValue<T> {
    ...
    public static final Object f14466OooO0OO = new Object();

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    @NonNull
    public final Object f14467OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @Nullable
    public Object f14468OooO0O0 = null;

    public GservicesValue(@NonNull String str, @NonNull Object obj) {
        this.f14467OooO00o = obj;
    }

    @KeepForSdk
    public static boolean isInitialized() {
        synchronized (f14466OooO0OO) {
        }
        return false;
    }
    ...
    @KeepForSdk
    public final T get() {
        T t = (T) this.f14468OooO0O0;
        if (t != null) {
            return t;
        }
        StrictMode.ThreadPolicy threadPolicyAllowThreadDiskReads = StrictMode.allowThreadDiskReads();
        Object obj = f14466OooO0OO;
        synchronized (obj) {
        }
        synchronized (obj) {
            try {
    ...
    public static GservicesValue<Boolean> value(@NonNull String str, boolean z) {
        return new o000O00(str, Boolean.valueOf(z));
    }
}
