...
public class DataBufferSafeParcelable<T extends SafeParcelable> extends AbstractDataBuffer<T> {
    ...
    public static final String[] f14482OooO0o = {"data"};

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final Parcelable.Creator<T> f14483OooO0o0;

    @KeepForSdk
    public DataBufferSafeParcelable(@NonNull DataHolder dataHolder, @NonNull Parcelable.Creator<T> creator) {
        super(dataHolder);
        this.f14483OooO0o0 = creator;
    }
    ...
    public static DataHolder.Builder buildDataHolder() {
        return DataHolder.builder(f14482OooO0o);
    }
    ...
    @KeepForSdk
    public T get(int i) {
        DataHolder dataHolder = (DataHolder) Preconditions.checkNotNull(this.f14469OooO0Oo);
        byte[] byteArray = dataHolder.getByteArray("data", i, dataHolder.getWindowIndex(i));
        Parcel parcelObtain = Parcel.obtain();
        parcelObtain.unmarshall(byteArray, 0, byteArray.length);
        parcelObtain.setDataPosition(0);
        T tCreateFromParcel = this.f14483OooO0o0.createFromParcel(parcelObtain);
        parcelObtain.recycle();
