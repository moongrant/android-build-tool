...
public class LibraryVersion {
    ...
    public static final GmsLogger f14609OooO0O0 = new GmsLogger("LibraryVersion", "");

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final LibraryVersion f14610OooO0OO = new LibraryVersion();

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final ConcurrentHashMap f14611OooO00o = new ConcurrentHashMap();
    ...
    public String getVersion(@NonNull String str) throws Throwable {
        ?? r5;
        String property;
        GmsLogger gmsLogger = f14609OooO0O0;
        Preconditions.checkNotEmpty(str, "Please provide a valid libraryName");
        ConcurrentHashMap concurrentHashMap = this.f14611OooO00o;
