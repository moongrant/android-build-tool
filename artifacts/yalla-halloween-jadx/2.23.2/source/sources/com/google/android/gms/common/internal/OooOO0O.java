...
public final class OooOO0O extends com.google.android.gms.internal.common.zzi {
    ...
    public final /* synthetic */ BaseGmsClient f14630OooO00o;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooOO0O(BaseGmsClient baseGmsClient, Looper looper) {
        super(looper);
        this.f14630OooO00o = baseGmsClient;
    }

    @Override // android.os.Handler
    public final void handleMessage(Message message) {
        BaseGmsClient baseGmsClient = this.f14630OooO00o;
        boolean z = false;
        if (baseGmsClient.f14560OooOoo.get() != message.arg1) {
            int i = message.what;
            if (i == 2 || i == 1 || i == 7) {
        ...
        int i3 = message.what;
        if (i3 == 4) {
            baseGmsClient.f14557OooOoO = new ConnectionResult(message.arg2);
            if (!baseGmsClient.f14559OooOoOO && !TextUtils.isEmpty(baseGmsClient.OooO0Oo()) && !TextUtils.isEmpty(null)) {
                try {
            ...
            if (z && !baseGmsClient.f14559OooOoOO) {
                baseGmsClient.OooO(3, null);
                return;
            }
            ConnectionResult connectionResult = baseGmsClient.f14557OooOoO;
        ...
        if (i3 == 5) {
            ConnectionResult connectionResult2 = baseGmsClient.f14557OooOoO;
            if (connectionResult2 == null) {
                connectionResult2 = new ConnectionResult(8);
            }
            baseGmsClient.f14548OooOOOo.onReportServiceBinding(connectionResult2);
        ...
        if (i3 == 3) {
            ...
            baseGmsClient.f14548OooOOOo.onReportServiceBinding(connectionResult3);
        ...
        if (i3 == 6) {
            ...
            baseGmsClient.f14534OooO00o = message.arg2;
            baseGmsClient.f14535OooO0O0 = System.currentTimeMillis();
