...
public class SafeParcelReader {
    ...
    public static void OooO00o(Parcel parcel, int i, int i2) {
        ...
        throw new ParseException(o0oOO.OooO0O0(o00000.OooO00o("Expected size ", i2, " got ", i, " (0x"), Integer.toHexString(i), ")"), parcel);
    }
    ...
    public static void OooO0O0(Parcel parcel, int i, int i2) {
        ...
        throw new ParseException(o0oOO.OooO0O0(o00000.OooO00o("Expected size ", i2, " got ", size, " (0x"), Integer.toHexString(size), ")"), parcel);
    }
    ...
    public static int validateObjectHeader(@NonNull Parcel parcel) {
        ...
        if (i < iDataPosition || i > parcel.dataSize()) {
            throw new ParseException(OooO0O0.OooO0O0("Size read is invalid start=", iDataPosition, " end=", i), parcel);
        }
        return i;
    }
}
