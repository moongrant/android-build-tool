...
public final class zac {
    ...
    @GuardedBy("sCache")
    public static final OooOo<String, String> f14647OooO00o = new OooOo<>();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @Nullable
    @GuardedBy("sCache")
    public static Locale f14648OooO0O0;
    ...
    public static String OooO0O0(Context context, String str) {
        OooOo<String, String> oooOo = f14647OooO00o;
        synchronized (oooOo) {
            Locale localeOooO0OO = o00O0O.OooO00o(context.getResources().getConfiguration()).OooO0OO(0);
            if (!localeOooO0OO.equals(f14648OooO0O0)) {
                oooOo.clear();
                f14648OooO0O0 = localeOooO0OO;
            }
            String orDefault = oooOo.getOrDefault(str, null);
            if (orDefault != null) {
                return orDefault;
            }
