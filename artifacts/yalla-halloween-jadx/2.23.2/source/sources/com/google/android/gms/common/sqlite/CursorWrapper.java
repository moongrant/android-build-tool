...
public class CursorWrapper extends android.database.CursorWrapper implements CrossProcessCursor {
    ...
    public final AbstractWindowedCursor f14762OooO0Oo;
    ...
    public CursorWrapper(@NonNull Cursor cursor) {
        ...
        this.f14762OooO0Oo = (AbstractWindowedCursor) cursor;
    }

    @Override // android.database.CrossProcessCursor
    @KeepForSdk
    public void fillWindow(int i, @NonNull CursorWindow cursorWindow) {
        this.f14762OooO0Oo.fillWindow(i, cursorWindow);
    }
    ...
    public CursorWindow getWindow() {
        return this.f14762OooO0Oo.getWindow();
    }

    @Override // android.database.CursorWrapper
    @NonNull
    public final /* synthetic */ Cursor getWrappedCursor() {
        return this.f14762OooO0Oo;
    }

    @Override // android.database.CrossProcessCursor
    public final boolean onMove(int i, int i2) {
        return this.f14762OooO0Oo.onMove(i, i2);
    }

    @KeepForSdk
    public void setWindow(@Nullable CursorWindow cursorWindow) {
        this.f14762OooO0Oo.setWindow(cursorWindow);
    }
}
