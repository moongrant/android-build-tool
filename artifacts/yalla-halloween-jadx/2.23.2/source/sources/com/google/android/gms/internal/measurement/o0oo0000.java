...
public final class o0oo0000 {
    ...
    public static final Unsafe f15142OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final Class f15143OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final oO0Oo f15144OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public static final boolean f15145OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public static final long f15146OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public static final boolean f15147OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public static final boolean f15148OooO0oO;
    ...
    static {
        ...
        f15142OooO00o = unsafeOooOO0O;
        int i = o00OOOO0.f15031OooO00o;
        f15143OooO0O0 = Memory.class;
        Class<?> cls = Long.TYPE;
        ...
        f15144OooO0OO = o0ooo001;
        if (o0ooo001 == null) {
            z = false;
        } else {
            try {
                Class<?> cls2 = o0ooo001.f15155OooO00o.getClass();
        ...
        f15145OooO0Oo = z;
        oO0Oo oo0oo2 = f15144OooO0OO;
        if (oo0oo2 == null) {
            z2 = false;
        } else {
            try {
                Class<?> cls3 = oo0oo2.f15155OooO00o.getClass();
        ...
        f15147OooO0o0 = z2;
        f15146OooO0o = OooOo0o(byte[].class);
        ...
        if (fieldOooO0O0 != null && (oo0oo = f15144OooO0OO) != null) {
            oo0oo.f15155OooO00o.objectFieldOffset(fieldOooO0O0);
        }
        f15148OooO0oO = ByteOrder.nativeOrder() == ByteOrder.BIG_ENDIAN;
    }

    public static Object OooO(Class cls) {
        try {
            return f15142OooO00o.allocateInstance(cls);
    ...
    public static void OooO00o(Class cls) {
        if (f15147OooO0o0) {
            f15144OooO0OO.f15155OooO00o.arrayIndexScale(cls);
        }
    }
    ...
    public static void OooO0OO(Object obj, long j, byte b) {
        oO0Oo oo0oo = f15144OooO0OO;
        long j2 = (-4) & j;
        int i = oo0oo.f15155OooO00o.getInt(obj, j2);
        int i2 = ((~((int) j)) & 3) << 3;
        oo0oo.f15155OooO00o.putInt(obj, j2, ((255 & b) << i2) | (i & (~(255 << i2))));
    }
    ...
    public static void OooO0Oo(Object obj, long j, byte b) {
        ...
        long j2 = (-4) & j;
        int i = (((int) j) & 3) << 3;
        oo0oo.f15155OooO00o.putInt(obj, j2, ((255 & b) << i) | (oo0oo.f15155OooO00o.getInt(obj, j2) & (~(255 << i))));
    }

    public static float OooO0o(long j, Object obj) {
        return f15144OooO0OO.OooO0O0(j, obj);
    }

    public static double OooO0o0(long j, Object obj) {
        return f15144OooO0OO.OooO00o(j, obj);
    }

    public static int OooO0oO(long j, Object obj) {
        return f15144OooO0OO.f15155OooO00o.getInt(obj, j);
    }

    public static long OooO0oo(long j, Object obj) {
        return f15144OooO0OO.f15155OooO00o.getLong(obj, j);
    }

    public static Object OooOO0(long j, Object obj) {
        return f15144OooO0OO.f15155OooO00o.getObject(obj, j);
    }
    ...
    public static boolean OooOo0O(long j, Object obj) {
        return f15144OooO0OO.OooO0oO(j, obj);
    }

    public static int OooOo0o(Class cls) {
        if (f15147OooO0o0) {
            return f15144OooO0OO.f15155OooO00o.arrayBaseOffset(cls);
        }
        return -1;
    }
}
