...
public final class zzae implements Iterable, zzap, zzal {
    ...
    public final TreeMap f15175OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final TreeMap f15176OooO0o0;

    public zzae() {
        this.f15175OooO0Oo = new TreeMap();
        this.f15176OooO0o0 = new TreeMap();
    }
    ...
    public final boolean equals(Object obj) {
        ...
        TreeMap treeMap = this.f15175OooO0Oo;
        if (treeMap.isEmpty()) {
            return zzaeVar.f15175OooO0Oo.isEmpty();
        }
    ...
    public final int hashCode() {
        return this.f15175OooO0Oo.hashCode() * 31;
    }
    ...
    public final int zzb() {
        return this.f15175OooO0Oo.size();
    }
    ...
    public final zzap zzd() {
        ...
        for (Map.Entry entry : this.f15175OooO0Oo.entrySet()) {
            boolean z = entry.getValue() instanceof zzal;
            TreeMap treeMap = zzaeVar.f15175OooO0Oo;
            if (z) {
    ...
    public final zzap zze(int i) {
        zzap zzapVar;
        if (i < zzc()) {
            return (!zzs(i) || (zzapVar = (zzap) this.f15175OooO0Oo.get(Integer.valueOf(i))) == null) ? zzap.zzf : zzapVar;
        }
    ...
    public final zzap zzf(String str) {
        ...
        return (!zzt(str) || (zzapVar = (zzap) this.f15176OooO0o0.get(str)) == null) ? zzap.zzf : zzapVar;
    }
    ...
    public final Iterator zzk() {
        return this.f15175OooO0Oo.keySet().iterator();
    }

    @Override // com.google.android.gms.internal.measurement.zzap
    public final Iterator zzl() {
        return new OooO00o(this.f15175OooO0Oo.keySet().iterator(), this.f15176OooO0o0.keySet().iterator());
    }
    ...
    public final void zzr(String str, zzap zzapVar) {
        TreeMap treeMap = this.f15176OooO0o0;
        if (zzapVar == null) {
            treeMap.remove(str);
        } else {
    ...
    public final boolean zzt(String str) {
        return "length".equals(str) || this.f15176OooO0o0.containsKey(str);
    }
