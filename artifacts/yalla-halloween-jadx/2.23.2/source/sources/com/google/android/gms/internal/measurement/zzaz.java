...
public final class zzaz extends zzaw {
    public zzaz() {
        this.f15190OooO00o.add(zzbl.APPLY);
        this.f15190OooO00o.add(zzbl.BLOCK);
        this.f15190OooO00o.add(zzbl.BREAK);
        this.f15190OooO00o.add(zzbl.CASE);
        this.f15190OooO00o.add(zzbl.DEFAULT);
        this.f15190OooO00o.add(zzbl.CONTINUE);
        this.f15190OooO00o.add(zzbl.DEFINE_FUNCTION);
        this.f15190OooO00o.add(zzbl.FN);
        this.f15190OooO00o.add(zzbl.IF);
        this.f15190OooO00o.add(zzbl.QUOTE);
        this.f15190OooO00o.add(zzbl.RETURN);
        this.f15190OooO00o.add(zzbl.SWITCH);
        this.f15190OooO00o.add(zzbl.TERNARY);
    }

    public static zzao OooO0O0(zzg zzgVar, List list) {
    ...
    */
    public final zzap zza(String str, zzg zzgVar, List list) {
        ...
        if (iOrdinal == 2) {
            zzap zzapVarZzb2 = zzgVar.zzb((zzap) OooOO0.OooO00o(zzbl.APPLY, 3, list, 0));
            ...
            return zzapVarZzb2.zzbU(strZzi, zzgVar, ((zzae) zzapVarZzb3).zzm());
        }
        if (iOrdinal == 15) {
        ...
        if (iOrdinal == 57) {
            return list.isEmpty() ? zzap.zzj : new zzag("return", zzgVar.zzb((zzap) OooOO0.OooO00o(zzbl.RETURN, 1, list, 0)));
        }
        if (iOrdinal != 19) {
            if (iOrdinal == 20) {
                zzh.zzi(zzbl.DEFINE_FUNCTION.name(), 2, list);
                zzao zzaoVarOooO0O0 = OooO0O0(zzgVar, list);
                if (zzaoVarOooO0O0.zzc() == null) {
                    zzgVar.zzg("", zzaoVarOooO0O0);
                } else {
                    zzgVar.zzg(zzaoVarOooO0O0.zzc(), zzaoVarOooO0O0);
                }
                return zzaoVarOooO0O0;
            }
            if (iOrdinal == 60) {
                zzap zzapVarZzb7 = zzgVar.zzb((zzap) OooOO0.OooO00o(zzbl.SWITCH, 3, list, 0));
            ...
            if (iOrdinal == 61) {
                return zzgVar.zzb((zzap) OooOO0.OooO00o(zzbl.TERNARY, 3, list, 0)).zzg().booleanValue() ? zzgVar.zzb((zzap) list.get(1)) : zzgVar.zzb((zzap) list.get(2));
            }
            switch (iOrdinal) {
                case 11:
