...
public abstract class zzjk<MessageType extends zzjk<MessageType, BuilderType>, BuilderType extends zzjj<MessageType, BuilderType>> implements zzmi {
    ...
    public static void OooO0O0(Iterable iterable, zzli zzliVar) {
        ...
        if (iterable instanceof o0O0oo00) {
    ...
    public int OooO00o(oo0oO0 oo0oo0) {
        throw null;
    }
    ...
    public final zzka zzbv() {
        try {
            ...
            throw new RuntimeException(p004OooO0oO.o000oOoO.OooO0O0("Serializing ", getClass().getName(), " to a ByteString threw an IOException (should never happen)."), e);
        }
    }
    ...
    public final byte[] zzbx() {
        try {
            ...
            throw new RuntimeException(p004OooO0oO.o000oOoO.OooO0O0("Serializing ", getClass().getName(), " to a byte array threw an IOException (should never happen)."), e);
        }
    }
}
