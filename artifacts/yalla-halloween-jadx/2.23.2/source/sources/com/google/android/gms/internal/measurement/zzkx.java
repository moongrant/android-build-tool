...
public class zzkx<MessageType extends zzlb<MessageType, BuilderType>, BuilderType extends zzkx<MessageType, BuilderType>> extends zzjj<MessageType, BuilderType> {
    ...
    public final zzlb f15274OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public zzlb f15275OooO0o0;

    public zzkx(MessageType messagetype) {
        this.f15274OooO0Oo = messagetype;
        if (messagetype.OooOO0O()) {
            throw new IllegalArgumentException("Default instance must be immutable.");
        }
        this.f15275OooO0o0 = (zzlb) messagetype.OooOO0o(4);
    }

    public final void OooO0O0() {
        if (this.f15275OooO0o0.OooOO0O()) {
            return;
        }
        zzlb zzlbVar = (zzlb) this.f15274OooO0Oo.OooOO0o(4);
        o0O.f15041OooO0OO.OooO00o(zzlbVar.getClass()).OooO0o(zzlbVar, this.f15275OooO0o0);
        this.f15275OooO0o0 = zzlbVar;
    }
    ...
    public final zzkx zzav() {
        zzkx zzkxVar = (zzkx) this.f15274OooO0Oo.OooOO0o(5);
        zzkxVar.f15275OooO0o0 = zzaF();
        return zzkxVar;
    }

    public final zzkx zzaB(zzlb zzlbVar) {
        zzlb zzlbVar2 = this.f15274OooO0Oo;
        if (!zzlbVar2.equals(zzlbVar)) {
            if (!this.f15275OooO0o0.OooOO0O()) {
                zzlb zzlbVar3 = (zzlb) zzlbVar2.OooOO0o(4);
                o0O.f15041OooO0OO.OooO00o(zzlbVar3.getClass()).OooO0o(zzlbVar3, this.f15275OooO0o0);
                this.f15275OooO0o0 = zzlbVar3;
            }
            zzlb zzlbVar4 = this.f15275OooO0o0;
            o0O.f15041OooO0OO.OooO00o(zzlbVar4.getClass()).OooO0o(zzlbVar4, zzlbVar);
        }
        return this;
    }
    ...
    public final zzkx zzaC(byte[] bArr, int i, int i2, zzkn zzknVar) throws zzll {
        ...
        try {
            o0O.f15041OooO0OO.OooO00o(this.f15275OooO0o0.getClass()).OooO0Oo(this.f15275OooO0o0, bArr, 0, i2, new o00OOOOo(zzknVar));
            return this;
        } catch (zzll e) {
            throw e;
    ...
    */
    public final MessageType zzaD() {
        ...
        if (bByteValue != 1) {
            if (bByteValue != 0) {
                boolean zOooO0oo = o0O.f15041OooO0OO.OooO00o(messagetype.getClass()).OooO0oo(messagetype);
    ...
    public MessageType zzaF() {
        if (!this.f15275OooO0o0.OooOO0O()) {
            return (MessageType) this.f15275OooO0o0;
        }
        zzlb zzlbVar = this.f15275OooO0o0;
        zzlbVar.getClass();
        o0O.f15041OooO0OO.OooO00o(zzlbVar.getClass()).OooO00o(zzlbVar);
        zzlbVar.OooO0oo();
        return (MessageType) this.f15275OooO0o0;
    }
    ...
    public final /* bridge */ /* synthetic */ zzjj zzaw(byte[] bArr, int i, int i2) throws zzll {
        zzaC(bArr, 0, i2, zzkn.f15272OooO0OO);
        return this;
    }
