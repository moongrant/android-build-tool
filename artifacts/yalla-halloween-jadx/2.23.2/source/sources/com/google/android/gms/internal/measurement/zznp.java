...
public final class zznp extends AbstractList implements RandomAccess, zzlq {
    ...
    public final zzlq f15291OooO0Oo;

    public zznp(zzlq zzlqVar) {
        this.f15291OooO0Oo = zzlqVar;
    }

    @Override // java.util.AbstractList, java.util.List
    public final /* bridge */ /* synthetic */ Object get(int i) {
        return ((zzlp) this.f15291OooO0Oo).get(i);
    }
    ...
    public final int size() {
        return this.f15291OooO0Oo.size();
    }
    ...
    public final Object zzf(int i) {
        return this.f15291OooO0Oo.zzf(i);
    }

    @Override // com.google.android.gms.internal.measurement.zzlq
    public final List zzh() {
        return this.f15291OooO0Oo.zzh();
    }
