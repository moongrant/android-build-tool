...
public final class zzv extends zzai {
    ...
    public final zzz f15356OooO0o;

    public zzv(zzz zzzVar) {
        super("internal.registerCallback");
        this.f15356OooO0o = zzzVar;
    }
    ...
    public final zzap zza(zzg zzgVar, List list) {
        ...
        this.f15356OooO0o.zza(strZzi, zzamVar.zzt("priority") ? zzh.zzb(zzamVar.zzf("priority").zzh().doubleValue()) : 1000, (zzao) zzapVarZzb, zzamVar.zzf("type").zzi());
        return zzap.zzf;
    }
}
