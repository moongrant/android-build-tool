...
public final class OooO0OO extends zzy {
    ...
    public final transient zzx f15368OooO0o;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final transient Object[] f15369OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final transient int f15370OooO0oo;

    public OooO0OO(zzx zzxVar, Object[] objArr, int i) {
        this.f15368OooO0o = zzxVar;
        this.f15369OooO0oO = objArr;
        this.f15370OooO0oo = i;
    }
    ...
    public final boolean contains(@CheckForNull Object obj) {
        if (obj instanceof Map.Entry) {
            ...
            if (value != null && value.equals(this.f15368OooO0o.get(key))) {
                return true;
            }
        }
        return false;
