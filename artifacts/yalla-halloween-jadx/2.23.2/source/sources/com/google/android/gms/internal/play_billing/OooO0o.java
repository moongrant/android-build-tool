...
public final class OooO0o extends zzy {
    ...
    public final transient zzx f15371OooO0o;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final transient zzu f15372OooO0oO;

    public OooO0o(zzx zzxVar, OooO oooO) {
        this.f15371OooO0o = zzxVar;
        this.f15372OooO0oO = oooO;
    }

    @Override // com.google.android.gms.internal.play_billing.zzr
    public final int OooO00o(Object[] objArr) {
        return this.f15372OooO0oO.OooO00o(objArr);
    }
    ...
    public final boolean contains(@CheckForNull Object obj) {
        return this.f15371OooO0o.get(obj) != null;
    }
    ...
    public final /* synthetic */ Iterator iterator() {
        return this.f15372OooO0oO.listIterator(0);
    }

    @Override // java.util.AbstractCollection, java.util.Collection, java.util.Set
    public final int size() {
        return this.f15371OooO0o.size();
    }
