...
public final class zzb {
    ...
    public static Bundle zze(int i, boolean z, String str, @Nullable String str2, ArrayList arrayList) {
        ...
        if (i >= 14) {
            ...
            boolean z2 = false;
            boolean z3 = false;
            for (int iOooO00o = 0; iOooO00o < size; iOooO00o = o00O.OooO00o(0, arrayList4, iOooO00o, 1)) {
                arrayList2.add(null);
    ...
    public static Bundle zzf(BillingFlowParams billingFlowParams, boolean z, boolean z2, boolean z3, String str) {
        Bundle bundle = new Bundle();
        bundle.putString("playBillingLibraryVersion", str);
        int i = billingFlowParams.f12697OooO0Oo.f12711OooO0O0;
        if (i != 0) {
            bundle.putInt("prorationMode", i);
        }
        if (!TextUtils.isEmpty(billingFlowParams.f12695OooO0O0)) {
            bundle.putString("accountId", billingFlowParams.f12695OooO0O0);
        }
        if (!TextUtils.isEmpty(billingFlowParams.f12696OooO0OO)) {
            bundle.putString("obfuscatedProfileId", billingFlowParams.f12696OooO0OO);
        }
        if (billingFlowParams.f12700OooO0oO) {
            bundle.putBoolean("isOfferPersonalizedByDeveloper", true);
        }
        if (!TextUtils.isEmpty(null)) {
            bundle.putStringArrayList("skusToReplace", new ArrayList<>(Arrays.asList(null)));
        }
        if (!TextUtils.isEmpty(billingFlowParams.f12697OooO0Oo.f12710OooO00o)) {
            bundle.putString("oldSkuPurchaseToken", billingFlowParams.f12697OooO0Oo.f12710OooO00o);
        }
        if (!TextUtils.isEmpty(null)) {
    ...
    public static OooOo00 zzi(Intent intent, String str) {
        if (intent != null) {
            ...
            oooO00oOooO0O0.f12748OooO00o = zzb(intent.getExtras(), str);
            oooO00oOooO0O0.f12749OooO0O0 = zzk(intent.getExtras(), str);
            return oooO00oOooO0O0.OooO00o();
        }
        zzo("BillingHelper", "Got null intent!");
        OooOo00.OooO00o oooO00oOooO0O1 = OooOo00.OooO0O0();
        oooO00oOooO0O1.f12748OooO00o = 6;
        oooO00oOooO0O1.f12749OooO0O0 = "An internal error occurred.";
    ...
    public static String zzl(int i) {
        return o0O00oO0.OooO00o(i).toString();
    }
