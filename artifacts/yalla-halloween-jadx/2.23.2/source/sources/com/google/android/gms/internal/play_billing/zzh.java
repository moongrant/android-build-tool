...
public class zzh implements IInterface {
    ...
    public final IBinder f15376OooO0Oo;

    public zzh(IBinder iBinder) {
        this.f15376OooO0Oo = iBinder;
    }

    public static Parcel OooOOoo() {
    ...
    public final Parcel OooOo00(Parcel parcel, int i) throws RemoteException {
        ...
        try {
            try {
                this.f15376OooO0Oo.transact(i, parcel, parcelObtain, 0);
