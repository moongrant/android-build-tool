...
import p271o00ooooo.oO0;
import p271o00ooooo.oO000o00;
import p271o00ooooo.oO00O0o;
import p271o00ooooo.oO0O000;
import p271o00ooooo.oO0O0OoO;
import p271o00ooooo.oOO0000;
import p271o00ooooo.oOo000o0;

/* JADX INFO: loaded from: classes3.dex */
public final class zzfu extends j0 implements oO000o00 {

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    public final OooO f15491OooO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final OooO f15492OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @VisibleForTesting
    public final OooO f15493OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @VisibleForTesting
    public final OooO f15494OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    @VisibleForTesting
    public final OooO f15495OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final OooO f15496OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    @VisibleForTesting
    public final oOo000o0 f15497OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public final oO0 f15498OooOO0O;

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    public final OooO f15499OooOO0o;

    /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
    public final OooO f15500OooOOO;

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    public final OooO f15501OooOOO0;

    public zzfu(zzlh zzlhVar) {
        super(zzlhVar);
        this.f15492OooO0Oo = new OooO();
        this.f15494OooO0o0 = new OooO();
        this.f15493OooO0o = new OooO();
        this.f15495OooO0oO = new OooO();
        this.f15496OooO0oo = new OooO();
        this.f15499OooOO0o = new OooO();
        this.f15501OooOOO0 = new OooO();
        this.f15500OooOOO = new OooO();
        this.f15491OooO = new OooO();
        this.f15497OooOO0 = new oOo000o0(this);
        this.f15498OooOO0O = new oO0(this);
    }

    public static final OooO OooO0oO(com.google.android.gms.internal.measurement.zzff zzffVar) {
        OooO oooO = new OooO();
        if (zzffVar != null) {
            for (zzfj zzfjVar : zzffVar.zzp()) {
                oooO.put(zzfjVar.zzb(), zzfjVar.zzc());
            }
        }
        return oooO;
    }
    ...
    public final com.google.android.gms.internal.measurement.zzff OooO(String str) {
        ...
        OooO0o0(str);
        return (com.google.android.gms.internal.measurement.zzff) this.f15496OooO0oo.getOrDefault(str, null);
    }
        ...
        for (int i = 0; i < zzfeVar.zza(); i++) {
            ...
            if (zIsEmpty) {
                ...
                if (zzfcVar.zzf() && zzfcVar.zzd()) {
                    oooO.put(strZzc, Boolean.TRUE);
                }
                if (zzfcVar.zzg() && zzfcVar.zze()) {
                    oooO2.put(zzfcVar.zzc(), Boolean.TRUE);
                }
                if (zzfcVar.zzh()) {
                    if (zzfcVar.zza() < 2 || zzfcVar.zza() > 65535) {
                        ...
                        oooO3.put(zzfcVar.zzc(), Integer.valueOf(zzfcVar.zza()));
                    }
                }
            }
        }
        this.f15494OooO0o0.put(str, hashSet);
        this.f15493OooO0o.put(str, oooO);
        this.f15495OooO0oO.put(str, oooO2);
        this.f15491OooO.put(str, oooO3);
    }

    @WorkerThread
    public final void OooO0o(final String str, com.google.android.gms.internal.measurement.zzff zzffVar) {
        int iZza = zzffVar.zza();
        oOo000o0 ooo000o0 = this.f15497OooOO0;
        if (iZza == 0) {
            ooo000o0.remove(str);
            return;
        }
        ...
        try {
            ...
            zzcVar.zzd("internal.remoteConfig", new Callable() { // from class: com.google.android.gms.measurement.internal.zzfo
                ...
                public final Object call() {
                    return new zzn("internal.remoteConfig", new oO0O000(this.zza, str));
                }
            });
                ...
                public final Object call() {
                    ...
                    return new zzu("internal.appMetadata", new Callable() { // from class: com.google.android.gms.measurement.internal.zzfn
                        ...
                        public final Object call() {
                            ...
                            String str3 = str2;
                            oOO0000 ooo0000OooOOoo = zzfuVar2.f40509OooO0O0.zzh().OooOOoo(str3);
                            HashMap map = new HashMap();
                            map.put("platform", "android");
                            map.put("package_name", str3);
                            zzfuVar2.f40788OooO00o.zzf().zzh();
                            map.put("gmp_version", 79000L);
                            if (ooo0000OooOOoo != null) {
                                String strOooOoO0 = ooo0000OooOOoo.OooOoO0();
                                if (strOooOoO0 != null) {
                                    map.put("app_version", strOooOoO0);
                                }
                                map.put("app_version_int", Long.valueOf(ooo0000OooOOoo.OooOo00()));
                                ooo0000OooOOoo.f40653OooO00o.zzaB().zzg();
                                map.put("dynamite_version", Long.valueOf(ooo0000OooOOoo.f40670OooOOoo));
                            }
                            return map;
                        }
                    });
            ...
            zzcVar.zzd("internal.logger", new Callable() { // from class: com.google.android.gms.measurement.internal.zzfq
                @Override // java.util.concurrent.Callable
                public final Object call() {
                    return new com.google.android.gms.internal.measurement.zzt(this.zza.f15498OooOO0O);
                }
            });
            zzcVar.zzc(zzgtVar);
            ooo000o0.put(str, zzcVar);
    ...
    public final void OooO0o0(String str) {
        ...
        zzg();
        Preconditions.checkNotEmpty(str);
        OooO oooO5 = this.f15496OooO0oo;
        if (oooO5.getOrDefault(str, null) == 0) {
            oO00O0o oo00o0oZzh = this.f40509OooO0O0.zzh();
            Preconditions.checkNotEmpty(str);
            oo00o0oZzh.zzg();
            ...
            try {
                try {
                    cursorQuery = oo00o0oZzh.OooOOo().query("apps", new String[]{"remote_config", "config_last_modified_time", "e_tag"}, "app_id=?", new String[]{str}, null, null, null);
                    try {
                        if (cursorQuery.moveToFirst()) {
                            ...
                            if (blob != null) {
                                oo0o0ooo = new oO0O0OoO(string, string2, blob);
                                cursorQuery.close();
                            }
                            oooO = this.f15500OooOOO;
                            oooO2 = this.f15501OooOOO0;
                            oooO3 = this.f15499OooOO0o;
                            oooO4 = this.f15492OooO0Oo;
                            if (oo0o0ooo != null) {
                                com.google.android.gms.internal.measurement.zzfe zzfeVar = (com.google.android.gms.internal.measurement.zzfe) OooO0OO(str, oo0o0ooo.f40626OooO00o).zzbB();
                                OooO0Oo(str, zzfeVar);
                                oooO4.put(str, OooO0oO((com.google.android.gms.internal.measurement.zzff) zzfeVar.zzaD()));
                                oooO5.put(str, (com.google.android.gms.internal.measurement.zzff) zzfeVar.zzaD());
                                OooO0o(str, (com.google.android.gms.internal.measurement.zzff) zzfeVar.zzaD());
                                oooO3.put(str, zzfeVar.zze());
                                oooO2.put(str, oo0o0ooo.f40627OooO0O0);
                                oooO.put(str, oo0o0ooo.f40628OooO0OO);
                                return;
                            }
                            oooO4.put(str, null);
                            this.f15493OooO0o.put(str, null);
                            this.f15494OooO0o0.put(str, null);
                            this.f15495OooO0oO.put(str, null);
                            oooO5.put(str, null);
                            oooO3.put(str, null);
                            oooO2.put(str, null);
                            oooO.put(str, null);
                            this.f15491OooO.put(str, null);
                        }
                        ...
                        oooO4 = this.f15492OooO0Oo;
                        if (oo0o0ooo != null) {
                            com.google.android.gms.internal.measurement.zzfe zzfeVar2 = (com.google.android.gms.internal.measurement.zzfe) OooO0OO(str, oo0o0ooo.f40626OooO00o).zzbB();
                            OooO0Oo(str, zzfeVar2);
                            oooO4.put(str, OooO0oO((com.google.android.gms.internal.measurement.zzff) zzfeVar2.zzaD()));
                            oooO5.put(str, (com.google.android.gms.internal.measurement.zzff) zzfeVar2.zzaD());
                            OooO0o(str, (com.google.android.gms.internal.measurement.zzff) zzfeVar2.zzaD());
                            oooO3.put(str, zzfeVar2.zze());
                            oooO2.put(str, oo0o0ooo.f40627OooO0O0);
                            oooO.put(str, oo0o0ooo.f40628OooO0OO);
                            return;
                        }
            ...
            oooO4 = this.f15492OooO0Oo;
            if (oo0o0ooo != null) {
                com.google.android.gms.internal.measurement.zzfe zzfeVar3 = (com.google.android.gms.internal.measurement.zzfe) OooO0OO(str, oo0o0ooo.f40626OooO00o).zzbB();
                OooO0Oo(str, zzfeVar3);
                oooO4.put(str, OooO0oO((com.google.android.gms.internal.measurement.zzff) zzfeVar3.zzaD()));
                oooO5.put(str, (com.google.android.gms.internal.measurement.zzff) zzfeVar3.zzaD());
                OooO0o(str, (com.google.android.gms.internal.measurement.zzff) zzfeVar3.zzaD());
                oooO3.put(str, zzfeVar3.zze());
                oooO2.put(str, oo0o0ooo.f40627OooO0O0);
                oooO.put(str, oo0o0ooo.f40628OooO0OO);
                return;
            }
    ...
    public final int OooO0oo(String str, String str2) {
        ...
        zzg();
        OooO0o0(str);
        Map map = (Map) this.f15491OooO.getOrDefault(str, null);
    ...
    public final boolean OooOO0(String str, String str2) {
        ...
        Map map = (Map) this.f15495OooO0oO.getOrDefault(str, null);
    ...
    public final boolean OooOO0O(String str, String str2) {
        ...
        Map map = (Map) this.f15493OooO0o.getOrDefault(str, null);
        if (map == null || (bool = (Boolean) map.get(str2)) == null) {
            return false;
        }
        return bool.booleanValue();
    ...
    public final void OooOO0o(String str, String str2, byte[] bArr, String str3) throws Throwable {
        ...
        OooO0Oo(str, zzfeVar2);
        OooO0o(str, (com.google.android.gms.internal.measurement.zzff) zzfeVar2.zzaD());
        OooO oooO = this.f15496OooO0oo;
        oooO.put(str, (com.google.android.gms.internal.measurement.zzff) zzfeVar2.zzaD());
        this.f15499OooOO0o.put(str, zzfeVar2.zze());
        this.f15501OooOOO0.put(str, str2);
        this.f15500OooOOO.put(str, str3);
        this.f15492OooO0Oo.put(str, OooO0oO((com.google.android.gms.internal.measurement.zzff) zzfeVar2.zzaD()));
        ...
        Preconditions.checkNotEmpty(str);
        Preconditions.checkNotNull(arrayList);
        SQLiteDatabase sQLiteDatabaseOooOOo = oo00o0oZzh.OooOOo();
        sQLiteDatabaseOooOOo.beginTransaction();
        try {
            oo00o0oZzh.OooO00o();
            oo00o0oZzh.zzg();
            Preconditions.checkNotEmpty(str);
            SQLiteDatabase sQLiteDatabaseOooOOo2 = oo00o0oZzh.OooOOo();
            ...
            while (true) {
                ...
                zzgdVar = oo00o0oZzh.f40788OooO00o;
                if (!zHasNext) {
                    break;
                }
                                    ...
                                    while (true) {
                                        ...
                                        try {
                                                ...
                                                while (true) {
                                                    if (it6.hasNext()) {
                                                        ...
                                                        if (zzetVar.zze().isEmpty()) {
                                                            ...
                                                            try {
                                                                if (oo00o0oZzh.OooOOo().insertWithOnConflict("property_filters", null, contentValues, 5) == -1) {
                                            ...
                                            if (!zzekVar.zzg().isEmpty()) {
                                                ...
                                                try {
                                                    if (oo00o0oZzh.OooOOo().insertWithOnConflict("event_filters", null, contentValues2, 5) == -1) {
                                                    ...
                                                    oo00o0oZzh.zzg();
                                                    Preconditions.checkNotEmpty(str);
                                                    SQLiteDatabase sQLiteDatabaseOooOOo3 = oo00o0oZzh.OooOOo();
                                                    str4 = str9;
                                            ...
                                            oo00o0oZzh.zzg();
                                            Preconditions.checkNotEmpty(str);
                                            SQLiteDatabase sQLiteDatabaseOooOOo4 = oo00o0oZzh.OooOOo();
                                            str4 = str9;
            ...
            oo00o0oZzh.OooO00o();
            oo00o0oZzh.zzg();
            SQLiteDatabase sQLiteDatabaseOooOOo5 = oo00o0oZzh.OooOOo();
            try {
                long jOooOOO0 = oo00o0oZzh.OooOOO0("select count(1) from audience_filter_values where app_id=?", new String[]{str});
            ...
            try {
                ...
                this.f40788OooO00o.zzaA().zzk().zzc("Unable to serialize reduced-size config. Storing full config instead. appId", zzet.OooO0Oo(str), e4);
                bArrZzbx = bArr;
            }
            oO00O0o oo00o0oZzh2 = zzlhVar4.zzh();
            Preconditions.checkNotEmpty(str);
            oo00o0oZzh2.zzg();
            zzgd zzgdVar2 = oo00o0oZzh2.f40788OooO00o;
            oo00o0oZzh2.OooO00o();
            ...
            try {
                if (oo00o0oZzh2.OooOOo().update("apps", contentValues3, "app_id = ?", new String[]{str}) == 0) {
            ...
            oooO2.put(str, (com.google.android.gms.internal.measurement.zzff) zzfeVar5.zzaD());
        } catch (Throwable th2) {
            th = th2;
            sQLiteDatabase = sQLiteDatabaseOooOOo;
        }
    ...
    public final String zza(String str, String str2) {
        zzg();
        OooO0o0(str);
        Map map = (Map) this.f15492OooO0Oo.getOrDefault(str, null);
        if (map != null) {
    ...
    public final boolean zzo(String str) {
        ...
        return (TextUtils.isEmpty(str) || (zzffVar = (com.google.android.gms.internal.measurement.zzff) this.f15496OooO0oo.getOrDefault(str, null)) == null || zzffVar.zza() == 0) ? false : true;
    }
}
