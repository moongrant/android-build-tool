...
import p271o00ooooo.Oo0000;
import p271o00ooooo.a;
import p271o00ooooo.d;
import p271o00ooooo.e0;
import p271o00ooooo.j;
import p271o00ooooo.k;
import p271o00ooooo.oOO;
import p271o00ooooo.oOO0;
import p271o00ooooo.oOO000o;
import p271o00ooooo.oOO00O0;
import p271o00ooooo.oOO00OO;
import p271o00ooooo.oOO0O0;
import p271o00ooooo.oOO0O000;
import p271o00ooooo.oOO0O00O;
import p271o00ooooo.oOO0O0O;
import p271o00ooooo.oOO0O0O0;
import p271o00ooooo.oOO0OO;
import p271o00ooooo.oOO0Oo00;
import p271o00ooooo.oOO0OoO0;
import p271o00ooooo.oOOO00;
import p271o00ooooo.oOOO000o;
import p271o00ooooo.oOOO00Oo;
import p271o00ooooo.oOOO0OO0;
import p271o00ooooo.oOo000Oo;
import p271o00ooooo.oOo00o0o;
import p271o00ooooo.ooooO000;
import p271o00ooooo.ooooO0O0;

/* JADX INFO: loaded from: classes3.dex */
public final class zzik extends oOo00o0o {

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    @GuardedBy("consentLock")
    public zzhb f15560OooO;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @VisibleForTesting
    public oOOO0OO0 f15561OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public zzhf f15562OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public boolean f15563OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final CopyOnWriteArraySet f15564OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final AtomicReference f15565OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final Object f15566OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public final AtomicLong f15567OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public long f15568OooOO0O;

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    public final zzs f15569OooOO0o;

    /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
    public final oOO0OO f15570OooOOO;

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    @VisibleForTesting
    public boolean f15571OooOOO0;

    public zzik(zzgd zzgdVar) {
        super(zzgdVar);
        this.f15564OooO0o0 = new CopyOnWriteArraySet();
        this.f15566OooO0oo = new Object();
        this.f15571OooOOO0 = true;
        this.f15570OooOOO = new oOO0OO(this);
        this.f15565OooO0oO = new AtomicReference();
        this.f15560OooO = zzhb.zza;
        this.f15568OooOO0O = -1L;
        this.f15567OooOO0 = new AtomicLong(0L);
        this.f15569OooOO0o = new zzs(zzgdVar);
    }
    ...
    public static /* bridge */ /* synthetic */ void OooOO0O(zzik zzikVar, zzhb zzhbVar, zzhb zzhbVar2) {
        ...
        if (z || zZzn) {
            zzikVar.f40788OooO00o.zzh().OooO0OO();
        }
    }
    ...
    public static void OooOO0o(zzik zzikVar, zzhb zzhbVar, long j, boolean z, boolean z2) {
        ...
        if (j <= zzikVar.f15568OooOO0O && zzhb.zzk(zzhbVarOooO0o0.zza(), zzhbVar.zza())) {
            zzgdVar.zzaA().zzi().zzb("Dropped out-of-date consent setting, proposed settings", zzhbVar);
            return;
        }
        oOo000Oo ooo000ooZzm = zzgdVar.zzm();
        zzgd zzgdVar2 = ooo000ooZzm.f40788OooO00o;
        ooo000ooZzm.zzg();
        int iZza = zzhbVar.zza();
        if (!ooo000ooZzm.OooOO0(iZza)) {
        ...
        editorEdit.apply();
        zzikVar.f15568OooOO0O = j;
        zzjz zzjzVarZzt = zzgdVar.zzt();
        zzjzVarZzt.zzg();
        zzjzVarZzt.zza();
        if (z) {
            zzgd zzgdVar3 = zzjzVarZzt.f40788OooO00o;
            zzgdVar3.zzay();
            zzgdVar3.zzi().zzj();
        }
        if (zzjzVarZzt.OooO0o0()) {
            zzjzVarZzt.OooOO0(new k(zzjzVarZzt, zzjzVarZzt.OooO0oO(false)));
        }
        if (z2) {
    ...
    public final void OooO0OO(Bundle bundle, String str, String str2) {
        zzg();
        OooO0Oo(str, str2, bundle, this.f40788OooO00o.zzax().currentTimeMillis());
    }

    @WorkerThread
    public final void OooO0Oo(String str, String str2, Bundle bundle, long j) {
        zzg();
        OooO0o0(str, str2, j, bundle, true, this.f15562OooO0Oo == null || zzlp.OooOoOO(str2), true, null);
    }
    ...
    public final void OooO0o(long j, boolean z) {
        ...
        zzkpVarZzu.zzg();
        e0 e0Var = zzkpVarZzu.f15597OooO0o;
        e0Var.f40492OooO0OO.OooO00o();
        e0Var.f40490OooO00o = 0L;
        e0Var.f40491OooO0O0 = 0L;
        zzqu.zzc();
        ...
        oOo000Oo ooo000ooZzm = zzgdVar.zzm();
        ooo000ooZzm.f40768OooO0o0.zzb(j);
        zzgd zzgdVar2 = ooo000ooZzm.f40788OooO00o;
        if (!TextUtils.isEmpty(zzgdVar2.zzm().f40782OooOo00.zza())) {
            ooo000ooZzm.f40782OooOo00.zzb(null);
        }
        zzph.zzc();
        zzag zzagVarZzf = zzgdVar2.zzf();
        zzef zzefVar = zzeg.zzaf;
        if (zzagVarZzf.zzs(null, zzefVar)) {
            ooo000ooZzm.f40774OooOOO.zzb(0L);
        }
        ooo000ooZzm.f40776OooOOOO.zzb(0L);
        if (!zzgdVar2.zzf().zzv()) {
            ooo000ooZzm.OooO0oo(!zZzJ);
        }
        ooo000ooZzm.f40781OooOo0.zzb(null);
        ooo000ooZzm.f40783OooOo0O.zzb(0L);
        ooo000ooZzm.f40784OooOo0o.zzb(null);
        if (z) {
            zzjz zzjzVarZzt = zzgdVar.zzt();
            zzjzVarZzt.zzg();
            zzjzVarZzt.zza();
            ...
            zzgdVar3.zzay();
            zzgdVar3.zzi().zzj();
            zzjzVarZzt.OooOO0(new a(zzjzVarZzt, zzqVarOooO0oO));
        }
        zzph.zzc();
        if (zzgdVar.zzf().zzs(null, zzefVar)) {
            zzgdVar.zzu().f15598OooO0o0.OooO00o();
        }
        this.f15571OooOOO0 = !zZzJ;
    }

    /* JADX WARN: Failed to calculate best type for var: r0v14 ??
    jadx.core.utils.exceptions.JadxRuntimeException: Type update failed for variable: r0v14 ??, new type: o00ooooo.e0
    ...
    jadx.core.utils.exceptions.JadxRuntimeException: Type update failed for variable: r1v36 ??, new type: o00ooooo.f0
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:109)
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:59)
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.calculateFromBounds(TypeInferenceVisitor.java:147)
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.setBestType(TypeInferenceVisitor.java:125)
    ...
    public final void OooO0oO(zzhb zzhbVar) {
        ...
        if (z != zzgdVar.zzK()) {
            ...
            zzgd zzgdVar2 = ooo000ooZzm.f40788OooO00o;
            ooo000ooZzm.zzg();
            Boolean boolValueOf = ooo000ooZzm.OooO0Oo().contains("measurement_enabled_from_api") ? Boolean.valueOf(ooo000ooZzm.OooO0Oo().getBoolean("measurement_enabled_from_api", true)) : null;
    ...
    public final void OooO0oo(long j, String str, String str2, Object obj) {
        ...
        if (zEquals) {
            if (obj instanceof String) {
                ...
                if (!TextUtils.isEmpty(str3)) {
                    ...
                    zzgdVar.zzm().f40773OooOO0o.zzb(lValueOf.longValue() == 1 ? ServerProtocol.DIALOG_RETURN_SCOPES_TRUE : "false");
                    obj = lValueOf;
                } else if (obj == null) {
                    zzgdVar.zzm().f40773OooOO0o.zzb("unset");
                }
                str2 = "_npa";
            } else if (obj == null) {
                zzgdVar.zzm().f40773OooOO0o.zzb("unset");
        ...
        if (zzgdVar.OooO00o()) {
            ...
            zzjzVarZzt.zzg();
            zzjzVarZzt.zza();
            zzgd zzgdVar2 = zzjzVarZzt.f40788OooO00o;
            zzgdVar2.zzay();
            zzjzVarZzt.OooOO0(new Oo0000(zzjzVarZzt, zzjzVarZzt.OooO0oO(true), zzgdVar2.zzi().zzp(zzlkVar), zzlkVar));
        }
    }
    ...
    public final void OooOO0() {
        zzg();
        zzgd zzgdVar = this.f40788OooO00o;
        String strZza = zzgdVar.zzm().f40773OooOO0o.zza();
        if (strZza != null) {
        ...
        if (!zzgdVar.zzJ() || !this.f15571OooOOO0) {
            zzgdVar.zzaA().zzc().zza("Updating Scion state (FE)");
            zzjz zzjzVarZzt = zzgdVar.zzt();
            zzjzVarZzt.zzg();
            zzjzVarZzt.zza();
            zzjzVarZzt.OooOO0(new j(zzjzVarZzt, zzjzVarZzt.OooO0oO(true)));
            return;
        }
        ...
        zzgdVar.zzaB().zzp(new oOO000o(this));
    }
    ...
    public final void zzA(String str, String str2, Bundle bundle) {
        ...
        zzgdVar.zzaB().zzp(new oOO0O00O(this, bundle2));
    }

    public final void zzB() {
        zzgd zzgdVar = this.f40788OooO00o;
        if (!(zzgdVar.zzaw().getApplicationContext() instanceof Application) || this.f15561OooO0OO == null) {
            return;
        }
        ((Application) zzgdVar.zzaw().getApplicationContext()).unregisterActivityLifecycleCallbacks(this.f15561OooO0OO);
    }

    public final void zzD(String str, String str2, Bundle bundle) {
        zzE(str, str2, bundle, true, true, this.f40788OooO00o.zzax().currentTimeMillis());
    }
    ...
    public final void zzE(String str, String str2, Bundle bundle, boolean z, boolean z2, long j) {
        ...
        boolean z3 = !z2 || this.f15562OooO0Oo == null || zzlp.OooOoOO(str2);
        ...
        zzgdVar.zzaB().zzp(new oOO00O0(this, str3, str2, j, bundle3, z2, z3, z));
    }
    ...
    public final void zzJ(zzhg zzhgVar) {
        ...
        if (this.f15564OooO0o0.add(zzhgVar)) {
            return;
        }
        this.f40788OooO00o.zzaA().zzk().zza("OnEventListener already registered");
    }

    public final void zzK(long j) {
        this.f15565OooO0oO.set(null);
        this.f40788OooO00o.zzaB().zzp(new oOO0(this, j));
    }

    public final void zzP(Bundle bundle) {
        zzQ(bundle, this.f40788OooO00o.zzax().currentTimeMillis());
    }
    ...
    public final void zzQ(Bundle bundle, long j) {
        ...
        if (j3 > 15552000000L || j3 < 1) {
            ...
            zzgdVar.zzaB().zzp(new oOO0O000(this, bundle2));
        }
    }
    ...
    public final void zzR(zzhb zzhbVar, long j) {
        ...
        if (iZza != -10 && zzhbVar.zzf() == null && zzhbVar.zzg() == null) {
            this.f40788OooO00o.zzaA().zzl().zza("Discarding empty consent settings");
            return;
        }
        synchronized (this.f15566OooO0oo) {
            zzhbVar2 = this.f15560OooO;
            z = false;
            if (zzhb.zzk(iZza, zzhbVar2.zza())) {
                zZzm = zzhbVar.zzm(this.f15560OooO);
                zzha zzhaVar = zzha.ANALYTICS_STORAGE;
                if (zzhbVar.zzj(zzhaVar) && !this.f15560OooO.zzj(zzhaVar)) {
                    z = true;
                }
                zzhb zzhbVarZze = zzhbVar.zze(this.f15560OooO);
                this.f15560OooO = zzhbVarZze;
                zzhbVar3 = zzhbVarZze;
                z2 = z;
                z = true;
            } else {
        ...
        if (!z) {
            this.f40788OooO00o.zzaA().zzi().zzb("Ignoring lower-priority consent settings, proposed settings", zzhbVar3);
            return;
        }
        long andIncrement = this.f15567OooOO0.getAndIncrement();
        if (zZzm) {
            this.f15565OooO0oO.set(null);
            this.f40788OooO00o.zzaB().zzq(new oOOO00(this, zzhbVar3, j, andIncrement, z2, zzhbVar2));
            return;
        }
        oOOO00Oo oooo00oo = new oOOO00Oo(this, zzhbVar3, andIncrement, z2, zzhbVar2);
        if (iZza == 30 || iZza == -10) {
            this.f40788OooO00o.zzaB().zzq(oooo00oo);
        } else {
            this.f40788OooO00o.zzaB().zzp(oooo00oo);
        }
    }
    ...
    public final void zzT(zzhf zzhfVar) {
        ...
        zzg();
        zza();
        if (zzhfVar != null && zzhfVar != (zzhfVar2 = this.f15562OooO0Oo)) {
            Preconditions.checkState(zzhfVar2 == null, "EventInterceptor already set.");
        }
        this.f15562OooO0Oo = zzhfVar;
    }

    public final void zzU(Boolean bool) {
        zza();
        this.f40788OooO00o.zzaB().zzp(new oOOO000o(this, bool));
    }

    public final void zzW(String str, String str2, Object obj, boolean z) {
        zzX(DebugKt.DEBUG_PROPERTY_VALUE_AUTO, "_ldl", obj, true, this.f40788OooO00o.zzax().currentTimeMillis());
    }
    ...
    public final void zzX(String str, String str2, Object obj, boolean z, long j) {
        ...
        oOO0OO ooo0oo = this.f15570OooOOO;
        if (iOooo0oO != 0) {
            ...
            zzlp.OooOOO(ooo0oo, null, iOooo0oO, "_ev", strZzD, length);
            return;
        }
        String str3 = str == null ? "app" : str;
        if (obj == null) {
            zzgdVar.zzaB().zzp(new oOO00OO(this, str3, str2, null, j));
            return;
        }
        ...
        if (iOooo0OO == 0) {
            ...
            if (objOooO0o0 != null) {
                zzgdVar.zzaB().zzp(new oOO00OO(this, str3, str2, objOooO0o0, j));
                return;
            }
            return;
        }
        ...
        zzgdVar.zzv().getClass();
        zzlp.OooOOO(ooo0oo, null, iOooo0OO, "_ev", strZzD2, length);
    }

    public final void zzZ(zzhg zzhgVar) {
        zza();
        Preconditions.checkNotNull(zzhgVar);
        if (this.f15564OooO0o0.remove(zzhgVar)) {
            return;
        }
        this.f40788OooO00o.zzaA().zzk().zza("OnEventListener had not been registered");
    }
    ...
    public final Boolean zzi() {
        ...
        return (Boolean) this.f40788OooO00o.zzaB().OooO0Oo(atomicReference, 15000L, "boolean test flag value", new oOO0O0O0(this, atomicReference));
    }

    public final Double zzj() {
        AtomicReference atomicReference = new AtomicReference();
        return (Double) this.f40788OooO00o.zzaB().OooO0Oo(atomicReference, 15000L, "double test flag value", new oOO(this, atomicReference));
    }

    public final Integer zzl() {
        AtomicReference atomicReference = new AtomicReference();
        return (Integer) this.f40788OooO00o.zzaB().OooO0Oo(atomicReference, 15000L, "int test flag value", new ooooO0O0(this, atomicReference));
    }

    public final Long zzm() {
        AtomicReference atomicReference = new AtomicReference();
        return (Long) this.f40788OooO00o.zzaB().OooO0Oo(atomicReference, 15000L, "long test flag value", new oOO0OoO0(this, atomicReference));
    }

    public final String zzo() {
        return (String) this.f15565OooO0oO.get();
    }

    public final String zzp() {
        zzir zzirVarZzi = this.f40788OooO00o.zzs().zzi();
        if (zzirVarZzi != null) {
    ...
    public final String zzr() {
        AtomicReference atomicReference = new AtomicReference();
        return (String) this.f40788OooO00o.zzaB().OooO0Oo(atomicReference, 15000L, "String test flag value", new oOO0Oo00(this, atomicReference));
    }
    ...
    public final ArrayList zzs(String str, String str2) {
        ...
        AtomicReference atomicReference = new AtomicReference();
        zzgdVar.zzaB().OooO0Oo(atomicReference, 5000L, "get conditional user properties", new oOO0O0(this, atomicReference, str, str2));
    ...
    public final List zzt(boolean z) {
        ...
        AtomicReference atomicReference = new AtomicReference();
        zzgdVar.zzaB().OooO0Oo(atomicReference, 5000L, "get user properties", new ooooO000(this, atomicReference, z));
        List list = (List) atomicReference.get();
        if (list != null) {
            return list;
        }
    ...
    public final Map zzu(String str, String str2, boolean z) {
        ...
        AtomicReference atomicReference = new AtomicReference();
        zzgdVar.zzaB().OooO0Oo(atomicReference, 5000L, "get user properties", new oOO0O0O(this, atomicReference, str, str2, z));
        List<zzlk> list = (List) atomicReference.get();
        if (list == null) {
            zzgdVar.zzaA().zzd().zzb("Timed out waiting for handle get user properties, includeInternal", Boolean.valueOf(z));
            return Collections.emptyMap();
        }
        OooO oooO = new OooO(list.size());
        for (zzlk zzlkVar : list) {
            Object objZza = zzlkVar.zza();
            if (objZza != null) {
                oooO.put(zzlkVar.zzb, objZza);
            }
        }
        return oooO;
    }
    ...
    public final void zzz() {
        ...
        if (zzgdVar.OooO00o()) {
                ...
                if (boolOooO0OO != null && boolOooO0OO.booleanValue()) {
                    ...
                    zzgdVar.zzaB().zzp(new Runnable() { // from class: com.google.android.gms.measurement.internal.zzhm
                        ...
                        public final void run() {
                            ...
                            zzikVar.zzg();
                            zzgd zzgdVar2 = zzikVar.f40788OooO00o;
                            if (zzgdVar2.zzm().f40778OooOOo.zzb()) {
                                zzgdVar2.zzaA().zzc().zza("Deferred Deep Link already retrieved. Not fetching again.");
                                return;
                            }
                            long jZza = zzgdVar2.zzm().f40780OooOOoo.zza();
                            zzgdVar2.zzm().f40780OooOOoo.zzb(1 + jZza);
                            zzgdVar2.zzf();
                            if (jZza < 5) {
                                zzgdVar2.zzE();
                            } else {
                                zzgdVar2.zzaA().zzk().zza("Permanently failed to retrieve Deferred Deep Link. Reached maximum retries.");
                                zzgdVar2.zzm().f40778OooOOo.zza(true);
                            }
                        }
                    });
                }
            ...
            zzjzVarZzt.f40788OooO00o.zzi().zzk();
            zzjzVarZzt.OooOO0(new d(zzjzVarZzt, zzqVarOooO0oO));
            this.f15571OooOOO0 = false;
            oOo000Oo ooo000ooZzm = zzgdVar.zzm();
            ooo000ooZzm.zzg();
            String string = ooo000ooZzm.OooO0Oo().getString("previous_os_version", null);
            ooo000ooZzm.f40788OooO00o.zzg().OooO0OO();
