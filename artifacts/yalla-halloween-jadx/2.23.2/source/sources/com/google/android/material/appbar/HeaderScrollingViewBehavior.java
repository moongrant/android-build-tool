...
abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
    ...
    public final Rect f15775OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final Rect f15776OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public int f15777OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public int f15778OooO0o0;

    public HeaderScrollingViewBehavior() {
        this.f15775OooO0OO = new Rect();
        this.f15776OooO0Oo = new Rect();
        this.f15778OooO0o0 = 0;
    }
    ...
    public final void OooOo0O(@NonNull CoordinatorLayout coordinatorLayout, @NonNull View view, int i) {
        ...
        Rect rect2 = this.f15776OooO0Oo;
        int i2 = oooO0o.f5219OooO0OO;
        if (i2 == 0) {
            i2 = 8388659;
        }
        ...
        this.f15778OooO0o0 = rect2.top - appBarLayoutOooOo0o.getBottom();
    }
