...
public final class OooOO0O extends OooOOO implements Cloneable {

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    public float f15945OooO = -1.0f;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public float f15946OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public float f15947OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public float f15948OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public float f15949OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public float f15950OooO0oo;

    public OooOO0O(float f, float f2, float f3) {
        this.f15948OooO0o0 = f;
        this.f15946OooO0Oo = f2;
        if (f3 < 0.0f) {
            throw new IllegalArgumentException("cradleVerticalOffset must be positive.");
        }
        this.f15949OooO0oO = f3;
        this.f15950OooO0oo = 0.0f;
    }
    ...
    public final void OooO0Oo(float f, float f2, float f3, @NonNull com.google.android.material.shape.OooO0o oooO0o) {
        float f4;
        float f5;
        float f6 = this.f15947OooO0o;
        if (f6 == 0.0f) {
            oooO0o.OooO0Oo(f, 0.0f);
            return;
        }
        float f7 = ((this.f15948OooO0o0 * 2.0f) + f6) / 2.0f;
        float f8 = f3 * this.f15946OooO0Oo;
        float f9 = f2 + this.f15950OooO0oo;
        float fOooO00o = OooOo.OooO0o.OooO00o(1.0f, f3, f7, this.f15949OooO0oO * f3);
        if (fOooO00o / f7 >= 1.0f) {
            oooO0o.OooO0Oo(f, 0.0f);
            return;
        }
        float f10 = this.f15945OooO;
        float f11 = f10 * f3;
