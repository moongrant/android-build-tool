...
public class OooO0OO extends o0O0O00 {
    ...
    public static final /* synthetic */ int f16058OooO0o0 = 0;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public boolean f16059OooO0Oo;
    ...
    public final boolean OooO0OO(boolean z) {
        ...
        if (!bottomSheetBehaviorOooO0oo.f15990Oooo0 || !oooO0O0.f16046OooOO0) {
            return false;
        }
        this.f16059OooO0Oo = z;
        if (bottomSheetBehaviorOooO0oo.f15997Oooo0o0 == 5) {
            OooO0O0();
            return true;
        }
        if (getDialog() instanceof OooO0O0) {
            OooO0O0 oooO0O1 = (OooO0O0) getDialog();
            oooO0O1.f16043OooO0o.f16006OoooOOo.remove(oooO0O1.f16052OooOOOo);
        }
    ...
    @Override // androidx.appcompat.app.o0O0O00, androidx.fragment.app.Oooo0
    @NonNull
