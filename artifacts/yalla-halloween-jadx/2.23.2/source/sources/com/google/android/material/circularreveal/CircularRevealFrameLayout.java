...
public class CircularRevealFrameLayout extends FrameLayout implements OooO0O0 {
    ...
    @NonNull
    public final CircularRevealHelper f16313OooO0Oo;
    ...
    public final void draw(@NonNull Canvas canvas) {
        CircularRevealHelper circularRevealHelper = this.f16313OooO0Oo;
    ...
    public Drawable getCircularRevealOverlayDrawable() {
        return this.f16313OooO0Oo.f16319OooO0o0;
    }

    @Override // com.google.android.material.circularreveal.OooO0O0
    public int getCircularRevealScrimColor() {
        return this.f16313OooO0Oo.OooO0O0();
    }

    @Override // com.google.android.material.circularreveal.OooO0O0
    @Nullable
    public OooO0O0.OooO0o getRevealInfo() {
        return this.f16313OooO0Oo.OooO0OO();
    }
    ...
    public void setCircularRevealOverlayDrawable(@Nullable Drawable drawable) {
        this.f16313OooO0Oo.OooO0o0(drawable);
    }

    @Override // com.google.android.material.circularreveal.OooO0O0
    public void setCircularRevealScrimColor(@ColorInt int i) {
        this.f16313OooO0Oo.OooO0o(i);
    }

    @Override // com.google.android.material.circularreveal.OooO0O0
    public void setRevealInfo(@Nullable OooO0O0.OooO0o oooO0o) {
        this.f16313OooO0Oo.OooO0oO(oooO0o);
    }

    public CircularRevealFrameLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        super(context, attributeSet);
        this.f16313OooO0Oo = new CircularRevealHelper(this);
    }
}
