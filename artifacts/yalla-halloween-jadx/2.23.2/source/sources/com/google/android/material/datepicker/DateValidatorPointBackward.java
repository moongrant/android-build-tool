...
public class DateValidatorPointBackward implements CalendarConstraints.DateValidator {
    ...
    public final long f16349OooO0Oo;
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof DateValidatorPointBackward) && this.f16349OooO0Oo == ((DateValidatorPointBackward) obj).f16349OooO0Oo;
    }

    public final int hashCode() {
        return Arrays.hashCode(new Object[]{Long.valueOf(this.f16349OooO0Oo)});
    }

    @Override // android.os.Parcelable
    public final void writeToParcel(@NonNull Parcel parcel, int i) {
        parcel.writeLong(this.f16349OooO0Oo);
    }
}
