...
final class MaterialCalendarGridView extends GridView {
    ...
    public final Calendar f16351OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final boolean f16352OooO0o0;
    ...
    public final void onDraw(@NonNull Canvas canvas) {
        ...
        DateSelector<?> dateSelector = adapter.f16492OooO0o0;
        OooO0O0 oooO0O0 = adapter.f16493OooO0oO;
        int iMax = Math.max(adapter.OooO0O0(), getFirstVisiblePosition());
        int iOooO0O2 = adapter.OooO0O0();
        Month month = adapter.f16490OooO0Oo;
        int iMin = Math.min((iOooO0O2 + month.f16389OooO0oo) - 1, getLastVisiblePosition());
            ...
            if (f != 0) {
                ...
                if (s != 0) {
                    ...
                    if (!(item == null || item2 == null || lValueOf == null || lValueOf2 == null || lValueOf.longValue() > item2.longValue() || lValueOf2.longValue() < item.longValue())) {
                        ...
                        Calendar calendar = materialCalendarGridView.f16351OooO0Oo;
                        if (jLongValue < jLongValue3) {
                            if (iMax % month.f16388OooO0oO == 0) {
                                right = 0;
                            } else {
                        ...
                        if (jLongValue2 > item2.longValue()) {
                            if ((iMin + 1) % month.f16388OooO0oO == 0) {
                                width2 = getWidth();
                            } else {
                        ...
                        while (itemId <= itemId2) {
                            ...
                            int top = viewOooO0O2.getTop() + oooO0O0.f16403OooO00o.f16397OooO00o.top;
                            Iterator it3 = it2;
                            int bottom = viewOooO0O2.getBottom() - oooO0O0.f16403OooO00o.f16397OooO00o.bottom;
                            if (zOooO0o) {
                            ...
                            canvas.drawRect(i, top, width3, bottom, oooO0O0.f16410OooO0oo);
                            itemId++;
    ...
    public final void onFocusChanged(boolean z, int i, Rect rect) {
        ...
        if (i == 33) {
            o0ooOOo adapter = getAdapter();
            setSelection((adapter.OooO0O0() + adapter.f16490OooO0Oo.f16389OooO0oo) - 1);
        } else if (i == 130) {
    ...
    public MaterialCalendarGridView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f16351OooO0Oo = o0000.OooO(null);
        if (MaterialDatePicker.OooO0Oo(getContext())) {
            setNextFocusLeftId(p272o0O0000o.o0000Ooo.cancel_button);
            setNextFocusRightId(p272o0O0000o.o0000Ooo.confirm_button);
        }
        this.f16352OooO0o0 = MaterialDatePicker.OooO0o0(p272o0O0000o.o00000.nestedScrollable, getContext());
