...
public final class o00oO0o {
    ...
    public static final int[] f16848OooO00o = {o00000.colorPrimary};

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final int[] f16849OooO0O0 = {o00000.colorPrimaryVariant};
    ...
    public static void OooO00o(@NonNull Context context, AttributeSet attributeSet, @AttrRes int i, @StyleRes int i2) {
        ...
        if (z) {
            ...
            if (!context.getTheme().resolveAttribute(o00000.isMaterialTheme, typedValue, true) || (typedValue.type == 18 && typedValue.data == 0)) {
                OooO0OO(context, f16849OooO0O0, "Theme.MaterialComponents");
            }
        }
        OooO0OO(context, f16848OooO00o, "Theme.AppCompat");
    }
    ...
    public static void OooO0OO(@NonNull Context context, @NonNull int[] iArr, String str) {
        ...
        for (int i = 0; i < iArr.length; i++) {
            if (!typedArrayObtainStyledAttributes.hasValue(i)) {
                typedArrayObtainStyledAttributes.recycle();
                if (z) {
                    throw new IllegalArgumentException(p004OooO0oO.o000oOoO.OooO0O0("The style on this component requires your app theme to be ", str, " (or a descendant)."));
                }
            }
        }
        typedArrayObtainStyledAttributes.recycle();
