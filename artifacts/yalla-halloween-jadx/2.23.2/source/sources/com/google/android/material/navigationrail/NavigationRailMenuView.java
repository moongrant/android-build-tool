...
public class NavigationRailMenuView extends NavigationBarMenuView {
    ...
    @Px
    public int f16983Oooo0;

    /* JADX INFO: renamed from: Oooo0O0, reason: collision with root package name */
    public final FrameLayout.LayoutParams f16984Oooo0O0;

    public NavigationRailMenuView(@NonNull Context context) {
        super(context);
        this.f16983Oooo0 = -1;
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(-1, -2);
        this.f16984Oooo0O0 = layoutParams;
    ...
    public int getItemMinimumHeight() {
        return this.f16983Oooo0;
    }

    public int getMenuGravity() {
        return this.f16984Oooo0O0.gravity;
    }
    ...
    public void setMenuGravity(int i) {
        FrameLayout.LayoutParams layoutParams = this.f16984Oooo0O0;
