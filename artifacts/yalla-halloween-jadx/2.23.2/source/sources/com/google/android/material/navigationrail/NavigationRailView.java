...
import p275o0O00Oo.OooO0OO;

/* JADX INFO: loaded from: classes3.dex */
public class NavigationRailView extends NavigationBarView {

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    public final int f16985OooO;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    @Nullable
    public View f16986OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    @Nullable
    public final Boolean f16987OooOO0O;

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    @Nullable
    public final Boolean f16988OooOO0o;
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        View view = this.f16986OooOO0;
        int i5 = 0;
        boolean z2 = (view == null || view.getVisibility() == 8) ? false : true;
        int i6 = this.f16985OooO;
        if (z2) {
            int bottom = this.f16986OooOO0.getBottom() + i6;
            int top = navigationRailMenuView.getTop();
            if (top < bottom) {
                i5 = bottom - top;
            }
        } else {
            if ((navigationRailMenuView.f16984Oooo0O0.gravity & 112) == 48) {
                i5 = i6;
            }
        }
        if (i5 > 0) {
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if ((view == null || view.getVisibility() == 8) ? false : true) {
            measureChild(getNavigationRailMenuView(), i, View.MeasureSpec.makeMeasureSpec((getMeasuredHeight() - this.f16986OooOO0.getMeasuredHeight()) - this.f16985OooO, Integer.MIN_VALUE));
        }
    }
    ...
    public NavigationRailView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
        ...
        if (iOooO != 0) {
            ...
            if (view != null) {
                removeView(view);
                this.f16986OooOO0 = null;
            }
            this.f16986OooOO0 = viewInflate;
        ...
        if (o000oo0OooO0o0.OooOO0o(i4)) {
            this.f16987OooOO0O = Boolean.valueOf(o000oo0OooO0o0.OooO00o(i4, false));
        }
        int i5 = o000OO.NavigationRailView_paddingBottomSystemWindowInsets;
        if (o000oo0OooO0o0.OooOO0o(i5)) {
            this.f16988OooOO0o = Boolean.valueOf(o000oo0OooO0o0.OooO00o(i5, false));
        }
        o000oo0OooO0o0.OooOOO();
        oo0o0Oo.OooO00o(this, new OooO0OO(this));
    }
}
