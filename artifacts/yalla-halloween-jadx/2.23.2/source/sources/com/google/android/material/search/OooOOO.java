...
public final /* synthetic */ class OooOOO implements View.OnClickListener {
    ...
    public final /* synthetic */ int f17026OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ Object f17027OooO0o0;

    public /* synthetic */ OooOOO(Object obj, int i) {
        this.f17026OooO0Oo = i;
        this.f17027OooO0o0 = obj;
    }

    @Override // android.view.View.OnClickListener
    public final void onClick(View view) {
        int i = this.f17026OooO0Oo;
        Object obj = this.f17027OooO0o0;
        switch (i) {
            case 0:
                SearchView searchView = (SearchView) obj;
                if (!searchView.f17078OooOoo0.equals(SearchView.TransitionState.SHOWN)) {
                    SearchView.TransitionState transitionState = searchView.f17078OooOoo0;
                    ...
                    if (!transitionState.equals(transitionState2)) {
                        ...
                        if (searchBar != null) {
                            ...
                            Toolbar toolbar = oo000oVar.f17095OooO0oO;
                            Menu menu = toolbar.getMenu();
                            if (menu != null) {
                                menu.clear();
                            }
                            if (oo000oVar.f17100OooOOO0.getMenuResId() == -1 || !searchView2.f17069OooOo) {
                                toolbar.setVisibility(8);
                            } else {
                                toolbar.OooOO0O(oo000oVar.f17100OooOOO0.getMenuResId());
                            ...
                            CharSequence text = oo000oVar.f17100OooOOO0.getText();
                            EditText editText = oo000oVar.f17088OooO;
                            editText.setText(text);
                            editText.setSelection(editText.getText().length());
                            clippableRoundedCornerLayout.setVisibility(4);
                            clippableRoundedCornerLayout.post(new o0O00O0o(oo000oVar, 2));
                        } else {
                            if (searchView2.OooO0OO()) {
                                searchView2.postDelayed(new androidx.media3.ui.OooOO0O(searchView2, i2), 150L);
                            }
                            clippableRoundedCornerLayout.setVisibility(4);
                            clippableRoundedCornerLayout.post(new androidx.compose.material.ripple.OooO00o(oo000oVar, 1));
                        }
