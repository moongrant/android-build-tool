...
public final class OooO0OO implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final /* synthetic */ BaseTransientBottomBar f17351OooO0Oo;

    public OooO0OO(BaseTransientBottomBar baseTransientBottomBar, int i) {
        this.f17351OooO0Oo = baseTransientBottomBar;
    }
    ...
    public final void onAnimationUpdate(@NonNull ValueAnimator valueAnimator) {
        ...
        this.f17351OooO0Oo.f17312OooO.setTranslationY(iIntValue);
    }
}
