...
public class OooOOO extends MaterialShapeDrawable {
    ...
    public static final /* synthetic */ int f17494OooOoo0 = 0;

    /* JADX INFO: renamed from: OooOoOO, reason: collision with root package name */
    @NonNull
    public OooO00o f17495OooOoOO;

    @TargetApi(18)
    public static class OooO0O0 extends OooOOO {
        @Override // com.google.android.material.shape.MaterialShapeDrawable
        public final void OooO0oO(@NonNull Canvas canvas) {
            if (this.f17495OooOoOO.f17496OooOo0O.isEmpty()) {
                super.OooO0oO(canvas);
                return;
            }
            canvas.save();
            if (Build.VERSION.SDK_INT >= 26) {
                canvas.clipOutRect(this.f17495OooOoOO.f17496OooOo0O);
            } else {
                canvas.clipRect(this.f17495OooOoOO.f17496OooOo0O, Region.Op.DIFFERENCE);
            }
            super.OooO0oO(canvas);
            canvas.restore();
        }
    ...
    public OooOOO(OooO00o oooO00o) {
        super(oooO00o);
        this.f17495OooOoOO = oooO00o;
    }

    public final void OooOo(float f, float f2, float f3, float f4) {
        RectF rectF = this.f17495OooOoOO.f17496OooOo0O;
    ...
    public final Drawable mutate() {
        this.f17495OooOoOO = new OooO00o(this.f17495OooOoOO);
        return this;
    }
    ...
    public static final class OooO00o extends MaterialShapeDrawable.OooO0O0 {
        ...
        public OooO00o(OooO00o oooO00o) {
            super(oooO00o);
            this.f17496OooOo0O = oooO00o.f17496OooOo0O;
        }
    }
}
