...
class RadialViewGroup extends ConstraintLayout {
    ...
    public final OooO0O0 f17721OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public MaterialShapeDrawable f17722OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public int f17723OooO0o0;
    ...
    public void OooO0O0() {
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            int iRound = ((Integer) entry.getKey()).intValue() == 2 ? Math.round(this.f17723OooO0o0 * 0.66f) : this.f17723OooO0o0;
            Iterator it = list.iterator();
            float size = 0.0f;
            while (it.hasNext()) {
                int id = ((View) it.next()).getId();
                int i3 = o0000Ooo.circle_center;
                androidx.constraintlayout.widget.OooO0O0.C0119OooO0O0 c0119OooO0O0 = oooO0O0.OooO0oo(id).f5066OooO0o0;
                c0119OooO0O0.f5108OooOoOO = i3;
                c0119OooO0O0.f5110OooOoo0 = iRound;
                c0119OooO0O0.f5109OooOoo = size;
    ...
    public final void addView(View view, int i, ViewGroup.LayoutParams layoutParams) {
        ...
        if (handler != null) {
            OooO0O0 oooO0O0 = this.f17721OooO0Oo;
    ...
    public final void setBackgroundColor(@ColorInt int i) {
        this.f17722OooO0o.OooOOO(ColorStateList.valueOf(i));
    }
    ...
    public RadialViewGroup(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.f17722OooO0o = materialShapeDrawable;
        Oooo000 oooo000 = new Oooo000(0.5f);
        ...
        oooO00o.f17168OooO0o0 = oooo000;
        oooO00o.f17167OooO0o = oooo000;
        oooO00o.f17169OooO0oO = oooo000;
        oooO00o.f17170OooO0oo = oooo000;
        materialShapeDrawable.setShapeAppearanceModel(new com.google.android.material.shape.OooO0O0(oooO00o));
        this.f17722OooO0o.OooOOO(ColorStateList.valueOf(-1));
        MaterialShapeDrawable materialShapeDrawable2 = this.f17722OooO0o;
        WeakHashMap<View, o000OOo0> weakHashMap = ViewCompat.f5341OooO00o;
        ...
        this.f17723OooO0o0 = typedArrayObtainStyledAttributes.getDimensionPixelSize(o000OO.RadialViewGroup_materialCircleRadius, 0);
        this.f17721OooO0Oo = new Runnable() { // from class: com.google.android.material.timepicker.OooO0O0
            @Override // java.lang.Runnable
            public final void run() {
                this.f17718OooO0Oo.OooO0O0();
            }
        };
