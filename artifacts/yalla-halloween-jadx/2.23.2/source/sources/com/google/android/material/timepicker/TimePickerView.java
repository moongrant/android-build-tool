...
class TimePickerView extends ConstraintLayout {
    ...
    public static final /* synthetic */ int f17728OooO0o0 = 0;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final Chip f17729OooO0Oo;
    ...
    public class OooO00o implements View.OnClickListener {
        ...
        public final void onClick(View view) {
            int i = TimePickerView.f17728OooO0o0;
    ...
    public final void onVisibilityChanged(@NonNull View view, int i) {
        ...
        if (view == this && i == 0) {
            this.f17729OooO0Oo.sendAccessibilityEvent(8);
        }
    }
    ...
    public TimePickerView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        materialButtonToggleGroup.f16082OooO0o.add(new MaterialButtonToggleGroup.OooO0o() { // from class: com.google.android.material.timepicker.OooO0OO
            @Override // com.google.android.material.button.MaterialButtonToggleGroup.OooO0o
            public final void OooO00o() {
                int i2 = TimePickerView.f17728OooO0o0;
                this.f17719OooO00o.getClass();
            }
        });
        Chip chip = (Chip) findViewById(o0000Ooo.material_minute_tv);
        Chip chip2 = (Chip) findViewById(o0000Ooo.material_hour_tv);
        this.f17729OooO0Oo = chip2;
