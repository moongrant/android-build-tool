...
public abstract class ExpandableBehavior extends CoordinatorLayout.Behavior<View> {
    ...
    public int f17731OooO00o;

    public class OooO00o implements ViewTreeObserver.OnPreDrawListener {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ View f17732OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ o0O00O0o.OooO00o f17733OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f17734OooO0o0;

        public OooO00o(View view, int i, o0O00O0o.OooO00o oooO00o) {
            this.f17732OooO0Oo = view;
            this.f17734OooO0o0 = i;
            this.f17733OooO0o = oooO00o;
        }

        /* JADX WARN: Multi-variable type inference failed */
        @Override // android.view.ViewTreeObserver.OnPreDrawListener
        public final boolean onPreDraw() {
            View view = this.f17732OooO0Oo;
            view.getViewTreeObserver().removeOnPreDrawListener(this);
            ExpandableBehavior expandableBehavior = ExpandableBehavior.this;
            if (expandableBehavior.f17731OooO00o == this.f17734OooO0o0) {
                o0O00O0o.OooO00o oooO00o = this.f17733OooO0o;
    ...
    public final boolean OooO0Oo(CoordinatorLayout coordinatorLayout, View view, View view2) {
        ...
        if (!(!oooO00o.OooO00o() ? this.f17731OooO00o != 1 : !((i = this.f17731OooO00o) == 0 || i == 2))) {
            return false;
        }
        this.f17731OooO00o = oooO00o.OooO00o() ? 1 : 2;
    ...
    public final boolean OooO0oo(@NonNull CoordinatorLayout coordinatorLayout, @NonNull View view, int i) {
        ...
        if (!ViewCompat.OooOO0O.OooO0OO(view)) {
            ...
            if (oooO00o != null) {
                if (!oooO00o.OooO00o() ? this.f17731OooO00o != 1 : !((i2 = this.f17731OooO00o) == 0 || i2 == 2)) {
                    int i4 = oooO00o.OooO00o() ? 1 : 2;
                    this.f17731OooO00o = i4;
