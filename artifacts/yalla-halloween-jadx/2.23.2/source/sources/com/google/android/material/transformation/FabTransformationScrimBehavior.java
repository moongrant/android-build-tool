...
public class FabTransformationScrimBehavior extends ExpandableTransformationBehavior {
    ...
    public final OooOOOO f17748OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final OooOOOO f17749OooO0Oo;

    public class OooO00o extends AnimatorListenerAdapter {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ boolean f17750OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ View f17751OooO0o0;

        public OooO00o(boolean z, View view) {
            this.f17750OooO0Oo = z;
            this.f17751OooO0o0 = view;
        }

        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        public final void onAnimationEnd(Animator animator) {
            if (this.f17750OooO0Oo) {
                return;
            }
            this.f17751OooO0o0.setVisibility(4);
        }

        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        public final void onAnimationStart(Animator animator) {
            if (this.f17750OooO0Oo) {
                this.f17751OooO0o0.setVisibility(0);
            }
        }
    }

    public FabTransformationScrimBehavior() {
        this.f17748OooO0OO = new OooOOOO(75L);
        this.f17749OooO0Oo = new OooOOOO(0L);
    }
    ...
    public final AnimatorSet OooOo0(@NonNull View view, @NonNull View view2, boolean z, boolean z2) {
        ...
        new ArrayList();
        OooOOOO oooOOOO = z ? this.f17748OooO0OO : this.f17749OooO0Oo;
        if (z) {
            if (!z2) {
                view2.setAlpha(0.0f);
            }
