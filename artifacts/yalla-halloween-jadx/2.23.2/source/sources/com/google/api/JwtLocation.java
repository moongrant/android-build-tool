...
public final class JwtLocation extends GeneratedMessageV3 implements MessageOrBuilder {
    ...
    public int f18051OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public volatile Object f18052OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public Object f18053OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public byte f18054OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public static final JwtLocation f18050OooO0oo = new JwtLocation();

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    public static final OooO00o f18049OooO = new OooO00o();
    ...
    public static /* synthetic */ class OooO0O0 {
        ...
        public static final /* synthetic */ int[] f18055OooO00o;
        ...
        static {
            ...
            try {
                f18055OooO00o[InCase.QUERY.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f18055OooO00o[InCase.IN_NOT_SET.ordinal()] = 3;
    ...
    public static final class OooO0OO extends GeneratedMessageV3.Builder<OooO0OO> implements MessageOrBuilder {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f18056OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public Object f18057OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public Object f18058OooO0o0;

        public OooO0OO() {
            this.f18056OooO0Oo = 0;
            this.f18057OooO0o = "";
            JwtLocation jwtLocation = JwtLocation.f18050OooO0oo;
        }
        ...
        public final JwtLocation buildPartial() {
            ...
            int i = this.f18056OooO0Oo;
            if (i == 1) {
                jwtLocation.f18053OooO0o0 = this.f18058OooO0o0;
            }
            if (i == 2) {
                jwtLocation.f18053OooO0o0 = this.f18058OooO0o0;
            }
            jwtLocation.f18052OooO0o = this.f18057OooO0o;
            jwtLocation.f18051OooO0Oo = this.f18056OooO0Oo;
            onBuilt();
            return jwtLocation;
        }
        ...
        public final void OooO0Oo() {
            ...
            this.f18057OooO0o = "";
            this.f18056OooO0Oo = 0;
            this.f18058OooO0o0 = null;
        }

        public final void OooO0o(JwtLocation jwtLocation) {
            if (jwtLocation == JwtLocation.f18050OooO0oo) {
                return;
            }
            if (!jwtLocation.OooO0o0().isEmpty()) {
                this.f18057OooO0o = jwtLocation.f18052OooO0o;
                onChanged();
            }
            int i = OooO0O0.f18055OooO00o[jwtLocation.OooO0OO().ordinal()];
            if (i == 1) {
                this.f18056OooO0Oo = 1;
                this.f18058OooO0o0 = jwtLocation.f18053OooO0o0;
                onChanged();
            } else if (i == 2) {
                this.f18056OooO0Oo = 2;
                this.f18058OooO0o0 = jwtLocation.f18053OooO0o0;
                onChanged();
            }
            onChanged();
        ...
        public final void OooO0oO(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws Throwable {
            ...
            try {
                try {
                    JwtLocation.f18049OooO.getClass();
        ...
        public final Message getDefaultInstanceForType() {
            return JwtLocation.f18050OooO0oo;
        }

        @Override // com.google.protobuf.GeneratedMessageV3.Builder, com.google.protobuf.Message.Builder, com.google.protobuf.MessageOrBuilder
        public final Descriptors.Descriptor getDescriptorForType() {
            return o0O0O0Oo.OooO0OO.f41165OooO0o0;
        }

        @Override // com.google.protobuf.GeneratedMessageV3.Builder
        public final GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return o0O0O0Oo.OooO0OO.f41164OooO0o.ensureFieldAccessorsInitialized(JwtLocation.class, OooO0OO.class);
        }
    ...
    public JwtLocation(GeneratedMessageV3.Builder<?> builder) {
        super(builder);
        this.f18051OooO0Oo = 0;
        this.f18054OooO0oO = (byte) -1;
    }

    public final String OooO0O0() {
        Object obj = this.f18051OooO0Oo == 1 ? this.f18053OooO0o0 : "";
        if (obj instanceof String) {
            return (String) obj;
        }
        String stringUtf8 = ((ByteString) obj).toStringUtf8();
        if (this.f18051OooO0Oo == 1) {
            this.f18053OooO0o0 = stringUtf8;
        }
        return stringUtf8;
    }

    public final InCase OooO0OO() {
        int i = this.f18051OooO0Oo;
        if (i == 0) {
    ...
    public final String OooO0Oo() {
        Object obj = this.f18051OooO0Oo == 2 ? this.f18053OooO0o0 : "";
        if (obj instanceof String) {
            return (String) obj;
        }
        String stringUtf8 = ((ByteString) obj).toStringUtf8();
        if (this.f18051OooO0Oo == 2) {
            this.f18053OooO0o0 = stringUtf8;
        }
        return stringUtf8;
    }
    ...
    public final String OooO0o0() {
        Object obj = this.f18052OooO0o;
        if (obj instanceof String) {
            return (String) obj;
        }
        String stringUtf8 = ((ByteString) obj).toStringUtf8();
        this.f18052OooO0o = stringUtf8;
        return stringUtf8;
    }
    ...
    public final int getSerializedSize() {
        ...
        int iComputeStringSize = this.f18051OooO0Oo == 1 ? 0 + GeneratedMessageV3.computeStringSize(1, this.f18053OooO0o0) : 0;
        if (this.f18051OooO0Oo == 2) {
            iComputeStringSize += GeneratedMessageV3.computeStringSize(2, this.f18053OooO0o0);
        }
        if (!GeneratedMessageV3.isStringEmpty(this.f18052OooO0o)) {
            iComputeStringSize += GeneratedMessageV3.computeStringSize(3, this.f18052OooO0o);
        }
    ...
    public final int hashCode() {
        ...
        int iHashCode2 = OooO0o0().hashCode() + o0O0O0Oo.OooO00o.OooO00o(o0O0O0Oo.OooO0OO.f41165OooO0o0, 779, 37, 3, 53);
        int i2 = this.f18051OooO0Oo;
        if (i2 != 1) {
            if (i2 == 2) {
    ...
    public final Message.Builder newBuilderForType() {
        return f18050OooO0oo.toBuilder();
    }
    ...
    public final void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        if (this.f18051OooO0Oo == 1) {
            GeneratedMessageV3.writeString(codedOutputStream, 1, this.f18053OooO0o0);
        }
        if (this.f18051OooO0Oo == 2) {
            GeneratedMessageV3.writeString(codedOutputStream, 2, this.f18053OooO0o0);
        }
        if (!GeneratedMessageV3.isStringEmpty(this.f18052OooO0o)) {
            GeneratedMessageV3.writeString(codedOutputStream, 3, this.f18052OooO0o);
        }
                    ...
                    try {
                        ...
                        if (tag != 0) {
                            if (tag == 10) {
                                ...
                                this.f18051OooO0Oo = 1;
                                this.f18053OooO0o0 = stringRequireUtf8;
                            } else if (tag == 18) {
                                String stringRequireUtf9 = codedInputStream.readStringRequireUtf8();
                                this.f18051OooO0Oo = 2;
                                this.f18053OooO0o0 = stringRequireUtf9;
                            } else if (tag != 26) {
                                if (!parseUnknownField(codedInputStream, builderNewBuilder, extensionRegistryLite, tag)) {
                                }
                            } else {
                                this.f18052OooO0o = codedInputStream.readStringRequireUtf8();
                            }
                        }
                        z = true;
                    } catch (InvalidProtocolBufferException e) {
