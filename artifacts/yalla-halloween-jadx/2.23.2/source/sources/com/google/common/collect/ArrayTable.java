...
public final class ArrayTable<R, C, V> extends o0OoOo0<R, C, V> implements Serializable {
    ...
    @CheckForNull
    public transient ArrayTable<R, C, V>.OooO0OO f18626OooO0o;

    public static abstract class OooO00o<K, V> extends oo0O.OooO0OO<K, V> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final ImmutableMap<K, Integer> f18627OooO0Oo = null;

        /* JADX INFO: renamed from: com.google.common.collect.ArrayTable$OooO00o$OooO00o, reason: collision with other inner class name */
        public class C0225OooO00o extends com.google.common.collect.OooO0OO<Map.Entry<K, V>> {
            public C0225OooO00o(int i) {
                super(i, 0);
            }
            ...
            public final Object OooO0O0(int i) {
                ...
                com.google.common.base.o0OoOo0.OooO0oo(i, oooO00o.size());
        ...
        public final Iterator<Map.Entry<K, V>> OooO00o() {
            return new C0225OooO00o(size());
        }

        public final K OooO0O0(int i) {
            return this.f18627OooO0Oo.keySet().OooO00o().get(i);
        }
        ...
        public final boolean containsKey(@CheckForNull Object obj) {
            return this.f18627OooO0Oo.containsKey(obj);
        }

        @Override // java.util.AbstractMap, java.util.Map
        @CheckForNull
        public final V get(@CheckForNull Object obj) {
            Integer num = this.f18627OooO0Oo.get(obj);
            if (num == null) {
                return null;
            }
        ...
        public final boolean isEmpty() {
            return this.f18627OooO0Oo.isEmpty();
        }

        @Override // java.util.AbstractMap, java.util.Map
        public final Set<K> keySet() {
            return this.f18627OooO0Oo.keySet();
        }

        @Override // java.util.AbstractMap, java.util.Map
        @CheckForNull
        public V put(K k, @ParametricNullness V v) {
            ImmutableMap<K, Integer> immutableMap = this.f18627OooO0Oo;
            ...
            StringBuilder sb = new StringBuilder(strValueOf2.length() + strValueOf.length() + com.google.common.base.OooO0o.OooO00o(strOooO0OO, 9));
        ...
        public final int size() {
            return this.f18627OooO0Oo.size();
        }
    }
    ...
    public final Map<R, Map<C, V>> OooO0O0() {
        ArrayTable<R, C, V>.OooO0OO oooO0OO = this.f18626OooO0o;
        if (oooO0OO != null) {
            return oooO0OO;
        }
        ArrayTable<R, C, V>.OooO0OO oooO0OO2 = new OooO0OO();
        this.f18626OooO0o = oooO0OO2;
        return oooO0OO2;
    }
