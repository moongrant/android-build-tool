...
public final class EnumMultiset<E extends Enum<E>> extends OooOOOO<E> implements Serializable {
    ...
    public transient int f18637OooO;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public transient Class<E> f18638OooO0o;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public transient E[] f18639OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public transient int[] f18640OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public transient long f18641OooOO0;
    ...
    public class OooO00o extends EnumMultiset<E>.OooO0OO<E> {
        ...
        public final Object OooO00o(int i) {
            return EnumMultiset.this.f18639OooO0oO[i];
        }
    }
    ...
    public abstract class OooO0OO<T> implements Iterator<T> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f18644OooO0Oo = 0;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public int f18646OooO0o0 = -1;
        ...
        public final boolean hasNext() {
            while (true) {
                int i = this.f18644OooO0Oo;
                EnumMultiset enumMultiset = EnumMultiset.this;
                if (i >= enumMultiset.f18639OooO0oO.length) {
                    return false;
                }
                if (enumMultiset.f18640OooO0oo[i] > 0) {
                    return true;
                }
                this.f18644OooO0Oo = i + 1;
            }
        }
        ...
        public final T next() {
            ...
            T tOooO00o = OooO00o(this.f18644OooO0Oo);
            int i = this.f18644OooO0Oo;
            this.f18646OooO0o0 = i;
            this.f18644OooO0Oo = i + 1;
            return tOooO00o;
        }
        ...
        public final void remove() {
            oo000o.OooO0Oo(this.f18646OooO0o0 >= 0);
            EnumMultiset enumMultiset = EnumMultiset.this;
            int[] iArr = enumMultiset.f18640OooO0oo;
            int i = this.f18646OooO0o0;
            int i2 = iArr[i];
            if (i2 > 0) {
                enumMultiset.f18637OooO--;
                enumMultiset.f18641OooOO0 -= (long) i2;
                iArr[i] = 0;
            }
            this.f18646OooO0o0 = -1;
        }
    }
    ...
    private void readObject(ObjectInputStream objectInputStream) throws ClassNotFoundException, IOException {
        ...
        this.f18638OooO0o = cls;
        E[] enumConstants = cls.getEnumConstants();
        this.f18639OooO0oO = enumConstants;
        this.f18640OooO0oo = new int[enumConstants.length];
    ...
    public final void OooO0o(Object obj) {
        ...
        String strValueOf = String.valueOf(this.f18638OooO0o);
    ...
    public final int Oooo00o(int i, @CheckForNull Object obj) {
        ...
        if (i2 <= i) {
            iArr[iOrdinal] = 0;
            this.f18637OooO--;
            this.f18641OooOO0 -= (long) i2;
        } else {
            iArr[iOrdinal] = i2 - i;
            this.f18641OooOO0 -= (long) i;
        }
        return i2;
    }
    ...
    public final void clear() {
        Arrays.fill(this.f18640OooO0oo, 0);
        this.f18641OooOO0 = 0L;
        this.f18637OooO = 0;
    }
    ...
    public final int o000000O(@CheckForNull Object obj) {
        ...
        return this.f18640OooO0oo[((Enum) obj).ordinal()];
    }
    ...
    public final int size() {
        return com.google.common.primitives.OooO0OO.OooO0OO(this.f18641OooOO0);
    }
}
