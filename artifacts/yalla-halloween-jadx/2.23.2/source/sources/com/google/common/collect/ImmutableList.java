...
public abstract class ImmutableList<E> extends ImmutableCollection<E> implements List<E>, RandomAccess {
    ...
    public static final OooO0O0 f18681OooO0o0 = new OooO0O0(0, o0O00.f19060OooO0oo);

    public class OooO extends ImmutableList<E> {

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final transient int f18682OooO0o;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final transient int f18683OooO0oO;

        public OooO(int i, int i2) {
            this.f18682OooO0o = i;
            this.f18683OooO0oO = i2;
        }
        ...
        public final int OooO0Oo() {
            return ImmutableList.this.OooO0o0() + this.f18682OooO0o + this.f18683OooO0oO;
        }
        ...
        public final int OooO0o0() {
            return ImmutableList.this.OooO0o0() + this.f18682OooO0o;
        }
        ...
        public final ImmutableList<E> subList(int i, int i2) {
            com.google.common.base.o0OoOo0.OooOO0O(i, i2, this.f18683OooO0oO);
            int i3 = this.f18682OooO0o;
            return ImmutableList.this.subList(i + i3, i2 + i3);
        }

        @Override // java.util.List
        public final E get(int i) {
            com.google.common.base.o0OoOo0.OooO0oo(i, this.f18683OooO0oO);
            return ImmutableList.this.get(i + this.f18682OooO0o);
        }
    ...
    public static final class OooO00o<E> extends ImmutableCollection.OooO00o<E> {
        ...
        public final o0O00 OooO0oo() {
            this.f18680OooO0OO = true;
            return ImmutableList.OooO(this.f18679OooO0O0, this.f18678OooO00o);
        }
    }
    ...
    public static class OooO0OO<E> extends ImmutableList<E> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final transient ImmutableList<E> f18686OooO0o;

        public OooO0OO(ImmutableList<E> immutableList) {
            this.f18686OooO0o = immutableList;
        }

        @Override // com.google.common.collect.ImmutableCollection
        public final boolean OooO0o() {
            return this.f18686OooO0o.OooO0o();
        }

        @Override // com.google.common.collect.ImmutableList, java.util.List
        /* JADX INFO: renamed from: OooOOo */
        public final ImmutableList<E> subList(int i, int i2) {
            com.google.common.base.o0OoOo0.OooOO0O(i, i2, size());
            return this.f18686OooO0o.subList(size() - i2, size() - i).OooOOo0();
        }

        @Override // com.google.common.collect.ImmutableList
        public final ImmutableList<E> OooOOo0() {
            return this.f18686OooO0o;
        }

        @Override // com.google.common.collect.ImmutableList, com.google.common.collect.ImmutableCollection, java.util.AbstractCollection, java.util.Collection
        public final boolean contains(@CheckForNull Object obj) {
            return this.f18686OooO0o.contains(obj);
        }

        @Override // java.util.List
        public final E get(int i) {
            com.google.common.base.o0OoOo0.OooO0oo(i, size());
            return this.f18686OooO0o.get((size() - 1) - i);
        }

        @Override // com.google.common.collect.ImmutableList, java.util.List
        public final int indexOf(@CheckForNull Object obj) {
            int iLastIndexOf = this.f18686OooO0o.lastIndexOf(obj);
            if (iLastIndexOf >= 0) {
        ...
        public final int lastIndexOf(@CheckForNull Object obj) {
            int iIndexOf = this.f18686OooO0o.indexOf(obj);
            if (iIndexOf >= 0) {
    ...
    public static class OooO0o implements Serializable {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final Object[] f18687OooO0Oo;

        public OooO0o(Object[] objArr) {
            this.f18687OooO0Oo = objArr;
        }

        public Object readResolve() {
            return ImmutableList.OooOO0o(this.f18687OooO0Oo);
        }
    }

    public static o0O00 OooO(int i, Object[] objArr) {
        return i == 0 ? o0O00.f19060OooO0oo : new o0O00(objArr, i);
    }
    ...
    public final OooO0O0 listIterator(int i) {
        com.google.common.base.o0OoOo0.OooOO0(i, size());
        return isEmpty() ? f18681OooO0o0 : new OooO0O0(i, this);
    }
    ...
    public ImmutableList<E> subList(int i, int i2) {
        ...
        return i3 == 0 ? o0O00.f19060OooO0oo : new OooO(i, i3);
    }
            ...
            if (size == list.size()) {
                if (list instanceof RandomAccess) {
                    for (int i = 0; i < size; i++) {
                        if (com.google.common.base.Oooo0.OooO00o(get(i), list.get(i))) {
                        }
                    }
                    return true;
                }
                ...
                while (it.hasNext()) {
                    if (it2.hasNext() && com.google.common.base.Oooo0.OooO00o(it.next(), it2.next())) {
                    }
                }
                return !it2.hasNext();
            }
