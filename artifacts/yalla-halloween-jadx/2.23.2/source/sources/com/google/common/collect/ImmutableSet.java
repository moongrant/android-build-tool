...
public abstract class ImmutableSet<E> extends ImmutableCollection<E> implements Set<E> {
    ...
    public static final /* synthetic */ int f18718OooO0o = 0;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @RetainedWith
    @CheckForNull
    @LazyInit
    public transient ImmutableList<E> f18719OooO0o0;

    public static class OooO00o<E> extends ImmutableCollection.OooO00o<E> {
        public ImmutableSet<E> OooO() {
            int i = this.f18679OooO0O0;
            if (i == 0) {
                int i2 = ImmutableSet.f18718OooO0o;
                return o0O00O0o.f19090OooOOO0;
            }
            if (i != 1) {
                ImmutableSet<E> immutableSetOooOO0 = ImmutableSet.OooOO0(i, this.f18678OooO00o);
                this.f18679OooO0O0 = immutableSetOooOO0.size();
                this.f18680OooO0OO = true;
                return immutableSetOooOO0;
            }
            Object obj = this.f18678OooO00o[0];
            Objects.requireNonNull(obj);
            int i3 = ImmutableSet.f18718OooO0o;
    ...
    public static class OooO0O0 implements Serializable {
        ...
        public final Object[] f18720OooO0Oo;

        public OooO0O0(Object[] objArr) {
            this.f18720OooO0Oo = objArr;
        }

        public Object readResolve() {
            return ImmutableSet.OooOO0o(this.f18720OooO0Oo);
        }
    }
    ...
    public static int OooO(int i) {
        ...
        if (iMax >= 751619276) {
            com.google.common.base.o0OoOo0.OooO0o0(iMax < 1073741824, "collection too large");
    ...
    public static <E> ImmutableSet<E> OooOO0(int i, Object... objArr) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            ...
            if (obj2 == null) {
                throw new NullPointerException(android.support.v4.media.session.OooO0OO.OooO00o(20, "at index ", i5));
            }
    ...
    public ImmutableList<E> OooO00o() {
        ImmutableList<E> immutableList = this.f18719OooO0o0;
        if (immutableList != null) {
            return immutableList;
        }
        ImmutableList<E> immutableListOooOOO0 = OooOOO0();
        this.f18719OooO0o0 = immutableListOooOOO0;
