...
public class ImmutableSetMultimap<K, V> extends ImmutableMultimap<K, V> implements o0O0O0O<K, V> {
    ...
    @CheckForNull
    @LazyInit
    public transient OooO00o f18721OooO0oo;

    public static final class OooO00o<K, V> extends ImmutableSet<Map.Entry<K, V>> {

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        @Weak
        public final transient ImmutableSetMultimap<K, V> f18722OooO0oO;

        public OooO00o(ImmutableSetMultimap<K, V> immutableSetMultimap) {
            this.f18722OooO0oO = immutableSetMultimap;
        }
        ...
        public final boolean contains(@CheckForNull Object obj) {
            ...
            return this.f18722OooO0oO.OooO00o(entry.getKey(), entry.getValue());
        }

        @Override // java.util.AbstractCollection, java.util.Collection, java.util.Set
        public final int size() {
            this.f18722OooO0oO.getClass();
            return 0;
        }
    }
    ...
    public static final class OooO0O0 {
        ...
        public static final o0O00oO0.OooO00o<ImmutableSetMultimap> f18723OooO00o = o0O00oO0.OooO00o(ImmutableSetMultimap.class, "emptySet");
    }
    ...
    private void readObject(ObjectInputStream objectInputStream) throws ClassNotFoundException, IOException {
        ...
        if (i < 0) {
            throw new InvalidObjectException(android.support.v4.media.session.OooO0OO.OooO00o(29, "Invalid key count ", i));
        }
        ...
        for (int i3 = 0; i3 < i; i3++) {
            ...
            if (i4 <= 0) {
                throw new InvalidObjectException(android.support.v4.media.session.OooO0OO.OooO00o(31, "Invalid value count ", i4));
            }
        ...
        try {
            ImmutableMultimap.OooO0OO.f18701OooO00o.OooO00o(this, OooO00o2.OooO00o(true));
            o0O00oO0.OooO00o<ImmutableMultimap> oooO00o2 = ImmutableMultimap.OooO0OO.f18702OooO0O0;
            oooO00o2.getClass();
            try {
                oooO00o2.f19101OooO00o.set(this, Integer.valueOf(i2));
                o0O00oO0.OooO00o<ImmutableSetMultimap> oooO00o3 = OooO0O0.f18723OooO00o;
                if (comparator == null) {
                    int i6 = ImmutableSet.f18718OooO0o;
                    objOooOo00 = o0O00O0o.f19090OooOOO0;
                } else {
    ...
    @Deprecated
    public final Collection OooO0o0(@CheckForNull Object obj) {
    ...
    public final Collection OooO0oo() {
        OooO00o oooO00o = this.f18721OooO0oo;
        if (oooO00o != null) {
            return oooO00o;
        }
        OooO00o oooO00o2 = new OooO00o(this);
        this.f18721OooO0oo = oooO00o2;
        return oooO00o2;
    }
