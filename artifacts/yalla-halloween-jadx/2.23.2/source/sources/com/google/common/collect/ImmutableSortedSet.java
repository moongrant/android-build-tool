...
public abstract class ImmutableSortedSet<E> extends o00O000o<E> implements NavigableSet<E>, o0O0OOO0<E> {
    ...
    public final transient Comparator<? super E> f18743OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    @CheckForNull
    @GwtIncompatible
    @LazyInit
    public transient ImmutableSortedSet<E> f18744OooO0oo;

    public static final class OooO00o<E> extends ImmutableSet.OooO00o<E> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final Comparator<? super E> f18745OooO0Oo;

        public OooO00o(Comparator<? super E> comparator) {
            this.f18745OooO0Oo = comparator;
        }

        @Override // com.google.common.collect.ImmutableSet.OooO00o
        public final ImmutableSet OooO() {
            Object[] objArr = this.f18678OooO00o;
            o0O00OO o0o00ooOooOOOo = ImmutableSortedSet.OooOOOo(this.f18679OooO0O0, this.f18745OooO0Oo, objArr);
            this.f18679OooO0O0 = o0o00ooOooOOOo.size();
    ...
    public static class OooO0O0<E> implements Serializable {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final Comparator<? super E> f18746OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final Object[] f18747OooO0o0;

        public OooO0O0(Comparator<? super E> comparator, Object[] objArr) {
            this.f18746OooO0Oo = comparator;
            this.f18747OooO0o0 = objArr;
        }

        public Object readResolve() {
            oo000o.OooO0O0(4, "initialCapacity");
            Object[] objArrCopyOf = new Object[4];
            Comparator<? super E> comparator = this.f18746OooO0Oo;
            comparator.getClass();
            Object[] objArr = this.f18747OooO0o0;
    ...
    public static <E> o0O00OO<E> OooOo00(Comparator<? super E> comparator) {
        return o0O0o.f19109OooO0Oo.equals(comparator) ? (o0O00OO<E>) o0O00OO.f19096OooOO0 : new o0O00OO<>(o0O00.f19060OooO0oo, comparator);
    }
    ...
    public ImmutableSortedSet<E> descendingSet() {
        ImmutableSortedSet<E> immutableSortedSet = this.f18744OooO0oo;
        if (immutableSortedSet != null) {
            return immutableSortedSet;
        }
        ImmutableSortedSet<E> immutableSortedSetOooOOo0 = OooOOo0();
        this.f18744OooO0oo = immutableSortedSetOooOOo0;
        immutableSortedSetOooOOo0.f18744OooO0oo = this;
    ...
    public ImmutableSortedSet<E> subSet(E e, boolean z, E e2, boolean z2) {
        e.getClass();
        e2.getClass();
        com.google.common.base.o0OoOo0.OooO0Oo(this.f18743OooO0oO.compare(e, e2) <= 0);
    ...
    public Object writeReplace() {
        return new OooO0O0(this.f18743OooO0oO, toArray());
    }
}
