...
public abstract class ImmutableTable<R, C, V> extends o0OoOo0<R, C, V> implements Serializable {
    ...
    public static final class OooO00o implements Serializable {
        ...
        public final Object[] f18748OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final Object[] f18749OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final Object[] f18750OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final int[] f18751OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final int[] f18752OooO0oo;

        public OooO00o(Object[] objArr, Object[] objArr2, Object[] objArr3, int[] iArr, int[] iArr2) {
            this.f18748OooO0Oo = objArr;
            this.f18750OooO0o0 = objArr2;
            this.f18749OooO0o = objArr3;
            this.f18751OooO0oO = iArr;
            this.f18752OooO0oo = iArr2;
        }
        ...
        public static OooO00o OooO00o(ImmutableTable<?, ?, ?> immutableTable, int[] iArr, int[] iArr2) {
            ...
            Collection<V> collectionOooOOO = (Collection<V>) immutableTable.f19165OooO0o0;
            if (collectionOooOOO == null) {
                collectionOooOOO = immutableTable.OooOOO();
                immutableTable.f19165OooO0o0 = collectionOooOOO;
            }
            return new OooO00o(array, array2, collectionOooOOO.toArray(), iArr, iArr2);
        }

        public Object readResolve() {
            Object[] objArr = this.f18749OooO0o;
            if (objArr.length == 0) {
                return o0O0o00O.f19112OooOO0;
            }
            int length = objArr.length;
            Object[] objArr2 = this.f18750OooO0o0;
            Object[] objArr3 = this.f18748OooO0Oo;
            int i = 0;
            if (length == 1) {
            ...
            while (i < objArr.length) {
                o0OO000o o0oo000oOooO0oO = ImmutableTable.OooO0oO(objArr3[this.f18751OooO0oO[i]], objArr2[this.f18752OooO0oo[i]], objArr[i]);
                int i3 = i2 + 1;
            ...
            return ((long) o0o00OooO.f19062OooO0oO) > (((long) immutableSetOooOO0o.size()) * ((long) immutableSetOooOO0o2.size())) / 2 ? new o00000O(o0o00OooO, immutableSetOooOO0o, immutableSetOooOO0o2) : new o0O0o00O(o0o00OooO, immutableSetOooOO0o, immutableSetOooOO0o2);
        }
    }
