...
public abstract class OooOO0<K, V> extends com.google.common.collect.OooOOO<K, V> implements Serializable {
    ...
    public transient int f18830OooO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public transient Map<K, Collection<V>> f18831OooO0oo;
    ...
    public class OooO extends oo0O.OooO0o<K, Collection<V>> {
        ...
        public class OooO00o implements Iterator<K> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            @CheckForNull
            public Map.Entry<K, Collection<V>> f18833OooO0Oo;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public final /* synthetic */ Iterator f18835OooO0o0;

            public OooO00o(Iterator it) {
                this.f18835OooO0o0 = it;
            }

            @Override // java.util.Iterator
            public final boolean hasNext() {
                return this.f18835OooO0o0.hasNext();
            }

            @Override // java.util.Iterator
            @ParametricNullness
            public final K next() {
                Map.Entry<K, Collection<V>> entry = (Map.Entry) this.f18835OooO0o0.next();
                this.f18833OooO0Oo = entry;
                return entry.getKey();
            }

            @Override // java.util.Iterator
            public final void remove() {
                com.google.common.base.o0OoOo0.OooOOO(this.f18833OooO0Oo != null, "no calls to next() since the last call to remove()");
                Collection<V> value = this.f18833OooO0Oo.getValue();
                this.f18835OooO0o0.remove();
                OooOO0.this.f18830OooO -= value.size();
                value.clear();
                this.f18833OooO0Oo = null;
            }
        }
        ...
        public final boolean containsAll(Collection<?> collection) {
            return this.f19201OooO0Oo.keySet().containsAll(collection);
        }

        @Override // java.util.AbstractSet, java.util.Collection, java.util.Set
        public final boolean equals(@CheckForNull Object obj) {
            return this == obj || this.f19201OooO0Oo.keySet().equals(obj);
        }

        @Override // java.util.AbstractSet, java.util.Collection, java.util.Set
        public final int hashCode() {
            return this.f19201OooO0Oo.keySet().hashCode();
        }
        ...
        public final Iterator<K> iterator() {
            return new OooO00o(this.f19201OooO0Oo.entrySet().iterator());
        }

        @Override // com.google.common.collect.oo0O.OooO0o, java.util.AbstractCollection, java.util.Collection, java.util.Set
        public final boolean remove(@CheckForNull Object obj) {
            int size;
            Collection collection = (Collection) this.f19201OooO0Oo.remove(obj);
            if (collection != null) {
                size = collection.size();
                collection.clear();
                OooOO0.this.f18830OooO -= size;
            } else {
                size = 0;
            }
            return size > 0;
    ...
    public class OooO0OO extends oo0O.OooOO0O<K, Collection<V>> {
        ...
        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final transient Map<K, Collection<V>> f18836OooO0oO;
        ...
        public class OooO00o extends oo0O.OooO0O0<K, Collection<V>> {
            ...
            public final boolean contains(@CheckForNull Object obj) {
                Set<Map.Entry<K, Collection<V>>> setEntrySet = OooO0OO.this.f18836OooO0oO.entrySet();
            ...
            public final boolean remove(@CheckForNull Object obj) {
                ...
                Map<K, Collection<V>> map = oooOO1.f18831OooO0oo;
                map.getClass();
                try {
        ...
        public class OooO0O0 implements Iterator<Map.Entry<K, Collection<V>>> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final Iterator<Map.Entry<K, Collection<V>>> f18839OooO0Oo;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            @CheckForNull
            public Collection<V> f18841OooO0o0;

            public OooO0O0() {
                this.f18839OooO0Oo = OooO0OO.this.f18836OooO0oO.entrySet().iterator();
            }

            @Override // java.util.Iterator
            public final boolean hasNext() {
                return this.f18839OooO0Oo.hasNext();
            }

            @Override // java.util.Iterator
            public final Object next() {
                Map.Entry<K, Collection<V>> next = this.f18839OooO0Oo.next();
                this.f18841OooO0o0 = next.getValue();
                return OooO0OO.this.OooO0OO(next);
            }

            @Override // java.util.Iterator
            public final void remove() {
                com.google.common.base.o0OoOo0.OooOOO(this.f18841OooO0o0 != null, "no calls to next() since the last call to remove()");
                this.f18839OooO0Oo.remove();
                OooOO0.this.f18830OooO -= this.f18841OooO0o0.size();
                this.f18841OooO0o0.clear();
                this.f18841OooO0o0 = null;
            }
        }

        public OooO0OO(Map<K, Collection<V>> map) {
            this.f18836OooO0oO = map;
        }
        ...
        public final void clear() {
            OooOO0 oooOO1 = OooOO0.this;
            if (this.f18836OooO0oO == oooOO1.f18831OooO0oo) {
                oooOO1.clear();
            } else {
        ...
        public final boolean containsKey(@CheckForNull Object obj) {
            Map<K, Collection<V>> map = this.f18836OooO0oO;
            map.getClass();
            try {
        ...
        @Override // java.util.AbstractMap, java.util.Map
        public final boolean equals(@CheckForNull Object obj) {
            return this == obj || this.f18836OooO0oO.equals(obj);
        }

        @Override // java.util.AbstractMap, java.util.Map
        @CheckForNull
        public final Object get(@CheckForNull Object obj) {
            Collection collection = (Collection) oo0O.OooO0OO(obj, this.f18836OooO0oO);
            if (collection == null) {
                return null;
            }
        ...
        @Override // java.util.AbstractMap, java.util.Map
        public final int hashCode() {
            return this.f18836OooO0oO.hashCode();
        }
        ...
        public final Object remove(@CheckForNull Object obj) {
            Collection<V> collectionRemove = this.f18836OooO0oO.remove(obj);
            ...
            oooOO1.f18830OooO -= collectionRemove.size();
        ...
        public final int size() {
            return this.f18836OooO0oO.size();
        }

        @Override // java.util.AbstractMap
        public final String toString() {
            return this.f18836OooO0oO.toString();
        }
    }
    ...
    public abstract class OooO0o<T> implements Iterator<T> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final Iterator<Map.Entry<K, Collection<V>>> f18842OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        @CheckForNull
        public K f18844OooO0o0 = null;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        @CheckForNull
        public Collection<V> f18843OooO0o = null;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public Iterator<V> f18845OooO0oO = o00O0O0O.OooO00o.INSTANCE;

        public OooO0o() {
            this.f18842OooO0Oo = OooOO0.this.f18831OooO0oo.entrySet().iterator();
        }
        ...
        @Override // java.util.Iterator
        public final boolean hasNext() {
            return this.f18842OooO0Oo.hasNext() || this.f18845OooO0oO.hasNext();
        }

        @Override // java.util.Iterator
        public final T next() {
            if (!this.f18845OooO0oO.hasNext()) {
                Map.Entry<K, Collection<V>> next = this.f18842OooO0Oo.next();
                this.f18844OooO0o0 = next.getKey();
                Collection<V> value = next.getValue();
                this.f18843OooO0o = value;
                this.f18845OooO0oO = value.iterator();
            }
            return OooO00o(this.f18844OooO0o0, this.f18845OooO0oO.next());
        }

        @Override // java.util.Iterator
        public final void remove() {
            this.f18845OooO0oO.remove();
            Collection<V> collection = this.f18843OooO0o;
            Objects.requireNonNull(collection);
            if (collection.isEmpty()) {
                this.f18842OooO0Oo.remove();
            }
            OooOO0.this.f18830OooO--;
        }
    }

    /* JADX INFO: renamed from: com.google.common.collect.OooOO0$OooOO0, reason: collision with other inner class name */
    public class C0230OooOO0 extends OooOO0<K, V>.OooOOO implements NavigableMap<K, Collection<V>> {
        public C0230OooOO0(NavigableMap<K, Collection<V>> navigableMap) {
            super(navigableMap);
        }
        ...
        public final NavigableMap<K, Collection<V>> OooO0o() {
            return (NavigableMap) ((SortedMap) this.f18836OooO0oO);
        }
        ...
        public final NavigableSet<K> descendingKeySet() {
            return ((C0230OooOO0) descendingMap()).navigableKeySet();
        }

        @Override // java.util.NavigableMap
        public final NavigableMap<K, Collection<V>> descendingMap() {
            return new C0230OooOO0(OooO0o().descendingMap());
        }
    ...
    public class OooOO0O extends OooOO0<K, V>.OooOOOO implements NavigableSet<K> {
        ...
        public final NavigableMap<K, Collection<V>> OooO0o0() {
            return (NavigableMap) ((SortedMap) this.f19201OooO0Oo);
        }
    ...
    public class OooOOO extends OooOO0<K, V>.OooO0OO implements SortedMap<K, Collection<V>> {
        ...
        public SortedMap<K, Collection<V>> OooO0o() {
            return (SortedMap) this.f18836OooO0oO;
        }
        ...
        public SortedSet<K> keySet() {
            SortedSet<K> sortedSet = this.f18849OooO;
            if (sortedSet != null) {
                return sortedSet;
            }
            SortedSet<K> sortedSetOooO0O0 = OooO0O0();
            this.f18849OooO = sortedSetOooO0O0;
    ...
    public class OooOOOO extends OooOO0<K, V>.OooO implements SortedSet<K> {
        ...
        public SortedMap<K, Collection<V>> OooO0o0() {
            return (SortedMap) this.f19201OooO0Oo;
        }
    ...
    public class Oooo0 extends OooOO0<K, V>.OooOo00 implements Set<V> {
        ...
        public final boolean removeAll(Collection<?> collection) {
            ...
            int size = size();
            boolean zOooO0o = o0O0O0Oo.OooO0o((Set) this.f18856OooO0o0, collection);
            if (zOooO0o) {
                OooOO0.this.f18830OooO += this.f18856OooO0o0.size() - size;
                OooO0OO();
            }
            return zOooO0o;
        }
    ...
    public class Oooo000 extends OooOO0<K, V>.o000oOoO implements NavigableSet<V> {
        ...
        public final Oooo000 OooO0o(NavigableSet navigableSet) {
            OooOO0<K, V>.OooOo00 oooOo00 = this.f18855OooO0o;
            if (oooOo00 == null) {
                oooOo00 = this;
            }
            return new Oooo000(this.f18854OooO0Oo, navigableSet, oooOo00);
        }

        @Override // com.google.common.collect.OooOO0.o000oOoO
        /* JADX INFO: renamed from: OooO0o0, reason: merged with bridge method [inline-methods] */
        public final NavigableSet<V> OooO0Oo() {
            return (NavigableSet) ((SortedSet) this.f18856OooO0o0);
        }
    ...
    public class o000oOoO extends OooOO0<K, V>.OooOo00 implements SortedSet<V> {
        ...
        public SortedSet<V> OooO0Oo() {
            return (SortedSet) this.f18856OooO0o0;
        }
        ...
        public final SortedSet<V> headSet(@ParametricNullness V v) {
            ...
            return new o000oOoO(this.f18854OooO0Oo, sortedSetHeadSet, oooOo00);
        }
        ...
        public final SortedSet<V> subSet(@ParametricNullness V v, @ParametricNullness V v2) {
            ...
            return new o000oOoO(this.f18854OooO0Oo, sortedSetSubSet, oooOo00);
        }
        ...
        public final SortedSet<V> tailSet(@ParametricNullness V v) {
            ...
            return new o000oOoO(this.f18854OooO0Oo, sortedSetTailSet, oooOo00);
        }
    }

    public OooOO0(Map<K, Collection<V>> map) {
        com.google.common.base.o0OoOo0.OooO0Oo(map.isEmpty());
        this.f18831OooO0oo = map;
    }
    ...
    public Map<K, Collection<V>> OooO0OO() {
        return new OooO0OO(this.f18831OooO0oo);
    }
    ...
    public Collection<V> OooO0o0(@CheckForNull Object obj) {
        Collection<V> collectionRemove = this.f18831OooO0oo.remove(obj);
        if (collectionRemove == null) {
            return OooOOOO();
        }
        Collection collectionOooOO0O = OooOO0O();
        collectionOooOO0O.addAll(collectionRemove);
        this.f18830OooO -= collectionRemove.size();
        collectionRemove.clear();
    ...
    public Set<K> OooO0oO() {
        return new OooO(this.f18831OooO0oo);
    }
    ...
    public final OooO OooOOO() {
        Map<K, Collection<V>> map = this.f18831OooO0oo;
        if (map instanceof NavigableMap) {
            return new OooOO0O((NavigableMap) this.f18831OooO0oo);
        }
        return map instanceof SortedMap ? new OooOOOO((SortedMap) this.f18831OooO0oo) : new OooO(this.f18831OooO0oo);
    }

    public final OooO0OO OooOOO0() {
        Map<K, Collection<V>> map = this.f18831OooO0oo;
        if (map instanceof NavigableMap) {
            return new C0230OooOO0((NavigableMap) this.f18831OooO0oo);
        }
        return map instanceof SortedMap ? new OooOOO((SortedMap) this.f18831OooO0oo) : new OooO0OO(this.f18831OooO0oo);
    }
    ...
    public final void OooOOo(Map<K, Collection<V>> map) {
        ...
        for (Collection<V> collection : map.values()) {
            com.google.common.base.o0OoOo0.OooO0Oo(!collection.isEmpty());
            this.f18830OooO = collection.size() + this.f18830OooO;
        }
    }

    public boolean OooOOo0(@ParametricNullness K k, @ParametricNullness V v) {
        Collection<V> collection = this.f18831OooO0oo.get(k);
        if (collection != null) {
            if (!collection.add(v)) {
                return false;
            }
        ...
        this.f18830OooO++;
        this.f18831OooO0oo.put(k, collectionOooOO0o);
        return true;
    }
    ...
    public Collection<V> OooOo00() {
        Collection<V> collection = this.f18874OooO0o;
        if (collection != null) {
            return collection;
        }
        Collection<V> collectionOooOOOo = OooOOOo();
        this.f18874OooO0o = collectionOooOOOo;
        return collectionOooOOOo;
    }

    @Override // com.google.common.collect.o00OO
    public void clear() {
        Iterator<Collection<V>> it = this.f18831OooO0oo.values().iterator();
        while (it.hasNext()) {
            it.next().clear();
        }
        this.f18831OooO0oo.clear();
        this.f18830OooO = 0;
    }

    @Override // com.google.common.collect.o00OO
    public final boolean containsKey(@CheckForNull Object obj) {
        return this.f18831OooO0oo.containsKey(obj);
    }

    @Override // com.google.common.collect.o00OO
    public final int size() {
        return this.f18830OooO;
    }
    ...
    public class OooOo extends OooOO0<K, V>.OooOo00 implements List<V> {
        ...
        public class OooO00o extends OooOO0<K, V>.OooOo00.OooO00o implements ListIterator<V> {
            ...
            public final ListIterator<V> OooO0O0() {
                OooO00o();
                return (ListIterator) this.f18859OooO0Oo;
            }
            ...
            public OooO00o(int i) {
                super(((List) OooOo.this.f18856OooO0o0).listIterator(i));
            }
        }
        ...
        public final void add(int i, @ParametricNullness V v) {
            OooO0O0();
            boolean zIsEmpty = this.f18856OooO0o0.isEmpty();
            ((List) this.f18856OooO0o0).add(i, v);
            OooOO0.this.f18830OooO++;
            if (zIsEmpty) {
                OooO00o();
            }
        ...
        public final boolean addAll(int i, Collection<? extends V> collection) {
            ...
            int size = size();
            boolean zAddAll = ((List) this.f18856OooO0o0).addAll(i, collection);
            if (zAddAll) {
                OooOO0.this.f18830OooO += this.f18856OooO0o0.size() - size;
                if (size == 0) {
                    OooO00o();
        ...
        public final V get(int i) {
            OooO0O0();
            return (V) ((List) this.f18856OooO0o0).get(i);
        }

        @Override // java.util.List
        public final int indexOf(@CheckForNull Object obj) {
            OooO0O0();
            return ((List) this.f18856OooO0o0).indexOf(obj);
        }

        @Override // java.util.List
        public final int lastIndexOf(@CheckForNull Object obj) {
            OooO0O0();
            return ((List) this.f18856OooO0o0).lastIndexOf(obj);
        }
        ...
        public final V remove(int i) {
            OooO0O0();
            V v = (V) ((List) this.f18856OooO0o0).remove(i);
            OooOO0.this.f18830OooO--;
            OooO0OO();
            return v;
        }
        ...
        public final V set(int i, @ParametricNullness V v) {
            OooO0O0();
            return (V) ((List) this.f18856OooO0o0).set(i, v);
        }

        @Override // java.util.List
        public final List<V> subList(int i, int i2) {
            OooO0O0();
            List listSubList = ((List) this.f18856OooO0o0).subList(i, i2);
            OooOO0<K, V>.OooOo00 oooOo00 = this.f18855OooO0o;
            if (oooOo00 == null) {
                oooOo00 = this;
            }
    ...
    public class OooOo00 extends AbstractCollection<V> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        @ParametricNullness
        public final K f18854OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        @CheckForNull
        public final OooOO0<K, V>.OooOo00 f18855OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public Collection<V> f18856OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        @CheckForNull
        public final Collection<V> f18857OooO0oO;

        public OooOo00(K k, @CheckForNull Collection<V> collection, OooOO0<K, V>.OooOo00 oooOo00) {
            this.f18854OooO0Oo = k;
            this.f18856OooO0o0 = collection;
            this.f18855OooO0o = oooOo00;
            this.f18857OooO0oO = oooOo00 == null ? null : oooOo00.f18856OooO0o0;
        }
        ...
        public final void OooO00o() {
            ...
            if (oooOo00 != null) {
                ...
                OooOO0.this.f18831OooO0oo.put(this.f18854OooO0Oo, this.f18856OooO0o0);
            }
        }
        ...
        public final void OooO0O0() {
            ...
            if (oooOo00 != null) {
                oooOo00.OooO0O0();
                if (oooOo00.f18856OooO0o0 != this.f18857OooO0oO) {
                    throw new ConcurrentModificationException();
                }
            } else {
                if (!this.f18856OooO0o0.isEmpty() || (collection = OooOO0.this.f18831OooO0oo.get(this.f18854OooO0Oo)) == null) {
                    return;
                }
                this.f18856OooO0o0 = collection;
            }
        ...
        public final void OooO0OO() {
            ...
            if (oooOo00 != null) {
                oooOo00.OooO0OO();
            } else if (this.f18856OooO0o0.isEmpty()) {
                OooOO0.this.f18831OooO0oo.remove(this.f18854OooO0Oo);
            }
        }
        ...
        public final boolean add(@ParametricNullness V v) {
            OooO0O0();
            boolean zIsEmpty = this.f18856OooO0o0.isEmpty();
            boolean zAdd = this.f18856OooO0o0.add(v);
            if (zAdd) {
                OooOO0.this.f18830OooO++;
                if (zIsEmpty) {
                    OooO00o();
        ...
        public final boolean addAll(Collection<? extends V> collection) {
            ...
            int size = size();
            boolean zAddAll = this.f18856OooO0o0.addAll(collection);
            if (zAddAll) {
                OooOO0.this.f18830OooO += this.f18856OooO0o0.size() - size;
                if (size == 0) {
                    OooO00o();
        ...
        public final boolean contains(@CheckForNull Object obj) {
            OooO0O0();
            return this.f18856OooO0o0.contains(obj);
        }

        @Override // java.util.AbstractCollection, java.util.Collection
        public final boolean containsAll(Collection<?> collection) {
            OooO0O0();
            return this.f18856OooO0o0.containsAll(collection);
        }
        ...
        public final boolean equals(@CheckForNull Object obj) {
            ...
            OooO0O0();
            return this.f18856OooO0o0.equals(obj);
        }

        @Override // java.util.Collection
        public final int hashCode() {
            OooO0O0();
            return this.f18856OooO0o0.hashCode();
        }
        ...
        public final boolean remove(@CheckForNull Object obj) {
            OooO0O0();
            boolean zRemove = this.f18856OooO0o0.remove(obj);
            if (zRemove) {
                OooOO0.this.f18830OooO--;
                OooO0OO();
            }
        ...
        public boolean removeAll(Collection<?> collection) {
            ...
            int size = size();
            boolean zRemoveAll = this.f18856OooO0o0.removeAll(collection);
            if (zRemoveAll) {
                OooOO0.this.f18830OooO += this.f18856OooO0o0.size() - size;
                OooO0OO();
            }
        ...
        public final boolean retainAll(Collection<?> collection) {
            collection.getClass();
            int size = size();
            boolean zRetainAll = this.f18856OooO0o0.retainAll(collection);
            if (zRetainAll) {
                OooOO0.this.f18830OooO += this.f18856OooO0o0.size() - size;
                OooO0OO();
            }
        ...
        public final int size() {
            OooO0O0();
            return this.f18856OooO0o0.size();
        }

        @Override // java.util.AbstractCollection
        public final String toString() {
            OooO0O0();
            return this.f18856OooO0o0.toString();
        }

        public class OooO00o implements Iterator<V> {

            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final Iterator<V> f18859OooO0Oo;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public final Collection<V> f18861OooO0o0;

            public OooO00o() {
                Collection<V> collection = OooOo00.this.f18856OooO0o0;
                this.f18861OooO0o0 = collection;
                this.f18859OooO0Oo = collection instanceof List ? ((List) collection).listIterator() : collection.iterator();
            }

            public final void OooO00o() {
                OooOo00 oooOo00 = OooOo00.this;
                oooOo00.OooO0O0();
                if (oooOo00.f18856OooO0o0 != this.f18861OooO0o0) {
                    throw new ConcurrentModificationException();
                }
            }
            ...
            public final boolean hasNext() {
                OooO00o();
                return this.f18859OooO0Oo.hasNext();
            }
            ...
            public final V next() {
                OooO00o();
                return this.f18859OooO0Oo.next();
            }

            @Override // java.util.Iterator
            public final void remove() {
                this.f18859OooO0Oo.remove();
                OooOo00 oooOo00 = OooOo00.this;
                OooOO0.this.f18830OooO--;
                oooOo00.OooO0OO();
            }
            ...
            public OooO00o(Iterator<V> it) {
                this.f18861OooO0o0 = OooOo00.this.f18856OooO0o0;
                this.f18859OooO0Oo = it;
            }
        }
    }
}
