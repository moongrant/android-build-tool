...
public abstract class OooOOOO<E> extends AbstractCollection<E> implements o0oOO<E> {
    ...
    @CheckForNull
    @LazyInit
    public transient Set<E> f18879OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @CheckForNull
    @LazyInit
    public transient Set<o0oOO.OooO00o<E>> f18880OooO0o0;
    ...
    public Set<E> OooO0oO() {
        Set<E> set = this.f18879OooO0Oo;
        if (set != null) {
            return set;
        }
        Set<E> setOooO00o = OooO00o();
        this.f18879OooO0Oo = setOooO00o;
        return setOooO00o;
    }
    ...
    public final boolean addAll(Collection<? extends E> collection) {
        ...
        if (collection instanceof o0oOO) {
            ...
            if (o0ooo2 instanceof OooOO0O) {
                ...
                if (!oooOO0O.isEmpty()) {
                    for (int iOooO0O0 = oooOO0O.f18865OooO0o.OooO0O0(); iOooO0O0 >= 0; iOooO0O0 = oooOO0O.f18865OooO0o.OooO0oO(iOooO0O0)) {
                        o0O00000<E> o0o00000 = oooOO0O.f18865OooO0o;
                        com.google.common.base.o0OoOo0.OooO0oo(iOooO0O0, o0o00000.f19065OooO0OO);
                        Object obj = o0o00000.f19063OooO00o[iOooO0O0];
                        o0O00000<E> o0o00001 = oooOO0O.f18865OooO0o;
                        com.google.common.base.o0OoOo0.OooO0oo(iOooO0O0, o0o00001.f19065OooO0OO);
                        Oooooo(obj, o0o00001.f19064OooO0O0[iOooO0O0]);
                    }
                    return true;
                }
    ...
    public final Set<o0oOO.OooO00o<E>> entrySet() {
        Set<o0oOO.OooO00o<E>> set = this.f18880OooO0o0;
        if (set != null) {
            return set;
        }
        Set<o0oOO.OooO00o<E>> setOooO0O0 = OooO0O0();
        this.f18880OooO0o0 = setOooO0O0;
        return setOooO0O0;
    }
    ...
    @CanIgnoreReturnValue
    public boolean o00o0O(int i, @ParametricNullness Object obj) {
