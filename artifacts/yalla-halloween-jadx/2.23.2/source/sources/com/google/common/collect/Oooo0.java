...
public abstract class Oooo0<E> extends OooOOOO<E> implements oo0OOoo<E> {
    ...
    @GwtTransient
    public final Comparator<? super E> f18883OooO0o;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    @CheckForNull
    public transient Oooo000 f18884OooO0oO;

    public Oooo0(Comparator<? super E> comparator) {
        comparator.getClass();
        this.f18883OooO0o = comparator;
    }
    ...
    public final oo0OOoo<E> OoooOoo(@ParametricNullness E e, BoundType boundType, @ParametricNullness E e2, BoundType boundType2) {
        boundType.getClass();
        boundType2.getClass();
        return ((TreeMultiset) ((TreeMultiset) this).o00000OO(e, boundType)).o000000(e2, boundType2);
    }

    @Override // com.google.common.collect.oo0OOoo, com.google.common.collect.o0O0OOO0
    public final Comparator<? super E> comparator() {
        return this.f18883OooO0o;
    }
    ...
    public final oo0OOoo<E> o00Ooo() {
        Oooo000 oooo000 = this.f18884OooO0oO;
        if (oooo000 != null) {
            return oooo000;
        }
        Oooo000 oooo001 = new Oooo000(this);
        this.f18884OooO0oO = oooo001;
        return oooo001;
    }
