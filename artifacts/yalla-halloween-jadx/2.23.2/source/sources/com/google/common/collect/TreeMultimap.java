...
public class TreeMultimap<K, V> extends o000oOoO<Object, Object> {
    ...
    public transient Comparator<? super K> f18894OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public transient Comparator<? super V> f18895OooOO0O;
    ...
    private void readObject(ObjectInputStream objectInputStream) throws ClassNotFoundException, IOException {
        ...
        comparator.getClass();
        this.f18894OooOO0 = comparator;
        Comparator<? super V> comparator2 = (Comparator) objectInputStream.readObject();
        comparator2.getClass();
        this.f18895OooOO0O = comparator2;
        OooOOo(new TreeMap(this.f18894OooOO0));
    ...
    private void writeObject(ObjectOutputStream objectOutputStream) throws IOException {
        ...
        objectOutputStream.writeObject(this.f18894OooOO0);
        objectOutputStream.writeObject(this.f18895OooOO0O);
    ...
    public final Map OooO0Oo() {
        return (NavigableMap) ((SortedMap) super.OooO0Oo());
    }
    ...
    public final Collection OooOO0O() {
        return new TreeSet(this.f18895OooOO0O);
    }

    @Override // com.google.common.collect.OooOO0
    public final Collection<V> OooOO0o(@ParametricNullness K k) {
        if (k == null) {
            this.f18894OooOO0.compare(k, k);
        }
        return OooOO0O();
    }
