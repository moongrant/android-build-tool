...
public final class o0000<E> extends ImmutableSortedSet<E> {
    ...
    public final o0OO0<E> descendingIterator() {
        return this.f18918OooO.iterator();
    }
    ...
    public final ImmutableSortedSet<E> descendingSet() {
        return this.f18918OooO;
    }

    @Override // com.google.common.collect.ImmutableSortedSet
    public final ImmutableSortedSet<E> OooOo0o(E e, boolean z) {
        return this.f18918OooO.tailSet(e, z).descendingSet();
    }

    @Override // com.google.common.collect.ImmutableSortedSet
    public final ImmutableSortedSet<E> OooOoO(E e, boolean z, E e2, boolean z2) {
        return this.f18918OooO.subSet(e2, z2, e, z).descendingSet();
    }

    @Override // com.google.common.collect.ImmutableSortedSet
    public final ImmutableSortedSet<E> OooOoo(E e, boolean z) {
        return this.f18918OooO.headSet(e, z).descendingSet();
    }

    @Override // com.google.common.collect.ImmutableSortedSet, java.util.NavigableSet
    @CheckForNull
    public final E ceiling(E e) {
        return this.f18918OooO.floor(e);
    }

    @Override // com.google.common.collect.ImmutableCollection, java.util.AbstractCollection, java.util.Collection
    public final boolean contains(@CheckForNull Object obj) {
        return this.f18918OooO.contains(obj);
    }
    ...
    public final E floor(E e) {
        return this.f18918OooO.ceiling(e);
    }

    @Override // com.google.common.collect.ImmutableSortedSet, java.util.NavigableSet
    @CheckForNull
    public final E higher(E e) {
        return this.f18918OooO.lower(e);
    }

    @Override // com.google.common.collect.ImmutableSortedSet, java.util.NavigableSet
    @CheckForNull
    public final E lower(E e) {
        return this.f18918OooO.higher(e);
    }

    @Override // java.util.AbstractCollection, java.util.Collection, java.util.Set
    public final int size() {
        return this.f18918OooO.size();
    }
}
