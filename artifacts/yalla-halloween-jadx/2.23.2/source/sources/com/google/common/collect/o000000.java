...
public final class o000000<E> extends oo0o0Oo<E> {
    ...
    @CheckForNull
    public transient int[] f18923OooO;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    @CheckForNull
    public transient int[] f18924OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public transient int f18925OooOO0O;

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    public transient int f18926OooOO0o;
    ...
    public final int OooO0O0() {
        ...
        this.f18923OooO = new int[iOooO0O0];
        this.f18924OooOO0 = new int[iOooO0O0];
        return iOooO0O0;
    }
    ...
    public final LinkedHashSet OooO0OO() {
        ...
        this.f18923OooO = null;
        this.f18924OooOO0 = null;
        return linkedHashSetOooO0OO;
    }

    @Override // com.google.common.collect.oo0o0Oo
    public final int OooO0o(int i) {
        int[] iArr = this.f18924OooOO0;
    ...
    @Override // com.google.common.collect.oo0o0Oo
    public final int OooO0o0() {
        return this.f18925OooOO0O;
    }

    @Override // com.google.common.collect.oo0o0Oo
    public final void OooO0oo(int i) {
        super.OooO0oo(i);
        this.f18925OooOO0O = -2;
        this.f18926OooOO0o = -2;
    }
    ...
    public final void OooOO0(int i, int i2) {
        int size = size() - 1;
        super.OooOO0(i, i2);
        int[] iArr = this.f18923OooO;
        Objects.requireNonNull(iArr);
        OooOOOo(iArr[i] - 1, OooO0o(i));
        if (i < size) {
            int[] iArr2 = this.f18923OooO;
            Objects.requireNonNull(iArr2);
            OooOOOo(iArr2[size] - 1, i);
            OooOOOo(i, OooO0o(size));
        }
        int[] iArr3 = this.f18923OooO;
        Objects.requireNonNull(iArr3);
        iArr3[size] = 0;
        int[] iArr4 = this.f18924OooOO0;
    ...
    public final void OooOOO(int i) {
        ...
        int[] iArr = this.f18923OooO;
        Objects.requireNonNull(iArr);
        this.f18923OooO = Arrays.copyOf(iArr, i);
        int[] iArr2 = this.f18924OooOO0;
        Objects.requireNonNull(iArr2);
        this.f18924OooOO0 = Arrays.copyOf(iArr2, i);
    }

    public final void OooOOOo(int i, int i2) {
        if (i == -2) {
            this.f18925OooOO0O = i2;
        } else {
            int[] iArr = this.f18924OooOO0;
            Objects.requireNonNull(iArr);
            iArr[i] = i2 + 1;
    ...
    public final void clear() {
        ...
        this.f18926OooOO0o = -2;
        int[] iArr = this.f18923OooO;
        if (iArr != null && this.f18924OooOO0 != null) {
            Arrays.fill(iArr, 0, size(), 0);
            Arrays.fill(this.f18924OooOO0, 0, size(), 0);
        }
        super.clear();
    }
