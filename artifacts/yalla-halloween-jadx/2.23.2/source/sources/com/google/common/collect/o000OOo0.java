...
public final class o000OOo0<K, V> extends o00O00<K> {
    ...
    public final ImmutableMap<K, V> f18974OooO0oO;

    @GwtIncompatible
    public static class OooO00o<K> implements Serializable {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final ImmutableMap<K, ?> f18975OooO0Oo;

        public OooO00o(ImmutableMap<K, ?> immutableMap) {
            this.f18975OooO0Oo = immutableMap;
        }

        public Object readResolve() {
            return this.f18975OooO0Oo.keySet();
        }
    }

    public o000OOo0(ImmutableMap<K, V> immutableMap) {
        this.f18974OooO0oO = immutableMap;
    }
    ...
    public final o0OO0<K> iterator() {
        return new o000O(this.f18974OooO0oO.entrySet().iterator());
    }

    @Override // com.google.common.collect.ImmutableCollection, java.util.AbstractCollection, java.util.Collection
    public final boolean contains(@CheckForNull Object obj) {
        return this.f18974OooO0oO.containsKey(obj);
    }

    @Override // com.google.common.collect.o00O00
    public final K get(int i) {
        return this.f18974OooO0oO.entrySet().OooO00o().get(i).getKey();
    }

    @Override // java.util.AbstractCollection, java.util.Collection, java.util.Set
    public final int size() {
        return this.f18974OooO0oO.size();
    }

    @Override // com.google.common.collect.ImmutableSet, com.google.common.collect.ImmutableCollection
    @GwtIncompatible
    public Object writeReplace() {
        return new OooO00o(this.f18974OooO0oO);
    }
}
