...
public abstract class o00OOO0O<K0, V0> {
    ...
    public static final class OooO00o<V> implements com.google.common.base.o000OOo<List<V>>, Serializable {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final int f19051OooO0Oo;

        public OooO00o(int i) {
            oo000o.OooO0O0(i, "expectedValuesPerKey");
            this.f19051OooO0Oo = i;
        }

        @Override // com.google.common.base.o000OOo
        public final Object get() {
            return new ArrayList(this.f19051OooO0Oo);
        }
    }
