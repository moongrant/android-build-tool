...
public final class o0O00OO<E> extends ImmutableSortedSet<E> {
    ...
    public static final o0O00OO<Comparable> f19096OooOO0;

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    @VisibleForTesting
    public final transient ImmutableList<E> f19097OooO;

    static {
        ImmutableList.OooO0O0 oooO0O0 = ImmutableList.f18681OooO0o0;
        f19096OooOO0 = new o0O00OO<>(o0O00.f19060OooO0oo, o0O0o.f19109OooO0Oo);
    }

    public o0O00OO(ImmutableList<E> immutableList, Comparator<? super E> comparator) {
        super(comparator);
        this.f19097OooO = immutableList;
    }

    @Override // com.google.common.collect.ImmutableSet, com.google.common.collect.ImmutableCollection
    public final ImmutableList<E> OooO00o() {
        return this.f19097OooO;
    }

    @Override // com.google.common.collect.ImmutableCollection
    public final int OooO0O0(int i, Object[] objArr) {
        return this.f19097OooO.OooO0O0(i, objArr);
    }

    @Override // com.google.common.collect.ImmutableCollection
    @CheckForNull
    public final Object[] OooO0OO() {
        return this.f19097OooO.OooO0OO();
    }
    ...
    public final o0OO0<E> descendingIterator() {
        return this.f19097OooO.OooOOo0().listIterator(0);
    }

    @Override // com.google.common.collect.ImmutableSortedSet
    public final ImmutableSortedSet<E> OooOOo0() {
        Comparator comparatorReverseOrder = Collections.reverseOrder(this.f18743OooO0oO);
        return isEmpty() ? ImmutableSortedSet.OooOo00(comparatorReverseOrder) : new o0O00OO(this.f19097OooO.OooOOo0(), comparatorReverseOrder);
    }
    ...
    public final o0O00OO<E> OooOooO(int i, int i2) {
        ...
        Comparator<? super E> comparator = this.f18743OooO0oO;
        return i < i2 ? new o0O00OO<>(this.f19097OooO.subList(i, i2), comparator) : ImmutableSortedSet.OooOo00(comparator);
    }

    public final int OooOooo(E e, boolean z) {
        e.getClass();
        int iBinarySearch = Collections.binarySearch(this.f19097OooO, e, this.f18743OooO0oO);
        if (iBinarySearch >= 0) {
    ...
    public final E ceiling(E e) {
        ...
        return this.f19097OooO.get(iOooo000);
    }
    ...
    public final boolean contains(@CheckForNull Object obj) {
        ...
        try {
            return Collections.binarySearch(this.f19097OooO, obj, this.f18743OooO0oO) >= 0;
    ...
    public final E floor(E e) {
        ...
        return this.f19097OooO.get(iOooOooo);
    }
    ...
    public final int indexOf(@CheckForNull Object obj) {
        ...
        try {
            int iBinarySearch = Collections.binarySearch(this.f19097OooO, obj, this.f18743OooO0oO);
            if (iBinarySearch >= 0) {
                return iBinarySearch;
            }
            return -1;
    ...
    public final E last() {
        ...
        return this.f19097OooO.get(size() - 1);
    }
