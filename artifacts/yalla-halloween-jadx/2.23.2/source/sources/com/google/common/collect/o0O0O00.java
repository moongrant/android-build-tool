...
public final class o0O0O00 {
    public static Object OooO00o(int i) {
        if (i < 2 || i > 1073741824 || Integer.highestOneBit(i) != i) {
            throw new IllegalArgumentException(android.support.v4.media.session.OooO0OO.OooO00o(52, "must be power of 2 between 2^1 and 2^30: ", i));
        }
        if (i <= 256) {
            return new byte[i];
        }
    ...
    public static int OooO0O0(@CheckForNull Object obj, @CheckForNull Object obj2, int i, Object obj3, int[] iArr, Object[] objArr, @CheckForNull Object[] objArr2) {
        ...
        while (true) {
            int i6 = iOooO0OO2 - 1;
            int i7 = iArr[i6];
            if ((i7 & i3) == i4 && com.google.common.base.Oooo0.OooO00o(obj, objArr[i6]) && (objArr2 == null || com.google.common.base.Oooo0.OooO00o(obj2, objArr2[i6]))) {
                int i8 = i7 & i;
                if (i5 == -1) {
                    OooO0Oo(i2, i8, obj3);
                } else {
