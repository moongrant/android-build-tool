...
public abstract class o0OoOo0<R, C, V> implements o0O<R, C, V> {
    ...
    @CheckForNull
    @LazyInit
    public transient Set<o0O.OooO00o<R, C, V>> f19164OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @CheckForNull
    @LazyInit
    public transient Collection<V> f19165OooO0o0;
    ...
    public Set<o0O.OooO00o<R, C, V>> OooO00o() {
        Set<o0O.OooO00o<R, C, V>> set = this.f19164OooO0Oo;
        if (set != null) {
            return set;
        }
        Set<o0O.OooO00o<R, C, V>> setOooO0o0 = OooO0o0();
        this.f19164OooO0Oo = setOooO0o0;
        return setOooO0o0;
    }
