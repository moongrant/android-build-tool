...
public final class oo0O {
    ...
    public static class OooO<K, V> extends OooO0o<K, V> implements SortedSet<K> {
        ...
        public final Comparator<? super K> comparator() {
            return ((SortedMap) this.f19201OooO0Oo).comparator();
        }

        @Override // java.util.SortedSet
        @ParametricNullness
        public final K first() {
            return (K) ((SortedMap) this.f19201OooO0Oo).firstKey();
        }

        @Override // java.util.SortedSet
        public final SortedSet<K> headSet(@ParametricNullness K k) {
            return new OooO(((SortedMap) this.f19201OooO0Oo).headMap(k));
        }

        @Override // java.util.SortedSet
        @ParametricNullness
        public final K last() {
            return (K) ((SortedMap) this.f19201OooO0Oo).lastKey();
        }

        @Override // java.util.SortedSet
        public final SortedSet<K> subSet(@ParametricNullness K k, @ParametricNullness K k2) {
            return new OooO(((SortedMap) this.f19201OooO0Oo).subMap(k, k2));
        }

        @Override // java.util.SortedSet
        public final SortedSet<K> tailSet(@ParametricNullness K k) {
            return new OooO(((SortedMap) this.f19201OooO0Oo).tailMap(k));
        }
    }

    /* JADX WARN: Failed to restore enum class, 'enum' modifier and super class removed */
    /* JADX WARN: Unknown enum class pattern. Please report as an issue! */
    public static abstract class OooO00o implements com.google.common.base.OooOOO<Map.Entry<?, ?>, Object> {
        ...
        public final enum C0234OooO00o extends OooO00o {
            public C0234OooO00o() {
                super("KEY", 0);
            }
        ...
        static {
            C0234OooO00o c0234OooO00o = new C0234OooO00o();
            KEY = c0234OooO00o;
            OooO0O0 oooO0O0 = new OooO0O0();
            VALUE = oooO0O0;
            $VALUES = new OooO00o[]{c0234OooO00o, oooO0O0};
        }
    ...
    public static abstract class OooO0O0<K, V> extends o0O0O0Oo.OooO0OO<Map.Entry<K, V>> {
        ...
        public boolean contains(@CheckForNull Object obj) {
            ...
            if (com.google.common.base.Oooo0.OooO00o(objOooO0OO, entry.getValue())) {
    ...
    public static class OooO0o<K, V> extends o0O0O0Oo.OooO0OO<K> {
        ...
        @Weak
        public final Map<K, V> f19201OooO0Oo;

        public OooO0o(Map<K, V> map) {
            map.getClass();
            this.f19201OooO0Oo = map;
        }

        public Map<K, V> OooO0Oo() {
            return this.f19201OooO0Oo;
        }
    ...
    public static class OooOO0<K, V> extends AbstractCollection<V> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        @Weak
        public final Map<K, V> f19202OooO0Oo;

        public OooOO0(Map<K, V> map) {
            map.getClass();
            this.f19202OooO0Oo = map;
        }

        @Override // java.util.AbstractCollection, java.util.Collection
        public final void clear() {
            this.f19202OooO0Oo.clear();
        }

        @Override // java.util.AbstractCollection, java.util.Collection
        public final boolean contains(@CheckForNull Object obj) {
            return this.f19202OooO0Oo.containsValue(obj);
        }

        @Override // java.util.AbstractCollection, java.util.Collection
        public final boolean isEmpty() {
            return this.f19202OooO0Oo.isEmpty();
        }

        @Override // java.util.AbstractCollection, java.util.Collection, java.lang.Iterable
        public final Iterator<V> iterator() {
            return new o00OO00O(this.f19202OooO0Oo.entrySet().iterator());
        }
        ...
        public final boolean remove(@CheckForNull Object obj) {
            try {
                ...
                Map<K, V> map = this.f19202OooO0Oo;
                for (Map.Entry<K, V> entry : map.entrySet()) {
                    if (com.google.common.base.Oooo0.OooO00o(obj, entry.getValue())) {
        ...
        @Override // java.util.AbstractCollection, java.util.Collection
        public final int size() {
            return this.f19202OooO0Oo.size();
        }
    }
    ...
    public static abstract class OooOO0O<K, V> extends AbstractMap<K, V> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        @CheckForNull
        public transient Set<Map.Entry<K, V>> f19203OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        @CheckForNull
        public transient OooOO0 f19204OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        @CheckForNull
        public transient Set<K> f19205OooO0o0;
        ...
        @Override // java.util.AbstractMap, java.util.Map
        public final Set<Map.Entry<K, V>> entrySet() {
            Set<Map.Entry<K, V>> set = this.f19203OooO0Oo;
            if (set != null) {
                return set;
            }
            Set<Map.Entry<K, V>> setOooO00o = OooO00o();
            this.f19203OooO0Oo = setOooO00o;
            return setOooO00o;
        }

        @Override // java.util.AbstractMap, java.util.Map
        public Set<K> keySet() {
            Set<K> set = this.f19205OooO0o0;
            if (set != null) {
                return set;
            }
            Set<K> setOooO0O0 = OooO0O0();
            this.f19205OooO0o0 = setOooO0O0;
            return setOooO0O0;
        }

        @Override // java.util.AbstractMap, java.util.Map
        public final Collection<V> values() {
            OooOO0 oooOO1 = this.f19204OooO0o;
            if (oooOO1 != null) {
                return oooOO1;
            }
            OooOO0 oooOO2 = new OooOO0(this);
            this.f19204OooO0o = oooOO2;
            return oooOO2;
        }
    }
