...
public final class OooO0o extends OooO implements Serializable, OooO0O0 {
    private void readObject(ObjectInputStream objectInputStream) throws ClassNotFoundException, IOException {
        ...
        this.f19237OooO0o = 0;
        this.f19236OooO0Oo = null;
        this.f19238OooO0o0 = objectInputStream.readLong();
    }
    ...
    public final void OooO00o(long j) {
        ...
        OooO.OooO0O0[] oooO0O0Arr2 = this.f19236OooO0Oo;
        if (oooO0O0Arr2 == null) {
            long j2 = this.f19238OooO0o0;
            if (OooO0OO(j2, j2 + j)) {
                return;
            }
        }
        ThreadLocal<int[]> threadLocal = OooO.f19231OooO0oO;
        ...
        if (iArr == null) {
            ...
            iNextInt = OooO.f19232OooO0oo.nextInt();
            if (iNextInt == 0) {
                iNextInt = 1;
            }
            iArr[0] = iNextInt;
        ...
        while (true) {
            boolean z3 = false;
            while (true) {
                oooO0O0Arr = this.f19236OooO0Oo;
                if (oooO0O0Arr != null && (length = oooO0O0Arr.length) > 0) {
                    OooO.OooO0O0 oooO0O1 = oooO0O0Arr[(length - 1) & iNextInt];
                    if (oooO0O1 != null) {
                        if (zOooO00o) {
                            long j4 = oooO0O1.f19241OooO00o;
                            if (oooO0O1.OooO00o(j4, j4 + j)) {
                                return;
                            }
                            if (length < OooO.f19230OooO && this.f19236OooO0Oo == oooO0O0Arr) {
                                if (z3) {
                                    if (this.f19237OooO0o == 0 && OooO0Oo()) {
                                        break;
                                    }
                                } else {
                                    z3 = true;
                        ...
                        iNextInt = i2 ^ (i2 << 5);
                        iArr[0] = iNextInt;
                    } else if (this.f19237OooO0o == 0) {
                        OooO.OooO0O0 oooO0O2 = new OooO.OooO0O0(j);
                        if (this.f19237OooO0o == 0 && OooO0Oo()) {
                            try {
                                OooO.OooO0O0[] oooO0O0Arr3 = this.f19236OooO0Oo;
                    ...
                    iNextInt = i5 ^ (i5 << 5);
                    iArr[0] = iNextInt;
                } else if (this.f19237OooO0o == 0 && this.f19236OooO0Oo == oooO0O0Arr && OooO0Oo()) {
                    try {
                        if (this.f19236OooO0Oo == oooO0O0Arr) {
                            OooO.OooO0O0[] oooO0O0Arr4 = new OooO.OooO0O0[2];
                            oooO0O0Arr4[iNextInt & 1] = new OooO.OooO0O0(j);
                            this.f19236OooO0Oo = oooO0O0Arr4;
                            z = true;
                        } else {
                            z = false;
                        }
            ...
            try {
                if (this.f19236OooO0Oo == oooO0O0Arr) {
                    ...
                    this.f19236OooO0Oo = oooO0O0Arr5;
                }
                this.f19237OooO0o = 0;
            } catch (Throwable th3) {
                this.f19237OooO0o = 0;
    ...
    public final long OooO0o() {
        long j = this.f19238OooO0o0;
        OooO.OooO0O0[] oooO0O0Arr = this.f19236OooO0Oo;
        if (oooO0O0Arr != null) {
            for (OooO.OooO0O0 oooO0O0 : oooO0O0Arr) {
                if (oooO0O0 != null) {
                    j += oooO0O0.f19241OooO00o;
                }
            }
        }
        return j;
