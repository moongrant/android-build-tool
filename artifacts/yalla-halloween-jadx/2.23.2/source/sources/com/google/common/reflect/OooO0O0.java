...
public final class OooO0O0 {
    ...
    public final C0237OooO0O0 f19281OooO00o;

    public static final class OooO00o extends OooOO0 {

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final HashMap f19282OooO0O0 = new HashMap();
        ...
        public final void OooO0Oo(ParameterizedType parameterizedType) {
            ...
            o0OoOo0.OooOOO0(typeParameters.length == actualTypeArguments.length);
            for (int i = 0; i < typeParameters.length; i++) {
                OooO0OO oooO0OO = new OooO0OO(typeParameters[i]);
                Type type = actualTypeArguments[i];
                HashMap map = this.f19282OooO0O0;
    ...
    public static final class OooO0OO {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final TypeVariable<?> f19284OooO00o;

        public OooO0OO(TypeVariable<?> typeVariable) {
            typeVariable.getClass();
            this.f19284OooO00o = typeVariable;
        }

        public final boolean OooO00o(TypeVariable<?> typeVariable) {
            TypeVariable<?> typeVariable2 = this.f19284OooO00o;
        ...
        public final boolean equals(@CheckForNull Object obj) {
            if (obj instanceof OooO0OO) {
                return OooO00o(((OooO0OO) obj).f19284OooO00o);
            }
            return false;
        }

        public final int hashCode() {
            TypeVariable<?> typeVariable = this.f19284OooO00o;
            return Arrays.hashCode(new Object[]{typeVariable.getGenericDeclaration(), typeVariable.getName()});
        }

        public final String toString() {
            return this.f19284OooO00o.toString();
        }
    }

    public OooO0O0() {
        this.f19281OooO00o = new C0237OooO0O0();
    }
    ...
    public final Type OooO00o(Type type) {
        ...
        if (type instanceof TypeVariable) {
            ...
            C0237OooO0O0 c0237OooO0O0 = this.f19281OooO00o;
            c0237OooO0O0.getClass();
            return c0237OooO0O0.OooO00o(typeVariable, new com.google.common.reflect.OooO0OO(typeVariable, c0237OooO0O0));
        }
        ...
        o0OoOo0.OooO0o(cls.getEnclosingClass() != null, "Owner type for unenclosed %s", cls);
    ...
    public static class C0237OooO0O0 {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final ImmutableMap<OooO0OO, Type> f19283OooO00o;

        public C0237OooO0O0() {
            this.f19283OooO00o = o0OoO00O.f19150OooOO0;
        }

        public Type OooO00o(TypeVariable typeVariable, com.google.common.reflect.OooO0OO oooO0OO) {
            Type type = this.f19283OooO00o.get(new OooO0OO(typeVariable));
            if (type != null) {
            ...
            return (OooOO0O.OooO0o.f19294OooO00o && Arrays.equals(bounds, typeArrOooO0O0)) ? typeVariable : OooOO0O.OooO0OO(typeVariable.getGenericDeclaration(), typeVariable.getName(), typeArrOooO0O0);
        }

        public C0237OooO0O0(o0OoO00O o0ooo00o2) {
            this.f19283OooO00o = o0ooo00o2;
        }
    }

    public OooO0O0(C0237OooO0O0 c0237OooO0O0) {
        this.f19281OooO00o = c0237OooO0O0;
    }
}
