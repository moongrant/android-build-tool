...
public final class OooOO0O {
    ...
    public static final OooOo00 f19289OooO00o;

    public static final class OooO implements ParameterizedType, Serializable {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        @CheckForNull
        public final Type f19290OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final Class<?> f19291OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final o0O00 f19292OooO0o0;

        public OooO(@CheckForNull Type type, Class<?> cls, Type[] typeArr) {
            cls.getClass();
            o0OoOo0.OooO0Oo(typeArr.length == cls.getTypeParameters().length);
            OooOO0O.OooO00o(typeArr, "type parameter");
            this.f19290OooO0Oo = type;
            this.f19291OooO0o = cls;
            this.f19292OooO0o0 = OooO0OO.CURRENT.OooO0OO(typeArr);
        }
        ...
        public final boolean equals(@CheckForNull Object obj) {
            ...
            if (this.f19291OooO0o.equals(parameterizedType.getRawType())) {
                return Oooo0.OooO00o(this.f19290OooO0Oo, parameterizedType.getOwnerType()) && Arrays.equals(getActualTypeArguments(), parameterizedType.getActualTypeArguments());
            }
            return false;
        }
        ...
        public final Type[] getActualTypeArguments() {
            return (Type[]) this.f19292OooO0o0.toArray(new Type[0]);
        }

        @Override // java.lang.reflect.ParameterizedType
        @CheckForNull
        public final Type getOwnerType() {
            return this.f19290OooO0Oo;
        }

        @Override // java.lang.reflect.ParameterizedType
        public final Type getRawType() {
            return this.f19291OooO0o;
        }

        public final int hashCode() {
            Type type = this.f19290OooO0Oo;
            return ((type == null ? 0 : type.hashCode()) ^ this.f19292OooO0o0.hashCode()) ^ this.f19291OooO0o.hashCode();
        }
    ...
    public static abstract class OooO00o {
        ...
        public final enum C0238OooO00o extends OooO00o {
            public C0238OooO00o() {
        ...
        static {
            C0238OooO00o c0238OooO00o = new C0238OooO00o();
            OWNED_BY_ENCLOSING_CLASS = c0238OooO00o;
            OooO0O0 oooO0O0 = new OooO0O0();
            LOCAL_CLASS_HAS_NO_OWNER = oooO0O0;
            $VALUES = new OooO00o[]{c0238OooO00o, oooO0O0};
            new OooOOO();
    ...
    public static final class OooO0O0 implements GenericArrayType, Serializable {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final Type f19293OooO0Oo;

        public OooO0O0(Type type) {
            this.f19293OooO0Oo = OooO0OO.CURRENT.OooO0Oo(type);
        }
        ...
        public final boolean equals(@CheckForNull Object obj) {
            ...
            return Oooo0.OooO00o(this.f19293OooO0Oo, ((GenericArrayType) obj).getGenericComponentType());
        }

        @Override // java.lang.reflect.GenericArrayType
        public final Type getGenericComponentType() {
            return this.f19293OooO0Oo;
        }

        public final int hashCode() {
            return this.f19293OooO0Oo.hashCode();
        }

        public final String toString() {
            OooOo00 oooOo00 = OooOO0O.f19289OooO00o;
            Type type = this.f19293OooO0Oo;
    ...
    public static abstract class OooO0OO {
        ...
        public final enum C0239OooO0OO extends OooO0OO {
            public C0239OooO0OO() {
                super("JAVA8", 2);
            }
        ...
        static {
            ...
            OooO0O0 oooO0O0 = new OooO0O0();
            JAVA7 = oooO0O0;
            C0239OooO0OO c0239OooO0OO = new C0239OooO0OO();
            JAVA8 = c0239OooO0OO;
            OooO0o oooO0o = new OooO0o();
            JAVA9 = oooO0o;
            $VALUES = new OooO0OO[]{oooO00o, oooO0O0, c0239OooO0OO, oooO0o};
            if (AnnotatedElement.class.isAssignableFrom(TypeVariable.class)) {
                if (new OooO().OooO00o().toString().contains("java.util.Map.java.util.Map")) {
                    CURRENT = c0239OooO0OO;
                    return;
                } else {
                    CURRENT = oooO0o;
                    return;
    ...
    public static final class OooO0o<X> {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public static final boolean f19294OooO00o = !OooO0o.class.getTypeParameters()[0].equals(OooOO0O.OooO0OO(OooO0o.class, "X", new Type[0]));
    }

    public static final class OooOO0<D extends GenericDeclaration> {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final D f19295OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final String f19296OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final o0O00 f19297OooO0OO;

        public OooOO0(D d, String str, Type[] typeArr) {
            OooOO0O.OooO00o(typeArr, "bound for type variable");
            d.getClass();
            this.f19295OooO00o = d;
            str.getClass();
            this.f19296OooO0O0 = str;
            this.f19297OooO0OO = ImmutableList.OooOO0o(typeArr);
        }

        public final boolean equals(@CheckForNull Object obj) {
            boolean z = OooO0o.f19294OooO00o;
            D d = this.f19295OooO00o;
            String str = this.f19296OooO0O0;
            if (!z) {
            ...
            if (obj == null || !Proxy.isProxyClass(obj.getClass()) || !(Proxy.getInvocationHandler(obj) instanceof C0240OooOO0O)) {
                return false;
            }
            OooOO0<?> oooOO1 = ((C0240OooOO0O) Proxy.getInvocationHandler(obj)).f19299OooO00o;
            return str.equals(oooOO1.f19296OooO0O0) && d.equals(oooOO1.f19295OooO00o) && this.f19297OooO0OO.equals(oooOO1.f19297OooO0OO);
        }

        public final int hashCode() {
            return this.f19295OooO00o.hashCode() ^ this.f19296OooO0O0.hashCode();
        }

        public final String toString() {
            return this.f19296OooO0O0;
        }
    }

    /* JADX INFO: renamed from: com.google.common.reflect.OooOO0O$OooOO0O, reason: collision with other inner class name */
    public static final class C0240OooOO0O implements InvocationHandler {

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public static final o0OoO00O f19298OooO0O0;

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final OooOO0<?> f19299OooO00o;
        ...
        static {
            ...
            f19298OooO0O0 = OooO00o2.OooO00o(false);
        }

        public C0240OooOO0O(OooOO0<?> oooOO1) {
            this.f19299OooO00o = oooOO1;
        }
        ...
        public final Object invoke(Object obj, Method method, @CheckForNull Object[] objArr) throws Throwable {
            ...
            Method method2 = (Method) f19298OooO0O0.get(name);
            if (method2 == null) {
                throw new UnsupportedOperationException(name);
            }
            try {
                return method2.invoke(this.f19299OooO00o, objArr);
    ...
    public static final class OooOOO0 implements WildcardType, Serializable {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final o0O00 f19300OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final o0O00 f19301OooO0o0;
        ...
        public OooOOO0(Type[] typeArr, Type[] typeArr2) {
            ...
            OooO0OO oooO0OO = OooO0OO.CURRENT;
            this.f19300OooO0Oo = oooO0OO.OooO0OO(typeArr);
            this.f19301OooO0o0 = oooO0OO.OooO0OO(typeArr2);
        }

        public final boolean equals(@CheckForNull Object obj) {
            if (obj instanceof WildcardType) {
                WildcardType wildcardType = (WildcardType) obj;
                if (this.f19300OooO0Oo.equals(Arrays.asList(wildcardType.getLowerBounds()))) {
                    if (this.f19301OooO0o0.equals(Arrays.asList(wildcardType.getUpperBounds()))) {
                        return true;
                    }
                }
            }
        ...
        public final Type[] getLowerBounds() {
            OooOo00 oooOo00 = OooOO0O.f19289OooO00o;
            return (Type[]) this.f19300OooO0Oo.toArray(new Type[0]);
        }

        @Override // java.lang.reflect.WildcardType
        public final Type[] getUpperBounds() {
            OooOo00 oooOo00 = OooOO0O.f19289OooO00o;
            return (Type[]) this.f19301OooO0o0.toArray(new Type[0]);
        }

        public final int hashCode() {
            return this.f19300OooO0Oo.hashCode() ^ this.f19301OooO0o0.hashCode();
        }

        public final String toString() {
            StringBuilder sb = new StringBuilder("?");
            ImmutableList.OooO0O0 oooO0O0ListIterator = this.f19300OooO0Oo.listIterator(0);
            ...
            OooOo00 oooOo00 = OooOO0O.f19289OooO00o;
            oo000o oo000oVar = new oo000o(new o00Ooo());
            o0O00 o0o01 = this.f19301OooO0o0;
            o0o01.getClass();
            Iterator<Object> it = new o00O00O(o0o01, oo000oVar).iterator();
            while (true) {
    ...
    static {
        ...
        f19289OooO00o = new OooOo00(oooOo, oooOo);
    }
    ...
    public static void OooO00o(Type[] typeArr, String str) {
        for (Type type : typeArr) {
            if (type instanceof Class) {
                Class cls = (Class) type;
                o0OoOo0.OooO0oO(!cls.isPrimitive(), "Primitive type '%s' used as %s", cls, str);
            }
        }
    }
    ...
    public static Type OooO0O0(Type type) {
        ...
        o0OoOo0.OooO0o0(lowerBounds.length <= 1, "Wildcard cannot have more than one lower bounds.");
        if (lowerBounds.length == 1) {
            return new OooOOO0(new Type[]{OooO0O0(lowerBounds[0])}, new Type[]{Object.class});
        }
        Type[] upperBounds = wildcardType.getUpperBounds();
        o0OoOo0.OooO0o0(upperBounds.length == 1, "Wildcard should have only one upper bound.");
    ...
    public static <D extends GenericDeclaration> TypeVariable<D> OooO0OO(D d, String str, Type... typeArr) {
        ...
        C0240OooOO0O c0240OooOO0O = new C0240OooOO0O(new OooOO0(d, str, typeArr));
        o0OoOo0.OooO0o(TypeVariable.class.isInterface(), "%s is not an interface", TypeVariable.class);
        return (TypeVariable) TypeVariable.class.cast(Proxy.newProxyInstance(TypeVariable.class.getClassLoader(), new Class[]{TypeVariable.class}, c0240OooOO0O));
    }
}
