...
public final class o00oO0o implements Closeable {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final URL f19903OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @Nullable
    public Task<Bitmap> f19904OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @Nullable
    public volatile Future<?> f19905OooO0o0;

    public o00oO0o(URL url) {
        this.f19903OooO0Oo = url;
    }

    public final Bitmap OooO00o() throws IOException {
        boolean zIsLoggable = Log.isLoggable("FirebaseMessaging", 4);
        URL url = this.f19903OooO0Oo;
        if (zIsLoggable) {
    ...
    public final void close() {
        this.f19905OooO0o0.cancel(true);
    }
}
