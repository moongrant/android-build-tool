...
public enum ToNumberPolicy implements o0ooOOo {
    ...
    LONG_OR_DOUBLE { // from class: com.google.gson.ToNumberPolicy.OooO0OO
        ...
        public final Number OooO00o(JsonReader jsonReader) throws JsonParseException, IOException {
            ...
            try {
                ...
                StringBuilder sbOooO0O0 = p004OooO0oO.o0OoOo0.OooO0O0("Cannot parse ", strNextString, "; at path ");
                sbOooO0O0.append(jsonReader.getPreviousPath());
                throw new JsonParseException(sbOooO0O0.toString(), e);
            }
        }
    },
