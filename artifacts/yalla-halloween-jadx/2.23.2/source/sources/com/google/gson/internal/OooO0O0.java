...
public final class OooO0O0 {
    ...
    public static final Type[] f20153OooO00o = new Type[0];

    public static final class OooO00o implements GenericArrayType, Serializable {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final Type f20154OooO0Oo;

        public OooO00o(Type type) {
            this.f20154OooO0Oo = OooO0O0.OooO00o(type);
        }
        ...
        public final int hashCode() {
            return this.f20154OooO0Oo.hashCode();
        }

        public final String toString() {
            return OooO0O0.OooO(this.f20154OooO0Oo) + "[]";
        }
    }

    /* JADX INFO: renamed from: com.google.gson.internal.OooO0O0$OooO0O0, reason: collision with other inner class name */
    public static final class C0258OooO0O0 implements ParameterizedType, Serializable {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final Type f20155OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final Type[] f20156OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final Type f20157OooO0o0;

        public C0258OooO0O0(Type type, Type type2, Type... typeArr) {
            ...
            this.f20155OooO0Oo = type == null ? null : OooO0O0.OooO00o(type);
            this.f20157OooO0o0 = OooO0O0.OooO00o(type2);
            Type[] typeArr2 = (Type[]) typeArr.clone();
            this.f20156OooO0o = typeArr2;
            int length = typeArr2.length;
            for (int i = 0; i < length; i++) {
                this.f20156OooO0o[i].getClass();
                OooO0O0.OooO0O0(this.f20156OooO0o[i]);
                Type[] typeArr3 = this.f20156OooO0o;
        ...
        public final Type[] getActualTypeArguments() {
            return (Type[]) this.f20156OooO0o.clone();
        }
        ...
        public final int hashCode() {
            int iHashCode = Arrays.hashCode(this.f20156OooO0o) ^ this.f20157OooO0o0.hashCode();
            Type type = this.f20155OooO0Oo;
            return iHashCode ^ (type != null ? type.hashCode() : 0);
        }

        public final String toString() {
            Type[] typeArr = this.f20156OooO0o;
            int length = typeArr.length;
            Type type = this.f20157OooO0o0;
            if (length == 0) {
    ...
    public static final class OooO0OO implements WildcardType, Serializable {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final Type f20158OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final Type f20159OooO0o0;
        ...
        public OooO0OO(Type[] typeArr, Type[] typeArr2) {
            ...
            if (typeArr2.length != 1) {
                ...
                this.f20159OooO0o0 = null;
                this.f20158OooO0Oo = OooO0O0.OooO00o(typeArr[0]);
                return;
            }
            typeArr2[0].getClass();
            OooO0O0.OooO0O0(typeArr2[0]);
            com.google.gson.internal.OooO00o.OooO00o(typeArr[0] == Object.class);
            this.f20159OooO0o0 = OooO0O0.OooO00o(typeArr2[0]);
            this.f20158OooO0Oo = Object.class;
        }
        ...
        public final Type[] getLowerBounds() {
            Type type = this.f20159OooO0o0;
            return type != null ? new Type[]{type} : OooO0O0.f20153OooO00o;
        }

        @Override // java.lang.reflect.WildcardType
        public final Type[] getUpperBounds() {
            return new Type[]{this.f20158OooO0Oo};
        }

        public final int hashCode() {
            Type type = this.f20159OooO0o0;
            return (type != null ? type.hashCode() + 31 : 1) ^ (this.f20158OooO0Oo.hashCode() + 31);
        }
    ...
    public static Type OooO00o(Type type) {
        ...
        if (type instanceof ParameterizedType) {
            ...
            return new C0258OooO0O0(parameterizedType.getOwnerType(), parameterizedType.getRawType(), parameterizedType.getActualTypeArguments());
        }
            ...
            if (!(type2 instanceof TypeVariable)) {
                if (!(type2 instanceof Class)) {
                    if (type2 instanceof GenericArrayType) {
                        if (type2 instanceof ParameterizedType) {
                            ...
                            if (lowerBounds.length == 1) {
                                ...
                                type2 = new OooO0OO(upperBounds2, f20153OooO00o);
                                break;
                            }
                        ...
                        c0258OooO0O0 = new C0258OooO0O0(typeOooO0oo3, type2.getRawType(), actualTypeArguments);
                        type2 = c0258OooO0O0;
                        break;
                    }
                    ...
                    if (OooO0OO(genericComponentType, typeOooO0oo5)) {
                        c0258OooO0O0 = new OooO00o(typeOooO0oo5);
                        type2 = c0258OooO0O0;
                        break;
                    }
                    break;
                ...
                if (!OooO0OO(componentType, typeOooO0oo6)) {
                    c0258OooO0O0 = new OooO00o(typeOooO0oo6);
                    type2 = c0258OooO0O0;
                    break;
                }
                type2 = cls2;
