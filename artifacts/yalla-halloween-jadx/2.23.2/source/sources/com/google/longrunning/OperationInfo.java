...
public final class OperationInfo extends GeneratedMessageV3 implements MessageOrBuilder {
    ...
    public static final OperationInfo f20325OooO0oO = new OperationInfo();

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public static final OooO00o f20326OooO0oo = new OooO00o();

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public volatile Object f20327OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public byte f20328OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public volatile Object f20329OooO0o0;
    ...
    public static final class OooO0O0 extends GeneratedMessageV3.Builder<OooO0O0> implements MessageOrBuilder {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public Object f20330OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public Object f20331OooO0o0;

        public OooO0O0() {
            this.f20330OooO0Oo = "";
            this.f20331OooO0o0 = "";
            OperationInfo operationInfo = OperationInfo.f20325OooO0oO;
        }
        ...
        public final OperationInfo buildPartial() {
            ...
            operationInfo.f20327OooO0Oo = this.f20330OooO0Oo;
            operationInfo.f20329OooO0o0 = this.f20331OooO0o0;
            onBuilt();
        ...
        public final void OooO0o(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws Throwable {
            ...
            try {
                try {
                    OperationInfo.f20326OooO0oo.getClass();
        ...
        public final void OooO0o0(OperationInfo operationInfo) {
            if (operationInfo == OperationInfo.f20325OooO0oO) {
                return;
            }
            if (!operationInfo.OooO0OO().isEmpty()) {
                this.f20330OooO0Oo = operationInfo.f20327OooO0Oo;
                onChanged();
            }
            if (!operationInfo.OooO0O0().isEmpty()) {
                this.f20331OooO0o0 = operationInfo.f20329OooO0o0;
                onChanged();
            }
            onChanged();
        }
        ...
        public final Message getDefaultInstanceForType() {
            return OperationInfo.f20325OooO0oO;
        }

        @Override // com.google.protobuf.GeneratedMessageV3.Builder, com.google.protobuf.Message.Builder, com.google.protobuf.MessageOrBuilder
        public final Descriptors.Descriptor getDescriptorForType() {
            return o0O0O00.f42091OooOOOO;
        }

        @Override // com.google.protobuf.GeneratedMessageV3.Builder
        public final GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return o0O0O00.f42092OooOOOo.ensureFieldAccessorsInitialized(OperationInfo.class, OooO0O0.class);
        }
    ...
    public OperationInfo(GeneratedMessageV3.Builder<?> builder) {
        super(builder);
        this.f20328OooO0o = (byte) -1;
    }

    public final String OooO0O0() {
        Object obj = this.f20329OooO0o0;
        if (obj instanceof String) {
            return (String) obj;
        }
        String stringUtf8 = ((ByteString) obj).toStringUtf8();
        this.f20329OooO0o0 = stringUtf8;
        return stringUtf8;
    }

    public final String OooO0OO() {
        Object obj = this.f20327OooO0Oo;
        if (obj instanceof String) {
            return (String) obj;
        }
        String stringUtf8 = ((ByteString) obj).toStringUtf8();
        this.f20327OooO0Oo = stringUtf8;
        return stringUtf8;
    }
    ...
    public final int getSerializedSize() {
        ...
        int iComputeStringSize = GeneratedMessageV3.isStringEmpty(this.f20327OooO0Oo) ? 0 : 0 + GeneratedMessageV3.computeStringSize(1, this.f20327OooO0Oo);
        if (!GeneratedMessageV3.isStringEmpty(this.f20329OooO0o0)) {
            iComputeStringSize += GeneratedMessageV3.computeStringSize(2, this.f20329OooO0o0);
        }
    ...
    public final int hashCode() {
        ...
        int iHashCode = this.unknownFields.hashCode() + ((OooO0O0().hashCode() + ((((OooO0OO().hashCode() + o0O0O0Oo.OooO00o.OooO00o(o0O0O00.f42091OooOOOO, 779, 37, 1, 53)) * 37) + 2) * 53)) * 29);
    ...
    public final Message.Builder newBuilderForType() {
        return f20325OooO0oO.toBuilder();
    }
    ...
    public final void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        if (!GeneratedMessageV3.isStringEmpty(this.f20327OooO0Oo)) {
            GeneratedMessageV3.writeString(codedOutputStream, 1, this.f20327OooO0Oo);
        }
        if (!GeneratedMessageV3.isStringEmpty(this.f20329OooO0o0)) {
            GeneratedMessageV3.writeString(codedOutputStream, 2, this.f20329OooO0o0);
        }
            ...
            try {
                try {
                    try {
                        ...
                        if (tag != 0) {
                            if (tag == 10) {
                                this.f20327OooO0Oo = codedInputStream.readStringRequireUtf8();
                            } else if (tag != 18) {
                                if (!parseUnknownField(codedInputStream, builderNewBuilder, extensionRegistryLite, tag)) {
                                }
                            } else {
                                this.f20329OooO0o0 = codedInputStream.readStringRequireUtf8();
                            }
                        }
                        z = true;
                    } catch (InvalidProtocolBufferException e) {
