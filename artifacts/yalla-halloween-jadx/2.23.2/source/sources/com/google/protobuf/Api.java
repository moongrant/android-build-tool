...
public final class Api extends GeneratedMessageV3 implements ApiOrBuilder {
    ...
    public int hashCode() {
        ...
        if (getMethodsCount() > 0) {
            iHashCode = getMethodsList().hashCode() + o00Ooo.OooO00o(iHashCode, 37, 2, 53);
        }
        if (getOptionsCount() > 0) {
            iHashCode = getOptionsList().hashCode() + o00Ooo.OooO00o(iHashCode, 37, 3, 53);
        }
        int iHashCode2 = getVersion().hashCode() + o00Ooo.OooO00o(iHashCode, 37, 4, 53);
        if (hasSourceContext()) {
            iHashCode2 = getSourceContext().hashCode() + o00Ooo.OooO00o(iHashCode2, 37, 5, 53);
        }
        if (getMixinsCount() > 0) {
            iHashCode2 = getMixinsList().hashCode() + o00Ooo.OooO00o(iHashCode2, 37, 6, 53);
        }
        int iHashCode3 = getUnknownFields().hashCode() + ((o00Ooo.OooO00o(iHashCode2, 37, 7, 53) + this.syntax_) * 29);
