...
public class RepeatedFieldBuilderV3<MType extends AbstractMessage, BType extends AbstractMessage.Builder, IType extends MessageOrBuilder> implements AbstractMessage.BuilderParent {
    ...
    private List<MType> f20343messages;
    ...
    private void ensureBuilders() {
        if (this.builders == null) {
            this.builders = new ArrayList(this.f20343messages.size());
            for (int i = 0; i < this.f20343messages.size(); i++) {
    ...
    private void ensureMutableMessageList() {
        ...
        this.f20343messages = new ArrayList(this.f20343messages);
    ...
    public RepeatedFieldBuilderV3<MType, BType, IType> addAllMessages(Iterable<? extends MType> iterable) {
        ...
        if (size >= 0) {
            List<MType> list = this.f20343messages;
    ...
    public List<MType> build() {
        ...
        if (!z2 && this.builders == null) {
            return this.f20343messages;
        }
        if (!z2) {
            int i = 0;
            while (true) {
                if (i >= this.f20343messages.size()) {
                    z = true;
                    break;
                }
                MType mtype = this.f20343messages.get(i);
        ...
        ensureMutableMessageList();
        for (int i2 = 0; i2 < this.f20343messages.size(); i2++) {
            this.f20343messages.set(i2, (MType) getMessage(i2, true));
        }
        List<MType> listUnmodifiableList = Collections.unmodifiableList(this.f20343messages);
        this.f20343messages = listUnmodifiableList;
        this.isMessagesListMutable = false;
        return listUnmodifiableList;
    }

    public void clear() {
        this.f20343messages = Collections.emptyList();
        this.isMessagesListMutable = false;
        List<SingleFieldBuilderV3<MType, BType, IType>> list = this.builders;
        if (list != null) {
    ...
    public BType getBuilder(int i) {
        ...
        SingleFieldBuilderV3<MType, BType, IType> singleFieldBuilderV3 = this.builders.get(i);
        if (singleFieldBuilderV3 == null) {
            SingleFieldBuilderV3<MType, BType, IType> singleFieldBuilderV4 = new SingleFieldBuilderV3<>(this.f20343messages.get(i), this, this.isClean);
    ...
    public int getCount() {
        return this.f20343messages.size();
    }
    ...
    public IType getMessageOrBuilder(int i) {
        List<SingleFieldBuilderV3<MType, BType, IType>> list = this.builders;
        if (list == null) {
            return this.f20343messages.get(i);
        }
        SingleFieldBuilderV3<MType, BType, IType> singleFieldBuilderV3 = list.get(i);
        return singleFieldBuilderV3 == null ? this.f20343messages.get(i) : (IType) singleFieldBuilderV3.getMessageOrBuilder();
    }
    ...
    public boolean isEmpty() {
        return this.f20343messages.isEmpty();
    }
    ...
    public RepeatedFieldBuilderV3<MType, BType, IType> setMessage(int i, MType mtype) {
        ...
        Internal.checkNotNull(mtype);
        ensureMutableMessageList();
        this.f20343messages.set(i, mtype);
        List<SingleFieldBuilderV3<MType, BType, IType>> list = this.builders;
    ...
    public RepeatedFieldBuilderV3<MType, BType, IType> addMessage(int i, MType mtype) {
        Internal.checkNotNull(mtype);
        ensureMutableMessageList();
        this.f20343messages.add(i, mtype);
        List<SingleFieldBuilderV3<MType, BType, IType>> list = this.builders;
        if (list != null) {
            list.add(i, null);
        }
    ...
    public BType addBuilder(int i, MType mtype) {
        ...
        ensureBuilders();
        SingleFieldBuilderV3<MType, BType, IType> singleFieldBuilderV3 = new SingleFieldBuilderV3<>(mtype, this, this.isClean);
        this.f20343messages.add(i, null);
