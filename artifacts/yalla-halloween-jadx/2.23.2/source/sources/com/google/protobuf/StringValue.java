...
public final class StringValue extends GeneratedMessageV3 implements StringValueOrBuilder {
    ...
    public int getSerializedSize() {
        ...
        int serializedSize = getUnknownFields().getSerializedSize() + (GeneratedMessageV3.isStringEmpty(this.value_) ? 0 : 0 + GeneratedMessageV3.computeStringSize(1, this.value_));
