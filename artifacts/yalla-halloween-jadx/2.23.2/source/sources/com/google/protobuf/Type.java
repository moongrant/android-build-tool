...
public final class Type extends GeneratedMessageV3 implements TypeOrBuilder {
    ...
    public int getSerializedSize() {
        ...
        for (int i3 = 0; i3 < this.oneofs_.size(); i3++) {
            iOooO00o = o000O0o.OooO00o(this.oneofs_, i3, iOooO00o);
        }
        int size = (getOneofsList().size() * 1) + iComputeStringSize + iOooO00o;
    ...
    public int hashCode() {
        ...
        if (getFieldsCount() > 0) {
            iHashCode = getFieldsList().hashCode() + o00Ooo.OooO00o(iHashCode, 37, 2, 53);
        }
        if (getOneofsCount() > 0) {
            iHashCode = getOneofsList().hashCode() + o00Ooo.OooO00o(iHashCode, 37, 3, 53);
        }
        if (getOptionsCount() > 0) {
            iHashCode = getOptionsList().hashCode() + o00Ooo.OooO00o(iHashCode, 37, 4, 53);
        }
        if (hasSourceContext()) {
            iHashCode = getSourceContext().hashCode() + o00Ooo.OooO00o(iHashCode, 37, 5, 53);
        }
        int iHashCode2 = getUnknownFields().hashCode() + ((o00Ooo.OooO00o(iHashCode, 37, 6, 53) + this.syntax_) * 29);
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        ...
        while (iOooO00o < this.oneofs_.size()) {
            iOooO00o = OooO0O0.OooO00o(this.oneofs_, iOooO00o, codedOutputStream, 3, iOooO00o, 1);
        }
