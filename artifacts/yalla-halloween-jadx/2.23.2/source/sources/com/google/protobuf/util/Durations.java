...
public final class Durations {
    ...
    public static Duration add(Duration duration, Duration duration2) {
        ...
        long jOooO00o = OooO0O0.OooO00o(duration.getSeconds(), duration2.getSeconds());
    ...
    public static Duration checkNotNegative(Duration duration) {
        o0OoOo0.OooO0o(!isNegative(duration), "duration (%s) must not be negative", toString(duration));
        return duration;
    }

    @CanIgnoreReturnValue
    public static Duration checkPositive(Duration duration) {
        o0OoOo0.OooO0o(isPositive(duration), "duration (%s) must be positive", toString(duration));
        return duration;
    }
    ...
    public static Duration fromDays(long j) {
        return Duration.newBuilder().setSeconds(OooO0O0.OooO0O0(j, SECONDS_PER_DAY)).setNanos(0).build();
    }

    public static Duration fromHours(long j) {
        return Duration.newBuilder().setSeconds(OooO0O0.OooO0O0(j, SECONDS_PER_HOUR)).setNanos(0).build();
    }
    ...
    public static Duration fromMinutes(long j) {
        return Duration.newBuilder().setSeconds(OooO0O0.OooO0O0(j, SECONDS_PER_MINUTE)).setNanos(0).build();
    }
    ...
    public static Duration normalizedDuration(long j, int i) {
        ...
        if (j2 <= -1000000000 || j2 >= MathMethodsKt.NANOS_PER_SECOND) {
            j = OooO0O0.OooO00o(j, j2 / MathMethodsKt.NANOS_PER_SECOND);
    ...
    public static Duration subtract(Duration duration, Duration duration2) {
        checkValid(duration);
        checkValid(duration2);
        return normalizedDuration(OooO0O0.OooO0OO(duration.getSeconds(), duration2.getSeconds()), OooO00o.OooO00o(duration.getNanos(), duration2.getNanos()));
    }
    ...
    public static long toMicros(Duration duration) {
        checkValid(duration);
        return OooO0O0.OooO00o(OooO0O0.OooO0O0(duration.getSeconds(), AnimationKt.MillisToNanos), ((long) duration.getNanos()) / 1000);
    }

    public static long toMillis(Duration duration) {
        checkValid(duration);
        return OooO0O0.OooO00o(OooO0O0.OooO0O0(duration.getSeconds(), 1000L), ((long) duration.getNanos()) / AnimationKt.MillisToNanos);
    }
    ...
    public static long toNanos(Duration duration) {
        checkValid(duration);
        return OooO0O0.OooO00o(OooO0O0.OooO0O0(duration.getSeconds(), MathMethodsKt.NANOS_PER_SECOND), duration.getNanos());
    }
