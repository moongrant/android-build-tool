...
final class l111l11111lIl {
    ...
    public static byte[] l111l11111lIl(ByteBuffer byteBuffer) {
        ...
        StringBuilder sbOooO0O0 = o0000O0.OooO0O0("Underflow while reading length-prefixed value. Length: ", i, ", available: ");
        sbOooO0O0.append(byteBuffer.remaining());
    ...
    public static ByteBuffer l1111l111111Il(ByteBuffer byteBuffer) {
        ...
        StringBuilder sbOooO0O0 = o0000O0.OooO0O0("Length-prefixed field longer than remaining buffer. Field length: ", i, ", remaining: ");
        sbOooO0O0.append(byteBuffer.remaining());
        throw new IOException(sbOooO0O0.toString());
    }
    ...
    private static ByteBuffer l1111l111111Il(ByteBuffer byteBuffer, int i, int i2) {
        ...
        if (i2 > byteBuffer.capacity()) {
            throw new IllegalArgumentException(OooO0O0.OooO0O0("end > capacity: ", i2, " > ", iCapacity));
        }
        int iLimit = byteBuffer.limit();
        int iPosition = byteBuffer.position();
        try {
