...
public class l1111l111111Il {
    ...
    private void l111l11111Il() {
        HashSet hashSet = new HashSet(this.l111l1111lI1l.getStringSet(l111l11111Il, new HashSet()));
        hashSet.add(String.valueOf(System.currentTimeMillis()));
        com.ishumei.l111l1111llIl.l111l1111llIl.l1111l111111Il(this.l111l1111lI1l, l111l11111Il, hashSet);
    }
    ...
    private void l111l1111l1Il() {
        try {
            this.l111l1111lIl = new ArrayList(this.l111l1111lI1l.getStringSet(l111l11111Il, new HashSet()));
            com.ishumei.l111l1111llIl.l111l1111llIl.l1111l111111Il(this.l111l1111lI1l, l111l11111lIl, System.currentTimeMillis());
            com.ishumei.l111l1111llIl.l111l1111llIl.l1111l111111Il(this.l111l1111lI1l, l111l11111Il, new HashSet());
    ...
    public static l1111l111111Il l1111l111111Il() {
        return C0269l1111l111111Il.l1111l111111Il;
    }
    ...
    public final synchronized boolean l111l11111lIl() {
        try {
            ...
            int size = this.l111l1111lI1l.getStringSet(l111l11111Il, new HashSet()).size();
            int i2 = i >> 20;
            if (i2 > 100) {
                i2 = 100;
            }
