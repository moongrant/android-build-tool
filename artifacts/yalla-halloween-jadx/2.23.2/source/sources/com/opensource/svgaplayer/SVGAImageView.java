...
public class SVGAImageView extends ImageView {
    ...
    public static final /* synthetic */ int f20786OooOOo0 = 0;
    ...
    @NotNull
    public final String f20788OooO0Oo;
    ...
    @Nullable
    public ValueAnimator f20793OooOO0;

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public boolean f20794OooOO0O;

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    public boolean f20795OooOO0o;

    /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
    @NotNull
    public final OooO0O0 f20796OooOOO;

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    @NotNull
    public final OooO00o f20797OooOOO0;

    /* JADX INFO: renamed from: OooOOOO, reason: collision with root package name */
    public int f20798OooOOOO;

    /* JADX INFO: renamed from: OooOOOo, reason: collision with root package name */
    public int f20799OooOOOo;
    ...
    public static final class OooO00o implements Animator.AnimatorListener {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        @NotNull
        public final WeakReference<SVGAImageView> f20800OooO0Oo;

        public OooO00o(@NotNull SVGAImageView view) {
            Intrinsics.checkNotNullParameter(view, "view");
            this.f20800OooO0Oo = new WeakReference<>(view);
        }

        @Override // android.animation.Animator.AnimatorListener
        public final void onAnimationCancel(@NotNull Animator animation) {
            Intrinsics.checkNotNullParameter(animation, "animation");
            if (this.f20800OooO0Oo.get() == null) {
                return;
            }
        ...
        public final void onAnimationEnd(@NotNull Animator animation) {
            Intrinsics.checkNotNullParameter(animation, "animation");
            SVGAImageView sVGAImageView = this.f20800OooO0Oo.get();
    ...
    public static final class OooO0O0 implements ValueAnimator.AnimatorUpdateListener {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        @NotNull
        public final WeakReference<SVGAImageView> f20801OooO0Oo;

        public OooO0O0(@NotNull SVGAImageView view) {
            Intrinsics.checkNotNullParameter(view, "view");
            this.f20801OooO0Oo = new WeakReference<>(view);
        }

        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
        public final void onAnimationUpdate(@NotNull ValueAnimator animation) {
            Intrinsics.checkNotNullParameter(animation, "animation");
            SVGAImageView sVGAImageView = this.f20801OooO0Oo.get();
            if (sVGAImageView != null) {
    ...
    public static void OooO00o(SVGAImageView this$0, o00Ooo videoItem) {
        ...
        videoItem.f42405OooO0O0 = this$0.f20794OooOO0O;
        ...
        if (sVGADrawable != null) {
            ...
            sVGADrawable.f42359OooO0o0 = scaleType;
        }
        if (this$0.f20795OooOO0o) {
            this$0.OooO0Oo();
        }
    }
    ...
    public static final void OooO0O0(SVGAImageView sVGAImageView) {
        ...
        if (sVGADrawable != null) {
            ...
            if (i == 1) {
                int i2 = sVGAImageView.f20798OooOOOO;
                if (sVGADrawable.f42357OooO0Oo != i2) {
                    sVGADrawable.f42357OooO0Oo = i2;
                    sVGADrawable.invalidateSelf();
                }
            } else if (i == 2) {
                int i3 = sVGAImageView.f20799OooOOOo;
                if (sVGADrawable.f42357OooO0Oo != i3) {
                    sVGADrawable.f42357OooO0Oo = i3;
                    sVGADrawable.invalidateSelf();
                }
            } else if (i == 3) {
    ...
    public static final void OooO0OO(SVGAImageView sVGAImageView, ValueAnimator valueAnimator) {
        ...
        if (sVGADrawable.f42357OooO0Oo != iIntValue) {
            sVGADrawable.f42357OooO0Oo = iIntValue;
            sVGADrawable.invalidateSelf();
        }
        int i = sVGADrawable.f42357OooO0Oo;
        int i2 = sVGADrawable.f42354OooO00o.f42408OooO0o;
        o0OO0O0O.OooO0OO oooO0OO = sVGAImageView.callback;
        if (oooO0OO != null) {
            oooO0OO.OooO0OO(i);
        }
    ...
    public final void OooO0Oo() {
        ...
        if (sVGADrawable2 != null) {
            ...
            Intrinsics.checkNotNullExpressionValue(scaleType, "scaleType");
            Intrinsics.checkNotNullParameter(scaleType, "<set-?>");
            sVGADrawable2.f42359OooO0o0 = scaleType;
        }
        this.f20798OooOOOO = Math.max(0, 0);
        o00Ooo o00ooo2 = sVGADrawable.f42354OooO00o;
        int iMin = Math.min(o00ooo2.f42408OooO0o - 1, 2147483646);
        this.f20799OooOOOo = iMin;
        ValueAnimator valueAnimatorOfInt = ValueAnimator.ofInt(this.f20798OooOOOO, iMin);
        valueAnimatorOfInt.setInterpolator(new LinearInterpolator());
        double d = (1000 / o00ooo2.f42409OooO0o0) * ((this.f20799OooOOOo - this.f20798OooOOOO) + 1);
        double d2 = 1.0d;
        try {
        ...
        valueAnimatorOfInt.addUpdateListener(this.f20796OooOOO);
        valueAnimatorOfInt.addListener(this.f20797OooOOO0);
        valueAnimatorOfInt.start();
        this.f20793OooOO0 = valueAnimatorOfInt;
    }
    ...
    public final void OooO0o0() {
        ...
        o0OO0O0O.OooO sVGADrawable = getSVGADrawable();
        if (sVGADrawable == null || sVGADrawable.f42357OooO0Oo == 0) {
            return;
        }
        sVGADrawable.f42357OooO0Oo = 0;
        sVGADrawable.invalidateSelf();
    }

    public final void OooO0oO(boolean z) {
        ValueAnimator valueAnimator = this.f20793OooOO0;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        ValueAnimator valueAnimator2 = this.f20793OooOO0;
        if (valueAnimator2 != null) {
            valueAnimator2.removeAllListeners();
        }
        ValueAnimator valueAnimator3 = this.f20793OooOO0;
        ...
        if (sVGADrawable != null) {
            o00Ooo o00ooo2 = sVGADrawable.f42354OooO00o;
            Iterator<T> it = o00ooo2.f42411OooO0oo.iterator();
            while (it.hasNext()) {
                Integer num = ((p333o0OO0Ooo.OooO0o) it.next()).f42425OooO0Oo;
                if (num != null) {
                    int iIntValue = num.intValue();
                    o0OoOo0.f42417OooO00o.getClass();
                    SoundPool soundPool = o00ooo2.f42403OooO;
                    if (soundPool != null) {
    ...
    public void onDetachedFromWindow() {
        ...
        if (this.clearsAfterDetached) {
            ...
            o0OO0O0O.OooO sVGADrawable2 = getSVGADrawable();
            if (sVGADrawable2 != null) {
                o00Ooo o00ooo2 = sVGADrawable2.f42354OooO00o;
                for (p333o0OO0Ooo.OooO0o oooO0o : o00ooo2.f42411OooO0oo) {
                    Integer num = oooO0o.f42425OooO0Oo;
                    if (num != null) {
                        int iIntValue = num.intValue();
                        o0OoOo0.f42417OooO00o.getClass();
                        SoundPool soundPool = o00ooo2.f42403OooO;
                    ...
                    oooO0o.f42425OooO0Oo = null;
                }
                o0OoOo0.f42417OooO00o.getClass();
                SoundPool soundPool2 = o00ooo2.f42403OooO;
                if (soundPool2 != null) {
                    soundPool2.release();
                }
                o00ooo2.f42403OooO = null;
                o00ooo2.f42411OooO0oo = CollectionsKt.emptyList();
                o00ooo2.f42410OooO0oO = CollectionsKt.emptyList();
                o00ooo2.f42412OooOO0.clear();
            }
    ...
    public final boolean onTouchEvent(@Nullable MotionEvent motionEvent) {
        ...
        for (Map.Entry<String, int[]> entry : sVGADrawable.f42355OooO0O0.f42368OooO0oo.entrySet()) {
            entry.getKey();
    ...
    public SVGAImageView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        this.f20788OooO0Oo = "SVGAImageView";
        FillMode fillMode = FillMode.Forward;
        this.fillMode = fillMode;
        this.f20794OooOO0O = true;
        this.f20795OooOO0o = true;
        this.f20797OooOOO0 = new OooO00o(this);
        this.f20796OooOOO = new OooO0O0(this);
        if (attributeSet != null) {
            ...
            this.f20794OooOO0O = typedArrayObtainStyledAttributes.getBoolean(o0OO0O0O.OooO0O0.SVGAImageView_antiAlias, true);
            this.f20795OooOO0o = typedArrayObtainStyledAttributes.getBoolean(o0OO0O0O.OooO0O0.SVGAImageView_autoPlay, true);
            ...
            if (string2 != null) {
                ...
                if (!StringsKt__StringsJVMKt.startsWith$default(string2, "http://", false, 2, null) && !StringsKt__StringsJVMKt.startsWith$default(string2, "https://", false, 2, null)) {
                    ...
                    if (oooO0OO.f20770OooO00o == null) {
                        ...
                        ExecutorService executorService = com.opensource.svgaplayer.OooO0OO.f20769OooO0Oo;
                        if (zExists) {
                            Intrinsics.checkNotNullParameter("SVGAParser", ViewHierarchyConstants.TAG_KEY);
                            ...
                            executorService.execute(new Runnable() { // from class: o0OO0O0O.OooOOO0
                                ...
                                public final void run() {
                                    ...
                                    boolean z = SVGACache.f20784OooO00o == SVGACache.Type.DEFAULT;
                                    ...
                                    this$0.getClass();
                                    Intrinsics.checkNotNullParameter(cacheKey2, "cacheKey");
                                    com.opensource.svgaplayer.OooO0OO.f20769OooO0Oo.execute(new Runnable() { // from class: o0OO0O0O.OooOo
                                        @Override // java.lang.Runnable
                                        public final void run() {
                                            StringBuilder sb;
                                            Unit unit;
                            ...
                            final com.opensource.svgaplayer.OooO0OO.OooO00o oooO00o2 = oooO0OO.f20771OooO0O0;
                            oooO00o2.getClass();
                            Intrinsics.checkNotNullParameter(url, "url");
