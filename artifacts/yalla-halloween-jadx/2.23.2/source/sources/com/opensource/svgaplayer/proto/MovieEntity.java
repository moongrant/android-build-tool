...
public final class MovieEntity extends Message<MovieEntity, Builder> {
    ...
    public static final class ProtoAdapter_MovieEntity extends ProtoAdapter<MovieEntity> {
        ...
        public int encodedSize(MovieEntity movieEntity) {
            ...
            MovieParams movieParams = movieEntity.params;
            return movieEntity.unknownFields().OooO0o0() + AudioEntity.ADAPTER.asRepeated().encodedSizeWithTag(5, movieEntity.audios) + SpriteEntity.ADAPTER.asRepeated().encodedSizeWithTag(4, movieEntity.sprites) + this.images.encodedSizeWithTag(3, movieEntity.images) + iEncodedSizeWithTag + (movieParams != null ? MovieParams.ADAPTER.encodedSizeWithTag(2, movieParams) : 0);
        }

        @Override // com.squareup.wire.ProtoAdapter
        public MovieEntity redact(MovieEntity movieEntity) throws IOException {
    ...
    public MovieEntity(String str, MovieParams movieParams, Map<String, ByteString> map, List<SpriteEntity> list, List<AudioEntity> list2) {
        this(str, movieParams, map, list, list2, ByteString.f60193OooO0oO);
    }
    ...
    public int hashCode() {
        ...
        int iHashCode3 = ((this.sprites.hashCode() + ((this.images.hashCode() + ((iHashCode2 + (movieParams != null ? movieParams.hashCode() : 0)) * 37)) * 37)) * 37) + this.audios.hashCode();
