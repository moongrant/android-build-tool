        ...
        private void checkNameAndValue(String str, String str2) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (cCharAt <= ' ' || cCharAt >= 127) {
                    throw new IllegalArgumentException(oO000o00.OooO("Unexpected char %#04x at %d in header name: %s", Integer.valueOf(cCharAt), Integer.valueOf(i), str));
                }
            }
            if (str2 == null) {
                throw new NullPointerException(o000oOoO.OooO0O0("value for name ", str, " == null"));
            }
            int length2 = str2.length();
            for (int i2 = 0; i2 < length2; i2++) {
                char cCharAt2 = str2.charAt(i2);
                if ((cCharAt2 <= 31 && cCharAt2 != '\t') || cCharAt2 >= 127) {
                    throw new IllegalArgumentException(oO000o00.OooO("Unexpected char %#04x at %d in %s value: %s", Integer.valueOf(cCharAt2), Integer.valueOf(i2), str, str2));
                }
            }
        }
