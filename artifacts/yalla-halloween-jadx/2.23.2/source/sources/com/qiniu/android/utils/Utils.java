...
public class Utils {
    ...
    private static String getIPV4StringType(String str, String str2) {
        ...
        return o0OoOo0.OooO0O0(str2, "-", strOooO00o);
    }
    ...
    private static String getIPV6StringType(String str, String str2) {
        ...
        while (i < strArrSplit.length) {
            ...
            strArr[i] = o0oOO.OooO0O0(new StringBuilder(), strArr2[str3.length()], str3);
            i++;
        }
        ...
        while (i < length) {
            ...
            strArr[i2] = o0oOO.OooO0O0(new StringBuilder(), strArr2[str4.length()], str4);
            length--;
            i2--;
        }
        return o0OoOo0.OooO0O0(str2, "-ipv6-", StringUtils.join((String[]) Arrays.copyOfRange(strArr, 0, 4), "-"));
    }
