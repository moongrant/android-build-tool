...
public abstract class o00oO0o {
    public static void OooO00o(int i, int i2, int i3, int i4, BitmapFactory.Options options, o00Ooo o00ooo2) {
        ...
        if (i4 > i2 || i3 > i) {
            if (i2 == 0) {
                ...
                iMax = o00ooo2.f21326OooOO0 ? Math.max(iFloor, iFloor2) : Math.min(iFloor, iFloor2);
            }
            iMax = (int) dFloor;
        } else {
            iMax = 1;
    ...
    public static BitmapFactory.Options OooO0OO(o00Ooo o00ooo2) {
        ...
        Bitmap.Config config = o00ooo2.f21332OooOOOo;
    ...
    public static final class OooO00o {
        ...
        public final Picasso.LoadedFrom f21341OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final Bitmap f21342OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final InputStream f21343OooO0OO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final int f21344OooO0Oo;
        ...
        public OooO00o(Bitmap bitmap, InputStream inputStream, Picasso.LoadedFrom loadedFrom, int i) {
            if ((inputStream != null) ^ (bitmap != null)) {
                this.f21342OooO0O0 = bitmap;
                this.f21343OooO0OO = inputStream;
                StringBuilder sb = o000000O.f21300OooO00o;
                if (loadedFrom != null) {
                    this.f21341OooO00o = loadedFrom;
                    this.f21344OooO0Oo = i;
                    return;
                }
