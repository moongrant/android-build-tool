...
public abstract class Message<M extends Message<M, B>, B extends Builder<M, B>> implements Serializable {
    ...
    @Metadata(d1 = {"\u0000<\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\r\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\t\b&\u0018\u0000*\u0014\b\u0002\u0010\u0002*\u000e\u0012\u0004\u0012\u00028\u0002\u0012\u0004\u0012\u00028\u00030\u0001*\u0014\b\u0003\u0010\u0003*\u000e\u0012\u0004\u0012\u00028\u0002\u0012\u0004\u0012\u00028\u00030\u00002\u00020\u0004B\t\b\u0004¢\u0006\u0004\b(\u0010)J\b\u0010\u0006\u001a\u00020\u0005H\u0002J\u001a\u0010\t\u001a\u000e\u0012\u0004\u0012\u00028\u0002\u0012\u0004\u0012\u00028\u00030\u00002\u0006\u0010\b\u001a\u00020\u0007J,\u0010\u000f\u001a\u000e\u0012\u0004\u0012\u00028\u0002\u0012\u0004\u0012\u00028\u00030\u00002\u0006\u0010\u000b\u001a\u00020\n2\u0006\u0010\r\u001a\u00020\f2\b\u0010\u000e\u001a\u0004\u0018\u00010\u0004J\u0012\u0010\u0010\u001a\u000e\u0012\u0004\u0012\u00028\u0002\u0012\u0004\u0012\u00028\u00030\u0000J\u0006\u0010\u0011\u001a\u00020\u0007J\u000f\u0010\u0012\u001a\u00028\u0002H&¢\u0006\u0004\b\u0012\u0010\u0013R\"\u0010\u0014\u001a\u00020\u00078\u0000@\u0000X\u0080\u000e¢\u0006\u0012\n\u0004\b\u0014\u0010\u0015\u001a\u0004\b\u0016\u0010\u0017\"\u0004\b\u0018\u0010\u0019R$\u0010\u001b\u001a\u0004\u0018\u00010\u001a8\u0000@\u0000X\u0080\u000e¢\u0006\u0012\n\u0004\b\u001b\u0010\u001c\u001a\u0004\b\u001d\u0010\u001e\"\u0004\b\u001f\u0010 R$\u0010\"\u001a\u0004\u0018\u00010!8\u0000@\u0000X\u0080\u000e¢\u0006\u0012\n\u0004\b\"\u0010#\u001a\u0004\b$\u0010%\"\u0004\b&\u0010'¨\u0006*"}, d2 = {"Lcom/squareup/wire/Message$Builder;", "Lcom/squareup/wire/Message;", "M", "B", "", "", "prepareForNewUnknownFields", "Lokio/ByteString;", "unknownFields", "addUnknownFields", "", ViewHierarchyConstants.TAG_KEY, "Lcom/squareup/wire/FieldEncoding;", "fieldEncoding", AppMeasurementSdk.ConditionalUserProperty.VALUE, "addUnknownField", "clearUnknownFields", "buildUnknownFields", "build", "()Lcom/squareup/wire/Message;", "unknownFieldsByteString", "Lokio/ByteString;", "getUnknownFieldsByteString$wire_runtime", "()Lokio/ByteString;", "setUnknownFieldsByteString$wire_runtime", "(Lokio/ByteString;)V", "Lo0oooO0O/oo0OOoo;", "unknownFieldsBuffer", "Lo0oooO0O/oo0OOoo;", "getUnknownFieldsBuffer$wire_runtime", "()Lo0oooO0O/oo0OOoo;", "setUnknownFieldsBuffer$wire_runtime", "(Lo0oooO0O/oo0OOoo;)V", "Lcom/squareup/wire/ProtoWriter;", "unknownFieldsWriter", "Lcom/squareup/wire/ProtoWriter;", "getUnknownFieldsWriter$wire_runtime", "()Lcom/squareup/wire/ProtoWriter;", "setUnknownFieldsWriter$wire_runtime", "(Lcom/squareup/wire/ProtoWriter;)V", "<init>", "()V", "wire-runtime"}, k = 1, mv = {1, 6, 0})
    public static abstract class Builder<M extends Message<M, B>, B extends Builder<M, B>> {

        @Nullable
        private transient oo0OOoo unknownFieldsBuffer;

        @NotNull
        private transient ByteString unknownFieldsByteString = ByteString.f60193OooO0oO;
        ...
        private final void prepareForNewUnknownFields() throws IOException {
            if (this.unknownFieldsBuffer == null) {
                this.unknownFieldsBuffer = new oo0OOoo();
                oo0OOoo oo0oooo = this.unknownFieldsBuffer;
                Intrinsics.checkNotNull(oo0oooo);
                ProtoWriter protoWriter = new ProtoWriter(oo0oooo);
                ...
                this.unknownFieldsByteString = ByteString.f60193OooO0oO;
            }
        }
        ...
        public final ByteString buildUnknownFields() {
            ...
            if (oo0oooo != null) {
                Intrinsics.checkNotNull(oo0oooo);
                this.unknownFieldsByteString = oo0oooo.Oooo0o0();
        ...
        public final Builder<M, B> clearUnknownFields() throws EOFException {
            setUnknownFieldsByteString$wire_runtime(ByteString.f60193OooO0oO);
            if (getUnknownFieldsBuffer() != null) {
                oo0OOoo unknownFieldsBuffer = getUnknownFieldsBuffer();
        ...
        public final oo0OOoo getUnknownFieldsBuffer() {
        ...
        public final void setUnknownFieldsBuffer$wire_runtime(@Nullable oo0OOoo oo0oooo) {
            this.unknownFieldsBuffer = oo0oooo;
        }
    ...
    public final void encode(@NotNull o0O0o00O sink) throws IOException {
    ...
    public final ByteString unknownFields() {
        ...
        return byteString == null ? ByteString.f60193OooO0oO : byteString;
    }
