...
public class TweetView extends BaseTweetView {
    ...
    private void setVerifiedCheck(com.twitter.sdk.android.core.models.OooOo oooOo) {
        User user;
        if (oooOo == null || (user = oooOo.f21622OooOooO) == null || !user.f21722OoooO00) {
            this.f21805OooO.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
        } else {
            this.f21805OooO.setCompoundDrawablesWithIntrinsicBounds(0, 0, o0OO00O.tw__ic_tweet_verified, 0);
        }
    }
    ...
    public final void OooO0Oo() {
        super.OooO0Oo();
        setVerifiedCheck(this.f21809OooO0oO);
    }
