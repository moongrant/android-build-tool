...
public class WXEntryActivity extends BaseFragmentActivity {
    public final void OooOo0(OooO0O0 oooO0O0) {
        String str = ((OooO0o) oooO0O0).f42799OooO0O0;
        if (oooO0O0.f42803OooO00o == 0 && OooOo00.OooO0O0(str)) {
            LiveEventBus.get(p354o0OOOo0O.OooO0O0.OooO00o("ZiU7UhwLyy9+JzFU\n", "MWB4Gl1flGM=\n")).post(str);
        } else {
            LiveEventBus.get(p354o0OOOo0O.OooO0O0.OooO00o("0po/HNXUqs3KmDUa\n", "hd98VJSA9YE=\n")).post("");
        }
        finish();
    }
