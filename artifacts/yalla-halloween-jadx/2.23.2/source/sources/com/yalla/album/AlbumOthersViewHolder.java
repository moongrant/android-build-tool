...
public final class AlbumOthersViewHolder extends BaseAlbumViewHolder {
    ...
    @NotNull
    private final o000O interceptor;
    ...
    public static final class OooO00o extends OooO0OO {
        ...
        public final /* synthetic */ Album f22039OooO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ AlbumItem f22041OooO0oo;

        public OooO00o(AlbumItem albumItem, Album album) {
            this.f22041OooO0oo = albumItem;
            this.f22039OooO = album;
        }
        ...
        public final void OooO00o(@NotNull View view) {
            ...
            o000O interceptor = albumOthersViewHolder.getInterceptor();
            Context mContext = albumOthersViewHolder.getMContext();
            int maxCount = albumOthersViewHolder.getMaxCount();
            interceptor.getClass();
            if (o000O.OooO00o(mContext, this.f22041OooO0oo, this.f22039OooO, maxCount).booleanValue()) {
                return;
            }
            RecyclerView.Adapter<? extends RecyclerView.o0O0O00> bindingAdapter = albumOthersViewHolder.getBindingAdapter();
            o0000OO0 o0000oo1 = bindingAdapter instanceof o0000OO0 ? (o0000OO0) bindingAdapter : null;
            if (o0000oo1 != null) {
                o0000oo1.updateMultiSelectData(new AlbumItemWrapper(this.f22041OooO0oo, null, 0, 6, null));
                AlbumActivity this$0 = (AlbumActivity) ((o00000OO) o0000oo1.f42966OooO0Oo).f9289OooO0Oo;
    ...
    public AlbumOthersViewHolder(@NotNull View itemView, @NotNull AlbumAdapterItemClickListener mListener, @NotNull o000O interceptor, int i) {
        super(itemView);
        ...
        this.maxCount = i;
        this.imageGif = (TextView) itemView.findViewById(o0OO0O0.OooO0OO.layout_all_image_tv_gif);
        this.videoDuration = (TextView) itemView.findViewById(o0OO0O0.OooO0OO.item_send_post_video_duration);
        this.imageView = (ImageView) itemView.findViewById(o0OO0O0.OooO0OO.layout_all_image_iv);
        this.selectLayout = (RelativeLayout) itemView.findViewById(o0OO0O0.OooO0OO.layout_all_image_layout_select);
        this.selectTv = (TextView) itemView.findViewById(o0OO0O0.OooO0OO.layout_all_image_tv_select);
        this.conver = itemView.findViewById(o0OO0O0.OooO0OO.layout_all_image_layout_covering);
    }
    ...
    private final void checkVideo(AlbumItem data) {
        ...
        Function1<? super AlbumItem, Boolean> function1 = OooOO0O.f37478OooO0O0;
    ...
    public final void bindData(@NotNull final Album album, @NotNull final AlbumItem data, final int adapterPosition) {
        ...
        this.itemView.setOnClickListener(new View.OnClickListener() { // from class: o0OOOooo.o0000O0O
        ...
        int i = albumActivity != null ? albumActivity.f22019OooO : 0;
        View view = this.conver;
        if (view != null) {
    ...
    @NotNull
    public final o000O getInterceptor() {
