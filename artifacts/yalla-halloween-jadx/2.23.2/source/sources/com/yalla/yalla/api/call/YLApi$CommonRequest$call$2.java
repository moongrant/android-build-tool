...
@Metadata(d1 = {"\u0000\f\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0003\u001a\b\u0012\u0004\u0012\u00028\u00000\u0002\"\u0006\b\u0000\u0010\u0000\u0018\u0001*\u00020\u0001H\u008a@"}, d2 = {"T", "Lkotlinx/coroutines/CoroutineScope;", "Lcom/yalla/yalla/model/http/ApiResult;", "<anonymous>"}, k = 3, mv = {1, 9, 0})
...
public final class YLApi$CommonRequest$call$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<Object>>, Object> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public int f22199OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ o0ooOOo f22200OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public YLApi$CommonRequest$call$2(o0ooOOo o0ooooo, Continuation<? super YLApi$CommonRequest$call$2> continuation) {
        super(2, continuation);
        this.f22200OooO0o0 = o0ooooo;
    }
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        ...
        return new YLApi$CommonRequest$call$2(this.f22200OooO0o0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ApiResult<Object>> continuation) {
        return ((YLApi$CommonRequest$call$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f22199OooO0Oo;
        try {
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                o0ooOOo o0ooooo = this.f22200OooO0o0;
            ...
            Intrinsics.needClassReification();
            Type type = new TypeToken<ApiResult<Object>>() { // from class: com.yalla.yalla.api.call.YLApi$CommonRequest$call$2$invokeSuspend$lambda$1$$inlined$parseByApiResult$1
            }.getType();
            o00ooo2.getClass();
            ...
            if (apiResult == null) {
                ...
                Intrinsics.needClassReification();
                Type type2 = new TypeToken<Object>() { // from class: com.yalla.yalla.api.call.YLApi$CommonRequest$call$2$invokeSuspend$lambda$1$$inlined$parseByApiResult$2
                }.getType();
