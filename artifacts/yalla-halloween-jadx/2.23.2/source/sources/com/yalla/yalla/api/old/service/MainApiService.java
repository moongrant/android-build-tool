...
public interface MainApiService {
    ...
    @Nullable
    Object fbLogin(@NotNull @Query("deviceid") String str, @NotNull @Query("accesstoken") String str2, @NotNull @Query(UserDataStore.COUNTRY) String str3, @NotNull @Query("SimCountryCode") String str4, @NotNull @Query("DeviceCountryCode") String str5, @NotNull Continuation<? super ApiResult<LoginListModel>> continuation);
