...
public final class ApiTagUtils$init$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f22251OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            String str = Oooo0.f43443o0ooOOo;
            ApiTagUtils$init$1$invokeSuspend$$inlined$call$1 apiTagUtils$init$1$invokeSuspend$$inlined$call$1 = new ApiTagUtils$init$1$invokeSuspend$$inlined$call$1(oo000o.OooO00o(str, "url", str, 0), null);
            this.f22251OooO0Oo = 1;
        ...
        ArrayList<CategoryModel> arrayList = ApiTagUtils.f22249OooO0O0;
        arrayList.clear();
        List list = (List) ((ApiResult) obj).getData();
        if (list != null) {
            Boxing.boxBoolean(arrayList.addAll(list));
        }
        ApiTagUtils.f22248OooO00o.clear();
