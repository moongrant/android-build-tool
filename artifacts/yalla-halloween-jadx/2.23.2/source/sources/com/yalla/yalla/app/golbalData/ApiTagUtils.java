...
public final class ApiTagUtils {
    ...
    @NotNull
    public static final HashMap<String, CategoryModel> f22248OooO00o = new HashMap<>();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public static final ArrayList f22249OooO0O0 = new ArrayList();

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static int f22250OooO0OO;

    @Nullable
    public static CategoryModel OooO00o(@NotNull String key) {
        Intrinsics.checkNotNullParameter(key, "key");
        HashMap<String, CategoryModel> map = f22248OooO00o;
    ...
    public static void OooO0O0() {
        if (f22250OooO0OO == OooOo00.OooO0OO() && (!f22249OooO0O0.isEmpty())) {
            return;
        }
        f22250OooO0OO = OooOo00.OooO0OO();
