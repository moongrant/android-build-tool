...
public abstract class LoadLogic<K, T> {
    ...
    jadx.core.utils.exceptions.JadxRuntimeException: Can't remove SSA var: r6v1 com.yalla.yalla.base.loadcache.LoadLogic$LoadLevel[], still in use, count: 1, list:
      (r6v1 com.yalla.yalla.base.loadcache.LoadLogic$LoadLevel[]) from 0x0029: INVOKE (r6v1 com.yalla.yalla.base.loadcache.LoadLogic$LoadLevel[]) STATIC call: kotlin.enums.EnumEntriesKt.enumEntries(java.lang.Enum[]):kotlin.enums.EnumEntries A[MD:<E extends java.lang.Enum<E>>:(E extends java.lang.Enum<E>[]):kotlin.enums.EnumEntries<E extends java.lang.Enum<E>> (m), WRAPPED] (LINE:42)
    ...
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\u0010\b\n\u0002\b\b\b\u0086\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001R\u0017\u0010\u0003\u001a\u00020\u00028\u0006¢\u0006\f\n\u0004\b\u0003\u0010\u0004\u001a\u0004\b\u0005\u0010\u0006j\u0002\b\u0007j\u0002\b\bj\u0002\b\t¨\u0006\n"}, d2 = {"Lcom/yalla/yalla/base/loadcache/LoadLogic$LoadLevel;", "", "", "level", "I", "OooO00o", "()I", "CACHE", "DISK", "ALL", "YLBase_release"}, k = 1, mv = {1, 9, 0})
    public static final class LoadLevel {
        CACHE(1),
        DISK(2),
        ALL(3);
        ...
        static {
            $ENTRIES = EnumEntriesKt.enumEntries(loadLevelArr);
        }
        ...
        public static LoadLevel valueOf(String str) {
            return (LoadLevel) Enum.valueOf(LoadLevel.class, str);
        }

        public static LoadLevel[] values() {
            return (LoadLevel[]) $VALUES.clone();
        }
    ...
    public final Object OooO0O0(String str, @NotNull LoadLevel loadLevel, @NotNull Continuation continuation) {
        ...
        if (continuation instanceof OooO00o) {
            ...
            int i = oooO00o.f22295OooO;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO00o.f22295OooO = i - Integer.MIN_VALUE;
            } else {
        ...
        Object objOooO0OO = oooO00o.f22299OooO0oO;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (oooO00o.f22295OooO) {
            case 0:
                ResultKt.throwOnFailure(objOooO0OO);
                oooO00o.f22296OooO0Oo = this;
                oooO00o.f22298OooO0o0 = str;
                oooO00o.f22297OooO0o = loadLevel;
                oooO00o.f22295OooO = 1;
                ...
                if (loadLevel.getLevel() > 1) {
                    oooO00o.f22296OooO0Oo = loadLogic;
                    oooO00o.f22298OooO0o0 = obj;
                    oooO00o.f22297OooO0o = loadLevel;
                    oooO00o.f22295OooO = 2;
                    ...
                    if (objOooO0OO != null) {
                        obj3 = obj;
                        oooO00o.f22296OooO0Oo = objOooO0OO;
                        oooO00o.f22298OooO0o0 = null;
                        oooO00o.f22297OooO0o = null;
                        oooO00o.f22295OooO = 3;
                    ...
                    if (loadLevel.getLevel() > 2) {
                        oooO00o.f22296OooO0Oo = loadLogic;
                        oooO00o.f22298OooO0o0 = obj3;
                        oooO00o.f22297OooO0o = null;
                        oooO00o.f22295OooO = 4;
                        ...
                        if (objOooO0OO != null) {
                            oooO00o.f22296OooO0Oo = loadLogic;
                            oooO00o.f22298OooO0o0 = obj5;
                            oooO00o.f22297OooO0o = objOooO0OO;
                            oooO00o.f22295OooO = 5;
                            if (loadLogic.OooO0o(obj5, objOooO0OO) == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            obj6 = objOooO0OO;
                            obj7 = obj5;
                            oooO00o.f22296OooO0Oo = obj6;
                            oooO00o.f22298OooO0o0 = null;
                            oooO00o.f22297OooO0o = null;
                            oooO00o.f22295OooO = 6;
                ...
                return null;
            case 1:
                loadLevel = (LoadLevel) oooO00o.f22297OooO0o;
                Object obj9 = oooO00o.f22298OooO0o0;
                loadLogic = (LoadLogic) oooO00o.f22296OooO0Oo;
                ResultKt.throwOnFailure(objOooO0OO);
                obj = obj9;
                if (objOooO0OO != null) {
                    obj = str;
                ...
                return null;
            case 2:
                loadLevel2 = (LoadLevel) oooO00o.f22297OooO0o;
                Object obj11 = oooO00o.f22298OooO0o0;
                loadLogic = (LoadLogic) oooO00o.f22296OooO0Oo;
                ResultKt.throwOnFailure(objOooO0OO);
                obj2 = obj11;
                if (objOooO0OO != null) {
                ...
                return null;
            case 3:
                Object obj13 = oooO00o.f22296OooO0Oo;
                ResultKt.throwOnFailure(objOooO0OO);
                return obj13;
            case 4:
                Object obj14 = oooO00o.f22298OooO0o0;
                LoadLogic<K, T> loadLogic2 = (LoadLogic) oooO00o.f22296OooO0Oo;
                ResultKt.throwOnFailure(objOooO0OO);
                ...
                return null;
            case 5:
                obj6 = oooO00o.f22297OooO0o;
                Object obj15 = oooO00o.f22298OooO0o0;
                loadLogic = (LoadLogic) oooO00o.f22296OooO0Oo;
                ResultKt.throwOnFailure(objOooO0OO);
                obj7 = obj15;
                oooO00o.f22296OooO0Oo = obj6;
                ...
                return obj6;
            case 6:
                Object obj16 = oooO00o.f22296OooO0Oo;
                ResultKt.throwOnFailure(objOooO0OO);
                return obj16;
            default:
