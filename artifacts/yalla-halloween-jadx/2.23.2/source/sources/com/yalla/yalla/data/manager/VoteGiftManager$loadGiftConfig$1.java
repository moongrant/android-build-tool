...
public final class VoteGiftManager$loadGiftConfig$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f22382OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            String url = oo000o.OooO0OO("Webservers/vote/GetGiftList");
            Intrinsics.checkNotNullParameter(url, "url");
            VoteGiftManager$loadGiftConfig$1$invokeSuspend$$inlined$call$1 voteGiftManager$loadGiftConfig$1$invokeSuspend$$inlined$call$1 = new VoteGiftManager$loadGiftConfig$1$invokeSuspend$$inlined$call$1(new o0ooOOo(url, 0), null);
            this.f22382OooO0Oo = 1;
        ...
        if (apiResult.isSuccess()) {
            ...
            OooOOO0.f45931OooO00o.postValue(arrayList);
        }
