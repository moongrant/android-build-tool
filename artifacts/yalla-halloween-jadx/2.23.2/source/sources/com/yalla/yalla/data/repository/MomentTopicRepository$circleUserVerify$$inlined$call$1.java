...
public final class MomentTopicRepository$circleUserVerify$$inlined$call$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<TopicVerifyState>>, Object> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public int f22641OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ o0ooOOo f22642OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MomentTopicRepository$circleUserVerify$$inlined$call$1(o0ooOOo o0ooooo, Continuation continuation) {
        super(2, continuation);
        this.f22642OooO0o0 = o0ooooo;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new MomentTopicRepository$circleUserVerify$$inlined$call$1(this.f22642OooO0o0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ApiResult<TopicVerifyState>> continuation) {
        return ((MomentTopicRepository$circleUserVerify$$inlined$call$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f22641OooO0Oo;
        Object obj2 = null;
        try {
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                o0ooOOo o0ooooo = this.f22642OooO0o0;
            ...
            Type type = new TypeToken<ApiResult<TopicVerifyState>>() { // from class: com.yalla.yalla.data.repository.MomentTopicRepository$circleUserVerify$$inlined$call$1.1
            }.getType();
            o00ooo2.getClass();
            ...
            if (apiResult == null) {
                ...
                Type type2 = new TypeToken<TopicVerifyState>() { // from class: com.yalla.yalla.data.repository.MomentTopicRepository$circleUserVerify$$inlined$call$1.2
                }.getType();
                Intrinsics.checkNotNullExpressionValue(type2, "getType(...)");
                Object objOooO0Oo = OooO00o.OooO0Oo(strOooO00o, type2);
                if (objOooO0Oo instanceof TopicVerifyState) {
                    obj2 = objOooO0Oo;
                }
                apiResult.setData((TopicVerifyState) obj2);
            }
