...
public final class SearchRepo$loadSearchRecommendUser$$inlined$call$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<List<? extends UserInfoModel>>>, Object> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public int f22659OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ o0ooOOo f22660OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SearchRepo$loadSearchRecommendUser$$inlined$call$1(o0ooOOo o0ooooo, Continuation continuation) {
        super(2, continuation);
        this.f22660OooO0o0 = o0ooooo;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new SearchRepo$loadSearchRecommendUser$$inlined$call$1(this.f22660OooO0o0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ApiResult<List<? extends UserInfoModel>>> continuation) {
        return ((SearchRepo$loadSearchRecommendUser$$inlined$call$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f22659OooO0Oo;
        Object obj2 = null;
        try {
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                o0ooOOo o0ooooo = this.f22660OooO0o0;
            ...
            Type type = new TypeToken<ApiResult<List<? extends UserInfoModel>>>() { // from class: com.yalla.yalla.data.repository.SearchRepo$loadSearchRecommendUser$$inlined$call$1.1
            }.getType();
            o00ooo2.getClass();
            ...
            if (apiResult == null) {
                ...
                Type type2 = new TypeToken<List<? extends UserInfoModel>>() { // from class: com.yalla.yalla.data.repository.SearchRepo$loadSearchRecommendUser$$inlined$call$1.2
                }.getType();
