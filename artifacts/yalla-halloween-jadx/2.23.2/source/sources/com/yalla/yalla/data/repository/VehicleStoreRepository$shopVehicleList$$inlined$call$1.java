...
@DebugMetadata(c = "com.yalla.yalla.data.repository.VehicleStoreRepository$shopVehicleList$$inlined$call$1", f = "VehicleStoreRepository.kt", i = {}, l = {73}, m = "invokeSuspend", n = {}, s = {})
...
public final class VehicleStoreRepository$shopVehicleList$$inlined$call$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Response<List<ShopVehicleListModel>>>, Object> {
    ...
    public int f22788OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ String f22789OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ oO0O000o f22790OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public VehicleStoreRepository$shopVehicleList$$inlined$call$1(oO0O000o oo0o000o, Continuation continuation, String str) {
        super(2, continuation);
        this.f22790OooO0o0 = oo0o000o;
        this.f22789OooO0o = str;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new VehicleStoreRepository$shopVehicleList$$inlined$call$1(this.f22790OooO0o0, continuation, this.f22789OooO0o);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
        ...
        int i = this.f22788OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            final oO0O000o oo0o000o = this.f22790OooO0o0;
            this.f22788OooO0Oo = 1;
            ...
            OooO0OO.OooO0O0 oooO0O0 = new OooO0OO.OooO0O0() { // from class: com.yalla.yalla.data.repository.VehicleStoreRepository$shopVehicleList$$inlined$call$1.1
                ...
                public final void OooO0o0(@Nullable String str) {
                    ...
                    if (z) {
                        ...
                        Type type = new TypeToken<Response<List<ShopVehicleListModel>>>() { // from class: com.yalla.yalla.data.repository.VehicleStoreRepository$shopVehicleList$.inlined.call.1.1.1
                        }.getType();
            ...
            String vehicleType = this.f22789OooO0o;
            Intrinsics.checkNotNullParameter(vehicleType, "vehicleType");
            LinkedHashMap linkedHashMapOooO00o = OooOOOO.OooO00o();
            Intrinsics.checkNotNull(linkedHashMapOooO00o);
            linkedHashMapOooO00o.put("vehicleType", vehicleType);
            OooO0OO.OooO0O0(null, Oooo0.f43359OooOoo, "/Webservers/Shop/ShopVehicleList", linkedHashMapOooO00o, oooO0O0);
