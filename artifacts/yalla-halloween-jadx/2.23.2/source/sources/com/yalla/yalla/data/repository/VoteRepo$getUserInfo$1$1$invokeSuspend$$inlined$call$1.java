...
public final class VoteRepo$getUserInfo$1$1$invokeSuspend$$inlined$call$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<RoomUserInfoDTO>>, Object> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public int f22831OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ o0ooOOo f22832OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public VoteRepo$getUserInfo$1$1$invokeSuspend$$inlined$call$1(o0ooOOo o0ooooo, Continuation continuation) {
        super(2, continuation);
        this.f22832OooO0o0 = o0ooooo;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new VoteRepo$getUserInfo$1$1$invokeSuspend$$inlined$call$1(this.f22832OooO0o0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ApiResult<RoomUserInfoDTO>> continuation) {
        return ((VoteRepo$getUserInfo$1$1$invokeSuspend$$inlined$call$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f22831OooO0Oo;
        Object obj2 = null;
        try {
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                o0ooOOo o0ooooo = this.f22832OooO0o0;
            ...
            Type type = new TypeToken<ApiResult<RoomUserInfoDTO>>() { // from class: com.yalla.yalla.data.repository.VoteRepo$getUserInfo$1$1$invokeSuspend$$inlined$call$1.1
            }.getType();
            o00ooo2.getClass();
            ...
            if (apiResult == null) {
                ...
                Type type2 = new TypeToken<RoomUserInfoDTO>() { // from class: com.yalla.yalla.data.repository.VoteRepo$getUserInfo$1$1$invokeSuspend$$inlined$call$1.2
                }.getType();
                Intrinsics.checkNotNullExpressionValue(type2, "getType(...)");
                Object objOooO0Oo = OooO00o.OooO0Oo(strOooO00o, type2);
                if (objOooO0Oo instanceof RoomUserInfoDTO) {
                    obj2 = objOooO0Oo;
                }
                apiResult.setData((RoomUserInfoDTO) obj2);
            }
