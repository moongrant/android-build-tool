...
public final class TestVideoActivity extends AppCompatActivity {
        ...
        public final Unit invoke(Composer composer, Integer num) {
            ...
            if ((iIntValue & 11) == 2 && composer2.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(1822702112, iIntValue, -1, "com.yalla.yalla.developer.TestVideoActivity.onCreate.<anonymous> (TestVideoActivity.kt:58)");
                }
                ...
                ButtonKt.Button(com.yalla.yalla.developer.OooO00o.f22846OooO0Oo, null, false, null, null, null, null, null, null, o0ooOOo.f46562OooO00o, composer2, 805306374, 510);
                ButtonKt.Button(OooO0O0.f22847OooO0Oo, null, false, null, null, null, null, null, null, o0ooOOo.f46563OooO0O0, composer2, 805306374, 510);
                ButtonKt.Button(OooO0OO.f22848OooO0Oo, null, false, null, null, null, null, null, null, o0ooOOo.f46564OooO0OO, composer2, 805306374, 510);
                ...
                ButtonKt.Button(OooO0o.f22849OooO0Oo, null, false, null, null, null, null, null, null, o0ooOOo.f46565OooO0Oo, composer2, 805306374, 510);
                TestVideoActivity testVideoActivity = TestVideoActivity.this;
                ButtonKt.Button(new OooO(testVideoActivity), null, false, null, null, null, null, null, null, o0ooOOo.f46567OooO0o0, composer2, 805306368, 510);
                ButtonKt.Button(new OooOO0(testVideoActivity), null, false, null, null, null, null, null, null, o0ooOOo.f46566OooO0o, composer2, 805306368, 510);
                composer2.endReplaceableGroup();
                composer2.endNode();
                composer2.endReplaceableGroup();
                composer2.endReplaceableGroup();
                ...
                ButtonKt.Button(new OooOO0O(testVideoActivity), null, false, null, null, null, null, null, null, o0ooOOo.f46568OooO0oO, composer2, 805306368, 510);
    ...
    public final void onCreate(@Nullable Bundle bundle) {
        ...
        setContentView(oo0o0Oo.activity_test_video);
        RoomGiftPlayContainer roomGiftPlayContainer = (RoomGiftPlayContainer) findViewById(o0OO00O.roomGifPlayContainer);
        roomGiftPlayContainer.initSvgaView(new RoomGiftSVGAView(this, null, 6, 0));
        Intrinsics.checkNotNull(roomGiftPlayContainer);
        this.f22859OooO0oo.init(this, roomGiftPlayContainer);
        ((ComposeView) findViewById(o0OO00O.composeView)).setContent(ComposableLambdaKt.composableLambdaInstance(1822702112, true, new OooO00o()));
    }
}
