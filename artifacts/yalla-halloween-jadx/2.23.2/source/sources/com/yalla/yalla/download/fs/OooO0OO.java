...
public final class OooO0OO extends OooO00o {
    ...
    public Object[] f22915OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public Object f22916OooO0o0;
            ...
            if (obj == null) {
                ...
                try {
                    ...
                    if (TextUtils.isEmpty(str)) {
                        ...
                        if (objOooO0OO4 == null) {
                            iIntValue = -1;
                            if (iIntValue != -1 && (context2 = OooO00o.f22910OooO00o.get()) != null) {
                            ...
                            if (!TextUtils.isEmpty(string) && (string.startsWith("string/") || string.startsWith("string/", 1))) {
                                ...
                                context = OooO00o.f22910OooO00o.get();
    ...
    public final ArrayList OooO00o() {
        ...
        List<StorageVolume> list = OooO00o.f22911OooO0O0;
        if (list != null) {
            list.clear();
        }
        Method method = null;
        do {
            List<StorageVolume> list2 = OooO00o.f22911OooO0O0;
            if (list2 != null && list2.size() > 0) {
                break;
            }
            Object systemService = this.f22916OooO0o0;
            if (systemService == null) {
                WeakReference<Context> weakReference = OooO00o.f22910OooO00o;
                if (weakReference == null || weakReference.get() == null) {
                    this.f22916OooO0o0 = null;
                    systemService = null;
                } else {
                    systemService = OooO00o.f22910OooO00o.get().getSystemService("storage");
                    this.f22916OooO0o0 = systemService;
                }
            }
            if (systemService != null) {
                try {
        ...
        } while (OooO00o.f22911OooO0O0.size() <= 0);
        if (method != null) {
            try {
                this.f22915OooO0o = (Object[]) method.invoke(this.f22916OooO0o0, new Object[0]);
                arrayListOooO0Oo = OooO0Oo(this.f22915OooO0o);
                if (arrayListOooO0Oo != null && arrayListOooO0Oo.size() > 0) {
                    OooO00o.f22911OooO0O0.addAll(arrayListOooO0Oo);
                    return new ArrayList(OooO00o.f22911OooO0O0);
                }
