...
public final /* data */ class RoomPKResultModel {
    ...
    public int hashCode() {
        int iOooO00o = (OooO0O0.OooO00o(this.pk_end, this.gift_picurl.hashCode() * 31, 31) + this.pk_time_duration) * 31;
        long j = this.room_a_barid;
        int iOooO00o2 = OooO0O0.OooO00o(this.room_a_picurl, OooO0O0.OooO00o(this.room_a_name, (((((iOooO00o + ((int) (j ^ (j >>> 32)))) * 31) + this.room_a_giftamount) * 31) + this.room_a_giftnumber) * 31, 31), 31);
        long j2 = this.room_b_barid;
        return this.room_b_picurl.hashCode() + OooO0O0.OooO00o(this.room_b_name, (((((iOooO00o2 + ((int) (j2 ^ (j2 >>> 32)))) * 31) + this.room_b_giftamount) * 31) + this.room_b_giftnumber) * 31, 31);
    }
    ...
    public String toString() {
        ...
        StringBuilder sbOooO00o = OooO0OO.OooO00o("RoomPKResultModel(gift_picurl=", str, ", pk_end=", str2, ", pk_time_duration=");
        sbOooO00o.append(i);
        sbOooO00o.append(", room_a_barid=");
        sbOooO00o.append(j);
        sbOooO00o.append(", room_a_giftamount=");
        sbOooO00o.append(i2);
        sbOooO00o.append(", room_a_giftnumber=");
        sbOooO00o.append(i3);
        OooO0OO.OooO0O0.OooO00o(sbOooO00o, ", room_a_name=", str3, ", room_a_picurl=", str4);
        OooOOO0.OooO00o(sbOooO00o, ", room_b_barid=", j2, ", room_b_giftamount=");
        o000O0Oo.OooOOO0.OooO00o(sbOooO00o, i4, ", room_b_giftnumber=", i5, ", room_b_name=");
        return o0OoOo0.OooO0OO(sbOooO00o, str5, ", room_b_picurl=", str6, ")");
    }
