...
public final /* data */ class FirebaseDataMessage {
    ...
    public FirebaseDataMessage(int i, @NotNull String str, @NotNull String str2, @NotNull String str3) {
        OooO00o.OooO00o(str, "source", str2, "message_id", str3, "info");
        this.type = i;
        this.source = str;
    ...
    public int hashCode() {
        return this.info.hashCode() + OooO0O0.OooO00o(this.message_id, OooO0O0.OooO00o(this.source, this.type * 31, 31), 31);
    }
    ...
    public String toString() {
        ...
        return o0OoOo0.OooO0OO(oo0o0O0.OooO0O0.OooO00o("FirebaseDataMessage(type=", i, ", source=", str, ", message_id="), this.message_id, ", info=", this.info, ")");
    }
}
