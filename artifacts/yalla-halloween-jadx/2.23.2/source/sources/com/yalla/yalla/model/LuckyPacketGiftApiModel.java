...
public final /* data */ class LuckyPacketGiftApiModel {
    ...
    public int hashCode() {
        int iOooO00o = OooO0O0.OooO00o(this.message, this.code.hashCode() * 31, 31);
    ...
    public String toString() {
        ...
        List<GiftPropModel> list = this.data;
        StringBuilder sbOooO00o = OooO0OO.OooO00o("LuckyPacketGiftApiModel(code=", str, ", message=", str2, ", data=");
