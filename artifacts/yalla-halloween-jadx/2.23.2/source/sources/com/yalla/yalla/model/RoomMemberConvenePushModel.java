...
public final /* data */ class RoomMemberConvenePushModel extends BasePushMessage {
    ...
    public int hashCode() {
        long j = this.userId;
        int iOooO00o = OooO0O0.OooO00o(this.userAvatar, (OooO0O0.OooO00o(this.userName, OooO0O0.OooO00o(this.userIdx, ((int) (j ^ (j >>> 32))) * 31, 31), 31) + this.userLevel) * 31, 31);
        boolean z = this.vip;
        ?? r1 = z;
        if (z) {
            r1 = 1;
        }
        int iOooO00o2 = OooO0O0.OooO00o(this.message, (((iOooO00o + r1) * 31) + this.vipLevel) * 31, 31);
        long j2 = this.time;
    ...
    public String toString() {
        ...
        sb.append(", message=");
        sb.append(str4);
        OooOOO0.OooO00o(sb, ", time=", j2, ", roomId=");
        return OooO0OO.OooO0O0(sb, j3, ")");
    }
}
