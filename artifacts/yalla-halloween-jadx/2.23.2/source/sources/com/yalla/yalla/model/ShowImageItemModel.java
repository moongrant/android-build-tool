...
public final /* data */ class ShowImageItemModel implements Serializable {
    ...
    public String toString() {
        return "ShowImageItemModel(url=" + this.url + ", imageView=" + this.imageView + ", imageLocationInfo=" + this.imageLocationInfo + ", width=" + this.width + ", watermarkText=" + this.watermarkText + ", isSave=" + this.isSave + ")";
    }
