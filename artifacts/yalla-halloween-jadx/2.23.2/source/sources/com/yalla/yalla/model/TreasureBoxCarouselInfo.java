...
public final /* data */ class TreasureBoxCarouselInfo {
    ...
    public int hashCode() {
        return OooO0O0.OooO00o(this.nickName, OooO0O0.OooO00o(this.headUrl, this.broadcast.hashCode() * 31, 31), 31) + this.userId;
    }
    ...
    public String toString() {
        ...
        int i = this.userId;
        StringBuilder sbOooO00o = OooO0OO.OooO00o("TreasureBoxCarouselInfo(broadcast=", str, ", headUrl=", str2, ", nickName=");
    ...
    public TreasureBoxCarouselInfo(@NotNull String str, @NotNull String str2, @NotNull String str3, int i) {
        OooO00o.OooO00o(str, "broadcast", str2, "headUrl", str3, "nickName");
        this.broadcast = str;
        this.headUrl = str2;
        this.nickName = str3;
        this.userId = i;
