...
@Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000b\n\u0002\b#\b\u0086\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0019\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\b\b\u0002\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006R\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0004\u0010\u0007R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\b\u0010\tj\u0002\b\nj\u0002\b\u000bj\u0002\b\fj\u0002\b\rj\u0002\b\u000ej\u0002\b\u000fj\u0002\b\u0010j\u0002\b\u0011j\u0002\b\u0012j\u0002\b\u0013j\u0002\b\u0014j\u0002\b\u0015j\u0002\b\u0016j\u0002\b\u0017j\u0002\b\u0018j\u0002\b\u0019j\u0002\b\u001aj\u0002\b\u001bj\u0002\b\u001cj\u0002\b\u001dj\u0002\b\u001ej\u0002\b\u001fj\u0002\b j\u0002\b!j\u0002\b\"j\u0002\b#j\u0002\b$j\u0002\b%j\u0002\b&j\u0002\b'¨\u0006("}, d2 = {"Lcom/yalla/yalla/model/WebFrom;", "", AppMeasurementSdk.ConditionalUserProperty.VALUE, "", "isShowOpenInBrowser", "", "(Ljava/lang/String;IIZ)V", "()Z", "getValue", "()I", "LoginInstagram", "RoomActivity", "ActivityNotice", "RoomMainBanner", "FAQ", "StoreCoin", "TermsOfService", "UserLevel", "LoginPageFeedback", "VerificationCodeFeedback", "CrystalExchangeRecord", "VIPNobleIntroductionPage", "MomentActivityBanner", "Mintroute_Recharge", "PrivateChatShare", "Ad", "RoomBonus", "YallaTeamLink", "KaVipDetails", "FirstChargeRewardUrlWallet", "FirstChargeRewardUrlMain", "FirstChargeRewardUrlGiftDialog", "YallaChatDownUrl", "StoreBubbleObtain", "FaqRule", "UserWealthLevel", "UserKaVip", "UserKaVipHelpPage", "ExternalLink", "Unknow", "Common_YallaRelease"}, k = 1, mv = {1, 9, 0}, xi = 48)
public final class WebFrom {
    ...
    public static final WebFrom ExternalLink;
    ...
    public static final WebFrom UserKaVip;
    public static final WebFrom UserKaVipHelpPage;
    public static final WebFrom UserLevel;
    public static final WebFrom UserWealthLevel;
    ...
    private static final /* synthetic */ WebFrom[] $values() {
        return new WebFrom[]{LoginInstagram, RoomActivity, ActivityNotice, RoomMainBanner, FAQ, StoreCoin, TermsOfService, UserLevel, LoginPageFeedback, VerificationCodeFeedback, CrystalExchangeRecord, VIPNobleIntroductionPage, MomentActivityBanner, Mintroute_Recharge, PrivateChatShare, Ad, RoomBonus, YallaTeamLink, KaVipDetails, FirstChargeRewardUrlWallet, FirstChargeRewardUrlMain, FirstChargeRewardUrlGiftDialog, YallaChatDownUrl, StoreBubbleObtain, FaqRule, UserWealthLevel, UserKaVip, UserKaVipHelpPage, ExternalLink, Unknow};
    }
    ...
    static {
        ...
        UserWealthLevel = new WebFrom("UserWealthLevel", 25, 27, z4, i4, defaultConstructorMarker5);
        UserKaVip = new WebFrom("UserKaVip", 26, 28, z3, i3, defaultConstructorMarker4);
        UserKaVipHelpPage = new WebFrom("UserKaVipHelpPage", 27, 29, z4, i4, defaultConstructorMarker5);
        ExternalLink = new WebFrom("ExternalLink", 28, 30, z3, i3, defaultConstructorMarker4);
        Unknow = new WebFrom("Unknow", 29, 100, z4, i4, defaultConstructorMarker5);
        WebFrom[] webFromArr$values = $values();
        $VALUES = webFromArr$values;
        $ENTRIES = EnumEntriesKt.enumEntries(webFromArr$values);
    }
    ...
    @NotNull
    public static EnumEntries<WebFrom> getEntries() {
        return $ENTRIES;
    }
