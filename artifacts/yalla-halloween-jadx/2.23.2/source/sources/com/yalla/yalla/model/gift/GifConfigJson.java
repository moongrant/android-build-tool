...
public final /* data */ class GifConfigJson {
    ...
    public GifConfigJson(int i, @NotNull String str, @NotNull String str2, @NotNull String str3, int i2, int i3) {
        OooO00o.OooO00o(str, "name", str2, "png", str3, "gif");
        this.id = i;
        this.name = str;
        this.png = str2;
        this.gif = str3;
    ...
    public int hashCode() {
        return ((OooO0O0.OooO00o(this.gif, OooO0O0.OooO00o(this.png, OooO0O0.OooO00o(this.name, this.id * 31, 31), 31), 31) + this.lowestVip) * 31) + this.lowestKAVIP;
    }
    ...
    public String toString() {
        ...
        StringBuilder sbOooO00o = oo0o0O0.OooO0O0.OooO00o("GifConfigJson(id=", i, ", name=", str, ", png=");
        OooO0OO.OooO0O0.OooO00o(sbOooO00o, str2, ", gif=", str3, ", lowestVip=");
        sbOooO00o.append(i2);
        sbOooO00o.append(", lowestKAVIP=");
        sbOooO00o.append(i3);
        sbOooO00o.append(")");
