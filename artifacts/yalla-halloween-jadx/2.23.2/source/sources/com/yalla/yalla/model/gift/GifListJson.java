...
public final /* data */ class GifListJson {
    ...
    public int hashCode() {
        ...
        int iOooO00o = OooO0O0.OooO00o(this.folderIcon, OooO0O0.OooO00o(this.folderName, (((((((((((i2 + r2) * 31) + ((int) (j ^ (j >>> 32)))) * 31) + this.dayNum) * 31) + this.payType) * 31) + this.price) * 31) + this.promotionPrice) * 31, 31), 31);
