...
public final /* data */ class SelectMusicModel implements Parcelable {
    ...
    public SelectMusicModel(long j, @NotNull String str, @NotNull String str2, long j2, @NotNull String str3) {
        OooO00o.OooO00o(str, "displayName", str2, "titleKey", str3, "filePath");
        this.durationMs = j;
    ...
    public int hashCode() {
        ...
        int iOooO00o = OooO0O0.OooO00o(this.titleKey, OooO0O0.OooO00o(this.displayName, ((int) (j ^ (j >>> 32))) * 31, 31), 31);
