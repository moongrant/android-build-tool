...
public final class MomentDetailModel implements Serializable {
    ...
    public final MomentForwardContent getForwardContent() {
        try {
            if (o00O00OO.OooO0o(this.forwardContent)) {
                return (MomentForwardContent) OooO.OooO0O0(MomentForwardContent.class, this.forwardContent);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public final ArrayList<MomentImageModel> getImageInfoList() {
        ...
        ArrayList<MomentImageModel> arrayListOooO00o = o000OOo0.OooO00o(this.pFName, this.pNumber, this.size);
        Intrinsics.checkNotNullExpressionValue(arrayListOooO00o, "getImageInfoList(...)");
    ...
    public final MutableLiveData<MomentPoll> getMomentPollLiveData() {
        try {
            ...
            if (mutableLiveData.getValue() == null && this.type == 21 && o00O00OO.OooO0o(this.forwardContent)) {
                MutableLiveData<MomentPoll> mutableLiveData2 = this.momentPoll;
                Intrinsics.checkNotNull(mutableLiveData2);
                mutableLiveData2.setValue((MomentPoll) OooO.OooO0O0(MomentPoll.class, this.forwardContent));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public final void transformBySendModel(@NotNull MomentSendModel sendModel) {
        ...
        this.headUrl = str;
        String str2 = (String) o0O00oO0.OooOOoo().getValue();
        if (str2 == null) {
            str2 = "";
        }
        this.nickName = str2;
        ...
        for (MomentSelectMedia momentSelectMedia : sendModel.getListSendPostMedia()) {
            ...
            if (momentImageModel.getDuration() == 0) {
                ...
                BitmapFactory.Options optionsOooO00o = b3.OooO00o(o000O00O.OooO00o(), momentSelectMedia.getPath());
