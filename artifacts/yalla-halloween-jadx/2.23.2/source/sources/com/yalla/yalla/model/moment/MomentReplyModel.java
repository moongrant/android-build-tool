...
public final class MomentReplyModel implements Serializable {
    ...
    public final MomentSendContentModel getContent() {
        ...
        Object objOooO0O0 = oOOO00.OooO0O0(this.content, new TypeToken<MomentSendContentModel>() { // from class: com.yalla.yalla.model.moment.MomentReplyModel.getContent.1
        }.getType());
    ...
    public final MomentReplyModel setLocalPostCommentReplyModel(@NotNull MomentSendCommentModel sendPostCommentModel) {
        ...
        this.content = OooO.OooO00o(sendPostCommentModel.getContent());
        o0O00oO0 o0o00oo1 = o0O00oO0.f47936OooO00o;
        this.userid = ((Number) OooO00o.OooO00o()).longValue();
        this.nickname = (String) o0O00oO0.OooOOoo().getValue();
        this.headurl = (String) o0O00oO0.OooO().getValue();
        T value = o0O00oO0.OooOOO().getValue();
