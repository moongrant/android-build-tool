...
public final /* data */ class RoomMemberTaskModel {
    ...
    public int hashCode() {
        int iOooO00o = OooO0O0.OooO00o(this.badgeUrl, ((this.badgeLevel * 31) + this.badgeSate) * 31, 31);
    ...
    public String toString() {
        int i = this.badgeLevel;
        int i2 = this.badgeSate;
        String str = this.badgeUrl;
        long j = this.dayFriendShip;
        long j2 = this.dayFriendShipLimit;
        long j3 = this.totalFriendShip;
        int i3 = this.memberLevel;
        int i4 = this.memberLevelLimit;
        int i5 = this.memberNum;
        List<RoomMemberTaskInfoModel> list = this.taskList;
        int i6 = this.weekRank;
        long j4 = this.totalProgress;
        long j5 = this.currentProgress;
        StringBuilder sbOooO00o = o00000.OooO00o("RoomMemberTaskModel(badgeLevel=", i, ", badgeSate=", i2, ", badgeUrl=");
        sbOooO00o.append(str);
        sbOooO00o.append(", dayFriendShip=");
        sbOooO00o.append(j);
        OooOOO0.OooO00o(sbOooO00o, ", dayFriendShipLimit=", j2, ", totalFriendShip=");
        sbOooO00o.append(j3);
        sbOooO00o.append(", memberLevel=");
        sbOooO00o.append(i3);
        sbOooO00o.append(", memberLevelLimit=");
        sbOooO00o.append(i4);
        sbOooO00o.append(", memberNum=");
        sbOooO00o.append(i5);
        sbOooO00o.append(", taskList=");
        sbOooO00o.append(list);
        sbOooO00o.append(", weekRank=");
        sbOooO00o.append(i6);
        OooOOO0.OooO00o(sbOooO00o, ", totalProgress=", j4, ", currentProgress=");
        return OooO0OO.OooO0O0(sbOooO00o, j5, ")");
    }
    ...
    public /* synthetic */ RoomMemberTaskModel(int i, int i2, String str, long j, long j2, long j3, int i3, int i4, int i5, List list, int i6, long j4, long j5, int i7, DefaultConstructorMarker defaultConstructorMarker) {
        this((i7 & 1) != 0 ? 0 : i, (i7 & 2) != 0 ? 0 : i2, (i7 & 4) != 0 ? "" : str, (i7 & 8) != 0 ? 0L : j, (i7 & 16) != 0 ? 0L : j2, (i7 & 32) != 0 ? 0L : j3, (i7 & 64) != 0 ? 0 : i3, (i7 & 128) != 0 ? 0 : i4, (i7 & PSKKeyManager.MAX_KEY_LENGTH_BYTES) != 0 ? 0 : i5, (i7 & ConstantsKt.MINIMUM_BLOCK_SIZE) != 0 ? CollectionsKt.emptyList() : list, (i7 & LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) != 0 ? 0 : i6, (i7 & 2048) != 0 ? 0L : j4, (i7 & 4096) != 0 ? 0L : j5);
    }
}
