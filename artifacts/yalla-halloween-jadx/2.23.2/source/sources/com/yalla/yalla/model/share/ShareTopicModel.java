...
public final /* data */ class ShareTopicModel {
    ...
    public int hashCode() {
        ...
        return this.msg.hashCode() + ((((OooO0O0.OooO00o(this.name, OooO0O0.OooO00o(this.image, (iHashCode + ((int) (j ^ (j >>> 32)))) * 31, 31), 31) + this.userCount) * 31) + this.momentCount) * 31);
    }
    ...
    public String toString() {
        ...
        sb.append(", circleId=");
        sb.append(j);
        OooO0OO.OooO0O0.OooO00o(sb, ", image=", str, ", name=", str2);
        sb.append(", userCount=");
        sb.append(i);
