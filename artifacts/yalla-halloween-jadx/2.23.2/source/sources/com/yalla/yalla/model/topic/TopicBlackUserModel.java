...
public final /* data */ class TopicBlackUserModel {
    ...
    public int hashCode() {
        int iOooO00o = OooO0O0.OooO00o(this.nickName, OooO0O0.OooO00o(this.imageurl, ((this.createTime * 31) + this.id) * 31, 31), 31);
    ...
    public String toString() {
        ...
        OooO0OO.OooO0O0.OooO00o(sbOooO00o, str, ", nickName=", str2, ", prettyId=");
        sbOooO00o.append(j);
        sbOooO00o.append(", sex=");
        sbOooO00o.append(i3);
        OooOOO0.OooO00o(sbOooO00o, ", userId=", j2, ", vip=");
        o000O0Oo.OooOOO0.OooO00o(sbOooO00o, i4, ", vipLevel=", i5, ", exUserid=");
        sbOooO00o.append(j3);
        sbOooO00o.append(", exRole=");
        sbOooO00o.append(i6);
        return androidx.compose.compiler.plugins.kotlin.OooO0O0.OooO00o(sbOooO00o, ", exnickName=", str3, ")");
    }
    ...
    public TopicBlackUserModel(int i, int i2, @NotNull String str, @NotNull String str2, long j, int i3, long j2, int i4, int i5, long j3, int i6, @NotNull String str3) {
        OooO00o.OooO00o(str, "imageurl", str2, "nickName", str3, "exnickName");
        this.createTime = i;
        this.id = i2;
        this.imageurl = str;
        this.nickName = str2;
