...
public final /* data */ class CountryItemData implements Parcelable {
    ...
    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0006\u0010\u0003\u001a\u00020\u0004¨\u0006\u0005"}, d2 = {"Lcom/yalla/yalla/model/user/CountryItemData$Companion;", "", "()V", "createDefault", "Lcom/yalla/yalla/model/user/CountryItemData;", "Common_YallaRelease"}, k = 1, mv = {1, 9, 0}, xi = 48)
    ...
    public int hashCode() {
        return this.isoCode.hashCode() + ((OooO0O0.OooO00o(this.icon, OooO0O0.OooO00o(this.countryName, this.countryCode.hashCode() * 31, 31), 31) + this.id) * 31);
    }
    ...
    public String toString() {
        ...
        StringBuilder sbOooO00o = OooO0OO.OooO00o("CountryItemData(countryCode=", str, ", countryName=", str2, ", icon=");
        sbOooO00o.append(str3);
        sbOooO00o.append(", id=");
        sbOooO00o.append(i);
        sbOooO00o.append(", isoCode=");
        return o0oOO.OooO0O0(sbOooO00o, str4, ")");
    }
