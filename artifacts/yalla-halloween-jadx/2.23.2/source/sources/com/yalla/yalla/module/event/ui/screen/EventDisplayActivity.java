...
import p450o0OoOooO.o0O0OO0;

/* JADX INFO: loaded from: classes4.dex */
@StabilityInferred(parameters = 0)
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0007\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Lcom/yalla/yalla/module/event/ui/screen/EventDisplayActivity;", "Lcom/yalla/yalla/ui/activity/BaseComposeActivity;", "<init>", "()V", "Event_YallaRelease"}, k = 1, mv = {1, 9, 0})
...
public final class EventDisplayActivity extends BaseComposeActivity {
    ...
    public static final /* synthetic */ int f23353OooO = 0;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    @NotNull
    public final ViewModelLazy f23354OooO0oo = new ViewModelLazy(Reflection.getOrCreateKotlinClass(EventDisplayViewModel.class), new Function0<ViewModelStore>() { // from class: com.yalla.yalla.module.event.ui.screen.EventDisplayActivity$special$$inlined$viewModels$default$2
        {
            super(0);
        }
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function0 f23359OooO0Oo = null;
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f23359OooO0Oo;
    ...
    public static final class OooO00o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ int f23356OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(int i) {
            super(2);
            this.f23356OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f23356OooO0o0 | 1);
    ...
    public final void OooOOOO(@Nullable Composer composer, int i) {
        ...
        if ((i & 1) == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            o0O0OO0.OooO0O0(composerStartRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public final void onCreate(@Nullable Bundle bundle) {
        ...
        EventDisplayViewModel eventDisplayViewModel = (EventDisplayViewModel) this.f23354OooO0oo.getValue();
