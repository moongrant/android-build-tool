...
public final class o00Oo0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f23487OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ EventDetailViewModel f23488OooO0o0;
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<EventCreateStateModel, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public /* synthetic */ Object f23489OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ EventDetailViewModel f23490OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(EventDetailViewModel eventDetailViewModel, Continuation<? super OooO00o> continuation) {
            super(2, continuation);
            this.f23490OooO0o0 = eventDetailViewModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO00o oooO00o = new OooO00o(this.f23490OooO0o0, continuation);
            oooO00o.f23489OooO0Oo = obj;
            return oooO00o;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            EventCreateScreen.INSTANCE.copyEvent(this.f23490OooO0o0.getEventModel(), (EventCreateStateModel) this.f23489OooO0Oo);
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<ApiResult<EventCreateStateModel>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ EventDetailViewModel f23491OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(EventDetailViewModel eventDetailViewModel, Continuation<? super OooO0O0> continuation) {
            super(2, continuation);
            this.f23491OooO0Oo = eventDetailViewModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0O0(this.f23491OooO0Oo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            IntrinsicsKt.getCOROUTINE_SUSPENDED();
            ResultKt.throwOnFailure(obj);
            this.f23491OooO0Oo.getShowLoadingDialog().setValue(Boxing.boxBoolean(false));
            return Unit.INSTANCE;
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00Oo0(EventDetailViewModel eventDetailViewModel, Continuation<? super o00Oo0> continuation) {
        super(2, continuation);
        this.f23488OooO0o0 = eventDetailViewModel;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o00Oo0(this.f23488OooO0o0, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f23487OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            EventDetailViewModel eventDetailViewModel = this.f23488OooO0o0;
            ...
            this.f23487OooO0Oo = 1;
            if (p384o0OOoo0O.o00O0O.OooO00o(createEventState, oooO00o, oooO0O0, this, 10) == coroutine_suspended) {
