...
public final class o00Ooo extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ EventDetailViewModel f23492OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00Ooo(EventDetailViewModel eventDetailViewModel) {
        super(0);
        this.f23492OooO0Oo = eventDetailViewModel;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        EventDetailViewModel eventDetailViewModel = this.f23492OooO0Oo;
