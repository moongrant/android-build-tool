...
public final class EventCreateViewModel extends OooOO0 {
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<o00OO0O0<ApiResult<Long>>, Continuation<? super Unit>, Object> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public String f23601OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public long f23602OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public long f23603OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public int f23604OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public /* synthetic */ Object f23605OooO0oo;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public final /* synthetic */ String f23606OooOO0;

        /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
        public final /* synthetic */ String f23607OooOO0O;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(String str, String str2, Continuation<? super OooO00o> continuation) {
            super(2, continuation);
            this.f23606OooOO0 = str;
            this.f23607OooOO0O = str2;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO00o oooO00o = EventCreateViewModel.this.new OooO00o(this.f23606OooOO0, this.f23607OooOO0O, continuation);
            oooO00o.f23605OooO0oo = obj;
            return oooO00o;
        }
        ...
        /* JADX WARN: Code duplicated, block: B:46:0x0165 A[RETURN] */
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i2 = this.f23604OooO0oO;
            EventCreateViewModel eventCreateViewModel = EventCreateViewModel.this;
            if (i2 != 0) {
                if (i2 == 1) {
                    o00oo0o1 = (o00OO0O0) this.f23605OooO0oo;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i2 != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                    }
                    j2 = this.f23602OooO0o;
                    j = this.f23603OooO0o0;
                    str = this.f23601OooO0Oo;
                    o00oo0o2 = (o00OO0O0) this.f23605OooO0oo;
                    ResultKt.throwOnFailure(obj);
                }
            ...
            if (eventCreateViewModel.getHeadPath().length() > 0) {
                if (eventCreateViewModel.getHeadUrl().length() == 0) {
                    ...
                    this.f23605OooO0oo = o00oo0o1;
                    this.f23604OooO0oO = 1;
            ...
            this.f23605OooO0oo = o00oo0o2;
            this.f23601OooO0Oo = describe;
            this.f23603OooO0o0 = timeInMillis;
            this.f23602OooO0o = timeInMillis2;
            this.f23604OooO0oO = 2;
            ...
            o0oooooOooO00o.OooO0O0(this.f23606OooOO0, "createToken");
            o0oooooOooO00o.OooO0O0(this.f23607OooOO0O, "RoomId");
            ...
            o0ooOOo o0oooooOooO00o2 = p391o0OOooo0.oo000o.OooO00o(strOooO0O1, "url", strOooO0O1, 1);
            o0oooooOooO00o2.OooO0O0(this.f23606OooOO0, "createToken");
            o0oooooOooO00o2.OooO0O0(this.f23607OooOO0O, "RoomId");
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public Object f23608OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public int f23610OooO0o0;
        ...
        public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ ApiResult<List<EventTagModel>> f23611OooO0Oo;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public final /* synthetic */ EventCreateViewModel f23612OooO0o0;
            ...
            public OooO00o(ApiResult<List<EventTagModel>> apiResult, EventCreateViewModel eventCreateViewModel, Continuation<? super OooO00o> continuation) {
                super(2, continuation);
                this.f23611OooO0Oo = apiResult;
                this.f23612OooO0o0 = eventCreateViewModel;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                return new OooO00o(this.f23611OooO0Oo, this.f23612OooO0o0, continuation);
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                ResultKt.throwOnFailure(obj);
                ApiResult<List<EventTagModel>> apiResult = this.f23611OooO0Oo;
                if (apiResult.isSuccess() && (data = apiResult.getData()) != null) {
                    EventCreateViewModel eventCreateViewModel = this.f23612OooO0o0;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            eventCreateViewModel.getShowLoadingDialog().setValue(Boxing.boxBoolean(true));
            this.f23610OooO0o0 = 1;
            String strOooO0O0 = oo000o.OooO0O0("/Webservers/Event/GetTagList");
            obj = OooOOO.OooO0Oo(new EventRepo$getTagList$$inlined$call$1(p391o0OOooo0.oo000o.OooO00o(strOooO0O0, "url", strOooO0O0, 0), null), this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            MainCoroutineDispatcher main = Dispatchers.getMain();
            OooO00o oooO00o = new OooO00o((ApiResult) obj, eventCreateViewModel, null);
            this.f23608OooO0Oo = obj;
            this.f23610OooO0o0 = 2;
    ...
    @NotNull
    public final o00OO0O0<ApiResult<Long>> create(@NotNull String createToken, @NotNull String roomId) {
        Intrinsics.checkNotNullParameter(createToken, "createToken");
        Intrinsics.checkNotNullParameter(roomId, "roomId");
        return o00O.OooO00o(this, new OooO00o(createToken, roomId, null));
    }
