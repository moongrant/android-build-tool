...
@Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\b\u0007\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0017\u0010\u0018J\u0006\u0010\u0003\u001a\u00020\u0002R+\u0010\b\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00048F@FX\u0086\u008e\u0002¢\u0006\u0012\n\u0004\b\u0006\u0010\u0007\u001a\u0004\b\b\u0010\t\"\u0004\b\n\u0010\u000bR\u001d\u0010\r\u001a\b\u0012\u0004\u0012\u00020\u00040\f8\u0006¢\u0006\f\n\u0004\b\r\u0010\u000e\u001a\u0004\b\u000f\u0010\u0010R\u001d\u0010\u0013\u001a\b\u0012\u0004\u0012\u00020\u00120\u00118\u0006¢\u0006\f\n\u0004\b\u0013\u0010\u0014\u001a\u0004\b\u0015\u0010\u0016¨\u0006\u0019"}, d2 = {"Lcom/yalla/yalla/module/event/vm/EventSquareViewModel;", "Lo0Oo0/OooOO0;", "", "sortEvent", "", "<set-?>", "isSortByTime$delegate", "Landroidx/compose/runtime/MutableState;", "isSortByTime", "()Z", "setSortByTime", "(Z)V", "Lkotlinx/coroutines/flow/MutableSharedFlow;", "refreshEvent", "Lkotlinx/coroutines/flow/MutableSharedFlow;", "getRefreshEvent", "()Lkotlinx/coroutines/flow/MutableSharedFlow;", "Lo00o00oO/o000;", "Lcom/yalla/yalla/model/event/EventModel;", "squareEventPager", "Lo00o00oO/o000;", "getSquareEventPager", "()Lo00o00oO/o000;", "<init>", "()V", "Event_YallaRelease"}, k = 1, mv = {1, 9, 0})
@SourceDebugExtension({"SMAP\nEventSquareViewModel.kt\nKotlin\n*S Kotlin\n*F\n+ 1 EventSquareViewModel.kt\ncom/yalla/yalla/module/event/vm/EventSquareViewModel\n+ 2 SnapshotState.kt\nandroidx/compose/runtime/SnapshotStateKt__SnapshotStateKt\n*L\n1#1,42:1\n81#2:43\n107#2,2:44\n*S KotlinDebug\n*F\n+ 1 EventSquareViewModel.kt\ncom/yalla/yalla/module/event/vm/EventSquareViewModel\n*L\n17#1:43\n17#1:44,2\n*E\n"})
public final class EventSquareViewModel extends OooOO0 {
    ...
    @NotNull
    private final o000<EventModel> squareEventPager = new o000<>(ViewModelKt.getViewModelScope(this), new OooO0O0(null));
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<Integer, Continuation<? super o000Oo0<EventModel>>, Object> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f23635OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ int f23637OooO0o0;

        public static final class OooO00o extends Lambda implements Function1<EventModel, Boolean> {

            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public static final OooO00o f23638OooO0Oo = new OooO00o();
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            ...
            oooO0O0.f23637OooO0o0 = ((Number) obj).intValue();
            return oooO0O0;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            int i;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i2 = this.f23635OooO0Oo;
            EventSquareViewModel eventSquareViewModel = EventSquareViewModel.this;
            if (i2 == 0) {
                ResultKt.throwOnFailure(obj);
                int i3 = this.f23637OooO0o0;
                int i4 = eventSquareViewModel.isSortByTime() ? 1 : 2;
                this.f23637OooO0o0 = i3;
                this.f23635OooO0Oo = 1;
                String strOooO0O0 = oo000o.OooO0O0("/Webservers/Event/GetList");
                o0ooOOo o0oooooOooO00o = p391o0OOooo0.oo000o.OooO00o(strOooO0O0, "url", strOooO0O0, 0);
                o0oooooOooO00o.OooO0O0(Boxing.boxInt(i4), "ordertype");
                o0oooooOooO00o.OooO0O0(Boxing.boxInt(i3), "pageindex");
                Object objOooO0Oo = OooOOO.OooO0Oo(new EventRepo$getSquareEventList$$inlined$call$1(o0oooooOooO00o, null), this);
            ...
            if (!eventSquareViewModel.isSortByTime() && i == 1) {
                ...
                o0oo0000.OooO00o.OooO0OO("301001", MapsKt.mapOf(new Pair("roomeventlist", arrayList.toString())));
            }
            List list2 = (List) apiResult.getData();
            if (list2 != null) {
                Boxing.boxBoolean(CollectionsKt.removeAll(list2, (Function1) OooO00o.f23638OooO0Oo));
            }
    ...
    @NotNull
    public final o000<EventModel> getSquareEventPager() {
