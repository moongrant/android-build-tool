...
public final class OooO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ Uri f24144OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooO(Uri uri, Continuation<? super OooO> continuation) {
        super(2, continuation);
        this.f24144OooO0Oo = uri;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new OooO(this.f24144OooO0Oo, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (oo0o0Oo.OooO0o0() || ((Boolean) Oooo0.f47822OooO0O0.getValue()).booleanValue()) {
            Lazy lazy = o00O0OO0.f47783OooO00o;
            OooOOO.OooO0O0(GlobalScope.INSTANCE, new o00O0O00(2000L, null));
        }
        Intrinsics.checkNotNullParameter("视频压缩成功", ShareConstants.WEB_DIALOG_PARAM_MESSAGE);
        LiveEventBus.get("MOMENT_SEND_EDIT_VIDEO_URI").post(this.f24144OooO0Oo);
