...
public final class FecebookOAuth {
    ...
    @NotNull
    public final FragmentActivity f24249OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public final CallbackManager f24250OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @Nullable
    public Function1<? super String, Unit> f24251OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @Nullable
    public Function0<Unit> f24252OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @Nullable
    public Function0<Unit> f24253OooO0o0;
    ...
    public static final class OooO00o implements FacebookCallback<LoginResult> {
        ...
        public final void onCancel() {
            Function0<Unit> function0 = FecebookOAuth.this.f24252OooO0Oo;
            if (function0 != null) {
                function0.invoke();
            }
        }
        ...
        public final void onError(@NotNull FacebookException error) {
            ...
            o0000O00.OooO0o0("FecebookOAuth", "FecebookOAuthError", error);
            Function0<Unit> function0 = FecebookOAuth.this.f24253OooO0o0;
            if (function0 != null) {
                function0.invoke();
            }
        }
        ...
        public final void onSuccess(LoginResult loginResult) {
            ...
            Function1<? super String, Unit> function1 = FecebookOAuth.this.f24251OooO0OO;
            if (function1 != null) {
    ...
    public FecebookOAuth(@NotNull FragmentActivity fragmentActivity) {
        ...
        this.f24249OooO00o = fragmentActivity;
        CallbackManager callbackManagerCreate = CallbackManager.Factory.create();
        this.f24250OooO0O0 = callbackManagerCreate;
        ...
        fragmentActivity.getLifecycle().addObserver(new DefaultLifecycleObserver() { // from class: com.yalla.yalla.open_auth.FecebookOAuth.2
            ...
            public final void onDestroy(@NotNull LifecycleOwner owner) {
                ...
                fecebookOAuth.f24251OooO0OO = null;
                fecebookOAuth.f24252OooO0Oo = null;
                fecebookOAuth.f24253OooO0o0 = null;
                try {
                    try {
                        ...
                        o0000O00.OooO0o0("OAuthManager", "Facebook Logout Error", e);
                        companion2 = LoginManager.INSTANCE.getInstance();
                    }
                    fecebookOAuth = fecebookOAuth.f24250OooO0O0;
                    companion2.unregisterCallback(fecebookOAuth);
                } catch (Throwable th) {
                    LoginManager.INSTANCE.getInstance().unregisterCallback(fecebookOAuth.f24250OooO0O0);
                    throw th;
                }
            }
