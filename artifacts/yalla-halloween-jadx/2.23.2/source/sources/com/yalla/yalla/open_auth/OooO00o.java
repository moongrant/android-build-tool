...
public final class OooO00o extends Lambda implements Function1<String, Unit> {
    ...
    public final /* synthetic */ OpenAuthManager f24261OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooO00o(OpenAuthManager openAuthManager) {
        super(1);
        this.f24261OooO0Oo = openAuthManager;
    }
    ...
    public final Unit invoke(String str) {
        ...
        Function3<? super String, ? super OpenAuthManager.AuthType, ? super String, Unit> function3 = this.f24261OooO0Oo.f24267OooO0O0;
        if (function3 != null) {
