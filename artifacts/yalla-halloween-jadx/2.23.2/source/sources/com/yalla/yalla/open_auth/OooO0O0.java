...
public final class OooO0O0 extends Lambda implements Function2<String, String, Unit> {
    ...
    public final /* synthetic */ OpenAuthManager f24262OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooO0O0(OpenAuthManager openAuthManager) {
        super(2);
        this.f24262OooO0Oo = openAuthManager;
    }
    ...
    public final Unit invoke(String str, String str2) {
        ...
        Function3<? super String, ? super OpenAuthManager.AuthType, ? super String, Unit> function3 = this.f24262OooO0Oo.f24267OooO0O0;
        if (function3 != null) {
