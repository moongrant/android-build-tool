...
public final class AppConfigRepo extends oO0O000o {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    @NotNull
    public static final AppConfigRepo f24292OooO00o = new AppConfigRepo();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public static final MutableLiveData<Boolean> f24293OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @NotNull
    public static final MutableLiveData<Boolean> f24294OooO0OO;

    @DebugMetadata(c = "com.yalla.yalla.repository.AppConfigRepo", f = "AppConfigRepo.kt", i = {}, l = {107}, m = "getInitConfig", n = {}, s = {})
    public static final class OooO00o extends ContinuationImpl {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public /* synthetic */ Object f24295OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f24296OooO0o;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f24295OooO0Oo = obj;
            this.f24296OooO0o |= Integer.MIN_VALUE;
            return AppConfigRepo.this.OooO0OO(this);
        }
    }

    @DebugMetadata(c = "com.yalla.yalla.repository.AppConfigRepo", f = "AppConfigRepo.kt", i = {}, l = {107}, m = "updateKeyStore", n = {}, s = {})
    public static final class OooO0O0 extends ContinuationImpl {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public /* synthetic */ Object f24298OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f24299OooO0o;
        ...
        @Nullable
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f24298OooO0Oo = obj;
            this.f24299OooO0o |= Integer.MIN_VALUE;
            return AppConfigRepo.this.OooO0Oo(this);
        }
    }
    ...
    static {
        ...
        f24293OooO0O0 = new MutableLiveData<>(bool);
        f24294OooO0OO = new MutableLiveData<>(bool);
    }
    ...
    public final Object OooO0OO(@NotNull Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof OooO00o) {
            ...
            int i = oooO00o.f24296OooO0o;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO00o.f24296OooO0o = i - Integer.MIN_VALUE;
            } else {
        ...
        Object objOooO0Oo = oooO00o.f24295OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = oooO00o.f24296OooO0o;
        if (i2 == 0) {
        ...
        if (getInitConfigModel != null) {
            GetInitConfigModel.VideoPostConf videoPostConf = getInitConfigModel.getVideoPostConf();
            if (videoPostConf != null) {
                o000oOoO.f49574OooO00o = videoPostConf.getMinDuration();
                o000oOoO.f49575OooO0O0 = videoPostConf.getMaxDuration();
                o000oOoO.f49576OooO0OO = videoPostConf.getMaxFileSize();
            }
            GetInitConfigModel.FacebookConf facebookConf = getInitConfigModel.getFacebookConf();
            if (facebookConf != null) {
                f24293OooO0O0.postValue(Boxing.boxBoolean(!facebookConf.getCanUseFacebookLogin()));
                f24294OooO0OO.postValue(Boxing.boxBoolean(!facebookConf.getCanUseFacebookShare()));
            }
        }
        return Unit.INSTANCE;
    }
    ...
    public final Object OooO0Oo(@NotNull Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof OooO0O0) {
            ...
            int i = oooO0O0.f24299OooO0o;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO0O0.f24299OooO0o = i - Integer.MIN_VALUE;
            } else {
        ...
        Object objOooO0Oo = oooO0O0.f24298OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = oooO0O0.f24299OooO0o;
        if (i2 == 0) {
            ResultKt.throwOnFailure(objOooO0Oo);
            String url = oo000o.OooO0OO("/Webservers/Api/Info");
            Intrinsics.checkNotNullParameter(url, "url");
            o0ooOOo o0ooooo = new o0ooOOo(url, 0);
            o0ooooo.OooO0O0(Boxing.boxInt(o00Ooo.OooO0o().OooO0OO(ServerProtocol.FALLBACK_DIALOG_PARAM_VERSION, 0)), ServerProtocol.FALLBACK_DIALOG_PARAM_VERSION);
        ...
        if (appConfigModel != null) {
            o00Ooo.OooO0o().OooO0oO(appConfigModel.getVersion(), ServerProtocol.FALLBACK_DIALOG_PARAM_VERSION);
            if (appConfigModel.getIsGet() && (!StringsKt.isBlank(appConfigModel.getDomainName()))) {
                int i3 = o00000OO.f56659OooO00o;
                String domainName = appConfigModel.getDomainName();
                Intrinsics.checkNotNullParameter(domainName, "<set-?>");
                o00000OO.f56660OooO0O0 = domainName;
            } else {
                int i4 = o00000OO.f56659OooO00o;
                Intrinsics.checkNotNullParameter("", "<set-?>");
                o00000OO.f56660OooO0O0 = "";
            }
            long jCurrentTimeMillis = System.currentTimeMillis() / ((long) 1000);
            Lazy lazy = o0OOO0o.f43500OooO0O0;
            o0OOO0o.f43499OooO00o = appConfigModel.getTime() - jCurrentTimeMillis;
            o00Ooo.OooO00o().OooO0oO(appConfigModel.getFirstRecharge(), "firstRecharge");
            o00Ooo.OooO00o().OooO0oO(appConfigModel.getPhoneCodeType(), "phoneCodeType");
            ...
            o00Ooo.OooO00o().OooO0o("redemptionCodeIsOpenCDK", appConfigModel.getRedemptionCodeIsOpenCDK());
            ...
            o00Ooo.OooO0O0().OooO0oO(appConfigModel.getSocketSwitch(), "socket");
            ...
            f24292OooO00o.getClass();
            if (appConfigModel.getUpt()) {
                byte[] bArrRsaDecrypt = RSAKt.rsaDecrypt(Base64ExtensionsKt.base64Decode(appConfigModel.getBf()), oOO0Oo00.OooO0O0("K2"));
                ...
                AppKeyModel appKeyModel = (AppKeyModel) oOOO00.OooO00o(new String(AESKt.aesDecrypt$default(bArrBase64Decode, str, bArr, (String) null, 4, (Object) null), charset), AppKeyModel.class);
                oO000Oo0 oo000oo0OooO0o3 = o00Ooo.OooO0o();
                ...
                oO000Oo0 oo000oo0OooO0o4 = o00Ooo.OooO0o();
                ...
                oO000Oo0 oo000oo0OooO0o5 = o00Ooo.OooO0o();
                String value7 = appKeyModel.getInstagram().getKeyId();
                oo000oo0OooO0o5.getClass();
                Intrinsics.checkNotNullParameter(value7, "value");
                oo000oo0OooO0o5.OooO(String.valueOf(-372408188), Base64ExtensionsKt.base64EncodeToString(AESKt.aesEncrypt$default(value7, oOO0Oo00.OooO00o(), bArr, (String) null, 4, (Object) null)));
                oO000Oo0 oo000oo0OooO0o6 = o00Ooo.OooO0o();
                String value8 = appKeyModel.getInstagram().getSecret();
                oo000oo0OooO0o6.getClass();
                Intrinsics.checkNotNullParameter(value8, "value");
                oo000oo0OooO0o6.OooO(String.valueOf(-2019988625), Base64ExtensionsKt.base64EncodeToString(AESKt.aesEncrypt$default(value8, oOO0Oo00.OooO00o(), bArr, (String) null, 4, (Object) null)));
                oO000Oo0 oo000oo0OooO0o7 = o00Ooo.OooO0o();
                String value9 = appKeyModel.getWechat().getKeyId();
                oo000oo0OooO0o7.getClass();
                Intrinsics.checkNotNullParameter(value9, "value");
                oo000oo0OooO0o7.OooO(String.valueOf(1657547256), Base64ExtensionsKt.base64EncodeToString(AESKt.aesEncrypt$default(value9, oOO0Oo00.OooO00o(), bArr, (String) null, 4, (Object) null)));
                oO000Oo0 oo000oo0OooO0o8 = o00Ooo.OooO0o();
                String value10 = appKeyModel.getZego().getKeyId();
                oo000oo0OooO0o8.getClass();
                Intrinsics.checkNotNullParameter(value10, "value");
                oo000oo0OooO0o8.OooO(String.valueOf(371703205), Base64ExtensionsKt.base64EncodeToString(AESKt.aesEncrypt$default(value10, oOO0Oo00.OooO00o(), bArr, (String) null, 4, (Object) null)));
                oO000Oo0 oo000oo0OooO0o9 = o00Ooo.OooO0o();
                String value11 = appKeyModel.getAgora().getKeyId();
                oo000oo0OooO0o9.getClass();
                Intrinsics.checkNotNullParameter(value11, "value");
                oo000oo0OooO0o9.OooO(String.valueOf(-1319252278), Base64ExtensionsKt.base64EncodeToString(AESKt.aesEncrypt$default(value11, oOO0Oo00.OooO00o(), bArr, (String) null, 4, (Object) null)));
                oO000Oo0 oo000oo0OooO0o10 = o00Ooo.OooO0o();
                String value12 = appKeyModel.getAppsFlyer().getKeyId();
                oo000oo0OooO0o10.getClass();
                Intrinsics.checkNotNullParameter(value12, "value");
                oo000oo0OooO0o10.OooO(String.valueOf(-1347112992), Base64ExtensionsKt.base64EncodeToString(AESKt.aesEncrypt$default(value12, oOO0Oo00.OooO00o(), bArr, (String) null, 4, (Object) null)));
                oO000Oo0 oo000oo0OooO0o11 = o00Ooo.OooO0o();
                ...
                oO000Oo0 oo000oo0OooO0o12 = o00Ooo.OooO0o();
                ...
                oO000Oo0 oo000oo0OooO0o13 = o00Ooo.OooO0o();
                ...
                oO000Oo0 oo000oo0OooO0o14 = o00Ooo.OooO0o();
                ...
                oO000Oo0 oo000oo0OooO0o15 = o00Ooo.OooO0o();
