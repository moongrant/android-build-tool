...
import p475o0Ooooo0.oO0O00;
import p475o0Ooooo0.oO0O000o;
import p475o0Ooooo0.oO0O00O;
...
public final class CloudFileRepo$loadToken$$inlined$call$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Response<UploadTokenModel>>, Object> {
    ...
    public int f24312OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ CloudFileType f24313OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ oO0O000o f24314OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final /* synthetic */ Long f24315OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final /* synthetic */ Boolean f24316OooO0oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CloudFileRepo$loadToken$$inlined$call$1(oO0O000o oo0o000o, Continuation continuation, CloudFileType cloudFileType, Long l, Boolean bool) {
        super(2, continuation);
        this.f24314OooO0o0 = oo0o000o;
        this.f24313OooO0o = cloudFileType;
        this.f24315OooO0oO = l;
        this.f24316OooO0oo = bool;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new CloudFileRepo$loadToken$$inlined$call$1(this.f24314OooO0o0, continuation, this.f24313OooO0o, this.f24315OooO0oO, this.f24316OooO0oo);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
        ...
        int i = this.f24312OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            final oO0O000o oo0o000o = this.f24314OooO0o0;
            this.f24312OooO0Oo = 1;
            ...
            OooO0OO.OooO0O0 callback = new OooO0OO.OooO0O0() { // from class: com.yalla.yalla.repository.CloudFileRepo$loadToken$$inlined$call$1.1
                ...
                public final void OooO0O0(@Nullable String str2, @Nullable String str3) {
                    ...
                    cancellableContinuationImpl.resumeWith(o0000O0.OooO00o(oo0o000o, str2, str3));
                }
                ...
                public final void OooO0o0(@Nullable String str2) {
                    ...
                    if (z) {
                        ...
                        OooO0o.OooO0O0(oo0o000o2, (Response) o0000O0O.OooO0OO.OooO00o(type, str2, type), cancellableContinuation);
                    }
                }
            };
            CloudFileType type = this.f24313OooO0o;
            ...
            Long l = this.f24315OooO0oO;
            if (l != null) {
                linkedHashMapOooO00o.put("sourceId", String.valueOf(l.longValue()));
            }
            switch (oO0O00.$EnumSwitchMapping$0[type.ordinal()]) {
                case 1:
                    list = Oooo0.f43359OooOoo;
                ...
                case 15:
                case 16:
                    list = Oooo0.f43408o0000O0O;
                    p423o0OoO0OO.o0000O0.OooO00o(this.f24316OooO0oo, new oO0O00O(linkedHashMapOooO00o));
