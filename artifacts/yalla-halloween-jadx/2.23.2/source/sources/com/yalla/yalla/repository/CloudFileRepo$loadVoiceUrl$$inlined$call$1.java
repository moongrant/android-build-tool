...
public final class CloudFileRepo$loadVoiceUrl$$inlined$call$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Response<ChangeUrlModel>>, Object> {
    ...
    public int f24319OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ String f24320OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ oO0O000o f24321OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CloudFileRepo$loadVoiceUrl$$inlined$call$1(oO0O000o oo0o000o, Continuation continuation, String str) {
        super(2, continuation);
        this.f24321OooO0o0 = oo0o000o;
        this.f24320OooO0o = str;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new CloudFileRepo$loadVoiceUrl$$inlined$call$1(this.f24321OooO0o0, continuation, this.f24320OooO0o);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
        ...
        int i = this.f24319OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            final oO0O000o oo0o000o = this.f24321OooO0o0;
            this.f24319OooO0Oo = 1;
            ...
            linkedHashMapOooO00o.put("voiceurl", this.f24320OooO0o);
            linkedHashMapOooO00o.put("timelong", AppEventsConstants.EVENT_PARAM_VALUE_NO);
            OooO0OO.OooO0O0(null, Oooo0.f43359OooOoo, Oooo0.f43381OoooOo0, linkedHashMapOooO00o, oooO0O0);
