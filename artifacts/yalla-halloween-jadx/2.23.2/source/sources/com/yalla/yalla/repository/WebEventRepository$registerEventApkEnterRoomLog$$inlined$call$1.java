...
import com.yalla.yalla.model.EnterRoomLogJsonValue;
...
@DebugMetadata(c = "com.yalla.yalla.repository.WebEventRepository$registerEventApkEnterRoomLog$$inlined$call$1", f = "WebEventRepository.kt", i = {}, l = {73}, m = "invokeSuspend", n = {}, s = {})
...
public final class WebEventRepository$registerEventApkEnterRoomLog$$inlined$call$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Response<String>>, Object> {
    ...
    public final /* synthetic */ EnterRoomParentPage f24457OooO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public int f24458OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ ArrayList f24459OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ oO0O000o f24460OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final /* synthetic */ ArrayList f24461OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final /* synthetic */ String f24462OooO0oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WebEventRepository$registerEventApkEnterRoomLog$$inlined$call$1(oO0O000o oo0o000o, Continuation continuation, ArrayList arrayList, ArrayList arrayList2, String str, EnterRoomParentPage enterRoomParentPage) {
        super(2, continuation);
        this.f24460OooO0o0 = oo0o000o;
        this.f24459OooO0o = arrayList;
        this.f24461OooO0oO = arrayList2;
        this.f24462OooO0oo = str;
        this.f24457OooO = enterRoomParentPage;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new WebEventRepository$registerEventApkEnterRoomLog$$inlined$call$1(this.f24460OooO0o0, continuation, this.f24459OooO0o, this.f24461OooO0oO, this.f24462OooO0oo, this.f24457OooO);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
        ...
        int i = this.f24458OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            final oO0O000o oo0o000o = this.f24460OooO0o0;
            this.f24458OooO0Oo = 1;
            ...
            OooO0OO.OooO0O0 callback = new OooO0OO.OooO0O0() { // from class: com.yalla.yalla.repository.WebEventRepository$registerEventApkEnterRoomLog$$inlined$call$1.1
                ...
                public final void OooO0o0(@Nullable String str) {
                    ...
                    if (z) {
                        ...
                        Type type = new TypeToken<Response<String>>() { // from class: com.yalla.yalla.repository.WebEventRepository$registerEventApkEnterRoomLog$.inlined.call.1.1.1
                        }.getType();
            ...
            String roomId = this.f24462OooO0oo;
            Intrinsics.checkNotNullParameter(roomId, "roomId");
            EnterRoomParentPage sourcePage = this.f24457OooO;
            Intrinsics.checkNotNullParameter(sourcePage, "sourcePage");
            Intrinsics.checkNotNullParameter(callback, "callback");
            StringBuffer stringBuffer = new StringBuffer();
            ArrayList<String> arrayList = this.f24459OooO0o;
            ...
            ArrayList<String> arrayList2 = this.f24461OooO0oO;
            if (arrayList2 != null) {
            ...
            enterRoomLogJsonValue.setUserId(String.valueOf(linkedHashMapOooO00o.get("userid")));
            ...
            linkedHashMapOooO00o.put("jsonvalue", enterRoomLogJsonValue.toJson());
            OooO0OO.OooO0OO(Oooo0.f43421o0000oO, "/Webservers/Apk/EnterRoomLog", linkedHashMapOooO00o, callback);
