...
public final class WebEventRepository$registerEventApkRoomExposureLog$$inlined$call$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Response<String>>, Object> {
    ...
    public final /* synthetic */ ArrayList f24466OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ oO0O000o f24467OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final /* synthetic */ ArrayList f24468OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final /* synthetic */ EnterRoomParentPage f24469OooO0oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WebEventRepository$registerEventApkRoomExposureLog$$inlined$call$1(oO0O000o oo0o000o, Continuation continuation, ArrayList arrayList, ArrayList arrayList2, EnterRoomParentPage enterRoomParentPage) {
        super(2, continuation);
        this.f24467OooO0o0 = oo0o000o;
        this.f24466OooO0o = arrayList;
        this.f24468OooO0oO = arrayList2;
        this.f24469OooO0oo = enterRoomParentPage;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new WebEventRepository$registerEventApkRoomExposureLog$$inlined$call$1(this.f24467OooO0o0, continuation, this.f24466OooO0o, this.f24468OooO0oO, this.f24469OooO0oo);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
        ...
        int i = this.f24465OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            final oO0O000o oo0o000o = this.f24467OooO0o0;
            this.f24465OooO0Oo = 1;
            ...
            EnterRoomParentPage expoSource = this.f24469OooO0oo;
            Intrinsics.checkNotNullParameter(expoSource, "expoSource");
            Intrinsics.checkNotNullParameter(callback, "callback");
            ArrayList arrayList = this.f24466OooO0o;
            if (arrayList != null && !arrayList.isEmpty()) {
                ...
                ArrayList<String> arrayList2 = this.f24468OooO0oO;
                if (arrayList2 != null) {
                ...
                roomExposureLogJsonValue.setUserId(String.valueOf(linkedHashMapOooO00o.get("userid")));
                ...
                linkedHashMapOooO00o.put("jsonvalue", roomExposureLogJsonValue.toJson());
                OooO0OO.OooO0OO(Oooo0.f43421o0000oO, "/Webservers/Apk/RoomExposureLog", linkedHashMapOooO00o, callback);
            }
