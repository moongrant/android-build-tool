...
import com.yalla.yalla.model.UserVoiceLogJsonValue;
...
public final class WebEventRepository$uploadRoomVoice$$inlined$call$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Response<String>>, Object> {
    ...
    public int f24472OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ List f24473OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ oO0O000o f24474OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final /* synthetic */ long f24475OooO0oO;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WebEventRepository$uploadRoomVoice$$inlined$call$1(oO0O000o oo0o000o, Continuation continuation, List list, long j) {
        super(2, continuation);
        this.f24474OooO0o0 = oo0o000o;
        this.f24473OooO0o = list;
        this.f24475OooO0oO = j;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new WebEventRepository$uploadRoomVoice$$inlined$call$1(this.f24474OooO0o0, continuation, this.f24473OooO0o, this.f24475OooO0oO);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
        ...
        int i = this.f24472OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            final oO0O000o oo0o000o = this.f24474OooO0o0;
            this.f24472OooO0Oo = 1;
            ...
            OooO0OO.OooO0O0 callback = new OooO0OO.OooO0O0() { // from class: com.yalla.yalla.repository.WebEventRepository$uploadRoomVoice$$inlined$call$1.1
                ...
                public final void OooO0o0(@Nullable String str) {
                    ...
                    if (z) {
                        ...
                        Type type = new TypeToken<Response<String>>() { // from class: com.yalla.yalla.repository.WebEventRepository$uploadRoomVoice$.inlined.call.1.1.1
                        }.getType();
            ...
            for (RoomVoiceModule.TimeVoice timeVoice : this.f24473OooO0o) {
                if (timeVoice != null) {
            ...
            Intrinsics.checkNotNullExpressionValue(timeVoice2, "toString(...)");
            String roomId = String.valueOf(this.f24475OooO0oO);
            ...
            userVoiceLogJsonValue.setUserId(String.valueOf(linkedHashMapOooO00o.get("userid")));
            ...
            linkedHashMapOooO00o.put("jsonvalue", userVoiceLogJsonValue.toJson());
            OooO0OO.OooO0OO(Oooo0.f43421o0000oO, "/Webservers/Apk/UserVoiceLog", linkedHashMapOooO00o, callback);
