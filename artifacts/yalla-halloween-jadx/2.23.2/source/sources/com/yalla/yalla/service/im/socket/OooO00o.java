...
public final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f24503OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ boolean f24504OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ IMSocketManagerOld f24505OooO0o0;
    ...
    public static final class C0314OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ IMSocketManagerOld f24506OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C0314OooO00o(IMSocketManagerOld iMSocketManagerOld, Continuation<? super C0314OooO00o> continuation) {
            super(2, continuation);
            this.f24506OooO0Oo = iMSocketManagerOld;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C0314OooO00o(this.f24506OooO0Oo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            IMSocketManagerOld iMSocketManagerOld = this.f24506OooO0Oo;
            IMSocketManagerOld.State value = iMSocketManagerOld.f24491OooO0o.getValue();
            IMSocketManagerOld.State state = IMSocketManagerOld.State.Connectting;
            if (value != state) {
                iMSocketManagerOld.f24491OooO0o.setValue(state);
            }
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ IMSocketManagerOld f24507OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(IMSocketManagerOld iMSocketManagerOld, Continuation<? super OooO0O0> continuation) {
            super(2, continuation);
            this.f24507OooO0Oo = iMSocketManagerOld;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0O0(this.f24507OooO0Oo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            IntrinsicsKt.getCOROUTINE_SUSPENDED();
            ResultKt.throwOnFailure(obj);
            IMSocketManagerOld iMSocketManagerOld = this.f24507OooO0Oo;
            IMSocketManagerOld.State value = iMSocketManagerOld.f24491OooO0o.getValue();
            IMSocketManagerOld.State state = IMSocketManagerOld.State.ConnectLost;
            if (value != state) {
                iMSocketManagerOld.f24491OooO0o.setValue(state);
            }
            o0000O00.OooO0O0("SocketManager connectWhenAvailable when Connected time " + iMSocketManagerOld.f24486OooO);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ IMSocketManagerOld f24508OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(IMSocketManagerOld iMSocketManagerOld, Continuation<? super OooO0OO> continuation) {
            super(2, continuation);
            this.f24508OooO0Oo = iMSocketManagerOld;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0OO(this.f24508OooO0Oo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            IntrinsicsKt.getCOROUTINE_SUSPENDED();
            ResultKt.throwOnFailure(obj);
            IMSocketManagerOld iMSocketManagerOld = this.f24508OooO0Oo;
            IMSocketManagerOld.State value = iMSocketManagerOld.f24491OooO0o.getValue();
            IMSocketManagerOld.State state = IMSocketManagerOld.State.Connectting;
            if (value != state) {
                iMSocketManagerOld.f24491OooO0o.setValue(state);
    ...
    public OooO00o(IMSocketManagerOld iMSocketManagerOld, boolean z, Continuation<? super OooO00o> continuation) {
        super(2, continuation);
        this.f24505OooO0o0 = iMSocketManagerOld;
        this.f24504OooO0o = z;
    }
    ...
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new OooO00o(this.f24505OooO0o0, this.f24504OooO0o, continuation);
    }
