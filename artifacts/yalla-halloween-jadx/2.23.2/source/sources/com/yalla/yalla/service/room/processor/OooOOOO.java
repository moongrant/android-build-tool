...
import p485o0o000oO.o00O00;
import p485o0o000oO.o00O000o;
...
public final class OooOOOO implements com.yalla.yalla.service.room.processor.OooO00o {
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public int f24655OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ byte[] f24656OooO0o;
        ...
        public static final class C0320OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {

            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public int f24658OooO0Oo;

            /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
            public final /* synthetic */ byte[] f24659OooO0o;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public final /* synthetic */ OooOOOO f24660OooO0o0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C0320OooO00o(OooOOOO oooOOOO, byte[] bArr, Continuation<? super C0320OooO00o> continuation) {
                super(2, continuation);
                this.f24660OooO0o0 = oooOOOO;
                this.f24659OooO0o = bArr;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                return new C0320OooO00o(this.f24660OooO0o0, this.f24659OooO0o, continuation);
            }

            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
                return ((C0320OooO00o) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                int i = this.f24658OooO0Oo;
                if (i != 0 && i != 1) {
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                }
                ResultKt.throwOnFailure(obj);
                while (com.yalla.yalla.service.room.OooO00o.f24519OooOO0.f48495OooO0OO.isEmpty()) {
                    this.f24658OooO0Oo = 1;
                    if (DelayKt.delay(50L, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                }
                this.f24660OooO0o0.OooO0O0(this.f24659OooO0o, true);
        ...
        public OooO00o(byte[] bArr, Continuation<? super OooO00o> continuation) {
            super(2, continuation);
            this.f24656OooO0o = bArr;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return OooOOOO.this.new OooO00o(this.f24656OooO0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f24655OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                C0320OooO00o c0320OooO00o = new C0320OooO00o(OooOOOO.this, this.f24656OooO0o, null);
                this.f24655OooO0Oo = 1;
                if (TimeoutKt.withTimeout(3000L, c0320OooO00o, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ InOutRoomModel f24661OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(InOutRoomModel inOutRoomModel, Continuation<? super OooO0O0> continuation) {
            super(2, continuation);
            this.f24661OooO0Oo = inOutRoomModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0O0(this.f24661OooO0Oo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            com.yalla.yalla.service.room.OooO00o.f24519OooOO0.f48494OooO0O0.setValue(Boxing.boxInt(this.f24661OooO0Oo.getOnline()));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ RoomUserInfoModel f24662OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ InOutRoomModel f24663OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(RoomUserInfoModel roomUserInfoModel, InOutRoomModel inOutRoomModel, Continuation<? super OooO0OO> continuation) {
            super(2, continuation);
            this.f24662OooO0Oo = roomUserInfoModel;
            this.f24663OooO0o0 = inOutRoomModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0OO(this.f24662OooO0Oo, this.f24663OooO0o0, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            RoomUserInfoModel roomUserInfoModel = this.f24662OooO0Oo;
            if (snapshotStateList.contains(roomUserInfoModel.getUserId().getValue())) {
                return Unit.INSTANCE;
            }
            Iterator<Long> it = o0000o1.f48495OooO0OO.iterator();
            boolean z = false;
            int i = 0;
            while (true) {
                if (!it.hasNext()) {
            ...
            if (i == -1) {
                o0000O0 o0000o2 = com.yalla.yalla.service.room.OooO00o.f24519OooOO0;
                if (o0000o2.f48495OooO0OO.size() < 50) {
                    o0000o2.f48495OooO0OO.add(roomUserInfoModel.getUserId().getValue());
                }
            } else {
                if (i >= 0 && i < com.yalla.yalla.service.room.OooO00o.f24519OooOO0.f48495OooO0OO.size()) {
                    z = true;
                }
                if (z) {
                    o0000O0 o0000o3 = com.yalla.yalla.service.room.OooO00o.f24519OooOO0;
                    o0000o3.f48495OooO0OO.add(i, roomUserInfoModel.getUserId().getValue());
                    SnapshotStateList<Long> snapshotStateList2 = o0000o3.f48495OooO0OO;
                    if (snapshotStateList2.size() > 50) {
                        CollectionsKt.removeLast(snapshotStateList2);
                    }
                }
            }
            com.yalla.yalla.service.room.OooO00o.f24519OooOO0.f48494OooO0O0.setValue(Boxing.boxInt(this.f24663OooO0o0.getOnline()));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ RoomUserInfoModel f24664OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ InOutRoomModel f24665OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(RoomUserInfoModel roomUserInfoModel, InOutRoomModel inOutRoomModel, Continuation<? super OooO0o> continuation) {
            super(2, continuation);
            this.f24664OooO0Oo = roomUserInfoModel;
            this.f24665OooO0o0 = inOutRoomModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0o(this.f24664OooO0Oo, this.f24665OooO0o0, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            o0000O0 o0000o1 = com.yalla.yalla.service.room.OooO00o.f24519OooOO0;
            o0000o1.f48495OooO0OO.remove(this.f24664OooO0Oo.getUserId().getValue());
            o0000o1.f48494OooO0O0.setValue(Boxing.boxInt(this.f24665OooO0o0.getOnline()));
            return Unit.INSTANCE;
        }
    }
    ...
    public final void OooO0O0(byte[] bArr, boolean z) {
        ...
        o0000O00.OooO0OO(com.yalla.yalla.service.room.processor.OooO00o.C0318OooO00o.OooO00o(this), "parseInOrOutRoomMessage data = ".concat(new String(bArr, charset)));
        ...
        if (com.yalla.yalla.service.room.OooO00o.f24519OooOO0.f48495OooO0OO.isEmpty()) {
            if (z) {
                return;
            }
    ...
    public final void OooO0OO(int i, @Nullable Object obj) {
        ...
        if (i == 10054) {
            ...
            if (from2 != null) {
                o0000O00.OooO0OO(com.yalla.yalla.service.room.processor.OooO00o.C0318OooO00o.OooO00o(this), "parseGetSofaListMessage data = " + from2.getUsersList().size());
                ArrayList arrayList = new ArrayList();
                List<Room.UserModel> usersList = from2.getUsersList();
                Intrinsics.checkNotNullExpressionValue(usersList, "getUsersList(...)");
                ArrayList arrayList2 = new ArrayList(CollectionsKt.OooO0oo(usersList));
                for (Room.UserModel userModel : usersList) {
                    ...
                    arrayList2.add(Long.valueOf(userModel.getUserId()));
                }
                arrayList.addAll(arrayList2);
                BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), null, null, new o00O00(arrayList, from2, null), 3, null);
                return;
            }
            return;
        }
        if (i == 10055 && (from = Room.UserStaticListReply.parseFrom((byte[]) obj)) != null) {
            o0000O00.OooO0OO("parseGetOnlineListMessage", "data = " + from);
            ArrayList arrayList4 = new ArrayList();
            List<Room.UserModel> usersList2 = from.getUsersList();
            Intrinsics.checkNotNullExpressionValue(usersList2, "getUsersList(...)");
            ArrayList arrayList5 = new ArrayList(CollectionsKt.OooO0oo(usersList2));
            for (Room.UserModel userModel2 : usersList2) {
                ...
                RoomUserInfoModel roomUserInfoModelOf = companion2.of(userModel2);
                ArrayList arrayList6 = com.yalla.yalla.service.room.OooO00o.f24511OooO00o;
                com.yalla.yalla.service.room.OooO00o.OooO0o(roomUserInfoModelOf);
                arrayList4.add(roomUserInfoModelOf);
                arrayList5.add(Long.valueOf(userModel2.getUserId()));
            }
            if (from.getKind() == 0) {
                BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), null, null, new o00O000o(arrayList5, from, null), 3, null);
            }
            com.yalla.yalla.service.room.OooO00o.f24519OooOO0.f48496OooO0Oo.postValue(Integer.valueOf(from.getTournum()));
