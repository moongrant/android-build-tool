...
public final class OooO00o extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ BaseComposeActivity f24683OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooO00o(BaseComposeActivity baseComposeActivity) {
        super(2);
        this.f24683OooO0Oo = baseComposeActivity;
    }
    ...
    public final Unit invoke(Composer composer, Integer num) {
        ...
        if ((iIntValue & 11) == 2 && composer2.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-2116732229, iIntValue, -1, "com.yalla.yalla.ui.activity.BaseComposeActivity.onCreate.<anonymous>.<anonymous> (BaseComposeActivity.kt:32)");
            }
            ...
            this.f24683OooO0Oo.OooOOOO(composer2, 8);
