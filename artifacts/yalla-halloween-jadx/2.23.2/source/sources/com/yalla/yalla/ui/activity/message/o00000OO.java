...
public final class o00000OO extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ PrivateChatActivity f25351OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00000OO(PrivateChatActivity privateChatActivity) {
        super(2);
        this.f25351OooO0Oo = privateChatActivity;
    }
    ...
    public final Unit invoke(Composer composer, Integer num) {
        ...
        if ((iIntValue & 11) == 2 && composer2.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-977081340, iIntValue, -1, "com.yalla.yalla.ui.activity.message.PrivateChatActivity.initBottom.<anonymous> (PrivateChatActivity.kt:550)");
            }
            ...
            PrivateChatActivity privateChatActivity = this.f25351OooO0Oo;
            ...
            View bottomViewPlaceHolder = privateChatActivity.OooOo0().f44881OooO0OO;
            Intrinsics.checkNotNullExpressionValue(bottomViewPlaceHolder, "bottomViewPlaceHolder");
            o00O0000.OooO0Oo(boxScopeInstance, value, bottomViewPlaceHolder, composer2, 582);
