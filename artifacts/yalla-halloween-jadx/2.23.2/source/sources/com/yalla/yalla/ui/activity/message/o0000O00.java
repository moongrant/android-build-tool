...
public final class o0000O00 extends Lambda implements Function1<String, Unit> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ PrivateChatActivity f25354OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0000O00(PrivateChatActivity privateChatActivity) {
        super(1);
        this.f25354OooO0Oo = privateChatActivity;
    }
    ...
    public final Unit invoke(String str) {
        ...
        PrivateChatActivity privateChatActivity = this.f25354OooO0Oo;
