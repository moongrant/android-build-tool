...
public final class o000OOo0 extends Lambda implements Function1<ApiResult<FriendChatModel>, Unit> {
    ...
    public final /* synthetic */ PrivateChatActivity f25374OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o000OOo0(PrivateChatActivity privateChatActivity) {
        super(1);
        this.f25374OooO0Oo = privateChatActivity;
    }
    ...
    public final Unit invoke(ApiResult<FriendChatModel> apiResult) {
        ...
        PrivateChatActivity privateChatActivity = this.f25374OooO0Oo;
        if (zIsSuccess) {
            ...
            if (data != null) {
                ...
                ((YallaChatVM) privateChatActivity.f25246OooOo0O.getValue()).toYallaChat(data);
            }
        } else {
            ...
            if (code == 2077) {
                ...
                Lazy lazy = privateChatActivity.f25246OooOo0O;
                ...
                Lazy lazy2 = privateChatActivity.f25246OooOo0O;
                ...
                ((YallaChatVM) privateChatActivity.f25246OooOo0O.getValue()).getYallaChatDialogFriendNoBindShow().setValue(Boolean.TRUE);
            }
        }
