...
public final class o00O0000 {
    ...
    public static final class OooO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ com.yalla.yalla.ui.activity.message.Oooo000 f25381OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f25382OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(com.yalla.yalla.ui.activity.message.Oooo000 oooo000, int i) {
            super(2);
            this.f25381OooO0Oo = oooo000;
            this.f25382OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f25382OooO0o0 | 1);
            o00O0000.OooO0O0(this.f25381OooO0Oo, composer, iUpdateChangedFlags);
    ...
    public static final class OooO00o extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ com.yalla.yalla.ui.activity.message.Oooo000 f25383OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ Context f25384OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(com.yalla.yalla.ui.activity.message.Oooo000 oooo000, Context context) {
            super(0);
            this.f25383OooO0Oo = oooo000;
            this.f25384OooO0o0 = context;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            p371o0OOo0oO.oo000o value = this.f25383OooO0Oo.f25223OooO.getValue();
            if (value != null) {
                value.OooO0OO(this.f25384OooO0o0);
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0O0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ com.yalla.yalla.ui.activity.message.Oooo000 f25385OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f25386OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ Modifier f25387OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f25388OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(com.yalla.yalla.ui.activity.message.Oooo000 oooo000, Modifier modifier, int i, int i2) {
            super(2);
            this.f25385OooO0Oo = oooo000;
            this.f25387OooO0o0 = modifier;
            this.f25386OooO0o = i;
            this.f25388OooO0oO = i2;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f25386OooO0o | 1);
            Modifier modifier = this.f25387OooO0o0;
            int i = this.f25388OooO0oO;
            o00O0000.OooO00o(this.f25385OooO0Oo, modifier, composer, iUpdateChangedFlags, i);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0OO extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ com.yalla.yalla.ui.activity.message.Oooo000 f25389OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(com.yalla.yalla.ui.activity.message.Oooo000 oooo000) {
            super(0);
            this.f25389OooO0Oo = oooo000;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            com.yalla.yalla.ui.activity.message.Oooo000 oooo000 = this.f25389OooO0Oo;
            ...
            if (privateChatVMOooO0O0.userInfo() != null) {
                ...
                if (userInfo.getUserId() != 0 && privateChatVMOooO0O0.sendFilter()) {
                    ...
                    if (TextUtils.isEmpty(strValueOf.subSequence(i, length + 1).toString())) {
                        String strOooO0OO = com.code.android.util.o0000.OooO0OO(p562o0oOo000.o000000.illegal_empty_msg);
    ...
    public static final class OooO0o extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ com.yalla.yalla.ui.activity.message.Oooo000 f25390OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(com.yalla.yalla.ui.activity.message.Oooo000 oooo000) {
            super(0);
            this.f25390OooO0Oo = oooo000;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            com.yalla.yalla.ui.activity.message.Oooo000 oooo000 = this.f25390OooO0Oo;
    ...
    public static final class OooOO0 extends Lambda implements Function1<Context, EmojiEditText> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ com.yalla.yalla.ui.activity.message.Oooo000 f25391OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0(com.yalla.yalla.ui.activity.message.Oooo000 oooo000) {
            super(1);
            this.f25391OooO0Oo = oooo000;
        }
        ...
        public final EmojiEditText invoke(Context context) {
            ...
            return this.f25391OooO0Oo.OooO00o();
        }
    }
    ...
    public static final class OooOO0O extends Lambda implements Function1<EmojiEditText, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooOO0O f25392OooO0Oo = new OooOO0O();
    ...
    public static final class OooOOO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ com.yalla.yalla.ui.activity.message.Oooo000 f25393OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f25394OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO(com.yalla.yalla.ui.activity.message.Oooo000 oooo000, int i) {
            super(2);
            this.f25393OooO0Oo = oooo000;
            this.f25394OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f25394OooO0o0 | 1);
            o00O0000.OooO0OO(this.f25393OooO0Oo, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOOO0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ com.yalla.yalla.ui.activity.message.Oooo000 f25395OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO0(com.yalla.yalla.ui.activity.message.Oooo000 oooo000, Continuation<? super OooOOO0> continuation) {
            super(2, continuation);
            this.f25395OooO0Oo = oooo000;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOOO0(this.f25395OooO0Oo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            com.yalla.yalla.ui.activity.message.Oooo000 oooo000 = this.f25395OooO0Oo;
            if (oooo000.f25228OooO0o.getValue().booleanValue() && oooo000.f25234OooOO0o.f56977OooO0O0.getValue().booleanValue() && !oooo000.OooO00o().isFocused()) {
    ...
    public static final class OooOOOO extends Lambda implements Function1<LayoutCoordinates, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ View f25396OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOOO(View view) {
            super(1);
            this.f25396OooO0Oo = view;
        }
    ...
    public static final class OooOo extends Lambda implements Function1<DisposableEffectScope, DisposableEffectResult> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ com.yalla.yalla.ui.activity.message.Oooo000 f25397OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOo(com.yalla.yalla.ui.activity.message.Oooo000 oooo000) {
            super(1);
            this.f25397OooO0Oo = oooo000;
        }
        ...
        public final DisposableEffectResult invoke(DisposableEffectScope disposableEffectScope) {
            ...
            return new o0O0ooO(this.f25397OooO0Oo);
        }
    }
    ...
    public static final class OooOo00 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ BoxScope f25398OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ View f25399OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ com.yalla.yalla.ui.activity.message.Oooo000 f25400OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f25401OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOo00(BoxScope boxScope, com.yalla.yalla.ui.activity.message.Oooo000 oooo000, View view, int i) {
            super(2);
            this.f25398OooO0Oo = boxScope;
            this.f25400OooO0o0 = oooo000;
            this.f25399OooO0o = view;
            this.f25401OooO0oO = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f25401OooO0oO | 1);
            com.yalla.yalla.ui.activity.message.Oooo000 oooo000 = this.f25400OooO0o0;
            View view = this.f25399OooO0o;
            o00O0000.OooO0Oo(this.f25398OooO0Oo, oooo000, view, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class Oooo0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ com.yalla.yalla.ui.activity.message.Oooo000 f25402OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f25403OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public Oooo0(com.yalla.yalla.ui.activity.message.Oooo000 oooo000, int i) {
            super(2);
            this.f25402OooO0Oo = oooo000;
            this.f25403OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f25403OooO0o0 | 1);
            o00O0000.OooO0o0(this.f25402OooO0Oo, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class Oooo000 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ com.yalla.yalla.ui.activity.message.Oooo000 f25404OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ CoroutineScope f25405OooO0o0;

        public static final class OooO extends Lambda implements Function2<String, Integer, Unit> {

            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ com.yalla.yalla.ui.activity.message.Oooo000 f25406OooO0Oo;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public OooO(com.yalla.yalla.ui.activity.message.Oooo000 oooo000) {
                super(2);
                this.f25406OooO0Oo = oooo000;
            }
            ...
            public final Unit invoke(String str, Integer num) {
                String str2 = str;
                Integer num2 = num;
                PrivateChatVM privateChatVMOooO0O0 = this.f25406OooO0Oo.OooO0O0();
        ...
        public static final class OooO00o extends Lambda implements Function2<Boolean, Integer, Unit> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ com.yalla.yalla.ui.activity.message.Oooo000 f25407OooO0Oo;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public final /* synthetic */ CoroutineScope f25408OooO0o0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public OooO00o(com.yalla.yalla.ui.activity.message.Oooo000 oooo000, CoroutineScope coroutineScope) {
                super(2);
                this.f25407OooO0Oo = oooo000;
                this.f25408OooO0o0 = coroutineScope;
            }
            ...
            public final Unit invoke(Boolean bool, Integer num) {
                ...
                num.intValue();
                View view = null;
                com.yalla.yalla.ui.activity.message.Oooo000 oooo000 = this.f25407OooO0Oo;
                if (zBooleanValue) {
                    o0oo0000.OooO00o.OooO0OO("202021", MapsKt.mapOf(new Pair("sources", 2)));
                    com.code.android.util.OooOOO.OooO0O0(this.f25408OooO0o0, new o00oOoo(null));
                    View view2 = oooo000.f25237OooOOOO;
                    if (view2 != null) {
                        view = view2;
                    } else {
                    ...
                    oooo000.f25228OooO0o.setValue(Boolean.FALSE);
                    oooo000.OooO00o().clearFocus();
                    if (oooo000.OooO0O0().getLayoutYallaChatShowing()) {
                        View view3 = oooo000.f25237OooOOOO;
                        if (view3 != null) {
                            view = view3;
                        } else {
                            Intrinsics.throwUninitializedPropertyAccessException("layoutYallaChat");
        ...
        public static final class OooO0O0 extends Lambda implements Function2<Boolean, Integer, Unit> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ com.yalla.yalla.ui.activity.message.Oooo000 f25409OooO0Oo;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public OooO0O0(com.yalla.yalla.ui.activity.message.Oooo000 oooo000) {
                super(2);
                this.f25409OooO0Oo = oooo000;
            }
            ...
            public final Unit invoke(Boolean bool, Integer num) {
                boolean zBooleanValue = bool.booleanValue();
                num.intValue();
                com.yalla.yalla.ui.activity.message.Oooo000 oooo000 = this.f25409OooO0Oo;
                oooo000.f25229OooO0o0.setValue(Boolean.valueOf(zBooleanValue));
                p434o0OoOOOO.o0oOOo o0oooo = oooo000.f25236OooOOO0;
                if (o0oooo == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("privateChatVoiceManager");
                    o0oooo = null;
                }
                o0oooo.OooO00o(oooo000);
                if (zBooleanValue) {
                    o0oo0000.OooO00o.OooO0O0("104028");
                } else if (!oooo000.f25234OooOO0o.f56977OooO0O0.getValue().booleanValue()) {
                    oooo000.OooO00o().clearFocus();
                }
                oooo000.f25228OooO0o.setValue(Boolean.valueOf(!zBooleanValue));
                return Unit.INSTANCE;
            }
        }
        ...
        public static final class OooO0OO extends Lambda implements Function1<Boolean, Unit> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ com.yalla.yalla.ui.activity.message.Oooo000 f25410OooO0Oo;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public OooO0OO(com.yalla.yalla.ui.activity.message.Oooo000 oooo000) {
                super(1);
                this.f25410OooO0Oo = oooo000;
            }

            @Override // kotlin.jvm.functions.Function1
            public final Unit invoke(Boolean bool) {
                if (!bool.booleanValue()) {
                    this.f25410OooO0Oo.OooO00o().clearFocus();
                }
                return Unit.INSTANCE;
            }
        }
        ...
        public static final class OooO0o extends Lambda implements Function1<Integer, Unit> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ com.yalla.yalla.ui.activity.message.Oooo000 f25411OooO0Oo;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public OooO0o(com.yalla.yalla.ui.activity.message.Oooo000 oooo000) {
                super(1);
                this.f25411OooO0Oo = oooo000;
            }

            @Override // kotlin.jvm.functions.Function1
            public final Unit invoke(Integer num) {
                Integer num2 = num;
                PrivateChatVM privateChatVMOooO0O0 = this.f25411OooO0Oo.OooO0O0();
                Intrinsics.checkNotNull(num2);
        ...
        public Oooo000(com.yalla.yalla.ui.activity.message.Oooo000 oooo000, CoroutineScope coroutineScope, Continuation<? super Oooo000> continuation) {
            super(2, continuation);
            this.f25404OooO0Oo = oooo000;
            this.f25405OooO0o0 = coroutineScope;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new Oooo000(this.f25404OooO0Oo, this.f25405OooO0o0, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            IntrinsicsKt.getCOROUTINE_SUSPENDED();
            ResultKt.throwOnFailure(obj);
            com.yalla.yalla.ui.activity.message.Oooo000 oooo000 = this.f25404OooO0Oo;
            MutableState<p371o0OOo0oO.oo000o> mutableState = oooo000.f25223OooO;
            p371o0OOo0oO.oo000o oo000oVar = new p371o0OOo0oO.oo000o(oooo000.f25233OooOO0O, oooo000.OooO00o());
            oo000oVar.f43184OooO0Oo = new OooO00o(oooo000, this.f25405OooO0o0);
            oo000oVar.f43183OooO0OO = new OooO0O0(oooo000);
            mutableState.setValue(oo000oVar);
            EmojiEditText emojiEditTextOooO00o = oooo000.OooO00o();
            t tVar = oooo000.f25234OooOO0o;
            tVar.OooO00o(emojiEditTextOooO00o);
            tVar.f56976OooO00o = new OooO0OO(oooo000);
            tVar.f56978OooO0OO = new OooO0o(oooo000);
            tVar.f56979OooO0Oo = new OooO(oooo000);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class o000oOoO extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final o000oOoO f25412OooO0Oo = new o000oOoO();
    ...
    public static final class o00O0O extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ com.yalla.yalla.ui.activity.message.Oooo000 f25413OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public o00O0O(com.yalla.yalla.ui.activity.message.Oooo000 oooo000) {
            super(0);
            this.f25413OooO0Oo = oooo000;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            com.yalla.yalla.ui.activity.message.Oooo000 oooo000 = this.f25413OooO0Oo;
            if (oooo000.f25230OooO0oO.getValue().booleanValue()) {
                ...
                p434o0OoOOOO.o0oOOo o0oooo = oooo000.f25226OooO0OO;
                if (o0oooo != null) {
                    o0oooo.OooO00o(oooo000);
                }
            } else {
                o0oo0000.OooO00o.OooO0O0("104029");
                Context context2 = oooo000.f25224OooO00o;
                Intrinsics.checkNotNull(context2, "null cannot be cast to non-null type android.app.Activity");
                com.yalla.yalla.util.permission.OooO00o.OooO0OO((Activity) context2, PermissionGroupReveal.f32335OooO00o, null, new o00O000(oooo000));
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class o00Oo0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ com.yalla.yalla.ui.activity.message.Oooo000 f25414OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f25415OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public o00Oo0(com.yalla.yalla.ui.activity.message.Oooo000 oooo000, int i) {
            super(2);
            this.f25414OooO0Oo = oooo000;
            this.f25415OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f25415OooO0o0 | 1);
            o00O0000.OooO0oO(this.f25414OooO0Oo, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class o0OoOo0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ RowScope f25416OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f25417OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ com.yalla.yalla.ui.activity.message.Oooo000 f25418OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public o0OoOo0(RowScope rowScope, com.yalla.yalla.ui.activity.message.Oooo000 oooo000, int i) {
            super(2);
            this.f25416OooO0Oo = rowScope;
            this.f25418OooO0o0 = oooo000;
            this.f25417OooO0o = i;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f25417OooO0o | 1);
            o00O0000.OooO0o(this.f25416OooO0Oo, this.f25418OooO0o0, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final void OooO00o(com.yalla.yalla.ui.activity.message.Oooo000 oooo000, Modifier modifier, Composer composer, int i, int i2) {
        ...
        if (p417o0Oo0oo0.o0Oo0oo.OooO0O0(composerStartRestartGroup)) {
            if (oooo000.f25228OooO0o.getValue().booleanValue()) {
                z = false;
            } else {
            ...
            if (z && Intrinsics.areEqual(LiveDataAdapterKt.observeAsState((MutableLiveData) p415o0Oo0oO0.o00Ooo.OooO0o0().f46399OooO0O0.getValue(), composerStartRestartGroup, 8).getValue(), Boolean.FALSE)) {
                modifierOooO00o = com.code.android.util.o0000Ooo.OooO00o(Modifier.INSTANCE, false, ColorKt.Color(4294863980L), Dp.m3775constructorimpl((float) 4.5d), false, true, Dp.m3775constructorimpl(26), Dp.m3775constructorimpl(-24), Dp.m3775constructorimpl(1), 553);
            } else {
        ...
        ImageKt.Image(PainterResources_androidKt.painterResource(oooo000.f25228OooO0o.getValue().booleanValue() ? p562o0oOo000.o0O0O00.ic_moment_chat_keyboard_gray : p562o0oOo000.o0O0O00.iv_room_emoji_gray, composerStartRestartGroup, 0), (String) null, com.code.android.util.o0O0O00.OooO0O0(SizeKt.m525size3ABfNKs(PaddingKt.m480paddingVpY3zN4$default(Modifier.INSTANCE.then(modifierOooO00o).then(modifier2), Dp.m3775constructorimpl(8), 0.0f, 2, null), Dp.m3775constructorimpl(27)), false, false, 0L, false, null, null, null, new OooO00o(oooo000, (Context) composerStartRestartGroup.consume(AndroidCompositionLocals_androidKt.getLocalContext())), 253), (Alignment) null, (ContentScale) null, 0.0f, (ColorFilter) null, composerStartRestartGroup, 56, 120);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void OooO0O0(com.yalla.yalla.ui.activity.message.Oooo000 oooo000, Composer composer, int i) {
        ...
        if (oooo000.f25232OooOO0.getValue().booleanValue() || oooo000.f25230OooO0oO.getValue().booleanValue()) {
            composerStartRestartGroup.startReplaceableGroup(-57048353);
            ImageKt.Image(PainterResources_androidKt.painterResource(p562o0oOo000.o0Oo0oo.icon_gift_red, composerStartRestartGroup, 0), (String) null, com.code.android.util.o0O0O00.OooO0O0(SizeKt.m525size3ABfNKs(PaddingKt.m482paddingqDBjuR0$default(PaddingKt.m480paddingVpY3zN4$default(Modifier.INSTANCE, Dp.m3775constructorimpl(9), 0.0f, 2, null), 0.0f, 0.0f, 0.0f, Dp.m3775constructorimpl(11), 7, null), Dp.m3775constructorimpl(32)), false, false, 0L, false, null, null, null, new OooO0o(oooo000), 253), (Alignment) null, (ContentScale) null, 0.0f, (ColorFilter) null, composerStartRestartGroup, 56, 120);
            composerStartRestartGroup.endReplaceableGroup();
        } else {
            composerStartRestartGroup.startReplaceableGroup(-57049515);
            ImageKt.Image(PainterResources_androidKt.painterResource(p562o0oOo000.o0O0O00.ic_moment_chat_send, composerStartRestartGroup, 0), (String) null, com.code.android.util.o0O0O00.OooO0O0(SizeKt.m525size3ABfNKs(PaddingKt.m482paddingqDBjuR0$default(PaddingKt.m480paddingVpY3zN4$default(Modifier.INSTANCE, Dp.m3775constructorimpl(12), 0.0f, 2, null), 0.0f, 0.0f, 0.0f, Dp.m3775constructorimpl(14), 7, null), Dp.m3775constructorimpl(26)), false, false, 0L, false, null, null, null, new OooO0OO(oooo000), 253), (Alignment) null, (ContentScale) null, 0.0f, (ColorFilter) null, composerStartRestartGroup, 56, 120);
            composerStartRestartGroup.endReplaceableGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public static final void OooO0OO(com.yalla.yalla.ui.activity.message.Oooo000 oooo000, Composer composer, int i) {
        ...
        Modifier modifierOooO00o = androidx.media3.session.o00O0O0.OooO00o(21, PaddingKt.m479paddingVpY3zN4(SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), Dp.m3775constructorimpl(0), Dp.m3775constructorimpl(8)));
        int i2 = o0OOo000.f48347o00OOooO;
        Modifier modifierM482paddingqDBjuR0$default = PaddingKt.m482paddingqDBjuR0$default(BackgroundKt.m171backgroundbw27NRU$default(modifierOooO00o, o0OOo000.f48270o000o0Oo, null, 2, null), Dp.m3775constructorimpl(12), 0.0f, 0.0f, 0.0f, 14, null);
        ...
        AndroidView_androidKt.AndroidView(new OooOO0(oooo000), SizeKt.m512heightInVpY3zN4(androidx.compose.foundation.layout.OooOO0O.OooO00o(RowScopeInstance.INSTANCE, companion, 1.0f, false, 2, null), Dp.m3775constructorimpl(38), Dp.m3775constructorimpl(87)), OooOO0O.f25392OooO0Oo, composerStartRestartGroup, 384, 0);
        EffectsKt.LaunchedEffect(oooo000.f25228OooO0o.getValue(), new OooOOO0(oooo000, null), composerStartRestartGroup, 64);
        OooO00o(oooo000, PaddingKt.m482paddingqDBjuR0$default(companion, 0.0f, 0.0f, 0.0f, Dp.m3775constructorimpl(6), 7, null), composerStartRestartGroup, 56, 0);
        composerStartRestartGroup.endReplaceableGroup();
    ...
    public static final void OooO0Oo(@NotNull BoxScope boxScope, @NotNull com.yalla.yalla.ui.activity.message.Oooo000 chatBottomState, @NotNull View bottomViewPlaceHolder, @Nullable Composer composer, int i) {
        ...
        int i2 = o0OOo000.f48347o00OOooO;
        Modifier modifierM171backgroundbw27NRU$default = BackgroundKt.m171backgroundbw27NRU$default(modifierOnGloballyPositioned, o0OOo000.f48135OooO0O0, null, 2, null);
        ...
        if (chatBottomState.f25227OooO0Oo.getValue().booleanValue()) {
            ...
            Modifier modifierM513heightInVpY3zN4$default = SizeKt.m513heightInVpY3zN4$default(SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), Dp.m3775constructorimpl(54), 0.0f, 2, null);
            composerStartRestartGroup.startReplaceableGroup(693286680);
            MeasurePolicy measurePolicyOooO0O2 = androidx.compose.material.OooO0OO.OooO0O0(arrangement, bottom2, composerStartRestartGroup, 48, -1323940314);
            int currentCompositeKeyHash3 = ComposablesKt.getCurrentCompositeKeyHash(composerStartRestartGroup, 0);
            CompositionLocalMap currentCompositionLocalMap3 = composerStartRestartGroup.getCurrentCompositionLocalMap();
            Function0<ComposeUiNode> constructor3 = companion3.getConstructor();
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3ModifierMaterializerOf3 = LayoutKt.modifierMaterializerOf(modifierM513heightInVpY3zN4$default);
            if (!(composerStartRestartGroup.getApplier() instanceof Applier)) {
                ComposablesKt.invalidApplier();
            }
            composerStartRestartGroup.startReusableNode();
            ...
            composerStartRestartGroup.endReplaceableGroup();
            composerStartRestartGroup.endReplaceableGroup();
            p497o0o00OoO.o0000O00.OooO00o(chatBottomState.f25233OooOO0O, chatBottomState.f25234OooOO0o, chatBottomState.f25229OooO0o0.getValue().booleanValue() ? 60 : 300, composerStartRestartGroup, 72, 0);
            composerStartRestartGroup.endReplaceableGroup();
            composerStartRestartGroup.endNode();
            composerStartRestartGroup.endReplaceableGroup();
            composerStartRestartGroup.endReplaceableGroup();
    ...
    public static final void OooO0o(RowScope rowScope, com.yalla.yalla.ui.activity.message.Oooo000 oooo000, Composer composer, int i) {
        ...
        if (oooo000.f25230OooO0oO.getValue().booleanValue()) {
            SpacerKt.Spacer(com.code.android.util.o0O0O00.OooO0O0(BackgroundKt.m171backgroundbw27NRU$default(boxScopeInstance.matchParentSize(companion), o0OOo000.f48135OooO0O0, null, 2, null), false, false, 0L, false, null, null, null, o000oOoO.f25412OooO0Oo, 253), composerStartRestartGroup, 0);
        }
        composerStartRestartGroup.endReplaceableGroup();
        composerStartRestartGroup.endReplaceableGroup();
        composerStartRestartGroup.endNode();
    ...
    public static final void OooO0o0(com.yalla.yalla.ui.activity.message.Oooo000 oooo000, Composer composer, int i) {
        ...
        composerStartRestartGroup.endReplaceableGroup();
        EffectsKt.LaunchedEffect(oooo000.OooO00o(), oooo000.f25233OooOO0O, oooo000.f25223OooO, new Oooo000(oooo000, coroutineScope, null), composerStartRestartGroup, 4168);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ScopeUpdateScope scopeUpdateScopeEndRestartGroup = composerStartRestartGroup.endRestartGroup();
    ...
    public static final void OooO0oO(@NotNull com.yalla.yalla.ui.activity.message.Oooo000 chatBottomState, @Nullable Composer composer, int i) {
        ...
        if (chatBottomState.f25231OooO0oo.getValue().booleanValue()) {
            ImageKt.Image(PainterResources_androidKt.painterResource(chatBottomState.f25230OooO0oO.getValue().booleanValue() ? p562o0oOo000.o0O0O00.icon_keyboard : p562o0oOo000.o0O0O00.btn_chitchat_voice_n, composerStartRestartGroup, 0), (String) null, com.code.android.util.o0O0O00.OooO0O0(SizeKt.m525size3ABfNKs(PaddingKt.m482paddingqDBjuR0$default(Modifier.INSTANCE, 0.0f, 0.0f, Dp.m3775constructorimpl(12), Dp.m3775constructorimpl(13), 3, null), Dp.m3775constructorimpl(27)), false, false, 0L, false, null, null, null, new o00O0O(chatBottomState), 253), (Alignment) null, (ContentScale) null, 0.0f, (ColorFilter) null, composerStartRestartGroup, 56, 120);
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
