...
public final class o00OO0OO extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ ShareToFriendsActivity f25448OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ EventModel f25449OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ long f25450OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final /* synthetic */ p205o00o0o0o.o000O f25451OooO0oO;
    ...
    public o00OO0OO(ShareToFriendsActivity shareToFriendsActivity, long j, EventModel eventModel, p205o00o0o0o.o000O o000o) {
        super(0);
        this.f25448OooO0Oo = shareToFriendsActivity;
        this.f25450OooO0o0 = j;
        this.f25449OooO0o = eventModel;
        this.f25451OooO0oO = o000o;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        List<Long> listMutableListOf;
        ShareToFriendsActivity activity = this.f25448OooO0Oo;
        ...
        if (o000ooo1.f27084OooOOo) {
            ...
            listMutableListOf = CollectionsKt.mutableListOf(Long.valueOf(this.f25450OooO0o0));
        }
        List<Long> list = listMutableListOf;
        ShareToFriendVM shareToFriendVMOooOoOO = activity.OooOoOO();
        EventModel eventModel = this.f25449OooO0o;
