...
public final class o0O0o extends Lambda implements Function1<Boolean, Unit> {
    ...
    public final /* synthetic */ ShareToFriendsActivity f25505OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0O0o(ShareToFriendsActivity shareToFriendsActivity) {
        super(1);
        this.f25505OooO0Oo = shareToFriendsActivity;
    }
    ...
    public final Unit invoke(Boolean bool) {
        ...
        if (bool2.booleanValue()) {
            ...
            o0oo0000.OooO00o.OooO0O0("202026");
        }
        this.f25505OooO0Oo.finish();
