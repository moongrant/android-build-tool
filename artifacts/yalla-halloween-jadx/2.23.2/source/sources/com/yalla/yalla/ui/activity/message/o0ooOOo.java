...
public final class o0ooOOo extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ FriendRequestMessageActivity f25539OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0ooOOo(FriendRequestMessageActivity friendRequestMessageActivity) {
        super(0);
        this.f25539OooO0Oo = friendRequestMessageActivity;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        int i = FriendRequestMessageActivity.f25195OooOo0o;
        this.f25539OooO0Oo.OooOoO().clearMessage();
