...
public final class OooO0O0 extends Lambda implements Function1<Boolean, Unit> {
    ...
    public final /* synthetic */ AddTopicListActivity.OooO00o f25770OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooO0O0(AddTopicListActivity.OooO00o oooO00o) {
        super(1);
        this.f25770OooO0Oo = oooO00o;
    }

    @Override // kotlin.jvm.functions.Function1
    public final Unit invoke(Boolean bool) {
        boolean zBooleanValue = bool.booleanValue();
        AddTopicListActivity.OooO00o oooO00o = this.f25770OooO0Oo;
        AddTopicListActivity activity = oooO00o.f25573OooOoo0;
