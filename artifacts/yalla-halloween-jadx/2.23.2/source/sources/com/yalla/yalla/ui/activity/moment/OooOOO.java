...
public final class OooOOO extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MomentDetailActivity f25777OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooOOO(MomentDetailActivity momentDetailActivity) {
        super(0);
        this.f25777OooO0Oo = momentDetailActivity;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        MomentDetailActivity momentDetailActivity = this.f25777OooO0Oo;
