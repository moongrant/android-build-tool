...
public final class OooOo extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ MomentRecordEditVM f25780OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ long f25781OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooOo(MomentRecordEditVM momentRecordEditVM, long j, Continuation<? super OooOo> continuation) {
        super(2, continuation);
        this.f25780OooO0Oo = momentRecordEditVM;
        this.f25781OooO0o0 = j;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new OooOo(this.f25780OooO0Oo, this.f25781OooO0o0, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        MomentRecordEditVM momentRecordEditVM = this.f25780OooO0Oo;
        if (momentRecordEditVM.getLoadMoreState().getValue() == LoadMoreState.Loading) {
            momentRecordEditVM.loadData(this.f25781OooO0o0, false);
        }
