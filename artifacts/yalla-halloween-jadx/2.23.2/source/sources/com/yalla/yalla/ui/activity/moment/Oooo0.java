...
public final class Oooo0 extends Lambda implements Function1<LazyListScope, Unit> {
    ...
    public final /* synthetic */ MomentRecordEditVM f25784OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ MutableState<o000OO> f25785OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ FragmentActivity f25786OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final /* synthetic */ long f25787OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final /* synthetic */ int f25788OooO0oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public Oooo0(MomentRecordEditVM momentRecordEditVM, FragmentActivity fragmentActivity, MutableState<o000OO> mutableState, long j, int i) {
        super(1);
        this.f25784OooO0Oo = momentRecordEditVM;
        this.f25786OooO0o0 = fragmentActivity;
        this.f25785OooO0o = mutableState;
        this.f25787OooO0oO = j;
        this.f25788OooO0oo = i;
    }
    ...
    public final Unit invoke(LazyListScope lazyListScope) {
        ...
        MomentRecordEditVM momentRecordEditVM = this.f25784OooO0Oo;
        ...
        final FragmentActivity fragmentActivity = this.f25786OooO0o0;
        final MutableState<o000OO> mutableState = this.f25785OooO0o;
        LazyColumn.items(size, null, function1, ComposableLambdaKt.composableLambdaInstance(-1091073711, true, new Function4<LazyItemScope, Integer, Composer, Integer, Unit>() { // from class: com.yalla.yalla.ui.activity.moment.MomentEditRecordScreen$ListContent$3$2$1$invoke$$inlined$itemsIndexed$default$3
            ...
            public final Unit invoke(LazyItemScope lazyItemScope, Integer num, Composer composer, Integer num2) {
                ...
                if ((i & 731) == 146 && composer2.getSkipping()) {
                    ...
                    oo0oOO0.OooO00o(momentDetailModel, iIntValue, MomentEditRecordScreen.ListContent$lambda$3(mutableState), MomentAdapterTag.MomentEditRecord, fragmentActivity, EnterRoomParentPage.Moments_Other_SharedRoom, null, false, false, null, false, 0L, null, null, null, null, composer2, (i2 & 112) | 1805832, 0, 65408);
        ...
        if (momentRecordEditVM.getListData().size() > 0) {
            LazyListScope.CC.OooO(LazyColumn, null, null, ComposableLambdaKt.composableLambdaInstance(315383475, true, new Oooo000(momentRecordEditVM, this.f25787OooO0oO, this.f25788OooO0oo)), 3, null);
        }
        return Unit.INSTANCE;
    }
}
