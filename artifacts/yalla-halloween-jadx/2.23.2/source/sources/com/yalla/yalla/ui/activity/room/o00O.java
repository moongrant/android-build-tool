...
public final class o00O extends Lambda implements Function1<ProfileLimitModel, Unit> {
    ...
    public final /* synthetic */ RoomSettingActivity f26402OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00O(RoomSettingActivity roomSettingActivity) {
        super(1);
        this.f26402OooO0Oo = roomSettingActivity;
    }
    ...
    public final Unit invoke(ProfileLimitModel profileLimitModel) {
        ...
        RoomSettingActivity roomSettingActivity = this.f26402OooO0Oo;
