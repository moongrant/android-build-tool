...
public final class o00O0OOO extends Lambda implements Function1<ProfileLimitModel, Unit> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ RoomSettingActivity f26420OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00O0OOO(RoomSettingActivity roomSettingActivity) {
        super(1);
        this.f26420OooO0Oo = roomSettingActivity;
    }
    ...
    public final Unit invoke(ProfileLimitModel profileLimitModel) {
        ...
        RoomSettingActivity roomSettingActivity = this.f26420OooO0Oo;
        for (RoomItemInfoModel roomItemInfoModel : roomSettingActivity.f26195OooOo00) {
            ...
            if (profileLimitModel3 != null) {
                z = profileLimitModel3.getOperationType() == 1;
            }
            if (z) {
