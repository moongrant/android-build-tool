...
public final class o0ooOOo extends Lambda implements Function1<Editable, Unit> {
    ...
    public final /* synthetic */ CreateRoomActivity f26488OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0ooOOo(CreateRoomActivity createRoomActivity) {
        super(1);
        this.f26488OooO0Oo = createRoomActivity;
    }
    ...
    public final Unit invoke(Editable editable) {
        ...
        CreateRoomActivity createRoomActivity = this.f26488OooO0Oo;
        if (editable2 != null) {
            TextView textView = createRoomActivity.f26053OooOOoo;
            if (textView == null) {
        ...
        EditText editText2 = createRoomActivity.f26051OooOOo;
        if (editText2 == null) {
