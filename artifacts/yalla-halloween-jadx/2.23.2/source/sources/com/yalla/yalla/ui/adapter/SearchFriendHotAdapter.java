...
public final class SearchFriendHotAdapter extends RecyclerView.Adapter<SearchFriendHotViewHolder> {
    ...
    @NotNull
    public final FragmentActivity f26986OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @Nullable
    public Context f26987OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @Nullable
    public SearchRecommendModel f26988OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @Nullable
    public Function3<? super View, ? super Integer, ? super UserInfo, Unit> f26989OooO0Oo;
    ...
    public static final class SearchFriendHotViewHolder extends RecyclerView.o0O0O00 {
        ...
        public SearchFriendHotViewHolder(@NotNull View itemView) {
            ...
            View viewFindViewById = itemView.findViewById(p562o0oOo000.o0OO00O.head);
            Intrinsics.checkNotNullExpressionValue(viewFindViewById, "findViewById(...)");
            this.head = (NetImageView) viewFindViewById;
            View viewFindViewById2 = itemView.findViewById(p562o0oOo000.o0OO00O.vip);
            Intrinsics.checkNotNullExpressionValue(viewFindViewById2, "findViewById(...)");
            this.vip = (UserPremiumView) viewFindViewById2;
            View viewFindViewById3 = itemView.findViewById(p562o0oOo000.o0OO00O.name);
            Intrinsics.checkNotNullExpressionValue(viewFindViewById3, "findViewById(...)");
            this.name = (TextView) viewFindViewById3;
            View viewFindViewById4 = itemView.findViewById(p562o0oOo000.o0OO00O.sex);
            Intrinsics.checkNotNullExpressionValue(viewFindViewById4, "findViewById(...)");
            this.sex = (ImageView) viewFindViewById4;
            View viewFindViewById5 = itemView.findViewById(p562o0oOo000.o0OO00O.kaVip);
            Intrinsics.checkNotNullExpressionValue(viewFindViewById5, "findViewById(...)");
            this.kaVip = (UserVipView) viewFindViewById5;
            View viewFindViewById6 = itemView.findViewById(p562o0oOo000.o0OO00O.wealth);
    ...
    public SearchFriendHotAdapter(@NotNull FragmentActivity activity) {
        ...
        this.f26986OooO00o = activity;
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public final int getItemCount() {
        SearchRecommendModel searchRecommendModel = this.f26988OooO0OO;
    ...
    public final void onBindViewHolder(RecyclerView.o0O0O00 o0o0o00, int i) {
        ...
        com.code.android.util.o000O.OooO(itemView, new o000O0(this, holder, i, userInfo));
        o0OOo0Oo.Oooo000.OooO00o oooO00o = new o0OOo0Oo.Oooo000.OooO00o(this.f26987OooO0O0);
        ...
        FragmentActivity fragmentActivity = this.f26986OooO00o;
        ...
        if (Intrinsics.areEqual(AppEventsConstants.EVENT_PARAM_VALUE_NO, sb.toString())) {
            holder.getSex().setImageResource(p562o0oOo000.o0Oo0oo.icon_female);
            return;
        }
        ...
        if (Intrinsics.areEqual("1", sb2.toString())) {
            holder.getSex().setImageResource(p562o0oOo000.o0Oo0oo.icon_male);
        } else {
    ...
    public final RecyclerView.o0O0O00 onCreateViewHolder(ViewGroup parent, int i) {
        ...
        this.f26987OooO0O0 = context;
        View viewInflate = LayoutInflater.from(context).inflate(p562o0oOo000.oo0o0Oo.item_search_friend_hot, parent, false);
        Intrinsics.checkNotNull(viewInflate);
        return new SearchFriendHotViewHolder(viewInflate);
    }
}
