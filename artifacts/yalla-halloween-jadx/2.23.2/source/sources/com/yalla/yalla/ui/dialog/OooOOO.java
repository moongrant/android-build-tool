...
public final class OooOOO extends Lambda implements Function1<Boolean, Unit> {
    ...
    public final /* synthetic */ RoomGameBoxDialog f27391OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooOOO(RoomGameBoxDialog roomGameBoxDialog) {
        super(1);
        this.f27391OooO0Oo = roomGameBoxDialog;
    }
    ...
    public final Unit invoke(Boolean bool) {
        Boolean bool2 = bool;
        if (bool2 != null) {
            this.f27391OooO0Oo.OooOOO0(bool2.booleanValue(), RoomGameBoxDialog.GameType.GameCamel);
        }
