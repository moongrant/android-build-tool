...
public final class GiftSendFragment extends p527o0o0OO0o.o000O<o0> {
    ...
    public static final class OooO0OO extends Lambda implements Function0<o0ooOOo> {
        public OooO0OO() {
            super(0);
        }
        ...
        public final o0ooOOo invoke() {
            ...
            return new o0ooOOo(giftSendFragment, giftSendFragment.getContext(), p562o0oOo000.oo0o0Oo.item_gift_send_page);
        }
    }
    ...
    public static final class OooO0o extends RecyclerView.o00O0O {
        ...
        public final void onScrollStateChanged(@NotNull RecyclerView recyclerView, int i) {
            ...
            if (i == 0) {
                GiftSendFragment giftSendFragment = GiftSendFragment.this;
                RecyclerView.Oooo000 layoutManager = giftSendFragment.getBinding().f44204OooO0OO.getLayoutManager();
    ...
    public final void closeDefaultAnimator(RecyclerView mRvCustomer) {
        ...
        if (itemAnimator != null) {
            itemAnimator.f10686OooO0OO = 0L;
            itemAnimator.f10688OooO0o = 0L;
            itemAnimator.f10689OooO0o0 = 0L;
            itemAnimator.f10687OooO0Oo = 0L;
            ((androidx.recyclerview.widget.o00000O0) itemAnimator).f10831OooO0oO = false;
        }
    }
    ...
    private final p571o0oOoO0.o0000oo<List<GiftPropModel>> getGiftPagerAdapter() {
        return (p571o0oOoO0.o0000oo) this.giftPagerAdapter.getValue();
    }
    ...
    private final void initGiftPoint(int pageSize) {
        ...
        getBinding().f44203OooO0O0.removeAllViews();
        for (int i = 0; i < pageSize; i++) {
            ImageView imageView = new ImageView(getContext());
            if (i == 0) {
                imageView.setImageResource(p562o0oOo000.o0Oo0oo.icon_banner_point_green);
            } else {
                imageView.setImageResource(p562o0oOo000.o0Oo0oo.no_select);
            }
            ...
            getBinding().f44203OooO0O0.addView(imageView, layoutParams);
        }
    }

    @SuppressLint({"ClickableViewAccessibility"})
    private final void initView() {
        getBinding().f44204OooO0OO.setLayoutManager(new LinearLayoutManager(getContext(), 0, false));
        RecyclerView recyclerView = getBinding().f44204OooO0OO;
        Intrinsics.checkNotNullExpressionValue(recyclerView, "recyclerView");
        closeDefaultAnimator(recyclerView);
        new androidx.recyclerview.widget.o000000().attachToRecyclerView(getBinding().f44204OooO0OO);
        getGiftPagerAdapter().Oooo00o();
        getGiftPagerAdapter().OooOo0(getEmptyView());
        getBinding().f44204OooO0OO.setOnTouchListener(new o00Ooo());
        getBinding().f44204OooO0OO.addOnScrollListener(new OooO0o());
        getBinding().f44204OooO0OO.setAdapter(getGiftPagerAdapter());
    }
        ...
        for (Object obj : this.giftPageList) {
            ...
            for (Object obj2 : (List) obj) {
                ...
                if (((GiftPropModel) obj2).getGiftId() == giftId) {
                    getBinding().f44204OooO0OO.scrollToPosition(i2);
                    RecyclerView.Adapter adapter = getBinding().f44204OooO0OO.getAdapter();
                    if (adapter != null) {
    ...
    public final void updateIndicator(int position) {
        if (getBinding().f44203OooO0O0.getChildCount() <= 1) {
            return;
        }
        int childCount = getBinding().f44203OooO0O0.getChildCount();
        for (int i = 0; i < childCount; i++) {
            View childAt = getBinding().f44203OooO0O0.getChildAt(i);
    ...
    @NotNull
    public o0 getViewBinding(@NotNull LayoutInflater inflater, @Nullable ViewGroup container) {
        Intrinsics.checkNotNullParameter(inflater, "inflater");
        o0 o0VarInflate = o0.inflate(inflater);
        Intrinsics.checkNotNullExpressionValue(o0VarInflate, "inflate(...)");
        return o0VarInflate;
    }
}
