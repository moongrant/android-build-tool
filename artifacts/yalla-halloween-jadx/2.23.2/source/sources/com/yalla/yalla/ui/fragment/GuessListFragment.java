...
import p405o0Oo0OOO.d0;
import p642o0ooOOO0.d1;

/* JADX INFO: loaded from: classes4.dex */
@StabilityInferred(parameters = 0)
@Metadata(d1 = {"\u0000J\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0007\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B#\u0012\u0006\u0010\r\u001a\u00020\f\u0012\b\b\u0002\u0010\u0012\u001a\u00020\u0011\u0012\b\b\u0002\u0010\u0014\u001a\u00020\u0011¢\u0006\u0004\b!\u0010\"J\u001a\u0010\u0007\u001a\u00020\u00022\u0006\u0010\u0004\u001a\u00020\u00032\b\u0010\u0006\u001a\u0004\u0018\u00010\u0005H\u0016J\b\u0010\t\u001a\u00020\bH\u0016J\u0006\u0010\n\u001a\u00020\bJ\b\u0010\u000b\u001a\u00020\bH\u0014R\u0017\u0010\r\u001a\u00020\f8\u0006¢\u0006\f\n\u0004\b\r\u0010\u000e\u001a\u0004\b\u000f\u0010\u0010R\u0014\u0010\u0012\u001a\u00020\u00118\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0012\u0010\u0013R\u0014\u0010\u0014\u001a\u00020\u00118\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0014\u0010\u0013R\u0018\u0010\u0016\u001a\u0004\u0018\u00010\u00158\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0016\u0010\u0017R\u001b\u0010\u001d\u001a\u00020\u00188BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u0019\u0010\u001a\u001a\u0004\b\u001b\u0010\u001cR\u001c\u0010\u001f\u001a\b\u0012\u0004\u0012\u00020\u00150\u001e8\u0002@\u0002X\u0082.¢\u0006\u0006\n\u0004\b\u001f\u0010 ¨\u0006#"}, d2 = {"Lcom/yalla/yalla/ui/fragment/GuessListFragment;", "Lo0o0OO0o/o000O;", "Lo0Oo0OOO/d0;", "Landroid/view/LayoutInflater;", "inflater", "Landroid/view/ViewGroup;", "container", "getViewBinding", "", "onResume", "updateSelfData", "onLazyInit", "Landroid/content/Context;", "mContext", "Landroid/content/Context;", "getMContext", "()Landroid/content/Context;", "", "giftId", "I", "moraRankType", "Lcom/yalla/yalla/model/GuessUserData;", "selfData", "Lcom/yalla/yalla/model/GuessUserData;", "Lcom/yalla/yalla/ui/vm/room/GuessListVM;", "vm$delegate", "Lkotlin/Lazy;", "getVm", "()Lcom/yalla/yalla/ui/vm/room/GuessListVM;", "vm", "Lo0oOoO0/o0000oo;", "adapter", "Lo0oOoO0/o0000oo;", "<init>", "(Landroid/content/Context;II)V", "Common_YallaRelease"}, k = 1, mv = {1, 9, 0})
@SourceDebugExtension({"SMAP\nGuessListFragment.kt\nKotlin\n*S Kotlin\n*F\n+ 1 GuessListFragment.kt\ncom/yalla/yalla/ui/fragment/GuessListFragment\n+ 2 FragmentViewModelLazy.kt\nandroidx/fragment/app/FragmentViewModelLazyKt\n*L\n1#1,120:1\n106#2,15:121\n*S KotlinDebug\n*F\n+ 1 GuessListFragment.kt\ncom/yalla/yalla/ui/fragment/GuessListFragment\n*L\n34#1:121,15\n*E\n"})
public final class GuessListFragment extends p527o0o0OO0o.o000O<d0> {
    public static final int $stable = 8;
    private p571o0oOoO0.o0000oo<GuessUserData> adapter;
    ...
    public static final class OooO00o extends p571o0oOoO0.o0000oo<GuessUserData> {
        ...
        public final void OooO0oO(BaseViewHolder baseViewHolder, Object obj) {
            ...
            int i = p562o0oOo000.o0OO00O.ivRanking;
            int num = guessUserData.getNum();
            viewHolder.setGone(i, 1 <= num && num < 4);
            int i2 = p562o0oOo000.o0OO00O.ivRankingFrame;
            int num2 = guessUserData.getNum();
            viewHolder.setGone(i2, 1 <= num2 && num2 < 4);
            int i3 = p562o0oOo000.o0OO00O.tvRanking;
            viewHolder.setGone(i3, guessUserData.getNum() > 3);
            int num3 = guessUserData.getNum();
            if (num3 == 1) {
                ((ImageView) viewHolder.getView(i)).setImageResource(p562o0oOo000.o0Oo0oo.user_support_one);
                ((ImageView) viewHolder.getView(i2)).setImageResource(p562o0oOo000.o0Oo0oo.room_dialog_rank_gold);
            } else if (num3 == 2) {
                ((ImageView) viewHolder.getView(i)).setImageResource(p562o0oOo000.o0Oo0oo.user_support_two);
                ((ImageView) viewHolder.getView(i2)).setImageResource(p562o0oOo000.o0Oo0oo.user_badge_item_rank_second);
            } else if (num3 != 3) {
                ((TextView) viewHolder.getView(i3)).setText(String.valueOf(guessUserData.getNum()));
            } else {
                ((ImageView) viewHolder.getView(i)).setImageResource(p562o0oOo000.o0Oo0oo.user_support_three);
                ((ImageView) viewHolder.getView(i2)).setImageResource(p562o0oOo000.o0Oo0oo.user_badge_item_rank_third);
            }
            ((UserPremiumView) viewHolder.getView(p562o0oOo000.o0OO00O.vipView)).OooO0Oo(guessUserData.getPremiumLevel(), guessUserData.isPremium());
            ((SexView) viewHolder.getView(p562o0oOo000.o0OO00O.sexView)).setSex(guessUserData.getSex());
            viewHolder.setText(p562o0oOo000.o0OO00O.tvName, guessUserData.getUserName());
            ...
            oooO00o.OooO0Oo((ImageView) viewHolder.getView(p562o0oOo000.o0OO00O.ivHeader));
            viewHolder.setText(p562o0oOo000.o0OO00O.tvGiftNumber, String.valueOf(guessUserData.getNumber()));
            ((ImageView) viewHolder.getView(p562o0oOo000.o0OO00O.ivType)).setImageResource(GuessListFragment.this.moraRankType == 1 ? p562o0oOo000.o0Oo0oo.room_dialog_guessing_gift : p562o0oOo000.o0Oo0oo.icon_room_bottom_game_box_mora);
        }
    }
        ...
        public final Unit invoke(ApiResult<GuessData> apiResult) {
            ...
            if (apiResult2.isSuccess()) {
                ...
                if (data2 != null && (rankData = data2.getRankData()) != null) {
                    p571o0oOoO0.o0000oo o0000ooVar = guessListFragment.adapter;
                    if (o0000ooVar == null) {
                        Intrinsics.throwUninitializedPropertyAccessException("adapter");
                        o0000ooVar = null;
                    }
                    o0000ooVar.OooOoO0(rankData);
                    p571o0oOoO0.o0000oo o0000ooVar2 = guessListFragment.adapter;
                    if (o0000ooVar2 == null) {
                        Intrinsics.throwUninitializedPropertyAccessException("adapter");
                        o0000ooVar2 = null;
                    }
    ...
    public static final class OooO0OO implements Observer, FunctionAdapter {
        ...
        public final /* synthetic */ Function1 f27669OooO0Oo;

        public OooO0OO(OooO0O0 function) {
            Intrinsics.checkNotNullParameter(function, "function");
            this.f27669OooO0Oo = function;
        }
        ...
        public final boolean equals(@Nullable Object obj) {
            ...
            return Intrinsics.areEqual(this.f27669OooO0Oo, ((FunctionAdapter) obj).getFunctionDelegate());
        }
        ...
        public final int hashCode() {
            return this.f27669OooO0Oo.hashCode();
        }

        @Override // androidx.lifecycle.Observer
        public final /* synthetic */ void onChanged(Object obj) {
            this.f27669OooO0Oo.invoke(obj);
        }
    }
    ...
    public void onLazyInit() {
        super.onLazyInit();
        OooO00o oooO00o = new OooO00o(this.mContext, p562o0oOo000.oo0o0Oo.room_item_dialog_guess_list);
        this.adapter = oooO00o;
        oooO00o.OooOooo(p562o0oOo000.o0Oo0oo.room_dialog_guess_list_empty);
        getBinding().f43773OooO0O0.setLayoutManager(new FixLinearLayoutManager(this.mContext));
        RecyclerView recyclerView = getBinding().f43773OooO0O0;
        p571o0oOoO0.o0000oo<GuessUserData> o0000ooVar = this.adapter;
        p571o0oOoO0.o0000oo<GuessUserData> o0000ooVar2 = null;
        if (o0000ooVar == null) {
            Intrinsics.throwUninitializedPropertyAccessException("adapter");
            o0000ooVar = null;
        }
        ...
        if (this.mContext instanceof FragmentActivity) {
            p571o0oOoO0.o0000oo<GuessUserData> o0000ooVar3 = this.adapter;
            if (o0000ooVar3 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("adapter");
            } else {
                o0000ooVar2 = o0000ooVar3;
            }
            o0000ooVar2.f13176OooO0o = new BaseQuickAdapter.OooO0o() { // from class: androidx.media3.session.o00000
                @Override // com.chad.library.adapter.base.BaseQuickAdapter.OooO0o
                public final void OooO0o(BaseQuickAdapter baseQuickAdapter, View view, int i) {
                    GuessListFragment.onLazyInit$lambda$0((GuessListFragment) this, baseQuickAdapter, view, i);
                }
            };
    ...
    public GuessListFragment(@NotNull Context mContext, int i, int i2) {
        ...
        this.vm = androidx.fragment.app.o000Oo0.OooO0O0(this, Reflection.getOrCreateKotlinClass(GuessListVM.class), new Function0<ViewModelStore>() { // from class: com.yalla.yalla.ui.fragment.GuessListFragment$special$$inlined$viewModels$default$3
            {
                super(0);
            }
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ Function0 f27673OooO0Oo = null;
            ...
            public final CreationExtras invoke() {
                ...
                Function0 function0 = this.f27673OooO0Oo;
    ...
    @NotNull
    public d0 getViewBinding(@NotNull LayoutInflater inflater, @Nullable ViewGroup container) {
        Intrinsics.checkNotNullParameter(inflater, "inflater");
        d0 d0VarInflate = d0.inflate(inflater, container, false);
        Intrinsics.checkNotNullExpressionValue(d0VarInflate, "inflate(...)");
        return d0VarInflate;
    }
}
