...
import p525o0o0OO0.o00OO0O0;
import p529o0o0OOO0.o00000;
import p529o0o0OOO0.o000000O;
import p529o0o0OOO0.o00000O;
import p529o0o0OOO0.o00000O0;
import p529o0o0OOO0.o00000OO;
import p529o0o0OOO0.o000OOo;
...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0007\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Lcom/yalla/yalla/ui/fragment/message/MessageBoxFragment;", "Lo0o0OO0/o00OO0O0;", "<init>", "()V", "Common_YallaRelease"}, k = 1, mv = {1, 9, 0})
...
public final class MessageBoxFragment extends o00OO0O0 {

    /* JADX INFO: renamed from: OooOo00, reason: collision with root package name */
    public static final /* synthetic */ int f27995OooOo00 = 0;

    /* JADX INFO: renamed from: OooOOOO, reason: collision with root package name */
    @NotNull
    public final ViewModelLazy f27996OooOOOO;

    /* JADX INFO: renamed from: OooOOOo, reason: collision with root package name */
    public Oooo000 f27997OooOOOo;

    /* JADX INFO: renamed from: OooOOo, reason: collision with root package name */
    @NotNull
    public final ConcatAdapter f27998OooOOo;

    /* JADX INFO: renamed from: OooOOo0, reason: collision with root package name */
    public com.yalla.yalla.ui.adapter.OooO0OO f27999OooOOo0;

    /* JADX INFO: renamed from: OooOOoo, reason: collision with root package name */
    public oO0O00o0 f28000OooOOoo;
    ...
    public static final class OooO0O0 implements Observer, FunctionAdapter {
        ...
        public final /* synthetic */ Function1 f28001OooO0Oo;

        public OooO0O0(Function1 function) {
            Intrinsics.checkNotNullParameter(function, "function");
            this.f28001OooO0Oo = function;
        }
        ...
        public final boolean equals(@Nullable Object obj) {
            ...
            return Intrinsics.areEqual(this.f28001OooO0Oo, ((FunctionAdapter) obj).getFunctionDelegate());
        }

        @Override // kotlin.jvm.internal.FunctionAdapter
        @NotNull
        public final Function<?> getFunctionDelegate() {
            return this.f28001OooO0Oo;
        }

        public final int hashCode() {
            return this.f28001OooO0Oo.hashCode();
        }

        @Override // androidx.lifecycle.Observer
        public final /* synthetic */ void onChanged(Object obj) {
            this.f28001OooO0Oo.invoke(obj);
        }
    }
    ...
    public MessageBoxFragment() {
        ...
        this.f27996OooOOOO = o000Oo0.OooO0O0(this, Reflection.getOrCreateKotlinClass(o0000O0O.class), new Function0<ViewModelStore>() { // from class: com.yalla.yalla.ui.fragment.message.MessageBoxFragment$special$$inlined$viewModels$default$3
            {
                super(0);
            }
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ Function0 f28005OooO0Oo = null;
            ...
            public final CreationExtras invoke() {
                ...
                Function0 function0 = this.f28005OooO0Oo;
        ...
        this.f27998OooOOo = new ConcatAdapter(new RecyclerView.Adapter[0]);
    }

    @Override // p525o0o0OO0.o00OO0O0
    public final int OooO0Oo() {
        return oo0o0Oo.message_fragment_message_list;
    }
    ...
    public final void OooO0o0() {
        View splitLine = this.f53231OooO;
        Intrinsics.checkNotNullExpressionValue(splitLine, "splitLine");
        o000O.OooO0O0(splitLine);
        this.f53238OooOOO.setTextColor(o0000.OooO00o(o0OOO0o.color_333333));
        this.f53238OooOOO.getPaint().setFakeBoldText(true);
        oO0O00o0 oo0o00o0OooO00o = oO0O00o0.OooO00o(this.f53234OooO0oo);
        Intrinsics.checkNotNullExpressionValue(oo0o00o0OooO00o, "bind(...)");
        this.f28000OooOOoo = oo0o00o0OooO00o;
        LinearLayout clChatServerConnStatus = oo0o00o0OooO00o.f44871OooO0O0;
        Intrinsics.checkNotNullExpressionValue(clChatServerConnStatus, "clChatServerConnStatus");
        o000O.OooO0O0(clChatServerConnStatus);
        oO0O00o0 oo0o00o0 = this.f28000OooOOoo;
        if (oo0o00o0 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("binding");
            oo0o00o0 = null;
        }
        oo0o00o0.f44877OooO0oo.f20857OooOooO = false;
        oO0O00o0 oo0o00o1 = this.f28000OooOOoo;
        if (oo0o00o1 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("binding");
            oo0o00o1 = null;
        }
        oo0o00o1.f44875OooO0o0.setLayoutManager(new FixLinearLayoutManager(getActivity()));
        oO0O00o0 oo0o00o2 = this.f28000OooOOoo;
        if (oo0o00o2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("binding");
            oo0o00o2 = null;
        }
        Context context = oo0o00o2.f44877OooO0oo.getContext();
        Intrinsics.checkNotNullExpressionValue(context, "getContext(...)");
        Oooo000 oooo000 = new Oooo000(context);
        this.f27997OooOOOo = oooo000;
        oooo000.OooOoOO(true);
        Oooo000 oooo001 = this.f27997OooOOOo;
        if (oooo001 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("adapterMessageHead");
            oooo001 = null;
        }
        int i = 3;
        oooo001.f13176OooO0o = new o000O0o(this, i);
        Oooo000 oooo002 = this.f27997OooOOOo;
        if (oooo002 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("adapterMessageHead");
            oooo002 = null;
        }
        ConcatAdapter concatAdapter = this.f27998OooOOo;
        concatAdapter.OooO0O0(oooo002);
        com.yalla.yalla.ui.adapter.OooO0OO oooO0OO = new com.yalla.yalla.ui.adapter.OooO0OO(this);
        this.f27999OooOOo0 = oooO0OO;
        concatAdapter.OooO0O0(oooO0OO);
        oO0O00o0 oo0o00o3 = this.f28000OooOOoo;
        if (oo0o00o3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("binding");
            oo0o00o3 = null;
        }
        oo0o00o3.f44875OooO0o0.setAdapter(concatAdapter);
        com.yalla.yalla.ui.adapter.OooO0OO oooO0OO2 = this.f27999OooOOo0;
        if (oooO0OO2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("adapterMessageChat");
            oooO0OO2 = null;
        }
        o00000OO listener = new o00000OO(this);
        oooO0OO2.getClass();
        Intrinsics.checkNotNullParameter(listener, "listener");
        oooO0OO2.f58005OooOO0O = listener;
        oO0O00o0 oo0o00o4 = this.f28000OooOOoo;
        if (oo0o00o4 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("binding");
            oo0o00o4 = null;
        }
        FixedRecyclerView rvMessage = oo0o00o4.f44875OooO0o0;
        Intrinsics.checkNotNullExpressionValue(rvMessage, "rvMessage");
        l0.OooO00o(rvMessage);
        oO0O00o0 oo0o00o5 = this.f28000OooOOoo;
        if (oo0o00o5 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("binding");
            oo0o00o5 = null;
        }
        ComposeView myRoomCV = oo0o00o5.f44873OooO0Oo;
        Intrinsics.checkNotNullExpressionValue(myRoomCV, "myRoomCV");
        o0000oo.OooO0Oo(myRoomCV, o000OOo.f53386OooO00o);
        ...
        if (unreadSystemMessageCount != null) {
            unreadSystemMessageCount.observe(this, new oo0OOoo(this, i));
        }
        LiveData<SystemMessage> latestSystemMessage = sharedMessageVM.getLatestSystemMessage();
        if (latestSystemMessage != null) {
            latestSystemMessage.observe(this, new OooO0O0(new o000000O(this)));
        }
        ...
        unreadYallaTeamMessageCount.observe(this, new OooO0O0(new o00000(this)));
        ...
        latestYallaTeamMessage.observe(this, new OooO0O0(new o00000O0(this)));
        BuildersKt__Builders_commonKt.launch$default(LifecycleOwnerKt.getLifecycleScope(this), null, null, new o00000O(this, null), 3, null);
    }
