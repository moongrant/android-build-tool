...
public final class o000 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MomentFeaturedVM f28294OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o000(MomentFeaturedVM momentFeaturedVM) {
        super(0);
        this.f28294OooO0Oo = momentFeaturedVM;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        MomentFeaturedVM momentFeaturedVM = this.f28294OooO0Oo;
