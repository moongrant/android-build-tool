...
public final class o0000O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ MomentFeaturedVM f28310OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0000O0(MomentFeaturedVM momentFeaturedVM, Continuation<? super o0000O0> continuation) {
        super(2, continuation);
        this.f28310OooO0Oo = momentFeaturedVM;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o0000O0(this.f28310OooO0Oo, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        this.f28310OooO0Oo.setSupportHidePost(true);
