...
public final class OooO extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ RoomInfoMomentListVM f28426OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooO(RoomInfoMomentListVM roomInfoMomentListVM) {
        super(0);
        this.f28426OooO0Oo = roomInfoMomentListVM;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        RoomInfoMomentListVM.getMoments$default(this.f28426OooO0Oo, false, 1, null);
