...
public final class OooOOO extends Lambda implements Function3<LazyItemScope, Composer, Integer, Unit> {
    ...
    public final /* synthetic */ RoomInfoMomentListVM f28434OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooOOO(RoomInfoMomentListVM roomInfoMomentListVM) {
        super(3);
        this.f28434OooO0Oo = roomInfoMomentListVM;
    }
    ...
    public final Unit invoke(LazyItemScope lazyItemScope, Composer composer, Integer num) {
        ...
        if ((iIntValue & 81) == 16 && composer2.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-793681587, iIntValue, -1, "com.yalla.yalla.ui.fragment.room.RoomInfoMomentFragment.initView.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous> (RoomInfoMomentFragment.kt:132)");
            }
            RoomInfoMomentListVM roomInfoMomentListVM = this.f28434OooO0Oo;
            ...
            o00Oo00.OooO0O0(roomInfoMomentListVM.getLoadMoreState().getValue(), null, composer2, 0, 2);
            if (ComposerKt.isTraceInProgress()) {
