...
import p509o0o00ooO.n2;
import p530o0o0OOOO.o0O00OO;
...
public final class RoomInfoProfileFragment extends com.yalla.yalla.base.fragment.OooO00o {
    ...
    private final Lazy liveRoomVM = o000Oo0.OooO0O0(this, Reflection.getOrCreateKotlinClass(LiveRoomVM.class), new Function0<ViewModelStore>() { // from class: com.yalla.yalla.ui.fragment.room.RoomInfoProfileFragment$special$$inlined$activityViewModels$default$1
        ...
        public final /* synthetic */ Function0 f28504OooO0Oo = null;
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f28504OooO0Oo;
    ...
    @NotNull
    private final Lazy loadingVM = o000Oo0.OooO0O0(this, Reflection.getOrCreateKotlinClass(o0oOo0O0.class), new Function0<ViewModelStore>() { // from class: com.yalla.yalla.ui.fragment.room.RoomInfoProfileFragment$special$$inlined$activityViewModels$default$4
        {
            super(0);
        }
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function0 f28508OooO0Oo = null;
        ...
        public final CreationExtras invoke() {
            CreationExtras creationExtras;
            Function0 function0 = this.f28508OooO0Oo;
            if (function0 != null && (creationExtras = (CreationExtras) function0.invoke()) != null) {
                return creationExtras;
            }
            CreationExtras defaultViewModelCreationExtras = this.requireActivity().getDefaultViewModelCreationExtras();
    ...
    public static final class OooO extends Lambda implements Function1<Integer, Unit> {
        ...
        public final /* synthetic */ com.yalla.yalla.service.room.OooO0O0 f28488OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(com.yalla.yalla.service.room.OooO0O0 oooO0O0) {
            super(1);
            this.f28488OooO0o0 = oooO0O0;
        }
    ...
    public static final class OooOO0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f28492OooO0Oo;

        public static final class OooO00o<T> implements FlowCollector {

            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ RoomInfoProfileFragment f28494OooO0Oo;

            public OooO00o(RoomInfoProfileFragment roomInfoProfileFragment) {
                this.f28494OooO0Oo = roomInfoProfileFragment;
            }

            @Override // kotlinx.coroutines.flow.FlowCollector
            public final Object emit(Object obj, Continuation continuation) {
                String string = (String) obj;
                RoomInfoProfileFragment roomInfoProfileFragment = this.f28494OooO0Oo;
                FixTextView fixTextView = roomInfoProfileFragment.tvRoomBroadcast;
                if (fixTextView != null) {
                    if (TextUtils.isEmpty(string)) {
                        string = roomInfoProfileFragment.getString(o000000.title_RoomInfoMenu_normalNotice);
                    }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f28492OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                MutableStateFlow<String> mutableStateFlow = com.yalla.yalla.service.room.OooO00o.f24516OooO0o0.f48463OooO0o;
                OooO00o oooO00o = new OooO00o(RoomInfoProfileFragment.this);
                this.f28492OooO0Oo = 1;
    ...
    public static final class OooOOO extends Lambda implements Function1<View, Unit> {
        ...
        public final Unit invoke(View view) {
            ...
            Boolean value = com.yalla.yalla.service.room.OooO0O0.f24533OoooOOO.OooO00o().f24545OooOO0O.getValue();
            Boolean bool = Boolean.TRUE;
            if (Intrinsics.areEqual(value, bool)) {
                com.yalla.yalla.service.room.OooO00o.f24524OooOOOO.f48542OooOoO.setValue(bool);
            } else {
                RoomInfoProfileFragment roomInfoProfileFragment = RoomInfoProfileFragment.this;
                FragmentActivity activity = roomInfoProfileFragment.getActivity();
                if (activity != null) {
                    o0oOo0O0.OooO0O0(roomInfoProfileFragment.getLoadingVM());
    ...
    public static final class OooOOOO extends o0OOOO0o {
        ...
        public final void OooO00o(@NotNull View view) {
            ...
            o0oo0000.OooO00o.OooO0O0("102155");
            RoomInfoProfileFragment roomInfoProfileFragment = RoomInfoProfileFragment.this;
            ...
            clipboardManager.setPrimaryClip(ClipData.newPlainText("Yalla", ((String[]) StringsKt__StringsKt.split$default((CharSequence) String.valueOf(textView != null ? textView.getText() : null), new String[]{"ID:"}, false, 0, 6, (Object) null).toArray(new String[0]))[1]));
            String strOooO0OO = o0000.OooO0OO(o000000.UserInfo_Clip_cpoied);
    ...
    public static final class OooOo extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ String f28499OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ RoomInfoProfileFragment f28500OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOo(RoomInfoProfileFragment roomInfoProfileFragment, String str) {
            super(0);
            this.f28499OooO0Oo = str;
            this.f28500OooO0o0 = roomInfoProfileFragment;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            String str = this.f28499OooO0Oo;
            int iHashCode = str.hashCode();
            if (iHashCode != -1298587734) {
                RoomInfoProfileFragment roomInfoProfileFragment = this.f28500OooO0o0;
                if (iHashCode != -841454749) {
                    if (iHashCode == 613961165 && str.equals("unJoin&unFollow")) {
                        o0oo0000.OooO00o.OooO0O0("102313");
                    ...
                    String userid2 = String.valueOf(o0O00oO0.OooOOo0().getValue());
                ...
                o0oo0000.OooO00o.OooO0O0("202014");
    ...
    public static final class OooOo00 implements Observer, FunctionAdapter {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function1 f28501OooO0Oo;

        public OooOo00(Function1 function) {
            Intrinsics.checkNotNullParameter(function, "function");
            this.f28501OooO0Oo = function;
        }
        ...
        public final boolean equals(@Nullable Object obj) {
            ...
            return Intrinsics.areEqual(this.f28501OooO0Oo, ((FunctionAdapter) obj).getFunctionDelegate());
        }

        @Override // kotlin.jvm.internal.FunctionAdapter
        @NotNull
        public final Function<?> getFunctionDelegate() {
            return this.f28501OooO0Oo;
        }

        public final int hashCode() {
            return this.f28501OooO0Oo.hashCode();
        }

        @Override // androidx.lifecycle.Observer
        public final /* synthetic */ void onChanged(Object obj) {
            this.f28501OooO0Oo.invoke(obj);
        }
    }

    public static final class Oooo000 implements l4.OooO00o {
        public Oooo000() {
        }

        @Override // o0ooo.l4.OooO00o
        public final void onClick(@NotNull View v) {
            Intrinsics.checkNotNullParameter(v, "v");
            int id = v.getId();
            int i = o0OO00O.un_join;
            RoomInfoProfileFragment roomInfoProfileFragment = RoomInfoProfileFragment.this;
            if (id == i) {
                o0oo0000.OooO00o.OooO0O0("102173");
                o0oo0000.OooO00o.OooO0O0("102310");
                com.yalla.yalla.service.room.OooO00o.f24524OooOOOO.f48539OooOo00.setValue(Boolean.TRUE);
            } else {
                o0oo0000.OooO00o.OooO0O0("102312");
                roomInfoProfileFragment.setCenterTextDialog("unJoin&unFollow");
            }
            l4 l4Var = roomInfoProfileFragment.triangleDialog;
    ...
    private final List<ReportFromData> getLash50RoomChatList() {
        ...
        Object objClone = (mixedRoomActivity == null || (arrayList = mixedRoomActivity.f22968OooOoo.f50854OooO0o0) == null) ? null : arrayList.clone();
            ...
            for (ChatModel chatModel : list) {
                if (i != 50 && ((type = chatModel.getType()) == 0 || type == 7)) {
                    ...
                    if (newFrom != null && (userId = newFrom.getUserId()) != null) {
                        ...
                        reportFromData.setPrettyId(com.code.android.util.o000000.OooO0o(newFrom2.getUserIdx().getValue()));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final o0oOo0O0 getLoadingVM() {
        return (o0oOo0O0) this.loadingVM.getValue();
    }

    @SuppressLint({"SetTextI18n"})
    private final void initDataObserver(com.yalla.yalla.service.room.OooO0O0 liveDataSource) {
        liveDataSource.f24545OooOO0O.observe(getViewLifecycleOwner(), new OooOo00(new OooO0O0()));
        liveDataSource.f24536OooO00o.observe(getViewLifecycleOwner(), new OooOo00(new OooO0OO()));
        liveDataSource.f24537OooO0O0.observe(getViewLifecycleOwner(), new OooOo00(new OooO0o()));
        liveDataSource.f24546OooOO0o.observe(getViewLifecycleOwner(), new OooOo00(new OooO(liveDataSource)));
        com.code.android.util.OooOOO.OooO0OO(LifecycleOwnerKt.getLifecycleScope(this), new OooOO0(null));
        liveDataSource.f24552OooOOo0.observe(getViewLifecycleOwner(), new OooOo00(new OooOO0O()));
        liveDataSource.f24551OooOOo.observe(getViewLifecycleOwner(), new OooOo00(new OooOOO0()));
    }

    private final void initView(View view) {
        XRefreshLayout xRefreshLayout = (XRefreshLayout) view.findViewById(o0OO00O.xrl_dialog_room_profile);
        xRefreshLayout.f20857OooOooO = false;
        xRefreshLayout.setNestedScrollingEnabled(false);
        this.vLevelClick = view.findViewById(o0OO00O.layout_room_info_pop_progress_layout);
        this.ivRoomHead = (NetImageView) view.findViewById(o0OO00O.layout_room_info_pop_head_iv);
        this.ivOfficial = (ImageView) view.findViewById(o0OO00O.layout_room_info_pop_official_iv);
        this.ivRoomWarning = (ImageView) view.findViewById(o0OO00O.layout_room_info_pop_warning_iv);
        this.tvRoomSetting = (TextView) view.findViewById(o0OO00O.layout_room_info_pop_setting_iv);
        this.ivRoomSetting = (ImageView) view.findViewById(o0OO00O.iv_room_setting);
        this.tvRedPoint = (TextView) view.findViewById(o0OO00O.tv_red_point);
        this.tvRoomName = (TextView) view.findViewById(o0OO00O.layout_room_info_pop_room_name_tv);
        this.tvRoomId = (TextView) view.findViewById(o0OO00O.layout_room_info_pop_id_tv);
        this.ivLevelMore = (ImageView) view.findViewById(o0OO00O.iv_room_info_pop_level_more);
        this.tvLevelCurrent = (TextView) view.findViewById(o0OO00O.layout_room_info_pop_current_level_tv);
        this.tvLevelNext = (TextView) view.findViewById(o0OO00O.layout_room_info_pop_next_level_tv);
        this.tvProgress = (TextView) view.findViewById(o0OO00O.layout_room_info_pop_progress_tv);
        this.pbRoomLevel = (ProgressBar) view.findViewById(o0OO00O.layout_room_info_pop_progress);
        TextView textView = (TextView) view.findViewById(o0OO00O.tv_profile_room_level_tag);
        TextView textView2 = (TextView) view.findViewById(o0OO00O.tv_profile_room_member_tag);
        TextView textView3 = (TextView) view.findViewById(o0OO00O.tv_profile_room_language_tag);
        TextView textView4 = (TextView) view.findViewById(o0OO00O.tv_profile_room_location_tag);
        TextView textView5 = (TextView) view.findViewById(o0OO00O.tv_profile_room_tags_tag);
        TextView textView6 = (TextView) view.findViewById(o0OO00O.tv_profile_room_broadcast_tag);
        textView.setText(o0O0O0Oo.OooO0oO(getString(o000000.Level), CertificateUtil.DELIMITER));
        textView2.setText(o0O0O0Oo.OooO0oO(getString(o000000.Member), CertificateUtil.DELIMITER));
        textView3.setText(o0O0O0Oo.OooO0oO(getString(o000000.languge), CertificateUtil.DELIMITER));
        textView4.setText(o0O0O0Oo.OooO0oO(getString(o000000.country), CertificateUtil.DELIMITER));
        textView5.setText(o0O0O0Oo.OooO0oO(getString(o000000.tag), CertificateUtil.DELIMITER));
        textView6.setText(o0O0O0Oo.OooO0oO(getString(o000000.Announcement), CertificateUtil.DELIMITER));
        this.tvRoomMember = (TextView) view.findViewById(o0OO00O.layout_room_info_pop_member_tv);
        this.tvRoomLanguage = (TextView) view.findViewById(o0OO00O.layout_room_info_pop_region_tv);
        this.tvRoomLocation = (TextView) view.findViewById(o0OO00O.layout_room_info_pop_location_tv);
        this.tvRoomTag = (TextView) view.findViewById(o0OO00O.layout_room_info_pop_tag_tv);
        this.tvRoomBroadcast = (FixTextView) view.findViewById(o0OO00O.layout_room_info_pop_broadcast_tv);
        this.llOther = (LinearLayout) view.findViewById(o0OO00O.layout_room_info_pop_other_layout);
        this.tvJoinCostBrackets1 = view.findViewById(o0OO00O.tvJoinCostBrackets1);
        this.tvJoinCostBrackets2 = view.findViewById(o0OO00O.tvJoinCostBrackets2);
        this.ivCoin = view.findViewById(o0OO00O.ivCoin);
        TextView textView7 = (TextView) view.findViewById(o0OO00O.tvFollow);
        this.tvFollow = textView7;
        if (textView7 != null) {
            o000O.OooO(textView7, new OooOOO());
        }
        LinearLayout linearLayout = (LinearLayout) view.findViewById(o0OO00O.llJoin);
        this.llJoin = linearLayout;
        if (linearLayout != null) {
            linearLayout.setOnClickListener(new o0O00OO());
        }
        TextView textView8 = (TextView) view.findViewById(o0OO00O.tvJoined);
        this.tvJoined = textView8;
        if (textView8 != null) {
            textView8.setOnClickListener(new n2(this, 1));
        }
        this.tvJoinCount = (TextView) view.findViewById(o0OO00O.tvJoinCost);
        this.ivPrettyId = (UserPrettyIdView) view.findViewById(o0OO00O.iv_prettyid);
    ...
    public static final void initView$lambda$3(View view) {
        o0oo0000.OooO00o.OooO0O0("102047");
        o0000Ooo o0000ooo = com.yalla.yalla.service.room.OooO00o.f24524OooOOOO;
        o0000ooo.f48544OooOoOO.setValue(Boolean.TRUE);
        o0000ooo.OooO0oO(false);
    }
    ...
    private final void setBottomLayout(boolean isMyRoom) {
        ...
        if (com.yalla.yalla.service.room.OooO00o.f24516OooO0o0.OooO0o() > 0 || !p415o0Oo0oO0.o00Ooo.OooO0o0().OooOO0O() || p415o0Oo0oO0.o00Ooo.OooO0o0().OooOO0o()) {
    ...
    public final void setCenterTextDialog(String type) {
        ...
        this.centerTextDialog = o00O000o.OooO00o((BaseFragmentActivity) activity, type, null, new OooOo(this, type));
    }
    ...
    public final void setFollowState(boolean isFollow) {
        if (isFollow) {
            ...
            if (textView != null) {
                textView.setText(o000000.Following);
            }
            TextView textView2 = this.tvFollow;
            if (textView2 != null) {
                textView2.setTextColor(o0000.OooO00o(p562o0oOo000.o0OOO0o.color_333333));
            }
            TextView textView3 = this.tvFollow;
            if (textView3 != null) {
                textView3.setBackgroundResource(p562o0oOo000.o0Oo0oo.shape_corner_stroke_e8e8e8);
                return;
            }
            return;
        }
        ...
        if (textView4 != null) {
            textView4.setText(o000000.Follow);
        }
        TextView textView5 = this.tvFollow;
        if (textView5 != null) {
            textView5.setTextColor(o0000.OooO00o(p562o0oOo000.o0OOO0o.color_00d8c9));
        }
        TextView textView6 = this.tvFollow;
        if (textView6 != null) {
            textView6.setBackgroundResource(p562o0oOo000.o0Oo0oo.shape_corner_stroke_00d8c9);
        }
    }
    ...
    public final void setRoomHeader(String header) {
        ...
        oooO00o.f43126OooO0OO = p403o0Oo0OO.OooO0OO.OooO00o(header);
    ...
    private final void showLevelDialog() {
        ...
        if (com.code.android.util.OooO0OO.OooO00o(getActivity())) {
            o0oo0000.OooO00o.OooO0O0("102154");
            ...
            new h1(fragmentActivityRequireActivity, id, name).show();
        }
    }

    private final void showRoomInfo() {
        com.yalla.yalla.service.room.OooO0O0.OooO00o oooO00o = com.yalla.yalla.service.room.OooO0O0.f24533OoooOOO;
        this.mRoomConfiguration = oooO00o.OooO00o().f24535OooO.getValue();
        ...
        if (textView != null) {
            ...
            textView.setText(o0O0O0Oo.OooO0oO("ID:", roomConfiguration3.getBaridx()));
        }
        ...
        if (textView2 != null) {
            ...
            textView2.setText(o0O0O0Oo.OooO0oO("LV.", String.valueOf(roomConfiguration4.getBarlevel()), ZegoConstants.ZegoVideoDataAuxPublishingStream));
        }
        ...
        if (textView3 != null) {
            ...
            textView3.setText(o0O0O0Oo.OooO0oO("LV.", String.valueOf(roomConfiguration5.getBarlevel() + 1), ZegoConstants.ZegoVideoDataAuxPublishingStream));
        }
        TextView textView4 = this.tvRoomMember;
        if (textView4 != null) {
            textView4.setText(String.valueOf(com.yalla.yalla.service.room.OooO00o.f24524OooOOOO.OooO0o0()));
        }
        ...
        switch (roomConfiguration6.getRegion()) {
            case 0:
                ...
                if (textView5 != null) {
                    textView5.setText(o000000.English);
                }
                break;
            case 1:
                TextView textView6 = this.tvRoomLanguage;
                if (textView6 != null) {
                    textView6.setText(o000000.Arabic);
                }
                break;
            case 2:
                TextView textView7 = this.tvRoomLanguage;
                if (textView7 != null) {
                    textView7.setText(o000000.Turkish);
                }
                break;
            case 3:
                TextView textView8 = this.tvRoomLanguage;
                if (textView8 != null) {
                    textView8.setText(o000000.Indonesia);
                }
                break;
            case 4:
            default:
            ...
            case 5:
                ...
                if (textView10 != null) {
                    textView10.setText(o000000.Portuguese);
                }
                break;
            case 6:
                TextView textView11 = this.tvRoomLanguage;
                if (textView11 != null) {
                    textView11.setText(o000000.Spanish);
                }
                break;
            case 7:
                TextView textView12 = this.tvRoomLanguage;
                if (textView12 != null) {
                    textView12.setText(o000000.Hindi);
                }
                break;
            case 8:
                TextView textView13 = this.tvRoomLanguage;
                if (textView13 != null) {
                    textView13.setText(o000000.Urdu);
                }
                break;
        }
        ...
        if (textView15 != null) {
            textView15.setText(o000000.Space);
        }
    }
    ...
    private final void unJoinRoom() {
        FragmentActivity fragmentActivityRequireActivity = requireActivity();
        Intrinsics.checkNotNullExpressionValue(fragmentActivityRequireActivity, "requireActivity(...)");
        l4 l4Var = new l4(fragmentActivityRequireActivity);
        this.triangleDialog = l4Var;
        l4Var.show();
        l4 l4Var2 = this.triangleDialog;
        if (l4Var2 != null) {
            Oooo000 onClickListener = new Oooo000();
            Intrinsics.checkNotNullParameter(onClickListener, "onClickListener");
            l4Var2.f58376OooO = onClickListener;
        }
    }
    ...
    public void onClick(@NotNull View v) {
        ...
        if (id == o0OO00O.layout_room_info_pop_warning_iv) {
            List<ReportFromData> lash50RoomChatList = getLash50RoomChatList();
            RoomConfiguration roomConfiguration = this.mRoomConfiguration;
            Intrinsics.checkNotNull(roomConfiguration);
            o00O00.OooO0o0(ReportScreen.INSTANCE, ReportScreen.bundleOf(1, com.code.android.util.o0OoOo0.OooO(0L, roomConfiguration.getBarid()), (244 & 4) != 0 ? null : lash50RoomChatList, (244 & 8) != 0 ? null : null, (244 & 16) != 0 ? null : null, (244 & 32) != 0 ? null : null, (244 & 64) != 0 ? null : null, (244 & 128) != 0 ? null : null), false, null, 12);
            return;
        }
        if (id == o0OO00O.layout_room_info_pop_setting_iv || id == o0OO00O.iv_room_setting || id == o0OO00O.tv_red_point) {
            if (this.userIdentityInfo == 1) {
                o0oo0000.OooO00o.OooO0O0("102156");
        ...
        if (id != o0OO00O.ivFollow) {
            if (id == o0OO00O.layout_room_info_pop_progress_layout) {
                showLevelDialog();
            }
        } else if (this.userIdentityInfo != 1) {
            if (Intrinsics.areEqual(com.yalla.yalla.service.room.OooO0O0.f24533OoooOOO.OooO00o().f24545OooOO0O.getValue(), Boolean.TRUE)) {
                setCenterTextDialog("unFollow");
            } else {
                o0oo0000.OooO00o.OooO0O0("102164");
                MixedRoomDataSource.OooO0o0().OooOo0();
            }
        }
    }
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View viewInflate = inflater.inflate(oo0o0Oo.fragment_dialog_room_profile, container, false);
    ...
    public void onEventMainThread(@Nullable p545o0oO0O00.OooOOO<?> msg) {
        ...
        if (msg != null && msg.f55758OooO00o == 57) {
            MixedRoomDataSource.OooO0o0().f22991OooO0o.setWage(0);
