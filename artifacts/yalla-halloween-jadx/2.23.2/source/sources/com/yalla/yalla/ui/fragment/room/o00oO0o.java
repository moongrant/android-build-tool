...
public final class o00oO0o extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ RoomThemeStoreFragment f28603OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ ThemeModel f28604OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00oO0o(RoomThemeStoreFragment roomThemeStoreFragment, ThemeModel themeModel) {
        super(0);
        this.f28603OooO0Oo = roomThemeStoreFragment;
        this.f28604OooO0o0 = themeModel;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        RoomThemeStoreFragment roomThemeStoreFragment = this.f28603OooO0Oo;
        if (roomThemeStoreFragment.isHasRoom) {
            ThemeModel themeModel = this.f28604OooO0o0;
            int themeTagType = themeModel.getThemeTagType();
            if (themeTagType == 2 || themeTagType == 3) {
                o0oo0000.OooO00o.OooO0OO("102014", MapsKt.mapOf(new Pair("shopid", Long.valueOf(themeModel.getShopId()))));
            }
            roomThemeStoreFragment.showPurchase(themeModel);
        } else {
            String strOooO0OO = o0000.OooO0OO(o000000.message_room_theme_to_create_room);
