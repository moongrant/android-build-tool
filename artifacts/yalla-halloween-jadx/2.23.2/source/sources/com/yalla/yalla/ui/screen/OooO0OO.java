...
public final class OooO0OO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ ScreenNavigationActivity f28619OooO0Oo;
    ...
    public OooO0OO(ScreenNavigationActivity screenNavigationActivity, Continuation<? super OooO0OO> continuation) {
        ...
        this.f28619OooO0Oo = screenNavigationActivity;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new OooO0OO(this.f28619OooO0Oo, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        this.f28619OooO0Oo.getWindow().setBackgroundDrawable(new ColorDrawable(o0000.OooO00o(o0OOO0o.transparent)));
