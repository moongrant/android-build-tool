...
public final class OooO0o extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ String f28620OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ ScreenNavigationActivity f28621OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooO0o(String str, ScreenNavigationActivity screenNavigationActivity) {
        super(2);
        this.f28620OooO0Oo = str;
        this.f28621OooO0o0 = screenNavigationActivity;
    }
    ...
    public final Unit invoke(Composer composer, Integer num) {
        ...
        if ((iIntValue & 11) == 2 && composer2.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-344805032, iIntValue, -1, "com.yalla.yalla.ui.screen.ScreenNavigationActivity.onCreate.<anonymous>.<anonymous> (ScreenNavigationActivity.kt:66)");
            }
            ...
            o00O00OO o00o00oo2 = (o00O00OO) RememberSaveableKt.m1333rememberSaveable(Arrays.copyOf(navigatorArr, 0), SaverKt.Saver(Oooo0.f10135OooO0Oo, new o000oOoO(context)), (String) null, (Function0) new o0OoOo0(context), composer2, 72, 4);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            composer2.endReplaceableGroup();
            ScreenNavigationActivity screenNavigationActivity = this.f28621OooO0o0;
            EffectsKt.LaunchedEffect(o00o00oo2, new OooO00o(screenNavigationActivity, o00o00oo2, null), composer2, 72);
            NavHostKt.OooO0O0(o00o00oo2, str, null, null, null, null, null, null, null, new OooO0O0(o00o00oo2), composer2, 8, 508);
            composer2.startReplaceableGroup(-938422131);
            if (((Boolean) screenNavigationActivity.f28623OooO0o.getValue()).booleanValue()) {
