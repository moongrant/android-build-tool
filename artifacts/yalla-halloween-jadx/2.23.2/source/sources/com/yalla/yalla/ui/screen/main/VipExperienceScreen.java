...
public final class VipExperienceScreen extends o000O0 {
    ...
    jadx.core.utils.exceptions.JadxRuntimeException: Can't remove SSA var: r12v1 com.yalla.yalla.ui.screen.main.VipExperienceScreen$ExperienceType[], still in use, count: 1, list:
      (r12v1 com.yalla.yalla.ui.screen.main.VipExperienceScreen$ExperienceType[]) from 0x004d: INVOKE (r12v1 com.yalla.yalla.ui.screen.main.VipExperienceScreen$ExperienceType[]) STATIC call: kotlin.enums.EnumEntriesKt.enumEntries(java.lang.Enum[]):kotlin.enums.EnumEntries A[MD:<E extends java.lang.Enum<E>>:(E extends java.lang.Enum<E>[]):kotlin.enums.EnumEntries<E extends java.lang.Enum<E>> (m), WRAPPED] (LINE:78)
    ...
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\u0010\b\n\u0002\b\r\b\u0086\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001R\"\u0010\u0003\u001a\u00020\u00028\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\u0003\u0010\u0004\u001a\u0004\b\u0005\u0010\u0006\"\u0004\b\u0007\u0010\bj\u0002\b\tj\u0002\b\nj\u0002\b\u000bj\u0002\b\fj\u0002\b\rj\u0002\b\u000e¨\u0006\u000f"}, d2 = {"Lcom/yalla/yalla/ui/screen/main/VipExperienceScreen$ExperienceType;", "", "", AppMeasurementSdk.ConditionalUserProperty.VALUE, "I", "OooO00o", "()I", "setValue", "(I)V", "RechargeCoin", "BuyMembership", "BuyRoomLock", "CoinReimburse", "AristocracyReimburse", "RoomLockReimburse", "Common_YallaRelease"}, k = 1, mv = {1, 9, 0})
    public static final class ExperienceType {
        ...
        static {
            $ENTRIES = EnumEntriesKt.enumEntries(experienceTypeArr);
        }

        public ExperienceType(int i) {
            super(str, i);
            this.value = i;
        }
    ...
    public static final class OooO00o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ ColumnScope f28656OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(ColumnScope columnScope, int i) {
            super(2);
            this.f28656OooO0o0 = columnScope;
            this.f28655OooO0o = i;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f28655OooO0o | 1);
            VipExperienceScreen.this.Content(this.f28656OooO0o0, composer, iUpdateChangedFlags);
    ...
    public static final class OooO0O0 extends Lambda implements Function3<BoxScope, Composer, Integer, Unit> {
        ...
        public final /* synthetic */ LazyListState f28657OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ p107o000ooO0.OooOOOO<VipExperienceDetailModel> f28658OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(LazyListState lazyListState, p107o000ooO0.OooOOOO<VipExperienceDetailModel> oooOOOO) {
            super(3);
            this.f28657OooO0Oo = lazyListState;
            this.f28658OooO0o0 = oooOOOO;
        }
        ...
        public final Unit invoke(BoxScope boxScope, Composer composer, Integer num) {
            ...
            if ((iIntValue & 81) == 16 && composer2.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(1988365854, iIntValue, -1, "com.yalla.yalla.ui.screen.main.VipExperienceScreen.ExperienceHistoryList.<anonymous>.<anonymous> (VipExperienceScreen.kt:104)");
                }
                LazyDslKt.LazyColumn(SizeKt.fillMaxSize$default(Modifier.INSTANCE, 0.0f, 1, null), this.f28657OooO0Oo, null, false, null, null, null, false, new com.yalla.yalla.ui.screen.main.OooO0O0(this.f28658OooO0o0), composer2, 6, 252);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public static final class OooO0OO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f28660OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(int i) {
            super(2);
            this.f28660OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f28660OooO0o0 | 1);
    ...
    public final void ExperienceHistoryList(Composer composer, int i) {
        ...
        if ((i & 1) == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            float f = 14;
            Modifier modifierM171backgroundbw27NRU$default = BackgroundKt.m171backgroundbw27NRU$default(SizeKt.fillMaxSize$default(ClipKt.clip(PaddingKt.m480paddingVpY3zN4$default(companion, Dp.m3775constructorimpl(10), 0.0f, 2, null), RoundedCornerShapeKt.m731RoundedCornerShapea9UjIt4$default(Dp.m3775constructorimpl(f), Dp.m3775constructorimpl(f), 0.0f, 0.0f, 12, null)), 0.0f, 1, null), o0000oo.OooO0OO(composerStartRestartGroup).f38618OooO0O0, null, 2, null);
            ...
            p107o000ooO0.OooOOOO oooOOOOOooO00o = o00O0O.OooO00o(vipExperienceVM.getExperienceDetailsFlow().f38501OooO0oo, composerStartRestartGroup);
            LazyListState lazyListStateRememberLazyListState = LazyListStateKt.rememberLazyListState(0, 0, composerStartRestartGroup, 0, 3);
            Modifier modifierFillMaxSize$default = SizeKt.fillMaxSize$default(companion, 0.0f, 1, null);
            ComposableLambda composableLambda = o0OOO00.f53520OooO00o;
            ComposableLambda composableLambda2 = ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1988365854, true, new OooO0O0(lazyListStateRememberLazyListState, oooOOOOOooO00o));
    ...
    public void Content(@NotNull ColumnScope columnScope, @Nullable Composer composer, int i) {
        ...
        if ((i & 1) == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            Modifier.Companion companion = Modifier.INSTANCE;
            Modifier modifierM171backgroundbw27NRU$default = BackgroundKt.m171backgroundbw27NRU$default(companion, o0000oo.OooO0OO(composerStartRestartGroup).f38619OooO0OO, null, 2, null);
            composerStartRestartGroup.startReplaceableGroup(733328855);
            ...
            androidx.compose.animation.OooOO0.OooO00o(0, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composerStartRestartGroup)), composerStartRestartGroup, 2058660585);
            BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
            ImageKt.Image(PainterResources_androidKt.painterResource(o0Oo0oo.user_ka_vip_experience_bg, composerStartRestartGroup, 0), (String) null, SizeKt.m511height3ABfNKs(SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), Dp.m3775constructorimpl(265)), companion2.getTopCenter(), (ContentScale) null, 0.0f, (ColorFilter) null, composerStartRestartGroup, 3512, 112);
            ...
            String strStringResource = StringResources_androidKt.stringResource(o000000.user_ka_vip_experience_title, composerStartRestartGroup, 0);
            long j = o0OOo000.f48135OooO0O0;
            composer2 = composerStartRestartGroup;
            o0O0oo0o.OooO00o(strStringResource, 0.0f, j, null, null, null, null, null, null, composerStartRestartGroup, 0, 506);
            SpacerKt.Spacer(SizeKt.m511height3ABfNKs(companion, Dp.m3775constructorimpl(28)), composer2, 6);
            Integer numValueOf = Integer.valueOf(iIntValue);
            composer2.startReplaceableGroup(1157296644);
            boolean zChanged2 = composer2.changed(numValueOf);
            Object objRememberedValue2 = composer2.rememberedValue();
            if (zChanged2 || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                objRememberedValue2 = o00O00OO.OooO0O0(String.valueOf(Math.abs(iIntValue)));
                composer2.updateRememberedValue(objRememberedValue2);
            }
            composer2.endReplaceableGroup();
            String strOooO00o = (String) objRememberedValue2;
            if (iIntValue < 0) {
                strOooO00o = p022Oooo00O.o00O00OO.OooO00o("-", strOooO00o);
            }
            TextKt.m1261Text4IGK_g(strOooO00o, PaddingKt.m482paddingqDBjuR0$default(companion, Dp.m3775constructorimpl(15), 0.0f, 0.0f, 0.0f, 14, null), j, TextUnitKt.getSp(38), (FontStyle) null, FontWeight.INSTANCE.getBold(), (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 199728, 0, 131024);
            androidx.compose.ui.semantics.OooO0O0.OooO0O0(26, companion, composer2, 6);
