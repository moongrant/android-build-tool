...
public final class OooOOO extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ StoreRoomChatBubbleModel f29163OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ StoreRoomChatBubbleVM f29164OooO0o0;
    ...
    public OooOOO(StoreRoomChatBubbleModel storeRoomChatBubbleModel, StoreRoomChatBubbleVM storeRoomChatBubbleVM) {
        super(0);
        this.f29163OooO0Oo = storeRoomChatBubbleModel;
        this.f29164OooO0o0 = storeRoomChatBubbleVM;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        StoreChatBubbleScreen.INSTANCE.onBuyClick(this.f29163OooO0Oo, this.f29164OooO0o0);
