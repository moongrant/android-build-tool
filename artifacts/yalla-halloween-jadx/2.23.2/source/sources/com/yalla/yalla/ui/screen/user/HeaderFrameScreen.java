...
public final class HeaderFrameScreen extends o000O0 {
    ...
    public static final class OooO extends Lambda implements Function0<Unit> {
        ...
        public final /* synthetic */ HeadFrameViewModel f29370OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(HeadFrameViewModel headFrameViewModel) {
            super(0);
            this.f29370OooO0Oo = headFrameViewModel;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            this.f29370OooO0Oo.getHeadFrameList();
    ...
    public static final class OooO00o extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ HeadFrameViewModel f29371OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(HeadFrameViewModel headFrameViewModel) {
            super(0);
            this.f29371OooO0Oo = headFrameViewModel;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            HeadFrameViewModel headFrameViewModel = this.f29371OooO0Oo;
            if (headFrameViewModel.getMTempShowUserHeaderFrameModel().getValue() != null) {
                ...
                if (value.getLocalTypeModel() == 1) {
                    ...
                    if (!Intrinsics.areEqual(pic, o0O00oO0.OooO().getValue()) && headFrameViewModel.getCurrentSelectPosition() >= 0) {
    ...
    public static final class OooO0O0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ int f29373OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ ColumnScope f29374OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(ColumnScope columnScope, int i) {
            super(2);
            this.f29374OooO0o0 = columnScope;
            this.f29373OooO0o = i;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f29373OooO0o | 1);
            HeaderFrameScreen.this.Content(this.f29374OooO0o0, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0OO extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function3<UserHeadFrameModel, Integer, Boolean, Unit> f29375OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f29376OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ UserHeadFrameModel f29377OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ boolean f29378OooO0oO;
        ...
        public OooO0OO(Function3<? super UserHeadFrameModel, ? super Integer, ? super Boolean, Unit> function3, UserHeadFrameModel userHeadFrameModel, int i, boolean z) {
            super(0);
            this.f29375OooO0Oo = function3;
            this.f29377OooO0o0 = userHeadFrameModel;
            this.f29376OooO0o = i;
            this.f29378OooO0oO = z;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            this.f29375OooO0Oo.invoke(this.f29377OooO0o0, Integer.valueOf(this.f29376OooO0o), Boolean.valueOf(this.f29378OooO0oO));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ int f29379OooO;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ UserHeadFrameModel f29381OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f29382OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ boolean f29383OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ Function3<UserHeadFrameModel, Integer, Boolean, Unit> f29384OooO0oo;
        ...
        public OooO0o(int i, UserHeadFrameModel userHeadFrameModel, boolean z, Function3<? super UserHeadFrameModel, ? super Integer, ? super Boolean, Unit> function3, int i2) {
            super(2);
            this.f29382OooO0o0 = i;
            this.f29381OooO0o = userHeadFrameModel;
            this.f29383OooO0oO = z;
            this.f29384OooO0oo = function3;
            this.f29379OooO = i2;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            HeaderFrameScreen.this.HeaddressItem(this.f29382OooO0o0, this.f29381OooO0o, this.f29383OooO0oO, this.f29384OooO0oo, composer, RecomposeScopeImplKt.updateChangedFlags(this.f29379OooO | 1));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0 extends Lambda implements Function3<BoxScope, Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ HeadFrameViewModel f29385OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0(HeadFrameViewModel headFrameViewModel) {
            super(3);
            this.f29385OooO0Oo = headFrameViewModel;
        }
        ...
        public final Unit invoke(BoxScope boxScope, Composer composer, Integer num) {
            ...
            if ((iIntValue & 81) == 16 && composer2.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(649642600, iIntValue, -1, "com.yalla.yalla.ui.screen.user.HeaderFrameScreen.HeaddressList.<anonymous> (HeaderFrameScreen.kt:269)");
                }
                p520o0o0O0o.OooOo00.OooO00o(null, ComposableLambdaKt.composableLambda(composer2, 1592929136, true, new com.yalla.yalla.ui.screen.user.OooOOOO(this.f29385OooO0Oo)), composer2, 48, 1);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public static final class OooOO0O extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f29387OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ HeadFrameViewModel f29388OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0O(HeadFrameViewModel headFrameViewModel, int i) {
            super(2);
            this.f29388OooO0o0 = headFrameViewModel;
            this.f29387OooO0o = i;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f29387OooO0o | 1);
            HeaderFrameScreen.this.HeaddressList(this.f29388OooO0o0, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOOO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f29390OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ HeadFrameViewModel f29391OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO(HeadFrameViewModel headFrameViewModel, int i) {
            super(2);
            this.f29391OooO0o0 = headFrameViewModel;
            this.f29390OooO0o = i;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f29390OooO0o | 1);
            HeaderFrameScreen.this.HeaderCompose(this.f29391OooO0o0, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOOO0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO, reason: collision with root package name */
        public final /* synthetic */ int f29392OooO;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ String f29394OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f29395OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ float f29396OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ int f29397OooO0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO0(int i, String str, float f, int i2, int i3) {
            super(2);
            this.f29395OooO0o0 = i;
            this.f29394OooO0o = str;
            this.f29396OooO0oO = f;
            this.f29397OooO0oo = i2;
            this.f29392OooO = i3;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            HeaderFrameScreen.this.m4202HeaddressListTitle6a0pyJM(this.f29395OooO0o0, this.f29394OooO0o, this.f29396OooO0oO, composer, RecomposeScopeImplKt.updateChangedFlags(this.f29397OooO0oo | 1), this.f29392OooO);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOOOO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f29399OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ HeadFrameViewModel f29400OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOOO(HeadFrameViewModel headFrameViewModel, int i) {
            super(2);
            this.f29400OooO0o0 = headFrameViewModel;
            this.f29399OooO0o = i;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f29399OooO0o | 1);
            HeaderFrameScreen.this.HeaderContainer(this.f29400OooO0o0, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOo00 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ HeadFrameViewModel f29402OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f29403OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f29404OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOo00(int i, HeadFrameViewModel headFrameViewModel, int i2) {
            super(2);
            this.f29403OooO0o0 = i;
            this.f29402OooO0o = headFrameViewModel;
            this.f29404OooO0oO = i2;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f29404OooO0oO | 1);
            int i = this.f29403OooO0o0;
            HeadFrameViewModel headFrameViewModel = this.f29402OooO0o;
    ...
    public final void HeaddressItem(int i, UserHeadFrameModel userHeadFrameModel, boolean z, Function3<? super UserHeadFrameModel, ? super Integer, ? super Boolean, Unit> function3, Composer composer, int i2) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1590193805, i2, -1, "com.yalla.yalla.ui.screen.user.HeaderFrameScreen.HeaddressItem (HeaderFrameScreen.kt:335)");
        }
        if (userHeadFrameModel.isLocalIsSelect()) {
            modifierBorder = BorderKt.border(Modifier.INSTANCE, new BorderStroke(Dp.m3775constructorimpl((float) 0.5d), new SolidColor(o0OOo000.f48185Ooooo00, null), null), RoundedCornerShapeKt.m729RoundedCornerShape0680j_4(Dp.m3775constructorimpl(12)));
        } else {
            modifierBorder = Modifier.INSTANCE;
        }
        Modifier.Companion companion = Modifier.INSTANCE;
        Modifier modifierOooO0O0 = o0O0O00.OooO0O0(SizeKt.m525size3ABfNKs(companion, Dp.m3775constructorimpl(82)).then(modifierBorder), false, false, 0L, false, null, null, null, new OooO0OO(function3, userHeadFrameModel, i, z), 253);
        ...
        oO0OO.OooO00o.f59939OooO00o.OooO0oo(ConstantsKt.MINIMUM_BLOCK_SIZE, 0, composerStartRestartGroup, boxScopeInstance.align(SizeKt.m525size3ABfNKs(companion, Dp.m3775constructorimpl(77)), companion2.getCenter()), userHeadFrameModel.getPic());
        composerStartRestartGroup.startReplaceableGroup(2088031089);
        if (userHeadFrameModel.getIsweared() == 1) {
            composer2 = composerStartRestartGroup;
            TextKt.m1261Text4IGK_g(o0000.OooO0OO(o000000.header_frame_in_use), boxScopeInstance.align(PaddingKt.m480paddingVpY3zN4$default(BackgroundKt.m170backgroundbw27NRU(PaddingKt.m482paddingqDBjuR0$default(companion, 0.0f, 0.0f, 0.0f, Dp.m3775constructorimpl(5), 7, null), o0OOo000.f48185Ooooo00, RoundedCornerShapeKt.m729RoundedCornerShape0680j_4(Dp.m3775constructorimpl(40))), Dp.m3775constructorimpl(8), 0.0f, 2, null), companion2.getBottomCenter()), Color.INSTANCE.m1718getWhite0d7_KjU(), oOO0O00O.OooO0OO(12, composerStartRestartGroup), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 1, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 384, 3072, 122864);
        } else {
            composer2 = composerStartRestartGroup;
        }
    ...
    public final void HeaddressList(HeadFrameViewModel headFrameViewModel, Composer composer, int i) {
        ...
        oOO00O.OooO0o0(headFrameViewModel.getMContentState(), false, null, null, null, null, new OooO(headFrameViewModel), ComposableLambdaKt.composableLambda(composerStartRestartGroup, 649642600, true, new OooOO0(headFrameViewModel)), composerStartRestartGroup, 12582912, 62);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    ...
    public final void m4202HeaddressListTitle6a0pyJM(int i, String str, float f, Composer composer, int i2, int i3) {
        int i4;
        float f2;
        ...
        if (i5 == 0) {
            ...
            if ((i4 & 731) == 146 || !composerStartRestartGroup.getSkipping()) {
                ...
                Modifier.Companion companion = Modifier.INSTANCE;
                Modifier modifierM482paddingqDBjuR0$default = PaddingKt.m482paddingqDBjuR0$default(companion, 0.0f, fM3775constructorimpl, 0.0f, Dp.m3775constructorimpl(10), 5, null);
                ...
                ImageKt.Image(PainterResources_androidKt.painterResource(i, composerStartRestartGroup, i4 & 14), (String) null, SizeKt.m525size3ABfNKs(companion, Dp.m3775constructorimpl(18)), (Alignment) null, (ContentScale) null, 0.0f, (ColorFilter) null, composerStartRestartGroup, 440, 120);
                com.code.android.util.OooOO0.OooO0Oo(Dp.m3775constructorimpl(6), null, composerStartRestartGroup, 6, 2);
                TextKt.m1261Text4IGK_g(str, (Modifier) null, o0000oo.OooO0OO(composerStartRestartGroup).f38616OooO, oOO0O00O.OooO0OO(16, composerStartRestartGroup), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composerStartRestartGroup, (i4 >> 3) & 14, 0, 131058);
        ...
        if ((i4 & 731) == 146) {
            ...
            Modifier modifierM482paddingqDBjuR0$default2 = PaddingKt.m482paddingqDBjuR0$default(companion3, 0.0f, fM3775constructorimpl, 0.0f, Dp.m3775constructorimpl(10), 5, null);
            composerStartRestartGroup.startReplaceableGroup(693286680);
            ...
            ImageKt.Image(PainterResources_androidKt.painterResource(i, composerStartRestartGroup, i4 & 14), (String) null, SizeKt.m525size3ABfNKs(companion3, Dp.m3775constructorimpl(18)), (Alignment) null, (ContentScale) null, 0.0f, (ColorFilter) null, composerStartRestartGroup, 440, 120);
            com.code.android.util.OooOO0.OooO0Oo(Dp.m3775constructorimpl(6), null, composerStartRestartGroup, 6, 2);
            TextKt.m1261Text4IGK_g(str, (Modifier) null, o0000oo.OooO0OO(composerStartRestartGroup).f38616OooO, oOO0O00O.OooO0OO(16, composerStartRestartGroup), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composerStartRestartGroup, (i4 >> 3) & 14, 0, 131058);
            if (androidx.compose.material.OooO0o.OooO00o(composerStartRestartGroup)) {
                ComposerKt.traceEventEnd();
            ...
            Modifier modifierM482paddingqDBjuR0$default3 = PaddingKt.m482paddingqDBjuR0$default(companion5, 0.0f, fM3775constructorimpl, 0.0f, Dp.m3775constructorimpl(10), 5, null);
            composerStartRestartGroup.startReplaceableGroup(693286680);
            ...
            ImageKt.Image(PainterResources_androidKt.painterResource(i, composerStartRestartGroup, i4 & 14), (String) null, SizeKt.m525size3ABfNKs(companion5, Dp.m3775constructorimpl(18)), (Alignment) null, (ContentScale) null, 0.0f, (ColorFilter) null, composerStartRestartGroup, 440, 120);
            com.code.android.util.OooOO0.OooO0Oo(Dp.m3775constructorimpl(6), null, composerStartRestartGroup, 6, 2);
            TextKt.m1261Text4IGK_g(str, (Modifier) null, o0000oo.OooO0OO(composerStartRestartGroup).f38616OooO, oOO0O00O.OooO0OO(16, composerStartRestartGroup), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composerStartRestartGroup, (i4 >> 3) & 14, 0, 131058);
            if (androidx.compose.material.OooO0o.OooO00o(composerStartRestartGroup)) {
                ComposerKt.traceEventEnd();
    ...
    public final void HeaderCompose(HeadFrameViewModel headFrameViewModel, Composer composer, int i) {
        ...
        androidx.compose.animation.OooOO0.OooO00o(0, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composerStartRestartGroup)), composerStartRestartGroup, 2058660585);
        BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
        ImageKt.Image(PainterResources_androidKt.painterResource(o0Oo0oo.bg_header_frame_head_bg, composerStartRestartGroup, 0), (String) null, SizeKt.m511height3ABfNKs(SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), Dp.m3775constructorimpl(148)), (Alignment) null, (ContentScale) null, 0.0f, (ColorFilter) null, composerStartRestartGroup, 440, 120);
        Modifier modifierAlign = boxScopeInstance.align(PaddingKt.m482paddingqDBjuR0$default(companion, 0.0f, Dp.m3775constructorimpl(52), 0.0f, 0.0f, 13, null), companion2.getCenter());
        composerStartRestartGroup.startReplaceableGroup(733328855);
        ...
        UserHeadFrameModel value = headFrameViewModel.getMTempShowUserHeaderFrameModel().getValue();
        oooO00o.OooO(str, value != null ? value.getPic() : null, Dp.m3775constructorimpl(2), Color.m1671boximpl(Color.INSTANCE.m1718getWhite0d7_KjU()), boxScopeInstance.align(SizeKt.m525size3ABfNKs(companion, Dp.m3775constructorimpl(90)), companion2.getCenter()), composerStartRestartGroup, 265600, 0);
        UserHeadFrameModel value2 = headFrameViewModel.getMTempShowUserHeaderFrameModel().getValue();
        ImageKt.Image(PainterResources_androidKt.painterResource(value2 != null && value2.getLocalTypeModel() == 0 ? o0Oo0oo.icon_header_frame_title_not_unlock : o0Oo0oo.icon_header_frame_title_unlock, composerStartRestartGroup, 0), (String) null, boxScopeInstance.align(SizeKt.m525size3ABfNKs(PaddingKt.m482paddingqDBjuR0$default(companion, 0.0f, 0.0f, 0.0f, Dp.m3775constructorimpl(17), 7, null), Dp.m3775constructorimpl(20)), companion2.getBottomEnd()), (Alignment) null, (ContentScale) null, 0.0f, (ColorFilter) null, composerStartRestartGroup, 56, 120);
    ...
    public final void HeaderContainer(HeadFrameViewModel headFrameViewModel, Composer composer, int i) {
        ...
        o000OO.OooO00o(o0OOo000.f48232o000O0, false, composerStartRestartGroup, 48);
        ...
        o0O0oo0o.OooO00o(StringResources_androidKt.stringResource(o000000.user_info_header_select_header_frame_title, composerStartRestartGroup, 0), 0.0f, o0OOo000.f48135OooO0O0, null, null, null, null, null, null, composerStartRestartGroup, 0, 506);
        ...
        String strOooO0OO2 = o0000.OooO0OO(o000000.header_frame_lock_state);
        long j = o0000oo.OooO0OO(composerStartRestartGroup).f38627OooOO0o;
        long jOooO0OO = oOO0O00O.OooO0OO(12, composerStartRestartGroup);
        float f = 40;
        Modifier modifierM480paddingVpY3zN4$default = PaddingKt.m480paddingVpY3zN4$default(SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), Dp.m3775constructorimpl(f), 0.0f, 2, null);
        TextAlign.Companion companion4 = TextAlign.INSTANCE;
        TextKt.m1261Text4IGK_g(strOooO0OO2, modifierM480paddingVpY3zN4$default, j, jOooO0OO, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, TextAlign.m3674boximpl(companion4.m3681getCentere0LSkKk()), 0L, 0, false, 1, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composerStartRestartGroup, 48, 3072, 122352);
        Modifier modifierM513heightInVpY3zN4$default = SizeKt.m513heightInVpY3zN4$default(companion, Dp.m3775constructorimpl(53), 0.0f, 2, null);
        ...
        if (value == null || (strOooO0OO = value.getUnlocktext()) == null) {
            strOooO0OO = o0000.OooO0OO(o000000.header_frame_unlock_automatically);
        }
        TextKt.m1261Text4IGK_g(strOooO0OO, PaddingKt.m480paddingVpY3zN4$default(SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), Dp.m3775constructorimpl(f), 0.0f, 2, null), o0000oo.OooO0OO(composerStartRestartGroup).f38616OooO, oOO0O00O.OooO0OO(14, composerStartRestartGroup), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, TextAlign.m3674boximpl(companion4.m3681getCentere0LSkKk()), 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composerStartRestartGroup, 48, 0, 130544);
    ...
    public final void OverdueTime(int i, HeadFrameViewModel headFrameViewModel, Composer composer, int i2) {
        ...
        if ((i3 & 11) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(994605807, i3, -1, "com.yalla.yalla.ui.screen.user.HeaderFrameScreen.OverdueTime (HeaderFrameScreen.kt:170)");
            }
            Alignment.Vertical centerVertically = Alignment.INSTANCE.getCenterVertically();
            Arrangement.HorizontalOrVertical center = Arrangement.INSTANCE.getCenter();
            Modifier.Companion companion = Modifier.INSTANCE;
            float f = 3;
            Modifier modifierM479paddingVpY3zN4 = PaddingKt.m479paddingVpY3zN4(BackgroundKt.m171backgroundbw27NRU$default(ClipKt.clip(PaddingKt.m482paddingqDBjuR0$default(companion, 0.0f, Dp.m3775constructorimpl(6), 0.0f, 0.0f, 13, null), RoundedCornerShapeKt.getCircleShape()), ColorKt.Color(452942664), null, 2, null), Dp.m3775constructorimpl(5), Dp.m3775constructorimpl(f));
            composerStartRestartGroup.startReplaceableGroup(693286680);
    ...
    public void Content(@NotNull ColumnScope columnScope, @Nullable Composer composer, int i) {
        ...
        if ((i & 1) == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            if (headFrameViewModel.getShowReplaceButton()) {
                ...
                composer2 = composerStartRestartGroup;
                o00O0OO0.OooO00o(o0000.OooO0OO(o000000.user_info_header_frame_replace), 0L, null, null, null, null, null, 0.0f, null, false, false, 0L, false, null, null, null, null, null, SizeKt.m511height3ABfNKs(PaddingKt.m479paddingVpY3zN4(BackgroundKt.m171backgroundbw27NRU$default(SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), Color.INSTANCE.m1718getWhite0d7_KjU(), null, 2, null), Dp.m3775constructorimpl(20), Dp.m3775constructorimpl(8)), Dp.m3775constructorimpl(36)), new OooO00o(headFrameViewModel), composer2, 0, 0, 262142);
