...
public final class OooO00o extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ FollowUserInfoModel f29433OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooO00o(FollowUserInfoModel followUserInfoModel) {
        super(0);
        this.f29433OooO0Oo = followUserInfoModel;
    }
    ...
    public final Unit invoke() {
        ...
        if (activityOooO0O0 != null) {
            UserInfoActivity.OooO00o.OooO0OO(UserInfoActivity.f26775Oooo0o, activityOooO0O0, String.valueOf(this.f29433OooO0Oo.getUserId()), false, 12);
        }
