...
public final class RoomThemeScreen extends o000O0 {
    ...
    public static final class OooO00o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ int f29576OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ ColumnScope f29577OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(ColumnScope columnScope, int i) {
            super(2);
            this.f29577OooO0o0 = columnScope;
            this.f29576OooO0o = i;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f29576OooO0o | 1);
            RoomThemeScreen.this.Content(this.f29577OooO0o0, composer, iUpdateChangedFlags);
    ...
    public static final class OooO0O0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f29579OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ RoomThemePageType f29580OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f29581OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(RoomThemePageType roomThemePageType, int i, int i2) {
            super(2);
            this.f29580OooO0o0 = roomThemePageType;
            this.f29579OooO0o = i;
            this.f29581OooO0oO = i2;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f29579OooO0o | 1);
            RoomThemeScreen.this.MainContent(this.f29580OooO0o0, composer, iUpdateChangedFlags, this.f29581OooO0oO);
            return Unit.INSTANCE;
        }
    }
    ...
    public final void MainContent(@Nullable RoomThemePageType roomThemePageType, @Nullable Composer composer, int i, int i2) {
        ...
        if ((i3 & 11) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            float f = 52;
            o000OO00.OooO00o(pageList, o000000VarOooO00o, BackgroundKt.m171backgroundbw27NRU$default(SizeKt.m511height3ABfNKs(companion, Dp.m3775constructorimpl(f)), o0OOo000.f48134OooO00o, null, 2, null), null, oOO0OOO.f55506OooO00o, composerStartRestartGroup, 24584, 8);
            Pager.OooO00o(roomThemeVM.getPageList().size(), PaddingKt.m482paddingqDBjuR0$default(SizeKt.fillMaxSize$default(companion, 0.0f, 1, null), 0.0f, Dp.m3775constructorimpl(f), 0.0f, 0.0f, 13, null), o000000VarOooO00o, false, 0.0f, null, null, null, null, false, oOO0OOO.f55507OooO0O0, composerStartRestartGroup, 805306416, 6, 504);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
