...
public final class UserMomentListScreen extends o000O0 {
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final /* synthetic */ MomentUserListVM f29589OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(MomentUserListVM momentUserListVM, Continuation<? super OooO00o> continuation) {
            super(2, continuation);
            this.f29589OooO0Oo = momentUserListVM;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO00o(this.f29589OooO0Oo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            MomentUserListVM momentUserListVM = this.f29589OooO0Oo;
    ...
    public static final class OooO0O0 extends Lambda implements Function1<DisposableEffectScope, DisposableEffectResult> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ BaseMomentDetailVM f29590OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(BaseMomentDetailVM baseMomentDetailVM) {
            super(1);
            this.f29590OooO0Oo = baseMomentDetailVM;
        }
        ...
        public final DisposableEffectResult invoke(DisposableEffectScope disposableEffectScope) {
            ...
            BaseMomentDetailVM baseMomentDetailVM = this.f29590OooO0Oo;
            baseMomentDetailVM.statisticalTime();
            return new f1(baseMomentDetailVM);
        }
    }
    ...
    public static final class OooO0OO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ int f29592OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ ColumnScope f29593OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(ColumnScope columnScope, int i) {
            super(2);
            this.f29593OooO0o0 = columnScope;
            this.f29592OooO0o = i;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f29592OooO0o | 1);
            UserMomentListScreen.this.Content(this.f29593OooO0o0, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public void Content(@NotNull ColumnScope columnScope, @Nullable Composer composer, int i) {
        ...
        if ((i & 1) == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            if (string != null) {
                ...
                jOooOO0 = com.code.android.util.o0OoOo0.OooO(com.code.android.util.o0OoOo0.OooOO0((Long) o0O00oO0.OooOOo0().getValue()), string);
            } else {
                o0O00oO0 o0o00oo2 = o0O00oO0.f47936OooO00o;
                jOooOO0 = com.code.android.util.o0OoOo0.OooOO0((Long) o0O00oO0.OooOOo0().getValue());
            }
            ...
            o2.OooO0O0(momentUserListVM, String.valueOf(momentUserListVM.getToUserId().getValue().longValue()), lazyListStateRememberLazyListState, composerStartRestartGroup, 8);
            ...
            o2.OooO0Oo(momentUserListVM, String.valueOf(momentUserListVM.getToUserId().getValue().longValue()), lazyListStateRememberLazyListState, composerStartRestartGroup, 8);
            o2.OooO0o0(boxScopeInstance, momentUserListVM.getToUserId().getValue().longValue(), composerStartRestartGroup, 6);
            composerStartRestartGroup.endReplaceableGroup();
    ...
    public final void navigate(@NotNull String userID) {
        ...
        o00O00.OooO0o0(INSTANCE, p063o0000oO.o000oOoO.OooO0O0(TuplesKt.to("Id", userID)), false, null, 12);
    }
}
