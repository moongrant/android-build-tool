...
public final class o0ooOOo extends Lambda implements Function4<LazyItemScope, Integer, Composer, Integer, Unit> {
    ...
    public final /* synthetic */ p107o000ooO0.OooOOOO<VisitorUserInfoModel> f29649OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ UserVisitorVM f29650OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0ooOOo(p107o000ooO0.OooOOOO<VisitorUserInfoModel> oooOOOO, UserVisitorVM userVisitorVM) {
        super(4);
        this.f29649OooO0Oo = oooOOOO;
        this.f29650OooO0o0 = userVisitorVM;
    }
    ...
    public final Unit invoke(LazyItemScope lazyItemScope, Integer num, Composer composer, Integer num2) {
        ...
        if ((iIntValue2 & 721) == 144 && composer2.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1113755398, iIntValue2, -1, "com.yalla.yalla.ui.screen.user.UserVisitorScreen.Content.<anonymous>.<anonymous>.<anonymous> (UserVisitorScreen.kt:56)");
            }
            p107o000ooO0.OooOOOO<VisitorUserInfoModel> oooOOOO = this.f29649OooO0Oo;
            VisitorUserInfoModel visitorUserInfoModelOooO00o = oooOOOO.OooO00o(iIntValue);
            if (visitorUserInfoModelOooO00o != null) {
                if (visitorUserInfoModelOooO00o.getVisitorType()) {
                    ...
                    UserVisitorScreen.INSTANCE.InvisibleVisitorItem(visitorUserInfoModelOooO00o, oo000o.f29651OooO0Oo, composer2, 440);
                    composer2.endReplaceableGroup();
                } else {
                    composer2.startReplaceableGroup(207208826);
                    UserVisitorScreen.INSTANCE.VisitorItem(visitorUserInfoModelOooO00o, new o00oO0o(visitorUserInfoModelOooO00o, this.f29650OooO0o0), composer2, 392);
                    composer2.endReplaceableGroup();
                }
