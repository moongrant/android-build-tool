...
public final class LuckyNumberView extends AppCompatImageView {
    ...
    public final int f29944OooO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public final RectF f29945OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final float f29946OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @NotNull
    public final RectF f29947OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final float f29948OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final float f29949OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public Bitmap f29950OooOO0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LuckyNumberView(@NotNull Context context) {
        super(context);
        Intrinsics.checkNotNullParameter(context, "context");
        this.f29945OooO0Oo = new RectF();
        this.f29947OooO0o0 = new RectF();
        Paint paint = new Paint();
        this.f29946OooO0o = o0000O0.OooO00o(12);
        this.f29948OooO0oO = o0000O0.OooO00o((float) 2.5d);
        this.f29949OooO0oo = o0000O0.OooO00o(3);
        new PorterDuffXfermode(PorterDuff.Mode.DST_IN);
        Color.parseColor("#000000");
        this.f29944OooO = Color.parseColor("#33000000");
        setLayerType(1, null);
    ...
    public final void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        paint.setColor(this.f29944OooO);
        float f6 = this.f29946OooO0o;
    ...
    public final void setRange(int range) {
        int i;
        if (range == 1) {
            i = o0Oo0oo.ic_room_lucky_number;
        } else if (range != 2) {
            i = range != 3 ? o0Oo0oo.ic_room_lucky_number : o0Oo0oo.ic_room_lucky_number_3;
        } else {
            i = o0Oo0oo.ic_room_lucky_number_2;
        }
        setImageResource(i);
    }
