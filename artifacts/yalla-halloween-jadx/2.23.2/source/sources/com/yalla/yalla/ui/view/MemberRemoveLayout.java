...
public final class MemberRemoveLayout extends FrameLayout {
    ...
    public static final /* synthetic */ int f29952OooO0o = 0;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public final v0 f29953OooO0Oo;
    ...
    public MemberRemoveLayout(@NotNull Context context) {
        ...
        v0 v0VarInflate = v0.inflate(LayoutInflater.from(getContext()), this, true);
        Intrinsics.checkNotNullExpressionValue(v0VarInflate, "inflate(...)");
        this.f29953OooO0Oo = v0VarInflate;
    }
