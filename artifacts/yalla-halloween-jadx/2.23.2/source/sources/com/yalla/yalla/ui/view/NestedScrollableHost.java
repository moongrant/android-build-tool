    ...
    public final boolean onInterceptTouchEvent(@NotNull MotionEvent e) {
        ...
        if (parentViewPager != null) {
            ...
            if (OooO00o(-1.0f, orientation) || OooO00o(1.0f, orientation)) {
                if (e.getAction() == 0) {
                    this.f29957OooO0o0 = e.getX();
                    this.f29956OooO0o = e.getY();
                    getParent().requestDisallowInterceptTouchEvent(true);
                } else if (e.getAction() == 2) {
                    float x = e.getX() - this.f29957OooO0o0;
                    float y = e.getY() - this.f29956OooO0o;
                    boolean z = orientation == 0;
                    float fAbs = Math.abs(x) * (z ? 0.5f : 1.0f);
                    float fAbs2 = Math.abs(y) * (z ? 1.0f : 0.5f);
                    float f = this.f29955OooO0Oo;
                    if (fAbs > f || fAbs2 > f) {
                        if (z == (fAbs2 > fAbs)) {
