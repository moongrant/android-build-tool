...
public final class NumberViews extends LinearLayout {
    ...
    public final void OooO00o() {
        int i = this.numCount;
        if (i >= 0) {
            this.f29963OooO0o = o00O000o.OooO00o(i, this.f29963OooO0o);
        }
        int i2 = 0;
        if (this.f29963OooO0o.length() == 0) {
            setVisibility(8);
            return;
        }
        setVisibility(0);
        char[] charArray = this.f29963OooO0o.toCharArray();
        ...
        while (it.hasNext()) {
            ...
            if (c == '-') {
                setGravity(17);
                numberView.setDataRes(NumberSize.f29959OooO0O0);
                addView(numberView);
            } else if (c == 'X' || c == 'x') {
                setGravity(80);
                numberView.setDataRes(NumberSize.f29958OooO00o);
                addView(numberView);
    ...
    public NumberViews(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, o00000.NumberViews);
        int integer = typedArrayObtainStyledAttributes.getInteger(o00000.NumberViews_numSize, 1);
        int i2 = NumberSize.f29958OooO00o;
        this.size = NumberSize.OooO00o(Integer.valueOf(integer));
        this.f29963OooO0o = o0OoOo0.OooOOO(typedArrayObtainStyledAttributes.getString(o00000.NumberViews_numData), "");
        this.numCount = typedArrayObtainStyledAttributes.getInteger(o00000.NumberViews_numCount, -1);
