...
import p587o0oOooOO.g1;
import p587o0oOooOO.h1;
import p587o0oOooOO.j1;
...
public abstract class ScrollableView extends ScrollView {
    ...
    @NotNull
    public final Scroller f30059OooO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public final ArrayList f30060OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public int f30061OooO0o;
    ...
    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public int f30063OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public int f30064OooO0oo;
    ...
    public static final class OooO00o extends Lambda implements Function0<LinearLayout> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Context f30066OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(Context context) {
            super(0);
            this.f30066OooO0Oo = context;
        }

        @Override // kotlin.jvm.functions.Function0
        public final LinearLayout invoke() {
            LinearLayout linearLayout = new LinearLayout(this.f30066OooO0Oo);
    ...
    public final void OooO0OO(long j, @Nullable Function0 function0, boolean z, @IntRange(from = ULong.MIN_VALUE, to = 9) int i) {
        if (z) {
            this.f30060OooO0Oo.clear();
            getLinearLayout().removeAllViews();
        }
        this.f30064OooO0oo = i;
        g1 g1Var = new g1(this);
        int i2 = 0;
        while (true) {
            Context context = getContext();
            Intrinsics.checkNotNullExpressionValue(context, "getContext(...)");
            g1Var.invoke(OooO0O0(i2, context));
            if (i2 == 9) {
                break;
            } else {
                i2++;
        ...
        if (i3 >= 0) {
            ...
            while (true) {
                ...
                h1Var.invoke(OooO0O0(i4, context2));
                if (i4 == i3) {
                    break;
                } else {
                    i4++;
        ...
        j1 j1Var = new j1(this, j, function0);
        Intrinsics.checkNotNullParameter(linearLayout, "<this>");
        linearLayout.measure(0, 0);
        j1Var.invoke(linearLayout);
    }

    @Override // android.widget.ScrollView, android.view.View
    public final void computeScroll() {
        Scroller scroller = this.f30059OooO;
    ...
    public final int getF30064OooO0oo() {
        return this.f30064OooO0oo;
    }
    ...
    public ScrollableView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        this.f30060OooO0Oo = new ArrayList();
        this.linearLayout = LazyKt.lazy(new OooO00o(context));
        this.f30061OooO0o = -1;
        this.f30063OooO0oO = -1;
        removeAllViews();
        addView(getLinearLayout());
        this.f30059OooO = new Scroller(context);
