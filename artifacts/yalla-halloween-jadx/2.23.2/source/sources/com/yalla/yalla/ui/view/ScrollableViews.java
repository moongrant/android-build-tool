...
import p587o0oOooOO.k1;
import p587o0oOooOO.l1;
...
public final class ScrollableViews extends LinearLayout {
    ...
    @NotNull
    public final ArrayList f30068OooO0Oo;
    ...
    public static void OooO00o(final ScrollableViews scrollableViews, int i) {
        ...
        scrollableViews.f30070OooO0o0 = false;
        ArrayList arrayList = scrollableViews.f30068OooO0Oo;
        Iterator it = arrayList.iterator();
        while (it.hasNext()) {
            o000O.OooO0O0((View) it.next());
        }
        scrollableViews.f30072OooO0oo = numStr;
        int i2 = scrollableViews.numMinCount;
        if (i2 >= 0) {
            scrollableViews.f30072OooO0oo = o00O000o.OooO00o(i2, numStr);
        }
        char[] charArray = scrollableViews.f30072OooO0oo.toCharArray();
        ...
        while (it2.hasNext()) {
            ...
            if ((!arrayList.isEmpty()) && charArray.length == arrayList.size()) {
                ...
                if (scrollableView != null) {
                    scrollableView.OooO0OO(((long) (iNextInt + 1)) * scrollableViews.delay, new l1(scrollableViews, iNextInt, charArray), scrollableViews.f30070OooO0o0, charArray[iNextInt] - '0');
                    o000O.OooOOOO(scrollableView);
                }
            } else {
                ...
                ScrollableView scrollableView2 = new ScrollableView(context) { // from class: com.yalla.yalla.ui.view.ScrollableViews$initView$scrollableView$1
                    ...
                    public final NumberView OooO0O0(int i3, @NotNull Context context2) {
                        ...
                        numberView.setSize(this.f30075OooOO0O.getSize());
                        numberView.setData(i3);
                        return numberView;
                    }
                };
                scrollableView2.OooO0OO(scrollableViews.delay * ((long) (iNextInt + 1)), new k1(scrollableViews, iNextInt, charArray), scrollableViews.f30070OooO0o0, charArray[iNextInt] - '0');
    ...
    public ScrollableViews(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        this.f30068OooO0Oo = new ArrayList();
        this.f30070OooO0o0 = true;
