...
public final class StickerFaceView extends RecyclerView {
    ...
    public static final /* synthetic */ int f30181OooO0oO = 0;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public final OooO00o f30182OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @Nullable
    public Function1<? super Integer, Unit> f30183OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public long f30184OooO0o0;

    @SourceDebugExtension({"SMAP\nStickerFaceView.kt\nKotlin\n*S Kotlin\n*F\n+ 1 StickerFaceView.kt\ncom/yalla/yalla/ui/view/StickerFaceView$1\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,68:1\n1#2:69\n*E\n"})
    public static final class OooO00o extends o0000oo<OooO0O0> {
        ...
        public final void OooO0oO(BaseViewHolder baseViewHolder, Object obj) {
            ...
            if (oooO0O0 != null) {
                helper.setImageResource(o0OO00O.iv_face, oooO0O0.f30186OooO0O0);
            }
        }
    }
    ...
    public static final class OooO0O0 {
        ...
        public final int f30185OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final int f30186OooO0O0;

        public OooO0O0(int i, int i2) {
            this.f30185OooO00o = i;
            this.f30186OooO0O0 = i2;
        }
        ...
        public final boolean equals(@Nullable Object obj) {
            ...
            OooO0O0 oooO0O0 = (OooO0O0) obj;
            return this.f30185OooO00o == oooO0O0.f30185OooO00o && this.f30186OooO0O0 == oooO0O0.f30186OooO0O0;
        }

        public final int hashCode() {
            return (this.f30185OooO00o * 31) + this.f30186OooO0O0;
        }

        @NotNull
        public final String toString() {
            StringBuilder sb = new StringBuilder("StickerModel(stickerId=");
            sb.append(this.f30185OooO00o);
            sb.append(", stickerImg=");
            return OooOO0.OooO00o(sb, this.f30186OooO0O0, ")");
        }
    }
    ...
    public StickerFaceView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        arrayList.add(new OooO0O0(0, o0Oo0oo.icon_room_face_dice));
        arrayList.add(new OooO0O0(1, o0Oo0oo.icon_room_face_jsb));
        OooO00o oooO00o = new OooO00o(oo0o0Oo.item_sticker_face, context, arrayList);
        this.f30182OooO0Oo = oooO00o;
        setOverScrollMode(2);
        ...
        setAdapter(oooO00o);
        oooO00o.f13176OooO0o = new o0OO00OO(this);
    }
}
