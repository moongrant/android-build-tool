...
import p405o0Oo0OOO.a1;
import p562o0oOo000.o0Oo0oo;
import p587o0oOooOO.q2;
...
public final class UserInfoPendantLayout extends FrameLayout {
    ...
    public static final /* synthetic */ int f30237OooO0o0 = 0;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public final a1 f30238OooO0Oo;
    ...
    public static final class OooO00o implements com.opensource.svgaplayer.OooO0OO.OooO0O0 {
        ...
        public final void OooO00o(@NotNull o00Ooo videoItem) {
            ...
            o0OO0O0O.OooO oooO = new o0OO0O0O.OooO(videoItem);
            UserInfoPendantLayout userInfoPendantLayout = UserInfoPendantLayout.this;
            userInfoPendantLayout.f30238OooO0Oo.f43715OooO0OO.setImageDrawable(oooO);
            userInfoPendantLayout.f30238OooO0Oo.f43715OooO0OO.OooO0Oo();
        }
    ...
    private final void setImageResource(int resource) {
        a1 a1Var = this.f30238OooO0Oo;
        a1Var.f43714OooO0O0.setVisibility(0);
        a1Var.f43715OooO0OO.setVisibility(8);
        a1Var.f43714OooO0O0.setImageResource(resource);
    }

    private final void setKaVipBackgroundResource(int kaVipLevel) {
        a1 a1Var = this.f30238OooO0Oo;
        ViewGroup.LayoutParams layoutParams = a1Var.f43715OooO0OO.getLayoutParams();
        Intrinsics.checkNotNull(layoutParams, "null cannot be cast to non-null type android.widget.LinearLayout.LayoutParams");
        LinearLayout.LayoutParams layoutParams2 = (LinearLayout.LayoutParams) layoutParams;
        layoutParams2.bottomMargin = o0000O0.OooO00o(0);
        a1Var.f43715OooO0OO.setLayoutParams(layoutParams2);
        if (kaVipLevel == VipLevel.Vip1.getValue()) {
            setImageResource(o0Oo0oo.room_user_info_dialog_pendant_ka_vip_1);
            return;
        }
        if (kaVipLevel == VipLevel.Vip2.getValue()) {
            setImageResource(o0Oo0oo.room_user_info_dialog_pendant_ka_vip_2);
            return;
        }
    ...
    public final void OooO00o(String str) {
        a1 a1Var = this.f30238OooO0Oo;
        a1Var.f43714OooO0O0.setVisibility(8);
        a1Var.f43715OooO0OO.setVisibility(0);
    ...
    public UserInfoPendantLayout(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        a1 a1VarInflate = a1.inflate(LayoutInflater.from(context), this, true);
        Intrinsics.checkNotNullExpressionValue(a1VarInflate, "inflate(...)");
        this.f30238OooO0Oo = a1VarInflate;
        a1VarInflate.f43715OooO0OO.setOnClickListener(new q2());
        a1VarInflate.f43714OooO0O0.setOnClickListener(new q2());
    }
}
