...
public final class UserNameView extends AppCompatTextView {
    ...
    @Nullable
    public LinearGradient f30247OooOO0O;

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    @NotNull
    public final Matrix f30248OooOO0o;

    /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
    @Nullable
    public Job f30249OooOOO;

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    public float f30250OooOOO0;

    /* JADX INFO: renamed from: OooOOOO, reason: collision with root package name */
    @NotNull
    public final int[] f30251OooOOOO;
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public static final class C0341OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {

            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ UserNameView f30255OooO0Oo;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C0341OooO00o(UserNameView userNameView, Continuation<? super C0341OooO00o> continuation) {
                super(2, continuation);
                this.f30255OooO0Oo = userNameView;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                return new C0341OooO00o(this.f30255OooO0Oo, continuation);
            }

            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
                return ((C0341OooO00o) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
            }
    ...
    public final void onDraw(@NotNull Canvas canvas) {
        ...
        super.onDraw(canvas);
        if (this.isFlash) {
            if (this.f30247OooOO0O == null) {
                this.f30247OooOO0O = new LinearGradient(0.0f, 0.0f, o000O000.f46650OooO00o, 0.0f, this.f30251OooOOOO, (float[]) null, Shader.TileMode.MIRROR);
            }
            TextPaint paint2 = getPaint();
            if ((paint2 != null ? paint2.getShader() : null) == null && (paint = getPaint()) != null) {
                paint.setShader(this.f30247OooOO0O);
            }
            float fOooO00o = this.f30250OooOOO0 + o0000O0.OooO00o(6);
            this.f30250OooOOO0 = fOooO00o;
            int i = o000O000.f46650OooO00o;
            if (fOooO00o > i) {
                this.f30250OooOOO0 = -i;
            }
            Matrix matrix = this.f30248OooOO0o;
            matrix.setTranslate(this.f30250OooOOO0, 0.0f);
            LinearGradient linearGradient = this.f30247OooOO0O;
    ...
    public final void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        this.f30247OooOO0O = null;
        this.f30250OooOOO0 = 0.0f;
    }
    ...
    public final void setFlash(boolean z) {
        ...
        if (this.isFlash) {
            ...
            this.f30249OooOOO = jobLaunch$default;
    ...
    public UserNameView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        this.f30248OooOO0o = new Matrix();
        int i2 = o0OOO0o.color_FF4;
        int i3 = o0OOO0o.color_FA6;
        int i4 = o0OOO0o.color_F58;
        int i5 = o0OOO0o.color_D4F;
        int i6 = o0OOO0o.color_4FF;
        this.f30251OooOOOO = new int[]{o0000.OooO00o(i2), o0000.OooO00o(i3), o0000.OooO00o(i4), o0000.OooO00o(i5), o0000.OooO00o(i6), o0000.OooO00o(i2), o0000.OooO00o(i3), o0000.OooO00o(i4), o0000.OooO00o(i5), o0000.OooO00o(i6), o0000.OooO00o(i2), o0000.OooO00o(i3), o0000.OooO00o(i4), o0000.OooO00o(i5), o0000.OooO00o(i6)};
    }
}
