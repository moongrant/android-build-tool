...
public class SkiaImageDecoder implements o0O0o000 {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final Bitmap.Config f30411OooO00o;

    @Keep
    public SkiaImageDecoder() {
        Bitmap.Config preferredBitmapConfig = SubsamplingScaleImageView.getPreferredBitmapConfig();
        if (preferredBitmapConfig != null) {
            this.f30411OooO00o = preferredBitmapConfig;
        } else {
            this.f30411OooO00o = Bitmap.Config.RGB_565;
        }
    }

    @Override // p555o0oOOoo.o0O0o000
    @NonNull
    public final Bitmap OooO00o(Context context, @NonNull Uri uri) throws Exception {
        ...
        options.inPreferredConfig = this.f30411OooO00o;
