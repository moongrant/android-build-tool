...
public final class GiftTypeNotUpTipsView extends ConstraintLayout {
    ...
    public static final class OooO00o extends Lambda implements Function1<View, Unit> {
        ...
        public final Unit invoke(View view) {
            ...
            if (num != null) {
                o0oo0000.OooO00o.OooO0OO("102213", MapsKt.hashMapOf(new Pair("target", Integer.valueOf(num.intValue()))));
            }
    ...
    public GiftTypeNotUpTipsView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullExpressionValue(e3VarInflate, "inflate(...)");
        this.f30494OooO0Oo = e3VarInflate;
        this.typeUser = GiftPropTypeUser.Hot.getValue();
        Intrinsics.checkNotNullParameter(context, "context");
        Context context2 = o000O00O.f13421OooO00o;
        Intrinsics.checkNotNullParameter(context, "<set-?>");
        o000O00O.f13421OooO00o = context;
        ConstraintLayout constraintLayout = e3VarInflate.f43831OooO00o;
        Intrinsics.checkNotNullExpressionValue(constraintLayout, "getRoot(...)");
        o000O.OooO0oo(constraintLayout, new OooO00o());
        MarqueeText tvInfo = e3VarInflate.f43830OooO;
