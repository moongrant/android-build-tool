...
public final class GiftWeekStarTipsView extends ConstraintLayout {
    ...
    public final void setData(@NotNull String string) {
        ...
        g3 g3Var = this.f30509OooO0Oo;
        MarqueeText content = g3Var.f43880OooO0O0;
        Intrinsics.checkNotNullExpressionValue(content, "content");
        MarqueeText.OooOO0o(content);
        MarqueeText content2 = g3Var.f43880OooO0O0;
        content2.setText(string);
        Intrinsics.checkNotNullExpressionValue(content2, "content");
        o000O.OooOOOO(content2);
    }
    ...
    public GiftWeekStarTipsView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullExpressionValue(g3VarInflate, "inflate(...)");
        this.f30509OooO0Oo = g3VarInflate;
        Intrinsics.checkNotNullParameter(context, "context");
        Context context2 = o000O00O.f13421OooO00o;
        Intrinsics.checkNotNullParameter(context, "<set-?>");
        o000O00O.f13421OooO00o = context;
        ConstraintLayout layoutRoot = g3VarInflate.f43881OooO0OO;
        Intrinsics.checkNotNullExpressionValue(layoutRoot, "layoutRoot");
        o000O.OooO(layoutRoot, new OooO00o());
        setData(o000.OooO0OO(context, o000000.weekly_gifts_new));
    }
}
