...
import p405o0Oo0OOO.oOOO00o0;
import p412o0Oo0o0O.o000O000;
import p475o0Ooooo0.oOo0oooO;
import p492o0o00OO0.o00OOO0;
import p492o0o00OO0.o0O00oO0;
...
public final class MomentsMessagesEditView extends FrameLayout {
    ...
    @Nullable
    public Function1<? super MomentSendCommentModel, Unit> f30612OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @Nullable
    public MomentSendCommentModel f30613OooO0o;
    ...
    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    @NotNull
    public final o00OOO0 f30615OooO0oO;
        ...
        public final Unit invoke(Composer composer, Integer num) {
            ...
            if ((iIntValue & 11) == 2 && composer2.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(1901980334, iIntValue, -1, "com.yalla.yalla.ui.view.moment.MomentsMessagesEditView.<anonymous> (MomentsMessagesEditView.kt:70)");
                }
                ...
                o0O00oO0.OooO0o0(BoxScopeInstance.INSTANCE, MomentsMessagesEditView.this.f30615OooO0oO, null, composer2, 454);
    ...
    public static final class OooO0O0 extends Lambda implements Function1<o00OOO0, Unit> {
        public OooO0O0() {
            super(1);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Unit invoke(o00OOO0 o00ooo1) {
            o00OOO0 it = o00ooo1;
    ...
    public static final class OooO0OO extends Lambda implements Function3<o00OOO0, Boolean, Integer, Unit> {
        public OooO0OO() {
            super(3);
        }

        @Override // kotlin.jvm.functions.Function3
        public final Unit invoke(o00OOO0 o00ooo1, Boolean bool, Integer num) {
            boolean zBooleanValue = bool.booleanValue();
            Intrinsics.checkNotNullParameter(o00ooo1, "<anonymous parameter 0>");
            ...
            if (zBooleanValue) {
                ...
                o000O.OooO0O0(momentsMessagesEditView);
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public static final void OooO00o(MomentsMessagesEditView momentsMessagesEditView) {
        String jSONString;
        o00OOO0 o00ooo1 = momentsMessagesEditView.f30615OooO0oO;
        boolean z = true;
        if (StringsKt.isBlank(o00ooo1.OooO00o().getText().toString())) {
            String strOooO0OO = o0000.OooO0OO(o000000.please_input_dynamic);
        ...
        EditTextSpan editTextSpanOooO00o = o00ooo1.OooO00o();
        HashMap map = oOO.f57157OooO0Oo;
        if ((editTextSpanOooO00o != null ? editTextSpanOooO00o.getText().length() : 0) > 500) {
            String strOooO00o = o0000O.OooO00o(o0000.OooO0OO(o000000.char_room_text_lenght), "500");
            if (StringsKt.isBlank(strOooO00o)) {
                return;
            }
            o000Oo0 o000oo0OooO00o2 = OooOo00.OooO00o(strOooO00o, "runnable");
            if (Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                o000oo0OooO00o2.run();
                return;
            } else {
        ...
        if (oOO.OooO0Oo(o00ooo1.OooO00o()) > 50) {
            String strOooO0OO2 = o0000.OooO0OO(o000000.char_room_edit1);
        ...
        String strOooO00o2 = o00O0O.OooO00o((Activity) momentsMessagesEditView.getContext(), o00ooo1.OooO00o());
        Intrinsics.checkNotNullExpressionValue(strOooO00o2, "getAtUserToAtNum(...)");
        MomentSendContentModel momentSendContentModel = new MomentSendContentModel(strOooO00o2);
        ArrayList<? extends oOo00ooO> arrayListOooO0O0 = o00ooo1.OooO00o().getSpanManager().OooO0O0("@");
        ...
        for (int i = 0; i < size; i++) {
            ...
            Intrinsics.checkNotNullExpressionValue(ooo00ooo, "get(...)");
            oOo00ooO ooo00ooo2 = ooo00ooo;
            List<MomentSendContentAtModel> at = momentSendContentModel.getAt();
            String strOooO00o3 = o0000O00.OooO00o(ooo00ooo2.f56182OooO0o0);
        ...
        MomentSendCommentModel momentSendCommentModel = momentsMessagesEditView.f30613OooO0o;
        if (momentSendCommentModel != null) {
            ...
            if (!z) {
                ...
                BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), null, null, new oOo0oooO(actionType, actionInfo, null, null), 3, null);
            }
        }
        Function1<? super MomentSendCommentModel, Unit> function1 = momentsMessagesEditView.f30612OooO0Oo;
        if (function1 != null) {
            function1.invoke(momentsMessagesEditView.f30613OooO0o);
        }
    }

    private final void setClickableOnSend(boolean clickable) {
        this.f30615OooO0oO.f49185OooO0oo.setValue(Boolean.valueOf(clickable));
    }

    private final void setReplyPostDetailComment(MomentReplyModel data) {
        if (data != null) {
            MomentSendCommentModel momentSendCommentModel = this.f30613OooO0o;
            if (momentSendCommentModel != null) {
                momentSendCommentModel.cleanComment();
            }
            MomentSendCommentModel momentSendCommentModel2 = this.f30613OooO0o;
            if (momentSendCommentModel2 != null) {
                String strOooO00o = o0000O00.OooO00o(data.getId());
                String strOooO00o2 = o0000O00.OooO00o(data.getUserid());
            ...
            this.f30615OooO0oO.f49183OooO0o0.setValue(o0000O.OooO00o(o0000.OooO0OO(o000000.Reply_xxx), o000O000.OooO0O0(jOooO, parentUserName != null ? parentUserName : "")));
        }
    }
    ...
    public final void OooO0OO() {
        ...
        o00OOO0 o00ooo1 = this.f30615OooO0oO;
        o00ooo1.OooO00o().setText("");
        EditTextSpan editTextSpanOooO00o = o00ooo1.OooO00o();
        oOo0000O spanManager = editTextSpanOooO00o.getSpanManager();
        spanManager.OooO00o();
    ...
    public final void setSendPostCommentModel(@Nullable MomentSendCommentModel sendPostCommentModel) {
        ...
        if (sendPostCommentModel != null) {
            ...
            o00ooo1.f49183OooO0o0.setValue(o0000O.OooO00o(o0000.OooO0OO(o000000.Reply_xxx), o000O000.OooO0O0(jOooO, parentUserName)));
            o00ooo1.OooO00o().setText("");
        }
    }
    ...
    public MomentsMessagesEditView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        oOOO00o0 oooo00o0Inflate = oOOO00o0.inflate(LayoutInflater.from(context), this, true);
        Intrinsics.checkNotNullExpressionValue(oooo00o0Inflate, "inflate(...)");
        View viewShade = oooo00o0Inflate.f45158OooO0OO;
        Intrinsics.checkNotNullExpressionValue(viewShade, "viewShade");
        this.f30615OooO0oO = new o00OOO0((AppCompatActivity) context, viewShade, new OooO0O0(), new OooO0OO());
        ComposeView composeView = oooo00o0Inflate.f45157OooO0O0;
        Intrinsics.checkNotNullExpressionValue(composeView, "composeView");
        o0000oo.OooO0Oo(composeView, ComposableLambdaKt.composableLambdaInstance(1901980334, true, new OooO00o()));
    }
}
