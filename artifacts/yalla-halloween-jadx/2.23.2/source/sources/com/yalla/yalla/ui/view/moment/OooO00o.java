...
public final class OooO00o extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MomentDetailCommentItemView f30634OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooO00o(MomentDetailCommentItemView momentDetailCommentItemView) {
        super(0);
        this.f30634OooO0Oo = momentDetailCommentItemView;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        MomentDetailCommentItemView momentDetailCommentItemView = this.f30634OooO0Oo;
