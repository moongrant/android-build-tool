...
public final class OooO0OO extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MomentDetailCommentItemView f30636OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooO0OO(MomentDetailCommentItemView momentDetailCommentItemView) {
        super(0);
        this.f30636OooO0Oo = momentDetailCommentItemView;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        UserInfoActivity.OooO00o oooO00o = UserInfoActivity.f26775Oooo0o;
        MomentDetailCommentItemView momentDetailCommentItemView = this.f30636OooO0Oo;
