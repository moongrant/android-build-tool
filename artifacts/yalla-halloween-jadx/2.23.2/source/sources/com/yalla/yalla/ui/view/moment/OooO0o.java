...
public final class OooO0o extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MomentReplyItemView f30637OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooO0o(MomentReplyItemView momentReplyItemView) {
        super(0);
        this.f30637OooO0Oo = momentReplyItemView;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        UserInfoActivity.OooO00o oooO00o = UserInfoActivity.f26775Oooo0o;
        MomentReplyItemView momentReplyItemView = this.f30637OooO0Oo;
