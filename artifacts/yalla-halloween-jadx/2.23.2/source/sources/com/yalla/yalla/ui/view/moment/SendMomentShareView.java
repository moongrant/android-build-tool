...
import p405o0Oo0OOO.o0OOO0OO;
import p423o0OoO0OO.o00O0O0O;
import p562o0oOo000.o000000;
import p562o0oOo000.o0OOO0o;
import p562o0oOo000.o0Oo0oo;
import p564o0oOo0O.o0OO;
...
public final class SendMomentShareView extends LinearLayout {
    ...
    public static final /* synthetic */ int f30694OooO0oO = 0;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public final o0OOO0OO f30695OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @NotNull
    public final Drawable f30696OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @NotNull
    public final Drawable f30697OooO0o0;
    ...
    private final void setEditEventView(MomentForwardContent it) {
        o0OOO0OO o0ooo0oo2 = this.f30695OooO0Oo;
        ConstraintLayout layoutEvent = o0ooo0oo2.f44632OooO0oo;
        ...
        oooO00o.OooO0o0(8);
        oooO00o.f43126OooO0OO = p184o00o00O0.OooO0OO.OooO0oo(o0000O0.OooO00o(144), o0000O0.OooO00o(81), it.getImage());
        oooO00o.f43124OooO00o = 0;
        oooO00o.OooO0Oo(o0ooo0oo2.f44626OooO0O0);
        int eventState = it.getEventState();
        int inProgress = EventState.INSTANCE.getInProgress();
        TextView eventTime = o0ooo0oo2.f44629OooO0o;
        if (eventState == inProgress) {
            Intrinsics.checkNotNullExpressionValue(eventTime, "eventTime");
            o00O0O0O.OooO0oO(eventTime, this.f30696OooO0o);
            eventTime.setTextColor(o0000.OooO00o(o0OOO0o.color_FFA21F));
            eventTime.setText(o0000.OooO0OO(o000000.Event_Live_Now));
        } else if (o0O0OOOo.OooO00o(it.getStartTime()) > 0) {
            Intrinsics.checkNotNullExpressionValue(eventTime, "eventTime");
            o00O0O0O.OooO0oO(eventTime, this.f30697OooO0o0);
            eventTime.setTextColor(o0000.OooO00o(o0OOO0o.color_FFFFFFF));
            eventTime.setText(o0O0O0o0.OooO0o(o0O0OOOo.OooO00o(it.getStartTime())));
        }
        o0ooo0oo2.f44627OooO0OO.setText(o0OoOo0.OooOOO(it.getName(), ""));
        o0ooo0oo2.f44630OooO0o0.setText(o0OoOo0.OooOOO(it.getRoomName(), ""));
        o0ooo0oo2.f44628OooO0Oo.setText(String.valueOf(it.getRoomIdx()));
    ...
    private final void setEditForwardView(MomentDetailModel forward) {
        ...
        o0OOO0OO o0ooo0oo2 = this.f30695OooO0Oo;
        LinearLayout layoutShare = o0ooo0oo2.f44633OooOO0;
        ...
        FrameLayout layoutImage = o0ooo0oo2.f44624OooO;
        ...
        if (!TextUtils.isEmpty(image)) {
            ...
            oooO00o.OooO00o(d1.OooO0Oo());
            oooO00o.OooO0o0(8);
            oooO00o.f43126OooO0OO = p184o00o00O0.OooO0OO.OooO0O0(o0000O0.OooO00o(120), image);
            oooO00o.f43124OooO00o = 0;
            oooO00o.OooO0Oo(o0ooo0oo2.f44631OooO0oO);
        }
        TextView tvShareTitle = o0ooo0oo2.f44635OooOO0o;
        ...
        TextView tvShareContent = o0ooo0oo2.f44634OooOO0O;
        Intrinsics.checkNotNullExpressionValue(tvShareContent, "tvShareContent");
        o000O.OooOOOO(tvShareContent);
        Intrinsics.throwUninitializedPropertyAccessException("activity");
        o00O0O.OooO0OO(null, forward.getContent(), tvShareContent, new o0OO());
        Intrinsics.throwUninitializedPropertyAccessException("imageHideListener");
        throw null;
    }
    ...
    private final void setEditShareView(MomentForwardContent forwardContent) {
        ...
        if (!TextUtils.isEmpty(forwardContent.getImage())) {
            ...
            oooO00o.OooO00o(d1.OooO0Oo());
            oooO00o.OooO0o0(8);
            oooO00o.f43126OooO0OO = p184o00o00O0.OooO0OO.OooO0O0(o0000O0.OooO00o(120), forwardContent.getImage());
            oooO00o.f43124OooO00o = 0;
            oooO00o.OooO0Oo(o0ooo0oo2.f44631OooO0oO);
        }
        TextView tvShareTitle = o0ooo0oo2.f44635OooOO0o;
        ...
        if (!TextUtils.isEmpty(forwardContent.getContent())) {
            TextView textView = o0ooo0oo2.f44634OooOO0O;
    ...
    private final void setShareForwardEventView(EventModel eventModel) {
        ...
        oooO00o.OooO00o(d1.OooO0Oo());
        oooO00o.OooO0o0(8);
        oooO00o.f43126OooO0OO = p184o00o00O0.OooO0OO.OooO0oo(o0000O0.OooO00o(144), o0000O0.OooO00o(81), eventModel.getEventImage());
        oooO00o.f43124OooO00o = 0;
        oooO00o.OooO0Oo(o0ooo0oo2.f44626OooO0O0);
        ...
        if (eventState == inProgress) {
            ...
            eventTime.setTextColor(o0000.OooO00o(o0OOO0o.color_FFA21F));
            eventTime.setText(o0000.OooO0OO(o000000.Event_Live_Now));
        } else if (o0O0OOOo.OooO00o(eventModel.getEventStartTime()) > 0) {
            Intrinsics.checkNotNullExpressionValue(eventTime, "eventTime");
            o000O.OooOOOO(eventTime);
            Intrinsics.checkNotNullExpressionValue(eventTime, "eventTime");
            o00O0O0O.OooO0oO(eventTime, this.f30697OooO0o0);
            eventTime.setTextColor(o0000.OooO00o(o0OOO0o.color_FFFFFFF));
            eventTime.setText(o0O0O0o0.OooO0o(o0O0OOOo.OooO00o(eventModel.getEventStartTime())));
        }
        if (eventModel.getEventName().length() > 0) {
            TextView eventName = o0ooo0oo2.f44627OooO0OO;
            Intrinsics.checkNotNullExpressionValue(eventName, "eventName");
            o000O.OooOOOO(eventName);
            eventName.setText(eventModel.getEventName());
        }
        if (eventModel.getRoomName().length() > 0) {
            TextView eventRoomName = o0ooo0oo2.f44630OooO0o0;
        ...
        if (eventModel.getRoomIdx() > 0) {
            TextView eventRoomId = o0ooo0oo2.f44628OooO0Oo;
    ...
    private final void setShareForwardRoomView(RoomShareModel roomShareModel) {
        ...
        if (!TextUtils.isEmpty(roomShareModel.getImageUrl())) {
            ...
            oooO00o.OooO00o(d1.OooO0Oo());
            oooO00o.OooO0o0(8);
            oooO00o.f43126OooO0OO = p184o00o00O0.OooO0OO.OooO0O0(o0000O0.OooO00o(120), roomShareModel.getImageUrl());
            oooO00o.f43124OooO00o = 0;
            oooO00o.OooO0Oo(o0ooo0oo2.f44631OooO0oO);
        }
        TextView tvShareTitle = o0ooo0oo2.f44635OooOO0o;
        ...
        o0ooo0oo2.f44634OooOO0O.setText(roomShareModel.getContent());
    }
    ...
    private final void setShareForwardWebView(ShareWebModel webModel) {
        ...
        if (!TextUtils.isEmpty(webModel.getImagesUrl())) {
            ...
            oooO00o.OooO00o(d1.OooO0Oo());
            oooO00o.OooO0o0(8);
            oooO00o.f43126OooO0OO = p184o00o00O0.OooO0OO.OooO0O0(o0000O0.OooO00o(120), webModel.getImagesUrl());
            oooO00o.f43124OooO00o = 0;
            oooO00o.OooO0Oo(o0ooo0oo2.f44631OooO0oO);
        }
        TextView tvShareTitle = o0ooo0oo2.f44635OooOO0o;
        ...
        o0ooo0oo2.f44634OooOO0O.setText(webModel.getContent());
    }
    ...
    public SendMomentShareView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        o0OOO0OO o0ooo0ooInflate = o0OOO0OO.inflate(LayoutInflater.from(context), this, true);
        Intrinsics.checkNotNullExpressionValue(o0ooo0ooInflate, "inflate(...)");
        this.f30695OooO0Oo = o0ooo0ooInflate;
        this.f30697OooO0o0 = o0000.OooO0O0(o0Oo0oo.ic_event_time);
        this.f30696OooO0o = o0000.OooO0O0(o0Oo0oo.ic_event_time_progress);
    }
}
