...
public final class XRefreshFooterView extends FrameLayout implements OooO0o {
    ...
    public TextView f30712OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public boolean f30713OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public int f30714OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public SVGAView f30715OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public com.yalla.yalla.util.Function.OooO00o f30716OooO0oo;
    ...
    public final void OooO00o(@NotNull OooOOO0 refreshLayout, @NotNull RefreshState oldState, @NotNull RefreshState newState) {
        ...
        if (i == 1) {
            SVGAView sVGAView = this.f30715OooO0oO;
            if (sVGAView == null) {
                Intrinsics.throwUninitializedPropertyAccessException("svgaFooter");
                sVGAView = null;
            }
            o000O.OooOOO0(sVGAView, true ^ this.f30713OooO0o);
            TextView textView = this.f30712OooO0Oo;
            if (textView == null) {
                Intrinsics.throwUninitializedPropertyAccessException("tvFooter");
                textView = null;
            }
            o000O.OooOOO0(textView, this.f30713OooO0o);
            SVGAView sVGAView2 = this.f30715OooO0oO;
            if (sVGAView2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("svgaFooter");
                sVGAView2 = null;
            }
            sVGAView2.OooO0Oo();
            com.yalla.yalla.util.Function.OooO00o oooO00o2 = this.f30716OooO0oo;
            if (oooO00o2 == null) {
        ...
        SVGAView sVGAView3 = this.f30715OooO0oO;
        if (sVGAView3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("svgaFooter");
            sVGAView3 = null;
        }
        o000O.OooOOO0(sVGAView3, !this.f30713OooO0o);
        TextView textView2 = this.f30712OooO0Oo;
        if (textView2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("tvFooter");
            textView2 = null;
        }
        o000O.OooOOO0(textView2, this.f30713OooO0o);
        SVGAView sVGAView4 = this.f30715OooO0oO;
        if (sVGAView4 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("svgaFooter");
            sVGAView4 = null;
        }
        sVGAView4.OooO0oO(false);
        com.yalla.yalla.util.Function.OooO00o oooO00o3 = this.f30716OooO0oo;
        if (oooO00o3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("loadingAnim");
        } else {
            oooO00o = oooO00o3;
    ...
    public final void OooO0oo(@NotNull SmartRefreshLayout.OooOOO kernel, int i, int i2) {
        ...
        if (this.f30714OooO0o0 != 0) {
            kernel.OooO0OO(this, o0000.OooO00o(o0OOO0o.colorPrimary));
        }
    }
    ...
    public XRefreshFooterView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        View.inflate(getContext(), oo0o0Oo.layout_load_more_footer, this);
        View viewFindViewById = findViewById(o0OO00O.tv_refresh_footer);
        Intrinsics.checkNotNullExpressionValue(viewFindViewById, "findViewById(...)");
        this.f30712OooO0Oo = (TextView) viewFindViewById;
        View viewFindViewById2 = findViewById(o0OO00O.svga_refersh_footer);
        Intrinsics.checkNotNullExpressionValue(viewFindViewById2, "findViewById(...)");
        SVGAView sVGAView2 = (SVGAView) viewFindViewById2;
        this.f30715OooO0oO = sVGAView2;
