...
@Metadata(d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0007\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0004\b\u0007\u0018\u00002\u00020\u0001B'\b\u0007\u0012\u0006\u0010\u0007\u001a\u00020\u0006\u0012\n\b\u0002\u0010\t\u001a\u0004\u0018\u00010\b\u0012\b\b\u0002\u0010\u000b\u001a\u00020\n¢\u0006\u0004\b\f\u0010\rJ\u0010\u0010\u0005\u001a\u00020\u00042\b\b\u0002\u0010\u0003\u001a\u00020\u0002¨\u0006\u000e"}, d2 = {"Lcom/yalla/yalla/ui/view/room/RoomMemberBadgeView;", "Landroid/widget/FrameLayout;", "", "fontSize", "", "setTextSize", "Landroid/content/Context;", "context", "Landroid/util/AttributeSet;", "attrs", "", "defStyle", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "Common_YallaRelease"}, k = 1, mv = {1, 9, 0})
public final class RoomMemberBadgeView extends FrameLayout {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public final NetImageView f30778OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @NotNull
    public final TextView f30779OooO0o0;
    ...
    public final void OooO00o(@Nullable Integer num, @Nullable String str, boolean z, float f) {
        if (num != null && num.intValue() > 0) {
            if (!(str == null || StringsKt.isBlank(str))) {
                ...
                oooO00o.OooO0Oo(this.f30778OooO0Oo);
                TextView textView = this.f30779OooO0o0;
                o000O.OooOOO0(textView, !z);
    ...
    public final void setTextSize(float fontSize) {
        this.f30779OooO0o0.setTextSize(fontSize);
    }
    ...
    public RoomMemberBadgeView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.f30778OooO0Oo = netImageView;
        TextView textView = new TextView(context);
        this.f30779OooO0o0 = textView;
