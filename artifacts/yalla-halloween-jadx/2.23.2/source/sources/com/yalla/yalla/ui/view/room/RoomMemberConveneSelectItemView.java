...
public final class RoomMemberConveneSelectItemView extends FrameLayout {
    ...
    public static final /* synthetic */ int f30787OooO0o = 0;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public final d1 f30788OooO0Oo;
    ...
    public RoomMemberConveneSelectItemView(@NotNull Context context) {
        ...
        d1 d1VarInflate = d1.inflate(LayoutInflater.from(getContext()), this, true);
        Intrinsics.checkNotNullExpressionValue(d1VarInflate, "inflate(...)");
        this.f30788OooO0Oo = d1VarInflate;
    }
