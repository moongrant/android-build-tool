...
@Metadata(d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u000e\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0004\b\u0007\u0018\u00002\u00020\u0001B'\b\u0007\u0012\u0006\u0010\u000f\u001a\u00020\u000e\u0012\n\b\u0002\u0010\u0011\u001a\u0004\u0018\u00010\u0010\u0012\b\b\u0002\u0010\u0013\u001a\u00020\u0012¢\u0006\u0004\b\u0014\u0010\u0015R\u001b\u0010\u0007\u001a\u00020\u00028BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u0003\u0010\u0004\u001a\u0004\b\u0005\u0010\u0006R\u001a\u0010\r\u001a\u00020\b8\u0006X\u0086D¢\u0006\f\n\u0004\b\t\u0010\n\u001a\u0004\b\u000b\u0010\f¨\u0006\u0016"}, d2 = {"Lcom/yalla/yalla/ui/view/room/RoomUserVipView;", "Landroidx/constraintlayout/widget/ConstraintLayout;", "Lo0Oo0OOO/n3;", "OooO0Oo", "Lkotlin/Lazy;", "getBinding", "()Lo0Oo0OOO/n3;", "binding", "", "OooO0o0", "Ljava/lang/String;", "getVipStr", "()Ljava/lang/String;", "vipStr", "Landroid/content/Context;", "context", "Landroid/util/AttributeSet;", "attrs", "", "defStyle", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "Common_YallaRelease"}, k = 1, mv = {1, 9, 0})
public final class RoomUserVipView extends ConstraintLayout {
    ...
    public static final class OooO00o extends Lambda implements Function0<n3> {
        ...
        public final /* synthetic */ Context f30792OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ RoomUserVipView f30793OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(Context context, RoomUserVipView roomUserVipView) {
            super(0);
            this.f30792OooO0Oo = context;
            this.f30793OooO0o0 = roomUserVipView;
        }

        @Override // kotlin.jvm.functions.Function0
        public final n3 invoke() {
            n3 n3VarInflate = n3.inflate(LayoutInflater.from(this.f30792OooO0Oo), this.f30793OooO0o0, true);
    ...
    public final void OooO0O0(int i, int i2, int i3, @Nullable MixedRoomActivity mixedRoomActivity) {
        ...
        o000O.OooO0O0(svga);
        TextView tvVip = getBinding().f44198OooO0Oo;
        ...
        setVisibility(0);
        getBinding().f44198OooO0Oo.setText(this.vipStr + VipLevel.INSTANCE.of(i2).level());
        TextView tvVip2 = getBinding().f44198OooO0Oo;
        Intrinsics.checkNotNullExpressionValue(tvVip2, "tvVip");
        o000O.OooOOOO(tvVip2);
        SVGAView svga2 = getBinding().f44197OooO0OO;
        Intrinsics.checkNotNullExpressionValue(svga2, "svga");
        o000O.OooOOOO(svga2);
        if (i2 == VipLevel.Vip1.getValue()) {
            getBinding().f44196OooO0O0.setBackgroundResource(o0Oo0oo.room_user_info_dialog_ka_vip_1);
            getBinding().f44197OooO0OO.setImageResource(o0O0O00.main_ka_vip_level_1);
            return;
        }
        if (i2 == VipLevel.Vip2.getValue()) {
            getBinding().f44196OooO0O0.setBackgroundResource(o0Oo0oo.room_user_info_dialog_ka_vip_2);
            getBinding().f44197OooO0OO.setImageResource(o0O0O00.main_ka_vip_level_2);
            return;
        }
        if (i2 == VipLevel.Vip3.getValue()) {
            getBinding().f44196OooO0O0.setBackgroundResource(o0Oo0oo.room_user_info_dialog_ka_vip_3);
            getBinding().f44197OooO0OO.setImageResource(o0O0O00.main_ka_vip_level_3);
            return;
        }
        if (i2 == VipLevel.Vip4.getValue()) {
            getBinding().f44196OooO0O0.setBackgroundResource(o0Oo0oo.room_user_info_dialog_ka_vip_4);
            getBinding().f44197OooO0OO.setImageResource(o0O0O00.main_ka_vip_level_4);
            return;
        }
        if (i2 == VipLevel.Vip5.getValue()) {
            getBinding().f44196OooO0O0.setBackgroundResource(o0Oo0oo.room_user_info_dialog_ka_vip_5);
            getBinding().f44197OooO0OO.setImageResource(o0O0O00.main_ka_vip_level_5);
        } else {
            ...
            sVGAView.OooOO0O("svga/ic_vip6_small.svga", mixedRoomActivity);
            sVGAView.OooOO0o();
            getBinding().f44196OooO0O0.setBackgroundResource(o0Oo0oo.room_user_info_dialog_ka_vip_6_bg);
        }
    }
