...
public final class TipsBubbleView extends LinearLayout implements View.OnClickListener {
    ...
    public TipsBubbleView(@NotNull Context context) {
        ...
        this.f30834OooO0Oo = o0000O0.OooO00o(5.0f);
        this.f30833OooO = 17;
        LayoutInflater.from(getContext()).inflate(oo0o0Oo.layout_tips_bubble, (ViewGroup) this, true);
        View viewFindViewById = findViewById(o0OO00O.tips_bubble_triangle_upward);
        Intrinsics.checkNotNullExpressionValue(viewFindViewById, "findViewById(...)");
        this.f30836OooO0o0 = viewFindViewById;
        View viewFindViewById2 = findViewById(o0OO00O.tips_bubble_triangle_downward);
        Intrinsics.checkNotNullExpressionValue(viewFindViewById2, "findViewById(...)");
        this.f30835OooO0o = viewFindViewById2;
        View viewFindViewById3 = findViewById(o0OO00O.tips_bubble_content);
        Intrinsics.checkNotNullExpressionValue(viewFindViewById3, "findViewById(...)");
        this.f30838OooO0oo = viewFindViewById3;
        View viewFindViewById4 = findViewById(o0OO00O.tv_tips_bubble_content);
        Intrinsics.checkNotNullExpressionValue(viewFindViewById4, "findViewById(...)");
        this.f30837OooO0oO = (TextView) viewFindViewById4;
        View viewFindViewById5 = findViewById(o0OO00O.tv_tips_bubble_ok);
    ...
    public final void OooO00o(boolean z) {
        int i = z ? 0 : 8;
        View view = this.f30835OooO0o;
        view.setVisibility(i);
        int i2 = z ? 8 : 0;
        View view2 = this.f30836OooO0o0;
        view2.setVisibility(i2);
        setVisibility(0);
        if (z) {
            ViewGroup.LayoutParams layoutParams = this.f30838OooO0oo.getLayoutParams();
            Intrinsics.checkNotNull(layoutParams, "null cannot be cast to non-null type android.widget.LinearLayout.LayoutParams");
            ((LinearLayout.LayoutParams) layoutParams).topMargin = 0;
        }
        if (this.f30839OooOO0 == null || this.f30840OooOO0O == null) {
            if (!z) {
                view = view2;
            }
            ...
            getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() { // from class: o0oOoOOO.oO0Oo0o0
                ...
                public final boolean onPreDraw() {
                    ...
                    int i5;
                    int i6;
                    int i7 = TipsBubbleView.f30832OooOOO;
                    TipsBubbleView this$0 = this.f56462OooO0Oo;
                    Intrinsics.checkNotNullParameter(this$0, "this$0");
                    if (this$0.f30841OooOO0o) {
                        return true;
                    }
                    View view3 = this$0.f30835OooO0o;
                    if (view3.getVisibility() == 8) {
                        view3 = this$0.f30836OooO0o0;
                    }
                    int[] iArr = new int[2];
                    int[] iArr2 = new int[2];
                    View view4 = this$0.f30839OooOO0;
                    if (view4 != null) {
                    ...
                    View view5 = this$0.f30839OooOO0;
                    Intrinsics.checkNotNull(view5);
                    int measuredWidth = view5.getMeasuredWidth();
                    View view6 = this$0.f30839OooOO0;
                    ...
                    if (absoluteGravity == 3) {
                        ...
                        if (absoluteGravity != 8388611) {
                            if (absoluteGravity != 8388613) {
                                ...
                                if (zOooO0o0) {
                                    i3 = (measuredWidth / 2) + (((iOooO0OO - iArr[0]) - measuredWidth) - iAbs);
                                    i4 = measuredWidth3 / 2;
                                } else {
    ...
    public final View getTriangleView() {
        View view = this.f30835OooO0o;
        return view.getVisibility() == 8 ? this.f30836OooO0o0 : view;
    }

    @Override // android.view.View.OnClickListener
    public final void onClick(@Nullable View view) {
        OooO00o oooO00o = this.f30842OooOOO0;
        if (oooO00o != null) {
            oooO00o.OooO00o();
        }
    }
