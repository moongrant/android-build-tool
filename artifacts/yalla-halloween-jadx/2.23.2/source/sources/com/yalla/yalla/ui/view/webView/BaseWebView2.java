...
public final class BaseWebView2 extends WebView {
    ...
    public static final /* synthetic */ int f30861OooOO0 = 0;
    ...
    public boolean f30863OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @Nullable
    public Job f30864OooO0o;
    ...
    public static final class OooO00o extends WebChromeClient {
        ...
        public static final class C0346OooO00o extends Lambda implements Function0<Object> {

            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ JsResult f30870OooO0Oo;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C0346OooO00o(JsResult jsResult) {
                super(0);
                this.f30870OooO0Oo = jsResult;
            }

            @Override // kotlin.jvm.functions.Function0
            @Nullable
            public final Object invoke() {
                JsResult jsResult = this.f30870OooO0Oo;
                if (jsResult == null) {
                    return null;
                }
                jsResult.confirm();
        ...
        public final boolean onJsAlert(@Nullable WebView webView, @Nullable String str, @Nullable String str2, @Nullable JsResult jsResult) {
            ...
            o000o.OooOo00(str2);
            o000o.OooOo0(new C0346OooO00o(jsResult));
            o000o.OooO0o(false);
            o000o.OooOO0o();
            return true;
        }
        ...
        public final void onProgressChanged(@Nullable WebView webView, int i) {
            ...
            if (i != 100 || baseWebView2.f30863OooO0Oo) {
                return;
            }
            Job job = baseWebView2.f30864OooO0o;
            if (job != null) {
        ...
        public final void onReceivedTitle(@Nullable WebView webView, @Nullable String str) {
            ...
            BaseWebView2 baseWebView2 = BaseWebView2.this;
            if (baseWebView2.f30863OooO0Oo || (onReceivedTitle = baseWebView2.getOnReceivedTitle()) == null) {
                return;
            }
    ...
    public static final class OooO0O0 extends WebViewClient {
        ...
        public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public int f30872OooO0Oo;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public final /* synthetic */ BaseWebView2 f30873OooO0o0;
            ...
            public static final class C0347OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {

                /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
                public int f30874OooO0Oo;

                /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
                public final /* synthetic */ BaseWebView2 f30875OooO0o0;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C0347OooO00o(BaseWebView2 baseWebView2, Continuation<? super C0347OooO00o> continuation) {
                    super(2, continuation);
                    this.f30875OooO0o0 = baseWebView2;
                }

                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                @NotNull
                public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                    return new C0347OooO00o(this.f30875OooO0o0, continuation);
                }

                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
                    return ((C0347OooO00o) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
                }
                ...
                public final Object invokeSuspend(@NotNull Object obj) {
                    ...
                    int i = this.f30874OooO0Oo;
                    if (i == 0) {
                        ResultKt.throwOnFailure(obj);
                        long timeOut = this.f30875OooO0o0.getTimeOut();
                        this.f30874OooO0Oo = 1;
            ...
            public OooO00o(BaseWebView2 baseWebView2, Continuation<? super OooO00o> continuation) {
                super(2, continuation);
                this.f30873OooO0o0 = baseWebView2;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                return new OooO00o(this.f30873OooO0o0, continuation);
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                int i = this.f30872OooO0Oo;
                BaseWebView2 baseWebView2 = this.f30873OooO0o0;
                if (i == 0) {
                    ResultKt.throwOnFailure(obj);
                    CoroutineDispatcher coroutineDispatcher = Dispatchers.getDefault();
                    C0347OooO00o c0347OooO00o = new C0347OooO00o(baseWebView2, null);
                    this.f30872OooO0Oo = 1;
                    if (BuildersKt.withContext(coroutineDispatcher, c0347OooO00o, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (i != 1) {
        ...
        public static final class C0348OooO0O0 extends Lambda implements Function0<Object> {

            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ SslErrorHandler f30876OooO0Oo;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C0348OooO0O0(SslErrorHandler sslErrorHandler) {
                super(0);
                this.f30876OooO0Oo = sslErrorHandler;
            }

            @Override // kotlin.jvm.functions.Function0
            @Nullable
            public final Object invoke() {
                SslErrorHandler sslErrorHandler = this.f30876OooO0Oo;
        ...
        public static final class OooO0OO extends Lambda implements Function0<Object> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ SslErrorHandler f30877OooO0Oo;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public OooO0OO(SslErrorHandler sslErrorHandler) {
                super(0);
                this.f30877OooO0Oo = sslErrorHandler;
            }

            @Override // kotlin.jvm.functions.Function0
            @Nullable
            public final Object invoke() {
                SslErrorHandler sslErrorHandler = this.f30877OooO0Oo;
                if (sslErrorHandler == null) {
                    return null;
                }
        ...
        public final void onPageStarted(@Nullable WebView webView, @Nullable String str, @Nullable Bitmap bitmap) {
            ...
            BaseWebView2 baseWebView2 = BaseWebView2.this;
            baseWebView2.f30863OooO0Oo = false;
            Job job = baseWebView2.f30864OooO0o;
            if (job != null) {
                Job.DefaultImpls.cancel$default(job, (CancellationException) null, 1, (Object) null);
            }
            baseWebView2.f30864OooO0o = BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), null, null, new OooO00o(baseWebView2, null), 3, null);
        }
        ...
        public final void onReceivedError(@NotNull WebView view, int i, @NotNull String description, @NotNull String failingUrl) {
            ...
            baseWebView2.f30863OooO0Oo = true;
            Job job = baseWebView2.f30864OooO0o;
            if (job != null) {
                Job.DefaultImpls.cancel$default(job, (CancellationException) null, 1, (Object) null);
            }
        ...
        public final void onReceivedSslError(@Nullable WebView webView, @Nullable SslErrorHandler sslErrorHandler, @Nullable SslError sslError) {
            ...
            if (fragmentActivity != null) {
                ...
                o000o.OooO0o(false);
                o000o.OooOo0(new C0348OooO0O0(sslErrorHandler));
        ...
        public final boolean shouldOverrideUrlLoading(@Nullable WebView webView, @Nullable WebResourceRequest webResourceRequest) {
            ...
            if (!StringsKt__StringsKt.contains$default(String.valueOf(webResourceRequest != null ? webResourceRequest.getUrl() : null), "market", false, 2, (Object) null)) {
                if (!StringsKt__StringsKt.contains$default(String.valueOf(webResourceRequest != null ? webResourceRequest.getUrl() : null), "https://play.google.com/store/apps/details?id=", false, 2, (Object) null)) {
                    ...
                    settings.setJavaScriptEnabled(!StringsKt__StringsJVMKt.startsWith$default(url3, "file://", false, 2, null));
    ...
    public static final class OooOO0 implements Observer, FunctionAdapter {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function1 f30878OooO0Oo;

        public OooOO0(OooO function) {
            Intrinsics.checkNotNullParameter(function, "function");
            this.f30878OooO0Oo = function;
        }
        ...
        public final boolean equals(@Nullable Object obj) {
            ...
            return Intrinsics.areEqual(this.f30878OooO0Oo, ((FunctionAdapter) obj).getFunctionDelegate());
        }

        @Override // kotlin.jvm.internal.FunctionAdapter
        @NotNull
        public final Function<?> getFunctionDelegate() {
            return this.f30878OooO0Oo;
        }

        public final int hashCode() {
            return this.f30878OooO0Oo.hashCode();
        }

        @Override // androidx.lifecycle.Observer
        public final /* synthetic */ void onChanged(Object obj) {
            this.f30878OooO0Oo.invoke(obj);
        }
    }
    ...
    public BaseWebView2(@NotNull Context context) {
        ...
        setDownloadListener(new oOO000o());
        OooO0O0();
    }
    ...
    public final void OooO0O0() {
        ...
        if (lifecycleOwner != null) {
            ...
            LiveEventBus.get("H5RefreshAssociationYallaChat", String.class).observe(lifecycleOwner, new o00000O(this, 2));
        }
    }
