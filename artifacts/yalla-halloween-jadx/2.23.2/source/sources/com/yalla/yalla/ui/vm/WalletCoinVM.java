...
public final class WalletCoinVM extends p394o0Oo0.OooOO0 {
    ...
    public static final class OooO extends SuspendLambda implements Function2<LiveDataScope<ApiResult<RechargeMenuModel>>, Continuation<? super Unit>, Object> {
        ...
        public int f30979OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ String f30980OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f30981OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(String str, Continuation<? super OooO> continuation) {
            super(2, continuation);
            this.f30980OooO0o = str;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO oooO = new OooO(this.f30980OooO0o, continuation);
            oooO.f30981OooO0o0 = obj;
            return oooO;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f30979OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                liveDataScope = (LiveDataScope) this.f30981OooO0o0;
                if (oOO0.f57167OooO00o.OooO0OO()) {
                    WalletRepo walletRepo = WalletRepo.f24376OooO00o;
                    this.f30981OooO0o0 = liveDataScope;
                    this.f30979OooO0Oo = 1;
                    walletRepo.getClass();
                    ...
                    this.f30981OooO0o0 = null;
                    this.f30979OooO0Oo = 3;
                    ...
                    this.f30981OooO0o0 = liveDataScope;
                    this.f30979OooO0Oo = 2;
                    obj = walletRepo2.OooOOO0(this.f30980OooO0o, this);
                    if (obj == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    apiResult = (ApiResult) obj;
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<LiveDataScope<ApiResult<RechargeMenuConfirmOrderResultModel>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f30982OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ PayOrder f30983OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f30984OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(PayOrder payOrder, Continuation<? super OooO00o> continuation) {
            super(2, continuation);
            this.f30983OooO0o = payOrder;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO00o oooO00o = new OooO00o(this.f30983OooO0o, continuation);
            oooO00o.f30984OooO0o0 = obj;
            return oooO00o;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            LiveDataScope liveDataScope;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f30982OooO0Oo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f30984OooO0o0;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            liveDataScope = (LiveDataScope) this.f30984OooO0o0;
            WalletRepo walletRepo = WalletRepo.f24376OooO00o;
            this.f30984OooO0o0 = liveDataScope;
            this.f30982OooO0Oo = 1;
            obj = walletRepo.OooO00o(this.f30983OooO0o, this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f30984OooO0o0 = null;
            this.f30982OooO0Oo = 2;
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<LiveDataScope<ApiResult<RechargeMenuCreateOrderResultModel>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ RechargeMenuCreateOrderModel f30986OooO0o;
        ...
        public OooO0O0(RechargeMenuCreateOrderModel rechargeMenuCreateOrderModel, Continuation<? super OooO0O0> continuation) {
            super(2, continuation);
            this.f30986OooO0o = rechargeMenuCreateOrderModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0O0 oooO0O0 = new OooO0O0(this.f30986OooO0o, continuation);
            oooO0O0.f30987OooO0o0 = obj;
            return oooO0O0;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ApiResult apiResult;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            switch (this.f30985OooO0Oo) {
                case 0:
                    ResultKt.throwOnFailure(obj);
                    liveDataScope = (LiveDataScope) this.f30987OooO0o0;
                    RechargeMenuCreateOrderModel rechargeMenuCreateOrderModel = this.f30986OooO0o;
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<LiveDataScope<ApiResult<VipCreateOrderResultModel>>, Continuation<? super Unit>, Object> {
        ...
        public final /* synthetic */ int f30988OooO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f30989OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ boolean f30990OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f30991OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ String f30992OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ double f30993OooO0oo;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public final /* synthetic */ String f30994OooOO0;

        /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
        public final /* synthetic */ String f30995OooOO0O;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(boolean z, String str, double d, int i, String str2, String str3, Continuation<? super OooO0OO> continuation) {
            super(2, continuation);
            this.f30990OooO0o = z;
            this.f30992OooO0oO = str;
            this.f30993OooO0oo = d;
            this.f30988OooO = i;
            this.f30994OooOO0 = str2;
            this.f30995OooOO0O = str3;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0OO oooO0OO = new OooO0OO(this.f30990OooO0o, this.f30992OooO0oO, this.f30993OooO0oo, this.f30988OooO, this.f30994OooOO0, this.f30995OooOO0O, continuation);
            oooO0OO.f30991OooO0o0 = obj;
            return oooO0OO;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            LiveDataScope liveDataScope;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f30989OooO0Oo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f30991OooO0o0;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            ResultKt.throwOnFailure(obj);
            liveDataScope = (LiveDataScope) this.f30991OooO0o0;
            int i2 = !this.f30990OooO0o ? 1 : 0;
            WalletRepo walletRepo = WalletRepo.f24376OooO00o;
            String str = this.f30992OooO0oO;
            double d = this.f30993OooO0oo;
            int i3 = this.f30988OooO;
            String str2 = this.f30994OooOO0;
            String str3 = this.f30995OooOO0O;
            this.f30991OooO0o0 = liveDataScope;
            this.f30989OooO0Oo = 1;
            obj = walletRepo.OooO0oO(i2, str, d, i3, str2, str3, this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f30991OooO0o0 = null;
            this.f30989OooO0Oo = 2;
            if (liveDataScope.emit(obj, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
    ...
    public static final class OooO0o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f30996OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ String f30997OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(String str, Continuation<? super OooO0o> continuation) {
            super(2, continuation);
            this.f30997OooO0o0 = str;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0o(this.f30997OooO0o0, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f30996OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                WalletRepo walletRepo = WalletRepo.f24376OooO00o;
                this.f30996OooO0Oo = 1;
                walletRepo.getClass();
                if (WalletRepo.OooOO0o(this.f30997OooO0o0) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
    ...
    public static final class OooOO0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f30998OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ WalletCoinVM f30999OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ PayOrder f31000OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0(PayOrder payOrder, WalletCoinVM walletCoinVM, Continuation<? super OooOO0> continuation) {
            super(2, continuation);
            this.f31000OooO0o0 = payOrder;
            this.f30999OooO0o = walletCoinVM;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOO0(this.f31000OooO0o0, this.f30999OooO0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f30998OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                WalletRepo walletRepo = WalletRepo.f24376OooO00o;
                PayOrder payOrder = this.f31000OooO0o0;
                String orderId = payOrder.getOrderId();
                String sku = payOrder.getSku();
                String payTypeName = this.f30999OooO0o.getPayTypeName(payOrder.getType());
                this.f30998OooO0Oo = 1;
    ...
    public static final class OooOO0O extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31001OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ WalletCoinVM f31002OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ PayOrder f31003OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0O(PayOrder payOrder, WalletCoinVM walletCoinVM, Continuation<? super OooOO0O> continuation) {
            super(2, continuation);
            this.f31003OooO0o0 = payOrder;
            this.f31002OooO0o = walletCoinVM;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOO0O(this.f31003OooO0o0, this.f31002OooO0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31001OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                WalletRepo walletRepo = WalletRepo.f24376OooO00o;
                PayOrder payOrder = this.f31003OooO0o0;
                String orderId = payOrder.getOrderId();
                String sku = payOrder.getSku();
                String payTypeName = this.f31002OooO0o.getPayTypeName(payOrder.getType());
                int errorCode = payOrder.getErrorCode();
                this.f31001OooO0Oo = 1;
    ...
    public static final class OooOOO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOOO(this.f31006OooO0o0, this.f31005OooO0o, continuation);
        }
    ...
    public static final class OooOOO0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ String f31008OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ Double f31009OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ List<RechargeMenuType> f31010OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO0(Double d, String str, List<RechargeMenuType> list, Continuation<? super OooOOO0> continuation) {
            super(2, continuation);
            this.f31009OooO0o0 = d;
            this.f31008OooO0o = str;
            this.f31010OooO0oO = list;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return WalletCoinVM.this.new OooOOO0(this.f31009OooO0o0, this.f31008OooO0o, this.f31010OooO0oO, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            String str3 = this.f31008OooO0o;
            List<RechargeMenuType> list = this.f31010OooO0oO;
            if (str3 != null) {
                if (string != null) {
                    try {
                        ...
                        if (!z2) {
                            ((AppEventsLogger) lazy.getValue()).logPurchase(BigDecimal.valueOf(o0O0O0Oo.OooOO0(string)), Currency.getInstance("USD"));
                        } else if (list != null) {
            ...
            if (str3 != null) {
                if (str2 != null) {
                    try {
                        ...
                        if (!z) {
                            o0000O00.OooO0O0("GooglePlayPay amount =" + str2 + "===" + o0O0O0Oo.OooOO0(str2) + "===" + str3);
                            HashMap map = new HashMap();
                            map.put(AFInAppEventParameterName.REVENUE, Double.valueOf(o0O0O0Oo.OooOO0(str2)));
                    ...
                    map3.put(AFInAppEventParameterName.REVENUE, Double.valueOf(o0O0O0Oo.OooOO0(str2)));
    ...
    public static final class OooOOOO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31011OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ MutableLiveData<Boolean> f31012OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ PayOrder f31013OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOOO(PayOrder payOrder, MutableLiveData<Boolean> mutableLiveData, Continuation<? super OooOOOO> continuation) {
            super(2, continuation);
            this.f31013OooO0o0 = payOrder;
            this.f31012OooO0o = mutableLiveData;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOOOO(this.f31013OooO0o0, this.f31012OooO0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31011OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                PayOrder payOrder = this.f31013OooO0o0;
                if (payOrder.getType() == PaySupportChannels.pay_type_googlePay.getNum() || payOrder.getType() == PaySupportChannels.pay_type_huaWeiPay.getNum()) {
                    WalletRepo walletRepo = WalletRepo.f24376OooO00o;
                    this.f31011OooO0Oo = 1;
                    walletRepo.getClass();
                    o00Oo0.OooO00o().OooOoO().OooO0O0(payOrder);
            ...
            this.f31012OooO0o.postValue(Boxing.boxBoolean(true));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOo extends SuspendLambda implements Function2<LiveDataScope<ApiResult<List<GoldModel>>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31014OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ String f31015OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f31016OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ String f31017OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOo(String str, String str2, Continuation<? super OooOo> continuation) {
            super(2, continuation);
            this.f31015OooO0o = str;
            this.f31017OooO0oO = str2;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooOo oooOo = new OooOo(this.f31015OooO0o, this.f31017OooO0oO, continuation);
            oooOo.f31016OooO0o0 = obj;
            return oooOo;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            LiveDataScope liveDataScope;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31014OooO0Oo;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f31016OooO0o0;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (i != 2) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            liveDataScope = (LiveDataScope) this.f31016OooO0o0;
            WalletRepo walletRepo = WalletRepo.f24376OooO00o;
            this.f31016OooO0o0 = liveDataScope;
            this.f31014OooO0Oo = 1;
            walletRepo.getClass();
            ...
            o0ooooo.OooO0O0(this.f31015OooO0o, "pageindex");
            o0ooooo.OooO0O0(this.f31017OooO0oO, "type");
            obj = com.code.android.util.OooOOO.OooO0Oo(new WalletRepo$userBill$$inlined$call$1(o0ooooo, null), this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            this.f31016OooO0o0 = null;
            this.f31014OooO0Oo = 2;
            if (liveDataScope.emit(obj, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
    ...
    public static final class OooOo00 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOo00(this.f31019OooO0o0, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31018OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                PayOrder payOrder = this.f31019OooO0o0;
                if (payOrder.getType() == PaySupportChannels.pay_type_googlePay.getNum() || payOrder.getType() == PaySupportChannels.pay_type_huaWeiPay.getNum()) {
                    WalletRepo walletRepo = WalletRepo.f24376OooO00o;
                    this.f31018OooO0Oo = 1;
                    walletRepo.getClass();
    ...
    private final CountryModel getUserCountry() {
        ...
        return com.yalla.yalla.app.golbalData.OooO00o.OooO00o(String.valueOf(o0O00oO0.OooO0OO().getValue()));
    }
