...
@Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0002\b\u0007\b\u0007\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\f\u0010\rJ\u000e\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002R%\u0010\t\u001a\u0010\u0012\f\u0012\n \b*\u0004\u0018\u00010\u00070\u00070\u00068\u0006¢\u0006\f\n\u0004\b\t\u0010\n\u001a\u0004\b\t\u0010\u000b¨\u0006\u000e"}, d2 = {"Lcom/yalla/yalla/ui/vm/account/ProtectionDetailVM;", "Lo0Oo0/OooOO0;", "", "id", "", "deleteUserTrustDevice", "Landroidx/lifecycle/MutableLiveData;", "", "kotlin.jvm.PlatformType", "isOperatingSuccess", "Landroidx/lifecycle/MutableLiveData;", "()Landroidx/lifecycle/MutableLiveData;", "<init>", "()V", "Common_YallaRelease"}, k = 1, mv = {1, 9, 0})
public final class ProtectionDetailVM extends OooOO0 {
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public int f31153OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ ProtectionDetailVM f31154OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ long f31155OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(long j, ProtectionDetailVM protectionDetailVM, Continuation<? super OooO00o> continuation) {
            super(2, continuation);
            this.f31155OooO0o0 = j;
            this.f31154OooO0o = protectionDetailVM;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO00o(this.f31155OooO0o0, this.f31154OooO0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f31153OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                AccountRepo accountRepo = AccountRepo.f22385OooO00o;
                this.f31153OooO0Oo = 1;
                accountRepo.getClass();
                String str = OooOOO0.f43287OooO;
                o0ooOOo o0oooooOooO00o = oo000o.OooO00o(str, "url", str, 0);
                o0oooooOooO00o.OooO0O0(Boxing.boxLong(this.f31155OooO0o0), "id");
                obj = OooOOO.OooO0Oo(new AccountRepo$deleteUserTrustDevice$$inlined$call$1(o0oooooOooO00o, null), this);
            ...
            if (((ApiResult) obj).isSuccess()) {
                this.f31154OooO0o.isOperatingSuccess().postValue(Boxing.boxBoolean(true));
            }
