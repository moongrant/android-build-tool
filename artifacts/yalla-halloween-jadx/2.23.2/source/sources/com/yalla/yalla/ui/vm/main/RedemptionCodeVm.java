...
public final class RedemptionCodeVm extends p394o0Oo0.OooOO0 {
    ...
    @NotNull
    private final oo00oO loadingDialogState = new oo00oO(false);
    ...
    public static final class OooO extends Lambda implements Function0<Unit> {
        ...
        public final Unit invoke() {
            RedemptionCodeVm.this.getLoadingDialogState().f51734OooO00o.setValue(Boolean.FALSE);
            o0000O00.OooO0o("wrm geetinfoCode webViewShow");
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<Integer, Continuation<? super o000Oo0<RedemptionCodeModel>>, Object> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31289OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ int f31290OooO0o0;
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            ...
            oooO0O0.f31290OooO0o0 = ((Number) obj).intValue();
            return oooO0O0;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Integer num, Continuation<? super o000Oo0<RedemptionCodeModel>> continuation) {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f31289OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                int i2 = this.f31290OooO0o0;
                this.f31289OooO0Oo = 1;
                String strOooO0OO = oo000o.OooO0OO("/Webservers/cdkey/List");
                ...
                obj = OooOOO.OooO0Oo(new RedemptionCodeRepo$cdkeyList$$inlined$call$1(o0oooooOooO00o, null), this);
    ...
    public static final class OooO0OO extends Lambda implements Function0<Unit> {
        ...
        public final Unit invoke() {
            RedemptionCodeVm.this.getLoadingDialogState().f51734OooO00o.setValue(Boolean.FALSE);
            o0000O00.OooO0Oo("wrm geetinfoCode callNetFailure");
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0o extends Lambda implements Function0<Unit> {
        ...
        public final Unit invoke() {
            ...
            redemptionCodeVm.getLoadingDialogState().f51734OooO00o.setValue(Boolean.FALSE);
            ...
            if (redemptionCodeVm.getCheckGeetErrorCount() >= redemptionCodeVm.checkGeetErrorCountMax) {
                o000O00.OooO00o(o000000.redemption_error_3014);
            }
            o0000O00.OooO("wrm geetinfoCode checkError");
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0 extends Lambda implements Function1<String, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ Function1<String, Unit> f31294OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public OooOO0(Function1<? super String, Unit> function1) {
            super(1);
            this.f31294OooO0o0 = function1;
        }
        ...
        public final Unit invoke(String str) {
            ...
            Function1<String, Unit> function1 = this.f31294OooO0o0;
            if (function1 != null) {
                function1.invoke(it);
            }
            o0000O00.OooO0O0("wrm geetinfoCode checkSuccess it = " + it);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0O extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public static final class OooO00o extends SuspendLambda implements Function2<ApiError, Continuation<? super Unit>, Object> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public /* synthetic */ Object f31297OooO0Oo;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public final /* synthetic */ RedemptionCodeVm f31298OooO0o0;
            ...
            public static final class C0353OooO00o extends Lambda implements Function1<Integer, Unit> {

                /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
                public final /* synthetic */ ApiError f31299OooO0Oo;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C0353OooO00o(ApiError apiError) {
                    super(1);
                    this.f31299OooO0Oo = apiError;
                }

                @Override // kotlin.jvm.functions.Function1
                public final Unit invoke(Integer num) {
                    num.intValue();
                    ApiError error = this.f31299OooO0Oo;
            ...
            public OooO00o(RedemptionCodeVm redemptionCodeVm, Continuation<? super OooO00o> continuation) {
                super(2, continuation);
                this.f31298OooO0o0 = redemptionCodeVm;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                OooO00o oooO00o = new OooO00o(this.f31298OooO0o0, continuation);
                oooO00o.f31297OooO0Oo = obj;
                return oooO00o;
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                ResultKt.throwOnFailure(obj);
                ApiError apiError = (ApiError) this.f31297OooO0Oo;
                RedemptionCodeVm redemptionCodeVm = this.f31298OooO0o0;
                redemptionCodeVm.getLoadingDialogState().f51734OooO00o.setValue(Boxing.boxBoolean(false));
                ...
                redemptionCodeVm.setGeetCodeErrorDialogContent(redemptionCodeVm.getErrorMessage(new C0353OooO00o(apiError)));
                int code = apiError.getCode();
                if (code == 3014) {
                    ApiError3014 apiError3014 = (ApiError3014) p187o00o00o0.OooO.OooO0O0(ApiError3014.class, redemptionCodeVm.getGeetinfoCodeErrorMessage());
                    redemptionCodeVm.setGeetCodeErrorDialogContent(o0OoOo0.OooOOO(apiError3014 != null ? apiError3014.getMessage() : null, o0000.OooO0OO(o000000.redemption_error_3014)));
                    redemptionCodeVm.getGeetCodeErrorDialogShow().setValue(Boxing.boxBoolean(true));
                } else if (code == 3016) {
                    ApiError3016 apiError3016 = (ApiError3016) p187o00o00o0.OooO.OooO0O0(ApiError3016.class, redemptionCodeVm.getGeetinfoCodeErrorMessage());
                    redemptionCodeVm.setGeetCodeErrorDialogContent(o0OoOo0.OooOOO(apiError3016 != null ? apiError3016.getMessage() : null, o0000.OooO0OO(o000000.redemption_error_3016)));
                    redemptionCodeVm.getGeetCodeErrorDialogShow().setValue(Boxing.boxBoolean(true));
                }
                return Unit.INSTANCE;
            }
        ...
        public static final class OooO0O0 extends SuspendLambda implements Function2<List<RedemptionCodeAwards>, Continuation<? super Unit>, Object> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public /* synthetic */ Object f31300OooO0Oo;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public final /* synthetic */ RedemptionCodeVm f31301OooO0o0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public OooO0O0(RedemptionCodeVm redemptionCodeVm, Continuation<? super OooO0O0> continuation) {
                super(2, continuation);
                this.f31301OooO0o0 = redemptionCodeVm;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                OooO0O0 oooO0O0 = new OooO0O0(this.f31301OooO0o0, continuation);
                oooO0O0.f31300OooO0Oo = obj;
                return oooO0O0;
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                IntrinsicsKt.getCOROUTINE_SUSPENDED();
                ResultKt.throwOnFailure(obj);
                List<RedemptionCodeAwards> list = (List) this.f31300OooO0Oo;
                RedemptionCodeVm redemptionCodeVm = this.f31301OooO0o0;
                redemptionCodeVm.getLoadingDialogState().f51734OooO00o.setValue(Boxing.boxBoolean(false));
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            o0000O00.OooO0O0("wrm toCdKeyExchange\n searchText = " + redemptionCodeVm.getSearchText() + "\n geetinfoCodeText = " + redemptionCodeVm.getGeetinfoCodeText());
            redemptionCodeVm.getLoadingDialogState().f51734OooO00o.setValue(Boxing.boxBoolean(true));
            String searchText = redemptionCodeVm.getSearchText();
            String geetinfoCodeText = redemptionCodeVm.getGeetinfoCodeText();
            this.f31295OooO0Oo = 1;
            String url = oo000o.OooO0OO("/Webservers/cdkey/Exchange");
            Intrinsics.checkNotNullParameter(url, "url");
            o0ooOOo o0ooooo = new o0ooOOo(url, 1);
            o0ooooo.OooO0O0(searchText, "cdk");
            o0ooooo.OooO0O0(geetinfoCodeText, "geetinfo");
            obj = OooOOO.OooO0Oo(new RedemptionCodeRepo$cdKeyExchange$$inlined$call$1(o0ooooo, null), this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            OooO00o oooO00o = new OooO00o(redemptionCodeVm, null);
            OooO0O0 oooO0O0 = new OooO0O0(redemptionCodeVm, null);
            this.f31295OooO0Oo = 2;
            if (o00O0O.OooO0OO((ApiResult) obj, true, null, oooO00o, oooO0O0, this, 2) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
        }
    ...
    public static final class OooOOO0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31302OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ Context f31303OooO0o;

        public static final class OooO00o extends Lambda implements Function1<String, Unit> {

            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ RedemptionCodeVm f31305OooO0Oo;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public OooO00o(RedemptionCodeVm redemptionCodeVm) {
                super(1);
                this.f31305OooO0Oo = redemptionCodeVm;
            }
            ...
            public final Unit invoke(String str) {
                String it = str;
                Intrinsics.checkNotNullParameter(it, "it");
                this.f31305OooO0Oo.toCdKeyExchange();
                return Unit.INSTANCE;
            }
        }
        ...
        public OooOOO0(Context context, Continuation<? super OooOOO0> continuation) {
            super(2, continuation);
            this.f31303OooO0o = context;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return RedemptionCodeVm.this.new OooOOO0(this.f31303OooO0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31302OooO0Oo;
            boolean z = false;
            RedemptionCodeVm redemptionCodeVm = RedemptionCodeVm.this;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                redemptionCodeVm.getLoadingDialogState().f51734OooO00o.setValue(Boxing.boxBoolean(true));
                this.f31302OooO0Oo = 1;
                String strOooO0OO = oo000o.OooO0OO("/Webservers/geet/getCdkInfo");
                obj = OooOOO.OooO0Oo(new RedemptionCodeRepo$getCdkInfo$$inlined$call$1(p391o0OOooo0.oo000o.OooO00o(strOooO0OO, "url", strOooO0OO, 0), null), this);
                if (obj == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
            ...
            redemptionCodeVm.checkGeetinfo(this.f31303OooO0o, o0OoOo0.OooOOO(redemptionCdkInfoModel2 != null ? redemptionCdkInfoModel2.getRedemptionCodeCaptchaId() : null, ""), new OooO00o(redemptionCodeVm));
            return Unit.INSTANCE;
        }
    }

    /* JADX WARN: Enum visitor error
    jadx.core.utils.exceptions.JadxRuntimeException: Can't remove SSA var: r5v2 com.yalla.yalla.ui.vm.main.RedemptionCodeVm$RedemptionCodeState[], still in use, count: 1, list:
      (r5v2 com.yalla.yalla.ui.vm.main.RedemptionCodeVm$RedemptionCodeState[]) from 0x0029: INVOKE (r5v2 com.yalla.yalla.ui.vm.main.RedemptionCodeVm$RedemptionCodeState[]) STATIC call: kotlin.enums.EnumEntriesKt.enumEntries(java.lang.Enum[]):kotlin.enums.EnumEntries A[MD:<E extends java.lang.Enum<E>>:(E extends java.lang.Enum<E>[]):kotlin.enums.EnumEntries<E extends java.lang.Enum<E>> (m), WRAPPED] (LINE:42)
    ...
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0004\b\u0086\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001j\u0002\b\u0002j\u0002\b\u0003j\u0002\b\u0004¨\u0006\u0005"}, d2 = {"Lcom/yalla/yalla/ui/vm/main/RedemptionCodeVm$RedemptionCodeState;", "", "Default", "Success", "Error", "Common_YallaRelease"}, k = 1, mv = {1, 9, 0})
    public static final class RedemptionCodeState {
        ...
        static {
            $ENTRIES = EnumEntriesKt.enumEntries(redemptionCodeStateArr);
        }

        public RedemptionCodeState() {
            super(str, i);
        }

        public static RedemptionCodeState valueOf(String str) {
            return (RedemptionCodeState) Enum.valueOf(RedemptionCodeState.class, str);
        }

        public static RedemptionCodeState[] values() {
            return (RedemptionCodeState[]) $VALUES.clone();
        }
    }
    ...
    public RedemptionCodeVm() {
        ...
        this.cdkeyListPager = new o000<>(ViewModelKt.getViewModelScope(this), new OooO0O0(null));
    ...
    public final void checkGeetinfo(Context context, String redemptionCodeCaptchaId, Function1<? super String, Unit> listener) {
        this.loadingDialogState.f51734OooO00o.setValue(Boolean.TRUE);
        ...
        this.mGTCaptcha4Client = o00Oo0.OooO00o(context, redemptionCodeCaptchaId, new OooO0OO(), new OooO0o(), new OooO(), new OooOO0(listener));
    }
    ...
    @NotNull
    public final o000<RedemptionCodeModel> getCdkeyListPager() {
    ...
    public final String getErrorMessage(@Nullable Function1<? super Integer, Unit> isOtherCodeListener) {
        ...
        if (geetinfoCodeErrorCode == 3015) {
            ApiError3015 apiError3015 = (ApiError3015) p187o00o00o0.OooO.OooO0O0(ApiError3015.class, getGeetinfoCodeErrorMessage());
            return o0OoOo0.OooOOO(apiError3015 != null ? apiError3015.getMessage() : null, o0000.OooO0OO(o000000.redemption_error_3015));
        }
        if (geetinfoCodeErrorCode == 3016) {
            return "";
        }
        if (geetinfoCodeErrorCode == 3017) {
            ApiError3017 apiError3017 = (ApiError3017) p187o00o00o0.OooO.OooO0O0(ApiError3017.class, getGeetinfoCodeErrorMessage());
            return o0OoOo0.OooOOO(apiError3017 != null ? apiError3017.getMessage() : null, o0000.OooO0OO(o000000.redemption_error_3017));
        }
        if (geetinfoCodeErrorCode == 3018) {
            ApiError3018 apiError3018 = (ApiError3018) p187o00o00o0.OooO.OooO0O0(ApiError3018.class, getGeetinfoCodeErrorMessage());
            return o0OoOo0.OooOOO(apiError3018 != null ? apiError3018.getMessage() : null, o0000.OooO0OO(o000000.redemption_error_3018));
        }
        if (geetinfoCodeErrorCode == 3019) {
            ApiError3019 apiError3019 = (ApiError3019) p187o00o00o0.OooO.OooO0O0(ApiError3019.class, getGeetinfoCodeErrorMessage());
            return o0OoOo0.OooOOO(apiError3019 != null ? apiError3019.getMessage() : null, o0000.OooO0OO(o000000.redemption_error_3019));
        }
        if (geetinfoCodeErrorCode == 3020) {
            ApiError3020 apiError3020 = (ApiError3020) p187o00o00o0.OooO.OooO0O0(ApiError3020.class, getGeetinfoCodeErrorMessage());
            return o0OoOo0.OooOOO(apiError3020 != null ? apiError3020.getMessage() : null, o0000.OooO0OO(o000000.redemption_error_3020));
        }
        if (geetinfoCodeErrorCode == this.LocalCodeRedemptionFailed) {
            return o0000.OooO0OO(o000000.redemption_failed);
        }
    ...
    @NotNull
    public final oo00oO getLoadingDialogState() {
