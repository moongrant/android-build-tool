...
@Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\b\u0016\b\u0007\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u001a\u0010\u001bJ\u001a\u0010\u0007\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00060\u00050\u00042\u0006\u0010\u0003\u001a\u00020\u0002J\u001a\u0010\b\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00060\u00050\u00042\u0006\u0010\u0003\u001a\u00020\u0002J\u001a\u0010\t\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00060\u00050\u00042\u0006\u0010\u0003\u001a\u00020\u0002R+\u0010\u0011\u001a\u00020\u00022\u0006\u0010\n\u001a\u00020\u00028F@FX\u0086\u008e\u0002¢\u0006\u0012\n\u0004\b\u000b\u0010\f\u001a\u0004\b\r\u0010\u000e\"\u0004\b\u000f\u0010\u0010R+\u0010\u0015\u001a\u00020\u00022\u0006\u0010\n\u001a\u00020\u00028F@FX\u0086\u008e\u0002¢\u0006\u0012\n\u0004\b\u0012\u0010\f\u001a\u0004\b\u0013\u0010\u000e\"\u0004\b\u0014\u0010\u0010R+\u0010\u0019\u001a\u00020\u00022\u0006\u0010\n\u001a\u00020\u00028F@FX\u0086\u008e\u0002¢\u0006\u0012\n\u0004\b\u0016\u0010\f\u001a\u0004\b\u0017\u0010\u000e\"\u0004\b\u0018\u0010\u0010¨\u0006\u001c"}, d2 = {"Lcom/yalla/yalla/ui/vm/main/VipSettingVM;", "Lo0Oo0/OooOO0;", "", "check", "Lo0OoO0Oo/o00OO0O0;", "Lcom/yalla/yalla/model/http/ApiResult;", "", "changeVipShowState", "changeShowPremiumFirst", "changeInvisibleVisitor", "<set-?>", "hideVip$delegate", "Landroidx/compose/runtime/MutableState;", "getHideVip", "()Z", "setHideVip", "(Z)V", "hideVip", "showPremiumFirst$delegate", "getShowPremiumFirst", "setShowPremiumFirst", "showPremiumFirst", "invisibleVisitor$delegate", "getInvisibleVisitor", "setInvisibleVisitor", "invisibleVisitor", "<init>", "()V", "Common_YallaRelease"}, k = 1, mv = {1, 9, 0})
@SourceDebugExtension({"SMAP\nVipSettingVM.kt\nKotlin\n*S Kotlin\n*F\n+ 1 VipSettingVM.kt\ncom/yalla/yalla/ui/vm/main/VipSettingVM\n+ 2 SnapshotState.kt\nandroidx/compose/runtime/SnapshotStateKt__SnapshotStateKt\n*L\n1#1,55:1\n81#2:56\n107#2,2:57\n81#2:59\n107#2,2:60\n81#2:62\n107#2,2:63\n*S KotlinDebug\n*F\n+ 1 VipSettingVM.kt\ncom/yalla/yalla/ui/vm/main/VipSettingVM\n*L\n16#1:56\n16#1:57,2\n17#1:59\n17#1:60,2\n18#1:62\n18#1:63,2\n*E\n"})
public final class VipSettingVM extends OooOO0 {
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<o00OO0O0<ApiResult<String>>, Continuation<? super Unit>, Object> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31348OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ boolean f31349OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f31350OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ VipSettingVM f31351OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(boolean z, VipSettingVM vipSettingVM, Continuation<? super OooO00o> continuation) {
            super(2, continuation);
            this.f31349OooO0o = z;
            this.f31351OooO0oO = vipSettingVM;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO00o oooO00o = new OooO00o(this.f31349OooO0o, this.f31351OooO0oO, continuation);
            oooO00o.f31350OooO0o0 = obj;
            return oooO00o;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f31348OooO0Oo;
            boolean z = this.f31349OooO0o;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                o00OO0O0 o00oo0o2 = (o00OO0O0) this.f31350OooO0o0;
                this.f31350OooO0o0 = o00oo0o2;
                this.f31348OooO0Oo = 1;
                String strOooO0OO = oo000o.OooO0OO("/Webservers/User/ChangeKAVIPStealthVisit?");
                o0ooOOo o0oooooOooO00o = p391o0OOooo0.oo000o.OooO00o(strOooO0OO, "url", strOooO0OO, 1);
                o0oooooOooO00o.OooO0O0(Boxing.boxInt(z ? 1 : 0), "changeType");
                Object objOooO0Oo = OooOOO.OooO0Oo(new VipRepo$changeVIPStealthVisit$$inlined$call$1(o0oooooOooO00o, null), this);
                ...
                o00oo0o1 = (o00OO0O0) this.f31350OooO0o0;
                ResultKt.throwOnFailure(obj);
            }
            ApiResult apiResult = (ApiResult) obj;
            boolean zIsSuccess = apiResult.isSuccess();
            VipSettingVM vipSettingVM = this.f31351OooO0oO;
            if (zIsSuccess) {
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<o00OO0O0<ApiResult<String>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31352OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ boolean f31353OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f31354OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ VipSettingVM f31355OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(boolean z, VipSettingVM vipSettingVM, Continuation<? super OooO0O0> continuation) {
            super(2, continuation);
            this.f31353OooO0o = z;
            this.f31355OooO0oO = vipSettingVM;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0O0 oooO0O0 = new OooO0O0(this.f31353OooO0o, this.f31355OooO0oO, continuation);
            oooO0O0.f31354OooO0o0 = obj;
            return oooO0O0;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            o00OO0O0 o00oo0o1;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31352OooO0Oo;
            boolean z = this.f31353OooO0o;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                o00OO0O0 o00oo0o2 = (o00OO0O0) this.f31354OooO0o0;
                this.f31354OooO0o0 = o00oo0o2;
                this.f31352OooO0Oo = 1;
                String strOooO0OO = oo000o.OooO0OO("/Webservers/User/ChangePremiumFirstState");
                o0ooOOo o0oooooOooO00o = p391o0OOooo0.oo000o.OooO00o(strOooO0OO, "url", strOooO0OO, 1);
                o0oooooOooO00o.OooO0O0(Boxing.boxInt(z ? 1 : 0), "changeType");
                Object objOooO0Oo = OooOOO.OooO0Oo(new VipRepo$changeShowPremiumFirst$$inlined$call$1(o0oooooOooO00o, null), this);
                if (objOooO0Oo == coroutine_suspended) {
                    return coroutine_suspended;
                }
                o00oo0o1 = o00oo0o2;
                ...
                o00oo0o1 = (o00OO0O0) this.f31354OooO0o0;
                ResultKt.throwOnFailure(obj);
            }
            ApiResult apiResult = (ApiResult) obj;
            boolean zIsSuccess = apiResult.isSuccess();
            VipSettingVM vipSettingVM = this.f31355OooO0oO;
            if (zIsSuccess) {
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<o00OO0O0<ApiResult<String>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31356OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ boolean f31357OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f31358OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ VipSettingVM f31359OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(boolean z, VipSettingVM vipSettingVM, Continuation<? super OooO0OO> continuation) {
            super(2, continuation);
            this.f31357OooO0o = z;
            this.f31359OooO0oO = vipSettingVM;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0OO oooO0OO = new OooO0OO(this.f31357OooO0o, this.f31359OooO0oO, continuation);
            oooO0OO.f31358OooO0o0 = obj;
            return oooO0OO;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            o00OO0O0 o00oo0o1;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31356OooO0Oo;
            boolean z = this.f31357OooO0o;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                o00OO0O0 o00oo0o2 = (o00OO0O0) this.f31358OooO0o0;
                int i2 = !z ? 1 : 0;
                this.f31358OooO0o0 = o00oo0o2;
                this.f31356OooO0Oo = 1;
                String strOooO0OO = oo000o.OooO0OO("/Webservers/User/ChangeKAVIPShowState");
                o0ooOOo o0oooooOooO00o = p391o0OOooo0.oo000o.OooO00o(strOooO0OO, "url", strOooO0OO, 1);
                o0oooooOooO00o.OooO0O0(Boxing.boxInt(i2), "changeType");
                Object objOooO0Oo = OooOOO.OooO0Oo(new VipRepo$changeKaVipShowState$$inlined$call$1(o0oooooOooO00o, null), this);
                if (objOooO0Oo == coroutine_suspended) {
                    return coroutine_suspended;
                }
                o00oo0o1 = o00oo0o2;
                ...
                o00oo0o1 = (o00OO0O0) this.f31358OooO0o0;
                ResultKt.throwOnFailure(obj);
            }
            ApiResult apiResult = (ApiResult) obj;
            boolean zIsSuccess = apiResult.isSuccess();
            VipSettingVM vipSettingVM = this.f31359OooO0oO;
            if (zIsSuccess) {
                ...
                o0O00oO0.OooOO0().postValue(new Pair(Boxing.boxInt(value), Boxing.boxInt(pair != null ? ((Number) pair.getSecond()).intValue() : VipLevel.Vip0.getValue())));
            } else {
                vipSettingVM.setHideVip(!z);
            }
            o00oo0o1.postValue(apiResult);
    ...
    @NotNull
    public final o00OO0O0<ApiResult<String>> changeInvisibleVisitor(boolean check) {
        return o00O.OooO00o(this, new OooO00o(check, this, null));
    }

    @NotNull
    public final o00OO0O0<ApiResult<String>> changeShowPremiumFirst(boolean check) {
        return o00O.OooO00o(this, new OooO0O0(check, this, null));
    }

    @NotNull
    public final o00OO0O0<ApiResult<String>> changeVipShowState(boolean check) {
        return o00O.OooO00o(this, new OooO0OO(check, this, null));
    }
