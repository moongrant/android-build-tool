...
public class BaseMomentVM extends p394o0Oo0.OooOO0 {
    ...
    public static final class OooO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public int f31592OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ BaseMomentVM f31593OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MomentSendModel f31594OooO0o0;

        public static final class OooO00o extends Lambda implements Function1<MomentDetailModel, Boolean> {

            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ MomentSendModel f31595OooO0Oo;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public OooO00o(MomentSendModel momentSendModel) {
                super(1);
                this.f31595OooO0Oo = momentSendModel;
            }
            ...
            public final Boolean invoke(MomentDetailModel momentDetailModel) {
                ...
                return Boolean.valueOf(sendPostModel != null && sendPostModel.getTaskId() == this.f31595OooO0Oo.getTaskId());
            }
        }
        ...
        public static final class OooO0O0 extends SuspendLambda implements Function2<MomentDetailModel, Continuation<? super Unit>, Object> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public /* synthetic */ Object f31596OooO0Oo;

            /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
            public final /* synthetic */ BaseMomentVM f31597OooO0o;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public final /* synthetic */ MomentSendModel f31598OooO0o0;

            public static final class OooO00o extends Lambda implements Function1<MomentDetailModel, Boolean> {

                /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
                public final /* synthetic */ MomentDetailModel f31599OooO0Oo;

                /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
                public final /* synthetic */ MomentSendModel f31600OooO0o0;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public OooO00o(MomentDetailModel momentDetailModel, MomentSendModel momentSendModel) {
                    super(1);
                    this.f31599OooO0Oo = momentDetailModel;
                    this.f31600OooO0o0 = momentSendModel;
                }
                ...
                public final Boolean invoke(MomentDetailModel momentDetailModel) {
                    ...
                    long id = it.getId();
                    boolean z = true;
                    MomentDetailModel momentDetailModel2 = this.f31599OooO0Oo;
                    if (id == 0 || it.getId() != momentDetailModel2.getId()) {
                        MomentSendModel sendPostModel = momentDetailModel2.getSendPostModel();
                        if (!(sendPostModel != null && sendPostModel.getTaskId() == this.f31600OooO0o0.getTaskId())) {
                            z = false;
                        }
                    }
                    if (z) {
            ...
            public OooO0O0(MomentSendModel momentSendModel, BaseMomentVM baseMomentVM, Continuation<? super OooO0O0> continuation) {
                ...
                this.f31598OooO0o0 = momentSendModel;
                this.f31597OooO0o = baseMomentVM;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                OooO0O0 oooO0O0 = new OooO0O0(this.f31598OooO0o0, this.f31597OooO0o, continuation);
                oooO0O0.f31596OooO0Oo = obj;
                return oooO0O0;
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                MomentDetailModel momentDetailModel = (MomentDetailModel) this.f31596OooO0Oo;
                if (momentDetailModel == null) {
                    return Unit.INSTANCE;
                }
                o0000O00.OooO0O0("WRM momentDetail itemData = ".concat(p187o00o00o0.OooO.OooO00o(momentDetailModel)));
                MomentSendModel momentSendModel = this.f31598OooO0o0;
                if (momentSendModel.getPower() != MomentTypePower.Self.getValue()) {
                    BaseMomentVM baseMomentVM = this.f31597OooO0o;
                    ...
                    if (i == 0) {
                        ...
                        o0000OO0.OooO0O0(momentSendModel);
        ...
        public OooO(MomentSendModel momentSendModel, BaseMomentVM baseMomentVM, Continuation<? super OooO> continuation) {
            super(2, continuation);
            this.f31594OooO0o0 = momentSendModel;
            this.f31593OooO0o = baseMomentVM;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO(this.f31594OooO0o0, this.f31593OooO0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f31592OooO0Oo;
            BaseMomentVM baseMomentVM = this.f31593OooO0o;
            MomentSendModel momentSendModel = this.f31594OooO0o0;
            if (i != 0) {
                if (i == 1) {
                    ResultKt.throwOnFailure(obj);
                } else {
            ...
            this.f31592OooO0Oo = 2;
            if (o00O0O.OooO0OO((ApiResult) obj, false, null, null, oooO0O0, this, 7) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
        }
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<FlowCollector<? super ApiResult<Object>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public ApiResult f31601OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public /* synthetic */ Object f31602OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public int f31603OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ String f31604OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ String f31605OooO0oo;
        ...
        public static final class C0354OooO00o extends SuspendLambda implements Function2<Object, Continuation<? super Unit>, Object> {
            public C0354OooO00o(Continuation<? super C0354OooO00o> continuation) {
                super(2, continuation);
            }
            ...
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                return new C0354OooO00o(continuation);
            }

            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Continuation<? super Unit> continuation) {
                return new C0354OooO00o(continuation).invokeSuspend(Unit.INSTANCE);
            }
        ...
        public OooO00o(String str, String str2, Continuation<? super OooO00o> continuation) {
            super(2, continuation);
            this.f31604OooO0oO = str;
            this.f31605OooO0oo = str2;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO00o oooO00o = new OooO00o(this.f31604OooO0oO, this.f31605OooO0oo, continuation);
            oooO00o.f31602OooO0o = obj;
            return oooO00o;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ApiResult apiResult;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31603OooO0o0;
            if (i != 0) {
                if (i == 1) {
                    flowCollector = (FlowCollector) this.f31602OooO0o;
                    ResultKt.throwOnFailure(obj);
                } else if (i == 2) {
                    apiResult = this.f31601OooO0Oo;
                    flowCollector2 = (FlowCollector) this.f31602OooO0o;
                    ResultKt.throwOnFailure(obj);
                    this.f31602OooO0o = null;
                    this.f31601OooO0Oo = null;
                    this.f31603OooO0o0 = 3;
            ...
            ResultKt.throwOnFailure(obj);
            FlowCollector flowCollector3 = (FlowCollector) this.f31602OooO0o;
            this.f31602OooO0o = flowCollector3;
            this.f31603OooO0o0 = 1;
            String strOooO0Oo = oo000o.OooO0Oo("/Webservers/Comment/Del");
            o0ooOOo o0oooooOooO00o = p391o0OOooo0.oo000o.OooO00o(strOooO0Oo, "url", strOooO0Oo, 0);
            o0oooooOooO00o.OooO0O0(this.f31604OooO0oO, "dyid");
            o0oooooOooO00o.OooO0O0(this.f31605OooO0oo, "cid");
            Object objOooO0Oo = OooOOO.OooO0Oo(new MomentRepository$deleteCommentOrReply$$inlined$call$1(o0oooooOooO00o, null), this);
            ...
            C0354OooO00o c0354OooO00o = new C0354OooO00o(null);
            this.f31602OooO0o = flowCollector;
            this.f31601OooO0Oo = apiResult2;
            this.f31603OooO0o0 = 2;
            if (o00O0O.OooO0OO(apiResult2, false, null, null, c0354OooO00o, this, 7) == coroutine_suspended) {
                return coroutine_suspended;
            }
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function0<Unit> f31606OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(Function0<Unit> function0, Continuation<? super OooO0O0> continuation) {
            super(2, continuation);
            this.f31606OooO0Oo = function0;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0O0(this.f31606OooO0Oo, continuation);
        }
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MomentDetailModel f31608OooO0o0;
        ...
        public static final class OooO00o extends SuspendLambda implements Function2<Object, Continuation<? super Unit>, Object> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ MomentDetailModel f31609OooO0Oo;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public OooO00o(MomentDetailModel momentDetailModel, Continuation<? super OooO00o> continuation) {
                super(2, continuation);
                this.f31609OooO0Oo = momentDetailModel;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                return new OooO00o(this.f31609OooO0Oo, continuation);
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                MomentDetailModel momentDetailModel = this.f31609OooO0Oo;
                if (momentDetailModel.isFollow()) {
                    ...
                    o000O00.OooO0O0(o0000.OooO0OO(o000000.post_list_follow_succeed));
                }
                oooOOO.f55760OooO0OO = o0OoOo0.OooOOO0("", Boxing.boxLong(momentDetailModel.getUserId()));
                OooOo00.OooO00o().OooO0Oo(oooOOO);
                return Unit.INSTANCE;
            }
        }
        ...
        public OooO0OO(MomentDetailModel momentDetailModel, Continuation<? super OooO0OO> continuation) {
            super(2, continuation);
            this.f31608OooO0o0 = momentDetailModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0OO(this.f31608OooO0o0, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            MomentDetailModel momentDetailModel = this.f31608OooO0o0;
            if (i != 0) {
                if (i == 1) {
                    ResultKt.throwOnFailure(obj);
                } else {
            ...
            String strOooO00o = androidx.compose.foundation.layout.oo000o.OooO00o(momentDetailModel.isFollow() ? 1 : 0);
            this.f31607OooO0Oo = 1;
            String url = oo000o.OooO0OO(Oooo0.f43432o00Ooo);
            Intrinsics.checkNotNullParameter(url, "url");
            o0ooOOo o0ooooo = new o0ooOOo(url, 0);
            o0ooooo.OooO0O0(strValueOf, "fuserid");
            o0ooooo.OooO0O0(strOooO00o, "type");
            obj = OooOOO.OooO0Oo(new MomentRepository$focusCtl$$inlined$call$1(o0ooooo, null), this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            OooO00o oooO00o = new OooO00o(momentDetailModel, null);
            this.f31607OooO0Oo = 2;
    ...
    public static final class OooO0o extends Lambda implements Function1<MomentDetailModel, Boolean> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ long f31610OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(long j) {
            super(1);
            this.f31610OooO0Oo = j;
        }
        ...
        public final Boolean invoke(MomentDetailModel momentDetailModel) {
            MomentDetailModel it = momentDetailModel;
            Intrinsics.checkNotNullParameter(it, "it");
            return Boolean.valueOf(it.getId() == this.f31610OooO0Oo);
        }
    }
    ...
    public static final class OooOO0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31611OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ Function1<MomentCommentResultModel, Unit> f31612OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MomentSendCommentModel f31613OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ BaseMomentVM f31614OooO0oO;
        ...
        public static final class OooO00o extends SuspendLambda implements Function2<MomentCommentResultModel, Continuation<? super Unit>, Object> {
            ...
            public /* synthetic */ Object f31615OooO;

            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public Function1 f31616OooO0Oo;

            /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
            public MomentSendCommentModel f31617OooO0o;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public BaseMomentVM f31618OooO0o0;

            /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
            public MomentCommentResultModel f31619OooO0oO;

            /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
            public int f31620OooO0oo;

            /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
            public final /* synthetic */ Function1<MomentCommentResultModel, Unit> f31621OooOO0;

            /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
            public final /* synthetic */ BaseMomentVM f31622OooOO0O;

            /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
            public final /* synthetic */ MomentSendCommentModel f31623OooOO0o;
            ...
            public static final class C0355OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                public final Object invokeSuspend(@NotNull Object obj) {
                    IntrinsicsKt.getCOROUTINE_SUSPENDED();
                    ResultKt.throwOnFailure(obj);
                    o000O00.OooO0O0(o0000.OooO0OO(o000000.Comment_successfully));
                    return Unit.INSTANCE;
                }
            }
            ...
            public OooO00o(MomentSendCommentModel momentSendCommentModel, BaseMomentVM baseMomentVM, Continuation continuation, Function1 function1) {
                super(2, continuation);
                this.f31621OooOO0 = function1;
                this.f31622OooOO0O = baseMomentVM;
                this.f31623OooOO0o = momentSendCommentModel;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                OooO00o oooO00o = new OooO00o(this.f31623OooOO0o, this.f31622OooOO0O, continuation, this.f31621OooOO0);
                oooO00o.f31615OooO = obj;
                return oooO00o;
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                int i = this.f31620OooO0oo;
                MomentDetailModel momentDetailModel = null;
                if (i == 0) {
                    ResultKt.throwOnFailure(obj);
                    MomentCommentResultModel momentCommentResultModel3 = (MomentCommentResultModel) this.f31615OooO;
                    if (momentCommentResultModel3 != null) {
                        C0355OooO00o c0355OooO00o = new C0355OooO00o(null);
                        this.f31615OooO = momentCommentResultModel3;
                        function1 = this.f31621OooOO0;
                        this.f31616OooO0Oo = function1;
                        baseMomentVM = this.f31622OooOO0O;
                        this.f31618OooO0o0 = baseMomentVM;
                        MomentSendCommentModel momentSendCommentModel2 = this.f31623OooOO0o;
                        this.f31617OooO0o = momentSendCommentModel2;
                        this.f31619OooO0oO = momentCommentResultModel3;
                        this.f31620OooO0oo = 1;
                        if (OooOOO.OooO0o0(c0355OooO00o, this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                ...
                momentCommentResultModel = this.f31619OooO0oO;
                momentSendCommentModel = this.f31617OooO0o;
                baseMomentVM = this.f31618OooO0o0;
                function1 = this.f31616OooO0Oo;
                momentCommentResultModel2 = (MomentCommentResultModel) this.f31615OooO;
                ResultKt.throwOnFailure(obj);
                if (function1 != null) {
                ...
                o0oo0000.OooO00o.OooO0OO("106056", MapsKt.mapOf(TuplesKt.to("discovery_id", momentSendCommentModel.getDyid()), TuplesKt.to("video_id", momentSendCommentModel.getLocalSourcesId()), TuplesKt.to("rec_sessionid", momentSendCommentModel.getLocalSessionId())));
                return Unit.INSTANCE;
            }
        }
        ...
        public OooOO0(MomentSendCommentModel momentSendCommentModel, BaseMomentVM baseMomentVM, Continuation continuation, Function1 function1) {
            super(2, continuation);
            this.f31613OooO0o0 = momentSendCommentModel;
            this.f31612OooO0o = function1;
            this.f31614OooO0oO = baseMomentVM;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            Function1<MomentCommentResultModel, Unit> function1 = this.f31612OooO0o;
            return new OooOO0(this.f31613OooO0o0, this.f31614OooO0oO, continuation, function1);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31611OooO0Oo;
            MomentSendCommentModel momentSendCommentModel = this.f31613OooO0o0;
            boolean z = true;
            if (i != 0) {
                if (i == 1) {
                    ResultKt.throwOnFailure(obj);
            ...
            ResultKt.throwOnFailure(obj);
            o0000O00.OooO0O0("WRM 添加 sendCommentOrReplyApi \nmodel = ".concat(p187o00o00o0.OooO.OooO00o(momentSendCommentModel)));
            this.f31611OooO0Oo = 1;
            ...
            o0oooooOooO00o.OooO0O0(momentSendCommentModel.getDyid(), "dyid");
            String cid = momentSendCommentModel.getCid();
            if (!(cid == null || cid.length() == 0)) {
                o0oooooOooO00o.OooO0O0(momentSendCommentModel.getCid(), "cid");
            }
            ...
            if (!(parentUserId == null || parentUserId.length() == 0)) {
                ...
                if (!z) {
                    o0oooooOooO00o.OooO0O0(momentSendCommentModel.getParentUserId(), "parentUserId");
                    o0oooooOooO00o.OooO0O0(oOO0OOO.OooO0O0(momentSendCommentModel.getParentUserName()), "parentUserName");
                }
            }
            if (!oo0o0Oo.OooO0o()) {
                o0oooooOooO00o.OooO0O0(p187o00o00o0.OooO.OooO00o(momentSendCommentModel.getContent()), "content");
                o0000O00.OooO0O0("WRM sendCommentOrReply apiParams = ".concat(p187o00o00o0.OooO.OooO00o(o0oooooOooO00o)));
            }
            o0oooooOooO00o.OooO0O0(oOO0OOO.OooO0O0(p187o00o00o0.OooO.OooO00o(momentSendCommentModel.getContent())), "content");
            obj = OooOOO.OooO0Oo(new MomentRepository$sendCommentOrReply$$inlined$call$1(o0oooooOooO00o, null), this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            ApiResult apiResult = (ApiResult) obj;
            OooO00o oooO00o = new OooO00o(momentSendCommentModel, this.f31614OooO0oO, null, this.f31612OooO0o);
            this.f31611OooO0Oo = 2;
    ...
    public static final class OooOO0O extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31624OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ BaseMomentVM f31625OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ long f31626OooO0o0;
        ...
        public static final class OooO00o extends SuspendLambda implements Function2<MomentDetailModel, Continuation<? super Unit>, Object> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public /* synthetic */ Object f31627OooO0Oo;

            /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
            public final /* synthetic */ long f31628OooO0o;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public final /* synthetic */ BaseMomentVM f31629OooO0o0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public OooO00o(long j, BaseMomentVM baseMomentVM, Continuation continuation) {
                super(2, continuation);
                this.f31629OooO0o0 = baseMomentVM;
                this.f31628OooO0o = j;
            }
            ...
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                OooO00o oooO00o = new OooO00o(this.f31628OooO0o, this.f31629OooO0o0, continuation);
                oooO00o.f31627OooO0Oo = obj;
                return oooO00o;
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                IntrinsicsKt.getCOROUTINE_SUSPENDED();
                ResultKt.throwOnFailure(obj);
                MomentDetailModel momentDetailModel = (MomentDetailModel) this.f31627OooO0Oo;
                if (momentDetailModel == null) {
                    return Unit.INSTANCE;
                }
                BaseMomentVM baseMomentVM = this.f31629OooO0o0;
                ...
                while (true) {
                    ...
                    if (it.next().getId() == this.f31628OooO0o) {
                        break;
                    }
                    i++;
                }
        ...
        public OooOO0O(long j, BaseMomentVM baseMomentVM, Continuation<? super OooOO0O> continuation) {
            super(2, continuation);
            this.f31626OooO0o0 = j;
            this.f31625OooO0o = baseMomentVM;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOO0O(this.f31626OooO0o0, this.f31625OooO0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31624OooO0Oo;
            long j = this.f31626OooO0o0;
            if (i != 0) {
                if (i == 1) {
                    ResultKt.throwOnFailure(obj);
                } else {
            ...
            ApiResult apiResult = (ApiResult) obj;
            OooO00o oooO00o = new OooO00o(j, this.f31625OooO0o, null);
            this.f31624OooO0Oo = 2;
            if (o00O0O.OooO0OO(apiResult, false, null, null, oooO00o, this, 7) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
    ...
    public BaseMomentVM() {
        com.yalla.yalla.mixedroom.OooO0O0 oooO0O0 = new com.yalla.yalla.mixedroom.OooO0O0(this, 3);
        this.hidePostObserver = oooO0O0;
        LiveEventBus.get("MOMENT_HIDE_POST", Long.TYPE).observeForever(oooO0O0);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void hidePostObserver$lambda$0(BaseMomentVM this$0, long j) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        if (this$0.supportHidePost) {
            CollectionsKt.removeAll((List) this$0.listData, (Function1) new OooO0o(j));
            return;
        }
        Function1<Long, Unit> hidePostListener = this$0.getHidePostListener();
        if (hidePostListener != null) {
            hidePostListener.invoke(Long.valueOf(j));
        }
    }
    ...
    public final void reportCommentOrReply(long dyId, long commentIdOrReplyId) {
        o00O00.OooO0o0(ReportScreen.INSTANCE, ReportScreen.bundleOf(5, commentIdOrReplyId, (244 & 4) != 0 ? null : null, (244 & 8) != 0 ? null : Long.valueOf(dyId), (244 & 16) != 0 ? null : null, (244 & 32) != 0 ? null : null, (244 & 64) != 0 ? null : null, (244 & 128) != 0 ? null : null), false, null, 12);
    }
        ...
        for (int i = 0; i < this.listData.size(); i++) {
            ...
            if (type == MomentType.Poll.getValue()) {
                if (momentDetailModel.getId() == result.getId()) {
                    o0000O00.OooO0o("POST_DETAIL_POLL_DATA_REFRESH FollowingFragment i= " + i + "\nresult = " + result);
