...
public final class MomentReplyVM extends BaseMomentDetailVM {
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<Integer, Continuation<? super o000Oo0<MomentReplyModel>>, Object> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public long f31723OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f31724OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public long f31725OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public /* synthetic */ int f31726OooO0oO;
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            ...
            oooO00o.f31726OooO0oO = ((Number) obj).intValue();
            return oooO00o;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Integer num, Continuation<? super o000Oo0<MomentReplyModel>> continuation) {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                ...
                this.f31723OooO0Oo = jOooOO0;
                this.f31725OooO0o0 = jOooOO1;
                this.f31724OooO0o = 1;
                j = jOooOO1;
                ...
                long j3 = this.f31725OooO0o0;
                j2 = this.f31723OooO0Oo;
                ResultKt.throwOnFailure(obj);
                j = j3;
                objOooO0O0 = obj;
            }
    ...
    public final void addReply(@NotNull MomentReplyModel data) {
        ...
        if (currentMomentDetail != null && currentMomentDetail.getId() == data.getLocalMomentId()) {
            ...
            if (currentCommentId != null && currentCommentId.longValue() == localCommentId) {
                o000<MomentReplyModel> replyPagerState = getReplyPagerState();
                if ((replyPagerState == null || (list3 = replyPagerState.f38497OooO0Oo) == null || !list3.isEmpty()) ? false : true) {
                    o000<MomentReplyModel> replyPagerState2 = getReplyPagerState();
                    if (replyPagerState2 != null && (list2 = replyPagerState2.f38497OooO0Oo) != null) {
                        list2.add(data);
                    }
                } else {
                    o000<MomentReplyModel> replyPagerState3 = getReplyPagerState();
                    if (replyPagerState3 != null && (list = replyPagerState3.f38497OooO0Oo) != null) {
                        list.add(0, data);
                    }
                }
                o000<MomentReplyModel> replyPagerState4 = getReplyPagerState();
    ...
    public final void getReplays() {
        setReplyPagerState(new o000<>(ViewModelKt.getViewModelScope(this), new OooO00o(null)));
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Nullable
    public final o000<MomentReplyModel> getReplyPagerState() {
        return (o000) this.replyPagerState.getValue();
    }
    ...
    public final void setReplyPagerState(@Nullable o000<MomentReplyModel> o000Var) {
        this.replyPagerState.setValue(o000Var);
    }
