...
public final class MomentVideoVM extends BaseMomentDetailVM {
    ...
    @NotNull
    private final Map<Integer, Boolean> downLoadingMap;
    ...
    @DebugMetadata(c = "com.yalla.yalla.ui.vm.moment.MomentVideoVM$userFollow$1", f = "MomentVideoVM.kt", i = {0, 1, 1}, l = {268, 269, 277}, m = "invokeSuspend", n = {"$this$sharedFlow", "$this$sharedFlow", ReportItem.QualityKeyResult}, s = {"L$0", "L$0", "L$1"})
    public static final class OooO extends SuspendLambda implements Function2<FlowCollector<? super ApiResult<Boolean>>, Continuation<? super Unit>, Object> {
        ...
        public ApiResult f31772OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public /* synthetic */ Object f31773OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public int f31774OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ MomentDetailModel f31775OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f31776OooO0oo;
        ...
        public static final class OooO00o extends SuspendLambda implements Function2<Boolean, Continuation<? super Unit>, Object> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ MomentVideoVM f31777OooO0Oo;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public final /* synthetic */ MomentDetailModel f31778OooO0o0;
            ...
            public OooO00o(MomentDetailModel momentDetailModel, MomentVideoVM momentVideoVM, Continuation continuation) {
                ...
                this.f31777OooO0Oo = momentVideoVM;
                this.f31778OooO0o0 = momentDetailModel;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                return new OooO00o(this.f31778OooO0o0, this.f31777OooO0Oo, continuation);
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                Iterator<MomentDetailModel> it = this.f31777OooO0Oo.getListData().iterator();
                while (true) {
                    boolean zHasNext = it.hasNext();
                    MomentDetailModel momentDetailModel = this.f31778OooO0o0;
                    if (!zHasNext) {
        ...
        public OooO(MomentDetailModel momentDetailModel, MomentVideoVM momentVideoVM, Continuation<? super OooO> continuation) {
            super(2, continuation);
            this.f31775OooO0oO = momentDetailModel;
            this.f31776OooO0oo = momentVideoVM;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO oooO = new OooO(this.f31775OooO0oO, this.f31776OooO0oo, continuation);
            oooO.f31773OooO0o = obj;
            return oooO;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f31774OooO0o0;
            MomentDetailModel momentDetailModel = this.f31775OooO0oO;
            if (i != 0) {
                if (i == 1) {
                    flowCollector = (FlowCollector) this.f31773OooO0o;
                    ResultKt.throwOnFailure(obj);
                    objOooO0OO = obj;
                } else if (i == 2) {
                    apiResult = this.f31772OooO0Oo;
                    flowCollector2 = (FlowCollector) this.f31773OooO0o;
                    ResultKt.throwOnFailure(obj);
                    this.f31773OooO0o = null;
                    this.f31772OooO0Oo = null;
                    this.f31774OooO0o0 = 3;
            ...
            this.f31773OooO0o = flowCollector;
            this.f31774OooO0o0 = 1;
            ...
            OooO00o oooO00o = new OooO00o(momentDetailModel, this.f31776OooO0oo, null);
            this.f31773OooO0o = flowCollector3;
            this.f31772OooO0Oo = apiResult2;
            this.f31774OooO0o0 = 2;
    ...
    public static final class OooO0O0 extends Lambda implements Function0<l> {
        public OooO0O0() {
            super(0);
        }
        ...
        public final l invoke() {
            ...
            return new l(fragmentActivity, GiftPropTypeShow.InMomentDetail, momentVideoVM, new com.yalla.yalla.ui.vm.moment.OooO00o(momentVideoVM), 8);
        }
    }

    @DebugMetadata(c = "com.yalla.yalla.ui.vm.moment.MomentVideoVM$praisePost$1", f = "MomentVideoVM.kt", i = {0, 1, 1}, l = {284, 285, 293}, m = "invokeSuspend", n = {"$this$sharedFlow", "$this$sharedFlow", ReportItem.QualityKeyResult}, s = {"L$0", "L$0", "L$1"})
    public static final class OooO0OO extends SuspendLambda implements Function2<FlowCollector<? super ApiResult<PraisePostResultModel>>, Continuation<? super Unit>, Object> {
        ...
        public final /* synthetic */ boolean f31781OooO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public ApiResult f31782OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public /* synthetic */ Object f31783OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public int f31784OooO0o0;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ long f31786OooO0oo;
        ...
        public static final class OooO00o extends SuspendLambda implements Function2<PraisePostResultModel, Continuation<? super Unit>, Object> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public /* synthetic */ Object f31787OooO0Oo;

            /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
            public final /* synthetic */ long f31788OooO0o;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public final /* synthetic */ MomentVideoVM f31789OooO0o0;

            /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
            public final /* synthetic */ boolean f31790OooO0oO;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public OooO00o(MomentVideoVM momentVideoVM, long j, boolean z, Continuation<? super OooO00o> continuation) {
                super(2, continuation);
                this.f31789OooO0o0 = momentVideoVM;
                this.f31788OooO0o = j;
                this.f31790OooO0oO = z;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                OooO00o oooO00o = new OooO00o(this.f31789OooO0o0, this.f31788OooO0o, this.f31790OooO0oO, continuation);
                oooO00o.f31787OooO0Oo = obj;
                return oooO00o;
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                IntrinsicsKt.getCOROUTINE_SUSPENDED();
                ResultKt.throwOnFailure(obj);
                PraisePostResultModel praisePostResultModel = (PraisePostResultModel) this.f31787OooO0Oo;
                Iterator<MomentDetailModel> it = this.f31789OooO0o0.getListData().iterator();
                do {
                    if (!it.hasNext()) {
                        next = null;
                        break;
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0OO oooO0OO = MomentVideoVM.this.new OooO0OO(this.f31786OooO0oo, this.f31781OooO, continuation);
            oooO0OO.f31783OooO0o = obj;
            return oooO0OO;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ApiResult apiResult2;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31784OooO0o0;
            boolean z = false;
            MomentVideoVM momentVideoVM = MomentVideoVM.this;
            if (i != 0) {
                if (i == 1) {
                    flowCollector = (FlowCollector) this.f31783OooO0o;
                    ResultKt.throwOnFailure(obj);
                    objOooO0Oo = obj;
                } else if (i == 2) {
                    apiResult = this.f31782OooO0Oo;
                    flowCollector2 = (FlowCollector) this.f31783OooO0o;
                    ResultKt.throwOnFailure(obj);
                    apiResult2 = null;
                    this.f31783OooO0o = apiResult2;
                    this.f31782OooO0Oo = apiResult2;
                    this.f31784OooO0o0 = 3;
                    if (flowCollector2.emit(apiResult, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    z = false;
            ...
            int i2 = !this.f31781OooO ? 1 : 0;
            this.f31783OooO0o = flowCollector;
            this.f31784OooO0o0 = 1;
            String strOooO0Oo = oo000o.OooO0Oo("/Webservers/Moment/Praise");
            o0ooOOo o0oooooOooO00o = p391o0OOooo0.oo000o.OooO00o(strOooO0Oo, "url", strOooO0Oo, 0);
            o0oooooOooO00o.OooO0O0(Boxing.boxLong(this.f31786OooO0oo), "dyid");
            o0oooooOooO00o.OooO0O0(Boxing.boxInt(i2), "type");
            objOooO0Oo = OooOOO.OooO0Oo(new MomentRepository$postPraise$$inlined$call$1(o0oooooOooO00o, null), this);
            if (objOooO0Oo == coroutine_suspended) {
                return coroutine_suspended;
            }
            FlowCollector flowCollector3 = flowCollector;
            ApiResult apiResult3 = (ApiResult) objOooO0Oo;
            OooO00o oooO00o = new OooO00o(MomentVideoVM.this, this.f31786OooO0oo, this.f31781OooO, null);
            this.f31783OooO0o = flowCollector3;
            this.f31782OooO0Oo = apiResult3;
            this.f31784OooO0o0 = 2;
            if (o00O0O.OooO0OO(apiResult3, false, null, null, oooO00o, this, 7) == coroutine_suspended) {
                return coroutine_suspended;
            }
            flowCollector2 = flowCollector3;
    ...
    @DebugMetadata(c = "com.yalla.yalla.ui.vm.moment.MomentVideoVM$refreshMomentDetail$1$1", f = "MomentVideoVM.kt", i = {}, l = {306, 306}, m = "invokeSuspend", n = {}, s = {})
    public static final class OooO0o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f31792OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ long f31793OooO0o0;
        ...
        public static final class OooO00o extends SuspendLambda implements Function2<MomentDetailModel, Continuation<? super Unit>, Object> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public /* synthetic */ Object f31794OooO0Oo;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public final /* synthetic */ MomentVideoVM f31795OooO0o0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public OooO00o(MomentVideoVM momentVideoVM, Continuation<? super OooO00o> continuation) {
                super(2, continuation);
                this.f31795OooO0o0 = momentVideoVM;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                OooO00o oooO00o = new OooO00o(this.f31795OooO0o0, continuation);
                oooO00o.f31794OooO0Oo = obj;
                return oooO00o;
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                IntrinsicsKt.getCOROUTINE_SUSPENDED();
                ResultKt.throwOnFailure(obj);
                MomentDetailModel momentDetailModel = (MomentDetailModel) this.f31794OooO0Oo;
                if (momentDetailModel != null) {
                    MomentDetailModelKt.cloneData(this.f31795OooO0o0.getCurrentMomentDetail(), momentDetailModel);
                }
                return Unit.INSTANCE;
            }
        }
        ...
        public OooO0o(long j, MomentVideoVM momentVideoVM, Continuation<? super OooO0o> continuation) {
            super(2, continuation);
            this.f31793OooO0o0 = j;
            this.f31792OooO0o = momentVideoVM;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0o(this.f31793OooO0o0, this.f31792OooO0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            String strValueOf = String.valueOf(this.f31793OooO0o0);
            this.f31791OooO0Oo = 1;
            String url = oo000o.OooO0Oo("/Webservers/Discovery/SquareSingle");
            Intrinsics.checkNotNullParameter(url, "url");
            o0ooOOo o0ooooo = new o0ooOOo(url, 0);
            o0ooooo.OooO0O0(strValueOf, "dyId");
            o0ooooo.OooO0O0(Boxing.boxInt(0), "sourceType");
            obj = OooOOO.OooO0Oo(new MomentRepository$momentDetail$$inlined$call$1(o0ooooo, null), this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
            ApiResult apiResult = (ApiResult) obj;
            OooO00o oooO00o = new OooO00o(this.f31792OooO0o, null);
            this.f31791OooO0Oo = 2;
    ...
    @DebugMetadata(c = "com.yalla.yalla.ui.vm.moment.MomentVideoVM$userMomentList$3", f = "MomentVideoVM.kt", i = {}, l = {FacebookRequestErrorClassification.EC_INVALID_TOKEN, 198, 199, 247, 248}, m = "invokeSuspend", n = {}, s = {})
    public static final class OooOO0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO, reason: collision with root package name */
        public final /* synthetic */ Function1<Continuation<? super Unit>, Object> f31796OooO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f31797OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ Long f31798OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f31799OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f31800OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ long f31801OooO0oo;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public final /* synthetic */ boolean f31802OooOO0;
        ...
        @DebugMetadata(c = "com.yalla.yalla.ui.vm.moment.MomentVideoVM$userMomentList$3$1", f = "MomentVideoVM.kt", i = {}, l = {214}, m = "invokeSuspend", n = {}, s = {})
        public static final class OooO00o extends SuspendLambda implements Function2<ApiResult<List<MomentDetailModel>>, Continuation<? super Unit>, Object> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public int f31803OooO0Oo;

            /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
            public final /* synthetic */ MomentVideoVM f31804OooO0o;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public /* synthetic */ Object f31805OooO0o0;

            /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
            public final /* synthetic */ int f31806OooO0oO;

            /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
            public final /* synthetic */ Function1<Continuation<? super Unit>, Object> f31807OooO0oo;
            ...
            public OooO00o(MomentVideoVM momentVideoVM, int i, Function1<? super Continuation<? super Unit>, ? extends Object> function1, Continuation<? super OooO00o> continuation) {
                super(2, continuation);
                this.f31804OooO0o = momentVideoVM;
                this.f31806OooO0oO = i;
                this.f31807OooO0oo = function1;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                OooO00o oooO00o = new OooO00o(this.f31804OooO0o, this.f31806OooO0oO, this.f31807OooO0oo, continuation);
                oooO00o.f31805OooO0o0 = obj;
                return oooO00o;
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                int i = this.f31803OooO0Oo;
                if (i == 0) {
                    ResultKt.throwOnFailure(obj);
                    ApiResult apiResult = (ApiResult) this.f31805OooO0o0;
                    MomentVideoVM momentVideoVM = this.f31804OooO0o;
                    ...
                    if (apiResult.isSuccess()) {
                        ...
                        if (this.f31806OooO0oO == 0) {
                            momentVideoVM.setPageIndex(apiResult.getPage().getPageIndex());
                        } else {
                            momentVideoVM.setPageIndex(momentVideoVM.getPageIndex() + 1);
                        }
                    }
                    Function1<Continuation<? super Unit>, Object> function1 = this.f31807OooO0oo;
                    if (function1 != null) {
                        this.f31803OooO0Oo = 1;
        ...
        public static final class OooO0O0 extends SuspendLambda implements Function2<ApiError, Continuation<? super Unit>, Object> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ MomentVideoVM f31808OooO0Oo;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public OooO0O0(MomentVideoVM momentVideoVM, Continuation<? super OooO0O0> continuation) {
                super(2, continuation);
                this.f31808OooO0Oo = momentVideoVM;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                return new OooO0O0(this.f31808OooO0Oo, continuation);
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                IntrinsicsKt.getCOROUTINE_SUSPENDED();
                ResultKt.throwOnFailure(obj);
                MomentVideoVM momentVideoVM = this.f31808OooO0Oo;
        ...
        @SourceDebugExtension({"SMAP\nMomentVideoVM.kt\nKotlin\n*S Kotlin\n*F\n+ 1 MomentVideoVM.kt\ncom/yalla/yalla/ui/vm/moment/MomentVideoVM$userMomentList$3$3\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,372:1\n1#2:373\n*E\n"})
        public static final class OooO0OO extends SuspendLambda implements Function2<List<MomentDetailModel>, Continuation<? super Unit>, Object> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public /* synthetic */ Object f31809OooO0Oo;

            /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
            public final /* synthetic */ boolean f31810OooO0o;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public final /* synthetic */ MomentVideoVM f31811OooO0o0;

            /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
            public final /* synthetic */ int f31812OooO0oO;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public OooO0OO(MomentVideoVM momentVideoVM, boolean z, int i, Continuation<? super OooO0OO> continuation) {
                super(2, continuation);
                this.f31811OooO0o0 = momentVideoVM;
                this.f31810OooO0o = z;
                this.f31812OooO0oO = i;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                OooO0OO oooO0OO = new OooO0OO(this.f31811OooO0o0, this.f31810OooO0o, this.f31812OooO0oO, continuation);
                oooO0OO.f31809OooO0Oo = obj;
                return oooO0OO;
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                MomentDetailModel startVideo2;
                IntrinsicsKt.getCOROUTINE_SUSPENDED();
                ResultKt.throwOnFailure(obj);
                List list = (List) this.f31809OooO0Oo;
                MomentVideoVM momentVideoVM = this.f31811OooO0o0;
                momentVideoVM.getContentState().setValue(ContentState.Content);
                boolean z = true;
                if (list != null) {
                    boolean z2 = this.f31810OooO0o;
                    int i = this.f31812OooO0oO;
                    if (z2 && i != 0) {
                        momentVideoVM.getListData().clear();
                    }
                    if (i == 2 && momentVideoVM.getPageIndex() == 1) {
                        Iterator<MomentDetailModel> it = momentVideoVM.getListData().iterator();
                        do {
                            if (!it.hasNext()) {
                                next = null;
                                break;
                            ...
                            next = it.next();
                            momentDetailModel = next;
                            startVideo2 = momentVideoVM.getStartVideo();
                        } while (!(startVideo2 != null && momentDetailModel.getId() == startVideo2.getId()));
                        if (!(next != null) && (startVideo = momentVideoVM.getStartVideo()) != null) {
        ...
        public static final class OooO0o extends SuspendLambda implements Function2<ApiError, Continuation<? super Unit>, Object> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public /* synthetic */ Object f31813OooO0Oo;
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                IntrinsicsKt.getCOROUTINE_SUSPENDED();
                ResultKt.throwOnFailure(obj);
                ((ApiError) this.f31813OooO0Oo).getCode();
                return Unit.INSTANCE;
            }
        }
        ...
        public OooOO0(int i, Long l, MomentVideoVM momentVideoVM, long j, Function1<? super Continuation<? super Unit>, ? extends Object> function1, boolean z, Continuation<? super OooOO0> continuation) {
            super(2, continuation);
            this.f31799OooO0o0 = i;
            this.f31798OooO0o = l;
            this.f31800OooO0oO = momentVideoVM;
            this.f31801OooO0oo = j;
            this.f31796OooO = function1;
            this.f31802OooOO0 = z;
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooOO0(this.f31799OooO0o0, this.f31798OooO0o, this.f31800OooO0oO, this.f31801OooO0oo, this.f31796OooO, this.f31802OooOO0, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            OooO oooO;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f31797OooO0Oo;
            long j = this.f31801OooO0oo;
            int i2 = this.f31799OooO0o0;
            MomentVideoVM momentVideoVM = this.f31800OooO0oO;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                if (i2 == 0) {
                    Long l = this.f31798OooO0o;
                    Intrinsics.checkNotNull(l);
                    long jLongValue = l.longValue();
                    long dateSort = momentVideoVM.getDateSort();
                    int pageIndex = momentVideoVM.getPageIndex();
                    this.f31797OooO0Oo = 1;
                    ...
                    oooO00o = new OooO00o(momentVideoVM2, i2, this.f31796OooO, continuation2);
                    oooO0O0 = new OooO0O0(momentVideoVM2, continuation2);
                    oooO0OO = new OooO0OO(momentVideoVM2, this.f31802OooOO0, i2, continuation2);
                    this.f31797OooO0Oo = 3;
                    if (o00O0O.OooO0OO(apiResult, false, oooO00o, oooO0O0, oooO0OO, this, 1) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    String strOooOOO0 = o0OoOo0.OooOOO0(AppEventsConstants.EVENT_PARAM_VALUE_NO, Boxing.boxLong(j));
                    this.f31797OooO0Oo = 4;
                    String url = oo000o.OooO0Oo("/Webservers/Discovery/SquareSingle");
                    Intrinsics.checkNotNullParameter(url, "url");
                    o0ooOOo o0ooooo = new o0ooOOo(url, 0);
                    o0ooooo.OooO0O0(strOooOOO0, "dyId");
                    o0ooooo.OooO0O0(Boxing.boxInt(0), "sourceType");
                    continuation3 = null;
                    objOooO0Oo2 = OooOOO.OooO0Oo(new MomentRepository$momentDetail$$inlined$call$1(o0ooooo, null), this);
                    if (objOooO0Oo2 == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    oooO0o = new OooO0o(continuation3);
                    oooO = new OooO(continuation3);
                    this.f31797OooO0Oo = 5;
                    if (o00O0O.OooO0OO((ApiResult) objOooO0Oo2, false, null, oooO0o, oooO, this, 3) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    momentVideoVM = momentVideoVM;
                    int pageIndex2 = momentVideoVM.getPageIndex();
                    this.f31797OooO0Oo = 2;
                    String strOooO0Oo = oo000o.OooO0Oo("/Webservers/video/gethot");
                    o0ooOOo o0oooooOooO00o = p391o0OOooo0.oo000o.OooO00o(strOooO0Oo, "url", strOooO0Oo, 0);
                    o0oooooOooO00o.OooO0O0(Boxing.boxLong(j), "dyId");
                    o0oooooOooO00o.OooO0O0(Boxing.boxInt(pageIndex2), "pageindex");
                    o0oooooOooO00o.OooO0O0(Boxing.boxInt(20), "pagesize");
                    continuation = null;
                    objOooO0Oo = OooOOO.OooO0Oo(new MomentRepository$getHotVideoFeed$$inlined$call$1(o0oooooOooO00o, null), this);
                    if (objOooO0Oo == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    apiResult = (ApiResult) objOooO0Oo;
                    ...
                    oooO00o = new OooO00o(momentVideoVM3, i2, this.f31796OooO, continuation2);
                    oooO0O0 = new OooO0O0(momentVideoVM3, continuation2);
                    oooO0OO = new OooO0OO(momentVideoVM3, this.f31802OooOO0, i2, continuation2);
                    this.f31797OooO0Oo = 3;
                    if (o00O0O.OooO0OO(apiResult, false, oooO00o, oooO0O0, oooO0OO, this, 1) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    ...
                    this.f31797OooO0Oo = 4;
                    String url2 = oo000o.OooO0Oo("/Webservers/Discovery/SquareSingle");
                    Intrinsics.checkNotNullParameter(url2, "url");
                    o0ooOOo o0ooooo2 = new o0ooOOo(url2, 0);
                    o0ooooo2.OooO0O0(strOooOOO1, "dyId");
                    o0ooooo2.OooO0O0(Boxing.boxInt(0), "sourceType");
                    continuation3 = null;
                    objOooO0Oo2 = OooOOO.OooO0Oo(new MomentRepository$momentDetail$$inlined$call$1(o0ooooo2, null), this);
                    if (objOooO0Oo2 == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    oooO0o = new OooO0o(continuation3);
                ...
                oooO00o = new OooO00o(momentVideoVM4, i2, this.f31796OooO, continuation2);
                oooO0O0 = new OooO0O0(momentVideoVM4, continuation2);
                oooO0OO = new OooO0OO(momentVideoVM4, this.f31802OooOO0, i2, continuation2);
                this.f31797OooO0Oo = 3;
                if (o00O0O.OooO0OO(apiResult, false, oooO00o, oooO0O0, oooO0OO, this, 1) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                ...
                this.f31797OooO0Oo = 4;
                String url3 = oo000o.OooO0Oo("/Webservers/Discovery/SquareSingle");
                Intrinsics.checkNotNullParameter(url3, "url");
                o0ooOOo o0ooooo3 = new o0ooOOo(url3, 0);
                o0ooooo3.OooO0O0(strOooOOO2, "dyId");
                o0ooooo3.OooO0O0(Boxing.boxInt(0), "sourceType");
                continuation3 = null;
                objOooO0Oo2 = OooOOO.OooO0Oo(new MomentRepository$momentDetail$$inlined$call$1(o0ooooo3, null), this);
                if (objOooO0Oo2 == coroutine_suspended) {
                    return coroutine_suspended;
                }
                oooO0o = new OooO0o(continuation3);
                ...
                oooO00o = new OooO00o(momentVideoVM5, i2, this.f31796OooO, continuation2);
                oooO0O0 = new OooO0O0(momentVideoVM5, continuation2);
                oooO0OO = new OooO0OO(momentVideoVM5, this.f31802OooOO0, i2, continuation2);
                this.f31797OooO0Oo = 3;
                if (o00O0O.OooO0OO(apiResult, false, oooO00o, oooO0O0, oooO0OO, this, 1) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                ...
                this.f31797OooO0Oo = 4;
                String url4 = oo000o.OooO0Oo("/Webservers/Discovery/SquareSingle");
                Intrinsics.checkNotNullParameter(url4, "url");
                o0ooOOo o0ooooo4 = new o0ooOOo(url4, 0);
                o0ooooo4.OooO0O0(strOooOOO3, "dyId");
                o0ooooo4.OooO0O0(Boxing.boxInt(0), "sourceType");
                continuation3 = null;
                objOooO0Oo2 = OooOOO.OooO0Oo(new MomentRepository$momentDetail$$inlined$call$1(o0ooooo4, null), this);
                if (objOooO0Oo2 == coroutine_suspended) {
                    return coroutine_suspended;
                }
                oooO0o = new OooO0o(continuation3);
                ...
                this.f31797OooO0Oo = 4;
                String url5 = oo000o.OooO0Oo("/Webservers/Discovery/SquareSingle");
                Intrinsics.checkNotNullParameter(url5, "url");
                o0ooOOo o0ooooo5 = new o0ooOOo(url5, 0);
                o0ooooo5.OooO0O0(strOooOOO4, "dyId");
                o0ooooo5.OooO0O0(Boxing.boxInt(0), "sourceType");
                continuation3 = null;
                objOooO0Oo2 = OooOOO.OooO0Oo(new MomentRepository$momentDetail$$inlined$call$1(o0ooooo5, null), this);
                if (objOooO0Oo2 == coroutine_suspended) {
                    return coroutine_suspended;
                }
                oooO0o = new OooO0o(continuation3);
    ...
    public MomentVideoVM() {
        ...
        this.showVideoLikeTip = oo0ooo0oOooO0o0.OooO0O0("videoLikeTip" + o0O00oO0.OooOOo0().getValue(), true);
    ...
    private final l getMomentGiftSendUtil() {
    ...
    public final void deleteItem(long hidePostId) {
        ...
        o0000O00.OooO0O0("refreshIndex is " + this.refreshIndex.getValue());
    }
    ...
    public final void preLoadVideo(int settledPage) {
        if (getListData().size() > 0) {
            for (int i = 0; i < 4; i++) {
                int i2 = settledPage + i;
                if (i2 < getListData().size() && this.downLoadingMap.get(Integer.valueOf(i2)) == null) {
                    this.downLoadingMap.put(Integer.valueOf(i2), Boolean.TRUE);
                    p362o0OOo00.OooO0O0 oooO0O0 = p362o0OOo00.OooO0O0.f43001OooO00o;
                    String videoUrl = getListData().get(i2).getVideoUrl();
                    oooO0O0.getClass();
    ...
    public final void sendGift() {
        l momentGiftSendUtil = getMomentGiftSendUtil();
    ...
    public final void showSwipeGuideDone() {
        ...
        oO0OOo0o oo0ooo0oOooO0o0 = o00Ooo.OooO0o0();
        oo0ooo0oOooO0o0.OooO0o("videoSwipeGuide" + oo0ooo0oOooO0o0.f46400OooO0OO, false);
    }
    ...
    public final void toInputCommentOrReply(@Nullable MomentCommentDetailModel comment, @Nullable MomentReplyModel reply, boolean isReplyPage) {
        ...
        o0000O00.OooO0O0("WRM toInputCommentOrReply " + str + " \tcurrentCommentId = " + getCurrentCommentId() + "\tcurrentReplyId = " + getCurrentReplyId() + "\nreplyUserInfo = " + p187o00o00o0.OooO.OooO00o(getReplyUserInfo()));
    }
