...
import p412o0Oo0o0O.o0O00000;
import p412o0Oo0o0O.o0O0000O;
import p412o0Oo0o0O.o0O000O;
import p424o0OoO0Oo.o00OO000;
import p475o0Ooooo0.o0O00oO0;

/* JADX INFO: loaded from: classes4.dex */
@StabilityInferred(parameters = 0)
@Metadata(d1 = {"\u0000B\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\b\n\u0002\b\u000b\b\u0007\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u001a\u0010\u001bJ\u0012\u0010\u0005\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00040\u00030\u0002J\u0006\u0010\u0007\u001a\u00020\u0006J$\u0010\u000e\u001a\u0018\u0012\u0014\u0012\u0012\u0012\u0004\u0012\u00020\f0\u000bj\b\u0012\u0004\u0012\u00020\f`\r0\n2\u0006\u0010\t\u001a\u00020\bJ\u0014\u0010\u0012\u001a\b\u0012\u0004\u0012\u00020\u00110\n2\u0006\u0010\u0010\u001a\u00020\u000fJ\u000e\u0010\u0014\u001a\u00020\u00062\u0006\u0010\u0013\u001a\u00020\bJ\u0006\u0010\u0015\u001a\u00020\u0006R-\u0010\u0016\u001a\u0018\u0012\u0014\u0012\u0012\u0012\u0004\u0012\u00020\f0\u000bj\b\u0012\u0004\u0012\u00020\f`\r0\n8\u0006¢\u0006\f\n\u0004\b\u0016\u0010\u0017\u001a\u0004\b\u0018\u0010\u0019¨\u0006\u001c"}, d2 = {"Lcom/yalla/yalla/ui/vm/moment/TopicSearchVM;", "Lcom/yalla/yalla/ui/vm/moment/BaseMomentDetailVM;", "Landroidx/lifecycle/LiveData;", "", "Lcom/yalla/yalla/data/db/model/SearchHistoryTable;", "getSearchHistory", "", "loadSearchRecommendTopic", "", "search", "Lo0OoO0Oo/o00OO000;", "Ljava/util/ArrayList;", "Lcom/yalla/yalla/model/topic/TopicInfoModel;", "Lkotlin/collections/ArrayList;", "searchTopic", "", "topicId", "", "joinTopic", "searchTag", "saveSearchHistory", "clearSearchHistory", "recommendList", "Lo0OoO0Oo/o00OO000;", "getRecommendList", "()Lo0OoO0Oo/o00OO000;", "<init>", "()V", "Common_YallaRelease"}, k = 1, mv = {1, 9, 0})
public final class TopicSearchVM extends BaseMomentDetailVM {
    public static final int $stable = 0;

    @NotNull
    private final o00OO000<ArrayList<TopicInfoModel>> recommendList = new o00OO000<>();

    public static final class OooO extends Lambda implements Function1<Response<ArrayList<TopicInfoModel>>, Unit> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ o00OO000<ArrayList<TopicInfoModel>> f31928OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(o00OO000<ArrayList<TopicInfoModel>> o00oo001) {
            super(1);
            this.f31928OooO0Oo = o00oo001;
        }
        ...
        public final Unit invoke(Response<ArrayList<TopicInfoModel>> response) {
            ...
            this.f31928OooO0Oo.postValue(it);
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            o0o0ooo0OooOooo.OooO0OO(2, ((Number) com.yalla.yalla.common.manager.OooO00o.OooO00o()).longValue());
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0O0 extends Lambda implements Function1<Response<Integer>, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ o00OO000<Integer> f31930OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(o00OO000<Integer> o00oo001) {
            super(1);
            this.f31930OooO0Oo = o00oo001;
        }
        ...
        public final Unit invoke(Response<Integer> response) {
            ...
            Intrinsics.checkNotNullParameter(it, "it");
            this.f31930OooO0Oo.postValue(it);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final /* synthetic */ String f31933OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(String str, Continuation<? super OooO0o> continuation) {
            super(2, continuation);
            this.f31933OooO0o0 = str;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return TopicSearchVM.this.new OooO0o(this.f31933OooO0o0, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            String searchTag = this.f31933OooO0o0;
            ...
            o0o0ooo0OooOooo.OooO0O0(((Number) com.yalla.yalla.common.manager.OooO00o.OooO00o()).longValue(), 2, 5, 2);
            return Unit.INSTANCE;
        }
    }
    ...
    @NotNull
    public final o00OO000<ArrayList<TopicInfoModel>> getRecommendList() {
    ...
    public final LiveData<List<SearchHistoryTable>> getSearchHistory() {
        ...
        o0O0OOO0 o0o0ooo0OooOooo = o00Oo0.OooO00o().OooOooo();
        o0O00oO0 o0o00oo1 = o0O00oO0.f47936OooO00o;
        return o0o0ooo0OooOooo.OooO0Oo(2, ((Number) com.yalla.yalla.common.manager.OooO00o.OooO00o()).longValue());
    }

    @NotNull
    public final o00OO000<Integer> joinTopic(long topicId) {
        o00OO000<Integer> o00oo001 = new o00OO000<>();
        OooO0O0 listener = new OooO0O0(o00oo001);
        Intrinsics.checkNotNullParameter(listener, "listener");
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), null, null, new o0O0000O(topicId, true, listener, null), 3, null);
        return o00oo001;
    }
    ...
    public final void loadSearchRecommendTopic() {
        ...
        Intrinsics.checkNotNullParameter(listener, "listener");
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), null, null, new o0O000O(listener, null), 3, null);
    }
    ...
    @NotNull
    public final o00OO000<ArrayList<TopicInfoModel>> searchTopic(@NotNull String search) {
        Intrinsics.checkNotNullParameter(search, "search");
        o00OO000<ArrayList<TopicInfoModel>> o00oo001 = new o00OO000<>();
        OooO listener = new OooO(o00oo001);
        Intrinsics.checkNotNullParameter(search, "search");
        Intrinsics.checkNotNullParameter(listener, "listener");
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), null, null, new o0O00000(search, listener, null), 3, null);
        return o00oo001;
    }
}
