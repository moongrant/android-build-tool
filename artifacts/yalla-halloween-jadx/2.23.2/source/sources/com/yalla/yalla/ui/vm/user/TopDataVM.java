...
public final class TopDataVM extends OooOO0 {
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<LiveDataScope<ApiResult<TopRankResponse>>, Continuation<? super Unit>, Object> {
        ...
        public int f32184OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ String f32185OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f32186OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ String f32187OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ TopDataVM f32188OooO0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(String str, String str2, TopDataVM topDataVM, Continuation<? super OooO0O0> continuation) {
            super(2, continuation);
            this.f32185OooO0o = str;
            this.f32187OooO0oO = str2;
            this.f32188OooO0oo = topDataVM;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO0O0 oooO0O0 = new OooO0O0(this.f32185OooO0o, this.f32187OooO0oO, this.f32188OooO0oo, continuation);
            oooO0O0.f32186OooO0o0 = obj;
            return oooO0O0;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f32184OooO0Oo;
            String str = this.f32185OooO0o;
            if (i != 0) {
                if (i == 1) {
                    liveDataScope = (LiveDataScope) this.f32186OooO0o0;
            ...
            this.f32186OooO0o0 = liveDataScope;
            this.f32184OooO0Oo = 1;
            o000Var.getClass();
            String url = oo000o.OooO0OO("/Webservers/rankinglist/RankingList");
            Intrinsics.checkNotNullParameter(url, "url");
            o0ooOOo o0ooooo = new o0ooOOo(url, 0);
            o0ooooo.OooO00o();
            o0ooooo.OooO0O0(str, "str");
            o0ooooo.OooO0O0(this.f32187OooO0oO, "type");
            obj = OooOOO.OooO0Oo(new CommonRepository$rankingList$$inlined$call$1(o0ooooo, null), this);
            ...
            if (apiResult.isSuccess()) {
                ...
                if (topRankResponse != null) {
                    ...
                    if (Intrinsics.areEqual(str, TopVM.TYPE_ROOM_GIFT)) {
                        ...
                        String str2 = (String) o0O00oO0.OooO().getValue();
                        String str3 = "";
                        if (str2 == null) {
                            str2 = "";
                        } else {
                        ...
                        String str4 = (String) o0O00oO0.OooOOoo().getValue();
                        if (str4 != null) {
    ...
    public final int getHeadBgResource(@NotNull String rankType) {
        ...
        int i = o0O0O00.main_top_room_gift;
        ...
        if (Intrinsics.areEqual(rankType, TopVM.TYPE_GIFT_SENT)) {
            return o0O0O00.main_top_sent_gift;
        }
        companion.getClass();
        if (Intrinsics.areEqual(rankType, TopVM.TYPE_GIFT_RECEIVE)) {
            return o0O0O00.main_top_receive_gift;
        }
        companion.getClass();
        return Intrinsics.areEqual(rankType, TopVM.TYPE_YALLA_BILLION) ? o0O0O00.main_top_yalla_billion : i;
    }
    ...
    public final int getTextResource(@NotNull String rankType) {
        Intrinsics.checkNotNullParameter(rankType, "rankType");
        int i = o0Oo0oo.main_top_head_bg_blue;
        TopVM.Companion companion = TopVM.INSTANCE;
        companion.getClass();
        if (Intrinsics.areEqual(rankType, TopVM.TYPE_ROOM_GIFT)) {
            return i;
        ...
        companion.getClass();
        if (Intrinsics.areEqual(rankType, TopVM.TYPE_GIFT_SENT)) {
            return o0Oo0oo.main_all_head_bg_yellow;
        }
        companion.getClass();
        if (Intrinsics.areEqual(rankType, TopVM.TYPE_GIFT_RECEIVE)) {
            return o0Oo0oo.main_top_head_bg_purple;
        }
        companion.getClass();
        return Intrinsics.areEqual(rankType, TopVM.TYPE_YALLA_BILLION) ? o0Oo0oo.main_top_head_bg_red : i;
    }
