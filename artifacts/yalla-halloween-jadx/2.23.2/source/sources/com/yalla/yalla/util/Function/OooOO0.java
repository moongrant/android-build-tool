...
public final class OooOO0 extends o00OOOOo {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final OooO0o f32276OooO00o;

    public OooOO0(ApiAppConfig$getWebErrorList$1 apiAppConfig$getWebErrorList$1) {
        this.f32276OooO00o = apiAppConfig$getWebErrorList$1;
    }
    ...
    public final void OooO00o(Exception exc) {
        OooO0o oooO0o = this.f32276OooO00o;
        if (oooO0o != null) {
            oooO0o.OooO0Oo();
            oooO0o.OooO0O0(AppEventsConstants.EVENT_PARAM_VALUE_NO, "");
            o0000O00.OooO0Oo(exc.getMessage());
        }
    }
    ...
    public final void OooO0O0(Object obj) {
        ...
        try {
            AbsJavaBeanApi absJavaBeanApi = (AbsJavaBeanApi) oOOO00.OooO0O0(str, new TypeToken<AbsJavaBeanApi<UserCloseModel>>() { // from class: com.yalla.yalla.util.Function.WebApiCallback$1
            }.getType());
            if (absJavaBeanApi != null && absJavaBeanApi.getData() != null && ((UserCloseModel) absJavaBeanApi.getData()).getBlockingMsg() != null) {
                o0000O00.OooO0O0("result : " + absJavaBeanApi.toJSONString());
                if (oooO0o != null) {
