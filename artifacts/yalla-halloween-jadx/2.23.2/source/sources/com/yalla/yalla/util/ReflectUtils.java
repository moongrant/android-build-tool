...
public final class ReflectUtils {
    ...
    public final Class<?> f32277OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final Object f32278OooO0O0;
    ...
    public ReflectUtils(Class<?> cls, Object obj) {
        this.f32277OooO00o = cls;
        this.f32278OooO0O0 = obj;
    }
    ...
    public final void OooO0O0(Object obj, String str) {
        try {
            ...
            Object obj2 = this.f32278OooO0O0;
            if (obj instanceof ReflectUtils) {
                obj = ((ReflectUtils) obj).f32278OooO0O0;
            }
    ...
    public final Field OooO0OO(String str) throws IllegalAccessException {
        Field field;
        Class<?> superclass = this.f32277OooO00o;
        try {
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof ReflectUtils) {
            if (this.f32278OooO0O0.equals(((ReflectUtils) obj).f32278OooO0O0)) {
                return true;
            }
        }
        return false;
    ...
    public final int hashCode() {
        return this.f32278OooO0O0.hashCode();
    }

    public final String toString() {
        return this.f32278OooO0O0.toString();
    }
}
