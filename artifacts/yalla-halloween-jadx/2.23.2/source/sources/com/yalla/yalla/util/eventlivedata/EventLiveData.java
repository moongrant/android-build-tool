...
public class EventLiveData<T> extends LiveData<T> {
    ...
    public final HashMap<Observer<? super T>, EventLiveData<T>.OooO0OO> f32305OooO00o = new HashMap<>();

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public int f32307OooO0OO = 0;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final OooO00o f32306OooO0O0 = new OooO00o();

    public class EventLifecycleBoundEventObserver extends EventLiveData<T>.OooO0OO implements LifecycleObserver {

        /* JADX INFO: renamed from: OooO, reason: collision with root package name */
        public Lifecycle.Event f32308OooO;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        @NonNull
        public final LifecycleOwner f32309OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public Lifecycle.State f32310OooO0oo;

        public EventLifecycleBoundEventObserver(LifecycleOwner lifecycleOwner, Observer<? super T> observer) {
            super(observer);
            this.f32310OooO0oo = Lifecycle.State.STARTED;
            this.f32308OooO = null;
            this.f32309OooO0oO = lifecycleOwner;
        }
        ...
        public final boolean OooO0O0(LifecycleOwner lifecycleOwner) {
            return this.f32309OooO0oO == lifecycleOwner;
        }

        @Override // com.yalla.yalla.util.eventlivedata.EventLiveData.OooO0OO
        public final boolean OooO0OO() {
            return this.f32309OooO0oO.getLifecycle().getCurrentState().isAtLeast(this.f32310OooO0oo);
        }

        @OnLifecycleEvent(Lifecycle.Event.ON_ANY)
        public void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
            Lifecycle.Event event2;
            if (this.f32309OooO0oO.getLifecycle().getCurrentState() == Lifecycle.State.DESTROYED || ((event2 = this.f32308OooO) != null && event2 == event)) {
                EventLiveData.this.removeObserver(this.f32313OooO0Oo);
            } else {
                OooO00o(OooO0OO());
            }
        }
    ...
    public class OooO00o implements Observer<T> {
        ...
        public final void onChanged(T t) {
            Iterator<Map.Entry<Observer<? super T>, EventLiveData<T>.OooO0OO>> it = EventLiveData.this.f32305OooO00o.entrySet().iterator();
            while (it.hasNext()) {
                EventLiveData<T>.OooO0OO value = it.next().getValue();
                if (value.OooO0OO()) {
                    value.f32313OooO0Oo.onChanged(t);
                }
            }
        }
    }
    ...
    public abstract class OooO0OO {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final Observer<? super T> f32313OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public boolean f32315OooO0o0;

        public OooO0OO(Observer<? super T> observer) {
            this.f32313OooO0Oo = observer;
        }

        public final void OooO00o(boolean z) {
            if (z == this.f32315OooO0o0) {
                return;
            }
            this.f32315OooO0o0 = z;
            EventLiveData eventLiveData = EventLiveData.this;
            int i = eventLiveData.f32307OooO0OO;
            boolean z2 = i == 0;
            eventLiveData.f32307OooO0OO = i + (z ? 1 : -1);
            if (z2 && z) {
                eventLiveData.getClass();
            }
            if (eventLiveData.f32307OooO0OO != 0 || this.f32315OooO0o0) {
                return;
            }
            eventLiveData.getClass();
        }
    ...
    private static void OooO00o(String str) {
        if (!Looper.getMainLooper().isCurrentThread()) {
            throw new IllegalStateException(o000oOoO.OooO0O0("Cannot invoke ", str, " on a background thread"));
        }
    }
    ...
    public final void OooO0O0(Object obj, String str) {
        ...
        StringBuilder sbOooO00o = androidx.compose.compiler.plugins.kotlin.OooO0OO.OooO00o("Parameter specified as non-null is null: method ", stackTraceElement.getClassName(), ".", stackTraceElement.getMethodName(), ", parameter ");
    ...
    public final boolean hasActiveObservers() {
        return this.f32307OooO0OO > 0;
    }

    @Override // androidx.lifecycle.LiveData
    public final boolean hasObservers() {
        return this.f32305OooO00o.size() > 0;
    }
    ...
    public final void observe(@NonNull LifecycleOwner lifecycleOwner, @NonNull Observer observer) {
        ...
        if (state == state2) {
            ...
            sb.append(className);
            sb.append(".");
            IllegalArgumentException illegalArgumentException = new IllegalArgumentException(o0oOO.OooO0O0(sb, methodName, ", parameter   minimumStateForSendingEvent"));
            OooO0OO(illegalArgumentException);
            throw illegalArgumentException;
        }
        if (Lifecycle.Event.ON_START == null || Lifecycle.Event.ON_CREATE == null || Lifecycle.Event.ON_RESUME == null) {
            ...
            IllegalArgumentException illegalArgumentException2 = new IllegalArgumentException(oO00OOOo.OooO00o("State can not be equal to nullmethod ", stackTraceElement2.getClassName(), ".", stackTraceElement2.getMethodName(), ", parameter  maximumEventForRemovingEvent"));
            OooO0OO(illegalArgumentException2);
            throw illegalArgumentException2;
        }
        if (state == state2) {
            StackTraceElement stackTraceElement3 = Thread.currentThread().getStackTrace()[3];
            StringBuilder sbOooO00o = androidx.compose.compiler.plugins.kotlin.OooO0OO.OooO00o("State can not be equal to DESTROYED! : method ", stackTraceElement3.getClassName(), ".", stackTraceElement3.getMethodName(), ", parameter ");
        ...
        eventLifecycleBoundEventObserver.f32310OooO0oo = state;
        eventLifecycleBoundEventObserver.f32308OooO = null;
        HashMap<Observer<? super T>, EventLiveData<T>.OooO0OO> map = this.f32305OooO00o;
        ...
        super.observeForever(this.f32306OooO0O0);
    }
    ...
    public final void removeObserver(@NonNull Observer observer) {
        ...
        OooO0O0(observer, "observer");
        this.f32305OooO00o.remove(observer);
    }
