...
public final class PlatformActivity extends AppCompatActivity {
    ...
    @Nullable
    public Fragment f32395OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @NotNull
    public final String f32396OooO0o0 = "PlatformFragment";
    ...
    public final void OooOOO0(FragmentManager fragmentManager, OooO00o oooO00o) {
        ...
        oooO00o2.OooO0OO(l5.frameAuthRoot, oooO00o, this.f32396OooO0o0, 1);
        oooO00o2.OooO0o();
    }
    ...
    public final void onActivityResult(int i, int i2, @Nullable Intent intent) {
        ...
        Fragment fragment = this.f32395OooO0o;
        if (fragment == null) {
            return;
        }
    ...
    public final void onBackPressed() {
        ...
        if (fragment instanceof OooOO0O) {
            ...
            WebBrowser webBrowser = ((OooOO0O) fragment).f116OooO0o0;
            if (webBrowser != null && webBrowser.onBackPressed()) {
                return;
            }
        }
        Fragment fragment2 = this.f32395OooO0o;
    ...
    public final void onPause() {
        ...
        if (h5.f57416OooO0O0) {
            Log.d(h5.f57415OooO00o, "Platform Activity onPause");
        }
    }
    ...
    public final void onResume() {
        ...
        if (h5.f57416OooO0O0) {
            Log.d(h5.f57415OooO00o, "Platform Activity onResume");
        }
    }
    ...
    public final void onStop() {
        ...
        if (h5.f57416OooO0O0) {
            Log.d(h5.f57415OooO00o, "Platform Activity onStop");
        }
    }
}
