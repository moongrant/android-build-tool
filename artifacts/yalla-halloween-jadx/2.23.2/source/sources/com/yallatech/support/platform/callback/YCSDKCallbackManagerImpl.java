...
public final class YCSDKCallbackManagerImpl implements YCSDKCallbackManager {
    ...
    @NotNull
    public static final OooO0O0 f32404OooO0O0 = new OooO0O0();

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @NotNull
    public static final HashMap f32405OooO0OO = new HashMap();

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    @NotNull
    public final HashMap f32406OooO00o = new HashMap();
    ...
    public final boolean onActivityResult(int i, int i2, @Nullable Intent intent) {
        OooO00o oooO00o;
        OooO00o oooO00o2 = (OooO00o) this.f32406OooO00o.get(Integer.valueOf(i));
        if (oooO00o2 != null) {
            oooO00o2.OooO00o(i2, intent);
            return true;
        }
        synchronized (f32404OooO0O0) {
            oooO00o = (OooO00o) f32405OooO0OO.get(Integer.valueOf(i));
        }
        if (oooO00o == null) {
            return false;
        }
