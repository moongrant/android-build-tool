...
public class AppBarLayoutBehavior extends AppBarLayout.Behavior {
    ...
    public boolean f32409OooOOOO;

    /* JADX INFO: renamed from: OooOOOo, reason: collision with root package name */
    public boolean f32410OooOOOo;
    ...
    public final boolean OooO0oO(CoordinatorLayout coordinatorLayout, View view, MotionEvent motionEvent) {
        ...
        this.f32410OooOOOo = false;
        if (this.f32409OooOOOO) {
            this.f32410OooOOOo = true;
        }
