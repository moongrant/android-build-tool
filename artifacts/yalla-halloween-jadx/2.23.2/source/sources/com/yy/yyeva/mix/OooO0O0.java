...
public final class OooO0O0 extends Lambda implements Function2<Bitmap, EvaSrc.FitType, Unit> {
    ...
    public final /* synthetic */ EvaSrc f32432OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ com.yy.yyeva.mix.OooO00o f32433OooO0o0;
    ...
    public OooO0O0(EvaSrc evaSrc, com.yy.yyeva.mix.OooO00o oooO00o) {
        super(2);
        this.f32432OooO0Oo = evaSrc;
        this.f32433OooO0o0 = oooO00o;
    }
    ...
    public final Unit invoke(Bitmap bitmap, EvaSrc.FitType fitType) {
        ...
        EvaSrc evaSrc = this.f32432OooO0Oo;
        if (bitmap2 == null) {
            String msg = "fetch image " + this.f32432OooO0Oo.f32412OooO00o + " bitmap return null";
        ...
        evaSrc.f32419OooO0oo = bitmapCopy;
        int i = fitType2 == null ? -1 : OooO00o.$EnumSwitchMapping$0[fitType2.ordinal()];
        if (i == -1) {
            str = this.f32432OooO0Oo.f32418OooO0oO;
        } else if (i != 1) {
        ...
        int i2 = this.f32433OooO0o0.f32424OooO00o.f57461OooO0O0;
        EvaSrc evaSrc2 = this.f32432OooO0Oo;
        evaJniUtil.setSrcBitmap(i2, evaSrc2.f32412OooO00o, evaSrc2.f32419OooO0oo, str);
        StringBuilder sb = new StringBuilder("fetch image ");
        sb.append(this.f32432OooO0Oo.f32412OooO00o);
        sb.append(" finish bitmap is ");
        Bitmap bitmap3 = this.f32432OooO0Oo.f32419OooO0oo;
        sb.append(bitmap3 != null ? Integer.valueOf(bitmap3.hashCode()) : null);
        String msg2 = sb.toString();
        Intrinsics.checkNotNullParameter("EvaAnimPlayer.MixAnimPlugin", ViewHierarchyConstants.TAG_KEY);
        Intrinsics.checkNotNullParameter(msg2, "msg");
        Bitmap bitmap4 = this.f32432OooO0Oo.f32419OooO0oo;
        if (bitmap4 != null) {
            bitmap4.recycle();
        }
        com.yy.yyeva.mix.OooO00o oooO00o = this.f32433OooO0o0;
