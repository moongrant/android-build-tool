...
public class KaraokeHelper {
    ...
    private static final int[][] ReverbCustomParams = {new int[]{200, 1000, 500, 4500, 1000, ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED}, new int[]{5000, 4500, 1200, 4500, 6500, 1200}, new int[]{4500, 8000, 1000, 4000, 6500, ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED}, new int[]{2500, BannerConfig.LOOP_TIME, ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED, 4000, 5000, ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED}, new int[]{3500, 5500, ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED, 5000, 5500, ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED}, new int[]{4000, BannerConfig.LOOP_TIME, 1000, 2500, 5500, 1200}, new int[]{500, 5000, LogSeverity.EMERGENCY_VALUE, 4500, BannerConfig.LOOP_TIME, 1200}, new int[]{20, 500, 60, 4500, 5000, ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED}, new int[]{0, 0, 0, 4000, 0, 1200}};
    ...
    public int EnableVivoKaraoke(int i) {
        ...
        this._audioManager.setParameters("vivo_ktv_play_source=".concat(i == 0 ? AppEventsConstants.EVENT_PARAM_VALUE_NO : "1"));
        return 0;
    }
    ...
    public void setEQParams(int i) {
        ...
        this._audioManager.setParameters("vivo_ktv_miceq_band2=" + (iArr[i][1] + 8));
        this._audioManager.setParameters("vivo_ktv_miceq_band3=" + (iArr[i][2] + 8));
        this._audioManager.setParameters("vivo_ktv_miceq_band4=" + (iArr[i][3] + 8));
        this._audioManager.setParameters("vivo_ktv_miceq_band5=" + (iArr[i][4] + 8));
    }
    ...
    public void setReverbParams(int i) {
        ...
        sb.append(iArr[i][0]);
        audioManager.setParameters(sb.toString());
        this._audioManager.setParameters("vivo_ktv_rb_damp=" + iArr[i][1]);
        this._audioManager.setParameters("vivo_ktv_rb_wet=" + iArr[i][2]);
        this._audioManager.setParameters("vivo_ktv_rb_dry=" + iArr[i][3]);
        this._audioManager.setParameters("vivo_ktv_rb_width=" + iArr[i][4]);
        this._audioManager.setParameters("vivo_ktv_rb_gain=" + iArr[i][5]);
