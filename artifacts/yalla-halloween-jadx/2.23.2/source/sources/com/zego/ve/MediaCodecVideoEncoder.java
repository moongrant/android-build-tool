...
public class MediaCodecVideoEncoder {
    ...
    private double getBitrateScale(int i) {
        return Math.pow(2.0d, ((double) i) / 10.0d);
    }
    ...
    private void reportEncodedFrame(int i) {
        ...
        if (this.bitrateObservationTimeMs > 3000.0d) {
            android.util.Log.d(TAG, "Acc: " + ((int) this.bitrateAccumulator) + ". Max: " + ((int) this.bitrateAccumulatorMax) + ". ExpScale: " + this.bitrateAdjustmentScaleExp);
            ...
            if (z) {
                ...
                android.util.Log.d(TAG, "Adjusting bitrate scale to " + this.bitrateAdjustmentScaleExp + ". Value: " + getBitrateScale(this.bitrateAdjustmentScaleExp));
    ...
    private boolean setRates(int i, int i2) {
        ...
        if (bitrateAdjustmentType == BitrateAdjustmentType.FRAMERATE_ADJUSTMENT && i2 > 0) {
            ...
            android.util.Log.v(TAG, "setRates: " + (i / 1000) + " -> " + (i4 / 1000) + " kbps. Fps: " + this.targetFps);
            i = i4;
    ...
    public OutputBufferInfo dequeueOutputBuffer() {
        ...
        try {
            ...
            if (iDequeueOutputBuffer >= 0) {
                ByteBuffer byteBufferDuplicate = getByteBuffer(false, iDequeueOutputBuffer).duplicate();
                ...
                return new OutputBufferInfo(iDequeueOutputBuffer, byteBufferDuplicate.slice(), bufferInfo.size, (bufferInfo.flags & 1) != 0, bufferInfo.presentationTimeUs);
            }
    ...
    public boolean initEncode(int i, int i2, int i3, int i4, int i5, boolean z, int i6, int i7, String str) {
        ...
        int i10;
        String str4 = " x ";
        StringBuilder sbOooO00o = o00000.OooO00o("Java initEncode: ", i2, " x ", i3, ". @ ");
        sbOooO00o.append(i4 / 1000);
        sbOooO00o.append(" kbps. Fps: ");
        sbOooO00o.append(i5);
        sbOooO00o.append(" useSurface:");
        sbOooO00o.append(z);
        ...
        if (videoCodecType == VideoCodecType.VIDEO_CODEC_H264_AVC) {
            ...
            str2 = H264_MIME_TYPE;
            encoderPropertiesFindHwEncoder = findHwEncoder(H264_MIME_TYPE, mediaCodecPropertiesArr, iArr);
            if (encoderPropertiesFindHwEncoder.supportedProfile) {
                int profileType = getProfileType(str, i7, encoderPropertiesFindHwEncoder.supportedHighProfile ? 8 : 1);
                int i11 = (i2 * i3) / PSKKeyManager.MAX_KEY_LENGTH_BYTES <= 8192 ? 2048 : ShareRequest.THUMB_DATA_SIZE_LIMIT;
                i9 = profileType;
                str4 = " x ";
                str3 = H264_MIME_TYPE;
                i10 = i11;
                encoderPropertiesFindHwEncoder = encoderPropertiesFindHwEncoder;
            } else {
                String str5 = str2;
                i10 = -1;
                i9 = -1;
            ...
            if (this.type == videoCodecType2 && encoderPropertiesFindHwEncoder.codecName.startsWith(qcomVp8HwProperties.codecPrefix) && ((i8 = Build.VERSION.SDK_INT) == 23 || i8 > 23)) {
        ...
        this.bitrateAdjustmentType = encoderPropertiesFindHwEncoder.bitrateAdjustmentType;
        int iMin = Math.min(i5, 30);
        if (this.bitrateAdjustmentType == BitrateAdjustmentType.FRAMERATE_ADJUSTMENT) {
            this.originFps = iMin;
        }
        android.util.Log.d(TAG, "Color format: " + this.colorFormat + ". Bitrate adjustment: " + this.bitrateAdjustmentType + ". Initial fps: " + iMin);
        ...
        try {
            MediaFormat mediaFormatCreateVideoFormat = MediaFormat.createVideoFormat(str3, i2, i3);
            mediaFormatCreateVideoFormat.setInteger("bitrate", this.targetBitrateBps);
            if (encoderPropertiesFindHwEncoder.supportedCBR && i7 == 0) {
            ...
            if (i9 != -1) {
                mediaFormatCreateVideoFormat.setInteger(Scopes.PROFILE, i9);
                mediaFormatCreateVideoFormat.setInteger("level", i10);
                if (i7 != 0) {
                    mediaFormatCreateVideoFormat.setInteger("priority", 1);
                    mediaFormatCreateVideoFormat.setInteger("latency", 3);
            ...
            android.util.Log.d(TAG, "Input frame stride and slice height: " + this.stride + str4 + this.sliceHeight);
