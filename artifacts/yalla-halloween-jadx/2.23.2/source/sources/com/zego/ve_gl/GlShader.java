...
public class GlShader {
    ...
    private static int compileShader(int i, String str) {
        ...
        StringBuilder sbOooO0O0 = o0000O0.OooO0O0("Could not compile shader ", i, CertificateUtil.DELIMITER);
    ...
    public int getAttribLocation(String str) {
        ...
        throw new RuntimeException(o000oOoO.OooO0O0("Could not locate '", str, "' in program"));
    }
    ...
    public int getUniformLocation(String str) {
        ...
        throw new RuntimeException(o000oOoO.OooO0O0("Could not locate uniform '", str, "' in program"));
    }
