...
public class VideoCaptureCamera extends VideoCapture implements Camera.PreviewCallback, SurfaceTextureHelper.OnTextureFrameAvailableListener {
    ...
    public static String getName(int i) {
        ...
        StringBuilder sbOooO0O0 = o0000O0.OooO0O0("camera ", i, ", facing ");
        sbOooO0O0.append(cameraInfo.facing == 1 ? "front" : "back");
    ...
    public int createCapabilities() {
        ...
        Camera.Parameters cameraParameters = getCameraParameters();
        if (cameraParameters != null) {
            String strOooO00o = OooOO0.OooO00o(new StringBuilder("\"id\":"), this.mId, ",");
            ...
            for (int i = 0; i < supportedPreviewSizes.size(); i++) {
                ...
                if (i2 >= 240 && i3 >= 240 && (i2 >= 320 || i3 >= 320)) {
                    ...
                    strOooO0O0 = !strOooO0O0.isEmpty() ? o0OoOo0.OooO0O0(strOooO0O0, ",", strOooO00o2) : strOooO00o2;
                }
            }
            ...
            strOooO0OO = o0OoOo0.OooO0OO(OooO0OO.OooO00o("{", strOooO00o, "\"resolution\":[", strOooO0O0, "],\"format\":["), str2, "],\"fps\":[", str, "]}");
        } else {
            strOooO0OO = null;
        }
        VideoCapture.cacheCapability(this.mId, this.mContext, strOooO0OO, getCaptureName());
        return 0;
    }
