...
public class VideoCaptureCamera2 extends VideoCapture implements SurfaceTextureHelper.OnTextureFrameAvailableListener {
    ...
    public static int createCapabilities(int i, Context context) {
        ...
        for (int i3 = 0; i3 < arrayList.size(); i3++) {
            ...
            if (width >= 240 && height >= 240 && (width >= 320 || height >= 320)) {
                String strOooO00o2 = o0O00o0.OooO00o("{\"w\":", width, ",\"h\":", height, "}");
                strOooO0O0 = !strOooO0O0.isEmpty() ? o0OoOo0.OooO0O0(strOooO0O0, ",", strOooO00o2) : strOooO00o2;
            }
        }
        VideoCapture.cacheCapability(i, context, o0OoOo0.OooO0OO(OooO0OO.OooO00o("{", strOooO00o, "\"resolution\":[", strOooO0O0, "],\"format\":["), "" + VideoCapture.translateToEngineFormat(35), "],\"fps\":[", strValueOf, "]}"), getCaptureName());
        return 0;
    }
    ...
    public static String getName(int i, Context context) {
        ...
        StringBuilder sbOooO0O0 = o0000O0.OooO0O0("camera2 ", i, ", facing ");
        sbOooO0O0.append(iIntValue == 0 ? "front" : "back");
