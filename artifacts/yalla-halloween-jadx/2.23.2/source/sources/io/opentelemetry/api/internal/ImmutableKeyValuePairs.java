...
public abstract class ImmutableKeyValuePairs<K, V> {
    ...
    public final Object[] f32503OooO0Oo;

    public ImmutableKeyValuePairs(Object[] objArr) {
        this.f32503OooO0Oo = objArr;
    }
    ...
    public final Map<K, V> OooO0Oo() {
        List listAsList = Arrays.asList(this.f32503OooO0Oo);
        int i = ReadOnlyArrayMap.f32512OooO0o;
        return listAsList.isEmpty() ? Collections.emptyMap() : new ReadOnlyArrayMap(listAsList);
    }

    public final void OooO0o(BiConsumer<? super K, ? super V> biConsumer) {
        int i = 0;
        while (true) {
            Object[] objArr = this.f32503OooO0Oo;
            if (i >= objArr.length) {
                return;
            }
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof ImmutableKeyValuePairs) {
            return Arrays.equals(this.f32503OooO0Oo, ((ImmutableKeyValuePairs) obj).f32503OooO0Oo);
        }
        return false;
    }

    public final int hashCode() {
        return Arrays.hashCode(this.f32503OooO0Oo) ^ 1000003;
    }

    public final boolean isEmpty() {
        return this.f32503OooO0Oo.length == 0;
    }

    public final int size() {
        return this.f32503OooO0Oo.length / 2;
    }
    ...
    public final String toString() {
        ...
        while (true) {
            ...
            String strOooO0O0 = obj instanceof String ? oo000o.OooO0O0(new StringBuilder("\""), (String) obj, Typography.quote) : obj.toString();
            sb.append(objArr[i]);
            sb.append("=");
