...
final class ArrayBasedContext implements Context {
    ...
    public static final Context f32543OooO0O0 = new ArrayBasedContext(new Object[0]);

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final Object[] f32544OooO00o;

    public ArrayBasedContext(Object[] objArr) {
        this.f32544OooO00o = objArr;
    }
    ...
    /* JADX WARN: Type inference failed for: r0v0, types: [o0OoOo0.o00000O0] */
    @Override // io.opentelemetry.context.Context
    public final o00000O0 OooO0O0(final Runnable runnable) {
        return new Runnable() { // from class: o0OoOo0.o00000O0
            @Override // java.lang.Runnable
            public final void run() throws Exception {
                Context context = (Context) this;
                Runnable runnable2 = (Runnable) runnable;
                Scope scopeOooO0o = context.OooO0o();
                try {
                    runnable2.run();
                    if (scopeOooO0o != null) {
                        scopeOooO0o.close();
    ...
    public final <V> V OooO0OO(ContextKey<V> contextKey) {
        int i = 0;
        while (true) {
            Object[] objArr = this.f32544OooO00o;
            if (i >= objArr.length) {
                return null;
            }
    ...
    public final Scope OooO0o() {
        return LazyStorage.f32549OooO0O0.OooO00o(this);
    }

    @Override // io.opentelemetry.context.Context
    public final Context OooO0o0(ImplicitContextKeyed implicitContextKeyed) {
        return implicitContextKeyed.OooO0oO(this);
    }
