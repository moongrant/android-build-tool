...
final class LazyStorage {
    ...
    public static final Logger f32548OooO00o = Logger.getLogger(LazyStorage.class.getName());

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final ContextStorage f32549OooO0O0;
    ...
    static {
        ...
        synchronized (ContextStorageWrappers.f32546OooO0O0) {
            arrayList = ContextStorageWrappers.f32545OooO00o;
        }
        Iterator it3 = arrayList.iterator();
        while (it3.hasNext()) {
            strictContextStorage = (ContextStorage) ((Function) it3.next()).apply(strictContextStorage);
        }
        f32549OooO0O0 = strictContextStorage;
        ContextStorageWrappers.OooO00o();
        Throwable th = (Throwable) atomicReference.get();
        if (th != null) {
            f32548OooO00o.log(Level.WARNING, "ContextStorageProvider initialized failed. Using default", th);
        }
    }
