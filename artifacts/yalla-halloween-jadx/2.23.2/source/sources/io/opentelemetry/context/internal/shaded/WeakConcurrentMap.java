...
public class WeakConcurrentMap<K, V> extends AbstractWeakConcurrentMap<K, V, LookupKey<K>> {
    ...
    public static final ThreadLocal<LookupKey<?>> f32573OooO0o = new ThreadLocal<LookupKey<?>>() { // from class: io.opentelemetry.context.internal.shaded.WeakConcurrentMap.1
    ...
    public final boolean f32574OooO0o0;

    public static final class LookupKey<K> {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public K f32575OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public int f32576OooO0O0;

        public final boolean equals(Object obj) {
            if (obj instanceof LookupKey) {
                return ((LookupKey) obj).f32575OooO00o == this.f32575OooO00o;
            }
            return ((AbstractWeakConcurrentMap.WeakKey) obj).get() == this.f32575OooO00o;
        }

        public final int hashCode() {
            return this.f32576OooO0O0;
        }
    }
    ...
    public static class WithInlinedExpunction<K, V> extends WeakConcurrentMap<K, V> {
        ...
        public final Object OooO0OO(Object obj) {
            LookupKey<?> lookupKey = this.f32574OooO0o0 ? WeakConcurrentMap.f32573OooO0o.get() : new LookupKey<>();
            lookupKey.f32575OooO00o = obj;
            lookupKey.f32576OooO0O0 = System.identityHashCode(obj);
            return lookupKey;
        }
        ...
        public final void OooO0o(Object obj) {
            ...
            lookupKey.f32575OooO00o = null;
            lookupKey.f32576OooO0O0 = 0;
        }
    ...
    public final void OooO00o() {
        while (true) {
            ...
            if (referencePoll == null) {
                ...
                this.f32566OooO0Oo.remove(referencePoll);
            }
        }
    }
    ...
    public Object OooO0O0(Object obj) {
        ...
        try {
            V v = this.f32566OooO0Oo.get(objOooO0OO);
            OooO0o(objOooO0OO);
            if (v == null) {
                return null;
            }
    ...
    public Object OooO0OO(Object obj) {
        LookupKey<?> lookupKey = this.f32574OooO0o0 ? f32573OooO0o.get() : new LookupKey<>();
        lookupKey.f32575OooO00o = obj;
        lookupKey.f32576OooO0O0 = System.identityHashCode(obj);
        return lookupKey;
    }
    ...
    public Object OooO0Oo(Object obj, Object obj2) {
        ...
        return this.f32566OooO0Oo.put(new AbstractWeakConcurrentMap.WeakKey<>(obj, this), obj2);
    }
    ...
    public final Object OooO0o0(Object obj) {
        ...
        Object objOooO0OO = OooO0OO(obj);
        try {
            return this.f32566OooO0Oo.remove(objOooO0OO);
        } finally {
            OooO0o(objOooO0OO);
        }
    }
