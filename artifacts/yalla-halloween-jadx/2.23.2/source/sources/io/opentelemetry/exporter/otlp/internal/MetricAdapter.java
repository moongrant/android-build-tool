...
public final class MetricAdapter {
    ...
    @NotNull
    public static final MetricAdapter f32590OooO00o = new MetricAdapter();
    ...
    public static ArrayList OooO(@NotNull Collection points) {
        ...
        while (it.hasNext()) {
            ...
            longPointData.OooO00o().OooO0o(new o0000O0O(builderNewBuilder));
    ...
    public static ArrayList OooO0oO(@NotNull Collection points) {
        ...
        while (it.hasNext()) {
            ...
            doublePointData.OooO00o().OooO0o(new o0O00O0o(builderNewBuilder));
        ...
        while (it.hasNext()) {
            ...
            if (!metricData2.OooOOO()) {
                ...
                switch (metricDataTypeOooOO0o == null ? -1 : WhenMappings.$EnumSwitchMapping$0[metricDataTypeOooOO0o.ordinal()]) {
                    case 1:
                        LongSumData longSumData = metricData2.OooOO0o() == MetricDataType.LONG_SUM ? (LongSumData) metricData2.OooO0oO() : MetricData.f32759OooO0Oo;
                        ...
                        break;
                    case 2:
                        DoubleSumData doubleSumData = metricData2.OooOO0o() == MetricDataType.DOUBLE_SUM ? (DoubleSumData) metricData2.OooO0oO() : MetricData.f32758OooO0OO;
                        ...
                        break;
                    case 3:
                        DoubleSummaryData doubleSummaryData = metricData2.OooOO0o() == MetricDataType.SUMMARY ? (DoubleSummaryData) metricData2.OooO0oO() : MetricData.f32761OooO0o0;
                        ...
                        for (DoubleSummaryPointData doubleSummaryPointData : points) {
                            ...
                            doubleSummaryPointData.OooO00o().OooO0o(new OooOo00(builderNewBuilder5));
                        ...
                        break;
                    case 4:
                        LongGaugeData longGaugeData = metricData2.OooOO0o() == MetricDataType.LONG_GAUGE ? (LongGaugeData) metricData2.OooO0oO() : MetricData.f32757OooO0O0;
                        ...
                        break;
                    case 5:
                        DoubleGaugeData doubleGaugeData = metricData2.OooOO0o() == MetricDataType.DOUBLE_GAUGE ? (DoubleGaugeData) metricData2.OooO0oO() : MetricData.f32756OooO00o;
                        ...
                        break;
                    case 6:
                        DoubleHistogramData doubleHistogramData = metricData2.OooOO0o() == MetricDataType.HISTOGRAM ? (DoubleHistogramData) metricData2.OooO0oO() : MetricData.f32760OooO0o;
                        ...
                        for (DoubleHistogramPointData doubleHistogramPointData : points2) {
                            ...
                            doubleHistogramPointData.OooO00o().OooO0o(new o0000O0(builderNewBuilder10, 3));
