...
final class ResourceAdapter {
    ...
    public static final WeakConcurrentMap.WithInlinedExpunction f32594OooO00o = new WeakConcurrentMap.WithInlinedExpunction();

    private ResourceAdapter() {
    }

    public static Resource OooO00o(io.opentelemetry.sdk.resources.Resource resource) {
        WeakConcurrentMap.WithInlinedExpunction withInlinedExpunction = f32594OooO00o;
        ...
        resource.OooO0O0().OooO0o(new BiConsumer() { // from class: io.opentelemetry.exporter.otlp.internal.OooO00o
            @Override // io.opentelemetry.compat.BiConsumer
            public final void accept(Object obj, Object obj2) {
                WeakConcurrentMap.WithInlinedExpunction withInlinedExpunction2 = ResourceAdapter.f32594OooO00o;
