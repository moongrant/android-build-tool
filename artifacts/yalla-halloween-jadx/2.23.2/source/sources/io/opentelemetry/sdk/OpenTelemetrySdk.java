...
public final class OpenTelemetrySdk implements OpenTelemetry {
    ...
    public final ObfuscatedTracerProvider f32651OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final ContextPropagators f32652OooO0O0;

    @ThreadSafe
    public static class ObfuscatedTracerProvider implements TracerProvider {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final SdkTracerProvider f32653OooO0Oo;

        public ObfuscatedTracerProvider(SdkTracerProvider sdkTracerProvider) {
            this.f32653OooO0Oo = sdkTracerProvider;
        }

        public final Tracer OooO00o(String str) {
            return this.f32653OooO0Oo.OooO00o(str);
        }

        public final TracerBuilder OooO0O0(String str) {
            return this.f32653OooO0Oo.OooO0oO(str);
        }
    ...
    public OpenTelemetrySdk(ObfuscatedTracerProvider obfuscatedTracerProvider, ContextPropagators contextPropagators) {
        this.f32651OooO00o = obfuscatedTracerProvider;
        this.f32652OooO0O0 = contextPropagators;
    }

    public final Tracer OooO00o(String str) {
        return this.f32651OooO00o.OooO00o(str);
    }

    public final TracerBuilder OooO0O0(String str) {
        return this.f32651OooO00o.OooO0O0(str);
    }
}
