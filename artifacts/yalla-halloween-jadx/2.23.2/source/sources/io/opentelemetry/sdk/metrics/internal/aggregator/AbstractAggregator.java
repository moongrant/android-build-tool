...
public abstract class AbstractAggregator<T> implements Aggregator<T> {
    ...
    public final Resource f32781OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final InstrumentationLibraryInfo f32782OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final MetricDescriptor f32783OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final boolean f32784OooO0Oo;
    ...
    public AbstractAggregator(Resource resource, InstrumentationLibraryInfo instrumentationLibraryInfo, MetricDescriptor metricDescriptor, boolean z) {
        this.f32781OooO00o = resource;
        this.f32782OooO0O0 = instrumentationLibraryInfo;
        this.f32783OooO0OO = metricDescriptor;
        this.f32784OooO0Oo = z;
    }
