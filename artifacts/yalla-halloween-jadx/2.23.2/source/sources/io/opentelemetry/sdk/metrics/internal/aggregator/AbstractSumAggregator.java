...
abstract class AbstractSumAggregator<T> extends AbstractAggregator<T> {
    ...
    public final AggregationTemporality f32785OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final boolean f32786OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final MergeStrategy f32787OooO0oO;
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        public static final /* synthetic */ int[] f32788OooO00o;
        ...
        static {
            ...
            try {
                f32788OooO00o[MergeStrategy.DIFF.ordinal()] = 2;
    ...
    public AbstractSumAggregator(Resource resource, InstrumentationLibraryInfo instrumentationLibraryInfo, InstrumentDescriptor instrumentDescriptor, MetricDescriptor metricDescriptor, AggregationTemporality aggregationTemporality) {
        ...
        this.f32786OooO0o0 = instrumentTypeOooO0Oo2 == InstrumentType.COUNTER || instrumentTypeOooO0Oo2 == instrumentType;
        this.f32785OooO0o = aggregationTemporality;
        this.f32787OooO0oO = ((instrumentTypeOooO0Oo2 == instrumentType || instrumentTypeOooO0Oo2 == InstrumentType.OBSERVABLE_UP_DOWN_SUM) && aggregationTemporality == AggregationTemporality.DELTA) ? MergeStrategy.DIFF : MergeStrategy.SUM;
    }

    @Override // io.opentelemetry.sdk.metrics.internal.aggregator.Aggregator
    public final T OooO0O0(T t, T t2) {
        int[] iArr = AnonymousClass1.f32788OooO00o;
        MergeStrategy mergeStrategy = this.f32787OooO0oO;
