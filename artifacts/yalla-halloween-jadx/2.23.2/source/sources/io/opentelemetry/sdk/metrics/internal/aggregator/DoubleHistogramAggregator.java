...
final class DoubleHistogramAggregator extends AbstractAggregator<HistogramAccumulation> {
    ...
    public final List<Double> f32800OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final double[] f32801OooO0o0;

    public static final class Handle extends AggregatorHandle<HistogramAccumulation> {

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final double[] f32802OooO0OO;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final long[] f32805OooO0o0;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final ReentrantLock f32804OooO0o = new ReentrantLock();

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public double f32803OooO0Oo = 0.0d;

        public Handle(double[] dArr) {
            this.f32802OooO0OO = dArr;
            this.f32805OooO0o0 = new long[dArr.length + 1];
        }

        @Override // io.opentelemetry.sdk.metrics.internal.aggregator.AggregatorHandle
        public final HistogramAccumulation OooO0O0() {
            long[] jArr = this.f32805OooO0o0;
            ReentrantLock reentrantLock = this.f32804OooO0o;
            reentrantLock.lock();
            try {
                AutoValue_HistogramAccumulation autoValue_HistogramAccumulation = new AutoValue_HistogramAccumulation(this.f32803OooO0Oo, Arrays.copyOf(jArr, jArr.length));
                this.f32803OooO0Oo = 0.0d;
                Arrays.fill(jArr, 0L);
        ...
        public final void OooO0OO() {
            ...
            int length = 0;
            while (true) {
                double[] dArr = this.f32802OooO0OO;
    ...
    public DoubleHistogramAggregator(Resource resource, InstrumentationLibraryInfo instrumentationLibraryInfo, MetricDescriptor metricDescriptor, double[] dArr, boolean z) {
        ...
        this.f32801OooO0o0 = dArr;
        ArrayList arrayList = new ArrayList(dArr.length);
        for (double d : dArr) {
            arrayList.add(Double.valueOf(d));
        }
        this.f32800OooO0o = Collections.unmodifiableList(arrayList);
    }
    ...
    public final Object OooO00o(long j) {
        double d = j;
        double[] dArr = this.f32801OooO0o0;
    ...
    public final AggregatorHandle<HistogramAccumulation> OooO0OO() {
        return new Handle(this.f32801OooO0o0);
    }
    ...
    public final MetricData OooO0Oo(Map<Attributes, HistogramAccumulation> map, long j, long j2, long j3) {
        ...
        for (Map.Entry<Attributes, HistogramAccumulation> entry : map.entrySet()) {
            ...
            arrayList3.add(DoubleHistogramPointData.OooO0OO(j4, j3, key, value.OooO0O0(), list, arrayList2));
