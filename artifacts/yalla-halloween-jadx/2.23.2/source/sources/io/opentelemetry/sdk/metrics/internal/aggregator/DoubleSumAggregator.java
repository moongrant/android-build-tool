...
final class DoubleSumAggregator extends AbstractSumAggregator<Double> {
    ...
    public static final class CompatHandle extends AggregatorHandle<Double> {
        ...
        public final AtomicDouble f32811OooO0OO = new AtomicDouble();

        @Override // io.opentelemetry.sdk.metrics.internal.aggregator.AggregatorHandle
        public final Double OooO0O0() {
            AtomicDouble atomicDouble = this.f32811OooO0OO;
            atomicDouble.getClass();
            return Double.valueOf(Double.longBitsToDouble(atomicDouble.f19307OooO0Oo.getAndSet(Double.doubleToRawLongBits(0.0d))));
        }
    }
    ...
    public static final class Handle extends AggregatorHandle<Double> {
        ...
        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final DoubleAdder f32812OooO0OO = OooO.OooO00o();

        @Override // io.opentelemetry.sdk.metrics.internal.aggregator.AggregatorHandle
        public final Double OooO0O0() {
            return Double.valueOf(this.f32812OooO0OO.sumThenReset());
        }
    }
    ...
    public final MetricData OooO0Oo(Map<Attributes, Double> map, long j, long j2, long j3) {
        ...
        return MetricData.OooO0OO(resource, instrumentationLibraryInfo, strOooO0OO, strOooO0O0, strOooO0Oo, DoubleSumData.OooO0Oo(aggregationTemporality2, MetricDataUtils.OooO00o(map, j, j3), this.f32786OooO0o0));
    }
