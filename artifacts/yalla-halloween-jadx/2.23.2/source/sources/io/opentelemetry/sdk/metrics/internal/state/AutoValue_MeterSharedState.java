...
final class AutoValue_MeterSharedState extends MeterSharedState {
    ...
    public final InstrumentationLibraryInfo f32845OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final MetricStorageRegistry f32846OooO0OO;
    ...
    public final boolean equals(Object obj) {
        ...
        return this.f32845OooO0O0.equals(meterSharedState.OooO0O0()) && this.f32846OooO0OO.equals(meterSharedState.OooO0OO());
    }

    public final int hashCode() {
        return ((this.f32845OooO0O0.hashCode() ^ 1000003) * 1000003) ^ this.f32846OooO0OO.hashCode();
    }

    public final String toString() {
        return "MeterSharedState{instrumentationLibraryInfo=" + this.f32845OooO0O0 + ", metricStorageRegistry=" + this.f32846OooO0OO + "}";
    }
}
