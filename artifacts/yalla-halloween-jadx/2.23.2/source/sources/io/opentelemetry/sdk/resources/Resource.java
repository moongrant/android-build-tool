...
public abstract class Resource {
    ...
    public static final Logger f32904OooO00o = Logger.getLogger(Resource.class.getName());

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final Resource f32905OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final Resource f32906OooO0OO;

    static {
        Resource resourceOooO00o;
        OooO00o(OooO.OooO0O0(), null);
        f32905OooO0O0 = OooO00o(OooO.OooO0OO(ResourceAttributes.f32910OooO0Oo, "unknown_service:java"), null);
        AttributesBuilder attributesBuilderOooO00o = OooO.OooO00o();
        attributesBuilderOooO00o.OooO0Oo(ResourceAttributes.f32912OooO0o0, "opentelemetry");
        attributesBuilderOooO00o.OooO0Oo(ResourceAttributes.f32911OooO0o, "java");
        InternalAttributeKeyImpl internalAttributeKeyImpl = ResourceAttributes.f32913OooO0oO;
        ...
        Resource resource = f32905OooO0O0;
        resource.getClass();
        ...
        attributesBuilderOooO00o2.OooO0OO(autoValue_Resource.f32903OooO0o0);
        AutoValue_Resource autoValue_Resource2 = (AutoValue_Resource) resourceOooO00o2;
        attributesBuilderOooO00o2.OooO0OO(autoValue_Resource2.f32903OooO0o0);
        String str = autoValue_Resource.f32902OooO0Oo;
        String str2 = autoValue_Resource2.f32902OooO0Oo;
        if (str2 == null) {
            ...
            f32904OooO00o.info("Attempting to merge Resources with different schemaUrls. The resulting Resource will have no schemaUrl assigned. Schema 1: " + str + " Schema 2: " + str2);
            resourceOooO00o = OooO00o(attributesBuilderOooO00o2.build(), null);
        }
        f32906OooO0OO = resourceOooO00o;
    }

    public static Resource OooO00o(Attributes attributes, @Nullable String str) {
        Objects.requireNonNull(attributes, "attributes");
        attributes.OooO0o(new BiConsumer<AttributeKey<?>, Object>() { // from class: io.opentelemetry.sdk.resources.Resource.1
            ...
            public final void accept(AttributeKey<?> attributeKey, Object obj) {
                ...
                Logger logger = Resource.f32904OooO00o;
                boolean z3 = false;
