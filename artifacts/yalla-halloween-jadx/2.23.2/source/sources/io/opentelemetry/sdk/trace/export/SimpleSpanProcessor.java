...
public final class SimpleSpanProcessor implements SpanProcessor {
    ...
    public static final Logger f33046OooO0Oo = Logger.getLogger(SimpleSpanProcessor.class.getName());
    ...
    public final void o0000Oo(ReadableSpan readableSpan) {
        try {
            Collections.singletonList(readableSpan.OooO0Oo());
            throw null;
        } catch (RuntimeException e) {
            f33046OooO0Oo.log(Level.WARNING, "Exporter threw an Exception", (Throwable) e);
        }
    }
