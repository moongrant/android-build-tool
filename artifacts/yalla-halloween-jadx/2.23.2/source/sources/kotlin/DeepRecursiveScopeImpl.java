...
final class DeepRecursiveScopeImpl<T, R> extends DeepRecursiveScope<T, R> implements Continuation<R> {
    ...
    public final R runCallLoop() {
        while (true) {
            ...
            if (Result.m4217equalsimpl0(DeepRecursiveKt.UNDEFINED_RESULT, r)) {
                try {
                    ...
                    if (objWrapWithContinuationImpl != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                        continuation.resumeWith(Result.m4215constructorimpl(objWrapWithContinuationImpl));
                    }
                } catch (Throwable th) {
                    Result.Companion companion = Result.INSTANCE;
                    continuation.resumeWith(Result.m4215constructorimpl(ResultKt.createFailure(th)));
                }
            } else {
                this.result = DeepRecursiveKt.UNDEFINED_RESULT;
