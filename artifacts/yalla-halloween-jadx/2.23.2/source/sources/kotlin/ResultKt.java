...
public final class ResultKt {
    ...
    private static final <R, T> R fold(Object obj, Function1<? super T, ? extends R> onSuccess, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        Throwable thM4218exceptionOrNullimpl = Result.m4218exceptionOrNullimpl(obj);
        return thM4218exceptionOrNullimpl == null ? onSuccess.invoke(obj) : onFailure.invoke(thM4218exceptionOrNullimpl);
    }
    ...
    private static final <R, T extends R> R getOrDefault(Object obj, R r) {
        return Result.m4221isFailureimpl(obj) ? r : obj;
    }
    ...
    private static final <R, T extends R> R getOrElse(Object obj, Function1<? super Throwable, ? extends R> onFailure) {
        Intrinsics.checkNotNullParameter(onFailure, "onFailure");
        Throwable thM4218exceptionOrNullimpl = Result.m4218exceptionOrNullimpl(obj);
        return thM4218exceptionOrNullimpl == null ? obj : onFailure.invoke(thM4218exceptionOrNullimpl);
    }
    ...
    private static final <R, T> Object map(Object obj, Function1<? super T, ? extends R> transform) {
        ...
        return Result.m4222isSuccessimpl(obj) ? Result.m4215constructorimpl(transform.invoke(obj)) : Result.m4215constructorimpl(obj);
    }
    ...
    private static final <R, T> Object mapCatching(Object obj, Function1<? super T, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        if (!Result.m4222isSuccessimpl(obj)) {
            return Result.m4215constructorimpl(obj);
        }
        try {
            return Result.m4215constructorimpl(transform.invoke(obj));
        } catch (Throwable th) {
            Result.Companion companion = Result.INSTANCE;
            return Result.m4215constructorimpl(createFailure(th));
        }
    }
    ...
    private static final <T> Object onFailure(Object obj, Function1<? super Throwable, Unit> action) {
        ...
        if (thM4218exceptionOrNullimpl != null) {
            action.invoke(thM4218exceptionOrNullimpl);
        }
        return obj;
    }
    ...
    private static final <R, T extends R> Object recover(Object obj, Function1<? super Throwable, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        Throwable thM4218exceptionOrNullimpl = Result.m4218exceptionOrNullimpl(obj);
        return thM4218exceptionOrNullimpl == null ? obj : Result.m4215constructorimpl(transform.invoke(thM4218exceptionOrNullimpl));
    }
    ...
    private static final <R, T extends R> Object recoverCatching(Object obj, Function1<? super Throwable, ? extends R> transform) {
        ...
        try {
            return Result.m4215constructorimpl(transform.invoke(thM4218exceptionOrNullimpl));
        } catch (Throwable th) {
            Result.Companion companion = Result.INSTANCE;
            return Result.m4215constructorimpl(createFailure(th));
        }
    ...
    private static final <R> Object runCatching(Function0<? extends R> block) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            return Result.m4215constructorimpl(block.invoke());
        } catch (Throwable th) {
    ...
    private static final <T, R> Object runCatching(T t, Function1<? super T, ? extends R> block) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            return Result.m4215constructorimpl(block.invoke(t));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.m4215constructorimpl(createFailure(th));
        }
