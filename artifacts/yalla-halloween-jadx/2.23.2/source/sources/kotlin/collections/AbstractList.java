    ...
    public static final class Companion {
        ...
        public final void checkBoundsIndexes$kotlin_stdlib(int startIndex, int endIndex, int size) {
            if (startIndex < 0 || endIndex > size) {
                StringBuilder sbOooO00o = o00000.OooO00o("startIndex: ", startIndex, ", endIndex: ", endIndex, ", size: ");
                sbOooO00o.append(size);
                throw new IndexOutOfBoundsException(sbOooO00o.toString());
            }
            if (startIndex > endIndex) {
                throw new IllegalArgumentException(androidx.compose.compiler.plugins.kotlin.lower.OooO0O0.OooO0O0("startIndex: ", startIndex, " > endIndex: ", endIndex));
            }
        }

        public final void checkElementIndex$kotlin_stdlib(int index, int size) {
            if (index < 0 || index >= size) {
                throw new IndexOutOfBoundsException(androidx.compose.compiler.plugins.kotlin.lower.OooO0O0.OooO0O0("index: ", index, ", size: ", size));
            }
        }
        ...
        public final void checkRangeIndexes$kotlin_stdlib(int fromIndex, int toIndex, int size) {
            if (fromIndex < 0 || toIndex > size) {
                StringBuilder sbOooO00o = o00000.OooO00o("fromIndex: ", fromIndex, ", toIndex: ", toIndex, ", size: ");
                sbOooO00o.append(size);
                throw new IndexOutOfBoundsException(sbOooO00o.toString());
            }
            if (fromIndex > toIndex) {
                throw new IllegalArgumentException(androidx.compose.compiler.plugins.kotlin.lower.OooO0O0.OooO0O0("fromIndex: ", fromIndex, " > toIndex: ", toIndex));
            }
        }
