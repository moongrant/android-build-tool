...
public class CollectionsKt__ReversedViewsKt extends CollectionsKt__MutableCollectionsKt {
    ...
    public static final int reverseElementIndex$CollectionsKt__ReversedViewsKt(List<?> list, int i) {
        ...
        StringBuilder sbOooO0O0 = o0000O0.OooO0O0("Element index ", i, " must be in range [");
        sbOooO0O0.append(new IntRange(0, CollectionsKt__CollectionsKt.getLastIndex(list)));
        sbOooO0O0.append("].");
    ...
    public static final int reversePositionIndex$CollectionsKt__ReversedViewsKt(List<?> list, int i) {
        ...
        StringBuilder sbOooO0O0 = o0000O0.OooO0O0("Position index ", i, " must be in range [");
        sbOooO0O0.append(new IntRange(0, list.size()));
        sbOooO0O0.append("].");
        throw new IndexOutOfBoundsException(sbOooO0O0.toString());
    }
}
