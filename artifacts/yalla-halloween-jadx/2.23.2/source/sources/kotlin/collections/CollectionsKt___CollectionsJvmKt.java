...
public class CollectionsKt___CollectionsJvmKt extends CollectionsKt__ReversedViewsKt {
    ...
    public static final /* synthetic */ Double m4642max(Iterable iterable) {
        Intrinsics.checkNotNullParameter(iterable, "<this>");
        return CollectionsKt___CollectionsKt.m4650maxOrNull((Iterable<Double>) iterable);
    }
    ...
    public static final /* synthetic */ <T, R extends Comparable<? super R>> T maxBy(Iterable<? extends T> iterable, Function1<? super T, ? extends R> function1) {
        Iterator itOooO00o = OooO0o.OooO00o(iterable, "<this>", function1, "selector");
    ...
    public static final /* synthetic */ Double m4644min(Iterable iterable) {
        Intrinsics.checkNotNullParameter(iterable, "<this>");
        return CollectionsKt___CollectionsKt.m4658minOrNull((Iterable<Double>) iterable);
    }
    ...
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* JADX INFO: renamed from: max, reason: collision with other method in class */
    public static final /* synthetic */ Float m4643max(Iterable iterable) {
        Intrinsics.checkNotNullParameter(iterable, "<this>");
        return CollectionsKt___CollectionsKt.m4651maxOrNull((Iterable<Float>) iterable);
    }
    ...
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* JADX INFO: renamed from: min, reason: collision with other method in class */
    public static final /* synthetic */ Float m4645min(Iterable iterable) {
        Intrinsics.checkNotNullParameter(iterable, "<this>");
        return CollectionsKt___CollectionsKt.m4659minOrNull((Iterable<Float>) iterable);
    }
