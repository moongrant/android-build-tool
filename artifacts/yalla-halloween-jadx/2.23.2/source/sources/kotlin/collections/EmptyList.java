...
public final class EmptyList implements List, Serializable, RandomAccess, KMappedMarker {
    ...
    public List subList(int fromIndex, int toIndex) {
        ...
        throw new IndexOutOfBoundsException(androidx.compose.compiler.plugins.kotlin.lower.OooO0O0.OooO0O0("fromIndex: ", fromIndex, ", toIndex: ", toIndex));
    }
    ...
    public Void get(int index) {
        throw new IndexOutOfBoundsException(androidx.compose.animation.core.OooO0OO.OooO00o("Empty list doesn't contain element at index ", index, '.'));
    }
    ...
    public ListIterator listIterator(int index) {
        ...
        throw new IndexOutOfBoundsException(android.support.v4.media.OooO00o.OooO00o("Index: ", index));
    }
