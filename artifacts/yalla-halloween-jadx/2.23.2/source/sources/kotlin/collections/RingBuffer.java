...
final class RingBuffer<T> extends AbstractList<T> implements RandomAccess {
    ...
    public RingBuffer(@NotNull Object[] buffer, int i) {
        ...
        if (i <= buffer.length) {
            ...
            StringBuilder sbOooO0O0 = o0000O0.OooO0O0("ring buffer filled size: ", i, " cannot be larger than the buffer size: ");
            sbOooO0O0.append(buffer.length);
    ...
    public final void removeFirst(int n) {
        ...
        if (!(n <= size())) {
            StringBuilder sbOooO0O0 = o0000O0.OooO0O0("n shouldn't be greater than the buffer size: n = ", n, ", size = ");
