...
class FilesKt__FilePathComponentsKt {
    ...
    private static final int getRootLength$FilesKt__FilePathComponentsKt(String str) {
        ...
        int iIndexOf$default2 = StringsKt__StringsKt.indexOf$default(str, File.separatorChar, 0, false, 4, (Object) null);
        ...
        if (str.length() > 1) {
            ...
            if (cCharAt == c && (iIndexOf$default = StringsKt__StringsKt.indexOf$default(str, c, 2, false, 4, (Object) null)) >= 0) {
                int iIndexOf$default3 = StringsKt__StringsKt.indexOf$default(str, File.separatorChar, iIndexOf$default + 1, false, 4, (Object) null);
    ...
    public static final FilePathComponents toComponents(@NotNull File file) {
        ...
        if (strSubstring2.length() == 0) {
            ...
            ArrayList arrayList = new ArrayList(CollectionsKt.OooO0oo(listSplit$default));
