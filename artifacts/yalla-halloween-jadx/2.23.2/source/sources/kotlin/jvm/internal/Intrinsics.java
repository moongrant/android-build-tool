...
public class Intrinsics {
    ...
    public static void checkExpressionValueIsNotNull(Object obj, String str) {
        if (obj == null) {
            throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException(OooOOOO.OooO00o(str, " must not be null"))));
        }
    }

    public static void checkFieldIsNotNull(Object obj, String str, String str2) {
        if (obj == null) {
            throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException(o00Ooo.OooO00o("Field specified as non-null is null: ", str, ".", str2))));
        }
    }
    ...
    public static void checkHasClass(String str) throws ClassNotFoundException {
        ...
        try {
            ...
            throw ((ClassNotFoundException) sanitizeStackTrace(new ClassNotFoundException(o000oOoO.OooO0O0("Class ", strReplace, " is not found. Please update the Kotlin runtime to the latest version"), e)));
        }
    }
    ...
    public static void checkNotNullExpressionValue(Object obj, String str) {
        if (obj == null) {
            throw ((NullPointerException) sanitizeStackTrace(new NullPointerException(OooOOOO.OooO00o(str, " must not be null"))));
        }
    }
    ...
    public static void checkReturnedValueIsNotNull(Object obj, String str, String str2) {
        if (obj == null) {
            throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException(o00Ooo.OooO00o("Method specified as non-null returned null: ", str, ".", str2))));
        }
    }
    ...
    private static String createParameterIsNullExceptionMessage(String str) {
        ...
        StringBuilder sbOooO00o = OooO0OO.OooO00o("Parameter specified as non-null is null: method ", stackTraceElement.getClassName(), ".", stackTraceElement.getMethodName(), ", parameter ");
    ...
    public static void checkHasClass(String str, String str2) throws ClassNotFoundException {
        ...
        try {
            ...
            throw ((ClassNotFoundException) sanitizeStackTrace(new ClassNotFoundException(o00Ooo.OooO00o("Class ", strReplace, " is not found: this code requires the Kotlin runtime of version at least ", str2), e)));
        }
    }
