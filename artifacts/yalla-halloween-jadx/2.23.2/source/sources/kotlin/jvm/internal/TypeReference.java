...
public final class TypeReference implements KType {
    ...
    private final String asString(boolean convertPrimitiveToWrapper) {
        ...
        String strOooO0O0 = o0OoOo0.OooO0O0(name, getArguments().isEmpty() ? "" : CollectionsKt___CollectionsKt.joinToString$default(getArguments(), ", ", "<", ">", 0, null, new Function1<KTypeProjection, CharSequence>() { // from class: kotlin.jvm.internal.TypeReference$asString$args$1
            {
                super(1);
            }
        ...
        if (Intrinsics.areEqual(strAsString, strOooO0O0)) {
            return strOooO0O0;
        }
        if (Intrinsics.areEqual(strAsString, strOooO0O0 + '?')) {
            return strOooO0O0 + '!';
        }
        return "(" + strOooO0O0 + ".." + strAsString + ')';
    }
    ...
    public String toString() {
        return o0oOO.OooO0O0(new StringBuilder(), asString(false), " (Kotlin reflection is not available)");
    }
