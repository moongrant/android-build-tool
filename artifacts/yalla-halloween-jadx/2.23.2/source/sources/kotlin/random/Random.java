...
public abstract class Random {
    ...
    public byte[] nextBytes(@NotNull byte[] array, int fromIndex, int toIndex) {
        ...
        if (!(new IntRange(0, array.length).contains(fromIndex) && new IntRange(0, array.length).contains(toIndex))) {
            throw new IllegalArgumentException(OooO0O0.OooO00o(o00000.OooO00o("fromIndex (", fromIndex, ") or toIndex (", toIndex, ") are out of range: 0.."), array.length, '.').toString());
        }
        if (!(fromIndex <= toIndex)) {
            throw new IllegalArgumentException(o0O00o0.OooO00o("fromIndex (", fromIndex, ") must be not greater than toIndex (", toIndex, ").").toString());
        }
