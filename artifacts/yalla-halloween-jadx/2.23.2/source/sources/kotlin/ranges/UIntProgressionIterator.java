...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m4304boximpl(m5439nextpVg5ArA());
    }

    /* JADX INFO: renamed from: next-pVg5ArA, reason: not valid java name */
    public int m5439nextpVg5ArA() {
        int i = this.next;
        if (i != this.finalElement) {
            this.next = UInt.m4310constructorimpl(this.step + i);
        } else {
            if (!this.hasNext) {
    ...
    private UIntProgressionIterator(int i, int i2, int i3) {
        ...
        boolean z = true;
        int iCompare = Integer.compare(i ^ Integer.MIN_VALUE, Integer.MIN_VALUE ^ i2);
        if (i3 <= 0 ? iCompare < 0 : iCompare > 0) {
            z = false;
        }
        this.hasNext = z;
        this.step = UInt.m4310constructorimpl(i3);
