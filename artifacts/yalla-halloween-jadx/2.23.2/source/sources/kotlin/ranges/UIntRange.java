...
public final class UIntRange extends UIntProgression implements ClosedRange<UInt>, OpenEndRange<UInt> {
    ...
    public static /* synthetic */ void m5440getEndExclusivepVg5ArA$annotations() {
    }

    @Override // kotlin.ranges.ClosedRange, kotlin.ranges.OpenEndRange
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m5441containsWZ4Q5Ns(((UInt) comparable).getData());
    }

    /* JADX INFO: renamed from: contains-WZ4Q5Ns, reason: not valid java name */
    public boolean m5441containsWZ4Q5Ns(int value) {
    ...
    public /* bridge */ /* synthetic */ Comparable getEndExclusive() {
        return UInt.m4304boximpl(m5442getEndExclusivepVg5ArA());
    }

    /* JADX INFO: renamed from: getEndExclusive-pVg5ArA, reason: not valid java name */
    public int m5442getEndExclusivepVg5ArA() {
        if (getLast() != -1) {
            return UInt.m4310constructorimpl(getLast() + 1);
        }
    ...
    public /* bridge */ /* synthetic */ Comparable getEndInclusive() {
        return UInt.m4304boximpl(m5443getEndInclusivepVg5ArA());
    }

    /* JADX INFO: renamed from: getEndInclusive-pVg5ArA, reason: not valid java name */
    public int m5443getEndInclusivepVg5ArA() {
        return getLast();
    }

    @Override // kotlin.ranges.ClosedRange, kotlin.ranges.OpenEndRange
    public /* bridge */ /* synthetic */ Comparable getStart() {
        return UInt.m4304boximpl(m5444getStartpVg5ArA());
    }

    /* JADX INFO: renamed from: getStart-pVg5ArA, reason: not valid java name */
    public int m5444getStartpVg5ArA() {
        return getFirst();
    }
    ...
    public String toString() {
        return ((Object) UInt.m4356toStringimpl(getFirst())) + ".." + ((Object) UInt.m4356toStringimpl(getLast()));
    }
