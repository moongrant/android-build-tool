...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final ULongProgression m5447fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM4389constructorimpl = ((int) ULong.m4389constructorimpl(j ^ ULong.m4389constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM4389constructorimpl2 = (iM4389constructorimpl + ((int) ULong.m4389constructorimpl(j2 ^ ULong.m4389constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return iM4389constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }

    public boolean isEmpty() {
        long j = this.step;
        long j2 = this.first ^ Long.MIN_VALUE;
        long j3 = Long.MIN_VALUE ^ this.last;
        if (j > 0) {
            if (Long.compare(j2, j3) > 0) {
                return true;
            }
        } else if (Long.compare(j2, j3) < 0) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m4435toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) ULong.m4435toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m5421getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
}
