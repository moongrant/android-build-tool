...
public class URangesKt___URangesKt {
    ...
    public static final short m5454coerceAtLeast5PvTz6A(short s, short s2) {
    ...
    public static final int m5455coerceAtLeastJ1ME1BU(int i, int i2) {
    ...
    public static final byte m5456coerceAtLeastKr8caGY(byte b, byte b2) {
    ...
    public static final long m5457coerceAtLeasteb3DHEI(long j, long j2) {
    ...
    public static final short m5458coerceAtMost5PvTz6A(short s, short s2) {
        return Intrinsics.compare(s & UShort.MAX_VALUE, 65535 & s2) > 0 ? s2 : s;
    }
    ...
    public static final int m5459coerceAtMostJ1ME1BU(int i, int i2) {
        return Integer.compare(i ^ Integer.MIN_VALUE, Integer.MIN_VALUE ^ i2) > 0 ? i2 : i;
    }
    ...
    public static final byte m5460coerceAtMostKr8caGY(byte b, byte b2) {
        return Intrinsics.compare(b & UByte.MAX_VALUE, b2 & UByte.MAX_VALUE) > 0 ? b2 : b;
    }
    ...
    public static final long m5461coerceAtMosteb3DHEI(long j, long j2) {
        return Long.compare(j ^ Long.MIN_VALUE, Long.MIN_VALUE ^ j2) > 0 ? j2 : j;
    }
    ...
    public static final long m5462coerceInJPwROB0(long j, @NotNull ClosedRange<ULong> range) {
        Intrinsics.checkNotNullParameter(range, "range");
        if (range instanceof ClosedFloatingPointRange) {
            return ((ULong) RangesKt___RangesKt.coerceIn(ULong.m4383boximpl(j), (ClosedFloatingPointRange<ULong>) range)).getData();
        }
        if (range.isEmpty()) {
    ...
    public static final short m5463coerceInVKSA0NQ(short s, short s2, short s3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) UShort.m4540toStringimpl(s3)) + " is less than minimum " + ((Object) UShort.m4540toStringimpl(s2)) + '.');
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    /* JADX INFO: renamed from: coerceIn-WZ9TVnA, reason: not valid java name */
    public static final int m5464coerceInWZ9TVnA(int i, int i2, int i3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) UInt.m4356toStringimpl(i3)) + " is less than minimum " + ((Object) UInt.m4356toStringimpl(i2)) + '.');
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    /* JADX INFO: renamed from: coerceIn-b33U2AM, reason: not valid java name */
    public static final byte m5465coerceInb33U2AM(byte b, byte b2, byte b3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) UByte.m4277toStringimpl(b3)) + " is less than minimum " + ((Object) UByte.m4277toStringimpl(b2)) + '.');
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    /* JADX INFO: renamed from: coerceIn-sambcqE, reason: not valid java name */
    public static final long m5466coerceInsambcqE(long j, long j2, long j3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) ULong.m4435toStringimpl(j3)) + " is less than minimum " + ((Object) ULong.m4435toStringimpl(j2)) + '.');
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    /* JADX INFO: renamed from: coerceIn-wuiCnnA, reason: not valid java name */
    public static final int m5467coerceInwuiCnnA(int i, @NotNull ClosedRange<UInt> range) {
        Intrinsics.checkNotNullParameter(range, "range");
        if (range instanceof ClosedFloatingPointRange) {
            return ((UInt) RangesKt___RangesKt.coerceIn(UInt.m4304boximpl(i), (ClosedFloatingPointRange<UInt>) range)).getData();
        }
        if (range.isEmpty()) {
            throw new IllegalArgumentException("Cannot coerce value to an empty range: " + range + '.');
        }
    ...
    public static final boolean m5468contains68kG9v0(@NotNull UIntRange contains, byte b) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m5441containsWZ4Q5Ns(UInt.m4310constructorimpl(b & UByte.MAX_VALUE));
    }
    ...
    private static final boolean m5469containsGYNo2lE(ULongRange contains, ULong uLong) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return uLong != null && contains.m5450containsVKZWuLQ(uLong.getData());
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    /* JADX INFO: renamed from: contains-Gab390E, reason: not valid java name */
    public static final boolean m5470containsGab390E(@NotNull ULongRange contains, int i) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m5450containsVKZWuLQ(ULong.m4389constructorimpl(((long) i) & 4294967295L));
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    /* JADX INFO: renamed from: contains-ULb-yJY, reason: not valid java name */
    public static final boolean m5471containsULbyJY(@NotNull ULongRange contains, byte b) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m5450containsVKZWuLQ(ULong.m4389constructorimpl(((long) b) & 255));
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    /* JADX INFO: renamed from: contains-ZsK3CEQ, reason: not valid java name */
    public static final boolean m5472containsZsK3CEQ(@NotNull UIntRange contains, short s) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m5441containsWZ4Q5Ns(UInt.m4310constructorimpl(s & UShort.MAX_VALUE));
    }
    ...
    private static final boolean m5473containsbiwQdVI(UIntRange contains, UInt uInt) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return uInt != null && contains.m5441containsWZ4Q5Ns(uInt.getData());
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    /* JADX INFO: renamed from: contains-fz5IDCE, reason: not valid java name */
    public static final boolean m5474containsfz5IDCE(@NotNull UIntRange contains, long j) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return ULong.m4389constructorimpl(j >>> 32) == 0 && contains.m5441containsWZ4Q5Ns(UInt.m4310constructorimpl((int) j));
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    /* JADX INFO: renamed from: contains-uhHAxoY, reason: not valid java name */
    public static final boolean m5475containsuhHAxoY(@NotNull ULongRange contains, short s) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m5450containsVKZWuLQ(ULong.m4389constructorimpl(((long) s) & 65535));
    }
    ...
    public static final UIntProgression m5476downTo5PvTz6A(short s, short s2) {
        return UIntProgression.INSTANCE.m5438fromClosedRangeNkh28Cs(UInt.m4310constructorimpl(s & UShort.MAX_VALUE), UInt.m4310constructorimpl(s2 & UShort.MAX_VALUE), -1);
    }
    ...
    public static final UIntProgression m5477downToJ1ME1BU(int i, int i2) {
        return UIntProgression.INSTANCE.m5438fromClosedRangeNkh28Cs(i, i2, -1);
    }
    ...
    public static final UIntProgression m5478downToKr8caGY(byte b, byte b2) {
        return UIntProgression.INSTANCE.m5438fromClosedRangeNkh28Cs(UInt.m4310constructorimpl(b & UByte.MAX_VALUE), UInt.m4310constructorimpl(b2 & UByte.MAX_VALUE), -1);
    }
    ...
    public static final ULongProgression m5479downToeb3DHEI(long j, long j2) {
        return ULongProgression.INSTANCE.m5447fromClosedRange7ftBX0g(j, j2, -1L);
    }
    ...
    public static final UInt firstOrNull(@NotNull UIntProgression uIntProgression) {
        ...
        return UInt.m4304boximpl(uIntProgression.getFirst());
    }
    ...
    public static final UInt lastOrNull(@NotNull UIntProgression uIntProgression) {
        ...
        return UInt.m4304boximpl(uIntProgression.getLast());
    }
    ...
    public static final UIntProgression reversed(@NotNull UIntProgression uIntProgression) {
        Intrinsics.checkNotNullParameter(uIntProgression, "<this>");
        return UIntProgression.INSTANCE.m5438fromClosedRangeNkh28Cs(uIntProgression.getLast(), uIntProgression.getFirst(), -uIntProgression.getStep());
    }
    ...
    public static final UIntProgression step(@NotNull UIntProgression uIntProgression, int i) {
        ...
        int iM5436getFirstpVg5ArA = uIntProgression.getFirst();
        int iM5437getLastpVg5ArA = uIntProgression.getLast();
        if (uIntProgression.getStep() <= 0) {
            i = -i;
        }
        return companion.m5438fromClosedRangeNkh28Cs(iM5436getFirstpVg5ArA, iM5437getLastpVg5ArA, i);
    }
    ...
    public static final UIntRange m5480until5PvTz6A(short s, short s2) {
        int i = s2 & UShort.MAX_VALUE;
        return Intrinsics.compare(i, 0) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange(UInt.m4310constructorimpl(s & UShort.MAX_VALUE), UInt.m4310constructorimpl(UInt.m4310constructorimpl(i) - 1), null);
    }
    ...
    public static UIntRange m5481untilJ1ME1BU(int i, int i2) {
        return Integer.compare(i2 ^ Integer.MIN_VALUE, Integer.MIN_VALUE) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange(i, UInt.m4310constructorimpl(i2 - 1), null);
    }
    ...
    public static final UIntRange m5482untilKr8caGY(byte b, byte b2) {
        int i = b2 & UByte.MAX_VALUE;
        return Intrinsics.compare(i, 0) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange(UInt.m4310constructorimpl(b & UByte.MAX_VALUE), UInt.m4310constructorimpl(UInt.m4310constructorimpl(i) - 1), null);
    }
    ...
    public static ULongRange m5483untileb3DHEI(long j, long j2) {
        return Long.compare(j2 ^ Long.MIN_VALUE, Long.MIN_VALUE) <= 0 ? ULongRange.INSTANCE.getEMPTY() : new ULongRange(j, ULong.m4389constructorimpl(j2 - ULong.m4389constructorimpl(((long) 1) & 4294967295L)), null);
    }
    ...
    public static final ULong firstOrNull(@NotNull ULongProgression uLongProgression) {
        ...
        return ULong.m4383boximpl(uLongProgression.getFirst());
    }
    ...
    public static final ULong lastOrNull(@NotNull ULongProgression uLongProgression) {
        ...
        return ULong.m4383boximpl(uLongProgression.getLast());
    }
    ...
    public static final ULongProgression reversed(@NotNull ULongProgression uLongProgression) {
        Intrinsics.checkNotNullParameter(uLongProgression, "<this>");
        return ULongProgression.INSTANCE.m5447fromClosedRange7ftBX0g(uLongProgression.getLast(), uLongProgression.getFirst(), -uLongProgression.getStep());
    }
    ...
    public static final UInt randomOrNull(@NotNull UIntRange uIntRange, @NotNull Random random) {
        ...
        return UInt.m4304boximpl(URandomKt.nextUInt(random, uIntRange));
    }
    ...
    public static final ULongProgression step(@NotNull ULongProgression uLongProgression, long j) {
        ...
        long jM5445getFirstsVKNKU = uLongProgression.getFirst();
        long jM5446getLastsVKNKU = uLongProgression.getLast();
        if (uLongProgression.getStep() <= 0) {
            j = -j;
        }
        return companion.m5447fromClosedRange7ftBX0g(jM5445getFirstsVKNKU, jM5446getLastsVKNKU, j);
    }
    ...
    public static final ULong randomOrNull(@NotNull ULongRange uLongRange, @NotNull Random random) {
        ...
        return ULong.m4383boximpl(URandomKt.nextULong(random, uLongRange));
    }
}
