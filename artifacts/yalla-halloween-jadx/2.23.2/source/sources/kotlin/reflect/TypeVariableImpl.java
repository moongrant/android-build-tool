...
final class TypeVariableImpl implements TypeVariable<GenericDeclaration>, TypeImpl {
    ...
    public Type[] getBounds() {
        ...
        ArrayList arrayList = new ArrayList(CollectionsKt.OooO0oo(upperBounds));
    ...
    public GenericDeclaration getGenericDeclaration() {
        throw new NotImplementedError(o00O00OO.OooO00o("An operation is not implemented: ", "getGenericDeclaration() is not yet supported for type variables created from KType: " + this.typeParameter));
    }
