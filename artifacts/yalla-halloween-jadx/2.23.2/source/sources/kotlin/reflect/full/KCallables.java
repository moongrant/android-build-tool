...
public final class KCallables {
    ...
    public static final class C09261<R> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        int label;
        ...
        public C09261(Continuation<? super C09261> continuation) {
            super(continuation);
        }
    ...
    public static final <R> Object callSuspendBy(@NotNull KCallable<? extends R> kCallable, @NotNull Map<KParameter, ? extends Object> map, @NotNull Continuation<? super R> continuation) throws IllegalCallableAccessException {
        C09261 c09261;
        if (continuation instanceof C09261) {
            c09261 = (C09261) continuation;
            int i = c09261.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c09261.label = i - Integer.MIN_VALUE;
            } else {
                c09261 = new C09261(continuation);
            }
        } else {
            c09261 = new C09261(continuation);
        }
        Object objCallDefaultMethod$kotlin_reflection = c09261.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c09261.label;
        if (i2 == 0) {
            ...
            c09261.L$0 = kCallable;
            c09261.L$1 = map;
            c09261.L$2 = kCallableImplAsKCallableImpl;
            c09261.label = 1;
            objCallDefaultMethod$kotlin_reflection = kCallableImplAsKCallableImpl.callDefaultMethod$kotlin_reflection(map, c09261);
            if (objCallDefaultMethod$kotlin_reflection == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                DebugProbesKt.probeCoroutineSuspended(c09261);
            }
            ...
            kCallable = (KCallable) c09261.L$0;
            ResultKt.throwOnFailure(objCallDefaultMethod$kotlin_reflection);
        }
