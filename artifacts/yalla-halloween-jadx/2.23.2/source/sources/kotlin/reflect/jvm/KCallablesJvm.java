...
public final class KCallablesJvm {
    public static final boolean isAccessible(@NotNull KCallable<?> kCallable) {
        ...
        if (kCallable instanceof KMutableProperty) {
            ...
            Member memberMo5484getMember = (kCallableImplAsKCallableImpl == null || (defaultCaller = kCallableImplAsKCallableImpl.getDefaultCaller()) == null) ? null : defaultCaller.mo5484getMember();
            AccessibleObject accessibleObject = memberMo5484getMember instanceof AccessibleObject ? (AccessibleObject) memberMo5484getMember : null;
