    ...
    public final JvmFunctionSignature mapSignature(@NotNull FunctionDescriptor possiblySubstitutedFunction) {
        ...
        if (constructorDescriptor.isPrimary()) {
            ...
            if (StringsKt__StringsJVMKt.endsWith$default(jvmConstructorSignature.getDesc(), ")V", false, 2, null)) {
                jvmConstructorSignature = JvmMemberSignature.Method.copy$default(jvmConstructorSignature, null, StringsKt__StringsKt.removeSuffix(jvmConstructorSignature.getDesc(), (CharSequence) "V") + jvmDescriptor, 1, null);
