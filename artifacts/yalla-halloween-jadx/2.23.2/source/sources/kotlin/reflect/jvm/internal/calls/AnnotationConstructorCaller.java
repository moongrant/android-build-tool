...
public final class AnnotationConstructorCaller implements Caller {
    ...
    public AnnotationConstructorCaller(@NotNull Class<?> jClass, @NotNull List<String> parameterNames, @NotNull CallMode callMode, @NotNull Origin origin, @NotNull List<Method> methods) {
        ...
        ArrayList arrayList = new ArrayList(CollectionsKt.OooO0oo(methods));
        ...
        ArrayList arrayList3 = new ArrayList(CollectionsKt.OooO0oo(list2));
        Iterator<T> it4 = list2.iterator();
        while (it4.hasNext()) {
            arrayList3.add(((Method) it4.next()).getDefaultValue());
        }
        this.defaultValues = arrayList3;
        if (this.callMode == CallMode.POSITIONAL_CALL && origin == Origin.JAVA && (!CollectionsKt___CollectionsKt.minus(this.parameterNames, AppMeasurementSdk.ConditionalUserProperty.VALUE).isEmpty())) {
    ...
    public /* synthetic */ AnnotationConstructorCaller(Class cls, List list, CallMode callMode, Origin origin, List list2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 16) != 0) {
            list2 = new ArrayList(CollectionsKt.OooO0oo(list));
