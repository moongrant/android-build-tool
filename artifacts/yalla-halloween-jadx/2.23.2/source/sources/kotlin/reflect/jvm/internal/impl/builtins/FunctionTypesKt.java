...
public final class FunctionTypesKt {
    public static final int contextFunctionTypeParamsCount(@NotNull KotlinType kotlinType) {
        ...
        AnnotationDescriptor annotationDescriptorMo5487findAnnotation = kotlinType.getAnnotations().mo5487findAnnotation(StandardNames.FqNames.contextFunctionTypeParams);
        if (annotationDescriptorMo5487findAnnotation == null) {
            return 0;
        }
        ConstantValue constantValue = (ConstantValue) MapsKt.getValue(annotationDescriptorMo5487findAnnotation.getAllValueArguments(), StandardNames.CONTEXT_FUNCTION_TYPE_PARAMETER_COUNT_NAME);
    ...
    public static final Name extractParameterNameFromFunctionTypeArgument(@NotNull KotlinType kotlinType) {
        String value;
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        AnnotationDescriptor annotationDescriptorMo5487findAnnotation = kotlinType.getAnnotations().mo5487findAnnotation(StandardNames.FqNames.parameterName);
        if (annotationDescriptorMo5487findAnnotation == null) {
            return null;
        }
    ...
    public static final List<KotlinType> getContextReceiverTypesFromFunctionType(@NotNull KotlinType kotlinType) {
        ...
        ArrayList arrayList = new ArrayList(CollectionsKt.OooO0oo(listSubList));
    ...
    public static final List<TypeProjection> getFunctionTypeArgumentProjections(@Nullable KotlinType kotlinType, @NotNull List<? extends KotlinType> contextReceiverTypes, @NotNull List<? extends KotlinType> parameterTypes, @Nullable List<Name> list, @NotNull KotlinType returnType, @NotNull KotlinBuiltIns builtIns) {
        ...
        ArrayList arrayList2 = new ArrayList(CollectionsKt.OooO0oo(contextReceiverTypes));
        ...
        for (Object obj : parameterTypes) {
            ...
            if (name != null) {
                ...
                kotlinTypeReplaceAnnotations = TypeUtilsKt.replaceAnnotations(kotlinTypeReplaceAnnotations, Annotations.Companion.create(CollectionsKt.plus(kotlinTypeReplaceAnnotations.getAnnotations(), new BuiltInAnnotationDescriptor(builtIns, fqName, MapsKt.mapOf(TuplesKt.to(nameIdentifier, new StringValue(strAsString))), false, 8, null))));
            }
    ...
    public static final FunctionTypeKind getFunctionTypeKind(@NotNull KotlinType kotlinType) {
        ...
        if (classifierDescriptorMo5492getDeclarationDescriptor != null) {
            return getFunctionTypeKind(classifierDescriptorMo5492getDeclarationDescriptor);
        }
        return null;
    }
    ...
    public static final boolean isBuiltinFunctionalType(@NotNull KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor classifierDescriptorMo5492getDeclarationDescriptor = kotlinType.getConstructor().mo5492getDeclarationDescriptor();
        return classifierDescriptorMo5492getDeclarationDescriptor != null && isBuiltinFunctionalClassDescriptor(classifierDescriptorMo5492getDeclarationDescriptor);
    }
    ...
    private static final boolean isTypeAnnotatedWithExtensionFunctionType(KotlinType kotlinType) {
        return kotlinType.getAnnotations().mo5487findAnnotation(StandardNames.FqNames.extensionFunctionType) != null;
    }
