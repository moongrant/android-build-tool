...
public final class PrimitiveType {
    ...
    static {
        ...
        NUMBER_TYPES = SetsKt.setOf((Object[]) new PrimitiveType[]{new PrimitiveType("Char"), new PrimitiveType("Byte"), new PrimitiveType("Short"), new PrimitiveType("Int"), new PrimitiveType("Float"), new PrimitiveType("Long"), new PrimitiveType("Double")});
        $ENTRIES = EnumEntriesKt.enumEntries(primitiveTypeArrValues);
    }
