...
public final class ReflectionTypes {
    ...
    public final ClassDescriptor find(String str, int i) {
        ...
        ClassifierDescriptor classifierDescriptorMo5494getContributedClassifier = getKotlinReflectScope().mo5494getContributedClassifier(nameIdentifier, NoLookupLocation.FROM_REFLECTION);
