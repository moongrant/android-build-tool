...
public final class StandardNames {
    ...
    public static final class FqNames {
        ...
        static {
            ...
            mapEntry = OooO00o.OooO00o("Entry", fqNameCollectionsFqName, "map.child(Name.identifier(\"Entry\"))");
            ...
            mutableMapEntry = OooO00o.OooO00o("MutableEntry", fqNameCollectionsFqName2, "mutableMap.child(Name.identifier(\"MutableEntry\"))");
        ...
        private final FqName annotationName(String str) {
            return OooO00o.OooO00o(str, StandardNames.ANNOTATION_PACKAGE_FQ_NAME, "ANNOTATION_PACKAGE_FQ_NA…e.identifier(simpleName))");
        }

        private final FqName collectionsFqName(String str) {
            return OooO00o.OooO00o(str, StandardNames.COLLECTIONS_PACKAGE_FQ_NAME, "COLLECTIONS_PACKAGE_FQ_N…e.identifier(simpleName))");
        }

        private final FqName fqName(String str) {
            return OooO00o.OooO00o(str, StandardNames.BUILT_INS_PACKAGE_FQ_NAME, "BUILT_INS_PACKAGE_FQ_NAM…e.identifier(simpleName))");
        }
        ...
        private final FqName internalName(String str) {
            return OooO00o.OooO00o(str, StandardNames.KOTLIN_INTERNAL_FQ_NAME, "KOTLIN_INTERNAL_FQ_NAME.…e.identifier(simpleName))");
        }
    ...
    static {
        ...
        CONTINUATION_INTERFACE_FQ_NAME = OooO00o.OooO00o("Continuation", fqName, "COROUTINES_PACKAGE_FQ_NA…entifier(\"Continuation\"))");
        ...
        Name nameIdentifier11 = Name.identifier(Constants.SDK_LANGUAGE);
        ...
        FqName fqNameOooO00o = OooO00o.OooO00o("annotation", fqName3, "BUILT_INS_PACKAGE_FQ_NAM…identifier(\"annotation\"))");
        ANNOTATION_PACKAGE_FQ_NAME = fqNameOooO00o;
        FqName fqNameOooO00o2 = OooO00o.OooO00o("collections", fqName3, "BUILT_INS_PACKAGE_FQ_NAM…dentifier(\"collections\"))");
        COLLECTIONS_PACKAGE_FQ_NAME = fqNameOooO00o2;
        FqName fqNameOooO00o3 = OooO00o.OooO00o("ranges", fqName3, "BUILT_INS_PACKAGE_FQ_NAM…ame.identifier(\"ranges\"))");
        RANGES_PACKAGE_FQ_NAME = fqNameOooO00o3;
        TEXT_PACKAGE_FQ_NAME = OooO00o.OooO00o(ViewHierarchyConstants.TEXT_KEY, fqName3, "BUILT_INS_PACKAGE_FQ_NAM…(Name.identifier(\"text\"))");
        FqName fqNameOooO00o4 = OooO00o.OooO00o("internal", fqName3, "BUILT_INS_PACKAGE_FQ_NAM…e.identifier(\"internal\"))");
        KOTLIN_INTERNAL_FQ_NAME = fqNameOooO00o4;
        NON_EXISTENT_CLASS = new FqName("error.NonExistentClass");
        BUILT_INS_PACKAGE_FQ_NAMES = SetsKt.setOf((Object[]) new FqName[]{fqName3, fqNameOooO00o2, fqNameOooO00o3, fqNameOooO00o, fqName2, fqNameOooO00o4, fqName});
    }
