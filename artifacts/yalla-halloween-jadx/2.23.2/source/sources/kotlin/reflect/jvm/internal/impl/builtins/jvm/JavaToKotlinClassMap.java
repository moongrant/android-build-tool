...
public final class JavaToKotlinClassMap {
    ...
    static {
        ...
        for (int i = 0; i < 23; i++) {
            ...
            ClassId classId20 = ClassId.topLevel(new FqName(OooO00o.OooO00o("kotlin.jvm.functions.Function", i)));
    ...
    public final ClassId mapKotlinToJava(@NotNull FqNameUnsafe kotlinFqName) {
        ...
        return isKotlinFunctionWithBigArity(kotlinFqName, NUMBERED_K_SUSPEND_FUNCTION_PREFIX) ? K_FUNCTION_CLASS_ID : kotlinToJava.get(kotlinFqName);
    }
