...
public final class JvmBuiltInsCustomizer implements AdditionalClassPartsProvider, PlatformDependentDeclarationFilter {
    ...
    public JvmBuiltInsCustomizer(@NotNull ModuleDescriptor moduleDescriptor, @NotNull final StorageManager storageManager, @NotNull Function0<JvmBuiltIns.Settings> settingsComputation) {
        ...
        this.deprecationForSomeOfTheListMethods = storageManager.createMemoizedFunction(new Function1<Pair<? extends String, ? extends String>, Annotations>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.jvm.JvmBuiltInsCustomizer$deprecationForSomeOfTheListMethods$1
            ...
            public final Annotations invoke2(@NotNull Pair<String, String> pair) {
                ...
                return Annotations.Companion.create(CollectionsKt.listOf(AnnotationUtilKt.createDeprecatedAnnotation$default(this.this$0.moduleDescriptor.getBuiltIns(), oO00OOOo.OooO00o("'", strComponent1, "()' member of List is redundant in Kotlin and might be removed soon. Please use '", strComponent2, "()' stdlib extension instead"), OooOOOO.OooO00o(strComponent2, "()"), null, true, 4, null)));
            }
        });
    }
    ...
    private final Collection<SimpleFunctionDescriptor> getAdditionalFunctions(ClassDescriptor classDescriptor, Function1<? super MemberScope, ? extends Collection<? extends SimpleFunctionDescriptor>> function1) {
        ...
        ArrayList arrayList = new ArrayList(CollectionsKt.OooO0oo(collectionMapPlatformClass));
    ...
    public static final Iterable getJdkMethodStatus$lambda$9(JvmBuiltInsCustomizer this$0, ClassDescriptor classDescriptor) {
        ...
        Intrinsics.checkNotNullExpressionValue(collectionMo5493getSupertypes, "it.typeConstructor.supertypes");
        ArrayList arrayList = new ArrayList();
        Iterator<T> it = collectionMo5493getSupertypes.iterator();
        while (it.hasNext()) {
            ClassifierDescriptor classifierDescriptorMo5492getDeclarationDescriptor = ((KotlinType) it.next()).getConstructor().mo5492getDeclarationDescriptor();
            ClassDescriptor javaAnalogue = null;
            ClassifierDescriptor original = classifierDescriptorMo5492getDeclarationDescriptor != null ? classifierDescriptorMo5492getDeclarationDescriptor.getOriginal() : null;
    ...
    private final boolean isTrivialCopyConstructorFor(ConstructorDescriptor constructorDescriptor, ClassDescriptor classDescriptor) {
        if (constructorDescriptor.getValueParameters().size() == 1) {
            ...
            ClassifierDescriptor classifierDescriptorMo5492getDeclarationDescriptor = ((ValueParameterDescriptor) CollectionsKt.single((List) valueParameters)).getType().getConstructor().mo5492getDeclarationDescriptor();
            if (Intrinsics.areEqual(classifierDescriptorMo5492getDeclarationDescriptor != null ? DescriptorUtilsKt.getFqNameUnsafe(classifierDescriptorMo5492getDeclarationDescriptor) : null, DescriptorUtilsKt.getFqNameUnsafe(classDescriptor))) {
                return true;
            }
        }
        return false;
