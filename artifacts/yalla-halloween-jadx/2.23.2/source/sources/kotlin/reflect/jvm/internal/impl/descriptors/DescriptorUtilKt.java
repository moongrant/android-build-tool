...
public final class DescriptorUtilKt {
    ...
    public static final ClassDescriptor resolveClassByFqName(@NotNull ModuleDescriptor moduleDescriptor, @NotNull FqName fqName, @NotNull LookupLocation lookupLocation) {
        ...
        ClassifierDescriptor classifierDescriptorMo5494getContributedClassifier2 = memberScope.mo5494getContributedClassifier(nameShortName, lookupLocation);
        ClassDescriptor classDescriptor = classifierDescriptorMo5494getContributedClassifier2 instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo5494getContributedClassifier2 : null;
        if (classDescriptor != null) {
        ...
        if (classDescriptorResolveClassByFqName == null || (unsubstitutedInnerClassesScope = classDescriptorResolveClassByFqName.getUnsubstitutedInnerClassesScope()) == null) {
            classifierDescriptorMo5494getContributedClassifier = null;
        } else {
            Name nameShortName2 = fqName.shortName();
            Intrinsics.checkNotNullExpressionValue(nameShortName2, "fqName.shortName()");
            classifierDescriptorMo5494getContributedClassifier = unsubstitutedInnerClassesScope.mo5494getContributedClassifier(nameShortName2, lookupLocation);
        }
