...
public final class TypeParameterUtilsKt {
    ...
    public static final PossiblyInnerType buildPossiblyInnerType(@NotNull KotlinType kotlinType) {
        ...
        return buildPossiblyInnerType(kotlinType, classifierDescriptorMo5492getDeclarationDescriptor instanceof ClassifierDescriptorWithTypeParameters ? (ClassifierDescriptorWithTypeParameters) classifierDescriptorMo5492getDeclarationDescriptor : null, 0);
    }
    ...
    public static final List<TypeParameterDescriptor> computeConstructorTypeParameters(@NotNull ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters) {
        ...
        ArrayList arrayList = new ArrayList(CollectionsKt.OooO0oo(listPlus));
