...
public final class JvmPackageScope implements MemberScope {
    ...
    public ClassifierDescriptor mo5494getContributedClassifier(@NotNull Name name, @NotNull LookupLocation location) {
        ...
        ClassDescriptor classDescriptorMo5494getContributedClassifier = this.javaScope.mo5494getContributedClassifier(name, location);
        if (classDescriptorMo5494getContributedClassifier != null) {
            return classDescriptorMo5494getContributedClassifier;
        }
        ClassifierDescriptor classifierDescriptor = null;
        for (MemberScope memberScope : getKotlinScopes()) {
            ClassifierDescriptor classifierDescriptorMo5494getContributedClassifier = memberScope.mo5494getContributedClassifier(name, location);
            if (classifierDescriptorMo5494getContributedClassifier != null) {
                if (!(classifierDescriptorMo5494getContributedClassifier instanceof ClassifierDescriptorWithTypeParameters) || !((ClassifierDescriptorWithTypeParameters) classifierDescriptorMo5494getContributedClassifier).isExpect()) {
