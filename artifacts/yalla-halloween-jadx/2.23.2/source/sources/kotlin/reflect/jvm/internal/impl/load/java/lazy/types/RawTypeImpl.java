...
public final class RawTypeImpl extends FlexibleType implements RawType {
    ...
    public MemberScope getMemberScope() {
        ClassifierDescriptor classifierDescriptorMo5492getDeclarationDescriptor = getConstructor().mo5492getDeclarationDescriptor();
        ...
        throw new IllegalStateException(("Incorrect classifier: " + getConstructor().mo5492getDeclarationDescriptor()).toString());
    }
