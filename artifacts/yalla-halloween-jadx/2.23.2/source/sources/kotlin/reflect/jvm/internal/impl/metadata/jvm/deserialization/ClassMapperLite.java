...
public final class ClassMapperLite {
    ...
    @NotNull
    private static final String f33070kotlin = CollectionsKt___CollectionsKt.joinToString$default(CollectionsKt.listOf((Object[]) new Character[]{'k', 'o', 't', 'l', 'i', 'n'}), "", null, null, 0, null, null, 62, null);
    ...
    static {
        ...
        if (progressionLastElement >= 0) {
            ...
            while (true) {
                ...
                sb2.append(str);
                sb2.append('/');
                linkedHashMap.put(o0oOO.OooO0O0(sb2, (String) listListOf.get(i), "Array"), "[" + ((String) listListOf.get(i2)));
        ...
        linkedHashMap.put(f33070kotlin + "/Unit", "V");
        ...
        for (String str5 : CollectionsKt.listOf((Object[]) new String[]{"Char", "Byte", "Short", "Int", "Float", "Long", "Double", "String", "Enum"})) {
            map$lambda$0$add(linkedHashMap, OooOOOO.OooO00o(str5, ".Companion"), o0OoOo0.OooO0OO(new StringBuilder(), f33070kotlin, "/jvm/internal/", str5, "CompanionObject"));
        }
        map = linkedHashMap;
    }
    ...
    private static final void map$lambda$0$add(Map<String, String> map2, String str, String str2) {
        map2.put(f33070kotlin + '/' + str, "L" + str2 + ';');
    }
