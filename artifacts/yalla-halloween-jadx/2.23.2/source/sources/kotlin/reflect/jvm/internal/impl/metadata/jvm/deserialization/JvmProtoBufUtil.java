...
public final class JvmProtoBufUtil {
    ...
    public final JvmMemberSignature.Method getJvmConstructorSignature(@NotNull ProtoBuf.Constructor proto, @NotNull NameResolver nameResolver, @NotNull TypeTable typeTable) {
        ...
        if (jvmMethodSignature == null || !jvmMethodSignature.hasDesc()) {
            ...
            ArrayList arrayList = new ArrayList(CollectionsKt.OooO0oo(valueParameterList));
    ...
    public final JvmMemberSignature.Method getJvmMethodSignature(@NotNull ProtoBuf.Function proto, @NotNull NameResolver nameResolver, @NotNull TypeTable typeTable) {
        ...
        if (jvmMethodSignature == null || !jvmMethodSignature.hasDesc()) {
            ...
            ArrayList arrayList2 = new ArrayList(CollectionsKt.OooO0oo(listPlus));
            ...
            strOooO0O0 = o0oOO.OooO0O0(new StringBuilder(), CollectionsKt___CollectionsKt.joinToString$default(arrayList2, "", "(", ")", 0, null, null, 56, null), strMapTypeDefault2);
        } else {
            strOooO0O0 = nameResolver.getString(jvmMethodSignature.getDesc());
        }
        return new JvmMemberSignature.Method(nameResolver.getString(name), strOooO0O0);
    }
