...
public final class StandardClassIds {
    ...
    static {
        FqName fqName = new FqName(Constants.SDK_LANGUAGE);
        BASE_KOTLIN_PACKAGE = fqName;
        FqName fqNameOooO00o = OooO00o.OooO00o("reflect", fqName, "BASE_KOTLIN_PACKAGE.chil…me.identifier(\"reflect\"))");
        BASE_REFLECT_PACKAGE = fqNameOooO00o;
        FqName fqNameOooO00o2 = OooO00o.OooO00o("collections", fqName, "BASE_KOTLIN_PACKAGE.chil…dentifier(\"collections\"))");
        BASE_COLLECTIONS_PACKAGE = fqNameOooO00o2;
        FqName fqNameOooO00o3 = OooO00o.OooO00o("ranges", fqName, "BASE_KOTLIN_PACKAGE.chil…ame.identifier(\"ranges\"))");
        BASE_RANGES_PACKAGE = fqNameOooO00o3;
        FqName fqNameOooO00o4 = OooO00o.OooO00o("jvm", fqName, "BASE_KOTLIN_PACKAGE.child(Name.identifier(\"jvm\"))");
        BASE_JVM_PACKAGE = fqNameOooO00o4;
        BASE_JVM_INTERNAL_PACKAGE = OooO00o.OooO00o("internal", fqNameOooO00o4, "BASE_JVM_PACKAGE.child(N…e.identifier(\"internal\"))");
        FqName fqNameOooO00o5 = OooO00o.OooO00o("annotation", fqName, "BASE_KOTLIN_PACKAGE.chil…identifier(\"annotation\"))");
        BASE_ANNOTATION_PACKAGE = fqNameOooO00o5;
        FqName fqNameOooO00o6 = OooO00o.OooO00o("internal", fqName, "BASE_KOTLIN_PACKAGE.chil…e.identifier(\"internal\"))");
        BASE_INTERNAL_PACKAGE = fqNameOooO00o6;
        BASE_INTERNAL_IR_PACKAGE = OooO00o.OooO00o("ir", fqNameOooO00o6, "BASE_INTERNAL_PACKAGE.child(Name.identifier(\"ir\"))");
        FqName fqNameOooO00o7 = OooO00o.OooO00o("coroutines", fqName, "BASE_KOTLIN_PACKAGE.chil…identifier(\"coroutines\"))");
        BASE_COROUTINES_PACKAGE = fqNameOooO00o7;
        BASE_ENUMS_PACKAGE = OooO00o.OooO00o("enums", fqName, "BASE_KOTLIN_PACKAGE.chil…Name.identifier(\"enums\"))");
        BASE_CONTRACTS_PACKAGE = OooO00o.OooO00o("contracts", fqName, "BASE_KOTLIN_PACKAGE.chil….identifier(\"contracts\"))");
        BASE_CONCURRENT_PACKAGE = OooO00o.OooO00o("concurrent", fqName, "BASE_KOTLIN_PACKAGE.chil…identifier(\"concurrent\"))");
        builtInsPackages = SetsKt.setOf((Object[]) new FqName[]{fqName, fqNameOooO00o2, fqNameOooO00o3, fqNameOooO00o5, fqNameOooO00o, fqNameOooO00o6, fqNameOooO00o7});
        ...
        primitiveTypes = of;
        Set<ClassId> set = of;
        LinkedHashMap linkedHashMap = new LinkedHashMap(RangesKt.coerceAtLeast(MapsKt.mapCapacity(CollectionsKt.OooO0oo(set)), 16));
        for (Object obj : set) {
        ...
        LinkedHashMap linkedHashMap2 = new LinkedHashMap(RangesKt.coerceAtLeast(MapsKt.mapCapacity(CollectionsKt.OooO0oo(set2)), 16));
