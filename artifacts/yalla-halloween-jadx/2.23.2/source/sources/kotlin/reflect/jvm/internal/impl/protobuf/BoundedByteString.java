...
class BoundedByteString extends LiteralByteString {
    ...
    public BoundedByteString(byte[] bArr, int i, int i2) {
        super(bArr);
        if (i < 0) {
            throw new IllegalArgumentException(OooO0OO.OooO00o(29, "Offset too small: ", i));
        }
        if (i2 < 0) {
            throw new IllegalArgumentException(OooO0OO.OooO00o(29, "Length too small: ", i));
        }
    ...
    public byte byteAt(int i) {
        if (i < 0) {
            throw new ArrayIndexOutOfBoundsException(OooO0OO.OooO00o(28, "Index too small: ", i));
        }
        if (i < size()) {
