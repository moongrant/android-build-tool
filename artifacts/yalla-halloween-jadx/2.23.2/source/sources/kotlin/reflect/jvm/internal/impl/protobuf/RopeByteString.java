...
class RopeByteString extends ByteString {
        ...
        private void doBalance(ByteString byteString) {
            if (byteString.isBalanced()) {
                ...
                if (!(byteString instanceof RopeByteString)) {
                    ...
                    throw new IllegalArgumentException(o0oOO.OooO0O0(new StringBuilder(strValueOf.length() + 49), "Has a new type of ByteString been created? Found ", strValueOf));
                }
    ...
    static {
        ...
        int i2 = 1;
        while (i > 0) {
            int iOooO00o = o00O.OooO00o(i, arrayList, i2, i);
            i2 = i;
            i = iOooO00o;
        }
