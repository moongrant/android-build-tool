        ...
        for (DeclarationDescriptor declarationDescriptor : ResolutionScope.DefaultImpls.getContributedDescriptors$default(memberScope, DescriptorKindFilter.CLASSIFIERS, null, 2, null)) {
            if (declarationDescriptor instanceof ClassDescriptor) {
                ...
                if (classDescriptor2.isExpect()) {
                    ...
                    ClassifierDescriptor classifierDescriptorMo5494getContributedClassifier = memberScope.mo5494getContributedClassifier(name, NoLookupLocation.WHEN_GET_ALL_DESCRIPTORS);
                    classDescriptor2 = classifierDescriptorMo5494getContributedClassifier instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo5494getContributedClassifier : classifierDescriptorMo5494getContributedClassifier instanceof TypeAliasDescriptor ? ((TypeAliasDescriptor) classifierDescriptorMo5494getContributedClassifier).getClassDescriptor() : null;
                }
