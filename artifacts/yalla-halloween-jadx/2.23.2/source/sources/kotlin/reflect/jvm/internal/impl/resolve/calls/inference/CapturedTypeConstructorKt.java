    ...
    public static final TypeSubstitution wrapWithCapturingSubstitution(@NotNull TypeSubstitution typeSubstitution, final boolean z) {
        ...
        if (!(typeSubstitution instanceof IndexedParametersSubstitution)) {
            return new DelegatedTypeSubstitution(typeSubstitution) { // from class: kotlin.reflect.jvm.internal.impl.resolve.calls.inference.CapturedTypeConstructorKt.wrapWithCapturingSubstitution.2
                ...
                public TypeProjection mo5497get(@NotNull KotlinType key) {
                    Intrinsics.checkNotNullParameter(key, "key");
                    TypeProjection typeProjectionMo5497get = super.mo5497get(key);
                    if (typeProjectionMo5497get == null) {
                        return null;
                    }
                    ClassifierDescriptor classifierDescriptorMo5492getDeclarationDescriptor = key.getConstructor().mo5492getDeclarationDescriptor();
                    return CapturedTypeConstructorKt.createCapturedIfNeeded(typeProjectionMo5497get, classifierDescriptorMo5492getDeclarationDescriptor instanceof TypeParameterDescriptor ? (TypeParameterDescriptor) classifierDescriptorMo5492getDeclarationDescriptor : null);
                }
            };
        }
        ...
        ArrayList arrayList = new ArrayList(CollectionsKt.OooO0oo(listZip));
