...
public final class DescriptorUtilsKt {
    ...
    public static final Iterable declaresOrInheritsDefaultValue$lambda$5(ValueParameterDescriptor valueParameterDescriptor) {
        ...
        ArrayList arrayList = new ArrayList(CollectionsKt.OooO0oo(overriddenDescriptors));
    ...
    public static final ClassDescriptor getAnnotationClass(@NotNull AnnotationDescriptor annotationDescriptor) {
        ...
        ClassifierDescriptor classifierDescriptorMo5492getDeclarationDescriptor = annotationDescriptor.getType().getConstructor().mo5492getDeclarationDescriptor();
    ...
    public static final ClassDescriptor getSuperClassNotAny(@NotNull ClassDescriptor classDescriptor) {
        ...
        for (KotlinType kotlinType : classDescriptor.getDefaultType().getConstructor().mo5493getSupertypes()) {
            if (!KotlinBuiltIns.isAnyOrNullableAny(kotlinType)) {
                ...
                if (DescriptorUtils.isClassOrEnumClass(classifierDescriptorMo5492getDeclarationDescriptor)) {
    ...
    public static final ClassDescriptor resolveTopLevelClass(@NotNull ModuleDescriptor moduleDescriptor, @NotNull FqName topLevelClassFqName, @NotNull LookupLocation location) {
        ...
        ClassifierDescriptor classifierDescriptorMo5494getContributedClassifier = memberScope.mo5494getContributedClassifier(nameShortName, location);
