...
public final class SubstitutingScope implements MemberScope {
    ...
    public ClassifierDescriptor mo5494getContributedClassifier(@NotNull Name name, @NotNull LookupLocation location) {
        ...
        if (classifierDescriptorMo5494getContributedClassifier != null) {
            return (ClassifierDescriptor) substitute(classifierDescriptorMo5494getContributedClassifier);
        }
        return null;
    }
    ...
    public void mo5498recordLookup(@NotNull Name name, @NotNull LookupLocation lookupLocation) {
