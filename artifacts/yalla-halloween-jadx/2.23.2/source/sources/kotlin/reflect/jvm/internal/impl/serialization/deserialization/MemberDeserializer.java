...
public final class MemberDeserializer {
    ...
    public final PropertyDescriptor loadProperty(@NotNull ProtoBuf.Property proto) {
        ...
        if (OooO00o.OooO0O0(Flags.HAS_SETTER, flags, "HAS_SETTER.get(flags)")) {
            ...
            boolean zOooO0O5 = OooO00o.OooO0O0(Flags.IS_NOT_DEFAULT, i3, "IS_NOT_DEFAULT.get(setterFlags)");
            boolean zOooO0O6 = OooO00o.OooO0O0(Flags.IS_EXTERNAL_ACCESSOR, i3, "IS_EXTERNAL_ACCESSOR.get(setterFlags)");
            boolean zOooO0O7 = OooO00o.OooO0O0(Flags.IS_INLINE_ACCESSOR, i3, "IS_INLINE_ACCESSOR.get(setterFlags)");
            ...
            if (zOooO0O5) {
                ...
                PropertySetterDescriptorImpl propertySetterDescriptorImpl = new PropertySetterDescriptorImpl(deserializedPropertyDescriptor2, annotations3, protoEnumFlags3.modality(flagField2.get(i3)), ProtoEnumFlagsUtilsKt.descriptorVisibility(protoEnumFlags3, flagField.get(i3)), !zOooO0O5, zOooO0O6, zOooO0O7, deserializedPropertyDescriptor2.getKind(), null, SourceElement.NO_SOURCE);
    ...
    public final TypeAliasDescriptor loadTypeAlias(@NotNull ProtoBuf.TypeAlias proto) {
        ...
        ArrayList arrayList = new ArrayList(CollectionsKt.OooO0oo(annotationList));
