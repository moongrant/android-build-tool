...
public final class TypeDeserializer {
    ...
    private final SimpleType createSimpleSuspendFunctionType(KotlinType kotlinType, KotlinType kotlinType2) {
        ...
        ArrayList arrayList = new ArrayList(CollectionsKt.OooO0oo(listDropLast));
    ...
    private final SimpleType transformRuntimeFunctionTypeToSuspendFunction(KotlinType kotlinType) {
        ...
        FqName fqNameSafe = classifierDescriptorMo5492getDeclarationDescriptor != null ? DescriptorUtilsKt.getFqNameSafe(classifierDescriptorMo5492getDeclarationDescriptor) : null;
    ...
    public final SimpleType simpleType(@NotNull final ProtoBuf.Type proto, boolean z) {
        ...
        if (ErrorUtils.isError(typeConstructor.mo5492getDeclarationDescriptor())) {
        ...
        ArrayList arrayList = new ArrayList(CollectionsKt.OooO0oo(listSimpleType$collectAllArguments));
        int i = 0;
        ...
        if (z && (classifierDescriptorMo5492getDeclarationDescriptor instanceof TypeAliasDescriptor)) {
            KotlinTypeFactory kotlinTypeFactory = KotlinTypeFactory.INSTANCE;
            SimpleType simpleTypeComputeExpandedType = KotlinTypeFactory.computeExpandedType((TypeAliasDescriptor) classifierDescriptorMo5492getDeclarationDescriptor, list);
