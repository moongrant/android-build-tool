...
public abstract class AbstractClassTypeConstructor extends AbstractTypeConstructor {
    ...
    public KotlinType defaultSupertypeIfEmpty() {
        if (KotlinBuiltIns.isSpecialClassWithNoSupertypes(mo5492getDeclarationDescriptor())) {
            return null;
        }
    ...
    public Collection<KotlinType> getAdditionalNeighboursInSupertypeGraph(boolean z) {
        DeclarationDescriptor containingDeclaration = mo5492getDeclarationDescriptor().getContainingDeclaration();
        ...
        ClassDescriptor classDescriptorMo5485getCompanionObjectDescriptor = classDescriptor.mo5485getCompanionObjectDescriptor();
        if (z && classDescriptorMo5485getCompanionObjectDescriptor != null) {
            smartList.add(classDescriptorMo5485getCompanionObjectDescriptor.getDefaultType());
        }
        return smartList;
    }
    ...
    public KotlinBuiltIns getBuiltIns() {
        KotlinBuiltIns builtIns = DescriptorUtilsKt.getBuiltIns(mo5492getDeclarationDescriptor());
        if (builtIns == null) {
            $$$reportNull$$$0(1);
        }
        return builtIns;
    ...
    public abstract ClassDescriptor mo5492getDeclarationDescriptor();
    ...
    public boolean isSameClassifier(@NotNull ClassifierDescriptor classifierDescriptor) {
        ...
        return (classifierDescriptor instanceof ClassDescriptor) && areFqNamesEqual(mo5492getDeclarationDescriptor(), classifierDescriptor);
    }
}
