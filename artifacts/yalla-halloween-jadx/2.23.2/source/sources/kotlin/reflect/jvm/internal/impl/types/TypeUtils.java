...
public class TypeUtils {
    ...
    private static /* synthetic */ void $$$reportNull$$$0(int i) {
        ...
        switch (i) {
            ...
            case 22:
                ...
                break;
            case 24:
                objArr[0] = ReportItem.QualityKeyResult;
                break;
            case 31:
            case 33:
                objArr[0] = "clazz";
    ...
    public static ClassDescriptor getClassDescriptor(@NotNull KotlinType kotlinType) {
        ...
        if (classifierDescriptorMo5492getDeclarationDescriptor instanceof ClassDescriptor) {
            return (ClassDescriptor) classifierDescriptorMo5492getDeclarationDescriptor;
        }
        return null;
    }
    ...
    public static List<KotlinType> getImmediateSupertypes(@NotNull KotlinType kotlinType) {
        ...
        Collection<KotlinType> collectionMo5493getSupertypes = kotlinType.getConstructor().mo5493getSupertypes();
        ArrayList arrayList = new ArrayList(collectionMo5493getSupertypes.size());
        Iterator<KotlinType> it = collectionMo5493getSupertypes.iterator();
        while (it.hasNext()) {
    ...
    public static TypeParameterDescriptor getTypeParameterDescriptorOrNull(@NotNull KotlinType kotlinType) {
        ...
        if (kotlinType.getConstructor().mo5492getDeclarationDescriptor() instanceof TypeParameterDescriptor) {
            return (TypeParameterDescriptor) kotlinType.getConstructor().mo5492getDeclarationDescriptor();
        }
        return null;
    }
    ...
    public static boolean hasNullableSuperType(@NotNull KotlinType kotlinType) {
        ...
        if (kotlinType.getConstructor().mo5492getDeclarationDescriptor() instanceof ClassDescriptor) {
            return false;
        }
    ...
    public static boolean isNullableType(@NotNull KotlinType kotlinType) {
        ...
        if (constructor instanceof IntersectionTypeConstructor) {
            Iterator<KotlinType> it = constructor.mo5493getSupertypes().iterator();
            while (it.hasNext()) {
                if (isNullableType(it.next())) {
                    return true;
                }
    ...
    private static boolean contains(@Nullable KotlinType kotlinType, @NotNull Function1<UnwrappedType, Boolean> function1, SmartSet<KotlinType> smartSet) {
        ...
        TypeConstructor constructor = kotlinType.getConstructor();
        if (constructor instanceof IntersectionTypeConstructor) {
            Iterator<KotlinType> it = ((IntersectionTypeConstructor) constructor).mo5493getSupertypes().iterator();
            while (it.hasNext()) {
