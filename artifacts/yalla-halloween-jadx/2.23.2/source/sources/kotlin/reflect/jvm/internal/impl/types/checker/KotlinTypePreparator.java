    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> collectionMo5493getSupertypes = capturedTypeConstructorImpl.mo5493getSupertypes();
                ArrayList arrayList = new ArrayList(CollectionsKt.OooO0oo(collectionMo5493getSupertypes));
        ...
        if (constructor instanceof IntegerValueTypeConstructor) {
            Collection<KotlinType> collectionMo5493getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo5493getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt.OooO0oo(collectionMo5493getSupertypes2));
            Iterator<T> it2 = collectionMo5493getSupertypes2.iterator();
            while (it2.hasNext()) {
        ...
        Collection<KotlinType> collectionMo5493getSupertypes3 = intersectionTypeConstructor.mo5493getSupertypes();
        ArrayList arrayList3 = new ArrayList(CollectionsKt.OooO0oo(collectionMo5493getSupertypes3));
        Iterator<T> it3 = collectionMo5493getSupertypes3.iterator();
        while (it3.hasNext()) {
