...
public final class UtilsKt {
    ...
    private static final String debugInfo(TypeConstructor typeConstructor) {
        ...
        for (DeclarationDescriptor declarationDescriptorMo5492getDeclarationDescriptor = typeConstructor.mo5492getDeclarationDescriptor(); declarationDescriptorMo5492getDeclarationDescriptor != null; declarationDescriptorMo5492getDeclarationDescriptor = declarationDescriptorMo5492getDeclarationDescriptor.getContainingDeclaration()) {
            debugInfo$lambda$1$unaryPlus("fqName: " + DescriptorRenderer.FQ_NAMES_IN_TYPES.render(declarationDescriptorMo5492getDeclarationDescriptor), sb);
            debugInfo$lambda$1$unaryPlus("javaClass: " + declarationDescriptorMo5492getDeclarationDescriptor.getClass().getCanonicalName(), sb);
        }
    ...
    public static final KotlinType findCorrespondingSupertype(@NotNull KotlinType subtype, @NotNull KotlinType supertype, @NotNull TypeCheckingProcedureCallbacks typeCheckingProcedureCallbacks) {
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            for (KotlinType immediateSupertype : constructor2.mo5493getSupertypes()) {
