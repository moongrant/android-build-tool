...
public class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    public static final class C09501<R> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
        ...
        public C09501(Sequence<? extends T> sequence, Function2<? super Integer, ? super T, ? extends C> function2, Function1<? super C, ? extends Iterator<? extends R>> function1, Continuation<? super C09501> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C09501 c09501 = new C09501(this.$source, this.$transform, this.$iterator, continuation);
            c09501.L$0 = obj;
            return c09501;
        }
        ...
        public final Object invoke(@NotNull SequenceScope<? super R> sequenceScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C09501) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public static final class C09541<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C09541(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> function0, Continuation<? super C09541> continuation) {
            super(2, continuation);
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C09541 c09541 = new C09541(this.$this_ifEmpty, this.$defaultValue, continuation);
            c09541.L$0 = obj;
            return c09541;
        }
        ...
        public final Object invoke(@NotNull SequenceScope<? super T> sequenceScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C09541) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public static final class C09551<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C09551(Sequence<? extends T> sequence, Random random, Continuation<? super C09551> continuation) {
            super(2, continuation);
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C09551 c09551 = new C09551(this.$this_shuffled, this.$random, continuation);
            c09551.L$0 = obj;
            return c09551;
        }
        ...
        @Nullable
        public final Object invoke(@NotNull SequenceScope<? super T> sequenceScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C09551) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public static final <T, C, R> Sequence<R> flatMapIndexed(@NotNull Sequence<? extends T> source, @NotNull Function2<? super Integer, ? super T, ? extends C> transform, @NotNull Function1<? super C, ? extends Iterator<? extends R>> iterator) {
        ...
        Intrinsics.checkNotNullParameter(iterator, "iterator");
        return SequencesKt__SequenceBuilderKt.sequence(new C09501(source, transform, iterator, null));
    }
    ...
    public static final <T> Sequence<T> ifEmpty(@NotNull Sequence<? extends T> sequence, @NotNull Function0<? extends Sequence<? extends T>> defaultValue) {
        ...
        return SequencesKt__SequenceBuilderKt.sequence(new C09541(sequence, defaultValue, null));
    }
    ...
    public static final <T> Sequence<T> shuffled(@NotNull Sequence<? extends T> sequence, @NotNull Random random) {
        ...
        return SequencesKt__SequenceBuilderKt.sequence(new C09551(sequence, random, null));
    }
