...
class SequencesKt___SequencesJvmKt extends SequencesKt__SequencesKt {
    ...
    public static final /* synthetic */ Double m5499max(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt___SequencesKt.m5507maxOrNull((Sequence<Double>) sequence);
    }
    ...
    public static final /* synthetic */ <T, R extends Comparable<? super R>> T maxBy(Sequence<? extends T> sequence, Function1<? super T, ? extends R> function1) {
        Iterator itOooO0O0 = OooO00o.OooO0O0(sequence, "<this>", function1, "selector");
        if (!itOooO0O0.hasNext()) {
            return null;
        }
        Object obj = (Object) itOooO0O0.next();
        if (itOooO0O0.hasNext()) {
            R rInvoke = function1.invoke(obj);
            do {
                Object obj2 = (Object) itOooO0O0.next();
    ...
    public static final /* synthetic */ Double m5501min(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt___SequencesKt.m5515minOrNull((Sequence<Double>) sequence);
    }
    ...
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* JADX INFO: renamed from: max, reason: collision with other method in class */
    public static final /* synthetic */ Float m5500max(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt___SequencesKt.m5508maxOrNull((Sequence<Float>) sequence);
    }
    ...
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* JADX INFO: renamed from: min, reason: collision with other method in class */
    public static final /* synthetic */ Float m5502min(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt___SequencesKt.m5516minOrNull((Sequence<Float>) sequence);
    }
