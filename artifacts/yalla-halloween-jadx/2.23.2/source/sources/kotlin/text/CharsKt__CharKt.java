...
public class CharsKt__CharKt extends CharsKt__CharJVMKt {
    ...
    public static final char digitToChar(int i, int i2) {
        ...
        if (i < 0 || i >= i2) {
            throw new IllegalArgumentException(androidx.compose.compiler.plugins.kotlin.lower.OooO0O0.OooO0O0("Digit ", i, " does not represent a valid digit in radix ", i2));
        }
