...
public final class Regex implements Serializable {
    ...
    public static final class C09771 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super String>, Continuation<? super Unit>, Object> {
        ...
        public C09771(CharSequence charSequence, int i, Continuation<? super C09771> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C09771 c09771 = Regex.this.new C09771(this.$input, this.$limit, continuation);
            c09771.L$0 = obj;
            return c09771;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i2 == 0) {
                ...
                if (this.$limit != 1 && matcher2.find()) {
                    ...
                    matcher = matcher2;
                    i = 0;
                    string = c09771.$input.subSequence(iEnd, matcher.start()).toString();
                    c09771.L$0 = sequenceScope;
                    c09771.L$1 = matcher;
                    c09771.I$0 = i;
                    c09771.label = 2;
                    if (sequenceScope.yield(string, c09771) == coroutine_suspended) {
                    ...
                    CharSequence charSequence = c09771.$input;
                    string2 = charSequence.subSequence(iEnd, charSequence.length()).toString();
                    c09771.L$0 = null;
                    c09771.L$1 = null;
                    c09771.label = 3;
                    if (sequenceScope.yield(string2, c09771) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                ...
                if (i2 != 1) {
                    if (i2 == 2) {
                        ...
                        iEnd = matcher.end();
                        i++;
                        if (i != c09771.$limit - 1 || !matcher.find()) {
                            CharSequence charSequence2 = c09771.$input;
                        ...
                        CharSequence charSequence3 = c09771.$input;
        ...
        public final Object invoke(@NotNull SequenceScope<? super String> sequenceScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C09771) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public final Sequence<MatchResult> findAll(@NotNull final CharSequence input, final int startIndex) {
        ...
        StringBuilder sbOooO0O0 = o0000O0.OooO0O0("Start index out of bounds: ", startIndex, ", input length: ");
        sbOooO0O0.append(input.length());
    ...
    public final Sequence<String> splitToSequence(@NotNull CharSequence input, int limit) {
        Intrinsics.checkNotNullParameter(input, "input");
        StringsKt__StringsKt.requireNonNegativeLimit(limit);
        return SequencesKt.sequence(new C09771(input, limit, null));
    }
