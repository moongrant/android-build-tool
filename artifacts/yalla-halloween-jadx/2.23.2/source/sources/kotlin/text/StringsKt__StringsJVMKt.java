...
public class StringsKt__StringsJVMKt extends StringsKt__StringNumberConversionsKt {
    ...
    private static final String format(String str, Object... args) {
        ...
        return OooO0O0.OooO0O0.OooO00o(args, args.length, str, "format(this, *args)");
    }
    ...
    public static String repeat(@NotNull CharSequence charSequence, int i) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        if (!(i >= 0)) {
            throw new IllegalArgumentException(OooO0OO.OooO00o("Count 'n' must be non-negative, but was ", i, '.').toString());
        }
        if (i == 0) {
            return "";
        }
        ...
        IntIterator intIteratorOooO00o = androidx.compose.animation.OooO0OO.OooO00o(1, i);
        while (intIteratorOooO00o.hasNext()) {
            intIteratorOooO00o.nextInt();
    ...
    public static final String replace(@NotNull String str, @NotNull String str2, @NotNull String str3, boolean z) {
        com.common.support.apm.netdetector.OooO00o.OooO00o(str, "<this>", str2, "oldValue", str3, "newValue");
        int i = 0;
    ...
    @NotNull
    public static String replaceFirst(@NotNull String str, @NotNull String str2, @NotNull String str3, boolean z) {
        com.common.support.apm.netdetector.OooO00o.OooO00o(str, "<this>", str2, "oldValue", str3, "newValue");
    ...
    private static final String format(StringCompanionObject stringCompanionObject, String format, Object... args) {
        ...
        Intrinsics.checkNotNullParameter(args, "args");
        return OooO0O0.OooO0O0.OooO00o(args, args.length, format, "format(format, *args)");
    }
