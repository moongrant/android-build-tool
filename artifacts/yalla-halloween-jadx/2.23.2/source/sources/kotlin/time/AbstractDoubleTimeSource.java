...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    public static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo5543elapsedNowUwyO8pc() {
            return Duration.m5588minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.ComparableTimeMark
        public boolean equals(@Nullable Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m5558equalsimpl0(mo5545minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m5656getZEROUwyO8pc());
        }
        ...
        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m5581hashCodeimpl(Duration.m5589plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }
        ...
        public long mo5545minusUwyO8pc(@NotNull ComparableTimeMark other) {
            ...
            if (other instanceof DoubleTimeMark) {
                ...
                if (Intrinsics.areEqual(this.timeSource, doubleTimeMark.timeSource)) {
                    if (Duration.m5558equalsimpl0(this.offset, doubleTimeMark.offset) && Duration.m5585isInfiniteimpl(this.offset)) {
                        return Duration.INSTANCE.m5656getZEROUwyO8pc();
                    }
                    long jM5588minusLRDsOJo = Duration.m5588minusLRDsOJo(this.offset, doubleTimeMark.offset);
                    long duration = DurationKt.toDuration(this.startedAt - doubleTimeMark.startedAt, this.timeSource.getUnit());
                    return Duration.m5558equalsimpl0(duration, Duration.m5606unaryMinusUwyO8pc(jM5588minusLRDsOJo)) ? Duration.INSTANCE.m5656getZEROUwyO8pc() : Duration.m5589plusLRDsOJo(duration, jM5588minusLRDsOJo);
                }
            }
        ...
        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt__DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m5602toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
        ...
        public ComparableTimeMark mo5546plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m5589plusLRDsOJo(this.offset, duration), null);
        }
    }
    ...
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m5656getZEROUwyO8pc(), null);
    }
}
