...
final class AdjustedTimeMark implements TimeMark {
    ...
    public long mo5543elapsedNowUwyO8pc() {
        return Duration.m5588minusLRDsOJo(this.mark.mo5543elapsedNowUwyO8pc(), this.adjustment);
    }
    ...
    public TimeMark mo5544minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m5690minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    @NotNull
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo5546plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m5589plusLRDsOJo(this.adjustment, duration), null);
    }
