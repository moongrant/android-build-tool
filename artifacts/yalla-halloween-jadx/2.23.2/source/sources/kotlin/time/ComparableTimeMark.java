...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    public static final class DefaultImpls {
        public static int compareTo(@NotNull ComparableTimeMark comparableTimeMark, @NotNull ComparableTimeMark other) {
            ...
            return Duration.m5552compareToLRDsOJo(comparableTimeMark.mo5545minusUwyO8pc(other), Duration.INSTANCE.m5656getZEROUwyO8pc());
        }
        ...
        public static ComparableTimeMark m5548minusLRDsOJo(@NotNull ComparableTimeMark comparableTimeMark, long j) {
            return comparableTimeMark.mo5546plusLRDsOJo(Duration.m5606unaryMinusUwyO8pc(j));
        }
    }
    ...
    ComparableTimeMark mo5544minusLRDsOJo(long duration);

    /* JADX INFO: renamed from: minus-UwyO8pc */
    long mo5545minusUwyO8pc(@NotNull ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    @NotNull
    /* JADX INFO: renamed from: plus-LRDsOJo */
    ComparableTimeMark mo5546plusLRDsOJo(long duration);
}
