...
public final class DurationKt {
    ...
    public static final long durationOf(long j, int i) {
        return Duration.m5553constructorimpl((j << 1) + ((long) i));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m5553constructorimpl((j << 1) + 1);
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m5553constructorimpl(j << 1);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        boolean z3;
        boolean z4;
        long jM5589plusLRDsOJo;
        int length = str.length();
        if (length == 0) {
            throw new IllegalArgumentException("The string is empty");
        }
        Duration.Companion companion = Duration.INSTANCE;
        long jM5656getZEROUwyO8pc = companion.m5656getZEROUwyO8pc();
        ...
        if (str.charAt(length2) == 'P') {
            ...
            while (i < length) {
                if (str.charAt(i) != 'T') {
                    ...
                    if (durationUnitDurationUnitByIsoChar != DurationUnit.SECONDS || iIndexOf$default <= 0) {
                        jM5589plusLRDsOJo = Duration.m5589plusLRDsOJo(jM5656getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    } else {
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring2 = strSubstring.substring(0, iIndexOf$default);
                        Intrinsics.checkNotNullExpressionValue(strSubstring2, "this as java.lang.String…ing(startIndex, endIndex)");
                        long jM5589plusLRDsOJo2 = Duration.m5589plusLRDsOJo(jM5656getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM5589plusLRDsOJo = Duration.m5589plusLRDsOJo(jM5589plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    }
                    jM5656getZEROUwyO8pc = jM5589plusLRDsOJo;
            ...
            if (StringsKt__StringsJVMKt.regionMatches(str, length2, "Infinity", 0, Math.max(length - length2, 8), true)) {
                jM5656getZEROUwyO8pc = companion.m5654getINFINITEUwyO8pc();
            } else {
                boolean z9 = !z6;
                ...
                while (length2 < length) {
                    ...
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM5589plusLRDsOJo3 = Duration.m5589plusLRDsOJo(jM5656getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM5656getZEROUwyO8pc = Duration.m5589plusLRDsOJo(jM5589plusLRDsOJo3, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < length) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        jM5656getZEROUwyO8pc = Duration.m5589plusLRDsOJo(jM5656getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
        ...
        return z2 ? Duration.m5606unaryMinusUwyO8pc(jM5656getZEROUwyO8pc) : jM5656getZEROUwyO8pc;
    }
    ...
    private static final long m5679timeskIfJnKk(double d, long j) {
        return Duration.m5590timesUwyO8pc(j, d);
    }
    ...
    private static final long m5680timesmvk6XK0(int i, long j) {
        return Duration.m5591timesUwyO8pc(j, i);
    }
