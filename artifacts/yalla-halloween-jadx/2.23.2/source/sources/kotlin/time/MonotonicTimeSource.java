...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public final long m5684adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m5696constructorimpl(LongSaturatedMathKt.m5682saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }

    /* JADX INFO: renamed from: differenceBetween-fRLX17w, reason: not valid java name */
    public final long m5685differenceBetweenfRLX17w(long one, long another) {
    ...
    public final long m5686elapsedFrom6eNON_k(long timeMark) {
        return LongSaturatedMathKt.saturatingDiff(read(), timeMark, DurationUnit.NANOSECONDS);
    }

    @Override // kotlin.time.TimeSource.WithComparableMarks, kotlin.time.TimeSource
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m5693boximpl(m5687markNowz9LOYto());
    }

    /* JADX INFO: renamed from: markNow-z9LOYto, reason: not valid java name */
    public long m5687markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m5696constructorimpl(read());
    }
