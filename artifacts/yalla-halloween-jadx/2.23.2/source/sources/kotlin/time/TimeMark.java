...
public interface TimeMark {
    ...
    public static final class DefaultImpls {
        public static boolean hasNotPassedNow(@NotNull TimeMark timeMark) {
            return Duration.m5586isNegativeimpl(timeMark.mo5543elapsedNowUwyO8pc());
        }
        ...
        public static TimeMark m5690minusLRDsOJo(@NotNull TimeMark timeMark, long j) {
            return timeMark.mo5546plusLRDsOJo(Duration.m5606unaryMinusUwyO8pc(j));
        }

        @NotNull
        /* JADX INFO: renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m5691plusLRDsOJo(@NotNull TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }
    }

    /* JADX INFO: renamed from: elapsedNow-UwyO8pc */
    long mo5543elapsedNowUwyO8pc();
    ...
    TimeMark mo5544minusLRDsOJo(long duration);

    @NotNull
    /* JADX INFO: renamed from: plus-LRDsOJo */
    TimeMark mo5546plusLRDsOJo(long duration);
}
