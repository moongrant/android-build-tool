...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m5711copyRFiDyg4$default(TimedValue timedValue, Object obj, long j, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m5713copyRFiDyg4(obj, j);
    }
    ...
    public final TimedValue<T> m5713copyRFiDyg4(T value, long duration) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Intrinsics.areEqual(this.value, timedValue.value) && Duration.m5558equalsimpl0(this.duration, timedValue.duration);
    }

    /* JADX INFO: renamed from: getDuration-UwyO8pc, reason: not valid java name */
    public final long m5714getDurationUwyO8pc() {
        return this.duration;
    }
    ...
    public int hashCode() {
        T t = this.value;
        return Duration.m5581hashCodeimpl(this.duration) + ((t == null ? 0 : t.hashCode()) * 31);
    }

    @NotNull
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((Object) Duration.m5602toStringimpl(this.duration)) + ')';
    }
