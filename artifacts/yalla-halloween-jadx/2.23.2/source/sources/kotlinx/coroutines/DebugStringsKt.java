...
public final class DebugStringsKt {
    ...
    public static final String toDebugString(@NotNull Continuation<?> continuation) {
        ...
        try {
            ...
            objM4215constructorimpl = Result.m4215constructorimpl(continuation + '@' + getHexAddress(continuation));
        } catch (Throwable th) {
        ...
        if (Result.m4218exceptionOrNullimpl(objM4215constructorimpl) != null) {
            objM4215constructorimpl = continuation.getClass().getName() + '@' + getHexAddress(continuation);
        }
        return (String) objM4215constructorimpl;
    }
}
