...
public final class DelayKt {
    ...
    public static final Object delay(long j, @NotNull Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (j < LongCompanionObject.MAX_VALUE) {
            getDelay(cancellableContinuationImpl.getContext()).mo5779scheduleResumeAfterDelay(j, cancellableContinuationImpl);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m5717delayVtjQ1oo(long j, @NotNull Continuation<? super Unit> continuation) throws Throwable {
        Object objDelay = delay(m5718toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m5718toDelayMillisLRDsOJo(long j) {
        if (Duration.m5552compareToLRDsOJo(j, Duration.INSTANCE.m5656getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m5571getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
