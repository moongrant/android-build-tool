        ...
        try {
            ...
            try {
                ...
                if (job != null && !job.isActive()) {
                    ...
                    continuation.resumeWith(Result.m4215constructorimpl(ResultKt.createFailure(cancellationException)));
                } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                    Result.Companion companion2 = Result.INSTANCE;
                    continuation.resumeWith(Result.m4215constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
                } else {
                    Result.Companion companion3 = Result.INSTANCE;
                    continuation.resumeWith(Result.m4215constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(objTakeState$kotlinx_coroutines_core)));
                }
                ...
                try {
                    ...
                    objM4215constructorimpl2 = Result.m4215constructorimpl(Unit.INSTANCE);
                } catch (Throwable th) {
                    Result.Companion companion4 = Result.INSTANCE;
                    objM4215constructorimpl2 = Result.m4215constructorimpl(ResultKt.createFailure(th));
                }
                handleFatalException(null, Result.m4218exceptionOrNullimpl(objM4215constructorimpl2));
            } catch (Throwable th2) {
                if (undispatchedCoroutineUpdateUndispatchedCompletion == null || undispatchedCoroutineUpdateUndispatchedCompletion.clearThreadContext()) {
                    ThreadContextKt.restoreThreadContext(context, objUpdateThreadContext);
                }
            ...
            try {
                ...
                objM4215constructorimpl = Result.m4215constructorimpl(ResultKt.createFailure(th4));
            }
            handleFatalException(th3, Result.m4218exceptionOrNullimpl(objM4215constructorimpl));
        }
    }
