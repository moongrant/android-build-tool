...
public class JobSupport implements Job, ChildJob, ParentJob, SelectClause0 {
        ...
        public final void addExceptionLocked(@NotNull Throwable exception) {
            ...
            if (!(obj instanceof Throwable)) {
                if (!(obj instanceof ArrayList)) {
                    throw new IllegalStateException(o000oOoO.OooO00o("State is ", obj));
                }
    ...
    public final Object awaitSuspend(Continuation<Object> continuation) throws Throwable {
        ...
        while (true) {
            ...
            if (!incomplete.getIsActive()) {
                ...
                if (objTryMakeCompleting == JobSupportKt.COMPLETING_ALREADY) {
                    throw new IllegalStateException(o000oOoO.OooO00o("Cannot happen in ", state$kotlinx_coroutines_core));
                }
    ...
    public CancellationException getChildJobCancellationCause() {
        ...
        if (state$kotlinx_coroutines_core instanceof Finishing) {
            ...
            if (state$kotlinx_coroutines_core instanceof Incomplete) {
                throw new IllegalStateException(o000oOoO.OooO00o("Cannot be cancelling child in this state: ", state$kotlinx_coroutines_core));
            }
            rootCause = null;
        }
    ...
    @Override // kotlinx.coroutines.Job
    @Nullable
    public final Object join(@NotNull Continuation<? super Unit> continuation) throws Throwable {
        if (joinInternal()) {
    ...
    public final String toDebugString() {
        ...
        sb.append('{');
        return oo000o.OooO0O0(sb, stateString(getState$kotlinx_coroutines_core()), '}');
    }
