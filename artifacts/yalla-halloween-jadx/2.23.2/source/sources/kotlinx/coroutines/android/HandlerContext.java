...
public final class HandlerContext extends HandlerDispatcher {
    ...
    public static final void m5728invokeOnTimeout$lambda3(HandlerContext handlerContext, Runnable runnable) {
    ...
    public DisposableHandle invokeOnTimeout(long timeMillis, @NotNull final Runnable block, @NotNull CoroutineContext context) {
        if (this.handler.postDelayed(block, RangesKt.coerceAtMost(timeMillis, DurationKt.MAX_MILLIS))) {
            return new DisposableHandle() { // from class: kotlinx.coroutines.android.OooO00o
                @Override // kotlinx.coroutines.DisposableHandle
                public final void dispose() {
                    HandlerContext.m5728invokeOnTimeout$lambda3(this.f33077OooO0Oo, block);
                }
            };
        }
        cancelOnRejection(context, block);
    ...
    public void mo5779scheduleResumeAfterDelay(long timeMillis, @NotNull final CancellableContinuation<? super Unit> continuation) {
    ...
    public String toString() {
        ...
        return this.invokeImmediately ? OooOOOO.OooO00o(string, ".immediate") : string;
    }
