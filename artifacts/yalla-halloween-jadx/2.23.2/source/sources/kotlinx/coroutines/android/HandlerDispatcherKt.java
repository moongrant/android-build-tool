...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM4215constructorimpl = Result.m4215constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM4215constructorimpl = Result.m4215constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m4221isFailureimpl(objM4215constructorimpl) ? null : objM4215constructorimpl);
    }
    ...
    public static final Object awaitFrame(@NotNull Continuation<? super Long> continuation) throws Throwable {
        ...
        Dispatchers.getMain().mo5778dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1
    ...
    public static final void postFrameCallback(Choreographer choreographer2, final CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() { // from class: kotlinx.coroutines.android.OooO0O0
            ...
            public final void doFrame(long j) {
                HandlerDispatcherKt.m5729postFrameCallback$lambda6(cancellableContinuation, j);
            }
        });
    }
    ...
    public static final void m5729postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
