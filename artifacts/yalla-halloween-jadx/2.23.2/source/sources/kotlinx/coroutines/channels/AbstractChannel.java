...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    public static final class Itr<E> implements ChannelIterator<E> {
        ...
        public final Object hasNextSuspend(Continuation<? super Boolean> continuation) throws Throwable {
            ...
            while (true) {
                ...
                if (objPollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause != null) {
                        ...
                        orCreateCancellableContinuation.resumeWith(Result.m4215constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                        break;
                    }
                    Result.Companion companion2 = Result.INSTANCE;
                    orCreateCancellableContinuation.resumeWith(Result.m4215constructorimpl(Boxing.boxBoolean(false)));
                    break;
                }
                if (objPollInternal != AbstractChannelKt.POLL_FAILED) {
                    ...
                    orCreateCancellableContinuation.resume(boolBoxBoolean, function1 != null ? OnUndeliveredElementKt.bindCancellationFun(function1, objPollInternal, orCreateCancellableContinuation.getContext()) : null);
                    break;
                }
            }
    ...
    public static class ReceiveElement<E> extends Receive<E> {
        ...
        public void resumeReceiveClosed(@NotNull Closed<?> closed) {
            if (this.receiveMode == 1) {
                this.cont.resumeWith(Result.m4215constructorimpl(ChannelResult.m5738boximpl(ChannelResult.INSTANCE.m5751closedJP2dKIU(closed.closeCause))));
                return;
            }
            CancellableContinuation<Object> cancellableContinuation = this.cont;
            Result.Companion companion = Result.INSTANCE;
            cancellableContinuation.resumeWith(Result.m4215constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
        }

        @Nullable
        public final Object resumeValue(E value) {
            return this.receiveMode == 1 ? ChannelResult.m5738boximpl(ChannelResult.INSTANCE.m5753successJP2dKIU(value)) : value;
        }
        ...
        public String toString() {
            ...
            return OooO0O0.OooO00o(sb, this.receiveMode, ']');
        }
    ...
    public static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        public void completeResumeReceive(E value) throws Throwable {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m5738boximpl(ChannelResult.INSTANCE.m5753successJP2dKIU(value)) : value, this.select.getCompletion(), resumeOnCancellationFun(value));
        }
        ...
        public void resumeReceiveClosed(@NotNull Closed<?> closed) throws Throwable {
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m5738boximpl(ChannelResult.INSTANCE.m5751closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                }
            }
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Multi-variable type inference failed */
    public final <R> Object receiveSuspend(int i, Continuation<? super R> continuation) throws Throwable {
        CancellableContinuationImpl orCreateCancellableContinuation = CancellableContinuationKt.getOrCreateCancellableContinuation(IntrinsicsKt.intercepted(continuation));
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) throws Throwable {
        ...
        if (!z) {
            if (i != 1) {
                ...
                UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m5738boximpl(z ? companion.m5751closedJP2dKIU(((Closed) obj).closeCause) : companion.m5753successJP2dKIU(obj)), selectInstance.getCompletion());
                return;
            }
        }
        if (i == 0) {
        ...
        if (i == 1 && selectInstance.trySelect()) {
            UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m5738boximpl(ChannelResult.INSTANCE.m5751closedJP2dKIU(((Closed) obj).closeCause)), selectInstance.getCompletion());
        }
    }
    ...
    public void onCancelIdempotent(boolean wasClosed) {
        ...
        Object objM5769constructorimpl$default = InlineList.m5769constructorimpl$default(null, 1, null);
        while (true) {
            LockFreeLinkedListNode prevNode = closedForSend.getPrevNode();
            if (prevNode instanceof LockFreeLinkedListHead) {
                mo5730onCancelIdempotentListww6eGU(objM5769constructorimpl$default, closedForSend);
                return;
            } else if (prevNode.mo5777remove()) {
                objM5769constructorimpl$default = InlineList.m5774plusFjFbRPM(objM5769constructorimpl$default, (Send) prevNode);
            } else {
                prevNode.helpRemove();
            }
        }
    ...
    public void mo5730onCancelIdempotentListww6eGU(@NotNull Object list, @NotNull Closed<?> closed) {
        if (list == null) {
            return;
        }
    ...
    public final Object mo5731receiveCatchingJP2dKIU(@NotNull Continuation<? super ChannelResult<? extends E>> continuation) throws Throwable {
        ...
        if (i2 == 0) {
            ...
            Object objPollInternal = pollInternal();
            if (objPollInternal != AbstractChannelKt.POLL_FAILED) {
                return objPollInternal instanceof Closed ? ChannelResult.INSTANCE.m5751closedJP2dKIU(((Closed) objPollInternal).closeCause) : ChannelResult.INSTANCE.m5753successJP2dKIU(objPollInternal);
            }
    ...
    public final Object mo5732tryReceivePtdJZtk() {
        Object objPollInternal = pollInternal();
        if (objPollInternal == AbstractChannelKt.POLL_FAILED) {
            return ChannelResult.INSTANCE.m5752failurePtdJZtk();
        }
        return objPollInternal instanceof Closed ? ChannelResult.INSTANCE.m5751closedJP2dKIU(((Closed) objPollInternal).closeCause) : ChannelResult.INSTANCE.m5753successJP2dKIU(objPollInternal);
    }
