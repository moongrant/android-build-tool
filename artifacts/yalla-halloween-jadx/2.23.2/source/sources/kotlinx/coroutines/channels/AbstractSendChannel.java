...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    public static final class SendBuffered<E> extends Send {
        ...
        public String toString() {
            ...
            sb.append('(');
            return OooOOO0.OooO00o(sb, this.element, ')');
        }
    ...
    private final String getQueueDebugStateString() {
        ...
        StringBuilder sbOooO0O0 = o000O0o.OooO0O0(string, ",queueSize=");
        sbOooO0O0.append(countQueueSize());
    ...
    private final void helpClose(Closed<?> closed) {
        ...
        while (true) {
            ...
            if (receive == null) {
                break;
            } else if (receive.mo5777remove()) {
                objM5769constructorimpl$default = InlineList.m5774plusFjFbRPM(objM5769constructorimpl$default, receive);
            } else {
                receive.helpRemove();
            }
        }
        if (objM5769constructorimpl$default != null) {
            if (objM5769constructorimpl$default instanceof ArrayList) {
                ArrayList arrayList = (ArrayList) objM5769constructorimpl$default;
                for (int size = arrayList.size() - 1; -1 < size; size--) {
                    ((Receive) arrayList.get(size)).resumeReceiveClosed(closed);
                }
            } else {
                ((Receive) objM5769constructorimpl$default).resumeReceiveClosed(closed);
            }
        }
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 == null || (undeliveredElementExceptionCallUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) == null) {
            ...
            continuation.resumeWith(Result.m4215constructorimpl(ResultKt.createFailure(sendException)));
        } else {
            ...
            continuation.resumeWith(Result.m4215constructorimpl(ResultKt.createFailure(undeliveredElementExceptionCallUndeliveredElementCatchingException$default)));
        }
    }
            ...
            if (objOfferSelectInternal != AbstractChannelKt.OFFER_FAILED && objOfferSelectInternal != AtomicKt.RETRY_ATOMIC) {
                if (objOfferSelectInternal == AbstractChannelKt.OFFER_SUCCESS) {
                    ...
                    if (!(objOfferSelectInternal instanceof Closed)) {
                        throw new IllegalStateException(o000oOoO.OooO00o("offerSelectInternal returned ", objOfferSelectInternal));
                    }
    ...
    /* JADX WARN: Code duplicated, block: B:29:0x0064 A[EDGE_INSN: B:29:0x0064->B:30:0x0069 BREAK  A[LOOP:0: B:3:0x0008->B:45:?]] */
    /* JADX WARN: Code duplicated, block: B:38:0x0080  */
    /* JADX WARN: Code duplicated, block: B:43:0x0050 A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:44:0x0060 A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:45:? A[LOOP:0: B:3:0x0008->B:45:?, LOOP_END, SYNTHETIC] */
    public final Object sendSuspend(E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        while (true) {
            if (isFullImpl()) {
                ...
                if (objEnqueueSend != AbstractChannelKt.ENQUEUE_FAILED && !(objEnqueueSend instanceof Receive)) {
                    throw new IllegalStateException(o000oOoO.OooO00o("enqueueSend returned ", objEnqueueSend));
                }
                objOfferInternal = offerInternal(e);
                if (objOfferInternal == AbstractChannelKt.OFFER_SUCCESS) {
                    Result.Companion companion = Result.INSTANCE;
                    orCreateCancellableContinuation.resumeWith(Result.m4215constructorimpl(Unit.INSTANCE));
                    break;
                }
                if (objOfferInternal != AbstractChannelKt.OFFER_FAILED) {
                    if (objOfferInternal instanceof Closed) {
                        throw new IllegalStateException(o000oOoO.OooO00o("offerInternal returned ", objOfferInternal));
                    }
    ...
    public void invokeOnClose(@NotNull Function1<? super Throwable, Unit> handler) {
        ...
        if (!z2) {
            ...
            if (obj != AbstractChannelKt.HANDLER_INVOKED) {
                throw new IllegalStateException(o00O0O0.OooO0O0("Another handler was already registered: ", obj));
            }
    ...
    @Override // kotlinx.coroutines.channels.SendChannel
    @Nullable
    public final Object send(E e, @NotNull Continuation<? super Unit> continuation) throws Throwable {
    ...
    public final Object mo5733trySendJP2dKIU(E element) {
        Object objOfferInternal = offerInternal(element);
        if (objOfferInternal == AbstractChannelKt.OFFER_SUCCESS) {
            return ChannelResult.INSTANCE.m5753successJP2dKIU(Unit.INSTANCE);
        }
        if (objOfferInternal == AbstractChannelKt.OFFER_FAILED) {
            Closed<?> closedForSend = getClosedForSend();
            return closedForSend == null ? ChannelResult.INSTANCE.m5752failurePtdJZtk() : ChannelResult.INSTANCE.m5751closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        }
        if (objOfferInternal instanceof Closed) {
            return ChannelResult.INSTANCE.m5751closedJP2dKIU(helpCloseAndGetSendException((Closed) objOfferInternal));
        }
        throw new IllegalStateException(o000oOoO.OooO00o("trySend returned ", objOfferInternal));
    }
