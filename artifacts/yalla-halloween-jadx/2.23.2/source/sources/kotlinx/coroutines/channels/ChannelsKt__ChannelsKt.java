...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            return ChannelResult.m5738boximpl(Result.m4222isSuccessimpl(objM4215constructorimpl) ? ChannelResult.INSTANCE.m5753successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m5751closedJP2dKIU(Result.m4218exceptionOrNullimpl(objM4215constructorimpl)));
        }
    ...
    public static final <E> void sendBlocking(@NotNull SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m5748isSuccessimpl(sendChannel.mo5733trySendJP2dKIU(e))) {
            return;
        }
    ...
    public static final <E> Object trySendBlocking(@NotNull SendChannel<? super E> sendChannel, E e) {
        Object objMo5733trySendJP2dKIU = sendChannel.mo5733trySendJP2dKIU(e);
        if (objMo5733trySendJP2dKIU instanceof ChannelResult.Failed) {
