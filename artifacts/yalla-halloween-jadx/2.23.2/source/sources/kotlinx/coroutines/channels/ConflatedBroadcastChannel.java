...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    public final void closeSubscriber(Subscriber<E> subscriber) {
        ...
        do {
            ...
            if (!(obj instanceof State)) {
                throw new IllegalStateException(o000oOoO.OooO00o("Invalid state ", obj));
            }
    ...
    public Object mo5733trySendJP2dKIU(E element) {
        Closed closedOfferInternal = offerInternal(element);
        return closedOfferInternal != null ? ChannelResult.INSTANCE.m5751closedJP2dKIU(closedOfferInternal.getSendException()) : ChannelResult.INSTANCE.m5753successJP2dKIU(Unit.INSTANCE);
    }
