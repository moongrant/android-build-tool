...
public interface ReceiveChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(@NotNull ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo5732tryReceivePtdJZtk = receiveChannel.mo5732tryReceivePtdJZtk();
            if (ChannelResult.m5748isSuccessimpl(objMo5732tryReceivePtdJZtk)) {
                return (E) ChannelResult.m5744getOrThrowimpl(objMo5732tryReceivePtdJZtk);
            }
            Throwable thM5742exceptionOrNullimpl = ChannelResult.m5742exceptionOrNullimpl(objMo5732tryReceivePtdJZtk);
            if (thM5742exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM5742exceptionOrNullimpl);
        }
        ...
        public static <E> Object receiveOrNull(@NotNull ReceiveChannel<? extends E> receiveChannel, @NotNull Continuation<? super E> continuation) {
            ...
            if (i2 == 0) {
                ...
                objMo5731receiveCatchingJP2dKIU = receiveChannel.mo5731receiveCatchingJP2dKIU(anonymousClass1);
            ...
            return ChannelResult.m5743getOrNullimpl(objMo5731receiveCatchingJP2dKIU);
        }
    ...
    Object mo5731receiveCatchingJP2dKIU(@NotNull Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo5732tryReceivePtdJZtk();
}
