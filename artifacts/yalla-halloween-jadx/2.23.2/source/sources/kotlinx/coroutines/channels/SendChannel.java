...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(@NotNull SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m5748isSuccessimpl(objMo5733trySendJP2dKIU)) {
                return true;
            }
            Throwable thM5742exceptionOrNullimpl = ChannelResult.m5742exceptionOrNullimpl(objMo5733trySendJP2dKIU);
    ...
    Object mo5733trySendJP2dKIU(E element);
}
