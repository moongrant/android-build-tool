...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM4215constructorimpl = Result.m4215constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM4215constructorimpl = Result.m4215constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m4221isFailureimpl(objM4215constructorimpl) ? null : objM4215constructorimpl);
    ...
    private final void installSignalHandler() {
        try {
            Signal.handle(new Signal("TRAP"), new o0O000o0());
        } catch (Throwable unused) {
        }
    }

    /* JADX INFO: renamed from: installSignalHandler$lambda-1, reason: not valid java name */
    private static final void m5755installSignalHandler$lambda1(Signal signal) {
