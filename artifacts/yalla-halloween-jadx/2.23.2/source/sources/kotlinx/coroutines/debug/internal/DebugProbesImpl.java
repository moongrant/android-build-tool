...
public final class DebugProbesImpl {
    ...
    private final void build(Job job, Map<Job, DebugCoroutineInfoImpl> map, StringBuilder sb, String str) {
        ...
        if (debugCoroutineInfoImpl != null) {
            ...
            StringBuilder sbOooO00o2 = o0o0Oo.OooO00o(str);
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> coroutineTrace) {
        ...
        try {
            ...
            objM4215constructorimpl = Result.m4215constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
        ...
        StackTraceElement[] stackTraceElementArr = (StackTraceElement[]) objM4215constructorimpl;
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        try {
            ...
            objM4215constructorimpl = Result.m4215constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(objNewInstance, 1));
            if (Result.m4221isFailureimpl(objM4215constructorimpl)) {
                objM4215constructorimpl = null;
            }
            return (Function1) objM4215constructorimpl;
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM4215constructorimpl = Result.m4215constructorimpl(ResultKt.createFailure(th));
        }
    ...
    public final Object[] dumpCoroutinesInfoAsJsonAndReferences() {
        ...
        for (DebugCoroutineInfo debugCoroutineInfo : listDumpCoroutinesInfo) {
            ...
            sbOooO0O0.append(lValueOf);
            sbOooO0O0.append(",\n                    \"dispatcher\": ");
            sbOooO0O0.append(stringWithQuotes2);
            sbOooO0O0.append(",\n                    \"sequenceNumber\": ");
            sbOooO0O0.append(debugCoroutineInfo.getSequenceNumber());
            sbOooO0O0.append(",\n                    \"state\": \"");
            sbOooO0O0.append(debugCoroutineInfo.getState());
            sbOooO0O0.append("\"\n                } \n                ");
            arrayList3.add(StringsKt.trimIndent(sbOooO0O0.toString()));
            arrayList2.add(debugCoroutineInfo.getLastObservedFrame());
            arrayList.add(debugCoroutineInfo.getLastObservedThread());
        }
        Object[] objArr = new Object[4];
        objArr[0] = oo000o.OooO0O0(new StringBuilder("["), CollectionsKt___CollectionsKt.joinToString$default(arrayList3, null, null, null, 0, null, null, 63, null), ']');
    ...
    public final String enhanceStackTraceWithThreadDumpAsJson(@NotNull DebugCoroutineInfo info) {
        ...
        return oo000o.OooO0O0(new StringBuilder("["), CollectionsKt___CollectionsKt.joinToString$default(arrayList, null, null, null, 0, null, null, 63, null), ']');
    }
