...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    public static final class AnonymousClass2<T> implements FlowCollector {
        ...
        public static final class C10251 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
            int label;
            ...
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                return new C10251(continuation);
            }
            ...
            public final Object invoke(@NotNull Throwable th, @Nullable Continuation<? super Boolean> continuation) {
                return ((C10251) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
            }
        }
        ...
        public static final <T> Flow<T> m5763catch(@NotNull Flow<? extends T> flow, @NotNull Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        ...
        public static final <T> Flow<T> retry(@NotNull Flow<? extends T> flow, long j, @NotNull Function2<? super Throwable, ? super Continuation<? super Boolean>, ? extends Object> function2) {
            ...
            throw new IllegalArgumentException(OooO00o.OooO00o("Expected positive amount of retries, but had ", j).toString());
        }
