...
final /* synthetic */ class FlowKt__MigrationKt {
    ...
    public static final class C10281<T> extends SuspendLambda implements Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        final /* synthetic */ long $timeMillis;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C10281(long j, Continuation<? super C10281> continuation) {
            super(2, continuation);
            this.$timeMillis = j;
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C10281(this.$timeMillis, continuation);
        }
        ...
        public final Object invoke(@NotNull FlowCollector<? super T> flowCollector, @Nullable Continuation<? super Unit> continuation) {
            return ((C10281) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public static final <T> Flow<T> delayFlow(@NotNull Flow<? extends T> flow, long j) {
        return FlowKt.onStart(flow, new C10281(j, null));
    }
