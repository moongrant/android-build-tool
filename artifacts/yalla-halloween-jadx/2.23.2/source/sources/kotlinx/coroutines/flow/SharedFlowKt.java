...
public final class SharedFlowKt {
    ...
    public static final <T> MutableSharedFlow<T> MutableSharedFlow(int i, int i2, @NotNull BufferOverflow bufferOverflow) {
        boolean z = true;
        if (!(i >= 0)) {
            throw new IllegalArgumentException(OooO00o.OooO00o("replay cannot be negative, but was ", i).toString());
        }
        if (!(i2 >= 0)) {
            throw new IllegalArgumentException(OooO00o.OooO00o("extraBufferCapacity cannot be negative, but was ", i2).toString());
        }
