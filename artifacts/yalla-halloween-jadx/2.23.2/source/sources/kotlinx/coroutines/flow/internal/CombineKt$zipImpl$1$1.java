...
public final class CombineKt$zipImpl$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
        ...
        public static final class AnonymousClass1<T> implements FlowCollector {
            ...
            public static final class C03851 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
                final /* synthetic */ ReceiveChannel<Object> $second;
                final /* synthetic */ FlowCollector<R> $this_unsafeFlow;
                final /* synthetic */ Function3<T1, T2, Continuation<? super R>, Object> $transform;
                ...
                public C03851(ReceiveChannel<? extends Object> receiveChannel, FlowCollector<? super R> flowCollector, Function3<? super T1, ? super T2, ? super Continuation<? super R>, ? extends Object> function3, T1 t1, Continuation<? super C03851> continuation) {
                ...
                public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                    return new C03851(this.$second, this.$this_unsafeFlow, this.$transform, this.$value, continuation);
                }
                ...
                public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
                    Object objMo5731receiveCatchingJP2dKIU;
                    ...
                    if (i != 0) {
                        if (i == 1) {
                            ...
                            objMo5731receiveCatchingJP2dKIU = ((ChannelResult) obj).getHolder();
                        } else if (i == 2) {
                    ...
                    this.label = 1;
                    objMo5731receiveCatchingJP2dKIU = receiveChannel.mo5731receiveCatchingJP2dKIU(this);
                    if (objMo5731receiveCatchingJP2dKIU == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    FlowCollector flowCollector3 = this.$this_unsafeFlow;
                    if (objMo5731receiveCatchingJP2dKIU instanceof ChannelResult.Failed) {
                        Throwable thM5742exceptionOrNullimpl = ChannelResult.m5742exceptionOrNullimpl(objMo5731receiveCatchingJP2dKIU);
                        if (thM5742exceptionOrNullimpl == null) {
                            throw new AbortFlowException(flowCollector3);
                        }
                        throw thM5742exceptionOrNullimpl;
                    }
                    Function3<T1, T2, Continuation<? super R>, Object> function3 = this.$transform;
                    T1 t1 = this.$value;
                    if (objMo5731receiveCatchingJP2dKIU == NullSurrogateKt.NULL) {
                        objMo5731receiveCatchingJP2dKIU = null;
                    }
                    this.L$0 = flowCollector3;
                    this.label = 2;
                    obj = function3.invoke(t1, objMo5731receiveCatchingJP2dKIU, this);
                ...
                public final Object invoke(@NotNull Unit unit, @Nullable Continuation<? super Unit> continuation) {
                    return ((C03851) create(unit, continuation)).invokeSuspend(Unit.INSTANCE);
                }
            }
            ...
            public final Object emit(T1 t1, @NotNull Continuation<? super Unit> continuation) {
                ...
                if (i2 == 0) {
                    ...
                    C03851 c03851 = new C03851(this.$second, this.$this_unsafeFlow, this.$transform, t1, null);
                    combineKt$zipImpl$1$1$2$1$emit$1.label = 1;
                    if (ChannelFlowKt.withContextUndispatched(coroutineContext, unit, obj2, c03851, combineKt$zipImpl$1$1$2$1$emit$1) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (i2 != 1) {
