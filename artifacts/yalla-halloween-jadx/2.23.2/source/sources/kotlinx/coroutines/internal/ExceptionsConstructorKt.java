...
public final class ExceptionsConstructorKt {
            ...
            return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$4
                ...
                public final Throwable invoke(@NotNull Throwable th) {
                    ...
                    try {
                        ...
                        th2.initCause(th);
                        objM4215constructorimpl = Result.m4215constructorimpl(th2);
                        if (Result.m4221isFailureimpl(objM4215constructorimpl)) {
                            objM4215constructorimpl = null;
                        }
                        return (Throwable) objM4215constructorimpl;
                    } catch (Throwable th3) {
                ...
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$1
                    ...
                    public final Throwable invoke(@NotNull Throwable th) {
                        ...
                        try {
                            ...
                            objM4215constructorimpl = Result.m4215constructorimpl((Throwable) objNewInstance);
                            if (Result.m4221isFailureimpl(objM4215constructorimpl)) {
                                objM4215constructorimpl = null;
                            }
                            return (Throwable) objM4215constructorimpl;
                            ...
                            Result.Companion companion2 = Result.INSTANCE;
                            objM4215constructorimpl = Result.m4215constructorimpl(ResultKt.createFailure(th2));
                        }
                    }
                };
            }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM4215constructorimpl = Result.m4215constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
        ...
        return ((Number) objM4215constructorimpl).intValue();
    }
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(@NotNull Throwable th) {
                ...
                try {
                    Result.Companion companion = Result.INSTANCE;
                    objM4215constructorimpl = Result.m4215constructorimpl(function2.invoke(th));
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM4215constructorimpl = Result.m4215constructorimpl(ResultKt.createFailure(th2));
                }
    ...
    public static final <E extends Throwable> E tryCopyException(@NotNull E e) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM4215constructorimpl = Result.m4215constructorimpl(((CopyableThrowable) e).createCopy());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM4215constructorimpl = Result.m4215constructorimpl(ResultKt.createFailure(th));
        }
        ...
        return (E) objM4215constructorimpl;
    }
}
