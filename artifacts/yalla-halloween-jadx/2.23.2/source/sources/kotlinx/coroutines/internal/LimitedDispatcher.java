...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    public void mo5778dispatch(@NotNull CoroutineContext context, @NotNull Runnable block) {
        ...
        this.dispatcher.mo5778dispatch(this, this);
    }
    ...
    public void mo5779scheduleResumeAfterDelay(long timeMillis, @NotNull CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo5779scheduleResumeAfterDelay(timeMillis, continuation);
    }
}
