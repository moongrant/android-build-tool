...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM4215constructorimpl = Result.m4215constructorimpl(BaseContinuationImpl.class.getCanonicalName());
        } catch (Throwable th) {
        ...
        if (Result.m4218exceptionOrNullimpl(objM4215constructorimpl) != null) {
            objM4215constructorimpl = baseContinuationImplClass;
        }
        baseContinuationImplClassName = (String) objM4215constructorimpl;
        try {
            objM4215constructorimpl2 = Result.m4215constructorimpl(StackTraceRecoveryKt.class.getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion3 = Result.INSTANCE;
            objM4215constructorimpl2 = Result.m4215constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m4218exceptionOrNullimpl(objM4215constructorimpl2) != null) {
            objM4215constructorimpl2 = stackTraceRecoveryClass;
        }
        stackTraceRecoveryClassName = (String) objM4215constructorimpl2;
    }
