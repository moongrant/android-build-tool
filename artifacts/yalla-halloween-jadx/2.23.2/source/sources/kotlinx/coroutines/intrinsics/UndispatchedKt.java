...
public final class UndispatchedKt {
        ...
        try {
            ...
            try {
                ...
                if (objInvoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    continuationProbeCoroutineCreated.resumeWith(Result.m4215constructorimpl(objInvoke));
                }
            } catch (Throwable th) {
                ThreadContextKt.restoreThreadContext(context, objUpdateThreadContext);
                throw th;
            ...
            continuationProbeCoroutineCreated.resumeWith(Result.m4215constructorimpl(ResultKt.createFailure(th2)));
        }
    }
    ...
    public static final <T> void startCoroutineUnintercepted(@NotNull Function1<? super Continuation<? super T>, ? extends Object> function1, @NotNull Continuation<? super T> continuation) {
        ...
        try {
            ...
            Result.Companion companion = Result.INSTANCE;
            continuationProbeCoroutineCreated.resumeWith(Result.m4215constructorimpl(ResultKt.createFailure(th)));
        }
    }
