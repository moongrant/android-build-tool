...
public final class CoroutineScheduler implements Executor, Closeable {
    ...
    public CoroutineScheduler(int i, int i2, long j, @NotNull String str) {
        ...
        if (!(i2 >= i)) {
            throw new IllegalArgumentException(OooO0O0.OooO0O0("Max pool size ", i2, " should be greater than or equals to core pool size ", i).toString());
        }
        if (!(i2 <= 2097150)) {
    ...
    public final void dispatch(@NotNull Runnable block, @NotNull TaskContext taskContext, boolean tailDispatch) {
        ...
        if (taskSubmitToLocalQueue != null && !addToGlobalQueue(taskSubmitToLocalQueue)) {
            throw new RejectedExecutionException(o0oOO.OooO0O0(new StringBuilder(), this.schedulerName, " was terminated"));
        }
