...
public final class SelectBuilderImpl<R> extends LockFreeLinkedListHead implements SelectBuilder<R>, SelectInstance<R>, Continuation<R>, CoroutineStackFrame {
    ...
    public static final class AtomicSelectOp extends AtomicOp<Object> {
        ...
        public String toString() {
            return o000oOoO.OooO00o(new StringBuilder("AtomicSelectOp(sequence="), getOpSequence(), ')');
        }
    }
    ...
    public final void handleBuilderException(@NotNull Throwable e) {
        if (trySelect()) {
            ...
            resumeWith(Result.m4215constructorimpl(ResultKt.createFailure(e)));
        } else {
        ...
        while (true) {
            ...
            if (obj == SelectKt.UNDECIDED) {
                ...
                if (z) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    continuationIntercepted.resumeWith(Result.m4215constructorimpl(ResultKt.createFailure(exception)));
                    return;
                }
            }
        }
    ...
    public void resumeWith(@NotNull Object result) {
        while (true) {
            ...
            if (obj == SelectKt.UNDECIDED) {
                ...
                if (z) {
                    if (!Result.m4221isFailureimpl(result)) {
                        this.uCont.resumeWith(result);
                        return;
                    }
                    Continuation<R> continuation = this.uCont;
                    Throwable thM4218exceptionOrNullimpl = Result.m4218exceptionOrNullimpl(result);
                    Intrinsics.checkNotNull(thM4218exceptionOrNullimpl);
                    continuation.resumeWith(Result.m4215constructorimpl(ResultKt.createFailure(thM4218exceptionOrNullimpl)));
                    return;
                }
            }
        }
    ...
    public String toString() {
        ...
        sb.append(", result=");
        return OooOOO0.OooO00o(sb, this._result, ')');
    }
    ...
    public boolean trySelect() {
        ...
        throw new IllegalStateException(androidx.compose.runtime.o000oOoO.OooO00o("Unexpected trySelectIdempotent result ", objTrySelectOther));
    }
