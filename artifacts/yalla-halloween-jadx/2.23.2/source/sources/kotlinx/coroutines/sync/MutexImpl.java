...
public final class MutexImpl implements Mutex, SelectClause2<Object, Mutex> {
    ...
    public static final class LockedQueue extends LockFreeLinkedListHead {
        ...
        @NotNull
        public String toString() {
            return OooOOO0.OooO00o(new StringBuilder("LockedQueue["), this.owner, ']');
        }
    }
        ...
        while (true) {
            ...
            if (obj2 instanceof Empty) {
                ...
                if (!(lockedQueue2.owner != obj)) {
                    throw new IllegalStateException(o00O0O0.OooO0O0("Already locked by ", obj).toString());
                }
                ...
                if (!(obj2 instanceof OpDescriptor)) {
                    throw new IllegalStateException(o000oOoO.OooO00o("Illegal state ", obj2));
                }
    ...
    public boolean isLocked() {
        while (true) {
            ...
            if (!(obj instanceof OpDescriptor)) {
                throw new IllegalStateException(o000oOoO.OooO00o("Illegal state ", obj));
            }
        ...
        while (!select.isSelected()) {
            ...
            if (obj instanceof Empty) {
                ...
                if (empty.locked != MutexKt.UNLOCKED) {
                    ...
                    if (objPerformAtomicTrySelect == null) {
                        ...
                        if (objPerformAtomicTrySelect != MutexKt.LOCK_FAIL && objPerformAtomicTrySelect != AtomicKt.RETRY_ATOMIC) {
                            throw new IllegalStateException(o000oOoO.OooO00o("performAtomicTrySelect(TryLockDesc) returned ", objPerformAtomicTrySelect));
                        }
                    }
                }
                ...
                if (!(lockedQueue2.owner != owner)) {
                    throw new IllegalStateException(o00O0O0.OooO0O0("Already locked by ", owner).toString());
                }
    ...
    public String toString() {
        while (true) {
            Object obj = this._state;
            if (obj instanceof Empty) {
                return OooOOO0.OooO00o(new StringBuilder("Mutex["), ((Empty) obj).locked, ']');
            }
            if (!(obj instanceof OpDescriptor)) {
                if (obj instanceof LockedQueue) {
                    return OooOOO0.OooO00o(new StringBuilder("Mutex["), ((LockedQueue) obj).owner, ']');
                }
                throw new IllegalStateException(o000oOoO.OooO00o("Illegal state ", obj));
            }
            ((OpDescriptor) obj).perform(this);
