...
public abstract class SQLiteProgram extends SQLiteClosable implements o000 {
    ...
    public SQLiteProgram(SQLiteDatabase sQLiteDatabase, String str) {
        ...
        if (compiledStatementForSql == null) {
            ...
            if (SQLiteDebug.DEBUG_ACTIVE_CURSOR_FINALIZATION) {
                ...
                OooOOO0.OooO00o(sb, ") because the previously created DbObj (id#", j, ") was not released for sql:");
                sb.append(str);
