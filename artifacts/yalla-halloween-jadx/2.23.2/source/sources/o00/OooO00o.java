                    ...
                    if (name.length() == 0) {
                        ...
                        while (true) {
                            if (i2 < length) {
                                ...
                                int i3 = i + 1;
                                if (str2.length() < name.length() + 2 || !(StringsKt__StringsJVMKt.endsWith$default(str2, strConcat, false, 2, null) || (str2.charAt(0) == '`' && StringsKt__StringsJVMKt.endsWith$default(str2, str, false, 2, null)))) {
                                    i2++;
                                    i = i3;
                                } else {
                                    columnIndex = i;
