...
import p416o0Oo0oo.oOo00o0o;

/* JADX INFO: loaded from: classes.dex */
public abstract class OooO0o extends oOo00o0o {
    ...
    public static class OooO0O0 extends OooO0o {
        ...
        public final SparseArray<ConstraintAttribute> f33233OooO0o;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public float[] f33234OooO0oO;

        public OooO0O0(String str, SparseArray<ConstraintAttribute> sparseArray) {
            String str2 = str.split(",")[1];
            this.f33233OooO0o = sparseArray;
        }

        @Override // p416o0Oo0oo.oOo00o0o
        ...
        public final void OooO0OO(int i) {
            SparseArray<ConstraintAttribute> sparseArray = this.f33233OooO0o;
            int size = sparseArray.size();
            int iOooO0OO = sparseArray.valueAt(0).OooO0OO();
            double[] dArr = new double[size];
            this.f33234OooO0oO = new float[iOooO0OO];
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                constraintAttributeValueAt.OooO0O0(this.f33234OooO0oO);
                int i3 = 0;
                while (true) {
                    float[] fArr = this.f33234OooO0oO;
                    if (i3 < fArr.length) {
                        dArr2[i2][i3] = fArr[i3];
                        i3++;
                    }
        ...
        @Override // o000000.OooO0o
        public final void OooO0Oo(View view, float f) {
            this.f46537OooO00o.OooO0Oo(f, this.f33234OooO0oO);
            o000000.OooO00o.OooO0O0(this.f33233OooO0o.valueAt(0), view, this.f33234OooO0oO);
        }
    }
    ...
    public static class C0389OooO0o extends OooO0o {
        @Override // o000000.OooO0o
        public final void OooO0Oo(View view, float f) {
        }
    }
    ...
    public static class OooOO0O extends OooO0o {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public boolean f33235OooO0o = false;
        ...
        public final void OooO0Oo(View view, float f) {
            ...
            if (this.f33235OooO0o) {
                return;
            }
            try {
                method = view.getClass().getMethod("setProgress", Float.TYPE);
            } catch (NoSuchMethodException unused) {
                this.f33235OooO0o = true;
                method = null;
            }
            if (method != null) {
                try {
