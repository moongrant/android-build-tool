...
public final class OooO0O0 extends ContextCompat {

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final /* synthetic */ int f33405OooO0OO = 0;
    ...
    /* JADX INFO: renamed from: o00000O.OooO0O0$OooO0O0, reason: collision with other inner class name */
    @RequiresApi(21)
    public static class C0390OooO0O0 {
        @DoNotInline
        public static void OooO00o(Activity activity) {
    ...
    public static class OooOO0O extends SharedElementCallback {
        ...
        public final oo0o0Oo f33406OooO00o;

        public OooOO0O(oo0o0Oo oo0o0oo) {
            this.f33406OooO00o = oo0o0oo;
        }
        ...
        public final Parcelable onCaptureSharedElementSnapshot(View view, Matrix matrix, RectF rectF) {
            ...
            Bitmap bitmap;
            oo0o0Oo oo0o0oo = this.f33406OooO00o;
            oo0o0oo.getClass();
            ...
            if (iRound <= 0 || iRound2 <= 0) {
                ...
                if (oo0o0oo.f33471OooO00o == null) {
                    oo0o0oo.f33471OooO00o = new Matrix();
                }
                oo0o0oo.f33471OooO00o.set(matrix);
                oo0o0oo.f33471OooO00o.postTranslate(-rectF.left, -rectF.top);
                oo0o0oo.f33471OooO00o.postScale(fMin2, fMin2);
                bitmapCreateBitmap = Bitmap.createBitmap(i7, i8, Bitmap.Config.ARGB_8888);
                Canvas canvas2 = new Canvas(bitmapCreateBitmap);
                canvas2.concat(oo0o0oo.f33471OooO00o);
                view.draw(canvas2);
            }
    ...
    public static boolean OooO0o(@NonNull Activity activity, @NonNull String str) {
    ...
    public static void OooO0o0(@NonNull ComponentActivity componentActivity, @NonNull String[] strArr, @IntRange(from = ULong.MIN_VALUE) int i) {
        HashSet hashSet = new HashSet();
        for (int i2 = 0; i2 < strArr.length; i2++) {
            if (TextUtils.isEmpty(strArr[i2])) {
                throw new IllegalArgumentException(o0oOO.OooO0O0(new StringBuilder("Permission request for permissions "), Arrays.toString(strArr), " must not contain null or empty values"));
            }
