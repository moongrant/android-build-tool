...
public final class OooO0O0 {
    ...
    public static final Method f33589OooO00o;
    ...
    @RequiresApi(24)
    public static class C0392OooO0O0 {
        @DoNotInline
    ...
    static {
        if (Build.VERSION.SDK_INT < 24) {
            try {
                f33589OooO00o = Class.forName("libcore.icu.ICU").getMethod("addLikelySubtags", Locale.class);
            } catch (Exception e) {
    ...
    public static String OooO00o(@NonNull Locale locale) {
        if (Build.VERSION.SDK_INT >= 24) {
            return C0392OooO0O0.OooO0OO(C0392OooO0O0.OooO00o(C0392OooO0O0.OooO0O0(locale)));
        }
        try {
            return OooO00o.OooO00o((Locale) f33589OooO00o.invoke(null, locale));
