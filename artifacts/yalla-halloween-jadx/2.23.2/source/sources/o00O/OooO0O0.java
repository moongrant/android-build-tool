...
public final class OooO0O0 implements OooO0OO {
    ...
    @NotNull
    public final Context f35982OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final float f35983OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final float f35984OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public final String f35985OooO0Oo;

    public OooO0O0(Context context) {
        Intrinsics.checkNotNullParameter(context, "context");
        this.f35982OooO00o = context;
        this.f35983OooO0O0 = 10.0f;
        this.f35984OooO0OO = 1.0f;
        double d = 10.0f;
        if (!(0.0d <= d && d <= 25.0d)) {
            throw new IllegalArgumentException("radius must be in [0, 25].".toString());
        }
        this.f35985OooO0Oo = OooO0O0.class.getName() + "-10.0-1.0";
    }
    ...
    public final Bitmap OooO00o(@NotNull Bitmap bitmap) throws Throwable {
        ...
        try {
            RenderScript renderScriptCreate = RenderScript.create(this.f35982OooO00o);
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        scriptIntrinsicBlurCreate.setRadius(this.f35983OooO0O0);
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof OooO0O0) {
            ...
            if (Intrinsics.areEqual(this.f35982OooO00o, oooO0O0.f35982OooO00o)) {
                if (this.f35983OooO0O0 == oooO0O0.f35983OooO0O0) {
                    if (this.f35984OooO0OO == oooO0O0.f35984OooO0OO) {
                        return true;
                    }
                }
            }
    ...
    public final String getCacheKey() {
        return this.f35985OooO0Oo;
    }

    public final int hashCode() {
        return Float.floatToIntBits(this.f35984OooO0OO) + o0OoOo0.OooO00o(this.f35983OooO0O0, this.f35982OooO00o.hashCode() * 31, 31);
    }

    @NotNull
    public final String toString() {
        return "BlurTransformation(context=" + this.f35982OooO00o + ", radius=" + this.f35983OooO0O0 + ", sampling=" + this.f35984OooO0OO + ")";
    }
}
