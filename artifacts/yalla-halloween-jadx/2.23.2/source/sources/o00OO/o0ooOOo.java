...
public final class o0ooOOo {
    ...
    public static final JsonReader.OooO00o f36912OooO00o = JsonReader.OooO00o.OooO00o("nm", "ind", "refId", "ty", "parent", "sw", "sh", "sc", "ks", "tt", "masksProperties", "shapes", "t", "ef", "sr", UserDataStore.STATE, "w", "h", "ip", "op", "tm", "cl", "hd");

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final JsonReader.OooO00o f36913OooO0O0 = JsonReader.OooO00o.OooO00o("d", "a");

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final JsonReader.OooO00o f36914OooO0OO = JsonReader.OooO00o.OooO00o("ty", "nm");

    public static /* synthetic */ class OooO00o {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public static final /* synthetic */ int[] f36915OooO00o;
        ...
        static {
            ...
            try {
                f36915OooO00o[Layer.MatteType.LUMA_INVERTED.ordinal()] = 2;
    ...
    public static Layer OooO00o(com.airbnb.lottie.parser.moshi.OooO00o oooO00o, com.airbnb.lottie.OooOO0 oooOO1) throws IOException {
        ...
        String strOooo2 = "UNSET";
        float fOooOooo4 = 0.0f;
        while (oooO00o.OooOo0()) {
            char c2 = 2;
            switch (oooO00o.Oooo0o0(f36912OooO00o)) {
                case 0:
                ...
                case 6:
                    ...
                    break;
                case 7:
                    color = Color.parseColor(oooO00o.Oooo0());
                    continue;
                    c = CharCompanionObject.MIN_VALUE;
                    break;
                case 8:
                    ...
                    while (oooO00o.OooOo0()) {
                        ...
                        while (oooO00o.OooOo0()) {
                            ...
                            if (b == 0) {
                                ...
                                String strOooo3 = oooO00o.Oooo0();
                                strOooo3.getClass();
                                int iHashCode2 = strOooo3.hashCode();
                                if (iHashCode2 != 97) {
                                    if (iHashCode2 != 105) {
                                        if (iHashCode2 != 110) {
                                            if (iHashCode2 == 115 && strOooo3.equals("s")) {
                                                b2 = 3;
                                            } else {
                                                b2 = -1;
                                            }
                                        } else if (strOooo3.equals("n")) {
                                            b2 = 2;
                                        } else {
                                            b2 = -1;
                                        }
                                    } else if (strOooo3.equals("i")) {
                                        b2 = 1;
                                    } else {
                                        b2 = -1;
                                    }
                                } else if (strOooo3.equals("a")) {
                                    b2 = 0;
                                } else {
                                    b2 = -1;
                                }
                        ...
                        oooO00o.OooOOo();
                        arrayList.add(new Mask(maskMode2, oo0o0oo, o0oooooOooO0OO, zOooOo2));
                        maskMode = null;
                    }
                    z = false;
                    oooOO1.f11826OooOOOO += arrayList.size();
                    oooO00o.OooO0oO();
                    continue;
                    c = CharCompanionObject.MIN_VALUE;
                    break;
                ...
                case 12:
                    oooO00o.OooO0OO();
                    while (oooO00o.OooOo0()) {
                        int iOooo0o0 = oooO00o.Oooo0o0(f36913OooO0O0);
                        if (iOooo0o0 == 0) {
                            o000ooo2 = new p134o00OO0o.o000OOo(o00oO0o.OooO00o(oooO00o, oooOO1, 1.0f, OooOOO.f36865OooO00o, false));
                        } else if (iOooo0o0 != 1) {
                            oooO00o.Oooo0oO();
                            oooO00o.OoooO00();
                        } else {
                            oooO00o.OooO00o();
                            if (oooO00o.OooOo0()) {
                                JsonReader.OooO00o oooO00o2 = OooO0O0.f36859OooO00o;
                                oooO00o.OooO0OO();
                                p134o00OO0o.o000000 o000000Var2 = null;
                                while (oooO00o.OooOo0()) {
                                    if (oooO00o.Oooo0o0(OooO0O0.f36859OooO00o) != 0) {
                                        oooO00o.Oooo0oO();
                                        oooO00o.OoooO00();
                                    } else {
                                        oooO00o.OooO0OO();
                                        ...
                                        while (oooO00o.OooOo0()) {
                                            int iOooo0o1 = oooO00o.Oooo0o0(OooO0O0.f36860OooO0O0);
                                            if (iOooo0o1 == 0) {
                ...
                case 13:
                    ...
                    while (oooO00o.OooOo0()) {
                        oooO00o.OooO0OO();
                        while (oooO00o.OooOo0()) {
                            int iOooo0o2 = oooO00o.Oooo0o0(f36914OooO0OO);
                            if (iOooo0o2 == 0) {
                                int iOooo00o3 = oooO00o.Oooo00o();
                                if (iOooo00o3 == 29) {
                                    JsonReader.OooO00o oooO00o3 = OooO.f36856OooO00o;
                                    oooO0OO = null;
                                    while (oooO00o.OooOo0()) {
                                        if (oooO00o.Oooo0o0(OooO.f36856OooO00o) != 0) {
                                            oooO00o.Oooo0oO();
                                            oooO00o.OoooO00();
                                        } else {
                                            oooO00o.OooO00o();
                                            while (oooO00o.OooOo0()) {
                                                ...
                                                while (true) {
                                                    ...
                                                    while (true) {
                                                        if (oooO00o.OooOo0()) {
                                                            int iOooo0o3 = oooO00o.Oooo0o0(OooO.f36857OooO0O0);
                                                            if (iOooo0o3 != 0) {
                                                                if (iOooo0o3 != 1) {
                                                                    oooO00o.Oooo0oO();
                                                                    oooO00o.OoooO00();
                                    ...
                                    while (oooO00o.OooOo0()) {
                                        if (oooO00o.Oooo0o0(OooOo00.f36874OooO0o) != 0) {
                                            oooO00o.Oooo0oO();
                                            oooO00o.OoooO00();
                                        } else {
                                            oooO00o.OooO00o();
                                            while (oooO00o.OooOo0()) {
                                                ...
                                                String strOooo4 = "";
                                                while (oooO00o.OooOo0()) {
                                                    int iOooo0o4 = oooO00o.Oooo0o0(OooOo00.f36875OooO0oO);
                                                    if (iOooo0o4 == 0) {
                                                        ...
                                                        if (b3 == 0) {
                                                            oooOo00.f36879OooO0Oo = OooO0o.OooO0O0(oooO00o, oooOO1, true);
                                                        } else if (b3 == 1) {
                                                            oooOo00.f36877OooO0O0 = OooO0o.OooO0O0(oooO00o, oooOO1, false);
                                                        } else if (b3 == c2) {
                                                            oooOo00.f36878OooO0OO = OooO0o.OooO0O0(oooO00o, oooOO1, false);
                                                        } else if (b3 == 3) {
                                                            oooOo00.f36876OooO00o = OooO0o.OooO00o(oooO00o, oooOO1);
                                                        } else if (b3 != 4) {
                                                            oooO00o.OoooO00();
                                                        } else {
                                                            oooOo00.f36880OooO0o0 = OooO0o.OooO0O0(oooO00o, oooOO1, true);
                                                        }
                                                    }
                                                    c2 = 2;
                                                }
                                    ...
                                    p134o00OO0o.o00Ooo o00ooo2 = oooOo00.f36876OooO00o;
                                    oooOOOO = (o00ooo2 == null || (oo000oVar = oooOo00.f36877OooO0O0) == null || (oo000oVar2 = oooOo00.f36878OooO0OO) == null || (oo000oVar3 = oooOo00.f36879OooO0Oo) == null || (oo000oVar4 = oooOo00.f36880OooO0o0) == null) ? null : new OooOOOO(o00ooo2, oo000oVar, oo000oVar2, oo000oVar3, oo000oVar4);
                                }
                            } else if (iOooo0o2 != 1) {
                                oooO00o.Oooo0oO();
                                oooO00o.OoooO00();
                            } else {
                                arrayList3.add(oooO00o.Oooo0());
                            }
                            c2 = 2;
                            z = false;
                        }
                ...
                case 18:
                    ...
                    break;
                case 19:
                    fOooOooo3 = (float) oooO00o.OooOooo();
                    continue;
                    c = CharCompanionObject.MIN_VALUE;
                    break;
                case 20:
        ...
        if (fOooOooo4 > 0.0f) {
            arrayList4.add(new o00OOO0O.OooO00o(oooOO1, fValueOf2, fValueOf2, (Interpolator) null, 0.0f, Float.valueOf(fOooOooo4)));
        }
        if (fOooOooo3 <= 0.0f) {
            fOooOooo3 = oooOO1.f11823OooOO0o;
        }
        arrayList4.add(new o00OOO0O.OooO00o(oooOO1, fValueOf, fValueOf, (Interpolator) null, fOooOooo4, Float.valueOf(fOooOooo3)));
        arrayList4.add(new o00OOO0O.OooO00o(oooOO1, fValueOf2, fValueOf2, (Interpolator) null, fOooOooo3, Float.valueOf(Float.MAX_VALUE)));
        if (strOooo2.endsWith(".ai") || "ai".equals(str)) {
            str = strOooo0;
            oooOO1.OooO00o("Convert your Illustrator layers to shape layers.");
        }
        str = strOooo0;
        return new Layer(arrayList2, oooOO1, strOooo2, jOooo00o, layerType, jOooo00o2, strOooo1, arrayList, o000000oOooO00o, iOooO0OO, iOooO0OO2, color, fOooOooo, fOooOooo2, iOooO0OO3, iOooO0OO4, o000ooo2, o000000Var, arrayList4, matteType2, oo000oVarOooO0O0, zOooOo, oooO0OO, oooOOOO);
    }
}
