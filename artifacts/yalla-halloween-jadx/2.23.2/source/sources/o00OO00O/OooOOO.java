...
public final class OooOOO {
    ...
    public static final boolean f37075OooO00o;
    ...
    static {
        ...
        if (i == 26) {
            ...
            if (str2 == null) {
                zContains = false;
            } else if (StringsKt__StringsJVMKt.startsWith$default(StringsKt.removePrefix(str2, (CharSequence) "SAMSUNG-"), "SM-", false, 2, null)) {
                zContains = true;
            } else {
