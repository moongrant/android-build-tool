...
public final class o0ooOOo<DataT> implements o0OoOo0<Uri, DataT> {
    ...
    public final Context f37915OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final o0OoOo0<Integer, DataT> f37916OooO0O0;

    public static final class OooO00o implements o00O0O<Uri, AssetFileDescriptor> {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final Context f37917OooO00o;

        public OooO00o(Context context) {
            this.f37917OooO00o = context;
        }
        ...
        public final o0OoOo0<Uri, AssetFileDescriptor> OooO0Oo(@NonNull oo000o oo000oVar) {
            return new o0ooOOo(this.f37917OooO00o, oo000oVar.OooO0OO(Integer.class, AssetFileDescriptor.class));
        }
    }
    ...
    public static final class OooO0O0 implements o00O0O<Uri, InputStream> {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final Context f37918OooO00o;

        public OooO0O0(Context context) {
            this.f37918OooO00o = context;
        }
        ...
        public final o0OoOo0<Uri, InputStream> OooO0Oo(@NonNull oo000o oo000oVar) {
            return new o0ooOOo(this.f37918OooO00o, oo000oVar.OooO0OO(Integer.class, InputStream.class));
        }
    }

    public o0ooOOo(Context context, o0OoOo0<Integer, DataT> o0oooo1) {
        this.f37915OooO00o = context.getApplicationContext();
        this.f37916OooO0O0 = o0oooo1;
    }

    @Override // o00OoO.o0OoOo0
    public final boolean OooO00o(@NonNull Uri uri) {
        Uri uri2 = uri;
        return "android.resource".equals(uri2.getScheme()) && this.f37915OooO00o.getPackageName().equals(uri2.getAuthority());
    }
    ...
    public final o0OoOo0.OooO00o OooO0O0(@NonNull Uri uri, int i, int i2, @NonNull p154o00Oo0oo.oo0o0Oo oo0o0oo) {
        ...
        o0OoOo0<Integer, DataT> o0oooo1 = this.f37916OooO0O0;
        o0OoOo0.OooO00o<DataT> oooO00oOooO0O0 = null;
        if (size == 1) {
            try {
                int i3 = Integer.parseInt(uri2.getPathSegments().get(0));
                if (i3 != 0) {
                    oooO00oOooO0O0 = o0oooo1.OooO0O0(Integer.valueOf(i3), i, i2, oo0o0oo);
        ...
        Context context = this.f37915OooO00o;
        int identifier = context.getResources().getIdentifier(str2, str, context.getPackageName());
        if (identifier != 0) {
            return o0oooo1.OooO0O0(Integer.valueOf(identifier), i, i2, oo0o0oo);
        }
        if (!Log.isLoggable("ResourceUriLoader", 5)) {
            return null;
        }
