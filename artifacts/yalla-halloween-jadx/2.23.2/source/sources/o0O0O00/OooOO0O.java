...
public class OooOO0O extends OooOO0 {
    ...
    public int f41124OooOOO0;

    public OooOO0O(o0OoOo0 o0oooo1) {
        super(o0oooo1);
        if (o0oooo1 instanceof OooOo) {
            this.f41118OooO0o0 = OooOO0.OooO00o.HORIZONTAL_DIMENSION;
        } else {
            this.f41118OooO0o0 = OooOO0.OooO00o.VERTICAL_DIMENSION;
        }
    }
