...
public final class RouteException extends RuntimeException {
    ...
    @NotNull
    public final IOException f60179OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @NotNull
    public IOException f60180OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RouteException(@NotNull IOException firstConnectException) {
        super(firstConnectException);
        Intrinsics.checkNotNullParameter(firstConnectException, "firstConnectException");
        this.f60179OooO0Oo = firstConnectException;
        this.f60180OooO0o0 = firstConnectException;
    }
}
