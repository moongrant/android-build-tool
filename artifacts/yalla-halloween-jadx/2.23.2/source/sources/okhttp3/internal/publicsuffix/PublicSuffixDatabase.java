...
public final class PublicSuffixDatabase {
    ...
    @NotNull
    public static final List<String> f60182OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @NotNull
    public static final byte[] f60183OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    @NotNull
    public static final PublicSuffixDatabase f60184OooO0oO;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    @NotNull
    public final AtomicBoolean f60185OooO00o = new AtomicBoolean(false);

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public final CountDownLatch f60186OooO0O0 = new CountDownLatch(1);

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public byte[] f60187OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public byte[] f60188OooO0Oo;
    ...
    public static final class OooO00o {
        public static final String OooO00o(byte[] bArr, byte[][] bArr2, int i) {
            ...
            int i3;
            int i4;
            byte[] bArr3 = PublicSuffixDatabase.f60183OooO0o0;
            ...
            while (i5 < length) {
                ...
                while (true) {
                    ...
                    byte b2 = bArr[i7 + i12];
                    byte[] bArr5 = oO000o00.f58124OooO00o;
    ...
    static {
        new OooO00o();
        f60183OooO0o0 = new byte[]{42};
        f60182OooO0o = CollectionsKt.listOf("*");
        f60184OooO0oO = new PublicSuffixDatabase();
    }
    ...
    public final String OooO00o(@NotNull String domain) {
        ...
        if (this.f60185OooO00o.get() || !this.f60185OooO00o.compareAndSet(false, true)) {
            try {
                this.f60186OooO0O0.await();
            ...
            while (true) {
                try {
                    ...
                    o000O0o.OooO(e, 5, "Failed to read public suffix list");
                    if (z) {
                        Thread.currentThread().interrupt();
                    }
                }
        ...
        while (true) {
            ...
            int i5 = i4 + 1;
            bArr3[i4] = f60183OooO0o0;
            byte[] bArr4 = this.f60187OooO0OO;
            if (bArr4 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("publicSuffixListBytes");
                bArr4 = null;
            }
        ...
        if (strOooO00o3 != null) {
            ...
            listSplit$default = f60182OooO0o;
        } else {
    ...
    public final void OooO0O0() throws IOException {
        ...
        o0o0000 o0o0000VarOooO0O0 = o0OO.OooO0O0(new o0OO00o0(o0OO.OooO0oo(resourceAsStream)));
        try {
            long j = o0o0000VarOooO0O0.readInt();
            o0o0000VarOooO0O0.OoooOoO(j);
            byte[] bArrOooo0OO = o0o0000VarOooO0O0.f59801OooO0o0.Oooo0OO(j);
            long j2 = o0o0000VarOooO0O0.readInt();
            o0o0000VarOooO0O0.OoooOoO(j2);
            byte[] bArrOooo0OO2 = o0o0000VarOooO0O0.f59801OooO0o0.Oooo0OO(j2);
            Unit unit = Unit.INSTANCE;
            CloseableKt.closeFinally(o0o0000VarOooO0O0, null);
            synchronized (this) {
                Intrinsics.checkNotNull(bArrOooo0OO);
                this.f60187OooO0OO = bArrOooo0OO;
                Intrinsics.checkNotNull(bArrOooo0OO2);
                this.f60188OooO0Oo = bArrOooo0OO2;
            }
            this.f60186OooO0O0.countDown();
        } catch (Throwable th) {
            try {
                throw th;
            } catch (Throwable th2) {
