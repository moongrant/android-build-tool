...
import p659o0oooO.o00O0000;
import p662o0oooO0O.oO000;
import p662o0oooO0O.oO0000o0;
...
public class ByteString implements Serializable, Comparable<ByteString> {
    ...
    @JvmField
    @NotNull
    public static final ByteString f60193OooO0oO;
    ...
    @Nullable
    public transient String f60195OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public transient int f60196OooO0o0;
    ...
    public static final class OooO00o {
        ...
        public static ByteString OooO00o(@NotNull String str) {
            ...
            byte[] bArr = oO0000o0.f59819OooO00o;
            Intrinsics.checkNotNullParameter(str, "<this>");
        ...
        public static ByteString OooO0O0(@NotNull String str) {
            ...
            for (int i = 0; i < length; i++) {
                int i2 = i * 2;
                bArr[i] = (byte) (o00O0000.OooO00o(str.charAt(i2 + 1)) + (o00O0000.OooO00o(str.charAt(i2)) << 4));
            }
        ...
        public static ByteString OooO0Oo(int i, int i2, @NotNull byte[] bArr) {
            ...
            Intrinsics.checkNotNullParameter(bArr, "<this>");
            if (i2 == oO000.f59810OooO0O0) {
                i2 = bArr.length;
            }
            oO000.OooO0O0(bArr.length, i, i2);
            return new ByteString(ArraysKt.copyOfRange(bArr, i, i2 + i));
        }

        public static ByteString OooO0o0(byte[] bArr) {
            return OooO0Oo(0, oO000.f59810OooO0O0, bArr);
        }
    }

    static {
        new OooO00o();
        f60193OooO0oO = new ByteString(new byte[0]);
    }
    ...
    public String OooO00o() {
        byte[] bArr = this.data;
        byte[] map = oO0000o0.f59819OooO00o;
        Intrinsics.checkNotNullParameter(bArr, "<this>");
    ...
    */
    ...
    public String OooO0o() {
        ...
        for (byte b : bArr) {
            int i2 = i + 1;
            char[] cArr2 = o00O0000.f59652OooO00o;
            cArr[i] = cArr2[(b >> 4) & 15];
            i = i2 + 1;
            cArr[i2] = cArr2[b & 15];
        }
    ...
    public int OooO0oO(int i, @NotNull byte[] other) {
        ...
        if (iMax <= length) {
            while (!oO000.OooO00o(this.data, iMax, 0, other, other.length)) {
                if (iMax != length) {
                    iMax++;
                }
            }
    ...
    public int OooOO0O(int i, @NotNull byte[] other) {
        Intrinsics.checkNotNullParameter(other, "other");
        for (int iMin = Math.min(oO000.OooO0OO(i, this), this.data.length - other.length); -1 < iMin; iMin--) {
            if (oO000.OooO00o(this.data, iMin, 0, other, other.length)) {
                return iMin;
            }
        }
        return -1;
    ...
    public boolean OooOOOO(int i, @NotNull byte[] other, int i2, int i3) {
        ...
        if (i >= 0) {
            byte[] bArr = this.data;
            if (i <= bArr.length - i3 && i2 >= 0 && i2 <= other.length - i3 && oO000.OooO00o(bArr, i, i2, other, i3)) {
                return true;
            }
        }
        return false;
    ...
    public void OooOo0(@NotNull oo0OOoo buffer, int i) {
        Intrinsics.checkNotNullParameter(buffer, "buffer");
        Intrinsics.checkNotNullParameter(this, "<this>");
        Intrinsics.checkNotNullParameter(buffer, "buffer");
        buffer.OoooooO(0, i, this.data);
    }

    @NotNull
    public final String OooOo00() {
        String str = this.f60195OooO0o;
        if (str != null) {
            return str;
        }
        byte[] data = getData();
    ...
    public String toString() {
        ...
        sb.append(" hex=");
        int iOooO0OO = oO000.OooO0OO(64, this);
