...
public final class OooO0OO {
    ...
    public final OooO00o f60357OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final ArrayList f60358OooO0O0;

    public OooO0OO(OooO00o oooO00o) {
        this.f60357OooO00o = oooO00o;
        ArrayList arrayList = new ArrayList();
        this.f60358OooO0O0 = arrayList;
    ...
    public final void OooO00o(int i, int[] iArr) {
        ...
        ArrayList arrayList = this.f60358OooO0O0;
        int size = arrayList.size();
        int i2 = 0;
        int i3 = 1;
        OooO00o oooO00o = this.f60357OooO00o;
        if (i >= size) {
            OooO0O0 oooO0O4 = (OooO0O0) OooOOO.OooO00o(arrayList, 1);
            int size2 = arrayList.size();
            while (size2 <= i) {
                int[] iArr3 = {i3, oooO00o.f60349OooO00o[(size2 - 1) + oooO00o.f60353OooO0o]};
                if (iArr3[i2] == 0) {
                    int i4 = i3;
                ...
                oooO0O4.getClass();
                OooO00o oooO00o2 = oooO0O4.f60355OooO00o;
                if (!oooO00o2.equals(oooO00o)) {
                    throw new IllegalArgumentException("GenericGFPolys do not have same GenericGF field");
                }
                int[] iArr5 = oooO0O4.f60356OooO0O0;
                if ((iArr5[i2] == 0 ? i3 : i2) != 0) {
                    oooO0O3 = oooO00o2.f60351OooO0OO;
                } else {
                    if (iArr3[i2] != 0) {
                        i3 = i2;
                    }
        ...
        if (!oooO00o.equals(oooO0O5.f60355OooO00o)) {
            throw new IllegalArgumentException("GenericGFPolys do not have same GenericGF field");
        }
        int[] iArr10 = oooO0O5.f60356OooO0O0;
        if (iArr10[0] == 0) {
        ...
        int i13 = oooO00o.f60349OooO00o[(oooO00o.f60352OooO0Oo - oooO00o.f60350OooO0O0[i12]) - 1];
        OooO0O0 oooO0O7 = oooO00o.f60351OooO0OO;
        OooO0O0 oooO0O0OooO00o = oooO0O7;
        while (true) {
            iArr2 = oooO0O6.f60356OooO0O0;
            ...
            OooO00o oooO00o3 = oooO0O5.f60355OooO00o;
            if (iOooO00o == 0) {
                oooO0O1 = oooO00o3.f60351OooO0OO;
                oooO0O0 = oooO0O5;
            } else {
