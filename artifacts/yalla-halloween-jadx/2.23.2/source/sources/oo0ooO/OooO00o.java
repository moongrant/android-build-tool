...
import o0OO00OO.OooOO0O;
import o0OO00OO.OooOOO;
import o0OO00OO.OooOOOO;
import o0OO00OO.OooOo00;
import p264o00ooo0o.o00O0O00;
...
public final class OooO00o implements OooO0o {
    ...
    public final OooO0O0 OooO00o(String str, BarcodeFormat barcodeFormat, EnumMap enumMap) {
        ...
        o0O.OooO00o oooO00o = (o0O.OooO00o) enumMap.get(EncodeHintType.MIN_SIZE);
        if (oooO00o == null) {
            oooO00o = null;
        }
        o0O.OooO00o oooO00o2 = (o0O.OooO00o) enumMap.get(EncodeHintType.MAX_SIZE);
        o0O.OooO00o oooO00o3 = oooO00o2 != null ? oooO00o2 : null;
        int i4 = 0;
        int i5 = 1;
        int i6 = 2;
        int i7 = 3;
        OooO[] oooOArr = {new o0OO00OO.OooO00o(), new Oooo000(), new OooOOOO(), new OooOo00(), new o00O0O00(), new o0OO00OO.OooO0O0()};
        OooOO0 oooOO1 = new OooOO0(str);
        oooOO1.f42292OooO0O0 = symbolShapeHint;
        oooOO1.f42293OooO0OO = oooO00o;
        oooOO1.f42294OooO0Oo = oooO00o3;
        if (str.startsWith("[)>\u001e05\u001d") && str.endsWith("\u001e\u0004")) {
            oooOO1.OooO0o0((char) 236);
            oooOO1.f42290OooO = 2;
            oooOO1.f42295OooO0o += 7;
        } else if (str.startsWith("[)>\u001e06\u001d") && str.endsWith("\u001e\u0004")) {
            oooOO1.OooO0o0((char) 237);
            oooOO1.f42290OooO = 2;
            oooOO1.f42295OooO0o += 7;
        }
        int i8 = 0;
        while (oooOO1.OooO0OO()) {
            oooOArr[i8].OooO00o(oooOO1);
            int i9 = oooOO1.f42297OooO0oO;
            if (i9 >= 0) {
                oooOO1.f42297OooO0oO = -1;
                i8 = i9;
            }
        }
        int iOooO00o = oooOO1.OooO00o();
        oooOO1.OooO0Oo(oooOO1.OooO00o());
        int i10 = oooOO1.f42298OooO0oo.f42305OooO0O0;
        if (iOooO00o < i10 && i8 != 0 && i8 != 5 && i8 != 4) {
            oooOO1.OooO0o0((char) 254);
        }
        StringBuilder sb = oooOO1.f42296OooO0o0;
        if (sb.length() < i10) {
            sb.append((char) 129);
        }
        while (sb.length() < i10) {
        ...
        OooOOO oooOOOOooO0o = OooOOO.OooO0o(string.length(), symbolShapeHint, oooO00o, oooO00o3);
        int[] iArr = OooOO0O.f42299OooO00o;
        int length2 = string.length();
        int i11 = oooOOOOooO0o.f42305OooO0O0;
        if (length2 != i11) {
            throw new IllegalArgumentException("The number of codewords does not match the selected symbol");
        }
        int i12 = oooOOOOooO0o.f42306OooO0OO;
        StringBuilder sb2 = new StringBuilder(i11 + i12);
        sb2.append(string);
        int iOooO0OO = oooOOOOooO0o.OooO0OO();
        if (iOooO0OO == 1) {
            sb2.append(OooOO0O.OooO00o(i12, string));
        } else {
            ...
            while (i13 < iOooO0OO) {
                ...
                iArr3[i13] = oooOOOOooO0o.f42311OooO0oo;
                iArr4[i13] = 0;
                if (i13 > 0) {
            ...
            for (int i15 = 0; i15 < iOooO0OO; i15++) {
                ...
                String strOooO00o = OooOO0O.OooO00o(iArr3[i15], sb3.toString());
                int i17 = i15;
                int i18 = 0;
        ...
        int i19 = oooOOOOooO0o.f42307OooO0Oo;
        int iOooO0o0 = oooOOOOooO0o.OooO0o0();
        int i20 = oooOOOOooO0o.f42309OooO0o0;
        o0OO00OO.OooO0o oooO0o = new o0OO00OO.OooO0o(string2, iOooO0O0 * i19, iOooO0o0 * i20);
        int i21 = 0;
        int i22 = 0;
        int i23 = 4;
        while (true) {
            i = oooO0o.f42288OooO0OO;
            i2 = oooO0o.f42287OooO0O0;
            if (i23 == i2 && i21 == 0) {
                int i24 = i2 - 1;
        ...
        int[] iArr5 = oooO0O0.f42266OooO0oO;
