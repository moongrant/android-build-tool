...
abstract class NativeSslSession {
    ...
    private static void checkRemaining(ByteBuffer byteBuffer, int i) throws IOException {
        if (i < 0) {
            throw new IOException(android.support.v4.media.OooO00o.OooO00o("Length is negative: ", i));
        }
        if (i <= byteBuffer.remaining()) {
            return;
        }
        StringBuilder sbOooO0O0 = o0000O0.OooO0O0("Length of blob is longer than available: ", i, " > ");
