...
public abstract class OpenSSLCipher extends CipherSpi {
    ...
    public void engineSetMode(String str) throws NoSuchAlgorithmException {
        try {
            ...
            NoSuchAlgorithmException noSuchAlgorithmException = new NoSuchAlgorithmException(o00O00OO.OooO00o("No such mode: ", str));
    ...
    public void engineSetPadding(String str) throws NoSuchPaddingException {
        try {
            ...
            NoSuchPaddingException noSuchPaddingException = new NoSuchPaddingException(o00O00OO.OooO00o("No such padding: ", str));
    ...
    public byte[] engineUpdate(byte[] bArr, int i, int i2) {
        ...
        try {
            ...
            throw new RuntimeException(android.support.v4.media.OooO00o.OooO00o("calculated buffer size was wrong: ", outputSizeForUpdate));
        }
    }
