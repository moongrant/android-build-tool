...
public final class OpenSSLECKeyPairGenerator extends KeyPairGenerator {
    ...
    public KeyPair generateKeyPair() {
        if (this.group == null) {
            ...
            if (curveByName == null) {
                throw new RuntimeException(o00O00OO.OooO00o("Curve not recognized: ", str));
            }
        }
    ...
    public void initialize(AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidAlgorithmParameterException {
        ...
        if (algorithmParameterSpec instanceof ECGenParameterSpec) {
            ...
            throw new InvalidAlgorithmParameterException(o00O00OO.OooO00o("unknown curve name: ", name));
        }
