...
public final class OooOo {
    ...
    public static final class OooO00o extends Lambda implements Function0<Unit> {
        ...
        public final /* synthetic */ OooO0o f203OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ boolean f204OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(OooO0o oooO0o, boolean z) {
            super(0);
            this.f203OooO0Oo = oooO0o;
            this.f204OooO0o0 = z;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            OooO0o oooO0o = this.f203OooO0Oo;
            oooO0o.f2191OooO00o = this.f204OooO0o0;
            Function0<Unit> function0 = oooO0o.f2193OooO0OO;
            if (function0 != null) {
                function0.invoke();
            }
    ...
    public static final class OooO0O0 extends Lambda implements Function1<DisposableEffectScope, DisposableEffectResult> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ OnBackPressedDispatcher f205OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ OooO0o f206OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ LifecycleOwner f207OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(OnBackPressedDispatcher onBackPressedDispatcher, LifecycleOwner lifecycleOwner, OooO0o oooO0o) {
            super(1);
            this.f205OooO0Oo = onBackPressedDispatcher;
            this.f207OooO0o0 = lifecycleOwner;
            this.f206OooO0o = oooO0o;
        }
        ...
        public final DisposableEffectResult invoke(DisposableEffectScope disposableEffectScope) {
            ...
            OnBackPressedDispatcher onBackPressedDispatcher = this.f205OooO0Oo;
            LifecycleOwner lifecycleOwner = this.f207OooO0o0;
            OooO0o oooO0o = this.f206OooO0o;
    ...
    public static final class OooO0OO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ boolean f208OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f209OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ Function0<Unit> f210OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f211OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(boolean z, Function0<Unit> function0, int i, int i2) {
            super(2);
            this.f208OooO0Oo = z;
            this.f210OooO0o0 = function0;
            this.f209OooO0o = i;
            this.f211OooO0oO = i2;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int i = this.f209OooO0o | 1;
            OooOo.OooO00o(this.f208OooO0Oo, this.f210OooO0o0, composer, i, this.f211OooO0oO);
            return Unit.INSTANCE;
        }
    }

    public static final class OooO0o extends o000oOoO {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ State<Function0<Unit>> f212OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public OooO0o(boolean z, State<? extends Function0<Unit>> state) {
            super(z);
            this.f212OooO0Oo = state;
        }

        @Override // androidx.activity.o000oOoO
        public final void OooO00o() {
            this.f212OooO0Oo.getValue().invoke();
        }
    }
    ...
    public static final void OooO00o(boolean z, @NotNull Function0<Unit> onBack, @Nullable Composer composer, int i, int i2) {
        ...
        if ((i3 & 91) == 18 && composerStartRestartGroup.getSkipping()) {
            ...
            o00Oo0 o00oo0OooO00o = o000oOoO.OooO00o(composerStartRestartGroup);
            if (o00oo0OooO00o == null) {
                throw new IllegalStateException("No OnBackPressedDispatcherOwner was provided via LocalOnBackPressedDispatcherOwner".toString());
            }
            OnBackPressedDispatcher onBackPressedDispatcher = o00oo0OooO00o.getOnBackPressedDispatcher();
