...
public abstract class OooOo00 implements Oooo000, OooOOO, AdapterView.OnItemClickListener {
    ...
    public final void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
        ...
        (listAdapter instanceof HeaderViewListAdapter ? (OooO0o) ((HeaderViewListAdapter) listAdapter).getWrappedAdapter() : (OooO0o) listAdapter).f2616OooO0Oo.OooOOo0((MenuItem) listAdapter.getItem(i), this, (this instanceof CascadingMenuPopup) ^ true ? 0 : 4);
    }
}
