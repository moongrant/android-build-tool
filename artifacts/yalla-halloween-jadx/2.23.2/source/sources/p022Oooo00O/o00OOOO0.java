...
public final /* synthetic */ class o00OOOO0 implements Runnable {
    ...
    public final /* synthetic */ int f649OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ Object f650OooO0o0;

    public /* synthetic */ o00OOOO0(Object obj, int i) {
        this.f649OooO0Oo = i;
        this.f650OooO0o0 = obj;
    }
    ...
    public final void run() {
        ...
        Bundle bundle;
        int i = this.f649OooO0Oo;
        Object obj = this.f650OooO0o0;
        switch (i) {
            case 0:
            ...
            case 1:
                ...
                break;
            case 2:
                final Context context = ((FirebaseMessaging) obj).f19764OooO0Oo;
                ...
                if (!applicationContext.getSharedPreferences("com.google.firebase.messaging", 0).getBoolean("proxy_notification_initialized", false)) {
                    ...
                    if (PlatformVersion.isAtLeastQ()) {
                        ...
                        new Runnable() { // from class: com.google.firebase.messaging.o000000
                            @Override // java.lang.Runnable
                            public final void run() {
            ...
            default:
                ...
                AtomicInteger atomicInteger = OooO0OO.f20768OooO0OO;
                if (oooO0O0 != null) {
                    oooO0O0.onError();
                }
                break;
