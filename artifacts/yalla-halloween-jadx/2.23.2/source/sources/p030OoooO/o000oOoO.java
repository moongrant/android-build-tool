...
@RequiresApi(21)
public abstract class o000oOoO<V> implements OooOO0O<V> {

    public static class OooO00o<V> extends o000oOoO<V> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        @NonNull
        public final Throwable f1345OooO0Oo;

        public OooO00o(@NonNull Throwable th) {
            this.f1345OooO0Oo = th;
        }

        @Override // java.util.concurrent.Future
        @Nullable
        public final V get() throws ExecutionException {
            throw new ExecutionException(this.f1345OooO0Oo);
        }

        @NonNull
        public final String toString() {
            return super.toString() + "[status=FAILURE, cause=[" + this.f1345OooO0Oo + "]]";
        }
    }
    ...
    public static final class OooO0OO<V> extends o000oOoO<V> {

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public static final OooO0OO f1346OooO0o0 = new OooO0OO(null);

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        @Nullable
        public final V f1347OooO0Oo;
        ...
        @Nullable
        public final V get() {
            return this.f1347OooO0Oo;
        }

        public final String toString() {
            return super.toString() + "[status=SUCCESS, result=[" + this.f1347OooO0Oo + "]]";
        }
    }
