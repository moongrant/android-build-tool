...
public final class o0OOO0o extends AbstractExecutorService implements ScheduledExecutorService {
    ...
    public final Handler f1402OooO0Oo;
    ...
    public class OooO0O0 implements Callable<Void> {
        ...
        public final /* synthetic */ Runnable f1403OooO00o;

        public OooO0O0(Runnable runnable) {
            this.f1403OooO00o = runnable;
        }

        @Override // java.util.concurrent.Callable
        public final Void call() throws Exception {
            this.f1403OooO00o.run();
            return null;
        }
    }
    ...
    public static class OooO0OO<V> implements RunnableScheduledFuture<V> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final AtomicReference<o000Oo0.OooO00o<V>> f1404OooO0Oo = new AtomicReference<>(null);

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final Callable<V> f1405OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final long f1406OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final o000Oo0.OooO0o f1407OooO0oO;

        public class OooO00o implements o000Oo0.OooO0OO<V> {

            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ Handler f1408OooO0Oo;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public final /* synthetic */ Callable f1410OooO0o0;
            ...
            public class RunnableC0005OooO00o implements Runnable {
                ...
                public final void run() {
                    ...
                    if (OooO0OO.this.f1404OooO0Oo.getAndSet(null) != null) {
                        oooO00o.f1408OooO0Oo.removeCallbacks(OooO0OO.this);
                    }
                }
            }

            public OooO00o(Handler handler, Callable callable) {
                this.f1408OooO0Oo = handler;
                this.f1410OooO0o0 = callable;
            }

            @Override // o0ooOO0.o000Oo0.OooO0OO
            public final Object OooO0o0(@NonNull o000Oo0.OooO00o<V> oooO00o) throws RejectedExecutionException {
                oooO00o.OooO00o(new RunnableC0005OooO00o(), o00oO0o.OooO00o());
                OooO0OO.this.f1404OooO0Oo.set(oooO00o);
                return "HandlerScheduledFuture-" + this.f1410OooO0o0.toString();
            }
        }

        public OooO0OO(Handler handler, long j, Callable<V> callable) {
            this.f1406OooO0o0 = j;
            this.f1405OooO0o = callable;
            this.f1407OooO0oO = o000Oo0.OooO00o(new OooO00o(handler, callable));
        }

        @Override // java.util.concurrent.Future
        public final boolean cancel(boolean z) {
            return this.f1407OooO0oO.cancel(z);
        }
        ...
        public final V get() throws ExecutionException, InterruptedException {
            return (V) this.f1407OooO0oO.get();
        }

        @Override // java.util.concurrent.Delayed
        public final long getDelay(TimeUnit timeUnit) {
            return timeUnit.convert(this.f1406OooO0o0 - System.currentTimeMillis(), TimeUnit.MILLISECONDS);
        }

        @Override // java.util.concurrent.Future
        public final boolean isCancelled() {
            return this.f1407OooO0oO.isCancelled();
        }

        @Override // java.util.concurrent.Future
        public final boolean isDone() {
            return this.f1407OooO0oO.isDone();
        }
        ...
        public final void run() {
            o000Oo0.OooO00o andSet = this.f1404OooO0Oo.getAndSet(null);
            if (andSet != null) {
                try {
                    andSet.OooO0O0(this.f1405OooO0o.call());
                } catch (Exception e) {
                    andSet.OooO0OO(e);
                }
            }
        ...
        public final V get(long j, @NonNull TimeUnit timeUnit) throws ExecutionException, InterruptedException, TimeoutException {
            return (V) this.f1407OooO0oO.f57741OooO0o0.get(j, timeUnit);
        }
    }
    ...
    public final void execute(@NonNull Runnable runnable) {
        Handler handler = this.f1402OooO0Oo;
    ...
    public final <V> ScheduledFuture<V> schedule(@NonNull Callable<V> callable, long j, @NonNull TimeUnit timeUnit) {
        ...
        return new o000oOoO.OooO0O0(new RejectedExecutionException(handler + " is shutting down"));
    }
}
