...
public final class o00oO0o {
    ...
    public final o0Oo0oo f1425OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final Rational f1426OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final boolean f1427OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final o0ooOOo f1428OooO0Oo;

    public o00oO0o(@NonNull o0Oo0oo o0oo0oo2, @Nullable Size size) {
        Rational rational;
        this.f1425OooO00o = o0oo0oo2;
        o0oo0oo2.OooO0OO();
        o0oo0oo2.OooO0o0();
        if (size != null) {
        ...
        this.f1426OooO0O0 = rational;
        this.f1427OooO0OO = rational == null || rational.getNumerator() >= rational.getDenominator();
        this.f1428OooO0Oo = new o0ooOOo(o0oo0oo2, rational);
    }
    ...
    public static ArrayList OooO0O0(@NonNull ArrayList arrayList) {
        ...
        arrayList2.add(OooOOOO.f1359OooO00o);
        arrayList2.add(OooOOOO.f1361OooO0OO);
        ...
        while (it.hasNext()) {
            ...
            if (!arrayList2.contains(rational)) {
                ...
                while (true) {
                    ...
                    if (OooOOOO.OooO00o(size, (Rational) it2.next(), o0000oo.f1447OooO0OO)) {
                        z = true;
                        break;
                    }
                }
    ...
    public static Rational OooO0OO(int i, boolean z) {
        if (i != -1) {
            if (i == 0) {
                return z ? OooOOOO.f1359OooO00o : OooOOOO.f1360OooO0O0;
            }
            if (i == 1) {
                return z ? OooOOOO.f1361OooO0OO : OooOOOO.f1362OooO0Oo;
            }
    ...
    public static HashMap OooO0Oo(@NonNull ArrayList arrayList) {
        ...
        while (it2.hasNext()) {
            ...
            for (Rational rational : map.keySet()) {
                if (OooOOOO.OooO00o(size, rational, o0000oo.f1447OooO0OO)) {
    ...
    @NonNull
    public final ArrayList OooO00o(@NonNull o00Oo00 o00oo00) {
        Size[] sizeArr;
        int iOooO0o = o00oo00.OooO0o();
        List listOooO00o = ((ImageOutputConfig) o00oo00).OooO00o();
        if (listOooO00o == null) {
            sizeArr = null;
            break;
        }
        ...
        if (listAsList == null) {
            listAsList = this.f1425OooO00o.OooO0oo(iOooO0o);
        }
