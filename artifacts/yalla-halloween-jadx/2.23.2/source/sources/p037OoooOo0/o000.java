...
public final class o000 implements o00O000, SurfaceTexture.OnFrameAvailableListener {
    ...
    public final o000Oo0 f1471OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final o0OOO0o f1472OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @VisibleForTesting
    public final HandlerThread f1473OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    @VisibleForTesting
    public final Handler f1474OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final AtomicBoolean f1475OooO0oo = new AtomicBoolean(false);

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    public final float[] f1470OooO = new float[16];

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public final float[] f1476OooOO0 = new float[16];

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public final LinkedHashMap f1477OooOO0O = new LinkedHashMap();

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    public int f1478OooOO0o = 0;

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    public boolean f1480OooOOO0 = false;

    /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
    public final ArrayList f1479OooOOO = new ArrayList();

    @AutoValue
    public static abstract class OooO00o {
        @NonNull
        public abstract o000Oo0.OooO00o<Void> OooO00o();
    ...
    public o000(@NonNull final DynamicRange dynamicRange) {
        ...
        this.f1473OooO0o0 = handlerThread;
        handlerThread.start();
        Handler handler = new Handler(handlerThread.getLooper());
        this.f1474OooO0oO = handler;
        this.f1472OooO0o = new o0OOO0o(handler);
        this.f1471OooO0Oo = new o000Oo0();
        try {
            try {
                o000Oo0.OooO00o(new o000Oo0.OooO0OO(this) { // from class: OoooOo0.o0000O00

                    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
                    public final /* synthetic */ o000 f1508OooO0Oo;

                    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
                    public final /* synthetic */ o000O00O f1509OooO0o;

                    {
                        o000O00O.OooO00o oooO00o = o000O00O.f1528OooO00o;
                        this.f1508OooO0Oo = this;
                        this.f1509OooO0o = oooO00o;
                    }
                    ...
                    public final Object OooO0o0(o000Oo0.OooO00o oooO00o) {
                        ...
                        o000O00O o000o00o2 = this.f1509OooO0o;
                        o000 o000Var = this.f1508OooO0Oo;
                        o000Var.getClass();
    ...
    public final void OooO(@NonNull final Runnable runnable, @NonNull final Runnable runnable2) {
        try {
            this.f1472OooO0o.execute(new Runnable() { // from class: OoooOo0.o0000O0
                @Override // java.lang.Runnable
                public final void run() {
                    if (this.f1505OooO0Oo.f1480OooOOO0) {
                        runnable2.run();
                    } else {
                        runnable.run();
                    }
    ...
    public final OooOO0O<Void> OooO0Oo(@IntRange(from = ULong.MIN_VALUE, to = AndroidComposeViewAccessibilityDelegateCompat.SendRecurringAccessibilityEventsIntervalMillis) final int i, @IntRange(from = ULong.MIN_VALUE, to = 359) final int i2) {
        return OooOo.OooO0o0(o000Oo0.OooO00o(new o000Oo0.OooO0OO() { // from class: OoooOo0.o0000OO0
            @Override // o0ooOO0.o000Oo0.OooO0OO
            public final Object OooO0o0(final o000Oo0.OooO00o oooO00o) {
                o000 o000Var = this.f1512OooO0Oo;
                o000Var.getClass();
                final int i3 = 0;
                o000Var.OooO(new o00000O(i3, o000Var, new o000000(i, i2, oooO00o)), new Runnable() { // from class: OoooOo0.o00000OO
                    ...
                    public final void run() {
                        ...
                        switch (i4) {
                            case 0:
                                ((o000Oo0.OooO00o) obj).OooO0OO(new Exception("Failed to snapshot: OpenGLRenderer not ready."));
                                break;
                            default:
    ...
    public final void OooO0oo() {
        if (this.f1480OooOOO0 && this.f1478OooOO0o == 0) {
            LinkedHashMap linkedHashMap = this.f1477OooOO0O;
            Iterator it = linkedHashMap.keySet().iterator();
            while (it.hasNext()) {
                ((SurfaceOutput) it.next()).close();
            }
            Iterator it2 = this.f1479OooOOO.iterator();
            while (it2.hasNext()) {
                ((OooO00o) it2.next()).OooO00o().OooO0OO(new Exception("Failed to snapshot: DefaultSurfaceProcessor is released."));
            }
            linkedHashMap.clear();
            o000Oo0 o000oo1 = this.f1471OooO0Oo;
            if (o000oo1.f1552OooO00o.getAndSet(false)) {
                o000oo1.OooO0OO();
                o000oo1.OooOOo0();
            }
            this.f1473OooO0o0.quit();
        }
    }

    public final void OooOO0(@NonNull Exception exc) {
        ArrayList arrayList = this.f1479OooOOO;
    ...
    public final Bitmap OooOO0O(@NonNull Size size, @NonNull float[] fArr, int i) {
        ...
        o000Oo0.OooO0O0("glActiveTexture");
        GLES20.glBindTexture(36197, o000oo1.f1551OooO);
        o000Oo0.OooO0O0("glBindTexture");
        o000oo1.f1559OooO0oo = null;
        ...
        GLES20.glUniformMatrix4fv(o000oo1.f1561OooOO0O, 1, false, fArr2, 0);
    ...
    public final void onFrameAvailable(@NonNull SurfaceTexture surfaceTexture) {
        ...
        float[] fArr = this.f1470OooO;
        surfaceTexture.getTransformMatrix(fArr);
        Triple<Surface, Size, float[]> triple = null;
        for (Map.Entry entry : this.f1477OooOO0O.entrySet()) {
            Surface surface = (Surface) entry.getValue();
            SurfaceOutput surfaceOutput = (SurfaceOutput) entry.getKey();
            float[] fArr2 = this.f1476OooOO0;
            ...
            if (surfaceOutput.getFormat() == 34) {
                ...
                if (o000000o2 == o000Oo0.f1550OooOo00) {
                    try {
                        EGLDisplay eGLDisplay = o000oo1.f1555OooO0Oo;
                        EGLConfig eGLConfig = o000oo1.f1556OooO0o;
                        Objects.requireNonNull(eGLConfig);
                        EGLSurface eGLSurfaceOooOO0 = o000Oo0.OooOO0(eGLDisplay, eGLConfig, surface);
                        int[] iArr = new int[1];
                        EGL14.eglQuerySurface(o000oo1.f1555OooO0Oo, eGLSurfaceOooOO0, 12375, iArr, 0);
                        int i = iArr[0];
                        int[] iArr2 = new int[1];
                        EGL14.eglQuerySurface(o000oo1.f1555OooO0Oo, eGLSurfaceOooOO0, 12374, iArr2, 0);
                ...
                if (surface != o000oo1.f1559OooO0oo) {
                    o000oo1.OooOOOo(o000000o2.OooO00o());
                    o000oo1.f1559OooO0oo = surface;
                ...
                GLES20.glDrawArrays(5, 0, 4);
                o000Oo0.OooO0O0("glDrawArrays");
                EGLExt.eglPresentationTimeANDROID(o000oo1.f1555OooO0Oo, o000000o2.OooO00o(), timestamp);
                if (!EGL14.eglSwapBuffers(o000oo1.f1555OooO0Oo, o000000o2.OooO00o())) {
    ...
    public final void release() {
        if (this.f1475OooO0oo.getAndSet(true)) {
            return;
        }
