    ...
    public static void OooO0O0(@NonNull StringBuilder sb, @NonNull MediaCodecInfo.CodecCapabilities codecCapabilities, @NonNull MediaFormat mediaFormat) {
        ...
        if (audioCapabilities != null) {
            ...
            if (Build.VERSION.SDK_INT >= 31) {
                sb.append("[AudioCaps] getMinInputChannelCount = " + o0oO0O0o.OooO0O0(audioCapabilities));
                sb.append("\n");
                sb.append("[AudioCaps] getInputChannelCountRanges = " + Arrays.toString(o0oO0O0o.OooO00o(audioCapabilities)));
                sb.append("\n");
            }
        ...
        if (encoderCapabilities != null) {
            ...
            if (Build.VERSION.SDK_INT >= 28) {
                sb.append("[EncoderCaps] getQualityRange = " + o0O00oO0.OooO00o(encoderCapabilities));
                sb.append("\n");
            }
            try {
