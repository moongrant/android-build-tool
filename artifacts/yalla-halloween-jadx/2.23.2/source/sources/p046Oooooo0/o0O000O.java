...
public final class o0O000O implements OooOOO<o000OOo0> {
    ...
    public final String f2023OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final Timebase f2024OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final OooOo f2025OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final Size f2026OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final DynamicRange f2027OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final EncoderProfilesProxy.VideoProfileProxy f2028OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final Range<Integer> f2029OooO0oO;
    ...
    public o0O000O(@NonNull String str, @NonNull Timebase timebase, @NonNull OooOo oooOo, @NonNull Size size, @NonNull EncoderProfilesProxy.VideoProfileProxy videoProfileProxy, @NonNull DynamicRange dynamicRange, @NonNull Range<Integer> range) {
        ...
        this.f2024OooO0O0 = timebase;
        this.f2025OooO0OO = oooOo;
        this.f2026OooO0Oo = size;
        this.f2028OooO0o0 = videoProfileProxy;
        this.f2027OooO0o = dynamicRange;
        this.f2029OooO0oO = range;
    }

    @Override // o000OO.OooOOO
    @NonNull
    public final o000OOo0 get() {
        EncoderProfilesProxy.VideoProfileProxy videoProfileProxy = this.f2028OooO0o0;
        int iOooO0o = videoProfileProxy.OooO0o();
        Range<Integer> range = SurfaceRequest.f3500OooOOOO;
        Range<Integer> range2 = this.f2029OooO0oO;
        ...
        Range<Integer> rangeOooO0OO = this.f2025OooO0OO.OooO0OO();
        ...
        Timebase timebase = this.f2024OooO0O0;
        if (timebase == null) {
        ...
        oooO00oOooO0Oo.f1835OooO0O0 = Integer.valueOf(iOooOO0);
