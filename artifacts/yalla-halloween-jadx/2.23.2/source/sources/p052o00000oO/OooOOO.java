...
public final class OooOOO {
    public static boolean OooO00o(@Nullable OooO00o[] oooO00oArr, @Nullable OooO00o[] oooO00oArr2) {
        ...
        for (int i = 0; i < oooO00oArr.length; i++) {
            ...
            char c = oooO00o.f33481OooO00o;
            OooO00o oooO00o2 = oooO00oArr2[i];
            if (c != oooO00o2.f33481OooO00o || oooO00o.f33482OooO0O0.length != oooO00o2.f33482OooO0O0.length) {
                return false;
            }
        }
        return true;
    ...
    */
                        ...
                        if (strTrim.length() <= 0) {
                            if (strTrim.charAt(i3) != 'z' || strTrim.charAt(i3) == 'Z') {
                                ...
                                try {
                                    ...
                                    throw new RuntimeException(o000oOoO.OooO0O0("error in parsing \"", strTrim, "\""), e);
                                }
                            }
    ...
    public static class OooO00o {
        ...
        public char f33481OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final float[] f33482OooO0O0;

        public OooO00o(char c, float[] fArr) {
            this.f33481OooO00o = c;
            this.f33482OooO0O0 = fArr;
        }
        ...
        public static void OooO0O0(OooO00o[] oooO00oArr, Path path) {
            ...
            while (i5 < oooO00oArr.length) {
                ...
                int i6 = i4;
                while (true) {
                    float[] fArr2 = oooO00o.f33482OooO0O0;
                    if (i6 < fArr2.length) {
                        if (c3 != 'A') {
                            if (c3 != 'C') {
                                if (c3 == 'H') {
                ...
                c = 'm';
                i4 = i48;
                c2 = oooO00oArr[i47].f33481OooO00o;
            }
        }

        public OooO00o(OooO00o oooO00o) {
            this.f33481OooO00o = oooO00o.f33481OooO00o;
            float[] fArr = oooO00o.f33482OooO0O0;
            this.f33482OooO0O0 = OooOOO.OooO0O0(fArr, fArr.length);
        }
    }
}
