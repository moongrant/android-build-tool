    ...
    public final Typeface OooO00o(Context context, FontResourcesParserCompat.OooO0OO oooO0OO, Resources resources, int i) {
        try {
            ...
            for (FontResourcesParserCompat.OooO0o oooO0o : oooO0OO.f5291OooO00o) {
                try {
                    Font fontBuild = new Font.Builder(resources, oooO0o.f5296OooO0o).setWeight(oooO0o.f5293OooO0O0).setSlant(oooO0o.f5294OooO0OO ? 1 : 0).setTtcIndex(oooO0o.f5297OooO0o0).setFontVariationSettings(oooO0o.f5295OooO0Oo).build();
                    if (builder == null) {
    ...
    public final Typeface OooO0O0(Context context, @NonNull Oooo000[] oooo000Arr, int i) {
        ...
        try {
            ...
            for (Oooo000 oooo000 : oooo000Arr) {
                try {
                    ParcelFileDescriptor parcelFileDescriptorOpenFileDescriptor = contentResolver.openFileDescriptor(oooo000.f33567OooO00o, "r", null);
                    if (parcelFileDescriptorOpenFileDescriptor == null) {
                        if (parcelFileDescriptorOpenFileDescriptor != null) {
                        }
                    } else {
                        try {
                            Font fontBuild = new Font.Builder(parcelFileDescriptorOpenFileDescriptor).setWeight(oooo000.f33569OooO0OO).setSlant(oooo000.f33570OooO0Oo ? 1 : 0).setTtcIndex(oooo000.f33568OooO0O0).build();
                            if (builder == null) {
                                builder = new FontFamily.Builder(fontBuild);
                            } else {
                                builder.addFont(fontBuild);
