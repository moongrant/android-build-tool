...
public final class OooO0o {
    ...
    public static final int f33624OooO00o = OooOO0O.pooling_container_listener_holder_tag;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final int f33625OooO0O0 = OooOO0O.is_pooling_container_tag;

    public static final void OooO00o(@NotNull View view) {
        Intrinsics.checkNotNullParameter(view, "<this>");
        Iterator it = SequencesKt.sequence(new o000O0Oo(view, null)).iterator();
        while (it.hasNext()) {
            ArrayList<OooO> arrayList = OooO0O0((View) it.next()).f33626OooO00o;
