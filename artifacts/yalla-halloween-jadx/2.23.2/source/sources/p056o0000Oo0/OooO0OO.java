...
public final class OooO0OO {
    ...
    public static class OooO0O0<T> implements Comparator<T> {
        ...
        public final boolean f33642OooO0o;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final OooO00o<T> f33644OooO0oO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final Rect f33641OooO0Oo = new Rect();

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final Rect f33643OooO0o0 = new Rect();

        public OooO0O0(boolean z, o0000Oo0.OooO0O0.OooO00o oooO00o) {
            this.f33642OooO0o = z;
            this.f33644OooO0oO = oooO00o;
        }

        /* JADX WARN: Multi-variable type inference failed */
        @Override // java.util.Comparator
        public final int compare(T t, T t2) {
            o0000Oo0.OooO0O0.OooO00o oooO00o = (o0000Oo0.OooO0O0.OooO00o) this.f33644OooO0oO;
            oooO00o.getClass();
            Rect rect = this.f33641OooO0Oo;
            ((o0O0O00) t).OooO0o(rect);
            oooO00o.getClass();
            Rect rect2 = this.f33643OooO0o0;
            ((o0O0O00) t2).OooO0o(rect2);
            int i = rect.top;
            int i2 = rect2.top;
            if (i < i2) {
                return -1;
