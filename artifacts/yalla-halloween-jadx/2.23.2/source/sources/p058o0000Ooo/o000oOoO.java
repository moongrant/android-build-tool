...
public final class o000oOoO {
    ...
    public static final ThreadLocal<TypedValue> f33723OooO00o = new ThreadLocal<>();
    ...
    public static ColorStateList OooO0O0(@NonNull Resources resources, @NonNull XmlResourceParser xmlResourceParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next == 2 && depth <= depth2 && xmlResourceParser.getName().equals("item")) {
                int[] iArr3 = OooOO0O.ColorStateListItem;
                ...
                if (resourceId == -1) {
                    ...
                    if (((i4 < 28 || i4 > 31) ? i : z2) == 0) {
                        try {
                            ...
                            color = typedArrayObtainAttributes.getColor(OooOO0O.ColorStateListItem_android_color, -65281);
                        }
                    } else {
                        color = typedArrayObtainAttributes.getColor(i3, -65281);
                    }
                }
                int i5 = OooOO0O.ColorStateListItem_android_alpha;
                if (typedArrayObtainAttributes.hasValue(i5)) {
                    f = typedArrayObtainAttributes.getFloat(i5, 1.0f);
                } else {
                    int i6 = OooOO0O.ColorStateListItem_alpha;
                    f = typedArrayObtainAttributes.hasValue(i6) ? typedArrayObtainAttributes.getFloat(i6, 1.0f) : 1.0f;
                }
                if (Build.VERSION.SDK_INT >= 31) {
                    int i7 = OooOO0O.ColorStateListItem_android_lStar;
                    if (typedArrayObtainAttributes.hasValue(i7)) {
                        f2 = typedArrayObtainAttributes.getFloat(i7, -1.0f);
                    } else {
                        f2 = typedArrayObtainAttributes.getFloat(OooOO0O.ColorStateListItem_lStar, -1.0f);
                    }
                } else {
                    f2 = typedArrayObtainAttributes.getFloat(OooOO0O.ColorStateListItem_lStar, -1.0f);
                }
                ...
                if (f != 1.0f || z3) {
                    ...
                    if (z3) {
                        ...
                        float f9 = oooo000OooO00o.f33718OooO0O0;
                        if (f9 >= 1.0d && Math.round(f2) > 0.0d && Math.round(f2) < 100.0d) {
                            float f10 = oooo000OooO00o.f33717OooO00o;
                            ...
                            while (true) {
                                ...
                                while (true) {
                                    ...
                                    int iOooO0OO = Oooo000.OooO0O0(f18, f12, fMin).OooO0OO(o00oO0o.f33731OooOO0O);
                                    ...
                                    z = true;
                                    float[] fArr = Oooo0.f33716OooO0Oo[1];
                                    f4 = 100.0f;
                                    ...
                                    if (fAbs < 0.2f) {
                                        ...
                                        Oooo000 oooo000OooO0O0 = Oooo000.OooO0O0(oooo000OooO00o2.f33719OooO0OO, oooo000OooO00o2.f33718OooO0O0, fMin);
                                        f6 = f18;
                                        float f20 = oooo000OooO00o2.f33720OooO0Oo - oooo000OooO0O0.f33720OooO0Oo;
                                        f3 = fMin;
                                        float f21 = oooo000OooO00o2.f33722OooO0o0 - oooo000OooO0O0.f33722OooO0o0;
                                        float f22 = oooo000OooO00o2.f33721OooO0o - oooo000OooO0O0.f33721OooO0o;
