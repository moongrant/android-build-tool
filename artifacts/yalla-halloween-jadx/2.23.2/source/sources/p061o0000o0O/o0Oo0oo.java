...
public final class o0Oo0oo implements InputFilter {
    ...
    public final TextView f33765OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public OooO00o f33766OooO0O0;
    ...
    public static class OooO00o extends EmojiCompat.OooOO0 implements Runnable {
        ...
        public final WeakReference f33767OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final WeakReference f33768OooO0o0;

        public OooO00o(TextView textView, o0Oo0oo o0oo0oo2) {
            this.f33767OooO0Oo = new WeakReference(textView);
            this.f33768OooO0o0 = new WeakReference(o0oo0oo2);
        }
        ...
        public final void onInitialized() {
            Handler handler;
            super.onInitialized();
            TextView textView = (TextView) this.f33767OooO0Oo.get();
        ...
        public final void run() {
            ...
            InputFilter[] filters;
            TextView textView = (TextView) this.f33767OooO0Oo.get();
            InputFilter inputFilter = (InputFilter) this.f33768OooO0o0.get();
            boolean z = false;
    ...
    public o0Oo0oo(@NonNull TextView textView) {
        this.f33765OooO00o = textView;
    }

    @Override // android.text.InputFilter
    public final CharSequence filter(CharSequence charSequence, int i, int i2, Spanned spanned, int i3, int i4) {
        TextView textView = this.f33765OooO00o;
        ...
        if (this.f33766OooO0O0 == null) {
            this.f33766OooO0O0 = new OooO00o(textView, this);
        }
        emojiCompatOooO00o.OooO(this.f33766OooO0O0);
        return charSequence;
    }
}
