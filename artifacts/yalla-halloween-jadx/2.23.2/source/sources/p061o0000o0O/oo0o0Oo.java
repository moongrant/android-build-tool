...
public final class oo0o0Oo {
    ...
    public final OooO0O0 f33772OooO00o;

    @RequiresApi(19)
    public static class OooO00o extends OooO0O0 {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final TextView f33773OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final o0Oo0oo f33774OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public boolean f33775OooO0OO = true;

        public OooO00o(TextView textView) {
            this.f33773OooO00o = textView;
            this.f33774OooO0O0 = new o0Oo0oo(textView);
        }

        @Override // o0000o0O.oo0o0Oo.OooO0O0
        @NonNull
        public final InputFilter[] OooO00o(@NonNull InputFilter[] inputFilterArr) {
            if (!this.f33775OooO0OO) {
            ...
            int i4 = 0;
            while (true) {
                o0Oo0oo o0oo0oo2 = this.f33774OooO0O0;
                if (i4 >= length2) {
        ...
        public final boolean OooO0O0() {
            return this.f33775OooO0OO;
        }

        @Override // o0000o0O.oo0o0Oo.OooO0O0
        public final void OooO0OO(boolean z) {
            if (z) {
                TextView textView = this.f33773OooO00o;
        ...
        public final TransformationMethod OooO0o0(@Nullable TransformationMethod transformationMethod) {
            ...
            return transformationMethod instanceof o000OOo ? ((o000OOo) transformationMethod).f33752OooO00o : transformationMethod;
        }
    }
    ...
    public static class OooO0OO extends OooO0O0 {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final OooO00o f33776OooO00o;

        public OooO0OO(TextView textView) {
            this.f33776OooO00o = new OooO00o(textView);
        }

        @Override // o0000o0O.oo0o0Oo.OooO0O0
        @NonNull
        public final InputFilter[] OooO00o(@NonNull InputFilter[] inputFilterArr) {
            return EmojiCompat.OooO0OO() ^ true ? inputFilterArr : this.f33776OooO00o.OooO00o(inputFilterArr);
        }

        @Override // o0000o0O.oo0o0Oo.OooO0O0
        public final boolean OooO0O0() {
            return this.f33776OooO00o.f33775OooO0OO;
        }
        ...
        public final void OooO0OO(boolean z) {
            ...
            this.f33776OooO00o.OooO0OO(z);
        }

        @Override // o0000o0O.oo0o0Oo.OooO0O0
        public final void OooO0Oo(boolean z) {
            boolean z2 = !EmojiCompat.OooO0OO();
            OooO00o oooO00o = this.f33776OooO00o;
            if (z2) {
                oooO00o.f33775OooO0OO = z;
            } else {
                oooO00o.OooO0Oo(z);
            }
        }
        ...
        @Nullable
        public final TransformationMethod OooO0o0(@Nullable TransformationMethod transformationMethod) {
            return EmojiCompat.OooO0OO() ^ true ? transformationMethod : this.f33776OooO00o.OooO0o0(transformationMethod);
        }
    }

    public oo0o0Oo(@NonNull TextView textView) {
        OooOOO0.OooO0o0(textView, "textView cannot be null");
        this.f33772OooO00o = new OooO0OO(textView);
    }
}
