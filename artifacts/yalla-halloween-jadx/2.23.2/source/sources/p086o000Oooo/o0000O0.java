...
@UnstableApi
public final class o0000O0 extends o0000Ooo {

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final o0000oo f35008OooO0O0 = new o0000oo();

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    @Nullable
    public final OooO00o f35009OooO00o;
    ...
    public static final class OooO0O0 {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final int f35010OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final boolean f35011OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final int f35012OooO0OO;

        public OooO0O0(int i, boolean z, int i2) {
            this.f35010OooO00o = i;
            this.f35011OooO0O0 = z;
            this.f35012OooO0OO = i2;
        }
    }

    public o0000O0(@Nullable OooO00o oooO00o) {
        this.f35009OooO00o = oooO00o;
    }

    public static GeobFrame OooO(int i, o000O000 o000o001) {
        int iOooOo0O = o000o001.OooOo0O();
        Charset charsetOooOOO = OooOOO(iOooOo0O);
        int i2 = i - 1;
        byte[] bArr = new byte[i2];
        o000o001.OooO0Oo(0, i2, bArr);
        int iOooOOo0 = OooOOo0(0, bArr);
        String str = new String(bArr, 0, iOooOOo0, OooOO0.f18591OooO0O0);
        int i3 = iOooOOo0 + 1;
        ...
        return new GeobFrame(str, strOooOO0O, i2 <= iOooOOO1 ? o00.f34914OooO0o : Arrays.copyOfRange(bArr, iOooOOO1, i2), strOooOO0O2);
    }

    public static ApicFrame OooO0Oo(int i, int i2, o000O000 o000o001) {
        int iOooOOo0;
        String strConcat;
        int iOooOo0O = o000o001.OooOo0O();
        Charset charsetOooOOO = OooOOO(iOooOo0O);
        ...
        o000o001.OooO0Oo(0, i3, bArr);
        if (i2 == 2) {
            String str = "image/" + OooO0OO.OooO00o(new String(bArr, 0, 3, OooOO0.f18591OooO0O0));
            ...
            String strOooO00o = OooO0OO.OooO00o(new String(bArr, 0, iOooOOo0, OooOO0.f18591OooO0O0));
            strConcat = strOooO00o.indexOf(47) == -1 ? "image/".concat(strOooO00o) : strOooO00o;
        }
        ...
        int iOooOOO0 = OooOOO0(iOooOo0O) + iOooOOOo;
        return new ApicFrame(strConcat, str2, i4, i3 <= iOooOOO0 ? o00.f34914OooO0o : Arrays.copyOfRange(bArr, iOooOOO0, i3));
    }

    public static ChapterTocFrame OooO0o(o000O000 o000o001, int i, int i2, boolean z, int i3, @Nullable OooO00o oooO00o) {
        int i4 = o000o001.f34963OooO0O0;
        int iOooOOo0 = OooOOo0(i4, o000o001.f34962OooO00o);
        String str = new String(o000o001.f34962OooO00o, i4, iOooOOo0 - i4, OooOO0.f18591OooO0O0);
        o000o001.Oooo00O(iOooOOo0 + 1);
        int iOooOo0O = o000o001.OooOo0O();
        ...
        for (int i5 = 0; i5 < iOooOo0O2; i5++) {
            ...
            int iOooOOo1 = OooOOo0(i6, o000o001.f34962OooO00o);
            strArr[i5] = new String(o000o001.f34962OooO00o, i6, iOooOOo1 - i6, OooOO0.f18591OooO0O0);
            o000o001.Oooo00O(iOooOOo1 + 1);
        }
        ArrayList arrayList = new ArrayList();
        int i7 = i4 + i;
        while (o000o001.f34963OooO0O0 < i7) {
            Id3Frame id3FrameOooO0oo = OooO0oo(i2, o000o001, z, i3, oooO00o);
    ...
    public static ChapterFrame OooO0o0(o000O000 o000o001, int i, int i2, boolean z, int i3, @Nullable OooO00o oooO00o) {
        int i4 = o000o001.f34963OooO0O0;
        int iOooOOo0 = OooOOo0(i4, o000o001.f34962OooO00o);
        String str = new String(o000o001.f34962OooO00o, i4, iOooOOo0 - i4, OooOO0.f18591OooO0O0);
        o000o001.Oooo00O(iOooOOo0 + 1);
        ...
        ArrayList arrayList = new ArrayList();
        int i5 = i4 + i;
        while (o000o001.f34963OooO0O0 < i5) {
            Id3Frame id3FrameOooO0oo = OooO0oo(i2, o000o001, z, i3, oooO00o);
            if (id3FrameOooO0oo != null) {
                arrayList.add(id3FrameOooO0oo);
            }
    ...
    @Nullable
    public static CommentFrame OooO0oO(int i, o000O000 o000o001) {
        if (i < 4) {
            return null;
        }
        int iOooOo0O = o000o001.OooOo0O();
        ...
        o000o001.OooO0Oo(0, 3, bArr);
        String str = new String(bArr, 0, 3);
        int i2 = i - 4;
        byte[] bArr2 = new byte[i2];
        o000o001.OooO0Oo(0, i2, bArr2);
    ...
    /* JADX WARN: Type inference failed for: r5v24, types: [androidx.media3.extractor.metadata.id3.Id3Frame] */
    ...
    @Nullable
    public static Id3Frame OooO0oo(int i, o000O000 o000o001, boolean z, int i2, @Nullable OooO00o oooO00o) {
        int iOooOoO0;
        int i3;
        ?? r15;
        boolean z2;
        ...
        int iOooOo0O4 = i >= 3 ? o000o001.OooOo0O() : 0;
        if (i == 4) {
            iOooOoO0 = o000o001.OooOoO0();
            if (!z) {
                iOooOoO0 = (((iOooOoO0 >> 24) & 255) << 21) | (iOooOoO0 & 255) | (((iOooOoO0 >> 8) & 255) << 7) | (((iOooOoO0 >> 16) & 255) << 14);
            }
        } else {
            iOooOoO0 = i == 3 ? o000o001.OooOoO0() : o000o001.OooOo();
        }
        int i4 = iOooOoO0;
        int iOooOoOO = i >= 3 ? o000o001.OooOoOO() : 0;
        if (iOooOo0O == 0 && iOooOo0O2 == 0 && iOooOo0O3 == 0 && iOooOo0O4 == 0 && i4 == 0 && iOooOoOO == 0) {
            o000o001.Oooo00O(o000o001.f34964OooO0OO);
            return null;
        }
        int i5 = o000o001.f34963OooO0O0 + i4;
        if (i5 > o000o001.f34964OooO0OO) {
        ...
        if (i != 3) {
            ...
            int iOooOOo = i4;
            if (z9) {
                iOooOOo = OooOOo(iOooOOo, o000o001);
            }
            int i7 = iOooOOo;
            try {
                if (iOooOo0O == 84 && iOooOo0O2 == 88 && iOooOo0O3 == 88 && (i == 2 || iOooOo0O4 == 88)) {
                    ...
                    if (iOooOo0O == 87 && iOooOo0O2 == 88 && iOooOo0O3 == 88 && (i == 2 || iOooOo0O4 == 88)) {
                        if (i7 < 1) {
                            ...
                            privFrame = new UrlLinkFrame("WXXX", str, OooOO0O(bArr3, iOooOOO0, OooOOo0(iOooOOO0, bArr3), OooOO0.f18591OooO0O0));
                        }
                    } else if (iOooOo0O == 87) {
                        String strOooOOOO2 = OooOOOO(i, iOooOo0O, iOooOo0O2, iOooOo0O3, iOooOo0O4);
                        byte[] bArr4 = new byte[i7];
                        o000o001.OooO0Oo(0, i7, bArr4);
                        privFrame = new UrlLinkFrame(strOooOOOO2, r15, new String(bArr4, 0, OooOOo0(0, bArr4), OooOO0.f18591OooO0O0));
                    } else if (iOooOo0O == 80 && iOooOo0O2 == 82 && iOooOo0O3 == 73 && iOooOo0O4 == 86) {
                        byte[] bArr5 = new byte[i7];
                        o000o001.OooO0Oo(0, i7, bArr5);
                        int iOooOOo0 = OooOOo0(0, bArr5);
                        String str2 = new String(bArr5, 0, iOooOOo0, OooOO0.f18591OooO0O0);
                        int i11 = iOooOOo0 + 1;
                        privFrame = new PrivFrame(str2, i7 <= i11 ? o00.f34914OooO0o : Arrays.copyOfRange(bArr5, i11, i7));
                    } else if (iOooOo0O == 71 && iOooOo0O2 == 69 && iOooOo0O3 == 79 && (iOooOo0O4 == 66 || i == 2)) {
                        binaryFrame = OooO(i7, o000o001);
                    } else if (i == 2) {
                        if (iOooOo0O == 80 && iOooOo0O2 == 73 && iOooOo0O3 == 67) {
                            binaryFrame = OooO0Oo(i7, i, o000o001);
                        } else if (iOooOo0O != 67 && iOooOo0O2 == 79 && iOooOo0O3 == 77 && (iOooOo0O4 == 77 || i == 2)) {
                            binaryFrame = OooO0oO(i7, o000o001);
                        } else if (iOooOo0O != 67 && iOooOo0O2 == 72 && iOooOo0O3 == 65 && iOooOo0O4 == 80) {
                            chapterFrameOooO0o0 = OooO0o0(o000o001, i7, i, z, i2, oooO00o);
                        } else if (iOooOo0O != 67 && iOooOo0O2 == 84 && iOooOo0O3 == 79 && iOooOo0O4 == 67) {
                            chapterTocFrameOooO0o = OooO0o(o000o001, i7, i, z, i2, oooO00o);
                        } else if (iOooOo0O != 77 && iOooOo0O2 == 76 && iOooOo0O3 == 76 && iOooOo0O4 == 84) {
                            mlltFrameOooOO0 = OooOO0(i7, o000o001);
                        } else {
                            String strOooOOOO3 = OooOOOO(i, iOooOo0O, iOooOo0O2, iOooOo0O3, iOooOo0O4);
                            byte[] bArr6 = new byte[i7];
                            o000o001.OooO0Oo(0, i7, bArr6);
    ...
    public static MlltFrame OooOO0(int i, o000O000 o000o001) {
        int iOooOoOO = o000o001.OooOoOO();
        int iOooOo = o000o001.OooOo();
        int iOooOo2 = o000o001.OooOo();
        int iOooOo0O = o000o001.OooOo0O();
        int iOooOo0O2 = o000o001.OooOo0O();
        o000 o000Var = new o000();
        o000Var.OooOO0(o000o001.f34964OooO0OO, o000o001.f34962OooO00o);
        o000Var.OooOO0O(o000o001.f34963OooO0O0 * 8);
        int i2 = ((i - 10) * 8) / (iOooOo0O + iOooOo0O2);
        int[] iArr = new int[i2];
        int[] iArr2 = new int[i2];
        for (int i3 = 0; i3 < i2; i3++) {
            int iOooO0oO = o000Var.OooO0oO(iOooOo0O);
            int iOooO0oO2 = o000Var.OooO0oO(iOooOo0O2);
            iArr[i3] = iOooO0oO;
            iArr2[i3] = iOooO0oO2;
        }
    ...
    public static o0O00 OooOO0o(int i, int i2, byte[] bArr) {
        if (i2 >= bArr.length) {
        ...
        o0O00 o0o00OooO0oo = oooO00o.OooO0oo();
        return o0o00OooO0oo.isEmpty() ? ImmutableList.OooOOOo("") : o0o00OooO0oo;
    }

    public static Charset OooOOO(int i) {
        if (i == 1) {
            return OooOO0.f18594OooO0o;
        }
        if (i != 2) {
            return i != 3 ? OooOO0.f18591OooO0O0 : OooOO0.f18592OooO0OO;
        }
    ...
    public static int OooOOo(int i, o000O000 o000o001) {
    ...
    public static boolean OooOOoo(o000O000 o000o001, int i, int i2, boolean z) {
        int iOooOo;
        long jOooOo;
        int iOooOoOO;
        int i3;
        ...
        while (true) {
            try {
                boolean z2 = true;
                if (o000o001.f34964OooO0OO - o000o001.f34963OooO0O0 < i2) {
                    o000o001.Oooo00O(i4);
                    return true;
                }
                if (i >= 3) {
                    iOooOo = o000o001.OooO0o();
                    jOooOo = o000o001.OooOo0o();
                    iOooOoOO = o000o001.OooOoOO();
                } else {
                    iOooOo = o000o001.OooOo();
                    jOooOo = o000o001.OooOo();
                    iOooOoOO = 0;
                }
                ...
                if (o000o001.f34964OooO0OO - o000o001.f34963OooO0O0 < jOooOo) {
                    o000o001.Oooo00O(i4);
                    return false;
                }
                o000o001.Oooo00o((int) jOooOo);
            } catch (Throwable th) {
                o000o001.Oooo00O(i4);
                throw th;
            }
    ...
    public final Metadata OooO0OO(int i, byte[] bArr) {
        ...
        ArrayList arrayList = new ArrayList();
        o000O000 o000o001 = new o000O000(bArr, i);
        boolean z2 = true;
        if (o000o001.f34964OooO0OO - o000o001.f34963OooO0O0 < 10) {
            ...
            if (iOooOo == 4801587) {
                ...
                if (iOooOo0O == 2) {
                    ...
                    if (iOooOo0O == 3) {
                        if ((iOooOo0O2 & 64) != 0) {
                            int iOooO0o = o000o001.OooO0o();
                            o000o001.Oooo00o(iOooO0o);
                            iOooOo0 -= iOooO0o + 4;
                        }
                    } else if (iOooOo0O == 4) {
                        if ((iOooOo0O2 & 64) != 0) {
                            int iOooOo1 = o000o001.OooOo0();
                            o000o001.Oooo00o(iOooOo1 - 4);
                            iOooOo0 -= iOooOo1;
                        }
                        if ((iOooOo0O2 & 16) != 0) {
                            iOooOo0 -= 10;
                        ...
                        Oooo000.OooO00o("Skipped ID3 tag with unsupported majorVersion=", iOooOo0O, "Id3Decoder");
                    }
                    if (iOooOo0O < 4) {
                        z = false;
                    } else {
                ...
                int i4 = o000o001.f34963OooO0O0;
                i2 = oooO0O0.f35010OooO00o;
                i3 = i2 == 2 ? 6 : 10;
                iOooOOo = oooO0O0.f35012OooO0OO;
                if (oooO0O0.f35011OooO0O0) {
                    iOooOOo = OooOOo(iOooOOo, o000o001);
                }
                o000o001.Oooo000(i4 + iOooOOo);
                if (OooOOoo(o000o001, i2, i3, false)) {
                    z2 = false;
                } else if (i2 == 4 || !OooOOoo(o000o001, 4, i3, true)) {
                    Oooo000.OooO00o("Failed to validate ID3 tag with majorVersion=", i2, "Id3Decoder");
                    return null;
                }
                while (o000o001.f34964OooO0OO - o000o001.f34963OooO0O0 >= i3) {
                    id3FrameOooO0oo = OooO0oo(i2, o000o001, z2, i3, this.f35009OooO00o);
                    if (id3FrameOooO0oo != null) {
                        arrayList.add(id3FrameOooO0oo);
                    }
                }
