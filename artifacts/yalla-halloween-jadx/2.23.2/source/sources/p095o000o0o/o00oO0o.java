...
public final class o00oO0o extends o0Oo0oo {
    ...
    public static final Pattern f35271OooOOOO = Pattern.compile("\\s*((?:(\\d+):)?(\\d+):(\\d+)(?:,(\\d+))?)\\s*-->\\s*((?:(\\d+):)?(\\d+):(\\d+)(?:,(\\d+))?)\\s*");

    /* JADX INFO: renamed from: OooOOOo, reason: collision with root package name */
    public static final Pattern f35272OooOOOo = Pattern.compile("\\{\\\\.*?\\}");

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    public final StringBuilder f35274OooOOO0 = new StringBuilder();

    /* JADX INFO: renamed from: OooOOO, reason: collision with root package name */
    public final ArrayList<String> f35273OooOOO = new ArrayList<>();
    ...
    public final o0OO00O OooO0oO(byte[] bArr, int i, boolean z) {
        ...
        int i6 = 0;
        while (true) {
            String strOooO0oo = o000o001.OooO0oo(charsetOooOoo);
            if (strOooO0oo != null) {
                if (strOooO0oo.length() != 0) {
                    try {
                        Integer.parseInt(strOooO0oo);
                        String strOooO0oo2 = o000o001.OooO0oo(charsetOooOoo);
                        if (strOooO0oo2 == null) {
                            Log.OooO0o("SubripDecoder", "Unexpected end");
                        } else {
                            Matcher matcher = f35271OooOOOO.matcher(strOooO0oo2);
                            if (matcher.matches()) {
                                ...
                                StringBuilder sb = o00oo0o2.f35274OooOOO0;
                                sb.setLength(i5);
                                ArrayList<String> arrayList2 = o00oo0o2.f35273OooOOO;
                                arrayList2.clear();
                                String strOooO0oo3 = o000o001.OooO0oo(charsetOooOoo);
                                while (!TextUtils.isEmpty(strOooO0oo3)) {
                                    ...
                                    Matcher matcher2 = f35272OooOOOo.matcher(strTrim);
                                    int i9 = i5;
                                    while (matcher2.find()) {
                                    ...
                                    strOooO0oo3 = o000o001.OooO0oo(charsetOooOoo);
                                    i5 = 0;
                                }
                                ...
                                oooO00o.f6915OooO00o = spannedFromHtml;
                                if (str == null) {
                                    ...
                                    if (b2 == 0 || b2 == 1) {
                                        ...
                                        if (b2 != 2) {
                                            if (b2 == 3 || b2 == 4 || b2 == 5) {
                                                ...
                                                oooO00o.f6921OooO0oO = 1;
                                            }
                                            i2 = 2;
                                        } else {
                                            i2 = 2;
                                        }
                                        i3 = oooO00o.f6914OooO;
                                        f = 0.92f;
                                        if (i3 != 0) {
                                            f2 = 0.08f;
                                        } else if (i3 != 1) {
        ...
        return new o0ooOOo((Cue[]) arrayList.toArray(new Cue[i5]), Arrays.copyOf(jArrCopyOf, i6));
    }
}
