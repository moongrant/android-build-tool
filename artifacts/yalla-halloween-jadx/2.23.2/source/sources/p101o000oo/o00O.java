...
public final class o00O<T1, T2> {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    @NotNull
    public final Function4<T1, T2, CombineSource, Continuation<? super Unit>, Object> f35495OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public final CompletableDeferred<Unit> f35496OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @NotNull
    public final Mutex f35497OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public final CompletableDeferred<Unit>[] f35498OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @NotNull
    public final Object[] f35499OooO0o0;
    ...
    public static final class OooO00o extends ContinuationImpl {
        ...
        public final /* synthetic */ o00O<T1, T2> f35500OooO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public o00O f35501OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public Mutex f35502OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public Object f35503OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public int f35504OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public /* synthetic */ Object f35505OooO0oo;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public int f35506OooOO0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(o00O<T1, T2> o00o2, Continuation<? super OooO00o> continuation) {
            super(continuation);
            this.f35500OooO = o00o2;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @Nullable
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f35505OooO0oo = obj;
            this.f35506OooOO0 |= Integer.MIN_VALUE;
            return this.f35500OooO.OooO00o(0, null, this);
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public o00O(@NotNull Function4<? super T1, ? super T2, ? super CombineSource, ? super Continuation<? super Unit>, ? extends Object> send) {
        Intrinsics.checkNotNullParameter(send, "send");
        this.f35495OooO00o = send;
        this.f35496OooO0O0 = CompletableDeferredKt.CompletableDeferred$default(null, 1, null);
        this.f35497OooO0OO = MutexKt.Mutex$default(false, 1, null);
        ...
        this.f35498OooO0Oo = completableDeferredArr;
        Object[] objArr = new Object[2];
        for (int i2 = 0; i2 < 2; i2++) {
            objArr[i2] = o00000O.f35397OooO00o;
        }
        this.f35499OooO0o0 = objArr;
    }
    ...
    public final Object OooO00o(int i, @Nullable Object obj, @NotNull Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (continuation instanceof OooO00o) {
            ...
            int i5 = oooO00o.f35506OooOO0;
            if ((i5 & Integer.MIN_VALUE) != 0) {
                oooO00o.f35506OooOO0 = i5 - Integer.MIN_VALUE;
            } else {
        ...
        Object obj6 = oooO00o.f35505OooO0oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i6 = oooO00o.f35506OooOO0;
        if (i6 == 0) {
            ResultKt.throwOnFailure(obj6);
            CompletableDeferred<Unit>[] completableDeferredArr = this.f35498OooO0Oo;
            if (completableDeferredArr[i4].isCompleted()) {
                oooO00o.f35501OooO0Oo = this;
                obj2 = obj;
                oooO00o.f35503OooO0o0 = obj2;
                oooO00o.f35504OooO0oO = i4;
                oooO00o.f35506OooOO0 = 1;
                if (this.f35496OooO0O0.await(oooO00o) == coroutine_suspended) {
            ...
            if (i6 != 1) {
                if (i6 != 2) {
                    ...
                    mutex2 = (Mutex) oooO00o.f35503OooO0o0;
                    o00o3 = oooO00o.f35501OooO0Oo;
                    try {
                        ResultKt.throwOnFailure(obj6);
                        o00o3.f35496OooO0O0.complete(Unit.INSTANCE);
                ...
                i4 = oooO00o.f35504OooO0oO;
                mutex = oooO00o.f35502OooO0o;
                obj3 = oooO00o.f35503OooO0o0;
                o00o2 = oooO00o.f35501OooO0Oo;
                ResultKt.throwOnFailure(obj6);
                try {
                    objArr = o00o2.f35499OooO0o0;
                    ...
                    while (true) {
                        ...
                        if (objArr[i2] == o00000O.f35397OooO00o) {
                            z4 = true;
                        } else {
                            z4 = false;
                        }
                    ...
                    while (true) {
                        ...
                        if (objArr[i3] == o00000O.f35397OooO00o) {
                            z3 = true;
                        } else {
                            z3 = false;
                        }
                    ...
                    if (z2) {
                        ...
                        function4 = o00o2.f35495OooO00o;
                        obj4 = objArr[0];
                        obj5 = objArr[1];
                        oooO00o.f35501OooO0Oo = o00o2;
                        oooO00o.f35503OooO0o0 = mutex;
                        oooO00o.f35502OooO0o = null;
                        oooO00o.f35506OooOO0 = 3;
            ...
            i4 = oooO00o.f35504OooO0oO;
            obj2 = oooO00o.f35503OooO0o0;
            o00o2 = oooO00o.f35501OooO0Oo;
            ResultKt.throwOnFailure(obj6);
        }
        Mutex mutex3 = o00o2.f35497OooO0OO;
        oooO00o.f35501OooO0Oo = o00o2;
        oooO00o.f35503OooO0o0 = obj2;
        oooO00o.f35502OooO0o = mutex3;
        oooO00o.f35504OooO0oO = i4;
        oooO00o.f35506OooOO0 = 2;
