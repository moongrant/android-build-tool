...
public final class o00000 {
    ...
    public static final HashSet f35692OooO00o = new HashSet();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final boolean f35693OooO0O0;
    ...
    public static void OooO0O0(Context context, File file, File file2) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, InstantiationException, IOException, SecurityException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
        ...
        synchronized (hashSet) {
            ...
            OooO0o0(file4);
            o00000O o00000o = new o00000O(file, file4);
            try {
                try {
                    OooO0Oo(file4, classLoader, o00000o.OooOOo(context, false));
                } catch (IOException e3) {
                    Log.w("MultiDex", "Failed to install extracted secondary dex files, retrying with forced extraction", e3);
                    OooO0Oo(file4, classLoader, o00000o.OooOOo(context, true));
                }
                try {
                    o00000o.close();
    ...
    public static Field OooO0OO(Object obj, String str) throws NoSuchFieldException {
        ...
        StringBuilder sbOooO0O0 = o0OoOo0.OooO0O0("Field ", str, " not found in ");
        sbOooO0O0.append(obj.getClass());
        throw new NoSuchFieldException(sbOooO0O0.toString());
    }
