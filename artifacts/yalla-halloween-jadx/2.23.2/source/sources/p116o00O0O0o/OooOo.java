...
public final class OooOo extends OooOOO0<OooO0O0> {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooOo(@NotNull OooOO0O<OooO0O0> tracker) {
        super(tracker);
    ...
    public final boolean OooO0O0(@NotNull o00Ooo workSpec) {
        ...
        NetworkType networkType = workSpec.f36224OooOO0.f36131OooO00o;
    ...
    public final boolean OooO0OO(OooO0O0 oooO0O0) {
        ...
        return !value.f36177OooO00o || value.f36179OooO0OO;
    }
}
