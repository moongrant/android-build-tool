...
public final class OooOO0O {
    public static String OooO00o(Context context, String str) {
        ...
        try {
            ...
            HashMap<String, String> map = OooOO0.f37740OooO00o;
            if (!TextUtils.isEmpty(strSubstring)) {
                Boolean bool = Boolean.FALSE;
                if (OooOO0.f37741OooO0O0.containsKey(OooOO0.OooO0OO(strSubstring).toLowerCase())) {
                    bool = Boolean.TRUE;
                }
                if (bool.booleanValue() && (iLastIndexOf = strSubstring.lastIndexOf(OooOO0.OooO0OO(strSubstring))) > 0 && iLastIndexOf < strSubstring.length()) {
    ...
    public static String OooO0O0(Context context, String str) {
        File file = new File(o0oOO.OooO0O0(new StringBuilder(), (Environment.getExternalStorageState().equals("mounted") || !Environment.isExternalStorageRemovable()) ? context.getExternalCacheDir().getPath() : context.getCacheDir().getPath(), "/MyPhoto"));
        if (!file.exists()) {
            file.mkdirs();
        }
        return file + o000oOoO.OooO0O0("/", str, ".png");
    }
    ...
    public static String OooO0OO(Bitmap bitmap, String str) {
