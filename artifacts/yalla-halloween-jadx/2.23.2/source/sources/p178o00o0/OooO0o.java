...
public final class OooO0o {
    ...
    public final int f38364OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public final List<Integer>[] f38365OooO0O0;

    public OooO0o(int i) {
        this.f38364OooO00o = i;
        this.f38365OooO0O0 = new List[i];
        for (int i2 = 0; i2 < i; i2++) {
            this.f38365OooO0O0[i2] = new ArrayList();
        }
    }
    ...
    public final Vector<Integer> OooO00o() {
        ...
        int i = this.f38364OooO00o;
        int[] iArr = new int[i];
        int i2 = 0;
        while (true) {
            listArr = this.f38365OooO0O0;
            if (i2 >= i) {
                break;
            }
