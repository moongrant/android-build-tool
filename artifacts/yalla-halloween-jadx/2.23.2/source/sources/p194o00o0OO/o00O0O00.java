...
public final class o00O0O00 implements NestedScrollConnection {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ SwipeableState<Object> f38696OooO0Oo;
    ...
    public static final class OooO00o extends ContinuationImpl {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public /* synthetic */ Object f38697OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f38698OooO0o;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f38697OooO0Oo = obj;
            this.f38698OooO0o |= Integer.MIN_VALUE;
            return o00O0O00.this.mo333onPostFlingRZ2iAVY(0L, 0L, this);
        }
    }
    ...
    public static final class OooO0O0 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            return o00O0O00.this.mo335onPreFlingQWom1Mo(0L, this);
        }
    }

    public o00O0O00(SwipeableState<Object> swipeableState) {
        this.f38696OooO0Oo = swipeableState;
    }
    ...
    public final Object mo333onPostFlingRZ2iAVY(long j, long j2, @NotNull Continuation<? super Velocity> continuation) {
        ...
        if (continuation instanceof OooO00o) {
            ...
            int i = oooO00o.f38698OooO0o;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO00o.f38698OooO0o = i - Integer.MIN_VALUE;
            } else {
        ...
        Object obj = oooO00o.f38697OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = oooO00o.f38698OooO0o;
        if (i2 == 0) {
            ResultKt.throwOnFailure(obj);
            Log.e("SwipeToRefreshAndLoad", "LoadPreUp onPostFling: consumed:" + Velocity.m4007toStringimpl(j) + "   available:" + Velocity.m4007toStringimpl(j2));
            float fM1448getYimpl = Offset.m1448getYimpl(OffsetKt.Offset(Velocity.m4000getXimpl(j2), Velocity.m4001getYimpl(j2)));
            oooO00o.f38698OooO0o = 1;
            if (this.f38696OooO0Oo.performFling(fM1448getYimpl, oooO00o) == coroutine_suspended) {
    ...
    public final long mo334onPostScrollDzOQY0M(long j, long j2, int i) {
        ...
        return OffsetKt.Offset(0.0f, this.f38696OooO0Oo.performDrag(Offset.m1448getYimpl(j2)));
    }
    ...
    public final Object mo335onPreFlingQWom1Mo(long j, @NotNull Continuation<? super Velocity> continuation) {
        ...
        if (i2 == 0) {
            ...
            if (fM1448getYimpl > 0.0f) {
                ...
                if (this.f38696OooO0Oo.performFling(fM1448getYimpl, oooO0O0) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
    ...
    public final long mo336onPreScrollOzD1aCk(long j, int i) {
        ...
        return (fM1448getYimpl <= 0.0f || !NestedScrollSource.m2604equalsimpl0(i, NestedScrollSource.INSTANCE.m2609getDragWNlRxjI())) ? Offset.INSTANCE.m1463getZeroF1C5BW0() : OffsetKt.Offset(0.0f, this.f38696OooO0Oo.performDrag(fM1448getYimpl));
    }
}
