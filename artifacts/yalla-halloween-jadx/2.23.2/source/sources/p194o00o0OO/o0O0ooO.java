...
public final class o0O0ooO {
    ...
    public static final class OooO00o extends Lambda implements Function1<DrawScope, Unit> {
        ...
        public final /* synthetic */ State<Drawable> f38812OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ ContentScale f38813OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(MutableState mutableState, ContentScale contentScale) {
            super(1);
            this.f38812OooO0Oo = mutableState;
            this.f38813OooO0o0 = contentScale;
        }
        ...
        public final Unit invoke(DrawScope drawScope) {
            ...
            Drawable value = this.f38812OooO0Oo.getValue();
            if (value != null) {
                long jSize = SizeKt.Size(value.getIntrinsicWidth(), value.getIntrinsicHeight());
                long jSize2 = SizeKt.Size(Size.m1516getWidthimpl(Canvas.mo2118getSizeNHjbRc()), Size.m1513getHeightimpl(Canvas.mo2118getSizeNHjbRc()));
                ContentScale.Companion companion = ContentScale.INSTANCE;
                ContentScale inside = companion.getInside();
                ContentScale contentScale = this.f38813OooO0o0;
                if (Intrinsics.areEqual(contentScale, inside)) {
                    if (Size.m1516getWidthimpl(jSize) > Size.m1516getWidthimpl(jSize2) || Size.m1513getHeightimpl(jSize) > Size.m1513getHeightimpl(jSize2)) {
                        float fMin = Math.min(Size.m1516getWidthimpl(jSize2) / Size.m1516getWidthimpl(jSize), Size.m1513getHeightimpl(jSize2) / Size.m1513getHeightimpl(jSize));
                    ...
                    float fMax = Math.max(Size.m1516getWidthimpl(jSize2) / Size.m1516getWidthimpl(jSize), Size.m1513getHeightimpl(jSize2) / Size.m1513getHeightimpl(jSize));
                    jScaleFactor = ScaleFactorKt.ScaleFactor(fMax, fMax);
                } else {
                    float fMin2 = Math.min(Size.m1516getWidthimpl(jSize2) / Size.m1516getWidthimpl(jSize), Size.m1513getHeightimpl(jSize2) / Size.m1513getHeightimpl(jSize));
                    jScaleFactor = ScaleFactorKt.ScaleFactor(fMin2, fMin2);
                }
                long jSize3 = SizeKt.Size(ScaleFactor.m2867getScaleXimpl(jScaleFactor) * Size.m1516getWidthimpl(jSize), ScaleFactor.m2868getScaleYimpl(jScaleFactor) * Size.m1513getHeightimpl(jSize));
                float f = 2;
                long jOffset = OffsetKt.Offset((Size.m1516getWidthimpl(jSize2) - Size.m1516getWidthimpl(jSize3)) / f, (Size.m1513getHeightimpl(jSize2) - Size.m1513getHeightimpl(jSize3)) / f);
                int iM1516getWidthimpl = (int) Size.m1516getWidthimpl(jSize3);
                int iM1513getHeightimpl = (int) Size.m1513getHeightimpl(jSize3);
                if (value instanceof BitmapDrawable) {
                    BitmapDrawable bitmapDrawable = (BitmapDrawable) value;
                    if (bitmapDrawable.getBitmap() == null) {
                        throw new IllegalArgumentException("bitmap is null");
                    }
                    bitmap = (iM1516getWidthimpl == bitmapDrawable.getBitmap().getWidth() && iM1513getHeightimpl == bitmapDrawable.getBitmap().getHeight()) ? bitmapDrawable.getBitmap() : Bitmap.createScaledBitmap(bitmapDrawable.getBitmap(), iM1516getWidthimpl, iM1513getHeightimpl, true);
                } else {
                    ...
                    Bitmap bitmapCreateBitmap = Bitmap.createBitmap(iM1516getWidthimpl, iM1513getHeightimpl, Bitmap.Config.ARGB_8888);
                    value.setBounds(0, 0, iM1516getWidthimpl, iM1513getHeightimpl);
                    value.draw(new Canvas(bitmapCreateBitmap));
    ...
    public static final class OooO0O0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ Function0<Unit> f38814OooO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ int f38815OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ ContentScale f38816OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ long f38817OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f38818OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ Function0<Unit> f38819OooO0oo;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public final /* synthetic */ Function1<Integer, Unit> f38820OooOO0;

        /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
        public final /* synthetic */ Modifier f38821OooOO0O;

        /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
        public final /* synthetic */ int f38822OooOO0o;

        /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
        public final /* synthetic */ int f38823OooOOO0;
        ...
        public OooO0O0(int i, long j, ContentScale contentScale, int i2, Function0<Unit> function0, Function0<Unit> function1, Function1<? super Integer, Unit> function2, Modifier modifier, int i3, int i4) {
            super(2);
            this.f38815OooO0Oo = i;
            this.f38817OooO0o0 = j;
            this.f38816OooO0o = contentScale;
            this.f38818OooO0oO = i2;
            this.f38819OooO0oo = function0;
            this.f38814OooO = function1;
            this.f38820OooOO0 = function2;
            this.f38821OooOO0O = modifier;
            this.f38822OooOO0o = i3;
            this.f38823OooOOO0 = i4;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            o0O0ooO.OooO00o(this.f38815OooO0Oo, this.f38817OooO0o0, this.f38816OooO0o, this.f38818OooO0oO, this.f38819OooO0oo, this.f38814OooO, this.f38820OooOO0, this.f38821OooOO0O, composer, RecomposeScopeImplKt.updateChangedFlags(this.f38822OooOO0o | 1), this.f38823OooOOO0);
            return Unit.INSTANCE;
        }
    }
                    ...
                    if (i11 != 0) {
                        ...
                        if ((i5 & 23967451) == 4793490 || !composerStartRestartGroup.getSkipping()) {
                            ...
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventStart(-1670476034, i5, -1, "com.code.android.uikit.FrameAnim (FrameAnimations.kt:79)");
                            }
                            ...
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventStart(409503362, i21, -1, "com.code.android.uikit.frameAnimWithDrawable (FrameAnimations.kt:140)");
                            }
                            ...
                            EffectsKt.LaunchedEffect(iArr2, new o00oOoo(j, iArr2, i19, function7, function6, mutableState, context2, null), composerStartRestartGroup, 72);
                            if (ComposerKt.isTraceInProgress()) {
