...
public final class o00000OO {
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final /* synthetic */ o000O0o f38850OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ boolean f38851OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(o000O0o o000o0o2, boolean z, Continuation<? super OooO00o> continuation) {
            super(2, continuation);
            this.f38850OooO0Oo = o000o0o2;
            this.f38851OooO0o0 = z;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO00o(this.f38850OooO0Oo, this.f38851OooO0o0, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            this.f38850OooO0Oo.OooO0O0(!this.f38851OooO0o0);
    ...
    public static final class OooO0O0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ boolean f38852OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f38853OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f38854OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(int i, int i2, boolean z) {
            super(2);
            this.f38852OooO0Oo = z;
            this.f38854OooO0o0 = i;
            this.f38853OooO0o = i2;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f38854OooO0o0 | 1);
            int i = this.f38853OooO0o;
            o00000OO.OooO0O0(this.f38852OooO0Oo, composer, iUpdateChangedFlags, i);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final float OooO00o(@NotNull WindowInsets.Companion companion, @Nullable Composer composer) {
        ...
        float fMo428calculateBottomPaddingD9Ej5fM = WindowInsetsKt.asPaddingValues(WindowInsets_androidKt.getNavigationBars(companion, composer, 8), composer, 0).getBottom();
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return fMo428calculateBottomPaddingD9Ej5fM;
    }
    ...
    public static final void OooO0O0(boolean z, @Nullable Composer composer, int i, int i2) {
        ...
        if ((i3 & 11) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            if ((i & 1) != 0 && !composerStartRestartGroup.getDefaultsInvalid()) {
                ...
                z = !((Boolean) composerStartRestartGroup.consume(o0000oo.f38633OooO00o)).booleanValue();
                i3 &= -15;
            }
            ...
            boolean zChanged = composerStartRestartGroup.changed(boolValueOf2) | composerStartRestartGroup.changed(o000VarOooO00o);
            Object objRememberedValue = composerStartRestartGroup.rememberedValue();
            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = new OooO00o(o000VarOooO00o, z, null);
