...
public final class o0O00o0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ LazyListState f39327OooO0o0;
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f39328OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                this.f39328OooO0Oo = 1;
    ...
    public o0O00o0(LazyListState lazyListState, Continuation<? super o0O00o0> continuation) {
        super(2, continuation);
        this.f39327OooO0o0 = lazyListState;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o0O00o0(this.f39327OooO0o0, continuation);
    }
