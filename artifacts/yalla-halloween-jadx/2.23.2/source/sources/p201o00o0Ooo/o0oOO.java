...
public final class o0oOO {
    ...
    public static final class OooO00o implements MeasurePolicy {
        ...
        public static final OooO00o f39330OooO00o = new OooO00o();

        /* JADX INFO: renamed from: o00o0Ooo.o0oOO$OooO00o$OooO00o, reason: collision with other inner class name */
        public static final class C0438OooO00o extends Lambda implements Function1<Placeable.PlacementScope, Unit> {

            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ List<Placeable> f39331OooO0Oo;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C0438OooO00o(ArrayList arrayList) {
                super(1);
                this.f39331OooO0Oo = arrayList;
            }
            ...
            public final Unit invoke(Placeable.PlacementScope placementScope) {
                ...
                int height = 0;
                for (Placeable placeable : this.f39331OooO0Oo) {
        ...
        public final MeasureResult mo3measure3p2s80s(@NotNull MeasureScope Layout, @NotNull List<? extends Measurable> measurableList, long j) {
            ...
            while (it.hasNext()) {
                Placeable placeableMo2804measureBRTryo0 = it.next().mo2804measureBRTryo0(j);
                iMax = Math.max(iMax, placeableMo2804measureBRTryo0.getWidth());
                measuredHeight += placeableMo2804measureBRTryo0.getMeasuredHeight() + measuredHeight;
                arrayList.add(placeableMo2804measureBRTryo0);
            }
            return MeasureScope.CC.OooOOo0(Layout, iMax, measuredHeight, null, new C0438OooO00o(arrayList), 4, null);
        }
    ...
    public static final class OooO0O0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Modifier f39332OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f39333OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ Function2<Composer, Integer, Unit> f39334OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f39335OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public OooO0O0(Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, int i, int i2) {
            super(2);
            this.f39332OooO0Oo = modifier;
            this.f39334OooO0o0 = function2;
            this.f39333OooO0o = i;
            this.f39335OooO0oO = i2;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f39333OooO0o | 1);
            o0oOO.OooO00o(this.f39332OooO0Oo, this.f39334OooO0o0, composer, iUpdateChangedFlags, this.f39335OooO0oO);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final void OooO00o(@Nullable Modifier modifier, @NotNull Function2<? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, int i, int i2) {
        ...
        if ((i3 & 91) == 18 && composerStartRestartGroup.getSkipping()) {
            ...
            OooO00o oooO00o = OooO00o.f39330OooO00o;
            ...
            Updater.m1327setimpl(composerM1320constructorimpl, oooO00o, companion.getSetMeasurePolicy());
