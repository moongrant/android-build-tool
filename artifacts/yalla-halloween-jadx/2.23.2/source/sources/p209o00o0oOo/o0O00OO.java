...
public final class o0O00OO extends RecyclerView.OooOo {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public int f39642OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public final Paint f39643OooO0O0;

    public o0O00OO(int i) {
        Paint paint = new Paint();
        this.f39643OooO0O0 = paint;
    ...
    public final void onDraw(@NotNull Canvas c, @NotNull RecyclerView parent, @NotNull RecyclerView.o0OOO0o state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (parent.getChildAdapterPosition(childAt) != 0) {
                c.drawRect(parent.getPaddingLeft(), childAt.getTop() - this.f39642OooO00o, parent.getWidth() - parent.getPaddingRight(), childAt.getTop(), this.f39643OooO0O0);
            }
        }
    }
}
