...
public final class o0O0000O implements Parcelable.Creator<Status> {
    ...
    public final /* synthetic */ Status createFromParcel(Parcel parcel) {
        ...
        if ((i & 65535) != 20293) {
            throw new a.C0203a("Expected object header. Got 0x" + Integer.toHexString(i));
        }
        int i2 = iOooO0O0 + iDataPosition;
        if (i2 < iDataPosition || i2 > parcel.dataSize()) {
            throw new a.C0203a(OooO0O0.OooO0O0("Size read is invalid start=", iDataPosition, " end=", i2));
        }
        int iOooO00o = 0;
        int iOooO00o2 = 0;
        ...
        throw new a.C0203a("Overread allowed size end=".concat(String.valueOf(i2)));
    }
