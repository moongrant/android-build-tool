...
public final class o0000O00 {
    ...
    @NotNull
    public final CoroutineScope f39873OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public final MutableSharedFlow<OooO00o> f39874OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @NotNull
    public final MutableState f39875OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public final MutableState f39876OooO0Oo;

    public interface OooO00o {

        /* JADX INFO: renamed from: o00oOoO.o0000O00$OooO00o$OooO00o, reason: collision with other inner class name */
        @StabilityInferred(parameters = 0)
        public static final class C0439OooO00o implements OooO00o {

            /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
            @NotNull
            public static final C0439OooO00o f39877OooO00o = new C0439OooO00o();
        }
        ...
        public static final class OooO0o implements OooO00o {
            ...
            /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
            @NotNull
            public static final OooO0o f39878OooO00o = new OooO0o();
        }
    }
    ...
    public static final class OooO0O0 extends ContinuationImpl {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public /* synthetic */ Object f39879OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f39880OooO0o;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f39879OooO0Oo = obj;
            this.f39880OooO0o |= Integer.MIN_VALUE;
            return o0000O00.this.OooO00o(null, this);
        }
    }
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<CoroutineScope, Continuation<?>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f39882OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ WebView f39883OooO0o;

        public static final class OooO00o implements FlowCollector<OooO00o> {

            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ WebView f39885OooO0Oo;

            public OooO00o(WebView webView) {
                this.f39885OooO0Oo = webView;
            }

            @Override // kotlinx.coroutines.flow.FlowCollector
            public final Object emit(OooO00o oooO00o, Continuation continuation) {
                OooO00o oooO00o2 = oooO00o;
                boolean z = oooO00o2 instanceof OooO00o.C0439OooO00o;
                WebView webView = this.f39885OooO0Oo;
                if (z) {
                    webView.goBack();
        ...
        public OooO0OO(WebView webView, Continuation<? super OooO0OO> continuation) {
            ...
            this.f39883OooO0o = webView;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return o0000O00.this.new OooO0OO(this.f39883OooO0o, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f39882OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                MutableSharedFlow<OooO00o> mutableSharedFlow = o0000O00.this.f39874OooO0O0;
                OooO00o oooO00o = new OooO00o(this.f39883OooO0o);
                this.f39882OooO0Oo = 1;
    ...
    public o0000O00(@NotNull CoroutineScope coroutineScope) {
        Intrinsics.checkNotNullParameter(coroutineScope, "coroutineScope");
        this.f39873OooO00o = coroutineScope;
        this.f39874OooO0O0 = SharedFlowKt.MutableSharedFlow$default(0, 0, null, 7, null);
        Boolean bool = Boolean.FALSE;
        this.f39875OooO0OO = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(bool, null, 2, null);
        this.f39876OooO0Oo = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(bool, null, 2, null);
    }
    ...
    public final Object OooO00o(@NotNull WebView webView, @NotNull Continuation<?> continuation) {
        ...
        if (continuation instanceof OooO0O0) {
            ...
            int i = oooO0O0.f39880OooO0o;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO0O0.f39880OooO0o = i - Integer.MIN_VALUE;
            } else {
        ...
        Object obj = oooO0O0.f39879OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = oooO0O0.f39880OooO0o;
        if (i2 == 0) {
            ResultKt.throwOnFailure(obj);
            MainCoroutineDispatcher main = Dispatchers.getMain();
            OooO0OO oooO0OO = new OooO0OO(webView, null);
            oooO0O0.f39880OooO0o = 1;
