...
public final class o0000oo extends zzf {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final /* synthetic */ Rpc f40236OooO00o;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0000oo(Rpc rpc, Looper looper) {
        super(looper);
        this.f40236OooO00o = rpc;
    }

    @Override // android.os.Handler
    public final void handleMessage(Message message) {
        Rpc rpc = this.f40236OooO00o;
            ...
            if (obj instanceof Intent) {
                ...
                if (intent.hasExtra("google.messenger")) {
                    ...
                    if (parcelableExtra instanceof zzd) {
                        rpc.f14107OooO0oO = (zzd) parcelableExtra;
                    }
                    if (parcelableExtra instanceof Messenger) {
                        rpc.f14105OooO0o = (Messenger) parcelableExtra;
                    }
                }
                ...
                if (stringExtra != null) {
                    Matcher matcher = Rpc.f14100OooOO0O.matcher(stringExtra);
                    if (!matcher.matches()) {
                        if (Log.isLoggable("Rpc", 3)) {
                ...
                if (!stringExtra2.startsWith("|")) {
                    synchronized (rpc.f14101OooO00o) {
                        int i2 = 0;
                        while (true) {
                            OooOo<String, TaskCompletionSource<Bundle>> oooOo = rpc.f14101OooO00o;
                            if (i2 < oooOo.f38568OooO0o) {
                                rpc.OooO0Oo(intent2.getExtras(), oooOo.OooO0oo(i2));
                                i2++;
                            }
                        }
                    }
