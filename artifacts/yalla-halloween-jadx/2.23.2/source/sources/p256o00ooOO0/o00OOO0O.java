...
public final class o00OOO0O<T> implements OnCompleteListener<T> {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final GoogleApiManager f40304OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final int f40305OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final ApiKey<?> f40306OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final long f40307OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final long f40308OooO0o0;

    @VisibleForTesting
    public o00OOO0O(GoogleApiManager googleApiManager, int i, ApiKey apiKey, long j, long j2) {
        this.f40304OooO00o = googleApiManager;
        this.f40305OooO0O0 = i;
        this.f40306OooO0OO = apiKey;
        this.f40307OooO0Oo = j;
        this.f40308OooO0o0 = j2;
    }
    ...
    public static ConnectionTelemetryConfiguration OooO00o(zabq<?> zabqVar, BaseGmsClient<?> baseGmsClient, int i) {
        ...
        if (zabqVar.f14415OooOOOO < telemetryConfiguration.getMaxMethodInvocationsLogged()) {
    ...
    public final void onComplete(@NonNull Task<T> task) {
        ...
        GoogleApiManager googleApiManager = this.f40304OooO00o;
        if (googleApiManager.OooO00o()) {
            RootTelemetryConfiguration config = RootTelemetryConfigManager.getInstance().getConfig();
            if ((config == null || config.getMethodInvocationTelemetryEnabled()) && (zabqVar = (zabq) googleApiManager.f14265OooOOO0.get(this.f40306OooO0OO)) != null && (zabqVar.zaf() instanceof BaseGmsClient)) {
                BaseGmsClient baseGmsClient = (BaseGmsClient) zabqVar.zaf();
                long j2 = this.f40307OooO0Oo;
                ...
                if (config != null) {
                    ...
                    if (baseGmsClient.hasConnectionInfo() && !baseGmsClient.isConnecting()) {
                        ConnectionTelemetryConfiguration connectionTelemetryConfigurationOooO00o = OooO00o(zabqVar, baseGmsClient, this.f40305OooO0O0);
                ...
                if (methodTimingTelemetryEnabled) {
                    ...
                    iElapsedRealtime = (int) (SystemClock.elapsedRealtime() - this.f40308OooO0o0);
                } else {
                    j = 0;
                ...
                zaqVar.sendMessage(zaqVar.obtainMessage(18, new o0o0Oo(new MethodInvocation(this.f40305OooO0O0, i3, errorCode, j, jCurrentTimeMillis, null, null, gCoreServiceId, iElapsedRealtime), version, i2, i)));
            }
        }
    }
}
