...
public final class o0O00o0 extends zaq {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final /* synthetic */ zada f40324OooO00o;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0O00o0(zada zadaVar, Looper looper) {
        super(looper);
        this.f40324OooO00o = zadaVar;
    }
    ...
    public final void handleMessage(Message message) {
        ...
        synchronized (this.f40324OooO00o.f14437OooO0o0) {
            try {
                zada zadaVar = (zada) Preconditions.checkNotNull(this.f40324OooO00o.f14433OooO0O0);
                if (pendingResult == null) {
                    zadaVar.OooO00o(new Status(13, "Transform returned null"));
                } else if (pendingResult instanceof zacp) {
                    zadaVar.OooO00o(((zacp) pendingResult).f14422OooO00o);
                } else {
