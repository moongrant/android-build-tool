...
public final class oO00O0o extends j0 {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final oO00O0o0 f40552OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final g0 f40553OooO0o0;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public static final String[] f40545OooO0o = {"last_bundled_timestamp", "ALTER TABLE events ADD COLUMN last_bundled_timestamp INTEGER;", "last_bundled_day", "ALTER TABLE events ADD COLUMN last_bundled_day INTEGER;", "last_sampled_complex_event_id", "ALTER TABLE events ADD COLUMN last_sampled_complex_event_id INTEGER;", "last_sampling_rate", "ALTER TABLE events ADD COLUMN last_sampling_rate INTEGER;", "last_exempt_from_sampling", "ALTER TABLE events ADD COLUMN last_exempt_from_sampling INTEGER;", "current_session_count", "ALTER TABLE events ADD COLUMN current_session_count INTEGER;"};

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public static final String[] f40546OooO0oO = {AppMeasurementSdk.ConditionalUserProperty.ORIGIN, "ALTER TABLE user_attributes ADD COLUMN origin TEXT;"};

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public static final String[] f40547OooO0oo = {"app_version", "ALTER TABLE apps ADD COLUMN app_version TEXT;", "app_store", "ALTER TABLE apps ADD COLUMN app_store TEXT;", "gmp_version", "ALTER TABLE apps ADD COLUMN gmp_version INTEGER;", "dev_cert_hash", "ALTER TABLE apps ADD COLUMN dev_cert_hash INTEGER;", "measurement_enabled", "ALTER TABLE apps ADD COLUMN measurement_enabled INTEGER;", "last_bundle_start_timestamp", "ALTER TABLE apps ADD COLUMN last_bundle_start_timestamp INTEGER;", TopDataVM.TYPE_DAY, "ALTER TABLE apps ADD COLUMN day INTEGER;", "daily_public_events_count", "ALTER TABLE apps ADD COLUMN daily_public_events_count INTEGER;", "daily_events_count", "ALTER TABLE apps ADD COLUMN daily_events_count INTEGER;", "daily_conversions_count", "ALTER TABLE apps ADD COLUMN daily_conversions_count INTEGER;", "remote_config", "ALTER TABLE apps ADD COLUMN remote_config BLOB;", "config_fetched_time", "ALTER TABLE apps ADD COLUMN config_fetched_time INTEGER;", "failed_config_fetch_time", "ALTER TABLE apps ADD COLUMN failed_config_fetch_time INTEGER;", "app_version_int", "ALTER TABLE apps ADD COLUMN app_version_int INTEGER;", "firebase_instance_id", "ALTER TABLE apps ADD COLUMN firebase_instance_id TEXT;", "daily_error_events_count", "ALTER TABLE apps ADD COLUMN daily_error_events_count INTEGER;", "daily_realtime_events_count", "ALTER TABLE apps ADD COLUMN daily_realtime_events_count INTEGER;", "health_monitor_sample", "ALTER TABLE apps ADD COLUMN health_monitor_sample TEXT;", "android_id", "ALTER TABLE apps ADD COLUMN android_id INTEGER;", "adid_reporting_enabled", "ALTER TABLE apps ADD COLUMN adid_reporting_enabled INTEGER;", "ssaid_reporting_enabled", "ALTER TABLE apps ADD COLUMN ssaid_reporting_enabled INTEGER;", "admob_app_id", "ALTER TABLE apps ADD COLUMN admob_app_id TEXT;", "linked_admob_app_id", "ALTER TABLE apps ADD COLUMN linked_admob_app_id TEXT;", "dynamite_version", "ALTER TABLE apps ADD COLUMN dynamite_version INTEGER;", "safelisted_events", "ALTER TABLE apps ADD COLUMN safelisted_events TEXT;", "ga_app_id", "ALTER TABLE apps ADD COLUMN ga_app_id TEXT;", "config_last_modified_time", "ALTER TABLE apps ADD COLUMN config_last_modified_time TEXT;", "e_tag", "ALTER TABLE apps ADD COLUMN e_tag TEXT;", "session_stitching_token", "ALTER TABLE apps ADD COLUMN session_stitching_token TEXT;", "sgtm_upload_enabled", "ALTER TABLE apps ADD COLUMN sgtm_upload_enabled INTEGER;", "target_os_version", "ALTER TABLE apps ADD COLUMN target_os_version INTEGER;", "session_stitching_token_hash", "ALTER TABLE apps ADD COLUMN session_stitching_token_hash INTEGER;"};

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    public static final String[] f40544OooO = {"realtime", "ALTER TABLE raw_events ADD COLUMN realtime INTEGER;"};

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public static final String[] f40548OooOO0 = {"has_realtime", "ALTER TABLE queue ADD COLUMN has_realtime INTEGER;", "retry_count", "ALTER TABLE queue ADD COLUMN retry_count INTEGER;"};

    /* JADX INFO: renamed from: OooOO0O, reason: collision with root package name */
    public static final String[] f40549OooOO0O = {"session_scoped", "ALTER TABLE event_filters ADD COLUMN session_scoped BOOLEAN;"};

    /* JADX INFO: renamed from: OooOO0o, reason: collision with root package name */
    public static final String[] f40550OooOO0o = {"session_scoped", "ALTER TABLE property_filters ADD COLUMN session_scoped BOOLEAN;"};

    /* JADX INFO: renamed from: OooOOO0, reason: collision with root package name */
    public static final String[] f40551OooOOO0 = {"previous_install_count", "ALTER TABLE app2 ADD COLUMN previous_install_count INTEGER;"};

    public oO00O0o(zzlh zzlhVar) {
        super(zzlhVar);
        this.f40553OooO0o0 = new g0(this.f40788OooO00o.zzax());
        this.f40788OooO00o.zzf();
        this.f40552OooO0Oo = new oO00O0o0(this, this.f40788OooO00o.zzaw());
    }
    ...
    public final boolean OooO(zzac zzacVar) {
        ...
        u0 u0VarOooOo = OooOo(str, zzacVar.zzc.zzb);
    ...
    @WorkerThread
    public final void OooO0o(oO00OO0O oo00oo0o) {
        zzgd zzgdVar = this.f40788OooO00o;
        Preconditions.checkNotNull(oo00oo0o);
        zzg();
        OooO00o();
        ContentValues contentValues = new ContentValues();
        String str = oo00oo0o.f40560OooO00o;
        contentValues.put("app_id", str);
        contentValues.put("name", oo00oo0o.f40561OooO0O0);
        contentValues.put("lifetime_count", Long.valueOf(oo00oo0o.f40562OooO0OO));
        contentValues.put("current_bundle_count", Long.valueOf(oo00oo0o.f40563OooO0Oo));
        contentValues.put("last_fire_timestamp", Long.valueOf(oo00oo0o.f40564OooO0o));
        contentValues.put("last_bundled_timestamp", Long.valueOf(oo00oo0o.f40566OooO0oO));
        contentValues.put("last_bundled_day", oo00oo0o.f40567OooO0oo);
        contentValues.put("last_sampled_complex_event_id", oo00oo0o.f40559OooO);
        contentValues.put("last_sampling_rate", oo00oo0o.f40568OooOO0);
        contentValues.put("current_session_count", Long.valueOf(oo00oo0o.f40565OooO0o0));
        Boolean bool = oo00oo0o.f40569OooOO0O;
    ...
    @WorkerThread
    public final void OooO0o0(oOO0000 ooo0000) {
        Preconditions.checkNotNull(ooo0000);
        zzg();
        OooO00o();
        String strOooOo0o = ooo0000.OooOo0o();
        Preconditions.checkNotNull(strOooOo0o);
        ContentValues contentValues = new ContentValues();
        contentValues.put("app_id", strOooOo0o);
        contentValues.put("app_instance_id", ooo0000.OooOo());
        contentValues.put("gmp_app_id", ooo0000.OooO00o());
        zzgd zzgdVar = ooo0000.f40653OooO00o;
        zzgdVar.zzaB().zzg();
        contentValues.put("resettable_device_id_hash", ooo0000.f40658OooO0o0);
        zzgdVar.zzaB().zzg();
        contentValues.put("last_bundle_index", Long.valueOf(ooo0000.f40659OooO0oO));
        zzgdVar.zzaB().zzg();
        contentValues.put("last_bundle_start_timestamp", Long.valueOf(ooo0000.f40660OooO0oo));
        zzgdVar.zzaB().zzg();
        contentValues.put("last_bundle_end_timestamp", Long.valueOf(ooo0000.f40652OooO));
        contentValues.put("app_version", ooo0000.OooOoO0());
        zzgdVar.zzaB().zzg();
        contentValues.put("app_store", ooo0000.f40663OooOO0o);
        zzgdVar.zzaB().zzg();
        contentValues.put("gmp_version", Long.valueOf(ooo0000.f40665OooOOO0));
        zzgdVar.zzaB().zzg();
        contentValues.put("dev_cert_hash", Long.valueOf(ooo0000.f40664OooOOO));
        zzgdVar.zzaB().zzg();
        contentValues.put("measurement_enabled", Boolean.valueOf(ooo0000.f40666OooOOOO));
        zzgdVar.zzaB().zzg();
        contentValues.put(TopDataVM.TYPE_DAY, Long.valueOf(ooo0000.f40677OooOoO0));
        zzgdVar.zzaB().zzg();
        contentValues.put("daily_public_events_count", Long.valueOf(ooo0000.f40676OooOoO));
        zzgdVar.zzaB().zzg();
        contentValues.put("daily_events_count", Long.valueOf(ooo0000.f40678OooOoOO));
        zzgdVar.zzaB().zzg();
        contentValues.put("daily_conversions_count", Long.valueOf(ooo0000.f40680OooOoo0));
        zzgdVar.zzaB().zzg();
        contentValues.put("config_fetched_time", Long.valueOf(ooo0000.f40684Oooo00O));
        zzgdVar.zzaB().zzg();
        contentValues.put("failed_config_fetch_time", Long.valueOf(ooo0000.f40685Oooo00o));
        contentValues.put("app_version_int", Long.valueOf(ooo0000.OooOo00()));
        contentValues.put("firebase_instance_id", ooo0000.OooOoO());
        zzgdVar.zzaB().zzg();
        contentValues.put("daily_error_events_count", Long.valueOf(ooo0000.f40679OooOoo));
        zzgdVar.zzaB().zzg();
        contentValues.put("daily_realtime_events_count", Long.valueOf(ooo0000.f40681OooOooO));
        zzgdVar.zzaB().zzg();
        contentValues.put("health_monitor_sample", ooo0000.f40682OooOooo);
        zzgdVar.zzaB().zzg();
        contentValues.put("android_id", (Long) 0L);
        zzgdVar.zzaB().zzg();
        contentValues.put("adid_reporting_enabled", Boolean.valueOf(ooo0000.f40667OooOOOo));
        contentValues.put("admob_app_id", ooo0000.OooOo0());
        zzgdVar.zzaB().zzg();
        contentValues.put("dynamite_version", Long.valueOf(ooo0000.f40670OooOOoo));
        zzgdVar.zzaB().zzg();
        contentValues.put("session_stitching_token", ooo0000.f40672OooOo0);
        zzgdVar.zzaB().zzg();
        contentValues.put("sgtm_upload_enabled", Boolean.valueOf(ooo0000.f40674OooOo0O));
        zzgdVar.zzaB().zzg();
        contentValues.put("target_os_version", Long.valueOf(ooo0000.f40675OooOo0o));
        zzgdVar.zzaB().zzg();
        contentValues.put("session_stitching_token_hash", Long.valueOf(ooo0000.f40671OooOo));
        zzgdVar.zzaB().zzg();
        ArrayList arrayList = ooo0000.f40673OooOo00;
        zzgd zzgdVar2 = this.f40788OooO00o;
        if (arrayList != null) {
    ...
    @WorkerThread
    public final boolean OooOO0(u0 u0Var) {
        Preconditions.checkNotNull(u0Var);
        zzg();
        OooO00o();
        String str = u0Var.f40846OooO00o;
        String str2 = u0Var.f40848OooO0OO;
        u0 u0VarOooOo = OooOo(str, str2);
        zzgd zzgdVar = this.f40788OooO00o;
        String str3 = u0Var.f40847OooO0O0;
        if (u0VarOooOo == null) {
        ...
        contentValues.put("set_timestamp", Long.valueOf(u0Var.f40849OooO0Oo));
        OooOO0o(contentValues, u0Var.f40850OooO0o0);
        try {
    ...
    public final void OooOO0O(long j, long j2, s0 s0Var) throws Throwable {
                ...
                try {
                    ...
                    do {
                        ...
                        try {
                            ...
                            if (!s0Var.OooO00o(j3, (zzft) zzfsVar.zzaD())) {
                                cursorQuery2.close();
                                return;
                            }
                        } catch (IOException e) {
    ...
    public final long OooOOO0(String str, String[] strArr) {
        ...
        try {
            try {
                ...
                this.f40788OooO00o.zzaA().zzd().zzc("Database error", str, e);
                throw e;
            }
        } catch (Throwable th) {
            if (0 != 0) {
    ...
    public final SQLiteDatabase OooOOo() {
        zzg();
        try {
            return this.f40552OooO0Oo.getWritableDatabase();
        } catch (SQLiteException e) {
            this.f40788OooO00o.zzaA().zzk().zzb("Error opening database", e);
            throw e;
        }
    }
    ...
    @WorkerThread
    public final oOO0000 OooOOoo(String str) {
        Cursor cursorQuery;
        Cursor cursor;
        zzgd zzgdVar = this.f40788OooO00o;
        Preconditions.checkNotEmpty(str);
        ...
        try {
            try {
                ...
                try {
                    ...
                    oOO0000 ooo0000 = new oOO0000(this.f40509OooO0O0.f15615OooOO0o, str);
                    zzgd zzgdVar2 = ooo0000.f40653OooO00o;
                    ooo0000.OooO0OO(cursorQuery.getString(0));
                    ooo0000.OooOO0O(cursorQuery.getString(1));
                    ooo0000.OooOOo(cursorQuery.getString(2));
                    ooo0000.OooOOOO(cursorQuery.getLong(3));
                    ooo0000.OooOOOo(cursorQuery.getLong(4));
                    ooo0000.OooOOO(cursorQuery.getLong(5));
                    ooo0000.OooO0o0(cursorQuery.getString(6));
                    ooo0000.OooO0Oo(cursorQuery.getString(7));
                    ooo0000.OooOO0o(cursorQuery.getLong(8));
                    ooo0000.OooO0oo(cursorQuery.getLong(9));
                    ooo0000.OooOOo0(cursorQuery.isNull(10) || cursorQuery.getInt(10) != 0);
                    long j = cursorQuery.getLong(11);
                    zzgdVar2.zzaB().zzg();
                    ooo0000.f40683Oooo000 |= ooo0000.f40677OooOoO0 != j;
                    ooo0000.f40677OooOoO0 = j;
                    long j2 = cursorQuery.getLong(12);
                    zzgdVar2.zzaB().zzg();
                    ooo0000.f40683Oooo000 |= ooo0000.f40676OooOoO != j2;
                    ooo0000.f40676OooOoO = j2;
                    long j3 = cursorQuery.getLong(13);
                    zzgdVar2.zzaB().zzg();
                    ooo0000.f40683Oooo000 |= ooo0000.f40678OooOoOO != j3;
                    ooo0000.f40678OooOoOO = j3;
                    long j4 = cursorQuery.getLong(14);
                    zzgdVar2.zzaB().zzg();
                    ooo0000.f40683Oooo000 |= ooo0000.f40680OooOoo0 != j4;
                    ooo0000.f40680OooOoo0 = j4;
                    ooo0000.OooO0oO(cursorQuery.getLong(15));
                    long j5 = cursorQuery.getLong(16);
                    zzgdVar2.zzaB().zzg();
                    ooo0000.f40683Oooo000 |= ooo0000.f40685Oooo00o != j5;
                    ooo0000.f40685Oooo00o = j5;
                    ooo0000.OooO0o(cursorQuery.isNull(17) ? -2147483648L : cursorQuery.getInt(17));
                    ooo0000.OooOO0(cursorQuery.getString(18));
                    long j6 = cursorQuery.getLong(19);
                    zzgdVar2.zzaB().zzg();
                    ooo0000.f40683Oooo000 |= ooo0000.f40679OooOoo != j6;
                    ooo0000.f40679OooOoo = j6;
                    long j7 = cursorQuery.getLong(20);
                    zzgdVar2.zzaB().zzg();
                    ooo0000.f40683Oooo000 |= ooo0000.f40681OooOooO != j7;
                    ooo0000.f40681OooOooO = j7;
                    ooo0000.OooOOO0(cursorQuery.getString(21));
                    boolean z2 = cursorQuery.isNull(23) || cursorQuery.getInt(23) != 0;
                    zzgdVar2.zzaB().zzg();
                    ooo0000.f40683Oooo000 |= ooo0000.f40667OooOOOo != z2;
                    ooo0000.f40667OooOOOo = z2;
                    ooo0000.OooO0O0(cursorQuery.getString(24));
                    ooo0000.OooO(cursorQuery.isNull(25) ? 0L : cursorQuery.getLong(25));
                    if (!cursorQuery.isNull(26)) {
                        ooo0000.OooOOoo(Arrays.asList(cursorQuery.getString(26).split(",", -1)));
                    }
                    zzqu.zzc();
                    if (zzgdVar.zzf().zzs(str, zzeg.zzao) || zzgdVar.zzf().zzs(null, zzeg.zzam)) {
                        String string = cursorQuery.getString(28);
                        zzgdVar2.zzaB().zzg();
                        ooo0000.f40683Oooo000 |= !zzg.zza(ooo0000.f40672OooOo0, string);
                        ooo0000.f40672OooOo0 = string;
                    }
                    zzrd.zzc();
                    if (zzgdVar.zzf().zzs(null, zzeg.zzaq)) {
                        boolean z3 = (cursorQuery.isNull(29) || cursorQuery.getInt(29) == 0) ? false : true;
                        zzgdVar2.zzaB().zzg();
                        ooo0000.f40683Oooo000 |= ooo0000.f40674OooOo0O != z3;
                        ooo0000.f40674OooOo0O = z3;
                    }
                    zzpz.zzc();
                    if (zzgdVar.zzf().zzs(null, zzeg.zzaE)) {
                        long j8 = cursorQuery.getLong(30);
                        zzgdVar2.zzaB().zzg();
                        ooo0000.f40683Oooo000 |= ooo0000.f40675OooOo0o != j8;
                        ooo0000.f40675OooOo0o = j8;
                    }
                    if (zzgdVar.zzf().zzs(null, zzeg.zzaH)) {
                        long j9 = cursorQuery.getLong(31);
                        zzgdVar2.zzaB().zzg();
                        boolean z4 = ooo0000.f40683Oooo000;
                        if (ooo0000.f40671OooOo == j9) {
                            z = false;
                        }
                        ooo0000.f40683Oooo000 = z4 | z;
                        ooo0000.f40671OooOo = j9;
                    }
                    zzgdVar2.zzaB().zzg();
                    ooo0000.f40683Oooo000 = false;
                    if (cursorQuery.moveToNext()) {
    ...
    @WorkerThread
    public final u0 OooOo(String str, String str2) {
        Cursor cursorQuery;
        zzgd zzgdVar = this.f40788OooO00o;
        Preconditions.checkNotEmpty(str);
        Preconditions.checkNotEmpty(str2);
        ...
        try {
            ...
            try {
                try {
                    ...
                    u0 u0Var = new u0(j, str, cursorQuery.getString(2), str2, objOooOoO0);
                    if (cursorQuery.moveToNext()) {
            ...
            try {
                ...
                try {
                    ...
                    if (cursorQuery.getLong(0) == j) {
                        zzaiVar.f15400OooO0O0 = cursorQuery.getLong(1);
                        zzaiVar.f15399OooO00o = cursorQuery.getLong(2);
                        zzaiVar.f15401OooO0OO = cursorQuery.getLong(3);
                        zzaiVar.f15402OooO0Oo = cursorQuery.getLong(4);
                        zzaiVar.f15403OooO0o0 = cursorQuery.getLong(5);
                    }
                    if (z) {
                        zzaiVar.f15400OooO0O0 += j2;
                    }
                    if (z2) {
                        zzaiVar.f15399OooO00o += j2;
                    }
                    if (z3) {
                        zzaiVar.f15401OooO0OO += j2;
                    }
                    if (z4) {
                        zzaiVar.f15402OooO0Oo += j2;
                    }
                    if (z5) {
                        zzaiVar.f15403OooO0o0 += j2;
                    }
                    ContentValues contentValues = new ContentValues();
                    contentValues.put(TopDataVM.TYPE_DAY, Long.valueOf(j));
                    contentValues.put("daily_public_events_count", Long.valueOf(zzaiVar.f15399OooO00o));
                    contentValues.put("daily_events_count", Long.valueOf(zzaiVar.f15400OooO0O0));
                    contentValues.put("daily_conversions_count", Long.valueOf(zzaiVar.f15401OooO0OO));
                    contentValues.put("daily_error_events_count", Long.valueOf(zzaiVar.f15402OooO0Oo));
                    contentValues.put("daily_realtime_events_count", Long.valueOf(zzaiVar.f15403OooO0o0));
    ...
    @WorkerThread
    public final oO00OO0O OooOo0o(String str, String str2) {
        Cursor cursorQuery;
        Boolean boolValueOf;
        zzgd zzgdVar = this.f40788OooO00o;
        Preconditions.checkNotEmpty(str);
        ...
        try {
            ...
            try {
                try {
                    ...
                    oO00OO0O oo00oo0o = new oO00OO0O(str, str2, j, j2, cursorQuery.isNull(8) ? 0L : cursorQuery.getLong(8), j3, j4, lValueOf, lValueOf2, lValueOf3, boolValueOf);
                    if (cursorQuery.moveToNext()) {
    ...
    public final Object OooOoO0(Cursor cursor, int i) {
        ...
        zzgd zzgdVar = this.f40788OooO00o;
        if (type == 0) {
            o00O00.OooO00o(zzgdVar, "Loaded invalid null value from database");
            return null;
        }
        if (type == 1) {
        ...
        o00O00.OooO00o(zzgdVar, "Loaded invalid blob type value, ignoring it");
        return null;
    }
                            ...
                            while (true) {
                                try {
                                    ...
                                    if (objOooOoO0 == null) {
                                        ...
                                        str5 = string3;
                                        arrayList.add(new u0(j, str, str5, string2, objOooOoO0));
                                    }
                                    try {
                                        if (!cursorQuery.moveToNext()) {
                                            break;
            ...
            try {
                ...
                do {
                    ...
                    if (objOooOoO0 == null) {
                        ...
                        arrayList.add(new u0(j, str, str2, string, objOooOoO0));
                    }
    ...
    public final void OooOooO(List list) {
        ...
        if (OooO0oO()) {
            String strOooO0O0 = o000oOoO.OooO0O0("(", TextUtils.join(",", list), ")");
            long jOooOOO0 = OooOOO0("SELECT COUNT(1) FROM queue WHERE rowid IN " + strOooO0O0 + " AND retry_count =  2147483647 LIMIT 1", null);
            zzgd zzgdVar = this.f40788OooO00o;
            if (jOooOOO0 > 0) {
                zzgdVar.zzaA().zzk().zza("The number of upload retries exceeds the limit. Will remain unchanged.");
            }
            try {
                OooOOo().execSQL("UPDATE queue SET retry_count = IFNULL(retry_count, 0) + 1 WHERE rowid IN " + strOooO0O0 + " AND (retry_count IS NULL OR retry_count < 2147483647)");
            } catch (SQLiteException e) {
        ...
        try {
            try {
                ...
                try {
                    ...
                    e = e2;
                    this.f40788OooO00o.zzaA().zzd().zzb("Database error getting next bundle app id", e);
                    if (cursorRawQuery != null) {
                        cursorRawQuery.close();
                    }
                    return null;
