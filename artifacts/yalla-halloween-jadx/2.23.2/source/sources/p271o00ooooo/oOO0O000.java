...
public final class oOO0O000 implements Runnable {
    ...
    public final /* synthetic */ Bundle f40705OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ zzik f40706OooO0o0;

    public oOO0O000(zzik zzikVar, Bundle bundle) {
        this.f40706OooO0o0 = zzikVar;
        this.f40705OooO0Oo = bundle;
    }

    @Override // java.lang.Runnable
    public final void run() {
        zzik zzikVar = this.f40706OooO0o0;
        zzikVar.zzg();
        zzikVar.zza();
        Bundle bundle = this.f40705OooO0Oo;
