...
public final class OooOo00 {
    ...
    public final File f41694OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final File f41695OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final File f41696OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final File f41697OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final File f41698OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final File f41699OooO0o0;

    public OooOo00(Context context) {
        String str;
        File filesDir = context.getFilesDir();
        this.f41694OooO00o = filesDir;
        ...
        OooO0OO(file);
        this.f41695OooO0O0 = file;
        File file2 = new File(file, "open-sessions");
        OooO0OO(file2);
        this.f41696OooO0OO = file2;
        File file3 = new File(file, "reports");
        OooO0OO(file3);
        this.f41697OooO0Oo = file3;
        File file4 = new File(file, "priority-reports");
        OooO0OO(file4);
        this.f41699OooO0o0 = file4;
        File file5 = new File(file, "native-reports");
        OooO0OO(file5);
        this.f41698OooO0o = file5;
    }
    ...
    public final File OooO0O0(String str, String str2) {
        File file = new File(this.f41696OooO0OO, str);
        file.mkdirs();
