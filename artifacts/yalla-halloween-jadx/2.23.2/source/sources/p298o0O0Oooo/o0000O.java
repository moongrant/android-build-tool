...
public final class o0000O {
    ...
    public final String f41711OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final Map<String, String> f41712OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final HashMap f41713OooO0OO = new HashMap();

    public o0000O(String str, HashMap map) {
        this.f41711OooO00o = str;
        this.f41712OooO0O0 = map;
    }
    ...
    public static String OooO00o(String str, Map map) throws UnsupportedEncodingException {
        ...
        if (!str.contains("?")) {
            return o0OoOo0.OooO0O0(str, "?", string);
        }
        if (!str.endsWith("&")) {
            string = "&".concat(string);
        }
        return OooOOOO.OooO00o(str, string);
    }

    public final o000 OooO0O0() throws Throwable {
        Throwable th;
        ...
        inputStream = null;
        try {
            String strOooO00o = OooO00o(this.f41711OooO00o, this.f41712OooO0O0);
            ...
            try {
                ...
                for (Map.Entry entry : this.f41713OooO0OO.entrySet()) {
                ...
                httpsURLConnection.disconnect();
                return new o000(responseCode, string);
            } catch (Throwable th3) {
                th = th3;
            }
        } catch (Throwable th4) {
