...
public final class OooOo implements OooO0o {
    public static OooO0O0 OooO0O0(byte[][] bArr, int i) {
        ...
        int[] iArr = oooO0O0.f42266OooO0oO;
    ...
    public final OooO0O0 OooO00o(String str, BarcodeFormat barcodeFormat, EnumMap enumMap) throws WriterException {
        ...
        if (enumMap.containsKey(encodeHintType3)) {
            ((OooO0OO) enumMap.get(encodeHintType3)).getClass();
            i = 0;
            i2 = 0;
            i3 = 0;
            i4 = 0;
        ...
        int i24 = 1 << (i23 + 1);
        byte[] bArr = OooOO0.f42328OooO00o;
        StringBuilder sb = new StringBuilder(str.length());
        Charset charset = OooOO0.f42332OooO0o0;
        ...
        int i25 = OooOO0.OooO00o.f42333OooO00o[compactionValueOf.ordinal()];
        if (i25 == 1) {
            z = zBooleanValue;
            i5 = i;
            i6 = i22;
            ...
            OooOO0.OooO0OO(sb, 0, str, length, 0);
        } else if (i25 == 2) {
            z = zBooleanValue;
            i5 = i;
            i6 = i22;
            ...
            OooOO0.OooO00o(bytes, bytes.length, 1, sb);
        } else if (i25 != 3) {
            int i26 = 0;
            int i27 = 0;
            loop0: while (true) {
                ...
                while (true) {
                    ...
                    if (i19 >= 5 || i16 == length) {
                        ...
                        int iOooO0OO = OooOO0.OooO0OO(sb, i26, str, i19, i20);
                        i26 += i19;
                        i28 = iOooO0OO;
                    } else {
                        ...
                        if (bytes2.length == 1 && i27 == 0) {
                            OooOO0.OooO00o(bytes2, 1, 0, sb);
                            i28 = i29;
                        } else {
                            OooOO0.OooO00o(bytes2, bytes2.length, i27, sb);
                            i27 = 1;
                            i28 = 0;
                        }
                        i26 = i36;
            ...
            str2 = "Error correction level must be between 0 and 8!";
            sb.append((char) 902);
            OooOO0.OooO0O0(sb, 0, length, str);
        }
        ...
        OooO00o oooO00o = new OooO00o(i43, i42);
        String strOooO00o = OooOOOO.OooO00o(string2, string3);
        int i51 = 0;
        for (int i52 = 0; i52 < i43; i52++) {
            int i53 = i52 % 3;
            oooO00o.f42322OooO0O0++;
            o0OO00o0.OooO0o.OooO00o(130728, 17, oooO00o.OooO00o());
            if (i53 == 0) {
                i11 = (i52 / 3) * 30;
                i9 = ((i43 - 1) / 3) + i11;
                i12 = i42 - 1;
                ...
                iArr = o0OO00o0.OooO0o.f42327OooO00o;
                o0OO00o0.OooO0o.OooO00o(iArr[i53][i9], 17, oooO00o.OooO00o());
                for (i13 = 0; i13 < i42; i13++) {
                    o0OO00o0.OooO0o.OooO00o(iArr[i53][strOooO00o.charAt(i51)], 17, oooO00o.OooO00o());
                    i51++;
                }
                if (z) {
                    o0OO00o0.OooO0o.OooO00o(260649, 1, oooO00o.OooO00o());
                } else {
                    o0OO00o0.OooO0o.OooO00o(iArr[i53][i10], 17, oooO00o.OooO00o());
                    o0OO00o0.OooO0o.OooO00o(260649, 18, oooO00o.OooO00o());
                }
            }
            i10 = i12 + i11;
            iArr = o0OO00o0.OooO0o.f42327OooO00o;
        ...
        byte[][] bArrOooO0O0 = oooO00o.OooO0O0(1, 4);
        ...
        byte[][] bArrOooO0O1 = oooO00o.OooO0O0(length7, length7 << 2);
        if (z2) {
