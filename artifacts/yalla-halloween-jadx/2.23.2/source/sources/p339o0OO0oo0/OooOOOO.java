...
public final class OooOOOO implements Interpolator {
    ...
    public static final float f42525OooO0O0 = Resources.getSystem().getDisplayMetrics().density;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public static final float f42526OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public static final float f42527OooO0Oo;

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final int f42528OooO00o;

    static {
        float fOooO0oO = 1.0f / OooO0oO(1.0f);
        f42526OooO0OO = fOooO0oO;
        f42527OooO0Oo = 1.0f - (OooO0oO(1.0f) * fOooO0oO);
    }

    public OooOOOO(int i) {
        this.f42528OooO00o = i;
    }
    ...
    public static int OooO0OO(float f) {
        return (int) ((f * f42525OooO0O0) + 0.5f);
    }
    ...
    public final float getInterpolation(float f) {
        if (this.f42528OooO00o == 1) {
            float f2 = 1.0f - f;
            return 1.0f - (f2 * f2);
        }
        float fOooO0oO = OooO0oO(f) * f42526OooO0OO;
        return fOooO0oO > 0.0f ? fOooO0oO + f42527OooO0Oo : fOooO0oO;
    }
}
