...
public final class OooOOO0 {
    ...
    public static class OooO0O0 {
        ...
        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final HashMap f42877OooO00o = new HashMap();

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final OooOOO f42878OooO0O0 = new OooOOO();
    }

    static {
        OooOOO0 oooOOO0 = new OooOOO0();
        f42872OooO0O0 = oooOOO0;
        OooO0O0(oooOOO0);
    }

    public static void OooO0O0(OooOOO0 oooOOO0) {
        oooOOO0.OooO00o(f42875OooO0o0);
        oooOOO0.OooO00o(f42873OooO0OO);
        oooOOO0.OooO00o(f42874OooO0Oo);
    }
    ...
    public final void OooO00o(String[][] strArr) {
        ...
        while (i < length) {
            ...
            OooO00o oooO00o = this.f42876OooO00o;
            oooO00o.f42877OooO00o.put(str, Integer.valueOf(i2));
            OooOOO oooOOO = oooO00o.f42878OooO0O0;
            OooOOO.OooO00o[] oooO00oArr = oooOOO.f42866OooO00o;
            ...
            while (true) {
                if (oooO00o2 == null) {
                    if (oooOOO.f42867OooO0O0 >= oooOOO.f42868OooO0OO) {
                        OooOOO.OooO00o[] oooO00oArr2 = oooOOO.f42866OooO00o;
                        int length3 = oooO00oArr2.length;
                        int i5 = (length3 * 2) + 1;
                        OooOOO.OooO00o[] oooO00oArr3 = new OooOOO.OooO00o[i5];
                        oooOOO.f42868OooO0OO = (int) (i5 * 0.75f);
                        oooOOO.f42866OooO00o = oooO00oArr3;
                        while (true) {
                            int i6 = length3 - 1;
                            if (length3 <= 0) {
                                break;
                            ...
                            while (oooO00o3 != null) {
                                OooOOO.OooO00o oooO00o4 = oooO00o3.f42871OooO0OO;
                                int i7 = (oooO00o3.f42869OooO00o & i3) % i5;
                                oooO00o3.f42871OooO0OO = oooO00oArr3[i7];
                        ...
                        oooO00oArr = oooOOO.f42866OooO00o;
                        length2 = i4 % oooO00oArr.length;
                    }
                    oooO00oArr[length2] = new OooOOO.OooO00o(i2, str, oooO00oArr[length2]);
                    oooOOO.f42867OooO0O0++;
                    break;
                }
                if (oooO00o2.f42869OooO00o == i2) {
                    oooO00o2.f42870OooO0O0 = str;
                    break;
                }
                oooO00o2 = oooO00o2.f42871OooO0OO;
            }
            i++;
            c = 0;
        }
