...
public final class OooOo extends OooOo00 {
    ...
    @NotNull
    public final String f43305OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @Nullable
    public final ParamsWrapper f43306OooO0O0;

    public OooOo(@NotNull String url, @Nullable ParamsWrapper paramsWrapper) {
        Intrinsics.checkNotNullParameter(url, "url");
        this.f43305OooO00o = url;
        this.f43306OooO0O0 = paramsWrapper;
    }
    ...
    public final Object OooO00o(@NotNull Continuation<? super o0O00oO0> continuation) {
        ...
        ParamsWrapper paramsWrapper = this.f43306OooO0O0;
        if (paramsWrapper != null && (map2 = paramsWrapper.f22206OooO00o) != null) {
            boolean z = true;
            if (!map2.isEmpty()) {
        ...
        if (paramsWrapper != null && (map = paramsWrapper.f22208OooO0OO) != null) {
            map3.putAll(map);
        }
        return HttpCoreRequest.f22204OooO00o.get(map3, this.f43305OooO00o + ((Object) sb), continuation);
    }
}
