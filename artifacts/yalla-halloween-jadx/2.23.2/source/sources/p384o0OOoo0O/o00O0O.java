...
public final class o00O0O {
    ...
    public static final class OooO00o<T> extends ContinuationImpl {
        ...
        public ApiResult f43452OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public boolean f43453OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public Function2 f43454OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public /* synthetic */ Object f43455OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public int f43456OooO0oo;

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @Nullable
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f43455OooO0oO = obj;
            this.f43456OooO0oo |= Integer.MIN_VALUE;
            return o00O0O.OooO0O0(null, false, null, null, null, this);
        }
    }
    ...
    public static final class OooO0O0 implements Observer, FunctionAdapter {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function1 f43457OooO0Oo;

        public OooO0O0(o00Oo0 function) {
            Intrinsics.checkNotNullParameter(function, "function");
            this.f43457OooO0Oo = function;
        }
        ...
        public final boolean equals(@Nullable Object obj) {
            ...
            return Intrinsics.areEqual(this.f43457OooO0Oo, ((FunctionAdapter) obj).getFunctionDelegate());
        }

        @Override // kotlin.jvm.internal.FunctionAdapter
        @NotNull
        public final Function<?> getFunctionDelegate() {
            return this.f43457OooO0Oo;
        }

        public final int hashCode() {
            return this.f43457OooO0Oo.hashCode();
        }

        @Override // androidx.lifecycle.Observer
        public final /* synthetic */ void onChanged(Object obj) {
            this.f43457OooO0Oo.invoke(obj);
        }
    }
    ...
    public static Object OooO00o(MutableSharedFlow mutableSharedFlow, Function2 function2, Function2 function3, Continuation continuation, int i) {
        ...
        Object objCollect = mutableSharedFlow.collect(new o0OoOo0(function2, null, false, function3), continuation);
    ...
    public static final <T> Object OooO0O0(@NotNull ApiResult<T> apiResult, boolean z, @Nullable Function2<? super ApiResult<T>, ? super Continuation<? super Unit>, ? extends Object> function2, @Nullable Function2<? super ApiError, ? super Continuation<? super Unit>, ? extends Object> function3, @NotNull Function2<? super T, ? super Continuation<? super Unit>, ? extends Object> function4, @NotNull Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof OooO00o) {
            ...
            int i = oooO00o.f43456OooO0oo;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO00o.f43456OooO0oo = i - Integer.MIN_VALUE;
            } else {
        ...
        Object obj = oooO00o.f43455OooO0oO;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = oooO00o.f43456OooO0oo;
        if (i2 == 0) {
            ResultKt.throwOnFailure(obj);
            if (apiResult.isSuccess()) {
                T data = apiResult.getData();
                oooO00o.f43452OooO0Oo = apiResult2;
                oooO00o.f43454OooO0o0 = function5;
                oooO00o.f43456OooO0oo = 1;
                ...
                if (function3 != null) {
                    ...
                    oooO00o.f43454OooO0o0 = function5;
                    z2 = z;
                    oooO00o.f43453OooO0o = z2;
                    oooO00o.f43456OooO0oo = 2;
            ...
            oooO00o.f43452OooO0Oo = null;
            oooO00o.f43454OooO0o0 = null;
            oooO00o.f43456OooO0oo = 3;
            if (function5.invoke(apiResult2, oooO00o) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else if (i2 == 1) {
            Function2<? super ApiResult<T>, ? super Continuation<? super Unit>, ? extends Object> function6 = oooO00o.f43454OooO0o0;
            ApiResult<T> apiResult3 = oooO00o.f43452OooO0Oo;
            ResultKt.throwOnFailure(obj);
            function5 = function6;
            ...
            boolean z3 = oooO00o.f43453OooO0o;
            function5 = oooO00o.f43454OooO0o0;
            ApiResult<T> apiResult4 = oooO00o.f43452OooO0Oo;
            ResultKt.throwOnFailure(obj);
            z2 = z3;
    ...
    public static void OooO0Oo(LiveData liveData, LifecycleOwner owner, boolean z, Function1 function1, Function1 function2, Function1 onSuccess, int i) {
        ...
        liveData.observe(owner, new OooO0O0(new o00Oo0(onSuccess, function2, function1, z)));
    }
}
