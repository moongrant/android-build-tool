...
public final class o0OOO0o {
    ...
    @NotNull
    public static final Lazy f43464OooO00o = LazyKt.lazy(OooO00o.f43465OooO0Oo);

    public static final class OooO00o extends Lambda implements Function0<TaskService> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO00o f43465OooO0Oo = new OooO00o();
        ...
        public final TaskService invoke() {
            ...
            return (TaskService) OooOo.OooO0Oo().OooO0O0(TaskService.class);
        }
    }

    @NotNull
    public static TaskService OooO00o() {
        Object value = f43464OooO00o.getValue();
