...
import p333o0OO0Ooo.OooO;
import p333o0OO0Ooo.OooOO0O;
import p333o0OO0Ooo.OooOOO;
...
public final class o00Ooo extends o00Oo0 {
    ...
    @Nullable
    public Boolean[] f43529OooO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public final OooOO0 f43530OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @NotNull
    public final HashMap<String, Bitmap> f43531OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @NotNull
    public final OooO0O0 f43532OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    @NotNull
    public final OooO00o f43533OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    @Nullable
    public Boolean[] f43534OooO0oo;

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    @NotNull
    public final float[] f43535OooOO0;

    public static final class OooO00o {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public int f43536OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public int f43537OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        @NotNull
        public final HashMap<SVGAVideoShapeEntity, Path> f43538OooO0OO = new HashMap<>();
    }
    ...
    public static final class OooO0O0 {
        ...
        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        @Nullable
        public Bitmap f43545OooO0oO;

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        @NotNull
        public final Paint f43539OooO00o = new Paint();

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        @NotNull
        public final Path f43540OooO0O0 = new Path();

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        @NotNull
        public final Path f43541OooO0OO = new Path();

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        @NotNull
        public final Matrix f43542OooO0Oo = new Matrix();

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        @NotNull
        public final Matrix f43544OooO0o0 = new Matrix();

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        @NotNull
        public final Paint f43543OooO0o = new Paint();
    }
    ...
    public o00Ooo(@NotNull o0OO0O0O.o00Ooo videoItem, @NotNull OooOO0 dynamicItem) {
        ...
        this.f43530OooO0Oo = dynamicItem;
        this.f43532OooO0o0 = new OooO0O0();
        this.f43531OooO0o = new HashMap<>();
        this.f43533OooO0oO = new OooO00o();
        this.f43535OooOO0 = new float[16];
    }
    ...
    public final void OooO00o(o00Oo0.OooO00o oooO00o, Canvas canvas, int i) {
        ...
        String str3 = oooO00o9.f43527OooO0O0;
        OooO0O0 oooO0O3 = this.f43532OooO0o0;
        o0OO0O0O.o00Ooo o00ooo2 = this.f43523OooO00o;
        OooOO0 oooOO2 = this.f43530OooO0Oo;
        if (str3 == null || Intrinsics.areEqual(oooOO2.f42361OooO00o.get(str3), Boolean.TRUE)) {
            canvas2 = canvas;
            oooO0O0 = oooO0O3;
        } else {
            ...
            Bitmap bitmap = oooOO2.f42362OooO0O0.get(strSubstring);
            if (bitmap == null && (bitmap = o00ooo2.f42412OooOO0.get(strSubstring)) == null) {
                canvas2 = canvas;
                oooO0O0 = oooO0O3;
            } else {
                OooOOO oooOOO3 = oooO00o9.f43528OooO0OO;
                Intrinsics.checkNotNull(oooOOO3);
                Matrix matrixOooO0O0 = OooO0O0(oooOOO3.f42430OooO0OO);
                Paint paint = oooO0O3.f43539OooO00o;
                paint.reset();
                paint.setAntiAlias(o00ooo2.f42405OooO0O0);
                paint.setFilterBitmap(o00ooo2.f42405OooO0O0);
                OooOOO oooOOO4 = oooO00o9.f43528OooO0OO;
                Intrinsics.checkNotNull(oooOOO4);
                double d2 = 255;
                paint.setAlpha((int) (oooOOO4.f42428OooO00o * d2));
                OooOOO oooOOO5 = oooO00o9.f43528OooO0OO;
                Intrinsics.checkNotNull(oooOOO5);
                OooO oooO2 = oooOOO5.f42431OooO0Oo;
                Path path4 = oooO0O3.f43540OooO0O0;
                if (oooO2 != null) {
                    OooOOO oooOOO6 = oooO00o9.f43528OooO0OO;
                    Intrinsics.checkNotNull(oooOOO6);
                    OooO oooO3 = oooOOO6.f42431OooO0Oo;
                    if (oooO3 == null) {
                        canvas2 = canvas;
                        oooO0O0 = oooO0O3;
                    } else {
                        ...
                        OooOOO oooOOO7 = oooO00o9.f43528OooO0OO;
                        Intrinsics.checkNotNull(oooOOO7);
                        oooO0O2 = oooO0O3;
                        float width = (float) (oooOOO7.f42429OooO0O0.f42463OooO00o / ((double) bitmap.getWidth()));
                        OooOOO oooOOO8 = oooO00o9.f43528OooO0OO;
                        Intrinsics.checkNotNull(oooOOO8);
                        matrix4 = matrixOooO0O0;
                        matrix4.preScale(width, (float) (oooOOO8.f42429OooO0O0.f42464OooO0O0 / ((double) bitmap.getHeight())));
                    ...
                    oooO0O2 = oooO0O3;
                    matrix4 = matrixOooO0O0;
                    OooOOO oooOOO9 = oooO00o9.f43528OooO0OO;
                    Intrinsics.checkNotNull(oooOOO9);
                    path3 = path4;
                    float width2 = (float) (oooOOO9.f42429OooO0O0.f42463OooO00o / ((double) bitmap.getWidth()));
                    OooOOO oooOOO10 = oooO00o9.f43528OooO0OO;
                    Intrinsics.checkNotNull(oooOOO10);
                    d = d2;
                    matrix4.preScale(width2, (float) (oooOOO10.f42429OooO0O0.f42464OooO0O0 / ((double) bitmap.getHeight())));
                    if (!bitmap.isRecycled()) {
                        canvas.drawBitmap(bitmap, matrix4, paint);
                    }
                }
                o0OO0O0O.OooO00o oooO00o10 = oooOO2.f42360OooO.get(str3);
                if (oooO00o10 != null) {
                ...
                boolean z = oooOO2.f42370OooOO0O;
                HashMap<String, Bitmap> map2 = this.f43531OooO0o;
                if (z) {
                    map2.clear();
                    oooOO2.f42370OooOO0O = false;
                }
                String str4 = oooO00o9.f43527OooO0O0;
                if (str4 == null) {
                    canvas2 = canvas;
                } else {
                    String str5 = oooOO2.f42363OooO0OO.get(str4);
                    if (str5 == null || (textPaint = oooOO2.f42364OooO0Oo.get(str4)) == null) {
                    ...
                    BoringLayout boringLayout = oooOO2.f42365OooO0o.get(str4);
                    ...
                    StaticLayout staticLayout = oooOO2.f42366OooO0o0.get(str4);
                    ...
                    if (bitmapCreateBitmap != null) {
                        oooO0O0 = oooO0O2;
                        Paint paint2 = oooO0O0.f43539OooO00o;
                        paint2.reset();
                        paint2.setAntiAlias(o00ooo2.f42405OooO0O0);
                        OooOOO oooOOO11 = oooO00o9.f43528OooO0OO;
                        Intrinsics.checkNotNull(oooOOO11);
                        paint2.setAlpha((int) (oooOOO11.f42428OooO00o * d));
                        OooOOO oooOOO12 = oooO00o9.f43528OooO0OO;
                        Intrinsics.checkNotNull(oooOOO12);
                        if (oooOOO12.f42431OooO0Oo != null) {
                            OooOOO oooOOO13 = oooO00o9.f43528OooO0OO;
                            Intrinsics.checkNotNull(oooOOO13);
                            OooO oooO4 = oooOOO13.f42431OooO0Oo;
                            if (oooO4 == null) {
                                canvas2 = canvas;
                            } else {
                                canvas.save();
                            ...
                            canvas2 = canvas;
                            paint2.setFilterBitmap(o00ooo2.f42405OooO0O0);
        ...
        OooOOO oooOOO14 = oooO00o9.f43528OooO0OO;
        Intrinsics.checkNotNull(oooOOO14);
        Matrix matrixOooO0O1 = OooO0O0(oooOOO14.f42430OooO0OO);
        OooOOO oooOOO15 = oooO00o9.f43528OooO0OO;
        Intrinsics.checkNotNull(oooOOO15);
        Iterator it2 = oooOOO15.f42432OooO0o0.iterator();
        ...
        while (it2.hasNext()) {
            ...
            if (shape.f20806OooO0o0 != null) {
                it = it2;
            } else {
                Path path6 = OooOO0O.f42427OooO00o;
                path6.reset();
                SVGAVideoShapeEntity.Type type = shape.f20802OooO00o;
                if (type == SVGAVideoShapeEntity.Type.shape) {
                    HashMap map3 = shape.f20803OooO0O0;
                    ...
                    if (type == SVGAVideoShapeEntity.Type.ellipse) {
                        ...
                        if (number != null) {
                            ...
                            if (number2 != null) {
                                ...
                                if (number3 != null) {
                                    ...
                                    if (shape.f20806OooO0o0 != null) {
                                        Paint paint3 = oooO0O0.f43539OooO00o;
                                        paint3.reset();
                                        paint3.reset();
                                        paint3.setAntiAlias(o00ooo2.f42405OooO0O0);
                                        OooOOO oooOOO16 = oooO00o11.f43528OooO0OO;
                                        Intrinsics.checkNotNull(oooOOO16);
                                        double d3 = 255;
                                        paint3.setAlpha((int) (oooOOO16.f42428OooO00o * d3));
                                        Path path7 = oooO0O0.f43540OooO0O0;
                                        path7.reset();
                                        path7.reset();
                                        OooO00o oooO00o12 = this.f43533OooO0oO;
                                        oooO00o12.getClass();
                                        Intrinsics.checkNotNullParameter(shape, "shape");
                                        map = oooO00o12.f43538OooO0OO;
                                        if (!map.containsKey(shape)) {
                                            path = new Path();
                                            path2 = shape.f20806OooO0o0;
                                            if (path2 != null) {
                                                path.set(path2);
                                            }
                                            map.put(shape, path);
                                        ...
                                        path7.addPath(path8);
                                        matrix = oooO0O0.f43544OooO0o0;
                                        matrix.reset();
                                        matrix.reset();
                                        matrix2 = shape.f20805OooO0Oo;
                                        if (matrix2 != null) {
                                            matrix.postConcat(matrix2);
                                        }
                                        matrix.postConcat(matrixOooO0O1);
                                        path7.transform(matrix);
                                        oooO00o2 = shape.f20804OooO0OO;
                                        Path path9 = oooO0O0.f43541OooO0OO;
                                        if (oooO00o2 != null || (i2 = oooO00o2.f20807OooO00o) == 0) {
                                            oooO0O1 = oooO0O0;
                                        } else {
                                            paint3.setStyle(Paint.Style.FILL);
                                            paint3.setColor(i2);
                                            OooOOO oooOOO17 = oooO00o11.f43528OooO0OO;
                                            Intrinsics.checkNotNull(oooOOO17);
                                            oooO0O1 = oooO0O0;
                                            int iMin = Math.min(255, Math.max(0, (int) (oooOOO17.f42428OooO00o * d3)));
                                            if (iMin != 255) {
                                                paint3.setAlpha(iMin);
                                            }
                                            OooOOO oooOOO18 = oooO00o11.f43528OooO0OO;
                                            Intrinsics.checkNotNull(oooOOO18);
                                            if (oooOOO18.f42431OooO0Oo != null) {
                                                canvas.save();
                                            }
                                            OooOOO oooOOO19 = oooO00o11.f43528OooO0OO;
                                            Intrinsics.checkNotNull(oooOOO19);
                                            OooO oooO5 = oooOOO19.f42431OooO0Oo;
                                            if (oooO5 != null) {
                                                path9.reset();
                                                oooO5.OooO00o(path9);
                                            ...
                                            OooOOO oooOOO20 = oooO00o11.f43528OooO0OO;
                                            Intrinsics.checkNotNull(oooOOO20);
                                            if (oooOOO20.f42431OooO0Oo != null) {
                                                canvas.restore();
                                            }
                                        }
                                        oooO00o3 = shape.f20804OooO0OO;
                                        if (oooO00o3 != null || oooO00o3.f20809OooO0OO <= 0.0f) {
                                            oooO00o = oooO00o;
                                        } else {
                                            OooOOO oooOOO21 = oooO00o11.f43528OooO0OO;
                                            Intrinsics.checkNotNull(oooOOO21);
                                            paint3.setAlpha((int) (oooOOO21.f42428OooO00o * d3));
                                            paint3.setStyle(Paint.Style.STROKE);
                                            SVGAVideoShapeEntity.OooO00o oooO00o13 = shape.f20804OooO0OO;
                                            if (oooO00o13 != null) {
                                                paint3.setColor(oooO00o13.f20808OooO0O0);
                                                OooOOO oooOOO22 = oooO00o11.f43528OooO0OO;
                                                Intrinsics.checkNotNull(oooOOO22);
                                                c = 0;
                                                int iMin2 = Math.min(255, Math.max(0, (int) (oooOOO22.f42428OooO00o * d3)));
                                                if (iMin2 != 255) {
                                            ...
                                            if (f2 == 0.0f) {
                                                ...
                                                if (!(d4 * d7 == d5 * d6)) {
                                                    ...
                                                    fAbs = Math.abs(this.f43524OooO0O0.f42469OooO0o0 ? (float) dSqrt : (float) dSqrt2);
                                                }
                                                oooO00o4 = shape.f20804OooO0OO;
                                                if (oooO00o4 != null) {
                                                    paint3.setStrokeWidth(oooO00o4.f20809OooO0OO * fAbs);
                                                }
                                                oooO00o5 = shape.f20804OooO0OO;
                                                if (oooO00o5 != null && (str2 = oooO00o5.f20810OooO0Oo) != null) {
                                                ...
                                                oooO00o6 = shape.f20804OooO0OO;
                                                if (oooO00o6 != null && (str = oooO00o6.f20812OooO0o0) != null) {
                                                ...
                                                oooO00o7 = shape.f20804OooO0OO;
                                                if (oooO00o7 != null) {
                                                    paint3.setStrokeMiter(oooO00o7.f20811OooO0o * fAbs);
                                                }
                                                oooO00o8 = shape.f20804OooO0OO;
                                                if (oooO00o8 == null && (fArr = oooO00o8.f20813OooO0oO) != null && fArr.length == 3) {
                                                    ...
                                                    oooOOO = oooO00o.f43528OooO0OO;
                                                    Intrinsics.checkNotNull(oooOOO);
                                                    if (oooOOO.f42431OooO0Oo != null) {
                                                        canvas.save();
                                                    }
                                                    OooOOO oooOOO23 = oooO00o.f43528OooO0OO;
                                                    Intrinsics.checkNotNull(oooOOO23);
                                                    oooO = oooOOO23.f42431OooO0Oo;
                                                    if (oooO != null) {
                                                        path9.reset();
                                                        oooO.OooO00o(path9);
                                                    ...
                                                    oooOOO2 = oooO00o.f43528OooO0OO;
                                                    Intrinsics.checkNotNull(oooOOO2);
                                                    if (oooOOO2.f42431OooO0Oo != null) {
                                                        canvas.restore();
                                                    }
                                                    oooO00o11 = oooO00o;
                                                    canvas9 = canvas;
                                                ...
                                                OooOOO oooOOO24 = oooO00o.f43528OooO0OO;
                                                Intrinsics.checkNotNull(oooOOO24);
                                                oooO = oooOOO24.f42431OooO0Oo;
                                                if (oooO != null) {
                                                    path9.reset();
                                                    oooO.OooO00o(path9);
                                                    matrixOooO0O1 = matrix3;
                                            ...
                                            OooOOO oooOOO25 = oooO00o.f43528OooO0OO;
                                            Intrinsics.checkNotNull(oooOOO25);
                                            oooO = oooOOO25.f42431OooO0Oo;
                                            if (oooO != null) {
                                                path9.reset();
                                                oooO.OooO00o(path9);
                                                matrixOooO0O1 = matrix3;
                        ...
                        oooOO1 = oooOO2;
                        if (shape.f20806OooO0o0 != null) {
                            Paint paint4 = oooO0O0.f43539OooO00o;
                            paint4.reset();
                            paint4.reset();
                            paint4.setAntiAlias(o00ooo2.f42405OooO0O0);
                            OooOOO oooOOO110 = oooO00o11.f43528OooO0OO;
                            Intrinsics.checkNotNull(oooOOO110);
                            double d13 = 255;
                            paint4.setAlpha((int) (oooOOO110.f42428OooO00o * d13));
                            Path path10 = oooO0O0.f43540OooO0O0;
                            path10.reset();
                            path10.reset();
                            OooO00o oooO00o14 = this.f43533OooO0oO;
                            oooO00o14.getClass();
                            Intrinsics.checkNotNullParameter(shape, "shape");
                            map = oooO00o14.f43538OooO0OO;
                            if (!map.containsKey(shape)) {
                                path = new Path();
                                path2 = shape.f20806OooO0o0;
                                if (path2 != null) {
                            ...
                            oooO00o2 = shape.f20804OooO0OO;
                            Path path12 = oooO0O0.f43541OooO0OO;
                            if (oooO00o2 != null) {
                                oooO0O1 = oooO0O0;
                            } else {
                                oooO0O1 = oooO0O0;
                        ...
                        if (type == SVGAVideoShapeEntity.Type.rect) {
                            ...
                            if (number5 != null) {
                                ...
                                if (number6 != null) {
                                    ...
                                    if (number7 != null) {
                                        HashMap map11 = shape.f20803OooO0O0;
                                        ...
                                        if (number8 != null) {
                                            HashMap map12 = shape.f20803OooO0O0;
                        ...
                        if (shape.f20806OooO0o0 != null) {
                            Paint paint5 = oooO0O0.f43539OooO00o;
                            paint5.reset();
                            paint5.reset();
                            paint5.setAntiAlias(o00ooo2.f42405OooO0O0);
                            OooOOO oooOOO111 = oooO00o11.f43528OooO0OO;
                            Intrinsics.checkNotNull(oooOOO111);
                            double d14 = 255;
                            paint5.setAlpha((int) (oooOOO111.f42428OooO00o * d14));
                            Path path13 = oooO0O0.f43540OooO0O0;
                            path13.reset();
                            path13.reset();
                            OooO00o oooO00o15 = this.f43533OooO0oO;
                            oooO00o15.getClass();
                            Intrinsics.checkNotNullParameter(shape, "shape");
                            map = oooO00o15.f43538OooO0OO;
                            if (!map.containsKey(shape)) {
                                path = new Path();
                                path2 = shape.f20806OooO0o0;
                                if (path2 != null) {
                            ...
                            oooO00o2 = shape.f20804OooO0OO;
                            Path path15 = oooO0O0.f43541OooO0OO;
                            if (oooO00o2 != null) {
                                oooO0O1 = oooO0O0;
                            } else {
                                oooO0O1 = oooO0O0;
                ...
                shape.f20806OooO0o0 = path16;
                path16.set(path6);
                if (shape.f20806OooO0o0 != null) {
                    Paint paint6 = oooO0O0.f43539OooO00o;
                    paint6.reset();
                    paint6.reset();
                    paint6.setAntiAlias(o00ooo2.f42405OooO0O0);
                    OooOOO oooOOO112 = oooO00o11.f43528OooO0OO;
                    Intrinsics.checkNotNull(oooOOO112);
                    double d15 = 255;
                    paint6.setAlpha((int) (oooOOO112.f42428OooO00o * d15));
                    Path path17 = oooO0O0.f43540OooO0O0;
                    path17.reset();
                    path17.reset();
                    OooO00o oooO00o16 = this.f43533OooO0oO;
                    oooO00o16.getClass();
                    Intrinsics.checkNotNullParameter(shape, "shape");
                    map = oooO00o16.f43538OooO0OO;
                    if (!map.containsKey(shape)) {
                        path = new Path();
                        path2 = shape.f20806OooO0o0;
                        if (path2 != null) {
                    ...
                    oooO00o2 = shape.f20804OooO0OO;
                    Path path19 = oooO0O0.f43541OooO0OO;
                    if (oooO00o2 != null) {
                        oooO0O1 = oooO0O0;
                    } else {
                        oooO0O1 = oooO0O0;
            ...
            oooOO1 = oooOO2;
            if (shape.f20806OooO0o0 != null) {
                Paint paint7 = oooO0O0.f43539OooO00o;
                paint7.reset();
                paint7.reset();
                paint7.setAntiAlias(o00ooo2.f42405OooO0O0);
                OooOOO oooOOO113 = oooO00o11.f43528OooO0OO;
                Intrinsics.checkNotNull(oooOOO113);
                double d16 = 255;
                paint7.setAlpha((int) (oooOOO113.f42428OooO00o * d16));
                Path path110 = oooO0O0.f43540OooO0O0;
                path110.reset();
                path110.reset();
                OooO00o oooO00o17 = this.f43533OooO0oO;
                oooO00o17.getClass();
                Intrinsics.checkNotNullParameter(shape, "shape");
                map = oooO00o17.f43538OooO0OO;
                if (!map.containsKey(shape)) {
                    path = new Path();
                    path2 = shape.f20806OooO0o0;
                    if (path2 != null) {
                ...
                oooO00o2 = shape.f20804OooO0OO;
                Path path112 = oooO0O0.f43541OooO0OO;
                if (oooO00o2 != null) {
                    oooO0O1 = oooO0O0;
                } else {
                    oooO0O1 = oooO0O0;
        ...
        String str7 = oooO00o11.f43527OooO0O0;
        if (str7 == null) {
            return;
        }
        Function2<Canvas, Integer, Boolean> function2 = oooOO3.f42367OooO0oO.get(str7);
        if (function2 != null) {
            OooOOO oooOOO26 = oooO00o11.f43528OooO0OO;
            Intrinsics.checkNotNull(oooOOO26);
            Matrix matrixOooO0O2 = OooO0O0(oooOOO26.f42430OooO0OO);
            canvas.save();
            canvas3 = canvas10;
        ...
        Function4<Canvas, Integer, Integer, Integer, Boolean> function4 = oooOO3.f42369OooOO0.get(str7);
        if (function4 != null) {
            OooOOO oooOOO27 = oooO00o11.f43528OooO0OO;
            Intrinsics.checkNotNull(oooOOO27);
            Matrix matrixOooO0O3 = OooO0O0(oooOOO27.f42430OooO0OO);
            canvas.save();
            canvas3.concat(matrixOooO0O3);
            Integer numValueOf = Integer.valueOf(i);
            OooOOO oooOOO28 = oooO00o11.f43528OooO0OO;
            Intrinsics.checkNotNull(oooOOO28);
            Integer numValueOf2 = Integer.valueOf((int) oooOOO28.f42429OooO0O0.f42463OooO00o);
            OooOOO oooOOO29 = oooO00o11.f43528OooO0OO;
            Intrinsics.checkNotNull(oooOOO29);
            function4.invoke(canvas3, numValueOf, numValueOf2, Integer.valueOf((int) oooOOO29.f42429OooO0O0.f42464OooO0O0));
            canvas.restore();
        }
    }

    public final Matrix OooO0O0(Matrix matrix) {
        Matrix matrix2 = this.f43532OooO0o0.f43542OooO0Oo;
        matrix2.reset();
        OooO0o oooO0o = this.f43524OooO0O0;
        matrix2.postScale(oooO0o.f42467OooO0OO, oooO0o.f42468OooO0Oo);
        matrix2.postTranslate(oooO0o.f42465OooO00o, oooO0o.f42466OooO0O0);
