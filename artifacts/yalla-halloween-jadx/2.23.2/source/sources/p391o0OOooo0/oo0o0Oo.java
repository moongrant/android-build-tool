...
public final class oo0o0Oo {
    ...
    @NotNull
    public static final MutableLiveData<Map<Integer, GiftPropModel>> f43573OooO00o = new MutableLiveData<>(new LinkedHashMap());

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public static final MutableLiveData<Map<Integer, GiftPropModel>> f43574OooO0O0 = new MutableLiveData<>(new LinkedHashMap());

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @NotNull
    public static final MutableLiveData<List<GiftPropModel>> f43575OooO0OO = new MutableLiveData<>(new ArrayList());

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public static final MutableLiveData<List<GiftPropAll>> f43576OooO0Oo = new MutableLiveData<>(new ArrayList());

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @Nullable
    public static Integer f43577OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public static boolean f43578OooO0o0;
    ...
    public static final class OooO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ int f43579OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ long f43580OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ long f43581OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(long j, long j2, int i, Continuation continuation) {
            super(2, continuation);
            this.f43579OooO0Oo = i;
            this.f43581OooO0o0 = j;
            this.f43580OooO0o = j2;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO(this.f43581OooO0o0, this.f43580OooO0o, this.f43579OooO0Oo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            long j = this.f43580OooO0o;
            long j2 = this.f43581OooO0o0;
            int i = this.f43579OooO0Oo;
    ...
    public static final class OooO00o extends Lambda implements Function1<Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO00o f43582OooO0Oo = new OooO00o();
        ...
        public final Unit invoke(Integer num) {
            Integer num2 = num;
            if (!Intrinsics.areEqual(num2, oo0o0Oo.f43577OooO0o)) {
                oo0o0Oo.f43577OooO0o = num2;
    ...
    public static final class OooO0O0 extends Lambda implements Function1<Boolean, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO0O0 f43583OooO0Oo = new OooO0O0();
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f43584OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ boolean f43585OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(boolean z, Continuation<? super OooO0OO> continuation) {
            super(2, continuation);
            this.f43585OooO0o0 = z;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO0OO(this.f43585OooO0o0, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f43584OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                if (this.f43585OooO0o0) {
                    MutableLiveData<Map<Integer, GiftPropModel>> mutableLiveData = oo0o0Oo.f43573OooO00o;
                    this.f43584OooO0Oo = 1;
                    if (oo0o0Oo.OooO00o(this) == coroutine_suspended) {
            ...
            o0000O00.OooO0O0("WRM GiftData allGiftMapForId.size = " + numBoxInt + ", \ndata = " + p187o00o00o0.OooO.OooO00o(mutableLiveData3.getValue()));
            MutableLiveData<Map<Integer, GiftPropModel>> mutableLiveData4 = oo0o0Oo.f43574OooO0O0;
            Map<Integer, GiftPropModel> value3 = mutableLiveData4.getValue();
            Integer numBoxInt2 = value3 != null ? Boxing.boxInt(value3.size()) : null;
            o0000O00.OooO0o("WRM GiftData backpackGiftMapForId.size = " + numBoxInt2 + ", \ndata = " + p187o00o00o0.OooO.OooO00o(mutableLiveData4.getValue()));
            MutableLiveData<List<GiftPropModel>> mutableLiveData5 = oo0o0Oo.f43575OooO0OO;
            List<GiftPropModel> value4 = mutableLiveData5.getValue();
            Integer numBoxInt3 = value4 != null ? Boxing.boxInt(value4.size()) : null;
            o0000O00.OooO0O0("WRM GiftData allGiftNewList.size = " + numBoxInt3 + ", \ndata = " + p187o00o00o0.OooO.OooO00o(mutableLiveData5.getValue()));
            MutableLiveData<List<GiftPropAll>> mutableLiveData6 = oo0o0Oo.f43576OooO0Oo;
            List<GiftPropAll> value5 = mutableLiveData6.getValue();
            Integer numBoxInt4 = value5 != null ? Boxing.boxInt(value5.size()) : null;
            o0000O00.OooO("WRM GiftData allGiftList.size = " + numBoxInt4 + ", \ndata = " + p187o00o00o0.OooO.OooO00o(mutableLiveData6.getValue()));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f43586OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                List<GiftPropAll> value = oo0o0Oo.f43576OooO0Oo.getValue();
                if (o0OoOo0.OooO0o0(0, value != null ? Boxing.boxInt(value.size()) : null) <= 1) {
                    this.f43586OooO0Oo = 1;
                    if (oo0o0Oo.OooO00o(this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                }
    ...
    public static final class OooOO0 implements Observer, FunctionAdapter {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function1 f43587OooO0Oo;

        public OooOO0(Function1 function) {
            Intrinsics.checkNotNullParameter(function, "function");
            this.f43587OooO0Oo = function;
        }
        ...
        public final boolean equals(@Nullable Object obj) {
            ...
            return Intrinsics.areEqual(this.f43587OooO0Oo, ((FunctionAdapter) obj).getFunctionDelegate());
        }

        @Override // kotlin.jvm.internal.FunctionAdapter
        @NotNull
        public final Function<?> getFunctionDelegate() {
            return this.f43587OooO0Oo;
        }

        public final int hashCode() {
            return this.f43587OooO0Oo.hashCode();
        }

        @Override // androidx.lifecycle.Observer
        public final /* synthetic */ void onChanged(Object obj) {
            this.f43587OooO0Oo.invoke(obj);
        }
    }
    ...
    public static final class OooOO0O implements Runnable {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Object f43588OooO0Oo;

        public OooOO0O(MutableLiveData mutableLiveData) {
            this.f43588OooO0Oo = mutableLiveData;
        }

        @Override // java.lang.Runnable
        public final void run() {
            ((MutableLiveData) this.f43588OooO0Oo).observeForever(new OooOO0(OooO00o.f43582OooO0Oo));
        }
    }
    ...
    public static final class OooOOO0 implements Runnable {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Object f43589OooO0Oo;

        public OooOOO0(MutableLiveData mutableLiveData) {
            this.f43589OooO0Oo = mutableLiveData;
        }

        @Override // java.lang.Runnable
        public final void run() {
            ((MutableLiveData) this.f43589OooO0Oo).observeForever(new OooOO0(OooO0O0.f43583OooO0Oo));
        }
    }
    ...
    static {
        ...
        f43577OooO0o = (Integer) o0O00oO0.OooOOO0().getValue();
        MutableLiveData mutableLiveDataOooOOO0 = o0O00oO0.OooOOO0();
        if (Intrinsics.areEqual(Looper.getMainLooper().getThread(), Thread.currentThread())) {
            mutableLiveDataOooOOO0.observeForever(new OooOO0(OooO00o.f43582OooO0Oo));
        } else {
        ...
        if (Intrinsics.areEqual(Looper.getMainLooper().getThread(), Thread.currentThread())) {
            mutableLiveDataOooOo0O.observeForever(new OooOO0(OooO0O0.f43583OooO0Oo));
        } else {
    ...
    public static boolean OooO0OO() {
        ...
        List<GiftPropAll> value = f43576OooO0Oo.getValue();
        if (value != null) {
    ...
    public static void OooO0o0(@NotNull LifecycleOwner owner, @NotNull Observer observer) {
        ...
        f43576OooO0Oo.observe(owner, observer);
    }
}
