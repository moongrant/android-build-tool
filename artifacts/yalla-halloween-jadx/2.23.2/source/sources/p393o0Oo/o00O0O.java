...
public final class o00O0O extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super File>, Object> {
    ...
    public int f43599OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ String f43600OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ String f43601OooO0o0;

    public static final class OooO00o<D> implements o0000O00 {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final /* synthetic */ CancellableContinuation<File> f43602OooO00o;

        public OooO00o(CancellableContinuationImpl cancellableContinuationImpl) {
            this.f43602OooO00o = cancellableContinuationImpl;
        }

        @Override // p675oOooo0o.o0000O00
        public final void result(boolean z, Object obj) {
            String str = (String) obj;
            CancellableContinuation<File> cancellableContinuation = this.f43602OooO00o;
            if (z) {
    ...
    public o00O0O(String str, String str2, Continuation<? super o00O0O> continuation) {
        super(2, continuation);
        this.f43601OooO0o0 = str;
        this.f43600OooO0o = str2;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o00O0O(this.f43601OooO0o0, this.f43600OooO0o, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
        ...
        int i = this.f43599OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            String str = this.f43601OooO0o0;
            String str2 = this.f43600OooO0o;
            this.f43599OooO0Oo = 1;
            CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(IntrinsicsKt.intercepted(this), 1);
            cancellableContinuationImpl.initCancellability();
            oo000o oo000oVar = new oo000o((File) o0O0o00O.f47855OooOOO.getValue());
