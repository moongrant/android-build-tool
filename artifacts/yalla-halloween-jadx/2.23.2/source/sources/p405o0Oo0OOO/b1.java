...
public final class b1 implements OooO00o {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    @NonNull
    public final LinearLayoutCompat f43735OooO00o;

    public b1(@NonNull LinearLayoutCompat linearLayoutCompat) {
        this.f43735OooO00o = linearLayoutCompat;
    }
    ...
    public final View getRoot() {
        return this.f43735OooO00o;
    }

    @NonNull
    public static b1 inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(oo0o0Oo.room_layout_user_info_rank, viewGroup, false);
        if (z) {
        ...
        if (((ImageView) OooO0O0.OooO00o(i, viewInflate)) != null) {
            ...
            if (((TextView) OooO0O0.OooO00o(i2, viewInflate)) != null) {
                return new b1(linearLayoutCompat);
            }
            i = i2;
        }
