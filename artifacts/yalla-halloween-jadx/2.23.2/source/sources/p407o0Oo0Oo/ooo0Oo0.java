...
public final class ooo0Oo0 implements o0o0000 {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final RoomDatabase f45878OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final oO0Oo f45879OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final TagConverter f45880OooO0OO = new TagConverter();

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final o0oo0000 f45881OooO0Oo;

    public ooo0Oo0(YlAppDataBase ylAppDataBase) {
        this.f45878OooO00o = ylAppDataBase;
        this.f45879OooO0O0 = new oO0Oo(this, ylAppDataBase);
        this.f45881OooO0Oo = new o0oo0000(ylAppDataBase);
    }

    @Override // p407o0Oo0Oo.o0o0000
    public final void OooO00o(long j) {
        RoomDatabase roomDatabase = this.f45878OooO00o;
        roomDatabase.OooO0O0();
        o0oo0000 o0oo0000Var = this.f45881OooO0Oo;
        SupportSQLiteStatement supportSQLiteStatementOooO00o = o0oo0000Var.OooO00o();
        ...
        try {
            ...
            roomDatabase.OooOO0();
            o0oo0000Var.OooO0Oo(supportSQLiteStatementOooO00o);
        }
    }
            ...
            try {
                ...
                try {
                    ...
                    if (cursorOooO0O0.moveToFirst()) {
                        ...
                        try {
                            userInfo2.setTags(this.f45880OooO0OO.stringToList(cursorOooO0O0.isNull(iOooO00o23) ? null : cursorOooO0O0.getString(iOooO00o23)));
    ...
    public final void OooO0OO(UserInfoModel userInfoModel) {
        ...
        roomDatabase.OooO0OO();
        try {
            this.f45879OooO0O0.OooO0oO(userInfoModel);
            roomDatabase.OooOOO();
        } finally {
            roomDatabase.OooOO0();
        }
    ...
    public final void OooO0Oo(List<? extends UserInfo> list) {
        ...
        roomDatabase.OooO0OO();
        try {
            this.f45879OooO0O0.OooO0o(list);
            roomDatabase.OooOOO();
        } finally {
            roomDatabase.OooOO0();
        }
