...
public final class o0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f45932OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ Function1<Response<ArrayList<UserInfo>>, Unit> f45933OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ String f45934OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public o0(String str, Function1<? super Response<ArrayList<UserInfo>>, Unit> function1, Continuation<? super o0> continuation) {
        super(2, continuation);
        this.f45934OooO0o0 = str;
        this.f45933OooO0o = function1;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o0(this.f45934OooO0o0, this.f45933OooO0o, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f45932OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            this.f45932OooO0Oo = 1;
            ...
            o0oooooOooO00o.OooO0O0(this.f45934OooO0o0, "circleid");
            objOooO0Oo = OooOOO.OooO0Oo(new TopicRepo$circleAdmin$$inlined$call$1(o0oooooOooO00o, null), this);
        ...
        Function1<Response<ArrayList<UserInfo>>, Unit> function1 = this.f45933OooO0o;
        if (zIsSuccess) {
