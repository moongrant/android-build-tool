...
public final class o000 extends oO0O000o {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    @NotNull
    public static final o000 f45936OooO00o = new o000();
    ...
    public static final class OooO00o extends ContinuationImpl {
        ...
        public /* synthetic */ Object f45937OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f45938OooO0o;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f45937OooO0Oo = obj;
            this.f45938OooO0o |= Integer.MIN_VALUE;
            return o000.this.OooO0OO(0, this);
        }
    }
    ...
    public static final class OooO0O0 extends ContinuationImpl {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public /* synthetic */ Object f45940OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f45941OooO0o;
        ...
        @Nullable
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f45940OooO0Oo = obj;
            this.f45941OooO0o |= Integer.MIN_VALUE;
            return o000.this.OooO0Oo(0, 0, this);
        }
    }
    ...
    public static final class OooO0OO extends ContinuationImpl {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public /* synthetic */ Object f45943OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f45944OooO0o;
        ...
        @Nullable
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f45943OooO0Oo = obj;
            this.f45944OooO0o |= Integer.MIN_VALUE;
            return o000.this.OooO0o0(0, 0, this);
        }
    }
    ...
    public final Object OooO0OO(int i, @NotNull Continuation<? super ApiResult<CountryListModel>> continuation) {
        ...
        if (continuation instanceof OooO00o) {
            ...
            int i2 = oooO00o.f45938OooO0o;
            if ((i2 & Integer.MIN_VALUE) != 0) {
                oooO00o.f45938OooO0o = i2 - Integer.MIN_VALUE;
            } else {
    ...
    public final Object OooO0Oo(int i, int i2, @NotNull Continuation<? super ApiResult<List<RoomIndexModel>>> continuation) {
        ...
        if (continuation instanceof OooO0O0) {
            ...
            int i3 = oooO0O0.f45941OooO0o;
            if ((i3 & Integer.MIN_VALUE) != 0) {
                oooO0O0.f45941OooO0o = i3 - Integer.MIN_VALUE;
            } else {
        ...
        Object roomListByCountry = oooO0O0.f45940OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i4 = oooO0O0.f45941OooO0o;
        try {
            if (i4 == 0) {
                ResultKt.throwOnFailure(roomListByCountry);
                MainApiService mainApiServiceOooO00o = OooOOO.OooO00o();
                oooO0O0.f45941OooO0o = 1;
    ...
    public final Object OooO0o0(int i, int i2, @NotNull Continuation<? super ApiResult<List<RoomIndexModel>>> continuation) {
        ...
        if (continuation instanceof OooO0OO) {
            ...
            int i3 = oooO0OO.f45944OooO0o;
            if ((i3 & Integer.MIN_VALUE) != 0) {
                oooO0OO.f45944OooO0o = i3 - Integer.MIN_VALUE;
            } else {
        ...
        Object roomListByTag = oooO0OO.f45943OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i4 = oooO0OO.f45944OooO0o;
        try {
            if (i4 == 0) {
                ResultKt.throwOnFailure(roomListByTag);
                MainApiService mainApiServiceOooO00o = OooOOO.OooO00o();
                oooO0OO.f45944OooO0o = 1;
