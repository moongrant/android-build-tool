...
public final class o00O0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f46086OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ MutableLiveData<Boolean> f46087OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ ChatMessage f46088OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final /* synthetic */ List<Long> f46089OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final /* synthetic */ List<Pair<String, String>> f46090OooO0oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00O0O0(ChatMessage chatMessage, MutableLiveData<Boolean> mutableLiveData, List<Long> list, List<Pair<String, String>> list2, Continuation<? super o00O0O0> continuation) {
        super(2, continuation);
        this.f46088OooO0o0 = chatMessage;
        this.f46087OooO0o = mutableLiveData;
        this.f46089OooO0oO = list;
        this.f46090OooO0oo = list2;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o00O0O0(this.f46088OooO0o0, this.f46087OooO0o, this.f46089OooO0oO, this.f46090OooO0oo, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f46086OooO0Oo;
        MutableLiveData<Boolean> mutableLiveData = this.f46087OooO0o;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ChatMessage chatMessage = this.f46088OooO0o0;
            ...
            this.f46086OooO0Oo = 1;
            MessageIM.ShareUserProfileIn.Builder builderNewBuilder = MessageIM.ShareUserProfileIn.newBuilder();
            builderNewBuilder.setUserId(userId);
            builderNewBuilder.setPrettyID(userIdx);
            builderNewBuilder.setPhoto(userHead);
            builderNewBuilder.setNickName(userName);
            builderNewBuilder.setMsg(message);
            Iterator<T> it = this.f46089OooO0oO.iterator();
            while (it.hasNext()) {
                builderNewBuilder.addTargets(((Number) it.next()).longValue());
            }
            o0OoO00O o0ooo00o2 = OooOO0.f48392OooO00o;
            String str = Oooo0.f43355OooOo0o;
        ...
        Iterator<T> it2 = this.f46090OooO0oo.iterator();
        while (it2.hasNext()) {
