...
public final class o00O0OO0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f46145OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ MutableLiveData<Boolean> f46146OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ ChatMessage f46147OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00O0OO0(ChatMessage chatMessage, MutableLiveData<Boolean> mutableLiveData, Continuation<? super o00O0OO0> continuation) {
        super(2, continuation);
        this.f46147OooO0o0 = chatMessage;
        this.f46146OooO0o = mutableLiveData;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o00O0OO0(this.f46147OooO0o0, this.f46146OooO0o, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws InvalidProtocolBufferException {
        ...
        int i = this.f46145OooO0Oo;
        MutableLiveData<Boolean> mutableLiveData = this.f46146OooO0o;
        ChatMessage chatMessage = this.f46147OooO0o0;
        if (i == 0) {
            ...
            this.f46145OooO0Oo = 1;
            MessageIM.SendVoiceRequest.Builder builderNewBuilder = MessageIM.SendVoiceRequest.newBuilder();
            builderNewBuilder.setToId(targetId);
            builderNewBuilder.setUrl(voiceUrl);
            builderNewBuilder.setMid(mid);
            builderNewBuilder.setDuration((int) voiceDuration);
            o0OoO00O o0ooo00o2 = OooOO0.f48392OooO00o;
            String str = Oooo0.f43332OooO;
