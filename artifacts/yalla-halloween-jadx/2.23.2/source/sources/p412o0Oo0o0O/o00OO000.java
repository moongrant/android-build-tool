...
public final class o00OO000 {
    ...
    @NotNull
    public static final o00OO000 f46175OooO00o = new o00OO000();
    ...
    public static final class OooO00o extends ContinuationImpl {
        ...
        public /* synthetic */ Object f46176OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f46177OooO0o;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f46176OooO0Oo = obj;
            this.f46177OooO0o |= Integer.MIN_VALUE;
            return o00OO000.this.OooO00o(0L, null, this);
        }
    }
    ...
    public static final class OooO0O0 extends ContinuationImpl {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public /* synthetic */ Object f46179OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f46180OooO0o;
        ...
        @Nullable
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f46179OooO0Oo = obj;
            this.f46180OooO0o |= Integer.MIN_VALUE;
            return o00OO000.this.OooO0O0(0L, 0, this);
        }
    }
    ...
    public final Object OooO00o(long j, @NotNull List<Long> list, @NotNull Continuation<? super ApiResult<Object>> continuation) {
        ...
        if (continuation instanceof OooO00o) {
            ...
            int i = oooO00o.f46177OooO0o;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO00o.f46177OooO0o = i - Integer.MIN_VALUE;
            } else {
        ...
        Object obj = oooO00o.f46176OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = oooO00o.f46177OooO0o;
        try {
            if (i2 != 0) {
                if (i2 != 1) {
    ...
    public final Object OooO0O0(long j, int i, @NotNull Continuation<? super ApiResult<RoomMemberListModel<List<RoomUserInfoDTO>>>> continuation) {
        ...
        if (continuation instanceof OooO0O0) {
            ...
            int i2 = oooO0O0.f46180OooO0o;
            if ((i2 & Integer.MIN_VALUE) != 0) {
                oooO0O0.f46180OooO0o = i2 - Integer.MIN_VALUE;
            } else {
        ...
        Object batchRoomMemberList = oooO0O0.f46179OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i3 = oooO0O0.f46180OooO0o;
        try {
            if (i3 == 0) {
                ResultKt.throwOnFailure(batchRoomMemberList);
                SearchApiService searchApiServiceOooO0OO = OooOOO.OooO0OO();
                oooO0O0.f46180OooO0o = 1;
