...
public final class o00OO0OO {
    ...
    @NotNull
    public static final o00OO0OO f46186OooO00o = new o00OO0OO();
    ...
    public static final class OooO00o extends ContinuationImpl {
        ...
        public /* synthetic */ Object f46187OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f46188OooO0o;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f46187OooO0Oo = obj;
            this.f46188OooO0o |= Integer.MIN_VALUE;
            return o00OO0OO.this.OooO00o(false, this);
        }
    }
    ...
    public static final class OooO0O0 extends ContinuationImpl {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public /* synthetic */ Object f46190OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f46191OooO0o;
        ...
        @Nullable
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f46190OooO0Oo = obj;
            this.f46191OooO0o |= Integer.MIN_VALUE;
            return o00OO0OO.this.OooO0O0(0, this);
        }
    }
    ...
    public static final class OooO0OO extends ContinuationImpl {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public /* synthetic */ Object f46193OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f46194OooO0o;
        ...
        @Nullable
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f46193OooO0Oo = obj;
            this.f46194OooO0o |= Integer.MIN_VALUE;
    ...
    public static final class OooO0o extends ContinuationImpl {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public /* synthetic */ Object f46196OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f46197OooO0o;
        ...
        @Nullable
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f46196OooO0Oo = obj;
            this.f46197OooO0o |= Integer.MIN_VALUE;
            return o00OO0OO.this.OooO0Oo(null, this);
        }
    }
    ...
    public final Object OooO00o(boolean z, @NotNull Continuation<? super ApiResult<PremiumShopModel>> continuation) {
        ...
        if (continuation instanceof OooO00o) {
            ...
            int i = oooO00o.f46188OooO0o;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO00o.f46188OooO0o = i - Integer.MIN_VALUE;
            } else {
        ...
        Object objShopUnitPrice = oooO00o.f46187OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = oooO00o.f46188OooO0o;
        try {
            if (i2 == 0) {
    ...
    public final Object OooO0O0(int i, @NotNull Continuation<? super ApiResult<VipPrivilegeModel>> continuation) {
        ...
        if (continuation instanceof OooO0O0) {
            ...
            int i2 = oooO0O0.f46191OooO0o;
            if ((i2 & Integer.MIN_VALUE) != 0) {
                oooO0O0.f46191OooO0o = i2 - Integer.MIN_VALUE;
            } else {
        ...
        Object objVipPrivilege = oooO0O0.f46190OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i3 = oooO0O0.f46191OooO0o;
        try {
            if (i3 == 0) {
                ResultKt.throwOnFailure(objVipPrivilege);
                MainApiService mainApiServiceOooO00o = OooOOO.OooO00o();
                oooO0O0.f46191OooO0o = 1;
    ...
    public final Object OooO0OO(@NotNull Continuation<? super ApiResult<PremiumTimeModel>> continuation) {
        ...
        if (continuation instanceof OooO0OO) {
            ...
            int i = oooO0OO.f46194OooO0o;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO0OO.f46194OooO0o = i - Integer.MIN_VALUE;
            } else {
        ...
        Object objShopUserbuy = oooO0OO.f46193OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = oooO0OO.f46194OooO0o;
        try {
            if (i2 == 0) {
                ResultKt.throwOnFailure(objShopUserbuy);
                MainApiService mainApiServiceOooO00o = OooOOO.OooO00o();
                oooO0OO.f46194OooO0o = 1;
    ...
    public final Object OooO0Oo(@NotNull String str, @NotNull Continuation<? super ApiResult<VipBuyResultModel>> continuation) {
        ...
        if (continuation instanceof OooO0o) {
            ...
            int i = oooO0o.f46197OooO0o;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO0o.f46197OooO0o = i - Integer.MIN_VALUE;
            } else {
        ...
        Object objShopPurchase = oooO0o.f46196OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = oooO0o.f46197OooO0o;
        try {
            if (i2 == 0) {
                ResultKt.throwOnFailure(objShopPurchase);
                MainApiService mainApiServiceOooO00o = OooOOO.OooO00o();
                oooO0o.f46197OooO0o = 1;
