...
public final class o00Oo00 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f46245OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ Function1<Response<Boolean>, Unit> f46246OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ String f46247OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public o00Oo00(String str, Function1<? super Response<Boolean>, Unit> function1, Continuation<? super o00Oo00> continuation) {
        super(2, continuation);
        this.f46247OooO0o0 = str;
        this.f46246OooO0o = function1;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o00Oo00(this.f46247OooO0o0, this.f46246OooO0o, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f46245OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            String strOooOO0 = o00O00OO.OooOO0(this.f46247OooO0o0);
            this.f46245OooO0Oo = 1;
            ...
            o0ooooo.OooO0O0(String.valueOf(2), "type");
        ...
        Function1<Response<Boolean>, Unit> function1 = this.f46246OooO0o;
        if (zIsSuccess) {
