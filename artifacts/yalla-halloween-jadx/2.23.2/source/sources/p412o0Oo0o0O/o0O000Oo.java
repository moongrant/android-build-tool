...
public final class o0O000Oo extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f46265OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ String f46266OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ String f46267OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final /* synthetic */ Integer f46268OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final /* synthetic */ Function1<Response<ArrayList<TopicInfoModel>>, Unit> f46269OooO0oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public o0O000Oo(String str, String str2, Integer num, Function1<? super Response<ArrayList<TopicInfoModel>>, Unit> function1, Continuation<? super o0O000Oo> continuation) {
        super(2, continuation);
        this.f46267OooO0o0 = str;
        this.f46266OooO0o = str2;
        this.f46268OooO0oO = num;
        this.f46269OooO0oo = function1;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o0O000Oo(this.f46267OooO0o0, this.f46266OooO0o, this.f46268OooO0oO, this.f46269OooO0oo, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f46265OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            Integer numBoxInt = Boxing.boxInt(1);
            this.f46265OooO0Oo = 1;
            ...
            o0oooooOooO00o.OooO0O0(String.valueOf(this.f46268OooO0oO), "pageindex");
            o0oooooOooO00o.OooO0O0(this.f46267OooO0o0, "touserid");
            o0oooooOooO00o.OooO0O0(String.valueOf(numBoxInt), "type");
            o0oooooOooO00o.OooO0O0(this.f46266OooO0o, "datesort");
            objOooO0Oo = OooOOO.OooO0Oo(new TopicRepo$circlePersonal$$inlined$call$1(o0oooooOooO00o, null), this);
        ...
        Function1<Response<ArrayList<TopicInfoModel>>, Unit> function1 = this.f46269OooO0oo;
        if (zIsSuccess) {
