...
public final class oo0O {
    ...
    @NotNull
    public static final oo0O f46361OooO00o = new oo0O();
    ...
    public static final class OooO00o extends ContinuationImpl {
        ...
        public /* synthetic */ Object f46362OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f46363OooO0o;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f46362OooO0Oo = obj;
            this.f46363OooO0o |= Integer.MIN_VALUE;
            return oo0O.this.OooO00o(0, null, this);
        }
    }
    ...
    public static final class OooO0O0 extends ContinuationImpl {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public /* synthetic */ Object f46365OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f46366OooO0o;
        ...
        @Nullable
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f46365OooO0Oo = obj;
            this.f46366OooO0o |= Integer.MIN_VALUE;
            return oo0O.this.OooO0O0(0, null, null, null, null, null, null, this);
        }
    }
    ...
    public final Object OooO00o(int i, @Nullable Integer num, @NotNull Continuation<? super ApiResult<List<ReportModel>>> continuation) {
        ...
        if (continuation instanceof OooO00o) {
            ...
            int i2 = oooO00o.f46363OooO0o;
            if ((i2 & Integer.MIN_VALUE) != 0) {
                oooO00o.f46363OooO0o = i2 - Integer.MIN_VALUE;
            } else {
    ...
    public final Object OooO0O0(int i, @Nullable Long l, @Nullable Integer num, @Nullable Integer num2, @Nullable Long l2, @Nullable String str, @Nullable String str2, @NotNull Continuation<? super ApiResult<Object>> continuation) {
        ...
        if (continuation instanceof OooO0O0) {
            ...
            int i2 = oooO0O0.f46366OooO0o;
            if ((i2 & Integer.MIN_VALUE) != 0) {
                oooO0O0.f46366OooO0o = i2 - Integer.MIN_VALUE;
            } else {
        ...
        Object objReport = oooO0O1.f46365OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i3 = oooO0O1.f46366OooO0o;
        try {
            if (i3 == 0) {
                ResultKt.throwOnFailure(objReport);
                MainApiService mainApiServiceOooO00o = OooOOO.OooO00o();
                oooO0O1.f46366OooO0o = 1;
