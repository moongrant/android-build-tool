...
public final class oO0OOO00 extends oO00OOo0 {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final double[] f46510OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final double[][] f46511OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final double[][] f46512OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final double[] f46513OooO0Oo;

    public oO0OOO00(double[] dArr, double[][] dArr2) {
        int length = dArr.length;
        int length2 = dArr2[0].length;
        this.f46513OooO0Oo = new double[length2];
        int i = length - 1;
        ...
        this.f46510OooO00o = dArr;
        this.f46511OooO0O0 = dArr2;
        this.f46512OooO0OO = dArr4;
    }
    ...
    public final double OooO0O0(double d) {
        ...
        double d3;
        double dOooO0o0;
        double[] dArr = this.f46510OooO00o;
        int length = dArr.length;
        double d4 = dArr[0];
        double[][] dArr2 = this.f46511OooO0O0;
        if (d <= d4) {
            d2 = dArr2[0][0];
            d3 = d - d4;
            dOooO0o0 = OooO0o0(d4);
            ...
            if (d < d5) {
                ...
                while (i2 < i) {
                    ...
                    if (d < d7) {
                        ...
                        double[][] dArr3 = this.f46512OooO0OO;
    ...
    public final void OooO0OO(double d, double[] dArr) {
        double[] dArr2 = this.f46510OooO00o;
        int length = dArr2.length;
        double[][] dArr3 = this.f46511OooO0O0;
        int i = 0;
        int length2 = dArr3[0].length;
        double d2 = dArr2[0];
        double[] dArr4 = this.f46513OooO0Oo;
        if (d <= d2) {
            OooO0o(d2, dArr4);
            for (int i2 = 0; i2 < length2; i2++) {
        ...
        while (i4 < length - 1) {
            ...
            if (d < d4) {
                ...
                while (i < length2) {
                    ...
                    double[][] dArr5 = this.f46512OooO0OO;
    ...
    public final void OooO0Oo(double d, float[] fArr) {
        ...
        int length2 = dArr2[0].length;
        double d2 = dArr[0];
        double[] dArr3 = this.f46513OooO0Oo;
        if (d <= d2) {
            OooO0o(d2, dArr3);
            for (int i2 = 0; i2 < length2; i2++) {
        ...
        while (i4 < i3) {
            ...
            if (d < d4) {
                ...
                while (i < length2) {
                    ...
                    double[][] dArr4 = this.f46512OooO0OO;
