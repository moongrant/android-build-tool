...
public final class o00O00OO {
    ...
    public static final class OooO00o extends ClickableSpan {
        ...
        public final /* synthetic */ Function0<Unit> f46702OooO0Oo;

        public OooO00o(Function0<Unit> function0) {
            this.f46702OooO0Oo = function0;
        }

        @Override // android.text.style.ClickableSpan
        public final void onClick(@NotNull View widget) {
            Intrinsics.checkNotNullParameter(widget, "widget");
            this.f46702OooO0Oo.invoke();
        }
    ...
    public static final void OooO00o(@Nullable Activity activity, @Nullable String str, @NotNull String copiedTips) {
        ...
        if (activity != null) {
            ...
            o000Oo0 o000oo0OooO00o = OooOo00.OooO00o(copiedTips, "runnable");
    ...
    public static final String OooO0O0(@NotNull String str) {
        ...
        String strOooO0Oo = o0O0O0Oo.OooO0Oo(str);
    ...
    public static final boolean OooO0Oo(@Nullable String str) {
        return !(str == null || str.length() == 0) && (StringsKt__StringsJVMKt.startsWith$default(str, "http", false, 2, null) || StringsKt__StringsJVMKt.startsWith$default(str, "https", false, 2, null) || StringsKt__StringsJVMKt.startsWith$default(str, "/http", false, 2, null) || StringsKt__StringsJVMKt.startsWith$default(str, "/https", false, 2, null));
    }
    ...
    public static final boolean OooO0o0(@Nullable String str) {
        ...
        try {
            ...
            return StringsKt__StringsJVMKt.startsWith$default(strOooO0oo, OooO0oo("http"), false, 2, null);
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
    ...
    public static final boolean OooO0oO(@Nullable String str) {
        ...
        try {
            ...
            return StringsKt__StringsJVMKt.endsWith$default(strOooO0oo, OooO0oo(".svga"), false, 2, null);
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
    ...
    public static final String OooO0oo(@NotNull String str) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        String lowerCase = str.toLowerCase(oOOo0O00.OooO00o());
    ...
    public static final String OooOO0O(@NotNull String str) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        String upperCase = str.toUpperCase(oOOo0O00.OooO00o());
