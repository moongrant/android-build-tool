...
public final class o0Oo0oo {
    ...
    @NotNull
    public static final MutableState f46817OooO00o = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(RoomState.Close, null, 2, null);

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static boolean f46818OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @Nullable
    public static Job f46819OooO0OO;
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f46820OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                this.f46820OooO0Oo = 1;
    ...
    public static void OooO00o() {
        f46817OooO00o.setValue(RoomState.Close);
        ...
        f46818OooO0O0 = true;
        f46819OooO0OO = OooOOO.OooO0O0(GlobalScope.INSTANCE, new OooO00o(null));
    }

    public static void OooO0O0(int i, @Nullable String str) {
        o0000O00.OooO0OO("RoomStateManager", "disconnectRoom errorCode = " + i + ", message = " + str);
        ArrayList arrayList = com.yalla.yalla.service.room.OooO00o.f24511OooO00o;
    ...
    public static void OooO0Oo(RoomModel roomModel) {
        ...
        if (activityOooO0O0 != null) {
            ...
            f46817OooO00o.setValue(RoomState.InRoom);
            ...
            if (o000000Var.OooO0o0() != roomModel.getId()) {
                o000000Var.f48467OooOO0.setValue(Boolean.valueOf(!o00Ooo.OooO0o0().OooOO0O()));
                o000000Var.f48462OooO0Oo.setValue(Boolean.valueOf(o00Ooo.OooO0o0().OooOO0o()));
            }
    ...
    public static void OooO0o(@Nullable RoomModel roomModel, @Nullable EnterRoomParentPage sourcePage) {
        if (roomModel.getId() == 0 || f46818OooO0O0) {
            return;
        }
        if (sourcePage != null) {
            ...
            BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), null, null, new oO0O0O0o(roomId, sourcePage, null), 3, null);
        }
        if (OooO0oO() == RoomState.Close || roomModel.getId() == com.yalla.yalla.service.room.OooO00o.f24516OooO0o0.OooO0o0()) {
            OooO0Oo(roomModel);
            return;
        }
        Context context = o000O00O.f13421OooO00o;
        Activity activityOooO0O0 = OooO0O0.OooO0O0();
        if (activityOooO0O0 != null) {
            BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), null, null, new o0OOO0o(activityOooO0O0, roomModel, null), 3, null);
        }
    }
    ...
    public static RoomState OooO0oO() {
        return (RoomState) f46817OooO00o.getValue();
    }
}
