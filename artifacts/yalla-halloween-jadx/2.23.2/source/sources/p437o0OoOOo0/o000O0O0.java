...
public final class o000O0O0 {
    ...
    public static String OooO00o(long j, @NotNull String priceCurrencyCode) {
        ...
        strValueOf.getClass();
        return o0OoOo0.OooO0O0(priceCurrencyCode, ZegoConstants.ZegoVideoDataAuxPublishingStream, OooO0O0.OooO00o(new Object[]{Double.valueOf(com.code.android.util.o0OoOo0.OooO0OO(strValueOf, 0.0d))}, 1, "%.2f", "format(format, *args)"));
    }
}
