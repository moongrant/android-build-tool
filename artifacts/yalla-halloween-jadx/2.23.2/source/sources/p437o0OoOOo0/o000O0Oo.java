...
public final class o000O0Oo extends o000O00O {
    ...
    public static final class OooO extends Lambda implements Function0<Unit> {
        ...
        public final Unit invoke() {
            ...
            if (arrayList2 != null && (oooO0o = (ProductDetails.OooO0o) arrayList2.get(0)) != null && (oooO0OO = oooO0o.f12766OooO0O0) != null && (arrayList = oooO0OO.f12764OooO00o) != null) {
        ...
        public final Unit invoke(OooOo00 oooOo00, List<? extends Purchase> list) {
            ...
            if (i == 0) {
                ...
                if (googlePaySubscriptionModel != null && googlePaySubscriptionModel.f22940OooO0OO == GooglePaySubscriptionModel.Action.Downgrade) {
                    ...
                    continuation.resumeWith(Result.m4215constructorimpl(new o00O0000(null, new o000OOo0(-104, o0000.OooO0OO(o000000.Pay_Purchases_Token_Is_Null)))));
                } else {
                    for (Purchase purchase : list2) {
                        ...
                        rechargeMenuPayBuyResultModel2.setAcknowledged(purchase.f12772OooO0OO.optBoolean("acknowledged", true));
                        continuation.resumeWith(Result.m4215constructorimpl(new o00O0000(rechargeMenuPayBuyResultModel2, null)));
                    }
                }
            } else if (i == 1) {
                Result.Companion companion2 = Result.INSTANCE;
                continuation.resumeWith(Result.m4215constructorimpl(new o00O0000(null, new o000OOo0(-106, o0000.OooO0OO(o000000.Pay_User_Cancelled_Payment)))));
            } else if (i != 7) {
                String str = result.f12747OooO0O0;
                Intrinsics.checkNotNullExpressionValue(str, "getDebugMessage(...)");
                continuation.resumeWith(Result.m4215constructorimpl(new o00O0000(null, new o000OOo0(i, str))));
            } else {
                Result.Companion companion3 = Result.INSTANCE;
                continuation.resumeWith(Result.m4215constructorimpl(new o00O0000(null, new o000OOo0(-105, o0000.OooO0OO(o000000.Pay_Commodity_Already_Owned)))));
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public static boolean OooO0oo(o000O0Oo o000o0oo2) {
        ...
        if (oooO0o.OooO0Oo()) {
            ...
            switch (b) {
                case 0:
                    oooOo00 = !oooO0o.f12727OooO0oo ? com.android.billingclient.api.o0000.f12791OooOOO : com.android.billingclient.api.o0000.f12789OooOO0O;
                    break;
                case 1:
                    oooOo00 = !oooO0o.f12719OooO ? com.android.billingclient.api.o0000.f12793OooOOOO : com.android.billingclient.api.o0000.f12789OooOO0O;
                    break;
                case 2:
                    oooOo00 = !oooO0o.f12730OooOO0o ? com.android.billingclient.api.o0000.f12794OooOOOo : com.android.billingclient.api.o0000.f12789OooOO0O;
                    break;
                case 3:
                    oooOo00 = !oooO0o.f12733OooOOOO ? com.android.billingclient.api.o0000.f12798OooOo0 : com.android.billingclient.api.o0000.f12789OooOO0O;
                    break;
                case 4:
                    oooOo00 = !oooO0o.f12736OooOOo0 ? com.android.billingclient.api.o0000.f12796OooOOo0 : com.android.billingclient.api.o0000.f12789OooOO0O;
                    break;
                case 5:
                    oooOo00 = !oooO0o.f12734OooOOOo ? com.android.billingclient.api.o0000.f12797OooOOoo : com.android.billingclient.api.o0000.f12789OooOO0O;
                    break;
                case 6:
                case 7:
                    oooOo00 = !oooO0o.f12735OooOOo ? com.android.billingclient.api.o0000.f12795OooOOo : com.android.billingclient.api.o0000.f12789OooOO0O;
                    break;
                case 8:
                    oooOo00 = !oooO0o.f12737OooOOoo ? com.android.billingclient.api.o0000.f12799OooOo00 : com.android.billingclient.api.o0000.f12789OooOO0O;
                    break;
                default:
                    zzb.zzo("BillingClient", "Unsupported feature: ".concat(BillingClient.FeatureType.PRODUCT_DETAILS));
                    oooOo00 = com.android.billingclient.api.o0000.f12800OooOo0O;
                    break;
            }
        } else {
            oooOo00 = com.android.billingclient.api.o0000.f12790OooOO0o;
        }
        Intrinsics.checkNotNullExpressionValue(oooOo00, "isFeatureSupported(...)");
        int i = oooOo00.f12746OooO00o;
        boolean z = i == 0;
        if (!z) {
            o0000O00.OooO("GooglePay 检查否支持 V5 isFeatureSupported responseCode = " + i);
        }
        return z;
    }
    ...
    /* JADX WARN: Code duplicated, block: B:39:0x00b6 A[LOOP:1: B:35:0x009d->B:39:0x00b6, LOOP_END] */
    ...
    /* JADX WARN: Code duplicated, block: B:64:0x017e A[RETURN] */
    /* JADX WARN: Code duplicated, block: B:65:0x017f  */
    /* JADX WARN: Code duplicated, block: B:7:0x001b  */
    /* JADX WARN: Code duplicated, block: B:86:0x0250  */
    /* JADX WARN: Code duplicated, block: B:88:0x0258  */
    ...
    public final Object OooO(@NotNull List<String> list, boolean z, @NotNull Continuation<? super o00O0000<List<o000OO00>>> continuation) throws Throwable {
        ...
        if (i2 == 0) {
            ...
            for (String str2 : list2) {
                ...
                oooO00o2.f12861OooO00o = str2;
                oooO00o2.f12862OooO0O0 = str;
                if (str2 != null) {
            ...
            for (oo000o.OooO0O0 oooO0O1 : arrayList) {
                zEquals |= oooO0O1.f12860OooO0O0.equals("inapp");
                zEquals2 |= oooO0O1.f12860OooO0O0.equals("subs");
            }
            if (!zEquals) {
            }
            oooO00o.f12858OooO00o = zzu.zzk(arrayList);
            ...
            if (!oooO0o2.OooO0Oo()) {
                oooOO0O.OooO00o(com.android.billingclient.api.o0000.f12790OooOO0o, new ArrayList());
            } else if (!oooO0o2.f12737OooOOoo) {
                zzb.zzo("BillingClient", "Querying product details is not supported.");
                oooOO0O.OooO00o(com.android.billingclient.api.o0000.f12799OooOo00, new ArrayList());
                ...
                public final Object call() {
                    ...
                    zzu zzuVar = oo000oVar2.f12857OooO00o;
                    ...
                    while (true) {
                        ...
                        for (int i5 = 0; i5 < size2; i5++) {
                            arrayList4.add(((oo000o.OooO0O0) arrayList3.get(i5)).f12859OooO00o);
                        }
                        Bundle bundle = new Bundle();
                        bundle.putStringArrayList("ITEM_ID_LIST", arrayList4);
                        bundle.putString("playBillingLibraryVersion", oooO0o3.f12721OooO0O0);
                        try {
                            Bundle bundleZzl = oooO0o3.f12724OooO0o.zzl(17, oooO0o3.f12725OooO0o0.getPackageName(), strOooO00o, bundle, zzb.zzg(oooO0o3.f12721OooO0O0, arrayList3, null));
                            if (bundleZzl != null) {
                    ...
                    oooOo00.f12746OooO00o = iZzb;
                    oooOo00.f12747OooO0O0 = strZzk;
        ...
        if (o0oooo1.f12851OooO00o.f12746OooO00o != 0) {
        ...
        objectRef.element = "";
        List<ProductDetails> list4 = o0oooo1.f12852OooO0O0;
        if (list4 != null) {
            for (ProductDetails productDetails : list4) {
                ArrayList arrayList3 = productDetails.f12758OooO0oO;
                if (arrayList3 != null) {
                ...
                if (OooO00o2 != null) {
                    ...
                    String str3 = productDetails.f12754OooO0OO;
                    Intrinsics.checkNotNullExpressionValue(str3, "getProductId(...)");
                    o000OO00 o000oo01 = new o000OO00(str3);
                    String strValueOf = String.valueOf((OooO00o2.f12759OooO00o / ((long) ResponseInfo.UnknownError)) / 100.0d);
                    ...
                    String str4 = OooO00o2.f12760OooO0O0;
        ...
        o0000O00.OooO0O0("GooglePay 商品详情 V5：queryProductDetailsAsync " + objectRef.element + "\npayResult = " + o00o0006 + ZegoConstants.ZegoVideoDataAuxPublishingStream);
        return o00o0006;
    }
    ...
    /* JADX WARN: Code duplicated, block: B:57:0x01ab A[DONT_INVERT] */
    ...
    /* JADX WARN: Code duplicated, block: B:85:0x0224 A[RETURN] */
    ...
    public final Object OooO0o(@NotNull String str, @NotNull RechargeMenuToPayModel rechargeMenuToPayModel, @Nullable GooglePaySubscriptionModel googlePaySubscriptionModel, @NotNull Continuation<? super o00O0000<RechargeMenuPayBuyResultModel>> continuation) {
        ...
        if (i3 == 0) {
            ...
            if (rechargeMenuToPayModel.getProductDetails() == null) {
                ...
                o00o0002.f47169OooO0O0 = new o000OOo0(-113, o0000.OooO0OO(o000000.Pay_Params_Is_Null));
                return o00o0002;
            }
            ...
            oooO00o2.f12708OooO00o = productDetails;
            if (productDetails.OooO00o() != null) {
                productDetails.OooO00o().getClass();
                oooO00o2.f12709OooO0O0 = productDetails.OooO00o().f12761OooO0OO;
            }
            ...
            zzm.zzc(oooO00o2.f12708OooO00o, "ProductDetails is required for constructing ProductDetailsParams.");
            zzm.zzc(oooO00o2.f12709OooO0O0, "offerToken is required for constructing ProductDetailsParams.");
            ...
            oooO00o3.f12701OooO00o = Base64ExtensionsKt.base64EncodeToString(AESKt.aesEncrypt$default(content, oOO0Oo00.OooO00o(), oO0oO000.f57154OooO00o, (String) null, 4, (Object) null));
            oooO00o3.f12702OooO0O0 = str4;
            oooO00o3.f12703OooO0OO = new ArrayList(arrayList2);
            ...
            o0000O00.OooO0O0("GooglePay 购买订阅 V5 \norderId:" + str4 + " \nproductDetails:" + rechargeMenuToPayModel2.getProductDetails() + "\nsubscription:" + googlePaySubscriptionModel2 + "\nbillingResult:" + oooOo00OooO0o0);
            if (googlePaySubscriptionModel2 != null) {
                str2 = googlePaySubscriptionModel2.f22939OooO0O0;
                i = GooglePaySubscriptionModel.OooO00o.$EnumSwitchMapping$0[googlePaySubscriptionModel2.f22940OooO0OO.ordinal()];
                if (i != 1) {
                    if (i != 2) {
                        i4 = 1;
                    } else {
                ...
                oooO0OO.f12710OooO00o = str2;
                oooO0OO.f12711OooO0O0 = i4;
                BillingFlowParams.OooO0OO.OooO00o oooO00o4 = new BillingFlowParams.OooO0OO.OooO00o();
                oooO00o4.f12712OooO00o = oooO0OO.f12710OooO00o;
                oooO00o4.f12714OooO0OO = oooO0OO.f12711OooO0O0;
                oooO00o3.f12705OooO0o0 = oooO00o4;
            }
            if (oooOo00OooO0o0.f12746OooO00o == 0) {
                return new o00O0000(null, o00o0001.f47169OooO0O0);
            }
            ...
            if (i3 == 2) {
                ...
                productDetails2 = rechargeMenuToPayModel2.getProductDetails();
                if (productDetails2 != null && (arrayList = productDetails2.f12758OooO0oO) != null) {
                    Intrinsics.checkNotNull(arrayList);
                    while (r14.hasNext()) {
                        if (oooO0o == null && (str3 = oooO0o.f12765OooO00o) != null) {
                            oooO00o2.f12709OooO0O0 = str3;
                        }
                    }
                }
                zzm.zzc(oooO00o2.f12708OooO00o, "ProductDetails is required for constructing ProductDetailsParams.");
                ...
                oooO00o3.f12701OooO00o = Base64ExtensionsKt.base64EncodeToString(AESKt.aesEncrypt$default(content2, oOO0Oo00.OooO00o(), oO0oO000.f57154OooO00o, (String) null, 4, (Object) null));
                oooO00o3.f12702OooO0O0 = str4;
                oooO00o3.f12703OooO0OO = new ArrayList(arrayList3);
                Intrinsics.checkNotNullExpressionValue(oooO00o3, "setProductDetailsParamsList(...)");
                oooOo00OooO0o0 = o000o0oo2.f47090OooO0Oo.OooO0o0(o000o0oo2.f47087OooO00o, oooO00o3.OooO00o());
                Intrinsics.checkNotNullExpressionValue(oooOo00OooO0o0, "launchBillingFlow(...)");
                o0000O00.OooO0O0("GooglePay 购买订阅 V5 \norderId:" + str4 + " \nproductDetails:" + rechargeMenuToPayModel2.getProductDetails() + "\nsubscription:" + googlePaySubscriptionModel2 + "\nbillingResult:" + oooOo00OooO0o0);
                if (googlePaySubscriptionModel2 != null && (!StringsKt.isBlank(googlePaySubscriptionModel2.f22938OooO00o)) && (!StringsKt.isBlank(googlePaySubscriptionModel2.f22939OooO0O0))) {
                    str2 = googlePaySubscriptionModel2.f22939OooO0O0;
                    i = GooglePaySubscriptionModel.OooO00o.$EnumSwitchMapping$0[googlePaySubscriptionModel2.f22940OooO0OO.ordinal()];
                    if (i != 1) {
                        if (i != 2) {
                    ...
                    oooO0OO2.f12710OooO00o = str2;
                    oooO0OO2.f12711OooO0O0 = i4;
                    BillingFlowParams.OooO0OO.OooO00o oooO00o5 = new BillingFlowParams.OooO0OO.OooO00o();
                    oooO00o5.f12712OooO00o = oooO0OO2.f12710OooO00o;
                    oooO00o5.f12714OooO0OO = oooO0OO2.f12711OooO0O0;
                    oooO00o3.f12705OooO0o0 = oooO00o5;
                }
                if (oooOo00OooO0o0.f12746OooO00o == 0) {
                    return new o00O0000(null, o00o0001.f47169OooO0O0);
                }
    ...
    public final Object OooO0oO(@NotNull PayOrder payOrder, @NotNull Continuation<? super Boolean> continuation) {
        ...
        if (i2 == 0) {
            ...
            if (payOrder.getIsSubscription()) {
                ...
                oooOo.f12745OooO00o = purchaseToken;
                ...
                oooOo00 = ((Oooo0) objOooO0O0).f12750OooO00o;
                o0000O00.OooO("GooglePay consumeOrderV5 consumePurchase \nbillingResult = " + oooOo00);
            } else if (payOrder.getSubscriptionState() == GooglePaySubscriptionModel.Action.Downgrade.getValue()) {
                oooOo00 = new OooOo00();
                oooOo00.f12746OooO00o = 0;
                oooOo00.f12747OooO0O0 = "";
                ...
                oooO0O0.f12718OooO00o = purchaseToken2;
                Intrinsics.checkNotNullExpressionValue(oooO0O0, "build(...)");
            ...
            if (i2 == 2) {
                ...
                if (payOrder.getIsSubscription()) {
                    ...
                    oooOo2.f12745OooO00o = purchaseToken;
                    ...
                    oooO0O1.f12718OooO00o = purchaseToken2;
                    Intrinsics.checkNotNullExpressionValue(oooO0O1, "build(...)");
    ...
    public final Object OooOO0(boolean z, @NotNull Continuation<? super List<PayOrder>> continuation) throws Throwable {
        ...
        if (i2 == 0) {
            ...
            if (Intrinsics.areEqual(o00o0001.f47168OooO00o, Boxing.boxBoolean(true))) {
                ...
                oooO0o.getClass();
                oooO0o.OooOO0O(o00oo0o2.f12842OooO00o, oooOOO);
                ...
                OooOo00 oooOo00 = o00oo1.f12840OooO00o;
                StringBuilder sb = new StringBuilder("GooglePay 补单V5 有丢单记录1 \n billingResult:");
                sb.append(oooOo00);
                sb.append(" \n purchaseList:");
                list = o00oo1.f12841OooO0O0;
                sb.append(list);
                o0000O00.OooO0O0(sb.toString());
                if (o00oo1.f12840OooO00o.f12746OooO00o == 0) {
                    for (Purchase purchase : list) {
                        OooO00o2 = purchase.OooO00o();
                        if (OooO00o2 != null) {
                            str2 = OooO00o2.f12716OooO00o;
                        } else {
                            str2 = null;
                        }
                        OooO00o3 = purchase.OooO00o();
                        if (OooO00o3 != null) {
                            str3 = OooO00o3.f12717OooO0O0;
                        } else {
                            str3 = null;
                        }
                        if (str2 == null) {
                            ...
                            if (!z2) {
                                ...
                                for (String str4 : arrayListOooO0Oo) {
                                    ...
                                    JSONObject jSONObject = purchase.f12772OooO0OO;
            ...
            if (i2 == 2) {
                ...
                if (Intrinsics.areEqual(o00o0001.f47168OooO00o, Boxing.boxBoolean(true))) {
                    ...
                    oooO0o2.getClass();
                    oooO0o2.OooOO0O(o00oo0o3.f12842OooO00o, oooOOO2);
            ...
            o00oo1 = (o00Oo0) objOooO0O0;
            OooOo00 oooOo01 = o00oo1.f12840OooO00o;
                    ...
                    if (str2 == null) {
                        ...
                        if (!z2) {
                            ...
                            while (r7.hasNext()) {
                                ...
                                JSONObject jSONObject2 = purchase.f12772OooO0OO;
        ...
        o0000O00.OooO0O0("GooglePay 补单V5 有丢单记录2 \n isSubscription:" + z + "\n connected:" + o00o0001 + "\n payOrderList:" + arrayList);
        return arrayList;
    }
}
