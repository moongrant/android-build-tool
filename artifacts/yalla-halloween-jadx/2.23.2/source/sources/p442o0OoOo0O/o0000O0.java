...
public final class o0000O0 extends Lambda implements Function1<SelectImageData, Unit> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ o000OO f47240OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0000O0(o000OO o000oo2) {
        super(1);
        this.f47240OooO0Oo = o000oo2;
    }
    ...
    public final Unit invoke(SelectImageData selectImageData) {
        ...
        if (selectImageData2 != null && (uri = selectImageData2.OooO0O0()) != null) {
            this.f47240OooO0Oo.getClass();
            if (!OooOo00.OooO00o(uri) && MixedRoomDataSource.OooO0o0().f22991OooO0o != null) {
                Intrinsics.checkNotNullParameter(uri, "uri");
                o0000O listener = o0000O.f47239OooO0Oo;
                Intrinsics.checkNotNullParameter(listener, "listener");
                BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), null, null, new o0000O00(uri, listener, null), 3, null);
            }
        }
