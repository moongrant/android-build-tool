...
public final class o000O0O0 implements OooO0o {
    ...
    public final OooO0O0 OooO00o(String str, BarcodeFormat barcodeFormat, EnumMap enumMap) throws WriterException {
        ...
        int[] iArr = o0OO0.OooO0OO.f42243OooO00o;
        if (!zEquals) {
            i5 = 0;
            z6 = false;
            z7 = false;
        ...
        int i10 = o0OO0.OooO0OO.OooO00o.f42244OooO00o[mode.ordinal()];
        if (i10 == 1) {
        ...
        if (enumMap.containsKey(encodeHintType5)) {
            oooO0OOOooO0O0 = OooO0OO.OooO0O0(Integer.parseInt(enumMap.get(encodeHintType5).toString()));
            int iOooO0O0 = mode.OooO0O0(oooO0OOOooO0O0) + oooO00o.f42262OooO0o0 + oooO00o2.f42262OooO0o0;
            OooO0OO.OooO0O0 oooO0O0 = oooO0OOOooO0O0.f42314OooO0O0[errorCorrectionLevelValueOf.ordinal()];
            int i19 = 0;
            for (OooO0OO.OooO00o oooO00o3 : oooO0O0.f42319OooO0O0) {
                i19 += oooO00o3.f42316OooO00o;
            }
            if (!(oooO0OOOooO0O0.f42315OooO0OO - (i19 * oooO0O0.f42318OooO00o) >= (iOooO0O0 + 7) / 8)) {
                throw new WriterException("Data too big for requested version");
            }
        } else {
            int iOooO0O1 = mode.OooO0O0(OooO0OO.OooO0O0(1)) + oooO00o.f42262OooO0o0 + oooO00o2.f42262OooO0o0;
            int i20 = 1;
            while (true) {
                if (i20 > 40) {
                    throw new WriterException("Data too big");
                }
                OooO0OO oooO0OOOooO0O1 = OooO0OO.OooO0O0(i20);
                int i21 = oooO0OOOooO0O1.f42315OooO0OO;
                OooO0OO.OooO0O0 oooO0O1 = oooO0OOOooO0O1.f42314OooO0O0[errorCorrectionLevelValueOf.ordinal()];
                int i22 = 0;
                for (OooO0OO.OooO00o oooO00o4 : oooO0O1.f42319OooO0O0) {
                    i22 += oooO00o4.f42316OooO00o;
                }
                if (i21 - (i22 * oooO0O1.f42318OooO00o) >= (iOooO0O1 + 7) / 8) {
                    int iOooO0O2 = mode.OooO0O0(oooO0OOOooO0O1) + oooO00o.f42262OooO0o0 + oooO00o2.f42262OooO0o0;
                    int i23 = 40;
                    int i24 = 1;
                    while (true) {
                        if (i24 > i23) {
                        ...
                        OooO0OO oooO0OOOooO0O2 = OooO0OO.OooO0O0(i24);
                        int i25 = oooO0OOOooO0O2.f42315OooO0OO;
                        OooO0OO.OooO0O0 oooO0O2 = oooO0OOOooO0O2.f42314OooO0O0[errorCorrectionLevelValueOf.ordinal()];
                        int i26 = 0;
                        for (OooO0OO.OooO00o oooO00o5 : oooO0O2.f42319OooO0O0) {
                            i26 += oooO00o5.f42316OooO00o;
                        }
                        if (i25 - (i26 * oooO0O2.f42318OooO00o) >= (iOooO0O2 + 7) / 8) {
                            oooO0OOOooO0O0 = oooO0OOOooO0O2;
                            break;
                        }
                        i24++;
                        i23 = 40;
        ...
        OooO00o oooO00o6 = new OooO00o();
        int i27 = oooO00o.f42262OooO0o0;
        oooO00o6.OooO0o0(oooO00o6.f42262OooO0o0 + i27);
        for (int i28 = 0; i28 < i27; i28++) {
            oooO00o6.OooO0O0(oooO00o.OooO0o(i28));
        }
        int length5 = mode == Mode.BYTE ? (oooO00o2.f42262OooO0o0 + 7) / 8 : str.length();
        int iOooO0O3 = mode.OooO0O0(oooO0OOOooO0O0);
        int i29 = 1 << iOooO0O3;
        if (length5 >= i29) {
        ...
        int i30 = oooO00o2.f42262OooO0o0;
        oooO00o6.OooO0o0(oooO00o6.f42262OooO0o0 + i30);
        for (int i31 = 0; i31 < i30; i31++) {
            oooO00o6.OooO0O0(oooO00o2.OooO0o(i31));
        }
        OooO0OO.OooO0O0 oooO0O3 = oooO0OOOooO0O0.f42314OooO0O0[errorCorrectionLevelValueOf.ordinal()];
        int i32 = 0;
        for (OooO0OO.OooO00o oooO00o7 : oooO0O3.f42319OooO0O0) {
            i32 += oooO00o7.f42316OooO00o;
        }
        int i33 = i32 * oooO0O3.f42318OooO00o;
        int i34 = oooO0OOOooO0O0.f42315OooO0OO;
        int i35 = i34 - i33;
        int i36 = i35 << 3;
        if (oooO00o6.f42262OooO0o0 > i36) {
            throw new WriterException("data bits cannot fit in the QR Code" + oooO00o6.f42262OooO0o0 + " > " + i36);
        }
        for (int i37 = 0; i37 < 4 && oooO00o6.f42262OooO0o0 < i36; i37++) {
            oooO00o6.OooO0O0(false);
        }
        boolean z8 = false;
        int i38 = oooO00o6.f42262OooO0o0 & 7;
        if (i38 > 0) {
            while (i38 < 8) {
                oooO00o6.OooO0O0(z8);
                i38++;
        ...
        int i39 = i35 - ((oooO00o6.f42262OooO0o0 + 7) / 8);
        ...
        int i41 = 0;
        for (OooO0OO.OooO00o oooO00o8 : oooO0O3.f42319OooO0O0) {
            i41 += oooO00o8.f42316OooO00o;
        }
        if ((oooO00o6.f42262OooO0o0 + 7) / 8 != i35) {
        ...
        while (i42 < i41) {
            ...
            OooO0OO oooO0OO2 = oooO0OOOooO0O0;
            if (i41 != i45 + i44) {
            ...
            new oo0oO0.OooO0OO(oo0oO0.OooO00o.f60347OooOO0O).OooO00o(i63, iArr4);
            byte[] bArr3 = new byte[i63];
            for (int i65 = 0; i65 < i63; i65++) {
                bArr3[i65] = (byte) iArr4[i53 + i65];
            }
            arrayList.add(new o0OO0.OooO00o(bArr2, bArr3));
            ...
            oooO0OOOooO0O0 = oooO0OO2;
            i34 = i61;
        }
        OooO0OO oooO0OO3 = oooO0OOOooO0O0;
        ...
        OooO00o oooO00o9 = new OooO00o();
        for (int i68 = 0; i68 < iMax; i68++) {
            Iterator it = arrayList.iterator();
            while (it.hasNext()) {
                byte[] bArr4 = ((o0OO0.OooO00o) it.next()).f42238OooO00o;
                if (i68 < bArr4.length) {
        ...
        for (int i69 = 0; i69 < iMax2; i69++) {
            ...
            while (it2.hasNext()) {
                byte[] bArr5 = ((o0OO0.OooO00o) it2.next()).f42239OooO0O0;
                if (i69 < bArr5.length) {
                    oooO00o9.OooO0Oo(bArr5[i69], 8);
                }
            }
        }
        if (i67 != (oooO00o9.f42262OooO0o0 + 7) / 8) {
            StringBuilder sbOooO0O0 = o0000O0.OooO0O0("Interleaving error: ", i67, " and ");
            sbOooO0O0.append((oooO00o9.f42262OooO0o0 + 7) / 8);
            sbOooO0O0.append(" differ.");
            throw new WriterException(sbOooO0O0.toString());
        }
        OooO0OO oooO0OO4 = oooO0OO3;
        int i70 = (oooO0OO4.f42313OooO00o * 4) + 17;
        o0OO0.OooO0O0 oooO0O4 = new o0OO0.OooO0O0(i70, i70);
        int i71 = Integer.MAX_VALUE;
        int i72 = 0;
        int i73 = -1;
        while (true) {
            i = oooO0O4.f42242OooO0OO;
            i2 = oooO0O4.f42241OooO0O0;
            if (i72 >= 8) {
                break;
            }
            ErrorCorrectionLevel errorCorrectionLevel3 = errorCorrectionLevel2;
            OooO.OooO00o(oooO00o9, errorCorrectionLevel3, oooO0OO4, i72, oooO0O4);
            int iOooO00o = o0OO0.OooO0o.OooO00o(oooO0O4, false) + o0OO0.OooO0o.OooO00o(oooO0O4, true);
            int i74 = 0;
            int i75 = 0;
            while (true) {
                int i76 = i - 1;
                bArr = oooO0O4.f42240OooO00o;
                if (i74 >= i76) {
                    break;
                }
                byte[] bArr6 = bArr[i74];
        ...
        OooO.OooO00o(oooO00o9, errorCorrectionLevel2, oooO0OO4, i73, oooO0O4);
        int i91 = i66 << 1;
        int i92 = i2 + i91;
        int i93 = i91 + i;
        ...
        OooO0O0 oooO0O5 = new OooO0O0(iMax7, iMax8);
        int i96 = 0;
        while (i96 < i) {
            int i97 = 0;
            int i98 = i94;
            while (i97 < i2) {
                if (oooO0O4.OooO00o(i97, i96) == 1) {
                    oooO0O5.OooO0o0(i98, i95, iMin5, iMin5);
                }
                i97++;
                i98 += iMin5;
            }
