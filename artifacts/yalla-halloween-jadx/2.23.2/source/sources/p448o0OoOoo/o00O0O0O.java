...
public final class o00O0O0O {
    ...
    public static final class OooO00o extends Lambda implements Function3<BoxScope, Composer, Integer, Unit> {
        ...
        public final /* synthetic */ OooOOOO<EventModel> f47413OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(OooOOOO<EventModel> oooOOOO) {
            super(3);
            this.f47413OooO0Oo = oooOOOO;
        }
        ...
        public final Unit invoke(BoxScope boxScope, Composer composer, Integer num) {
            ...
            if ((iIntValue & 81) == 16 && composer2.getSkipping()) {
                ...
                LazyDslKt.LazyColumn(SizeKt.fillMaxSize$default(Modifier.INSTANCE, 0.0f, 1, null), null, null, false, null, null, null, false, new o00O0O0(this.f47413OooO0Oo), composer2, 6, 254);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public static final class OooO0O0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ EventViewModel f47414OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f47415OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(EventViewModel eventViewModel, int i) {
            super(2);
            this.f47414OooO0Oo = eventViewModel;
            this.f47415OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f47415OooO0o0 | 1);
            o00O0O0O.OooO00o(this.f47414OooO0Oo, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final void OooO00o(@NotNull EventViewModel eventVM, @Nullable Composer composer, int i) {
        ...
        if ((i & 1) == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            final OooOOOO oooOOOOOooO00o = o00O0O.OooO00o(eventMineViewModel.getMineEventPager().f38501OooO0oo, composerStartRestartGroup);
            Observable<Object> observable = LiveEventBus.get("EVENT_DELETED");
            Intrinsics.checkNotNullExpressionValue(observable, "get(...)");
            o00O0000.OooO00o(observable, new o00O00o0(eventMineViewModel, 0), composerStartRestartGroup, 72);
            ...
            o00O0000.OooO00o(observable2, new Observer() { // from class: o0OoOoo.oo00o
                ...
                public final void onChanged(Object obj) {
                    ...
                    Iterator<T> it2 = mineEventPager.f38497OooO0Oo.iterator();
                    do {
                        if (!it2.hasNext()) {
                            next = null;
                            break;
                    ...
                    List<EventModel> list = mineEventPager.f38497OooO0Oo;
                    if (eventModel == null) {
                        return;
                    }
            ...
            ComposableLambda composableLambda = o000OO00.f47396OooO00o;
