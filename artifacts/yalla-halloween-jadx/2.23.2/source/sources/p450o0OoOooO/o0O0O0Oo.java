...
public final class o0O0O0Oo {
    ...
    @NotNull
    public static final ComposableLambda f47528OooO00o = ComposableLambdaKt.composableLambdaInstance(-545640121, false, OooO00o.f47530OooO0Oo);

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public static final ComposableLambda f47529OooO0O0 = ComposableLambdaKt.composableLambdaInstance(-688673167, false, OooO0O0.f47531OooO0Oo);
    ...
    public static final class OooO00o extends Lambda implements Function3<Modifier, Composer, Integer, Unit> {
        ...
        public static final OooO00o f47530OooO0Oo = new OooO00o();
        ...
        public final Unit invoke(Modifier modifier, Composer composer, Integer num) {
            ...
            if ((iIntValue & 14) == 0) {
                iIntValue |= composer2.changed(modifier2) ? 4 : 2;
            }
            if ((iIntValue & 91) == 18 && composer2.getSkipping()) {
                composer2.skipToGroupEnd();
            } else {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-545640121, iIntValue, -1, "com.yalla.yalla.module.event.ui.screen.ComposableSingletons$EventRoomPreviewScreenKt.lambda-1.<anonymous> (EventRoomPreviewScreen.kt:249)");
                }
                float fMo326toPx0680j_4 = ((Density) composer2.consume(CompositionLocalsKt.getLocalDensity())).mo326toPx0680j_4(Dp.m3775constructorimpl(8));
                ...
                if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue = new o0O0oo0o(fMo326toPx0680j_4);
    ...
    public static final class OooO0O0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO0O0 f47531OooO0Oo = new OooO0O0();
        ...
        public final Unit invoke(Composer composer, Integer num) {
            ...
            if ((iIntValue & 11) == 2 && composer2.getSkipping()) {
                ...
                o0O00oO0.f51523OooO00o.OooO00o(null, 0.0f, o0000oo.OooO0OO(composer2).f38619OooO0OO, composer2, 0, 3);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
            }
