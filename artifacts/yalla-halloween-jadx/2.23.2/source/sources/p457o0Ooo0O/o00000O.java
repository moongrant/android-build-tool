...
public final class o00000O {
    ...
    public static final class OooO00o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ MutableState<Boolean> f47650OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f47651OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(MutableState<Boolean> mutableState, int i) {
            super(2);
            this.f47650OooO0Oo = mutableState;
            this.f47651OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f47651OooO0o0 | 1);
            o00000O.OooO00o(this.f47650OooO0Oo, composer, iUpdateChangedFlags);
    ...
    public static final void OooO00o(@NotNull MutableState<Boolean> showMergingDialog, @Nullable Composer composer, int i) {
        ...
        if ((i2 & 11) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            o0000O0.OooO00o(showMergingDialog, false, false, null, null, 0, 0, 0.0f, o00000OO.f47652OooO00o, composerStartRestartGroup, (i2 & 14) | 100663728, 248);
            if (ComposerKt.isTraceInProgress()) {
