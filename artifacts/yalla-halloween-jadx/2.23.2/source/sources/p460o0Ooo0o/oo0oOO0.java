...
public final class oo0oOO0 {
    ...
    @NotNull
    public static final oo0oOO0 f47814OooO00o = new oo0oOO0();
    ...
    public static final class OooO00o extends ContinuationImpl {
        ...
        public CameraViewModel f47815OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f47817OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public int f47818OooO0oO;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f47817OooO0o0 = obj;
            this.f47818OooO0oO |= Integer.MIN_VALUE;
            return oo0oOO0.this.OooO00o(null, null, null, this);
        }
    }
    ...
    public final Object OooO00o(@NotNull CameraViewModel cameraViewModel, @NotNull Context context, @NotNull MutableState<PreviewView> mutableState, @NotNull Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof OooO00o) {
            ...
            int i = oooO00o.f47818OooO0oO;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO00o.f47818OooO0oO = i - Integer.MIN_VALUE;
            } else {
        ...
        Object obj = oooO00o.f47817OooO0o0;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = oooO00o.f47818OooO0oO;
        if (i2 == 0) {
            ResultKt.throwOnFailure(obj);
            cameraViewModel.getClass();
            cameraViewModel.f23764OooOO0O.setValue(Boolean.valueOf(!cameraViewModel.OooO0oO()));
            o0oOO.f47775OooO0O0.OooO0O0("showFrontCamera", cameraViewModel.OooO0oO());
            PreviewView value = mutableState.getValue();
            oooO00o.f47815OooO0Oo = cameraViewModel;
            oooO00o.f47818OooO0oO = 1;
            ...
            cameraViewModel = oooO00o.f47815OooO0Oo;
            ResultKt.throwOnFailure(obj);
        }
        cameraViewModel.getClass();
