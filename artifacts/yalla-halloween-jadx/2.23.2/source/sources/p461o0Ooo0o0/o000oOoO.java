...
public final class o000oOoO {
    ...
    public static final class OooO00o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ o00O00OO f47827OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f47828OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(o00O00OO o00o00oo2, int i) {
            super(2);
            this.f47827OooO0Oo = o00o00oo2;
            this.f47828OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f47828OooO0o0 | 1);
            o000oOoO.OooO00o(this.f47827OooO0Oo, composer, iUpdateChangedFlags);
    ...
    public static final class OooO0O0 extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ CoroutineScope f47829OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ o00O00OO f47830OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(CoroutineScope coroutineScope, o00O00OO o00o00oo2) {
            super(0);
            this.f47829OooO0Oo = coroutineScope;
            this.f47830OooO0o0 = o00o00oo2;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            OooOOO.OooO0OO(this.f47829OooO0Oo, new o0OoOo0(this.f47830OooO0o0, null));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0OO extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f47831OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(MutableState<Boolean> mutableState) {
            super(0);
            this.f47831OooO0Oo = mutableState;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            this.f47831OooO0Oo.setValue(Boolean.TRUE);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ o00O00OO f47832OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f47833OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(o00O00OO o00o00oo2, int i) {
            super(2);
            this.f47832OooO0Oo = o00o00oo2;
            this.f47833OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f47833OooO0o0 | 1);
            o000oOoO.OooO00o(this.f47832OooO0Oo, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final void OooO00o(@NotNull o00O00OO previewViewModel, @Nullable Composer composer, int i) {
        ...
        if (!((Boolean) Oooo0.f47821OooO00o.getValue()).booleanValue()) {
            if (ComposerKt.isTraceInProgress()) {
        ...
        float f = previewViewModel.f55985OooOOo / 1000.0f;
        float longValue = previewViewModel.f55986OooOOo0.getLongValue() / 1000.0f;
        float floatValue = previewViewModel.f55979OooOO0O.getFloatValue();
        ...
        long j = o0OOo000.f48285o000ooo;
        float f2 = 80;
        float f3 = 5;
        TextKt.m1261Text4IGK_g(str, PaddingKt.m482paddingqDBjuR0$default(companion, Dp.m3775constructorimpl(f3), Dp.m3775constructorimpl(f2), 0.0f, 0.0f, 12, null), j, TextUnitKt.getSp(10), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composerStartRestartGroup, 3072, 0, 131056);
        MutableState<SelectMusicModel> mutableState = previewViewModel.f55974OooO0o;
        SelectMusicModel value = mutableState.getValue();
        composerStartRestartGroup.startReplaceableGroup(1100293278);
        if (value != null) {
            if (previewViewModel.OooO0OO().f55893OooO00o.getValue().booleanValue()) {
                lValueOf = Long.valueOf(previewViewModel.OooO0OO().f55894OooO0O0.getLongValue());
            } else {
            ...
            long j2 = previewViewModel.f55977OooO0oo;
            p363o0OOo00O.OooO0o oooO0o = o00OOO00.f47803OooO00o;
            boxScopeInstance = boxScopeInstance2;
            composer2 = composerStartRestartGroup;
            TextKt.m1261Text4IGK_g("music length: " + durationMs + "  \nmusic voice: " + iOooO0O0 + " \nrange start: " + lValueOf + " \nrange end: " + j2 + " \ncurrent AudioPlay volume: " + (oooO0o.f43015OooO0Oo ? 0.0f : oooO0o.f43014OooO0OO) + " \n", boxScopeInstance2.align(PaddingKt.m482paddingqDBjuR0$default(companion, 0.0f, Dp.m3775constructorimpl(f2), Dp.m3775constructorimpl(f3), 0.0f, 9, null), companion2.getTopEnd()), j, TextUnitKt.getSp(10), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 3072, 0, 131056);
        } else {
            composer2 = composerStartRestartGroup;
            boxScopeInstance = boxScopeInstance2;
        }
        ...
        ButtonKt.Button(new OooO0O0(coroutineScope, previewViewModel), boxScopeInstance3.align(companion, companion2.getBottomEnd()), false, null, null, null, null, null, null, Oooo000.f47823OooO00o, composer3, 805306368, 508);
        composer3.startReplaceableGroup(-492369756);
        ...
        oo000o.OooO00o(6, composer3, mutableState2, previewViewModel.OooO0Oo().getRealFilePath());
        ...
        composer3.endReplaceableGroup();
        ButtonKt.Button((Function0) objRememberedValue3, boxScopeInstance3.align(companion, companion2.getBottomStart()), false, null, null, null, null, null, null, Oooo000.f47824OooO0O0, composer3, 805306368, 508);
