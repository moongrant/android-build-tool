...
public final class o0O0OOO0 {
    ...
    @NotNull
    public static final o0O0OOO0 f47920OooO00o = new o0O0OOO0();
    ...
    public static final class OooO00o extends ContinuationImpl {
        ...
        public /* synthetic */ Object f47921OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f47922OooO0o;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f47921OooO0Oo = obj;
            this.f47922OooO0o |= Integer.MIN_VALUE;
            return o0O0OOO0.this.OooO00o(this);
        }
    }
    ...
    public static final class OooO0O0 extends ContinuationImpl {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public /* synthetic */ Object f47924OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f47925OooO0o;
        ...
        @Nullable
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f47924OooO0Oo = obj;
            this.f47925OooO0o |= Integer.MIN_VALUE;
            return o0O0OOO0.this.OooO0O0(this);
        }
    }
    ...
    public static final class OooO0OO extends ContinuationImpl {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public /* synthetic */ Object f47927OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f47928OooO0o;
        ...
        @Nullable
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f47927OooO0Oo = obj;
            this.f47928OooO0o |= Integer.MIN_VALUE;
            return o0O0OOO0.this.OooO0OO(0, this);
        }
    }
    ...
    public static final class OooO0o extends ContinuationImpl {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public /* synthetic */ Object f47930OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f47931OooO0o;
        ...
        @Nullable
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f47930OooO0Oo = obj;
            this.f47931OooO0o |= Integer.MIN_VALUE;
            return o0O0OOO0.this.OooO0Oo(0, this);
        }
    }
    ...
    public final Object OooO00o(@NotNull Continuation<? super ApiResult<List<StoreRoomChatBubbleModel>>> continuation) {
        ...
        if (continuation instanceof OooO00o) {
            ...
            int i = oooO00o.f47922OooO0o;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO00o.f47922OooO0o = i - Integer.MIN_VALUE;
            } else {
    ...
    public final Object OooO0O0(@NotNull Continuation<? super ApiResult<List<StoreRoomChatBubbleModel>>> continuation) {
        ...
        if (continuation instanceof OooO0O0) {
            ...
            int i = oooO0O0.f47925OooO0o;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO0O0.f47925OooO0o = i - Integer.MIN_VALUE;
            } else {
        ...
        Object bubbleShopList = oooO0O0.f47924OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = oooO0O0.f47925OooO0o;
        try {
            if (i2 == 0) {
                ResultKt.throwOnFailure(bubbleShopList);
                MainApiService mainApiServiceOooO00o = OooOOO.OooO00o();
                oooO0O0.f47925OooO0o = 1;
    ...
    public final Object OooO0OO(int i, @NotNull Continuation<? super ApiResult<StoreRoomChatBubbleBuyModel>> continuation) {
        ...
        if (continuation instanceof OooO0OO) {
            ...
            int i2 = oooO0OO.f47928OooO0o;
            if ((i2 & Integer.MIN_VALUE) != 0) {
                oooO0OO.f47928OooO0o = i2 - Integer.MIN_VALUE;
            } else {
        ...
        Object objPurchaseBubble = oooO0OO.f47927OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i3 = oooO0OO.f47928OooO0o;
        try {
            if (i3 == 0) {
                ResultKt.throwOnFailure(objPurchaseBubble);
                MainApiService mainApiServiceOooO00o = OooOOO.OooO00o();
                oooO0OO.f47928OooO0o = 1;
    ...
    public final Object OooO0Oo(int i, @NotNull Continuation<? super ApiResult<String>> continuation) {
        ...
        if (continuation instanceof OooO0o) {
            ...
            int i2 = oooO0o.f47931OooO0o;
            if ((i2 & Integer.MIN_VALUE) != 0) {
                oooO0o.f47931OooO0o = i2 - Integer.MIN_VALUE;
            } else {
        ...
        Object obj = oooO0o.f47930OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i3 = oooO0o.f47931OooO0o;
        try {
            if (i3 == 0) {
                ResultKt.throwOnFailure(obj);
                MainApiService mainApiServiceOooO00o = OooOOO.OooO00o();
                oooO0o.f47931OooO0o = 1;
