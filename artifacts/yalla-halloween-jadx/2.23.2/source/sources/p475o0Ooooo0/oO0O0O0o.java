...
public final class oO0O0O0o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f48105OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ EnterRoomParentPage f48106OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ String f48107OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public oO0O0O0o(String str, EnterRoomParentPage enterRoomParentPage, Continuation<? super oO0O0O0o> continuation) {
        super(2, continuation);
        this.f48107OooO0o0 = str;
        this.f48106OooO0o = enterRoomParentPage;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new oO0O0O0o(this.f48107OooO0o0, this.f48106OooO0o, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f48105OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            WebEventRepository webEventRepository = WebEventRepository.f24430OooO00o;
            String str = this.f48107OooO0o0;
            EnterRoomParentPage enterRoomParentPage = this.f48106OooO0o;
            this.f48105OooO0Oo = 1;
