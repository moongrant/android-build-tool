...
public final class Oooo000 {
    ...
    public static void OooO00o(@NotNull String message, boolean z) {
        ...
        if (Intrinsics.areEqual(value, bool)) {
            o0000O00.OooO0OO("FirebaseMessageHandler", "post fromNotification = " + z + " message = " + message);
            FirebaseDataMessage firebaseDataMessage = (FirebaseDataMessage) oOOO00.OooO00o(message, FirebaseDataMessage.class);
            if (firebaseDataMessage != null) {
                ...
                o0000O00.OooO0OO("FirebaseMessageHandler", "data fromNotification = " + z + " type = " + type + "  value = " + info);
                OooO00o.OooO0OO("101090", MapsKt.mapOf(TuplesKt.to("type", Integer.valueOf(type)), TuplesKt.to("source", source), TuplesKt.to("message_id", message_id)));
                if (type == 1002) {
                    if (Intrinsics.areEqual(o0O00oO0.OooOo0O().getValue(), bool) && (friendRequestPushModel = (FriendRequestPushModel) oOOO00.OooO00o(info, FriendRequestPushModel.class)) != null) {
                ...
                if (type == 1003) {
                    if (Intrinsics.areEqual(o0O00oO0.OooOo0O().getValue(), bool) && (activityPushMessageModel = (ActivityPushMessageModel) oOOO00.OooO00o(info, ActivityPushMessageModel.class)) != null) {
                ...
                if (type == 1004) {
                    if (Intrinsics.areEqual(o0O00oO0.OooOo0O().getValue(), bool) && (yallaTeamPushMessageModel = (YallaTeamPushMessageModel) oOOO00.OooO00o(info, YallaTeamPushMessageModel.class)) != null) {
                ...
                if (type != 1005) {
                    if (type == 1006 && Intrinsics.areEqual(o0O00oO0.OooOo0O().getValue(), bool) && (eventPushModel = (EventPushModel) oOOO00.OooO00o(info, EventPushModel.class)) != null) {
                ...
                if (Intrinsics.areEqual(o0O00oO0.OooOo0O().getValue(), bool) && (roomMemberConvenePushModel = (RoomMemberConvenePushModel) oOOO00.OooO00o(info, RoomMemberConvenePushModel.class)) != null) {
                    ...
                    if (l5 != null && receiverId5 == l5.longValue()) {
                        ...
                        o0Oo0oo.OooO0o(roomModel2, null);
                    }
                }
            }
        }
