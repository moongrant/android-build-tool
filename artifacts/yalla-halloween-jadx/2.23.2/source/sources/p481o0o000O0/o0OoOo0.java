...
public final class o0OoOo0 extends OooOo {
    ...
    @NotNull
    public final String f48422OooO00o = "MomentMsgProcessor";
    ...
    public final void OooO0O0(@NotNull MessageIM.Message message, boolean z) {
        ...
        String str = this.f48422OooO00o;
        o0000O00.OooO00o(102, str, "\n动态消息\nMomentMsgProcessor parseMessage message = " + message, null);
        ...
        Intrinsics.checkNotNullParameter(mid, "mid");
        if (OooOo00.OooO0O0(o00Oo0.OooO00o().OooOo().OooO0oO(mid))) {
            return;
        }
        if (o0O00oO0.OooOOo0().getValue() == 0) {
            return;
        }
        int head = message.getHead();
        if (head == 1000) {
            o0000O00.OooO0OO(str, "\n朋友圈评论点赞通知 \nsaveMessage1000 message " + message);
            try {
                ...
                o0000O00.OooO0O0("MomentMessageRepo saveMessage msg:" + momentMessageOooO00o + ZegoConstants.ZegoVideoDataAuxPublishingStream);
                o00Oo0.OooO00o().OooOo().OooOOO(momentMessageOooO00o);
                return;
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        if (head == 1001) {
            ...
            try {
                ...
                o0000O00.OooO0O0("MomentMessageRepo saveMessage msg:" + momentMessageOooO00o2 + ZegoConstants.ZegoVideoDataAuxPublishingStream);
                o00Oo0.OooO00o().OooOo().OooOOO(momentMessageOooO00o2);
                return;
            } catch (Exception e2) {
                e2.printStackTrace();
                return;
        ...
        if (head == 1501) {
            ...
            try {
                ...
                o0000O00.OooO0oo(str, "\n动态被删除 \nsaveMessage1501 \nmessage : " + message + " \nmessageData : " + oOOOOo0O.OooO00o(from3) + "\ndb : " + momentMessageOooO00o3);
                ...
                o00Oo0.OooO00o().OooOo().OooOOO(momentMessageOooO00o3);
                return;
            } catch (Exception e3) {
                e3.printStackTrace();
                return;
        ...
        if (head == 1503) {
            ...
            try {
                ...
                o0000O00.OooO0oo(str, "\n评论加精通知 \nsaveMessage1503 \nmessage : " + message + " \nmessageData : " + oOOOOo0O.OooO00o(from4) + "\ndb : " + momentMessageOooO00o4);
                ...
                o00Oo0.OooO00o().OooOo().OooOOO(momentMessageOooO00o4);
                return;
            } catch (Exception e4) {
                e4.printStackTrace();
                return;
        ...
        if (head == 2117) {
            ...
            try {
                ...
                o0000O00.OooO0O0("MomentMessageRepo saveMessage msg:" + momentMessageOooO00o5 + ZegoConstants.ZegoVideoDataAuxPublishingStream);
                o00Oo0.OooO00o().OooOo().OooOOO(momentMessageOooO00o5);
                return;
            } catch (Exception e5) {
                e5.printStackTrace();
                return;
        ...
        switch (head) {
            case 1003:
                ...
                try {
                    Message.MessageDyToppedAndRemove messageDyToppedAndRemove = (Message.MessageDyToppedAndRemove) Message.MessageDyToppedAndRemove.f33084OooOO0O.parseFrom(message.getBody());
                    if (!OooOo00.OooO00o(messageDyToppedAndRemove)) {
                        ...
                        momentTopicTop.setUserId(messageDyToppedAndRemove.f33090OooO0oo);
                        ...
                        momentTopicTop.setTopicId(messageDyToppedAndRemove.f33086OooO0Oo);
                        ...
                        o0000O00.OooO0O0("MomentMessageRepo saveMessage msg:" + momentMessageOooO00o6 + ZegoConstants.ZegoVideoDataAuxPublishingStream);
                        o00Oo0.OooO00o().OooOo().OooOOO(momentMessageOooO00o6);
                    }
                } catch (Exception e6) {
                    e6.printStackTrace();
                    return;
            ...
            case 1004:
                ...
                try {
                    Message.MessageDyToppedAndRemove messageDyToppedAndRemove2 = (Message.MessageDyToppedAndRemove) Message.MessageDyToppedAndRemove.f33084OooOO0O.parseFrom(message.getBody());
                    if (!OooOo00.OooO00o(messageDyToppedAndRemove2)) {
                        ...
                        momentTopicTopRevoke.setUserId(messageDyToppedAndRemove2.f33090OooO0oo);
                        ...
                        momentTopicTopRevoke.setTopicId(messageDyToppedAndRemove2.f33086OooO0Oo);
                        ...
                        o0000O00.OooO0oo(str, "\n圈子内置顶取消通知 \nsaveMessage1004 \nmessage : " + message + " \nmessageData : " + oOOOOo0O.OooO00o(messageDyToppedAndRemove2) + "\ndb : " + momentMessageOooO00o7);
                        ...
                        o0000O00.OooO0O0(sb3.toString());
                        o00Oo0.OooO00o().OooOo().OooOOO(momentMessageOooO00o7);
                    }
                } catch (Exception e7) {
                    e7.printStackTrace();
                    return;
            ...
            case 1005:
                ...
                try {
                    Message.MessageDyToppedAndRemove messageDyToppedAndRemove3 = (Message.MessageDyToppedAndRemove) Message.MessageDyToppedAndRemove.f33084OooOO0O.parseFrom(message.getBody());
                    if (!OooOo00.OooO00o(messageDyToppedAndRemove3)) {
                        ...
                        momentTopicRemoveOwner.setUserId(messageDyToppedAndRemove3.f33090OooO0oo);
                        ...
                        momentTopicRemoveOwner.setMomentId(messageDyToppedAndRemove3.f33086OooO0Oo);
                        ...
                        o0000O00.OooO0oo(str, "\n圈子内移除通知-圈主移出 \nsaveMessage1005 \nmessage : " + message + " \nmessageData : " + oOOOOo0O.OooO00o(messageDyToppedAndRemove3) + "\ndb : " + momentMessageOooO00o8);
                        ...
                        o0000O00.OooO0O0(sb4.toString());
                        o00Oo0.OooO00o().OooOo().OooOOO(momentMessageOooO00o8);
                    }
                } catch (Exception e8) {
                    e8.printStackTrace();
                    return;
            ...
            case 1006:
                ...
                try {
                    Message.MessageDyToppedAndRemove messageDyToppedAndRemove4 = (Message.MessageDyToppedAndRemove) Message.MessageDyToppedAndRemove.f33084OooOO0O.parseFrom(message.getBody());
                    if (!OooOo00.OooO00o(messageDyToppedAndRemove4)) {
                        ...
                        momentTopicRemoveAdmin.setUserId(messageDyToppedAndRemove4.f33090OooO0oo);
                        ...
                        momentTopicRemoveAdmin.setMomentId(messageDyToppedAndRemove4.f33086OooO0Oo);
                        ...
                        o0000O00.OooO0oo(str, "\n圈子内移除通知-管理员移出 \nsaveMessage1006 \nmessage : " + message + " \nmessageData : " + oOOOOo0O.OooO00o(messageDyToppedAndRemove4) + "\ndb : " + momentMessageOooO00o9);
                        ...
                        o0000O00.OooO0O0(sb5.toString());
                        o00Oo0.OooO00o().OooOo().OooOOO(momentMessageOooO00o9);
                    }
                } catch (Exception e9) {
                    e9.printStackTrace();
                    return;
    ...
    public final void OooO0OO(MessageIM.Message message) throws InvalidProtocolBufferException {
        ...
        MomentMessageCommentModel momentMessageCommentModel = (MomentMessageCommentModel) oOOO00.OooO00o(messageData.getContent(), MomentMessageCommentModel.class);
        o0000O00.OooO0oo(this.f48422OooO00o, "\n朋友圈操作消息 \nsaveMessage2114 \nmessage : " + message + " \nmomentMessageCommentModel : " + momentMessageCommentModel);
                        ...
                        if (lValueOf.longValue() > 0) {
                            ...
                            try {
                                if (!OooOo00.OooO00o(messageData)) {
                                    ...
                                    o0000O00.OooO00o(104, "MomentMsgProcessor - 2114", "\n朋友圈操作消息 - 动态评论/动态回复 被@ - 撤回 \nsaveMessage2114MomentCommentAtRevoke db = " + momentMessageOooO00o, null);
                                    o00OO00O.OooO00o(momentMessageOooO00o);
                                }
                            } catch (Exception e) {
                                e.printStackTrace();
                                return;
            ...
            case -3:
                ...
                try {
                    if (!OooOo00.OooO00o(messageData)) {
                        ...
                        o00OO00O.OooO00o(momentMessageOooO00o2);
                    }
                } catch (Exception e2) {
                    e2.printStackTrace();
                    return;
            ...
            case -2:
                ...
                try {
                    if (!OooOo00.OooO00o(messageData)) {
                        ...
                        o00OO00O.OooO00o(momentMessageOooO00o3);
                    }
                } catch (Exception e3) {
                    e3.printStackTrace();
                    return;
            ...
            case -1:
                ...
                try {
                    if (!OooOo00.OooO00o(messageData)) {
                        ...
                        o00OO00O.OooO00o(momentMessageOooO00o4);
                    }
                } catch (Exception e4) {
                    e4.printStackTrace();
                    return;
            ...
            case 3:
                ...
                try {
                    if (!OooOo00.OooO00o(messageData)) {
                        ...
                        o0000O00.OooO0O0("MomentMessageRepo saveMessage msg:" + momentMessageOooO00o7 + ZegoConstants.ZegoVideoDataAuxPublishingStream);
                        o00Oo0.OooO00o().OooOo().OooOOO(momentMessageOooO00o7);
                    }
                } catch (Exception e7) {
                    e7.printStackTrace();
            ...
            case 4:
                        ...
                        if (lValueOf2.longValue() > 0) {
                            ...
                            try {
                                if (!OooOo00.OooO00o(messageData)) {
                                    ...
                                    o0000O00.OooO0O0("MomentMessageRepo saveMessage msg:" + momentMessageOooO00o8 + ZegoConstants.ZegoVideoDataAuxPublishingStream);
                                    o00Oo0.OooO00o().OooOo().OooOOO(momentMessageOooO00o8);
                                }
                            } catch (Exception e8) {
                                e8.printStackTrace();
                ...
                try {
                    if (!OooOo00.OooO00o(messageData)) {
                        ...
                        o0000O00.OooO0O0("MomentMessageRepo saveMessage msg:" + momentMessageOooO00o9 + ZegoConstants.ZegoVideoDataAuxPublishingStream);
                        o00Oo0.OooO00o().OooOo().OooOOO(momentMessageOooO00o9);
                    }
                } catch (Exception e9) {
                    e9.printStackTrace();
    ...
    public final void OooO0Oo(MessageIM.Message message) {
        ...
        try {
            ...
            o0000O00.OooO0oo(str, "\n动态的评论/回复打赏 \nsaveMessage2125 \nmessage : " + message + " \nmessageData : " + oOOOOo0O.OooO00o(from) + "\ndb : " + momentMessageOooO00o);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public final void OooO0oO(MessageIM.Message message) {
        ...
        try {
            ...
            int iOooO0o0 = com.code.android.util.o0OoOo0.OooO0o0(0, topicGroupCreateOrJoinResult.getType());
            if (iOooO0o0 == 1) {
                LiveEventBus.get("TOPIC_GROUP_RESULT_CREATE").post(Long.valueOf(com.code.android.util.o0OoOo0.OooOO0(topicGroupCreateOrJoinResult.getCircleId())));
            } else if (iOooO0o0 == 2) {
                LiveEventBus.get("TOPIC_GROUP_RESULT_JOIN").post(Long.valueOf(com.code.android.util.o0OoOo0.OooOO0(topicGroupCreateOrJoinResult.getCircleId())));
            }
