...
public final class o00O00 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ List<Long> f48682OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ Room.UserListReply f48683OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00O00(List<Long> list, Room.UserListReply userListReply, Continuation<? super o00O00> continuation) {
        super(2, continuation);
        this.f48682OooO0Oo = list;
        this.f48683OooO0o0 = userListReply;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o00O00(this.f48682OooO0Oo, this.f48683OooO0o0, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        o0000o1.f48495OooO0OO.addAll(this.f48682OooO0Oo);
        o0000o1.f48494OooO0O0.setValue(Boxing.boxInt(this.f48683OooO0o0.getOnline()));
