...
public final class o0 extends Lambda implements Function1<View, Unit> {
    ...
    public final /* synthetic */ TestActivity f48740OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ ScrollableViews f48741OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0(TestActivity testActivity, ScrollableViews scrollableViews) {
        super(1);
        this.f48740OooO0Oo = testActivity;
        this.f48741OooO0o0 = scrollableViews;
    }
    ...
    public final Unit invoke(View view) {
        ...
        TestActivity testActivity = this.f48740OooO0Oo;
        int i = testActivity.f25112OooOo0O;
        ScrollableViews this_apply = this.f48741OooO0o0;
        if (i == 0) {
            this_apply.setDelay(200L);
            Intrinsics.checkNotNullExpressionValue(this_apply, "$this_apply");
            ScrollableViews.OooO00o(this_apply, 1);
            testActivity.f25112OooOo0O++;
        } else if (i == 1) {
