...
public final class o00O0000 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ LoginActivity f48972OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00O0000(LoginActivity loginActivity, Continuation<? super o00O0000> continuation) {
        super(2, continuation);
        this.f48972OooO0Oo = loginActivity;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o00O0000(this.f48972OooO0Oo, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        BaseActivityK.OooOo0o(this.f48972OooO0Oo, null, 0L, 3);
