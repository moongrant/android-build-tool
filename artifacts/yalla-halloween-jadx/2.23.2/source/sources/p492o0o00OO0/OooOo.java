...
public final class OooOo extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ AddTopicListActivity f49097OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooOo(AddTopicListActivity addTopicListActivity) {
        super(0);
        this.f49097OooO0Oo = addTopicListActivity;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        AddTopicListActivity activity = this.f49097OooO0Oo;
        activity.getClass();
