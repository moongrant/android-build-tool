...
public final class o000O0Oo extends Lambda implements Function2<PostDetailHeaderViewTag, Object, Unit> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ MomentDetailActivity f49141OooO0Oo;
    ...
    public o000O0Oo(MomentDetailActivity momentDetailActivity) {
        super(2);
        this.f49141OooO0Oo = momentDetailActivity;
    }
    ...
    public final Unit invoke(PostDetailHeaderViewTag postDetailHeaderViewTag, final Object obj) {
        ...
        if (OooO00o.$EnumSwitchMapping$1[tag.ordinal()] == 1) {
            ...
            final MomentDetailActivity momentDetailActivity = this.f49141OooO0Oo;
            ...
            if ((value == null ? -1 : OooO00o.$EnumSwitchMapping$0[value.ordinal()]) == 1) {
                momentDetailActivity.OooOoO().f44927OooO00o.postDelayed(new Runnable() { // from class: o0o00OO0.o000O0
                    /* JADX WARN: Multi-variable type inference failed */
                    @Override // java.lang.Runnable
                    public final void run() {
                        MomentDetailActivity this$0 = momentDetailActivity;
                        Intrinsics.checkNotNullParameter(this$0, "this$0");
                        PrivateChatVM privateChatVM = (PrivateChatVM) this$0.f25613OooOo0O.getValue();
