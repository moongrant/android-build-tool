...
public final class o000Oo0 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MomentDetailActivity f49149OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o000Oo0(MomentDetailActivity momentDetailActivity) {
        super(0);
        this.f49149OooO0Oo = momentDetailActivity;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        int i = MomentDetailActivity.f25608Oooo0;
        MomentDetailActivity momentDetailActivity = this.f49149OooO0Oo;
        ...
        if (o0OoOo0.OooO00o(momentDetailModel != null ? Boolean.valueOf(MomentStateKt.isSystemDelete(momentDetailModel)) : null)) {
            ...
            if (o0OoOo0.OooO00o(momentDetailModel2 != null ? Boolean.valueOf(MomentStateKt.isApprovedState(momentDetailModel2)) : null)) {
                o000000O.OooO0OO(null, (MomentDetailModel) OooOo.OooO00o(momentDetailActivity), true, momentDetailActivity.OooOooO().getMomentAdapterTag().getValue(), momentDetailActivity, null, true, null, null, momentDetailActivity.OooOooO(), null, false, new o000O0o(momentDetailActivity));
            } else {
