...
public final class o00OO00O extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ MomentReplyActivity f49172OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00OO00O(MomentReplyActivity momentReplyActivity, Continuation<? super o00OO00O> continuation) {
        super(2, continuation);
        this.f49172OooO0Oo = momentReplyActivity;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o00OO00O(this.f49172OooO0Oo, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        MomentReplyActivity momentReplyActivity = this.f49172OooO0Oo;
