...
public final class oOOO0OO0 extends Lambda implements Function1<View, Unit> {
    ...
    public final /* synthetic */ MomentReplyHeaderView f49668OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public oOOO0OO0(MomentReplyHeaderView momentReplyHeaderView) {
        super(1);
        this.f49668OooO0Oo = momentReplyHeaderView;
    }
    ...
    public final Unit invoke(View view) {
        ...
        MomentReplyHeaderView momentReplyHeaderView = this.f49668OooO0Oo;
