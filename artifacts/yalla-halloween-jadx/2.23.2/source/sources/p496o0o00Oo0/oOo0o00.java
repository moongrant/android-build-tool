...
public final class oOo0o00 extends Lambda implements Function1<View, Unit> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ MomentReplyHeaderView f49674OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public oOo0o00(MomentReplyHeaderView momentReplyHeaderView) {
        super(1);
        this.f49674OooO0Oo = momentReplyHeaderView;
    }
    ...
    public final Unit invoke(View view) {
        ...
        MomentReplyHeaderView momentReplyHeaderView = this.f49674OooO0Oo;
