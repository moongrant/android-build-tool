...
public final class o extends Lambda implements Function1<Long, Unit> {
    ...
    public final /* synthetic */ WalletActivity f50326OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o(WalletActivity walletActivity) {
        super(1);
        this.f50326OooO0Oo = walletActivity;
    }

    @Override // kotlin.jvm.functions.Function1
    public final Unit invoke(Long l) {
        long jLongValue = l.longValue();
        WalletActivity walletActivity = this.f50326OooO0Oo;
        if (walletActivity.f26594OooOo0o == 1.0d) {
