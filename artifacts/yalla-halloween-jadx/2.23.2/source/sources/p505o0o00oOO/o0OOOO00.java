...
public final class o0OOOO00 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ VehicleStoreActivity f50365OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0OOOO00(VehicleStoreActivity vehicleStoreActivity) {
        super(0);
        this.f50365OooO0Oo = vehicleStoreActivity;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        int i = PremiumActivity.f26673Oooo0oO;
        VehicleStoreActivity vehicleStoreActivity = this.f50365OooO0Oo;
