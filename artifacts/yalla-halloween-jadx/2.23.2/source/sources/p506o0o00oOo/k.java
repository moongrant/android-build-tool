...
public final class k extends o0OOOO0o {

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final /* synthetic */ UserInfoEditActivity f50420OooO0oO;

    public k(UserInfoEditActivity userInfoEditActivity) {
        this.f50420OooO0oO = userInfoEditActivity;
    }

    @Override // p473o0OoooOo.o0OOOO0o
    public final void OooO00o(@NotNull View view) {
        Intrinsics.checkNotNullParameter(view, "view");
        UserInfoEditActivity context = this.f50420OooO0oO;
        context.OooOoo();
        ArrayList<? extends Parcelable> arrayList = new ArrayList<>();
        List<UserInfo.TagInfo> list = context.f26828OooOoo;
        if (list != null) {
