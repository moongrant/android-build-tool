...
public final class oO0OO00o extends Lambda implements Function1<String, Unit> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ PremiumActivity f50494OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public oO0OO00o(PremiumActivity premiumActivity) {
        super(1);
        this.f50494OooO0Oo = premiumActivity;
    }
    ...
    public final Unit invoke(String str) {
        ...
        if (!(url == null || StringsKt.isBlank(url))) {
            ...
            WebActivity.OooO00o.OooO00o(this.f50494OooO0Oo, webPageInfo);
        }
