...
public final class z0 extends Lambda implements Function1<String, Unit> {
    ...
    public final /* synthetic */ UserWelfareMallActivity f50605OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public z0(UserWelfareMallActivity userWelfareMallActivity) {
        super(1);
        this.f50605OooO0Oo = userWelfareMallActivity;
    }
    ...
    public final Unit invoke(String str) {
        ...
        if (!(str2 == null || StringsKt.isBlank(str2))) {
            ...
            WebActivity.OooO00o.OooO00o(this.f50605OooO0Oo, webPageInfo);
        }
