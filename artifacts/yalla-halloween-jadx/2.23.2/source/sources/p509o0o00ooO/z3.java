...
public final class z3 extends Lambda implements Function1<View, Unit> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ ChatModel f50895OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public z3(ChatModel chatModel) {
        super(1);
        this.f50895OooO0Oo = chatModel;
    }
    ...
    public final Unit invoke(View view) {
        ...
        RoomUserInfoModel newFrom = this.f50895OooO0Oo.getNewFrom();
