...
import p518o0o0O0O0.OooOO0O;
import p590o0oOooo0.oOO0OO;

/* JADX INFO: loaded from: classes4.dex */
@SourceDebugExtension({"SMAP\nFacePanel.kt\nKotlin\n*S Kotlin\n*F\n+ 1 FacePanel.kt\ncom/yalla/yalla/ui/composable/face_panel/FacePanelKt$EmojiFaceList$1$1$1\n+ 2 LazyGridDsl.kt\nandroidx/compose/foundation/lazy/grid/LazyGridDslKt\n*L\n1#1,302:1\n477#2,14:303\n*S KotlinDebug\n*F\n+ 1 FacePanel.kt\ncom/yalla/yalla/ui/composable/face_panel/FacePanelKt$EmojiFaceList$1$1$1\n*L\n259#1:303,14\n*E\n"})
public final class OooOOO0 extends Lambda implements Function1<LazyGridScope, Unit> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ Function1<String, Unit> f51853OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ int f51854OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public OooOOO0(Function1<? super String, Unit> function1, int i) {
        super(1);
        this.f51853OooO0Oo = function1;
        this.f51854OooO0o0 = i;
    }
    ...
    public final Unit invoke(LazyGridScope lazyGridScope) {
        ...
        final List<Pair<String, Integer>> list = oOO0OO.f57220OooO0O0;
        int size = list.size();
        ...
        final int i = this.f51854OooO0o0;
        final Function1<String, Unit> function2 = this.f51853OooO0Oo;
        LazyVerticalGrid.items(size, null, null, function1, ComposableLambdaKt.composableLambdaInstance(1229287273, true, new Function4<LazyGridItemScope, Integer, Composer, Integer, Unit>(list, i, function2) { // from class: com.yalla.yalla.ui.composable.face_panel.FacePanelKt$EmojiFaceList$1$1$1$invoke$$inlined$itemsIndexed$default$4
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ List f27332OooO0Oo;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public final /* synthetic */ Function1 f27333OooO0o0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(4);
                this.f27333OooO0o0 = function2;
            }
            ...
            public final Unit invoke(LazyGridItemScope lazyGridItemScope, Integer num, Composer composer, Integer num2) {
                ...
                if ((i2 & 731) == 146 && composer2.getSkipping()) {
                    ...
                    Pair pair = (Pair) this.f27332OooO0Oo.get(iIntValue);
                    Alignment center = Alignment.INSTANCE.getCenter();
                    Modifier.Companion companion = Modifier.INSTANCE;
                    Modifier modifierOooO0O0 = OooO00o.OooO0O0(48, SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), composer2, 733328855);
                    ...
                    Function2 function2OooO00o = OooO.OooO00o(companion2, composerM1320constructorimpl, measurePolicyRememberBoxMeasurePolicy, composerM1320constructorimpl, currentCompositionLocalMap);
                    ...
                    float f = 6;
                    Modifier modifierClip = ClipKt.clip(SizeKt.m525size3ABfNKs(companion, Dp.m3775constructorimpl(36)), RoundedCornerShapeKt.m729RoundedCornerShape0680j_4(Dp.m3775constructorimpl(f)));
                    composer2.startReplaceableGroup(511388516);
                    Function1 function3 = this.f27333OooO0o0;
                    boolean zChanged = composer2.changed(function3) | composer2.changed(pair);
                    Object objRememberedValue = composer2.rememberedValue();
                    if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                        objRememberedValue = new OooOO0O(function3, pair);
                        composer2.updateRememberedValue(objRememberedValue);
                    }
                    composer2.endReplaceableGroup();
                    ImageKt.Image(painterPainterResource, "", PaddingKt.m478padding3ABfNKs(o0O0O00.OooO0O0(modifierClip, false, false, 100L, false, null, null, null, (Function0) objRememberedValue, 251), Dp.m3775constructorimpl(f)), (Alignment) null, (ContentScale) null, 0.0f, (ColorFilter) null, composer2, 56, 120);
