...
@SourceDebugExtension({"SMAP\nMomentInputCoverReply.kt\nKotlin\n*S Kotlin\n*F\n+ 1 MomentInputCoverReply.kt\ncom/yalla/yalla/ui/composable/moment/MomentInputCoverReplyKt\n+ 2 ViewModel.kt\nandroidx/lifecycle/viewmodel/compose/ViewModelKt\n+ 3 Effects.kt\nandroidx/compose/runtime/EffectsKt\n+ 4 Composables.kt\nandroidx/compose/runtime/ComposablesKt\n+ 5 Composer.kt\nandroidx/compose/runtime/ComposerKt\n+ 6 Effects.kt\nandroidx/compose/runtime/EffectsKt$rememberCoroutineScope$1\n*L\n1#1,89:1\n81#2,11:90\n81#2,11:101\n486#3,4:112\n490#3,2:120\n494#3:126\n25#4:116\n1097#5,3:117\n1100#5,3:123\n486#6:122\n*S KotlinDebug\n*F\n+ 1 MomentInputCoverReply.kt\ncom/yalla/yalla/ui/composable/moment/MomentInputCoverReplyKt\n*L\n30#1:90,11\n31#1:101,11\n32#1:112,4\n32#1:120,2\n32#1:126\n32#1:116\n32#1:117,3\n32#1:123,3\n32#1:122\n*E\n"})
public final class o0O00 {

    public static final class OooO00o extends Lambda implements Function0<Unit> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f52214OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ TempAtVM f52215OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ CoroutineScope f52216OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(TempAtVM tempAtVM, MomentVideoVM momentVideoVM, CoroutineScope coroutineScope) {
            super(0);
            this.f52214OooO0Oo = momentVideoVM;
            this.f52216OooO0o0 = coroutineScope;
            this.f52215OooO0o = tempAtVM;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            o0oo0000.OooO00o.OooO0O0("106117");
            o0O000o0 onLogin = new o0O000o0(this.f52215OooO0o, this.f52214OooO0Oo, this.f52216OooO0o0);
    ...
    public static final class OooO0O0 extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f52217OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(MomentVideoVM momentVideoVM) {
            super(0);
            this.f52217OooO0Oo = momentVideoVM;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            o0oo0000.OooO00o.OooO0O0("106116");
            o0OoO00O onLogin = new o0OoO00O(this.f52217OooO0Oo);
            Intrinsics.checkNotNullParameter(onLogin, "onLogin");
            o0O00oO0 o0o00oo1 = o0O00oO0.f47936OooO00o;
            if (Intrinsics.areEqual(o0O00oO0.OooOo0O().getValue(), Boolean.TRUE)) {
                onLogin.invoke();
    ...
    public static final class OooO0OO extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f52218OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(MomentVideoVM momentVideoVM) {
            super(0);
            this.f52218OooO0Oo = momentVideoVM;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            o0oo0000.OooO00o.OooO0O0("106118");
            o0O00O0o onLogin = new o0O00O0o(this.f52218OooO0Oo);
            Intrinsics.checkNotNullParameter(onLogin, "onLogin");
            o0O00oO0 o0o00oo1 = o0O00oO0.f47936OooO00o;
            if (Intrinsics.areEqual(o0O00oO0.OooOo0O().getValue(), Boolean.TRUE)) {
                onLogin.invoke();
    ...
    public static final class OooO0o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ int f52219OooO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ boolean f52220OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ MutableState<String> f52221OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ boolean f52222OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ Modifier f52223OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ int f52224OooO0oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(boolean z, boolean z2, MutableState<String> mutableState, Modifier modifier, int i, int i2) {
            super(2);
            this.f52220OooO0Oo = z;
            this.f52222OooO0o0 = z2;
            this.f52221OooO0o = mutableState;
            this.f52223OooO0oO = modifier;
            this.f52224OooO0oo = i;
            this.f52219OooO = i2;
        }
        ...
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            o0O00.OooO00o(this.f52220OooO0Oo, this.f52222OooO0o0, this.f52221OooO0o, this.f52223OooO0oO, composer, RecomposeScopeImplKt.updateChangedFlags(this.f52224OooO0oo | 1), this.f52219OooO);
            return Unit.INSTANCE;
        }
    }
    ...
    /* JADX WARN: Instruction removed from duplicated block: B:61:0x00ae, please report this as an issue */
    ...
    public static final void OooO00o(boolean z, boolean z2, @Nullable MutableState<String> mutableState, @Nullable Modifier modifier, @Nullable Composer composer, int i, int i2) {
        ...
        Composer composerStartRestartGroup = composer.startRestartGroup(-1544160524);
        int i7 = i2 & 1;
        if (i7 != 0) {
            i3 = i | 6;
            z3 = z;
            ...
            if (i4 != 0) {
                ...
                if ((i3 & 5851) == 1170 || !composerStartRestartGroup.getSkipping()) {
                    ...
                    if ((i & 1) != 0 || composerStartRestartGroup.getDefaultsInvalid()) {
                        ...
                        boolean z6 = i8 == 0 ? z4 : false;
                        if ((i2 & 4) != 0) {
                            i3 &= -897;
                            mutableStateMutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(o0000.OooO0OO(o000000.hint_say_something), null, 2, null);
                        }
                        if (i4 != 0) {
                    ...
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(-1544160524, i6, -1, "com.yalla.yalla.ui.composable.moment.MomentInputCoverReply (MomentInputCoverReply.kt:28)");
                    }
                    ...
                    composerStartRestartGroup.endReplaceableGroup();
                    o0O000O.OooO00o(z3, z5, mutableState2, new OooO00o(tempAtVM, momentVideoVM, coroutineScope), new OooO0O0(momentVideoVM), new OooO0OO(momentVideoVM), modifier3, composerStartRestartGroup, (i6 & 14) | (i6 & 112) | (i6 & 896) | ((i6 << 9) & 3670016), 0);
                    if (ComposerKt.isTraceInProgress()) {
                ...
                scopeUpdateScopeEndRestartGroup.updateScope(new OooO0o(z3, z5, mutableState2, modifier2, i, i2));
            }
            i3 |= 3072;
            modifier2 = modifier;
            if ((i3 & 5851) == 1170) {
                ...
                composerStartRestartGroup.endReplaceableGroup();
                o0O000O.OooO00o(z3, z5, mutableState2, new OooO00o(tempAtVM2, momentVideoVM, coroutineScope2), new OooO0O0(momentVideoVM), new OooO0OO(momentVideoVM), modifier3, composerStartRestartGroup, (i6 & 14) | (i6 & 112) | (i6 & 896) | ((i6 << 9) & 3670016), 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier2 = modifier3;
                ...
                composerStartRestartGroup.endReplaceableGroup();
                o0O000O.OooO00o(z3, z5, mutableState2, new OooO00o(tempAtVM3, momentVideoVM, coroutineScope3), new OooO0O0(momentVideoVM), new OooO0OO(momentVideoVM), modifier3, composerStartRestartGroup, (i6 & 14) | (i6 & 112) | (i6 & 896) | ((i6 << 9) & 3670016), 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier2 = modifier3;
        ...
        if (i4 != 0) {
            ...
            if ((i3 & 5851) == 1170) {
                ...
                composerStartRestartGroup.endReplaceableGroup();
                o0O000O.OooO00o(z3, z5, mutableState2, new OooO00o(tempAtVM4, momentVideoVM, coroutineScope4), new OooO0O0(momentVideoVM), new OooO0OO(momentVideoVM), modifier3, composerStartRestartGroup, (i6 & 14) | (i6 & 112) | (i6 & 896) | ((i6 << 9) & 3670016), 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier2 = modifier3;
                ...
                composerStartRestartGroup.endReplaceableGroup();
                o0O000O.OooO00o(z3, z5, mutableState2, new OooO00o(tempAtVM5, momentVideoVM, coroutineScope5), new OooO0O0(momentVideoVM), new OooO0OO(momentVideoVM), modifier3, composerStartRestartGroup, (i6 & 14) | (i6 & 112) | (i6 & 896) | ((i6 << 9) & 3670016), 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier2 = modifier3;
        ...
        if ((i3 & 5851) == 1170) {
            ...
            composerStartRestartGroup.endReplaceableGroup();
            o0O000O.OooO00o(z3, z5, mutableState2, new OooO00o(tempAtVM6, momentVideoVM, coroutineScope6), new OooO0O0(momentVideoVM), new OooO0OO(momentVideoVM), modifier3, composerStartRestartGroup, (i6 & 14) | (i6 & 112) | (i6 & 896) | ((i6 << 9) & 3670016), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier2 = modifier3;
            ...
            composerStartRestartGroup.endReplaceableGroup();
            o0O000O.OooO00o(z3, z5, mutableState2, new OooO00o(tempAtVM7, momentVideoVM, coroutineScope7), new OooO0O0(momentVideoVM), new OooO0OO(momentVideoVM), modifier3, composerStartRestartGroup, (i6 & 14) | (i6 & 112) | (i6 & 896) | ((i6 << 9) & 3670016), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier2 = modifier3;
