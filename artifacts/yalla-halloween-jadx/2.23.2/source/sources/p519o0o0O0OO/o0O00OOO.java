...
public final class o0O00OOO extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MomentVideoVM f52267OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ TempAtVM f52268OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ CoroutineScope f52269OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0O00OOO(TempAtVM tempAtVM, MomentVideoVM momentVideoVM, CoroutineScope coroutineScope) {
        super(0);
        this.f52267OooO0Oo = momentVideoVM;
        this.f52269OooO0o0 = coroutineScope;
        this.f52268OooO0o = tempAtVM;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        MomentVideoVM momentVideoVM = this.f52267OooO0Oo;
        ...
        if (o0OoOo0.OooO00o(currentMomentDetail != null ? Boolean.valueOf(MomentStateKt.isApprovedState(currentMomentDetail)) : null)) {
            MomentVideoVM.toInputCommentOrReply$default(this.f52267OooO0Oo, null, null, false, 4, null);
            int i = AtFriendsActivity.f25165OooOooO;
            AtFriendsActivity.OooO00o.OooO00o(new o0O00OO(this.f52268OooO0o, momentVideoVM, this.f52269OooO0o0));
