...
public final class o0O00oO0 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MomentVideoVM f52340OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0O00oO0(MomentVideoVM momentVideoVM) {
        super(0);
        this.f52340OooO0Oo = momentVideoVM;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        MomentVideoVM momentVideoVM = this.f52340OooO0Oo;
        ...
        if (o0OoOo0.OooO00o(currentMomentDetail != null ? Boolean.valueOf(MomentStateKt.isApprovedState(currentMomentDetail)) : null)) {
            MomentVideoVM.toInputCommentOrReply$default(this.f52340OooO0Oo, null, null, false, 4, null);
