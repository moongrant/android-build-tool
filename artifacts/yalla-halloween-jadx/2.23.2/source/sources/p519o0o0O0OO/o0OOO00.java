...
public final class o0OOO00 {
    ...
    public static final class OooO00o extends Lambda implements Function1<DrawScope, Unit> {
        ...
        public final /* synthetic */ Drawable f52542OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(Drawable drawable) {
            super(1);
            this.f52542OooO0Oo = drawable;
        }
        ...
        public final Unit invoke(DrawScope drawScope) {
            ...
            Drawable drawable = this.f52542OooO0Oo;
            if (drawable != null) {
    ...
    public static final class OooO0O0 extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ boolean f52543OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ Context f52544OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MomentDetailModel f52545OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(boolean z, MomentDetailModel momentDetailModel, Context context) {
            super(0);
            this.f52543OooO0Oo = z;
            this.f52545OooO0o0 = momentDetailModel;
            this.f52544OooO0o = context;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            String circleName;
            if (!this.f52543OooO0Oo) {
                MomentDetailModel momentDetailModel = this.f52545OooO0o0;
                ...
                if ((content != null ? content.getCircleId() : 0L) > 0) {
                    ...
                    TopicDetailActivity.OooO00o.OooO00o(this.f52544OooO0o, topicInfoModel);
                }
            }
            return Unit.INSTANCE;
        }
    ...
    public static final class OooO0OO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Modifier f52546OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f52547OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MomentDetailModel f52548OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f52549OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(Modifier modifier, MomentDetailModel momentDetailModel, int i, int i2) {
            super(2);
            this.f52546OooO0Oo = modifier;
            this.f52548OooO0o0 = momentDetailModel;
            this.f52547OooO0o = i;
            this.f52549OooO0oO = i2;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f52547OooO0o | 1);
            MomentDetailModel momentDetailModel = this.f52548OooO0o0;
            int i = this.f52549OooO0oO;
            o0OOO00.OooO0O0(this.f52546OooO0Oo, momentDetailModel, composer, iUpdateChangedFlags, i);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final void OooO00o(int i, int i2, @Nullable Composer composer, @Nullable Modifier modifier) {
        ...
        if ((i3 & 11) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(309696291, i3, -1, "com.yalla.yalla.ui.composable.moment.MomentTopicEnterComp (MomentTopicEnterComp.kt:41)");
            }
            if (((Boolean) composerStartRestartGroup.consume(oo0OOoo.f52734OooO0o)).booleanValue()) {
                ...
                scopeUpdateScopeEndRestartGroup.updateScope(new o0OO0oO0(modifier, i, i2));
                return;
            }
            ...
            if (((momentAdapterTag == MomentAdapterTag.TopicDetailFragmentPopular || momentAdapterTag == MomentAdapterTag.TopicDetailFragmentLatest || momentAdapterTag == MomentAdapterTag.PostDetailActivity || ((Boolean) composerStartRestartGroup.consume(oo0OOoo.f52730OooO00o)).booleanValue()) ? false : true) && momentDetailModel.getContent() != null) {
                MomentSendContentModel content = momentDetailModel.getContent();
        ...
        scopeUpdateScopeEndRestartGroup2.updateScope(new o0OO(modifier, i, i2));
    }
    ...
    public static final void OooO0O0(Modifier modifier, MomentDetailModel momentDetailModel, Composer composer, int i, int i2) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-931640365, i, -1, "com.yalla.yalla.ui.composable.moment.MomentTopicEnterContent (MomentTopicEnterComp.kt:65)");
        }
        Context context = (Context) composerStartRestartGroup.consume(AndroidCompositionLocals_androidKt.getLocalContext());
        composerStartRestartGroup.startReplaceableGroup(-492369756);
        Object objRememberedValue = composerStartRestartGroup.rememberedValue();
        if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
            int i3 = o0O0O00.ic_moment_topic_enter_bg;
        ...
        Modifier modifierOooO0O0 = com.code.android.util.o0O0O00.OooO0O0(PaddingKt.m480paddingVpY3zN4$default(DrawModifierKt.drawBehind(ClipKt.clip(SizeKt.m511height3ABfNKs(companion.then(modifier2), Dp.m3775constructorimpl(27)), RoundedCornerShapeKt.getCircleShape()), new OooO00o((Drawable) objRememberedValue)), Dp.m3775constructorimpl(8), 0.0f, 2, null), false, false, 0L, false, null, null, null, new OooO0O0(zBooleanValue, momentDetailModel, context), 253);
        ...
        float f = 15;
        ImageKt.Image(PainterResources_androidKt.painterResource(o0O0O00.ic_moment_topic_enter, composerStartRestartGroup, 0), (String) null, SizeKt.m525size3ABfNKs(companion, Dp.m3775constructorimpl(f)), (Alignment) null, (ContentScale) null, 0.0f, (ColorFilter) null, composerStartRestartGroup, 440, 120);
        MomentSendContentModel content = momentDetailModel.getContent();
        if (content == null || (circleName = content.getCircleName()) == null) {
            circleName = "";
        }
        Modifier modifier3 = modifier2;
        TextKt.m1261Text4IGK_g(circleName, SizeKt.m532widthInVpY3zN4$default(PaddingKt.m482paddingqDBjuR0$default(companion, Dp.m3775constructorimpl(6), 0.0f, 0.0f, 0.0f, 14, null), Dp.m3775constructorimpl(24), 0.0f, 2, null), ColorKt.Color(4278239411L), TextUnitKt.getSp(11), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, new TextStyle(0L, 0L, (FontWeight) null, (FontStyle) null, (FontSynthesis) null, (FontFamily) null, (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (DrawStyle) null, (TextAlign) null, (TextDirection) null, 0L, (TextIndent) null, new PlatformTextStyle(false), (LineHeightStyle) null, (LineBreak) null, (Hyphens) null, (TextMotion) null, 16252927, (DefaultConstructorMarker) null), composerStartRestartGroup, 3504, 0, 65520);
        ImageKt.Image(PainterResources_androidKt.painterResource(o0O0O00.ic_moment_topic_enter_arrow, composerStartRestartGroup, 0), (String) null, com.code.android.util.o0O0O00.OooO0Oo(SizeKt.m525size3ABfNKs(PaddingKt.m482paddingqDBjuR0$default(companion, Dp.m3775constructorimpl(2), 0.0f, 0.0f, 0.0f, 14, null), Dp.m3775constructorimpl(f)), composerStartRestartGroup, 6), (Alignment) null, (ContentScale) null, 0.0f, (ColorFilter) null, composerStartRestartGroup, 56, 120);
