...
public final class o0OoO00O extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MomentVideoVM f52570OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0OoO00O(MomentVideoVM momentVideoVM) {
        super(0);
        this.f52570OooO0Oo = momentVideoVM;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        MomentVideoVM momentVideoVM = this.f52570OooO0Oo;
