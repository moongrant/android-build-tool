...
public final class oo0ooO {
    ...
    public static final class OooO00o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ Modifier f52863OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f52864OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ EnterRoomParentPage f52865OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f52866OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(Modifier modifier, EnterRoomParentPage enterRoomParentPage, int i, int i2) {
            super(2);
            this.f52863OooO0Oo = modifier;
            this.f52865OooO0o0 = enterRoomParentPage;
            this.f52864OooO0o = i;
            this.f52866OooO0oO = i2;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f52864OooO0o | 1);
            oo0ooO.OooO00o(this.f52863OooO0Oo, this.f52865OooO0o0, composer, iUpdateChangedFlags, this.f52866OooO0oO);
    ...
    public static final class OooO0O0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Modifier f52867OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f52868OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ EnterRoomParentPage f52869OooO0o0;
        ...
        public OooO0O0(Modifier modifier, EnterRoomParentPage enterRoomParentPage, int i, int i2) {
            super(2);
            this.f52867OooO0Oo = modifier;
            this.f52869OooO0o0 = enterRoomParentPage;
            this.f52868OooO0o = i;
            this.f52870OooO0oO = i2;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f52868OooO0o | 1);
            oo0ooO.OooO00o(this.f52867OooO0Oo, this.f52869OooO0o0, composer, iUpdateChangedFlags, this.f52870OooO0oO);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final void OooO00o(@Nullable Modifier modifier, @Nullable EnterRoomParentPage enterRoomParentPage, @Nullable Composer composer, int i, int i2) {
        ...
        if ((i3 & 91) == 18 && composerStartRestartGroup.getSkipping()) {
            ...
            if (!MomentTypeKt.isSupportMomentType(momentDetailModel)) {
                o0OO00o0.OooO00o(modifier, StringResources_androidKt.stringResource(o000000.moment_content_not_support, composerStartRestartGroup, 0), true, composerStartRestartGroup, (i3 & 14) | 384, 0);
            ...
            if (momentDetailModel.getIsForward() && momentDetailModel.getDeleteType() == MomentTypeDelete.FORWARD.getValue()) {
                ...
                o0OO00o0.OooO00o(modifier, StringResources_androidKt.stringResource(o000000.This_moment_has_been_deleted, composerStartRestartGroup, 0), false, composerStartRestartGroup, i3 & 14, 4);
                composerStartRestartGroup.endReplaceableGroup();
                ...
                o0OO00o0.OooO00o(modifier, StringResources_androidKt.stringResource(o000000.event_has_been_deleted, composerStartRestartGroup, 0), false, composerStartRestartGroup, i3 & 14, 4);
                composerStartRestartGroup.endReplaceableGroup();
                ...
                o0OO00OO.OooO00o(modifier, forwardContent, enterRoomParentPage, composerStartRestartGroup, (i3 & 14) | 64 | ((i3 << 3) & 896), 0);
                composerStartRestartGroup.endReplaceableGroup();
