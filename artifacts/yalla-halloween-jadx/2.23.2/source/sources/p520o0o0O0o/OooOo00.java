...
public final class OooOo00 {
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public int f52880OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ o000oOoO f52881OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(o000oOoO o000oooo2, Continuation<? super OooO00o> continuation) {
            super(2, continuation);
            this.f52881OooO0o0 = o000oooo2;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO00o(this.f52881OooO0o0, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f52880OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                o000oOoO o000oooo2 = this.f52881OooO0o0;
                if (!((Boolean) o000oooo2.f52898OooO0o0.getValue()).booleanValue()) {
                    this.f52880OooO0Oo = 1;
                    Object objMutate$default = MutatorMutex.mutate$default(o000oooo2.f52895OooO0O0, null, new Oooo000(o000oooo2, 0.0f, null), this, 1, null);
    ...
    public static final class OooO0O0 extends Lambda implements Function1<LayoutCoordinates, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MutableState<Integer> f52882OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(MutableState<Integer> mutableState) {
            super(1);
            this.f52882OooO0Oo = mutableState;
        }
        ...
        public final Unit invoke(LayoutCoordinates layoutCoordinates) {
            ...
            this.f52882OooO0Oo.setValue(Integer.valueOf(IntSize.m3934getHeightimpl(it.mo2811getSizeYbymL2g())));
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0OO extends Lambda implements Function1<Density, IntOffset> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ o000oOoO f52883OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(o000oOoO o000oooo2) {
            super(1);
            this.f52883OooO0Oo = o000oooo2;
        }
        ...
        public final IntOffset invoke(Density density) {
            ...
            return IntOffset.m3884boximpl(IntOffsetKt.IntOffset(0, (int) this.f52883OooO0Oo.f52894OooO00o.getValue().floatValue()));
        }
    }
    ...
    public static final class OooO0o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Modifier f52884OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f52885OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ Function2<Composer, Integer, Unit> f52886OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f52887OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public OooO0o(Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, int i, int i2) {
            super(2);
            this.f52884OooO0Oo = modifier;
            this.f52886OooO0o0 = function2;
            this.f52885OooO0o = i;
            this.f52887OooO0oO = i2;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f52885OooO0o | 1);
            OooOo00.OooO00o(this.f52884OooO0Oo, this.f52886OooO0o0, composer, iUpdateChangedFlags, this.f52887OooO0oO);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final void OooO00o(@Nullable Modifier modifier, @NotNull Function2<? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, int i, int i2) {
        ...
        if ((i3 & 91) == 18 && composerStartRestartGroup.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1066139866, i3, -1, "com.yalla.yalla.ui.composable.refresh.SwipeLayout (SwipeLayout.kt:20)");
            }
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(665005425, 0, -1, "com.yalla.yalla.ui.composable.refresh.rememberSwipeRefreshState (SwipeState.kt:13)");
            }
            composerStartRestartGroup.startReplaceableGroup(-492369756);
            Object objRememberedValue2 = composerStartRestartGroup.rememberedValue();
            if (objRememberedValue2 == companion.getEmpty()) {
                objRememberedValue2 = new o000oOoO(fIntValue, fIntValue2);
                composerStartRestartGroup.updateRememberedValue(objRememberedValue2);
            }
            composerStartRestartGroup.endReplaceableGroup();
            o000oOoO o000oooo2 = (o000oOoO) objRememberedValue2;
            o000oooo2.f52897OooO0Oo.setValue(Float.valueOf(fIntValue));
            o000oooo2.f52896OooO0OO.setValue(Float.valueOf(fIntValue2));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            composerStartRestartGroup.endReplaceableGroup();
            Boolean boolValueOf = Boolean.valueOf(((Boolean) o000oooo2.f52898OooO0o0.getValue()).booleanValue());
            composerStartRestartGroup.startReplaceableGroup(1157296644);
            boolean zChanged = composerStartRestartGroup.changed(o000oooo2);
            Object objRememberedValue3 = composerStartRestartGroup.rememberedValue();
            if (zChanged || objRememberedValue3 == companion.getEmpty()) {
                objRememberedValue3 = new OooO00o(o000oooo2, null);
            ...
            boolean zChanged2 = composerStartRestartGroup.changed(o000oooo2) | composerStartRestartGroup.changed(coroutineScopeOooO00o);
            Object objRememberedValue4 = composerStartRestartGroup.rememberedValue();
            if (zChanged2 || objRememberedValue4 == companion.getEmpty()) {
                objRememberedValue4 = new OooOo(o000oooo2, coroutineScopeOooO00o);
                composerStartRestartGroup.updateRememberedValue(objRememberedValue4);
            }
            composerStartRestartGroup.endReplaceableGroup();
            OooOo oooOo = (OooOo) objRememberedValue4;
            oooOo.getClass();
            Modifier modifierNestedScroll$default = NestedScrollModifierKt.nestedScroll$default(modifier3, oooOo, null, 2, null);
            ...
            composerStartRestartGroup.endReplaceableGroup();
            BoxKt.Box(SizeKt.m511height3ABfNKs(OnGloballyPositionedModifierKt.onGloballyPositioned(companion4, (Function1) objRememberedValue5), Dp.m3775constructorimpl(40)), composerStartRestartGroup, 0);
            composerStartRestartGroup.startReplaceableGroup(1157296644);
            boolean zChanged4 = composerStartRestartGroup.changed(o000oooo2);
            Object objRememberedValue6 = composerStartRestartGroup.rememberedValue();
            if (zChanged4 || objRememberedValue6 == companion.getEmpty()) {
                objRememberedValue6 = new OooO0OO(o000oooo2);
