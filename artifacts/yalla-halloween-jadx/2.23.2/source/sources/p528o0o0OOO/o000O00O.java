...
public final class o000O00O {
    ...
    @NotNull
    public static final ComposableLambda f53348OooO00o = ComposableLambdaKt.composableLambdaInstance(159473290, false, OooO00o.f53349OooO0Oo);
    ...
    public static final class OooO00o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public static final OooO00o f53349OooO0Oo = new OooO00o();
        ...
        public final Unit invoke(Composer composer, Integer num) {
            ...
            if ((iIntValue & 11) == 2 && composer2.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(159473290, iIntValue, -1, "com.yalla.yalla.ui.fragment.moment.ComposableSingletons$MainMomentFollowingFragmentKt.lambda-1.<anonymous> (MainMomentFollowingFragment.kt:127)");
                }
                ...
                if (momentFollowingVM.getShowRecommendTop().getValue().booleanValue() || (!momentFollowingVM.getHeadUserList().isEmpty())) {
                    z0.f57313OooO00o.OooO00o(70, 0, composer2, SizeKt.m511height3ABfNKs(companion, Dp.m3775constructorimpl(84)));
                    Context context = (Context) composer2.consume(AndroidCompositionLocals_androidKt.getLocalContext());
                    composer2.startReplaceableGroup(-492369756);
                    Object objRememberedValue = composer2.rememberedValue();
                    if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
                        int i = momentFollowingVM.getShowRecommendTop().getValue().booleanValue() ? o0O0O00.ic_moment_following_top_recommend_bg : o0O0O00.ic_moment_following_top_user_container_bg;
                    ...
                    float f = 0;
                    Modifier modifierDrawBehind = DrawModifierKt.drawBehind(SizeKt.m511height3ABfNKs(SizeKt.fillMaxWidth$default(PaddingKt.m479paddingVpY3zN4(companion, Dp.m3775constructorimpl(f), Dp.m3775constructorimpl(f)), 0.0f, 1, null), Dp.m3775constructorimpl(momentFollowingVM.getShowRecommendTop().getValue().booleanValue() ? 87 : 122)), new o000O00(drawable));
                    composer2.startReplaceableGroup(733328855);
