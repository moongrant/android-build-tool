...
public abstract class o000O0 {
    ...
    public static final class OooO00o extends Lambda implements Function1<Lifecycle.Event, Unit> {
        ...
        public final Unit invoke(Lifecycle.Event event) {
            ...
            o0000O00.OooO0O0("ActivityTask screen " + o000O0.this.routerName() + " event = " + event2);
    ...
    public static final class OooO0O0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ int f53482OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(int i) {
            super(2);
            this.f53482OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f53482OooO0o0 | 1);
            o000O0.this.OnScreen(composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public final void OnScreen(@Nullable Composer composer, int i) {
        ...
        if ((i2 & 11) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            o0oOO.OooO00o(o0ooo0o1.f56520OooO00o, (String) o0ooo0o1.f56521OooO0O0.getValue(), false, composerStartRestartGroup, 8, 4);
            o00000OO.OooO0O0(false, composerStartRestartGroup, 0, 1);
            Modifier modifierM171backgroundbw27NRU$default = BackgroundKt.m171backgroundbw27NRU$default(SizeKt.fillMaxSize$default(Modifier.INSTANCE, 0.0f, 1, null), mo4200getWindowBackgroundColorWaAFU9c(composerStartRestartGroup, i2 & 14), null, 2, null);
    ...
    public long mo4200getWindowBackgroundColorWaAFU9c(@Nullable Composer composer, int i) {
        ...
        long j = o0000oo.OooO0OO(composer).f38618OooO0O0;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
