...
import p535o0o0Oo0.o0O;
import p535o0o0Oo0.o0O0o0;
import p535o0o0Oo0.o0O0oo00;
import p535o0o0Oo0.o0oOo0O0;
...
public final class o0O0OOOo {
    ...
    @NotNull
    public static final o0O0OOOo f53714OooO00o = new o0O0OOOo();
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final /* synthetic */ RefreshState f53715OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f53716OooO0o0;
        ...
        public OooO00o(RefreshState refreshState, MomentVideoVM momentVideoVM, Continuation<? super OooO00o> continuation) {
            ...
            this.f53715OooO0Oo = refreshState;
            this.f53716OooO0o0 = momentVideoVM;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO00o(this.f53715OooO0Oo, this.f53716OooO0o0, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (this.f53715OooO0Oo.OooO0OO() == RefreshState.State.Null) {
                this.f53716OooO0o0.refreshMomentDetail();
            }
    ...
    public static final class OooO0O0 extends Lambda implements Function3<BoxScope, Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ LazyListState f53717OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ OooOOOO<MomentGift> f53718OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(LazyListState lazyListState, OooOOOO<MomentGift> oooOOOO) {
            super(3);
            this.f53717OooO0Oo = lazyListState;
            this.f53718OooO0o0 = oooOOOO;
        }
        ...
        public final Unit invoke(BoxScope boxScope, Composer composer, Integer num) {
            ...
            if ((iIntValue & 81) == 16 && composer2.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(1981293371, iIntValue, -1, "com.yalla.yalla.ui.screen.moment.media.MomentCommentDialogGifts.Content.<anonymous>.<anonymous> (MomentCommentDialogGifts.kt:91)");
                }
                LazyDslKt.LazyColumn(SizeKt.fillMaxSize$default(Modifier.INSTANCE, 0.0f, 1, null), this.f53717OooO0Oo, null, false, null, null, null, false, new o0O0o000(this.f53718OooO0o0), composer2, 6, 252);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public static final class OooO0OO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ int f53720OooO0o;
        ...
        public OooO0OO(int i, int i2) {
            ...
            this.f53720OooO0o = i2;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f53720OooO0o | 1);
            o0O0OOOo.this.OooO00o(this.f53721OooO0o0, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f53723OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f53724OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(int i, int i2) {
            super(2);
            this.f53724OooO0o0 = i;
            this.f53723OooO0o = i2;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f53723OooO0o | 1);
            o0O0OOOo.this.OooO00o(this.f53724OooO0o0, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }

    public static final void OooO0O0(o0O0OOOo o0o0oooo, Composer composer, int i) {
        o0o0oooo.getClass();
        ...
        if ((i & 1) == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            if ((currentMomentDetail != null ? currentMomentDetail.getTotalPropValue() : 0L) <= 0) {
                ...
                scopeUpdateScopeEndRestartGroup.updateScope(new o0O0o00O(o0o0oooo, i));
                return;
            }
            ...
            LayoutKt.MultiMeasureLayout(SemanticsModifierKt.semantics$default(modifierM171backgroundbw27NRU$default, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: com.yalla.yalla.ui.screen.moment.media.MomentCommentDialogGifts$ItemTitle$$inlined$ConstraintLayout$1
                {
                    super(1);
                }
                ...
                public final Unit invoke(Composer composer2, Integer num) {
                    ...
                    if (((num.intValue() & 11) ^ 2) == 0 && composer3.getSkipping()) {
                        ...
                        String strStringResource = StringResources_androidKt.stringResource(o000000.XXX_gift_value, composer3, 0);
                        String[] strArr = new String[1];
                        MomentDetailModel currentMomentDetail2 = momentVideoVM.getCurrentMomentDetail();
                        String strOooO0o = o0O0O0Oo.OooO0o(o0OoOo0.OooOO0(currentMomentDetail2 != null ? Long.valueOf(currentMomentDetail2.getTotalPropValue()) : null), false);
                        Intrinsics.checkNotNullExpressionValue(strOooO0o, "formatNumberToKMUnit(...)");
                        strArr[0] = strOooO0o;
                        String strOooO00o = i5.OooO00o(strStringResource, strArr);
                        long sp = TextUnitKt.getSp(14);
                        long j3 = o0000oo.OooO0OO(composer3).f38627OooOO0o;
                        Modifier.Companion companion2 = Modifier.INSTANCE;
                        float f = 16;
                        TextKt.m1261Text4IGK_g(strOooO00o, PaddingKt.m480paddingVpY3zN4$default(ConstraintLayoutScope.OooO00o(companion2, o0ooOooO00o, o0O0o0.f53727OooO0Oo), Dp.m3775constructorimpl(f), 0.0f, 2, null), j3, sp, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer3, 3072, 0, 131056);
                        Modifier modifierM478padding3ABfNKs = PaddingKt.m478padding3ABfNKs(BackgroundKt.m171backgroundbw27NRU$default(ClipKt.clip(SizeKt.m511height3ABfNKs(PaddingKt.m480paddingVpY3zN4$default(ConstraintLayoutScope.OooO00o(companion2, o0ooOooO0O0, o0oOo0O0.f53836OooO0Oo), Dp.m3775constructorimpl(f), 0.0f, 2, null), Dp.m3775constructorimpl(30)), RoundedCornerShapeKt.RoundedCornerShape(50)), o0OOo000.f48272o000o0o0, null, 2, null), Dp.m3775constructorimpl(3));
                        composer3.startReplaceableGroup(693286680);
                        Arrangement.Horizontal start = Arrangement.INSTANCE.getStart();
                        Alignment.Companion companion3 = Alignment.INSTANCE;
                        MeasurePolicy measurePolicyOooO00o = androidx.compose.material.OooOO0O.OooO00o(companion3, start, composer3, 0, -1323940314);
                        ...
                        float f2 = 24;
                        Modifier modifierClip = ClipKt.clip(SizeKt.m511height3ABfNKs(companion2, Dp.m3775constructorimpl(f2)), RoundedCornerShapeKt.RoundedCornerShape(50));
                        MomentGiftsVM momentGiftsVM2 = momentGiftsVM;
                        float f3 = 8;
                        Modifier modifierOooO0O0 = o0O0O00.OooO0O0(PaddingKt.m480paddingVpY3zN4$default(BackgroundKt.m171backgroundbw27NRU$default(modifierClip, momentGiftsVM2.getGiftsSortType() == 1 ? o0OOo000.f48135OooO0O0 : o0OOo000.f48134OooO00o, null, 2, null), Dp.m3775constructorimpl(f3), 0.0f, 2, null), false, false, 0L, false, null, null, null, new o0O0oo00(momentGiftsVM2), 253);
                        composer3.startReplaceableGroup(733328855);
                        MeasurePolicy measurePolicyOooO00o2 = Oooo000.OooO00o(companion3, false, composer3, 0, -1323940314);
                        ...
                        String strStringResource2 = StringResources_androidKt.stringResource(o000000.byValue, composer3, 0);
                        ...
                        if (momentGiftsVM2.getGiftsSortType() == 1) {
                            ...
                            j = o0000oo.OooO0OO(composer3).f38616OooO;
                        } else {
                            composer3.startReplaceableGroup(1851250680);
                            j = o0000oo.OooO0OO(composer3).f38626OooOO0O;
                        }
                        composer3.endReplaceableGroup();
                        TextKt.m1261Text4IGK_g(strStringResource2, boxScopeInstance.align(companion2, companion3.getCenter()), j, sp2, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, TextAlign.m3674boximpl(iM3681getCentere0LSkKk), 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer3, 3072, 0, 130544);
                        composer3.endReplaceableGroup();
                        composer3.endNode();
                        composer3.endReplaceableGroup();
                        composer3.endReplaceableGroup();
                        Modifier modifierOooO0O1 = o0O0O00.OooO0O0(PaddingKt.m480paddingVpY3zN4$default(BackgroundKt.m171backgroundbw27NRU$default(ClipKt.clip(SizeKt.m511height3ABfNKs(companion2, Dp.m3775constructorimpl(f2)), RoundedCornerShapeKt.RoundedCornerShape(50)), momentGiftsVM2.getGiftsSortType() == 0 ? o0OOo000.f48135OooO0O0 : o0OOo000.f48134OooO00o, null, 2, null), Dp.m3775constructorimpl(f3), 0.0f, 2, null), false, false, 0L, false, null, null, null, new o0O(momentGiftsVM2), 253);
                        composer3.startReplaceableGroup(733328855);
                        MeasurePolicy measurePolicyOooO00o3 = Oooo000.OooO00o(companion3, false, composer3, 0, -1323940314);
                        ...
                        String strStringResource3 = StringResources_androidKt.stringResource(o000000.byTime, composer3, 0);
                        long sp3 = TextUnitKt.getSp(14);
                        int iM3681getCentere0LSkKk2 = companion5.m3681getCentere0LSkKk();
                        if (momentGiftsVM2.getGiftsSortType() == 0) {
                            composer3.startReplaceableGroup(1851251666);
                            j2 = o0000oo.OooO0OO(composer3).f38616OooO;
                        } else {
                            composer3.startReplaceableGroup(1851251681);
                            j2 = o0000oo.OooO0OO(composer3).f38626OooOO0O;
                        }
                        composer3.endReplaceableGroup();
                        TextKt.m1261Text4IGK_g(strStringResource3, boxScopeInstance.align(companion2, companion3.getCenter()), j2, sp3, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, TextAlign.m3674boximpl(iM3681getCentere0LSkKk2), 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer3, 3072, 0, 130544);
                        composer3.endReplaceableGroup();
                        composer3.endNode();
                        composer3.endReplaceableGroup();
                        composer3.endReplaceableGroup();
        ...
        scopeUpdateScopeEndRestartGroup2.updateScope(new o0OO000(o0o0oooo, i));
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final void OooO0OO(o0O0OOOo o0o0oooo, int i, MomentGift momentGift, Composer composer, int i2) {
        ...
        if ((currentMomentDetail != null ? Long.valueOf(currentMomentDetail.getId()) : null) == null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new o0OO000o(o0o0oooo, i, momentGift, i2));
            return;
        }
        ...
        float f = 16;
        Modifier modifierOooO0O0 = o0O0O00.OooO0O0(BackgroundKt.m171backgroundbw27NRU$default(SizeKt.m511height3ABfNKs(PaddingKt.m482paddingqDBjuR0$default(SizeKt.fillMaxWidth$default(companion3, 0.0f, 1, null), Dp.m3775constructorimpl(f), 0.0f, Dp.m3775constructorimpl(12), 0.0f, 10, null), Dp.m3775constructorimpl(60)), o0OOo000.f48135OooO0O0, null, 2, null), false, false, 0L, false, null, null, null, new oo0ooO(momentGift), 253);
        ...
        RowScopeInstance rowScopeInstance = RowScopeInstance.INSTANCE;
        Modifier modifierOooO00o = o00O0.OooO00o(38, companion3, composerStartRestartGroup, 733328855);
        ...
        float f2 = 36;
        oooO00o.OooOO0O(p184o00o00O0.OooO0OO.OooO0oo(80, 80, momentGift.getHeadUrl()), SizeKt.m525size3ABfNKs(boxScopeInstance.align(companion3, companion2.getCenter()), Dp.m3775constructorimpl(f2)), 0.0f, null, false, composerStartRestartGroup, 262144, 28);
        float f3 = 2;
        oooO00o.OooOOo0(ConstantsKt.MINIMUM_BLOCK_SIZE, 0, composerStartRestartGroup, boxScopeInstance.align(OffsetKt.m439offsetVpY3zN4$default(companion3, Dp.m3775constructorimpl(f3), 0.0f, 2, null), companion2.getTopEnd()), UserInfo.Role.INSTANCE.isOfficial(momentGift.role));
        composerStartRestartGroup.endReplaceableGroup();
        ...
        Function2 function2OooO00o3 = OooO.OooO00o(companion4, composerM1320constructorimpl3, measurePolicyOooO0O1, composerM1320constructorimpl3, currentCompositionLocalMap3);
        if (composerM1320constructorimpl3.getInserting() || !Intrinsics.areEqual(composerM1320constructorimpl3.rememberedValue(), Integer.valueOf(currentCompositeKeyHash3))) {
            androidx.compose.animation.OooO0O0.OooO0O0(currentCompositeKeyHash3, composerM1320constructorimpl3, currentCompositeKeyHash3, function2OooO00o3);
        }
        ...
        Function2 function2OooO00o4 = OooO.OooO00o(companion4, composerM1320constructorimpl4, measurePolicyOooO0O2, composerM1320constructorimpl4, currentCompositionLocalMap4);
        ...
        oooO00o.OooOOOo(o000O000.OooO0O0(userId, nickname), o0000oo.OooO0OO(composerStartRestartGroup).f38625OooOO0, false, TextUnitKt.getSp(16), 0, 0, null, false, rowScopeInstance.weight(companion3, 1.0f, false), composerStartRestartGroup, 1073744896, 244);
        com.code.android.util.OooOO0.OooO0Oo(Dp.m3775constructorimpl(f3), null, composerStartRestartGroup, 6, 2);
        oooO00o.OooO0oO(Integer.valueOf(momentGift.getSex()), SizeKt.m511height3ABfNKs(companion3, Dp.m3775constructorimpl(f)), composerStartRestartGroup, 560, 0);
        com.code.android.util.OooOO0.OooO0Oo(Dp.m3775constructorimpl(f3), null, composerStartRestartGroup, 6, 2);
        ...
        if (l != null && userId2 == l.longValue() && Intrinsics.areEqual(o0O00oO0.OooOo().getValue(), Boolean.TRUE)) {
            ...
            oooO00o.OooOo(o0OoOo0.OooO0o0(0, (Integer) o0O00oO0.OooO0oO().getValue()), o0OoOo0.OooOOO((String) o0O00oO0.OooO0o0().getValue(), ""), SizeKt.m511height3ABfNKs(companion3, Dp.m3775constructorimpl(19)), o0000O0.OooO0OO(10, composerStartRestartGroup, 6), composerStartRestartGroup, 33152, 0);
            composerStartRestartGroup.endReplaceableGroup();
            companion = companion3;
        } else {
            composerStartRestartGroup.startReplaceableGroup(718034577);
            int i3 = momentGift.wealthLevel;
            String str = momentGift.wealthBadgeImage;
            long jOooO0OO = o0000O0.OooO0OO(10, composerStartRestartGroup, 6);
            Modifier modifierM511height3ABfNKs = SizeKt.m511height3ABfNKs(companion3, Dp.m3775constructorimpl(19));
            Intrinsics.checkNotNull(str);
            companion = companion3;
            oooO00o.OooOo(i3, str, modifierM511height3ABfNKs, jOooO0OO, composerStartRestartGroup, 33152, 0);
            composerStartRestartGroup.endReplaceableGroup();
        }
        com.code.android.util.OooOO0.OooO0Oo(Dp.m3775constructorimpl(f3), null, composerStartRestartGroup, 6, 2);
        float f4 = 19;
        Modifier.Companion companion5 = companion;
        oO0OO.OooO00o.OooOo0(null, Integer.valueOf(momentGift.kaVIPLv), null, Dp.m3775constructorimpl(f), SizeKt.m511height3ABfNKs(companion5, Dp.m3775constructorimpl(f4)), composerStartRestartGroup, 289792, 5);
        com.code.android.util.OooOO0.OooO0Oo(Dp.m3775constructorimpl(f3), null, composerStartRestartGroup, 6, 2);
        oO0OO.OooO00o.OooOOo(Boolean.valueOf(o00O000o.OooO0OO(Integer.valueOf(momentGift.getIsVip()))), Integer.valueOf(momentGift.getVipLevel()), false, Dp.m3775constructorimpl(f4), SizeKt.m511height3ABfNKs(companion5, Dp.m3775constructorimpl(f4)), composerStartRestartGroup, 289792, 4);
        composerStartRestartGroup.endReplaceableGroup();
        composerStartRestartGroup.endNode();
        composerStartRestartGroup.endReplaceableGroup();
        composerStartRestartGroup.endReplaceableGroup();
        ...
        Function2 function2OooO00o5 = OooO.OooO00o(companion4, composerM1320constructorimpl5, measurePolicyRowMeasurePolicy, composerM1320constructorimpl5, currentCompositionLocalMap5);
        ...
        oooO00o.OooO00o(p184o00o00O0.OooO0OO.OooO0oo(70, 70, momentGift.getPropImage()), SizeKt.m525size3ABfNKs(companion5, Dp.m3775constructorimpl(f2)), 0.0f, null, false, composerStartRestartGroup, 262192, 28);
        com.code.android.util.OooOO0.OooO0Oo(Dp.m3775constructorimpl(f3), null, composerStartRestartGroup, 6, 2);
        TextKt.m1261Text4IGK_g(android.support.v4.media.OooO00o.OooO00o("×  ", momentGift.getPropNum()), (Modifier) null, o0000oo.OooO0OO(composerStartRestartGroup).f38626OooOO0O, TextUnitKt.getSp(12), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 1, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composerStartRestartGroup, 3072, 3072, 122866);
        composerStartRestartGroup.endReplaceableGroup();
        composerStartRestartGroup.endNode();
        composerStartRestartGroup.endReplaceableGroup();
        composerStartRestartGroup.endReplaceableGroup();
        ...
        scopeUpdateScopeEndRestartGroup2.updateScope(new o0OO00OO(o0o0oooo, i, momentGift, i2));
    }
    ...
    public final void OooO00o(int i, @Nullable Composer composer, int i2) {
        ...
        if ((i2 & 1) == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            OooOO0.OooO00o(0, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composerStartRestartGroup)), composerStartRestartGroup, 2058660585);
            BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
            o000<MomentGift> giftsPagerState = momentGiftsVM.getGiftsPagerState();
            SharedFlow sharedFlow = giftsPagerState != null ? giftsPagerState.f38501OooO0oo : null;
            composerStartRestartGroup.startReplaceableGroup(-1590228201);
            OooOOOO oooOOOOOooO00o = sharedFlow == null ? null : o00O0O.OooO00o(sharedFlow, composerStartRestartGroup);
            composerStartRestartGroup.endReplaceableGroup();
            ...
            ComposableLambda composableLambda = o00OOOOo.f53645OooO00o;
            ComposableLambda composableLambda2 = ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1981293371, true, new OooO0O0(lazyListStateRememberLazyListState, oooOOOOOooO00o));
            int i3 = OooOOOO.f35803OooO0o0;
            composer2 = composerStartRestartGroup;
            oo00o.OooO00o(oooOOOOOooO00o, modifierFillMaxSize$default2, lazyListStateRememberLazyListState, refreshStateOooO0OO, false, null, composableLambda, null, composableLambda2, composerStartRestartGroup, 102240312, 176);
