...
public final class o0OO00o0 {
    ...
    @NotNull
    public static final o0OO00o0 f53747OooO00o = new o0OO00o0();
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final /* synthetic */ RefreshState f53748OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f53749OooO0o0;
        ...
        public OooO00o(RefreshState refreshState, MomentVideoVM momentVideoVM, Continuation<? super OooO00o> continuation) {
            ...
            this.f53748OooO0Oo = refreshState;
            this.f53749OooO0o0 = momentVideoVM;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO00o(this.f53748OooO0Oo, this.f53749OooO0o0, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (this.f53748OooO0Oo.OooO0OO() == RefreshState.State.Null) {
                this.f53749OooO0o0.refreshMomentDetail();
            }
    ...
    public static final class OooO0O0 extends Lambda implements Function3<BoxScope, Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ LazyListState f53750OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ OooOOOO<PostUserModel> f53751OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(LazyListState lazyListState, OooOOOO<PostUserModel> oooOOOO) {
            super(3);
            this.f53750OooO0Oo = lazyListState;
            this.f53751OooO0o0 = oooOOOO;
        }
        ...
        public final Unit invoke(BoxScope boxScope, Composer composer, Integer num) {
            ...
            if ((iIntValue & 81) == 16 && composer2.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-1984781061, iIntValue, -1, "com.yalla.yalla.ui.screen.moment.media.MomentCommentDialogPraises.Content.<anonymous>.<anonymous> (MomentCommentDialogPraises.kt:83)");
                }
                LazyDslKt.LazyColumn(SizeKt.fillMaxSize$default(Modifier.INSTANCE, 0.0f, 1, null), this.f53750OooO0Oo, null, false, null, null, null, false, new o0OO0O0(this.f53751OooO0o0), composer2, 6, 252);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public static final class OooO0OO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final /* synthetic */ int f53753OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f53754OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(int i, int i2) {
            super(2);
            this.f53754OooO0o0 = i;
            this.f53753OooO0o = i2;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f53753OooO0o | 1);
            o0OO00o0.this.OooO00o(this.f53754OooO0o0, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f53756OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f53757OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(int i, int i2) {
            super(2);
            this.f53757OooO0o0 = i;
            this.f53756OooO0o = i2;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f53756OooO0o | 1);
            o0OO00o0.this.OooO00o(this.f53757OooO0o0, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }

    public static final void OooO0O0(o0OO00o0 o0oo00o1, Composer composer, int i) {
        o0oo00o1.getClass();
        ...
        if ((i & 1) == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            if ((currentMomentDetail != null ? currentMomentDetail.getPraiseNum() : 0L) <= 0) {
                ...
                scopeUpdateScopeEndRestartGroup.updateScope(new o0OOooO0(o0oo00o1, i));
                return;
            }
            ...
            LayoutKt.MultiMeasureLayout(SemanticsModifierKt.semantics$default(modifierM171backgroundbw27NRU$default, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: com.yalla.yalla.ui.screen.moment.media.MomentCommentDialogPraises$ItemTitle$$inlined$ConstraintLayout$1
                {
                    super(1);
                }
                ...
                public final Unit invoke(Composer composer2, Integer num) {
                    ...
                    if (((num.intValue() & 11) ^ 2) == 0 && composer3.getSkipping()) {
                        ...
                        o0OO o0ooOooO00o = constraintLayoutScope2.OooO0OO().OooO00o();
                        String strStringResource = StringResources_androidKt.stringResource(o000000.XXX_likes, composer3, 0);
                        String[] strArr = new String[1];
                        MomentDetailModel currentMomentDetail2 = momentVideoVM.getCurrentMomentDetail();
                        String strOooO0o = o0O0O0Oo.OooO0o(o0OoOo0.OooOO0(currentMomentDetail2 != null ? Long.valueOf(currentMomentDetail2.getPraiseNum()) : null), false);
                        Intrinsics.checkNotNullExpressionValue(strOooO0o, "formatNumberToKMUnit(...)");
                        strArr[0] = strOooO0o;
                        TextKt.m1261Text4IGK_g(i5.OooO00o(strStringResource, strArr), PaddingKt.m480paddingVpY3zN4$default(SizeKt.fillMaxWidth$default(ConstraintLayoutScope.OooO00o(Modifier.INSTANCE, o0ooOooO00o, o0OO0o00.f53761OooO0Oo), 0.0f, 1, null), Dp.m3775constructorimpl(16), 0.0f, 2, null), o0000oo.OooO0OO(composer3).f38627OooOO0o, TextUnitKt.getSp(14), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer3, 3072, 0, 131056);
                    }
                    return Unit.INSTANCE;
                }
        ...
        scopeUpdateScopeEndRestartGroup2.updateScope(new o0OO0o(o0oo00o1, i));
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final void OooO0OO(o0OO00o0 o0oo00o1, int i, PostUserModel postUserModel, Composer composer, int i2) {
        ...
        if ((currentMomentDetail != null ? Long.valueOf(currentMomentDetail.getId()) : null) == null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new o0OO0oO0(o0oo00o1, i, postUserModel, i2));
            return;
        }
        ...
        float f = 16;
        Modifier modifierOooO0O0 = o0O0O00.OooO0O0(BackgroundKt.m171backgroundbw27NRU$default(SizeKt.m511height3ABfNKs(PaddingKt.m480paddingVpY3zN4$default(SizeKt.fillMaxWidth$default(companion3, 0.0f, 1, null), Dp.m3775constructorimpl(f), 0.0f, 2, null), Dp.m3775constructorimpl(60)), o0OOo000.f48135OooO0O0, null, 2, null), false, false, 0L, false, null, null, null, new o0OOO00(postUserModel), 253);
        ...
        oooO00o.OooOO0O(p184o00o00O0.OooO0OO.OooO0oo(80, 80, postUserModel.getHeadurl()), SizeKt.m525size3ABfNKs(boxScopeInstance.align(companion3, companion2.getCenter()), Dp.m3775constructorimpl(36)), 0.0f, null, false, composerStartRestartGroup, 262144, 28);
        float f2 = 2;
        oooO00o.OooOOo0(ConstantsKt.MINIMUM_BLOCK_SIZE, 0, composerStartRestartGroup, boxScopeInstance.align(OffsetKt.m439offsetVpY3zN4$default(companion3, Dp.m3775constructorimpl(f2), 0.0f, 2, null), companion2.getTopEnd()), UserInfo.Role.INSTANCE.isOfficial(postUserModel.getRole()));
        composerStartRestartGroup.endReplaceableGroup();
        ...
        oooO00o.OooO0oO(Integer.valueOf(postUserModel.getSex()), SizeKt.m511height3ABfNKs(companion3, Dp.m3775constructorimpl(f)), composerStartRestartGroup, 560, 0);
        com.code.android.util.OooOO0.OooO0Oo(Dp.m3775constructorimpl(f2), null, composerStartRestartGroup, 6, 2);
        ...
        if (l != null && userid2 == l.longValue() && Intrinsics.areEqual(o0O00oO0.OooOo().getValue(), Boolean.TRUE)) {
            ...
            String str = postUserModel.wealthBadgeImage;
            long jOooO0OO = o0000O0.OooO0OO(10, composerStartRestartGroup, 6);
            Modifier modifierM511height3ABfNKs = SizeKt.m511height3ABfNKs(companion, Dp.m3775constructorimpl(19));
        ...
        com.code.android.util.OooOO0.OooO0Oo(Dp.m3775constructorimpl(f2), null, composerStartRestartGroup, 6, 2);
        float f3 = 19;
        oO0OO.OooO00o.OooOo0(null, Integer.valueOf(postUserModel.kaVIPLv), null, Dp.m3775constructorimpl(f), SizeKt.m511height3ABfNKs(companion, Dp.m3775constructorimpl(f3)), composerStartRestartGroup, 289792, 5);
        com.code.android.util.OooOO0.OooO0Oo(Dp.m3775constructorimpl(f2), null, composerStartRestartGroup, 6, 2);
        oO0OO.OooO00o.OooOOo(Boolean.valueOf(o00O000o.OooO0OO(Integer.valueOf(postUserModel.getVip()))), Integer.valueOf(postUserModel.getVipLevel()), false, Dp.m3775constructorimpl(f3), SizeKt.m511height3ABfNKs(companion, Dp.m3775constructorimpl(f3)), composerStartRestartGroup, 289792, 4);
        ...
        scopeUpdateScopeEndRestartGroup2.updateScope(new o0OOO0(o0oo00o1, i, postUserModel, i2));
    }
    ...
    public final void OooO00o(int i, @Nullable Composer composer, int i2) {
        ...
        if ((i2 & 1) == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            OooOO0.OooO00o(0, function3ModifierMaterializerOf, SkippableUpdater.m1311boximpl(SkippableUpdater.m1312constructorimpl(composerStartRestartGroup)), composerStartRestartGroup, 2058660585);
            BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
            o000<PostUserModel> praisesPagerState = momentPraiseVM.getPraisesPagerState();
            SharedFlow sharedFlow = praisesPagerState != null ? praisesPagerState.f38501OooO0oo : null;
            ...
            ComposableLambda composableLambda = o0oOO.f53829OooO00o;
            ComposableLambda composableLambda2 = ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1984781061, true, new OooO0O0(lazyListStateRememberLazyListState, oooOOOOOooO00o));
