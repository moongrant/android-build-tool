...
public final class o0OOO00 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ PostUserModel f53770OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0OOO00(PostUserModel postUserModel) {
        super(0);
        this.f53770OooO0Oo = postUserModel;
    }
    ...
    public final Unit invoke() {
        ...
        if (activityOooO0O0 != null) {
            o0OO onLogin = new o0OO(activityOooO0O0, this.f53770OooO0Oo);
