...
public final class o0OOO0OO {
    ...
    @NotNull
    public static final o0OOO0OO f53771OooO00o = new o0OOO0OO();

    public static final class OooO extends Lambda implements Function2<Composer, Integer, Unit> {

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f53773OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO(int i) {
            super(2);
            this.f53773OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f53773OooO0o0 | 1);
    ...
    public static final class OooO00o extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f53775OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(int i) {
            super(2);
            this.f53775OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f53775OooO0o0 | 1);
            o0OOO0OO.this.OooO00o(composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0O0 extends Lambda implements Function2<Integer, MoreModel, Unit> {
        ...
        public final /* synthetic */ MomentReplyVM f53776OooO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ FragmentActivity f53777OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f53778OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MomentCommentDetailModel f53779OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ MomentCommentsVM f53780OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ LifecycleOwner f53781OooO0oo;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public final /* synthetic */ CoroutineScope f53782OooOO0;
        ...
        public OooO0O0(FragmentActivity fragmentActivity, MomentCommentDetailModel momentCommentDetailModel, MomentVideoVM momentVideoVM, MomentCommentsVM momentCommentsVM, LifecycleOwner lifecycleOwner, MomentReplyVM momentReplyVM, CoroutineScope coroutineScope) {
            super(2);
            this.f53777OooO0Oo = fragmentActivity;
            this.f53779OooO0o0 = momentCommentDetailModel;
            this.f53778OooO0o = momentVideoVM;
            this.f53780OooO0oO = momentCommentsVM;
            this.f53781OooO0oo = lifecycleOwner;
            this.f53776OooO = momentReplyVM;
            this.f53782OooOO0 = coroutineScope;
        }
        ...
        public final Unit invoke(Integer num, MoreModel moreModel) {
            ...
            if (moreModel2 != null) {
                ...
                MomentCommentDetailModel momentCommentDetailModel2 = this.f53779OooO0o0;
                if (i != 1) {
                    MomentVideoVM momentVideoVM = this.f53778OooO0o;
                    MomentCommentsVM momentCommentsVM = this.f53780OooO0oO;
                    MomentReplyVM momentReplyVM = this.f53776OooO;
                    if (i == 2) {
                        ...
                        o0o0000 onLogin = new o0o0000(momentVideoVM, momentCommentDetailModel2, this.f53782OooOO0);
                    ...
                    FragmentActivity fragmentActivity = this.f53777OooO0Oo;
                    TextView textView = new TextView(fragmentActivity);
                    o00O0O.OooO0OO(fragmentActivity, momentCommentDetailModel2.getContent(), textView, new o00000());
    ...
    public static final class OooO0OO extends Lambda implements Function0<Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f53783OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ o000O0o f53784OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(MomentVideoVM momentVideoVM, o000O0o o000o0o2) {
            super(0);
            this.f53783OooO0Oo = momentVideoVM;
            this.f53784OooO0o0 = o000o0o2;
        }

        @Override // kotlin.jvm.functions.Function0
        @Nullable
        public final Object invoke() {
            this.f53783OooO0Oo.setShowDialogCommentMore(null);
            return this.f53784OooO0o0;
        }
    }
    ...
    public static final class OooO0o extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f53785OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(MomentVideoVM momentVideoVM) {
            super(0);
            this.f53785OooO0Oo = momentVideoVM;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            this.f53785OooO0Oo.setShowDialogCommentMore(null);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f53787OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0(int i) {
            super(2);
            this.f53787OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f53787OooO0o0 | 1);
            o0OOO0OO.this.OooO0O0(composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0O extends Lambda implements Function2<Integer, MoreModel, Unit> {
        ...
        /* JADX INFO: renamed from: OooO, reason: collision with root package name */
        public final /* synthetic */ MomentCommentsVM f53788OooO;

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ FragmentActivity f53789OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f53790OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MomentReplyModel f53791OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ LifecycleOwner f53792OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ MomentReplyVM f53793OooO0oo;

        /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
        public final /* synthetic */ CoroutineScope f53794OooOO0;
        ...
        public OooOO0O(FragmentActivity fragmentActivity, MomentReplyModel momentReplyModel, MomentVideoVM momentVideoVM, LifecycleOwner lifecycleOwner, MomentReplyVM momentReplyVM, MomentCommentsVM momentCommentsVM, CoroutineScope coroutineScope) {
            super(2);
            this.f53789OooO0Oo = fragmentActivity;
            this.f53791OooO0o0 = momentReplyModel;
            this.f53790OooO0o = momentVideoVM;
            this.f53792OooO0oO = lifecycleOwner;
            this.f53793OooO0oo = momentReplyVM;
            this.f53788OooO = momentCommentsVM;
            this.f53794OooOO0 = coroutineScope;
        }
        ...
        public final Unit invoke(Integer num, MoreModel moreModel) {
            ...
            if (moreModel2 != null) {
                int i = OooO00o.$EnumSwitchMapping$0[moreModel2.getTag().ordinal()];
                MomentReplyModel momentReplyModel = this.f53791OooO0o0;
                if (i != 1) {
                    MomentVideoVM momentVideoVM = this.f53790OooO0o;
                    if (i == 2) {
                        MomentDetailModel currentMomentDetail = momentVideoVM.getCurrentMomentDetail();
                        o0OoOo0.OooO00o(momentVideoVM.deleteCommentOrReply(com.code.android.util.o0OoOo0.OooOOO0("", currentMomentDetail != null ? Long.valueOf(currentMomentDetail.getId()) : null), com.code.android.util.o0OoOo0.OooOOO0("", Long.valueOf(momentReplyModel.getId()))), this.f53792OooO0oO, new o0oo0000(this.f53793OooO0oo, momentReplyModel, this.f53788OooO, momentVideoVM));
                    } else if (i == 3) {
                        MomentDetailModel currentMomentDetail2 = momentVideoVM.getCurrentMomentDetail();
                        ...
                        o onLogin = new o(momentVideoVM, momentReplyModel, this.f53794OooOO0);
                        Intrinsics.checkNotNullParameter(onLogin, "onLogin");
                        o0O00oO0 o0o00oo1 = o0O00oO0.f47936OooO00o;
                        if (Intrinsics.areEqual(o0O00oO0.OooOo0O().getValue(), Boolean.TRUE)) {
                            onLogin.invoke();
                    ...
                    FragmentActivity fragmentActivity = this.f53789OooO0Oo;
                    TextView textView = new TextView(fragmentActivity);
                    o00O0O.OooO0OO(fragmentActivity, momentReplyModel.getContent(), textView, new o00000O());
                    o00O0O0O.OooO0o0(textView, fragmentActivity, o0000.OooO0OO(o000000.Copied));
                }
            }
            return null;
    ...
    public static final class OooOOO extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f53795OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO(MomentVideoVM momentVideoVM) {
            super(0);
            this.f53795OooO0Oo = momentVideoVM;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            this.f53795OooO0Oo.setShowDialogReplySonMore(null);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOOO0 extends Lambda implements Function0<Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MomentVideoVM f53796OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ o000O0o f53797OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO0(MomentVideoVM momentVideoVM, o000O0o o000o0o2) {
            super(0);
            this.f53796OooO0Oo = momentVideoVM;
            this.f53797OooO0o0 = o000o0o2;
        }

        @Override // kotlin.jvm.functions.Function0
        @Nullable
        public final Object invoke() {
            this.f53796OooO0Oo.setShowDialogReplySonMore(null);
            return this.f53797OooO0o0;
        }
    }
    ...
    public static final class OooOOOO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f53799OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOOO(int i) {
            super(2);
            this.f53799OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f53799OooO0o0 | 1);
            o0OOO0OO.this.OooO0O0(composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
        ...
        if ((i & 1) == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            if (showDialogCommentMore != null) {
                ...
                if (fragmentActivity != null) {
                    ...
                    o000O0Oo.OooO00o(o000o0o2, new OooO0o(momentVideoVM));
                    o000o0o2.OooOO0o();
                }
            }
            if (ComposerKt.isTraceInProgress()) {
        ...
        if ((i & 1) == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            if (showDialogReplySonMore != null) {
                ...
                if (fragmentActivity != null) {
                    ...
                    o000O0Oo.OooO00o(o000o0o2, new OooOOO(momentVideoVM));
                    o000o0o2.OooOO0o();
                }
            }
            if (ComposerKt.isTraceInProgress()) {
