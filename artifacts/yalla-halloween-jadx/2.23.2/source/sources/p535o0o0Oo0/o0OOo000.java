...
public final class o0OOo000 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f53808OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ MomentVideoVM f53809OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0OOo000(MomentVideoVM momentVideoVM, Continuation<? super o0OOo000> continuation) {
        super(2, continuation);
        this.f53809OooO0o0 = momentVideoVM;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o0OOo000(this.f53809OooO0o0, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f53808OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            this.f53808OooO0Oo = 1;
        ...
        MomentVideoVM momentVideoVM = this.f53809OooO0o0;
