...
public final class oO0000Oo extends Lambda implements Function1<PraiseCommentResultModel, Unit> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ MutableState<Boolean> f53868OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ MomentReplyModel f53869OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ int f53870OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final /* synthetic */ MomentDetailModel f53871OooO0oO;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public oO0000Oo(MutableState<Boolean> mutableState, int i, MomentReplyModel momentReplyModel, MomentDetailModel momentDetailModel) {
        super(1);
        this.f53868OooO0Oo = mutableState;
        this.f53870OooO0o0 = i;
        this.f53869OooO0o = momentReplyModel;
        this.f53871OooO0oO = momentDetailModel;
    }
    ...
    public final Unit invoke(PraiseCommentResultModel praiseCommentResultModel) {
        ...
        this.f53868OooO0Oo.setValue(Boolean.valueOf(this.f53870OooO0o0 == 0));
        MomentReplyModel momentReplyModel = this.f53869OooO0o;
        ...
        MomentDetailModel momentDetailModel = this.f53871OooO0oO;
