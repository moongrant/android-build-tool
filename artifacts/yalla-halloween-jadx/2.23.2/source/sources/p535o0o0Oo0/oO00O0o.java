...
public final class oO00O0o extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MomentVideoVM f53909OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ Ref.ObjectRef<MomentReplyModel> f53910OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public oO00O0o(MomentVideoVM momentVideoVM, Ref.ObjectRef<MomentReplyModel> objectRef) {
        super(0);
        this.f53909OooO0Oo = momentVideoVM;
        this.f53910OooO0o0 = objectRef;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        MomentVideoVM momentVideoVM = this.f53909OooO0Oo;
        ...
        if (o0OoOo0.OooO00o(currentMomentDetail != null ? Boolean.valueOf(MomentStateKt.isApprovedState(currentMomentDetail)) : null)) {
            momentVideoVM.toInputCommentOrReply(momentVideoVM.getCurrentComment(), this.f53910OooO0o0.element, true);
