...
public final class OooO extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ OfficialActionModel f54349OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ FragmentActivity f54350OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooO(OfficialActionModel officialActionModel, FragmentActivity fragmentActivity) {
        super(0);
        this.f54349OooO0Oo = officialActionModel;
        this.f54350OooO0o0 = fragmentActivity;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        String url = this.f54349OooO0Oo.getH5EntranceUrl();
        if (url != null) {
            ...
            WebActivity.OooO00o.OooO00o(this.f54350OooO0o0, webPageInfo);
        }
