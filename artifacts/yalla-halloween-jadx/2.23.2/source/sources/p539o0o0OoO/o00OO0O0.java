...
public final class o00OO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public int f54569OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ int f54570OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ o000000 f54571OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00OO0O0(o000000 o000000Var, int i, Continuation<? super o00OO0O0> continuation) {
        super(2, continuation);
        this.f54571OooO0o0 = o000000Var;
        this.f54570OooO0o = i;
    }
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new o00OO0O0(this.f54571OooO0o0, this.f54570OooO0o, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = this.f54569OooO0Oo;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            this.f54569OooO0Oo = 1;
            Saver<o000000, ?> saver = o000000.f39751OooO0oo;
            if (this.f54571OooO0o0.OooOO0(this.f54570OooO0o, 0.0f, this) == coroutine_suspended) {
