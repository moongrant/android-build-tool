...
public final class oO00000 extends Lambda implements Function3<LazyItemScope, Composer, Integer, Unit> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ MutableState<Boolean> f54907OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ int f54908OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ boolean f54909OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public oO00000(MutableState<Boolean> mutableState, boolean z, int i) {
        super(3);
        this.f54907OooO0Oo = mutableState;
        this.f54909OooO0o0 = z;
        this.f54908OooO0o = i;
    }
    ...
    public final Unit invoke(LazyItemScope lazyItemScope, Composer composer, Integer num) {
        ...
        if ((iIntValue & 81) == 16 && composer2.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1490560464, iIntValue, -1, "com.yalla.yalla.ui.dialog.room.LiveRoomMemberUserRankDialog.MemberRankList.<anonymous>.<anonymous> (LiveRoomMemberUserRankDialog.kt:323)");
            }
            ...
            boolean zBooleanValue = this.f54907OooO0Oo.getValue().booleanValue();
            o oVar = o.f54639OooO00o;
            if (zBooleanValue) {
                o.OooO0oo(oVar, null, composer2, 48, 1);
            }
            composer2.endReplaceableGroup();
            oVar.OooO00o(this.f54909OooO0o0, composer2, (this.f54908OooO0o & 14) | 48);
            composer2.endReplaceableGroup();
            composer2.endNode();
            composer2.endReplaceableGroup();
            composer2.endReplaceableGroup();
