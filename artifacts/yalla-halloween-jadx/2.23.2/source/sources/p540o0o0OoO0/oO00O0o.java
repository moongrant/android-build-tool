...
public final class oO00O0o extends Lambda implements Function3<LazyGridItemScope, Composer, Integer, Unit> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ MixedRoomActivity f54943OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public oO00O0o(MixedRoomActivity mixedRoomActivity) {
        super(3);
        this.f54943OooO0Oo = mixedRoomActivity;
    }
    ...
    public final Unit invoke(LazyGridItemScope lazyGridItemScope, Composer composer, Integer num) {
        ...
        if ((iIntValue & 81) == 16 && composer2.getSkipping()) {
            ...
            oO000Oo.OooO0o0(this.f54943OooO0Oo, composer2, 8);
            if (ComposerKt.isTraceInProgress()) {
