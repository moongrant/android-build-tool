...
public final class oO0o0o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ RefreshState f54998OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ MutableState<Boolean> f54999OooO0o0;
    ...
    public oO0o0o(RefreshState refreshState, MutableState<Boolean> mutableState, Continuation<? super oO0o0o> continuation) {
        super(2, continuation);
        this.f54998OooO0Oo = refreshState;
        this.f54999OooO0o0 = mutableState;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new oO0o0o(this.f54998OooO0Oo, this.f54999OooO0o0, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i = OooO00o.$EnumSwitchMapping$0[this.f54998OooO0Oo.OooO0OO().ordinal()];
        MutableState<Boolean> mutableState = this.f54999OooO0o0;
        if (i == 1) {
