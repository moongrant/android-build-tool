...
public final class oO0O0 {
    ...
    @NotNull
    public static final oO0O0 f55079OooO00o = new oO0O0();

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public static final MutableState f55080OooO0O0 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m3884boximpl(IntOffsetKt.IntOffset(0, 0)), null, 2, null);

    public static final class OooO00o extends Lambda implements Function2<Composer, Integer, Unit> {

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f55082OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(int i) {
            super(2);
            this.f55082OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f55082OooO0o0 | 1);
            oO0O0.this.OooO00o(composer, iUpdateChangedFlags);
    ...
    public final void OooO00o(@Nullable Composer composer, int i) {
        ...
        if ((i & 1) == 0 && composerStartRestartGroup.getSkipping()) {
            ...
            ooOOO00O.OooO00o(composerStartRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
