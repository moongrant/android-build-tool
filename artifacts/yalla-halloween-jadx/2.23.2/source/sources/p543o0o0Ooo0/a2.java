...
public final class a2 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ Context f55360OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ String f55361OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public a2(Context context, String str) {
        super(0);
        this.f55360OooO0Oo = context;
        this.f55361OooO0o0 = str;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        int i = JoinTopicListActivity.f25596OooOoO0;
        Context context = this.f55360OooO0Oo;
        Intrinsics.checkNotNullParameter(context, "context");
        Intent intent = new Intent(context, (Class<?>) JoinTopicListActivity.class);
        intent.putExtra("Id", this.f55361OooO0o0);
