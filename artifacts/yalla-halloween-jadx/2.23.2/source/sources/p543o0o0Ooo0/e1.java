...
public final class e1 {
    ...
    @NotNull
    public static final e1 f55398OooO00o = new e1();
    ...
    public final void OooO00o(int i, int i2, @Nullable Composer composer, @Nullable Function1 function1) {
        ...
        if ((i3 & 11) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1204052238, i3, -1, "com.yalla.yalla.ui.screen.user.UserMomentListFilterTypePop.Pop (UserMomentListFilterTypePop.kt:44)");
            }
            ...
            if (rectBoundsInWindow != null) {
                ...
                if (objRememberedValue2 == companion.getEmpty()) {
                    int i5 = o0O0O00.ic_user_moment_screen_pop_bg;
                    Object obj = ContextCompat.f5281OooO00o;
                    objRememberedValue2 = ContextCompat.OooO0OO.OooO0O0(context, i5);
                    composerStartRestartGroup.updateRememberedValue(objRememberedValue2);
                }
                composerStartRestartGroup.endReplaceableGroup();
                AndroidPopup_androidKt.m4014PopupK5zGePQ(Alignment.INSTANCE.getTopStart(), IntOffsetKt.IntOffset(o0000O00.OooO0OO(), (((int) Offset.m1448getYimpl(rectBoundsInWindow.m1474getBottomCenterF1C5BW0())) - IntSize.m3934getHeightimpl(((IntSize) mutableState.getValue()).getPackedValue())) + 230), new x0(momentUserListVM), new PopupProperties(true, true, true, null, false, false, 56, null), ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1875424598, true, new c1((Drawable) objRememberedValue2, mutableState, momentUserListVM, function3)), composerStartRestartGroup, 27654, 0);
            }
            if (ComposerKt.isTraceInProgress()) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new d1(this, function3, i, i2));
    }
}
