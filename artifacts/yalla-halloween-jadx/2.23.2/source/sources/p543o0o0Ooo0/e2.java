...
public final class e2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ MomentUserListVM f55399OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e2(MomentUserListVM momentUserListVM, Continuation<? super e2> continuation) {
        super(2, continuation);
        this.f55399OooO0Oo = momentUserListVM;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new e2(this.f55399OooO0Oo, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        MomentUserListVM momentUserListVM = this.f55399OooO0Oo;
