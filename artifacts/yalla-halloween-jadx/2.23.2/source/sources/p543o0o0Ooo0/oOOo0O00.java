...
public final class oOOo0O00 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ State<Integer> f55540OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public oOOo0O00(State<Integer> state) {
        super(0);
        this.f55540OooO0Oo = state;
    }
    ...
    public final Unit invoke() {
        ...
        if (context2 != null) {
            ...
            Integer value = this.f55540OooO0Oo.getValue();
