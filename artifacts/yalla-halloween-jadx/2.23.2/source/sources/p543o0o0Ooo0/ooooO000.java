...
public final class ooooO000 {
    ...
    public static final class OooO extends Lambda implements Function0<Unit> {
        ...
        public static final OooO f55573OooO0Oo = new OooO();
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ VipVm f55574OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO00o(VipVm vipVm, Continuation<? super OooO00o> continuation) {
            super(2, continuation);
            this.f55574OooO0Oo = vipVm;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new OooO00o(this.f55574OooO0Oo, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            this.f55574OooO0Oo.loadPersonData();
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0O0<T> implements Observer {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ State<PersonalVipModel> f55575OooO0Oo;

        public OooO0O0(State<PersonalVipModel> state) {
            this.f55575OooO0Oo = state;
        }

        @Override // androidx.lifecycle.Observer
        public final void onChanged(Object obj) {
            this.f55575OooO0Oo.getValue().setShowPremiumFirst(((Boolean) obj).booleanValue());
        }
    }
    ...
    public static final class OooO0OO<T> implements Observer {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ State<PersonalVipModel> f55576OooO0Oo;

        public OooO0OO(State<PersonalVipModel> state) {
            this.f55576OooO0Oo = state;
        }

        @Override // androidx.lifecycle.Observer
        public final void onChanged(Object obj) {
            this.f55576OooO0Oo.getValue().setStealthVisit(((Boolean) obj).booleanValue());
        }
    }
    ...
    public static final class OooO0o extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ State<PersonalVipModel> f55577OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0o(State<PersonalVipModel> state) {
            super(0);
            this.f55577OooO0Oo = state;
        }
        ...
        public final Unit invoke() {
            ...
            State<PersonalVipModel> state = this.f55577OooO0Oo;
    ...
    public static final class OooOO0 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f55578OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f55579OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0(MutableState<Boolean> mutableState, int i) {
            super(2);
            this.f55578OooO0Oo = mutableState;
            this.f55579OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f55579OooO0o0 | 1);
            ooooO000.OooO00o(this.f55578OooO0Oo, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOO0O extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ AppCompatActivity f55580OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0O(AppCompatActivity appCompatActivity) {
            super(0);
            this.f55580OooO0Oo = appCompatActivity;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            AppCompatActivity appCompatActivity = this.f55580OooO0Oo;
            if (appCompatActivity != null) {
                o00000OO.f56680OooOo0O.observe(appCompatActivity, new OooOOOO(new oOO0(appCompatActivity)));
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOOO extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f55581OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ int f55582OooO0o0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOOO(MutableState<Boolean> mutableState, int i) {
            super(2);
            this.f55581OooO0Oo = mutableState;
            this.f55582OooO0o0 = i;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(this.f55582OooO0o0 | 1);
            ooooO000.OooO0O0(this.f55581OooO0Oo, composer, iUpdateChangedFlags);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooOOO0 extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooOOO0 f55583OooO0Oo = new OooOOO0();
    ...
    public static final class OooOOOO implements Observer, FunctionAdapter {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function1 f55584OooO0Oo;

        public OooOOOO(oOO0 function) {
            Intrinsics.checkNotNullParameter(function, "function");
            this.f55584OooO0Oo = function;
        }
        ...
        public final boolean equals(@Nullable Object obj) {
            ...
            return Intrinsics.areEqual(this.f55584OooO0Oo, ((FunctionAdapter) obj).getFunctionDelegate());
        }

        @Override // kotlin.jvm.internal.FunctionAdapter
        @NotNull
        public final Function<?> getFunctionDelegate() {
            return this.f55584OooO0Oo;
        }

        public final int hashCode() {
            return this.f55584OooO0Oo.hashCode();
        }

        @Override // androidx.lifecycle.Observer
        public final /* synthetic */ void onChanged(Object obj) {
            this.f55584OooO0Oo.invoke(obj);
        }
    }
    ...
    public static final void OooO00o(@NotNull MutableState<Boolean> show, @Nullable Composer composer, int i) {
        ...
        if ((i2 & 11) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = new OooO0O0(stateCollectAsStateWithLifecycle);
            ...
            if (zChanged2 || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                objRememberedValue2 = new OooO0OO(stateCollectAsStateWithLifecycle);
                composerStartRestartGroup.updateRememberedValue(objRememberedValue2);
            }
            composerStartRestartGroup.endReplaceableGroup();
            o00O0000.OooO00o(observable2, (Observer) objRememberedValue2, composerStartRestartGroup, 72);
            String strStringResource = StringResources_androidKt.stringResource(o000000.my_outfit_is_vip_hidden, composerStartRestartGroup, 0);
            String strStringResource2 = StringResources_androidKt.stringResource(o000000.Go_to_Settings, composerStartRestartGroup, 0);
            composerStartRestartGroup.startReplaceableGroup(1157296644);
            boolean zChanged3 = composerStartRestartGroup.changed(stateCollectAsStateWithLifecycle);
            Object objRememberedValue3 = composerStartRestartGroup.rememberedValue();
            if (zChanged3 || objRememberedValue3 == Composer.INSTANCE.getEmpty()) {
                objRememberedValue3 = new OooO0o(stateCollectAsStateWithLifecycle);
                composerStartRestartGroup.updateRememberedValue(objRememberedValue3);
            }
            composerStartRestartGroup.endReplaceableGroup();
            composer2 = composerStartRestartGroup;
            o000O0Oo.OooO0Oo(show, null, strStringResource, null, false, false, null, null, strStringResource2, false, null, false, (Function0) objRememberedValue3, null, false, false, null, OooO.f55573OooO0Oo, null, null, composer2, i2 & 14, 12582912, 913146);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void OooO0O0(@NotNull MutableState<Boolean> show, @Nullable Composer composer, int i) {
        ...
        if ((i2 & 11) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            composer2 = composerStartRestartGroup;
            o000O0Oo.OooO0Oo(show, null, StringResources_androidKt.stringResource(o000000.my_outfit_is_wealth_hidden, composerStartRestartGroup, 0), null, false, false, null, null, StringResources_androidKt.stringResource(o000000.Go_to_Settings, composerStartRestartGroup, 0), false, null, false, new OooOO0O(objConsume instanceof AppCompatActivity ? (AppCompatActivity) objConsume : null), null, false, false, null, OooOOO0.f55583OooO0Oo, null, null, composer2, i2 & 14, 12582912, 913146);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
