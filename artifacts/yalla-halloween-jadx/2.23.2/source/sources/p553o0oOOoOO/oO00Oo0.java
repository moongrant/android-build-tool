...
public final class oO00Oo0 extends Lambda implements Function3<BoxScope, Composer, Integer, Unit> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ OooOOOO<VipShopRecordModel> f56128OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public oO00Oo0(OooOOOO<VipShopRecordModel> oooOOOO) {
        super(3);
        this.f56128OooO0Oo = oooOOOO;
    }
    ...
    public final Unit invoke(BoxScope boxScope, Composer composer, Integer num) {
        ...
        if ((iIntValue & 81) == 16 && composer2.getSkipping()) {
            ...
            oO00000.OooO00o(new oO00Oo00(this.f56128OooO0Oo), 0, null, 0L, null, null, composer2, 0, 62);
            if (ComposerKt.isTraceInProgress()) {
