...
public final class oO00o00O implements TextWatcher {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final EditTextSpan f56165OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final oO0O000o f56166OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public int f56167OooO0o0;
    ...
    public class OooO00o implements oO0O000o.OooO00o {
        ...
        public final void OooO00o(int i, int i2, int i3, String str) {
            oO00o00O.this.OooO00o(i, i2, i3);
        }
    }

    public oO00o00O(EditTextSpan editTextSpan) {
        System.currentTimeMillis();
        this.f56167OooO0o0 = 0;
        this.f56165OooO0Oo = editTextSpan;
        this.f56166OooO0o = new oO0O000o(new OooO00o());
    }

    public final void OooO00o(int i, int i2, int i3) {
        oOo00ooO next;
        EditTextSpan editTextSpan = this.f56165OooO0Oo;
    ...
    public final void afterTextChanged(Editable editable) {
        this.f56167OooO0o0 = editable.length();
    }
    ...
    public final void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        ...
        oO0O000o oo0o000o = this.f56166OooO0o;
        oo0o000o.OooO00o(jCurrentTimeMillis);
        if (i == 0 && i2 == (i4 = this.f56167OooO0o0) && i3 == 0 && i4 > 0) {
        ...
        ((o0000O0O) editTextSpan.getSpanKeyListener()).OooO00o(str);
    }
}
