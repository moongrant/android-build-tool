...
public final class o0O000O extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ MomentDetailCommentItemView f56325OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0O000O(MomentDetailCommentItemView momentDetailCommentItemView) {
        super(0);
        this.f56325OooO0Oo = momentDetailCommentItemView;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        MomentDetailCommentItemView momentDetailCommentItemView = this.f56325OooO0Oo;
        ...
        ImageView praiseIvSon = momentDetailCommentItemView.f30537OooO0Oo.f45060OooOOO;
        Intrinsics.checkNotNullExpressionValue(praiseIvSon, "praiseIvSon");
        o000O.OooO0OO(praiseIvSon);
