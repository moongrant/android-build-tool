...
public final class oO0OO0O implements ViewTreeObserver.OnPreDrawListener {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ View f56460OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ OooO00o f56461OooO0o0;

    public oO0OO0O(OooO00o oooO00o, LinearLayout linearLayout) {
        this.f56461OooO0o0 = oooO00o;
        this.f56460OooO0Oo = linearLayout;
    }

    @Override // android.view.ViewTreeObserver.OnPreDrawListener
    public final boolean onPreDraw() {
        Rect rect;
        OooO00o oooO00o = this.f56461OooO0o0;
        oooO00o.getClass();
        boolean zOooO0o0 = OooOo00.OooO0o0();
        int i = o0OO00O.viewPager;
        View view = this.f56460OooO0Oo;
        View viewFindViewById = view.findViewById(i);
        View viewFindViewById2 = view.findViewById(o0OO00O.layoutUser);
        View viewFindViewById3 = view.findViewById(o0OO00O.tvSend);
        View viewFindViewById4 = view.findViewById(o0OO00O.giftNum);
        int[] iArr = new int[2];
        oooO00o.f30831OooO.getLocationOnScreen(iArr);
        ...
        if (zOooO0o0) {
            int iOooO0OO = o0000O00.OooO0OO() - iArr2[0];
            int i2 = iArr2[1];
            rect = new Rect(iOooO0OO - measuredWidth, i2, iOooO0OO, measuredHeight + i2);
        } else {
            int i3 = iArr2[0];
            int i4 = iArr2[1];
        ...
        arrayList.add(rect2);
        arrayList.add(rect3);
        oooO00o.f30831OooO.setHollowAdapter(new GiftGuideView.OooO00o(arrayList));
