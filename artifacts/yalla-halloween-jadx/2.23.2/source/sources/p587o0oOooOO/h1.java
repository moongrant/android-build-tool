...
public final class h1 extends Lambda implements Function1<View, Unit> {
    ...
    public final /* synthetic */ ScrollableView f56809OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public h1(ScrollableView scrollableView) {
        super(1);
        this.f56809OooO0Oo = scrollableView;
    }
    ...
    public final Unit invoke(View view) {
        ...
        ScrollableView scrollableView = this.f56809OooO0Oo;
        ...
        if (!Intrinsics.areEqual(it.getTag(), Integer.valueOf(scrollableView.f30064OooO0oo))) {
