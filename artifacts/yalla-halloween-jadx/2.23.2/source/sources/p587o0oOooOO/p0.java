...
public final class p0 {
    ...
    @NotNull
    public final FragmentActivity f56916OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    @NotNull
    public final ArrayList f56917OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @Nullable
    public BannerAdapter f56918OooO0OO;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public final Lazy f56919OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    @NotNull
    public final Lazy f56920OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @NotNull
    public final Lazy f56921OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    @NotNull
    public final Lazy f56922OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    @Nullable
    public Function1<? super View, Unit> f56923OooO0oo;
    ...
    public static final class OooO extends Lambda implements Function0<View> {
        ...
        public final View invoke() {
            return View.inflate(p0.this.f56916OooO00o, oo0o0Oo.main_fragment_recommend_banner, null);
        }
    }
    ...
    public static final class OooO0O0 extends Lambda implements Function1<BarBannerModel, Unit> {
        ...
        public final Unit invoke(BarBannerModel barBannerModel) {
            ...
            p0 p0Var = p0.this;
            if (!com.code.android.util.OooO0OO.OooO00o(p0Var.f56916OooO00o) || barBannerModel2 == null) {
                bannerAdapter = p0Var.f56918OooO0OO;
                ...
                if (bannerList == null || bannerList.isEmpty()) {
                    ...
                    BannerAdapter bannerAdapter4 = p0Var.f56918OooO0OO;
                    if (bannerAdapter4 == null) {
                        p0Var.f56918OooO0OO = new BannerAdapter(barBannerModel2.getBannerList());
                        Lazy lazy = p0Var.f56922OooO0oO;
                        Banner banner = (Banner) lazy.getValue();
                        BannerAdapter bannerAdapter5 = p0Var.f56918OooO0OO;
                        ...
                        BannerAdapter bannerAdapter6 = p0Var.f56918OooO0OO;
                        if (bannerAdapter6 != null) {
                            bannerAdapter6.setOnBannerListener(new o00OOO00(p0Var));
                        }
                        ...
                        BannerAdapter bannerAdapter7 = p0Var.f56918OooO0OO;
                        if (bannerAdapter7 != null) {
                            bannerAdapter7.setDatas(null);
                        }
                        BannerAdapter bannerAdapter8 = p0Var.f56918OooO0OO;
                        if (bannerAdapter8 != null) {
                            bannerAdapter8.notifyItemRangeRemoved(0, itemCount2);
                        }
                        BannerAdapter bannerAdapter9 = p0Var.f56918OooO0OO;
                        if (bannerAdapter9 != null) {
                            bannerAdapter9.setDatas(barBannerModel2.getBannerList());
                        }
                        BannerAdapter bannerAdapter10 = p0Var.f56918OooO0OO;
                        if (bannerAdapter10 != null) {
                            bannerAdapter10.notifyItemRangeInserted(0, barBannerModel2.getBannerList().size());
                        }
                    }
                    Function1<? super View, Unit> function2 = p0Var.f56923OooO0oo;
                    if (function2 != null) {
                        function2.invoke((View) p0Var.f56920OooO0o.getValue());
                    }
                }
            }
            return Unit.INSTANCE;
    ...
    public static final class OooO0OO extends Lambda implements Function1<ApiResult<BarBannerModel>, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public static final OooO0OO f56927OooO0Oo = new OooO0OO();
    ...
    public static final class OooO0o extends Lambda implements Function0<Banner<Object, ?>> {
        ...
        public final Banner<Object, ?> invoke() {
            return (Banner) ((View) p0.this.f56920OooO0o.getValue()).findViewById(o0OO00O.banner);
        }
    }
    ...
    public static final class OooOO0 implements Observer, FunctionAdapter {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function1 f56929OooO0Oo;

        public OooOO0(OooO00o function) {
            Intrinsics.checkNotNullParameter(function, "function");
            this.f56929OooO0Oo = function;
        }
        ...
        public final boolean equals(@Nullable Object obj) {
            ...
            return Intrinsics.areEqual(this.f56929OooO0Oo, ((FunctionAdapter) obj).getFunctionDelegate());
        }

        @Override // kotlin.jvm.internal.FunctionAdapter
        @NotNull
        public final Function<?> getFunctionDelegate() {
            return this.f56929OooO0Oo;
        }

        public final int hashCode() {
            return this.f56929OooO0Oo.hashCode();
        }

        @Override // androidx.lifecycle.Observer
        public final /* synthetic */ void onChanged(Object obj) {
            this.f56929OooO0Oo.invoke(obj);
        }
    }
    ...
    public static final class OooOO0O extends Lambda implements Function0<AdVM> {
        ...
        public final AdVM invoke() {
            return (AdVM) new ViewModelProvider(p0.this.f56916OooO00o).get(AdVM.class);
        }
    }
    ...
    public static final class OooOOO0 extends Lambda implements Function0<BannerVM> {
        ...
        public final BannerVM invoke() {
            return (BannerVM) new ViewModelProvider(p0.this.f56916OooO00o).get(BannerVM.class);
        }
    }

    public p0(@NotNull FragmentActivity activity) {
        Intrinsics.checkNotNullParameter(activity, "activity");
        this.f56916OooO00o = activity;
        this.f56917OooO0O0 = new ArrayList();
        this.f56919OooO0Oo = LazyKt.lazy(new OooOOO0());
        this.f56921OooO0o0 = LazyKt.lazy(new OooOO0O());
        this.f56920OooO0o = LazyKt.lazy(new OooO());
        this.f56922OooO0oO = LazyKt.lazy(new OooO0o());
        OooO00o();
        o0O00oO0 o0o00oo1 = o0O00oO0.f47936OooO00o;
        o0O00oO0.OooOo0O().observe(activity, new OooOO0(new OooO00o()));
    }

    public final void OooO00o() {
        this.f56917OooO0O0.clear();
        ((BannerVM) this.f56919OooO0Oo.getValue()).getBarBanner().observe(this.f56916OooO00o, new o000oOoO(new OooO0O0(), null, OooO0OO.f56927OooO0Oo, false, 10));
    }
}
