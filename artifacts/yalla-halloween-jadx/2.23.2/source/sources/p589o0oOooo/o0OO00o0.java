...
public final class o0OO00o0 {
    ...
    public static final String[] f57090OooO00o = {"_id", ShareConstants.WEB_DIALOG_PARAM_TITLE, "title_key", "artist", "artist_id", "artist_key", "composer", "album", "album_id", "album_key", "_display_name", "duration", "_size", "year", "track", "is_ringtone", "is_podcast", "is_alarm", "is_music", "is_notification", "mime_type", "_data"};

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final String[] f57091OooO0O0 = {Environment.getExternalStorageDirectory() + "", Environment.getExternalStorageDirectory() + "/0", Environment.getExternalStorageDirectory() + "/Music", Environment.getExternalStorageDirectory() + "/UCDownloads", Environment.getExternalStorageDirectory() + "/xiami/audios", Environment.getExternalStorageDirectory() + "/netease/cloudmusic/Music"};

    public class OooO00o implements MediaScannerConnection.OnScanCompletedListener {

        /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
        public final /* synthetic */ String[] f57092OooO00o;

        /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
        public final /* synthetic */ OooO0O0 f57093OooO0O0;

        /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
        public final /* synthetic */ Context f57094OooO0OO;

        public OooO00o(String[] strArr, OooO0O0 oooO0O0, Context context) {
            this.f57092OooO00o = strArr;
            this.f57093OooO0O0 = oooO0O0;
            this.f57094OooO0OO = context;
        }

        @Override // android.media.MediaScannerConnection.OnScanCompletedListener
        public final void onScanCompleted(String str, Uri uri) {
            OooO0O0 oooO0O0;
            String[] strArr = this.f57092OooO00o;
            if (!strArr[strArr.length - 1].equals(str) || (oooO0O0 = this.f57093OooO0O0) == null) {
                return;
            }
            oooO0O0.OooO00o(o0OO00o0.OooO00o(this.f57094OooO0OO));
        }
    }
    ...
    public static ArrayList OooO00o(Context context) throws Throwable {
        ...
        ContentResolver contentResolver = context != null ? context.getContentResolver() : App.f22232OooO0o.getContentResolver();
        ?? r12 = 0;
        try {
            try {
                Uri uri = MediaStore.Audio.Media.EXTERNAL_CONTENT_URI;
                String[] strArr = f57090OooO00o;
    ...
    public static void OooO0O0(Context context, OooO0O0 oooO0O0) {
        ...
        ArrayList arrayList = new ArrayList();
        for (String filePath : f57091OooO0O0) {
