...
public final class oOO {
    ...
    public final Context f57163OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final Rect f57164OooO0O0;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    public final OooO00o f57165OooO0OO = new OooO00o();

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public static final HashMap f57157OooO0Oo = new HashMap();

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public static SparseArray<String> f57159OooO0o0 = null;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public static final HashMap f57158OooO0o = new HashMap();

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public static final HashMap f57160OooO0oO = new HashMap();

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public static ArrayList f57161OooO0oo = new ArrayList();

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    public static final String f57156OooO = "<img src=";

    /* JADX INFO: renamed from: OooOO0, reason: collision with root package name */
    public static final String f57162OooOO0 = "\">";
    ...
    public class OooO00o implements Html.ImageGetter {
        ...
        public final Drawable getDrawable(String str) {
            ...
            try {
                ...
                Context context = ooo.f57163OooO00o;
    ...
    public oOO(Context context, Rect rect) {
        this.f57163OooO00o = context;
        this.f57164OooO0O0 = rect;
    }

    public static String OooO00o(String str) {
        while (true) {
            int iIndexOf = str.indexOf(f57156OooO);
            if (iIndexOf == -1) {
                return str;
            }
            str.substring(iIndexOf);
            int iIndexOf2 = str.indexOf(f57162OooOO0);
            if (iIndexOf2 != -1) {
                try {
                    str = str.substring(0, iIndexOf) + f57159OooO0o0.get(o0O0O0Oo.OooOO0O(str.substring(iIndexOf + 10, iIndexOf2))) + str.substring(iIndexOf2 + 2);
    ...
    public static String OooO0O0(String str, ArrayList<? extends oOo00ooO> arrayList) {
        HashMap map = new HashMap();
        for (oOo00ooO ooo00ooo : arrayList) {
            map.put(OooO0OO(Html.toHtml(SpannableString.valueOf(ooo00ooo.f56179OooO + ooo00ooo.f56180OooO0Oo))).replaceAll("<(?!br|img|font|/font|span|/span)[^>]+>", "").trim(), ooo00ooo);
        }
    ...
    public static String OooO0OO(String str) {
        ...
        for (int i = 0; i < strArrSplit.length; i++) {
            ...
            if (iIndexOf > -1) {
                if (iIndexOf > 0) {
                    string = OooOOOO.OooO00o(string, strSubstring.substring(0, iIndexOf));
                    strSubstring = strSubstring.substring(iIndexOf);
                }
                int iOooOO0O = o0O0O0Oo.OooOO0O(strSubstring.replace("&#", ""));
                string = iOooOO0O > 127000 ? o0OoOo0.OooO0O0(string, strSubstring, ";") : string + ((char) iOooOO0O);
            } else {
    ...
    public static ArrayList<String> OooO0o0(String str) {
        ...
        if (str.contains("<font color =\"#00d8c9;\">")) {
            ooo0ooo0 = new oOO0OoO0();
            ooo0ooo0.f57223OooO00o = "<font color =\"#00d8c9;\">";
            ooo0ooo0.f57224OooO0O0 = "</font>";
            ...
            ooo0ooo0 = new oOO0OoO0();
            ooo0ooo0.f57223OooO00o = "<span style=\"color:#00D8C9;\">";
            ooo0ooo0.f57224OooO0O0 = "</span>";
        } else if (str.contains("<span style=\"color:#00D8C9\">")) {
            ooo0ooo0 = new oOO0OoO0();
            ooo0ooo0.f57223OooO00o = "<span style=\"color:#00D8C9\">";
            ooo0ooo0.f57224OooO0O0 = "</span>";
        ...
        for (String str2 : new String(str).split(ooo0ooo0.f57224OooO0O0)) {
            if (!TextUtils.isEmpty(str2)) {
                if (str2.contains(ooo0ooo0.f57223OooO00o)) {
                    String[] strArrSplit = str2.split(ooo0ooo0.f57223OooO00o);
    ...
    public static void OooO0oO() {
        boolean z;
        NodeList nodeList;
        if (f57161OooO0oo == null) {
            f57161OooO0oo = new ArrayList();
        }
        if (f57161OooO0oo.isEmpty()) {
            App app = App.f22232OooO0o;
            z zVar = new z();
            try {
                Document document = DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(app.getResources().openRawResource(o000OOo.faceconfig_mr));
                zVar.f57308OooO00o = document;
                zVar.f57309OooO0O0 = document.getDocumentElement();
                z = true;
            } catch (Exception e) {
                e.printStackTrace();
                z = false;
            ...
            if (z) {
                if (zVar.f57309OooO0O0 != null) {
                    try {
                        String[] strArrSplit = "FC".split("/");
                        Element element = zVar.f57309OooO0O0;
                        ...
                        zVar.f57310OooO0OO = elementsByTagName;
                        if (elementsByTagName.getLength() == 0 && element.getNodeName().equals(arrayList.get(arrayList.size() - 1)) && element == zVar.f57309OooO0O0) {
                            zVar.f57310OooO0OO = zVar.f57308OooO00o.getChildNodes();
                        }
                        nodeList = zVar.f57310OooO0OO;
                        if (nodeList == null) {
                            nodeList = null;
                        }
                    } catch (Exception e3) {
                    ...
                    zVar.f57310OooO0OO = nodeList;
                    zVar.f57312OooO0o0 = 0;
                }
                f57159OooO0o0 = new SparseArray<>();
                while (true) {
                    try {
                        zVar.f57311OooO0Oo = null;
                        zVar.f57311OooO0Oo = zVar.f57310OooO0OO.item(zVar.f57312OooO0o0);
                        zVar.f57312OooO0o0++;
                    } catch (Exception unused) {
                    }
                    if (zVar.f57311OooO0Oo == null) {
                        break;
                    }
                    try {
                        FaceModel faceModel = new FaceModel();
                        faceModel.sHotKey = zVar.OooO00o("HK");
                        faceModel.sFilePath = zVar.OooO00o("FP");
                        faceModel.sName = zVar.OooO00o("FN");
                        f57157OooO0Oo.put(faceModel.sHotKey, faceModel);
                        ...
                        f57159OooO0o0.put(identifier, faceModel.sHotKey);
                        f57158OooO0o.put(faceModel.sHotKey, Integer.valueOf(identifier));
                        oo000o.OooO0Oo(identifier, faceModel.sHotKey);
                        if (f57161OooO0oo == null) {
                            f57161OooO0oo = new ArrayList();
                        }
                        f57161OooO0oo.add(faceModel);
                    } catch (Exception e4) {
                        e4.printStackTrace();
                    }
                }
                ...
                Collections.sort(f57161OooO0oo, new ooooO0O0());
            }
        }
    }
                ...
                try {
                    ...
                    if (faceModel != null) {
                        ...
                        try {
                            ...
                            try {
                                if (o000OOo.class.getField(strSubstring2) != null) {
                                    i3 = 16;
                                    try {
                                        strReplaceAll = Pattern.compile(strSubstring, 16).matcher(str3).replaceAll("<img src='" + o000OOo.class.getField(strSubstring2).get(context) + "'/>");
                                    } catch (Exception unused) {
                        ...
                        if (faceModel2 != null) {
                            ...
                            try {
                                if (o000OOo.class.getField(strSubstring3) != null) {
                                    strReplaceAll = Pattern.compile(strSubstring, 16).matcher(str3).replaceAll("<img src='" + o000OOo.class.getField(strSubstring3).get(context) + "'/>");
                                    str3 = strReplaceAll;
                                }
                            ...
                            if (faceModel3 != null) {
                                ...
                                try {
                                    if (o000OOo.class.getField(strSubstring4) != null) {
                                        strReplaceAll = Pattern.compile(strSubstring, 16).matcher(str3).replaceAll("<img src='" + o000OOo.class.getField(strSubstring4).get(context) + "'/>");
                                        str3 = strReplaceAll;
                                    }
