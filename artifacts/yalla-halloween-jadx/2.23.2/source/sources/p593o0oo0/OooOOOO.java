...
public final class OooOOOO extends ScrollingMovementMethod {

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public static final NoCopySpan.Concrete f57325OooO0O0 = new NoCopySpan.Concrete();

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public OooO00o f57326OooO00o = null;
    ...
    public static boolean OooO00o(TextView textView, Spannable spannable, int i) {
        ...
        if (iMin < 0 && spannable.getSpanStart(f57325OooO0O0) >= 0) {
    ...
    public final void initialize(TextView textView, Spannable spannable) {
        ...
        spannable.removeSpan(f57325OooO0O0);
    }
    ...
    public final void onTakeFocus(TextView textView, Spannable spannable, int i) {
        Selection.removeSelection(spannable);
        int i2 = i & 1;
        NoCopySpan.Concrete concrete = f57325OooO0O0;
        if (i2 != 0) {
    ...
    public final boolean onTouchEvent(TextView textView, Spannable spannable, MotionEvent motionEvent) {
        ...
        try {
            if (action == 0 || action == 1) {
                o0000O00.OooO0O0("action = ".concat(action == 1 ? "MotionEvent_ACTION_UP" : "MotionEvent_ACTION_DOWN"));
                ...
                if (action == 1) {
                    if (clickableSpanArr.length != 0) {
                        ...
                        OooO00o oooO00o = this.f57326OooO00o;
                        if (oooO00o != null) {
                            oooO00o.OooO0Oo();
                        }
                    }
                ...
                o0000O00.OooO0O0("MotionEvent_ACTION_MOVE ");
                return false;
            }
        } catch (Exception e) {
            e.printStackTrace();
