...
public final class OooO0OO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ String f57328OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ Map<String, Object> f57329OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ String f57330OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OooO0OO(String str, String str2, Map<String, ? extends Object> map, Continuation<? super OooO0OO> continuation) {
        super(2, continuation);
        this.f57328OooO0Oo = str;
        this.f57330OooO0o0 = str2;
        this.f57329OooO0o = map;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new OooO0OO(this.f57328OooO0Oo, this.f57330OooO0o0, this.f57329OooO0o, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        BuriedPoint buriedPointCreate = BuriedPoint.Factory.INSTANCE.create(this.f57328OooO0Oo, this.f57330OooO0o0, this.f57329OooO0o);
