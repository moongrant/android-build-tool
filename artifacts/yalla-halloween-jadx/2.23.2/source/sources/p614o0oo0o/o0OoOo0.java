...
public final class o0OoOo0 implements YCSDKCallback {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final /* synthetic */ Function1<BaseResp, Unit> f57538OooO00o;

    /* JADX WARN: Multi-variable type inference failed */
    public o0OoOo0(Function1<? super BaseResp, Unit> function1) {
        this.f57538OooO00o = function1;
    }
    ...
    public final void onResult(@NotNull BaseResp result) {
        ...
        o0000O00.OooO0O0("YallaChatSDK toConversationRequestisSuccess = " + result.isSuccess() + "code = " + result.getCode() + " message = " + result.getMsg());
        this.f57538OooO00o.invoke(result);
