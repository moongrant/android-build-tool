...
public final class oo000o implements YCSDKCallback {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    public final /* synthetic */ Function1<BaseResp, Unit> f57539OooO00o;

    /* JADX WARN: Multi-variable type inference failed */
    public oo000o(Function1<? super BaseResp, Unit> function1) {
        this.f57539OooO00o = function1;
    }
    ...
    public final void onResult(@NotNull BaseResp result) {
        ...
        o0000O00.OooO0O0("YallaChatSDK toGroupJoinisSuccess = " + result.isSuccess() + "code = " + result.getCode() + " message = " + result.getMsg());
        this.f57539OooO00o.invoke(result);
