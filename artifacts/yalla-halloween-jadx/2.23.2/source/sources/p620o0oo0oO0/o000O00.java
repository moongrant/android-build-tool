...
public final class o000O00 {
    ...
    public static Bitmap OooO00o(@NotNull EvaSrc src) {
        ...
        int i = src.f32413OooO0O0;
        Bitmap.Config config = Bitmap.Config.ARGB_8888;
        int i2 = src.f32414OooO0OO;
        Bitmap bitmap = Bitmap.createBitmap(i, i2, config);
        Canvas canvas = new Canvas(bitmap);
        Rect rect = new Rect(0, 0, i, i2);
        Rect rect2 = new Rect();
        TextPaint textPaint = new TextPaint();
        float f = src.f32422OooOO0o;
        textPaint.setTextSize(f);
        String str = src.f32423OooOOO0;
        ...
        if (src.f32420OooOO0 == EvaSrc.Style.BOLD) {
            textPaint.setTypeface(Typeface.create(Typeface.DEFAULT, 1));
        }
        textPaint.setColor(src.f32421OooOO0O);
        String string = TextUtils.ellipsize(src.f32411OooO, textPaint, i, TextUtils.TruncateAt.END).toString();
        float f2 = 0.8f;
        while (f2 > 0.1f) {
