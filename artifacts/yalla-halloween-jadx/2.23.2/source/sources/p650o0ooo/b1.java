...
public final class b1 extends Lambda implements Function3<ColumnScope, Composer, Integer, Unit> {
    ...
    public final /* synthetic */ GifListJson f58158OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public b1(GifListJson gifListJson) {
        super(3);
        this.f58158OooO0Oo = gifListJson;
    }
    ...
    public final Unit invoke(ColumnScope columnScope, Composer composer, Integer num) {
        ...
        if ((iIntValue & 81) == 16 && composer2.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1362092999, iIntValue, -1, "com.yalla.yalla.ui.dialog.RoomGifBuyDialogUtil.showRoomGifBuyDialog.<anonymous>.<anonymous> (RoomGifBuyDialogUtil.kt:38)");
            }
            GifListJson gifListJson = this.f58158OooO0Oo;
            ...
            if (beforeTips2 != null) {
                ...
                if (z) {
                    ...
                    long j = o0OOo000.f48280o000oo0O;
                    int i = length + iIndexOf$default2;
                    builder.addStyle(new SpanStyle(Color.m1680copywmQWz5c$default(j, 0.6f, 0.0f, 0.0f, 0.0f, 14, null), 0L, (FontWeight) null, (FontStyle) null, (FontSynthesis) null, (FontFamily) null, (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, TextDecoration.INSTANCE.getLineThrough(), (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 61438, (DefaultConstructorMarker) null), iIndexOf$default2, i);
                    int i2 = i + 1;
                    ...
                    long j2 = o0OOo000.f48280o000oo0O;
                    ...
                    int i4 = i3 + 1;
                    builder.addStyle(new SpanStyle(Color.m1680copywmQWz5c$default(j2, 0.6f, 0.0f, 0.0f, 0.0f, 14, null), 0L, (FontWeight) null, (FontStyle) null, (FontSynthesis) null, (FontFamily) null, (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, TextDecoration.INSTANCE.getLineThrough(), (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 61438, (DefaultConstructorMarker) null), i4, String.valueOf(price).length() + i4);
                }
                TextKt.m1262TextIbK3jfQ(builder.toAnnotatedString(), PaddingKt.m480paddingVpY3zN4$default(Modifier.INSTANCE, Dp.m3775constructorimpl(25), 0.0f, 2, null), o0OOo000.f48278o000oo0, TextUnitKt.getSp(15), null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, null, null, composer2, 3120, 0, 262128);
                if (ComposerKt.isTraceInProgress()) {
