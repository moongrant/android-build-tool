...
public final class c extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ String f58164OooO0Oo;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ int f58165OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public c(String str, int i) {
        super(2);
        this.f58164OooO0Oo = str;
        this.f58165OooO0o0 = i;
    }
    ...
    public final Unit invoke(Composer composer, Integer num) {
        ...
        if ((iIntValue & 11) == 2 && composer3.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-434339684, iIntValue, -1, "com.yalla.yalla.ui.dialog.OldLoadingDialogCompose.<anonymous> (OldLoadingDialogCompose.kt:36)");
            }
            ...
            if (!StringsKt.isBlank(str)) {
                androidx.compose.ui.semantics.OooO0O0.OooO0O0(12, companion, composer3, 6);
                composer2 = composer3;
                TextKt.m1261Text4IGK_g(str, (Modifier) null, o0OOo000.f48147OooOOOO, TextUnitKt.getSp(14), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, (14 & (this.f58165OooO0o0 >> 3)) | 3072, 0, 131058);
            } else {
                composer2 = composer3;
            }
