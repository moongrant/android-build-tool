...
public final class i5 {
    ...
    @NotNull
    public static final i5 f58278OooO00o = new i5();

    public static final class OooO extends Lambda implements Function2<Composer, Integer, Unit> {

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ Function1<VipLevel, Unit> f58280OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public final /* synthetic */ MutableState<Boolean> f58281OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ int f58282OooO0oO;

        /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
        public final /* synthetic */ int f58283OooO0oo;
        ...
        public OooO(MutableState<Boolean> mutableState, Function1<? super VipLevel, Unit> function1, int i, int i2) {
            super(2);
            this.f58281OooO0o0 = mutableState;
            this.f58280OooO0o = function1;
            this.f58282OooO0oO = i;
            this.f58283OooO0oo = i2;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Unit invoke(Composer composer, Integer num) {
            num.intValue();
            i5.this.OooO00o(this.f58281OooO0o0, this.f58280OooO0o, composer, RecomposeScopeImplKt.updateChangedFlags(this.f58282OooO0oO | 1), this.f58283OooO0oo);
    ...
    public static final class OooO0O0 extends Lambda implements Function3<ColumnScope, Composer, Integer, Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ VipLevel f58284OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0O0(VipLevel vipLevel) {
            super(3);
            this.f58284OooO0Oo = vipLevel;
        }
        ...
        public final Unit invoke(ColumnScope columnScope, Composer composer, Integer num) {
            ...
            if ((iIntValue & 81) == 16 && composer2.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(114092823, iIntValue, -1, "com.yalla.yalla.ui.dialog.VipAddedDialog.OnAddVip6Dialog.<anonymous> (VipAddedDialog.kt:44)");
                }
                ...
                oO0OO.OooO00o.OooOo0O(Integer.valueOf(VipState.Vip.getValue()), Integer.valueOf(this.f58284OooO0Oo.getValue()), Dp.m3775constructorimpl(100), null, composer2, 265264, 20);
    ...
    public static final class OooO0OO extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ VipVm f58285OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooO0OO(VipVm vipVm) {
            super(0);
            this.f58285OooO0Oo = vipVm;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            o00Ooo.OooOO0O().OooOOO0(VipLevel.Vip6.level());
            this.f58285OooO0Oo.getAddVip6Dialog().setValue(Boolean.FALSE);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class OooO0o extends Lambda implements Function0<Unit> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public final /* synthetic */ Function1<VipLevel, Unit> f58286OooO0Oo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public OooO0o(Function1<? super VipLevel, Unit> function1) {
            super(0);
            this.f58286OooO0Oo = function1;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Unit invoke() {
            Function1<VipLevel, Unit> function1 = this.f58286OooO0Oo;
            if (function1 != null) {
    ...
    public final void OooO00o(@NotNull MutableState<Boolean> isShow, @Nullable Function1<? super VipLevel, Unit> function1, @Nullable Composer composer, int i, int i2) {
        ...
        if (i5 == 0) {
            ...
            if ((i4 & 91) == 18 || !composerStartRestartGroup.getSkipping()) {
                ...
                String strStringResource = StringResources_androidKt.stringResource(o000000.add_vip6_dialog_title, composerStartRestartGroup, 0);
                String strOooO00o = o0000O.OooO00o(StringResources_androidKt.stringResource(o000000.add_vip6_dialog_content_XXX, composerStartRestartGroup, 0), String.valueOf(vipLevel.level()));
                String strOooO00o2 = o0000O.OooO00o(StringResources_androidKt.stringResource(o000000.add_vip6_dialog_button_XXXX, composerStartRestartGroup, 0), String.valueOf(vipLevel.level()));
                ...
                o000O0Oo.OooO0Oo(isShow, strStringResource, strOooO00o, composableLambda, true, false, null, oooO0OO, strOooO00o2, false, null, false, (Function0) objRememberedValue, null, false, false, null, null, null, null, composer2, (i4 & 14) | 27648, 0, 1044064);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                function2 = function4;
        ...
        if ((i4 & 91) == 18) {
            ...
            composerStartRestartGroup.endReplaceableGroup();
            EffectsKt.LaunchedEffect(Unit.INSTANCE, new OooO00o(null), composerStartRestartGroup, 70);
            String strStringResource2 = StringResources_androidKt.stringResource(o000000.add_vip6_dialog_title, composerStartRestartGroup, 0);
            String strOooO00o3 = o0000O.OooO00o(StringResources_androidKt.stringResource(o000000.add_vip6_dialog_content_XXX, composerStartRestartGroup, 0), String.valueOf(vipLevel.level()));
            String strOooO00o4 = o0000O.OooO00o(StringResources_androidKt.stringResource(o000000.add_vip6_dialog_button_XXXX, composerStartRestartGroup, 0), String.valueOf(vipLevel.level()));
            ...
            composer2 = composerStartRestartGroup;
            o000O0Oo.OooO0Oo(isShow, strStringResource2, strOooO00o3, composableLambda2, true, false, null, oooO0OO2, strOooO00o4, false, null, false, (Function0) objRememberedValue, null, false, false, null, null, null, null, composer2, (i4 & 14) | 27648, 0, 1044064);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            function2 = function5;
            ...
            composerStartRestartGroup.endReplaceableGroup();
            EffectsKt.LaunchedEffect(Unit.INSTANCE, new OooO00o(null), composerStartRestartGroup, 70);
            String strStringResource3 = StringResources_androidKt.stringResource(o000000.add_vip6_dialog_title, composerStartRestartGroup, 0);
            String strOooO00o5 = o0000O.OooO00o(StringResources_androidKt.stringResource(o000000.add_vip6_dialog_content_XXX, composerStartRestartGroup, 0), String.valueOf(vipLevel.level()));
            String strOooO00o6 = o0000O.OooO00o(StringResources_androidKt.stringResource(o000000.add_vip6_dialog_button_XXXX, composerStartRestartGroup, 0), String.valueOf(vipLevel.level()));
            ...
            composer2 = composerStartRestartGroup;
            o000O0Oo.OooO0Oo(isShow, strStringResource3, strOooO00o5, composableLambda3, true, false, null, oooO0OO3, strOooO00o6, false, null, false, (Function0) objRememberedValue, null, false, false, null, null, null, null, composer2, (i4 & 14) | 27648, 0, 1044064);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            function2 = function6;
