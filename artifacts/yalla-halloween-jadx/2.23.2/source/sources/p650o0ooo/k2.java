...
public final class k2 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ RoomVoteDialog f58361OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public k2(RoomVoteDialog roomVoteDialog) {
        super(0);
        this.f58361OooO0Oo = roomVoteDialog;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        this.f58361OooO0Oo.f27501OooOOoo = true;
        RoomGameConfig.Vote value = OooO0O0.f24533OoooOOO.OooO00o().f24575Oooo0oO.getValue();
