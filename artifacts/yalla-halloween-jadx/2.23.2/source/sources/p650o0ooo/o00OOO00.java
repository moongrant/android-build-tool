...
public final class o00OOO00 extends Lambda implements Function1<TextFieldValue, Unit> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ int f58567OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ int f58568OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ MutableState<TextFieldValue> f58569OooO0o0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o00OOO00(int i, int i2, MutableState mutableState) {
        super(1);
        this.f58567OooO0Oo = i;
        this.f58569OooO0o0 = mutableState;
        this.f58568OooO0o = i2;
    }
    ...
    public final Unit invoke(TextFieldValue textFieldValue) {
        ...
        MutableState<TextFieldValue> mutableState = this.f58569OooO0o0;
        int i = this.f58567OooO0Oo;
        if (iOooO0o0 < i) {
