...
public final class o0O00O0o extends Lambda implements Function1<LazyListScope, Unit> {

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    public final /* synthetic */ MomentFollowingTopUserVM f58625OooO0Oo;

    /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
    public final /* synthetic */ MutableState<o000OO> f58626OooO0o;

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    public final /* synthetic */ FragmentActivity f58627OooO0o0;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public final /* synthetic */ l f58628OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public final /* synthetic */ RecommendNewPostModel f58629OooO0oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0O00O0o(MomentFollowingTopUserVM momentFollowingTopUserVM, FragmentActivity fragmentActivity, MutableState<o000OO> mutableState, l lVar, RecommendNewPostModel recommendNewPostModel) {
        super(1);
        this.f58625OooO0Oo = momentFollowingTopUserVM;
        this.f58627OooO0o0 = fragmentActivity;
        this.f58626OooO0o = mutableState;
        this.f58628OooO0oO = lVar;
        this.f58629OooO0oo = recommendNewPostModel;
    }
    ...
    public final Unit invoke(LazyListScope lazyListScope) {
        ...
        MomentFollowingTopUserVM momentFollowingTopUserVM = this.f58625OooO0Oo;
        ...
        final l lVar = this.f58628OooO0oO;
        final MutableState<o000OO> mutableState = this.f58626OooO0o;
        final FragmentActivity fragmentActivity = this.f58627OooO0o0;
        LazyColumn.items(size, null, function1, ComposableLambdaKt.composableLambdaInstance(-1091073711, true, new Function4<LazyItemScope, Integer, Composer, Integer, Unit>() { // from class: com.yalla.yalla.ui.dialog.FollowingMomentTopUserDialogKt$FollowingUserMomentContent$2$3$3$1$invoke$$inlined$itemsIndexed$default$3
            ...
            public final Unit invoke(LazyItemScope lazyItemScope, Integer num, Composer composer, Integer num2) {
                ...
                if ((i & 731) == 146 && composer2.getSkipping()) {
                    ...
                    oo0oOO0.OooO00o(momentDetailModel, iIntValue, (o000OO) mutableState.getValue(), MomentAdapterTag.MomentListFollowingFragment_Top, fragmentActivity, EnterRoomParentPage.Moments_Following_SharedRoom, new o0O000o0(lVar), false, false, null, false, 0L, null, null, null, null, composer2, (i2 & 112) | 232968, 0, 65408);
        ...
        if (momentFollowingTopUserVM.getListData().size() > 0) {
            LazyListScope.CC.OooO(LazyColumn, null, null, ComposableLambdaKt.composableLambdaInstance(-259800009, true, new o0OoO00O(momentFollowingTopUserVM, this.f58629OooO0oo)), 3, null);
        }
        return Unit.INSTANCE;
    }
}
