...
public final class o0OO0 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ RoomUserInfoModel f58676OooO0Oo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0OO0(RoomUserInfoModel roomUserInfoModel) {
        super(0);
        this.f58676OooO0Oo = roomUserInfoModel;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        String uid = String.valueOf(this.f58676OooO0Oo.getUserId().getValue().longValue());
