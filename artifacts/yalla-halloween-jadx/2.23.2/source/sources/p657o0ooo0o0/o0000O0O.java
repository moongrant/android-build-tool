...
public final class o0000O0O extends o000O0o {
    ...
    public static final boolean f59612OooO0Oo;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @NotNull
    public final Provider f59613OooO0OO = new BouncyCastleJsseProvider();
    ...
    public final SSLContext OooOO0o() throws NoSuchAlgorithmException {
        SSLContext sSLContext = SSLContext.getInstance("TLS", this.f59613OooO0OO);
