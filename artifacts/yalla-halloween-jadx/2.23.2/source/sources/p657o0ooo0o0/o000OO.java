...
public final class o000OO extends o000O0o {
    ...
    public static final boolean f59620OooO0Oo;

    /* JADX INFO: renamed from: OooO0OO, reason: collision with root package name */
    @NotNull
    public final Provider f59621OooO0OO;
    ...
    public static final class OooO0O0 implements ConscryptHostnameVerifier {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        @NotNull
        public static final OooO0O0 f59622OooO0Oo = new OooO0O0();
    ...
    public o000OO() {
        ...
        this.f59621OooO0OO = providerNewProvider;
    }
    ...
    public final SSLContext OooOO0o() throws NoSuchAlgorithmException {
        SSLContext sSLContext = SSLContext.getInstance("TLS", this.f59621OooO0OO);
    ...
    public final X509TrustManager OooOOO() throws NoSuchAlgorithmException, KeyStoreException {
        ...
        Conscrypt.setHostnameVerifier(x509TrustManager, OooO0O0.f59622OooO0Oo);
