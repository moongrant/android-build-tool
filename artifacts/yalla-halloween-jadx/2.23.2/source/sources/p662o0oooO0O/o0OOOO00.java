...
public final class o0OOOO00 implements Comparable<o0OOOO00> {

    /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
    @JvmField
    @NotNull
    public static final String f59787OooO0o0;

    /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
    @NotNull
    public final ByteString f59788OooO0Oo;
    ...
    public static final class OooO00o {
        ...
        @NotNull
        @JvmOverloads
        public static o0OOOO00 OooO00o(@NotNull String str, boolean z) {
            Intrinsics.checkNotNullParameter(str, "<this>");
            ByteString byteString = o0O0ooO.f59653OooO00o;
            Intrinsics.checkNotNullParameter(str, "<this>");
            oo0OOoo oo0oooo = new oo0OOoo();
            oo0oooo.o00000OO(str);
            return o0O0ooO.OooO0Oo(oo0oooo, z);
        }

        public static o0OOOO00 OooO0O0(File file) {
    ...
    static {
        ...
        f59787OooO0o0 = separator;
    }

    public o0OOOO00(@NotNull ByteString bytes) {
        Intrinsics.checkNotNullParameter(bytes, "bytes");
        this.f59788OooO0Oo = bytes;
    }

    @NotNull
    public final ArrayList OooO00o() {
        ArrayList arrayList = new ArrayList();
        int iOooO00o = o0O0ooO.OooO00o(this);
        ByteString byteString = this.f59788OooO0Oo;
        if (iOooO00o == -1) {
            iOooO00o = 0;
    ...
    public final o0OOOO00 OooO0O0() {
        o0OOOO00 o0oooo01;
        ByteString byteString = o0O0ooO.f59656OooO0Oo;
        ByteString byteString2 = this.f59788OooO0Oo;
        if (!Intrinsics.areEqual(byteString2, byteString)) {
            ByteString byteString3 = o0O0ooO.f59653OooO00o;
            if (!Intrinsics.areEqual(byteString2, byteString3)) {
                ByteString prefix = o0O0ooO.f59654OooO0O0;
                if (!Intrinsics.areEqual(byteString2, prefix)) {
                    ByteString suffix = o0O0ooO.f59657OooO0o0;
                    ...
                    if (!(byteString2.OooOOO(iOooO0o0 - bArr.length, suffix, bArr.length) && (byteString2.OooO0o0() == 2 || byteString2.OooOOO(byteString2.OooO0o0() + (-3), byteString3, 1) || byteString2.OooOOO(byteString2.OooO0o0() + (-3), prefix, 1)))) {
                        ...
                        if (iOooOO0o != 2 || OooO0o() == null) {
                            ...
                            if (iOooOO0o != -1 || OooO0o() == null) {
                                if (iOooOO0o == -1) {
                                    return new o0OOOO00(byteString);
                                }
                                o0oooo01 = iOooOO0o == 0 ? new o0OOOO00(ByteString.OooOOo0(byteString2, 0, 1, 1)) : new o0OOOO00(ByteString.OooOOo0(byteString2, 0, iOooOO0o, 1));
                            } else if (byteString2.OooO0o0() != 2) {
                                o0oooo01 = new o0OOOO00(ByteString.OooOOo0(byteString2, 0, 2, 1));
                            }
                            return o0oooo01;
                        }
                        if (byteString2.OooO0o0() != 3) {
                            o0oooo01 = new o0OOOO00(ByteString.OooOOo0(byteString2, 0, 3, 1));
                            return o0oooo01;
                        }
                    }
                }
    ...
    @NotNull
    public final o0OOOO00 OooO0OO(@NotNull String child) {
        Intrinsics.checkNotNullParameter(child, "child");
        oo0OOoo oo0oooo = new oo0OOoo();
        oo0oooo.o00000OO(child);
        return o0O0ooO.OooO0O0(this, o0O0ooO.OooO0Oo(oo0oooo, false), false);
    }
    ...
    */
    ...
    public final int compareTo(o0OOOO00 o0oooo01) {
        o0OOOO00 other = o0oooo01;
        Intrinsics.checkNotNullParameter(other, "other");
        return this.f59788OooO0Oo.compareTo(other.f59788OooO0Oo);
    }

    public final boolean equals(@Nullable Object obj) {
        return (obj instanceof o0OOOO00) && Intrinsics.areEqual(((o0OOOO00) obj).f59788OooO0Oo, this.f59788OooO0Oo);
    }

    public final int hashCode() {
        return this.f59788OooO0Oo.hashCode();
    }

    @NotNull
    public final String toString() {
        return this.f59788OooO0Oo.OooOo00();
    }
}
