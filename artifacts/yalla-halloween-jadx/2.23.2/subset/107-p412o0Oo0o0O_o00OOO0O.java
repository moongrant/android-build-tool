...
public final class o00OOO0O extends oO0O000o {

    /* JADX INFO: renamed from: OooO00o, reason: collision with root package name */
    @NotNull
    public static final o00OOO0O f46207OooO00o = new o00OOO0O();
    ...
    public static final class OooO extends ContinuationImpl {
        ...
        public /* synthetic */ Object f46208OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public int f46209OooO0o;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f46208OooO0Oo = obj;
            this.f46209OooO0o |= Integer.MIN_VALUE;
            return o00OOO0O.this.OooO0oO(this);
        }
    }
    ...
    public static final class OooO0OO extends ContinuationImpl {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            return o00OOO0O.this.OooO0o0(this);
        }
    }
    ...
    public static final class OooO0o extends ContinuationImpl {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            return o00OOO0O.this.OooO0o(0, 0, this);
        }
    }
    ...
    public static final class OooOO0 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            return o00OOO0O.this.OooO0oo(0, this);
        }
    }
    ...
    public static final class OooOO0O extends ContinuationImpl {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            return o00OOO0O.this.OooO(0L, this);
        }
    }
    ...
    public static final class OooOOO extends ContinuationImpl {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            return o00OOO0O.this.OooOO0O(0L, 0, 0, this);
        }
    }
    ...
    public static final class OooOOO0 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            return o00OOO0O.this.OooOO0(null, 0, this);
        }
    }
    ...
    public static final class OooOOOO extends ContinuationImpl {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            return o00OOO0O.this.OooOO0o(0L, 0L, this);
        }
    }
    ...
    public final Object OooO(long j, @NotNull Continuation<? super ApiResult<ThemeBoughtModel>> continuation) {
        ...
        if (continuation instanceof OooOO0O) {
            ...
            int i = oooOO0O.f46227OooO0o;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooOO0O.f46227OooO0o = i - Integer.MIN_VALUE;
            } else {
    ...
    public final Object OooO0OO(@NotNull Continuation<? super ApiResult<List<CustomPrices>>> continuation) {
        ...
        if (continuation instanceof OooO00o) {
            ...
            int i = oooO00o.f46212OooO0o;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO00o.f46212OooO0o = i - Integer.MIN_VALUE;
            } else {
        ...
        Object customRoomThemePrices = oooO00o.f46211OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = oooO00o.f46212OooO0o;
        try {
            if (i2 == 0) {
                ResultKt.throwOnFailure(customRoomThemePrices);
                MainApiService mainApiServiceOooO00o = p384o0OOoo0O.OooOOO.OooO00o();
                oooO00o.f46212OooO0o = 1;
    ...
    public final Object OooO0Oo(@NotNull Continuation<? super ApiResult<Integer>> continuation) {
        ...
        if (continuation instanceof OooO0O0) {
            ...
            int i = oooO0O0.f46215OooO0o;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO0O0.f46215OooO0o = i - Integer.MIN_VALUE;
            } else {
        ...
        Object roomThemeGiveCount = oooO0O0.f46214OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = oooO0O0.f46215OooO0o;
        try {
            if (i2 == 0) {
                ResultKt.throwOnFailure(roomThemeGiveCount);
                MainApiService mainApiServiceOooO00o = p384o0OOoo0O.OooOOO.OooO00o();
                oooO0O0.f46215OooO0o = 1;
    ...
    public final Object OooO0o(int i, int i2, @NotNull Continuation<? super ApiResult<MyThemeListModel>> continuation) {
        ...
        if (continuation instanceof OooO0o) {
            ...
            int i3 = oooO0o.f46221OooO0o;
            if ((i3 & Integer.MIN_VALUE) != 0) {
                oooO0o.f46221OooO0o = i3 - Integer.MIN_VALUE;
            } else {
        ...
        Object objShopRoomThemeList = oooO0o.f46220OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i4 = oooO0o.f46221OooO0o;
        try {
            if (i4 == 0) {
                ResultKt.throwOnFailure(objShopRoomThemeList);
                MainApiService mainApiServiceOooO00o = p384o0OOoo0O.OooOOO.OooO00o();
                oooO0o.f46221OooO0o = 1;
    ...
    public final Object OooO0o0(@NotNull Continuation<? super ApiResult<List<CustomizeThemeModel>>> continuation) {
        ...
        if (continuation instanceof OooO0OO) {
            ...
            int i = oooO0OO.f46218OooO0o;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO0OO.f46218OooO0o = i - Integer.MIN_VALUE;
            } else {
        ...
        Object objCustomizeRoomThemeList = oooO0OO.f46217OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = oooO0OO.f46218OooO0o;
        try {
            if (i2 == 0) {
                ResultKt.throwOnFailure(objCustomizeRoomThemeList);
                MainApiService mainApiServiceOooO00o = p384o0OOoo0O.OooOOO.OooO00o();
                oooO0OO.f46218OooO0o = 1;
    ...
    public final Object OooO0oO(@NotNull Continuation<? super ApiResult<List<ThemeListModel>>> continuation) {
        ...
        if (continuation instanceof OooO) {
            ...
            int i = oooO.f46209OooO0o;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooO.f46209OooO0o = i - Integer.MIN_VALUE;
            } else {
        ...
        Object objShopRoomThemeListTop = oooO.f46208OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = oooO.f46209OooO0o;
        try {
            if (i2 == 0) {
    ...
    public final Object OooO0oo(int i, @NotNull Continuation<? super ApiResult<List<ThemeModel>>> continuation) {
        ...
        if (continuation instanceof OooOO0) {
            ...
            int i2 = oooOO1.f46224OooO0o;
            if ((i2 & Integer.MIN_VALUE) != 0) {
                oooOO1.f46224OooO0o = i2 - Integer.MIN_VALUE;
            } else {
        ...
        Object objShopRoomThemeListByType = oooOO1.f46223OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i3 = oooOO1.f46224OooO0o;
        try {
            if (i3 == 0) {
                ResultKt.throwOnFailure(objShopRoomThemeListByType);
                MainApiService mainApiServiceOooO00o = p384o0OOoo0O.OooOOO.OooO00o();
                oooOO1.f46224OooO0o = 1;
    ...
    public final Object OooOO0(@NotNull String str, int i, @NotNull Continuation<? super ApiResult<RenewCustomizeTheme>> continuation) {
        ...
        if (continuation instanceof OooOOO0) {
            ...
            int i2 = oooOOO0.f46233OooO0o;
            if ((i2 & Integer.MIN_VALUE) != 0) {
                oooOOO0.f46233OooO0o = i2 - Integer.MIN_VALUE;
            } else {
        ...
        Object objPurchaseCustomImage = oooOOO0.f46232OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i3 = oooOOO0.f46233OooO0o;
        try {
            if (i3 == 0) {
                ResultKt.throwOnFailure(objPurchaseCustomImage);
                MainApiService mainApiServiceOooO00o = p384o0OOoo0O.OooOOO.OooO00o();
                oooOOO0.f46233OooO0o = 1;
    ...
    public final Object OooOO0O(long j, int i, int i2, @NotNull Continuation<? super ApiResult<RenewCustomizeTheme>> continuation) {
        ...
        if (continuation instanceof OooOOO) {
            ...
            int i3 = oooOOO.f46230OooO0o;
            if ((i3 & Integer.MIN_VALUE) != 0) {
                oooOOO.f46230OooO0o = i3 - Integer.MIN_VALUE;
            } else {
        ...
        Object objRenewCustomTheme = oooOOO2.f46229OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i4 = oooOOO2.f46230OooO0o;
        try {
            if (i4 == 0) {
                ResultKt.throwOnFailure(objRenewCustomTheme);
                MainApiService mainApiServiceOooO00o = p384o0OOoo0O.OooOOO.OooO00o();
                oooOOO2.f46230OooO0o = 1;
    ...
    public final Object OooOO0o(long j, long j2, @NotNull Continuation<? super ApiResult<String>> continuation) {
        ...
        if (continuation instanceof OooOOOO) {
            ...
            int i = oooOOOO.f46236OooO0o;
            if ((i & Integer.MIN_VALUE) != 0) {
                oooOOOO.f46236OooO0o = i - Integer.MIN_VALUE;
            } else {
        ...
        Object objRoomThemeEdit = oooOOOO2.f46235OooO0Oo;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = oooOOOO2.f46236OooO0o;
        try {
            if (i2 == 0) {
                ResultKt.throwOnFailure(objRoomThemeEdit);
                MainApiService mainApiServiceOooO00o = p384o0OOoo0O.OooOOO.OooO00o();
                oooOOOO2.f46236OooO0o = 1;
