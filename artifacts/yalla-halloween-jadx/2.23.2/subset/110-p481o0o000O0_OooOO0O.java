...
public final class OooOO0O extends OooOo {
    public static void OooO0O0(Intent intent, String str, String str2) {
        PendingIntent activity = PendingIntent.getActivity(App.f22232OooO0o, 1807201968, intent, 335544320);
        String strOooO0OO = o0000.OooO0OO(o000000.notification_new_message);
        Notification.Builder builderOooO00o = g0.OooO00o();
        builderOooO00o.setContentTitle(str).setContentText(str2).setTicker(strOooO0OO).setDefaults(2).setSmallIcon(o0Oo0oo.icon_notification_small).setLargeIcon(BitmapFactory.decodeResource(App.f22232OooO0o.getResources(), o0Oo0oo.ic_logo)).setAutoCancel(true).setOngoing(false).setPriority(1).setContentIntent(activity);
        App.f22234OooO0oO.post(new o00Oo00(1, "Yalla_Notice_PriveteChat", builderOooO00o));
    }

    public final boolean OooO0OO() {
        return (OooOo.OooO00o() || !o00Ooo.OooOO0o().OooOOOO() || (OooO0O0.OooO0O0() instanceof PrivateChatActivity)) ? false : true;
    }

    /* JADX WARN: Multi-variable type inference failed */
    public final void OooO0Oo(@NotNull MessageIM.Message msg, boolean z) throws InvalidProtocolBufferException {
        Intrinsics.checkNotNullParameter(msg, "msg");
        o0000O00.OooO0OO("ChatMsgProcessor", "message = " + msg);
        ...
        if (!(o00Oo0.OooO00o().OooOOo0().OooO0o(((Number) OooO00o.OooO00o()).longValue(), msg.getMid()) != null) || z) {
            ...
            if (head == 1504) {
                ...
                o000OO.OooO0oO(o000OO.OooO0o(mid, true));
                if (OooO0OO()) {
                    ...
                    if (userInfoOooO0Oo != null) {
                        String strOooO0O0 = o000O000.OooO0O0(msg.getFromId(), userInfoOooO0Oo.getUserName());
                        Intent intent = new Intent(App.f22232OooO0o, (Class<?>) PrivateChatActivity.class);
                        intent.putExtra(v3.f45737OooO00o, msg.getFromId());
                        MutableLiveData<List<OooOOO0>> mutableLiveData = OooOOO.f43158OooO00o;
                        OooO0O0(intent, strOooO0O0, OooOOO.OooO00o(o0000O.OooO00o(o0000.OooO0OO(o000000.message_give_theme_successful), strOooO0O0)));
                        return;
                    }
                    return;
                }
            ...
            if (head == 2103) {
                o0oo0000.OooO00o.OooO0OO("204012", MapsKt.mapOf(new Pair("region", String.valueOf(p595o0oo00O.OooOo00.OooO0OO()))));
                ...
                o000OO.OooO0oO(o000OO.OooOo0o(fromId3, content, mid2, msg.getTime(), true, from2.getWarn() == 1));
                if (OooO0OO()) {
                    UserInfoRepo userInfoRepo2 = UserInfoRepo.f22735OooO00o;
                    ...
                    if (userInfoOooO0Oo2 != null) {
                        String strOooO0O1 = o000O000.OooO0O0(msg.getFromId(), userInfoOooO0Oo2.getUserName());
                        Intent intent2 = new Intent(App.f22232OooO0o, (Class<?>) PrivateChatActivity.class);
                        intent2.putExtra(v3.f45737OooO00o, msg.getFromId());
            ...
            if (head == 2105) {
                ...
                ChatMessage chatMessageOooOO0O = o000OO.OooOO0O(fromId5, giftId, number, giftURL, mid3, msg.getTime(), true, false, false, false, false, 1920);
                o000OO.OooO0oO(chatMessageOooOO0O);
                if (OooO0OO()) {
                    UserInfoRepo userInfoRepo3 = UserInfoRepo.f22735OooO00o;
                    ...
                    if (userInfoOooO0Oo3 != null) {
                        String strOooO0O2 = o000O000.OooO0O0(msg.getFromId(), userInfoOooO0Oo3.getUserName());
                        Intent intent3 = new Intent(App.f22232OooO0o, (Class<?>) PrivateChatActivity.class);
                        intent3.putExtra(v3.f45737OooO00o, msg.getFromId());
                        MutableLiveData<Map<Integer, GiftPropModel>> mutableLiveData3 = oo0o0Oo.f43573OooO00o;
                        GiftPropModel giftPropModelOooO0O0 = oo0o0Oo.OooO0O0(from3.getGiftId());
                        OooO0O0(intent3, strOooO0O2, chatMessageOooOO0O.getGifInfo() != null ? String.valueOf(giftPropModelOooO0O0 != null ? giftPropModelOooO0O0.getName() : null) : o0000.OooO0OO(o000000.notification_default_gift));
                        return;
                    }
                    return;
                }
            ...
            if (head == 2109) {
                ...
                o000OO.OooO0oO(o000OO.OooOoO0(fromId7, duration, "", url, mid4, msg.getTime(), true));
                if (OooO0OO()) {
                    UserInfoRepo userInfoRepo4 = UserInfoRepo.f22735OooO00o;
                    ...
                    if (userInfoOooO0Oo4 != null) {
                        String strOooO0O3 = o000O000.OooO0O0(msg.getFromId(), userInfoOooO0Oo4.getUserName());
                        Intent intent4 = new Intent(App.f22232OooO0o, (Class<?>) PrivateChatActivity.class);
                        intent4.putExtra(v3.f45737OooO00o, msg.getFromId());
                        OooO0O0(intent4, strOooO0O3, o0000.OooO0OO(o000000.voice_notice));
                        return;
                    }
                    return;
                }
            ...
            if (head == 2115) {
                ...
                ChatMessage chatMessage = o000OO.OooO0oo(fromId9, type, number2, mid5, msg.getTime(), true);
                Intrinsics.checkNotNullParameter(chatMessage, "chatMessage");
                o00Oo0.OooO00o().OooOOo0().OooO0oo(chatMessage);
                o000OO.OooO0oO(chatMessage);
                if (OooO0OO()) {
                    UserInfoRepo userInfoRepo5 = UserInfoRepo.f22735OooO00o;
                    ...
                    if (userInfoOooO0Oo5 != null) {
                        String strOooO0O4 = o000O000.OooO0O0(msg.getFromId(), userInfoOooO0Oo5.getUserName());
                        Intent intent5 = new Intent(App.f22232OooO0o, (Class<?>) PrivateChatActivity.class);
                        intent5.putExtra(v3.f45737OooO00o, msg.getFromId());
                        OooO0O0(intent5, strOooO0O4, o0000.OooO0OO(o000000.Stickers));
                        return;
                    }
                    return;
                }
            ...
            if (head == 2124) {
                ...
                o000OO.OooO0oO(o000OO.OooOo0(fromId11, userId, prettyID, nickName, photo, msg2, mid6, msg.getTime(), true));
                if (OooO0OO()) {
                    UserInfoRepo userInfoRepo6 = UserInfoRepo.f22735OooO00o;
                    ...
                    if (userInfoOooO0Oo6 != null) {
                        String strOooO0O5 = o000O000.OooO0O0(msg.getFromId(), userInfoOooO0Oo6.getUserName());
                        Intent intent6 = new Intent(App.f22232OooO0o, (Class<?>) PrivateChatActivity.class);
                        intent6.putExtra(v3.f45737OooO00o, msg.getFromId());
                        OooO0O0(intent6, strOooO0O5, o0000O.OooO00o(o0000.OooO0OO(o000000.XXX_shared_a_user_with_you), strOooO0O5));
                    }
                }
            ...
            if (head == 2140) {
                ...
                if (giftsList != null) {
                    ...
                    for (MessageIM.GiftIdUrl giftIdUrl : giftsList) {
                        ...
                        ChatMessage chatMessageOooOO0O2 = o000OO.OooOO0O(fromId13, iOooO0oO, 1, giftUrl, mid7, msg.getTime(), true, false, false, false, false, 1920);
                        o000OO.OooO0oO(chatMessageOooOO0O2);
                        if (OooO0OO()) {
                            UserInfoRepo userInfoRepo7 = UserInfoRepo.f22735OooO00o;
                            ...
                            if (userInfoOooO0Oo7 != null) {
                                String strOooO0O6 = o000O000.OooO0O0(msg.getFromId(), userInfoOooO0Oo7.getUserName());
                                Intent intent7 = new Intent(App.f22232OooO0o, (Class<?>) PrivateChatActivity.class);
                                intent7.putExtra(v3.f45737OooO00o, msg.getFromId());
                                MutableLiveData<Map<Integer, GiftPropModel>> mutableLiveData4 = oo0o0Oo.f43573OooO00o;
                                GiftPropModel giftPropModelOooO0O1 = oo0o0Oo.OooO0O0(o0OoOo0.OooO0oO(Long.valueOf(giftIdUrl.getGiftId())));
                                OooO0O0(intent7, strOooO0O6, chatMessageOooOO0O2.getGifInfo() != null ? String.valueOf(giftPropModelOooO0O1 != null ? giftPropModelOooO0O1.getName() : null) : o0000.OooO0OO(o000000.notification_default_gift));
                            }
                        }
                    }
                    return;
            ...
            switch (head) {
                case 2119:
                    ...
                    if (from8 != null) {
                        ...
                        o000OO.OooO0oO(o000OO.OooO(gifid, fromId15, msg.getTime(), gifurl, mid8, true));
                        if (OooO0OO()) {
                            UserInfoRepo userInfoRepo8 = UserInfoRepo.f22735OooO00o;
                            ...
                            if (userInfoOooO0Oo8 != null) {
                                String strOooO0O7 = o000O000.OooO0O0(msg.getFromId(), userInfoOooO0Oo8.getUserName());
                                Intent intent8 = new Intent(App.f22232OooO0o, (Class<?>) PrivateChatActivity.class);
                                intent8.putExtra(v3.f45737OooO00o, msg.getFromId());
                                OooO0O0(intent8, strOooO0O7, o0000.OooO0OO(o000000.Stickers));
                            }
                        }
                    }
                    break;
                case 2120:
                    ...
                    if (from9 != null) {
                        ...
                        o000OO.OooO0oO(o000OO.OooOOo0(fromId17, i64RoomId, i64RoomIdx, name, image, roomIp, msg3, mid9, msg.getTime(), true));
                        if (OooO0OO()) {
                            UserInfoRepo userInfoRepo9 = UserInfoRepo.f22735OooO00o;
                            ...
                            if (userInfoOooO0Oo9 != null) {
                                String strOooO0O8 = o000O000.OooO0O0(msg.getFromId(), userInfoOooO0Oo9.getUserName());
                                Intent intent9 = new Intent(App.f22232OooO0o, (Class<?>) PrivateChatActivity.class);
                                intent9.putExtra(v3.f45737OooO00o, msg.getFromId());
                                OooO0O0(intent9, strOooO0O8, o0000O.OooO00o(o0000.OooO0OO(o000000.recommend_room_to_you), strOooO0O8));
                            }
                        }
                ...
                case 2121:
                    ...
                    if (from10 != null) {
                        ...
                        o000OO.OooO0oO(o000OO.OooOOOO(fromId19, momentId64, image2, text, type2, msg4, mid10, msg.getTime(), true));
                        if (OooO0OO()) {
                            UserInfoRepo userInfoRepo10 = UserInfoRepo.f22735OooO00o;
                            ...
                            if (userInfoOooO0Oo10 != null) {
                                String strOooO0O9 = o000O000.OooO0O0(msg.getFromId(), userInfoOooO0Oo10.getUserName());
                                Intent intent10 = new Intent(App.f22232OooO0o, (Class<?>) PrivateChatActivity.class);
                                intent10.putExtra(v3.f45737OooO00o, msg.getFromId());
                                OooO0O0(intent10, strOooO0O9, o0000O.OooO00o(o0000.OooO0OO(o000000.XXX_shared_a_post_with_you), strOooO0O9));
                                if (from10.getType() == MomentToShareFriend.Poll.getValue()) {
                                    OooO0O0(intent10, strOooO0O9, o0000O.OooO00o(o0000.OooO0OO(o000000.moment_poll_share_from_user), strOooO0O9));
                                }
                            }
                        }
                ...
                case 2122:
                    ...
                    if (from11 != null) {
                        ...
                        o000OO.OooO0oO(o000OO.OooOOoo(fromId21, image3, name2, userCount, msg5, true, momentCount, mid11, circleId, msg.getTime()));
                        if (OooO0OO()) {
                            UserInfoRepo userInfoRepo11 = UserInfoRepo.f22735OooO00o;
                            ...
                            if (userInfoOooO0Oo11 != null) {
                                String strOooO0O10 = o000O000.OooO0O0(msg.getFromId(), userInfoOooO0Oo11.getUserName());
                                Intent intent11 = new Intent(App.f22232OooO0o, (Class<?>) PrivateChatActivity.class);
                                intent11.putExtra(v3.f45737OooO00o, msg.getFromId());
                                OooO0O0(intent11, strOooO0O10, o0000O.OooO00o(o0000.OooO0OO(o000000.XXX_shared_a_topic_with_you), strOooO0O10));
                            }
                        }
                ...
                default:
                    switch (head) {
                        case 2127:
                            ...
                            o000OO.OooO0oO(o000OO.OooOO0o(fromId23, image4, txt1, txt2, url2, msg6, mid12, msg.getTime(), true));
                            if (OooO0OO()) {
                                UserInfoRepo userInfoRepo12 = UserInfoRepo.f22735OooO00o;
                                ...
                                if (userInfoOooO0Oo12 != null) {
                                    String strOooO0O11 = o000O000.OooO0O0(msg.getFromId(), userInfoOooO0Oo12.getUserName());
                                    Intent intent12 = new Intent(App.f22232OooO0o, (Class<?>) PrivateChatActivity.class);
                                    intent12.putExtra(v3.f45737OooO00o, msg.getFromId());
                                    OooO0O0(intent12, strOooO0O11, o0000O.OooO00o(o0000.OooO0OO(o000000.message_XX_shared_a_activity_with_you), strOooO0O11));
                                }
                            }
                        ...
                        case 2128:
                            ...
                            if (from13 != null) {
                                ...
                                ChatMessage chatMessageOooO0O0 = o000OO.OooO0O0(fromId25, time, mid13, true);
                                ...
                                if (OooO0OO()) {
                                    UserInfoRepo userInfoRepo13 = UserInfoRepo.f22735OooO00o;
                                    ...
                                    if (userInfoOooO0Oo13 != null) {
                                        String strOooO0O12 = o000O000.OooO0O0(msg.getFromId(), userInfoOooO0Oo13.getUserName());
                                        Intent intent13 = new Intent(App.f22232OooO0o, (Class<?>) PrivateChatActivity.class);
                                        intent13.putExtra(v3.f45737OooO00o, msg.getFromId());
                                        OooO0O0(intent13, strOooO0O12, o0000O.OooO00o(o0000.OooO0OO(o000000.message_XX_shared_a_activity_with_you), strOooO0O12));
                                    }
                                }
                        ...
                        case 2129:
                            ...
                            if (from14 != null) {
                                ...
                                o000OO.OooO0oO(o000OO.OooOOO(fromId27, eventId, eventName, pic, keyWord, startTime, endTime, roomId, roomName, roomIp2, mid14, msg.getTime(), true));
                                if (OooO0OO()) {
                                    UserInfoRepo userInfoRepo14 = UserInfoRepo.f22735OooO00o;
                                    ...
                                    if (userInfoOooO0Oo14 != null) {
                                        String strOooO0O13 = o000O000.OooO0O0(msg.getFromId(), userInfoOooO0Oo14.getUserName());
                                        Intent intent14 = new Intent(App.f22232OooO0o, (Class<?>) PrivateChatActivity.class);
                                        intent14.putExtra(v3.f45737OooO00o, msg.getFromId());
                                        OooO0O0(intent14, strOooO0O13, o0000O.OooO00o(o0000.OooO0OO(o000000.message_you_accept_xx_share_event), strOooO0O13));
                                    }
                                }
                            }
                            break;
                        default:
                            ...
                            ChatMessage chatMessageOooO0O1 = o000OO.OooO0O0(fromId29, time2, mid15, true);
                            chatMessageOooO0O1.setContentType(100);
                            chatMessageOooO0O1.setUnknownMessage(messageContent);
                            o00Oo0.OooO00o().OooOOo0().OooO0oo(chatMessageOooO0O1);
                            o000OO.OooO0oO(chatMessageOooO0O1);
                            if (OooO0OO()) {
                                UserInfoRepo userInfoRepo15 = UserInfoRepo.f22735OooO00o;
                                ...
                                if (userInfoOooO0Oo15 != null) {
                                    String strOooO0O14 = o000O000.OooO0O0(msg.getFromId(), userInfoOooO0Oo15.getUserName());
                                    Intent intent15 = new Intent(App.f22232OooO0o, (Class<?>) PrivateChatActivity.class);
                                    intent15.putExtra(v3.f45737OooO00o, msg.getFromId());
    ...
    public final void OooO0o0(MessageIM.Message message, String str) {
        ...
        o000OO.OooO0oO(o000OO.OooOo(message.getFromId(), str, o0O0o00O.f55755OooO00o.OooO00o(Long.valueOf(message.getFromId())), message.getTime() + 1, true, 32));
        if (OooO0OO()) {
            UserInfoRepo userInfoRepo = UserInfoRepo.f22735OooO00o;
            ...
            if (userInfoOooO0Oo != null) {
                String strOooO0O0 = o000O000.OooO0O0(message.getFromId(), userInfoOooO0Oo.getUserName());
                Intent intent = new Intent(App.f22232OooO0o, (Class<?>) PrivateChatActivity.class);
                intent.putExtra(v3.f45737OooO00o, message.getFromId());
