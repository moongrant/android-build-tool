...
public final class EventDetailViewModel extends EventViewModel {
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public ApiResult f23613OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public int f23615OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ MutableSharedFlow<ApiResult<String>> f23616OooO0oO;
        ...
        public OooO00o(MutableSharedFlow<ApiResult<String>> mutableSharedFlow, Continuation<? super OooO00o> continuation) {
            ...
            this.f23616OooO0oO = mutableSharedFlow;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return EventDetailViewModel.this.new OooO00o(this.f23616OooO0oO, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f23615OooO0o0;
            EventDetailViewModel eventDetailViewModel = EventDetailViewModel.this;
            if (i != 0) {
                if (i == 1) {
                    ResultKt.throwOnFailure(obj);
                } else if (i == 2) {
                    apiResult = this.f23613OooO0Oo;
                    ResultKt.throwOnFailure(obj);
                    this.f23613OooO0Oo = null;
                    this.f23615OooO0o0 = 3;
                    if (this.f23616OooO0oO.emit(apiResult, this) == coroutine_suspended) {
            ...
            if (apiResult.isSuccess()) {
                ...
                this.f23613OooO0Oo = apiResult;
                this.f23615OooO0o0 = 2;
    ...
    public static final class OooO0OO extends SuspendLambda implements Function2<Integer, Continuation<? super o000Oo0<UserInfoModel>>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f23619OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ int f23621OooO0o0;
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            ...
            oooO0OO.f23621OooO0o0 = ((Number) obj).intValue();
            return oooO0OO;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f23619OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                int i2 = this.f23621OooO0o0;
                long id = EventDetailViewModel.this.getEventModel().getId();
                this.f23619OooO0Oo = 1;
    ...
    public final void updateRoomEventState() {
        ...
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.MainScope(), Dispatchers.getIO(), null, new o0000O(mid, null), 2, null);
    }
