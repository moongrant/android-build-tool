...
public final class VipVm extends p394o0Oo0.OooOO0 {
    ...
    public static final class OooO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i = this.f32032OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                this.f32032OooO0Oo = 1;
                String strOooO0OO = oo000o.OooO0OO("/Webservers/KaPoint/GetShopTop");
                obj = OooOOO.OooO0Oo(new VipRepo$getGetShopTop$$inlined$call$1(p391o0OOooo0.oo000o.OooO00o(strOooO0OO, "url", strOooO0OO, 0), null), this);
    ...
    public static final class OooO00o extends SuspendLambda implements Function2<Integer, Continuation<? super o000Oo0<VipShopRecordModel>>, Object> {
        ...
        public final /* synthetic */ int f32035OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ int f32036OooO0o0;
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooO00o oooO00o = new OooO00o(this.f32035OooO0o, continuation);
            oooO00o.f32036OooO0o0 = ((Number) obj).intValue();
            return oooO00o;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                ...
                o0oooooOooO00o.OooO0O0(Boxing.boxInt(this.f32035OooO0o), "type");
    ...
    public static final class OooO0O0 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public Object f32037OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public /* synthetic */ Object f32038OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public int f32039OooO0o0;
        ...
        public static final class OooO00o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
            public final /* synthetic */ ApiResult<PersonalVipModel> f32041OooO0Oo;

            /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
            public final /* synthetic */ ApiResult<List<VipWelfareModel>> f32042OooO0o;

            /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
            public final /* synthetic */ ApiResult<List<VipModel>> f32043OooO0o0;

            /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
            public final /* synthetic */ VipVm f32044OooO0oO;
            ...
            public OooO00o(ApiResult<PersonalVipModel> apiResult, ApiResult<List<VipModel>> apiResult2, ApiResult<List<VipWelfareModel>> apiResult3, VipVm vipVm, Continuation<? super OooO00o> continuation) {
                super(2, continuation);
                this.f32041OooO0Oo = apiResult;
                this.f32043OooO0o0 = apiResult2;
                this.f32042OooO0o = apiResult3;
                this.f32044OooO0oO = vipVm;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            @NotNull
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                return new OooO00o(this.f32041OooO0Oo, this.f32043OooO0o0, this.f32042OooO0o, this.f32044OooO0oO, continuation);
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                ResultKt.throwOnFailure(obj);
                ApiResult<PersonalVipModel> apiResult = this.f32041OooO0Oo;
                boolean zIsSuccess = apiResult.isSuccess();
                VipVm vipVm = this.f32044OooO0oO;
                if (zIsSuccess) {
                    ApiResult<List<VipModel>> apiResult2 = this.f32043OooO0o0;
                    if (apiResult2.isSuccess()) {
                        ...
                        ApiResult<List<VipWelfareModel>> apiResult3 = this.f32042OooO0o;
                        ...
                        if (data3 != null) {
                            ...
                            if (vipVm.getKaVipModels().isEmpty()) {
                                ...
                                if (!vipVm.getOpenDialog() && vipVm.getPersonalKaVipModel().getValue().getKaVIPLv() != vipLevel.getValue() && vipVm.getSupportVip6().getValue().booleanValue()) {
                                    ...
                                    addVip6Dialog.setValue(Boxing.boxBoolean(ooo00oo0OooOO0O.OooO0O0("addVipLevelDialog-" + iLevel4 + "-" + o0O00oO0.OooOOo0().getValue(), true)));
                                }
        ...
        public static final class OooO0OO extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<List<VipModel>>>, Object> {
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                int i = this.f32046OooO0Oo;
                if (i == 0) {
                    ResultKt.throwOnFailure(obj);
                    this.f32046OooO0Oo = 1;
                    String strOooO0OO = oo000o.OooO0OO("/Webservers/User/KAVIPPrivilege");
                    obj = OooOOO.OooO0Oo(new VipRepo$getVipPrivilege$$inlined$call$1(p391o0OOooo0.oo000o.OooO00o(strOooO0OO, "url", strOooO0OO, 0), null), this);
                    if (obj == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
        ...
        public static final class OooO0o extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<PersonalVipModel>>, Object> {
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                int i = this.f32047OooO0Oo;
                if (i == 0) {
                    ResultKt.throwOnFailure(obj);
                    this.f32047OooO0Oo = 1;
                    String strOooO0OO = oo000o.OooO0OO("/Webservers/User/UserKAVIPInfo");
                    obj = OooOOO.OooO0Oo(new VipRepo$getPersonalVip$$inlined$call$1(p391o0OOooo0.oo000o.OooO00o(strOooO0OO, "url", strOooO0OO, 0), null), this);
                    if (obj == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            OooO00o oooO00o;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f32039OooO0o0;
            if (i != 0) {
                if (i == 1) {
                    deferredAsync$default2 = (Deferred) this.f32037OooO0Oo;
                    Deferred deferred2 = (Deferred) this.f32038OooO0o;
                    ResultKt.throwOnFailure(obj);
                    deferredAsync$default = deferred2;
                    objAwait = obj;
                } else if (i == 2) {
                    apiResult = (ApiResult) this.f32037OooO0Oo;
                    Deferred deferred3 = (Deferred) this.f32038OooO0o;
                    ResultKt.throwOnFailure(obj);
                    deferred = deferred3;
                    objAwait2 = obj;
                    apiResult2 = (ApiResult) objAwait2;
                    this.f32038OooO0o = apiResult;
                    this.f32037OooO0Oo = apiResult2;
                    this.f32039OooO0o0 = 3;
                    ...
                    this.f32038OooO0o = null;
                    this.f32037OooO0Oo = null;
                    this.f32039OooO0o0 = 4;
                    if (OooOOO.OooO0o0(oooO00o, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else if (i == 3) {
                    ApiResult apiResult5 = (ApiResult) this.f32037OooO0Oo;
                    ApiResult apiResult6 = (ApiResult) this.f32038OooO0o;
                    ResultKt.throwOnFailure(obj);
            ...
            ResultKt.throwOnFailure(obj);
            CoroutineScope coroutineScope = (CoroutineScope) this.f32038OooO0o;
            ...
            this.f32038OooO0o = deferredAsync$default;
            this.f32037OooO0Oo = deferredAsync$default2;
            this.f32039OooO0o0 = 1;
            objAwait = deferredAsync$default3.await(this);
            if (objAwait == coroutine_suspended) {
                return coroutine_suspended;
            }
            ApiResult apiResult7 = (ApiResult) objAwait;
            this.f32038OooO0o = deferredAsync$default2;
            this.f32037OooO0Oo = apiResult7;
            this.f32039OooO0o0 = 2;
    ...
    public static final class OooO0o extends SuspendLambda implements Function2<Integer, Continuation<? super o000Oo0<VipWelfareModel>>, Object> {
        ...
        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f32050OooO0Oo;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ int f32051OooO0o0;
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            ...
            oooO0o.f32051OooO0o0 = ((Number) obj).intValue();
            return oooO0o;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.f32050OooO0Oo;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                int i2 = this.f32051OooO0o0;
                this.f32050OooO0Oo = 1;
    ...
    public static final class OooOO0 extends SuspendLambda implements Function2<o00OO0O0<ApiResult<VipShopExchangeModel>>, Continuation<? super Unit>, Object> {

        /* JADX INFO: renamed from: OooO0Oo, reason: collision with root package name */
        public int f32052OooO0Oo;

        /* JADX INFO: renamed from: OooO0o, reason: collision with root package name */
        public final /* synthetic */ int f32053OooO0o;

        /* JADX INFO: renamed from: OooO0o0, reason: collision with root package name */
        public /* synthetic */ Object f32054OooO0o0;

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ VipVm f32055OooO0oO;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OooOO0(int i, VipVm vipVm, Continuation<? super OooOO0> continuation) {
            super(2, continuation);
            this.f32053OooO0o = i;
            this.f32055OooO0oO = vipVm;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            OooOO0 oooOO1 = new OooOO0(this.f32053OooO0o, this.f32055OooO0oO, continuation);
            oooOO1.f32054OooO0o0 = obj;
            return oooOO1;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(o00OO0O0<ApiResult<VipShopExchangeModel>> o00oo0o1, Continuation<? super Unit> continuation) {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                o00OO0O0 o00oo0o2 = (o00OO0O0) this.f32054OooO0o0;
                this.f32054OooO0o0 = o00oo0o2;
                ...
                o0oooooOooO00o.OooO0O0(Boxing.boxInt(this.f32053OooO0o), "shopId");
                ...
                o00oo0o1 = (o00OO0O0) this.f32054OooO0o0;
                ResultKt.throwOnFailure(obj);
            }
            ApiResult apiResult = (ApiResult) obj;
            if (apiResult.isSuccess()) {
                this.f32055OooO0oO.getMyWelfareData().OooO0O0();
            }
    ...
    public static final class OooOO0O extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                ...
                if (OooOOO.OooO0Oo(new VipRepo$updateVipDialogState$$inlined$call$1(p391o0OOooo0.oo000o.OooO00o(strOooO0OO, "url", strOooO0OO, 1), null), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
    ...
    public final void hideRedPoint() {
        oOo00OO0 ooo00oo0OooOO0O = o00Ooo.OooOO0O();
        ooo00oo0OooOO0O.getClass();
        ooo00oo0OooOO0O.OooO0o("vipRedDot_CustomRoomTheme_Hide4Fragment" + o0O00oO0.OooOOo0().getValue(), true);
        oOo00OO0 ooo00oo0OooOO0O2 = o00Ooo.OooOO0O();
        ooo00oo0OooOO0O2.getClass();
        ooo00oo0OooOO0O2.OooO0o("vipRedDot_ExclusiveBubble_Hide4Fragment" + o0O00oO0.OooOOo0().getValue(), true);
        oOo00OO0 ooo00oo0OooOO0O3 = o00Ooo.OooOO0O();
        ooo00oo0OooOO0O3.getClass();
        ooo00oo0OooOO0O3.OooO0o("vipRedDot_IncognitoAccess_Hide4Fragment" + o0O00oO0.OooOOo0().getValue(), true);
        oOo00OO0 ooo00oo0OooOO0O4 = o00Ooo.OooOO0O();
        ooo00oo0OooOO0O4.getClass();
        ooo00oo0OooOO0O4.OooO0o("vipRedDot_ExclusiveBackpackGift_Hide4Fragment" + o0O00oO0.OooOOo0().getValue(), true);
        oOo00OO0 ooo00oo0OooOO0O5 = o00Ooo.OooOO0O();
        ooo00oo0OooOO0O5.getClass();
        ooo00oo0OooOO0O5.OooO0o("vipRedDot_ExclusiveGiftRunway_Hide4Fragment" + o0O00oO0.OooOOo0().getValue(), true);
        oOo00OO0 ooo00oo0OooOO0O6 = o00Ooo.OooOO0O();
        ooo00oo0OooOO0O6.getClass();
        ooo00oo0OooOO0O6.OooO0o("vipRedDot_LuckyPacketSend_Hide4Fragment" + o0O00oO0.OooOOo0().getValue(), true);
        oOo00OO0 ooo00oo0OooOO0O7 = o00Ooo.OooOO0O();
        ooo00oo0OooOO0O7.getClass();
        o000oOoO.OooO0OO("vipRedDot_CustomUserPrettyId_Hide4Fragment", o0O00oO0.OooOOo0().getValue(), ooo00oo0OooOO0O7, true);
    }
    ...
    @NotNull
    public final o00OO0O0<ApiResult<VipShopExchangeModel>> shopExchange(int shopId) {
        return o00O.OooO00o(this, new OooOO0(shopId, this, null));
    }
