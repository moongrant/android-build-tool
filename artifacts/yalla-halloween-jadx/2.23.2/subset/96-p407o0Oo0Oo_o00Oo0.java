...
public final class o00Oo0 extends o0OO00O<ChatMessage> {
    ...
    public final void OooO0o0(SupportSQLiteStatement supportSQLiteStatement, ChatMessage chatMessage) {
        ...
        if (voiceInfo != null) {
            ...
            OooO0OO.OooO0O0(supportSQLiteStatement, 11, 12, 13, 14);
        }
        ...
        if (giftInfo != null) {
            ...
            OooO0OO.OooO0O0(supportSQLiteStatement, 18, 19, 20, 21);
            supportSQLiteStatement.bindNull(22);
            supportSQLiteStatement.bindNull(23);
            supportSQLiteStatement.bindNull(24);
        }
        ...
        if (shareMomentInfo != null) {
            ...
            OooO0OO.OooO0O0(supportSQLiteStatement, 32, 33, 34, 35);
        ...
        if (shareActivityInfo != null) {
            ...
            OooO0OO.OooO0O0(supportSQLiteStatement, 48, 49, 50, 51);
            supportSQLiteStatement.bindNull(52);
        }
        ...
        if (giveRoomThemeInfo != null) {
            ...
            OooO0OO.OooO0O0(supportSQLiteStatement, 53, 54, 55, 56);
        ...
        if (shareEventRoomInfo == null) {
            OooO0OO.OooO0O0(supportSQLiteStatement, 60, 61, 62, 63);
            OooO0OO.OooO0O0(supportSQLiteStatement, 64, 65, 66, 67);
