...
public final class o0O0OO0 implements o0O0O0Oo {
    ...
    public final RoomDatabase f45828OooO00o;

    /* JADX INFO: renamed from: OooO0O0, reason: collision with root package name */
    public final o0O0O0o0 f45829OooO0O0;

    public o0O0OO0(YlAppDataBase ylAppDataBase) {
        this.f45828OooO00o = ylAppDataBase;
        this.f45829OooO0O0 = new o0O0O0o0(ylAppDataBase);
    }

    @Override // p407o0Oo0Oo.o0O0O0Oo
    public final void OooO00o(RoomTheme roomTheme) {
        RoomDatabase roomDatabase = this.f45828OooO00o;
        roomDatabase.OooO0O0();
        roomDatabase.OooO0OO();
        try {
            this.f45829OooO0O0.OooO0oO(roomTheme);
            roomDatabase.OooOOO();
        } finally {
            roomDatabase.OooOO0();
        }
