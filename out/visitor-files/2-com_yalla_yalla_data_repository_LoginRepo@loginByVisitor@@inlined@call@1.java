...
public final class LoginRepo$loginByVisitor$$inlined$call$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<LoginModel>>, Object> {

    /* JADX INFO: renamed from: OooO, reason: collision with root package name */
    public final /* synthetic */ com.yalla.yalla.api.call.OooO f46714OooO;

    /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
    public com.yalla.yalla.api.call.OooO f46715OooO0oO;

    /* JADX INFO: renamed from: OooO0oo, reason: collision with root package name */
    public int f46716OooO0oo;

    public static final class OooO00o implements Function0<String> {

        /* JADX INFO: renamed from: OooO0oO, reason: collision with root package name */
        public final /* synthetic */ Exception f46717OooO0oO;

        public OooO00o(Exception exc) {
            this.f46717OooO0oO = exc;
        }

        @Override // kotlin.jvm.functions.Function0
        public final String invoke() {
            Exception exc = this.f46717OooO0oO;
    ...
    public LoginRepo$loginByVisitor$$inlined$call$1(com.yalla.yalla.api.call.OooO oooO, Continuation continuation) {
        super(2, continuation);
        this.f46714OooO = oooO;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new LoginRepo$loginByVisitor$$inlined$call$1(this.f46714OooO, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ApiResult<LoginModel>> continuation) {
        return ((LoginRepo$loginByVisitor$$inlined$call$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        int i = this.f46716OooO0oo;
        Object obj2 = null;
        try {
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                com.yalla.yalla.api.call.OooO oooO2 = this.f46714OooO;
                ...
                this.f46715OooO0oO = oooO2;
                this.f46716OooO0oo = 1;
                ...
                oooO = this.f46715OooO0oO;
                ResultKt.throwOnFailure(obj);
                objOooO00o = obj;
            }
            com.yalla.yalla.api.call.OooO0OO oooO0OO = com.yalla.yalla.api.call.OooO0OO.f44954OooO00o;
            Type type = new TypeToken<ApiResult<LoginModel>>() { // from class: com.yalla.yalla.data.repository.LoginRepo$loginByVisitor$$inlined$call$1.1
            }.getType();
            oooO0OO.getClass();
            ...
            if (apiResult == null) {
                ...
                Type type2 = new TypeToken<LoginModel>() { // from class: com.yalla.yalla.data.repository.LoginRepo$loginByVisitor$$inlined$call$1.2
                }.getType();
                Intrinsics.checkNotNullExpressionValue(type2, "getType(...)");
                jsonUtil.getClass();
                Object objOooO0o0 = JsonUtil.OooO0o0(strOooO00o, type2);
                if (objOooO0o0 instanceof LoginModel) {
                    obj2 = objOooO0o0;
                }
